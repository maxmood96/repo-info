...
```console
$ docker pull drupal@sha256:7b93a6c7888faa9ed2ed7acdd22ff4d919b030a0ce949a62183f12f19eaefd4e
```
...
```console
$ docker pull drupal@sha256:25d391b617202dbdbde4c425e6128063c7e627c4d335eb67ecf2aa882f1efec4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.8 MB (174778671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e54fef26acae37be2a9c32c40655ce12aeccbc1ccebe63b3f0d9e549d63e15ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Fri, 06 May 2022 00:40:46 GMT
ENV DRUPAL_VERSION=9.3.12
# Fri, 06 May 2022 00:40:47 GMT
WORKDIR /opt/drupal
# Fri, 06 May 2022 00:40:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 May 2022 00:41:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f0057b53d2d877d417d24635c2593f532e98c9c2ea133e1a7e72661eb3c5ec8c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c86206e062d70bb4e056af5bdec7dd4ee60a4b8e96a80859d725dc6f72e627a0`  
		Last Modified: Fri, 06 May 2022 00:56:43 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bf579db633008ba8a5a70511586fb77b2d900a95440c2750060d05d587bc41b`  
		Last Modified: Fri, 06 May 2022 00:56:48 GMT  
		Size: 21.2 MB (21166976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:3a12c0060e4a2cf54a1d190e53e6efa6e9249e00541d401a5639c49301c09194
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154702743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2757828f4365a14dbdf8253ea5d11283b933c3731947d238c95916b71b8bb4ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 21 Apr 2022 07:31:28 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Fri, 06 May 2022 00:44:08 GMT
ENV DRUPAL_VERSION=9.3.12
# Fri, 06 May 2022 00:44:09 GMT
WORKDIR /opt/drupal
# Fri, 06 May 2022 00:44:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:90a2bfa76a32b9d2defae943ddfda3a8e8da093c8b017bc91ecade0aab400f2f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1aad096994d299826667301b697ca7f4dcb96a55443b78be308cb83b7faadc0`  
		Last Modified: Fri, 06 May 2022 01:01:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:864554ecfb05561bf7c9146e3095e45ddb01befdf65679e5f16b188542357aab`  
		Last Modified: Fri, 06 May 2022 01:01:04 GMT  
		Size: 21.2 MB (21164272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
