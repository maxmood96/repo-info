...
```console
$ docker pull drupal@sha256:fa1fbc2cf0c20190f35963a176b599bade564bfcee42bf3bd1972296a4d5b958
```
...
```console
$ docker pull drupal@sha256:39e88bf9e07ec7ecb00907136794d869015d2dd59559b1e25012e305f6f9e70e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.2 MB (170246681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8eaa9918f821d6a69ef15ecf44a9fd531d4a9f50f930245f1aa8fc71d405c9f4`
...
# Thu, 04 Aug 2022 23:37:22 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 23:37:22 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:37:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:37:33 GMT
...
-	Layers:
	...
	-	`sha256:1244984385b1712fda56b5f18f909415ddfe450c65c7f055a9a45094bb761a59`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:463324371a347adc1e13a09c87a9fa5adc8fcf5b382ce1284b400127dca02150`  
		Last Modified: Fri, 05 Aug 2022 00:01:27 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dd1b282b9b45e5ac2247d1a03037c07b81c096ae5064a397bddef75040dd07a`  
		Last Modified: Fri, 05 Aug 2022 00:01:32 GMT  
		Size: 21.9 MB (21863836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1b1aeb624ec5a214b45c3a5ecd71c976e97a3ac9eafa1566b678488dc85264a1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.4 MB (145407287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9758faf6578b8e0440f7e5bd122b504d925d6a1839bf4214b77a2bd2f16db67b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 07:41:47 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 07:46:22 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 07:46:22 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:46:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:46:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73962d66b6639869f63b60a39185408a3bd001016c836ae02c6f7e29eee02dc8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d6c4850ef4c3879796c731b3b48b5d5820a83d4f79c9ea2020066c31e65811`  
		Last Modified: Fri, 05 Aug 2022 08:26:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:117d7ddbe505601ab44158c0a334bf26dd5e8c93006b71231bd2cb7473096d75`  
		Last Modified: Fri, 05 Aug 2022 08:26:20 GMT  
		Size: 21.9 MB (21863471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:b828ba3a1e71321321bfe7d19975fbda46b575eae263ebcfc5c74d3491b7ed44
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162300650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac25c44b5e6f8f2483f84b79b3384dad533d9c02aa13019bd89b3e3f106f7469`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:40:52 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 00:40:53 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:41:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:41:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:364272ee77b01cc70f3a744dbb5582e23487a7bbff41a47e99d9d13749bb8666`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9669f0efd84f6ede60b3075f68e27e41420474c1f8c3db6ceac23ec836edad20`  
		Last Modified: Fri, 05 Aug 2022 01:15:06 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:affdf85ae58fe54eaa8eefd4463535d68b752025ce8fca14e9bdf41ec89b8fa4`  
		Last Modified: Fri, 05 Aug 2022 01:15:12 GMT  
...
```console
$ docker pull drupal@sha256:b325e720e6f9ac8fffb407f21995b9f48df2eca66c824fce1f11e32b805aa539
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175533671 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2eae4c03787882bdab080c09d800188e13f0a3e8191b44b9e25017bee88c0cb2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e1c59ebe2bf2d1ceb26c48752dab274a0524b10c1520517266f8464ad13c6d6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7476cc060b904103a1d04fe29f95f332aa8cb96130c030ecee956c251c6b00a2`  
		Last Modified: Fri, 05 Aug 2022 00:21:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1119b0b32d40b142f9df3f3377c0d711d65f58eaf33e156efba18ae2888c5af`  
		Last Modified: Fri, 05 Aug 2022 00:21:36 GMT  
		Size: 21.9 MB (21864738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
