...
```console
$ docker pull drupal@sha256:5aecad2d90729c4a81011f59cf19da6d63cdfb68f06d3e2c34fab0a477ff0777
```
...
```console
$ docker pull drupal@sha256:5684adf984437ed9fdcd246a0c7afce42d3d10dee8521aa53d9e1b47ee09189c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.5 MB (146471297 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdbc4e6c583f2f00f63d52044238e18015c840fa5a0f7ae4b2758ba27d686866`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 21 Mar 2023 20:39:00 GMT
ENV DRUPAL_VERSION=9.5.5
# Tue, 21 Mar 2023 20:39:00 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 20:39:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 20:39:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b7c877a0c6c0bd1924cd680f6fad22f8442e58c5a40378b84cb085b59462269e`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46529af049832b06766eda1649a64eb71ca8de9a7bea256128e974e0a80973c2`  
		Last Modified: Tue, 21 Mar 2023 20:56:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9f8cda6aaba884d3ba63e8755057d884bd99df7cfa08f9523ac83d1566ccf30`  
		Last Modified: Tue, 21 Mar 2023 20:56:58 GMT  
		Size: 22.8 MB (22849993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:057ae5fe59a25751e82d4e8cf2a8326a1c2b3062a47cafbdee1d700f65fffe4d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164020234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60995e6fd298a3092914baa2ec2e372088e6b5e655bfd7659b2952110d4ce819`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Mar 2023 20:39:27 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 20:39:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 20:39:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:566419beffae04cb1a8dc5d63045578d739944a5152799ee836448d2a701f2bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fb8e7f89d943a48edd63e514ab18433c3cd75988fbbc70153ad017923f3b046`  
		Last Modified: Tue, 21 Mar 2023 20:55:39 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4318c87b020a387ea9fd8f007d053922c6d4392b6b4ff1fc9b2140e1e1347df6`  
		Last Modified: Tue, 21 Mar 2023 20:55:43 GMT  
		Size: 22.8 MB (22849298 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:398f307ca08f53f4bc1d9056fddfb6bbe6729ae9cfee05b0e89c1b59e2334449
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177255558 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ec5c13d7232b7ec8942186c52c4a62661e4d47c91a8557ec8387a32cc6b16b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Mar 2023 01:00:57 GMT
ENV DRUPAL_VERSION=9.5.5
# Tue, 21 Mar 2023 01:00:57 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 01:01:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 01:01:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3d7636a0ba7e9a12762866822880a4f7b720b18a06941583eebca5b80c5a37ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:253557872164642c393babe32b81875165ebbd884f33088ef5c193f2a8b18736`  
		Last Modified: Tue, 21 Mar 2023 01:17:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c178f63fc0e759705f0ee45d86d6cdbd518edbeb4b77a224f44f5f22a7fd18`  
		Last Modified: Tue, 21 Mar 2023 01:17:54 GMT  
		Size: 22.8 MB (22849709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
