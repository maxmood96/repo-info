...
```console
$ docker pull drupal@sha256:729e6e431ef00877e5ef66c75efd24b6ab1a2d422849aa4b99ead5fdb3cd4421
```
...
```console
$ docker pull drupal@sha256:7b12a0150b83afeed142872ebe95009dffceca194f19af7a381cef798abdecff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177257146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db32bc9d32b69b11311ed8d0dc750c15818b891a09699d860ddcc6138f1a266b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Mar 2023 00:18:17 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:20:41 GMT
ENV DRUPAL_VERSION=9.5.5
# Fri, 24 Mar 2023 00:20:41 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:20:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:20:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8bc3030680b15886a447fb3409324dfa4aa63fe14f104d5d27f0e9b25efbad9d`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37b1844077cd3e4a5bb8d5f6195211b83bee74ca77d821eda5322e67c0c9521b`  
		Last Modified: Fri, 24 Mar 2023 00:37:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5a10222e61648ec0ba6fdce2f5992c73a003c25f708470a15c4230534e5063b`  
		Last Modified: Fri, 24 Mar 2023 00:37:19 GMT  
		Size: 22.8 MB (22849970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
