...
```console
$ docker pull drupal@sha256:aea20235cbfd59283b843725823d97541902843e10880a4fd52843b2ac79cda7
```
...
```console
$ docker pull drupal@sha256:caf7b9fd9f51bc7d7b6553e4e228970eddd19f28167d5dec7889a9e1c6868c73
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.5 MB (198516691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7836ec25e33b731f225e41cf1061d92bedf746f5959ca42a5172afb17edb4180`
...
# Thu, 03 Aug 2023 03:55:41 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 03 Aug 2023 03:55:41 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 03:55:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 03:55:52 GMT
...
-	Layers:
	...
	-	`sha256:35d0f4ccc845536e52fd3accefa7a9340aaf37e9e4fa7c9ef484424801803815`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:556b3a43d2c8fe621d28b413dc120370a88e2c5263696cb11999a9142329379d`  
		Last Modified: Thu, 03 Aug 2023 04:07:10 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9eb750ab6365a8dcc73d86df1a298bd5d69992a895d8485dfe5c54b0c3c237a`  
		Last Modified: Thu, 03 Aug 2023 04:07:14 GMT  
		Size: 18.5 MB (18510542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c09cfdc995c5fb623b7acdd5ae8adbc861dcb5c2d78394a36d0c843196904657
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.6 MB (162589229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b68e198bb415a37cc15bbdeecc3092bf095279cdee4b095bace4da94fa1014f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 29 Jul 2023 00:50:24 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 03 Aug 2023 01:34:53 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 03 Aug 2023 01:34:53 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 01:35:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 01:35:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b4edffa223e38ffb1a7c0199e3e474498f508ffbb4f2569b622eb96752df3789`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:868b01cff70d5fd32e740bf2bcbf4637f80aa32f2e964a400e5ae27834fdcd0b`  
		Last Modified: Thu, 03 Aug 2023 01:44:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be09733e60626084807d706987bef345fbe616fb560351b43d36d4d4601df767`  
		Last Modified: Thu, 03 Aug 2023 01:44:52 GMT  
		Size: 18.5 MB (18510438 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:74b8b227a64b8886723d686833b7020623b76157b1be471c20c24fc35f0ee357
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.6 MB (192575010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:161113a6d36825a568a2e339969671ae5ba0118ffd0ff934353d3d4f1bf0d5df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 03 Aug 2023 01:36:34 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 01:36:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 01:36:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:972f55b549302ccdbd12c0487d723601585cdcd168f6a8412eebcf79b6e865c4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e7387125bec8a840c10e201b347808f15454ff5d05723842b0a64456b2ce4e7`  
		Last Modified: Thu, 03 Aug 2023 01:45:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b673e4ecb9433df6e442d66d8c4f672c229435bb841cafe7e699b2c5daa3903`  
		Last Modified: Thu, 03 Aug 2023 01:45:32 GMT  
		Size: 18.5 MB (18510822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:1ecf7eaf8368eb8c5314aecd9f2f14ea100b7957426ac625999d1bc42101a89a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171730618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f1ac66c6150e8feacc96c6df4ffb58ac7dd8ba57d4cdba641dcf361b34ecc2d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 29 Jul 2023 07:02:05 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 03 Aug 2023 09:07:07 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 03 Aug 2023 09:07:08 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 09:07:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 09:07:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:635e1a8db76ead6a99b1aaeceaeacceea94e356b861eb06418e48acaf25f8208`  
		...
		Size: 698.2 KB (698241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b18786b4ad626a8d9eba7a9426272e438f935cc8d493e2ee51de1e46c3653f51`  
		Last Modified: Thu, 03 Aug 2023 09:21:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15241b42e759aeae4278f19f7dd5282d4567764e0a36ab493164cd2bed08c0e9`  
		Last Modified: Thu, 03 Aug 2023 09:21:20 GMT  
		Size: 18.5 MB (18510870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
