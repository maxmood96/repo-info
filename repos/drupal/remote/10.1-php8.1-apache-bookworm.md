...
```console
$ docker pull drupal@sha256:4a5745fb998813bbf3ad9af7de3476efe8925f0b7e1a625e4c2cfc3cd8acbeb1
```
...
```console
$ docker pull drupal@sha256:fbf9bf1d1d8032b7e42ab8488fb4f7ff0f5dc3eacf19c170738f7942357bf88c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.5 MB (198537847 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f2fc5a09a149ea4ac566c01bfb453b44df50fc0ddc57c4d285677065065d410`
...
# Thu, 07 Sep 2023 23:34:26 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 23:34:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 23:34:37 GMT
...
-	Layers:
	...
	-	`sha256:24a0b6eeeef3fecb763c31f9232f20e1a29c342bbfe9c22148158104371fa78f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea4a3829a18e07143f6f3e9a3446de58fb042056177a4eede5e5644cf204a3fe`  
		Last Modified: Thu, 07 Sep 2023 23:55:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e27a1a691a8711a088ff96e94cc4821dcdca563ad1a1a6614d603c520fea30e8`  
		Last Modified: Thu, 07 Sep 2023 23:55:13 GMT  
...
```console
$ docker pull drupal@sha256:6cbc02141cfbea0e2fe9f24e0073c6b3f2c125b698e5a3b2ef1820cce893c42a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.6 MB (162610208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a73cf46cc29f8a277018544e66e097a07f7a75e49fc3e5ccbe692758eb64fec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 05 Sep 2023 23:49:19 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:49:20 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:49:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:49:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:adacedc57695e864e0709ae0294c78e031328853b56c714efceb32a7dfa150ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1476d183ea4341659be96b2d3e80649d4ccc512c8a8e2fe4af3dc204c1b4dc05`  
		Last Modified: Wed, 06 Sep 2023 00:08:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a46af921383543a751f7a2d2864084033b049819ae4388156da101c46e6994e`  
		Last Modified: Wed, 06 Sep 2023 00:09:08 GMT  
		Size: 18.5 MB (18512337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:2c4c055b6662db5829332ddc94211ef2e51da66c19c056f97af6c126dc3c9507
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.6 MB (192596147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:143f545a86dbb68a64112f6f3ae8f5ef1b77e4c96b5473e80a063c9a9a4e9b73`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 Sep 2023 19:47:25 GMT
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 19:47:26 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 07 Sep 2023 19:47:26 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 19:47:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 19:47:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a9f562c903b583747f7bffd0447023258deae5c21ebaec06b245e8a5b4425c4`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f56adbe42036dc3e048dbe4da73a34b16da4a593d39bddef47914471b5a4bb`  
		Last Modified: Thu, 07 Sep 2023 20:06:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:400c1234a4bc025f83021474053f38db06e76c5c1ab0d24d82bcdbb673440745`  
		Last Modified: Thu, 07 Sep 2023 20:07:07 GMT  
		Size: 18.5 MB (18512317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:54f723ecb3d5ba5de56362571d2d5aaa0e2c0b24d1d8348fbecf624a104c14b2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.5 MB (197514597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3065442e079c1542aea9c6287c74c60f8dfdd656313592263f8f00864e05aa47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 05 Sep 2023 21:56:48 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 21:57:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 21:57:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:12216d13ae66cb87c8af905bf03741bddabb0362ed631a7ba5f3189657ce8802`  
		...
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e82e37b8f4eda3c18a8d86c65c21f29ae95b20c757a8f765bd2ada5dab0eeba`  
		Last Modified: Tue, 05 Sep 2023 22:16:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75e318f5e4d2ea3ec35ce66a083a6b9fd29b8480ea35f0c9d80ae7804a1775fd`  
		Last Modified: Tue, 05 Sep 2023 22:16:41 GMT  
		Size: 18.5 MB (18512101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:5ca1e1a9a1becb2d45450363373deec363f23ddcf9f0b8cd37c1369519cf3b5a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.9 MB (202912917 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7de4e0c5e1ae26e08806939f7c39faa41244e2476b206011dfa902b85a867e4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 18:01:14 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 07 Sep 2023 18:01:15 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 18:01:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 18:01:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cd8136ea3ea23ba4919e1e538caf184fda5913960f0c9ca8dc2b155030e5163d`  
		...
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f19edb62bac05a14e9feea84fb02ea7530cdba1ddb9049addf5fbd7f8f9f090d`  
		Last Modified: Thu, 07 Sep 2023 18:28:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01591cc5f15329e0ecde330bd782f484557624fe89ed9eef69cd1633a4f6f12e`  
		Last Modified: Thu, 07 Sep 2023 18:29:13 GMT  
		Size: 18.5 MB (18512454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:48cbd5e193d6c0c7a8212ee90779f987c5c50f7d9c0b4675241a94d435beaa93
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171753710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81a1877fc3f82db60721a20f5e968e5a0be41b96a4f07f5b8869bf72faa6d9f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 Sep 2023 18:13:04 GMT
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 18:13:05 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 07 Sep 2023 18:13:05 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 18:13:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 18:13:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:27f0b6480e1ee5685d82828cdfce0e7b54f22a1b7fb3351002f108098401d88d`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28b0fe7c42df174589faf3ce0f02c3443f984d48c2f7df8db4875acbf030779c`  
		Last Modified: Thu, 07 Sep 2023 18:31:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eea7b48ff6c499b0b5094b2b2b59bdbe65a6095b54ee62ba4934e7a8f33d8b05`  
		Last Modified: Thu, 07 Sep 2023 18:31:14 GMT  
		Size: 18.5 MB (18512266 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
