...
```console
$ docker pull drupal@sha256:f689854a1ca4c0418decada7d82a84ee9bbfd5405b77852db69a00f607c37c1b
```
...
```console
$ docker pull drupal@sha256:456c6ad1529f625550f7877500b02b3eac7ab31a9456f17040c62adba9bbdfd1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.6 MB (192591130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:244e5908c5c67f5a35a0c0bd65f40ac040cbd516b13df8e6641b9e7535c43412`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 08:17:10 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:17:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:17:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a8f7317ecc999bc0ae786c9f83b149f16f51ca9771496bd77fc2ba7623379c26`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1afd71d87835d4532e6633ad3bd4a836ca19cab85821c9d24eecab8f8a9d725b`  
		Last Modified: Sat, 02 Sep 2023 08:37:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:659cd1affbfcf6963fc2cd807171487a79688682fa179076ca346ffe56bbe633`  
		Last Modified: Sat, 02 Sep 2023 08:37:37 GMT  
		Size: 18.5 MB (18511872 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a079dc9c6201c42d3eebb7e957a37c0eeae029d999e0f0047526ce42fae28956
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.9 MB (202907817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed26d0cb1cdcb0e782ef5eedda9871f656c7c5bcc335931465d90a81adca3cbe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:00:28 GMT
ENV DRUPAL_VERSION=10.1.2
# Sat, 02 Sep 2023 11:00:28 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:00:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:00:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d429cb0adb0b13468cc50aaa4dd8174a16eec907b7d34565d8ee15d5d6c75879`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:787bcc6609fc1fabf9af92a39a2d3f0d006d9b0229356a66de82255d7a1a79a3`  
		Last Modified: Sat, 02 Sep 2023 11:39:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7640a6f37368f5377dc362bee26936e6bcbf2640ed6631233b38fcb5ebdde099`  
		Last Modified: Sat, 02 Sep 2023 11:39:50 GMT  
		Size: 18.5 MB (18512348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
