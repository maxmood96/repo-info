...
```console
$ docker pull drupal@sha256:d5ef158858067730ee3defa942c60603d895e1bdafe7ac53498d71693173f80d
```
...
```console
$ docker pull drupal@sha256:b6839fd732341ab52ae6243bbd72c689a54b5fdfce67f402cbb579379519bec7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.5 MB (197530530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00668a6f6fd7b54c13e66111dfd2895de5843a06ffd739860b0e90f7800814b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 21 Oct 2023 07:23:24 GMT
WORKDIR /opt/drupal
# Sat, 21 Oct 2023 07:23:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 21 Oct 2023 07:23:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7742db15a5b29fe1c9f32493443bb9ce0ca52b0c36e4e3c56df361e5e36fb51b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c5a8c809ffd54c15b7be618613060513250e0cc1070a4cbfc2d03bec454c35`  
		Last Modified: Sat, 21 Oct 2023 07:46:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e217dd7c9b1fd88753f6aa786e82cdd88c2d76941af137c50cfadd52e7935c`  
		Last Modified: Sat, 21 Oct 2023 07:47:09 GMT  
		Size: 18.5 MB (18543062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cb508d826ea7838945333ef86af2492b87809931341a9283be051cc48df1224d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174261472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0a7fc6d4d00dfd13b694659f7edf5a75031ba849ca9c6a611ade82f3e383acd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 28 Oct 2023 05:18:43 GMT
WORKDIR /opt/drupal
# Sat, 28 Oct 2023 05:18:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 28 Oct 2023 05:19:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:57576b58bfd000dd565aa575c6e80648c39318e0391b91b9b1cd2ce5c9132dc7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dc4165a15aeb975fc697ac526f6655c6320c23457d584b2c75b7bb2623ac91d`  
		Last Modified: Sat, 28 Oct 2023 05:42:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90f4d781834c39072b83f85e6911c841bd823905cdd385a3689da958f42a10c1`  
		Last Modified: Sat, 28 Oct 2023 05:42:04 GMT  
		Size: 18.5 MB (18542179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
