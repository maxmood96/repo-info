...
### `drupal:10.5.0-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.5.0-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.5.0-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.5.0-fpm-bookworm` - linux; s390x
