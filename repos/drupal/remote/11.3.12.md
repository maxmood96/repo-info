...
```console
$ docker pull drupal@sha256:5d2416805f743c1163c81f36dac369ff7875f04d1f22197748214f373ca8259e
```
...
### `drupal:11.3.12` - unknown; unknown
...
### `drupal:11.3.12` - linux; arm variant v7
...
### `drupal:11.3.12` - linux; arm64 variant v8
