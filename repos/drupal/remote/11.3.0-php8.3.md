...
```console
$ docker pull drupal@sha256:60ebfac9ee4e00a810c484022be6007a85361a1de64d5eb936d1130976ca576e
```
...
### `drupal:11.3.0-php8.3` - linux; amd64
...
### `drupal:11.3.0-php8.3` - unknown; unknown
...
### `drupal:11.3.0-php8.3` - linux; arm variant v7
...
### `drupal:11.3.0-php8.3` - linux; arm64 variant v8
...
### `drupal:11.3.0-php8.3` - linux; 386
...
### `drupal:11.3.0-php8.3` - linux; ppc64le
...
### `drupal:11.3.0-php8.3` - linux; s390x
