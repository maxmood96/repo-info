...
```console
$ docker pull drupal@sha256:699232662f1b00296c7e68e3422efafec7e7bdc622999fbc3756740c5008b164
```
...
### `drupal:9.3.20-fpm-alpine` - linux; amd64
...
### `drupal:9.3.20-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.3.20-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.20-fpm-alpine` - linux; 386
...
### `drupal:9.3.20-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:7aa44694962e87665d2b3eae2b96252920f8bbc19dfeed3222937e3284263e46
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51925346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0318beb4876bd50c6d5955993b8dd8b109037e51642a4f8a1067d02c233045df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jul 2022 01:40:35 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:58:46 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:58:46 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:59:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:59:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9fad6ef70c110320ac4d9382d6a348748b8a61febea20ad2f648dfe9c214045e`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12732fbd39054eec06274da2db3a17159bb1c47211dd769725b222ab371831f4`  
		Last Modified: Fri, 29 Jul 2022 02:34:30 GMT  
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4d51d8b14c628c08e3dfc56273f8a00f0057922fa062de4012651d503beea70`  
		Last Modified: Fri, 29 Jul 2022 02:49:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf36be7192af900fbb85854d987f3d738bcd196047aaaed83cc8f6a46b2d2c77`  
		Last Modified: Fri, 29 Jul 2022 02:50:08 GMT  
		Size: 21.2 MB (21215249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-fpm-alpine` - linux; s390x
