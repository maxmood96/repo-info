...
```console
$ docker pull drupal@sha256:f7de4acff1354ef91e95c339e11cdadbc94b4cbfe5c2b10d47c47c7eb995b4e0
```
...
### `drupal:9.3.20-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:04ae270b952177766eab2f256b3712b81151e671aefddcfebe4bc4d9241a4355
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48716486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcd4364549fcbddc29dd5c196ad5c9602a77d73b7c38832d3c26e5e9b661acb4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:15:02 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:28:28 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:28:28 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:28:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:28:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8beec75f41f4777273e41b44173d086687cd25743df04d27b59d905171fe3216`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c1a19fd745318cdf04376c4b22e79682e893e8d9cd54a4b14a481b243b6f49c`  
		Last Modified: Thu, 04 Aug 2022 10:17:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f86bc5d6f4918738fe09f72c0f21a9ca0d08422392237e21cf9ff6ab176412b`  
		Last Modified: Thu, 04 Aug 2022 10:17:43 GMT  
		Size: 21.2 MB (21214370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
