...
```console
$ docker pull drupal@sha256:d515fc12aa09071da7714cad82a0ad4008a463241eb024aa876c8a53a68d62e2
```
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - linux; amd64
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - unknown; unknown
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - linux; arm variant v7
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - linux; 386
...
### `drupal:11.0.0-php8.2-fpm-bullseye` - linux; ppc64le
