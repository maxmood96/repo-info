...
```console
$ docker pull drupal@sha256:912b1e6787e7873bdc0f21714f846303072f976dbd24bcd5d4a32b33437b30b0
```
...
### `drupal:9.1.15-fpm-alpine` - linux; amd64
...
### `drupal:9.1.15-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.1.15-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.1.15-fpm-alpine` - linux; ppc64le
...
### `drupal:9.1.15-fpm-alpine` - linux; s390x
