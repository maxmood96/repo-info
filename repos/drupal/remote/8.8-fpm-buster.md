...
```console
$ docker pull drupal@sha256:02f0ae25bfd2251a1afb0b3a4b6501d50bc4b8eb6ef90f2286e91829bb299453
```
...
```console
$ docker pull drupal@sha256:52861ec73dd5bc8c7a20fe3c4ae0cf40a6588d39872be51bcfbb4625d66aec58
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157807078 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b60cd0e970e78b94ede1c59b35a00299c4a9edbd8cd87d18441abb9d6058bf00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:45:08 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:45:09 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:45:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:b9e93388e851504ea0f34082c4b0b210b66f030e9cd4fc9ea5e4262509bf582e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1150602b09e6f77657d9130b424b01da46dd844d7260992e4a8c75430fc7a56`  
		Last Modified: Fri, 07 Aug 2020 18:51:51 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87eee4e8a173f28fa3505979bbb5eb003577a64dddc81b6161f862f1f37d9732`  
		Last Modified: Fri, 07 Aug 2020 18:52:00 GMT  
...
```console
$ docker pull drupal@sha256:800d3da3ee3d74095b64329310f9f8cb48c570c1deef7602a5643b3f7e43288b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.5 MB (171490275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8242791a96824ba86888cca5c55ffec2abe392e8ca63223d11b84ebc869cdaa7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:41:34 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:41:35 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:41:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:091ec86564217a452bf2f727fa97292b29a857df50ae7c7ec5f0454a72378d01`  
		...
		Size: 505.0 KB (504971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:844afade5e54e923e32f6749c889774c65e008d87db33d361f325bc193ba5bdb`  
		Last Modified: Fri, 07 Aug 2020 18:45:29 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:777912fc5198bced5971ee2a6e111e6e91c32072d40d7919a464fe96c89f8d0a`  
		Last Modified: Fri, 07 Aug 2020 18:45:37 GMT  
		Size: 20.5 MB (20535374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:b10640c74607edd40bca4cf2df3de76143e181e598c05d20914d2436a766efc1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176568291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b9e6a96219b434503f8ace98f2c47a6daf6bb9562ef06e06ebca397b61da74b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2bff5703f4420809c1ab0d14a92cbaaea30b7bf5e04295cbfca14fb386641b72 in /usr/local/bin/ 
# Fri, 07 Aug 2020 18:25:16 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 07 Aug 2020 18:25:19 GMT
WORKDIR /opt/drupal
# Fri, 07 Aug 2020 18:26:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
```
...
-	Layers:
	...
	-	`sha256:c8e5701c27c5067e2ae2f73ccc29bef8d02a8d36628dd7ff5ed96a9392bee60b`  
		...
		Size: 505.0 KB (504970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae9cdb9881cee08998333ca6f838924e3db40942b7faabf68fdf622cb92e7dc9`  
		Last Modified: Fri, 07 Aug 2020 18:37:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b910e206fad58202534483ed0fbcebe69425cbd8728cb6c628fdba2d916365c`  
		Last Modified: Fri, 07 Aug 2020 18:38:49 GMT  
		Size: 20.5 MB (20535315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
