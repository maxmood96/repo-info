...
```console
$ docker pull drupal@sha256:1ae4d55699ba9bcc55c30257ad0ae0769019fe15a1b6a0f09d4281635339b4ac
```
...
```console
$ docker pull drupal@sha256:c3e8be955e94b76490c5a203ae0124b7d7f91dabbc113781207bd7e591fd6e6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186963860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14b82ca03c2c67dde4056a19212aec3ff714c3237e72d785e65f3857e979ab80`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:13:36 GMT
ENV DRUPAL_VERSION=10.0.9
# Wed, 05 Jul 2023 09:13:36 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:14:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:14:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68e6d73802367a8a817d33861633d2eb104a03e4b5b32fe5042e0f2566e579b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c856b71df0869b04436ff1cf2729527acaee97be12886651f854aade4f540641`  
		Last Modified: Wed, 05 Jul 2023 10:04:11 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5544ca2346df860fc5956ab51e392047f9fe9894b23ad543a2138d5f2c6ee12`  
		Last Modified: Wed, 05 Jul 2023 10:04:47 GMT  
