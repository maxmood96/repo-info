...
```console
$ docker pull drupal@sha256:d21ee7b57cdc149b57ef6ead865bc020c7b165e245546d0234a70dfdbf9a3a78
```
...
```console
$ docker pull drupal@sha256:84aa90c0e3a560807ee62bd15c3f95cdff9060942623d32f9668187eacb2890c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.9 MB (160888931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ce9fb0fd5a448632e82f3b40c9f64d7fd23af39ed17bd6281180be0a0284567`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 06:32:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:09:52 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:09:52 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:09:52 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:10:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:10:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:48014f80511b86f94d149e4008a787cccc2e578dce8993779fee6932cd1de18a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ce6c6c622654fd099f03516bbfd79a6172f866e196b008e4cd1ee77fec61039`  
		Last Modified: Wed, 16 Mar 2022 18:31:59 GMT  
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24d9eacd1e60db6c23a211624a031851b244612cd2876e0ae7d5d631fae7d430`  
		Last Modified: Wed, 16 Mar 2022 18:31:59 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0db9266cf72c6a14cc730bd27b324e679f80dd99777e7fae107fe43d4e87c6a`  
		Last Modified: Wed, 16 Mar 2022 18:32:03 GMT  
		Size: 20.9 MB (20938775 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
