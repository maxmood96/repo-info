...
```console
$ docker pull drupal@sha256:a4df6db6fd58f5f7b036740d947e10dba5a27214fa71efdfa8ab0106a62f8fa4
```
...
```console
$ docker pull drupal@sha256:f45c4db77f2e50f95cbcd4eb6a3379b448081697eeceb5fe9e8048d6a9f89b44
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154288980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8621de4fbf730b866f3d07929de48d28d0cf696ad831a27bb4ac84c07f11bb4e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:11:07 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:26:39 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:26:39 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:26:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:26:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ee897161553857abf2ba3776a7114f5b6ac3180db97ce9f96d8a51a4bfe829a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60388f228903ba23ea83fd4812fd3676f71d93dad278456ebdf4dbd378fe26d9`  
		Last Modified: Thu, 04 Aug 2022 10:15:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06b2b0caba6d14eab614ee7ba9a8bda10b611047f8d90fcefdaa8e94cbcc4d41`  
		Last Modified: Thu, 04 Aug 2022 10:15:36 GMT  
		Size: 21.2 MB (21223850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
