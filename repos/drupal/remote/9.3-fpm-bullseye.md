...
```console
$ docker pull drupal@sha256:fea421931e311b8e5591276a79b77d66d965fb6d6ab5f123f30b0602374dfffc
```
...
```console
$ docker pull drupal@sha256:2036cbcaeb0e257adaf0a36ac0eea992bdc74e76a544c688419ceef2925ee403
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.1 MB (184143837 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9c44e2c12040df98d83706c78cfcf67957b0bb3716b109f39ff18ca6f8eebe8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 24 Jun 2022 12:23:18 GMT
ENV DRUPAL_VERSION=9.3.17
# Fri, 24 Jun 2022 12:23:21 GMT
WORKDIR /opt/drupal
# Fri, 24 Jun 2022 12:23:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Jun 2022 12:24:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cd345b3dc97ea78087091898ff83c6f0cc3a94f18d0f1017f4b84d50342b600d`  
		...
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40a845e6af61fdcf47e7ec0d07ec52c0283e6b0f51ba0bedb6198a3fb5ba6b79`  
		Last Modified: Fri, 24 Jun 2022 13:42:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:caa28f613fb8370f637b4b0be082bc288d5a3b4f698a1a0ddb00bfd2f8d1864e`  
		Last Modified: Fri, 24 Jun 2022 13:44:09 GMT  
		Size: 21.2 MB (21216302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
