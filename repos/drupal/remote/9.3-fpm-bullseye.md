...
```console
$ docker pull drupal@sha256:ba8d6ab4311af6ea851f51f2503df77a1aed9a8840374eb540e5be3a38b5111d
```
...
```console
$ docker pull drupal@sha256:541ed3707e38016645d2b16ce059925f1818841a74589adf3866d62be4c4acfe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154280961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f35fff9c0552c41f93e8ce308927cdc20ff79708b42df963e5a3b649bc50032`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 14:43:44 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 14:43:44 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 14:44:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 14:44:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:597073600036408d11d6abc36bdf1e5e8ff2f443da57f979141971c3512c91bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2c24a513aeb333196d3dad37244c0cb6e27a5c45b311821f549aef3e9d362d6`  
		Last Modified: Wed, 13 Jul 2022 15:44:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07d592c8e7b4c9d9207c1bd2e144af45dd087197f36185fd64bf1f896de013ab`  
		Last Modified: Wed, 13 Jul 2022 15:44:40 GMT  
		Size: 21.2 MB (21216607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0a1609616baa01a1a9dcfb64a74636d96a2bc29aed530357e31a034f3c59106d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.0 MB (184038828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2c5d74931af9a5dcba3fc46472ebdec7e31ea70a362e2e55fc0d345fe06d8a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 08:57:25 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 08:57:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:4c44e83b626fc1919053e7883d354fe798351058b4dfdb9f131f7474e5591705`  
		...
		Size: 670.1 KB (670059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26a3ccca40c4828c31a1c101b31ded886fc13a126be2c8cc2986725fc2be73f2`  
		Last Modified: Wed, 13 Jul 2022 10:18:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dc18b2f03c61959fdc4a9d81f5737ea4eff438ad41c1fca31d4eaef8d594d9e`  
		Last Modified: Wed, 13 Jul 2022 10:20:06 GMT  
		Size: 21.2 MB (21216475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
