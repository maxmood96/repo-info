...
```console
$ docker pull drupal@sha256:36791fa8984a96375cf04ec9a3658c916cbccb15ccf4dedf64664667807160b3
```
...
```console
$ docker pull drupal@sha256:15a4700d08ded47a4bbb1ea1d003e426b2921270031bb1ad8a3ab234734f519f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.4 MB (154384936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16baa83f357cc93b89d715d7288b703dffcdf2c602e20977dee6751bcc43ff5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 25 Jun 2022 00:10:22 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Sat, 25 Jun 2022 00:34:08 GMT
ENV DRUPAL_VERSION=9.3.17
# Sat, 25 Jun 2022 00:34:09 GMT
WORKDIR /opt/drupal
# Sat, 25 Jun 2022 00:34:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Jun 2022 00:34:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:259731e0c005b0fd9e6eeaafe2fff3d1fbc2f114f0462ebdb5f7fc2cc438a2b9`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4701f0c534fd6033c214507234850311965d252317124a8f5091e1683fd7a3c2`  
		Last Modified: Sat, 25 Jun 2022 01:20:14 GMT  
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17933cd2620d90d3fbda048aac5850735ea15f461029c49b49d40f37ffb46640`  
		Last Modified: Sat, 25 Jun 2022 01:34:05 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6258978001a947bc0d47e62d074b9646711ea3443ba3f3a0583042d34593c5c5`  
		Last Modified: Sat, 25 Jun 2022 01:34:34 GMT  
		Size: 21.2 MB (21216298 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
