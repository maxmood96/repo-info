...
```console
$ docker pull drupal@sha256:559c7695f0f8ddfce82a1cc49076058d7cda990d0196deff0a387bbcccd715ab
```
...
```console
$ docker pull drupal@sha256:bb09c8881fa8c51410a007ca964d34fecf2e1623540dc753906f4f919113cc34
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.8 MB (48835841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bd38fc0e86f7585a03907778de1cf9cedc895665394e2c017122f30ef5bb0bf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:42:53 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 18 Nov 2022 01:52:36 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:52:36 GMT
WORKDIR /opt/drupal
# Fri, 18 Nov 2022 01:52:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Nov 2022 01:52:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1aba434e91ac205c7b103469ec5d0391d2c8bc3afee783b5c2ab6e262cff81f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d144d43f65b94fc34569e4e530b12269f8a9b3da402c5efa445fa27c2ddd6bf`  
		Last Modified: Fri, 18 Nov 2022 02:00:34 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff497f0419e36ed4d4090bb2a36940a9b7db5d5e4045953356f6820078f55c2f`  
		Last Modified: Fri, 18 Nov 2022 02:00:40 GMT  
		Size: 17.7 MB (17662673 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:96e9e4fddc4fc099986b5b9158001074871841a7b29de4d32658a59c2a03b529
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48431713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41f0684affe901af4d94263dbe3e69ac24f99fdf81cf9c339c971092ebf09a98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:46:17 GMT
WORKDIR /opt/drupal
# Fri, 18 Nov 2022 01:46:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Nov 2022 01:46:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a49f672a0e5be1f03011a48df3f352d86c46f16687b1df86fdcf3afadab44f27`  
		...
		Size: 695.2 KB (695181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b0cc7264fca9f0e8c3cc8f93ac1db424074884ccdfb709cfb19b0bf2e8ad7a5`  
		Last Modified: Fri, 18 Nov 2022 02:01:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0255fbc5e8f361c712cabfd7250e341a65510e8bc74c3134964c27cdf538afb`  
		Last Modified: Fri, 18 Nov 2022 02:01:15 GMT  
