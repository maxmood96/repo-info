...
### `drupal:8.9.8-fpm-buster` - linux; amd64
...
### `drupal:8.9.8-fpm-buster` - linux; arm variant v7
...
### `drupal:8.9.8-fpm-buster` - linux; arm64 variant v8
...
### `drupal:8.9.8-fpm-buster` - linux; 386
...
### `drupal:8.9.8-fpm-buster` - linux; ppc64le
...
### `drupal:8.9.8-fpm-buster` - linux; s390x
