...
```console
$ docker pull drupal@sha256:75136f36550f899d989e13f14697e1a07cc9b193ee4795164716e9e1c4a5e79e
```
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
-	Layers:
	...
	-	`sha256:8a0f1384c51148597f04e6f1f679b3fafc94b418c31c1fe9b986a5ed176a99bc`  
		Last Modified: Sat, 21 Jun 2025 12:50:14 GMT  
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; riscv64
...
### `drupal:10.5.0-php8.4-fpm-alpine3.22` - linux; s390x
