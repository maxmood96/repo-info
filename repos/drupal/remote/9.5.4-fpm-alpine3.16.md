...
```console
$ docker pull drupal@sha256:45305250d23260a6f64196e0cb9c804dac825d530c26733f32f9e6f650a034ee
```
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; arm variant v6

```console
$ docker pull drupal@sha256:733f03ed453cf24ce69c2aa5946bed66ee183c9e1c9fa8d6c19380bec2aeb5da
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52579930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9d5eb0f4654ebd96975fd7ad7b3e808f2bd9682930638646a2658ca6b859fc8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 01:23:09 GMT
CMD ["php-fpm"]
# Sat, 04 Mar 2023 02:12:04 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 04 Mar 2023 02:12:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Mar 2023 02:12:04 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 02:12:44 GMT
ENV DRUPAL_VERSION=9.5.4
# Sat, 04 Mar 2023 02:12:44 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:12:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:12:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9b804357f0c15afc1215895f6bb3fbc1934fda6245435b8bf2fc1ff0923e515`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cb5d63958c1cbdc3a793e6689035f0e82941c5fe9302bc045dec9f19570c903`  
		Last Modified: Sat, 04 Mar 2023 02:20:12 GMT  
		Size: 1.7 MB (1657908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d0d545a704189c702212b5e3f379ffdde64e2d9fdf5779138ac60b1c30202c1`  
		Last Modified: Sat, 04 Mar 2023 02:20:11 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7fdb1f4f79723871b3aa65bfe2027cb7faeb825232fdc77c8c7e0ab4d31c6c9`  
		Last Modified: Sat, 04 Mar 2023 02:20:12 GMT  
		Size: 697.1 KB (697143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f271b2893e8cb136489658afcc2fd16fe3ad4a300b4410560422b2bf194b3e1`  
		Last Modified: Sat, 04 Mar 2023 02:21:25 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85b1fac380aab4e127e59c16fd5e65f8c7fcad00e671f082291e55a926806554`  
		Last Modified: Sat, 04 Mar 2023 02:21:31 GMT  
		Size: 22.8 MB (22836856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.4-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; 386
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.5.4-fpm-alpine3.16` - linux; s390x
