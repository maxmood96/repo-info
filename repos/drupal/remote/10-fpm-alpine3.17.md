...
```console
$ docker pull drupal@sha256:27e30cec5d6e7635d450f8dbea04d68693bb1e107b30dc2472301765908bbff4
```
...
```console
$ docker pull drupal@sha256:9861c2b5a4050be11b78ca31c32f6cb29287091da58266f2d29e82b499ccd76d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51558614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3070e5c81a75b60f66dd7afdbe31f7434acefae52db88edc7b3e7ee86963d18d`
...
# Tue, 05 Sep 2023 22:40:34 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 22:40:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 22:40:45 GMT
...
-	Layers:
	...
	-	`sha256:ae68164c9d91086e234a5c86b95dba3b86aa85eb9e3233545fece29bb8a5d3c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9f83fde698e68f23fcaa4134c1e34db7265f523c8f13bb68b25843e284c02d5`  
		Last Modified: Tue, 05 Sep 2023 22:56:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6000f755490c022fcd4add4ffa0eaf9ff0661fe21970db16029bf60a3ebc604`  
		Last Modified: Tue, 05 Sep 2023 22:56:37 GMT  
		Size: 18.5 MB (18506922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-fpm-alpine3.17` - linux; arm variant v6

```console
$ docker pull drupal@sha256:5de05f6f120895f31f64612319a11e47f91c040dfaee5b693e738227a3c90588
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.6 MB (49565298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5426037763595aa50c62565d72e44ffce8b74b8b279d7f44e81e1fbf72d4f7c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 23:13:02 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:13:03 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:13:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:13:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb2f5e7a14812352538cdaa481b1c6dac95722695eebe644f600900db049aa83`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1947e66f752d0c1756a41980f4d54172bc649e030208f8f79f230a1482a14fe8`  
		Last Modified: Tue, 05 Sep 2023 23:20:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cca60c5440c6c7be9441a9ec6f74058fec4062929cd0f95fddbdddf65f366a4`  
		Last Modified: Tue, 05 Sep 2023 23:20:21 GMT  
		Size: 18.5 MB (18507190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d9ccd904756201f2f97c32ca609647dc26ed80e66a4b837bbaf13f99489a2d6a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52097136 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f1a4fd4a04f59f2e1d7f0bf3834fd97d08ac407eb6da351ca36d12da2bf0291`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 21:56:31 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 21:56:32 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 21:56:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 21:56:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b4b051cd82cf280f3a5dcd03db451b506a73ec4edff91220bae6a68997365bb7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e5dd12ebfb905af7de93d91476cc8f6e121106317001a735319f7a64aa1f60a`  
		Last Modified: Tue, 05 Sep 2023 22:15:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c957bbeab03ee9fb532cb2bb1ae49dccc501bb0d228e253791ee3cf5ce3fc27`  
		Last Modified: Tue, 05 Sep 2023 22:16:03 GMT  
		Size: 18.5 MB (18506895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-fpm-alpine3.17` - linux; ppc64le

```console
$ docker pull drupal@sha256:6c36b003f5dcd9286ade16a6af5a7bfa810eb3b06141ba1869b92e4215c31e4d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51797858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e973c10f678f162ef4512732372ce9bd04fa4e6a02fd443b161b4b27c80edc8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:25:27 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:25:27 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:25:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:25:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7d3dc854f3f99f875649e95cda84ee930d132f22a960af745bcb20ed6439c244`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0cccf915a31b10c8653ba28fb62b7d90c8a542ca4238b300e5ac8626fa04e63`  
		Last Modified: Tue, 05 Sep 2023 23:52:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:104e05d0ed6583686c9c1a098313543b83e208554d821397aff9614f7b86ce9f`  
		Last Modified: Tue, 05 Sep 2023 23:52:48 GMT  
		Size: 18.5 MB (18507163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-fpm-alpine3.17` - linux; s390x

```console
$ docker pull drupal@sha256:7e2e2a62ba4016059d19adc8cde7a0e4c43a6b72aee646c587b9e094627d7983
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50140079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77eeaca96a8b06af86c0543b42119e3c7bdd9545531f6291f9e65f88534c72ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 23:24:10 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:24:11 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:24:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:24:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:11d129b17727f11b354a696cfc7c01e86882b42cbb324fde3e07e0c488d31f4c`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d414377e376843e3ae17851fa1ab79d2882b18e8f246b5366089a448bb0a432`  
		Last Modified: Tue, 05 Sep 2023 23:48:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbac4a872c8d8611f9e83bc2dfe1e00a58c76631b971fec4a6e6b963bec61082`  
		Last Modified: Tue, 05 Sep 2023 23:48:47 GMT  
		Size: 18.5 MB (18507192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
