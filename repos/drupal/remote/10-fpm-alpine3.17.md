...
```console
$ docker pull drupal@sha256:6ca3bed397c64f703364c9e912fe03eefbccd58d9687af9c168818f248e02d6d
```
...
```console
$ docker pull drupal@sha256:33ca05cea6ee730edfa6af8cbba6eae97e95aa4cfc5ba3dc7a57c1961c594cab
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48665781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8e3fdf88b79e5cf24975ee3f0d6731b9d38c461558c062aa1e555a4a20f901a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 03:07:14 GMT
ENV DRUPAL_VERSION=10.0.4
# Tue, 14 Mar 2023 03:07:15 GMT
WORKDIR /opt/drupal
# Tue, 14 Mar 2023 03:07:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 14 Mar 2023 03:07:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68b3e879bc7454548971ed30a5960df03fea6ff94db3059e65edb70bd90bc0aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1c2764eb0d43adcf83eac5e78c7b395e74a74367b6264f541f2f4516915403a`  
		Last Modified: Tue, 14 Mar 2023 03:16:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56b6e2a9c08c15ccf81b6df56c2865bc52b8fbf2d81b6856bdbb62ddce2bf3c2`  
		Last Modified: Tue, 14 Mar 2023 03:16:15 GMT  
		Size: 17.7 MB (17650027 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
