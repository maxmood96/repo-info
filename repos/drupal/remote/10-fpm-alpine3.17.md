...
```console
$ docker pull drupal@sha256:2ddeadc2944921d99304fdb49069fb1c6f16d30b6d2a7df8a49f3bb2f972373e
```
...
```console
$ docker pull drupal@sha256:1989aa04779cba858d9d8476632b66559453100facd3ca2e442707f533f60507
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49477673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24b56ae8a95339994f5eda0df3e04f1a1df248fcd861aec22b57674123f07853`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 13:39:33 GMT
ENV DRUPAL_VERSION=10.0.7
# Sat, 25 Mar 2023 13:39:34 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 13:39:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 13:39:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:be55681b5bfde110436477deddace828c61b307a2f1f0af0edd35a1f3c956d64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78cbcbdef3236fbac39844de7502a79c0b8e9c714491d10e9b0519de6797e227`  
		Last Modified: Sat, 25 Mar 2023 13:48:25 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73c1804a91b0ba41c542f684edc228f7096795edd64e721c41f3e076f64e592c`  
		Last Modified: Sat, 25 Mar 2023 13:48:28 GMT  
		Size: 17.7 MB (17662998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
