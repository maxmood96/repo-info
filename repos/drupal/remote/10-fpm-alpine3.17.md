...
```console
$ docker pull drupal@sha256:b838c66df6a7bb48840f01c23fa44dcc5bc9925617ff8f1ebc0d709063d3d9b0
```
...
```console
$ docker pull drupal@sha256:0e126e10fb0e72364ab7be077af65e5a7269dcad3e417518371d51510933fa12
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48328520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b23a1361a50678fd01a060736bda918d8747afcf5cc73ef7ccd460560d83213`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Aug 2023 23:50:04 GMT
CMD ["php-fpm"]
# Fri, 18 Aug 2023 01:16:24 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 18 Aug 2023 01:16:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 01:16:25 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 01:16:25 GMT
ENV DRUPAL_VERSION=10.1.2
# Fri, 18 Aug 2023 01:16:25 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:16:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:16:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:75e8972d7c61b9f0c94f4e78baf272f02f4d798b82c76bfff22a971cbad57d54`  
		...
		Size: 9.2 KB (9180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b677fc28a88e5c13ec73ff807051ca63a21cef56717e8e6be8e27561498cb918`  
		Last Modified: Fri, 18 Aug 2023 01:27:58 GMT  
		Size: 1.5 MB (1546950 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f1aea389ddce98313b8587ce3bc315af7ad9c47e79e8eea92c9fffad8910ad4`  
		Last Modified: Fri, 18 Aug 2023 01:27:57 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cd99e2f8662e786b17185a37ce9c8bf13d753600f486dce37de548d8690e829`  
		Last Modified: Fri, 18 Aug 2023 01:27:58 GMT  
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c89a416eab15cf3fb18f076bf28a390426f26d4c21b98f39d6b77f6047df2da3`  
		Last Modified: Fri, 18 Aug 2023 01:27:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b136739b5baf48e1ad2e362bb8babc170d4fce09eb96a1615a686c866f1be5`  
		Last Modified: Fri, 18 Aug 2023 01:28:03 GMT  
		Size: 18.5 MB (18507007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:4d818553550cf629552f833057ff97f9564f60d1391d4462d6f38a254211de22
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50128705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1865024bf9485ab07f43d0842878d13a2546a238c11bd4cc451a1f7c8067b988`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6e3bd30610609cbbe9a4b4de091cc328c15eb22fe83ba02b0732bb5aafb83234`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1b9104cfe20e6bd8ba5c803b66046fbd88717f22ef5800f9f3ccbc89964fa2e`  
		Last Modified: Fri, 18 Aug 2023 01:03:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3eb33f44cd07c014a2442b15c83ebe8c497e2b98bc1d9ad3cf0d9858f0efc75`  
		Last Modified: Fri, 18 Aug 2023 01:03:30 GMT  
		Size: 18.5 MB (18507056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
