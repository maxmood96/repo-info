...
```console
$ docker pull drupal@sha256:a56008394351947e4568cf553aeda37a127f180464589cb2d06b0958a1a99593
```
...
```console
$ docker pull drupal@sha256:f985f996f7fed5299e2ead21be4a250ee2a6f55e989112bbc857818db52cb9d8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50782715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4b1547609e2c1c0a6b3e95012538ade6f98d221d5acc1cb93412c427070bd6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:24f3e0cef2d71dbf74ba2166c492612767ea893f4d247b44d5ac8b7ad945530f`  
		...
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:acfd11bc24f523288024c9efceb21762266d3e2cb88a5317ba4d700964f11dda`  
		Last Modified: Wed, 24 Jul 2024 20:59:24 GMT  
		Size: 19.2 MB (19201605 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:rc-php8.3-fpm-alpine3.19` - unknown; unknown

```console
$ docker pull drupal@sha256:47ebac33f69c5f102482bbc5c39fabbaeb09e352f5d4a583c64c372dabba576d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **378.2 KB (378171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d42f295a52e376a2c0d74e995eeaf7e3f04b6dd2cf4d4413886088fc6a464e33`

```dockerfile
```

-	Layers:
	-	`sha256:042f90bfe5bc0306de5220bda46db6922e85d33cd76f0d698f5df3e7bc0e0b99`  
		Last Modified: Wed, 24 Jul 2024 20:59:20 GMT  
		Size: 347.0 KB (346955 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7576e0b1904430ffb11b53251025205684438b0be60237e76a35fb5d2a61fce6`  
		Last Modified: Wed, 24 Jul 2024 20:59:20 GMT  
