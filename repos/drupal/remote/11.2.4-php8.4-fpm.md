...
```console
$ docker pull drupal@sha256:2e9a8ee047705e0ee64afad2cb7ffa70cf4af32c32ea486e0d6b974513b619b3
```
...
### `drupal:11.2.4-php8.4-fpm` - linux; amd64
...
### `drupal:11.2.4-php8.4-fpm` - unknown; unknown
...
### `drupal:11.2.4-php8.4-fpm` - linux; arm variant v7
...
### `drupal:11.2.4-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:11.2.4-php8.4-fpm` - linux; 386
...
### `drupal:11.2.4-php8.4-fpm` - linux; ppc64le
...
### `drupal:11.2.4-php8.4-fpm` - linux; s390x
