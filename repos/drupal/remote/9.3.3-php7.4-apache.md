...
```console
$ docker pull drupal@sha256:dc8a421deaa4d463cd0e1eafdf56facecbb165b496f3184809a20ea669e1b22b
```
...
### `drupal:9.3.3-php7.4-apache` - linux; amd64
...
### `drupal:9.3.3-php7.4-apache` - linux; arm variant v7
...
### `drupal:9.3.3-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.3.3-php7.4-apache` - linux; 386
...
### `drupal:9.3.3-php7.4-apache` - linux; ppc64le
...
### `drupal:9.3.3-php7.4-apache` - linux; s390x
