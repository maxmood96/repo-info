...
```console
$ docker pull drupal@sha256:fc8ff1093894c0e261028c3e1e5220779b4fdee0130a1331b9cb39239f78c9ec
```
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.12-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.12-fpm-alpine3.23` - linux; s390x
