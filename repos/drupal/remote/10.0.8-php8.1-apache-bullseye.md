...
```console
$ docker pull drupal@sha256:6ef07a4c3302898ab5c7de72fa0d7b2c39597cba252bac12d03e2674171340ce
```
...
### `drupal:10.0.8-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:10.0.8-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.8-php8.1-apache-bullseye` - linux; 386
...
### `drupal:10.0.8-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:10.0.8-php8.1-apache-bullseye` - linux; s390x
