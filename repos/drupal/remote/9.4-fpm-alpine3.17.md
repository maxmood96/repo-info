...
```console
$ docker pull drupal@sha256:f059ee501e4c3830a4885f21354c174aeb4cbba4a4e14d9f891d3f7d903c0b2b
```
...
```console
$ docker pull drupal@sha256:d6856991ab839f0153a174576a2bc9f59127eb244946aad5d557a69dbbb14b4f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53252204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd30c95c75f3fdf2cbb9ca75fbb288c73cb5a10cbd478b56d16bef1321a7a373`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 20:11:40 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:52:10 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:52:10 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:52:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:52:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01d7694b0856a4fdc4ac5455b64e6dbbc573b07678f071e7e64fb92598b2b18b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac355bcd4eb731ecfe9f4d4c5f5d40fd3d1464442e713fba89a092db3f09dc08`  
		Last Modified: Thu, 20 Apr 2023 23:01:07 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:894744400b70fe7c12e36bd2d7b0fdfdb5828f369eb0dc4bd7e827b43084e38c`  
		Last Modified: Thu, 20 Apr 2023 23:01:11 GMT  
		Size: 21.9 MB (21907577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
