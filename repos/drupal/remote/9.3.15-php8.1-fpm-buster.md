...
```console
$ docker pull drupal@sha256:eb9cd6d42f228787f6e8f3c71c8d3c95c9880fa037959e3f69185fbcb275183f
```
...
### `drupal:9.3.15-php8.1-fpm-buster` - linux; amd64
...
### `drupal:9.3.15-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:9.3.15-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.3.15-php8.1-fpm-buster` - linux; 386
...
### `drupal:9.3.15-php8.1-fpm-buster` - linux; s390x
