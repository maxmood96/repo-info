...
```console
$ docker pull drupal@sha256:f8f2196eb180ba90df855d992c78b0bdfb478d29330185c8dbf85ea86b359fca
```
...
```console
$ docker pull drupal@sha256:fba110c867ef89c70f71166d30dadcfe249afd67f872b3bda9b50367da7dd8a5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51465507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3a4ac8b24f818b0ccc58d33554f825fc03102539a8603ac2740ffc5b5f12dbb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:50:00 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 16 Dec 2021 23:50:00 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:50:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:50:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed76d2a73cc557a96b68bb65bda45e53c5be5e50d671ebc564996156b30d35a9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31cdb2faa44aeef55394c267191e339b3dc34b2e6af3145342585dc416c09c53`  
		Last Modified: Thu, 16 Dec 2021 23:59:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d68b324ee345e14016eaec88327c43e68dcab8540d1e4f0b221a7f54e1771e1`  
		Last Modified: Thu, 16 Dec 2021 23:59:51 GMT  
		Size: 20.1 MB (20136589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:20d57ca148269361f89723eea8e2673e6fe975668b1faf82a815816278d4f056
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52092116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d46a6d2f7ef477383d2401782a45beb1f29a2b7ada747b5dc612447c79eb2990`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Dec 2021 23:31:24 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:23:10 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 16 Dec 2021 23:23:11 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:23:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:23:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b52b7f9110aab131c0ff6b1d446c445245969c17b09d4be8a4d832cb3d623248`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab54d92aa233702334138572cec029dec1febf5b854b59340f45571989e91b6a`  
		Last Modified: Thu, 16 Dec 2021 23:42:49 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e62b1b7849cd303ef23b27776081884a412236deb35326f0b0b2767b1e2c585`  
		Last Modified: Thu, 16 Dec 2021 23:42:54 GMT  
		Size: 20.1 MB (20136568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
