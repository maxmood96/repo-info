...
```console
$ docker pull drupal@sha256:6bc409d231aa377e47c38c3714a56fc77f7880c96ec8346fdf2d54f81ce77c04
```
...
```console
$ docker pull drupal@sha256:1f5998d7d8c38dd963116b8b50309a32c609909f058211638b7f35a62be73cbc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53528059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc95ca85156dda04ef038ce9b8cda6ab939cc31c332c04a5a324b435c36fc88b`
...
# Thu, 06 Jan 2022 20:24:08 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:24:08 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:24:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:24:22 GMT
...
-	Layers:
	...
	-	`sha256:8a443cda7781ee292ca0c3cfb9256ba6b3283fbb2a4d2ffff412187e182560e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2249ed8650febcd4e7c81aa75eac41818389cc553438319e364c9e7bd1634a44`  
		Last Modified: Thu, 06 Jan 2022 20:32:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12bd04bad4e6f9747c964da26d34135666e4a6a53088b2886788b7df908d447b`  
		Last Modified: Thu, 06 Jan 2022 20:33:06 GMT  
...
```console
$ docker pull drupal@sha256:2fe28fffa52cbf2155f33ef47edff20c0096243c33807ba0bfc55958fe2df324
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51487494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41ce7effcba3f858a66d49453d43d168b12539fe42aaab2c4ed2cf9758c3745a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:00:01 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:00:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:00:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d42cb1642e7725e855959914a8c0b92d102897f3cb04d61db546c56de60ab9b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e49c0faaf12056ccf2ef119c2b6b2edbc94cd2757530c4066922315c7850b07`  
		Last Modified: Thu, 06 Jan 2022 20:09:26 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e36265b05963dfeb242ef39f961028150b43b5f4055c5962df6fa21e87979144`  
		Last Modified: Thu, 06 Jan 2022 20:09:55 GMT  
		Size: 20.1 MB (20142159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:2c902189a94d3d795ba801010089cf79a46d19059eee643465128b3f1801e11b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50127524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9d85d3616d08bfd54e3bc53910d95696346252c24b228ab41a34a29c5b743f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:12:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:12:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d2cb868f9b2d5e232bb1ac9a11dc77283e8b574efd4007c8ee27c82e9fcc61ff`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe1be1f29d8d3a153e3e2eac7fece4026a6010c88893c98afab77feffb8379de`  
		Last Modified: Thu, 06 Jan 2022 20:42:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31dea7d6c75055364111d7ef15f3c6c3f9735f7b31fcc6df54a94f0862aaed32`  
		Last Modified: Thu, 06 Jan 2022 20:43:27 GMT  
		Size: 20.1 MB (20141633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e512421aaa85aef0054995e2d6c3cdb0eb70f48c71557c97d80751d1f3c7bffe
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52507592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c08b11b0fd2686a0c1bc347d0d246cbd30d68a2fb31c92b4299e48346804f3a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:47:27 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:47:28 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:47:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:47:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d97dc3d4933e966c3808f27e271cf0023dae801bc56a3ad5574f51b8272b6895`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d37901e348b572768933bd9fecc944fa6e816aba7b3fbe70628f30df2600fb03`  
		Last Modified: Thu, 06 Jan 2022 20:04:14 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4f45e79990750b2a76d8de40537bcf215cacb6c822b798a19e270a0a4caa58`  
		Last Modified: Thu, 06 Jan 2022 20:04:19 GMT  
		Size: 20.1 MB (20143557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:8414ea8f7fd2dd188c6a8833855769dd79da88bcc3abed909fbdea3fc255685e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (53983715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c1191d704933cd90f1090a637a17ad90a8a6b054aaec93a256454040867c601`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:46:40 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:46:40 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:47:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:47:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc4098c0e74d5106838eff6e1309a3f349fb853a16a286f15b0cc69b4711f61a`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53fbed4496c47dd95d9b2beed5ceeb4de5072ce9aadc295bda16d027ffc5092f`  
		Last Modified: Thu, 06 Jan 2022 20:04:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b03ed8c5a5dede1d1f0cb3e1015840fdefdae2d4559de9a288c9b07c7d5ca47`  
		Last Modified: Thu, 06 Jan 2022 20:04:56 GMT  
		Size: 20.1 MB (20141471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:d53168b15500a7b3ce826ef5120db96d9384d868b9c0a56f75bb6162985a18a6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54227983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfb00ac82f38e06c897a16cd8edcdb815e720f57011c179f54c71d6567d2950f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:26:37 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:26:40 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:27:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:27:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6c408fbb5e53ab3bbc7da637ee2d128f66845e5acdee46b75da6ec06d7374a1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65ec63857eee398f10547a9ba562cb1ef418e994753728ba39686e27c7676074`  
		Last Modified: Thu, 06 Jan 2022 20:46:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c64c0867b2e5c9ed1fac952b4a0d6eca1f950fb5a83754e42e228a0545a1bbb7`  
		Last Modified: Thu, 06 Jan 2022 20:46:57 GMT  
...
```console
$ docker pull drupal@sha256:4523b241b688bd48dfec659ee161c07329142085904a1a2e083a9094e8d2a680
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52112138 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77a622b10c5fc26e409b65b537d56c401b7347a78b3504617199e988cb365469`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:54:16 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:54:16 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:54:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:54:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1b588ae8e585282da19bc1905b2c72633a90f8f87ff5a793959760c408750f8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bd8cd0350699061089a79d1081c1466a7c8f0f8f8ce44baa7668e57940ab2d7`  
		Last Modified: Thu, 06 Jan 2022 20:08:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7621cdb16bd8918ce69f0f98789de789a87dd38cc3fb691e742aa6784256c848`  
		Last Modified: Thu, 06 Jan 2022 20:08:11 GMT  
		Size: 20.1 MB (20141510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
