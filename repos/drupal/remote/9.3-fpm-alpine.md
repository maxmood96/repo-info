...
```console
$ docker pull drupal@sha256:f983b4bcda19acec28b499ea9191c9222f405a1cd1ed9709ffe252090f5ac588
```
...
```console
$ docker pull drupal@sha256:5b643a42498ee8ee116c361d474ff89799ff62db41953680220b535e9e8ce6ce
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50397468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbb79458095fb219ef7751c4a24af9dfa9f3ef3836d7fea41b44446e9603e823`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Sat, 12 Nov 2022 12:15:29 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 12 Nov 2022 12:15:29 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 12:15:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 12:15:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f53a670458008633629e0866bbaaefbe89118f91af74e37573b9c3c990ec2330`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15675b65e628aefdc544ac2802e3a7e67ff0481a2f2736ca3815a9742613bf22`  
		Last Modified: Sat, 12 Nov 2022 12:27:24 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ccd9a87f5d3bdc42c0e06dbc771c159d0dccf4ebe9000491231a7031b927ed2`  
		Last Modified: Sat, 12 Nov 2022 12:27:31 GMT  
...
```console
$ docker pull drupal@sha256:f70747edf5ffe3cfb223d40fcc40e7fcc2dff0c0af66350de665846aa6c25528
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50523735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:136dd867501aa3e5fb02676ade78f1e6515efab87aba54d1400c1fda60d58cfa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 15:11:49 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 15:18:24 GMT
ENV DRUPAL_VERSION=9.3.22
# Fri, 11 Nov 2022 15:18:25 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 15:18:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 15:18:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:46de049724cac6f48b4cb91547e81456001c6fed6c465ffc487ee240dd386578`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2a5a970dd893fd61524e21a186c570f21036cf68b57715e6aad40ec63539c16`  
		Last Modified: Fri, 11 Nov 2022 15:46:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e99b2b371939de9640fbfc5493a703535c103402111804fe264169ee9a10bb`  
		Last Modified: Fri, 11 Nov 2022 15:46:28 GMT  
...
```console
$ docker pull drupal@sha256:d16c419a191af8bc028d9e1e26dcd652f03754b2733f9c1e990e5dd1f1c65452
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50951834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e194d90ee3db7d710b89c412a318d0813f1306310ea2e0b91b8425fec71ff67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Sat, 12 Nov 2022 12:47:33 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 12 Nov 2022 12:47:34 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 12:47:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 12:48:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b126ed06869738897fe94c5ef5d7972ab2e090f1b98e166c49d4682e4caba636`  
		...
		Size: 695.2 KB (695182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94283502ec36596b4b8211cb9e0b9501ab3e951a7a15f768f1e0ae784b671c07`  
		Last Modified: Sat, 12 Nov 2022 13:06:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81e8cf6e567b3cde4209fc76032ae3703622a9835307fb805dfb0d154459d458`  
		Last Modified: Sat, 12 Nov 2022 13:06:53 GMT  
		Size: 21.3 MB (21314926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
