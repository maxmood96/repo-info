...
```console
$ docker pull drupal@sha256:263d4f3c1e11c4df987014d8b1cbdea9c65cf2fb9c9c3251a0dc593508d214ea
```
...
```console
$ docker pull drupal@sha256:9d4698eab7f4c84aa52a8de8ed9ba12aa4369f0356508bb77db1ffaf1f43ed0b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49141267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70eaba86fd801ff5f35586ed6d30d7c7fa42302215fb27b4cea4778a36d03ba4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:11:17 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 22:11:17 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 22:11:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 22:11:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2a95908b105e564348d5b8b6eaf8a23fd5d8b6f071590722be1a14de7a8d02e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:136529a85cd60d4bb67abbe70f0cc3f23e0339a5dbb774327e9778e9951ebe29`  
		Last Modified: Thu, 29 Sep 2022 23:00:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6eb2bfa107fee98b8277f98a759fad43bc7fbc543076898c94a830f2b64fbdbe`  
		Last Modified: Thu, 29 Sep 2022 23:01:05 GMT  
...
```console
$ docker pull drupal@sha256:66546fbadb26496fa4d92b1492b165c98c2135d1c8f384a8b84ff1ff7cf28da8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52627555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:056be8ccafecb84b8ff5b7924d47861621b1fd9153de60213e762f007be8a605`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Sat, 01 Oct 2022 00:20:39 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 01 Oct 2022 00:20:40 GMT
WORKDIR /opt/drupal
# Sat, 01 Oct 2022 00:20:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 Oct 2022 00:20:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d702e7699abbf24650cb0168d2452ff1d8b28400896626ead990079582d2de8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369ef5f343e14469f02417e5397b66de12dae4ae7ee24952a5804f920282a63e`  
		Last Modified: Sat, 01 Oct 2022 00:44:25 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa2f91a348fdfc4f315fe09999707a81932e14a150e598be9e5153077e561acf`  
		Last Modified: Sat, 01 Oct 2022 00:44:31 GMT  
