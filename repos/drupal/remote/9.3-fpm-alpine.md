...
```console
$ docker pull drupal@sha256:21e19f756ec06d6d4c6200282d40695d885c1f5748167d2664bf080643c55508
```
...
```console
$ docker pull drupal@sha256:8c981c1b16fd26a2937eabdf76c290fa186aa94361190730533f10e797fb8f7b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.2 MB (48233055 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:144d54b90684e8a30d66dcdc7a23d64ba01e63f55d065dc39e9fc24a91168687`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 18:04:49 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Thu, 03 Mar 2022 18:11:36 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 03 Mar 2022 18:11:36 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:12:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:12:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:530ff90fa8553dce59fba549affce16f12956c7ac4e4e2fc3de086d8df14ac14`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fe246d32679a72aba80a782edd0e33ca378bb2066ad5f2868e8121c7328a06d`  
		Last Modified: Thu, 03 Mar 2022 19:12:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:764e0ff985fbcba6d2a76757462b2a32e25a9e7efd34b3f4990a0eac4a126be6`  
		Last Modified: Thu, 03 Mar 2022 19:13:02 GMT  
		Size: 20.1 MB (20118874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
