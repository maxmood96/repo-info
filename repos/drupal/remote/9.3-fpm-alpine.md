...
```console
$ docker pull drupal@sha256:adae93356e900ef18a6e7552ac9902d13f15efcffc1f8153408fc2d535bbdad8
```
...
```console
$ docker pull drupal@sha256:fa6a45bd750be3d85b0b85fe9d6e65ff9be114764289007796cdd40156791263
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49296210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:525f94357e887fb34bd667aab61fd434b455c8c9be8b5d3c06282581066396d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:8cc5d2a1486028d8ccea4f88ff5dee13be4d03d4fbaf8bc71459b56627ce2c88`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15877637358c0c53e5c30e1cd30f84eb924bd6fc077a16114c256948f3447fc8`  
		Last Modified: Tue, 29 Nov 2022 07:30:52 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae2dcba8295a54e7e98df0068ab3783f6699aeb1301cdd00968ccfcc1ff689c5`  
		Last Modified: Tue, 29 Nov 2022 07:30:59 GMT  
...
```console
$ docker pull drupal@sha256:8bea6598c30adac7eceeb1a82495665050b25be3fa2a3b5a541597828ddcb361
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51272747 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40acfbbdb3763b2c1e48ca7d8299e126eafbd6681f26e41b2371929c536a7f03`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:03:32 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:08:31 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:08:31 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:08:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:e3c05e538bc8ddab44139edffef44e46a5b10f063227ee788a38bf509aebe545`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a65fb64904d543203388d7716afbc51ee91bf0d9a06ed813e28d477bef7354e`  
		Last Modified: Tue, 29 Nov 2022 06:28:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ed15225d6d0c37cfdee331128ec1ee441537795a23a13d570c3e63aae24458b`  
		Last Modified: Tue, 29 Nov 2022 06:28:40 GMT  
...
```console
$ docker pull drupal@sha256:e89dde9ed1dae760da2f7527eb1b2126e61844d2124356080e3973a3e02983e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52548866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0deb6c4a739f83d081186257a00de47ebaaaefe68e8e1281c02ab00196c1a19e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 07:04:02 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 07:11:06 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 07:11:07 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 07:11:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 07:11:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1ba18d2ec8d95c753a430ce3c4dc6dda31212573d3bd28470ff29b3bb8d7a5e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:820e744d548357dd6cea855ab6d42f3221c29a63993e3bd40d1e004865385611`  
		Last Modified: Tue, 29 Nov 2022 07:42:37 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b7873b9ddd9da43b6dfeea31e632382f100159dd0bee79b77e8547fc710b818`  
		Last Modified: Tue, 29 Nov 2022 07:43:01 GMT  
		Size: 21.3 MB (21314765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
