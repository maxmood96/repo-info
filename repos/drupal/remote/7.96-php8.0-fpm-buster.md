...
```console
$ docker pull drupal@sha256:ae053e098b9a0d9960e6ccfe7987961f6a9d5deb4df65107625cb49941242c8a
```
...
### `drupal:7.96-php8.0-fpm-buster` - linux; amd64
...
### `drupal:7.96-php8.0-fpm-buster` - linux; arm64 variant v8
