...
```console
$ docker pull drupal@sha256:25a441e26e15a1fffb65a5061e9abb63192bd3c48a5b61f1a94d082572a6052e
```
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.2.6-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; 386
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.6-fpm-alpine3.21` - linux; s390x
