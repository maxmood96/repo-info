...
```console
$ docker pull drupal@sha256:8b114f005bc9b8e85b19e2d332ffa57f369ae0a04537badeab599115c6000ed1
```
...
### `drupal:9.3.8-php7.4-apache` - linux; amd64
...
### `drupal:9.3.8-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:9.3.8-php7.4-apache` - linux; 386
...
### `drupal:9.3.8-php7.4-apache` - linux; s390x
