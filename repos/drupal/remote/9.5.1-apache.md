...
```console
$ docker pull drupal@sha256:94458697141ca3ad2c6cfce6845242e4cf09b7b4065ad1ff50b1768b35d4ba01
```
...
### `drupal:9.5.1-apache` - linux; amd64

```console
$ docker pull drupal@sha256:9fad2804a85438be08eaf475c278911cafb2b10c91faf5bc00225d11b3ca5df9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.1 MB (191100283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89a8f0eea2e038914bb468b2c81268f152183daf1e0f89cb3835952b34f10733`
...
# Wed, 11 Jan 2023 22:58:29 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 22:58:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 22:58:43 GMT
...
-	Layers:
	...
	-	`sha256:56f721997559baa8156af264490e6970a887d870d2c3b4e14172567ea61090db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f52e77432782c4eb23fb8e8994461e1dd04e4ac2f5381fcf21b86c2b1dca304`  
		Last Modified: Wed, 11 Jan 2023 23:16:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9adad6ce502deb1b34bfacadd20b296e30217ab6f25848792cef895d445b8201`  
		Last Modified: Wed, 11 Jan 2023 23:17:05 GMT  
		Size: 22.8 MB (22836972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.1-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:32596720a8769c300b223173d8c16f28b0851d3501ed5bdae20148ab268e0c91
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160565339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffd345ff03adfd742127aeb4293c0e9975f1f49feef7d42280b3d3ed8f1f13a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Jan 2023 03:58:54 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Thu, 12 Jan 2023 04:03:05 GMT
ENV DRUPAL_VERSION=9.5.1
# Thu, 12 Jan 2023 04:03:05 GMT
WORKDIR /opt/drupal
# Thu, 12 Jan 2023 04:03:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Jan 2023 04:03:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fa1e9dc394171f3103e78f9941d242362a9ebd9d960e51e0ef058a796d2a9c6b`  
		...
		Size: 700.1 KB (700097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6084f4dd5ce9b01319fa33a0c9b4d9622a85355e9867a436485d89d64dc57943`  
		Last Modified: Thu, 12 Jan 2023 04:33:52 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50d68f85979e937b73fd9ca9b68af2d632321e45b91e3597bf5f32f373f91456`  
		Last Modified: Thu, 12 Jan 2023 04:34:00 GMT  
		Size: 22.8 MB (22836755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.1-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:094a68190b7b8ff3c75c0b784b32d53cc3a60cdc6e6f8406151a43ad03d906ea
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185282725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e764ef5409813db1e6c64ac434afe482692027bb6ffe5316a9dfeba15762aecd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 Jan 2023 20:24:39 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Wed, 11 Jan 2023 20:29:39 GMT
ENV DRUPAL_VERSION=9.5.1
# Wed, 11 Jan 2023 20:29:39 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 20:29:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 20:29:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f37151d8aeab94a9abc97926be44ae3dcaada2829a5599a4cd47cfb6e3aceb85`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:589bdd3ff1ac7ad2d18b2fb9c05e4f3ee4e47ab28c9220afb2f22dc741607a15`  
		Last Modified: Wed, 11 Jan 2023 20:46:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc144fa55be33e1160ee62c8f06632a7385278633963ead5d600d9873921cb78`  
		Last Modified: Wed, 11 Jan 2023 20:47:04 GMT  
		Size: 22.8 MB (22835376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.1-apache` - linux; 386

```console
$ docker pull drupal@sha256:ed30ff4ce0cfe1aff4dd40824be8329f2a3838cc33873fb7a93d6565054ea0ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.3 MB (193282238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a56f118aef274ec0d3306680fb4bc1d47cf43067722f8983d19591d44f7a682a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 Jan 2023 19:37:56 GMT
ENV DRUPAL_VERSION=9.5.1
# Wed, 11 Jan 2023 19:37:57 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 19:38:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 19:38:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:800b819abdc28f42e8dc416e536f3f56fd906fb1e66db1aa3bcc3da245bc738f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7b0821b621df4b59ed186c091af1ed19c9db070afb1914f7a02e86002722f3b`  
		Last Modified: Wed, 11 Jan 2023 20:04:12 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0679b0c012f3bde25ef5590a113758628a743b9401bc343aa0390355b94620a8`  
		Last Modified: Wed, 11 Jan 2023 20:04:17 GMT  
		Size: 22.8 MB (22837024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.1-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:5c95a5e2866f6bc7a970dd38b55f657b774c54fbbf8d927ab321dab4033566fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.4 MB (191445688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04f6ffb70ea170336dad2c9055db522f83f1dd5994518b51abc306147809f318`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 Jan 2023 19:10:06 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Wed, 11 Jan 2023 19:12:38 GMT
ENV DRUPAL_VERSION=9.5.1
# Wed, 11 Jan 2023 19:12:38 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 19:13:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 19:13:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:65773900b8dc7381b7edef3095e2bd0dba68e970da3e18b39fffc797ce1dc39f`  
		...
		Size: 700.1 KB (700097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80fa28fe2f34a73cb2d72f3087c37e8038fcb449bf38ea3c57e09da592df0459`  
		Last Modified: Wed, 11 Jan 2023 19:34:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0232b5b881ef3559506f312210019466a300deef73452a5b6095913971df6cf5`  
		Last Modified: Wed, 11 Jan 2023 19:34:13 GMT  
		Size: 22.8 MB (22835542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.1-apache` - linux; s390x

```console
$ docker pull drupal@sha256:2437bb45b6733ee9e4cc53832cfa1c265e26a98f34afe509f870ffcfcfae90fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.9 MB (167875559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:858e1336911e16e1da42858c7524be636fb3b60bfe590e5de27bac59e2d698b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 Jan 2023 13:34:12 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Wed, 11 Jan 2023 13:35:35 GMT
ENV DRUPAL_VERSION=9.5.1
# Wed, 11 Jan 2023 13:35:35 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 13:35:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 13:35:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e8e688de5f43b4166db9ce5f7bab646bf082ef67657f9193018156e92e94cf7f`  
		...
		Size: 700.1 KB (700098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2122914246b86f4f93c1ada3a9f7736fdcf91df4c26a4909ee1e75d2e6e9117`  
		Last Modified: Wed, 11 Jan 2023 13:50:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7983b64771c9511f21beff6f3a3f0ef2274f3b84ef7b1351c60591404ca3215a`  
		Last Modified: Wed, 11 Jan 2023 13:50:18 GMT  
		Size: 22.8 MB (22836828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
