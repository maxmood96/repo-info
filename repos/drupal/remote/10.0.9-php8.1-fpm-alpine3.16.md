...
```console
$ docker pull drupal@sha256:2f2dcecb169660df595b9fe8adfcbac7f58f40d430966706ad658603771fa340
```
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull drupal@sha256:59e09686edce5e0587da0dfeaf6fc07d3bc71062905ddb310a6b5a487b19906e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49817934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a364b3f528b4f408d512f183ac963c71a15730c297f9caa1038025a28a5f0be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 May 2023 07:24:59 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:25:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:25:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9af454a60fa5d59fef369d769fb4f9257eea79d556d6f9ab618011c94b04c693`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf824d1d8407df28a3089a70aaae397c40bd2ac1868cbb511b05ab5d54e8004a`  
		Last Modified: Thu, 04 May 2023 07:50:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09727e31fdd5bdd61ef80728d6e7e5e398724cfdd49355a778ea15f1be19bb84`  
		Last Modified: Thu, 04 May 2023 07:50:53 GMT  
		Size: 17.7 MB (17675411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.9-php8.1-fpm-alpine3.16` - linux; s390x

```console
$ docker pull drupal@sha256:d0f5086fc17a2b098f671f9cf57ae1e6762c0104ce189a230c8365064c60bbdb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48259418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d60c5ab70060a3378c8dea5b3aa5921ca6c5279155c2ed86965c175a39f34443`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:06:43 GMT
ENV DRUPAL_VERSION=10.0.9
# Thu, 04 May 2023 07:06:43 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:06:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:07:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a9ff1de241fdbbbd8463236672ede58f4bfce5a30ae1ce859b420e384449a9d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2ecb35036882c357a83fb374e69b6022e15980494c4d9c1e7359dc126efece3`  
		Last Modified: Thu, 04 May 2023 07:17:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ff88f632c59cc9740a8d8d91eee6859ad5fd6916dc7b733d9e565f0333a6a98`  
		Last Modified: Thu, 04 May 2023 07:17:59 GMT  
		Size: 17.7 MB (17675176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
