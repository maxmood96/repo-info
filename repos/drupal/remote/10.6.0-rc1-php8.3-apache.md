...
```console
$ docker pull drupal@sha256:d366918f152d09afc2f229bb6e9eb1657b4c0049a9572a412e40b3d91394aef7
```
...
### `drupal:10.6.0-rc1-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.0-rc1-php8.3-apache` - linux; s390x
