...
```console
$ docker pull drupal@sha256:72c64c88d9147a9f0a7cfe65eef1534b265bdccde00db3a0590ef123022d36e1
```
...
```console
$ docker pull drupal@sha256:61ecb8588a06c6abd028f4ac3595c83c58e497136d46cae134080222742e6a0d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.9 MB (187851005 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c08592bb64cbec80de7606a584dbaeb4bcd5d68e0226b50a416fb654b6d2692b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 05 Oct 2022 15:18:28 GMT
ENV DRUPAL_VERSION=9.4.7
# Wed, 05 Oct 2022 15:18:29 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 15:18:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 15:18:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:54a08ae038b9d68526a8ed0d8ec31f5b82bd4a54eca5b50a6210dfcf95d06d3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2f828c0eaf096ae591e15bfc0e9f16cc3924ed156d9d706834b3774e4a3f14d`  
		Last Modified: Wed, 05 Oct 2022 15:52:03 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e58816079348f6f4e027816dfd8be9cec3a77fcb98a01f92f80c8a945335af4d`  
		Last Modified: Wed, 05 Oct 2022 15:52:08 GMT  
		Size: 21.9 MB (21891710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
