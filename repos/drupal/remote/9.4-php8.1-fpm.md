...
```console
$ docker pull drupal@sha256:94d3717a8938755f8c0583b730e65fc6178452b6105c2486bcf8c8c40e76a773
```
...
```console
$ docker pull drupal@sha256:c54943218e544879368de26d7548ae7129943077a28998124ed045efc4e8060b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156069537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcfb23f7ba5294ce3b0eaadd1472b9e4d93e662084760bc798b8948c2a3e95e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 07:00:43 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 02 Mar 2023 07:13:14 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 02 Mar 2023 07:13:14 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:13:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f69f9968757775e81b070e4a76257ad6f7d29aaae1bd984586e3a48a8af79c19`  
		...
		Size: 697.1 KB (697149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daa2122ece665cfe1bb4c47f6429537fec8f2e2ff92bab675e1fbc5a2d620e2f`  
		Last Modified: Thu, 02 Mar 2023 07:44:48 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e3d396ae5a46273331c13f8d09cedb91058e4955f340e6adce60bfe818ccd7a`  
		Last Modified: Thu, 02 Mar 2023 07:44:54 GMT  
