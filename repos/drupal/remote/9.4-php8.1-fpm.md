...
```console
$ docker pull drupal@sha256:769693b1074e7f032b71ddb16c29087ed4bb35c2886ac5625b2b41990d04d649
```
...
```console
$ docker pull drupal@sha256:a81a1bcc324e8a30e055f561c3253f0be7f10f6741c6ead00ab70b6c20e051f4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185894761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d82d1177e82644fa6fb04926e01a81c6ddb2091d329e8e3b09a20864ccd372c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 May 2023 07:23:21 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:34:19 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:34:21 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:34:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:35:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:283da174dddb4db6e1f90a0071741663af338212579681c67839ebb02c313d9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfba6faec72c2f8c99161902ee7fa4ca27213b4d7dc2e5043cd98a15f233fe56`  
		Last Modified: Thu, 04 May 2023 07:59:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f8d515bc55d0f3ac087530e889bd1acc32c7f4bb49aa7d693caa3d0fb975592`  
		Last Modified: Thu, 04 May 2023 08:00:13 GMT  
		Size: 21.9 MB (21914381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
