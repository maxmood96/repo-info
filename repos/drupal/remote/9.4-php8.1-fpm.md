...
```console
$ docker pull drupal@sha256:c0b09505c8747d976b65ebbe1e84a7be9048cb2e932512ff2bbd4d888f4e9946
```
...
```console
$ docker pull drupal@sha256:cc5d98d2233e09c6260e29d715762698fe3399fc97862fa39a0f23b546084059
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188709802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7090d4f13330faa43ce8f3fe6135233ff263eed81b1698b23bf35626dbe81f55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 07:08:50 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 02 Mar 2023 07:08:50 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:09:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 07:09:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1eefddca71fc94623bb355a3ed75884ce7105b4bf7c488a90563c80de267ff8f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdece21f5f796b7c9c62b6d85603e3133a487889fa434f02fd8ca01378f895c9`  
		Last Modified: Thu, 02 Mar 2023 07:38:20 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a81c3e41d4fffa014a161aa73ea586ea42a08e8f2ea4ec6e034f38478720038`  
		Last Modified: Thu, 02 Mar 2023 07:38:28 GMT  
		Size: 21.9 MB (21911578 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
