...
```console
$ docker pull drupal@sha256:f4d623e1d53717d74664ed57628e609ba5f37389881f76e5f35328112cdf90d0
```
...
```console
$ docker pull drupal@sha256:75c528d8e0fae89715b66794180be05de5f9232dc68396c46f2b0114a0660483
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156111153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae9e78e4e97675ad0c9665f2e06c340d5f01e49a99d29ce02a3f795055f9b785`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 20:12:08 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:18:40 GMT
ENV DRUPAL_VERSION=9.4.13
# Fri, 14 Apr 2023 20:18:40 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:18:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:18:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:362c4c91fe7a453d26aa22682c93be117ec396b532b31e05e43415ec31b77a5b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c659e12a8ab5c162dab824eb96b713d137e373957383e570eee1f69b2d00576f`  
		Last Modified: Fri, 14 Apr 2023 20:33:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b49669ce5f2076a257930a254b42a10820ce9cdaba6331c135c930222dd1b8ed`  
		Last Modified: Fri, 14 Apr 2023 20:33:12 GMT  
		Size: 21.9 MB (21916998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:acdd8c69c0b610d5c785bf8a5d584c01e3e32277dd3c10bdf48b566c1c218778
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163018181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8f82b0f594aacd531591160bf0001f5780571321826d94bf09b5d8c0d7a3781`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:15:23 GMT
ENV DRUPAL_VERSION=9.4.13
# Fri, 14 Apr 2023 20:15:24 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:15:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:15:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:13e2fa2888ec2a39a34279bdd5572065d73631b8ffb4f3055c83b65c8fbcceaa`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e766927a015f19a868f4dd1929fb034f359251d8dd2ce15d132708c64537dd7`  
		Last Modified: Fri, 14 Apr 2023 20:23:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93c26ecc32fb5e6ce63a76df5e045a59b7ae9d543ad6038ef4c709cb3314c5b0`  
		Last Modified: Fri, 14 Apr 2023 20:23:09 GMT  
		Size: 21.9 MB (21916830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
