...
```console
$ docker pull drupal@sha256:f486a7f2eecaefe752df835ad8690e0d8def2cae06a2705c676995a198da3417
```
...
```console
$ docker pull drupal@sha256:7f5693f1b9321b18eb5b6a461f5e069f5421d0d5893253585ee3656ba47b06bd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163018734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54b27e209a276b31b832f3993ae190ac8db41d5f545327fe6216cbda21e35ab9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:51:47 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:51:47 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:52:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:52:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:13e2fa2888ec2a39a34279bdd5572065d73631b8ffb4f3055c83b65c8fbcceaa`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc9674e7cccc2880bf14180a9eaef2cc674b89fa4a11715a0953248bccfda5ee`  
		Last Modified: Thu, 20 Apr 2023 23:00:52 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fe66b56d726dfdf1783c2a43544ac0164e65aaa4d71bcaf4bf3405194db5a1f`  
		Last Modified: Thu, 20 Apr 2023 23:00:56 GMT  
		Size: 21.9 MB (21917384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
