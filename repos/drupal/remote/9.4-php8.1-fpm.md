...
```console
$ docker pull drupal@sha256:ae3beeb28faf634e4afac3c5c7f5bb51a0a06991d54db90fb30a3fb828f25092
```
...
```console
$ docker pull drupal@sha256:50aec97ed38f4f12e6a457ec3dd3b5e21747af018e3cdc6919bef09038cf1642
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188762216 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8340aeaece5580c95af19f0a1ac963db0daf5121e3748f98e3d2ba1f703e976d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 22:33:45 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 13 Jun 2023 22:43:58 GMT
ENV DRUPAL_VERSION=9.4.15
# Tue, 13 Jun 2023 22:43:59 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 22:44:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 22:44:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0366f45d9bcbe82d72031a62c5e7ed7cd95d24b090af3a391896078ffef5f57b`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06d5768e3e3c43d321a9b676960de61646689c7e739aa9325096849365caf012`  
		Last Modified: Tue, 13 Jun 2023 22:58:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5508d993d6a1088c3a8aed3176943e01c16eeac7178f53eb990921fb799b4d7`  
		Last Modified: Tue, 13 Jun 2023 22:59:04 GMT  
		Size: 21.9 MB (21915353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:ed84a32e7a3d4b807f202325491f471556c026bfade17a97c69759202071c8b7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185918087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5fce6b6b97dd0b990da4a7b5b1468b5e01c1c3c7e0fd446f1e27807da216baf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 23:49:18 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 13 Jun 2023 23:55:27 GMT
ENV DRUPAL_VERSION=9.4.15
# Tue, 13 Jun 2023 23:55:28 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 23:55:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 23:55:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:007bb74ab9b628b30abab11d0e011aeae4ed965a2d245a36eca49fdae0509de0`  
		...
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ef609b61048510d66721bd6983b3dacc894021640fa39d7d41c0e4d0d4a0442`  
		Last Modified: Wed, 14 Jun 2023 00:08:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:092949ff814f4dcc9e5c0a1c248230255e886d4c745b63cb09dc3c1196505a5a`  
		Last Modified: Wed, 14 Jun 2023 00:08:10 GMT  
		Size: 21.9 MB (21915511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
