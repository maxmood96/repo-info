...
```console
$ docker pull drupal@sha256:556a1b38c2eca1c89b8926413a01d6957152c88663142399b2012f84b0755be9
```
...
```console
$ docker pull drupal@sha256:7278df246a8f85d0f5883536f0631a24671183637fd879782d8219561940ace0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.1 MB (186097317 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b20490b849398fd1cd6715d7c942a31d5463643e1895cea9709b4f70bcbacc55`
...
# Sat, 04 Mar 2023 03:10:11 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 03:10:11 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 03:10:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 03:10:25 GMT
...
-	Layers:
	...
	-	`sha256:837bfdfde020ec79db7b2728e4a25e5e5e55ceadaf9e6f162753402a5306acd5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c3a18072c388655f20d85c4e075296c0a4f7d0153c5c6e749128092f7035482`  
		Last Modified: Sat, 04 Mar 2023 03:23:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bd26f2ba21ea0f006f3727ad2ab7d28feaf9e05e77003ed9f51e1ed93af23b6`  
		Last Modified: Sat, 04 Mar 2023 03:24:01 GMT  
...
```console
$ docker pull drupal@sha256:df308b459b750f73f9d5b87e4c3cc19ce533bb42a5595f9d06b0505e20dd48a7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156068254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9790cf384c2ec0630e043467a15008dd31ca8ea266cc3f4f62795f3f6e67827a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 03:18:28 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 03:26:50 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 03:26:50 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 03:27:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 03:27:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b41f3cc37ee915ee22fe2f18e654d9685cade7e72b26722002ddd7c51fd61aa0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e37896ab9caf37b01f4e9e885f70e425e927996885d758849b65a84a9f81262`  
		Last Modified: Sat, 04 Mar 2023 03:51:21 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f33a8e7555447241c2179dd0b78c62af4e80550355455188e52104d85c0bf3f`  
		Last Modified: Sat, 04 Mar 2023 03:51:27 GMT  
		Size: 21.9 MB (21910343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:74f96fb0c4f151f461b283cd6a76d16d964c832512005c17541b5c732c71694e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.3 MB (180338608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a0391cd5f5cd7866e46505626345b7a17c2fe8a754bfa8c856c265aaa09a588`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:49:53 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 02:59:11 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 02:59:11 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:59:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:59:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b7cc9461b41da2c1db5a656d10c34abc53d709905c5d61f45edce9f22ad9349d`  
		...
		Size: 697.2 KB (697152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:483788b1db4b4b381b7631e3cab030d1e4adf674cd181a3048336bb7d204db7d`  
		Last Modified: Sat, 04 Mar 2023 03:13:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:face700697915d2c4d0ca23e0270ab0b2244a6ad50a4db9d338e7db543beca18`  
		Last Modified: Sat, 04 Mar 2023 03:13:32 GMT  
		Size: 21.9 MB (21911932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm` - linux; 386

```console
$ docker pull drupal@sha256:e7eff24b09242a93de1c653bf2d0fb52527a14229d588f8ababce8e662a59ecc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188707125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b31b4f40a27f545bf956976db2674851afb8dad564eeab28f38cb6c9b6717ce1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 05:31:18 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 05:31:18 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 05:31:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 05:31:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bbc8d9b4e98b86a86ee15552f5fe6b22132ba7d6fe9d441b5416419b3594d6cc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d72e2259a937765090b6566e2d8ff6de72816dc6bcbfff1d7c1cf62e4b1bd894`  
		Last Modified: Sat, 04 Mar 2023 05:53:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec23006ee9c14accf6c3e159bd32479fe7cc004c9be03dc49ac55706771b11a8`  
		Last Modified: Sat, 04 Mar 2023 05:53:41 GMT  
		Size: 21.9 MB (21908849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:35c51668c44df345e9578f05f8758958baa2c29f549edbab86e587ebb1a8fbe7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185859804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44f9564fc9dc9efe4e8089e6eb0aa8e4852149e49bb3193b1c869482deacbcba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 03:12:35 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 03:12:35 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 03:12:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 03:13:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e83910ddf6ca7f8a02e854eff4f41062a33d17e32a5d3489d786762bace29971`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de8b7eb47d0654f625e7bb53e275a4f03c3c4c226a897ffcee3579f3447a71b2`  
		Last Modified: Sat, 04 Mar 2023 03:31:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dd0942deb4189a8c59e8a99319beed05725fd6a48c3c6c22deceb0c38ebbcf1`  
		Last Modified: Sat, 04 Mar 2023 03:31:24 GMT  
		Size: 21.9 MB (21911469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:5e243458e6aa870b0017cf15adc3ed4a79cea95ac3d7d56581183718019e8a91
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (162969676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71e60c457f7f4bc75acf351c75cf476c1e17a099f01d8926a82963db64f628e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 01:50:18 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 01:50:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 01:50:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aa58ef08674638258cfaa1ab127398a557960520f84f5bd282dc22044c8ee45c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c04c5b493f4ac3622fcff1400c64be1150b89401d30fd1db36d930650fc87b07`  
		Last Modified: Sat, 04 Mar 2023 02:05:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c7d9e18406daf4fcdd0340820066ce013a4c34f07e33cacc5237063cabd5443`  
		Last Modified: Sat, 04 Mar 2023 02:05:56 GMT  
		Size: 21.9 MB (21912015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
