...
```console
$ docker pull drupal@sha256:a86e98bc8fa675e0f1b31d4688d603cf132b8a0e0d07644d802492044d734859
```
...
```console
$ docker pull drupal@sha256:b907cc086c88c0b0e59082c369f9dfdab5a787234611d66c9e3eb1894b9590da
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.7 MB (201715119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c72c0aab450ca27f7235cbb9f7bf55945a8a5b931485a0b2d38427e6b94fd91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 05 Jul 2023 09:20:30 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:47:28 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 05 Jul 2023 09:47:29 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:48:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:48:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68dab3dd245628663ab53af858b2a7ba5686ba104bcfe35423eff53bf91d4c27`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47416df661807713d71d339648c4511384f42b97a00a69f7db38ef3a61710aa5`  
		Last Modified: Wed, 05 Jul 2023 10:30:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec1d2f2519b9bf5328e02051cae6d2e13a7fa116a934b089a3ca214dec250b75`  
		Last Modified: Wed, 05 Jul 2023 10:31:14 GMT  
		Size: 21.9 MB (21915163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
