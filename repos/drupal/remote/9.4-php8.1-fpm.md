...
```console
$ docker pull drupal@sha256:909d7fd47671092efa12eeaeb53f66280c82e87a82617d4d2ff51a7e75653a3c
```
...
```console
$ docker pull drupal@sha256:2857d4a2aac0cc991ccd29b7a6adb6b8a955a1d88a4c2a27fd03b4b5b3bb6efc
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156105348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:732bea11db6c2d5f4c5a5b8165fa989d95625dd795d32f3aef3125fa12728bb5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 08:53:18 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:03:56 GMT
ENV DRUPAL_VERSION=9.4.11
# Sun, 05 Feb 2023 09:03:56 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:04:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:04:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:060441f615b7638553cde1fd4cc3d4af9c3fc6e81b7a794ea55fdce1db8fa768`  
		...
		Size: 700.1 KB (700098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deac8ef0e793b4d00126d88706cb08b48420394ec154407332810b633b65db0d`  
		Last Modified: Sun, 05 Feb 2023 09:33:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76421e0de8b603952e48bbeeb10c3ccc519d6f69771e16e13164ae7ef8d5a39`  
		Last Modified: Sun, 05 Feb 2023 09:34:02 GMT  
		Size: 21.9 MB (21909400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
