...
```console
$ docker pull drupal@sha256:b4f2fa6200075b845eb59f4e8dc07c7131b29cd8ae75e37ad8a27051d23872cd
```
...
```console
$ docker pull drupal@sha256:d5e09bfea24e4a122fbb8f7f71a408fe24a6d124cbbec656870df88773fe1d4b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185917989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:618697f8e5bf2f94af74a6df12c46b8b0e637d78292f7809c80278e6b9aff9f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Mar 2023 23:25:54 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Mar 2023 23:32:42 GMT
ENV DRUPAL_VERSION=9.4.12
# Thu, 16 Mar 2023 23:32:42 GMT
WORKDIR /opt/drupal
# Thu, 16 Mar 2023 23:33:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:71aa63ba0735c846cfdee1617965727648ca05051d39e6897bd3fdfeb7a8d412`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:539766b8f870f048d0a89daa913fc8a1beaaf88ad7a56a3371d0f4e03f3a8ad9`  
		Last Modified: Thu, 16 Mar 2023 23:53:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d0962237904f2495b19393bec323c077d60f286adeeb24539a8fa7c6f77ce91`  
		Last Modified: Thu, 16 Mar 2023 23:53:55 GMT  
		Size: 21.9 MB (21909331 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
