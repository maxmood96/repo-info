...
```console
$ docker pull drupal@sha256:46c8f3874576c44c521161ce4f98efc77c3922a5a8b16bddec2232ad4375b3ef
```
...
```console
$ docker pull drupal@sha256:3b2fdcf308d341a9ca79564f2c8fa1def44623bcf4743d813b5ecef19cc5919b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185913939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbbcc644c7ed0de144ec0665367a588f5b09a63f9ef421d47c8b3345a32b60cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2c6e86189bae3d0f441696ba145d29f22860cb3f94dece0c5761829ffdb8cb91 in /usr/local/bin/ 
# Thu, 09 Feb 2023 16:44:36 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 09 Feb 2023 16:44:37 GMT
WORKDIR /opt/drupal
# Thu, 09 Feb 2023 16:44:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 09 Feb 2023 16:45:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:667ed91fa470d9d7e3a1e8d4b4729af0db72d2c14dd11beb981b152370ab5b94`  
		...
		Size: 697.1 KB (697101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e0d0b6551c7c53187d7f2241c62bc576fce606d1794e8a9d0bed0f884e2f101`  
		Last Modified: Thu, 09 Feb 2023 17:04:59 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6450e45af70f7f702c6ec6e0880c20290c551b493949a4273376408410992c81`  
		Last Modified: Thu, 09 Feb 2023 17:05:08 GMT  
		Size: 21.9 MB (21911707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
