...
```console
$ docker pull drupal@sha256:3654e08c308a459eab906426e027012d4344109d83344cf7bc59e795eff90cf7
```
...
```console
$ docker pull drupal@sha256:1b99f2a23a79f1b2937de8013756ce5feb05c1d512db085b7aeed889dea08d26
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162918936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a6b1109087d807a4a0eccecb59a626b657b878bb95a325117ac5064e15d4db6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:03:48 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:03:49 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:04:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:04:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:218f4fa29249889a9720da5d18e09e0129c2c018f8e8dc299616696200ccdecb`  
		...
		Size: 692.0 KB (692047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7182140a612e659689ab9d2ffeca1f0987d4967dc797fa4811fcf5f23d9127db`  
		Last Modified: Mon, 22 Aug 2022 19:36:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:789ebe67c60adcda6994cb37772c1f55e67b940545963d7de217a8d732d77d43`  
		Last Modified: Mon, 22 Aug 2022 19:36:54 GMT  
		Size: 21.9 MB (21864032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
