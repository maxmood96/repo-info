...
```console
$ docker pull drupal@sha256:c755a358b38d4715a3779d1989bb6195c0e098ecdc4bbb0eb9d6b29a515d7b86
```
...
```console
$ docker pull drupal@sha256:5c238f91a4e89387668c4b0c48cb439474c26ef2e2042f49f913758a0942dbc6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156118814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48159dabf976ef53dbd024df3a67a11b99d6e783c42de134bda258c6659d4ecf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 14 Jun 2023 02:03:07 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 14 Jun 2023 02:12:18 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 14 Jun 2023 02:12:18 GMT
WORKDIR /opt/drupal
# Wed, 14 Jun 2023 02:12:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 14 Jun 2023 02:12:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f6b726e2b8e91cf5122e7104b7fcc1c456043fb5ae1dfe3ab45493b0879cfd04`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:227363eb749afb05433c8b641296aec3ed63f49cd3f35c0cee9f8d0c23d698d9`  
		Last Modified: Wed, 14 Jun 2023 02:29:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:350435470ba6bcf511fc865d1aa6cb22ee130326a6f93bd3d5587eb39e632f4f`  
		Last Modified: Wed, 14 Jun 2023 02:29:22 GMT  
