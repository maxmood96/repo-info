...
```console
$ docker pull drupal@sha256:f69d9f4df970cbd64e069f88fc61ba82874cb0ec825c6dee76db413bfd65a29e
```
...
```console
$ docker pull drupal@sha256:fed5ce14c6e8d40ba1529e86178e4aa0bbb9db9d17aabc64766e693cd1c6bead
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.4 MB (179447685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4750e670765f44c3c10c0fdbdc6421f8ef8beeb564a5b1a7fff9961d6fabb310`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 23 Aug 2022 23:36:59 GMT
ENV DRUPAL_VERSION=9.4.5
# Tue, 23 Aug 2022 23:36:59 GMT
WORKDIR /opt/drupal
# Tue, 23 Aug 2022 23:37:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 23 Aug 2022 23:37:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:28472db87a62e9576d427374d52cafabecb2c22275e000bbdaf2c15385a86c25`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c42849f966ec7ac18b7e9971860a289b36166132f3136b1bb64a56fd7dc66d62`  
		Last Modified: Wed, 24 Aug 2022 00:12:09 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af023b527264c1f4dc4328dde7041a9c6bfa7d8642de75adbd91c90f1deb774e`  
		Last Modified: Wed, 24 Aug 2022 00:12:15 GMT  
		Size: 21.9 MB (21867190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
