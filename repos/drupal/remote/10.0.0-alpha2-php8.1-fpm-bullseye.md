...
```console
$ docker pull drupal@sha256:6f6c53c258ef15876c4b6a96a066f47cf340b45f7b30bfd83d20bd5ed458caf2
```
...
```console
$ docker pull drupal@sha256:40d58977f06af727520118490755494ecf290028163d3476f96c7aab328c3e0f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183081760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8503c4a810f91520cb59dc9bb849fa52fe757180461d28270aee46b86afdb123`
...
# Wed, 16 Mar 2022 19:35:40 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 19:35:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 19:35:52 GMT
...
-	Layers:
	...
	-	`sha256:3ecd34db4486d4c129673bbbc3b8a11e3a1385d8a757713ae1e1e04a25b78a90`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dd9f2b61c488e2a06913a3e50a04e8bf98fcbdbaa8c88da30566a9e417e3136`  
		Last Modified: Fri, 11 Mar 2022 12:27:57 GMT  
		Size: 2.1 MB (2106535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b8b5ccf4ac79795802db162a8775290d83b3c8867de57824ead9ce9cf556c19`  
		Last Modified: Fri, 11 Mar 2022 12:27:57 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d151df273f76d589685a33b0d37d9ab94633fbfb4cea899114f13462c6d2226a`  
		Last Modified: Wed, 16 Mar 2022 19:47:32 GMT  
		Size: 575.7 KB (575718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e3f35f99f555610303d9e77340a5357a74969c6ecb979fd32df121f8f10dec4`  
		Last Modified: Wed, 16 Mar 2022 19:47:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7353f0e36cf4cd37cea10835fe0d8b5737a6abcc17fbb66aafc2aae4c618ae2c`  
		Last Modified: Wed, 16 Mar 2022 19:47:37 GMT  
		Size: 19.1 MB (19136377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:923f6478b0c33fbf7bf00ade1f28f5c19aada04c064be2b5d78fbabc226bd8b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.7 MB (176740568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:859f9e226f5a4f4c9147a13689435d0ec14e9979f2b0bc7e87d8796bb6e25f98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Mar 2022 10:41:36 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 10:41:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:17:52 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:17:52 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:17:53 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:18:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:18:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9ec2305812d15a57bf77580401b54d286ffc9019f24bb092c33bdac40693058c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9db0b5ee1fa3dcd341400925c1c725a5e48cf41e91c16b183381395ef4e3abfa`  
		Last Modified: Fri, 11 Mar 2022 11:19:27 GMT  
		Size: 2.2 MB (2154946 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5958c1a20cda39ed43a582b0105d4013083970586209c1c64d4cf3443b98ec8c`  
		Last Modified: Fri, 11 Mar 2022 11:19:26 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c87e9f44ef053afc728f6e3e5824e1d46ceebb85aaaf15554b777b1b05d28bbe`  
		Last Modified: Wed, 16 Mar 2022 18:39:44 GMT  
		Size: 575.7 KB (575717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52638ef70b18165e274b1ab761525ee5c21509ba6a090a9e7c45598cdea96c3`  
		Last Modified: Wed, 16 Mar 2022 18:39:43 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9f3cc1af73cc913382372fce1e9a1a0af16d5cff6ce427cc97c84d80e171c56`  
		Last Modified: Wed, 16 Mar 2022 18:39:49 GMT  
		Size: 19.1 MB (19135969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-alpha2-php8.1-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:3f1c0ecf2bdb2f5bf99fefdb7c876dee445430bb847508a2ac88a89bc255c1cc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.7 MB (185743349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26bd8833ca6c83894ce593c9f062c79445b258a7ce4689de0f6c82a0ccf65cb4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Mar 2022 14:34:59 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 14:35:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:22:08 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:22:08 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:22:08 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:22:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:22:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9d5918194189a0626c4c26e6efa504a675e9469ee46a6c882f78a745c167d74`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41b721f354f200b9fa02b332ca4fed4e6fb5f803d2a7ffd3fce0e9eb1a818703`  
		Last Modified: Fri, 11 Mar 2022 15:13:53 GMT  
		Size: 2.2 MB (2172546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b5e88f092e462fa25c2aa4ca8602711514d82a1a2e9937705a2d52b5e34c1ff`  
		Last Modified: Fri, 11 Mar 2022 15:13:52 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7437e64dfb0f4d924303644261af3412795750ab77f0e4ccee192d8c18143b64`  
		Last Modified: Wed, 16 Mar 2022 18:50:57 GMT  
		Size: 575.7 KB (575719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:451d3e62817493f2f0bd54b8c00a437e3bf20b2e32a550353f1ebccbe25293d6`  
		Last Modified: Wed, 16 Mar 2022 18:50:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c2fcc5d1d017060e212120a1569c8e6fc0d35c6fd65845bfab0b2f869a2ff3`  
		Last Modified: Wed, 16 Mar 2022 18:51:14 GMT  
...
```console
$ docker pull drupal@sha256:510a69ce19354b938afaa70935936933f5b529e7428587e7b2b799c5c732b53b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (160029021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:600a7b538f4cd11601ba55ce781a91adfec848e82e8cf86e263c54643c3393fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 01:21:38 GMT
CMD ["php-fpm"]
# Fri, 11 Mar 2022 06:27:19 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 06:27:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:07:01 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:07:01 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:07:01 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:07:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:07:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:06455c5b6c3614066840ed8a5545a2aa352baeb7319d321a697e38c987d2fd9c`  
		...
		Size: 8.6 KB (8625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19544d379c0a99147118e6733725f7a29f5a91a9f554d9b3bdc6b2cc57db4276`  
		Last Modified: Fri, 11 Mar 2022 06:56:58 GMT  
		Size: 1.7 MB (1701789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c31aa80cd5cb92a96d36b13af0a8da600ef2353f592d6a69fc25d664cf44ddbf`  
		Last Modified: Fri, 11 Mar 2022 06:56:58 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95ebd0c5a2b56d584a3fb4c8fcc8400719ace3e085899076118ee69bc4e27d36`  
		Last Modified: Wed, 16 Mar 2022 18:29:27 GMT  
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91a6ff9cff7483e00c239f9b3f1b88720b3eab50b305df11a4d9d84642a94b8a`  
		Last Modified: Wed, 16 Mar 2022 18:29:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:157a717951dcfa3c62e3935d3614d86d2bdbd571a0ad6b0bf5a2b9c67442d893`  
		Last Modified: Wed, 16 Mar 2022 18:29:30 GMT  
		Size: 19.1 MB (19136458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
