...
```console
$ docker pull drupal@sha256:4dc2e3b4c64b39881ba57b3e7ebae4e669b234fc78dcaa313417063048fefbf9
```
...
### `drupal:10.2.1-php8.3-fpm` - linux; amd64
...
### `drupal:10.2.1-php8.3-fpm` - unknown; unknown
...
### `drupal:10.2.1-php8.3-fpm` - linux; arm64 variant v8
...
### `drupal:10.2.1-php8.3-fpm` - linux; 386
...
### `drupal:10.2.1-php8.3-fpm` - linux; ppc64le
...
### `drupal:10.2.1-php8.3-fpm` - linux; s390x
