...
```console
$ docker pull drupal@sha256:2bc28aaafffdd73dc70acb82bb1b7569e52c3eb37f7a8f3c577451b8f16a8925
```
...
```console
$ docker pull drupal@sha256:0d994b46ae57c3ae1250c45dc370a1a602699618cde55ff617896a08ddc67138
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52098873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6d92c4e23aea8d4303677c1d9f4383151af7ee05a0d666f893d6aa4046ecc63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 22:52:26 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 22:52:26 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:52:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:52:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:60fa14d2779ba96a61a75c3f658acd414e5b8a30dd711c0fb983ca01b32ec75a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccf103766546d164520a01490fb4c7a76aea4513c2648ab7c32d176a8930fc8d`  
		Last Modified: Thu, 17 Feb 2022 23:06:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0314239ec360758af0d0a9b4f76ded16aaf077a6da1945f782f812be15fe9671`  
		Last Modified: Thu, 17 Feb 2022 23:07:03 GMT  
		Size: 20.1 MB (20119528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
