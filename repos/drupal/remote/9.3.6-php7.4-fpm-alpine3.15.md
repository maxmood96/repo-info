...
```console
$ docker pull drupal@sha256:3c41eb5e6b1bd1bc8a019429566cc534b03768c88fb518ea3d856ebfe45362cc
```
...
```console
$ docker pull drupal@sha256:2a3a6ca1752cfffee761294f9154c523d5ece05299d258fc7e1b82e4d5cd0fe9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.5 MB (47520814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6946d3011ee9b6bd0f169d10d50d84b4df30053c5ac55eab4974ffb25770c4bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 18:25:21 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:25:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:25:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1baa7a908657ac8e415c5ad36627834ce78ccad0600035ba035667c99224ed86`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f47e466e0bf41037f897e609f1e23eae66c978ead11f680b04883d425a842cf`  
		Last Modified: Thu, 03 Mar 2022 19:18:07 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c27488604c1ee122bf5082640e83e402afc8fa470e2eefcc61b51497a35497e3`  
		Last Modified: Thu, 03 Mar 2022 19:18:37 GMT  
		Size: 20.1 MB (20119015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
