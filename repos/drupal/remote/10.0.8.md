...
```console
$ docker pull drupal@sha256:12eb6bfac482e34ac16ea497daf241947f8aaaaabb656ae64111dfd781564d5a
```
...
### `drupal:10.0.8` - linux; arm64 variant v8
