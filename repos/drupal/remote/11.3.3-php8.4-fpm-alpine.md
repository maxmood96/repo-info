...
```console
$ docker pull drupal@sha256:80a9af7cdc6ace90e82f8106dc3d4dc56aae50153a92ce12168cbb8912ada16b
```
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:11.3.3-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; 386
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.3-php8.4-fpm-alpine` - linux; s390x
