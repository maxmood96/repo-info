...
```console
$ docker pull drupal@sha256:e1374b6e20d3d127a88851825f2f801369ce96c95dbb9e7345103767a33febe9
```
...
### `drupal:10.6.12-apache` - linux; amd64
...
### `drupal:10.6.12-apache` - unknown; unknown
...
### `drupal:10.6.12-apache` - linux; arm variant v7
...
### `drupal:10.6.12-apache` - linux; arm64 variant v8
...
### `drupal:10.6.12-apache` - linux; 386
...
### `drupal:10.6.12-apache` - linux; ppc64le
...
### `drupal:10.6.12-apache` - linux; riscv64
...
### `drupal:10.6.12-apache` - linux; s390x
