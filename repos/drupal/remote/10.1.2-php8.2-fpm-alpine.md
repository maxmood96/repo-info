...
```console
$ docker pull drupal@sha256:e0aa85b210e6f8177be73040ecadf3c2c22780ddcc10fc7154a58a501917bcb3
```
...
```console
$ docker pull drupal@sha256:640f9fdaa49a337f88fdacb10390530d77dde21f9a78c300b3e11ff6a5040b45
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50569905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3e5e6eb1e3473d044b8fc150eaadb22b85a7a1637796949f2d6e32fa056fbb6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 03:47:46 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 03:47:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 03:47:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a4c5e997849a77a511871f5d4639cae589cc46ec6650aa2bba200d877b0ccf3a`  
		...
		Size: 698.2 KB (698231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9eae68bb35b9c96b3af70a4884a4f1015aa4f2dd848ac8370e7e967859a8ee5`  
		Last Modified: Wed, 09 Aug 2023 03:55:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e173080f85a8389be10007d124e06c3bfd3fc0c598c3c2475c7fca19aab84863`  
		Last Modified: Wed, 09 Aug 2023 03:55:30 GMT  
		Size: 18.5 MB (18507129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d2fc923cdd075d93b0e9fc4eb48cd3eddb1585c0c6ade300f835a128d4a835a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51132587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c835c2438852b6e5e571912db1cdfba0aa4a8481109cf8dc63841e43db3897c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 06:29:59 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 03 Aug 2023 09:06:17 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 03 Aug 2023 09:06:18 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 09:06:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 09:06:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7623db58a78e746ce39b96b7aec1179e273b5da626d48fb91ebce8819fd9966f`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a94b69caa6ff22e4cb671c4fc2ae2c8359b68f2d17117ab7ea5f20f8fc24bedc`  
		Last Modified: Thu, 03 Aug 2023 09:20:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424b93eec2e23f48078421b7eb84d5fbfec200f8ab9921144b5d33315bb7a8da`  
		Last Modified: Thu, 03 Aug 2023 09:20:18 GMT  
		Size: 18.5 MB (18507084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
