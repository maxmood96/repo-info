...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; amd64
...
### `drupal:11.0.0-rc1-fpm-alpine` - unknown; unknown
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; 386
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; ppc64le
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; riscv64
...
### `drupal:11.0.0-rc1-fpm-alpine` - linux; s390x
