...
```console
$ docker pull drupal@sha256:3cfdeeb62b236980252cabf8f80b9dd99bb3db6072347e04dee33fe2d97f62fe
```
...
```console
$ docker pull drupal@sha256:6c841cf61463791609dd8e2dc35e37fa3198bad25e2e9e5c1dad597f253d8060
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137421300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6900a9c6d7d470c3e51214c6a79ec404e25bdbab3e916e8fe136688489436a69`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:30:40 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:30:41 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:31:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:31:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:802898dac6df6269d2064c42c488119b88d7e309d5436667cca882bb1272d583`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6eb4bf581c009a39edbc602a9b5b8757ce55f0dbd83fef8cb169770d09b440a6`  
		Last Modified: Wed, 01 Jun 2022 18:27:48 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ea9583d84b376f7c8d5153c971b3172113d4692d59dc58f625e6e596e02e033`  
		Last Modified: Wed, 01 Jun 2022 18:28:16 GMT  
		Size: 19.1 MB (19118296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:1ae0b763d68b21a82cdb83b167f7d809240ebc13841ad6630f62b7c9d502300d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.7 MB (152700447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b43ce0516e727aa7a1eef171fa990c7704ef56b23dcd328c275856cad0cebd5c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:01:05 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:01:05 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:01:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:01:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:256f4c9e2d8efc3567ae3b1f4481efe23b40ca6b9cc3240e332624ba95493c67`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb2bc2c56d694251125f312a197a5de0c665576e3b8da28b4a1aaf4881c1e5da`  
		Last Modified: Wed, 01 Jun 2022 17:32:20 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:121896e69d0fd50dcead84690e878c2de1d5fb6a2f66c4915384364987411da0`  
		Last Modified: Wed, 01 Jun 2022 17:32:24 GMT  
		Size: 19.1 MB (19119346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:f5e59bd1e2462c56907ecc21c0f6d680e14591ef4141a72ac75f89a7a5c3da92
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166272096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d95e1734e0213ddf55abac3cbae0b4c8c04a437f1f6bf76af3c69e8e4b7ed19e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:53:39 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:53:39 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:53:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:53:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e53b5a20d52df57e68208d130be47d443b47515b45713ea13221d60ac31f27e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30564c969beb30711737e7e80cbc25c59b666c50e28d607a34cea549d4596217`  
		Last Modified: Wed, 01 Jun 2022 17:25:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af3d71bc9054f9e0f7bf506801f2ce6abd5ca04b0fded7cb8a50940f75dabc96`  
		Last Modified: Wed, 01 Jun 2022 17:25:46 GMT  
		Size: 19.1 MB (19119154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
