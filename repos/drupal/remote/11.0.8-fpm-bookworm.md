...
### `drupal:11.0.8-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.0.8-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.8-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.0.8-fpm-bookworm` - linux; s390x
