...
```console
$ docker pull drupal@sha256:c95ba94d9e8bb06e24b5b461e62fb69936abf67da47a7e517b2cfb760013c0b5
```
...
### `drupal:9.3.19-apache-buster` - linux; amd64

```console
$ docker pull drupal@sha256:444c78d9fb305d6369d6a2a7010956839a136bf4f65ebd77c2cd967490abd937
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168499280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed711b578ff080964bd333d5cb5fb6c7b99006e6cdb52bd585403167dcdeb5e7`
...
# Wed, 20 Jul 2022 23:38:52 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:38:52 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:39:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:39:03 GMT
...
-	Layers:
	...
	-	`sha256:1da7cbddd24c0a7c10dc3828697a1763fc344a9fb478f0ec04e46974b80e0990`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4efcad686c9a0572cd9fabcfb33d351bfbc6cae605ccc4a956f6dfa3a7cb0623`  
		Last Modified: Thu, 21 Jul 2022 00:01:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4115e016a098ca58bdf72c162d85f3d06ec5a5a1ca9673315cbaa895cb35d869`  
		Last Modified: Thu, 21 Jul 2022 00:01:53 GMT  
		Size: 21.2 MB (21217378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:8ee2736f09a51b4a2e0c84fefc37ba6cb9d98bd4695f2384edb1f5da21af7202
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143671684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7827cc38b4c16bbddc9c662e241097561cae8b426506ca6faaa70847cdc0787`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 14:23:17 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:38:58 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:38:59 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:39:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:39:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6fa2f403003aac0cdac76556f1121a1589667d131a24767c19872ccd8ba3fc5a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:824f06601fd3f027a6e650dd0366a1f0536d06f01ab4a6bc9524b151970a817c`  
		Last Modified: Wed, 13 Jul 2022 15:31:56 GMT  
		Size: 670.1 KB (670057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f621f6a87d80e6364e3a4f2ed5574bf188e544724ec5aaf315d5fe8155521880`  
		Last Modified: Thu, 21 Jul 2022 01:45:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7335230cf918d44793c4177ca98e342912ec6d0ebde09506de9a51837526dc17`  
		Last Modified: Thu, 21 Jul 2022 01:45:48 GMT  
		Size: 21.2 MB (21217354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:43b32edecf501eeb5f75ba6e834331727332f9558731b18fd1b6c0cd78779baf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159338162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85bb5cf061c61a884ae2e75f8385dc0cd8b8f287684d0d2276c6dfc7903ca912`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:09:10 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:09:10 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:09:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:09:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b946ea67a3dfe9096b183c34e54deaa336fac7fcc8a940958833f2ea66befe1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c5e2cb03c2700b70d4b52d2e64d073d0701b5d2f90edf438240c8dbabf36b0c`  
		Last Modified: Thu, 21 Jul 2022 00:47:18 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:414f1bad0e0f7151525d2149c44c96f9adbd0b04ddb7f7e6bdbdd1d9f129a48b`  
		Last Modified: Thu, 21 Jul 2022 00:47:24 GMT  
		Size: 21.2 MB (21218604 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:df4bdf4a0d8c79513fd17292a827fe84f2432f35a6a5817afc590d95d80dbb3b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.8 MB (173770501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ebe17baf3d304a538685a0c59d8d4d39f304eafb9ce789e38e4c0adeaa38010`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:55:49 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:55:49 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:56:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:56:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22060f52f99caf861d0d1854c89f9b73bde2d49f91ca3461753c06d2b78b4cea`  
		...
		Size: 670.1 KB (670052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d3c81ff7383c3cec8cc3b2dd75662b406a3d7185c51878cd7a35cfe5fe40e99`  
		Last Modified: Thu, 21 Jul 2022 00:29:55 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:189fd972aae10173687b34245a7ab46f33fbb3d6770407fa0b68ae4b793ce155`  
		Last Modified: Thu, 21 Jul 2022 00:30:01 GMT  
		Size: 21.2 MB (21218045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:f735378cb9d223435896f716ff16f4892a299336fc050887f492faba1a5c1290
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.9 MB (178929875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3e7b7fb29f03ea80456c1fc6f1f7c107a36202e9ceba67a647ef34f12469931`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:52:09 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:52:10 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:52:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:52:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:708ceaac077fdb88e76f1b089da414b60a6f720fa4abae676743d90a013707c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34f9cdb7ebe5b3f86d0e617c42d7ef77d04113c976b329fbf8baabb5c621a2bf`  
		Last Modified: Thu, 21 Jul 2022 01:05:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecf619f3a98b20e1b08a2f7a570776bdc306b5e52b2fc216ffe93cddb6ef542a`  
		Last Modified: Thu, 21 Jul 2022 01:06:14 GMT  
		Size: 21.2 MB (21217613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.19-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:3c6aa09c6523996dbb761d46f4e6bd134e5b88d2787768ce453f95e030197390
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.7 MB (153742255 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0bd4c2bd49ee2a047eac99dd66ee125f4a43434bb712c4f90467b85b9a950c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:14:29 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:15:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:15:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd587120d7dabde80d0e120cf6bea5808279f80772902c6bf1766dd90b684f27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b282c3005d557864687fef6f38cc160bd13ba4a0d8eceac6765b7c7bd1c19cc`  
		Last Modified: Thu, 21 Jul 2022 00:55:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a86ea5ac7a906431d58e2d9a696c4324838f4f5d5e00063c51513b1064a70ed`  
		Last Modified: Thu, 21 Jul 2022 00:55:09 GMT  
		Size: 21.2 MB (21217481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
