...
```console
$ docker pull drupal@sha256:3b8de81ada76d50cd9d9987ff9149bb48d7caa9c855c278bfa5a0a993f8eb0d0
```
...
```console
$ docker pull drupal@sha256:f7f457f7af35364df465f84f4eed38e520825fa015d84c4f1c9f4ea706b24ad8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.2 MB (191191883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0594674fca8dfd2ff0f9ceda94db66f33d4c03ebaf21dc910a996c98b992af61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:44:44 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 05 Jul 2023 09:44:45 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:45:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:45:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68e6d73802367a8a817d33861633d2eb104a03e4b5b32fe5042e0f2566e579b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e74fc33f3da3f2086b01e7134130347bfcafe8948e3047f28e86a4d510aac681`  
		Last Modified: Wed, 05 Jul 2023 10:26:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de333b8a3aa8f379cf1573cad02c49e88645bf4c9b347d934b1d5aa8da2974a8`  
		Last Modified: Wed, 05 Jul 2023 10:27:38 GMT  
