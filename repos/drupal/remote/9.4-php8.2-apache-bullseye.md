...
```console
$ docker pull drupal@sha256:449243c8e2d326c75e6812eca8ce106a2bd534d9572f3a73456646ba4e2c2344
```
...
```console
$ docker pull drupal@sha256:b3efddcc60c3306ed092a0036af74e690c6a86472fd6920cc215847f9a0ae750
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167550037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0165a59f7615dfcb2e3afca3a69ba9d66b882a92fa2a209fd97ab54e34432a67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jun 2023 23:44:58 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:57:57 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 22 Jun 2023 23:57:57 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:58:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:58:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9637ea0ef3564a7e73abee063e1f4bfa5ca555a9d828cf3ec658cccf094e41fe`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d33a23188ac6c28ab3d94be016fa1976024077338429f1009375e576a2ee3c35`  
		Last Modified: Fri, 23 Jun 2023 00:17:45 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4acbb9018fb03f1036fa4944585ea8b54e3ee71021ce5923917033a4f225c271`  
		Last Modified: Fri, 23 Jun 2023 00:17:49 GMT  
		Size: 21.9 MB (21915265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
