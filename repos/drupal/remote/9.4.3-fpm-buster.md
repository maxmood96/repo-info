...
```console
$ docker pull drupal@sha256:54e0be4f3986c85ec6884695e3e9422362fbca9dcbcf871f4f6838d5e23cf4f6
```
...
### `drupal:9.4.3-fpm-buster` - linux; amd64
...
### `drupal:9.4.3-fpm-buster` - linux; arm variant v7
...
### `drupal:9.4.3-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.4.3-fpm-buster` - linux; 386
...
### `drupal:9.4.3-fpm-buster` - linux; ppc64le
...
### `drupal:9.4.3-fpm-buster` - linux; s390x
