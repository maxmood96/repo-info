...
```console
$ docker pull drupal@sha256:6652402cdf080b84a902f2017fa3af765270c7be1667f4657036e54d93673110
```
...
```console
$ docker pull drupal@sha256:e2ce1d22977eb17fb8338338afe3f60d3a8998009092edd03d34961eeda8fc58
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **208.7 MB (208669495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3a76d08eae46761a59fd6f1fdbcebf59627be5a551969c7b78735ae200c43f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:959028abeb13400dc581e66b95e0d7299947a8f84c21ed6def1defe28b45c06c`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3ce0ec30581b87ea7f2f9a080faa4a191eaa676bb689e15dfdaca8b78a0b3b4c`  
...
```console
$ docker pull drupal@sha256:5115ec92a2578f957b57719d8333ed7346a92c32b8f994e7f36904ff499983b9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7073163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9255da0265026bba3ddc01deee1de7c947d9d0309afee415a4db14bf96e5914`

```dockerfile
```

-	Layers:
	-	`sha256:720282269032cf850848de495784aae1b6368f3da770fc06e8886f6e49a8df14`  
		Last Modified: Thu, 11 Jun 2026 10:37:49 GMT  
		Size: 7.0 MB (7029140 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c0f03b147fdf83e375d80ccdf0e8e4d5b19a6162bc1941ff597c2b5b6f350aa1`  
		Last Modified: Thu, 11 Jun 2026 10:37:49 GMT  
