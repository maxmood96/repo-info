...
```console
$ docker pull drupal@sha256:c3185454e322d74b065f4d8b169383fa8f88c4db77d7b56daae65f61ae2ebf67
```
...
### `drupal:10.6-rc-php8.4-apache-trixie` - linux; amd64
...
### `drupal:10.6-rc-php8.4-apache-trixie` - unknown; unknown
...
### `drupal:10.6-rc-php8.4-apache-trixie` - linux; arm variant v7
...
### `drupal:10.6-rc-php8.4-apache-trixie` - linux; arm64 variant v8
...
### `drupal:10.6-rc-php8.4-apache-trixie` - linux; 386
...
### `drupal:10.6-rc-php8.4-apache-trixie` - linux; ppc64le

```console
$ docker pull drupal@sha256:37696bf85c1239ca693b96fb1c036b3b14e541f28c9ca93e88646ef10ee9fc9e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.3 MB (200301978 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efbb9d29154c2dc50c57c73cb6bb096408d9247945fc6d222aebf09ddff97694`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6e45f41c4307ffee2dd1427c88a910dd67603c97a594fd68f3b2f48a8d2fa989`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:dfbcc01a999faa5d1df729e29594a5829e54959c51ff92016731507d596cc2c6`  
		Last Modified: Tue, 09 Dec 2025 04:45:17 GMT  
		Size: 21.8 MB (21847216 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6-rc-php8.4-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:216724d85f4dea25469a6a750132234838ae1b97809dc4eca077bba7bc00da33
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7373146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56d4081f5742f5b77b6a4ee94a4944adca2865d0c3c2cf356a86fc749f04dc6f`

```dockerfile
```

-	Layers:
	-	`sha256:ce09b524fcdd0800a21d1f5f92e5b070dde92945dafc5b9b69920767f068ab3f`  
		Last Modified: Tue, 09 Dec 2025 06:00:24 GMT  
		Size: 7.3 MB (7330059 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b61302a0e1d752348b0e50c0575092e87c54d4f1ea1326b341f3aaab24f6a721`  
		Last Modified: Tue, 09 Dec 2025 06:00:25 GMT  
		Size: 43.1 KB (43087 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6-rc-php8.4-apache-trixie` - linux; riscv64

```console
$ docker pull drupal@sha256:bfa38188c67af7cfa56edbdbf56c813a40ac4fb9ac8f1ab351db812d49d08f4b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.9 MB (229891061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:035675ec4227b9b49d2d223a6657b741202e53cf8caa7c3a1d9844989b7da8a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:17eb1c215afa7e054f111345dbd4d0006872eb595fe04bf76cc8266ddd5f8fd2`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b35b699dd74861af2b6b14639c0f53865c076fbc36ac4f94177c452659b12a8a`  
		Last Modified: Thu, 11 Dec 2025 10:08:42 GMT  
		Size: 21.8 MB (21847074 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6-rc-php8.4-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:5a237319e01554031211fe487066bec184327e06175a08da41f28914f91363de
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7447379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43394310627853d4acbf27d4d056b8f9ec0a5d17ebd10eca1aeeef5c0a48ad08`

```dockerfile
```

-	Layers:
	-	`sha256:030cd4df84d35e26f793d03aa52f9e4d363806ab1353cd3c4ad7b9c27452489a`  
		Last Modified: Thu, 11 Dec 2025 11:59:49 GMT  
		Size: 7.4 MB (7402092 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0ec7f750f53b115cd866d27ae6be5e53718ce8f6ab550e68a621663ebfd35b7c`  
		Last Modified: Thu, 11 Dec 2025 11:59:55 GMT  
		Size: 45.3 KB (45287 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6-rc-php8.4-apache-trixie` - linux; s390x
