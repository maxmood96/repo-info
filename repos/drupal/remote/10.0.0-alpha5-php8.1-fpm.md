...
```console
$ docker pull drupal@sha256:3e79657d9dbc33972e3547b51a7d07621eacb69d3bdbc39c1ad407392a235466
```
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; amd64
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; 386
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-php8.1-fpm` - linux; s390x
