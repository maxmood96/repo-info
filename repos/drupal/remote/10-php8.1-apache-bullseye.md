...
```console
$ docker pull drupal@sha256:439d231cff5f1ab27a7e3fefa51e5a6571ebe94145285a076e0f61256168e5a8
```
...
```console
$ docker pull drupal@sha256:d03c60548c9598bcb4339809c6ccda0d20e9a47b63d3d986ef49caa8ce68e7c9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.3 MB (187281926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba9d4bd490ad9ecc90cc75a0f856ade655ffe5ecc91c720678b7e1fe4d7fbb6d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 21:18:57 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:18:58 GMT
ENV DRUPAL_VERSION=10.1.5
# Thu, 12 Oct 2023 21:18:58 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:19:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:19:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e68497745a2d72dbe60f53eab6b7cb24cf0e2b940f03558125df69b026eeef5c`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7835b8fad1efeeb37ff0d5fca432780475d32acbfa3cf5bcf13e31615ffbd3e`  
		Last Modified: Thu, 12 Oct 2023 21:46:39 GMT  
		Size: 705.0 KB (705005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b76ca31c7042e0068801aa6debc75a5c68998aaaaa14b48cbf05390c1fea953e`  
		Last Modified: Thu, 12 Oct 2023 21:46:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbde8c8a8b66110f7cb9e5ef80a7f34aa9353d1b553583d67f0f6921a1a855b4`  
		Last Modified: Thu, 12 Oct 2023 21:47:03 GMT  
		Size: 18.5 MB (18542854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
