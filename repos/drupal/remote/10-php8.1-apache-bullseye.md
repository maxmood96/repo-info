...
```console
$ docker pull drupal@sha256:12892a3bc265e3d85160ced98d65af50390b74bc00f842441c5f2aa1e53ffc3e
```
...
```console
$ docker pull drupal@sha256:7cc5ace665d9743827713915fd283c426f7eb6be492ea786d97f56324bd72fb4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180204306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96e65952e4653c875577385eebfe7172f0999b07b6240dee8f4608dc548e737b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 19:46:30 GMT
WORKDIR /opt/drupal
# Thu, 23 Mar 2023 19:46:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Mar 2023 19:46:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4938427c5c414c1b38a5ca4771afa8488381c7dfa3a06e4ed626b46e2744fbb3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ad76efabaf5497bcab4c536eff669c13282825f28964d1e19e8ab71818077be`  
		Last Modified: Thu, 23 Mar 2023 20:03:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fa72888c4a8436cc214ecedf0eaf48d76a6741983a46d0cedc512753f41b44d`  
		Last Modified: Thu, 23 Mar 2023 20:03:46 GMT  
...
```console
$ docker pull drupal@sha256:597fa075910b2a11de5c9e79c47418de886fce017518c1dd4164a5c973607380
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.4 MB (186362773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24030d17c3afb6cd9749adf7b5f1222fbc0bcb90ded6b9e3ea59e6747efb93e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 19:10:39 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 23 Mar 2023 19:10:40 GMT
ENV DRUPAL_VERSION=10.0.5
# Thu, 23 Mar 2023 19:10:40 GMT
WORKDIR /opt/drupal
# Thu, 23 Mar 2023 19:11:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:4eb89dd43ab03bbae7c4b531d60afc46bbb61250296685431e1cad850cd1a671`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5274226946589265522ca363b35876e21911066f0392fb48b6109a72650560b`  
		Last Modified: Thu, 23 Mar 2023 19:23:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5156052b3394985b9f0a544c7fba9cbe7623a4580cde1c940770dfc1002b6d21`  
		Last Modified: Thu, 23 Mar 2023 19:24:01 GMT  
