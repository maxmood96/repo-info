...
```console
$ docker pull drupal@sha256:f96e495c151f9bb155762304339effdf20ac964c7875283acd61a921246ecdbc
```
...
```console
$ docker pull drupal@sha256:4f751ab569843f2b6373831a213f3a9cfdd67507907356582468b07f08b02ff2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.1 MB (181067660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92e3a8fcea1b8fd033e2c5db724c47fa8be84a3a14ed4b90f1c2dd927f3e2e1e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Aug 2023 21:22:30 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:22:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:22:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8e53badd076deec66607f049cdee243b1b3559f2053f484904039becba55c776`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4d39b810282ce58e82d5b6d23ab77d1e25d9b725cee2e47d35b3f6be03651ef`  
		Last Modified: Wed, 16 Aug 2023 21:39:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6918896415b5fc504ab9792f9f919d5f4aa5f2b66ef9111794ced288ec3cd557`  
		Last Modified: Wed, 16 Aug 2023 21:39:29 GMT  
