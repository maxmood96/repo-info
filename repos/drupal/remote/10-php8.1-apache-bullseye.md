...
```console
$ docker pull drupal@sha256:e9a3f85f28eed6148aa1ec515c8664d68debefd4c9e99c874ddbc210f3178372
```
...
```console
$ docker pull drupal@sha256:435d6c744c60f685fa394bf489d81a2017079084d9ceef2ab9039d8f80d2f62f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.2 MB (187198811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:526155b38523625aea6da30e52c8b42ddbfa6f1d939a17347c6205748d3e2f49`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jul 2023 21:23:15 GMT
WORKDIR /opt/drupal
# Thu, 06 Jul 2023 21:23:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jul 2023 21:23:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:687a5b5cd96d4310edcac06937702862fba3ef67d39832f2dc205a92987da15d`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc92b56b4176ad327ef525a4cea4d10e434a7045151d561360bad536e9403e9e`  
		Last Modified: Thu, 06 Jul 2023 22:04:15 GMT  
		Size: 18.5 MB (18505166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:82bc08c5b52352ae00a530509a644c5ea73a618e916aa0a781ab6ab3dfe151f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.6 MB (163631836 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d7653255a773a6546b07aa03c10027a50552433452628a396b618fe9ab9d0fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 04 Jul 2023 18:52:36 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 06 Jul 2023 21:45:57 GMT
ENV DRUPAL_VERSION=10.1.1
# Thu, 06 Jul 2023 21:45:57 GMT
WORKDIR /opt/drupal
# Thu, 06 Jul 2023 21:46:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jul 2023 21:46:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:27c05e65580b130ff9557af70c166200b5f2938769da77184f58c854c84f5570`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928d96a466e5d635b7622ba5e543e4a9d4e270ab4b64fd0c7ae06d973c71d567`  
		Last Modified: Thu, 06 Jul 2023 22:07:20 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d320b6c5babf791e833e5eb0de04523765db441d4670768c08a7f6c42af428`  
		Last Modified: Thu, 06 Jul 2023 22:07:25 GMT  
		Size: 18.5 MB (18504933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
