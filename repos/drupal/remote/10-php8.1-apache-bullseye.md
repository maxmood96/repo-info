...
```console
$ docker pull drupal@sha256:54f2f31e72611be3aaa22e97e6f8d17907b0e82405a4cf6db9bc9f4121d782e5
```
...
```console
$ docker pull drupal@sha256:864c333ef2e42af5fbc4daeac3dd7227153bdb0400b733470c7aa092a9b640bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155486790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae821b33170fd166f581ff8e77b5bacbcb831f09d30279d9824b86a22a8be5ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 17:34:43 GMT
WORKDIR /opt/drupal
# Thu, 23 Mar 2023 17:34:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Mar 2023 17:34:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9cc36c09f7f8fcdf4548022fdea0f99e9c02136de043e084ac7eb3b27ed0598b`  
		...
		Size: 697.5 KB (697534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:846096f58e9d23605894b3fd6b73a5b4c7eef3557f30019097ef5090711452d4`  
		Last Modified: Thu, 23 Mar 2023 17:52:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e43eec8b6468aa9dbed53d785df3b98dfc92c343afe45774c1d918374d0c843`  
		Last Modified: Thu, 23 Mar 2023 17:52:35 GMT  
		Size: 17.7 MB (17663869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
