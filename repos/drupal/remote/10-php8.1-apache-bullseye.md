...
```console
$ docker pull drupal@sha256:8474a95bfd2a8a15850abb09b7974d1fb52569871a1cae1292d8541d5ea69da2
```
...
```console
$ docker pull drupal@sha256:d3007ec02344d3e475ff2f4679849eb7d2260f9c1930971fab18f210cf4c5401
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185998751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a58676ce12c97060f8723ae8cb3058e8c12b7df17eebfa6174d56d9de55b577`
...
# Fri, 14 Apr 2023 19:41:35 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:41:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:41:45 GMT
...
-	Layers:
	...
	-	`sha256:d2f1aed646bc4579c7b83cfbb3ea5e3f6465882807476d46b6f15e024886397c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7836a3b061a73d89d40ad588429ea8e60623cc8aaa6b3a92d475e25bdebc7abb`  
		Last Modified: Fri, 14 Apr 2023 19:57:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4de6d27609b04cd6f7f57618b82d1ab3d37102104b58c2475a824fffe30bd49`  
		Last Modified: Fri, 14 Apr 2023 19:57:06 GMT  
...
```console
$ docker pull drupal@sha256:88c32c0271795167b8771020b95532bbb4fd7275b0ecbbe09807af9a47352e52
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180213465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f48497d153a150729ca401c2c47da88ce1e472d2195257fd72fa68940770f8e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 17:31:07 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:31:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:31:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd4fff43509cc000c5a03a29a4f9f0bb47e90c7ddfadb24eacf8d932d25646c0`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cff24a3c97c07743a3daca311baefb2259940bb44b2c4fe2febd7bfc8d02128d`  
		Last Modified: Wed, 12 Apr 2023 17:49:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8445efc419d72cdbd2d3fa80a4faaad4acc203e751d70c8eedcb322f7d55141d`  
		Last Modified: Wed, 12 Apr 2023 17:49:05 GMT  
		Size: 17.7 MB (17670891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:bb95243ce1c100644bf4438a186c43359d08b934fa83631ff627ba862cb14917
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.9 MB (188873359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0dd31f93005533f7e9c2c50b34a2ea33fd97709b344c5a26df71fb7133696fe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 23:16:30 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:16:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:16:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e765119355ee48779edfb77cffb144a3373864b3e0ad91e81aadb8efa7f18b7b`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c33ce86d3092730377fa2f054beea2bba7cd3c7659cbd440a0e6f88ad0c3f35`  
		Last Modified: Wed, 12 Apr 2023 23:35:14 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70ee03bee778b3493000afa6c22534bedc28a4cdf104fe7d8070191ce2b67ac6`  
		Last Modified: Wed, 12 Apr 2023 23:35:24 GMT  
		Size: 17.7 MB (17671236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:d6b882100643c003ba8ad21b3ea84ee615ac26413141cad7beb3fac5c7f41da3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.4 MB (186350701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df5197f0e3d721f6121efa122df94e34abc59c3c1db2df6ee8236d4591f44e41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:d92a0532bc3a9037cf789faf430ac032b14d76fdd7b6bac6f0a42ff93134146f`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6661b4d8f9dfd73f4313998e393b6ff2f97d78cc775bfce21a04110e034edf83`  
		Last Modified: Fri, 14 Apr 2023 19:49:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:052a41988e0a52e97bcf34de81ec2ba37e120bf57d83c1aefa4cd50cff2d8d7b`  
		Last Modified: Fri, 14 Apr 2023 19:49:38 GMT  
