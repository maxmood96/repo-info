...
```console
$ docker pull drupal@sha256:ffb3324849f21bc07ff676e8fc38799eec6db8e974283820b7fd4d04515f2938
```
...
```console
$ docker pull drupal@sha256:839c048195ab235f6ea5342a82e4c85ebf36dd047893dd828d2ff0683f5e74a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155473718 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f19a674701981dcdc97b9bcd8f533d02b8b422ad8cda56778933d07e627bd15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:11:21 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 23:27:56 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 23:27:56 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 23:28:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 23:28:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0984834f08a3291724f42d4b847a0e3a178e99efffb14b077dcc4287f995d398`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf192b1f2dbdc106f9734ca6d9247d2d9e1c37299c9a362969e05941a3014885`  
		Last Modified: Thu, 20 Apr 2023 23:45:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4faa4ad801991752cb0d78026e2229e11185fff69c5fa8bffccd66a401e8510e`  
		Last Modified: Thu, 20 Apr 2023 23:45:39 GMT  
		Size: 17.7 MB (17672810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10-php8.1-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f4d3298b9a129e9b59a79620c526659907a555cd5b2749bbc9df48b9212e1215
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180191101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:420d58afcfc28b65b65e4c02f0ebcd78cdfb494cc47c3320d74e99a99618d815`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:17:20 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:39:04 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:39:04 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:39:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:39:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26e7f2323119ab2c8ef73af48bc4fb56e5b95f475893208b2064597da1052ef2`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dda89e7be3055dbaee5e0b2262b1412ce7b5c600c55b937ded4d93aee2177ef`  
		Last Modified: Thu, 20 Apr 2023 22:53:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a81e1018ab6d1062c5b706988ea69b9d03f5b21a65040b0f372bea1a6221cc7`  
		Last Modified: Thu, 20 Apr 2023 22:54:02 GMT  
		Size: 17.7 MB (17673489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d1e9726d44c009a976b8e610721e04142ba642ae8caeaff485616f9057cb4645
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.8 MB (162785642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3cfd644fba361c2189d82210b63398b7dcb12f966ffaed6b497b48e81f9749d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:10:06 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:47:26 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:47:26 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:47:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:47:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:235713481276484f3fb1bf780287449016fcef4592f34ffaffc64aafeb59223d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e385df2e2a3e3952635a2a2fceac89c6fc45c173bf95a9265cb01f99f70fab32`  
		Last Modified: Thu, 20 Apr 2023 22:57:15 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fe056dac6065b2eb71c5f6469b91ed7b6247f1652f37c1c9ba02f013a6bdeff`  
		Last Modified: Thu, 20 Apr 2023 22:57:19 GMT  
		Size: 17.7 MB (17672142 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
