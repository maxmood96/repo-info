...
```console
$ docker pull drupal@sha256:9d7e2555dd2654cced42a4dfeb9aee9353050c0f36644a8df597a2c2184e2a40
```
...
```console
$ docker pull drupal@sha256:7d2ff745a39090643dd5b8be5a011ec76df2265bc4064d335282e7f1f82cb6fe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.3 MB (187298038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25446e5e41e074b82b89483088f1fd7015339686dd0832b1e187394b58b89167`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 11:04:27 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:04:28 GMT
ENV DRUPAL_VERSION=10.1.2
# Sat, 02 Sep 2023 11:04:28 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:04:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:04:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:58082892b1700eef45d480fda83bf17b05123e24903d75840c840fbe3071fbea`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ef542a24a69cb72d19f8494dda363034bf1f1b8b4e52720612e301785297c20`  
		Last Modified: Sat, 02 Sep 2023 11:41:46 GMT  
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13b0314ec1e27dca67fabfad37d91a42e01bd0951662d346d43825177c35d26f`  
		Last Modified: Sat, 02 Sep 2023 11:41:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70f8275d3574317b66135a66d8326893bc535a823d926d5075778e4aa21b0661`  
		Last Modified: Sat, 02 Sep 2023 11:42:11 GMT  
		Size: 18.5 MB (18512377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
