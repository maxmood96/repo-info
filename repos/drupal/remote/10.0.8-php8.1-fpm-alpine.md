...
```console
$ docker pull drupal@sha256:cd2ea1fe41a72cbeeedf7d4037bd066ffe70d4ed7f55479669b1aa0bf8eda463
```
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:b34e8b5f7f2e3e3987c44188156c6a16d291e11653dbfb33163c7364d71e8224
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48403432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a88adea872736197be32576ccfb9d1303580f490ec3f514a0b0f199b7cf2cf37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:28:14 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:28:14 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:28:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:28:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5cd19c55c225636b11f9b6332d12d66de44d1187107657076d67c8ecad015957`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d6aca5699bf6c4af24c8cae1b89bd862457a152f32d73ee9167c77ab0a7041f`  
		Last Modified: Thu, 20 Apr 2023 22:33:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5d10bdd4af2fa56d5103c2e72356004f93daacb32d911248b3127f1e69f589b`  
		Last Modified: Thu, 20 Apr 2023 22:33:23 GMT  
		Size: 17.7 MB (17664881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.8-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; 386
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:10.0.8-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:c7e6c64a8bc69b9ae72cf8a73078fceaff7d75a61f0937b74394b353c11429f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49009457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebf24f0b018115885aacb3288b85f25247b382d45feb388168a923b98b9b4000`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 20:11:40 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:48:01 GMT
ENV DRUPAL_VERSION=10.0.8
# Thu, 20 Apr 2023 22:48:01 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:48:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:48:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01d7694b0856a4fdc4ac5455b64e6dbbc573b07678f071e7e64fb92598b2b18b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fca0ea045dd4482b2e2dadcf6e0063de2fe21a05d5498ce638aa711d07158cd9`  
		Last Modified: Thu, 20 Apr 2023 22:57:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e07fd300964fe2425bf8c04cf3f59e84229d4a109dfb415ed8fbcbe00b13c2d3`  
		Last Modified: Thu, 20 Apr 2023 22:57:55 GMT  
		Size: 17.7 MB (17664829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
