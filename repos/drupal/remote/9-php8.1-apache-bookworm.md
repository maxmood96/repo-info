...
```console
$ docker pull drupal@sha256:d733abf325aceb6f14f3a455ae768dc25522f09510c7832f9c60bb16774d08ac
```
...
```console
$ docker pull drupal@sha256:21707c9e297314a77bdb778bde9c6e6340a88b64dc47041605e32685f6c157e8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.0 MB (176047441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:727b6586dbb60593c295dca98c25db9ce469234f5f0dafc5ef8866dab3b317a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Tue, 10 Oct 2023 04:21:28 GMT
ENV DRUPAL_VERSION=9.5.11
# Tue, 10 Oct 2023 04:21:28 GMT
WORKDIR /opt/drupal
# Tue, 10 Oct 2023 04:21:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Oct 2023 04:22:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf527844a243df8284e64c71f1be04de7cc37b1ad202a40d6c0019957685f78b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bc1ffe81fa439d396a209dd06e1bfdea30587197c02a0df2bdd7dd0b2e23026`  
		Last Modified: Tue, 10 Oct 2023 05:27:05 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735a722985c7d71fed2ce40dbce826ed8e70f7632f13c9014f26a418ac437f38`  
		Last Modified: Tue, 10 Oct 2023 05:27:09 GMT  
		Size: 22.9 MB (22878779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
