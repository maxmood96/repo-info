...
```console
$ docker pull drupal@sha256:31e889e5f61d5ab44e584c06028e6e2449479810d135ed2349ef5d7d1ff537da
```
...
### `drupal:9-php8.1-apache-bookworm` - linux; amd64

```console
$ docker pull drupal@sha256:ff73ac6613d50ddaa992ad81447967900d6671a03d1b7d9fb0553518925fe2d6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.0 MB (202976764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20cd4dec2e80c3d4d83e29a770bc361394d5fae0c9a65fb7d35de9e8eb48d3de`
...
# Wed, 01 Nov 2023 19:28:30 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 19:28:30 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 19:28:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 19:28:43 GMT
...
-	Layers:
	...
	-	`sha256:71cde5c5aca723320843cbaf87a7fe055a777f8db6f70bb07771ad6b8d7ab22b`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05f28dad3007ba7c8d7dc4698407a73526bda28005b17f56d071c1db5020d065`  
		Last Modified: Wed, 01 Nov 2023 19:41:34 GMT  
		Size: 2.2 MB (2200408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76dd98bfdb62adc97385535fafdfebb6a2a7f9044a4a7933cf3ba94e23095768`  
		Last Modified: Wed, 01 Nov 2023 19:41:34 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8164aeed197cadd9c9b35cef6e0e127e4df6e9e28314d0df3278c9342e1d4ab4`  
		Last Modified: Wed, 01 Nov 2023 19:41:34 GMT  
		Size: 705.0 KB (705009 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90dd86797a545d2c75eaec54b4e3ef68437bbb4c4391d407e646ac2118b02256`  
		Last Modified: Wed, 01 Nov 2023 19:48:12 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e90e0f1a5d148f4bfb7477746cc510ffc13ff52d714a531a04783cd0cc0ad5`  
		Last Modified: Wed, 01 Nov 2023 19:48:17 GMT  
		Size: 22.9 MB (22879289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:65d15d74457fff1c4c5f102f59a7dc1d16884e52df6095295788beb712a94470
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.0 MB (166963227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bf1597546c3e272762ddb71efc8f1b71b4d2b305064d023da5fb433725ee6ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:48:40 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 17:38:39 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 17:38:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:38:40 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:46:07 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:46:07 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:46:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:46:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8347f9841c5a8b3d7df19f592040c3e341fa7bd7c4e54c545b3d40a0df2e1a51`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cec17da1569ff64fd23f3a4b78a9d3cc8293f23a4f60431f40b505f2f110d4ef`  
		Last Modified: Wed, 01 Nov 2023 18:00:13 GMT  
		Size: 1.6 MB (1550660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c36cd1a3a26246449090d05d6dd1ea3dcffc4d7316d80891bff4811150baf442`  
		Last Modified: Wed, 01 Nov 2023 18:00:12 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a01cbe27009cbc9f7f56be1abb7be5fa22e46a5b459dceef4fdf97801c4e82e9`  
		Last Modified: Wed, 01 Nov 2023 18:00:13 GMT  
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8455514e700af918f8b085a7111c4f55667f0b50abedd477316f876d7ac15354`  
		Last Modified: Wed, 01 Nov 2023 18:09:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1655d64ad04b2d54e41dcd465bcec2cfeafdeaf70bcf2d026aa4e330b3fc88b`  
		Last Modified: Wed, 01 Nov 2023 18:10:06 GMT  
		Size: 22.9 MB (22880147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:bd8919043a6705f2e1de8b0f8a707341b4272c89cb9764223920217af6810054
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.0 MB (197040362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7b2f78fdbcc010df3da723795ec03a04645f837f05b2c6102661c0f60273ffe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 17:48:08 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:48:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:48:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c974a4c28800ea6a778db938895e4c390fc157834d29d365d9e4c33fab2aa961`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37153162da131c71f3e11f5e6e3be9cbeeecf6530131da5e5f9c09e83326cb2c`  
		Last Modified: Wed, 01 Nov 2023 18:06:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aa85f8145fd452d7bba31ba587bdcd70fb41633053dc90899e40d1cafd230b1`  
		Last Modified: Wed, 01 Nov 2023 18:06:34 GMT  
		Size: 22.9 MB (22880085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:ccb5eea76ddc9991006acda0d3f185d50335df18605972c76ac7bd81b1690e4f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.0 MB (201962597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c51184117c355ea15e284e755a568cd2ed6e511f5314810c11aedcdea68000f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 14:27:20 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 14:36:00 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 14:36:01 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 14:36:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 14:36:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:92f527f24544aaab7290aff2c02ed4c3d0ff760d030e4ba1450e2406ad6105c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:390465330bc5cd88d3d511c4b2841038fe9317d08c5a88026f3c531173bd2bd7`  
		Last Modified: Wed, 01 Nov 2023 14:59:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed53e76b484c383968474e4537927838fbbb4c26c2c68438554c074176201839`  
		Last Modified: Wed, 01 Nov 2023 14:59:07 GMT  
		Size: 22.9 MB (22878802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:bc43695d297f3cb002fc1cac5651ea57b7b54be46129a16a733b1863fa632aa5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.3 MB (207347664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38eba6dd3fe06c9b7cca68a197d4a2947ace4b1d0487348d7ebe511143a1028a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 15:52:16 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 16:09:11 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 16:09:14 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 16:09:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 16:10:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:da9f842cee5480d2aa80d4a08004e6ff409c220a65d4767c9773a56afec9cc8d`  
		...
		Size: 705.0 KB (705007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8271c0e901bbf697dd93b4e2a8711ca5f4b7e8c2fba21a4ac8cfc1666d54e224`  
		Last Modified: Wed, 01 Nov 2023 18:22:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51cb688fc0453d759e06b01a54e622ba552e93db031eb915c9a19f5192591176`  
		Last Modified: Wed, 01 Nov 2023 18:23:36 GMT  
		Size: 22.9 MB (22878926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:f0851d7805b693a575dde77c4cdbc537305dd87827145647f88989daeb503c3f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176191342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63ba11cc17d05ed3769db34b05713e6f842a381a39ec1fe061d8e7b8bb23039e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:36:29 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 13:44:23 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 13:44:23 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 13:44:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 13:44:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1ad2b06d2159b477e3596171cff044abd9b049274a0d5c0f37b2ee74de500858`  
		...
		Size: 705.0 KB (705005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9152b5f8e82864aabc5875848715d804173bbcb99ea40bcf0f979e08756d137e`  
		Last Modified: Wed, 01 Nov 2023 13:59:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9533c9c9337e6223bd8717e200c93e17b1aa9f11238d61e52d5ef8193f58ac90`  
		Last Modified: Wed, 01 Nov 2023 13:59:50 GMT  
