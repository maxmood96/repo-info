...
```console
$ docker pull drupal@sha256:64a82cf8fb2a7693c3c45256c5da28dcd9930d9f72812b420808dbb41ca98063
```
...
```console
$ docker pull drupal@sha256:2ec138f31d2accb2ee291a576caa850a0961a1975e773ba7b223516ae11f5ec1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.9 MB (202878980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a82560f2b5d48dc6dd5deec9135292a9af36dbdb4fb06ba387a461c9a15b45a4`
...
# Thu, 12 Oct 2023 19:49:41 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 19:49:41 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 19:49:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 19:49:52 GMT
...
-	Layers:
	...
	-	`sha256:fd37a56aa0137ea260cc8bdce9766362889c2e262625b8b7ada24fa7797f8d12`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09aa45b9a5fb52d864323cf613002169d1ded4888afe346949ac8fc6965add78`  
		Last Modified: Thu, 12 Oct 2023 20:10:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efcbb9790ccc3a486a23d093aac7765d9a358ecdf5559023dcb541ea6b21dfaa`  
		Last Modified: Thu, 12 Oct 2023 20:10:59 GMT  
		Size: 22.9 MB (22878826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6acb4b2994dd936c643319ce0ec513112eaf6667655692955e20e6adf5bcc218
```
...
-	Total Size: **166.9 MB (166866418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8b0534bf402062a64cf519a59d05d47316efd50d1693cd3721a5a6a264f1fee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 04:51:31 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 05:01:18 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 05:01:19 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 05:01:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 05:01:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d193ee264aae133880a5210e37b97c070495a6849f369aa63789352c0e27deb3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9c44eb2fdc4e0fee1e6ab3b2a238fbf1e72d8c8abe575b357db72f2a96fe6eb`  
		Last Modified: Thu, 12 Oct 2023 05:27:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:815907833eda3655eeb86e809f54ccf8bd75bc24a01150325f643fe1a3ae06bd`  
		Last Modified: Thu, 12 Oct 2023 05:27:29 GMT  
		Size: 22.9 MB (22879529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:dcd70472f19d56a04b4c19f76ac4d2d3a4c548f932817e45fca75977fe5af5c9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.9 MB (196947720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2724b88f8d6ed5c898f0a4ab37629a998300348b8ff05ae29f503e8f6d3579c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 17:17:26 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 17:24:57 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 17:24:57 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 17:25:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 17:25:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fbb065782f4ed041e06c95fe6803e0a6c018c04e61414b8c8c91897b53f92640`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41af05c8b9ca3d2f4dba2daba4b53dc3b61e8981f8a566b7140b51c8b9d240b`  
		Last Modified: Thu, 12 Oct 2023 17:42:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c2bc118b2527d00b23dfb2e79d975244ba6d7da14194f8d9adfd48524ec6ac7`  
		Last Modified: Thu, 12 Oct 2023 17:42:58 GMT  
		Size: 22.9 MB (22880150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:792c4399a3bef8e12753f88c0970d4506a03832f16fbebb8de5e2729addadeec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.9 MB (201866846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d30ae49163edd94588f358a3557235e38815365c399c00b6def302e2a123318`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 16:16:23 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 16:25:17 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 16:25:18 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 16:25:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 16:25:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb573dec67d7a189ef4d16ec08d07b6aea933f01ac1ee12b3a1d232fb086a073`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34dcaab47f71d6add75e65159b2699b5a4833d5c32f0cfad85434ae33c1132fb`  
		Last Modified: Thu, 12 Oct 2023 16:47:44 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64e3c052ffa6599cda861f26a18fb4391499ffe839f4a441f91d5c0a6f8ac11d`  
		Last Modified: Thu, 12 Oct 2023 16:47:51 GMT  
		Size: 22.9 MB (22879387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:c9274fd6cd8209af0b06f6d6b8ac771b3cdf07d57cdcf9b6cf0cd241694a4c50
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.3 MB (207251922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3433205fe627d174a6141454b23f03c251afef5806d0a370af7893c0586ded6b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:28:58 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 21:28:59 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:29:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:29:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:db1856fe187cabb292aaa1728df9000b2a9de8f24ae3a1a3d6f8ad75745407ae`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:708483cfd6ca85d4b8a16d85c0a044c7286bdee91fc1f632dbbea92d6f71fe42`  
		Last Modified: Thu, 12 Oct 2023 21:44:42 GMT  
		Size: 705.0 KB (705006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:892406b338bec86fbd6a1f40aa8de4486885f6967fa840aab86a85b360ca80f1`  
		Last Modified: Thu, 12 Oct 2023 21:57:20 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78ed410abc7c07561a432a7bb52771d00c2496aa073140f7240ab0b6548868da`  
		Last Modified: Thu, 12 Oct 2023 21:57:49 GMT  
		Size: 22.9 MB (22879620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:556157f4b3dd0a9d580688566f5b5cc6fb4ff335db173adcfda34efe4e437591
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176093941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2415c5cc087ebe552206395aab4deb2d872dfbe1985dbe1beb12e9792cddb7ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 13 Oct 2023 03:08:59 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 13 Oct 2023 03:21:07 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 13 Oct 2023 03:21:07 GMT
WORKDIR /opt/drupal
# Fri, 13 Oct 2023 03:21:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Oct 2023 03:21:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:049276659d002e655759248a1532f5f6def742fd030e03756f71fe1033dbbb94`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1abf7e380289330b2392533aa717bb0914f49b8095b95ed207148d44cb39429`  
		Last Modified: Fri, 13 Oct 2023 03:35:35 GMT  
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bafb6477ac9809446088ac22192841563248b41a92bb31c540fdfaa6b648bb65`  
		Last Modified: Fri, 13 Oct 2023 03:40:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:473e6bc855d3b2bd39127b670c2277570b5acebe3edcafb3dd74a90103f32184`  
		Last Modified: Fri, 13 Oct 2023 03:40:12 GMT  
