...
```console
$ docker pull drupal@sha256:312c03080f9ee75cabb680f2153ececc13336cd6ea352cbcefc6d532b172a505
```
...
```console
$ docker pull drupal@sha256:0d59c6c36302688c23f848eaf5f05e5971cc883c588054ced4b55bc22d68642b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.8 MB (202837432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf9c8f19ff0a9bdb365ad30f980409c930a054b5d62ed7d641d235bc3457bccb`
...
# Fri, 04 Aug 2023 23:53:50 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 04 Aug 2023 23:53:50 GMT
WORKDIR /opt/drupal
# Fri, 04 Aug 2023 23:54:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Aug 2023 23:54:04 GMT
...
-	Layers:
	...
	-	`sha256:67b7ce4e3f2bdca521b57bdbe303df2e05facda6a3f49bfb039c3ea8db7e4026`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8759fad854c7e398535c16d159acc3a5f45e113af229737ecd4e0d8e7a03a0c0`  
		Last Modified: Sat, 05 Aug 2023 00:04:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50af776c743b85708830b266132e909f746dd09a3646e286fcac39a8d6c5ca10`  
		Last Modified: Sat, 05 Aug 2023 00:04:25 GMT  
		Size: 22.9 MB (22880172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:38166c642a9381736cc75253c3183f424c4f50c7af85b070161dacd7cddbf66d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166908146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8683b558ca808388f6edf04239006438472b1d81ccc305182e8a0d624fb7d3e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 05 Aug 2023 00:28:07 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:34:29 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 00:34:29 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:34:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:34:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:63ba15ea7fbe2e5808e433dbc851305d530f7c0b815bffc14ad99be3c683f5a4`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47d959d38fd696040ca645ddd34273f5b042b050040aaedbae8b05fd4291d9c0`  
		Last Modified: Sat, 05 Aug 2023 00:44:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd233c10b30615711e293e8d6a6ac4228ac2e9f86de9fa3aba38b54ac6a9f2d4`  
		Last Modified: Sat, 05 Aug 2023 00:44:37 GMT  
		Size: 22.9 MB (22880523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:15d95b85031a1aa7b2ff7d90070ddb8cdaae7c7c4180fec5c66832249a03833c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.9 MB (196896591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c1a516f7ae6f75e47987a49074ebf2a7356245c06cdfcf0d78588b5821aaa90`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 05 Aug 2023 02:03:13 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 02:03:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 02:03:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2cebe760bf844eef269f5259d1f1a53021f97d9f1214b15057fb43e3eaea82d9`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af0036457e43575f375fc425bdcc7cca60ec4e6d28f9e9dcf77c1a5bd861f871`  
		Last Modified: Sat, 05 Aug 2023 02:08:13 GMT  
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:218daff46e13ba44a79f2c4650c69b9f5422ed2a9172e473bb72edd46822885e`  
		Last Modified: Sat, 05 Aug 2023 02:13:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:285551a5295e1eba9dd5dcb3ccb11eb4fed93368cf1e987f0f73c4039cc218b5`  
		Last Modified: Sat, 05 Aug 2023 02:13:11 GMT  
...
```console
$ docker pull drupal@sha256:fb0e540464585589c2fa6e84f5d3252b4646fb4621bf60745140ecc436f5e8dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.8 MB (201811690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00e40b2b5de06424f42b05cdad6f46d0a67658f89a5e9264de61ebaa8439c8af`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 02:53:44 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Aug 2023 02:53:44 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 03:03:13 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 03:03:13 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 03:03:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 03:03:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6ea1edcd03f57458b127cd701774d66d4c737acae4d10cd5892371f2b7229ef`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:770ace73770d4cadbe9c91480841785ea7a61b907d8f24b83366bbed47e06236`  
		Last Modified: Sat, 05 Aug 2023 03:09:02 GMT  
		Size: 2.3 MB (2250189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b9bf0bb8be562bb687ecf61407e23b9ec0b4af4a8afaba2837c70f8d7437701`  
		Last Modified: Sat, 05 Aug 2023 03:09:01 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12c76717821431046d53cfdb92c0c29868a58e38f157eade8eaeeea3c98bff6d`  
		Last Modified: Sat, 05 Aug 2023 03:09:02 GMT  
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:845ee403f64dfaeb71f86691ed8c4a0f9cecc86138ed256052807a26bf0d09d4`  
		Last Modified: Sat, 05 Aug 2023 03:14:25 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cf4b870ae44ea4b7f738e4dc5bd4fba92382deadd75d200768d357e61ccc18a`  
		Last Modified: Sat, 05 Aug 2023 03:14:33 GMT  
		Size: 22.9 MB (22880111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:54af743a8123e26f779f03aae9e8f1b07b97fefd26b22695ca8f432d970444a3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207212391 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96a6729eefe0133c0d9cc60e9ab17537da4cbc3d9d2d7ac393de89b39a1f219b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 05 Aug 2023 00:25:42 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:41:31 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 00:41:32 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:42:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:42:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:949c7b99db940deee8eb57ac32a8e971b322fa5f6226714234d4b4eda61bbecb`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1195f6a17093a986d205a26fa057d1f1351e053fab8c693df6c766c255ab1146`  
		Last Modified: Sat, 05 Aug 2023 01:03:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f4be58251927882a718bcf00a6012d36aba03913ebbea17e6cbb59c7139e100`  
		Last Modified: Sat, 05 Aug 2023 01:03:50 GMT  
		Size: 22.9 MB (22880333 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:4cd6dfeb20e3fff4cc5642c4b043fe0b7523837cb5fe21f10aabdc13f5f37806
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176052825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26cb5bd5ea0c1c80decc0ae2c89629d6652a9b1fe9ed03016c319e78d464c6ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:36:06 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 00:36:06 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:36:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:36:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1a470f3ecd243f04edca1e7c908cb7dab3a849e8a19a5a256dfcca0a7a544fe8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56e15b34a64a94f0c95356a181f2333193ab5f18f9994f353ffe24da0d503fac`  
		Last Modified: Sat, 05 Aug 2023 00:47:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9aaa69fbaf741d1ac6b48981f435e2ff0751f276bcce80c48271ba4d91059da`  
		Last Modified: Sat, 05 Aug 2023 00:47:26 GMT  
		Size: 22.9 MB (22880442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
