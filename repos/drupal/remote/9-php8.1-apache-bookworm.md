...
```console
$ docker pull drupal@sha256:0ebe2df01636bab505396538a372063fa94cb9f9a76d3f35f65de4e5c52a48bd
```
...
```console
$ docker pull drupal@sha256:f44a9e2b8f025af9760f46a5189cc77eb27292a7adac849186a4c9a51cd153be
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.0 MB (176020238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:250d24ed1e2abf89fcd4eafbd1cd703daf5b1713d19a04faf9ddfe2dc3878036`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jun 2023 23:47:00 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:52:55 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 22 Jun 2023 23:52:55 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:53:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:53:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e3d88017c224db0a044ed1c59db6a0a368106fcb9ca5ab994e990fa097321fec`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:966e729370707baefdab4538f4c14d577fc36471b516f02bf22d3dcf97f777f2`  
		Last Modified: Fri, 23 Jun 2023 00:12:35 GMT  
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28b4242f825f6d3fb68efd1e3445e9f5028233fb0a822607c76410eaa4d7613a`  
		Last Modified: Fri, 23 Jun 2023 00:15:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4e04a3aa2e701db54da74c7e8c12093ba2710e0bbbda48e7fcf7607f2c12e10`  
		Last Modified: Fri, 23 Jun 2023 00:15:27 GMT  
		Size: 22.9 MB (22878576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
