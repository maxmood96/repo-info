...
```console
$ docker pull drupal@sha256:0637e40118222da1718bc49587dca01e2e29ee7da33459928ab166112df54eff
```
...
```console
$ docker pull drupal@sha256:fc1fadb9f9a7f15f7f20bc06a3ee9eebde649bd24f07da166b3c4b3a2e68b470
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.9 MB (196897729 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:219490d92c3994f94c631352eb996bb5a9e7ffa547602af5b26470f9856fc032`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Aug 2023 21:19:38 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 21:27:12 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 21:27:12 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:27:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:27:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ce19fcef3cd2620830bbb1505b0b0684436160a72dd9581896bc17f0414b20d`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1e9e0edc4c0a9bbfd5134b7f01b7d0e5191741334d6ac550128a95da1233f7b`  
		Last Modified: Wed, 16 Aug 2023 21:44:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48b33b215c3e3018ea7846805135fb66f6adc74446258cd0686dd614dd2c6eaf`  
		Last Modified: Wed, 16 Aug 2023 21:44:24 GMT  
		Size: 22.9 MB (22879974 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:bb85a2610d088a5002f1f24fed24d10fff3a2a91f2b309c4efb1d77cd5c399cf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.8 MB (201811990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cff936b65e9663290dcd84ff0b4498491f4e03ad503d7383c7301323f9244e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Aug 2023 19:10:37 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:19:09 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 19:19:09 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:19:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:19:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:63572c7b797499a78fb07665c1d49c3f3b92302192b231b428563e1cdf0c3d7e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0aeeb02f17d7074f4cc6eed0d9d50d4b23fd42abc9687757484e216ba109a47`  
		Last Modified: Wed, 16 Aug 2023 19:40:00 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:531acf05c524dc94553fda776be506438d9148b455070c5d8dd16ce06252c054`  
		Last Modified: Wed, 16 Aug 2023 19:40:07 GMT  
		Size: 22.9 MB (22880504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:27dd4ed9a66057d6eb37650e19ab8b91192a3155ce043b831cb231296bbe11a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176053117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73b76b78587f7f487155ffc7cdae8ce8d02735621a4a47caf4634abfebcaad4c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Aug 2023 19:52:47 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 20:01:10 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 20:01:11 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 20:01:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 20:01:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e76c843166719ac163a3a535d31fdc60de40f4e45986ae83dba1f56afcb8ae82`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4066c517514664f416edac24f882e267fba967772d73526ac93ab6cae26a1d93`  
		Last Modified: Wed, 16 Aug 2023 20:16:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c37d937623dd0a1776ea1c048bdfab8ca77e450ab4761c5b427327e19d5601b0`  
		Last Modified: Wed, 16 Aug 2023 20:16:58 GMT  
		Size: 22.9 MB (22880566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
