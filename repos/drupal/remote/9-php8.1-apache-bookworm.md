...
```console
$ docker pull drupal@sha256:04201e68f5b5f23701a5a673c17c46326cee8a29a3f9f85489567c047d842f06
```
...
```console
$ docker pull drupal@sha256:29788f7ff1b536926bf1affb1525c142bee43fd1e9fa29f6b0cce44055e5e4cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.9 MB (202906105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c33912c51deb704ffe37adb0645c6e73d20e9620d688ed75841509f1af5360bb`
...
# Thu, 07 Sep 2023 23:41:57 GMT
ENV DRUPAL_VERSION=9.5.10
# Thu, 07 Sep 2023 23:41:57 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 23:42:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 23:42:10 GMT
...
-	Layers:
	...
	-	`sha256:24a0b6eeeef3fecb763c31f9232f20e1a29c342bbfe9c22148158104371fa78f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7af0abdb8f22cf43c34f20f78e98502b913cfeddc2e0d1fbcca934127e57970c`  
		Last Modified: Fri, 08 Sep 2023 00:03:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8362e79d8f27a9e441264a807cbd24cba39ccad130e8bbe7fdd848630efbcba6`  
		Last Modified: Fri, 08 Sep 2023 00:03:11 GMT  
...
```console
$ docker pull drupal@sha256:1fa9acbb780f038fc2dcbefb1a7438c13909ce9bc40334a6393adc5a77aa1837
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.0 MB (196963956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:916add3453c0d2842e2f3b7124db4d3514867f224daf7f7657b8d053ea42ffc3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 Sep 2023 19:47:25 GMT
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 19:55:10 GMT
ENV DRUPAL_VERSION=9.5.10
# Thu, 07 Sep 2023 19:55:10 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 19:55:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 19:55:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a9f562c903b583747f7bffd0447023258deae5c21ebaec06b245e8a5b4425c4`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:350c07040239903aa0644b3c81233809323ecb7e0176d3121cdfcc70f1d889f3`  
		Last Modified: Thu, 07 Sep 2023 20:13:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e2b68723c4d91a0845715b2f69a1b227e06fa9d26691a8304e88ec4ab5f570b`  
		Last Modified: Thu, 07 Sep 2023 20:13:30 GMT  
...
```console
$ docker pull drupal@sha256:60cb50a325e5b67089d642fe0f7816a38f6fdb1b48361c49bf0ec0c026173696
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.3 MB (207280570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25cc6432519d2f8629dd2e0d24062bdca71963f2ac8bc55acc6a9c4b2ed322ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 18:14:18 GMT
ENV DRUPAL_VERSION=9.5.10
# Thu, 07 Sep 2023 18:14:19 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 18:14:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:cd8136ea3ea23ba4919e1e538caf184fda5913960f0c9ca8dc2b155030e5163d`  
		...
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f855fda2b3b34f10a656a2e4e3b33f1a18dc3717608635ea3356d5602d02958b`  
		Last Modified: Thu, 07 Sep 2023 18:41:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8e6f38c535be762d5eea6cd5c14052a9eadca425f25c687fc8b7c7d92c2ad89`  
		Last Modified: Thu, 07 Sep 2023 18:41:47 GMT  
...
```console
$ docker pull drupal@sha256:eea9740168d7acb5a4fedec15208c8e9c3869cd965f331936acaa37c1d114d69
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176121469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d48d9140cbede8879fd3cb93ebc4dce1344798be4297f6ebd91ef61ef02c4f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 Sep 2023 18:13:04 GMT
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Thu, 07 Sep 2023 18:20:42 GMT
ENV DRUPAL_VERSION=9.5.10
# Thu, 07 Sep 2023 18:20:42 GMT
WORKDIR /opt/drupal
# Thu, 07 Sep 2023 18:20:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Sep 2023 18:20:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:27f0b6480e1ee5685d82828cdfce0e7b54f22a1b7fb3351002f108098401d88d`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61ad0a41b36bb32df3e410ddd5c51520ed032d8cbb443461669361cecd9bcfb6`  
		Last Modified: Thu, 07 Sep 2023 18:35:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0e2215385fcd711d611aa73352e386baa4302ee03f820137e6e3a0b7446d56d`  
		Last Modified: Thu, 07 Sep 2023 18:35:51 GMT  
		Size: 22.9 MB (22880025 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
