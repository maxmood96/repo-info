...
```console
$ docker pull drupal@sha256:1c6ae72527e440e544350664e3f1b23209a03839ad42ca2d594dd7a076fc28e2
```
...
```console
$ docker pull drupal@sha256:49754809c9c5cb7d59ac08d8cdbbb42d5adc68483dfd4061ae37680074ea791d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.8 MB (202830625 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4db687d6cc1439b26ff0f0f5d21587f02ab180fd2f52db0f95925c580119e944`
...
# Fri, 06 Oct 2023 18:45:24 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:45:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:45:36 GMT
...
-	Layers:
	...
	-	`sha256:b5dd750cb52c299d881663be380d8304df7778109fa9f317c7c9bc6cdd1b8461`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:feededaa932b4c1c9d7aa6c721e9826cbde1918aef58774c4c566ed22b911ede`  
		Last Modified: Fri, 06 Oct 2023 19:05:40 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0acb52fbe3658e96dbeee3fb1900d3084e1a3435761093309cbb385f47c11a82`  
		Last Modified: Fri, 06 Oct 2023 19:05:46 GMT  
		Size: 22.9 MB (22878703 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:cb7e21977068b297af7642de7b65bda468a27d90ff71ec5110ff6d03a7e7cad2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166904614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2155bcbf4d6a9c0734fad4d01f8ac8441f0e1f6fa7a834e8a6ed716d128776c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:30:50 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:30:50 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:31:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:31:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dd1ebfedc8daf1b248555671f1000bfc96d4070859a975f5f41ef3bd1132584e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01356889751f12a8b92c5566bd2cce84cea19dcaa9b58bcf06a9d0a47660337d`  
		Last Modified: Fri, 06 Oct 2023 19:57:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2d4ffcf2818c66b6a29c6667e277d77b1d8e35ab0b553fd60c32c3392700e5a`  
		Last Modified: Fri, 06 Oct 2023 19:57:22 GMT  
		Size: 22.9 MB (22880686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:27b33af6b2b30456bb05734df765956eac007db97f22691507c5d3a8899eb5ba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.9 MB (196889897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4cb2dccc32bca369712afea06e96d874ffe9dec5f7af05d2a81f26e591f6195`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:16:55 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:16:55 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:17:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:17:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c5257c48ccb51d9eb46e80ba77bb29724fb19d10015b640e7945e565ce7fbfa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8721296caad1fbcb3e628adb0508bdd1d00b4545fbbcaf9de5f420a21db446e8`  
		Last Modified: Fri, 06 Oct 2023 19:40:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d1c881164d6e3e65f6f83da21b0f34e7fd91d7c794e2150810b9c768a1d65b6`  
		Last Modified: Fri, 06 Oct 2023 19:40:39 GMT  
		Size: 22.9 MB (22879109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:069e9c83595fe3767ac5dbb25b0403e6be65d6f9a94fad41285a181bf749f1d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.8 MB (201808412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:526838f6df440ab074987e1fdd06b189b23894f033f8af0bef202c0ff04137d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:17:39 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:17:39 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:17:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:17:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:701e9ff6e376340139c2ac5e5ee0dbb0d7060574c1adae0af2ba6cfea318b1e7`  
		...
		Size: 705.0 KB (705004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:917060164b43537abee37ed933d95b14d33ab53309db704494d1417e6bf527a9`  
		Last Modified: Fri, 06 Oct 2023 19:44:30 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:728071566bf3ba69248398ea5ba07debb7b90501ad1ddc73a2d0b8d48b8edfee`  
		Last Modified: Fri, 06 Oct 2023 19:44:48 GMT  
		Size: 22.9 MB (22878713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:be8b7265bf430448d047153eb5d5163454b25439ff0de042d6c21c8e8a28be65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207202912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3138dd06dfed66d4b3ecf7992c22990cec0fd3ec4035b671e87590454d08e40a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 18:52:24 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 18:52:25 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:52:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:52:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9386e150dd501cac750da4efe70431ee5914e0f2bd9acbf22353da97131dbb4`  
		...
		Size: 705.0 KB (705006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e6e10006a6de9e34cd655dda96d92f84df69c805658a4492f4684f72791545`  
		Last Modified: Fri, 06 Oct 2023 19:25:35 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed4170286032d351c93df323a23934a685594b5abec0843b53c178aa257793df`  
		Last Modified: Fri, 06 Oct 2023 19:25:59 GMT  
		Size: 22.9 MB (22878861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:8af8b5b7ab7d9f2c0d53a0bf2f7af1e7b920bef6eb1596e222205f1bedad11e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.0 MB (176049195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d67020c6ed27b7160cea06bc1a1027d7c2d2bfc30b6d75d314f2064fc21209ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 08:19:00 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 08:19:00 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:19:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:19:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0df7e6cdbd35fc97b78d9d37f7faf3fc1f98010fbf93423cf7d4bdad2717e064`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72aa64e2e1f00fed7bc0163b0c94f392e925f7c1a448d5442bd979c99bc174cb`  
		Last Modified: Sat, 30 Sep 2023 08:52:14 GMT  
		Size: 704.9 KB (704945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95a03fda17d5ddf41abd54246bc029b2fc29fd33c12b6a0950d0630a16c5e0a7`  
		Last Modified: Sat, 30 Sep 2023 09:22:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14498e6ef7c204632e2661243a6764773e3410f0e2a54bdff940d7eca82e2ed0`  
		Last Modified: Sat, 30 Sep 2023 09:22:23 GMT  
		Size: 22.9 MB (22880596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
