...
```console
$ docker pull drupal@sha256:e8f1e4d11bd973f1e78c618161bcf0322388a1ab6f655525697c190c2138c86c
```
...
### `drupal:9.2.17-php8.0-apache-buster` - linux; amd64
...
### `drupal:9.2.17-php8.0-apache-buster` - linux; arm variant v7
...
### `drupal:9.2.17-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.17-php8.0-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:1befe8f02a4119ce109bd9033746e67f580807c0d9a257efa3325cba0fac6a64
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171810474 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8977d4c9649950c22bd83d5ea5f5ea8bdb7b6379787982f49df948155495929d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Apr 2022 02:26:07 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:26:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:26:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0afdc5b35a610b6cb2513d12f96c464d5646287c1bfda20f675edb82bbeeb876`  
		...
		Size: 661.6 KB (661587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec2a1dfb932b4da4bb07ef186910fbe1b777795b0648313cccfb2739ffcbd398`  
		Last Modified: Tue, 19 Apr 2022 03:59:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b1a1989bca6b268039dd0f69e3e557fd70f41f73009483895c0f02891babf18`  
		Last Modified: Tue, 19 Apr 2022 03:59:26 GMT  
		Size: 19.1 MB (19127031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php8.0-apache-buster` - linux; ppc64le
...
### `drupal:9.2.17-php8.0-apache-buster` - linux; s390x
