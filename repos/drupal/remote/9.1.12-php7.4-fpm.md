...
```console
$ docker pull drupal@sha256:90b93a0de1c537ddedb5fc1cfe6655f1f7256b3ea3aed74d7c69f42deabdced8
```
...
```console
$ docker pull drupal@sha256:37b38b7fc62920f1e9be1acd09baa802abd3cc4f5f2f6df11694ef7f4e9f960c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.8 MB (140832673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45792d68ef8702d9efb22b9458230e059cf95fed1b4008089498c7bc6570af03`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Sep 2021 17:55:10 GMT
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Sat, 04 Sep 2021 17:59:29 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 17:59:29 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 17:59:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 17:59:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:da0084caf370ec143e4935a02447ec7ac2a5e9e789bc5a3c485da225c7ea185d`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e41068e99b96890745794cc556ae98c0965ff24be71b356129373bd2cbd62d6`  
		Last Modified: Sat, 04 Sep 2021 18:24:53 GMT  
		Size: 554.6 KB (554576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72d910de1ff78a7b29965164d3263f4e69956697ec4c900f1c406800ef5bf7a7`  
		Last Modified: Sat, 04 Sep 2021 18:29:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a95cff09c9aeb6d1962d6f8ea0515435017f5cb428d24618d0da010b53c17f5d`  
		Last Modified: Sat, 04 Sep 2021 18:30:15 GMT  
		Size: 18.9 MB (18875344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
