...
```console
$ docker pull drupal@sha256:8081ff2b0fa4f9c45879e0f24e3f7ca5e324d77ba67e1906baa2a873b0159635
```
...
```console
$ docker pull drupal@sha256:4888f3fd0db75ef3d43a80f3ba76b3e725e91c49905abcf522f793325f3d9a7b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (163968183 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea5a487bae606e3d6d0b56e04be049d2a2e447bea21e0f9814ab116ad354e6ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:49:00 GMT
ENV DRUPAL_VERSION=9.5.8
# Thu, 20 Apr 2023 22:49:01 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:49:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:49:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:13e2fa2888ec2a39a34279bdd5572065d73631b8ffb4f3055c83b65c8fbcceaa`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba52bcda097cd772bc3446a594dc9bf2a639bded2e96ad55bd9ee1165d2b25bd`  
		Last Modified: Thu, 20 Apr 2023 22:58:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e747a9e56b6fc4887be06074fa3074ffe0e569dcdb0f482a2c48f9ad0e6d22bb`  
		Last Modified: Thu, 20 Apr 2023 22:58:51 GMT  
		Size: 22.9 MB (22866832 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
