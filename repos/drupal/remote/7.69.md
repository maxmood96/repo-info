...
```console
$ docker pull drupal@sha256:198acc4dde74efc7d54269ec34dd01462d59922cec61584c939d464e3a3ed3f8
```
...
```console
$ docker pull drupal@sha256:ec6ad43bd5912478afd89bb03a795dd5c5949f22fbd3ad4cbcd5ca72da9e9dfe
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.7 MB (125713372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bc71f1b79166ce4c3e1215eb64d878b679830181f3134af36c3950a77882c61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 19 Mar 2020 23:57:13 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 19 Mar 2020 23:57:14 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 19 Mar 2020 23:57:19 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9c623943e60f1d4b17993bee65d4b6dd6419f9eed6ad1b0f7c9cc0e943cad814`  
		...
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4ae5b40beb32a85063208d409ebc1ad929c382133bcb32c3afc1a477c42775d`  
		Last Modified: Thu, 19 Mar 2020 23:59:31 GMT  
...
```console
$ docker pull drupal@sha256:ce99d34bd0fd0900817a9dbcc883efc6370356b305d6204c516318e1f054630e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.0 MB (132973173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62bb5d1333140ec5950b18efef46ab557cafe133da63564c853706f2553d3a04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 27 Feb 2020 06:27:28 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 27 Feb 2020 06:27:36 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 27 Feb 2020 06:27:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f663b2f3fe079d476d4a61943e82525eff1c010918ca7ff05ffd41f4b04c0df4`  
		...
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:123c4137331d6d7d4c023969fad2d67811c898917988ed36bcc08c0441de6972`  
		Last Modified: Thu, 27 Feb 2020 06:31:19 GMT  
