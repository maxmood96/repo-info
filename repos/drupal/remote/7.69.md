...
```console
$ docker pull drupal@sha256:9a7afe6d7a262009ea06fb1aab64907d48dea31a1f53d32d870e54e67af56610
```
...
```console
$ docker pull drupal@sha256:ebf9b00799f3104e7ba346f817cc54b1660cd33197ad32fa5dee5f64dff0c066
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.3 MB (138308795 bytes)**  
...
-	Layers:
	...
	-	`sha256:ecc0df24f7d2644bd188dcfc4e39c565b02e60406c924ef13c2dac892574212c`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ed2a219e5ea8f54346c142cd4a7e0d6a87af4a07f9a499017435d2e9ca91f37`  
		Last Modified: Wed, 01 Apr 2020 05:51:26 GMT  
...
```console
$ docker pull drupal@sha256:a968751053e926bb118665bbaa9394df4282087cd4f30340a47211efac337c81
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.7 MB (125716683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0e11770eb11aefd0286070bd670e0ebbc31e4973317708f1898573829b71cb7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 16 Apr 2020 22:51:54 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 16 Apr 2020 22:51:56 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 16 Apr 2020 22:52:01 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:07aaef938ee758023d6686d9fd55a76801c9253690888b4febd3fa05be10edee`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ea0832b29294c68d707f1b35cc7288520a476c970bc4257e367fb4361b5cf64`  
		Last Modified: Thu, 16 Apr 2020 22:53:59 GMT  
...
```console
$ docker pull drupal@sha256:e2842a7b6a5ee808830429a384af6df4f4cb461757f2e56d1c133003b497babc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.7 MB (118656716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1163146b5066bfe6fd105dbd7dd408c428290f4c9dd705a6caee519597e472cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Wed, 01 Apr 2020 05:39:01 GMT
ENV DRUPAL_VERSION=7.69
# Wed, 01 Apr 2020 05:39:02 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Wed, 01 Apr 2020 05:39:05 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7373a57ebedcb1e5fb3b662680063e7d52a169189d2603b41a7e3f15e39b8fdc`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:848241b4f30e3f4dfd8c9f1a156b906b703e21aa20650a7a8e39778625c4c897`  
		Last Modified: Wed, 01 Apr 2020 05:41:19 GMT  
		Size: 3.3 MB (3335074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:58422b9a324a6cfa222c1ba8b6ece003d156d57e75e7fc53352922fc9b6dd071
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.9 MB (124866492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:417b23ba3b46b8c65c358c3deedfddeb00325c28ee5676e7df7143c65ff08955`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Wed, 01 Apr 2020 06:58:29 GMT
ENV DRUPAL_VERSION=7.69
# Wed, 01 Apr 2020 06:58:30 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Wed, 01 Apr 2020 06:58:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bb7a2ea92553e69d366d5b9c542f0fea022474f03b079efbd4d63afd5551b104`  
		...
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3738861b2fc95a59dd7d2ae677cb47b70c2e08b3305964b38182f310db2bba3`  
		Last Modified: Wed, 01 Apr 2020 07:00:27 GMT  
...
```console
$ docker pull drupal@sha256:76a53d8fb35fbbc787aa8821aa1552cbcf423d0fffccd258a1d1cf6a40c63d26
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.8 MB (143836482 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23d454bcaf93acf8724b493ada3f15d00abd5426d006f8db4f97ebdb3df993c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 16 Apr 2020 20:27:49 GMT
WORKDIR /var/www/html
# Thu, 16 Apr 2020 20:30:18 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 16 Apr 2020 20:30:18 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 16 Apr 2020 20:30:20 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6c109a3560f5ec8e162b512655bfb96bc721872bd43cca7568f438e901c46086`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b752bf9a43bee65700675ad761ff2b71edf2d3b7b5d21bac6a706f75ecf790a9`  
		Last Modified: Thu, 16 Apr 2020 20:32:07 GMT  
...
```console
$ docker pull drupal@sha256:eebd3e063a591be7766294877f50a5209bb6bd4b6ab22240f2f569caee2cc188
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.0 MB (132977378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:060b2af307d4a6491d41814af9c0380ca249d10df3d4c5a40127e756199a8c1d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Wed, 01 Apr 2020 09:47:15 GMT
ENV DRUPAL_VERSION=7.69
# Wed, 01 Apr 2020 09:47:17 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Wed, 01 Apr 2020 09:47:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:523127928c03ade15acad7839c3d0438164ae8d45f74f791ddb3689ae0f9e558`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b366765d882bf4d25ff6496a0103eb4eec1dd5b0694b58c87eeeddbe0bf0518`  
		Last Modified: Wed, 01 Apr 2020 09:50:29 GMT  
		Size: 3.3 MB (3335074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b2c26a314d11dd486847fed70a46b4285503c6fa59c3e3d02e9ee7b6f77b2584
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.5 MB (126535937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63b3cf89189e8ae9b3868fa46c00220a314369c4b04f3fdfe61d41d17e20e5df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 16 Apr 2020 14:07:33 GMT
WORKDIR /var/www/html
# Thu, 16 Apr 2020 14:10:33 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 16 Apr 2020 14:10:33 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 16 Apr 2020 14:10:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:51f4d1e90681fd2b48d4833f5af077de03d4b8d888603936f5576286164b062b`  
		...
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80a347e88c902595a1365c623fd84435240e416866e4d50a42e4a74a3c062311`  
		Last Modified: Thu, 16 Apr 2020 14:12:35 GMT  
