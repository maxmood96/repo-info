...
```console
$ docker pull drupal@sha256:3ca80032a023f0cb197fe78e9687a106a3678bb16f53f5770d500e21b50df457
```
...
```console
$ docker pull drupal@sha256:e1c3b2ae4863ebf84ae27002ebf460a38e855c4b1f3c8b9e4afc62c474f7979d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.3 MB (138307101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d33c67c08f9f83342bd8d7939bb9d4109105b585d3ca726af60ccd8e201d81c`
...
-	Layers:
	...
	-	`sha256:a3cddf097b5eaf3d850ed83f82ac7ab5c5eed30c2ab87a935011c026aefcd5b2`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54d4500e19eb0a9d69a68d2fd5c74a9e7bc635406ca71ee10d1f4058e6da6a88`  
		Last Modified: Thu, 27 Feb 2020 04:35:08 GMT  
...
```console
$ docker pull drupal@sha256:cb1268645fcafeef148e205b96e9e06523bc34e1c80c29be3362a0616b9984cc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.7 MB (125712371 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d14e9560c4835762cb612d9db4d08e39d221bc636dac1ddef863e2321a631b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Wed, 26 Feb 2020 14:16:03 GMT
ENV DRUPAL_VERSION=7.69
# Wed, 26 Feb 2020 14:16:04 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Wed, 26 Feb 2020 14:16:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c42151236645d191d085ada0bee5e2d42933d3db4606e44070ce07bf91077738`  
		...
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f1657071762a91a93ed5d4e9b36e2aa7415b2bd10392243f42bec8e0c695715`  
		Last Modified: Wed, 26 Feb 2020 14:18:16 GMT  
...
```console
$ docker pull drupal@sha256:d8093409f7e33585687cd59d458f13ecb9cb003322e44b0659a88cb0c52f823b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.7 MB (118655626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88149a48eeebd88ecdb43914fee990280529d71d3d301b74f50f561a3faa5a9b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 27 Feb 2020 00:38:04 GMT
WORKDIR /var/www/html
# Thu, 27 Feb 2020 00:41:48 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 27 Feb 2020 00:41:48 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 27 Feb 2020 00:41:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7df66a1c0804b43df01ca42f2649ec5d7e086b574b4fd78ee042ff9fe286b2ed`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eacaf2a159363d63f171f1bfcc516c09e4b473a74f42f2989d8fae52bd7eb98a`  
		Last Modified: Thu, 27 Feb 2020 00:44:05 GMT  
...
```console
$ docker pull drupal@sha256:7b3dd85aa57077f06e34963609a90db9f6272712bf9c9a3e9a442ffd6573feb4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.9 MB (124865944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93bc9d25aae5135eaedcd772c3d2ae0d74c405962b2d3a71cddc1779451ccd85`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 27 Feb 2020 01:18:44 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 27 Feb 2020 01:18:45 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 27 Feb 2020 01:18:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e56816b5e46b69e57c589ccadce8e641e6f23cf0d3e14adacdbb29fa99df2a6e`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc162929d65b7a13de4b12f906c66491a98a3d7cc1ee50feb6a28d2eed796350`  
		Last Modified: Thu, 27 Feb 2020 01:21:11 GMT  
...
```console
$ docker pull drupal@sha256:04677f3b83be6c606f7c344b56a90c25f2d39c4f7d6cd0efb9aac42c76cdf754
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.8 MB (143833863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1593e44139095679eb2b5ff0edc33f894a4995ed33c256fb08c3d4790aa8964`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 26 Feb 2020 20:56:26 GMT
WORKDIR /var/www/html
# Wed, 26 Feb 2020 21:00:33 GMT
ENV DRUPAL_VERSION=7.69
# Wed, 26 Feb 2020 21:00:33 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Wed, 26 Feb 2020 21:00:37 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:367b02b28be3aac1dd77d22a935f271f6a8caa2dda8ea9ef4487386e38e917cf`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c32da95ea5992b509bd627e3a08bfdefc8b19b77a4161e230b015d316769cc4`  
		Last Modified: Wed, 26 Feb 2020 21:03:40 GMT  
...
```console
$ docker pull drupal@sha256:1b93438d30efed8d794c9fa6663fdca3e2a313939a521ad0aab80d89ab3ea7d1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.0 MB (132989379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15032f318fbabd01259030fc4ffa594fac65382bc6beb6b4f41efab6a2a46b8f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=7.69
# Fri, 21 Feb 2020 05:09:43 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 21 Feb 2020 05:09:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fcb4db616db7fb47ac896ade820ad1d8a7e2a38fe9e9751b41f5bfce00b5bba5`  
		...
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22762664613e4bb4fc5c230aa055ab2c6be96a5cbf06ceba4013bf7e54df0dc0`  
		Last Modified: Fri, 21 Feb 2020 05:17:53 GMT  
