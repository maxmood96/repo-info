...
```console
$ docker pull drupal@sha256:72442e5a8c8401548e01994a2f71e8a596c49f975ef48df1ce39c6a501182d44
```
...
```console
$ docker pull drupal@sha256:b2c0b0c6f3c207c3cdeeda67b4de63d7a57e25e255c2520311d29738c9dc7261
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.5 MB (138459615 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52d3550f594480fec10f43cc6acbfb5230a57d691c087b5300b2421f568d3a81`
...
-	Layers:
	...
	-	`sha256:7974513b50cab1304e219c545dae63670ae201f1be35612237c97547f2f7d8da`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63441f9951f44f5dc0ed8c8072f131d92df423cddf2140a3423f8840c54be966`  
		Last Modified: Thu, 07 May 2020 03:19:47 GMT  
...
```console
$ docker pull drupal@sha256:59183359ed32009c2af55db6d816efa037fefa62b3544f05109dda1d231c80c1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.8 MB (118779977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1175740f3b45f382735d6696622607d59f87a35102a7440645f07d5ed952197`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 07 May 2020 01:01:40 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 07 May 2020 01:01:41 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
...
-	Layers:
	...
	-	`sha256:99b1ca69183dce70554547dea3341603ac3d41c8369b3eb732bb968194f26fc8`  
		...
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c096e4b087e43fe2aef5ae4d34ef1c62bc161b7baa6b6ad0e590c50135a4de9a`  
		Last Modified: Thu, 07 May 2020 01:04:44 GMT  
		Size: 3.3 MB (3335071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:4be90a64a2e7874f2a6b213d44bb1a0dd444e2a4d8155b285886b662bc4b8927
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.0 MB (124998422 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffbaa82849b680ceb84b87a32164e92b1159ec4ae888dd45428b4c6a42268c76`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 May 2020 01:03:59 GMT
WORKDIR /var/www/html
# Thu, 07 May 2020 01:09:34 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 07 May 2020 01:09:35 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 07 May 2020 01:09:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0d5be9b8d3b734813be69850089078a45ff1dda62aa5052faa9fadcf2fc2a30f`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92c56d62ff0881c20195baca223a922aa6dd7a62915575a4fb0b4be5f97bb462`  
		Last Modified: Thu, 07 May 2020 01:12:29 GMT  
...
```console
$ docker pull drupal@sha256:15b1050207693d16977fa5417c704f57d09bbd199faf65b1c9d10b04daaa1891
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.0 MB (144007480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00e23104cd0dadc980b122db928453c1f5e6ef881d6a36c5ea3ca0ad7ca28f73`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 May 2020 03:27:59 GMT
WORKDIR /var/www/html
# Thu, 07 May 2020 03:31:57 GMT
ENV DRUPAL_VERSION=7.69
# Thu, 07 May 2020 03:31:57 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Thu, 07 May 2020 03:31:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bd4dff84345740a1eb1143b79f56168e37b919eb81fcc1f8f3c1c6d1557ba049`  
		...
		Size: 336.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2cf3ed9ba5205858635ce4fd29a12439b66f4a6aedb565924c521bca720dc6f`  
		Last Modified: Thu, 07 May 2020 03:34:01 GMT  
...
```console
$ docker pull drupal@sha256:bfa568c0aabc5eb078d940d8d0a064480a1e911504be01f7b22867acdac5544a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.7 MB (126687655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aae6cd1b322635304851f32429a943802f9956ac1e1aee588ef42bd481335fd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:2141d50955061a4b1ad5d1e161eb3fdeb8b8a957045d1ae40d3afa081338e1aa`  
		...
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:076af9c5298857d00998b213a4ec6ad044ce9aa61c08662b7cc989fc8345806f`  
		Last Modified: Thu, 07 May 2020 03:57:07 GMT  
		Size: 3.3 MB (3335070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
