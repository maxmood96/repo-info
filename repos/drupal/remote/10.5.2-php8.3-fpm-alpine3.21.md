...
```console
$ docker pull drupal@sha256:6ef7be6c62736fcbaa875267b7f27b8604f80fa9059cdd2b527f4825cbe6cb3b
```
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; amd64
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; 386
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; riscv64
...
### `drupal:10.5.2-php8.3-fpm-alpine3.21` - linux; s390x
