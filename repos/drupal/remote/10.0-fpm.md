...
```console
$ docker pull drupal@sha256:27a2a3b93a43f8c6ca787be6724f0785c1926c959d9cd5c742bda6db2bddb821
```
...
```console
$ docker pull drupal@sha256:0f2398108a3324e3c04146f6aad8f557bd56d08e4461c1280185534d1c08cf74
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.1 MB (198053458 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d558d23baef32fc526526719b9267ab58b2ebe0ae63778729fe22345b8d895c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:11:18 GMT
ENV DRUPAL_VERSION=10.0.9
# Wed, 05 Jul 2023 09:11:18 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:11:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:11:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:598068247e676a42af789083b30a99b104f81a6f07206be5051f2ec211858f11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3157a3903fcd35d7b7fe6a6c13f1e279235d970fab4cee68726ae8dcb83b7e5e`  
		Last Modified: Wed, 05 Jul 2023 10:02:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29bc7891ccb272872c4af30ec3d7f589e44c5182f50dbc9bacb061c44436bed3`  
		Last Modified: Wed, 05 Jul 2023 10:02:58 GMT  
