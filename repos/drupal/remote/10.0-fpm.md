...
```console
$ docker pull drupal@sha256:1ff19a336c1c9f61781a5fcf553aca0300b3b71ab7194f0d85376181040c4fce
```
...
```console
$ docker pull drupal@sha256:a48148d884115502ed232945c604b29c23503adb3b36f81d1492f99bf99736df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.0 MB (193027757 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6dcfa83498cfbf32ff219407136cbaec9151a6fd06729a8fc775ed8e31bbdb55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Sat, 21 Oct 2023 07:28:07 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 21 Oct 2023 07:28:08 GMT
WORKDIR /opt/drupal
# Sat, 21 Oct 2023 07:28:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 21 Oct 2023 07:28:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:414cd22cada2831777296d2abef2be5daba748d6fd1c96cbb7759768f0a8070b`  
		...
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36aece7810e2c0ef5afcaa980b66a1980a0c118e27348fa64d20e378b5714ed2`  
		Last Modified: Sat, 21 Oct 2023 07:51:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a2395d0895d53ad33aa646642d66a96c7eef4d8db3c904d6e9dc347fe47318a`  
		Last Modified: Sat, 21 Oct 2023 07:51:42 GMT  
		Size: 17.7 MB (17697057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b822e95c1bb639471a68c9962eb4a946d17a1cef312f24ff32286dce192887b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.0 MB (169991841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08d894d494095c409f6737e2e718550e19d65c45400778f916da8367c57a2bb8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 28 Oct 2023 05:13:37 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Sat, 28 Oct 2023 05:23:58 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 28 Oct 2023 05:23:59 GMT
WORKDIR /opt/drupal
# Sat, 28 Oct 2023 05:24:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 28 Oct 2023 05:24:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e84086ea55f5b979b8d08a3f617707cf0f16e9b941b7c142b852dc1f094b3220`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e24c6e2df7c815cc356b542413b10e93d7ffa1a581d2ab9656e4e49f553d813`  
		Last Modified: Sat, 28 Oct 2023 05:44:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6889b581a6f31cab05b1b9c27bf9bdfa9b551abdc6f0d764625eba8e7014a6a`  
		Last Modified: Sat, 28 Oct 2023 05:44:08 GMT  
		Size: 17.7 MB (17696961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
