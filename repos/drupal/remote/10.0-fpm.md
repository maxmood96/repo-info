...
```console
$ docker pull drupal@sha256:aa10e15c01ef07a5e5bf2b4df01350be28e4b6ef55d06266ad869dee90aa55f4
```
...
```console
$ docker pull drupal@sha256:7ac1a92bedcbf6626b266e347673faf93a5a9fc1ec707c091f9cfe8244bdb358
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (184989249 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08795e0294c5d4cdcca7c6335517565714b3ead9d83614bb370c92d01837d031`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:11:37 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:11:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:11:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b816e8316299d89b18ae5ad9bf27ac38d8eaaf6279ce6ff074d0666adf39b037`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6844449b57050ce230198239349ea9909b3c472d67b05eee9469ff53cda2649f`  
		Last Modified: Fri, 24 Mar 2023 00:31:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee955a89ab0f7afb2457c9e745cddb3c5e438d338477d8fa4e5b57ecb188b240`  
		Last Modified: Fri, 24 Mar 2023 00:32:01 GMT  
		Size: 17.7 MB (17663483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
