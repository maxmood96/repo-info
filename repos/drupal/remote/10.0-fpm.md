...
```console
$ docker pull drupal@sha256:137feed4f23b42e22967eaa9a5e5bd4a7bae34f58058aec69fbdf5ffe1d711b6
```
...
```console
$ docker pull drupal@sha256:c0ae43639cd78286d683a17839054b019da887f88914877bbb3bd2c4c3d738e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.5 MB (167537027 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de433d3cf5c7c5280d8100c5ff1a0e78833ec9828edcaac682d043f67080a1cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 08:09:29 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 08:09:29 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:09:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:09:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:09bfe4bd063e22c171b5a6d8668e14b782505ddf5c4bd0dbd3d39030ed53cc25`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c77bafdda07190284b4675ba864f58c6a6c3283fa929b06b1708b6b5c1de1edb`  
		Last Modified: Sat, 30 Sep 2023 09:04:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:974008050fec0f6ad5b379e4cd13e2231362a162d782e7db56cdb80dcffd929b`  
		Last Modified: Sat, 30 Sep 2023 09:04:12 GMT  
		Size: 17.7 MB (17697210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
