...
```console
$ docker pull drupal@sha256:cc3349ed00e9edfe7957a92d0b8709e514dcf166c81e80bea6eb3c7e453cd129
```
...
```console
$ docker pull drupal@sha256:320104a141bf24862e4737c3afea97a79bf3bae8b789ffcc29578efbb1c35544
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158693231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a9e0fb1245074eb0bcee226d4adb6108dd361f6e2042f278c33a13e445697e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Nov 2023 17:35:44 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:41:43 GMT
ENV DRUPAL_VERSION=10.0.11
# Wed, 01 Nov 2023 17:41:43 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:41:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:41:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:793d62eea9af6be9f396cb1ef778e2813244542dbbaea340a3e9f1d150883d37`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe72c1a645830874dea9d63136a69bbeb09a7510f5454604772d73f3db30226a`  
		Last Modified: Wed, 01 Nov 2023 18:03:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a93ba5de157831f5a469d091de444524f08000122fa1afb4cf9c04ae5ee3438`  
		Last Modified: Wed, 01 Nov 2023 18:04:00 GMT  
...
```console
$ docker pull drupal@sha256:d46e2d7674c0e85b644b99ede1198dc7e5ac8937d11cb7b940acfa4a0816687c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188288387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a59779057592d85451b2a1ebda4a6f3fb5dfdb71ed951e94edf005181d4a181`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:af9e408855c1a154737f722d1e37e4697a7e1da0a79ac8791220b8eb7f94955f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fd391fa5bbb1679b0a6320081a46877b451fdfe2aaaaf5501c7c5967e4ecaaa`  
		Last Modified: Wed, 01 Nov 2023 18:02:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bb97f7c281f4ee57a00017c6cc46d128d218065c12ebe58d31777b1fabad30b`  
		Last Modified: Wed, 01 Nov 2023 18:02:40 GMT  
		Size: 17.7 MB (17697040 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
