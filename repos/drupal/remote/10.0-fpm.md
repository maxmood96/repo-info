...
```console
$ docker pull drupal@sha256:df6a12302a6b63785aea6b19d4a72cdb9c9ac47e3d97be507d53c060e0a3805b
```
...
```console
$ docker pull drupal@sha256:732f039737135fe48412662730f67fa1b9ee9329f97eb50b62203cd94ffe4b46
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152238672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1125a27c064a24b2c3370b322db65e54b5ad9954564258d0967021900da4f286`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 08:48:29 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 08:48:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 08:48:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d0f4a01d808a55a0c7b1ddc73b59c8bc9fbf1ac72978d5a5ec491a2c7a07a37b`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d7b0f2af000f76e215e9e763e674aed7850414dffce4caac05f64a706dc6649`  
		Last Modified: Sun, 05 Feb 2023 09:21:25 GMT  
		Size: 700.1 KB (700099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12bbd777b65d3c2e74951b72919627428711ca4e9d9628d19a295a4bf5f710f9`  
		Last Modified: Sun, 05 Feb 2023 09:21:24 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:656bb5a17c799e4a2106f47ff16ea3c15feb0bb27fb79984f29dfb766cfb535a`  
		Last Modified: Sun, 05 Feb 2023 09:21:31 GMT  
		Size: 17.7 MB (17656800 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
