...
```console
$ docker pull drupal@sha256:9292a6794b1ed1a3fc035828e864992888693e334f7a3d14c353e0cf8e2c793d
```
...
```console
$ docker pull drupal@sha256:ce67df0a1d90f918aafeca076cb2abcebcb06df6b6481da5bbab0a7ec4cb89d7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158689380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a5da3a273a339ebbd6d867d5c0bea1565507d42ac283e6cd6b9f316175535f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 Oct 2023 04:45:46 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 04:58:18 GMT
ENV DRUPAL_VERSION=10.0.11
# Thu, 12 Oct 2023 04:58:18 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 04:58:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 04:58:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c3bc53cab197e4ba8a03718fb343a3a7eef5cb5f3b1cc91050a38d0428e6c67e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff7857e192e26cd90b70bdddff14dab61d790c92da7ef1897f12342ae8d3fb62`  
		Last Modified: Thu, 12 Oct 2023 05:20:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efc069fecf9572e41fe364dd7ad2b495f06d71f66f8fe3b472fa909f0e3fe373`  
		Last Modified: Thu, 12 Oct 2023 05:21:07 GMT  
...
```console
$ docker pull drupal@sha256:fbbbfa603e12d7a70b7e5afe102d2066604017aae83aa26969a98d8cde1b3244
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.1 MB (198145863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56572938ee69ab58c87b50a3a368590a0a136d52c1de062bcad19bdce8117b50`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:22:00 GMT
ENV DRUPAL_VERSION=10.0.11
# Thu, 12 Oct 2023 21:22:01 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:22:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:22:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e78dbc4aa9c80f2976ef954ab8b53480f986f99f85b9812df7b2b93a7fc36339`  
		...
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e16b841f6d8aaafeabdf0da0058957658f1b8de6b3b396eadae4f3fb6cbeb2a2`  
		Last Modified: Thu, 12 Oct 2023 21:49:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:953401758934b824dfe94363f13c79babec797aabd238cc958206d61e7271539`  
		Last Modified: Thu, 12 Oct 2023 21:49:28 GMT  
		Size: 17.7 MB (17697055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
