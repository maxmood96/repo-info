...
```console
$ docker pull drupal@sha256:d2ff71b9114a7b1bf3c7a074e0405ae680b73506a2c17d75d38411c6c52986e4
```
...
```console
$ docker pull drupal@sha256:876a00e2ec47d1277acbc93c6a2e3093309a380c40028b546aa1e99b67dcbdf4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165526778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a6b9e2ed2d7037e13d7562fc021f800724b4f3a61804e054506a3da0cdce1ed`
...
# Fri, 10 Jun 2022 02:05:01 GMT
ENV DRUPAL_VERSION=9.3.15
# Fri, 10 Jun 2022 02:05:01 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 02:05:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 02:05:12 GMT
...
-	Layers:
	...
	-	`sha256:cee2cadd6e94eafda37d4ff9880f645829ad6acef160a5dc687a87d7d03b33e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db6caffebd0b98dd25bab794a0bf8be65d65d861143a06148dd0c985e8f425d7`  
		Last Modified: Fri, 10 Jun 2022 02:31:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:889e3334e91f9b825da6de9f28f579680dcb1de312402f59b9f9bbadfe1baf7b`  
		Last Modified: Fri, 10 Jun 2022 02:31:08 GMT  
		Size: 21.2 MB (21208655 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:4e5213eb17a268952dbfc3173ff59c4c63f5d36d94a5d28756998d52e1aaf4b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141100779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b8aee884cba6b7afccde48858c82100cf1635004bfc44101d9d7a3f065b45fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:20:43 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:20:43 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:21:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:21:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1325c7ea7a5916a17003ba5bfd6742fe32b88080eadf80fb23522071533ea95`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e68cd2bc5f2d2add0a47267924bb6e553789f051f70802822939d42df0d0175d`  
		Last Modified: Mon, 06 Jun 2022 19:15:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dd5bbb550314560ad5715bf8ab64092a3963b4f5b627bdcd9d7478d54b706cb`  
		Last Modified: Mon, 06 Jun 2022 19:15:52 GMT  
		Size: 21.2 MB (21207226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:16cac6e00c0408cab08dc6a31cc9a28f9344d6cc9439b30d9dbc5f95282ca8fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.6 MB (157639166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89ab5c25621fad59ebb35d05b5d57f1d5f72731794e9581fcc052af8661ed53c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:53:14 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:53:15 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:53:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:00106d1bd86cbcf3cd8e10f0ac6c6f8f459e7fbeb57e842b20d78060aad8b7e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96a61c6770595702068ef4d80ec92322d9d2a7281f57fa0c822bac3b24627c89`  
		Last Modified: Mon, 06 Jun 2022 18:19:37 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:999afd2b5bf8769395832e95ec6f83b2ac9d985a9066568a863c2281e2184980`  
		Last Modified: Mon, 06 Jun 2022 18:19:43 GMT  
		Size: 21.2 MB (21208380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:86c494a2f3adc69ae80e62a6114cb719542c680695b48b8b7c3ed200febe4b6a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170610786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e7aeb3c3d15198a7cef1d6e155adb4fe2af4178ae85b9e6971f24bbe24f4cd9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:48:14 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:48:15 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:48:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:48:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fbb842f1f373e4e21d86805321af60437a3d8720d5a7364db17430ba1f061bc6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:479b57babf349a0d633e13d2f23692f4c6f49e4b2dd00859ac48d87623a70f53`  
		Last Modified: Mon, 06 Jun 2022 18:13:04 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da7ef6b11c67d433ca94b6f0e677990ddbf9f6fc4e59f1128590119761d106c0`  
		Last Modified: Mon, 06 Jun 2022 18:13:09 GMT  
		Size: 21.2 MB (21207841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:92e36333384b4a5728bb37e1bf2d681363d25ed0ea6a904ce46e1f71dab2c50e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.4 MB (175437222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:052a42e1ef8c04d96a4999a32b047c58e21c413be69c8d6ba2f5eea517663586`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:47:48 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:47:52 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:48:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:48:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7be2d7e3046a881c16fda417546085881c8beec0c2e03c64fcba5c468fbca96`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b58513eb9a75bb30609032b02866cb3d269530f523c39b84d79eef149fc868ee`  
		Last Modified: Mon, 06 Jun 2022 19:44:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:119d6e15380dc4d2805e4f5fa5140e3c5d806850625c2fc129e9f254b157deb3`  
		Last Modified: Mon, 06 Jun 2022 19:45:53 GMT  
		Size: 21.2 MB (21206971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.1-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:53c699679edfd7e2d2fc8646d7b237c1da7f7ee62a1cd2c23a8f120c2d659ff3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.8 MB (150805054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9f79ba318c73f41f21905ebde6c093099ffed35dc78a93663e3a2d69968cab5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 02:36:15 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 02:42:48 GMT
ENV DRUPAL_VERSION=9.3.15
# Fri, 10 Jun 2022 02:42:49 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 02:43:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:8a914a4bd82a66c1ec7cb4dfde7fe55dcf16ca19433ecc60a472f103d0c615df`  
		...
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:403bd9e66e3cecc9e140fe3776564ea48dd31a8d1c6936f4c71dc1a7a67fe9e4`  
		Last Modified: Fri, 10 Jun 2022 03:22:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55db7fd181737c592e5536f46659330b384c2a67270cb00b52a195d7cb60016b`  
		Last Modified: Fri, 10 Jun 2022 03:21:59 GMT  
		Size: 21.2 MB (21208773 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
