...
### `drupal:10.2.9-fpm-alpine3.20` - linux; amd64
...
### `drupal:10.2.9-fpm-alpine3.20` - unknown; unknown
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; 386
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; riscv64
...
### `drupal:10.2.9-fpm-alpine3.20` - linux; s390x
