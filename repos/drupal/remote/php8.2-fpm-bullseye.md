...
```console
$ docker pull drupal@sha256:eada9782a485029421516cb902a2cf2c45d3ec900d626befa394b51122e77831
```
...
```console
$ docker pull drupal@sha256:bf84b1ace2ef6a311559d5e34cb5b6fc36d73cac33cedbd3b710e74fcfe426cd
```
...
```console
$ docker pull drupal@sha256:043873b3c9f3a217f38642077c55048dd11b6f887be05c8c61a08bb169e3212b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5375669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5717b4f09a35b651567303e22ad09326243a80949add2d1816038aed379b34c`

```dockerfile
```

-	Layers:
	-	`sha256:34b69268b9367dbe6506a87458370955ae0a63368e72cc6110b8e7d8a0126b68`  
		Last Modified: Sat, 20 Jan 2024 07:46:16 GMT  
		Size: 5.3 MB (5340758 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:348041841e1cf2aa777a446d30b146c136110e853eeff540cc191cc03a5a0293`  
		Last Modified: Sat, 20 Jan 2024 07:46:15 GMT  
...
```console
$ docker pull drupal@sha256:d7618fd76fc918d8ceb58c775652dcd410da6801251d2e47ed3653e384ebec63
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.1 MB (178075252 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:119d22f23bd7d5e25eccded1be659cc52471a78505b7e2c8fbe58b1ef82ce7c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3c5316c9682fdf50fc4529a944af4d83deb8d78d74a69724ab59de2b1807bb8a`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:07ce9ad47e1e3615b04f3216c4fc1fde76a5454f309a4b1bfe67658de4083a4b`  
		Last Modified: Sat, 20 Jan 2024 08:33:58 GMT  
...
```console
$ docker pull drupal@sha256:e63dfd7a8c7150a187730abd2861c33a6b722026586fde93105b68ea27168e27
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.5 MB (5543781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d331d648b1d983a44f8f28c9094c091b3b39cf613b27c285cabbe82a8bfc776c`

```dockerfile
```

-	Layers:
	-	`sha256:bae80fcb8dd39f37acfd937c16e38ec367e00bf813c65cf71e87e524c850487b`  
		Last Modified: Sat, 20 Jan 2024 08:33:54 GMT  
		Size: 5.5 MB (5508996 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1edf720beaa2da5f1fa9b164f99c37eb218f7b514bcef9523d55be84a4d96f48`  
		Last Modified: Sat, 20 Jan 2024 08:33:54 GMT  
...
```console
$ docker pull drupal@sha256:f679b3e5ee620c23f720ba11b59904e7d6c38429a14bdd8535f9b65b8b1be6b2
```
...
```console
$ docker pull drupal@sha256:c7fd4207dbefcfbf23fcc49e2e9a6b13e1139c206707e12460835c6373435fd3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.4 MB (5393232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:011c256b8b3ece153a80755814878afcab0bb7ab6034994630a4751399654fcc`

```dockerfile
```

-	Layers:
	-	`sha256:4a8cb577b1fcc1156d0fb18a9a3ef6409345397eecaff4924031f0ede1f66991`  
		Last Modified: Sat, 20 Jan 2024 20:26:15 GMT  
		Size: 5.4 MB (5358465 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0eeddf1d85c9974429039e004326d83528c0ca9f79f10caec972e7d9d6633b2f`  
		Last Modified: Sat, 20 Jan 2024 20:26:15 GMT  
