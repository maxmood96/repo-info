...
```console
$ docker pull drupal@sha256:5e6f98980177c3de15aad19a4cf6722bfb3a0eff3053f4ab957e798bf29ebbac
```
...
### `drupal:10.6.12-php8.3-fpm` - linux; amd64
...
### `drupal:10.6.12-php8.3-fpm` - unknown; unknown
...
### `drupal:10.6.12-php8.3-fpm` - linux; arm variant v7
...
### `drupal:10.6.12-php8.3-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.12-php8.3-fpm` - linux; 386
...
### `drupal:10.6.12-php8.3-fpm` - linux; ppc64le
...
### `drupal:10.6.12-php8.3-fpm` - linux; s390x
