...
```console
$ docker pull drupal@sha256:74f9da85021d9b625ae9af5d826a28183606bdf83a2635c0127c3c70f5549d24
```
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; amd64
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - unknown; unknown
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; 386
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.2.9-php8.3-fpm-bookworm` - linux; s390x
