...
```console
$ docker pull drupal@sha256:6a17b69c061f0a3cd7cfd28187f636ab39625d582ac2b8f5248c8ab7b5b2c7d8
```
...
```console
$ docker pull drupal@sha256:938741bd8b12dd7f0c5e88e40b2d9afa5ebed2f5ee7f261362f4ecce3c74bc6b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189493349 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04c2a3f3a62680596614a940765a0f32dc4e3581216c6278bea3438186b56c47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 21 Oct 2023 07:28:24 GMT
WORKDIR /opt/drupal
# Sat, 21 Oct 2023 07:28:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 21 Oct 2023 07:28:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d7ce59e2cd53199e405b04f9c5786b958250f9864c5c1e27817cfbbe423f1a8c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5b03e3c6ae265dec90c1d6cd195d383681d9284ec3b16e5b8c44cf137254dec`  
		Last Modified: Sat, 21 Oct 2023 07:52:05 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1700464306f8c1d766a4b376bb87aa5642661eeed14d97a8318362a9690a995`  
		Last Modified: Sat, 21 Oct 2023 07:52:14 GMT  
		Size: 17.7 MB (17697116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
