...
```console
$ docker pull drupal@sha256:a6fc6cfd8d53b560ae28e50002db8837a51e299f84f03586cb16ee3618969232
```
...
```console
$ docker pull drupal@sha256:359d49094bcb2b2d01eb9df6ba0b68e5a93ea96bec82751ef44dac956938f781
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156050933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc4e469b75b867531968c3f65f3158b46aafa15022d9636b1e80f1f0119fa9ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:26:09 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:26:09 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:26:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:26:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:616b0ce2865027ae1cf3f348305f93da72ff41a8d167410eab3e1d4021fc36de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad5c74b145a1cb11600879506fc46851432a25fb1aa3980174541e10a3bc58c3`  
		Last Modified: Fri, 06 Oct 2023 19:48:51 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6385e514d73657b8bb783f48eeb90762c42ed93fb9b6eb83969952dc90e56d0`  
		Last Modified: Fri, 06 Oct 2023 19:49:04 GMT  
...
```console
$ docker pull drupal@sha256:f8534583a83d18aff879154ec414bc88d0d21d2fc96b802b873f86bbc4c9a783
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180818383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24aa6273c5dd9c1defd68d3c6aee592d27d6cf2fb04d7c11dee3b8dfa110f7ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:13:34 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:13:34 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:13:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:13:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5553038cda8328d3781919ab0d2b50c56ad8194417b4208ae971ff67e69da79c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6488a000dbee8584ec5d6b5b3344fa510b7eae596cbe689bc2e971b31eced36`  
		Last Modified: Fri, 06 Oct 2023 19:33:37 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a15085c129f0617b6eb28a587b58c7d41df3ecaea57fa35d0778e86735ceabf2`  
		Last Modified: Fri, 06 Oct 2023 19:33:48 GMT  
...
```console
$ docker pull drupal@sha256:d4df149df156132e65440c66e7201f68516300abcfc42d9d55a2287b489c109f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189475030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68b56b56d2af5a3eb7193ab6b8f494eff018479a0cffa98f6cc62fdec98d7634`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:13:10 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:13:10 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:13:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:13:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c2199a7957712cdf4b2ff4b661ba35b4d019e27e6d860a5f5c7fe0b832ef0dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a81e704309b59424e1aff7f53233d96217f2efe1a835f5372cbe59c86ffe308d`  
		Last Modified: Fri, 06 Oct 2023 19:35:51 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3454cffe3d369e71a2b1c48746cb1b78c7aed7dfde759a73957fad2bebc5113`  
		Last Modified: Fri, 06 Oct 2023 19:36:07 GMT  
...
```console
$ docker pull drupal@sha256:c555f343573dbcc1bc08440cd3132c56fc66d0c3ba066d7ea09d3468ab95c4bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163379979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecbf8d0f5d1d60eb6e22bfc6382bcaf16c563cae0e7083e7c1e026067a33da95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 08:10:06 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 08:10:06 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:10:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:10:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5391d483a08711422e17baeacf34af99565b6502b88877689e85a1b143ea9c3b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de199dbd58d73f1fd9e382b26d0c1a8a64cb81ad2c286c8f75fa22b77fcc6a6c`  
		Last Modified: Sat, 30 Sep 2023 09:05:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58c641d3b1528af7b3d994e9c7d80f57576f4e86f59e623a50a4cd2f4e478fc9`  
		Last Modified: Sat, 30 Sep 2023 09:05:57 GMT  
