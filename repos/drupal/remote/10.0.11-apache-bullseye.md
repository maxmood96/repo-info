...
```console
$ docker pull drupal@sha256:924221329054cdce46c3d81bd8c695b2675380aadf2de7219cd4f2234a93a7ac
```
...
```console
$ docker pull drupal@sha256:21b49ae8a513c07ff5fffe4f2759eba5ff60286aa9e44fcc36c19c77fe9ddaef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187048929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d64f67b275aadd132c2cc56c8c17494fc27f0899937aced901e3ed7c9f856db8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 21:11:16 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:22:42 GMT
ENV DRUPAL_VERSION=10.0.11
# Thu, 12 Oct 2023 21:22:43 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:23:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:23:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0199c5192aa873c5aac33834ba079783c83eb998b4fb1f472f523e3118abf6a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:791afae60df5ae35c15c0db660adc41c5992708ed607f47d4901b0c5739111e0`  
		Last Modified: Thu, 12 Oct 2023 21:49:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea6b2bf9bd74ce5a0260f49cb0cb611ade7cd3e8f20569d5531dfa31f9720fa2`  
		Last Modified: Thu, 12 Oct 2023 21:50:17 GMT  
		Size: 17.7 MB (17696909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
