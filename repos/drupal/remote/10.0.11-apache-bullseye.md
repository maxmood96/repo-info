...
```console
$ docker pull drupal@sha256:67f8eb7d9a1b1b6c36b9d646788093cb3f439819fb7b20c1581012a84a6d5ac2
```
...
```console
$ docker pull drupal@sha256:a2353eff663542fce7c24279527a913ce2ddebab670d312c70844c9761a23050
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186602473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa706ad0a7e6d72ecc95aa753829215cc2163a085e7946a7410807f0986b054b`
...
# Sat, 30 Sep 2023 05:23:14 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:23:14 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:23:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:23:24 GMT
...
-	Layers:
	...
	-	`sha256:499e7db2e00926d4fdb390d657a864ce8371261ecf6d1eaf8bbf3816ac07e189`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47b66be6511f88992117ee9cd577db52694c457675f7c13cb47867209e1cdc26`  
		Last Modified: Sat, 30 Sep 2023 05:40:28 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aa73718572371606fe177256c07c820b1a467d4a2b5c180cac02d962bda779b`  
		Last Modified: Sat, 30 Sep 2023 05:40:32 GMT  
...
```console
$ docker pull drupal@sha256:91c6d349c8a30cdff8e09d689f774bbbc49b286e64c2fde4b714cb0dd6dfa6e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.1 MB (156050954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c50fdfbdb849b707539e301a8cd616529740a94ae1a4f495acdcdebaf7d6545`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:05:25 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:13:40 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:13:41 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:13:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:13:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a0d8a26a2491b73cdeef873e21582d19188b5afc08f7f04fd560c244be566df5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:666ed59d28302fa91a990307936b68e64deb3a78919acdedab12e3da6c3b8d77`  
		Last Modified: Sat, 30 Sep 2023 05:32:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:870c97f39d337d943b2291499ad3cce4777390bc07db8a8ee7338b2bd964bdcb`  
...
```console
$ docker pull drupal@sha256:52abbce2f131a50833cd9781661665628ee43dc9981c63d821427ad5eaee6888
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180818573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fb41ead7e2c1ed72529eba1ff2e8de943de0634bc0c8336c06f0f20c9b63c75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:10:48 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:10:48 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:10:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:78b76ad9783e350a3ab4423850f8135d78320dd2e1d8e5e0b553148b262fecd1`  
		...
		Size: 704.9 KB (704940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f3b1dea52f23c906a578f422643e89e7ebbc78191f916e81e29a296de1df206`  
		Last Modified: Sat, 30 Sep 2023 05:28:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d00b0968267c7b8353fba01a7af18ebfe28fba35d4c9698f2ca19f7c70646a9`  
		Last Modified: Sat, 30 Sep 2023 05:28:35 GMT  
		Size: 17.7 MB (17697195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:fa31d803bd74d625fb5b3c218bcaf7cf515d787eff8e779ac33a4db29cd4ec95
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189475291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e135644e0138b50177661f6aceb5c1b77f7a4bcdd8abbb2e0cd5b5820f5b5b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:57:58 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 06:12:39 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 06:12:39 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 06:12:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 06:12:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0f1d7e6bd42c93835162d841757ddab3a31cf97acd0cb01ccb48da1547672057`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4990e9b90eeab852a6409cc81af68a9fec4a07f267b83afda60c182eba1924c8`  
		Last Modified: Sat, 30 Sep 2023 06:32:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ec900930a186d9db1e78f191d36b6dd0e95e024e75f26942153d6fcb9e21484`  
		Last Modified: Sat, 30 Sep 2023 06:32:56 GMT  
...
```console
$ docker pull drupal@sha256:225262b71c40be190298c18a5179e4fab4a15e9e7739a0d436d3a0187b3a8ecc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187016742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c49ab44b73b99461a3db30124dd53865d1eb52a53601eda1d377ea685dcb378`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:39:18 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 20:39:19 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:39:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:39:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:44fde0594691bc6ddb410c1e7100889be5b859641586998b99639de49608fcd1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360af20c9f1ac5a16faf59bfa858e4625d4171d4be172833959ca5a47b882d65`  
		Last Modified: Fri, 29 Sep 2023 21:13:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7df45655e61dfcdb181f8bb7da9254c04787b30070f59a73788d2aec4af3d51f`  
		Last Modified: Fri, 29 Sep 2023 21:14:12 GMT  
		Size: 17.7 MB (17696119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:7355b0920f9ac419aa51ee0ca2473f50b8aacafb3bccb54d6e499f46ced9eeb0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163372057 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c274c006cfa3adf832a9ddea6540abfa68430e93769938220b0751b4872481f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:53:47 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 22:53:48 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 22:53:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 22:54:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:08bda1e77d0e1bb8d153c98d743f5e73e74725b01da4cd0451d4dadd4bdd1435`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97d555501bc31b97bbe7378a994b842bc114379ab4c2c89a07307f6e7b073705`  
		Last Modified: Fri, 29 Sep 2023 23:47:35 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b6af7ecbadf380abc50fd7c835c73670029af360ca27f69dabca113ee9d0fa8`  
		Last Modified: Fri, 29 Sep 2023 23:47:39 GMT  
		Size: 17.7 MB (17695780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
