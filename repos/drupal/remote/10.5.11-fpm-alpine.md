...
```console
$ docker pull drupal@sha256:5097b86b8b1e1841b65c9caf492d90641a39ff24626e87b4f63b11673252b633
```
...
### `drupal:10.5.11-fpm-alpine` - linux; amd64
...
### `drupal:10.5.11-fpm-alpine` - unknown; unknown
...
### `drupal:10.5.11-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.5.11-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.5.11-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.5.11-fpm-alpine` - linux; 386
...
### `drupal:10.5.11-fpm-alpine` - linux; ppc64le
...
### `drupal:10.5.11-fpm-alpine` - linux; riscv64
...
### `drupal:10.5.11-fpm-alpine` - linux; s390x
