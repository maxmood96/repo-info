...
### `drupal:11.0.8-php8.3` - linux; amd64
...
### `drupal:11.0.8-php8.3` - unknown; unknown
...
### `drupal:11.0.8-php8.3` - linux; arm variant v7
...
### `drupal:11.0.8-php8.3` - linux; arm64 variant v8
...
### `drupal:11.0.8-php8.3` - linux; 386
...
### `drupal:11.0.8-php8.3` - linux; ppc64le
...
### `drupal:11.0.8-php8.3` - linux; s390x
