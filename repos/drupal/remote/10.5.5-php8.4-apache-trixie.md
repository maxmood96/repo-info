...
```console
$ docker pull drupal@sha256:0e97b2fca979660330fce810134ce6fd0b54a1aa5f8ab799c51814b0e070f1f1
```
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; amd64
...
### `drupal:10.5.5-php8.4-apache-trixie` - unknown; unknown
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; arm variant v7
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; arm64 variant v8
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; 386
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; ppc64le
...
### `drupal:10.5.5-php8.4-apache-trixie` - linux; s390x
