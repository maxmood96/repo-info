...
```console
$ docker pull drupal@sha256:9db8e6eb43376a1448d5761b8e7ba6dfca74a7a05b7480872fa9cc8685e5a9a3
```
...
```console
$ docker pull drupal@sha256:c888a88a4178f5d18f96049adddec016951ec7dc0f5e9da9dabe2467d1dd6f70
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.2 MB (167193633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80366a2e3e427ac4d06c488d050c1b3224e8b9cf73fe01ad3b106d62324a143a`
...
-	Layers:
	...
	-	`sha256:9c29336d1c73544afbaefffef0eebcc8306603fe1ccbebec53cf53451b84ef27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fc0f49a3493c7d11309006a9c441cce851f891dc2cd3948c741f76affaccc88`  
		Last Modified: Fri, 10 Jun 2022 02:39:00 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6022eb02419db391216f5e85e57bac0bb0c74dc9432f1a7987f383dac6ad575`  
		Last Modified: Fri, 10 Jun 2022 02:39:05 GMT  
		Size: 21.2 MB (21200526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:f55e971782af1f21354d62826a47ab810dc6a8ea231ac0d222c2e86e9fce7a01
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143050797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82469db4ff2b60008a80c85e5c717410acce8a436cb85d956515feddd2e2eeaa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:36:00 GMT
ENV DRUPAL_VERSION=9.3.15
# Fri, 10 Jun 2022 06:36:01 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:36:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:36:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bf75bf06afd9caa1b6351c1c9fa0a26e3d82c3881c670379f44bad0ce8119ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91a2a53ba8b32440ac14d7aa524a27e1c793821701972ab3a1cc34a49a0173fa`  
		Last Modified: Fri, 10 Jun 2022 07:37:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:841e13bce6b2a87e24d810c1e91f5c9d7d11d0487745e9625f3f4b5387dae9f3`  
		Last Modified: Fri, 10 Jun 2022 07:38:23 GMT  
		Size: 21.2 MB (21200917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:0848c17bae5007790888f3a770d52e25cd5773e2e17be81dec8bc07826b19f7c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158695386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0aa66c71475c517079b8c1ca1e7ddccf1208b9ede789da28d7a0e08822c509e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:12:00 GMT
ENV DRUPAL_VERSION=9.3.15
# Fri, 10 Jun 2022 06:12:01 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:12:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:12:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:21e31121ae543c084faf37b93c86e488f1acd7d00384b84098eea355ea444558`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff3592009da8a5e9b45774b2c1d3339ec431ddbf417972b15c4b612940a14ae9`  
		Last Modified: Fri, 10 Jun 2022 06:44:46 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14a10077f0fa1a267b4dd0a16c8c0ff52cb521d0a49bbad091ceafc5e97e5ce6`  
		Last Modified: Fri, 10 Jun 2022 06:44:51 GMT  
		Size: 21.2 MB (21200124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:dc57b6f2f66109c9c024b4cf054ad8b7b1d8a9a93203c7737a58fcb2bf265192
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172519268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:478045ad479255c26dc51cab5d8d7e07e48a0138f893368147d129677748cfb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 04:03:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 04:03:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3a29773a38ff38ffddb951b80e41ff55d7633c01a7a2f8fca42512f4c9612135`  
		...
		Size: 669.8 KB (669843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2fdf67ef5696f504cea2f28896fc62c4a3c225f52ed3d12f2f5e55452a58f77`  
		Last Modified: Fri, 10 Jun 2022 04:35:23 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:351222aa8898eff314ae7174723851596919c2e8739d7546d90e2dc46dc9859b`  
		Last Modified: Fri, 10 Jun 2022 04:35:28 GMT  
		Size: 21.2 MB (21200988 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:3a1b3f093cbd00dacfbdd9a06d2db7513c67f4ab22b0b7a47807b1b68169ad3d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.3 MB (178266702 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8de6f5dfd11576584aae889100fa43b26104341327d970b6edeb0880c69014d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:48:53 GMT
ENV DRUPAL_VERSION=9.3.15
# Fri, 10 Jun 2022 06:48:57 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:49:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:49:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1d9e35f030acdfc733a2fe01fb233808a72a4955d65348b72208839315a745e`  
		...
		Size: 669.8 KB (669842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db0bc33aa99a5d875ef9e4f006d6eebfd8edcfee2c18cbc6868c0117648592ac`  
		Last Modified: Fri, 10 Jun 2022 08:03:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42d7218557a76d3d9cf1daaba20557f0b6e2b2d2ce554b06d0442b183b67352`  
		Last Modified: Fri, 10 Jun 2022 08:04:49 GMT  
		Size: 21.2 MB (21200802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:0f5b7a2743a525bb0978f323ec0914951bc2cb2d2ed5e16cef0d7c2dc7b4e65e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.1 MB (153112265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42a1b303701306d7bb88e24de2d33a6cebeeeb382fe1696902ebe701d4f32051`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:11964a2440e303f255e9ddde9f28dd9825e072f556dd65744ae253ba973143e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15577334d9f9eff1f22f5d5bb0fd3a9cd09d23affafb5463a18eca638e7ca5bc`  
		Last Modified: Fri, 10 Jun 2022 03:29:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20737551ead941c4739270a6cdf0787e570afd9d0386a96995b5db3239e3606d`  
		Last Modified: Fri, 10 Jun 2022 03:29:52 GMT  
		Size: 21.2 MB (21200674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
