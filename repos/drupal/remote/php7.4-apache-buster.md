...
```console
$ docker pull drupal@sha256:8451fd30fefb0f70ed34783188c51f2f5f4fb5adf706c7c1a88c9203d9cda2ef
```
...
```console
$ docker pull drupal@sha256:d57e7f8b21adee0356ba640f99db1514eaff5ba08963c64d5246632df51ebc1c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168752186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:223465a9628c873e972f404d55293eb09d8b630a5de94f06789fb2f434b28d57`
...
# Thu, 29 Sep 2022 15:58:34 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 15:58:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 15:58:47 GMT
...
-	Layers:
	...
	-	`sha256:4a3a5991c6265f9d609e9d7a9c7802740050e4eef054524379b37fb8b2a0b446`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e071e8ae6bef040c8bc45c7a686d46ae5349658e2e0f0db77c8652bc268b4a30`  
		Last Modified: Thu, 29 Sep 2022 16:12:25 GMT  
		Size: 21.9 MB (21876474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e4f9fa85251c77b9c0dd9b07b902f7f4ff900e5f75006aa4dcd91833aa1bc1a6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.1 MB (174127990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b08b43316a055fd8cd1c20df3d491b4070ceba1b213bf0bd2f1da122b2120b20`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 16:19:37 GMT
ENV DRUPAL_VERSION=9.4.6
# Thu, 29 Sep 2022 16:19:38 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 16:19:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 16:19:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab473a0fd830da790e999bd2717659695b32228889c68259c1e833a29ae94120`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b104184fcb3df123d015b74fdface24cef7ecf97a17f455a4994445804a8764c`  
		Last Modified: Thu, 29 Sep 2022 16:43:07 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6c86ef2a9f292456f260d4d482bf419f0c7b2115809866341b320249a914760`  
		Last Modified: Thu, 29 Sep 2022 16:43:12 GMT  
		Size: 21.9 MB (21877456 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
