...
```console
$ docker pull drupal@sha256:8e827861370ff71b8707d91766e355082e006f811cbbadd26c968d6df3989c13
```
...
```console
$ docker pull drupal@sha256:284dfcff1aeebe4f1b05226b6f3947f34cdacdcee796f9de632fa6714c5750c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.7 MB (152744422 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30cc7e8026598e59fec94f29eb71c3525c9315c5473b2a7bf83d674212b6cf55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 16 Mar 2022 18:12:59 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:13:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:13:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d2c1f5364b05af7f60a161a9555a0046c86d3a54336402b52e3728415fb56def`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b2ace2cd13bee7e7e69fa34660a430f3e242d80396e9b7a854f401fe2808bb0`  
		Last Modified: Wed, 16 Mar 2022 18:35:28 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f48fa8f4ba1d3b7e9c16f2f561d0d394b197d082de70b22c95177b55d2352709`  
		Last Modified: Wed, 16 Mar 2022 18:35:32 GMT  
		Size: 20.9 MB (20934131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
