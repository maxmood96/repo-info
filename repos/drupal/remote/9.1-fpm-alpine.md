...
```console
$ docker pull drupal@sha256:c7d300e3f444565b64f525426af3ed2d773ae0cd45ff81163cb26b7a3e40a207
```
...
```console
$ docker pull drupal@sha256:672e6bbf18bb502d14d50fc5643b81f836bfb33bf59e9d41cdd3a7b02e59f7d4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52169875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38feb60bddb908f9f0d44e469389d88487a2fc3fffee9271622af136e214679f`
...
# Wed, 24 Nov 2021 20:25:02 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:25:02 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:25:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:25:20 GMT
...
-	Layers:
	...
	-	`sha256:c62428bf5d37100f90c6afb9dc1ba27e7230e2791ffadae93eafdfa0d6008bbc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abcc0cf1687a44581168930429583e742ceac9aed25a64a706119e807e605dd4`  
		Last Modified: Wed, 24 Nov 2021 20:39:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b57c2643343caf2a163843666570fe4941efe808c00e91f7013fb0c3970816f7`  
		Last Modified: Wed, 24 Nov 2021 20:39:14 GMT  
...
```console
$ docker pull drupal@sha256:d627245e412ec6622d51913c8bdaabed9cd977ec5641970897a2060fd9002279
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50172469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae52f7f05a7435e2867d3bb1f07df9c8348176a56433d9e56767bbf53fa37dd9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 24 Nov 2021 20:53:29 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:53:29 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:54:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:54:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:82b0c73997d1d151bbaa8258542e3aec907c53528dc526a32957e0b283b9fd95`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fd5d6b099e09e0625b1883ef1877851d5fa4cd8945ecc42131f9bcbd9ce204c`  
		Last Modified: Wed, 24 Nov 2021 21:05:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:960ece94e3c35d6903362fb17f62b04a86da8981a913db5fa9c38d2f7c1485cf`  
		Last Modified: Wed, 24 Nov 2021 21:05:49 GMT  
		Size: 18.9 MB (18879818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:252f6e234d5de8c5fa88604d6087437f2903912e74b7d10444ef9063b7f6903f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.8 MB (48799432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac5559bad45f0d2591471ba4d102a4ae9a9486f36e1e63297d204f88f67c712e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 20 Nov 2021 00:49:21 GMT
ENV DRUPAL_VERSION=9.1.14
# Sat, 20 Nov 2021 00:49:22 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:49:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:49:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2444e4ed0aa6285413e7c3641e0e1c7c634ca515dc74dfa3bfb723bdddaddd05`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41e0cdb4f44bb25567102efc9493500a6e90063f26ca37e304fa9e12051f6a1e`  
		Last Modified: Sat, 20 Nov 2021 01:17:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00300f736ef3398e1a2e9ec878b85c803137d1132c81e901a33900a93587f8b`  
		Last Modified: Sat, 20 Nov 2021 01:17:33 GMT  
		Size: 18.9 MB (18879782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:fee9f4bb8911013affb38d81ff0870ba908a607e9ea7e1a36fda3226ff7f7389
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51179962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fafb53c56aa909fe948454f9a3da6a3082fb45c1c58a31e825afeac948d3031`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 24 Nov 2021 20:47:13 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:47:14 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:47:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:47:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:586d93a868a53271205b0c30fd1ce62913c7d297aa55adaf109fa5c9a115222b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a13526c082885ac808135da92a44a2eaca81d6baf08872469798624e44da14d9`  
		Last Modified: Wed, 24 Nov 2021 21:04:30 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6bf08a6c6065e161e83eb264c59c5580a10e9cd3b3058718ee610840334da9c`  
		Last Modified: Wed, 24 Nov 2021 21:04:35 GMT  
		Size: 18.9 MB (18881222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:c0c192d9f875b153e25c4788aaa9deb37fca0b493521cea5aca3aa63a103a3eb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52804763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:627e51f144501854e97b3cc0044e0b9b1bdfb673510345147f022a5c8e913d63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 24 Nov 2021 20:38:45 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:38:48 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:39:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:67fa1d02b314e03d5ebc7bfd2ad50b125072103306cce82cc67e34e764da797b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e274dea27cbe250058462ba0e6cf7a2c62fe77767404dcdccfb069700839ae0`  
		Last Modified: Wed, 24 Nov 2021 21:11:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52d05d7370ee9c16edc2423701b3b58298f2ffef1c6fe5c060b34e3b9dab0db2`  
		Last Modified: Wed, 24 Nov 2021 21:12:24 GMT  
		Size: 18.9 MB (18880057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:54ca8ec55e62aa71be622503f03d663827f32ceae6778d9356f3c3a79317bce6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50760184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e61d7de08294e274cd65657d630081640a77932084ca9f3608eaaf2f2f46945d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 19 Nov 2021 23:09:33 GMT
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 24 Nov 2021 20:48:15 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:48:15 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:48:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:48:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:29953124f10ddee2c63ba33d7adab10f9d395ba41a3f87f9e7ec55942df3d350`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef4f3af81f5d591428ad5a10bba5b6fb66778285f4b3fcf5128fc7012098e7d2`  
		Last Modified: Wed, 24 Nov 2021 21:02:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dca7086c8b96799419d70181c680fe82137446271e8d47b7dbebb4516e67ef2`  
		Last Modified: Wed, 24 Nov 2021 21:02:30 GMT  
		Size: 18.9 MB (18880014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
