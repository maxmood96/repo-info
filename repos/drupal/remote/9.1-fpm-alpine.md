...
```console
$ docker pull drupal@sha256:3e8272b4dc562c64223c80f812fadc08edcd5c7b4b53c800c705e4a634e2bc38
```
...
```console
$ docker pull drupal@sha256:addd820f9c19bdc46ae835fb17ad51d52fc8833e4a9fbbb0449d5a1aa471267a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50349161 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea73b1bd21cc1f4235abb43612d42b9975e5e10c9db0abd3761d2cdeb8682cbd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 10:03:46 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 10:09:31 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 10:09:32 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 10:10:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 10:10:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ae7057893ff532d1d1ba3f55a5310c34f824b20a057365e741e0f242e5b9cf9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e7799d33790683cccd1598e34ee3baa914b91c29747afcb1a86dab8f682dc6e`  
		Last Modified: Sat, 31 Jul 2021 10:23:12 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa3a6ab0b9a5ceab170f1342be58a59137b782bec363d86f9c3f2d2d55e099e6`  
		Last Modified: Sat, 31 Jul 2021 10:23:39 GMT  
		Size: 18.9 MB (18873532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:044757f24097aeb47dff43ba1aab0fefbfaeea1bef825d68b17b610a0603db97
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (48966429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecb0a352151f22683a6ecbcd71bd10499198a66b231a4bff01e08b88d2899214`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 13:54:25 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 13:54:25 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 13:54:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 13:54:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2661a98560e488315c99e3bbc8262d6a84d467d1081a01f217c00c236989232`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f847032665928aac994276d220f7909b63cd8077cb914b44718fd3eef784aa35`  
		Last Modified: Sat, 31 Jul 2021 14:20:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e8729cd4ce07859d30ca0661227c75a7458cdab3834619dc5f87b7ff656204e`  
		Last Modified: Sat, 31 Jul 2021 14:21:11 GMT  
...
```console
$ docker pull drupal@sha256:8e275df73c29aed753537ed4f61dbd70e3fb8bdbcc32109dc3722cc47d03ec11
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.0 MB (52991500 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64819bcf2ce54f8c3ebc6715229055ab0224380fa3128fd26b58c1cf955599c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 11:22:46 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 11:22:49 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 11:23:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 11:23:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c373cd419dcfc48ca9faae8ebe225a90d17513a3fd6539f9da0437af6debe3ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60763932887306360cabfe8ff579e4dc2bbdaef32636b85b5de0fe45244f955d`  
		Last Modified: Sat, 31 Jul 2021 11:41:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8a7339aa0de8797119809aa38aa5b2eb211439fd1db023718a6eb16cc585afb`  
		Last Modified: Sat, 31 Jul 2021 11:42:30 GMT  
		Size: 18.9 MB (18873019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:c78a30fde03cb3f9c88edef8b46851d47ec6d72bdc930ff2a5beabe8fb4b12fa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50947767 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95a8f9c2db1d0b8aa11b8ca8906dbf5f6df94a4e162b66458ed6059ecbcdb769`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 06:29:03 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 31 Jul 2021 06:29:03 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 06:29:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 06:29:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:927f691477b2fab7856d57c11a10d0dd71a4ab54c71730d65be736689dfc9525`  
		...
		Size: 553.9 KB (553916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebf78be1d53176b00e981b5f3fd82699614d0c682af3f284e431fe74d6e7d378`  
		Last Modified: Sat, 31 Jul 2021 06:39:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:935512591791cea2ec67477eea3d0992b6d33b53d011d193311ef742ab579e0a`  
		Last Modified: Sat, 31 Jul 2021 06:39:12 GMT  
		Size: 18.9 MB (18872960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
