...
```console
$ docker pull drupal@sha256:cc8fab4c883f0ebd5b8e6c1a40de13c8d0f85a731433aff8780ab544afcf8949
```
...
```console
$ docker pull drupal@sha256:a2f2bb4d199632eec418868c647980f43a535e3d90b2ec1227cc9d6f46cf00db
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48852418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be34f2e85a6a3d9a120f1c2e66eaec1a411141d4fef010ca724381d9db524409`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Sat, 04 Dec 2021 05:21:28 GMT
ENV DRUPAL_VERSION=9.1.15
# Sat, 04 Dec 2021 05:21:29 GMT
WORKDIR /opt/drupal
# Sat, 04 Dec 2021 05:21:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Dec 2021 05:21:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:afd5c6eee63cc5d9d299bca0412de6bff43625f292f55b6fc9667932a0b0df8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95311e018a2cd45175c62469caf958b9ca92c0433d4bc7155ffc64e29035add0`  
		Last Modified: Sat, 04 Dec 2021 06:02:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edc002f5ce96502daff7a2c58615fef9121061686ab2e1682508af4f37a3fc32`  
		Last Modified: Sat, 04 Dec 2021 06:02:29 GMT  
		Size: 18.9 MB (18880188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
