...
```console
$ docker pull drupal@sha256:b21e9567d14c492d75b36e4a19498e98a9540c06b4db463c4172f1d9ebecd378
```
...
```console
$ docker pull drupal@sha256:195cd8ae29f991d8d037bb404c7a2184a732f47d93abeae16c916ffc81204d61
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53077352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc7e529cd521562058996725300ed0e1d2050f46bb904905cb6a69f0fef1ec75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 08 Jul 2021 08:39:12 GMT
ENV DRUPAL_VERSION=9.1.10
# Thu, 08 Jul 2021 08:39:19 GMT
WORKDIR /opt/drupal
# Thu, 08 Jul 2021 08:39:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 08 Jul 2021 08:39:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9fd388e21b6614fd612be201ae83843e28c473033de37f7baa9e94f54e678b7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4fa1b1e5ebb5da5b170e965f22d434825c4e833b515b33e3ea2c7d9a04c2348`  
		Last Modified: Thu, 08 Jul 2021 08:57:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa074a1203aac7e6eab19534da8a8abaf73672ab38457c07d766a8dcb1df6ee8`  
		Last Modified: Thu, 08 Jul 2021 08:57:40 GMT  
