...
```console
$ docker pull drupal@sha256:135de15fcc23357b48a078f5731e3562b8eda67ed590fff897f11df044490836
```
...
```console
$ docker pull drupal@sha256:399ccdf315e229d7a66e5944f65abda6c2444a96384a29a8ae49ad3606a59f2a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50339820 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f448f9601e3c493c7af6a2b8efc50dd85344e7384bd665767347cc4510eb9f4f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 18:20:40 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 18:20:41 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 18:21:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 18:21:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:97957ff52db8513f5b29559ef62e2dec5fcc4f584b012bc2de84adb805a2ef6a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c784b792dc2686d1e915ceca870f327f06998fa8a260381ae26fb7798f60f841`  
		Last Modified: Fri, 23 Jul 2021 18:32:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fa01ca5d3f69aaea0db5e25547cc15b385257f4f0c8fd15189ab65e3de4bfc3`  
		Last Modified: Fri, 23 Jul 2021 18:33:23 GMT  
		Size: 18.9 MB (18873021 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
