...
```console
$ docker pull drupal@sha256:ac3bed2fdcc3f7d2d0ac77da183fa1e6609eaf98c81ebd87b937bc6a0bdcbac5
```
...
```console
$ docker pull drupal@sha256:5103ad540184a2fe609ee8d9f585829b997154c6dead3a1eb384513c823ed1e3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49176032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79425c68d7a498d09cb870ea88b319a5a798b4963fd03639e2edb31660ab436e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:10:57 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:10:57 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:11:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f4e95bca6dca80edd672dad95c201a64f588f21472d7f0fe4afdb3f453da2592`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dc47c3af7300793634f2b9c9481494df932027f2002fa8a5ef29abd4f8dad69`  
		Last Modified: Fri, 30 Jul 2021 04:47:29 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:277e10f99f5ee3542b3a241a0f188a826b8de190b0dad852aa2e2fa3d5fed6f9`  
		Last Modified: Fri, 30 Jul 2021 04:47:55 GMT  
		Size: 18.9 MB (18872745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
