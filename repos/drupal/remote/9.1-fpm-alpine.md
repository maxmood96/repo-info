...
```console
$ docker pull drupal@sha256:9c34c47191b2503ec7fc5dcdca4a10b335d19c2a3d9b0f1ef1d756dc88bab509
```
...
```console
$ docker pull drupal@sha256:4626a5980d59506132a491de63db98ea244c15cf4d3b2c05395370462c4266d2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50173335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90c19e0174f5561cfc677dbd14dad8075bc73bc4c2f6a4d6f2e8054e9255c588`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 07:01:44 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 07:01:45 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:02:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:02:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9f332257aba2e7f7fd66a15d5997485dc19e17a11d6574323895400e7cf43c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f77b57dafe363084d612e8a64e9d958ac5d68fa76bec3fdc4db043842f46fef7`  
		Last Modified: Thu, 02 Dec 2021 07:13:33 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2e747dd48320de41732b956fa23fd26179dd968f633376fea267aa61ca1be79`  
		Last Modified: Thu, 02 Dec 2021 07:14:00 GMT  
		Size: 18.9 MB (18880163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6bf6eb8ee00a4180d7ebf4a3443e0fb3dd4d66ad881b39418326f09c7a80e319
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.8 MB (48799788 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4aceee3797f16166e76d054cf0c0cc01e0b9751ac603be02a47e19818b469198`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2444e4ed0aa6285413e7c3641e0e1c7c634ca515dc74dfa3bfb723bdddaddd05`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2754b173f06f14311e61c8f9b1b564858fe39b0c9e508b7c472e4c69becc980b`  
		Last Modified: Wed, 24 Nov 2021 22:27:38 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8626520cf2fa79d008b96aa86de6ae2257dd1946d066a7f8b2f79c97e5946fe9`  
		Last Modified: Wed, 24 Nov 2021 22:28:05 GMT  
