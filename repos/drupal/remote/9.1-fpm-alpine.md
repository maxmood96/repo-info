...
```console
$ docker pull drupal@sha256:ca5d203092fc8abe6c1aa71988ecf58b9db6d204558616cf1e41d214ef4c2bb8
```
...
```console
$ docker pull drupal@sha256:00a3bc090dce97a464a45bc1f54a01036f03463db45e24eaca543d34fd1cdab9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52804400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d7e0825a66fb5cd99d346d353cf3d289c681b32a8341562d4823612b2ba87fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 20 Nov 2021 00:50:32 GMT
ENV DRUPAL_VERSION=9.1.14
# Sat, 20 Nov 2021 00:50:35 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:51:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:51:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:67fa1d02b314e03d5ebc7bfd2ad50b125072103306cce82cc67e34e764da797b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2129828179e7c708ac6d12b003b655c31226e31dd856cde547bac06cf5f52a93`  
		Last Modified: Sat, 20 Nov 2021 01:09:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7ae4cf8ee4ef0d912fbc727e0664c2c52fcb92e0c923507f20f8c4a3ef17972`  
		Last Modified: Sat, 20 Nov 2021 01:10:20 GMT  
		Size: 18.9 MB (18879694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
