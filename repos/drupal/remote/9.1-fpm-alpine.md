...
```console
$ docker pull drupal@sha256:297cb8fea4c9c22595adf7c326ef0f82713557781eed437b3875d1a04c3dc894
```
...
```console
$ docker pull drupal@sha256:da3e1812a14966398eda9e6e75b1786d498a239d17517d3aec36a7e5def19b87
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51194157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a7ce6d89c849bdcbe5b7b56a3d9c0af96c9ef185c4b270a304a856e7e471d82`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:40:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:41:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:db356fcc610b160c7859bfa426416ae0ed54338090b587b873b1c05a33d27d36`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26d50ab4c9a6f90f6106b7a74573475a21669a3b72ce20d070bce4ac6bbc58c7`  
		Last Modified: Fri, 30 Jul 2021 03:58:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b13ee3d71923559f9880ce0847b7ce034f867922f3136da5918b56e8ced354ca`  
		Last Modified: Fri, 30 Jul 2021 03:58:58 GMT  
		Size: 18.9 MB (18872709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
