...
```console
$ docker pull drupal@sha256:68942c323fc6985a6ebdd5edfa23fcbe9490bcb3c5ec3cca84b74e87086cb3dc
```
...
```console
$ docker pull drupal@sha256:7ff7478c95c461c5cc07a5d754c65f7e9532c926211110a2bdc79440ac8eb68a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51356298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec2c38c66f51a428766025e609717ce38f6b3d3744f9f9853752c8e939e70bb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 23 Jul 2021 03:51:02 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 03:51:02 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:51:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:51:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:abd960aaf93c6e7bf7bf800c8f826beb0844632b07e787af53cf8395bbaab399`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bca53befed74982149ba62c31ddc7e3e613834b7089efb15c3a2ccd415f4cc46`  
		Last Modified: Fri, 23 Jul 2021 04:09:36 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0807cbbfb297511f20f540c56de0c05f9f466b1d6dbfedb273fe1ba47a6c3d4`  
		Last Modified: Fri, 23 Jul 2021 04:09:41 GMT  
		Size: 18.9 MB (18873623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
