...
### `drupal:9.4.15-php8.1-fpm` - linux; amd64
...
### `drupal:9.4.15-php8.1-fpm` - linux; arm variant v7
...
### `drupal:9.4.15-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.15-php8.1-fpm` - linux; 386
...
### `drupal:9.4.15-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.4.15-php8.1-fpm` - linux; s390x
