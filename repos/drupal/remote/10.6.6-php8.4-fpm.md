...
```console
$ docker pull drupal@sha256:a864f2ce2696dea3c07f505fb6ecb522836c26f8219901f12fb7e8f21ada7662
```
...
### `drupal:10.6.6-php8.4-fpm` - linux; amd64
...
### `drupal:10.6.6-php8.4-fpm` - unknown; unknown
...
### `drupal:10.6.6-php8.4-fpm` - linux; arm variant v7
...
### `drupal:10.6.6-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.6-php8.4-fpm` - linux; 386
...
### `drupal:10.6.6-php8.4-fpm` - linux; ppc64le
...
### `drupal:10.6.6-php8.4-fpm` - linux; s390x
