...
```console
$ docker pull drupal@sha256:8509fbf79fba2d154dc527c01e75c6f72898e3405c3753d6027d49fbfdeac991
```
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; amd64
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - unknown; unknown
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; 386
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.6.3-php8.4-fpm-alpine3.22` - linux; s390x
