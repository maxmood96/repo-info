...
```console
$ docker pull drupal@sha256:b2d7aa7f68b812a31dbf728a86604bf0f8b823d2450eaa3f30ffd3bde7771c37
```
...
```console
$ docker pull drupal@sha256:0b2adbb976d14e4be0c348e3d7a60ae376ec6a49f7afccae5ce9bbd081414499
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.0 MB (169951579 bytes)**  
...
# Thu, 21 Sep 2023 06:24:24 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 06:24:24 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 06:24:25 GMT
...
-	Layers:
	...
	-	`sha256:67a30c9b931ccee27b7b1162a808e93a62fc335c0149ab0b6cb56114589d71c4`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fadfc355b75774164012836d59f3502b3e00ef64f76de7fafc5ead71d3d8722`  
		Last Modified: Thu, 21 Sep 2023 06:41:35 GMT  
...
```console
$ docker pull drupal@sha256:eff1c92b50ff51963cba7a90f411e4d43c34824cb28d015dee7f2337eab4b25e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.3 MB (147348651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13c9192e1526e441c9928cc6deea107b578f618ce1ea333779b90c757aec1072`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 12 Oct 2023 09:14:00 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 12 Oct 2023 09:14:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 09:14:01 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 09:14:01 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 09:14:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e447021f0b0986beba8cbc442e0dbcd28f9b420aee29e1df0e68563b263c2e7b`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b405e95d3c7fcf7d7284fc3a681ee570623d9733cedd3b65b1ee3e735f941b7`  
		Last Modified: Thu, 12 Oct 2023 09:17:47 GMT  
		Size: 1.8 MB (1798716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c82e6157603cc5d6fceccfabca7fdcb9404f9e3c799226bc978130e7456ac7b`  
		Last Modified: Thu, 12 Oct 2023 09:17:46 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:711f9f91c2d2b86a4500ae2f5fcc87afd8e47f1c65627618568d4b03589a7e6f`  
		Last Modified: Thu, 12 Oct 2023 09:17:47 GMT  
...
```console
$ docker pull drupal@sha256:46e044148b42f0b69791d879f18ada3ebac522484b15669a97a7777d98bc2cf2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.4 MB (146369296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ee510c026827e3cf4d6d33056e6ffdc8f87036c8671f6ca67dd937bfc608ea6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 21 Sep 2023 22:41:23 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 22:41:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 22:41:33 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 22:41:37 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 22:41:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ea5238397653a4cff5c89f9850db44abe77a2c1f9033824b6fdb0d9c21c09ce4`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e1d224fb277f6b53d5aa7c0da5078955cda2c2f216be0a556b55d4c44a605c`  
		Last Modified: Thu, 21 Sep 2023 22:48:19 GMT  
		Size: 1.7 MB (1692510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2cd3f1cc74a0b3b251723d4262f8011f1b2543a5ec088efe29eb47d6c8d3355`  
		Last Modified: Thu, 21 Sep 2023 22:48:18 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04502c388a3845ee165b0e2882127c5a51999e7c4c2d058f3eda11242a90381d`  
		Last Modified: Thu, 21 Sep 2023 22:48:21 GMT  
...
```console
$ docker pull drupal@sha256:68b90a5b6270a804ce1d6e239005de17e3572ce0a00006ceff68c22349ecf74f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170316022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c1ced24965e7416f45a0b210fe991e3e528627a4de4de01d99070a279d79d39`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 10:02:02 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 10:02:02 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 10:02:04 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a3f33ad31c62fb064954f11b94fba469e454233b339e247c739fa83a976626b2`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7847045e8bb6ed14e7202397335e6b14a669f333753946b58233b7de5c1333f`  
		Last Modified: Thu, 21 Sep 2023 10:26:30 GMT  
		Size: 3.4 MB (3410789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
