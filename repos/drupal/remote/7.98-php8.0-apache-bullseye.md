...
```console
$ docker pull drupal@sha256:2d22433ec7d51d76ef738ff84e34871cf78f78b2b0f124d3e3e5b2ae46b67da7
```
...
```console
$ docker pull drupal@sha256:1e826a4c75c2089a7ef8bbb8c6fcd89a6102dad64a87f9767e180a9327cea2d3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.0 MB (169968717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:273a216f4af103d145e5f92f5bf5f247cdf7c79c28479d625cfaf465c89829df`
...
# Wed, 01 Nov 2023 19:30:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 19:35:15 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 19:35:15 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 19:35:16 GMT
...
-	Layers:
	...
	-	`sha256:0261d3a57bb7804fde110d53eb0980f4537290288326139bb2562f7cb81166be`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:376348fe7beeb1e858eba7c24d70d9370f5b5c7d3dc47f05c12ab5aeab807bae`  
		Last Modified: Wed, 01 Nov 2023 19:50:44 GMT  
		Size: 2.3 MB (2295360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3ea4b37322a75f90028fda31211f55c348415193b7b13b373f01b6eb846bafd`  
		Last Modified: Wed, 01 Nov 2023 19:50:44 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6031a7531ec2cb13e3f3e841b75791089cb8285e0c2c334509527c30bf294142`  
		Last Modified: Wed, 01 Nov 2023 19:53:48 GMT  
...
```console
$ docker pull drupal@sha256:1b5e54283119fe146de45efb43ecedd4fdac51f6998c1462bee96c3515774ff2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.5 MB (139477447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1dbbca2eef66f03a275e301bc12ecdd5a1c671d070df2aa803854527231abba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 14:09:06 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 17:48:53 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 17:48:53 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:53:21 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 17:53:22 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 17:53:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0457a9afbb639ab87fdccc17e608c9a7c4a52fc2eb0f482e2eecbafdb3811e74`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e2689eea55084828e421a0d4ff1c2e22b81e9e2a5efd49f3f96768485cfcc90`  
		Last Modified: Wed, 01 Nov 2023 18:13:17 GMT  
		Size: 1.7 MB (1667903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dbc22f7c515907bf9c792a258d186817c0c0341531a26adcb7ea262e6476853`  
		Last Modified: Wed, 01 Nov 2023 18:13:16 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa02058ee4ddeda445ed0f8f73e8507184237b07a853f348d267cd571f434346`  
		Last Modified: Wed, 01 Nov 2023 18:17:07 GMT  
...
```console
$ docker pull drupal@sha256:154695e09040a107ba8913d0a87d93ea3b845f1b31908b25efb90a27e6d0bcc3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162930449 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:323c66ba8bb1eb850cbc2b7bec4d51b7d7952d332d7b786da7e7a6292ddd1bdd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:16:53 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 17:49:39 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 17:49:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:53:23 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 17:53:23 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 17:53:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:62b412d1c402aecc66817c472eb3cef3933a4b261602920074ec10ad79f95889`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06c87b71528ef547c79efc2c08dff70d5954f0cd45803764a80e1846a8a3f468`  
		Last Modified: Wed, 01 Nov 2023 18:09:08 GMT  
		Size: 1.9 MB (1938714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c6c98c1f264a2cf5dc062a50e9b05cd3d004aee01dbfe662e9bbe57e32f2b33`  
		Last Modified: Wed, 01 Nov 2023 18:09:07 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34051ea336f1c41496f5c635836da99ef40553df6fbb4046b216a6c6a3d7c013`  
		Last Modified: Wed, 01 Nov 2023 18:12:15 GMT  
		Size: 3.4 MB (3410786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:600b2dfbf6f4265114b9454306a56392529285c5fefcd4e5bb3aa470bd155bd7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.8 MB (172799271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:959c332fc1ab48eae2efcf90dc1026e88dc8368b1b5270e2935abf865125dc7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 03:50:25 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 14:38:28 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 14:38:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 14:44:01 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 14:44:01 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 14:44:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f3fc387b23c569e255e03edb43f0bd2f2e81dee7ba17feb9a8b57cc7b6b53650`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735c37b355dbceed5c273687e77742cb67d0f85207089c4fe0afabea368bc7ed`  
		Last Modified: Wed, 01 Nov 2023 15:01:53 GMT  
		Size: 2.4 MB (2359956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8715cc8d353895d1f4fa3ea34e9331daa32a8c75b66e2fa0ddb747af69be1bb0`  
		Last Modified: Wed, 01 Nov 2023 15:01:52 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd509561dc262cb7b411b9dc40f35c5034df5edd9cc80640224ab54448b77419`  
		Last Modified: Wed, 01 Nov 2023 15:06:20 GMT  
		Size: 3.4 MB (3410786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9eace85c293d0a3fb3f54311b7d7819fc1335aeea07728e0e4a0dfb20d385ba6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.4 MB (146382570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13a3c7f909898d6c82a8b9a026bcc296816be4bc80df112e6a70aabd2325fc40`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 22:50:29 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 22:50:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 22:50:39 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 22:50:43 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 22:50:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e4362ed45933c8184a95e255d0a3606242fd0bd5d922ded991da4485fd6619ae`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62603293e6e8b2ef21169c2ef5434322bcb780a786c53ed2402b3c6026a72eda`  
		Last Modified: Wed, 01 Nov 2023 22:57:17 GMT  
		Size: 1.7 MB (1692472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:079a027027634fba672bcd8ab1ee8eb4635f082c042f062cd6fc5f8082bf0a13`  
		Last Modified: Wed, 01 Nov 2023 22:57:16 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60b4a21b17f2dcf4933de56fc050dfb03fabf54e70d3b78cf093979903ec3fe9`  
		Last Modified: Wed, 01 Nov 2023 22:57:20 GMT  
...
```console
$ docker pull drupal@sha256:1d5d1e027ca6cbf5d47682ed35b5d17d815c68152ff08d8b7f41acf3b60067a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170337762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44f36b09c364a4e322619e7bda0db5d1128799fc17afada38d63294083995d00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:26:38 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 16:14:04 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 16:14:06 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 16:18:59 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 16:19:01 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 16:19:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fef1031d38a136e2b9b6b6941028c8750a25044053c4421a99169300fa739447`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fe255abc6b721b62f0fd520c4faf8f31496f12e4cf7b406e48cb6c20513080b`  
		Last Modified: Wed, 01 Nov 2023 18:27:35 GMT  
		Size: 2.2 MB (2201609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ee89149c3162e56785355afa63a8252eb365c173f08af0c1592f46607f1545f`  
		Last Modified: Wed, 01 Nov 2023 18:27:34 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c033980fb7b377538d1da1ed626e2ab5ddf22149339ed8f1c5a6f5042bb108f6`  
		Last Modified: Wed, 01 Nov 2023 18:31:33 GMT  
		Size: 3.4 MB (3410779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
