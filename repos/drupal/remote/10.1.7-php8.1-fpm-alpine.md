...
```console
$ docker pull drupal@sha256:54eca36357610a20f8fb563b117488624d1a3d3116d2a4fb674096c806db8189
```
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.1.7-php8.1-fpm-alpine` - unknown; unknown
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:10.1.7-php8.1-fpm-alpine` - linux; s390x
