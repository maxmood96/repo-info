...
```console
$ docker pull drupal@sha256:72478a882a7470f171b19cde689de70f4b4f6ce5f75911aed58ce73e7fc1aac5
```
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; 386
...
### `drupal:8.9.20-php7.4-fpm-alpine` - linux; s390x
