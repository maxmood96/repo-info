...
```console
$ docker pull drupal@sha256:f630df72257dba3e9041a4b5da8c1536a01eb600798f9c5261789072e0040444
```
...
### `drupal:8.8.11-fpm` - linux; arm variant v7
...
### `drupal:8.8.11-fpm` - linux; arm64 variant v8
...
### `drupal:8.8.11-fpm` - linux; 386

```console
$ docker pull drupal@sha256:ea9e686f2f489f287039dd697729c30f850fd1d0e21a37c10f93cd3f7832ae34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.6 MB (171555892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e5a86da5b08de2a407bfc5014d020c491c7d44a07a401343797499948b861d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 09:14:24 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 09:18:24 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 09:18:24 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 09:18:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 09:18:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d6dc46e55ce1dfc8535280d2b01bf4a4054937f2dbc13e7da1fd7d5e5e27c163`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f464a4301922561d9148854964fe99eb382b2310295f414bd1fd0c967fe5004`  
		Last Modified: Tue, 01 Dec 2020 09:23:20 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0795d1552a9e38c2789a4b841dceebb76e3460e8c4eb7fa63bda5f932656960c`  
		Last Modified: Tue, 01 Dec 2020 09:23:32 GMT  
		Size: 20.5 MB (20541759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.11-fpm` - linux; ppc64le
