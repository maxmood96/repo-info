...
```console
$ docker pull drupal@sha256:551221cb2b455bd8546c137d2e8cbf75f6aa0f3fa748864a3c763f8f11b5d9c4
```
...
```console
$ docker pull drupal@sha256:bf70b27fb742cd7d1ceb556c1ab0f292a4af7dc7e0aa2725fa81f3dc2b881d00
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161939730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fa14c3050bf9e204ad493ba677402579d95cb5231d799f91c76ae7f69b1af3d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 May 2023 07:09:57 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:12:33 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:12:34 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:12:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:12:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d65470527b21e9bd859c4c8b49e88213761d97062f522dcd7e7e2fe183260882`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b637b3810e8d43a0f1bbf68e3939e8001e3a2a2e3593c6df805789202131c6c`  
		Last Modified: Thu, 04 May 2023 07:21:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54c931f9e4f6ecbf8e1f3e2d2f9d7e179b62573df1ad15fe885aaea4c56ca7a4`  
		Last Modified: Thu, 04 May 2023 07:21:46 GMT  
		Size: 21.9 MB (21914541 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
