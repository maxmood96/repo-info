...
```console
$ docker pull drupal@sha256:8d8254e3399cd1d9477ab3f7cad9dea5da59b5c5dadcc640bd084758991f43c2
```
...
```console
$ docker pull drupal@sha256:1133eec0ffa4720403042d5b56d53b379365180ba86a9cfb479ab4c10c7a2573
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165818076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf84cc6b5e5979d992211cec9b54766b63672b6e773cc60d9d2245a65d90e6ac`
...
# Fri, 23 Jul 2021 03:28:05 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:28:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:28:23 GMT
...
-	Layers:
	...
	-	`sha256:b6f310e519097eb2fe69dbac6ff9570f7983a569ccccd6ef29d272e73ea92fe4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a38a31472a0ff53c9b2dae7d15d83ac0e939b15e90dcc6d5b5ed47e8570cc39b`  
		Last Modified: Fri, 23 Jul 2021 03:44:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2748b93d85711f3f88d4d41e040f6316002dbec6eeb58f540ac6b7d1c4dddf26`  
		Last Modified: Fri, 23 Jul 2021 03:44:14 GMT  
		Size: 19.2 MB (19179458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:645ace1ba9a1f1553e1b47aeb2dc550d231bf6a8644b6f0b7e1f774c5c2fe415
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157334828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:faa98f0cf1d1d7f0f59e0b86c5827fab2afeb01e1135dfa3ac803b5318aa92d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 23 Jul 2021 03:47:07 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:47:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:47:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:99102394559dcb0a9fcb79d8374b79451acacc98169ed2cd6463e76310280e29`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:733aa45d5c478740637f725584af59b424676fe082a080eaafc4a190ca11ee0e`  
		Last Modified: Fri, 23 Jul 2021 04:02:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d520380e24d5382b95984f70d8e8bbeb4bd6ad771c66c087f1ad478b023b4b6`  
		Last Modified: Fri, 23 Jul 2021 04:02:20 GMT  
		Size: 19.2 MB (19179470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cf4c5bbb86ee0687c0a2b34ff2bade9fe2f810eec005d4655288766335f7b231
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150875093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee07805c8eed4bd91d30f59c16e8ddc36e15c4669a9f3643146821e617a6fff4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5b0f37fae58d62cf1ebe5912cbfa57f9316290804d17b8bf9f3c001f68794ad9 in /usr/local/bin/ 
# Fri, 23 Jul 2021 03:51:38 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 23 Jul 2021 03:51:38 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:52:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:52:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:35c920f88586678605fb1a08a02e3e43c06ca269e635f37bc6ebaffdd9ab077d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17ccadfcdbb8462f132409f06604c49abe871bc3115a6364751bfdc67e7b75b3`  
		Last Modified: Fri, 23 Jul 2021 04:09:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3a9b18a9e00d339bbefe1eb7603345b1beb1ae71f3ca83508975df81b09496a`  
		Last Modified: Fri, 23 Jul 2021 04:09:39 GMT  
		Size: 19.2 MB (19179513 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
