...
```console
$ docker pull drupal@sha256:0b7ce2959b51339178c555b66e4bea3f0398f30fb868c370c01d4683cb904b2f
```
...
```console
$ docker pull drupal@sha256:bf5acde01a11f6980e07dce00c2e3988b0aa4bbcc9b6e4f748c03563408ee695
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.5 MB (164492579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb35fbc8fe3b11292a6a33f5f1638940c0412d97642f035e9b296fc4f4eb4c1b`
...
-	Layers:
	...
	-	`sha256:a00a716d305867f742566bbfa856ea79a25077e151c0cfe495337229287ed202`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6ed40a2f7d342aaa0a0b6ef0ffb2e9f5e4d843271426a9d1b4f54a97d172999`  
		Last Modified: Mon, 06 Jun 2022 18:50:48 GMT  
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffb39b0bf939d3d5d3a29dde14194d17fd6a43b5b7ccd3c694b55a05d2d9bd0b`  
		Last Modified: Mon, 06 Jun 2022 18:50:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0b4773e372d81b15fe1dbda0f61fb6109e7d686a34ec706c87c9359fb667ed7`  
		Last Modified: Mon, 06 Jun 2022 18:50:52 GMT  
		Size: 21.2 MB (21207396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b9b12e432269691fb6af9f54da28a4a3257ea907a0b45c19c8b05b5c1b6f4e67
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140104425 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b230b113a3c322d4d99b6bd50d6be1fe5aa22d7a19f3a85757ca614b77ff4a39`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:26:21 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:26:21 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:26:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:8d21a9ce3ce7d1b782a7077b459208d01cca46b5d7ea302690626e160482454b`  
		...
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b252901d5aa2ff23ad57aed78864d739f4ac835c4bbfa00f0a308b037d699941`  
		Last Modified: Mon, 06 Jun 2022 19:23:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:233445d91d1321b9636a6d438901c6f7703efc509267d8e1c97849b0e8304f5f`  
		Last Modified: Mon, 06 Jun 2022 19:23:19 GMT  
		Size: 21.2 MB (21207335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a108875ff1d53f1fb8edfc7a9d61da07776d542b08500453508b60cfacc5fac0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.4 MB (155409146 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5bf65bc913b4b2f3a27c944f17c75ae9bbd8f4cb7fdbcfbb99fb56b5abb00c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:56:03 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:56:04 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:56:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:56:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a0dfb4d1ca3e159b51f720dc79b5d520381a0f558d3be716315eec0c7224e952`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d47972febb58e01363f4476e15552287b0f528a0b866c3b76aa92739ecf7b25`  
		Last Modified: Mon, 06 Jun 2022 18:24:37 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92dea3f8567049397c9a303517835aaa9fa8801295faba438bdcb84b1cc63271`  
		Last Modified: Mon, 06 Jun 2022 18:24:43 GMT  
		Size: 21.2 MB (21207745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:c33bed092dcc79bb88f68eb1f98a76ac8596558d9c82d7a9e8d05a5529e1c4de
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169582879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0b015c477e727ea25e586af3ffa2fb0b587dc63f3425ceeb9b450be134c950b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:50:45 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:50:46 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:50:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:50:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a4d1687b85865799224e4e226a02e4d0bcd8dd5ef20e8e0b99ab39c56379ef37`  
		...
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e0d097d43fa63ccb7b446e1da3b60fa82f26b97304c085bc0e8538d78ccbee`  
		Last Modified: Mon, 06 Jun 2022 18:18:23 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5879bad641b9d90a419308aeaa8853379a25cc0b9d7f00f903770da3ac38bf4a`  
		Last Modified: Mon, 06 Jun 2022 18:18:29 GMT  
		Size: 21.2 MB (21208439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:2adeb8f4250f9e2e87cb6a1902cb1ab5b29b7d8107f948358cc842cfb5075442
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.4 MB (174403355 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:578490e55bc3403470c320717c1b5147ae4f8120a281ffe51e0451a71078ec15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 16:28:30 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:28:34 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:29:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:29:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3778175571de4ae2e6497b41d26b512334a68a28ba4e601322e451f807c37880`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77ff2cf1fc46b6968569de614e2ead45b5d6517a1606c07fc277df904ee0df5b`  
		Last Modified: Wed, 01 Jun 2022 17:19:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:465f241e7d1feb5a8f2c4fb9e422694b6800955fab0f804019d07f49ee1224f1`  
		Last Modified: Wed, 01 Jun 2022 17:21:02 GMT  
		Size: 21.2 MB (21182932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:ae70100885b9bdd815b0894b0f5c7700585ec3a04e979df9dbf1a69d18d86976
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.8 MB (149798430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9896f1fa07c0a3d2f9258db6c170ec6f20d708bd9a9c65f7ceab4e5d128fb4f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 29 May 2022 05:06:24 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:57:30 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:57:31 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:58:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:58:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed62b461187ab5978f215676a9608956af11be91db799700c719d90ea0749b9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc90b63e32d0cc369cd34db0b72f5e0c03643a0bee35cdb89bb978abf4a664a1`  
		Last Modified: Mon, 06 Jun 2022 18:26:07 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81077f40ddfa24e1ea949e61839f835dec0c491cce5b6c9da2e451c2d6126a48`  
		Last Modified: Mon, 06 Jun 2022 18:26:11 GMT  
		Size: 21.2 MB (21207399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
