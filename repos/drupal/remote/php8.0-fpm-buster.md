...
```console
$ docker pull drupal@sha256:b5aaec5bca98aebccfbd8fbb6046083ff0437e716a2c636fddb048d4cc0a3546
```
...
```console
$ docker pull drupal@sha256:89c4c80b03a86cbdf8dae9dc8f01bbc08d85181bdf97a7c6c5d93af044bc6c4f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.1 MB (164138451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d62c963b1948ed9ed7e3602ca533624b5383a1070285065a87a014e29f30b8d7`
...
-	Layers:
	...
	-	`sha256:f18770133d66c50a71c6b4b6cb933201f4620f4ed5de5ece9e6f99aaa380bdc5`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65ad7505ade8e2c0a748c23dbbc79af4677eb474e5a26ccfcc1399848d8e333e`  
		Last Modified: Thu, 31 Mar 2022 05:59:49 GMT  
		Size: 576.1 KB (576057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:680ce8968347a1d96e9946c6008d0b219edc8390a74030acd62baf43deffe69f`  
		Last Modified: Thu, 31 Mar 2022 05:59:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4924bd28ca192cbd1dfc2419f08a92129a3d612cccbf06d566b094c20735e74c`  
		Last Modified: Thu, 31 Mar 2022 05:59:54 GMT  
		Size: 20.9 MB (20949395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:906b8104bce8c9f3a7a061b67afaeaf3a35e9c015e2c9f86a46cb72d94bc9dbc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.7 MB (139744650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34a7a0fe89df670286889d7ff3a5b9e811825b601792afeff07f2e0999f19648`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Mar 2022 11:32:23 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 29 Mar 2022 11:32:24 GMT
WORKDIR /opt/drupal
# Tue, 29 Mar 2022 11:32:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Mar 2022 11:32:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15274b306229a295e913ca0fc8c00bd05bd11d43effc0d3095283857166bbe71`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61ab1f8ab2a5c0959e0746a8953617f5aafd5164b090da2cdc67f899ee057e4b`  
		Last Modified: Tue, 29 Mar 2022 14:13:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89db036cfe8eb7c71c3b5dce1845124ddc49a7b86159fcfe45d144af1a7c4777`  
		Last Modified: Tue, 29 Mar 2022 14:14:25 GMT  
		Size: 20.9 MB (20948889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f1c11bc067c64fa0dc8b1da3f6f50234685225b1e87283ca92d59d2ba2e8f81e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155051171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67fc4cadf1b6f5f9b657167bd26ebc89880e0ecaabcd6777f1c1fbacbcc65684`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:22:00 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:22:00 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 15:22:01 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:22:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:22:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c6ab9f8137c341221a1176bdff4cc698b4150b94413f2824e5239474ca39222a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ccb645acf494b98c746fa5c67736256b45c157ec482eb9740b58358958dbb9e`  
		Last Modified: Wed, 30 Mar 2022 15:52:06 GMT  
		Size: 575.7 KB (575713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3b51bf869b5a8217a5b3a1110bebc7c744260087a35381c8f3eab16ed1e9b91`  
		Last Modified: Wed, 30 Mar 2022 15:52:06 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2bbba1ac8d358e8e400906b400a3756df1306d95c97207fd9516ea64e9c5990`  
		Last Modified: Wed, 30 Mar 2022 15:52:11 GMT  
		Size: 21.0 MB (20950234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:de7a33591e1265f5f0ffcd9cef4b33bd357988d8dcded06a6019a604dd08a655
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.2 MB (169219925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1194ca70cc0e0671965e6d5925ae7f98f75f6545f5907ee1d7fd817de210497a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Mar 2022 19:00:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:24:06 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:24:06 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 18:24:07 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:24:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:24:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89557c60107b40ee81fa3357a30145b7a8406ca28a796e6834236ed3514fc47c`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4980dfd0130322c3202184dd4321a104e356688a4fc326597c3c5f9792cfb70`  
		Last Modified: Wed, 30 Mar 2022 18:47:09 GMT  
		Size: 576.1 KB (576058 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93f4bb1478ac52909777e2f4ade75be9c3c811c3d924263f67e03d199791ac15`  
		Last Modified: Wed, 30 Mar 2022 18:47:09 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c7c09e7b79f316d24e730a6684624db3e85ca037dd6446cf320904013e1fc0f`  
		Last Modified: Wed, 30 Mar 2022 18:47:14 GMT  
		Size: 20.9 MB (20949995 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:56fadb623c6a1d20915e0aced123159c6e0701a869bc58c8efc5763617c09bf7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.1 MB (174066587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9de932b5eaf2812b4149bc70d87c274caaca3b1e223e2fc70c8cc675e9203786`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 18:24:03 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:24:15 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 18:24:21 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:25:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:25:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cf120d6bfcea36e32f60fae5800fb37e73e02c56d1613abfd0cee558a83a87c2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb6966bbc21886aeddb8e2018ab9e229d5ca9d47087c445dfa892fee017d04d9`  
		Last Modified: Wed, 30 Mar 2022 19:59:54 GMT  
		Size: 575.7 KB (575720 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cfd12399896cead2ef3667e9914952d77e3a382f7dcd8ea6adb5f651b82b377`  
		Last Modified: Wed, 30 Mar 2022 19:59:54 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e221a54e4fa1b96ce5aee4b284b34b20bbe0f2ecaa86e03aa2b2ba8a4a89200e`  
		Last Modified: Wed, 30 Mar 2022 20:02:50 GMT  
		Size: 20.9 MB (20949008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:35fff181f69f56ae47059caef9afc11f29b1ff147e93343aba9517be32a7190f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.5 MB (149450423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:715b146121fd586b2c37526f7d930cb5e36fdc28fafcb58f58902b49d52ed9c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 21:21:30 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 21:21:30 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 21:21:30 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 21:21:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:85a9fe7ee1d86107fa3669be8bd94909884fa9b456def1007938ad996f57afd0`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c13c084a0c4c88b729f7311401f969af684a4acf23b111d5c781c8d2fb4c47e`  
		Last Modified: Wed, 30 Mar 2022 22:10:23 GMT  
		Size: 576.1 KB (576062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eafb7374b82543239d57fb7f59ee6c345c32f4814c0bd470654ce60a5dd6ebd`  
		Last Modified: Wed, 30 Mar 2022 22:10:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd092a9b7da883a87cdd3e6222b2206423308204ae95b20a59240872bf7c8e87`  
		Last Modified: Wed, 30 Mar 2022 22:10:27 GMT  
		Size: 20.9 MB (20949481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
