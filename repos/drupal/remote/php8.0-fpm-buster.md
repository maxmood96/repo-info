...
```console
$ docker pull drupal@sha256:5ed54305ca2e27c8b3633bfa13550f61d24cdb770617ce1bff24b4d55494dbca
```
...
```console
$ docker pull drupal@sha256:13ba1e83d331d3328aa6587ef44323c6e3e56ecf8e4fc6b7fee2ab3f96edda42
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165835817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae10dfaa56709871c8566b546e8d3d8b0c18f4287ebdec1f6b6b2764305ba155`
...
-	Layers:
	...
	-	`sha256:b2206c8c49e4511eb6623ffd6738c7fa3e9e64fa3bacf4390c0dc2052efa94bd`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e2c0c44f38929721bd190f8ef9ff44e5585ac539222d68a550435111894318d`  
		Last Modified: Tue, 02 Nov 2021 21:09:49 GMT  
		Size: 563.7 KB (563748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5158e2da5ac4c7fd31c96d907280ee2bb53ab3f75506b9c7bbc5c36300745b4a`  
		Last Modified: Tue, 02 Nov 2021 21:09:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcdbad28e0fb65caadc47faa9a4aeab8b3fe3aa7dd0f0e3497c2950150482391`  
		Last Modified: Tue, 02 Nov 2021 21:09:54 GMT  
		Size: 19.2 MB (19190105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:a87ecd7d7b8b09a841515f69ba994f389109c0335cbac41b550ff59bb7dcbaf8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140946340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:453338c159e3481bfc85cf9bcd45cc107d43ce7391b68d436ea1e5efcd92d51f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Nov 2021 22:08:34 GMT
ENV DRUPAL_VERSION=9.2.7
# Tue, 02 Nov 2021 22:08:35 GMT
WORKDIR /opt/drupal
# Tue, 02 Nov 2021 22:09:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Nov 2021 22:09:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00d22e5b0bcb9353b4051dbccd9e7374a065bac69310f5161657bd0ed3fc2f6b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4103a27c6f74f943cb1271aef1e859d7fa63193c8a1d69703394d0609d7330a5`  
		Last Modified: Tue, 02 Nov 2021 22:38:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45940bf2e0c9f5eeec49e27681f236c3cc3fb70ec4f721b4a004d29abfbe5650`  
		Last Modified: Tue, 02 Nov 2021 22:38:37 GMT  
		Size: 19.2 MB (19190192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:440cf514706cb7e760586815ebf4227a94f71288c1001d59b816618cad79c062
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.7 MB (156716411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88a2567048d33989126459804b3c0f41f349a10c811cb319f7df7230a6a09cd0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Nov 2021 21:34:46 GMT
ENV DRUPAL_VERSION=9.2.7
# Tue, 02 Nov 2021 21:34:47 GMT
WORKDIR /opt/drupal
# Tue, 02 Nov 2021 21:35:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Nov 2021 21:35:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f78cf74d75e2355150e08fee83415e32fa5d8a8bc7d06a8bf114ceb2ce51b75b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8baba5c864b583fbab2fb6902343cb106757f1d1d0af8a5b4a77b3a76c3838ba`  
		Last Modified: Tue, 02 Nov 2021 21:50:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed7399f92e17bbe347333a9672f2e68b2d8045638ad29b970002e93cda497b64`  
		Last Modified: Tue, 02 Nov 2021 21:50:46 GMT  
		Size: 19.2 MB (19191170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3ca67a6b40b1396cc9e25eab56700004a705aef8a58ec8a99735ae33e4879191
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176118284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb197d12e97c15aefcfc1d9605a15f380314a97580576648c7f48ba2ece80a35`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 02 Nov 2021 04:40:36 GMT
COPY file:d241cf3df430734966c74646c5ec20283e588ee8633f6b8731d10feef78acbf9 in /usr/local/bin/ 
# Tue, 02 Nov 2021 04:40:40 GMT
ENV DRUPAL_VERSION=9.2.7
# Tue, 02 Nov 2021 04:40:42 GMT
WORKDIR /opt/drupal
# Tue, 02 Nov 2021 04:41:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Nov 2021 04:41:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4421f46f362dc58ca4363a120cb09812e580666dfd46a86b300be6ce790b85a8`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c192bd3e1dd1168a0ba81e1f6806fc74c3b6b335640f5cff3f0234708b0cb6e2`  
		Last Modified: Tue, 02 Nov 2021 05:07:15 GMT  
		Size: 563.2 KB (563249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec159966ba55a0494005054a4fca5f10b5548367a9e7dee66cee4e37fcff8f49`  
		Last Modified: Tue, 02 Nov 2021 05:07:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75a3c2d85c08ab7de1611ad6ae4a19a9f5ecc4c37b3cab634d3a87cad8264f87`  
		Last Modified: Tue, 02 Nov 2021 05:08:56 GMT  
		Size: 19.2 MB (19189951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:6d5a471072e57b59370b8a22342682799ba5d2253d7ecee81880fc4d01c04fce
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150926828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15d93f277404feecd9d79e371b57d6c4d71111b56f4715be15169d28e58f660b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:80d4bf27c2e7b39ab20a213acb94fe5d80ca22e3a11094d46fda4ad832320763 in /usr/local/bin/ 
# Tue, 02 Nov 2021 22:11:27 GMT
ENV DRUPAL_VERSION=9.2.7
# Tue, 02 Nov 2021 22:11:27 GMT
WORKDIR /opt/drupal
# Tue, 02 Nov 2021 22:12:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Nov 2021 22:12:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:be3a6cdbf6a86ac460c0b86608de9cd2025bb36a5d4a797b57de1e3118ae8711`  
		...
		Size: 563.7 KB (563748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee5fb50b2267a228d47aea75af1c60f811a9eb83d09b64ac610dcad8ba87726f`  
		Last Modified: Tue, 02 Nov 2021 22:30:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:072be3ca4029e805fa8b617b994472d506f6a4d47c9c72a56e4f6ec92254c1d5`  
		Last Modified: Tue, 02 Nov 2021 22:31:02 GMT  
		Size: 19.2 MB (19190114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
