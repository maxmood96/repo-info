...
```console
$ docker pull drupal@sha256:f4a4cfa315d6d906fc3eb014323ea8296acadfa6694a7a38970a8c43ce704a11
```
...
```console
$ docker pull drupal@sha256:d60b6851a97c9c57bc894f2a7b9ea64634358efc88208190f8edd325ae7cdf80
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176110407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d551c71a4dc905a4d9ecef610637778312b2393134bccfb384acb9227052f829`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 09 Jul 2021 00:42:27 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 09 Jul 2021 00:42:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 09 Jul 2021 00:43:00 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 09 Jul 2021 00:43:10 GMT
ENV DRUPAL_VERSION=9.2.1
# Fri, 09 Jul 2021 00:43:15 GMT
WORKDIR /opt/drupal
# Fri, 09 Jul 2021 00:43:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 09 Jul 2021 00:43:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dedfd64b4be28e0a6c94508de3c468317f96236f540a339d392349c9c0e08393`  
		...
		Size: 8.6 KB (8576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5564ac5ff8a6dc7a35af67b18f1f35d14fb215cac018f804fd4f52f8283ef804`  
		Last Modified: Fri, 09 Jul 2021 01:30:22 GMT  
		Size: 1.9 MB (1936317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96fad4c9ad3739c8d6ceab4f5432c24b617aafab3c748d156f0252ff26b296e1`  
		Last Modified: Fri, 09 Jul 2021 01:30:20 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bfd9557a68030ecdffca0f43b43e2ba1595014034904f4e5ee2117988c80e32`  
		Last Modified: Fri, 09 Jul 2021 01:30:21 GMT  
		Size: 553.2 KB (553186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7aaeb7f7219c0c15079d864c70a0c3755249bd4672f5dbba4ab9bc32dda5a1b`  
		Last Modified: Fri, 09 Jul 2021 01:30:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4504b8da4072a576906836a1b2f43e7a92ab93bd1e43cf49b2b2343de926d9d`  
		Last Modified: Fri, 09 Jul 2021 01:33:15 GMT  
		Size: 19.2 MB (19180137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:0420435feb1b9b7947db914047951fff1720491d76162958bf9c4e8f52c1739e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150874818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3273ef37780de4671f826abf7c3380fe7b541fa33cff7675f3313a12da6708f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 08 Jul 2021 18:42:46 GMT
ENV DRUPAL_VERSION=9.2.1
# Thu, 08 Jul 2021 18:42:47 GMT
WORKDIR /opt/drupal
# Thu, 08 Jul 2021 18:43:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 08 Jul 2021 18:43:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0aa991d63f553dcda524d80dc3169c15a41dee41a87e8c7f4adac3fee0136f8e`  
		...
		Size: 553.2 KB (553186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bb0013d9d3b14faa383059530e0c0c22968e2e2ac642d159f2c58e7167050c1`  
		Last Modified: Thu, 08 Jul 2021 18:53:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98eab7c25a2285e26d310b561adcc91968f3a98621b71a356a99ff48bcc88256`  
		Last Modified: Thu, 08 Jul 2021 18:53:54 GMT  
		Size: 19.2 MB (19180116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
