...
```console
$ docker pull drupal@sha256:8f56404f8f6c891446e4c29e29194e68c35f75d9c995d8f7f4cbe418bde0155b
```
...
```console
$ docker pull drupal@sha256:78f4ee0af238bb8949aa79dad4a221ba7e2f7aab3c5f36060f81895581a43655
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.0 MB (166036290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb45e3e1390f899d323ffc4e4a5b61face8a7662ad71b5c202ce71425ce5a2e6`
...
-	Layers:
	...
	-	`sha256:e0363fd9a7504dca0deaa4e12299a14a501045881a360d8901c6eeb3735e392d`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f8f38c5fe98e9605a49bc69682ea40b5bc260216f88bb6a0890b98597742346`  
		Last Modified: Mon, 03 Jan 2022 19:52:03 GMT  
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7755dd816a319b4a82bfd14c8fc46e76d760855842b34fe74dd26379ae8b195c`  
		Last Modified: Mon, 03 Jan 2022 19:58:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b66eac6665d2797f98af4c37e8d5e1b34adc8c857d9aacc54f893f13c55680c`  
		Last Modified: Mon, 03 Jan 2022 19:58:34 GMT  
		Size: 19.2 MB (19203320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6f342d9d756dc85f8e837df361be83a96765c57d2f2b4ff63b1229456e59a511
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141138036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2e70b3b8428d6b53ae8cdb04fcc729d9eba79c04cff5de552732e9133c07c5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 20:54:04 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:05:04 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:05:05 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:05:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:05:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:162859812fd2587379fdd4bbc27c8456eb68836b9986e005d861f7eb549c4aaf`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec33b48b861b213ac59a5fa0491bb90613270a94eea0158724e3ebfb588ccdc1`  
		Last Modified: Mon, 03 Jan 2022 21:32:37 GMT  
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf3ca7b76145449b7ad01a2290117f9f5a80f67fd46debdf090ecef1cab387d2`  
		Last Modified: Mon, 03 Jan 2022 21:45:18 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec646173cbc617cd792267df025f9030ab6eb97e137a5f904d1332a12c6fb124`  
		Last Modified: Mon, 03 Jan 2022 21:45:45 GMT  
...
```console
$ docker pull drupal@sha256:5d6a4ee580e4cb71643309bb2354c9818dbcb51c97825425572f60565435d0d1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156906117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7cedf54d59a1bf98885e382e50a36d1b8d1f95971cb611b804f7c1446efaf59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:37:10 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:44:14 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:44:15 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:44:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:44:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fbcb3deb93ea1dfb64ab42450292c2d3705dc99bb5aefac553a148197d183e81`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f0acfe995a3d278ef16777ee380f3e52a5ad97e1ee6b054c248952b3afdcc2`  
		Last Modified: Mon, 03 Jan 2022 21:58:13 GMT  
		Size: 573.6 KB (573623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:918344432252cb7c6d6b422a8d9ef1a04c3d26a6f2c6d0fa32ce74ef5d78a34a`  
		Last Modified: Mon, 03 Jan 2022 22:05:19 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0272fcdea796d493f25faac66ce73c21fac9dd639ca925f806951d813b3a4b77`  
		Last Modified: Mon, 03 Jan 2022 22:05:24 GMT  
		Size: 19.2 MB (19202672 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:52cdef6148a8091f1ca19ffa561b1548c3de9830679c33ed6a87c726193c9b8d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171823691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:032e8af4d7c3aabb560bd6f8d053bfa5f8148b33651a7adaf329e633b30ae5bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:01:41 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 20:01:41 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:01:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:01:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ff581c2e6c2907649075b8f2ac58e0e0bdf636e790593b4e74553c01f4effbf2`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7f570342974ab6d00f191ebf38d7a4f099936ad1e3b349eb04c0da80e696f02`  
		Last Modified: Mon, 03 Jan 2022 20:16:05 GMT  
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62a37ec907c573b59b2e100bd673276757161ffd2de17152b387d775cb532cf0`  
		Last Modified: Mon, 03 Jan 2022 20:24:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:022b704f6b5c80608d61d66dffd809ca32191f5b96afe7d51a298eccf5b260cb`  
		Last Modified: Mon, 03 Jan 2022 20:24:49 GMT  
		Size: 19.2 MB (19203122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:4be3fd07a46ca37abde23a44ff84c90d9cf662d0c85583dd4fd952f3def529bc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176310346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:101aefb4e492a3c87b943f8931f9ba41c4bf047369a0b50e72535cd7ad89b768`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:23:20 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:33:32 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:33:35 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:34:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:34:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c90e001d46731e9c959dce0d6ce264f49b15d72b50337ea8e18a275b74c8593`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7d9e4f339ab61350642bca19defc1cbd0d5375149b8293c051ed92bd6c1e647`  
		Last Modified: Mon, 03 Jan 2022 21:53:17 GMT  
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d704edadb46370e5642a2f42ca9c1ff106fd33350e9511505ba1941127c6e963`  
		Last Modified: Mon, 03 Jan 2022 22:09:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c1ca3fee96a4a1724b435dbaec70be596dbf8f78533e85d2a2a21336f3c1208`  
		Last Modified: Mon, 03 Jan 2022 22:10:44 GMT  
		Size: 19.2 MB (19203204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:8f5aaaa73496adbcf9ea6f746eea397d56449a5ddd4d4961dc4e0f448875243e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.1 MB (151120118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:664c7ff6a2e3153a46e1115dda89925cd6a89e454ab68e5f4ff9508c32abb921`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 21 Dec 2021 16:52:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 03 Jan 2022 21:51:05 GMT
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:56:21 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:56:22 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:56:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:56:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3d4ee8c0dbfd6199233ed8f7ffe993cf1f3c524d63420f2a4b513c46f0ed72fc`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19670db2f1ae52d2ccc2d0724769b09ea79f5f876e35431ba05234df6c2ec797`  
		Last Modified: Mon, 03 Jan 2022 22:08:27 GMT  
		Size: 573.6 KB (573623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae04fd64d1b4fda36214f60bbd7f25acb78a532f50d893a178bdce2e9cf07234`  
		Last Modified: Mon, 03 Jan 2022 22:12:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa8bf5f62b6c6dcdee8cee57974098894e8ca6afa61655365bc0469b1ab3f1bd`  
		Last Modified: Mon, 03 Jan 2022 22:12:59 GMT  
		Size: 19.2 MB (19203194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
