...
```console
$ docker pull drupal@sha256:d2c5c814be653a65f77bec0b76816b56d972d7829ab2a01928afc7f0537a957a
```
...
```console
$ docker pull drupal@sha256:156e35bf71f035ad73988da5901b762da264b88d36f98bc1bf4d856905cbbf53
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141137941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:073a576e6739ed71c42886ab2f7f7b7d254fb39fee2e9322c85b12c88803b443`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:11:13 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 20:11:13 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:11:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:11:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:162859812fd2587379fdd4bbc27c8456eb68836b9986e005d861f7eb549c4aaf`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bde671893cefb0258fa765e7b05074ec818861228ba4beecd859d5c918b0bed`  
		Last Modified: Wed, 29 Dec 2021 20:38:20 GMT  
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a47871f22ee617ca1641b6f71fb6b395ecc97fd8ff038278f15b9b2f88cfcf18`  
		Last Modified: Wed, 29 Dec 2021 20:50:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63f4a81f1a3d890b1b1b79b116be63507bb84418d606b98acf7f441c6f304fee`  
		Last Modified: Wed, 29 Dec 2021 20:51:15 GMT  
		Size: 19.2 MB (19203215 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8fce2bea0a1321f41e1eaee2dcbb7470ae22780005e1838bbc1f5e2de86ac828
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176310329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8000249cafb4d025b1a6084c4fe7d2d762134fe12147c9f68fada16aa6e1d51f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:56:55 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:06:37 GMT
ENV DRUPAL_VERSION=9.2.10
# Wed, 29 Dec 2021 20:06:40 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:07:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:07:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c90e001d46731e9c959dce0d6ce264f49b15d72b50337ea8e18a275b74c8593`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e5d3aee3a1128b296dab80b0449b11d44434f1d49a33eed7606a5b87fcbb6cd`  
		Last Modified: Wed, 29 Dec 2021 20:23:46 GMT  
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c86906437f8b5653ce2227e3c71d94bb86223f56f6148323b1ee5c353d1c3565`  
		Last Modified: Wed, 29 Dec 2021 20:38:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b557db6f9dfb200c70e96045a9b30b49075349444d19ab6fd82aaac7418c3c49`  
		Last Modified: Wed, 29 Dec 2021 20:38:40 GMT  
		Size: 19.2 MB (19203339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
