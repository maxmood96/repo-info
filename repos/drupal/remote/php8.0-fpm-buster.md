...
```console
$ docker pull drupal@sha256:b3b359ed7973d86bc57a66b436d2ab5a6299094fcd51d43192940d3dc58d0cf3
```
...
```console
$ docker pull drupal@sha256:d6c2d32fa6c92b7057cf3a594cc72d4fa342601ee4ac2128b2a938f6c5051490
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165367257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f32be1ab3de6a75bb2ed4056aa0a0c0cb7632d361e0d9557fc24ef511a483fd9`
...
-	Layers:
	...
	-	`sha256:002ba35308099ff8d8684b45eec82c5b9e5e057a685f3a57800ee8fd55b255eb`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c536a9367e3a2f52eb0d8a49012e9481b0b370b1cac3747159ef173eb63905c2`  
		Last Modified: Wed, 24 Feb 2021 18:57:07 GMT  
		Size: 551.8 KB (551789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ef6a1e05ebe5ed2599be840292f566b6c717c1365f8d8498e12494928aadc50`  
		Last Modified: Wed, 24 Feb 2021 18:57:07 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02331b97ad3594506161fb3c0e6a0941e83b5ca3ce5470883f5ceb7afcda3d43`  
		Last Modified: Wed, 24 Feb 2021 18:57:21 GMT  
		Size: 18.8 MB (18830963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:ee4dea31f9b05eb94ad8dfaf8c1618ef917d9fa4aafc67d2d0c21eec6944c9bf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.5 MB (140504460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a2328b2ccde1170117f50dc5981715d2f0b8703c77bb77e11efb9ac3325c1ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 26 Feb 2021 03:24:35 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:24:36 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:25:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:25:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d2968c510e369d5535e896a085969f8fa12248b9f5720a5bb10c81dc7ebd8c2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30f9704d9f5cca9825fc64895ed2596518ed6ee774d845014def5f25b37a2276`  
		Last Modified: Fri, 26 Feb 2021 03:32:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82a7e2caa8c29a8e99f2209c889124ae36621dc79b491ecec5549d65f1377c14`  
		Last Modified: Fri, 26 Feb 2021 03:32:21 GMT  
		Size: 18.8 MB (18831511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5e276374f0929cda629c4e144243794d84e812ad738edf2874bc2ee4c3d07929
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156878655 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:955c029c198a132554dd894428b0560b83fd8538354f4fe3957c6bded56e5a2f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Fri, 26 Feb 2021 03:21:28 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:21:28 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:21:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:21:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a38d6268249fc663b530bbe617563393d63bfd419df86ebd4554f42990728e45`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01ffed4c7f4f885b0c7456b1a69ac6020a51143f87b427d3313473c31c38f535`  
		Last Modified: Fri, 26 Feb 2021 03:28:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3bc475daddfda7a819d5e0e80537d5f31b49a5cc5839a5b0588b2d17de7e602`  
		Last Modified: Fri, 26 Feb 2021 03:28:26 GMT  
		Size: 18.8 MB (18830290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:a22b4e53924edf8671b6c64b1be8d303bef5eabf018d7505da117cb16fd93b21
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170566963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:554d84a80757a7b6c3732799b57a25b062d9d1398c7577255079779172757246`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Feb 2021 18:55:05 GMT
COPY file:1b32c2cc2578adb470417567850eca1f7168281e86639ee273f7664dbafacc12 in /usr/local/bin/ 
# Wed, 24 Feb 2021 18:55:05 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 24 Feb 2021 18:55:05 GMT
WORKDIR /opt/drupal
# Wed, 24 Feb 2021 18:55:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Feb 2021 18:55:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3d0a853f7bb3eb8a6f1f5e4e8c4b91e123df9088a4295b6cc4b7e5887b5a589`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52ddcf09ebf0e4b5e45b15e7dbf46f13350cfbe480a3477c9a32e29ed8badb77`  
		Last Modified: Wed, 24 Feb 2021 19:00:10 GMT  
		Size: 551.8 KB (551793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec724185678618f7f3a45b52867bfdb45186b3c286aeb1724b37f5369f71b45f`  
		Last Modified: Wed, 24 Feb 2021 19:00:09 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b32ff366c40828738ce2a610658218a424de0a7ee06b87d6f0d53ab7e9ff687b`  
		Last Modified: Wed, 24 Feb 2021 19:00:25 GMT  
		Size: 18.8 MB (18831227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:54348d2642e47bab00135904f01ed8f37ea09fb8852ad9f4388ee8e5d8d5bb70
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175689415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a45f96b4664abe7f0d89d95fcaf465d9c858acf7f716cc35a62a7114cec0f913`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Feb 2021 19:22:20 GMT
COPY file:1b32c2cc2578adb470417567850eca1f7168281e86639ee273f7664dbafacc12 in /usr/local/bin/ 
# Wed, 24 Feb 2021 19:22:25 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 24 Feb 2021 19:22:29 GMT
WORKDIR /opt/drupal
# Wed, 24 Feb 2021 19:23:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Feb 2021 19:23:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72a86771dee948fcf5d384633e90dc4c769790cb4ba9b9a9aaa1dc9d5a8568ad`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f236ad6c255cbf722aa612e41d0bc403f6a8d2f561eed936f06784c602d028f`  
		Last Modified: Wed, 24 Feb 2021 19:38:27 GMT  
		Size: 551.8 KB (551793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68188326ce86c19ece08157a64449b0e9f200cf02436f0a8e4b0ab5fff80edc9`  
		Last Modified: Wed, 24 Feb 2021 19:38:25 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ddef12e424eb6d5f72fbfa2da335981ac14d8db0c252b8ab5117946ef94d473`  
		Last Modified: Wed, 24 Feb 2021 19:39:53 GMT  
		Size: 18.8 MB (18831439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:b416e9831b09ba053b8aaa3138acf977d54ed069c84823a896cdf0fc525a4aa7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.4 MB (150435083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b751a2099e1c618a207a8c488b7ecd6e130044be4c96d9f53fc73e5da1a4111`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 26 Feb 2021 03:28:27 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:28:28 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:29:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:29:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c715fb686c07a62b97d68e320ffc82b81cecdae10fca836e6a882b2dc3f9eff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:632de5ca552121026891127da63985569c72344859552c4e21a90b5b0a72b227`  
		Last Modified: Fri, 26 Feb 2021 03:36:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19c22fdae7821c91cdcccc957d42632635959f57627e7c5909c7a6742dbf9dac`  
		Last Modified: Fri, 26 Feb 2021 03:36:44 GMT  
		Size: 18.8 MB (18831219 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
