...
```console
$ docker pull drupal@sha256:85733152a08d30385a39a2a45dce480213fbd654913257855c3985256ed429c0
```
...
```console
$ docker pull drupal@sha256:6ab907c4f6aaf5601b5a620afb6d02fad5454680bea6a4cd747d8408762a8be9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.4 MB (174435439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c839e42552e6f2b8ee4d15cc29fcd979887ae4510254e8d28f416cf925eb354a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:55:28 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:55:34 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:56:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:56:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2d046c8ca28b4225a34461385ae4f5f0c9dec5420f9e3e0aa92a1a171a6f368d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d00740a385f61318e210a522352f22b8ec4410b9417b13275d109aa2be26df2e`  
		Last Modified: Mon, 06 Jun 2022 19:57:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6498d627a02c1d3dcd35ecce8341c564517cc940f9d33d6da11f96ee6d129af7`  
		Last Modified: Mon, 06 Jun 2022 19:59:12 GMT  
		Size: 21.2 MB (21206762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:4035fcc608f33ec7b23d7dbfb395128d1b8c912847f74ad4d4c4ada0b4b5b050
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.8 MB (149805335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ffa9823e923a9330d932281781b3640740cd0458a34c1290200c6f149d5479b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 07 Jun 2022 04:21:12 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:21:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:21:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3e1167318a635778bdb92237897c4acb0f3203c01cee7bd589c439c4d9299ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d70b47d39f094f2d82c611cca684cc7106c69062148eb9716fd5c29332c44c3`  
		Last Modified: Tue, 07 Jun 2022 04:50:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:043251cb193c1f786c871a8c4c4c55c99f549f22f6d314cedebb41957c192c97`  
		Last Modified: Tue, 07 Jun 2022 04:50:25 GMT  
		Size: 21.2 MB (21206048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
