...
```console
$ docker pull drupal@sha256:d3daad98df2021e45079422127b0360d486a9dde449d331643cebcb1fc76788a
```
...
```console
$ docker pull drupal@sha256:4c518cc3bf5f7cb26148fc6ddf93bf7966de9b50b58ec38d6ed3aab7db35ca0e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.3 MB (165321107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5884c3bbe61669d560a9d495362c8a52d3736f38ba8657371e137af55b7b86ee`
...
# Fri, 07 Oct 2022 06:56:07 GMT
WORKDIR /opt/drupal
# Fri, 07 Oct 2022 06:56:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 Oct 2022 06:56:19 GMT
...
-	Layers:
	...
	-	`sha256:56f952dedc422b648e5e4534fee0bc7cb755def7579f123e2e0ce40132ec12d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de157520f022caab8a225bd4551ca554205ae063c73a39a941df9f551f13b615`  
		Last Modified: Fri, 07 Oct 2022 07:22:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b0cf24fccbd81c331e9df001c2fdae48a520cb529acc95b10587ff9cc524028`  
		Last Modified: Fri, 07 Oct 2022 07:23:05 GMT  
		Size: 21.9 MB (21891789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:5574577acf0b84e27b365c3aa7617e5e56e8134015f9c49527f760c11a33088e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140930110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:970b33e54b306e58dc947193c2b88c67fa39c54c8855df24055ab6046801a9b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Oct 2022 18:26:32 GMT
WORKDIR /opt/drupal
# Thu, 06 Oct 2022 18:27:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Oct 2022 18:27:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c7fa019847fd67c3449eb64953add7c31fee8ff3e4eed15d3c89be3e484d0779`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edf233015597791ded0f2dff893e5ca1fd60578d4c3c4cd798d1f1ec881b4944`  
		Last Modified: Thu, 06 Oct 2022 19:05:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a40ecb3db83b9e7ecc56207be9857570f25151e05249ede989518698ef492619`  
		Last Modified: Thu, 06 Oct 2022 19:05:38 GMT  
		Size: 21.9 MB (21891701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:b576c7f10eef081ee5ca32db5a16b9336df96ffe2030849152db86ce6d30e822
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.2 MB (156239156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07e19169f3e1bd2b82c3ff504e4c927aa2647a410735bbc55b35618b593df9f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 05 Oct 2022 22:56:48 GMT
ENV DRUPAL_VERSION=9.4.7
# Wed, 05 Oct 2022 22:56:49 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 22:57:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 22:57:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:396f95af2da1ed42905cb284c70b4ea73b5e0b1daeed0a3b35b57a3cc3dba3bb`  
		...
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bf6eb36353e8a8cde16e97ee4e8eab58ce2f3a1757122ee4387b9481530ce20`  
		Last Modified: Wed, 05 Oct 2022 23:31:55 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43385b0c8bb69e875fa6a5a15e310823ebd7b068fe8a78213f2e7fdb0c5e2270`  
		Last Modified: Wed, 05 Oct 2022 23:32:01 GMT  
		Size: 21.9 MB (21892704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:2bb43465f440248e9722814ef5d35d10ac53b8b0eee133b599b72fe575c4967f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170415833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb68817b79cd5dc48c56adf6951b3f6a09ac4cb426cf142e76004f60e2d42b75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Oct 2022 02:58:37 GMT
ENV DRUPAL_VERSION=9.4.7
# Fri, 07 Oct 2022 02:58:38 GMT
WORKDIR /opt/drupal
# Fri, 07 Oct 2022 02:58:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 Oct 2022 02:58:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:073e146a58d90a400fd06c65a8c99e1e053cdffe093485ff25384172deb77a4d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e3fe0615b202c5045ee1de938989483f37dfbde4a6d0e7b1a2e94e633a2e501`  
		Last Modified: Fri, 07 Oct 2022 03:37:08 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5324a6033da90369bfe6e6bc167eb471a8a30110b435e719bc70bf33c90150e`  
		Last Modified: Fri, 07 Oct 2022 03:37:14 GMT  
		Size: 21.9 MB (21891583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
