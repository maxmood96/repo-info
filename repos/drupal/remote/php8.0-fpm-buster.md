...
```console
$ docker pull drupal@sha256:8745c9b902d8becc5191a17d7e74dc9653f47e54132166d0abc989d7343701ac
```
...
```console
$ docker pull drupal@sha256:7f2ee1d2128d728795973aa8d8975fda7ddf1a6b984deb9f2e0b99f9d99b501b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165365986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d44b42e81fb4e6955da5e9a37aaed1e851ffe0de1d219dce94caa3b42d8ff167`
...
-	Layers:
	...
	-	`sha256:002ba35308099ff8d8684b45eec82c5b9e5e057a685f3a57800ee8fd55b255eb`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5f1d3e2e0379bdfbaa0ffafc234987f387c5b6aba40758e93ce9528fa185ae9`  
		Last Modified: Wed, 10 Feb 2021 09:55:14 GMT  
		Size: 550.5 KB (550527 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee92e05ccc2f6df1be98c24cdc116b18936613b84fda826dfcf48b99acc358a9`  
		Last Modified: Wed, 10 Feb 2021 09:55:14 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f5711e9e591866a61543f22037e063819945e589ed2a6f39627f8e4c4867b8a`  
		Last Modified: Wed, 10 Feb 2021 09:55:20 GMT  
		Size: 18.8 MB (18830953 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6dd64138d38f4a566d1e80fa7ffe9a5f76a6a8a30ed119625dfd8332003a2b18
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.5 MB (140502923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a0d43fcfd2d6516b08f9e93dc2b8e245b4217174d6d0eaa892e644dcaa80798`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 02:11:54 GMT
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Wed, 10 Feb 2021 02:11:55 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 10 Feb 2021 02:11:55 GMT
WORKDIR /opt/drupal
# Wed, 10 Feb 2021 02:12:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Feb 2021 02:12:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e0f9681adff831d44186380f7636bd6bde3aa598c7d655700ac0f2adfe6546e`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fa1aeb4209d4595202065ab4c8c4fd218299117c066f2098d6e8747a3d3b0be`  
		Last Modified: Wed, 10 Feb 2021 02:24:43 GMT  
		Size: 550.5 KB (550529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c86861a3ec26ba0061d07514f39275d5087f7fdcc51d2c0a013cce35a9a35040`  
		Last Modified: Wed, 10 Feb 2021 02:24:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:150d7dd18bdbe0198ceccfd2ab2a42741edaf6667de2bc1d7bc11cd9229242d3`  
		Last Modified: Wed, 10 Feb 2021 02:24:53 GMT  
		Size: 18.8 MB (18831251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:cc66a46157f87cf19028e8f0ec75b28cf33f57707c5d044b65664e596c7a77c6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.9 MB (156878155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f62d725ec08f415383c968f63d65a1a6527a2456bd6c8651ad3254442a4a773`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 04:35:25 GMT
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Wed, 10 Feb 2021 04:35:26 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 10 Feb 2021 04:35:26 GMT
WORKDIR /opt/drupal
# Wed, 10 Feb 2021 04:35:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Feb 2021 04:35:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e3b76cde69ac8b928b6797dfe44c14cedfb1e15ae6696affbbac46d30631c2ca`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffd47c23d2c6c051c15e5cfaaaf6d8375aa95ff30ce80ec3ba5de76896393674`  
		Last Modified: Wed, 10 Feb 2021 04:47:02 GMT  
		Size: 550.5 KB (550536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5303e6a9ff7749bd8ce27a02f5b1762ca31497265327bdf6836227b2c7660df1`  
		Last Modified: Wed, 10 Feb 2021 04:47:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b52d41882ac092ab892023435fe5c0f874d3db8614241dfb723cdfc9ce6bd14`  
		Last Modified: Wed, 10 Feb 2021 04:47:10 GMT  
		Size: 18.8 MB (18831059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:136d6a1fc344a4ad1ac6de0093a4b39dc4d568f81242abfad7ab4697db726f76
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170565650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:708ce82fdce97b01e069405de6886461a2e1e1649e9196306fa6df2c15af3779`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Feb 2021 21:13:04 GMT
ENV DRUPAL_VERSION=9.1.4
# Tue, 09 Feb 2021 21:13:05 GMT
WORKDIR /opt/drupal
# Tue, 09 Feb 2021 21:13:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 09 Feb 2021 21:13:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b3d0a853f7bb3eb8a6f1f5e4e8c4b91e123df9088a4295b6cc4b7e5887b5a589`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f19f656e75448c62ae2dc13fc5d28b04e5996579b2c491ea4a30494a82826e8`  
		Last Modified: Tue, 09 Feb 2021 21:23:19 GMT  
		Size: 550.5 KB (550531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dd3b8bc019967eb921fcefa3b216ce51ce31d95fff6eb11c59279e5a4b1561c`  
		Last Modified: Tue, 09 Feb 2021 21:23:20 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc844dac6c5bf5e5791c9aa6a61c781e7620152a3f4b60b149448570fed7fc43`  
		Last Modified: Tue, 09 Feb 2021 21:23:40 GMT  
		Size: 18.8 MB (18831177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:aab0181b07d7570fa224df1455c758249586a2828cf56eb1455a3822a266ae7f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.7 MB (175687823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da43e3188e63c85b5d82b2ac4f64e356a6e346d76824176eacf762294e032e6a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Feb 2021 06:59:09 GMT
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Wed, 10 Feb 2021 06:59:19 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 10 Feb 2021 06:59:33 GMT
WORKDIR /opt/drupal
# Wed, 10 Feb 2021 07:00:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Feb 2021 07:00:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72a86771dee948fcf5d384633e90dc4c769790cb4ba9b9a9aaa1dc9d5a8568ad`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6502b22b2433df5ed5a5b044cad81d6d16513176c11ccd47cc940e8cd264e2e`  
		Last Modified: Wed, 10 Feb 2021 07:27:14 GMT  
		Size: 550.5 KB (550532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c33ce6e4b15a05f2758e1f98d895b0076d9d45230ebeff26af5d7c972d3ea25`  
		Last Modified: Wed, 10 Feb 2021 07:27:14 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:145934d0b8ca515a4503caa073fcfd18c2dc9461969e218aab430c88afff7def`  
		Last Modified: Wed, 10 Feb 2021 07:28:34 GMT  
		Size: 18.8 MB (18831108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:66b897dd322e256b140291b86d6e1d8d5c7d865acb260742c6de8ee9b7717d1d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.4 MB (150432251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d492524f5113fbfbb3efbfc1d6605cb27e558575b4611ef0644cf81c78339e3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 09 Feb 2021 11:59:33 GMT
COPY file:0826bb80f25640302569956f6f16f2d2cfc7e1120f911f85e5aa5ff80d542914 in /usr/local/bin/ 
# Tue, 09 Feb 2021 11:59:34 GMT
ENV DRUPAL_VERSION=9.1.4
# Tue, 09 Feb 2021 11:59:34 GMT
WORKDIR /opt/drupal
# Tue, 09 Feb 2021 11:59:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 09 Feb 2021 11:59:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1a2e03d87db452d1ed0f40c3b3d1f54b07a733e99c35ab910a9ca47b46f6e4d1`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:794646224320595f9bf1a5e47cdb35c73c14a8bfab7903c2ffd429a006506106`  
		Last Modified: Tue, 09 Feb 2021 12:08:06 GMT  
		Size: 550.5 KB (550529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e7692c3bfac7d3905648819f275c2be3a87a4303fd431998c5176f4b716d0b`  
		Last Modified: Tue, 09 Feb 2021 12:08:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d210684f34081f1b1d721e9bd51a0ce5160a80214924fd0ddc5a039b3b1221c0`  
		Last Modified: Tue, 09 Feb 2021 12:08:09 GMT  
		Size: 18.8 MB (18829660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
