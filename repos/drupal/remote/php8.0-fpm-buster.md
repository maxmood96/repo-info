...
```console
$ docker pull drupal@sha256:363049a71e0baa56ffebd32d76a49aa112289ccaf4545c2de161b8ae5cb281c1
```
...
```console
$ docker pull drupal@sha256:0ab83c3a80d4dce87a14566251f47c7ce7c66cc2d72d5e281ab5ff6d36bd883f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165817299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b46ab0933909677d36e93d495a97527158073b135d559e6ce0da23dabf15ecc7`
...
-	Layers:
	...
	-	`sha256:b06d43daa71a242c8265fa43acdcc9240661b21724bb9dbfbfa0ca2c32c8954b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30d6e98e7dde8070c3e40056c363f6919b6c6d0e249fe6107cb72bc0b4073b6b`  
		Last Modified: Thu, 22 Jul 2021 00:30:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16467d85c1e3cee7cb7c7c558818a28918068b0f77695f49290085ac42ae8cff`  
		Last Modified: Thu, 22 Jul 2021 00:30:52 GMT  
		Size: 19.2 MB (19179453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:eaf3e8b5697a682f91c61726dfee7f6a7b34ff11a9a7f2c5459e37ae6f3fd81c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140935522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:247aa3b9d8d69ecb0a1456b98bc30e2d4b92b3827440a49997fb5495a11b879f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 22 Jul 2021 01:05:17 GMT
ENV DRUPAL_VERSION=9.2.2
# Thu, 22 Jul 2021 01:05:18 GMT
WORKDIR /opt/drupal
# Thu, 22 Jul 2021 01:05:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jul 2021 01:05:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:46bf8d2b7554d243089fdf964fa4febfe250807b18aab5258e591d5414ee1f59`  
		...
		Size: 553.2 KB (553182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a62b8bd1698ece157780149c0f72e3fe4ab98b088ed5f45a8ea541314f418498`  
		Last Modified: Thu, 22 Jul 2021 01:39:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23c415cac736df97260a4eeab1bf21609d55e6a6b560916430fcf604b46a1c77`  
		Last Modified: Thu, 22 Jul 2021 01:39:35 GMT  
		Size: 19.2 MB (19179365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:09f180f61c1a67be74982ba0ae4645ca11414ba7eea699b2069e061adc67ab3a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157334007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80b94b696d2e03fbcb41b8de747143ca264672ec2ba28ce50141cecd7fbea9ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Wed, 21 Jul 2021 23:40:47 GMT
ENV DRUPAL_VERSION=9.2.2
# Wed, 21 Jul 2021 23:40:48 GMT
WORKDIR /opt/drupal
# Wed, 21 Jul 2021 23:41:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Jul 2021 23:41:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3468d302bd238ce8bc84d6f6ee4159c52653e615c06dc1345feacdd87a633989`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2fd6506586e713e978d07ac136dbd0a5b235c0d28da65f8fd0ca4962433894c`  
		Last Modified: Wed, 21 Jul 2021 23:58:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d861dcd6a1616affd3316be0285ef7842df4ebf8e015c2f9fc6c134f08c37e46`  
		Last Modified: Wed, 21 Jul 2021 23:58:26 GMT  
		Size: 19.2 MB (19179360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b9579a0bd30912f8cd3b965146018d7d69875f19d551488d102e2ac4947ddea1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176109060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2302152d6a3808e9583122376a3a2b196901b900ec327d2d74df203765aa93f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 22 Jul 2021 00:33:51 GMT
ENV DRUPAL_VERSION=9.2.2
# Thu, 22 Jul 2021 00:33:55 GMT
WORKDIR /opt/drupal
# Thu, 22 Jul 2021 00:34:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jul 2021 00:34:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:602220a778b5a7e77088a2cc7ac0ade9dbe3d54ab4cd072904988389e1935382`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddac763c20fe3e6f7c4826cc6eedafa2ecc5e9050a66f151df5530b42e8db982`  
		Last Modified: Thu, 22 Jul 2021 01:05:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2bef4fadf15aeb7479254c4b0ccf04812f202a71e88f8a2fc830f54a5084da7`  
		Last Modified: Thu, 22 Jul 2021 01:07:00 GMT  
		Size: 19.2 MB (19179571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:698155d7fe14b1ee50b6c65472e8135618f0117e58a8e48c5a998a1614bfc48e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150874934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e8b1392080e1a4e5ca6824839282282066a3f5ccd3a2c26243e9b16ad08365d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 10 Jul 2021 05:03:16 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Wed, 21 Jul 2021 23:43:27 GMT
ENV DRUPAL_VERSION=9.2.2
# Wed, 21 Jul 2021 23:43:28 GMT
WORKDIR /opt/drupal
# Wed, 21 Jul 2021 23:44:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Jul 2021 23:44:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:02fb7634dc903f7fa2165f535689fe81905e8ce578732a700c86437fb9c94471`  
		...
		Size: 553.2 KB (553185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10f46fbc1f2766362c7fab7471e22b35a2bf5d777102f6947c5a5ab8a703e5ea`  
		Last Modified: Thu, 22 Jul 2021 00:08:23 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46ef892d095e8c9bc9866f5324c76f3d9381b5b53076bc7999a7acd0a651a67e`  
		Last Modified: Thu, 22 Jul 2021 00:08:27 GMT  
