...
```console
$ docker pull drupal@sha256:d25cc8f15a209cd81f8cde9d8cfc5be9b0b691a486d5b9d1566d6678bc1bedc1
```
...
```console
$ docker pull drupal@sha256:ec06e8c8c141bd3815a7eda180fded957db8c2f66674e433468f97f2b21edb79
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.1 MB (165062345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fd9e888465d9b9fa2bcf1bb95a8dfa6ea51cc988f807030eb1a033a051af763`
...
# Mon, 25 Jul 2022 18:46:13 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 18:46:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 18:46:24 GMT
...
-	Layers:
	...
	-	`sha256:aa657bb3d55e4bfa9e89ba93f6952bd8a2d9e891fd6efe1ee5c317ee0ae70d4b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3219288a1983f3dc60b931763a3e259ab5acf0541aaa3a39e5c9b450279b10a8`  
		Last Modified: Mon, 25 Jul 2022 19:09:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba1ed2e51a5f9476a159573d753c6c2a1f0938db30bfd85dd6934d09549f5755`  
		Last Modified: Mon, 25 Jul 2022 19:09:31 GMT  
		Size: 21.8 MB (21765839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:303584bc1c20f97dd7dbdf3480ddd6e66d80c307b8ebb6c5efdcc704048cc794
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.7 MB (140673939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a1d3eb412be7104bc30dffcaafadaec858caa691dbee28b7608eca37a75ca9a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:40:08 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:40:08 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:40:09 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:40:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:40:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:74bd93e8fb30b9dc96ae3c319bd332fcd0976879e967d59d8e40e9e88cf37065`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96c5988973df3541814dcf5bfd99b2bf8e7bcc5d75e3c63806dc72f95d50541a`  
		Last Modified: Mon, 25 Jul 2022 20:53:17 GMT  
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05a43231a18ccd1a1affea91c88eecd129b9a4b5cb1b906cae33b8cd427ef597`  
		Last Modified: Mon, 25 Jul 2022 20:53:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:502a5f7b8df4048e393950379b5153777eeceb67ef90c0cc5f5650741abaa546`  
		Last Modified: Mon, 25 Jul 2022 20:53:46 GMT  
		Size: 21.8 MB (21767101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:92002764f6d5acceb548b15f6229315aff9e41071618d39c81fcee13bcaa812a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155981880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cb886052b7f1c52f03f638d38ff53b0ce259d2180f3512ea7756207781528b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 25 Jul 2022 19:09:26 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:09:27 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:09:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:09:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c721c7c292f9a7d2e1f394de8ff4cb6f3565710cc620cc4bbd559a4a7358164`  
		...
		Size: 670.4 KB (670417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8ef406db3515a94681189a252659cf25014d47861de16d5ec0d14d9fb9f893b`  
		Last Modified: Mon, 25 Jul 2022 19:44:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e42c74054c58c7d803469e8a12c7c59a90ddb68db89932db46a9a04b634ecd2`  
		Last Modified: Mon, 25 Jul 2022 19:44:47 GMT  
		Size: 21.8 MB (21768527 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:a4cd24fe078f77fd5800f4aa5499a7cca79a55924bc0aa62ae4a0f8b1ea568d8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.2 MB (170153892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d572bfa9df7e272f3cc0969e5371eba5a7341a1d72ba538f9799cd2cc58c11d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:03:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:03:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77744a7d0e130e643d863f90e42c9dd45f69aad323db9747b96e00b256a3a191`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:948ea5cbf71ce35502fd4b4d45a899488a2bb1cfa82057494ad514fc2d7302b4`  
		Last Modified: Mon, 25 Jul 2022 19:37:15 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cdda8a2b05ba61c1b0b8dd05ea0d28daec8615802bbbf656566208d21bf54b2`  
		Last Modified: Mon, 25 Jul 2022 19:37:21 GMT  
		Size: 21.8 MB (21767005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:b02f0ec448d93de283f4e6a0fbb3290f954b77bdc7c065e86b72f13341b29333
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.0 MB (175006401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:890b26b2672c1b7d31cbc962d12142cf99aa843eb2a3be528fcf697cc1b768cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:56:22 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:56:25 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:56:28 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:57:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:57:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95cd259ab0d41a35af16e881d74ecff7fc8e113572f315541f328ee122d3e663`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12b9af91608d29a0892e4d48e0ba91d715baae3ab985c75c1b214d95dd5ff9c9`  
		Last Modified: Mon, 25 Jul 2022 21:34:23 GMT  
		Size: 670.4 KB (670415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17c512a036e64a3afe80dbad7e7355bde0b13c045f5450b3d623b681ac15add3`  
		Last Modified: Mon, 25 Jul 2022 21:34:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88879c10b1e44487d6ce5e1390c08230268cc61778bd2cc9136773acad86479a`  
		Last Modified: Mon, 25 Jul 2022 21:35:32 GMT  
		Size: 21.8 MB (21767121 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:397f3ae6bb9d2cff0997253f6f62ff6e85105acca5082956e085591ce319f5b2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.4 MB (150375353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41911145c27e8fa0f99d923bd46aab93fe08ff64e7054ba7049cad5b9f023fb3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:11:59 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:11:59 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:12:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:12:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7af0243bb9b7683b5d8a7abb3d6afaad095ab06ebaec63dfe3595babb96f774b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4d15f1374bf00709eb559aee0fb987bb637786f07b4293c6d6dd79eb07c5571`  
		Last Modified: Mon, 25 Jul 2022 19:52:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:557cf74eacb861254369e3722addf0bff3c6ab6b75100e9272325e180c942218`  
		Last Modified: Mon, 25 Jul 2022 19:52:22 GMT  
		Size: 21.8 MB (21766575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
