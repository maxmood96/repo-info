...
```console
$ docker pull drupal@sha256:88b121e15760b51a14febde8501d8a36a7b440e8729120c2889a5f2eb7602978
```
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; amd64
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - unknown; unknown
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; 386
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:11.1.8-php8.3-fpm-alpine3.20` - linux; s390x
