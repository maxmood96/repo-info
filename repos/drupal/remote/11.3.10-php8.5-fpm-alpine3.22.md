...
```console
$ docker pull drupal@sha256:d15985924cc4cdcdcccec40e860a537244330589c11c0a9277826c06606cab10
```
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; riscv64

```console
$ docker pull drupal@sha256:ced5fad9b6c888fc10dcd877c471ecbd178dcd1feb2c01c88631e11770a0233a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.9 MB (60898829 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2d901c36e71b43701152064caf24f6bc1df39eaeceae6c0bbe1f0d4ee66ae24`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:16abb4e30606ad5642550b2e182f7c1c5099c9e9cb969279d54b42a0537a039f`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8230bcc94a00fc31bdf617df7bb74895112c8f3493a4262c22c61ba45f30fd4c`  
		Last Modified: Sat, 23 May 2026 07:10:13 GMT  
		Size: 21.4 MB (21361080 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.3.10-php8.5-fpm-alpine3.22` - unknown; unknown

```console
$ docker pull drupal@sha256:5eba76342051a5d491a160c7e1c2928432f01e1df169881cedd03f31dabd22dc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **401.5 KB (401541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df1306b9e511c6a13357dff944442a306b1d78903a6bff91a1aec06b36b65119`

```dockerfile
```

-	Layers:
	-	`sha256:d8603282347c06d8aae6544787b7a959fb2e5d0ade464ae669e844253f5dc837`  
		Last Modified: Sat, 23 May 2026 07:10:10 GMT  
		Size: 369.2 KB (369211 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:97e336fbf46397abf5a25679d6ac2e9ead3494f329551175e5d6b69395effc88`  
		Last Modified: Sat, 23 May 2026 07:10:10 GMT  
		Size: 32.3 KB (32330 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.3.10-php8.5-fpm-alpine3.22` - linux; s390x
