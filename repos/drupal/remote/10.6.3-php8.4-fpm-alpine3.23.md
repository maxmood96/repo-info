...
```console
$ docker pull drupal@sha256:821841746722a95bf84d2f4bfa531ddb0d34f1629c390193deb3b8132d5b7f58
```
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:10.6.3-php8.4-fpm-alpine3.23` - linux; s390x
