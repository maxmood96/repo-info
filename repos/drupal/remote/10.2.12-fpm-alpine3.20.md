## `drupal:10.2.12-fpm-alpine3.20`

```console
$ docker pull drupal@sha256:8f8d23c0f629fad2ae6a3006df784e3ce9099f060597abd27441e8936a480fe1
```
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; amd64
...
### `drupal:10.2.12-fpm-alpine3.20` - unknown; unknown
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; 386
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:10.2.12-fpm-alpine3.20` - linux; riscv64

```console
$ docker pull drupal@sha256:11f513e89c63723de33ca715c698a293a6f287ec6abac49ed665c3b34f138bed
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.2 MB (55198640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e394dea1ab5c4bbcc387f859ce035bafb390c886062613b84f34ab85f417cd44`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:8682496799fe60874d9663598fec28a832440dd6df8431678c9361894be75267`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:be6bcb5c2d427ee8f2a07b0d0a44a5fd04768d831a8cc177defc1a1d4bf29ec0`  
		Last Modified: Fri, 13 Dec 2024 19:58:38 GMT  
		Size: 19.3 MB (19308673 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2.12-fpm-alpine3.20` - unknown; unknown

```console
$ docker pull drupal@sha256:4f63847328171c6e82b009a53de31b0499fd15c9acc20d9d09b99fa8ce88f605
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **380.9 KB (380949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d21f43141901a577ea7d5c65b117dca17e37ab1979e9220d872546149b42f203`

```dockerfile
```

-	Layers:
	-	`sha256:0de78a0fcbcd088f5c821fe685ac06b84b416cfa3a78810923a48f254afbda08`  
		Last Modified: Fri, 13 Dec 2024 19:58:35 GMT  
		Size: 347.2 KB (347180 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e8fb24f32940fec86a1eb40096823ce9f44e9891927869779b3e46a7e21ec1ca`  
		Last Modified: Fri, 13 Dec 2024 19:58:35 GMT  
		Size: 33.8 KB (33769 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.2.12-fpm-alpine3.20` - linux; s390x
