## `drupal:9.4.12-php8.0-fpm`

```console
$ docker pull drupal@sha256:5a1bf1acb7afabb7e6b8d35ccf344c2cea5e103ff10f89c095cd0700a8d73b23
```
...
### `drupal:9.4.12-php8.0-fpm` - linux; amd64
...
### `drupal:9.4.12-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.4.12-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.12-php8.0-fpm` - linux; 386

```console
$ docker pull drupal@sha256:1675cbc6b589a6435f446a3e27856589ace84731dab3e627ade0d7301d353533
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187613616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e549188eb9c5756ec001c71582dc8d5daa5651a455b9ad7bd10d3bac684d1dd9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:23:38 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:28:11 GMT
ENV DRUPAL_VERSION=9.4.12
# Fri, 24 Mar 2023 00:28:11 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:28:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:28:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:71a95ba68eae76ad8c22e5de71249e67b689a87c3be5a65d169272470afa0042`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ce1aaa1f2bb4851731d1120d2ae9e509522bc3adf5fcd888be86aafa065fd66`  
		Last Modified: Fri, 24 Mar 2023 00:42:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8685827d80122b4aa48ea956c0b265f61577315e3688725c8c33461f531f53cb`  
		Last Modified: Fri, 24 Mar 2023 00:42:13 GMT  
		Size: 21.9 MB (21912111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.12-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.4.12-php8.0-fpm` - linux; s390x
