...
```console
$ docker pull drupal@sha256:552507f967939c9f0ef8cc79dc6f39032644f7eb5856d623550aa46af751f6fa
```
...
```console
$ docker pull drupal@sha256:3d2a24a34c3cda019634f6b80b86ea6776bf9481ed210a7ce031bfc5e637f07d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.3 MB (140343636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:140160d0a73ec428b78759e6316530214b2bb32772cf300b7bc2fa277510430d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 14:25:41 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 14:30:08 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 14:30:08 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 14:30:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 14:30:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e8eada066e8b00c46036d3ef99c96a0358be3ec844be37b66074b44e5c865590`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02ec396d0866144b0ac2f4485d0f7df7fb86b61e9f794266b36f9b3ff1d197bd`  
		Last Modified: Tue, 06 Dec 2022 14:56:11 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cd867fac66d69313ba2124ca5845b49656e7f6a01ec1ec23ca18e04dcbe6500`  
		Last Modified: Tue, 06 Dec 2022 14:56:19 GMT  
...
```console
$ docker pull drupal@sha256:79ff38ea9dac4e5ee8affd28da58a5af8e61271d3f98b06f5f5a7dd44f9a2a64
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156282050 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f816f0db7b597562c91bd29f64a930f7fd306cc8d7edc84a1f4a135d349f0743`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 18:16:06 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 18:19:16 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 18:19:16 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 18:19:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 18:19:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fa33c4fb13f7e109a602a876a9ae365609763bf10a71a6b01227e9b713e0bc9b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90d9a9e82c052030a92d567f3e2f36ab35aa4301f329711ac80b3eac41141073`  
		Last Modified: Tue, 06 Dec 2022 18:34:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15a6d921a7fd27f1f03f260cc2199fa02451c41919d9c7e8822d99322689b4bc`  
		Last Modified: Tue, 06 Dec 2022 18:34:12 GMT  
		Size: 21.3 MB (21324642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:95f9bcddcff00173b147af4d7ce23a1c0f15dd42071f389cf5e0192bf08df14c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.8 MB (169822712 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b7c54ea638a78cbbd5d9f67291d57020007e55a9c7357472755d72c5c3e5bbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 17:22:44 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 17:22:44 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 17:22:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 17:22:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3047e5dba88be1e2920d15e5f8e4cf76f0371009760b0e4b345b350915a48d6d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a522866aaf0bd4c223b2b7127c88ec68608c5c86e5090581f87c36f4836eab5`  
		Last Modified: Tue, 06 Dec 2022 17:44:06 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cdc3c2d58680c53c0a907e34d29b697eea321283e809d1edba1486784a7b365`  
		Last Modified: Tue, 06 Dec 2022 17:44:11 GMT  
		Size: 21.3 MB (21323864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
