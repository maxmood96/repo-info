...
```console
$ docker pull drupal@sha256:99666df2879f1357235fed1a56040d66aef0836175897cc5cd2bd9448e001c28
```
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; amd64
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - unknown; unknown
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; 386
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; ppc64le
...
### `drupal:11.3.0-rc1-php8.4-apache-bookworm` - linux; s390x
