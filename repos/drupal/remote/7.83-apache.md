...
```console
$ docker pull drupal@sha256:9bcdaa52becf2c740ccf029cba45bedcc0fa3f8739a3f7bdcd06a087d9ae9ec2
```
...
### `drupal:7.83-apache` - linux; amd64
...
### `drupal:7.83-apache` - linux; arm variant v5
...
### `drupal:7.83-apache` - linux; arm64 variant v8
...
### `drupal:7.83-apache` - linux; mips64le
...
### `drupal:7.83-apache` - linux; ppc64le
...
### `drupal:7.83-apache` - linux; s390x
