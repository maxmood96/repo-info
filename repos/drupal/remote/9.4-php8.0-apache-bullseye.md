...
```console
$ docker pull drupal@sha256:4fa60ff4b7c54bf7d25dc4fd0fe8271ff8e6cb0eda249c43cd4cac5337f05b43
```
...
```console
$ docker pull drupal@sha256:5307b734bdca21019ec28c52f1cb6eb758f8f5d23446736d82fefe1385c7d66d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182084742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c1887600eb512a0d384c952ca2c0f98cc23deaa13c4fbd6618b69de2f38dc9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 14 Feb 2023 23:48:37 GMT
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Tue, 14 Feb 2023 23:54:25 GMT
ENV DRUPAL_VERSION=9.4.11
# Tue, 14 Feb 2023 23:54:25 GMT
WORKDIR /opt/drupal
# Tue, 14 Feb 2023 23:54:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 14 Feb 2023 23:54:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e13b737c2ee7de8f9404ceee4ec593c1d87ebecd633b10aaf71b295238922911`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3386ba30495123ee30f4f811fedd0bd3f81899afbf50aa09172febde0882f059`  
		Last Modified: Wed, 15 Feb 2023 00:10:52 GMT  
		Size: 697.1 KB (697135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a155551253997dd60fd9bbe74bce57001dc23d5e303363dc555c1a2b14ad05c2`  
		Last Modified: Wed, 15 Feb 2023 00:15:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e15ceca48213d10453aa82e532a718f087bb56f96ce06c61d5d7b83610ca361`  
		Last Modified: Wed, 15 Feb 2023 00:15:31 GMT  
		Size: 21.9 MB (21911808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
