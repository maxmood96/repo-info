...
```console
$ docker pull drupal@sha256:1e8f1249127a0e5b0f0d6f2132e2ae329aab1179458347ba8202a1876debaf2b
```
...
```console
$ docker pull drupal@sha256:04243acc9ee78ded22f64338284403866a65b34c3c10b0c56ef6eff230a431f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158640209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47bb059cc6f084ddc030ae1465d19cc1f9fe76156610e214857dcb0a95537e51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 28 Mar 2023 07:39:50 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 07:46:24 GMT
ENV DRUPAL_VERSION=9.4.13
# Tue, 28 Mar 2023 07:46:24 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:46:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:46:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ee5c2f5e8fa83e4de53344454bb9496327dbef6e779cee2872b39507a9e5a3b6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b6d32e71a1a4a3b90a3d4cff7a27ebd07ea46fc264f9f2a2682dbbb19fa03cf`  
		Last Modified: Tue, 28 Mar 2023 08:04:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19429d37095358221741fc3c6692b4bcf5e87e7996418a44c902d30349a48d4c`  
		Last Modified: Tue, 28 Mar 2023 08:04:56 GMT  
		Size: 21.9 MB (21916891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
