...
```console
$ docker pull drupal@sha256:02828793a991451d75921392915c6833ada6adb963d6934ee1abd476c262b553
```
...
```console
$ docker pull drupal@sha256:8fe8416bf13f132ccf76df4900b0e82dc5b3fe657029d3cd214f1b44724d7fb5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158627141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df2925a4d429809ab633c29523d6cd5ae3d2f88b793f61a8bd2dab319f7965c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 21 Mar 2023 20:44:49 GMT
ENV DRUPAL_VERSION=9.4.12
# Tue, 21 Mar 2023 20:44:49 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 20:45:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 20:45:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c72cedf215ae200293e159736566b6a824437914dbcaad758819ae82392c4959`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:434004a94b3aaacb2dac446ce5d0310ea876d99aa5bfbde2d13b3b8bfdf476f5`  
		Last Modified: Tue, 21 Mar 2023 21:03:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c81f408090f52f65316fb7929e5e25ca074b69482f9db1ffb74563a54b795260`  
		Last Modified: Tue, 21 Mar 2023 21:03:18 GMT  
		Size: 21.9 MB (21912024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f90f8bf8ad7186175cbdf4a97e9bcb82bfec7e038fab024b8e03d5dab6f906e6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.9 MB (191948686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d6b37c42244fad50748454fbe959ec83162ec7ad266a58b9d749ef5602b836e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Mar 2023 01:05:32 GMT
ENV DRUPAL_VERSION=9.4.12
# Tue, 21 Mar 2023 01:05:32 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 01:05:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 01:05:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8672026c3a4c9bc2ab9bda200cf6c7a065f40fe4c3bc3cbdeffec4c63227fdbe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c228a730ac7c27c1da421292fc96f6d11f1d77fc659f88ea276f30e8a91b45a5`  
		Last Modified: Tue, 21 Mar 2023 01:24:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa7c84595a692eabb133ef3b8ed6521860de9ee216d4bbbab44d4caf652ecafe`  
		Last Modified: Tue, 21 Mar 2023 01:24:34 GMT  
...
```console
$ docker pull drupal@sha256:0656ec1db97c2f9c8811aefaf810f6c31b02be0a9443d0ae5237cb2972f25aad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165937009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:490ba4f2970acc68cef7e5413dbb023406e4cba47e63bd1f0b6df99fdb35b185`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 21 Mar 2023 20:23:23 GMT
ENV DRUPAL_VERSION=9.4.12
# Tue, 21 Mar 2023 20:23:23 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 20:23:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 20:23:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5c41e70211d13e6ac39dc2585d2178f56eac53611afeb02535110e957856c2ec`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6d7821005b6562cb80067d1f618c48060c98bfd6564a0fc854368f9373d5bdd`  
		Last Modified: Tue, 21 Mar 2023 20:32:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1244f88453b0c4fb20f7eea1b35ec50ab3e98161fdf9e75424f6247008ca358`  
		Last Modified: Tue, 21 Mar 2023 20:32:09 GMT  
		Size: 21.9 MB (21912085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
