...
```console
$ docker pull drupal@sha256:8d3ea8a95d83464dabe49f64f527290918188c488ffcf0fa491ef6d8b72f6642
```
...
```console
$ docker pull drupal@sha256:011b2fc59ef6d5ce8197e9111631f9ea84f8d8a236123e193650c0b37df9358a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189484101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c19b6eec2205f922f96b9a2b0b258bd10592292b27e06a4ffa3d97068f70c010`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 09 Feb 2023 16:41:12 GMT
COPY file:2c6e86189bae3d0f441696ba145d29f22860cb3f94dece0c5761829ffdb8cb91 in /usr/local/bin/ 
# Thu, 09 Feb 2023 16:45:24 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 09 Feb 2023 16:45:25 GMT
WORKDIR /opt/drupal
# Thu, 09 Feb 2023 16:45:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 09 Feb 2023 16:45:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c86b15dbc7a00907d11c09c69b6734ce35965b117a81abb7c620fb0e0f40887`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acf787703f600379aedba2709d2695f7cba81b690d0ad85c2fd4c195d1812ebf`  
		Last Modified: Thu, 09 Feb 2023 17:05:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6737993030cbd4859e60bbec5bf2a419595429ef38c57749b4a96b9c1d9d85b`  
		Last Modified: Thu, 09 Feb 2023 17:06:01 GMT  
		Size: 21.9 MB (21911430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
