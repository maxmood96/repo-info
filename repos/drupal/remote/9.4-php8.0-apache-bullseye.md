...
```console
$ docker pull drupal@sha256:e83d06ca06517ab1c79460135559e1cb698aa9f3be94a30a2195f0c683e92e6b
```
...
```console
$ docker pull drupal@sha256:af773c9edafa0a8ab8331fe984c7d97f15c937c926eaace58d563ee15dc85614
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.0 MB (191959626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce0a353214480841d9755e8560c648e26c537a47b3e636b28b6b285569abdd4d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Jun 2023 22:39:12 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 13 Jun 2023 22:44:53 GMT
ENV DRUPAL_VERSION=9.4.15
# Tue, 13 Jun 2023 22:44:53 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 22:45:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 22:45:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe3195aa9bb3b2e25438d7ff6e1474aa2fdad17fcbcaee56201f869577efcca8`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:944a5a29f7ef02da62bd3b0bb99bc66e76af7f93ccc32fd03e3ed7a4c0df0e30`  
		Last Modified: Tue, 13 Jun 2023 22:56:34 GMT  
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a9d0c700fae0d998d648da224138d13381c393ef10d8c35e23abed4271d353c`  
		Last Modified: Tue, 13 Jun 2023 23:00:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90940928541a9eb28def6e9d728fb9b8d9d1835a11d1eafcdf407187d8eabd5e`  
		Last Modified: Tue, 13 Jun 2023 23:00:29 GMT  
