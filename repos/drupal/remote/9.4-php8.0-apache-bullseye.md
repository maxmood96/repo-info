...
```console
$ docker pull drupal@sha256:ceebe63351ed37b8b0f357e300d13e8ad32e6b120859cd6d0e4db774324aeb81
```
...
```console
$ docker pull drupal@sha256:462a0ae2598085817ba4bd9b176179b95c4d6bca8732f1ca8dc59031381499ea
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158608910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9acabc4f443ef62ee63be221a41d20c4733f84d96b801202411875317b94aaea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 05 Feb 2023 08:59:18 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:05:31 GMT
ENV DRUPAL_VERSION=9.4.11
# Sun, 05 Feb 2023 09:05:31 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:05:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:05:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b02b5d7e658a85f6294429914d68320555a49eea20b4baf7f7e49753183d0742`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23a086b4518d63ae20f1e0ffe403d790916126bf837132632a05cb9d76c7b17b`  
		Last Modified: Sun, 05 Feb 2023 09:30:48 GMT  
		Size: 700.1 KB (700096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec9e7757d239489bd920202b2de4fae3f40be9b649a889e065353f2d78de2390`  
		Last Modified: Sun, 05 Feb 2023 09:35:38 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee040f509e91100680f2c99ab59bc4d1cef86ee513f9101c39358fb9794bf7d9`  
		Last Modified: Sun, 05 Feb 2023 09:35:46 GMT  
		Size: 21.9 MB (21910395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
