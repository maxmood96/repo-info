...
```console
$ docker pull drupal@sha256:ae787229fe28420cb1590b0c822a931e4ed29878e1f45c2d0bbef88f08cafd01
```
...
```console
$ docker pull drupal@sha256:828bf532fff5857ee2d79672ac87b6394fb1f7d510f5e4d5726ebc2fd8a8b087
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.7 MB (158651538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9ac7614e357ecfdfca0c463252c2447f48d82735792e9c9dcdbdd0f34bac06f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 21:51:40 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 29 Sep 2022 21:51:40 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 21:52:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 21:52:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:04a80bf777c21d78a250b75b8259152486f57fa18e9b772867fdb63faeb26a8e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f2eebe774be2fead1d4a9afc4a90f74c46948f7ad2285af1b7365d4ee722886`  
		Last Modified: Thu, 29 Sep 2022 22:40:37 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f22d00f46f70835924838357dfa1f7ca9d26cf5569ee909be4f2a0973cd37b63`  
		Last Modified: Thu, 29 Sep 2022 22:40:51 GMT  
		Size: 21.9 MB (21893911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ce5cd9a2ec1861a25bea89bba50c10c50c89502419e46f943d4411cca18b1cc5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.1 MB (166132803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fe6d3bd7e7eba3947cae09384f980e6b301c5b0a63130d7762a4b86a1a70787`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Sep 2022 23:57:21 GMT
ENV DRUPAL_VERSION=9.4.7
# Fri, 30 Sep 2022 23:57:22 GMT
WORKDIR /opt/drupal
# Fri, 30 Sep 2022 23:57:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Sep 2022 23:57:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6feb6727d31046e5ab0f705aae2514aa1beec35f1d39bbcaca5485476c7ddadd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e9a7e5c9163a44d1a893f932216d841bbf675d2e84db790d72f9efcda2ae34e`  
		Last Modified: Sat, 01 Oct 2022 00:14:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9de67ed6c388058c1947bace6decba91b3a0cb5e5b658359b2d399f1f9ec46d1`  
		Last Modified: Sat, 01 Oct 2022 00:14:43 GMT  
		Size: 21.9 MB (21893977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
