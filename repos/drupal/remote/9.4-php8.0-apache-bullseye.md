...
```console
$ docker pull drupal@sha256:1f9ababcad106b35f161573d59d94b3a71cf5b093b3c460af1a8fca19ea90c86
```
...
```console
$ docker pull drupal@sha256:9f4e004ac21e063e4bbca0c051e294d7fc085ddf8afbbe92f2f66cb98b6a0dd6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189135762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ebfb09abca899c19685d64767d92c290c906955df3bbe51336a737ee266062cc`
...
# Wed, 12 Apr 2023 11:42:22 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 11:42:22 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 11:42:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 11:42:33 GMT
...
-	Layers:
	...
	-	`sha256:3afa9fddc75f9aac38b957a73dd781f1035fea2b5825b1fd6926d42646e2f85f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b8c09b49ab23ffe51b4dd9911510779c801c058166af9d73b85494e027dd31b`  
		Last Modified: Wed, 12 Apr 2023 11:55:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e46836fc1ae29d27f9f6605bd6da1809608a8cc7d9fe073ac18720fdbb86b385`  
...
```console
$ docker pull drupal@sha256:e8e9cc78bdccd0e170eac9eb559f4b6a3fcd40c664f0031b7316c0886673374d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182095589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2e617abcbf04cb1c76dc329a190e864c9af83ab94be07e5799ef873e7ab2d77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 17:43:06 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:43:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:43:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:43eaac9a241033fcba9f1b2ed57638bf0cbb2140798377429742a9f185b9c912`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:031e6c4c298090f06a96b5db2d272d20b9b17aaa3a96ecd8cb3d2c0c7889470d`  
		Last Modified: Wed, 12 Apr 2023 17:55:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1348b50050e9d3a34712a24d6b3276d4a8913f021eb1c8c74b8f69e5b4be0e66`  
		Last Modified: Wed, 12 Apr 2023 17:55:55 GMT  
		Size: 21.9 MB (21916218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.0-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:d18676d2093bfcbafb49d3a83ec83b8e1365af96eb66a1270777f2a8c7a2edfc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.0 MB (191960013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:481aa3b491f905a9c78b14a046e7d0c08994e70beb4982fb857954caf895a0ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:29:05 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 23:29:06 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:29:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:29:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:06172a7c0734ff5cccf43dbad7a7c672d0bcee9097d198762ceecb6d66fe172e`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:520f819f0472ef5f79077570c2bd5166bb1d273e04d944ffc8a8eeb1336a9a17`  
		Last Modified: Wed, 12 Apr 2023 23:43:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42111077968937a9fa3b01742cf348ab908176c9e11aabad4a52cf55eb58a715`  
		Last Modified: Wed, 12 Apr 2023 23:43:16 GMT  
		Size: 21.9 MB (21916985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.0-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:6e875f0061392a0d654823061f9e65597356fdb82c62820cbd5917c393a51193
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189493601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8c4baecbb56c76722698cbb2ba9c7097a6c8434058a27e74dc6774059419c95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 12:07:41 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 12:11:44 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 12:11:44 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:12:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 12:12:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8200177119adffc1faa2105aa9c2275b75d6a94b7532f96c0f62d3e45b3f8936`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46bddde4a8e55a95ec39c8df2b5d3ffca8ace14bdd488e878cf3608e6df645b1`  
		Last Modified: Wed, 12 Apr 2023 12:24:20 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6e2a155890f3d6ee20da849249ae45300522f771c9b271c01a437eb28d785fa`  
		Last Modified: Wed, 12 Apr 2023 12:24:30 GMT  
...
```console
$ docker pull drupal@sha256:fa6d6c3896dd2b30d89cc3a07baed73e58ecc79aa05ceeefb8269ea6208e0115
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.0 MB (165953729 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcd7e47bfee72fffe6bf75924ee055e9b0a4004b2168e79af49bfcf73f45095c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 11:58:45 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 12:01:39 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 12:01:39 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:01:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 12:01:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e7588d68cbd54f08a8377883026521aa252e303dc1033e2eb3f6e2394151565c`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8c7beedc9ee2b89e1c1104fc23bdce806e0f0c110dea37dea00353adb93eed9`  
		Last Modified: Wed, 12 Apr 2023 12:08:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97ff6b1ba48fd2d0535a9aff4193e9a4431837da4b8d8583e898d5829524a715`  
		Last Modified: Wed, 12 Apr 2023 12:08:36 GMT  
		Size: 21.9 MB (21916967 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
