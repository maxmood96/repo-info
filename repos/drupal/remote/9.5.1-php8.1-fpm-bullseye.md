...
```console
$ docker pull drupal@sha256:8f1320ac27391d5f019ba2b57ba7e21de34038958ec4ab371f93aa3d8ea51c8f
```
...
```console
$ docker pull drupal@sha256:b4e7745cc17f1546f4f51a46f4fcdd43283934760dfb74d360b4be9b82b7651e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.2 MB (181235181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0761992584e232dec916a4ad6c0bef3795b06a5931afdf31300931494b01346b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Jan 2023 02:41:30 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Fri, 06 Jan 2023 02:48:49 GMT
ENV DRUPAL_VERSION=9.5.1
# Fri, 06 Jan 2023 02:48:49 GMT
WORKDIR /opt/drupal
# Fri, 06 Jan 2023 02:48:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Jan 2023 02:49:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ce2cbaa1230dcd1a6f244b9a3b8bba3b7365a32df8f29edb0d4a6b173c33791a`  
		...
		Size: 700.1 KB (700099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cd4b8e2c01d9f19a664ccbf4728f452cb3291cc817017d4c8934e39ce67bddd`  
		Last Modified: Fri, 06 Jan 2023 03:10:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91362ae99dabfd69db11d8bb2cca762aedd2caba42f08ed3b3c0422ca94fa760`  
		Last Modified: Fri, 06 Jan 2023 03:10:23 GMT  
		Size: 22.8 MB (22834892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
