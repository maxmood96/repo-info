...
```console
$ docker pull drupal@sha256:760e1ac5ffea5a814da3126a1a29fb2efe6c2ded84a51c1ec4c709b85657a52b
```
...
```console
$ docker pull drupal@sha256:c5907917d4e918a1c2378c88f6a102461ff2b82f37a08bd74b632f60a041187e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **205.7 MB (205674707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd97a57a3532a3ebfbd21eb87c5bdd6de42f4c0c982e2ba964db565065aba68c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 09 May 2026 03:32:13 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Sat, 09 May 2026 03:32:14 GMT
ENV DRUPAL_VERSION=11.3.9
# Sat, 09 May 2026 03:32:14 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Sat, 09 May 2026 03:32:14 GMT
WORKDIR /opt/drupal
# Sat, 09 May 2026 03:32:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Sat, 09 May 2026 03:32:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d52bce91a54a28a4d42a3d55bd9ba7d69bb79e2cc10a832384074da4539daa26`  
		...
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e76b5c467ac0f03ee955565eefbebd9b38a1399b1f9fb1e43a2bf74cecd287e7`  
		Last Modified: Sat, 09 May 2026 03:33:06 GMT  
		Size: 790.8 KB (790769 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2840ff63034798f204c5ca7b8dd46cb0e6f83332ece5a781fe7785721d664766`  
		Last Modified: Sat, 09 May 2026 03:33:06 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b32935a76638459f755a69f493cc6d0ead8f0c77a18b27a03e6cb970079f4fe5`  
		Last Modified: Sat, 09 May 2026 03:33:08 GMT  
		Size: 21.4 MB (21351764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.3.9-php8.5-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:723373daed5b346dc7c662dcc44600f3e49b064b73a639d2f17007a7fc5fcf57
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.5 MB (6532114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22e20e873d514ab9e75547498ad27f2c3c06558305413366656b2e639947105b`

```dockerfile
```

-	Layers:
	-	`sha256:ce10aa52c4a212e6f8ffab0785aaa2f57b490a2b839420be6d5c4fa38d306461`  
		Last Modified: Sat, 09 May 2026 03:33:07 GMT  
		Size: 6.5 MB (6498514 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2a175bd07b4def20d896fb4cf1d1f642e7f373e05dc3127b9693ea5ac3779ef0`  
		Last Modified: Sat, 09 May 2026 03:33:06 GMT  
