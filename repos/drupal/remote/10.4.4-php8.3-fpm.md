...
```console
$ docker pull drupal@sha256:99c40a339246a72239f95b034862276d342d7e4218e53b8d697399a9a157af03
```
...
### `drupal:10.4.4-php8.3-fpm` - linux; amd64
...
### `drupal:10.4.4-php8.3-fpm` - unknown; unknown
...
### `drupal:10.4.4-php8.3-fpm` - linux; arm variant v7
...
### `drupal:10.4.4-php8.3-fpm` - linux; arm64 variant v8
...
### `drupal:10.4.4-php8.3-fpm` - linux; 386
...
### `drupal:10.4.4-php8.3-fpm` - linux; ppc64le
...
### `drupal:10.4.4-php8.3-fpm` - linux; s390x
