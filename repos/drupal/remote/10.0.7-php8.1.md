...
```console
$ docker pull drupal@sha256:099d0ac3f2038d5717ba8723ecd1424a60128afa878e56baab0cdb08d25ec6ff
```
...
### `drupal:10.0.7-php8.1` - linux; amd64
...
### `drupal:10.0.7-php8.1` - linux; arm64 variant v8
...
### `drupal:10.0.7-php8.1` - linux; 386
...
### `drupal:10.0.7-php8.1` - linux; ppc64le
