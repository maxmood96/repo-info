...
```console
$ docker pull drupal@sha256:a13ed5e0b88ef961af512497964ac8c53b7464a0ab298cc4796dbe063995cef3
```
...
```console
$ docker pull drupal@sha256:26fd905338f85b90a0bfbf1c29d2700da4fcf333120e2cdb0f43c74d20b8f719
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161722064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c11316e07370490cc285a1617221d9b3ee9686cb2631a82c407a4ec8dd7d474`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 21 Dec 2022 20:04:51 GMT
WORKDIR /opt/drupal
# Wed, 21 Dec 2022 20:05:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Dec 2022 20:05:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:39fb00a232fdf3bd4afb6ac538a687a87011fd5d46459efc9266a03535d625b3`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:434212656479fffeb7c49beaee3a5c3fd31f9d801b38a4127703333f8f3993d8`  
		Last Modified: Wed, 21 Dec 2022 20:21:49 GMT  
		Size: 695.2 KB (695203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3f8400fe60949bf802a2733f5d19616eac38d7089139dafea01b42d9234a4cd`  
		Last Modified: Wed, 21 Dec 2022 20:21:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a38885df2b16e55ee2612dbd1bcf797e187d21a38501d6aced5a22dc6202201b`  
		Last Modified: Wed, 21 Dec 2022 20:21:53 GMT  
		Size: 22.9 MB (22850859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
