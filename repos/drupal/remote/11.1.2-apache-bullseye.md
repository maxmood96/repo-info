...
```console
$ docker pull drupal@sha256:3cf47423622212f5f178f5d316b33dd6e61998609feb534464f694251915a2e2
```
...
### `drupal:11.1.2-apache-bullseye` - linux; amd64
...
### `drupal:11.1.2-apache-bullseye` - unknown; unknown
...
### `drupal:11.1.2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:11.1.2-apache-bullseye` - linux; 386
