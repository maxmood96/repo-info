...
```console
$ docker pull drupal@sha256:0be634108bcb350cd113265be158b2a30e6a1467ae3547bc8e10eb2a198c7170
```
...
```console
$ docker pull drupal@sha256:cb385b526fcda085bb3f25b63ecceec1e5a295a64561c82426fb81a164179486
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.7 MB (193688414 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c409adae0ce5fbcfea8a408e41f826987a71663e1e0ff467c52147dac8ed68f`
...
# Sat, 30 Sep 2023 05:24:26 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:24:26 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:24:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:24:37 GMT
...
-	Layers:
	...
	-	`sha256:e80f4ab9f512b032f88abeaf17f145dea7fe03d9a822ef9d503df81892a1843b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:123196e6ddbd46958e87dceff6d555257b33df7babc2a13508b6a6be2f514584`  
		Last Modified: Sat, 30 Sep 2023 05:42:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffe8b99f792466526630bb7586e257560f9f28e6ecef72dc765311fc1f1bbd51`  
		Last Modified: Sat, 30 Sep 2023 05:42:15 GMT  
		Size: 17.7 MB (17697139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:ca27ab747a1718425c843a422f433ef9f54c507cd78e03668a01bff60f06e8bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.2 MB (158215433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:477fe6621be2f9c88ba6d09d1e6f950012a25fc20bdf04c1f504f781b98963dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 05:09:42 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:14:49 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:14:49 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:15:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:15:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0652b2dd67407db8ff20f8fd60480329b16191d566f2b1916ad1ec880edf751f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47f17b7d483eb52533de6db3da52a1b0e787f5b0408935a3f0288fa94539ec90`  
		Last Modified: Sat, 30 Sep 2023 05:34:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc6403749ca7402b9481ab66cf975ed12322e0de3fa18090ff07815124384e3c`  
		Last Modified: Sat, 30 Sep 2023 05:35:11 GMT  
...
```console
$ docker pull drupal@sha256:5ff8e6977d9cb347576e7091a521e89a53cf48535cd1ff6efef947fd93f34206
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187696562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac163671f48cd79d301c60f470f41aecf0ff85ce7caf97be89bf3d881426b647`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 05:03:29 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:11:50 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:11:50 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:11:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:d6192bf945fcedc6593fdd348e4b4491e0a7b7d4eaa4fd5f3b8d1bb7640ebf5e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37b98d20ae8365b866c3c8860d525bd76234072f26a6708ed579dc4bc92024b5`  
		Last Modified: Sat, 30 Sep 2023 05:30:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9006f02a7adbe7e40355fa166ee3d45e2d8a294dbf0f5c904cdaed0a308ad75c`  
		Last Modified: Sat, 30 Sep 2023 05:30:34 GMT  
		Size: 17.7 MB (17696651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:49d84edd9ae3bacddf7acf6146686b804dbe63bc43417317066e19b1ce360354
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.4 MB (192433535 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d25bb62178b05d1d30ea8de190c418de611decbd88a6c999910a72c035bb89d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 06:05:56 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 06:14:07 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 06:14:07 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 06:14:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 06:14:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7d831ee46a0f30d01f16e8c2f54305c1a81835f55e0a5df2a19c9ab31c07d59f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b44f863e73676325ab59b4577c4a5039a6ed924b0aad5a93e438533e1fe688a`  
		Last Modified: Sat, 30 Sep 2023 06:35:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3057c4a2bfc7a945a1a1d52c3bcdb9d6ecd1845f9e2beb23afc04ca242a88305`  
		Last Modified: Sat, 30 Sep 2023 06:35:20 GMT  
		Size: 17.7 MB (17697149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:18692893b9bb8d31e280640d1685da546f6d70f79b6ade74b07d5ab35fd37cd2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197593918 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bf8d51d7c005fcbfd69323b870d1b3fef88df41ffda10cf38067a8ae5e01602`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:42:33 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 20:42:34 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:43:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:43:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:80062195d53871a5d1e17583af26d8f2347c9cc87ca5cec69e0d6b307a04fd23`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30421a79a6f4df431d219f2475739cb9f223d9b42d2c38867d900cd83704ca48`  
		Last Modified: Fri, 29 Sep 2023 21:17:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7850932b165689d70e29c45357efb92820e5b701080b4e562f5429b15cf2156`  
		Last Modified: Fri, 29 Sep 2023 21:17:48 GMT  
		Size: 17.7 MB (17697135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:c2a673dde417cb99c84c24261cb79ee3ba391702c4cbf05132f7b53f927043b6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167087023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe9a9776c0b19d7836256e5ff9e6fedaa8247166e773cdb63816f7d62f3ee9e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:56:04 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 22:56:04 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 22:56:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 22:56:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9b02729179f9ea94eba323d5458a84d5e9529a0fecc5245b390132951924a7e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:829f414d9e0c6180ef980d517050464b0a9695e119f019baf175c72ecbf98256`  
		Last Modified: Fri, 29 Sep 2023 23:54:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cba6223927c87fd6cb17c40017ac83d589e7bd5583d97e8a6faa2039c747935`  
		Last Modified: Fri, 29 Sep 2023 23:54:22 GMT  
		Size: 17.7 MB (17696940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
