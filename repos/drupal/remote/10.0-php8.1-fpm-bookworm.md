...
```console
$ docker pull drupal@sha256:0f5a9f2480a5a4a8b6e43b5bc58182bff3ca514182afe9397f7fe7ada4a05868
```
...
```console
$ docker pull drupal@sha256:1dfbbe91a41daebdc201f6515bb004a8859012d8f45d335bcf7de1f0b5601447
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187701309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a190d2bc0f8c2e2fde305612f01dd81d4daaf1e89dc3450ce1dc65b1114595bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 01:55:11 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 02:02:00 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 05 Aug 2023 02:02:00 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 02:02:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 02:02:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:963ab06663552f6f354b38f162d0fa32b0acbba43e99c992a6903c5e3f703af3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6552067ce73ca130db18b08e0177f2445769308927bd82e32c828bb3cb7ba6e`  
		Last Modified: Sat, 05 Aug 2023 02:11:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2cb3ab0d563c404ce6689bc25acab72f4ab3a10aab6fd8f46662776dec00b73`  
		Last Modified: Sat, 05 Aug 2023 02:11:18 GMT  
		Size: 17.7 MB (17696273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:25c09b76e9e2e24ba4db8257781aaf233046a719bdcf74b1e66f70d27cae2254
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.4 MB (192439454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d010dc4a28cebd34ba1f0468b3402032228b48deaf5af07e725ea51be5589ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 02:55:06 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 03:01:41 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 05 Aug 2023 03:01:41 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 03:01:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 03:01:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fb65352df331e5ad937a926a38d158f2a8395717ac3f27f3e9b5853d03af81e9`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1bd8b5e7d325f8d69fc76fb23770817d23fd15ee112b20a745c974fa99b7a75`  
		Last Modified: Sat, 05 Aug 2023 03:12:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:570612c85f4a77d5db9f545d8f87165edeaedb780f0c6877074161985b345d82`  
		Last Modified: Sat, 05 Aug 2023 03:12:49 GMT  
		Size: 17.7 MB (17696276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
