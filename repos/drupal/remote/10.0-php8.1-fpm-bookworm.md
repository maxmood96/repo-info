...
```console
$ docker pull drupal@sha256:63e7d04557b442944608fbfb899f9edb4299c63f89c6ef88fc5694160deb8788
```
...
```console
$ docker pull drupal@sha256:deeb3b61d418cb57e58edd2a1073a916dc4df70ebdf9cfd0ab8e32f7a323799b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.5 MB (197494719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cd2c9dad42faeeffec1f126949644bd01cd4333156ff13ab7ea528361f3a8d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jul 2023 21:30:49 GMT
WORKDIR /opt/drupal
# Thu, 06 Jul 2023 21:31:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jul 2023 21:31:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68dab3dd245628663ab53af858b2a7ba5686ba104bcfe35423eff53bf91d4c27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08bfbe916301abe3f0eb3f3712dc98c621836489e556ffc9d13d5c72ae26fe1b`  
		Last Modified: Thu, 06 Jul 2023 22:15:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b6f2c9a0d4cca363f702c08e5962c29b47c9a7fc1c309a25e29d168a56ff5b9`  
		Last Modified: Thu, 06 Jul 2023 22:16:00 GMT  
