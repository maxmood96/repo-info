...
```console
$ docker pull drupal@sha256:6678630e08efc253f6a5b23a0221dbb1ec9665508edcbe22e2d077b0d57ef0a4
```
...
```console
$ docker pull drupal@sha256:8881608c40e8a307492ba159c7501e68fe5c9fccb92865493c7233094d3b99c5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.2 MB (158173388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e72c32524309b1fde688f397abac5c23dea60ce7f9b9c33f4232ab0e7455ac45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 04:59:23 GMT
ENV DRUPAL_VERSION=10.0.11
# Thu, 12 Oct 2023 04:59:24 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 04:59:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 04:59:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9185aaf15825ed9422320daf714abdd0654ca6e0c450eeb8f9a7297b1218ef4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17f24898dbcef3a90d141b319c0d9bddb89eb9bbf84fe649c9dccd22c24cfb60`  
		Last Modified: Thu, 12 Oct 2023 05:23:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a5eaa4089258f7dbc2c93ac47bfe22fefc74e60feef14b023cc5ec662df72eb`  
		Last Modified: Thu, 12 Oct 2023 05:23:39 GMT  
		Size: 17.7 MB (17697207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e83f2f26881cf84d613204b3032669e050971318427be3da60937c523e45b109
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197560779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6089f01b0f2a89f7709f7ec5c464ed85c0b3c957b3ed152f450117841da28e9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:17:07 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:24:32 GMT
ENV DRUPAL_VERSION=10.0.11
# Thu, 12 Oct 2023 21:24:32 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:25:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:25:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:39b21ac764231ac44edc8ce0636b033bb557bf13e7a857410c285fdcde31c13d`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f18903018279a78215696a1264f2e6601a4e97804516f08c43458e863d9d213d`  
		Last Modified: Thu, 12 Oct 2023 21:45:48 GMT  
		Size: 705.0 KB (705009 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fd64d7b66cfefbb0838f8dd310598d63a8f12f9677da0411f25161c5d4978d5`  
		Last Modified: Thu, 12 Oct 2023 21:52:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5448ab05e17ae6e9e3687840df318d342ad77db1194ccb684b3b491a507c226`  
		Last Modified: Thu, 12 Oct 2023 21:52:27 GMT  
		Size: 17.7 MB (17696916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:5be5abaf7a00907e3c0b3167715503f8d9035f92230a72e6e4de421e2c8ee760
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.0 MB (167010267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b832e940e2efa488c10e3991c58065fc7ef389ede39ffa85aef28bbbe76001ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Tue, 10 Oct 2023 04:13:21 GMT
ENV DRUPAL_VERSION=10.0.11
# Tue, 10 Oct 2023 04:13:21 GMT
WORKDIR /opt/drupal
# Tue, 10 Oct 2023 04:13:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Oct 2023 04:13:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c3126881e532be8ff77fbc9341e909aedbde6eb331ef4aa3ca317a69261541d`  
		...
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0f14d201d345aced291735e8020133ac38b1129d044aebb57c160055a23ec22`  
		Last Modified: Tue, 10 Oct 2023 05:16:20 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f5a5d878692bff7a862b20f296d0cb4e4ee7f0319c4e668da7cd1da70a1e57`  
		Last Modified: Tue, 10 Oct 2023 05:16:24 GMT  
		Size: 17.7 MB (17697072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
