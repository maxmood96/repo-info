...
```console
$ docker pull drupal@sha256:3bfaaf25eca07aa6dcfff768cf6d3e6112ce253aa9c5640d734c47ae71cad9c8
```
...
```console
$ docker pull drupal@sha256:03286062dba358610857db983628cdd53810a23780fb18cb99c4d55d7a728b22
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53370322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e81d9bc3a3828153a9f79f9b0944051780893b1e24fcbbb11b20c27efd2033a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=8.7.11
# Fri, 27 Dec 2019 01:51:00 GMT
ENV DRUPAL_MD5=bcf01576c060dfb7de0ec1f7125f7bbe
# Fri, 27 Dec 2019 01:51:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e0fc5bf7ce505063fd14ad7fa3397461a49991e700a7caef304e27f479a437e0`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f617d79e9332322fa3bf17a945c114fda2077861c015594c2f242c734f76cca3`  
		Last Modified: Fri, 27 Dec 2019 01:53:40 GMT  
...
```console
$ docker pull drupal@sha256:82efb3f59e1932116a5df9631499d86e2ce20e34bed7af7f01ba1b733e700f74
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51919169 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9e5c93d1ada4da1e4e51305c38307c53f3c701e1d6cbe85aa3b211250377dd3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 27 Dec 2019 00:43:32 GMT
ENV DRUPAL_VERSION=8.7.11
# Fri, 27 Dec 2019 00:43:33 GMT
ENV DRUPAL_MD5=bcf01576c060dfb7de0ec1f7125f7bbe
...
-	Layers:
	...
	-	`sha256:ed84dfb63efe83fd6207ed54151d9f1a4de4e4be031fde50b639a7f819c22cef`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:725acc50b9d9ee6e1c19d92fd2b36923b97b7f2c1ad42fa0d57fde836e23397f`  
		Last Modified: Fri, 27 Dec 2019 00:46:48 GMT  
...
```console
$ docker pull drupal@sha256:b2ee006f8d5c078a906ebd1ee2231daba3038cce896a761c210d2c95ea717c17
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.7 MB (54688957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9190074b6d6538172e2b9125a4d794c31795f2ac8203746d2aae4b1f2b3f87d6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 27 Dec 2019 01:12:58 GMT
ENV DRUPAL_VERSION=8.7.11
# Fri, 27 Dec 2019 01:12:59 GMT
ENV DRUPAL_MD5=bcf01576c060dfb7de0ec1f7125f7bbe
# Fri, 27 Dec 2019 01:13:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:13d4a4274060388e6f8789c9b6970e9a153a3c5ec8a92a61ed7c0e18bd514ec8`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f57d7a0ce78ca6dc2cbac18c0eae8a0623ae9a1fdb1968ff12e3435bab155686`  
		Last Modified: Fri, 27 Dec 2019 01:15:56 GMT  
...
```console
$ docker pull drupal@sha256:57bd7eea305ce512599675f26427af93c88e01f74183d34693a9b5d64148f967
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56361579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8f9fd61f2e3679fb0c14738ed982f6e09678dea08fb757732a23c2038002ebd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 27 Dec 2019 01:36:49 GMT
ENV DRUPAL_VERSION=8.7.11
# Fri, 27 Dec 2019 01:36:51 GMT
ENV DRUPAL_MD5=bcf01576c060dfb7de0ec1f7125f7bbe
# Fri, 27 Dec 2019 01:37:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:934cc9f76b1c507f553f0829b52939982556deb8b34c7f0953ae43fb41113fec`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3df8a34bd89e2d7b3c984e5b58715123d0845bd0218da849092a9e7713ecb8be`  
		Last Modified: Fri, 27 Dec 2019 01:40:49 GMT  
