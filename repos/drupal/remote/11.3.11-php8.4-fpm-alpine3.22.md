...
```console
$ docker pull drupal@sha256:adfc9fa39d72d72bbac20d28fc616c8f8f3b6416d8af3e1a2bfa546d26b6bb38
```
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.11-php8.4-fpm-alpine3.22` - linux; s390x
