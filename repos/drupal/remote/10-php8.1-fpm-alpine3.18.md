...
```console
$ docker pull drupal@sha256:63717ab6e1fd0401594209adadbb18e7ed3f1576775ad067590aefaa5d262b9e
```
...
```console
$ docker pull drupal@sha256:6b7499f1df7f2975e220e8bcf4c2a5af56f7f06f2bc7399d09175b087e7ff7ea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52218730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a94110215402af6a373fec9d658dc2237c3f81d5f702e45179608305a244a6e2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 18:40:24 GMT
ENV DRUPAL_VERSION=10.1.4
# Fri, 06 Oct 2023 18:40:25 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:40:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:40:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f9551fb5d1ae8d6b419e302ad930434bc413130cf270a7617ed7be06dc5d356c`  
		...
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed467c70dc6c47847cadeee3e3fbaf57982665d45109e9895d1b77253c2c8851`  
		Last Modified: Fri, 06 Oct 2023 19:11:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccef4a596254eb61229a74554a9ef5914ba0b66eb7ff61177850baaf618e3fab`  
		Last Modified: Fri, 06 Oct 2023 19:11:53 GMT  
		Size: 18.5 MB (18516076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
