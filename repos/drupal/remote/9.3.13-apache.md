...
### `drupal:9.3.13-apache` - linux; amd64
...
### `drupal:9.3.13-apache` - linux; arm64 variant v8
...
### `drupal:9.3.13-apache` - linux; 386
...
### `drupal:9.3.13-apache` - linux; s390x
