...
### `drupal:7.90-php7.4-apache` - linux; arm variant v7
...
### `drupal:7.90-php7.4-apache` - linux; arm64 variant v8
...
### `drupal:7.90-php7.4-apache` - linux; ppc64le
...
### `drupal:7.90-php7.4-apache` - linux; s390x
