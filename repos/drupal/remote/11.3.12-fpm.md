...
```console
$ docker pull drupal@sha256:c2f3506a12b0702175465ba11c86412de07b69d2053fea6b6c67ccf8249cb927
```
...
### `drupal:11.3.12-fpm` - linux; amd64
...
### `drupal:11.3.12-fpm` - unknown; unknown
...
### `drupal:11.3.12-fpm` - linux; arm variant v7
...
### `drupal:11.3.12-fpm` - linux; arm64 variant v8
...
### `drupal:11.3.12-fpm` - linux; ppc64le
...
### `drupal:11.3.12-fpm` - linux; s390x
