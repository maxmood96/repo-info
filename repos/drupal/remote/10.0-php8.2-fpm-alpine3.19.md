...
```console
$ docker pull drupal@sha256:8922899dddfc9eef9391ce25493e0762325ee97b33fa4a69d3977707400324a2
```
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; amd64
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - unknown; unknown
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; arm variant v6
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; 386
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:10.0-php8.2-fpm-alpine3.19` - linux; s390x

```console
$ docker pull drupal@sha256:079b2b6dafd77c00b506feb66d1669ac74336b32f31c772486a363c6bd2e8672
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51326762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fc174fb7dac17569f5b2e398804bba5cb73e60426b0a1b8d5822372a467f7d8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6b02017766cac0efd2b48b653b7addcf5a7df0ba7bca3eabc9174554d851c4f7`  
		...
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ef94e9b6a4c428d5e8981843f7e301e7a40433168bf5b848a4dbedee92dc3f7e`  
		Last Modified: Sat, 16 Dec 2023 12:24:56 GMT  
		Size: 17.7 MB (17691518 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.0-php8.2-fpm-alpine3.19` - unknown; unknown

```console
$ docker pull drupal@sha256:e2735ede78c1c283077a26c05b9ee59b6dcea5de97b94c068d49265c4d085339
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.6 KB (306582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:789ef45b1e597a67a3ef6686bfb6df1f9ab7585c11e16a78b081fbac5a6f9b7e`

```dockerfile
```

-	Layers:
	-	`sha256:d1b4f9082228ac4546db58c7173b105ced8bbed2838ecd539b7a23c2ce44212d`  
		Last Modified: Sat, 16 Dec 2023 12:24:55 GMT  
		Size: 274.7 KB (274664 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5ac210da1196ff352863ca649bd21e8f3dfef18c8d03cdba07d6c3e0427d1a12`  
		Last Modified: Sat, 16 Dec 2023 12:24:55 GMT  
