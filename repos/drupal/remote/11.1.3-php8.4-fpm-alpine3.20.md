...
```console
$ docker pull drupal@sha256:e16ec6aecc8f315adaa80c11eee9e7beba2c6ba49bf9350de30b3ff7e24cd9f0
```
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - unknown; unknown
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; 386
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; riscv64
...
### `drupal:11.1.3-php8.4-fpm-alpine3.20` - linux; s390x
