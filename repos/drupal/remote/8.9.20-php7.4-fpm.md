...
### `drupal:8.9.20-php7.4-fpm` - linux; amd64
...
### `drupal:8.9.20-php7.4-fpm` - linux; arm variant v7
...
### `drupal:8.9.20-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:8.9.20-php7.4-fpm` - linux; ppc64le
...
### `drupal:8.9.20-php7.4-fpm` - linux; s390x
