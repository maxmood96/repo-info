...
```console
$ docker pull drupal@sha256:1691bb279c0bd359be3aaf279b73b6507e7f37bf5a2e2ed31325e0728ca1995e
```
...
### `drupal:7.87` - linux; arm variant v5
...
### `drupal:7.87` - linux; arm variant v7

```console
$ docker pull drupal@sha256:96f1d73c751fea8322add9b048670d9ce649dafafd9f2bc6f7fd1ffa53f02163
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141755284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6ee2d63464495d7b291a6bb92f035918765c349d3b516a4362136a5e6953140`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 20 Jan 2022 19:21:20 GMT
ENV DRUPAL_VERSION=7.87
# Thu, 20 Jan 2022 19:21:20 GMT
ENV DRUPAL_MD5=75200b0b3f00140f25a990cb1ef35789
# Thu, 20 Jan 2022 19:21:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:521772f3ea72ded66b0fb5032a96239fafd3ae273c171b3fbeb7865f1dce655a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6fa1e995661c9612d48b538ac7418e60d21114096a6cf6827b0d0b0ff4d43ee`  
		Last Modified: Thu, 20 Jan 2022 20:09:58 GMT  
		Size: 3.4 MB (3380482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.87` - linux; arm64 variant v8
