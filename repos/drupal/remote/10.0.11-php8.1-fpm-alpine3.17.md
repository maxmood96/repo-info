...
```console
$ docker pull drupal@sha256:8a33c304fa0fdc9b330b56be819b2192559f0620431cfbb85a602939935a8822
```
...
```console
$ docker pull drupal@sha256:bc8d5f02403a6d1707eb4c70275f3e5547dacfe2dea5de37020cab451ccfeecb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50301925 bytes)**  
...
# Fri, 22 Sep 2023 00:36:53 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:37:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:37:04 GMT
...
-	Layers:
	...
	-	`sha256:9f9d0e9eb55a091adfb1b89d4375c2abde23e391939860a44069d69282a078d8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2f755b1add7e4eb1012c8fcdbb7934ecf1f686cf310c8017e37b4a27f6f2597`  
		Last Modified: Fri, 22 Sep 2023 00:56:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a51b25640bfe83f37f14fa653a52657af2c4e3cf1e21e58d5046a420ceffdcf3`  
		Last Modified: Fri, 22 Sep 2023 00:56:10 GMT  
...
```console
$ docker pull drupal@sha256:f1be084b2956a148c0936ea9906cd1f6f4d0c51a0f084ceef84ba35e466b9fe7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50817559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:515420e87ded969879dd9107f3dc058c73eb0440da5af7421c9759a0d01979b6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:45:15 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 22 Sep 2023 00:45:15 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:45:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:45:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ddb132a2b0e7647aec29d446933f8fe8b1799b20cdc49932d49b56502a25881b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c83510afeca39c2766c1d08174cb6328812517e66e5f0b81dd9513055b5f4a`  
		Last Modified: Fri, 22 Sep 2023 01:09:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af9bb80b953b432bc9063adbb592163b271c54b17d48690b8b39b04637c25160`  
