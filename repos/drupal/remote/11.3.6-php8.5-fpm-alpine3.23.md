...
```console
$ docker pull drupal@sha256:e979e2ba8992210f76e65ed72338cbfd54b610da985df40a8a0b8449ead152a2
```
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.6-php8.5-fpm-alpine3.23` - linux; s390x
