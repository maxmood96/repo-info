...
```console
$ docker pull drupal@sha256:27f40403a7dddb1093b8da49c842f241bff9c3008a8903560ca1bf0714735f53
```
...
```console
$ docker pull drupal@sha256:23c6870cfacb96f9007dd8bfc73408bffe60cb2e7965365739eddeafd88d74f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.1 MB (164098608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f55483394433d3bcc9cac35a01cd63c776852696fae1324b0216ade48f2ff45e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 21 Apr 2022 07:29:29 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 10 May 2022 16:42:13 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Tue, 10 May 2022 16:42:13 GMT
WORKDIR /opt/drupal
# Tue, 10 May 2022 16:42:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 May 2022 16:42:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c75092e33a5fafcb08adf5fc7e0a0200b768f8dd0bba8765784539cada0d8cb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d099047b44fa82803f9fc59c1770ccdb58a05bf6cb88677aaedb15fce3b5b05`  
		Last Modified: Tue, 10 May 2022 16:58:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eecd1bd89238f902225be53d48d11f7633e4322193aab27898e333386ae0772a`  
		Last Modified: Tue, 10 May 2022 16:58:21 GMT  
		Size: 19.1 MB (19117444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
