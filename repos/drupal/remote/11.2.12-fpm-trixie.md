...
```console
$ docker pull drupal@sha256:033e902adf0cad0fef2fd6154d930b2d816bfca01c8c7672751f67539562c181
```
...
### `drupal:11.2.12-fpm-trixie` - linux; amd64
...
### `drupal:11.2.12-fpm-trixie` - unknown; unknown
...
### `drupal:11.2.12-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.2.12-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.2.12-fpm-trixie` - linux; 386
...
### `drupal:11.2.12-fpm-trixie` - linux; ppc64le
...
### `drupal:11.2.12-fpm-trixie` - linux; s390x
