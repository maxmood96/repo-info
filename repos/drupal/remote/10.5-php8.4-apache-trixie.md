...
```console
$ docker pull drupal@sha256:faf45acf67808f64c20a63476f313839e1571d6955c4754729e6f36ce0a5f1a6
```
...
```console
$ docker pull drupal@sha256:202214ea607b4f71ef068f92ef1c5666d34d6845543e619744ebee4b2420297c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.6 MB (203623488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35a4ed2e8c738819edaef093f32254e98fa4959e1f53167ae838327d68d81fba`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c76386989edc916231f0b46e9da4f9fb0d43e094becdbaaeada5fa4b4e42a182`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
		Size: 1.7 MB (1658638 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:00f8710f8c8bf1bd45938c7ae971efd4e2529ae157c0598b2bcfe6d8cfa7bf1b`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:90c1b2afc4cd6a98f273af926f63c4185f9ab1c433c314dce5903c54e887b5cb`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
		Size: 257.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a77e857fbfd8a9db0945ed3f5383b582e03c5429be7d371a0c5df491ff0da8a0`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
	...
	-	`sha256:a5ad06115a3084da02748fbf75b4f2affcf5afc1e842709c008ee13351b5646a`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f555cf0eb7a13de15845b972040ca4a3c034ce386e0ae099c20be2134585e1cb`  
		Last Modified: Fri, 08 May 2026 17:46:40 GMT  
...
```console
$ docker pull drupal@sha256:2b83201315f07d4b461d82c80d95d99f3664106f904f5b0f52388c358c67936d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7377589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5fe03c3f2ec935cdadd219ee8a02dbf914d2cb36d80c96d054cb167b87fd2ff`

```dockerfile
```

-	Layers:
	-	`sha256:8e6b36075ab1625ab4c7f2317cbe77c86403ef7d25e3423a194ed78b019f3349`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
		Size: 7.3 MB (7332512 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:28d922014e8a9f29046ef42d8fe1335d027827f22b9b29636cb67d32165b73b8`  
		Last Modified: Fri, 08 May 2026 17:46:38 GMT  
...
```console
$ docker pull drupal@sha256:e9707ef302121f2a6fcb36165b3afebfa20f47cd5ea0f3b1ae124ef4bd943b10
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165734738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c97fcabb366ac8e617a4ad2e8227617163d61aac84bacdf08f0693fd046dd5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 07 May 2026 16:43:03 GMT
CMD ["apache2-foreground"]
# Fri, 08 May 2026 17:50:51 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 08 May 2026 17:50:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Fri, 08 May 2026 17:50:51 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Fri, 08 May 2026 17:50:52 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Fri, 08 May 2026 17:50:52 GMT
ENV DRUPAL_VERSION=10.5.9
# Fri, 08 May 2026 17:50:52 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cea61187dad88d9a61b2f395c2087e0ae901cab6023038a6c1be34692e764a0a`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
		Size: 1.4 MB (1371177 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:82c5ab6a3c78c79009e71f285cfd8ed11c5737820f4a3f5da181b66e54b643c5`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:12f0877b159a0a0df288e0497572644cbe497105bf81f022decfafe6b88e5c53`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
		Size: 257.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2c5d07fe20c5d47e201db2141ad8fbe72bea10303d3deee313b16d42e68a886e`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
		Size: 790.8 KB (790770 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0b1962dceb047d4820de3b3adea1987c19d1d894d1430068fb0125b1373384fe`  
		Last Modified: Fri, 08 May 2026 17:51:17 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0b154781f2a21b3aa78d4532b4c23e5267369afcf3a0bdf2d2814cc46b93874b`  
		Last Modified: Fri, 08 May 2026 17:51:18 GMT  
		Size: 21.7 MB (21749949 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.4-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:f03d8bc4cf0f06cd2e9fe04b0ee18ec76aa030549286998da5997fd3462165c4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.2 MB (7181700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d9030d9482601b392762caa8e79314c0e60521c55d35228d05878e763ed2d9b`

```dockerfile
```

-	Layers:
	-	`sha256:26e7141a29d0bbd53f7bcd0f0599c23d56662a584348b5549bedf79d280e96d5`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
		Size: 7.1 MB (7136425 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c0a215ab8653c79f9f74640db7d22ab09973d7035120852a18d667b31ff77d3c`  
		Last Modified: Fri, 08 May 2026 17:51:16 GMT  
...
```console
$ docker pull drupal@sha256:f7d8c702b1ad0988480570bba74deeefbee67a523088fb70790e8be8a3e7b5d2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.1 MB (204053635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:468b86f5a9e542d42051e69cb6d335a74cafe50e3314dbecf83dc0c6e7671e8c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:66e393c6235a371d9b523220f85b0b84ebe260bb24df37a1feba20e9f3acee0a`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0480e0dfa64d8d9220227320ae71aa6bf7b6547e907ce09ad19786dd818ec3ce`  
		Last Modified: Fri, 08 May 2026 17:46:30 GMT  
		Size: 21.8 MB (21750308 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.4-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:03c683dd17675f4beb16cd7a074357eee6cbd146761003aab9d438c02b0aa208
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7351314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da8f738e9600f54c36c3bfcce37b3123901318946d612ec89c818bf788185231`

```dockerfile
```

-	Layers:
	-	`sha256:dbe60098f7c7f29038dec649e64c9d4bad99a716fc751117f0771a61f2542a89`  
		Last Modified: Fri, 08 May 2026 17:46:30 GMT  
		Size: 7.3 MB (7306324 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0d0d248b41b9ac318855c9e917ff3ccb324b0268d87a7b134ebbedcf57584d30`  
		Last Modified: Fri, 08 May 2026 17:46:29 GMT  
...
```console
$ docker pull drupal@sha256:2f0c6abd055f91870ddf5e93d52c233998495b5c129c8629c9361d5049bcd1c5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.3 MB (180304205 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:042e433a1e2cd02aeba347c22a7d11a7f99ea50abb6c6dc9d643035ce844e0f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:cad16377c242500274fdd620d72ef661f235392c7c2257934ca31137f180a832`  
		...
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a73aecaa644e1fa3368bfa690fdf04b9f7d76f06703437d5cd0f52e45b74c028`  
...
```console
$ docker pull drupal@sha256:f7ea15c6d8424436f70eca12a4f5adcaab3e30a47d568fcbcc9a72a953bd9b24
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.2 MB (7192633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03c7ffbd994ea4cce4cafb14a4ba8a9685ccaa6ed5279bb844d62be6249e608a`

```dockerfile
```

-	Layers:
	-	`sha256:cc546fbbca9b56a1530a4c02e0b73bb9dc7192556fab7b3f7d9c8c61e2f73592`  
		Last Modified: Fri, 08 May 2026 17:49:27 GMT  
		Size: 7.1 MB (7149762 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a82fd50933ca53ab93b2516d474650f00cd305b5619e149fd240bea06f6116ce`  
		Last Modified: Fri, 08 May 2026 17:49:27 GMT  
