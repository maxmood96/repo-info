...
```console
$ docker pull drupal@sha256:c8b0886fc55902e42db16f3463a21eea941ed5995ce842bdf51e75677f82777b
```
...
```console
$ docker pull drupal@sha256:1688cb28dcf9d826943add65d7348381cf87aca2d7e7fb28007bd9ba742c5c4e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.8 MB (206771642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe776ebc8b0db04863d07e2d237075b8912d81bb0975955b986ceb5ea05ef111`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:3b0e686d473f00e31088e3a5a8776aa36a475fc4c58c304062e2ad564cdd6ed9`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:564773848d468955fa2cbd55720bbdc46ab1c9bf769f03d7aaad9751b5595b87`  
		Last Modified: Thu, 16 Apr 2026 00:16:50 GMT  
...
```console
$ docker pull drupal@sha256:bbaef6530caf9d55d4dda8b12f4805a6ce19b4c1cc79fb8af80a8b6c78d45e64
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7351316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b868017d2b8e730bba9d8b2dcf033153df801a5206b88b9b38d852010a5e77d`

```dockerfile
```

-	Layers:
	-	`sha256:ee179278d56bce59514b05d619fbe7764c93fb9ef01e57c005874e9e323bdd49`  
		Last Modified: Thu, 16 Apr 2026 00:16:50 GMT  
		Size: 7.3 MB (7306324 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:be1e3d606cb3e0ee25d55c1f3f3a9330e9dd3091f390d6b0c79d27b45adeee75`  
...
```console
$ docker pull drupal@sha256:b2b69e466c6485dc4c3989262df5873bf993c9ec1448a05e8ea29e9af96082df
```
...
```console
$ docker pull drupal@sha256:45b26b7dedb2f81685072166900bfe072a819f260d98b2ddd0c4fe8f110d9c7d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7377570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7632b03468d185e700acc0422fa8b8a878594ad7e92a219f194ecbeeb883e7f`

```dockerfile
```

-	Layers:
	-	`sha256:7236de38902942d81410bdd526d8d1a06dc96accbc4b907d1913bf8b52b86664`  
		Last Modified: Thu, 16 Apr 2026 04:07:37 GMT  
		Size: 7.3 MB (7332385 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:daeb1df90e7dd521bc71a9d0a8ef0561fd97350ceef86396a6a4d4bd64ddc450`  
		Last Modified: Thu, 16 Apr 2026 04:07:36 GMT  
...
```console
$ docker pull drupal@sha256:13b5c6fbcccb5f3b950314a22b6e894b799e4576590b2fb3e2eab98703260047
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.2 MB (181205997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2468e7d2f9c306e8854a152d7f454473154e3f0d0be3c9bb952c68ba9dc7e07d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:929b3eac41504a3885ce14ff3d11881dfe2e78d526775e515a743a5c5fa570cd`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1425c89b53457a4458739592aa9620324bee646764daf6793716f4b792f73ff4`  
...
```console
$ docker pull drupal@sha256:f4c1903f055324bce787598cebd348c78266ba33a9d0bea3ed734421d419905e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.2 MB (7192631 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1ae5be4d96d05a8db2a2cae169dababac02dd139aee281599266bb5db7f1c91`

```dockerfile
```

-	Layers:
	-	`sha256:81d1b5ae21534b8f59e278a3c23ee8cc8fa327236b3e512b900ee00168f76298`  
		Last Modified: Thu, 16 Apr 2026 01:06:58 GMT  
		Size: 7.1 MB (7149762 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:02859f63ecb90dca6844ce538ee403ecfa223bc8a93876d4b3d35f1172ab3061`  
		Last Modified: Thu, 16 Apr 2026 01:06:58 GMT  
