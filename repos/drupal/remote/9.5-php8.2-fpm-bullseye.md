...
```console
$ docker pull drupal@sha256:15a446ef7f7b65fe1b2d237e1bd5e37eaf025824d44fd1ce402983233171d31a
```
...
```console
$ docker pull drupal@sha256:06be66aa59ca011db3b1865898d8432431005dc8cb9060b2a62d6db4a2905cdb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.5 MB (187483025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9419ff51919c07705f6d5df92e071aebe004ea519a44212fb4f795ab405d9383`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 05:20:54 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 29 Jul 2023 05:38:27 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 29 Jul 2023 05:38:28 GMT
WORKDIR /opt/drupal
# Sat, 29 Jul 2023 05:39:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 29 Jul 2023 05:39:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9f888ed25ab3f034af1f81c25576d5312e481aa934788d19be5349baf59702c4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b5fd61bbaf8e3f1d20c31b53dc44b3ebbaf78b8a7d630e600f72fc759750e0e`  
		Last Modified: Sat, 29 Jul 2023 06:16:39 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:391265210bfe15504f8945b6a451cf850be67410121a7e9657ebfe38dfde065d`  
		Last Modified: Sat, 29 Jul 2023 06:17:10 GMT  
		Size: 22.9 MB (22879940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
