...
```console
$ docker pull drupal@sha256:cb870fc6f71c7b3557f17dd51f89bde9d15d2f35933a01b1beff16adcb2d0348
```
...
```console
$ docker pull drupal@sha256:8d6e1d6553a7c77a10d186f72ca72919d0c7bed1f75567e04682e13523684f0e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187670181 bytes)**  
...
# Fri, 22 Sep 2023 00:37:59 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:37:59 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:38:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:38:11 GMT
...
-	Layers:
	...
	-	`sha256:ab2e7dc399f5863c364fd3581d142e20f8b5b741e295caf516cb5177fe015d7b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfe3c761d9e07de06b27046402b9cac07f22748397f5fc268d56ef81a9d83df8`  
		Last Modified: Fri, 22 Sep 2023 00:57:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:144f02105ff5a392ffcce71545eaadefd4bfa334db0c4539e27e95085f72b1b9`  
		Last Modified: Fri, 22 Sep 2023 00:57:40 GMT  
		Size: 22.9 MB (22880600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5-php8.2-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:019488560513f3f0bc177db743c7dbdcdd661d8788e84116f368e879d19f4e6b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.6 MB (157609692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31dd1397132904ed94a17823919ebd77a42cce6fa138591b3b92b9ebdad71b3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Sep 2023 09:59:22 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 01:17:59 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 01:17:59 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 01:18:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 01:18:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:44eebd344a9b804299d9dcbb8b1fb12613d1d8b62c46b67c7c291a1df9885d52`  
		...
		Size: 704.4 KB (704419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:802a4120b967665bb16d97e60a56f0be360b234aedb21c8ea1215c23725606cf`  
		Last Modified: Fri, 22 Sep 2023 01:42:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d276469b64c7acc1e22e43b1745fdf7d14bf892183963c201b0fdb438c0e74fb`  
		Last Modified: Fri, 22 Sep 2023 01:42:49 GMT  
		Size: 22.9 MB (22881085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5-php8.2-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a37e4c68d29300d00b6e8a603c45e2f1f64150189c06be28a5f5dac481072bed
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181931861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcd3838ac47bbf7f91d904aa6fe9016f6faebb0ec9a07972e99ebbff8c72a6d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Sep 2023 18:31:19 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:55:24 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:55:24 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:55:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:55:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8eb61b89941b15e45b81e56d61838315336b5d52839e7e96d2cf07e7d35997ba`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:449468f2d3efd9b2db599b8bd3ef2e70d019a82e688c11483f9b3036b5ed0965`  
		Last Modified: Fri, 22 Sep 2023 01:17:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29cdf86d9a1245250ec890f945b718e6c35b295b705aa587c6fc462dd4d76914`  
		Last Modified: Fri, 22 Sep 2023 01:18:12 GMT  
...
```console
$ docker pull drupal@sha256:a15fbb2c0e64bbb26bf5969e0c559bdb298ce38bf1ec791a9dc8c506a6834cf1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.3 MB (190296314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4e5c16932376a4fbbcff5e1a4db26bd9e9284712f6b2f33694dc29f822eb20b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Sep 2023 02:52:58 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:46:34 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:46:34 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:46:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:46:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0371a2e76f741bc2d7732538bd230b37a11a04567af7de485267d36175e62edc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecbce8db687dca88415c5e04a6faeae3382c0c294c4ec940de80a8ba1b1634cb`  
		Last Modified: Fri, 22 Sep 2023 01:11:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ede6c12073184455855b93fc463640bc974abfca261248c141d879c91ccd3523`  
		Last Modified: Fri, 22 Sep 2023 01:11:43 GMT  
...
```console
$ docker pull drupal@sha256:b0b455ee3e226344e81a39fef17e636c34be240c394a4f4b9194ae23d8aef6a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.5 MB (187509153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f524dae5b9d77437d9ef15138dc6ae7daf823e8512a8a11ce852f44ed80078aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Sep 2023 09:41:56 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:30:39 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:30:39 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:30:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:5a6a5e6005bdef970ae96f20bef8b9da6b94eec7a1adce67ed24c9c68f5c3be0`  
		...
		Size: 704.4 KB (704418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cdf10ca1093286eff9855da2613822c6215bdb180d4a568283d5875d838a7c7`  
		Last Modified: Fri, 22 Sep 2023 01:04:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e2cbdb1adf54e5e104ce271c8640169c27413e85abe861c44b916ddaeb43633`  
		Last Modified: Fri, 22 Sep 2023 01:04:44 GMT  
		Size: 22.9 MB (22880539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
