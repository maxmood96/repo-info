...
```console
$ docker pull drupal@sha256:f0fb0a68f799a1e2379ad8c0f0c387771b274a38655c423da7069695af63af0b
```
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.8-php8.5-fpm-alpine3.22` - linux; s390x
