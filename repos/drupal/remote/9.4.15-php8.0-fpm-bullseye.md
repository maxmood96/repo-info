...
```console
$ docker pull drupal@sha256:fbc994fdf6f37a65644c2f5605297589d2f49370dbb571737fe5f845548d76f1
```
...
```console
$ docker pull drupal@sha256:b460806de73bfe6c45a686f72175ad72ac2f09d7259c2b8d499644d354c89157
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (161953194 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79554e85d5b105026abdce36f81edd5ad82e6561e8525c818e2f3ba0fb9ae62e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:56:24 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 23 Jun 2023 00:03:43 GMT
ENV DRUPAL_VERSION=9.4.15
# Fri, 23 Jun 2023 00:03:43 GMT
WORKDIR /opt/drupal
# Fri, 23 Jun 2023 00:04:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jun 2023 00:04:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f1a1ad7105998d3e8c28cc6399d2e2cd0f5669cb064cc67c2c09bbf2292b015e`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c0da439afd0f5c0611e0ee2ffe71a2f9d913979f0119208de47a979285e1560`  
		Last Modified: Fri, 23 Jun 2023 00:20:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b44479628081edcafdda59cdff0eac903738d1271c3540223078116262c3ec8`  
		Last Modified: Fri, 23 Jun 2023 00:20:05 GMT  
		Size: 21.9 MB (21915280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
