...
### `drupal:7.85-fpm-bullseye` - linux; arm variant v5
...
### `drupal:7.85-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:7.85-fpm-bullseye` - linux; 386
...
### `drupal:7.85-fpm-bullseye` - linux; ppc64le
...
### `drupal:7.85-fpm-bullseye` - linux; s390x
