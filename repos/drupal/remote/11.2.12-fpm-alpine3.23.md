## `drupal:11.2.12-fpm-alpine3.23`

```console
$ docker pull drupal@sha256:d8d831bb8935bfe33d9a2c6c0a9de2356d750daf27142a298fcd05f020a401be
```
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.2.12-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; 386
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.2.12-fpm-alpine3.23` - linux; s390x
