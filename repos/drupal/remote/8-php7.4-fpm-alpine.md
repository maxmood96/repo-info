...
```console
$ docker pull drupal@sha256:978a33ac59a65bc19767871982a5d5cbfb2cb22323375f2c7801b74958413301
```
...
```console
$ docker pull drupal@sha256:12b9c1f88fb318915d3bfee0bff6425874d596dbacb45069a76c7c7051706c30
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52783240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6520b0e8fdf0630f17a564e479139cdda37a575eaee8294ac9ee2af442d9e354`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 13 Aug 2021 04:40:28 GMT
ENV DRUPAL_VERSION=8.9.18
# Fri, 13 Aug 2021 04:40:28 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 04:41:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 04:41:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec7cfb2f1d7e3295b1baf3813c250039d0dc9a1152034611c4e8831db33bb881`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:966b68f7d6b16bff36239e7d130ffb356985cb6fd8847a717ad7e8ef1aefb0b1`  
		Last Modified: Fri, 13 Aug 2021 05:01:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66eb3eff196b66557999797e3ab527312bb5deaaffba240babe33a303d1bc6e4`  
		Last Modified: Fri, 13 Aug 2021 05:01:28 GMT  
		Size: 20.8 MB (20796976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
