...
```console
$ docker pull drupal@sha256:3f9a33a22bdee48ea9f821f2224cd21e7a8572a6d963e6770720b61accc98e45
```
...
```console
$ docker pull drupal@sha256:5e04dadfb7adae16ad572f406f906bce7c5842d30a9de1dcf8089450854667f2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51530895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da25af8b9df32c8e9dfd27bc9fed5e9dee26703b55b3c105130314bf49d0404a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 10:11:12 GMT
ENV DRUPAL_VERSION=8.9.17
# Sat, 31 Jul 2021 10:11:13 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 10:12:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 10:12:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:197e04e74eeb14a6a57874fe3d03efedcc34e7bb0728d1542d10d67c3169a950`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52eec2bd69c47eb5d43330e964a7074b1e792116aa9d6663152234e1ac7cc54e`  
		Last Modified: Sat, 31 Jul 2021 10:25:05 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9c697505b5e2a55e6732d3556be2f8b5bad3e0b8801e2be1add9eb0d308649e`  
		Last Modified: Sat, 31 Jul 2021 10:25:34 GMT  
		Size: 20.8 MB (20798296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:4c7bb2f08b0031a8a36d5d8539fc7b40525b3e88b2a623a4a333aa4997dae5dd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.1 MB (54109300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f43fd89c50d0327de07d523ae79adc953827f1c909adfbb9eab1ad53e836e05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 31 Jul 2021 11:25:39 GMT
ENV DRUPAL_VERSION=8.9.17
# Sat, 31 Jul 2021 11:25:41 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 11:26:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 11:26:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ac2294d6828169122814ba1dbaf6f7ac00a7ee06c0f0594146d1037127448841`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:038d796f4bb0c019d90bc725447ba1b039e6709933f83e3ee9c762bff4ac4f68`  
		Last Modified: Sat, 31 Jul 2021 11:44:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a3fcd6d4480bd310d0e83539d8786f639007be1d6b2f62787925b53890361ed`  
		Last Modified: Sat, 31 Jul 2021 11:44:28 GMT  
		Size: 20.8 MB (20798542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:7cf7c1cedb618cddab938da0e3d88b968dc59d947daa00075eb841db0fe42738
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52111929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c9e9f63a754032e8b8730880c238e22152703ea30d7d6bf204e18052ec3c605`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 06:30:35 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 06:31:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 06:31:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a9634b42ebdd3c0d058bd3ca163fd1fa3270d3dd012cc61c8fdf63ef3802adcc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc6deaba5215adee0b4a2815ec05df8e66595835ee897457967875dab85c5aa7`  
		Last Modified: Sat, 31 Jul 2021 06:40:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da4e0f3d9cff784b2d2ec2dfa33482e9601384b8df846135d54f5ce693faf144`  
		Last Modified: Sat, 31 Jul 2021 06:40:25 GMT  
		Size: 20.8 MB (20798382 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
