...
```console
$ docker pull drupal@sha256:257356636f20bcc1131f23e6df3e432efb8ac538b77f665cf77fa4a29fe25b33
```
...
### `drupal:8-php7.4-fpm-alpine` - linux; amd64

```console
$ docker pull drupal@sha256:a4f0fadcc822fc6177ca56f425d1d40961b75ee125043caf918b5f531ea81eda
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52541848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7bd7a63c35fd1263257b4e2da3a1e15e93afdf2d464c13039384cf40ca53edc`
...
# Fri, 19 Nov 2021 01:12:59 GMT
ENV DRUPAL_VERSION=8.9.20
# Fri, 19 Nov 2021 01:13:00 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 01:13:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 01:13:38 GMT
...
-	Layers:
	...
	-	`sha256:50fa380f667c683ec2450bf2e4eb0d059e752106e396926774a77d0f845e2943`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23e6dddd12154bdc2f9ec170589daf9743b080d9a9497f488b0898d3bbbd9b2b`  
		Last Modified: Fri, 19 Nov 2021 01:28:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f299521b0eee2707b45aba13e1fd46b4087e3e129fb2ba1ea2c0ca508a046ba8`  
		Last Modified: Fri, 19 Nov 2021 01:29:00 GMT  
		Size: 20.8 MB (20800569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:1229d9fb6795974bf841cf5a5a446b649ed63d465cb7979281f5662ff2f90486
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51225775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:770c905f49eb07cdcf4085242aaa3be85c9a98984ff545b5d3403ac538cc3be0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Fri, 19 Nov 2021 00:04:51 GMT
ENV DRUPAL_VERSION=8.9.20
# Fri, 19 Nov 2021 00:04:52 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 00:05:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 00:06:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e3b197d089282962b7e92bde1d2625446fb459721a9a328d2d95a506dfa5db93`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfc74b1a5a89a4efe1109ef96ce92f634f9995a0ee94d505b1b5367ae1e9d095`  
		Last Modified: Fri, 19 Nov 2021 00:18:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbbee5689db6c7da9b551df338a5f00df5496b988a2cfb0d9aaff0e047844d09`  
		Last Modified: Fri, 19 Nov 2021 00:19:23 GMT  
		Size: 20.8 MB (20800702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:49b304e0b5df6918c84014764fa17b9881d7ea164e7f1db9a030789988b5bf7c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49864294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75df850a69821ae5281821e745f7710c2a21078f47549138cb8f64bdbc845f07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 03:16:05 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Fri, 19 Nov 2021 03:16:06 GMT
ENV DRUPAL_VERSION=8.9.20
# Fri, 19 Nov 2021 03:16:06 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 03:17:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 03:17:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:745fe6da363309f407470e7149bf77d0c4f8ae171bced7f6cbbba052b773dd4d`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e048ffa83aa6a6a9c1f011b66d90a41597d36ea05f52fad43a5c851697a74a3`  
		Last Modified: Fri, 19 Nov 2021 03:53:31 GMT  
		Size: 498.9 KB (498913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c51ef9abfc4eaa2d787f1d2db5a4e79a16352cf37330f120f6c859a86df4b0ac`  
		Last Modified: Fri, 19 Nov 2021 03:53:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dedeca0a8a842b15052127161ae07554220914d76913b22f1f66aec21ff9aba9`  
		Last Modified: Fri, 19 Nov 2021 03:53:58 GMT  
		Size: 20.8 MB (20800715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a3b015d69bd689f652feedc80e84a6e960f4639e44efd5d1b99cee70dd961a30
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52220436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:632452f1c999d8bd10ccc7aa10e54345ea183a5e883e175548228598be599f3d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:59:07 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Thu, 18 Nov 2021 23:59:07 GMT
ENV DRUPAL_VERSION=8.9.20
# Thu, 18 Nov 2021 23:59:08 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 00:00:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:14b290760de3093d42c8a7514c95d4e63fe092cafb7d3e71364bdcf8cdac4bbd`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:472c95e990d15bec60989f6f043f828165a4d727b652abb21aa2935e625fced0`  
		Last Modified: Fri, 19 Nov 2021 00:19:18 GMT  
		Size: 498.9 KB (498913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbc76bd787ee8e40aac79a1643e38a56438b311e1229d2f58ca899d4518f59dd`  
		Last Modified: Fri, 19 Nov 2021 00:19:17 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ac70a7952a706f54c869e3aae0e84cc58eb00aa6abb968e7a0e412004d4d9e9`  
		Last Modified: Fri, 19 Nov 2021 00:19:23 GMT  
		Size: 20.8 MB (20801774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:6c243675c65d7db1da7d4514989500440c7ad6d96e68bf0360d1c3213f27bb68
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53796347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97436a800ff45b9c86183601c9a8c5fca575a06b2c4de27f48f9d5e1283c028b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 08:16:57 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Fri, 19 Nov 2021 08:17:00 GMT
ENV DRUPAL_VERSION=8.9.20
# Fri, 19 Nov 2021 08:17:03 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 08:19:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 08:19:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f31b93095928288827f76cac994da9f6ecd30d4e75092d690519370a6a7f2438`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ce5ad548fa1fb827b4c46974284946de74676dac994e944994902f1d7a7de93`  
		Last Modified: Fri, 19 Nov 2021 09:06:44 GMT  
		Size: 498.9 KB (498915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fba2efd03254b52ded6425b435d485de3f221742bf30074050f1690ffd7d6c4f`  
		Last Modified: Fri, 19 Nov 2021 09:06:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63bf4113d79ad81f9c3575a08c559019e0dabac17b1d6cbc2e6919f74a90af6`  
		Last Modified: Fri, 19 Nov 2021 09:08:35 GMT  
		Size: 20.8 MB (20800651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:4b3c716f768ff4c08ac17e8ad47fd7edf3d433b23635b3820aaabc51c9fce084
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51799922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec11c4b43f203f8f3b44a59ae9373c3ca62b644bc5e0fed7b3b4a8b51110a88d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Thu, 18 Nov 2021 23:56:24 GMT
ENV DRUPAL_VERSION=8.9.20
# Thu, 18 Nov 2021 23:56:24 GMT
WORKDIR /opt/drupal
# Thu, 18 Nov 2021 23:56:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 18 Nov 2021 23:57:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1251a4018ab28751b148de7a368addb7ba4bfdd6ae9e52b520f6e355ae2a0e85`  
		...
		Size: 498.9 KB (498914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c271a0f1702d991a3a8ecbb48e9431904fd32d3c1efd9ec0fd998eb2d7b30be4`  
		Last Modified: Fri, 19 Nov 2021 00:17:54 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df148dbde29d313f151fb37ef727c276c12795153acf66114433bddcb71c5b49`  
		Last Modified: Fri, 19 Nov 2021 00:17:58 GMT  
		Size: 20.8 MB (20800576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
