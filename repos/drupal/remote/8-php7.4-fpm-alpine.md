...
```console
$ docker pull drupal@sha256:20e95aca012a3e70a0e1c3ece8166eeaaa0cc0cb0fa3a8b9ccc652874a03de10
```
...
### `drupal:8-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:e908c8c49890cc9a83b494beb31e97c7383981a152deacfcba87849c76daa2cd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53145934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16fc287072dfc3d2cf92f722e63527b2fb1d5292b8a24d3466dcf99c98fae13b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:57:17 GMT
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Thu, 18 Nov 2021 23:57:20 GMT
ENV DRUPAL_VERSION=8.9.20
# Thu, 18 Nov 2021 23:57:21 GMT
WORKDIR /opt/drupal
# Thu, 18 Nov 2021 23:58:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 18 Nov 2021 23:58:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7f882cdfe2c79f3d5d972262ebd4b67ca3b2ddb624aec5de862df84e6e95745d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2797c79bbc532b6f8934eb9c5cc754fcfb05963cee4fe9a1d662d57e82932fb`  
		Last Modified: Fri, 19 Nov 2021 00:22:02 GMT  
		Size: 507.6 KB (507625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43bab2a17f94be32a17598af61501ba8c92b149fe9a1da7729bdfea7144243c5`  
		Last Modified: Fri, 19 Nov 2021 00:22:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70a545c1ef359f30d8acc6c7d397994975f8db3ee196039b949a0d2064574e35`  
		Last Modified: Fri, 19 Nov 2021 00:22:09 GMT  
		Size: 20.8 MB (20800272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
