...
```console
$ docker pull drupal@sha256:c7b24f9e3c923238e7b409648a575df93edaaf7c61a06d6e69fff619738e9abf
```
...
```console
$ docker pull drupal@sha256:872cdb96e79268961eaa53fdd04fb7a4a3dde6f00ed72c96c09cea15f9c811d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.2 MB (146210550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2f1eb0f838fbed2b0762d073118706c1fbd4155f2fa384fef3292a0bd840957`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Mar 2022 15:08:21 GMT
CMD ["php-fpm"]
# Wed, 02 Mar 2022 08:33:09 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 08:33:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Mar 2022 08:33:11 GMT
ENV DRUPAL_VERSION=7.88
# Wed, 02 Mar 2022 08:33:11 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Wed, 02 Mar 2022 08:33:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1bca44ce98470494158066304c574e7caa759027b3e28f2bf8f3fa736e027925`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea47d285b6bd6bc77d137e9a52f83b5b81f3aaf707bc5c69b9d87c561c4cbdda`  
		Last Modified: Wed, 02 Mar 2022 08:42:12 GMT  
		Size: 1.7 MB (1747706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8ff4403bd1a333eb2a0603ef39f75e51ef8080e59dec882c68120b7c40593b0`  
		Last Modified: Wed, 02 Mar 2022 08:42:11 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6d860cf39e3e35f82dec6cf815648474eadbd94c783e1339de8ed1897386f9d`  
		Last Modified: Wed, 02 Mar 2022 08:42:14 GMT  
		Size: 3.4 MB (3380481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f508b3eeaefbda27602c2ab7d11a4fb1060a1dc0e47febd2c2f81b7e0a604332
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.5 MB (145516887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5c9de607ce7f4d7d55cc36c23daace63a63da44997f7152fcfd73bfb1f451b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Mar 2022 14:29:53 GMT
CMD ["php-fpm"]
# Tue, 01 Mar 2022 22:16:45 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Mar 2022 22:16:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Mar 2022 22:24:06 GMT
ENV DRUPAL_VERSION=7.88
# Tue, 01 Mar 2022 22:24:06 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Tue, 01 Mar 2022 22:24:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b9d8211054df10319f6eec166b367f73e8cefea8cafaf5ec4fb0be8a0b86c67a`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cbb606f6c0757f40b34f1513c87349604ffda3883666f649dd33c553d36bcf2`  
		Last Modified: Tue, 01 Mar 2022 22:37:25 GMT  
		Size: 1.9 MB (1864182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a72d9bac20441fc673c7a0a7ed34f3083e4341beb5134f17b40529a45a86d1a`  
		Last Modified: Tue, 01 Mar 2022 22:37:24 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fcb71d9de357c606eceb92d9891a58e18ae4ac3ae60d29f0c918afe8a3aaf5b`  
		Last Modified: Tue, 01 Mar 2022 22:42:51 GMT  
		Size: 3.4 MB (3380480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
