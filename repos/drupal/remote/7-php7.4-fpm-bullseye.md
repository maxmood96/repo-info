...
```console
$ docker pull drupal@sha256:8155f82e08d1baf5ba1d054d53c1172ec1e7fbd3cd885cce4f804b0e4f1a45f3
```
...
```console
$ docker pull drupal@sha256:ecdee76db1e8c41f2ac95a1f2f7cccbbd70c2689bc490aaa52e4124911b44501
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.4 MB (164426710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb2b71dc0dd191cd2391f465a208a3ed7f613f8e038e113ebd84514f5c193836`
...
-	Layers:
	...
	-	`sha256:2f525c3d9868c023ea0e4d8ff411a52c8e2faf8822a7f4f892f860d34b1efc6c`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7abaff095085e7ee8c7cd11c8792db2b38b66477de54da4f8ac9dc1b40db7d4a`  
		Last Modified: Sat, 19 Mar 2022 17:37:48 GMT  
...
```console
$ docker pull drupal@sha256:77cda56e98f54a87502c2cfed05fef6c25eafdfa2cf0197575ca071e4bf04bae
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142813702 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:317307613b3765589e82e48193952b04014bd36b2200c80679b055877035b028`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Mar 2022 23:14:42 GMT
CMD ["php-fpm"]
# Fri, 18 Mar 2022 15:57:24 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Mar 2022 15:57:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Mar 2022 15:57:26 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 18 Mar 2022 15:57:27 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 18 Mar 2022 15:57:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1a5a7a5cc3d4ccc17bc6b744da7c43cbfbe329c69a3a9e78db7ae7dcc5c223e3`  
		...
		Size: 8.4 KB (8447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a437af8afc2258e90bfa735580b6f7ca85ca5fed8475a17638d116e11687973a`  
		Last Modified: Fri, 18 Mar 2022 16:06:05 GMT  
		Size: 1.7 MB (1747697 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c600211af56ec5ae079e629c7538ec5b4710aec982f13de00a663145602cce79`  
		Last Modified: Fri, 18 Mar 2022 16:06:04 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fe74441b05203b6e553683fc376fd088d0ab0602b9e4bfd995719555e7d5f5f`  
		Last Modified: Fri, 18 Mar 2022 16:06:06 GMT  
...
```console
$ docker pull drupal@sha256:c8889037987c508c416dc2a9923a354e184f855295bf1a9a736fbd538db5437e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135176276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d3dc76e4dd4b1f917080b45c4eac7cfafb3ec02e9406e76fae71e15f8e257a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 13:21:10 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 13:21:11 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 13:21:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f27ca9b5b26b383a7ec449447381231852c10f4d9865d193f599a573d4ff435b`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48dd0409538298ff5521688d4987abe237e1ffdff408dd27ebaf02501824991e`  
		Last Modified: Fri, 11 Mar 2022 15:51:19 GMT  
...
```console
$ docker pull drupal@sha256:68c82cb35de349b06528c65ddc7792bd7c0c84832ff3f9b1676df80985008056
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167128307 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac3cb803589c620d026c7b90fe758499bb128600e871e1e4111d7e673f0ab863`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Mar 2022 06:24:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 19 Mar 2022 06:34:32 GMT
ENV DRUPAL_VERSION=7.89
# Sat, 19 Mar 2022 06:34:32 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Sat, 19 Mar 2022 06:34:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c2496503b81f4bfa999c4a1c240f22629f029d972f8e8e0b9ab09e4df151af76`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0a4a7c9e5b4eab690c0978419b38f94e2349791d2bfff70a4b5c7fab6470734`  
		Last Modified: Sat, 19 Mar 2022 07:10:42 GMT  
		Size: 3.4 MB (3383152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8399597aa9f21b60fd2054199eb9b4946764af87696ea9a5edca2d6c83773e1b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141741352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b896448ed28e8a6e48503fcd576de489a08dc8b265c108a8e6ae7aa1e9deb227`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 19 Mar 2022 06:27:20 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 19 Mar 2022 06:27:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 19 Mar 2022 06:27:30 GMT
ENV DRUPAL_VERSION=7.89
# Sat, 19 Mar 2022 06:27:33 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Sat, 19 Mar 2022 06:27:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:347ef483a81b269b851f3435ff46edf13573189d1e59248e4599c50213159e38`  
		...
		Size: 8.4 KB (8449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee5b8d4fd90101a379ef9731567aa5baa8987c57407a380a88b94507c74e5a1e`  
		Last Modified: Sat, 19 Mar 2022 06:35:25 GMT  
		Size: 1.6 MB (1641982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37c78ed10d5a64fb0dd1ac6b6a1b3b689c60f97e4ad892c14c98334a7d65e08b`  
		Last Modified: Sat, 19 Mar 2022 06:35:24 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2008a47a8a2144c9b9c262e94283410c53cd37ffbb9199902888fc03c2cdc483`  
		Last Modified: Sat, 19 Mar 2022 06:35:27 GMT  
...
```console
$ docker pull drupal@sha256:fa7aa54a5bd09b3ac56076e5a81a1bf776fe535c16c1bf07e435c6af13a8da3e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.9 MB (164898475 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4aa8ce2cdc78b37c03ac789e53aa539f06895342189afc6c6e8ea8ccbc541f4c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 12:25:04 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 12:25:08 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 12:25:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f8d4d2798e90076f201b78afb1ebab4f6baec239c13b6ce04bb003fb25b5924f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db82d09233a9d92a91f7f5cbd2a95a1e02d0729cbc3702b718018cd86b2c4958`  
		Last Modified: Fri, 11 Mar 2022 14:04:28 GMT  
		Size: 3.4 MB (3383150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f137edd929ad5d8246b75b9880977de846e4db4a1976371854cb092fbd136b1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.1 MB (142073902 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:468789dc180336283f21352c6479bfaa862352e6b6467c5b9656857947748eef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Mar 2022 21:18:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Mar 2022 21:27:00 GMT
ENV DRUPAL_VERSION=7.89
# Thu, 17 Mar 2022 21:27:00 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Thu, 17 Mar 2022 21:27:01 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e92d3f36dcbfdc290eeabb159d4dc63912c250a3d11d5a0b23547bbfea14acd2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1746913eea06c9359868401e02cbe575c59da6beeb6f3d90b32d166f7711915a`  
		Last Modified: Thu, 17 Mar 2022 21:45:34 GMT  
		Size: 3.4 MB (3383152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
