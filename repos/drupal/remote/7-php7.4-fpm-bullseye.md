...
```console
$ docker pull drupal@sha256:19818bf9d72a45b40eb4a4723fbc46bd99deb558ac11e41e74a3f3907215ef45
```
...
```console
$ docker pull drupal@sha256:6a2dc70a0b3113e9a24eaed8866d7d59862ecf12d0e7ab0c0fdc60136c8fa608
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.4 MB (164422973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f74c3700ffaae0a56ade483a5febab16350f97a5563ebb80a92459427126fae`
...
-	Layers:
	...
	-	`sha256:e73b8580b2c3e8419d27c84c470cf05c586cd5b5802c23635569033d2fcace32`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf0da8a95b38f01922936288ac43f625a975c1f0d95e461870e0963c1f2eebe1`  
		Last Modified: Wed, 13 Jul 2022 02:18:38 GMT  
...
```console
$ docker pull drupal@sha256:6d5ccc8723745f206a7fd43f27ed18cff2c0ba299992f1bc586e4eb26079a3e8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142807222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acc029f4d4248effaa5bfea72efba45ab49feab94eaab90ca70e44041ba493bf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 13 Jul 2022 13:25:17 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 13:25:18 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 13:25:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ddd016b449790f986bcbe6d19f2c96a45e02ba52faf2acfeaba2697df695f4f2`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20d37fe47a3d9d226bd1ca0ea868ecb5207187f35dd1e2713a48449694ced329`  
		Last Modified: Wed, 13 Jul 2022 13:35:37 GMT  
...
```console
$ docker pull drupal@sha256:e09ed9c3d7685828ffd9ff252c051e28de477544d56266730127c7d478c47c88
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135183022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e47cab25a2efac82e3a74029e2df9017cf8494cf593d093ae47f8c9048304acf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:7bc48998cfe1b859e111ee3ae4b3d5c9d75d266969661914f7ce8a06bc9edbb4`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d0ae4e9a82c61465997308e95db38fad85fb6eb58b929ad3f31598ab0c8d312`  
		Last Modified: Wed, 13 Jul 2022 15:53:18 GMT  
...
```console
$ docker pull drupal@sha256:9d86c43c1a70f772f4d6dffcd9ea7adb0dfdf15c3a734bb29741da0a658af35b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157525532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70828d4fd167568c4a0d459548f2d7878256946b2d5aa37d93b51700a3c8be86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 16:01:50 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 16:01:51 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 16:01:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8983b0d8507c7070cb8114245152dd5ed64fb58a3b5a606721a0922226125d20`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a39e6042759d9d606e83b4cb5f4ba27753042ea689efb16e86db38b7f9489a42`  
		Last Modified: Tue, 12 Jul 2022 16:36:19 GMT  
...
```console
$ docker pull drupal@sha256:8c9f19b3b24c8ffc34573c671d7f5f12bd2e99867136e89791fa284058bf1c7b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.5 MB (166476778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ffa91e75015487129e0a5f9356dcc279f6a2a27b72b9006f82e7b2beb674e3c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 15:55:45 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 15:55:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2e7a487197acc82b5158bbdd006f6c755327624597bc859f837fc92427729dcc`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e87099d0003dfa01689261cb9ad33b142c4d913e1c8bac8d9d5c5dc5abfd43d`  
		Last Modified: Tue, 12 Jul 2022 16:30:19 GMT  
...
```console
$ docker pull drupal@sha256:7adca4008cc53476d7eca98b90379d35ed50dcc32fbf2e2c31a8a040ad031f34
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141944030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88b7343dc3eff733741e195ef28a2983c6471c89814b34dd0c09329bbe925a44`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 14 Jul 2022 04:14:51 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 14 Jul 2022 04:14:55 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 14 Jul 2022 04:15:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0993812d7f37c88d912b2d2533eb419921df441f4e43bc0e00eb73b83b706ae0`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d33b172c7ad8926aba4983e994ff8d015319e204cf135676d5458976d6e77dd2`  
		Last Modified: Thu, 14 Jul 2022 04:24:49 GMT  
		Size: 3.4 MB (3388282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:2217bfb149c4301b6ec21ca8612129a443bcf1edb61dcb2782d661709df7532c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.9 MB (164905895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7333a7d2bdc8ccf9318b0b21d1db3bb001ff3dfd933a97998b4dc98f90b0a8c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 09:06:32 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 09:06:36 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 09:06:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:00d23ede346c0856f99edb5248af4aee37b038a677176ebb4e6b261ada7f7c06`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:508bf33f481ef66ab2bd7f6524df8703d3085bd0f57ae1c810cb087df1c5325c`  
		Last Modified: Wed, 13 Jul 2022 10:34:29 GMT  
...
```console
$ docker pull drupal@sha256:617e7fe271f7c7e1ea7d344a49ad7072c9f31f84847f0b0e7919eceda4ea603f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.1 MB (142072556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ed4ac6c747a23c4896245d1f722314704b10e44e24da7ef0122b6f0cef694e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 20:23:22 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 20:23:23 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 20:23:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8db5fb3ebb866e4438c8d10efa142cbf74d8da60b037fd3dcd6b003d87fd1311`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ead682dcddfaf7bd9d343156eeeb4cedee0db9a80911577a49df99cfc26c9fa6`  
		Last Modified: Tue, 12 Jul 2022 21:04:25 GMT  
		Size: 3.4 MB (3388620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
