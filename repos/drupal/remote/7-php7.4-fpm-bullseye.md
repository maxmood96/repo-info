...
```console
$ docker pull drupal@sha256:be2c4e6960f8c7a0502b3b52ccd31e567c9fc45c6c5cf774ec29abfa3711ee13
```
...
```console
$ docker pull drupal@sha256:cc5ee1193f2f1d2fbf4bfe7e3c8c65c1c4af998630dab072aca893be6abd4113
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.4 MB (164438516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:caa3553aeb8309c59de39625ed3f8b3e0287f70100deb0a3580e36f56990a654`
...
-	Layers:
	...
	-	`sha256:261abf704d1009292087d236a6182bea80f7a2bf7bd4913f3d140f04df83113f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:428dbd6db013465f144755165b932b5def7fbaa13ad97694f299ac078cf25b40`  
		Last Modified: Tue, 23 Aug 2022 22:31:24 GMT  
...
```console
$ docker pull drupal@sha256:db53247f49f4469b4366227c5b5a4318282023574be677b45e89e083353599e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142818914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e3e4a3870a9200327b28f98d960abdd5960ed842337e5ba1287335d5af329bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f7e53ad6d2fb09f5200502f4f10b28b6ccd9b0bb01dac460760d2aba6b48fcc1`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfc8385105f388bac7c1effbee9d2c7dc2903cad00954e98c8bfa8b9e568851`  
		Last Modified: Tue, 23 Aug 2022 22:45:40 GMT  
		Size: 3.4 MB (3389343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d652542feff48d4d204887ce7c2ad6ee226b9de26d78e28f371293e233359ca0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135196965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58c8f0003ddf4e03f43192ddd86d9b9d1f614d4a9e639ee7d68bb556ca07ce18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 09:44:12 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 09:44:12 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 09:44:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:45e9fb0311a01c615a4f7a71d9c11019f5fe9496b25453e98e3f1315055379c0`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0506f309d0ce5ac7c96eae78de19457a98bdc3882d37e7a9a980f86c2532a171`  
		Last Modified: Tue, 23 Aug 2022 10:25:59 GMT  
...
```console
$ docker pull drupal@sha256:3507f37fba39f3d299fa25375d44a4a35b224bea9b5ff5fa4fe835dc833b9cc5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157332677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc5602ff15e18a9cc5786c33523e4bfafe40841c52d44931bbd4e22322e21cdf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 23:57:04 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 23:57:05 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
...
-	Layers:
	...
	-	`sha256:615163e4406ea5e2fdae08d5fc85cfb4956f22094153e68b900eb73198a0f9bc`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ed3357695ff934015b16b6f53861f0f5c06aa10728bea599826738741f41d74`  
		Last Modified: Wed, 24 Aug 2022 00:28:43 GMT  
...
```console
$ docker pull drupal@sha256:34013107910803e3239ac5e4f6e921da2238cc6ba03ca31bd204a28309ced44b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166288074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ace5f260a851507277a7321a4ffe05386d92f64fa62b6fef9e9091f732a98781`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 19:15:42 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 19:15:43 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 19:15:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cc69784d12cf02338c191aaf4acce910f4e47dc899193d100671d6ea46af3b73`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06767037d840d8568e506f4151e9d9ab1daf8a307d5aa1496d334d035824f7ae`  
		Last Modified: Tue, 23 Aug 2022 19:48:44 GMT  
...
```console
$ docker pull drupal@sha256:e937c2368b9cc326c9133dbaab96580aed6b61da3e225a63c0f021740e3a5832
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141752520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c117bb290881bb55576d1dc6bbddc09a4528dd1e9a4ade293dab1b4c3fdc04c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 23:17:55 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 23:17:59 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 23:18:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:98460418ad8032812718745deebdad81c989b673728f3d14bfe8b0920202181f`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93b4ef239b21f18731c7f7060c99097088b0575b253c0be8b3d62b5ba8cc5f59`  
		Last Modified: Tue, 23 Aug 2022 23:21:01 GMT  
		Size: 3.4 MB (3389055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:472c88ba763b6e5cb4031316cedc0c0862f240a21f9290b81ca43cb0ef072ebc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.9 MB (164924526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3cce85cfe01339e1b53ad84ace2f641b5f6c1e0199b906bcb76edb3b16c6a91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:982e1e68450e1f7e11951972924cf2cf4e67132fb1cb7224d71fc6429ca6d057`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2d846de688ddf18eaaf0c753cf45e5b058282a6838c88699004b92dc95e26cb`  
		Last Modified: Tue, 23 Aug 2022 17:41:22 GMT  
		Size: 3.4 MB (3389343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
