...
```console
$ docker pull drupal@sha256:db9ca2ffaffc3be5a77b011a9902b595e2f242729df2bdd839633f2ad3fab1a3
```
...
```console
$ docker pull drupal@sha256:589e1c5e883a12892bea6ba91af721d1d23bc3cbd3cb2dcc3aca8bb4191167c6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.4 MB (164427852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61e31bf6392f8a2f0f2520b37cfc5d992703ca87f3cfed2863d5f0fe5a706be1`
...
-	Layers:
	...
	-	`sha256:589643d434b05fa2a5f55da40e800c1536c6e695e0f542ae096f7bc939fe262c`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:910955b31f358fad480df3e48b58f84fd9966c048f3f73beac479a379f722965`  
		Last Modified: Thu, 12 May 2022 03:01:52 GMT  
...
```console
$ docker pull drupal@sha256:671865d7eaa2ccf8fbda9402b89b159c7690c07b16c567637f0f8b87e23f1fb3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142815861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00551a5479460653dc78c7bd2b74803a391393a8f53039854bbafff83e2d5a63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 11 May 2022 12:17:28 GMT
CMD ["php-fpm"]
# Thu, 12 May 2022 08:34:56 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 08:34:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 May 2022 08:34:58 GMT
ENV DRUPAL_VERSION=7.89
# Thu, 12 May 2022 08:34:59 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Thu, 12 May 2022 08:35:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0763f16adb32092eb2ee475a37ff80d841c6e7fcd8795964027989e73bd6c3e9`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f532314968f110aeec0be2b8ea5e9e05e7cb79f26671f1948caf2d89ab097894`  
		Last Modified: Thu, 12 May 2022 08:43:11 GMT  
		Size: 1.7 MB (1747803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7de806408bb65384d3be077ffd4111a8ac0d91b4917e389550b195fc85e25e0`  
		Last Modified: Thu, 12 May 2022 08:43:10 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28656c32ceeb8e02a33e6414b64f307436959fa40ce7f29057031a93b2de236e`  
		Last Modified: Thu, 12 May 2022 08:43:14 GMT  
...
```console
$ docker pull drupal@sha256:f921cb53a7c950a83407db00aad59884ab1d68b27f64d39e0c3464ad771a3ab3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135189014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15b1841c8402b41683b95894a994e21e7aaf9dba7487b9d4fe1c2714e51f0653`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Apr 2022 15:55:35 GMT
CMD ["php-fpm"]
# Fri, 22 Apr 2022 14:36:28 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 14:36:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 22 Apr 2022 14:54:15 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 22 Apr 2022 14:54:16 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
...
-	Layers:
	...
	-	`sha256:27dc3430b30cd372ef450aa7f3ab3d7253584b913d293b0006e1c63f117a1986`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:140a26fe69e1f6d90398f64d3ca06e5bad93a8c5dede0d66ba6d17584d0a3b46`  
		Last Modified: Fri, 22 Apr 2022 15:26:34 GMT  
		Size: 1.6 MB (1619110 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0b21dd2005eac98560a4bdba85ff829a5a7da2ba9fd9bcf2f83d0d7cabee6c5`  
		Last Modified: Fri, 22 Apr 2022 15:26:33 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b32dac86eb797fe1f3300706c4c11a1fbe92463bfd61ed5c375d96609abce19a`  
		Last Modified: Fri, 22 Apr 2022 15:42:43 GMT  
...
```console
$ docker pull drupal@sha256:6492c981480e3d4b030158b93fe827f60cd4ed188997abbdd56a4a680a1d8e6d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157328184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ab16304f242891a339a9c2cffe5873ded95de5d464791aec6dbb5268c3d4cdf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 11 May 2022 21:36:07 GMT
ENV DRUPAL_VERSION=7.89
# Wed, 11 May 2022 21:36:08 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Wed, 11 May 2022 21:36:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:027d7c18ac3195b0edad8bc0e7f5da8e074eb1049794c5492bffd330cf328a1a`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3e114bac550a63f225c3a37e0f51d1481e2770cd14146f8cf2edbfeaf586ac2`  
		Last Modified: Wed, 11 May 2022 22:01:44 GMT  
...
```console
$ docker pull drupal@sha256:300721b589ba38a1dd231702734409ddad8ae0a6c218995ad7624fc39c77283e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166278735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67584749a391fb8ae40c41820b79baa9e3b2239527ed125750919bcd21ef5a8e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 11 May 2022 18:44:38 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 11 May 2022 18:50:55 GMT
ENV DRUPAL_VERSION=7.89
# Wed, 11 May 2022 18:50:56 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Wed, 11 May 2022 18:50:58 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d818685818c2311f765fcef931dffb27cd35df691b0a3f689fdec1359192b1e7`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74f92214766d35a8a4001da451a1dfb75581abc77ac3244ad66c0e5285238682`  
		Last Modified: Wed, 11 May 2022 19:17:32 GMT  
...
```console
$ docker pull drupal@sha256:95c104d6a67b4e2115b3bdbfcf2b72f42a0e7317c51dcd3981253d58accc0fb5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141743566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:440664a269d6e7ce1066dbb641d2ac490cfe16cc386730d56c4c7dfddcecef7c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 22 Apr 2022 09:47:53 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 09:47:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 22 Apr 2022 09:48:03 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 22 Apr 2022 09:48:06 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 22 Apr 2022 09:48:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:161a51a0efccfcc4b824cdbd72f016a3f947f6708fdcdfc707d166d52a5457db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc0125388b5aee1ddfcb771403e00b9b9ed7edd276ab24b108b898cf1d23c561`  
		Last Modified: Fri, 22 Apr 2022 09:56:15 GMT  
		Size: 1.6 MB (1641985 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34adc6933e898d5c6678039923249759460202f49300e518e3a2736eee2e381e`  
		Last Modified: Fri, 22 Apr 2022 09:56:14 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb7f07643c92c68b6be5b39481206334a6be45e36c6793ecfb29dda309594868`  
		Last Modified: Fri, 22 Apr 2022 09:56:17 GMT  
		Size: 3.4 MB (3382853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6c15797704fd1a66e2c8d1c2a1152eaf98ee11431ffe049c7b716c18ced5e1e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.9 MB (164912695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c2dd2eb0f192b050ac2ca7a8cc9d9a98a056d1b901d2ec9a2bbd24659111a41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 12 May 2022 14:19:13 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 12 May 2022 14:19:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 May 2022 14:35:44 GMT
ENV DRUPAL_VERSION=7.89
# Thu, 12 May 2022 14:35:48 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Thu, 12 May 2022 14:35:55 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9304fffb08cea1f1b3959b0d8e90c9facf5d9809667c295b75eed2b046aebc5f`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea7ce44e54c07e065c6d09b6e74183ea0bea69808952c6629157753f7fe5f20e`  
		Last Modified: Thu, 12 May 2022 15:17:41 GMT  
		Size: 2.2 MB (2150567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac112917359aae2495c8b91072ff33fcf474c3395a144f8f6470ccd37571126`  
		Last Modified: Thu, 12 May 2022 15:17:37 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9d5701b23919f106c3d058a8e564462f2dc7e5b52fddc10c0fccb58b90db9c5`  
		Last Modified: Thu, 12 May 2022 15:39:39 GMT  
		Size: 3.4 MB (3383152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5dce7464d8e8ba6170f2b0223b13697335f49300e9383624b3db9397e874bd2e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.1 MB (142078009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00ac28a196a4674521b21cc842f4232fca41091b1f651e76cbc9e9fa2d4c59ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 11 May 2022 18:04:23 GMT
ENV DRUPAL_VERSION=7.89
# Wed, 11 May 2022 18:04:24 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Wed, 11 May 2022 18:04:28 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f3d28d9d2f393af171d4bcbd2147357b56c72437e408c734de95c2cbc405052d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64b632faf3dfee32c50619a13d2ded298b5ed27d1f2d2576570fd390c5df7960`  
		Last Modified: Wed, 11 May 2022 18:26:37 GMT  
		Size: 3.4 MB (3383150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
