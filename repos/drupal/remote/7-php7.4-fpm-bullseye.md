...
```console
$ docker pull drupal@sha256:2d2302296942d552ec4a9a88794100c59b4cd1f1909fb6b1906a9a78c03338c4
```
...
```console
$ docker pull drupal@sha256:1de06437bb3febabb569f77b2543420304756200f236425ec72f54a972852961
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.4 MB (164416175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44cec7a37f4b12ec1ef12a202c22341e4a59af12aca2aa8dced7d4ca0f9240fe`
...
-	Layers:
	...
	-	`sha256:d1a04b6b316ca37928a146570a480fd40e45818c819740bdac2abea4ec6f91d0`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c8e3a8b04e882a7df1b9fcefe8efcd745a2e3c85be02f811e147ded1095b03b`  
		Last Modified: Fri, 11 Mar 2022 12:43:41 GMT  
...
```console
$ docker pull drupal@sha256:5cf20a33685612cbd74bc00840528bd2b8d42ca445afe0828ff098bba212c3d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167119199 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aef543f962f3cf7054a70329ec62c786898463e82b5fe228bbda26cd35eacd4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 15:02:46 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 15:02:46 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 15:02:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b662bcffec426d9da342ad37800f1c37ed2e3d095a17cddbf6df7e2d1d93b523`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4fe81552d2cd2375cfb0f0f7224d2053af93189175b5eb2ec14cd12ccf7a7ad`  
		Last Modified: Fri, 11 Mar 2022 15:37:34 GMT  
...
```console
$ docker pull drupal@sha256:1bac7a4facb8f1bb4c23513bf1144a6bfc1e1a18762d03bd00cdfda0a34b858c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141939428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:500638e22a97d84a82535bd351940cb59f6cd181c87d17541b47d82ed5e5b0b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Mar 2022 13:26:37 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 13:26:44 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 13:26:47 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 13:26:50 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 13:27:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:86fb95d2cd2f5d4669ee9e6680b189f460577107f7600292b729c2b7f7048d6b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db984122ccb56c1c5cfbb94e1415148e02553726f59f190ad0ca1b23b75019fa`  
		Last Modified: Fri, 11 Mar 2022 13:34:42 GMT  
		Size: 1.6 MB (1641932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f612aa0bd069e51eb6e92e3147b9754b00f3c72f265b352a63029847ec79b917`  
		Last Modified: Fri, 11 Mar 2022 13:34:41 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dee56b8868090c941a141f0e0ff3d82aae248c8d81907560fc993f0c3cda126`  
		Last Modified: Fri, 11 Mar 2022 13:34:44 GMT  
		Size: 3.4 MB (3382854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
