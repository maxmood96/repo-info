...
```console
$ docker pull drupal@sha256:456d7d144c60f756164f3c45d9dd0cb04f96021364a1670ddf67885235cf1d8e
```
...
```console
$ docker pull drupal@sha256:47694b829b2ab8affe8a6d0c1b96eb4d829d063789ca09f44e075f0cfd76f43b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135186038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad67da199345e8794c3a443daf2b60d906fba926b22081fbd49eb4b8d700d120`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 19 Mar 2022 22:29:44 GMT
ENV DRUPAL_VERSION=7.89
# Sat, 19 Mar 2022 22:29:45 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Sat, 19 Mar 2022 22:29:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d98034ee5a0537c1dc791d3c8c84934354ce543ad5d714a5fe93db125ddb895a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb1a479414f2a7f9abd8ba9263396a2c0121453670a61d6c2cede1ade9a463cc`  
		Last Modified: Sat, 19 Mar 2022 23:19:52 GMT  
		Size: 3.4 MB (3383154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:93a566116f54b07abc3486119df57510cde26733f7323bea4d37821a115e9b43
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166271025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a6885069391095096d5a8c39659c59362f8348481ad1b27247e9c77456bed94`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:cfdc5cd7f0d3de9e6f608099dacbbecead7a571e7294dbcd6e44ef02d7094253`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db7dba24ed8b9061ae99b0b44987e134807822ae57f3dd472981d0cd366de17c`  
		Last Modified: Thu, 24 Mar 2022 09:31:41 GMT  
		Size: 3.4 MB (3382854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
