...
```console
$ docker pull drupal@sha256:5b1c069cec5f9fdedfab472301c1b394c51544ca096a50029b56443ac3ef2622
```
...
```console
$ docker pull drupal@sha256:a3a96d24bb2f53b75728978e97f0840e7829ee1555daa155a44f4772775679e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50464461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:196626f45b08b8f85710e0b16cc70977eeae966224342d2bbc5ddd009f45d82a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:06:10 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:08:52 GMT
ENV DRUPAL_VERSION=9.4.4
# Thu, 04 Aug 2022 09:08:52 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:09:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:09:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:66afdf51161f576648797d8142bcd68fcc2e2a241732e5c93d3c3ef321e60f9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8caad0fd1be41c9580a377c170692260d66c5657e748e97761060f3e4885ae50`  
		Last Modified: Thu, 04 Aug 2022 09:56:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e40a3fdd86338d2ebbcedd14decd0e8f47c3f176ab60a04dff6f195506db80`  
		Last Modified: Thu, 04 Aug 2022 09:56:51 GMT  
		Size: 21.8 MB (21758259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:141e862cc283d3e2905553b5b6823c3c3ba545cd6d7e3613798913b3b402fbff
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53788913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6d1d14e9760be35be0b7bd739ccf7ef0b0f3ecfc738f016ba71391466f089e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:10:03 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:10:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:10:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:38ce0bf9118617b16320a8495762ab57116f110c8c4cf0effbbd7d0e1cc2f6e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6476382bcf635d00f546f2bd1cac7ea106600d2343747d8064fbe2328082f602`  
		Last Modified: Wed, 03 Aug 2022 13:08:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c8a3e4eb9d7a034683e821508a009377455dc7e20f3a18a78e5252be3a5b1a8`  
		Last Modified: Wed, 03 Aug 2022 13:09:12 GMT  
		Size: 21.8 MB (21758105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
