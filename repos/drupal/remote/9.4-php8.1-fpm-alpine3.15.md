...
```console
$ docker pull drupal@sha256:cd2cdf6ed4f694199ca2e2001fc92dec80d866be05a4e6f2704ef7a5642c9431
```
...
```console
$ docker pull drupal@sha256:99c4f94b20d8a2bda590bd7230e6aba13a2d0b56516187e15f0b16b4594784d2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53499601 bytes)**  
...
# Mon, 25 Jul 2022 18:45:02 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 18:45:02 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 18:45:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 18:45:14 GMT
...
-	Layers:
	...
	-	`sha256:0866a868ce3e617305eabad0bbd3ab9d84cbca9d9b5055a9348a6b2f61269c12`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2df9f3bb4fb2b673db4ca46fcdb2a69ddf6754d6bff685b69623f0d0431bf107`  
		Last Modified: Mon, 25 Jul 2022 19:05:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaebc7fec52c3eda93a1de61f001c2dbc59ee8601549ba38636e6fb0347ab790`  
		Last Modified: Mon, 25 Jul 2022 19:05:55 GMT  
		Size: 21.8 MB (21757509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:df808b3f3e51fdba90787e7d99cf29d414a4aab0d2e35ff5d7703f1982654db7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51610338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fe303bf67ab077cbcd61fff3f6acb98a4913149cf7372467a1ac8e2520970f5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 25 Jul 2022 19:11:18 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:13:05 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:13:05 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:13:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:13:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a7a020080ac68a029746cc1981b3c94f186067961c9688998c950d98154f807a`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b9e4c1f9e5164fbe93ada7182632406e5f9421525cca8efa817aa53a9a1f152`  
		Last Modified: Mon, 25 Jul 2022 19:31:52 GMT  
		Size: 670.4 KB (670415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:facbed0595d42981b3a780ed788c85e3e595e29cb1616ee21a98bf2d1fcb40cb`  
		Last Modified: Mon, 25 Jul 2022 19:33:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6bd1edff9f10d16e30448fa94dcc1c69cb4cc5daa4c631e7969025c15d405cd`  
		Last Modified: Mon, 25 Jul 2022 19:34:28 GMT  
		Size: 21.8 MB (21757230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:0b4815d227b895165bae08f76672222aada7e98977123174d36bc9b2140cd3d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50449007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2cbbb1f08352fb933008396aa6a59e22be36a5833db4731597eeee436b6457e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:36:05 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:36:06 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:36:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:36:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c12731be7bff972f3b26f15b464bb0c9cb189c21021c186dff18efbe4cbadfb5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a762b1b29cf640a3f0a341119233477fd04b01fe27f8482561d707991733c262`  
		Last Modified: Mon, 25 Jul 2022 20:46:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60a568aeaf0c5d0826d7e86ee405e2e0de267daaa259b0cc7569fc74da373f86`  
		Last Modified: Mon, 25 Jul 2022 20:46:51 GMT  
		Size: 21.8 MB (21757447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:707286e213e2e05f1eaffed91956257db97f5db4112821b718dcddf8121b8e60
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53701229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ee4472cf3e1a157ec9c301fc84aea9093b8906780c342d0191e27b1c057e654`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:14b6826ac3c88dd1d5bc651829c16c4dfd5ad1d5bf0f919127104360077effa8`  
		...
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:729918d4ac249bf5b5a5dd1b1d3101425fecfc65051819d98aeefbbd6f902bb3`  
		Last Modified: Mon, 25 Jul 2022 19:40:49 GMT  
		Size: 21.8 MB (21758437 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:e5cc662b5db3d699317c2ca5e82a4387e32747df3923abd33b0511861f7c466e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.9 MB (53938743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39908f070dab4cb374f874e1e8c3eb5b8466e012ea16d93b01ead5bfd4e44ffd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:01:16 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:01:17 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:01:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:01:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4836f1782d20f7977c6dcc2fb4ab2abce109a2042edc6f65d7793d5cb8fc429e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43fd41a829496ae7cb20eb2f632ffce95ba5b2d5db1b49f67c1fe361e1e12ba2`  
		Last Modified: Mon, 25 Jul 2022 19:33:10 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63fc738456fd563dcd1924fb7d81acec6a8942108751825e7d32b1f29a0f51cb`  
		Last Modified: Mon, 25 Jul 2022 19:33:16 GMT  
		Size: 21.8 MB (21758388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:3dcecc2ddf1d527b240f7b3974aada3adfbf167d75e095db0fd55e76149b0623
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53770881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:644b6a98a9d8403d62f7c18e258c16798c75e7f00fb657cc4788abcc1bb6ea26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:51:44 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:51:48 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:52:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:52:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c54f704371cc190ae21b07648b1bf8ad3f6623d6f297646bc941bdbe4ee16c7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1652bb9be9534cee5b0283b8a26b8e75fad86ccc6244c73eef5934dd82c7b8b9`  
		Last Modified: Mon, 25 Jul 2022 21:24:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4fc6ba8d1cf58bb2cd24b4b302132b50f2daa4f6c5e10f6dc4ae2c117f58302`  
		Last Modified: Mon, 25 Jul 2022 21:26:11 GMT  
		Size: 21.8 MB (21757539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:1cb733f6b479bbf72d00cbf8507386c9510e61898d201eb05d48860c6ba3031d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52188174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:169401f77ad717283e90fb42fba16e8be068fe9b8e94c3450706709f8f27dda9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:08:59 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:09:00 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:09:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:20b59024c19f2050cc6a4b9769a02ff10c06ec4ee72563a8332448eed0ffbc0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba325d8c235bc521779cddfe66c9620843e5925aa135a4c25ed44ef1959e8522`  
		Last Modified: Mon, 25 Jul 2022 19:49:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7c3200cf8f6704d7d93aecfc70cc0dd47b1f69e058986dae670f67f5afd652a`  
		Last Modified: Mon, 25 Jul 2022 19:49:24 GMT  
		Size: 21.8 MB (21757754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
