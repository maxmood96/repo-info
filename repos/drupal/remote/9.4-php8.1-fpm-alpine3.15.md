...
```console
$ docker pull drupal@sha256:6aca6e2b0cfebd5f542b7754e0b8af7a40cfdb8aed27328f11c2ac1f2528594e
```
...
```console
$ docker pull drupal@sha256:f4ea99d6cef6a5f63754671a97b4105521ba4def77a0dcfb07e41325f8a0f78f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51609844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7364b9ee9e1e66164e5396e3327cf1f9c5c3f38331eaba8c3eade55fd5b48e60`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Jul 2022 07:45:13 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 07:46:25 GMT
ENV DRUPAL_VERSION=9.4.2
# Wed, 20 Jul 2022 07:46:25 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 07:46:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 07:46:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:708cf9a05432b3d1865e4c08384ef8a59f0d2e03c5a061b892de91050cc2f696`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63ab11e8746472d4450451ab06c891e4078e3a00eb4e04288f694e1a1db378fc`  
		Last Modified: Wed, 20 Jul 2022 08:05:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8007b9bb7d3dc060ec762a39c3966da4ed26d3c2f8bae0bf555c755c499ab24`  
		Last Modified: Wed, 20 Jul 2022 08:06:17 GMT  
		Size: 21.8 MB (21757105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:62bf6498e97e2679f744c0b4f6d5f479cc8869f5abe0140c09759e14cf6072b8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50448350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33ba889b616c35117f340c988f2584a05dde2c09e3b75259f34cf7ebacbf7372`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Jul 2022 11:23:36 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 11:26:03 GMT
ENV DRUPAL_VERSION=9.4.2
# Wed, 20 Jul 2022 11:26:04 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 11:26:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 11:26:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8dbd02db33ca79f9f55447d7915bf7aca7292b6d21059556da5b48cb285f2892`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bba7cfeda8d3dbff9b6f8a213e72ff7102f6d01f1a7543996ab5f7cfdf6f53f8`  
		Last Modified: Wed, 20 Jul 2022 12:10:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aecb46e197e8478daebb1ffb1005617c0219d6302feb66d730271221bf142eaa`  
		Last Modified: Wed, 20 Jul 2022 12:11:09 GMT  
		Size: 21.8 MB (21757157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d4a588f2f764d9449dde05d7d5c8d178b9f1ab9b6ff82ac9b1d630ac9c59f0b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53770235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0194ec9c5e1193d4f489b135ddc703e54c87fd1bc41de73239f5817e6106e3d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 07:27:39 GMT
ENV DRUPAL_VERSION=9.4.2
# Wed, 20 Jul 2022 07:27:43 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 07:28:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 07:28:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2e815b0660c11b7b3a6e7da3a3a2accda73a749289a833653974d915988f1223`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:483cff386bfbe5babe3ae910e574ffab6224674f54bffedcf1e8b953aa1c148c`  
		Last Modified: Wed, 20 Jul 2022 08:01:07 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4dff965d9fb51e945395efc916b73ce162aa8f94455fc139a647e82faa1edd6`  
		Last Modified: Wed, 20 Jul 2022 08:02:58 GMT  
		Size: 21.8 MB (21757265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:c9e57d1a3c84772848c81ad5e7a7f4ce78c49e73d987bcc954471166fae79f62
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52187424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b27f5590c53e760a822df04b4c2182f321e8d43f70eaa92fe45396b3971c5011`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 06:57:40 GMT
ENV DRUPAL_VERSION=9.4.2
# Wed, 20 Jul 2022 06:57:41 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 06:58:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b3eaf4da4e2a4afac7c94baf16984150944e20e6cc04db3ed3409e11c3fc4b43`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb36374155369c62157fde744a206c011bd26d41d4a1cac0dba21204a4e0680e`  
		Last Modified: Wed, 20 Jul 2022 07:29:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb61a179d9388a1416cb77211011523c99a8135dfeace36da6c808b877a22e85`  
		Last Modified: Wed, 20 Jul 2022 07:29:04 GMT  
		Size: 21.8 MB (21757368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
