...
```console
$ docker pull drupal@sha256:f1c63790452155b80fac4f18c81d798eb07dfc9aa6a02459e34edcf7651b04c2
```
...
```console
$ docker pull drupal@sha256:05f84ba586c25ed403be1c51fde6d715151105f2fce1efb8bfc8ad1563aa4eb6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (53987547 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a292ec5f5647b976fb9fa245dcf54cc8942df276f25c2cd8899c9089d75b56e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 17 Aug 2022 21:59:25 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 21:59:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 21:59:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3a197b66f25498cbed4a17a67171c880a374b7a9b12321ce6e886fff18ea3b4b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9949322ac02bc59f404b3d830df8a37676c54da471bb9a11bc5eea0c978ca941`  
		Last Modified: Wed, 17 Aug 2022 22:43:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:225241ed7aa7e3b4ce877ce165270827a08642f5d9a7975fb6e0e7c0a7f59ae9`  
		Last Modified: Wed, 17 Aug 2022 22:43:30 GMT  
		Size: 21.9 MB (21867167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php8.1-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:184ae113a3bddffcd2e3a3a2d5ebd5c942fe18f5a77103bb5564dfde941dd5d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52404342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:861598e767040d1e4c1a5f5e940682bf3355014d17954ca09cc28cbf837a586a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 10 Aug 2022 10:55:47 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 22 Aug 2022 19:02:54 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:06:03 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:06:03 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:06:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:06:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:87a97ccd079744df7081aa0b3a92642b8337e503a29abb988544ad1cf548cfc9`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e861796a1bd0a45d84f6b37467558dc259d3a42e91d6f9ac4f97f051661dfcb`  
		Last Modified: Mon, 22 Aug 2022 19:35:58 GMT  
		Size: 692.1 KB (692055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e47bac5270b90a68dbbfc6431862fb5c51ec1d180f10be748755a99c308d1e`  
		Last Modified: Mon, 22 Aug 2022 19:38:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d05ee9b5f2154034a7dd9218007f2b7dfb13db8e025ae3f7b2f58858c233584b`  
		Last Modified: Mon, 22 Aug 2022 19:38:10 GMT  
		Size: 21.9 MB (21866967 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
