...
```console
$ docker pull drupal@sha256:0b89e7a54316778be5ded08c7b77d465e633bed81145f3ae9f78e27a2d8cbd60
```
...
```console
$ docker pull drupal@sha256:a8c1db25cb9b96b84ad38e649f6ab0a4e456f62ba6cc381d684ff09870d69477
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50473826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f65e5532546a5d8c3af065faa324b7bd0dac9b0ea20e8b3e51bee83b863a5df5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 08 Aug 2023 06:13:02 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 08 Aug 2023 06:13:03 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 08 Aug 2023 06:13:03 GMT
WORKDIR /opt/drupal
# Tue, 08 Aug 2023 06:13:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Aug 2023 06:13:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d54eedf7ce2fc1f310e8b306736e667357f0a178f08c93c75162fcd36fb69e2b`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0b208f13ff21dd7c0ffbda171a97de05bc04ca139564dd123d3f29f654d60e0`  
		Last Modified: Tue, 08 Aug 2023 06:23:11 GMT  
		Size: 698.2 KB (698234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:432250fdbc976f2f69572527db7b7a3cc623633b08f0ed92ef52de9126fbcc77`  
		Last Modified: Tue, 08 Aug 2023 06:23:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa4ceff9c15cc837b4af5132202d94438cc1428df63fd24614962edbebb66248`  
		Last Modified: Tue, 08 Aug 2023 06:23:17 GMT  
