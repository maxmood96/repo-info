...
```console
$ docker pull drupal@sha256:cd0e5650c20f721a9c066b024a9c3106017ed2231b3d49fb76e200be29a364e5
```
...
```console
$ docker pull drupal@sha256:a5dec6f6e2e99394e488a302ebdfcb451f38027408ea70782575d03ff49cb4a0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51525140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10a3446fbb9bf7fb1445187dc3b090996f2ded143b176cd2e7ccb01822286107`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 03:12:02 GMT
WORKDIR /opt/drupal
# Tue, 14 Mar 2023 03:12:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 14 Mar 2023 03:12:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1d00bfca403c019cca95dd7f6ebcbdad794720a28394041a6b9c7f775e52f568`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc1f1efe75c20f86b914a3e0bb1022eefffca266cfe87e1f9b0c933d327fb69b`  
		Last Modified: Tue, 14 Mar 2023 03:20:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb7fc71b3de4459b1a55a30e2b09ab55688b611499f03961264cbe86c31e914f`  
		Last Modified: Tue, 14 Mar 2023 03:20:18 GMT  
		Size: 22.8 MB (22836925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
