...
```console
$ docker pull drupal@sha256:4a98d669ca81e66148af5c61e665c78664469881ff8e98d71507d62726a1308b
```
...
```console
$ docker pull drupal@sha256:c31a0a839c709a69421f613329bcbda2d2312ae60a9bcac695f62a4fada04727
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (150042319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cea4230dff6cfd716a17e150bdeb264f615aaa1a57648c781e2a50c471b3650`
...
-	Layers:
	...
	-	`sha256:b5ca503790f559df89a6b3909e9fa0bf08b280905f0371f1a0ab2e5d38721164`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb5bf2c2717e2390cc83f2d3fefba6b4b9a98c702483827da46fc3abb7bc5b7f`  
		Last Modified: Thu, 02 Mar 2023 01:12:49 GMT  
...
```console
$ docker pull drupal@sha256:a29a1c7cac04a66fda756d8bd919f22b7e5b0b1a2e20508588cf4a7f3eb9fd77
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.2 MB (125208583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7158b39556bbcdc514e0463f32bb125e64bc1aefee0002285e59f93f88c41d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:d6b5320276ddc28a6e4148364660c78a5483b5638675ce59af4d26791e16be2c`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d838ffa6ad58310c02e9f1138144e7e455cd2ab9e5527107858a35730616c923`  
		Last Modified: Wed, 15 Feb 2023 02:51:47 GMT  
...
```console
$ docker pull drupal@sha256:e15157dce3200006249b9dd35eac8c0d109cc7903e193dea3293449d187e701a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.5 MB (141523286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0e7a1dfb07be16230f8f1997e9035fa31a0ddbaa7993fb58d6919b5f9c51ba8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 18:27:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Mar 2023 18:32:21 GMT
ENV DRUPAL_VERSION=7.94
# Wed, 01 Mar 2023 18:32:21 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Wed, 01 Mar 2023 18:32:22 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:abc175b2864f68dc819af3aab9717ffaecd554c9ba6dfafff17cc8b54ce0b973`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:058b9d9ad81be91822776261de11a94b25cebd9afb995f136871804062120b2d`  
		Last Modified: Wed, 01 Mar 2023 18:49:50 GMT  
...
```console
$ docker pull drupal@sha256:a6dea4021d2604f9555b0b5c35e8e70bb8890bbb0cf7754aceaef40abebcfa3f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155308755 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fba44f5e3d09e917c7b9f9c4d901a377e888dc2120ff8e954868e71d83005e31`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 00:03:19 GMT
ENV DRUPAL_VERSION=7.94
# Wed, 15 Feb 2023 00:03:20 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Wed, 15 Feb 2023 00:03:22 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e023d62f2d71f2d8d7e7a02fab7f9b7e289faec3a1108ba0120d82cab53c7f31`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc43c0990bb5010a95d5ad6fcdb9265c45a45031855c3ee847b0af7a9eac9f1b`  
		Last Modified: Wed, 15 Feb 2023 00:33:37 GMT  
		Size: 3.4 MB (3402297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
