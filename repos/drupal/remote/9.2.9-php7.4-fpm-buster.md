...
```console
$ docker pull drupal@sha256:6c662b11694329c8db48b85f01a899c973aad936c62056f4566693651a4d6c3f
```
...
### `drupal:9.2.9-php7.4-fpm-buster` - linux; amd64
...
### `drupal:9.2.9-php7.4-fpm-buster` - linux; arm variant v7
