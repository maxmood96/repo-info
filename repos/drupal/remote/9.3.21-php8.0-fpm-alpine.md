...
```console
$ docker pull drupal@sha256:ed6e49a56c6c6027d608f39b5d68eee4170250bb42a87461627d1371133c894d
```
...
### `drupal:9.3.21-php8.0-fpm-alpine` - linux; amd64
...
### `drupal:9.3.21-php8.0-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:1d9969af50cd6d9bc51517f42371e130cde9d147523a95c54862ae4df6b91f01
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50299352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fcf4fd61499cff9589bc7dab19c4c796d55fb30adebf870129f74f83220ee4d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f02999662907cf21b7954e02b3d92c042b458385260fd7c3d3832e546a71c0f8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e460605e8bf5c5b284c58b4c92793de67597cdcbfc3e7299a7888dfff24a42f`  
		Last Modified: Fri, 02 Sep 2022 04:15:22 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7059622a3f9b67f1c1916758982d38d1b3db6ef21d892f6e5b8c737461a3530`  
		Last Modified: Fri, 02 Sep 2022 04:15:35 GMT  
		Size: 21.3 MB (21312539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.0-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:ddcd975b9cc968eab7399d907be52a0393046afe5cad8b51abd88c36cc0547be
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49138718 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:188c8ff0580fd0450c18c18436fe422c9a4cab0f61639ccb79f2c13e69e7b545`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Sep 2022 06:51:11 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 06:58:50 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 06:58:50 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 06:59:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Sep 2022 06:59:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b5780d8d7fd9a1992858a0d5d6e731aee22c7cb139898a81b4de15e89558425`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd53c7cf15e0809998fc6141e90eed70042557188ffe127077abb54fa6c78a3e`  
		Last Modified: Fri, 02 Sep 2022 07:37:43 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e810df688ccaa6db31c70d20fcc5dcba82fd754acb619a4480a3f7681a41c9f8`  
		Last Modified: Fri, 02 Sep 2022 07:37:57 GMT  
		Size: 21.3 MB (21312619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.0-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.21-php8.0-fpm-alpine` - linux; 386
...
### `drupal:9.3.21-php8.0-fpm-alpine` - linux; ppc64le
...
### `drupal:9.3.21-php8.0-fpm-alpine` - linux; s390x
