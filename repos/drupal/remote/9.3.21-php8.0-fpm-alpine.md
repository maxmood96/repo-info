...
```console
$ docker pull drupal@sha256:248c1379adc4672f08a1c80c6473bdb7b75e28ae1e72fcf55d3fe82c858bc5a2
```
...
```console
$ docker pull drupal@sha256:64b737e0654c73de23552c0cc2f8706916c24e45a147e5bd2869d71df94f982f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50782437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d212d80c9091274e830ec8f7297d788202df4596a16e544f35b29e178beddbf3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:14:38 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:14:39 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:14:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:14:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ae9ad708eafbc25a0f2ec04a84d8c4dce9a786d292fd0bb144c4750c7ac5829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a8795988112bd4038445584c96c680691de20cd448069943862e5a8276705fc`  
		Last Modified: Wed, 17 Aug 2022 23:51:52 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea9f5600692029c8ca78c892c0e75b13bf5b1b44d6a8b5456646ea5376f67ee6`  
		Last Modified: Wed, 17 Aug 2022 23:51:57 GMT  
		Size: 21.3 MB (21312152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
