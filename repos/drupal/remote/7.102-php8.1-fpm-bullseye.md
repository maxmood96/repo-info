...
### `drupal:7.102-php8.1-fpm-bullseye` - linux; amd64
...
### `drupal:7.102-php8.1-fpm-bullseye` - unknown; unknown
...
### `drupal:7.102-php8.1-fpm-bullseye` - linux; arm variant v7
...
### `drupal:7.102-php8.1-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:7.102-php8.1-fpm-bullseye` - linux; 386
