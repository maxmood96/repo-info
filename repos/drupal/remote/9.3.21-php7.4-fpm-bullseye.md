...
```console
$ docker pull drupal@sha256:5693e56861e979907a4288c0899af029944f32ff15a03c0b1469129bcfeabbdf
```
...
```console
$ docker pull drupal@sha256:003dde228ea12e11debc2a489f8f132df062705ce1d922639251bf7a3c0f3968
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.7 MB (160687505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cee57473a9e298f118df3a4fce73a7ab46f589ac52a3c31e435eb0d9cb0ab7c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 22 Aug 2022 19:10:17 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:19:07 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:19:08 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:19:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:19:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1dc6cec539345946a42fb7f2b2a1076fb5bd1cd86742314d7f365978a0c72e9c`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6395e4a715a07591d6ad28d230ae18f31de5219f8540a00a0787f804ff88734a`  
		Last Modified: Mon, 22 Aug 2022 19:42:28 GMT  
		Size: 692.1 KB (692053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97c88829f308504cd06db059d96a9117f689199d78e63da9ff5c29bc754bebc1`  
		Last Modified: Mon, 22 Aug 2022 19:47:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d36b39795b4ee56e0fd47e8ab6fcf8b45b2171dbcc7e353718f9ee5ce82e98b6`  
		Last Modified: Mon, 22 Aug 2022 19:47:57 GMT  
		Size: 21.3 MB (21312537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
