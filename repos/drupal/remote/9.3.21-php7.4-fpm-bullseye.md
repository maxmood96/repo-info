...
```console
$ docker pull drupal@sha256:524de23bce3ed218c324a2d4fc50bb213939de3af7b084f836f88b0b032e46f4
```
...
```console
$ docker pull drupal@sha256:85884a89a292c0e2ec1524665d341523c614f0835540ab3c745fe570fa5e2e28
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176141711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ea44612bdb69883745908e23e8b21e53c9f785aae5534ff914c97d19b57b056`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 06:14:01 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 17 Aug 2022 23:07:13 GMT
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:15:50 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:15:51 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:16:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:16:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8485e7bacad0eca5cef6324cb561e80e8ee2ac6b5cfd3b2526c5631b5ad41c96`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28968f14fc6a180b8c5799018da972e691cd17eab4ea7092cbafa3b9b5f15b33`  
		Last Modified: Wed, 17 Aug 2022 23:44:41 GMT  
		Size: 691.9 KB (691870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c13270556f3778f131a40fabb44a5a2b9c12c0a0ee8d45ad890be38640ef7b44`  
		Last Modified: Wed, 17 Aug 2022 23:53:29 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe36e35d89e8128b368bb0c5affdf452b09ebff47b7c0b8855a15af6ac8aa8a1`  
		Last Modified: Wed, 17 Aug 2022 23:53:34 GMT  
		Size: 21.3 MB (21312293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
