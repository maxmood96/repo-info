...
```console
$ docker pull drupal@sha256:539f71f4843d8ce32f2bfac8871a5719b130d8dec31e92c0f409457745164429
```
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; amd64
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - unknown; unknown
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; arm variant v6
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; 386
...
### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; ppc64le

```console
$ docker pull drupal@sha256:b12704f169301ed054ba8940eaee63deac6a8edc7733e0edc4b67169294607d0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.7 MB (57683544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c8835078fccb0453ded3205666d7114cba29b61fbd72a44aaa17fb7eabe086c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:12c5260fad2eb40ede72e4cf0ddcede691eb18795f8bc0ee810ab828f4d56fcd`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2d4051532dde1eb8f2f6a77c620b755d90e3f13774251f58b9ec8caf2c17ae4c`  
		Last Modified: Mon, 18 Nov 2024 23:47:47 GMT  
		Size: 21.1 MB (21123571 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.3.8-php8.2-fpm-alpine3.19` - unknown; unknown

```console
$ docker pull drupal@sha256:73e6a2a4ace8cd08415763834cfa48977ca35f8561956727f3675ccadec54839
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **382.3 KB (382256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:137272787b7ddbd7f2c7e8447b1664bda617e098f49346b63fd80a5cd00109ef`

```dockerfile
```

-	Layers:
	-	`sha256:4aa6d20df39efe07d33a6f0df9b144bda1b984385c5edb7295074fb221743a70`  
		Last Modified: Mon, 18 Nov 2024 23:47:44 GMT  
		Size: 349.1 KB (349147 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8f1a85460184bf3baf1b3228db887c60bbc7e126a4487e7f84c866cfacc9b54f`  
		Last Modified: Mon, 18 Nov 2024 23:47:44 GMT  
		Size: 33.1 KB (33109 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.3.8-php8.2-fpm-alpine3.19` - linux; s390x
