...
```console
$ docker pull drupal@sha256:e114958375b04b6ad0a06a0f18327bd8853094a2a7528531982e532b01514b69
```
...
```console
$ docker pull drupal@sha256:a2a34e78dc4a82deab2b09bbb5ba7a0e082d4d3293dfb11ec4760dd012314268
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.9 MB (133877905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45efb46aefa850ae63d72d159aee85da9dc8ce1eaa1bc055cbfcd721531eeb17`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 03:47:50 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 30 Jul 2021 03:47:51 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 30 Jul 2021 03:47:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d30a8bf9bc545464062effc9e8b0bb45bafc462546eba18dd1ca8a796549ae78`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14b17b6a8e9dab3dcfd0ffd27fb022164264a6c6e1f8f635e7a7bd48f0d8a126`  
		Last Modified: Fri, 30 Jul 2021 04:02:49 GMT  
		Size: 3.4 MB (3373707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
