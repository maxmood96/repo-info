...
```console
$ docker pull drupal@sha256:7b6c7dfd9ce2c25de793116fed35b696f84f7d4297d7ef8e0a1ed8c098d3a25e
```
...
```console
$ docker pull drupal@sha256:3898068cd30ea084ec9a11825652b85fc4b74ef9af1b07a317aba89ccb921986
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **126.6 MB (126575797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee897b4a5ac5510f549a35589cc6ebb522d7af42a5db7bcf6f60866cd2025c5f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 18 Nov 2021 23:52:47 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 23:52:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:52:49 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 18 Nov 2021 23:52:49 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 18 Nov 2021 23:52:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:105eac8ac59d97fc670617f2d0c83550f1e81659bf97161670b92ae95672ef91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:924487092a891e34782e526cd7261e274bf1734613ea0d71adb71cc463c16c82`  
		Last Modified: Thu, 18 Nov 2021 23:55:39 GMT  
		Size: 1.5 MB (1532809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82ff8804846009987246f75d05499c23dac4940140eac46ac12b5d21c7b61a20`  
		Last Modified: Thu, 18 Nov 2021 23:55:38 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e486f581d50d2817dbd869cc6d2a2c237a656d31f32d659818feb55d8d40b034`  
		Last Modified: Thu, 18 Nov 2021 23:55:42 GMT  
		Size: 3.4 MB (3373708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e2cd2ea90eb82570d5c4869eeea16f7a5a5a2f954a74b3977a1a6d5070cddc13
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.7 MB (139734715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0d3990e50a5df75422021738baae5f444d9068b078d57d22e4f9658f48d05a9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 00:00:32 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 00:00:33 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 00:00:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5f294f6bbf9c703fdd0dbb7da72c14ebaa4330522f626843b9e40a06d24a16d8`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e0070801a0c92205fa117b3c633066a9cac805161fa4fb638e2c12d76843fa4`  
...
```console
$ docker pull drupal@sha256:37345c1da54dea384fe90e896f46cbc597210ed71cf21643dfbfe191a1f01965
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.0 MB (154049383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21cacbe282dcd065e59b0b71273bfa742c8de804d0ab2b8aeeb1aca9512664dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:58:33 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 18 Nov 2021 23:58:33 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 18 Nov 2021 23:58:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e79176cc6d8d5e1c6717f8b82778c6025a1b8a9033a1261ce5b6bf8debadff73`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85abb11cfd996a459ffa10997e9b558d2e8c55f1942df981b7ae9331fbf604dd`  
		Last Modified: Fri, 19 Nov 2021 00:24:02 GMT  
		Size: 3.4 MB (3373708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a770585dd664a51c50bd84fc256309c4ab2d9f02d5863013c6b9e1e7e7110976
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.9 MB (130880175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:602ef24b4260ef397e3733c4a2cbf5c01e0c906741c24ee458de3fe8194efc78`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 19 Nov 2021 00:26:31 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 00:26:32 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 00:26:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b8f1ed66e774d3ca877d565e2620502fa8a64a04b08179c23853390b1b10aeaf`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0276732e0b1726fbf7f39774a91a3c877b4708bde9836349b6f17238cab134b8`  
		Last Modified: Fri, 19 Nov 2021 00:28:02 GMT  
		Size: 1.6 MB (1636809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d74b56bf16d0143a51373ce178d268ab5dc15a8ce035455d71bba79663e9e714`  
		Last Modified: Fri, 19 Nov 2021 00:28:01 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d89f04c9a28c6625a8d0d09219604a46e601d34d2c1af3dd7ab660620d604551`  
		Last Modified: Fri, 19 Nov 2021 00:28:04 GMT  
		Size: 3.4 MB (3373467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
