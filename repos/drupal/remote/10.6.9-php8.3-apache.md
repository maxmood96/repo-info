## `drupal:10.6.9-php8.3-apache`

```console
$ docker pull drupal@sha256:d81a2b6e36686976b048c824dcd7429c90903f35cbde74e2400e543fa7759565
```
...
### `drupal:10.6.9-php8.3-apache` - linux; amd64
...
### `drupal:10.6.9-php8.3-apache` - unknown; unknown
...
### `drupal:10.6.9-php8.3-apache` - linux; arm variant v7
...
### `drupal:10.6.9-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.6.9-php8.3-apache` - linux; 386
...
### `drupal:10.6.9-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.9-php8.3-apache` - linux; s390x
