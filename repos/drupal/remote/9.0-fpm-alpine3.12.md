...
```console
$ docker pull drupal@sha256:1689b08d7be75c0aab8813eb3a419c159f9e8ebc9705381cebc46e88bcfa8b89
```
...
```console
$ docker pull drupal@sha256:22ed3182ad6d835f5ef88964072c876cf2dbcd6c2a8a648063076fff5941d6e8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50883964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9f60ca90a52e9c38c38cb5fc29f877661c126a37a2e3bdd8801d85fe714973c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 23:22:58 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 23:23:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 23:23:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1d010afd3a813d13e666846ea10ca3b62defed5cdae27c226b58a5c30da8e1db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5e6e710c7b53a7f16d2eacc0ac881a7297bb0ab6b024a9dfa437396e8a07b81`  
		Last Modified: Thu, 21 Jan 2021 23:31:53 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba72353a961744d14cb0c901e0dde1706bf0b7caec850093f592afa8ef09244e`  
		Last Modified: Thu, 21 Jan 2021 23:32:01 GMT  
...
```console
$ docker pull drupal@sha256:8386e21d9fda41561efcb7ef54ac2464baa18dd9894a48ef8f2187612b0c9a5d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50093285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1e6a31ebbdaf8af49faef73ae9a7d4df83f0764d30dd8362f14ddb51101c699`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Jan 2021 23:04:45 GMT
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 23:04:46 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 23:04:47 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 23:05:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 23:05:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:412f70e82d9e06d58413b6828108c9a075de41e524196fd8dfef0c38b1ae64f1`  
		...
		Size: 508.4 KB (508386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd983ae900211618b21b088e9f0069f4b1dca4f241344ac6e73a3af3c2ef3ab2`  
		Last Modified: Thu, 21 Jan 2021 23:14:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2c6c30df192fc0b26f6ee55a8a2804cb0cd8cea989f1ef1b188252a3c862811`  
		Last Modified: Thu, 21 Jan 2021 23:14:14 GMT  
