...
```console
$ docker pull drupal@sha256:a90d9e209d7b78b2a11cdb86af5742aa8f69de9059a7c42ae24a08bc07682efc
```
...
### `drupal:7.98-apache` - linux; amd64
...
### `drupal:7.98-apache` - linux; arm variant v5
...
### `drupal:7.98-apache` - linux; arm variant v7
...
### `drupal:7.98-apache` - linux; arm64 variant v8
...
### `drupal:7.98-apache` - linux; 386

```console
$ docker pull drupal@sha256:e9888170aa0da3bc232630d3b36eea7583652cfcf1f6fcd6f6504be8b9393e1f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.8 MB (172756695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a00226bdc3c73df79dabbea981903fcfc107aa2709131cd1ac0b232769f810a7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Jun 2023 12:41:39 GMT
CMD ["apache2-foreground"]
# Tue, 13 Jun 2023 22:39:11 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Jun 2023 22:39:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Jun 2023 22:46:09 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 13 Jun 2023 22:46:10 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 13 Jun 2023 22:46:11 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9988c1ac7a16b9d33ea21a1d56730f95ac56851fc0038af7ca0218e5dc91474d`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1e3ee3fb52c8d5a1fff720f20486ec0cdba9be5d700802a5ae5ea6596ed8e66`  
		Last Modified: Tue, 13 Jun 2023 22:56:34 GMT  
		Size: 2.4 MB (2358923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe3195aa9bb3b2e25438d7ff6e1474aa2fdad17fcbcaee56201f869577efcca8`  
		Last Modified: Tue, 13 Jun 2023 22:56:33 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:930ef2c8e1c30745af6adc88ede9715c979f22770ccfd8126db6ee19e8e69e67`  
		Last Modified: Tue, 13 Jun 2023 23:01:43 GMT  
		Size: 3.4 MB (3410779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.98-apache` - linux; mips64le
...
### `drupal:7.98-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:d44ad9313108a1aca07071c4084ae750ac6c900bd5beda2ffab82b652f44d93a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.3 MB (170290889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a982e553bd5d0014cdf9bfd549a1518e26cea058802adf93f77f22248e4a424d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 13 Jun 2023 23:52:25 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Jun 2023 23:52:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Jun 2023 23:57:13 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 13 Jun 2023 23:57:13 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 13 Jun 2023 23:57:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4673c6617c25a68b07ed18c1a80eafda2349fde4684104e9cd27866cdf16864f`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acc08e6c549cfb8d4ed571e0d4e09916c8c97ab2892cf1373b890b2e3ee1faeb`  
		Last Modified: Wed, 14 Jun 2023 00:06:02 GMT  
		Size: 2.2 MB (2200168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:961c315a3a060c660a3ff6b34e895ae7417e8b60524590acf036f9a6c54b72b6`  
		Last Modified: Wed, 14 Jun 2023 00:06:01 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e89c46b94e60e0c8a033561b1e23e9d059c3130dd7f3a8f2cc0c88bffafd120a`  
		Last Modified: Wed, 14 Jun 2023 00:09:42 GMT  
		Size: 3.4 MB (3410777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.98-apache` - linux; s390x
