...
```console
$ docker pull drupal@sha256:8c9bc72801205db1f99770bf28651f53c8c6a902b58e16e98fcb1b1601ea763c
```
...
### `drupal:9.2.19-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.2.19-php8.0-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:9a9b41866d9f576d569ccdd68f5366c9383bb92b68067bbad63be769819e43a8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.0 MB (182032462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef59f7e53c765877d209cd3f58f0c802c3d4aaa92dacc7128eb675b12d5ceaab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 23:13:48 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 23:13:51 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 23:14:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 23:14:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d8ebe5583144058518c31208580755f3aa5ebd1c63671c5906f33ed212b0b145`  
		...
		Size: 661.6 KB (661587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92497f5de37bb5a0776fd3bcc17120aee2eb313c660cf64435614ef2fe414ea8`  
		Last Modified: Fri, 13 May 2022 00:43:31 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41e7be87f15c47779fe2fccc69d940eb6542b953e632df3733dbc5e11d8fe542`  
		Last Modified: Fri, 13 May 2022 00:45:04 GMT  
		Size: 19.1 MB (19127620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
