...
### `drupal:11.0.0-apache-bullseye` - linux; amd64
...
### `drupal:11.0.0-apache-bullseye` - unknown; unknown
...
### `drupal:11.0.0-apache-bullseye` - linux; arm variant v7
...
### `drupal:11.0.0-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:11.0.0-apache-bullseye` - linux; 386
...
### `drupal:11.0.0-apache-bullseye` - linux; ppc64le
...
### `drupal:11.0.0-apache-bullseye` - linux; s390x
