...
```console
$ docker pull drupal@sha256:b06927a8480adedd6a107b65c4dac1989bc1420997f2b3b39127079f41350e3d
```
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; amd64
...
### `drupal:11.3.8-php8.5-apache-trixie` - unknown; unknown
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; arm variant v7
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; 386
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; ppc64le
...
### `drupal:11.3.8-php8.5-apache-trixie` - linux; s390x
