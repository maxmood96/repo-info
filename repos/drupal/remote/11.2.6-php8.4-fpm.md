...
```console
$ docker pull drupal@sha256:7273a1de64a6d2f43b44c6df4d1e40eaa2b5697c872d95728c1c0db47371a86d
```
...
### `drupal:11.2.6-php8.4-fpm` - linux; amd64
...
### `drupal:11.2.6-php8.4-fpm` - unknown; unknown
...
### `drupal:11.2.6-php8.4-fpm` - linux; arm variant v7
...
### `drupal:11.2.6-php8.4-fpm` - linux; arm64 variant v8
...
### `drupal:11.2.6-php8.4-fpm` - linux; 386
...
### `drupal:11.2.6-php8.4-fpm` - linux; ppc64le
...
### `drupal:11.2.6-php8.4-fpm` - linux; s390x
