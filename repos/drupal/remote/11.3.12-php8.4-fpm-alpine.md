...
```console
$ docker pull drupal@sha256:5a3b8ea3c1c30772e58cc67013c96ac71e41ddcc41d790a5a0bc4678938e8f49
```
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:11.3.12-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; 386
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.12-php8.4-fpm-alpine` - linux; s390x
