...
```console
$ docker pull drupal@sha256:500f3a431ee9e63835b073fc3ab1336ab1ae4e64bc72344f1de9ccc2c5d1b93b
```
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; arm variant v7
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; 386
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.2.16-php8.0-fpm-alpine3.15` - linux; s390x
