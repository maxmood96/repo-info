...
```console
$ docker pull drupal@sha256:a7042bdc2fb98508c05833f6d570bdd31c6dc09d764b9fe8bfc27f8c0a845fed
```
...
```console
$ docker pull drupal@sha256:9e80736e787a48e28597a221198200b2f8cc2203b00a7a60acd1473bc141188e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.1 MB (33144209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2479e4fcd87d084132c86c525a95bf4ecb94964fdbdc2912064dde7c9c1b5441`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 07 Jul 2022 23:37:40 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 07 Jul 2022 23:37:41 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 07 Jul 2022 23:37:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:346b0221c01b76466ff061e8e68bb200ff802e42fffc8ef5a2a070602fd87aeb`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00fb6c034d537bb8149f2a6aedf3b89bd3499beaf55aa3e0f85fb368a6b499bd`  
		Last Modified: Thu, 07 Jul 2022 23:52:51 GMT  
		Size: 3.4 MB (3388795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e277654e8fb42295620953db6f1f71f099805b27de6aafbedfa9ac5cc0f1fe95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (31973172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a957381141609b25480c8317993307d922f6601d4e17d480aac07ccb0daa1a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Jun 2022 00:12:17 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 14 Jun 2022 00:12:17 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 14 Jun 2022 00:12:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:135e869a13a8499b35fb974346bdc7268304f7f1f032b53198a2af2a925cabe5`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10c11da23db2e498bccd4d1b79474fd521b69b8ba1f36d6586fc817fda3d1810`  
		Last Modified: Tue, 14 Jun 2022 00:45:40 GMT  
		Size: 3.4 MB (3388793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:99f34cd47264662b479699f6c6fe5cdaf0d762a46d14c11049772b6baa3bae3a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34210709 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9f8a8bef1ba9669df62d75a7239d1a5a84a8208eeb27fc322f8b57a77aeebd4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 06:08:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Jun 2022 00:12:23 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 14 Jun 2022 00:12:24 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 14 Jun 2022 00:12:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b0e88ccae076b43aa0e4ec2b78844b8b0477970560caf699f1150e54d1734a02`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eeda1710d55c59d3237a3cae24acdb3f280adc6900deebd1e415e06162017fe`  
		Last Modified: Tue, 14 Jun 2022 00:28:14 GMT  
...
```console
$ docker pull drupal@sha256:6f360471298ab961d6efd58793c1a0c0a039ad0b3bdc1a4585671f0b6b694f05
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33753982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a5485702fad99a748e277b93e294a538fae2320b554c86048a61289af272ae6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 00:14:27 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 08 Jul 2022 00:14:28 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 08 Jul 2022 00:14:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8937401ca3b7e762a3747cd71b6d77f8045dedcda4db722eb104b68f0abd3f11`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ff5ab58c8165635c91542b3ea936623a4ceb2139523af6cb1efcb35b67416c5`  
		Last Modified: Fri, 08 Jul 2022 00:36:04 GMT  
