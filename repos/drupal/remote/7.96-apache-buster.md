...
```console
$ docker pull drupal@sha256:305f21c92a89b0db31537e99edf2cbc50461181329fb7757fad93cd719b92f2b
```
...
### `drupal:7.96-apache-buster` - linux; amd64
...
### `drupal:7.96-apache-buster` - linux; arm64 variant v8
