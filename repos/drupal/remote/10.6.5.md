...
```console
$ docker pull drupal@sha256:5f6f0c16cc51a3fd2d7d7bab81d1eeca4fda582aa04deccf26e3243746387cf4
```
...
### `drupal:10.6.5` - linux; arm variant v7
...
### `drupal:10.6.5` - linux; arm64 variant v8
...
### `drupal:10.6.5` - linux; ppc64le

```console
$ docker pull drupal@sha256:29fcc3d69ede2997c3e43cceb0dfd3c9ae5ce4b61306962bf110b36ea0271ba0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.4 MB (200390821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9cc696307838d255f5b1df3c219f284b3072733ef66864c7e74ec3eb05ad4ea2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:363635d0cc770c09f5387f76e9a3d691e14fbde1dc9a1b537267b4a2adea14eb`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c53dcfea72893bf6ebeb98d43ba9c948171ec98effaea85e2cd8b9e7726a7523`  
		Last Modified: Tue, 07 Apr 2026 10:30:38 GMT  
		Size: 21.9 MB (21879082 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.5` - unknown; unknown

```console
$ docker pull drupal@sha256:3bbea9fc25400e2c27de348b7b992ccb423382d42a9109621b23b6f3e7fe7799
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7377069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e9204cdb2dfda80815a442880937f783381edb0435ce3011033bfe275c792a0`

```dockerfile
```

-	Layers:
	-	`sha256:9e956e1c93c3f83483a441a8734d592061a2f4d17b87708cbc5a27b7cbdd5383`  
		Last Modified: Tue, 07 Apr 2026 10:30:38 GMT  
		Size: 7.3 MB (7332181 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5a57e30ad925db1825d133e148947218263f2807f68750a7214f72c6e964b9de`  
		Last Modified: Tue, 07 Apr 2026 10:30:37 GMT  
		Size: 44.9 KB (44888 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.5` - linux; riscv64
