...
```console
$ docker pull drupal@sha256:bfe3a1535fd61694b7349d57f505d624a1093d4069c3e8b761109dfd5af85bd3
```
...
```console
$ docker pull drupal@sha256:3692733bcf61fdd002189d878c214413862be470a010781a2e54d1890420474d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.9 MB (162916539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f595ec89c8e1707cf90fac880f069fc66efb4a957c18c0b56ea800a2882fce9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:56:24 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:56:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:56:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba8699f15ab804a2a915bca7d6836d29a9e1ddd6b20e3177d3d58d7e4dc20d09`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1a1ad7105998d3e8c28cc6399d2e2cd0f5669cb064cc67c2c09bbf2292b015e`  
		Last Modified: Fri, 23 Jun 2023 00:17:06 GMT  
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f75dba9ec7288dead8a1a52ccd1c135ac5a8a403a744eaa473f65fa66624182e`  
		Last Modified: Fri, 23 Jun 2023 00:17:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7ad53ff73c1f7296c651c6908e4fa5375e29d25df73055708ea7ef3c7e01e76`  
		Last Modified: Fri, 23 Jun 2023 00:17:10 GMT  
		Size: 22.9 MB (22878625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
