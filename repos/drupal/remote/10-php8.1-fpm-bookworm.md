...
```console
$ docker pull drupal@sha256:d3cca805f083e65afc1546561377400893019d77f06d1460f12a010ce54b78c5
```
...
```console
$ docker pull drupal@sha256:b9a2f57807bb31a595d2fef2ab0fe929a1fdcb23fba237115335737bac79062c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.3 MB (198347643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2772751d91f416938ab97d1bc0c41e92f53e3561569209f237e10a3b42d6a55a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 18:38:33 GMT
ENV DRUPAL_VERSION=10.1.4
# Fri, 06 Oct 2023 18:38:33 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:39:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:39:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:91a620efd7daf592f86f752685fa63c09964aa25f143f0570bbc0871cfaa0078`  
		...
		Size: 705.0 KB (705007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbb1de777c9e035b458da1fac8641fb8b619f542ef778da3e5253cf957e59a1e`  
		Last Modified: Fri, 06 Oct 2023 19:09:22 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff71bbe6ffccbccef323f02c04139f320ddf9a5cfed2afc8ab7bc1839d14c400`  
