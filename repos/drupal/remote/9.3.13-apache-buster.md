## `drupal:9.3.13-apache-buster`

```console
$ docker pull drupal@sha256:f01e7cd6881c794bbf913123096c32806d5dfff9bc18efca64feb51af466649a
```
...
### `drupal:9.3.13-apache-buster` - linux; amd64
...
### `drupal:9.3.13-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.3.13-apache-buster` - linux; 386
...
### `drupal:9.3.13-apache-buster` - linux; s390x
