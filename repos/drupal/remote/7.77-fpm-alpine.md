...
```console
$ docker pull drupal@sha256:cfd79965577278d85a560574a2490ec24e7a669a1ce4108558094a191829254d
```
...
```console
$ docker pull drupal@sha256:046f1771711a0b98d3152299a10fd565431dac9ea54577857faa00b2e1da8e59
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.2 MB (35189206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28ee33d35c339fa6bf6b32c0a5fbd057551eeb131cc2c3f800c97f6b1fb71362`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Dec 2020 09:08:17 GMT
ENV DRUPAL_VERSION=7.77
# Thu, 17 Dec 2020 09:08:18 GMT
ENV DRUPAL_MD5=3594011c69191ce8804f27c698d18b0e
# Thu, 17 Dec 2020 09:08:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cb971e3a533e9cc6542d3ff68a1d33e0a5930dd533490722f75d6779f47c99c0`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8ae27eab21bb19b976418650cd63de556915acd674c1400dc0559df2c6bbe73`  
		Last Modified: Thu, 17 Dec 2020 09:10:22 GMT  
...
```console
$ docker pull drupal@sha256:73a0d22c4eb84e49b9dfe5a4c6b64baba613f8b3118dc9864c99a17a1ad04b4c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.0 MB (33959686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:851e6a81e0cb99aa3e3ff708ac4a4ec8a99786ec371af580888d1b95acd30836`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Dec 2020 09:25:59 GMT
ENV DRUPAL_VERSION=7.77
# Thu, 17 Dec 2020 09:26:00 GMT
ENV DRUPAL_MD5=3594011c69191ce8804f27c698d18b0e
# Thu, 17 Dec 2020 09:26:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8f1dbf225fead41e350c52d9892707ce98881d4c3d495b385c53cabe33994b34`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70b0f302c453b22226157d6044182ba8159e055fc5e822cbf927a127c1ced8c4`  
		Last Modified: Thu, 17 Dec 2020 09:29:12 GMT  
...
```console
$ docker pull drupal@sha256:fe2a26ee0f3fbcf65a8d658ce425cc3360a50336bc5ee42e9394b8d962e715d0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.7 MB (35695378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68b9e9257029581e2e8551a448984a0b6d6f56921fabf6ba9a2c2df2b2131c2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c8be574a9932497428f66a2ebd2ba6ac6320cea1822e7dba79c09cffb684a8b2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c66067071764432e9c092009734c35fd86cb2cccdd369bb20410ce8b4cadb78b`  
		Last Modified: Thu, 17 Dec 2020 12:41:47 GMT  
		Size: 3.4 MB (3359584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
