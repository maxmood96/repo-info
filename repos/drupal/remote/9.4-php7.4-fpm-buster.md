...
```console
$ docker pull drupal@sha256:7be828dcb88841d02c0a3aa1604c0603ded1dacc3f7609e4cb6a296aea889e1f
```
...
```console
$ docker pull drupal@sha256:5f710832557520d56e24b4b2e30b114312a1f63b593a7a262984bcc2c1c93489
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.9 MB (163920299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a12ed57fda8ac6e6fc3cff86968df345b342dc43bdc6568877d9a29b85c0ab20`
...
-	Layers:
	...
	-	`sha256:ef7c2d598ee014f11db9bd289b4f1ee47258edd18089e3ddd944a08da89758bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aba3d27dfb7bee2c03da6a47d272404974d05f75def7fcea0b02d4e018cbde34`  
		Last Modified: Fri, 07 Oct 2022 07:26:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b2d266edf26349ca6eb24ae50feb0177729306042fd99be1647f28b9b636d40`  
		Last Modified: Fri, 07 Oct 2022 07:26:55 GMT  
		Size: 21.9 MB (21881098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d20fcf6674bc41b5e2dad12ac0995b3068676e0060f1bd048962802e688e09fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.2 MB (140213531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:785ebf4416da7be65f543d7b7d1aa4cf231de2349a1bb7b3337da2a1340fbca9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Oct 2022 18:31:47 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 06 Oct 2022 18:31:48 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 06 Oct 2022 18:31:48 GMT
WORKDIR /opt/drupal
# Thu, 06 Oct 2022 18:32:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Oct 2022 18:32:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a8f15bb28383ab8ecee59e4a04fcb9f18a66285d72a848ebe471d2e074f05f66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8528e44f7d366d79362b29891a995610bbe0c86df201326aed9ddd5c2d710a3b`  
		Last Modified: Thu, 06 Oct 2022 19:09:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:100bdd127ce2d8ebe155235bfd005d047483e6c468bf993e82aeb1dc3b5606e1`  
		Last Modified: Thu, 06 Oct 2022 19:09:20 GMT  
		Size: 21.9 MB (21880794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f382fabb12e3a8bb188ecc220c4eb9e78cf20387859a69b18954ff54fde2c30e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.1 MB (169066815 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cee9d98cc0635af3ce6e91d68ddb75a21c22c323a1d9f6baf95e1682297f387a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Oct 2022 03:03:32 GMT
ENV DRUPAL_VERSION=9.4.7
# Fri, 07 Oct 2022 03:03:33 GMT
WORKDIR /opt/drupal
# Fri, 07 Oct 2022 03:03:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 Oct 2022 03:03:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:754ab4929059e3b9f4780357fb81e86f7ca3325a6a6638025614138d80d885fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bf6591b65de77c65f5e3f1222a41bbaddfa4de8fd0a80eb97b7f8427c636a3c`  
		Last Modified: Fri, 07 Oct 2022 03:41:41 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:211494d459cbf8af159e52b62c5621237bac7467e4982872285a5b087d6bb974`  
		Last Modified: Fri, 07 Oct 2022 03:41:46 GMT  
