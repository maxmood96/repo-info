...
```console
$ docker pull drupal@sha256:da8cf61b1f411100634d2b6ae0eabe995f7c22e2235a66451a4a2fd589d29229
```
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; amd64
...
### `drupal:10.6.0-rc1-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; 386
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; ppc64le
...
### `drupal:10.6.0-rc1-fpm-alpine` - linux; riscv64

```console
$ docker pull drupal@sha256:75c025b98ab80a1c9d6f023567d74327cf51c9e0e735e15fc07168a9825871d2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.5 MB (59547125 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3bfb666ea35313bbcbff1b771bcea3e065c5187a9c3ab3f900e2f04aeca4022`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3fed8e664c87d218e1a3f5bb6c2b5e253037c9bcbc461a321f591b9d2390f424`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:018739d8e58368e4186839f065a4f48e9943e99b6a4c951e306b12d521d7cf88`  
		Last Modified: Fri, 05 Dec 2025 10:02:24 GMT  
		Size: 21.8 MB (21840233 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.0-rc1-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:454e8c5bb0ada0dc22dae3c0b957f9b755ef8b6d4611f0ab2bcfec1abe5443c3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **401.9 KB (401890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8f958227a57a20c40f16e0cf03dd1208a01b2dfbba8179315008af537ee0dae`

```dockerfile
```

-	Layers:
	-	`sha256:260f227b08851d480c711fc8abfc51854111f5781fdca88351d38121488c7c0b`  
		Last Modified: Fri, 05 Dec 2025 11:59:06 GMT  
		Size: 367.2 KB (367230 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:7e677078820fc9f283503989de5f2abbdc3dda3a292c5903a581bea31e15f384`  
		Last Modified: Fri, 05 Dec 2025 11:59:06 GMT  
		Size: 34.7 KB (34660 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.0-rc1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:6e1a2a3299565fa5afdc637697ca5456c3aa6547c8c368ea2697e7a89a0fd575
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.3 MB (60345256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6835584d8665f961e1f5ada14a73d8c37a3451585d379d5fb8eb337b57863caf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d360af0655756c8e0677158b5de22a6e277374490fe9e34f62c555a715f61042`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:750369a9432506de8202eaf6d9f2b0df31ab0e2bf1057bd8e725944abdc3bdfb`  
		Last Modified: Thu, 04 Dec 2025 23:53:58 GMT  
		Size: 21.8 MB (21840134 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.0-rc1-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:e90c8dedd440fe7d3467a97be5f4701ac2d8ecb2508e4bcf0bd2b52e8389ff1a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **401.8 KB (401754 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04c0ba3aa23a8e2b1d9c5e6eb1d4d3fc47507e526209f0df4984506ca33004ce`

```dockerfile
```

-	Layers:
	-	`sha256:64bbe8a49231b766cac448137c38344889347310c465876433629c74e21c66d8`  
		Last Modified: Fri, 05 Dec 2025 03:01:53 GMT  
		Size: 367.2 KB (367176 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:9942d443607edda4f4119e485dd5ab2c42951fb0355a178619dd50bbbb1636a9`  
		Last Modified: Fri, 05 Dec 2025 03:01:54 GMT  
