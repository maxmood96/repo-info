...
```console
$ docker pull drupal@sha256:b597edc8979df926ff8ced1993a464bc610ede8764040d3b13f2407271e0c74e
```
...
```console
$ docker pull drupal@sha256:d2a8793fdbaaf89b2c42e1f789720d469106cfc763545132fe8a1e75e23566a0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.1 MB (48090601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ec228ffa7b5ed011b970638e8170f419f519d5f02acb20d4b1e0de3af3054f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 28 Apr 2021 19:08:13 GMT
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Wed, 28 Apr 2021 19:08:14 GMT
ENV DRUPAL_VERSION=9.0.12
# Wed, 28 Apr 2021 19:08:15 GMT
WORKDIR /opt/drupal
# Wed, 28 Apr 2021 19:09:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Apr 2021 19:09:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b943334feb784693b74086b194b500135a286f8210ab1eb52b700692ddfe520b`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39a5f382ef34b32e106f33fe2157523c7b256382aa8dd639038fda85653a271b`  
		Last Modified: Wed, 28 Apr 2021 19:13:01 GMT  
		Size: 507.6 KB (507621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30dd073cab495660e964ce4a6b71db5a5f389eb91ddcbd05f67e300862e4a5c4`  
		Last Modified: Wed, 28 Apr 2021 19:13:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40948bb14b77cc206756119e5e32684b9bf958b132d7ff54fdfad55a9ad60eb4`  
		Last Modified: Wed, 28 Apr 2021 19:13:12 GMT  
		Size: 17.2 MB (17240959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9b2ac2d82356dfb0ccbce3e6ca00f89c4dbbb7310f9308ac90597147c7001d2b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50111619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5c17feb5d3b2dd53983b78913271e6d7cbe2671f3d67ec17f3e41a67164fe95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 28 Apr 2021 19:32:12 GMT
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Wed, 28 Apr 2021 19:32:13 GMT
ENV DRUPAL_VERSION=9.0.12
# Wed, 28 Apr 2021 19:32:13 GMT
WORKDIR /opt/drupal
# Wed, 28 Apr 2021 19:32:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Apr 2021 19:32:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a17b101a8c573a2c104c74d9fe55755566d327f0432fc370cd31463c94e43ab`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3e74e67c51d16fb94223b59b3c3a9cf018afbd0b06071b8ae5e8b3a5a782e85`  
		Last Modified: Wed, 28 Apr 2021 19:53:51 GMT  
		Size: 507.6 KB (507625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea384ad447c4ca49a4316f3207420b5ba64c0a6ed751a10769696640c1c1a5b6`  
		Last Modified: Wed, 28 Apr 2021 19:53:50 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2356cd671f34c30476286514f89cc7d1b27b002f2f2ba46fde9549f8a7c2a702`  
		Last Modified: Wed, 28 Apr 2021 19:54:07 GMT  
