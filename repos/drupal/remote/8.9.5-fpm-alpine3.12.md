...
```console
$ docker pull drupal@sha256:aeae7d795ba225989aa784ba62b1905902b8665a8bbdab9c478cfe259c148ac2
```
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; amd64
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; 386
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; ppc64le
...
### `drupal:8.9.5-fpm-alpine3.12` - linux; s390x
