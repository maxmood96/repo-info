...
```console
$ docker pull drupal@sha256:408ac5c745e7b091228cb643293083b53d3a64b6955afde30c0be9feee6f92e9
```
...
### `drupal:9.3.8-php8.0-apache` - linux; amd64
...
### `drupal:9.3.8-php8.0-apache` - linux; 386
...
### `drupal:9.3.8-php8.0-apache` - linux; s390x
