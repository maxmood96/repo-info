...
```console
$ docker pull drupal@sha256:60b73978ceee8d4f9886710670b554bdc163c234f87adfce80ff7d3fe9adedd6
```
...
```console
$ docker pull drupal@sha256:fdae4d877efa01fa3b47fd156edd340d94df3a20e37fc23a9ad2d16daf94086b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162538745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e170b9c58e9ed976769ae3092a25a417874b25447ac0800d2161a65aecfe70d`
...
# Thu, 03 Jun 2021 23:08:56 GMT
ENV DRUPAL_VERSION=9.0.14
# Thu, 03 Jun 2021 23:08:56 GMT
WORKDIR /opt/drupal
# Thu, 03 Jun 2021 23:09:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Jun 2021 23:09:32 GMT
...
-	Layers:
	...
	-	`sha256:f33c9e8ae0752227b87f1800b1bbeded432475fb9d76bb1ecd9d03cd9673f118`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff93332647323bec0da8e1f71c7be1e878e487dd48bbc301f2b72e019398421d`  
		Last Modified: Thu, 03 Jun 2021 23:18:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:904048bf72649a0c7d04192442dcedc18f8b293268266d750121847fefadc6a1`  
		Last Modified: Thu, 03 Jun 2021 23:18:46 GMT  
		Size: 17.3 MB (17273992 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:45501a2f2b5abea5147c1ec5a121bf466e55bb63482b51116d69ab8f32a0643d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.4 MB (138366416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee36c2ef632c62d04cba1527cc753a5b09142e3f1599722ae6d61a8fe1521420`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Thu, 27 May 2021 07:22:39 GMT
ENV DRUPAL_VERSION=9.0.14
# Thu, 27 May 2021 07:22:39 GMT
WORKDIR /opt/drupal
# Thu, 27 May 2021 07:24:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 27 May 2021 07:24:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cd89dddf7f5377a00adad35d94c6382f0ab7901cce34ff715bb1803a88389f27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c00895ae2b8c6425760a9bb1838890ab95838832ebc492bf0323de3c22f5588`  
		Last Modified: Thu, 27 May 2021 07:48:08 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08fbd833db5136395e7d27ac92c16c607b7b9ce341df3e8d4d75eb148808af90`  
		Last Modified: Thu, 27 May 2021 07:48:16 GMT  
		Size: 17.3 MB (17274078 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e80dc0af96c9528161e7c4969787cf1c30908e1dbf86ba9cb6bdddde0da3716b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154733108 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81a8c6369f45b733332f63e86784f24dc1084c420ccc2ce8da07c6cbca7c19e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 03:10:12 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 03:10:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 03:10:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f22a8f3d13d9e25a28d4a07da1272dac49cd9de2262e89f7e6049df9ae559194`  
		...
		Size: 507.6 KB (507624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0e301bb355aee32bdba2bb8a96c876eaf2c38d3143d0e6d7a2461f08fdeab06`  
		Last Modified: Fri, 04 Jun 2021 03:28:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f2e47a463cdba01a3bb4d06fbed3a08df6df19559d9b3a35abb97b8c0d89df8`  
		Last Modified: Fri, 04 Jun 2021 03:28:29 GMT  
		Size: 17.3 MB (17274042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:9058180291daf93ddae7a9a84bc684fa2cbfeb1a34d5e5f5bb4583f2a670e9f7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168403574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1de4fb88b7161c892b0517cb0151df9f3973387dd0b88777b18363f7a2649656`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Jun 2021 23:24:49 GMT
ENV DRUPAL_VERSION=9.0.14
# Thu, 03 Jun 2021 23:24:50 GMT
WORKDIR /opt/drupal
# Thu, 03 Jun 2021 23:25:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Jun 2021 23:25:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e70ce63f76c38c8371214bd90813bc2d0faca550ad5ada4c59083426531372ad`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3434863e9285caf34c0de769e0983da9a645029bc9d795feb5a0a58f33fca2ea`  
		Last Modified: Thu, 03 Jun 2021 23:40:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2042eff3102c090bb0cc9e0ab8c049d6e00c180121f527edada5e11f8a7956e`  
		Last Modified: Thu, 03 Jun 2021 23:40:40 GMT  
		Size: 17.3 MB (17274087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:0440247e34158c85e41db1e760e879008f4c5157d7ef6c823e4bbfb00d6f335e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.5 MB (173482093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3edd6085166f44a1ae435fc54377337463aff9a7612c8596ef90ea3678a82cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 04 Jun 2021 01:36:33 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 01:36:38 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 01:38:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 01:38:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c8c81d4530b040d9195c6263e7e1e80afbbb4b68dbe1fe824715405f0d0e6bf`  
		...
		Size: 507.6 KB (507624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d77747b3613efb155a862961c6f87a0dcb53b291884b9d0e0f3c926d4ee50d0b`  
		Last Modified: Fri, 04 Jun 2021 02:04:53 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7c8535e26e163195923c95d66458b402912a1b15d073e155baa266534cd91ee`  
		Last Modified: Fri, 04 Jun 2021 02:07:20 GMT  
...
```console
$ docker pull drupal@sha256:9d2936f6a4877992fc449bb1d41334c2df94efec7205a4b60ef76fc6eec2c00a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.3 MB (148282311 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee1bbe192e08c4b199a55823c2ea066e0f85029f6a9457a3edc268a870cd7589`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 00:52:09 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 00:52:10 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 00:52:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:d386a428ed397c3ca75da2b7f0717438b4e0bb1acf38e1e36f156f0e5404faa4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9758411cc250662d62e89ec198a748970b41c1e85c66662e0b44078614119c09`  
		Last Modified: Fri, 04 Jun 2021 01:00:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89999c8a05f52a0c6c8a1dfe27928f7e62ed659cca011db53b521937cefca51d`  
		Last Modified: Fri, 04 Jun 2021 01:00:18 GMT  
		Size: 17.3 MB (17274048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
