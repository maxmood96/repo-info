...
```console
$ docker pull drupal@sha256:b33a13c76a6a1119469d88c7bb0576071675c9f25b44f1e917649bbdf45b9db5
```
...
```console
$ docker pull drupal@sha256:7d99a0126f0e3fa5cee0cb5121b03f539c3195b81d3e290620e046ce414469b1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.4 MB (138371527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ca5d65b4b046e46e667ee85aec15cf53afd98d4c2f9276fb4ea2d35829f593d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 07:18:56 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 07:18:57 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 07:19:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 07:19:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1ecb614d6d04cccac486fb23e8e673149e462d7fa947999567dcb6baead7895`  
		...
		Size: 507.6 KB (507622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3168cd8e1d7f2c309d1030e77260d4bca921a1d663eda7781a2668a9175c3c36`  
		Last Modified: Fri, 04 Jun 2021 07:42:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f2b596470aba0a5d53a5f12282c1a067af84d689724e3a96c7f308a512d86d0`  
		Last Modified: Fri, 04 Jun 2021 07:42:58 GMT  
		Size: 17.3 MB (17273903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d085a804d030d92244922072dd868b14787db7695fc0c7658daf1c7ee8620347
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.3 MB (148282768 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:982ed821d2bf655cb09e05aaab837e8f3f7faba2e9a4d00ddcaf9e8708200b93`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Wed, 23 Jun 2021 13:21:02 GMT
ENV DRUPAL_VERSION=9.0.14
# Wed, 23 Jun 2021 13:21:02 GMT
WORKDIR /opt/drupal
# Wed, 23 Jun 2021 13:21:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 23 Jun 2021 13:21:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6f80bf63a3ed7ab8498ec8f77f70dea16cdd744b7c7ebb9fd4f29e6ff00fd3a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:234114cb8e2a4b54aaa20c5c1560cecab83114e97f84653c506ebb979e68ebe7`  
		Last Modified: Wed, 23 Jun 2021 13:27:44 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:567e1b778b37921fe01ce4fb196cb1e80856f29087881ca7e42fd5e7d8af224a`  
		Last Modified: Wed, 23 Jun 2021 13:27:47 GMT  
		Size: 17.3 MB (17274022 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
