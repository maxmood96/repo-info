...
```console
$ docker pull drupal@sha256:c749650f53ddbe7e82f7181bb6abd671bc31204a3323608dddc4e81d28d02636
```
...
```console
$ docker pull drupal@sha256:bab5a53a9dd7bd0cc918c54ffcedbc006124f822073e55ee1db4f254f415420d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.7 MB (160726034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:add8df9b84250437acf6a931db66633e21f404de20eb500ead89459ec04e9a16`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 20:06:35 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 20:06:35 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 20:06:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 20:06:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fde7c69b38f0f455c182879bd3667dbd46f63694ee5a5595c42663bed2d187c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9061cdecb08cb9dea105d39339e3b4ef158a9ac664d9ec64abbe12ec58cc9aad`  
		Last Modified: Wed, 15 Feb 2023 20:27:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d3afe30c0353ed977e808d162c0836e3cfdc51fc2423335e64cc8864820f34e`  
		Last Modified: Wed, 15 Feb 2023 20:27:35 GMT  
