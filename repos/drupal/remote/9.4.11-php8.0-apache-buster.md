...
```console
$ docker pull drupal@sha256:5b47d6ba050ba8067473ac83643b83bdf3e8334a3a201bd52a445d49b503e8c8
```
...
```console
$ docker pull drupal@sha256:f8593ab5f69467024b1e91acbf4a785ede185cff687971ef54e5e4e0bea19095
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.4 MB (144415293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8dce435359cc9b6d050f283fd0b3f6c05394c3cbdc651c1bdf089c485b83b668`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 15 Feb 2023 02:06:47 GMT
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Wed, 15 Feb 2023 02:13:46 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 02:13:46 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 02:14:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 02:14:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:165faebf64664a2a2f41749c60e0471e284742992489b6865f2ea7b416ca5ba8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d90ecd972076be57731c15ccc6f274102cac26aa4a0d8654e98701254243deb4`  
		Last Modified: Wed, 15 Feb 2023 02:49:24 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd0d3cf0f2f9e526291ab34200e94dff839036a64c3b3975dca1af13174a61ce`  
