...
```console
$ docker pull drupal@sha256:c3aafd7ff18c577884d81a8e8c18742fe32f104e5660f6075bb9fa32999c1567
```
...
```console
$ docker pull drupal@sha256:bbfff47b500c6dd69679bc034cb9a1ee474f249a08669e67da27327772fd0938
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.2 MB (169248928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92f9132f61424fdc5c2b760149339dffae700ebac50c20cf1bd0d39ad05e155a`
...
# Thu, 02 Mar 2023 00:54:52 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 02 Mar 2023 00:54:52 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 00:55:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 00:55:04 GMT
...
-	Layers:
	...
	-	`sha256:9fc25ac6f95895002d53e7927910563167f5793053ed3fb02cd02a1f2740670a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8be269e9edf2bdd7965ef2d4790c59a49fbd721ec1cc7e55677b222f0e89e9cb`  
		Last Modified: Thu, 02 Mar 2023 01:11:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6622c61be1b1ec5e6f983edad46a9d2e062209933d52769353da812bad22e6a`  
		Last Modified: Thu, 02 Mar 2023 01:11:24 GMT  
		Size: 21.9 MB (21911928 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.11-php8.0-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:08c4151ebbf5fb2f422ba200164d1a83d63a9a43be79d915cd1b428d308560ac
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.4 MB (144415446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38009becccaef53338fde3fda55b3e3212d018a4bed09ff5672dc5cc2179390c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:24:35 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:24:35 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:24:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Feb 2023 23:25:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:200ae5112791711240ec17f30e74cf9c4e2241df1e4be6a2e13219f876863b0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c1cad9cfc183ed28605d1b48b74f0b0e297e68ba9e40417aef5905f97a19996`  
		Last Modified: Wed, 15 Feb 2023 23:59:40 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dae5821132a9154eaca4df117d9e7f12816dcd4f0a7c8b856e81512b19a2ad6`  
		Last Modified: Wed, 15 Feb 2023 23:59:49 GMT  
		Size: 21.9 MB (21911895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.11-php8.0-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5250ebc4733edbbdba2c7c102432b4ca63e44fe984a9adf027f90fbd00cead76
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.7 MB (160729890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56e36d14111fe55ab9797635269224a55393eda87b6b2d3e6d773d30a5c4aabc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 18:27:45 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 01 Mar 2023 18:31:25 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 01 Mar 2023 18:31:25 GMT
WORKDIR /opt/drupal
# Wed, 01 Mar 2023 18:31:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Mar 2023 18:31:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84d5d2f0263381d070683f8ae3c03b14be3805e136a689379c9d2a953240523f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ef6299e8e7d5c910ac82b9a8a1f46e2503145b176d6b934bbb4e70176f14f48`  
		Last Modified: Wed, 01 Mar 2023 18:48:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f9cc0aeffbf9ea1633afd84f7636b7f9c726d39dc8dee97f357c387f9b90e6a`  
		Last Modified: Wed, 01 Mar 2023 18:48:26 GMT  
...
```console
$ docker pull drupal@sha256:59c5af9aa6378f2021fd4b769201b9126d1d6ef0b06f1fe78b75d885fd4fc386
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.5 MB (174512299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56dcf355fa7372edd8f6fa8f253032ff80540d88baff6cf841697753a2befd8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 15 Feb 2023 00:01:51 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 00:01:52 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 00:02:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:06519d99e492e1a20604183bf220443cb750c44aa3c7fda7a9ff8d0b3b0beb40`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ab3174e2de79df5999faef561281f098003943f4e76587842af230e1f7bac52`  
		Last Modified: Wed, 15 Feb 2023 00:31:33 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:653c2b127067b35b0e53bf84ca0929f8eb0e1d400e4126bbecb89931488e0713`  
		Last Modified: Wed, 15 Feb 2023 00:31:38 GMT  
		Size: 21.9 MB (21910524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
