...
```console
$ docker pull drupal@sha256:b3efd28b92c4c65df5706e982e4ea7e816e264aa075247f7cd512de20442064f
```
...
```console
$ docker pull drupal@sha256:e14e59b5f8534d8a20429fb11bd80c7262e264017bd5fc0247f2f5b55db452ff
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.0 MB (193978220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edb08a29b15d256cf3160b990dd598cb2e874f17b54226c16a0e498832c7f0b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:0acf4de5ea3c84e0079d2babd6548e89cc3b31c0835daf1b2badb417b5b880a6`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0894fc9e0a44b9ed09ccf3e88f5ca50e6d26ea30092689f4140e5b119339033f`  
		Last Modified: Thu, 03 Apr 2025 17:28:13 GMT  
		Size: 21.5 MB (21487792 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.4.6-php8.4-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:bca707d864991cf233f9efd2d6545de6e2eabdc7fab69f80ddff7569e49b9544
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.4 MB (6393757 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc00811319043c6cae1f54649ae64beeb089c0a2b1b9d2ff3c2d191cad72c9d9`

```dockerfile
```

-	Layers:
	-	`sha256:6ef25a09ffe7aefe22d9d980f97288c934ce2798577ec743dfddaa0b4403b184`  
		Last Modified: Thu, 03 Apr 2025 17:28:12 GMT  
		Size: 6.4 MB (6361501 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:17a340cfa63afc6822afb38d0f721ac3903a04745a39ddd71c2ed1364bf4667c`  
		Last Modified: Thu, 03 Apr 2025 17:28:12 GMT  
...
```console
$ docker pull drupal@sha256:fec714cfb0ed1ac169294f6abf1cba035f12a62e8ff9847df5180ee757b2f235
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174712972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:838562e19b9fe8eb4a0f18cbcdf42ece62161b1446d081c127cac7d971321517`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:74a41d53990b278bc08fc274a17ade6263c3b4a8110ab90e0b7628e96f477d48`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:349d7b8e674d1e2eee73dc6257340b53709adf08bb7d831ae3438752fd5fb06f`  
		Last Modified: Thu, 03 Apr 2025 17:25:22 GMT  
		Size: 21.5 MB (21487757 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.4.6-php8.4-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:e4b81b0b9b88a0098925b775aaf5a8407df72759987cb02c07b23c0f5d7e2fb6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.2 MB (6206593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:612ad121237af76fcbe408878a495c808c90a4d278d987094512e236bd3d38ef`

```dockerfile
```

-	Layers:
	-	`sha256:5deb3fa91c9699ce671e657bb8ab6bbe207ccea5caec8c343305cd0341a7cbb7`  
		Last Modified: Thu, 03 Apr 2025 17:25:21 GMT  
		Size: 6.2 MB (6174521 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:f390252bfe1cc003c82c94f74875f80fd9262fb73a629857087a088dc4344a28`  
		Last Modified: Thu, 03 Apr 2025 17:25:21 GMT  
