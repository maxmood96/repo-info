...
### `drupal:7.100-php8.1-fpm-alpine3.18` - linux; amd64
...
### `drupal:7.100-php8.1-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:7.100-php8.1-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:7.100-php8.1-fpm-alpine3.18` - linux; s390x
