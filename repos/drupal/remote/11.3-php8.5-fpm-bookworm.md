...
```console
$ docker pull drupal@sha256:76fb4bfb95cb8eae9348017c6d1f56fd1335c4e42e7423a8a28c584c13e257dd
```
...
```console
$ docker pull drupal@sha256:753cf0749fe08e93bcdcbaf33a14887459e0a1eedf18ed1e11114c5f83781f7b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **205.4 MB (205374112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d24a9abbe9b7b9d6f87765b7d5b9e83ad2c8d2ff31b6994052e5d04ae24dc67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 03 Feb 2026 10:41:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Tue, 03 Feb 2026 10:41:32 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Tue, 03 Feb 2026 10:41:33 GMT
ENV DRUPAL_VERSION=11.3.2
# Tue, 03 Feb 2026 10:41:33 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Tue, 03 Feb 2026 10:41:33 GMT
WORKDIR /opt/drupal
# Tue, 03 Feb 2026 10:41:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Tue, 03 Feb 2026 10:41:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d0e0361842cffe83d7e310cc68fbb529bffafe9183aa2d19eadcb5efbf4a9242`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:80faae551f4d324460d758bddcef823cd2c8d0583df9e7df1d85b791178729e0`  
		Last Modified: Tue, 03 Feb 2026 10:42:42 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:514da147ed681d1a127f76e3c45c53d0b4ed20563ecfbc7484dac4a376dfc6fb`  
		Last Modified: Tue, 03 Feb 2026 10:42:42 GMT  
		Size: 777.5 KB (777546 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a1c113a30ebd62c4cecc876109efb90e957d20f67a484ff2c86c6fd937672b5`  
		Last Modified: Tue, 03 Feb 2026 10:42:42 GMT  
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:01fde5dcf4e50e27289e26f5831dd5e64d772bc78c28f2d7f00433216208097d`  
		Last Modified: Tue, 03 Feb 2026 10:42:44 GMT  
...
```console
$ docker pull drupal@sha256:7cb2c7056a93e68604630aa560b8b276398bafbb9570390b8996d61461bb76da
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.5 MB (6532104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d30b4c0ed09e17684a362cd0333a015c3584e43e4d74f64ba73f140838c46c95`

```dockerfile
```

-	Layers:
	-	`sha256:f7667744fbe421e6ae00fe8152f60b9fac8462e46c30211fe4d6bdf36af57ab6`  
		Last Modified: Tue, 03 Feb 2026 10:42:43 GMT  
		Size: 6.5 MB (6498504 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ebbc8fec2c3d9766de206b7585009944a2d96616d902c5f32d9f59dbe9f68a82`  
		Last Modified: Tue, 03 Feb 2026 10:42:42 GMT  
