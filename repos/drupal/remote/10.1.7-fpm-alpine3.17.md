...
```console
$ docker pull drupal@sha256:54d1d8ae294a4a22e6ecd381475de927c74b230387d4814ef0ae1c176a623d57
```
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; amd64
...
### `drupal:10.1.7-fpm-alpine3.17` - unknown; unknown
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:10.1.7-fpm-alpine3.17` - linux; s390x
