## `drupal:9.4.7-php8.0-apache-buster`

```console
$ docker pull drupal@sha256:e42bf651b811a92246491ffcb91ae50cdf65dca68bc8b690b1e023bc139f0c0a
```
...
### `drupal:9.4.7-php8.0-apache-buster` - linux; amd64
...
### `drupal:9.4.7-php8.0-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1c5f41836fa68d29dedf57bf4000827c779a153b74f898620762a12e083f50af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.5 MB (144493510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c48ac9dbd6367b8520b9187bebf393aae474ee75a1108eb7df595c8d63b250d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 21:52:58 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 29 Sep 2022 21:52:58 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 21:53:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 21:53:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bd408c017cab64704bd53bfa96a6fc6ba619355dd635bd2f587b94181b83c56`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c86d0d0957cb2b60f0503d120d9deea52721c51574bdbeeeac1eacd522f4a03f`  
		Last Modified: Thu, 29 Sep 2022 22:43:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6912e7849ca74ab969c669332c8f83a01f312af55f8959cb1d5f75ac7f27566`  
		Last Modified: Thu, 29 Sep 2022 22:44:11 GMT  
		Size: 21.9 MB (21893647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.7-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.4.7-php8.0-apache-buster` - linux; 386
