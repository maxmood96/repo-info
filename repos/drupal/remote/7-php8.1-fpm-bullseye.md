...
```console
$ docker pull drupal@sha256:acfb8b4b1b3455b5f65d1e0643c853ee62fd9c106d283661cd8de070dfdbd721
```
...
```console
$ docker pull drupal@sha256:26241ac0a52268c51308f4bd902d5c53e8b8bb239a5456dc04e8a7ebfaa12a07
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161262006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ab823d45fe25401c90807a886ce495a4c8b9b16ce09c09b47f29870f1029876`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 03:19:15 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 03:19:15 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 03:19:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:645f20e6912781aab2ec35cbd2d6ad4508a5a9271a3f0b9b339c19ca0b506d25`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20fca647c6a850d72c26d55413f254087f86d899048e3eb97588e62acae1cefb`  
...
```console
$ docker pull drupal@sha256:7ad1da41c757d1c392fcee4022f8dcb93a721441e54596714b802997bb959d8a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169635266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b8ee03b60ad3c9067140251d08a166b2f987f135943c54a6c66289f68504739`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jul 2023 02:00:45 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 11 Jul 2023 02:00:45 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 11 Jul 2023 02:00:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0b4f5309bf4fb79002d90c7276f96d44599c8f69a6bc5ca55471787676b42de9`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c71b2712af1db982ff0b7b42112c112ef2f27377b9c25be62b413a2a6f038a9`  
		Last Modified: Tue, 11 Jul 2023 02:25:06 GMT  
