...
```console
$ docker pull drupal@sha256:30637fde451245fb2b8a4e3b0063149e5e9fb05bc29c2b6c57f6c9a3fdfab654
```
...
```console
$ docker pull drupal@sha256:98fd0bb1f0833153cd51b8af86c38686c2eea402905a70156a1865c9252cc8cc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.6 MB (144596841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c9c351d8701a2ae02083d572e2dc5b34aba2b6314605eeae60005d48b9dd2ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Aug 2023 22:53:05 GMT
CMD ["php-fpm"]
# Sat, 05 Aug 2023 00:10:22 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 00:10:23 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Aug 2023 00:10:23 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 05 Aug 2023 00:10:23 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 05 Aug 2023 00:10:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4e8943db727cbfad591dae3d5923ff8e9414ddbcd5dbcb891ce8aa367c0bcee2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9de77dfd0b9942ab193d9388c315bb8ade95433a9e9c1f68d25ded48b14062d2`  
		Last Modified: Sat, 05 Aug 2023 00:11:42 GMT  
		Size: 1.6 MB (1600001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63807cc1ac85b400ee4f42ef39a8c6e18a623ed246641249d453ae37df06d17f`  
		Last Modified: Sat, 05 Aug 2023 00:11:42 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99811fa9b340383919854b7b85a6d40f0aab3398871b9710b24e22eec66cdf5b`  
		Last Modified: Sat, 05 Aug 2023 00:11:43 GMT  
...
```console
$ docker pull drupal@sha256:d8e4db723092c50d28c8144b6cdff55a5eab35e9a3295b5c25d292099e46a89d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143574810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e083891509e4965494b3d9ad524435a0a0bd775180f6f65ceef2c0df0f34595a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 29 Jul 2023 21:26:12 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 21:26:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 29 Jul 2023 21:26:22 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 29 Jul 2023 21:26:26 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 29 Jul 2023 21:26:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:90a7364ccb50b7cb32c00b33fd19fea920c145a2f6386c8ed0fe25fa0a2bdf8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e06ca0098863dc79d4c686a56d1d3a01ee8e332949a4a4258ba5f0fff7cbaa98`  
		Last Modified: Sat, 29 Jul 2023 21:36:12 GMT  
		Size: 1.5 MB (1483661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f19254ea7627fd84a449da62ffa01fc00c3bb5aaf77d4392af7ce2d27f791237`  
		Last Modified: Sat, 29 Jul 2023 21:36:11 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a10be1af760232e3f055aa4e4a98fa02c443068c2228c628f6b507f25be24927`  
		Last Modified: Sat, 29 Jul 2023 21:36:14 GMT  
