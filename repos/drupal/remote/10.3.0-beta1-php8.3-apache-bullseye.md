...
```console
$ docker pull drupal@sha256:cfb27fae3f6b6c0c1adf839e3f526c5e036460eb2c0535a9805ba19c977a50a0
```
...
### `drupal:10.3.0-beta1-php8.3-apache-bullseye` - linux; arm variant v7
...
### `drupal:10.3.0-beta1-php8.3-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:10.3.0-beta1-php8.3-apache-bullseye` - linux; ppc64le
