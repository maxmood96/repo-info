...
```console
$ docker pull drupal@sha256:3531bdec4895cc86188af795cb8daf88ff32d57728401da1a5332aaf757ed14a
```
...
```console
$ docker pull drupal@sha256:0cd9f178f14192711ae4486e3aa7122258237e04524146480713ef15c0e88a32
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141328533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:900662ff4b3cfe9e77bb489a8db23d12f92c7897557663ee05af923b06134118`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Dec 2021 02:22:38 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Fri, 17 Dec 2021 02:22:38 GMT
ENV DRUPAL_VERSION=9.3.0
# Fri, 17 Dec 2021 02:22:39 GMT
WORKDIR /opt/drupal
# Fri, 17 Dec 2021 02:23:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Dec 2021 02:23:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5e6959f4b100e9fd45ebd75f1bd95916181a08197adbe6c7147ae04acc8dcc85`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5987f79d9d35bc01b46d8541e82c6a5b35d4c5bf002af09b8f990e8ddca5f60c`  
		Last Modified: Fri, 17 Dec 2021 03:01:13 GMT  
		Size: 564.7 KB (564657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97fbbb66562d79163aa31f12354f31fc223f28c1efd1b9119ab76f63489bd1b1`  
		Last Modified: Fri, 17 Dec 2021 03:01:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edb816a02d83698602c7214db9cc6e7af49f53dd9df3f53ca0c65b1901ff51dc`  
		Last Modified: Fri, 17 Dec 2021 03:01:41 GMT  
		Size: 20.1 MB (20136532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:13e5cfe73639261c0fdfd3c3b1f7c410eed0cb15f1d0cb687189e70052e125ac
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.3 MB (151277738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b9082eb6cfb774252d8d5fddc1b43e4151d1091806bed20314816d3fb8cd38b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 21 Dec 2021 16:56:04 GMT
WORKDIR /opt/drupal
# Tue, 21 Dec 2021 16:56:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Dec 2021 16:56:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:78bea1cab637556d18b6bc7a9bc21e52abac052d57df36716cc45e76e471743a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5276d6195b5aeb3c20e9d6da31af2c87d73ab2f1a1e1823ab7d134acaad9c777`  
		Last Modified: Tue, 21 Dec 2021 17:11:33 GMT  
		Size: 564.7 KB (564653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82d89ffd0156fe7da21f7da0ca2da04ad6bbad2c82d3f16d7cadaf47adc586c3`  
		Last Modified: Tue, 21 Dec 2021 17:11:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67f168df5c5f5f8fd2727c92bc485a8ba369a421f93f02bace2322357d864877`  
		Last Modified: Tue, 21 Dec 2021 17:11:36 GMT  
		Size: 20.1 MB (20136544 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
