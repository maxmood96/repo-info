...
```console
$ docker pull drupal@sha256:e5287f84728853e4f0a7a44408201bc869d41d51e3e7a278f23ed915cebf04d6
```
...
```console
$ docker pull drupal@sha256:e3ca585bf7cd19619970b3c6d2d8fdcee24a70a771e4d0b5ef11380d3649c227
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165540608 bytes)**  
...
-	Layers:
	...
	-	`sha256:5ce68086afe7482f614570a71fc6e824dfa6cb856c57415fa351799b98206dcb`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16ddc2f4033614c5acfa5f32be2361f42b4aa661714d4f0b2adc2ce0ef1fc2a7`  
		Last Modified: Wed, 29 Dec 2021 20:00:40 GMT  
		Size: 573.5 KB (573472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a2d6d3fb9365b0c689b94fb9aa1dc620b16cb648813d8c462f98802a6b9c0cb`  
		Last Modified: Wed, 29 Dec 2021 20:00:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ec046872193c291a559e86721a02bd82feedc29e84e20e1ffdc0a009c31ff7a`  
		Last Modified: Wed, 29 Dec 2021 20:00:44 GMT  
		Size: 20.1 MB (20136852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9c8564d1f28f1fafbadf08156eb72f7f1ef07fb54f542db2767f55221acba3bc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141337833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79b1a3770912c14e617404eae64e0bda8466ec2742ee1289e52983803eff0bb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 20:05:38 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:05:39 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:05:39 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:06:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:06:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3fccc10c16f635da9d48f0ffcf76ba9af685aad550f3b981f96a3292bba8d686`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eb41fe62bbca31bbc5f900206928158d4624bd966029b8d6989e2248e547df1`  
		Last Modified: Wed, 29 Dec 2021 20:43:26 GMT  
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4af826575f64089263599c142b1bbfd6d880e67b4f2f11636ca0bba94f08a182`  
		Last Modified: Wed, 29 Dec 2021 20:43:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:471727d2e927e7ec2ddf9208a08bd551b22a1e7e5e0d836fa49991ba0c2c58f5`  
		Last Modified: Wed, 29 Dec 2021 20:43:54 GMT  
		Size: 20.1 MB (20137164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ec12df11f8f20cff6e039c6de1cc0a251bb8ac880feec95c4f2f70e6f0583525
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157072716 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d7206d5810c8126888e2a644b2946bcb06cd8e2448c93289515ab30fdba6740`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 29 Dec 2021 19:01:55 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:01:56 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:02:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:02:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:67c4d98ff32e16d0c808015114169cbcb07aa39267489cc8ab700d9bbbc07ff6`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c7e1ffb921b9d270787f6471810aa79a3931a1241b24847c3d2136ad205bf08`  
		Last Modified: Wed, 29 Dec 2021 19:21:38 GMT  
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1053a2c3a40ace119a4018486e7037407bb74bc6a72303954ec26e16557206a`  
		Last Modified: Wed, 29 Dec 2021 19:21:38 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2c3aff1d0868449e7ee1f0576107bc0f9feec952d88f7412bcef21dbffa92f4`  
		Last Modified: Wed, 29 Dec 2021 19:21:43 GMT  
		Size: 20.1 MB (20138080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:961f9b3a62f0c89efb08e7d4f4086806a4c158241543ce8a30520aab81456d21
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171386226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1ce298e787dc73055f5c647100d4f69a544fc20b6753c8846d3461bdedb766c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 29 Dec 2021 19:05:32 GMT
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:05:32 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:05:32 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:05:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:4d8e808c410c54cb7f106f3a45a70269ec30bc20587376b51e406d68e8c85d42`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:226bb778cb9a4d013f1dac4254947603017f1b9eac4fac02f04c06c7006526b3`  
		Last Modified: Wed, 29 Dec 2021 19:26:02 GMT  
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a19f53a4b1849bec5dd154ed398c6b5bf98e54388f89bd16b284aee9d9630fd7`  
		Last Modified: Wed, 29 Dec 2021 19:26:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c61f10d1a81b10f957f11c11198cdcddde4e461fc6728597f829165703fcb9ff`  
		Last Modified: Wed, 29 Dec 2021 19:26:17 GMT  
		Size: 20.1 MB (20136903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:12ae2a56515cf0ae097ae213ddb1126f6c4005302614855b74e774ddb01dec89
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.4 MB (176446997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16b492542ea5c7451117ea56ca48c8c94eb081c8a7c6c796a974f5fee1e49434`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:02:08 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:02:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:02:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3e342b4943513ddeed201bce87ebb66b47deb3e232632d164402ba8fec6f32e0`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f316f4c44d2accabbcf54096f74fc39696b89c1e7cc663a7dc6f23bc8e4ff42`  
		Last Modified: Wed, 29 Dec 2021 20:30:08 GMT  
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a79e36085384e50514397cf1129829038283e67d1d48569216a858a495c461b3`  
		Last Modified: Wed, 29 Dec 2021 20:30:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8d3d902a3aa61953560280b88b4da5a7cf97313cc2235ca53e03e7adb8d0e27`  
		Last Modified: Wed, 29 Dec 2021 20:30:42 GMT  
		Size: 20.1 MB (20137307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:e7240e60a20a6c97c4ed39ab4cb1fab05399daf157b65d9467cdb3ff4a798bda
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.3 MB (151287071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed045306ddabc99f56c7cacd2cce31d91863a64e736c65fc842c26e6281cdbea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 29 Dec 2021 19:02:20 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:02:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:02:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:78bea1cab637556d18b6bc7a9bc21e52abac052d57df36716cc45e76e471743a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2778fcc0efcdb20402de689ad4a1b754267740cc4b13ec53eb97cb6ec6ecf8cc`  
		Last Modified: Wed, 29 Dec 2021 19:20:12 GMT  
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b55529c9cadc28b1a2a857d71ba8845c90ffd36054f574afa88e651466fd0b5`  
		Last Modified: Wed, 29 Dec 2021 19:20:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d54f88d1ed89d4795a5b5f3834040625ebd860fc3e7ae44d3c43264d1413afeb`  
		Last Modified: Wed, 29 Dec 2021 19:20:16 GMT  
		Size: 20.1 MB (20137057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
