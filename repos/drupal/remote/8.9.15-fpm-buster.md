## `drupal:8.9.15-fpm-buster`

```console
$ docker pull drupal@sha256:fc5a3a9da017f6596d9b2eb3ece0f9396cc3fa0510249c655cbf6d0365a527f7
```
...
### `drupal:8.9.15-fpm-buster` - linux; amd64
...
### `drupal:8.9.15-fpm-buster` - linux; arm variant v7
...
### `drupal:8.9.15-fpm-buster` - linux; arm64 variant v8
...
### `drupal:8.9.15-fpm-buster` - linux; 386
...
### `drupal:8.9.15-fpm-buster` - linux; s390x
