...
```console
$ docker pull drupal@sha256:ef8b7a97f2e86c6bb71662843dbf922837750aaca98ed0c608ad2f2b0f5b2534
```
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; amd64
...
### `drupal:10.6.10-fpm-alpine3.24` - unknown; unknown
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; 386
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:10.6.10-fpm-alpine3.24` - linux; s390x
