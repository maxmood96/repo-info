...
```console
$ docker pull drupal@sha256:214ad35bf405d3e3015c3a8a67b2819b0ac81e2097301d15aecb34b8508c3475
```
...
```console
$ docker pull drupal@sha256:82c7c77ccb6254db16004072d327faebbde9b237f254165a6e59819ec247a26b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159710691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e72f1f63393d0c3b6c5a624806d2da11c87e92e0ce4b049f2e0fb80369c6730`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:268b6bca47012faa9ad8935d64484f3367c5ef3543a67d6374e0ee1fe0aed1cc`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ac3189d3d8f47574b00cbaa6cb76dc82d22b78872a799e45921cd86fda740f96`  
		Last Modified: Wed, 03 Jul 2024 01:55:51 GMT  
		Size: 19.0 MB (18959902 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:rc-php8.2-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:6288a1685196e1ee0d4d7b94c99e5ca68958ea7bbd4ad33e18a1e5817a405eb2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.1 MB (6128109 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59eb47e114015319bb107bb63af74d135e067041974f84a6c6871bb8269adb5b`

```dockerfile
```

-	Layers:
	-	`sha256:d0861f17fb4d1e6d344126b11d53d6dfb5c3fdad615855ad0a93f06df7aa4d0c`  
		Last Modified: Wed, 03 Jul 2024 01:55:48 GMT  
		Size: 6.1 MB (6092724 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:59f7bde8011dfd477dbf83e91f3230134fc69b1a9843679d3aa857da154b8011`  
		Last Modified: Wed, 03 Jul 2024 01:55:47 GMT  
...
```console
$ docker pull drupal@sha256:5794693efa1099d610c98447be88b20e2970aac6e69fe7853ecbdb5bdee1ef25
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168840898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:834eb5220d34f32ab560ac85b4de67d5e424aee2998234081af2ad921009099e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:148a9754305dccc878e32f7ffc2a187fe77d4a74b0038f74e8805f01dc07e868`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cff0954ae7ec5f02ea7bcc2837e313c470d4f8dbaa8f25993703c8d0ba00f335`  
		Last Modified: Tue, 02 Jul 2024 11:08:52 GMT  
		Size: 19.0 MB (18960523 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:rc-php8.2-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:fd2c924c134e4885c8f88d00a1d317b429377a5f6df2b827db50d52ca5586626
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.2 MB (6154278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864b4c9502b8983c9be217801f10eda476874083bb639a1629b4c011069a358c`

```dockerfile
```

-	Layers:
	-	`sha256:1832fc2c0d290e4399df51e8f6c6f4fd482cdebd44265afc646f9bbb31c2b7ec`  
		Last Modified: Tue, 02 Jul 2024 11:08:50 GMT  
		Size: 6.1 MB (6119075 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0d102bd5da946766db7a9660432d52cd4f355788c7545df0cfb52c44f153f9bf`  
		Last Modified: Tue, 02 Jul 2024 11:08:50 GMT  
		Size: 35.2 KB (35203 bytes)  
		MIME: application/vnd.in-toto+json
