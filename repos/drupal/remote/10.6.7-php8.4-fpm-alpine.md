...
```console
$ docker pull drupal@sha256:478a6661879f02e6cb13340826d38a838caeb2b352b009eddfddb13810e76bc3
```
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:10.6.7-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; 386
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:b0aba8363bea4f748380c77feee1adf60292a4009bffd1522977c73830088487
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.9 MB (61851396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8188471e722f1a03b3fde5fad68065fd9facd58bf57d815060fa9ce6042e37a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e6b5d2f0aaa932d74b59d4b16c2b5eebb24fef0bce3f6123065ff20e0de4a726`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1929f51ee6f503b504f20c668d6002b9d39f00edf010a1fc148c4084dbfe12f2`  
		Last Modified: Thu, 07 May 2026 19:14:02 GMT  
		Size: 21.9 MB (21864353 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.7-php8.4-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:d7b44a338c17c044b0f439c847935c132dc3b87ccb1998c19a6bd8502b70e9af
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.2 KB (400210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd74bef7db86415bec67a9a67328a2d367640ddc89b1675c0999ec5ce5187142`

```dockerfile
```

-	Layers:
	-	`sha256:474cbd2db63ddd5198af3a17c8275b1f590b6c93a7cf0e2d5ce671b09f10b702`  
		Last Modified: Thu, 07 May 2026 19:14:01 GMT  
		Size: 366.5 KB (366507 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:c9c2f8d931ba979ee540d768b68c2d471f56cd409fb4882b10c1d6553ee157ed`  
		Last Modified: Thu, 07 May 2026 19:14:01 GMT  
		Size: 33.7 KB (33703 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.7-php8.4-fpm-alpine` - linux; riscv64
...
### `drupal:10.6.7-php8.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:b26d54688e83584f4d4759966dddaa4a25043fa8cb8858ccd6e5a84d0c31e7b2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.6 MB (60581780 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:151737208876f247244e9307c6e67267e7e1bea6007de295d02b86a28b7435e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:4d94c2288433dc88ee80f07a73ac0b41d0ae3de2505bbcc03ece7823ca595ad4`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b7a50932775f0162174b5442dfdd9f96177b4d80a640fd171d771e2b86bc64e5`  
		Last Modified: Thu, 07 May 2026 19:39:52 GMT  
...
```console
$ docker pull drupal@sha256:ff62f09fcc5e9ca6d9c4f8f1b81cf5356bf1d1109f0ed88ac7e65b8495704b28
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **402.2 KB (402220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11fc75db36cbee9586a597ccd9a5e2ef93c9a7da912fd08563911f74cd5c82e4`

```dockerfile
```

-	Layers:
	-	`sha256:164ed37093e129b3fa3086fa4ccd70137ac4f2a40399a5bb43388ddd35405728`  
		Last Modified: Thu, 07 May 2026 19:39:52 GMT  
		Size: 366.4 KB (366425 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3cff86be6f39eb1ac72f7e26aad26ad8cb82853708ad3fa2a50f53addd7311fc`  
		Last Modified: Thu, 07 May 2026 19:39:52 GMT  
		Size: 35.8 KB (35795 bytes)  
		MIME: application/vnd.in-toto+json
