...
```console
$ docker pull drupal@sha256:1c7d93ebfb352a7638126027cbc3f2f32c004c7dc039b419fe27295287e02f52
```
...
```console
$ docker pull drupal@sha256:1f89bf093af2ed1ee50e9bf7150b10b04e6ed454840ac780285328be2b775e3d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.0 MB (170991741 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:017d7f0fc345cbc0e3ca489e6ab73e3a9b9170d4fa76f4e97190d6e1f5e5cfde`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:26:21 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:28:43 GMT
ENV DRUPAL_VERSION=9.4.12
# Fri, 24 Mar 2023 00:28:43 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:28:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:28:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a81926f7381ab55e9cf1f81796e37ee1715b86fc48387b8553821bb0e2532df`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51dd84a06b2731dfa279f749e95ecc7afd1b2afde7295e16bea1d85d9e2849dc`  
		Last Modified: Fri, 24 Mar 2023 00:42:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63f0975cdb20cb7be08d28f9a3348ae3d0e95547eb8b5c47256d06bf6695feaa`  
		Last Modified: Fri, 24 Mar 2023 00:42:50 GMT  
		Size: 21.9 MB (21911911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
