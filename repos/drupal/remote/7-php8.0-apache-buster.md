...
```console
$ docker pull drupal@sha256:987b05447e5f09cd95222f7b4eeb8eb0d18eba84dd2437a21e0eff74c1a9d6d7
```
...
```console
$ docker pull drupal@sha256:7a407b384228a89fdff305874ff59ba7733b3bbc2eb54e1a1d5439c9aec58552
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.3 MB (156304092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:539c473b9583a60ba9b08dbb7cbfde2db04ea4fabe0621a5c1c18497351e23c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:22:20 GMT
ENV DRUPAL_VERSION=7.92
# Sat, 01 Oct 2022 00:22:21 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Sat, 01 Oct 2022 00:22:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bb1820627a8955232e8c5b541eb3ebf519d282aaff3932cc0f57f6ca2637468a`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:beb0d05d74aefe1c2465d66646657dc1eb3da2739255449f58e0699e0b18f665`  
		Last Modified: Sat, 01 Oct 2022 00:46:29 GMT  
		Size: 3.4 MB (3396554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
