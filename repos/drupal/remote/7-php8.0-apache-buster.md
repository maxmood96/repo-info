...
```console
$ docker pull drupal@sha256:c4d500e01cb1ac7c9d4f746e9ddb7ccda04db14989c88c50f75226796a6e3a7d
```
...
```console
$ docker pull drupal@sha256:a87d4208dba318f9f32360ba7a146036cd1bb13c0d1efd01e6bcf887490484bb
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **125.3 MB (125271049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbee5cec3086bddb0b478ef0e016c1ec8e9f49a6c573b88b7c796117ab88cb27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 06:55:07 GMT
ENV DRUPAL_VERSION=7.92
# Tue, 29 Nov 2022 06:55:08 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Tue, 29 Nov 2022 06:55:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:89f9728d9cee8a47d315361b42101c5999c0127eccea57faf1a64181a0b47a4c`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d477832d6899047fedac44b582aabc98c67efdc619b5b3da1d934c6106e997f2`  
		Last Modified: Tue, 29 Nov 2022 07:33:01 GMT  
