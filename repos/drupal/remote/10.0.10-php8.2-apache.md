## `drupal:10.0.10-php8.2-apache`

```console
$ docker pull drupal@sha256:b000b71ae6420b4db281a34e74f8e365de6a4383a220ef655b893651c926d834
```
...
### `drupal:10.0.10-php8.2-apache` - linux; amd64
...
### `drupal:10.0.10-php8.2-apache` - linux; arm variant v7
...
### `drupal:10.0.10-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.0.10-php8.2-apache` - linux; 386
...
### `drupal:10.0.10-php8.2-apache` - linux; ppc64le
...
### `drupal:10.0.10-php8.2-apache` - linux; s390x
