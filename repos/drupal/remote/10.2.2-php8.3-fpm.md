...
```console
$ docker pull drupal@sha256:599df564e52e07a6808cd34aa2f4a5cf66c9a5e9301c54e21efd4abca8d44714
```
...
### `drupal:10.2.2-php8.3-fpm` - linux; amd64
...
### `drupal:10.2.2-php8.3-fpm` - unknown; unknown
...
### `drupal:10.2.2-php8.3-fpm` - linux; arm variant v7
...
### `drupal:10.2.2-php8.3-fpm` - linux; arm64 variant v8
...
### `drupal:10.2.2-php8.3-fpm` - linux; 386
...
### `drupal:10.2.2-php8.3-fpm` - linux; ppc64le
