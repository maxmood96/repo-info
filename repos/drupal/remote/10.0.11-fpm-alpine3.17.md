...
```console
$ docker pull drupal@sha256:eb3e875cd421de3e08381e4424ba1be2e98fe926cd46ae3e1034f1cd68b62d94
```
...
```console
$ docker pull drupal@sha256:a4f7b2b5a504f25f131982da27865aa036a524ded40c9867799e77cce2899adf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51917766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5738307181008e7f8c04637333870f0db2d0d4c8e9a58a367f46551206eefc4e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 08:11:40 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 08:11:40 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:11:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:11:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9177dad8b75e9b1d9d42359f6057caae8568196b9cb2f40426d4e8e3d378b301`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed73dd7628d10e808c92554c052e0aa9802251537bf03cb94d49b392f8c73fc1`  
		Last Modified: Sat, 30 Sep 2023 09:09:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60e01d4901ac8be280f5ec05fe6dc74089035631ea88769e2a98f08fc4497621`  
		Last Modified: Sat, 30 Sep 2023 09:09:28 GMT  
		Size: 17.7 MB (17690247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
