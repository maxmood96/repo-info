...
```console
$ docker pull drupal@sha256:6b2324e7dcf1785925c16cae76aefed760ad293c5c83ac81659cd0572d1a432b
```
...
```console
$ docker pull drupal@sha256:a62c5aa379244526f44f22c028a0f98d31396cea1e88461fc1403d20fed970ec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.6 MB (53571353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89783f8ea234b23003819f6c77e8900260b6247ee181b2ab97fce4fef038e061`
...
# Sat, 30 Sep 2023 05:23:57 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:23:57 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:24:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:24:09 GMT
...
-	Layers:
	...
	-	`sha256:6ef655214a752eb28e448d6ed55c1ea8d17a97492736060dd66804c31872d324`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5419b3696706378cbe9585405695d77b6c54da6fe090f16908dc6cd1c0168a31`  
		Last Modified: Sat, 30 Sep 2023 05:41:30 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10da11820808584f13717d7679cb70a788eb0f624e6abdb341fcffaffc53d12a`  
		Last Modified: Sat, 30 Sep 2023 05:41:34 GMT  
		Size: 17.7 MB (17690714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-fpm-alpine3.17` - linux; arm variant v6

```console
$ docker pull drupal@sha256:ea991907edf569e7a7fae6a4b4dcd1366e7b8de286cf1155c25e6ce34b25b671
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51230537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb17ac8ec710905a1f4c5d0ea8d29c6d5d8c9eb619846127863104eb3edeb722`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 02:57:51 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 03:00:48 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 03:00:49 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 03:01:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:a67b19a85e8c9e50080aba2316eb399cec4c63598874e1cc183c18a330e0b662`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:091fdb74541771f181d118ef80645f27bf170537cc2b8434fac07f5b9f970d2d`  
		Last Modified: Sat, 30 Sep 2023 03:07:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45d0d77ec1bbeae116cf4a7b4af6c761538c9fac650b1a37ff31b1ba37d3b609`  
		Last Modified: Sat, 30 Sep 2023 03:07:45 GMT  
		Size: 17.7 MB (17690447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-fpm-alpine3.17` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c2274e8465c4b00d6f9b5cb58077a760609310029e2238ba4ea89c0cfc04d8c3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49823305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6da388b143523f33a0f1dbdc494925d47df71300a853c4daf28daa902f7d2f60`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 05:08:01 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:14:21 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:14:21 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:14:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:011e2049825f1bfff91b74483c7a085e7e8b04ec0e363b9464723078a0a63f38`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60a8f500174739bfcab9f3ec4644e35d8a121a020117feb916b1320494babdcb`  
		Last Modified: Sat, 30 Sep 2023 05:33:56 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5de03c915c590d9b5473a3b0240b95d652a5cc3185a1b3e10dd5e2a7765aca9b`  
		Last Modified: Sat, 30 Sep 2023 05:34:10 GMT  
		Size: 17.7 MB (17690831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-fpm-alpine3.17` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:eb6f7c7f703a995c0cd4d9fc2425eb397df02ba9464d01c0134a66e60ae54ba4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53519048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8d438867cd4887b405b19fdbc037e7a3e31c3c7d47bb76128059561f1710a96`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 05:00:08 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:11:25 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 05:11:25 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:11:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:11:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d4f192bfad72d7745eaaaa07afbd545ef8b1eaa07770e951d9af4d5df35cbccf`  
		...
		Size: 704.9 KB (704938 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:306180a3f3127cde2faab779f70eed1dfa5a0325e4d67adda09644bc1f751361`  
		Last Modified: Sat, 30 Sep 2023 05:29:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90b361c48146f0d46087fe846d198719f90a5aaeebe568ab10cbb9c2b92c20b0`  
		Last Modified: Sat, 30 Sep 2023 05:29:48 GMT  
		Size: 17.7 MB (17690740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-fpm-alpine3.17` - linux; 386

```console
$ docker pull drupal@sha256:d2d8fc61fce215b2e488ee4aae998ab8ba86b8a7e3124e2fd4c216fec07e9a0c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54185077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c411045a66d78a14483b3ca8001dadd467d35f956f0c053d4a5e8c299ddd5ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 06:02:47 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 06:13:31 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 06:13:31 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 06:13:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 06:13:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d213ef5aa329f7c8779e8881f36a6d5e2ecb36d7579a7883c2deca89bb36b120`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a93e7d09482b7b0fcf60852ad33a2292a04710f735d3e08847d4d096b8e2193`  
		Last Modified: Sat, 30 Sep 2023 06:34:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b04f2db69a9e41a37ac2fdf89007f5ddb5f81ad895177a0410999afcbb66fe3`  
		Last Modified: Sat, 30 Sep 2023 06:34:32 GMT  
		Size: 17.7 MB (17690193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
