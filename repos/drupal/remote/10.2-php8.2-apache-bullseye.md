...
```console
$ docker pull drupal@sha256:da36997d85cf97e25a3f1750b64123a00e51e6b6b4737a00aa0b71b9dc4eb577
```
...
```console
$ docker pull drupal@sha256:336f545aaad9a9924ceafb54062001086e94a93c744f4638452e1d3067d3075d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182280690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f136eb8e2aa93995f8941658e2f9d342720ec528023259012beff3585d139070`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:e17e37d5d99634c351b87ffd55c03bbd0ebc48e19a7266d3ea3446eab2d29bbd`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:aab33679f72f4ccf40a04a3881e42f07a42dabf1022a65561f6861ced26db813`  
		Last Modified: Sat, 24 Aug 2024 00:47:26 GMT  
...
```console
$ docker pull drupal@sha256:85d70efa26f722e7f37c73965bb1aacba2cc076841edf01c319900c65343504b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7054420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5feb874cfbe488bad86daa66963ea8a44318046a212dbc38ee1a07c79e50cd4`

```dockerfile
```

-	Layers:
	-	`sha256:87b649115f5762d7d4a3b26d7bfddd28a383793dcaa243d69d054df824b7848d`  
		Last Modified: Sat, 24 Aug 2024 00:47:25 GMT  
		Size: 7.0 MB (7017720 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:328bff65708ddfacced24aa5268dc62f3604100e4edf45dcc18e91f34cc47849`  
		Last Modified: Sat, 24 Aug 2024 00:47:25 GMT  
