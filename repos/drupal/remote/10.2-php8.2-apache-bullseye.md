...
```console
$ docker pull drupal@sha256:ac676ce2bdf376b9066fded5356b573e9b83018a889833645d3abd2d9f58a1ef
```
...
```console
$ docker pull drupal@sha256:edc74ad5a1b5d4e46012e847f21142bac48545ceb7960ec26dd92b5a3d4c5277
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182276979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8df92a25f51ab55a583654d2cf0e1014e6f30e11cb32969d50801dfb7494446`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:dbb4592ca5c67c7404572323ab6c719f1af9332aea67a2eeddf99790fcfbf28a`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bd6f73010176b53e9889acb1950a15a1b358abbff4ab5775032058d5294af477`  
		Last Modified: Fri, 02 Aug 2024 05:37:23 GMT  
...
```console
$ docker pull drupal@sha256:7cdff5a9df4bc0544185007903692e304c101a4fcac785349703f8a0e4ef5b0d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7054159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38425157e4fcc6b563323ea81a12d5f1927938dd415ab20fc6dd1314926115fc`

```dockerfile
```

-	Layers:
	-	`sha256:c3ab32ff995d2b1d331209154d5b01330a9097a2fe653736aa68403b47d817be`  
		Last Modified: Fri, 02 Aug 2024 05:37:23 GMT  
		Size: 7.0 MB (7017720 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:57e2ab32b35a72cc015f511d516df600af5105fbe55a99a17781c388adc6e687`  
		Last Modified: Fri, 02 Aug 2024 05:37:22 GMT  
