...
```console
$ docker pull drupal@sha256:b0dbbba1641003ae7e4386067e8f603bab945d6ebed5159a21e1c1444f2d1037
```
...
### `drupal:9.3.15-php8.1-fpm` - linux; amd64
...
### `drupal:9.3.15-php8.1-fpm` - linux; arm variant v7
...
### `drupal:9.3.15-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.3.15-php8.1-fpm` - linux; 386
...
### `drupal:9.3.15-php8.1-fpm` - linux; s390x
