...
```console
$ docker pull drupal@sha256:11cf1cd29fff7d5e698281183efa3ee60d5309a15032b23436a74e68cf1f9b14
```
...
### `drupal:11.3.13-php8.5-apache` - linux; amd64
...
### `drupal:11.3.13-php8.5-apache` - unknown; unknown
...
### `drupal:11.3.13-php8.5-apache` - linux; arm variant v7
...
### `drupal:11.3.13-php8.5-apache` - linux; arm64 variant v8
...
### `drupal:11.3.13-php8.5-apache` - linux; 386
...
### `drupal:11.3.13-php8.5-apache` - linux; ppc64le
...
### `drupal:11.3.13-php8.5-apache` - linux; s390x
