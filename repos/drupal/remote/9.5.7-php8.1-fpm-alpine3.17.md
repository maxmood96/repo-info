...
```console
$ docker pull drupal@sha256:1a2b20d23d65c087d232fac6453e65bcfd1f0b4a23290495de58a533a2aa491c
```
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; amd64
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; 386
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:9.5.7-php8.1-fpm-alpine3.17` - linux; s390x
