...
```console
$ docker pull drupal@sha256:7fe47a56c8cc7711bf7aa39e8f3a8911685997155bc57fa46f7ea4a96bb34ed9
```
...
### `drupal:11.2.9-php8.3-apache-bookworm` - linux; amd64
...
### `drupal:11.2.9-php8.3-apache-bookworm` - unknown; unknown
...
### `drupal:11.2.9-php8.3-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.2.9-php8.3-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.2.9-php8.3-apache-bookworm` - linux; 386
...
### `drupal:11.2.9-php8.3-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:3907b36f5fa673ab434f1a6845f4026e3f47317e3c22bd750a4154612ced5278
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.7 MB (204737269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ed2ae1b5f3cd3e88ac4b0ed89e2b5307e0e77dcd36e76635ea8c12d208ec5eb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:83b728685363727f422eeafbe6e9500d2b0c8cfa363e977d1689ee3877f7929a`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:13a82ceeea61758c736d7b68625de1d79bf46fb173edcb40aeec8bc3d351b8e2`  
		Last Modified: Tue, 09 Dec 2025 16:39:35 GMT  
		Size: 20.7 MB (20652523 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.2.9-php8.3-apache-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:92cafe59dd00fe202d265874a2266341cb15b81c35888b538790dd8b3ff4413f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7070256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41ca46415fa3d3e766c129376c47848d1e23d44b6fe5f2c37d5fb39adbb07e9f`

```dockerfile
```

-	Layers:
	-	`sha256:ec48838cfb96cd934f77cf3ac54786fb8db6db13d3b167fcdf13d2c848f33fc8`  
		Last Modified: Tue, 09 Dec 2025 18:00:20 GMT  
		Size: 7.0 MB (7029762 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d85bd884a83bd5e9075d2c9914b95b3dcd958a9a6e4d99e5a7ac22fe72847c80`  
		Last Modified: Tue, 09 Dec 2025 18:00:21 GMT  
		Size: 40.5 KB (40494 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2.9-php8.3-apache-bookworm` - linux; s390x
