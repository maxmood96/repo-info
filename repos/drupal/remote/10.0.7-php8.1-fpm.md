...
```console
$ docker pull drupal@sha256:a4c9a3897de15b4531a894dc2bd5da37d1bf8d5a1ef180aa032cc1dc6314647e
```
...
```console
$ docker pull drupal@sha256:ef17574cbc887edba5b9b204ec454f5d033c40c6ab5dce916c62747ac842b447
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181898553 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c7a7c3911ace7dbcee7e0f0c487571c77efca09eca9acf4c3e724dd61e1527f`
...
# Fri, 14 Apr 2023 19:42:44 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:42:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:42:54 GMT
...
-	Layers:
	...
	-	`sha256:6b61dcca11a5903b57f33b535b041c43313992b9d35f43f3ac24b42373405d12`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:524c3c53f5880c3d373f6fd3ad8a4037eb8b9c82add78aa42af2fd34a6c78dbc`  
		Last Modified: Fri, 14 Apr 2023 19:57:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f30053bbbe75f43b8d5e4e47a492e04eed7334472b7b53a3a3a71fd9966a8bc`  
		Last Modified: Fri, 14 Apr 2023 19:57:43 GMT  
...
```console
$ docker pull drupal@sha256:fbb5dd7441d7ae5620f1cefe8d214e9e9597a8b04fe6ad1cafd4014dfb9ec385
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176158811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9db9822cb4ec83c86370217bfb73fdddd830280635cf74945481cfb9bf9e2ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 17:32:26 GMT
ENV DRUPAL_VERSION=10.0.7
# Wed, 12 Apr 2023 17:32:27 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:32:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:32:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7055213c14bbe79edd031acaaaa133ac66bddf6053ec21bc44a47461101aca68`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfdce8b7d8928a004e6c201b2ac5303cf83cbe53462fde7b57c56fe22228fe17`  
		Last Modified: Wed, 12 Apr 2023 17:49:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5056c0d92499459962dcc3b6ee394539d3dfb62ec2a829ad08b9ab1af9f66037`  
		Last Modified: Wed, 12 Apr 2023 17:49:41 GMT  
		Size: 17.7 MB (17668900 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.1-fpm` - linux; 386

```console
$ docker pull drupal@sha256:e176ac79c4daea6be8784e744a7bd2e72165b56465d0e40648aa2459cbbb306f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.5 MB (184535958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b01cd91bc43c32d1bbbb5d25d5c0698e746af95ee82ea79bd857cbfe40867e0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 23:17:52 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:18:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:18:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a0f140f1fa5d34a3bb5dbe3fade0956d6d22b8da1641d2df2ff0cbc95168f367`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ff0cb00b2cc6b5f417f7054f4e4fee0e4dae4e88a429a4822dc205aa198d3bc`  
		Last Modified: Wed, 12 Apr 2023 23:35:56 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:febdbbcf8e07283175101ad27d8b109c8ce2c086719b97e0df9ed9195e3616f3`  
		Last Modified: Wed, 12 Apr 2023 23:36:03 GMT  
...
```console
$ docker pull drupal@sha256:4493228fbefe5e0461e04912386355d51280ab99db8ba34089053c8d914f0f65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181660446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb306da5bd41499288681ad9fbeeb3fb008285afe407c5f00e2e974d0d3211db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 19:35:19 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:35:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:35:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:427644b6d9ee8c53b87fbf01873d30a3698c888f40ea92fa1c2e6f65754e47e5`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0a1b434355de2382713f3252308f0baa4e023a3f3c274ec2fe32b3739ff0073`  
		Last Modified: Fri, 14 Apr 2023 19:50:25 GMT  
		Size: 17.7 MB (17671255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.7-php8.1-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:e4bde86c54cf3fd705d7133ad22e980f0cf7574220f5ef8c595088f3cae9b52f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158772518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48961300fdce57a87a4e6701ad0d644dba9a7edfdbde148871f774423bd5ba52`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 18:18:14 GMT
CMD ["php-fpm"]
# Fri, 14 Apr 2023 20:10:55 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Apr 2023 20:10:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 14 Apr 2023 20:10:56 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:10:56 GMT
ENV DRUPAL_VERSION=10.0.7
# Fri, 14 Apr 2023 20:10:56 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:11:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:11:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:896776546b3b4729bb73c6e499fae13be2586a95ce8ded9cbca6992fb86d3215`  
		...
		Size: 8.9 KB (8880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b88a82824c561eedaff6e8cbae8231dc0068c4f2e089d51f5aece61d2854c88`  
		Last Modified: Fri, 14 Apr 2023 20:20:35 GMT  
		Size: 1.7 MB (1703416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccf962bf200ab5b52d6919cf25413e7960677efefd6abc30a6e6a9adbccb61cb`  
		Last Modified: Fri, 14 Apr 2023 20:20:35 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13e2fa2888ec2a39a34279bdd5572065d73631b8ffb4f3055c83b65c8fbcceaa`  
		Last Modified: Fri, 14 Apr 2023 20:20:35 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a815bcefee7cccdbd2826432e98a8b7b368020f9477104092d8218af4a8dae4`  
		Last Modified: Fri, 14 Apr 2023 20:20:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:273f13ecf6fe907cb8b77e3e7552cb5ea5905bdddecd7f6a2f701a2483ce574e`  
		Last Modified: Fri, 14 Apr 2023 20:20:39 GMT  
		Size: 17.7 MB (17671167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
