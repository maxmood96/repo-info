...
```console
$ docker pull drupal@sha256:e39862dc33fb22107c51155a723ca5d25e218a562a1af6d52cc26eaf26d2ce9c
```
...
```console
$ docker pull drupal@sha256:776a61990ba7d846cf759fbfce1c9a366e617dc3936af9f9720e914309d6fbb5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.9 MB (151888971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca3062b826ce054d0b93e268177d608108a9e46ab443397e64211e53f0bcdc8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 07:33:02 GMT
ENV DRUPAL_VERSION=10.0.7
# Tue, 28 Mar 2023 07:33:03 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:33:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:33:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a16b1a41df949a9867b9040fabb7c58b32d5820f88630e830b3a9008441516c8`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46bfb3019d39a92dfd47e832eb1339a331101a9e6fb6d77d72673134137a5753`  
		Last Modified: Tue, 28 Mar 2023 07:55:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86fae3d921b86a2da92ef8871001db2d5d4911ab2df74a8a601ac47b385357a0`  
		Last Modified: Tue, 28 Mar 2023 07:55:13 GMT  
		Size: 17.7 MB (17671124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
