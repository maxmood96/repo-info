...
```console
$ docker pull drupal@sha256:f317c419bd3bb39c388007d449807badb5078403451e869281e033ed0a089748
```
...
```console
$ docker pull drupal@sha256:6d5df93ed7c82f575b7b03206f3ab7cb0a8df2355b445f46e43b00cedeb4d038
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.2 MB (200171083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0d8e78dcec5f80ff6964c965c8b8f30ed1493ebc4b07e8db9fb75c9a538acb5`
...
-	Layers:
	...
	-	`sha256:e37124bcfe26d6cd8cac9cc0eb3316b0568d5f2be37d63bc4e554aa4b026f2fd`  
		...
		Size: 895.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a8d3131fc8d58d39b64bd87cd4ae05ca8921862bcbd547b69e6b84f975682df5`  
		Last Modified: Sat, 16 Mar 2024 03:52:41 GMT  
		Size: 2.0 MB (1999518 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e4b3fd57a3e1df9c8ece95c5615b7e00028908c383f7ee6955bfe62e7dbafa64`  
		Last Modified: Sat, 16 Mar 2024 03:52:41 GMT  
		Size: 313.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f53b4a3e79e7128a8c016dc2d4ddf2bb97917fb62ac51aec7fb5f46e6b84b2f3`  
		Last Modified: Sat, 16 Mar 2024 03:52:41 GMT  
	...
	-	`sha256:2f3756a885aa769c601cba623a95bdc89b5208a79f382165f7f8807088cb6435`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a3409bde8a493d689fd962df511d95fe5b133178deeb64540fb4a79f9441de3b`  
		Last Modified: Sat, 16 Mar 2024 03:52:42 GMT  
		Size: 19.3 MB (19250460 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2-php8.3-apache` - unknown; unknown

```console
$ docker pull drupal@sha256:7a9afbf2d69cf6df62f352f4f4802e1e33025d20d5ef0b70a48835bbcb52a9aa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7344029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c0f7437437b97d0d99f973457745baea0342d4183f26d4072d88c17ccd1413d`

```dockerfile
```

-	Layers:
	-	`sha256:d823f3ffa80542512a5f34066e20e658a41203655ef30d8049030ad353f1d7e3`  
		Last Modified: Sat, 16 Mar 2024 03:52:39 GMT  
		Size: 7.3 MB (7301604 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:57568a22d99a14bb46e8a519eff8fa524bd9f6516d75d51010a242effeb3bcae`  
		Last Modified: Sat, 16 Mar 2024 03:52:39 GMT  
...
```console
$ docker pull drupal@sha256:18e8a3e89b3a3c73092b72cd68f37870510afc5f7160bff375e69dfb827582c7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.1 MB (164091107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fda6512148bf0e7e4457b23c142a6f0d6dc3eb44012a46a4015b9976f492580`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Mar 2024 07:53:35 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends gnupg; 	rm -rf /var/lib/apt/lists/*; 		mkdir -p /usr/src; 	cd /usr/src; 		curl -fsSL -o php.tar.xz "$PHP_URL"; 		if [ -n "$PHP_SHA256" ]; then 		echo "$PHP_SHA256 *php.tar.xz" | sha256sum -c -; 	fi; 		if [ -n "$PHP_ASC_URL" ]; then 		curl -fsSL -o php.tar.xz.asc "$PHP_ASC_URL"; 		export GNUPGHOME="$(mktemp -d)"; 		for key in $GPG_KEYS; do 			gpg --batch --keyserver keyserver.ubuntu.com --recv-keys "$key"; 		done; 		gpg --batch --verify php.tar.xz.asc php.tar.xz; 		gpgconf --kill all; 		rm -rf "$GNUPGHOME"; 	fi; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark > /dev/null; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false
# Tue, 12 Mar 2024 07:53:35 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Tue, 12 Mar 2024 07:56:10 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		apache2-dev 		libargon2-dev 		libcurl4-openssl-dev 		libonig-dev 		libreadline-dev 		libsodium-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 	; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 		PHP_BUILD_PROVIDER='https://github.com/docker-library/php' 		PHP_UNAME='Linux - Docker' 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--with-pic 				--enable-mbstring 		--enable-mysqlnd 		--with-password-argon2 		--with-sodium=shared 		--with-pdo-sqlite=/usr 		--with-sqlite3=/usr 				--with-curl 		--with-iconv 		--with-openssl 		--with-readline 		--with-zlib 				--disable-phpdbg 				--with-pear 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				--disable-cgi 				--with-apxs2 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find 		/usr/local 		-type f 		-perm '/0111' 		-exec sh -euxc ' 			strip --strip-all "$@" || : 		' -- '{}' + 	; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc; 		php --version
# Tue, 12 Mar 2024 07:56:10 GMT
COPY multi:e11221d43af7136e4dbad5a74e659bcfa753214a9e615c3daf357f1633d9d3d1 in /usr/local/bin/ 
# Tue, 12 Mar 2024 07:56:11 GMT
RUN docker-php-ext-enable sodium
# Tue, 12 Mar 2024 07:56:11 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Tue, 12 Mar 2024 07:56:11 GMT
STOPSIGNAL SIGWINCH
# Tue, 12 Mar 2024 07:56:12 GMT
COPY file:e3123fcb6566efa979f945bfac1c94c854a559d7b82723e42118882a8ac4de66 in /usr/local/bin/ 
# Tue, 12 Mar 2024 07:56:12 GMT
WORKDIR /var/www/html
# Tue, 12 Mar 2024 07:56:12 GMT
...
-	Layers:
	...
	-	`sha256:e80ab35907f224b714479c0d690981e813f85317b735df440f7c2f06bb4a1d42`  
		...
		Size: 315.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:424b1e3c3880eeb3bcfb48ad8b27d2839a652551edc530523860a1daf3339391`  
		Last Modified: Wed, 13 Mar 2024 10:14:19 GMT  
		Size: 722.2 KB (722248 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a08943bf969c9f6e7ca1ef1a216fe9f7297361fc1c8836b3b847b9babe035e1b`  
		Last Modified: Wed, 13 Mar 2024 10:14:18 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:78dd4eb494858f0ee805c9859c611b7fef1a1178a15f1f56fc6bff4584938e2e`  
		Last Modified: Wed, 13 Mar 2024 10:14:19 GMT  
...
```console
$ docker pull drupal@sha256:1946ed9c10dc821131730142c99e83c04a5c48225c88983793d7c369757edc33
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.2 MB (7158225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b6b388763e134836351dbc9d22a3d6f33f5d3796f4429cdf1ff7411ebe7671b`

```dockerfile
```

-	Layers:
	-	`sha256:4a08027a0e05ae2ef31346207cb9c3b4b6d418ad6b3c7a796b66f512a9e1a679`  
		Last Modified: Wed, 13 Mar 2024 10:14:19 GMT  
		Size: 7.1 MB (7117739 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:5d85d88cdfa310f5defa7bf477fe756edd7452dc09bd353cf1f7e00a8dc6aa87`  
		Last Modified: Wed, 13 Mar 2024 10:14:18 GMT  
...
```console
$ docker pull drupal@sha256:a1ea068f10400e0fb1e4cba5434fe652354259d25a4e28c98e2f0754166e2bb3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.2 MB (199153019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49b3bc5219cf319d1ea0c7db663419ca08f3c69aaaf1976e1e9e38b5b5481477`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:fe93a390e67e187d1ba21563a65963c843bdf2d487c0bad2022fc9897537d210`  
		...
		Size: 893.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:524566096c3526997af2d3a86ff051aa45dc1ebcec5299107e09d317a6ad98bd`  
		Last Modified: Sat, 16 Mar 2024 05:52:43 GMT  
		Size: 2.1 MB (2053549 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:339ece11db9d4910a3d859d9ccd3dff1a71e54624c310013974b2edc2e0ca377`  
		Last Modified: Sat, 16 Mar 2024 05:52:43 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f32ea1059462b15c814ce22128781f325222859edb528d7c0f4df41fe7197ed2`  
		Last Modified: Sat, 16 Mar 2024 05:52:44 GMT  
		Size: 722.2 KB (722245 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:89fcd4fae4ce2cd78190a03836d768ab517cf9d06e069be6212044b38dc38e8e`  
		Last Modified: Sat, 16 Mar 2024 05:52:44 GMT  
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e66bbec202b9909fe692006cbd0cd30af06dca7dfef4c2853402edd9d305aa89`  
		Last Modified: Sat, 16 Mar 2024 05:52:45 GMT  
		Size: 19.3 MB (19250353 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2-php8.3-apache` - unknown; unknown

```console
$ docker pull drupal@sha256:745e2c538d1116ec5b2e7f5580e0bd04be46a74ac8187e4c7d76ff4dcc5218f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7324667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:606d6496389fb890b5c31b282f3ebc3b3b6bcc592b2bb389094a06abf5b0f213`

```dockerfile
```

-	Layers:
	-	`sha256:b5e03d42bc60a2d8dfb2ccc823bc42c9ecd96bd960d3ecc697b6496320698bc8`  
		Last Modified: Sat, 16 Mar 2024 05:52:43 GMT  
		Size: 7.3 MB (7282322 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:11b12b211c987583dec3a123147b6558264d0287983629cc0f9dee92b450f665`  
