...
```console
$ docker pull drupal@sha256:1ea7afbe52201aefea89d921248587f722dc33f95683d8df12d46b37648fe6cb
```
...
### `drupal:9.1.15-php7.4-apache-buster` - linux; 386
...
```console
$ docker pull drupal@sha256:4cd15774bcaa3944425218724ab1421b25d6d642daddf30e0aeff68ee99268af
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.7 MB (179655515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6a936ee3be4ef9c3610bb0c63aef420d1d11654b61b1c2f3737d3059a63556d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 02 Dec 2021 11:06:31 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 11:13:47 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 11:13:50 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 11:14:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 11:14:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d327baa847b3bb4ec085b7eed56d3e36befff71df2c1dd42a05e1d259c6a807`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:621329627223456f108fea9d9eb2f9f910b2434d0e781ba5e5334f827485428a`  
		Last Modified: Thu, 02 Dec 2021 11:37:22 GMT  
		Size: 564.7 KB (564662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c501d387200a5472c1b6c4b9eb141be177d75b4ed1cdc9c5f4cbb9ee2cd3330`  
		Last Modified: Thu, 02 Dec 2021 11:52:57 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab7b4e9c8e73eb58ee06b18b5ac7d68afbb0ba7acb0a25c30ed0bd1437320696`  
		Last Modified: Thu, 02 Dec 2021 11:54:12 GMT  
		Size: 18.9 MB (18879739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
