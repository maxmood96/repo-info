...
```console
$ docker pull drupal@sha256:e9cbd8c91f848c83854bd2e4b856791f44119cf83cedef6a3d21e27e7b2ec4ae
```
...
### `drupal:9.1.15-php7.4-apache-buster` - linux; amd64
...
### `drupal:9.1.15-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:f1b084ebbcd4abd0aecb649bb956cecb9f07ab0221dc58ca7d094950aaf4bb38
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143609477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98b6b6bb8c70a2aed2af2830e76522d0be9ea87a0c5be6251e08a87ad7e77370`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 24 Nov 2021 21:55:45 GMT
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 21:55:46 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 21:56:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 21:56:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4fb531ddc4cc8c8baf8b3581e01752f6b45446542ede0e9c568c18235197418e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd16cf525304221b762e589b4e8f6815d8c3ff84c54ccf580e2f293ad05a584`  
		Last Modified: Wed, 24 Nov 2021 22:28:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dc03f991ffe6405a4d9da1f27f5e682eeb74230655c2b69e510ae777810cccd`  
		Last Modified: Wed, 24 Nov 2021 22:29:11 GMT  
		Size: 18.9 MB (18879859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.15-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:590c907e6792c47d5a473a802a2a92ae6c4850a67c4e1e338a2400cfab3220e5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159714960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2db5b7c2f0fdaa4842bdd18e9fb7397e8be8464f5de66ee6af15c0d3ac6882bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 02 Dec 2021 07:43:49 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 07:48:11 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 07:48:12 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:48:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:48:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:48d1a170002de871d88f40ac827e75e9ec04133a723a9c373d9c6ffdc0421277`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec0e75f63536fb990d0907d05e5e0b3210e6df981ed9e32221bd676c0314f9c0`  
		Last Modified: Thu, 02 Dec 2021 08:00:49 GMT  
		Size: 564.7 KB (564654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2cc5ec185abee7df5e69a5a45b56ca9ef23fe5b9749ac19bed94694612f4a98`  
		Last Modified: Thu, 02 Dec 2021 08:05:16 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:696779eb88f68786f147e4436005f911d1f5413ebc43ed89d2a8094cb7f2237e`  
		Last Modified: Thu, 02 Dec 2021 08:05:21 GMT  
		Size: 18.9 MB (18881141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.15-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:511616ce9a067b12c74e2452d14d8312d0e5031e3a892b032d47a2ab5a794770
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.7 MB (179655114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bc081ca38bbfd401a9ec314686846f52c2724312dc19ffb62f75338f9a7ca58`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.1.15
# Wed, 24 Nov 2021 20:40:14 GMT
WORKDIR /opt/drupal
# Wed, 24 Nov 2021 20:40:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Nov 2021 20:40:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a20c41d40876c95b72fa7b6a07f83d49003926b41eef44cf903f468aaeed8f3a`  
		...
		Size: 564.1 KB (564144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af2020ecd2e9aba2fb3ea51cb94f708051fdaa8e1050738abdca07aa93c206b9`  
		Last Modified: Wed, 24 Nov 2021 21:12:59 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1be44e2e9c9c089a66862b8d5c836002cb255d429aeee71654edc01bfcb9a1f`  
		Last Modified: Wed, 24 Nov 2021 21:13:45 GMT  
		Size: 18.9 MB (18879857 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.15-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:8f1f7ba6983d3041c901ab591441a70e936e7eea5555a560d8ca72c7fd18bda3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153934877 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a1289e69838ce3b5a6e373161eef50a99acfcf5783963bb797ce2dccdb1d47d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 18 Nov 2021 17:41:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 02 Dec 2021 06:58:33 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 07:02:06 GMT
ENV DRUPAL_VERSION=9.1.15
# Thu, 02 Dec 2021 07:02:06 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:02:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:02:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:98b601f665a37b26b19553d89f89c927e9e240ee4976dabedc232b4a1692e419`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfca376a1be1a64192c7fe8f0733355de8ce46935ec190dc91954c259a00f66`  
		Last Modified: Thu, 02 Dec 2021 07:13:25 GMT  
		Size: 564.7 KB (564652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d95ec07a017412e65577b69d8e672b1cd3a5a948c2c4c62b3763062c667aa3d4`  
		Last Modified: Thu, 02 Dec 2021 07:16:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38a440d3418b81938d11ad1da8200829a2cde0b76da1478b28806185dee4badb`  
		Last Modified: Thu, 02 Dec 2021 07:16:18 GMT  
		Size: 18.9 MB (18880131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
