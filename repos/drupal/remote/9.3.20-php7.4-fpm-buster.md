...
```console
$ docker pull drupal@sha256:cc143ee7f6529d605bca929d4085c982b2d064be25509a40c5dbbb2efd4dcda7
```
...
```console
$ docker pull drupal@sha256:3f6e6157559fe789b7e4e47ffc6af0680d099f7eec51a7250ef45dc44e665592
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.2 MB (163232437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c199f1da1589c8ca251e8af9487f133b7681dac8fff7c6caccf150200fcdf85`
...
# Wed, 03 Aug 2022 08:47:01 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 08:47:01 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 08:47:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 08:47:13 GMT
...
-	Layers:
	...
	-	`sha256:8516d0e796349928ae00f81f1f4fb76c234ba229040e42068350f1a42864a479`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a218c25dcd81ed70330a8d689aa606be1312e4f8597ae25d87e0698e0859a81d`  
		Last Modified: Wed, 03 Aug 2022 09:08:54 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:284689057ae8888164cf4c9709549df6adbda8ef293f637c97bab84d18b8a0af`  
		Last Modified: Wed, 03 Aug 2022 09:08:59 GMT  
		Size: 21.2 MB (21214324 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:2095d0a8c2016045adc2ec1f030a8df16f8004c09b3909fcd2578511a31c7489
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.5 MB (139525972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a22cffc68fbba2a61fe48e31ab2c3c5622e0db82106f6780a9186e777df3579`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:20:54 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:30:31 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:30:31 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:30:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:30:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7dcc964a2cb7fba7dbeb898886fe10261fb1570db6f71a6314acc3c5daec344d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93f7be954150726b142f8b57f6688353997f6ffbbe20fbfd32108325c54bf8c0`  
		Last Modified: Thu, 04 Aug 2022 10:20:53 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94223799f2b68e82cbe6c4c332bf8dfa0bdd0d8aa98120a18229310ced5ce480`  
		Last Modified: Thu, 04 Aug 2022 10:21:07 GMT  
		Size: 21.2 MB (21214284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9fdad60afd5fbfbaca3a3a5debfd2480d679f416e57a72436dda748102e8d45b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.8 MB (154808239 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c723af9374ad2394de620d7bdfa2db6f93ef9e307907281ce1275739903c7ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 06:22:31 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 06:22:31 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 06:22:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 06:22:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a8235acbd281cc793365e3249fd0913450b4461692415216a180dedaa6e7b9ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7044060752cec014ba64bb1630c3e7e836a287df2ff80994786b25461a31b699`  
		Last Modified: Wed, 03 Aug 2022 06:59:00 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:505d6974e31c51cd670749516c9302d65ac8489743a652833aca472d3c072a91`  
		Last Modified: Wed, 03 Aug 2022 06:59:05 GMT  
		Size: 21.2 MB (21217364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:e506a095b95a71008aca90066524e8f322f8d6662227d31702d52eb2fc2ccdb0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168379678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21ba57983a73edca56fd4ba2a73c99414079400562a03cb7e1514a783b84157c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Tue, 02 Aug 2022 18:35:41 GMT
ENV DRUPAL_VERSION=9.3.20
# Tue, 02 Aug 2022 18:35:41 GMT
WORKDIR /opt/drupal
# Tue, 02 Aug 2022 18:35:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:526e9e673745a4286154fd4119b2e55c5ae7ebdd8e7497cc13658c3e2d8a542d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4cd4c4effbdc4d313e9573dc7095f045a26ea06eb8cd5976ac536902d98ebeb`  
		Last Modified: Tue, 02 Aug 2022 19:07:27 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16512585576a47bf14db1328ae5802334de88a007ce6ac195aa09ac361826564`  
		Last Modified: Tue, 02 Aug 2022 19:07:32 GMT  
		Size: 21.2 MB (21217395 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:092f5dce5669d627a7004585ff9e4f615934157230649822a31b679709df1fe8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.8 MB (173803201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f852064e03667bf7223e15720fd0e8a7dcf976b2bd45b50b22d606b01d1e2ce9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:27:41 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:40:42 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:40:42 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:41:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:41:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0bca7056a3f8dabafa456f3cfe8eb250c26080bf002e8164c51c6cb44bf813a1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa5ccd47f4521a404a43fffe8d61c75b713483d7106f82f5289adaaf70e6e36c`  
		Last Modified: Wed, 03 Aug 2022 13:35:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f9725a0214c7ae094e053ee4707e4d7f249f5e80bafc06fe15ad8c98fee506`  
		Last Modified: Wed, 03 Aug 2022 13:35:48 GMT  
		Size: 21.2 MB (21214484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php7.4-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:386fb50db9e99bfd9e24b262c437aac42ef5b06fcfbbd4f7dc9ed95f390cec4a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.2 MB (149214691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39ce6b9a29d7d231bc7d07fc3b6586f57f9c4af2eb3af4a8d96d930e4ef42b89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Aug 2022 20:51:11 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Tue, 02 Aug 2022 20:58:09 GMT
ENV DRUPAL_VERSION=9.3.20
# Tue, 02 Aug 2022 20:58:09 GMT
WORKDIR /opt/drupal
# Tue, 02 Aug 2022 20:58:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Aug 2022 20:58:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:926f3e54624c123f3e5a9a3331b1a9a8132db38eea1aa9288386526ce6919eaa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7095fbd593412b876bcfecebe47040bb3bcd83f6c003b9991f2ac97959595598`  
		Last Modified: Tue, 02 Aug 2022 21:23:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e0c5dbf0b4f9c196bc585a39c6e2c370205d96e79cdb59c21cb581eafa444ff`  
		Last Modified: Tue, 02 Aug 2022 21:23:28 GMT  
		Size: 21.2 MB (21214277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
