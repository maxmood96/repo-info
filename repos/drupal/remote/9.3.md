...
```console
$ docker pull drupal@sha256:51f77de37ecf25597f2f3fe0e722b381de88d969061c85b084b32151e0d759f5
```
...
```console
$ docker pull drupal@sha256:d354b8fc3912e862a39c25c96ee10ea700336493778afde5a801c32c2915c74a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.9 MB (164873434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fcf2c33a246a32068177cd8ed75ea3eada081fe9adc98491286bc4c3793712b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Mar 2022 21:12:46 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 17 Mar 2022 21:12:47 GMT
ENV DRUPAL_VERSION=9.3.7
# Thu, 17 Mar 2022 21:12:47 GMT
WORKDIR /opt/drupal
# Thu, 17 Mar 2022 21:12:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Mar 2022 21:12:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a7baafb4e9f3d0a355a0dad8850bc19ffe8faab60062e50aad98c7863c6164b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22dbf643f8b3e693186923dd8eefa4aee7f5f946da911d8d7f457daf0d21c337`  
		Last Modified: Thu, 17 Mar 2022 21:36:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e8df8d312e09080971b7636a09c1b8d415df90cb2601c1e3aec754a50e7b34`  
		Last Modified: Thu, 17 Mar 2022 21:36:48 GMT  
