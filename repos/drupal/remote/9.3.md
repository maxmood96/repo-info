...
```console
$ docker pull drupal@sha256:595660ef82578994bc9b8e603aacaa6e5668471ae36f2d22532fbc658bb1da84
```
...
```console
$ docker pull drupal@sha256:ee3ad9aadc5dac2f5c18671eee258b8e2314105e52ac000203516b9ca457ddab
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190737733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3cb2304e252022a7808d1f1ae512cc382d2d948cb3d8370ccedcd2127f0247c`
...
# Wed, 29 Dec 2021 19:46:56 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:47:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:47:07 GMT
...
-	Layers:
	...
	-	`sha256:4774a1bb75dfc4fea5daa27eb560586d03b02df0e2e067388f7ece75b6b4443e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e66c39e18bd46176c07954cd542310938cc556952fb5eded09f588f68d5f4a02`  
		Last Modified: Wed, 29 Dec 2021 19:56:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90d11f403ae9e9a140ccb93b9c382001b077d470e6f2ae825bacbe839626b8fd`  
		Last Modified: Wed, 29 Dec 2021 19:56:39 GMT  
...
```console
$ docker pull drupal@sha256:328ef4bd86463cd69ca9008b3b8a1c35e0d05d8b10d8b4e09bb1e656e9e04258
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.8 MB (159829440 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8925e23bfc4ae2e7e56145f80b35e2e6bd78036d5bff9235157868f6d4fc5c3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:58:09 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:58:09 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:58:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:58:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:652a6ac0cedded6e7e72fe2c33e41e3afbb19952b65a450ce12889c88106fc9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8808cf6da9e9067ad4694700e82ec5beabc09129cc8eaf7742cf3f450c244e4f`  
		Last Modified: Wed, 29 Dec 2021 20:34:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdfa2217245d416f9c656590e9efcd1fc51e8f02c0b18a13109490c3d21c936d`  
		Last Modified: Wed, 29 Dec 2021 20:35:23 GMT  
		Size: 20.1 MB (20141859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:dd7e4ae633502d969bb0a235e6ee8514ad7da8f2cd02fa551a4faa5c444bfd7c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183053670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:330470b5c8a50ae9db57f4e3e8a4f84018814baa16a907736e040b9eaff718b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 18:56:38 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 18:56:39 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 18:57:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 18:57:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d8f7c7d650d024de217ff8c4b9519eec7ef35983bc2c23c204be0d5781e24216`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dcce15de32819494531811ac27afacf2628c5b0c216816b0c550b2fc4ed71e3`  
		Last Modified: Wed, 29 Dec 2021 19:17:03 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0164cef11af8a07fd820a0bb4ef1a9d2d6cf9b2e284c5d4fa608eeaa6cc0e757`  
		Last Modified: Wed, 29 Dec 2021 19:17:09 GMT  
		Size: 20.1 MB (20143864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:984a96de540e70755e9c3e6356cdabdcb1f2023988742f863782f863cd6665ba
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.7 MB (193682234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0339b4f5e35dbd3bdf58b0a0af2672f481c8f56659d9c71e338129ec5aa02b0b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 19:02:01 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:02:02 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:02:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:02:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2a8e9d07665fd651445b92fc4193e781d9ba0d2210753bbb65fb155314f866bb`  
		...
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dfd1918b4e49a0dee5909caff26b8e042dc51b3b9ec9af51ce837f8571afac4`  
		Last Modified: Wed, 29 Dec 2021 19:19:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84ac83c3159072cbbd27e445c1ed874de6e55db37918b3aee39672fdbcbd81fa`  
		Last Modified: Wed, 29 Dec 2021 19:19:39 GMT  
		Size: 20.1 MB (20141686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:e53e8da8eb7b3f4bf44dfbcc570bb6fd37782f6e7a14ceb172e33165dd6e9919
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191468689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e56e8f1385aa31745e42318d8ab0334b8f20d121230638905018f13eb244dfaa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:53:52 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:53:54 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:54:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:54:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c2c53aae084d46e3d78129a02404d6461353b8fe7dda1b8bce700532fbe1809`  
		...
		Size: 573.5 KB (573477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a44e1ca02fdc9c6785f06e9550496c43a51f86f83d77bf1f832460781cf098f6`  
		Last Modified: Wed, 29 Dec 2021 20:19:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e063e766b42fef49b69f679f481a9dabc4ab8ff21c6607c8ac48659cf3124c7a`  
		Last Modified: Wed, 29 Dec 2021 20:20:19 GMT  
...
```console
$ docker pull drupal@sha256:7e815a7c28ae27a056db4ddbf5694843d5f72480b5590d0472a21c8040c65cbc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167404236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2858b2812583390e90641ce5e6b788d8c0e338fd2be343bae1344cd72a1d054d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 18:58:13 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 18:58:13 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 18:58:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 18:58:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8134ecdf8e6c091d6013a02041f2876496b019faf70b2c1b59e2a1d17569abc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99cf614471bfd970cb4aa1d91ddce9f63dededec7ca04d7608d594ab08ce010c`  
		Last Modified: Wed, 29 Dec 2021 19:17:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73d92dfa39dc21ad6560d61fb7d96d31e05ef98bff63ca9355a305c050782c1b`  
		Last Modified: Wed, 29 Dec 2021 19:17:16 GMT  
		Size: 20.1 MB (20141799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
