...
```console
$ docker pull drupal@sha256:d8cf9fef68716f2774d350b72c2fd0185d33fae9c3aedf492b6747ca411440ad
```
...
```console
$ docker pull drupal@sha256:f67959901ad194825e38653569de62364b6d81f3232e54dbed005a9f5b3b3649
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190737266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:243439a719fb3bea393b33c1d5772cfff06dbd5c7789d99b2cb007971ab18738`
...
# Thu, 23 Dec 2021 20:35:42 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:35:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:35:54 GMT
...
-	Layers:
	...
	-	`sha256:64f9fff77883fff9f20b92b6da1721ecb0527a74a6ce0fc3f21ef52fffc13cf4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:861d2345866cdcce4287f4f6da342fc9e6847a6db8a0a7b0be2252f6dc16714b`  
		Last Modified: Thu, 23 Dec 2021 20:45:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c559e33fd013aca91c1b4b6526c3592549daa0de499a5329067bc637386fb71`  
		Last Modified: Thu, 23 Dec 2021 20:45:35 GMT  
		Size: 20.1 MB (20141493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c0337073b44614b3bfa2feacf8706f4e9c61829e0387ab53f0dcbb73eb981cc9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.8 MB (159829318 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a1fdac1822cbe4cbb614a406f5964a74c5dac59db3b7a9d55ee3a847c3f7004`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:16:47 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:16:47 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:17:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:17:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6d2ee376b8fdba011365f152b34ebe8a406f7599cd3910fa1a253106d1fcbd5a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b83c6c35c3966c4c7c424fd4bc1650b4c3ec1cf566c28e4def17d0eb47e58f7c`  
		Last Modified: Thu, 23 Dec 2021 20:53:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ecf2fe33e3878b2a1fa6aa96198db2adf7386c975207ac1b5b5efef0e66fa0e`  
		Last Modified: Thu, 23 Dec 2021 20:54:08 GMT  
		Size: 20.1 MB (20141888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:00365eec1f3aec223a8d24d8de09dbef813ff00383744502316258a314b5e838
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183053844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edf2ff204603c95b3655b440e319476dc6fe979a3f7bd2dd8a8da0efaf255368`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Dec 2021 19:56:27 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:56:28 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:56:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:56:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:703bf13275f0698361c4be735ec7ffad56e51eccfd4f2ee09a253da00e759174`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0b38258c49ba9dc264d88ea2156d04fe3ccf5acf37e10cc4633dcb046d281fd`  
		Last Modified: Thu, 23 Dec 2021 20:17:04 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd09520476beeb435976332330c3e394be7cbb031f4fd772cd7137bdbae56208`  
		Last Modified: Thu, 23 Dec 2021 20:17:10 GMT  
		Size: 20.1 MB (20144199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:dc9d50e9ac27757ff128e1560cfca6d358fb5707a1aa6e2e1f2fa59d2468a72a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.7 MB (193681993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca317404218939182835621ced2c5624aa451f008292b7c0f3fdd08e2af534ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Dec 2021 19:55:43 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:55:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:55:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c9f87494d0dd7de31dea83b37c1be569b446ae1deafc8c647c761d5206fafd03`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e20316584f18a1a35af1fcf948fde22dadd235af37a9cbdc2d909da4f67e85f0`  
		Last Modified: Thu, 23 Dec 2021 20:13:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:315bfcfae37b10ca41119c27fd2d03b02596928ac79302fc58ed1bf94a4036ce`  
		Last Modified: Thu, 23 Dec 2021 20:13:22 GMT  
		Size: 20.1 MB (20141600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:6b8e7bb93385c31a3462690d20fcf1f0eeca2194bbc85004e44f89d4ff25476b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191468249 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:967bb7c22057eb512d3fcad2f28e19392ea039ee8b0122c24f0dae3a8e782623`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:34:20 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:34:23 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:34:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:34:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b3a909ecf4455344fd175a63b15841d947c4cc77d1e416bc9d4f11407501117`  
		...
		Size: 573.3 KB (573318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c44c43b0904f7fe1d0349eefa47ab81a3318c10b1e8ca4463f457000fd63831`  
		Last Modified: Thu, 23 Dec 2021 21:05:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74fed9aa117b9a98460c4f6dd50002e7bbfb5f555bd1e9858b212f1657d1ea8e`  
		Last Modified: Thu, 23 Dec 2021 21:05:50 GMT  
		Size: 20.1 MB (20141537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:cc9cab73df62d2f37ba2b8e9b1e22bde111478343dd23f574b79a2b618027c6f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167403989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:982ebcff9e3c5a459b602c462f49ae03f98645d6c3413a4275bb5c553a39e66b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 19:58:11 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:58:11 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:58:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:58:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4dff35e23f7f5290f3675454d41e89e08874679278baae0e4724bd859357cb33`  
		...
		Size: 573.3 KB (573318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2033244f4de5e9e11c6c5a5d4c871233e79ab506da22eb31579dd55db79889e5`  
		Last Modified: Thu, 23 Dec 2021 20:16:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5098008daf301a5eb8313865edb6239c283b87529d1c944f2779819cb3310bfe`  
		Last Modified: Thu, 23 Dec 2021 20:16:13 GMT  
		Size: 20.1 MB (20141705 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
