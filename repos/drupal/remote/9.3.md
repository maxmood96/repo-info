...
```console
$ docker pull drupal@sha256:7b8dac74f521951e21460492deb0cad9087763b22b8ed9a2e7c109fa9e546c6b
```
...
```console
$ docker pull drupal@sha256:9b11a7aa19808c06762ae609b171233a37eb26f2d6456e5685b91082510543d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157877336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2552f3b8ac6ae514a884d87a7b491e7119bd951be35a09e2fb6434ce001e746`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Jul 2022 03:17:03 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Sat, 30 Jul 2022 03:33:33 GMT
ENV DRUPAL_VERSION=9.3.20
# Sat, 30 Jul 2022 03:33:33 GMT
WORKDIR /opt/drupal
# Sat, 30 Jul 2022 03:33:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Jul 2022 03:33:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:41de049b34fe29d80938d48dddcc09b736fe95040e44377243ae06f89f874948`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d2e0c623346b1d1a7082cd457fd94321cc0abeda49e36f1bab471588579b5d0`  
		Last Modified: Sat, 30 Jul 2022 04:03:00 GMT  
		Size: 670.4 KB (670424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6870ce317991efea3503f087ac5b7db15f2b8e1c464f8e74811e2f7cbfaae33`  
		Last Modified: Sat, 30 Jul 2022 04:17:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:367cf553fb1770781382f05e991138df924ae77c9eacf35ac78474cdb8e77946`  
		Last Modified: Sat, 30 Jul 2022 04:17:55 GMT  
		Size: 21.2 MB (21223873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
