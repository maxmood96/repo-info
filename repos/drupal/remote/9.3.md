...
```console
$ docker pull drupal@sha256:25793f32bfffcb2f7cb221493fc1e58d93f775b460c6268d0d8565e06ded6bea
```
...
```console
$ docker pull drupal@sha256:f511bcd697e74c9339cbd435d30f98f0604bf5668f174a31eea95395d4e73daa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180810468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f9ffb64df50cf1cd47ba991f889b2b5bfa2d45a72a9b5a3611cb2514d4cc70d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 17 Aug 2022 23:03:20 GMT
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:12:31 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:12:32 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:12:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:12:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:831eeca9337d5a24d7d90c0d18846434c5d0d7b4b68f5db091ecf68adecd3802`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c355e8913a69acd578c24147cbefc0b71c59dc828d14e04e3c1fdce61fced00d`  
		Last Modified: Wed, 17 Aug 2022 23:37:26 GMT  
		Size: 691.9 KB (691863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adf9c9e2e1758fbfb57b414e2c53412edfec85c0ed7a853e67a9fca4090fc4fb`  
		Last Modified: Wed, 17 Aug 2022 23:49:25 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cceaaafa219b16861764085936cb088adc8fe4e198a3f5015ccf461734690ff`  
		Last Modified: Wed, 17 Aug 2022 23:49:30 GMT  
		Size: 21.3 MB (21321480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:640813946eb251dbdeec9569c71a55d578417edae9472122eb5d0bbe74559eda
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190660014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12b881927ba14024d29b61e7bd5b96ae0a4709f9df2a84e83b6f1f4e14467b56`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:109db1876167cc781e12fa1661d5ff1f91e73f8c97791afad3ab87b7aea9c9e2`  
		...
		Size: 691.9 KB (691863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f2caa0a91bfa8af792772bc7f47104443a3607ece106eca4a728610504f8768`  
		Last Modified: Wed, 17 Aug 2022 23:04:18 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc40c671aa3414607a66088231de950e216a89fa269588291c451c3a098197e8`  
		Last Modified: Wed, 17 Aug 2022 23:04:23 GMT  
		Size: 21.3 MB (21321830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:fd04a505ccaeaf3d1b7a2a0a4e67410772a510e9f45fd6602e98c81805b2998e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.3 MB (165313392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb40fa41ec10fd600e76cae76430201d6fe2cce0f8a07e0c700e13e9a2e81c36`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 22:22:16 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 22:22:16 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 22:22:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 22:22:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2470c285309ce98271073c908243fd08cd0042133af08edfec25841d23c0b92d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56a82eaf250a61c16d89066d84805a14e10dab1c515a7159bcc726dd3400bfe9`  
		Last Modified: Wed, 17 Aug 2022 22:52:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5af38785f4aaa2dc80107cdc9935ca4f01c172faf48af2a5b6f7601d26506e5`  
		Last Modified: Wed, 17 Aug 2022 22:52:30 GMT  
		Size: 21.3 MB (21321771 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
