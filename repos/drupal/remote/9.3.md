...
```console
$ docker pull drupal@sha256:a06d07f248020b18563011e6a3b61fd491c9e71592e1cd18acdeca41b8033021
```
...
```console
$ docker pull drupal@sha256:f05735d4fb80222fae64add19eb5733230eb6b8bee3708bb504086978a510c74
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190739399 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1ac74240296b489a99456dcb1ccb1fdd0c08931bca2b15c15f2530e021cdc8a`
...
# Thu, 06 Jan 2022 20:22:54 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:22:54 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:23:07 GMT
...
-	Layers:
	...
	-	`sha256:456f2bb956723a755ebe6fb02e1447d08c66a7ad04a0b01066a41a75a4fda94a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd988f0b66423f825d2cbf5bbe90290f803c914b533414cbba98afafffd35bef`  
		Last Modified: Thu, 06 Jan 2022 20:30:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d283542e1ba4c27a8c9f24958eab3c7f1c8e0707bec9db5da8888bbe512abad8`  
		Last Modified: Thu, 06 Jan 2022 20:30:51 GMT  
		Size: 20.1 MB (20143313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm variant v7

```console
$ docker pull drupal@sha256:0ba125c561af424ff4d924c1094fc43dc4ac5d2094badc6697181a95c1938e73
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.8 MB (159830900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:744478005249c01a4d2db9b008b14b3ac2602b4abadb4cd741f298e400edccd7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:08:44 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:08:45 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:09:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:09:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec4a34301c151aa1d500dbcf5453a35305fb419a5892da9f38a2095f07b8a85d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0db8386204d0acfffed0eced0121998732147a7ce00854310deb0ab0304cb501`  
		Last Modified: Thu, 06 Jan 2022 20:38:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29b00d011d5f63268358d2a072449c1ceb220287878d6b11d92f938dbbf2dbc0`  
		Last Modified: Thu, 06 Jan 2022 20:39:07 GMT  
		Size: 20.1 MB (20143163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:677f53e743784d4d160cc7fdba08669c2738daefd69d8ba6208ec19dc13c6615
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183056692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b0d4cf285de77a9c32857e6c227ca2bc924fb5efc3be8854845b4d0095c74fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:44:48 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:44:49 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:45:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:45:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9036b3bb87124a1fedff2e14cea07de0c14283780ee819cb4ef4e1fbeadc3392`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65ff662910f2b73b8d6949f6c7e74dad3059677a1e40d310daa90c11355e7644`  
		Last Modified: Thu, 06 Jan 2022 20:01:46 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50a916d9e48c6980f0d8093c49737ade538aee87bc523dd80a7257f1b846fd4e`  
		Last Modified: Thu, 06 Jan 2022 20:01:52 GMT  
		Size: 20.1 MB (20146737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:f05376ecec78ed1986d775d57d3c6953fabbc5e97f596f4de866b816437e683f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.7 MB (193684109 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a6fc70ec6e6e4b110439aa7e916685b724ae5dd25a2c1fae97a4a543f4e7bd4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:44:11 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:44:11 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:44:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:44:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:05abf242384618b68e3f1bb9d6bc5bc51b96f770faafe57ea7161923f0f03803`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ff60b7ce9e9e51fe064718d416dee9a5ec363545c38ee55bcaeacab438c4c2e`  
		Last Modified: Thu, 06 Jan 2022 20:01:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4de7aa31c324a29e38414a5a9f5b8a2c329b36e84087316cb6242f9bbe1bc275`  
		Last Modified: Thu, 06 Jan 2022 20:02:07 GMT  
		Size: 20.1 MB (20143411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:ea0cb2c8769ffe7a151b26ec959feece0ce81647f77f9a819fa67ca5a0aaeb76
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191470379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18452b29511a2da756ae205b8f0be00afe91df8639e2b58f18ed9e2c74ff8f4f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:22:27 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:23:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:23:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab41bc27691a974b63d6c6ea48216362d9f8e025230480c8af375892cb7ea67c`  
		...
		Size: 573.6 KB (573627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61c5237df9e1c1bd430cb29724d65a5040dcead99655efbbb701c136ac01993a`  
		Last Modified: Thu, 06 Jan 2022 20:41:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd0bdbe0f210738f6a81a9f8f242b977abdb7ff4c38c6205dcec3ab55a856b93`  
		Last Modified: Thu, 06 Jan 2022 20:41:58 GMT  
		Size: 20.1 MB (20143358 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:1df971db4307f2920363a804cd040026633a11c810708fccadd951e831644ad4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167406118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2bd9f0eaad1b4dd5fc5139eb4671a9a3ca2bed8977c0b3c990d49f62db72cd3e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:52:35 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:52:36 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:52:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:52:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fb36eeef651a90e1e87030857df501e19fc0fb1db60f77707dff6fc3c79816e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd2b98097e1ca7bb67ff8c643dc2ca8cc00bcfc5ba198332b5d600941af97de5`  
		Last Modified: Thu, 06 Jan 2022 20:06:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:880dc6eb0614a9bb1bba4ab19f8f65616b5535f2a122fe86963db09a9afd5593`  
		Last Modified: Thu, 06 Jan 2022 20:06:39 GMT  
		Size: 20.1 MB (20143527 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
