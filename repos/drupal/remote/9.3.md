...
```console
$ docker pull drupal@sha256:a6e6a860cafd0f547e7de2c0b2d8186423b0a88865d58e2437eeb691103723df
```
...
```console
$ docker pull drupal@sha256:fa4968d2e5485f55b27214409a1d5c6ea6d09bef660f1b17352e95ad934f9a32
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157975073 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:212c70fc8b481695afe67a5bbdc25adb5cd7895c9722571d3d496c19c14beb09`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 07:49:01 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 08:01:20 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 08:01:20 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 08:01:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 08:01:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0f38452538d4ed7636368754c6239ae110de8982d565a365a9ccbaaa915b28b8`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e048f57f66f18247b40d80d994380cc0248e9260a47bdebd73d7b298ed74b9e`  
		Last Modified: Fri, 05 Aug 2022 08:28:36 GMT  
		Size: 670.4 KB (670416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cd981316e42468d364f99f2ebd63a4e8ee04e98b84f3f16e406db9a0be81d3f`  
		Last Modified: Fri, 05 Aug 2022 08:40:16 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9b408656974f23fe3bb0cda40d8aa7397fb0eb066832fee32f9b7c90783736a`  
		Last Modified: Fri, 05 Aug 2022 08:40:28 GMT  
		Size: 21.3 MB (21321710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ffa26fa5e7c13041f31090daee2a71bd5cf45ef08007578c87158595940547ee
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180789289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:856c1cae2ffba9dde06081592ec01372ed9276bbacd3b8e28318963abb362367`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:54:03 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 00:54:03 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:54:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:54:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6e7a46be7b0ab6c972f549e228735dd494c05bf2c82f7e8d6831b2154ef8b6f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb641bf89a9635a12d3410229f3d45419ea74514a2f01fc8724d9f583bd0b755`  
		Last Modified: Fri, 05 Aug 2022 01:26:05 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6de0dca4d3569213b27cbd51a531a305809793d9850247f23c7813bf67d709e`  
		Last Modified: Fri, 05 Aug 2022 01:26:11 GMT  
		Size: 21.3 MB (21321742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:b028906a35af61e67f10175d2dc114b70a194aa0b229cca179cb012406dc8b5d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190638549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a78202c1082cd78f76025cbcca41e69b367d9ad745aa667d391d1aafbef40990`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 23:59:51 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 04 Aug 2022 23:59:52 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:00:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:00:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a1390672696282c80a84c3c942c4074787d84a2af6368926cb0b22b7791ee0e`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efe5422449baf57ff3f2a2ac16540249455947347c9156f4d08de718a6510acf`  
		Last Modified: Fri, 05 Aug 2022 00:23:27 GMT  
		Size: 670.4 KB (670422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fe17f4aa3a2f34a241c5f982bab0c903fa69301bdc7df88b03ff86a1d9e6e3e`  
		Last Modified: Fri, 05 Aug 2022 00:32:22 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2a4fd681a5db6cd8c5068f24748512ee3c0ccdcde4e7c00bd0ecbbcee65dbb1`  
		Last Modified: Fri, 05 Aug 2022 00:32:28 GMT  
		Size: 21.3 MB (21321807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:373e125f7bab4f97c125ac31083856bfcd5db7767bee44a6db984497b0de9121
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188833973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39ecaa2077cb46e65ce5a96229f3959350802ab15ff75589d06e61cb3dc45f53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 00:05:53 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:15:58 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 00:15:58 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:16:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:16:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e66e9e314da6969faa21965f202b2d682c59e9e3d5158a0f826335610d9012c7`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2047428093c5ddca681325194254729ded03f4971bb8a1a66e4d6002e4286266`  
		Last Modified: Fri, 05 Aug 2022 00:41:50 GMT  
		Size: 670.4 KB (670413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7f030ec530af432b4260cdb76a30a197848ca4caeec8a95a50519f1fadcd997`  
		Last Modified: Fri, 05 Aug 2022 00:51:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80634891f51ec3284a92f868308fa0dbb4bb9bb54c2b36f96793c163484d35c3`  
		Last Modified: Fri, 05 Aug 2022 00:52:19 GMT  
		Size: 21.3 MB (21321687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
