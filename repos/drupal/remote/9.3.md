...
```console
$ docker pull drupal@sha256:f22e9cc62744636bb09658f689059f0d0a2fe5b6ecb28b91d86cf165e55fea67
```
...
```console
$ docker pull drupal@sha256:41e83937db4e495244fe08d6449b18949ef629c3857db5508688f5724b6b05cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.4 MB (159397710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a910cf326721115a5a237c41b260bfc6a903ced1b2320dcf760bf49d730d46b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 02:56:07 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:36:08 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:36:09 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:36:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:36:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00e85f5ddbbb5b1996898b9c1d99c00f0c123fc87d721b9fe85c2b754c25d840`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38e6d9d9609acfe4ff5d18b6f2898fa7f52cc46ef81ca9b37339985b71e0c388`  
		Last Modified: Fri, 08 Jul 2022 04:04:03 GMT  
		Size: 670.1 KB (670060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10894b46027219253e086486f47d7d1225b0edeac7bb43d99369e0b3809a8e4f`  
		Last Modified: Tue, 12 Jul 2022 02:22:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:103fd0aa72f1f8d418675560be9db85434e9b33b4d9c0ed75cf53d2b208d3d1d`  
		Last Modified: Tue, 12 Jul 2022 02:22:55 GMT  
		Size: 21.2 MB (21216558 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cdd24f3df0003ab3cef03f22772a8499cda477a223cc31f3384c823229fa10b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.8 MB (190788155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58c044de61fa6ae84ccb03aa62ba6429dcb9f0e9daa17d4b21f66ce9e785322f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 05:45:26 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 02:00:55 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 02:01:02 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 02:01:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 02:01:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c5eb3c44bb2d931891793821e04ea434666dff74286e22d1d69c8a722b06b700`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5291e9849b1171d50925b1aab85a92a2a51b64a581a7a3d9b1ea13cb4e22b8f`  
		Last Modified: Fri, 08 Jul 2022 07:22:10 GMT  
		Size: 670.1 KB (670060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a27abf06f3a1bb797b9f363aefdd2dd0bb30cc992927c4b1af96e130732a9f03`  
		Last Modified: Tue, 12 Jul 2022 02:41:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a63413d915c44907ed00030931c3b7450325054d4026ef076acdbb86bb0ccb4`  
		Last Modified: Tue, 12 Jul 2022 02:41:57 GMT  
