...
```console
$ docker pull drupal@sha256:2ffb342d37b40bdee8b6d19e9e998e1e6951628cadaa93ed3c6fdf6c532833bd
```
...
```console
$ docker pull drupal@sha256:af1bba8d3f480c7bf427a1dc448643a1742f33f78c0815ae067cab547a4c814f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188299077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2749a38807d56b32a3b7902b35ef2e09291e1744f83458d3ff7c1ef456f6a092`
...
# Mon, 06 Jun 2022 18:31:25 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:31:25 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:31:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:31:36 GMT
...
-	Layers:
	...
	-	`sha256:45e909cfe688dac465f4fe6058cadb381faee9201a39b12b91fb738432fd8ec0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3573ea33d40dcbe9e44c13a79e363ce66050f4cfc0e9b4ebcb5ff9555a637042`  
		Last Modified: Mon, 06 Jun 2022 18:47:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:410e93fe9032ddaba857289f7daf4c46661bc1feec8fcfe1fb43be1635692d74`  
		Last Modified: Mon, 06 Jun 2022 18:47:29 GMT  
		Size: 21.2 MB (21207319 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm variant v7

```console
$ docker pull drupal@sha256:58e5546b198001d4ae8070bdd2451a3a64166d0ba99249b7e8f4cb9aea08cc3d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157827581 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88d78ba7f7072f5939913d9dce4e2d51a3772b3910faa399c5e833712ce03463`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Jun 2022 17:08:59 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 17:08:59 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:09:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:09:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2b6b762c7ecd2df8adbdc8229bc2749d920d1b0ff08847837fd393c89ce375e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e686aa9cc6016668fa9d880c954548177bfa078fac1a75bd833a737ac76657e8`  
		Last Modified: Wed, 01 Jun 2022 18:03:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97c00ec39d36040ed1c7d6b544b4dec8385bae1ea057d051b58900f09952fb54`  
		Last Modified: Wed, 01 Jun 2022 18:03:53 GMT  
		Size: 21.2 MB (21182716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:1d419e0542d33aed4cd9635455051998e07e77fcacb84d82b0d9d97763abdadd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.5 MB (180466179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d643f1ba41faff7509170fa5d7efd2e75271aae8e305f0fdf6e2576392a0f2ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Jun 2022 17:54:27 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:54:28 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:54:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:54:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c6c2839a10ec088dee14ced499462dd95a11fe2b49356bea777036945faa388`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a30946cacc7f1ada833fc6e2df96416e981403df30993cf6f142b6f2478f8ec`  
		Last Modified: Mon, 06 Jun 2022 18:21:06 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b72ba4ffc02dd6a486ccd4ae7b59f1c2c8de4037b4966e22926a35f0e150fbbe`  
		Last Modified: Mon, 06 Jun 2022 18:21:11 GMT  
		Size: 21.2 MB (21208489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:8d9d17187d0c858edb495e0d93bedcaf83bc8653851cfcdd2a50dcabb994ca64
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.3 MB (190309591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27f03f329b4b04d61b171a5502610c8b21e127e0e6ccf48b4d155d07be71695b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Jun 2022 17:49:19 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:49:20 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:49:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:49:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e779e0eb2290a33811a19767e5a7be1aeeabf62949a09fc4855b08f9da523f9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27d04aa6fc34573e6142c6721b50d947e69cc059daa4bf4c8e4ce1d58b21aefd`  
		Last Modified: Mon, 06 Jun 2022 18:14:31 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36820b0d1f0abab561146364bce718b27114e0261b3d40d7d89e2da0e27eb643`  
		Last Modified: Mon, 06 Jun 2022 18:14:41 GMT  
		Size: 21.2 MB (21207993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:7eacb8bc61182574f1189f4cc295fa402045255e93970bca1e24fc45f0b63b55
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188674705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09220939ab14461c321f912537f8ad53c5a9de507fdf589666be74dfd21a3f45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:25:42 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:25:44 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:26:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:26:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:30f12a0dd93497a57c78b60c45f76b39995daa37e598da06d52b5dfde2065db6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1ce94fb4e34f5b8dd60437f8a86cb0f43d66977eb0a18c10718cbd431171e35`  
		Last Modified: Wed, 01 Jun 2022 17:12:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad5e82fd025a41c460f37a06e32b52790e52f26dff1a9dd5114b903610dc361d`  
		Last Modified: Wed, 01 Jun 2022 17:13:55 GMT  
		Size: 21.2 MB (21182772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:fd442a3d17beb781535bd447fa2fce9ca7a2d9d8c99b7c46c234fcd54ae54b15
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165154609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ba0dddc21c74537985c7aa4aa78dabcb2a6dd08c17670602716063db5764c81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 05:02:23 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:54:37 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:54:38 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:54:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:55:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8a80cde5a559a94231e7909f11c9c929cc066754da96db2742fa3c8f154662b7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74af3d7d65b91dea84ccd6fcbdc03fe5238b362ca9e6ba66ea199ac0d3529bd5`  
		Last Modified: Mon, 06 Jun 2022 18:22:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de8159cac530f5aaf8be9d3c61670c88705c5b5a8f9b725aeadf2b1aa349f49e`  
		Last Modified: Mon, 06 Jun 2022 18:22:52 GMT  
		Size: 21.2 MB (21207422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
