...
```console
$ docker pull drupal@sha256:4e3407774da4b8b68c28ac549a651802f528ca06c74bf19a1557ee007689a9c7
```
...
```console
$ docker pull drupal@sha256:64ad48f8622748562cedfcd6e63266304961a5d2f3b85d3c1e530299fb27a9c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188574472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:566864a93debe02c752ed7e11d691da882ebbe327922f4b0417cb16e93c10cb5`
...
# Tue, 13 Sep 2022 18:44:25 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 18:44:25 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 18:44:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 18:44:39 GMT
...
-	Layers:
	...
	-	`sha256:f6eb7b2be8e25766dd0ea052f9731c11ccbab41a7706e8d93de25b09b745054e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:503960af89a662674984fb134470b9427304ffa2274fbda984e4f270c578e7ab`  
		Last Modified: Tue, 13 Sep 2022 19:05:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:565c623fe25a9e613fc933b6011a99fcc62b8b0ee942829da9d11416b36700c2`  
		Last Modified: Tue, 13 Sep 2022 19:05:49 GMT  
		Size: 21.3 MB (21322405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9f9909b5e095dfaedb83fc94fb971395378aee48c1ffe272cea932deb7260f23
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158077590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7140b58976a497b164a19a0414a90bb306f6561a2498f6acc846cf23af4ec719`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 14 Sep 2022 23:57:32 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Thu, 15 Sep 2022 00:10:14 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 15 Sep 2022 00:10:14 GMT
WORKDIR /opt/drupal
# Thu, 15 Sep 2022 00:10:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Sep 2022 00:10:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:62becc3cefe46e396e428adb295f6955cb6f9c8e30218364465235a695a23636`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8deba5b2015f6dc67189cce89455af461a15c1e15936a82decfb769b7784599`  
		Last Modified: Thu, 15 Sep 2022 00:47:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a7abd5d276edd935012ac8defd030ab15008ed8d19838bee5db2791e5472389`  
		Last Modified: Thu, 15 Sep 2022 00:48:09 GMT  
		Size: 21.3 MB (21320503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:42b27c45a1b1e409caac21daed81cbbe76b23e18c33a04d6a646e2db66f470e0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180890695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7415a2823eaf3d943d8d46f6fb469b97b5dde43088fb666f4686f843b00a1d72`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:14:25 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:14:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:14:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:03c3866688d8b11251d2d0af23c812d4c216a35616bc391726dcc90ad70197a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec917240db4468e80f25c2fe81337520f10420fafebe14163f5c6342f036c16e`  
		Last Modified: Wed, 28 Sep 2022 00:51:30 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71e3c14893589ca2944eae931168a89b90758f0ec00cb906d9ac3bf28b64005d`  
		Last Modified: Wed, 28 Sep 2022 00:51:36 GMT  
...
```console
$ docker pull drupal@sha256:49d76ce10744e122c7347f8fa4403a0213d8458faf241879c3436f31ec6fdf10
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190744123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9eb1770aac576e762d01fdac05f1c3f94f7154ddd6f0c2ac6854166c7160a121`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:09:32 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:09:32 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:09:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:09:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:80be50fc416b69b3c14ab3f814488e64bc7a29ea87a2c897405dae40f77436b7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47255617e1bf1f67a6d9210a7c8c508aba01876c563e59a0c792a23c141906a0`  
		Last Modified: Wed, 28 Sep 2022 00:46:47 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4061c52284309c11fdbe0837ffc1c270ae402e6489dee517673cdc944cfb775`  
		Last Modified: Wed, 28 Sep 2022 00:46:52 GMT  
		Size: 21.3 MB (21322520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:dbff099852efa7fe72a9f38f7798fa676ae26ca49e71b8836fe86371e0a05f16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.9 MB (188932321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ac74b7b0eed5cddcb26fa2d702a8463768f79da0c5d4c8dd75abe80cfcef639`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Sep 2022 17:53:00 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 13 Sep 2022 18:00:52 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 18:00:53 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 18:01:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 18:01:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f45f3540170962ca31a51083ebd6708e240b25f70fccfd362e417b9cf95f0a7f`  
		...
		Size: 692.1 KB (692052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2b5ced3a99d118e2082716504b77457896181a3322895afbc627bb78cbb9481`  
		Last Modified: Tue, 13 Sep 2022 18:26:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3f2ca2c8a7997d015781d159b0950e9209256921c3fc3fd12b4cf46f0005d5d`  
		Last Modified: Tue, 13 Sep 2022 18:26:42 GMT  
		Size: 21.3 MB (21322517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:02083c4388d694d5de0937082e7b6ca0e13e7be6e30175fa5b597b1954484d59
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165385890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:362e527ee5ad3c8e353f994e89978ab3b9b188288c5231d0cb573648d158ab61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:09:29 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:09:29 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:09:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:09:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:71aa9c33a68234845f66be24fcc84cf515d948a5313831e77cc8a82f0e2b4635`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a336465b1e1a233e42a9ac284948d1f87dc2f69749d991f50ac467f3a2cc020e`  
		Last Modified: Wed, 28 Sep 2022 00:31:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04fa8b60ad892ade929cf329620adcb37b0677a527e9154efc16fcedaf0eac80`  
		Last Modified: Wed, 28 Sep 2022 00:31:26 GMT  
		Size: 21.3 MB (21322503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
