...
```console
$ docker pull drupal@sha256:196ad3c47ff62b5ae90bcd291271191a0abb2f4167ff91e129be5f45aee41a87
```
...
```console
$ docker pull drupal@sha256:5d73ecc8ef8996f8bb5762184910a758a13d789b59049fb962475fc15785a6c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180692881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00c03db01f2c439a6d7f29cd51653b15b3cb5c78c388baa80b98937391f0f1ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:52:23 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:52:24 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:52:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:52:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6f20bff0b73970591a41fffa463cc80ac37f4d85f421cdd752d9c614cc59a4d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:845b13322c4cdfff2559721b89ef931253eb17bee76a9515536947e2490c5d00`  
		Last Modified: Fri, 29 Jul 2022 02:23:55 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f529f98ac9855f5eb0fbbd1c0006a92551301d6d598fb8dc1365428adad5d2bf`  
		Last Modified: Fri, 29 Jul 2022 02:24:00 GMT  
		Size: 21.2 MB (21225255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:77ba0cc57d6435756b68ecbc30c4c61229a64a1961f55906377151094e839697
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190540461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b9485b341289f26f7768604839638e35b210c5519d0f0ba3cf4619a245f7837`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:49:32 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:49:33 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:49:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:49:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1c8abacf455c0ce45ee8ff63ca530489afe0d856b98272921ee952335f31f8bd`  
		...
		Size: 670.4 KB (670417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6d02d3f3b5569ec9aa4c8eeaa91ca82caaf615a095be6489e2ed9ada913896d`  
		Last Modified: Fri, 29 Jul 2022 02:21:44 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:798d6c88044c0dedaf8e6c919773acc0a48f4fbef567d54f19ea44ad404b41c9`  
		Last Modified: Fri, 29 Jul 2022 02:21:49 GMT  
...
```console
$ docker pull drupal@sha256:732d6aacc54e0a6fff57c006936636f5c9624b456de7b3c99bf2df33af88a8d7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188730805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7fcde57a3622f6b381020b7ece8ae775d8f2e988aff7b11bc307199371eb062`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 29 Jul 2022 01:33:37 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:56:30 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:56:30 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:56:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:56:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cb209dafb3ef0d11cc7f66bcbc58468a1ad039cab764e3b9e42b4f9dc8fe12c2`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:931678cfb7ea96476ed029e0d78768594986bb9f699dc90e1161313e9935c685`  
		Last Modified: Fri, 29 Jul 2022 02:28:49 GMT  
		Size: 670.4 KB (670423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b91df7cee706c587fec73b857152d3662c9ef71d180c49264fc6ce49fb46e30`  
		Last Modified: Fri, 29 Jul 2022 02:46:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a70a3bc675c0efa32951d8ac20affaaa7026da87f84a99c3d0ed2cbf81e6c15`  
		Last Modified: Fri, 29 Jul 2022 02:46:31 GMT  
		Size: 21.2 MB (21223038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:8c37b5499a0b4ced615e4663064a7834b202446ac01558dc7fe46cb4ce3d4716
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165195058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64bed8bfc92533ae26e97e1b2286610315d6a1f1f72aa3342699b9ca9f5395f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:55:45 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:55:45 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:55:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:56:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a0ebf3ac567c7358ab70c00859c36e7ba3330ba4ced88cb9aacac4e1d4cb1ca4`  
		...
		Size: 670.4 KB (670415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a8f30ed80fe60026cf3c9ac2081fd1d30dffc42230ac26b4da820da56144dd8`  
		Last Modified: Fri, 29 Jul 2022 02:22:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a0da33282c12360376d17ae77e96af3f1e9d9796d2e2d5e09660921207ba37f`  
		Last Modified: Fri, 29 Jul 2022 02:22:51 GMT  
		Size: 21.2 MB (21223006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
