...
```console
$ docker pull drupal@sha256:edd1e36fb18f4b4a54a77c990f512f3be6b96f274879e3a643ed0eccc73e4dad
```
...
```console
$ docker pull drupal@sha256:4921e2d2776682650b733b5ab06e295c44466a9c04c55c15014df2dbfd17ed7d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188575083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5657fe6aae0270138c8b6b777e3ea75f09f91f01b9d54b698af76fe4db4c949`
...
# Wed, 28 Sep 2022 00:58:39 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:58:39 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:58:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:58:51 GMT
...
-	Layers:
	...
	-	`sha256:570ee1a8816ae2f1b65b5cd9d0ee44769a4c5abd0fca06c4367d53444079097a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c9a2f6782543f2a69d5f5bc874e50371e124ccd04f596150c4236e8f8ccf4c`  
		Last Modified: Wed, 28 Sep 2022 01:23:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bcbac87eb615f2e2066207b4f845fc0e224155dd879f88c29e1e2ffd2503987`  
		Last Modified: Wed, 28 Sep 2022 01:24:03 GMT  
...
```console
$ docker pull drupal@sha256:db16cfb533cc72e2251ffcee8d0385bf787138dd43611df9218dc22280a85b1a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158079838 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1729407803a21313b5b3116020cff289f35717e7b188a88f81956256e013d950`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 28 Sep 2022 00:36:40 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:37:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:37:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:04a80bf777c21d78a250b75b8259152486f57fa18e9b772867fdb63faeb26a8e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0ca9bffb4e8f714b697d97ecd416857be2a5a55d8ef796de8f140e0f157da40`  
		Last Modified: Wed, 28 Sep 2022 01:31:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b26481f010bc6a940f0d028f5a872d9975961a78690e36b507256bc8916c3cd3`  
		Last Modified: Wed, 28 Sep 2022 01:31:56 GMT  
		Size: 21.3 MB (21322209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:21a461a9f31f7b937f73088740105700b7408199cf27b74472a1f5bcbf754adb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.9 MB (188932619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd51980da918db7de0696315d423a4e9f41a329c70414d95e9789b24fb2546b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:47:46 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:47:46 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:48:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:48:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:025cb78b66eaa19c4d44460ce613945e8f9d1215a2577c3ff03e1aee94642f93`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00c5394d73ab45efd721795bca6b2f7466a606750d536661a9bb36f84012564f`  
		Last Modified: Wed, 28 Sep 2022 01:24:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5643bcca08ea535a55fc23bfe9fe390fa3b651a0adcca297e37b130cb7a47c01`  
		Last Modified: Wed, 28 Sep 2022 01:25:16 GMT  
		Size: 21.3 MB (21322277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
