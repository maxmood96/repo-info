...
```console
$ docker pull drupal@sha256:197c72c5bfe884a359e822360f3a00de110b5a565b58ed856439d184b4125d2c
```
...
```console
$ docker pull drupal@sha256:743d6ae80c0ace825931c72bca3b5d5b3fdedb5dbbc54aa057257171fe28f731
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.1 MB (180088139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea58761d845885c1f849d6f958ebd069623d75a7e4c226100d95f3af1e0b1e0c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Mar 2022 18:08:55 GMT
WORKDIR /opt/drupal
# Sat, 19 Mar 2022 18:09:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 19 Mar 2022 18:09:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:873b8eebaa6f76b3130fdcd1c4c94439ad1a1c91c7e2422ec9f33e62f8284f1b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e2da5f90e3203d93b0de67e7b647ba1c76f25b920f2efa1824ecfe1a3d08df7`  
		Last Modified: Sat, 19 Mar 2022 18:31:26 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a28926d6ae0e0559dfb7bfe52491ad8eee9a962e192bbc0a51bb7226cdbe837`  
		Last Modified: Sat, 19 Mar 2022 18:31:31 GMT  
		Size: 20.9 MB (20946756 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:5a19bfba9fe1423d223aa345d26a7764da604900688d83ea505dc81956ab2e9c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.8 MB (190786294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b65253bd5c13f84171d74321bd1bb542a29cd4a5111300d821512c3e4b483828`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:40:10 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 22 Mar 2022 22:40:10 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:40:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:40:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:321ac4270b19af6e953a67c0406f8aeea32bbaf231c6512b069a269456d39dc5`  
		...
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ced3e0781dbbcfc34037622e0713212035d14e9d64bdd21001ec3aa7b92991a5`  
		Last Modified: Tue, 22 Mar 2022 22:58:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd9712e7007e546126d1f2c9ca0d3bf0d6cd1739b270ca05e0e42ba76f9a9030`  
		Last Modified: Tue, 22 Mar 2022 22:58:26 GMT  
		Size: 20.9 MB (20945061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
