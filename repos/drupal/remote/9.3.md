...
```console
$ docker pull drupal@sha256:f28602d481a60890c2b6d18611351a8e03d9426e8b5462daa3459014a9ad7ae4
```
...
```console
$ docker pull drupal@sha256:68d574bdd28dc8e8c38e7828392366f925fc509ccf02de780218b24665da95cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.5 MB (157493821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff51ac42eac4072a5575e0b717573ad0b0c61dca5ad20157a0d21086904fe5ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 29 Mar 2022 11:22:52 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 29 Mar 2022 11:22:52 GMT
WORKDIR /opt/drupal
# Tue, 29 Mar 2022 11:23:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Mar 2022 11:23:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf89e24484176ecbb28d4bcdb7314a9e7e15ae6a526b4c0783201ec577bd9e59`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbab31fa1af614d835469b9b4102887f941904fb160b77a2886f9c2f2241c122`  
		Last Modified: Tue, 29 Mar 2022 12:28:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dd408d8471c015283c62be2e2757201969a7acbc0893f5c5225bba5faf0c357`  
		Last Modified: Tue, 29 Mar 2022 12:29:07 GMT  
		Size: 20.9 MB (20949275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:94ed07d8ff01ed1c2d397bce9c04c49b562abf622e7d5069ee93886f4de39da3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.9 MB (189943365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c20fdd90f68691d892003beff9ed60652d8430190175bdfbfd7463860fe240ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Tue, 29 Mar 2022 18:56:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Mar 2022 18:56:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:717dbf0dca685cc82cf83869606d31e02b4d378ae38c8b55dfb66e2a80ee860d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c667058b90a97ea2ee18e684a0a44493203354c8bafe4ae381c0d26dc873bf4c`  
		Last Modified: Tue, 29 Mar 2022 19:25:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e18fd1e40d3492d1104c4dd628231de3add56b6c95cb78337a19fa39219dc11`  
		Last Modified: Tue, 29 Mar 2022 19:25:41 GMT  
		Size: 21.0 MB (20950514 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
