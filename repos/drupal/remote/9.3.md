...
```console
$ docker pull drupal@sha256:9240336bd4dc97ca3c4d1dac4e55720aca6fbe3bbc9998f984e375b1b2ecf969
```
...
```console
$ docker pull drupal@sha256:40977e23bf63255e80e20a1dc5a95fba15bc05232c74c8674b8ee7b0d9dd093c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.3 MB (188311054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b90684b0d90e00b1ef92691d6ef56f318cae63ba3d94d164bfae0fe2adaa0f9`
...
# Wed, 03 Aug 2022 08:45:09 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 08:45:09 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 08:45:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 08:45:21 GMT
...
-	Layers:
	...
	-	`sha256:9b1dcc252df0b5a192c703e164da75c20f1681ca6dadf30a07d058647ec33f2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec3cda0a4e290b6d9aee1ffe5b142e1c5c653fc14ffb7d7b82053bbeeb829c1a`  
		Last Modified: Wed, 03 Aug 2022 09:05:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360e8df06c0488e8934951cd3199730f3fa30ba477baee5de8ebbe66ecddb47e`  
		Last Modified: Wed, 03 Aug 2022 09:05:30 GMT  
		Size: 21.2 MB (21224008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7539ddee2515c379564318bee8262ce9acee3d432e40e4fa0bdb20d3535a06a0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157877288 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01869ddd82a23c68252b0963abf6ac33192386a9e5ccbe19a4f622cf29cb8288`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:09:54 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:26:14 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:26:15 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:26:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:26:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:241c35f36a2f446527d097c82826424f677cac93679b2aa42f77cd4ae55241ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bde465c5ea706fa5d54c9b3c0a7931f38e0bf4d2009434231b0608035e249ca`  
		Last Modified: Thu, 04 Aug 2022 10:14:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f61f99b3d97b064227d7cfaf4d3e928a79000150602ebb85b966a08d66850a8`  
		Last Modified: Thu, 04 Aug 2022 10:14:19 GMT  
		Size: 21.2 MB (21223891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a95c29908d44a1d4681704ee01780eba9b2a33bdee50b5e6aabc974939d7a777
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180693733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:707f4d8896fac6b4f87155a9dfec540f8becb06c4bf389a65832d42af0e56748`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 06:19:02 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 06:19:03 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 06:19:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 06:19:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fc632f49406d0cd4ffcdb510591720b9191dbe22ba08b83d52e8ea452febd479`  
		...
		Size: 670.4 KB (670423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:599e45a0ee1129f50c364591d19bb15f03c6513cad6cd35fe080fef17b45b185`  
		Last Modified: Wed, 03 Aug 2022 06:53:24 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a31a91b055c20170efdb682c4dbc8cd165c38d9d7929b24177727d2c280d896e`  
		Last Modified: Wed, 03 Aug 2022 06:53:29 GMT  
		Size: 21.2 MB (21226088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:779451ee37a6550388455c33323eb07992d94b6f0ed7bed218ee66205a1f7317
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190542335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57c45d430cf0455dded5245b1a5256a51dd5840d5e846b571a0a954ffc75f372`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Tue, 02 Aug 2022 18:32:41 GMT
ENV DRUPAL_VERSION=9.3.20
# Tue, 02 Aug 2022 18:32:42 GMT
WORKDIR /opt/drupal
# Tue, 02 Aug 2022 18:32:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Aug 2022 18:32:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b855545875ce0b6ab78bd881434f442c0ba1214e49ea5433851fcaee717bd456`  
		...
		Size: 670.4 KB (670423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b61bb0a9fa1eff0430b35d32dc16c702875196381e35b3ba1bc0b0d8abcbab61`  
		Last Modified: Tue, 02 Aug 2022 19:03:32 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46ecf1daac85b6374ca8f522c781f229b2379262bc31b2cb42ddc5d26ef62d9a`  
		Last Modified: Tue, 02 Aug 2022 19:03:40 GMT  
		Size: 21.2 MB (21226111 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; ppc64le

```console
$ docker pull drupal@sha256:5a42bb556f3fa7dfbf9a4342a1b99c7c8aead6a774ce3c6ee6836cad6f09fcdd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188736323 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b4e06cdb2d296a2e75018b53c9bcfd73cce5b6db52351105cb6882eccbf3bc3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 03 Aug 2022 12:11:43 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:35:33 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:35:33 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:35:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:35:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b6fb54d3a4711c9426861d42f0f8bbe9eb5ca13f935dc1ba348479f60bef818b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23f8cc5ecce628ac383f703d315822f9ada530442d10fb4b3eda8fe23e144b1f`  
		Last Modified: Wed, 03 Aug 2022 13:27:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:354703299725193dca089304b95051527488100732268c1da3af00008e45220d`  
		Last Modified: Wed, 03 Aug 2022 13:28:03 GMT  
		Size: 21.2 MB (21224356 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:fa60fbac92a1e86a2f7d49c669f5389f8d1db15cdc64ffd8cdd5699f001ea368
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165194380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e39d7eccda47a26a32a0ec6d060ad4d31644d6ad0275ef557ba04acb1ba40d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 02 Aug 2022 20:43:44 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Tue, 02 Aug 2022 20:54:20 GMT
ENV DRUPAL_VERSION=9.3.20
# Tue, 02 Aug 2022 20:54:20 GMT
WORKDIR /opt/drupal
# Tue, 02 Aug 2022 20:54:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 02 Aug 2022 20:54:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:468eb50307c8733f6c2a18ea35f0262de32e0ad01a8b0abc7b486504e15fcf19`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84f2d5f6ea6d81bbe2ac90767c3336f656f08de49bd3cb854c09b243a4baecd8`  
		Last Modified: Tue, 02 Aug 2022 21:20:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:351e9a5cef5a342a9712c5f2e93e93c3149259e58bf2d4742170191db9fab473`  
		Last Modified: Tue, 02 Aug 2022 21:20:59 GMT  
