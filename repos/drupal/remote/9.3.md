...
```console
$ docker pull drupal@sha256:d6ad0063e3db6cc795a55ac2714bddd3ea52086c5386672af3214d4ab10d795a
```
...
```console
$ docker pull drupal@sha256:7820614ccc818bfeecac96e431485e04f46afc40d2617dc43adeaa9a2821e48a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180430226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f3281e07ac0c8f89d90dfb724705fb7af2b68a5d351532b679c969f2e4928ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 May 2022 22:31:23 GMT
ENV DRUPAL_VERSION=9.3.13
# Thu, 12 May 2022 22:31:24 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 22:31:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 22:31:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1baf1e2e4ccca9183380bce752a30f1180bd8ab2db26736dba996ce337301929`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75c2108e358fd92fbc428a434bd3441137e5513d7eabd2b31fb95172ecd2ba1f`  
		Last Modified: Thu, 12 May 2022 22:54:14 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cacb63c9236ee1cfc104176775dffe65990ad06bd7b2fa83a1c6b53fe209a9a0`  
		Last Modified: Thu, 12 May 2022 22:54:19 GMT  
		Size: 21.2 MB (21182345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
