...
```console
$ docker pull drupal@sha256:88115b29fe53ec74f143d5d88185af71b12c6b18305b180cd4185b003b89f75b
```
...
```console
$ docker pull drupal@sha256:b6c42ec9de6e3ee6b4efe6c560b663a2fac7647516d181bacc538b3a605ad0e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157860263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fefed92c7dc64bbdf525a83020f2b2ed630c6e44cfa321452d8cf9bee0e3c06`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Jun 2022 18:23:11 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:23:12 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:23:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:23:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a5dca0b7da1aed17dd5147da33289b0d73e45863ff4f4137eb74e46aba93ee47`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ce8e33e3801bfda66eed7a86bf539237187bdd06a5d139ba7db3accf696a5d1`  
		Last Modified: Mon, 06 Jun 2022 19:17:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bfb79de21993ba057d7922f8d3b92f47f399901ff197df2dbcd6435355400d5`  
		Last Modified: Mon, 06 Jun 2022 19:18:22 GMT  
		Size: 21.2 MB (21207141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e61dfcfca42e78986270c5cf35136074b1d652d39723a88758fa5670a928c806
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.7 MB (188707331 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c493c3611c19d2ff7ba2032aca0efa793250760f393f6ca718b05a7ad16ea01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:51:11 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:51:16 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:52:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:52:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e714660c025299f32bb3353ca34f43d58d5678a7d3cc1fcf2601e3818e258bf4`  
		...
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38a2b6f07a5108e2530ccf880998a453a7c0aa58d6acc7af70322d23ddfb7453`  
		Last Modified: Mon, 06 Jun 2022 19:49:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63a2cb2a62688a3e1d4afd4b60b03d687745269e34646ee4e42c750bb8d922f`  
		Last Modified: Mon, 06 Jun 2022 19:50:54 GMT  
		Size: 21.2 MB (21207140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; s390x

```console
$ docker pull drupal@sha256:bdc35e389e83f40ca0f5b285eb143c2d690d087e03ccb734ecf6024c5a9d56c3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165162814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ab81a42f271c3b27cf326d2876a08569841e3eef1a70ccd3f21b3741a67fa14`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 07 Jun 2022 04:19:25 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:19:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:19:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c5183df51d4f83b41bfb22b1245090ca5a9813bfd9513f808a639c8d29c6f659`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4896e904b5df3489b436607a69940ea57e70addf6f8c9f6c2555c9ab112cac98`  
		Last Modified: Tue, 07 Jun 2022 04:48:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c822c2556cb3e8c03783cb7168133a8a9ad05c2ad92bc641f8fc41ed42c92768`  
		Last Modified: Tue, 07 Jun 2022 04:48:10 GMT  
		Size: 21.2 MB (21207369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
