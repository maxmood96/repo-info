...
```console
$ docker pull drupal@sha256:38c72586792c8909083c6baf782c345166a902994be4811e9d96ee33a52f77b1
```
...
```console
$ docker pull drupal@sha256:e551aec8772f3145f11f971b325f9c4cb0cd924e66e57057aa57edd9f517ae7c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190743723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfe5b2fecb8e0c1118bae2f61ebcf7c3c17718612b4980c2f3df83d6f3844b8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 18:26:57 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 18:27:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 18:27:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1e1c0ef9e77ebfc23597d65f6b5fa4a6702cbecf74160a0267b40e2aca8ceb0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8db5735b8202db1538f72e638f7d92a7c26d08160aaf04525dc27a3b341c7e9e`  
		Last Modified: Tue, 13 Sep 2022 18:59:21 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c5efbb0a4749785556778874783b7eae9609980caf3d889610856a4232b0271`  
		Last Modified: Tue, 13 Sep 2022 18:59:27 GMT  
		Size: 21.3 MB (21322660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6a4e26e547e208c0e67059f3c705402281302ba35bea61110e16392197c4872b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165385355 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc9568aca975eb0f2f3b05bdb4027110abe4f86ef583aa028b5ee750e7b65421`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Sep 2022 12:52:50 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 13 Sep 2022 12:57:59 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 12:57:59 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 12:58:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 12:58:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f5f257232b84381db6c25b6eb2699b2997044e8a58af466a022e6e14bdc24f17`  
		...
		Size: 692.0 KB (692044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ece97edb31040cfdbf446be383761685e462bb6685909992b86cebbb14d354b2`  
		Last Modified: Tue, 13 Sep 2022 13:16:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e08470072c8181b5179c09e08bcecd8f6adc64dc00de6ced586df29506b393ec`  
		Last Modified: Tue, 13 Sep 2022 13:16:30 GMT  
		Size: 21.3 MB (21322504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
