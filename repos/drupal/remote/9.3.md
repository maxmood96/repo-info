...
```console
$ docker pull drupal@sha256:2cd69d80ebbacdcf1749f7753f67930ae44c5a14d1d7a94d18b63fac6c37c38e
```
...
```console
$ docker pull drupal@sha256:3badf50114655175e5ce5f2ce84b5653d3ed4240130f6c0b72246e20e1598787
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190738010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa66dbaef53380c3ff72ec4ac0f0d91b67f09ef9d8b73ee7318357bf51de6c01`
...
# Mon, 03 Jan 2022 19:40:10 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 19:40:10 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:40:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:40:22 GMT
...
-	Layers:
	...
	-	`sha256:456f2bb956723a755ebe6fb02e1447d08c66a7ad04a0b01066a41a75a4fda94a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1389be152eac443dffa32e8c34e6bfc9bd9027fdd5cd20a567adf724fda54f58`  
		Last Modified: Mon, 03 Jan 2022 19:50:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e777fe4947ef85e7f26e6b8d59e4bb9ef16b861bc41527635d9229ea0e68723a`  
		Last Modified: Mon, 03 Jan 2022 19:50:18 GMT  
...
```console
$ docker pull drupal@sha256:629103829fb58629db9692c90e949897443b64a6058e8aa6815d724be7b7514e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.8 MB (159829699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1416b46620fdd45342615efd8a6ee9ef5ea28ab71b9192526b1518ad9a07e36`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:51:00 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 20:51:01 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:51:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:51:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec4a34301c151aa1d500dbcf5453a35305fb419a5892da9f38a2095f07b8a85d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e97ca432b6a10d53148e7b44df0b0fad2049092c77bf71e2f722372c6dd75f0`  
		Last Modified: Mon, 03 Jan 2022 21:29:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c530f8c383505e9275588fd76690dff8d6eb7410d5dba89a618b0eb618249583`  
		Last Modified: Mon, 03 Jan 2022 21:29:37 GMT  
		Size: 20.1 MB (20141962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a5f4a737b23417b2d70fdc2795e3765dfe7bbcfa86496517706bf031689250e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183054207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d12c704915b1f4c395d87de0a61bc560f071e2c37e0c8d2024380a7e09770771`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 03 Jan 2022 21:35:26 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:35:27 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:35:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:35:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9036b3bb87124a1fedff2e14cea07de0c14283780ee819cb4ef4e1fbeadc3392`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bdd678360e2a2a77dbd714ed676ebf553c3fea6f0b04b72fa17f01862ff68b8`  
		Last Modified: Mon, 03 Jan 2022 21:56:15 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18495dea6fe5886a418501df8251470806b96dcbdba736ab5d74b995dae8f583`  
		Last Modified: Mon, 03 Jan 2022 21:56:21 GMT  
		Size: 20.1 MB (20144253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3` - linux; 386

```console
$ docker pull drupal@sha256:8c6d8c04f0ee0067d5c7936eb83e312b9d85423ac9d22523a6722cb8cb03928e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.7 MB (193682226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d6965ccd822e6c738bdd9a56c5d1706f7333e266a4d5c57e1f929948389eca7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 19:55:32 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 19:55:32 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:55:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:55:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:05abf242384618b68e3f1bb9d6bc5bc51b96f770faafe57ea7161923f0f03803`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd67b8807880148928edb79abd2caf63b5fb5283363aaa33230f2b29a73199bd`  
		Last Modified: Mon, 03 Jan 2022 20:13:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9228c2e187705d2d971cc9d7b3bb9276164393b4d18be675c1930d0b4aa28be`  
		Last Modified: Mon, 03 Jan 2022 20:13:40 GMT  
...
```console
$ docker pull drupal@sha256:34c037c1c5153713fb95ebd8bd00627dffbe0ddfb9ac7a827bf481eba05bc815
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.5 MB (191468974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb4b7cf013d078a931ade7b3bdea134511481b91cb2493963f5c64a50deceec3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:21:02 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:21:05 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:21:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:21:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab41bc27691a974b63d6c6ea48216362d9f8e025230480c8af375892cb7ea67c`  
		...
		Size: 573.6 KB (573627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7ed51c4f8cef304fe99795e2cfc302eb1fd9d93ef55a7bbf3c2747a92808600`  
		Last Modified: Mon, 03 Jan 2022 21:47:37 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeeb71ffde4a83bb359a1d34321ce981ed1ad24e432d492b8757745a7ff01937`  
		Last Modified: Mon, 03 Jan 2022 21:48:56 GMT  
...
```console
$ docker pull drupal@sha256:1bfed94e02f43cae04c3090bdf21e43af951a85a9b5c3fa191fdc66afbfa7a56
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167404609 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6c26c92b750e3817291b5864b2ebef83ee4c37716c71b6423f924f77b17eb28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:49:53 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:49:53 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:50:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:50:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fb36eeef651a90e1e87030857df501e19fc0fb1db60f77707dff6fc3c79816e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ece5797200fb7d4a15ebedcecaea83992fd647e563f2c694e21ace3609a8f9e`  
		Last Modified: Mon, 03 Jan 2022 22:07:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b35a9783bc89db33a403076ac2d98f888f1d50f8207371e3f6c506538eecd501`  
		Last Modified: Mon, 03 Jan 2022 22:07:17 GMT  
		Size: 20.1 MB (20142018 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
