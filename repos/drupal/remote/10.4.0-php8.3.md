...
```console
$ docker pull drupal@sha256:2bfbee3c7dfaaa2090fa0005d90e446336a5368cbf1aca3076c24872b2932c83
```
...
### `drupal:10.4.0-php8.3` - linux; amd64
...
### `drupal:10.4.0-php8.3` - unknown; unknown
...
### `drupal:10.4.0-php8.3` - linux; arm variant v7
...
### `drupal:10.4.0-php8.3` - linux; arm64 variant v8
...
### `drupal:10.4.0-php8.3` - linux; 386
...
### `drupal:10.4.0-php8.3` - linux; ppc64le
...
### `drupal:10.4.0-php8.3` - linux; s390x
