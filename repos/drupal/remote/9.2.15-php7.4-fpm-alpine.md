...
```console
$ docker pull drupal@sha256:0e4299d39b8e187b02d2d6817cfc2337774faabc8549e8a39f34e943ab04a67c
```
...
### `drupal:9.2.15-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.15-php7.4-fpm-alpine` - linux; 386
