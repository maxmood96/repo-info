...
```console
$ docker pull drupal@sha256:5f5b6523de3a849c87527a6d2d8b0c29a42a98909aee3c6c899bc5af9e35ba1c
```
...
```console
$ docker pull drupal@sha256:c1dd19cdcf62142321a2dbccccc76a686a37b02df2c87e6d87cd29ddeb8b3b11
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141786820 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04f79901a2b0d3bad0f84b3fb8bbd9c6bb17f0bf64d885853fbf599bca06a3db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jan 2021 19:15:15 GMT
WORKDIR /opt/drupal
# Thu, 07 Jan 2021 19:15:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Jan 2021 19:16:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b79d18c1dec8447c9749aa8cae3c5b2dd3b5149548afd10cb8020ee414f0aad5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9faf45dadf86f3570640bd8ca2e2dbb600c223c992a08f13e60a54f0299571dd`  
		Last Modified: Thu, 07 Jan 2021 19:21:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64f9824a15a5f22517d8dfe2ebb2106df5d816297b1944eabcf005d1bc7e699c`  
		Last Modified: Thu, 07 Jan 2021 19:21:58 GMT  
		Size: 20.8 MB (20767161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f9db946f646a316587171411aed7aef89a3a327003fe1ddb234d05dd9f2c452c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.7 MB (151678676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d2437cb8cc8fc157cce4c113070a092b7e241a6b02c62678562eafc0077e90d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 07 Jan 2021 19:51:42 GMT
ENV DRUPAL_VERSION=8.9.11
# Thu, 07 Jan 2021 19:51:42 GMT
WORKDIR /opt/drupal
# Thu, 07 Jan 2021 19:52:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Jan 2021 19:52:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:11c25ca7fbd8c3d013d870ef8079bb1ed8f1a5f0f755d30bf7865f8d0cda2e96`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:582caee22be036560967e3103766b08ec90aac93786bcf25aa7b8864e0fc6f75`  
		Last Modified: Thu, 07 Jan 2021 19:58:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:748c8d1d87b6474d8a71716e08b777df4ab031564ae263a633b87902d842c806`  
