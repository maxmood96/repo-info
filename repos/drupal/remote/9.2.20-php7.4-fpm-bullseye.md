...
```console
$ docker pull drupal@sha256:2dd01df7d80c932b323e84e27cc9d896df0f735644e8e781780917f10ff6052a
```
...
```console
$ docker pull drupal@sha256:d7b1a47e867f7580aa33400ad47d60536640201cc1305632fe48a1b0151637db
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.5 MB (158485507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf920f69a13646aeae66e5fe7096b96f0d5fc10fe93418daea428517b45c51a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 07 Jun 2022 04:23:30 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:30:21 GMT
ENV DRUPAL_VERSION=9.2.20
# Tue, 07 Jun 2022 04:30:22 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:30:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:30:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00ef95477bdd5c5b125d3046a94e9dbcc46fe9b38e92eaad95fa2fc54756241b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25c7ec5f1b327c05e6eb772ca18437a8290cc6160b83e271f7460ddb4cdba2e3`  
		Last Modified: Tue, 07 Jun 2022 04:52:38 GMT  
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9c6050d2bbaf78ea3846cf38c05e4dacef27eaa76d848b6f1bb85e3c85fd2be`  
		Last Modified: Tue, 07 Jun 2022 04:57:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fba2f1ae50a848b95d5fde02cbaf872652b5738117e576d0c2e79902206acbc`  
		Last Modified: Tue, 07 Jun 2022 04:57:14 GMT  
		Size: 19.1 MB (19118138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
