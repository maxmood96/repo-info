...
```console
$ docker pull drupal@sha256:d2a0117d798e982827f72f2a5a5006f4ad1465565a3b169724f8b12f6e2de71a
```
...
```console
$ docker pull drupal@sha256:f78011db803606e23652cff3a14283379d9829465e6dd2800dddfd1c52bdf39d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.7 MB (173726287 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eadf1cb9870bcd8451cac3498be3b9aab3fe83659c6fb70b455654db6dc12a22`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:00:05 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:00:06 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:00:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:00:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:47360ad78f809d0511cfd356eff2b2bff012d2187f02e5632df90023bf69ab31`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ead3fbc06f1d8af58fa168e42a2d79a7ae5a8c126effc44aa78fdefd68299d5b`  
		Last Modified: Wed, 01 Jun 2022 17:31:38 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3ebeb8f52606facd9c51de0edd15ba84e2b75c8ef129555d48b9a094870cfbb`  
		Last Modified: Wed, 01 Jun 2022 17:31:43 GMT  
		Size: 19.1 MB (19119376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:96c8ddf0d9456c2297575628a6aa737a5d7229d079d8896acf289bb7c366e3ac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.7 MB (182680166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5230e0dc11a900a2e5f03a6254c26cc0ab71bb851b247a2ac95c424c5acea380`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:52:59 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:52:59 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:53:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:53:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9445c152b263b53ea1a03fda1e10ed1e229e894f2a7c8bf406ed075b2b6b2a06`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0219ace95332edf8cdffa9c06997c0abfd44afabb535a298b376d59ff0806374`  
		Last Modified: Wed, 01 Jun 2022 17:25:00 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed4910fa74d10099f2ec8b7e80024654966b6a5f00cfff5f6bd2c946b29cb9b3`  
		Last Modified: Wed, 01 Jun 2022 17:25:05 GMT  
		Size: 19.1 MB (19119223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
