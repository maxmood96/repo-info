...
```console
$ docker pull drupal@sha256:81e44bf81490875eb5f960eb765055293f139a8f6f7278dd7daa169274e658e6
```
...
```console
$ docker pull drupal@sha256:a09180ec917a98b62b0adf2c300c8baf6c8e0aed6dd6610e3f989d37d4ab42dc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.3 MB (140326879 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27003ddd67f2522dce3964e593872b3d322e9748b22518647096badff8d663b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 19 Aug 2021 00:15:00 GMT
ENV DRUPAL_VERSION=9.2.4
# Thu, 19 Aug 2021 00:15:00 GMT
WORKDIR /opt/drupal
# Thu, 19 Aug 2021 00:15:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 19 Aug 2021 00:15:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c8d4783547a8f9900af2e0c5a53d0f604a4ecb78cac98146e6d73c05321bbf1`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd4bef132e2fff444734df294d10634d41e777eda6e090844dc0476e63f4211e`  
		Last Modified: Thu, 19 Aug 2021 00:44:26 GMT  
		Size: 553.9 KB (553916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78f1221547c8a56a409806d97ff122450993c2a8d919a085abf214f7afaca22b`  
		Last Modified: Thu, 19 Aug 2021 00:44:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb97a2903fcd42cd2c05a9b4db8e8bbbb00f55f212984dea2c28d6c17c17331a`  
		Last Modified: Thu, 19 Aug 2021 00:44:52 GMT  
