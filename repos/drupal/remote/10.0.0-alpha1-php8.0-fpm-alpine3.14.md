...
```console
$ docker pull drupal@sha256:94b12558f2b35e6c9eaaea35d0dd5a998c4f862ee078b2c1b0e7f788eb2fcf52
```
...
```console
$ docker pull drupal@sha256:ee96f6da157e73d7953d269c63f4509271cd6a3575db3eed57766b7547e8fc7b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.9 MB (46875607 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5ca8b84025280d555761cd26491e61d7906f7b04e406935cf4d142b9f095554`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 18:07:24 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:07:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:07:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b6e5be746f2fada2be724d64202a0d9915abae2c3728c7a04fe7a0687b157585`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:009f8e952220e9c433404a5144d24efce13b20f427a1aa23675d791d9dee6afe`  
		Last Modified: Thu, 03 Mar 2022 19:07:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:923585c4cb4d2afffba75e8fd178e15cb2214d0c19b777a4242befb5b7671881`  
		Last Modified: Thu, 03 Mar 2022 19:07:33 GMT  
		Size: 20.0 MB (19956540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
