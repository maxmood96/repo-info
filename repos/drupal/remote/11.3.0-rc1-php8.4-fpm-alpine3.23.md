...
```console
$ docker pull drupal@sha256:9769642fdf87f8e9932de0499555917e681fff8bf0fde58712d4d3db8b0ec5bd
```
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.0-rc1-php8.4-fpm-alpine3.23` - linux; s390x
