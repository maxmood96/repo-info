...
```console
$ docker pull drupal@sha256:c22acd117e63e4680312e6de029c69d5e2aeb003105766de8805def7edade882
```
...
### `drupal:9.3.20-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.3.20-fpm-buster` - linux; 386
...
### `drupal:9.3.20-fpm-buster` - linux; ppc64le
...
### `drupal:9.3.20-fpm-buster` - linux; s390x
