...
```console
$ docker pull drupal@sha256:be4874ca3567edfba6fbd3fd216788b052d803780bc714cf4d5427504349890e
```
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; amd64
...
### `drupal:11.3.0-rc1-php8.3-apache` - unknown; unknown
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; 386
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; ppc64le
...
### `drupal:11.3.0-rc1-php8.3-apache` - linux; s390x
