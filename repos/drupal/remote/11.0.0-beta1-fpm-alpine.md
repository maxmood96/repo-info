...
### `drupal:11.0.0-beta1-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.0.0-beta1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.0.0-beta1-fpm-alpine` - linux; 386
...
### `drupal:11.0.0-beta1-fpm-alpine` - linux; ppc64le
