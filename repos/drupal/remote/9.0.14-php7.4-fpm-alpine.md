...
```console
$ docker pull drupal@sha256:816a09e14f2cb06b352526515bc064c51a42d3d13e7b0ca17ca84785838d8987
```
...
```console
$ docker pull drupal@sha256:97d2a93921433cc1efa32efff83879e076c53cb4c4a37bfee632a8b0585e8e63
```
...
-	Total Size: **46.8 MB (46778290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed177965411b3df99218a574d2cb948983b5f7fba19f2bd58a14028429dc163c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Jun 2021 07:19:58 GMT
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 04 Jun 2021 07:19:58 GMT
ENV DRUPAL_VERSION=9.0.14
# Fri, 04 Jun 2021 07:19:58 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 07:20:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Jun 2021 07:20:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c25a1d3e76ee9be1655b94891a6fa59e6d5d0e2c8bc1c469d8095256b9220dcb`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9700261f9a8f949039f0925dc298e5627ba223075893968452bd260d9a0a8c9`  
		Last Modified: Fri, 04 Jun 2021 07:43:39 GMT  
		Size: 507.6 KB (507622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed530c521413f08bebbc9c9e3c10180db7091351a200dc5fc3392e0bca7e9a7c`  
		Last Modified: Fri, 04 Jun 2021 07:43:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd4e747dd009381b8373131469ed79a16314c46fd4178a39545d0f96ad80aa54`  
		Last Modified: Fri, 04 Jun 2021 07:43:46 GMT  
