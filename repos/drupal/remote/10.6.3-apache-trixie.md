...
```console
$ docker pull drupal@sha256:3f1d8b9424e94627d8b43c632cf4e2035f64351954b9d1234a5b63a668539c75
```
...
### `drupal:10.6.3-apache-trixie` - linux; amd64
...
### `drupal:10.6.3-apache-trixie` - unknown; unknown
...
### `drupal:10.6.3-apache-trixie` - linux; arm variant v7
...
### `drupal:10.6.3-apache-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.3-apache-trixie` - linux; 386
...
### `drupal:10.6.3-apache-trixie` - linux; ppc64le
...
### `drupal:10.6.3-apache-trixie` - linux; riscv64
...
### `drupal:10.6.3-apache-trixie` - linux; s390x
