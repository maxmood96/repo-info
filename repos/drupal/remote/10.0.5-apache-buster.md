## `drupal:10.0.5-apache-buster`

```console
$ docker pull drupal@sha256:823661887a2483feb97c2b47087d5d507ca6dac2595af5ff6a32fec7937702bc
```
...
### `drupal:10.0.5-apache-buster` - linux; amd64
...
### `drupal:10.0.5-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:cb30b4b1216c71a1d7e5d0a815cdab1bbeb166a14a0cb29d694918da1ced51dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141726769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e729a70ee60d6b1f14a6c9afedb0ce00c2ef66c46bbf5b244c7f92d5fa4ce317`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:24d4039be196612931a377c4fd67f50cf5b12a759245106762fd3ec3611c0ffc`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17fa4a9509104c0e51a86b00c72c92af416a3e920f1954e444539ee107938f93`  
		Last Modified: Tue, 21 Mar 2023 20:50:21 GMT  
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ede86ab73478d831215674e90326ddd2673d4c76923afc9312c7dcebbab8668`  
		Last Modified: Tue, 21 Mar 2023 20:50:21 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3abd76f9ba7bb359df95c0404f987a8d868f942b599a2a726ffe0e46619fd220`  
		Last Modified: Tue, 21 Mar 2023 20:50:26 GMT  
		Size: 17.7 MB (17663753 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.5-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:192d062fea3464ea8cf774fb4d8e00852948df1842bc3124e0de220bd596b2c0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159297927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ab08e0b95042bb27b322c0c77cdd053938937d81cfa6405ccb053e84f1e07e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Mar 2023 01:03:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 21 Mar 2023 20:35:44 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 21 Mar 2023 20:35:45 GMT
ENV DRUPAL_VERSION=10.0.5
# Tue, 21 Mar 2023 20:35:45 GMT
WORKDIR /opt/drupal
# Tue, 21 Mar 2023 20:36:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 21 Mar 2023 20:36:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5fa6fcecd058ef7b96a20b6e27d16bb21e3dc4212507d2fdad055377e5edbd47`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:794718452e1cbaa7db436a453d951beeab70a68335a8577a69449d2b91cc851a`  
		Last Modified: Tue, 21 Mar 2023 20:49:15 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33033de5b2b545d513f20747da37ac027ee35e942c433cbfb9a4bb48eea0437f`  
		Last Modified: Tue, 21 Mar 2023 20:49:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d5073cb9438fd9758cb39fbc1041fafc65708fcb47f5faf5a4230ca8e8542cb`  
		Last Modified: Tue, 21 Mar 2023 20:49:20 GMT  
		Size: 17.7 MB (17663771 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.5-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:de5ce9df3b4c3a96fbc0bdb0d5e239bd9026ce098ea27a7e3c808bcab2d55b27
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172531283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a85dd2fcbfbfd2d4b31775455b825439d081cf67cb1ab3162404abd73503805e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:3f74e96fcbb017b317448b1ff5e68cbcdda2ce20ca53ef0253c37cfd96dcc756`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d70cd20123d76e297880bc78dbe42ff8cbb31297ed6ecf38a5d16bb05a218eb`  
		Last Modified: Tue, 21 Mar 2023 01:11:11 GMT  
		Size: 697.2 KB (697152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3276461c6fbc0935f6cf7ec149a2d852a16354f792dcc93da2650881fef169f6`  
		Last Modified: Tue, 21 Mar 2023 01:11:10 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f62b37021d4f9b08da784d4295f32c8a14e9f45d1c5c6f5e4e5280ced639640`  
		Last Modified: Tue, 21 Mar 2023 01:11:17 GMT  
		Size: 17.7 MB (17662546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
