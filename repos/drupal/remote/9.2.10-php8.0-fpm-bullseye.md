...
```console
$ docker pull drupal@sha256:6849a686f528a46ba8d44f73fe3ad6b1d8dee47fdc9907aa53a57eeaf7c09acc
```
...
```console
$ docker pull drupal@sha256:12abc55241178442562bfda0368abda869713041357cf999b2c1f1528efb4588
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.9 MB (177880865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be07fc2363a2151dd2c20f5ecc31e40226dbb68c56c5f70e177fcaac1778eb8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Dec 2021 05:07:32 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 18 Dec 2021 05:07:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 18 Dec 2021 05:07:35 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Sat, 18 Dec 2021 05:15:00 GMT
ENV DRUPAL_VERSION=9.2.10
# Sat, 18 Dec 2021 05:15:00 GMT
WORKDIR /opt/drupal
# Sat, 18 Dec 2021 05:15:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 18 Dec 2021 05:15:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8967f2d8d96a7a5fe53d15b210022c8054a4d34f810a88ef68ebe456f5fa5a50`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:807481657f53155a40492863ee094633b77b26d9e8fc2ab1a9ae596d10cf9c0a`  
		Last Modified: Sat, 18 Dec 2021 05:26:16 GMT  
		Size: 1.5 MB (1474687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:823017c4ace4b3c283b4d00030bd663b9548c32936de0c2af54c1367cdcde2c2`  
		Last Modified: Sat, 18 Dec 2021 05:26:16 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a589755323e7373e40aa93c731a226bdec1ba76a4554497137e8c34948105c26`  
		Last Modified: Sat, 18 Dec 2021 05:26:16 GMT  
		Size: 564.7 KB (564655 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:253f71d3074babf21460efa85489d6cd66b92219b70f061681f4532718539efc`  
		Last Modified: Sat, 18 Dec 2021 05:30:48 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:700411b6f016cf26c201f1813cc3f6eac127c3aecb7d0ea426b3ae0a193f9a24`  
		Last Modified: Sat, 18 Dec 2021 05:30:54 GMT  
		Size: 19.2 MB (19202908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
