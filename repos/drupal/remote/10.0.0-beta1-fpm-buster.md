...
```console
$ docker pull drupal@sha256:af81f153cb3b958fa3a333840f7a109d5526aa734c75440316a12438bec0d659
```
...
### `drupal:10.0.0-beta1-fpm-buster` - linux; amd64
...
### `drupal:10.0.0-beta1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta1-fpm-buster` - linux; 386
