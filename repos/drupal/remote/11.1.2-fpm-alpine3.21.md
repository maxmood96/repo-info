...
```console
$ docker pull drupal@sha256:ae5ec352ddc45c7d8a5683cb3c5bad08ad3ed97cae548a05254d5d32584374fd
```
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.1.2-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; 386
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; riscv64
...
### `drupal:11.1.2-fpm-alpine3.21` - linux; s390x
