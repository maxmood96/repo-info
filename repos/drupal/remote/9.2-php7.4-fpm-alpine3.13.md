...
```console
$ docker pull drupal@sha256:63e55d74ebd785e25ec7029b867095f93cd73c4ec96c30ba43be7e99fada3560
```
...
```console
$ docker pull drupal@sha256:ce4499da50b3067e7eb758bcfbd65d74a232ba7bea4060390494aeb1d0e80b3d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50889877 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:767c1399896ee211e24804c63c03a30cbed6ee3b14fe8eee459501fd24078cb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 13 Oct 2021 13:37:50 GMT
ENV DRUPAL_VERSION=9.2.7
# Wed, 13 Oct 2021 13:37:51 GMT
WORKDIR /opt/drupal
# Wed, 13 Oct 2021 13:38:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Oct 2021 13:38:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2ef82cf7ee37258c2e4c8227be8a18d4709caf09392c30e738af23a0978d3aae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a97c19a12b0940b3a807e114d1c9132f63f989d97b897720a92d9a3cd153da9`  
		Last Modified: Wed, 13 Oct 2021 13:59:02 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b538869837347cf564da8b484293faacacb5328d512b790d88df032e73bdb194`  
		Last Modified: Wed, 13 Oct 2021 13:59:07 GMT  
		Size: 19.2 MB (19182188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
