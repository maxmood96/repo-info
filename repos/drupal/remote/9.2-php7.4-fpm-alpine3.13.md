...
```console
$ docker pull drupal@sha256:6cd827a3fddb0c73ed63a0ebbf722db139538356a49722a179a8d330f37c5732
```
...
```console
$ docker pull drupal@sha256:e5e0723380ee4d0e0a6abe27a4aa1588ae94b533986c514421b454645a69fae7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48585967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb35a343ef3406ed58bddd05773111e3c2243cce8c6459474452cefc0f5095d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Tue, 03 Aug 2021 19:06:42 GMT
ENV DRUPAL_VERSION=9.2.3
# Tue, 03 Aug 2021 19:06:43 GMT
WORKDIR /opt/drupal
# Tue, 03 Aug 2021 19:07:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 03 Aug 2021 19:07:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d18bae0c60b738500f216f1be33c8b84565929446799ed8609eda46de835fb0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63d4bfb05a0c97355b1916f761088bb0d4c04ad83a4879ddb877a237a1260ce3`  
		Last Modified: Tue, 03 Aug 2021 19:35:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7764f4ab04ae8a43319fcffa7b301026a69f3b9eae66d973d3076e2ebc61c6d`  
		Last Modified: Tue, 03 Aug 2021 19:36:00 GMT  
		Size: 19.2 MB (19177478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9369b5dc9f51144e84e264f22fa210b797e1861ac9a237bee8bd3d87f626f25b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52534534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:739cab9a9d91ddb2d8f382880c6479b9e6021b04f6b20d7dbf7627fd19f1392f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Tue, 03 Aug 2021 20:50:03 GMT
ENV DRUPAL_VERSION=9.2.3
# Tue, 03 Aug 2021 20:50:11 GMT
WORKDIR /opt/drupal
# Tue, 03 Aug 2021 20:50:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 03 Aug 2021 20:50:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:939d771a259baac9ebf6ce2957e2c3b790807c2662524fa7417e56a6428a4100`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff94120d65a3277e30f47a1d3355a17ca5d275359b79564eaac066f48262bf5b`  
		Last Modified: Tue, 03 Aug 2021 21:22:19 GMT  
		Size: 144.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c44c7ad0cfe482b04eafa671cfb04a734f4137a03dc94b2106556a0703f28427`  
		Last Modified: Tue, 03 Aug 2021 21:24:24 GMT  
		Size: 19.2 MB (19177482 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
