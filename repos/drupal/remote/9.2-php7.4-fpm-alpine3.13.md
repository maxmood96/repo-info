...
```console
$ docker pull drupal@sha256:b56697e18ac1e8eb6aa6b2f478488451a011e7d8ad4dcbe272241e707d3d1c5e
```
...
```console
$ docker pull drupal@sha256:d4b4244efa768a04b3cd5233fc8ddfc33940075da7215ffd0c6f0d2abb7f9fda
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51513751 bytes)**  
...
# Fri, 13 Aug 2021 00:21:47 GMT
ENV DRUPAL_VERSION=9.2.4
# Fri, 13 Aug 2021 00:21:48 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 00:21:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 00:22:00 GMT
...
-	Layers:
	...
	-	`sha256:c0c0d436cbbc637d65a9662503a10ecf96a3c71eeccd2b60fb71e6a57bc24e00`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4dd51d6e4ba45392f0e549b8d47f077da4c3d8f211167271605cc5733e4f4b3`  
		Last Modified: Fri, 13 Aug 2021 00:34:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eb4e66fd36f0ca0f154be17bd9fc5f439170d76cf2abc0d9fc94bf7942aac1a`  
		Last Modified: Fri, 13 Aug 2021 00:35:04 GMT  
...
```console
$ docker pull drupal@sha256:1f87369e335931520d810a109975f396f428a5acca70663d423c29c248d74161
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51211538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1d2560ebea8a6e003f968e84ada4a9c6283a7f2d44b785f89fd36fb66762c7b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 01:38:38 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 13 Aug 2021 04:35:31 GMT
ENV DRUPAL_VERSION=9.2.4
# Fri, 13 Aug 2021 04:35:31 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 04:35:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 04:35:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:91913ca8f90d5f013e928175db7d9cad78e893845499e208f3e2e23e69479e76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9760c279d1038a3db8432fb4b351b00e13734369dcc1523774f4b98fc34f3687`  
		Last Modified: Fri, 13 Aug 2021 04:55:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b8e1a59310610145082f22b4d021657e06d5351ed6e7b8969e6f4ffa5b3d72b`  
		Last Modified: Fri, 13 Aug 2021 04:55:08 GMT  
		Size: 19.2 MB (19178976 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:47bcc211b353d4d9f4eb4fee63fe490d3dd85eb3d0b7219ee20fd9a257102437
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50538786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fda4e6e736b9ed4a1475b04662cfc19c484ef93e7fe26de781d39d1b8f270757`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 06:28:07 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 13 Aug 2021 03:17:38 GMT
ENV DRUPAL_VERSION=9.2.4
# Fri, 13 Aug 2021 03:17:38 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 03:17:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 03:17:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2538520c83fd3489c2071cbba958c8db364b91684c868e50b76344cc53eab7d3`  
		...
		Size: 553.9 KB (553915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b94ae1fabf47b7ce323cac283b57c429c18b85ce0e0815b4a57d9c1b50a8af`  
		Last Modified: Fri, 13 Aug 2021 03:38:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7730103a88fc5972e89a6c8423ba89fd6e087a616c94cca1552205ecd5f0efba`  
		Last Modified: Fri, 13 Aug 2021 03:38:20 GMT  
		Size: 19.2 MB (19178948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
