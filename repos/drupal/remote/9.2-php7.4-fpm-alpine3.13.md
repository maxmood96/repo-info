...
```console
$ docker pull drupal@sha256:5a25dc23aea5a32e8fd960c330da45a31c7bf1e383ac0affb71756f07aa670a4
```
...
```console
$ docker pull drupal@sha256:fa481fd06a7de18d152d85cfe7d5a556b9d14ad829e935cf1484e9a0dbc47eea
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49881785 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efc2eb1f6418b2e42ebe521f21f415d38c3498f019317f9911baa484df67b8da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Sep 2021 00:13:27 GMT
ENV DRUPAL_VERSION=9.2.6
# Fri, 24 Sep 2021 00:13:28 GMT
WORKDIR /opt/drupal
# Fri, 24 Sep 2021 00:13:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Sep 2021 00:13:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7628b584e52fdfb481b4e36f59961ffea7d864b5d1ee70a76a892d420ed03ca6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:512597d16b730f31ff473732c2b8d84b13ac3d849c5cead4c5c4d730d17a6192`  
		Last Modified: Fri, 24 Sep 2021 00:27:03 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cd2a6e5c4dcbe5f761463ea3fe7b4e282ecd67af1a33fab3910aa24f471b1ee`  
		Last Modified: Fri, 24 Sep 2021 00:27:29 GMT  
		Size: 19.2 MB (19180126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
