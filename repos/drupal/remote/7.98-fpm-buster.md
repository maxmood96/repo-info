...
```console
$ docker pull drupal@sha256:79fe129d6f4f3e2a366460018bac99dcc34f0952572aa7b3ebc26c24949ee7cd
```
...
```console
$ docker pull drupal@sha256:f731a56a394c9e69a0008d328c5571d8e0e971a0fdb3304a72e87d01a54f3e46
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146064636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e997e27555318efac8b481d2d33da6ed8580fd29ed45ac2a2e7e3011077df7bc`
...
# Thu, 22 Jun 2023 23:42:27 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:42:27 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:42:28 GMT
...
-	Layers:
	...
	-	`sha256:3af7e9dbc2c72004099a67311dd921bd1122488991e2a9bdef985d39a0c84ca1`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:156a5da1a9739ee1389d7288834c73efd710dfd69dbec623ff3307b1fe9974fc`  
		Last Modified: Fri, 23 Jun 2023 00:04:09 GMT  
...
```console
$ docker pull drupal@sha256:8f1913582a9fde52033d05f5e5139b874524852bd2e1e80831b4b3888269820e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.7 MB (121667785 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ead7cd8f9c7620de9b15018c00d851228b8be29f5f013ac22f64f3519b83a797`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Jun 2023 23:16:51 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:16:51 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:16:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8f36e2bb7342cd50df914431dc609a1b3cc629ee1af8c6c0c1d3081a9e5f6add`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:646362f56911bff4f2d917d7c544fa982da23beab0143caee2398274a13f4c56`  
		Last Modified: Thu, 22 Jun 2023 23:40:50 GMT  
...
```console
$ docker pull drupal@sha256:e58285fe125b21544149f3cd1c57b5696a221866503507a1bb4595948377d5d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.6 MB (137616052 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb8cee08552620539fb95478d6f077b8eb9ee6c0577de583aba2757acd2df6a8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:05 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:05 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0822480aff232ce01de40701d94d36d39ebb5e93e215823b38c425d068151a4a`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2900d165d8fc1af8548afdd4f807e5d9d2abd4335c3717ad649531b63978ad11`  
		Last Modified: Fri, 23 Jun 2023 00:23:29 GMT  
...
```console
$ docker pull drupal@sha256:414b7ffc65e708d2d75939cf7bfc3b5ba11b4007b79ea5ce476c44b563be028d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.8 MB (151793512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd23acea07a09084dca5b84c0963d9c89b4e3c84d74f52dcf2f6bdab71bb1ec4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:58:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:03:18 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:03:18 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:03:19 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:85e85222fbee52ad53fa4b6005cc03cd35780a5084f3211d845bbf2e9c7ce3b9`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:434b4b20137662aa5e20ddcab8e5049d723bd732727ea8f17731afe61a522fda`  
		Last Modified: Fri, 23 Jun 2023 00:28:48 GMT  
