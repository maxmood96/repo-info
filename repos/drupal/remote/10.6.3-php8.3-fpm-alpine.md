...
```console
$ docker pull drupal@sha256:ef73d1468aa55a1074a16a73bfa84bb017371f16d30565266e8e3e490718b7b3
```
...
### `drupal:10.6.3-php8.3-fpm-alpine` - linux; riscv64

```console
$ docker pull drupal@sha256:21e1d0951f17f546ff973e65cc36ba9652881708da691a7701de3d26a1eb009f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.8 MB (56819738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:943cb631195779a98ce0c65772eef0c492ccb7b0e21169be6c3fbf6c4cc67d47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 02 Feb 2026 23:06:20 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Fri, 06 Feb 2026 10:18:32 GMT
ENV DRUPAL_VERSION=10.6.3
# Fri, 06 Feb 2026 10:18:32 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Fri, 06 Feb 2026 10:18:32 GMT
WORKDIR /opt/drupal
# Fri, 06 Feb 2026 10:19:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Fri, 06 Feb 2026 10:19:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:155e1c98c04b2b223b2bccec027c98092e24fe1fb4cc73f15ef283c1f69fa8dc`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f46c18be65d2a273ba5b15cd16c057ab9e3edc73323db375cd70698b7ae13644`  
		Last Modified: Fri, 06 Feb 2026 10:21:39 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bcbaa09e6026299a2b8c8dd276e1b7f394eb6b114731824283df6eed42fcfbaa`  
		Last Modified: Fri, 06 Feb 2026 10:21:43 GMT  
		Size: 21.8 MB (21843789 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.3-php8.3-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:0478567f52bbef20fd350d6f75964d677f5dee240745dceeb96700a15de68976
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.4 KB (400448 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd9cd722e76f2511c38ad48441549ecd07551f74bdacba161e0400342ed69fe1`

```dockerfile
```

-	Layers:
	-	`sha256:0580cb942b29378cd482f85c9a09e1487d9fd7271b146e26ef1ce73c8470e0be`  
		Last Modified: Fri, 06 Feb 2026 10:21:39 GMT  
		Size: 366.5 KB (366502 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0e495c679138a792b5089f279e4bc0afa35f7a4ebdf21750c39a63042eeef880`  
		Last Modified: Fri, 06 Feb 2026 10:21:39 GMT  
		Size: 33.9 KB (33946 bytes)  
		MIME: application/vnd.in-toto+json
