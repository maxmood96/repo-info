...
```console
$ docker pull drupal@sha256:d6ba7d33f1f0362a3764fbb613c28be9b5928dfb075b589600304edbcb75fbda
```
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; amd64
...
### `drupal:10.2.5-fpm-alpine3.18` - unknown; unknown
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; 386
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; ppc64le
...
### `drupal:10.2.5-fpm-alpine3.18` - linux; s390x
