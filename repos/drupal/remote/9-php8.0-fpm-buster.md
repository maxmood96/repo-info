...
```console
$ docker pull drupal@sha256:6a5fdde2dd015ad0c260323b272fd50d56b5fbc3ccabdeeaa2e5bf1576e33ecd
```
...
```console
$ docker pull drupal@sha256:43a9b05f9f0278df669c5aaaee3b4222ecfd7cf78c2cc41385b27440a02c8ea1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141821200 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8944e2cf6e79e1aa218507a9e51c978f69bb052ebf443a751743f42194ef658c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 07:42:44 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:43:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:43:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d8ca9da7a9d18ff49afbb591a30fbfc889dd208dfee787e97aabd4e774308bd6`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e41add9dbfaba5f74ec269ada88a25699b7e3b0856ac70e3923251af0b19647`  
		Last Modified: Tue, 28 Mar 2023 08:01:40 GMT  
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:552b9a04fd5573b7e3aa6bf8db621bab873707f7dcb1b996cd97b0c10be42aa6`  
		Last Modified: Tue, 28 Mar 2023 08:01:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79a1efad9008613801d55d229249e644203fa9b462aca9353b4d88d6ae38dc59`  
		Last Modified: Tue, 28 Mar 2023 08:01:46 GMT  
		Size: 22.9 MB (22865180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
