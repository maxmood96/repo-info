...
```console
$ docker pull drupal@sha256:f4e1ec3a39d38bac682e9aa49c994ed7aad73a1e81336d7a24eb6953a11be107
```
...
```console
$ docker pull drupal@sha256:6b8d401f2713ea503a10a90ab9644453a53a7b1b3a7619351713013ca51f19c4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141885498 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5ca10c6ed297f790e63d89426438fbe0cc963e19f23e982c1cb97acfcc2c821`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 01:01:19 GMT
WORKDIR /opt/drupal
# Sat, 29 Jul 2023 01:01:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 29 Jul 2023 01:01:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5d09fe1f7fc947998a46870c706a1be9231d0ccfee768a11eff8e253a3348346`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:151e015549de3d9aa555a14ca90ac64e603bd3de8ef8eb31f5ad992ad2f5b56f`  
		Last Modified: Sat, 29 Jul 2023 01:18:49 GMT  
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81351ee23403e6c7d96fb0ffbc089e7e243f5f1fc0732387d6869e8589efebeb`  
		Last Modified: Sat, 29 Jul 2023 01:18:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bbc11af0efcf9d7c79a3063233f916da14fe9174cbd262a08af1a7a30695ca3`  
		Last Modified: Sat, 29 Jul 2023 01:18:56 GMT  
