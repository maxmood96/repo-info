...
```console
$ docker pull drupal@sha256:70b0dd0607ee1f40b4ccc1f557e8c01bb8da0d0da5e7332c684528f2e906a6a2
```
...
```console
$ docker pull drupal@sha256:b5c500e68d83c3fef7ef8ec3a4a62a17d5130d3a27153b06b13878a1261c7a8a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141801394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f1d94fbbab97431190aefa43dfb10793211eb4574490e11f9cd4592bf857eb7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 09:03:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sun, 05 Feb 2023 09:03:04 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:03:04 GMT
ENV DRUPAL_VERSION=9.5.3
# Sun, 05 Feb 2023 09:03:04 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:03:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:03:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:20b7a24c1aa1b10611d03b04bf6e7b0d413d3c6dceda1ae300615c57dd86ac0d`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2f2fa8f71fbef0cd5da2f5a1c4e3c120b6c4e523741885cbe78fbc456de08b4`  
		Last Modified: Sun, 05 Feb 2023 09:32:32 GMT  
		Size: 700.1 KB (700097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e734a8e74d8f68c91a6751dc29d2de03c76549907e9779cdd21a69ca08bc9193`  
		Last Modified: Sun, 05 Feb 2023 09:32:32 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c487b4377342d36851e1fde0aba3d30d10ee3981d08de5f9f50626f21b4b628d`  
		Last Modified: Sun, 05 Feb 2023 09:32:40 GMT  
		Size: 22.8 MB (22844338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
