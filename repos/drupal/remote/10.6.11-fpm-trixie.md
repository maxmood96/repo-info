...
```console
$ docker pull drupal@sha256:0adb7275fa9d3bb84030d67e7939a241f43beb1bdc07f6925b8cc599e1ef34f8
```
...
### `drupal:10.6.11-fpm-trixie` - linux; amd64
...
### `drupal:10.6.11-fpm-trixie` - unknown; unknown
...
### `drupal:10.6.11-fpm-trixie` - linux; arm variant v7
...
### `drupal:10.6.11-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.11-fpm-trixie` - linux; 386
...
### `drupal:10.6.11-fpm-trixie` - linux; ppc64le
...
### `drupal:10.6.11-fpm-trixie` - linux; s390x
