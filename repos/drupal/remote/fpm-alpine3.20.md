...
```console
$ docker pull drupal@sha256:2515eb61383d93f951999b80f3ccf055b514f3546218afaa6c86154858700672
```
...
```console
$ docker pull drupal@sha256:29281fbc58b1b18601795cfe1acdb2acf3cf7affee002a73d41be4fa4f569110
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52371682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9957fa61fcb1418072ba1cbfb5950474eded2236539e0f2407fbe84848955554`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e8f17f11ae32ff80742cd73932df271c69590b0e71c0299443237439861591a2`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0626f27111d348db6d64df42cd8cdfe34716a9330bef68c283744366ac8733c3`  
		Last Modified: Wed, 24 Jul 2024 21:16:52 GMT  
		Size: 21.1 MB (21069170 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:fpm-alpine3.20` - unknown; unknown

```console
$ docker pull drupal@sha256:68f0183786838e18ea9a9d1dec8085b3a01e9937f3b059c5ec900ec8608aeda2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **384.0 KB (384046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d0b614e25673c6ea3246603168a3466038c6100187d713d4faa06d93ae26f6f`

```dockerfile
```

-	Layers:
	-	`sha256:daed2c0b5184f5594c50997afbda991318a2f5872c730d85f0607522adaeccd3`  
		Last Modified: Wed, 24 Jul 2024 21:16:50 GMT  
		Size: 348.6 KB (348581 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:094a32188bac23d6de7212061ddb0f55bae0da2eb72094306e412a7462ab5204`  
		Last Modified: Wed, 24 Jul 2024 21:16:50 GMT  
		Size: 35.5 KB (35465 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull drupal@sha256:31d1aa7f8998af58567a4cbb7749c7f158acdac5a3fdb70d902e89d300bd6adf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.4 MB (54430786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d01b8736166462e2d6cf568d423c8a9f8f21e371bd31fb4daf4f72add6e1df10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f22ab43206622f6c05cf32af9b86cd853343a367706889470454ac84a484972f`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6fdad5af69172ee7835f568eb787801d058178479da7ead3cab08a55fe5548d6`  
		Last Modified: Wed, 24 Jul 2024 16:08:43 GMT  
		Size: 21.1 MB (21070023 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:fpm-alpine3.20` - unknown; unknown

```console
$ docker pull drupal@sha256:8d6af8f18432911d69e5a33e4565d660ca78359081a27a8088d89d54b4ec2e97
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **382.0 KB (381971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccda8d6fa910eb63b35e5c1609451eaab974510462d3429da11f3d592e81d607`

```dockerfile
```

-	Layers:
	-	`sha256:3045be6f976dc8eef0b4c6b482b9934ceaaa2c9473f0a398afc2c14bad5b5524`  
		Last Modified: Wed, 24 Jul 2024 16:08:39 GMT  
		Size: 346.6 KB (346597 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ef7b94c77e49e6a674f9f58f3afd9b708e18100137766ac8013e400fa40a5bf5`  
		Last Modified: Wed, 24 Jul 2024 16:08:39 GMT  
		Size: 35.4 KB (35374 bytes)  
		MIME: application/vnd.in-toto+json
