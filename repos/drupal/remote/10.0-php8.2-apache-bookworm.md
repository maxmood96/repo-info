...
```console
$ docker pull drupal@sha256:64bd96d27b37fefae89ca72232df712f9fe9deb1d624622329d2b3e0c7be15cb
```
...
```console
$ docker pull drupal@sha256:260f06e2c4d099d6ad353c8cd6dd255f39e597c36ec7df79a31359c3860bb426
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202584764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f10a33b1ca88510a7c4eafc0f54ef6fdd941b2689a8ea01b3ba8de8ccd9b65b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 10:48:57 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:10:37 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 11:10:37 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:11:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:11:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:602f042d99a0ec6692f79fb10e6f85439850082b8b0cdf5c643d77df79002e17`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ca8101d1dd7d2e9503ecee5ca2a9a981f4a5b5f18f9bda67ea5a99756f89174`  
		Last Modified: Sat, 02 Sep 2023 11:45:28 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a9c941469ea34a74a616908865ac0c4d529c223cb4da868e37e2662f617749f`  
		Last Modified: Sat, 02 Sep 2023 11:46:01 GMT  
