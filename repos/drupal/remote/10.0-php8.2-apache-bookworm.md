...
```console
$ docker pull drupal@sha256:bfae56518629b387554a27ca6957c14421b4c2f484b42223075f096b0a7595f3
```
...
```console
$ docker pull drupal@sha256:45c7ac4ff4dc23eb4318b722707a67294a2ff21d4481512a52dd2764b76932da
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.2 MB (198165157 bytes)**  
...
# Sat, 02 Sep 2023 09:29:23 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 09:29:23 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 09:29:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 09:29:36 GMT
...
-	Layers:
	...
	-	`sha256:0805d348c58d903f7718e45ab4b64bd895aa41e218cacaeeecf02027b29e4738`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a74d665f97d2fe0db0a529905fb7107788ee45dbe9a2aa6f527c708b6b0e700d`  
		Last Modified: Sat, 02 Sep 2023 09:45:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c199175781690aa6969140367baca126e88a948103397bc315897ad269a302a0`  
		Last Modified: Sat, 02 Sep 2023 09:45:15 GMT  
...
```console
$ docker pull drupal@sha256:b442cee97146c920cc8e5e9e342c2658b4948f0ea4d21b0141e13dc97573d1b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.2 MB (192236093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fdd1e83085473bc823a07bd79fafbdf7f812294dda2cefff7ecebdfe8fd7038`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 08:07:52 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:25:15 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:25:15 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:25:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:25:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:115039d2a3cabd2db46945e64a6b934a4286267d812c22f366fc01e9cd761b5f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48bf6998521851b46013e31208eb854bcb772fedce9393d43d677e140de7d006`  
		Last Modified: Sat, 02 Sep 2023 08:39:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6bd391a56b7445908d87cb454a7b40b98d2cb57992ae0288ad0d57945c7fbaf`  
		Last Modified: Sat, 02 Sep 2023 08:39:55 GMT  
		Size: 17.7 MB (17695528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.2-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:2db2906ab262458af07f80fb29835f88ae6d257a1bf0d4b719dcd1a2dd37044b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.2 MB (197155691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:684f88352ddd95b10dab301a06396a7424242e4406dc3c333cb88211854d8b07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:04:20 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:04:20 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:04:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:04:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:71b858ad919186bf81c70cacad0bdb32ecea53595319942ce0e79afd9cb78b65`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c53d24dfa74d50512ea77d42ee34206569d12e9128b447f0e4eaa473706e94cf`  
		Last Modified: Sat, 02 Sep 2023 08:22:44 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec8cd7c753040ae83681a3c2e256e1dccb9cbc626f71b0c4b996c633b9d834ed`  
		Last Modified: Sat, 02 Sep 2023 08:22:51 GMT  
