...
```console
$ docker pull drupal@sha256:429af171a599c1ae2328450dd746c162c1d71c0b163a9b959f9f3926584408eb
```
...
```console
$ docker pull drupal@sha256:0f327468e3b74ca761475bfe1923d51eef0bfacf9f1931d762b77184ee7023a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.2 MB (162231603 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:190749eede20d032b66695114ab70a4bb3818c3952c8fab9ac5627f32967d562`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 01:12:19 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 01:16:57 GMT
ENV DRUPAL_VERSION=10.0.10
# Fri, 18 Aug 2023 01:16:57 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:17:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:17:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:75f118f071c5cd8476495937490a3316b386e55678eadd88f6d379e5ae71d9b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9001870947387a23f3ecdde38c1062851a406653197f65514f66e298c5ae4a41`  
		Last Modified: Fri, 18 Aug 2023 01:28:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9d205ece84fd11bc1107d2932118305c5a7f1e650b53e158ced84b972e7fcec`  
		Last Modified: Fri, 18 Aug 2023 01:28:48 GMT  
		Size: 17.7 MB (17696173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5070cca2906188f598a48d13b44720f11aaa6cf0ec80e775850de013b5d5603a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171373395 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5c62c028b129f12949f00b7a3b476ac2a0c6f89bc0072d649175d6f408aaf78`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 00:45:13 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 00:50:48 GMT
ENV DRUPAL_VERSION=10.0.10
# Fri, 18 Aug 2023 00:50:48 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:51:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:51:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2fcef9bf15a6e53da127a82f37c5f024ebb45ae6167ff2c818fedffad84c06d`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4be2bbf50d1115b2928ac496ee8c2d0a32c18e56dc611d360359a2cf91a6ff7`  
		Last Modified: Fri, 18 Aug 2023 01:04:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9f17ee26866740d0059ca6ec1a91bb01a40eff9c282a2160c670202cf5eb3fc`  
		Last Modified: Fri, 18 Aug 2023 01:04:09 GMT  
		Size: 17.7 MB (17694425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
