...
```console
$ docker pull drupal@sha256:0bd4f0a83649c8a8145bf0599fb6063557ee60560f4efec3665c93f1f82e3a33
```
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; amd64
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; arm variant v7
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; 386
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; ppc64le
...
### `drupal:8.9.13-php7.4-fpm-alpine3.12` - linux; s390x
