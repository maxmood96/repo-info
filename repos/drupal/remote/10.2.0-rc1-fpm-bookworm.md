...
```console
$ docker pull drupal@sha256:8b86e0fff0aaef50befc6b6aed02d744268417fd97b702d48442242cc2acf580
```
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; amd64
...
### `drupal:10.2.0-rc1-fpm-bookworm` - unknown; unknown
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; 386
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; ppc64le
...
### `drupal:10.2.0-rc1-fpm-bookworm` - linux; s390x
