...
```console
$ docker pull drupal@sha256:7ac4599e028b9b47f1c0226443414bcd0d56ac9167dfc39e0c28324161de00af
```
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.9-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.9-fpm-alpine3.23` - linux; s390x
