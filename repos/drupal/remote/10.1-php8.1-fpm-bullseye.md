...
```console
$ docker pull drupal@sha256:4d53fcf351e56ca87ba29c9bff2cc6f5150e98a501bb90a98053ac990f66b20e
```
...
```console
$ docker pull drupal@sha256:258a9eb2c76fb912f2fb928c26c6ee297f03334fe7abe8b67e0a82e4b0edb17d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.5 MB (185520359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f0d515d9b724ab2e44126f3ebf87eb926fc394f59cf337598936e584fa1ea1d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:18075659fdd99dbe812ccaa990a55cb03260f6218ff0f7962411aa73735043c2`  
		...
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5056466e31db58508e565b75629617c8e4d0f9957db816a2f721e2d93cad77e`  
		Last Modified: Wed, 01 Nov 2023 14:53:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a06112d8160817b17d638ad568c830ab4f1f82721c9d6f0602a5753941b42eef`  
		Last Modified: Wed, 01 Nov 2023 14:53:18 GMT  
		Size: 18.5 MB (18542922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.1-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:c3a4ab0406a1bc9e5ccd85ea859816b36a4bc017e2f605638db51d5db1b49c8e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.7 MB (182675732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c14a719c754dc7312932205f0df690eb33dcbe44f9aa20ef75649f77ec9fdabb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=10.1.5
# Wed, 01 Nov 2023 15:59:18 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 15:59:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 16:00:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:476d67588f39f63cfec63eb2c770d44425239a607b3c71f1e76d9b647799f6c6`  
		...
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59f25d0f214bfe0e28eb3718647ae968bb186da25bfd748cb37925b9df985fb4`  
		Last Modified: Wed, 01 Nov 2023 16:32:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50a713eeb16be6b5bf27b9f14354b3dcb18712b26339ab93762b90336e55aaa3`  
		Last Modified: Wed, 01 Nov 2023 16:32:39 GMT  
