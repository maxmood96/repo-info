...
```console
$ docker pull drupal@sha256:43c5f8e3ef80f1e91a7e8c340d48b3e9bc0786a2355be504f0b315e17a0f04d8
```
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.3-php8.5-fpm-alpine3.22` - linux; s390x
