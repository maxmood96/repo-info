...
```console
$ docker pull drupal@sha256:2565f4185854d94561dd5f656f8fd3934b4fd3e016d85d1e14d5b3f3a63a5d3a
```
...
```console
$ docker pull drupal@sha256:73055b55f7c9cddd4ed299e3d1234d446161514dd391865e3793c2866b903d71
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51482383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:accafcacfaf87d8e6a72a307700b6c5cdd071584fdc2609121970159d057f507`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:23:42 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:24:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:24:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d42cb1642e7725e855959914a8c0b92d102897f3cb04d61db546c56de60ab9b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc8beaad295bae33e12aef6cdfdf39b5f01f2e32ee66d7183d3a3d4dc26fe836`  
		Last Modified: Mon, 03 Jan 2022 21:35:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa831b59776192b4a31d9c860285caa8d5c495925008cfa960f7161a4b2a0447`  
		Last Modified: Mon, 03 Jan 2022 21:35:49 GMT  
		Size: 20.1 MB (20137046 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:afa735a0eb99ecde6ec66f3044e78c406f5d9893a497adf3591721158a089861
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50123516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82e88e1e14708e27edfb252ca1d5bc2b29e8b6a14d28db2ce1c6be100e7049fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 20:54:56 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 20:54:57 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:55:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:55:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d2cb868f9b2d5e232bb1ac9a11dc77283e8b574efd4007c8ee27c82e9fcc61ff`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef89ff9a2d18500509657ca98ddc748e44186977e351eee440989bd4d2936848`  
		Last Modified: Mon, 03 Jan 2022 21:33:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6caec46c75996a1570f0931a24a381b186886334fedb3c3f400cf163cd6bfa7b`  
		Last Modified: Mon, 03 Jan 2022 21:33:54 GMT  
		Size: 20.1 MB (20137625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a37c8e7928baddb2fa7518769c20c4ecedd0260474e21762eaae6490f0227608
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52502380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01c3b39a3068329a229ab71dc0d13bcd126dd6860825514cb6b5dc930a9e4f1d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:37:48 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:37:49 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:38:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:38:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d97dc3d4933e966c3808f27e271cf0023dae801bc56a3ad5574f51b8272b6895`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97265936daad13b40847e56788642f8abe7ace5977133a9466e9ab522bbb304b`  
		Last Modified: Mon, 03 Jan 2022 21:58:37 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0985f2eb1568997a19ae1b79af629ac474e473f9a78c73812f2d1bf0ee9f510`  
		Last Modified: Mon, 03 Jan 2022 21:58:42 GMT  
		Size: 20.1 MB (20138347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:eedb12a855fb7aab98d3ec681bc4e5a46f175ace4338c44ebe28884902c51b6b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54223532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d196ec008a1fdbca2a6a890defacaead4ad95f9e43281f99665fcd89fc1251e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:24:48 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:24:50 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:25:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:25:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6c408fbb5e53ab3bbc7da637ee2d128f66845e5acdee46b75da6ec06d7374a1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b2acf193c76c615ec45df01778c3961cbca259302f015575ab9e7561487440f`  
		Last Modified: Mon, 03 Jan 2022 21:54:35 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a45efc4443c97fcf3b41dbe19c6d399be7760097a14e5abe0a7caf64fa8c860`  
		Last Modified: Mon, 03 Jan 2022 21:55:25 GMT  
		Size: 20.1 MB (20137367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php8.0-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:d631553f5326ce29f5f4cc51f0debc94fc744d9d11fc2bad912a2fde1ca26935
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52108186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5f2b07df9459cb6249f03985458599940b882ff0f6dfc96046f490e87e5b37c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:51:43 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:51:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:51:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1b588ae8e585282da19bc1905b2c72633a90f8f87ff5a793959760c408750f8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ec4ce78192ce08c70df2a6792cf53e646813d4804d8afca05a7858d50ca1cad`  
		Last Modified: Mon, 03 Jan 2022 22:08:48 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d25fa87d7c5ca2cb9f204a9fb3ee7ff617cf3d8c97c032c9bcf6a294c63fb306`  
		Last Modified: Mon, 03 Jan 2022 22:08:51 GMT  
		Size: 20.1 MB (20137561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
