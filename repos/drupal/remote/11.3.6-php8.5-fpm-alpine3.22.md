...
```console
$ docker pull drupal@sha256:2956dd62e0302f0963629fc972071dff63cc332f609c882460473f214c14e296
```
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.6-php8.5-fpm-alpine3.22` - linux; s390x
