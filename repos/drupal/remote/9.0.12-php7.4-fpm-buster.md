## `drupal:9.0.12-php7.4-fpm-buster`

```console
$ docker pull drupal@sha256:725eba10116183bfdf5d9349275ec102c3a2f47e1eb6b4b9cbbe805bf24874f1
```
...
### `drupal:9.0.12-php7.4-fpm-buster` - linux; amd64

```console
$ docker pull drupal@sha256:c3b066c4c509fd95ad217f822ca5d7c501bfb37d4f34d17a05d377b3be3f982d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162494306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3911332ed2aafac388585c16707b26aa6ab515480967361f33abb5f8e54771a2`
...
# Sat, 01 May 2021 06:07:29 GMT
WORKDIR /opt/drupal
# Sat, 01 May 2021 06:08:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 06:08:02 GMT
...
-	Layers:
	...
	-	`sha256:43724438025071953a5bd4213b5ca92ce9d3dfb7593016d69fce99a5146ce249`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77ace17660c6e23b0816a3076429d32b40e5ebe9861f25d8151bab1ec4251947`  
		Last Modified: Sat, 01 May 2021 06:16:46 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:721bc7e6f0c2bdf1590cb5c58ce30054324fa67dc2301b3fe9e785e50f540242`  
		Last Modified: Sat, 01 May 2021 06:16:51 GMT  
		Size: 17.2 MB (17240894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.12-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:5f96f88d24ad29a28142c68ae7deced69f18e87afd599f159cf8f5297ccff2d3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.3 MB (138326821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b47f36989938db041845f8d5e73460e7d2f434f580bdd5bbd2fb735e2ae3584`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 01 May 2021 04:04:30 GMT
ENV DRUPAL_VERSION=9.0.12
# Sat, 01 May 2021 04:04:31 GMT
WORKDIR /opt/drupal
# Sat, 01 May 2021 04:05:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 04:05:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1c1a3ed269c0a344c8760b2a499224bd3e6e12f490829a020d71a81a375c81d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50aecf063dbe690c56cbde124a27178e56bee15b58b0885bdc25dea0034dceb3`  
		Last Modified: Sat, 01 May 2021 04:15:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed2aaf12707643117d2f66f540d93613292059a833ba6ab6ee287243952476b0`  
		Last Modified: Sat, 01 May 2021 04:15:11 GMT  
		Size: 17.2 MB (17241042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.12-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:8043624fd84395736c5322a281a02b55d015c4adb5271911904a4b239a6a1fb1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154688205 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77db1968fed4b0d9f9aaa510c97d76c728318e263cee3a3893e1be61b7f9e80b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 01 May 2021 04:44:34 GMT
ENV DRUPAL_VERSION=9.0.12
# Sat, 01 May 2021 04:44:35 GMT
WORKDIR /opt/drupal
# Sat, 01 May 2021 04:45:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 04:45:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:38b81740b67a138291d3e1679d6d1116cc5ad2331c9d2126151ff8032df5016c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5eaaeb09dd48cb46b3144acdce837ceb18da90dc0412ecdd25071437db9c4ca8`  
		Last Modified: Sat, 01 May 2021 04:54:58 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6de4fafa9f5180cf64f8345a007d507a5facec23f79e8995482a4755dd462f8b`  
		Last Modified: Sat, 01 May 2021 04:55:07 GMT  
		Size: 17.2 MB (17240840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.12-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:2dc76ad8e7111b984be0fe0aab5b353b538aa9a5060e5ae246e7eaf87170d74b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168359245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9755133a2446ba4bd13d2c596abc6b3c25a1501c6c555aafeba704ea0eccb94f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 01 May 2021 00:53:54 GMT
ENV DRUPAL_VERSION=9.0.12
# Sat, 01 May 2021 00:53:54 GMT
WORKDIR /opt/drupal
# Sat, 01 May 2021 00:54:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 00:54:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:17a777f3355d98f8e969ab7d3af64ba47fb3e7059b8b749319a8084a0af50c05`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:227db0123e628feeb6cf541c5872f3b3180b69ee0ab9e49a58ed514c1c5655e0`  
		Last Modified: Sat, 01 May 2021 01:15:28 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2ac8491ca0913e807d4b1e6538f7311a4076303a143c4f380c5e1d66cd7b2e8`  
		Last Modified: Sat, 01 May 2021 01:15:38 GMT  
		Size: 17.2 MB (17240836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.12-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:ac71dc4b50d8e84ba85be73e8f1f0c9e8eed0ebf4f74812ed59cf37560111d1a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173436311 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a772eeb4534bb4600cf6ee05a09e5cf9e75c134d81fcc5d28e5cb8b5bb6e376`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 01 May 2021 06:15:02 GMT
ENV DRUPAL_VERSION=9.0.12
# Sat, 01 May 2021 06:15:08 GMT
WORKDIR /opt/drupal
# Sat, 01 May 2021 06:16:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 06:16:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e6b3a515ee11e38a546331b967beb5e57fcd3b9042043f4b5bd256dc523fb21f`  
		...
		Size: 507.6 KB (507624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7710a26700a3f417a0bef5ccea2a77aa54c6dc62cfd666884d75c0d906d31439`  
		Last Modified: Sat, 01 May 2021 06:45:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0014e2fe5f179617a6cc465d2ec29c13c2869ec9d90c0bde02845ea64385cf0`  
		Last Modified: Sat, 01 May 2021 06:47:42 GMT  
		Size: 17.2 MB (17240831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.12-php7.4-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:877a2190f8dd0a2e92b00779d2db232a896c46eba04454a787976d18ba6eb36a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.2 MB (148236933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1af6ed56f822105f1a0e0129034b8ee9c24e74d6a57e27f7772d514016146b59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Sat, 01 May 2021 03:57:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 May 2021 03:57:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2f2f51b427134801ddec78fa749c776d7fb5ef98354c6f9f7641abb66660ca31`  
		...
		Size: 507.6 KB (507621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a30f52956cd05513c5c1147386d8f54d8553241f13d11947248090d855b06e37`  
		Last Modified: Sat, 01 May 2021 04:06:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79b65e49bc256f2046fec6a44efb5a57ec0b08f00c6f4b62e391a8d43030ad3e`  
		Last Modified: Sat, 01 May 2021 04:06:45 GMT  
		Size: 17.2 MB (17240894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
