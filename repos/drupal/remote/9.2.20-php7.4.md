...
```console
$ docker pull drupal@sha256:04bb94911264d02fc4d45f174e6a312b30278b5a4b454ab97cedb7b16ccc3798
```
...
### `drupal:9.2.20-php7.4` - linux; amd64
...
### `drupal:9.2.20-php7.4` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b6a092a0dd6f317d6f48209e6939272a408807732d6cb6bfcf3e6dd32a0e37a4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155166201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:787b09f43f8b306663b25e8c2832570161178fc9761055c3c45c52eb86f02dca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:28:24 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:28:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:28:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3171bfd0761f1c2b55c28119fb2393c414795376fd39737783ede3bc84f26956`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7eb101bc55f75c8a017b03f585ea2f1ca08fcd8b862ae5c2d17911b915ccc886`  
		Last Modified: Wed, 01 Jun 2022 18:25:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:358837c22353de3be6126fde7ce01b7e46fdf7fd3f83cdc1588647032fb58bbb`  
		Last Modified: Wed, 01 Jun 2022 18:25:50 GMT  
		Size: 19.1 MB (19118595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:db3fddb2b5ef91e87bf9f29d7d4f205e8f44d3be81a95290fc552a989d7cf295
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177760159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbbeaa565e91cc3dc828a05f3cf80da695ebad18fecd337a9a78a85984a807ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:59:43 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:59:43 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:59:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:59:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ffe2ef73f051e0f0a8cf35646a936fc2d255fe36f2fb5f5b80e04b311095d02c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4845037c99d712af1ec3fd708faae6a53ba4e46b5e195953a05af1ff8382fec8`  
		Last Modified: Wed, 01 Jun 2022 17:31:06 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21c77341f994d9889ad7ed66fb5ca290cee07178f9c0d463006723078bfd94eb`  
		Last Modified: Wed, 01 Jun 2022 17:31:10 GMT  
		Size: 19.1 MB (19119198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4` - linux; 386

```console
$ docker pull drupal@sha256:21323759d38809467822d7aa28db6bfbc2325bda11513ad61fb8f79f07efad37
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186991534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da47622258f364baf2f27777e7b328c6843d749f73f19a970d4f2ba935feda88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:52:37 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:52:38 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:52:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:52:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe34ef2e4fd92d6076f0bbd7fef58bfd02aadf50de3d81018ccc43828008180f`  
		...
		Size: 661.6 KB (661586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f5ca59d97f38b379882f9a8b0fe1b84e29846559f62728601f39e7bda58fda2`  
		Last Modified: Wed, 01 Jun 2022 17:24:27 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fd6936a230e2de53cd2b4fc61e112234bb877cd5477b2e5bbd0db49c03ede2f`  
		Last Modified: Wed, 01 Jun 2022 17:24:31 GMT  
		Size: 19.1 MB (19119293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4` - linux; ppc64le

```console
$ docker pull drupal@sha256:e0babf18d1dee4e42d0674dd236186f9d9c891ee58c797ced368b9c2c749039a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185984862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d25d55542f85b7f968c5cb675d3aee2cf7cbf2da0ccb6514d3415ef6c6f557b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:44:11 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:44:14 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:44:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:44:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:14caf0ae3f7a9357d3725fdd788feac11e8be3098ebbb2cbfb4b632167d625d8`  
		...
		Size: 661.6 KB (661586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e38f46b3b26aecec854c9461c338478542734cb4a0461a3d2352e5de11c29079`  
		Last Modified: Wed, 01 Jun 2022 17:48:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32c29cc8169bf9dc0c7c1287cc5eae818f498d0cff6dd27e9db268884199d794`  
		Last Modified: Wed, 01 Jun 2022 17:50:11 GMT  
		Size: 19.1 MB (19118496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4` - linux; s390x

```console
$ docker pull drupal@sha256:d55c5177aa381a6e9b1cb8ab97487dd4cf09490def75103f5b5148681bf23c61
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162455929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb680acd04ded537daa3ac6305016cae785e142ca22ebd883c6e1985e552d5ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 05:07:55 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:13:31 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:13:31 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:13:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:13:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:27375c7341b3755bae62c2634deeba05002b82b00507eb54d07f53c63e145c15`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:305683ac692129723d20445c7c2f1ea710a73c8442bb26421f640819bd7158d2`  
		Last Modified: Wed, 01 Jun 2022 17:44:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccdd2de28ea27b8afee444e7235527955e82d918d5ccc64f58818a36f20f01cb`  
		Last Modified: Wed, 01 Jun 2022 17:44:21 GMT  
		Size: 19.1 MB (19118562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
