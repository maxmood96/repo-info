...
```console
$ docker pull drupal@sha256:e0a196d0d5d5a575872b7348305f19c10550de93712bb71c4d5436463912da01
```
...
```console
$ docker pull drupal@sha256:93750a848061173b664c266c078c9d30520c76fe99e6c8b1b7dbe6f43434e4fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162463582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46fbe14cfed34bcfaf786e8e3a73441e955ceb9e50999db7b0b5058c102dca3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:29:51 GMT
ENV DRUPAL_VERSION=9.2.20
# Tue, 07 Jun 2022 04:29:51 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:30:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:30:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0ffb25af8a220bed38e4e8c216f6949b95fad34aead68cc44be790848bf43aab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55a254c91d49fe653cf3cb6bf6784b2f174ef0e6a7f38fdaae82db66119ba504`  
		Last Modified: Tue, 07 Jun 2022 04:56:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd2091b4feff9d3cfecf8b071427e04855e626d18669c4235a5ae43d68d9f588`  
		Last Modified: Tue, 07 Jun 2022 04:56:53 GMT  
		Size: 19.1 MB (19117959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
