...
```console
$ docker pull drupal@sha256:71d0111b7dfde4cfb8d9775ec058222ecceb7167649791e51c988dfafe9db00e
```
...
```console
$ docker pull drupal@sha256:9ff94f0a4e459dd5d0f1b66218211f6494dedae59f6b12f2f6a9cf774cf70593
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49499404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:823526408a269d203b0ea86da2fa7ecf78deff8b05e45638413ffe674b2dad00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 04:39:17 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 04:42:28 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 04:42:28 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 04:42:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 04:42:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c7596eb65d5faa359dc8ce054dcec0ff6be1f08660bd6993bec202dd1ef3d88`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d75276c863d469bdcd5c6886871b8356d415b73bfc4bf359a860795ead91c058`  
		Last Modified: Fri, 05 Aug 2022 04:54:36 GMT  
		Size: 670.4 KB (670412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95804e1762c824b7a9ac1da572a10f3c86bd335761d6220d25c2cb90aab0db9f`  
		Last Modified: Fri, 05 Aug 2022 04:58:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12b04293d3adef58409e54bfdabfa3c74357e79d579e29b699fc49a874ec0ec4`  
		Last Modified: Fri, 05 Aug 2022 04:58:32 GMT  
		Size: 21.3 MB (21312684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f5c8a4a4764eaffb262977e7ebe6b8b5dfaf96365c27c1eb3946e0aad0a5f004
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51134755 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c2f61201c4f37eb59ac8c1e2448f00334f70f04e16cb00fb64037e7616fe015`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Wed, 10 Aug 2022 01:52:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Aug 2022 01:52:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1db6ba10b025e73d11cea25de6ca6432595b0ea68a5bc44d6c242338d22f679`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdee387470320daa6334354b6c47e3a7b91657e41f1e2eb778c96233f6fd80f8`  
		Last Modified: Wed, 10 Aug 2022 02:14:39 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7bdad4620b5fc57a898f422b1932b91f7450dafc4ce45db4d2bdf29055f7ee2`  
		Last Modified: Wed, 10 Aug 2022 02:14:44 GMT  
