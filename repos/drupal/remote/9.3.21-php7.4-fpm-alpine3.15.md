...
```console
$ docker pull drupal@sha256:2cafb9a6e95b7bbcfa5e2b396bc24866c8a5d34abb40fd6083137c12e09987c6
```
...
```console
$ docker pull drupal@sha256:4946f7735dbb35c9be074edabf449d51c0da8437ee6e6bd51a48f32e4f87a7a9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49529704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a08744250bad435dde96df7fe9c15150c53e494f5f2e9b24249b26233ca8470`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 22 Aug 2022 19:12:15 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:12:15 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:12:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:7d7d34948b0c2b6e3ccfa4542d5a104b22de65bdff65ac8eb3e58fd759d4c3e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e7b8f84a8593a1764b627cd066178f1c684f17a870c266ad23128dd050923c2`  
		Last Modified: Mon, 22 Aug 2022 19:27:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfc23e0fb4a67876db26229eb6e6e8de0881eca9a8bf473e7364ac6018bfedb2`  
		Last Modified: Mon, 22 Aug 2022 19:27:35 GMT  
...
```console
$ docker pull drupal@sha256:5471831b2deaf26da5d099c31a4b402b7d1e5f3246f2121c2864caa909721d8e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50371115 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c87edcd8fc2763f9b1ae9e9b0dea8e0b79084700d364bac965f6931271c07be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:18:53 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:18:53 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:19:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:1cd2eee9dce4261ed7190a2ce7e847c198a1de032f25fc47d4c40d4fa4f2136c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb584b2a4e7c972fa930469e3583532cb1b22e44623d6c098f8e0f508e2e60a9`  
		Last Modified: Mon, 22 Aug 2022 19:55:34 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc99affd14212baa2188dd84c43a03f72071b3ace1406b76fead147f9d0fa02f`  
		Last Modified: Mon, 22 Aug 2022 19:55:39 GMT  
		Size: 21.3 MB (21312256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php7.4-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:4747c0d317d11393d35f117018e446ba14c34a1425ca628606d8ba54141b776d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51156527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a79d8f5709bf9f92841d14f5acf24133081715f514026ec5d5218ea92f90d0a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:13:59 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:14:00 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:14:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:14:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:33f173adad8c4a710be39bbf25f410dc7cf85e5d5474fe0b43de4ea655230d31`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41c86e05bae6180f61e11f727319348ea95a1f6b8ea698b13176aaacc76d4f18`  
		Last Modified: Mon, 22 Aug 2022 19:51:12 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b20c05ebc37215e1b29c0dda81bb8ee978baa4c792abc9b174bb68b5c5671624`  
		Last Modified: Mon, 22 Aug 2022 19:52:35 GMT  
		Size: 21.3 MB (21312179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:dac70d35ad71ea5d346f569d50ebad74e1617c7ba8ce50449f4addffdf00c47a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50125170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00df078aac723a3dd08c8f9b5b543fd2b5f405b4fd9b7c1ab12d9decb40331e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 22 Aug 2022 19:12:29 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:21:21 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:21:21 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:21:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:21:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7d360c27347c3694bae919d44e86d87fb431b38418e4bad26c8331765cdb18df`  
		...
		Size: 692.1 KB (692054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4606207444e43f624d9003b02714b725c3376c98bbf5e4c6cd2ca1fc0b3c11a3`  
		Last Modified: Mon, 22 Aug 2022 19:48:45 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4f9b28a5ab6c460fbf626d13d6926bcea46c40017c7bde30cf014bc80bef9c2`  
		Last Modified: Mon, 22 Aug 2022 19:48:48 GMT  
		Size: 21.3 MB (21312734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
