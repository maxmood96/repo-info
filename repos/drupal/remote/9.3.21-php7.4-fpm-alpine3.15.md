...
```console
$ docker pull drupal@sha256:fb0995c2778a2c43e48b92b1b9773d8ba7d43b0f467d38c7fcb5c26b8c6e59b2
```
...
```console
$ docker pull drupal@sha256:9b0f7940b7349df89be7b91eb0889494dc8a24de9a62b00b1c1b868a097925a4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48404794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b000834b8a2649efe18aaf7a5a0f398608eca26e23a7b61e804dd09aad332980`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:38:20 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:38:20 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:38:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:38:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84576e28c9508e9b8261f34bde64d2bf3de3512151110651c6127381a677ae60`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aafdb210dd003671d37bee80ac111bc88c17ad5fe5fa10c9e36d885f576b8ff1`  
		Last Modified: Mon, 22 Aug 2022 20:24:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:856b81a272054fc29a01691e25d008fde954bed78aededfbe2207362dc9ec16c`  
		Last Modified: Mon, 22 Aug 2022 20:25:00 GMT  
		Size: 21.3 MB (21312561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
