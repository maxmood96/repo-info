...
```console
$ docker pull drupal@sha256:53c8c097047551f1d1db1e130ced2341031b8639f513003b282c911bc55e5a6c
```
...
```console
$ docker pull drupal@sha256:3ee6e0cdee44a78523fbe92049fc96e3441f60394101b1b46afc36ca757d18e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51131333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f17d619166cde1991036ce035fd20d69679b00fd286162533b5fb6a0410ef3e7`
...
# Fri, 30 Jul 2021 02:55:59 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 02:56:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 02:56:12 GMT
...
-	Layers:
	...
	-	`sha256:2bc48107d38cbab46d5082cf039fb52d7fdb4028085313fed62459959403898e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7ea9a6ae34af74276138272830234b068cdb8c9e5e1bb363396454d49ba609c`  
		Last Modified: Fri, 30 Jul 2021 03:11:13 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf900ee935f695d95968a007bafb16f8279171fa919c9fc5b6f06633c62d8807`  
		Last Modified: Fri, 30 Jul 2021 03:11:21 GMT  
		Size: 19.2 MB (19175191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.2-php7.4-fpm-alpine3.14` - linux; arm variant v6

```console
$ docker pull drupal@sha256:91aeafc26daff132057265aea1c8c9c5e1c3bcf96e79c349ebbca137fc1bc8c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.6 MB (49568027 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:096850303e53916851c0033986d2a9e31725794bfd1f8a3fad2e276a2cbd1d6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 10:06:17 GMT
ENV DRUPAL_VERSION=9.2.2
# Sat, 31 Jul 2021 10:06:18 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 10:06:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 10:06:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c96d0329e9ec77fbea63fa9ff972d29373b818dc31e3733faba995b184268b19`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4c0f02a86a2d07a5b8b50546076cfa253032a099f33f9fcb246fbc19cca7717`  
		Last Modified: Sat, 31 Jul 2021 10:21:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ee8f4f399eb78419feb1d1c4d00c17cfe25a646a874a4ee341e925fb355f072`  
		Last Modified: Sat, 31 Jul 2021 10:21:42 GMT  
		Size: 19.2 MB (19175922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.2-php7.4-fpm-alpine3.14` - linux; arm variant v7

```console
$ docker pull drupal@sha256:51b2e09cfde662c2dce6c34c85f04bf9b1726a17219c6f58defb13e7a6bd3e6f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48430194 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:136d0c755ddaa7b4d1f56da7ac39bffbe0d4c27a5833c933983c2fd8b2c89849`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 04:05:56 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 04:05:57 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:06:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:06:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7a6396d4ffa9d8fde3c292ec573711bd28083a062ef92359304ccdddcdcf51b`  
		...
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39aaa8f7d194a6733621f87e19ac3a82e9988d5828f01818a08238ca7d7123c2`  
		Last Modified: Fri, 30 Jul 2021 04:43:07 GMT  
		Size: 553.9 KB (553914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9edf22f9698cdcdfd2e8fab3f926a14788e89035b189ca97806bca19812cbb64`  
		Last Modified: Fri, 30 Jul 2021 04:43:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fff5eab1106ea042d098c3221c739bf2dfe8e7ad400c8c454151a33ca8c3f7e`  
		Last Modified: Fri, 30 Jul 2021 04:43:33 GMT  
		Size: 19.2 MB (19175098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.2-php7.4-fpm-alpine3.14` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:05450b26eb4f9960b463e764a31a11d2b42f9874db6d7f8c62e8350caa9dd167
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50803900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6df3bc82422b4bd1d713eefeeb3a72371fe747cf1518e2f98f5cd401ac3cc94`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 01:37:36 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 01:37:37 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 01:37:37 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 01:37:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f52d90481ee3baffe38f1a71fe907d96e2bbfb053f5bde0d0094049311464afc`  
		...
		Size: 553.9 KB (553916 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:071ef957b2d96833b13c13c4fff71067e20429ae6394673ddac2c83d667b0056`  
		Last Modified: Fri, 30 Jul 2021 01:57:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65bc78bd95f560f474e90cceb275542bb0a97f8566a022cc03b0fd1adef028d5`  
		Last Modified: Fri, 30 Jul 2021 01:58:03 GMT  
		Size: 19.2 MB (19174889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.2-php7.4-fpm-alpine3.14` - linux; 386

```console
$ docker pull drupal@sha256:a709b76818240f8bde8a91ef22ce76b84358344314f3929b62bb5ed1d262d95e
```
...
-	Total Size: **51.8 MB (51771337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:744b66da6c30402c3e3da91879a46ed15fda77e48ac2794a5e08769eb3028fbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 01:41:34 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 01:41:34 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 01:41:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 01:41:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dd098feb04ea5d9d97c0a9977aaa659c0a5af1bfc9403a3d91321754b9ac4a94`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0880ddd30b57a8d9fd0376f000abbf2700d019d48b7ed224e4d8d72ce2ac7572`  
		Last Modified: Fri, 30 Jul 2021 02:09:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6eb58ed0f8fc38dfebeb9f7690fc4889cdd162a9c1fd4f584b5a28ae7e953454`  
		Last Modified: Fri, 30 Jul 2021 02:09:27 GMT  
		Size: 19.2 MB (19175404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.2-php7.4-fpm-alpine3.14` - linux; ppc64le

```console
$ docker pull drupal@sha256:03d3ba3f37234ea6540d4314bc1ec4fc36aad194d0a16c1824f59738d12ed1d5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52397656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0afd992e90ab9b656c93162763405cee4b8dffc074a638d6831066536016bdd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 02:31:56 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 02:32:02 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 02:32:10 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 02:32:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 02:33:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3068362e54b22d221f46f6ef32b2403fe65b035c84e2a0ca6e48a8dd2885a473`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35318cac6fb75b69ef4321251131105b3e09e74cac038223f3a81fc739b6393c`  
		Last Modified: Fri, 30 Jul 2021 03:18:55 GMT  
		Size: 553.9 KB (553917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3afa155a9b65c0e33bb470f54d830670a25c39d1560725d6c9b39c7d7ad7a31d`  
		Last Modified: Fri, 30 Jul 2021 03:18:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a41459fcb9f8e21d8d64a92f200377ec5783e215f18556a08ffbddf4db68581a`  
		Last Modified: Fri, 30 Jul 2021 03:21:19 GMT  
		Size: 19.2 MB (19175155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
