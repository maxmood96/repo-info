...
```console
$ docker pull drupal@sha256:40762b844c60a7780f76e9595344ba8e3f82f3044ac57e99053265783d776884
```
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; 386
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.2.1-php8.3-fpm-alpine3.22` - linux; s390x
