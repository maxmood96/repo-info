...
```console
$ docker pull drupal@sha256:a4e45ca73d3c1079b05114286587e63e45e6d751af42ab3f0389cd8574059a40
```
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.0-rc1-php8.4-fpm-trixie` - linux; s390x
