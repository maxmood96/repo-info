...
```console
$ docker pull drupal@sha256:2898f93c7cba33840ef560fbb1fb877035931b33060fe96c50ff60f9019bb23f
```
...
```console
$ docker pull drupal@sha256:d8dfaee1d9695334fe81758510b978cea81058be7e4abef979bd58767bcd79c3
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.6 MB (49572019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3865078cd25750a5e23f49803fd42596e29b713f0d81c7e374cf4fdaee8fa34`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 15:16:02 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 15:20:11 GMT
ENV DRUPAL_VERSION=9.3.22
# Fri, 11 Nov 2022 15:20:11 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 15:20:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 15:20:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f259a82bbd92facef213dcab05f8fd798076ad6108649f5bb0b5f1e5ca7a399`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b63d11c5ce9cdc7a4051efd58a6f4fa5df4f349088912901bb94bbe30e96ce5a`  
		Last Modified: Fri, 11 Nov 2022 15:48:14 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9f125752e79e7710ea70b3e9bd1165a6d5f3761bcc494a1589fd7c23b6ae87f`  
