...
```console
$ docker pull drupal@sha256:e59e1bdd8b5aad83e14e80bdfe92aa5e8f4ded16c7a1b2fba1e49103b1dc1bef
```
...
### `drupal:10.3.3-php8.3-apache-bullseye` - linux; ppc64le
...
### `drupal:10.3.3-php8.3-apache-bullseye` - linux; s390x
