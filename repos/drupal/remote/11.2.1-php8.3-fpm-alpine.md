...
### `drupal:11.2.1-php8.3-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.2.1-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.2.1-php8.3-fpm-alpine` - linux; ppc64le
...
### `drupal:11.2.1-php8.3-fpm-alpine` - linux; s390x
