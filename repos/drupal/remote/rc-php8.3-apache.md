...
```console
$ docker pull drupal@sha256:06fc25515794bac443be66d328124d758a84ac326f7e02dc5fabbef46efddd91
```
...
```console
$ docker pull drupal@sha256:15cec8a7fa594cd38c6de9835a784182b0b1e6e690f411c25f79e20c49e006d3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.8 MB (163831967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d6ef81efa5a247fc9e56815d026455d9aaac43ffbea1ca25bba66add5a7580d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:609ae522a4de80905ef6d3d28061c27dd36eecdf97821fd87bbf2d42e67f810b`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f3cbbaafe7e7a80c19d731b862c7b524c006500b2e0ed1b9a25194e522ddd5be`  
		Last Modified: Wed, 03 Jul 2024 01:47:30 GMT  
		Size: 19.0 MB (18960404 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:rc-php8.3-apache` - unknown; unknown

```console
$ docker pull drupal@sha256:9d96c74467096d6dfabcd14f0babc21c43f751cb2675008cc2153a9032017eaf
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.6 MB (6640110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65c0d0c563604d9dc2eef15f217a1baeb50d159bd7509645a416add915876ec9`

```dockerfile
```

-	Layers:
	-	`sha256:48b9f301c1639e7019fa3f3f7c9b0ef6901243520e85dae02c0ef4c7031914ea`  
		Last Modified: Wed, 03 Jul 2024 01:47:25 GMT  
		Size: 6.6 MB (6602553 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ccba31b78c1576c436b2c9fb344b802057a1910bf090f1efad05675dc56acd22`  
		Last Modified: Wed, 03 Jul 2024 01:47:25 GMT  
