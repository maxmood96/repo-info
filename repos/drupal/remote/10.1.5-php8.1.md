...
```console
$ docker pull drupal@sha256:8d43206a591eaeb864afac0967b04e74916dd4b24a199d69481715d0bac4e739
```
...
### `drupal:10.1.5-php8.1` - linux; amd64
...
### `drupal:10.1.5-php8.1` - linux; arm variant v7
...
### `drupal:10.1.5-php8.1` - linux; arm64 variant v8
...
### `drupal:10.1.5-php8.1` - linux; 386
...
### `drupal:10.1.5-php8.1` - linux; ppc64le
