...
```console
$ docker pull drupal@sha256:9e4116ce2f8c5037919aec8590d2c790808becfc38dad0564c3c902445b618f9
```
...
### `drupal:11.1.2-php8.3-fpm-bullseye` - linux; amd64
...
### `drupal:11.1.2-php8.3-fpm-bullseye` - unknown; unknown
...
### `drupal:11.1.2-php8.3-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:11.1.2-php8.3-fpm-bullseye` - linux; 386
