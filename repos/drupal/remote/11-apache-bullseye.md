...
```console
$ docker pull drupal@sha256:4a4aa4429a14b07828cb6aee724015e5c05d0532d6d3e6e498541b652a921d75
```
...
```console
$ docker pull drupal@sha256:6d5ad7cd520ec7f63c23b128510ba6b80ef813b5ec1c71d1afcb62436a199b84
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161296965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a528bdb1bde3841a93db36dfdca502b0334f66c715c781b5017a9002244041e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:fbba63670cc251fdb26d9668c46be628f9c2a8676432b77e9858a180ec23b73a`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:da720037fd5e88a554b3f914462f1480141eee67e99bead6650e3a33540fc867`  
		Last Modified: Fri, 04 Jul 2025 05:26:05 GMT  
		Size: 20.5 MB (20520656 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11-apache-bullseye` - unknown; unknown

```console
$ docker pull drupal@sha256:55236be2762cec60dec91a20f174b6bff5bfa4b710001bcb2bb0dff3f9997c34
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7082421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47b3f82d02c715a6be74cbcc0cb81c1dbeef8579b02c3c4211fac10a078e4c31`

```dockerfile
```

-	Layers:
	-	`sha256:1ba4e19a4d3921d8df0bbe811c4f1ee84a1b280681171e50d68057dc29bcd427`  
		Last Modified: Fri, 04 Jul 2025 08:01:09 GMT  
		Size: 7.0 MB (7038063 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3af164c1dc7386204961482522a788b1263dab7cce658704167e4c99de7a56ee`  
		Last Modified: Fri, 04 Jul 2025 08:01:10 GMT  
...
```console
$ docker pull drupal@sha256:1594ed273d8f6c9ef59a36e85ccfec9f0bd105710ba8852c17ed4c73a2803c6b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.5 MB (185454537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc1274dc93225ce6f0c294ab854b9ef023ff9d6b78ca430c724a1d829a54e1b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6242ec9ade6c3fe675b0ad8086148f8a2c436b3f024a77dd941d5a2a7a565f60`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1aca9495414bbf81fb28923bb088f21643e982c54214a050b84093b52af42632`  
		Last Modified: Fri, 04 Jul 2025 08:24:26 GMT  
		Size: 20.5 MB (20520600 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11-apache-bullseye` - unknown; unknown

```console
$ docker pull drupal@sha256:664941c9ddd483b8caeb0ec102d8fdc8ec95b806a0ce77f6a7dcf7fd8bca21f2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7277259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:872f8943fa805b32d7f399662074c2664ae6e21ec81ca8a2fa60d4111aa6f846`

```dockerfile
```

-	Layers:
	-	`sha256:9c25c915648ecff1d625bd939ac6914ae712fac8e0fd65eb1e1e259915086047`  
		Last Modified: Fri, 04 Jul 2025 11:01:30 GMT  
		Size: 7.2 MB (7232847 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:66d9a3d1fc4b96dcc84a588ae965419f198020413461d21cda8e9ea086e91060`  
		Last Modified: Fri, 04 Jul 2025 11:01:31 GMT  
