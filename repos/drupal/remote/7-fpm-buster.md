...
```console
$ docker pull drupal@sha256:4878af9061a7e02f9dbad669e9bc8e734add311138435f972d8b56cab278e6e2
```
...
```console
$ docker pull drupal@sha256:472ddc307503f6adcfebf7bae14d03ad42eb8a84d681ecc8bfce2ba8dbb01ad6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146121225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b8d75bf5bdd483299583b59eaad6577f0ee8b4bb3c938347ab38de5d5a609d7`
...
-	Layers:
	...
	-	`sha256:75328369ea6e899759a639722d111a5b51d4a87a748ce9d0b8bce4efec574c7b`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:439c64399be72eae9661be7d050319ad1e0c1b8da8f170b004331589d3cbe1ff`  
		Last Modified: Thu, 08 Dec 2022 05:01:01 GMT  
...
```console
$ docker pull drupal@sha256:972e4ee7e1e681434f87470ca852f74a87b4dee0802acb70c08641034dcccec7
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.7 MB (121726079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f356fd8acd5b7f861e77d6a446c7b4d5fb29978edfb7be28a5f3f2bf4c15a90`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 06:54:51 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 06:54:51 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 06:54:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:53de35b363ac088d90b211a2042cb59cdb1395ea73be03be2871c8c6917d35f9`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19e80699603015863581ef0d69f5fc9a75081e64b4d89d100aa209e51fb18c40`  
		Last Modified: Thu, 08 Dec 2022 07:17:18 GMT  
		Size: 3.4 MB (3402246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9caad070900cbcd2e8da3d4c9ccd61a22f5c21afd82088ac353fa05632227304
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.7 MB (137664648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e7bb4ca11945067472608212e98a59f2ab6b3ddeccf5a79e6f8709f8cf20429`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 03:35:56 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 03:35:56 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 03:35:57 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fc847f62dc6e802ad1d846b0b17f4aa6611b08bf06b0296ec6bdfa5e755f792f`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f61d15f9b8ef1df3198fb1ebbae5f7148150a846656f45931537d335da279694`  
		Last Modified: Thu, 08 Dec 2022 03:48:05 GMT  
...
```console
$ docker pull drupal@sha256:8569776488d11d0288852da9ec98b52f57c4fe1e44d75d0945f6014a47421b1a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.2 MB (151205787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fe0023b041828b5e004d70a8f662eaeba124b0f6da8672e58326d375f28067e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 17:19:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 05:05:30 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 05:05:31 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 05:05:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2b0f0ec97c0dcaae560941bdcc2e1ef2504b74b03b7aa0ff8a93211a9551be1d`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcdd3588d8885772913058cf2e33b5f4e9d0bfab682239fd0ef274fb2caebb7f`  
		Last Modified: Thu, 08 Dec 2022 05:23:45 GMT  
