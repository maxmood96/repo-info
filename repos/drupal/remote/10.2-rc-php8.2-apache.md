...
```console
$ docker pull drupal@sha256:56165c43e4755b48465681fefbde7a978ef7de8cc00f5ab95238601469fbd823
```
...
### `drupal:10.2-rc-php8.2-apache` - linux; amd64
...
### `drupal:10.2-rc-php8.2-apache` - unknown; unknown
...
### `drupal:10.2-rc-php8.2-apache` - linux; arm variant v7
...
### `drupal:10.2-rc-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.2-rc-php8.2-apache` - linux; 386
...
### `drupal:10.2-rc-php8.2-apache` - linux; ppc64le
...
### `drupal:10.2-rc-php8.2-apache` - linux; s390x

```console
$ docker pull drupal@sha256:e0f3795931419026baaa8f9bce844c74052ca4fe3e30cc172f7f94f9558ee835
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.8 MB (172767141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:099af5ebaf8114324ae7084bf309f96806e0eca301ecb9599ff70098089820a8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:f15a89ef8ea186f11d9b5c7e70fa114dfd1d701de9b8e03175b1ecc4f8b9476f`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:68834119569974cc1275f33fadce862d5ec429f56875b5009520869ccef7b6a4`  
		Last Modified: Sat, 16 Dec 2023 12:08:49 GMT  
...
```console
$ docker pull drupal@sha256:40defa1fc2e8231c1a4652a115d00e0e5839722a4d166e6ba77768ac3b0b06a3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.8 MB (5817409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92d4196b1688d6fdc98d44b14962fb9c93a8b5209218a16a7b4e57ba34f0255d`

```dockerfile
```

-	Layers:
	-	`sha256:9130f9d3af4991e84509d2be76e514856cf506fd9c90f9ad7b607d53c249f91c`  
		Last Modified: Sat, 16 Dec 2023 12:08:49 GMT  
		Size: 5.8 MB (5777970 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4f7c083661b897fa7dd6f86359c26187ad8884b3ef293d7680e2d0308e581306`  
		Last Modified: Sat, 16 Dec 2023 12:08:48 GMT  
