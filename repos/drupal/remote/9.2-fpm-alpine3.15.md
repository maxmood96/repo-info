...
```console
$ docker pull drupal@sha256:df8bfaaa7d8302eb07908eca1d22765d0d5d52603fd991af043987a8be9ef7b0
```
...
```console
$ docker pull drupal@sha256:00a8dbd4858a0628b1c3cebf0790295c073106765f40028bfa6c5da58473b92d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48523057 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d61c71a1e7877677d360691abe124b55a4fc8d2a7fecaca81572baefd29658ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Mar 2022 21:16:44 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 17 Mar 2022 21:23:59 GMT
ENV DRUPAL_VERSION=9.2.14
# Thu, 17 Mar 2022 21:23:59 GMT
WORKDIR /opt/drupal
# Thu, 17 Mar 2022 21:24:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:8add8efcb2b70eeb0d937c020c59f8f27158fa3aef19c62e2a202a1f13e2129d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae474cab97c115d9cb069ce7b4e30eef105e91e751729e0ab16b28981cccc8d8`  
		Last Modified: Thu, 17 Mar 2022 21:43:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:060684c4ecb62f77be98b0f524065ee50487dd5783268fecdbca72a665021579`  
		Last Modified: Thu, 17 Mar 2022 21:43:30 GMT  
