...
```console
$ docker pull drupal@sha256:2038699637c8bb001be60d79d822e7babbd5781c41af519725ce4ee17ddedd07
```
...
```console
$ docker pull drupal@sha256:d5ccd4c230c2ed89b2a0150904a48de5b37cb62632cb2d4df9eb42813723359b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46689285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de533bf1b7ad36250656b96eb53740e97b06dbecb6bda597c9af9b6d6d23e633`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 24 Mar 2022 07:43:15 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 24 Mar 2022 07:43:16 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 07:43:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 07:43:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9643deaeee731eccc7c11cc172c2fb8577abec2158511b64adbfcc4dc792c8a1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4788f3e6535d254c57a346ced8ccdc00fb3517298c2a38d3c115f19b1ce08f1d`  
		Last Modified: Thu, 24 Mar 2022 08:10:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4851f67b05334595fbd415113cb1935a82dcd721753606de5de586dd5b186c86`  
		Last Modified: Thu, 24 Mar 2022 08:11:21 GMT  
		Size: 19.1 MB (19115940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:eccac147ae75b4f2f070066afe0cc4971c5e8577ca750423233a2b518d8a1405
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50065419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abc1bf32c99db1096312d742216d03882ae2d6c5f11e0a3b9d7c9e138b22c466`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 24 Mar 2022 07:21:18 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 24 Mar 2022 07:21:19 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 07:21:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 07:21:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68c5c0b965314075bbc5cf8cf19752806ddf5e80a8c7f8c06ff1d6e4e21f3aa5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:623442ff6fe0d854475c6f98c4e0affee21665fe7f2a0638e438a00681616f17`  
		Last Modified: Thu, 24 Mar 2022 09:27:38 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb67b86a2425729aa5d233c54ee33cef7ee7b60a98c1f48f3abe90bef15000d7`  
		Last Modified: Thu, 24 Mar 2022 09:27:43 GMT  
