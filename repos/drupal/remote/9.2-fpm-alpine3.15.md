...
```console
$ docker pull drupal@sha256:d5b99b2fdd6f779bae4d39495dba3e201e37b12f630f493501b95edb4fc6d650
```
...
```console
$ docker pull drupal@sha256:8ba5ce3e66c8c4b83ac8906d16149c824bbe57392c9d5b30455d23a8339f9853
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49748224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec5f466d64b143d57963d56b4f34408bacf4ef30188aa6f0d3ad8587e34627c9`
...
# Fri, 08 Apr 2022 20:57:09 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:57:09 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:57:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:57:20 GMT
...
-	Layers:
	...
	-	`sha256:a23e03e43a2dead6768640e9ad9ae4e964b89acd879f36525152a0b1efb7cf16`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:508ef1a3091e57f535aed78de27ae886d42e7673040c68573971077832f1679a`  
		Last Modified: Fri, 08 Apr 2022 22:55:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5eb5f4572a7ec61314bbd3ebe090d922f88eb42765225966877cc5680313afc7`  
		Last Modified: Fri, 08 Apr 2022 22:56:01 GMT  
		Size: 19.1 MB (19115910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:3da8a4a37f3682b805078e7f4b6e4f72a043a8e628975fe829fda17afbbd7d2d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47913420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44494b3c6aaad1dfd86e9ba7a109f32452c840c86bc5b808c9692fda73399e37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:13:26 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:13:27 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:13:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:13:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3b73079ac22ccba098ea7f20b28e91eac6ebfa379a8891e8d8414060e8a48f24`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c6712fae737df11a88bba8203dc8fba1255cd636d04c45924b439ceaa4c580b`  
		Last Modified: Fri, 08 Apr 2022 21:28:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddc963594f91634d8f5c10018892f1332973d6a766ec14b72dd2bb72538712f6`  
		Last Modified: Fri, 08 Apr 2022 21:29:05 GMT  
...
```console
$ docker pull drupal@sha256:1fe9f159cb674d3ea239b374301080c34c55f2483e4b6d9681079e236a49ed99
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46771622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92de930e70d17398377ee559fde2e6f744066de70a1ce00e1f923ddfe625180b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:36:55 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:36:55 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:37:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:37:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1a272e8e990bceea420207f27196ff9577e7fc06d6158b02ce8f251cc184e6e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6680351f8f33c09cdd669bfeb0c50ea1a60254e1875fe50c70eb6718addd64fd`  
		Last Modified: Sat, 09 Apr 2022 00:06:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f96ec4b9d0a1195cd668f94289babff015f2bf495693ca93aef62ee9fef974c`  
		Last Modified: Sat, 09 Apr 2022 00:07:08 GMT  
		Size: 19.1 MB (19115817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:566474f4199c785c1cbd56f843ce2911bcb10b5f45f7eea5c016a92430a74795
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.8 MB (48758527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21b074bdf018bc6ff695ac4e0509fab1b2e4b3357d37228fc2af96aae4e2bda2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:13:13 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:13:14 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:13:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:13:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:790623c4f886f1cad66ec448a6dd88bf208344b4a2404dfc5d7ecaffaa8ee8fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f098773bf7818e42fe65fbeafa7b3e91881bc35cd65322f67135c7a79fc302a0`  
		Last Modified: Fri, 08 Apr 2022 21:38:11 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e922e751c0b7fdf1d4fbb160afadcb4953531803fda9801f49f1a46b23dba9a`  
		Last Modified: Fri, 08 Apr 2022 21:38:16 GMT  
		Size: 19.1 MB (19117033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:6498b4d155ca3a0683507093665b96ac70c74a03a99161df2464f44e14601e39
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50148578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65216c09f122e5a0dc8712eb0c692dcf62f8a455110896cb94c7bebc3f9da7b6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 08 Apr 2022 21:04:50 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:05:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:05:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:54b084c4d8eaee6c867cb45ea40076f11f455124272a0b0dbf963662167cd020`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c7fa048ebc879261fe0aaf399e072468873b34ad209613500c3ef7bd581b4c5`  
		Last Modified: Fri, 08 Apr 2022 21:30:21 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7495aa6bec86751cd5a2d77b09f67ae02faf1a5e42bd61cf57ebe9d08523a0b8`  
		Last Modified: Fri, 08 Apr 2022 21:30:26 GMT  
		Size: 19.1 MB (19116915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:ef66202eb1f82cbf536d481b4b89774f0e00d45cc43c79d372a219236da58d5a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50073810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17a74eb38fee06d543f17223338188571ec2d57fa6b351db4d455b64025029a7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:58:05 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:58:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:58:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4a7e5279652a952198aae73a683036cbc90e27ee71dc15f43fa41a9a01a1de20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b66442e4e05068b000817c13ffe850a0540bfa1daafbbe8933ef9f7f37efc99`  
		Last Modified: Fri, 08 Apr 2022 21:57:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:486a4f70e27505960919f9c351438dc5d8ead3cd693cc14627454cbaff7bd69a`  
		Last Modified: Fri, 08 Apr 2022 21:59:53 GMT  
		Size: 19.1 MB (19116010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:981552eff000cc5376fdcdba1e67da394d1c7c4c01a4914d13a46629b39b1ce3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48519024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38e046355c7ef7bb4395550d886bb3c3ad4bf4bec3905a49b5e736703e7f36b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:12:32 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:12:32 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:12:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:12:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc229e1d3bbb5da73672e90696d806256656e55cb68036485eb6e4c72f9a81e7`  
		...
		Size: 660.9 KB (660941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5711799664c15a4150ab3e5874dad2bbd61c5f36e115cbd9e948541365c4eed3`  
		Last Modified: Fri, 08 Apr 2022 23:14:02 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cd588f88caa6a20b0941f4a2ab969b95d98ee856909be30ea3ede1cdc05830e`  
		Last Modified: Fri, 08 Apr 2022 23:14:05 GMT  
		Size: 19.1 MB (19115787 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
