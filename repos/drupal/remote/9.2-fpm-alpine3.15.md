...
```console
$ docker pull drupal@sha256:9f4546e7fd7c3933994a3af863f7f46f8ab77047f93c2fa05936608998a6d399
```
...
```console
$ docker pull drupal@sha256:ec929d26d37bbdfc4aa93b92fbb093874052f9bff83579f3fc72ac26e7db7428
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50262540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccba6db06ea0eca67665a2970a7dc7eac010755f8798c91aa0a6cfb36d3d7b92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 23:17:32 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 23:17:37 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 23:18:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:708f440ae76b72da8023a83f1f34330d0ddf3183fd24da5e38b116036d82c512`  
		...
		Size: 661.6 KB (661584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52d55b1f0ccc6905974ee537b368d121f25981867a6f618d09bb663601fed624`  
		Last Modified: Fri, 13 May 2022 00:49:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dadeba9146e5a12cea1c416672f16e75c69b99caaba20cb863f9a86b86d245af`  
		Last Modified: Fri, 13 May 2022 00:51:37 GMT  
		Size: 19.1 MB (19117286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
