...
```console
$ docker pull drupal@sha256:9f05dc2df2a6eff322d056a74eb6f2ab961bb9029b4d3463e27cf876a3a1a796
```
...
```console
$ docker pull drupal@sha256:700f95a7133cad87916850b9a5aeaa383d38fa917d944753100bc445d4f1a26e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46770223 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c555e943f794eb6f4a14761917779eab99a0f0f0ba4d25688dcaa7ead417248`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 01 Apr 2022 19:47:33 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 19:47:34 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 19:48:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 19:48:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:149ebfb63b6817fd338f72206dbeee74ce179a63b8168f7bffd002e5e5a12923`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a23a4c9ed70fd36a1d7a70b7b3e36b4ed40d4dce9dfcce746088f7d49f55ac2`  
		Last Modified: Fri, 01 Apr 2022 20:36:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60075618ec79d9fafc3ad81121fcfae1f2658ed8fb32ecc1c4689e04ccdcbb85`  
		Last Modified: Fri, 01 Apr 2022 20:36:38 GMT  
		Size: 19.1 MB (19115922 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:65d4e28fe8226f84837d600a7b76575645029699176d6e18142b4a36d31c6176
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50148087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3472da94c8e885b372ed4a3eb7a6c99dbedbe13883cf8b681d68c1ec99a5109c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:05:29 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:05:30 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:05:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:05:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4cff687019d3f683c4211ef0a21924faa3ee3d135bdde44d0226c9849de07173`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2ce1c03403675474ca0a149fccc81b04254f9dbe97afdcaa1b790f2eb5b05b5`  
		Last Modified: Mon, 04 Apr 2022 21:31:59 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4542f1f50e0d29d3f2f5ad27a04d42a4242c6be88a937a95461a6e16e89034c`  
		Last Modified: Mon, 04 Apr 2022 21:32:04 GMT  
...
```console
$ docker pull drupal@sha256:7b8db5f37f7efe79316fdf56d0b9525a15c1e5acb3fcecdb311a03b37c889ee9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50071470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bc33df064dd0aab0fbfacbfdf216a87c48c98818cd3538c53ac1bb93ef9cae0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c3280c5aa1c63545b95c5964162aa4e4237d0a5e557cee74de211cd921f827d0 in /usr/local/bin/ 
# Fri, 01 Apr 2022 20:41:48 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 20:41:50 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 20:42:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 20:42:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0780e7b32d9c0dc37a7ba6e664b2d665071fb82e3c7cfb4e9875cce29d139f66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fe1ba93e9fce107fe9824e49013e00ae43a1006a5c7073a34550dd65b150b1e`  
		Last Modified: Fri, 01 Apr 2022 21:42:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:958c626723c2bcbc0646f7c29ae3256445ec14f76c642091172671d4f9094e6b`  
		Last Modified: Fri, 01 Apr 2022 21:43:57 GMT  
		Size: 19.1 MB (19115839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
