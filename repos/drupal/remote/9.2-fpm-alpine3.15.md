...
```console
$ docker pull drupal@sha256:d2fae0015d3966d25cac289e69d03c7200e640dee3e0af697a12b8642fe2d84c
```
...
```console
$ docker pull drupal@sha256:5d584cf24f28c54b725a756a31af31810e959429cffc0144ed75e7f4ef066c19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.9 MB (46929651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c6cc3aa308fccf02bfdd99cdfbdc7a34ac0b663b69b8a72932b6f7858e081cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 06:22:43 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 06:22:44 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 06:23:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 06:23:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:834b183c3b277b82ff9e3897292733be5c6ccf28101e176bc73e8b0962aad9fe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02e920a71dd5e577fbe69c14099490f76b5471bab8c77e1e34734604b81ee519`  
		Last Modified: Tue, 19 Apr 2022 08:52:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e31bc8e521e3400b75341789b516596db8de84b8de9d4f273d4a49803dcf6ac5`  
		Last Modified: Tue, 19 Apr 2022 08:52:54 GMT  
		Size: 19.1 MB (19116122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a09d6b3af6866f77407e42c44095998c9512f60b2fee3c339d564ec4878d4946
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50261477 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:402854838153fabd261ef35202f0204d81fc91e43af903be566f8e90f06c367f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 08:11:44 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 08:11:48 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 08:12:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 08:12:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:708f440ae76b72da8023a83f1f34330d0ddf3183fd24da5e38b116036d82c512`  
		...
		Size: 661.6 KB (661584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d2047940e5760e91a40b4756d8c9e4fe1b62c08e8ad2eaa5cb7492bdaddecbc`  
		Last Modified: Tue, 19 Apr 2022 10:56:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32adfbaa91b451695916baf3f0a9cea6c6aeff534e725b4c84e60156b2110945`  
		Last Modified: Tue, 19 Apr 2022 10:58:27 GMT  
		Size: 19.1 MB (19116223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
