...
```console
$ docker pull drupal@sha256:21444bc622a817da6a54e0fba6cb3f2d4d3c77ca9feb8b31cbbf47a65e2554dd
```
...
```console
$ docker pull drupal@sha256:6868953cd654bea6e58cfaac3b489761f784d877ff637cd9a4a05ee252936b17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48376613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e78c4a8cd720e8fd8808375d0c8a844d9c50395a8ee355b7d0a0d59b1d8a07a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 06:26:58 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:21:46 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:21:46 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:22:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:22:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5319e87fc5ce6baaf099ba568755175f00ade64141e492a009a59de3273a9f78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe5b08097508d03e1bb1238c00167aaf80a3dee2aed655d38e80cbb11a1e170d`  
		Last Modified: Mon, 13 Jun 2022 21:14:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e7e674bd1f79abad31a387604a5ce4556d202e228bd20f6f88f81dd15ae04d`  
		Last Modified: Mon, 13 Jun 2022 21:15:15 GMT  
		Size: 19.1 MB (19122243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:1d7665f4e953d83b617a617ead10514081f8959ca45593ac1db6b479b8394c95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (52007641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7bbe475e403364d29e8b0a4aa44acd83b04b5b82d4601d827e4cd5dbe149b05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:14:52 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:14:58 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:15:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f36e9ad122f890fda93040d9e5d1b8048a44d48592d96ad6dae26663b0ea6b79`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:902c77385017deb6b4a80ec396d36465f0a51b0c389b7faf1f75059f66949150`  
		Last Modified: Mon, 13 Jun 2022 21:26:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2df8c7ecc8b64a6cf466942a1ac6d2bfe722d4d6d280a1421426ed80dc8a27c`  
		Last Modified: Mon, 13 Jun 2022 21:28:33 GMT  
		Size: 19.1 MB (19121898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
