...
```console
$ docker pull drupal@sha256:9fd6f1777eaae9efa734881f0287b56c08c9c43f5dd177cf7ecd3c4737e4cdb1
```
...
```console
$ docker pull drupal@sha256:bc82d0354e131e2ce7a4c2dc5170ea111e0cf8a8db7855179b664076cdbcdb96
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49663269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35a12f435f52efcc58fa529e4bf00cc69a25581ab61f2def1b3716259f8ad68f`
...
# Thu, 31 Mar 2022 05:47:53 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 31 Mar 2022 05:47:53 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 05:48:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 05:48:04 GMT
...
-	Layers:
	...
	-	`sha256:cc7265aacaec85c2e76c0ea14deda611829671cb92daf774a7d07696a2b5ecb9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45265705eb4e52949d00f30802f2cc5ae3f86d5649fc8e50916af9e901c9f01b`  
		Last Modified: Thu, 31 Mar 2022 06:07:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00ea95c28c22d8f8766aa7132fd8b2d2a33373f5e75cc2ca9fee7c3f43faf482`  
		Last Modified: Thu, 31 Mar 2022 06:07:45 GMT  
		Size: 19.1 MB (19115852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:237f6ee971cf0af7fe72dcbc0b1cf699a14212e66284fc33b7d9b0575e52df4b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47828818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d8ca9f5e6ffd6b62617402980138d955df91b1a2e8202d7d88b54f7a21e0504`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Wed, 30 Mar 2022 18:14:19 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 18:14:20 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:14:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:14:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:db2f8391f3d0e2977ca90759e0a11bb8160373b48bc6e201409a120bb01660ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a8e8049569f914a4a0e4a32be2dace7a08a247517ce516d22c53197820adae6`  
		Last Modified: Wed, 30 Mar 2022 18:29:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63e758d5c81dd42a1aacd7d08098b3623c88dad642c27325aad9b97c74fd588a`  
		Last Modified: Wed, 30 Mar 2022 18:30:09 GMT  
		Size: 19.1 MB (19116019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d0856cb3c4f0bd4aacaa863f5c152b732361c90da14171c8500c05425f5c9fe9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48673647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77049a9b049c8e6dc2526ead62e2728a1c1d131edb7266957a7038e5faa8937b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:34:02 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 15:34:03 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:34:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:34:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ea7316edb929923232d049ac59d7d0a84440e58034041e664b36d4e3f9cdc6b5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dd46863207e521f0113f0e1be4a923f0187465665889d70b0b45065501f23d9`  
		Last Modified: Wed, 30 Mar 2022 16:01:02 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:528bdc102f233ca090e8db316523531aa0e71c8fa16afdf2dd4cd0d8e7bfa57d`  
		Last Modified: Wed, 30 Mar 2022 16:01:06 GMT  
		Size: 19.1 MB (19117375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:9a118612a7738d6dc8eb29e12b73ecbe4257bc12448288543472cff1b0d1090e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50063862 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29a6f708840fc71e99225c7d4abdd84fbe952953fa0e7ccc1389dc7a2b1a2ffa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 18:29:37 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 18:29:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 18:29:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:617111795473d787eba22dc3613f70cc02ee3d23e323b2f47bf27bb113b9a7f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62f623fa146096ecdef2c042539b14ac9431a929541bd21c484598e95283bd8e`  
		Last Modified: Wed, 30 Mar 2022 18:56:28 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e21d202b96b0aaa12c8d4e5517367c81df3fdb027e642085c7ce65d1b22f81a`  
		Last Modified: Wed, 30 Mar 2022 18:56:33 GMT  
		Size: 19.1 MB (19117050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:5ba3b9c3fad489783a05c910c3599e153efff701a5699f6fbecbcc36888462be
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (49988402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3596157ffd2b45bad5ee8ad3b922a1f6ab65b5db52ba1565f71666d323f7a72c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 19:05:24 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 19:05:37 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 19:06:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 19:06:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:51fda53acbcdf3e27856feee78b2e748d583c11842965c95a501f3a2d3be36b5`  
		...
		Size: 575.7 KB (575716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3308c7080181d25707e4958c4e9ac826aa0028df3db1095b45544af9af59da0a`  
		Last Modified: Wed, 30 Mar 2022 21:15:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:213ef00bc7dc49bda3774229debc24d43f7585bbb16be3b94baeb39e60819aa8`  
		Last Modified: Wed, 30 Mar 2022 21:18:02 GMT  
		Size: 19.1 MB (19116086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
