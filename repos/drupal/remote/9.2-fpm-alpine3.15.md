...
```console
$ docker pull drupal@sha256:a264390e02258e5fa9cd7b52e49e78d95cb962c276935d558e5545843b43dd0d
```
...
```console
$ docker pull drupal@sha256:4c2316a7fc457413f54b674825558bea7b2385bc19bc715034fdbb6bb7f7dbba
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49746315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:136b1d6135944a1b18b58bd0da26f0118b6201b4baf1278dddf0be7d650cfdf8`
...
# Fri, 01 Apr 2022 17:42:01 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 17:42:01 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 17:42:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 17:42:12 GMT
...
-	Layers:
	...
	-	`sha256:954d15c54645b83c079de6991e34af2c0401f8c01f174b35b7b553521eafe6a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3426f0c437c7f20f1ef2e23d51e0f455da9c9cf654b113a3a7e2a6ceb7c261c`  
		Last Modified: Fri, 01 Apr 2022 18:01:45 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1692247581e9ee7a6ca5267c99bc5ed7ec61f03fd1a5a4431ed030400a0eb0b4`  
		Last Modified: Fri, 01 Apr 2022 18:01:50 GMT  
		Size: 19.1 MB (19115930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:4dac09d36213a44dda96e3f7e852ada2cc1ddee501774bee2ba38e8c230fb225
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47911411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8027905b1fb24cc941dd3efda7c94d6bd99334891097fed2aca870b664e2195`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c3280c5aa1c63545b95c5964162aa4e4237d0a5e557cee74de211cd921f827d0 in /usr/local/bin/ 
# Fri, 01 Apr 2022 18:13:33 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 18:13:34 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 18:14:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:fa41f61af08cf6a75a24c4ea2d9cf990b959aa960a07b478ce1320de8579e1de`  
		...
		Size: 659.0 KB (659031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a229c6ef28c7be49d70d811623df9f803bcd76b53f927431d14443abc8b2af4f`  
		Last Modified: Fri, 01 Apr 2022 18:28:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e8e4e29591238f49724d1d34afd5217bcb9bef4f46ed50c87e033d88548beb7`  
		Last Modified: Fri, 01 Apr 2022 18:29:19 GMT  
		Size: 19.1 MB (19115649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:64d09d91194a49ca59119e6a465e37d95efb383a1f083005671be08e4c5e2b8a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46687284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f546ebf12a4c8c4912bf4bd20632897b5ac3a730c47d524c0e0cbb3ee5752aa0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 01 Apr 2022 03:42:56 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 03:42:56 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 03:43:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 03:43:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:55510d07ce5abe7e731bb2430d9631130b21e4ad82192f3f6b92a20779e5187a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:200c8051e233ac3b6f209439acd7056d815ab9eb9109ff886a41c91bb5e3944b`  
		Last Modified: Fri, 01 Apr 2022 04:31:45 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7c1b3aec5c486b992f96915c4e9b2d42f0e56a4f8df6f147790513e286f9745`  
		Last Modified: Fri, 01 Apr 2022 04:32:13 GMT  
		Size: 19.1 MB (19115959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:74a9447f00b0409ce398ea72522978d782983abeab0ab66aaf7785095996ced0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48673736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38cc7590f42e85f4e6987421c355ce2fd1552770f95a6738185d82119b0ee7bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 10:26:13 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 31 Mar 2022 10:26:14 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 10:26:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 10:26:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5f403b892e8cf6a6aae173992373771c0e84c5a801cf7573acb0b8843c8de361`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fc3de83ed1804ca8d96b7780103225efc6ddafb1a746619ef4b184c4c3e9ec4`  
		Last Modified: Thu, 31 Mar 2022 10:51:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d3d1d098a90f2dad734b33884d6b697bef3643db5a9a1b5d4be8981bed775b0`  
		Last Modified: Thu, 31 Mar 2022 10:51:59 GMT  
		Size: 19.1 MB (19117106 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:a2a20f686afaf01ed09dec1688b8ca773e61f30758059c2122e458da0c3128e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50146418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:512dcc5931df7fa2452b86bb81021cce0491034b5d1b63c36c38d8c6ffb3417d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c3280c5aa1c63545b95c5964162aa4e4237d0a5e557cee74de211cd921f827d0 in /usr/local/bin/ 
# Fri, 01 Apr 2022 18:05:01 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 18:05:02 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 18:05:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f8e4e2dfb270faa59bc3666b029a7e5ebcf6073fa4e6ea628292fa4bf6a9994b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af3a5e748d70509d06729bd4f955e020797bf18cc696fadf091af0f6ef94994c`  
		Last Modified: Fri, 01 Apr 2022 18:30:51 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16fc827fac8d0bb2cc5b6c12195192469a7ae33265f9699c1bcb04b7be3ffd68`  
		Last Modified: Fri, 01 Apr 2022 18:30:56 GMT  
		Size: 19.1 MB (19116643 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:67ee08455a353c283748e64210a746facf56ecd9d38fd75ae949dc263694f9b7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (49988583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb23e09f4fbbdf289d810de066dd8a467cf8c428d3001ad73ac18e1cce9146fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 19:27:00 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 31 Mar 2022 19:27:04 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 19:27:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 19:27:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:86e8237aa6cf7287073bddaabe6721a088452b3f13f51816fb7eb69408893742`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d51efbb12ebd148e226eb37796c8c8d360773607f0435d0cffe1c9de7f6d831`  
		Last Modified: Thu, 31 Mar 2022 20:36:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b4f63934a9ee41b6446eb2855cb77604f73714f30cd3648a1a077419aabd94f`  
		Last Modified: Thu, 31 Mar 2022 20:37:52 GMT  
...
```console
$ docker pull drupal@sha256:8de8d38beca84f407dbfccf525e2b9a333482a57ada78e0d5c739118b394c444
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48434419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b750a7ffd54859ded81fbae7fb1d6faa4a7f31cf933895f47fd26dd6d24c7dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 30 Mar 2022 21:29:02 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 21:29:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 21:29:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:225caaaf62d24385a2040cb1916e226d300330f31a114b8ebb2da7701e758f77`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:465ccb9ecb6cfc485f8467380b38e4a4900d69fc8523d31234b3c5828e4899ab`  
		Last Modified: Wed, 30 Mar 2022 22:15:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86fda1ff994c1ac2e9de0c13a6235b34b6246e5f87973d92f57b2acef5029aee`  
		Last Modified: Wed, 30 Mar 2022 22:15:24 GMT  
		Size: 19.1 MB (19115952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
