...
```console
$ docker pull drupal@sha256:7a5292bda12ef414a23bb2870eed08a0798934fc85787635125401aa8311db2f
```
...
```console
$ docker pull drupal@sha256:e518acee73f103dcb31fbd34f9375ef74edaf4dfcc48b957c15df8ab2d5d06bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.9 MB (46929471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0c13f86179d763547d2e5f470f8779b867323888366897072a9f12180318169`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Fri, 22 Apr 2022 14:47:37 GMT
ENV DRUPAL_VERSION=9.2.18
# Fri, 22 Apr 2022 14:47:37 GMT
WORKDIR /opt/drupal
# Fri, 22 Apr 2022 14:48:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Apr 2022 14:48:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:834b183c3b277b82ff9e3897292733be5c6ccf28101e176bc73e8b0962aad9fe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cfc393e2baca9ca56677202cc609582da3b2915d77079922798c5d9ab19e875`  
		Last Modified: Fri, 22 Apr 2022 15:35:16 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:328aba39ccd2e6f2b43fc9cbe3d458cfd3b638fd4d7042ea2318ca0c40c74959`  
		Last Modified: Fri, 22 Apr 2022 15:35:43 GMT  
		Size: 19.1 MB (19115944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
