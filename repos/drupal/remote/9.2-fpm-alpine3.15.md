...
```console
$ docker pull drupal@sha256:5dd244ee026d16d18b910d596b7df5f2ba1bdd639a9cc2d8c468d9a74ccba835
```
...
```console
$ docker pull drupal@sha256:837c80eba8ffe3ec1c9e9c230788b94b4e86732c64ef228b0fa30103b1ebe07b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (47953094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a0ffd28d7d0cb525a97725935debb433d365f1adc668451674261f1b5cdad9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 12:52:24 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:14:36 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:14:37 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:15:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:15:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8b07205daee72af257864db3dc7001cf3731ad498b628e9a5537b45953453803`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1423cf9d2c86141be8d96352f0a4769ec341ef3ea8c2183ba1db05fed95ff689`  
		Last Modified: Fri, 11 Mar 2022 15:43:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4541bad6e975fcb24a86373491173776453e65cb158f8fba451ad1fda787754e`  
		Last Modified: Fri, 11 Mar 2022 15:44:18 GMT  
...
```console
$ docker pull drupal@sha256:6a8d2905bcbc8f603e6fb550d4c4ae107e15d3426f76e9c2bcf00608c6ffc532
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51636314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a76e12f2baa212f125345b300a37e86eb0e21b46e8fb5f3c0cd45da47595677e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 14:49:22 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 14:59:47 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 14:59:47 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 15:00:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 15:00:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0894422ee1205b1ba5ed9bc5ab1ea8e46d0c14d6bf3990e2c0c51bde81b11c7c`  
		...
		Size: 575.3 KB (575341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88fe9e63f7441b2bbadbdf76b6e000e2552229bd6e19d86f0a58bcb244c18c54`  
		Last Modified: Fri, 11 Mar 2022 15:32:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ce1e800d677de566d0327ba40fa85b1727a0e954543dee7c77927cb58ea921e`  
		Last Modified: Fri, 11 Mar 2022 15:32:30 GMT  
		Size: 19.1 MB (19109969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
