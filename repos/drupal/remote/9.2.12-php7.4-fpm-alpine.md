...
```console
$ docker pull drupal@sha256:85412014c198b863d1670ead0d24611768f57f7c62cfb966d62687871fcf4c60
```
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.12-php7.4-fpm-alpine` - linux; s390x
