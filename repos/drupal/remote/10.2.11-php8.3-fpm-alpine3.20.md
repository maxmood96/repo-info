## `drupal:10.2.11-php8.3-fpm-alpine3.20`

```console
$ docker pull drupal@sha256:e7d5426d116d452ac9baf9d30064b090b9deeaeda8a7313e4d8a39fa07f7dd7f
```
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; amd64
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - unknown; unknown
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; 386
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:10.2.11-php8.3-fpm-alpine3.20` - linux; s390x
