...
```console
$ docker pull drupal@sha256:c754cf7970a41dbcadd8ba7f1908e4436a10c19de8ca2a2317bbf4214f0cda1c
```
...
```console
$ docker pull drupal@sha256:fc9330c38d03b29268a4300cbef05b20e85631aca3b13c24919bf0750f95aa71
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.3 MB (171342132 bytes)**  
...
# Wed, 12 Apr 2023 11:36:09 GMT
ENV DRUPAL_VERSION=9.5.7
# Wed, 12 Apr 2023 11:36:09 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 11:36:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 11:36:21 GMT
...
-	Layers:
	...
	-	`sha256:10810ff90d6edfcedbe65218afedc6663dab511d39fc517951301f28844947dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12021e42e6176b827c22319d0e80cb9537e2058e11662ebeaa30d2d3bd91bfb7`  
		Last Modified: Wed, 12 Apr 2023 11:51:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:772033401b0ea002277ce26f12f40d89835be072cbdeecca13fe24e616f1e472`  
		Last Modified: Wed, 12 Apr 2023 11:51:15 GMT  
...
```console
$ docker pull drupal@sha256:eb3a8087e53afa92b92b34d51c2bfeeced71e5e59bbfcc22b56e9e7c47cf74e7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164035471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47338766e6c1909b4a60d8343f9442e537acfa5032161b643171f78b09b1dbd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 17:33:48 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 17:36:28 GMT
ENV DRUPAL_VERSION=9.5.7
# Wed, 12 Apr 2023 17:36:28 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:36:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:36:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f08c7012311415eedc82bafb70309a29ab726074151c30adaab579775afd95bf`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41273fdc8fd957237d950e5963e58d9adc128df612c4f9c09c567efdd75cb77a`  
		Last Modified: Wed, 12 Apr 2023 17:52:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c7e8b617cb559d5a508c85e0c6ae33498051e84472448c1977ded476fa2443`  
		Last Modified: Wed, 12 Apr 2023 17:52:07 GMT  
