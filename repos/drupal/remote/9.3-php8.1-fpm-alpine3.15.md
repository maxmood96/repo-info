...
```console
$ docker pull drupal@sha256:5fbdde44b59e344994568d2b2defaf8641dccb9da2cbb23deafed09c82007642
```
...
```console
$ docker pull drupal@sha256:6ad7f29baec764cd2ff0b63ace9cb1bf226d75d3aaed0dfb9256427cb07afabb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52615435 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e860a0e1ca922bbb5fa4f0874f84066b56ee908211c69a326f6858b582e33845`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:54:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:54:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab08e026cb36606110a16814deebcdfaa92ace29ec9d19019790ded1f89431ec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc87dd84d8e7a6d43ad66f3351ab262843fe02e83445e66a20c97508e2444ad5`  
		Last Modified: Mon, 06 Jun 2022 18:07:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c73de51209e577a8ff13a8d53d79ef43cea61b0a70e6e744f820ca4c8f8d6cf`  
		Last Modified: Mon, 06 Jun 2022 18:07:38 GMT  
		Size: 21.2 MB (21201488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3d8f05fc84f726bc55d002f2725716bc3aa620ce9bdc95db13a868474999105a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53198465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:807ab23d13f8a4971e24b47391f85688faaddf04e5f23e1581306da95be60ce0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:91568838266fb7b8cd5acb0de6a68f18c528856dd57f512cad675f5d017be14a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d267051e4e88502c04e3996c0a1920a03575e5c2a4619934117ac70d7b130a35`  
		Last Modified: Mon, 06 Jun 2022 18:22:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37770c013735264f8857827d959e2636ede25723b20ad7e843c1934b86780e6e`  
		Last Modified: Mon, 06 Jun 2022 18:22:21 GMT  
		Size: 21.2 MB (21201343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
