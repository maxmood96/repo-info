...
```console
$ docker pull drupal@sha256:ec0c538f63a4a6a9af30010a10836865f6a48b7d8d05887342ffe0621ce6e2fd
```
...
### `drupal:9.2.14-fpm` - linux; arm variant v7
...
### `drupal:9.2.14-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:2bd7693802e5a1805d14a7c85888e351c06b83ba6bee41602f9e5cdf6a3f36d4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.5 MB (174524604 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be19d0bbe475ed1828f8e6da3e66fc16207cd12f82e121a0a193a6d1b7cf6ff9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:26:28 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:26:29 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:26:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:26:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15d7431e3ead277ba255c9500f7fa6e67fcc9c9c33050fee419dc3ea5d76458f`  
		...
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:999a8666d683d269986b12e0ecb1048fcb704904118e73e66d1c115b63f89906`  
		Last Modified: Wed, 16 Mar 2022 18:52:30 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b04618ac6f577f5d93e1aa95e438687170a72e6c671c6d31371fb6414d53af5f`  
		Last Modified: Wed, 16 Mar 2022 18:52:35 GMT  
		Size: 19.1 MB (19124686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-fpm` - linux; 386

```console
$ docker pull drupal@sha256:1589e164a2ee323006527d5e594d0d8997cfccaf45ea06630f67c9f97f0974b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.7 MB (184733406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ce398fb719dcac740a3e633625a8c3bdd36289424a138892339f2e5b03a35c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:32:30 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:32:30 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:32:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:32:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b517dd9c2b8aa4b3f5a51fe4b151987d5edb54aacd4cba78e9aaae65adc7d235`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5d3ba3ca4c0b912b9fe8173332f1fe10155475d3889463a20c97ca4eb9ddbec`  
		Last Modified: Wed, 16 Mar 2022 20:48:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77139841b555117d3f1776d805bd16ddf10b43122b041735b8cd12fb6f35a1c`  
		Last Modified: Wed, 16 Mar 2022 20:48:32 GMT  
		Size: 19.1 MB (19124629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-fpm` - linux; ppc64le
...
### `drupal:9.2.14-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:3359552c043164f8a8798c90b3b27bca06b8df5f6cf9e78dc6b35399a29cf0c6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159074853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46acdb39d241302ba61674310b19ab3fe93a69aeb9d91efbc10cd830f8f9d204`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:15:18 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:15:18 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:15:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:15:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ce6c6c622654fd099f03516bbfd79a6172f866e196b008e4cd1ee77fec61039`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73247158c7db544988ff57bce6eb648f130ee9a12077249aa5014495b72d5968`  
		Last Modified: Wed, 16 Mar 2022 18:37:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a41a2965ff3df82acf1277b657f337c6e96f5231a958694bfff59bccf57190a`  
		Last Modified: Wed, 16 Mar 2022 18:37:15 GMT  
		Size: 19.1 MB (19124695 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
