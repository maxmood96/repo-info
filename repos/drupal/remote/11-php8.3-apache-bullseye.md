...
```console
$ docker pull drupal@sha256:d890fb99cb61f2fe0b4da7d7c696dbda42b986c8d18dc5e655ad60476d241703
```
...
```console
$ docker pull drupal@sha256:8948fdf27579ea52f4e42172b97bac3f2ce8b148382a713c1e1dc7662c975bd0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157987560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:766938454126b856250b96cf19ab029fbb9034aa035b7cb88171e3a15aed5cf4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:8711b8852cc8a8a218c33bb33e66b27b4e0b2026d530d95832a2b4647de8c6f3`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f369a6ea3bf483c702cda35582e98b878cb42ad665d0d9b84695df577107fe51`  
		Last Modified: Fri, 20 Jun 2025 22:19:46 GMT  
...
```console
$ docker pull drupal@sha256:18d53a30a96305bca936009654524719c66d59e9275d4c1fa3b4217f934a1d49
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7073516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec44d0ce07a48b75a1a2b3435bae277e56455d11815437375ed9af829e9be3c7`

```dockerfile
```

-	Layers:
	-	`sha256:628d4aaa6100a9b5461c5a065db2dca5337d3ada8e5e0bc8f402bb946f40a16b`  
		Last Modified: Sat, 21 Jun 2025 02:02:31 GMT  
		Size: 7.0 MB (7036701 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:05251924d5070489b74878bd54a524da8cb28fda6a2f9cc2f498c7294c408f34`  
		Last Modified: Sat, 21 Jun 2025 02:02:32 GMT  
...
```console
$ docker pull drupal@sha256:547840ae10b108cb5fe3538b3a3305e33efbe1955a93dae08d51bdf3cd1839b2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.5 MB (182477818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96f173220a6b2bce891277850706cb717437aa76f73fa5a2e9e0c4811f851979`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:9c97f981eed02828d94c2e9908adbb9995130ce281fd932c94c20e6764250b0f`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:44c0d2bb114fb666418bc2367948121a48c75d10184045a548e265dac4221965`  
		Last Modified: Fri, 20 Jun 2025 22:08:56 GMT  
		Size: 20.5 MB (20517795 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11-php8.3-apache-bullseye` - unknown; unknown

```console
$ docker pull drupal@sha256:5cc4ee9e8ef827b98fc9db052791ccb27332fbb742cb191303e917a166ba4a96
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7266123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12db7a773e7f7cfd12a670d4c3befd9dca0299e1a4f5bae5360f194f6e387233`

```dockerfile
```

-	Layers:
	-	`sha256:05bc63264e131b51ef4bed61cdd9ec01145640cfa3351ed1d70632ed6cec366b`  
		Last Modified: Sat, 21 Jun 2025 02:02:43 GMT  
		Size: 7.2 MB (7231469 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ad136f0032694d71cde5ce8f06c4d73480a8b4282b2a5891e2404b782b5d0272`  
