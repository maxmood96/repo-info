...
```console
$ docker pull drupal@sha256:3377dac999b0c047b0154ceaacc7d1d3d8cbfc0a6a01a7e13d616726bc8f25ee
```
...
### `drupal:9.3.20-apache-buster` - linux; amd64
...
### `drupal:9.3.20-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.3.20-apache-buster` - linux; 386
...
### `drupal:9.3.20-apache-buster` - linux; ppc64le
...
### `drupal:9.3.20-apache-buster` - linux; s390x
