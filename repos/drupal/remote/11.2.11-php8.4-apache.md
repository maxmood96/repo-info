...
```console
$ docker pull drupal@sha256:f077ac4bb39e24f6a1cc325e9f8800ccd6a7a44f261bf07bb4b630edf8ff20b9
```
...
### `drupal:11.2.11-php8.4-apache` - linux; amd64
...
### `drupal:11.2.11-php8.4-apache` - unknown; unknown
...
### `drupal:11.2.11-php8.4-apache` - linux; arm variant v7
...
### `drupal:11.2.11-php8.4-apache` - linux; arm64 variant v8
...
### `drupal:11.2.11-php8.4-apache` - linux; 386
...
### `drupal:11.2.11-php8.4-apache` - linux; ppc64le
...
### `drupal:11.2.11-php8.4-apache` - linux; riscv64
...
### `drupal:11.2.11-php8.4-apache` - linux; s390x
