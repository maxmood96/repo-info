...
### `drupal:10.4.3-fpm-bullseye` - linux; amd64
...
### `drupal:10.4.3-fpm-bullseye` - unknown; unknown
...
### `drupal:10.4.3-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.4.3-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.4.3-fpm-bullseye` - linux; 386
