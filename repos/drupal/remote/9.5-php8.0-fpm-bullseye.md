...
```console
$ docker pull drupal@sha256:c5b21564c367c0d2b4980847dcba05374c3ef4d2db320d1327ea2c5fdc7f12ca
```
...
```console
$ docker pull drupal@sha256:4829f78ee83d9f1b1f48e75f39da811f5868ca9f181bd9f1251d49dae59a9b8b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155951962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b1a1f8517dedc5fb446c6c1a262a45e1c576894a7118491b7618d49ea15e389`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 09:00:33 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:00:34 GMT
ENV DRUPAL_VERSION=9.5.3
# Sun, 05 Feb 2023 09:00:34 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:00:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:00:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:588b0789fa3dbdad0116d63f0defffb0a4104f10d34357b0057716b12ce3afde`  
		...
		Size: 700.1 KB (700099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9f5b32079e7816482a897df7f9249e7908cd21c8c3153fbb284fe12a113d9e5`  
		Last Modified: Sun, 05 Feb 2023 09:31:33 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a4f228264416708d0aa8a355b68da9d1e9d93feb60532b2db1a3653d0310b2c`  
		Last Modified: Sun, 05 Feb 2023 09:31:41 GMT  
		Size: 22.8 MB (22844345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
