...
```console
$ docker pull drupal@sha256:e80a1d1d1c98f0abd0beaf6b01fc87cfaca9bf2d43bfefbc26f890dcb7031190
```
...
```console
$ docker pull drupal@sha256:49f9ce1fef74c8094f988f3ab10a7981540e1c3916bbc2a7a2ced34251f03293
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (156006232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb4a78e305c0d305eafab8c39f86f18a04d4002dab480447306c660fcae8363d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 00:58:58 GMT
WORKDIR /opt/drupal
# Sat, 29 Jul 2023 00:59:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 29 Jul 2023 00:59:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cc5e602966387467bea5f7db5c9c057a9c843e36b698a2768b8df12a0b7786f3`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9522dc59be5d2ce3ee2fd927ce4ffca5597b7e25137cc47e4e40780a754aac7b`  
		Last Modified: Sat, 29 Jul 2023 01:18:14 GMT  
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c66dccf7fffb255909bf9299d25f81a53970483a9cf21bf524f37f7599e1056c`  
		Last Modified: Sat, 29 Jul 2023 01:18:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f23a3789e007b6ebeb9331fe81137c66dd5ac5b897f450fc04fbd729a2df162`  
		Last Modified: Sat, 29 Jul 2023 01:18:20 GMT  
