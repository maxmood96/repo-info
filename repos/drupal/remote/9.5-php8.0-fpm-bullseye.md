...
```console
$ docker pull drupal@sha256:04c27d3bbfb4406384f79180e719974eb3078587258090a862196c5eb3eaeba5
```
...
```console
$ docker pull drupal@sha256:52bbaa7ebd62a4c114d1e17ab0b3b751fe75897483af921953c2fbe1920c3bcd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188551539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35ff4ae6b60e9e64426148623e6893d4a0c1759e68396833fe56675113ab7df5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 00:23:38 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:23:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:23:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:71a95ba68eae76ad8c22e5de71249e67b689a87c3be5a65d169272470afa0042`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c24f4a46d5ceceb5e0286c11e700d91ecf0d67a4cf5b8719a45c493ca28c474a`  
		Last Modified: Fri, 24 Mar 2023 00:38:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d53baf925776af968e8f815d5c0157cdd7b5240fe97990dfad490aab076326c`  
		Last Modified: Fri, 24 Mar 2023 00:38:47 GMT  
		Size: 22.9 MB (22850034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
