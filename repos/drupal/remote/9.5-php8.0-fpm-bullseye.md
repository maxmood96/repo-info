...
```console
$ docker pull drupal@sha256:4fa95892b36b772fd196ad00fb5e5edc4396e100d8fcf2edc2158c4304c17187
```
...
```console
$ docker pull drupal@sha256:4a786b41492cff33f4643c77abb0af514d693156d8e44341af6e871e89c428e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185939266 bytes)**  
...
# Wed, 11 Jan 2023 23:02:01 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 23:02:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 23:02:15 GMT
...
-	Layers:
	...
	-	`sha256:90137b386f06001caa2649651e711a83ccf1565a84c6e3c9043cb294df13db0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ee565ef362f72242499e02dcffc74c520fa6729735c869b3813294206f3d39f`  
		Last Modified: Wed, 11 Jan 2023 23:20:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a6957a3556ba3ac94583a060f1e85c558dcbb2544ca48cfb310b72580ce7126`  
		Last Modified: Wed, 11 Jan 2023 23:20:10 GMT  
