...
```console
$ docker pull drupal@sha256:513dcf4eef31e5be0e13b5af136d18799a10f0f7dcb4f048f46f2a5840d57144
```
...
```console
$ docker pull drupal@sha256:9f98707c02e59285298e27db1ea2d1ef904a7b3bdfee772af57aad74c8291d34
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.8 MB (185817328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29eeae04cab8963d3326cde3b1c928992956407c31da5af946c2ad4950118c81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 Oct 2023 21:35:05 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:35:06 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 21:35:07 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:35:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:35:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ad808e31c75ec30c5992ccda44049c61c3928626d2ca7b70d1f9576d595ee93e`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:825f641e07fb3bc2ede3f8f4e091e2ade82b422caeda561aef9161bf0944881b`  
		Last Modified: Thu, 12 Oct 2023 22:19:24 GMT  
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2714df4054075504bfce91626d8ed24d3979b67b95bd5fbc4695d5bae68a8a0b`  
		Last Modified: Thu, 12 Oct 2023 22:19:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5146a7af4bd25481599b43b17f2bd262e9dad7681565f098141648c6c3d46707`  
		Last Modified: Thu, 12 Oct 2023 22:19:43 GMT  
		Size: 22.9 MB (22879065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5-php8.0-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:47543a374f1918b79f97bf9e1f608aa5b7d911b1c6123f19f3c8f397b6a7525e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (162958672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e412731f67c316698daea147f4eb2731394d0dfb03e07b734f5f3f7f5d8659d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 Oct 2023 03:27:34 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 13 Oct 2023 03:27:35 GMT
WORKDIR /opt/drupal
# Fri, 13 Oct 2023 03:28:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Oct 2023 03:28:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0d3f1fbfe417472fd5bc2982053f79a3791092e4a6bbf355cc64fcac8802a466`  
		...
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:539377377eea0bb7fa6749f14033874d885f19a3826e76aa2476ce224219f767`  
		Last Modified: Fri, 13 Oct 2023 03:42:00 GMT  
		Size: 705.0 KB (705012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d6c74ce3978ace43b25806f75669db4fbaec026f8dfea27da22d9587212528e`  
		Last Modified: Fri, 13 Oct 2023 03:42:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b71219cc537708442026ceb0726488177c9b9d591340fa6ca56891e2ed45c4dd`  
		Last Modified: Fri, 13 Oct 2023 03:42:05 GMT  
