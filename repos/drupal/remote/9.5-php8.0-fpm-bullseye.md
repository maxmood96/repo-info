...
```console
$ docker pull drupal@sha256:36e8757a608c2ed96c0739807169a6ed62aaeafe75550cb82d07bf2e8fd73f3e
```
...
```console
$ docker pull drupal@sha256:aa96d0af5e28078637d545c8eaa6c255f348e2e52b906c885f132a75a6164bbc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155988019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38bf14b782c8aabe944783e0ed56c76e3d971c0b67d91457e4e3ee8785d5b378`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 07:40:47 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:40:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:41:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6edba886f1db7c4fee1ec1be91bf621fc05dcc4004cca41c48b76ca988ad1da9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:632f57c3131e879677f25d3c2e46b33bc6b0066c73f4820a4451631981a7d47c`  
		Last Modified: Tue, 28 Mar 2023 08:00:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e21e736d84ae3d99a212bab69e967f8f48f1ac35df9edd92eb48124f3f73633a`  
		Last Modified: Tue, 28 Mar 2023 08:01:05 GMT  
		Size: 22.9 MB (22865138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
