...
```console
$ docker pull drupal@sha256:4e1c02024778ca0ce5f240147ead38151a80898d219b3ea15a66f1e63e058f5e
```
...
```console
$ docker pull drupal@sha256:f5c96c5a3736007c76f326b9aec0cee7dff6b74b8593bee2a3364eb4d83a8478
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.6 MB (188569029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6a6973848c5562623fab7396ace555248c91ceb320a048153daa4f06d79b6b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 23:24:42 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:24:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:24:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d41233b0a9da8cb9ae79c93993915b5ddb43fa66bb3f64bbfd8e674b182d5383`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24ae1ffce96e4ca5765b3bfd10ac85edbdc1e301395b790057a9e0e46df988bb`  
		Last Modified: Wed, 12 Apr 2023 23:40:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29ccc01999a4e08bf9e042843480215d0baadbb3781eddd36fee9692519f7f07`  
		Last Modified: Wed, 12 Apr 2023 23:40:19 GMT  
		Size: 22.9 MB (22864463 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
