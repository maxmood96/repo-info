## `drupal:10.6.6-php8.3-fpm-alpine`

```console
$ docker pull drupal@sha256:ee290e77b824c02a2967e08c7d64c825b6b1134c9424932f23b77aa3963de698
```
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; amd64
...
### `drupal:10.6.6-php8.3-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; 386
...
### `drupal:10.6.6-php8.3-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:f208e059003020726b44ede53aa9c979497ac354cd91d6116f993d55e2772324
```
...
```console
$ docker pull drupal@sha256:866ba1a9704e847e3dc28f2debeae1adfe2e38068b103e4782a0c1559e0e7744
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.5 KB (400452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bda4d858a23dfe0c0854a541f789dca7af33b7e2aaf75d1c75ba18b976291da`

```dockerfile
```

-	Layers:
	-	`sha256:e7d15ee6d4de8fc258a458a3ea51e1189bd4b5a9cc5d2366ecd807cf75276c99`  
		Last Modified: Fri, 10 Apr 2026 01:37:38 GMT  
		Size: 366.5 KB (366506 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:92d7a779e54e2b3076773b72059a966eb49afee73a0ff047e71df8779430e8c9`  
		Last Modified: Fri, 10 Apr 2026 01:37:38 GMT  
		Size: 33.9 KB (33946 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.6-php8.3-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:af21abdf8ffe9ccdc504f931e63a8d0247677af78a0e4a8490635807585e6b2b
```
...
```console
$ docker pull drupal@sha256:e19cff6c0ec21d1026124bc8fb84cdffb129e723f4b2429bdd7900e34d25ad90
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **398.1 KB (398137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a31ea99470f6054e25c827cb6bf5ac385bd1e6202de6b40775636a500daa4d5b`

```dockerfile
```

-	Layers:
	-	`sha256:a7bdf5b078e948eeb89779225479e017791b1b070d55344f75947089e0efbea5`  
		Last Modified: Thu, 09 Apr 2026 23:40:04 GMT  
		Size: 366.5 KB (366460 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:108c914da6e420cf3d6d797b7e946e5b2d1da79092cb3e3b4f148e4d578ad24c`  
		Last Modified: Thu, 09 Apr 2026 23:40:04 GMT  
