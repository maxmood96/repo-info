...
```console
$ docker pull drupal@sha256:f904bc73fd4e69d69d54b9333ac66f6a45ab055cf1efa4829d38ad4464bb8412
```
...
### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull drupal@sha256:13fdf7dd1ad61afa02427cb93d832c893da78e0135b703ea6411f1665e159135
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (48015339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cac5b20316542a1233ca19d4e6edb27565e757a83772045300c21f3db120dee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 17:21:39 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:21:40 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 17:21:40 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:22:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:22:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:75d4133b6a4bc216f3ae1967ac5a83fd28b56a36384a16c6400e816cc431c1b5`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c22927d5d7496519aef853fe5d44fe35f6049b12ecbe78b14b65ac1540a53be9`  
		Last Modified: Wed, 01 Jun 2022 18:17:19 GMT  
		Size: 661.6 KB (661586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d570f25067f2997d6b0cce6e893f1aad842ea799d3c04921f48bd3933cfe2d90`  
		Last Modified: Wed, 01 Jun 2022 18:17:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a0612439cf5b400fad0d586a4324815d1b551af3efc1ccf5aa42e3d7206ab18`  
		Last Modified: Wed, 01 Jun 2022 18:17:48 GMT  
		Size: 21.2 MB (21168478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e4e216d9898ac9b925d74ef2efc80cd6cd5ecd2f1b1dcbd56c18aa22127b07c0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49921522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbb55fd6f254c115c962e1e35d3983afd447ab1212c0d943d2f58e3738bc1212`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Jun 2022 16:55:43 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:55:43 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:55:44 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:56:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:56:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2015ee1cd84fb8ee1c4ef0b52542c8a14e5fcbf704e1736ea6440a25f44e6609`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cf058586475ac504889f5196697b1329b613601ba3c0efb781b6bf7ae0c8885`  
		Last Modified: Wed, 01 Jun 2022 17:26:36 GMT  
		Size: 661.6 KB (661582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:568d5341f251126b473c68eafa52636a890b5a18632e69db0045870c8aa9e4d9`  
		Last Modified: Wed, 01 Jun 2022 17:26:36 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dfbc1c7fb14faef906e5785ff126cf4b7b2adba13dd5246c618e76182d50d87`  
		Last Modified: Wed, 01 Jun 2022 17:26:41 GMT  
		Size: 21.2 MB (21171257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; 386
...
### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull drupal@sha256:8b3c51c942e04c4045b347e0b39643d94c2eb91d5bf0e1c53493c8d528ba56b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51157975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b61131989d03002d7966259e2bf844dd86deac14559d5a9d0a927bbf545c6604`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:37:04 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:37:08 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:37:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:37:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0616dd92b5019334e34b9111cdcf2ff77c2a05b4d6bcea2432188715a76be7bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2138cb1a2ef1da17e8b97e8afdeddf9df9f19c0e12c0c43c779e9ac92369c6c2`  
		Last Modified: Wed, 01 Jun 2022 17:33:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a95fc0127197e7e0903baa19eca05ae72ac5f5b31348858808017c36570b47e9`  
		Last Modified: Wed, 01 Jun 2022 17:34:32 GMT  
		Size: 21.2 MB (21167806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.14-php7.4-fpm-alpine3.16` - linux; s390x

```console
$ docker pull drupal@sha256:f9fddffae21361d1f9f39e577f9f589c23cf82534ad6ead65e6e2ebf7a9ef0b7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49662768 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad1910e484270395fb1535334509b20750ebeeb11c7bd1751a02a870a00d7fb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 17:08:16 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:08:17 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 17:08:18 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:08:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:09:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:389fce7d2af1b08b0530b3894c03355cb5289e4a7c5248dbce28c378dd3ac5ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4d00692c3053e1a69e7ba02f4a435923b5bcdf9e0bf3241377b3dc1b2ab8ae8`  
		Last Modified: Wed, 01 Jun 2022 17:39:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89506c707af746ad8022ed9079adb87a4c4a4e1974210d820c8b68bea729b8e4`  
		Last Modified: Wed, 01 Jun 2022 17:39:33 GMT  
		Size: 21.2 MB (21168638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
