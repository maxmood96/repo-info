...
```console
$ docker pull drupal@sha256:2e07a228e727049500f8718c16d95c3ed78c55f3c595a3ec444979dd299a4474
```
...
```console
$ docker pull drupal@sha256:877c5c73cf37fcae0dfdad4522f5a4da505fd2875706f7b94b0c623b33d5af1e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163533309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05c87e3aed10c90a583277f84198f1f90d3a68765964ca3baf8c19e869cbc043`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:58:21 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 22 Jun 2023 23:58:21 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:58:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:58:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fb54f7fdd77a59a5b5b19fb0380cdb6ab11a0e2f79fc574ce1e53ed017162508`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99f4bb7d0521bc0820e789a5f85d6b016beaa5518329550ee8ad08215231133e`  
		Last Modified: Fri, 23 Jun 2023 00:17:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef1ad862d52aad82f3f0ea8146e77046fef3f939f89649514e021a40aedec331`  
		Last Modified: Fri, 23 Jun 2023 00:17:59 GMT  
		Size: 21.9 MB (21915199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
