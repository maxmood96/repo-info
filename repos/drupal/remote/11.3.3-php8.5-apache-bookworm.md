...
```console
$ docker pull drupal@sha256:d122f50230133cff4578ae77e2f6f0da03ae154b20e21744e29a35b8ab3c9988
```
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; amd64
...
### `drupal:11.3.3-php8.5-apache-bookworm` - unknown; unknown
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; 386
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; ppc64le
...
### `drupal:11.3.3-php8.5-apache-bookworm` - linux; s390x
