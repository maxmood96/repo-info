...
```console
$ docker pull drupal@sha256:fb042ef4dab2a0f2e7adc2ed3f7574a96de16003c4a03d7400c165140b65b08d
```
...
### `drupal:9.2.21-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7827b58f90ec90891d0137c44d367c2f72d31c716ed2cf6932f49ce7b08f9344
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.1 MB (138125137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77dfc6a599fcb5e2e72b7d3c60295705177aa9d48e49610e0a336f25945ec8e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:20:08 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:20:08 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:20:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:20:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:794021b3bc6cf5e716a34cfd1883062be03e0aa363d7b904292431438507a999`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74ab5e5cbaacaa80e1fc1a7bb22bf02531be81c54a05bd7228a6f842f9f3640f`  
		Last Modified: Mon, 13 Jun 2022 21:12:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51d06bebd5cebdb90185b83171d249d0b773bf9fa67a63f43e0a1ad2e149c855`  
		Last Modified: Mon, 13 Jun 2022 21:13:24 GMT  
		Size: 19.1 MB (19127886 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:9.2.21-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:cfec444fbd12a1fba5dc944ec553e1456ca592cd31607413cefa94d249408a6e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172456823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf0100e8ea9f9764219f264f4f9cd3aed8b2fad4f338354df01bb0ac8da1e575`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:12:29 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:12:33 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:13:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:13:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4e959b868f426177f55e874d4034c4678162ee9146391f4972074f7ce9429572`  
		...
		Size: 669.8 KB (669843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a819a616c55fffbfd4f7741ede6ac84665668572790889bc08e0f9c7cc7ea9f`  
		Last Modified: Mon, 13 Jun 2022 21:22:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c75c502d092667cc0358fe56c387f2dbd070bffbebb0fb3841de7239a9761f3`  
		Last Modified: Mon, 13 Jun 2022 21:24:21 GMT  
		Size: 19.1 MB (19128375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
