...
```console
$ docker pull drupal@sha256:df29e601ea6024892dff6e50c05f4024a64c4620d7955ccb9037b014126a9f8f
```
...
```console
$ docker pull drupal@sha256:9a4107a2e96ad55e02263c1f59b10c910dbbb7cd3963bd4653e528654c7a3829
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (158957854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8dd21faf3c3732c8becd385066eb3f3757e588b69eef74601629515fd3d6388`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:20:47 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:20:47 GMT
ENV DRUPAL_VERSION=9.3.9
# Wed, 30 Mar 2022 15:20:48 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:21:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:21:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6488014269e4fa375da4eb69852803adaa64fd3fb3ca690d0d562af6211a83ff`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cacc7bed63bc25ddc60ab52086e7e2a224f6e7a3c71bf58f605b8c612c50343`  
		Last Modified: Wed, 30 Mar 2022 15:51:25 GMT  
		Size: 575.7 KB (575713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1443ff9da89e08a38f8331b7752870bad0044cebc474a777fd06f2ac3a47bd62`  
		Last Modified: Wed, 30 Mar 2022 15:51:25 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e44b4a2e06d79531ce7732088fffeb36137d3e45ae76b782a9911880574e8a84`  
		Last Modified: Wed, 30 Mar 2022 15:51:30 GMT  
		Size: 21.0 MB (20950569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
