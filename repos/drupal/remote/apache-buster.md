...
```console
$ docker pull drupal@sha256:c6adf93b065fcdeca8bf32be24c051600d0a349c298d9ef02b703b55036e6a30
```
...
```console
$ docker pull drupal@sha256:9d0b071ed76b595f541f5b1772407976c3c7b725ad8c9402e185fcd7c44d057f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.7 MB (144688936 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47b581e447566db74c43eb19ccee65ca67310559a19db446303c1442909ea48c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:04:04 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:04:05 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:04:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:04:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fea1382bc83e7cd506f768382c3af06399039ec6e4e9b9d0bdf1faa11001409d`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5f6a9a3ab67f3a40e745d4f38100914f9965f679faa957e29990614dffa7e1a`  
		Last Modified: Mon, 03 Jan 2022 21:44:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3fb4602ed0a8825bcc6771772fedb055f2f1db7e68c062ff4b29d9c3cfe04e1`  
		Last Modified: Mon, 03 Jan 2022 21:44:37 GMT  
...
```console
$ docker pull drupal@sha256:45c1b23cf474fa3a6d33b29cf5fd170d37eaddaf474ae2ab2f5b13b5ae536801
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.8 MB (160808777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4bc7d0dc1832ff96153cc8a651e7e72ed4ee0d91ee941e729db294547487535`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:43:41 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:43:42 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:44:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:44:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5f58a17ca272ff95f870624e051352ce953fc550b2d586704b5c209a358d28c9`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:020396e48275ae95a33b77847e5b70f582c7f8cf635e863f213474c203aa1b04`  
		Last Modified: Mon, 03 Jan 2022 22:04:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:498512acde6d2ddaa4895941b2bbd499b8d74c956d5f012aeffdc290e790b9a8`  
		Last Modified: Mon, 03 Jan 2022 22:04:44 GMT  
		Size: 19.2 MB (19202396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7e5bdc4b03a399bd26b435b2588e8103d1a4037410403d9bdfd67a3f5678b0c8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180788428 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1369d3c48dbe1b40450000cb35bbd4e065405edb206257a5d85411655665c97`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:32:48 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:32:51 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:33:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:33:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b3626bb3bd94556564af3105d8e7cbc396d4552529d38c8e9ba9400418f7a9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:694dcea5f26734f03faccba0430ec7c07bbfb6e2985ddd1a558d02db23e3b72e`  
		Last Modified: Mon, 03 Jan 2022 22:08:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa1a27411e967417b8229c454b6523bf382fb7c12a2f94753e274eba20b5ab4a`  
...
```console
$ docker pull drupal@sha256:afb72a2d7aad63557baec19ee90b230189b331b77aa49e8ac8b00554543a0e21
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155031390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94f1383ec0355ddf04e404ed83e5a24a7f42208a6f31996328ece412645895cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:55:42 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:55:42 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:56:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:56:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ef2c21e60ec5b8cbd06982c2187887c073ef07419054dc29e982521fd9411a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b6b5fa8d58772a677accff06c5e030affe0c8ddb348f73e0087596890343eb5`  
		Last Modified: Mon, 03 Jan 2022 22:12:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:719e8fe7edfae128c6390d0f1d7c7e386b9953617488c6d118a77531e1237d3e`  
		Last Modified: Mon, 03 Jan 2022 22:12:34 GMT  
		Size: 19.2 MB (19203192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
