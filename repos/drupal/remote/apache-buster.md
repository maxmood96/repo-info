...
```console
$ docker pull drupal@sha256:7eef01d92aca1b23f6a391763a0511443f9f7c6d031b69ef22d321c37312836e
```
...
```console
$ docker pull drupal@sha256:689f06bbd70c40cfd0586b76dc69f9b02fad4ad9f46ce977f52fa8acb8f1f4e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155143226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da4decd587231615a996b710e3a3337e2a7c6e9bcd12becc6180a9fa7640f08e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 01 Mar 2022 22:11:30 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Mar 2022 22:11:30 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Mar 2022 22:11:30 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 22:20:18 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 22:20:18 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:20:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:20:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0094c9968d2e35085c24c6466fb6f6ed514ba4848bd3e9b8905cdc11ac3a2e78`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d8119cde90b73266c471e570ac4278fdc20f5b7efb0efbbf4d32154f99495fb`  
		Last Modified: Tue, 01 Mar 2022 22:34:21 GMT  
		Size: 1.9 MB (1857165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:390ca6f8a791020a1c3ebd18f410ae953e5d4bcc727e042b1d9d7116095daf7a`  
		Last Modified: Tue, 01 Mar 2022 22:34:20 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81edfeb01b1580eee425de8c4938621d475fc713af5cecaaebaca83202590bfc`  
		Last Modified: Tue, 01 Mar 2022 22:34:21 GMT  
		Size: 575.3 KB (575347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff648dfdf5f5cb4f9347c12c33a845e69320259dc1a7484c28731853332aabc1`  
		Last Modified: Tue, 01 Mar 2022 22:39:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd4b831362b2c0fb47dca55a72229ac61e529ca56c52903c3b01df4e8a14fffa`  
		Last Modified: Tue, 01 Mar 2022 22:39:48 GMT  
		Size: 19.1 MB (19123275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
