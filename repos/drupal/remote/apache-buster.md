...
```console
$ docker pull drupal@sha256:baef83388422eb34545280633da77535253d6ae6237db4328448ecfc41d5325c
```
...
```console
$ docker pull drupal@sha256:1f0ea91049fc12e0b923e5905ef3d76ed646ab8565e9876a1e2e6fc99d4fe7e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143619843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ff7b07dba37baee61c9c51b8734b6ab6575995a5f1cb132c9511b5417671ba5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 30 May 2022 02:07:46 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:11:16 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 17:11:16 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:11:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:11:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e6c83abbffc6e620098011457f0c45ac0d0963adc3fd56928e2bcb1d3b0506cb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1b743bee2fc64180f1f2249b702953fbd40e6bb13f6ef2b28b4ac360540c7d8`  
		Last Modified: Wed, 01 Jun 2022 18:07:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4479b96eae23b804d649e1f246f9e9b2db07ec3103b84ab5305ca10bda4386e`  
		Last Modified: Wed, 01 Jun 2022 18:08:22 GMT  
		Size: 21.2 MB (21182972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:1a69d82bff3fc9fb8159ac65de5ee93294494388a97a5ca5b7c4754dff00033b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159282183 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81f9980efaebfea65b7af0aef6273c3e51f8799ddf8eef7068a0ba1da0adbbaa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Jun 2022 16:49:04 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:49:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:49:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:380756e983d57e93a68acb903c678238687a10c3f916e9c5b2535e1ba320ed0b`  
		...
		Size: 661.6 KB (661587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45131aedf264ddcb5dbd37fa4021a24844e9c76a0910ebe75ffc4efcb5d4c55d`  
		Last Modified: Wed, 01 Jun 2022 17:20:52 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:509347eadfb4bcad5dbb46e4de0afa8fa622d87714b5c525dd1ac9772098c179`  
		Last Modified: Wed, 01 Jun 2022 17:20:57 GMT  
		Size: 21.2 MB (21183956 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:943c604395a19e7301a16c110fcba1ffbf1cf10192cf258be9178316b4b347c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.9 MB (178881557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7721d73ef78b885936d068bd88a4c9aa5c5fa35dc027b078b494af48dedd941`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:27:43 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:27:45 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:28:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:28:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7afec321aa9ea80ef8af29b34debe2065ce8f257f07b65c70db9644f23659703`  
		...
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05a49aeb29962f3f276e5b9337172b4f701bd1565864bb48f456f976ca40f664`  
		Last Modified: Wed, 01 Jun 2022 17:19:07 GMT  
		Size: 21.2 MB (21182831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:1b16f9e2b278c65cbd5679e79888869aa4fa3bf31abe86a8b2145a4336f50651
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.7 MB (153689430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e72005a70194d64496a2d441b9b41459a2172f63958137434a921965907b9811`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 05:05:08 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:58:23 GMT
ENV DRUPAL_VERSION=9.3.14
# Wed, 01 Jun 2022 16:58:23 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:59:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:59:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2dcca29eee4342887aee7901408ef223123bcc85d37b68f2d070cbe7deea3486`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbb328a62303c51ffbf0c5f824269c750e00cfd1c2160272b63d5adb91ee32e1`  
		Last Modified: Wed, 01 Jun 2022 17:35:38 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fe6829fca462c19150b67f89fdb3c6bbcd220fb654cfc17817a36668bb966de`  
		Last Modified: Wed, 01 Jun 2022 17:35:41 GMT  
		Size: 21.2 MB (21182798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
