...
```console
$ docker pull drupal@sha256:6482e49ee8627bfe18be0c67a5729153077c7c12615462b4df57d7180349e9a6
```
...
```console
$ docker pull drupal@sha256:1ec92fe44e2318c5dd5d099987a5ac072baaa297d7eb9489e2db77162fb7b03a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.8 MB (169843891 bytes)**  
...
# Tue, 08 Feb 2022 02:27:06 GMT
ENV DRUPAL_VERSION=9.2.12
# Tue, 08 Feb 2022 02:27:07 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:27:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 02:27:18 GMT
...
-	Layers:
	...
	-	`sha256:ed1553ac06e62f290a38adb7e1ef20c3b978f01109252cd66720e4dfa46d40a5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa8aa6d12c13a5dd093a8b288f364512a11cf39b218615e3a790b36375fa1d9d`  
		Last Modified: Tue, 08 Feb 2022 02:54:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0e312925e6430c4f359425d859e5de01c7037c3b48cc2272336ff11aeb7de5a`  
		Last Modified: Tue, 08 Feb 2022 02:55:01 GMT  
		Size: 19.1 MB (19123169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:8896c02ed276e5e4f14fed2f5908e40dc89aac47956ef11d90923396b2067f23
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.5 MB (144516662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c3c60db3b3a728bfc79d14cae9538a576ef0f5b042c8317cc813848afa93c9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 02:17:12 GMT
ENV DRUPAL_VERSION=9.2.12
# Tue, 08 Feb 2022 02:17:12 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:17:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:248f9892b67ad19fcc64d9d59d3034718201afa36208d9365e63344c4904b424`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fbc97ff68b6f90bbf17facdff426543cba57a84a3374d46e39067f8139e08b8`  
		Last Modified: Tue, 08 Feb 2022 03:08:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb39b9aa164af4e53c10a3c550b2a7c94fd8c1c987557b251645c8608f969342`  
		Last Modified: Tue, 08 Feb 2022 03:09:00 GMT  
...
```console
$ docker pull drupal@sha256:d897f65973d873a68786bba695c2602c9b01095f4cce8068b7e5f64c0a56ed07
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175818689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67218d9d3644c4fba7d5ea4fa1b48d57cec85d576e2616c5bfe2469c251f7392`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 04:24:39 GMT
ENV DRUPAL_VERSION=9.2.12
# Tue, 08 Feb 2022 04:24:40 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 04:25:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 04:25:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f0fe88caff5b4dba2c274ac4736f7b3ba77965559bb2fba67dc1bd7623020422`  
		...
		Size: 575.1 KB (575054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2c97f35b976c0b40a6a0622d69e64909c4aa1fc96a95898b79af386649598c4`  
		Last Modified: Tue, 08 Feb 2022 05:00:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae3578c9c56e74fadced83c041aa58acd6ff83dc790941c1c5504aea9f8d04c0`  
		Last Modified: Tue, 08 Feb 2022 05:00:26 GMT  
		Size: 19.1 MB (19123213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:966ee97f52f48fb46cd7d314050ffbde606008ed7739b191619527b44511ad0b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.6 MB (180615845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:230576b0653ab08c282dde9cfbad545f2f26d3a0fd05af5fb639cd24f340681d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 02:49:02 GMT
ENV DRUPAL_VERSION=9.2.12
# Tue, 08 Feb 2022 02:49:05 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:50:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 02:50:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ffc1d10ab806fac30d02989a7fcd1aecb4330403297c78d7156a1624c7ef5305`  
		...
		Size: 575.1 KB (575056 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f76912a965e08b8c63613fabf9cf0739cfd64eaf8577364415c2899fdbcee4b7`  
		Last Modified: Tue, 08 Feb 2022 05:43:59 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bec6eaf0f4e1fd9c786e8318fdfb8d8cb2c61686bc8bef993eda425c2aae739`  
		Last Modified: Tue, 08 Feb 2022 05:45:10 GMT  
		Size: 19.1 MB (19123285 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:4308cd58413ef794886696cfc10db6e69c10f3c9ebc6bb447e09688e7e15cb82
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154856662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbaf38ab357cb2e93a8b9fce62db842a595d727b43576a80a7b4f293bdf566fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 01:52:40 GMT
ENV DRUPAL_VERSION=9.2.12
# Tue, 08 Feb 2022 01:52:40 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 01:53:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 01:53:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:40897f1da13281d1e54d76c7a0707634cd8b77df0cad2393f93baceafbcb1554`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12d06894b53bbe975c3bc49e1c065ecba95ea715fecbf4e0b888d392a7549dfa`  
		Last Modified: Tue, 08 Feb 2022 03:54:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2004f389352fc86f8f71c25e78949024fd9e92d070218ad555080a2add7e67de`  
		Last Modified: Tue, 08 Feb 2022 03:54:47 GMT  
