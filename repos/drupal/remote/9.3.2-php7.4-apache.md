...
```console
$ docker pull drupal@sha256:5680206362b5c355e84390f4b49b2933b2d503bf5d283011c69d03b1cf985eb2
```
...
### `drupal:9.3.2-php7.4-apache` - linux; amd64

```console
$ docker pull drupal@sha256:5657804de370670b804ef2e6251fca4819bd78c65815cc17b3e893c6ea1fab2b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.3 MB (189304316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff2709048c54889f8550355e486a97044b4fa1fefc31cd2f371df4fe8cf1db3d`
...
# Thu, 06 Jan 2022 20:24:48 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:24:48 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:24:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:25:00 GMT
...
-	Layers:
	...
	-	`sha256:5df52e294db51f4a41d68e530922d9f9d436a1d0d46865256166c57338c89a2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b97e51a32e01edfcb7782328a030e802281beaf13087dc1ff965cf1aa02b47c1`  
		Last Modified: Thu, 06 Jan 2022 20:33:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ae5222505741c4b440d62040a770a898d349eed8cf46996753aee5f57766983`  
		Last Modified: Thu, 06 Jan 2022 20:34:03 GMT  
		Size: 20.1 MB (20141002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:95860151eef81b799f1872361617ad0b20e32363d078b66ea008b0e4227932a7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159089296 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0441820621643a06360f31883f1fba7b6e6ade8739d05d3d53cb23b468f2fa73`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:13:47 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:13:48 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:14:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:14:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e63f1c7c0aefd1dd736a296a4a7371ef0df3616390b73e51315a6e66a28ddd55`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb52f83e822238d92d9081d7c034248996eff4be5dd764be3e2a13a4fe5e284f`  
		Last Modified: Thu, 06 Jan 2022 20:44:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f083ab0ba902499511978f63893984e999e4529fd9619576abab7c78f228efed`  
		Last Modified: Thu, 06 Jan 2022 20:45:24 GMT  
		Size: 20.1 MB (20140719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a87e7f91bb8c6846e187a17dbf98b6bbf9121b47ceac617504abceafbf719c67
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182303303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcfe4427f5b997cb35f4698563a24c365b6655c86dadcec636ae396c4cc34894`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:50:14 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:50:15 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:50:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:50:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0efcfceac5bb677e825c9bc085f93ac363296a3fec874cb05767924f2a9f2e6a`  
		...
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:005c3ed0981076ba4f9d4aa608ea521d843e0108b1641d79406a8f6de19f9b2c`  
		Last Modified: Thu, 06 Jan 2022 20:05:18 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb45b97878af80f54a866548d0d32d020067f379a58e7e4177aa92d7873bb0b9`  
		Last Modified: Thu, 06 Jan 2022 20:05:23 GMT  
		Size: 20.1 MB (20143129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-apache` - linux; 386

```console
$ docker pull drupal@sha256:3bff44fe6354217a41d026550e35b7a5db4a3754c50d9a08930adb942bfad6ec
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192307845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cee8ca1d7167b8df2347fe60563f6f3847c3eb578c7d963fb71d2139c7c1a8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:48:03 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:48:03 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:50:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:50:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9a3b22a0f1fd6e2d77af2d28f6c31cbe5b06e09720673edb638f079554c962e`  
		...
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3632a91768831cc80124bab24acbbf77cd1adb603de33aec2bc3a0a872b4d549`  
		Last Modified: Thu, 06 Jan 2022 20:05:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbd40fcdc9d48f9f565e952ec3d1c16a4b44fff2e73e7230fb4bfe7339a182e6`  
		Last Modified: Thu, 06 Jan 2022 20:06:05 GMT  
		Size: 20.1 MB (20141191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:ec90157b993d5e51820dfd60c637c6cbffb472a12e91d7d0b32d0e938447ef1f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190680207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:131c52ac93e10baad7ae6322e9626ae59869d9dc2abcebbbecc1d0fc2c65ccb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:28:27 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:28:32 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:29:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:29:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7b27b115ecb16a529e87d1adf7fe79535648ad747b4dbeb1ed0e20361b86fb91`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90ced0b88cac512d60d5bd972714a96125ff08b9397658b747272a7dc3206324`  
		Last Modified: Thu, 06 Jan 2022 20:48:59 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f912981eea77ab21047a316ca718450f090eafe06b599397ec966884ddff0ed`  
		Last Modified: Thu, 06 Jan 2022 20:49:52 GMT  
		Size: 20.1 MB (20141227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-apache` - linux; s390x

```console
$ docker pull drupal@sha256:b8fce9126f8ff9516896edb857383729bcbe37b403d1faa56d9ce957476da534
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166637971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d6b0545ee6100222f8b96b6212b6455735895d614fa3427afb00e3e3144cf8f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:55:09 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:55:09 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:55:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:55:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ef764983b12c1feb55b8ec0f26992bcadadce21444aabc70ca3c1579e444f044`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04af85b08c7c5f5b3ed36b1a65d5fe67584e618257a2e3888cc6ebae3d4e8782`  
		Last Modified: Thu, 06 Jan 2022 20:08:47 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efad626aa2b515c12aee55d8cfc2e5b7eeeed80a4ca1226f317acdbcc095d66b`  
		Last Modified: Thu, 06 Jan 2022 20:08:53 GMT  
		Size: 20.1 MB (20141057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
