...
```console
$ docker pull drupal@sha256:8035db11362a01d1aa80f2d2a6160781a55eea4d38ccc6e234fb2b661b86479f
```
...
```console
$ docker pull drupal@sha256:2a04cc7ea018606cde3fa9dd581a05f345051e2f88a8145fc9f0c1850bd81d3a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.7 MB (168696769 bytes)**  
...
# Sat, 04 Sep 2021 15:19:57 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 15:19:57 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 15:20:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 15:20:08 GMT
...
-	Layers:
	...
	-	`sha256:41b79bf342051b195a8160e038ad29f0d31e537da5e0002b5268e6cb12849c2d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7011398b6b79a7b59941bfb38a1e25bceae3ec16d07c8b4a0797a29a354242a`  
		Last Modified: Sat, 04 Sep 2021 15:30:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76e798c0bd3488fdec15d85fffb3ab761a607a01f3724aad6d2b950cebc96937`  
		Last Modified: Sat, 04 Sep 2021 15:30:37 GMT  
		Size: 18.9 MB (18875498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.12-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9e8458e1bbc48c43b314df4f8037a08e7058e57c39665911512c7738e7bb083c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144108908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a97130425dcc6debd3384d65bf9ed5a52dd572f1ccf8a30ea1dba0fdcc9cff9a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 04 Sep 2021 17:52:31 GMT
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Sat, 04 Sep 2021 17:58:42 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 17:58:42 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 17:59:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 17:59:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cf23c41f99c66531a39d1e84c879fd7953f164b54d2e47c7426aac2ea0f41c1a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01f6f1bdf96ab11b3e022e43695da918cb98b5c5b08d3d08d7fb4fa2517f7e82`  
		Last Modified: Sat, 04 Sep 2021 18:28:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c548df6f8cac38f6d6e4febb94afd8ff0db166c5c3cfe00027abed5c7248329`  
		Last Modified: Sat, 04 Sep 2021 18:29:25 GMT  
