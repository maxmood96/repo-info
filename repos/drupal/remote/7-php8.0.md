...
```console
$ docker pull drupal@sha256:ccb8c49394b373bc0dec80366fccda652b0e8a11159c5d281572152fcbc9b4f8
```
...
```console
$ docker pull drupal@sha256:9590a4c5ca2e13dab43c578e41a806e2b6475751eb887051a2c9688d73736b5d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.3 MB (147268661 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06df1bb68fab92c0ba23b63df48652c71cccb1b90d3ee1f783e20d6228490b6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Aug 2022 09:17:51 GMT
CMD ["apache2-foreground"]
# Tue, 23 Aug 2022 22:38:00 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Aug 2022 22:38:01 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 22:38:01 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 22:38:01 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 22:38:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:283f0f05a0d6bb1b77f5b2da466af7f8a2442972b9082f9f4ac9c0a0290a9113`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e849985f636153f24833cd28632d89127d497723a6c9e3cd21072801a436605`  
		Last Modified: Tue, 23 Aug 2022 22:43:41 GMT  
		Size: 1.8 MB (1795717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6e1a90325c722a461749879d3a9de3c91a74f538fc531838d1f0f1f974e5932`  
		Last Modified: Tue, 23 Aug 2022 22:43:41 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8136ee8b3c8f717b24b3e0b17d3308e31e38ad728e3c0e2bace10634b579ca8a`  
		Last Modified: Tue, 23 Aug 2022 22:43:42 GMT  
...
```console
$ docker pull drupal@sha256:51e96b8d47a2460038ef6bcfc509651e9f95fc8e7221f2c7a56fef11fb07d4cb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171844812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a25506d2c72df3ca607a87953d0b923793e28f13656e60f66c009ac3af7427c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 19:14:47 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 19:14:47 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 19:14:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c808ea121741f219b2c798e43303a4bd6ef1c6d53ce16642be0dedde8a9f350b`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf7aeef192db43ed1b167d5966cc023b47c4e1d793c719b968129bad722cb14f`  
		Last Modified: Tue, 23 Aug 2022 19:46:34 GMT  
...
```console
$ docker pull drupal@sha256:f8beb0494437f463a995ca131510da0435326c4d0106ec578b008801f37ec2cd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.3 MB (146307368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a35bc6c18d018b6fabfc00a22012e092b271e57ee8c3100afc74db26d2c67be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 23 Aug 2022 23:08:01 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Aug 2022 23:08:07 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Aug 2022 23:08:11 GMT
ENV DRUPAL_VERSION=7.91
# Tue, 23 Aug 2022 23:08:15 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Tue, 23 Aug 2022 23:08:25 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5af295d393a1537b97514eff9cb40a803aee277600a284123613efa3fc5caf6f`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a49ef9f838b701b8099d7d61b67f7cf5f5797a0ce2f4a83ba1e486214f183d17`  
		Last Modified: Tue, 23 Aug 2022 23:19:02 GMT  
		Size: 1.7 MB (1691363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba47476918df3a9ed1a306557957ab438bffa9b129a1b4b4a8384501f0f13573`  
		Last Modified: Tue, 23 Aug 2022 23:19:01 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bed67a07218adb1b1e1def7ef0786b2c0a5f818bb6d8a22893a1cda478b1c45a`  
		Last Modified: Tue, 23 Aug 2022 23:19:04 GMT  
