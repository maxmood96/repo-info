...
```console
$ docker pull drupal@sha256:3a806cdf6fe53b44da505d46e99ea89583166caf601c6d72050e577ffaecb08e
```
...
### `drupal:9.4.5` - linux; arm variant v7

```console
$ docker pull drupal@sha256:cd61a825b57bd60b2e8676621005b4ca8649dad2de6b014061f72e179b551461
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.5 MB (158517228 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e69d008ffd786346e3c3bfbd28f6bca429dc99fc72cbf52cf771d56c29096e60`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 07:49:01 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:49:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:49:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8e048f57f66f18247b40d80d994380cc0248e9260a47bdebd73d7b298ed74b9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3606d67a05134b1baf8b01ef05fe91fc9d7625a233d162e9e2e82efff488eaa6`  
		Last Modified: Fri, 05 Aug 2022 08:28:36 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd57785fc4ab4ca1371b8865af393485ef20d04f752b6896164c88fd7709a8e2`  
		Last Modified: Fri, 05 Aug 2022 08:28:50 GMT  
		Size: 21.9 MB (21863866 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5` - linux; arm64 variant v8
...
### `drupal:9.4.5` - linux; ppc64le

```console
$ docker pull drupal@sha256:c0f148fb9fb8eeda924bef4aea7bb98ea790d3748b9bbd2e346c95c7d77fa6f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189375897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34b7ffa66279776e9a12e8a7e7cc38977256b525ee0115f79bbadf940c49fc6a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 00:05:53 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:05:54 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 00:05:54 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:06:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:06:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2047428093c5ddca681325194254729ded03f4971bb8a1a66e4d6002e4286266`  
		...
		Size: 670.4 KB (670413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c220d18242f224b730f4175442bfe7d43b3a1359d0311e4dd5cc8ab9b649030`  
		Last Modified: Fri, 05 Aug 2022 00:41:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34591e8c48574b043f3aa863cf44f97926f4f7e31d97261c54a7d65d12f61f09`  
		Last Modified: Fri, 05 Aug 2022 00:42:11 GMT  
		Size: 21.9 MB (21863611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5` - linux; s390x
