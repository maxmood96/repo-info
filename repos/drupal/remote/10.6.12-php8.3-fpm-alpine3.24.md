...
```console
$ docker pull drupal@sha256:7ba825dfc8cfac43fb971d282232d4bb540dea254deae577900332216b91f972
```
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; amd64
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - unknown; unknown
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; 386
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:10.6.12-php8.3-fpm-alpine3.24` - linux; s390x
