...
```console
$ docker pull drupal@sha256:46a026c1aae8083f83455140a597eb1bcfde0d4097f0fdcd9f567c70dccafe35
```
...
```console
$ docker pull drupal@sha256:48a4de100145e23362d300d1215fea4185e4ef7a3cd20864459ce38374de8218
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50139885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c8d54801839054370ab1f76438d80a1c1f3390489cf678e7e2da527253a1165`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 10 Nov 2021 23:00:51 GMT
ENV DRUPAL_VERSION=9.1.13
# Wed, 10 Nov 2021 23:00:52 GMT
WORKDIR /opt/drupal
# Wed, 10 Nov 2021 23:01:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Nov 2021 23:01:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72f5c94c91302807c58d635784dc63330f75c30d3ee64bd5c253c275d4c49add`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:217510f13439591509acb7384e19cd95dcdbbfbac4161e2a4f4607004a36f36d`  
		Last Modified: Wed, 10 Nov 2021 23:17:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e41c1a05915dde88fd19975f326a3cef295498abaef648c20277f952497e5208`  
		Last Modified: Wed, 10 Nov 2021 23:17:16 GMT  
		Size: 18.9 MB (18879177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
