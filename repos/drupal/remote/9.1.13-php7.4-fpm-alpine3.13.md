...
```console
$ docker pull drupal@sha256:841a1f3caaa958de0e0f5a3de61e5436b91cfb4e53845633b74105b7d1b53975
```
...
```console
$ docker pull drupal@sha256:838ae8896388aa802eef9ccebcb161539997a78a3f4d00bd885538b73346c153
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49340693 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0e78be89fd11c8197a6c5ac143ea9165e74f9919f489c9aec3a2474fbfd3563`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:54:16 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:54:17 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:54:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:54:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b43c63cf6d6635d5157ef1e424c543fb607d55a338d4c4c0cd1bc78e15dec5ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1708d1b101c03fab75a415a1d9c828e9c4bb930f74fb5524e5d3052a99f9a6a0`  
		Last Modified: Fri, 17 Sep 2021 19:07:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:040e436fae81b73db565336fa742cc20d73351be6d81805383b3841d4d8b868c`  
		Last Modified: Fri, 17 Sep 2021 19:08:11 GMT  
		Size: 18.9 MB (18879238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:16f1ad3b574f9d14f718e4bb54417e732f9ea3ba863d8aadaad0533cf5f5e58e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49908654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3105281c2170d9c7b38a28a5d26d2c42ac982511b9f85e789fa0412a89c3373d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:49:00 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:49:00 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:49:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:49:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bdaae71e2effcfc123f2be63c9f733c59779ddad99edeaa18533413ca635e72`  
		...
		Size: 555.2 KB (555171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c802600c5812df4368b5a3da7a3c69734ac25c0d3429faf21a0001d405748c5`  
		Last Modified: Fri, 17 Sep 2021 19:03:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a06a8ab49a41ab5086708b0621961d4c75eb2b9f98bd22e0a6468be57e9b9f8`  
		Last Modified: Fri, 17 Sep 2021 19:04:00 GMT  
		Size: 18.9 MB (18878974 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
