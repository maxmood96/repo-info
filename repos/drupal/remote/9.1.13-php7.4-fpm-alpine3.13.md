...
```console
$ docker pull drupal@sha256:fc3153ae0d62f2f3433dc4337cd9e49c9e9c3ea4a8d88cfeeddac791793cff87
```
...
```console
$ docker pull drupal@sha256:cabf2b4c7c6fefaeaf3c1a0b0432445187dcf959554809ad707344ac794e2f05
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50587961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1168dec95f647499084985bcbba0099b302796b5595bc61d22f08ac79b680d5c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 13 Oct 2021 13:37:47 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Wed, 13 Oct 2021 13:37:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Oct 2021 13:37:50 GMT
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Wed, 13 Oct 2021 13:41:40 GMT
ENV DRUPAL_VERSION=9.1.13
# Wed, 13 Oct 2021 13:41:41 GMT
WORKDIR /opt/drupal
# Wed, 13 Oct 2021 13:41:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Oct 2021 13:42:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ab35a5227534c2d75e49bdcda82b431d02ef79a402bdb95aefaaeec4f37b392`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edf87546eb0484283462790db105062c4d6c92c9fe8439aaa13d5b15233d8275`  
		Last Modified: Wed, 13 Oct 2021 13:59:02 GMT  
		Size: 1.9 MB (1905888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d96db9adcaa6040fc2d1f6b568030b034c5d6b53a3b194e5fa36a4bd0fed8b4`  
		Last Modified: Wed, 13 Oct 2021 13:59:01 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ef82cf7ee37258c2e4c8227be8a18d4709caf09392c30e738af23a0978d3aae`  
		Last Modified: Wed, 13 Oct 2021 13:59:02 GMT  
		Size: 557.0 KB (556997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c9f9582e5850daf2c82c9b3a1b9ad906325d1fcfd78b8843c39dd5666715361`  
		Last Modified: Wed, 13 Oct 2021 14:02:26 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6af79fffd6e25aab212bb23fc1a970fcec03274d27ec1bf97cb792f716117706`  
		Last Modified: Wed, 13 Oct 2021 14:02:31 GMT  
		Size: 18.9 MB (18880272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.13-php7.4-fpm-alpine3.13` - linux; 386

```console
$ docker pull drupal@sha256:50a2962ebc350eeda6c11f28390a3cba6f010515d4a80e50e057cf82066a43ff
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51547915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8169883ea7170ae8da082bd7408b601f610bbfe127fb4a204c3ff8fe41bd360`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.1.13
# Fri, 24 Sep 2021 03:21:18 GMT
WORKDIR /opt/drupal
# Fri, 24 Sep 2021 03:21:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Sep 2021 03:21:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5438e84f55003f305e88772b6a00dff29f4eafd8dd33bc1447273b88632891c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b9ad0a1381c8b94872dc140418bfb759663354b98c02bd946200c21dbe59e95`  
		Last Modified: Fri, 24 Sep 2021 03:44:52 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dcbffe1770bec8230031acf2db7bac7d892752df96a370f746ac4cfa5470eb7`  
		Last Modified: Fri, 24 Sep 2021 03:45:01 GMT  
