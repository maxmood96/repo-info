...
```console
$ docker pull drupal@sha256:1d7e4d3fc7a4766016444eda7d0de0c971964a3ff1b8ddf4a0e7855f6c4899b7
```
...
```console
$ docker pull drupal@sha256:d78288a57be587d679b3dd5be8fbf57de6d6d24d8db88b35e939b639fb11fa1a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52132046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d99258a228f9fd936ca65d17afb6bb5c8c08ef1adf174653ab257ecc9e904d42`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:80d4bf27c2e7b39ab20a213acb94fe5d80ca22e3a11094d46fda4ad832320763 in /usr/local/bin/ 
# Wed, 03 Nov 2021 00:06:28 GMT
ENV DRUPAL_VERSION=9.1.13
# Wed, 03 Nov 2021 00:06:31 GMT
WORKDIR /opt/drupal
# Wed, 03 Nov 2021 00:07:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Nov 2021 00:07:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:630fbc92d5c62cf3fe3b58157235dd637a9f5922d943b9f2f969d09d5d2d6890`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69007361802dc4c6ae9c576177d7000922746c06853d47ea37f0c424c6a641a5`  
		Last Modified: Wed, 03 Nov 2021 00:35:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e62b22976d787f8848340c42b6a14b3d1347e77d4760c3e390888de83e970985`  
		Last Modified: Wed, 03 Nov 2021 00:36:33 GMT  
		Size: 18.9 MB (18879284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
