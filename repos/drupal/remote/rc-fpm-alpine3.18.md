...
```console
$ docker pull drupal@sha256:7f641a9419ba565aaf814b502484eba8dd7ea192414e53d723a4a81d83906801
```
...
```console
$ docker pull drupal@sha256:bd2f1e1a991ffec5992b028daee8d8475b4e3af00b7f38431e12c2739b8c7db7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51334606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7087d635d45a506b144d72ea68e940fdb79efbadcb94241c9c70228f212a6ac3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:1190bb459b0fccdfb47114d4836f19006631917c0da7fc6115eba9f9da8ad421`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fcf6690da8a4242d87d251ff63a22cddbae0a1d957fb3eedc4b6a8ee8df3a2c0`  
		Last Modified: Mon, 01 Jan 2024 02:09:49 GMT  
...
```console
$ docker pull drupal@sha256:322d392e334bf7c188defe53296a6d6663401cb0646f6f12f7be637699333824
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.1 KB (35115 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c3f1275c8acc1cdc5fd93cd143d895cfaac7f3724065c92ba7b15ddc54f87ca`

```dockerfile
```

-	Layers:
	-	`sha256:1eb965d3a5316b71e9b49dd17c2cd514b8657aadea9de576f1a12d5042397bc2`  
		Last Modified: Mon, 01 Jan 2024 02:09:47 GMT  
