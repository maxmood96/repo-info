...
### `drupal:10.3.0-beta1-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.3.0-beta1-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.3.0-beta1-fpm-bullseye` - linux; ppc64le
