...
```console
$ docker pull drupal@sha256:dc658a97f5d727034fc7f3c0fbed518d84f4d23a7be40c04ec8d621aab4c0cfe
```
...
```console
$ docker pull drupal@sha256:aa5d2328c13bd86961c89917bc245db1ea302f89e2871223c509e6ead847e4e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.4 MB (181354933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8600588293fc5509b1c1cf48654b5d0d962a541b5e2dfc690c7a61583e3c5744`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 19:19:32 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 13 Jun 2023 19:23:22 GMT
ENV DRUPAL_VERSION=9.5.9
# Tue, 13 Jun 2023 19:23:22 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 19:23:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 19:23:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b1279c5450a0518ff88e50298c6e82a5507dda49af27cecb06a2185986e5c482`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e582de656c04eef38fbfa8ad81bdf2adc3bf12bff5f8f45150d1cef27f01647d`  
		Last Modified: Tue, 13 Jun 2023 19:38:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f20660403da24b3271294703b3e1fa366da437805c52ecaa76c61c82df7c2d5a`  
		Last Modified: Tue, 13 Jun 2023 19:38:39 GMT  
