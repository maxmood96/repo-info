...
```console
$ docker pull drupal@sha256:d19f98935614ce21a40fc650393416826c79b8face8efeb3d721fb9a17f975b0
```
...
```console
$ docker pull drupal@sha256:8a2f69f03cb2b250a0eadd210406fbc7c194745d49e84fd70358abdb65916529
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.9 MB (188869126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d41a6584eb8eaef14c7ed6236be5f21093c3221f46bba4aa31c98607a32ab4f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:24bf6e4ff958bf58ae126804a93affdbd6a0bf41615cc91af3f7538a88742dbd in /usr/local/bin/ 
# Fri, 09 Jun 2023 03:05:19 GMT
ENV DRUPAL_VERSION=9.5.9
# Fri, 09 Jun 2023 03:05:20 GMT
WORKDIR /opt/drupal
# Fri, 09 Jun 2023 03:05:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 09 Jun 2023 03:05:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3eb6903ae530ee39c435b098858e6f7ec6d8787689922920bea581a88fed8f8e`  
		...
		Size: 319.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8714cec9ff2a5f3c89755514e2f322247c507cca6d397626cb198b92662617d0`  
		Last Modified: Fri, 09 Jun 2023 03:23:49 GMT  
		Size: 698.1 KB (698148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04fc116f6b5cdb65c02234a4efec224808535c327a169466702a04a0aa23c3d6`  
		Last Modified: Fri, 09 Jun 2023 03:27:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3e446cf613d6433670858992aacf8c56cdeb04d096d7926adee4f28724f77ef`  
		Last Modified: Fri, 09 Jun 2023 03:27:27 GMT  
