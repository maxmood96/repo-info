...
```console
$ docker pull drupal@sha256:81222e1f8cf066e49ad36f27cedd32b449faeff95fc0de24daaf0d79b954c19c
```
...
```console
$ docker pull drupal@sha256:dacb22b46c4a9d1ddc594636f72091ccd0396e2eac074157ab3f72b5f2a696ec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157121851 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:437fce6bddf7ce74d5ecdc3f499e41b00ac7469d71fd9284a00b2327bfbd8935`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 13 May 2023 01:52:43 GMT
ENV DRUPAL_VERSION=9.5.9
# Sat, 13 May 2023 01:52:43 GMT
WORKDIR /opt/drupal
# Sat, 13 May 2023 01:52:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 13 May 2023 01:53:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c27e15d375e7d5d405110dedf80d0f0e87f6090a07f8a576a9fd30e49472eec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6603526d0d612adb8d065ae75349c5fcab523d0353ee13f69c4f09b541d4840`  
		Last Modified: Sat, 13 May 2023 02:01:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa2ec6a46d8ee455ad6d3274af22561f498de2451ca72d8a991a87f216017b74`  
		Last Modified: Sat, 13 May 2023 02:01:53 GMT  
