...
```console
$ docker pull drupal@sha256:0e3725e0bf80415172271d21bf8d623fd4a1269423acf2459a0120b8ab98f549
```
...
```console
$ docker pull drupal@sha256:d8a7d0ec03371bf7fb08f31ef686e0cdfa25504c5c8981ab1989f3f4306d07ed
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.1 MB (187089651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e19a28b74e62298e609199476fc8551a412e1f4c049ea04c776ee4669a855425`
...
# Thu, 04 May 2023 04:59:34 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 04:59:34 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 04:59:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 04:59:45 GMT
...
-	Layers:
	...
	-	`sha256:47b5b89428f54c744fb16b215eb6b13d16214361586adf073d9a4a7811f7086b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9037d6903e1e9f06a03def828d3130e0c0a26413787d1effda177a4eb34c014`  
		Last Modified: Thu, 04 May 2023 05:18:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:305be21b30cf37ccbb23c8119600e2c53632e3d8c61e578b12abeda11e0978b9`  
		Last Modified: Thu, 04 May 2023 05:18:46 GMT  
		Size: 22.9 MB (22878130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-php8.1-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:01e55c55db29f05cfad842b6c8abae481c06e100e47a1589c75e9482cf46a4bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157055214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6eda2ef5ecb318f09f665b4c9a79dc59771f9e248008e5f28311a7b71c5ce74a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 May 2023 07:10:36 GMT
CMD ["php-fpm"]
# Thu, 04 May 2023 02:45:40 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 04 May 2023 02:45:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 04 May 2023 02:45:41 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 02:48:45 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 02:48:46 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 02:48:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 02:48:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8b3940e051479a281581ab148703ffc0d5d492dbf5f98dba9a033757eb450902`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b3ce085859934dec8f500875186751e41d99fba290ef72013d0130b613910e9`  
		Last Modified: Thu, 04 May 2023 03:06:55 GMT  
		Size: 1.5 MB (1488687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f0bc8f0fbdb688bdc188de127dfec445c76854aa38a3a5b34ac2a507132a033`  
		Last Modified: Thu, 04 May 2023 03:06:55 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7701104be3162112dee4359d53087535f2b9d3fba314de929a023230090bb8bd`  
		Last Modified: Thu, 04 May 2023 03:06:55 GMT  
		Size: 697.5 KB (697530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3594166e2a74a2980661cc1f6e8aee9c3dd600160771bbf27f686f5bd1917f04`  
		Last Modified: Thu, 04 May 2023 03:09:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea2147861d3c49a91fa037e4c3c7078fe6c7b0f7674da69bcc02b7b4df6605d5`  
		Last Modified: Thu, 04 May 2023 03:09:50 GMT  
		Size: 22.9 MB (22877910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-php8.1-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9e04d661503347469096c1326dd731d8bf30f430efdb116f2c35d07f87864910
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181328071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5eeadb79a9dc6d6d4ec8366d3dc30d68782cf3374c2efa09c235ffd6277bd608`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 May 2023 23:09:48 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 03 May 2023 23:13:44 GMT
ENV DRUPAL_VERSION=9.5.9
# Wed, 03 May 2023 23:13:44 GMT
WORKDIR /opt/drupal
# Wed, 03 May 2023 23:13:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 May 2023 23:13:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a2b2185a16e9df1733ad579646ee2aa820dc3c9fd66c6cf363092692a2d9d160`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b43c80662ea17f78137c197f9f78742c635068317eded23b9ad885770f555757`  
		Last Modified: Wed, 03 May 2023 23:32:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:013b2ee556e1d6c8785bb340f60ab735e89ef8606af7619f300153457ea74f6a`  
		Last Modified: Wed, 03 May 2023 23:32:32 GMT  
		Size: 22.9 MB (22876339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-php8.1-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:212ea68cfe7d902a520ce8a2e496d59fb1aeb541c6dd593c05cdd5ca5e4b58c4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189702947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a92238dd458c3c01ae09983c9646c7f4d2aab12e0906a960b1508ee79299c8cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 May 2023 04:37:27 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 04:41:24 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 04:41:24 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 04:41:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 04:41:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bb2d9b228463d8d021b38c61e3a63c9d3cf34d88567d70b6ff263df432034549`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:488000d712f11ce69b68337fbfa0c7172dffbefa4e149d6fb960735be68c39f6`  
		Last Modified: Thu, 04 May 2023 05:03:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3691ecf49545d7907773093f557bf6faae9eaa9edbba837b1302c99f58d99d2b`  
		Last Modified: Thu, 04 May 2023 05:03:21 GMT  
		Size: 22.9 MB (22877991 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-php8.1-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:b29b00326e47b22ec152a8d68d843e1e1683d5ec447605831f38a1a8870d5e09
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186858563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cb2c9be7ada98c90b214a9f8a129aa1c5a255ea006d98b5073ed59fea4f8f63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 May 2023 08:16:48 GMT
CMD ["php-fpm"]
# Thu, 04 May 2023 07:23:18 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 04 May 2023 07:23:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 04 May 2023 07:23:21 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:26:15 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 07:26:16 GMT
WORKDIR /opt/drupal
...
-	Layers:
	...
	-	`sha256:9c6d00009476275d648b8e0de45cc3efc16a99a9914af42d6692a1ea9900803b`  
		...
		Size: 8.9 KB (8881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eedf68ece2848cd781648ec3c779cc8b2eb4bc737a6a26952b8c3b4291a84848`  
		Last Modified: Thu, 04 May 2023 07:48:15 GMT  
		Size: 2.0 MB (1975424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e80bf5c02039f04accfda371d2c5d6ee04b609c010394b10ea6c9869c537cb13`  
		Last Modified: Thu, 04 May 2023 07:48:15 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:283da174dddb4db6e1f90a0071741663af338212579681c67839ebb02c313d9b`  
		Last Modified: Thu, 04 May 2023 07:48:15 GMT  
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a38c2e04b6644d4c245bbd5cdf1f7532c2ce762c2ae33516e143a5e947c68156`  
		Last Modified: Thu, 04 May 2023 07:52:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73627da19355a936093316a8c6a8f8cbbb216bb255386a74cbcd416505779bf4`  
		Last Modified: Thu, 04 May 2023 07:53:12 GMT  
		Size: 22.9 MB (22878183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-php8.1-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:fc9d502afc20199fec9ce76045351f39e21386d96270dc0ebeaa92e9e750d123
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (163970073 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40e102d7b33489091c1d156003ff744876f39e79c7eef00c49ae89558befa3c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 May 2023 07:05:53 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:07:35 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 04 May 2023 07:07:35 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:07:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:07:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ae0a0350b3072ae1e42ed09dc94a3067cdfd2eaf259563cfe3373094bd6cf6a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:198e8c939e08399d7ba46e97edf3f240dd652c0909afedfde8f1f91ffd1a0115`  
		Last Modified: Thu, 04 May 2023 07:18:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69045596528755446d4c0cacee4718e4d7e8ac89b6f5ecef4a9f9ab396c86e56`  
		Last Modified: Thu, 04 May 2023 07:18:37 GMT  
