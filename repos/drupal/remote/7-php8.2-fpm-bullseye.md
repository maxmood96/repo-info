...
```console
$ docker pull drupal@sha256:bcf9400845bbd0d1b4819426794c34effe3324ae7ca7090ee38c247b639f21d9
```
...
```console
$ docker pull drupal@sha256:04335b20e62e2dbbce37521ab92fd60106d4e8c1769e99559170376eb1848de5
```
...
-	Total Size: **145.1 MB (145087390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ded2cbcc4391556394aee903a19ac87604f29a27ad5868df3d0003436e04a265`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c64092864977bf88014e77df8b6f67fd82df736dd936e17729bff1f2eac104f6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:272d833aaa34ea88087ab183e6c6458a980d0c6fcf7cc699f08d7d24b70e3281`  
		Last Modified: Thu, 22 Jun 2023 23:56:52 GMT  
		Size: 1.6 MB (1608518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70f2679683d8c27afc1f4e0481604aacf0515d605977d9755b1a1960a005dfe0`  
		Last Modified: Thu, 22 Jun 2023 23:56:52 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5a96213c0b2356a5d5bcd8d8c80bfe21cff5335d7e9b3d0c927c81cf33d8f74`  
		Last Modified: Thu, 22 Jun 2023 23:56:52 GMT  
...
```console
$ docker pull drupal@sha256:ba92fb4c5873357a4deefff5782db7858617eb83e622644ae1129e5a2f556462
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137405659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b31822e6eb08ac95ddcc6aecf119069125c2ffdf36c41561dc7a66c561644928`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9d330141f897ad202a1059e4b243f2863cd2821adb178ced33f414354c6f0bba`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0d38306d43d327398d21536d1021159a6a76a500bb4086836c600c0e983e9aa`  
		Last Modified: Thu, 22 Jun 2023 23:38:19 GMT  
...
```console
$ docker pull drupal@sha256:89861885312e6e3d0b8491aac459106dc2c563cd8097ecef3399ed939a1abc41
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161720294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24d335fe43352fd49da863a0a8fc0b0d3ab3a2c6539cb599a0be670c80986cec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:45:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:01:31 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:01:31 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:01:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d4cde0fa46db656d9d1b208b76be05459c49c8e792c7de89a4c89ca17fe06f7a`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e95c0aa2ceaba2e8711c52511c42d37b3c5f9881ff29f4fa4620536dcb8d1010`  
		Last Modified: Fri, 23 Jun 2023 00:20:58 GMT  
		Size: 3.4 MB (3410776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:240fb03a8abbfcde966c98520592a3479a2652d8b7f4aa6749161f812b62d97c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.1 MB (170085698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b0feeba317e489787f2a48bf93f9d348cebc08bac55e876578f05f1ba48828f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:38 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:38 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4a8e82e6ec60d0a04b7c378fb375a939606854d40ab2bddc40da2d928b6c23b7`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54dd7fbfe5fa1dc413c5aa8fe67b1c23f22414e738501b1bbf8aa67608a2ed55`  
		Last Modified: Fri, 23 Jun 2023 00:25:37 GMT  
...
```console
$ docker pull drupal@sha256:e4185984ba811876dbe247af07792a445b739885943448c6b6c8a0753b5ccd10
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.3 MB (144330503 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d544d8a752c8d1346a231a4e83c891b70d89963a1877711bf78c142c74c6e0c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:45:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:04:59 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:04:59 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:05:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0fb672111548834baab52535ebd6a8eaaea4f02026177066ae8f75d74fad055b`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2450edea3cbf8910cf44161f1c9b5485c43f5a27ade16333ef3e4c1d343de1d4`  
		Last Modified: Fri, 23 Jun 2023 00:20:41 GMT  
