...
```console
$ docker pull drupal@sha256:85c2aaed6c4dd2b8827b5a7bca6114f98f57aa7012afdcab4c4707db458ea0be
```
...
```console
$ docker pull drupal@sha256:4a7dadedec4cdfed90001abd5cac0ce03f5caaf940c3ddd2b09c2f2dd923e6ac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180182964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57c1829b49bce5aa24eeb1b03b3789d52b731f1149ccb024cf7eef763a8f009e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:15:27 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:15:27 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:15:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:15:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8742b904b5ff234d0e600f32f30e019406c8c066cace4fcb3113de9e0949f42c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d64bdf3729ee1ce89bb11ba0842a16cb25bc3786d5183c53f6386933706ef7a`  
		Last Modified: Wed, 17 Aug 2022 23:52:56 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1df7cc38442c3ac72b59ab7d28cf7611c9fdb49a4304f9d6d12d76c3f7583dec`  
		Last Modified: Wed, 17 Aug 2022 23:53:01 GMT  
		Size: 21.3 MB (21312193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
