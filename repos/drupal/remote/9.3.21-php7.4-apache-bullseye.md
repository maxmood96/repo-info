...
```console
$ docker pull drupal@sha256:7f8ad2554b586482fd8b87b7b4c9970cfac9bc49529d560692c9d7b4a59f12f7
```
...
```console
$ docker pull drupal@sha256:1a633abe94e16f7da533df4bbad40c6f6b71bab1d2a821e8dcb014076a662d4a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.7 MB (164682222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:205d06fe64fa825534c6eb0d529bf0e742611ed4fe7e889ddcc2040ac4d35d9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:18:44 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:18:45 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:18:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:18:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c04ed0fc27243f4c82cf133a3c0c6c770265080a3e7625910bf66b0b4702eb75`  
		...
		Size: 692.1 KB (692053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac8e15ef8c457fe3d3b9e4107065a4841d90a4dfc16e9dd7f6af051c006a70ad`  
		Last Modified: Mon, 22 Aug 2022 19:47:34 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00af6e506ef8643cf8f05c65dc7f52a8b1d512e497a66bc34642cd713f45083f`  
		Last Modified: Mon, 22 Aug 2022 19:47:38 GMT  
