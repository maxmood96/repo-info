...
```console
$ docker pull drupal@sha256:180092c47749aab8d031fb76a2ae5386f5acafbfb503aba1af733c3d577b2b11
```
...
### `drupal:10.6.8-fpm-alpine` - linux; amd64
...
### `drupal:10.6.8-fpm-alpine` - unknown; unknown
...
### `drupal:10.6.8-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6.8-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6.8-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6.8-fpm-alpine` - linux; 386
...
### `drupal:10.6.8-fpm-alpine` - linux; ppc64le
...
### `drupal:10.6.8-fpm-alpine` - linux; s390x
