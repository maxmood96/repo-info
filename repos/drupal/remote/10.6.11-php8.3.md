...
```console
$ docker pull drupal@sha256:ec9fc52a8bac0dfc43e0a31ac805ab5d6873fa7a637364f1fa87764060722fa6
```
...
### `drupal:10.6.11-php8.3` - linux; amd64
...
### `drupal:10.6.11-php8.3` - unknown; unknown
...
### `drupal:10.6.11-php8.3` - linux; arm variant v7
...
### `drupal:10.6.11-php8.3` - linux; arm64 variant v8
...
### `drupal:10.6.11-php8.3` - linux; 386
...
### `drupal:10.6.11-php8.3` - linux; ppc64le
...
### `drupal:10.6.11-php8.3` - linux; s390x
