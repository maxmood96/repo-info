...
```console
$ docker pull drupal@sha256:229765b3940e6ef3cca782f2ffd386a170f2c3f726d65d226a1fceaaaf5f9b6c
```
...
```console
$ docker pull drupal@sha256:15fcc261628036cdc10b82cfe0d0e5ddedbdcce2bf5cf85ed0853cee5771363a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46755971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dd59a68a810b8628c4e7582e320894318b1fb45f7436da85a20d6ffadce18c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:15:27 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:15:28 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:15:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:15:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf8b952dc7d20bb95167c786c4b4b0a46d03e5441929b2ab8864a6f5e4d0e940`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f024836275b614e63cc1378c90361dac1791a7d81125dcab05a038779b04b909`  
		Last Modified: Fri, 11 Mar 2022 15:44:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424739b8993e3f3959e7f0ee80bb7df9690bfb800253a907834c89adbb2925bc`  
		Last Modified: Fri, 11 Mar 2022 15:45:22 GMT  
		Size: 19.1 MB (19110342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:40bae1b2f76b8fc3271a7f350043ba7ee497b72af41a6d1e159c9fa82c7cf348
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50160947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f41f756c369819bd64af36cda53bd8341ea42921a2f89ee1d52335f73ccddd82`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 14:51:04 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 15:00:13 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 15:00:13 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 15:00:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 15:00:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:12abe2ac8b737f06597b9362b3c85ae15a2d2b7c35b70b3db94d148b7b5af8ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb9ee6239d3d7a736248012e0081ced872568457d33052c54fb85cfc2e901454`  
		Last Modified: Fri, 11 Mar 2022 15:33:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27c79782327228060a7a7132ed92d788c622be8e695a09de7ad52f0d9197cbcf`  
		Last Modified: Fri, 11 Mar 2022 15:33:19 GMT  
		Size: 19.1 MB (19109840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
