...
### `drupal:7.103-php8.2-fpm` - linux; amd64
...
### `drupal:7.103-php8.2-fpm` - unknown; unknown
...
### `drupal:7.103-php8.2-fpm` - linux; arm variant v5
...
### `drupal:7.103-php8.2-fpm` - linux; arm variant v7
...
### `drupal:7.103-php8.2-fpm` - linux; arm64 variant v8
...
### `drupal:7.103-php8.2-fpm` - linux; 386
...
### `drupal:7.103-php8.2-fpm` - linux; mips64le
...
### `drupal:7.103-php8.2-fpm` - linux; ppc64le
...
### `drupal:7.103-php8.2-fpm` - linux; s390x
