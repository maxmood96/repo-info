...
### `drupal:11.2.1-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.2.1-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.2.1-apache-bookworm` - linux; ppc64le
...
### `drupal:11.2.1-apache-bookworm` - linux; s390x
