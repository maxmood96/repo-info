...
```console
$ docker pull drupal@sha256:ae3603287fa4010a2964bc1027e9674757aa6f2c5e9cffbe85151a69410fe8c3
```
...
```console
$ docker pull drupal@sha256:2b26912125497807476829f4e35cd51bc3edaeee35ff48f8e18876fb1fc738d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48609583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f45fad3d944324458f4c12ce075e110a30bb56d053ba9deea64f2ea5b11f9d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:34:24 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 15:34:25 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:34:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:34:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d36281d7370a33e24a5161b645dc0a55a33e028d9aca3f920bcff94e1105e380`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b0160ea734b97d678eefb2a05e67187efac1a12955604c98dcc4134a7ce94cf`  
		Last Modified: Wed, 30 Mar 2022 16:01:43 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ee4e5fa0423fa5c0fb38e513bcde907aed945ff321627ffc9840615922d0ac`  
		Last Modified: Wed, 30 Mar 2022 16:01:50 GMT  
