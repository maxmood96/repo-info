...
### `drupal:10.6.1-fpm` - unknown; unknown
...
### `drupal:10.6.1-fpm` - linux; arm variant v7
...
### `drupal:10.6.1-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.1-fpm` - linux; ppc64le
