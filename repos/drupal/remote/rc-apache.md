...
```console
$ docker pull drupal@sha256:d737cbc0450cc824794159d8a3a56993179a8b6963fbe5fbadbfd47972c72f06
```
...
```console
$ docker pull drupal@sha256:7243b6c3a558c78e17547bb45427f9d56002babc446bc73852dec8fefe8167f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155210945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:587945bbdc2397f5ade39f0c24d8be932ad4e9325693cb71fa97a882089566af`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 19 Sep 2022 22:59:26 GMT
ENV DRUPAL_VERSION=10.0.0-beta1
# Mon, 19 Sep 2022 22:59:26 GMT
WORKDIR /opt/drupal
# Mon, 19 Sep 2022 22:59:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 19 Sep 2022 22:59:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c55854f67c5552c5a6fba3d96ec529c00f782666c212170fad22eb5dc4756348`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc2af505f68b157a60f66d2a860f3bcc12cfe1e6fe5fc654a45af8c0f2dcaadb`  
		Last Modified: Mon, 19 Sep 2022 23:30:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a276c5e4ad8b97b18761da39456a22681f6f9bcc732ae4d95ad8bd49ab1080e`  
		Last Modified: Mon, 19 Sep 2022 23:30:26 GMT  
		Size: 17.5 MB (17504344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:53c93141795a38e9b012231e52b8db7aa9c6775da3ab2329e005933665142375
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.1 MB (186083613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca8e2a3d67f6e72ea87279dc720378fa0674b88fa909f4b2553f64fd8d6e82b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Sep 2022 17:47:44 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 19 Sep 2022 23:17:25 GMT
ENV DRUPAL_VERSION=10.0.0-beta1
# Mon, 19 Sep 2022 23:17:25 GMT
WORKDIR /opt/drupal
# Mon, 19 Sep 2022 23:17:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 19 Sep 2022 23:17:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4182649a971fa7b803d8e407d2f91a35547bc856fd21629c544a26030c9739bc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:774c0523589c0eeb625e4b07882d44be4f7c394b734ff9981a0b045ebd6c96c7`  
		Last Modified: Mon, 19 Sep 2022 23:32:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49861f1911d8f009c32fbf3a1cf8d33631100ebd7efcfb64bb22bbba69963af0`  
		Last Modified: Mon, 19 Sep 2022 23:32:57 GMT  
		Size: 17.5 MB (17504080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
