...
```console
$ docker pull drupal@sha256:ae8c1dbadec1c4273b52c8752ed76ac6940fcb0a6489c593b8bf003c358ebdcd
```
...
```console
$ docker pull drupal@sha256:0c11d8d24bcbef5e7ac1b507143d9bdcdd84d33520a74015c9e455ed95ae57b7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.5 MB (163502630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4eb8282c67c39c6d9c0fbcd733188777670d2dc7ca0d526ebe23a204fc18fad8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:dac3de8148c1f117c322d20da9069cc70007f81f4a00f33f1aa30dc94f22b490`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e16a46876547e69f8690422d1d3046371fad21abb8cf7717706eb6ee7b5a8add`  
		Last Modified: Wed, 24 Jul 2024 21:00:52 GMT  
		Size: 19.2 MB (19211153 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:rc-apache` - unknown; unknown

```console
$ docker pull drupal@sha256:0015c5a816f405e51a83ddebdbf10f1402f33781b519da32dfa3614348957c29
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.7 MB (6692273 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c76466fdccf9d8b734933ddc5cef774eaa5ecc9bacbe92f2808b90727a8b20c4`

```dockerfile
```

-	Layers:
	-	`sha256:451c13f9c711cd8fd7971c5705e852af8dac2693bcb3438f95246177adce4974`  
		Last Modified: Wed, 24 Jul 2024 21:00:50 GMT  
		Size: 6.7 MB (6651783 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:baa2d884fd4a7a4d1317ba015eccdba4345b230cce18bc9d873a891703475258`  
		Last Modified: Wed, 24 Jul 2024 21:00:49 GMT  
