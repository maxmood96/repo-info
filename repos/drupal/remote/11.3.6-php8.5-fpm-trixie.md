...
```console
$ docker pull drupal@sha256:32c7b35490d9792aa673b3d48fb75bd60a315ab50bfe25c3e09a39d1707a82a9
```
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; amd64
...
### `drupal:11.3.6-php8.5-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; 386
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.6-php8.5-fpm-trixie` - linux; s390x
