## `drupal:10.2.11-php8.2-fpm-alpine3.20`

```console
$ docker pull drupal@sha256:b0c6e0182e2398ecd2f477842609af6d52ac821e967d8bb1a5261aa033fee1e5
```
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; amd64
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - unknown; unknown
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; 386
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; riscv64

```console
$ docker pull drupal@sha256:ee0a864dcb0f020fe07ee8e8bce15a3ee4fe576eeeee36f24d61a9db445753a1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.2 MB (55195659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7747fb13edb984abf92147550304a0bbebbc8e7024e3305a24b209ee8949cb0a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:20213873dec72e4e22c8fa8c748a8232b8706873c4091cf4b46dba6fa526ea61`  
		...
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:537202f85fe49b90e84cd5d3b5f081d7fd3db33b13b0ac4105c9affadabdc562`  
		Last Modified: Fri, 22 Nov 2024 09:56:28 GMT  
		Size: 19.3 MB (19308032 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2.11-php8.2-fpm-alpine3.20` - unknown; unknown

```console
$ docker pull drupal@sha256:6eb7632f2b6ead9c0560d4b9b9a6e8735894dec46f6288ba4a9b9056bae9c393
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **380.9 KB (380950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5072c7eb87761db6791665a9d60fb60b5e7a58134205dc4cc543df3228242830`

```dockerfile
```

-	Layers:
	-	`sha256:d3c5a8c521368d3cb87e9c431574ef8b918cc54931122e9a7e7a6ca12da0a51f`  
		Last Modified: Fri, 22 Nov 2024 09:56:25 GMT  
		Size: 347.2 KB (347180 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2f32380b69a38d69f8e81a4a8c4bce92f24fdc0d031a41da192361adac7f8ffe`  
		Last Modified: Fri, 22 Nov 2024 09:56:25 GMT  
		Size: 33.8 KB (33770 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.2.11-php8.2-fpm-alpine3.20` - linux; s390x
