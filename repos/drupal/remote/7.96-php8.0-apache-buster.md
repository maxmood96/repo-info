...
### `drupal:7.96-php8.0-apache-buster` - linux; amd64
...
### `drupal:7.96-php8.0-apache-buster` - linux; arm variant v7
...
### `drupal:7.96-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.96-php8.0-apache-buster` - linux; 386
