...
```console
$ docker pull drupal@sha256:486ba4d91c1144df0531da046117405778762794512e2af0cb4cc23d82d216f6
```
...
### `drupal:9.2.9-php7.4-apache-buster` - linux; amd64
...
### `drupal:9.2.9-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:9.2.9-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.9-php7.4-apache-buster` - linux; 386
...
### `drupal:9.2.9-php7.4-apache-buster` - linux; s390x
