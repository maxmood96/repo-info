...
```console
$ docker pull drupal@sha256:299236230d2c611a883439551d50ba2d5e093785fc7091678c394b56e2c71f40
```
...
```console
$ docker pull drupal@sha256:a3f079696f3edc4bdf40135d949aa8952adcd1788b107ecfe533b3edbbe557c1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.1 MB (193110950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed9a44e245dff6460de4156c4659e528c3e060a07798f8b26dbc8ed9559b0009`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Mar 2023 00:15:35 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:26:46 GMT
ENV DRUPAL_VERSION=9.4.12
# Fri, 24 Mar 2023 00:26:46 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:26:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:27:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fec8de5c8fe2e353dc9f86a02a1e737b98501f21e5562acdf27530c3b380bcfd`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:282b57e7ce2cdaf5e966b861b77643ee0b0714029f0f00efbd6bebc6eaa1c74a`  
		Last Modified: Fri, 24 Mar 2023 00:39:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ebfdedf8e44f27187bfe6b9d2dc886bebb4862317092ced2bb3d323baf17bd6`  
		Last Modified: Fri, 24 Mar 2023 00:39:50 GMT  
