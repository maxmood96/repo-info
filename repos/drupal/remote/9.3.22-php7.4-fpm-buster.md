...
```console
$ docker pull drupal@sha256:8b9f01e9224783c43981e9c983708c628ddc46f0e5007359810f147fc367d828
```
...
```console
$ docker pull drupal@sha256:930468393612d204009d6e0d6a6a64b2fa783d833e38ba24e9839347d1371085
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154924175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:776d254be44a7e19bc32693989811081a86dca8f4485872557fb82e3002ec0b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 05 Oct 2022 23:09:43 GMT
ENV DRUPAL_VERSION=9.3.22
# Wed, 05 Oct 2022 23:09:43 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 23:10:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Oct 2022 23:10:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1ada4aff24ae85ae771dd98567d4330dc1bfa85de4fc300107cbaa4fe4b08e78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4af2ba54709960c9839f1814828582e797a6fa50b8a19057a4f744e56653cf2`  
		Last Modified: Wed, 05 Oct 2022 23:40:58 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37156086b64b521fef2b34351ffb4d56b255273295a9365f15ad62e716547d2b`  
		Last Modified: Wed, 05 Oct 2022 23:41:04 GMT  
		Size: 21.3 MB (21314399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
