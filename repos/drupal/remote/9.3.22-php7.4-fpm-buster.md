...
```console
$ docker pull drupal@sha256:6afb42480c80cce4e837485a6464d9db10c9040f4d381422fb19e35d25dab7d4
```
...
```console
$ docker pull drupal@sha256:052ecfe7412b93e846f0f3d01b423d6a258f740382476cc4bcede406fe8c5671
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168507606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2611223bdaa784d5a18008cb31d74f9eb761b5a1000121d6d1ed27199f8a374`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:59:39 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:59:40 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:59:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:59:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ace86e59bbff86a56823d90cd850a578ad1c9ada2d9ef8f57ba3be192cd0beb6`  
		...
		Size: 695.2 KB (695189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84910fc137d2b80f2789d4461f48396cc758870c453bac783796f4709ab88f34`  
		Last Modified: Wed, 16 Nov 2022 22:58:36 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48c8db9269e0c5b9eada9020126bc8b41e987f6001453656aeb5f6cbdc595985`  
		Last Modified: Wed, 16 Nov 2022 22:58:51 GMT  
