...
```console
$ docker pull drupal@sha256:6e22719c2fcfd298db4b1d8503d89682120559fc6bb4d9cd3ce5539f2299eaac
```
...
### `drupal:7.96-fpm-alpine3.16` - linux; amd64
...
### `drupal:7.96-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:7.96-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:7.96-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:7.96-fpm-alpine3.16` - linux; s390x
