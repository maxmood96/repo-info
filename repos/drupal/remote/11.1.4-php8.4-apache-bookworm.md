...
```console
$ docker pull drupal@sha256:011b0405c898c04670eb48d6a2e2d241b386f87750603916b04ddf02ac66c788
```
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; amd64
...
### `drupal:11.1.4-php8.4-apache-bookworm` - unknown; unknown
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; 386
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; ppc64le
...
### `drupal:11.1.4-php8.4-apache-bookworm` - linux; s390x
