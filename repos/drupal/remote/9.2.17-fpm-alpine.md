...
### `drupal:9.2.17-fpm-alpine` - linux; amd64
...
### `drupal:9.2.17-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.2.17-fpm-alpine` - linux; 386
...
### `drupal:9.2.17-fpm-alpine` - linux; s390x
