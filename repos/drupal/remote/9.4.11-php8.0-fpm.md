...
```console
$ docker pull drupal@sha256:333d12ad55445c5fbda0fc852517eaf25f981424d6068226f9b6aba8437844f3
```
...
```console
$ docker pull drupal@sha256:4ded0fd1dff0d95aa5d1a9d9660f5c5ef097443ce56e1692c19f724ee329ac4d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155017782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6dda5cc8f3de23dd7c67def6f73abf985408114f97402465ad109627edab610e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 09:00:33 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Sun, 05 Feb 2023 09:05:56 GMT
ENV DRUPAL_VERSION=9.4.11
# Sun, 05 Feb 2023 09:05:56 GMT
WORKDIR /opt/drupal
# Sun, 05 Feb 2023 09:06:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 05 Feb 2023 09:06:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6c7b5eff8d2ce0d313eeba187998301cc03e5f85f5011c920a118625063154b9`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:588b0789fa3dbdad0116d63f0defffb0a4104f10d34357b0057716b12ce3afde`  
		Last Modified: Sun, 05 Feb 2023 09:31:33 GMT  
		Size: 700.1 KB (700099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2259c8bbcd5baad8169c9af1cdd077558e2259002c7d8d20526e9d94b65820da`  
		Last Modified: Sun, 05 Feb 2023 09:36:13 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e571ecbe0bac86f9cd944942027a015b35c369c5ac40749d11724df24379ba18`  
		Last Modified: Sun, 05 Feb 2023 09:36:21 GMT  
		Size: 21.9 MB (21910165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
