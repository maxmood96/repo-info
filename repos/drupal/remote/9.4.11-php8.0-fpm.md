...
```console
$ docker pull drupal@sha256:cb7c37192ae738059aca98f66f51481bfe3a7a3e9e9563a68e9c9eec614462c3
```
...
```console
$ docker pull drupal@sha256:c980a9ad98a2c4424f5f1a6b7a5aa8626abeae202f15fbc4243abf6727a36e7d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155034469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b88ccdb94ab161fcdeb442904c454e6e5aa1719a48d36d742df82638cafd3ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 07:09:04 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 02 Mar 2023 07:15:55 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 02 Mar 2023 07:15:55 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:16:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 07:16:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b071994b29d2c0178ee361d26d2d59216f88ab26a431e58f4a3fdd4605638036`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81beee4de44ebb447acedec494844f50d3908c6e3f4bc78fdb94fafb84f6b788`  
		Last Modified: Thu, 02 Mar 2023 07:47:52 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c0968ffe5a6597561508b73c5bf05a5eca692e9945f04f1ff3df93c52ee528d`  
		Last Modified: Thu, 02 Mar 2023 07:47:58 GMT  
		Size: 21.9 MB (21911638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
