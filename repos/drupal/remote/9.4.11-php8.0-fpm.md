...
```console
$ docker pull drupal@sha256:2f0600a5a772cbc1089687bd1c7569c926270822b208ffd3dbd0574f42aef23c
```
...
```console
$ docker pull drupal@sha256:c9bf2a4a794aa034b48a4b85ecac10961f76de8f622525e249b1fcc9f7f31a65
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.8 MB (184799850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:624a9e062672cdf8f32b37248aee2ac9508a08e084b6d7438cfa98d8f7e5cbfc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2c6e86189bae3d0f441696ba145d29f22860cb3f94dece0c5761829ffdb8cb91 in /usr/local/bin/ 
# Thu, 09 Feb 2023 16:46:08 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 09 Feb 2023 16:46:08 GMT
WORKDIR /opt/drupal
# Thu, 09 Feb 2023 16:46:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 09 Feb 2023 16:46:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed0fd910359d2247a0ab0ea2e20d9d5119660da8513e3a132fcbe5145e62257e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c51aaa5ec8843296d6ccecc89ca1b07bacaaf8e4005223c06e133b1bd0c14248`  
		Last Modified: Thu, 09 Feb 2023 17:06:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28915d3e0e3fc0b54532f7feaea2574055b8480ed59ffd4edbc68ab6682f1c24`  
		Last Modified: Thu, 09 Feb 2023 17:06:39 GMT  
		Size: 21.9 MB (21911828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
