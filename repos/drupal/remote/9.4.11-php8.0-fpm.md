...
```console
$ docker pull drupal@sha256:ca3f15db3502217d87872eb564a916a64de1f4671114c4eaf7a81679f0859603
```
...
```console
$ docker pull drupal@sha256:9590e41d4013b3500674f158509b46109a3bf0830da31ae9dc86b3592da56ff7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.6 MB (187610647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5aa6848e684b2c5b9d575e23ecf6218af9d33de6d10d89a74dfa9d449cc95fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 02 Mar 2023 07:10:54 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 02 Mar 2023 07:10:54 GMT
WORKDIR /opt/drupal
# Thu, 02 Mar 2023 07:11:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Mar 2023 07:11:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cf7c85ff05836a20450f8dc49c2749694a6d0da3578f851718567c80ea129bb5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed89c18e54573ecc9d3bfd0122b1ff0e33eae7e542543855e45120fa11ac0e22`  
		Last Modified: Thu, 02 Mar 2023 07:41:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07c21999dde8bf52dbef2fa1e633de0c10e9323baf4e829412f2ff3422fe2da6`  
		Last Modified: Thu, 02 Mar 2023 07:41:26 GMT  
		Size: 21.9 MB (21911418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
