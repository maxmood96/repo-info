...
```console
$ docker pull drupal@sha256:2dac20f8c6e030a6d0a1a90155ce0855c13a690a16fcf79e6e9e6de39b0b1df0
```
...
### `drupal:10.6.12-fpm` - linux; amd64
...
### `drupal:10.6.12-fpm` - unknown; unknown
...
### `drupal:10.6.12-fpm` - linux; arm variant v7
...
### `drupal:10.6.12-fpm` - linux; arm64 variant v8
...
### `drupal:10.6.12-fpm` - linux; ppc64le
...
### `drupal:10.6.12-fpm` - linux; s390x
