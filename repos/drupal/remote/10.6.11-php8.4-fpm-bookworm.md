...
```console
$ docker pull drupal@sha256:00e295786968e633921ccbb57a4d2839bf95acff8dd8f1589cae7405c7eb2317
```
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; amd64
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - unknown; unknown
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; arm variant v7
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; 386
...
### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:391f59909f9deaff40d095bd3495064acc17a1ebe7fd1a805a06cf5d323866ff
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **211.0 MB (211034452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6d1e628c71a69104ec3a4ea83b7753eb68222bb6d0aa5e73b555ec4fff20786`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:395083c020f2d2d27217319965105f549497ccb16a723c348a0144ede3b20acc`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ec9f1c4b06f5b3ccdb784d19a09c9a451828cdd398176dcc754ce84ee9e51c98`  
		Last Modified: Wed, 24 Jun 2026 09:33:34 GMT  
		Size: 21.9 MB (21910417 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.6.11-php8.4-fpm-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:b1608bee92444f4de890c5e259a1cd39a3fb802f27e904f90ce85cdb6d1696b1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.6 MB (6628587 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82b5c8d92ea9bb2d6da184c7af5bb7ffec99112e105f9cb13de09870fbe61066`

```dockerfile
```

-	Layers:
	-	`sha256:752cc5f9a4d0fc42fed2ca6fe41cc62a1a87585f575cf9e3173e4fd523a31625`  
		Last Modified: Wed, 24 Jun 2026 09:33:33 GMT  
		Size: 6.6 MB (6593245 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2fa53d69b57a6781fb235d897701b919f4635411f1572b8f768b20b0df1e683d`  
		Last Modified: Wed, 24 Jun 2026 09:33:33 GMT  
		Size: 35.3 KB (35342 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.11-php8.4-fpm-bookworm` - linux; s390x
