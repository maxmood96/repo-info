...
```console
$ docker pull drupal@sha256:4aec7f2fe2d5a921f5953cf333b1877233ad9e6d5d9e80661cfce6826e9ca74e
```
...
```console
$ docker pull drupal@sha256:6193f4e4df036519605bdc81c9c87e6faf8e0f223cfb597b62a13e2154fa419c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.0 MB (60956461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:30370d51e148fadf2e6c1cc73711a09d47ea2f2d15fa25bca967714a0527a7e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 May 2026 16:46:17 GMT
CMD ["php-fpm"]
# Thu, 04 Jun 2026 21:40:19 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps # buildkit
# Thu, 04 Jun 2026 21:40:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Thu, 04 Jun 2026 21:40:19 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Thu, 04 Jun 2026 21:40:20 GMT
ENV DRUPAL_VERSION=10.5.11
# Thu, 04 Jun 2026 21:40:20 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Thu, 04 Jun 2026 21:40:20 GMT
WORKDIR /opt/drupal
# Thu, 04 Jun 2026 21:40:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Thu, 04 Jun 2026 21:40:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d63c3e2f4126e79d71636da92f2d82b566f44097d53a7e82879cd60be2a06b12`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1ebb58421ace9086c78ba310a99d070d99f5fd5f5b7567ce54a4ce622dcd4dcd`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
		Size: 1.6 MB (1627558 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c8fe6450643b3967e0c5f73ee5631aa4232c4b91a062d2d4ac98b996a8ff9fa9`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
		Size: 311.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:be825b39ffab94a95c182136b2c33330ad684cb4ffa04f959bdf2a3c85b6b457`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
		Size: 823.3 KB (823336 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:17369e82bfa69fde48ac85ec789ae1e6959416d3e5a75ca9c66287ea359fd91a`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c389a658ace2b7522ecd7cd6a981cea68b02362549413cb49f4e633134763bda`  
		Last Modified: Thu, 04 Jun 2026 21:40:45 GMT  
		Size: 21.8 MB (21758260 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5.11-fpm-alpine3.23` - unknown; unknown

```console
$ docker pull drupal@sha256:290f56f66879497a9e4941410a19bb703889101e4da7e8988a56c6b16286e5c5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **405.3 KB (405303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c30a5001a7558d2ba81d4e81b3fdcac2e6c4d76bdd8e259d81381ba2b937f15`

```dockerfile
```

-	Layers:
	-	`sha256:0cd4e1e586d2ef1538d8253290606c3d107afd598fdbc548a0e3f5d8f43ef581`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
		Size: 370.9 KB (370853 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2be58e03f4db08eb4be369e54c8358052ac161716ff83dcb4e7d01141bcb913c`  
		Last Modified: Thu, 04 Jun 2026 21:40:43 GMT  
