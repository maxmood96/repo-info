...
```console
$ docker pull drupal@sha256:7b2ab27197183bd3a569682ac2e6ad3383599d21992dc391eee5ad34fe2f38d1
```
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; amd64
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - unknown; unknown
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; arm variant v7
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; 386
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; ppc64le
...
### `drupal:10.6-rc-php8.3-apache-bookworm` - linux; s390x
