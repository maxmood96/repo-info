...
```console
$ docker pull drupal@sha256:9bb37d94e69a12c72e2c394fc2ac3684317c9175c93c2d555ad8f8341f969cac
```
...
### `drupal:11.3.3-php8.5-apache` - linux; amd64
...
### `drupal:11.3.3-php8.5-apache` - unknown; unknown
...
### `drupal:11.3.3-php8.5-apache` - linux; arm variant v7
...
### `drupal:11.3.3-php8.5-apache` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.5-apache` - linux; 386
...
### `drupal:11.3.3-php8.5-apache` - linux; ppc64le
...
### `drupal:11.3.3-php8.5-apache` - linux; s390x
