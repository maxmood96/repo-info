...
```console
$ docker pull drupal@sha256:5d5909179b92e409abc42cb645b5d9bf912b458b2926dfa12e55fe2ed31b6de7
```
...
### `drupal:11.1.3-fpm` - linux; arm variant v7
...
### `drupal:11.1.3-fpm` - unknown; unknown
...
### `drupal:11.1.3-fpm` - linux; arm64 variant v8
...
### `drupal:11.1.3-fpm` - linux; ppc64le
