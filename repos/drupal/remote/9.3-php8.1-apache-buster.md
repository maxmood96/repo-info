...
```console
$ docker pull drupal@sha256:dafc75cd6eda298b691569c0fc3f71be2e4c8b836bc01d2e760ed5fb09c5aca8
```
...
```console
$ docker pull drupal@sha256:64a254959b195922f1dc01669a76401428bc999dd9f76e5074b2c66de342b456
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.7 MB (144700710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db2a04e7668fe6e2af035f8e8cdf037dc3eaeb29490c33a65e418358b98f5181`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:02:33 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:24:33 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:24:33 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:24:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:24:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ab3f9ec9ed9a9de8f15351dbd5cb0c874611fc1da738aabfcd9d64a00c43a7eb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5813fe69e95f8eb6a2d75ef4ee63bb341dca546bdebc055d7a36fea40419aa7b`  
		Last Modified: Thu, 04 Aug 2022 10:12:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cee825fccf5725c60adf9d63d33bc14ba8b69daa2a447e6e8ef6aed75137542c`  
		Last Modified: Thu, 04 Aug 2022 10:12:22 GMT  
		Size: 21.2 MB (21223272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
