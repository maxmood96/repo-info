...
```console
$ docker pull drupal@sha256:9e1b5b5660691d0ae8d2ddbc3b495da778cf83830b1fc9b9d82d8782a58fd865
```
...
```console
$ docker pull drupal@sha256:3265585084c17adbe41f231809e9858146e19db073da85134c19e8f175a76169
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.0 MB (175012932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8148fc7a3a93240a23d69490bc4411ff335300ef93e6bdfb8f0f4e3b7abde4c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:08:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:08:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b1db379554e8421d4d569a7bf2839f53892204f95296978b92f5472b171d7057`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d037979da8fbf54e1e9f243e2e7f8fbe9c92e573cad2fd55314ee350183567e8`  
		Last Modified: Mon, 22 Aug 2022 19:45:41 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b0c8e2aeed5b7b044b7b7965b934b32f49c5f1e3da98664ae056e8b3b298c02`  
		Last Modified: Mon, 22 Aug 2022 19:45:47 GMT  
		Size: 21.3 MB (21322367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
