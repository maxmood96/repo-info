...
```console
$ docker pull drupal@sha256:df958c23a03c148fd8590c1bfdda634e9d35527312cdfac3b99db5e43b23f8e1
```
...
```console
$ docker pull drupal@sha256:478c59dff6ea593c38d25ba0dd12e2759aaf01cb1c4287bcef16ed52ff68e72f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161780031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2ce1ad53495ac72364f1c36a1068e84c0c25328dcf9ff02b9c8c0b6920078eb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:10:33 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:10:33 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:10:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:10:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ced55837b86cbd35cf3c3f32512b3bbc3694488b4d3ab87583604b1601121207`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cefdfc707a6077b622335efdf28d603a0f479fa0534b23c8914c18bf6b9d0bf`  
		Last Modified: Wed, 17 Aug 2022 23:48:07 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3edd6a93eba5fed20c10fdd134e754c798415945e25dd5846b2d0256280e2d12`  
		Last Modified: Wed, 17 Aug 2022 23:48:13 GMT  
		Size: 21.3 MB (21321804 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
