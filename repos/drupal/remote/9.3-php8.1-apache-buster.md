...
```console
$ docker pull drupal@sha256:911e3bc609982cba998aa499d088ea57381aac1720e7bac2df788f5fc0c6cf0a
```
...
```console
$ docker pull drupal@sha256:490194d4dde1e3f4339750d3d5a2f011305c2010cbc94716c56f74d0a73c6193
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.0 MB (174993944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03d7028ff0a409e1627da3733c1b645d14df42d0824cf09d774f99d51b622cc6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:55:47 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:55:48 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:56:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:56:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:595c1a9eb5123d58e50d02164a4d28e6aba48cab3a99fd4a88933f496d08a957`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efd097f73ce8d1db2fa8c221f5b3475efb04588c9261a9e57e1e7f94833fbe55`  
		Last Modified: Wed, 16 Nov 2022 22:52:57 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a096344fc9c515ef4b4f2c3295a8e386f85e057a932418f6638e93ac65a8cb4`  
		Last Modified: Wed, 16 Nov 2022 22:53:11 GMT  
		Size: 21.3 MB (21323885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
