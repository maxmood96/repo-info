...
```console
$ docker pull drupal@sha256:4e9c6da5e9bd525fecc619c7c741763532eb8e62f8e564242de3295e32126b1c
```
...
```console
$ docker pull drupal@sha256:6c26db07f1736b819f4904893b3968e27e15115a3a6176ab476c48db8b317fb5
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.9 MB (144921603 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:205d50f3b30527669519ecb72bc8d23e457b9a729f032e322f766a7b485bbd8c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 06:49:15 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:49:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:49:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7fd48956fd823a05fc3f9880cd0e4cf0a700d5b6cf6be0d78b0d66d96ab1f476`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f3444e0696108a61c7f0478855ce36403b762a7890d83e7b7a4d0938bd89988`  
		Last Modified: Tue, 29 Nov 2022 07:27:04 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:465a39d8f9be703fd7694d4fa6ca275ede8ff8eb83d3b52c1a15573dc4b31450`  
		Last Modified: Tue, 29 Nov 2022 07:27:11 GMT  
		Size: 21.3 MB (21324436 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
