...
```console
$ docker pull drupal@sha256:c09c66554b239a75855727d1bd8e31fa445c2fcc30c92091830f3a9d21bc84b4
```
...
### `drupal:11.3.8-fpm` - unknown; unknown
...
### `drupal:11.3.8-fpm` - linux; arm variant v7
...
### `drupal:11.3.8-fpm` - linux; arm64 variant v8
...
### `drupal:11.3.8-fpm` - linux; ppc64le
...
### `drupal:11.3.8-fpm` - linux; riscv64
