...
```console
$ docker pull drupal@sha256:df724f69012a54d96161f8f9303619ef631d71f2ea09e25743e9138b37454be2
```
...
```console
$ docker pull drupal@sha256:22b6f08cc8e5a1dad82466393c3e230c187d645362fa5766f8723a4e02c12b82
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30313241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:433929585c1f224b1d0b19c5918b5aa86f6071e26359684ef9a226687fe981ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 08 Aug 2023 01:02:12 GMT
CMD ["php-fpm"]
# Tue, 08 Aug 2023 06:13:02 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 08 Aug 2023 06:13:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 08 Aug 2023 06:13:54 GMT
ENV DRUPAL_VERSION=7.98
# Tue, 08 Aug 2023 06:13:54 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Tue, 08 Aug 2023 06:13:55 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:278aceea56e7654784f3d50bd7ce907890d1015976fc20f4748a6af30a638092`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf9c13fa21ef7bc7c715794edf04f158a79e455417bd926cd7df776cd1a7bbd9`  
		Last Modified: Tue, 08 Aug 2023 06:23:11 GMT  
		Size: 1.7 MB (1671397 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d54eedf7ce2fc1f310e8b306736e667357f0a178f08c93c75162fcd36fb69e2b`  
		Last Modified: Tue, 08 Aug 2023 06:23:10 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6e843ccc1725d1c0410dc43e0154b8187af2adb32adfbb2d71c40ddfa3d0e66`  
		Last Modified: Tue, 08 Aug 2023 06:24:35 GMT  
