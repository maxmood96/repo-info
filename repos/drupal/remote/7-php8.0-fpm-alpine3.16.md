...
```console
$ docker pull drupal@sha256:bc7c60550ed618290c582d193fa3010d51b8a588f7f90770037418226213d25e
```
...
```console
$ docker pull drupal@sha256:ddf9756ac293cdc624036a8b15165d1f9a87a918e1512a43150dde401b0976df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31472032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:945cb4a6170081a232c616501ec34d0f0010f8483e302b67f09aa397a3e99c07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 03:54:35 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 09 Aug 2023 03:54:35 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 09 Aug 2023 03:54:37 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5d0ef7dab6d0ca74f0636e25896a5bb29411c6e38998c3ce207154ec19bf3340`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1e2f512f66774ecac3d5eb2d2636553d2c625a493afbcb1794df07fee67b125`  
		Last Modified: Wed, 09 Aug 2023 04:02:07 GMT  
...
```console
$ docker pull drupal@sha256:fb21eb24c52831db85f840b73e80c2877526ea38295b16e7e569ea81e449dcea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30335806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:183acb120e767f08132d7b594174dfab04f7fcd53bd8841847b773af5ddd7c2b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 01:25:08 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 09 Aug 2023 01:25:08 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 09 Aug 2023 01:25:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2b543e2e326803bbc5214f88ea4833495da085fc422eb0c2d4a6563308b1eaaf`  
		...
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b6eb84ff848170d9f4cf080adde2c6ad61cc9d40612ab69e034882c3b26e59`  
		Last Modified: Wed, 09 Aug 2023 01:32:10 GMT  
...
```console
$ docker pull drupal@sha256:d95a5ea9ff3069d274087b8d89212ef88027ad2130bffc6011797b288cc9b6e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (32020590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9316452c81c615c0dd7eb04f1d04ffe5b419ec78272aa69f8db68f37d0b407ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 09:21:42 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 09 Aug 2023 09:21:42 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 09 Aug 2023 09:21:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a0124c06b8e957f1c07ab0ee31c70b0f7e9f63c67647846ee67ddcab80c0c0af`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53ffd88002d83ca386232fed02fd32a8962100cb7470fd37874d64aba1b4755f`  
		Last Modified: Wed, 09 Aug 2023 09:32:17 GMT  
		Size: 3.4 MB (3411143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
