...
```console
$ docker pull drupal@sha256:eb4acab2bd3b03883dc1a81714a523b1703aa70f73556f4dd83d10591d4f5156
```
...
```console
$ docker pull drupal@sha256:59f15a3868a61c84023814f5efe2ef4785d3b403f0327daaccdc740f34a4e29b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.2 MB (33204512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dc56cfe38a7d6b165419f91aca83d5fcba58476297d377a91bded46b6c93f92`
...
-	Layers:
	...
	-	`sha256:54a8269d4ed024adef967c62add069c4d813eae8e9001a2c14668ea41b7a9862`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c91cf84ec8bf6976da4ae320e4c3f7d89b198e174d6decb4d68dadf069a3b273`  
		Last Modified: Sat, 11 Feb 2023 14:48:19 GMT  
		Size: 2.3 MB (2345568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48edecb4adbe0af55a9f5861800b2a523fcac560c496ff5996fc72c47a86dd89`  
		Last Modified: Sat, 11 Feb 2023 14:48:19 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f91b3d9b236914daa5fdbd9f35931eddca372a275c9a35f658a951aa8e09be62`  
		Last Modified: Sat, 11 Feb 2023 14:52:55 GMT  
...
```console
$ docker pull drupal@sha256:15960bc8b98ea17803bede9d36ff69b19bff80d39744a36253fe204333755f71
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.4 MB (31393290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cab356ca4ba7da2af32c9a42f6349aa327fe34ea99c56dc0d3a46cf973b69bfd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 Feb 2023 08:12:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 08:14:44 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 08:14:44 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 08:14:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c7c42bc0876ed0504eccc6ce9127b6ed31b780742bd810a566049e711b5d44ac`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1199893c8b5da949733bebeef6b5b12706050661ca85d161ad04b2ed118af6b`  
		Last Modified: Sat, 11 Feb 2023 08:24:46 GMT  
...
```console
$ docker pull drupal@sha256:c59cc71fe322b2b685e05ff8744e58e7034aee55c6335fbff900cbbab5764a23
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30256320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b46d40bc54998b8312649055855859401b3e5aedbe29bcca5db3d5d3e5a51ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 Feb 2023 07:47:57 GMT
CMD ["php-fpm"]
# Sat, 11 Feb 2023 13:15:40 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 11 Feb 2023 13:15:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 13:18:42 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 13:18:42 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 13:18:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9b1effa3d2fb2e055d18910bf62d7a429a3c50ff65e40865af8fb241d46420ab`  
		...
		Size: 8.7 KB (8678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b504042ba95753b25fb072b595cb111ca05bf552842b6bded7747a4d116e953`  
		Last Modified: Sat, 11 Feb 2023 13:36:51 GMT  
		Size: 1.7 MB (1671324 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f53fac5592d456738c6a23adf745382ac0db57259e36e02e445f5483920cb1c`  
		Last Modified: Sat, 11 Feb 2023 13:36:50 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62b78f715ac750e084e421613597d1f5e6ca8143f1c2bbf3f49b273c4d5c49bc`  
		Last Modified: Sat, 11 Feb 2023 13:39:40 GMT  
		Size: 3.4 MB (3402489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php8.0-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:23a342e8738efbf4cdb35c8c78a75eaafe373a33d01ff3d1c700746836ccf735
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32195925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:727ae458ca134c1ba19dcc60731e59331174b3f29079c834277e34d177c32345`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 07:38:13 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 07:38:13 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 07:38:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8ceae3fa2c47e48c2b78af239f57edee4e19e2b6572ab15f233e03ef3369e002`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e65c821a99816c875fa72f5b5fb04650ab131b174e8047a3597ab5c109f15553`  
		Last Modified: Sat, 11 Feb 2023 07:48:06 GMT  
...
```console
$ docker pull drupal@sha256:e051c24bd9c0d63a4d35e8eeef66b91884efa0aaf53ca79b97601d125d1519ca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.6 MB (33643047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:618a1782d00c1fe8dbcfff9631603b58e95667753ec90d290396aecce2538fd1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 04:19:51 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 04:19:51 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 04:19:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:58bc4b9c7c9edaae1f3af60948f57da67ad3c252c037e51a3374e5a078617c4f`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d464f10c057d262c62e25ea6887779c88a19f1b84b9de4df2f995806fdc32e81`  
		Last Modified: Sat, 11 Feb 2023 04:36:26 GMT  
		Size: 3.4 MB (3402476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php8.0-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull drupal@sha256:4253228c814cda02e764c6e74361ca47f717ca47c28489f4fb4da535526ad37c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33486863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f7d965203e861fb887baeb88bf7026f719b6adbb48d8393b19c334450366a6b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 10:24:14 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 10:24:14 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 10:24:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ad003c5f148ee8ecb76646cb67a2255d7dccb47670c98845f6c3abeaac8f371c`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b178782041230ed43f0378a5e1b641c82e9f46a091bbce54b7efd3d4b19cfb2`  
		Last Modified: Sat, 11 Feb 2023 10:40:48 GMT  
		Size: 3.4 MB (3402789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:814b51159def0cfb5175a74cade56d6b59e264f7eec0d823b55925aab401b2c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31941872 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfd7d60002d1bedbb117dea0306e511f7cb9642727c1c7ff805d134bb74b0582`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 11 Feb 2023 11:37:28 GMT
ENV DRUPAL_VERSION=7.94
# Sat, 11 Feb 2023 11:37:28 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sat, 11 Feb 2023 11:37:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f05cecdf95d15f3b8c173444fc4f008ecd53d742f0703fa197d3cf060aa08eb5`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efee6b1a5243650fbb625b915b22906490beb40b4219a5a23383b8ac1c88c4c1`  
		Last Modified: Sat, 11 Feb 2023 11:49:05 GMT  
		Size: 3.4 MB (3402786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
