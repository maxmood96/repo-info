...
```console
$ docker pull drupal@sha256:1044d77bf78830730fe6d1be55506b47d5a8f81192b592b9c59df41e6269d638
```
...
```console
$ docker pull drupal@sha256:c31055c7f761cc508a032254c07973683dc6ea5b8c5c0fa97eef8cdd7d7a99aa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.2 MB (35154730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ad1c611867282d8a8407bc3c25411d7432adda4c83ed3e6ad4b08cc394c0d27`
...
-	Layers:
	...
	-	`sha256:3adb16136994e68d29ab997f21b4833823f8216337645295ec2a8d6d6ea5303c`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec95b50d1b0184c9df8cddf54ec8a9f77483fdb81faaf18ca2202c4e308be8b8`  
		Last Modified: Fri, 30 Jul 2021 03:19:47 GMT  
...
```console
$ docker pull drupal@sha256:8effda06e824c9e5ea38277f463d69bebc69530ae5c6006254cf3e3b6a439567
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.6 MB (33598841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e82315a2a4de4ff05224d7e67d12cc871adfe199e5f55234a8295bdad09ebcf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 31 Jul 2021 10:13:07 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 31 Jul 2021 10:13:08 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 31 Jul 2021 10:13:11 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1a7266bc05ccb8961f768f072af909a8ba8717027d88bd1ac05c7b7eb8ed3891`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57619e91f7ca18ddef0402bd59b45731d8c774b2ad5baeaf2450c59fd16ab87f`  
		Last Modified: Sat, 31 Jul 2021 10:27:17 GMT  
...
```console
$ docker pull drupal@sha256:733dd776c5b50aea0fe1f11e00dc55a42f2dc03863a085022998fed661cb60c7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.4 MB (32436819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fad42fc7e7c587bc24c42ce0751215d83c602db292b9428417afc754608d4ed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 04:20:05 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 30 Jul 2021 04:20:05 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 30 Jul 2021 04:20:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:07a4c40f11d1adc35860b1f69c530a5aa3910d1e96ac89a91f8164327b797462`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d08fab1e49aee427f2e074f3767ecd6f6c30474c4c93ce61bc471e9d897730e`  
		Last Modified: Fri, 30 Jul 2021 04:58:09 GMT  
...
```console
$ docker pull drupal@sha256:386746a244f8dc945111330b12c9ae7ed64703a26e911d82a174ab896f8ce767
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.9 MB (34852517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6924137192a85533d68cbaf2fd0b61ef1a260b2c1972cdfa14b0205fb7ab4c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b2d443e6c3878652fd59a62bb541646ca0c9f5cab7f690b48fb6f4314e254a5e`  
		...
		Size: 320.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:392d775af2ccfea6cd4f8c7e669c46e47da8c092f1a441def34467f5bd6dad54`  
		Last Modified: Fri, 30 Jul 2021 02:07:52 GMT  
		Size: 3.4 MB (3374017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f3c41d0a34369f6202917929f845a03302b0fe82579a38d714999f6a05035727
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.4 MB (36433429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88f3c26c2265db6dacfb74d0a8f9a617ad10bae79e78df171519dafc818fdf8e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Jul 2021 02:51:08 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 30 Jul 2021 02:51:12 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 30 Jul 2021 02:51:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:27100c0c3071702d5d7f21c05e2b161573e5d6aba263298588efaf1dfe9e754f`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11de284eceba0f8f4670ce4fb3eca8ea80f6ed9c961d0e02518600ce490bbe1b`  
		Last Modified: Fri, 30 Jul 2021 03:58:11 GMT  
		Size: 3.4 MB (3374017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:c064614f498e8a4073e60f30b009fa76ed617cac40f341cfe9b45c00501ea874
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34179777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33d8024d425e6eda88e06ed3145a9ab9214ec19701af3d0488f7673aeb6d1c6d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 31 Jul 2021 06:31:45 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 31 Jul 2021 06:31:45 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 31 Jul 2021 06:31:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:200f972344017450eaa2e316212b5693334d90f8f82b6610bc88ad9c6136ae86`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6058c6b3c39625abaa5c41c150f9090814f1fa7a53b4aea5a8bb92edaf677663`  
		Last Modified: Sat, 31 Jul 2021 06:41:13 GMT  
		Size: 3.4 MB (3374003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
