...
```console
$ docker pull drupal@sha256:2f3176389afea441e0871e41af9940104be218dd9845aee2c4457d9afa4c8d36
```
...
```console
$ docker pull drupal@sha256:fbdf26bdc91c60ad0cba44320c513c1860567b27f750f8f86e971c077ec00fa2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.6 MB (34569225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb1a656d2f3aa11803bba76d2c05f597c45ec829f706c35852da76243f6194e6`
...
-	Layers:
	...
	-	`sha256:2ee62c7a9abea04c4b296df689cb3ca01faeac5ca554e20778a5a2113753a300`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7939e1602f071953482250470504153c670f4686848991074c84d6315e753189`  
		Last Modified: Sat, 13 Nov 2021 15:47:48 GMT  
...
```console
$ docker pull drupal@sha256:22fd0fd231249b5c4a8e7a51b9853162b8e838d70a4066fa80bdb72d3d2b1677
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.3 MB (33253043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:668f7d1989d232dbe1300c34d1f0a2892614045eb696e28b7fec9b2154a53ea3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Nov 2021 14:39:24 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 13 Nov 2021 14:39:24 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 13 Nov 2021 14:39:28 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:947d93914bd6d80806dfeda8e230065f734434ea3213a9fa1730687af9ecf784`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4886807b9733dcbd2d503ff3b072c0e520841eac828361ab173452842a10e50d`  
		Last Modified: Sat, 13 Nov 2021 14:53:14 GMT  
		Size: 3.4 MB (3374014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0a51c705153a4c846e7bab7b1c667165d6167bd32785640696fc0edfdbb1ce59
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33828290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac4bd0f731f42773a95ee7183f077fe0762e8387c0047ffa0be4bd7d219b98f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Nov 2021 06:28:53 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 13 Nov 2021 06:28:53 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 13 Nov 2021 06:28:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c3a9a639d94429103befbb498058cb2f0728e5c9207f0e78291ce883d4718b4a`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68a9186356d043015264e9f001466d0f16bccb624b3affcfcbe92d60d094f95a`  
