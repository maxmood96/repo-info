...
```console
$ docker pull drupal@sha256:02c2cf291ec11779c0b46ffd414193ae84f54f52ced18957ca643f05479ed950
```
...
### `drupal:8.9.7-fpm-buster` - linux; amd64
...
### `drupal:8.9.7-fpm-buster` - linux; arm variant v7
...
### `drupal:8.9.7-fpm-buster` - linux; arm64 variant v8
...
### `drupal:8.9.7-fpm-buster` - linux; 386
...
### `drupal:8.9.7-fpm-buster` - linux; ppc64le
...
### `drupal:8.9.7-fpm-buster` - linux; s390x
