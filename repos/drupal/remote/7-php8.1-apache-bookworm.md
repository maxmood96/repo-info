...
```console
$ docker pull drupal@sha256:5ff60542336dcd9c4147a3d2d1794f43c6d6e02255be46deebc886ff7019b747
```
...
```console
$ docker pull drupal@sha256:dae3bc8983aad58b7d5826b9b0df73d4ffc0acbac18fccadbb36b85e799b6330
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.7 MB (176694445 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d66e626307230a0f2d6988b38d2280a53fbcf9565f4aa6de51c9c5cd09d1df0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:01:39 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:01:39 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:01:41 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c2a10be11eb9b32b05f8fb7d27f8504d442045efb63bdf3e0855058d2883bf57`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c371505ee4cd966047afcb78bce495d13aae335dddb8e1ce996adf5087939640`  
		Last Modified: Fri, 23 Jun 2023 00:21:30 GMT  
...
```console
$ docker pull drupal@sha256:ea731db1bbe823bfce0b0e8e8a4b054a986516d1cdbd196bee556dc24ad079b5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181614030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:311eb7627f629e60993a41aee4701f5964fd99130ec46e154431bad03e4c2318`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:02:48 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:02:48 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:02:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ced3a1bd898d22439f8a991e7577aa95798db36f6bdb4109d3b402b471afad9d`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45db91f674942716c45de9e809d24466375686a0af8639a242f8047b5607ee89`  
		Last Modified: Fri, 23 Jun 2023 00:26:40 GMT  
		Size: 3.4 MB (3410777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f4dd1cf0b28ddbd983512249b22d093f5bd85780fddaedcbc24c7cdfc87725e1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187008082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32a3694ac93fde4518ec0d56652c679e05a8cf6d5d559f64d745b92d718850ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 22 Jun 2023 23:52:49 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 22 Jun 2023 23:52:50 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 22 Jun 2023 23:52:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:332cbec3c1d426f0111c540070dcd56c7cb6ebe1c94a4d1fbac28af32dcede45`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28b06ca9ba7d1ac3bd0f306d5a3f3e02d300e2f35d1ff0d1e5af5a5dc6834909`  
		Last Modified: Fri, 23 Jun 2023 00:32:47 GMT  
		Size: 3.4 MB (3410777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:979455318953b0549d30663e1bdebb19a027521c4f7bff4453a522a4927b7b29
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155854059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44176a484d231a65188b490cc8fcabb92b6a975f47b63f1c21ae5853501a6f67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:05:29 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:05:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:05:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f17fd4c781ef7ffc193b555d8d0129e208236b29d89a2af7c9eb92004c2b72a0`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:827999f7d3826ebe78dbffa6fca38104cb8d464e09811e6b808a5ad97744a20a`  
		Last Modified: Fri, 23 Jun 2023 00:12:36 GMT  
		Size: 1.7 MB (1748694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3d88017c224db0a044ed1c59db6a0a368106fcb9ca5ab994e990fa097321fec`  
		Last Modified: Fri, 23 Jun 2023 00:12:35 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:346ce2af5ab1ee9a10d2b9d30026102e91d576eb0a683bbe59af892635c107ff`  
		Last Modified: Fri, 23 Jun 2023 00:21:04 GMT  
		Size: 3.4 MB (3410782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
