...
```console
$ docker pull drupal@sha256:8643f9c354823445afbfdcad1d2ba930ef35ebfddbbb768cc1d831a2742e13e7
```
...
```console
$ docker pull drupal@sha256:adfb303a9d0ec7ceb1405f45410e918416c64f673acbbd5de4c7d81a4e8f30b8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.7 MB (182705779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ff0ae1291cc6d1fca35511f321d4f27fcfa62987447d4a691c773a59dde88e3`
...
# Thu, 12 Oct 2023 19:56:47 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 19:56:48 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 19:56:49 GMT
...
-	Layers:
	...
	-	`sha256:fa88a130c3461a3d0cf8b77adb139bd3777193ed5ffec73755d882fc3ef8cc5d`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:687be619ddcbe659a3245bcff4abff1f7e112a9472282a83be1e4f89ceef3f87`  
...
```console
$ docker pull drupal@sha256:224ab4f1c658e64d8a88e8dca2b16a640cae728b1d1415993b25e19e4314f743
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.8 MB (176773202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82ed1aa345b1c5442d8f84cc2460225b2033835a174e819774d8c7df5a377081`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 17:17:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 17:29:43 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 17:29:43 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 17:29:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7c1ed0f32254dc0acf415cff78852c183eafae58334631788b37ec44a55c1c26`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72c996f97ad4ff503477defd0fac6f994e5e624a08c1c4fc5a0bc5ec0f0ef913`  
		Last Modified: Thu, 12 Oct 2023 17:47:32 GMT  
...
```console
$ docker pull drupal@sha256:784ed5b051d57e8f470ea0fcbb8ad173ddd690bf880ee346e6e68558b785a4a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181693094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb0eacf9970452e6580df818020b48572040cdd68325490146bee3ed9e847186`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 16:33:14 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 16:33:14 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 16:33:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:900edfd939eeb401f1d8a40c07f3e024bcd02d9cf48a31f456f0ffc5e5c39807`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:298ffb21514af50e7dd8e98a6fe242891633c03a24c456736edee193f886a319`  
		Last Modified: Thu, 12 Oct 2023 16:53:04 GMT  
...
```console
$ docker pull drupal@sha256:846cc8641890bec88f315fc89b2d76c325d7e3a9c4cb1a442451bb9934fcf46d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.8 MB (156802054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b724db1ac19ba4ad32bf5acba248862c9874d0e4f8ab8a7cffe24e556f073a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 13 Oct 2023 02:14:11 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 02:14:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 02:14:20 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 02:14:24 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 02:14:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8f86ec0edbd6839391a6cdb2a613c0bed67df2b096a7caffab0a73e73e26bc4d`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:733b1fa65ff0e70014588676a4ddbc48d4b5ee8aa344247f7c720158eaa0efde`  
		Last Modified: Fri, 13 Oct 2023 02:31:35 GMT  
		Size: 1.6 MB (1564402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4b79e27be245d82ea965ae65cd6d58dbb245c2380981c33f8f69cc8d98b74fe`  
		Last Modified: Fri, 13 Oct 2023 02:31:34 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67a1c5337f4c4eb9d959a688974b93c2524c024bf144de553d163e48830993a2`  
		Last Modified: Fri, 13 Oct 2023 02:31:37 GMT  
...
```console
$ docker pull drupal@sha256:9ebe55624f63a87965f51fb6ab649ef3dd58489d2df3ac2a6f4144ffc85375c8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.1 MB (187077935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46a3a139d812c9cb23454528f6fa138a917291f0e174259e58b5194b5b67a927`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:36:37 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 21:36:38 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 21:36:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:db1856fe187cabb292aaa1728df9000b2a9de8f24ae3a1a3d6f8ad75745407ae`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e6fc7ccf40205b24e58480f2dce91ea4e1deff4cd20292f5c3371cbdc0fe2d9`  
		Last Modified: Thu, 12 Oct 2023 22:21:09 GMT  
		Size: 3.4 MB (3410787 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a13d462a845e9e648b367ec2286f480639df046afa210259010a9ae9d779ae46
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155920618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e52c13708c442dd841c95efb19cd06a5f28cb28bc9021b666f349fa66c5518a9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:29:24 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:29:24 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:29:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:049276659d002e655759248a1532f5f6def742fd030e03756f71fe1033dbbb94`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3538d207d7605d2e567ce14f7078ecc092bd0c80ca02259e9985a953cfb52fe`  
		Last Modified: Fri, 13 Oct 2023 03:42:53 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
