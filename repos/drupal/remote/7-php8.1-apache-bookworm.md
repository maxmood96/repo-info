...
```console
$ docker pull drupal@sha256:3390a058fff125a1adf49e29976f83914aaa5e2826be786d735057582295a2a4
```
...
```console
$ docker pull drupal@sha256:ce3c8731b92b2d50961fe4affc1735f6c6e4e1cc921a1be015c71944093c7c79
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155936051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7169feb3c0d4fcb881c1edaa877c40241f873a1644a4750cda7166ebc56c838e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:c6c48ee210c397b3948a8be423b1295c74149eccfc6967945f9f3785b42d76c4`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a8371fe5ecd22caab2c4e0b4bd31d9c6a70fad01d9bf73c6083370cb2682cdc`  
		Last Modified: Sat, 30 Sep 2023 04:40:13 GMT  
		Size: 1.7 MB (1665223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6801a1a26be3bb404fb2474d831fc4600a3ef72525cad0712fcb2145d9ba63dd`  
		Last Modified: Sat, 30 Sep 2023 04:40:12 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f18ee20b48e1404c1e6a6249c0e78f7e893929420c6f15428da88d86b1c90d4b`  
...
```console
$ docker pull drupal@sha256:9c60acae82c483adad60305431a5ea561686080e84e6bbd74566c2504e9f8e74
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146729560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c46369363b89938907fd1d9465f2b1dd6f76276a2992740ce9560f1d2f93f9b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:08:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:19:45 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:19:45 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:19:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:adb8c178c95cbb61f2a11e5e45d6c07d0903def8b56daa457447d28bd2d4040c`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4df7e1edc3c912ab2ef41388d4bd18e413069daeca5951fc6d762b9cff4e87c`  
		Last Modified: Sat, 30 Sep 2023 05:44:58 GMT  
...
```console
$ docker pull drupal@sha256:37534f61fefb4a2768d1608e7eed3a6ab8c25f5bf3a5e850ccd0be532ca06741
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.0 MB (157046375 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d60783d5264ef1376e2720b1ab570e97771d8b63cc7df30e0c4ad95dd048da1e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 21 Sep 2023 22:29:40 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 22:29:47 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 22:29:50 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 22:29:54 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 22:30:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f10cfc97bed97096499389cc0b83bdbd6308a03b77cb423e8b40b308f571edaf`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c7b46c15d4c3fa6437776a0e8c09fc441b4894f6e7c3dc32dc3309c815ee91a`  
		Last Modified: Thu, 21 Sep 2023 22:47:06 GMT  
		Size: 1.6 MB (1564302 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:586fba768901ba46404a0e957b2699b0ce214eb138959ddfb216e08189fbfb50`  
		Last Modified: Thu, 21 Sep 2023 22:47:05 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ff506de1f765befe44183682c405d77193c1377e4bfd835a81d254b8c325289`  
		Last Modified: Thu, 21 Sep 2023 22:47:08 GMT  
...
```console
$ docker pull drupal@sha256:7550eb7082807f541a652dde84ceafa0beefaf0be2582956ca3e44a74cf24610
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.1 MB (187106485 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e57fa1567fafafe5e6de6735ae04b1e9875d3787511e730b063b920e3ecc9f37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 10:01:36 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 10:01:36 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 10:01:38 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f206efbbbacd41a3020b74d4c5235bec33abbb686b3fb16369a16f7f925321e5`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:742a3f8c1298d12333af47ef10496f2f8fe01d4cd64b781d4ad0319d74edaed2`  
		Last Modified: Thu, 21 Sep 2023 10:25:27 GMT  
