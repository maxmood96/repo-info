...
### `drupal:7.96-fpm-bullseye` - linux; amd64
...
### `drupal:7.96-fpm-bullseye` - linux; arm variant v5
...
### `drupal:7.96-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:7.96-fpm-bullseye` - linux; mips64le
...
### `drupal:7.96-fpm-bullseye` - linux; ppc64le
...
### `drupal:7.96-fpm-bullseye` - linux; s390x
