## `drupal:7.90-php8.0-fpm-alpine3.16`

```console
$ docker pull drupal@sha256:3b477dbe97bce824b05eab1ceeb664c6dc8b34838aef4bc7ddb226cb254cb18e
```
...
### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; amd64

```console
$ docker pull drupal@sha256:787346924d126ed5e24e8d1b7376d21b30dd398e1631d41f5863e88f57e41187
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.2 MB (33235048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa49f7727745ef72f69f78afb494e3d407ff9272cd82b7dce5e1e61776be9257`
...
# Mon, 13 Jun 2022 23:22:22 GMT
ENV DRUPAL_VERSION=7.90
# Mon, 13 Jun 2022 23:22:23 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Mon, 13 Jun 2022 23:22:24 GMT
...
-	Layers:
	...
	-	`sha256:c7c980f85a659a78d50cb6475627e1caf579b8db1487d2ade819d5dce30015b1`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8feea8d842e945fbfa475a8ff6c1fdaa13ce7668b9627a6780b9f17ae7a6e014`  
		Last Modified: Mon, 13 Jun 2022 23:32:12 GMT  
		Size: 3.4 MB (3388791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; arm variant v6

```console
$ docker pull drupal@sha256:a9f731e85ec85fa577f50cd06fc6279515a48fd05c72f64637c88a330617bc9f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.4 MB (31426722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62fbbfd7680e5e638161101bb73ec34df6fcc61492a754c12690bf5c51fe0d4f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 13 Jun 2022 23:53:49 GMT
ENV DRUPAL_VERSION=7.90
# Mon, 13 Jun 2022 23:53:49 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Mon, 13 Jun 2022 23:53:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:82eab53bdb300c118cea7139f67691ab99d9b9a999f0db33946652235ea38a88`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1363ef54f28ab91843693fdb52a486b7977696a9ada5158322f1fb8a1ed6448a`  
		Last Modified: Tue, 14 Jun 2022 00:04:03 GMT  
		Size: 3.4 MB (3388799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull drupal@sha256:34b10cfcaa0c98fbdf7c3887405c0950e19d8d2c43511ad90dd254c83085af86
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30293464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e7a711bf860b5fffed57de218f048b0a01df58e9a753d2d5699d6bb640d56c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f02b2911bbf551b197d83f775e6aed6edc0d5fd64f73c6ed10b1cb59eb7066a4`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ee2484ec0dff7ad441d957a19878a0b717c4d0af16e338ee60d6ad1874cfc0`  
		Last Modified: Tue, 14 Jun 2022 00:45:16 GMT  
		Size: 3.4 MB (3388797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:364eaf57d384deaf6a1f48cfb2f1bcb6b46fe604634fbeb3fb415069eb7a807c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32226875 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f1ed13abb8a28f97019d24716288de0bfb7500f3ca01abdbc71bb3dc4bbd607`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Jun 2022 00:12:15 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 14 Jun 2022 00:12:16 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 14 Jun 2022 00:12:18 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:65c4d04162d5a97156c4cb2f684b57a076a101de6f905b5c8270e1aa52ac3db2`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90493ff39c9ed00e5fb1c4acd9d7d59be0199384d5ed519a80d1dd5c37f03e05`  
		Last Modified: Tue, 14 Jun 2022 00:27:56 GMT  
		Size: 3.4 MB (3388518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; 386

```console
$ docker pull drupal@sha256:8f78da39c3009baf1f3d6b64cdd12034fe40ba3144aa233e582b3a46093ae81c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.7 MB (33675546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c96b0852dac2e0065154626fdabfd3383b2aae1aa0a9d17e09fbee711afb10f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 13 Jun 2022 23:44:43 GMT
ENV DRUPAL_VERSION=7.90
# Mon, 13 Jun 2022 23:44:44 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Mon, 13 Jun 2022 23:44:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:44516eb3f43bd710ad58715ac4b6774eceb8c552d666057ec3a25ad176311746`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:884253498c544c08ac98e76eb9b5f172afb99520f902de358e0f19030c6bfb9c`  
		Last Modified: Tue, 14 Jun 2022 00:01:38 GMT  
		Size: 3.4 MB (3388519 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; ppc64le

```console
$ docker pull drupal@sha256:c890e3d5058a9befb88744243d3777ec5837f7c6b2a5cbb903f294a9b5cd3e41
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33510315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:318e4e81613cae4389874adbb5031fcc2f80afc27460d670eba6d7c02a236437`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 13 Jun 2022 23:27:49 GMT
ENV DRUPAL_VERSION=7.90
# Mon, 13 Jun 2022 23:27:57 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Mon, 13 Jun 2022 23:28:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fec6e5d94be648997bcefd3e41933a2071884b581198aa15f97be71f2a161b2e`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b73481b4042929a0af47cc5e61db287622b061170beddacb3bbeec63deb3dc8`  
		Last Modified: Mon, 13 Jun 2022 23:46:32 GMT  
		Size: 3.4 MB (3388793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.90-php8.0-fpm-alpine3.16` - linux; s390x

```console
$ docker pull drupal@sha256:1634ec3a92a22fbda89798f570869aee317ebc54ef25071a5ddd7e236444c2c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (31973967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:192c2a50b3c622de2a86eaba83534e8531fb7c7cf4ce214d09ae7b1f6af95b8a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 13 Jun 2022 23:50:04 GMT
ENV DRUPAL_VERSION=7.90
# Mon, 13 Jun 2022 23:50:05 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Mon, 13 Jun 2022 23:50:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e52b7e36bed9b52bb68994adfb103317e41ee7c8f5ef4c9eaac7de147b551aec`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21a621131187ba4ec0e23ce5bae77a494c870abf39fcaec4dd85f1a7674b3bf2`  
		Last Modified: Tue, 14 Jun 2022 00:09:02 GMT  
