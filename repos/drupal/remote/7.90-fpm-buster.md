...
```console
$ docker pull drupal@sha256:c16d2a24efa5115f0413fb125bafde41b3b36d9935b62c6b4d2108ff352d5776
```
...
```console
$ docker pull drupal@sha256:d2d8f6c509202cdff3d9a374038db6bd3a8afffb40e6d95c5589887b5b474c8a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.0 MB (121030063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14eae3d714164ff12dcbc0464293db940de0f2332e1d79f6d93b37d2097b4e86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 14:53:01 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 14:53:01 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 14:53:05 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c319806f048b4b4baffffc7973520ffdc34e899b2d5fa3d70e208c4a0170c702`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d891dc4bd62c4c6fe095add6cb1dbb7eb5e4caa44182cf15d3c9686a4acd5530`  
		Last Modified: Wed, 13 Jul 2022 15:54:26 GMT  
...
```console
$ docker pull drupal@sha256:ddce00693b53c921b79cdcd443513db9cdba2d6f34fa52823862f22760f906ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.0 MB (127001802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9e211bcb9c816168758f7c425783e494c517e1c8200b24d4ef4de410d581116`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 14 Jul 2022 04:21:03 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 14 Jul 2022 04:21:06 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 14 Jul 2022 04:21:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b7e73b4b613318944b776dff68e2e25c170ffef2b4a95df67dfe3b92a91bb094`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91086f039d96cfc39ab67f002214d8b6a90c68b22451a7be819dd9dd4457a3b5`  
		Last Modified: Thu, 14 Jul 2022 04:26:33 GMT  
