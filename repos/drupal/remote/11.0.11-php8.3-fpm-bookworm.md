...
```console
$ docker pull drupal@sha256:16bd583aabf7b4eaf8d55076a24f3d6e97d5b557afb229089e8dc68dcd697fff
```
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; amd64
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - unknown; unknown
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; 386
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.0.11-php8.3-fpm-bookworm` - linux; s390x
