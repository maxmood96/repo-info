...
### `drupal:10.6.1-fpm-trixie` - linux; amd64
...
### `drupal:10.6.1-fpm-trixie` - unknown; unknown
...
### `drupal:10.6.1-fpm-trixie` - linux; arm variant v7
...
### `drupal:10.6.1-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:10.6.1-fpm-trixie` - linux; 386
...
### `drupal:10.6.1-fpm-trixie` - linux; ppc64le
...
### `drupal:10.6.1-fpm-trixie` - linux; s390x
