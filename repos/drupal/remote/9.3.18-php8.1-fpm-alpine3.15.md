...
```console
$ docker pull drupal@sha256:cdfe351019820b31a384b577a8beefb61b841391ae0ff713e32d73785ded75d6
```
...
```console
$ docker pull drupal@sha256:c426748d233ac529400d434fd83f88e3a9cfdfecdc10f20c193aad68da6be502
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.3 MB (55284035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60bab48060c417c4d1ff07cdb9ae6350a346e65e1ab8f48564a844012cde5cdb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 00:56:40 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 00:56:41 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 00:56:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 00:56:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73ef2fadaf8cc5bea460fef32e073154b0eaaaad0f65dc68e57b1904ab077ba0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ed3a2c233865d3fe59f0b3db6ea80042dca9251fa5541bb344193a0e2b60a05`  
		Last Modified: Tue, 12 Jul 2022 01:17:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c36b7a03f9a16ab00f661bd80ee3148582bbe03375b9ee866fe0c0148e57d18`  
		Last Modified: Tue, 12 Jul 2022 01:17:44 GMT  
		Size: 21.2 MB (21207941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
