...
```console
$ docker pull drupal@sha256:6c144141236ad6d6d5bf9ffef684e8a1c02b9421d042f533ff97dc86fea7ac41
```
...
```console
$ docker pull drupal@sha256:7e4fddfbb5f8049aa349d87ce0d921ab434c07caf02ee4e45c961e78c0e10fa3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.8 MB (54806372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2403657f80d4849592d7efed169617a83e4e0a05025dc795291db2759b0b55a5`
...
# Tue, 12 Jul 2022 01:32:13 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:32:13 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:32:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:32:25 GMT
...
-	Layers:
	...
	-	`sha256:26fa39d578b94f2a3967b23e45819ececc17fff24ed0f4393f7d55bd11fbfdf3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16de3b531297be5622386420462ee316637ca725160b79d94bc7149f5c12c66c`  
		Last Modified: Tue, 12 Jul 2022 01:43:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43e8daa67738545f3fe5c8a841e3605f44a6abdb0184c617cee99bfee2516bad`  
		Last Modified: Tue, 12 Jul 2022 01:43:59 GMT  
		Size: 21.2 MB (21208467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.18-php8.1-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:c979aa29a472b40d11e1469c880b1fa08a622ee0a69ed68fbb72667a238d9ad6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52660051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:006c2017406ddeefa35849209944cd95f749044e6e41d395e383c7754ae04e89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jul 2022 23:23:12 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 00:53:52 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 00:53:52 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 00:54:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 00:54:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2690a11c9988a2c6db3790694736b4a522131974451705440e7bc1cb9618420`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbdd34e2d6ad26681d67a4e911684f3414e9de181f60008854078ebeda55a57f`  
		Last Modified: Tue, 12 Jul 2022 01:08:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78210e77e68382cb17db4dc6911df13e2a5883a058e2e789696eae2dc777f373`  
		Last Modified: Tue, 12 Jul 2022 01:08:54 GMT  
		Size: 21.2 MB (21208425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.18-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6a16020d9bc6fe6be40236f90dd3a30f3dd44dfe453816e4638e3f2e1d60c6c0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51373578 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd96765a16f771f0fcbd107b38e8ee56cda5ee54085e515fc0d70340ec70679a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Jul 2022 01:35:22 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:35:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:35:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a08d5cef6d025fc77295c83fdd86ee9633581b9dda0bdca50ee19ea3cec9e364`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e78e5346bf34a68bc6985b4c07a3ac13c4db12c10650298b6730ed8b9ced89a9`  
		Last Modified: Tue, 12 Jul 2022 02:21:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9493096614d25f00124e7e4789aca4867bf5b62b634f33437d2c48fe4fc3c2a`  
		Last Modified: Tue, 12 Jul 2022 02:22:13 GMT  
		Size: 21.2 MB (21208387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.18-php8.1-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ca2139ad8d896552c1dbf6dd95522d4c6f0e0b0bfe171166573cbf6408a5daeb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.9 MB (54875821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bdb3e18f6c7fdcd72f368e548681b0ae747272168bd75b4b19274c527e15dcee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e5c448ef9152c427bfc8033902ec048aee64c8f14a21f88aee62010f3c48664c`  
		...
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb21dcac09fa88510b5950be6b9677140af926e5816c0b92432d63ba50bb5082`  
		Last Modified: Tue, 12 Jul 2022 01:18:57 GMT  
		Size: 21.2 MB (21207983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:bcdfbd8ed36842a1cdebea78b42a413845883442b708d4fae0b3d93d32e98f42
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.0 MB (55020845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56fc724f53fb729d14d24ef1100fbe28d7ab7c618340a9bf837adf39a5ccc76f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:59:36 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 02:00:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 02:00:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1a3200cb857713144fc4c52939125df8a47b97b9e1b70d5064f58d7237a46c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e43f86f02e139d3fbb3d3b4165712421e3393835eca7f83a2593ef77c51f24`  
		Last Modified: Tue, 12 Jul 2022 02:39:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3f44e5e338424a37918da3a7b05b95d3273aebc47b55528ff1f53ea5b60b81e`  
		Last Modified: Tue, 12 Jul 2022 02:40:50 GMT  
...
```console
$ docker pull drupal@sha256:7c1febb33f9b2e604b12a2564e37359214f194352067432930e59b6030b015de
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53241234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26cdd4843f257e667bbe97f91215a039d7cfddc468307963f8c69dbd4470a64a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jul 2022 23:49:25 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:07:52 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:07:52 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:08:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:08:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:778a735fa1857f9682845ca350443a886c495d5e04846aab18764b7a2e66cf15`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1338be713551f0104d5a1dc1fe97a4fd0d9cd6526a0d1ee53eaa6130853bcebf`  
		Last Modified: Tue, 12 Jul 2022 01:31:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d8c387709f7cb3affed640f0499f4c2e92c3476209f561afc6f36eb318ee1d2`  
		Last Modified: Tue, 12 Jul 2022 01:31:53 GMT  
		Size: 21.2 MB (21208445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
