...
```console
$ docker pull drupal@sha256:c8ab5434e4ff2534c25afbcfb3e6b053fe70444a5349d536317d150d5fb9cfdc
```
...
```console
$ docker pull drupal@sha256:c0aea2ea126b785df33005adae8ee2aaa4d10ff2680c015e1d265c03df74dc17
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165864569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbded932f45a190f8fabbf96a46fb7c1229804b70f2be06727eca788b81a9200`
...
# Thu, 12 Oct 2023 19:57:11 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 19:57:11 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 19:57:12 GMT
...
-	Layers:
	...
	-	`sha256:68ab36bcf583485bf89c49176802687658d5711825ccc735d1b7a7e742c22283`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75abb1f7f3588a5270ac85e9fca3df917d41edf7637457c5e03f4e9701dede41`  
		Last Modified: Thu, 12 Oct 2023 20:17:17 GMT  
...
```console
$ docker pull drupal@sha256:7b3fe6e9b107857435f00bb629ae67fdf07788feafc4dc79adece572084ca215
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.5 MB (143500665 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a5416475a6de76e74441fd427d344a88921ab81b0bce9bedc3dadee98d67aef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 12 Oct 2023 09:15:03 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 12 Oct 2023 09:15:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 09:15:04 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 09:15:04 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 09:15:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e041bb1a20ff0e6367900a4fd7bca6bbee61102bc2d0e028e9569fae186c9130`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2239972e1d4cc425412214a56cedbdafb93cd2e888310ca05fd8aebb5df364c`  
		Last Modified: Thu, 12 Oct 2023 09:18:03 GMT  
		Size: 1.8 MB (1772469 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6ba93326df2e5a9c45897716265c4531c569d0781e0fd861475f4c16b83d6b0`  
		Last Modified: Thu, 12 Oct 2023 09:18:02 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0666c569a7ed5d0e92f0b548fba276b166c64f0537d3cd9cd52286cf6480e95b`  
		Last Modified: Thu, 12 Oct 2023 09:18:03 GMT  
...
```console
$ docker pull drupal@sha256:683c9098aee4ee391834dc5e9528810640a730993e7c9e7a3407622864c419e6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.9 MB (135869114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e878503eccebf4e81aa04d77cdf98cc3639719850a79d5f69b17292bad8d8715`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 05:10:30 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 05:10:30 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 05:10:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:363fe7d65d7fdce95bc139b9dfd9afe160a924bac93c181eba6bf000b18ae929`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b2ae03dad80727fb61cac2b425287b98d7f8eece38325041d61ebb6b63ccca`  
		Last Modified: Thu, 12 Oct 2023 05:35:16 GMT  
...
```console
$ docker pull drupal@sha256:50234f6387c4322dc958a3472ef498f414b4187826f18165d7d7319672a87f2c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158872457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:759b348ce7a7024107f0ad1a26f7bdfa345512905ecbb1f43ff779ff94e1214f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 Oct 2023 17:27:13 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 17:30:00 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 17:30:00 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 17:30:01 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f1cebb6dab06d5d4b03d2c36561211e4220ab070d0dc95363eca391d4d1739a0`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2a9dc9f8d40c5c9b07d6159fc80c0de3930c40aa0e74a9333c86c24b432515b`  
		Last Modified: Thu, 12 Oct 2023 17:48:42 GMT  
...
```console
$ docker pull drupal@sha256:1be09e77a70f3917cdb8d297e26e24cf51ad7157dd8a47c72f992a45475901dc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168453704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ba442aecf98af3eb37b7910a02ebee7150619078d12335cfc1f67d8a6e6d668`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 16:33:34 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 16:33:34 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 16:33:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a766868218f49a12ae9ee48e77cef4ee9149cb08ac5eeb10f03ac4b34bd2dc43`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad87b66ca07e02bd43e8e20bc3b2e650343598989c0a32b180ae250b3b29d501`  
		Last Modified: Thu, 12 Oct 2023 16:54:22 GMT  
...
```console
$ docker pull drupal@sha256:9ae1aae1005acd1478b56235968edba44497b0802bb219e346e2fe605790e42e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.4 MB (142426883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cb4b4c3ed04c1366d87fd93ef90b37c5d8b496ad7329e431bf82a5262c0f237`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 13 Oct 2023 02:29:11 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 02:29:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 02:29:20 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 02:29:23 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 02:29:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7b8b3127172839f480ef5fa383b9f1872fc83835db968b20cf2f203d45f200e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8092fd730c22702719c787d1490cb647582e87e4d821946e7cc8b4e05820cec6`  
		Last Modified: Fri, 13 Oct 2023 02:33:13 GMT  
		Size: 1.7 MB (1666139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:898a88cc73205ede881e34108b507e3629a2008ce95b704e08bdcec578b1684a`  
		Last Modified: Fri, 13 Oct 2023 02:33:12 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca855bfa9aff77a4be1385daba3e23d510db29fe0299ce5ffbe0294a6e9962b6`  
		Last Modified: Fri, 13 Oct 2023 02:33:15 GMT  
...
```console
$ docker pull drupal@sha256:9d66bb90e868c52883634f1a08329acb7ac1e0a7abd8d52b3f8915583db386b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165643893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c7b8f8296f44dc8cd4975af4121a6bc6d419d912d8637b218e92338d1fe2acd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:37:29 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 21:37:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 21:37:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ad808e31c75ec30c5992ccda44049c61c3928626d2ca7b70d1f9576d595ee93e`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41f80db3556a0e60275fdad228a5f6e43105e3b3ad973097e80766cf946252f3`  
		Last Modified: Thu, 12 Oct 2023 22:22:36 GMT  
...
```console
$ docker pull drupal@sha256:db62c0327de9dc99d5936bcb04051460b0d2581b5b5313184e2da3534a6f9cea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142785382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfff869278d5420166dce5d91803230940808227c93323467b4cfccd67c7f35e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:30:19 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:30:20 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:30:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0d3f1fbfe417472fd5bc2982053f79a3791092e4a6bbf355cc64fcac8802a466`  
		...
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c0d213883a3d694af8b727cb7f723c3557228522859f328cd1cdc0717008ffa`  
		Last Modified: Fri, 13 Oct 2023 03:43:41 GMT  
		Size: 3.4 MB (3410788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
