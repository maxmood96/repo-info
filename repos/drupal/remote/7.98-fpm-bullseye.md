...
```console
$ docker pull drupal@sha256:4daef3b28cab059695e398cc407dacc64888ffed299d5e651208468d83d1dadf
```
...
```console
$ docker pull drupal@sha256:46cab1e377f98d8cd5570d7004851e2c05b2822797dbf86a17a6bb457c4287ef
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165864736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f40e9fabe82fda2d7bdc0c05688e7992f10b230b17100442f7d1cddc1bf8cdda`
...
# Wed, 01 Nov 2023 19:35:18 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 19:35:18 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 19:35:20 GMT
...
-	Layers:
	...
	-	`sha256:9b97a3d44942ee3e99eb64cab318eaf398a8f7a0ec9784bf31674f89ae19a528`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dacd73fba51b81bdd487a0c462a9606e1f82bca2ecd54c902d74063aa200b55f`  
		Last Modified: Wed, 01 Nov 2023 19:54:04 GMT  
...
```console
$ docker pull drupal@sha256:0c4a9112c9f3bc5c21eed900d465db650d92c5f606443c03d9075a42b519ab46
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.9 MB (135869009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dac1254f0309c0a9cf5f1c164a1a49f94c9395c051026d4c0120fd85ab947186`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Nov 2023 17:49:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:53:25 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 17:53:25 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 17:53:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:089cb10fa12b2647ae4fd608f0e6b671fe12f6cbef34481c89b85222d5e4f650`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb5292781fbda3fa31c2d6f62637662b8ccac19c952ce41b64417a2d82b67df9`  
		Last Modified: Wed, 01 Nov 2023 18:17:23 GMT  
...
```console
$ docker pull drupal@sha256:fc6d378c982dbb699fbc052a53daa6f1730305b067f7074a913deef6a4fef16b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158872442 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73e1f3928796a5efc06a26822d2334a92c581740d98b0aec5e7079e41fb43a38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9d42c4323b2a3e902415641e0a86a11487c629d3c403e1099e971402f4333361`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdb010522c248fa519ab11e93b51d1d2067f7ab4432f2bfd3fda0f71fc5a83e5`  
...
```console
$ docker pull drupal@sha256:a2269b689f1141763e924967c2e49f56aeb5ed3a50d11000d5b7cdfb2136e84b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165643558 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4482a6cbef0d6008b14a35022ab9075a694e600a4a6d9577600edc8c55655129`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 16:19:25 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 16:19:26 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 16:19:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b218a770da19b012c8d6acc41ce283d6241abf9f54e093100e380c46dd16e1e4`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:928be5f3255bcd291df035d041c4e17e64c5a5201b5110909b8c0e081f50b715`  
		Last Modified: Wed, 01 Nov 2023 18:31:52 GMT  
