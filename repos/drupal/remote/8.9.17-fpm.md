...
```console
$ docker pull drupal@sha256:c9dd75813365a8e5e1a00431b9baa2fa787eb2e6e9cebe5c820846b5ef91573a
```
...
### `drupal:8.9.17-fpm` - linux; arm variant v7
...
### `drupal:8.9.17-fpm` - linux; arm64 variant v8
...
### `drupal:8.9.17-fpm` - linux; ppc64le
