...
```console
$ docker pull drupal@sha256:58ab28b8601afb3b9294ca51fe7bb0ec7c76251f73d58414c72e2088f3c1b859
```
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; amd64
...
### `drupal:10.2.8-php8.2-fpm-alpine` - unknown; unknown
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; 386
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; ppc64le
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; riscv64
...
### `drupal:10.2.8-php8.2-fpm-alpine` - linux; s390x
