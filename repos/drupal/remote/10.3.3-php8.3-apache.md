...
```console
$ docker pull drupal@sha256:644108e287c31ecd3c81a0dfb4c7db6785dc8e0c87b31944a037f97e715a9070
```
...
### `drupal:10.3.3-php8.3-apache` - linux; amd64
...
### `drupal:10.3.3-php8.3-apache` - unknown; unknown
...
### `drupal:10.3.3-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.3.3-php8.3-apache` - linux; 386
...
### `drupal:10.3.3-php8.3-apache` - linux; ppc64le
...
### `drupal:10.3.3-php8.3-apache` - linux; s390x
