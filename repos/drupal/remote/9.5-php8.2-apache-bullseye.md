...
```console
$ docker pull drupal@sha256:a5dd4f9900138badb7baf5d3a890b4cbaf22efa5046290a52c52c9ce18d94003
```
...
```console
$ docker pull drupal@sha256:6224cc8f4524ae7b6f95e460663c80e0480e54bfc499f8ac7bbc95f09a530050
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191774776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41153b4694dc158fba33c4bf04b7caafa83602e55f54fb840157149a1bd230c8`
...
# Sat, 02 Sep 2023 09:33:01 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 09:33:01 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 09:33:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 09:33:12 GMT
...
-	Layers:
	...
	-	`sha256:76cf1acac38be8a73d8eda6af5229ef291b44d098c80181e3a26f51533e33d1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1e8df4b8d0b09338c50ce8728d8850bd0960d9c56d13784d84370b31e29e3dd`  
		Last Modified: Sat, 02 Sep 2023 09:50:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:968f591cf9c868dcfbd3a167a39b09206b9da3e5bfdecca26b20ff4ac09fd589`  
		Last Modified: Sat, 02 Sep 2023 09:50:06 GMT  
...
```console
$ docker pull drupal@sha256:545bd24980e2c377410edf8ec3b1d6a2a480ef167bd1999aab6763aafe1c2026
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185984790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd4e83ac326b8241704511eea03087f86b786b31c506d978df834e10384aa4a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 08:11:00 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:28:09 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 08:28:09 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:28:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:28:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:08b55418f88982b5b31f6d4a7932aebacd2711375f712dded683c62f0a64cede`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4cae0ac364d68fef8c64f520e3459b3717d0e230a35e8d34e3cf02b871f1322`  
		Last Modified: Sat, 02 Sep 2023 08:44:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8301151fdad72640955f415e3ec40ae241c2c5ae53136a41f5d61f46b29ef20c`  
		Last Modified: Sat, 02 Sep 2023 08:44:32 GMT  
...
```console
$ docker pull drupal@sha256:5eda696d5a723e3cf6f4945aed278511f3a531c4bf46652c0b13f5e4247f2f14
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.6 MB (194640909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd7774c22061a263c5462f62c864d3958ff77e91453e444fab4241c20cdbca27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 07:48:53 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:08:33 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 08:08:33 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:08:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:08:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1970513edbe2948bf6dab2a6df5940cd21783f3f37f50af43c1518dcb49a4e3d`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecc1353a5b90b6f10faf224ea8e2468548896a753601653f162f6fa9afb8bcbe`  
		Last Modified: Sat, 02 Sep 2023 08:29:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbf1b1304ed69db464d8706f6d12ecc702824a82b167665071943c7d5f042bcd`  
		Last Modified: Sat, 02 Sep 2023 08:29:19 GMT  
		Size: 22.9 MB (22880051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
