...
```console
$ docker pull drupal@sha256:5d82b117d5cce553b8fe2be4d75bf85be3d3c03d036c651d391c1901845d8304
```
...
```console
$ docker pull drupal@sha256:5d60de8ceaa8aa53136749f6ddf5ef392050e8888a072988a7e19d04bd58b35b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32166096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc27aa0cc06fa4fb9b5e3cd777b66cb529eec77d15714c799168ace91aea5f5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 12:52:34 GMT
ENV DRUPAL_VERSION=7.92
# Fri, 11 Nov 2022 12:52:35 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Fri, 11 Nov 2022 12:52:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:606264dbdc1d5476bf87a86a67c0c514881a7acdacafbe42af1f3042b560020a`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e80dd9cbc243202e2521e885eb6e903210e755e2f7fa12f308ed138c46556baa`  
		Last Modified: Fri, 11 Nov 2022 13:07:27 GMT  
...
```console
$ docker pull drupal@sha256:412c0b58db75be90d788b49f53ce2bc8f32d3c4c057c56463908a1126f3bce51
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.0 MB (30958839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a22a663736fe1a28888b5909f93a189f9a60b0c4f58f46733da718fe34f12c19`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 15:22:01 GMT
ENV DRUPAL_VERSION=7.92
# Fri, 11 Nov 2022 15:22:01 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Fri, 11 Nov 2022 15:22:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bb2f87794e76115848b6f05631cf3e178bc58435435b6901adb8529c5bbf2521`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d589cfb7b3360522357c8f1dae2ec3aa77bcea0f9a38eab09fb2b3db82696652`  
		Last Modified: Fri, 11 Nov 2022 15:50:25 GMT  
...
```console
$ docker pull drupal@sha256:372c9b041cabe906e1f452e7fe59a1bfafad1f049ff0b0a5bd058fe9510f0a61
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.1 MB (33123937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b41b723ae1f5b6562a818ca0c20325b3378ec97bff4e437f01b28aa6da01e473`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:55:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 12:58:15 GMT
ENV DRUPAL_VERSION=7.92
# Fri, 11 Nov 2022 12:58:15 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Fri, 11 Nov 2022 12:58:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:609c7f0af4630226fe382104fd88e1d4c1ed9565d1f3b01b244ce92b17e197e4`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2b965128c43319ddc16207e697561ce9ed116028f0df8614d8050b1b213af87`  
		Last Modified: Fri, 11 Nov 2022 13:12:34 GMT  
