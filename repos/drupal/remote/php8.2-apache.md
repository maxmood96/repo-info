...
```console
$ docker pull drupal@sha256:9295ec3fad4d9fdd8cb9d1e4e6c8af5fab446a744a05a720ef9a3b8e56cef85f
```
...
```console
$ docker pull drupal@sha256:1a4cd47f68a3ac3e773cc5cdf129998ec2e1c9ec8846bbf025514fd845b4c13e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202551637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44b98e78ac36faed4da73a5746e23861f405cfef293dc2f6c381a5a820cde177`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 05 Jul 2023 09:08:43 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:08:44 GMT
ENV DRUPAL_VERSION=10.0.9
# Wed, 05 Jul 2023 09:08:44 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:09:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:09:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f78fa9b8b6787ac1c168a0834ba255b3cf62dc1c7b7cb207f4e1a2f9dbc4dfdd`  
		...
		Size: 698.2 KB (698241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bee910f1896ddb91c70656d7d2bd9f699da94abe9c3d2be7da400f33aa31405`  
		Last Modified: Wed, 05 Jul 2023 09:59:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc70b1ad7da66ded4cb1d13bf428f81eb4ab88690f0f048d9fe82e023134bcec`  
		Last Modified: Wed, 05 Jul 2023 10:00:34 GMT  
		Size: 17.7 MB (17687677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
