...
```console
$ docker pull drupal@sha256:dcd20d4909f490877bf5dbe1d895a3da56123670f47cc2b3293f54cf7eb939b5
```
...
```console
$ docker pull drupal@sha256:65212798b223bc5077cb8a872b2c1115955b3a37a0e789173368109db5ced5bd
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.9 MB (154885342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9aeb218cb782ac07b80f7db7069c11bf16a25043d20a80767f0a13409285db7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 18:10:35 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 18:10:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 18:10:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:35d6fc15e1f5a51fc8804bdf656b0c10e98aadcd744115f518d366334786ec5d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:564c2d3532c7d3e229c46ade700b47c31fbddac219d9fd76929b7d3a4e3df12c`  
		Last Modified: Tue, 06 Dec 2022 18:25:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eadebb93997009b89992b93dba7b905d89edd6307109b845c3d521fc07b6de40`  
		Last Modified: Tue, 06 Dec 2022 18:25:51 GMT  
		Size: 17.7 MB (17668868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.1-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:ca4b3f124819c24c93710c7e0233ed38119eab8d201a40bc8febc434578fa392
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.2 MB (167229380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:256ac5a2dbb6dd278b25ac9137fd16d88849cfd7be49c323483c271ac5de035b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 17:11:42 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 06 Dec 2022 17:11:43 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 17:11:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 17:11:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:856337061773b717d3086a8b8d93f83e474dab2b997760e0196adfd709213b42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e35c4bdfdefe0c86e287040f885c34c1a5baaff9dd1e642ede783ce1c4ba7ad`  
		Last Modified: Tue, 06 Dec 2022 17:34:05 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55dd6561653870136d9cc3cbf7449d8e237a58ce7edd1060eb2069643f7171fa`  
		Last Modified: Tue, 06 Dec 2022 17:34:10 GMT  
		Size: 17.7 MB (17670892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
