...
```console
$ docker pull drupal@sha256:7b238bbfb76fe01adb6f254bb345a6e7e263434f414605d39a7d774228c28d98
```
...
```console
$ docker pull drupal@sha256:f80c91fa2bcc188c158b76dd1b7e4d744070d8da8b29c593c5a9e8846959970f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163419327 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65831465c1f80890e83b0a8377e26b74ef8aa0468790a4b8dd0b586f07469abf`
...
# Mon, 06 Jun 2022 18:29:11 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:29:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:29:23 GMT
...
-	Layers:
	...
	-	`sha256:b84c4bd4dadaadb94d4cc6ba84807dbca3594cab08eb69ea50e8ee531a1e04d7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c1837d7384ebbf950b7825c14620e6cf3aedb0cac1227e3f66c70e54cfaa6df`  
		Last Modified: Mon, 06 Jun 2022 18:43:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5af1f6ea48055831f5d2558a59c1203a976b642b08252b8213004cfafe7aaae`  
		Last Modified: Mon, 06 Jun 2022 18:43:22 GMT  
...
```console
$ docker pull drupal@sha256:d5574ad7c3ca1721d3ebe577b839a1f8ebc2a37adedecc3cd1807262efa1a22f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.0 MB (139003697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9344951a8bca67329fa82887d4c585754d1f0e7fbdc05016e0f9363180253af3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 30 May 2022 01:54:26 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Mon, 30 May 2022 01:54:27 GMT
WORKDIR /opt/drupal
# Mon, 30 May 2022 01:54:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 30 May 2022 01:54:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2894a395d6e1ddcbb410cb93cb540c0844c0080691f6c8544a0b060418047f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c786495ae31ade9cb2a3a3495d8303f3b9bf1ece577c370721b4fe1906a1377f`  
		Last Modified: Mon, 30 May 2022 02:54:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9b7bba43b99d2bc0125ddead96fbebabaa52ba68acf146a7259445a2129e3cb`  
		Last Modified: Mon, 30 May 2022 02:55:23 GMT  
		Size: 19.1 MB (19118398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9837827b67b8382fdd9d4ab932214e3a176945df9dbaaa4d0e8ce047fed33939
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155549950 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36991a84129be793f0e873e6876936536655cd2cce3d0d5503b99458f1960cbd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:50:42 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Mon, 06 Jun 2022 17:50:43 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:51:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:51:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00106d1bd86cbcf3cd8e10f0ac6c6f8f459e7fbeb57e842b20d78060aad8b7e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43d00be87112313ddd8b374c613076dff64892f09584ee1af3daae690c51f8e7`  
		Last Modified: Mon, 06 Jun 2022 18:16:10 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bd09ca44ee863a99a8fdd4b3340550e6bef543f5756fee901209fa9a9bfb8de`  
		Last Modified: Mon, 06 Jun 2022 18:16:15 GMT  
		Size: 19.1 MB (19119164 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.1-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:d355a8151397112e54ca39c2372a83b5b6c3c51fb61acefe40a4a8d2705b0bc4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168522251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c90a6d8a4808d591783c64597246b01962c24840c622f05c8f8da1cc073052bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:45:55 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Mon, 06 Jun 2022 17:45:56 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:46:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:46:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fbb842f1f373e4e21d86805321af60437a3d8720d5a7364db17430ba1f061bc6`  
		...
		Size: 669.8 KB (669842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:439a7c696d221352cf4767888c8da9b446c084f675c79ae335a19bd6346d955d`  
		Last Modified: Mon, 06 Jun 2022 18:09:44 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98bb57ebf3cc20c0397daf95a7a136621388fe7a10528f13a44041febe809f31`  
		Last Modified: Mon, 06 Jun 2022 18:09:49 GMT  
		Size: 19.1 MB (19119307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.1-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:328e6a8fd29bfbbf839e5a62ddc0a55da24a5147cb691a0a7d110ee190731cb2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173340639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9dc034680eb4c6bba9d36b868cddd549441b47ee9c90007a82f004630843c99d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Sun, 29 May 2022 13:04:44 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Sun, 29 May 2022 13:04:48 GMT
WORKDIR /opt/drupal
# Sun, 29 May 2022 13:05:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 29 May 2022 13:05:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:da612dea7b5220addef945e9f3efa6a9b90effd8e131d6751be7971f99531a4c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30cddeb3a6c3ebe3a97fcd496f1df70a05cdc7367386fabaea20d843b9562924`  
		Last Modified: Sun, 29 May 2022 14:04:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6adc3b24f9399e74a6a7e968ed272022137e66809d9e1c71d4eab8a07d49271f`  
		Last Modified: Sun, 29 May 2022 14:04:51 GMT  
		Size: 19.1 MB (19118643 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.1-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:501abb397baaf4ee07954e4865870171824dbd3cd4412246c6a0fc20cb60855b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.7 MB (148689419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e59523d598af8217317a97e362e1595c0613d3d2831fbd8be49359f3af58b02`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 29 May 2022 04:57:40 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Sun, 29 May 2022 04:57:41 GMT
ENV DRUPAL_VERSION=10.0.0-alpha4
# Sun, 29 May 2022 04:57:41 GMT
WORKDIR /opt/drupal
# Sun, 29 May 2022 04:58:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sun, 29 May 2022 04:58:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a836a9106c546ac527e917818fda0269badf6b9958b244c298521c7160c07b06`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dad17ec1ff0f78adc286c3250e417f9aa86887f612d77f36acf7c00665db64e`  
		Last Modified: Sun, 29 May 2022 05:31:45 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efc2d5bfc06e88660e597dee001d87ccea3fbe7544950deeb0f77463cb3cb3ee`  
		Last Modified: Sun, 29 May 2022 05:31:49 GMT  
		Size: 19.1 MB (19118344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
