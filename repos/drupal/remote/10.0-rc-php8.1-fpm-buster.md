...
```console
$ docker pull drupal@sha256:321002dc4ed8c81fb00c850281c11cc300e995be59327a55ceca531288db8ec3
```
...
```console
$ docker pull drupal@sha256:305226be64085ec7c52be444cc952a590695e0f9dad5caa3f88fc4dcfec142fb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155464419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3a2e0d6d81f7c8b947d9f2968ec2f985630c4d6b28db035c41ad875653e2ddc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 30 Mar 2022 15:12:04 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:12:04 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 30 Mar 2022 15:12:05 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:12:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:12:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:46ced9f81ed09e59a9bae1df093cd6223ceee1bd7016704b98d732ea778f927b`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:549e3037d20cf000894e1dfa1ff1998e55846d824d0343de07dab45fd35cae69`  
		Last Modified: Wed, 30 Mar 2022 15:47:13 GMT  
		Size: 575.7 KB (575710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abf7f5ffe9c0546192b731b1c6c4cfe28c6ff8468157f4b1766b16152eac9c95`  
		Last Modified: Wed, 30 Mar 2022 15:47:13 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c760075f30a06e5e963f18692a8c98a1c1ea1dedcd63be3a09d7d5cdf0225747`  
		Last Modified: Wed, 30 Mar 2022 15:47:18 GMT  
		Size: 19.1 MB (19135759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
