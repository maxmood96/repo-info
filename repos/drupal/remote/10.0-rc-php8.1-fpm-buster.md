...
```console
$ docker pull drupal@sha256:a9cce3fc4ab86001551c5282e29b14eca7aad78b59d0712acad142427153a79f
```
...
```console
$ docker pull drupal@sha256:dd5f9e92b930ce97a43f5a176641c2e1c1df937b81219042dbd920c55afd521b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.7 MB (148657105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10461e755321aa508cb32b43e21eadf22f8f08ad2c176a034d41e1c4fa4dee7d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:07:58 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:07:58 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Wed, 16 Mar 2022 18:07:58 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:08:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:08:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7870eafe93daed0100147cd87d0f960e8580153811e6502eac97fc2b99a3fd14`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d868b48a7601d9b50bfa560b093a465c679bafbb44508fee8966adc4a6c0c3f`  
		Last Modified: Wed, 16 Mar 2022 18:30:00 GMT  
		Size: 575.7 KB (575713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ea11fc6e2e39bd4d92ebb68245c4142e79db35e5ffad0a75db24d645b0af2a0`  
		Last Modified: Wed, 16 Mar 2022 18:30:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cd4135aef045b66a7998e41898920079c1edec417f34a6c66e6e8a862200639`  
		Last Modified: Wed, 16 Mar 2022 18:30:04 GMT  
		Size: 19.1 MB (19136538 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
