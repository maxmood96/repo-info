...
```console
$ docker pull drupal@sha256:0b4250cd0da69f706e6289d314809c1e625a54b3afe8fefa734927a15c4a41b1
```
...
```console
$ docker pull drupal@sha256:d8ab4b7f8c81212e739761e312142b0bbff71b48849231744a599b501033e432
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168435120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d0850ded7bfa525cae12eed044d956392b0d21b12a398e10fe9fd828a0ae548`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 24 Mar 2022 07:02:14 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Mar 2022 07:02:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 24 Mar 2022 07:02:16 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 24 Mar 2022 07:02:16 GMT
ENV DRUPAL_VERSION=10.0.0-alpha2
# Thu, 24 Mar 2022 07:02:17 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 07:02:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 07:02:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2ad9d4e780d1b48d71c02b0aae78627820a9c1369d135bfb1007dcf7ebdb0c21`  
		...
		Size: 8.6 KB (8624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9812a9a7c8595dde80f0644904719886c0271f06d8f1cb271c461e234a29a217`  
		Last Modified: Thu, 24 Mar 2022 07:34:21 GMT  
		Size: 1.9 MB (1916094 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75f8b12a425bb530d42bdf7b1b299d5163318c3a28540e9a9f2bcfb027cbcb1c`  
		Last Modified: Thu, 24 Mar 2022 07:34:21 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c86456f0fd7c714afb126d78d08cd3f4e6d5b7c60f1cf04d618126899cbdf47f`  
		Last Modified: Thu, 24 Mar 2022 07:34:21 GMT  
		Size: 575.7 KB (575712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9894abca6748cb3230931afefb37d74315834e1a9267b53db35dd7af0bf29db`  
		Last Modified: Thu, 24 Mar 2022 07:34:21 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df201b4fcdc604108f0f404a316642ad0558b6a9b16a7789bf2e6c568a76000e`  
		Last Modified: Thu, 24 Mar 2022 07:34:26 GMT  
		Size: 19.1 MB (19135990 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
