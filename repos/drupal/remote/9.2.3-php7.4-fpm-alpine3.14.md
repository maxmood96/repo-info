...
```console
$ docker pull drupal@sha256:d369ce079004a8a2a5a79c7761c28d8ba7527dc841a48d45fbd4f89a9ec2795f
```
...
### `drupal:9.2.3-php7.4-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:9.2.3-php7.4-fpm-alpine3.14` - linux; ppc64le
