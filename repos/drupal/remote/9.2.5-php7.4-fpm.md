...
```console
$ docker pull drupal@sha256:52809e72852407d00ee0574e0645bc2a3366c3fe7cfe3db659fe30f2f03ddda0
```
...
```console
$ docker pull drupal@sha256:90b70a30fc13b2383be97c163c3fdf3964574b0f900767bf2dac72370cebd353
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141135626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7cdf469cca7b31fbaeb5c761cdbdac200691eecbc385a16cda09f32e43d8b48`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Sep 2021 17:55:10 GMT
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Sat, 04 Sep 2021 17:55:11 GMT
ENV DRUPAL_VERSION=9.2.5
# Sat, 04 Sep 2021 17:55:11 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 17:55:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 17:55:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8e41068e99b96890745794cc556ae98c0965ff24be71b356129373bd2cbd62d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05075590ec1858bb3d444cd4b04125ea676dc8edace6b32d495ca992b786d077`  
		Last Modified: Sat, 04 Sep 2021 18:24:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1c3d729cd17cb2f16f182429e6dce363ec26927e5d12054917a21d630e35ee1`  
		Last Modified: Sat, 04 Sep 2021 18:25:18 GMT  
		Size: 19.2 MB (19178297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
