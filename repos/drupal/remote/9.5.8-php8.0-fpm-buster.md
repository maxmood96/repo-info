...
```console
$ docker pull drupal@sha256:ddbd69668c90bd914663037cf71095a4dd16999f6ce6b3bb59cedf4623b51004
```
...
### `drupal:9.5.8-php8.0-fpm-buster` - linux; amd64
...
### `drupal:9.5.8-php8.0-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.5.8-php8.0-fpm-buster` - linux; 386
