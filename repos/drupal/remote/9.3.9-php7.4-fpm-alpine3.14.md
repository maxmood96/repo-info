...
```console
$ docker pull drupal@sha256:f595fa18d65dba6da03c542e5eae5e2b990a22340d1a1c33c9b9f0a30a628517
```
...
```console
$ docker pull drupal@sha256:b65e2a4aebcbe2d3cc489dbf05f3d67f99209d34e5362f309501ca7b3ca8bb81
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50717597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4afb6b66c36b29f8d17deeb74cf4b2976489316ff94fa772439d41192296f868`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 04 Apr 2022 21:03:39 GMT
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:03:39 GMT
ENV DRUPAL_VERSION=9.3.9
# Mon, 04 Apr 2022 21:03:40 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:03:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:03:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3b8ad418ad404e00162581af38a65acff4e4459191ad297f0889bcb3ba56056e`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e8631a9b9821a1c95fe883cdb39fcbca5589f4a88fea2e296c93ad4495ec881`  
		Last Modified: Mon, 04 Apr 2022 21:29:04 GMT  
		Size: 660.1 KB (660099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d87c38fbf2fb4aa5f38acca4cc9234e3285333846ee26fe93f6b98107328fed`  
		Last Modified: Mon, 04 Apr 2022 21:29:04 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eacdc45c1e2abf87862ba381497ccbdf49d1565506bd6c93af326b4582bc333`  
		Last Modified: Mon, 04 Apr 2022 21:29:09 GMT  
		Size: 20.9 MB (20938384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
