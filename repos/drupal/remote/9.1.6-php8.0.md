...
```console
$ docker pull drupal@sha256:2f402d2184b83b3e675ed78a39d8ab255109dd4960fc7af35bdec84f590bb68c
```
...
### `drupal:9.1.6-php8.0` - linux; amd64
...
### `drupal:9.1.6-php8.0` - linux; arm variant v7
...
### `drupal:9.1.6-php8.0` - linux; arm64 variant v8
...
### `drupal:9.1.6-php8.0` - linux; 386

```console
$ docker pull drupal@sha256:ee8a3269a1980e20f2e637a47985884fb4653f20b80c36722eb6ae4bbbffec0a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.9 MB (174925888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360c9288f64d43d9cee56287b026ab33e3769c678763028f80ef8fc4e2d399e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcdd9873d1016333cd6a1e73b637568a047577950b59a36536176b39a60c66cf in /usr/local/bin/ 
# Wed, 07 Apr 2021 18:38:54 GMT
ENV DRUPAL_VERSION=9.1.6
# Wed, 07 Apr 2021 18:38:54 GMT
WORKDIR /opt/drupal
# Wed, 07 Apr 2021 18:39:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 07 Apr 2021 18:39:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c2afbb35e3c1bef0b79010589f72d8e1838143d37a9bc78f720c931ecf7a76a`  
		...
		Size: 553.0 KB (553008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02bee94756806c1b47c4f77caacf7227e67242bd3784497594000525653e46cc`  
		Last Modified: Wed, 07 Apr 2021 18:48:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff8fba271fc3e0bfef2de4c6e0d6ad66a8415e9a53bcf41c01496963222a35ab`  
		Last Modified: Wed, 07 Apr 2021 18:48:37 GMT  
		Size: 18.9 MB (18853498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.6-php8.0` - linux; ppc64le
...
### `drupal:9.1.6-php8.0` - linux; s390x

```console
$ docker pull drupal@sha256:a3e6a38d903e378a234fb2b943d883d2b7e667bac6e34b2652427b14304ecffe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154544436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:031d0b02c62811ff009960b28ecf9e77db786879e09b2137b81b29c2721291d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcdd9873d1016333cd6a1e73b637568a047577950b59a36536176b39a60c66cf in /usr/local/bin/ 
# Thu, 08 Apr 2021 00:57:44 GMT
ENV DRUPAL_VERSION=9.1.6
# Thu, 08 Apr 2021 00:57:44 GMT
WORKDIR /opt/drupal
# Thu, 08 Apr 2021 00:58:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 08 Apr 2021 00:58:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:72531cbc89af874c4807d302838a55d44bc96304c016ccf15ffd85fc749dabf8`  
		...
		Size: 553.0 KB (553010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5e9b574feb4aa78931c4d508a2ceeb0e42f84145b26a4d75133d52027124333`  
		Last Modified: Thu, 08 Apr 2021 01:05:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97a0a0382d080333f17e527ad5271bb9f772bbdd678d297fd9948f1c59f0f7c5`  
		Last Modified: Thu, 08 Apr 2021 01:05:09 GMT  
		Size: 18.9 MB (18853808 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
