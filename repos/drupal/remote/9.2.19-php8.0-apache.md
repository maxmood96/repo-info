## `drupal:9.2.19-php8.0-apache`

```console
$ docker pull drupal@sha256:b1d0e5665f5d0c8b65a80bc8908244bc0132ab0595149aa4b8ea4efa531c13af
```
...
### `drupal:9.2.19-php8.0-apache` - linux; amd64
...
### `drupal:9.2.19-php8.0-apache` - linux; arm64 variant v8
...
### `drupal:9.2.19-php8.0-apache` - linux; 386
...
### `drupal:9.2.19-php8.0-apache` - linux; s390x
