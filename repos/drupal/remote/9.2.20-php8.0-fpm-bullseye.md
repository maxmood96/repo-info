...
```console
$ docker pull drupal@sha256:5d4e75aa1aaef57f3b4af2ae729f7dc571f6483f6a9dc0aa77a3361eba6d9861
```
...
```console
$ docker pull drupal@sha256:9e80c81c83a7034f19a19859664fa8aef78ebd138f5a14925ee2f56c09c3c0ea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152187291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1a42d97a1f7f8c4d3527e80ec2a55a41fb7f226e0d756d86e5e2d76a268ce1c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:24:18 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:24:19 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:24:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:24:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fc5463ccb638f2eacdb4d69e2e104fd796ef15d96a89f611207c7f54c0e6f6fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24c0969f9fb1e12c5afc64030f2736b83e200feaab8eec4b1ff39d8a493a58fa`  
		Last Modified: Wed, 01 Jun 2022 18:20:41 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7027e5b54bc7226627ae8551ff815fcec5150d79de57053e0ea16e277be446a2`  
		Last Modified: Wed, 01 Jun 2022 18:21:09 GMT  
		Size: 19.1 MB (19128289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php8.0-fpm-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ebc76090c2089333778e86d2b8239fe909e83628eb8a034ff4ab5986ceebf57a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174340698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59f03023b197d8b3651e5793323b05edd0a64e64faeb902dad1ea32e9466858f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:57:13 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:57:13 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:57:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:57:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1261bd474257b3ad7f463eb024bda65087be0485ff8fbde79aa7def2dd3be57b`  
		...
		Size: 661.6 KB (661586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2219e8598bc952ecd859b2af1047fcd5f884652786edbf3897b0dc222c90bf7e`  
		Last Modified: Wed, 01 Jun 2022 17:28:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f95c8bc29d8472cf0f7cfe41d8673c5fbbc3118b03b3aed9632c4105bdc2c281`  
		Last Modified: Wed, 01 Jun 2022 17:28:41 GMT  
		Size: 19.1 MB (19128334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php8.0-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:a8d54cac2cee9a3df008b825a1784df3e887f82073a90cdc6cd51239a5523299
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.9 MB (183901796 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92c2daa0ac59379ce80172c364b11260cb7f7385de25ceb598ed1bc48247e670`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:50:53 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:50:53 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:51:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:51:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:162c204b2c72b9adc55bc6e580e8270571cb67b3076510fb6aff4ed3d1f74e1b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11c0f5228fdae260d8677171ab9fc3a7db5e9fa8fe73b2b41cdc5939c1e51b77`  
		Last Modified: Wed, 01 Jun 2022 17:21:25 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b696a514748c2ad03676e70107d77ffcee024baa7324132e3ae5a664485cbd7`  
		Last Modified: Wed, 01 Jun 2022 17:21:30 GMT  
		Size: 19.1 MB (19128090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
