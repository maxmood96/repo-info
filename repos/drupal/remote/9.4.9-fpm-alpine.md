...
```console
$ docker pull drupal@sha256:26986ff52a45fc9535a241212945ae99ea0e299640303a063bad9c3a33b47a61
```
...
### `drupal:9.4.9-fpm-alpine` - linux; amd64
...
### `drupal:9.4.9-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.4.9-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7a04324df5889459b1cd247cf6fc47ba78fc865243b5868f75f33f29b0d4a7ef
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51118740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8865fe626cc2c34973279b55ec01bdba23273d30eab531ea204b1e18b8e322dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 10 Jan 2023 01:37:20 GMT
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Tue, 10 Jan 2023 01:39:34 GMT
ENV DRUPAL_VERSION=9.4.9
# Tue, 10 Jan 2023 01:39:34 GMT
WORKDIR /opt/drupal
# Tue, 10 Jan 2023 01:39:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Jan 2023 01:39:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c2fdc794282d9aa3ad2dc7c160efd9d3180e4489049c1f5d3db20814b44673a`  
		...
		Size: 700.1 KB (700096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a9849a7cb2d984b33231bc6f1958e5ba31379a5c0ebb72222f42819068f3201`  
		Last Modified: Tue, 10 Jan 2023 01:58:20 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48dc0f8d627de6e6dd853551c308db8621e5e6bf8b9db95cce2a5f9f87dc9e97`  
		Last Modified: Tue, 10 Jan 2023 01:58:28 GMT  
		Size: 21.9 MB (21918381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.9-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.4.9-fpm-alpine` - linux; 386
...
### `drupal:9.4.9-fpm-alpine` - linux; ppc64le
...
### `drupal:9.4.9-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:a7c30775236c8f5586352640ff9b915e78a0270398f0874676d013b040c8aa68
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52921417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d627290ad0adfca69a8c6ccfdad0cd0134cf24eb04d93adcae1b5ea736989b92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:81cad59228e2dc61b9d880277f60e1ab16f4d7a32f9f11b33c68bd0b2bacdc3a in /usr/local/bin/ 
# Tue, 10 Jan 2023 02:54:30 GMT
ENV DRUPAL_VERSION=9.4.9
# Tue, 10 Jan 2023 02:54:30 GMT
WORKDIR /opt/drupal
# Tue, 10 Jan 2023 02:54:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Jan 2023 02:55:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:16c4e2991a0385d397ada91e2922b466ad2c171a454b2128dbd4d20f18426684`  
		...
		Size: 700.1 KB (700096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efca45f411c10f45e809f6c2f2b13bc195499f4e9a43d648841fa016922b913d`  
		Last Modified: Tue, 10 Jan 2023 03:07:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d08f9d8620062a3c7363358a2fcd8a214258873761634d3416c819f1d74a9730`  
		Last Modified: Tue, 10 Jan 2023 03:07:49 GMT  
		Size: 21.9 MB (21918406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
