...
```console
$ docker pull drupal@sha256:10443697989e49da54b92309ee28af25fcea51c1b81090cc7610345ca8943a7c
```
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.2.9-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.2.9-php8.4-fpm-trixie` - linux; s390x
