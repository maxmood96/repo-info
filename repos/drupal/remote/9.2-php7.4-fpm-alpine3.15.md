...
```console
$ docker pull drupal@sha256:de1bda0f9a78c05f33fc6ee171013677c7324711a1bb1884ba8768c2398aa17d
```
...
```console
$ docker pull drupal@sha256:b09431f1fd9e94c3b921c3cad71603b6023e0471779bccd004d1249b10b9bad2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49723649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59aa3d49e569eb795207332e4f0b6ef443c14fe850c280f540595e912283c7a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:28:49 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:28:49 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:29:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:29:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7b1996886aa81b6365304d6be0636145c7a4a90212e8eff7a141f19ec7de43cf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51ad83ce02eb6752e210f03eeb5d672cea2016a353f9d9fcc4b115bb2b3c421f`  
		Last Modified: Mon, 03 Jan 2022 21:41:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dce972d5407ce385ea3611e9e3a349af9f40b419408f1e6c4123de0b5b3585f4`  
		Last Modified: Mon, 03 Jan 2022 21:42:02 GMT  
...
```console
$ docker pull drupal@sha256:9f1c989963ef4e758171d8765ce8c036c41f696d4d945eef67cb24d30ab2038a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48377525 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:406f5976720da38f884e44dbc1748afdde0c2e772704be37d5940b719683dba5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:11:19 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:11:20 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:11:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:11:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c78a9849c46c18e7a472e2670865104b29fd4b59a62d9b35356ce460196d4677`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d36fbd07f1c039bfafbb4e106367e5083d988de6693768244834904925125f5`  
		Last Modified: Mon, 03 Jan 2022 21:53:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:210606162fc7d24c14b966f3f1cfdc1ca1f9b83296bc8f8b224494e029184a8b`  
		Last Modified: Mon, 03 Jan 2022 21:53:51 GMT  
		Size: 19.2 MB (19193313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ea0ae183ba26571f9adac042c766cf6572904e5f2b58448fed7c2b3ed7ebe6f3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50741973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fee375a8a395bc86f0198b354b04559b159828b0b6154d2b451eea7ccbc99821`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:48:25 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:48:26 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:48:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:48:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1d4a53ff6ff976be7526280a50cd842fa9bc62ec7651355eb1cbfdcb968c587b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb178c79f942b781d9e4b7184ee16dfa2f2373e4720b5a9b8e619a5927e1d68e`  
		Last Modified: Mon, 03 Jan 2022 22:10:00 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ea54adf13ec1ec5b4675f658bfde633df4a5eb90a8219e11ed1a1c338e4cf85`  
		Last Modified: Mon, 03 Jan 2022 22:10:05 GMT  
		Size: 19.2 MB (19194803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b4cc506f0036755805a225bc6aa33bbe29ead62d418eb342d8264c9d477e9266
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52403941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc1960a85dfd8ccca150f4bcfa43e386e6e06a7931d1a4eecce1f5dca5d58ef2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:39:14 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:39:15 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:39:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:39:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bdcbf2db7f9c593f7f9876034065c1f576bbc9f79bdf5b00846633cd4b71cfe5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5223510b5f10000847192a66c8e8d2935fcf4fa5252635d432469de6b72a8c2c`  
		Last Modified: Mon, 03 Jan 2022 22:21:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06014c593b4c221eed18c7ab95c89ac45251fbc7dd2dfb7fe6073736c5bf6979`  
		Last Modified: Mon, 03 Jan 2022 22:22:26 GMT  
...
```console
$ docker pull drupal@sha256:7b01359e188f7d80bd9c4cfb0759159925f40fb9a1d37d8a8bda75340a20e3c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50337956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:667fec9f6460c43d2c01b324f7a86dd533f30166be9d08080aafd148a728cfe3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:59:18 GMT
ENV DRUPAL_VERSION=9.2.10
# Mon, 03 Jan 2022 21:59:18 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:59:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:59:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a351848765f7efd5bab20daf7881bda596a769aa025753cddb616016923bbb7d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cfea9ddd0a11efb7fe1e3ad032d071306f17778e2720e24352498e8df69ed61`  
		Last Modified: Mon, 03 Jan 2022 22:15:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e77792e7876b15f15e2ceb3b40c4e1b605b9903ec5f06f00a122a1e66d925676`  
		Last Modified: Mon, 03 Jan 2022 22:16:01 GMT  
