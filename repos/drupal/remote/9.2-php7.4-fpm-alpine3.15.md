...
```console
$ docker pull drupal@sha256:1790363059d8f6f5d78ff18c1924beccd8072384c7d0df1edc3a631eea237daf
```
...
```console
$ docker pull drupal@sha256:bf19561f14a98a03cdc50830b17ee392ec0fe29aad8310d1a8c23ca939fa20a3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51089436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8646ad45f50e8c49eb98ea67ca29366655150b1ed6ff7d1ef8abde5212f20fd3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 22:55:57 GMT
ENV DRUPAL_VERSION=9.2.13
# Thu, 17 Feb 2022 22:55:58 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:56:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:56:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:60fa14d2779ba96a61a75c3f658acd414e5b8a30dd711c0fb983ca01b32ec75a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d488d02080681d4a5b6a7cafcc4c96e5dc8195735b9253ac6c562adb721cc67`  
		Last Modified: Thu, 17 Feb 2022 23:10:52 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d3557e7d3b80f8e151747a45408fc6b669f9b805b401729f9a646a0e524c65e`  
		Last Modified: Thu, 17 Feb 2022 23:11:20 GMT  
		Size: 19.1 MB (19110093 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e14df09ba57143f3e553832876e1b977a519c0345d28dfb9f4450a2aba37d758
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51717223 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d2eb09dce441605e6cc9341dfec27d195783d08f8cc81b595bd5be897791fed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 22:57:59 GMT
ENV DRUPAL_VERSION=9.2.13
# Thu, 17 Feb 2022 22:57:59 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:58:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:58:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6380a26a5a2458c6267f2e705cedd0c0a8b5db3045ccf4be2196e7db8ece59e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3de2d5c83a269473592abf0d31d2d8d7ff42b23da6c5460fb85c8b552508536f`  
		Last Modified: Fri, 18 Feb 2022 01:02:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a18fdf9ca0ba788ef2bd0cafec0eb55e1ab999e61bcd97d95e55bb5228170131`  
		Last Modified: Fri, 18 Feb 2022 01:02:13 GMT  
		Size: 19.1 MB (19109890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
