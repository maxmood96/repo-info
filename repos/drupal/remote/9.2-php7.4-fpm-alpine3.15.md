...
```console
$ docker pull drupal@sha256:cf0e85cbdc863393b07e89a11bd2f89271efe9029a58c0fa68fee501468de60c
```
...
```console
$ docker pull drupal@sha256:51d6f74efa388cbcbf7594575bceea43fea7c9a78dff30f079d23db4980b6416
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47786991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:515bee3f69004309351878df7b65ce00f75eea70c235423216990c23d5f295fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Mar 2022 21:21:30 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 17 Mar 2022 21:26:19 GMT
ENV DRUPAL_VERSION=9.2.14
# Thu, 17 Mar 2022 21:26:19 GMT
WORKDIR /opt/drupal
# Thu, 17 Mar 2022 21:26:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Mar 2022 21:26:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a850b37f2be0a3c6a17ac15b9787acdca64b4748ef51a1bee89c122576d59f5d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a08966f2f5cc921bf4adbe9e76a410fff0087268f1888764926713461dbfb66`  
		Last Modified: Thu, 17 Mar 2022 21:44:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:554a39892d5902aa269ed0425b7005e61f295b3ec65927de5237a0e1498186da`  
		Last Modified: Thu, 17 Mar 2022 21:44:51 GMT  
		Size: 19.1 MB (19111243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
