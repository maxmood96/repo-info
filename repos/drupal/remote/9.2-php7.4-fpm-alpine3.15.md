...
```console
$ docker pull drupal@sha256:ea6bf7ebeee3223ac2b91e26796439008058f1905a9d816b3e3517ce9825777d
```
...
```console
$ docker pull drupal@sha256:cbfcbf683e7316a5c4190a632fc2b8b049975830a84c60e5f2063944e05fdf85
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48441896 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c30dcf7694e61b81162afc955c5e42df0414e6831bff77ecebb81f27d1ad04d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:31:38 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:35:02 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:35:02 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:35:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f6fbb40d8c8c50b0f897250f00423f3616ad53c0bdd60edd2b90aced8ef6fc9b`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bbd9fe7f67f6e5e2c42bf8e64e432ee1b1529356e2f57b779811154850908a8`  
		Last Modified: Wed, 16 Mar 2022 18:46:38 GMT  
		Size: 575.7 KB (575717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:493237267ca1e772a49c47db7d048b1ac91d7d01678b100622de697dba4b03ff`  
		Last Modified: Wed, 16 Mar 2022 20:31:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c11348355199686e94e1f453717de84110006528ac7678195b8ba603e4f66fc`  
		Last Modified: Wed, 16 Mar 2022 20:31:45 GMT  
		Size: 19.1 MB (19111425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a615d40b5dd2fbf84c1c5915f541b6cfb9df56383a26772b938dcb92490b0487
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49394933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4c032d10f5f15bea6443374905e9c48f364c5c99e1a36b614a2ce05dd36802d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:25:14 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:30:42 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:30:43 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:30:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:30:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:abdab8abc6c69a16d00bdb107e3003c4db507d30c69b19ae74c4792c91dd557c`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7148785eaf1d57815e88eed0d8817fda6c0f93a1f29166897bbb54b62857459e`  
		Last Modified: Wed, 16 Mar 2022 18:50:29 GMT  
		Size: 575.7 KB (575712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9fe12ac9c7415a78c31a2b551a7862ca2bb88e61709769027ef5eeb111ebb3c`  
		Last Modified: Wed, 16 Mar 2022 18:56:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93d1ab975f02c50154fc097ddff8f8aba9316f19d76677619a2aaaf10a79d5ed`  
		Last Modified: Wed, 16 Mar 2022 18:56:43 GMT  
		Size: 19.1 MB (19111663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:6fdc72a7b4880c0870e1a2e3cf11061aebb94666aae441a903ade1714dfc952c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50302189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1895be3ce87a26bb5a92a9aa71adc7bb5812e762beefc3ce99873080c9bf826`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:30:51 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:36:42 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:36:42 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:36:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:36:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:59bc6956a6b4d6eef4c3c0ecad2b3da1e48e18e26e7010c59d3ba98e3ee9368b`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ecdccd3b19b85ce20f833711caeacd997dd287f0e56ea5a4eade3dda200f37f`  
		Last Modified: Wed, 16 Mar 2022 20:45:51 GMT  
		Size: 575.7 KB (575718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aba89475dc298a0c4e5926f970e6230188046821d6d305fddfe18173c65d4e55`  
		Last Modified: Wed, 16 Mar 2022 20:53:35 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f0008e9fc7db8db98b75459f9b3383e8c29ec432d0769d737ae5d11fe92c917`  
		Last Modified: Wed, 16 Mar 2022 20:53:48 GMT  
		Size: 19.1 MB (19111307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e98641d50f6bfbdb864ce3d6145987f5de679f5a4afef52ef4d83efb1ab1b154
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49014057 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05e74cd6645ad65955cc991c809824b08ca101f10a2fc84069fed4c5a75b2d81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 06:41:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:14:04 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:20:03 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:20:03 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:20:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:20:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:87116014cf284810419ac4132b257a32924dc1098259e0174c7b80f6b3a2cfa4`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8dd4319e50670a87f6ecd0b29a88bc6aba914922d14efb3a88500f877f566a11`  
		Last Modified: Wed, 16 Mar 2022 18:36:00 GMT  
		Size: 575.7 KB (575709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc9725d14953c7a6f200ad50b0002b74d3ac24bc90a7df87fb4f4d88aa89bb56`  
		Last Modified: Wed, 16 Mar 2022 18:39:52 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b7781974c6dfbd22c6e3bc0d8e6bf384ccf72f7a9405eb77122a203befcf61b`  
		Last Modified: Wed, 16 Mar 2022 18:39:56 GMT  
