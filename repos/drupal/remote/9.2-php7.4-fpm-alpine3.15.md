...
```console
$ docker pull drupal@sha256:90e8e4cd229e8281aabe471f577f4b628a1de07dbacdea4c83ba59e1eeec5e9c
```
...
```console
$ docker pull drupal@sha256:625504c11efe19a9b136a56157282c18e531af85f496e6e34be6313668ff7918
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.2 MB (47238374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd8271b101558cbeafb59c1691fd0468d0ef30fc7200b5a833695c68ee67a254`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:19:15 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:19:16 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:19:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:19:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:02fc0804430d5576f1069f384b498febb74a448c8e48e2fc1e26cef061d52244`  
		...
		Size: 575.3 KB (575344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:968e7710c6bcd64d6b401cd54b2ff190774ccdeb4784941a2a53bc28b19235c8`  
		Last Modified: Fri, 11 Mar 2022 15:48:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bde36bf4c3010803e68c396e8b624923faf7227ce5e42318d379bfc3ac74be19`  
		Last Modified: Fri, 11 Mar 2022 15:49:14 GMT  
		Size: 19.1 MB (19109815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d569c463508f06257bb76c0b891946a54195da3b1bc0b294b56102c4630efe13
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50300412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:691e477532eb2cc7bd3157beb8ac6c29d07185454200c8f955b97b46a816aa69`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 14:56:37 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 15:01:55 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 15:01:55 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 15:02:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 15:02:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26e58fc832e7f664ebb13e6546317b1da78ae9596acb3c1fdf86ee4bfd95efad`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42e6d5c8e3c6d740531fe50e23c3aadd6261affad92977b6d0804cd30d8e722f`  
		Last Modified: Fri, 11 Mar 2022 15:35:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e13d8da85d632fbf6311f4193f8e62af7d14d086c968378bd9cc01c46bf769a0`  
		Last Modified: Fri, 11 Mar 2022 15:35:52 GMT  
		Size: 19.1 MB (19109903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
