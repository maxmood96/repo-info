...
```console
$ docker pull drupal@sha256:2743403489b78098a6a75fc190f0d2b242dcb04988a1060c1229514f0d20975e
```
...
```console
$ docker pull drupal@sha256:0e58833667f479ba33aa8cc6e5e6fb7dd356d6680f75b82d67cbd5376ac1a844
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.1 MB (46148406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e8ba4f9d09a0d6ccb1b0c7777452dbcdf970e316c1fc2f8805e5eee446ad27e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:51:15 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:51:16 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:51:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:51:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a03ce61a2ab84383771ccdcad2ee52b0e27b3022cce08dbbcc43e3e617f29377`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f9d4f5e1902933f7416f5c5cbd99c03d70d1a30729c1d2073ec817edb29f2fe`  
		Last Modified: Mon, 04 Apr 2022 23:47:40 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6eb26860a59d7f71dfa92b73a93b79ce63c88f8e912a73ef21c399a4ba8a5436`  
		Last Modified: Mon, 04 Apr 2022 23:48:08 GMT  
		Size: 19.1 MB (19115954 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5089b40134ab90f036ee2ccda6b0ee3e2969325d4e37b12eb7d08312d3c48ba7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48902810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b13d5730bc4a80231e8479bfa7fa7fb0d54b1d7ca5d61f710da6129ebd39b630`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Tue, 05 Apr 2022 07:45:29 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 05 Apr 2022 07:45:29 GMT
WORKDIR /opt/drupal
# Tue, 05 Apr 2022 07:45:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Apr 2022 07:45:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ee46d2b93bdc447429dfa5c8f2bda3582de258e5421ec73053ce36eb3834afe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:090953a9d8fd7b81734671e07853a19b1eb02262eecc899c7e7e581054521552`  
		Last Modified: Tue, 05 Apr 2022 08:00:45 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10438dcccd1a59d2da8c43d811127b8e3e825223a04d470414bd152ad006a3ba`  
		Last Modified: Tue, 05 Apr 2022 08:00:50 GMT  
...
```console
$ docker pull drupal@sha256:211bc36bdaa72f567d846373712dc0427eeb2f6be7eace4b5403b391555c2d9d
```
...
-	Total Size: **49.4 MB (49397747 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e48d20f1f4b9f1d19536faf4f3162b26ea30676d2311a1939509e2d3c01278c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 22:30:25 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:30:27 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:30:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:31:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bad7aca65b4c0c8a0dd2788bf75d741b82e0319d12212873fc77c8283f4d787`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6eebe355cef417a9b8a646498f335f42d56f513443f40a1e4af8f3244b31785`  
		Last Modified: Mon, 04 Apr 2022 23:46:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:367ed53b4d8989afa92868d26d460da0a87b713bc715dcb583f8a7a90c88d8c7`  
		Last Modified: Mon, 04 Apr 2022 23:47:52 GMT  
