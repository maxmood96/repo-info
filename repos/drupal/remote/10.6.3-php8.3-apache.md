...
```console
$ docker pull drupal@sha256:e20ff4e444d9a45a692785ac14e0770f939a263bb4cb227fbc55b9ed06b1f621
```
...
### `drupal:10.6.3-php8.3-apache` - linux; amd64
...
### `drupal:10.6.3-php8.3-apache` - unknown; unknown
...
### `drupal:10.6.3-php8.3-apache` - linux; arm variant v7
...
### `drupal:10.6.3-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:10.6.3-php8.3-apache` - linux; 386
...
### `drupal:10.6.3-php8.3-apache` - linux; ppc64le
...
### `drupal:10.6.3-php8.3-apache` - linux; riscv64

```console
$ docker pull drupal@sha256:6a91c6e5b850f1793207f6e988c7f0b311454d0489ef88b2221b5b42830b7581
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.1 MB (227132707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df1fbaed2df443075a5b5088a3d435fcabcf1e357a2bf4f25bf8ec88e049569a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:711c03c2204201d437a79637f299027e37ecea6bf14303d1b0627a47ebaebe2c`  
		...
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7915202d896c0e8bef342d11c50781cb5b23011d5b534a2e3419a941d187159f`  
		Last Modified: Fri, 06 Feb 2026 10:12:02 GMT  
...
```console
$ docker pull drupal@sha256:dd34cf92081a64735d283628f09e4d477eb722dec950729f6c1e2a3574bc4893
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7445539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a5773e893e7f2d7e851e1c9006f2bf04cc3dca8b48cbd64432602ba916a687b`

```dockerfile
```

-	Layers:
	-	`sha256:a487a083ad577dbf8fa5a5582d53e48c49ded347f321b07feb754bd143dc5d6b`  
		Last Modified: Fri, 06 Feb 2026 10:11:59 GMT  
		Size: 7.4 MB (7401278 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d14a0e9e076376add97ea2934ea90ef525b501fb6605e43f3b9721ddfff01957`  
		Last Modified: Fri, 06 Feb 2026 10:11:57 GMT  
		Size: 44.3 KB (44261 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:10.6.3-php8.3-apache` - linux; s390x
