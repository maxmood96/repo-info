...
```console
$ docker pull drupal@sha256:4a75754b239773a763cf85a5ca95ae8cd98ad1e5c0ed4dd36bbd4348fe47eb44
```
...
```console
$ docker pull drupal@sha256:d7a0641c94d6ef0d9f61f2bb6c398fd2de17408e02cf67b8ba0ecb599739eaa4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141822450 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9744d509a65a53adf60d45876343445352584eb5859a1383dc324476566620d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Sat, 13 Mar 2021 00:45:03 GMT
ENV DRUPAL_VERSION=9.0.11
# Sat, 13 Mar 2021 00:45:03 GMT
WORKDIR /opt/drupal
# Sat, 13 Mar 2021 00:45:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 13 Mar 2021 00:45:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5739e007cc76331a3fd9d06ba3feaf7b311d837c0b88f8a72cf1556a304aeeeb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5a3f9b0e1bfafebc10b3c9f561ec26e4cd38dfbe74b7767c208312993bf51e5`  
		Last Modified: Sat, 13 Mar 2021 00:54:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e812529d12c806998c5ddc72a5e003aefa5051451e71435b78e6843e58057dd`  
		Last Modified: Sat, 13 Mar 2021 00:54:54 GMT  
