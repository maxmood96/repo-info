...
```console
$ docker pull drupal@sha256:653a7289be05a3f07c7c78fc6aa2a1ef7163d5274c9ff1eba9cad2eb012a7b02
```
...
```console
$ docker pull drupal@sha256:25945c661768c9758565defd09a131783cc02bd0b293c217cc059147ddb12207
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.5 MB (158502975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f5eef09c78b1be261a7021177c03a13c18f0f5e0c087666eb093a08aea82e75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 02:46:46 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 02:46:46 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 02:47:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 02:47:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0925533070062d129abc2acc333f6a4fbe0abf03adc4dd3758eb1e865e2f129d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37c95334aec22ef65b5fcb55a2cc44458ff901a0b4c6c793d0c6d78e8b1b2de1`  
		Last Modified: Thu, 21 Jan 2021 02:56:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d0f64046542e095ad28c920da021555442464947527a34702d98aff99b1c899`  
		Last Modified: Thu, 21 Jan 2021 02:56:43 GMT  
...
```console
$ docker pull drupal@sha256:cccb3662f5c12f15e49e45cedc86c3226b54ad944e1d3ddc7b8753298219478d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172438451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18d2abfd4be849baa63f603bb1f7d7c48c3e2aee52c11df66d155ac0cba339c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Jan 2021 20:01:09 GMT
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 02:44:35 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 02:44:36 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 02:44:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 02:44:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0d94ea28d29308784c58e13af6a734179ded77850bdf70d6b7f23754440a12e7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6813f70ff86cfca5fe93f3deb28bc3f8b466f317110a2e2b1f00fe30edfb9ee9`  
		Last Modified: Thu, 21 Jan 2021 02:50:53 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e60b06ffe04fa523a58899b5be59b1678c1b5ef41472cd73d06cb0402cde4ac1`  
		Last Modified: Thu, 21 Jan 2021 02:51:19 GMT  
		Size: 17.2 MB (17240871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:90c77931610353de9aa3f4088c7b3f1faba551e5b6c2139b662e723b972cdc11
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177835203 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f938e09e01ae5712bf5f48d2b64549c3a9a41d30d13f02d1930a58ecb573df45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 02:26:22 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 02:26:30 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 02:27:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 02:27:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d391295c9451146c835a144a59ca5c32ad254e6cf23d50142447f8a250cf825a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba76630b9299f70277c317b5fbb919fe80dce5aaed6573af5486d84443fd2021`  
		Last Modified: Thu, 21 Jan 2021 02:47:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c28958f345aa977840a24ea3ab82ee0e905618348eb34e0c08f2dd0508807f73`  
		Last Modified: Thu, 21 Jan 2021 02:49:39 GMT  
...
```console
$ docker pull drupal@sha256:b1b8663515e0919a26fc8edef537caf014b5678ccaec8008351e11a7e54321e4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152092766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdd6cd5c8780e2b1637309f49366863208a886591ccf1156c47df5ba33468ae0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Jan 2021 15:32:44 GMT
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 02:50:13 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 02:50:14 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 02:51:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 02:51:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89a7af6cafe934af5934e71948831c9624edcb0bbb9509bafe96d8248525e10b`  
		...
		Size: 508.4 KB (508390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18512e7e6d57d7b8fb9a52027b5e91757cfb33bee9f4e1c6d41b5c58c107cba8`  
		Last Modified: Thu, 21 Jan 2021 03:01:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39bd58e0a8a04ce36139af46d2c48b35dda1bbd5a786883b75a2f9dbafdec338`  
		Last Modified: Thu, 21 Jan 2021 03:01:33 GMT  
		Size: 17.2 MB (17240858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
