...
```console
$ docker pull drupal@sha256:5b4cb18e7f22f9b5190181cf0bbcc105f2a3024d3da5d8a299b5b8a8abcf3421
```
...
```console
$ docker pull drupal@sha256:48343e8e56b9155f9f915b48892f4cb9ae30c07f3f2c33c333458fcc6015380f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.5 MB (166460697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c2c5fdce4c9d21bd312b50390310e92fc7d31b7cbeb4ac4b2b2829e980ac2a8`
...
# Thu, 01 Apr 2021 20:49:29 GMT
WORKDIR /opt/drupal
# Thu, 01 Apr 2021 20:49:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Apr 2021 20:49:59 GMT
...
-	Layers:
	...
	-	`sha256:3480fb1fad3a1274b5a9a546c8b490e193ec44c245eff2b746c5490652775a91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd0e3fe71d79681ce1010087b3a1cef14da7e1f23179122b499be5f6844fe19c`  
		Last Modified: Thu, 01 Apr 2021 21:02:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bdc42b0d8139d3b77eb1707f79e107dbf018e7076ef773ca2c0a59afb243bb7`  
		Last Modified: Thu, 01 Apr 2021 21:02:33 GMT  
...
```console
$ docker pull drupal@sha256:5dd524f186ee7886f1e9761e23a849186f52793fecd224984bdea9e0d31914d6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141852358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be7b2957a34abf84459bc0d62ce8a5ac0f07f543df0efa4e0b891a47038db1da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Thu, 01 Apr 2021 19:50:48 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 01 Apr 2021 19:50:49 GMT
WORKDIR /opt/drupal
# Thu, 01 Apr 2021 19:51:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Apr 2021 19:51:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8d18c3c59ddc8e3121dbe5dbf87250658b308278d6b5e859d474f36da5b6b390`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2dc4e29934693c40710e0979e01587e0c0bfd4d0ed1ed01c5b54517a22ae60b`  
		Last Modified: Thu, 01 Apr 2021 20:06:51 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f2bdce011be196ce3c8d548caa7d6c65cb5300beed8ecd9513519eb0aaf1dc8`  
		Last Modified: Thu, 01 Apr 2021 20:07:03 GMT  
...
```console
$ docker pull drupal@sha256:e16328b62b6071aa33de651cf3f1d2d210f472264c3126735abbac53756f4bf6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.6 MB (158569065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af8b202a0fe7b444d0eb1b81c1feeaa1c023ec7a4393e321d10c6f2dbbcf01b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Thu, 01 Apr 2021 19:39:43 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 01 Apr 2021 19:39:44 GMT
WORKDIR /opt/drupal
# Thu, 01 Apr 2021 19:40:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Apr 2021 19:40:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1b4dea4920790d56474d6bbb9a65352f2c7466a2ec814d20d55262f6727af6e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c1be06f5b01e2047f5132840f461d7ca20fd5f38a9bbfeb33e672d1b9089e5f`  
		Last Modified: Thu, 01 Apr 2021 19:52:14 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84c1822b6a19af52ad2de2f28f2c7fe68801ea168f5de7314bab30b9aca20d8f`  
		Last Modified: Thu, 01 Apr 2021 19:52:18 GMT  
		Size: 17.2 MB (17240799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:93eda697357b1d59fe71b790688f7647a636c97997a18e41e613264939050b5f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.9 MB (177902476 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09b51df09d17f37a9e678e92dd40a0e3cf43e66b3ed59a5011017672bb08f30e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Fri, 02 Apr 2021 05:21:32 GMT
ENV DRUPAL_VERSION=9.0.11
# Fri, 02 Apr 2021 05:21:37 GMT
WORKDIR /opt/drupal
# Fri, 02 Apr 2021 05:23:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Apr 2021 05:23:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8aaba9f693a30b2164f1012b52f7661e7b2b6e290130a86a936dde38fefcb303`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a55982d08ffbf9e8ff5eebef42924d3e1d8ea0336659143b631115a64fa1760e`  
		Last Modified: Fri, 02 Apr 2021 05:55:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c65263c3c29b13a2c155222383ecb9f9c1055b645421b819989ea97fd868b789`  
		Last Modified: Fri, 02 Apr 2021 05:56:43 GMT  
		Size: 17.2 MB (17240744 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0.11` - linux; s390x

```console
$ docker pull drupal@sha256:e5fa57e98002b2b9c48aff39cd6b3763924bfca66ddc958e3d7f54ecd2d39091
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152152507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e31e1767927b9dc9d8e8b57170bb65ce145a7ac35b885a8782cbcaeac4b6c2cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 10 Apr 2021 13:29:34 GMT
ENV DRUPAL_VERSION=9.0.11
# Sat, 10 Apr 2021 13:29:35 GMT
WORKDIR /opt/drupal
# Sat, 10 Apr 2021 13:30:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:82a1da9b6d44bbd44ef066ada27fbe02178d330fa2b2ea4d4546e3e611978680`  
		...
		Size: 507.5 KB (507537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f79a906eae48e2fd52ffcc7c7a8d42c466535f8b62873319bedb332bda7168a9`  
		Last Modified: Sat, 10 Apr 2021 13:37:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fc8d3b64ecfbce9a8bbfc17e40f7299eb29421142d633a0f5cc1eb493c6f1a1`  
		Last Modified: Sat, 10 Apr 2021 13:37:11 GMT  
		Size: 17.2 MB (17240795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
