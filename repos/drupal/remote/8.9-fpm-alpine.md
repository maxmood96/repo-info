...
```console
$ docker pull drupal@sha256:24944ac587a821b7b22de2a33e6fde551c00b8d51133ffc2d6f8c89fa2855eb0
```
...
```console
$ docker pull drupal@sha256:a48edb5d139142121013842f15d93d0a52211249f50c41eaff469da664a55d1c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53451401 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc091642a6f0d2df9f004e358236b1a15a71c19919f7720f36776102538a4091`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 10 Sep 2020 18:11:30 GMT
ENV DRUPAL_VERSION=8.9.5
# Thu, 10 Sep 2020 18:11:39 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:13:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:13:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fa99203e6ad97bdfb0b8c5e0d760622249b880d1fd12bff5f6eff9a7d3239069`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52bde2b6d19ba156fab2ff76b81931f37cba944fecfea97375759345a8b9575`  
		Last Modified: Thu, 10 Sep 2020 18:17:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d491231ada8b11e5adc5d07a5781a21004e966a63d840fcd043c8f0cdc3c5fb`  
		Last Modified: Thu, 10 Sep 2020 18:17:55 GMT  
		Size: 20.8 MB (20758909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:4f8eebe7347b9ad21d2db8c0454166c4cc02a2c1a5001e32b685e58dcac43911
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52186808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68e9ae120028db5460f5761793c6831dd028de491297d146e2b74f1af0b92665`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:39:19 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:39:20 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:40:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:40:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6e0fe9e5be5f87a4388d9be98230ea15920e7ddf87dc420e5939b474d497a734`  
		...
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ad799d49b7553bc70bbf83fb4a1653af196bcee9d2a9ba7390bab25779691be`  
		Last Modified: Wed, 09 Sep 2020 20:46:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2c68bcfcefba31a0ce4c9be43ec70eb142d38a2c03c9505beb485c2f4913efd`  
		Last Modified: Wed, 09 Sep 2020 20:46:46 GMT  
		Size: 20.8 MB (20758628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:626b899ed418f0d814c57d16efc214dcefb8c49e0ee47b5fc2394c2e7ceb53e4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.7 MB (54743396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d9087120d98f23aeb7787698e75ab40e5dfc294fa8627e3b8d24549f97efbdd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:26:22 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:26:23 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:26:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:26:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bef4716fd261156c2bf39a8959b167a1c649dfbbe8121d1bc78203ea5ef85b0b`  
		...
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:030c1b9e8b8fabae81af0e6470d855c1ab715d62db649874f98d7211eaafeb02`  
		Last Modified: Wed, 09 Sep 2020 20:32:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff0f54f82783920d420b4bd623bf140c4e9fad0bf8f1370ab8815f0a40e56be5`  
		Last Modified: Wed, 09 Sep 2020 20:32:56 GMT  
		Size: 20.8 MB (20758207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:41b0f326094ae5d0fe62b5b674e314de5bebf2f6d3ceb3b2deaa6852dbaafb5f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 MB (55661691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20aa6a8a2107e3e88607ff91c563fea29611166e5e58e98c7cb9b2856b631064`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 10 Sep 2020 18:58:30 GMT
ENV DRUPAL_VERSION=8.9.5
# Thu, 10 Sep 2020 18:58:30 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:58:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:58:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ca592d0c8fbb5772ebf4fc92f5433fe695d6f2939079bd824cf8e1a3d27ec8d1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31669b8427d86697dc4e0a25a855abf25eb51ed2a726f585aca3052a829d05c1`  
		Last Modified: Thu, 10 Sep 2020 19:04:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcfa54d7ca731babfb069aaa7b0bb2daa7877669b3ab63940df27d53b47ca57f`  
		Last Modified: Thu, 10 Sep 2020 19:04:58 GMT  
		Size: 20.8 MB (20758505 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:5221e2e18378a7a8d543e98616def6792b9ec70677cdccfff72dc1ebdd04fe82
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.2 MB (56160054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d0adc965052be12c56cfa18fdad2c64b00f73196129fccb3348954bc3cb90c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:48:04 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:48:12 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:50:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:50:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89918b01ce14978a5dc1d716ff27de98724dcd01fee8a9866063f1a49a3391b0`  
		...
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7765baeceb87e61544f2ad3fc5ebe1354ec63037e30512b818411978019c437`  
		Last Modified: Wed, 09 Sep 2020 21:19:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26fcf6207031e1c602cb791409a95bb15a17303623b7b48bd6df5f652c2033fc`  
		Last Modified: Wed, 09 Sep 2020 21:22:11 GMT  
		Size: 20.8 MB (20758493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:67c771dfba29308180c8395a5711dc2dd51579c69d555e9fcb441c90c232b659
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (53966269 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15fb831e10b29e6cbc9dad01265ed72d772377b5ad11c54316fab83502f80afb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 10 Sep 2020 18:00:24 GMT
ENV DRUPAL_VERSION=8.9.5
# Thu, 10 Sep 2020 18:00:24 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:00:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:00:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc7a928a8a2c2a0f0e242d3d55f2a7f6c6fe6d069422641fb390835e6e69e673`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36b25d79b0cee7325947d3554be9c3e81e2f0c1f487a23dff3bac678998d7084`  
		Last Modified: Thu, 10 Sep 2020 18:05:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa9c131c4b866363017020292f9615ad9c43c9cf0b2cfbddb20b81ddb9e3e8de`  
		Last Modified: Thu, 10 Sep 2020 18:05:47 GMT  
		Size: 20.8 MB (20758401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
