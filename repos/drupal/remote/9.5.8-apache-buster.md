...
```console
$ docker pull drupal@sha256:8214ddf3ebbc00255a09314caa4927a5cde402833ca236fef6f6b7e69e342a86
```
...
### `drupal:9.5.8-apache-buster` - linux; amd64
...
### `drupal:9.5.8-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.5.8-apache-buster` - linux; 386
