...
```console
$ docker pull drupal@sha256:075e8a59dd5b32b63175c62f7080a2fed253ece897c7576f78320ccbb1993a87
```
...
```console
$ docker pull drupal@sha256:b0a030e5e1b330ede0e76d44c8a4918f4049c33194de891de8e086d13c821dbc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53360884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:249b04922bd1bb0bd63225e874c93980fadac890e53bdae8fa253dad9184f560`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:1e6c1bc26266278dc6beb3a60c9fef58569076edb228ee07e1df79ca27559bf2 in /usr/local/bin/ 
# Wed, 17 Aug 2022 23:12:08 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 17 Aug 2022 23:12:09 GMT
WORKDIR /opt/drupal
# Wed, 17 Aug 2022 23:12:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Aug 2022 23:12:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dd4f1937d5ccfd8394c51ba26670c80ec6d85d14e7e61c915845cb4f577c6b87`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dde818008c51c8ae4d408c7ed410e218b239ffd1c1ee78deea309245f857d7dc`  
		Last Modified: Wed, 17 Aug 2022 23:49:14 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76b4e2b201cf4d00bfc9ab1935e76a72f9815d0d283bd0285073ea0f9da0a4f`  
		Last Modified: Wed, 17 Aug 2022 23:49:10 GMT  
