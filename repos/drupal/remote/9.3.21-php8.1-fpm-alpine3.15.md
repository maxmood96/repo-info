...
```console
$ docker pull drupal@sha256:e305ee663ea5f9aa9fefda28bff300ef7773a91ddb25434e66b6be5c104d429a
```
...
```console
$ docker pull drupal@sha256:2a68d41f06e69d5d282f2b5fe9666cd187530af5f5675aec7922bc67b34db549
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51850050 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3e59e856b61285643a3813eec87d23be6ae7f68448750697fa41c899a404da7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:15:22 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:15:22 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:15:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:15:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2e861796a1bd0a45d84f6b37467558dc259d3a42e91d6f9ac4f97f051661dfcb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e59c9b3c79df43bf7c24e90e325e4e4b5ffe1998f2b147ee39c04bd03683242b`  
		Last Modified: Mon, 22 Aug 2022 19:45:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17c038b48c46d64d38bed843351084e7fcec94c95f68c7a8d4b5b2d7003db440`  
		Last Modified: Mon, 22 Aug 2022 19:45:23 GMT  
		Size: 21.3 MB (21312675 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
