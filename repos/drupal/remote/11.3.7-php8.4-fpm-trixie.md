...
```console
$ docker pull drupal@sha256:95c666b715fe60c8a753c007590554eb6ff47462a7f78452c46aba55958c3a60
```
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.3.7-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.7-php8.4-fpm-trixie` - linux; s390x
