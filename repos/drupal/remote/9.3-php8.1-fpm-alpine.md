...
```console
$ docker pull drupal@sha256:2dad0673c82fc357cd419a26c709014857f79a9f60463f7c5da65af90e4f30b0
```
...
```console
$ docker pull drupal@sha256:307c54b211ac33b50b36bdf38749d52e9fe142f0c73c873bc9a5092a44d7edac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51585652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:523a76e5b9ad2a608f4391eb82f38fcc6e01fc3808d3d1b380d553a781e4102d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:14:56 GMT
ENV DRUPAL_VERSION=9.3.21
# Mon, 22 Aug 2022 19:14:56 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:15:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:15:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c15ca872aeb920b746fb949df445b8a5be5a663a59ab442a5871e27714c0da3b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0551e756e8caefc3eefaf020d015be4b3688747e104c919e762b495d49adaf8b`  
		Last Modified: Mon, 22 Aug 2022 19:45:04 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c5f1d911e6d3d4b73af7e91dfacda8388b59bddaf826bb4c87163fab98bf90d`  
		Last Modified: Mon, 22 Aug 2022 19:45:07 GMT  
