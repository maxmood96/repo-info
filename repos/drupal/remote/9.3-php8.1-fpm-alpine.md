...
```console
$ docker pull drupal@sha256:9b8b4b685be83a474f0d15d8268cbcfd01bcf1071d3d6dd355facaff82a51f67
```
...
```console
$ docker pull drupal@sha256:30c85815d05dd265564928981ae24b7646e4983dfaf3058d8e515971bcc80c58
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.0 MB (54970988 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32c19798af4d8d26056dca4f4cf2e2c2c07123b7859ce9c0b038f399436c5a55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:48:57 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 12:55:55 GMT
ENV DRUPAL_VERSION=9.3.22
# Fri, 11 Nov 2022 12:55:55 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 12:56:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 12:56:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8c7dc6473c0176dd45a7da81ef13d61278dc167900da64858464d4dafc81e1b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b7388e18fc3e2967a2ea10e5d3476816737aadaed538223d319b917770a2798`  
		Last Modified: Fri, 11 Nov 2022 13:09:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25427caf3d98ce80552bdcabf2f2f830d8c0fc020749b0ec4f445a9ddb88a88b`  
		Last Modified: Fri, 11 Nov 2022 13:09:06 GMT  
		Size: 21.3 MB (21314873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:ebbb945732ec9490c58cb944b3a03ac239a5fa1d72b0338b16d43fab7a86c5fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53655969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dae8785165dfb6121279a7cfcf4f07dff16bbb83345da8a9641bc522f72aaeb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 28 Oct 2022 21:37:46 GMT
ENV DRUPAL_VERSION=9.3.22
# Fri, 28 Oct 2022 21:37:47 GMT
WORKDIR /opt/drupal
# Fri, 28 Oct 2022 21:38:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 28 Oct 2022 21:38:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ee4f54f472b95452d1c68a09bf22c4fa4ce5d448b1350f6ec72b0547bc6f1367`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d177d221cad7e87e400fb3b242f52a7a6df603d1e4b216f8509f646e2e415dd0`  
		Last Modified: Fri, 28 Oct 2022 22:10:17 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:333dab261d66cf29ef2e40e9310557a586013ca680d5f739979834b8a1c7a5bf`  
		Last Modified: Fri, 28 Oct 2022 22:10:22 GMT  
		Size: 21.3 MB (21314613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
