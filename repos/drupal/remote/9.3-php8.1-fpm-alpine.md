...
```console
$ docker pull drupal@sha256:7c706476ae406ae6b9f14d4022396826fa123762e2f59d8f838cee89c3b52e2e
```
...
```console
$ docker pull drupal@sha256:73a9224ba4947344d97f3e113089b8b5bcfe2a794f204a1e58662ba966b3e2a6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53316293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7878d00e336b55ed5f0a4a71c2749a730bf3cbf581c48deac2df398d2463731`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 01:51:11 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 01:51:12 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 01:51:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Sep 2022 01:51:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:499873fb34d1a6568cb16aebb6cdc01d01ed1fd6a46c4bb8a76ac51caddb66aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c06a351fd1e4b73e1daf7ecafcafa7cabcb0bf053c5f0e206ede38414b485659`  
		Last Modified: Fri, 02 Sep 2022 02:23:04 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b462a11e2336919993c21b52ab4173991271c8b3f8dc020037b8b0d32aef41d0`  
		Last Modified: Fri, 02 Sep 2022 02:23:09 GMT  
