...
```console
$ docker pull drupal@sha256:1a5747e2a827183deffc763dbca22083293c85b4c74edd9d0bd5f3b8d4ba57be
```
...
```console
$ docker pull drupal@sha256:474881ec734e99e41837c055ac2445d507fefb0f2bdf4c97f26c7e74f92e7a16
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49718753 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f13417b709011b8d71c9062ae7ddf200caa867843446d628f4c6b7bed0c7940f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:05:08 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:25:34 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:25:34 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:25:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:25:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b824af9a67013f89ccd77575e5c128aa4f70aa1c18b2786fcdf65019479f1804`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5132eb5498506567e21c247c12f6895e4428dcb82b2f9fefe09d395026876c7`  
		Last Modified: Thu, 04 Aug 2022 10:13:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:407797b3bfd9b09ba7057fb99096f9a669f72a20804659669ce2d654f7d1321d`  
		Last Modified: Thu, 04 Aug 2022 10:13:15 GMT  
		Size: 21.2 MB (21214475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
