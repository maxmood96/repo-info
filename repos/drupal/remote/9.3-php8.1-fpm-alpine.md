...
```console
$ docker pull drupal@sha256:722776dd6a68f41bf7267b8faddeaaab7b9c27d33256e3fb8ee40dd9ac147c5e
```
...
```console
$ docker pull drupal@sha256:9c80c7e03d8e7ba5e89f920b960d0de2a67c3eecd993e5e8efe8dff8ea423db8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51188735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40cb31cfd05a9742786da232957a0a5cacd302dada76d148dca6af05812cf9e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:92a4e2a44fdd98a7ac0ced1583b61b38fd5fcf54499364d15af7e9c16fb3aa6e`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ed2378ebe286ec5c3f63b18409817ca7745b582ad38d7c60585e990c9b543e5`  
		Last Modified: Tue, 12 Jul 2022 02:21:24 GMT  
		Size: 21.2 MB (21208461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6e9854d4b87249521fe58d8f119547ca21ec468c5f15641fada005f887d0a7e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.7 MB (54709474 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51d7c614592a658e015e3eb32a413e7b7e4bd19ee984e112a47165baafb9218b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:58:07 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:59:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:59:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:83c2839539fe153a0ea17bf1de0e5a268215ef5ea9cb87c2168c9022cc714c1d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd0bf6881a9ba7c2964081242a261034945cf60af70b54a4cda442721b449b16`  
		Last Modified: Tue, 12 Jul 2022 02:38:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:093f1722ef181b9c461143a3b5685a27796cc73ac91611958c266b057a7b0301`  
		Last Modified: Tue, 12 Jul 2022 02:39:13 GMT  
