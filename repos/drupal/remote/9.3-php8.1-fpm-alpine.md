...
```console
$ docker pull drupal@sha256:e2b4ca1ccbecfe2aad7de8beac8e08614bbc84d18d456661321cc798a9e708c0
```
...
```console
$ docker pull drupal@sha256:752e2c0a5ba0705fc69d0a2ab3b61e54f038f032da034262391de8dcc0d7357c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52678164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e10d0f5956f716059ae53fa94ea527e87f15f6aaefc280a5193f779add852d4`
...
# Mon, 06 Jun 2022 18:30:55 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:30:55 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:31:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:31:07 GMT
...
-	Layers:
	...
	-	`sha256:ac05ff9c040f8511969dea1402620f8333208b52295bfd82f7ab4aa050aefc49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bcb7ad362a80c78b56d385ffba6cd01a50b9f8d738b600e2f8d243e1ee33f87`  
		Last Modified: Mon, 06 Jun 2022 18:46:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36b2f20208954405cdeffccff24afcf8a9d51c8b233a4b61fb19f1af2fee0240`  
		Last Modified: Mon, 06 Jun 2022 18:46:34 GMT  
		Size: 21.2 MB (21201031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:9e19935bf14295d4562eab8346a420f382386537d070ab9042be48c4e1bcda83
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50807734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:646026085764f700ca8de9899450fdce2f15a7479274e2e9c0ef6835b3206b58`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:53:24 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:53:25 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:53:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:548a2520971d97d8191e9d00327b870d8b215bf29a8d9fd49925f514d95b841f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abb757a8a01917d0767900dd148f02a3038d57eaaa2fee6add73bc92b6492c43`  
		Last Modified: Mon, 06 Jun 2022 18:06:05 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9ef371603828eafe0d3f59addfda2b5d20593f7f3455d7c6f067a80f73e3358`  
		Last Modified: Mon, 06 Jun 2022 18:06:35 GMT  
		Size: 21.2 MB (21201313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:17efb5b4b373948b5ff1ff3ec5f1e7729d402a82001226e4857e5513e85ba1ed
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49676340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bcd799ee29d54e9b745e7931c7ce0ca5e13dd655a283a8c60b2dbf6bc751d030`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:21:31 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:21:31 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:22:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:22:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f65508d562f90268a4fc724a8aa26688070ae03096a0934e72597ae6d40f2163`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83398391269d34515e26700889531da32d78496203aa8e79ff9beea219ce124b`  
		Last Modified: Mon, 06 Jun 2022 19:16:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c20fafd66bb8b0aca4019a2a7857ff4f2e432da9f09c08d4e6fb5b79ed4e946e`  
		Last Modified: Mon, 06 Jun 2022 19:16:35 GMT  
		Size: 21.2 MB (21201525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6a00e62d2e2fc61b07a3c7809a6564ff269fe8897989496bc96021e7ef6e667e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52860310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62b87b8dd0152ce2b5b7fe6aa24a5fc31e8d331c4b7474f743e1a33f8b3f3f04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:53:41 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:53:42 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:53:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:53:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:34e621beb5d9f975a009a3057599eed94e711739bff55c6548227f1a2232f36b`  
		...
		Size: 669.8 KB (669847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac387ef84118d0c7db472b141ac1d64c4bd8cac559e7a88e02da7cac4a57c81d`  
		Last Modified: Mon, 06 Jun 2022 18:20:01 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f3263761e4f631847d866ed15fd41f40d429709a0adc653627d94bcb09ff93c`  
		Last Modified: Mon, 06 Jun 2022 18:20:07 GMT  
		Size: 21.2 MB (21201587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:8b80a2cf171df2a91b458a3af3d8bda9419136ac292c37c4b3e5af36cd4033e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53148601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9ebd66ea5dd71a6b5a7c5a80d0b125550d4f256d049d61c513ead2744c64dd7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 17:48:35 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:48:35 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:48:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 17:48:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7cf857253d190b61d573c7a6178c81f36269ce9215139460a961a9508e2d840c`  
		...
		Size: 669.8 KB (669847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2e967aab578379c774ad8aabc0e36b547f07a1d6dc19cff71350a0dce00d61e`  
		Last Modified: Mon, 06 Jun 2022 18:13:28 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cbb4a253767ccba51b7adc7769e441fc22d2759ce0502bbf0c762b2acf75cc5`  
		Last Modified: Mon, 06 Jun 2022 18:13:33 GMT  
		Size: 21.2 MB (21201322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:72651cd823b8779e6bc1ff1980d27b588d188e3a2e42ace5d2ef42bcccb8e826
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52890305 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef24b961e035272761cf22f10eac264887c9381a0e3517898d95a7af2cbc85b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 18:48:54 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 18:48:59 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:49:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:49:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b311a789bb28a7f1f0994fd27ac7bbd29a842395ad149b91771ede0f199d32b7`  
		...
		Size: 669.8 KB (669845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4678a51f1fe573497921c6679a72a030fed587af5a4b6fac4da1011c4cab0c66`  
		Last Modified: Mon, 06 Jun 2022 19:46:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6be311fd6a5349984905c0a2b746b7e51691a47c6d9459e1efc59845c64b467a`  
		Last Modified: Mon, 06 Jun 2022 19:47:47 GMT  
		Size: 21.2 MB (21201277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:2093065f2a51870fa2ee30454fb4969a29b594824bed33f9adac440be2caf953
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51334786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f6f43697d22b42e803eb3f4746fd3bf463458650675b7cc2d663bb6dacf4d56`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:17:46 GMT
ENV DRUPAL_VERSION=9.3.15
# Tue, 07 Jun 2022 04:17:46 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:18:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:18:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d5a534e60d128eb35b95e067376eff23b2f639d5cb3002af4ad3294c70683011`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e270ac69a9e8c16244af07eb55e3cf2cb8d0f118592d2ccbf82e583b0c441fa8`  
		Last Modified: Tue, 07 Jun 2022 04:47:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3228f0a582bb41310be991a8100890f91192c882a3d80c0596a35b7b84c4df06`  
		Last Modified: Tue, 07 Jun 2022 04:47:28 GMT  
		Size: 21.2 MB (21201391 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
