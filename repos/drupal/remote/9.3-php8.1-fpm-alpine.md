...
```console
$ docker pull drupal@sha256:2457b2f2cf4b96383b96b11ea0eaa5421b3ba52c30a78410d42d00826b4dcb4b
```
...
```console
$ docker pull drupal@sha256:053e732410c3d80a2278bbb74e7bb4781ea4766c00b42da34eead2cba0cb6fec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53137221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47b680049101cd863c590a23e20d4e331be80d7ede83eb0f9c93710325f4f64e`
...
# Fri, 02 Sep 2022 01:28:32 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 01:28:33 GMT
WORKDIR /opt/drupal
...
-	Layers:
	...
	-	`sha256:f32d22c7852ec7da1d538e96f598a62692b8fb1103ce2c6fa7e10a991df753de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc47ef8fb108ad604e22c9a80623ee3ac24b481122677058bdc5db0af6581dc2`  
		Last Modified: Fri, 02 Sep 2022 01:50:18 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:214611843188b8f3dd1fdfa034533b2e02a4e832af85a2e9babd00dca30a8988`  
		Last Modified: Fri, 02 Sep 2022 01:50:23 GMT  
		Size: 21.3 MB (21312505 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7289ff79b204bc626215cfd01c668c091c89fa00053d4169e55bde13baba33cc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.6 MB (53628684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20c0918198965b4817ff7faff4f2a6ad6bcc5fb3b6727c5ca77544d129cde3c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 00:18:14 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 00:18:15 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 00:18:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Sep 2022 00:18:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:52318f11e681f3d433be62d354d5cbe350a68f48ba19d3af4f91fa09420ea3b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22709233c77bbbc9a0853c60fcfcbea68064494b38ba7087e618d76458e74a1a`  
		Last Modified: Fri, 02 Sep 2022 00:50:51 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7914eaaaae0ed1754f7fc8e2e47406ccbb25a66770ff5108d5167faffbcae177`  
		Last Modified: Fri, 02 Sep 2022 00:50:56 GMT  
		Size: 21.3 MB (21312097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:674a42454f1c99663a0e9389d4cf316047c75f1a6b8851a046c716bed1105b8a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53096770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a906f8c0e099ba0e38e1ed08ceb5759a5da90810547e248a533aa7a7c9c6eca5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 00:28:29 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 00:28:29 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 00:28:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:888a1ad7a4dfec7f2bcc10b6fba65ba39c52939b6228a923678a6f254bc165a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76a34382587ffe7fb35a350cf0bc0cbecd54efb69d31e1e1d33087fb21a590e`  
		Last Modified: Fri, 02 Sep 2022 01:00:27 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f0a42494d62e21a1188c10468f453bae093df8686e32a596514f401a4670953`  
		Last Modified: Fri, 02 Sep 2022 01:00:52 GMT  
