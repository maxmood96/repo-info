...
```console
$ docker pull drupal@sha256:f847b3fd82ab6104319a5d09d46d952382f4aefbd916fb12316d6952196d3f0e
```
...
```console
$ docker pull drupal@sha256:9da88fe0f18216e6518efe871661d1853e3059785b28db1514673c03413b134f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50076451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7858e52d08acb6225f7fed3dad2ecd07ee9662d091188cd1985b93bc5b6ebc34`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:35:30 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:35:30 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:35:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:db8d00115c740d08dc5189b26757569788e5b204bb76d535954af1c4f451c627`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb81b83f321db97eb016f08c135dcf6f2abfd15b35987c6279230455697068a3`  
		Last Modified: Wed, 28 Sep 2022 01:30:36 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fab9202f2a6991f7ea188bb0621c6d74d70b7a67e0cb817430d3efde66fd2f40`  
		Last Modified: Wed, 28 Sep 2022 01:30:52 GMT  
