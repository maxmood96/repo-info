...
```console
$ docker pull drupal@sha256:4fa4e626d251b1ee5a6770a5c4d6e76ad8d1f4626e153b4d512ccfacb69b4c8c
```
...
```console
$ docker pull drupal@sha256:40270da2c2fadc2a4b0fa8364e17f2003f8449a2760eea1380dd79ddacc8ef4e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52932689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c161a9dadadb878499ac8d81fb85e9ed055e4eb0cfebe6c378e2035a13735fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jul 2022 01:26:51 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:55:20 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:55:20 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:55:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:55:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f68f16bb9a1b76f67b64c7f913b32447aff1c2867fc4e09501f0167e31b1d2dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7837b3a64891141c25201ab4cd546c249339e03d280e07a99b3e154ca350e972`  
		Last Modified: Fri, 29 Jul 2022 02:44:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7b18b9e34e507660396d2a238d414e4d9b0b215e216388bbb36c2923b70823a`  
		Last Modified: Fri, 29 Jul 2022 02:45:17 GMT  
		Size: 21.2 MB (21214713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
