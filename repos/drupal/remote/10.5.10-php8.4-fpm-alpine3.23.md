...
```console
$ docker pull drupal@sha256:b0730b8f7654db37e2831f4cbf7b93c1d37eeb7c42a73ac8cf8c60722a15e0fc
```
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; riscv64
...
### `drupal:10.5.10-php8.4-fpm-alpine3.23` - linux; s390x
