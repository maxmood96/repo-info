...
```console
$ docker pull drupal@sha256:111e62b8c974ef53eb69ebc48695efd9e4d780b0bbf0f7615a6688bc3d0da160
```
...
```console
$ docker pull drupal@sha256:fd5aedc688dae0c5912134fb348bdd839b07f76673c75f3eca22c8552fab6abf
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.1 MB (37090866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21a1e64998b0d40b0d510949aef9ec39ba112e58f0090ef1fe20228f45d9f7ac`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 01:21:44 GMT
ENV DRUPAL_VERSION=7.72
# Fri, 07 Aug 2020 01:21:45 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Fri, 07 Aug 2020 01:21:46 GMT
...
-	Layers:
	...
	-	`sha256:41cac44ade56068772f9faa19b8720710262735c5dd1c36453e15c2d8823734f`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccd98d81c2dddc5505427aa9f7d6039282889c2711ee0910e9b417ce91105a1a`  
		Last Modified: Fri, 07 Aug 2020 01:23:42 GMT  
...
```console
$ docker pull drupal@sha256:0381c56770dfd3cd8c998aff81ec83ddf244690fbd57d5bb01e998951eef6a3d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.5 MB (35520122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a96f4a256f03b474b59a649c9cca151c6a49ab83e0270b4ff901c531e3a6794`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 00:59:41 GMT
ENV DRUPAL_VERSION=7.72
# Fri, 07 Aug 2020 00:59:46 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Fri, 07 Aug 2020 00:59:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ae9028df1df01690ff9bdfecce1b4a985f18894f9a1abeb62f689b904a43958f`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f651a4403544b04b04350ae93ec93af806ad9e3079b3e900739df9194d4614da`  
		Last Modified: Fri, 07 Aug 2020 01:00:56 GMT  
...
```console
$ docker pull drupal@sha256:b2f4ff5372483fee478335fda2125561f0b978fa467f0439dcd8eab35e82316c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34253519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:071ab4a9ca36bcb63872b7994d9b22abffcad881b1e45046bd19a0ba5d9e0877`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 06:14:44 GMT
ENV DRUPAL_VERSION=7.72
# Fri, 07 Aug 2020 06:14:46 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Fri, 07 Aug 2020 06:15:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f84303067df8fd137c4489e065b5301f43f1b1a03c062b5085619a8a3c0e2040`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68696f8c62884d820834581ff1b31785fd868838d194713da8223811172e0737`  
		Last Modified: Fri, 07 Aug 2020 06:18:15 GMT  
...
```console
$ docker pull drupal@sha256:a0c4541431a36670c18c552cefe2336773d381c2efd8b34bc53c3315fa6b177f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.8 MB (36811173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:666ea88e1f1cebbd2829dbd56c3e682c038605225a34cd313b64f550f51064f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 00:55:08 GMT
ENV DRUPAL_VERSION=7.72
# Fri, 07 Aug 2020 00:55:09 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Fri, 07 Aug 2020 00:55:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b4f374249ef1aeca91913d8d9aa71767c6de3481e9fe7794ba704adca5d2bf7e`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74502f53d979f044f899306dba6c52bf2e875510581fa9fee9b4759dafa2ad3c`  
		Last Modified: Fri, 07 Aug 2020 00:58:11 GMT  
...
```console
$ docker pull drupal@sha256:9e80664ea04d94e67db670a6a597b9d2b04a100c95538e8f2a386f8a3dc289f5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.7 MB (37728470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07d9c3c57ffe14e2c305e54ffcdeed31e14c206c2405cc20074c2ccb8fb9a9f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:5df2e3ed89b1f2c7c0abe4063adc1f20bb07ad7227a368998841f674f69525f6`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:455d5dc2192b40590fd76a31832a0fafd0ac3fcad6c0d59ee6107dcdb09e862f`  
		Last Modified: Fri, 07 Aug 2020 03:00:56 GMT  
		Size: 3.3 MB (3343897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6b87258d6e7c7990819bd0a086c909216ce1ea087c0873d007f143492db73282
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.2 MB (38228981 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f189d6e024a05ee5c3d0a6fa8b3e2dcc4cc30e57c0d60710ac7f40a8f1bc887`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Thu, 06 Aug 2020 23:38:05 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 06 Aug 2020 23:38:10 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 06 Aug 2020 23:38:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5a43021e5d919503c16ab7d0b634fb632ba925a69127edf92197f2a2d69884c1`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a178037b606e150aaaa3a8b8eba6e1ea719572ac0d5b1607455e813f81d299df`  
		Last Modified: Thu, 06 Aug 2020 23:42:15 GMT  
		Size: 3.3 MB (3344346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:38db6b1c5498b4d03dc3056961a299398e8cab0445183902109bd5d6d1dae573
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (36033639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adefbd54928254cb7a3b74f83e7975720f4453f4b54d125bcba5bcf28f63fc7e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Aug 2020 20:18:30 GMT
WORKDIR /var/www/html
# Thu, 06 Aug 2020 20:19:39 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 06 Aug 2020 20:19:39 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 06 Aug 2020 20:19:40 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a60ead41dcee78fb2039764dbe5cd28abb582d225f26ba69db5f55c1be97e826`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ddd800f69daba496b7d4bb8b0ba3e4e0bbd2392e66538cfc1430aed185be1ce`  
		Last Modified: Thu, 06 Aug 2020 20:21:40 GMT  
		Size: 3.3 MB (3344349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
