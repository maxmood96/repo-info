...
```console
$ docker pull drupal@sha256:206663208a3049cba59f638f39a2631fd8415158be2fa5bfa2f96f10b3dfea05
```
...
```console
$ docker pull drupal@sha256:450207a04a19132dc041992a10cb6ced503683ed8dc55828553d410098981652
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.3 MB (38324406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c21034fb3bbe514f6382f4a992593d26185a06f63ce10c7bb7321775d5b718c6`
...
-	Layers:
	...
	-	`sha256:6cb508971c9b9589f6ad5e35146467e6c5104a6a9f1d896a1427529b0ca905e4`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a83455171281568b1587760a22ff3a8371c65374cb62af7c03726a40defa83a8`  
		Last Modified: Sat, 25 Apr 2020 00:43:21 GMT  
...
```console
$ docker pull drupal@sha256:d185fcf5ecc222abd0ec081e72b6e20956d54531b49ff521d50c451203b46c66
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.4 MB (35404360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efdaaa57c6ac6bd02a4ee3b68a233f4b855f1f321b05a05694be0476a41b8af3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 24 Apr 2020 18:14:49 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Apr 2020 18:14:49 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 24 Apr 2020 18:14:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c1594651a745dc8d77ce33cf317a9c7b6ce45c15643fe8e88b14902b7e13c5b5`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae64331dc46968900049896045a86d1faa851b00b373c55694c8051a9634ab05`  
		Last Modified: Fri, 24 Apr 2020 18:17:34 GMT  
...
```console
$ docker pull drupal@sha256:1e4b2f1ddd7a5b99c9c80b5427341fda14e776ac3170fa08802f7673d89c59d2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.0 MB (37970974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0dfbfa8c2a55327c9a6769e877b6a579dba857e8d50354374c00366ca5337f00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Apr 2020 17:23:51 GMT
WORKDIR /var/www/html
# Fri, 24 Apr 2020 17:25:12 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Apr 2020 17:25:13 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
...
-	Layers:
	...
	-	`sha256:ba6a4173b84ee470b9af20930859fc690f4adab159caaa12aafaeda78b78ea4b`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04b97452f999ffbeab4b460f988e93eb26846ddd2680be4cc76634fdcf2af5e3`  
		Last Modified: Fri, 24 Apr 2020 17:26:29 GMT  
...
```console
$ docker pull drupal@sha256:2b127dd2861eacc92bec7f427ba547f87aaa44cdd484a178ed6dfb784c9a645b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.6 MB (39601201 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01820f5def5cc92becebf9b89bbc02edebae5751d1d3b3eefc7f785fe5f440ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 24 Apr 2020 14:27:23 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Apr 2020 14:27:26 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 24 Apr 2020 14:27:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d976ed40646949040d4744c640c1cbb3bc91aab9c382757b0ffaaf572ad705b4`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83c9a80b762e87b447dd954b5968922ea591a01e37ec061adedc6b1ced082c95`  
		Last Modified: Fri, 24 Apr 2020 14:29:09 GMT  
