...
```console
$ docker pull drupal@sha256:403e102e19d2689b3bfacbb4c3981645a9844047dab1bd9b6c662ba78b858b61
```
...
```console
$ docker pull drupal@sha256:49d0180e649e7d01553f46a5652373a6235576a37dda62e9c294decf103314fe
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.3 MB (37321568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec2672f63bf2bf681b6442ae4c2f66ef62667e0a457978c8ecc9fa09909726d2`
...
-	Layers:
	...
	-	`sha256:56f37075ac3f2a98794f066ba627874e63d9debe50dda2d783600915cfbdc776`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa7e0969f44e6e0a35dd9be06a421185669b91b32d6f20b810e1d002d74ea422`  
		Last Modified: Fri, 02 Oct 2020 03:41:19 GMT  
		Size: 3.3 MB (3344561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0a93736869b420356849567abcfad31a238511692961395bf4f887601c0bf18a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.1 MB (37056400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dd92791fc66443de67c050154dec9e2bce4f748cdfd27aac09654f9fce4d243`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 03:03:28 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 03:03:28 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 03:03:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:db48096a2b6a041cddd4c2fe3c44c1ed1f13913aaebd5ad9e252a77e308d9d54`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dbee49c1761087bff7c95857c097f6454cf62ca0e9d228ca6e275bf3b781130`  
		Last Modified: Fri, 02 Oct 2020 03:08:55 GMT  
		Size: 3.3 MB (3345003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:38544c7d0647902a06e8d10584ecf35a9c24baf74b09b78242f19a828c7874b2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.0 MB (37986396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8644a700cb9c66ecd5c171512aa298024c513616062f2a36298d3821e7a60180`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 02 Oct 2020 02:16:21 GMT
ENV DRUPAL_VERSION=7.73
# Fri, 02 Oct 2020 02:16:21 GMT
ENV DRUPAL_MD5=1db5b6bbacbfd735849221a0a9fb982e
# Fri, 02 Oct 2020 02:16:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f2ae1c1ebb8aa195fba955fe3e5aa758b5920ef5b8c7579b5f43f2a601fb56db`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eefa814edf98a062cb6fb92c9d2a9aa428b59f88ccbcf83b797776c85dd7d95`  
		Last Modified: Fri, 02 Oct 2020 02:22:10 GMT  
