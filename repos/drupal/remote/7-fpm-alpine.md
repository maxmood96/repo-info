...
```console
$ docker pull drupal@sha256:807a162e7ceb44a0ebaf014e2d782e3fb2f4482a569fe75f3645492476151034
```
...
```console
$ docker pull drupal@sha256:077d996b92d8185b490f3f6f92fd5ce570a637b28e37257a9b763b94e9fc890a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.9 MB (38872724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8da54520105b4d6b4d950bcf8b60a63e2439b2fdd888bf9271858ad0ab91c1a3`
...
-	Layers:
	...
	-	`sha256:cc2aa98379bc6ead5d13dfb75315d0005bb529dff1b2e3d76b46fdf8979f5c0e`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c349fe723a01282b2ebf5de8030c78ec271575c1ab3c6d4ad899b30b21f501`  
		Last Modified: Fri, 24 Jan 2020 11:00:59 GMT  
...
```console
$ docker pull drupal@sha256:62e491b03af052c8b27ffb6a5012aa6ef739330023018781307daba05d240f22
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (35959903 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74066e4900d6f8fa3b892eda81fd0c9113e14add828a059e262e13384ba86b89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 24 Jan 2020 06:49:34 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Jan 2020 06:49:35 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 24 Jan 2020 06:49:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:45c84676d0b4d0263390e0e61b09677382b9d35d3b5e41aef3d8248a9de75e29`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:048f644f2067ec02904db25d3686b892114f4d9aeb19a9aad742d52823cfe286`  
		Last Modified: Fri, 24 Jan 2020 06:52:59 GMT  
		Size: 3.3 MB (3335294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d06450dabc89f564ab5372b27b0bfa1e121717ec58aaa5b40e02fd34a7ff8ba2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.5 MB (39467994 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a10bce2d07c08e498cb3d03de4c1e321de816ad9258f4102523ab3ca683cc206`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Jan 2020 10:20:34 GMT
WORKDIR /var/www/html
# Fri, 24 Jan 2020 10:22:18 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Jan 2020 10:22:18 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 24 Jan 2020 10:22:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a87aad53abf5a0cdaf2de20605f3b1e73e7efa561b96f17529c5fe2114f68852`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d7e70bba64c592ef8dee145160c5252c08962b93955311d13f7d68c5a897e0b`  
		Last Modified: Fri, 24 Jan 2020 10:24:58 GMT  
		Size: 3.3 MB (3334995 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:eb5f0193dc73093444727eb3729fb77a24298ab13db0e3910046ca744147aa7d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.2 MB (40156795 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a76bb37cf2c5e004e2859dd9e5e0e3ba5715e02eecc481a58611c79f5da7f758`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 24 Jan 2020 07:10:12 GMT
ENV DRUPAL_VERSION=7.69
# Fri, 24 Jan 2020 07:10:14 GMT
ENV DRUPAL_MD5=292290a2fb1f5fc919291dc3949cdf7c
# Fri, 24 Jan 2020 07:10:20 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d307e6c34eb6cb83e8e797d0c3698422410fbdc46244ffab3969ed3d055cac44`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f25edea823c1e655438611793b4b12a2ea77166ca09fbd79ff8e7f9c56a4fdd0`  
		Last Modified: Fri, 24 Jan 2020 07:16:22 GMT  
