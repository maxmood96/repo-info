...
```console
$ docker pull drupal@sha256:1f5cdac83c05165921e2c2d1ff6e3e4c85e54aac0232304e6179a20f4230043c
```
...
```console
$ docker pull drupal@sha256:eff3de2fde2ce416d8ae98c8c9b73e08186105e46c5d61f8a1a0d6bb4d4ebfd6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.1 MB (37092926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a73fbce32c3fcf9619758092cb069c732f92eb884c06711396eb3c5cd6d2392`
...
-	Layers:
	...
	-	`sha256:eb0a1008c37e39ef27799e055ce17fd8bc0aeaf02cec16d0c660c7f55610f98f`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52abf79bcd187adcdce08743d90853cec4df10d494e7b56c5375c48dd32233e2`  
		Last Modified: Tue, 01 Sep 2020 22:24:26 GMT  
...
```console
$ docker pull drupal@sha256:83a829ee75bd3e52b451fa24365e29ee310bfc4e2c257ba13a74e2e6f14e61bb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.5 MB (35528728 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c42792f916b8927647e1fcf76456203bc3d7c601a7bb3798a3ad697239a4105`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 21:38:50 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 03 Sep 2020 21:39:04 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 03 Sep 2020 21:39:56 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bc5342cb0798d37f2830e838da07355382f1977ca1c1f4ea741b3389851e79ed`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6740fd001d92af435b574b99d4f09904223024287828e01fc94cbc0ed17f060f`  
		Last Modified: Thu, 03 Sep 2020 21:42:05 GMT  
		Size: 3.3 MB (3344349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:fed6c724afd76263d24110c1c4b98e4747dfcd5e5530a7267f87c832cea6ffaa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34253616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d31a6bc354693f40d03bf979158fa594b87f5799fa4252338d9f618e72184e4e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Sep 2020 05:18:31 GMT
ENV DRUPAL_VERSION=7.72
# Wed, 02 Sep 2020 05:18:36 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Wed, 02 Sep 2020 05:19:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f51b845078bd916d69ecc012dc851b1fd75b68423e59a1daebe89b05feea00f3`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1753dbf57a3fde8238fff9078aab886737b1a0c73b77227de7962f042bb3e57`  
		Last Modified: Wed, 02 Sep 2020 05:24:16 GMT  
		Size: 3.3 MB (3344349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6252ffe5caf2b2bebe4a9ac59fccb8c04758c5b5387602c46299de386ee0e60d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.8 MB (36812462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e84707e20aa2d18dd635d9d759a5fe276ea3aba8e879fd447cbf69d01e29e2f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Sep 2020 17:47:04 GMT
ENV DRUPAL_VERSION=7.72
# Tue, 01 Sep 2020 17:47:05 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Tue, 01 Sep 2020 17:47:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:caacaf8c5016e9a8df175e995fb4aeee6a1a1037a7cd8c33ecbd4265c81d80e1`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6db2589fd607ab2321c3a636c1dbd9bc3dbe0cbb93002f78297de7c8d8458de7`  
		Last Modified: Tue, 01 Sep 2020 17:52:30 GMT  
...
```console
$ docker pull drupal@sha256:379a08787d297be823737ec022984add50a061157f1241ff13211f5eab790824
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.7 MB (37728557 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd3284c8963a36484d284a9a9fa268f6daf01bb068a78721882317954a08bc2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Sep 2020 14:35:17 GMT
ENV DRUPAL_VERSION=7.72
# Tue, 01 Sep 2020 14:35:17 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Tue, 01 Sep 2020 14:35:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:17f3a578a6cb92affd47ad680b6ea90768e408b490603663b786ed5fee4d9422`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cac71bd24d775fa77254d137c7cf8e25586b82fac24648d14abfef19fa06cfb5`  
		Last Modified: Tue, 01 Sep 2020 14:41:27 GMT  
		Size: 3.3 MB (3343887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:b3481a6634a53b2b26cb752b4ba63c13c6a8797c9d52a2b856f9527a908c20fc
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.2 MB (38227724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9742a4b3223babd42e469a89f777b61a816378f4f63b0de6510fab27d1bffe63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Sep 2020 20:25:46 GMT
ENV DRUPAL_VERSION=7.72
# Tue, 01 Sep 2020 20:25:51 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Tue, 01 Sep 2020 20:26:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:765fa818663577157f1fc40dba5c8025033fd4c8b7c17e4a7ed40c483be2cee9`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f594ec6570c9c9db9262ffe88d487e9e4a5f8b4b98f56c6de6d2ddb69f139c9`  
		Last Modified: Tue, 01 Sep 2020 21:10:23 GMT  
		Size: 3.3 MB (3344352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:983c3c9f5dcf08760595e601e66445df986828225f73dd74ea8bb5e70e8e22f9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.0 MB (36044102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e38867af3c21e744a088c7772e383c73077b18be8411c474e71ee1ba18f2971b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 20:50:44 GMT
ENV DRUPAL_VERSION=7.72
# Thu, 03 Sep 2020 20:50:44 GMT
ENV DRUPAL_MD5=ed967195ce0e78bf2ab7245aaf0649d6
# Thu, 03 Sep 2020 20:50:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4b037dcd9d7b6fb429cd078c34059d231c3999e1711895ff7048cf72cbf64d59`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2964b002aa847541aa4c18240e5c5b86532c8ec56a3731f090be2987b3031b43`  
		Last Modified: Thu, 03 Sep 2020 20:54:17 GMT  
		Size: 3.3 MB (3344349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
