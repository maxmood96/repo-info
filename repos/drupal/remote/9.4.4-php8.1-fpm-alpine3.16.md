## `drupal:9.4.4-php8.1-fpm-alpine3.16`

```console
$ docker pull drupal@sha256:792dc6c0f8365cbcad8b1ca0cec5356fdff3ed24576d9b9d55b7f4a01e77c62c
```
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; amd64
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.4.4-php8.1-fpm-alpine3.16` - linux; s390x
