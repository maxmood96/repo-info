...
```console
$ docker pull drupal@sha256:e9b3a751b25d3a3ea2a29454bb9efc0be9a9a3c548712bc154fe95f652682432
```
...
```console
$ docker pull drupal@sha256:4ad7387f50deeb5ca59d798455a75acc88c31981f68d4266ed97aea6d8d43ba9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.3 MB (179271541 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00d1a0e197fc684278d9ec760a2967f9c720fd20c7df06e4608979dc593a2528`
...
# Wed, 01 Nov 2023 19:34:39 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 19:34:40 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 19:34:41 GMT
...
-	Layers:
	...
	-	`sha256:88d737b3cbaf5db28a8523121a1f470a52b5b7e45d0bbd89e8ad4c3933294a9a`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdebe00c57c7ca8fdb81fb17a8a9b5e00968c32f1b3313e95246d6f054e4a84b`  
		Last Modified: Wed, 01 Nov 2023 19:52:16 GMT  
...
```console
$ docker pull drupal@sha256:fdc0819b30ab17026081ac4f09dfd062147cf200a565d4aa05ba0c52665c9a90
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143701830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8434918fac4ee133833ec98ec5c785008845dc9d93f4ec1c5b70bafc38aa178e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:52:51 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 17:52:51 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 17:52:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9aa58d04ffbe70ef7b54d9337530f0a67396f4abf0a641dca0639bbe212dd398`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdf9022898121db269503e3ffd92be7d8d1e0703b69b5cc91345223d0ae10dc1`  
...
```console
$ docker pull drupal@sha256:82a9440f9f94435025d6e1ae46b2100488a9535ad39a4b68b12bd7e95607cdac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173296976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8085de5804a04bcb7b56a90aeb4f97a4fdfbbce4d85b7f0725bb2316e97f34c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 17:52:56 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 17:52:57 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c12b7034a5af351b6c48f9fa759d96489f8c44ca549ece58bead7360080b538b`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbe72e2eedde99c577b23cec4f7f4d10655ee7e321872a0bce149c019d15285e`  
		Last Modified: Wed, 01 Nov 2023 18:10:41 GMT  
...
```console
$ docker pull drupal@sha256:cf79841bf41bffd0e9d4f337a7ce81316b799d25fe3314abef6306262316db33
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183159248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:848d8f412624b1201cade7d37e1176c0dc5a3c5091ba2aee8163b1a978c707c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 16:17:11 GMT
ENV DRUPAL_VERSION=7.98
# Wed, 01 Nov 2023 16:17:17 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Wed, 01 Nov 2023 16:17:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:75c3c89997e90c858778d228a501dd5ce348901f2d42f5a6176e86ee7fd52f22`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86878bda92d41b7fe6d6e37c82906ef48a96b739f62fb64ef5595f46722a464c`  
