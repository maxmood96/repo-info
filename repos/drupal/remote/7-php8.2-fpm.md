...
```console
$ docker pull drupal@sha256:895f278717004245678b809fa42b8716ec24800a3667cf6d293fcba10465e5dd
```
...
```console
$ docker pull drupal@sha256:a0879c84d9483b77632a9e91dac96f3571ab214a312cce22480c188c739348df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.3 MB (179264216 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a57c903b2def8fa1a057fcbf23e42492932c3f83870dd780d13def03881b05a`
...
# Thu, 12 Oct 2023 19:56:32 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 19:56:32 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 19:56:33 GMT
...
-	Layers:
	...
	-	`sha256:d87eb107fcca1960f64dce0d30b8f259987f351df59190e534e02d9ebb92db74`  
		...
		Size: 319.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01880f6f8b84d121efdabbc4744f66f455e9c81e69e3135f6c4c8c619eecafff`  
		Last Modified: Thu, 12 Oct 2023 20:15:22 GMT  
...
```console
$ docker pull drupal@sha256:574c95bbf0c9b391114e9aa731dadb668b883bd493052ddb4f1a25b1ace64dcb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155011724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a75be3bad67063b6f7892634917f24bf9fbaeeedc20824fb1db4d3407fd76fbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 28 Oct 2023 01:33:05 GMT
CMD ["php-fpm"]
# Sat, 28 Oct 2023 03:00:27 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 28 Oct 2023 03:00:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Oct 2023 03:00:28 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 28 Oct 2023 03:00:28 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 28 Oct 2023 03:00:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:17f36cebd837d807502e89eaae20ac8d414eead0b0a9f5cc7c075c412a9ee579`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfb27f8ac267e549c3af23814ea5eeb703c377710538055782b98f081875d8d2`  
		Last Modified: Sat, 28 Oct 2023 03:07:00 GMT  
		Size: 1.7 MB (1655388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da5c288e1587078f09781ea612543f4bed86e49530c3a8aa240c3578abeef367`  
		Last Modified: Sat, 28 Oct 2023 03:06:59 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a07c71a4eae528a7ac3b30dd8225d6dccfc5b7411e160a539843c33f2bbe9928`  
		Last Modified: Sat, 28 Oct 2023 03:07:02 GMT  
...
```console
$ docker pull drupal@sha256:8e0dcfeeecd130ce0e88e5305a1734ff87f90c5871b08bb0b25e6eea42058243
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.3 MB (173299360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76d5113dc2c8de8f959ca95d14dc08467efc50c0956c0c36d3610ba8aa3cf8e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 17:29:32 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 17:29:32 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 17:29:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d02cd4d7de0e02744ff50d5dda75bc3e7d3aa3c01ff83b47fb42b30adf147564`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6414d1b69929f03d70c5165f1f0c614d16815f4c29dec631a6946989bc046595`  
		Last Modified: Thu, 12 Oct 2023 17:46:58 GMT  
...
```console
$ docker pull drupal@sha256:c0fbaccf19a292578c6226918bea241a244ccf01c4b42e35802fdea083bfca77
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.0 MB (178036328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7b348dfaf568227993f3b0d3e7b5c6f1050e2e18e36e9da417b87c71846b52c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 Oct 2023 16:11:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 16:33:01 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 16:33:01 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 16:33:02 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6ad5d54d4fb30b601c8db509624c174c782db6de8409e622f0ef24537f42d05d`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0b263e74df3463768d79a58d82c01845735eee58d90d3e8a0bcd708b00537dc`  
		Last Modified: Thu, 12 Oct 2023 16:52:26 GMT  
...
```console
$ docker pull drupal@sha256:b00982f63a6fd2ce935a0e331131b7ac276a65b1caa06a7429db63fa58b85b70
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153440958 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:feeed1ec0c7f50314cf0342dae9a6663f3cac0cf1300fd470294839f8506dd6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 13 Oct 2023 02:05:44 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 02:05:50 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 02:05:54 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 02:05:57 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 02:06:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:15ec6c96ae396ad172816ca42d341e9e4e0a78a0de8efbd92a1d2c439845bb69`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0099d94fb21280265a2e224f0b2f5b7d26343201e0264d6bcfd1de3119bcb59`  
		Last Modified: Fri, 13 Oct 2023 02:30:44 GMT  
		Size: 1.5 MB (1548333 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b885fa2a668f8c14f8c947a643ef70b14ec1cde0f44b2155a97a95dbd6627153`  
		Last Modified: Fri, 13 Oct 2023 02:30:43 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28c879a9db9f883e82267bd34eab369b979f10907c415c4283e03db91b490cb5`  
		Last Modified: Fri, 13 Oct 2023 02:30:46 GMT  
...
```console
$ docker pull drupal@sha256:37e082054097e19ca8ca8d66a6ae1a52c8d8b69dc271a38387fb524a6e7f714e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.2 MB (183154437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9212f880b0710e3ab9cf0b938b162674bee32cc1c2617a4617b55882f3dd28d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:36:08 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 12 Oct 2023 21:36:09 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 12 Oct 2023 21:36:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c5098a1396bcbee7d3df86c74d135c8e3904b2e720f329e3ab27d33e54c3ca8b`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:796bfe305c41830974f7468ed5e2f4ded5b14f8385dc3a8b8b8f75fe349f65d6`  
		Last Modified: Thu, 12 Oct 2023 22:20:23 GMT  
		Size: 3.4 MB (3410789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7952660c12a01d101703a3bea5a63f2ad3b20e66a8e65f4cccf424855582541e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.6 MB (152589189 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3889e46ebc17262cfa9bd102715525f191e624919d10769792f10641c0b4692e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:28:41 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 13 Oct 2023 03:28:41 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 13 Oct 2023 03:28:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ed58d248d65b2d879b4fc4ddf5d57e6cb02c65c1787e599fb36c1dcff0444f04`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56197216b8a97d945e09b81c0cc34b5f73724489119fe8aee551397d23c04102`  
		Last Modified: Fri, 13 Oct 2023 03:42:28 GMT  
		Size: 3.4 MB (3410785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
