...
```console
$ docker pull drupal@sha256:d699605c721b1d14eb8d2fa3ba0aa2655e3bf328556a329ad4045206b7500fa3
```
...
```console
$ docker pull drupal@sha256:5b0c01d7997bcdd1d51d267fc1cfdcb1527475df0148064c2485467b27bc2244
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.7 MB (152709673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2b8e5428d3c235ec8a8520b73fab64a7d4539f77d78f5493df54086031c5859`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:dbdeb4c6bce974d384f4f31384f76d223107fae01f4069d75e735e2d24fd6c01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab9a387ce671f6eac11d3a2e2f23b038f429e58ac0d1e4235f860d3a2b91778e`  
		Last Modified: Thu, 22 Jun 2023 23:56:27 GMT  
		Size: 1.7 MB (1652318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ef192eddc93570c8fff84e027b9e7e65051cad489e1b6bf419d0aad05e70677`  
		Last Modified: Thu, 22 Jun 2023 23:56:27 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcac0da48c6b68d643b6c4c5ee0d33a05481e57dbc7fc4d10820f49696bfa847`  
		Last Modified: Thu, 22 Jun 2023 23:56:28 GMT  
...
```console
$ docker pull drupal@sha256:cf15c4489b419348bf3f5e0f2625fc2a173af64ee452dbd3eb949b0af7e55041
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.5 MB (152509544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84243cedd6a84519869da1043ab884ae681b7532ba841866573b7709e5e27636`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jun 2023 00:04:39 GMT
ENV DRUPAL_VERSION=7.98
# Fri, 23 Jun 2023 00:04:39 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Fri, 23 Jun 2023 00:04:41 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f95865d8708657fee8560e012cb4c2099551842150a118e3ac1592e7dccf4ed1`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2ad5289d4dc6df93fdaf64ce0035195ae5daae871365017376a6e01d180eb59`  
		Last Modified: Fri, 23 Jun 2023 00:20:26 GMT  
