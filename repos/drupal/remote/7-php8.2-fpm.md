...
```console
$ docker pull drupal@sha256:81fb5d55c09776d6adb648332a8bb8f31fdd3e90245bca1ef74f27024373f7e2
```
...
```console
$ docker pull drupal@sha256:2051b1bdd6910f434fef2b9bcc8ad21cf10e1ef0fad86a0cb1d166805263c7ad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.7 MB (152740904 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b348d95367f4ee5e95fa037e1e20ecbc1f192b8558ae9a9b3a25fd8620806e34`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 01:31:46 GMT
CMD ["php-fpm"]
# Sat, 30 Sep 2023 04:33:39 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 30 Sep 2023 04:33:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 04:33:40 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 04:33:40 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 04:33:41 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:94e9823e1fdf5fee10c93151525633ed58f58355a9af3e106f215bcd551a3999`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f1b9e4012bcce08e801c11b83349946c1890e3d3d805b358d50798b55036211`  
		Last Modified: Sat, 30 Sep 2023 04:39:17 GMT  
		Size: 1.7 MB (1653141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30756096ab6b00630aadca45c2d4e655c41971f3330093c34a6252a5ec6ef366`  
		Last Modified: Sat, 30 Sep 2023 04:39:16 GMT  
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a3a53caaee184b16487f4b638504085c42d93b550dd174fb1aa0ef6e2047469`  
		Last Modified: Sat, 30 Sep 2023 04:39:17 GMT  
...
```console
$ docker pull drupal@sha256:7140d417459cf3dad8f85ba900c6c9e28b90ec1b9ceb34beddcfe3e8590a4e58
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143739865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85e7770a36154005a180bfd97eff4aed3c31e0659ffda8dbe530d0d8be9bb016`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 05:04:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:19:29 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 30 Sep 2023 05:19:29 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 30 Sep 2023 05:19:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4221b3c834beaabd8ad521cda9fb91640c38d0c7002b6ff6219995042b55bf25`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6049ed220dac95dc117d6dc75aa1b827ba897e57c22780f3da0078d362ccbb57`  
		Last Modified: Sat, 30 Sep 2023 05:43:59 GMT  
...
```console
$ docker pull drupal@sha256:c42e586a00ea99e2b06ed8fe4902312f4b652ab6c599faa27f16552950c16744
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.6 MB (153604384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87cf7065ec65cb2dfe131c799a24f2e9d513df284291e0cb6089548192cff0b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 21 Sep 2023 22:21:03 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 22:21:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 22:21:12 GMT
ENV DRUPAL_VERSION=7.98
# Thu, 21 Sep 2023 22:21:16 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Thu, 21 Sep 2023 22:21:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5d86181a972bbef459e7a67d790b30bfcc7230eda334e933f7ec6c840b8751c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73e6fa2860864de2ca24f3bf4de8dee345fe4e0421f8894d1ad88b45f6d30ed5`  
		Last Modified: Thu, 21 Sep 2023 22:46:17 GMT  
		Size: 1.5 MB (1548299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8d7c5f5068ddad436833b208661bac66443ef0a3eb090d2404e54774abd4eaf`  
		Last Modified: Thu, 21 Sep 2023 22:46:16 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1e7ed5ec7d9f0372cb850260dc5e39ab902b6de7fafede56021372ee996e85c`  
		Last Modified: Thu, 21 Sep 2023 22:46:20 GMT  
