...
```console
$ docker pull drupal@sha256:bf7fae9b136c35587574148b954f23578499ab1054a6132957594152dfcbe0c1
```
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; amd64
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; 386
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:10.5.5-php8.3-fpm-alpine3.21` - linux; s390x
