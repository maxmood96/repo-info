...
```console
$ docker pull drupal@sha256:9147b73ad0294573f34a3de4788d3ef73ea9d6291621e6302d802f4a3de168a1
```
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; 386
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:9.3.20-php8.1-fpm-alpine` - linux; s390x
