...
```console
$ docker pull drupal@sha256:51156758eb85ed12faeac79420e766b2c64800082fa7a27ca87eaba47035154c
```
...
```console
$ docker pull drupal@sha256:401ae12d034f803caabfaf5df6d4ee11e77f5f43aca27a3108d58127d860a11a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159050227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fc364fe31c19084538c4afbf94f437330946d2e6711c0bbf2bbf6c7c3ab8f53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 07:39:42 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 07:58:54 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 07:58:54 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:59:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:59:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9c6559d484bfdf2adf52d8f217e9a1599d67a348df0385b8e5598cc07000fd8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c34ea6ac38e43e096307f7629e900b95b3a117a8917f4c6e2691d52e52ff9c1b`  
		Last Modified: Fri, 05 Aug 2022 08:36:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63d4ecb763427422941fdbf37a2e37e82f442a47c4b3e6040c74a7a904f3c402`  
		Last Modified: Fri, 05 Aug 2022 08:36:34 GMT  
		Size: 21.3 MB (21321685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
