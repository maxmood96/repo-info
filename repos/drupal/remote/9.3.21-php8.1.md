...
```console
$ docker pull drupal@sha256:1e177c7d4bacadb2b97f5eda2fd15ce52bebca07a9b60f62218d1445265ff21d
```
...
```console
$ docker pull drupal@sha256:d1a96d57b8aee9de4670b87e33d45b5f617eb825f7bb85c6fa58a15f4421afde
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.5 MB (189510486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb6577556f041ef51d24c1adb07372d58c67f65a58ed7272aec0fe33958fd0b2`
...
# Thu, 04 Aug 2022 23:47:18 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:47:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:47:32 GMT
...
-	Layers:
	...
	-	`sha256:177676a3eebbd2985b3f6f48c6ad4e48bf7fc0591f553fcfdc8e1335a7aeea8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:901b9fca18fea3a92f1fafda0bc24512d70e1d74d7f73a99fb3c2fa24849c0c6`  
		Last Modified: Fri, 05 Aug 2022 00:08:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f75005ff85117760ba5b678d9df79c657632b331188a5270c9dd9210642280a1`  
		Last Modified: Fri, 05 Aug 2022 00:08:47 GMT  
		Size: 21.3 MB (21321573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:ed88600bfae78209ca8b7d15c6a91105dea9c6f43d20a27e05b4a6b161498984
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (158983460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb817c5c02122b3a68a7be60a0092c5fa284d7145debc3738fe3cef568c54dde`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:00:27 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 20:13:23 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 04 Aug 2022 20:13:24 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 20:13:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 20:13:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a18488d9a9590f9e8f93a95a934c6888592da22a25079248030733e7167fb73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a0ed026ae1fedfe615e070d2ef7fc5ba9dd03dbda5b32ac0fe300e908f1df2c`  
		Last Modified: Thu, 04 Aug 2022 21:06:34 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c9952ffd8dfedb69beefa5148a6b5b3928e4d2a4ef22a71b23330f65034e2fc`  
		Last Modified: Thu, 04 Aug 2022 21:06:53 GMT  
		Size: 21.3 MB (21321633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5cbb488fc4679e360b6f465da7d33838fe0de9fcdf9ab3e2b3ea264240a89f5b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183126354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e36a03b8b76ac680e459f032d6e4a177d838e128e509cb5e07c2f1af6ee65135`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:51:07 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 00:51:08 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:51:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:51:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:086fb429352184c665fef2e21836036bc55ac340c1b9ba58082624f715e56a6c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d14fd1c9be453b3eb296c2c9531b6a657aaba5488f9f1fa3bd736c40890749f`  
		Last Modified: Fri, 05 Aug 2022 01:23:52 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9ec071a4331012c09a3b7989d0921e80db55018eec16a9b701ba0a11cbc20ad`  
		Last Modified: Fri, 05 Aug 2022 01:23:58 GMT  
		Size: 21.3 MB (21321717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:a9cdf0e61a19d39b193e48bb6043c5ab80d640d40ed304edc58f2f4e0341f161
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191762417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e91037657501ddd8986a9a9b6106ae1b16003232439d12eb1ae5620a00ac5b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 23:57:46 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 04 Aug 2022 23:57:47 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:57:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:58:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed0bf0b7f37ad94734558f1bc12877139e860bb3ca1781f20a219938efc0ced0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25080982b93d4eafde0b0ed3048321110f77a45311c1e49620819dbcdb9679d5`  
		Last Modified: Fri, 05 Aug 2022 00:30:08 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a582398b1bd9b8e30acbaeabfce4acfdf95e2e8343e8005490eb191c38023a67`  
		Last Modified: Fri, 05 Aug 2022 00:30:13 GMT  
		Size: 21.3 MB (21319576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:104c3e287f29207b065d9f57c0f6e18d2f8bc49110dd3637868cdbf856e39c3a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.9 MB (189927952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b45dbcd1d2a1ffc70ddf68eee4ab08957f731ca2c490a1b964bfba9a660b82c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:13:20 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 05 Aug 2022 00:13:20 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:13:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:13:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:184fee8fa71cf859081574e155a02dbcbad09493c54b0d342b80f5c6fcbf3292`  
		...
		Size: 670.4 KB (670417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:466f06ac77deba73a17a642d1291bfa01fa2c6bbd4a65f86cd781e9a0c48427f`  
		Last Modified: Fri, 05 Aug 2022 00:49:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:256f212eaf86638a3e764feecc06bb2323bbef243d1cc6183f3fd9a5a6708b86`  
		Last Modified: Fri, 05 Aug 2022 00:49:23 GMT  
		Size: 21.3 MB (21321582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:be2466d3e4494f35827c911cd6b9de0b1008aabe6442964cfd8cd6001a8093c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.4 MB (166359941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8292bbdd6b6f655978607216b71dd73acaa7387a360a50f8324f419fc248f79a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 22:36:33 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 22:47:08 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 04 Aug 2022 22:47:08 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 22:47:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 22:47:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1ee6045dd3633cf7f69f96e54f54b0a59ef3addc3355687363d62110fe8b224`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ad5397af5ec92b0442290b6b87bcd1cf85ec2ba9e7ecf7310c26174f52e9e3c`  
		Last Modified: Thu, 04 Aug 2022 23:11:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3900aa3191751423dbf6acbe7e4463d3a18c6784188ce601ae6c17c0db5f4cbe`  
		Last Modified: Thu, 04 Aug 2022 23:11:12 GMT  
		Size: 21.3 MB (21321696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
