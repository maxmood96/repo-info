...
```console
$ docker pull drupal@sha256:529cc2d6abf6f4b33b2d89301b81ed3ae9ce8b2bd827e2262ec5cb82455e1bc8
```
...
```console
$ docker pull drupal@sha256:bcb858d5f7c79ef022c9311a938705ab5d3c4766a9ae6dff2e2d1d66fa06b8df
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.4 MB (166413123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7ec78b1abac419063d15a7f1a8dff469c550ef79a9f96143b5ec61c6e62cc3f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 01 Sep 2022 23:18:50 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Thu, 01 Sep 2022 23:28:46 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 01 Sep 2022 23:28:46 GMT
WORKDIR /opt/drupal
# Thu, 01 Sep 2022 23:28:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:4ab4ad6b15ba7faa9ad4373dba41236f5aede444ba73c2f766d3bcc35259f35f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcc8a712b8bcec77b02e27c55dec134117943e1ea57b92f04e6692e9bce91ac5`  
		Last Modified: Thu, 01 Sep 2022 23:48:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91e709ce2cf9fcdb9bd2f9ac1b5bb5ae4cc6b1ab7d9029e5189ae8e888e02243`  
		Last Modified: Thu, 01 Sep 2022 23:48:53 GMT  
