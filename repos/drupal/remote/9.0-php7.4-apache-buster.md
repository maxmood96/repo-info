...
```console
$ docker pull drupal@sha256:5360f0a0a1d4d57e25e4f348e3d78bb76d7ef973f818937e5b4dd7cfd10ed66f
```
...
### `drupal:9.0-php7.4-apache-buster` - linux; amd64
...
### `drupal:9.0-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:9.0-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.0-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:bc265a8d50c15e4fe29a487381864fe4df0d045f2d29926e93069597c29d532a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.6 MB (172562746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a2bb56e318c25223a7ebcff45822bde04fc75cfff3c085048488ab6a2d431c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 May 2021 20:23:14 GMT
ENV DRUPAL_VERSION=9.0.13
# Wed, 12 May 2021 20:23:15 GMT
WORKDIR /opt/drupal
# Wed, 12 May 2021 20:24:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 May 2021 20:24:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f9d75d91dc084046a5c932aa43e5a728e16c87dcfe4a991553590d8ceeaff708`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b143890b725fa28ed27e2c4f0b9b13528d54cac99868d37211304fce7a2e0f4`  
		Last Modified: Wed, 12 May 2021 20:44:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42272b3488cb7f30ac1f672a7e16b601c177d2293ce9064a478ba598b44e6366`  
		Last Modified: Wed, 12 May 2021 20:44:49 GMT  
		Size: 17.3 MB (17272441 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:127e6f08a91de8c1ed3c9998bb88dce628f3e96acfb53f87dc671d72409648b9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.9 MB (177941241 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c23b8e983d369398b8726691fe7c83878adc6ede312e0f0d6e85e0f4d9ec6dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 07 May 2021 02:11:08 GMT
ENV DRUPAL_VERSION=9.0.13
# Fri, 07 May 2021 02:11:11 GMT
WORKDIR /opt/drupal
# Fri, 07 May 2021 02:12:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 07 May 2021 02:12:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c46083f10061cd8f03719afc8a331066eadeec25784224ced29ad0e9796ca929`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5f931bedeee3a1b79c17fc7191a0b5294317eb37a283b5d53350c5ed961f3b2`  
		Last Modified: Fri, 07 May 2021 02:32:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77989d838a64b65e85de79805739d9c973fc1c4b0a60bb1064528427a0b8caa`  
		Last Modified: Fri, 07 May 2021 02:34:35 GMT  
		Size: 17.3 MB (17272007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.0-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:698b542c1078d67d2d1a08467f01b4dc464d68cf72436b9907a1826ee9691e1c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.2 MB (152203061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1715a19b0aaabccdaa627bf40c2b388e5b83d0d84443aa2b310b6868e506eb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Wed, 12 May 2021 19:46:47 GMT
ENV DRUPAL_VERSION=9.0.13
# Wed, 12 May 2021 19:46:48 GMT
WORKDIR /opt/drupal
# Wed, 12 May 2021 19:47:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 May 2021 19:47:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9e0a633a15152dbddd96d4efb46a21d34b0020fdfc37056bf1cee414b29840fa`  
		...
		Size: 507.6 KB (507624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:834e01530c7f5bbd5c01f41d0594c30d71aed4a4c46f6d3673d15b24a83210f3`  
		Last Modified: Wed, 12 May 2021 19:55:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b992ed9cc57ff1d29a27a4494f088f1d534fd69210c5cdf11995af5bcf89cea`  
		Last Modified: Wed, 12 May 2021 19:55:44 GMT  
		Size: 17.3 MB (17272372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
