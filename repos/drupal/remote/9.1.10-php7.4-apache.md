...
```console
$ docker pull drupal@sha256:1c2b7b4fcca804165d5fe76617a87527e9ead3113f048085ce1eb822e8dbf166
```
...
```console
$ docker pull drupal@sha256:23e8412209fe1519f7dbd20e5b7c5742d7fac56e78f1b52f97aeba03260637c9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179603540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:049f18fd8d6593bcd3489cb7abb1cff9af6779572f31d42a58ab621c919de912`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 09 Jul 2021 01:05:45 GMT
ENV DRUPAL_VERSION=9.1.10
# Fri, 09 Jul 2021 01:05:54 GMT
WORKDIR /opt/drupal
# Fri, 09 Jul 2021 01:06:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 09 Jul 2021 01:06:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e4d4e00f65ba8f58ede1e2e85ea2e64d43eff63b553305900dbe9222376bd25`  
		...
		Size: 553.2 KB (553187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:553cfd3338d43cf5448e0b3870d057df51d6d21d35b5eb864dcc4e53823439e6`  
		Last Modified: Fri, 09 Jul 2021 01:56:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d929ee9fbfb0f9899a4c88cde394757d4f1b37912166b507971c761ad704ccec`  
		Last Modified: Fri, 09 Jul 2021 02:00:24 GMT  
...
```console
$ docker pull drupal@sha256:782873e3b2fb1e24879ef82285440b97b3e5c59b5e58903a4594a090aa89068e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153858845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad9af349e5c078882fe3e58f3fc22b77069a7d7ce77aff91836fa8171574697f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 02 Jul 2021 02:55:09 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 02 Jul 2021 03:06:18 GMT
ENV DRUPAL_VERSION=9.1.10
# Fri, 02 Jul 2021 03:06:19 GMT
WORKDIR /opt/drupal
# Fri, 02 Jul 2021 03:07:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Jul 2021 03:07:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cfc8e5ec82d35555aa62b6636f4e6a07fe655777cd3ee5ea072ba1bc1289af6a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f8c12f36214f4b174e71f2e8d6cd5c967e6e66abbfb0aa146ade06e45ed35ca`  
		Last Modified: Fri, 02 Jul 2021 04:52:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba5c562f093d67c720415ee7046bfb4aa3e1eb3ca90d9ea756172746ed27cb90`  
		Last Modified: Fri, 02 Jul 2021 04:52:27 GMT  
		Size: 18.9 MB (18872851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
