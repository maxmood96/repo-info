...
### `drupal:11.2.5-apache-trixie` - linux; amd64
...
### `drupal:11.2.5-apache-trixie` - unknown; unknown
...
### `drupal:11.2.5-apache-trixie` - linux; arm variant v7
...
### `drupal:11.2.5-apache-trixie` - linux; arm64 variant v8
...
### `drupal:11.2.5-apache-trixie` - linux; 386
...
### `drupal:11.2.5-apache-trixie` - linux; ppc64le
...
### `drupal:11.2.5-apache-trixie` - linux; riscv64
...
### `drupal:11.2.5-apache-trixie` - linux; s390x
