## `drupal:9.4.4-php7.4-fpm-alpine3.15`

```console
$ docker pull drupal@sha256:b13318cca541e62d63171d8be564c70db99e7a2cfdaccb03edbb3b71f0f57e1a
```
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; amd64
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7be45522dcd3233a6558eaed3c89132306b880c23b87c621b732db13cd8a25c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.8 MB (48818633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a2cdc2eca074107d6fbc23003a8846e221a4d382ce15c13d89e1e1077c342fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:23:21 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:23:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:23:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b4320fc45372fc83abd7ee81828ce838994f2bb458745a422101ecea47359bb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1638e5707142d2f84e7043fc7ed85ddf093bfb8cfc3093ff6e64172ebe695e72`  
		Last Modified: Thu, 04 Aug 2022 10:10:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74a0f53a1a9fe40098ba76f199cd57764427077c82171fea849c235d91961ae4`  
		Last Modified: Thu, 04 Aug 2022 10:10:18 GMT  
		Size: 21.8 MB (21758080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; ppc64le
...
### `drupal:9.4.4-php7.4-fpm-alpine3.15` - linux; s390x
