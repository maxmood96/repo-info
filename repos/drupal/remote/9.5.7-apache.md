...
```console
$ docker pull drupal@sha256:12b801ec555911ce54c39c1b3513cb758896c5646aa4cdc66e3ae4edd62add97
```
...
```console
$ docker pull drupal@sha256:65d861c06193d9c8ae4c89f6567929a3a4254fd6170dbe95efa37c05b79aa9d8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.0 MB (167992889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:589cbebdda196eaafd5b29c0fbe56528279aa70a1a91c568f349ae29f67f3c45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Mar 2023 16:14:20 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 13:41:20 GMT
ENV DRUPAL_VERSION=9.5.7
# Sat, 25 Mar 2023 13:41:20 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 13:41:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 13:41:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1944ca9a53eaebe5606e4c437a7d1519cfb36da140735de1ac4783048fc582c0`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6645141468dce715e2a00e394f3a6f81ce55f7eb27a85d7aa2d1d2405ab8141f`  
		Last Modified: Sat, 25 Mar 2023 13:50:04 GMT  
		Size: 144.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b016426443fe9f8e664d4e2fb026283f11cb48aacdcd686522999a8e544f70f`  
		Last Modified: Sat, 25 Mar 2023 13:50:08 GMT  
		Size: 22.9 MB (22861260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
