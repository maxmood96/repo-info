...
```console
$ docker pull drupal@sha256:3eb45b96bcf029eb6cb7b9c3544dd7052f29cbae174235db124d706edb09b3d2
```
...
```console
$ docker pull drupal@sha256:120d7a353e1735a321c738f53ba50813d64abee4e3afa280449d1d610361b901
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.4 MB (54361190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:341d8f58a6f8b14fd67c8c207a8397a8a395be857c6e096a40a9a778d9ce7a4e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d8653e49572d2c4ba6fff94dfe236c06b3a143536ffbaed34be445ad5db41277`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:17076493897b65d8977d2c64f846e945d1960df07dcb63db2bffffb21f45470c`  
		Last Modified: Sat, 28 Sep 2024 01:00:04 GMT  
		Size: 19.3 MB (19298976 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2.8-fpm-alpine3.19` - unknown; unknown

```console
$ docker pull drupal@sha256:bbecf00a632531c45ad1beb1fe9ec1feb088cabdc06c918504d3b0e98c4a596e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **380.7 KB (380654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3a82cb104bab21cd4e9609620f6c65e3a3ce20c7f75edfe54645f831e156724`

```dockerfile
```

-	Layers:
	-	`sha256:986c7f057ad01124ba923a0316a02975ace7f1b7ed0b82f280ca93a0c31ec115`  
		Last Modified: Sat, 28 Sep 2024 01:00:03 GMT  
		Size: 348.4 KB (348365 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:181ba2c16af3389e6098770d3f9602d57e7ac8a7765006674262c1badc0af1cc`  
		Last Modified: Sat, 28 Sep 2024 01:00:03 GMT  
