...
```console
$ docker pull drupal@sha256:8d973540ef9ffcd6d7657c3cbabf0cca99724bf06c5771365b11da4dd681e793
```
...
```console
$ docker pull drupal@sha256:9453a88fc93696ac1c764f5b0916d88627f77aca6f70b34d6db44a7bc9959845
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161882563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8baa54375751e797114996ea317e587c26c1867dc1073817d4c74f3183bd8c7d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 08 May 2026 19:23:09 GMT
CMD ["php-fpm"]
# Thu, 14 May 2026 17:49:46 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 14 May 2026 17:49:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Thu, 14 May 2026 17:49:46 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Thu, 14 May 2026 17:49:47 GMT
ENV DRUPAL_VERSION=10.5.9
# Thu, 14 May 2026 17:49:47 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Thu, 14 May 2026 17:49:47 GMT
WORKDIR /opt/drupal
# Thu, 14 May 2026 17:49:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Thu, 14 May 2026 17:49:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:06a3de659ef85c886c137bf3e08ebc57cac729d1c263e712daeb0ad60696732d`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c09003867b2c3b978be5fa589ac2816814e7a8d81e8350b7cab8b39e66e7796a`  
		Last Modified: Thu, 14 May 2026 17:50:09 GMT  
		Size: 1.3 MB (1347744 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e58c7ae4df2bba3a5198c37c0ec26e2e9a29c8f3dc419dfa831323baba9c6d40`  
		Last Modified: Thu, 14 May 2026 17:50:09 GMT  
		Size: 317.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d3449dd8536c0abd46ce8d0823a9fd6ffaeb0f4cf9f219b77262241c5b40c775`  
		Last Modified: Thu, 14 May 2026 17:50:09 GMT  
		Size: 790.8 KB (790767 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0f07a27b0dcf1c7a0ca6c1051931566e6e4ec4e8ae4901751fffb3cbb9ca9b43`  
		Last Modified: Thu, 14 May 2026 17:50:09 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a5d5f4b1ffc22aea3c84c002f453c378f6a09f9f3394fa0f84c4536170b18e94`  
		Last Modified: Thu, 14 May 2026 17:50:11 GMT  
		Size: 21.8 MB (21750368 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.4-fpm` - unknown; unknown

```console
$ docker pull drupal@sha256:e91cfd10956639f5b49c70fa6823a89122c9e7940653e02e8d33327fe7758c3a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.6 MB (6642260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:215b89ac0bc28eef87458424fe8fbe821be4d487d42f5fb805825af736d67524`

```dockerfile
```

-	Layers:
	-	`sha256:0ce9a09ef785db02e8e2e9830f3bab0bd3f516ffdf30d9529c7d7891000cc8ca`  
		Last Modified: Thu, 14 May 2026 17:50:09 GMT  
		Size: 6.6 MB (6606423 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e7e7f5d7e837f3d696577ca31f14a0b61c7ae3449020cf76cea0467af043d570`  
		Last Modified: Thu, 14 May 2026 17:50:08 GMT  
...
```console
$ docker pull drupal@sha256:aeee533d9223141eec97e636799e66b894b1ea8d963171092409e892e6fe39e2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **199.7 MB (199679100 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc7d68c9715f7390d6d18344e8f47d80ad13a5dd44f8422c528a2874d77166d5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e145f173dab86228b49d54b503af41cf902be364b1f0b27ec247e6e0f560baa1`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fd8e216df02a40c61e5cdf2d41c6acfad008d4f1db5653fb21187314f4d08339`  
		Last Modified: Thu, 14 May 2026 17:15:31 GMT  
		Size: 1.7 MB (1714698 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4b6feb7346a784892a8e7d2e9f0fe929ba868f9924f0709815db9a00e66e312e`  
		Last Modified: Thu, 14 May 2026 17:15:30 GMT  
		Size: 317.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7fde68b2cd982cf4c87b34182af593354f02d553a59bba21e0654d2a8143bf22`  
		Last Modified: Thu, 14 May 2026 17:15:31 GMT  
		Size: 790.8 KB (790764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:efc39bf672d5cd0fd08b6d6f64a690b7d40403fad216fec232520ab3d1cc31a5`  
		Last Modified: Thu, 14 May 2026 17:15:31 GMT  
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:38c2363c68774c649bf1f922f940dc5e53a752cc365b0b64df15b67a66474498`  
		Last Modified: Thu, 14 May 2026 17:15:32 GMT  
...
```console
$ docker pull drupal@sha256:bb7b31944107f60f116206c587c4fea1a21217a18262a5c6b2e86572cd11d4a4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **6.8 MB (6812073 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8d546cd1429ee61bf1ae671a3ce61d1b688d0a9bf348a8157ecd00479c0cd14`

```dockerfile
```

-	Layers:
	-	`sha256:e7f156456b9cfa381a166bb34a8e010d14d32af897e37478d26ceef426fdeba5`  
		Last Modified: Thu, 14 May 2026 17:15:31 GMT  
		Size: 6.8 MB (6776454 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:84c4c1eb155251c24196564e49b7f638bc82aabe88a6a4da72b6a915de4305e0`  
		Last Modified: Thu, 14 May 2026 17:15:30 GMT  
