## `drupal:9.2.14-php8.0-fpm-alpine3.14`

```console
$ docker pull drupal@sha256:8c735f5ef4157e3eee53715128780066a9adfc347942a8c742700a8c0b6dead8
```
...
### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; amd64
...
### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; arm variant v6

```console
$ docker pull drupal@sha256:73bf349307f759100985ddebecb4954dbef9a64e7ba2113280c846222cbe5b41
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47903419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b03b0403c5dade7a0c27ad2f4cb2714eef598813f137a169048c0e9a3168e08`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:34:13 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:34:14 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:34:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:34:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:395b9ad1209cb25b4ea53b9013fcfbb2c6239d0029b594022167fb04a748254e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:137757b7d47fd49d5279d739bcb2772475d5aebe6749d3ccc81181ac0d1cbd67`  
		Last Modified: Wed, 16 Mar 2022 18:49:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20ec76972fb0ce3174454a71bab601142e4d1f004b375d9e2f14b01acf9e047c`  
		Last Modified: Wed, 16 Mar 2022 18:50:17 GMT  
		Size: 19.1 MB (19111454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; arm variant v7
...
### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:1e7c7534944882e472260b421ea8b54eff708180552ae4991c581da9e7b9a61c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48709147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:402b94b965ee747000bef0683369e40a9b138a81411ed8d819126afdcec578d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:28:25 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:28:26 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:28:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:28:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba8f0267e16696f4a56bdc02ef33b647eed8cfc4479eb4d46308b034604f0237`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0152c9d392f1bdefae43544170677be48f81be75590d7379669862c616717b9`  
		Last Modified: Wed, 16 Mar 2022 18:54:38 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d831682f65ca6ac7e7c02c258f0b582f8ee4e32bd70615ee4c799e1eb29588e7`  
		Last Modified: Wed, 16 Mar 2022 18:54:43 GMT  
		Size: 19.1 MB (19111594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; 386

```console
$ docker pull drupal@sha256:c58bef0861c1463c982ba20562cee9b22397a97a04c6d3ec237376b6f1a69135
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50163007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:daf132301bfd5485949158328f2b5df07369d7e0d8e383b0b852c4fe8dfdcc2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:34:32 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:34:32 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:34:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:34:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b50d75849ad283ca97a02f4aac9fba1aeb1c420d7cd9d9ff16fd30cc578d110`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0b85e637f4262e35a3644601cafe4adc393c05d974e2caacd35e926c0e677cd`  
		Last Modified: Wed, 16 Mar 2022 20:50:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:518ede76ce687e54ae15b1f15a8ea918a669bc97e55dba312557d3d349894b1c`  
		Last Modified: Wed, 16 Mar 2022 20:51:11 GMT  
		Size: 19.1 MB (19111526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; ppc64le
...
### `drupal:9.2.14-php8.0-fpm-alpine3.14` - linux; s390x

```console
$ docker pull drupal@sha256:b5341bb2a2e8196eba65b09358e951df517b8e58f12ee30334ccdc29b081ca61
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48465749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9cbbdd710453d9185e73fb0ff94722aaa2663d9f5da0cd8405c3350eed7da61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:17:17 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:17:17 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:17:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:17:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f02c1d4a0f3c71124d49a05ebedfda34bc0eb3e9721e12b440865edf3413fd5`  
		...
		Size: 575.7 KB (575712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:942a27ce67a481cd1242f651d0e01f504808214093dd0eabca7e5b1a52ead1ef`  
		Last Modified: Wed, 16 Mar 2022 18:38:28 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9089e4966c034a79db8474d56ae0ca212758961cd094d66c89f8f3d5a4eb4e0a`  
		Last Modified: Wed, 16 Mar 2022 18:38:32 GMT  
		Size: 19.1 MB (19111071 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
