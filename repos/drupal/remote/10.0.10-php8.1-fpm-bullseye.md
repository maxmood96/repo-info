...
```console
$ docker pull drupal@sha256:e95effcad03b003949fc8fdb0a8bcfdf79554a33fa3098d1c9af22d68e96a42b
```
...
```console
$ docker pull drupal@sha256:f400dd99bdacdffa0db296692ed51a84ca35c4938bfffd35ed8bd83f78af0b1a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.8 MB (181795377 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e051f21eae64080fa0f1f0a705ff9df4cd7e47be880eeb8430855160e6572121`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 05 Sep 2023 23:27:40 GMT
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:33:52 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 23:33:53 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:34:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:34:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a66d841f759836e910b2189225d011b2fe26c15c18a2e982b5b23056a68049d1`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4f2e1f4e6b9e57c6c585f0f33124a6abf5332cbdc1fc3e1fd24ee575aae8837`  
		Last Modified: Tue, 05 Sep 2023 23:55:50 GMT  
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26b66ea67526a166f6f48b75b871f500195b869dcee9aa6705377f5123ea5975`  
		Last Modified: Wed, 06 Sep 2023 00:04:33 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:559227f5154a8cb2a45db40d9c1fbc3399c11b99e3f7ac4f2978393c450fdaec`  
		Last Modified: Wed, 06 Sep 2023 00:04:59 GMT  
		Size: 17.7 MB (17696406 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
