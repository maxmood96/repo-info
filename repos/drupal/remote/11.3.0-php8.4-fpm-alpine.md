...
```console
$ docker pull drupal@sha256:c6a099432803e516adc7ceb7c0ff34aa8bad80a580f36e131cfebf08fc42863f
```
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:11.3.0-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; 386
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.0-php8.4-fpm-alpine` - linux; s390x
