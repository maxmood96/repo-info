...
```console
$ docker pull drupal@sha256:f8f4ebeab1cd6ac4f95679a6d2cb2adb7ddf41261fb29dadffd1e58baa0b49b2
```
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; amd64
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; 386
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-php8.1-fpm-buster` - linux; s390x
