...
```console
$ docker pull drupal@sha256:2d3d2523fda77a7af7b172923bc98ec112fc6d121eeb60736206d6f5490714bf
```
...
### `drupal:9.1-php7.4-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.1-php7.4-fpm-alpine3.15` - linux; arm64 variant v8
...
### `drupal:9.1-php7.4-fpm-alpine3.15` - linux; 386
...
### `drupal:9.1-php7.4-fpm-alpine3.15` - linux; s390x
