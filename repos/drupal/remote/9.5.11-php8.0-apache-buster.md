...
```console
$ docker pull drupal@sha256:c5309eaf51ed698b2520d1db1e3806cf9434cd0e262d7192ad69a2f2272cbc00
```
...
```console
$ docker pull drupal@sha256:407f702c0103e7981ce49fd677b27e27ac047e0a86467ca9c0c3e434a7036753
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.5 MB (145466193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:227284845ade9f42f2211936f658c63cfd0ed4a893bf727cd710756d60436a85`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 21 Sep 2023 10:10:16 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 06 Oct 2023 19:33:39 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:33:39 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:33:39 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:34:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:34:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84cacab21c46525fc6be942f3a0ffbd1558e7dbe5a2d2678ebf8f5f4ea658f2a`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e0a2cfc54fc36a3b4c54796e188c04ddb10c8f46bcfb539622dcb5496d2bbb5`  
		Last Modified: Fri, 06 Oct 2023 20:02:49 GMT  
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ad2d435ab86f551f4b9fbda893a1f7a6803aa3f43f73a95be85f57bb86f83f8`  
		Last Modified: Fri, 06 Oct 2023 20:02:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cccf9dc5a0ff4af457fc0a29be37060b12c29c25826332abe189f562c78898de`  
		Last Modified: Fri, 06 Oct 2023 20:03:04 GMT  
