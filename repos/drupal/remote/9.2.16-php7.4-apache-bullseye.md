...
```console
$ docker pull drupal@sha256:504b0d1c7293ebb806ab3877264c23786dd66d4a674a0ba473a4c7b328d48ed4
```
...
```console
$ docker pull drupal@sha256:1df07d3f11b1a774ebcb0bf3037b3bc738b737436b79a72eb0eac74e523610d4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184909184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bb9a5802258b59b333ac2e90581a7ef47cf231029366ed0d218e864873de9b5`
...
# Mon, 04 Apr 2022 22:15:16 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:15:16 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:15:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:15:26 GMT
...
-	Layers:
	...
	-	`sha256:1bb8bfc87b4069e1a3936471707e27b9e63e37e00b26bc7d6e6365bac28b04d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2feeb34dc21a193cbbcf6ba5c6526a07c41bdde2095ce06b10ddcf8e12cc9b8f`  
		Last Modified: Mon, 04 Apr 2022 22:34:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdd7b135e61d87d59f0a384ae0746fc7bc43bdc85ec345c7ed88c98f41152352`  
		Last Modified: Mon, 04 Apr 2022 22:34:39 GMT  
		Size: 19.1 MB (19115725 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d1eeb922f6705f36cb1651ec51c0f2263a68bf2a43c4de74f5fdb82043cf1746
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155156206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cd523e311ab83ba20685b43f300bedfd7988a726dc1e903703634aa5455b9d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:48:12 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:48:12 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:48:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:48:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eaa09d9e329e251b46a596d7791f3a3fe0658280acbf57ba75f33fe57a6f2d87`  
		...
		Size: 660.1 KB (660097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c2868bc5917b0d03a0a3330b6da13ba63a8dd179b60a50cddb8adfd88b3c9db`  
		Last Modified: Mon, 04 Apr 2022 23:44:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:589ef4891a287b4c79f33f8f88c86618b569a5be45d30e66b26e13494f93e454`  
		Last Modified: Mon, 04 Apr 2022 23:45:03 GMT  
		Size: 19.1 MB (19115245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:99ba55b9dd06524a7600674312b3014bebc0fcd8c4c54fcfb8fd05c9ec4133df
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177750694 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bfbfd9cec94f621d58f0eec5002960bb22ae06041eac15f15c3c74756bc40bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:29:35 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:29:36 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:29:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:29:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3046ffd00a22030852bf1b2c26422ef079f558029fa7b7d0a6094fb18de91cfd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f4bc96730ba8a645bdc19c3bef78ffce3060aa41ffc40152861b6919de4d32c`  
		Last Modified: Mon, 04 Apr 2022 22:25:49 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecf6105bc55f6fced935f23408010f9239d63cf2338076d055007051ca37b8c8`  
		Last Modified: Mon, 04 Apr 2022 22:25:54 GMT  
		Size: 19.1 MB (19116270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:8f1a9f7cd4f8cd031072a98bb2dd4cd7d38f73aaf43bf61c9e00df6d0a68aadb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186983789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b23c5707281b22014513709596ee4e139d2c7b9e166d98b1d0c9201671f3b57`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:c76440af82b8fb39df1b2f1ba07abbe8449a13f6cc826d5ce681e489d2f44f16`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec3836ea8d61fad6d07b7998096965d9d28398c04c1d23fbd548c45b903f2298`  
		Last Modified: Mon, 04 Apr 2022 21:33:02 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6640801a31bfcc24704554cf7c5491727f2579ce90358021ced952a99e4b4fd1`  
		Last Modified: Mon, 04 Apr 2022 21:33:07 GMT  
		Size: 19.1 MB (19116924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:6e36bbc30a4fafebb2ccbaedbb5d9b0e9548c6a58c68d95506933e0f66162413
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185972281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72e6f95f3b505ffd61c892c888ca47d620a583350d1c8c8d33d92f8087b639ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 22:27:00 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:27:02 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:27:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:27:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15f4d21dcff93fd83e04862a3db1a333eefbb5f74af23afce7d52075a8f635fa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8077f934906322e38e40c2f955c1e49fa92b97394b2f0a097b0d82df1bdb90a1`  
		Last Modified: Mon, 04 Apr 2022 23:36:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42a08ce8d89f0879ccc77edb8ce2ab63b7d9f1891c647453126ceef365e53487`  
		Last Modified: Mon, 04 Apr 2022 23:38:54 GMT  
		Size: 19.1 MB (19115758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:07468d88facf4a975ebd81f7f36641b2261fc43ad9f0ff6b87b1542b161226d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.4 MB (162446766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c89768a2197e36bf72bb70ad8fd488b2e6ad0c2cd18e08faa45e7e6bf49c60c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:13:52 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:13:52 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:14:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:14:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00f0d3f2b8cf1b5783302dce0136132f6cc23ef3dcde223e71c52dbda96b9b98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cfc0be337134aaba116f0345890fd33ad96d978866ff18b7799ba5d4e209264`  
		Last Modified: Mon, 04 Apr 2022 21:34:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cac5213bf7213c2a111f5db839628c0e1c49df66244a6bc1f26e721de3c3f79`  
		Last Modified: Mon, 04 Apr 2022 21:34:33 GMT  
