...
```console
$ docker pull drupal@sha256:a99d44ce4e5f343a3ba91320a45b7c63f6401a493392c9415427b207aba7c74f
```
...
```console
$ docker pull drupal@sha256:8160a57a667de0ca0b3d52962d48d62036d88c72a3b9b027acb1248aa3910bca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155155652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01c8817acad5a27c385f471cb5d950d4afdc33bee088265a3d49ecd743904804`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 01 Apr 2022 19:49:11 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 19:49:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 19:49:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7706a130ff25a0f7bf007d0e34a005c22563cba5de7b686885a10315492682a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fc24d4bde9209d998106f131b14b4eca1446fe4ec89c8a938d22437f25417fd`  
		Last Modified: Fri, 01 Apr 2022 20:38:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f896c38cfa06578e5ff5da59b1fa6a5af2c32f850c2c6baf136cd0b1f8039054`  
		Last Modified: Fri, 01 Apr 2022 20:38:30 GMT  
		Size: 19.1 MB (19115753 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f52169c05eed1ce228b412e1b6fb4d5fa45be7c841b92680e055fc3d8b736864
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185971131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7acf6d49d964b99401acaa79ab7cb6ac25293833804e27209ae748eddc393e97`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c3280c5aa1c63545b95c5964162aa4e4237d0a5e557cee74de211cd921f827d0 in /usr/local/bin/ 
# Fri, 01 Apr 2022 20:43:59 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 20:44:01 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 20:44:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 20:44:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:545ff1b3ab652e93f5144e30033e884a650b2fe198726bf59a77dbfde26e5516`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c25df17f813f71ea146c7f4e1f76c68e289e36e92d6fbee0b54df22d5460be98`  
		Last Modified: Fri, 01 Apr 2022 21:46:04 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9d66993c8c6dd98d1b99cd830713de01f89403c21da476ae83eff5456ccb671`  
		Last Modified: Fri, 01 Apr 2022 21:47:07 GMT  
