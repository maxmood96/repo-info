...
```console
$ docker pull drupal@sha256:5e9c3f1dfe39531cf6bce37d05aa85039287bc25613b8b724867a3e1a0be7c27
```
...
### `drupal:9.2.16-php7.4-apache-bullseye` - linux; amd64

```console
$ docker pull drupal@sha256:35b66ec7b3b9226893278daf9a50a2f5e0d9a0f3232ba4a2167f2cba11472d66
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184910183 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:572c9c222d4390355c98982f2244915b810cecdf359ffbc4019fb71e74b1d43a`
...
# Fri, 08 Apr 2022 20:57:38 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:57:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:57:48 GMT
...
-	Layers:
	...
	-	`sha256:0d9f4d936953fcf5aa70d25fc2ffc63f4b26a69661777401483a14fc61ff6612`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6139cf0540241d551de3720030db538dd1f038f148f4a8595245228fc60ab3de`  
		Last Modified: Fri, 08 Apr 2022 22:56:52 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6e21efbc12755780e0bd6cd7c1dcb680944960b9b9842ddc51d019bea90df29`  
		Last Modified: Fri, 08 Apr 2022 22:56:56 GMT  
		Size: 19.1 MB (19115888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:dcc60edc86d6cd4249f4599179458523f4c7cfb3aea8f3bea5c1830d40dde2c4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155157561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43645b29c832b58f55ac3a55a1a8f207447e93963ca644c43717236b5a413ac8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:38:34 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:38:35 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:39:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:39:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e8169af5d9f5b15f4e569f3a48bcd7fd4692c2caa385914a1d8bf4b22200ebd8`  
		...
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f549948273988c4f534cc21efb429cef7d884f59501291c04c8d34a20f3164f4`  
		Last Modified: Sat, 09 Apr 2022 00:08:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:051d87aa08e30d76300b80298c3efff6ceedcf344ed3c92cc41914f6dcd57886`  
		Last Modified: Sat, 09 Apr 2022 00:09:03 GMT  
		Size: 19.1 MB (19115763 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6a59dfa3700e72da0019629243e8f4f75a8de74ddfdcc398203c1e6f7856ac30
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177751889 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b07b24729b081c901fb86b0b01194aecbb134bb3a17ead3590d3f266a1f4952b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:13:56 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:13:57 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:14:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:14:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cd2033a3f8b353cc70de6c3fe795e72b6d41f5d5a5e7b10ffe6309b8228c7d0f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6536d8b10a9ddea4581c6d137ea4c094f753255b4a9687f480eb4b179a43b308`  
		Last Modified: Fri, 08 Apr 2022 21:39:11 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4d7abb7c7e01ae91cdcf4957e8840e569c06741631d2dcaddf9c05d2bf6de12`  
		Last Modified: Fri, 08 Apr 2022 21:39:16 GMT  
		Size: 19.1 MB (19116634 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:90b46ec548952c46c465e46274ff8165c11b7ad48684e4ff34073eb580f1a63f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186984344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cd7a9559093bfe92e88c87219676bb30157f8c80b594e5a2a7aec42ad88d9f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:05:33 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:05:33 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:05:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:05:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9167a369e2b80773d13e7d2a455cf8070e7e14b42e9f5d7d60d991de7e6ece0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb3b2962dd2236bca8b816e0ff5ff88e66132ad9b812b3061dc5f5e33a3f3164`  
		Last Modified: Fri, 08 Apr 2022 21:31:22 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcadc7f65ef6bc4f33455bf5f4354f695c7f8aae3bfb5ff425da2e6c9dc9f94a`  
		Last Modified: Fri, 08 Apr 2022 21:31:27 GMT  
		Size: 19.1 MB (19116642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:69690a0b931d77630fc2281996bbe96c199f70a205cbd206e739414a18c99431
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185973286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f6a2e87f2034cb3a4cce513098e6d3ca4b94d7bf5d16402c30bb4bfe837b4f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:00:16 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:00:20 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:00:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:01:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:863177290ab15e0864a66ff2b2550201a5ade421c1495234c617318c5f52837e`  
		...
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96acb4ff63e832cf2e79f9945faf4f9b1cfc7ff2cf60f1a5e1b803bc33bd8af0`  
		Last Modified: Fri, 08 Apr 2022 22:03:02 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3f38154e995cad8f0d78dec7c208b9459bbe47e19a6f3e1fc3905250ca43d48`  
		Last Modified: Fri, 08 Apr 2022 22:05:07 GMT  
		Size: 19.1 MB (19115926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:a2bdd5bcf1b7a46596dccf71cab8cd2dcf19cfa008423e64d2e8769a420e40b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.4 MB (162447491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e65dc1045bb6be78dff30e0d8f7fad9c406714510a66669da9edd8a03248b34d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:13:20 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:13:20 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:13:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:13:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b47d06d7c7107a954665c40587ba3ef4fc3945fa49c8654bfdcfa7b492397ee7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba5f7def34d778d6a6e4e73ede5f65851379960346b64584e628b4443ff6ed91`  
		Last Modified: Fri, 08 Apr 2022 23:14:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f539bd0f5918a79ca544f533589bf6086c86ebbfd8221451d7abf33a5372de2f`  
		Last Modified: Fri, 08 Apr 2022 23:14:49 GMT  
		Size: 19.1 MB (19115621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
