...
```console
$ docker pull drupal@sha256:b82f30391b7b9d67dfd0bd6bb5b9ced9af914ce6d77a71bc4b16779d114cd3fa
```
...
```console
$ docker pull drupal@sha256:ae58aa3fbaef561d7a811286263f7924bad67d70eb6d2dd957637db53e8566b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155069368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13aa75918da5dae03ad85a89c861e7f674d77b9c420642def0055e4d2ca7c181`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Mar 2022 22:06:01 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:27:58 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:27:59 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:28:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:346b1369d5522fccaa4d3fc2b7233ebbce9399e7bbcdd262c5c2c92a869b2400`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f3379f31bc9ff611a8aa220a683e56c4fa57cfe2787b504671de840db2c8df4`  
		Last Modified: Tue, 22 Mar 2022 23:11:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f2b8f787f8f0947a2e40e71b4d8265503227e50ef4dd493492c62cf432756ce`  
		Last Modified: Tue, 22 Mar 2022 23:12:23 GMT  
		Size: 19.1 MB (19116130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.16-php7.4-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:4909f1818cc5d07253da64b2393ecce3b9ab39be7a4a9975a1f1c5d0194f5ec2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187744807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a7a5c84bba9d04c2140984cc4823cdbd016d275ce4a1d05d2df7c0ef41033e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Mar 2022 06:23:33 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:47:12 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:47:12 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:47:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:47:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5e58d708c0dc18c93949392257934bc0a05b019575e39f44dd0c8f3253370c72`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48b6b6f4afe0488fdcad71e3025b32295f66b509be4b3fbf49a8338d91522202`  
		Last Modified: Tue, 22 Mar 2022 23:12:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee6ea9b316a62b9f0ba52fba3f9ab125201e6b776a68c9f63299d9ece23e0624`  
		Last Modified: Tue, 22 Mar 2022 23:13:02 GMT  
