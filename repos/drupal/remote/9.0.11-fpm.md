...
```console
$ docker pull drupal@sha256:be15e21aa78e00f504e32794a4747fdd42cfae8ac65e9ba0130aa741146c7758
```
...
```console
$ docker pull drupal@sha256:4188812746476778a1e4d76ddf6deaeea4b4a314246d0544ca76e0fe8af5c77d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173361041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38b8a46dd28c3364ed7facb03f6eb3c330d5c085b22ebd28c4516949b653362c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:893266ce95e6af1eb6a1906f755f43262047a47070453526958b5cb545d393f2 in /usr/local/bin/ 
# Thu, 28 Jan 2021 23:13:32 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 28 Jan 2021 23:13:36 GMT
WORKDIR /opt/drupal
# Thu, 28 Jan 2021 23:14:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 28 Jan 2021 23:14:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:47b6f0dad9d345ef61ad038e86f608cd03ac82ce31ef4e8819d1259112680f60`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddb02bd7021139837130d3580ba6f1b55b157cf39d58c3631340ed15c19de5c4`  
		Last Modified: Thu, 28 Jan 2021 23:32:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ced4b995e45f4de801b0ca4b40070b931d1a3d2accca9ef3a0abbd0a0638dfc1`  
		Last Modified: Thu, 28 Jan 2021 23:33:53 GMT  
		Size: 17.2 MB (17240817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
