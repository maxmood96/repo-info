...
```console
$ docker pull drupal@sha256:e14f1cf70d347baad9a34f39f74ee80a1fdd64baf31759000a7e2fd31594971c
```
...
```console
$ docker pull drupal@sha256:271776135dde85b8635d3f164412acb56930ecca37fc212eb71b636494528ceb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.6 MB (154606535 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ecb92ad221d13e4710bed701f86183712977285e742dde85abceae7b5060849`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 23:20:29 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 23:20:30 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 23:21:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 23:21:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d9ba6cadb53a05b208623584d890a5e6a11274a9589a2ab78fba0aa087603210`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:624a74d5547cb8e5e6f967818b4bffe6d1713e8cc5b6cefed7a722b859ddd049`  
		Last Modified: Thu, 21 Jan 2021 23:31:31 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50620471f31037cd7a0a25a1d6f3adb4fcd567dda20db037d0d8beef0b934e2e`  
		Last Modified: Thu, 21 Jan 2021 23:31:39 GMT  
...
```console
$ docker pull drupal@sha256:453d748583f870e52cc28b93d74d3b93053a9bdfa2a02b248e21f782a7081910
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.2 MB (148161000 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bb5103698ef0242a4e9390f47091a59d67df99a61aaf676929ccc1cc2403b29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Jan 2021 23:02:12 GMT
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 23:02:13 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 23:02:14 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 23:03:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 23:03:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:41abd1d91f25eb5bf6bbea45bf6cba1507674d943d13fdc6619383776e86e558`  
		...
		Size: 508.4 KB (508388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a75f8721eb1e75b89f581b9dcb0a2280f5f2c3055efb3d275176fc360bd1552`  
		Last Modified: Thu, 21 Jan 2021 23:13:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3f36586bc4d6d54d16528f66b24cca2785b12bf82e958e37b7f15487843350a`  
		Last Modified: Thu, 21 Jan 2021 23:13:50 GMT  
		Size: 17.2 MB (17240748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
