...
```console
$ docker pull drupal@sha256:03a75c13a423ad2b3e48edcfc8f2d28b64de6a35bf6e858d9ff9297a9c206a9d
```
...
```console
$ docker pull drupal@sha256:33743ff5df4d548b4dbb35a61ae713d7b73b38d7464d53204e5e5baacd8b4d98
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168266570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5488e1b4d074985a2075faca701fd75ca5c09be2b5b0bb33aa7f404766682ef7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 21 Jan 2021 02:45:05 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 21 Jan 2021 02:45:05 GMT
WORKDIR /opt/drupal
# Thu, 21 Jan 2021 02:45:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jan 2021 02:45:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc0956f74c74b58d4750eacb68446bbba43fd6abd7c83b3df2c0751f4f2f0559`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:720ec034f8855c73420bc94f20789845b2d77aa408f328470319a24623aaf6f2`  
		Last Modified: Thu, 21 Jan 2021 02:51:37 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fea5f0750cb17f4fd44563ee09bca9c6340a4a847aea3982350b6e76acb1cb8`  
		Last Modified: Thu, 21 Jan 2021 02:51:51 GMT  
		Size: 17.2 MB (17240780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
