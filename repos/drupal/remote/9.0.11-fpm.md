...
```console
$ docker pull drupal@sha256:d3ffca37ebb49514ec99443bc2496a737405a6aad06d1d34857395f03d2b1c50
```
...
```console
$ docker pull drupal@sha256:fd8541c4c9ff38aee9b2e4b3b29a0e580737e991b61fc195d26e87d2e610754e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168288082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb671055c715bcc267e612f8203bef5ee61de6b4ab616dd19a217a0203d077ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Feb 2021 21:46:52 GMT
WORKDIR /opt/drupal
# Thu, 04 Feb 2021 21:47:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Feb 2021 21:47:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3c5662ec616a05de0d50f943dd738e627a0721035c8072277545e29e291e2b59`  
		...
		Size: 507.4 KB (507425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95c97a47bb5007d65b9381747e6ee958d24b06268b1229e94a7ad16af751c564`  
		Last Modified: Thu, 04 Feb 2021 21:54:10 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9c3f18d2d2d82140603a6d4370d81a787acb6522f9b1f0b0e6a7a4e5f611074`  
		Last Modified: Thu, 04 Feb 2021 21:54:23 GMT  
