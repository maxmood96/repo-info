...
```console
$ docker pull drupal@sha256:076fb01f2158cd2e9907b22010c3140f520a845e3f54201bd504ef1b2b865098
```
...
```console
$ docker pull drupal@sha256:79b3972559062b0999c96ea19cfd258dbf540888237eda48b333c2a59825e02d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168349964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49ba0cfeb92f0fe591584810e8a021a68c52741e09d335e0475d63b6f0b86ed5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Apr 2021 18:58:52 GMT
WORKDIR /opt/drupal
# Thu, 01 Apr 2021 18:59:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Apr 2021 18:59:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:62353f8458a8916cfb500126516c86b1d61222120d77d87e34cbeb423a9bd90d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b424a98512a1643d3df4f82996bfdcc866736fbaa282b508308f8618874ae6f`  
		Last Modified: Thu, 01 Apr 2021 19:17:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cfe5c812ba6fadaf4d4e5e996ac64bda7203d27354032b2de44cb9684c1959e`  
		Last Modified: Thu, 01 Apr 2021 19:17:59 GMT  
...
```console
$ docker pull drupal@sha256:663bee00e54aaa7510e64814fad12d4c30e29c0ead0ff8c0089bae8eb1e72139
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.2 MB (148227049 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:518418c74049019bf3205bdebb4acacd6f8823faadbf0f2b99de3b42b9d5947f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:337078dbae1f3c47ff0a566503173154dbf4da6435b4ae6957b6d70fa93da4ea in /usr/local/bin/ 
# Thu, 01 Apr 2021 19:05:04 GMT
ENV DRUPAL_VERSION=9.0.11
# Thu, 01 Apr 2021 19:05:05 GMT
WORKDIR /opt/drupal
# Thu, 01 Apr 2021 19:06:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Apr 2021 19:06:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e802a1f26a715a8f6d1375049de1d2f3534497b904d522acbfd2665e63ead76f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e4a0316a25ca16c3189843ccf1cc1f6f87b59c35c1850aa83029ebb633c2a35`  
		Last Modified: Thu, 01 Apr 2021 19:21:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e7f35867990d0a63a554f47b268e47964c43e3245ccca39081c03212adcd3ee`  
