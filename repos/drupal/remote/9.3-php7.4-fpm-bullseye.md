...
```console
$ docker pull drupal@sha256:ae2a48d2c19ca843385b51273f20e0f48745e8f9d91550c4995703572bb6550d
```
...
```console
$ docker pull drupal@sha256:8898d747a66b6cda7bef7771675475ed5a1912f21cf81d7c7bc553198f5f9c48
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.5 MB (152487195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:851da766f658bb68bebee7964aa5668dedb0d90567089fa5594b83f32b9ac066`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Mar 2022 18:17:41 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 03 Mar 2022 18:17:42 GMT
WORKDIR /opt/drupal
# Thu, 03 Mar 2022 18:18:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Mar 2022 18:18:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0087621530d02a6aaa3268692794556e69f1d8688d42f862a9f0e6fae97dbc51`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeaf1ddeaa11d2781da1c7d2368d89850622b43ab9642b43e909770a7688f488`  
		Last Modified: Thu, 03 Mar 2022 19:15:58 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1dc4b3bbd1a1a586f940a23c0ecf517c0d9e27fce213dc87fa12e8ffe7e257a`  
		Last Modified: Thu, 03 Mar 2022 19:16:26 GMT  
		Size: 20.1 MB (20118664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
