...
```console
$ docker pull drupal@sha256:5aab83d9ace8d5ba3bd8202c6ddc55917793d2d3e47db01bb2251fa2be2bcd58
```
...
```console
$ docker pull drupal@sha256:0b5a4255cb2edb32725ae3e6f8fa4fdea1949ca4c18bbc9587bdad088a544306
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.8 MB (162830316 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c905a30eb2573256d96c388ef25e3b5e45651f9fc3f4a54c473c77a63173531`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Mar 2022 22:16:46 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:16:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:16:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0a72d9bac20441fc673c7a0a7ed34f3083e4341beb5134f17b40529a45a86d1a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b4a6e3f7844b5ed4a995cceb5ad7b69ec88e0e9f8d7fcfb523871f5bc6e7ece`  
		Last Modified: Tue, 01 Mar 2022 22:37:24 GMT  
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc461957ba2861db015253ae2aa14c59c578dca9ba4f0e1e9dc39026c0895264`  
		Last Modified: Tue, 01 Mar 2022 22:37:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf7eee73ef2006e62bb8433581d7b2631f9f07a7bbbcdae0ff37cc1f849c6bf6`  
		Last Modified: Tue, 01 Mar 2022 22:37:28 GMT  
