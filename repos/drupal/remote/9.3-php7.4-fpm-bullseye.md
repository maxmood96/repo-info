...
```console
$ docker pull drupal@sha256:d77b9acd6814aea724a2b35bcafdc13129b1bfd51fafdba4fb5aed4231696e88
```
...
```console
$ docker pull drupal@sha256:e31f91ba8befeff43f7c8d5060472d16c2b6566ddde143a7f27f1319feb4a896
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184912266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb995a55d38f82e470f1fc32fa63d9e48e7146c1f491077ce470006ccbc1cb99`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:58:53 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:58:54 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:59:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:59:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:042d8d36d4711a097d5001c26338db60ae2d8a4239b1d60f59cd1e99f92321e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95a31f877a7b730c1259cdfc10000d34f4d9585cd3d9098659117c50b4cb208e`  
		Last Modified: Wed, 16 Nov 2022 22:57:31 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d91a97825382348ff27b6946819eed9fab5800d7637db9b3a59181fceed7179f`  
		Last Modified: Wed, 16 Nov 2022 22:57:50 GMT  
