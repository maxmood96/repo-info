...
```console
$ docker pull drupal@sha256:9ba2c16fb55eddb4899d38fd3a3c9983ff347c2ac50a5870052a13e34ffb0c8d
```
...
```console
$ docker pull drupal@sha256:4d3ea58c26f017021d9b2dc470f2992e22402797595450fef967e1f06e67d667
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.2 MB (185223822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a497cbda47ce9f9fd5869710226d34528f9d2d25a2cf95a4652b46df7a96364c`
...
# Thu, 06 Jan 2022 20:25:05 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:25:05 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:25:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:25:19 GMT
...
-	Layers:
	...
	-	`sha256:a904f7c7f2406e045cc6c0baf1e8d46124549b827626d2397522cf4d276999e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:645471c22caa3e3c633ab96b072978f9011727c93de8124927663524c1ae9ddd`  
		Last Modified: Thu, 06 Jan 2022 20:34:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7155eaf209fa6e5e5e0fe9d6d89d9db4a24dc40999282db0f43ef3a87bfdc331`  
		Last Modified: Thu, 06 Jan 2022 20:34:37 GMT  
		Size: 20.1 MB (20141571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-fpm-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:f9e5a73365e24e42938631b453414ec609851208c6c429c0ee4d8584567c730b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155520638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed20a253af943a14f5cd81429f231069f1c452ee8fbc456f16b7311b99959e18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jan 2022 20:14:36 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:15:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:15:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b64938c3886d4ebb9410e9bd4fb589ca6f36309d51403af3db6e89923d851d7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb90e1d1acbe7af2e98622777610eb305977c7076bc33ba4484ffc4e4e17e97b`  
		Last Modified: Thu, 06 Jan 2022 20:45:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20c4ad687c3ad8806d28e09af730342daa0b55893bffb456a28a7385ab529ab5`  
		Last Modified: Thu, 06 Jan 2022 20:46:24 GMT  
		Size: 20.1 MB (20141188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:81e12d6b3f5cddc11dd85ff8e32333b6150c3fed079b570e622f5f341fffe196
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (186030480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:431d0a2f814e552f4bb0e9ecae8b2a6680918ea5bf6ecf9f3d3b28010cc38d1a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:29:25 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:29:27 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:29:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:db201b1ff8e229dc21301d27afcec442a2540ddb8d7321df45278c010cd36db0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b5fc79f4d4388bee801faec5f07335247967caf5f732ca54c805124f154ee47`  
		Last Modified: Thu, 06 Jan 2022 20:50:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c9c3b5a692977ef8e53f9675260487ec655d5734c9dccacd60bbcb6d45071f7`  
		Last Modified: Thu, 06 Jan 2022 20:51:17 GMT  
