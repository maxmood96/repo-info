...
```console
$ docker pull drupal@sha256:d93d15cd63769e35f538be37ae21fccbb92f8fa0a2a986d782bcbd84f9902892
```
...
### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; amd64

```console
$ docker pull drupal@sha256:cfd607a3873067b63879cb068235f5b5207282289ae2b98b3985735274a175b7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.9 MB (54926631 bytes)**  
...
# Tue, 29 Nov 2022 05:04:47 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 05:04:47 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 05:04:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 05:05:00 GMT
...
-	Layers:
	...
	-	`sha256:cad910cd2334bf8bcbf670f8e7103e79d04c97cc75b8b9ecd96d666c9f9757d8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9061b5030316d2abb125e2365ca1ad97e50874125f3b0189674431084d9fb97d`  
		Last Modified: Tue, 29 Nov 2022 05:24:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:613c70d46e565f38eef98f5a128ac23e8079fa54a898f49e185210feac54d864`  
		Last Modified: Tue, 29 Nov 2022 05:24:42 GMT  
		Size: 21.3 MB (21314755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; arm variant v6
...
### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:7a156112a52365ddfdd855f619cbf193678d2b203ab22c22d3b501a28609091f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51304061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf47298365e82d7b242c0a3e884d9062f22836252775a2f7489d321bb8c0fbb2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:50:41 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:50:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:50:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ef3d8611ccc8fb456e50580b9ac66d9e25b034be9a37dfbc409df3956acf6c61`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d37564c6806c2acb0502578f3a6cbe1bbe838d50e2b34d21219b5011c0bce938`  
		Last Modified: Tue, 29 Nov 2022 07:28:06 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cc93b39ce9d131577253ed670a9dae1391f8c525469e1b2b430dd81dbe2dfb8`  
		Last Modified: Tue, 29 Nov 2022 07:28:13 GMT  
		Size: 21.3 MB (21314727 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a30c9ca25e44e7a927418743558b7976f0663c45b0ae960b673761de00d01e59
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.7 MB (54749504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bee6deb1c150fc064fb2ddb55e4a1dfb445b12907680a619dff7d8e0649c1ef1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 05:57:26 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:06:44 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:06:45 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:06:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:07:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:56ee2b0c147d2cb3f0927ae1bfd69f6ba7a5deadee370e648955602a3a85cb8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20ad137cd5521a60d106efe2e565f46eb03e207a6a98b334b3edfe156b0f31ba`  
		Last Modified: Tue, 29 Nov 2022 06:26:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:404e2ce3b6b676465be8ef072ceeed477dd2cb092bed49f65eee0f84b7c5dea9`  
		Last Modified: Tue, 29 Nov 2022 06:26:46 GMT  
		Size: 21.3 MB (21314708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:afccfc482e7a2d2fd71df7b55dad184e10764dd40658dadbf48644aa8f991a95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.4 MB (55395646 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a67aa47be9503ff6b10a7985b3b71a4689910ef4824cdd7d0b81b4a37832205`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 05:30:06 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 05:30:07 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 05:30:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 05:30:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc3fe53e0e8ea17c03c859198621654819a4777ca76a639310984288440d9e2a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c8cc5eab08f364c1b8c8de0f5ac95ebecddc1d39e73850c1fd1d0598fd2e59d`  
		Last Modified: Tue, 29 Nov 2022 06:00:59 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43415258993f670aac30f5fc7d6effa465841ca19d4d6f65f6d61aeae2e9ee36`  
		Last Modified: Tue, 29 Nov 2022 06:01:04 GMT  
		Size: 21.3 MB (21313925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:ec52650bc7d32118cba49a9d542eef41c996fba7a7ce7f634ffb0ea3afda294d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.1 MB (55128952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f227eeeba31c6290c1e0c3d7cc81efc818ba2aacdf80913ebc18af554458762`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:55:49 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 07:09:12 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 07:09:12 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 07:09:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 07:09:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a9978895768670e3922f73a219bda5bf1ad0a360b5b0ab51627f6cb57acf06ef`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6178f132c8a89839a3ccd7df8aedf951e478933ff76fe333af9cbb85f4b04867`  
		Last Modified: Tue, 29 Nov 2022 07:39:50 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2ea0eb1a09f3c8f5e2c2d817d42e3a2085db8139f8f08f237ca5bc01310b3d4`  
		Last Modified: Tue, 29 Nov 2022 07:40:15 GMT  
		Size: 21.3 MB (21314731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-alpine3.15` - linux; s390x
