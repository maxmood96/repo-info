...
```console
$ docker pull drupal@sha256:7176800501fa1b2ad621fc63e71d7d4cbef4645fd71c62dae4e037316aa15e62
```
...
```console
$ docker pull drupal@sha256:de80ba2c0be20e5aa177a6850ebe7bfba4ad34747ad06b8063aa67950043f836
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159117040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5829cfbc8346b7e17239c2cee2a87342c7cf1d7414877f7484b4e1b5fb556e36`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 06:30:52 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:48:25 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:48:25 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:48:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:8a8ea6ea3e67a86ba04e25bae469857072f4d3fd7b3b08a76a32daaff5709b4f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f10b5e8e1b61465ebf9e55c31a5d3d9f8649140ae213e99c72c0380f1498bff`  
		Last Modified: Tue, 29 Nov 2022 07:26:05 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5beb75f2388c81add3bcf503d2101bb543977810bf6badde2fb51b277613c9a`  
