...
```console
$ docker pull drupal@sha256:69b3d13c1860d3ccafd3f6e0ebc4d8d32516122b1e0ab87518f85258427b5438
```
...
```console
$ docker pull drupal@sha256:4506b00c0d38665a2ca02da93e085b602fecff14f4c936a9460f06acd90d2701
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (159029165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0dced19b3b3dd88a46f8a72635b38c4cba08fc125fd1f04401685c2516f6f21`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 15 Sep 2022 00:07:57 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 15 Sep 2022 00:07:57 GMT
WORKDIR /opt/drupal
# Thu, 15 Sep 2022 00:08:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Sep 2022 00:08:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c55854f67c5552c5a6fba3d96ec529c00f782666c212170fad22eb5dc4756348`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2904aaeccf886871a53bd24a7d4906cf30b8ce95eb8ed1f9a44a9d6c97adc7c`  
		Last Modified: Thu, 15 Sep 2022 00:45:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ea68378e719c8b2d119be4c6b1a6685d5b7d9cf991f6f67c6ff56cc8016c543`  
		Last Modified: Thu, 15 Sep 2022 00:45:54 GMT  
