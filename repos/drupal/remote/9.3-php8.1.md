...
```console
$ docker pull drupal@sha256:22390002cbedbb5ebb8799f74ddd6b25e0d90974d80960f91449c7ec3d68854a
```
...
```console
$ docker pull drupal@sha256:7923307d202cd8336429c11d2cf66bc7a2bcd85bcb03fe66e05474cd4d421e0d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.0 MB (182963122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19203f6ac228fcf1c8232582c595a38564daa1619b17cbc05f609c7bc957d125`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:50:04 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:50:04 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:50:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:50:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f781a6114bdc5491e668827718b9afebd21bb4a29d58f280e940c47657d69fe`  
		...
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:536dd79df5c12c5db29bc65feac56cf5296b3a2c6a4a994e51aa384541d42b87`  
		Last Modified: Fri, 29 Jul 2022 02:21:44 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9acbf663a81f96dccc205dd887e672dfe29a032751455079863f84861cd5ffc`  
		Last Modified: Fri, 29 Jul 2022 02:21:50 GMT  
		Size: 21.2 MB (21225246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:33e84a32d4f4d8017e8469e61a6c382c9ef0a7fa555b49a448e34be452f1953f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.6 MB (191599353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80fd113e99ae955b35195dfa6c4ceff39e4d0df37a8ff26a044733e5b488ad27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:47:29 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:47:29 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:47:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:47:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:048e2831d6a79bbfb129488e10595d7040a428410824963c1c89986c83d53704`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c661a27b9b40c87958240efa16d7165db5ebc4c6c58d3f3bab2884084cd480c3`  
		Last Modified: Fri, 29 Jul 2022 02:19:28 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1665d86c56ec86ef37e2d4e9d76a2cacd509a33bdc482d2c607e7ae10f5214ff`  
		Last Modified: Fri, 29 Jul 2022 02:19:33 GMT  
		Size: 21.2 MB (21225328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:124d5fb9551c4b2bf799fdb5727ff5873f7aa346c6de2432618dcb5c22d2588f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189759440 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360336ccd4cc92af459aef838a4597dba9516be02521997e779073b6213e623e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6ca28c039f261160fe2f91b741600ade3757d37985306ee52d25af652f780dc0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7db41942539a200a26075ec50d25ab5c8868cdcc34751eb8d4b1241ef1b3a4f`  
		Last Modified: Fri, 29 Jul 2022 02:42:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f04fd93d3fc1575e20dabfa468d0dd7b2418fcac5afd53336360a6d173492310`  
		Last Modified: Fri, 29 Jul 2022 02:42:42 GMT  
		Size: 21.2 MB (21222969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:66987689d3499a215478d0779c1c6674d18adf013389fcf60e517a182af7190e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166195833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a03389475a57063b5e891cce901f0dc08893defdfe1ac17f718054fb743e07a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:52:56 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:52:56 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:53:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:7aff60aaf3ea50f3d7f81a0d36fc11f875f0794f4c6a409b7d6d5cef28eb8ce3`  
		...
		Size: 670.4 KB (670416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82a9e4cf5a9d4cc436f1cbdfda950741644864ad4398b5d2da786319d125e40e`  
		Last Modified: Fri, 29 Jul 2022 02:21:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b205e36c028a3c0517caf17a65e240552ada8a3753358e8acf92e3fe132e86f`  
		Last Modified: Fri, 29 Jul 2022 02:21:28 GMT  
