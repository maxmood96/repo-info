...
```console
$ docker pull drupal@sha256:ad4b3231be7c235194a49f1a72fbda9d96c5fd14b46a7a076097384c236c83df
```
...
```console
$ docker pull drupal@sha256:806098b52343d721762566aa966f30fa6130ee8836397be00692a16708636269
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158885870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c534b0ecb30d40e181cbb31152ec0cb9bf508990777c6ead73222a54a3088c18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:00:27 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:23:50 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:23:50 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:24:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:24:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a18488d9a9590f9e8f93a95a934c6888592da22a25079248030733e7167fb73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a842f2e898fe0aa38f4d43b6a0cebab84d6664d2ddb3b74196facf62911a1e70`  
		Last Modified: Thu, 04 Aug 2022 10:10:42 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd0df25904d008547f55b935aa19c585084132bad08406255486f3e9fedb6799`  
		Last Modified: Thu, 04 Aug 2022 10:10:55 GMT  
