...
```console
$ docker pull drupal@sha256:e035f67f0c544c8275fb66ee869ac2ed693411d2c5139be383b61005b930c2e7
```
...
```console
$ docker pull drupal@sha256:5fd611bafa9e7c9645574043435922e7cbc7172f838f10e6629fc43c10d635ed
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183300580 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a7d7cab61cfcd361aeb3c4753e208469bddaa05262fa79eb67f6dccff770cb1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 20:41:30 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:41:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:41:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26c35b33d5b3a51272c10727d843129438c905a77e89710a4ddeb4a58e8b2e4a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53f53c62bafed404c16ea832f703fd84f0acd3658c10b424ba637f9d437e452f`  
		Last Modified: Thu, 29 Sep 2022 21:18:39 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b1442892fdb38e7d61c5e540d134104ece75febdf04dcd9213c6b476121dbf9`  
		Last Modified: Thu, 29 Sep 2022 21:18:45 GMT  
		Size: 21.3 MB (21322470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:2fba69549d749d99e331603554d76ac83be19ace584c245ae3662d43976aecf3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.0 MB (191957956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc9fdff093d38156aaa8e4d023e2df1c5d19dcbff9084a33c909e970fdd35437`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:11:24 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:11:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:11:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0b07a202fd1fa50f00354e270780ced969eeb041eaa5972ddd8bdf80a99c3d61`  
		...
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cf025739bfcc991fc7e128d72d85d4d91e2fad650c299ee603c2470c68150a8`  
		Last Modified: Thu, 29 Sep 2022 20:48:24 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86f9dcc17d1ff427e492c3e0fde0e4c3b5a1deb10aad0d7b74d5454ed4ea0d8d`  
		Last Modified: Thu, 29 Sep 2022 20:48:29 GMT  
		Size: 21.3 MB (21323152 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:9de43ed291866994fe485a30b6f0c3736deb262518690914e73708b701779001
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.1 MB (190121751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c15dd0cc3fa2fe6e0a37ec1381feba08a0b47b2361aba955c91f539e5a1aa46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 20:02:44 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 20:16:21 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:16:21 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:16:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:16:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc262c09d8d7c432431f3cfb12298c90b0b9c78509577d98c264cfc5e64e359b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:845db8d7ff26755684a9f0a3650ed915c853abe01a18abb421e8d06e30aba336`  
		Last Modified: Thu, 29 Sep 2022 20:52:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91b15c03119dbf0a002cb070debca686907f69b43ee4a6b1d398684486bc785c`  
		Last Modified: Thu, 29 Sep 2022 20:52:40 GMT  
		Size: 21.3 MB (21323455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:e2d62a2ded03613a670c10cbc17d344e6a67c7dd0f1d2c325fe089700a6235b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.5 MB (166540462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fe19aab7ec9f5f239d6955d4d40942148d4957a31a0026fa8fcaacacdeef03b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 19:42:39 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 19:51:40 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 19:51:40 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 19:51:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 19:51:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:12b6bf49cba60ade424edda8f137ac9641a7cdac771c67f9bc6d6d1dfb04825e`  
		...
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:732e782613a662852e0aaf3c892f673cf98ce105e6ce785c7becdb9eae09bb94`  
		Last Modified: Thu, 29 Sep 2022 20:13:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5972cf9481866c42419c8c2704e541a6fb496a5dfcb729f8af239781c9c7c8ac`  
		Last Modified: Thu, 29 Sep 2022 20:13:37 GMT  
		Size: 21.3 MB (21323413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
