...
```console
$ docker pull drupal@sha256:7ef7eb523182bb34727570f47bd0e3f76a6352a4a607f84daf5e879c97e27249
```
...
```console
$ docker pull drupal@sha256:c583a355ca6b6fb0f3fe4877fd2bd55f58faf38558729585ff74f5f5d09d1af4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158879654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fc0ab0a91eca90123c51fed7547812b05fb0483d937e1c8e293c902bebaa4d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Sat, 25 Jun 2022 00:29:26 GMT
ENV DRUPAL_VERSION=9.3.17
# Sat, 25 Jun 2022 00:29:27 GMT
WORKDIR /opt/drupal
# Sat, 25 Jun 2022 00:29:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Jun 2022 00:30:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f1984bc738f76e80569aceef96abece717c947db4fee479205dd7c5f87fcdf28`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:638b11034718ef3962a1337f42b762e5bd8c772db7d1540661443093ec6904a0`  
		Last Modified: Sat, 25 Jun 2022 01:29:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34c42f2fde0f8c0afdae43a7d94ba729d9cb6bcd95a30a6b9b09fe058c7b1929`  
		Last Modified: Sat, 25 Jun 2022 01:29:49 GMT  
		Size: 21.2 MB (21216309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8df37bfad7db760fb816126f1e22c34640639f663fc5555a4e32792a11f05a3b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189749910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:639f23fcad633bea600d14da56874eb804a2fc907121a4e21e46c9508d35346b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 24 Jun 2022 12:17:19 GMT
ENV DRUPAL_VERSION=9.3.17
# Fri, 24 Jun 2022 12:17:24 GMT
WORKDIR /opt/drupal
# Fri, 24 Jun 2022 12:18:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Jun 2022 12:18:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:af3f51b5e8be3aa2b8a8680bb57eedb5cf95327a7927b9a6a16b2925242f70b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a23b0ede6197452635c2f2a5c4b3458f11fa5294c66aaf16d1c1f6fe4d0ea73`  
		Last Modified: Fri, 24 Jun 2022 13:32:31 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2e4ca47c0c743df7e7385eea0af7bb5795612d8453fee770ccf9987f23f7013`  
		Last Modified: Fri, 24 Jun 2022 13:34:05 GMT  
		Size: 21.2 MB (21215797 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
