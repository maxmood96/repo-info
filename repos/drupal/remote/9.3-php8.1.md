...
```console
$ docker pull drupal@sha256:150d55dc1a1e97431aa76e5e6a3315fab5eafc7d4807b8552da2266c637e96c2
```
...
```console
$ docker pull drupal@sha256:4321dd739a4b35745bb50beb43adeeba0575495af515f15c21177ea177d1d53f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.3 MB (189340781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5912ea21caf1643ddf49ac67ea0c7d9c83e70baec24cf71368bdf2a5c6878da`
...
# Wed, 20 Jul 2022 23:36:46 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:36:46 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:36:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:36:57 GMT
...
-	Layers:
	...
	-	`sha256:ad08e932df0905e38b76b6f4a572ef5b48d159721bb7da41919993619cae0481`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86c83d3db946362dcd9fb057b811e428ba8beb018df091d7767d2cf75ff58d7c`  
		Last Modified: Wed, 20 Jul 2022 23:58:30 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:586aa3cc0133ae68db3aacc02fbd605a561a5178c40282c7681ff3d87489650c`  
		Last Modified: Wed, 20 Jul 2022 23:58:35 GMT  
		Size: 21.2 MB (21217697 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:1da7d0f9333f1d5c1f1a3dafc343b3f4f2e4dffc71751dc0727f43eafe43458c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158879192 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bad7a1f1dce36f3cfea18ff932c53864516922a7d771f5acaddba9f6348e7713`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:32:18 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:32:18 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:32:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:32:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc3c3e017e349430e6cb6ccf2d21b23b825853fa678cc0eb02c983062bdcca0d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca253c1d016e40a001a50679634c917a97162f27fa483e96850d44da058e6e5d`  
		Last Modified: Thu, 21 Jul 2022 01:37:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eabf44e92b1fc75df71f212cca7bbfe140fff22db4012924cf6384f30034d1ee`  
		Last Modified: Thu, 21 Jul 2022 01:38:28 GMT  
		Size: 21.2 MB (21217480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:57e2284cbba1e126fad8cd8a6a36d6af741463d5ebc52ca3036fd8818982795a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.0 MB (182956070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53c7b0f50fbbd286fbf20e7eaf0bf33bbe500c45491cf292e77efe896c6404b6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:05:49 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:05:50 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:06:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:06:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0669d62c4310c9549fd8d96171771ec73fdbd2a7911c2292ceab9ca128d7fdbd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e386492de0cc4bd0532c11cfb1510c043259541e442b97038a61ca7ca701c899`  
		Last Modified: Thu, 21 Jul 2022 00:39:57 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef1e119dce8fc8f1f06eee5e8fe984bf3a0152ff076cdfc51271f80dc065c089`  
		Last Modified: Thu, 21 Jul 2022 00:40:03 GMT  
		Size: 21.2 MB (21218559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:d096b420fc295d01935624909bc39b4c2b6fe3907d9b0ab5030b887ce6b72c23
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.6 MB (191592195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b08abc5f941c6e07612450f6f884d84224413cb6593b34b07ec560507e4e3eb2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:52:54 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:53:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:53:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0fce2b280a5be2fc3fbf5d8c3ee33956d80e23ea335315938dc5f5f603760304`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db90de2693c6cf86b020355a7b4d1c8e976a86c96013cd3074df684ed899d527`  
		Last Modified: Thu, 21 Jul 2022 00:26:06 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7be074352de2f959d71869d6cc849f72f0e6e446f6c6e24c8ffef443ea0bd65`  
		Last Modified: Thu, 21 Jul 2022 00:26:11 GMT  
		Size: 21.2 MB (21218533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:9128ab6e3e85a9fb81ab3df6b798361965ae9180af48d7fb04491f975156e68f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.8 MB (189753812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0c4bff38c6df1bdae224ba562aacb8d6520d116bc24ee95297f15440488a68f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:45:29 GMT
ENV DRUPAL_VERSION=9.3.19
# Wed, 20 Jul 2022 23:45:32 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:46:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:46:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ca0f959097e7b7dfb79a931de36aa397ac60cb05cf5a4341b3b5e47aa4f83c46`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b9ae91eac9e5acdbb03b0588f288006891accd330617dbc7de2d472bfa6b75f`  
		Last Modified: Thu, 21 Jul 2022 00:51:02 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d5232360ea4bd331c3cc7ca4cbeb20602a3d82b93a0e024238ada7d5fd3130a`  
		Last Modified: Thu, 21 Jul 2022 00:52:05 GMT  
...
```console
$ docker pull drupal@sha256:073a22e55bcf008bbbf21f2e614a5ff02c2f0e5736df121c280259abd5cba9d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.2 MB (166189832 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e827e124735ace6f26bcfb5d59bc6c3eada582c0d3226bc4169b9bf2aaeffd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:06:32 GMT
ENV DRUPAL_VERSION=9.3.19
# Thu, 21 Jul 2022 00:06:33 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:06:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:07:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e31a0030eaa65ddee12aaf2d6d3789eb28ed485d1574b4f1bb9e8fc14b6ef25`  
		...
		Size: 670.1 KB (670053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b63cd983d5fc7f0d62696c26f2cd9032fd49b8926b731da7fe59c2775745a894`  
		Last Modified: Thu, 21 Jul 2022 00:52:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fd74b3da1166b3c1f3f22202c012dba42d8b0dd120d6f4a22108b4e2353c37e`  
		Last Modified: Thu, 21 Jul 2022 00:52:26 GMT  
		Size: 21.2 MB (21217443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
