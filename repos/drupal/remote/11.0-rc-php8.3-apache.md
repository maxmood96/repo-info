...
```console
$ docker pull drupal@sha256:8ff896262c957e4424199e695c48b3d672f6018519dce9c709f2e73fe33e1cba
```
...
### `drupal:11.0-rc-php8.3-apache` - linux; amd64
...
### `drupal:11.0-rc-php8.3-apache` - unknown; unknown
...
### `drupal:11.0-rc-php8.3-apache` - linux; arm variant v7
...
### `drupal:11.0-rc-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:11.0-rc-php8.3-apache` - linux; 386
...
### `drupal:11.0-rc-php8.3-apache` - linux; ppc64le
...
### `drupal:11.0-rc-php8.3-apache` - linux; s390x
