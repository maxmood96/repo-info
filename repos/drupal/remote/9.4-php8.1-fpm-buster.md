...
```console
$ docker pull drupal@sha256:caedf4d4dc6909a4ce098f53bee516d6d45685dbbc079f61ea55c0899c3adcbd
```
...
```console
$ docker pull drupal@sha256:ac8f72d2c96c5d1aef43dca471f2ec196ca8cf9ba1e600f101099a06df04b199
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141943914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74868f84bc7938b0c5cfb29011a15bf8cad871a20edcab5814065d931e4472d6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 03:51:23 GMT
CMD ["php-fpm"]
# Tue, 29 Nov 2022 06:34:23 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 29 Nov 2022 06:34:23 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 06:34:23 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:38:24 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 29 Nov 2022 06:38:24 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:38:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:2358f361606fec1c17cd489099fd06f6e0130c615c284a383318279a0b2cfafa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98c7cf031c8fb4506a6bc5a7e5a235cd8ec9328e5508f27b8322bdca4d14adbe`  
		Last Modified: Tue, 29 Nov 2022 07:13:45 GMT  
		Size: 1.5 MB (1456702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1c010526652217fc7927ff34aa33fab5f606747be334ae3bdc2a43056831264`  
		Last Modified: Tue, 29 Nov 2022 07:13:44 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c3869237af085e01d03d95bc18159662c48761c59c2e2928a417e7a555ca70a`  
		Last Modified: Tue, 29 Nov 2022 07:13:45 GMT  
		Size: 695.2 KB (695185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bcba8b4618d52448e911be015e6864f9e066e5be1e110915c782eb44cbb40d6`  
		Last Modified: Tue, 29 Nov 2022 07:17:46 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26f5950c0a7c386e402e66aa36cebb3bd2335ee6f942b1d2397f136c5b287488`  
		Last Modified: Tue, 29 Nov 2022 07:17:54 GMT  
		Size: 21.9 MB (21903394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
