...
```console
$ docker pull drupal@sha256:f308295ee1393f8fe39321d5bf7b6df886f8593095822c55562ab0b293f771c0
```
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; amd64
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; arm variant v7
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; 386
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; ppc64le
...
### `drupal:9.2.13-php8.0-apache-buster` - linux; s390x
