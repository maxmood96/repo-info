...
```console
$ docker pull drupal@sha256:9a9cc8e6ebc76f21164fb15066588749137a6abaf58c94303151a6033679ee33
```
...
```console
$ docker pull drupal@sha256:acb2f20ff7c53fb8030c33eb4a38de6e9aa70180bfdee36e6417e99a1c7a5960
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **210.1 MB (210079398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:169a71357bf9198f6c8088fdc3a5b13f390d78af430517b6cf281f589b802848`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 07 Apr 2026 02:33:03 GMT
CMD ["apache2-foreground"]
# Tue, 07 Apr 2026 10:05:47 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 07 Apr 2026 10:05:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Tue, 07 Apr 2026 10:05:51 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Tue, 07 Apr 2026 10:05:51 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Tue, 07 Apr 2026 10:05:52 GMT
ENV DRUPAL_VERSION=11.3.5
# Tue, 07 Apr 2026 10:05:52 GMT
ENV COMPOSER_ALLOW_SUPERUSER=1
# Tue, 07 Apr 2026 10:05:52 GMT
WORKDIR /opt/drupal
# Tue, 07 Apr 2026 10:06:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	composer check-platform-reqs; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME" # buildkit
# Tue, 07 Apr 2026 10:06:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5ddd37e2bc9009f0a40038446214b915704c56a8a49ec869fd74db8355431f33`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
		Size: 1.8 MB (1776077 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a38bf69b431cd9aa335a23d3cf1e79a76e98b5b8f4ef5bdaa0d086b7d413720`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:af43c6b6fd73eb43003fa56b2420dee998e8328464f07282aebd1f84121f6b64`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
		Size: 259.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fac8a78447be849e589c23769b8f9d17ef731f34b86f6935db486ec43207b005`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
		Size: 777.5 KB (777545 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:49830a7b13379fce7f2763ae136ca8a9cbdffd3d302d451a52261a31d0a81804`  
		Last Modified: Tue, 07 Apr 2026 10:06:45 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:26a6e30e4e9cf3881397d9af18d3a168e398a54d27fc55bc7a6bd8d44f5ca75a`  
		Last Modified: Tue, 07 Apr 2026 10:06:46 GMT  
		Size: 21.3 MB (21337799 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11-php8.5-apache-bookworm` - unknown; unknown

```console
$ docker pull drupal@sha256:eda5b00ff3e3e84aedb6aa3f398b39090946113cd741c886ee847c6d276355d3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.1 MB (7068090 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:274a2fc40117e1dbfc98ed402153bb09f3565947f5e5fc79d8ebcc80dbb7035f`

```dockerfile
```

-	Layers:
	-	`sha256:042f060d2d3bd89ea4d0bdde8c21c8fa7b88e1771f70a35efdca70fe89eaf742`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
		Size: 7.0 MB (7026485 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d166099c719f9b962ab52fbda1ee396f72bb70ed5ce74c25b1e98d290086d773`  
		Last Modified: Tue, 07 Apr 2026 10:06:44 GMT  
