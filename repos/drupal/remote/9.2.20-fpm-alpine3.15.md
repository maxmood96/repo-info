...
```console
$ docker pull drupal@sha256:9b9742b435feea7c8d8fc061a2285cb130ee5005c12d74eb562d85f139f977f7
```
...
```console
$ docker pull drupal@sha256:9354daf81c40d03a586bb9c53dfb898eb352e00d3c5521ee48fcc698ab86f18e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49524539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39bc5152166254d1867fe1a238d3326e06a824679ec1dc34e9befe80d99ae2a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 12 May 2022 19:54:14 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:04:15 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:04:15 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:04:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:04:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7096f390a01fdb8228ac8abf0957be3c670e1248be4a11016ce89bdb7f2d0835`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e3034eea83de65690bf3b7a38e82d9810ad308ed64c51afae841e8eadcf23c2`  
		Last Modified: Wed, 01 Jun 2022 17:22:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b162be004e49e9aceab83854b094a1e91d522c06fbec8a63180407078da06d39`  
		Last Modified: Wed, 01 Jun 2022 17:22:27 GMT  
		Size: 19.1 MB (19118569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9779675196295b74496db35da0c81470c6689f5c3eceb20a8812c701a3952b17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48264690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39327818d8d56c343bf16977e125ae430dc21dab9dad0408d9faa7156172ad45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 May 2022 08:16:57 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:27:36 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:27:37 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:28:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:28:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e101e7df3d4e8a4d73884d8f0bdf9d2e2e5290b0ccf6ad188c4b1fa2e75bdba4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c8e898e6cd5658cafb13ed2d68431002320b21a9f31dc3d1cf5292e1028b320`  
		Last Modified: Wed, 01 Jun 2022 18:24:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d9aacc19aba29a1a6529b1d62977f3d8c0339319f3e812b6b1bf29d3d833532`  
		Last Modified: Wed, 01 Jun 2022 18:25:03 GMT  
		Size: 19.1 MB (19118612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d9736aa9b94edb8f2d596f10559b232a9103ddc06f9857f7592037be30347459
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50501912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c0ec3bd8cd6a6ef1e766e117c92a45096854edcca96eb190331dc107128e409`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:59:14 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:59:15 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:59:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:59:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d473dae144f08280d5942dd30af5c40624406a00b8edb8c3e12a6e611b32b2d1`  
		...
		Size: 661.6 KB (661588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fc843127d3bf7bf9977493ce14be1075ab28008b9b816ba2e5ee000f756a388`  
		Last Modified: Wed, 01 Jun 2022 17:30:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2a49ac501c306a97878aabc5122cabcaee3e0ea3b2d5cfa71d934b5b4de0a2c`  
		Last Modified: Wed, 01 Jun 2022 17:30:47 GMT  
		Size: 19.1 MB (19119605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:6c2766041627ce276c9ebe874b333b308315dbb49ebab430c601e4b38be44274
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52051749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5e5e62541d2e33e5cff2780c1a27b85bc4b894f70c7f0a1692a8c0071cb33bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:52:17 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:52:17 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:52:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:52:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9fbcf057ea1a773b51b5175a5da716a6602cd33e7cd83b9520532e19b06026a9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:576c5826e6b8f0692481d57f41654847d3f11307bc41ac74ca72de12c56d7264`  
		Last Modified: Wed, 01 Jun 2022 17:24:03 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23ab267ed6aef02cfd569c8f41c7f61c2b4a385554361140534cded107e061a8`  
		Last Modified: Wed, 01 Jun 2022 17:24:07 GMT  
		Size: 19.1 MB (19119371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:2c3238f2a2028de709715552a81d6c346aef078136c2f91b270c97cb8239100c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51894159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:538801ce031b3a678ecbf2413ddc85b470ac07fe4a0a01446659424d83184fb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:43:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:43:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0873191d67b457fc11b91258908262e9b9c7cf032064dad245aeb9d2fbb47f28`  
		...
		Size: 661.6 KB (661585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a52ccbbdec0cca12b07dbfd3d8827ff88beb02a154b18186094c101900331ce9`  
		Last Modified: Wed, 01 Jun 2022 17:47:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edd15a7596d8b66916848db47e2ff840aa3f47b58306ffe9ec29508ce656cbda`  
		Last Modified: Wed, 01 Jun 2022 17:48:35 GMT  
		Size: 19.1 MB (19118695 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:caac205356ea03b855f8678bb6eea88a8898b3aa942a48af7211fa0cda94a23f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50133757 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0716df1ab9610d1d3dbb8395cff78ebef0504561140c1eef0b07b21f6aee648d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:13:01 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:13:01 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:13:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:13:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e191251ee546e9437f45dd95eb94a8e7c2924b283681e4ac5d4777970415ac9b`  
		...
		Size: 661.6 KB (661585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d749d298ff30756b7564e4140f2aafa42b5e8fce755de150cd2d0d55284b8d5`  
		Last Modified: Wed, 01 Jun 2022 17:44:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0e6a5c5c3ade1fb4a9673480d09d33c03ad26c2a734c630fa257fc6e44e2b41`  
		Last Modified: Wed, 01 Jun 2022 17:44:04 GMT  
		Size: 19.1 MB (19118577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
