...
```console
$ docker pull drupal@sha256:ba5ab3cdbcdbcf0a31c38643f01e6dd02cf8a32365bd1de1c7b053e3c1ca095a
```
...
### `drupal:9.2.7-php8.0-apache` - linux; amd64
...
### `drupal:9.2.7-php8.0-apache` - linux; arm variant v7
...
### `drupal:9.2.7-php8.0-apache` - linux; arm64 variant v8
