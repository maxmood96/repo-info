## `drupal:10.1.2-php8.2-apache`

```console
$ docker pull drupal@sha256:615e94f144680292a413f95bfc8094fd374bf6180b13197a7ac1264938fcf693
```
...
### `drupal:10.1.2-php8.2-apache` - linux; amd64
...
### `drupal:10.1.2-php8.2-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9b0e131afc18edb94f24763605e8098f1878f430552a5e078eff16c3a163225e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163047248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5888cca93059251dc1887ed97dad2cdb0a6d4480db4b1394f3ef06d674573745`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 01:12:19 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:12:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:12:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:75f118f071c5cd8476495937490a3316b386e55678eadd88f6d379e5ae71d9b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b435b7adb30c15b500da7765d7d5a2b01f587c34b0d6259b3fcbeb3b2a4aef9d`  
		Last Modified: Fri, 18 Aug 2023 01:23:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bd9b1e2ba1c6d725db1ef80e8162e75de5bd7a28aa24249ed1ae76324c20ed5`  
		Last Modified: Fri, 18 Aug 2023 01:23:52 GMT  
		Size: 18.5 MB (18511818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1.2-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.1.2-php8.2-apache` - linux; 386
...
### `drupal:10.1.2-php8.2-apache` - linux; ppc64le
...
### `drupal:10.1.2-php8.2-apache` - linux; s390x

```console
$ docker pull drupal@sha256:12cec84ecb14b5626cbdd1636b60a9e79d21f80ba109c25d9e04d5e75b0b7d58
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.2 MB (172190821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd18bec5d87dbb121234feb9d409a728b7af6463e04f20cdf218dc3ceb4c1ded`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 00:45:13 GMT
ENV DRUPAL_VERSION=10.1.2
# Fri, 18 Aug 2023 00:45:14 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:45:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:45:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2fcef9bf15a6e53da127a82f37c5f024ebb45ae6167ff2c818fedffad84c06d`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab4d605d53db046e4cb7da10e5330053f3c99663bb08fc92e01b1a246c40e31f`  
		Last Modified: Fri, 18 Aug 2023 01:01:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad4fbd086b48812e9d1608a77f8d43f51d9680607767eb41315e6be44609373f`  
		Last Modified: Fri, 18 Aug 2023 01:01:17 GMT  
		Size: 18.5 MB (18511851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
