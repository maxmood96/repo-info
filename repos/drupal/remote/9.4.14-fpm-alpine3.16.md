...
```console
$ docker pull drupal@sha256:3c2b3bd7f504e84fb71d44a2a86b6428ea4b1bae553225b6ebb89c1cad68ab3d
```
...
```console
$ docker pull drupal@sha256:af7fbdb0024d02ee84ec6714462d7573031fd8f7e0e8169d00bd33bbdaf6d388
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52483543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3845d2205c9c0a8eb9036f21b6d5c2ba252889b404dd487eb8e349dc39bebf8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 20:12:30 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:52:33 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:52:33 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:52:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:52:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c8a0e0b1eddcb08cd04f548859fe1a13d3c6564ffb35c93360ad93dee824b510`  
		...
		Size: 697.5 KB (697530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5eea68cc72049fc03e2ec18bae993fc5a7171d82bd5150b56503d3d374d99210`  
		Last Modified: Thu, 20 Apr 2023 23:01:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fc2a3ee6a2a92318ba23f4fa655727a7d1f01bd352c3825e08a4dc6e3bd4cc5`  
		Last Modified: Thu, 20 Apr 2023 23:01:31 GMT  
		Size: 21.9 MB (21907494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
