...
```console
$ docker pull drupal@sha256:a7125174dbb6e34e85cbf67642853ace2f3de90dae16f48155eed5082735a55f
```
...
```console
$ docker pull drupal@sha256:b58407aff5649c43bdbed3ffdde54b207fa262938c619849298ed7d1cef37cbd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52640314 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:635cee70191d82fcac9bbb4119d17ca6c77088d5e2b53028c8679d751077ae78`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 03 May 2023 22:52:35 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 03 May 2023 22:52:35 GMT
WORKDIR /opt/drupal
# Wed, 03 May 2023 22:52:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 May 2023 22:53:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5cd19c55c225636b11f9b6332d12d66de44d1187107657076d67c8ecad015957`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035e6a2dd78e4d5da85309216bd4edba15fb9179bc69052a006dc03fe5293eff`  
		Last Modified: Wed, 03 May 2023 22:59:05 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fbdc49d47d17f16e1bfa413047c966df4be45bed501d4ca2feb6e3a57230de6`  
		Last Modified: Wed, 03 May 2023 22:59:13 GMT  
		Size: 21.9 MB (21901765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.15-fpm-alpine3.17` - linux; arm variant v7

```console
$ docker pull drupal@sha256:dbf37c3763a785c3e614f6fc97cbd46049159e3d8b4da5050d95828e0e8be1c2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51403833 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f140d9a1e66f7bbd122293a959572f2f3f48e4f34b65f2e28b1f659cd8b391b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 02:57:08 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 02:57:08 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 02:57:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 02:57:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c19aa21e13e27fd75f6d112c899e7fe6f765e5fdcaa56ed3141c4a0e68eeb399`  
		...
		Size: 697.5 KB (697529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a3bef29b3dae15872b3f37478b914cc34bbbd207fb0756961206c643bc35ac6`  
		Last Modified: Thu, 04 May 2023 03:15:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:317a2b269bf7dbacbc82dec7c8fede831afc4d6883a87d63c916367a89eefd23`  
		Last Modified: Thu, 04 May 2023 03:16:05 GMT  
...
```console
$ docker pull drupal@sha256:bbb66f3326bef1b1d99f8aa8da4c1d97d16db75d2665a07f551606b0418a6aa7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.6 MB (54562803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fd7afd525ae853f2bf588a57aed9cbd8bce2b350ba7c69efdef419b866c049e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:35:16 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:35:17 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:35:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:35:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9998592b7b22eb48f2a5e27ddb3e0ee4961d6885d2187c6314999e883a9aad74`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0be39fcb503cc8fabfbea7593a7f2bedaff5029e2d2a758810c1e839e1b2e940`  
		Last Modified: Thu, 04 May 2023 08:00:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:707a750f5af4bbeed2355835cb41033e436cd53720645ea7590d96bd2a5206e4`  
		Last Modified: Thu, 04 May 2023 08:01:13 GMT  
		Size: 21.9 MB (21901846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
