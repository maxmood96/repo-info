...
```console
$ docker pull drupal@sha256:eaca214e7790bab4b49915cc8e66936778a7645fc6f96e83cb232e2c3bea286a
```
...
```console
$ docker pull drupal@sha256:4037d9287ed7a3a33c741915bf40e496ad23c96727f2edae38bf1cca35463c1f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53520561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ebb76ff81947f5c826f396272c056b953ff977696951dd9aa1625d14dbdbc47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 12 Jun 2023 20:25:14 GMT
WORKDIR /opt/drupal
# Mon, 12 Jun 2023 20:25:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 12 Jun 2023 20:25:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1aa3cc689b90819afcd8b7d658ea6744dfe0c1abca1fcc6bc31d2f7bbab007dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5558eb88866aa07d50a4d9bf9dab4d0195439f966da7dc67a398d45c0b2087ad`  
		Last Modified: Mon, 12 Jun 2023 20:45:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:151f57c3c60180afa7c37293ae3c051ae5f30ed5f39e03d0590d78493b2fb0b6`  
...
```console
$ docker pull drupal@sha256:e4635d8abf7489f7a14e6d461fb4423093613c3b590edbbff41ef49d1bc9c61d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.8 MB (57823729 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84fb0c3f55e28056012df8a77e803341c771d9d2a69c9f2e3e218bd72c42dd66`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Mon, 12 Jun 2023 20:02:47 GMT
ENV DRUPAL_VERSION=9.4.15
# Mon, 12 Jun 2023 20:02:47 GMT
WORKDIR /opt/drupal
# Mon, 12 Jun 2023 20:03:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 12 Jun 2023 20:03:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:571adb20a11e9905b3dad01af26c49ebe98cfd059318a978819268b0f994fdec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bb9dd83369b5840cd0833327353b04e6707a7daa5a914512a2328c58f806b84`  
		Last Modified: Mon, 12 Jun 2023 20:21:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c0549a29ca5c26efb9864e16028a346d8646f58cb0d57e85f50ccc0a7e314d6`  
		Last Modified: Mon, 12 Jun 2023 20:21:57 GMT  
		Size: 21.9 MB (21901842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
