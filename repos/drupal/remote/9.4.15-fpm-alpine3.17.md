...
```console
$ docker pull drupal@sha256:adeb86d58f31ae5485dea2aabaaea31292e758e730e17d5ed042f5a4cc2a5107
```
...
```console
$ docker pull drupal@sha256:11cdedca297825c00238675afd26e416782157f25afea2d9566982c9dfbe8600
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.6 MB (54594944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b4d6db223196c622979a403da98ca851b6794380ac79584d8d637ebc422021f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 15 Jun 2023 14:31:47 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 15 Jun 2023 14:31:49 GMT
WORKDIR /opt/drupal
# Thu, 15 Jun 2023 14:32:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Jun 2023 14:32:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:294b16adc357ef0c2e0062f673ea1f21cacac25265c51123633345725f2ce9b1`  
		...
		Size: 698.2 KB (698237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adac13a1ed1fdef5eb074e9ec694dfce1a8f28c5c0a9e962107e7dbd3b636645`  
		Last Modified: Thu, 15 Jun 2023 14:40:12 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f6af30c148778b72da25ffab7497ab24af96477c78f0c7a2e4105c89d503ddb`  
		Last Modified: Thu, 15 Jun 2023 14:40:21 GMT  
