...
```console
$ docker pull drupal@sha256:a33cc59e81197fc03dbf779daeabd09b770c3f3d86be2208841198c103cb9556
```
...
```console
$ docker pull drupal@sha256:ea725bd6c8166df419e719ecf2f6d981e70352fbb9668dc826384eff5bf639fd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176194672 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33cc1b705543528851eebe538f79b311262727fc4652908a87dd6623dbcb5c89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 21:23:53 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 21:26:00 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 21:26:00 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:26:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:26:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1a28b4a5c20bc4f5c895c1b8d626eaf22d7aa71bb45bb0e413d2a343170fb637`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f84b6ec42ac234a29ebfe554dcfa3561b0f83e343cf16842bbef54c67ac7c1`  
		Last Modified: Wed, 16 Aug 2023 21:42:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ca3dfc45e88d8708f98e20f800e4421aee29d3b1aff6af73998aad1204635c6`  
		Last Modified: Wed, 16 Aug 2023 21:42:42 GMT  
		Size: 17.7 MB (17696289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:5c73e7170f54f485476419afc16b730e935f444dd263ab131b34fa0b430ae386
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184572243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1cfd195e14a3b885661eacebb27695bae30d169135a7e7277a0bcf3ba30b1bba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:17:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:17:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe0d41028b5425c86e9b83909f1341d75decccd574d54dbff915803315a09d93`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86a8a3d99e58356638fb2f6cda9d1febe49d849c00c381943fd9b43b5ee90aa9`  
		Last Modified: Wed, 16 Aug 2023 19:37:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09b18315b42296f5bfe1ab39931b9d9249dd2a9cf93ee1330dbf1c9cae20717d`  
		Last Modified: Wed, 16 Aug 2023 19:38:02 GMT  
		Size: 17.7 MB (17696104 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:096898558363540f6292fd3f7e0d6960c670a1c3c9e3d4f56140563ffe89af8e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158837250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51963afacc36376b0977b2534333c878336499aebce5a432df2b57a9ff10034d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:55:15 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:58:39 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 19:58:39 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:58:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:58:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5cfd414344f4308167f42d1132b4e4c341817d19302ad12032291812ad6bf4d4`  
		...
		Size: 698.2 KB (698242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4568d9855ce740d4436a282fe744703317ae11f0825fb1c3858c77ef7c87295`  
		Last Modified: Wed, 16 Aug 2023 20:15:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8d32edd29eb92d6d0765bd16b54ec86faa021283f74dacfcef8231de791d827`  
		Last Modified: Wed, 16 Aug 2023 20:15:34 GMT  
		Size: 17.7 MB (17696184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
