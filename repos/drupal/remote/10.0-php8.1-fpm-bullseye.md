...
```console
$ docker pull drupal@sha256:d03f6682cd4073f38ddbdaca5b02e8bebde9df7b7a8b800a2a20fe83705d563d
```
...
```console
$ docker pull drupal@sha256:53c7176be560233bae5cb5fb789812038fb8958c1db3defd2cc43f7d6a3c1e84
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181724437 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63775f30a0f162edb20e8b3edabcad677f992e856d99f62c89b786d91cdf567b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 23:17:53 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 23:22:21 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 23:22:21 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 23:22:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 23:22:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5fba948d08754b39dcc1a6d2511702a68775e0317956fe3cdb962b80e0c0818f`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9c6ef695a2176bddfde20cbd26140eb3ea760efbd509dc6672b511f20f6a26d`  
		Last Modified: Wed, 16 Aug 2023 23:51:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70a38f0a499b91c5183bcc7e46e40e3148c648bba51deadd15e90094f3b1b4fa`  
		Last Modified: Wed, 16 Aug 2023 23:51:42 GMT  
		Size: 17.7 MB (17696293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
