...
```console
$ docker pull drupal@sha256:2df8bdbf6d52a4aebe3c0f77d05d273d3e1d0f9b719e55ba96a073aeadc9755f
```
...
```console
$ docker pull drupal@sha256:bc62efc70cf19811041ad6cb9340c74a63827e675ef9e7a2f03f3c2471a0151f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176242696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:045396d7899c6162a1f331f8d67cf701fc387222911bc8db22a100b20a98c24a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 03:09:54 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 11 Jul 2023 03:15:22 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 11 Jul 2023 03:15:22 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 03:15:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 03:15:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc7babf09b305740e6fd4204fb8defc9987fc7db559f788b857a0ac4340ea34b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d332b3eca0a18ec23ddbd96944caf1c119dc1ac055c0f4f23174d615d65a6bf6`  
		Last Modified: Tue, 11 Jul 2023 03:31:59 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd4759888ed90c1ac2e1b1d60f6f391afc8e922feb810a6a9ebde88c21a85f2b`  
		Last Modified: Tue, 11 Jul 2023 03:32:02 GMT  
		Size: 17.7 MB (17693088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:604a2b8dd586a2735d13a7548176e46a21176ad020f33500b14b35d8253b1673
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184617906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f47bcb113f4abc897856ec422af4144868a9b9a75d4bb48fc658e6d4659bb4ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 01:50:06 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 11 Jul 2023 01:55:47 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 11 Jul 2023 01:55:47 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 01:55:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 01:55:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f837ded9cdf86c2f521642fe57baf8a2a1fd779385820a25b289218de7c32f1f`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7442ff726475c78f4be7525371bf68fa75787e8b5b993c10f7f8feb92affeb55`  
		Last Modified: Tue, 11 Jul 2023 02:15:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d09b0a924c5ea3ab86aa94503fa35523e7bb44c7f9467a50bd40db6bcb846d36`  
		Last Modified: Tue, 11 Jul 2023 02:15:57 GMT  
		Size: 17.7 MB (17695041 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
