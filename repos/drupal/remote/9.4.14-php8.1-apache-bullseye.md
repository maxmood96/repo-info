...
```console
$ docker pull drupal@sha256:4d7c90d7b078cc315beb9a0c193eb29e1c6fde8729a19d0f5898f8d4564c486c
```
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; amd64
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; arm variant v7
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; 386
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; ppc64le
...
### `drupal:9.4.14-php8.1-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:bdfba0e3e9a3f407e163f0c9541819f8db64a444bfefb9fc11c26b8d6b0ccd67
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.0 MB (167031047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74682701d4c696cf27c95f7b0a26036d9ba7ee600a091714a401c9d4aa60cbdc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:10:06 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:51:23 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:51:23 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:51:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:51:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:235713481276484f3fb1bf780287449016fcef4592f34ffaffc64aafeb59223d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb0e545aa1cf880ef3ca1c3fcc4e12ae1d574a2bcb5ecc2db2a2541a9397f93a`  
		Last Modified: Thu, 20 Apr 2023 23:00:31 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c8e34b254eabffbe0bb893171f11da30a9a478a683a3fadbdf2fb1211cf646`  
		Last Modified: Thu, 20 Apr 2023 23:00:35 GMT  
		Size: 21.9 MB (21917547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
