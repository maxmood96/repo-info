...
```console
$ docker pull drupal@sha256:9e1d9025e914648443f042d2004ef1cd1daf7d709ccc1a2ec7010bad33f5abc3
```
...
```console
$ docker pull drupal@sha256:5f50685dfd5a347fd3b888874b014cdab1e1992762d7dc3824cf97ee0709c730
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171697285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c2b447e333e51baa71addbe6e57eddb4a438e164df43a70216a8254d50b46da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 14:34:19 GMT
ENV DRUPAL_VERSION=9.2.18
# Thu, 12 May 2022 14:34:21 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 14:34:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 14:34:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:057a75047daa27da63f50d2fcad32fcccbe7c697d5d5bb504f9c4b5cb715744d`  
		...
		Size: 661.6 KB (661590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:783e0fe09192f45a9aa7f9cc08b9b092d920dbdec6e68e0551fe4463c7018177`  
		Last Modified: Thu, 12 May 2022 15:37:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c14a024c3f7f869483770ca5755845b6f322f85b5cd0853d8df11a29b753c401`  
		Last Modified: Thu, 12 May 2022 15:38:07 GMT  
