...
```console
$ docker pull drupal@sha256:7a029eb44a2506aec1ae0c6dc5c07bb1fc8cf4035cf8d5729c1746c1832815b7
```
...
```console
$ docker pull drupal@sha256:a9f717a33a3f0a8f8c30c70b5d48a680a54aa14a2a7438b5120796fc075769b5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50887792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b8b29af011f27d7fabb6aa0befe94f6275de82f7cc24820106bc6b475962045`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Wed, 06 Oct 2021 20:49:16 GMT
ENV DRUPAL_VERSION=9.2.7
# Wed, 06 Oct 2021 20:49:16 GMT
WORKDIR /opt/drupal
# Wed, 06 Oct 2021 20:49:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 06 Oct 2021 20:49:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f0e070bb7b3d89b2d8bab4b0e70edd0f971af0dd44eb6b675f3e8c0e308f7bd9`  
		...
		Size: 557.0 KB (557008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7a01be8aa5829cea5ba2083a17a45697ffb42e50be43c0e9744e00ce2647ad1`  
		Last Modified: Wed, 06 Oct 2021 21:04:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f55b490fdf99115f5dd103c48af044258d5b6c739e667e6435a8033dde731c`  
		Last Modified: Wed, 06 Oct 2021 21:04:31 GMT  
		Size: 19.2 MB (19182705 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
