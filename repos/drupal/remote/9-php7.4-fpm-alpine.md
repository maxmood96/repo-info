...
```console
$ docker pull drupal@sha256:2cab56902465cb9e0d0aeb53776cda15552868aa56109d1a77461605065e739d
```
...
```console
$ docker pull drupal@sha256:c856da222df109933147ed315d68d3144fd2c582eccc22ed99e91d5093ae49e6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50264812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07c2d843ca8737ce5557b22134ba1de1255279cdbb76f6ea32ed54317b4ad532`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Mar 2022 18:31:38 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:31:39 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:32:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:32:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9bbd9fe7f67f6e5e2c42bf8e64e432ee1b1529356e2f57b779811154850908a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff9d69231f20ce7ad2cdf1dc2e129542f595fe1e608c289d9dbc7aac2a6c98d5`  
		Last Modified: Wed, 16 Mar 2022 18:46:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f32986fd861a90d38b4b8bb72867c09833a093cf71d969072bf86eb2f80854cd`  
		Last Modified: Wed, 16 Mar 2022 18:47:09 GMT  
		Size: 20.9 MB (20934341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9580505dfc93d348c09b4532fdb9973a06603bde85da4e8947f2c765e3668692
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51218678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d65418b31cba017b14bab3ca3147d16744570a2d971c43867d06c8a9ec41a992`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Mar 2022 18:25:14 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:25:15 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:25:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:25:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7148785eaf1d57815e88eed0d8817fda6c0f93a1f29166897bbb54b62857459e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e0e8bce5145064358a7c76e1d4136733c0d84d78e55a21fcce207363bd75d4c`  
		Last Modified: Wed, 16 Mar 2022 18:50:29 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dea37df82f561ba5267a3e5eaa76bac614f8c89472c29ed84a70eaa91f64311`  
		Last Modified: Wed, 16 Mar 2022 18:50:35 GMT  
		Size: 20.9 MB (20935409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:b745ea05490c12a61f9bd4d74a92a2bee21ecbf0e25dbd6668a75d97cab8ca54
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52125009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8c374762deff1f56a554331262f583b07ba02e4cf87e360f6122f28fabf139d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9ecdccd3b19b85ce20f833711caeacd997dd287f0e56ea5a4eade3dda200f37f`  
		...
		Size: 575.7 KB (575718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3da658a877ec27206d3c19d2df0df5ecaae4a6544545405eb81b7bc14026f67`  
		Last Modified: Wed, 16 Mar 2022 20:45:51 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bdfff044e48e9686960f233a050be89e92a472a3e5b07f079afd708f8967e22`  
		Last Modified: Wed, 16 Mar 2022 20:46:03 GMT  
		Size: 20.9 MB (20934127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:8d9a3ccf2650ca9dae790349ab30912cbe0a799fafa90d1bb657a886f06dfb14
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50837096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d24ef001675fd86d31f198619202b9b914a109c2e05b595c1277abbd91ade9b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:14:05 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:14:05 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:14:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:14:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8dd4319e50670a87f6ecd0b29a88bc6aba914922d14efb3a88500f877f566a11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a80e7359a144a8d4bb2ebdb00a8379c399c5363d7e44da07d7bbfc47fff63f`  
		Last Modified: Wed, 16 Mar 2022 18:36:00 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b3a789272693dad0ff988fbe8786f8552b3b5c7c788a7d68c09a0cb4a553063`  
		Last Modified: Wed, 16 Mar 2022 18:36:04 GMT  
		Size: 20.9 MB (20934224 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
