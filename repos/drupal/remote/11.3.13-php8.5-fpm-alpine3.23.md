...
```console
$ docker pull drupal@sha256:1347bbfdfe05ca6eb5ad1e7ccb120481d3520d48ea7888d529f8ab48f2625426
```
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.13-php8.5-fpm-alpine3.23` - linux; s390x
