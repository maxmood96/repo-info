...
```console
$ docker pull drupal@sha256:33d446800327115f2a4c20b99c2b39d9983cdce1d90f7771e8b5861c243752da
```
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; amd64
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - unknown; unknown
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; 386
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:10.5.5-php8.4-fpm-alpine3.21` - linux; s390x
