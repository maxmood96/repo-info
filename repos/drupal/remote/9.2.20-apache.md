...
```console
$ docker pull drupal@sha256:d1481629b2caef8b20720e3e2d1e59ad1a0b91bfe50681361ab9e19b94507819
```
...
```console
$ docker pull drupal@sha256:eb0586867e5becfd1e6799aabfb0d8334d3cc38e5936713627efb1597fab2ecd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186628463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77f4a2bc52b43f1e1e56ab7b9148b0cdae65dc3114e06a378a28052b0ece5e98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 06 Jun 2022 18:51:08 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 06 Jun 2022 19:05:43 GMT
ENV DRUPAL_VERSION=9.2.20
# Mon, 06 Jun 2022 19:05:46 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 19:06:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 19:06:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2f96c3620f34eca6daeec5f1a710614f9f0aace853848c71607de7821185a07d`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e714660c025299f32bb3353ca34f43d58d5678a7d3cc1fcf2601e3818e258bf4`  
		Last Modified: Mon, 06 Jun 2022 19:49:51 GMT  
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:364dd8625a3bf7b4d047d8205ae0d041a0fb8b1a01f445a27d86e7b56f7825a5`  
		Last Modified: Mon, 06 Jun 2022 20:15:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:794934dc345b55a779e7b041736659d82b8200a01ee0f55194a6ce3385260014`  
		Last Modified: Mon, 06 Jun 2022 20:16:48 GMT  
		Size: 19.1 MB (19128272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
