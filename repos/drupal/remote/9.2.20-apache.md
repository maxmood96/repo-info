...
```console
$ docker pull drupal@sha256:fc4e511604d3db1d77adee9f408cb1d5fdb7665a57694065e50cfe92bb8ea0b2
```
...
```console
$ docker pull drupal@sha256:88d3604dfd8c59d4f34fe99d6d7eb7557f47237eeb1f1fed4673a15dbd5c99ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.1 MB (163083781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a8e96f2cbfa8e70630b1f255638591c3e7ed9eb26ac5e9dbd3df058ae9870b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 07 Jun 2022 04:19:25 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:26:34 GMT
ENV DRUPAL_VERSION=9.2.20
# Tue, 07 Jun 2022 04:26:34 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:26:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:26:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d383cf1534a55dd340a239f3e199bfefe2f7e89253ce225d3dfe88c5a89424cd`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5183df51d4f83b41bfb22b1245090ca5a9813bfd9513f808a639c8d29c6f659`  
		Last Modified: Tue, 07 Jun 2022 04:48:07 GMT  
		Size: 669.8 KB (669846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eccb61403963a901297432c1169d7f4363fd10fb6f41b19a41ab3fd7f6dd677d`  
		Last Modified: Tue, 07 Jun 2022 04:54:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981ebbb7c1c54fb507deb634797d0c13135b9aab5acd356383154f9db104bdc0`  
		Last Modified: Tue, 07 Jun 2022 04:54:26 GMT  
		Size: 19.1 MB (19128338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
