...
```console
$ docker pull drupal@sha256:59e7aaed88e7413d97dabcea7935dd0fa69b46d236fccd0e8c6f1577482b8f12
```
...
```console
$ docker pull drupal@sha256:6791cb46d1e7310df8294b7f1e8f776036b49387a31c671f91152b38454b90fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.8 MB (155773171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a688625b40819f7072017da05f5fcc246a924b02aec7ed312c2cbe5d3acb46f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:23:22 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:23:23 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:23:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:23:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2b6b762c7ecd2df8adbdc8229bc2749d920d1b0ff08847837fd393c89ce375e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3f2b4b4e39bd4ead38363532f46f5828f9285b758d1717a1958877b5b85a8e7`  
		Last Modified: Wed, 01 Jun 2022 18:19:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa36c325d42244c7e9aaaff1277748685aecdbd2af497a9536b90f68a361b86f`  
		Last Modified: Wed, 01 Jun 2022 18:19:43 GMT  
		Size: 19.1 MB (19128306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f391bf8c669af26e68cdc9ae87a05ca042b783ded5e8ac8001a89c2ecbfd9187
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.4 MB (178377683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04232a67a47f6dcefea5d5080ee9b055c583040ce34d05e0b6a7019b3a9fb61b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:56:45 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:56:46 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:57:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:57:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f8a12276d4a435a911837d685ec7177e3cfe47496d376630000ec537644318cc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3226038fca4367a279d50200ce0158b70f2829aaca7e25c005d9e143f85d43c7`  
		Last Modified: Wed, 01 Jun 2022 17:27:40 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be316d32c046bda7cffbd015587a2526e91e6937c80a11c56f6dd1d9f0ff650b`  
		Last Modified: Wed, 01 Jun 2022 17:27:46 GMT  
		Size: 19.1 MB (19128251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-apache` - linux; 386

```console
$ docker pull drupal@sha256:2b361c366bdab345f41aca5a7b244134aa02eea0462487b27eb0b8479bb5ade4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.2 MB (188221486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82fe5d58339a094f6da20def22a24027e3b9fd6a14bc1667adc586f0f47182a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:50:27 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:50:28 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:50:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:50:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a0df553f3478e23f921b13824f57ac790e604baea2152d9c112083b352ef2d18`  
		...
		Size: 661.6 KB (661584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0859db6a98a4417dfb72d8d9b41e7f677c2f58c01703653e49503478a13c3a2e`  
		Last Modified: Wed, 01 Jun 2022 17:20:10 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56d4b0af920fa257278a1fa550fd9689734e24788930a88fb8e2287503a4ec7e`  
		Last Modified: Wed, 01 Jun 2022 17:20:15 GMT  
		Size: 19.1 MB (19128139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
