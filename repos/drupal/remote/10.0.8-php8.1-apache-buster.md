...
```console
$ docker pull drupal@sha256:adf83c6d903c64da34004648486f7a177ecf4b1acc2ed346f1eb378cbc646c4e
```
...
### `drupal:10.0.8-php8.1-apache-buster` - linux; amd64
...
### `drupal:10.0.8-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.8-php8.1-apache-buster` - linux; 386
