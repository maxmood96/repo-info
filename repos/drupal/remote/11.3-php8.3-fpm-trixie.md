...
```console
$ docker pull drupal@sha256:7b3b7a533fa451b9234a6cc5575167734d88a0d4b971e738f1273b0cc6fe4b5a
```
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; amd64
...
### `drupal:11.3-php8.3-fpm-trixie` - unknown; unknown
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; 386
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3-php8.3-fpm-trixie` - linux; s390x
