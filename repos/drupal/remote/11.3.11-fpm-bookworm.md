...
```console
$ docker pull drupal@sha256:3f7bbba47765e7effbb01833823dd6d9c6e899b2823b113b386f70f8fc7df451
```
...
### `drupal:11.3.11-fpm-bookworm` - linux; amd64
...
### `drupal:11.3.11-fpm-bookworm` - unknown; unknown
...
### `drupal:11.3.11-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.3.11-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.3.11-fpm-bookworm` - linux; 386
...
### `drupal:11.3.11-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.3.11-fpm-bookworm` - linux; s390x
