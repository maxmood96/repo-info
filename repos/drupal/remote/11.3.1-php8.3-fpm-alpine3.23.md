...
```console
$ docker pull drupal@sha256:8fe48057c262c0360dc3b2776dafed592ae36c93e9c4ea4aa0ab7445f23a525c
```
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.1-php8.3-fpm-alpine3.23` - linux; s390x
