...
```console
$ docker pull drupal@sha256:a7b320a2ec55dcab07176e2a3c146fd3b172c1af66d283178656b2281bb12bd0
```
...
```console
$ docker pull drupal@sha256:fd1e181af12396a9c55c46aaf5b4cf500c3cc59df42089e1a8f92116ccf4e406
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172328785 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0862f81ac5a1752a31c0810cd6d2c969d2a96024d6a103b798cec459d3e24b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 22:24:22 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:24:25 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:24:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:24:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:76701cc319be002649dc4248342ddda891158139c8015cd641c27abbadd0e047`  
		...
		Size: 660.1 KB (660099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3a358768f1fb5170bd6271693aeac12d3d3d09d19242fb83da74a314cc36981`  
		Last Modified: Mon, 04 Apr 2022 23:30:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9261fcb0d40a0574d2276f48dbc604403286433710cba4e1f07ed2a68687da8`  
		Last Modified: Mon, 04 Apr 2022 23:32:00 GMT  
		Size: 19.1 MB (19126825 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
