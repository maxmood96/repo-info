...
```console
$ docker pull drupal@sha256:b78e3fb150807fb5605c37d9f5034b921f20c6db1872d7d4fc0e205d0eec67e4
```
...
```console
$ docker pull drupal@sha256:a19a0408cec94b26c56c46f7bd08da15bae29cf9e19ace8f93bc1193c4f9318d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.4 MB (162401035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec67a30655e1dccf8d662fa56b9925d2a43bc0a592b34e6371b2e94bf4845f10`
...
# Fri, 08 Apr 2022 20:56:55 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:56:55 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:57:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:57:05 GMT
...
-	Layers:
	...
	-	`sha256:c71b5fbb0617257acddfe92b59e3953ec09cecc86d82118b44cf2b9e9da92c8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85ec4ef1b44143f6919e0e390e5bef547aa76d47412e5dae8e540d9963eaa472`  
		Last Modified: Fri, 08 Apr 2022 22:55:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5be4c9b430a36dabb16eacfcc7dbdb0d92e30643eeca669c4d0f814d45e6980e`  
		Last Modified: Fri, 08 Apr 2022 22:55:41 GMT  
		Size: 19.1 MB (19127105 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:faf57ee6e1ae0a362ce02bd1af2861fe4c90063025337d0dc8242aba08ee9536
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.0 MB (138008156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52cb083220277c4c205e4f39a229d00a92073748bcebddaaeb6eb9c95c0544bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:36:08 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:36:09 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:36:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:36:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f91903cfb21d9195a4eb3987cc457970f79e261e551f1611c4f0bef043e806a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19181fbb6faa395a6f14444b75369e20e3e32bd6ab057cce6b179845efdbd341`  
		Last Modified: Sat, 09 Apr 2022 00:05:53 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c75596326b0f4379e815f33f20a0fa05234ff3efc3a7161edae7898830bef046`  
		Last Modified: Sat, 09 Apr 2022 00:06:19 GMT  
		Size: 19.1 MB (19127185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b50829e8ee63d83893c0ed095f2f77ea0530a8eb71f2a20babc867a3f55d0a28
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.7 MB (147712939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4817797bafd18ea8cbcc998c784ff6847f20bdde9f143916cf6b9def04791c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:12:03 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:12:03 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:12:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:12:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4395a2259c106b6e5011582999e870cc0dadafcbc051dcfdb29c1b2621a74e2e`  
		...
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:136eee068225e50ef9c853695e0ae6badbbd6c3a4a3a1cb011c3ceaad4ab294c`  
		Last Modified: Fri, 08 Apr 2022 23:13:46 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acbb9d028cef63ad32e5a5453d056206d55f8e79d7eb50399d4bb34809b4063b`  
		Last Modified: Fri, 08 Apr 2022 23:13:50 GMT  
		Size: 19.1 MB (19127126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
