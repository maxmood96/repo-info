...
```console
$ docker pull drupal@sha256:9761f64bd45888e4b3fb28c646a223983f0fbc9a7f4b180bf596c04209bd28e6
```
...
```console
$ docker pull drupal@sha256:53fd4a861bdf3cab14721be522fd662995a4222f47b0c5893c697f01656c1fe1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.1 MB (138125211 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bd3419299801b1fe4a426e3bc28c601ca82cd8778c9e73517fc23e746fe21a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:46:58 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:46:58 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:47:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:47:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:794021b3bc6cf5e716a34cfd1883062be03e0aa363d7b904292431438507a999`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f32b6b9b871ec9e5c1f1f1f289ea7fba0df7c3d0dc6c98c9c8f7a026e8c8495`  
		Last Modified: Fri, 10 Jun 2022 07:45:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:549e65a3757f093ecee1a03bca3b03bf60f880605d3adcdf53945ab3bf059414`  
		Last Modified: Fri, 10 Jun 2022 07:45:57 GMT  
		Size: 19.1 MB (19127960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:58cf449de7655de60e3256ef63a9de9d534ea76b590fc6a32f452a1782dd75af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153429976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85bce06b55079e54049fdd8497cb689154899b0573c1f61a79120ac207a4173e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:17:51 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:17:51 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:18:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:18:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:56fa0b47d7e5849edb1cf05a96adbb93d5cd754712a6feea0528b5df7842f309`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca7e45f437b933aeae29bcfdfb2bded680829d0d9f8b4c383e3baa43b89b08ce`  
		Last Modified: Fri, 10 Jun 2022 06:48:32 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f02a644f3d9ef8f568b5dd27a416ef3593a378f63cfc3df81e9f2683f0779b7`  
		Last Modified: Fri, 10 Jun 2022 06:48:37 GMT  
		Size: 19.1 MB (19127396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:a653e586790b32863586e5e79f4d5c7f2ff6f05271aa113e66955e486fcd6dd6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167602957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fbf56f2315088a20c9b7e20d8c638dd7467031822616362cf14d6a2f13315d2b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 04:07:43 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 04:07:44 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 04:07:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 04:07:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:92d5c20e5b4046bbd3c8e8fce28ada298a573f07dde6522ab7841cc97a1387f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f35231bc633ce826596a7b0227e782b23c09018c842796dcd049523e2b2187c`  
		Last Modified: Fri, 10 Jun 2022 04:39:19 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ad92f4950481dc80c44adcc90072a0b06e8e0b0221d4c910125a195aaf9d9c3`  
		Last Modified: Fri, 10 Jun 2022 04:39:24 GMT  
...
```console
$ docker pull drupal@sha256:df4c3979b83b6e4145929b998c69a5f415d0d0c32d874b757d2d649bbf708543
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172456267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:032f84f0008e260c3ec397a2140f37c651ebcd82bd4279251563b1ffe8d52fc2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 07:05:05 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 07:05:07 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 07:05:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 07:05:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4e959b868f426177f55e874d4034c4678162ee9146391f4972074f7ce9429572`  
		...
		Size: 669.8 KB (669843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3f7e9d3e4d80a23b5cdecc9ba346e614537c34c3f823410f05da9e10ececd99`  
		Last Modified: Fri, 10 Jun 2022 08:15:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7db223eda0425dbfc1eda4176cf67196ffabd6984c9c787b1a9ffa7a3a7692d6`  
		Last Modified: Fri, 10 Jun 2022 08:16:40 GMT  
		Size: 19.1 MB (19127819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:42a5d4b977d3eb8674d1617a3af0a9ec5918d40674bdf32ca0a53233ddcfab13
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.8 MB (147827770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:973fee6c01e2615403dfcd118dfed143b8aa109ab892df504a7737b8da83ffb3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 02:48:55 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 03:01:26 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 03:01:27 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 03:01:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 03:02:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3f4337f549343cffc356fb8eec80f7f9a8749496eea8d32a105aa66f4d2d2ae0`  
		...
		Size: 669.8 KB (669844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e86017e2545fea72a7fb15af65ac4015a0ede1e38a38691d76977893b1964a71`  
		Last Modified: Fri, 10 Jun 2022 03:34:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:492cad1ecac1911d738a2b3390d289bb0f24b533b3d49a202c148a9833a83e40`  
		Last Modified: Fri, 10 Jun 2022 03:34:05 GMT  
		Size: 19.1 MB (19127885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
