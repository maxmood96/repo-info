...
```console
$ docker pull drupal@sha256:d21fbbd5cf9b8fc19dbd001c16e55c943ae26ed2f6133a8c22b23c04a0a685ff
```
...
```console
$ docker pull drupal@sha256:a20d6f1efa7540f339cbb7fc053bff54b7f522bc7b8ec113e0fe6a691592675f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153227358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2254c3ef53ee701e6e5d87d9c4ec0170e69d8249b4af8c333a1e13ba8013839`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:33:25 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 15:33:25 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:33:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:33:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2ccb645acf494b98c746fa5c67736256b45c157ec482eb9740b58358958dbb9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a335defdab752f13fcfd54040f0610776fe5ff7116ba19aa4f0b255ca250dc4`  
		Last Modified: Wed, 30 Mar 2022 16:00:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea3bd8e0554f2e7eea05e70f15ddf2e71875c05a6d84cc9d4f2dd73e56a90acb`  
		Last Modified: Wed, 30 Mar 2022 16:00:41 GMT  
		Size: 19.1 MB (19126421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
