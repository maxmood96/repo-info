...
```console
$ docker pull drupal@sha256:b92dc307b70a549a5a68c82b86febd21244d3aae5387da10d5bb74678f492804
```
...
```console
$ docker pull drupal@sha256:51d89023db39c8345d929205dca2035986f6d653b0b654cfcead4e88404ee9e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.0 MB (138005611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:376edfa52c14f05bcd6d553bda9910339857e5388ae8c6526474993cb7c6f7c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 01 Apr 2022 19:46:47 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 19:47:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 19:47:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3fc4a60b9ef26c80770d980620f6fc932b17e337f391b07a75e7bbc150ff0973`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:627ae821433005b08e1d349066f83e3159780052dc48ff876b61a911ba39ed74`  
		Last Modified: Fri, 01 Apr 2022 20:35:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f362f8d513b2fd86248f28b6bdacc801035b9f8512f5d34e77ff466cce20a22b`  
		Last Modified: Fri, 01 Apr 2022 20:35:49 GMT  
		Size: 19.1 MB (19126533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:03e8e71f27f195d57d0788ca15183361b03132546d1889b3a8da05415ebab83d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.3 MB (153312098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5589463218f8ee1a5ad95ce50a75b4ef876df4c1844f511be3eb966240b21f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:28:14 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:28:15 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:28:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:28:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e0a77637877419e1913fd584fdf7b402987e241dc7c9d3b8a65dd7e2b9e96f7c`  
		...
		Size: 660.1 KB (660099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc480d395abe518183fd702fe8c2e8af078d70a42867a88e4628098bc488c248`  
		Last Modified: Mon, 04 Apr 2022 22:24:22 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d4d4d4df576da80982455e19429601c6f6d05561fc642ff3449cd48c6ff0cbf`  
		Last Modified: Mon, 04 Apr 2022 22:24:27 GMT  
...
```console
$ docker pull drupal@sha256:a006cc3c0f16344fdfc54f8d4a74282b4d7b0f148274482c12634b9a6553f713
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.5 MB (167480492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ec378c57abd8e4b1648b24d2ea2cf48a204a38a9d87f4ee3b6a789fbc5d4b28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:05:09 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:05:09 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:05:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:05:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:501327436fbbf5889b95f56f10c66fe95bb43f43fd5667aa17b1eb911bd6a8af`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d93e04523e5202ee8068ab0d2ffa33639adca476d4aa044decf9308ed088d79`  
		Last Modified: Mon, 04 Apr 2022 21:31:34 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b3ee37c09c03df52741454e00285a680f847b7f57371626a74b2f9079bee91f`  
		Last Modified: Mon, 04 Apr 2022 21:31:38 GMT  
		Size: 19.1 MB (19126525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:c6d4f85c40df3ac0c5eced48bf770416fb7486fbbb7a7cc4cc9fc972607b807b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172328089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b3286e1f50aff85625fc9add9c4779b20013c1a3e0a96bdbc1bb669b4fa4855`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c3280c5aa1c63545b95c5964162aa4e4237d0a5e557cee74de211cd921f827d0 in /usr/local/bin/ 
# Fri, 01 Apr 2022 20:40:33 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 20:40:39 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 20:41:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 20:41:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:36af30398a6ee25ad1bcf8551a3174fcf9f1ab3e06e9954d2b024d8ab11a0947`  
		...
		Size: 659.0 KB (659031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e8416a1419f78efe8ccaa4d9db7e0915eaf8006ca5337e0325e6973dfdd043e`  
		Last Modified: Fri, 01 Apr 2022 21:41:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b8626572693406f6841bdcf8831bdb8d336acab46201644b9faa3643bc70ea7`  
		Last Modified: Fri, 01 Apr 2022 21:42:12 GMT  
