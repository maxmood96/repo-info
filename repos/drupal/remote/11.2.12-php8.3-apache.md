...
```console
$ docker pull drupal@sha256:0b001d0eb8243471d4f431fbc960214ff4b44e811716b126630077d79bcf68c9
```
...
### `drupal:11.2.12-php8.3-apache` - linux; amd64
...
### `drupal:11.2.12-php8.3-apache` - unknown; unknown
...
### `drupal:11.2.12-php8.3-apache` - linux; arm variant v7
...
### `drupal:11.2.12-php8.3-apache` - linux; arm64 variant v8
...
### `drupal:11.2.12-php8.3-apache` - linux; 386
...
### `drupal:11.2.12-php8.3-apache` - linux; ppc64le
...
### `drupal:11.2.12-php8.3-apache` - linux; s390x
