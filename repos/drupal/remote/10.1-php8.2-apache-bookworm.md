...
```console
$ docker pull drupal@sha256:3e001b9d59aff2c68d93e93527f981f8b1ec0a3c7e60c633067b02afd44bcb06
```
...
```console
$ docker pull drupal@sha256:afefd5e1a274428785501e2a65bb2bf9ab4bc1d174a53f3430e6c4d21256e5a1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.1 MB (198073835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:764939903266e91bbf8c6a5b3177128b22eecaa68ef2b47388a57af1aee5586a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 21 Oct 2023 07:18:59 GMT
WORKDIR /opt/drupal
# Sat, 21 Oct 2023 07:19:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 21 Oct 2023 07:19:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84e657fd849b741a9a6efee96e61ceb2e75ed70ea6f92d4497532eef18355eba`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6cfb2f39f32ac08b5d15e8d9850bb02c8c5f34d1307a8e0536c87625ed96e9f`  
		Last Modified: Sat, 21 Oct 2023 07:41:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f29c113a44766aef5db30a88caaa128861bf09f5d2d55a2a18f08db834d7f2a3`  
		Last Modified: Sat, 21 Oct 2023 07:41:32 GMT  
		Size: 18.5 MB (18543471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.2-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:5f07b124bd33435e3a890d27cc85804048a4bbfc843e551d8e9a54c88e1fc85a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.5 MB (203493759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ee6c5e537315eba98f23971c9505055aedaf8f77b42c57f27abccf62b742284`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 21 Oct 2023 04:16:14 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Sat, 21 Oct 2023 04:16:15 GMT
ENV DRUPAL_VERSION=10.1.5
# Sat, 21 Oct 2023 04:16:15 GMT
WORKDIR /opt/drupal
# Sat, 21 Oct 2023 04:16:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 21 Oct 2023 04:16:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e08330f53975d10fb8985d1db071b645187267772b6535c0fa222c7446278c1e`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:970a7f32a4e999a0fa9f56c885534cb09511a7afffc13edf8f9d257acea1ebfb`  
		Last Modified: Sat, 21 Oct 2023 04:47:36 GMT  
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac3285dab14269c45d9eb55a1b92064a8fa34b4b0c4ef35dda82ea8445623879`  
		Last Modified: Sat, 21 Oct 2023 04:47:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:947612f879118bd6863cfbb22b08b60234d2613c164e248ab9097a7dee385d51`  
		Last Modified: Sat, 21 Oct 2023 04:47:58 GMT  
		Size: 18.5 MB (18543083 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:db62b869081151f473600b3a6806951d89440b619dee02a3f35370b7ab23800f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174701876 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50cda182871f2f6692c1bc67680503bf63b7d9bc4221de3b7562b55ab88347ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 28 Oct 2023 05:12:38 GMT
WORKDIR /opt/drupal
# Sat, 28 Oct 2023 05:12:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 28 Oct 2023 05:13:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eaea934350bee705287450fb073ffddfd61244b8f051917582d525bb88150471`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88d56f86f0218ceaae676abac051d7442fbbc5cc030479a859dee61a65ce798f`  
		Last Modified: Sat, 28 Oct 2023 05:39:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e774f49d38bc940426d1111e3a724d1f3f9ba152ab617b981a28db71350c50c`  
		Last Modified: Sat, 28 Oct 2023 05:39:30 GMT  
		Size: 18.5 MB (18542879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
