...
```console
$ docker pull drupal@sha256:7ded6a496b493e257cd52dc4f1a4d474c665faf92576c75f0118ac612a66bd81
```
...
```console
$ docker pull drupal@sha256:fbce4217306e4ce44fedb3591dce9c242fc39e5e71fd9d8630cba3f3816ce737
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48365472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5777dd9f54f38535fa742a2e366ddc095d7ad187e0d995b17c88438256d7968d`
...
# Mon, 04 Apr 2022 22:16:27 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:16:27 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:16:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:16:39 GMT
...
-	Layers:
	...
	-	`sha256:d4a4dd2e68f74b3fc74d8e4e6365dad3bcb5d5b9fc712ddeec09fdec59b41604`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fb83b4d2a10d5b6612d5de1f334a368b86cb87a9173583e529e247c862efb82`  
		Last Modified: Mon, 04 Apr 2022 22:36:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c76864042db965b5a0556ca74f6303c9cea63482401931c11437c8ae985ff3e`  
		Last Modified: Mon, 04 Apr 2022 22:36:24 GMT  
		Size: 19.1 MB (19115425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:1cd494045138c6ee9cf2b695faee9e9b429c99ff2427f3b1e55002415363f06b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48896259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58a746650bb9478e5af6833ad8bec255fad5a9b58178e624964b9b5ec36c44b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:08:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:08:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7e8631a9b9821a1c95fe883cdb39fcbca5589f4a88fea2e296c93ad4495ec881`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:784b141d3a698fdc4b85ce7847e28983ea13032d6aa57f2775277c8dab5bdfe9`  
		Last Modified: Mon, 04 Apr 2022 21:34:56 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e44d2a80d1d21301c7606d168047324357e2496e7c0acd852d2cd908ba2c591a`  
		Last Modified: Mon, 04 Apr 2022 21:35:01 GMT  
...
```console
$ docker pull drupal@sha256:ff78885a7909033fa3ba545a785a43204b44a1f1b1fcba61fc7bb4e4ef35f59e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47801300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7beeb23977c0b98c59792f8cda26efae3b8d380262cc15849f64482a99eeb5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:16:07 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:16:07 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:16:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:16:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f886f073b67c1b889f961810177e871c48e78986fb10b662748cf57e7a7ffbab`  
		...
		Size: 660.1 KB (660099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d4976604dee41e14f38a10dd2cb986d105ff48f09419c61ae39b11fc1bf0ed4`  
		Last Modified: Mon, 04 Apr 2022 21:35:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e38eca0b9caa0281c66360b19a4b7ca6e70444a664d2d19d6e42741af3844ce4`  
		Last Modified: Mon, 04 Apr 2022 21:35:44 GMT  
