...
```console
$ docker pull drupal@sha256:d32a17655ab3db2f86a36f73ad0e47591b23825927dfec3c176be5c1153ffe8f
```
...
```console
$ docker pull drupal@sha256:fd97bb292f03b19ff8bded9e9ded65208002d24365b8eec298dc42f676060023
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (47971636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3675ccf353b81f9140f8acb4d18c44dd79bf4d5a4f326fee356fcb95a3de2e2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:36:46 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 15:36:47 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:37:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:603c1394a07cc62b9bed33a1a9d62301aa03cec89940776c3de2c7cce812f587`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4de16b85ce6efcb11e7c87556604cd96d384e4d131946505d2c7dca6f319172c`  
		Last Modified: Wed, 30 Mar 2022 16:04:16 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7872bde9b5d8c14ab21750457bc9c2377286d0f8d85ba3d95a835ace49d64613`  
		Last Modified: Wed, 30 Mar 2022 16:04:21 GMT  
		Size: 19.1 MB (19117205 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
