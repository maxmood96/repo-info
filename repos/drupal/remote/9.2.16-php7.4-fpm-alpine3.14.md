...
```console
$ docker pull drupal@sha256:c432a439860fbd2c668736777947c5216b06f3820877fd2cbd539c0779f8a825
```
...
```console
$ docker pull drupal@sha256:4929c6a73664d2905444280879753c7abfeca7409a32f7a61c08ffa176c49275
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.4 MB (48366868 bytes)**  
...
# Fri, 08 Apr 2022 20:58:49 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:59:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 20:59:01 GMT
...
-	Layers:
	...
	-	`sha256:24ed7d0392b283557c4f5a0a366d9e9044ad1fb529529cd229434220465f6578`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8919c68d9dcdb2ef09ef6006b8ac34a3606efaedca22a3e3102781739b04ec32`  
		Last Modified: Fri, 08 Apr 2022 22:58:31 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f01f49b4ffed72f13179f019db0fb80256b0cb8f2f67f9a5b64a7a8f630a9668`  
		Last Modified: Fri, 08 Apr 2022 22:58:36 GMT  
...
```console
$ docker pull drupal@sha256:67870a467d05d27bd0e02549e213509c448c82ca726308ed48151e607b1e4623
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47802381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c74c582288170fcc488fadf2f88af9f8e65b74781e19fa3a54465b2513869345`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:15:57 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:15:57 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:16:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:16:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a2b16b25ce4af826856c58da6f04056bad618e876aec3ca150f5ee5bab80946f`  
		...
		Size: 660.9 KB (660936 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:237a9f2a3d49aa2d94987ae4cbac98a141e6f004e665794f7b427b295f325c67`  
		Last Modified: Fri, 08 Apr 2022 23:16:10 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c26fc107273a56155d064375b54697cab91fada1fb98930c661574d4b29b6854`  
		Last Modified: Fri, 08 Apr 2022 23:16:13 GMT  
		Size: 19.1 MB (19115870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
