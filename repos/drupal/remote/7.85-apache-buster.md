...
```console
$ docker pull drupal@sha256:2954dcd2475b0bbdb14b7b3a2a59bfe59ed7130bfc4df872da6ed2d1ab2ee20e
```
...
### `drupal:7.85-apache-buster` - linux; amd64
...
### `drupal:7.85-apache-buster` - linux; arm variant v5
...
### `drupal:7.85-apache-buster` - linux; arm64 variant v8
...
### `drupal:7.85-apache-buster` - linux; 386
...
### `drupal:7.85-apache-buster` - linux; ppc64le
...
### `drupal:7.85-apache-buster` - linux; s390x
