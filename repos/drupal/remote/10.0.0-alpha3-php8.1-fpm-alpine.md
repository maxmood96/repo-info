...
```console
$ docker pull drupal@sha256:7ef5a8f6fd9b03232d67aec983ddb84e1d1184229c106ac82d2ac4794bf49a27
```
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; amd64
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; 386
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; ppc64le
...
### `drupal:10.0.0-alpha3-php8.1-fpm-alpine` - linux; s390x
