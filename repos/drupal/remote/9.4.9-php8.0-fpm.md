...
```console
$ docker pull drupal@sha256:68123f86eeb6669ce5bd6dad944cfa39b3a35dea6cef2f2e4b37acdea7c28ca9
```
...
### `drupal:9.4.9-php8.0-fpm` - linux; amd64

```console
$ docker pull drupal@sha256:6af2473a0491531fd1fc2c219487c67733bf801bd4c7e4b3a267663e7da4d65b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (185024092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01adda3bb1dad3a8effd74b049fc91c82dffea4e0cc6155f8aba3adbfd92eec1`
...
# Wed, 11 Jan 2023 23:06:54 GMT
ENV DRUPAL_VERSION=9.4.9
# Wed, 11 Jan 2023 23:06:55 GMT
WORKDIR /opt/drupal
# Wed, 11 Jan 2023 23:07:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 Jan 2023 23:07:08 GMT
...
-	Layers:
	...
	-	`sha256:90137b386f06001caa2649651e711a83ccf1565a84c6e3c9043cb294df13db0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9759c75a04cd096bac8df9329c60289cf340198127a387f018a455b7ad43afc`  
		Last Modified: Wed, 11 Jan 2023 23:23:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:880926fd044c8f29cd326622223c6b36f351571242bec3df3d4f75a7f7db0b9b`  
		Last Modified: Wed, 11 Jan 2023 23:23:37 GMT  
		Size: 21.9 MB (21921802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.9-php8.0-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:8db5f9bd9cfa41241c26ae749ec9801696fac3b4716dae2b443af8c73dd8f048
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155028991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85ddcdeb16a2d1e4eb9744b7b24374671ef6def6d9f8409e66739f6d485a1f61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.4.9
# Thu, 12 Jan 2023 04:13:00 GMT
WORKDIR /opt/drupal
# Thu, 12 Jan 2023 04:13:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Jan 2023 04:13:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c7835385c9ee3e07c67fb14211f664aaf51141b744415676d32bac46af478007`  
		...
		Size: 700.1 KB (700097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4101f4b95b002ce21ae73f8d72372713fc10067a1f3f15d44a8294a64c9e3cad`  
		Last Modified: Thu, 12 Jan 2023 04:42:56 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b43fd1b8e308c1742693eb01141bf2c05380f20e5662bfa43386c9b8c1cd69a`  
		Last Modified: Thu, 12 Jan 2023 04:43:03 GMT  
		Size: 21.9 MB (21921227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.9-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.9-php8.0-fpm` - linux; 386
...
### `drupal:9.4.9-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.4.9-php8.0-fpm` - linux; s390x
