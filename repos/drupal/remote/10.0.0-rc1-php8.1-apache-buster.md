...
```console
$ docker pull drupal@sha256:3109ce84c11b15a182ab2c896063ff8c18349204742bfc696c286952d5e64acc
```
...
### `drupal:10.0.0-rc1-php8.1-apache-buster` - linux; amd64
...
### `drupal:10.0.0-rc1-php8.1-apache-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc1-php8.1-apache-buster` - linux; 386
