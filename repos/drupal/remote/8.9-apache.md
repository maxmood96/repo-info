...
```console
$ docker pull drupal@sha256:87991caf308ed42b5a9e08e5964d3e5d29a8b60c2ab92030749d3d6fe0b0f12c
```
...
```console
$ docker pull drupal@sha256:0203cb05be8f497bf5f722d1c7eb29bec8628323a60392ea5adc7d2d1d01bfe4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162148947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac3c9fe10efdbf3dac9ef07ffaf6f7ed83526e5c3a571ea41685c03f4b2a5806`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Thu, 27 May 2021 13:39:28 GMT
ENV DRUPAL_VERSION=8.9.16
# Thu, 27 May 2021 13:39:28 GMT
WORKDIR /opt/drupal
# Thu, 27 May 2021 13:40:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 27 May 2021 13:40:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ac2b816eef5d806f1c801dac227785379995193096822cc5d592becb4704b67e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30aca5971fa08e49993a61ba5fa88115052de0b0c0e588be66cf8af174dd8627`  
		Last Modified: Thu, 27 May 2021 13:57:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:caed0328eddce6cc587f39bdf249f8bdf03f5ba81673bba10acea88ddfafb021`  
		Last Modified: Thu, 27 May 2021 13:57:08 GMT  
