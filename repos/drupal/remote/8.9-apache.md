...
```console
$ docker pull drupal@sha256:27ba46fd9a628d834d4057bd000dccb505ec866c2c226e408ed283d17f1e49a6
```
...
```console
$ docker pull drupal@sha256:3559f44f09583a0a5c8f34160c375a23e341d169b3d0e218d91194a0d4c29b94
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.4 MB (145432649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02a43d90424363b85ee65c60f44b1cbb354e786ad018f38e93e41360dc7349a8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Fri, 04 Jun 2021 07:20:52 GMT
ENV DRUPAL_VERSION=8.9.16
# Fri, 04 Jun 2021 07:20:52 GMT
WORKDIR /opt/drupal
# Fri, 04 Jun 2021 07:21:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:22eeb5be7e4698caf4e1c94eb4491758676a2f6b47749c57f97a33551ee3372a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f5b6534596be1f38ab0a5b2c463ca7cd37e50d838e06bd19ef6766cfad5581`  
		Last Modified: Fri, 04 Jun 2021 07:44:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd8c40686e6710dcde65426e2e9cd8f9cab2ecbb7fa24254e9bf263fcaf904c8`  
		Last Modified: Fri, 04 Jun 2021 07:44:34 GMT  
		Size: 20.8 MB (20798176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
