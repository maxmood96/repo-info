...
```console
$ docker pull drupal@sha256:483d060321f1a0d35a167d25b26ea2cf5ebf6d86ace313566b04303398c6d5a9
```
...
```console
$ docker pull drupal@sha256:6004ee0ea83ecde92c8d06c4d0c8bc91bac821d66a55801dff387f2fed62c6f4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.3 MB (145269909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4480d2713736aa4860b5ae481bf155194fed6d25ae97781198ce154dcf155819`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:37:40 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:37:41 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:38:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:38:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:60c4406f6a09d64b1f86e035c05d99f8e1b56cad943e79bf69081b6c4e7a2a68`  
		...
		Size: 507.9 KB (507870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c740546100b26a77d87362d9fb2b3f25b25b076f0613522604ef7cf6b2ecab75`  
		Last Modified: Wed, 09 Sep 2020 20:45:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4caf7bb864e39e2e07a8533d87142fc000531625ae795095982648f51daf2568`  
		Last Modified: Wed, 09 Sep 2020 20:45:49 GMT  
		Size: 20.8 MB (20758238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:58ad0b10cf6394b4d93a2231892b158ac0e747a694f793c4ecef897b8cadf726
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (161951797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55d2cee8732ac40e5e65bdb61557225d007182de3bc5a34b1c5f492a2ce1ee68`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:24:49 GMT
ENV DRUPAL_VERSION=8.9.5
# Wed, 09 Sep 2020 20:24:49 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:25:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:25:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ac343d79fb3b19246cd7d99e579e692ddfe1fbc791f6f09cbd6a4b1bd956409a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a6f18b68ffafb5ea86489452acfbb68d1684ef0594fdd2e2cdfe30595f2c407`  
		Last Modified: Wed, 09 Sep 2020 20:31:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da1f2bd0b3ff7a707fb941fd3a60315458b877610addca899a0e76e5622c21c1`  
		Last Modified: Wed, 09 Sep 2020 20:32:08 GMT  
		Size: 20.8 MB (20758012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
