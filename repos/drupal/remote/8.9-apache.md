...
```console
$ docker pull drupal@sha256:bf7f847b458f8026abb74b9e01f271044cd0b6fa8d0cef28601043d2bd9ad83b
```
...
```console
$ docker pull drupal@sha256:2755a16b0c6ac9fa4a1f508390f417d1842c576c650f4cd78d8d579d5c9c5b99
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170564792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a049baea83c5957a18154c91683e1dd255d71c87fd55fdbb28da7ddf3bf3d1ff`
...
-	Layers:
	...
	-	`sha256:2bb813f10e2950569afd8a7e2e1c958f3e00f1c5372e259ff4e4f593735a24ef`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c130fcfcdeb2c1bb905b6bbb3bf25611b61024ab39a9b6f3fccdb3bb12b531ae`  
		Last Modified: Tue, 05 Oct 2021 21:54:46 GMT  
		Size: 498.9 KB (498903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665a7cf65378c17659cca745d80e441513223c1f74e85cfaca475ff3a5af2f60`  
		Last Modified: Tue, 05 Oct 2021 21:54:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a4435e0abee95ce98324ec52fe064d02be95b3397362a58d35cbc63593207c2`  
		Last Modified: Tue, 05 Oct 2021 21:54:51 GMT  
		Size: 20.8 MB (20795846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:30881e88c23001b6d91ae3fcdbed00affb433f210003112d6c4d227a0a60e2b4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (145975255 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08fe3dacb9587903b829aa2e3f031e824858abc15e8459edd305943b2aad69f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 05 Oct 2021 21:59:47 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Tue, 05 Oct 2021 21:59:48 GMT
ENV DRUPAL_VERSION=8.9.19
# Tue, 05 Oct 2021 21:59:48 GMT
WORKDIR /opt/drupal
# Tue, 05 Oct 2021 22:00:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Oct 2021 22:00:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dcf40e62bb1103d0e5c6d3943848c71b55f14ff3e7e9bba5cd51b00131ca865d`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86ec25b5ec3260dbf0770c770bfa20773473a9cce2cd181088c598a3cade3235`  
		Last Modified: Tue, 05 Oct 2021 22:41:33 GMT  
		Size: 498.9 KB (498913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61a1a7413accfcae88da1ba6cef729dad7061ecd0f87595c74cddfdf402168b1`  
		Last Modified: Tue, 05 Oct 2021 22:41:32 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5981b7cf6cebf27685b5d523e67e529747316d556ab9b9f5221ab6bb040fdd8`  
		Last Modified: Tue, 05 Oct 2021 22:42:00 GMT  
		Size: 20.8 MB (20795628 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:9fba5c9f5d068e6f766df760c994af270e383660e817e12fda7b8b6b901239fe
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.6 MB (162607620 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e20f128026386591934de94a832cd3b53c1f2a552d82cb4b5a51b115d644f1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 05 Oct 2021 21:03:29 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Tue, 05 Oct 2021 21:03:30 GMT
ENV DRUPAL_VERSION=8.9.19
# Tue, 05 Oct 2021 21:03:30 GMT
WORKDIR /opt/drupal
# Tue, 05 Oct 2021 21:04:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f02dd6645e81836507dd83a5b0576c51ad35baa0b10eb22fde40df0c5e5e63ec`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5e73089b09e169e15224cdcdbce0c9eceb6ca018bf89ff7fb18365f07fcf424`  
		Last Modified: Tue, 05 Oct 2021 21:25:36 GMT  
		Size: 498.9 KB (498911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cf5969a1dcca3f457e2a563a32767d50ae0b240209f3861f5c1e839ef08b0a5`  
		Last Modified: Tue, 05 Oct 2021 21:25:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df826440b40de81b5e5774fee58091fc0d210a9c6632a8098e6f6b543f765388`  
		Last Modified: Tue, 05 Oct 2021 21:25:46 GMT  
...
```console
$ docker pull drupal@sha256:24176cfee25999b9334030e220fe3235c247b03468818e32dc21193cb5563680
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181928389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:830e5c17fc2805efeecf1666f333a1cf2189ec7f1976454bd02f6be63af12c3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 06 Oct 2021 10:52:45 GMT
COPY file:9cc76ee8d52eb5b7e4e6af32aa5d703d151015a7c3001b26e3d9b548456e3781 in /usr/local/bin/ 
# Wed, 06 Oct 2021 10:52:49 GMT
ENV DRUPAL_VERSION=8.9.19
# Wed, 06 Oct 2021 10:52:53 GMT
WORKDIR /opt/drupal
# Wed, 06 Oct 2021 10:53:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 06 Oct 2021 10:53:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22cf927284f1084f6011f3b9aac70e7d3f15c1e6501eb1d3a7ef198cd1e87ede`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8cb0107e329491776b97dd327e21d3847bdd0892880d4c69a81925f4f75cc85`  
		Last Modified: Wed, 06 Oct 2021 11:35:43 GMT  
		Size: 498.9 KB (498914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eff66855e4ba8e5a244390799e17506a7f6ee9b2c1f7eebb031cde8ee8f4c5b9`  
		Last Modified: Wed, 06 Oct 2021 11:35:42 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbff5adad13c52ce2240938e77362909c30d26329306138e8802be7b764d6faa`  
		Last Modified: Wed, 06 Oct 2021 11:36:50 GMT  
		Size: 20.8 MB (20795876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
