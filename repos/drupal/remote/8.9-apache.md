...
```console
$ docker pull drupal@sha256:486101d8ba34aaa4b4e214d1ad38f58b0caee0270591253134a3f784f82e2c88
```
...
# Tue, 13 Oct 2020 12:23:13 GMT
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 12:26:02 GMT
ENV DRUPAL_VERSION=8.9.7
# Tue, 13 Oct 2020 12:26:02 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 12:26:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Oct 2020 12:26:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:585300dc592f906d2e2974eb69f7e2202a8076713532758278c18c745be99623`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d46f6e295fbcdb0ae236c7d7ddf2f7c474c46c3fdb5158258212ffe48023a1e0`  
		Last Modified: Tue, 13 Oct 2020 12:31:43 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:500aadac1e788450aaca65e2bbc69f1e1b3ac3c939154ef5adafecf1dcaef13c`  
		Last Modified: Tue, 13 Oct 2020 12:31:47 GMT  
		Size: 20.8 MB (20764048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
