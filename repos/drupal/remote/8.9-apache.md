...
```console
$ docker pull drupal@sha256:64c2c3d001e4ba04c2c2d0e792838b987b843a3509d6ade05c6d698a0ebd6772
```
...
```console
$ docker pull drupal@sha256:80566121cf83fb2aa215aefc6605f9049222d3c52f0a0c229f629cf924cd2023
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.9 MB (175938151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c34f268c5bc4e980caeac9e33207120a6e7a24e46039bb1dfc44591b386431dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 16:48:25 GMT
ENV DRUPAL_VERSION=8.9.8
# Wed, 18 Nov 2020 16:48:26 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 16:49:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 16:49:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f22592de3126196ba47ddf35d1984b28cb0c16e460527cecb517c767767f7902`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9de1f2d9472ddcd7d9885d7b817c2e9be466d45240b04e61bf63335356c13e7`  
		Last Modified: Wed, 18 Nov 2020 16:52:27 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a236622192349347d937f551f59863b772e999b8755bcb187ce64efa949b4765`  
		Last Modified: Wed, 18 Nov 2020 16:52:35 GMT  
		Size: 20.8 MB (20765337 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:bed86a6eb0ec44ea2f9abd9d0fb18b56846e859d8aff72c95e327c0f28bb4b1a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.6 MB (155605645 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864ebd75645dc70e0756b58f8aad34e9a2ae6d10349d7a09f3d6fdbeab419d9d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 18:31:39 GMT
ENV DRUPAL_VERSION=8.9.8
# Wed, 18 Nov 2020 18:31:40 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 18:32:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 18:32:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b2b5f2181748049f3e5bcf2a63365fc65be772722279af1a6ec9e28a0dbe846`  
		...
		Size: 508.3 KB (508282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4663d211359233d50f78f5d72dacff10e496334cd255d522a3775de9167c983`  
		Last Modified: Wed, 18 Nov 2020 18:37:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b45222ea8909e4c8cdddde794af0c22bc4b710f1a0d6cf109226ee386f5d961b`  
		Last Modified: Wed, 18 Nov 2020 18:37:59 GMT  
		Size: 20.8 MB (20765497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
