...
```console
$ docker pull drupal@sha256:984c275ed5673ac74352805956e977c0fc0b737f39e22ca3a70003e45a6c1653
```
...
```console
$ docker pull drupal@sha256:fb147212e201bd7e43c8ad2e8c348acdd3b8e5aeae0ba705ee6a4221308090ce
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.4 MB (181352978 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:107f9e7eded06586de0045f0372c0c826cc60fa5b0e3e465f9d10337cae6efbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:397fc58b81ee5936a7a7973587c1eb7aec57c4919cfed55540949a78974f4bd9 in /usr/local/bin/ 
# Thu, 07 Jan 2021 22:31:40 GMT
ENV DRUPAL_VERSION=8.9.11
# Thu, 07 Jan 2021 22:31:49 GMT
WORKDIR /opt/drupal
# Thu, 07 Jan 2021 22:32:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 07 Jan 2021 22:33:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2675c9ddcb8150d26b7665fbe5dba503a9665c8ab56a483e45f28d852925965`  
		...
		Size: 508.4 KB (508387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e43f904051b994d1d045c52ba08914b8dd6b2f55a38db7120b0aa11f982f0e3`  
		Last Modified: Thu, 07 Jan 2021 22:43:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:878b5f7cdd706ee22bcff369bc59613d7e9c9e212c01f03b43561cd684db29d1`  
		Last Modified: Thu, 07 Jan 2021 22:44:02 GMT  
