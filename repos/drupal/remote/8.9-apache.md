...
```console
$ docker pull drupal@sha256:f0f889c4583ff4443f0500855435ed991cc46043c80ce98906a909899c9554b4
```
...
```console
$ docker pull drupal@sha256:ca4fbb78877bf6227b8e760157c473f8f7bd335e4b6dc67d59d2e4912483ae7c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168470061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f4b253cf1ce552f9471ad7859d981b1056c0a7dc2ba89b79510cd4591606084`
...
-	Layers:
	...
	-	`sha256:445284e754b8d473f5791ba50ac70c87f9d0212fe19325585c0994284116ebed`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15428b776546426edcd3764857a49f79486a78e8862c0dd6c996f519ed436a1f`  
		Last Modified: Fri, 07 Aug 2020 01:22:22 GMT  
...
```console
$ docker pull drupal@sha256:5cc788b34e47744d8d2ece891371690ed381385eb7c5469af0c838a946ae2d8f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146688212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56e6cda12c6f50909ce629cef28a26f06c82fb65fa0efd2257c5f01c0611d505`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 06 Aug 2020 23:31:00 GMT
ENV DRUPAL_VERSION=8.9.2
# Thu, 06 Aug 2020 23:31:13 GMT
ENV DRUPAL_MD5=f3f64fbef97831efd1c943f392975f45
# Thu, 06 Aug 2020 23:32:55 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c788c0f06c74d01661bed264a5fef873b99a19a90b1e29a98c8ef4ab9ac239e9`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd47cf8d947f5b44b42bc2fd86fffee79665547a86d5ee5cfa01a0245c93279b`  
		Last Modified: Thu, 06 Aug 2020 23:50:20 GMT  
...
```console
$ docker pull drupal@sha256:4053749c4ea77e894af6ffe15c396a708998aa9c2a96558d107f7a44aa12d483
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143905195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b665da14f3a3203c8275b444f18265b4d273c0d258c814146fa74924589f668`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 06:07:16 GMT
ENV DRUPAL_VERSION=8.9.2
# Fri, 07 Aug 2020 06:07:16 GMT
ENV DRUPAL_MD5=f3f64fbef97831efd1c943f392975f45
# Fri, 07 Aug 2020 06:07:36 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7a590d779587fe2c3a212c8c8ac8572a2bb20243bc703eb82797e97091ab6abb`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:279264f7735711d43bf5429b788be4f6769ebe9b98f425ec678bf10e1405018d`  
		Last Modified: Fri, 07 Aug 2020 06:15:54 GMT  
...
```console
$ docker pull drupal@sha256:28a344ba1e2602b75ce857166e16067f2b096f383241b8e62913a337d71c4621
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160587008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb436e94e8efd229abd16ccdfdcc4881c618638498ec671d937fc0d1a356320c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Fri, 07 Aug 2020 00:48:50 GMT
ENV DRUPAL_VERSION=8.9.2
# Fri, 07 Aug 2020 00:48:51 GMT
ENV DRUPAL_MD5=f3f64fbef97831efd1c943f392975f45
# Fri, 07 Aug 2020 00:49:05 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5b1f2b0a789f26388082178113c8218b043e04df816ed7c138c54f868f764e9b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:331e8350fdbd46e9da8f86cee220d6ae379d38a67c2718bff8e284a7f9067b13`  
		Last Modified: Fri, 07 Aug 2020 00:55:47 GMT  
...
```console
$ docker pull drupal@sha256:ae7fb62e71c1d3df453a50c3356ccb6eb9701232396fa9b4ac2248b1c291afaf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.5 MB (174526443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c65d5396b270f2fffa98135a63ceceddb334e786e7914edbf978e6879fb1c74a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:07c43b5d502d528055f2da7f4ec7cc4d492b35a35ce97ded91c87ac2d9778c41`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28563558ae1b6052815d5d8da5ec7bc1be90bf6c9296aa9e0b55805452a99fd8`  
		Last Modified: Fri, 07 Aug 2020 02:59:18 GMT  
...
```console
$ docker pull drupal@sha256:cad836cdd50f55773af3f1297a9420e5a0fa5ba02c8841d5e5071717d2a15862
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.1 MB (151103674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfcec2782a386b8bf0c64bb2c21e738ac091db4d15998d44053e2edbad70cf7c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Aug 2020 22:05:29 GMT
ENV DRUPAL_VERSION=8.9.2
# Thu, 06 Aug 2020 22:05:30 GMT
ENV DRUPAL_MD5=f3f64fbef97831efd1c943f392975f45
# Thu, 06 Aug 2020 22:05:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d651b3739f0329b1665a37f091bcc0fdf2e3d67d02c2a26438b82643a7c471d3`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f708d8b5439c6dbb63bb341d1885e7270084f113c4b574b84e6cd0f63032c312`  
		Last Modified: Thu, 06 Aug 2020 22:11:12 GMT  
...
```console
$ docker pull drupal@sha256:dea09da061ecfa7e50a7c41748bd629d8e201e93cc7ad78e89052ce83b845e06
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179904352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e4d1982a20ca28e12294e538cad54bec854f396550ae240462884d5b035391f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /var/www/html
# Thu, 06 Aug 2020 23:28:13 GMT
ENV DRUPAL_VERSION=8.9.2
# Thu, 06 Aug 2020 23:28:15 GMT
ENV DRUPAL_MD5=f3f64fbef97831efd1c943f392975f45
# Thu, 06 Aug 2020 23:28:40 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e55e1e30dc453c01b432ec801632aa923a920d1c12e48c8e981da11ebab96f4a`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b089c2bdbfe0c6f28fc84ce1ea4b4aeec07a44c1fbcb6f48125c79c8e67ef323`  
		Last Modified: Thu, 06 Aug 2020 23:39:18 GMT  
