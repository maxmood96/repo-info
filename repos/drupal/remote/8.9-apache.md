...
```console
$ docker pull drupal@sha256:03dcda1d27ed5c124845294871be849d4d2d6deb6aef67dd220b6e1d46c4b7bf
```
...
```console
$ docker pull drupal@sha256:f3de0dc883962a8d51676002ad27331e1403716b9f6883c2869ab638137b68b8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.5 MB (181481510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51c15bf0ee29d1a388bd7234b144e4fecf77904db075abbb08e5dc3408c4d142`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Tue, 29 Jun 2021 05:02:50 GMT
ENV DRUPAL_VERSION=8.9.16
# Tue, 29 Jun 2021 05:02:54 GMT
WORKDIR /opt/drupal
# Tue, 29 Jun 2021 05:03:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Jun 2021 05:04:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe940327d102af0e28510f8bc449f58faae96f16e8e14d236ef855cab8a6a0ac`  
		...
		Size: 507.6 KB (507622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5116ded66fdec667821a6028312d81d47b902104495d2e6abf949fb8fde294e`  
		Last Modified: Tue, 29 Jun 2021 05:33:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba06741caa6f2d5f5a467c668662c80d2a781438c54ee1498347d25a95fd6337`  
		Last Modified: Tue, 29 Jun 2021 05:35:46 GMT  
		Size: 20.8 MB (20798128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
