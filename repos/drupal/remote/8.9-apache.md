...
```console
$ docker pull drupal@sha256:661931e1f6ef0166fba8ff69dc4c8a451b6b8a19cd7f95d68fadb190110c5e53
```
...
```console
$ docker pull drupal@sha256:21c97710d3683594abd3b801f1854006b16e23de784df1b76d54cbd1982dab18
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.5 MB (181482116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:adedcb9ca6e24b1cec15ca8be81996f1c82ac16d06d929d6d26704791a74724e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 10 Jul 2021 02:40:46 GMT
ENV DRUPAL_VERSION=8.9.16
# Sat, 10 Jul 2021 02:40:51 GMT
WORKDIR /opt/drupal
# Sat, 10 Jul 2021 02:42:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 10 Jul 2021 02:42:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68872a7942d54e202b2ea6f261d305677d0e527ef0867d21496fab7fc5b111c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c66a5b61435abbbe0fc5262cce36019f1febda70bba91a7790cd36f17a0a977c`  
		Last Modified: Sat, 10 Jul 2021 03:11:48 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d11e1d07080fa0b6469d03b7d04fc935cfce1f3c7f2f2e02d822086cd9c9adb`  
		Last Modified: Sat, 10 Jul 2021 03:13:29 GMT  
		Size: 20.8 MB (20798119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.9-apache` - linux; s390x

```console
$ docker pull drupal@sha256:d252b923859ef56b0ab9e193db64c932dddfdeb025b23bdf3360a0b7728e3dd3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.7 MB (155739512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1b98c1eb545152c1549a27b79a36468931618ac4e6eacba92fc7a959bdf12e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 10 Jul 2021 05:10:31 GMT
ENV DRUPAL_VERSION=8.9.16
# Sat, 10 Jul 2021 05:10:31 GMT
WORKDIR /opt/drupal
# Sat, 10 Jul 2021 05:11:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 10 Jul 2021 05:11:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:641b3265b59bce52b9607aca08031b028272ae98ca8af65e497b614c29f32c46`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fe724f1d9e65134c583b01cb50287863ca93261d7719175d51ee151a9f4efc2`  
		Last Modified: Sat, 10 Jul 2021 05:22:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f53be06604f7513ffa43cc124ab64dd7d653be8bde9dfd671c227e323a5d1b7f`  
		Last Modified: Sat, 10 Jul 2021 05:22:56 GMT  
		Size: 20.8 MB (20798165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
