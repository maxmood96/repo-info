...
```console
$ docker pull drupal@sha256:1d8e22c1c9e0767ea44e6ca9e202e4f9ee769a37f34c831401d0a6f249347bf2
```
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.2.7-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.2.7-php8.4-fpm-trixie` - linux; s390x
