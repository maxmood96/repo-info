...
```console
$ docker pull drupal@sha256:139d04be420e7ba40a024093415ca9904abbacb33ae5b1823e349bdf6c17ec8c
```
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; amd64
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - unknown; unknown
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; 386
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; ppc64le
...
### `drupal:11.3.0-rc1-php8.4-apache-trixie` - linux; s390x
