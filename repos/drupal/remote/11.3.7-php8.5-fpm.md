...
```console
$ docker pull drupal@sha256:e6eeb7ed5516533debae5710757d457fb3e419516661bf2b5366b09b8976861f
```
...
### `drupal:11.3.7-php8.5-fpm` - linux; amd64
...
### `drupal:11.3.7-php8.5-fpm` - unknown; unknown
...
### `drupal:11.3.7-php8.5-fpm` - linux; arm variant v7
...
### `drupal:11.3.7-php8.5-fpm` - linux; arm64 variant v8
...
### `drupal:11.3.7-php8.5-fpm` - linux; 386
...
### `drupal:11.3.7-php8.5-fpm` - linux; ppc64le
...
### `drupal:11.3.7-php8.5-fpm` - linux; s390x
