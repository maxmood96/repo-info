...
### `drupal:11.0.5-php8.3-fpm` - linux; amd64
...
### `drupal:11.0.5-php8.3-fpm` - unknown; unknown
...
### `drupal:11.0.5-php8.3-fpm` - linux; arm variant v7
...
### `drupal:11.0.5-php8.3-fpm` - linux; arm64 variant v8
...
### `drupal:11.0.5-php8.3-fpm` - linux; 386
...
### `drupal:11.0.5-php8.3-fpm` - linux; ppc64le
...
### `drupal:11.0.5-php8.3-fpm` - linux; s390x
