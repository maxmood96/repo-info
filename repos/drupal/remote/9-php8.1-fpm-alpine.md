...
```console
$ docker pull drupal@sha256:8ea12d48c26d86be80352f31a279e63a29ccfe817c701908b8ada172a76e83da
```
...
```console
$ docker pull drupal@sha256:382290df0d855f4a076327a8c52f954b04c35599ca9d2b205fcedfab2dd143f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56368915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f86ece945253dabecb0870e6a828f977504295743877f3b1a8669eca1dda698`
...
# Fri, 06 Oct 2023 18:46:27 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 18:46:27 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:46:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:46:39 GMT
...
-	Layers:
	...
	-	`sha256:d692a7006832f21c58b052fd78f1cd482fcc064fe5e667b2821d501b762bc258`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7278be891f4a8fb7d05e7dd50e9be3808e4771b96f8cf619a3e0b86199720f0`  
		Last Modified: Fri, 06 Oct 2023 19:08:16 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da19c5dd978e2a93854256b621542fbc8c7d5e2767fc908e5357fdc8c7b88389`  
		Last Modified: Fri, 06 Oct 2023 19:08:21 GMT  
...
```console
$ docker pull drupal@sha256:1adcec6672606740969030c438ee8ec02425d68e29999cefbf35bc53bab53bba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.4 MB (54423485 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79abfb5dce39c4975033553ef6c82048f473ae60084a21b84c45e6e6ad2a4a11`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:13:03 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:13:03 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:13:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:13:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4ead53ce899653ecdd268dad3724ef8ad7f0cb36b027848fb4e1e4f24ed63477`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f059b8b785322cb55997e7bda915f58c1025d55f13b51bbc8a647b5b647a993`  
		Last Modified: Fri, 06 Oct 2023 19:19:26 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735487020ce37951208d00eaf12d289cdf41ea8d6bf7cb46acde47c7f463d187`  
		Last Modified: Fri, 06 Oct 2023 19:19:32 GMT  
		Size: 22.9 MB (22875140 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:32075866a7fc24d2bd964839a9521318ab6469c16e1dbbee0c5db685b4dcf6ae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53146274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb934683f2338a2d0279daf12f9efded34ee44e7c8e7b7d20e34776ab5e4492a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:32:12 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:32:13 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:32:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:32:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:310c025f051956c21e6db43b679cca362c9cb775e5f7417b131f1a0743b96338`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ae801f9422105ee1223a2568e9cf00e42da87674bde349a920643c0b67580f0`  
		Last Modified: Fri, 06 Oct 2023 20:00:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9d128b83cb803493c590d8b958c77e749923e80a76e69414389653a9c8a759b`  
		Last Modified: Fri, 06 Oct 2023 20:00:38 GMT  
...
```console
$ docker pull drupal@sha256:00d95897b81c78759f8b31715f5db4b3a437b3394de721abb26f35e65dda8b0b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.7 MB (56668124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:755571337508fb07c56d925d63e3a43e8c9e0f77a124dd5222dbb8abb4344663`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:17:55 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:17:55 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:18:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:18:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eb61d4960f6817fe8f12006ff4bd421f36691c96481de177e2fe6b80ac94ab14`  
		...
		Size: 705.0 KB (705009 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b140f60a82ccbfe4854e8600a5ca197579b066e3d078a772eabf11cd73150a9`  
		Last Modified: Fri, 06 Oct 2023 19:43:05 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3162467feeaa61bad13d4f0371cbc87a23fd429c053eaafba8cce7a839b28dd1`  
		Last Modified: Fri, 06 Oct 2023 19:43:10 GMT  
		Size: 22.9 MB (22875346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:f1c0a8a623e05f1441a111463d9f6b86106a06ca35bd3c2949f38aca8627d957
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56420431 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:808ba48c5720c3f56945963cdde6975ab9cfaaacb511348f5996b17a1d656916`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:18:54 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:18:54 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:19:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:19:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b760f42032960f4043b6a0e07d646177f141d578711da70f46e9101eb2b1c258`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:522f5d9b509d345524345d01b496b2ac3bd4b20cdfa44e3e98d3e2c584e87e6b`  
		Last Modified: Fri, 06 Oct 2023 19:47:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bcf96412735dda5e2658cb66619bfcb63a6d7fe028702ccf04b98387771d32f`  
		Last Modified: Fri, 06 Oct 2023 19:47:50 GMT  
		Size: 22.9 MB (22875212 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:c1b0022ddb5ca4e52a49fe236721c211d55d6e69b5d44ebe2da192065af9c2aa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.6 MB (56578025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c03a119427f71477c65a7227c1cd006aa2752bdc8b8080df67c7bb5fce5a31c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 18:54:54 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 18:54:54 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:55:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:55:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f9551fb5d1ae8d6b419e302ad930434bc413130cf270a7617ed7be06dc5d356c`  
		...
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66b9cccfa46318c3f1160f772b227e2c2679adf3cfe4b87bbd83ff37431aa159`  
		Last Modified: Fri, 06 Oct 2023 19:29:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec3361e732a916ce6fe304ab35a16e1e8b7ccc7fc90bd54d41d9e6ff539906e5`  
		Last Modified: Fri, 06 Oct 2023 19:29:56 GMT  
		Size: 22.9 MB (22875371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:db1d9c804530f3bb53dc5ae2da6460cfe31bb4d1ab64319fafe8baeb1c41e3a4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.0 MB (55010708 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c872372514e8b67c22e4fe0f3496ce5fb6cf5b7a591f519977cbcaeb1f8d7c2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 08:21:01 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 08:21:01 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:21:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:21:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b38fa67fb104d7dffbc373494f1978e80da3d36c11f96cdaaac78d48ac93619d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dfb40a49d42449482e9f485fd12de095e16bf7f351d75dda8570fd97d3ac7e7`  
		Last Modified: Sat, 30 Sep 2023 09:31:27 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ef5b9f845b05ba63f16397533f074ab12443f32da33f1d19ebeec8eb573c615`  
		Last Modified: Sat, 30 Sep 2023 09:31:31 GMT  
