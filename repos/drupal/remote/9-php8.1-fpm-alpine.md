...
```console
$ docker pull drupal@sha256:22c0c603f5934f8bff3fc19858756f2a16abc85f639b86c5e8194bb6d7b49afb
```
...
```console
$ docker pull drupal@sha256:e142316ca5400a1756a691979e3ad1d5c7fd586491fde44ead86b433ec904e83
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.6 MB (55553811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6e56387ada8d2b13fe572939ce0f1a3036f88e75b12e7ed700b9093429091d7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:48:57 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 12:51:27 GMT
ENV DRUPAL_VERSION=9.4.8
# Fri, 11 Nov 2022 12:51:27 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 12:51:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 12:51:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8c7dc6473c0176dd45a7da81ef13d61278dc167900da64858464d4dafc81e1b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:748f075e524b0b90237e007e95bab884af649f62ecc3036f4d5a53c149328a54`  
		Last Modified: Fri, 11 Nov 2022 13:05:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:858b859408699a0c69ff4d6ad643dc19d505b20d2ddd1d8649371a2199a97197`  
		Last Modified: Fri, 11 Nov 2022 13:05:12 GMT  
