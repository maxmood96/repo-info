...
```console
$ docker pull drupal@sha256:c72f0541a3359a0becd50abe2f6b27fb73ab8a1524f515f60383472bee4c5b49
```
...
```console
$ docker pull drupal@sha256:a2a3188d5ac320de1461c1b4a1870716ddc8c7888aee27839b498a9f0eeca7aa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53488732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8b69cb98bc3742f28d28a2449a5683585a3d07ec6b5ca7a15c9c3b370997d24`
...
# Mon, 22 Aug 2022 19:42:54 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:42:54 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:43:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:43:08 GMT
...
-	Layers:
	...
	-	`sha256:fafadca79d56006e9db6decf812496d95781aee008b3d05f557bf3e767a53642`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57093cef7932b0c694a6ca2c021d56ba30d81725bf9af8123b046a8b64f82384`  
		Last Modified: Mon, 22 Aug 2022 20:04:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69689f121ed494c9c78d3889c41e625e182d98672b56193a6d966f96d7e65a33`  
		Last Modified: Mon, 22 Aug 2022 20:04:43 GMT  
...
```console
$ docker pull drupal@sha256:0f71b535a728f93c1bae34d7691b8b1c18bc35f4b22763a77c9f4597b6cf0fe0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51618423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cea941b0176ff036f5cf89d56ebd67e80a525876d034b08009c154a158bfc0ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:07:57 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:07:57 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:08:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:9472741940a8e842a89c364e9fd0aca4ac50fb49d73a02ea178d211b5c3608a5`  
		...
		Size: 692.1 KB (692053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab21fabdfcf6b5a53a5be7f270005128d7ffd6ad9c27ca578dbb51fe0cc38727`  
		Last Modified: Mon, 22 Aug 2022 19:18:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb0392460e1bb0922511b2c41f6dcfdf692e6fe0d95ed1a02d0413b7a3fe4884`  
		Last Modified: Mon, 22 Aug 2022 19:19:03 GMT  
		Size: 21.9 MB (21866819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:f6af7e73acf21e9bcc8a9c50a5dddd420a4bf00a30ebbf516863a06366492a02
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50463756 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45b6f81dadc7d69d60d39fc1068dc924f7fe58b6dadd618cfbace08fbaebb072`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:22:02 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:22:02 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:22:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:22:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b516ff837a2a83da621c36d580146e00222762d26a9259d3bf5d80de5f476b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27fe2f3adba3d1a7e5c8dc9377c0c988c97083d7d0b8cdac2f2a1633d55947c3`  
		Last Modified: Mon, 22 Aug 2022 20:01:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8154fb0ddbc398f0a550476fc13b24b33340617cec1894481126b438b6ac1b06`  
		Last Modified: Mon, 22 Aug 2022 20:01:21 GMT  
		Size: 21.9 MB (21866935 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:342ed294026f572da88d2439315642dbd7279d014537b53868dff04ed651af31
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53667925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:305729f5a837e8820f8120e06438b6510b910863bc3f4ca72ed7a29bda79fbb8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:03:33 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:03:34 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:03:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:03:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b97b71f6adc6a2331daa110dca642aad34fd6f1889b52309a226e0ab63406908`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aae4d3ef2a2d6961eb0d8a05f4bde68bac84d41e6ae88ecf85f3166ec4150406`  
		Last Modified: Mon, 22 Aug 2022 19:37:31 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e27977f7db91bce120ad61a8d6f4ccc2dd23c4754e739d770e876fe7788da65`  
		Last Modified: Mon, 22 Aug 2022 19:37:36 GMT  
		Size: 21.9 MB (21866897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:ccc4e688c511d7dc57af6f196e3f60d88e980e8d5eed4947a2305727822b9337
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (53953424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:118867812d7af3e8fc429f263ff9f4fc238d7a5ef436f5d55dd670e4c7aaeffb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:01:07 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:01:08 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:01:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:01:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d8b4dfd1431fac4013645f775dee93b2591c3d0ba3138fe1490f435fd379d618`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f21a0116c658ddef547b14cf66ac0f3adc1f08c1b82ecf1ca8a87b5efc0188e`  
		Last Modified: Mon, 22 Aug 2022 19:33:45 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a17929458a55758f8d552f7df1fd294e9fbd1e1c242f421ff063269cea6c4df`  
		Last Modified: Mon, 22 Aug 2022 19:33:50 GMT  
...
```console
$ docker pull drupal@sha256:0dc9dfadb5a2103ec07035e07d24af7465f5296ddf1509c443dc894e7e2a0632
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53698892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e69a2e4f56b1e44be338b113554c42e6d1c4189faf7561c033c3528a1e16375d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:492f2560badd3e7948bdabd67f1fa818a91bb7a47ae8defe18d87425bf55ad42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d40cb1cfa1ac4aaf799b50b10d075fa818681ec2679aa47682c12ead6e74d86`  
		Last Modified: Mon, 22 Aug 2022 20:25:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef53d38690cd27492457c43a8b1d4da00e57ba01789dd4b0d2d21abf41a2926a`  
		Last Modified: Mon, 22 Aug 2022 20:25:40 GMT  
		Size: 21.9 MB (21866994 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:72c01994acfded3416c015b1a5c263e9d15aa44b9690af9c40598bbe4c589eca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52349558 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:427dd9a38fa67ecb2fe69238f8186f5ffb39de4027b20e1827b699085d89d5ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Sep 2022 23:20:48 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Thu, 01 Sep 2022 23:23:06 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 01 Sep 2022 23:23:07 GMT
WORKDIR /opt/drupal
# Thu, 01 Sep 2022 23:23:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Sep 2022 23:23:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5a724a8bf7d20f6f30eebc4908e6c60cf8bc411f6fe26cfe24ad8e6f8b9c0575`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a12d3dfe0eec88ca65f493873aea5c6f930255bd8b87856e09765ea254250e`  
		Last Modified: Thu, 01 Sep 2022 23:45:08 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff51aad7b92afe7a38db5954d9ba67e93f0aa3a7332eb0571563142f799e6d2d`  
		Last Modified: Thu, 01 Sep 2022 23:45:12 GMT  
