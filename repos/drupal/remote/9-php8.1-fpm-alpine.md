...
```console
$ docker pull drupal@sha256:470574177ac102803c142f703531ee0441b9acc5c398458f49859a56285cb592
```
...
```console
$ docker pull drupal@sha256:146aa5ea40914c701f207ebb7b06cbc68868a1f2720803ef1e3dafdf95361d0f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.5 MB (57503689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfd32dd81d95087247030a424b59355a2348d5e618a529148a294a75ce6c885f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Aug 2023 23:28:44 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 04 Aug 2023 23:30:57 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 04 Aug 2023 23:30:57 GMT
WORKDIR /opt/drupal
# Fri, 04 Aug 2023 23:31:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:33febe25f7d9f19cce5915ced256d013536f6dd53ec825bea6207ee27f1e6c25`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57d5e1553816dfc5177da940d6f4236826fe81b13c8dce29e3b908268c3f4c2e`  
		Last Modified: Fri, 04 Aug 2023 23:34:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:148e32b5852cba8ae5e23e932a7808514fbd52445a27423c53290b40bbb50e34`  
		Last Modified: Fri, 04 Aug 2023 23:34:25 GMT  
		Size: 22.9 MB (22874286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:60f45f5634f65b08ac4f33648a40870945e027ed8fcf2d45994cf8fd23390e1e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.0 MB (56010627 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9ce3b81d6cc8a8d3606b2b6fef958e3c9cf655a9fe1ef81dcc5f3c83646690f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 00:31:36 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:35:34 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 05 Aug 2023 00:35:34 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:35:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:35:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:80fe2905ea551b1132a737cf68747f8a7fa6b9442c238874b02e964fc59ac467`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66a033cf24bbd5d6d2e1d43ca7a06c000fcde589b1e3943096e96201789c141e`  
		Last Modified: Sat, 05 Aug 2023 00:47:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3c765dfe9ee97978f77aff8889aa1921337c503ea86bf32f5ef8ce975b50211`  
		Last Modified: Sat, 05 Aug 2023 00:47:11 GMT  
