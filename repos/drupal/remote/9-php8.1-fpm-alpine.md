...
```console
$ docker pull drupal@sha256:98c53c0ea86de35adb573bb354562b857a82146ea83762fac46c9bf5ae6ed9f3
```
...
```console
$ docker pull drupal@sha256:efaa2777a7156786a6a851cbf8a552fa39aa4489ac229773810c22188a566324
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.1 MB (54093789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab6060161efef491389e73639f0c25f914bcfa486aa48645e0e69cb648a6ecbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 07:36:06 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 07:38:45 GMT
ENV DRUPAL_VERSION=9.5.7
# Tue, 28 Mar 2023 07:38:45 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:38:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:38:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4bad98de951e2b71249d6e970cce59431a9314a9cd4919fb9f0b31152add2f01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:577f47390040cadacb05dc8d9386f7e94607c0eead123a95795e81a5cc9b6184`  
		Last Modified: Tue, 28 Mar 2023 07:59:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e468395d1247d5c21139b9c1541c17e659bd49ae6c498a8f494830e131a691db`  
		Last Modified: Tue, 28 Mar 2023 07:59:21 GMT  
		Size: 22.9 MB (22856945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
