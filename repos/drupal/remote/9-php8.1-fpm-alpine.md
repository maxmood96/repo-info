...
```console
$ docker pull drupal@sha256:3fb978b8ed7b5e5e372fa5e43b82d2b400e26f0e0aa808c6884bbd48351bd641
```
...
```console
$ docker pull drupal@sha256:8fa29d51a64ed104a2b86e14ebc802d1303bdc1b15ffc8615c724ca3fb74d21e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52359061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f499e62c66a4446806c5c1169a706465b0af4fc3d8fac0d4818b19c6d1bd7872`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:17:46 GMT
ENV DRUPAL_VERSION=9.5.7
# Fri, 14 Apr 2023 20:17:47 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:17:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:17:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c19aa21e13e27fd75f6d112c899e7fe6f765e5fdcaa56ed3141c4a0e68eeb399`  
		...
		Size: 697.5 KB (697529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f911f658a9a13e2f20596230bd9a79e65cc9f33f140f6e6c05f0728acfa9579f`  
		Last Modified: Fri, 14 Apr 2023 20:31:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79ddfd6ed0d27f9bbc84dbfe7611d60af6aca95287e585cd13a879caf573bcfd`  
		Last Modified: Fri, 14 Apr 2023 20:31:25 GMT  
		Size: 22.9 MB (22856798 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:82eeebe5b275e2c0862bcc9a1a33f14701bc751ae17bde5c9b325ffc7eaee6e4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54202886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cae5746a072298c7dc3d1de5c9dcd1adf68d5e796375fd88aaf7c47359cd847`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 14 Apr 2023 20:11:40 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:49:21 GMT
ENV DRUPAL_VERSION=9.5.8
# Thu, 20 Apr 2023 22:49:21 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:49:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:49:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01d7694b0856a4fdc4ac5455b64e6dbbc573b07678f071e7e64fb92598b2b18b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca2162cd391081d326ecebc44cd180689c3bfb4de03afc6775efaf0a6840b05f`  
		Last Modified: Thu, 20 Apr 2023 22:59:07 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cc6faff1f0cbc43bdc804e0484173feb9cb9ff984db1936357634cdd8cf52a2`  
		Last Modified: Thu, 20 Apr 2023 22:59:11 GMT  
		Size: 22.9 MB (22858259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
