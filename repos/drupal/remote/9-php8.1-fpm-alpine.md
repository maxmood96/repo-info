...
```console
$ docker pull drupal@sha256:da2797bf1d4ca3710cf0ad90b6a4a6ba0a49bf8ff4576054bbd0cd33fe7bfa5a
```
...
```console
$ docker pull drupal@sha256:3f57e309f440f1442b84f3d509db7f4ce65ae333662d895061f2ef3e137d3d12
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.7 MB (56697261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9870ffc70b9ae2f13c3814f58acd1258e3dd5857c16dc8c8b45150fd4307154`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.5.10
# Tue, 11 Jul 2023 03:18:14 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 03:18:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 03:18:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8d9809b9b0741ea19224a096d033779f5cc694b706eb82bc40c5d09126473d77`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da233a4f7d68dd2758c2e1feaddd089609780340a5ccab53e93894c2e569996`  
		Last Modified: Tue, 11 Jul 2023 03:36:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2cbc40df1cc2ccf498118500667ced779e463a5a456780253ddda1ef405884e0`  
		Last Modified: Tue, 11 Jul 2023 03:36:57 GMT  
		Size: 22.9 MB (22873893 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0a84f7ec95179efc44db8822ff2e5d1138839d790a1163cc6409f52fd627f1a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.6 MB (56609094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:324ecdf0761b9ff21292ec8478088565849ddb9981727bb2d1bddb63455d9d47`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 02:32:03 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 11 Jul 2023 02:53:38 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 11 Jul 2023 02:53:39 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 02:54:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 02:54:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:45a01bbb67816d57015c79f2c0d74563d016d2ffdc23904df83f5de7167c1f9c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7793275dae47a7facf2b3f7c11cb89ecc789679b1d2ff15535fdfb63a0d1abe`  
		Last Modified: Tue, 11 Jul 2023 03:39:12 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e83de8c7a760f62368f7a355cbaa4794d97e38eca6da24a629b7e39199ecd837`  
		Last Modified: Tue, 11 Jul 2023 03:40:01 GMT  
		Size: 22.9 MB (22874172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
