...
```console
$ docker pull drupal@sha256:13c5fc3fce2d9219077fa3bbf034a382c593fddb72c0a4df4a4233243d5283a0
```
...
```console
$ docker pull drupal@sha256:7e4a6da44ff351117eca3c3b64386ceda897548c5b7e67549409feef463055ea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56415221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bf738f511e94d13ef787f36a4eaded6cca9c22033799fc0350488aca1b266ee`
...
# Sat, 02 Sep 2023 09:35:09 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 09:35:09 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 09:35:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 09:35:21 GMT
...
-	Layers:
	...
	-	`sha256:1b25a498de059b9d853367c2aff15e30aa4d6100fe1fe6c04210a8002dd802a7`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25f9a20fb65416deb2a7e8603ccb5d04ba7b96089858f77afcc007f0aaa0b904`  
		Last Modified: Sat, 02 Sep 2023 09:44:26 GMT  
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a583a2fb7f2167ec738fbaf776e6feddcdb8c37fb7e4f7d310aadab8058bb5f6`  
		Last Modified: Sat, 02 Sep 2023 09:53:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cdbc3057d04a6eef17ae79f2ca5166f2fe8c84378caeac453db9936e4160e34`  
		Last Modified: Sat, 02 Sep 2023 09:53:33 GMT  
		Size: 22.9 MB (22873444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:186e3ffac7a485b03634d101d44e85417e315a189b241d21acfeae99451dd630
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.5 MB (56466126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e49be6ed75feb752c7406e60a24ab0459c6d312f3358fd30199ba268982052d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 08:02:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:02:18 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:11:04 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 08:11:04 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:11:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:11:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc74c871907c16fc9b89105a39bbcdd3783e68d94e22b3384e14e7e4d141ba46`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77d53f4c4eac56023c66b82c6abaa645478154b659568c84f71a48356ec1433b`  
		Last Modified: Sat, 02 Sep 2023 08:21:38 GMT  
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdbcc744022e3f085573de0dbcb09a0fbd93759f05da59e05e4c0b8ee2cf0baf`  
		Last Modified: Sat, 02 Sep 2023 08:33:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dbff27b4d8207e2d2a9870c13c5412e748f209e096e3118ef762e662e6ab7de`  
		Last Modified: Sat, 02 Sep 2023 08:33:17 GMT  
		Size: 22.9 MB (22873096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
