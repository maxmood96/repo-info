...
```console
$ docker pull drupal@sha256:6dc8060828a23f5f1021897347456b22144e6ede425eae34c177482d3b23f0d3
```
...
```console
$ docker pull drupal@sha256:576e6283e920603436c523068831cd51217d5bab3eddfebd02b425fd12d844a6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52139932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52d205e13653e5b6babcec3b06068b335df06c2cc9060927c34efaefe7eb2db7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:05:37 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:05:37 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:05:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:05:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c15ca872aeb920b746fb949df445b8a5be5a663a59ab442a5871e27714c0da3b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b0997242a9f53f2b2762a1ab53b3274c5eb642e405636283ddf0f762b97e7c0`  
		Last Modified: Mon, 22 Aug 2022 19:37:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ab1c9228ba0c13646b26be451ac37184c52d73f8b0d094471f5340db9ca745a`  
		Last Modified: Mon, 22 Aug 2022 19:37:47 GMT  
