...
```console
$ docker pull drupal@sha256:89beb7f343d1706262b6d32a543231688dcd6a5018e69a0d7ada0120c99a39b4
```
...
```console
$ docker pull drupal@sha256:6d7d0b1eb50535b7e00b308f3cfed47ba3eb08c051f17fac700fcef1c00f157f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54212298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b343c4413cb1caff57398e72c01fc32a375248c1efc47f01249bd240484f00b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 13:41:55 GMT
ENV DRUPAL_VERSION=9.5.7
# Sat, 25 Mar 2023 13:41:55 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 13:42:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 13:42:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e6c9ee8ac7d93abcc229c63018bc9687f8b43237fc4ec72a28c2373ce4ebad4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7908fb0bba1cef5b56029a7a4cbc4ef507ed7c418cd3eb4311b0c8c4fe99aa09`  
		Last Modified: Sat, 25 Mar 2023 13:50:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f544061b55e9fdc03a5a40902c1bab3e79ed93664350dd372ea6df29ae28e8f1`  
		Last Modified: Sat, 25 Mar 2023 13:51:01 GMT  
		Size: 22.9 MB (22856743 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
