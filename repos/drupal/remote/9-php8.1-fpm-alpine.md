...
```console
$ docker pull drupal@sha256:5bb62f730399b357bb8d01f1be8409c85b8fc1dcac92698da68ad0022d563b6d
```
...
```console
$ docker pull drupal@sha256:1fa9955ebff9db8952c311efd126f5b9ff219a71d3a498b2e96b8f1ddd177bf6
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50886657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7911c9fe1e1b935a31869239172a6168334f0bbcd7bca81c7c3a445bb87f6fa4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:38:54 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:39:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:39:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0ed36ac63ff7e577a76c83b2e3b86dad01630af49af1f49f43abdcf16d5cfec6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c6b771ea03fe32adc92e9154b429967837748ea3228382ff1ec51a22f9b7dbf`  
		Last Modified: Tue, 29 Nov 2022 07:18:16 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2142bf4018a7d83ce0e1c689af7e0de6c8cbaab049b3eeab59c0c2f16a7a89f0`  
		Last Modified: Tue, 29 Nov 2022 07:18:24 GMT  
...
```console
$ docker pull drupal@sha256:4262d2444f0eab412ed41ff0a8e6acdbf08b33e8afbf95cb6785f573fba283fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54152612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8bb8a1e27771fc2596acfe96648d846df328a4e8aa638b21a6d2f458ca41775`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:53:55 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:57:50 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 29 Nov 2022 06:57:50 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:58:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:58:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:760f83a2a8f067de41b396954b44d9252ffab3568fc13331e157c380149db397`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:580b70b33006304fced0d513793dad79c95b1ad1a4f9585524a870f29aebe281`  
		Last Modified: Tue, 29 Nov 2022 07:29:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bd2c6e83776b09d29cfac07d5d5f5e318869e0ae52b8564dace937dede7250b`  
		Last Modified: Tue, 29 Nov 2022 07:30:10 GMT  
		Size: 21.9 MB (21897657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
