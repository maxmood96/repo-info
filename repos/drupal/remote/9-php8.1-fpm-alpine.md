...
```console
$ docker pull drupal@sha256:0d008ba45e5699554363f9b4999502b6efb648f54e9aa5b0e1f6ec513089e397
```
...
```console
$ docker pull drupal@sha256:d7969814e7cbe5d57cf34de4fbf16d59116d17a55639438b35e1b2e954355c3d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50262439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdb164fd3870bb18de6de97adce8a510d32489a965da7c53324a0dbcd6b054f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:05:08 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:08:29 GMT
ENV DRUPAL_VERSION=9.4.4
# Thu, 04 Aug 2022 09:08:29 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:08:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:08:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b824af9a67013f89ccd77575e5c128aa4f70aa1c18b2786fcdf65019479f1804`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e49f86982abb6671d85c76d6b69d7fdefd0209e35697ae7a6e4c52cf36a90b0d`  
		Last Modified: Thu, 04 Aug 2022 09:55:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95b223d395dd13becf484048727c87d776b8a4c149dac2abbafd58d1ba98a699`  
		Last Modified: Thu, 04 Aug 2022 09:56:00 GMT  
...
```console
$ docker pull drupal@sha256:db7c90bc8c57e3668dc8b3081dd6ede56954f7a0888e125e1ac7aea387b06432
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53489191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:210539238289adf26a6254f3670fde939f00d8c287df1f7fc9fadf2267a74841`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:04:50 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:09:27 GMT
ENV DRUPAL_VERSION=9.4.4
# Wed, 03 Aug 2022 12:09:28 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:09:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:09:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bcfcd8c14a26005b8d4738e7771c2b770b208b4780ae39b16d8182b50879b6e9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5f6ed8185970b66e373a5d9fc1433b9b685c6e17ec210946d42aff5022bce43`  
		Last Modified: Wed, 03 Aug 2022 13:07:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86e5592c2e531641e01fddfa0ca8cdeca0f3f1dc3d078c834bb4d7c2e5219e9f`  
		Last Modified: Wed, 03 Aug 2022 13:08:14 GMT  
		Size: 21.8 MB (21758230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
