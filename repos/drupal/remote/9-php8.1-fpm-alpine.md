...
```console
$ docker pull drupal@sha256:53099cd3f88b89385dcf33ee595644c55a2464671d39c4f16f58d84e847659a0
```
...
```console
$ docker pull drupal@sha256:70e93f0bf60ac0ddb8548573fadd9f8b80160d6fd226dbbcb9e62c7dac6ed98d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53266825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36da2f9d90822caded1d67d2337ee7612be6741503bfae85fbb47bb047b25250`
...
# Mon, 25 Jul 2022 18:44:46 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 18:44:46 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 18:44:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 18:44:58 GMT
...
-	Layers:
	...
	-	`sha256:f7322f38cf6fc348836e43135d50fc0f6035321f22d4cbd5bd25fb60dcc5b7df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcf23a0b405a0cb40d33b3ff28a905d7946d72df93421b75e317041e40eb7001`  
		Last Modified: Mon, 25 Jul 2022 19:05:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6f15762ece3f1ef89a862fd22bc3e56d0decacaf9226058c67d6075a476c8e7`  
		Last Modified: Mon, 25 Jul 2022 19:05:20 GMT  
...
```console
$ docker pull drupal@sha256:27f9b1c583bd250f3284ba71d94b59670b6c465e8d05058ff9e000f8907d780c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51399300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ad467d99b84c12e515892b2b06cea4dccb72659d499d40f259c2518141611ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:12:09 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:12:10 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:12:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:12:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:56df0ff83414ad3c397ffdb73ba442625862c92e407ab157bea978db8c994e2f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47ce317a6b29000e3daeea09cbea39c05c36b9c18fb62ed76c26f54a5e5f2b13`  
		Last Modified: Mon, 25 Jul 2022 19:32:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25f5756fff8fb10f5261b76e65ad07523695908636ad65f35e1af3162436959b`  
		Last Modified: Mon, 25 Jul 2022 19:33:19 GMT  
		Size: 21.8 MB (21757570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:3c3fc50970584abb8bcec662466effed7be312c0936c298bd3e7248bcf088c1e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50247149 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3763115db917153ada4dce0a50f93535170620fa4ce90ac5892c2503c33b49b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:35:12 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:35:12 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:35:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:35:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cc7b8a4ef9e6bb0bceac77c681d20f30b1865f73f658072051c909df6839a74b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96cd07dfc1fceb22c112de38f8136e90459b735bd58f6213216b1d885b41ed3c`  
		Last Modified: Mon, 25 Jul 2022 20:44:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5a7d474d8aa9ac12807cd2d93187ca930308f9e7ed81e32eb4e31555f2a91bd`  
		Last Modified: Mon, 25 Jul 2022 20:44:39 GMT  
		Size: 21.8 MB (21757575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:8100d5e15e4bb7e9f3892aeabe3b84614828eb1c3ba11f02afa931acae86d054
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53446264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:843d2c2b93fb6a5402c9bdab7eafb2f5ffd3ac9a16840a5219fd03f9bcb7a820`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:06:53 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:06:54 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:07:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:07:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d3778db1f7cbafac41fd5edce5ab11d6856e57cc6d515ba3a3d149685d56cc73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58efaaee7c297f20964f0dd445b85a841a70a81606464a1defe4fb7529175399`  
		Last Modified: Mon, 25 Jul 2022 19:40:05 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5dcccc532442f3d58ae69af3d38b1a1309a5b9c407c5e29c1ce997f472280a3`  
		Last Modified: Mon, 25 Jul 2022 19:40:10 GMT  
		Size: 21.8 MB (21758287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:580185b08835c05acabaddca2c9d8d5a69b63a54dad71d8a530f91cb872d255d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53738191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff7661d7137f4e281f6260980ee7879bcd2d6555d285facdbad04f8d01a584f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:00:53 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:00:54 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:01:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:01:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:059b7d218bbbf41f78bc126a4227aba8039ac470875a64180966c22b4e47c9b2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d2e268ebb6b0054c6f84180b4a25d7f22b8a6ac68a150b4557c7b80b611bded`  
		Last Modified: Mon, 25 Jul 2022 19:32:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2d339b2afb2ecc084fcabcf5e252e529658113fb4493fc58d8cf7f028a1504b`  
		Last Modified: Mon, 25 Jul 2022 19:32:36 GMT  
		Size: 21.8 MB (21758542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:3b2ff9261c3c6d1ca7f9a04cd234a88400e4ec568a712b1b9d1c27a308d24b64
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53475590 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75e0f81f2b90f37156af6335ce50ebfd70c112793925708b631ce98fc499fe88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Jul 2022 23:30:24 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:30:26 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:31:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:31:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7a7bf7d8dcde37f7e2bf70b4d07ccdd556fc8b5c6df95e42494de82930f28832`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e02092c46b7170863c6d5eac877f918158c83f6c3096e3d9ce2c340522832e0c`  
		Last Modified: Thu, 21 Jul 2022 00:24:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9658dd63d61b17b4565077e498e2025978c07cc6f23320809296e77acc7d93ea`  
		Last Modified: Thu, 21 Jul 2022 00:25:20 GMT  
		Size: 21.8 MB (21757978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:6cc1a4e47929dc85ec05429ce1246bab7c09dfafe26257e0d3178a895283b894
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51921978 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f96ba8accd5e4a6bc57ca7adfee6d4197df4f611e3d86a075636200f91aa4875`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Mon, 25 Jul 2022 19:08:03 GMT
ENV DRUPAL_VERSION=9.4.3
# Mon, 25 Jul 2022 19:08:03 GMT
WORKDIR /opt/drupal
# Mon, 25 Jul 2022 19:08:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 25 Jul 2022 19:08:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8f20dc670979c7afcf3b8e8d36cb429619be718d43d63e1c4917d1e63b256eae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e8479e688210e904fb1582eb3df5c0219bbcd23124adb3a4d80c3fb8a40490c`  
		Last Modified: Mon, 25 Jul 2022 19:48:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cef069d31544975a9041985a31df74ce2a178edc3d92a91b3439c102472baa31`  
		Last Modified: Mon, 25 Jul 2022 19:48:57 GMT  
		Size: 21.8 MB (21757429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
