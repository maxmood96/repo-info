...
```console
$ docker pull drupal@sha256:022cfd80724d051c4c0b4cdf907cecaf6175fff436c203c981dff7c9b32c0f3d
```
...
```console
$ docker pull drupal@sha256:80742b60b059ec8ab9dfc1a948b81d0d5c074c054b152c31bb731b84867f22dc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53147275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccd9b352459a8468d6ab765a6884f594116a412afb838e912ba24e53f9f56a41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:24bf6e4ff958bf58ae126804a93affdbd6a0bf41615cc91af3f7538a88742dbd in /usr/local/bin/ 
# Wed, 24 May 2023 23:20:41 GMT
ENV DRUPAL_VERSION=9.5.9
# Wed, 24 May 2023 23:20:41 GMT
WORKDIR /opt/drupal
# Wed, 24 May 2023 23:20:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 May 2023 23:20:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0328cb3bb88660847ef95acd726540b2aef4f68791a7d918f821cf2dbadcc2e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:679d414c1dd8a7acd6b68acb2fb43c280a73b26aded131ae45969d0016ab4b8d`  
		Last Modified: Wed, 24 May 2023 23:40:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f268212e188abe50a65c07f29897f2e172d2516701114f5ad535becef07377d2`  
		Last Modified: Wed, 24 May 2023 23:40:57 GMT  
...
```console
$ docker pull drupal@sha256:c8200e2d71bcf593b96777dbef0d6974ed83ebd45d5c781f5779f37c1f087d6a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.7 MB (56659725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efc6f04c37dde223172b0de1a1d33e91e6cc8435e7a80f516102aacf54f38480`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:24bf6e4ff958bf58ae126804a93affdbd6a0bf41615cc91af3f7538a88742dbd in /usr/local/bin/ 
# Wed, 24 May 2023 23:17:48 GMT
ENV DRUPAL_VERSION=9.5.9
# Wed, 24 May 2023 23:17:49 GMT
WORKDIR /opt/drupal
# Wed, 24 May 2023 23:17:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 May 2023 23:18:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8ea3dc07723bbeb5e318cf519f7aa7b4d53b7222566469289309ab12f2e912c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae3addee0122c075deb292e35d7fe1dbf5b619434ca1053d8f86b76fd206124c`  
		Last Modified: Wed, 24 May 2023 23:33:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ecc60b211fa131ff2788d95543b3975eee5ab45e2d1e1b2e0c9d3ad6cd0bc18`  
		Last Modified: Wed, 24 May 2023 23:33:59 GMT  
		Size: 22.9 MB (22862547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.1-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:2d101c2d6605a0353cb01c7c6644a73b111bbb0c2a575b387ca912a7e6393cbb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.4 MB (56427653 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:415cef0d4b477aac9ff6478f96da5eeec91b29beb093fb78003228e8fa5f2d56`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:24bf6e4ff958bf58ae126804a93affdbd6a0bf41615cc91af3f7538a88742dbd in /usr/local/bin/ 
# Wed, 24 May 2023 23:03:18 GMT
ENV DRUPAL_VERSION=9.5.9
# Wed, 24 May 2023 23:03:18 GMT
WORKDIR /opt/drupal
# Wed, 24 May 2023 23:03:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 May 2023 23:03:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6d591f288c5b910a9155ddd614a126781d74766b214b73277c7b90fe4dfb8c7`  
		...
		Size: 698.1 KB (698149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb46c52de9846380643d8139152f27fd28c8e3e0514a6207955cba69a0da0625`  
		Last Modified: Wed, 24 May 2023 23:21:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c3b4cc9f71c64d38dac167afdcb063122c4c8fcc515d135de0fc6d77ea0752c`  
		Last Modified: Wed, 24 May 2023 23:21:17 GMT  
...
```console
$ docker pull drupal@sha256:44d11fedf9fbac7a96cb2b54ce78031797737124b3a43fb248223faf00a3c507
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.1 MB (59053738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33eba597dfb24683721daceccfef3c97223624d36b16c9c168bfde980b528ff9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.5.9
# Fri, 09 Jun 2023 03:05:55 GMT
WORKDIR /opt/drupal
# Fri, 09 Jun 2023 03:06:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 09 Jun 2023 03:06:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:626052c7134feda3c2499c410d0c68ef847ea57097df2a4922e7ef9172bae836`  
		...
		Size: 698.1 KB (698149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:254fd56f2d44f1c493fcd5ba0a858ffe150c706f53f6cd8be8f659dda0bdcba8`  
		Last Modified: Fri, 09 Jun 2023 03:28:03 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f9fe5d350cbf7b19e6a1494921bb8a63a600f303305b3111957da1c4177da25`  
		Last Modified: Fri, 09 Jun 2023 03:28:25 GMT  
