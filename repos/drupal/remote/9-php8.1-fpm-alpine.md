...
```console
$ docker pull drupal@sha256:0e60aec33c6b9f2a76bdf8d21a62751b56ace05c5e7bc50e386f3caff0086276
```
...
```console
$ docker pull drupal@sha256:96a00180a93d8e25c93fe49bf70da581d3666c625fe9ff4709edefe28d4f91d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51589550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bf7592f85bc91e6a552335334398c02fe105fdd5af29aeafc084c20c8e2f4b6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 04:29:05 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 04:31:05 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 04:31:05 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 04:31:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 04:31:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2502431d29ae2c8c7d8b8f89c8c20c0a886cf68ec97d13f2c04621c7490a0828`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0f3e609853a3c0896d761d654a2c439c1018e877be99a061e266ad025c10f62`  
		Last Modified: Fri, 05 Aug 2022 04:49:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55e73662b233dc0d7bd2a1c2a127ce1393dbdaf9cb90159686f5a43f5644d392`  
		Last Modified: Fri, 05 Aug 2022 04:50:13 GMT  
...
```console
$ docker pull drupal@sha256:d96faf2f17f030fdb56f72b75dfacdf78253125da74a2d8e1d487a93a705e82d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50437303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec4ed6fa826b528663031141230494c5fd49d02c2466bbcc1ce5d66a15f3212b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 07:47:36 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 07:47:36 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:47:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:47:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:75cb3189c062802628b7f2c328c90759b34cf488004268aecdfef39203b8e19b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02b3557423dbc7647aabc90c237cd6b5346543452ef35568764d7003023558b8`  
		Last Modified: Fri, 05 Aug 2022 08:27:15 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7ecb00c2db5b712b7f9528602ec284e44bb64d145900ca48f11bee184faf5d4`  
		Last Modified: Fri, 05 Aug 2022 08:27:28 GMT  
...
```console
$ docker pull drupal@sha256:fdd3f1191ad93d71c8b2aeb8cc0f6f5b13c790af5fddc3c0f1b55a5073b3fb5e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.9 MB (53931707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28c952745cb4b3f9ed227da9dad9a2763fb872efba4e0005d01cf5bb35eea215`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 10 Aug 2022 01:41:23 GMT
ENV DRUPAL_VERSION=9.4.5
# Wed, 10 Aug 2022 01:41:24 GMT
WORKDIR /opt/drupal
# Wed, 10 Aug 2022 01:41:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Aug 2022 01:41:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73875f8853e9dc96cc9494f68c3ef1031f7b7664986b08df4dd500e9a3607805`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e0e10f7529198eff6993452c62317150224ea62146956ebebadd19ca0026025`  
		Last Modified: Wed, 10 Aug 2022 02:06:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d63b2fb1c4b79d158863ad234a46380735c630f015cecc1179bb8aac0c7845f5`  
		Last Modified: Wed, 10 Aug 2022 02:06:46 GMT  
		Size: 21.9 MB (21866856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
