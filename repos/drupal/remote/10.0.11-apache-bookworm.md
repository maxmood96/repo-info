...
```console
$ docker pull drupal@sha256:6b0dd364a3a0303aca8e7aa094ec48ad5f6467c099c5a08748a78d7475ffaee1
```
...
```console
$ docker pull drupal@sha256:4bd74421ea8e7b3013ed7e0bcb8148d98386ef80f4d55120802901cf2f669d94
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202591895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67e8ec1ed5ba89010181acc86d090b1117da95ae95a4e80e9c8b53285bbed0c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:37:55 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 20:37:56 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:38:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:38:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9011d10cf7ec06c0f9cdd52876f25a9960f4c8bda7bb3c1566268d1a2e3e96f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7733efea8c320112becaf06f6804274b56cb2e6f3c6c79104d745b63c5fd119d`  
		Last Modified: Fri, 29 Sep 2023 21:11:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92a405eadb2c0684474e4ca613fe961e0f6ebacc60890eba4fe75e6b451da1c6`  
		Last Modified: Fri, 29 Sep 2023 21:12:16 GMT  
		Size: 17.7 MB (17697162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.11-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:aaac6ad8ddcd5ddb9b024ab633d48941a5175d4ab6e51cf441a231154b68f1d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171390562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b6a73bfcd216e31631d47231d95e70aba0db611adf0165d117e4ce87735f896`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:52:49 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 22:52:50 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 22:53:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 22:53:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a5cda24cff1f66f8e3db4e42eddb7175c8d84fc977b19e202d1927df33b7e0d4`  
		...
		Size: 704.9 KB (704945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaeab43bfedc1ace0dfbb4e3cdb79c86adb395cde1061388666a4fe0eb96fd6b`  
		Last Modified: Fri, 29 Sep 2023 23:42:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:575baabe3db618dfa5dace079c53eb9a067b1765aa8c1641f6837b328167d7fb`  
		Last Modified: Fri, 29 Sep 2023 23:42:18 GMT  
		Size: 17.7 MB (17697078 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
