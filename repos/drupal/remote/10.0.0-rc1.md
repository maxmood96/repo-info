...
```console
$ docker pull drupal@sha256:8a8147132490021de51dcdf3025d9ab3016f55d89ef52928bb3279a974df39bc
```
...
```console
$ docker pull drupal@sha256:a6920e43eaf58843fe68f0466e39ea43aa988c6c314b77684693b960d7f12914
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185929040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6744aacc39140036d7ba3a96d678f608f28ca8568ae6f3614cfdb1832204401a`
...
# Fri, 18 Nov 2022 01:23:12 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:23:12 GMT
WORKDIR /opt/drupal
# Fri, 18 Nov 2022 01:23:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Nov 2022 01:23:25 GMT
...
-	Layers:
	...
	-	`sha256:ee37dae5a91b083cfab2b7aac75fe328becfde58bdcba405f75e72a0be529637`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed50ac845aa1975c72e057de02cf52177399891c1124bab752ae31b3db80d28c`  
		Last Modified: Fri, 18 Nov 2022 01:31:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:157d8ed7ac0e63df5e595c6ce3a931a1ccf6873996a9e663e68c09f79ef600b2`  
		Last Modified: Fri, 18 Nov 2022 01:31:50 GMT  
		Size: 17.7 MB (17665982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:eb431bb5407a32d1d59cd5373c69a816a8c34ebdee5b4503b264393c6640e227
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.1 MB (180120738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01a4b8a859b477fad568466ad8bb84aa8c14b6ed63ce559383755e6b2648b140`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 18 Nov 2022 01:42:27 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:42:27 GMT
WORKDIR /opt/drupal
# Fri, 18 Nov 2022 01:42:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Nov 2022 01:42:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:201031906b2088293d8dac69108794d8099d6ca1980f3f31af717776cd17cf7b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2dc38b7c92102f1b1ff54b654c9be8cd477352a7d88843a6aa7b31f0057f9ca`  
		Last Modified: Fri, 18 Nov 2022 01:51:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49d4057c41c2847bf5fcfe1fdf89bd8e248fab8a2e1c3bfcd1983a6ea8a56911`  
		Last Modified: Fri, 18 Nov 2022 01:51:51 GMT  
		Size: 17.7 MB (17665903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; 386

```console
$ docker pull drupal@sha256:ac2fb9fd7a05e9a9c03b44ab570d1b38245d508856f9dd96c19e115bafda5a17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.9 MB (187916952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b186172f5f48a8bcda8be0eedbe714d22cea13ed05bc12d76cb941778716f150`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 15 Nov 2022 18:38:25 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 18:38:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 15 Nov 2022 18:38:28 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 18 Nov 2022 01:43:31 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:43:31 GMT
WORKDIR /opt/drupal
...
-	Layers:
	...
	-	`sha256:cfcb2b029c0e9be6f9ec52ca5ae11891bb38091d19f370e31322618bccbfeac5`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:294d89c843667a563f95f834e9ca0819873fa21dd5d287eaf9b2d6a90e4e5046`  
		Last Modified: Wed, 16 Nov 2022 22:37:41 GMT  
		Size: 2.0 MB (1987172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a55767de1cae4649febf661652ef7a8558c7da370d7829a987b3701e2d0e3329`  
		Last Modified: Wed, 16 Nov 2022 22:37:40 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e65a046f1d3a137a4391f13642ce1b6e922ed0cac427730eb4575309ca3a5b02`  
		Last Modified: Wed, 16 Nov 2022 22:37:40 GMT  
		Size: 695.2 KB (695190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f79251c90eea31d9d684b0de642489c5a99336ec4e5498997649eaeac586cab5`  
		Last Modified: Fri, 18 Nov 2022 02:02:18 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:489f30c031eca65fa6966b0843ec5392656f3658c233637f12ada5c82bee81bb`  
		Last Modified: Fri, 18 Nov 2022 02:02:23 GMT  
		Size: 17.7 MB (17668042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:c18468d7f0ba1daf7a6f60971e7102b99151c7dbe5df8cd1c3379e893a596cc0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.7 MB (162707358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:651b1c7f5a908da0d01333fd6dbb01f1fc81a237d378b88dea02b53712abaa48`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 18 Nov 2022 01:44:45 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Fri, 18 Nov 2022 01:44:45 GMT
WORKDIR /opt/drupal
# Fri, 18 Nov 2022 01:44:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Nov 2022 01:45:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7e0737aa6105bdefe8e6760fe85bd91805200c07f010c91cfeafad6ee187cd5c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fadd597bb0db97af73b12e8529136115c650cdb4ef11168d1a18c954da70b5f`  
		Last Modified: Fri, 18 Nov 2022 01:59:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71271ad1b0e0aed76694a89d1dbd1b4610cc6ee0220f7d811d3a42e9eb840719`  
		Last Modified: Fri, 18 Nov 2022 01:59:26 GMT  
		Size: 17.7 MB (17665889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
