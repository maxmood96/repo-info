...
```console
$ docker pull drupal@sha256:1fa0f79ec6f46fdf4abe683f599cc74c0e5c8ad4dfbbe7c8943446a852eea413
```
...
### `drupal:10.0.0-rc1` - linux; amd64

```console
$ docker pull drupal@sha256:f7d4f70ea9196b9ad1c9040a6a56ee1fc39487c1bb4695ede5ff083718b13980
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185995964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6847a23bf280000b662f7a915b1e7ebc3c1413f013c141b5fc11a5d6fbce7774`
...
# Tue, 29 Nov 2022 04:46:56 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 04:47:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 04:47:09 GMT
...
-	Layers:
	...
	-	`sha256:0ff1edc4d072cdff50c31f427cffd4670da69f935a98b841115433037e9abfd0`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c261436107e4eb367b75e50379e53dfe580fd243a6cf619150dfb8ed995d13b0`  
		Last Modified: Tue, 29 Nov 2022 05:12:25 GMT  
		Size: 2.1 MB (2138273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6685caae9fa1d818b839e9a6c5cf44b2205781d16965ff4d44d53bdfd20c4e0`  
		Last Modified: Tue, 29 Nov 2022 05:12:24 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07e7e47f3b75ec7d0e424434d78a060a46af1646368583094cdf03db9626ba8a`  
		Last Modified: Tue, 29 Nov 2022 05:12:25 GMT  
		Size: 695.2 KB (695196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780fe1d7ce40c9937ef0981d5001330dfbda5f54f94d15d4765f700f195e0ceb`  
		Last Modified: Tue, 29 Nov 2022 05:12:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcb9b664e6b073fc057226aa3d596d3bce912f53f9a31cd9f3aa619696f6c52c`  
		Last Modified: Tue, 29 Nov 2022 05:12:29 GMT  
		Size: 17.7 MB (17669207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e28b21ba1308c7ab69e7a5ead67a43a00f728f9fcb861c3ba2e21be904fa0bd0
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155460962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86caefbaf7ed52ee548825029b3e1b001ffb82354b5d270f1fc1163909086c73`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 03:36:40 GMT
CMD ["apache2-foreground"]
# Tue, 29 Nov 2022 06:30:52 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 29 Nov 2022 06:30:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 06:30:52 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:30:53 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 29 Nov 2022 06:30:53 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:31:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:556c2ace849c24d328a557e6045d91ca847e0670d0020b79818810bc37e2dc01`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7906e002251c7494957cd231dd59b7f4776cb7db1b74ae120e7f3aee72139f81`  
		Last Modified: Tue, 29 Nov 2022 07:10:56 GMT  
		Size: 1.5 MB (1515100 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:900bb10574887e20d33ef6715c41bda8ad9819eb30d3e164d6483dae8142a425`  
		Last Modified: Tue, 29 Nov 2022 07:10:55 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a8ea6ea3e67a86ba04e25bae469857072f4d3fd7b3b08a76a32daaff5709b4f`  
		Last Modified: Tue, 29 Nov 2022 07:10:56 GMT  
		Size: 695.2 KB (695190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46d8f69120fbf69774780c25780bfd4869f96c9219a3443511e43e1795b5ed7a`  
		Last Modified: Tue, 29 Nov 2022 07:10:55 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49209ac7dbb320744ac670995eca97f335c2dfbfac8be4b2367c848ed421df58`  
		Last Modified: Tue, 29 Nov 2022 07:11:02 GMT  
		Size: 17.7 MB (17668376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6fd7f7bc6ee16d2b6deea2709f21111f171ef9585eb339790b50d5816fa2d8e7
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180180819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a42148658516cdb116d07eedc86f1dad34b30ce1d4e72c908e5c0ccf90b71453`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 02:48:18 GMT
CMD ["apache2-foreground"]
# Tue, 29 Nov 2022 05:49:08 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 29 Nov 2022 05:49:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 05:49:09 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 05:49:09 GMT
...
# Tue, 29 Nov 2022 05:49:09 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 05:49:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 05:49:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bd5fc3f7a96721c8144be619d809017709596f083ac81c45ba46eb80afdbc1ae`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cef4ffc6c00d4a3930a6c282bbf8a182884ba8e830697dac30084c4ddcb0df1`  
		Last Modified: Tue, 29 Nov 2022 06:15:02 GMT  
		Size: 2.4 MB (2397664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90f20f73d32c2cc8269995c426f4c71034977cc5cb2a90d42d56da42fa4a7e85`  
		Last Modified: Tue, 29 Nov 2022 06:15:02 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04f3c183e3d85799434c8dc2d0f6a1f577164702f3e77ef88ebe00c141972b85`  
		Last Modified: Tue, 29 Nov 2022 06:15:02 GMT  
		Size: 695.2 KB (695188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e0d87c45cc8674326d38551a93cb439092b38f96621a039d5a5f3401dc895b6`  
		Last Modified: Tue, 29 Nov 2022 06:15:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:314c85dc5e5d8ec05c7f8e868fc8e75045aedccc20c618b27a946566510c715c`  
		Last Modified: Tue, 29 Nov 2022 06:15:06 GMT  
		Size: 17.7 MB (17669077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; 386

```console
$ docker pull drupal@sha256:583e881b70960b9340543b708184923d47a6eaff5592d1d58aaf73edc354ebd0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.0 MB (187979265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7587285b2cd7e458101e143a4ed386cfb79be9562d0887a56a8cf919c07ef057`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 29 Nov 2022 05:08:48 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 29 Nov 2022 05:08:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 05:08:50 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 05:08:50 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 29 Nov 2022 05:08:51 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 05:09:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 05:09:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6016b3fc3af83dca6b741a5ecd4dfd16242a674e78c9289f61d1879f04e3b7cb`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce6c66a692e946c2f11fcdb44f5c116f9a2402cc825e04bcc148105cef5ea5f9`  
		Last Modified: Tue, 29 Nov 2022 05:45:46 GMT  
		Size: 2.0 MB (1987199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e21b8013984c12b102f677bab92ef042f9cf58666e5ba821456eba90934bc52`  
		Last Modified: Tue, 29 Nov 2022 05:45:46 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0e05029480eb9b02c0046c1b808eda37b28e0c5823bda542ddec52f94a1429a`  
		Last Modified: Tue, 29 Nov 2022 05:45:46 GMT  
		Size: 695.2 KB (695185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e113cf8a61d9cec4214d4988243252e4040b527f3c690c9c71a8626b377f387`  
		Last Modified: Tue, 29 Nov 2022 05:45:46 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7da0265c983b9ba3bb8e168505d6d61b530c72eaed21cbbce1a478c9c5146e4e`  
		Last Modified: Tue, 29 Nov 2022 05:45:50 GMT  
		Size: 17.7 MB (17670685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; ppc64le

```console
$ docker pull drupal@sha256:0b95c81dde9d148018450cad242577b34f9786d54d1a769e4449f85fe4ddc776
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.3 MB (186342243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33c20bd6e0dc5ad13be8eaff20e68e919098c07205ed6856b9e4648f0d0a3347`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 02:25:55 GMT
CMD ["apache2-foreground"]
# Tue, 29 Nov 2022 06:50:31 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 29 Nov 2022 06:50:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 06:50:33 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:50:33 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 29 Nov 2022 06:50:34 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:50:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:50:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:977d45d8d8c1391ecb5cf6e79a2861ca2106461f8e8a58ea33b1984952009940`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88f39079551b5472be986f87f372743e0fe006cb6255eaf757bc21492d0e1fd9`  
		Last Modified: Tue, 29 Nov 2022 07:23:14 GMT  
		Size: 2.0 MB (2001409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c96c10311b64096f10969df326faa7046e6fb46584397c7b00fbbc08c81ebfc7`  
		Last Modified: Tue, 29 Nov 2022 07:23:13 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5d6a1e226ba5af0d7dc7ee729e9988aacd0d5cf7924424299425dd5607eced2`  
		Last Modified: Tue, 29 Nov 2022 07:23:13 GMT  
		Size: 695.2 KB (695198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa83b5821a962e7c4cb2ac4ee3272ba176b02d7c2eb270169507ea50605d4a30`  
		Last Modified: Tue, 29 Nov 2022 07:23:13 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50466d2d20c64e006de23990943918101ce277de4511553b9f1af87618c4e595`  
		Last Modified: Tue, 29 Nov 2022 07:23:32 GMT  
		Size: 17.7 MB (17668891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.0-rc1` - linux; s390x

```console
$ docker pull drupal@sha256:d974cd7adb2a31eec524e4da108a93682feffcb3cd49e815d3bebd10d6b785a4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.8 MB (162769819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a8f5d39b4ebe273fded5f079294cf654159a360a9c80c7496bee49d5ec05f83`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 03:58:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 29 Nov 2022 03:58:21 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 03:58:21 GMT
ENV DRUPAL_VERSION=10.0.0-rc1
# Tue, 29 Nov 2022 03:58:21 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 03:58:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 03:58:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b1d1f223604ba710a220ae4b49ec137753cce2d613044777a71a0f7ed8459dab`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9892c34676ba912b77cb977bcfb7dd67db2b14e6c56bb71e0987dd92879a36c`  
		Last Modified: Tue, 29 Nov 2022 04:21:26 GMT  
		Size: 1.7 MB (1729726 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9674250e54bfbca3fed6899f82a4798ea661a4fe6eb5506ea4f4485be85d05d1`  
		Last Modified: Tue, 29 Nov 2022 04:21:26 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c24e5da5d16296eec23446689682ba88b5704d4b14f0ddb1b10c2e1d80fc6931`  
		Last Modified: Tue, 29 Nov 2022 04:21:26 GMT  
		Size: 695.2 KB (695202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4945d971c56d3d339a80d43a9f80d7de24056554010c1394ef233d076081cd1a`  
		Last Modified: Tue, 29 Nov 2022 04:21:26 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90695a357ea9ad85de527022609055b79ab611314d18696eea59e6405833a9f4`  
		Last Modified: Tue, 29 Nov 2022 04:21:29 GMT  
		Size: 17.7 MB (17669118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
