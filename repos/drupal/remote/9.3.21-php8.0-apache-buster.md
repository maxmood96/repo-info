...
```console
$ docker pull drupal@sha256:7f20f3004d94e9ed12b583473693955b5ea2d8ec1607f305a3d8c90f1b144a67
```
...
```console
$ docker pull drupal@sha256:eefbf44108e16c0feae0028d95fec10b85111d1076b205eec6dfedb890eeb22f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168756738 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:038f2a998b24febc7e8625a8d258b9986bb4742e52cbe93f171cc1c8042e878c`
...
# Tue, 13 Sep 2022 18:45:00 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 18:45:00 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 18:45:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 18:45:13 GMT
...
-	Layers:
	...
	-	`sha256:10d0164928bb82436ac1ac9d3c60a0559259b0da19fcd36607205172436c2259`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5259191f3e92ed5e868812d7153574e06c5583ead7ebe4f1c7ff872fe220f4b6`  
		Last Modified: Tue, 13 Sep 2022 19:07:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f14da373de1edfe6bf9df2a2ba7ec4ff2baddbc888b9340194cec42af16e226`  
		Last Modified: Tue, 13 Sep 2022 19:07:14 GMT  
...
```console
$ docker pull drupal@sha256:09eca19bd870861325090f596dd0e3aba75bc5ac24321cecb9dc1229b2544052
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144225392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb636521494122e8808eefada014ddb88a7b668db5df9744f9d6de95f41f028d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 02 Sep 2022 06:48:25 GMT
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 06:57:17 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 06:57:18 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 06:58:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Sep 2022 06:58:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:09b4d5cdb130dd08205f996e5fa61dd51e11ad4e79fdc44fbd74cac7b20af243`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33e491f762cb8752eeecdb749e05fd46f0d3bd4221df099956c688bc7b118f4f`  
		Last Modified: Fri, 02 Sep 2022 07:36:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91bf19c11c80e5dbeca4527657641dd3d23d6c8965aed107365767dfe65ea718`  
		Last Modified: Fri, 02 Sep 2022 07:36:50 GMT  
		Size: 21.3 MB (21322411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.0-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5e25679fb1cca0e2a3d60b366b7c079655258210a68f985e3d65f5e45180c454
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159946318 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8c9e6e5c1f556dcf45ab5b91a6d38db0a51a876c217a215879201c466d21861`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Fri, 02 Sep 2022 01:52:54 GMT
ENV DRUPAL_VERSION=9.3.21
# Fri, 02 Sep 2022 01:52:54 GMT
WORKDIR /opt/drupal
# Fri, 02 Sep 2022 01:53:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Sep 2022 01:53:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3309db70e16f1894ba7d714a892f2c3731907dd0c1098f180eb7746237cf6e66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48befa3793c34450635fdc8462d7998a1486a00c2a4fe967b6e0fb70a353c060`  
		Last Modified: Fri, 02 Sep 2022 02:25:20 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd32ef334b5f27d0ac0d8396fa59ffdbd0c91138878a43e92bc1f7bcfcac8584`  
		Last Modified: Fri, 02 Sep 2022 02:25:26 GMT  
		Size: 21.3 MB (21320863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.21-php8.0-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:7d122578191922f4906355cb497237b48159d2116ffaecc14764a75674591335
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (174030063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d82b21caa2f3f8a6441d2b3fe7d564b3cd1597f5d2fb9b26c266004a2418efc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Tue, 13 Sep 2022 18:27:48 GMT
ENV DRUPAL_VERSION=9.3.21
# Tue, 13 Sep 2022 18:27:49 GMT
WORKDIR /opt/drupal
# Tue, 13 Sep 2022 18:28:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Sep 2022 18:28:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0ddd411857a129a99e1b6a85d1ecb1e4294b4fd37869ea1bc276eabde3a7690c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d93cd25b2e721df2a9e46245614c91f927af22daf35c44fbf7f566c6499c2e8`  
		Last Modified: Tue, 13 Sep 2022 19:00:59 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30f8c058744a7e08751dbc8ca3fcca20072ea8181a86e132ae2b2da1da2a6a71`  
		Last Modified: Tue, 13 Sep 2022 19:01:04 GMT  
		Size: 21.3 MB (21322616 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
