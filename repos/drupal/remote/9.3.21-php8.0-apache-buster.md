...
```console
$ docker pull drupal@sha256:ba712acb6728515d86cd855a62beecb1eb0dff41435ad3780981c6a6e30b7898
```
...
```console
$ docker pull drupal@sha256:65e819da6e5a236e0d3138608168b0245c1054eb9478840b9691a847dfb1e882
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168757538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6449c3b7a30512583d490f92de55104183c700676cb987018f0cdd7ff2d83a81`
...
# Wed, 28 Sep 2022 00:59:13 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:59:13 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:59:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:59:25 GMT
...
-	Layers:
	...
	-	`sha256:fcb8caf41f591599fab9c84cc9ca33d1d8a790c9c022542079eb43de2ade26a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30011aae452a3de4177170b7e3e5b649edecfd1a272c78e7da07a2844cc4b75b`  
		Last Modified: Wed, 28 Sep 2022 01:25:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e83b0642664afd13c0df243f7e7aad6b85f9eef8f7a0d8331744dbe52cd7cf4`  
		Last Modified: Wed, 28 Sep 2022 01:25:26 GMT  
...
```console
$ docker pull drupal@sha256:da5ab53dd312ede7b4d6d9de399f5d9bde08de09ddd615582df4a4a29f7aa145
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143921841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f4ae770518b0bca66b973bda886c1b2155bcb7fdddf176e173f5ff2f39b8199`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 15 Sep 2022 00:11:07 GMT
ENV DRUPAL_VERSION=9.3.21
# Thu, 15 Sep 2022 00:11:07 GMT
WORKDIR /opt/drupal
# Thu, 15 Sep 2022 00:11:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 15 Sep 2022 00:11:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f4cd3669b7df7343887b32d5b39cb6da0b9ba8da7216b71d4a997b304b81b5b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec60b4db00d0d06049877d81c859a8d9fcece082c9f667eec14bb2852db54e13`  
		Last Modified: Thu, 15 Sep 2022 00:49:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b38304b2e78bb760508ca818210fe708bd77151cb3d8b4f6541f2436041e43c`  
		Last Modified: Thu, 15 Sep 2022 00:50:08 GMT  
		Size: 21.3 MB (21322518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:64029e865bb6729a98f62996c87e1885244d3cf7ea3d4a01efd6065e361099c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.0 MB (174030595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a562021cf0a6a2f8b2f790ffd2b902aebccd37c299ee2d4afad7a8adeb2ffbc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 28 Sep 2022 00:10:28 GMT
ENV DRUPAL_VERSION=9.3.21
# Wed, 28 Sep 2022 00:10:28 GMT
WORKDIR /opt/drupal
# Wed, 28 Sep 2022 00:10:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 28 Sep 2022 00:10:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a9e051b7441608b40cfc4ab037df43862a5b5c890346c1ef699434a0477a2a3e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a152010e90ea904e7287c05ce8f44b9995ee2a5057004006f91731454dfecd45`  
		Last Modified: Wed, 28 Sep 2022 00:48:22 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ede72f31424f60e290b641ef2f4bebfa34c1ba0d4ea188c778f965e7039ebfe7`  
		Last Modified: Wed, 28 Sep 2022 00:48:27 GMT  
		Size: 21.3 MB (21322617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
