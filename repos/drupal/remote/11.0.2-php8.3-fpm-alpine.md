...
```console
$ docker pull drupal@sha256:975efb26b77ac494df4680e7fd861d52ce6872e43b5a4b0dad59bc44d9dc3e4e
```
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; amd64
...
### `drupal:11.0.2-php8.3-fpm-alpine` - unknown; unknown
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; 386
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; ppc64le
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; riscv64
...
### `drupal:11.0.2-php8.3-fpm-alpine` - linux; s390x
