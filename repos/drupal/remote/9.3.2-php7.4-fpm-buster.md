...
```console
$ docker pull drupal@sha256:17f5b7235b6037030a7c6fdfd8a25850781e6e59983575c1fc105d47a78b4208
```
...
### `drupal:9.3.2-php7.4-fpm-buster` - linux; amd64

```console
$ docker pull drupal@sha256:27156291436ae07f07b0853c5b0f3efc1912e0deda86b95547a96f8fd944c2ff
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.5 MB (165544915 bytes)**  
...
# Thu, 06 Jan 2022 20:25:37 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:25:37 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:25:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:25:49 GMT
...
-	Layers:
	...
	-	`sha256:9f7ade383b20821d7d1bb284df560f2fbde19637c1412b4365e731739a604604`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb28e72294c46a707aec2d76d6974bdf105cd81b4cd39e66d43ff32f30ff9def`  
		Last Modified: Thu, 06 Jan 2022 20:35:13 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15623e42e31b1c54109247db14853cfb7e3b10da767de6d35c8137f6186c0580`  
		Last Modified: Thu, 06 Jan 2022 20:35:28 GMT  
		Size: 20.1 MB (20141010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:ad545fd27d7fbdee9b2cc1d4af8edf865230db110f7d2f328c693ecd8e89846b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141342613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4970581709037afe9818f64f394393f378ee617d2faa6253e72e63ef3f5a756d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:16:07 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:16:08 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:16:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f4a5e1fe153aac5b9409409a37049604a2605e4ad4f1db2c0c45537ea3ec0254`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bdd1eb5ed0f2677e8d0760a490447d40e63d7387ec222cd77db5e9044a74872`  
		Last Modified: Thu, 06 Jan 2022 20:47:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06b8b783fbf708905495f252ead4dd2ea1984eb0fcf5760069536d73ebfa8848`  
		Last Modified: Thu, 06 Jan 2022 20:47:55 GMT  
		Size: 20.1 MB (20141791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:fa4788a40820908ed92665f542b4baf21ce3e6862185766a986d7177a950c4df
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157078085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7bdab0bd96f3d4bacc72ef3c31eee9d541fd1bbed96ffb7f239074bc3cf3df7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:51:56 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:51:56 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:52:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:52:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:85f9955f79d37fafe1caf5d5bbbc0ad8473b8691f67f91306c3cd24337d3dbe6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11c823bb33ffa1f5c95778dc2d2fa2e21c3fccfb49cbd4d17441a55f6769f17b`  
		Last Modified: Thu, 06 Jan 2022 20:06:30 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80666e774de9b39382efeefc3782cf42d28811926464884d3734efb03386eb25`  
		Last Modified: Thu, 06 Jan 2022 20:06:36 GMT  
		Size: 20.1 MB (20143299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:614601f70828ac3fd1df46a0bb08bc8eb6fe4dd8a4f121b4d12cca63ee3dd944
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171390572 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4159278703e927e705ba40bd67da2352f8c6a40a47e449704635d4b71fa920dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jan 2022 19:51:04 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:51:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:51:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4604a151940806837279eba8582b0bc2183e1f0552980195590d06500f850a6c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:573ea2fe3c96cf91978dcac08344e5bda05e5844fde08e212dcda21f1a79ddd0`  
		Last Modified: Thu, 06 Jan 2022 20:07:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc3ab996675c03c621d21fd39ab2b8fe6f22f5f1355d219d0a37bf0e09556ea1`  
		Last Modified: Thu, 06 Jan 2022 20:07:28 GMT  
		Size: 20.1 MB (20141099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:18ae7980ef713877a1db6e6fb35ebc68a23fe549040983815dadc10f0d43951d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.5 MB (176451289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dd42958df6eccb4b9d178115f0c40112936dbb25cc7a67f21ea50ac8b050cd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:afc8a469e1ca8efc0af0602cd0004d9835a2a01ec50be04394551e6108d2ef6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c5c40b05dd9caff10d20df70fbe4a1a29d7d683ac833cfeecb14f11b08574c3`  
		Last Modified: Thu, 06 Jan 2022 20:52:37 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0a472d5bf163cee40534f8b99bca0197c592299ef4a1d0e32b5fe360095b8e8`  
		Last Modified: Thu, 06 Jan 2022 20:53:27 GMT  
		Size: 20.1 MB (20141447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.2-php7.4-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:6da6aa10a57eb5b1a6da636f6701047cce75deea176e90add1af172cdd8f8a37
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.3 MB (151291354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be1f590ac6fccbd6e71ff137fd914f43aaa24af32c6a7b9839b7bcacba9bc604`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:56:17 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:56:17 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:56:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:56:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b1d24052ead83c8c7e8b0ecd5b80487bbbd4c717797a67a8b93bf97b0de92dc8`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42de7d9e0eebcbd19507debeb2481928927c10b35a16ad67a29db2af7a5c6c21`  
		Last Modified: Thu, 06 Jan 2022 20:09:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8312067e877e343cfe594f73832c1cfc89ac1f6dc89184fe15f4d6a53f62ba6e`  
		Last Modified: Thu, 06 Jan 2022 20:09:44 GMT  
		Size: 20.1 MB (20141187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
