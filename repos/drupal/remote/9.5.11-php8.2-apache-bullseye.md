...
```console
$ docker pull drupal@sha256:0246e1c9b12330089e7b99d9f17928855c6909d420cd3b6ac3adc060317fd2ca
```
...
```console
$ docker pull drupal@sha256:d39326a47abb9b5eabfc1ad4cb1bdb2af14e9dad87b76b2179c4962f4c7c2679
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168562257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:929ab21d6f983be5921a568e6bdd5b64ebaba39eb328a3a7cbdf03b758a6e882`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Tue, 10 Oct 2023 04:18:44 GMT
ENV DRUPAL_VERSION=9.5.11
# Tue, 10 Oct 2023 04:18:44 GMT
WORKDIR /opt/drupal
# Tue, 10 Oct 2023 04:19:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Oct 2023 04:19:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:068de5dc2b688d0d9bd0e2a1e17a21d05c7978aa920f89cd839a0db5318d8efb`  
		...
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7c76c0858d2be6f2429002f7f59120acb9790fcb4a1486c9b693a127606a5cc`  
		Last Modified: Tue, 10 Oct 2023 05:24:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17bc3d9bd6cb0fb4ef7e33d218c4566ea6b917646eb333c99b407c429776a98`  
		Last Modified: Tue, 10 Oct 2023 05:24:30 GMT  
		Size: 22.9 MB (22878858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
