...
```console
$ docker pull drupal@sha256:3af3f9cd1327359bd22da997c773b169fdf12072dd6e23bb2f9aac7c81565667
```
...
```console
$ docker pull drupal@sha256:800e4d546ad1bef683d1d2e05ca97e1b09f84bfed1215047c95f6d3d74059e37
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191785897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27d2266caf70a7c05063d0828b9ba8d6b19039485ed723b7bef2460c0433c653`
...
# Sat, 30 Sep 2023 05:26:13 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 05:26:13 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:26:23 GMT
...
-	Layers:
	...
	-	`sha256:7c19bf1bce4b71c2b91000be3eb791ed024d3461446806faf2cf6b14099656f7`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:499e7db2e00926d4fdb390d657a864ce8371261ecf6d1eaf8bbf3816ac07e189`  
		Last Modified: Sat, 30 Sep 2023 05:34:31 GMT  
		Size: 704.9 KB (704940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7573685cf96eead4e2129391b1c82c46bd90ca7b5814f3f43dab103e4b64a79`  
		Last Modified: Sat, 30 Sep 2023 05:44:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e2e0feeb1f59fc62665d39d6265f64779d04e3a1cbdffdcf31a59ed2f7836ca`  
		Last Modified: Sat, 30 Sep 2023 05:44:26 GMT  
...
```console
$ docker pull drupal@sha256:e619634ea56a2e503ac3fedecc6c5c573de3d285d79079fb97e71c52d061b551
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161234438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:926797fcb6bdf08566c6d7bf6755de86bc936ec9f94e438f38f73558f16cf0f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 02:56:33 GMT
CMD ["apache2-foreground"]
# Sat, 30 Sep 2023 05:05:24 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 30 Sep 2023 05:05:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 30 Sep 2023 05:05:25 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:16:35 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 05:16:35 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:16:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:16:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:feb8b9d33f8a737ad8826de950adfb8c26138264269d464fd7949062c44a2744`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424af30226f16412e02e0545c660ef1338accdaf577cf2c02b4d666f7dab56de`  
		Last Modified: Sat, 30 Sep 2023 05:24:56 GMT  
		Size: 1.5 MB (1524345 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16606a284f41092974a3ed3fffdc8c3f482f866b9c15cc32cc0f7c06e3e2e030`  
		Last Modified: Sat, 30 Sep 2023 05:24:55 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0d8a26a2491b73cdeef873e21582d19188b5afc08f7f04fd560c244be566df5`  
		Last Modified: Sat, 30 Sep 2023 05:24:56 GMT  
		Size: 704.9 KB (704939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:231ccc95e802456f66d508456a6927e74d30c1adc9393b1796a14bf654dc3e5d`  
		Last Modified: Sat, 30 Sep 2023 05:38:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0de32e1927ba02b84415b54da0c491c639f95892f705423486a4c7b088ecd368`  
		Last Modified: Sat, 30 Sep 2023 05:38:32 GMT  
		Size: 22.9 MB (22880582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:4f49f4e91efc8946f72cce29811efcffe6e6500393a4047a486a97c051708b0c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (186002103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5de7c87fa9a78968e72c2cc5fcc020ac02b4e13e91c4a4d109d80db7b30f465b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 05:13:19 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 05:13:19 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 05:13:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 05:13:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aa600d7c9f8aa0352ec2cfb6b1319fd5dc5b0ffaa1644fbff053f3ff48d3a837`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78b76ad9783e350a3ab4423850f8135d78320dd2e1d8e5e0b553148b262fecd1`  
		Last Modified: Sat, 30 Sep 2023 05:21:16 GMT  
		Size: 704.9 KB (704940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f67ed6f298e24be5faec1314e04e058e08328d59f7648f38cd2903f7379c2e8e`  
		Last Modified: Sat, 30 Sep 2023 05:32:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6215440119e013a7c76dfbe295075a798109c1cb953850ab1de7266e1cfee711`  
		Last Modified: Sat, 30 Sep 2023 05:32:38 GMT  
...
```console
$ docker pull drupal@sha256:e176a99cdf4f1cc1e4934f6ad3faa8d5aea1b77d314eb8d6328026c9a492177c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.7 MB (194658941 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d6c3bf327470ee5ea16b26c80cbdc10472636f4592778126230c803a7eb8b2e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 05:57:58 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Sat, 30 Sep 2023 06:16:08 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 06:16:08 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 06:16:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:d1707b541c5ac73e611665db6ef12012dbb863ee9826050d7d8f00332da533c3`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f1d7e6bd42c93835162d841757ddab3a31cf97acd0cb01ccb48da1547672057`  
		Last Modified: Sat, 30 Sep 2023 06:24:50 GMT  
		Size: 704.9 KB (704941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bacf409209bbad405b8f0e2fb3d4af01422497502f155e8e1b99c5c780c2a481`  
		Last Modified: Sat, 30 Sep 2023 06:37:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26ca58a9f4ee3e48cda4ca226adac4ea2b27c39f8b143c47daf81325a0170d93`  
		Last Modified: Sat, 30 Sep 2023 06:37:48 GMT  
		Size: 22.9 MB (22880789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:1af19783cdc460b013464ef1f3844458fd1904b9835d49fa7f17159d73ff6928
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.2 MB (192201030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f35ef4267f9d9107196c7eea8b62838fad8f8a5dd38bdefdea148b03f939876`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 29 Sep 2023 20:31:09 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:47:20 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 29 Sep 2023 20:47:21 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:47:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:47:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d9c8c89c6d40bda2b5ef832bf72c68289e54e643f51b65ca6ae7b4c1f63bd5a4`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44fde0594691bc6ddb410c1e7100889be5b859641586998b99639de49608fcd1`  
		Last Modified: Fri, 29 Sep 2023 21:03:23 GMT  
		Size: 704.9 KB (704945 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd2b83d0c31b3c2acf205d4cefa3621efef59013303013e8b375c69be980bd76`  
		Last Modified: Fri, 29 Sep 2023 21:23:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd94a67fde6c670a89363b909eb4bae9b7dee9b4763f87efdfdc82d428a8585d`  
		Last Modified: Fri, 29 Sep 2023 21:23:41 GMT  
		Size: 22.9 MB (22880407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:bb00b361300804e5567cfcee20a4c8165b62449c64243c7f2cf14636e8e57a13
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168556669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5ef92fc90ca4c1baf59b6d90b7eb86387088f900f71620f63c727daa4efa821`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 29 Sep 2023 22:47:57 GMT
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:59:48 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 29 Sep 2023 22:59:49 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 23:00:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 23:00:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73160cf4e0598f43486089cabf2cc3029b6411cb0c5af725926ac359c03ce691`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08bda1e77d0e1bb8d153c98d743f5e73e74725b01da4cd0451d4dadd4bdd1435`  
		Last Modified: Fri, 29 Sep 2023 23:21:18 GMT  
		Size: 704.9 KB (704943 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13590fa83f37f26a8f070bd878b3eea9f434a1be29058a843e21916057105bff`  
		Last Modified: Sat, 30 Sep 2023 00:02:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:349ca874d07f7c1274bff68887539db960eb7ce872459c6c78a0f26377e46283`  
		Last Modified: Sat, 30 Sep 2023 00:02:14 GMT  
		Size: 22.9 MB (22880390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
