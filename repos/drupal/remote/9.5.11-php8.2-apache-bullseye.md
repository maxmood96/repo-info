...
```console
$ docker pull drupal@sha256:43b47568f1e91a6e6e438b47141fd60a0d5b971c1ee12d3b0a540076bcecb131
```
...
```console
$ docker pull drupal@sha256:c05c69e421df8b1ce1fa81025bb08dc8e54125f25c7961101aa4561b8327fe66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.8 MB (191807048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7600f30cb83821da193168af9b738d9e43b6814eb306254fe754efc166d17efe`
...
# Wed, 01 Nov 2023 19:27:57 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 19:28:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 19:28:09 GMT
...
-	Layers:
	...
	-	`sha256:05c08a812fb5c4590df9d89bbfdddbb2ad1d36bc548a138c571bd779c0ff7385`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c847cee79887284536949c090d2c91f29639c957dfbd7984c0a4f9fd7d657008`  
		Last Modified: Wed, 01 Nov 2023 19:47:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8081f7825c1f0a16255025bfe49f0e62c7c1d33a4319893aabcdd3e3671cc05`  
		Last Modified: Wed, 01 Nov 2023 19:47:39 GMT  
		Size: 22.9 MB (22879401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:281998815a5d27f7559b79643958830ee0bc5e8888ba75cf028af651b1bae0a7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161251793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d14f205a93a55f46d5dd25f178449f4ad92740031e9350e93ad7482e6c4111e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 17:36:43 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:45:25 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:45:25 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:45:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:45:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0198368a19588cf01ca5b76dd5f490d75ecf6938f609f06722a9ca6a1b7cc56a`  
		...
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1352bc579a825adf897bd9d5f96a396f428d1d0ba9fca275536043cc3814d0cb`  
		Last Modified: Wed, 01 Nov 2023 18:08:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d7876567cf775153f552d749c76e25b37f6557462688a06484e85226003a14c`  
		Last Modified: Wed, 01 Nov 2023 18:09:00 GMT  
		Size: 22.9 MB (22878932 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:7180e4caa2fe33aebfd63cd008bf7b3eadc904a3d91a50e2462798b7e281f48e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (186018787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:303d84503fca5095908bf1c42d339d390997be2392805ef8395239a303bb7906`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 17:46:53 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:47:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:47:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1eccea24edf46eefabc978f3be7a07c8977a8d0b47957301a4104798cbf6a6d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00ad56bba46c0ba07734c11fbf561bd1b6f92a610ada355a82422a2380fee4f`  
		Last Modified: Wed, 01 Nov 2023 18:05:53 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c51d3a25c5819c1dbf9c27f07a5b504f03f30df456169015779f4e6ac1e14d27`  
		Last Modified: Wed, 01 Nov 2023 18:05:57 GMT  
...
```console
$ docker pull drupal@sha256:3df633458fe45850e1b169ed6f4a583a8d21c17538342db7fb04524b54b2a812
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.7 MB (194678236 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdd1a65c0a308763f8d0bce7b6c4c4ff15342cc1cc67f371b9d445a19e869a50`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:c88e89f9c407af2e4047b406a79d42790e87b125ac903ba8e4a1d60c623e4c0c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5df59f96d2b8add3bc997b9ba1737652290ab4158139cff764aefd83f02b5291`  
		Last Modified: Wed, 01 Nov 2023 14:58:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79af4560fd5aabbf4d91b37f221c7d80c436e6e2efb0c3d2dc3b45652b47d9bd`  
		Last Modified: Wed, 01 Nov 2023 14:58:25 GMT  
		Size: 22.9 MB (22879510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:708d95f9b7a921af555e71bad86ec34e37cf672a96bd9b91f9512e174a0608a9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.2 MB (192234725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91b196fdad11f2656c9867d06d10a08b0362f022ef011c559db293feb6798671`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 15:48:46 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 16:07:42 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 16:07:46 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 16:08:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 16:08:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:269563656b4c3fa184fb89c2696aa4794091e592c243e18462029acc5bcd3021`  
		...
		Size: 705.0 KB (705007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63c06f2335600b7fcef584ccf944c8b9e3777899dca2e6135978c5fad2bd7f67`  
		Last Modified: Wed, 01 Nov 2023 18:20:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcd2387c1932e1210c2fe6b6d3af2402428d31470332c378aad539e543fbef75`  
		Last Modified: Wed, 01 Nov 2023 18:20:38 GMT  
		Size: 22.9 MB (22879070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.11-php8.2-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:88876c532ada4a5af2354c9994792eb41aa109d0ec2224959830ab236dd471fa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168579419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4f220d0b828e9a9655475fad332d900cf4d5588d30b4554e2bc3d61c320a75a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:34:47 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 13:43:25 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 13:43:25 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 13:43:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 13:43:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:be8af20046eba6918aea0111f7874393d578c1f832b24efc8f00ab9b4fc00a21`  
		...
		Size: 705.0 KB (705007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f7b7cabd663e340e2aaae3478634e554e8255b17f6dc18e591a468cf1037f4a`  
		Last Modified: Wed, 01 Nov 2023 13:59:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9046bf8e92e58c985c895e5031ca704da557630e00abf6ce31e9e3be4d7401a6`  
		Last Modified: Wed, 01 Nov 2023 13:59:18 GMT  
