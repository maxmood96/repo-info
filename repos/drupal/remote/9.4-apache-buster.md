...
```console
$ docker pull drupal@sha256:9f87571d02bcbe3b2f014dc79d9c029d7143843490a9a52e610b04a0f47647d6
```
...
```console
$ docker pull drupal@sha256:effe49fca9e9c680c67c1767bd67b9462817f4b4a4625d5f94c0d636e6e9263e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144216325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:998f7f94b5aca214347e8b51c690a2766a11bdab1c8dcb9ceba4f1956c77402a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 14:23:18 GMT
ENV DRUPAL_VERSION=9.4.2
# Wed, 13 Jul 2022 14:23:18 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 14:23:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 14:23:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:824f06601fd3f027a6e650dd0366a1f0536d06f01ab4a6bc9524b151970a817c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2f6c80dc781dee828a0dca6141190f15f63cf9546dfdb544dfd1a05660cc2d0`  
		Last Modified: Wed, 13 Jul 2022 15:31:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a0145b6cb3db125f799cfacc36009083631719e631d25bc6dd7ba01ed81292a`  
		Last Modified: Wed, 13 Jul 2022 15:32:25 GMT  
