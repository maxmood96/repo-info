...
```console
$ docker pull drupal@sha256:41950470ac2a79471194b6204d5c6d1ba798eef514cc4fd925a7b18a1808d957
```
...
```console
$ docker pull drupal@sha256:9ac896101a0116156eaae116a1efc0e42015179e8c85e978086861691d160153
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.5 MB (145509673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aeec09ea90f6a7840af4e1987e32105d9f32c124b94d86e8a9f0058367c89966`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:12:57 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 20:18:56 GMT
ENV DRUPAL_VERSION=9.4.13
# Fri, 14 Apr 2023 20:18:56 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 20:19:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 20:19:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:89b625fac27d3ba24f1c2ae6863dc3905dcefa3e20af20ecad4cb6507413a595`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13f701e6f8625192b955d68c409b551e7e0db8ed3b22590ceb2cc0ffe48878a8`  
		Last Modified: Fri, 14 Apr 2023 20:33:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:951adf652edf353ae9b99899f16967e9e38c65fccdc5efdebef6f05d53bf25f9`  
		Last Modified: Fri, 14 Apr 2023 20:33:40 GMT  
...
```console
$ docker pull drupal@sha256:ec754392d8f62448ff28415fe892d401d20ec75bbed134692758cd2874678148
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.1 MB (163063412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81609050c169472fc53dc032d5dd556ede150a049895804d1afd40de0fc0e497`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 14 Apr 2023 20:20:34 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:44:51 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:44:51 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:45:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:45:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:45794d899717d28bb59fdea67b5984499170c394d7bed1a58006640627eab3e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8332377ff978ecf8c0cb6a4067bd529c5e240edb171d9653146121fcaab638af`  
		Last Modified: Thu, 20 Apr 2023 23:02:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af956f57852182dae72ec3525f8a22568afb76edc90a9fb3b8ad8698133971f5`  
		Last Modified: Thu, 20 Apr 2023 23:02:22 GMT  
		Size: 21.9 MB (21917488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
