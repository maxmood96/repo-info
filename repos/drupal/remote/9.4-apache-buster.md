...
```console
$ docker pull drupal@sha256:c141caa567a414f6584284115e2d53f6e2601ef4dc736ca2760be05e4d762298
```
...
```console
$ docker pull drupal@sha256:915019795ae5727d55e09d325e95f5d9d183b7b487dc18cbcea37a2b2642dc71
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.9 MB (145908798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21734fd23ffca3341c51d2079182a9916e8b18c6833722cfbcdb46a31e014341`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:21:34 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:21:34 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:22:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:2d9bf67b34327612a03b27b558d09b37d89395ca1be64e99e84ff38c1db480cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c2d33e3bd24efed247147b448efae7c975769db4b2ca0ce604063b5f0039339`  
		Last Modified: Wed, 15 Feb 2023 23:56:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51170e9eafeda0e0031d7c28f1e0b733585b38dfee8dc9674d82e1bfc0facd72`  
		Last Modified: Wed, 15 Feb 2023 23:56:49 GMT  
		Size: 21.9 MB (21911605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6ca83d0c8fe0afdc63c0dd653328c84fae5396c501955c4002617c783306bb48
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163019336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e47c6bc2d4e96fc7ea49a5c900a3f951ef8efe596158a9188e2b9692cb7c0eae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 16 Feb 2023 02:28:57 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Thu, 16 Feb 2023 02:37:26 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 16 Feb 2023 02:37:26 GMT
WORKDIR /opt/drupal
# Thu, 16 Feb 2023 02:37:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Feb 2023 02:37:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:93bdd1c2c75aaf16cb1fc8e75eee1fbcfa2db1fb702ed57c76e7c1aaebac69ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d986aec59cf11246c224a586cd8d0f18316478d24dc567580ef0e46baeae2aa5`  
		Last Modified: Thu, 16 Feb 2023 02:51:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b071354c40c894277a5acd7aa1414456608b48a0eceab1c5938db81640598ef6`  
		Last Modified: Thu, 16 Feb 2023 02:51:11 GMT  
		Size: 21.9 MB (21911848 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
