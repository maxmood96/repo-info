...
```console
$ docker pull drupal@sha256:330c0b604452f019db973efed1725c6d54ef5c50984b72c7cbccbe8226ef309f
```
...
```console
$ docker pull drupal@sha256:62ae2c0ca771ff072cce2a0c1ecc674dc732777b061a83df19ebcd387ab467b2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.0 MB (169048670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18209a90620c87dfb5659cb742fe89461e199a60f24cd3c0071c6a976b3393b1`
...
# Wed, 20 Jul 2022 23:34:07 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:34:07 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:34:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:34:19 GMT
...
-	Layers:
	...
	-	`sha256:1da7cbddd24c0a7c10dc3828697a1763fc344a9fb478f0ec04e46974b80e0990`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54299098ec41a24bdd5e801059ab8f40886ca6f09d53289e25d7c85b1479bf4e`  
		Last Modified: Wed, 20 Jul 2022 23:52:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c20f448fba3625348bf9f916bee3545882b7076381b02a6983913df6e9b807e`  
		Last Modified: Wed, 20 Jul 2022 23:52:58 GMT  
		Size: 21.8 MB (21766768 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:098e8073852a7454539ecb72d524cbba331ae35e57587e829b89f1d5bba097b1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144220104 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9a4a9f4358215d77956f7a4867c1dd7ad3681d042c878aa3816c7ee59bb075d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:23:19 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:23:20 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:23:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:23:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:824f06601fd3f027a6e650dd0366a1f0536d06f01ab4a6bc9524b151970a817c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:026ac73b04219f829a1b6914fe7a9a9a911f4d4fe85ad17ed76dcfc2154b2f8c`  
		Last Modified: Thu, 21 Jul 2022 01:26:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a97ee34e66de7405ad110aaf26d62a96bd2028d38f2e164b8f76a1918e3d6783`  
		Last Modified: Thu, 21 Jul 2022 01:26:52 GMT  
		Size: 21.8 MB (21765774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:917d1f4fe099b8585a7a48afa4ab3002876b10c6159ecc2a0a065944e5c84575
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159886623 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa3133fae41c49d59fc9dbc4cee15fbee6c6318474371b1e466fa89068501fe5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:01:02 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:01:02 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:01:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:01:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b946ea67a3dfe9096b183c34e54deaa336fac7fcc8a940958833f2ea66befe1e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28ca3e8c018a03eb3a25d447bee8e9d1a9415ed96ce6959c74e86eb6622b314b`  
		Last Modified: Thu, 21 Jul 2022 00:32:17 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:491e4d733c2dcc46e8fea7e59a1b62fdd8f85cca22d53b6d6c4a33a469f78c9f`  
		Last Modified: Thu, 21 Jul 2022 00:32:22 GMT  
		Size: 21.8 MB (21767065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:2e02496f06187cf042201c615feeb7ab71ec0ccc4fbbbd0ed3899c1b27d9d925
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.3 MB (174319868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48b7c36258455b68616181db4bc4412dab9018eaa32be8b6288bba3386fbab86`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:48:53 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:48:54 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:49:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:49:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22060f52f99caf861d0d1854c89f9b73bde2d49f91ca3461753c06d2b78b4cea`  
		...
		Size: 670.1 KB (670052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc34a56539171422c7783fb4839a16c40b71da08d1d77d2cf5fabb974b6ed1b2`  
		Last Modified: Thu, 21 Jul 2022 00:19:17 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6953a5246b5bde80dd6da3fc62b3621e8180d4f5e93d177a5b8c9d9c737bda88`  
		Last Modified: Thu, 21 Jul 2022 00:19:22 GMT  
		Size: 21.8 MB (21767413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:e8802d76f83dd630147e8adca84672e49f38b02bff96031c09572ebe1e449407
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.5 MB (179475909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b6e0d579775635cb9ae64f9cbc23367278e5e338bf61b4b6b42307135f522a7d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:35:09 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:35:11 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:35:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:35:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:708ceaac077fdb88e76f1b089da414b60a6f720fa4abae676743d90a013707c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09fb1b3501895547d590d32f14d0c794410a6eb6e10363308843b5d93db80095`  
		Last Modified: Thu, 21 Jul 2022 00:33:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6fb1c85a263a4c884498d85344716d67b35d9730f1c37ab5b1c8e06cc469ef3`  
		Last Modified: Thu, 21 Jul 2022 00:34:12 GMT  
		Size: 21.8 MB (21763647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:8a8405c1704587410c1a61134f7828b4a951035749d619fa2181d39493cdeec4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154291174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:13f28e0665f6bdb436a820db999d8eba68b6e05e1ce68bcde45ef2fe2ecdf435`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 20 Jul 2022 23:58:01 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:58:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:58:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd587120d7dabde80d0e120cf6bea5808279f80772902c6bf1766dd90b684f27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b2831db81e655d0f47e3c6b4d1b2acae54776bfdf2898628a41d75fc3bd9994`  
		Last Modified: Thu, 21 Jul 2022 00:47:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f281059b593cdec7dce50ed6369b5d71f392173bff7ca715531330d23321398`  
		Last Modified: Thu, 21 Jul 2022 00:47:15 GMT  
		Size: 21.8 MB (21766400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
