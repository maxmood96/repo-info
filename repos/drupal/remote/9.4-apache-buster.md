...
```console
$ docker pull drupal@sha256:4e6710c5fef9c498df7695006c9f9f43b294bced1c6d006090fd61c8fca96b80
```
...
```console
$ docker pull drupal@sha256:7141d091d0006552e85e907beeb8a75ca7f30c45f2313b5f76eab8ccf8f1de32
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176318737 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1da9ddf4a1a4127082988679453d646f7851c81effa1613de1f4844957f12139`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Mar 2023 00:18:17 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 24 Mar 2023 00:27:18 GMT
ENV DRUPAL_VERSION=9.4.12
# Fri, 24 Mar 2023 00:27:18 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:27:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:27:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8bc3030680b15886a447fb3409324dfa4aa63fe14f104d5d27f0e9b25efbad9d`  
		...
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da85a9d053d5e6a08c72875e3372655f527c0999e9d8cc7dc31417562b4e9ed`  
		Last Modified: Fri, 24 Mar 2023 00:40:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba3f5dd1b93f4e10428b2849f56820543eebe24b511e04d6b015b53fac833ea1`  
		Last Modified: Fri, 24 Mar 2023 00:41:01 GMT  
		Size: 21.9 MB (21911561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
