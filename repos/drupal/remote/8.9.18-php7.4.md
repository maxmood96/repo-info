...
```console
$ docker pull drupal@sha256:f5186b9faadd1e9b91344ac128992d239fc3197ba33de72efc09a12dcb04788f
```
...
```console
$ docker pull drupal@sha256:ce301ca1460df8598df66580c6575c1ea827b73ba94b2e23ed57dd2bbbe4185c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170571688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62428e80b8d75e960a8291de33b6e3f880700e54f07b5acf3c37064d463ca195`
...
# Sat, 04 Sep 2021 15:20:31 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 15:21:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 15:21:11 GMT
...
-	Layers:
	...
	-	`sha256:9ec5bcc1acc88e6d73b60dc14bddb79d47461d32f59c0f4ef1d33406f1a113ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8696ce92db7af2114ae258b470d7c49860b1a895599cf6832c9b42fc48f0371`  
		Last Modified: Sat, 04 Sep 2021 15:31:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f8aef425d75a66a8aa180108dba37c105d50d8f25c3fb92403b2f24e369069f`  
		Last Modified: Sat, 04 Sep 2021 15:31:22 GMT  
...
```console
$ docker pull drupal@sha256:834a0d1f8b0a03bdb51524899cfcfc39df6e420c4a6bd7649ff26865ee80b0e0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (145983499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98c473c9a4c5e02e0fabfb757ad576dacb28e6591daeeee5c7e317a5ed901b38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 04 Sep 2021 18:00:28 GMT
ENV DRUPAL_VERSION=8.9.18
# Sat, 04 Sep 2021 18:00:29 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 18:01:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 18:01:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f70be702877ed0ca549ff0550bc2e75e5e7c82b15ae6c06bfced7241f0b83167`  
		...
		Size: 507.6 KB (507614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af962f24e1831718743305377ca100041994629897e7528b91b1b3f78b9ae499`  
		Last Modified: Sat, 04 Sep 2021 18:30:43 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f7e661e96634c34b868661f944b32b5a5c51ff12df9801ed62fa478f8eac28`  
		Last Modified: Sat, 04 Sep 2021 18:31:11 GMT  
		Size: 20.8 MB (20797011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
