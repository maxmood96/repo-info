...
```console
$ docker pull drupal@sha256:b908007007a46ccafcfe60d42eeeeb0ffbeb9ed5a078524c38008530d293b61e
```
...
```console
$ docker pull drupal@sha256:0d775d0a963b1289d9bc958a6335a82c0a7c22c4526cc50d35948bc7cf21dfd1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.3 MB (55273917 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b65d9af6e5f805e9d15f448b2eb020fb339c4633920bbab4afdb6dad0a97c17`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:142e6b7fcfa4441d4dc8721f401158a3c954703d33ea3942463cbbfad7b1e9e2`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c1c11ec6cc0eb7de02eba3350bfd8192d5ba382dd6fda7b22de435befe3b20b0`  
		Last Modified: Sun, 07 Jul 2024 05:01:58 GMT  
		Size: 19.0 MB (18953971 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.0-rc-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:a28f4989798fd9690667f609cb5938d01076ec0cd6c8e1cd8f566c04cfff7a1e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **361.7 KB (361692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15cb2e9df97efbfb2a44dfc698189bd957a9be28ce8399ad97358258b6d21ac7`

```dockerfile
```

-	Layers:
	-	`sha256:5783f2e4bb007545aa2345ba4a0ae1eb313ae2a822ae60f847caa46a3b1948c3`  
		Last Modified: Sun, 07 Jul 2024 05:01:55 GMT  
		Size: 327.5 KB (327510 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a5e04378b265d5734de8f95873606214d775a9ba40d2bce9ebc928e0f3720bff`  
		Last Modified: Sun, 07 Jul 2024 05:01:55 GMT  
		Size: 34.2 KB (34182 bytes)  
		MIME: application/vnd.in-toto+json
