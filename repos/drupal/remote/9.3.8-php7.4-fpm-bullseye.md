...
```console
$ docker pull drupal@sha256:5833c573c78570aabd12e20c5a35dfbdc28fad1edf9b96254391abae04ba8c4d
```
...
### `drupal:9.3.8-php7.4-fpm-bullseye` - linux; amd64
...
### `drupal:9.3.8-php7.4-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:9.3.8-php7.4-fpm-bullseye` - linux; 386
...
### `drupal:9.3.8-php7.4-fpm-bullseye` - linux; s390x
