...
```console
$ docker pull drupal@sha256:efd058f0ac98f0f045de0a801cc231db2865ea1bd2b33662dad10f5110fe9cf0
```
...
### `drupal:9.2.17-php8.0-fpm` - linux; amd64
...
### `drupal:9.2.17-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.2.17-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.2.17-php8.0-fpm` - linux; 386
...
### `drupal:9.2.17-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.2.17-php8.0-fpm` - linux; s390x
