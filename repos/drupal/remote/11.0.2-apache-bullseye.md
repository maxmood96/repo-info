...
```console
$ docker pull drupal@sha256:0a5209df5b94bcc77a6008d54c83fd695f884006a28fc19f717d9042f16b8fe9
```
...
### `drupal:11.0.2-apache-bullseye` - linux; amd64
...
### `drupal:11.0.2-apache-bullseye` - unknown; unknown
...
### `drupal:11.0.2-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:11.0.2-apache-bullseye` - linux; 386
...
### `drupal:11.0.2-apache-bullseye` - linux; ppc64le
...
### `drupal:11.0.2-apache-bullseye` - linux; s390x
