...
```console
$ docker pull drupal@sha256:4abf30230c1076b86a7664952feeec1dd45b3a702d31872e05106519cf49fe30
```
...
### `drupal:9.4.14-php8.1-fpm` - linux; amd64
...
### `drupal:9.4.14-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.14-php8.1-fpm` - linux; 386
...
### `drupal:9.4.14-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.4.14-php8.1-fpm` - linux; s390x
