...
```console
$ docker pull drupal@sha256:595ee878cea74713aa196999923e34f81642ffa48097ff519087a2f8424ef0ff
```
...
### `drupal:10.2.5-php8.3-fpm-alpine3.19` - linux; amd64
...
### `drupal:10.2.5-php8.3-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.2.5-php8.3-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.2.5-php8.3-fpm-alpine3.19` - linux; s390x
