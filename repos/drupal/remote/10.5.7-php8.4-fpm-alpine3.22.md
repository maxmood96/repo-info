...
```console
$ docker pull drupal@sha256:949aebda72f5ab38754c7409580022cf03f49116d2feb891f0cfa65b2a98c0db
```
...
### `drupal:10.5.7-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.5.7-php8.4-fpm-alpine3.22` - linux; s390x
