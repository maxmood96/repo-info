...
### `drupal:10.3.0-rc1-php8.2-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:10.3.0-rc1-php8.2-apache-bookworm` - linux; ppc64le
...
### `drupal:10.3.0-rc1-php8.2-apache-bookworm` - linux; s390x
