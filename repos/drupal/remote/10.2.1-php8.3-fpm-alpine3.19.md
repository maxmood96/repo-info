...
```console
$ docker pull drupal@sha256:f0bc81bb239c57f6b01d2ee9e1de46a9b0b8a07b03567fb96cb8f13361772945
```
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; amd64
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - unknown; unknown
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; 386
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:10.2.1-php8.3-fpm-alpine3.19` - linux; s390x
