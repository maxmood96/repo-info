...
```console
$ docker pull drupal@sha256:63aeb2a1b180ba8ac7d6c247a3581771d98940771b9f55c65719b3e2a9c6d372
```
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; 386
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; riscv64
...
### `drupal:10.6-rc-php8.4-fpm-alpine` - linux; s390x
