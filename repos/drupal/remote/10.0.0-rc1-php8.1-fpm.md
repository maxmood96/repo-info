...
```console
$ docker pull drupal@sha256:96b626f5ac0902c50021e474944d20635d3ceeae2f03cc7c565324d4e800b7db
```
...
### `drupal:10.0.0-rc1-php8.1-fpm` - linux; amd64
...
### `drupal:10.0.0-rc1-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-rc1-php8.1-fpm` - linux; 386
...
### `drupal:10.0.0-rc1-php8.1-fpm` - linux; ppc64le
...
### `drupal:10.0.0-rc1-php8.1-fpm` - linux; s390x
