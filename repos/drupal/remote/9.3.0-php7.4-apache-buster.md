...
```console
$ docker pull drupal@sha256:9a20409a37b9e216a1ff141e48eb5196738957dff25e1bdcbfbd156a700d0ff5
```
...
```console
$ docker pull drupal@sha256:61ebeeb80c1d321a89e4b884b0104781c140e32d1179a3d3a737e050aa32dd88
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.9 MB (144875638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec48935363e1a2008cd6fce85285fb1c1a701a7ddafe59e55c55f2efa6bed10f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 20:04:53 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:04:54 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:05:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:05:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d3d1c9d7de1f90f0b43e1cc263a7cbb209ec11c3f6d63bf754f3f72540ec4df2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f56f6a069460ffa0266b0c1dcf477308cc961ef20011f404c5a1b17db5b5d509`  
		Last Modified: Wed, 29 Dec 2021 20:42:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d02728c2db4b52f7649e5b69ba2566d1eec5b528fb158d639e9ecca8bb8cfe97`  
		Last Modified: Wed, 29 Dec 2021 20:43:14 GMT  
		Size: 20.1 MB (20137076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0305d0310942277b3f0d6ef15ec57fb969e7cecf0be741e5456e5d22af7fd658
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180918848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90a343f23e39585a7858204679c2bd7de81428514116d73c1671af5f370770c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:01:05 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:01:07 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:01:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:01:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a70b98d9eb49c154ed8f0b6c3fef6e4ecd8969c13e8ddfcb0ccdff10e5a1c160`  
		...
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a0189e1a281757e48916aa42fa3ff37d628ce90cbfc000db9f07f54ab767263`  
		Last Modified: Wed, 29 Dec 2021 20:29:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bccc6bf7bcdd15bb1e1210a595710332980cf0e1f1d925a792237f710e9fc7b`  
		Last Modified: Wed, 29 Dec 2021 20:29:55 GMT  
		Size: 20.1 MB (20136933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
