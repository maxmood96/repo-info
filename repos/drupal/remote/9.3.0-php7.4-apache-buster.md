...
```console
$ docker pull drupal@sha256:4072f8e97c16e152e4ae8889a584f5b53bf6a3e781d445a47ebdd6e9a02d8ee4
```
...
```console
$ docker pull drupal@sha256:51694f16b24b16af4488f563ebbf29ef050865aebef64ab0da3cef7a27bea3d4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.5 MB (169520637 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3c27fdf29e7bfc53fd94160465b8fae9c7aebe4003471a3246bfa17dfbcf8cd`
...
# Mon, 03 Jan 2022 19:42:23 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:42:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:42:35 GMT
...
-	Layers:
	...
	-	`sha256:b92de90e1fdec69997ff1bda9b9f311b5090b19a82f758bc098bce463232d01e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dee81be5fa9162994821d8d37480d552b073c550b5d75eb3ec4327444a25b45b`  
		Last Modified: Mon, 03 Jan 2022 19:54:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf989457e594a257ca05b90f78c8dfafd36a0799fca42f69486f56bf1e19d60e`  
		Last Modified: Mon, 03 Jan 2022 19:54:14 GMT  
...
```console
$ docker pull drupal@sha256:1b3565667751341c26acb5c2aeac276108f056a1e25b3b6466a01f7a6337b596
```
...
-	Total Size: **144.9 MB (144876042 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88d1459894a91bfb181f58bf18e4b7b12234cdd1a7c162c01ef73ffedff06159`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:58:17 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 20:58:18 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:58:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:58:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec639f26021fe35f5f92e87f143adc72d02c8d7d55f64ba7353821dbb755b5c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45ea967b7359b61dcfbe3748a8879ed6d1bc7055ececb932a0f4649b436cec58`  
		Last Modified: Mon, 03 Jan 2022 21:37:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cae23d0aed02dcbf7cb89cada8f2d289c9ad1274e5c66ad84f3336920dfe64c5`  
		Last Modified: Mon, 03 Jan 2022 21:37:40 GMT  
...
```console
$ docker pull drupal@sha256:d1d5441eb50fad9495949c36ac98f918150d5459d286de5a8ffc2c6acd8afd70
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160980306 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bb577660f5721c1d5de2c24a35f5603ce212aefca6922132328dd8c6ed1dc99`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 03 Jan 2022 21:39:52 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:39:53 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:40:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:40:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b9455770ba540fd38c4d3356cbac84c9340931283a0ed85885b5a74a2681d36`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95227a5bb1f43c6d62a46b6e8e86e4329799e9bedc8d2c992f414988f85365e8`  
		Last Modified: Mon, 03 Jan 2022 22:00:35 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:baa807e3fb1928438b600ed3415201b494b8d031042b11acb1d7fadbe55b0ce5`  
		Last Modified: Mon, 03 Jan 2022 22:00:40 GMT  
...
```console
$ docker pull drupal@sha256:da1a8481388d50a7e61e3b37b0a9e3fffd2a6dff05ec9af4658ee006eeafd51a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175546555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8da6b23daf7b988b381c622855b706a86d550dfea50abe268f4878a1ab33e17d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 19:58:42 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 19:58:42 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:58:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:58:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8c8accd550932d4c49ba3c6de2a44a358ede9331254868680285f0bb141efb80`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fb844435d4df6f384272465b17d92200cc21e52ef103a38c36af065941dd818`  
		Last Modified: Mon, 03 Jan 2022 20:19:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e038bc679176b0f19b4f5639c0d8609e95f1f56691548368913e951d4246a7ef`  
		Last Modified: Mon, 03 Jan 2022 20:19:31 GMT  
		Size: 20.1 MB (20137052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:29c698deda28a4545c07ac235dd8adc2f5fca6c31b5eeadfba79fbf7e4cfe797
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180919245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87b6d5899757c324422be3345e7360f40e15a57cbdb966727afb2005f6c7e1d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:28:07 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:28:09 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:28:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:28:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c3bd7c53600bcc28c43b14fd4dd413c90c3f90bcff7d9a61889e8e38ebdc0a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e050fa3ca53814e1e40e2ff05fcb5116e2f1fab7811420e43f2fe25c9c5be740`  
		Last Modified: Mon, 03 Jan 2022 21:59:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec9098bdbe935bd6adbd5d05320f41cae38160a02847fb267160e6ae898513a6`  
		Last Modified: Mon, 03 Jan 2022 22:00:47 GMT  
		Size: 20.1 MB (20137177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:67547bfdb3e630c30d5296f93c69d749302d8573b3ae125c931e1b0dde40d5ec
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155200433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c26502bc4d9ca987ebc592d52b135492205d4efaf94830cf16f1aa92dd85a022`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 03 Jan 2022 21:53:09 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:53:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:53:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:14f88a7ab2c766fb8698bb3e936ae343a3729b89a0b409ffc6aab1cd329f4276`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84c4f7b9a8d228fa10956b977f46e7bf7d9252ae1cc3b2e6e23909bd7d880cbc`  
		Last Modified: Mon, 03 Jan 2022 22:10:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:973ef64e439cd0e13933e09e2c50c377d0f264104ee058d9cb258b44e68d6af4`  
		Last Modified: Mon, 03 Jan 2022 22:10:05 GMT  
		Size: 20.1 MB (20136940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
