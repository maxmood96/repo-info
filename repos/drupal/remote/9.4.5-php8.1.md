...
```console
$ docker pull drupal@sha256:4101be53c3f3d2bfa13ce5b20c2673d242d79db526a1109020a6b3938147296c
```
...
### `drupal:9.4.5-php8.1` - linux; amd64

```console
$ docker pull drupal@sha256:8cb59df2e1f5bf638d19d79c04c0e24e7536532163acf6a2b2dce1efe4aaffed
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.1 MB (190073776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4633d150a064e209117239b736548745094326e7325ef1f650b2f047f460d496`
...
# Mon, 22 Aug 2022 19:41:47 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:41:47 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:41:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:41:59 GMT
...
-	Layers:
	...
	-	`sha256:681d60e5db931136cc5d1d650af380c5ddea93a8504cd75da7452a20845f644d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b59f800f1ed419bdd73ec2f926aa9a22c066b9334e996a4cc978411d3748597`  
		Last Modified: Mon, 22 Aug 2022 20:01:42 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2df62b3223422e86241a55b7c5172b1846dfa39b75bf8dc8227f656ebefc4811`  
		Last Modified: Mon, 22 Aug 2022 20:01:56 GMT  
		Size: 21.9 MB (21863232 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c2fc84435dd86e5e3fd932c7c173cc4d7f7fa0fdd1d11d12b58b1ab9ae1f000e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159616491 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa33753737f8c836213eb24404a429be2005438583dac822f6d6686bd884296b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:19:34 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:19:34 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:19:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:19:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a2c8d4514c735797097e93ff5c94703dd1e7dd2e9f7cf956c9c9a82437b00eb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:397b1bbdf42a84991ef86ab133e25633b96d32e9b6cb78dacdc866683d29a08c`  
		Last Modified: Mon, 22 Aug 2022 19:58:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63aa028364e5b9d27371a3573c19707b85d8460a4cbc4039a0a9d5b2a68ff288`  
		Last Modified: Mon, 22 Aug 2022 19:58:16 GMT  
		Size: 21.9 MB (21866321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:79f3ac6ce672d05d84fb65703bf95a41af0fed5af63ad8168b5996d949f4f496
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.7 MB (183694499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5c66dcaa15b9b0703159d45bc3754785e8d31e266bb85b1fb6fd2f18f352141`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:01:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:01:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:713272bf2ea5f900494fa5c52808a709b58610ae444bf6fb9ff53a4cbada4a80`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b1dbf45dcc50b3a4183870e48e4972d9b737468a03873f298f5f8c47f4caa23`  
		Last Modified: Mon, 22 Aug 2022 19:35:07 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d6695a1fb7dfd388ee21d5ad3bf82236739068f376771905c2f6f60f8f15891`  
		Last Modified: Mon, 22 Aug 2022 19:35:12 GMT  
		Size: 21.9 MB (21868239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:aaf4fd6bce97c9188cf63983365e5f78c8cafd0bc0cdce8367b99e0de5165247
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192331256 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecb7d4be158f2dcfb6e5d6785984c5563d108eaafc51db5f237b8049cfc5e54b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 18:59:29 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 18:59:30 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 18:59:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 18:59:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95117d2c0d9a5a8f73c42a09a1adc9b37c22ae0004750e788c8ccba8f3874e9d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dceed21f23ea88d8eed55279ad68f1afaa4815cbe093d4f553db01a83da89437`  
		Last Modified: Mon, 22 Aug 2022 19:31:16 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bd01f630fec38e88da83adb869567574b12a7c8cb868eda7a9e5ec693edc4c8`  
		Last Modified: Mon, 22 Aug 2022 19:31:22 GMT  
		Size: 21.9 MB (21866787 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:dbf424344a32e07a636f8e2249092ba5d9121c15309fa34365c744337dc782bd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190491536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:133d4af525f3e4ff71992e8bf15ba1c936a8c5fd5ebfcb63f38ecd2585e05f79`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:39:51 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:39:52 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:40:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:40:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:260b8832200bfc1c929bce960d5691230d6bde07c81d16809fa93764083f8c13`  
		...
		Size: 692.0 KB (692043 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e9949b22cdcbe36d13e42a1b71f4edbfa5d9bac561f141c26492aa95567ae51`  
		Last Modified: Mon, 22 Aug 2022 20:21:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:956c311382681d2f865b5d326d1b179ec4d7d3ffcf83a6a1dddfd8f84782e1da`  
		Last Modified: Mon, 22 Aug 2022 20:21:55 GMT  
		Size: 21.9 MB (21863542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:588414157d1eab9c9ae9c1754dd315fec8c097b53c8713ebe34652dc86ab3345
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166925967 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:277c735ea41e577c7781392aa32dca344fcead9ee052d38ad0c3bab4ade57e52`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4d0825f63a9e599415e16f45e6edd9174543d5a1499166c8c1dd3050562baaf5 in /usr/local/bin/ 
# Mon, 22 Aug 2022 19:03:20 GMT
ENV DRUPAL_VERSION=9.4.5
# Mon, 22 Aug 2022 19:03:20 GMT
WORKDIR /opt/drupal
# Mon, 22 Aug 2022 19:03:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 22 Aug 2022 19:03:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:707eff154913d86ca5acffd83ea109aed00e8e9fb645d22db52ee4ebb9256d1c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bebafa9535746494133e311e6ff2f62a10caf96977366f24d548db9a4b0d692b`  
		Last Modified: Mon, 22 Aug 2022 19:36:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dface30fa32d205378625b0811296984ff261e4d1e1052e0b457f9133f224297`  
		Last Modified: Mon, 22 Aug 2022 19:36:21 GMT  
		Size: 21.9 MB (21866088 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
