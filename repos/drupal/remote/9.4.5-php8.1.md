...
```console
$ docker pull drupal@sha256:c3aedbbfc31dd33cc3b6d3d3235345cd14bf78db1fefc21e1d3d3ef8c970de05
```
...
```console
$ docker pull drupal@sha256:7b801fa3bd8905bbcdf83259047ffdc969cfb2d7afc370105e04f416c57ae79a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.1 MB (190052371 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77f084417555a9f0cdd874e1dbda6e4c712cbc4606ee109742af64b4d689fe3a`
...
# Thu, 04 Aug 2022 23:36:52 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 23:36:52 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:37:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:37:03 GMT
...
-	Layers:
	...
	-	`sha256:177676a3eebbd2985b3f6f48c6ad4e48bf7fc0591f553fcfdc8e1335a7aeea8a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2fe2330208da3fe0743e0bbaa316c2f9c7974ce93ffa054fb655bf2abca4c8d`  
		Last Modified: Fri, 05 Aug 2022 00:00:05 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:521793276e20ee33a82e08154a6f8e5bc5ac6f544d77c12270ef9c68bf20641b`  
...
```console
$ docker pull drupal@sha256:eb382792392b2fae0c35e8247e30d0db69e9c047f3a40178161916c94b8c2ac9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159525364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90080db5637a8e679e1b2f47a534457e2764ee4078a726b8165e2b7026d65e41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:00:27 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 20:00:18 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 20:00:18 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 20:00:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 20:00:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6a18488d9a9590f9e8f93a95a934c6888592da22a25079248030733e7167fb73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:487bf70b3da840eab87d400def683494375146d0857ef729a1403cb6d6397d87`  
		Last Modified: Thu, 04 Aug 2022 20:47:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94e91ce37b4bb92fc7b7b764e7e2824d9fce21d02dddca017e7a81f541b91dee`  
		Last Modified: Thu, 04 Aug 2022 20:47:20 GMT  
...
```console
$ docker pull drupal@sha256:88b44551ed321fb4cb7d73d3ac936d4a313d490ae094a54301dbb9a9af80c174
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.6 MB (183602899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7742e6b857e71a204aecbfea71395985c2ef5afb8253b8453dfe34cd18c3ddaa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 19:41:36 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 19:41:37 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 19:41:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 19:41:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6ae130360655f37fceec8ac7d2c09250104b901c210a1a4c18d3f3917b06bee`  
		...
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74f483da87b0ff58d9d52377d409f4140b8f380b942c851730a7f46d12d2c592`  
		Last Modified: Thu, 04 Aug 2022 20:09:12 GMT  
		Size: 21.9 MB (21864766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:9f0efe08e9b899755492f292f548db0eb8234de3b1466ab8a5e873a89a282005
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192307853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1629dc41225bbb9e576767a16cbd1343e69148cfafa79cf322835ba95d490aa3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 23:46:29 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 23:46:30 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:46:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:46:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ed0bf0b7f37ad94734558f1bc12877139e860bb3ca1781f20a219938efc0ced0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:848160992aa18c746f02955eeddec9a93e6995db9257015d5accb908d4a2281d`  
		Last Modified: Fri, 05 Aug 2022 00:19:51 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6820478b3ebdb3dca921926156699790575dda16ff02670fdaaf01c4be7a73c8`  
		Last Modified: Fri, 05 Aug 2022 00:19:56 GMT  
...
```console
$ docker pull drupal@sha256:4c3bc7384dc0404541d629ad077986c6242134afbbde494e2a95ca00ec6826b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190470123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c407a57b00ba51e06adbcbcab8c734c630ddf53686a7848b46ea327a961dc26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 00:02:01 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 00:02:01 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:02:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:02:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:184fee8fa71cf859081574e155a02dbcbad09493c54b0d342b80f5c6fcbf3292`  
		...
		Size: 670.4 KB (670417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49eb1f5d995d3559b393b6ad2633f86aa214f0a85c2eb6bb3910cf25d2434e41`  
		Last Modified: Fri, 05 Aug 2022 00:37:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1a7099de45765e3e74e301b71b8175b6f1cd96fe5030b8168169e656cab90d7`  
		Last Modified: Fri, 05 Aug 2022 00:37:55 GMT  
		Size: 21.9 MB (21863755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.5-php8.1` - linux; s390x

```console
$ docker pull drupal@sha256:dd480c1fd1b99aa26f2a26d72380ade9caaa35b2642b4a25870949d7664bdc66
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166901932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c9ff71357c0246397e2b7c39aaeaaaeaa850ee29c71e55d63f6648c69774824`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 22:36:33 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 22:40:03 GMT
ENV DRUPAL_VERSION=9.4.5
# Thu, 04 Aug 2022 22:40:03 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 22:40:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 22:40:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1ee6045dd3633cf7f69f96e54f54b0a59ef3addc3355687363d62110fe8b224`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1c398f7fbe7ac8d4cc4b43b004433a2a8267806cc4ed8f9cc550ca24483f203`  
		Last Modified: Thu, 04 Aug 2022 23:05:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4faedcd6f17e4d5a76eccce4aadad3094c8f9a7d51c070ee71d48aa4c51ed0b`  
		Last Modified: Thu, 04 Aug 2022 23:05:51 GMT  
		Size: 21.9 MB (21863687 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
