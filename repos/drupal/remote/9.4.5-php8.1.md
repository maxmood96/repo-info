...
```console
$ docker pull drupal@sha256:70df3780cfdca015eb9b44790f9b1207dfec519a1ca823c43abb789b974aa7c7
```
...
```console
$ docker pull drupal@sha256:7cd21046bc8aaa1f87560827dae1c5eb19886312246463a7ca49d091d7f5ee6a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159591991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ce39e0900f4ddce6ff51e1695aae151473abfaecb7a91792798a81f477f93e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Aug 2022 07:39:42 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 05 Aug 2022 07:45:31 GMT
ENV DRUPAL_VERSION=9.4.5
# Fri, 05 Aug 2022 07:45:31 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:45:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:45:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9c6559d484bfdf2adf52d8f217e9a1599d67a348df0385b8e5598cc07000fd8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c30fc1dcdd880b4972f99b572c4eb6c3134814ebb802c4dcd1dd0650d823d79`  
		Last Modified: Fri, 05 Aug 2022 08:24:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3093df7b01d99b907c2633b43a1cc8b03608051b6c4cc61412725ea8296235e`  
		Last Modified: Fri, 05 Aug 2022 08:24:22 GMT  
