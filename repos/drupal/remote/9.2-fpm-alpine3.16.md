...
```console
$ docker pull drupal@sha256:d65315619039c0cdc885eee534790ef0c8fbc1d0263790cfbd4d04c1d195591d
```
...
```console
$ docker pull drupal@sha256:85df1e151712cf63d05f0871096b45f1512c14251f5ced821d8cd9db56d4de23
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48273471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e780ec6af430d8b1e3a72833bedaf24932d3e5b08d8baa7a9db77091c29ff222`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Tue, 07 Jun 2022 04:28:52 GMT
ENV DRUPAL_VERSION=9.2.20
# Tue, 07 Jun 2022 04:28:53 GMT
WORKDIR /opt/drupal
# Tue, 07 Jun 2022 04:29:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 07 Jun 2022 04:29:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:84661a387ab34dbb86f773e08aac02b3f614d6e9c3a05749a45abb9aa7e3794e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc6e3cbe377b6f48b037f62b0101526395ec43fd919bd5b0da12bffefc25a011`  
		Last Modified: Tue, 07 Jun 2022 04:56:07 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a69dc9a63444c2e888e43b1b468d3cbfb5b4d17e07f47aadd94e91d55a1e1c4e`  
		Last Modified: Tue, 07 Jun 2022 04:56:11 GMT  
		Size: 19.1 MB (19118244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
