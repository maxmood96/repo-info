...
```console
$ docker pull drupal@sha256:86e9f9c9b27c57fb068d91e218a4bed72a51f42c9583e73611da9f514e41b263
```
...
```console
$ docker pull drupal@sha256:408f04f09d44a43537ffab0fe897a64191c2cd0efd3949988a58426b39809d39
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48518429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55069feceefdaeecc3587a0496bb8926a65d9deef2058d6b59a579b33566d011`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Jun 2022 16:51:33 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:58:48 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:58:49 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:59:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:59:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:feedbaf6bbc3ead5ac4fdb0aa77827fd7b8a960d5a0ed2e7f0711dfd37fef981`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96a3ada068d7993a5345bf6f556198311d13dec5f4483aa9a987be28e11847d7`  
		Last Modified: Wed, 01 Jun 2022 17:22:21 GMT  
		Size: 661.6 KB (661585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87bcebf39dd0f32052f7ab4b730a0023f6c432757616a3dfa0dc5c69fc3b4cdd`  
		Last Modified: Wed, 01 Jun 2022 17:30:03 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1d924b588cc9746878381616abec3393333ad5c4b8f324d590c029e1806fa2a`  
		Last Modified: Wed, 01 Jun 2022 17:30:08 GMT  
		Size: 19.1 MB (19119611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-fpm-alpine3.16` - linux; 386

```console
$ docker pull drupal@sha256:c6d70eefe58b3a8093a178bc4cf0a289893c1942f9d36a71a5dfaeb5e73b68c1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.0 MB (49967850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6426f1a3d8cd7c838c9431635518388f94967b94c706aeab9961d363d1ef563d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 16:51:55 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:52:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:52:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:50d1f4dc3e161782788674b50823879ff2a4e8ce7416beb39b01d1e6b093c484`  
		...
		Size: 661.6 KB (661584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40857ed74ad6fbd8e63918fc44c8ac928e0b6c1a6786119ebd715ad97dd22e0d`  
		Last Modified: Wed, 01 Jun 2022 17:23:23 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1de020f808d9b7f981cb3a7f82edb194eb10cfb4f2e8be21be7c6e3351adc345`  
		Last Modified: Wed, 01 Jun 2022 17:23:28 GMT  
		Size: 19.1 MB (19119486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
