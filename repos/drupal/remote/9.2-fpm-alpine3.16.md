...
```console
$ docker pull drupal@sha256:3cc950d4fdb36e79925681b19e823610a3e89459894c2f042352985e757d4c59
```
...
```console
$ docker pull drupal@sha256:2b38aca1afc4dbc957bc2b9bc7874626dd88b6dc54db5e291aed03315c70fc76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.7 MB (46696880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3ade2b01b6ebcf5fe4007ac8f04cda7272727ecc2808f3d504d79a7718fc0c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:20:54 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:20:55 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:21:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:21:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:265436ff16b808f818b8936666c084edc3aaa2b965af39f7c3468625eeb001e4`  
		...
		Size: 669.8 KB (669838 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9821efb9e07788c124fbac370c97c90cbe084e46fe8d2df960fe9054cd295940`  
		Last Modified: Mon, 13 Jun 2022 21:13:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab1bcb9ce4e482932a61bdc535f599d903f381ec9b49ce3303087f8e79aa0fd1`  
		Last Modified: Mon, 13 Jun 2022 21:14:11 GMT  
		Size: 19.1 MB (19122226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:47d36e3add0b1465919557770842ec7a5f8bc7ef70f122c4ac2ad13dae3143a3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49913361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f974157e0871cf53d7acc7ead382cdaf3d0b1c6629a68271a0bdd8d40f76aca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:13:39 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:13:41 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:14:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:14:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9c26af52fd9078738cbe153c90ae4bae24e6f2bda6f6a6581a95d1dc49e36ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd4e3ed2a4013fb94e98aa72fe00862ed1aa117c44684d768075a473fa5fdb1d`  
		Last Modified: Mon, 13 Jun 2022 21:24:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c56d33ae33fa97cef92da150f8e1b82a2d546be48a35a7093e23d4d0a8563d4`  
		Last Modified: Mon, 13 Jun 2022 21:26:12 GMT  
		Size: 19.1 MB (19121849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
