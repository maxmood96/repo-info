...
### `drupal:11.1.4-apache-bullseye` - linux; amd64
...
### `drupal:11.1.4-apache-bullseye` - unknown; unknown
...
### `drupal:11.1.4-apache-bullseye` - linux; arm variant v7
...
### `drupal:11.1.4-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:11.1.4-apache-bullseye` - linux; 386
