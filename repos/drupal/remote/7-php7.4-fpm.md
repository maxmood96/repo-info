...
```console
$ docker pull drupal@sha256:ec51c2ff3b4da9756e7394323d62c354398d93f9c12fa8d1f7b916317c61f52f
```
...
```console
$ docker pull drupal@sha256:075d65f491625bb2339c7ee7b8e0343a3cdcba18085fddd0ea2a016d3fba703d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (159044803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02d67189a8102dce0314fa4c0f008e0977dce64f153d8f5bba46a8594c8d8381`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 07 Apr 2021 22:22:29 GMT
ENV DRUPAL_VERSION=7.79
# Wed, 07 Apr 2021 22:22:37 GMT
ENV DRUPAL_MD5=672d35b4e172721452f351ee01644d76
# Wed, 07 Apr 2021 22:22:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5003a7ab51547ac8a9ce5a1f121a756b40cc62234e31d212dadf9786d665dca7`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17ef303d5d9fe841cdb70b699d4c5c0aa44f41581309cc9ac4bfe5938f2d3a5d`  
		Last Modified: Wed, 07 Apr 2021 22:45:31 GMT  
...
```console
$ docker pull drupal@sha256:2f8c07d36a9fce2bed88bede156cc2eb3d313a2d2a24554f8b5167998d38d0ac
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.8 MB (133844121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79fe9df5e83de3a120e1bb463c18a638f5a79c262957be0c0bc2f67f31bfae3d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Apr 2021 01:02:14 GMT
ENV DRUPAL_VERSION=7.79
# Thu, 08 Apr 2021 01:02:15 GMT
ENV DRUPAL_MD5=672d35b4e172721452f351ee01644d76
# Thu, 08 Apr 2021 01:02:18 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:936bce3dadd8af314d8bc224f7079cc07fc4a61af7d196f7ec0c6acff17f46a3`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa2c510bdce0ade7d783c028a69e91ec8a7a794f49eb8345d7bdc5b71cbf2b20`  
		Last Modified: Thu, 08 Apr 2021 01:12:48 GMT  
		Size: 3.4 MB (3365554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
