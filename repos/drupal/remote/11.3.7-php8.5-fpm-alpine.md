...
```console
$ docker pull drupal@sha256:43b62573e518ac163d9043d86dcfd815a15a4b12d99e0a186b0fecb2be0659a6
```
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; amd64
...
### `drupal:11.3.7-php8.5-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; 386
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; riscv64
...
### `drupal:11.3.7-php8.5-fpm-alpine` - linux; s390x
