...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; amd64
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - unknown; unknown
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; arm variant v6
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; arm variant v7
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; arm64 variant v8
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; 386
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; ppc64le
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; riscv64
...
### `drupal:10.6.11-php8.4-fpm-alpine3.24` - linux; s390x
