...
```console
$ docker pull drupal@sha256:330a6d12d279a9d77198e82010f650a9f653d564c8f439ee69d9d772913f21fd
```
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; amd64
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - unknown; unknown
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; arm64 variant v8
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; 386
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:10.4.8-php8.3-fpm-alpine3.20` - linux; s390x
