...
```console
$ docker pull drupal@sha256:054b8dbb0dd32a632fcdcefba8126668f66b730644631dad28090a59fe6a08cf
```
...
```console
$ docker pull drupal@sha256:555f4163b1e9a23df2f2985d1a85e8fb12d672f823726791e8638eb6414e694c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52146680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d8672d7796cd41ca784ad5bc4e4fffc657ccd0c09c443ce70b81d63609cd80b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 09:15:50 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 09:15:51 GMT
ENV DRUPAL_VERSION=9.0.8
# Tue, 01 Dec 2020 09:15:51 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 09:16:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 09:16:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:af68f5335f04b4d44b194b510ef138ae33f6a719504b7424c8913ec48729f66a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e968070ae27cf897a1a26b314ae59eb59f984ea1bda984aa9a785b43d1882b`  
		Last Modified: Tue, 01 Dec 2020 09:21:20 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2194c9813e0475ff13dcbe15b17781046dd21cf19c7f780fd743631ffd3d22c7`  
		Last Modified: Tue, 01 Dec 2020 09:21:39 GMT  
		Size: 17.2 MB (17232207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
