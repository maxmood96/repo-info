...
```console
$ docker pull drupal@sha256:71273e1e73e82ca181d4fd42d69620bca6696810e4ca5cc4e93d0762e079accc
```
...
```console
$ docker pull drupal@sha256:68732ab306c30d9a270cec5030bf55e8e4a03e505051e1556362586c3616d60e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.1 MB (51109878 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfc3d6702574b8769326b6c3cf24f95446a2979f40fcf8c13ad6a2060934b5bb`
...
# Thu, 22 Oct 2020 09:27:14 GMT
WORKDIR /opt/drupal
# Thu, 22 Oct 2020 09:27:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Oct 2020 09:27:34 GMT
...
-	Layers:
	...
	-	`sha256:ecd76a4619f33535cd7a5ac6d94c04d23f34ed74bc051ce53f9ec2e233637887`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2c73111078666b0925994f70dd0d66ad67ac82483227d7e9768ab0715dee646`  
		Last Modified: Thu, 22 Oct 2020 09:31:07 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:568756633669da93267756b17423016283bb2813aeabfe7ff978b4acfb6c5b5e`  
		Last Modified: Thu, 22 Oct 2020 09:31:13 GMT  
		Size: 17.2 MB (17227360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; arm variant v6

```console
$ docker pull drupal@sha256:63033c399d77430f3140efeb6bb4fd23e41f7213510506d8f1b85b87188cedbd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50133214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2d4abdb2237b023059b4b6d78c4c502dd20ddfcffa775c733bf6e78d5bbf68c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 20 Oct 2020 01:06:22 GMT
COPY file:72093f87dad8687147a6149eb182f1cb44a77f2b6888d834ed8e794be60e7def in /usr/local/bin/ 
# Tue, 20 Oct 2020 01:06:23 GMT
ENV DRUPAL_VERSION=9.0.7
# Tue, 20 Oct 2020 01:06:24 GMT
WORKDIR /opt/drupal
# Tue, 20 Oct 2020 01:07:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 20 Oct 2020 01:07:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:105ac2007b682f602a2b78ffb5b8f2002eacb5e0cad5945c180a53d19667a375`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d09a1462e613e9ec79f868037be2fef0796cd21c3236fc2c509dfac514675daa`  
		Last Modified: Tue, 20 Oct 2020 01:09:47 GMT  
		Size: 508.0 KB (508039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87f93b8f9270623754450fd1a4a51b844018bd03a0217229ebbef9cf40396963`  
		Last Modified: Tue, 20 Oct 2020 01:09:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbb50fe5f4ebb8e87dccb9a8b513c213472434bb7dd692e2ce8e7bd9a7494c9d`  
		Last Modified: Tue, 20 Oct 2020 01:09:58 GMT  
		Size: 17.2 MB (17228512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; arm variant v7

```console
$ docker pull drupal@sha256:5d74fb27fe57a489568e8676922e533fefa8eff98b1d73a8f676c63771758bbc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.3 MB (48307363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:483357b9d02b253a5a1e4603734dedbdb7968d0887c972ead252bd378636d73e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Oct 2020 09:45:23 GMT
ENV DRUPAL_VERSION=9.0.7
# Thu, 22 Oct 2020 09:45:24 GMT
WORKDIR /opt/drupal
# Thu, 22 Oct 2020 09:46:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Oct 2020 09:46:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:efda54cec7263ae1292c61b1f282a4d0c5c92065fc524bba03a96494d0864dcb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9848d3bf2c2f6df6567ca0e142ff982f8ac270af2a7f6722921c4d864c6ec972`  
		Last Modified: Thu, 22 Oct 2020 09:49:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea14bdcac346e35768eb91ee07a414e5217261fa0ec2b45e928301408e8e6a3f`  
		Last Modified: Thu, 22 Oct 2020 09:50:27 GMT  
		Size: 17.2 MB (17228364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5ca52558d3162905828128c5556023a4578a27d094b558695c202661f776c0fe
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51447984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04d472a807c40da34dd5a790935ce8f2df74bafa9953b259db87df1bcd6a23fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 20 Oct 2020 01:57:48 GMT
COPY file:72093f87dad8687147a6149eb182f1cb44a77f2b6888d834ed8e794be60e7def in /usr/local/bin/ 
# Tue, 20 Oct 2020 01:57:49 GMT
ENV DRUPAL_VERSION=9.0.7
# Tue, 20 Oct 2020 01:57:50 GMT
WORKDIR /opt/drupal
# Tue, 20 Oct 2020 01:58:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 20 Oct 2020 01:58:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:db48096a2b6a041cddd4c2fe3c44c1ed1f13913aaebd5ad9e252a77e308d9d54`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c868f0e2bf72f240c9f6861a46177e51902230cafee4e667cccd7167264b26e`  
		Last Modified: Tue, 20 Oct 2020 02:07:22 GMT  
		Size: 508.0 KB (508035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4805896df6f7b76549c1f97936b691dea186a2d51bd82996cbee95eb3386300f`  
		Last Modified: Tue, 20 Oct 2020 02:07:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f5c16572204e9f99bc518d2741cd3e5573a9c0eb94e23ab116c55c1529c132b`  
		Last Modified: Tue, 20 Oct 2020 02:07:31 GMT  
		Size: 17.2 MB (17228403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; 386

```console
$ docker pull drupal@sha256:87684ce0786fa5fd461eac09c424106b3ff5f8996760e2da8c0e6db5a5ef42fd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52378081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c87c441179d4c2b0ded102179a03f9ade2da0f4a40eafaab14067c39b617849`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 20 Oct 2020 01:55:19 GMT
COPY file:72093f87dad8687147a6149eb182f1cb44a77f2b6888d834ed8e794be60e7def in /usr/local/bin/ 
# Tue, 20 Oct 2020 01:55:19 GMT
ENV DRUPAL_VERSION=9.0.7
# Tue, 20 Oct 2020 01:55:20 GMT
WORKDIR /opt/drupal
# Tue, 20 Oct 2020 01:55:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 20 Oct 2020 01:55:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2ae1c1ebb8aa195fba955fe3e5aa758b5920ef5b8c7579b5f43f2a601fb56db`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc6819006d96915bdad3cd545a158a71118d16efa8a72d829bb3377a06502c82`  
		Last Modified: Tue, 20 Oct 2020 02:00:38 GMT  
		Size: 508.0 KB (508032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d82adc4af5d35214bf725d9ed263e447426a3f196a81e51a5a6db4f567b5938f`  
		Last Modified: Tue, 20 Oct 2020 02:00:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80c83ead4e4c01e99540a60acb0dca4304f0d35bb88a135c65e0d08b4e498abc`  
		Last Modified: Tue, 20 Oct 2020 02:00:48 GMT  
		Size: 17.2 MB (17228102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b60f4a34f54c1e5a79d9197a8874bd968dbdf2245d047fd5b37d738f1490832f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50658140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47c36a01abc90c274400790ac509cc6651a9e0d95a28b763f8df5328e939a81b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:72093f87dad8687147a6149eb182f1cb44a77f2b6888d834ed8e794be60e7def in /usr/local/bin/ 
# Tue, 20 Oct 2020 01:59:03 GMT
ENV DRUPAL_VERSION=9.0.7
# Tue, 20 Oct 2020 01:59:03 GMT
WORKDIR /opt/drupal
# Tue, 20 Oct 2020 01:59:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 20 Oct 2020 01:59:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:787eb3d98119e7ce2436d37ef759dae443e5a3ba023b93c76e4a90762ff58e30`  
		...
		Size: 508.0 KB (508035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a142bb3d8f8190242dd7a469c0a3a09c5dfb2200b30af3d304e33b4d56e4c2a7`  
		Last Modified: Tue, 20 Oct 2020 02:07:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dce2ca8488300c7f5a8b96f89eae2003cff62eb0cb62fa031bcd2a5107650ac0`  
		Last Modified: Tue, 20 Oct 2020 02:07:23 GMT  
		Size: 17.2 MB (17228280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
