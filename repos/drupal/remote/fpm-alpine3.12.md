...
```console
$ docker pull drupal@sha256:3a6ab563c3918e94e3aa4a648282e8db4cb23537d096a7e0c11f3d8fe5af751d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49911203 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:323ec2f6c5bc0ccba7d41e5d4c88fc279a246e30914a4db48635bfa643fde934`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Mon, 10 Aug 2020 18:12:42 GMT
ENV DRUPAL_VERSION=9.0.3
# Mon, 10 Aug 2020 18:12:48 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:13:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:50:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a3041ecc95eecf4c8fd375b92b1888be62154fbb80778d4b82dfff1317b80f8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3162f9c6ca1dc9f31d63869df47b700003880e08eb42d8a18d89b44d466eca49`  
		Last Modified: Mon, 10 Aug 2020 18:18:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a3e0e5913a676dcd295d160e918f98b6b4906766326bbce62edf89280bd7ca7`  
		Last Modified: Mon, 10 Aug 2020 18:18:41 GMT  
		Size: 17.2 MB (17226517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a729ab012ad19914e62d015d514941f0613fcaee4aa85a5c0e54b64c414b298b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52119735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:667fbd30068d3c170d5b57f05fd7eadddd5620bf740a0f08f0fd93a3ca73c3f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 10 Aug 2020 18:56:51 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:57:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:38:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cdf082cd3b5602be1da600d9ab13e672cbe185e82855a9d607efeb4ca3c7b740`  
		...
		Size: 508.8 KB (508762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ea1ad83e70d2e1e4c1494a571af76c458a78a7d33cfa0b4e18d8a0ff0bbf0a2`  
		Last Modified: Mon, 10 Aug 2020 19:02:33 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0529fb1b28dcdef468dc4b28bab7a8d56960b7da83b8522248d293fffa93f3e3`  
		Last Modified: Mon, 10 Aug 2020 19:02:51 GMT  
		Size: 17.2 MB (17226286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e76f5251667ceef5a09ec4bfe2f319266b5b5f6c6e79e9ddb41794e704f2892f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50424731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10ed0aeda3c70cb937759617b9871d63468a0fb0a37dea1fd471d911c17adbf4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 10 Aug 2020 18:58:38 GMT
WORKDIR /opt/drupal
# Mon, 10 Aug 2020 18:58:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Aug 2020 23:41:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ddb157d2b45d4916ac3e41d742320097985a698bc66e999c18dd91185ac01047`  
		...
		Size: 508.8 KB (508762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e99aaaeb5eedd9ea17329a551660ecc1198708dd3c5757b18a78fd1e627279`  
		Last Modified: Mon, 10 Aug 2020 19:04:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6948ecbb6b303097a0b8b072fd2d67f5aa81ccdde1a4279ee33bf6c78c7ba4d2`  
		Last Modified: Mon, 10 Aug 2020 19:04:40 GMT  
		Size: 17.2 MB (17226530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
