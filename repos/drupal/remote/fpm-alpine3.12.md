...
```console
$ docker pull drupal@sha256:e8317234912987d8fb92f8836ec6c2d6ef731d232aca657f7e2d95ec4a90d9cc
```
...
```console
$ docker pull drupal@sha256:071be7ef53545c79475b085da57fc249c6466e969a69e2bdb11659157fdf88ca
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51491023 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5268e82b02f5d92487d58dc65d5d2e7a8782aff8f9a365ed1cde096010bbb16`
...
-	Layers:
	...
	-	`sha256:8a6986b4d6802af2793f8e4dcec6446ebe6758fedde2db392e8cb3cdcba71076`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aa9d8b9931f9e6f188f9d0c70491d8c575c350509ad38174e6bd8c489487d72`  
		Last Modified: Wed, 09 Sep 2020 19:41:26 GMT  
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c15964ff13c4959650840b526915e56da493b3b9f3184092bcd450ff8d96940`  
		Last Modified: Wed, 09 Sep 2020 19:41:26 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81fee014759180cc795fe02bd02415dfc36276abd7916e86f4d7ee1ed13bcfd5`  
		Last Modified: Wed, 09 Sep 2020 19:41:36 GMT  
		Size: 17.2 MB (17226560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; arm variant v6

```console
$ docker pull drupal@sha256:7c8de57501e9187036053f846b9ec7e466a2b7e37d61de0302705ac2a714cca0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49919047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad39403855db211ed68a22d8eb2b35ee36f75a79f131e13e8a16f41878044385`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 10 Sep 2020 18:09:12 GMT
ENV DRUPAL_VERSION=9.0.5
# Thu, 10 Sep 2020 18:09:19 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:10:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:11:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fa99203e6ad97bdfb0b8c5e0d760622249b880d1fd12bff5f6eff9a7d3239069`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:007a6f40abaaf9e208f0fdd04dce9bb034ea2fa24e128d588b22aa89738a0f88`  
		Last Modified: Thu, 10 Sep 2020 18:16:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79154c08435897e25c75ee78e31a914c57dadef4cc3aeb01b5318ed5987de819`  
		Last Modified: Thu, 10 Sep 2020 18:17:09 GMT  
...
```console
$ docker pull drupal@sha256:77885b8aa42bbfe2538757bd986b74cca0b8f8475a2906c78c211eb2042a8cb4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48654793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c199e1a1f3d2927bd8bc7c9aec25f996c08578db1daa64d96c42a5bc22ee7398`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Sep 2020 20:36:44 GMT
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:36:45 GMT
ENV DRUPAL_VERSION=9.0.5
# Wed, 09 Sep 2020 20:36:45 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:37:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:37:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:710431b6d372d68632cedaa18f52cfd3eb4f9e906dd16c0dde61de8816fdb4ee`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e0fe9e5be5f87a4388d9be98230ea15920e7ddf87dc420e5939b474d497a734`  
		Last Modified: Wed, 09 Sep 2020 20:45:10 GMT  
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8700a51d410c16e75eded2c2fa207d2c91eaf50a24a71e992de272666d380543`  
		Last Modified: Wed, 09 Sep 2020 20:45:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:705ac7b3cad619cbd44b52574ab8e48de9735c2232a92cdb3de888a9fea0fc9a`  
		Last Modified: Wed, 09 Sep 2020 20:45:21 GMT  
		Size: 17.2 MB (17226613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:3021b5ed6afd597cdc8c30c1c5f0da561032dc21d5195589a524c34091cf60d2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51211989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffcfa5d21598c598a0414bfc9d8fa577d774a812cbe8b9817a6ea3c07bf6e87a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Sep 2020 20:23:51 GMT
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:23:53 GMT
ENV DRUPAL_VERSION=9.0.5
# Wed, 09 Sep 2020 20:23:55 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:24:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:24:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:880cd1c271de2adb86ba8c4f363b321ccfab0fc7cc803919d3a275d1494b1ff1`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bef4716fd261156c2bf39a8959b167a1c649dfbbe8121d1bc78203ea5ef85b0b`  
		Last Modified: Wed, 09 Sep 2020 20:31:35 GMT  
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42c3e7c2e6330e97e1913dbd4c3975cdf956c0bab1e40eeb9f5a0770defc3d0d`  
		Last Modified: Wed, 09 Sep 2020 20:31:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c4230f029c76bbb771352ef510d760f81f61dc8e2aaa500f78c63ea88149a3d`  
		Last Modified: Wed, 09 Sep 2020 20:31:44 GMT  
		Size: 17.2 MB (17226800 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; 386

```console
$ docker pull drupal@sha256:ea851a5c6f6dc2f34e271e8b521add1914b2f619bd00740cecc1a6b52d3e21fd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.1 MB (52129789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a9ff6f889e1141a5814809e9b45b27053b8770dfd2572d606387b55ae0d938f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 10 Sep 2020 18:57:08 GMT
ENV DRUPAL_VERSION=9.0.5
# Thu, 10 Sep 2020 18:57:08 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 18:57:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 18:57:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ca592d0c8fbb5772ebf4fc92f5433fe695d6f2939079bd824cf8e1a3d27ec8d1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28f31131a34720b80ed3ddf992861d1a3e9c61ed3f8434b2d45517e2ffcc0d4a`  
		Last Modified: Thu, 10 Sep 2020 19:03:24 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abca49fca89b68888b96f2ace9b9b12fa7bb1a7c599a4273f3b3354f1adc2e53`  
		Last Modified: Thu, 10 Sep 2020 19:03:39 GMT  
		Size: 17.2 MB (17226603 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; ppc64le

```console
$ docker pull drupal@sha256:4ab8c145878837a68dede5ad8b11ca7f977e6fd110d149c8c35dcd49fa55837b
```
...
-	Total Size: **52.6 MB (52628149 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55edd047d22e574a64b5524f6740195afe2fc59b2fd21f02658487060f78b535`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Sep 2020 20:38:30 GMT
COPY file:abcca8f78b1031d3d546723890f2ae4c6b2575830023ed634daaaec77093c96f in /usr/local/bin/ 
# Wed, 09 Sep 2020 20:38:47 GMT
ENV DRUPAL_VERSION=9.0.5
# Wed, 09 Sep 2020 20:38:54 GMT
WORKDIR /opt/drupal
# Wed, 09 Sep 2020 20:41:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Sep 2020 20:41:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2addcc671ad23cce2f183efeb0441ff9b28254c704119b691945d8378b6d762`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89918b01ce14978a5dc1d716ff27de98724dcd01fee8a9866063f1a49a3391b0`  
		Last Modified: Wed, 09 Sep 2020 21:10:18 GMT  
		Size: 507.9 KB (507869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b15d028769602591185797f8f5b45391ddd1136c9e9239a3498b8f22de5e0b6e`  
		Last Modified: Wed, 09 Sep 2020 21:10:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44dbb10d6349093810e13bfe0df0a3b6cd5dbf6bbc91b8182d0934d127069986`  
		Last Modified: Wed, 09 Sep 2020 21:12:13 GMT  
		Size: 17.2 MB (17226588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:fpm-alpine3.12` - linux; s390x

```console
$ docker pull drupal@sha256:225d4f8fb615dc39a563af2359c99777eab0ee7e8c00496499ffb7d4078ea5f1
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50434393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b68fde110a22126147bfb552cca33f389e9c7f6caa90ff992d50f1e1173acb83`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 10 Sep 2020 17:58:44 GMT
ENV DRUPAL_VERSION=9.0.5
# Thu, 10 Sep 2020 17:58:44 GMT
WORKDIR /opt/drupal
# Thu, 10 Sep 2020 17:59:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 10 Sep 2020 17:59:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc7a928a8a2c2a0f0e242d3d55f2a7f6c6fe6d069422641fb390835e6e69e673`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e6649c3cd3e9c0a30da5a7c930ba310ee418fb7e4c5968b9a27c7c1f8dff49d`  
		Last Modified: Thu, 10 Sep 2020 18:04:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b84fd22e4562a4cdb8ac3d8c41c35170fbbcfd9ac98c7c4da90728f12da2c58`  
		Last Modified: Thu, 10 Sep 2020 18:04:49 GMT  
		Size: 17.2 MB (17226525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
