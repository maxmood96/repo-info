...
```console
$ docker pull drupal@sha256:3ffd8887643218c57dcb7c427ebe0ee6bbdd5ce2f7f9b95d030a3218887bc24f
```
...
```console
$ docker pull drupal@sha256:ad85a2eb80e2a1008894ec6c1eae25e5baa9cabe5f7960c1cdaab4fe1bc347f9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49919923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85f946fd2ec1e84515ed0e77006af71bbec7ae8ecf12684fe42134a743960ebb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Wed, 16 Sep 2020 23:51:11 GMT
ENV DRUPAL_VERSION=9.0.6
# Wed, 16 Sep 2020 23:51:13 GMT
WORKDIR /opt/drupal
# Wed, 16 Sep 2020 23:51:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Sep 2020 23:51:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fa99203e6ad97bdfb0b8c5e0d760622249b880d1fd12bff5f6eff9a7d3239069`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fce6a7514b81d649c4092db7157556a02bce376791ff94e189b34411588c6170`  
		Last Modified: Wed, 16 Sep 2020 23:54:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b3cc60670c12ca8634df9254451a04f8454fbc6c2b05d03b5ec4b7a2f36d122`  
		Last Modified: Wed, 16 Sep 2020 23:55:01 GMT  
		Size: 17.2 MB (17227431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:34d064af420a67d6f07091598a9de9d460759727b60e16bdc862f5536b39bba7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50435053 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a700da049fc06e4c1282cd827c38468013e268dcfa5f8bbda6ca12061a4ca64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Wed, 16 Sep 2020 23:49:22 GMT
ENV DRUPAL_VERSION=9.0.6
# Wed, 16 Sep 2020 23:49:22 GMT
WORKDIR /opt/drupal
# Wed, 16 Sep 2020 23:49:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Sep 2020 23:49:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc7a928a8a2c2a0f0e242d3d55f2a7f6c6fe6d069422641fb390835e6e69e673`  
		...
		Size: 508.0 KB (507966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3effdf96337770b2e2cdadf0fe6f5df65d45a21a9c9666fab8a85623a454bc20`  
		Last Modified: Wed, 16 Sep 2020 23:54:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6522fd07665aa45ed1dc4b07ecc423235f8f9b2ec2555475b51194ad1740508`  
		Last Modified: Wed, 16 Sep 2020 23:54:54 GMT  
		Size: 17.2 MB (17227185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
