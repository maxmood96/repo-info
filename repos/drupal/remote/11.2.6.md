...
```console
$ docker pull drupal@sha256:2fdcfcec9df6f03c111afffcb9959c905d9f5e48e222bf358a3a8f2671244401
```
...
### `drupal:11.2.6` - linux; arm variant v7
...
### `drupal:11.2.6` - linux; arm64 variant v8
