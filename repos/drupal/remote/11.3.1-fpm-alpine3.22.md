...
```console
$ docker pull drupal@sha256:1519c98bf140661be7e8bf060fc7aea9ca3ffcd37254a21c1552594a02da641b
```
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.1-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.1-fpm-alpine3.22` - linux; riscv64

```console
$ docker pull drupal@sha256:dc1b520cb2862b667d52e269f4b1e8205a03267b891474cd128974e5ce3d0a9d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.9 MB (58883195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dde28abc31ca5dcc19faae7f099c321bfa1829202ea6582cd42bd4b3fa7581a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3c3e00911e0c0e72cef30f5e31dc21881cb59e0207c2701e328823b70d3ebb6f`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:34d390b8ad02383ce3fe222ccc71448c8c94b21d03574c78f24d577a463818e6`  
		Last Modified: Mon, 05 Jan 2026 10:06:46 GMT  
		Size: 21.3 MB (21293443 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.3.1-fpm-alpine3.22` - unknown; unknown

```console
$ docker pull drupal@sha256:a77bfa21608156edbef665e0a08ff9d626df6270adf801eeb435bacf17467513
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **407.0 KB (407013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b11af5568cdd1368995bbdb3a7c9def265dbf15eb7bbcd3671ebb6744e81c741`

```dockerfile
```

-	Layers:
	-	`sha256:f76313b6087ca078f3ffcc28e335f92ed45756ed6f46562f30ac2def305456e9`  
		Last Modified: Mon, 05 Jan 2026 11:56:55 GMT  
		Size: 372.4 KB (372431 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:a2bbe36fc76b2184157762d5265707c3a165abd8de0fdd8e7bee66143e60f899`  
		Last Modified: Mon, 05 Jan 2026 11:56:56 GMT  
		Size: 34.6 KB (34582 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.3.1-fpm-alpine3.22` - linux; s390x
