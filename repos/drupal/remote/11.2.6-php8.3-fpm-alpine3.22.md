## `drupal:11.2.6-php8.3-fpm-alpine3.22`

```console
$ docker pull drupal@sha256:67ed33226b36005ac0a10e234070136f12faa06597380e317dbbea4d7ae65e02
```
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; 386
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.2.6-php8.3-fpm-alpine3.22` - linux; s390x
