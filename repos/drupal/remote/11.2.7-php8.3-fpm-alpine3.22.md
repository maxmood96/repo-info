## `drupal:11.2.7-php8.3-fpm-alpine3.22`

```console
$ docker pull drupal@sha256:6c692beb50c350b2b6dcfde95420f89e4247efde915b8c97cd6642876832f1a9
```
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; 386
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.2.7-php8.3-fpm-alpine3.22` - linux; s390x
