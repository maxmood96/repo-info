...
```console
$ docker pull drupal@sha256:2db54ea4b0d305e8ac7636b302a701cf3a7a27197d38981a36faf6ced3b431eb
```
...
```console
$ docker pull drupal@sha256:dd72c209bbd4b7b2f13427f1d3f23bcafec0655ae5cdb3f0d06b043614d57f0e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146055591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78a003285f3c1e330ec640c4510765704d3300f9b487578b14b4e77a9284ce1e`
...
-	Layers:
	...
	-	`sha256:64744df7b009d8d3ba4b818a808d6f68b03530ea46a9cc5baef3cb4c0ac9aa7a`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cac7c73b1b414cda19c157ba23c80c64a2aa12aaf9f68ee36bd9af4f913116e2`  
		Last Modified: Thu, 09 Feb 2023 16:47:20 GMT  
...
```console
$ docker pull drupal@sha256:11601f4fb86187e2da4b4d6bd990396ef266a991f9f268bb103c9f3d26ea1af9
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.7 MB (121659127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:696ba94caedc81015fe11849bde8251c203cbf1543c6adb3a32255e75bed23fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 05 Feb 2023 09:03:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sun, 05 Feb 2023 09:07:41 GMT
ENV DRUPAL_VERSION=7.94
# Sun, 05 Feb 2023 09:07:41 GMT
ENV DRUPAL_MD5=dae634ea0da005c5c435cfa9a9c5c322
# Sun, 05 Feb 2023 09:07:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:20b7a24c1aa1b10611d03b04bf6e7b0d413d3c6dceda1ae300615c57dd86ac0d`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d90c85386e6ac675f492a494d697c898f523c801f0656716ac98dba76680695`  
		Last Modified: Sun, 05 Feb 2023 09:39:01 GMT  
...
```console
$ docker pull drupal@sha256:e4e10c90c5eca97e372972441e70d1c8d81d81200f910c331b422f8369c581e1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.6 MB (137607061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69c0a29841c1ed184c18016f02d9918eb14768eb11b33156e57b7d52b3d8fa37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:68515bcff176cb75fab8bc2e65ee4b936abcc3c3b9816eec68a99e6b78db956d`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53a603bb5c34fa865bb17bd698442fe5efccfcb891820745b30f2903c413fb26`  
		Last Modified: Thu, 09 Feb 2023 14:58:16 GMT  
...
```console
$ docker pull drupal@sha256:b1806b035cbd391916b97481c35f3e5a64283d2f59a07ccacb05dbf7907f4be1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.1 MB (151140568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e6f5947798b14905f6cf0d30892d34efd8c0f5a0354a5f7fe9f8bfc49b9a2b5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:7a5315e45cdfb1ae6ab852768fca5e2a057705c90190640b4754d765cb15af42`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a07dcdf340a5a29c2e402ba3717adea6a247b26a21f3862a52134009d88c36ac`  
		Last Modified: Thu, 09 Feb 2023 18:15:02 GMT  
