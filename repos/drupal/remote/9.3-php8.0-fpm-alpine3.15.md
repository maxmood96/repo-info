...
```console
$ docker pull drupal@sha256:87f4c8440c07fd399c24366f52bdbb990a987236f1280e9309744865f49bb2c2
```
...
```console
$ docker pull drupal@sha256:02fe961fa3c2d8753038a6503dbe16dd2e94ff83531206623e68794dfb67ce47
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52214946 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ed961e155f83a71032127af5d12a8be7b334bad2a84579bb05eecc37367b5cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jul 2022 01:42:28 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:59:21 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:59:21 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:59:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:59:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3449e0be1e431e7ddc1002e21b95581a3fc731e8535b46c8f742022d18ecdd83`  
		...
		Size: 670.4 KB (670416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:457feff0edc89111c7626dad30eb8fdb336fda0a4846e9585b293a9351c53568`  
		Last Modified: Fri, 29 Jul 2022 02:50:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:946af4d17d3e43f15ca121606de15b2db2dba86882eec8cef16bf59342b01f00`  
		Last Modified: Fri, 29 Jul 2022 02:51:05 GMT  
		Size: 21.2 MB (21214815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
