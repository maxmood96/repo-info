...
```console
$ docker pull drupal@sha256:5173dc3aad7ce0b8031f4f54f02f7872a74171351768eafddb9e6769e256ef16
```
...
```console
$ docker pull drupal@sha256:4825d516e99d1f69bfff1ea74b54db6c8c27454ef94283913acf5958a5c3b31f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.9 MB (48919888 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eae255f252ec6818c11b6149d4f442b52bbfbdbf922bdb196a798a48b1aee603`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:16:15 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:28:52 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:28:52 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:29:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:29:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd09616909d6b03d99c8da4ba2ad4e86f92a6b23563a7da505199845c5eb4419`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:248be42b1f8b9dfe0c134f2639a70e7bab77bee1d647c4c7fcf40423698859b5`  
		Last Modified: Thu, 04 Aug 2022 10:18:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac803041839fa1b003427f40f9cad652382f6b8544a1dd38064418c0f8ac87c8`  
		Last Modified: Thu, 04 Aug 2022 10:18:40 GMT  
...
```console
$ docker pull drupal@sha256:9919e74f69c666cfa16a9f33eda58c288d9f8e014a479bd47ea3909ca2025d9c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50900467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a9952a8ac06f2ca3e58784ae626b726f52517094b141bc9eb8858ea5297765e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:54:40 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:54:40 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:54:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:54:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:47bdf4132cac37d1fff3053d6df79d90225a99cd9f8b4905ef818b836da51699`  
		...
		Size: 670.4 KB (670421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60ae9f92977ebf1717084febed25735667be3c2708b4f420fbca58e49d28ef0d`  
		Last Modified: Fri, 29 Jul 2022 02:28:43 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6291788e206b09c0add4844a965a06c996e2a68ad99c42ad68eee8f64d210788`  
...
```console
$ docker pull drupal@sha256:83db9ac4f91027e64644a167804b782210c6d19f12b493faa5306123485fefbd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52281765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e655cc3dfa88a630b9f2b253e294a85f9ced8344fa127c67535b25244130e31`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:51:27 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:51:28 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:51:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:d19480701d1f2275f2d63e320211071915d5e6ff26c7b6af0789fcfc6c63bc08`  
		...
		Size: 670.4 KB (670421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe1d61c4a0f379b03ea29ac0531f69683826216ac255952bba283652f977fb6`  
		Last Modified: Fri, 29 Jul 2022 02:24:53 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da1ee2b38bb6a1f9eb24ba78eea5df4a5623aec72bd16fe7ea6583769ba5ab82`  
		Last Modified: Fri, 29 Jul 2022 02:24:58 GMT  
		Size: 21.2 MB (21217670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.0-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:4a367da687b8f449d8760a85c3efce7b44cb0bee52d7fab4a92c5d75e79e5069
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52232515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2a2cfe5e8a378cd6b6cbc51d6d4f0dc0b182af1eb7323cf11f831041e651e0f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:38:30 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:38:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:38:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba4ab8f8ec3e0f25474d7a4f1fa4e025fc1e64e44f88aa9009b981b1ecbafae5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea8c637be0ead867e23d9535701d7910ad592fb88da1930236ed0bd9ca54a317`  
		Last Modified: Wed, 03 Aug 2022 13:32:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b6bfcbc021a2a35849150036516c59618cdd1dd0ea20e31ba3d7f7f946aa46d`  
		Last Modified: Wed, 03 Aug 2022 13:32:56 GMT  
		Size: 21.2 MB (21214971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.0-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:5bfd99499946aa9027ff205210a4f8c7773f9e2d0137feec4e5559495a8db4bf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50654545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0d77681cf5c7b43ec1e5d123f8d951b367c3c736f4b19e77f7a5768b33c0bbc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jul 2022 01:58:14 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:58:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:58:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:34e0b251c43173bd78471ab72880fc6150166f7cea73cb7a7c47c9ec897d2fd9`  
		...
		Size: 670.4 KB (670421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5ad7321cd3e37925a0a2c5dd74403079863748fc62168a4759826fe7f3da2d5`  
		Last Modified: Fri, 29 Jul 2022 02:24:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595e4ebfc1ed37bff666618c55b142a09e3e9634bd748b725f82d60aaac7270f`  
		Last Modified: Fri, 29 Jul 2022 02:24:39 GMT  
		Size: 21.2 MB (21214731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
