...
```console
$ docker pull drupal@sha256:6567a29d45244334ce6d95c89e1b6f8efc64456f1314c76b4535408ee8d8ef60
```
...
```console
$ docker pull drupal@sha256:a19294dec454e3aa57479f5dc268fe1505f4e0e4a5a594d9b4a1b6f60eb5e462
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50296919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd94e0009191d68b4b9b93c1e13e85c2c7e24ee1a42cb7f139479193f98a8d79`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:fd42cf8845042cdaa098562617cb9b8a84df6ae3aa83b9e7dc07669de7a60be6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c8694722ab9336dc89ba25abe6cdb0a3d107bac0a334a818883a72ed09a1656`  
		Last Modified: Tue, 29 Nov 2022 07:31:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce377ddf8d802b3e539b0c590d72872e9e31525f2b6b546b9fd6581459806a0d`  
		Last Modified: Tue, 29 Nov 2022 07:31:39 GMT  
...
```console
$ docker pull drupal@sha256:c6a72ebc4efb941f4bea8e01c4d739cc947644439ed95d599f5c90c040628941
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52478943 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b2f12b47bb6dea3db22ec288de1d6e7b0cd1c251f15529b722cb8e778a76722`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:04:20 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:08:46 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:08:46 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:08:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:08:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5a90c6b4bacef888248507866a6a702fa505f70dd5635bb84f57a0b5ef001419`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffd96cb900460694ff520159f74cfdaded65ee27602466776c10da59e284aecd`  
		Last Modified: Tue, 29 Nov 2022 06:29:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c60cee3263e148d4bd04a8a97d8e0c07fbd0edb64036ceb1bdc7e6088f2f94af`  
		Last Modified: Tue, 29 Nov 2022 06:29:08 GMT  
		Size: 21.3 MB (21314742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:787c78781fb1dba408044ac3627cc9a3f0cb56302bf924216cad72b7558647d9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.1 MB (54096054 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:786d0a654ed81d6648d7ba13d1eb6098cce5d7709def00c36031908c737d2c1e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 07:05:58 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 07:11:46 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 07:11:46 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 07:12:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 07:12:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c6ec779f3a76d44eaab53a690fe5f1c89dcec3779feeade41080f112f488e57d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:773a794d40306519740ec22717f7847458a260f822b0f4577ff9f7fe70136373`  
		Last Modified: Tue, 29 Nov 2022 07:43:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:934e835de50bd6b9d08596581e5ebde601eec4aae8d55e3542ba174f6bf7e5d6`  
		Last Modified: Tue, 29 Nov 2022 07:43:58 GMT  
		Size: 21.3 MB (21315145 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
