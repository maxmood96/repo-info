...
```console
$ docker pull drupal@sha256:88bbd580860fffbb215f7d28cef95a6532e7dfd9b807fcc653faa4cb1d6c06b4
```
...
```console
$ docker pull drupal@sha256:439e9e7e3d781e89c12b1e4e3dca9407e9e585baa43fdb1d7e0ea8497fd91144
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49731821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc2f60fa9aa9470a64d4e0db4ec6343e0e166f3d0fc67b2cf25760f3f750e6c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Jul 2022 01:45:28 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:45:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:46:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4fafaf55a29ec0c039c7e4d18df2dad9cb4a853ef8fbc8a5591bd4bfe169b92f`  
		...
		Size: 670.1 KB (670054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5d7b2e4cc56026592600100a66b5f0dd77261685632aa120b946dfea43cfdf0`  
		Last Modified: Tue, 12 Jul 2022 02:32:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b6dcff4d61910b831cd4e63e6a3079da3ec7a5b0003546b4467a4c9422cfa2e`  
		Last Modified: Tue, 12 Jul 2022 02:33:06 GMT  
		Size: 21.2 MB (21208550 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:88d2fc6858f84b268bbc062e6820af0e840d1dbb94873403158c33c40c8780bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53299434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee92d8a37cacd799bd32a3d99274ccad905fd4593d176a460a819c0302a41c42`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 02:16:39 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 02:16:45 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 02:17:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 02:17:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7ad36db5a8fc9f7ab1830a1bdd5f82a799c8f0e11c76863183621e82abba8cee`  
		...
		Size: 670.1 KB (670055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9004bce55f95c54c281c219fd40eb9133e0ff9d9e411fe5bc5798ce0068b06b`  
		Last Modified: Tue, 12 Jul 2022 02:57:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3483e0e1c8ae6a2849975e06775d92128b1c69bf88b94358dce822227e0d788`  
		Last Modified: Tue, 12 Jul 2022 02:58:27 GMT  
		Size: 21.2 MB (21208491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
