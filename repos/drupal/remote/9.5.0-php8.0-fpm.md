...
```console
$ docker pull drupal@sha256:c2ceb0a9f6d4c25908af7e8cfafd2c4a7c2215473c420038ec7c7867f40cac5f
```
...
### `drupal:9.5.0-php8.0-fpm` - linux; amd64
...
### `drupal:9.5.0-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.5.0-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:9.5.0-php8.0-fpm` - linux; 386
...
### `drupal:9.5.0-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.5.0-php8.0-fpm` - linux; s390x
