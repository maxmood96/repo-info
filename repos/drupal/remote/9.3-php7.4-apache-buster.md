...
```console
$ docker pull drupal@sha256:59b238581a071118a076c4786aa8d0479f9357918b4eff0909b5b33d23124993
```
...
```console
$ docker pull drupal@sha256:74a38c02255143454ed2c53c1c19443956cee4b03e6a3acb1d26c8d0f9b3d7f5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.5 MB (169524674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1e7d68cf9a8f7a5614db7cd54519bf70788a009aa64a368f01ce0efc0d99da6`
...
# Thu, 06 Jan 2022 20:25:23 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:25:23 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:25:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:25:34 GMT
...
-	Layers:
	...
	-	`sha256:b92de90e1fdec69997ff1bda9b9f311b5090b19a82f758bc098bce463232d01e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4789b95088c3891797a9f8261148d5cba3df94676d49841679a9f797900eae0`  
		Last Modified: Thu, 06 Jan 2022 20:34:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:415c5c5418f7f8fcfdf29d91da18dffc84b60e10d0fd1d3de5e26e992d940d4a`  
		Last Modified: Thu, 06 Jan 2022 20:35:02 GMT  
		Size: 20.1 MB (20141147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:90bfdaee186c509198532d53b5280b242b8229fc5ef9dd991d8ca51b00046f82
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.9 MB (144880114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f8938f3db07f28f0bd306837507b3747304924a9332fab10090ad54a705c8df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 20:15:22 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 20:15:23 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 20:15:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 20:15:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec639f26021fe35f5f92e87f143adc72d02c8d7d55f64ba7353821dbb755b5c0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b130719414e257b8bdace4d3bd9f3981052b98fc0130569f1914dfd5c45354b`  
		Last Modified: Thu, 06 Jan 2022 20:46:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b94ab19c011035f97c6937549be07ce752d8bcff165813b5b8c23758e2b66e0`  
		Last Modified: Thu, 06 Jan 2022 20:47:15 GMT  
...
```console
$ docker pull drupal@sha256:96dc4ecc716a64d903487d3899c7436a5f05ad249d1912c001c744a5aa5454cd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160985234 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99a522a5d7f7d83eea5f8ac794c61ce88570a7a22ca354e0f026b7ee4cfed95b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:51:12 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:51:12 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:51:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:51:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b9455770ba540fd38c4d3356cbac84c9340931283a0ed85885b5a74a2681d36`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f41951d54b68bcf85ae5c328ad7724a78ec16c5bc80f3966903fccd363d6bd05`  
		Last Modified: Thu, 06 Jan 2022 20:06:14 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dffe9673144e7372b6e5cf139ace7f67cb2f459f3544182a72b6f88ef56e0046`  
		Last Modified: Thu, 06 Jan 2022 20:06:19 GMT  
		Size: 20.1 MB (20143132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:bcf4f3630a135ccc4d5a31cac120cfd6ab65d3f75b55e861e161246c068512bf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.6 MB (175550540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd9342debd5bbebcf68f0e5aa66692fd17ac088473b6a0b45031c053a3932841`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:50:38 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:50:39 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:50:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:50:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8c8accd550932d4c49ba3c6de2a44a358ede9331254868680285f0bb141efb80`  
		...
		Size: 573.6 KB (573625 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb3c1e82400b4e510267aa00505c9530b7f15fdf57087ca95858048577697d55`  
		Last Modified: Thu, 06 Jan 2022 20:07:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bd2defdadbfaf11763bc24304b9d955fda30f7239df185da842eeafba72f69c`  
		Last Modified: Thu, 06 Jan 2022 20:07:08 GMT  
		Size: 20.1 MB (20141037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:218ac9bcd96d567f62392024ee2ccd3caf7cf8197b7b4f10b0825dd679673660
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180923559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90f703b2f75947491122af50d3c79c231e65865138145ecb355db1974a8bdbd8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:2c3bd7c53600bcc28c43b14fd4dd413c90c3f90bcff7d9a61889e8e38ebdc0a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7b1d9435d7b1737ecae349d3edfc160e6121e944b05521d78b8b1dfd6c08280`  
		Last Modified: Thu, 06 Jan 2022 20:51:40 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f196f7ded516b31d2be8954162f3cfd2b5261498c4fc82344a30785fddf077c`  
		Last Modified: Thu, 06 Jan 2022 20:52:25 GMT  
		Size: 20.1 MB (20141492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:ac2ba57829dd1a3bf113dfe049fc34593be2592385293bafd00d1e3a04676529
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155204790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7036afc26db6618c1369c3b5e36d38e7a470b93ff911c93b216004eb72f4ae62`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Thu, 06 Jan 2022 19:55:52 GMT
ENV DRUPAL_VERSION=9.3.2
# Thu, 06 Jan 2022 19:55:52 GMT
WORKDIR /opt/drupal
# Thu, 06 Jan 2022 19:56:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 06 Jan 2022 19:56:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:14f88a7ab2c766fb8698bb3e936ae343a3729b89a0b409ffc6aab1cd329f4276`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bf4660e99883dcb4dc7939a6ebd8a5d05033b1c5a64e6c5aeab44cc5a3ef1d5`  
		Last Modified: Thu, 06 Jan 2022 20:09:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f12f88fc8a7df1f225975f277d047b5d1d708afb8ac5498ee80ae36ab59b4ef`  
		Last Modified: Thu, 06 Jan 2022 20:09:32 GMT  
		Size: 20.1 MB (20141297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
