...
```console
$ docker pull drupal@sha256:f5db87918c10d7827fdb6f73627b55fc01b66d239f7d3b653f0649cac5316ce2
```
...
```console
$ docker pull drupal@sha256:f7982584ab7d7a7355d02f27c14228ab10747d13f82df4c34f3e3908bcf0fa1c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143064077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ddc9567e0fc7e275e70bc17ae2bf7bd376a37d4c65a2352495fa57279436b12`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Aug 2022 09:19:30 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:29:55 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:29:55 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:30:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:30:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c456b6b15109ee54ebc45cb262c335003f7884094a9ea686b8c8cda9f7eeeef0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b2a721e8727c64a06ca09c814dbaf05f8d4704925448850a5ce3e625df4da02`  
		Last Modified: Thu, 04 Aug 2022 10:20:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6b8057d0cecda099e9c2941aa7ebd29bcd75ca0e2846d420def7c792dce71a2`  
		Last Modified: Thu, 04 Aug 2022 10:20:40 GMT  
		Size: 21.2 MB (21214354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
