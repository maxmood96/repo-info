...
```console
$ docker pull drupal@sha256:f3df93ad246642fc837a7ee9ce24fb5199132053198e409f5515b3edc6462c5b
```
...
```console
$ docker pull drupal@sha256:06127617bf1e23e031e4e3919f733f641dcc255fbc25fe00213d3360f140f99a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143890592 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5dda7f81c42789a2cd391aa9a3331c96b6bb91b91636d9ec4a5f410e62099239`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 21:59:30 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:13:14 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 22:13:14 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 22:13:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 22:13:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5686cb455ccf1b145df1c9f5092d104b776049dce0ef9c2a6e0929dba770dfc6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f5199fbcb464c72c5869abfd168494a3ba22035ad565ab90fbbb75f9b3b0097`  
		Last Modified: Thu, 29 Sep 2022 23:04:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b228941da21de30e026b19fbcf2c69b5c412781df8f9e96d374fb4ead0c671a5`  
		Last Modified: Thu, 29 Sep 2022 23:04:21 GMT  
		Size: 21.3 MB (21314454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:6f004c997d63ab6b30ac60383bb1b923372326741f19bfd3169107c037a1f2d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159688745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b0a22709e2a0d63a3b74fa30988ae13078b3d2ae34997e31f08aa4c765f55e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:48:18 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:48:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:52d27784765e33b21d1e965a0bf873c9df8bdb5253cf106abc9b2bd9722390f9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdaa4b19af9262ed233f8378239d571b1a273b9dc0b8c624c4cb303986348f85`  
		Last Modified: Thu, 29 Sep 2022 21:25:08 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f2a7a6d3845b895d71d8cc0e561886f4916d586cd516f9e03a10bdabd0e0b52`  
		Last Modified: Thu, 29 Sep 2022 21:25:13 GMT  
		Size: 21.3 MB (21314315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
