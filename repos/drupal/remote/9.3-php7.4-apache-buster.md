...
```console
$ docker pull drupal@sha256:8ebc8c9d482fb9904cb3b99cf2888a130388efa36fa758bc6a1e304178fcbee7
```
...
```console
$ docker pull drupal@sha256:dbc195157d4cc4214bc1f1a22c099f0fe39687f9bfd2903ffda8c09ed54f39a2
```
...
-	Image ID: `sha256:b988ba1375731527f1dc8a26c1d4b1d373819fd65af10c9b0805a6d41ac1dc11`
...
# Wed, 26 Oct 2022 17:19:53 GMT
ENV DRUPAL_VERSION=9.3.22
# Wed, 26 Oct 2022 17:19:53 GMT
WORKDIR /opt/drupal
# Wed, 26 Oct 2022 17:20:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 26 Oct 2022 17:20:05 GMT
...
-	Layers:
	...
	-	`sha256:7976fb19215a61a57913853e055cdc6b22e65f0d078d3a5cdf749cf3966be3c1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f73706dd6ce78438e988afab5fc82482d50a289a7740659239988c4f4a1d078c`  
		Last Modified: Wed, 26 Oct 2022 17:41:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09217c2b8c2c11bb54cba832acf249c59a77956cf635f3d3da4374f2abcd1077`  
		Last Modified: Wed, 26 Oct 2022 17:41:54 GMT  
...
```console
$ docker pull drupal@sha256:8d00a2dd5e6e51b99308535d5729e11578442d52e720c91cbb9d574409b844f2
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.2 MB (143200564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28877590a5443b779b185d71fcd1e592006874c8a784efcb192e247f1de6a848`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 26 Oct 2022 17:32:49 GMT
COPY file:885ab970f10508225fd61630bb5f5deca9a4c5f5efa71af5b20e1efa22fecb2c in /usr/local/bin/ 
# Wed, 26 Oct 2022 17:43:38 GMT
ENV DRUPAL_VERSION=9.3.22
# Wed, 26 Oct 2022 17:43:39 GMT
WORKDIR /opt/drupal
# Wed, 26 Oct 2022 17:44:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 26 Oct 2022 17:44:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:508fab4d9eb11cc06a0a7748d75420118f8eb3cc51575d33f651b351bfb67c96`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:695cc026383fc77c02002dff454a3c8a612ec157917eaa603e9a70c208d5e591`  
		Last Modified: Wed, 26 Oct 2022 18:31:03 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a164b3706b2ce375d9ec05662dc1ebb629b6fa62bc521b45c490bcf2e8c231d`  
		Last Modified: Wed, 26 Oct 2022 18:31:11 GMT  
		Size: 21.3 MB (21314568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:338af1203c28476c394d65d06abd9444e9b6375b7afc2b2604cab4e463054951
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159481447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:257f1981e30f31a5392cead95d83cac4fb1bd315eb090eec58ee3c307ec82da7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 26 Oct 2022 12:20:54 GMT
COPY file:885ab970f10508225fd61630bb5f5deca9a4c5f5efa71af5b20e1efa22fecb2c in /usr/local/bin/ 
# Wed, 26 Oct 2022 12:28:38 GMT
ENV DRUPAL_VERSION=9.3.22
# Wed, 26 Oct 2022 12:28:38 GMT
WORKDIR /opt/drupal
# Wed, 26 Oct 2022 12:28:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 26 Oct 2022 12:28:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b9d233293c4dabf0bda772c70cda2e045ac9de94542971c5b6cad15ab08ca054`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84b560b79666077a2f61db74eda4d7b0ee85d953f3c871df9518fe442508391c`  
		Last Modified: Wed, 26 Oct 2022 12:56:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a79d0a0c6d8472e49a201dfbdd127688f5e3f8dd02f3894df8ca9de618779afa`  
		Last Modified: Wed, 26 Oct 2022 12:57:03 GMT  
...
```console
$ docker pull drupal@sha256:3d714e3ceddecb6903b5c652d06cdd6696a2a7069f18f33a7ce80ad7039b169a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172666372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23c1d022331ef6536974b1adc4db1eb572f4a6a6eda8fda03dc699b8b5676bf9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:885ab970f10508225fd61630bb5f5deca9a4c5f5efa71af5b20e1efa22fecb2c in /usr/local/bin/ 
# Tue, 25 Oct 2022 19:28:00 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 25 Oct 2022 19:28:01 GMT
WORKDIR /opt/drupal
# Tue, 25 Oct 2022 19:28:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 25 Oct 2022 19:28:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b940799ef4e00aa6fc410895ef026cd9d256a67b789d239f0b7b4e2ef792e3af`  
		...
		Size: 694.8 KB (694774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c30f1553c7b969a15cdde3cb85b2c18b5bdde32143c3162d35333edbc67f41b0`  
		Last Modified: Tue, 25 Oct 2022 19:59:39 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c87a6f6081d1702b6cf448d4e8290d408a1c409d834fd0361a18d074e5ca41`  
		Last Modified: Tue, 25 Oct 2022 19:59:45 GMT  
