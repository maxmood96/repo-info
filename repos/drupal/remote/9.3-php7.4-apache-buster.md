...
```console
$ docker pull drupal@sha256:4c8aa869dc7a593f32a2158a1ab1519ce37764392b1e51f7f8233f3261aad7db
```
...
```console
$ docker pull drupal@sha256:9351c7cb054e3f73164f7d8d20b14093248e939769f40eb4058f4233bef4b446
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172667942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91bfb2cd8c5e65436ca6a440ed503353d8802ad9e87a1a9907ddacd15b95aa3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:59:16 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:59:16 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:59:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:59:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:253578f2e7867597403528f6bd2b0043e1a86bfe44010e795f5a4819a2be8aa7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d981a5a3fc036cc57cd7e970ad816a6400f48a2c323e2b8e593a00e6be011227`  
		Last Modified: Wed, 16 Nov 2022 22:58:12 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c8cf0b13d02eedd8bedf3dac8f4adb5a4782f49da7f90fbca584176da287a42`  
		Last Modified: Wed, 16 Nov 2022 22:58:26 GMT  
