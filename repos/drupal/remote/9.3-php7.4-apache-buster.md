...
```console
$ docker pull drupal@sha256:a8b26f7c08b58e15898440c2cf95f6950f5d7a405ee68231d443ac97dc31597c
```
...
```console
$ docker pull drupal@sha256:71e83ccceec3917be2deaf5a94885b2f73c9b94e4ac9607a91cfa14956f8b35e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.9 MB (169894256 bytes)**  
...
# Thu, 17 Feb 2022 23:28:17 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:28:17 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:28:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:28:28 GMT
...
-	Layers:
	...
	-	`sha256:b9a5b76c92d499f663135fa3e1684df311d55530bf4337d3fec26cd1a1c93372`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b7dff78690cc0b0a8acf727a619adc45b31093666414ec4baaf1c5c9fc52a91`  
		Last Modified: Thu, 17 Feb 2022 23:41:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4799d5cc8d09fb133b80616eac8b38b1cb15d76f74b4ec85f16d86b7ce8a6130`  
		Last Modified: Thu, 17 Feb 2022 23:41:58 GMT  
		Size: 20.1 MB (20118846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f47ab53358fd55885bab02d2fb82609e591e6059f4e91367fbfbadc7e2a6f083
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.9 MB (175934803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:902c514a67e59bab766e05e1a3526b23339dbf308e196574c708b652c49d5477`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Feb 2022 21:13:13 GMT
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 23:41:16 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:41:17 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:41:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:41:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dc6b4a0f50a03813566861ec6684b547a90aabe187c5abf6b6a9352781d6c51c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1ab81d2560201bb23e4a29e0ad8933b4b0529f3d567ccdf81bf4186e87dce4d`  
		Last Modified: Fri, 18 Feb 2022 00:05:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd2094bcbb2ecd6d5422c8d7cbcc92d0ea2302a457c3d38781a0e0dc9168cf54`  
		Last Modified: Fri, 18 Feb 2022 00:05:15 GMT  
		Size: 20.1 MB (20119209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:8395668753b1f2f289c0a80d6a74df9a7a12836b7dbd4db75b1f2130dce7fd24
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.3 MB (181318018 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:faf1cc07b0bfed65092c004932cc1b7813b002ffa5228795956e9a46af7e6eee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Fri, 18 Feb 2022 01:43:23 GMT
ENV DRUPAL_VERSION=9.3.6
# Fri, 18 Feb 2022 01:43:40 GMT
WORKDIR /opt/drupal
# Fri, 18 Feb 2022 01:45:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Feb 2022 01:45:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:66683811cf06089dba9f8655b122ac8b2a5d04044de83b5b8d31d5564f05ee39`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f2b612718c28579402840c3fadf4f3ab438ceb29eac2eff895537dac7c85f75`  
		Last Modified: Fri, 18 Feb 2022 02:54:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23aeebcc7f0fae29cc5948fd0b0829091d086d581daf08b13dd04796910bd292`  
		Last Modified: Fri, 18 Feb 2022 02:55:21 GMT  
		Size: 20.1 MB (20118027 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:eadc4d45421a5c0324e426e93abcb807037299e73475c23f680ff5a0d534de4d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155539301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8cd4cb46c2468973e8f202896fde5199039a75420353bcb68e539942079e4203`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 22:49:35 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 22:50:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 22:50:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c7dc50962181de62c0dbb269617b6bb97403117a00af096da5ff21718b1f646d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5049170fa24fff11fbd7cabcf88defdfa67f37e49b5a82a892fe593e7e43bcf`  
		Last Modified: Thu, 17 Feb 2022 23:13:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94dcfc2e689bd95d37dfe9871d7a05fc973d914c9498f6d4ef82d78f29c4e137`  
		Last Modified: Thu, 17 Feb 2022 23:13:18 GMT  
		Size: 20.1 MB (20118818 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
