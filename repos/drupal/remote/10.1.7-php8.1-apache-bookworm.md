...
```console
$ docker pull drupal@sha256:3191348abcc04349f0ddc05017c4e3efb533bdd46ab546534283a8e3bb57a5c5
```
...
### `drupal:10.1.7-php8.1-apache-bookworm` - linux; amd64
...
### `drupal:10.1.7-php8.1-apache-bookworm` - unknown; unknown
...
### `drupal:10.1.7-php8.1-apache-bookworm` - linux; arm variant v7
...
### `drupal:10.1.7-php8.1-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:10.1.7-php8.1-apache-bookworm` - linux; ppc64le
...
### `drupal:10.1.7-php8.1-apache-bookworm` - linux; s390x
