...
```console
$ docker pull drupal@sha256:3316e140cd80fc50ab6a80aa44320b6fa7380a62e9d2840f115b822f9d3189fb
```
...
```console
$ docker pull drupal@sha256:2b60eeb77a00f36a985a8d93b491f97ee181c9300e92d31e9c5fec3e110f627c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.4 MB (57405389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9014910f092d7fb1bfd9c1a404e6979838c5cb9f2a3ae560ab1a575c456851c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 05:47:46 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 05:59:38 GMT
ENV DRUPAL_VERSION=9.4.13
# Tue, 28 Mar 2023 05:59:38 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 05:59:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 05:59:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bdaea77483f7b9a8156e408515d64e1a66cb2b7b31a70edeea316d13f2c8275f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e5bf111e56d81a860d07aba2c8fde601308708a24b7cbc18455668c3f4497e`  
		Last Modified: Tue, 28 Mar 2023 06:18:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b8c2db417a267e86e3dcdf2343078db59d2a91f1de745353b5d1c471a43090`  
		Last Modified: Tue, 28 Mar 2023 06:19:05 GMT  
		Size: 21.9 MB (21905748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
