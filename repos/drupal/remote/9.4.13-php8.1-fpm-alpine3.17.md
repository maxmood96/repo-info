...
```console
$ docker pull drupal@sha256:248126da0699e8d686a3bf5dc628a08eadec77e100fe11ef07a3e0900d6cc3fa
```
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; amd64
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; 386
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:9.4.13-php8.1-fpm-alpine3.17` - linux; s390x

```console
$ docker pull drupal@sha256:2df8fca467f50054f912cdf65075e0e5cd49ee4da66034d83b28c5f4a55fc3ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53261324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdd6f3740ede3102cd003baebef561d2c7638a902b6afb74e8cdc22e70b5cefd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Sat, 25 Mar 2023 13:44:10 GMT
ENV DRUPAL_VERSION=9.4.13
# Sat, 25 Mar 2023 13:44:10 GMT
WORKDIR /opt/drupal
# Sat, 25 Mar 2023 13:44:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 25 Mar 2023 13:44:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e6c9ee8ac7d93abcc229c63018bc9687f8b43237fc4ec72a28c2373ce4ebad4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c730cf01b128792ee29e07a213163710e08b11604093691fe4c8ed3a41cf6713`  
		Last Modified: Sat, 25 Mar 2023 13:52:46 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:452e466f75d9c0e5946c1a5d9ee350859c49190e7a6112be26179842bc174fc6`  
		Last Modified: Sat, 25 Mar 2023 13:52:50 GMT  
		Size: 21.9 MB (21905769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
