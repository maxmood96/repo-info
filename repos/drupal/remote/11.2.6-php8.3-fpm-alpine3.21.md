...
```console
$ docker pull drupal@sha256:f62ca038c2f81de058640258c3b7c81141391fa2841caed520eda3dcac171d4a
```
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; 386
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.6-php8.3-fpm-alpine3.21` - linux; s390x
