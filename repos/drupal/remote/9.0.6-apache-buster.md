...
```console
$ docker pull drupal@sha256:38ded3b598e7da474760f87e3b34bf7d90f1a88a967c8a8604109763f741ed7f
```
...
```console
$ docker pull drupal@sha256:550bade58994a011152104cf39a1ee13e2891222eefc5866ba03a2ce2749fc06
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141737439 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:77e9469622a1441198ea820347f5e652e2347f6c06575e81163b63bcc77536c3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 17 Sep 2020 02:34:29 GMT
ENV DRUPAL_VERSION=9.0.6
# Thu, 17 Sep 2020 02:34:34 GMT
WORKDIR /opt/drupal
# Thu, 17 Sep 2020 02:35:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Sep 2020 02:36:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:57882685a7cca36ca5727bd11684e99221b221fed9dc3611357628b5cbd06335`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0ba8c6699f848043a506ca3feba99a2f2c0c0ad3ffe31ef2d3737fb2d24be19`  
		Last Modified: Thu, 17 Sep 2020 02:57:26 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9343a903ea3c6571fc1f24cffb36eb8d6bf01836f51e95b9b5b5fdaff1e74be7`  
		Last Modified: Thu, 17 Sep 2020 02:57:54 GMT  
		Size: 17.2 MB (17226986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9d7f3093913328d5debc6e57dfdc3545859f574fde72a4fb56bbf52ca8a43338
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152034840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d978124f52760b59990fbd58c7edd13bf734d63e2ba61950e66e9d608ae81ad2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Wed, 16 Sep 2020 23:48:10 GMT
ENV DRUPAL_VERSION=9.0.6
# Wed, 16 Sep 2020 23:48:10 GMT
WORKDIR /opt/drupal
# Wed, 16 Sep 2020 23:48:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:af768f53c87ee1cffdbdead9d67dd26b2aa366641db92a322f4a01804a184267`  
		...
		Size: 508.0 KB (507966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:423585251f7f9e954c8640efe3323d293090a2d0a2cef3537528fd2021e6332d`  
		Last Modified: Wed, 16 Sep 2020 23:54:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1436ef12aa342cd83f2c3d105ee06566b609a4678f283131452d9458c0f019a9`  
		Last Modified: Wed, 16 Sep 2020 23:54:13 GMT  
		Size: 17.2 MB (17226647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
