...
```console
$ docker pull drupal@sha256:921db22f0fb47510c973529c4b51621e2c8f7066525c850986e1da93f894409b
```
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; amd64
...
### `drupal:11.3.3-php8.5-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; 386
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.3-php8.5-fpm-alpine` - linux; s390x
