...
```console
$ docker pull drupal@sha256:40706dd071559b5b1f0025d9f3ca64d9e2d9143def15686097f25961e8bf691f
```
...
### `drupal:9.4.14-apache-buster` - linux; amd64
...
### `drupal:9.4.14-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.4.14-apache-buster` - linux; 386
