...
```console
$ docker pull drupal@sha256:cba28ced420fe830f72efbb5b9c1b99e89e61fc75f2d58dedf827cedbc109975
```
...
```console
$ docker pull drupal@sha256:05ecbeceb43dd626c4ff5c882514efbdfb4d5883a89012a6fe5505202aef2faf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.6 MB (150575361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10084fe556853cc91f1edfa6c891cd87fc3e9064b8c1737c24b13e99b4dc360d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 10 Jul 2021 05:03:16 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Sat, 10 Jul 2021 05:08:18 GMT
ENV DRUPAL_VERSION=9.1.10
# Sat, 10 Jul 2021 05:08:18 GMT
WORKDIR /opt/drupal
# Sat, 10 Jul 2021 05:08:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 10 Jul 2021 05:08:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:02fb7634dc903f7fa2165f535689fe81905e8ce578732a700c86437fb9c94471`  
		...
		Size: 553.2 KB (553185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efa68b60fd3fe7b40442b924b9c29511ce4872fd3e1559a72e485672f8e3f453`  
		Last Modified: Sat, 10 Jul 2021 05:21:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e10e65c21d97abc48c4c66b8c41fa8bf690d16f813e4b24318fafe98815174c6`  
		Last Modified: Sat, 10 Jul 2021 05:21:48 GMT  
		Size: 18.9 MB (18879866 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
