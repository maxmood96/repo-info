...
```console
$ docker pull drupal@sha256:f24a66998a93f7008fc3a44ac3d8b34dfd9da5cc2f48898ea0364c03c53d319c
```
...
```console
$ docker pull drupal@sha256:6fb0c7614b0e7df42fe3ebb4bd1dbca8336e58d207b7ea71ec73c27b36a3cb9b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175810090 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ecf3a90b6feb9d730aa21e17190a0a870074e366ff1cc9bcc7d0bba7e534328`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 09 Jul 2021 01:02:47 GMT
ENV DRUPAL_VERSION=9.1.10
# Fri, 09 Jul 2021 01:02:56 GMT
WORKDIR /opt/drupal
# Fri, 09 Jul 2021 01:03:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 09 Jul 2021 01:03:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6bfd9557a68030ecdffca0f43b43e2ba1595014034904f4e5ee2117988c80e32`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f96e8ae9e31422be07e06c2fac7d6585c131f959649d32941ab5fcc545195bd`  
		Last Modified: Fri, 09 Jul 2021 01:50:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:366ed0400ee65f5739f40157c444aaf1ed1cdad82122e703941f8ebe5b6ab658`  
		Last Modified: Fri, 09 Jul 2021 01:52:43 GMT  
		Size: 18.9 MB (18879820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:1581a4756435aecc2bd18deacc0959e0f917576cf46a222ea9b2eb3435bc9997
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.6 MB (150574520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44af69f35eac88b18ffe50eb5e817ef193aeee3e74c66ad89ed221b25e09d0a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 02 Jul 2021 03:03:51 GMT
ENV DRUPAL_VERSION=9.1.10
# Fri, 02 Jul 2021 03:03:51 GMT
WORKDIR /opt/drupal
# Fri, 02 Jul 2021 03:05:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 02 Jul 2021 03:05:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0aa991d63f553dcda524d80dc3169c15a41dee41a87e8c7f4adac3fee0136f8e`  
		...
		Size: 553.2 KB (553186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf1bdb62328c48253a2cd9082cc2f038e34140ff964856a64786e2b4a424d1e4`  
		Last Modified: Fri, 02 Jul 2021 04:41:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0f3360759a42ce236d7d8088017335fc48fa27636d27504b3473c671d64c2d3`  
		Last Modified: Fri, 02 Jul 2021 04:41:01 GMT  
