...
```console
$ docker pull drupal@sha256:37b8d97396165395de0489c34287698bf1394b1bbfd307a8ca625d2cdc366389
```
...
### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b7c1c6c59f61df0bbf18c467ef73551af85d76d8c31a9c0e157ec756757ec9df
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.5 MB (56478085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99cb375c3d87176d7dbe0a55440fa49308e2bbde297336f5720511f13367dc51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:2741249086949127cd9088734929d165e0e3abf982e835a953af0603d5a63190`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:41709b4bbd9620de3aafec5176b25c5b87d55121538db89c833aa7919a127aa8`  
		Last Modified: Wed, 11 Jun 2025 21:19:05 GMT  
...
```console
$ docker pull drupal@sha256:89acca5f10683bf6ed88a59d0d7eb480ce82b85395749059061e2a4e400ff8d0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **410.6 KB (410595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a5bfa31f0a0db68d9e0c4a75fc1f24a91510d1d915f465a8c11853980cd1b66`

```dockerfile
```

-	Layers:
	-	`sha256:e5b1e4a3b3e03401b209ad338a17a827582fdf27f31ba3c337865bd79312c5fa`  
		Last Modified: Wed, 11 Jun 2025 23:10:58 GMT  
		Size: 376.7 KB (376670 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4c9499a25a870bf897898a4fb0d0ac7ee8e997c05322483bb09ac964dc677cd0`  
		Last Modified: Wed, 11 Jun 2025 23:10:59 GMT  
		Size: 33.9 KB (33925 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:0f54d3bea2513edeb6554275fd492c1df0e55bab8d2c1fa2800014791d225d9e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.4 MB (59423175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bee8684fec84149140b7ab5f0500c5e166728bd094619cca1bf0aef3f8253920`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:23c003fd5b0253deab1a6ca7a62494288311d69f55539f32503183e97f16ea20`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7208362aea13363229b0a20a27f743b4cf45871a2a376a5d6979047931d288cc`  
		Last Modified: Thu, 12 Jun 2025 01:11:48 GMT  
		Size: 20.4 MB (20384653 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - unknown; unknown

```console
$ docker pull drupal@sha256:5781f8b39fc4592ea37cfd43ed9bb7fa2170c32571f6fe30f8ee18d79b7eb23b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **410.7 KB (410683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:291fa7edd7bb3a542fc774fe5c3519cb05cb11ef71c5c5f3c417073a1b68a846`

```dockerfile
```

-	Layers:
	-	`sha256:e4910922075e5ebef9bd6843a2eae3ef67955c1c844d04356b66e6213f0d1cd5`  
		Last Modified: Wed, 11 Jun 2025 20:06:57 GMT  
		Size: 376.7 KB (376706 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:4d765ca67272ae67315c16ebae32429d59e7bfd0ac212eb1468022848802ac18`  
		Last Modified: Wed, 11 Jun 2025 20:06:58 GMT  
		Size: 34.0 KB (33977 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; 386
...
### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; ppc64le

```console
$ docker pull drupal@sha256:32907c060f8f21fe8dcf320c59bd1499a677b75d9f4eee9684196b938541cbf3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.6 MB (60578798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22c32c15636e052d971cd1c85a4f19c8dc64f8bf86c2f717e5d51321de5fd5bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:670384dce5ee122290aa927bc7d42c79ac965c4320b9a253917e911e449c9c2f`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f37533ffa5b2cc649b0ed43cddcfaa13d8fda7016ed526bf15cc965524219268`  
		Last Modified: Wed, 11 Jun 2025 21:01:26 GMT  
		Size: 20.4 MB (20384697 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - unknown; unknown

```console
$ docker pull drupal@sha256:7afccfcfba9b37f2e937b883424808820c72bed8dbbbddef331a37f7b484a9f3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.6 KB (408559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bec4168be35a5378556d733a0917d836a7a5534d5bdec2f28fd7a7d0b2735616`

```dockerfile
```

-	Layers:
	-	`sha256:5a96331108cc656963a91f36aa3b8ba986c237fe4a1ad073e1a57540dd369733`  
		Last Modified: Wed, 11 Jun 2025 23:11:14 GMT  
		Size: 374.7 KB (374709 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:28d8f37f5e2284a1aceaeb9e9cf10e12e14e3817ea2bd43009e57ff091b17e46`  
		Last Modified: Wed, 11 Jun 2025 23:11:15 GMT  
		Size: 33.9 KB (33850 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; riscv64

```console
$ docker pull drupal@sha256:822b4f26e634d8fd3b630113fbc6aafdc60ff744c5f171fc54cc991a005655c1
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.0 MB (59004784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:caad31376f853e9823bd9a20c6bb479bb2bef04cc4cbb7f0b5c4595a0b37e181`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:122832a7d8b30efacdebadf6c8d4be2c6e4d36db0f47ed155fe9398a3c7de277`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3dce2734d1d62f98e050522decb4b526ae5d70cb87b8fbbfd95ed37fc076b722`  
		Last Modified: Wed, 11 Jun 2025 17:46:55 GMT  
		Size: 20.4 MB (20384935 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - unknown; unknown

```console
$ docker pull drupal@sha256:7b6dd63f75a83a5ab3cf0a3a2c22bd28b4176d7f8839c4f193246f16fae538ce
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.6 KB (408555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f09ed48cb35381f6fdb030f702da0485aa3e8adeb02c4beaf36b022487f342e0`

```dockerfile
```

-	Layers:
	-	`sha256:f71c595ec9d9c7cd6a595d8b0c8a5d24085b06267e761f52cd215103e4d4b151`  
		Last Modified: Wed, 11 Jun 2025 20:07:11 GMT  
		Size: 374.7 KB (374705 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:fedc82c25a94b6e9dd0d44d894c3fd3fc0c824d64bdb6eb1956ee03ccb18b4ff`  
		Last Modified: Wed, 11 Jun 2025 20:07:12 GMT  
		Size: 33.9 KB (33850 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.2-rc-php8.4-fpm-alpine3.21` - linux; s390x
...
```console
$ docker pull drupal@sha256:58de7272df4ae969bfb3b15a4bc30a570e377b3f121e80d8a191270ff3c3b9df
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.4 KB (408419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ccf7a93a8ffd0477a9232547a7ac9db9f9892e459926cbbaebae37a649024fd`

```dockerfile
```

-	Layers:
	-	`sha256:19d82e30a183944b7e7ddb4dc4e7d18998f0f041d91acde2c5b9ea6ccd39bffb`  
		Last Modified: Wed, 11 Jun 2025 17:05:13 GMT  
		Size: 374.7 KB (374651 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:de1abb233aebd4a3dee569eff4a59ff8472a1fb7ca55307681216de84ef493c7`  
		Last Modified: Wed, 11 Jun 2025 17:05:13 GMT  
