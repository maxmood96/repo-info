...
```console
$ docker pull drupal@sha256:ccf8848a013dfd7124aa2005d1592a9db638b467ada1e95d4f387d0ab8331007
```
...
### `drupal:9.4.8-php7.4-fpm` - linux; amd64
...
### `drupal:9.4.8-php7.4-fpm` - linux; arm variant v7
...
### `drupal:9.4.8-php7.4-fpm` - linux; arm64 variant v8
...
### `drupal:9.4.8-php7.4-fpm` - linux; 386

```console
$ docker pull drupal@sha256:2c6ef23f7eab7cec7b911edd126d76523cd4bf23aece2c13de1e0953d6c220f1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.5 MB (185496962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c1c38509416dbe16787f6d391aa87c92f703f081a785e007e21b4e618a9fffc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 15 Nov 2022 18:52:13 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:52:13 GMT
ENV DRUPAL_VERSION=9.4.8
# Tue, 15 Nov 2022 18:52:14 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:52:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:52:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:37d0256811741709d813d193e66a0ae7da667667428c6e62ebac416dc4aecf19`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:042d8d36d4711a097d5001c26338db60ae2d8a4239b1d60f59cd1e99f92321e2`  
		Last Modified: Wed, 16 Nov 2022 22:49:55 GMT  
		Size: 695.2 KB (695201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61ef8ad57cab660d36f1d835079cf3a83a1f547203e7fb17fa7071c753ac7b84`  
		Last Modified: Wed, 16 Nov 2022 22:49:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbe851502f4cec286d70cb22e7ad94febaf6ea1032c9376c19d47171cccb9609`  
		Last Modified: Wed, 16 Nov 2022 22:50:09 GMT  
		Size: 21.9 MB (21899291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.8-php7.4-fpm` - linux; ppc64le
...
### `drupal:9.4.8-php7.4-fpm` - linux; s390x
