...
```console
$ docker pull drupal@sha256:a1222ee66cef4c40f41525ad989e2d3f8226b093a664d14e390f93b4c17d0601
```
...
```console
$ docker pull drupal@sha256:903870979dd213a96c03e65a4c28720af899c9195d21acf617ec1cd64ba77935
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.6 MB (53558543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b93dfd9ecc85739319a6558ba81b5f79070f879154b7ed119d5fe8bd87215e55`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Feb 2023 20:10:20 GMT
ENV DRUPAL_VERSION=9.5.3
# Fri, 10 Feb 2023 20:10:20 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:10:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:10:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bae49642fa436190b8e5b140b024cc6559d2a4c96b16b2bfbc9b7012b2533e50`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe93a8c685fb83a68651b75182860090dbc8d303642471dad6c19ae2f2b6127`  
		Last Modified: Fri, 10 Feb 2023 20:18:54 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:686b51904778a906aebefccf05646572142ea659c352d25312cc0f83e530890f`  
		Last Modified: Fri, 10 Feb 2023 20:18:59 GMT  
...
```console
$ docker pull drupal@sha256:b0e6de4866dcf2ddbe81a17552c24ecb5c58106e120736d514aab810dcd53f7b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 MB (55671761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e9e83a384f26fe81b3fa16216e8370b5500a169bfde2fc30ea4a3c16acf2b3e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Fri, 10 Feb 2023 20:21:55 GMT
ENV DRUPAL_VERSION=9.5.3
# Fri, 10 Feb 2023 20:21:55 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:22:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:22:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0f079559d67e202c76b54abc38c84303193d223481c6feb0c539396ddfdcd766`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0502039988e25e84ddf578d9bd934efa1ec1045a8a686b48f7a3f1f7085819ab`  
		Last Modified: Fri, 10 Feb 2023 20:42:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76858434b6e910326d5318de28c98b61e887499546214da5d00deee40c676113`  
		Last Modified: Fri, 10 Feb 2023 20:42:38 GMT  
		Size: 22.8 MB (22832229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-php8.1-fpm-alpine3.17` - linux; 386

```console
$ docker pull drupal@sha256:4c749d5a316f1ffc9c0df6de0eae443bce74067fb2c9c0b9602b3460793d940d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.1 MB (56106420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:114c7b51db9a33a4013780b8ae586fa24e3d19fc1848f0f706c78c6744d25b97`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Feb 2023 05:31:02 GMT
ENV DRUPAL_VERSION=9.5.3
# Sat, 04 Feb 2023 05:31:03 GMT
WORKDIR /opt/drupal
# Sat, 04 Feb 2023 05:31:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Feb 2023 05:31:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:18734936406687b8c1a646874125358d1a7043281d10045a8421bbcec0ebfb7d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9b6d9aea53b11d56678c7f8bda7dffb2ff89e26976c32d5f42f8ad5e528a94a`  
		Last Modified: Sat, 04 Feb 2023 05:50:50 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a93763eae11c6ee2bb839784d136c376aa2f455f1bc5d899a45642552ae23cf4`  
		Last Modified: Sat, 04 Feb 2023 05:50:56 GMT  
		Size: 22.8 MB (22834540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-php8.1-fpm-alpine3.17` - linux; ppc64le

```console
$ docker pull drupal@sha256:5db11d551945937646bd8f9b798e0071637af4f923681f3e4c49b2b08d8e5dc6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.8 MB (55755656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3593dc2ea86d5ade8ee985c996fc9d385573601141330fa72b2da5a7e470f3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Fri, 10 Feb 2023 20:16:51 GMT
ENV DRUPAL_VERSION=9.5.3
# Fri, 10 Feb 2023 20:16:52 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:17:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:17:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b03c7cfaa7b310ca4cdee393099747fd58b22e8cfe26bc0174450f79deabd1f`  
		...
		Size: 697.1 KB (697136 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b9e69ff5dbc3a5384cc267633758dfd526826368d5c15c1876083833a802df7`  
		Last Modified: Fri, 10 Feb 2023 20:44:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7de5ada249c8f891088ce592b8e1f319670b0a34a239261462fb6b13169bbad0`  
		Last Modified: Fri, 10 Feb 2023 20:44:56 GMT  
		Size: 22.8 MB (22832357 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.3-php8.1-fpm-alpine3.17` - linux; s390x

```console
$ docker pull drupal@sha256:cfa81493804c6ceab99e86bf2571b34c7a02f96de64e48ce9244013536458f6b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.2 MB (54168980 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74612a67beb9d562734a3e3a101e8c6f80456883372d3a5621cf8c3537016f10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Fri, 10 Feb 2023 20:39:58 GMT
ENV DRUPAL_VERSION=9.5.3
# Fri, 10 Feb 2023 20:39:59 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:40:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:40:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22e3f0fca2725a15e97cec0ac7609c9aeddca21efd855950b0a0e52a78441809`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71ca29b492ad8b60971383bbc4caad0d77ad8254d7ce32d85a62096c5926b004`  
		Last Modified: Fri, 10 Feb 2023 20:56:18 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eee53ff831446494be37c67e8abcc1278cea369a49fd10563842a8e67f422325`  
		Last Modified: Fri, 10 Feb 2023 20:56:22 GMT  
		Size: 22.8 MB (22832250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
