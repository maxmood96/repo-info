...
```console
$ docker pull drupal@sha256:0990dd38a978cc5d9b0a34a8b4a81c63c444918b4c266937c4b3dce1abd1f572
```
...
```console
$ docker pull drupal@sha256:c85e887fe25f08e4e6c174c89872b6fff4d5206a49a19723880880eab80b5b32
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185918651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6ed94f843e0b15074bf57cefc3ed14b95d5d3bfe6b9db0069c26ea65a963487`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 05 Jul 2023 09:25:43 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 05 Jul 2023 09:49:38 GMT
ENV DRUPAL_VERSION=9.4.15
# Wed, 05 Jul 2023 09:49:38 GMT
WORKDIR /opt/drupal
# Wed, 05 Jul 2023 09:50:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 05 Jul 2023 09:50:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e54874845f0573bcd3b3dbac8d1fb6a2f2a211c5286b80b17ca8b52b558b7bdc`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7db33e7dce99869bb5f32fc3c112f230d3fb4ccb90926bb573346c44c61458f`  
		Last Modified: Wed, 05 Jul 2023 10:32:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ba96d31a4331762403a8db606ea288d0eeccfe67a4a5d77364b3301b7334b3d`  
		Last Modified: Wed, 05 Jul 2023 10:33:22 GMT  
		Size: 21.9 MB (21915317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
