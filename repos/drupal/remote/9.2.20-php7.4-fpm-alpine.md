...
```console
$ docker pull drupal@sha256:5552067e9a8ae1659e41c4927aa3cbc9a76475633659d077e28085ed1d38d36b
```
...
```console
$ docker pull drupal@sha256:2dd2480f2bf1ad31b2b3c707c230392250a2ac6716e7c289be80f277699760d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (45965563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e041ed2e3902710874df309d83411f311031703c3208aa62f5bea6fedc840155`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 17:21:39 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:31:26 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:31:27 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:31:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:31:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c22927d5d7496519aef853fe5d44fe35f6049b12ecbe78b14b65ac1540a53be9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ef5d33f00fdb59bc75621f06c6d9a5c78e28c81f777980fcfd8482a4bf07256`  
		Last Modified: Wed, 01 Jun 2022 18:28:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db5544beaacafeaca47023f68748594526d914401ca0080765a901688f2bbb6a`  
		Last Modified: Wed, 01 Jun 2022 18:28:55 GMT  
		Size: 19.1 MB (19118702 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:bd4b73fca135c46d62f91e843fd8a1116b3bb4cac40dd8eba431ad9e78f1955c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47869797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15acad19266d77964ff80db8d4c2dd9f51487aabf8d21fb84f07f4e02ad19ecd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 01 Jun 2022 17:01:37 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:01:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:01:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1cf058586475ac504889f5196697b1329b613601ba3c0efb781b6bf7ae0c8885`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79a7d4002c55bfd7edd58e6f1f5929e7a5adaaa4bb84255822c1ef374953126e`  
		Last Modified: Wed, 01 Jun 2022 17:32:40 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cea8a28d308b16dfae8141a9915651e21466ebfc88e0128a1bb54fbb1397bc10`  
		Last Modified: Wed, 01 Jun 2022 17:32:45 GMT  
		Size: 19.1 MB (19119531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:f613c4ab5ea44dce2e1d57fa6902765fa2471d15ef329fa5f07d005bef463f03
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48706970 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1d7e34d9267c17b79147910ea095d1d5fb98237495c63808cbe554219fbc670`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:53:59 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:53:59 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:54:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:54:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:604f843575c53a23dde758b7ac3efe8200d4b63280d97f47ff3c1ed768f0a10b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00fc5f942dc3f7e1740c782458cf12ec15540b7530c647064d6bc1a18903c21e`  
		Last Modified: Wed, 01 Jun 2022 17:25:57 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93bccd0b0ec3c3090652247f6d2893f971af5056a04df1589d1795a5c35c47e6`  
		Last Modified: Wed, 01 Jun 2022 17:26:02 GMT  
		Size: 19.1 MB (19119411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
