## `drupal:9.2.20-php7.4-fpm-alpine`

```console
$ docker pull drupal@sha256:fa48034322c194c89762b108838cb7005cdb7113d11268bfdbab4af9fbf3e988
```
...
### `drupal:9.2.20-php7.4-fpm-alpine` - linux; amd64
...
### `drupal:9.2.20-php7.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:9.2.20-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9ce8e6526d46e9926ea28b4fce295f820cc4a3669a2582af499a128459058c25
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (45973812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a84c9e5f7d2de87c3791208975697b5a425c221a4eb33742c78870cddbb1f4e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:52:24 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:52:25 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:52:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:52:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:54e9d57104e030f79a34331d8ae442e8044c17074d5e82db3ab2ad753043ed47`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:138276f82cc8475a82a3e85e260fd4f34eca1674c9a799f3327a59399df293e7`  
		Last Modified: Fri, 10 Jun 2022 07:51:51 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5630996dc586e9d6a920dce37c6e3a494fc00da6c1136510131318619a67fba`  
		Last Modified: Fri, 10 Jun 2022 07:52:18 GMT  
		Size: 19.1 MB (19118549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:3ae275fe041a20f8fa63aa6fbd9438725a9e6ddcd4d2070c35ac6b63a78e78c2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47877972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1ff7d688ef738d01e4ce9bc7bbcf9740e8d4baafd421f198a969fd8a311a3d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:21:03 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:21:04 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:21:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:21:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0752c4cb86d575d504fee121ac95c7fc457d4aad62d133549a0b8c6bc4110599`  
		...
		Size: 669.8 KB (669840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a71c5ffd31dcd1832a5707e09180ed387c1107776c8822f911b2f4c4b94a228`  
		Last Modified: Fri, 10 Jun 2022 06:51:25 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7083d31285b3c9963d23bf7503f0c986c91a5a224db02c2a5b698f89809fdbf3`  
		Last Modified: Fri, 10 Jun 2022 06:51:30 GMT  
		Size: 19.1 MB (19119268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-alpine` - linux; 386
...
### `drupal:9.2.20-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:8732cca0d9ccfcb9bb0625f95d784cd9cdbbb5d34cc67bb70ffa8712c2b9c109
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49117571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d1aebff13eb9662792dd59f5665944b40e2e213eeb4fea1cc58070673a5feca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 07:12:35 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 07:12:37 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 07:13:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 07:13:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15b871803c9bc00631d038a245faf95b2cf38b51b3922ec9c69eee8ca646c9cb`  
		...
		Size: 669.8 KB (669840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a643920af9ea838d565c94935111869546d7e6bad84392d11df85d816d091374`  
		Last Modified: Fri, 10 Jun 2022 08:26:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36b95158d38c6cbd9406734e6dae6f66e232ad49036cff487861341734b6ba25`  
		Last Modified: Fri, 10 Jun 2022 08:28:06 GMT  
		Size: 19.1 MB (19118802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.20-php7.4-fpm-alpine` - linux; s390x
