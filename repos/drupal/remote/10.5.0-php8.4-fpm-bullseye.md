...
### `drupal:10.5.0-php8.4-fpm-bullseye` - linux; amd64
...
### `drupal:10.5.0-php8.4-fpm-bullseye` - unknown; unknown
...
### `drupal:10.5.0-php8.4-fpm-bullseye` - linux; arm variant v7
...
### `drupal:10.5.0-php8.4-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.5.0-php8.4-fpm-bullseye` - linux; 386
