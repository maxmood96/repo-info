...
### `drupal:11.1.2-fpm-bullseye` - linux; amd64
...
### `drupal:11.1.2-fpm-bullseye` - unknown; unknown
...
### `drupal:11.1.2-fpm-bullseye` - linux; arm variant v7
...
### `drupal:11.1.2-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:11.1.2-fpm-bullseye` - linux; 386
