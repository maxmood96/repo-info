...
```console
$ docker pull drupal@sha256:72859e981978b9ea823277de8734ea90e5f4fcca934d65f499e213e03c59b7af
```
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.7-php8.5-fpm-alpine3.22` - linux; s390x
