...
```console
$ docker pull drupal@sha256:638c17fea4d5c654cf9c2cef9706e61483b870670c71ca0a53b25bf1514a122c
```
...
```console
$ docker pull drupal@sha256:04e5ba4503371774f5b731f0dd59bd34c6cfd58b285d7336f04f095940134efe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.4 MB (171427212 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:845e42758360216c86afdaf2190c8f24cbe642d9990891f74db8e832073625c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:52:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 15:02:34 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 15:02:34 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 15:02:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1b7880f63ca27c8198aeb401d120d32aa4aec8c2f4c626aea19417962f69c3eb`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:415b048c3b413e1490560865bc072c39067c9629c59e398522dc67c76e5e7718`  
...
```console
$ docker pull drupal@sha256:803dd6b65c49b047db9d83fe78921c07f4cc1679678bb89203e642d2073f4bac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.9 MB (145870352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de1c40043fb07b2853dc1c9a1984d33452984f3d2955560c14f3022e4a735a62`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 11 Mar 2022 13:23:13 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 13:23:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
...
-	Layers:
	...
	-	`sha256:d2d006a854e8da20c0a335e717da537c533ca4b3110297ac0cad4d247833be58`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6673119e578f0e27fb7de9e8851f33d1ca3f378de0d3239e2f3558aa62717761`  
		Last Modified: Fri, 11 Mar 2022 13:33:52 GMT  
		Size: 1.7 MB (1667863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa6c487c806576953e9823c408309c4739fc1fe2fd95291d920edd47345885db`  
		Last Modified: Fri, 11 Mar 2022 13:33:51 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1077d18e1fe487928a03e5ad69942e53e243209e774b16b176bd8e4188985eab`  
		Last Modified: Fri, 11 Mar 2022 13:33:54 GMT  
