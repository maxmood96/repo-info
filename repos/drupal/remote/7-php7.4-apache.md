...
```console
$ docker pull drupal@sha256:0afa8e1742961ba7c595fe61015c02a16408c50386acd4d0406a90f6c80a4a6b
```
...
```console
$ docker pull drupal@sha256:f082b9dc0a35f81d008d8a22b989d60a2c2349d5b52bbf04c32185b08bb54c57
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (171983670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ef268e67eb8ee940e01ef4077ab6b19b24e8251ed8f430ef3facc2cf53ebc71`
...
-	Layers:
	...
	-	`sha256:5066fa6c34bb80697416ef53fab3b3d983f159e1f62bb5994899c781d1b8ffa0`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a27af9a63e200caed28791224124380e2c552325256a0560f1f0376cac4f2df5`  
		Last Modified: Fri, 03 Dec 2021 18:03:13 GMT  
		Size: 1.7 MB (1718649 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:220193204ff3e2cd05c870f442c55cd89168216df05d671faba1a6519802f036`  
		Last Modified: Fri, 03 Dec 2021 18:03:13 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bfcda3c7627853750f1f7111e732eafe8177f85cd2e096b3d2b2f133fc8b283`  
		Last Modified: Fri, 03 Dec 2021 18:10:49 GMT  
...
```console
$ docker pull drupal@sha256:fbf6f924db685b999c7eb0b614695182c86f80d26f60f7f8e1c1b8c035175864
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.8 MB (149843492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94f500c7f60853d9302ce29f3de5abd8c469f9e02b9f5359e4eb5d46a7945fb8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:2bbf523e4a9b0ea205bd5ff21820dbbbf53bb3b2e070824250efaea6a33b38d5`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa77f4dbf11223e7edca671ea680acd59b9c4ea907f3a76b8c3530fae8aa52cc`  
		Last Modified: Fri, 03 Dec 2021 10:55:27 GMT  
		Size: 1.6 MB (1595957 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1802d50c28e553ae8408438c46880378130ac955847d928cab17f023714e26ae`  
		Last Modified: Fri, 03 Dec 2021 10:55:26 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6edf9bce9f1c4c4bc96bd632415b57b4ee21420e64a6db35bafbc3488d813e8`  
		Last Modified: Fri, 03 Dec 2021 10:55:29 GMT  
...
```console
$ docker pull drupal@sha256:dbd6fc567cd0788afb9a63f31871ad3863217944c58a5433c3fe0f63bf83af4a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141768972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da2626017111bee9d9486d38073683dd970692366ccc809a46fd0aa505092905`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 04 Dec 2021 05:06:26 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Dec 2021 05:06:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Dec 2021 05:27:38 GMT
ENV DRUPAL_VERSION=7.83
# Sat, 04 Dec 2021 05:27:39 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
# Sat, 04 Dec 2021 05:27:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e37404b00d335493f61374f272a7216702cf8388f9f82f8a047b4ab50f127587`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70fb799a785d47f61d1dd774f0820312013b8e1141fa11c88298ad735e7f2139`  
		Last Modified: Sat, 04 Dec 2021 05:52:33 GMT  
		Size: 1.5 MB (1469738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2f45891b33707add0fe2d9dee2f53e03c7118a20e3141d7ea3f525cba376f51`  
		Last Modified: Sat, 04 Dec 2021 05:52:32 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dd6557a900c8040545ef1f6ebca80f2332785e8d616bdef7396b1b4e28900e1`  
		Last Modified: Sat, 04 Dec 2021 06:08:24 GMT  
		Size: 3.4 MB (3380166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3dc50339acb0fd7fba23a7b68cc89e4cbc3bc6a0ec2c837bb8c656487c95c197
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.8 MB (164775232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94c3f7ed38de25d27eaf2ecd1dd71ce4657ce60762aec1e10eb94e2cc2051c28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 03 Dec 2021 12:14:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 03 Dec 2021 12:26:56 GMT
ENV DRUPAL_VERSION=7.83
# Fri, 03 Dec 2021 12:26:57 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
# Fri, 03 Dec 2021 12:26:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:66ea42386502b194c584d71e1f88f69838db19da91b9267c10597425e0f5cb57`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d67d2b52b4bc8c236e8bcfa55aa8013eeecf4eda15b7b06d96d3967ff553435b`  
		Last Modified: Fri, 03 Dec 2021 12:39:35 GMT  
		Size: 1.5 MB (1482483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd6f96ab4eea108439dca2c82c25fac41f795259544a6361f9d3d07ba2b63840`  
		Last Modified: Fri, 03 Dec 2021 12:39:34 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c9506be9d95493ecddc28a1d310dd706885562e2b92459e3d16e8a464a190b`  
		Last Modified: Fri, 03 Dec 2021 12:57:16 GMT  
...
```console
$ docker pull drupal@sha256:70babc5280a93838804af4875bb4ea4a239b8491beda2f85362480318ae01263
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.0 MB (174983224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:197aff1eaa3578488cc67122efcc5ed590c0f3e11a9ffb379336881286a6b394`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Dec 2021 17:44:12 GMT
CMD ["apache2-foreground"]
# Fri, 03 Dec 2021 07:25:53 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 03 Dec 2021 07:25:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 03 Dec 2021 07:44:38 GMT
ENV DRUPAL_VERSION=7.83
# Fri, 03 Dec 2021 07:44:38 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
# Fri, 03 Dec 2021 07:44:40 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ba60d51d58ba398452d85888c43bf2dfb7ba533205f03682206e0010719e04cc`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da0108f5925a4bfeaaa752b45607ab43f086dc33d3e33eb3b42cccca10ce0949`  
		Last Modified: Fri, 03 Dec 2021 08:06:41 GMT  
		Size: 1.8 MB (1793237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f59d32b622cdd6303f5389ffa600669bd996e86c689d6f54e8d52c02bb9cb8e`  
		Last Modified: Fri, 03 Dec 2021 08:06:40 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdeaf0f134764cf9b7e11e82ccce1cfb93bb7b18a5cf482d9d647aa4f48681f4`  
		Last Modified: Fri, 03 Dec 2021 08:20:02 GMT  
...
```console
$ docker pull drupal@sha256:d4726391c59aacb51c02cfb18a0c033879e34f03c0f510e19a49e25d85b74dc0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.8 MB (149814816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b7d1a977e644b52964ab33de188b55d5cbc433b202c0665a7aead54349ae90a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Dec 2021 00:56:57 GMT
ENV DRUPAL_VERSION=7.83
# Sat, 04 Dec 2021 00:56:57 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
# Sat, 04 Dec 2021 00:57:01 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:96d3d372c2515107e0a31ffd9c7cdc83a33036bd5eb21985ec82b6515ec82454`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d0aa75c9f5d7bc271523add6825a5dba13ccbaa7325cf9e0783e6197a358bc9`  
		Last Modified: Sat, 04 Dec 2021 01:04:59 GMT  
		Size: 3.4 MB (3380055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:faa997e48e380e704e439009878ac96b68fbb37364dd67228bf3b26b4126ae1f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173359090 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb9e4bde36400e0468133bc01860eb34ef036453f30e88ada2105ed1fbef3356`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 03 Dec 2021 16:27:19 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 03 Dec 2021 16:27:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 03 Dec 2021 16:46:20 GMT
ENV DRUPAL_VERSION=7.83
# Fri, 03 Dec 2021 16:46:22 GMT
ENV DRUPAL_MD5=c8833da8f1ef03a244b4130b71872e26
...
-	Layers:
	...
	-	`sha256:a38eb14484e3c34ad2ce29c6624c60ab246b02058dba005ee58c74035b8363eb`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b625fd77bb40309e41766528126cac5d518e5b090ac1f19f813a99a10a049dd`  
		Last Modified: Fri, 03 Dec 2021 17:05:11 GMT  
		Size: 2.0 MB (1950553 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b46bd841bf4f36e98c3390593b2f97aec14a028b689e43333761c9e350234ac9`  
		Last Modified: Fri, 03 Dec 2021 17:05:11 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:619392a7e8529a48d639172b3999a948620c150a4c0b7a04f9af2efa3ea31060`  
		Last Modified: Fri, 03 Dec 2021 17:37:08 GMT  
		Size: 3.4 MB (3380166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:183e391f6384afc6c0718790d285e9997221db7b972ed1f7b8e49a542ce9e10f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.3 MB (149312938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5439158dd21e4f5e04f81e99856fc5dfd6a12ebbb6a25b89f0dea6e825eaf9f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:6dee65b596b984d82c9f32c5f0f05e9b6be56c276cd0591ce72da2a7c3b47e1d`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27ce77ef0acfd711aa17046c34f58aaf81461cb98586adba9ee69269548aedb3`  
		Last Modified: Thu, 02 Dec 2021 23:58:07 GMT  
		Size: 3.4 MB (3380169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
