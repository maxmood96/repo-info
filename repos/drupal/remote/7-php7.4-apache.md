...
```console
$ docker pull drupal@sha256:6e7f66acee1fbe20bdaa8ef7bb1b56fec6310b219fbbd60a4455d6fe5c911131
```
...
```console
$ docker pull drupal@sha256:4bf778a86bb6ebeec3df1d9e81196065360066428334e3f663e72f15e70c6ce3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.6 MB (170627047 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27da5b5d6c17e56c4aee28d7cdf9058ab7a0e8983c5f78e8db818210e54c8417`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 05 Oct 2022 15:35:52 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 05 Oct 2022 15:35:53 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 05 Oct 2022 15:35:55 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bf754c52cfe648fc0f8c2438e1a1298bf7d9f035577e8b6a891397c9cc4aa012`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fc1ad5b8a69f652ba7a2f3e034fe944c7a0ce6cf47ba2a491d5c54a6329c00d`  
		Last Modified: Wed, 05 Oct 2022 16:08:18 GMT  
...
```console
$ docker pull drupal@sha256:f241e24b4b5240b6700e7100dbbb3f7850cdbc0b5d09efbb07fae45c1d2bf2f0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169617496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72b67ae42efbf2bc15bf390772ef816dbc81073830053f517ee823770971a574`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:17c3ed74acbbc2e61e4f04d87104561578851139326279faba5581b0e830df0e`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95e2fe36c878f527bcfd5ae23872085745c5e25777a3f6d15d201ceed8e7c410`  
		Last Modified: Wed, 05 Oct 2022 17:21:42 GMT  
		Size: 3.4 MB (3396846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:97f6d75c498b8d640c1b781351cdb67e64b8068200c283471bb25204ab63c46b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146088350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16a8da18fc61d233640b04f8cf22775d4401926f261977c4b3cc75dd5bc7fb5d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 05 Oct 2022 13:34:45 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 05 Oct 2022 13:34:45 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 05 Oct 2022 13:34:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:04177813486987bbdae075dc9ab8675bdc808eb85d413b6aed75bf91e6d3756b`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e10f3843402af84c5230fafa5f8cf74944891f033cf2a998a47909ae7024b9d`  
		Last Modified: Wed, 05 Oct 2022 13:55:06 GMT  
		Size: 3.4 MB (3396846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
