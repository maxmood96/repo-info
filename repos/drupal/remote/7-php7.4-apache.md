...
```console
$ docker pull drupal@sha256:0fbff55464b95c053d514521a3ffd5bb7f57d5d5e433595942d826d18a83709f
```
...
```console
$ docker pull drupal@sha256:f2f53816b1b6d78209d484fc7bcc2836ddcb9fd072fb6522091ec9bf78d737b1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.8 MB (138764702 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ac766d44eee9c7876f0abc456bf97eedfa5650948b70e607a4732b8ffb9b706`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Jul 2022 00:48:44 GMT
ENV DRUPAL_VERSION=7.91
# Thu, 21 Jul 2022 00:48:44 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Thu, 21 Jul 2022 00:48:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8d55d8437e7b8deb13f841e333330e39199245566a00b33c1d42dac9c063f6f6`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05c9e5ca85ff7b08af3e780392142a7c1666eeb4cb72a7adbc45d8fa6055d16c`  
		Last Modified: Thu, 21 Jul 2022 02:03:28 GMT  
		Size: 3.4 MB (3389335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6693e115351e00ed0062a36cf507a0f530a1eae50b233ac1d5bf7e0f58ac990a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.8 MB (170803228 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:479bc05396fe426846eaef2cfb97354b0e543bdacbaaa9bb6a6cc69f54cab187`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Jul 2022 00:00:14 GMT
ENV DRUPAL_VERSION=7.91
# Thu, 21 Jul 2022 00:00:14 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Thu, 21 Jul 2022 00:00:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:83a3334d648a22b1cb88aa549b4249eba6241fd176b7bb868d8c28a9a083c6d3`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f866634b7cd417c67b2d732b820d1387d2089d5ca22cdf21513c7e42f1b8f4b3`  
		Last Modified: Thu, 21 Jul 2022 00:40:01 GMT  
		Size: 3.4 MB (3389053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d161938a5fab4642b4c37b56263fe262253d0bd2187647e4166d73613448bb5a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169589885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bec778f8112873ca05ccc8c5be50a9c9bd78959c27528c4aec9beac0d1ebc77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Jul 2022 00:02:38 GMT
ENV DRUPAL_VERSION=7.91
# Thu, 21 Jul 2022 00:02:42 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Thu, 21 Jul 2022 00:02:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c68b823f915627c7e5a535be4ca230f779e16a25752a3429d6226dc0d6fc00dd`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49146b030fa68bb8a408d0289e1b97067709530ca30a630bc446c98dba0c4807`  
		Last Modified: Thu, 21 Jul 2022 01:20:09 GMT  
		Size: 3.4 MB (3389335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
