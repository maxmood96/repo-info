...
```console
$ docker pull drupal@sha256:442eaa5af6858b753d2d619bf2a1f2578a5e7304ce442840431988757e4ca1c9
```
...
```console
$ docker pull drupal@sha256:c4fa20bf18a31f65c28cf2be25eead4a1a889223a055cf188b72fdf91000947c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168509006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85a025b82bc27b764f73ef0fa591e0aa7ed55e63a58f03544019e76d6bf43050`
...
-	Layers:
	...
	-	`sha256:5aa89702daa9a790f5510a7b54c381d8c412fc94d157b6896b76bbd360298349`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1435c07b21cfc82f031e53cd8e1bf4c5c20a10a2ac5f33a247d1aeb4a93bd4a`  
		Last Modified: Wed, 13 Jul 2022 02:17:52 GMT  
...
```console
$ docker pull drupal@sha256:1766a69f25b6856a9798f80a46ab1b4046bfed9682102f958d03b9f30a7bdc76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146643905 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5362905bcac5feb94280ef3b2a824bf488859688b4c29502dfa0d022bec48a0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 13 Jul 2022 13:22:49 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 13:22:50 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 13:22:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0d3a1eb64be8a8a3b77b374385bc993787a170a69dd2cf6b56ad3e312c2a9a91`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26aec0ade1ce9a8d6816faab066a04f9b986951f374884ed170b32404f1dc866`  
		Last Modified: Wed, 13 Jul 2022 13:34:37 GMT  
...
```console
$ docker pull drupal@sha256:0144b864dec456cce2de1840849a2f25687ae6f5f749c31cf90a41201c921f19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.8 MB (138763993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98d88b9daedf422bee614b58c3139160ffba5b5444dfb1c1b5f4fcb12ea579f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Jul 2022 13:14:57 GMT
CMD ["apache2-foreground"]
# Wed, 13 Jul 2022 14:29:32 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Jul 2022 14:29:34 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 14:51:52 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 14:51:53 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 14:51:56 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1864a3897d4671227f7bce9c52dae81d7a174eee73a3f80fb38e2afbba2523d9`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c49ac21fe2786cbb86547a7854d590779c5305c9c022452ac6dce4986e16823`  
		Last Modified: Wed, 13 Jul 2022 15:34:47 GMT  
		Size: 1.6 MB (1645691 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d55d8437e7b8deb13f841e333330e39199245566a00b33c1d42dac9c063f6f6`  
		Last Modified: Wed, 13 Jul 2022 15:34:46 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22015fbf9b56bf3427cc90f937f5ec09d14c1c017452a0110eed58bd5af29eac`  
		Last Modified: Wed, 13 Jul 2022 15:52:17 GMT  
		Size: 3.4 MB (3388626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5a6b24c27a700a9439d93ff0cbee25591927e3a184df8e8203f9f73445b3e8a1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.9 MB (145883835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fc6f5a6ecee459dac5dd960d27a0ff44b1d70fad39a3c16e48b517c2596ea6b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 14 Jul 2022 04:11:40 GMT
ENV DRUPAL_VERSION=7.90
# Thu, 14 Jul 2022 04:11:43 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Thu, 14 Jul 2022 04:11:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f4a7b3138fc24891e058183b51015e74fda10c08ab7bb31811e3a22e7b007e45`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6de37fa95edbd76d3608a6acca00334ccca05a78fd4ea89ac0d0c60961e1829d`  
		Last Modified: Thu, 14 Jul 2022 04:23:45 GMT  
...
```console
$ docker pull drupal@sha256:11a1af695313ecef098dcd76ef84d4af1248f6caa6ce26e502e4fe9eadc0dd33
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169589176 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae7d096cf64f45371a67756e1a844c3e916d8a5c16d70080ab2b7ff96e9b6b81`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Jul 2022 09:05:59 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 13 Jul 2022 09:06:01 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 13 Jul 2022 09:06:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c68b823f915627c7e5a535be4ca230f779e16a25752a3429d6226dc0d6fc00dd`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69c338f1da35ff26b690359ced0d77fc1c8785fdd299e46eff6e872dcd6b1116`  
		Last Modified: Wed, 13 Jul 2022 10:33:26 GMT  
		Size: 3.4 MB (3388626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:030dc0782370e510e9c63c1984912df6bedc151d522b57639ce3f3ef0c7518d6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146068145 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b69e33203ae199e3591ff773134dbd74b76262f0e1df22ec9656dc6a3b467997`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Jul 2022 20:23:04 GMT
ENV DRUPAL_VERSION=7.90
# Tue, 12 Jul 2022 20:23:04 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Tue, 12 Jul 2022 20:23:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4c01535a53576e868e5b8982438e485c0a6c5cd2235437ded82ca9a06aae372e`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e21895ffd9f9cc9496efc872a0e39ff6a52c7c53abd23d7825a06b61a41cc323`  
		Last Modified: Tue, 12 Jul 2022 21:03:46 GMT  
		Size: 3.4 MB (3388614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
