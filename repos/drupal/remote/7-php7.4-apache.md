...
```console
$ docker pull drupal@sha256:6764050159c4888d90acddc37fe0f62570cf502956113f2e9346278db9db86ad
```
...
```console
$ docker pull drupal@sha256:5580996b4038b298e61e6b9210bc1b1d59c3e477006b17ae9483331dcb73aa5a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161386405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4788157a106b998e595e21e1695c9dc65bc708749a82b4b77f7addaa0eab397d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 05 Oct 2022 22:58:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 05 Oct 2022 23:11:10 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 05 Oct 2022 23:11:10 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 05 Oct 2022 23:11:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:373343b72d84510606365dbcba6c2ea3f788633d09d472262df053e48565439f`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea0e8cb7c84bc67700522efe2cb28d3d919b0e3707e146f9259615419f6d5326`  
		Last Modified: Wed, 05 Oct 2022 23:42:35 GMT  
...
```console
$ docker pull drupal@sha256:1590bd014edb40f3e78f53fe9b708f29a76bd5c146eff0605d22fba031dbaf8e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.7 MB (145700775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba35ddfe05b718662b729dcde6bedd496905563721e78eaf00a6037551ecf180`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 06 Oct 2022 06:42:33 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 06:42:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 06 Oct 2022 06:42:42 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 06 Oct 2022 06:42:45 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 06 Oct 2022 06:42:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:18afc63e7afb959cb942e178d4c18bd78853a297a793e18e2e493e0e2827e32a`  
		...
		Size: 899.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19dcb48e9df8acf8ed67e37aef80bf16ed7f34d70357ca66809f0e4c14b6c608`  
		Last Modified: Thu, 06 Oct 2022 06:47:27 GMT  
		Size: 1.7 MB (1668657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35e4e97a1209ad52a5d3b65f35b5bc7e854b773ee67e5fab130243ef9e2d19bf`  
		Last Modified: Thu, 06 Oct 2022 06:47:26 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d276e5f396c0e8208401c32b41651d14b68d4b0e8db720c990fbbf192a82def3`  
		Last Modified: Thu, 06 Oct 2022 06:47:29 GMT  
		Size: 3.4 MB (3396561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
