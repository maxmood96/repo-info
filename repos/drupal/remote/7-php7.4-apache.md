...
```console
$ docker pull drupal@sha256:cab4b3e103c1b6d294e239214448137d663c87b598201dcd4e700cb81f15c692
```
...
```console
$ docker pull drupal@sha256:b11a24e35b4fe4655d63b12edd3a0b8381d5a52c72c512ca60e0c29b7169bbb2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (171983763 bytes)**  
...
-	Layers:
	...
	-	`sha256:220193204ff3e2cd05c870f442c55cd89168216df05d671faba1a6519802f036`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9861a1104b3bc03405c22db2350a9eccd21b6b40215aad5aea08f0be9d88e414`  
		Last Modified: Tue, 14 Dec 2021 01:28:25 GMT  
...
```console
$ docker pull drupal@sha256:801c1860222eca9d844f44613a10dbd07b3bafec90c85b83f1201ca90370ecbe
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.8 MB (149843031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20049bd0be3cd3548adb9a6cc89dbd374347a696d429c8e21d3b9ce4639e272a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 16 Dec 2021 22:17:24 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Dec 2021 22:17:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Dec 2021 22:17:26 GMT
ENV DRUPAL_VERSION=7.84
# Thu, 16 Dec 2021 22:17:26 GMT
ENV DRUPAL_MD5=1d270b00fbbb87a81776202eec1f848e
# Thu, 16 Dec 2021 22:17:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3d1e8b1b3ca84b45b14e69e644ee9064bbb207b7151034cdadd04595aa8debe0`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8f97370f4c985b44a484f40def30d6122f907ac124831a0a3c2cc96abd7227c`  
		Last Modified: Thu, 16 Dec 2021 22:26:46 GMT  
		Size: 1.6 MB (1595967 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e31fd1d5d5531d3aa0e1e7f78e294bad7d38f5e308e940d5435e8181209378d0`  
		Last Modified: Thu, 16 Dec 2021 22:26:45 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3d52c279cecd0f06b565853888e081f5c8e3f9fbc67ced6fc415de389182fd1`  
		Last Modified: Thu, 16 Dec 2021 22:26:49 GMT  
...
```console
$ docker pull drupal@sha256:60053de5442d5bcde604ea3f2c4b31583c7983e13e0a907d4b9dcb6d9741b2a2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.8 MB (141769070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a6a2a7a9c921d561fd8438cd9d50f219c04dfc869d0225f1674fe78252a31bc2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Dec 2021 02:06:20 GMT
ENV DRUPAL_VERSION=7.84
# Tue, 14 Dec 2021 02:06:21 GMT
ENV DRUPAL_MD5=1d270b00fbbb87a81776202eec1f848e
# Tue, 14 Dec 2021 02:06:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f2f45891b33707add0fe2d9dee2f53e03c7118a20e3141d7ea3f525cba376f51`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8703f2aa1e045a02273eb2466820251d4c03a50f825b42256c48c2b3d648b81`  
		Last Modified: Tue, 14 Dec 2021 02:27:29 GMT  
		Size: 3.4 MB (3380264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a74b2dacfa7f3ce6c0faa138ff4a135fba5b354b9942b336329c6a4409807d4c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.8 MB (164775352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9b2e4a631f079a2ae072bfaa2d0b822c7aca378afa93f3ff872746f494b3e5c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:fd6f96ab4eea108439dca2c82c25fac41f795259544a6361f9d3d07ba2b63840`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83a0fd1a034ab08d6d86c8e0bf0f5e10b56246e5a983bb6021f80a7d02630d3c`  
		Last Modified: Tue, 14 Dec 2021 01:55:12 GMT  
...
```console
$ docker pull drupal@sha256:f36e583003a39fbf4f48544da919fa57e976ceac90881c164a4d47c88c392ed3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.0 MB (174983319 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad7f302cfdfcc78545d9f2de3ef146afda9151bf564ff06bbee6700616e3a6f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:9f59d32b622cdd6303f5389ffa600669bd996e86c689d6f54e8d52c02bb9cb8e`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ae95de5854d3c194c63118bf05f5aba727c5e2cd7092299b9b9af3d6ae5ef06`  
		Last Modified: Tue, 14 Dec 2021 01:53:55 GMT  
		Size: 3.4 MB (3380264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:4e0a5ed2d7934c3d3edcecef18584305cace6475474e966fdf4b6c72092dcbae
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173359185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98bfc9c603f201517259e0905686b5afe6d5aabf603e2ff50dc032f604dbcf6b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Dec 2021 01:19:53 GMT
ENV DRUPAL_VERSION=7.84
# Tue, 14 Dec 2021 01:19:55 GMT
ENV DRUPAL_MD5=1d270b00fbbb87a81776202eec1f848e
# Tue, 14 Dec 2021 01:20:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b46bd841bf4f36e98c3390593b2f97aec14a028b689e43333761c9e350234ac9`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b776b4e025da80783563e86bdfa26b2fd6af89ae73d350b2fe65c0229be8a6a5`  
		Last Modified: Tue, 14 Dec 2021 01:29:31 GMT  
		Size: 3.4 MB (3380261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ab12a0e59937fe5669095afdb512e676fb4c13e81d32923d2c7b2dff0999b70b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.3 MB (149313033 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:998c1e4fb937d952e6065dbe2ae0fd74a9b7e1a1ab04a8f2af4ead5d611736fb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Dec 2021 01:45:42 GMT
ENV DRUPAL_VERSION=7.84
# Tue, 14 Dec 2021 01:45:43 GMT
ENV DRUPAL_MD5=1d270b00fbbb87a81776202eec1f848e
# Tue, 14 Dec 2021 01:45:45 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6dee65b596b984d82c9f32c5f0f05e9b6be56c276cd0591ce72da2a7c3b47e1d`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f04f2c700d9d6f588724d94aa047ede079d686ac70366af943ff649f26de93c`  
		Last Modified: Tue, 14 Dec 2021 01:55:34 GMT  
		Size: 3.4 MB (3380264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
