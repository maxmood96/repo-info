...
```console
$ docker pull drupal@sha256:46e22e138712d7dd619cba617bc8f4b1b38fbdd59e54c3371e9c4bba1f26b1e0
```
...
```console
$ docker pull drupal@sha256:7e40dc892433cf3c4c2875dcab3902c1745989b9659092bfc061da195d977717
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146624816 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e354568a879be3346c0d43a3ea974bddf64778508c95b2e9f964766c2eba8a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 11 Mar 2022 10:08:08 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 10:08:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 10:08:10 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 10:08:10 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 10:08:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e1ea85425570a0c60dcf6b6624c0f723942b2a9cb71fe5ff8c34c2b970797f59`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5b5f9eb886bd56827977d1a12ddfdc887580436bd61436751262301934fee96`  
		Last Modified: Fri, 11 Mar 2022 10:17:31 GMT  
		Size: 1.8 MB (1773112 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc6dae500c5f89ba66015a245fa297a53103063f5f379c44f6648b0e80f6567e`  
		Last Modified: Fri, 11 Mar 2022 10:17:30 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91b2346f8f66e7ee091aa01afc3220c7287a75f94cd3644ffcaa36ad87f608d3`  
		Last Modified: Fri, 11 Mar 2022 10:17:33 GMT  
...
```console
$ docker pull drupal@sha256:3dc41566bdd0b02872bc03253b5783395efc16cf46d11475b80cf60d12c737e8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.6 MB (161552802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7acd3f5ad6ad98d7522df966a2471785169f9ff60a66703f593ba44697ca9916`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 11:10:52 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 11:10:52 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 11:10:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d390d06ce6168f5392b5c7327b9a769d25822f97ea2781bf64299b99763f47aa`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:443c8eb07b7e9bf2b3a1ad2976daf18733a1b8fc591fec16df7a4bded118070d`  
		Last Modified: Fri, 11 Mar 2022 11:37:04 GMT  
...
```console
$ docker pull drupal@sha256:be1856b87a0ecbeb1749efa3a0fdc91a9b6c8e9052227e2ed15feb9a78d54c5e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.9 MB (145869989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34d023a79498f22368960a6bb436e0b79346d93f69a60b6d982be29433bdf167`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Mon, 07 Mar 2022 02:23:11 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Mon, 07 Mar 2022 02:23:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Mar 2022 02:23:21 GMT
ENV DRUPAL_VERSION=7.89
# Mon, 07 Mar 2022 02:23:24 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Mon, 07 Mar 2022 02:23:33 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6ccf75f86445ab9e4232ea77860313f40a2319b768c19dd72cd6d10e4496f5f6`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a93cc4e06cfc4cdb3ec28ca7d0348c64c147e416f56bd7ef676f277decb1aeb9`  
		Last Modified: Mon, 07 Mar 2022 02:33:34 GMT  
		Size: 1.7 MB (1667883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcf88f3ed922947718649ef77538c77b5fe4a07a534d1b23c6c555d86df37627`  
		Last Modified: Mon, 07 Mar 2022 02:33:33 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a144cc00baaab504e73a33ceab0c39cf6d480b2a49144242469357ef6ba621ef`  
		Last Modified: Mon, 07 Mar 2022 02:33:37 GMT  
...
```console
$ docker pull drupal@sha256:df6b06404fd0b8ebd2b25360602bfd4636415176fe6e785d3299433ac7b0d555
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (146042289 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9ad982db083015a56113d05242fa18c7feaa866a98166f8d62829073b08c7f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 06:37:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 06:48:08 GMT
ENV DRUPAL_VERSION=7.89
# Fri, 11 Mar 2022 06:48:08 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Fri, 11 Mar 2022 06:48:10 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c1674a8a6645792b4c842c6297d2a485d2c222e115c3ce8937a4372e9e403375`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56de696b6a08fe715d1c1fe87ccc8b112014d52499d7462591f2302012ffbd42`  
		Last Modified: Fri, 11 Mar 2022 10:27:45 GMT  
		Size: 3.4 MB (3383150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
