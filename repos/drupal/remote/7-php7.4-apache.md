...
```console
$ docker pull drupal@sha256:b784e856591d96117d3fbf2b5a031015e86fbd192221f26716ffc49f1ceb2646
```
...
```console
$ docker pull drupal@sha256:9780b9842a50642afafa760f0295e6cd298f5e1ec0cb2e1d365e1caaaa64ecdc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161420060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd3ef871e8b1cdd2e59be9c60f242ab5e96fcfc542ddbc860b4a40beb90df9c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 02:59:13 GMT
ENV DRUPAL_VERSION=7.89
# Tue, 19 Apr 2022 02:59:14 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Tue, 19 Apr 2022 02:59:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0ac0f3d09b9e78fe1414a1ef3e24957f560ba4fb68342e45dd56fd090def2bb2`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd54f2790a4afb5c8ec8b2b8591cfe87ab5cd8c7fa5cd3493b77d9ec1da822fe`  
		Last Modified: Tue, 19 Apr 2022 03:25:21 GMT  
...
```console
$ docker pull drupal@sha256:523fde9ee03f4d6bde72b8ab77b8277897dd7b2e17ba2ad50135922dde827e9b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.7 MB (170657600 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8df8a2381e9aa52686619f793db955f2d52ad72ce484141f0a557de83815c51f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Apr 2022 02:19:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 02:29:39 GMT
ENV DRUPAL_VERSION=7.89
# Tue, 19 Apr 2022 02:29:40 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Tue, 19 Apr 2022 02:29:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0b842900d852169f1305a60964e5c92e8cc03e3b50e4f9189d92e1d87ac07dbc`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9c2642164ff9859c19eefb553ef6ac65b1774357fe5e1c39f2a9447f23d2ceb`  
		Last Modified: Tue, 19 Apr 2022 04:03:31 GMT  
...
```console
$ docker pull drupal@sha256:90947aecf2a71a74ff85b1e301de529176d498dae587372bd914df10be1a61b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.1 MB (146120076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c95ecf601a8cd2d0927ba19b8efc3d6bc4be7341366d27dcf33b65adf3eff68`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 02:58:16 GMT
ENV DRUPAL_VERSION=7.89
# Tue, 19 Apr 2022 02:58:16 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Tue, 19 Apr 2022 02:58:19 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:0e20be72a5de665a0630089a36957516d48c18493585c1db9b9fe9f6e5a7ea60`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaf5ad78fcdafd3fd9bd389326b93ccf60cf76de5b43c7874bf0a1a33378aaa8`  
		Last Modified: Tue, 19 Apr 2022 03:20:13 GMT  
