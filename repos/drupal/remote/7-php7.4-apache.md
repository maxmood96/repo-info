...
```console
$ docker pull drupal@sha256:4ff4b9bd6e5784aedeb4f90595154563364c1e8ab6d419b1ad8d2bea3737a091
```
...
```console
$ docker pull drupal@sha256:8ccd5d1f9140db244641598b070f7c9e0299e8a818a6a429f483252de2864af0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172350406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fa4ab3bb070c1431474636835d945bfcbdab89603d128903dd1460dcf958938`
...
# Thu, 17 Feb 2022 23:32:44 GMT
ENV DRUPAL_VERSION=7.88
# Thu, 17 Feb 2022 23:32:45 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Thu, 17 Feb 2022 23:32:46 GMT
...
-	Layers:
	...
	-	`sha256:d6d818972d503bee13eacc451d16dd79f31c0e6819a1e16d3b5bb6e37d48026a`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71a787c46a889ed1546cc408be5dbebf7edfed73d3c775de166369ae7756a93a`  
		Last Modified: Thu, 17 Feb 2022 23:52:04 GMT  
...
```console
$ docker pull drupal@sha256:2c13edf067d461f3084cd5f38fc2bed0c402f92ea27138023763a403873cebcc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (150031745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:478e237b969482715aa29005f4413bb1a0048a538ff4f68d010bdeae9ce5f104`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 15:03:08 GMT
CMD ["apache2-foreground"]
# Wed, 02 Mar 2022 08:30:46 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 08:30:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Mar 2022 08:30:49 GMT
ENV DRUPAL_VERSION=7.88
# Wed, 02 Mar 2022 08:30:49 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Wed, 02 Mar 2022 08:30:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f9d25aad064ea2aac039bbdf5fb17480b02a0e0de22961fa374b6323b0a8ceaf`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb2805af738dfffae8491645b0e4c9a59680132656c1981c80e42a855ca34430`  
		Last Modified: Wed, 02 Mar 2022 08:40:19 GMT  
		Size: 1.8 MB (1773127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b30da20d9a9b0df35654656b5da3d3db2f0904a12e48fec88f1bbc94c5fb084`  
		Last Modified: Wed, 02 Mar 2022 08:40:17 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37d2ab94dd23d492bbbb2deb3f89f7be35f7777536b5455404e95bd37143ed63`  
		Last Modified: Wed, 02 Mar 2022 08:40:21 GMT  
		Size: 3.4 MB (3380485 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e3376afa46333a93c9c4d434d6345518cf6bb730ea43802a18d3ae34d796da80
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.0 MB (142045647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51b8a06d3dd6bbcfa34e5277e98992508bb22bfa72a3785a4f4e979383feb40a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Feb 2022 22:28:04 GMT
ENV DRUPAL_VERSION=7.88
# Thu, 17 Feb 2022 22:28:05 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Thu, 17 Feb 2022 22:28:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:718d73d1c5377c20b50e681a92a6894e78328838a6692ad212317144183e7e09`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3684b3ee46f0b7fb5b5f859de5e7404bdec4a9e3e9ce20465991fbff6da01cf6`  
		Last Modified: Fri, 18 Feb 2022 00:57:27 GMT  
		Size: 3.4 MB (3380485 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a4af94f2fe42b12f3c77636aaef6254d5572a573aafd328f78d29c84b1285bbf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.2 MB (165198664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:697e782928ff1cd4dea9381e086e7aad55ec60634e882206c9386e3235377aa9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 12:44:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Mar 2022 12:54:48 GMT
ENV DRUPAL_VERSION=7.88
# Wed, 02 Mar 2022 12:54:49 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Wed, 02 Mar 2022 12:54:51 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f87bc844eccb9afea70419078f4a857f9d182345a73e6761945254ac851b3a09`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90f70b5ad3809abaab2d3fd6d4ecc11cd685be31af14f6daa79fc79c3b68ec4f`  
		Last Modified: Wed, 02 Mar 2022 13:19:26 GMT  
		Size: 3.4 MB (3380358 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-apache` - linux; 386

```console
$ docker pull drupal@sha256:e0e2341ee8beaa8c6a1e122c6a2f3d90c032946c213c273b5b8d76b0b18eb16f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175216278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8a77ba4d2a59c8fe86d3323c1cb5c34b3a5e34f5bbb348044c33a64fc736cc3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:d3ede7434709c7e0d1b19fa3e8d01c676ef809418eb6e6f2dcbd393f8faa269b`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8bbfdc6c186384bc2b1a9ecd0fc435a9674fb46595cf3f9f2b0b9cf9df62057`  
		Last Modified: Wed, 02 Mar 2022 07:05:06 GMT  
...
```console
$ docker pull drupal@sha256:20ab54f038546bc7bd5aa66dbb7be455bfe21eb833af1c55029ee1ed8b5a166f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.2 MB (150156830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da5ef454d68a3870760d5c6cde2a3e3ae91bae30cb61d4f82026633f285c5924`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Feb 2022 19:26:28 GMT
CMD ["apache2-foreground"]
# Thu, 17 Feb 2022 20:52:39 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Feb 2022 20:52:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Feb 2022 23:06:03 GMT
ENV DRUPAL_VERSION=7.88
# Thu, 17 Feb 2022 23:06:04 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Thu, 17 Feb 2022 23:06:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:765007d7baa6246d9028224bfe7a0d037a167094649a351056fce0e72d57f4f6`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e39aa4dcb89c15a70854b76b98d11facac933a01d3ef66bb9b011f0db51796a`  
		Last Modified: Thu, 17 Feb 2022 21:12:59 GMT  
		Size: 1.9 MB (1881929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3c2543adcc6ca950e282347985a711c8435b29dc659ba76f49bbf7a4e5f9ee8`  
		Last Modified: Thu, 17 Feb 2022 21:01:08 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7063d60a8d8e15dd0a597dc6745190efb84f15c1f9e23c6737398e86eb18d454`  
		Last Modified: Thu, 17 Feb 2022 23:13:14 GMT  
...
```console
$ docker pull drupal@sha256:2357e2eadbd6fb72f532f7ddc75eeaf64f689027c2226e9932c317947fc1f99f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.7 MB (173741851 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29e31308d5f4ca298d195d5ad723dc77021f459ed62dc0c5dd26200042c04ae7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Feb 2022 02:22:03 GMT
ENV DRUPAL_VERSION=7.88
# Fri, 18 Feb 2022 02:22:07 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Fri, 18 Feb 2022 02:22:19 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7694275e409cc00f691e0548c2c37734470826f0ccd6d57a135c53b1631b9b17`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:702303aaff4fa541bcddb513300c789174459630634e76e1cd27480479ecdcd7`  
		Last Modified: Fri, 18 Feb 2022 03:30:34 GMT  
...
```console
$ docker pull drupal@sha256:84a7b2288c24c3357c3ede9a817bb35c9f096f1b203a48a8b462b421ee428eb4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.5 MB (149496826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23d579e1737cde960fef5f35f32d4354cf854c4528b8f15be100e5c6b654f284`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Mar 2022 22:23:53 GMT
ENV DRUPAL_VERSION=7.88
# Tue, 01 Mar 2022 22:23:53 GMT
ENV DRUPAL_MD5=ff1a687492ea18e22cfb009198a7dafc
# Tue, 01 Mar 2022 22:23:54 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:59831220f82308069d50cad70c912bee55a1e81f5ce9985fd397c9d4da726b56`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3896f140dfcde6873bf4b72a1f62b36dda61ef32ec11487e17ea796d1c7f1ec0`  
		Last Modified: Tue, 01 Mar 2022 22:37:03 GMT  
		Size: 1.9 MB (1889891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ada950771668810a7ddab152968a41fc6146796cdf8dbbb3dd35d571ad1917b`  
		Last Modified: Tue, 01 Mar 2022 22:37:03 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8183b6efc7c67a4c07a1576295b41351cd76aa334cd2468b6a7f8410c40b1166`  
		Last Modified: Tue, 01 Mar 2022 22:42:24 GMT  
		Size: 3.4 MB (3380483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
