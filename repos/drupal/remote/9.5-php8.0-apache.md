...
```console
$ docker pull drupal@sha256:d68d7cd28c62ab5b6f6805c67a124f92d56d5c757590d157459da7f8c005d0b7
```
...
```console
$ docker pull drupal@sha256:9640fbcbcf7f4b3bbf478fe41a5363a49309b6f54b4720abe80629e868b376ef
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.1 MB (190054134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:526c9af70f3b45159901051c34aee47736ceb9fb3d6bb5f191e8909c103a6611`
...
# Sat, 11 Feb 2023 14:26:42 GMT
WORKDIR /opt/drupal
# Sat, 11 Feb 2023 14:26:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 11 Feb 2023 14:26:55 GMT
...
-	Layers:
	...
	-	`sha256:49fadb6955fc00cae28f7372fe5861e3b58674f3d970a1e8f7aa2ca79bb17ef4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d515c5bdc6cc501cf4ae30553789846c11c9f06bb51dc67a564b77c6c3c559e`  
		Last Modified: Sat, 11 Feb 2023 14:46:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5dbe7b163df41f868957feac4a0bd437cbf5d840fe3ef7881a7c6816e729364`  
		Last Modified: Sat, 11 Feb 2023 14:46:54 GMT  
		Size: 22.8 MB (22844982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
