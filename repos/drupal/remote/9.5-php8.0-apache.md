...
```console
$ docker pull drupal@sha256:d471873d5dc07ac40916d5e4fe11306a750c868af4354f0cc7a4b6234ca58d0d
```
...
```console
$ docker pull drupal@sha256:c120b72f51e58024e841fc9d4f1870e0d3c6e249f6e945a475fb05dc48f0e466
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.9 MB (192890056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14aa0c73a2045acb0dd52a1f2df8b13bc4ca304c9e22394a601c4bcc35728640`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Mar 2023 00:22:16 GMT
WORKDIR /opt/drupal
# Fri, 24 Mar 2023 00:22:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Mar 2023 00:22:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ff83a34bee9d10ede051c605740b1491268dbc40bc4c05acd982313e8172f5e3`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:708d5d2c4504cae2d58261d096155df17b55d9a1c23a88de6873fb1ccfc2dc87`  
		Last Modified: Fri, 24 Mar 2023 00:38:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b0e5936b9c20fdb1ee04ab468c5f24d1ae89cfdca4f7320bd46964416b8a546`  
		Last Modified: Fri, 24 Mar 2023 00:38:14 GMT  
		Size: 22.9 MB (22850207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
