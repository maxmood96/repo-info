...
```console
$ docker pull drupal@sha256:44f4ba7f03509c4225fb48c3b55cbf64d8225266f4c2a7d18d36d21b00857ffa
```
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; amd64
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - unknown; unknown
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; 386
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; ppc64le
...
### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; riscv64

```console
$ docker pull drupal@sha256:97f72e81604b0ba99232432299af4ed688db7c1046ca8075f349eb781cc2e97c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **66.6 MB (66564621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31119ef5435905e266c08a737e36f41090a1ff59e3301aeaf66b672a491a5457`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9c7c9627012c47bfd1eada1e40f1215a2f7d3e574dbad380e04911b0fa65f97c`  
		...
		Size: 116.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:44b3b1932d5c1a3a2ee8629d2dddba47084a943dac22fa8ddcc6b8f9da55c5a1`  
		Last Modified: Sat, 20 Jun 2026 01:43:14 GMT  
		Size: 23.5 MB (23458786 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - unknown; unknown

```console
$ docker pull drupal@sha256:a2d48b0187e97238d87295a61c4a8eab758d2786552b062d78691ef55d70c077
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **408.7 KB (408713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd731a6cbfdbe8ac4befd359c569973d44093022545d34e084b245344f157a88`

```dockerfile
```

-	Layers:
	-	`sha256:b5271e0a23b70293f7d38357343d78b5e9bee068f9eff629456a218230f7e3e9`  
		Last Modified: Sat, 20 Jun 2026 01:43:08 GMT  
		Size: 374.8 KB (374842 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:35e4ccf7d47b84b160403856efce5b19362dd4a934dc207de0cc857e99993b50`  
		Last Modified: Sat, 20 Jun 2026 01:43:08 GMT  
		Size: 33.9 KB (33871 bytes)  
		MIME: application/vnd.in-toto+json

### `drupal:11.4.0-rc2-php8.5-fpm-alpine` - linux; s390x
