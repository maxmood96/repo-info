...
```console
$ docker pull drupal@sha256:690bdfa9f32643bbdc9ce837552070486c668822f63216c528638068e696f1df
```
...
```console
$ docker pull drupal@sha256:9453ad033851d60ae6105a4e2aa4e0a187bdc71f25422f2c23c56c314d4e265a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143859206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:897c8c5d007fc475f14799e8819867601e7d273b1013630e2bd30319a6b50b7a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:f4842fa6a36c22ccd05162400078f4346b68605b65dae043ae238d10a1e160ac`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1565ef6b4647f6e89077df02a79a36def8cc55ec831cb5a120ee37dce2543cfd`  
		Last Modified: Fri, 23 Jul 2021 15:11:15 GMT  
		Size: 553.2 KB (553184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe946232cc581124a89a3d96ebf6461ef4faec1ec4e766db9684f53d730a55f`  
		Last Modified: Fri, 23 Jul 2021 15:11:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd139e023ad3f28cc23b1df7c089a2d22e78129c13307eb3715b4a42fb74d310`  
		Last Modified: Fri, 23 Jul 2021 15:11:41 GMT  
		Size: 19.2 MB (19175887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:bc385594454cb4392950df04beac0ded25553914c2d49a2471901210fe2bc25b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.6 MB (160591324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdee67140ef9e9533c5e2a2fcd7a63f487e754b8b7c159c239b5e05fb47e2260`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jul 2021 22:04:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 03:48:22 GMT
COPY file:5b0f37fae58d62cf1ebe5912cbfa57f9316290804d17b8bf9f3c001f68794ad9 in /usr/local/bin/ 
# Fri, 23 Jul 2021 03:48:23 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 23 Jul 2021 03:48:23 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:48:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:48:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:61ab6802704bbc20dca2540c96604e2ac54e888cedc979d6e31d03880876b754`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:280f7477afcad212e60c173e5baba3c5f45e4928a1497d9787678e25c9659e7c`  
		Last Modified: Fri, 23 Jul 2021 04:05:23 GMT  
		Size: 553.9 KB (553885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29a05ef0cb585f763c66014a4dbf2ff125b0b4c26c43dde487e3f08d68bd7f12`  
		Last Modified: Fri, 23 Jul 2021 04:05:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a0457d01d75124a16afb074201df3f702e5a50d8649f2b2a7c950d04a873413`  
		Last Modified: Fri, 23 Jul 2021 04:05:28 GMT  
		Size: 19.2 MB (19175796 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:95842ae283ff9d7035169546fbff57f83c3b3c69c43dc0dfe7d33cdf74fc21dc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179904992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6f3ddf49ca424ef6a3680273e1e764c7f2dc1e9642d9ca23ddb727879547848`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 02:35:14 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 02:35:17 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 23 Jul 2021 02:35:23 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 02:35:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 02:36:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f5cee6f9a98f0ca159bab450a52aa86f0c2ee0c5d62a3ec7f093a481365b209a`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6765b57f07449d2f1436486f0a4fcdfd8e6726fcf7d80cc494ad4f7063f3eaa`  
		Last Modified: Fri, 23 Jul 2021 03:08:25 GMT  
		Size: 553.2 KB (553180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24a75f739eab2a2b26baec78aff746cb5a7ce47994e4349ae97c93f4e21ad907`  
		Last Modified: Fri, 23 Jul 2021 03:08:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b096ca550c308424a7162e5e948a467b6b9bd07e2aff9671e0573b0399e4480`  
		Last Modified: Fri, 23 Jul 2021 03:10:40 GMT  
		Size: 19.2 MB (19175882 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
