...
```console
$ docker pull drupal@sha256:48acf90a7e1787b0974e66ab5764eecceff1879e5392b451065e9648413dc07c
```
...
```console
$ docker pull drupal@sha256:f9c17861af8a1af9f0c66a6c23349ad36c4076773f8adbfdf37b1699ed5220cb
```
...
-	Image ID: `sha256:ab765ddc6b70eb6bceb002683816527a0feb423496b3971f05e3a9d191420d6c`
...
# Thu, 12 May 2022 02:42:48 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 02:42:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 02:42:58 GMT
...
-	Layers:
	...
	-	`sha256:eeae007a0ef15fb05ee077d4d2d4024511142cda55bd11a254487e02d5ed5080`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53d6df9563992e07435354a6cdc66082a10a40091fda4ac098b586777747caa5`  
		Last Modified: Thu, 12 May 2022 03:00:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff547dd331165af30c4122dcdeae707cb42ddf1c953b3e1b995fb2c1503c7f01`  
		Last Modified: Thu, 12 May 2022 03:00:37 GMT  
		Size: 19.1 MB (19115722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:b6a5ee016b2eb95af669fa6f9a39d3aec78c0a552f16718d1b2e0b1a3329b8ad
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.0 MB (140955962 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bdb525714f61a26036389a2e9111c2b8553143c078783fff07bcee4ba72910c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 22 Apr 2022 14:39:12 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Fri, 22 Apr 2022 14:50:52 GMT
ENV DRUPAL_VERSION=9.2.18
# Fri, 22 Apr 2022 14:50:52 GMT
WORKDIR /opt/drupal
# Fri, 22 Apr 2022 14:51:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Apr 2022 14:51:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:65843a7695f39729e04fee63b9e2f24c2f5d8cef37cc3f8208478811556d742e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5d4dd03834ce9407cbde2cc798f40dc76fabd231b4edcb30486206b948083ff`  
		Last Modified: Fri, 22 Apr 2022 15:38:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e583435c5e7eb0d9f851f7ba849031dbd2f02b2c1d127c04247eebc3b500b012`  
		Last Modified: Fri, 22 Apr 2022 15:39:18 GMT  
		Size: 19.1 MB (19115743 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:5cf95ec1b97e373285ece7aeb1f6c7790aeca3d830df7960028412460368df50
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.6 MB (156598332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91c4a8377e45e8480b1f779f799de0f21c27ffbc0b72e06dd3711e8a843bb6ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 11 May 2022 21:34:49 GMT
ENV DRUPAL_VERSION=9.2.18
# Wed, 11 May 2022 21:34:49 GMT
WORKDIR /opt/drupal
# Wed, 11 May 2022 21:35:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 May 2022 21:35:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f4b09fea2f0fc58dbe35079e56b2ddcf0d7e1f4b866ef31faab11bc00acaad56`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ece01bf732362d98cd34a1708cc43c9c6a1287b377325cb00172f16dad69124`  
		Last Modified: Wed, 11 May 2022 22:00:16 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:550052c58689bdd4a92d7ae32283d907aef153f311fcda3e9cd403e050581fa0`  
		Last Modified: Wed, 11 May 2022 22:00:21 GMT  
		Size: 19.1 MB (19116799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:78adc55bc56e1610185a833d3d7fe945e8c8ceee7c7f109af06152991bf6848a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170424809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f42812e4488c1912d27a87a347ae82daf20260fd40644d43ece0a986b0a25b2f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 11 May 2022 18:49:52 GMT
ENV DRUPAL_VERSION=9.2.18
# Wed, 11 May 2022 18:49:52 GMT
WORKDIR /opt/drupal
# Wed, 11 May 2022 18:50:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 May 2022 18:50:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2ef58c737ba83560ebc932c571557b2b2ea53f9951a9a38c73eb4d65721954d7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:144f2b5749340fb20340ec4ac4c3e2440a776fcbd36d40719fe6f9f5d96417b0`  
		Last Modified: Wed, 11 May 2022 19:16:01 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92cd001119949dd689a2aa5045a7933cb5768c3ad2d582cb521036dd87b4d537`  
		Last Modified: Wed, 11 May 2022 19:16:06 GMT  
		Size: 19.1 MB (19116550 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:44cb9c1c3f028c6a1d75924493a31c0a43508dc35f0e5069c784c8752eef2377
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176171767 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d44247533b061d8f804bd2903ca1ddba329062407e2471da0758e40b0443667`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.2.18
# Thu, 12 May 2022 14:33:30 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 14:34:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 14:34:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c477def7f673e4a6581f45674209ddef8d015f21acaa7022077f0cda515f89e`  
		...
		Size: 661.6 KB (661586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb88f5125c21da84fc14b5a2cfb4445b97776e8ce6a270b5b332ce2a976f089b`  
		Last Modified: Thu, 12 May 2022 15:35:26 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c997f0c3fe513961f7e8320510dcc4058e8db94e575cfa1c9cb041ff9db682d3`  
		Last Modified: Thu, 12 May 2022 15:37:02 GMT  
		Size: 19.1 MB (19115856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:923f0e878ae5cd39e9c6be40c082a89133533a6ecbc06a2ebbf6e015c0c61970
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.0 MB (151017300 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b119a437f15f538191c8c20eae717d59daec3c99eb27e8c50222057114be4771`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 May 2022 18:02:40 GMT
WORKDIR /opt/drupal
# Wed, 11 May 2022 18:03:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 11 May 2022 18:03:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d006d4ea4be76b534c4f12cb963322a7317ce8bafce35b6e13a2ae239d6e14be`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2916ad0d39e0c0f2b1837ade20968d02226d5721d71041f7b1fc24e80f643ab`  
		Last Modified: Wed, 11 May 2022 18:25:42 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:534c419346d2d41b8d10bd487b084c98729929b660159437af392f01c7f0c4e0`  
		Last Modified: Wed, 11 May 2022 18:25:46 GMT  
		Size: 19.1 MB (19115992 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
