...
```console
$ docker pull drupal@sha256:40ff3b32ccb60728872ff1769c7f6cb59b74390d31f190a9d3742c067caf8db9
```
...
```console
$ docker pull drupal@sha256:725d97860c198b316d0f8ef8dac8dd01963d95cbf9c405debcbd8d969096f321
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.5 MB (168503630 bytes)**  
...
# Wed, 10 Nov 2021 20:45:22 GMT
ENV DRUPAL_VERSION=9.2.8
# Wed, 10 Nov 2021 20:45:22 GMT
WORKDIR /opt/drupal
# Wed, 10 Nov 2021 20:45:32 GMT
...
-	Layers:
	...
	-	`sha256:3110bbebd6e6796dd95004b3b22e1a12f208b5cf5a5af3dfc05cf877cb35f917`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fed7599e17d3a0ce915a3bf7ee83f0bc0b990e040fbfbef3a89a0575dc998241`  
		Last Modified: Wed, 10 Nov 2021 20:55:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a57e6dcf69f5ed489f5e87c52001b42cf40fa4ac73c1d70ea18d4a7ba8777e1a`  
		Last Modified: Wed, 10 Nov 2021 20:55:58 GMT  
		Size: 19.2 MB (19188573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d586181aeb6e852a18dbd7d76b154644925b0e1d9890c9f0547ed7ec80f14569
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (159959198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:775876ee1893603ea9282ee46c0a8e36a2465d8c6f3e545ee6a3615c1e3cccd4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Nov 2021 22:32:46 GMT
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 10 Nov 2021 22:32:46 GMT
ENV DRUPAL_VERSION=9.2.8
# Wed, 10 Nov 2021 22:32:47 GMT
WORKDIR /opt/drupal
# Wed, 10 Nov 2021 22:33:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Nov 2021 22:33:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:924023b20cd598c504c253191079b53ea1738003fcaaf500536ad3633f77192c`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a56ebae8989a0e82cf5ad03dafdad5951c6a754c7dc85c16db2454a0635c161c`  
		Last Modified: Wed, 10 Nov 2021 22:49:55 GMT  
		Size: 564.1 KB (564138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:290f8f80ad31ad6dd4e2c52a2e12ac53e1f360018e78f4210718881d792189ad`  
		Last Modified: Wed, 10 Nov 2021 22:49:54 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb0496c44769df1455419c59853e7c9f0a831059531e1ba155cfa38bd47a7279`  
		Last Modified: Wed, 10 Nov 2021 22:50:00 GMT  
...
```console
$ docker pull drupal@sha256:4c78dc24e253fcf612114e0b5eb6b49cf9b4d8eb62fb44cdf219896765a1ac01
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154182881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bfca4e461f730ad6a53f645c5371360b36c40cea6d0e6feb433a6f5ede48c99`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 22 Oct 2021 19:57:30 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 10 Nov 2021 22:53:14 GMT
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Wed, 10 Nov 2021 22:53:15 GMT
ENV DRUPAL_VERSION=9.2.8
# Wed, 10 Nov 2021 22:53:15 GMT
WORKDIR /opt/drupal
# Wed, 10 Nov 2021 22:53:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 10 Nov 2021 22:53:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b62a4f82fcb6f9a96911087c0236f7c965ff3b898c83977077e0ebf3c192df77`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a202a84e1d8c6fe1c38ad185d8c883289c1dca165332037f24a6b06f6e97f107`  
		Last Modified: Wed, 10 Nov 2021 23:13:43 GMT  
		Size: 564.1 KB (564147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10e992c7096cee6d8b2ea85e4ee9d1790d2f4f7b0614e6ae22a06ea51b7f2c52`  
		Last Modified: Wed, 10 Nov 2021 23:13:42 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b60764486da6c4e8a2c2f57da8f2e9c4f81c14deeb6e3b85769d0c08375cef3`  
		Last Modified: Wed, 10 Nov 2021 23:13:47 GMT  
		Size: 19.2 MB (19188542 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
