...
```console
$ docker pull drupal@sha256:559de532eceee62a63a7f8b0013fefb337206936c992d074be448a65cb595432
```
...
```console
$ docker pull drupal@sha256:c1186b21cd2eb7c497292ba1843cb8aa25cb129de5a0eab1532b75b2255e18e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140853016 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c8005116f692ad5e77b387264e7de72eb1b42eda2058bfb4365ea5feebd5da8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Mar 2022 22:11:28 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:29:31 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:29:32 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:29:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:30:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:067cb6750b704d2a94e520a25fb157834270dbb58d0eb92b6014420ef2bd6f12`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d46fd7affc9f60d7e294260662e5905b0c20f8fd36dec3153ba8b7d93b363d3`  
		Last Modified: Tue, 22 Mar 2022 23:13:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcb3a385b44dcdb5050e70f5d4f56945a6b6d67bd2ba88e6428dc1bfc6bf3172`  
		Last Modified: Tue, 22 Mar 2022 23:14:11 GMT  
...
```console
$ docker pull drupal@sha256:f5ee2d6a516c46be2d9f23a146577d7a1cd8d58f98d06e11bbcf20b6b969bd31
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.0 MB (170984429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b626141c3e4678ff46b79ee61d7c7b5f7f4e6cd6d692405e2cbbfdaf11216a51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Mar 2022 06:25:54 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:47:57 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:47:57 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:48:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:561dd63eea9f1c43603186a8f7f9e1dacec451c12b7d8433d2ef4732279ca653`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad8926c705cbdb0b90e1f7f110bef0847d8966068d61bbcce12b608f66a21b03`  
		Last Modified: Tue, 22 Mar 2022 23:13:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50bf290f0cd7fdbf603821cfe858455e7754ba80468abdd2d9047599d25bb28e`  
		Last Modified: Tue, 22 Mar 2022 23:14:06 GMT  
		Size: 19.1 MB (19115779 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
