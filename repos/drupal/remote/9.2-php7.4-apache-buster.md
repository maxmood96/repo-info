...
```console
$ docker pull drupal@sha256:7b5873b06c1b56a2bee879e38b22cb5160a8bd187c200ebb53211221d7f82cac
```
...
```console
$ docker pull drupal@sha256:7dd70c15b6baf84cce755ffec671ba4122420e8a8a1dca01dd215f892e6d4055
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.0 MB (140968247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a61cd9e01aaa651596052cd26c4f5096368ad626d43d0b303b9caab96406814`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:50:59 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:50:59 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:51:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:51:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2bf75bf06afd9caa1b6351c1c9fa0a26e3d82c3881c670379f44bad0ce8119ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbc7bdcd3a0c1c66b90a062a75b34d4186c5659d69c45054beac52216dfff434`  
		Last Modified: Fri, 10 Jun 2022 07:50:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c6a775e80cd8f6c5cbd9e50f2dda24dcf9e0211eeb947000005aab626e8f076`  
		Last Modified: Fri, 10 Jun 2022 07:50:56 GMT  
		Size: 19.1 MB (19118367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:440fca747b38316b01cd9e633a7ae8bfa0b62d0b733c527e8adcadae23d2d983
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.6 MB (156614242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:03f1d90b8c750c6d19fe579cbd03b86179bea1e3adc1e2a27176e085dadaadde`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 06:20:00 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 06:20:00 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 06:20:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 06:20:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:21e31121ae543c084faf37b93c86e488f1acd7d00384b84098eea355ea444558`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab1512fc18fcce834dab09c0648d4269df96a12af0dd7082b22a6c650f8deec0`  
		Last Modified: Fri, 10 Jun 2022 06:50:52 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ffecd4d8722bd6d8b0efafb663fe416a73cbdfc28dfa1769404809a3a4a1080`  
		Last Modified: Fri, 10 Jun 2022 06:50:56 GMT  
		Size: 19.1 MB (19118981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:65a35a5517ad09da437e2f879156d9e8ce753107742ecdd0f1e882045baf2c57
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170436607 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8eadefe3a7878968e11f9cc0b85bceb8e681f997929596ea13bc544c111dea6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 04:09:30 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 04:09:31 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 04:09:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 04:09:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3a29773a38ff38ffddb951b80e41ff55d7633c01a7a2f8fca42512f4c9612135`  
		...
		Size: 669.8 KB (669843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0217468f816bc0c75f4be3ac21b469318ce5067f72be9bc44880aff72fd7bf2`  
		Last Modified: Fri, 10 Jun 2022 04:41:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c197b451d433094c41e6c5986f24196a0470ff042d2c91c8ca6863ca1223a5b7`  
		Last Modified: Fri, 10 Jun 2022 04:41:47 GMT  
...
```console
$ docker pull drupal@sha256:fccc5fb23493d675f7077570bd43a7ac268945055841ad484d0086cddcfdb4f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176184676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2ad7180c5528fc9a76cc6c732086c98fd028160da6089522ec27434f26adcf4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Fri, 10 Jun 2022 07:10:34 GMT
ENV DRUPAL_VERSION=9.2.20
# Fri, 10 Jun 2022 07:10:36 GMT
WORKDIR /opt/drupal
# Fri, 10 Jun 2022 07:11:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Jun 2022 07:11:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1d9e35f030acdfc733a2fe01fb233808a72a4955d65348b72208839315a745e`  
		...
		Size: 669.8 KB (669842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43a95f56f27d23afce92a4d2d1dfca4e1224c9404c7ae6611af5ecd158b077b5`  
		Last Modified: Fri, 10 Jun 2022 08:23:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32bd3daa35cc2bb0ffd9c4822c740aca77bead44bead201d46e075371ded2c2c`  
		Last Modified: Fri, 10 Jun 2022 08:25:16 GMT  
		Size: 19.1 MB (19118776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
