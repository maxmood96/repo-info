...
```console
$ docker pull drupal@sha256:5d23336f34fb66418e72f98433fd2bf4b6c5df90be65d531be6223622259fbc0
```
...
```console
$ docker pull drupal@sha256:83b238448e6a70e35c99a30da4fb06678fdb62584aa24bc9dd564bbd26d23a26
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168566750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b09a510e7e97728a65de6b5a67cfef72b6642611f2b8487b51ddefbdab295fdc`
...
# Thu, 02 Dec 2021 02:10:22 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 02 Dec 2021 02:10:22 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 02:10:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 02:10:33 GMT
...
-	Layers:
	...
	-	`sha256:e4330dbab965619112d95384654e12a488f470acb4fa18fefe6bf90576b9ef3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c9eba7f90ee26270842fbb3f5665817d54b30cfdc53b5bec8e39d21b9797a0c`  
		Last Modified: Thu, 02 Dec 2021 02:20:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1926d87b1c0eef5212331392db280c3a542369d91bfddc1bb87d6ff3b7819f3d`  
		Last Modified: Thu, 02 Dec 2021 02:20:38 GMT  
...
```console
$ docker pull drupal@sha256:c9a8b0fcbb98996ecd5af49731d216a8156db0f9885132073bd199cbe5f81ca3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143921543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5553baf9d661077994262552106887260c3ee53f4c9e09df170256e23df3ddbe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Dec 2021 08:19:55 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 02 Dec 2021 08:19:56 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 08:20:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 08:20:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:02c099b4145c710511717b9e832859870e7a9ae613f06f21fe98c42b51ea86b9`  
		...
		Size: 564.7 KB (564654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:544a46f6655e2409fa9c5430d75b34899fe0724cf7a7b99dfefd2cfdfd9d226f`  
		Last Modified: Thu, 02 Dec 2021 08:51:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79d8a4ce07a7c4f099e6e8fafbe7f19969547c50b460572a683c53c284f7559d`  
		Last Modified: Thu, 02 Dec 2021 08:51:37 GMT  
		Size: 19.2 MB (19191415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:189cbdbbd94c979cf934773895e2db64f8181f720378b8e6558a09f71b95e754
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.0 MB (179967496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ce891b27ba85fae413166f2578cdb4018962f12f88bf22ff19554279b7c4c3f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 02 Dec 2021 11:06:35 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 02 Dec 2021 11:06:39 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 11:07:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 11:07:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:621329627223456f108fea9d9eb2f9f910b2434d0e781ba5e5334f827485428a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4179c687353ea6d4482b79d2a7fcad4cb159a5f62e9776211ab3afc95beed6`  
		Last Modified: Thu, 02 Dec 2021 11:37:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50d1131c2a9db2b330f8d435637730ee6a3aab12e0dfb492eac11112a2e53006`  
		Last Modified: Thu, 02 Dec 2021 11:38:56 GMT  
		Size: 19.2 MB (19191719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
