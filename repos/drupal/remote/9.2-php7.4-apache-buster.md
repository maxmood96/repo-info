...
```console
$ docker pull drupal@sha256:546e0f4e5ce03b441fa42e5f5a06c59372e2ec7a8034013d686663839897784b
```
...
```console
$ docker pull drupal@sha256:2dea6d4497c00c77a2aa7a9e7eb2d4f6b43a2643ab4d9aa406d92ac2fa984698
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.0 MB (151021701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3774ff32f3daef4b0238e56a5292b382c3e56d3ca2453c26ef36bd182e113a94`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Jun 2022 17:14:32 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:14:32 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:15:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:15:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b127d90c26061b3e7a724380e3f3d54d4018bb8572bc153bb47c6b1133f250e5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:094fde395259cde17e9349772233ce545bb196409dbd5ea9390cc535606c4e53`  
		Last Modified: Wed, 01 Jun 2022 17:44:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a8ef464f9b2b0e4eaaf80ded12baa86ca81e8dea12147babd38d1237f7fec42`  
		Last Modified: Wed, 01 Jun 2022 17:45:00 GMT  
		Size: 19.1 MB (19118341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
