...
```console
$ docker pull drupal@sha256:57c9878a252170a2c46ed2b5548b9c3dd1ef1b9e579b9de1b97dc268776dd032
```
...
```console
$ docker pull drupal@sha256:8280d281abf6d2019f84d581f257b00d04481f636804cf114d85c2cbb6119a66
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154196787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57cb092f39813a3d8fce4c6b009adea241c6657e893a51762332d8d200aea925`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 17 Nov 2021 19:32:40 GMT
WORKDIR /opt/drupal
# Wed, 17 Nov 2021 19:32:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 17 Nov 2021 19:33:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3018aa56384e23b79f0ff93308c785fc5862f3ad75994e2b3f32c9e98d656bcd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11ae70b60d7bf6d8924f871914f31d47c5613f16de4b69db55558e0247a3d964`  
		Last Modified: Wed, 17 Nov 2021 19:47:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20421dd4878fd3f3029d1dd15a4120453b5c9fab0e11e0b9fd98f9a2ab9494a4`  
		Last Modified: Wed, 17 Nov 2021 19:47:18 GMT  
		Size: 19.2 MB (19188398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
