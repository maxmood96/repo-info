...
```console
$ docker pull drupal@sha256:218eda2a6a3ccfecfdc89877b42640823a52e572acbae863247263b1fe35674c
```
...
```console
$ docker pull drupal@sha256:a356d6f1b6719ab3270f063b6fc9340ff0d4aaeced8221800c67020c1726769e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150921691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7eff3244c4e7f07674936d0a1b33abf200c811627f9c6864256738c07946220`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Mar 2022 21:19:27 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Thu, 17 Mar 2022 21:25:17 GMT
ENV DRUPAL_VERSION=9.2.14
# Thu, 17 Mar 2022 21:25:17 GMT
WORKDIR /opt/drupal
# Thu, 17 Mar 2022 21:25:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Mar 2022 21:25:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c11a6ccde1ae821bfeecb76bf2dc1d91d9be8097a3252a01cfba8ac499de9292`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:167ae641a74c9772cfb2def3db2c2f409cd6e6d16044ff05a837860e9f8becb4`  
		Last Modified: Thu, 17 Mar 2022 21:44:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4de2d103ad640840f50aa5315a75f21ee2f25b5b1b2a1c3faa8674e9adffb830`  
		Last Modified: Thu, 17 Mar 2022 21:44:30 GMT  
