...
```console
$ docker pull drupal@sha256:4de347aa07b7b288b311bb2c9173cbaa46200b04de7f1adc1fc8ca573ffdff68
```
...
```console
$ docker pull drupal@sha256:244d74f3349bf8234d62020f72a0426868cc0f4815a16ad7d20239c638f8a5b8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (160026925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d7fa66e25d8246a361a67162c5dd2a313f0be767ef7650949f84f245f72ad79`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:58:04 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 16 Dec 2021 23:58:05 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:58:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:58:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b478ec7acffbd1570c72075a3145d470bbb8aec89c3f94f3bec398628e6fbffa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ce89dd576c93bc067f5abceba53a790d597d099ce480ad87f8c50ef3bfb1b17`  
		Last Modified: Fri, 17 Dec 2021 00:15:19 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac0aae37ff61dc79d67a9b9bf88972b5e0a3d0c2b6b39a1da897fa697562094f`  
		Last Modified: Fri, 17 Dec 2021 00:15:25 GMT  
...
```console
$ docker pull drupal@sha256:a3e94cb49bccb728f546077545f03a21b0bbfa93e7c408699ce5a4d29fc83a22
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.6 MB (174592550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1a6385c71fadc5ef1348f16af06732f2c7948f4ef5568ac3be1255794685bd0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 16 Dec 2021 23:58:30 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:58:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:58:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c1f51e7d7245425c6dd744f03e9fd0861e392c277aa94e560b95f351b832d4e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2bd7627d4cf8c268d20060c41bbec10da326a76847c0b252e15db59d20739f9`  
		Last Modified: Fri, 17 Dec 2021 00:20:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:746b1090e86f31c2377ecb1a4647632e6ab703a24bf398ebbf7a3e7a2955ab21`  
		Last Modified: Fri, 17 Dec 2021 00:20:19 GMT  
		Size: 19.2 MB (19192016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:ed89723efadfd825903cd8f70200b2d72e2aa6a4cd54a9d21c532c84d0369cfb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.0 MB (179966369 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e75e9c973dfb42e3a2cc3fbc2e2a454e8468b1d71c6f00e6c8fbbcd4b5ff9f67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:38:35 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 16 Dec 2021 23:38:38 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:39:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:39:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7710dfc8272ada1c68eff76ec39e333e839899f5324c37d3d4f41a5f4bd9327f`  
		...
		Size: 564.7 KB (564653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63ae00ac9f30ea1c4e443067a7b62cfa577e807567316d17147cbab0534fe070`  
		Last Modified: Fri, 17 Dec 2021 00:14:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14ac2047c73c57f665e1b795de531bc06a2669871ee40e6572a8c3e0d1e2f533`  
		Last Modified: Fri, 17 Dec 2021 00:15:49 GMT  
...
```console
$ docker pull drupal@sha256:ac2cbfabef8fbf8a8ec26f8c9542f5a8638989e653de0fb60d60634af4d5fd24
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154246467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a096cab867164df8739bf5318d5bbfe95639a6866b7edc21b33a777bcacfe15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 16 Dec 2021 23:26:10 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Thu, 16 Dec 2021 23:31:50 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 16 Dec 2021 23:31:50 GMT
WORKDIR /opt/drupal
# Thu, 16 Dec 2021 23:32:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 16 Dec 2021 23:32:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:002f0f6054946933f0386dfa9f8ecb820b746ba793deec85b9c7efe7282faaa5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47707f8677809a4a7647a1d50e913acb169a7a4566146a391cec14e857146d01`  
		Last Modified: Thu, 16 Dec 2021 23:46:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06d88809c58ce8021f91462769d643882b84c0a775d15f6a5e2fd273a8c46683`  
		Last Modified: Thu, 16 Dec 2021 23:46:53 GMT  
