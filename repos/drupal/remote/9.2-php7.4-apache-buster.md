...
```console
$ docker pull drupal@sha256:fa2d8dfb061350675778c680516b2ee017c07469295c02a716421d0b280a448a
```
...
```console
$ docker pull drupal@sha256:1cf28ad8a331bf985f107ff8119537a33df7cd214d642be7950d40425ee91ad7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.1 MB (165102819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cee8ac185c268d94df13e3f7307dd85d135c5bc6b6eb6d3c88a43b8cd69aa5c1`
...
# Wed, 01 Jun 2022 16:34:17 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:34:17 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:34:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:34:27 GMT
...
-	Layers:
	...
	-	`sha256:e398ab085c4b29eed6a050c300525eedc7fab1cbb992423bed2202fce0418f9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb972d44d83056364238d0899ced88e234d1d48dc01e9532e9aa11440b5ee34e`  
		Last Modified: Wed, 01 Jun 2022 16:55:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d80e801cc54bf1a00e3adc4466b28a298c01ecff19d9be92360dec8ef4d473b3`  
		Last Modified: Wed, 01 Jun 2022 16:55:11 GMT  
		Size: 19.1 MB (19118098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6f8e419ad08e437eb6a482ca1607ae22f1499c72d7566dfd14158bd036811bf2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.0 MB (140959218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6120126603287f648e60a7cd697f5abc1b4c48ad19323e82c86dfb4a0102ef22`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:29:57 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:29:58 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:30:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:30:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:94c3313654a299e7cd11cf52b23f6fcaba4073d1404cba5040122ed7b039399e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c0891c44551c73416e4fa4037e920a20d372b8e06b85addce46590a147d6e91`  
		Last Modified: Wed, 01 Jun 2022 18:27:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:989feaff3873ca61835c9c60f4e58f72a9f7f29fddfe94258820e3432b2c1d6b`  
		Last Modified: Wed, 01 Jun 2022 18:27:36 GMT  
		Size: 19.1 MB (19117864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f9db72ba52909cae6b73d2b55177d67a38952fea2253b64e646d824f54450800
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.6 MB (156605429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0af2d4edfd6c4fa72421344553d4c0a14e518a684bc1a6f0e6230f2744b05b4d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 17:00:27 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 17:00:28 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 17:00:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 17:00:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f9a5b26226560ce5392cc63949637e1115f4545de8b5d92af43ef81217e17987`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:243fd0aa10077850a2da67da438c04d16cd7e3c48c4360e92f906c3b626f615f`  
		Last Modified: Wed, 01 Jun 2022 17:32:02 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb8792309ae1cfd61646578cbf5b43c1cef454b7d72b5fb14baa7395cd18d968`  
		Last Modified: Wed, 01 Jun 2022 17:32:07 GMT  
...
```console
$ docker pull drupal@sha256:8e411f7d7df1c992d7a13d1fb3396c1a988ff3f32d9e1351a948a3fb9862788e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.4 MB (170428932 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccdc66624639cfd5ba83564e9787a38696290aac68499b475c2a85eebbb961c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:53:19 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:53:19 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:53:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Jun 2022 16:53:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2c84be8d3ad36934a42f1bc3a2f26b8827e48439a7c633e5a867fe727e18f945`  
		...
		Size: 661.6 KB (661585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:472ecc7cf385deaaa204d9bb948bdee6805cc3995ecf90598e004a675f7efb55`  
		Last Modified: Wed, 01 Jun 2022 17:25:24 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89ff73fe8beaeec5f81cb96625984d4f0c6ab78c8d6b8753ac0b8fd77a7d3a2c`  
		Last Modified: Wed, 01 Jun 2022 17:25:29 GMT  
		Size: 19.1 MB (19119173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:b1e153f1b92f6334e50d45782bb5b6ce65d2c081f1d5931e4bd91269a5ab7ce9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.2 MB (176175512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d3c3c1094c9288880906a5b32ab1e311cb97bd51fcdc3f5d92701a93d260564`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Wed, 01 Jun 2022 16:45:55 GMT
ENV DRUPAL_VERSION=9.2.20
# Wed, 01 Jun 2022 16:45:57 GMT
WORKDIR /opt/drupal
# Wed, 01 Jun 2022 16:46:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b528941ea2da7acd35f9d3035518ffb17add1d89d174b26650b524e8bcc8ce89`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4c1f4f3183fc9ef32539f0ba42b16a1a131eeec83e063918088ae0f41b8392a`  
		Last Modified: Wed, 01 Jun 2022 17:52:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:216b98a77b502c3be6eea9050ab0985674e9ad9ad8cf90eedeeb1b6a282d989d`  
		Last Modified: Wed, 01 Jun 2022 17:54:16 GMT  
		Size: 19.1 MB (19118585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
