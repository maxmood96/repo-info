...
```console
$ docker pull drupal@sha256:866d2a2daf17f4e825619898cde91737d6c78ce909450e9525e1fe5ad0312801
```
...
```console
$ docker pull drupal@sha256:12a1aa4be338f9ab5d26381bee2c30bb9c61078356290f72b879ffae08b973b0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.6 MB (168566715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4d5ffa223a4407a44069f26f60c02ee029b3cd22572ee79cce9603e4d2fb2e1`
...
# Fri, 03 Dec 2021 17:49:35 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 17:49:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 17:49:45 GMT
...
-	Layers:
	...
	-	`sha256:423de59485f98f6533afb9ea9c315a175d249ad61d545cdede0c3aab8156ce4e`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f696dd787c3053da7ec9f159b1106a3b69ca06911c196a9c410812ba20151e27`  
		Last Modified: Fri, 03 Dec 2021 18:04:37 GMT  
		Size: 564.7 KB (564654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76b4d73cd776a1236b15672cc59bbf660dab4261dbb75f48141751deab640a63`  
		Last Modified: Fri, 03 Dec 2021 18:04:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d60c189679e16ea0f908b76021714c3cf2598db562a76de42c5ee74f5ec5b83`  
		Last Modified: Fri, 03 Dec 2021 18:04:41 GMT  
		Size: 19.2 MB (19191788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:35399325bbc2993e3e04e11d26d5b038d8a9dd135aab873755ec0bc112a4b2d3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143923229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0aa02d1280199ae109bd7c21b0aa354d4707d922dbebc1560e175c6d62b38954`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Dec 2021 05:11:55 GMT
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Sat, 04 Dec 2021 05:11:55 GMT
ENV DRUPAL_VERSION=9.2.10
# Sat, 04 Dec 2021 05:11:56 GMT
WORKDIR /opt/drupal
# Sat, 04 Dec 2021 05:12:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Dec 2021 05:12:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae283a7e00cd099f1ff1fca53a21975ee746199cd23022e14dcd80568c3a45b2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d44ac71095c30374b5c55cd9afefc280067711317df898bcf6c0ec69e1a309bd`  
		Last Modified: Sat, 04 Dec 2021 05:55:10 GMT  
		Size: 564.7 KB (564652 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4094eb57f1e31da98b22f1e5201f1750649a85238cf353998a4a10806bf2ab5`  
		Last Modified: Sat, 04 Dec 2021 05:55:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57f5d398adf597bd8ed17e8004732c48c05c28d573fe159a43c6b20909284c9a`  
		Last Modified: Sat, 04 Dec 2021 05:55:37 GMT  
		Size: 19.2 MB (19191857 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:35b1b971e0495b18c03c367189178d9fe5615172bb3c9596d43290dc919947b7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (160027227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a94801199627f0be64f1fff2608d90ef5116fd1182b181ea41358329397ee039`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 03 Dec 2021 12:17:01 GMT
ENV DRUPAL_VERSION=9.2.10
# Fri, 03 Dec 2021 12:17:02 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 12:17:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 12:17:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5d19f48fc05c0c871bd7560abc2c9eedca2a4c54d59ed39fea5da24b80198a06`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2acaf01d7e551f65117bdf51d23c522d8c156bc7489f3499d8681e92c9658301`  
		Last Modified: Fri, 03 Dec 2021 12:41:06 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92220fd748b8bd68c2c4455d35ac8514439675f96cd2b8b38ac4192473297d1b`  
		Last Modified: Fri, 03 Dec 2021 12:41:12 GMT  
		Size: 19.2 MB (19193307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:e58804e4717efa6a88548cbdca879de14221507890f99fbcd9d7549559165120
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.6 MB (174593660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bd722d0fd32dc2162273f1c6d62a15b8b9ede0adf2880e8958ee68556e6c166`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 03 Dec 2021 07:31:28 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 07:31:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 07:31:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c75b2a2058d8fc1ed6da0fad76020be462cc997bb31fdf8c2dafbe18bb191621`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:603f9244c8a64cba5a445236afcb80e6ea07c735d63735d59cdb2b658650491e`  
		Last Modified: Fri, 03 Dec 2021 08:09:07 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61610b2d8c137e998b2b8511e9fe04783d6cd2f48982de09dd6d9459a0db6626`  
		Last Modified: Fri, 03 Dec 2021 08:09:23 GMT  
		Size: 19.2 MB (19192141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:58ca872371adbfbe875893986c867939973267b6020700ce731a632151e31282
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.0 MB (179966814 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ad541829fd6ecc40317b65c5c7e6d2fd7dc5a452aac4654632d637a6d522161`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10090a8213141077edae51a715f59c887d1297a899201471f0a120b7da96ad68 in /usr/local/bin/ 
# Fri, 03 Dec 2021 16:31:59 GMT
ENV DRUPAL_VERSION=9.2.10
# Fri, 03 Dec 2021 16:32:01 GMT
WORKDIR /opt/drupal
# Fri, 03 Dec 2021 16:32:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 03 Dec 2021 16:32:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:882591e34b183ea8386a1d36499fa7e63d0a9246db416fa1239814e79b843914`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:128304bc116494ed044255d8e5931efc0d44c6301978c827de4e5dfc21cb7da7`  
		Last Modified: Fri, 03 Dec 2021 17:08:31 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f42b7665c0b5c00fd9341902e2b5b6e603cef24fc85425a1cb4ea1f2034d707`  
		Last Modified: Fri, 03 Dec 2021 17:09:36 GMT  
		Size: 19.2 MB (19191806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:a7fe6f2acbdbb7a9f3c73e14de3e3c2a5a2406944849f5ff1ee82c629fe11847
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154246811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6faa08ce8f292fe96a065dd1846ec54be62e6a4dbc324f7d7ecdba2a8830084`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Dec 2021 23:34:15 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 23:34:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 23:34:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eeba30f8c63080af5c60a28531143b665d3cb1d74bbef815a2d1d62e93a07811`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:592c9427fd84757f8c0cd5ca3c2f16af48a79296511f886ac0e234b1add8a3c9`  
		Last Modified: Thu, 02 Dec 2021 23:53:48 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b0cd1f8acf4162d884cc6b4ba249203eed8b8cbdef11a88c4b0a1eca2bbc2cf`  
		Last Modified: Thu, 02 Dec 2021 23:53:52 GMT  
		Size: 19.2 MB (19191989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
