...
```console
$ docker pull drupal@sha256:b155365f10df911331831cfc96c22f3f1f7c931587059d95bb68b0db8c35ac98
```
...
```console
$ docker pull drupal@sha256:fb1496c868290b748dc76484998c42b1811127ea6a851948f31d2d6d01a62770
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (160027087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40f91aab047ac69ae92bdc2a5b9c430bda847a9ac576f0d3142b145384d6ba33`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Dec 2021 07:43:49 GMT
ENV DRUPAL_VERSION=9.2.10
# Thu, 02 Dec 2021 07:43:50 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 07:44:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 07:44:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec0e75f63536fb990d0907d05e5e0b3210e6df981ed9e32221bd676c0314f9c0`  
		...
		Size: 564.7 KB (564654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e67bb884cbfd776eee6615adc098310a91407b0e432a5881a5ebaeb0f154bfdc`  
		Last Modified: Thu, 02 Dec 2021 08:00:49 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc092c170f930e8af0deed30555be9860c1b655cede60b2ee88d44541f822337`  
		Last Modified: Thu, 02 Dec 2021 08:00:54 GMT  
		Size: 19.2 MB (19193267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:2d78ae0a475e327b406b0c6b5e84335bacd97ed3b8b405aa0a7715f9f2ef4ffc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154246711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23844e8fa64b00f55ca22b355a4eec7bb05bccb95efa24e8f4d094376234185a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 02 Dec 2021 06:58:33 GMT
WORKDIR /opt/drupal
# Thu, 02 Dec 2021 06:58:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 02 Dec 2021 06:58:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6cfca376a1be1a64192c7fe8f0733355de8ce46935ec190dc91954c259a00f66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ec77972b74f4139edcb98772067803328fef807d93870a237c982989c31f54c`  
		Last Modified: Thu, 02 Dec 2021 07:13:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7249557bdbf2527f6840efb5d748b983b3047704287037e3ca6e9cc0a57d2a2c`  
