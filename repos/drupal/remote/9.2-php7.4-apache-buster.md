...
```console
$ docker pull drupal@sha256:8e426d77b2eb12b5bc678219aaa775af107fd15d3b2b481626a681b0c246284c
```
...
```console
$ docker pull drupal@sha256:2243fbfdd782c6de347536405d48a88a2c54db38febae23d76b68a11c2cac6b9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (160037617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26d1b1a96a51617a518a525d8380d378669ad63bdf75f28332db1cab405cac2b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 24 Jan 2022 20:01:24 GMT
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 20:08:38 GMT
ENV DRUPAL_VERSION=9.2.11
# Mon, 24 Jan 2022 20:08:38 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 20:09:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 20:09:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7808967cadd6f0fa8c52ac4bda734e9f77d293439e6b9072792f3329b9d5841b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdf5ec0d001e23e92879c6db3fadcc3f07ccc548c549f775c8abb755fc97f639`  
		Last Modified: Mon, 24 Jan 2022 20:22:06 GMT  
		Size: 574.6 KB (574575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3389c9ca809a00e9a88caaa3e2dd8eef54bb3ab75a94208d04f5f9b1e34bb539`  
		Last Modified: Mon, 24 Jan 2022 20:30:53 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a1c05ca697ace22f6ab24413dd7cd7c868da931ce9dc1e4f5cc7de3f83982c6`  
		Last Modified: Mon, 24 Jan 2022 20:30:59 GMT  
		Size: 19.2 MB (19194563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:e87297e03aaeeec798e4a963490357eb888a39a470b21e055acb5e4496004927
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.6 MB (174604135 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e76e090acb0bc19fc70bc4c9cff181dfe7587cc9ea0fd92b5a3bbb6dc4f9379`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 20:08:35 GMT
ENV DRUPAL_VERSION=9.2.11
# Mon, 24 Jan 2022 20:08:36 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 20:08:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 20:08:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4f3bfc7ab2efec646ac9182b58e3a0aa6a644dfefabf1b95fa9c63ca6a9f7c28`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7029c04c71fc16d522034c8896eee5c754dd59c9ab4cab8a6c2676569cc0085`  
		Last Modified: Mon, 24 Jan 2022 21:02:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fb0d2fdb21a9a07c9696006962c7b986973577b5af3d14b490eebcdf8d4e824`  
		Last Modified: Mon, 24 Jan 2022 21:03:03 GMT  
		Size: 19.2 MB (19193680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:cd2916658e2985ef1c985760b951458733252f7140e3ad89ba9a3f84849384cd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.0 MB (179976274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3203a04d3a4a24fc43a089e493cf501c625b602b8ecd9e10578daabd69028dc9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 20:05:23 GMT
ENV DRUPAL_VERSION=9.2.11
# Mon, 24 Jan 2022 20:05:26 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 20:06:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 20:06:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:acaf1439508281f5ec26684e76e631d48673c18935d28ff32e64b95b7e016c29`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adb254ef20a74fddff0969452d0f7c5abab89c60a71ea6ccbe970310a15d66d4`  
		Last Modified: Mon, 24 Jan 2022 20:54:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c38a6bdf3ba31d32da59b0dc4973d15a597cd0838559792106944f198b5658f`  
		Last Modified: Mon, 24 Jan 2022 20:55:24 GMT  
		Size: 19.2 MB (19193249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; s390x

```console
$ docker pull drupal@sha256:fe00f2e78bea3263f69d168e7bc6afc6bd9beb13bc0ca35283d8ce3027524559
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154257732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:793696f4a44fb9b0181a377db9bbdc9c0815ae1a182f034f7c956b4c1764c73b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 21 Dec 2021 16:55:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 24 Jan 2022 20:01:55 GMT
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 20:07:59 GMT
ENV DRUPAL_VERSION=9.2.11
# Mon, 24 Jan 2022 20:08:00 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 20:08:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 20:08:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a1bd0663e4db0f7d4361ecd48abd6403de91776a217dd7a93da27c31b09d7ccb`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee0801634fcfe321cc8d5b20a53730cc2669ac3dc8a757153fd5bdc2abf12bf2`  
		Last Modified: Mon, 24 Jan 2022 20:20:35 GMT  
		Size: 574.6 KB (574582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47321790447546495bc6bc48ff8e8444b6e7afecc21ea7230ccc50a43c726f9e`  
		Last Modified: Mon, 24 Jan 2022 20:27:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e1fe9654bc0e31687406b574daa01fba01eb79fc7577a77ff3d9a4d5c4c0f24`  
		Last Modified: Mon, 24 Jan 2022 20:27:17 GMT  
