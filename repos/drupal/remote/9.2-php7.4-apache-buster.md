...
```console
$ docker pull drupal@sha256:85cb34f2c63485ece1d678372388e0177dfca48a502e666212c5a994e26a8c07
```
...
```console
$ docker pull drupal@sha256:5fb3a85350b105297dcad244f2955b1a984c1d7365e2df15d9d5fdd8c3f1cb48
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143863213 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3778ad28bf25e8ecbfe87aa6e4ab53008f763342597401c8601e736dd55b465`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Tue, 03 Aug 2021 19:03:33 GMT
ENV DRUPAL_VERSION=9.2.3
# Tue, 03 Aug 2021 19:03:34 GMT
WORKDIR /opt/drupal
# Tue, 03 Aug 2021 19:04:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 03 Aug 2021 19:04:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:568ea4ba3d4e7317f1d78f13250514cad8b3a500ac4456659d4d3bbeddb4b23b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e8519b6ec0616510503446a0a81c2658ac010feff6f40f03a895cb441ddf624`  
		Last Modified: Tue, 03 Aug 2021 19:32:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cefaf1eaa0f165f9df9ca82b226671f2728c30b926ac1bf192da55be073b0de`  
		Last Modified: Tue, 03 Aug 2021 19:32:38 GMT  
		Size: 19.2 MB (19177347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:fc149148980c7636b2df21846b79dfb6bcda57f089a4ef0b8a82b5fd7c2d39d8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179909542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:890c46e92ac44573cca46d5bbebd5e28f80e7e4bd21e4e1c40147500046977e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Tue, 03 Aug 2021 20:46:44 GMT
ENV DRUPAL_VERSION=9.2.3
# Tue, 03 Aug 2021 20:46:47 GMT
WORKDIR /opt/drupal
# Tue, 03 Aug 2021 20:47:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 03 Aug 2021 20:47:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:414fe636667fc94f022de1e15f78447a46e33dbd32f5aa4bff7f4119619e8cc7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f54b1fa76b3855f4a497aa98a9e5e450757462e80f1d019d427ffae8ee79854e`  
		Last Modified: Tue, 03 Aug 2021 21:11:29 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfdc90bf73e4fe94588af9356583fc57a0a78df0962699fc848e6248a9c16ff9`  
		Last Modified: Tue, 03 Aug 2021 21:15:21 GMT  
		Size: 19.2 MB (19177520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
