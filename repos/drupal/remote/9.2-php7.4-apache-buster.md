...
```console
$ docker pull drupal@sha256:efe576dde1f2dfbee4cb20162a20e298c08b13499248861865b3def1cee51f50
```
...
```console
$ docker pull drupal@sha256:449afe638c803de1e42d0bd0d6091c87a9b6b0100142ae713672441cdc31a312
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156515971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5dbba7118d1b2affd31667370b0c4bc4d4424fa8eae57b1ead6498da7672040`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:29:33 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:29:34 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:30:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:30:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cee233609541731c0b89c74ba28173368ec78604b8dc993381f7a12b7a00c4b8`  
		...
		Size: 575.7 KB (575718 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:804a7eee9df4f579af3fdf8c8a6e864bcfd22e00b43406b14587723dacf6703b`  
		Last Modified: Wed, 16 Mar 2022 18:56:00 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27c75ec0524f55207fc88eae60aca45279692d265d8520a3cdb18fd5eb406aca`  
		Last Modified: Wed, 16 Mar 2022 18:56:06 GMT  
		Size: 19.1 MB (19111574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-php7.4-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:d65dff4c198580492b1e40809f4e4aae246c4a83522f7d593e5ef4541f9d9883
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.0 MB (170980758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbe9ee04d4d4caf61d6d229fbdd78dc04f26b97ef0dfa2bea28ed1a745761b8f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:35:59 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:35:59 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:36:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:36:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:611f997661531a342c27896477dc8313417c4a94213a27ad92ef750bf3d14d30`  
		...
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0ce1e12b83f4a3f14abf940079681a6006857ee248250ef16c3a5a1599a481b`  
		Last Modified: Wed, 16 Mar 2022 20:52:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f42d1a6910a4887e8f3bf6400f91d279a378b952622e8239ed73a5cf92dea6a7`  
		Last Modified: Wed, 16 Mar 2022 20:52:56 GMT  
...
```console
$ docker pull drupal@sha256:62348a557b8c28dd54a99ba48d814949bc85814227b88fd1897a168a0cfb95c0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.9 MB (150921441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7b7f88aec51d6c65e414775933a12a4329f7b703a7d5e2f8855ea7b251138bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:12:59 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:18:35 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:18:35 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:18:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:19:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:444947115ec0f819fae9bc6b4bcbc181c2dfdeccdef938dd26b98126b8265f98`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2c1f5364b05af7f60a161a9555a0046c86d3a54336402b52e3728415fb56def`  
		Last Modified: Wed, 16 Mar 2022 18:35:28 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba0ee89a5162ae149da0bef1405225b34362b12c2e2edf333eff23ad9557aaaa`  
		Last Modified: Wed, 16 Mar 2022 18:39:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8df30cfe85d52f2f1bde7c0506537cedf49a70ca469feb99db8235052768db26`  
		Last Modified: Wed, 16 Mar 2022 18:39:35 GMT  
		Size: 19.1 MB (19111149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
