...
```console
$ docker pull drupal@sha256:8562fe0ab6fe3718f0451dfc6695b1fb9223f9cb2de5392b65cc96f5358d7d08
```
...
```console
$ docker pull drupal@sha256:33a5214ac94462731bf1b527ab4c03bad7e230deb2a461011e2359e71372ed4c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.9 MB (179902868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c53ff7c8b403f161a6ac8050ad95598e0cd945ab79df24208b424713354d907b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Nov 2021 02:00:40 GMT
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Thu, 11 Nov 2021 02:00:47 GMT
ENV DRUPAL_VERSION=9.2.8
# Thu, 11 Nov 2021 02:00:49 GMT
WORKDIR /opt/drupal
# Thu, 11 Nov 2021 02:01:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:af6d4876d298b1d5ed44142308c9ba66ffa72d797b7b583dd11a1a60634d72be`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8fb8356004fd8f1ea401a18c51545d8c0ae3118c27f4a8ed3c23e9780683662`  
		Last Modified: Thu, 11 Nov 2021 02:30:55 GMT  
		Size: 564.1 KB (564148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:171ad5e9512f68d722c7123d268d010e97e65f65b9f301a6d010a1f0d7c11dd5`  
		Last Modified: Thu, 11 Nov 2021 02:30:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db04529eaf57bedb9cef652b910e8d3aa18d31356bbe6121ba4476cb283e60d6`  
		Last Modified: Thu, 11 Nov 2021 02:32:14 GMT  
		Size: 19.2 MB (19188541 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
