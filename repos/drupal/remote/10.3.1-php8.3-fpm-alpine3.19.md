...
### `drupal:10.3.1-php8.3-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:10.3.1-php8.3-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:10.3.1-php8.3-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:10.3.1-php8.3-fpm-alpine3.19` - linux; s390x
