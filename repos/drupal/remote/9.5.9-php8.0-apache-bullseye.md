...
```console
$ docker pull drupal@sha256:d88fa4bd4d6ec1d93ffbeac258d5557f67359025a513d806815716d0ad0a9276
```
...
```console
$ docker pull drupal@sha256:4a9e1a4b1c53e4fee78aab9fbfea1817900d034ceb23e4eae50c8f886878158a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.9 MB (192922927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7629110a3b713dd512fbdf762dcc48939ceccb46c34055a91c95a50f2a481a04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Jun 2023 22:39:12 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 22:39:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 22:39:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:944a5a29f7ef02da62bd3b0bb99bc66e76af7f93ccc32fd03e3ed7a4c0df0e30`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ab282a9b2d2a2cb64d06fc3e5c8f49e8b4fb21e8ff96c3d8fa7505c974b411e`  
		Last Modified: Tue, 13 Jun 2023 22:56:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0ddd7a453b04439068a9d679f489138283779f5e3d9d3ad383c3e2d47d1410e`  
		Last Modified: Tue, 13 Jun 2023 22:56:41 GMT  
...
```console
$ docker pull drupal@sha256:4822dda77eed072f2ae373626dfefdb8042d85285c0538559c8a0f170f75c887
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.5 MB (190457059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:028c600b0ea54423b389c8232387d471e847c273d98a412dd9e031c2572a31ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Jun 2023 23:52:27 GMT
WORKDIR /opt/drupal
# Tue, 13 Jun 2023 23:52:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Jun 2023 23:52:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f3de6a12e6071696893391402ef339a66857f3583e18cb37a56c40d4757273b7`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6c652f584597930335c0d637d11db6e8054457448bb2d11cf4c9cf8a2ddba59`  
		Last Modified: Wed, 14 Jun 2023 00:06:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:919f7853e0dd1d4c0a0281d63155b0e727348220ecbb35a5302cb629d8632b9e`  
		Last Modified: Wed, 14 Jun 2023 00:06:10 GMT  
