...
```console
$ docker pull drupal@sha256:7da5a4f416ed87fcdce5fae0f82c8c315fd6078288c49f61126752e429049493
```
...
```console
$ docker pull drupal@sha256:3b4bfdc60ec271473f0da0a6ebfc0052683ea1bcfd9e58ad5489a78039da83fa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166918322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef0bae3aa4572173f640ba172a8a720d04916ecb0d477bd5946998eb53f10e1e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:55:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:55:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:23cea4a4ada98678d8dd580a429c4dc1a5f7feed9f9d6124915149c1400d4d9f`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80ffa0a73728d46692a66cb2250c24fe7019554342eeb7e489daf23de44861b3`  
		Last Modified: Fri, 23 Jun 2023 00:16:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8fc4a717c2c61362e361431a679540b94c24f111873815c42007491c6a948a6`  
		Last Modified: Fri, 23 Jun 2023 00:16:58 GMT  
		Size: 22.9 MB (22878622 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
