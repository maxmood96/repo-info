## `drupal:7.93-apache-bullseye`

```console
$ docker pull drupal@sha256:4b1d35ac4a7195275fcff09566fd943741f129304b54b98971c0cc576458ffc2
```
...
### `drupal:7.93-apache-bullseye` - linux; amd64
...
### `drupal:7.93-apache-bullseye` - linux; arm variant v5
...
### `drupal:7.93-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:21c114caa9875aa2a1d7bfcb3e14ea7fb559e230f92b2d85f7b32cda957aa857
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.5 MB (139486744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c301418f68ac2e78a9a65754c7ba19fa091b39844ba100a48eba5b3e511ca92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 06:54:14 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 06:54:14 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 06:54:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:de488b6461c00b044ea986b69fa8dbfcd45fd87bf54374ec3c9f86aca6bb4bb1`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b8ec35ef47e28c13742af56ce15b4b9733a634805e251a346e2bdf382da129b`  
		Last Modified: Thu, 08 Dec 2022 07:15:36 GMT  
		Size: 3.4 MB (3402257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.93-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:7.93-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:cc36d293f594b70da54476f0c4b228a86a92b1390de9c414ac0c3c514e041361
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.9 MB (171946137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6fbaef2eea31eb433eb85198b215f170172548c69d934fb502b3e4d6527c2052`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 08 Dec 2022 05:04:58 GMT
ENV DRUPAL_VERSION=7.93
# Thu, 08 Dec 2022 05:04:58 GMT
ENV DRUPAL_MD5=617617081b622a3b32757c7166cbf88f
# Thu, 08 Dec 2022 05:05:00 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:18a244362b017434d06fe7f4174e3a1af97ab45020155c9a1f437b225cc500d4`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:847ccc0ad98f178aa501cc211288a45fea9e2136d40a37a49f5c03a8514a34f3`  
		Last Modified: Thu, 08 Dec 2022 05:22:13 GMT  
		Size: 3.4 MB (3402257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7.93-apache-bullseye` - linux; mips64le
...
### `drupal:7.93-apache-bullseye` - linux; s390x
