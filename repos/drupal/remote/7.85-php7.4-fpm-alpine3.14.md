...
```console
$ docker pull drupal@sha256:d444e9d9c6b7dcb429e309bb78bf614fba790b02711b7d237e7d2971ff451539
```
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; amd64
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; arm variant v6
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; arm64 variant v8
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; 386
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; ppc64le
...
### `drupal:7.85-php7.4-fpm-alpine3.14` - linux; s390x
