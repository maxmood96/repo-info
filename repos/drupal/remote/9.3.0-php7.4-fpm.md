...
```console
$ docker pull drupal@sha256:ebf1931e6caf3bdeddc4695621b81322725e554eb3f722ac25712e594ec8af8b
```
...
```console
$ docker pull drupal@sha256:e6ab8dd7386a8705004c4c9be0eebc372d6760643ae48a6a0d007c3ff88c1962
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.3 MB (178271664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55579c72728828716a2c61aeb4f647ff270cc18f995a7bf213a2e7dcd9f13f27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:39:20 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:39:21 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:39:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:39:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:450f9550f3881bc6b26d70d59e113dede2fd9758a054d9c0ca111dfc4a4cc3aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a29e4c3dcedce0af5245269f7307e956fefe490f36484e3330c56def80bea1bd`  
		Last Modified: Mon, 03 Jan 2022 22:00:11 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:245ae85358ebdcc8daa5a022de9adef81aa732b70dcab83c8e6a2f41c41f3ee9`  
		Last Modified: Mon, 03 Jan 2022 22:00:16 GMT  
...
```console
$ docker pull drupal@sha256:5e777596cc6a471cd5e5dbf1b8ea372099475144caba228705bf548813be0d55
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.7 MB (162655567 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a33f0c7da08e8d1e15a4d7208587e1018a63792017203274da8e862a03ac1d01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:52:49 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:52:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:53:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e2e9422fe4460e83ffc52fa076c8f15ecbeca4ad1cadef00d218b3efdf099c7f`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4be53ea9d84de3664040d6fd94a6b6861aea2494f6f6ef47e9f614f0ee34a4c5`  
		Last Modified: Mon, 03 Jan 2022 22:09:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97bed326be8f6709e58b8d10b1e20cb008838c6f81b130b9a7cd2bebe2ee523f`  
		Last Modified: Mon, 03 Jan 2022 22:09:50 GMT  
