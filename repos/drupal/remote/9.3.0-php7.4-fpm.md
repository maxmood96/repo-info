...
```console
$ docker pull drupal@sha256:f477ec3cbc00280858a58f6a3e50e0d1a00c1b08d0a8107cd0a9da6ba6b2a5bf
```
...
```console
$ docker pull drupal@sha256:d45568e30584fd5dbc1bbb9875a0fff27a789d96e20e6fbc27f2c8766d1f5138
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.3 MB (178271312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5edc5b24f5cecbd7fa536d3c670202af01e01c788144817b14c2cca1f0e9fd33`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Dec 2021 20:00:33 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:00:34 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:00:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:00:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c4699c6e95be5bdfd775e1a255ced34a83ee6a9656123a1adfebc77748af0547`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73f9672e3b0d95960f55148b77ce9c88076fda686be8fbd6ce082b4bb2986ca2`  
		Last Modified: Thu, 23 Dec 2021 20:21:03 GMT  
		Size: 573.3 KB (573317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16428940ef4e8212e74384cdbbf0fa28a23993d6fad137c745ae0dbc8bab5186`  
		Last Modified: Thu, 23 Dec 2021 20:21:03 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035d783fd9a20da1a6ccaedb1a49fdd76bc85b7ce45cf1e74e9c3f1fe1b36f40`  
		Last Modified: Thu, 23 Dec 2021 20:21:08 GMT  
		Size: 20.1 MB (20138159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm` - linux; 386

```console
$ docker pull drupal@sha256:262a06a902153fbb209084ea09bf9af5b9303b683e7afcf56dec7d4b3e3faf7f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.0 MB (187998193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6eea225114b24b0bca0adbee2a605ce5981b18fbe7bf53bc5d126a1b1c10171b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 19:58:28 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 19:58:28 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:58:28 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 19:58:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 19:58:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:03dc44cf2719e718477a9ac600748c493fb6da233641ad269f80aec65f047533`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:899bd2a49b7a663105db98cc82b3c5dfbace791ef32ad2523a7bfcc1fa326170`  
		Last Modified: Thu, 23 Dec 2021 20:18:38 GMT  
		Size: 573.3 KB (573317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9de4d2918857d79470fc553081758cbf7204e9c4a3f449bfb2a1a65b10c06b35`  
		Last Modified: Thu, 23 Dec 2021 20:18:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaceeb34c2ff9296710193e78efd2f135e58879012b13df097cf68807f5d8f64`  
		Last Modified: Thu, 23 Dec 2021 20:18:54 GMT  
...
```console
$ docker pull drupal@sha256:36a8b9a10c000bd07f03545ff150573e281a525a8b6db93239ae55b67fa137f8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.7 MB (162654848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ead458bac5abd8b26fec1437351da60b43736ce82817547ca128d71f2bf02f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 20:01:20 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:01:20 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:01:20 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:01:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:82c54cb3162f2bb780410639b6c4a30b51801af0106e1b844d1c325d0bf4b028`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ae01f38e1943487631d9b54bf6a2b76e8a2fa636e60a7b7e0d172387a6d2eab`  
		Last Modified: Thu, 23 Dec 2021 20:18:32 GMT  
		Size: 573.3 KB (573318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dd0234dbd98d3868e9fc1b32c9518cd982f569af60e36ecfd0b92e8e3fb0eb5`  
		Last Modified: Thu, 23 Dec 2021 20:18:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddc2395b8ed0e722e32c1c949fdc4d0dc3839679deb01dbd235de17fab1db481`  
		Last Modified: Thu, 23 Dec 2021 20:18:36 GMT  
		Size: 20.1 MB (20136869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
