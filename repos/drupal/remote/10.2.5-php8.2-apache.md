...
### `drupal:10.2.5-php8.2-apache` - linux; amd64
...
### `drupal:10.2.5-php8.2-apache` - linux; arm variant v7
...
### `drupal:10.2.5-php8.2-apache` - linux; arm64 variant v8
...
### `drupal:10.2.5-php8.2-apache` - linux; s390x
