...
```console
$ docker pull drupal@sha256:a8ccea92335166a8f27cb77c8891e632bcd19bff8df9fd1b18a921af8313a128
```
...
### `drupal:10.5.3-apache` - linux; amd64
...
### `drupal:10.5.3-apache` - unknown; unknown
...
### `drupal:10.5.3-apache` - linux; arm variant v7
...
### `drupal:10.5.3-apache` - linux; arm64 variant v8
...
### `drupal:10.5.3-apache` - linux; 386
...
### `drupal:10.5.3-apache` - linux; ppc64le
...
### `drupal:10.5.3-apache` - linux; s390x
