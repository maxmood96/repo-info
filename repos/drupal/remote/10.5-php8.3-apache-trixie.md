...
```console
$ docker pull drupal@sha256:549b23c61fcac3c272ac473aeccb6fd00598ee7a32c3dace5be3271c2883caf6
```
...
```console
$ docker pull drupal@sha256:89a535a700d9d18c3cf3ba8346221cbdc60612e948558d9e194505a849f4f9cc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **200.9 MB (200924641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b38aa4c641641a9dfae43396148fcfe4409b50b0d985abe94bc81d398b99a868`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 May 2026 23:10:06 GMT
CMD ["apache2-foreground"]
# Thu, 04 Jun 2026 21:40:40 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Thu, 04 Jun 2026 21:40:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Thu, 04 Jun 2026 21:40:41 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Thu, 04 Jun 2026 21:40:41 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9d4a7dcd7a27d733f2f5a43e3d822f83d14b36206e473871133085ded4902a65`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
		Size: 1.7 MB (1725759 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3ec233108a057a4c78c17d082a40ea3230eafb7804c31099fe1cee14f90195ec`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:99738631d936ab901b3e148cb91085dff29f72148caeb365f7d21e447d64c934`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
		Size: 256.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:72b9bde6491b63fb3daa95c34f9e0bec881409aaeab6a74979597d4aae0f54dd`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
		Size: 823.3 KB (823342 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4369a292c366f50731fd597eba52cb52fed16f2466acbb5cf946b51f709ea199`  
		Last Modified: Thu, 04 Jun 2026 21:41:12 GMT  
		Size: 113.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0c1722b8015dc2c102d8bf20c2a0deda8eec7f0ddf971ad0b8c51b6526dc0a69`  
		Last Modified: Thu, 04 Jun 2026 21:41:13 GMT  
		Size: 21.8 MB (21774401 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.3-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:2521d8df1f8d1e0866b3b48e1a5787eacc11caecf5f3432c2735cebd93a045ce
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7347761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:319ac422912a6385e7a9a31ed601824fa13d8b8198d47170562616899d21a065`

```dockerfile
```

-	Layers:
	-	`sha256:b883ca8bd0cfc983a09ea7b28ccee87709acbb7efccf8a7792433e1720f78cc4`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
		Size: 7.3 MB (7304592 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:96167f4a38a7a016927fbee06f6c9ede27fbaf75954092d9fee146a831801ba7`  
		Last Modified: Thu, 04 Jun 2026 21:41:11 GMT  
