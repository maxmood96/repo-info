...
```console
$ docker pull drupal@sha256:272330de8cf0d3918539e582eb14647cf2952d04cfc991d06ce2a1ffbf6fe68d
```
...
```console
$ docker pull drupal@sha256:59d918ca6fbb505b7d9ccafe06094e2ec2ea3cb188e4e1e40904d260278a86d5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165561925 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95e297af85d17770bb31498c4bd4f9fa17d3120bf210380c5d4ad486ac8519d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d3ca45d2cfc8351f6022756e9aa2dafcc7f39ce36d05eb4af93f2b548b2cd82d`  
		Last Modified: Fri, 10 Apr 2026 00:15:35 GMT  
		Size: 4.0 MB (3970237 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:539f18035ed7fcdf935268b9d76b82f1ad7ef25ff19d5a66d8dd44cd1fa054d9`  
		Last Modified: Fri, 10 Apr 2026 00:15:35 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:50bec1a4b0ad0c934006d5e5fc5b48435999d5a977dd57820c7701574bb2ac68`  
		Last Modified: Fri, 10 Apr 2026 00:15:35 GMT  
		Size: 257.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:39364a8b64708b1c19dcbd8f159cddde995c9b6692075cd23af27d855fb13edc`  
		Last Modified: Fri, 10 Apr 2026 00:15:35 GMT  
		Size: 777.5 KB (777543 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:302f3e310777bf594d8e16efec19c0d92490d56fb29113a742fa38d2825da100`  
		Last Modified: Fri, 10 Apr 2026 00:15:36 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:096017fea5eeaefe2dd6f6b2b01099919adaf35de2538cbb758d15c665cbc2a1`  
		Last Modified: Fri, 10 Apr 2026 00:15:37 GMT  
		Size: 21.7 MB (21747781 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.3-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:a47192689c9e4bee12e48da40c7ca888f8fa566a65eda0f9b15ab294622c98dd
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.2 MB (7177884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0a726ef3578efca8127a4a9b1483b44decdc130b890f807e3b93121e874eb79`

```dockerfile
```

-	Layers:
	-	`sha256:7aa621be54aec26294da8825cf7a9c587575c2a8563cdc520a99c642676a857a`  
		Last Modified: Fri, 10 Apr 2026 00:15:35 GMT  
		Size: 7.1 MB (7134517 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e2908d6662bfb2ad4ad26ee1f48961eaadd012083cd2f61551ba988edcdb0800`  
		Last Modified: Fri, 10 Apr 2026 00:15:34 GMT  
...
```console
$ docker pull drupal@sha256:76fe70c64a5c2f180d863033495889083fc3066863162bf8b65001df99544f20
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **204.2 MB (204195258 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74b804a6cde9b9331e0d9dde2b86049d517cae02ca33b538d88aaf8c39ef4539`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 07 Apr 2026 01:33:05 GMT
CMD ["apache2-foreground"]
# Fri, 10 Apr 2026 04:14:44 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod expires rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Fri, 10 Apr 2026 04:14:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Fri, 10 Apr 2026 04:14:45 GMT
RUN { 		echo 'output_buffering=true'; 	} > /usr/local/etc/php/conf.d/docker-php-drupal-recommended.ini # buildkit
# Fri, 10 Apr 2026 04:14:45 GMT
...
-	Layers:
	...
	-	`sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1`  
		...
		Size: 32.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4ec3fd5ae323a74c4e1f689b260d114ac8d0d9d930672b0425ad4dc573f0353c`  
		Last Modified: Fri, 10 Apr 2026 04:15:08 GMT  
		Size: 5.1 MB (5072793 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8fc6860315958b71343432dacc9795a3d63865eb6ace63b07c2cbb99f6c166da`  
		Last Modified: Fri, 10 Apr 2026 04:15:08 GMT  
		Size: 315.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:049aa17546b923543886899ad9333147c4a0a66f82c95cad5c988b430b9f130d`  
		Last Modified: Fri, 10 Apr 2026 04:15:08 GMT  
		Size: 260.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:eacc92fcc12034e2c66503905093959a68749519bd5f8ac15d3e5155b60c39b4`  
		Last Modified: Fri, 10 Apr 2026 04:15:08 GMT  
		Size: 777.5 KB (777543 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3d2ffca36238eb194131203963972d9c4cfc95c98938eb0f9a3ce36ff22aa728`  
		Last Modified: Fri, 10 Apr 2026 04:15:09 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:19acf61458131af4ca0e7189f97521a815ee8f0ca858efdc3a65255905095414`  
		Last Modified: Fri, 10 Apr 2026 04:15:09 GMT  
		Size: 21.7 MB (21746585 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.3-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:3f0fe262c8a1a38ee5c8ef3ebd70c248d64e26eddf258f4b6d53a1937c11b7b2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.3 MB (7347656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8d6455431b4ac6348d469de193eee8c05eb99c0ab0e09225a722dae9de3e3f3`

```dockerfile
```

-	Layers:
	-	`sha256:ab8e54c6942b3d5bf758d84c9b51b9fa20fe5bac30b1f78401248ed3fe49cfa1`  
		Last Modified: Fri, 10 Apr 2026 04:15:08 GMT  
		Size: 7.3 MB (7304494 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:54361c903745ce90b6b18d6152b729a7e78aa09f082c2240f1dd718eb1d771ec`  
		Last Modified: Fri, 10 Apr 2026 04:15:07 GMT  
...
```console
$ docker pull drupal@sha256:44a1f666c208d74d72939f6dd930ef0589e849e3083331361ed5235914ee8fe9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.0 MB (201024546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4df283a33866002e4ec740b55161b22b29f6212e38fefc619605a0e29f2854bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:eb05b07a9afd00f5aab721fdff697988816aed09d1778ca0feb167a1c60f27f1`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ec9bafd25ea983c5ca9d90a929d2f8695ab5e5ba0b24d0a7b3ecc7c466f94136`  
		Last Modified: Fri, 10 Apr 2026 01:42:26 GMT  
...
```console
$ docker pull drupal@sha256:87210717f2fc43910ac25cc3324c2221d5e13992d16045c8cfdd0cb0868861a6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7373778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a711acf522de4a9bcbb7c52120c052917e4c95c92901c4a1f81a0612736bd74e`

```dockerfile
```

-	Layers:
	-	`sha256:c8fa999feb86f99d2b2a0dd2a014177a55f7d14cb5b87952b737c80fd47a1928`  
		Last Modified: Fri, 10 Apr 2026 01:42:25 GMT  
		Size: 7.3 MB (7330489 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8db86d615faef198f12c6bace0d9b15c671f39d181dc89034e360694dc153f8e`  
		Last Modified: Fri, 10 Apr 2026 01:42:25 GMT  
...
```console
$ docker pull drupal@sha256:412605f84d91345046c80e1c321e050abe8d140a71003d83bdf5c6ca20981da0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.1 MB (230061278 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8b88673e1547276cbadbe3821f9e462d594d7f99bab33fb7e214ea10bf0ae5e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:57fec335ffd76e91f05b9cb0ad4e4e27cc73e7c96158edcfd817bbefe8c6f4fd`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a1030c4feb8896c5b2919e613e1ac6e4eeb5c66b5076d9839897cb3a18042714`  
		Last Modified: Mon, 13 Apr 2026 02:23:55 GMT  
		Size: 21.7 MB (21747968 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.3-apache-trixie` - unknown; unknown

```console
$ docker pull drupal@sha256:93ced95af1878d57f0e5eb2b3b4887a2a5322fbe92cc9dbda8ca75ff1ff3e01f
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **7.4 MB (7445775 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9da0e1ea9695e087348eb8e32fee092762e3ec117f2af38788b75ae733a9d8ca`

```dockerfile
```

-	Layers:
	-	`sha256:820eb37fba538223a1b73616d63b4475be0b6d5a4e6aab29c4e4eed676302878`  
		Last Modified: Mon, 13 Apr 2026 02:23:53 GMT  
		Size: 7.4 MB (7402486 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:8442a5ad527bd7f9633f6040cf417027bf88a2039578132edb5220f7de2a2ca8`  
		Last Modified: Mon, 13 Apr 2026 02:23:51 GMT  
		Size: 43.3 KB (43289 bytes)  
		MIME: application/vnd.in-toto+json
