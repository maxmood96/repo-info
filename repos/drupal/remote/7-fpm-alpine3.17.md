...
```console
$ docker pull drupal@sha256:8251ee0a06602082e1570baf34612972a9c86015abf0bd7423ff5e8909a8fc92
```
...
### `drupal:7-fpm-alpine3.17` - linux; amd64
...
### `drupal:7-fpm-alpine3.17` - unknown; unknown
...
### `drupal:7-fpm-alpine3.17` - linux; arm variant v6
...
### `drupal:7-fpm-alpine3.17` - linux; arm variant v7
...
### `drupal:7-fpm-alpine3.17` - linux; arm64 variant v8
...
### `drupal:7-fpm-alpine3.17` - linux; ppc64le
...
### `drupal:7-fpm-alpine3.17` - linux; s390x
