...
```console
$ docker pull drupal@sha256:b0ed85de847073b4e4e8234428ef5474ee8d49d3148b1f15ceeb85af3c8ea0e7
```
...
```console
$ docker pull drupal@sha256:c506dd9f9afa863cdfab5c5a19618647add5569c91e32de357282ae26c53d4ae
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.5 MB (49463450 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b73f935a9e173de4f9d85438c8dbe5e76ae3a81389b9d9c880518db2572687f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:16:15 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:16:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:16:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd09616909d6b03d99c8da4ba2ad4e86f92a6b23563a7da505199845c5eb4419`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b323ca08898d754de0c70167c83943f355ebdfcaeb763102abc14a99bb4cc3`  
		Last Modified: Thu, 04 Aug 2022 10:04:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58ede3770df47e92d3bbb0cbe3400d192f57709a390e06a257c4f4826ebe06c8`  
		Last Modified: Thu, 04 Aug 2022 10:04:58 GMT  
		Size: 21.8 MB (21758084 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:bd623b0649f4fe6654c6e37b0a526141fb494797ca7987491a8369db70c79193
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52775840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c6302af8205fe786319ed3fec1487c642ac4d60e4c9610beaaf256c7e15bfe8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:20:47 GMT
ENV DRUPAL_VERSION=9.4.4
# Wed, 03 Aug 2022 12:20:47 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:21:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 03 Aug 2022 12:21:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba4ab8f8ec3e0f25474d7a4f1fa4e025fc1e64e44f88aa9009b981b1ecbafae5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:beb23dcef7721e15bd60d90cba4c60bdfdd16ead8425479b7509b474ee523bc3`  
		Last Modified: Wed, 03 Aug 2022 13:16:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e0f7e44f0ea1eff08d515d606f246846b0b939977d701a3077a2f32d8341e12`  
		Last Modified: Wed, 03 Aug 2022 13:17:20 GMT  
		Size: 21.8 MB (21758296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
