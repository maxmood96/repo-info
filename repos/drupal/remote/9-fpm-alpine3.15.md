...
```console
$ docker pull drupal@sha256:72fa4a1b72b5b07ca8990a1bbcdd744e9620ad9f8e83ba5ed3c7c7c06596aa01
```
...
```console
$ docker pull drupal@sha256:d7c26d96110bd95d18054e682f349a12a4b585016891406b803e9303fd1113e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51482412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4c5174dfeaf89077c027f20a2249d95dbf6be35e534bdbc6e29c443dc7e4fdc`
...
# Tue, 22 Mar 2022 22:23:55 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:24:05 GMT
...
-	Layers:
	...
	-	`sha256:400aed4d7efdea80470145e3b898a63e5b0ba1ae644b52d82226a5785ad72b42`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:355d4280f9d78dd87b0ec8eabeebfb5d4cb8e3e566c391f580b37d85ce5ce8a5`  
		Last Modified: Tue, 22 Mar 2022 22:36:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57dd421061b8e15a472fc1c3b3c74cf4f23b5a420588f9a7e24421a4f757401c`  
		Last Modified: Tue, 22 Mar 2022 22:36:35 GMT  
		Size: 20.9 MB (20938030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:ee80b7f360c6a5eab669ed08ef8bfe159c2f390e07188be5f5f78c35b17eb65c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49651835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:724b73d2011e564c4d17bb7379772a64045679021099db2286757365b999bde5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Mar 2022 03:16:23 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 21:50:35 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 22 Mar 2022 21:50:35 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 21:51:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 21:51:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6e3b734bda3e6b1f600bbfe255549ac4ad9eb5733acdc44498727f73b7bf899e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69f9995e223bcaaf43c2e0927a5a92769b431219f8db84dcdfd71df6bd85137d`  
		Last Modified: Tue, 22 Mar 2022 22:03:16 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d72bafb485c70b1650f8a4bb1d1e530d84391a85509d6f15ee5f3f4032612873`  
		Last Modified: Tue, 22 Mar 2022 22:03:46 GMT  
		Size: 20.9 MB (20937840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:60d29f1c841db741d5f0ca64e5754b76a428490ebee17001da701466f18052da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51811847 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79647166a5e9af1d950e98c2e6af049eaab4e84c80145b7a9f6dbb143817a4db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:32:33 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 22 Mar 2022 22:32:38 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:33:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:33:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7a541251c6ba27cc8054fe24947a7fe98d5594e7ee26435715fdfd17ce1862e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3ccdce141f3f29f6b2e7b0b280d07e0284269e0b812797affd968990399ecf7`  
		Last Modified: Tue, 22 Mar 2022 23:17:23 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d665fad01c0ee6546232a32edc488e95d046719c15189ccff97782bed3a8ab32`  
		Last Modified: Tue, 22 Mar 2022 23:18:20 GMT  
		Size: 20.9 MB (20937935 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:c8ba8b4246530a1ba17a099fec0f444f140e6f7de86b95e29c700e47422af230
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50256823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38492bba2687f08d8cd7a7233ef44eba105ce5720a07d7d0e85d38674c50e38d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Mar 2022 14:35:01 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 21:49:57 GMT
ENV DRUPAL_VERSION=9.3.9
# Tue, 22 Mar 2022 21:49:57 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 21:50:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 21:50:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9d8313e6d9f6f574e2bd6143042a84a737970f7cf586d19243bb08ec2aa5e873`  
		...
		Size: 575.7 KB (575716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8096185b06757820f0075f2d65b1ebd87370aa7e86120a2ae450618e7745a085`  
		Last Modified: Tue, 22 Mar 2022 22:10:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac8eaf4faa825c78964468a0938f9821b9e564e139364bf9ffc0f28bcedeba2b`  
		Last Modified: Tue, 22 Mar 2022 22:10:26 GMT  
		Size: 20.9 MB (20937836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
