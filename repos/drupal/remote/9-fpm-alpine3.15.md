...
```console
$ docker pull drupal@sha256:b30b2c663bdd7c5975d829fdad98b6b16b7e21abdf4e6d8db3a50be9502d71ff
```
...
```console
$ docker pull drupal@sha256:4837bac1b00e8ca96550622dce8a176c8d24bc45eb7e61623c5cb85787f4ee0d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (48960162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9926f9b008feac99d04f71072355b788e6fd5e568dfa243ec41493dfd2d019a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 06:00:22 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 06:00:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 06:00:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:834b183c3b277b82ff9e3897292733be5c6ccf28101e176bc73e8b0962aad9fe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d4da483af23dc346e6cea42ead33823e84386a00bb5b0c5819873055469a38`  
		Last Modified: Tue, 19 Apr 2022 08:39:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:429f874c4eb051d8d098bd0842443f884501c436424526d9ef206e3b010ccac8`  
		Last Modified: Tue, 19 Apr 2022 08:39:44 GMT  
...
```console
$ docker pull drupal@sha256:48876d0c6a7c388955e2814a6d45bcfe604908b6401767c8705dd9d67928ccbd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.4 MB (52365598 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcc9f4b94fc7ee99d0b1daee8581c0bc373c948ef546b7fb01994b6fa2cc50f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 02:16:52 GMT
ENV DRUPAL_VERSION=9.3.11
# Tue, 19 Apr 2022 02:16:53 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:17:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:17:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:800cc10dd2bb811b22a69021496e9de7203a2636f4a64fa88ae826e917c056b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57b1fc835c4a4057d01dcaa56bcda971d45666925b42143b2864013fed7cc0c5`  
		Last Modified: Tue, 19 Apr 2022 02:45:16 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca6a928acae804fc4eb12eb28f1d68d177cb7fb37ee1693b4d857a26b7331c0b`  
		Last Modified: Tue, 19 Apr 2022 02:45:22 GMT  
		Size: 21.1 MB (21149162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:18c91f86e8a80503b65b847e0bfc9c70d59f32c09ea0959fbe4cb4d5df8038eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52292705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3d25c3b1cc698d34611e33c5f4a7461d993c0de9e27329586464ab52b99145e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 07:45:38 GMT
ENV DRUPAL_VERSION=9.3.11
# Tue, 19 Apr 2022 07:45:40 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 07:46:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 07:46:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:708f440ae76b72da8023a83f1f34330d0ddf3183fd24da5e38b116036d82c512`  
		...
		Size: 661.6 KB (661584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08fc9939215baf32b9c7d03239c587ded3f5886d2437d96eb166d1ed06263a4c`  
		Last Modified: Tue, 19 Apr 2022 08:53:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0330f507980d8fb45fbf690b404612d13188d0a17c3ba69c8f6cba3db221fe5b`  
		Last Modified: Tue, 19 Apr 2022 08:54:42 GMT  
		Size: 21.1 MB (21147451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:002f286e716f331ab837353ca9e65ae5c87ef959be1d54394fec862e778c95f2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50728667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6792f0452ea55737ed7ed5b5faa55161e66b1fa806231a1382bc30106f20d6db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 02:34:21 GMT
ENV DRUPAL_VERSION=9.3.11
# Tue, 19 Apr 2022 02:34:22 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:34:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:34:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:02c620a5ab52861323467aed1f05cd74defb09546b34697b6198591720691921`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7ab63c3ab137078ef03844a54ffa1ece3029695ec9096d2396263160dd4a42a`  
		Last Modified: Tue, 19 Apr 2022 03:12:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78835f152e82c8c1404a37b9ea5d19b2f62f9de9e732a571e0a0f4903d6b1a54`  
		Last Modified: Tue, 19 Apr 2022 03:12:45 GMT  
		Size: 21.1 MB (21147000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
