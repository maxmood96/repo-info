...
```console
$ docker pull drupal@sha256:b37c2e4dcac0dbe972180e07b681c6f7b077202c470a7e99b0ca85559c28c519
```
...
```console
$ docker pull drupal@sha256:5e44cad9c7cefd3a58f8bd54923ef8118c709b0ba77d17ed333223d18f46bba9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48509122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e11d451ff84d88c9f51c44b92e9190d32465f27f4388c385285a9569c753f39`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 01 Apr 2022 03:32:27 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Fri, 01 Apr 2022 03:32:28 GMT
ENV DRUPAL_VERSION=9.3.9
# Fri, 01 Apr 2022 03:32:28 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 03:32:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 03:33:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:19754313825a682bd8700f941b6933d1ef9c896a060942a26bd32d42d92cfa77`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55510d07ce5abe7e731bb2430d9631130b21e4ad82192f3f6b92a20779e5187a`  
		Last Modified: Fri, 01 Apr 2022 04:18:41 GMT  
		Size: 576.1 KB (576065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4cc49310496470f88777f0ecb1b97f82178f9cf0d3dff5f3d75b5303e3b5076`  
		Last Modified: Fri, 01 Apr 2022 04:18:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4bee4c0c9e04fc249ed28ce18ee16579fea30c889548cae206ea068ff9bb10`  
		Last Modified: Fri, 01 Apr 2022 04:19:08 GMT  
		Size: 20.9 MB (20937795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:232110287a94e03388f5bac279bdc8c47cb6b4eeb59ed2e7758120f902b563cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50495288 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b3860b41a5e8df2772629659a7ae09ab67c55ff752fe847f90bc17f12cd9bba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 31 Mar 2022 10:20:35 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 10:20:35 GMT
ENV DRUPAL_VERSION=9.3.9
# Thu, 31 Mar 2022 10:20:36 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 10:20:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 10:20:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a81cdeb415a4b086a19923ef52f85d3a84aeb69b3dba26b01c80c9eb010cd53d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f403b892e8cf6a6aae173992373771c0e84c5a801cf7573acb0b8843c8de361`  
		Last Modified: Thu, 31 Mar 2022 10:44:04 GMT  
		Size: 576.1 KB (576064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5273c4242dd5d44bb0614c7db90da985678191c483f57a794d9de2c7fa3db543`  
		Last Modified: Thu, 31 Mar 2022 10:44:04 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db63533cb30a90f6c86cc1bae33f91ab2b335d705ba2d8a99a3cc13d97898780`  
		Last Modified: Thu, 31 Mar 2022 10:44:09 GMT  
		Size: 20.9 MB (20938659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:83a33f82a88fc0720be60f7ad141f00a5ac50f395b8ae4d21dc3a3cc659bf2b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51810583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d03322ac9eb31239031b37b0c80751ddd98308cc7e7a5c3901658399cff27c3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 31 Mar 2022 19:11:58 GMT
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 19:12:04 GMT
ENV DRUPAL_VERSION=9.3.9
# Thu, 31 Mar 2022 19:12:10 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 19:12:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 19:13:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a02bd988bc8e4d2af4afeeba7b73251460a7ba52843d79341339448104650d28`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86e8237aa6cf7287073bddaabe6721a088452b3f13f51816fb7eb69408893742`  
		Last Modified: Thu, 31 Mar 2022 20:12:35 GMT  
		Size: 576.1 KB (576062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be8ee4ff30a057dc54d0b6494d4810417d048971a486e128e6471071a841533f`  
		Last Modified: Thu, 31 Mar 2022 20:12:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c92f7631e3b57b3581dcb964239e15e1d9e04089b931be0dd94ad68cbefb769`  
		Last Modified: Thu, 31 Mar 2022 20:13:35 GMT  
		Size: 20.9 MB (20937921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
