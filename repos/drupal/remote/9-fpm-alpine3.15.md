...
```console
$ docker pull drupal@sha256:f8dabe7a3fad74fbb5a89ca2bf63be9f8880c2756b06a7978f7a5d3a8b475f71
```
...
```console
$ docker pull drupal@sha256:a00ef1b8e658d04dd09df8df0abfad3a34ffde05c33c6929d970ce8367b15e7a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53063151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84d4d1e9f4dc3b556acb664e3a3a090dc78dd462922b5b59b330e4ead599fd52`
...
-	Layers:
	...
	-	`sha256:e95e4c260ff9d3ee92a3fb3486c241a269b6b5be6ea80925ba23fe28aed2936e`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85a4924cc30804c4de8257c38ddeae19d22acb0e91c4256996668406b148c46f`  
		Last Modified: Wed, 16 Mar 2022 19:53:26 GMT  
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f430f839304ce17cec5a83b2d79d6e98dd394a291db2e23cca6c6d98fd055746`  
		Last Modified: Wed, 16 Mar 2022 19:53:25 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e55b951c296f234990d894e8065c7eabd2dd0d401b727f6a4dee1c493ef28d3e`  
		Last Modified: Wed, 16 Mar 2022 19:53:30 GMT  
		Size: 20.9 MB (20934203 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:3efc2472da6ac7efb45740cfbaf246b252b4fffd42482f21f28e35469495c60d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50996194 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:360be0449a08ee17ddd24f16eb12eb817b2b67a9cdb40763421de557623737f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:29:41 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:29:41 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:29:42 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:30:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:30:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e818d8d732d6fe7cba9e5e0afdebf6293f5e3910d09083d7be12a171911241b`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8d9dd6d617845160f0f09327b9aeb8e4750989e7848a34129eb5f3fec0fbac3`  
		Last Modified: Wed, 16 Mar 2022 18:43:50 GMT  
		Size: 575.7 KB (575717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0dbe6b25073a29c925d865124bf826756ba0ee7937044911dc3c3adfbb0a45d`  
		Last Modified: Wed, 16 Mar 2022 18:43:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ecce560b0869bb1f87139f10e8c21062923309c510c771dd4a75009eaff11d0`  
		Last Modified: Wed, 16 Mar 2022 18:44:19 GMT  
		Size: 20.9 MB (20934171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:37a440dd489c523b2471baca9cbf8cfc0f88463ba0dd0822ee2cc8b12fbbc093
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49777596 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21bd10226ef41c73e65b92c28222c8a4dc8d4bcf730e66e01ee249c5836e9ba2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 19:04:14 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 19:04:14 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 19:04:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 19:04:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bde7df3babbfa5236f807678bebc09f25d09cb75d19d7781025b0d6f46b9b5d5`  
		...
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06db871f581d1872d1a90337170aee24c72ba9625357686b964f12a457af34be`  
		Last Modified: Wed, 16 Mar 2022 19:50:17 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bc80d3f7f0e2ba58cee45ebaa10d751052ddca0ae553b132700ba15e351b8f7`  
		Last Modified: Wed, 16 Mar 2022 19:50:47 GMT  
		Size: 20.9 MB (20934193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:fac54ef05a6552f606e53c92c9dbcfbe20b92178343dbaecaa5bbe869e6ac183
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51949332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afd302bf38b983b438e16ef5032b5e30f695390bf0b4919ccfe836b29f488779`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:22:22 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:22:22 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:22:23 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:22:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:22:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fd8cd2e00e5e541be4fbcb19c6d844d6043b0a40517ac0daa093f330e99e5f6c`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:144ff547c0a423fbc8e29e53b311b2265e6ac5594cd5e22765a296993b226a9d`  
		Last Modified: Wed, 16 Mar 2022 18:46:09 GMT  
		Size: 575.7 KB (575720 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:802c8fc970962a083042269dea9239d7582441fd039a71cf51d05cdf93f920c6`  
		Last Modified: Wed, 16 Mar 2022 18:46:09 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:813b98df3ff2726637753bf55724a13ca8535c93024f7027d9d481ee2088886f`  
		Last Modified: Wed, 16 Mar 2022 18:46:15 GMT  
		Size: 20.9 MB (20935318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:35b932241ad66539ed5dd1cf2b5f83a3088c6749d8baf4ed729a071b6ab299e0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53460846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83ed979e54488816be83897bf5980f795bbbc2272c3e8950f9db3e95c0d6820e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 14:49:22 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:27:20 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:27:21 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:27:21 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:27:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:27:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6770a85dd5df75cc05a7eaec50e13c27771dcfc5f3204f15d1393d7b0b3b5082`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3232e6f94da586c000f6e06ffd4d3a96dd771c23220f9e9d9d4dcc808d85f80`  
		Last Modified: Wed, 16 Mar 2022 18:59:39 GMT  
		Size: 575.7 KB (575712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30b9f1f557f667674f0bd3311c32952680b43ca2482b4d8fbef862cab77715f5`  
		Last Modified: Wed, 16 Mar 2022 18:59:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9321fe556c74a3d0083ec65ca75f8e99c12ec2839e231a67b1e31750e744d491`  
		Last Modified: Wed, 16 Mar 2022 18:59:53 GMT  
		Size: 20.9 MB (20934130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:94941e2c861c5c6c1e4dc91659b8eab63c617ec77ab3c5e9a54e1de6abb72267
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53325525 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f064001056831f224e919263a1210fb9e9f689ad20abf261a6a7a1e0300e52d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 20:35:18 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 20:35:27 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 20:36:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 20:36:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5c8a146dfd384d2f403e432767b4d5edfb8f78761cb8051dedb73d4aab8e6053`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6d7bd32b0f99c02105652069e8fdaf4a30c9076a282e21bdf9450bf4e1ceda2`  
		Last Modified: Wed, 16 Mar 2022 22:04:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ca245cec5afe19c6114ca0b3fb68824879b61e74e6b197b3693f5e41ba6c973`  
		Last Modified: Wed, 16 Mar 2022 22:08:35 GMT  
		Size: 20.9 MB (20933986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:2088e2cf2e7b6e5b392d5a033f922b7f3e5480dd7668eacd07775516eae390b5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51572177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d1c9308da0b8a9e8c158ff5ed99f8f26d17ca6cd2de22d9c64e21e963632686`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 06:35:53 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:11:20 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:11:20 GMT
ENV DRUPAL_VERSION=9.3.7
# Wed, 16 Mar 2022 18:11:20 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:11:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:11:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5a10e390b7608d00357e119ea8c966b9a122104b8d559d09a7fcf025a6dc6f9f`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ba8c4de140991f5afece4fc1f5e54a1ea21d2c715312b16e2fa9bad44f88fb3`  
		Last Modified: Wed, 16 Mar 2022 18:33:31 GMT  
		Size: 575.7 KB (575709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74379912f2a2f8e5f497f9d379ce577fa0d2110ec7aeab3cf0ab9055a42319cd`  
		Last Modified: Wed, 16 Mar 2022 18:33:31 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c1dbda2950d626f8bc79f1297b14b76a02fe060c4515df5be6057d8d7cbe16`  
		Last Modified: Wed, 16 Mar 2022 18:33:34 GMT  
		Size: 20.9 MB (20933880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
