...
```console
$ docker pull drupal@sha256:9d6c24a8ca3f3076a1b0fdfedc50d84f21127f11d16cb13fde6cd512ef613e98
```
...
```console
$ docker pull drupal@sha256:387aa183997e3a604e4d5f6aa9d40f0741847eaf9302b1e7858745e4599b8444
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53062841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b0a4219e5b8ca7c932b8fb0da26319d5267f2ecc241928d2834ee5ec66cad21`
...
# Fri, 11 Mar 2022 12:13:05 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 12:13:05 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:13:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:13:16 GMT
...
-	Layers:
	...
	-	`sha256:d57f6bda87f7de78bf27edca53b7943c43e359554bd4cd73617ff9632c5cf308`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ea88d9f9b89637ec18b0af7809bd6617bec091db22ff0a106e9e829780ba718`  
		Last Modified: Fri, 11 Mar 2022 12:33:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91fa3bb24a0eff5b4ecdb5fefa03b2841bca423ee369263b2c40e99ad639acad`  
		Last Modified: Fri, 11 Mar 2022 12:33:43 GMT  
		Size: 20.9 MB (20934264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:b4c092e22a1acf23ef6b83db61804850a457a8ea4f91cd1d6df3f02213853034
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49777344 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a4180112edeb106ea7a31273b3a0749b73e546eed07fce5568e164f44fc969b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 12:52:24 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 12:52:25 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 12:52:25 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 12:52:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 12:52:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8b07205daee72af257864db3dc7001cf3731ad498b628e9a5537b45953453803`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a7d324fc8979a88ab469c54f6f66d09b1422c693c0197f337f63e8e7c09999a`  
		Last Modified: Fri, 11 Mar 2022 15:30:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83efe199988c646b5fb0180f20926d74463fa1a041f1a7b9cccbf5eb20382d08`  
		Last Modified: Fri, 11 Mar 2022 15:31:10 GMT  
		Size: 20.9 MB (20934311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:456e150e4a35e02d2e0ed6e069dcad2212931e86163902020851b72536a90db2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.5 MB (53460510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25bfffb2e277e05a7cfb0034c386e9e44aec4d1acc69c5bbdedb82a20a800316`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 14:49:22 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 14:49:23 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 14:49:23 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 14:49:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 14:49:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0894422ee1205b1ba5ed9bc5ab1ea8e46d0c14d6bf3990e2c0c51bde81b11c7c`  
		...
		Size: 575.3 KB (575341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81a3a7c27c930eb87dce79bbce1bb0606b8d1e1928f8220365a5afd686136adb`  
		Last Modified: Fri, 11 Mar 2022 15:22:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4505a7e8266383cf15cd54ce618c966cecf72eebd9fdb3528b9fbdbae8a79769`  
		Last Modified: Fri, 11 Mar 2022 15:22:34 GMT  
		Size: 20.9 MB (20934165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:489c6db925c76c2cb129a2bacb58c9f9f1c3207f86888e62b86bc702a06a2186
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53324839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c60a74ca0edc72913f57f29ac505739a9e6b787de3ab5e471beb943b66d7beff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 11:42:15 GMT
ENV DRUPAL_VERSION=9.3.7
# Fri, 11 Mar 2022 11:42:18 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 11:42:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 11:43:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:94183a231fa52b6ef58ffd96b85dd1e4f0527cd85fee65c7adf66cf95606b991`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06d56df2042f3299418c850b01dbeef32dbd1a35e0f8ee4b333fa40852f4d98f`  
		Last Modified: Fri, 11 Mar 2022 13:09:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31e7e54e49d0273dc27499190da8246cf22a338661e87f853762d73732b01608`  
		Last Modified: Fri, 11 Mar 2022 13:11:20 GMT  
		Size: 20.9 MB (20933671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
