...
```console
$ docker pull drupal@sha256:da3f1878ce5e052957f91d1fdb5cccdfc1afc0800b3e3e07f053f0b2b6d1bbde
```
...
```console
$ docker pull drupal@sha256:7a0ce3da9c77f338ec1b773dd4f18c02b34ead38df58b5cd67d15dd95bf54a83
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50583880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4307420ce3461e3307e84751cbcd14ae2780c464a784154c9444453fd86de7c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 18 Mar 2022 10:46:41 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 18 Mar 2022 10:46:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Mar 2022 10:46:44 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Fri, 18 Mar 2022 10:46:44 GMT
ENV DRUPAL_VERSION=9.3.8
# Fri, 18 Mar 2022 10:46:45 GMT
WORKDIR /opt/drupal
# Fri, 18 Mar 2022 10:46:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Mar 2022 10:47:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f48ad7fc3667f96b444239ee6f734046b44d1a6b7f1c528ddcba0b4bb24a4ba4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a67f430120d3933d1c0930eff5d5c88810b54caf49e813679c2c4dcbbb4a5cbc`  
		Last Modified: Fri, 18 Mar 2022 11:13:41 GMT  
		Size: 2.2 MB (2213905 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3227dc7a5b25c44af10eb1d086435d2cf989cfac0e4b3ca57e7335dd7272ce1`  
		Last Modified: Fri, 18 Mar 2022 11:13:40 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78c946cd4d17ac6bc6f9a948cfbc433fbd2ed77235271ea2232cbe10bf0ba9e0`  
		Last Modified: Fri, 18 Mar 2022 11:13:41 GMT  
		Size: 575.7 KB (575707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a52f4af6368fd249aa6371d230fdb73d745e9ec422bf584be438eef285f28c11`  
		Last Modified: Fri, 18 Mar 2022 11:13:40 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3eec8601238a4a8c7ab3011c51d0ac5c4d7a718a73b80bd72f430252668ca7d5`  
		Last Modified: Fri, 18 Mar 2022 11:13:46 GMT  
		Size: 20.9 MB (20937582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f74166132b6d3c26779b4bb0129c5e00038d8ef97fb95f012ecfaaf505bdacdb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50345897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ec63af955e9235ad128727dd42cdece7e64c6ea7c26420b9a7dd135c3396e0e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:324e0e1ac40422ed977d63f8f358b46128903a0abaac31c3367ea5eb8d150179`  
		...
		Size: 8.6 KB (8570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6222a0d3c3c6725a0281a92c368288a0b6b84db4f40dfc1900bb61890f18b9d0`  
		Last Modified: Thu, 17 Mar 2022 21:39:12 GMT  
		Size: 2.3 MB (2260329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d2d921f384a6fa3fedae2961e8a000a66e19a5032c33f71e4c164f49ec40a5`  
		Last Modified: Thu, 17 Mar 2022 21:39:12 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8add8efcb2b70eeb0d937c020c59f8f27158fa3aef19c62e2a202a1f13e2129d`  
		Last Modified: Thu, 17 Mar 2022 21:39:12 GMT  
		Size: 575.7 KB (575708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b428ea2908ec67626c0709048a3a0415eee7e74705f15b04f8588c84e45c699`  
		Last Modified: Thu, 17 Mar 2022 21:39:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed1815e2bc347cc825afdc3fc9ad09998f576b52ba59e3399fcbeee33212e7ae`  
		Last Modified: Thu, 17 Mar 2022 21:39:15 GMT  
		Size: 20.9 MB (20933967 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
