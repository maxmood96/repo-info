...
```console
$ docker pull drupal@sha256:0bf3774b4bf07b78b40234691cb55388385eed2fab47e3b3cf594c8bc50635ee
```
...
```console
$ docker pull drupal@sha256:8deb200f4260c78e53ff841bb4dbc5bed4a72cb32fff95dac880435c05d147eb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50892482 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be2b1a27531f97d6ccc0a255f8af97d7ae4a371e55894a77127bf01a76168d6a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 17 Oct 2022 20:08:45 GMT
COPY file:885ab970f10508225fd61630bb5f5deca9a4c5f5efa71af5b20e1efa22fecb2c in /usr/local/bin/ 
# Mon, 17 Oct 2022 20:08:45 GMT
ENV DRUPAL_VERSION=9.4.8
# Mon, 17 Oct 2022 20:08:45 GMT
WORKDIR /opt/drupal
# Mon, 17 Oct 2022 20:08:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 17 Oct 2022 20:09:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e2720206698a7ef05b65f37bfba6358333d0b843dcf617c2d66c2c819c6eaa5`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6ea826c3480753be7209fcdb0b7f9c03e6003f5a862b6f127e404266aff78fc`  
		Last Modified: Mon, 17 Oct 2022 20:21:11 GMT  
		Size: 694.8 KB (694772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:470ca95d798b8968a8781ceb66a4e1f2d3f6c568a8c68571ba592d2d4aa3eea7`  
		Last Modified: Mon, 17 Oct 2022 20:21:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c2d7e6fa4b4d892f755184ea2276765e72d351fbf418559c0bc7400b81a4d13`  
		Last Modified: Mon, 17 Oct 2022 20:21:25 GMT  
		Size: 21.9 MB (21897717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
