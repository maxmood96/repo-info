...
```console
$ docker pull drupal@sha256:bc49fe45bf35d29d9caff3e3dc1ba7508c76b24ab110d65f2c497d334cddeb52
```
...
```console
$ docker pull drupal@sha256:a9e0f1021fd5d325c95c54308acb6443c1cacd4496c12ac06c8aa112cf033a25
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.2 MB (188220389 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:850db3d8d32520f50463549a08f62a478b1a6f6329f67df97163f2e4f33e405a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 21:15:24 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 21:24:32 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 21:24:32 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:24:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:24:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:51d34e09f12ed7555ceb46a26a42bfaa3d4c05127b8215f0cc72777b5ac78443`  
		...
		Size: 698.2 KB (698243 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fb812fcaa0483c7c06dbac4ea4735f341b7b4ede9b4dc1248d22d4cdaafae73`  
		Last Modified: Wed, 16 Aug 2023 21:40:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f1e728d33482824ac40850e5aa6fde37012a37aaf796951447cf7e8f2b74abc`  
		Last Modified: Wed, 16 Aug 2023 21:40:45 GMT  
		Size: 17.7 MB (17696288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0.10-fpm` - linux; 386

```console
$ docker pull drupal@sha256:8395950163ace87c6fd2c2c81f2db75ecbae59f0a19db778c1caa481e0d9c487
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.0 MB (192956520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e04c2d26d5bd11a720a21e730485f81c335716f25e4472c1ac1ce04632ddd727`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:06:25 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:15:29 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 19:15:29 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:15:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:15:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2afc62fb1c0023e37038049977b29fdee44082c3074bf3d9632ae02eeacc3ab7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ffb47c58c1e278bea882ba09534c666f2bf57db8c9e85fe606ecc2fd6ae7921`  
		Last Modified: Wed, 16 Aug 2023 19:35:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0fcd1729ec77ac14d07e801733c14caf26966e90b7c44fdad28f9244a6acc03`  
		Last Modified: Wed, 16 Aug 2023 19:35:45 GMT  
		Size: 17.7 MB (17695630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:083ac597a3e8e7bfdc3ddf2a1f7b4ebef032aef54bee9ec20a37facd96a97b75
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.5 MB (167520142 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3385a3b30209ad950607f62e4aefba7bc18daa8ab7e1ea417c7fa579ac196835`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:50:12 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:56:18 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 16 Aug 2023 19:56:18 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:56:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:56:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c194479b88a34fac443f85e0192defad4e3b906a2c650538b35418c4505380dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2901230fa8a840cbacde893aab1f6a8489ec160d5123590d1ae655c8c3d38241`  
		Last Modified: Wed, 16 Aug 2023 20:13:59 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7264e427a1c84e4e2198019fd29c36c350510739b159a3998193519b3ed4801d`  
		Last Modified: Wed, 16 Aug 2023 20:14:03 GMT  
