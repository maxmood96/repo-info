...
```console
$ docker pull drupal@sha256:dc5e7f9c5f9c04641c700b59ea601d21761f02a1356b5265fab8b5d68473d517
```
...
### `drupal:9.3.17-apache-buster` - linux; amd64
...
### `drupal:9.3.17-apache-buster` - linux; arm variant v7
...
### `drupal:9.3.17-apache-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:43818ea7ebb08a89cb6d4ff53e46345402e8a905deec31e007859e4682cb0dd6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.4 MB (159424231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bee5fe449baff340d743c81c59a8c75a8e10522dc2b4498bbfb89e31cd445d85`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Thu, 23 Jun 2022 22:01:09 GMT
ENV DRUPAL_VERSION=9.3.17
# Thu, 23 Jun 2022 22:01:09 GMT
WORKDIR /opt/drupal
# Thu, 23 Jun 2022 22:01:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:97610538a3c85e1203f83c7d7552dd95e6f79de68d585f73631ff76c9c81cb6e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea7a25f6874203e2516c85e446cd39b6a5221bb4cde1ecdecc8cd2e652f2b2c5`  
		Last Modified: Thu, 23 Jun 2022 22:32:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2c79a498c6073079195357aed0f95c9017b5a8bc8c91cc0379f855afa737679`  
		Last Modified: Thu, 23 Jun 2022 22:32:36 GMT  
		Size: 21.2 MB (21216347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.17-apache-buster` - linux; 386
...
### `drupal:9.3.17-apache-buster` - linux; ppc64le
...
### `drupal:9.3.17-apache-buster` - linux; s390x
