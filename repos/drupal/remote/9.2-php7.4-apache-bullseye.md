...
```console
$ docker pull drupal@sha256:66e24cf9b5492bbd86c294973cac6ac8def7e3899a8a7ee5ccb4850033647c73
```
...
```console
$ docker pull drupal@sha256:40fbc64a16470d30394b17e29db42d8a1ab577cf8b8298b748e12709463603e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155052733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16a9757ef926fc1c1d8d72572657c815b9092eb9ca5e5dfe90516787bff0537e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:16:14 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:16:14 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:16:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:16:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1264f5d2e11aeace61ed311991897da2366c4a4cd20f2941cac2b6b870dcf8d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e52503c556a517563a87e0537c19bae8cf20c2b563f102152a70146a399b0bf`  
		Last Modified: Fri, 11 Mar 2022 15:45:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc33aa32eeca2c496f0922d22564e3bcb0f7fc907def87182559182514444849`  
		Last Modified: Fri, 11 Mar 2022 15:46:09 GMT  
...
```console
$ docker pull drupal@sha256:d79629dae0012f256f290d62980d3302d6f8caf8ba14b27902735e89ea85e6e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.7 MB (187729436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4c15fd26f4dc739818a258e740394e9b14b6ee515a6b24cdf93cc603142619c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 15:00:35 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 15:00:35 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 15:00:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 15:00:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:756f655c7ff6353b58442e08931c7c39a5f56361b42d9d5da60d71503e8cadbc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:784ad1f1a61c1bed63e23d9d37768f63879d5461e5accf2c924457af6e5d2d5d`  
		Last Modified: Fri, 11 Mar 2022 15:33:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc2ea0dec4ceb4a81e7a6a7e5a9530645b053784fd662117db3f5e6bf536f076`  
