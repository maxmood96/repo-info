...
```console
$ docker pull drupal@sha256:de8d359357677ffae4c685c7dc4eec58c77400fd17c752b563f9fdb4b69f0461
```
...
```console
$ docker pull drupal@sha256:4d66d3e313e4ac1bcb85b2a91b5b5a33e5736f40d9a28284887aa0619e23c4e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162346180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b42b60ab86e3e4da34e32aad8f8fda3b868e99024f884fc347155032f4a632f6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:17:45 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:17:45 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:17:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:18:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:207a9ec4c484d6b4694cbd819e03d5e4f8d803222ee85af4af6ed7007894b629`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33dd85dd8d6f270e2d56998fd0d249dcf117c315ce7c6d2077059c0d87cb7636`  
		Last Modified: Wed, 16 Mar 2022 18:38:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6527263c4a93e88b91e7faef336ecd5a4c6e158f18807b638d3f4c419ecf62ae`  
