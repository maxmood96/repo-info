...
```console
$ docker pull drupal@sha256:b8093a747b4a0bc198412f6ea46161f46d1dc7f8757a1e189d97571cfc083440
```
...
```console
$ docker pull drupal@sha256:a9cb060e20340705cbe8b877a880d7adb80e0df9129a0bf73541e691f1f5971b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185979098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:892a7d755722db235b3bde9bca98b6d70ce86777f4e063cc7caa3761412d1b65`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 14:31:46 GMT
ENV DRUPAL_VERSION=9.2.18
# Thu, 12 May 2022 14:31:51 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 14:32:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 14:32:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:abc4212c615c5694ee33b9b99a9401186950f8837bd93d649dd45bd3cc21b9bf`  
		...
		Size: 661.6 KB (661591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6064fcb6369f2c14ddebacdd5d706310a7416d92848c9e0747116c2c3fa25b8d`  
		Last Modified: Thu, 12 May 2022 15:31:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1888b28965f57e31d606650746600e6afb7b5c6a61361749d3c6d1867a630c19`  
		Last Modified: Thu, 12 May 2022 15:33:02 GMT  
		Size: 19.1 MB (19115800 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
