## `drupal:9.2.14-php7.4-fpm`

```console
$ docker pull drupal@sha256:1fbdc57b4297b67e70cc91c8dd8c107533dca4ecfe29dcc5b26c5b0c443b3925
```
...
### `drupal:9.2.14-php7.4-fpm` - linux; amd64
...
### `drupal:9.2.14-php7.4-fpm` - linux; arm variant v7
...
### `drupal:9.2.14-php7.4-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:bd9207fd3726771a448f56595d8546ea9c4c2f586f57e291bce609590a7022d1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.8 MB (173825893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6b74feb915fac6e943e7f99f3241a9d8b66cea104fefd9545ac8635c7843c12`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:29:10 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:29:10 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:29:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:29:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:975fe4c4ede469eb8ab9746d03f21c8bef152371e887b13d24eda06914ad8388`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21621920b50bb292acc1bf1d3a30a415185d9371642e11b663b585e968e3b778`  
		Last Modified: Wed, 16 Mar 2022 18:55:36 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5bbb3325671b7d73cddd9971c3c2421d647d05ce8f407ecafc01d9080f6e6ad`  
		Last Modified: Wed, 16 Mar 2022 18:55:41 GMT  
		Size: 19.1 MB (19111623 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.14-php7.4-fpm` - linux; 386
...
### `drupal:9.2.14-php7.4-fpm` - linux; ppc64le
...
### `drupal:9.2.14-php7.4-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:99d0035190b2c0162fc513251769c6e70bf13dfb45bdd1c1b5a05d8857a906fd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.4 MB (158370394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf88b913b1f518a74f04feccd6fa0d834ae2d99dd2cc0a575464fbbc526e8fd3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Mar 2022 18:18:09 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:18:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:18:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c575bc68f32879d5339b2a36f60bca28e4a5353942f4ef1045b16e91ae000de7`  
		...
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa7628843ae963db97283d6eac149b2bdab489801d5eb6b4a665ebb63afb71d6`  
		Last Modified: Wed, 16 Mar 2022 18:39:15 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d1f36f82263d4b054109d7022a485edf5e942523e5fd1a640ebee5d5254b1b6`  
		Last Modified: Wed, 16 Mar 2022 18:39:19 GMT  
