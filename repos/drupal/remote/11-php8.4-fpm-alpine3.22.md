...
```console
$ docker pull drupal@sha256:67c9549f109d2f7b5d50ab0a7caf7faece973e306dfcf565614f6c2d4acb9a62
```
...
```console
$ docker pull drupal@sha256:ddad303bc0ade0695bd19f8c997ccb62a9cbfb4c5a7e566cf99c883b49751b01
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.7 MB (58662793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2d86b1c1e7119d9c672f605ad3d56183f469ddea33f58de09cfc27e56634bff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull drupal@sha256:7a9066eec34f6f7146c6b472f765dc7fedef06a62e3c7b55030c46dcee9cafe2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **415.4 KB (415416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ae158389cd0593482e1645c7d20c78486066acf14efd04371461b024061f4b4`

```dockerfile
```

-	Layers:
	-	`sha256:4462cb721187eb2518e967682ea6ae5537f486b554fb8c641cba7ab356dac52c`  
		Last Modified: Sat, 21 Jun 2025 07:56:20 GMT  
		Size: 379.1 KB (379058 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:eed2b0ac58ff750aadc9b2e4820b7b969a2de2f695ffa07174eee7bd12c4664a`  
		Last Modified: Sat, 21 Jun 2025 07:56:20 GMT  
