...
```console
$ docker pull drupal@sha256:ad795d3535c881f6f203ef75a3a182bcf389af4184a476194a6e46609ac3ab57
```
...
### `drupal:10.4.9-fpm-alpine` - linux; amd64
...
### `drupal:10.4.9-fpm-alpine` - unknown; unknown
...
### `drupal:10.4.9-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.4.9-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.4.9-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.4.9-fpm-alpine` - linux; 386
...
### `drupal:10.4.9-fpm-alpine` - linux; ppc64le
...
### `drupal:10.4.9-fpm-alpine` - linux; riscv64
...
### `drupal:10.4.9-fpm-alpine` - linux; s390x
