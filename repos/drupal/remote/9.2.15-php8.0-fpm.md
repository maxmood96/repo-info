...
```console
$ docker pull drupal@sha256:660aea5e99d042c60a83b1ae937f53b59f5b77e473514e8f20cb4d7c2d218dc2
```
...
### `drupal:9.2.15-php8.0-fpm` - linux; amd64
...
### `drupal:9.2.15-php8.0-fpm` - linux; 386
...
### `drupal:9.2.15-php8.0-fpm` - linux; s390x
