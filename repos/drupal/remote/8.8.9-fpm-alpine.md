...
```console
$ docker pull drupal@sha256:904650a2c598adae90a923e51a10909264a275cd7f471c84e788ebc608680293
```
...
### `drupal:8.8.9-fpm-alpine` - linux; amd64
...
### `drupal:8.8.9-fpm-alpine` - linux; arm variant v6
...
### `drupal:8.8.9-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:8.8.9-fpm-alpine` - linux; 386
...
### `drupal:8.8.9-fpm-alpine` - linux; ppc64le
...
### `drupal:8.8.9-fpm-alpine` - linux; s390x
