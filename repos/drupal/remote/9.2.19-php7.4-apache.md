## `drupal:9.2.19-php7.4-apache`

```console
$ docker pull drupal@sha256:92b53d5101ba4fabe6a67c814692df5c9f97561e72160599c4f402e61a968672
```
...
### `drupal:9.2.19-php7.4-apache` - linux; amd64

```console
$ docker pull drupal@sha256:cee12c93571d9c943d8c6808620f95ee997779f658c798ecd988071b8bc73356
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.9 MB (184913025 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b47041619a8c5c9855bb4c4945aa68bd8d429b0eb69e18bde3f8e599c3db105`
...
# Thu, 12 May 2022 19:29:17 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 19:29:17 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 19:29:27 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 19:29:28 GMT
...
-	Layers:
	...
	-	`sha256:e22cd730413ed57afbf128b88f13653906b0ad9d9e2a4971a272800d65ad8f15`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ba3bc199435b76edd4fc437e7af38ce726411d61bb51fdeb49cb3892c7d8e4f`  
		Last Modified: Thu, 12 May 2022 19:49:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6706da29cb837f0c7ad869e3a5e85e9b382cfe9843a3d6bfcdc11026225f8799`  
		Last Modified: Thu, 12 May 2022 19:49:26 GMT  
		Size: 19.1 MB (19116874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.19-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:815beeb19b0cdac6fc0b2e5c70d446434c8290518d8f0f4decfb7f6eab5f21dd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.2 MB (155162386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae14f1938d7f536aaeedc99bd13ce586322f5a7827564c7e18787890a7c45ad2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 23:18:07 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 23:18:08 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 23:18:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:814287131fd11f7bdda1c86e0ba745cc86487b78e29f3a936791dac0de059de8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3c5e4796ab993c85b0c30fa15aaa33d835c8b445d641c3607b3f9c5d5c8d54d`  
		Last Modified: Fri, 13 May 2022 00:14:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adf5101f8be1d8c74d894c21db368b84797dc21b1f0cd5baeb31fd04cbd0c37c`  
		Last Modified: Fri, 13 May 2022 00:15:10 GMT  
		Size: 19.1 MB (19117170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.19-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:c42ff20d3f2e3a9a4170b4aac1ea00db2119ded46a117370bdec4c69b98f055c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.8 MB (177757463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4000ea51c76e652fbb77cf42dbff1fc3b4ad2707fddcbf7cd5bf1cbeea723c51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 19:51:43 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 19:51:44 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 19:51:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 19:51:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:82978916fb25fca970c9d163d24fc7a20a381ad0efec26362a79dfb078a1d62c`  
		...
		Size: 661.6 KB (661591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8f48e2106fd4f50a368725d38d7396c565a7afed45ced4db321509dccb87c1c`  
		Last Modified: Thu, 12 May 2022 20:19:30 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc8b67ec4bf3c2e89bfa1a0e3a99bac2ad87d5a186dcc8122c258d4b9f06c285`  
		Last Modified: Thu, 12 May 2022 20:19:35 GMT  
		Size: 19.1 MB (19118282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.19-php7.4-apache` - linux; 386

```console
$ docker pull drupal@sha256:f7b7d0fc042e76c16e96e4db4a24e74fd92b7c090f683c87ea90d8bbf15c9f36
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186987286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c752b48118769b83d65a0feac7e07d4c8b9a9627d00554860afadc5e51bc2f88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 19:49:26 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 19:49:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:4bba878fba7fa7cb8cc18c024e9096e76d658ecb83f85d9121adffbe4f5a295c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4b5d045e22d12e8be9005ae6b0b85095971c78db81e52caf5abff7f626926a2`  
		Last Modified: Thu, 12 May 2022 20:17:56 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a7c135ac4cb8483af250ce3a357e953711ea1df77a4974e80004e9924c4ae8a`  
		Last Modified: Thu, 12 May 2022 20:18:01 GMT  
		Size: 19.1 MB (19117640 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.19-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:84e7d247dd5c6576a9c1c94a625264b0dbafedb82254b15d5c624ed98e8be501
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.0 MB (185980014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dda6a0e963bd7db5a8ab9b1a5b38062a02dceb0f14b89879acbb2b723bf6b14d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 23:19:49 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 23:19:51 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 23:20:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 23:20:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:abc4212c615c5694ee33b9b99a9401186950f8837bd93d649dd45bd3cc21b9bf`  
		...
		Size: 661.6 KB (661591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d67cdf236e9ed1ecc9fb7a87866e01bb64d05f6a86961a6a32d0e8dc660cc9f9`  
		Last Modified: Fri, 13 May 2022 00:54:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25caa61a9979c60f83279e4b601bc31a4701a4c21a26af8dd7520bcd1c3bd9ef`  
		Last Modified: Fri, 13 May 2022 00:56:09 GMT  
		Size: 19.1 MB (19116716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.19-php7.4-apache` - linux; s390x

```console
$ docker pull drupal@sha256:37660c00a390f37ad86b9d26c1b8a1a6e48670326311ad9c133b77393a1d6272
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.5 MB (162451734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a30518dbaa22b4c3deb794bfac2534a8945d417fd37cc56cadb55f6bb89b2322`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 11 May 2022 17:55:33 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 19:55:46 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 19:55:46 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 19:55:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 19:56:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:40ed8ef71b70a64c7b34de6fc57410f5ba09820bbb3e7e20ee6d4c7c843a5b44`  
		...
		Size: 661.6 KB (661591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1e2e563d580204002f33ed445bce2a9a4c6f7e857e4303d599895f91340b90f`  
		Last Modified: Thu, 12 May 2022 20:18:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e8753477ec636801595f6b197ef148b3aa026a4747b860201b406c46e65d795`  
		Last Modified: Thu, 12 May 2022 20:18:06 GMT  
