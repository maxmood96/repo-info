...
```console
$ docker pull drupal@sha256:cfcbfce8bd24cc19b652021eea58cf5813cb46dcb34abfb6af87267eb3330241
```
...
```console
$ docker pull drupal@sha256:b2f09cfaaa4d6f58261280e81c45b96f3d8a49a8d8bdc252131b2fab36c48918
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.1 MB (142076617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e8550464735ba044777ae8af6c1621a4d68853d6b8600ad1f14051bd7d2aa89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 20:00:48 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:00:48 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:01:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:01:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9bde671893cefb0258fa765e7b05074ec818861228ba4beecd859d5c918b0bed`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79469f568bb61d248ad0a5d61e9d346f1db8e108cc9d32a3a7eb8174b071b2af`  
		Last Modified: Wed, 29 Dec 2021 20:38:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc88ea3ce26d83f29615a3c2e6fc120dfb46fb8c3b3a7e0341638c71be8c7be6`  
		Last Modified: Wed, 29 Dec 2021 20:38:46 GMT  
		Size: 20.1 MB (20141891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:995c3f324a7e6ba7331350e7d79c15f9e4aef82b4c2faffa98ecd9f4705388db
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.2 MB (177248612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dd3586d01a70d1aeb17bae0fc8a7b07b020155684e353e208060db51de1e149`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:56:57 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:56:58 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:57:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:57:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5e5d3aee3a1128b296dab80b0449b11d44434f1d49a33eed7606a5b87fcbb6cd`  
		...
		Size: 573.5 KB (573473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e61e6d061b94ba72456c09aebe1c4a08050fa2b1b42771557b8d71af2ca950a`  
		Last Modified: Wed, 29 Dec 2021 20:23:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc46766f8d41fe28988f92cd9eec80e6e5c97d1e650769179bc91ccf9cb98c3b`  
		Last Modified: Wed, 29 Dec 2021 20:24:22 GMT  
