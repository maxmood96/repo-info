...
```console
$ docker pull drupal@sha256:0d74c7b452b869469c01c278315d53b137ab289af28fbdc0cdda243983f5accb
```
...
```console
$ docker pull drupal@sha256:13b355dc7e0161afb3cc1d34c70c26466f7fb4eea4ff5889e734a537ad68bc4d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140123107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17e94f610d37024252bb45ced808c19ebb2f8c1da00d620fca78c1e62309926e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 14:45:25 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 14:45:26 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 14:45:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 14:46:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:233ed8a1aa469bc7991c1ea0a91355ea8bb23d6d2d51e8efb41c9f7faf72e97f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d44c8384ce2916e889996189e74fe5f0edd4f6789a16368154f4d9a32d673ac1`  
		Last Modified: Wed, 13 Jul 2022 15:46:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb209e79fe70784312447bc2a2a16185da959def78b89609f5a71f9286dc732a`  
		Last Modified: Wed, 13 Jul 2022 15:46:37 GMT  
		Size: 21.2 MB (21216631 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
