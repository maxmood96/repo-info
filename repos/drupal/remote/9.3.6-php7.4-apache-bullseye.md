...
```console
$ docker pull drupal@sha256:dcc47d76cfa5d7de14903112b4b9680c2b0f24c0369f44a9ddcc65d8c5b898a1
```
...
```console
$ docker pull drupal@sha256:6c02d4fd306ee9e0d097623c2b6d72a580eda6c2cf98b9f2e4da910940c3e982
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.8 MB (166810616 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ab2dda02b9a53701fb994db45f0db0060ce26f2dc91166a3f4be5c13431cbab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 22:15:55 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:16:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:16:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01e3458966796df8a118ffc3cde480d7fa558c05f11139434f32c25fd6ace361`  
		...
		Size: 575.3 KB (575348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ebc1931e5fb9fbd2eab7c75692524e8ea1d1346d5f4c33974b3e16d35f2aea5`  
		Last Modified: Tue, 01 Mar 2022 22:37:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f950a9f28b78e1e22fcc6b322ebc75d893b397e7ca40dfef44b55ef8e93ce192`  
		Last Modified: Tue, 01 Mar 2022 22:37:06 GMT  
		Size: 20.1 MB (20118776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
