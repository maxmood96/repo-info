...
```console
$ docker pull drupal@sha256:fa60dba8a4131fbdc2459e9912554ddb9e11e0ac97e19875e4483283602350f8
```
...
```console
$ docker pull drupal@sha256:b179cd6904546f0ee4c51f5b24907446c868cef0dd8e2215f566f118ed24a94a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189664036 bytes)**  
...
# Thu, 17 Feb 2022 23:27:48 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:27:48 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:27:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:27:59 GMT
...
-	Layers:
	...
	-	`sha256:f4c296cfb4936d557ae8a3b24e47f13d07099a4c112115df7c69720d2bcf48ec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e35a06fd54bee33a64188a26993ad4a5286e4a1a1832d7eedb1f559145b820f`  
		Last Modified: Thu, 17 Feb 2022 23:40:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a641f0480d82954b7c4c703b55c25d496521d25b7b4ef380485333eefca00c6c`  
		Last Modified: Thu, 17 Feb 2022 23:41:04 GMT  
		Size: 20.1 MB (20118912 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6d1e6f5fce06e4f65b2fbfaff324d376f853e905b5047c7ed0c1501a6baf7e27
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.7 MB (192674274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7a36e56f03d40740d05081a2aad193dfe9a86743428a618cffe33ba679f6b70`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Feb 2022 21:10:32 GMT
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Thu, 17 Feb 2022 23:40:32 GMT
ENV DRUPAL_VERSION=9.3.6
# Thu, 17 Feb 2022 23:40:32 GMT
WORKDIR /opt/drupal
# Thu, 17 Feb 2022 23:40:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 17 Feb 2022 23:40:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1c663a740723dcb7dff74093be468193b177f74e436dc7e69184c7f16963776c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:213366c9288c87a2a3c06cb34ff6268e111be8b1d240ec176e7e554cd8cef8b5`  
		Last Modified: Fri, 18 Feb 2022 00:03:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4a75b1231110dbc591f4b009f1df397eb166bf0b1cdc2d16c0a08103964902a`  
...
```console
$ docker pull drupal@sha256:fe6f894b913fb6e96507a2cc31e9ba8824e7ad2088695043c784e425117c61fe
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.1 MB (191055384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af107c5847ca38a3ea06451399651362784abf6f6866758575753e8ed3378ab2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Fri, 18 Feb 2022 01:39:24 GMT
ENV DRUPAL_VERSION=9.3.6
# Fri, 18 Feb 2022 01:39:31 GMT
WORKDIR /opt/drupal
# Fri, 18 Feb 2022 01:41:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:34a0a538583867aca46a7ee1259c3d3edfe6556d71edeb6c5e61af6a20a71084`  
		...
		Size: 575.1 KB (575054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2745b20b3d3172faf0c674d1fbd093576fee9226112a39abae40305538cc53cc`  
		Last Modified: Fri, 18 Feb 2022 02:50:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e71922c5abb39b1623e35c8a5b78543508a8f051ff9056e41a10b7fdea05397f`  
		Last Modified: Fri, 18 Feb 2022 02:51:44 GMT  
		Size: 20.1 MB (20118811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.6-php7.4-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:d7be488a4ae1e6931db8159395235173c806de7dd2f13b5b2648b325a53292e8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.0 MB (166950220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61318675271bfee53fc190ddabd569fc337687a474d14978d9e5a26450d920fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:aab4fd5dd7e10070b5303c9c0ff4f6f2121bd9c2b70473d22b26517d674ae96a`  
		...
		Size: 575.1 KB (575052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:721cb47f230eecb96ada6bda05baf702f9de561f9a7addf58634f7ec70fa917a`  
		Last Modified: Thu, 17 Feb 2022 23:12:39 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68f700eb08cf90fc7e2e8854974cbcf7790cd5adce08f2e06c95cbe8b2aee6fd`  
		Last Modified: Thu, 17 Feb 2022 23:12:43 GMT  
		Size: 20.1 MB (20118673 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
