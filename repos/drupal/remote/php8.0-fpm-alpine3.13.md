...
```console
$ docker pull drupal@sha256:fc8915d01b961bb38284aaeb7959f8b76c6f13828c6fe80cea4e5907ea982ae7
```
...
```console
$ docker pull drupal@sha256:b277dc45845c756e7544e874beea7fc224e5ef63a664ab3aed7ab05935cfb990
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49111863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5eebfd6f35f564080f8ede50bcc03692272edd36f7c1a377bb25a822caee9cdb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 20 Nov 2021 00:45:22 GMT
ENV DRUPAL_VERSION=9.2.9
# Sat, 20 Nov 2021 00:45:23 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:45:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:45:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2444e4ed0aa6285413e7c3641e0e1c7c634ca515dc74dfa3bfb723bdddaddd05`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b05f5fbe7336ed2ea9321dba91056968b6163fa4935314b67e30665081b51ed4`  
		Last Modified: Sat, 20 Nov 2021 01:12:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0e8ec135f60dda4b9c2756c341cc955b262248a4ac23276c7640f2c5ec19162`  
		Last Modified: Sat, 20 Nov 2021 01:13:12 GMT  
		Size: 19.2 MB (19192213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:2f3afd7f96684f58d3173b850fc248184be5a1686338d293bba0de8100422595
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.0 MB (52993677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f59273aea2f1418afd75aed201873b95f8b69e646f6070a4ab2e608f61d65a05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 20 Nov 2021 01:53:25 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 01:53:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 01:53:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3b1932597a1b5517c23d0ab606959e58917590e28ee5f3099712952fcdc60404`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bba1f60e625c04b5d60e731d58f182c6b500e33c715e2ba35b51473a512146a4`  
		Last Modified: Sat, 20 Nov 2021 02:09:23 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:141bc1799e78b685344b8e98144ab5d68e94dec8e2f454091955c4f6ba833822`  
		Last Modified: Sat, 20 Nov 2021 02:09:31 GMT  
		Size: 19.2 MB (19191694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; ppc64le

```console
$ docker pull drupal@sha256:4b6930ca3eaddef0a5a967540014f92bdb6d1dbcd9256a57f800f07ac0546806
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.1 MB (53116272 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:082d26d1ff62e0aafd0291b3def58cb5762dce9da2caff10f2a208f2a50000f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 20 Nov 2021 00:47:20 GMT
ENV DRUPAL_VERSION=9.2.9
# Sat, 20 Nov 2021 00:47:22 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:47:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:47:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:67fa1d02b314e03d5ebc7bfd2ad50b125072103306cce82cc67e34e764da797b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef19ac1286484ffc1ef126c373985d696d83b4630eb824be49084fb40219293e`  
		Last Modified: Sat, 20 Nov 2021 01:05:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:863095188acb78c3d948f708a7c0d526c5922db467f91bf3255c81f86331af38`  
		Last Modified: Sat, 20 Nov 2021 01:05:40 GMT  
		Size: 19.2 MB (19191566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
