...
```console
$ docker pull drupal@sha256:6ea59321e7dc8ec3010e0df3c1452f8dcd939fdc19720103e711d545dfb90330
```
...
```console
$ docker pull drupal@sha256:35a7f32b05e48499e52029043e62f3ed7279e81e16968cc8bc1bdb7c42815c82
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52900293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96f5560bc3ebfe50424d6f2a64b39aaff83f6d2f7341558eb4e7c2b8bb31e741`
...
# Tue, 24 Aug 2021 21:37:25 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 21:37:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 21:37:36 GMT
...
-	Layers:
	...
	-	`sha256:1d7f8c497f6d71f90374c6ca0f197cbbfbf661cca291505b592c90977602c686`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fc81b466eaeef31c11f14666f03de5a7a3d2cdddc6ac9fef8cce36bdf5ac1f3`  
		Last Modified: Tue, 24 Aug 2021 21:47:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:199934e1379a8867dba5bc5d954744ecd7076bbeb5a192a8aa6ae104ca5ee104`  
		Last Modified: Tue, 24 Aug 2021 21:47:32 GMT  
...
```console
$ docker pull drupal@sha256:d7df29c1a4c6bd0b6915a7bf97e9ba31eaaf00960981f81b8f74ae2b75a0b241
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50655225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb3139d03335e009938b63dd3c171cf6064dd97a62f6b0d7fe440f88ae50c8ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 24 Aug 2021 22:09:45 GMT
ENV DRUPAL_VERSION=9.2.4
# Tue, 24 Aug 2021 22:09:46 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 22:10:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 22:10:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8e7216551fc3628e1a0876b0c445fcbdbcaf19e2598ba747094d35d1b3844797`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bdef6afff392540603290d6da0a56972be4d1e4bf9b35758c0d9c3b943ab125`  
		Last Modified: Tue, 24 Aug 2021 22:21:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15eb5f92ae2a5598accd6f996a21f956b0e2a5300fb50cdee24481421d04cdfe`  
		Last Modified: Tue, 24 Aug 2021 22:21:51 GMT  
...
```console
$ docker pull drupal@sha256:7aa5617a34fb705f1ea8b57e267ec563bf54b214e9e0c53d20364b4573c72faf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49272288 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cad8b41f0eaf838ee2abb17066d6c47174e81f4c72bcef6c50be55348430060e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 23:16:52 GMT
ENV DRUPAL_VERSION=9.2.4
# Tue, 24 Aug 2021 23:16:52 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 23:17:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 23:17:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a056ac50216db0d3c34f67b1f6d2eccd149de21e16849ad4452f97042a8f9bb3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9faa0e80661f2c629f1c991a1a661967873b8b5f2a8f56aeb472379ee18a401`  
		Last Modified: Tue, 24 Aug 2021 23:50:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc6b8557dbf8bfa2a81e92690c88b6011e34f9efdefe4e926f285274cb377c04`  
		Last Modified: Tue, 24 Aug 2021 23:50:45 GMT  
		Size: 19.2 MB (19178966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:094a4ef9d6c36e97b50ee2f0d2cb61c3098f94ca0e619a6eba1c143357706c12
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51917364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:001c8bbb95bf237547d30a48b445cad967f0b5cc1efebe438b0b3ba0a71f3dbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 21:58:47 GMT
ENV DRUPAL_VERSION=9.2.4
# Tue, 24 Aug 2021 21:58:47 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 21:58:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 21:58:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ff2bff3d197c69add4e5b4d87080a5129b0b776771711de65b6bc0b4ff825baa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1decd1acb8c8c5daccc1fb1e964e1b3ece77c6f3e213fc2d0e349fec61dbb13`  
		Last Modified: Tue, 24 Aug 2021 22:15:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26252155e5d1fb6f3766284f87b6ae595e52cb690384a346e8f219072ea2bc3e`  
		Last Modified: Tue, 24 Aug 2021 22:16:04 GMT  
		Size: 19.2 MB (19178952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9bd7b332c2a9017fd265975af828570bfac7495f0ba6974723f9489498195a57
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53298010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8a91d0e4d9d54897e0c60fd9edfd9f4fd77c856c48fbf9a67e811791a09de30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 21:48:58 GMT
ENV DRUPAL_VERSION=9.2.4
# Tue, 24 Aug 2021 21:49:07 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 21:52:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 21:52:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5a2dd0053646cab5b260f3f1e5935f8814b5cf20870dce272c0797b666dd5cdf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24ca117e278cc803d0f1c8603c7130316872beb105f6b3610049d037986c889f`  
		Last Modified: Tue, 24 Aug 2021 22:58:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f1cd2b6de93fc40003769aae0b38d2d14c9510de8fde2131aab0b2d58cd392`  
		Last Modified: Tue, 24 Aug 2021 23:01:24 GMT  
		Size: 19.2 MB (19178863 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; s390x

```console
$ docker pull drupal@sha256:11b37edc16f48011dea27cc2ce9e70dbf4cbfc470d7cddaae9743d10927ac8ff
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51254499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:013d9608d9818962f637f31f362cf4143ed885c6876fd0135cc501fa81e473f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Tue, 24 Aug 2021 22:01:16 GMT
ENV DRUPAL_VERSION=9.2.4
# Tue, 24 Aug 2021 22:01:16 GMT
WORKDIR /opt/drupal
# Tue, 24 Aug 2021 22:01:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 24 Aug 2021 22:01:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b6c58922d820d5b0a3f6532e2c607580d3e506569334be93842df62d3f5ee95`  
		...
		Size: 554.6 KB (554577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54c7090f2a6333744e6ab63e201211ca048821afe1e1738778d5adb2fff6dbce`  
		Last Modified: Tue, 24 Aug 2021 22:16:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2504e7055841ff3a624056478e490810f04f52ecb6c992430d5d8d340c5df96e`  
		Last Modified: Tue, 24 Aug 2021 22:16:46 GMT  
		Size: 19.2 MB (19179031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
