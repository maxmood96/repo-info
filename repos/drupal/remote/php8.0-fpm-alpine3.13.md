...
```console
$ docker pull drupal@sha256:0758f6587b72814ee678bf9ba005eba52243c65cdab1570ee496a9e93491421f
```
...
```console
$ docker pull drupal@sha256:de82ded368897d15e38e9d656f1e657fdb25c2f11292b950fd2fc3c2dd4f34c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50341501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24be9bbcb848ca5ad4ac74ee354f8516040be787043b353278c88648ab6304de`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Fri, 19 Nov 2021 00:00:41 GMT
ENV DRUPAL_VERSION=9.2.9
# Fri, 19 Nov 2021 00:00:42 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 00:01:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 00:01:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:00cc2f63f8ae19105e5df94faf981549dfdf95874d26913e4d0bc8f0ab0086fc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d13677b58ef3145cf3df3667d337e4800a413842d725c99372b9766b336fc571`  
		Last Modified: Fri, 19 Nov 2021 00:13:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba85d6cc3e9fe9573d82755ef8b24bf1f696c7bdc4416baba485e1eff7afb430`  
		Last Modified: Fri, 19 Nov 2021 00:14:13 GMT  
		Size: 19.2 MB (19192181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:45606f726a310f79b03b391d9e64cb53dbde1e8b4952ed1259478f5fad74a2e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.0 MB (52968519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1d1aeec611463307e243d55b5b32ff93c3715562614861b2f9cf2445149452e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 13 Nov 2021 19:23:58 GMT
ENV DRUPAL_VERSION=9.2.8
# Sat, 13 Nov 2021 19:24:07 GMT
WORKDIR /opt/drupal
# Sat, 13 Nov 2021 19:24:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 13 Nov 2021 19:24:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2d4c3ee79cf2237b6f9c3d7c8f4deb1eced6a3100cef84ecb314c915d7eb3bb9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:985ea1355c17a3e580540c8b1c02f13f40f2130b390cd0d6e0347693d4c72491`  
		Last Modified: Sat, 13 Nov 2021 19:47:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665071d1a174bacbeea5a9f51731a04fda5ebf2dcd0863aa3839ad649447fbfa`  
		Last Modified: Sat, 13 Nov 2021 19:50:16 GMT  
		Size: 19.2 MB (19188445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; s390x

```console
$ docker pull drupal@sha256:51836eca9db0cae25bd936b635b89f74b7b158c68c1542d42ac7aedd22d9fef0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50930369 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc0486e75033b7fbdacfb8034ea9a45245f1bdd83a085ba5c9dba06160d36699`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 13 Nov 2021 06:23:37 GMT
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Thu, 18 Nov 2021 23:48:41 GMT
ENV DRUPAL_VERSION=9.2.9
# Thu, 18 Nov 2021 23:48:41 GMT
WORKDIR /opt/drupal
# Thu, 18 Nov 2021 23:48:52 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 18 Nov 2021 23:48:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01952093113a6ec588a4ee8254db05c8f1093ee945d9ae1290e18bae18c4bcb4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da153b9e3fa6533f4f8ef0b437eb2cd8782a8dc95bd2b36d9ca112c3168c23f4`  
		Last Modified: Fri, 19 Nov 2021 00:07:27 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dcb6a9dfbce031ce96443476f1dda0156fa7af16718044a7c73a2253950249b`  
		Last Modified: Fri, 19 Nov 2021 00:07:31 GMT  
		Size: 19.2 MB (19191884 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
