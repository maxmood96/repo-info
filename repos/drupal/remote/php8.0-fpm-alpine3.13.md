...
```console
$ docker pull drupal@sha256:f1fc046cd9c83872f2d7976916ca458c9f87f657ad66144fc3769c7e02bd753c
```
...
```console
$ docker pull drupal@sha256:6ad5b54c5115689168e69a6bb2f12ddd244a2628b84cd3312f6c27958e0c14ed
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50651423 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69460c7acb84affea9771dc636e194699009e503cf60ee4101941d9cc3f7ef1a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 10:03:46 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 10:03:47 GMT
ENV DRUPAL_VERSION=9.2.2
# Sat, 31 Jul 2021 10:03:47 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 10:04:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 10:04:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ae7057893ff532d1d1ba3f55a5310c34f824b20a057365e741e0f242e5b9cf9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:690c4d9a7118d02ac26e05151975a6320683163306f426c945371aa7f6f65c4e`  
		Last Modified: Sat, 31 Jul 2021 10:20:10 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ac2a505b86f3afe0c95702156a4cfe1f38c3e74ddb649bf33a1fa589fa1138d`  
		Last Modified: Sat, 31 Jul 2021 10:20:38 GMT  
		Size: 19.2 MB (19175794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; arm variant v7

```console
$ docker pull drupal@sha256:43408e142cdd5a7d00302274827d0a20f4c21b7ac6664f48153e44f8116b6869
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49268588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b5479ae29dafeb8bed36d907f74ab748ab830e4bda541467de3b621b3cfce1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Jul 2021 13:47:33 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 13:48:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 13:48:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2661a98560e488315c99e3bbc8262d6a84d467d1081a01f217c00c236989232`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb8e8522e388ed0932835d6b953f9bb779a8187c79cb78072b383948bccbad8f`  
		Last Modified: Sat, 31 Jul 2021 14:16:52 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c92d4a618d17b66dc87f0961587fdfcbb3f402bb141df6117a034c570fc14fc5`  
		Last Modified: Sat, 31 Jul 2021 14:17:18 GMT  
		Size: 19.2 MB (19175925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ff4e032d5096166d87e2eaa1f3d8d342c96a087e3d30af4abfb5e6bd3afb928c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53294151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4941ffb89a7527a0941f4445dfca7a74c1b2b28b248684477900e473a3a5594`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 31 Jul 2021 11:16:05 GMT
ENV DRUPAL_VERSION=9.2.2
# Sat, 31 Jul 2021 11:16:10 GMT
WORKDIR /opt/drupal
# Sat, 31 Jul 2021 11:16:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 31 Jul 2021 11:16:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c373cd419dcfc48ca9faae8ebe225a90d17513a3fd6539f9da0437af6debe3ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3be69ef5eba1de186dc8c9666b2d71c06018cd65234a7c57bbd11c9d17f8e9d`  
		Last Modified: Sat, 31 Jul 2021 11:36:49 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9204df17440fba37405c9f33d36939998d6410de98d7673e7261ec5c802bfa1d`  
		Last Modified: Sat, 31 Jul 2021 11:37:39 GMT  
		Size: 19.2 MB (19175671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
