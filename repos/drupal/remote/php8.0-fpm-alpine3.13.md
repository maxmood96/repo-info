...
```console
$ docker pull drupal@sha256:0446599c13283f85a834be17dcdf7aab30eb76f1a5236b13f4f02975aab34f27
```
...
```console
$ docker pull drupal@sha256:d73ee7df36986555a4316feb919197f366505657d374ebac053eb14cd79aa891
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.9 MB (52892042 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95124a262f232ee3e5ab130d01b4d7d9eaaa0507438156123a05301fe7611c7b`
...
-	Layers:
	...
	-	`sha256:b8be7498834c1ccb0136b2f57a2c5bdaa5a0681efae913b00aa2e93229b1be1f`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d77ef3d86cdf4e9264aa538047f3ae881610e788ba0b7886933156b62e6adba`  
		Last Modified: Fri, 23 Jul 2021 03:46:25 GMT  
		Size: 553.9 KB (553887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06ff58f3c0c3e4e56cf0cfab3f466f96a53048e90f13a72e1ad71d1e1f71f1a4`  
		Last Modified: Fri, 23 Jul 2021 03:46:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cc1f8e768da4311ab832599307d41280649cf7fc09b0441daad65906fcd94f4`  
		Last Modified: Fri, 23 Jul 2021 03:46:31 GMT  
		Size: 19.2 MB (19176129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; arm variant v6

```console
$ docker pull drupal@sha256:60b557361930680c941fdec16df2e57914841fbe20622711a91b489f9fba0cc8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50643061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe7401d181b307f3d024009d9c182c80b7c9304378be2195a79c5db1425dfb64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jul 2021 21:22:06 GMT
WORKDIR /opt/drupal
# Thu, 22 Jul 2021 21:22:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jul 2021 21:22:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f99ffcf3fb3bb1319e2e64ce512d51c423ffe59b8ae6cf75d0280aead382eb4f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:895f00e396eb3d90a8c78e27440db5f5b19f9697a58f93b73e161935a797f7b5`  
		Last Modified: Thu, 22 Jul 2021 21:33:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1a6e961adbd7d6dd7bd1a5cdbd5e18781e0710df877ae4e9879df18e942db44`  
		Last Modified: Thu, 22 Jul 2021 21:34:02 GMT  
		Size: 19.2 MB (19176297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; arm variant v7

```console
$ docker pull drupal@sha256:229fc6bd30106ae4c425fe944eefce51c450a0922e797d1a6df5ae695874e1f9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49259975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0272db368ec1e0541891f49048b2fc32aa6c99a25e9cd22fd8f58ee77180c42e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jul 2021 01:07:20 GMT
ENV DRUPAL_VERSION=9.2.2
# Thu, 22 Jul 2021 01:07:20 GMT
WORKDIR /opt/drupal
# Thu, 22 Jul 2021 01:07:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b4a9a36e62bfbad66f97b2f89e4884c464d7d6b02f5acd8ef046106a5ea4271f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4d30ac547aee7f35d4030922356c9e24da1b8d3bdec77add06f153737f58a4d`  
		Last Modified: Thu, 22 Jul 2021 01:42:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f3ded359ab27ebf99e57b90a9b6c2a486e327a0609bf780d8af3ce5194539f`  
		Last Modified: Thu, 22 Jul 2021 01:42:58 GMT  
		Size: 19.2 MB (19175979 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:eead51dac1cffae63989db8f3a390e71152bd84417f7883cbc86c42b95774d16
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51658650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78ddf65cbbee17e90d05cfadb55fa2fb42612e1502969d2ed6829be7a13d2141`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 03:48:02 GMT
COPY file:5b0f37fae58d62cf1ebe5912cbfa57f9316290804d17b8bf9f3c001f68794ad9 in /usr/local/bin/ 
# Fri, 23 Jul 2021 03:48:02 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 23 Jul 2021 03:48:02 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:48:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:48:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f125aea4d0a907402bdf5329ec7a588491763ca697608d50ef29879b62676192`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abd960aaf93c6e7bf7bf800c8f826beb0844632b07e787af53cf8395bbaab399`  
		Last Modified: Fri, 23 Jul 2021 04:04:42 GMT  
		Size: 553.9 KB (553885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a932efeb4205f2dc0ed894ca0bea42548226334ac63102b42d73e2046bd2d4fd`  
		Last Modified: Fri, 23 Jul 2021 04:04:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0deaaabe4704022fa2a5549c37ae11e65c3f625dcf8d6cd6e274e14abc39e3d`  
		Last Modified: Fri, 23 Jul 2021 04:04:46 GMT  
		Size: 19.2 MB (19175973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a4bd379ed5aa235b013bbed8e1ea1d6c76108874e458b01b7b35a83bd9c602a6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53287586 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:692a830605ec37b4e3928200a3b3c12725e34c877aad47ddb919bab6bbca5d89`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Thu, 22 Jul 2021 00:35:03 GMT
ENV DRUPAL_VERSION=9.2.2
# Thu, 22 Jul 2021 00:35:06 GMT
WORKDIR /opt/drupal
# Thu, 22 Jul 2021 00:35:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jul 2021 00:35:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e377c4089128c3aaafd0ff6450473bc876dfecc7a87edbd270878df6bb82aa64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12b630563bd8e40f7448d29f9be01c4a7ad0ed3689df5c1ff654ea1c18ec39cd`  
		Last Modified: Thu, 22 Jul 2021 01:08:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4221cf5cddd7c6c5e64e3ea7d3d86f6a1f21e1428a61cf79141630f07b6fbc1f`  
		Last Modified: Thu, 22 Jul 2021 01:10:20 GMT  
		Size: 19.2 MB (19175947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:php8.0-fpm-alpine3.13` - linux; s390x

```console
$ docker pull drupal@sha256:0f5de84ba756e4e099a67cbce61a0f0981850beede6266c81a890721f225c73d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51243106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a8c2f5ba846a769832a23fc0104d35aeeccd5fa7a0835b6167e0a75a193afe0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 03:52:42 GMT
COPY file:5b0f37fae58d62cf1ebe5912cbfa57f9316290804d17b8bf9f3c001f68794ad9 in /usr/local/bin/ 
# Fri, 23 Jul 2021 03:52:42 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 23 Jul 2021 03:52:43 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:53:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:53:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:15ae30708fbf7ddb563290496b32e7a18b1de296920158c904586ab9fb1f0bf6`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83d4de4bede62c3c637cd1a760ea106ede1d8be8e8fbb869b6124d3803e0532b`  
		Last Modified: Fri, 23 Jul 2021 04:10:19 GMT  
		Size: 553.9 KB (553889 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a0bc8500c2dd7a783ec10b0036c061a930c557f974abfe086c9c816ccd378ca`  
		Last Modified: Fri, 23 Jul 2021 04:10:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11e80d701cb90deba0d7d08d24716eb1719da140348fca35a8df83882892b845`  
		Last Modified: Fri, 23 Jul 2021 04:10:23 GMT  
		Size: 19.2 MB (19176130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
