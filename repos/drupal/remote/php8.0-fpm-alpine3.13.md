...
```console
$ docker pull drupal@sha256:830763ec1f19f5c32d4b8524b057ab4a48e0a895d480d613560a5efac3d72e9d
```
...
```console
$ docker pull drupal@sha256:ff8178910e2c447f679bee5059a1cc170b8c581d0859ef74dc536690bdcd4a5b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49271700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0f347136ab8f0379f90f66c525f376e0036fa96e9031c3aff4adbcc4858fa74`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 13 Aug 2021 07:04:56 GMT
ENV DRUPAL_VERSION=9.2.4
# Fri, 13 Aug 2021 07:04:56 GMT
WORKDIR /opt/drupal
# Fri, 13 Aug 2021 07:05:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 13 Aug 2021 07:05:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f2661a98560e488315c99e3bbc8262d6a84d467d1081a01f217c00c236989232`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54198978cd5512389677135b2c22a35505cda12c786cb8bf45e97d52e77d61cb`  
		Last Modified: Fri, 13 Aug 2021 07:39:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a7afb583ca199790cc5c90ee7466061de59bebd6045c399ae6879adab3f83d1`  
		Last Modified: Fri, 13 Aug 2021 07:39:26 GMT  
