...
```console
$ docker pull drupal@sha256:83a65816463b8728db8b960e6767045d9882fe8e2fee8724492f0cd4dd0ca98e
```
...
```console
$ docker pull drupal@sha256:e2ac0a44671f903f77d3e7ae8cc9f2c96010c9d4e9ac4567c6408f3b712629de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51281235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:071aae1b1393dee20dfa76a5f6b477d47ae6278f26df32c3cce4692ba0890fe5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 08:07:21 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 08:07:21 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 08:07:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 08:07:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77d53f4c4eac56023c66b82c6abaa645478154b659568c84f71a48356ec1433b`  
		...
		Size: 698.2 KB (698236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6813b607f4ed573526621c23cbdc231ebfabbe9a92f4e805e8d8d6fc1cf9ded`  
		Last Modified: Sat, 02 Sep 2023 08:27:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d9e835baa155f3aba97160d346d00c530e7400cddf21398bcd32e2eb3a6a583`  
		Last Modified: Sat, 02 Sep 2023 08:27:34 GMT  
		Size: 17.7 MB (17688205 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
