...
```console
$ docker pull drupal@sha256:10644f1893ebfdebdaeb67c975b06703a2cedcc2d9ac8eba972523b2c9becd5c
```
...
```console
$ docker pull drupal@sha256:c22d08e4f78028c511b3d9233aaecdde2514f7d5b61f47669c9273aaa97db4d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49812810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7d7d982b2f672262082ebc537e1a210da22ff9fe2fbb8ae90116b2d94015774`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 09:10:07 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 09 Aug 2023 09:13:11 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 09 Aug 2023 09:13:11 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 09:13:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 09:13:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7aeee8ac36c2d5bef9c386c35645fcbe39d88620dbb6256005a63a4402b5bd3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36dae6c15dad004b90bea053ff6dfaae2c49dae4f7e19dd1d7ddf64bc8940f70`  
		Last Modified: Wed, 09 Aug 2023 09:28:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:672225e63a87fb884b047c1946c0eb2370c1e7207309774c9687bba577c84a31`  
		Last Modified: Wed, 09 Aug 2023 09:28:20 GMT  
		Size: 17.7 MB (17688026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
