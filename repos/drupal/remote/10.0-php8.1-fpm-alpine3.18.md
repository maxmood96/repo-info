...
```console
$ docker pull drupal@sha256:39aa17c4973551ffe4e6b2af2acd66317882c74876d8a0dc4e78ab861e4781db
```
...
```console
$ docker pull drupal@sha256:e524cf11918629d6f28c0b59b9bb7ee326b4d02fc847039876fb77466a9be8df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49314283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:097ae2487ba2baf5591772b15fd8a07f56b70628dd3e57cbaecc6b4ba73b6fc8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Sep 2023 02:20:39 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 29 Sep 2023 02:21:24 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 02:21:24 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 02:21:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 02:21:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:507a0902a2367a6394cb22a55bd7f95040e23cdc8fb116c50acc37e711938ef7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a479f129f95612070966566008cc7c51639588bf35d3b6419d3342fb90e7d58`  
		Last Modified: Fri, 29 Sep 2023 02:25:33 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d65fb0e86a2840f2a4cd43d9d154dcc3d18605ded5b1c244ea725cfe4973292a`  
		Last Modified: Fri, 29 Sep 2023 02:25:39 GMT  
