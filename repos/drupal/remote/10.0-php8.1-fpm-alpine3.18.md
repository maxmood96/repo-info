...
```console
$ docker pull drupal@sha256:0886d1aedf0f35c122066bc7466d8fe9cd83bef75f028da9878bddcd8ccdae1e
```
...
```console
$ docker pull drupal@sha256:821b89d77472bb6e3b04e2fdfa1f94b2bf8b69c1bc0f8aee363799fb8a358f37
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49222599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:953b87e6f4e135f791e064346c89eba5bfb621dbed4c82e6924b7964e6709f10`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 09 Aug 2023 03:49:33 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 09 Aug 2023 03:51:23 GMT
ENV DRUPAL_VERSION=10.0.10
# Wed, 09 Aug 2023 03:51:23 GMT
WORKDIR /opt/drupal
# Wed, 09 Aug 2023 03:51:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 09 Aug 2023 03:51:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3b2d4c2fe4e91cdef4023457b1624c3931b107ee42425fa3ed529959f8e6b651`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dee76e77e26c1f91a51c3293697a2324aaaaddd9372e7531a192059349f97a02`  
		Last Modified: Wed, 09 Aug 2023 03:58:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f04b582a42630c23bddd040ff39286433a6fcea26fa0ea9b6f8cbb128e058a59`  
		Last Modified: Wed, 09 Aug 2023 03:58:26 GMT  
		Size: 17.7 MB (17688235 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
