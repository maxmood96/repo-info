...
```console
$ docker pull drupal@sha256:960a21903c2d714a95d3ed9f970a465a1104d71b00102c10faa61c57f1b12f75
```
...
```console
$ docker pull drupal@sha256:2f3e1a7ed0dc810414dd277f6456fa6aa285845178ec5a46c08eeb043e90e68d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49238677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efa8b7ede1affa8056f3274b5a43eaac6b14693f5cf487057aa2e8a3db2a5ecf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Oct 2023 19:11:54 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:12:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:12:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4ead53ce899653ecdd268dad3724ef8ad7f0cb36b027848fb4e1e4f24ed63477`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:005d2badc130b27aa15ad7d99eefe6473e4b20b968017325a3d73acf22135e33`  
		Last Modified: Fri, 06 Oct 2023 19:18:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fb34ee4c063531d0995f795ff5a268e09c324803505f1a3827c2d3cf6ca57ae`  
		Last Modified: Fri, 06 Oct 2023 19:18:12 GMT  
		Size: 17.7 MB (17690329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-alpine3.18` - linux; arm variant v7

```console
$ docker pull drupal@sha256:2e473c12adc1e33e6d53c5e2de2c97532892ea067d33860b6ff8feb4c6a9b4c3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (47963408 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fa08683c5dd2fdb168315cc51ee0524a132ae84352c12a827a43a8693e80deb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:28:21 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:28:21 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:28:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:28:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:310c025f051956c21e6db43b679cca362c9cb775e5f7417b131f1a0743b96338`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb268289d1745e2c4c9f31fa8b2470fa47ef69c763118cef8527cc04e4e00e1e`  
		Last Modified: Fri, 06 Oct 2023 19:52:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3e3d50e6b7f7820c02452aba16d6f3c6a6c7d2799daeede5632890c213d5064`  
		Last Modified: Fri, 06 Oct 2023 19:53:06 GMT  
		Size: 17.7 MB (17690377 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:903e03bd8f4b853eaa536ebdda9a3a1b87e4e0fcc98a904ac317d67aceee62bf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51393056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb4451c6c91606027dbe06124e8cf269e8e5c60fa0082fbc5e2f49abd33a1d26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f9551fb5d1ae8d6b419e302ad930434bc413130cf270a7617ed7be06dc5d356c`  
		...
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b0ae956ae927ddcb57fd51a44390145055ecbd838d19ee7d6518c17ffeb5aa3`  
		Last Modified: Fri, 06 Oct 2023 19:19:55 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cee9bb89f26bf07c6fe123ff632fa06bf1642bfcd85bf75a49d8379b0ec9c32`  
		Last Modified: Fri, 06 Oct 2023 19:20:17 GMT  
...
```console
$ docker pull drupal@sha256:72ce68bdc5c6db42e0e7e1867a21940e2ab74ab0fb2ce6de13f0387a979151f8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49825844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72dd4236a7b153419c1b5a1c3134c0c2e25f2554f495695f09cb347c1b0b2689`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 08:14:26 GMT
ENV DRUPAL_VERSION=10.0.11
# Sat, 30 Sep 2023 08:14:27 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:14:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:14:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b38fa67fb104d7dffbc373494f1978e80da3d36c11f96cdaaac78d48ac93619d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e5cde8ec50af7dabde5c9be9a11fd5d42fe2f2ecf564503582299c40e92765b`  
		Last Modified: Sat, 30 Sep 2023 09:13:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b581ec8e6aac307b50b82e49e89719808443287ec8872399ea436c0ee92ed0a`  
		Last Modified: Sat, 30 Sep 2023 09:13:48 GMT  
		Size: 17.7 MB (17690438 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
