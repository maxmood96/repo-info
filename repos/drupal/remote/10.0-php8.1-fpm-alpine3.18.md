...
```console
$ docker pull drupal@sha256:38a7540144b4550b5634069044ece746afbe97a45e7457f3334fe3152a5937a4
```
...
```console
$ docker pull drupal@sha256:006af6b392194dc2fd2bd6f4432397cd3b802fb1205fa69fcbed1d637130a1b7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51235065 bytes)**  
...
# Tue, 05 Sep 2023 22:44:46 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 22:44:46 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 22:44:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 22:44:57 GMT
...
-	Layers:
	...
	-	`sha256:eae903468e4a680e7afbf2126c727ca3a162077c13847934d8c8beaa0946c69d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ea56b2f4156fffce9edb9f9180036d1f21657b50e02fe25c3a281b572f29338`  
		Last Modified: Tue, 05 Sep 2023 23:03:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40c1506d44f3268de89c73d660fb748a696b45023bcddf2b573a23b7aedf8baa`  
		Last Modified: Tue, 05 Sep 2023 23:03:13 GMT  
		Size: 17.7 MB (17688157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-alpine3.18` - linux; arm variant v6

```console
$ docker pull drupal@sha256:8fe4a0e3e0ec67562f9a35beabd0ceb4c5a11941fd64076208e78abb3071df4b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49291483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2df2a901681541cd52d60b152e83f588ade7e15b1588a529669293bc4414fb22`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:14:55 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 23:14:55 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:15:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:15:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe32d5add99564f117690c73a344234951363e557fa806ca461b2b7fde6e7a20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2f47ad3c09693915b859382f0493dc8f3d33d0354d64123dae72e566fa0e653`  
		Last Modified: Tue, 05 Sep 2023 23:22:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db88b702816867e67fd9092b953cd33719e273330e5f17cab834e548214bd9d4`  
		Last Modified: Tue, 05 Sep 2023 23:22:53 GMT  
		Size: 17.7 MB (17688248 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a8b918ae08851ae301c3a90a42ab8d1ca4cfd1e2f919064e979b1b4d47e04fe5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51537283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b786d21fcafd03b8e891d85eb3e2ffe9caf0e3da0444904a312a7edfdf84152`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 22:55:08 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 22:55:08 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 22:55:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 22:55:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e86ef0701cfcf6b61ed3a057f9b44be0e9f0af1cd51a967ba157613a9fa784aa`  
		...
		Size: 703.4 KB (703369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba8652fd00fbdaf5631bf0af15d42d97d3bfa64baeae0c2dc80f1a1f6ee95a9b`  
		Last Modified: Tue, 05 Sep 2023 23:15:34 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37fad919c82b72a8dcd743ada0b8d0788b00b8abffd5f2a714e73c262964ee61`  
		Last Modified: Tue, 05 Sep 2023 23:15:45 GMT  
		Size: 17.7 MB (17688237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-alpine3.18` - linux; 386

```console
$ docker pull drupal@sha256:f95814b199aee073120604cc6e9b78a6d2fa3b855fa0c7ee33d2af9007e6655c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51286472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:528057d1fe7acb653831ef63b5a127b6a887148a115f5a84501dd58277f1b059`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 22:01:37 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 22:01:37 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 22:01:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 22:01:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e73f33337d2ffe323394eadd6f6b6e826107d250f1ae5ac33a4023fb179b9e85`  
		...
		Size: 703.4 KB (703369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:735aad829d61e9ca8f2e59d6e4c69e255b6c2a7e41e6441e06d75b6de06b1010`  
		Last Modified: Tue, 05 Sep 2023 22:25:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e38151b5828ed99f0164e784fe4e2faebfbd8d0ed7ea3f9e962b3971877f1072`  
		Last Modified: Tue, 05 Sep 2023 22:25:10 GMT  
		Size: 17.7 MB (17688309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-alpine3.18` - linux; ppc64le

```console
$ docker pull drupal@sha256:9c75c885b6908c4d02f9feaa8a56c15a8c3b49198b538666e253038aa40cd808
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51440773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f20189f0ca2577a2a4fc8f02f6a2f366122eae23cb807f4d25a5f3caec4f82cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:16:40 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 11:16:41 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:17:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:17:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c8b73fea3d3573128ff68dae46626a5b70d78c16deb4c123baf9a6e0baa01e87`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34851c6c0cb66031f27c6950de19fca6ed533380af882c1b7405bff14a220f80`  
		Last Modified: Sat, 02 Sep 2023 11:55:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d290139db99aa256b10800b6e02edbc257c92323df46035a4e3ddb90a2e275c`  
		Last Modified: Sat, 02 Sep 2023 11:56:04 GMT  
		Size: 17.7 MB (17688703 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1-fpm-alpine3.18` - linux; s390x

```console
$ docker pull drupal@sha256:35fc02b850f9a28739309524f148a8b69bb56009c3991fb5b3751cfe31ce0796
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49881096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a5c137ffd15727bf2fd3f0d241710c32d969c3378ae5735c01a48bffa04954f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:31:54 GMT
ENV DRUPAL_VERSION=10.0.10
# Tue, 05 Sep 2023 23:31:55 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:32:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:32:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c541f8589ecafd59ed30ddc86bb18b0d61f74f5972b3254b5787d14565dfe2df`  
		...
		Size: 703.4 KB (703370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32428fc31e2697c44bae7490d63e88e0feeb7281c2de5572b25e19f42289b031`  
		Last Modified: Tue, 05 Sep 2023 23:53:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe4854d136d9c6384b14793d4757d2719c14842ce5c8d74de575921741ae16ed`  
		Last Modified: Tue, 05 Sep 2023 23:53:29 GMT  
		Size: 17.7 MB (17688422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
