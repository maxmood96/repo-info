...
```console
$ docker pull drupal@sha256:d404c2d82d59df85b85f2665b2b358227caeb4c98662ba5724e16bca1e1dfa33
```
...
```console
$ docker pull drupal@sha256:bf5e319c5e63f519fcfaa276201af79d3a5a272bebc89374f3dc319c4adc89a6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50824939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67561799283aecc2dc8c154a4f4e40c4d65e3a9c5c5e26dd96cc5d716984c656`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 05 Aug 2023 00:31:36 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 00:33:50 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 05 Aug 2023 00:33:50 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 00:34:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 00:34:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:80fe2905ea551b1132a737cf68747f8a7fa6b9442c238874b02e964fc59ac467`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a959eb465609e661e64c7faa6dd75e9b04cc306acd69990977823bcad7e852`  
		Last Modified: Sat, 05 Aug 2023 00:43:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1bc2714b5d3623af0cf682e8f7a9dab5cee6face7912dd2922d1754b18e095c`  
		Last Modified: Sat, 05 Aug 2023 00:43:51 GMT  
		Size: 17.7 MB (17688144 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
