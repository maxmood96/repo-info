...
```console
$ docker pull drupal@sha256:10b56ae0a8176a5f0721bf9e065443fb263e09f968294338ba87ef290c25ec93
```
...
### `drupal:11.1.6-php8.3-fpm-bullseye` - linux; amd64
...
### `drupal:11.1.6-php8.3-fpm-bullseye` - unknown; unknown
...
### `drupal:11.1.6-php8.3-fpm-bullseye` - linux; arm variant v7
...
### `drupal:11.1.6-php8.3-fpm-bullseye` - linux; 386
