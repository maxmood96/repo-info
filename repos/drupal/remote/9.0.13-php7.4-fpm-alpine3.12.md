## `drupal:9.0.13-php7.4-fpm-alpine3.12`

```console
$ docker pull drupal@sha256:39ce0bf75bc3f636e375cd0107c65db0734a50ef145fdfffdd3e3ce5f5b0e0cb
```
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; amd64
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; arm variant v7
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; 386
...
### `drupal:9.0.13-php7.4-fpm-alpine3.12` - linux; s390x
