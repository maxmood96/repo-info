...
```console
$ docker pull drupal@sha256:347d566bb770c27dabc8de84f7d9996157e9f9e26fd84ca1637df59ec24b12e1
```
...
```console
$ docker pull drupal@sha256:a470ae6e0c1711a6e903367339e1507b8308594418cd14663c0fd929cd5f2582
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145619806 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f8bdc70fe89cc65a0969dc5282e0a0d6d20a0fdbfe06e1af984e6ed7e168ad2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 05 Mar 2021 00:09:13 GMT
CMD ["apache2-foreground"]
# Fri, 05 Mar 2021 02:45:46 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Mar 2021 02:45:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Mar 2021 02:45:50 GMT
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Fri, 05 Mar 2021 02:45:51 GMT
ENV DRUPAL_VERSION=9.1.5
# Fri, 05 Mar 2021 02:45:52 GMT
WORKDIR /opt/drupal
# Fri, 05 Mar 2021 02:46:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Mar 2021 02:46:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c938c7427d85be2dcf7256cccc0983ec9e333cf13280cf3868abb00057c36ea3`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1ae5a777fa6153fe7060b00a30012427eac2d465b9f716236f540a5247b2467`  
		Last Modified: Fri, 05 Mar 2021 03:07:46 GMT  
		Size: 1.5 MB (1488717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58dc0549ca24f43f587aa7242bdbcc2c126e6d3d6e3b49d5cf50188ecaf88b21`  
		Last Modified: Fri, 05 Mar 2021 03:07:46 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f98a217a6416b2b2629fe985a2fe7f2b0285558a21bd2f6acef1b4a7085abaee`  
		Last Modified: Fri, 05 Mar 2021 03:07:46 GMT  
		Size: 551.8 KB (551807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98549c4238efe02e6449f3060611edcc2cd0a631c69e10e41217321ca56c1781`  
		Last Modified: Fri, 05 Mar 2021 03:07:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b0dd02b483ab04bc8f9011255fe869bed4e25eccc0d72896bfe8384c7c4a03e`  
		Last Modified: Fri, 05 Mar 2021 03:07:57 GMT  
		Size: 18.8 MB (18834664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ef960d39385db7fe02fcf5cd5231fbca8966013781a658c95a0e99f4d2085de4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (156030680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7200b85404949e72aeea4757162c576d6cb11cc6cc5d9cdf371210229d2f662`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 04 Mar 2021 23:48:20 GMT
CMD ["apache2-foreground"]
# Fri, 05 Mar 2021 01:39:17 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 05 Mar 2021 01:39:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Mar 2021 01:39:18 GMT
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Fri, 05 Mar 2021 01:39:18 GMT
...
WORKDIR /opt/drupal
# Fri, 05 Mar 2021 01:39:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Mar 2021 01:39:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:926dcc3a229871b2571f3d2c877d07fdb98869ca979aab81fdc109f796ac911e`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e73d15ba8994a6ce0e9c0299fb09208dce6ad0441e942c3760c6508d28959e2`  
		Last Modified: Fri, 05 Mar 2021 01:52:55 GMT  
		Size: 1.7 MB (1701236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9953e671282d03899d010a37d7839d99bbfff761dcd9c19c57e84cf18054279`  
		Last Modified: Fri, 05 Mar 2021 01:52:55 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b518069db51ccdf2cb3896e64f546636e4c5c7436c485f37026ed7a8846dd2a9`  
		Last Modified: Fri, 05 Mar 2021 01:52:55 GMT  
		Size: 551.8 KB (551807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:087802e0cc8d10a1df6f6ee0594e62622962f5db03356d0d68fbd82f30d224b7`  
		Last Modified: Fri, 05 Mar 2021 01:52:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2687acc80c401a63537b7b2ee1bdd7e658b971e304eb33c1c18542f1dd408d30`  
		Last Modified: Fri, 05 Mar 2021 01:52:59 GMT  
		Size: 18.8 MB (18834817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
