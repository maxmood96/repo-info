...
```console
$ docker pull drupal@sha256:803152681a249988f100c8153b2ecc6ac46381a7643b9d47f366e570fe9a2a72
```
...
```console
$ docker pull drupal@sha256:e97be3e7259ff95069e002a57590a6fbb8bb04aa4edfbbc5602cf98b964bf03b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154487811 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7aac613f2755b85c41ba17636fbc1d61aec5b791a4518c2a395d4e46a64d6644`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 26 Mar 2021 10:05:48 GMT
COPY file:cddfcd7dd4b08ff278956da31aa5501966cc1e2e3488252d8cc9fdf6bb03e79a in /usr/local/bin/ 
# Fri, 26 Mar 2021 10:05:49 GMT
ENV DRUPAL_VERSION=9.1.5
# Fri, 26 Mar 2021 10:05:49 GMT
WORKDIR /opt/drupal
# Fri, 26 Mar 2021 10:06:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Mar 2021 10:06:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d7839a9a1a7d04b9863f58c6f3445383b6d52ad6c862e918b373f194c4b7dc5d`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccb1283126019e0c47f3129032fbe56cf2b39ee35fc44248145d622974c1ff99`  
		Last Modified: Fri, 26 Mar 2021 10:14:12 GMT  
		Size: 552.9 KB (552895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f891227fffc8c34194fa6573d3c320726f9363f1652ec9fc9aeeb7eb19011ad7`  
		Last Modified: Fri, 26 Mar 2021 10:14:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40d44c65d5679b8bfd7eec1a9081d7caf97afaea61f7697c025ebd559d7a5b19`  
		Last Modified: Fri, 26 Mar 2021 10:14:19 GMT  
		Size: 18.8 MB (18835125 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
