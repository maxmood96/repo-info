...
```console
$ docker pull drupal@sha256:8b8b16ced36b756c4e17fa17e2a95b58fcea17e416c455012c4dd6eafb568b1c
```
...
```console
$ docker pull drupal@sha256:d639fb2896513a4cabda221fdf028953aab04bf68f1f1ab8e585864ff165f850
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.6 MB (154615024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe641f8391d195a71ae73b3868b758c5fad26b748e2b6c27e54a96128e0b8c6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 15 Oct 2021 00:05:55 GMT
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Fri, 15 Oct 2021 00:13:14 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 15 Oct 2021 00:13:14 GMT
WORKDIR /opt/drupal
# Fri, 15 Oct 2021 00:13:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 15 Oct 2021 00:13:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bf3a03d11692506008e781087ceb8bc92de8ee5100c13e9c4cfd5f5f95b2de9f`  
		...
		Size: 557.0 KB (557005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e5121c6bbe16bfc860c094d515784170fbafe48278ba9fa074754993640154`  
		Last Modified: Fri, 15 Oct 2021 00:29:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4ea889f5b2ae413885e9fe8d5e1b85a758cf2ec8629db723e578f22671ef8d6`  
		Last Modified: Fri, 15 Oct 2021 00:29:05 GMT  
		Size: 18.9 MB (18883427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
