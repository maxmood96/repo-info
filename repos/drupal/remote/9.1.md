...
```console
$ docker pull drupal@sha256:f6362bfb41076173b707ec84c431fffeda1f8bbed3e3ecef48cba9eba39d8b11
```
...
```console
$ docker pull drupal@sha256:4ad20d67b6be150cc167a1e1b847b7a400966220b4603f9ed7836415924db91a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.0 MB (170045979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09111b67bc4f0a9fdf3bd61d3a7cb1274a56a632e77732b55ee28b914a86de36`
...
# Fri, 17 Sep 2021 18:25:04 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:25:04 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:25:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:25:18 GMT
...
-	Layers:
	...
	-	`sha256:e9bf819b9dd2c33a5bda30b85814dbbac61e60ae65185b9274dde9e51c712bdc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af3cf9a2f33b94c70358f757d7e245f9e4fa9491cbed90cc5062a9663cfe35f4`  
		Last Modified: Fri, 17 Sep 2021 18:38:10 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74702806768e4ee5eeb84c8b965c9283eea27cc071804ec73d41ebfaade91ae1`  
		Last Modified: Fri, 17 Sep 2021 18:38:15 GMT  
		Size: 18.9 MB (18882169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:c3315acff81ddcd76a454a35c5c0bcab5bdadd0d7c5a6db91eee6ed4dbb4eb2f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.8 MB (144752011 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a53d8409b27f0e4271b1d0f2149d07df8c666490e9a808271535e92a59d4e37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:05:59 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:06:00 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:06:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:06:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7a64f989f91a7f3d1b33b944b8860176d7d9cb307a8639b43bf2fbee02a01b2e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88f8e119f3f2869317f4a810eaedc959c4577cbfa0a9de1c8e0526f9c264491f`  
		Last Modified: Fri, 17 Sep 2021 18:41:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c1c5dad92835a7d6620c545e5f1f59da6793dafb94ce86bbc61bd8733ee3588`  
		Last Modified: Fri, 17 Sep 2021 18:42:08 GMT  
		Size: 18.9 MB (18881862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:7a9e43075510bf5562ee209ba2147e3308635fb90610f5810c6e03b93245288c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161409163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8e28eb4a288cdbc1138287beba5adb37abb4bb744c5de2b2443cb1d4b8b8d18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:46:13 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:46:14 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:46:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:46:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0b535c3478719abead75cfe2682c4e4485f2bed705df6fea54768669537aebc1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55867a1df35ad168304c7663fca4b2f40f0a06e47c7ea51b5d1b029632047fa4`  
		Last Modified: Fri, 17 Sep 2021 19:05:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34aa6ffd88a14dcf5f1e0b73891ce8d8146b8da914480ee1cd48d2526ce428ad`  
		Last Modified: Fri, 17 Sep 2021 19:05:47 GMT  
		Size: 18.9 MB (18882151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; 386

```console
$ docker pull drupal@sha256:2017e72b787f8a241856a06f1498660bce014d542096cf467bbae64d57da972a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176128646 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42f303dc7ceda87b78f1c486d7e719839ad0e6f46742d1256dfad58c130fbd54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Sep 2021 18:43:19 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:43:20 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:43:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:43:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bd775a14bbf2af7d0dab7f0a20640fc3ec3467026b115d907aeb08fb8e5f55b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:625019001ac3c08d900e3e6dc4c55b28a1e6c2a741b96f2477b551e505e2638f`  
		Last Modified: Fri, 17 Sep 2021 19:04:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0618e9ef7c7717e6ab27d0795fdc686d30ce717795e831270b29c3c4eb98223`  
		Last Modified: Fri, 17 Sep 2021 19:04:35 GMT  
		Size: 18.9 MB (18882080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:9cc7ac76e806531194d163ef43cb6e5abb5ac4f6935431aa9a687b24fd82eeb5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180762102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e416fa3fb0ca4edf0b180e90fffd6e0db78425e3666d29c0a9ebb04d5c99db7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:31:42 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:31:47 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:32:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:32:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:64ce620d19bfbc6855090f2b8378d11ed2cd2dd8da72578d336aab7a4b94a147`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:363679f285177bdca09d7bf10010230dbd5a673a8d3cd32149dd8694da065d66`  
		Last Modified: Fri, 17 Sep 2021 19:18:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b3d3091a504cdef3ee493db07b10344b517b71fca6440c84daf7dd3bdfcbfed`  
		Last Modified: Fri, 17 Sep 2021 19:20:32 GMT  
...
```console
$ docker pull drupal@sha256:a4bc0943a9ee249126ee2b4dc8771cb08e892915748da9ed834ecced2ee4a78a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.0 MB (155006628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a85e1199658d161827256e5551517c3eef4ff056775a711aae98548951775f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:dc207ca7ab98b6d16b7778ec45d2bd8228dd5555b6bf650b2acf6fb273bbf713 in /usr/local/bin/ 
# Fri, 17 Sep 2021 18:46:10 GMT
ENV DRUPAL_VERSION=9.1.13
# Fri, 17 Sep 2021 18:46:10 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:46:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:46:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2db813a39ef29b1dfa0b1624edafdb802225e1e2682014535fdefd72f1ffea76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d0917786017232eec48f25b1ec6b42e6fa59da8ab1c16a4495cc861719a86b4`  
		Last Modified: Fri, 17 Sep 2021 19:02:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6645b59c4624d540418fc396c9a3bebcc56ceaf6af7f35837a2e4feb26015c6a`  
		Last Modified: Fri, 17 Sep 2021 19:02:06 GMT  
		Size: 18.9 MB (18881363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
