...
```console
$ docker pull drupal@sha256:81ffdd1929629686fa01aa1b23a3a9a8238a5da7fcfb64b29151c01625bb3124
```
...
```console
$ docker pull drupal@sha256:639e2399838c9b6bf79d865069c0cf4401c0edbd35d41693512889e5bf260298
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155109410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a680b8c1bbbb86046165ec3979bf3021b78271f09eab9feb172e349f55389e7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 24 Sep 2021 00:00:49 GMT
WORKDIR /opt/drupal
# Fri, 24 Sep 2021 00:01:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 24 Sep 2021 00:01:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5e638388851da2ee0d1a2ea8f731301387488b910220a9301b57d69c95d658fb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbb92a8e3905e71d2a7a45d7641fb7b653eaa5ad98eada08b7cd4d3ff77f56cc`  
		Last Modified: Fri, 24 Sep 2021 00:16:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ed58f46f2d5b239b3af78e06033d06e6ca84ee00e2f42a788d3ab41e64e569c`  
		Last Modified: Fri, 24 Sep 2021 00:16:53 GMT  
		Size: 18.9 MB (18882220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
