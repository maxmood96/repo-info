...
```console
$ docker pull drupal@sha256:50e6023ad2551a5f8db488baffd02fca9fa884b39efb895726274e3daf805bbd
```
...
```console
$ docker pull drupal@sha256:e18b69b5305ee93626f363ac8d8768164f9f27bc5933aa69d3fc803eb4ffc7a9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144188945 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a5f6c4d94ef9e800dbc4a39b11be53abc3b3e2e11f311b1fd083a4fb6919fe1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 19 Aug 2021 00:16:22 GMT
ENV DRUPAL_VERSION=9.1.12
# Thu, 19 Aug 2021 00:16:22 GMT
WORKDIR /opt/drupal
# Thu, 19 Aug 2021 00:16:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 19 Aug 2021 00:16:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:08a48e92d02e95e8a44a4a379bea1dd5237f357ae7ca54f1f2aaf335f4ed1ef2`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:179d672b244852487f45afeed319363e0cb33efee3b17044b932cc556c4c4c2e`  
		Last Modified: Thu, 19 Aug 2021 00:38:38 GMT  
		Size: 553.9 KB (553917 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4aaa5e7c9175fd2a9927fcf27ab7b880eb933b885b23fce80bc8c80475700c8f`  
		Last Modified: Thu, 19 Aug 2021 00:45:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2907f7e8210debf20a24a22c10940da4af4655f4c6b62b658cf947d506f6c2c9`  
		Last Modified: Thu, 19 Aug 2021 00:46:18 GMT  
		Size: 18.9 MB (18879981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5e94831424143c381eff96526d40cff6515eee014ce1d1d66645f6a6f4317cb2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.3 MB (180294378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a1e52df1f0724fe5c38cd3eb2da2c1edba7c7b38da088d177325da1896ab82e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Wed, 18 Aug 2021 20:11:57 GMT
ENV DRUPAL_VERSION=9.1.12
# Wed, 18 Aug 2021 20:12:00 GMT
WORKDIR /opt/drupal
# Wed, 18 Aug 2021 20:12:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Aug 2021 20:12:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bea94bbd48171faf6f1a4e39399e5b959809547aa4e8b1126f702184a9fbc384`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38b1a9e96499168e0db360c9ddefbd0181bd41407ee8d35d5dc49db9f81ba3a8`  
		Last Modified: Wed, 18 Aug 2021 20:42:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:302a3591c756c9a6c52118de38976f920769d429df917f1483d4389da323d10f`  
		Last Modified: Wed, 18 Aug 2021 20:44:14 GMT  
		Size: 18.9 MB (18880062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
