...
```console
$ docker pull drupal@sha256:c40974a8b8f07b92f743258e8ffce17decad41cea9b54f555753b8abd7ec62ab
```
...
```console
$ docker pull drupal@sha256:dea4bdeeda8deb210acdee967a9294fa64f64dbba72ccd7bbe1cb44aff38af00
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.4 MB (144350573 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4509c9c3cbfe1aff8bef5a40d9ade5ef10fa82744d5286d0143fa8f3701856c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 20 Nov 2021 00:47:30 GMT
ENV DRUPAL_VERSION=9.1.14
# Sat, 20 Nov 2021 00:47:31 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:48:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:48:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d53b15992eea8a67fe4419a916354bb088b4939374f96468301164873bf9f384`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43b2b8db6af003cb935f5188166697f50f083e079eed10d7f60330428a116350`  
		Last Modified: Sat, 20 Nov 2021 01:14:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de42767fb990e266bdf739523ba0656d0969248f36e7b45eea54b95b8bdc2f00`  
		Last Modified: Sat, 20 Nov 2021 01:14:59 GMT  
		Size: 18.9 MB (18885546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:1f11d82077b64665f5720b5d08d942179fb76c19ee8f72b7b33ded00c41b412c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.5 MB (180450454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f29b8a1cdd503338f4a64ada433fbeea5d89785c9168f52a8e87da6788a076a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Sat, 20 Nov 2021 00:48:31 GMT
ENV DRUPAL_VERSION=9.1.14
# Sat, 20 Nov 2021 00:48:35 GMT
WORKDIR /opt/drupal
# Sat, 20 Nov 2021 00:49:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 20 Nov 2021 00:49:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:43ee7c4593f1a397cb5e0fcf3a0b2d52a3d3082e4e266e69a78171c12b8cd38e`  
		...
		Size: 564.1 KB (564138 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fd6552508a7af81447e0b6dc7de1ef35a730da69a72b91ad05e26aeaf310891`  
		Last Modified: Sat, 20 Nov 2021 01:06:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aee14ffc79397939302ed9cb41bdaca80f664e25bc8f863283dde63cd1da256`  
		Last Modified: Sat, 20 Nov 2021 01:07:21 GMT  
		Size: 18.9 MB (18885465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
