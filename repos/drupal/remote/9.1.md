...
```console
$ docker pull drupal@sha256:aa7e86784635369ac6c42625f9ab60793cbf4cafbc0f770fe3cd457f634bd78b
```
...
```console
$ docker pull drupal@sha256:11874171c1c79003695b84805bd670dc97464fd39a6bedb1f2e92eece90b3dcb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.0 MB (170043667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e75618185e28db56ea945203a600a8ad22563b1e2d1adc2b4166eff0b28a8e7`
...
# Sat, 04 Sep 2021 15:19:17 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 15:19:17 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 15:19:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 15:19:30 GMT
...
-	Layers:
	...
	-	`sha256:5d8e18649be91a56813cb4a994c34acdc5326c80c70fa45d303ce4fbf968f0f7`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51c78f67bfecab25c7effdacb5e7e2c256a29c78858c72e51400ab8713be570d`  
		Last Modified: Sat, 04 Sep 2021 15:25:13 GMT  
		Size: 554.6 KB (554574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36438e804c40eeb42b1921a97b03e173e608eaff04df7e0b42d82f1701372c9a`  
		Last Modified: Sat, 04 Sep 2021 15:29:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:932df7fb1a61d4897c8a0df087dbfb440092beeb42b7bc9e0c27711a5c1b3d49`  
		Last Modified: Sat, 04 Sep 2021 15:29:11 GMT  
		Size: 18.9 MB (18880447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d4c9e8b5bcd1f7a40a9dc4936aea969acaa275dabaedc2f71a53f06eab299a8e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.7 MB (144749960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad7df703287b9d21878d4c4b3ebf5abff35c8f12f6e562662b2953bb0263ce5a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Sep 2021 17:45:48 GMT
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Sat, 04 Sep 2021 17:56:33 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 17:56:34 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 17:57:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 17:57:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:06fe2efc9cb5e3aec49a73a22bb4177de63d766b2ac715d31afb515eb67e758b`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5e82ce7406b5a2d59d8fe9b95198335f375484f0cb3bf5189deb28f32b251c2`  
		Last Modified: Sat, 04 Sep 2021 18:19:00 GMT  
		Size: 554.6 KB (554575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec6a992601c858e01f9139a8cce657facd54ccf43dd48f77687bdbe34c8e21f8`  
		Last Modified: Sat, 04 Sep 2021 18:26:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bafa84e6b919f3a9f642e7ddeadfa5d3b6e6a4180cc44acf64cbe6f56c059db6`  
		Last Modified: Sat, 04 Sep 2021 18:26:42 GMT  
		Size: 18.9 MB (18880400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:72b968cb19c4e6aa0b3c97d4b268e90ab5755296285197c1114060644bad21a3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.8 MB (180760000 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d6a1a689ce8e735a2eca762d5eca255472137375a9b944f0eb1eb820f55957a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:14ce7dd939bea5562f6591e17e859bd0b7e982d5f45044990bf974ff71e9dd46 in /usr/local/bin/ 
# Sat, 04 Sep 2021 10:59:41 GMT
ENV DRUPAL_VERSION=9.1.12
# Sat, 04 Sep 2021 10:59:43 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 11:00:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 11:00:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:63474756b1f4da70895b51fedcd3d777d6c0b0f295588d62ddbddc2718356e07`  
		...
		Size: 554.6 KB (554574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c285831a5654cd6c7db80d28ccea8a3013f1a593f80a06daa956b74d7fafbfa`  
		Last Modified: Sat, 04 Sep 2021 11:26:34 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:612101107b1bfb552b0ebbf4d423008d1ed9a826a94dffb4822ae3f9a7577d63`  
		Last Modified: Sat, 04 Sep 2021 11:28:04 GMT  
		Size: 18.9 MB (18880488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
