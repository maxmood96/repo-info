...
```console
$ docker pull drupal@sha256:1c869aa1d65b42b6ce5cf54d58feecee4925b7faaa14928b31f494579ed21979
```
...
```console
$ docker pull drupal@sha256:7f9291336b17708b60a0a0937af1143f8cdf3419f4443f134bb540a1fc1f1abe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.4 MB (169354208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5acf4f027856608b24f139bb40e3b1424ce5ffbea1b57d08c00f22ba091287e0`
...
-	Layers:
	...
	-	`sha256:8e511c094326f2036959dc3b4e5aa6f0be50f6ef009112369d5a907cebb673a0`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:668dc85d8ec0afc60d5f873ae9cd0d59dc80f0d85b143527e211d55c3b584457`  
		Last Modified: Wed, 24 Feb 2021 18:56:29 GMT  
		Size: 551.8 KB (551793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:868acdee2d3fdfb3dcb41a125225cb141970d9a60d41312b7c0fe10a7a790ef8`  
		Last Modified: Wed, 24 Feb 2021 18:56:30 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e6a1a457fa1a8f59ef6d2183f890f22984e3005df3551dbc9f957ec1304733b`  
		Last Modified: Wed, 24 Feb 2021 18:56:35 GMT  
		Size: 18.8 MB (18829965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; arm variant v7

```console
$ docker pull drupal@sha256:65b50e676b37917b7ca891cc1200045db7feb73eb05b6afdd0d68c19c669fc5c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144051724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e00879b2e20eb2e5d629f50cdc72f08f2af01bce10fd00a2bbeb28e3de67f9ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 26 Feb 2021 03:23:46 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:23:47 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:24:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:24:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ecbe994fbcabf9174fc60808058f429fb86ba6b32009b14eae31896a0c76aecd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db3b364f338f85e7f5ca23641b29c1471835546894d33b50f1ef98e6763dd771`  
		Last Modified: Fri, 26 Feb 2021 03:31:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dabae5b22898941b3627bf11d31d000ad93888b848057fd93225a07853efc5c1`  
		Last Modified: Fri, 26 Feb 2021 03:31:23 GMT  
		Size: 18.8 MB (18831447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d3f1299349b19e77d7ad3c2a5f324e639f4ffe68ee714208aa3307a7d9a9d582
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.8 MB (160784070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3139a659f051f3146723495ce4f67501eea74f0169a44d995816b6463c0e614`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Fri, 26 Feb 2021 03:20:51 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:20:52 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:21:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:21:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:123fc8172e7d8912dbc6388748d643f610c3567c195ed1a463549f67448f8779`  
		...
		Size: 551.8 KB (551807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74c98cf61363ab8db87f20eda2083e7cdfecc4cc6232474dcda4dbb9c4ab29ab`  
		Last Modified: Fri, 26 Feb 2021 03:27:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b84cd12e4d79783338e6390dc1f4f26b8e904e3d4b0b9166adadfd535b9ca529`  
		Last Modified: Fri, 26 Feb 2021 03:27:37 GMT  
		Size: 18.8 MB (18830387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; 386

```console
$ docker pull drupal@sha256:da2c01166a66822b164a6aeafc0f95c8b1463d0d0f5d47aaef51f289c8c65848
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174740834 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ce808b293c059fe1f6ee664b6880a425335694f5810f4eb6c8c553e1a37dde5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Feb 2021 18:54:45 GMT
COPY file:1b32c2cc2578adb470417567850eca1f7168281e86639ee273f7664dbafacc12 in /usr/local/bin/ 
# Wed, 24 Feb 2021 18:54:45 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 24 Feb 2021 18:54:45 GMT
WORKDIR /opt/drupal
# Wed, 24 Feb 2021 18:54:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 24 Feb 2021 18:54:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77e99fd2f7d182fb09f741d19bab63b83cc964c85f0ba40d314197c7841fa2a8`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0383b1157b22102a2f5a63be468db0366b77f78852080f5d05e6ee8ca8501a0d`  
		Last Modified: Wed, 24 Feb 2021 18:59:18 GMT  
		Size: 551.8 KB (551792 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94292dd502225201e6bf966153082f37d0d794a60b33cf30ade28c8a96de591f`  
		Last Modified: Wed, 24 Feb 2021 18:59:17 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69dc69b02c5e785880127ba9d6faa577cf9e4b14808a28f755a10c680791fb0b`  
		Last Modified: Wed, 24 Feb 2021 18:59:32 GMT  
		Size: 18.8 MB (18831201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; ppc64le

```console
$ docker pull drupal@sha256:80ad8d672e9540f08150e05ceff4c04e59544631bf458fadd5d103a3096e12df
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.2 MB (180156635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:905f07859a66a4fe0e0a53031d34aa888704936646f2e8d4ab7b5d00095a62ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Feb 2021 19:20:42 GMT
COPY file:1b32c2cc2578adb470417567850eca1f7168281e86639ee273f7664dbafacc12 in /usr/local/bin/ 
# Wed, 24 Feb 2021 19:20:52 GMT
ENV DRUPAL_VERSION=9.1.4
# Wed, 24 Feb 2021 19:20:56 GMT
WORKDIR /opt/drupal
# Wed, 24 Feb 2021 19:21:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:f1e7bfa7de0fa1cea19b357204e17407fd7611f7a58c31e052b5bd54b2503cc0`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:037caa4c6219e01b43342899d3bed4b6d4940221b9b4be9d3f9d0174215ba5f3`  
		Last Modified: Wed, 24 Feb 2021 19:33:48 GMT  
		Size: 551.8 KB (551795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3ed404335573fb5c9979bea3588134f31c3ea4453bd0c0888856140de1cf2b2`  
		Last Modified: Wed, 24 Feb 2021 19:33:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9614acd7bebe7a8f16e43e8ceba1da50fdfca872de4af58175a035ac2bf6441b`  
		Last Modified: Wed, 24 Feb 2021 19:36:55 GMT  
		Size: 18.8 MB (18831191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1` - linux; s390x

```console
$ docker pull drupal@sha256:c635e80116d8f9729df6c98c5b5c8257dd8bdd7d867def2a9c0b59f2f454834f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.4 MB (154366262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e264562975ed1641ac6054bd41bfe5aeb9fadd072acf0b743edcb0a48782e01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:deb590b59fc201c558f5c400490c99455a4f02093f44f8b429b21b024fa29bb3 in /usr/local/bin/ 
# Fri, 26 Feb 2021 03:27:30 GMT
ENV DRUPAL_VERSION=9.1.4
# Fri, 26 Feb 2021 03:27:30 GMT
WORKDIR /opt/drupal
# Fri, 26 Feb 2021 03:28:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 26 Feb 2021 03:28:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f9557f5a8df1b8a59aabbf193e0497ea90f484c44de220fac56fd2ac678bd84e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efb783a8bd3466a03503fc1b6a0a33994ecdad0058717c2475c72c0b16f63698`  
		Last Modified: Fri, 26 Feb 2021 03:35:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e8d0fb795b6088179ea0f265a3a60c65353e0adeac8d064a32920d43b3ec6e2`  
		Last Modified: Fri, 26 Feb 2021 03:35:58 GMT  
		Size: 18.8 MB (18831438 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
