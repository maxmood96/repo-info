...
```console
$ docker pull drupal@sha256:b1a026a3fb3ae3a134336dd203be930ea98e2f7c92dc4e24494e5686d6cce61e
```
...
```console
$ docker pull drupal@sha256:fcf7123cc437c611f96baa5d35f688d27bf40ccfd4ecc43518f104807e75d222
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.2 MB (144189060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7ba2eed7dd5559ca5cc1b37f2e84576a7eb522f46292e598b08f7ad29558dbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:09:09 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:09:09 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:09:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:09:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1dc5fca30ebe52d1c5f4bd0ae5cb0933c9e0f52defdddd0fe45d160a54026bb5`  
		...
		Size: 553.9 KB (553918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c77c89af12cfdbad3c167e63343cc94bb871939c7200c66f7f1e8f0a783fdaee`  
		Last Modified: Fri, 30 Jul 2021 04:45:01 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3571bec98b9a0baabe43dd6464cd0350a5d18263d5facacddb9f69f80d5ef658`  
		Last Modified: Fri, 30 Jul 2021 04:45:26 GMT  
		Size: 18.9 MB (18880275 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:6ec49169a464284c8fef43de4b3004d1ffc0896bfdd7f842f53abe1232b5d03d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.5 MB (154514452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f81b3b577b27d63c7d5228f0c97991d05a2b3f7ad8c32f19de70c51b2f3512a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Jul 2021 03:23:37 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 03:38:28 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 03:38:29 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:38:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:39:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7bdfd0092343fc25f1c0b1dd787e2a184181efcd7239a6eae3babf2f98beedf`  
		...
		Size: 553.9 KB (553918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68430159915809b250f8c002e9424bd5f69db5303cd0c44eedd03cc305ad3402`  
		Last Modified: Fri, 30 Jul 2021 03:57:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b29804940dfaccd325e5a7ae8b33aa46307401e0a5a0430145b475a914491dc0`  
