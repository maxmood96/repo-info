...
```console
$ docker pull drupal@sha256:a863ddb06f9010ea5808920cb8b9dbb18294198c52f61b916460c6d612f6694c
```
...
```console
$ docker pull drupal@sha256:ad56c1f2fdba591aaa3479047bc55aca7275d0dddac25593fdc48dbff1553add
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.2 MB (50155103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96efb881fe32a89f9541d9c0072be5e1ef0921df437b7a1d486fc4a9bd1f68e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 09:29:43 GMT
CMD ["php-fpm"]
# Fri, 11 Nov 2022 15:16:01 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 11 Nov 2022 15:16:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 15:16:02 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 15:16:02 GMT
...
# Fri, 11 Nov 2022 15:16:02 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 15:16:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 15:16:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fc3950c743f393e23e088311d7023373632db8501b00a24c5dacd3eadd2f0f0f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff8770dc89c8cbd1b9f80e1dd3667b621b7face2dd24483e3cb27d8ec1c95896`  
		Last Modified: Fri, 11 Nov 2022 15:44:25 GMT  
		Size: 1.9 MB (1855178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb2f87794e76115848b6f05631cf3e178bc58435435b6901adb8529c5bbf2521`  
		Last Modified: Fri, 11 Nov 2022 15:44:25 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f259a82bbd92facef213dcab05f8fd798076ad6108649f5bb0b5f1e5ca7a399`  
		Last Modified: Fri, 11 Nov 2022 15:44:25 GMT  
		Size: 695.2 KB (695196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1666c2cd9106c20c00730c68175b900dbf6ce7d0bafb953e4d0b5bd5a3bc3a3e`  
		Last Modified: Fri, 11 Nov 2022 15:44:25 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18c991a5988f228f94cca52a4213b2b4ad2ef6a817faf2b7d3fddd095076222a`  
		Last Modified: Fri, 11 Nov 2022 15:44:33 GMT  
