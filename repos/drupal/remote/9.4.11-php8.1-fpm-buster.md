...
```console
$ docker pull drupal@sha256:907f833bc4657cc03dd7bdf0c57c3b5ef627edc75d855816cd8520fa4738fe2e
```
...
```console
$ docker pull drupal@sha256:c25624ffab308b3fd0ff63fe5b7e679e988776f518b800aea36ecf7a79286b16
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.0 MB (141964391 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:419c35af2f7a06e52d53f44d207e22bd3a20f6aea81617c589b3ee7e4b53c04e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:2c6e86189bae3d0f441696ba145d29f22860cb3f94dece0c5761829ffdb8cb91 in /usr/local/bin/ 
# Tue, 07 Feb 2023 02:29:55 GMT
ENV DRUPAL_VERSION=9.4.11
# Tue, 07 Feb 2023 02:29:55 GMT
WORKDIR /opt/drupal
# Tue, 07 Feb 2023 02:30:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:66f53e515ef230f1f74dc2bf72acbe172fbf27e94ce21894702d950400835688`  
		...
		Size: 697.1 KB (697099 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3f90e56bcca06c7a3c48e91f49542d8ab882ca35a9b5824af2e08478c4169a4`  
		Last Modified: Tue, 07 Feb 2023 03:05:03 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b60dc23c37bafad4ffe4a82e2bd6650838b8402d999f27c581626d9542b4dea0`  
		Last Modified: Tue, 07 Feb 2023 03:05:11 GMT  
		Size: 21.9 MB (21909048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.11-php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:a1ad6912175f59aba19f644abf72b861878843b37efdfdaee06125a792f2edb0
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159152468 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0efecdc566252937454eee739f0c359f94fe318e18584104c3d02950d57c526`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 09 Feb 2023 14:32:11 GMT
COPY file:2c6e86189bae3d0f441696ba145d29f22860cb3f94dece0c5761829ffdb8cb91 in /usr/local/bin/ 
# Thu, 09 Feb 2023 14:38:42 GMT
ENV DRUPAL_VERSION=9.4.11
# Thu, 09 Feb 2023 14:38:43 GMT
WORKDIR /opt/drupal
# Thu, 09 Feb 2023 14:39:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 09 Feb 2023 14:39:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3638cff043a3b779465a38c36de75842a898ef619a88d6616a7540dde50c3538`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb2ed884811329d3d1bf46bda72f0d938356ebd35cbc74a794edcd7eb2ebda70`  
		Last Modified: Thu, 09 Feb 2023 14:55:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61b61882978b0d1c1b57392ee97074ebc353c14f0f1152104e85816dcba8dbe5`  
		Last Modified: Thu, 09 Feb 2023 14:55:32 GMT  
		Size: 21.9 MB (21910952 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
