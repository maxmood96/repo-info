...
```console
$ docker pull drupal@sha256:658bf82bd50b13eacbf0adfa3a9971a2959a5a7184aeaa6a84bbc8c3f901bced
```
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; amd64
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; arm variant v6
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; arm variant v7
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; arm64 variant v8
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; 386
...
### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; ppc64le

```console
$ docker pull drupal@sha256:311242a1755bed11d29c102af93b31cf2439610420461a3eeb7b428cdd1a83d6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51940612 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffac65131e8c214bd364fd1a42772446e3352f947f3af3ae6345e53d46b26554`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:8534166b12f0b4bb92e85a7bb184cdd5874be64ea494cf9fe702cd43a4a50b79 in /usr/local/bin/ 
# Fri, 19 Nov 2021 08:08:58 GMT
ENV DRUPAL_VERSION=9.1.14
# Fri, 19 Nov 2021 08:09:19 GMT
WORKDIR /opt/drupal
# Fri, 19 Nov 2021 08:11:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 19 Nov 2021 08:11:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:98c8dd2932269946ee8d062a015feb5ad6a3bc0e69ce61bcf515feeb53180212`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15ab4b4c151226057ad130a7055dd562c7fadf197e444f119b5c1d397d735a66`  
		Last Modified: Fri, 19 Nov 2021 08:58:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:594cb543b77e883dcec1bc62ef6dfe5dff8c4ca7f64a4332eedd2eeddd5fe23c`  
		Last Modified: Fri, 19 Nov 2021 09:00:44 GMT  
		Size: 18.9 MB (18879693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.14-php7.4-fpm-alpine3.13` - linux; s390x
