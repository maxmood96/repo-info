...
```console
$ docker pull drupal@sha256:3838d3e17bec48db29f633a66a4a8920909f240a807a08771d9a3f15e0d34743
```
...
### `drupal:9.2.4-php7.4-apache-buster` - linux; arm variant v7
...
### `drupal:9.2.4-php7.4-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.2.4-php7.4-apache-buster` - linux; ppc64le
...
### `drupal:9.2.4-php7.4-apache-buster` - linux; s390x
