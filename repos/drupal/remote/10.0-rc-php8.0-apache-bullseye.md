...
```console
$ docker pull drupal@sha256:cb61c5a0c3cdc8eebc3c332a5be3cf08b700a39e681c7aaa73295b9add1cf714
```
...
```console
$ docker pull drupal@sha256:cdded5804e1e32e2d520d4f3277bdbfa029415a5dfc3c079743f52ebf3786bd7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.9 MB (190949977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd68d1fc57b942f4d45526d98bbe2640be4fb420d26a08cb4d63a199e2ae9265`
...
# Sat, 19 Feb 2022 04:33:22 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Sat, 19 Feb 2022 04:33:22 GMT
WORKDIR /opt/drupal
# Sat, 19 Feb 2022 04:33:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 19 Feb 2022 04:33:35 GMT
...
-	Layers:
	...
	-	`sha256:0ae57f0ac9353956e258cd7f3e7f5102abbc66c714d9b67bdf9d6730d70f860a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8fd78f3b043352dec5b212f0148f5c7e1361a0da68b5c29707b4dea6fdedce8`  
		Last Modified: Sat, 19 Feb 2022 04:49:20 GMT  
		Size: 575.0 KB (575047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb7ec1e3676865b395dfbf34c30d75ad12e5ed4e88080368270a30c28fc0ed8c`  
		Last Modified: Sat, 19 Feb 2022 04:49:19 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2cd088262893e3c465e252afa9c1850bfe99f6fc69406e5076600c3fbf2a677`  
		Last Modified: Sat, 19 Feb 2022 04:49:24 GMT  
		Size: 20.0 MB (19960862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:85d2afffcd319d3230089d4f2b2e333f9a1e4b18a355e5106262f1a2923d2003
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159949845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:394bda780a13a930fe8d54616716411e19c7629aba809648da47066feae6d664`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 19 Feb 2022 08:12:18 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Sat, 19 Feb 2022 08:12:19 GMT
WORKDIR /opt/drupal
# Sat, 19 Feb 2022 08:12:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 19 Feb 2022 08:12:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:95ad00f6a2dafa1fd51774d1895cf00f900e290b3d6335a99e2be53321835700`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73e423c581759dd0dfa849605fb0f9fb3ca608d73751a94decaeadffb5087ec7`  
		Last Modified: Sat, 19 Feb 2022 09:02:02 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eca73bbc5b3d494ed3ac19fb0d08fe0c5bd7dc2362988ea6978bc69b9978e75a`  
		Last Modified: Sat, 19 Feb 2022 09:02:29 GMT  
		Size: 20.0 MB (19962670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:659a54398258832182964271da3f17fb6db946ecfce57bb85fe3cb3ac12c7260
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183256461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87343f9aaef25f0eef616d84644e53fa9c74d5c297942375793739b16e4e6ac8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Feb 2022 22:34:51 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Fri, 18 Feb 2022 22:34:52 GMT
WORKDIR /opt/drupal
# Fri, 18 Feb 2022 22:35:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Feb 2022 22:35:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:47f7673afa9a2000130119e147ecee65dd5d789598ae3946561e005ff114839d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a7daa06a9e9b1830a62a76e974efff6b010f63abfc22b258d8d1afe7cdd42fc`  
		Last Modified: Fri, 18 Feb 2022 22:58:24 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5595379ecbe573c4793b6d140ac23d62591c0fc0316019a69837aed435553b1d`  
		Last Modified: Fri, 18 Feb 2022 22:58:29 GMT  
		Size: 20.0 MB (19963517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:5b1b4bbae062fae235fe156a07876390913925f4a275cfbfa662d7a816e5620b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.9 MB (193886765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a198cc3de252e49ee7c4241080cad54dc9ba5d12e4e9725bf14ba5c650e67a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 03:10:54 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 03:11:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 03:11:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:73a43660f31794bdcb21fa06eeb7da1e67fd0b606a2fad36781fc6ac5d722898`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9136cff2d7283b66f99f494559b36332984850b2f65e117e14a3072c716bf2f7`  
		Last Modified: Tue, 01 Mar 2022 03:32:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35de70ad70de4f2ef190d80e7bb49b515f675b40012035aba5d9226485f6af6a`  
		Last Modified: Tue, 01 Mar 2022 03:33:10 GMT  
		Size: 20.0 MB (19961401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:fb5e9bfac71134854e1f08b9528123a78a78f29c31db833d4e713bb5515e9388
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.7 MB (191689315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c1822eb67afbc74d04618fa5cec83ae100d58de98f1b4276f71afbcd82ff0e9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 19 Feb 2022 02:59:47 GMT
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Sat, 19 Feb 2022 02:59:50 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Sat, 19 Feb 2022 02:59:52 GMT
WORKDIR /opt/drupal
# Sat, 19 Feb 2022 03:00:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 19 Feb 2022 03:00:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6e409db468613f68c440622cd1016599c268f892d234f8d10c28ea89f782fe55`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39c7d6795483b7e9917083c00806028ed2e58c442fb2dda16aefadd6fe690c11`  
		Last Modified: Sat, 19 Feb 2022 03:54:45 GMT  
		Size: 575.1 KB (575052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72210a97288e06b7f24130ffa5b5364abf4fdd8b3b5df9c3b930e1ccf5c2827b`  
		Last Modified: Sat, 19 Feb 2022 03:54:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52b15f7a25c5828b140951ff32f444c0054b0b9315bdc87e06e4658694e8d7a4`  
		Last Modified: Sat, 19 Feb 2022 03:56:37 GMT  
		Size: 20.0 MB (19963265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:a40f108af57f08185dcf53781a6e372a0b125744de551f3c5fe5bc751fd7e4b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167564456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:85ea262abd9b080af52743180cf7e0b70b19f59eeb30bb1d4c9629014a43f12c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 03:13:17 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 03:13:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 03:13:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77c49cf52edd0dc008fde375249241aa08f4475963194e39b436ff88480ba471`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ba8845fa3fe79c1ed30f8d3b06de5b2c17ea35867521c1d44318a50433817da`  
		Last Modified: Tue, 01 Mar 2022 03:37:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7828579996e1e9fa5d128854a8eda545f2e498ce9b6c65d60d77cf00f982429`  
		Last Modified: Tue, 01 Mar 2022 03:37:24 GMT  
		Size: 20.0 MB (19962993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
