...
```console
$ docker pull drupal@sha256:cd53476df28e334fd015ecde16d811b424595e41bb76aa31f077608981d4c510
```
...
```console
$ docker pull drupal@sha256:613b845ad1149ad1ac2e6d56e9a1d8df5a3ae04bc600779d5032e2f046078f0a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.0 MB (190952642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48b850cf4241777cd1c4d0270847695fa5096c9ef5fd8f716338c9302d85b5a7`
...
-	Layers:
	...
	-	`sha256:ec992af869d5cdc659dff733011062a0a4fe3f6ec260f8b28b3d4efbdaab6a8c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7224473978b83bdd807636847fb9de76105fec26e7a61f9bb479b18ba2fd787`  
		Last Modified: Tue, 01 Mar 2022 05:59:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9324384941ecad2c1ce87b5dca5747e3ae36555ae5ea8e47fecdb4e2b0a22388`  
		Last Modified: Tue, 01 Mar 2022 05:59:25 GMT  
		Size: 20.0 MB (19963226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6f30f52f4fb14bc1beab15bba5a61a89e71ea4969e314a0ccec6f681859b9aa9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.0 MB (159950682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76df942e795eff9399146dd22fafe8a1381e1099c8b7d0ea1734608891a6dc61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 06:22:23 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Tue, 01 Mar 2022 06:22:24 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 06:22:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 06:22:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:37764f33cd351e06ac4aafab45993669dd1a6263e1873a8d4954c2ace4c2f37c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab25eecf2bdb3ccd43d3cd3142c735ecdb8c90652ab341747c59a69eef03a06c`  
		Last Modified: Tue, 01 Mar 2022 07:07:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6df0b212763356f7abe36decd1b2fc90ac32c3edcc93f52b5d7160120f515e49`  
		Last Modified: Tue, 01 Mar 2022 07:08:18 GMT  
		Size: 20.0 MB (19963210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:37c84ea9bb7b61508b059534916f972dd1bf7e077586c0162736e8ad02657b35
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.1 MB (183123536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa4c9290e7127f3092d1461d1d4a423d4980c75105e0d50c4b1d3f7d0a32a879`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 12:36:21 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Wed, 02 Mar 2022 12:36:22 GMT
WORKDIR /opt/drupal
# Wed, 02 Mar 2022 12:36:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 02 Mar 2022 12:36:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d950e9b900679a37aa27cf511c00d73366be6b3a78b249c43d97913df2144045`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e945af695963fdca2819462a59575f266cb68ad04e005d367412a5eab74f3181`  
		Last Modified: Wed, 02 Mar 2022 13:03:19 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05efb7abcd619f57b1dfcdef273a0d731949cd6902b2e175d3ac3c640c102d91`  
		Last Modified: Wed, 02 Mar 2022 13:03:24 GMT  
		Size: 20.0 MB (19963600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:899f0821ea559b6215ac9cc99488ac88c0526239eccfe1ffe78dd8e11dc29f78
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193753585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d7ef1786d1873232177d3413deb9f90690215d8fc297ed86a5a26da9a4906f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 06:11:48 GMT
WORKDIR /opt/drupal
# Wed, 02 Mar 2022 06:12:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 02 Mar 2022 06:12:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1f0698135b0fd789e3da67e17393ec3fbbf45b05ad18bc6ed7971754e73d4d06`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:808027b358a0c80c83a77d56f4aadd63152ef6cc3eacd4de656fdc176467ea46`  
		Last Modified: Wed, 02 Mar 2022 06:42:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecb91f4fdbe2b5178a9e8d10f898a11f7dd35c591b40266e4d365514fd162009`  
		Last Modified: Wed, 02 Mar 2022 06:43:32 GMT  
		Size: 20.0 MB (19963229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:63b829267409a2891559725954db605454f90847d086586b6a9509a5698c806e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.7 MB (191689471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b37eed4287a135edfcd2742f72f9a4a2bac6dff817b2c24e3e40ad345a2db1b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 05:01:25 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Tue, 01 Mar 2022 05:01:27 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 05:02:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 05:02:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:eaeaef3ad774edb029ff81d9d1207f5b3606fa4336a6a533f1d7d0a2a3477aa4`  
		...
		Size: 575.3 KB (575348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cdb0b2d86b17a975dc5d8cfec50fbe68eccbb77b99255a097b7988968cee0e9`  
		Last Modified: Tue, 01 Mar 2022 05:38:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be18965804ff27d605a796795dc0d120fe694778d8a2f2647a2ef962cd3494eb`  
		Last Modified: Tue, 01 Mar 2022 05:39:40 GMT  
		Size: 20.0 MB (19963125 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-rc-php8.0-apache-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:e452452d195e62d224687d9af150d89baceadc486dd672b8868937636eb643e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167426960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:239d4da07268dd6bcf421de38336db9554fbd208d5fb87282e0191da3f4a4e07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 14:06:40 GMT
CMD ["apache2-foreground"]
# Tue, 01 Mar 2022 22:09:40 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Mar 2022 22:09:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Mar 2022 22:09:40 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 22:09:41 GMT
ENV DRUPAL_VERSION=10.0.0-alpha1
# Tue, 01 Mar 2022 22:09:41 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:09:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:09:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d20563e0abac297a5b91867b6473aca60038826086ffecf181631ceea56824bb`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b11711668ae91e0c9ce906be551fd002f72f613f4e5aa252b210a0f716029a4`  
		Last Modified: Tue, 01 Mar 2022 22:32:54 GMT  
		Size: 1.9 MB (1904624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba4512c4f5d1dce1f25f953355f0fe566c8117ad79c84e8c53f037c6e05a2871`  
		Last Modified: Tue, 01 Mar 2022 22:32:54 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e57b6ba588aca5b1af33430b5abdf6c19377c0800a345153a83c0b365cbaff1`  
		Last Modified: Tue, 01 Mar 2022 22:32:54 GMT  
		Size: 575.3 KB (575344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78e8c16cdc8e5efdfd16fe42c0c67efe1176db141a32a67015eba56ca6400820`  
		Last Modified: Tue, 01 Mar 2022 22:32:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b08bc0c8f5c4c664ab9016183d9fb0fe356afd6e66514b2c2d196e9e73f345b`  
		Last Modified: Tue, 01 Mar 2022 22:32:57 GMT  
		Size: 20.0 MB (19962926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
