...
```console
$ docker pull drupal@sha256:381a0669739b0e74cd8af74b5a8cdecaff7e84005abc595f29b1e41bde448970
```
...
```console
$ docker pull drupal@sha256:9564c858f3e94264860ada47ead8981e6e491869b38f15afdafb7a16522dce4f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.5 MB (151494690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79fd8d6d84dd0ba296ae7b22b4f775dcbc583d09ce047c26c025f957d1d1c605`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:28:46 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:28:47 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:29:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:29:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6386983b1fe9c60cf04e8164a50f191b7d70e92caa2703abbc19a43521de96b6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:815741e73752c636d90424061bb8e088ce4516461c972106651a96f810937cb3`  
		Last Modified: Tue, 22 Mar 2022 23:12:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dc78e7a483fe7e02b6a6ca05eef7f1ba5e9f4c4f3afd135bbdb6531443bcf51`  
		Last Modified: Tue, 22 Mar 2022 23:13:22 GMT  
...
```console
$ docker pull drupal@sha256:4cd8670af9603661d31d735314774e73dd2121f49063a10b176af52f4b6bcbb6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.4 MB (183436813 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:255c6fa77d6e4058b1fdb7bbcc633e0522396847d26af577aa65a286c8003ef9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 22 Mar 2022 22:47:35 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 22 Mar 2022 22:47:35 GMT
WORKDIR /opt/drupal
# Tue, 22 Mar 2022 22:47:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 22 Mar 2022 22:47:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:744f8e29ed27fd3ae26d1cadf9f6f27300f52145229154de99e08aed0ef7fa25`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:636eddf3bc2ce6e8aab885d48865b06253319d4458c12b78d0791bf009fb909d`  
		Last Modified: Tue, 22 Mar 2022 23:13:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d1564e968eafe65971ae587d5050a320b19e69f88720c881fb6c12c438576a7`  
		Last Modified: Tue, 22 Mar 2022 23:13:38 GMT  
