...
```console
$ docker pull drupal@sha256:7034449657c36411efe3f3bc6448491efcdbdf9664834426166530e7c70004b8
```
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; amd64
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; arm variant v6
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; 386
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; ppc64le
...
### `drupal:10.0.10-php8.2-fpm-alpine3.18` - linux; s390x
