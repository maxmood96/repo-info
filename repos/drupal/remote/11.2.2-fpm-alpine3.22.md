...
### `drupal:11.2.2-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.2.2-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; 386
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; riscv64
...
### `drupal:11.2.2-fpm-alpine3.22` - linux; s390x
