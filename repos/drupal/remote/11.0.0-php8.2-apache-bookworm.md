...
```console
$ docker pull drupal@sha256:07529d1361448577a39fe3f92f48a3e7cfc5c38a00a3ab8c1efaf8c28ba76d84
```
...
### `drupal:11.0.0-php8.2-apache-bookworm` - linux; amd64
...
### `drupal:11.0.0-php8.2-apache-bookworm` - unknown; unknown
...
### `drupal:11.0.0-php8.2-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.0.0-php8.2-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.0-php8.2-apache-bookworm` - linux; 386
...
### `drupal:11.0.0-php8.2-apache-bookworm` - linux; ppc64le
