...
```console
$ docker pull drupal@sha256:5c4fd5b98fd7d38176bd2ba2e2518c05b3511ea02b84dc5d3e373cc90fde6b55
```
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.1-php8.4-fpm-alpine3.23` - linux; s390x
