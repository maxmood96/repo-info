...
```console
$ docker pull drupal@sha256:8b2a8360dc7c4963942ef626803dad67ad94df3021ca11363700c153b5735b75
```
...
### `drupal:9.5.9-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:6dbf42eb8292a8f343fcf4497fb9554d6e8c4777581c08c4686ac956a87c3aad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.4 MB (163371036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4342e7d9677e50774b24e7d8e05aa6e9aaec4b0ef148115b5a993ebbae59598e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:02:08 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:06:02 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 22 Jun 2023 23:06:02 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:06:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:06:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2dda455d6d60979d24bfcf6d943b3b6e9ce035390063ddbdd215e2d769272b92`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ae5d9f84dfce779f78669980d582232e2e45ccfc77771153d887fea51ee5fc8`  
		Last Modified: Thu, 22 Jun 2023 23:29:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ed7059edf135c19b1cda659a286a1bb095ef38d627894286169ecb99c05e6bc`  
		Last Modified: Thu, 22 Jun 2023 23:30:06 GMT  
		Size: 22.9 MB (22878627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:40a60ee3cac946a21feae8b405d4148277897ec1c4acbde669282a05fcc26c9b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.8 MB (192845720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f2db7103247b63614c3d0e203a252737613edcaa23cf9c328690c7516742ba92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:18f12b312bb2d090a7ce204f169c1ac6597220108cc94b2316507b18eec9cffd`  
		...
		Size: 698.2 KB (698239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1c63a1e9a493239945681aca69bb6bce62d728d871297b511e1b87f877bd49b`  
		Last Modified: Fri, 23 Jun 2023 00:13:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1a34038ea46bc615f6171a405815cad01c93c3913994f7ea9637b9050848d90`  
		Last Modified: Fri, 23 Jun 2023 00:13:20 GMT  
		Size: 22.9 MB (22878589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-fpm` - linux; 386

```console
$ docker pull drupal@sha256:bbe7e4f780deb801cd0105af2d2155900c4b8f81f65fb57fa20227fefd91fbbb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197588267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c51bc0f792b8d012fac65a67f644abc6eebdf0b5ec9f88b2cf13647cf90268d9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:1f26399a1753c175a6c21772d3d95b03287b64640597fe8e8b830b6c95698744`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f16169cc6e8b7fc090a147f370ac21f99f90a47473343f7fc942fdc359051568`  
		Last Modified: Fri, 23 Jun 2023 00:16:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df6b46e9b3a69c5fc952a9a3be6fedf9b753b22d9e3295afc800f3efdd9093b7`  
		Last Modified: Fri, 23 Jun 2023 00:16:36 GMT  
		Size: 22.9 MB (22878550 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.5.9-fpm` - linux; ppc64le
...
### `drupal:9.5.9-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:0ac4f769b2143c2481baecefb4e718ee1dedc1a1a2bbe6792b98b91874800cc7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.2 MB (172167772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f148077606a0468eed317332e3925967b3c79d7c4d87884673f0a9c42a2f2b53`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 22 Jun 2023 23:48:01 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 22 Jun 2023 23:53:27 GMT
ENV DRUPAL_VERSION=9.5.9
# Thu, 22 Jun 2023 23:53:27 GMT
WORKDIR /opt/drupal
# Thu, 22 Jun 2023 23:53:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 22 Jun 2023 23:53:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:93322755e78b66bc5a25ad7faf6a8dc9b47b944b667e3d144ecee62c7cd2a770`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b11b922cb2882b29c84777ca79f5b892bf084b6f63b29049ca6749dd914fca2a`  
		Last Modified: Fri, 23 Jun 2023 00:15:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef41ff1422777b2af8fd064d3d9dd1a629d149b4a409671febd5e4e5baba059d`  
		Last Modified: Fri, 23 Jun 2023 00:15:59 GMT  
