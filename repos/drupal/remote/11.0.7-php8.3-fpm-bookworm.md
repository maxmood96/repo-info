...
```console
$ docker pull drupal@sha256:92a9a91acbb2507541ad3e61189d3788fb6d5d084cc25806d46b13fd32063eb7
```
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - linux; amd64
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - unknown; unknown
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - linux; arm variant v7
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - linux; arm64 variant v8
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - linux; ppc64le
...
### `drupal:11.0.7-php8.3-fpm-bookworm` - linux; s390x
