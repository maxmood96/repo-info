...
```console
$ docker pull drupal@sha256:7a9a40f2052b0857d8fedf29af576f00ddbf9e6d00caa5937b6d5418d294e379
```
...
```console
$ docker pull drupal@sha256:ff13c4a2cb36d7ff852e7bfadb5eb1e8ea8ca718b65ee9147e283e9a54652a3c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.3 MB (187262230 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c84447211b3cf4712199843defd487020b81b75bea8fd94ac89f14a51b6b35b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:47:51 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:48:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:48:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:67f3d16dfe06efe07318681b8147e3568bf891bd0d9e06eba7fe4d9d661b3a33`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:351f7b80a38eb9ad49545aff481a0650570dfc8ad3f17c7b708d378a6bcad871`  
		Last Modified: Fri, 29 Jul 2022 02:20:02 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:610dd90be6fb8f0d82c7f544b50f13ffde1967cdbf21e9c86763f40f5c0c5feb`  
		Last Modified: Fri, 29 Jul 2022 02:20:07 GMT  
		Size: 21.2 MB (21225252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
