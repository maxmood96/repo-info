...
```console
$ docker pull drupal@sha256:b5549e2ab13c2377dbd1900f5055839dd0dd506e890b1b539068f50c278b4188
```
...
### `drupal:9.3.20-php8.1-fpm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d28704593015a773bf9d44d597527255c29c5924a29ec9a472dc63e9dbe48ff5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155286213 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7baf4e1c6a70040f17fdafdb8a2a76475430afe90d22ec438821a2419fad4ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:01:31 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:24:12 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:24:12 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:24:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:24:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9aac1c07aed68729a0a44b2aa4a48045177b2896f6cb6283856f9031d6a8db73`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2f802e725f37ca3b52408fe43f58def7239e9d3f6843df26e4e3ca19b27571a`  
		Last Modified: Thu, 04 Aug 2022 10:11:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1743ea3a7ced134a3192696f194f4580015279de1f10e19a242a7f18986c6039`  
		Last Modified: Thu, 04 Aug 2022 10:11:45 GMT  
		Size: 21.2 MB (21222935 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php8.1-fpm` - linux; arm64 variant v8
...
### `drupal:9.3.20-php8.1-fpm` - linux; 386
...
### `drupal:9.3.20-php8.1-fpm` - linux; ppc64le
...
### `drupal:9.3.20-php8.1-fpm` - linux; s390x
