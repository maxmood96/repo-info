...
```console
$ docker pull drupal@sha256:c0ae7345c308a05240e22ff98643d968ebf8cffe6a603ffad0a43641e935848d
```
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; amd64
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; arm variant v6
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; arm variant v7
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; 386
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; ppc64le
...
### `drupal:8.9.4-fpm-alpine3.12` - linux; s390x
