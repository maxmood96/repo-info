...
```console
$ docker pull drupal@sha256:c4907319e9c3ccd16772b447307105339752aeb243c68f159390150912781e12
```
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; amd64
...
### `drupal:10.3.3-php8.3-fpm-alpine` - unknown; unknown
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; arm variant v6
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; arm variant v7
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; 386
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; ppc64le
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; riscv64
...
### `drupal:10.3.3-php8.3-fpm-alpine` - linux; s390x
