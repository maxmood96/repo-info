...
```console
$ docker pull drupal@sha256:c7b0b45c555b9ad4e5b896f92068f6db03dcde4a212c996ee8e4172ba52d5260
```
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; amd64
...
### `drupal:11.3.0-php8.4-fpm-trixie` - unknown; unknown
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; arm variant v7
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; arm64 variant v8
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; 386
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; ppc64le
...
### `drupal:11.3.0-php8.4-fpm-trixie` - linux; s390x
