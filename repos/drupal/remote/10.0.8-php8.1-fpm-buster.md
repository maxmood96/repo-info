...
```console
$ docker pull drupal@sha256:f4040f693d210d5851e577bca711c72843c6b8ba2f218079b8d01aa3155da5af
```
...
### `drupal:10.0.8-php8.1-fpm-buster` - linux; amd64
...
### `drupal:10.0.8-php8.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.8-php8.1-fpm-buster` - linux; 386
