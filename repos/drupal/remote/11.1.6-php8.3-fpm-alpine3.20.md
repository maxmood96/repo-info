...
```console
$ docker pull drupal@sha256:720fdeebe5adeaacd533cf686330f3facd117344c7e162539fbc293adb9271b1
```
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; amd64
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - unknown; unknown
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; arm variant v6
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; arm variant v7
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; 386
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; ppc64le
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; riscv64
...
### `drupal:11.1.6-php8.3-fpm-alpine3.20` - linux; s390x
