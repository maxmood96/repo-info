...
```console
$ docker pull drupal@sha256:b2cf8e591a1fec5079fa48af801570caa35cf67d3957167c74618a34c9eb2b0f
```
...
```console
$ docker pull drupal@sha256:97d77b47893a8c7ea63c8e87c81bae0be482b2ebcccc70a6fe1563cf46d80706
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.8 MB (54846528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa86d10b9d88bd1c8213b0573f947c89de17d94db5b0eb87d97c63e7effe1ec7`
...
# Tue, 01 Dec 2020 23:33:15 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:33:15 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:33:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:33:38 GMT
...
-	Layers:
	...
	-	`sha256:8f8ee531c0640bf27b0f041743c1b6fb81e3de770ed6808953063ed4383f1e8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7883fa9b1e8af6766c31e5542eec37f6ea8b1599a87cd2ca4abfe8165a6175af`  
		Last Modified: Tue, 01 Dec 2020 23:37:17 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:258d7667832d5f98a9e4850c2fc93bbf5f2ce2a74593c1cc40d99888990ceb98`  
		Last Modified: Tue, 01 Dec 2020 23:37:23 GMT  
		Size: 20.5 MB (20547557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:29e9582ec2a3c2c0177ba46a55e64f54e35545586f3d3520a1bd5df45f7dc48e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.6 MB (54567878 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96aa4a6d89687aa611ac936d7471ad8c97bf6200ebca02c75b8d8bc7c2675f24`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:49:05 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:49:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:49:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec99477cfdf9b048d40506a02e3fdff44ed8017a9bc708098b06e5f66135e0b8`  
		...
		Size: 508.3 KB (508274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78a67753637e316be63718de2d3cbe0a552288ca8b88ec4e9cb62b7c83475461`  
		Last Modified: Tue, 01 Dec 2020 23:54:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aabc6f65f473dc96ffc8fdd4cd106f638647b7a1a401b76b2c8d8b650311de9`  
		Last Modified: Tue, 01 Dec 2020 23:54:33 GMT  
		Size: 20.5 MB (20547802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cee00977165809ae5a29d89a41405be30f89bcc3458e5bbc5eb677393f0cea9b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.0 MB (55983878 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8c6da0434b66295803862190a9e5e7573ec9ca2986d649d6c69ae291c899403`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:38:39 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:38:46 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:39:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:40:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f67c711d1bd50e02133409727ee81e1d2e7b1451a39b817ea6fe7689ee5a5f59`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e35ec9a55f634b93d009f59f5ddc3b9d98f65a6932fa5b6272b42eab9785d06`  
		Last Modified: Wed, 02 Dec 2020 00:02:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3264481462186762ca83e4b0ea9372bc643f1b1529770a2e75b13417fb6d3f1a`  
		Last Modified: Wed, 02 Dec 2020 00:03:31 GMT  
		Size: 20.5 MB (20547809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; s390x

```console
$ docker pull drupal@sha256:2234584c423507350ed117661c896f271d2aa3df35b743a9d738c331769f01ca
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53782266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:317e207394a9b7da52a9b5422818d1ee767eb4937788103644cfe70ed1a4ac66`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 05:24:27 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 23:49:12 GMT
ENV DRUPAL_VERSION=8.8.12
# Tue, 01 Dec 2020 23:49:12 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 23:49:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 23:49:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae2e4537b6564a9ba62667b244ea0035c08ef627b249334c692d50e631cbf69a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a8dff32346da1cabe17ccf5c59add3d76f0af913e90c5b8873be4a9bd045d94`  
		Last Modified: Tue, 01 Dec 2020 23:52:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf860bb43d947c7450701bae863dbea974ab6c25eef4236d714bb9fb6bd2eca8`  
		Last Modified: Tue, 01 Dec 2020 23:53:00 GMT  
		Size: 20.5 MB (20547601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
