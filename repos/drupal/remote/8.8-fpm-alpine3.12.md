...
```console
$ docker pull drupal@sha256:a6981ad64c8fdc436d6f3d958df685e6a53dd948f6a0c3d90d5d1ff7d1831793
```
...
-	Layers:
	...
	-	`sha256:63fa1ed9050e26e68ba7dd7581889c6294a006a326554291fcd1f1dc1c4fb064`  
		Last Modified: Fri, 02 Oct 2020 03:08:01 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
# Thu, 01 Oct 2020 21:59:34 GMT
WORKDIR /opt/drupal
# Thu, 01 Oct 2020 21:59:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Oct 2020 21:59:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:55d7fd4aeb08239d0791f7fd900505903416b1076b3c085c91ea8f8735ecf154`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:802b031af872cd1fa3e3f9220608d81db38bf6eb330e1eb1f25c4128794e966c`  
		Last Modified: Thu, 01 Oct 2020 22:04:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b6c7a3ce68b63be1bda0c2d11894de58340fc07322250af42dcdcea89e8c300`  
		Last Modified: Thu, 01 Oct 2020 22:04:41 GMT  
		Size: 20.5 MB (20538257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
