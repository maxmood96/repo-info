...
```console
$ docker pull drupal@sha256:f234fd889c311aa1856f3b56cca8ad7a0c775f2e844ce3d2db132eac6a1f6c34
```
...
```console
$ docker pull drupal@sha256:ddac3f03542e0b8c30b0edf02e24b143a837330a2e5fd9d3fb5e22775da9b1ae
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.8 MB (54802291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1533bdec114e23c9db6dc9f085cb3854dcefb1f79b60441aa13f0d40cfa2d291`
...
# Fri, 04 Sep 2020 20:23:37 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:23:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:23:59 GMT
...
-	Layers:
	...
	-	`sha256:1f28d6b10e8d69c947528651e0493599a6738f0b7abe73e2c1ff56e3a1c614d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39c972b54a89b723c83f1ee9881e1c0be3ceee234b58e702d4ee2409879cf264`  
		Last Modified: Fri, 04 Sep 2020 20:26:23 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a3f1d134f93a998c1a0ab46f32bdf21ced65060d2d238ef2944a0da3e2a9159`  
		Last Modified: Fri, 04 Sep 2020 20:26:37 GMT  
		Size: 20.5 MB (20536940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
