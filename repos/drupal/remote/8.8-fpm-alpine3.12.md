...
```console
$ docker pull drupal@sha256:dcdc3bd663860ec02dbcd682cbc0606f3cca216b9e9e7631d401b823175b6c70
```
...
```console
$ docker pull drupal@sha256:dac7eaa3ecfeef89f4a7a75a30009b01e067b3b2a28295f4aa13c83d3d6c8723
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53230823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf663f5390d0b858198d35f207e81dd39dd0c5c7d9c8e5261affb13cf018f025`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Sep 2020 20:51:54 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 20:52:00 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:53:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:53:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5699a6d9f692ec530fd901fca7e775124ecfe3e8b152af24ed70bf0a019d97b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13c50975870215ce50c4b902fb6db622c88d3eb79d6b8b5be1030ca5eee470af`  
		Last Modified: Fri, 04 Sep 2020 20:54:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5cedc5c5635389d9ca968995e3b7c46bca493d4edb11fe5887710c0bf15b64b`  
		Last Modified: Fri, 04 Sep 2020 20:54:35 GMT  
		Size: 20.5 MB (20537536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; arm variant v7

```console
$ docker pull drupal@sha256:599f1a0e1790e47a9bffa5dd1335bb8f9c8c931860f735d3e747e25fc9b017fa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (51966520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df0b13bd3f9d1e8cfb420f380fafd2559088f2f4b5383afe670ef667f2e9261a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 21:07:50 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 21:07:58 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 21:09:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 21:09:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:146782d6ed636b4ffaa6874e0438efa0261fcb4522dcd95562dd7451aa2bb8b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f71482bfd9c4864f6ba8e5c174d695ba633fb3107a883ec9dd9a55ff36f91b5`  
		Last Modified: Fri, 04 Sep 2020 21:13:41 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6caca515d841d1e33ea6694ebbc5bfb859cb9d28cc3bf8b0fbfddee4e9cbf8d6`  
		Last Modified: Fri, 04 Sep 2020 21:13:53 GMT  
		Size: 20.5 MB (20537450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:16477129e27d703046913eb61eb4ac1fb69e00bd59ee0a203f078a6580519823
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.5 MB (54523333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:841d521d1081a7ecd6aff4950db17e743242a6bd553deceb3a80c118cc555fb8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 20:43:49 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 20:43:50 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:44:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:44:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:49f359495e2482654664cbc77d38d63bbd301554a34dbe6d85188f0cdeac3a00`  
		...
		Size: 508.8 KB (508759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:262e9e2b213af16944e97762a10a6b99536e11a0e0bf66bc7d807ec57aa48ff5`  
		Last Modified: Fri, 04 Sep 2020 20:47:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7345bf718bddceee4c81ef9546bd4491f71606e56117c0de0661224bbbafed47`  
		Last Modified: Fri, 04 Sep 2020 20:47:31 GMT  
		Size: 20.5 MB (20537254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; 386

```console
$ docker pull drupal@sha256:7bc3b82f9d710700e8910d1a5b9b1a21a3d2e6b655a62d2c1133e7158a3d7596
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.4 MB (55440976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9f04ec10b3bf8f08d111db25ac813d904e4d54becac5d3565d8263fe2497ad0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Sep 2020 23:42:33 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 20:40:57 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 20:40:57 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:41:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:41:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b055fec92df9728c5858d50f79c5931305016bab6588cb0f67738039f71b7aa5`  
		...
		Size: 508.8 KB (508761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:804dca311b6963074eb3e21cd0cff810c4a57a0f0462e04d5f31cee50dd04b72`  
		Last Modified: Fri, 04 Sep 2020 20:43:19 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dddb6120638d41951e5337fd57945432e1128981597a638621b0fdace84ac70c`  
		Last Modified: Fri, 04 Sep 2020 20:43:27 GMT  
		Size: 20.5 MB (20536993 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; ppc64le

```console
$ docker pull drupal@sha256:8d27feb7bd338749b928444f952f22339f30a87198627e24ae1cd669aaf3ef2e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.9 MB (55939624 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81c5b18dd3c7d8e589f7dcdf31722cdc7a3b65aee11f2061af8c43d95cd95e06`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 20:25:57 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 20:25:59 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:26:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:27:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b25e64c19bff4d7a21f8fe844b03b6b69a024ab309b84fc2a67c19f1ad3758c3`  
		...
		Size: 508.8 KB (508761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b87aa6fb682c5eec95920585074a97ce0ce264d0d56a157c13a846f951d9c90`  
		Last Modified: Fri, 04 Sep 2020 20:31:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24ad5c2a864fe7f18e865456bb3d30e413eabaf515a168f9bd5322e343b434b3`  
		Last Modified: Fri, 04 Sep 2020 20:31:51 GMT  
		Size: 20.5 MB (20537171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; s390x

```console
$ docker pull drupal@sha256:13ce37ea807b014d8e6d083b2c8425d899e0123095210cc6aa52b5dcc04e035e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.7 MB (53746065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3e55c9914db9fc4995d7a077b866615960523c8f0e7615a6fa6219fafad16c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Sep 2020 20:46:36 GMT
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 20:46:57 GMT
ENV DRUPAL_VERSION=8.8.9
# Fri, 04 Sep 2020 20:46:57 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 20:47:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 20:47:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0b3ee62b939d194e56b6d9337a403e9556caa1d48d08083a8c7548144dab55ee`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:541cdca446479d2a1cc50f276c2e78357decf3248c56eedeff4c981e3480d769`  
		Last Modified: Fri, 04 Sep 2020 20:49:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77733dea937542c1b0059fa50f8833985a4ac71e47b20fc042af6eac5df21aa7`  
		Last Modified: Fri, 04 Sep 2020 20:49:56 GMT  
		Size: 20.5 MB (20537405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
