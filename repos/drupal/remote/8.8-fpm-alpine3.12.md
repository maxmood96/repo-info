...
```console
$ docker pull drupal@sha256:d625c5a78b93ad65f409af17ba281456a992649c84219b40f622cfbd7f8ee27b
```
...
```console
$ docker pull drupal@sha256:6c63afd8505270d57529d79ceab29ad0c538a50848ba9742474b2679c11b4d44
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (51964229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:742b1976ad477c9939f16c23debe91d1a2471390870e527eeef40aa9201cea13`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:a176a99b1a24c5f623be8e0b78cacefbcc455772227c7fa8eb37ab4513e950d0 in /usr/local/bin/ 
# Fri, 04 Sep 2020 00:09:03 GMT
ENV DRUPAL_VERSION=8.8.8
# Fri, 04 Sep 2020 00:09:10 GMT
WORKDIR /opt/drupal
# Fri, 04 Sep 2020 00:10:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 04 Sep 2020 00:10:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:146782d6ed636b4ffaa6874e0438efa0261fcb4522dcd95562dd7451aa2bb8b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33591678eeafc25c4bbe4298d475a36058abeba74a1b71703e323604c0316294`  
		Last Modified: Fri, 04 Sep 2020 00:19:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:258cfb1d4ffd94361769ffae9c2a910cbf3696f25fc8ccf33abba08151afe5f8`  
		Last Modified: Fri, 04 Sep 2020 00:19:58 GMT  
		Size: 20.5 MB (20535157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
