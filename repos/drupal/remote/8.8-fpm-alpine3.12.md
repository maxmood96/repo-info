...
```console
$ docker pull drupal@sha256:d8296b1070ba3412d1a01917db68f9f605b6b5e804b8df6e3d7a92fafc3d21cc
```
...
```console
$ docker pull drupal@sha256:772794e3393fe3450e0ee3e3b79e46e1f9e747d7b4afd814a7c82b3897a9d909
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.8 MB (54842464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3286e335c2c0a2482677db0c3a3a6020829009d4c1c91c0408ba15010cc1300f`
...
# Tue, 01 Dec 2020 07:57:21 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 07:57:21 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 07:57:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 07:57:44 GMT
...
-	Layers:
	...
	-	`sha256:8f8ee531c0640bf27b0f041743c1b6fb81e3de770ed6808953063ed4383f1e8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f75e8d8520583f7d2d32dd26e3b074932dd3d8cf34a3e06eeca3fb8e468fa10a`  
		Last Modified: Tue, 01 Dec 2020 08:01:17 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b55ea2ca6e2aac4a67ba8809c20731f50abf6ecbe37fd139ad83547b6feadf3c`  
		Last Modified: Tue, 01 Dec 2020 08:01:25 GMT  
		Size: 20.5 MB (20543494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; arm variant v6

```console
$ docker pull drupal@sha256:8802ea4ba01838b77397a87fbe66667fef06d6c17c75c8190e5146fbf5e7b813
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53266151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3e48be1c44d27b494121d03211eb9c2e2401609ce54307f3d779737a56f4310d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 03:17:35 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 03:18:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 03:18:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:212d1987876be405afdbc501d3fea293b1c6a9d0c75ab2dd6c4f085aab031749`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4406147085e4cb84e73e95db62128befee34c09a17b8d134ee3afb0edbd0df2`  
		Last Modified: Tue, 01 Dec 2020 03:19:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f00049a62cec18972aca8cc690ed4b2bb3f0a9a00e16d5dc61c7504775fa0c5e`  
		Last Modified: Tue, 01 Dec 2020 03:20:09 GMT  
		Size: 20.5 MB (20543853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; arm variant v7

```console
$ docker pull drupal@sha256:570bb87a73bf107b77cfc1dfd2f9483a83b9390e8eec1a5849c461f7280d40e4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (52002670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68afba5647eeaaaa0efa3d25bf42216928f35cc9a01e6d54a1e0edaf86e46c01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 05:22:11 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:28:31 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:28:33 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:29:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:29:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2088ac0b0da02b16ad6a51493296088606edbab6d2e5cc1271a7e9f465453cea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a9ee781c8cda01b4738d06307cdb25a06ca3b5baa27054f9a852f973acd25ff`  
		Last Modified: Tue, 01 Dec 2020 05:34:40 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82026abc34bd19e6c5efa8552261410020bc1606f64e8b1f0a45109c385c53f0`  
		Last Modified: Tue, 01 Dec 2020 05:34:52 GMT  
		Size: 20.5 MB (20544420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d7677f2c07535ab62d818f394052839a51cfef63972177dd0cfda70707a6ef5a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.6 MB (54564126 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f8256fcb1126b5f6ea9f40dc7808f2eb87ab3e0d8813cefacdcdd426b399d98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:31:35 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:31:36 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:32:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:32:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ec99477cfdf9b048d40506a02e3fdff44ed8017a9bc708098b06e5f66135e0b8`  
		...
		Size: 508.3 KB (508274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03b748d81bad50af103e4b0b1bb722a070083403c60c13bd5f103be2a98ef965`  
		Last Modified: Tue, 01 Dec 2020 05:37:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa24fce624d3f9bf4e746635164f014d702f208ddd6cfbd060a0555d6724619b`  
		Last Modified: Tue, 01 Dec 2020 05:37:21 GMT  
		Size: 20.5 MB (20544050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; 386

```console
$ docker pull drupal@sha256:1e8c24ac490891e995abacecf44802e2f1f5c35fb64ea03ae837eed349f4f227
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.5 MB (55457215 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2815f781a86d5fa13581903d5b4d345837e6590f4a8edeb04e3040d8ea4c38a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 09:15:50 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 09:18:49 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 09:18:49 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 09:19:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 09:19:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:af68f5335f04b4d44b194b510ef138ae33f6a719504b7424c8913ec48729f66a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2c0b4d7515e8eaaf86800d0410dc4f5629b326e6391b1e2aca2baa8ebdd76d0`  
		Last Modified: Tue, 01 Dec 2020 09:23:40 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3674bce3f57ffbf6eb8dd1a20ec2077f2b300d544d566038fc41206980d5918b`  
		Last Modified: Tue, 01 Dec 2020 09:23:50 GMT  
		Size: 20.5 MB (20542744 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; ppc64le

```console
$ docker pull drupal@sha256:bc244116f31b32233f1a27c4683a1897926e8d6da5ff5c185af1f0f85affeb5c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.0 MB (55980063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:531155b8cf51503569fbc9c9188634e9af53d5b302487b5398f23e4a3b16350d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 07:36:27 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 07:36:33 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 07:38:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 07:38:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f67c711d1bd50e02133409727ee81e1d2e7b1451a39b817ea6fe7689ee5a5f59`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8fe0da3ec0bddac8cb56aed365584ff6c91fc2bbc8d3dfecf2ac56f41108114`  
		Last Modified: Tue, 01 Dec 2020 07:59:07 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98d809b7440020fc5809795d60c5daae392427d5c2e5238a1a12a7823b566fe2`  
		Last Modified: Tue, 01 Dec 2020 08:00:49 GMT  
		Size: 20.5 MB (20543994 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8-fpm-alpine3.12` - linux; s390x

```console
$ docker pull drupal@sha256:5e8f650b9a9217ee203062bb52f108d98dbb2031a1ecde2d82c320adeb3fb10d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.8 MB (53778365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f37bd20356e1936c48ccc443d0abc405762968a052faf1e5cdeb7b9991639d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 05:24:27 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Tue, 01 Dec 2020 05:28:07 GMT
ENV DRUPAL_VERSION=8.8.11
# Tue, 01 Dec 2020 05:28:07 GMT
WORKDIR /opt/drupal
# Tue, 01 Dec 2020 05:28:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Dec 2020 05:28:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ae2e4537b6564a9ba62667b244ea0035c08ef627b249334c692d50e631cbf69a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b087087f20abdecb36153f9aa064a8947cbbfd31d30f0100d7496e162b0bdf`  
		Last Modified: Tue, 01 Dec 2020 05:31:48 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:073278bd25cc5e52f38f42134d6fc927ba4dc57f75fee27a5422e6ab80c8de34`  
		Last Modified: Tue, 01 Dec 2020 05:31:53 GMT  
		Size: 20.5 MB (20543703 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
