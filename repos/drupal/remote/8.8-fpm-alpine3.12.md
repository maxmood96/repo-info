...
```console
$ docker pull drupal@sha256:e03e9e3c135aa555f5fbac8a198206fbbb9ad004e1998c41a82bec4749f78615
```
...
```console
$ docker pull drupal@sha256:a3517d4d0851687b4162a0c54bc71205d4fc8a2524fe3d0ce4c4f18016f89acd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.8 MB (52844673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3ed9e707a8b348cb0cf2d019c36297c3836d4a09a6b0984b8bd74afdd3b173d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 27 Oct 2020 00:56:45 GMT
COPY file:c8e42714fc3b6e908b21339a71bfc5f3458ba771c7e8a3e007d1b173532671b4 in /usr/local/bin/ 
# Tue, 27 Oct 2020 00:58:43 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 27 Oct 2020 00:58:45 GMT
WORKDIR /opt/drupal
# Tue, 27 Oct 2020 00:59:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 27 Oct 2020 00:59:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:29f2d5efe5b3834f1e9557f70188ea906938f9139ef0fab9a652408f54af1608`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f118ba69394f2776c907950de26d85629b7365d791e4d2ad069ac2b168a57295`  
		Last Modified: Tue, 27 Oct 2020 01:00:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad3170efc6b304b8ef318529aa7c55c65e99370f9afa1c31168c6be5e8be7978`  
		Last Modified: Tue, 27 Oct 2020 01:01:09 GMT  
		Size: 20.5 MB (20538092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
