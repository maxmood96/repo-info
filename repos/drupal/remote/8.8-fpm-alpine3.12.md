...
```console
$ docker pull drupal@sha256:9368fadfba1dae04514aae3752c4d03bda87e646f73014195a0fde2398a3466f
```
...
```console
$ docker pull drupal@sha256:458d6d8d5042b1208c6677f23594d46f3fb8078d90fba7520b69ffc5c1d232d0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.6 MB (55556298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b7c7b87a58fbdf6d599be21096d33e8ab5e0135258216daa4c21e41dfa5486b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:c8e42714fc3b6e908b21339a71bfc5f3458ba771c7e8a3e007d1b173532671b4 in /usr/local/bin/ 
# Tue, 27 Oct 2020 05:14:41 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 27 Oct 2020 05:14:44 GMT
WORKDIR /opt/drupal
# Tue, 27 Oct 2020 05:15:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 27 Oct 2020 05:15:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e48eae82bc4a76c78e1ef6d5df406e9c64c573f2d969f9b29cd01a99f02f9e80`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b16290549f2cc839fb4dec35507abdff3b2293773447fdbd4c5d5434d38d9c33`  
		Last Modified: Tue, 27 Oct 2020 05:32:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe3fa6dfde5e7226aa602e00c73dc65ad47181f25ebe5e390991b4beac416a97`  
		Last Modified: Tue, 27 Oct 2020 05:32:59 GMT  
		Size: 20.5 MB (20538287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
