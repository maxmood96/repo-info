...
```console
$ docker pull drupal@sha256:1b9f722875c616f30c2d374b6bfad417f43f935711a3a291ea76311219cfa964
```
...
### `drupal:11.2.1-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.2.1-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.2.1-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.2.1-fpm-alpine3.21` - linux; s390x
