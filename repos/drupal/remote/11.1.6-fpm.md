...
```console
$ docker pull drupal@sha256:625b3e6e0e221687b24b64bba64f9040142d8516ac818100d971020c9ecfc05b
```
...
### `drupal:11.1.6-fpm` - unknown; unknown
...
### `drupal:11.1.6-fpm` - linux; arm variant v7
...
### `drupal:11.1.6-fpm` - linux; ppc64le
