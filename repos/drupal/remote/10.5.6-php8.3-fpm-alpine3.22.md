...
```console
$ docker pull drupal@sha256:99057f5d5c3db23c40fa4ae596119e79b0e191bfab38acf7c0bf95bb056f0506
```
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; amd64
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - unknown; unknown
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; 386
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; riscv64
...
### `drupal:10.5.6-php8.3-fpm-alpine3.22` - linux; s390x
