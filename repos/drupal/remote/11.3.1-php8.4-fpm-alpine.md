...
```console
$ docker pull drupal@sha256:b9b79e21f352d61c5afdcbafa29084f82f45a5590d2b9439fa1e159599a4c44b
```
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; amd64
...
### `drupal:11.3.1-php8.4-fpm-alpine` - unknown; unknown
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; arm variant v7
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; 386
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; ppc64le
...
### `drupal:11.3.1-php8.4-fpm-alpine` - linux; s390x
