...
```console
$ docker pull drupal@sha256:3552710951d1bbd1de06e356de180592b7aa6fa6f408357fbc586dc42adff996
```
...
```console
$ docker pull drupal@sha256:6db9b8a59562cf87fd0cdfd9801e288adcdc341ce906f1e8ea017e159adf3546
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.6 MB (63640749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bb4d4e7ab9eb848d7797ad7853b12c6a1ee31ea4f8b445bbef0319c6330d332`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Apr 2026 00:24:18 GMT
CMD ["php-fpm"]
# Tue, 14 Apr 2026 18:59:47 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps # buildkit
# Tue, 14 Apr 2026 18:59:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Tue, 14 Apr 2026 18:59:48 GMT
COPY /usr/bin/composer /usr/local/bin/ # buildkit
# Tue, 14 Apr 2026 18:59:48 GMT
...
-	Layers:
	...
	-	`sha256:bb98ac7534f9de8fd7a9a8f2458f8ffda4a0509930561f15132a351b3a973c1c`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:90c5f5940b3700314c7a472b2e06adbf71cec04722934ff4696e7749e85014fe`  
		Last Modified: Tue, 14 Apr 2026 19:00:13 GMT  
		Size: 2.1 MB (2053501 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:01338a48a469cb88d96efc1d1373ffae54f3c87965583b48f4032e2d3e6ea04c`  
		Last Modified: Tue, 14 Apr 2026 19:00:13 GMT  
		Size: 313.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b72e60ba45a6a57542a85aba993df6dc023406494727bd0cac48196f8a200e74`  
		Last Modified: Tue, 14 Apr 2026 19:00:13 GMT  
		Size: 790.8 KB (790764 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c9e80c7e87335e937534a8a9fadcc4641979aaef12f37d58673eb4f0016db830`  
		Last Modified: Tue, 14 Apr 2026 19:00:13 GMT  
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5f881a9f88932e1a7a27c18b86957281b8ac537be764f3097be8016af3527851`  
		Last Modified: Tue, 14 Apr 2026 19:00:15 GMT  
		Size: 21.7 MB (21730710 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.4-fpm-alpine3.22` - unknown; unknown

```console
$ docker pull drupal@sha256:1bf41f410d5ed35033873a744ba4fad166c6b4720281c9e8a563ea8a42c73a09
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **404.1 KB (404114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab01d44b7d49ef557d3eb44fe2641b81b2c9be0ec26002c64178d2cda7cbcc88`

```dockerfile
```

-	Layers:
	-	`sha256:2ccb586b50b71f7f983ab3531d3db66c786de4e86e3c07a06914908bee69bee2`  
		Last Modified: Tue, 14 Apr 2026 19:00:08 GMT  
		Size: 371.0 KB (370953 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:23307e0970af9f854d8d1c5dd68612a7779adb74def120dbc5d29968a2f68dcf`  
		Last Modified: Tue, 14 Apr 2026 19:00:08 GMT  
...
```console
$ docker pull drupal@sha256:b3b54e7c068fd3cdddc437e449d90e5f5255cceeffcf65f32817213c5b252ca9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.3 MB (63301208 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58ac5b77938d61e31b77682b3ea778070e4d364350894a85892f0c38df5ad624`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:84b9a9ce1c98443c29546be613f9d477a97e6f2a88a0a24e3fd7f61223da558a`  
		...
		Size: 115.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0320887ef866f98055f5452178ae60263f9e4cede5c79b942526eabe4004eb15`  
		Last Modified: Tue, 14 Apr 2026 19:07:19 GMT  
		Size: 21.7 MB (21730453 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.5-php8.4-fpm-alpine3.22` - unknown; unknown

```console
$ docker pull drupal@sha256:c22434c5a47f6d23b46458adffad80d1f88e85cdf487749c689caec0a55bd519
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **399.2 KB (399242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b218544ad5e97e40018adb844db3ce8c0087dcb1548a19e3475a712284c386d6`

```dockerfile
```

-	Layers:
	-	`sha256:c9fc11705bdc7862671cc07433687adcb2bf7c5d4c88644f885852ae31f195b2`  
		Last Modified: Tue, 14 Apr 2026 19:07:18 GMT  
		Size: 366.0 KB (366037 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:b9c2ca30a4f4e657f1655a74ce607e6e4916183421ec32be659f98218f67cd4f`  
		Last Modified: Tue, 14 Apr 2026 19:07:18 GMT  
