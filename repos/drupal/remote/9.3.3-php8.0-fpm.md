...
```console
$ docker pull drupal@sha256:4583e4bfef9336c7bfa730cf87bf267eac0445c5aaec0a5de90a1b1143ce150c
```
...
```console
$ docker pull drupal@sha256:34cc5fe2567328777c7dc861acb2cb080edc185bfb29ea77ef3e2040b8d7fc02
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.9 MB (178934078 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b48dc44df25e70112eed079157ed31665fae2aeb951618d140a46b4ceddc70a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 24 Jan 2022 19:57:18 GMT
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 19:57:18 GMT
ENV DRUPAL_VERSION=9.3.3
# Mon, 24 Jan 2022 19:57:19 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 19:57:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 19:57:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:de99d0f4e83df7cbb839ab4aedc20009887aef51cfdce7380b512cbbc9688b40`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df1481d8f7881d4edd9aab17ec4b6b7771d49b43488ddc7be49b34d3bd766f48`  
		Last Modified: Mon, 24 Jan 2022 20:18:31 GMT  
		Size: 574.6 KB (574580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be8bd50e6dddcde82f32e0b6f911763ea4a72324ca6c13140897a3a975ad012d`  
		Last Modified: Mon, 24 Jan 2022 20:18:31 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a900ae25345e3a311f9d091c6765bd503d62c0958774a2eb82e5ce323123ea8`  
		Last Modified: Mon, 24 Jan 2022 20:18:36 GMT  
		Size: 20.1 MB (20149214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d7434c86283ef2654eceff42888ea940bd43e63f75f005b70ca63e29731eaa5e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.3 MB (163334120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:288c481d675d219effbc3ce3aaa390317a8df21d4a2d7f7f98c5c91c4c78b594`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 20 Jan 2022 21:00:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 24 Jan 2022 19:58:53 GMT
COPY file:3713581496added9c148c20084b87b399428028bf2a1d7bf85f3574a00a0b8f3 in /usr/local/bin/ 
# Mon, 24 Jan 2022 19:58:53 GMT
ENV DRUPAL_VERSION=9.3.3
# Mon, 24 Jan 2022 19:58:53 GMT
WORKDIR /opt/drupal
# Mon, 24 Jan 2022 19:59:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 24 Jan 2022 19:59:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9eb10a9a53532aa6a757df6c074357ff847be2d3dc48769f070671e2214d732d`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e78408bd7d814e38c15cc41e19b75de648e3f0462fceb66ddf53ca01b50d3c94`  
		Last Modified: Mon, 24 Jan 2022 20:17:50 GMT  
		Size: 574.6 KB (574581 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ed19f1add40cc7a3c724769e383f980b1c87dfec78383a95db8cbc98626c3e1`  
		Last Modified: Mon, 24 Jan 2022 20:17:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9538478f97653ea26b5cbb225ebdda3be4977dbf6ec8d269c1946ab653c4c38e`  
		Last Modified: Mon, 24 Jan 2022 20:17:54 GMT  
		Size: 20.1 MB (20146295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
