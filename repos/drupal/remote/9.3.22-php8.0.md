...
```console
$ docker pull drupal@sha256:dbadd5a00e0733278ea02d851ad8ca5599f150f6cd3cc2256b87886f03eec6db
```
...
```console
$ docker pull drupal@sha256:cf7a403ebfcfee3a0bdcbb8892577c95eab97e5ef2a2ecedced8b465ca385e93
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158104202 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f5621e027cd9e5f1b4ed854f490e7ce6a7c06dfc8c458c35abc6714cc71d844`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 06 Dec 2022 14:28:36 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 14:28:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 14:28:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a2b2262afdb290812e995ad1d16c35d99a72b93fe48d08c2e85c31deb54dd063`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eca827cac56de389987759c15363ab3b9fd6bde33f0ceadb5713dfc81b57b2d`  
		Last Modified: Tue, 06 Dec 2022 14:54:08 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4e77a9a4db22369ff2a05e47c39aef69a990615d237366a5c2ffbd4fc11fd03`  
		Last Modified: Tue, 06 Dec 2022 14:54:16 GMT  
...
```console
$ docker pull drupal@sha256:4b9b1a652ff6e7a0ccfbb1a92ee981e0dfa20781b9efeae2607bf915bf963e86
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181562392 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:074c95a6e069f36e8c96f4e287c726ac1507db6395da1e0fc5ac150987144bf2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 06 Dec 2022 18:13:19 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 18:18:09 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 18:18:09 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 18:18:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 18:18:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d6bb6a1f97d2072fc472c614424b57b8a49bb9e7adcabd75f9eda2d11bfdb9e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780cf8133e4acb5f8ea69dd8a30f28cfea46c07440fe6e00004466056f71b8ef`  
		Last Modified: Tue, 06 Dec 2022 18:32:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65cccf7b6c650be03b3ad7e27aa7477d8db2a018cd77c319b94fe7a21310242c`  
		Last Modified: Tue, 06 Dec 2022 18:32:42 GMT  
		Size: 21.3 MB (21324445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0` - linux; 386

```console
$ docker pull drupal@sha256:8e40e261684e6beceaf06b6928bcf35a9bdd237a954ab1b05da13c3939b204f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.6 MB (190562972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eff7e0ba2c446b826edeb6511f6b34fd65c954a23025a329219612c3d1f8123f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 17:21:29 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 17:21:30 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 17:21:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 17:21:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d4f073cd41dd6766362979f6b285b356f9585c31f2b31344db7401041f81e7ce`  
		...
		Size: 695.2 KB (695189 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b61f76d995046387876bc8082a69818baa3335f63cf78410b212d740f5716af`  
		Last Modified: Tue, 06 Dec 2022 17:42:20 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67fd0f93400c5becaef53a15122c86e94f041adc4ebde2e6476b44b45eaba1e2`  
		Last Modified: Tue, 06 Dec 2022 17:42:25 GMT  
		Size: 21.3 MB (21323788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0` - linux; ppc64le

```console
$ docker pull drupal@sha256:b70cffb063e3972ec5a4df7f99518e22897ef10a2802faf38a6da460799bf344
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (188961080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fd3c1ffd3e9e8a42333dddbf8a5c1ea6c70661f321896e65f96fa3a49af1459`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 29 Nov 2022 07:00:13 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 07:09:49 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 07:09:49 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 07:10:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 07:10:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:29cb517f4ea4dfb19d6eabed4c20550ae93aa6d88a051b7c97cdff59a1b962be`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19405af5a5fcc7ff824f98c768840eb3a87761e885dea1f4ada4765047a799a4`  
		Last Modified: Tue, 29 Nov 2022 07:31:24 GMT  
		Size: 695.2 KB (695194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96352a85e80299fd80b293aed82de2fe96fa5f63acd555eb0b16ef70211d261a`  
		Last Modified: Tue, 29 Nov 2022 07:40:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c9bfc4151c54f4aa90dffa9ffc7cb41e51e99691537e4f40ebd9a54725e170e`  
		Last Modified: Tue, 29 Nov 2022 07:40:50 GMT  
		Size: 21.3 MB (21324346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0` - linux; s390x

```console
$ docker pull drupal@sha256:b22d1b035d5f0688f85d33768f030b0d4f6f09c88e48c7114a95fe474c74c170
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.4 MB (165413895 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1c03cf451fd1754b14f409a92f9ce033a477bb95b22bddba3f15915793ff0da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 06 Dec 2022 12:46:08 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 06 Dec 2022 12:48:59 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 06 Dec 2022 12:48:59 GMT
WORKDIR /opt/drupal
# Tue, 06 Dec 2022 12:49:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 06 Dec 2022 12:49:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:584f6be38c96e45fdb07a5430b36d59ba3b2f8627fbbd05e77a9cb2393499a64`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c225e23e4d116e6e35dd237cd292e1774b0e275fe991db70a5d26f48d847ca44`  
		Last Modified: Tue, 06 Dec 2022 13:00:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c631ae71fe6ca1bbf8d144a08a08c824c149afd9065d5730b090e582607a277`  
