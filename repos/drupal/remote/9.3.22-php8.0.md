...
```console
$ docker pull drupal@sha256:759e6fb23e4d96b7e4b0b19f4f63fc20a9b0f978da227266b430b0c846165d72
```
...
```console
$ docker pull drupal@sha256:b9eee3123ffea30401951c9f1315fbf2ef3610931cda1ee817962fb788e22ddc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.1 MB (158081075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62f52bf228935298a2c9b75c46024eee072a79e6f8cfc1a4e9d8f852d818a09d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 28 Sep 2022 00:24:20 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 22:08:49 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 22:08:49 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 22:09:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 22:09:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e25e8cc17d434e29eb31ecf1b5eb88c3531619005205990c3973e5ba5aca9eb6`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04a80bf777c21d78a250b75b8259152486f57fa18e9b772867fdb63faeb26a8e`  
		Last Modified: Wed, 28 Sep 2022 01:15:18 GMT  
		Size: 692.6 KB (692593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bda10b6a802db53593dc704ae391d969917fd49b897521b7cb096b7dd7a108e`  
		Last Modified: Thu, 29 Sep 2022 22:57:04 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b3d8fccc6ccdd4e462217f12329c14e9fda7e5655fb68da019e65792e301e7c`  
		Last Modified: Thu, 29 Sep 2022 22:57:22 GMT  
		Size: 21.3 MB (21323448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cc50dd2eadd80159ad2101b89fd338dfb4ae9eb25011aa81a8e12183c551a46b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.9 MB (190924466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea6cd0dad0b3ee58c6b73cc49b5d853d5252cf7da401b7d160d9efea621aa6f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Sat, 01 Oct 2022 00:09:58 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 01 Oct 2022 00:09:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:10:00 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Sat, 01 Oct 2022 00:18:55 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 01 Oct 2022 00:18:56 GMT
WORKDIR /opt/drupal
# Sat, 01 Oct 2022 00:19:12 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 Oct 2022 00:19:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8f8ecf0be5c39fb13e9a2a6271ceb5fcfcafe4800f1eeb7bc48767678e6d23a0`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c76ff77ee909eaf7c46697c62498ae08793c3148ccb3b845e1d9676fdac3a4e`  
		Last Modified: Sat, 01 Oct 2022 00:35:17 GMT  
		Size: 2.1 MB (2142420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71fc9ca564734edfdc15ae90f4d2b439e68b3e9479f49d55cc31a0c35fc2b17c`  
		Last Modified: Sat, 01 Oct 2022 00:35:16 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b0dd4b335b999106663fe633e1b3d1e57ae370e00ea16f299edf24f7c4ceb37`  
		Last Modified: Sat, 01 Oct 2022 00:35:17 GMT  
		Size: 692.6 KB (692584 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91ee0bc9eba7657836fd668ff3de9deda54349dc14235ca0db521daa956e78b3`  
		Last Modified: Sat, 01 Oct 2022 00:42:03 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fa58a5d4736ce0835bff28c0de249efafd4fd31079746e0b1dfdbb400b430de`  
		Last Modified: Sat, 01 Oct 2022 00:42:08 GMT  
		Size: 21.3 MB (21323578 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0` - linux; ppc64le

```console
$ docker pull drupal@sha256:2622052832f2ad9624967c7176dfb2ab4af92acbecc5f6996dcadc1b26c4836f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.1 MB (189126384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2dabbfbb55d354a39efa8131ee2d115e736140f97a5777f9dd29df6e4c6cbfc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 01 Oct 2022 00:53:34 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 01 Oct 2022 00:53:34 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Sat, 01 Oct 2022 01:00:56 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 01 Oct 2022 01:00:56 GMT
WORKDIR /opt/drupal
# Sat, 01 Oct 2022 01:01:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 Oct 2022 01:01:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a8733be3c729077114e341f7d744161b26bb1b0e19a40d209d0685065e7eda20`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:682b90978c5b3faf377a03a91fe4135ea2c468b393c77096c83ba3c4bc47f91e`  
		Last Modified: Sat, 01 Oct 2022 01:14:57 GMT  
		Size: 2.2 MB (2200037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07624e383695f52601764fcba45f5ad30a367ef9fae743a4f30c0f160c26bbc8`  
		Last Modified: Sat, 01 Oct 2022 01:14:56 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1d9c7a979c540192507186f498717556d368d3c83e23ce559f4bb5ed99ad962`  
		Last Modified: Sat, 01 Oct 2022 01:14:56 GMT  
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3d73eada4289911544ef49971082b718e32da2b9624d8ce6fc6e599c8d6b4e1`  
		Last Modified: Sat, 01 Oct 2022 01:21:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2b1cef0c4b49594aff5f0dc3c68a2d6c001c9ce0a66c0988a70451979c485e0`  
		Last Modified: Sat, 01 Oct 2022 01:21:12 GMT  
		Size: 21.3 MB (21323128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.0` - linux; s390x

```console
$ docker pull drupal@sha256:1b1a26de81e674a9fd21a7062060af4fd3e645d095cef7d353531096c2a46540
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.6 MB (165562207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7873d9c62cd23f4f7dd0d6b8291452a033fe9d10e954c59dcac1e3822f0461c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Sep 2022 22:54:48 GMT
CMD ["apache2-foreground"]
# Fri, 30 Sep 2022 23:57:21 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Sep 2022 23:57:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Sep 2022 23:57:21 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Sat, 01 Oct 2022 00:01:55 GMT
ENV DRUPAL_VERSION=9.3.22
# Sat, 01 Oct 2022 00:01:55 GMT
WORKDIR /opt/drupal
# Sat, 01 Oct 2022 00:02:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 01 Oct 2022 00:02:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:43c8ea2387120f770b35fb949970b439babc92d5969351862a5d414ab5f5e3e1`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56def58abe53bf183a00683496b908fee94a2513e781953c90dcbb99fc438c45`  
		Last Modified: Sat, 01 Oct 2022 00:14:40 GMT  
		Size: 1.9 MB (1907831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ad351c863e9b7e0de10e7075a78f7a33cd3e8dcdbcd0b302287fdf79f0d16cc`  
		Last Modified: Sat, 01 Oct 2022 00:14:39 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6feb6727d31046e5ab0f705aae2514aa1beec35f1d39bbcaca5485476c7ddadd`  
		Last Modified: Sat, 01 Oct 2022 00:14:39 GMT  
		Size: 692.6 KB (692587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:094dd6d1e140bc0b2e04db9aec1e45be52d8bc18158c8ba578fafe62c69dd454`  
		Last Modified: Sat, 01 Oct 2022 00:18:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8ab7d1ee10203125d3de3bd1b42617ac5cb3018295afad0df578826059123a7`  
		Last Modified: Sat, 01 Oct 2022 00:18:07 GMT  
		Size: 21.3 MB (21323381 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
