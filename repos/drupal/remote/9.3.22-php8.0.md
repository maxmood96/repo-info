...
```console
$ docker pull drupal@sha256:077f5beef5ce676bcbd74cf270bc4b0ab3842c36dcf0c95f5b53c5d299e854ea
```
...
```console
$ docker pull drupal@sha256:bdeca3af37134b319d6a2a77c82ff4b63993b3e1266cc9b0ebe34bcbada4a75f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180891492 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e532b8b9766ca5d4cfa8ca2c07c0551634eb6c4c6405b69507605b79ec6d29fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 28 Sep 2022 00:04:21 GMT
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 20:44:31 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:44:32 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:44:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:44:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:19db06ccabba0e9b649cef9ef6f28b53a53f5c85adaaa233baeef8213a0e97a9`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03c3866688d8b11251d2d0af23c812d4c216a35616bc391726dcc90ad70197a4`  
		Last Modified: Wed, 28 Sep 2022 00:39:37 GMT  
		Size: 692.6 KB (692583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7b3ab9f6463dfa0b35fe2e342d43b1884772abd49908204ffc9e38bf25a0496`  
		Last Modified: Thu, 29 Sep 2022 21:20:47 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c517df0b518494d1bc11fd017f28a1601e8ff1c7354beb489116fb601b671dbb`  
		Last Modified: Thu, 29 Sep 2022 21:20:52 GMT  
		Size: 21.3 MB (21323448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
