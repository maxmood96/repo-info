...
```console
$ docker pull drupal@sha256:54c726b51dcd15b35fe69ac06b972b4fc9f02cc8bf8d4c82f7696c09f8f76118
```
...
```console
$ docker pull drupal@sha256:672d0c4ed90ff43220feab306eab4f2115c7e239b45c79ef83d32c4118b339cb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.4 MB (151420292 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2681f60ff270dde70e1973855d50aee558bdab1f7167ea22a9b3a57d4d516228`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Thu, 01 Oct 2020 21:58:59 GMT
ENV DRUPAL_VERSION=8.8.10
# Thu, 01 Oct 2020 21:58:59 GMT
WORKDIR /opt/drupal
# Thu, 01 Oct 2020 21:59:25 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 01 Oct 2020 21:59:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:60957628cfeffa85c711b9c56139062cf5671a46b64b60f8141fd8053295cba3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:416cf46a2e939d8737831673797648b777a4a7f06fef8e0d7316a30d59636e17`  
		Last Modified: Thu, 01 Oct 2020 22:04:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a1124d12781294db651c87d5cab20c923c2ca3c4f26c0380be806a77ab1fb29`  
		Last Modified: Thu, 01 Oct 2020 22:04:25 GMT  
		Size: 20.5 MB (20537572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
