...
```console
$ docker pull drupal@sha256:1d672e287a66e54792ca6c5d78e3a8b20fb3b3117946bc9e856b8ac5db2dd34b
```
...
```console
$ docker pull drupal@sha256:f170e027dfceabd1e59f92c6884a93f4aacc02e7ed377e0ff5d000390635bc24
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.7 MB (165667877 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3395939ff1d9c08d8da1b1688abb666e492f6469ab025a0f2b56764e6cebae57`
...
-	Layers:
	...
	-	`sha256:30074ee186cfbcdbc62bb413618370353b155d0da7a94a4e6ba8189b401cdc2b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3684dee631df8c18f9ea5a4e115c30daf6d3e49f6de183ec44df0bfc4d07b157`  
		Last Modified: Fri, 06 Nov 2020 03:01:27 GMT  
		Size: 112.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:397eefd379eb18592936054d5c1fd8fef74380b1b30eb251bef75b39f649a19c`  
		Last Modified: Fri, 06 Nov 2020 03:01:34 GMT  
		Size: 20.5 MB (20537116 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.10-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:30647320cb4bb5b9d60ee99fac4733834437ea795fd81c15eb945e129d708f46
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.5 MB (141534598 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d171d3918d0710d0c5ef2eaf86ed7d6a068696ea90d3e6ba8df96b056ba3889`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 20:03:19 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 20:03:20 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 20:04:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 20:04:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0f9da2a89ab1072844cda313e8d89812b370b8725bcf9bbb1c04f8c3d6734986`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8dbabbcdaf0b3dd582a69ffa4e81957f6f9505d91e8ff870fc0d87addc253667`  
		Last Modified: Wed, 18 Nov 2020 20:08:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef19a4f58a9193f753da0d1fbb183d9ca5d285f9653a22e06998bc8b5bc7f117`  
		Last Modified: Wed, 18 Nov 2020 20:08:40 GMT  
		Size: 20.5 MB (20537516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.10-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f43ac3782b67f79b2b11178019dff08c2cb30b32d5fc7a2d9849e0f97fb2abbb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157862734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78d72b1eb552359931cc116a7adc2d6c9bcda210f96600cb85944a95f0c29ad3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 23:34:23 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 23:34:24 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 23:34:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 23:35:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d75adc90776781bd453bf80fec79f50774a0829fd9725dd5307721ab7c3162e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36dac774ac1265cf87483b247cdd679036334e930ffd3e8bc18b5a78e1e7fa4a`  
		Last Modified: Wed, 18 Nov 2020 23:38:42 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1a9bf7c8b98b4d1d982e906b1df1cf4dc3dc94c9dc795e148970bf44613dc90`  
		Last Modified: Wed, 18 Nov 2020 23:38:53 GMT  
...
```console
$ docker pull drupal@sha256:7095add6c017482e6fb5c679c0a942a68b3ade90b2d92d428e413065234a489c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.5 MB (171543636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d830d21e50bf6a98208e1c11745bcfe7646f6726f0c8d2e7ac18a2781a222396`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Nov 2020 16:47:40 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 16:50:15 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 16:50:15 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 16:50:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 16:50:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d408f78dbec0922b7b30746563ffe2b22a188c757a8dba63b77f21e8e1699043`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07bbb5980b55b5732522795365b25b8a39a8d4e2387bb89ade742b6ceaa162ba`  
		Last Modified: Wed, 18 Nov 2020 16:53:39 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:739a303e13ab5eee67e439eee62a6c50c31dbb0a7912a25bd07dbf94b50d5b3c`  
		Last Modified: Wed, 18 Nov 2020 16:53:55 GMT  
		Size: 20.5 MB (20537126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.10-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:1d5ee8781cd37e4d1bd76b336562ddfbdcf8db29807b33bfcde3380496bdee29
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176603572 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a29b4585f15c2c4776e6a8a049e1a7e43460ef4fed5b4825f148d8e5295073b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Fri, 06 Nov 2020 00:41:50 GMT
ENV DRUPAL_VERSION=8.8.10
# Fri, 06 Nov 2020 00:41:54 GMT
WORKDIR /opt/drupal
# Fri, 06 Nov 2020 00:43:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Nov 2020 00:43:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b142e77a7ace7621cce70b710ec63938d130f69ee23c26222955fd0aade52f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d58206edae6a6459414a30620418a3548f0b49a93d26f8b3cba5ae01efce0dd4`  
		Last Modified: Fri, 06 Nov 2020 01:16:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9f141c60b67420ddf3797ab816b5649aee3d80b604b1716a6ab62fff2b4ab9d`  
		Last Modified: Fri, 06 Nov 2020 01:19:10 GMT  
...
```console
$ docker pull drupal@sha256:ec270101efd51accd970830cc1fdaf26764726745cb6d432f08beaeae324cf98
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.5 MB (151453210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c67e629798f47d3307d8a8ee3344ce72c7e794e2a6f369836f94f6e2270dbd2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Nov 2020 18:30:40 GMT
COPY file:b6bcca04faa508806d0159296c412dceded25d0b0fb2121ecdc43d6442801f70 in /usr/local/bin/ 
# Wed, 18 Nov 2020 18:34:38 GMT
ENV DRUPAL_VERSION=8.8.10
# Wed, 18 Nov 2020 18:34:39 GMT
WORKDIR /opt/drupal
# Wed, 18 Nov 2020 18:35:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 18 Nov 2020 18:35:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8ddc96794a4d9342762929b97c90fcb65c9f7d7d318e99dd9d8bde80474db4aa`  
		...
		Size: 508.3 KB (508281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c549180066e56fa592f2ea51203a14aa789a689c00567494d5b1595ae8476c4d`  
		Last Modified: Wed, 18 Nov 2020 18:39:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b26851619246c5bcbc89656e5834f6b83351b7e1c2461525d72e8575b74b70b`  
		Last Modified: Wed, 18 Nov 2020 18:39:30 GMT  
		Size: 20.5 MB (20537463 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
