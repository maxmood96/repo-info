...
```console
$ docker pull drupal@sha256:d8aafb97380818becef53614c0b53a62cd7fe1dbbb2e3683b40091ff92a338f6
```
...
```console
$ docker pull drupal@sha256:8d3de89a238a22d2f37695f75f985c41a648fb445bb77c6a6ed276d98124f2d1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.5 MB (171508235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2399b4e4c6d8b2da6826e28d8599005d16f591933e8eddacce13e745f9e1643`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 22:03:59 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 13 Oct 2020 22:03:59 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 22:04:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Oct 2020 22:04:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c49e2d710c5ce0720484564afa5241da3f4056de6aaeb7800e53f3f89f1c36af`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52d9c1f18539e8cd60f3cc7fd2dcd7ccd1cdb3b7783ee921ae4ebbba034792a`  
		Last Modified: Tue, 13 Oct 2020 22:08:01 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:309ab700e2ba04bf80f5b1475ce19710a630930ebbdf69e14e9b35fc131c7a4a`  
		Last Modified: Tue, 13 Oct 2020 22:08:22 GMT  
		Size: 20.5 MB (20537076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:8.8.10-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:96c34e2a6a67bb53f484ce054c5034bd4873da5673f7da080306db41710bf6e2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176585701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7599d1ac83e48d1635b7de02a8fff8eb7539a841f0d584163957e7b0d9d24816`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:4e41b87210a4f06cf9838e9958d0b6874d70e58a203befb5e739a25b6083a994 in /usr/local/bin/ 
# Tue, 13 Oct 2020 19:19:39 GMT
ENV DRUPAL_VERSION=8.8.10
# Tue, 13 Oct 2020 19:19:52 GMT
WORKDIR /opt/drupal
# Tue, 13 Oct 2020 19:22:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 13 Oct 2020 19:23:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:533349ee5615268d86bad37946394178b5b8e080a8be8cbfcb842ac6ac1c6213`  
		...
		Size: 508.0 KB (507965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4f033b32148634d64686e96de6093179957fe46b0a78490f9ad9e42f8395f94`  
		Last Modified: Tue, 13 Oct 2020 19:41:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b54357bd010910423117569363ad9e08b73c86cf4ef3f82d430585e6d3c56e28`  
		Last Modified: Tue, 13 Oct 2020 19:43:16 GMT  
		Size: 20.5 MB (20537861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
