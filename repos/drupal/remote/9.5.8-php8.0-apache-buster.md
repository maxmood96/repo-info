...
```console
$ docker pull drupal@sha256:fbeba3add3bd41ae44b49e40fa8f73d8df81a726a68f2f3f05274a2206bd7704
```
...
### `drupal:9.5.8-php8.0-apache-buster` - linux; amd64
...
### `drupal:9.5.8-php8.0-apache-buster` - linux; arm64 variant v8
...
### `drupal:9.5.8-php8.0-apache-buster` - linux; 386
