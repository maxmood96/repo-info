...
```console
$ docker pull drupal@sha256:490840c471b01df03ea961684adf193ffc4cb3935f12c889d0d8eb60a65b064f
```
...
```console
$ docker pull drupal@sha256:465de26e1cd0861ab7e14303c67944b2ca230344b552dace961cc96b3bb55c6d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.4 MB (141364855 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:603a2e2939eef259e7ff70142c7406996651031109f08cbbcd9b94d7a9abf4c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 06:34:23 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:49:43 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:49:43 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:50:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:50:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c3869237af085e01d03d95bc18159662c48761c59c2e2928a417e7a555ca70a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faa0ae26df861ac7bd08b60ed66d473b7eae5d88c5e5c03b25faf26d5a72d043`  
		Last Modified: Tue, 29 Nov 2022 07:27:22 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e45ba9c3645f838c6f884e63db7b2ab72aab0d9c34a749044d96ad9a5c6914d`  
		Last Modified: Tue, 29 Nov 2022 07:27:29 GMT  
...
```console
$ docker pull drupal@sha256:7181182dd53386dabfba970cf642f4f401519e4e9b899f497c5e4beb75e4e463
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.5 MB (158541369 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cab99d0b1f00357fbf25fdd83c926afc13841e730b4fc839df7159590d78d0be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 05:53:33 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:05:59 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:05:59 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:06:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:06:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a8065776ffef15708fc26f9d8182004f42de52d748b63542597ad8756bc76e7`  
		...
		Size: 695.2 KB (695197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7c5bf0e729b5c8633d7929f013fbdc3a9568ada2841039fbb981f2b9c0deb3c`  
		Last Modified: Tue, 29 Nov 2022 06:26:12 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30ce8ea385de01631d037974e7b5f0f582495b1da33dc805f1dae7f79a737807`  
		Last Modified: Tue, 29 Nov 2022 06:26:16 GMT  
