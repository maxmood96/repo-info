...
```console
$ docker pull drupal@sha256:cc0de025ded1f4672ba230151ea20129f914d3857eb4c795f005f4f49bb2819c
```
...
```console
$ docker pull drupal@sha256:bf9d16c47b3d7c9ea8a117b2d9b13ff45c0a21995012865ef6b54175a80c437c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.9 MB (157888037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27f4d9bc491b3e96e907e5bc4be279a21f8c94e6116f08798dfcb546a208b221`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Wed, 05 Oct 2022 23:04:45 GMT
ENV DRUPAL_VERSION=9.3.22
# Wed, 05 Oct 2022 23:04:45 GMT
WORKDIR /opt/drupal
# Wed, 05 Oct 2022 23:05:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:dfebb820bd411ce1741b4f1ec97911a3282ff75cb9049b45aa39def4f5bacd7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3946832679a00f98f67f398127e9cb29e6855895ffc1e8bfa837415149a67970`  
		Last Modified: Wed, 05 Oct 2022 23:36:48 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f375e39c6522096eeaea422121312d9547ec3afdd52423c04e94663d3bd7c8a`  
		Last Modified: Wed, 05 Oct 2022 23:36:58 GMT  
		Size: 21.3 MB (21324155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
