...
```console
$ docker pull drupal@sha256:ac2ee8862dcf9f8c26a2a1c12eac6cc3ced9fd88cdc87a18173dda43c44d139b
```
...
```console
$ docker pull drupal@sha256:ca6390d98e748bd652303eb7ae120f2e882de1a4d0fea347652f53ff6c472e13
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.4 MB (141390860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:016cccc805b936831929bc17782abf1f99414efef6492d85db87313ef0dff523`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 22:07:08 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 22:07:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 22:07:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:59dfac3f46ee74039f50e51f7a18653d55c8d89065c95eaaa0d0a4b394696b0f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83e783cb3216dfd219dbe0d26be04a5e548becfa4e3f3d1acd67c9190342e2ea`  
		Last Modified: Thu, 29 Sep 2022 22:55:18 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75da32937a0d3898487b8178086589d3c3b0f86e44afaa85ce1c20cc3ff94c0a`  
		Last Modified: Thu, 29 Sep 2022 22:55:37 GMT  
		Size: 21.3 MB (21323386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.22-php8.1-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f7cd01ff7ec041ec6d551d83d5dea5673d043bc12748110d375b965da4b4cfad
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157954707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec548cc8115fa9b1728663d4976fd17b2327dd52a0e72c237eb2f9f48c8f8736`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 20:43:04 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:43:04 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:43:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:43:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:825c9dfab64f1fa2f2882d0771638543bde6be8d5b1f9f41b98bcf03ad57bb55`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fc5e03f294846f7747d89c7d8cee7025fefea2bd56018728aed25754d115242`  
		Last Modified: Thu, 29 Sep 2022 21:19:51 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87da2dd2b94baad654d49de969d1fdfa7fd27e991730746ec97ded11472c57ea`  
		Last Modified: Thu, 29 Sep 2022 21:19:56 GMT  
		Size: 21.3 MB (21323476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
