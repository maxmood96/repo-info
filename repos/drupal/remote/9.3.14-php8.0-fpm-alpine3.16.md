...
### `drupal:9.3.14-php8.0-fpm-alpine3.16` - linux; arm variant v6
...
### `drupal:9.3.14-php8.0-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.3.14-php8.0-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.3.14-php8.0-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.3.14-php8.0-fpm-alpine3.16` - linux; s390x
