...
### `drupal:11.0.10-fpm-alpine3.21` - linux; amd64
...
### `drupal:11.0.10-fpm-alpine3.21` - unknown; unknown
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; arm variant v6
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; arm64 variant v8
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; 386
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; ppc64le
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; riscv64
...
### `drupal:11.0.10-fpm-alpine3.21` - linux; s390x
