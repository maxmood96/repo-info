...
```console
$ docker pull drupal@sha256:600a24ab4795c81cff1685bb110866893d8deec373c3ebd1f00fab14df07492e
```
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.3-php8.4-fpm-alpine3.22` - linux; s390x
