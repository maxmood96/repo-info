...
```console
$ docker pull drupal@sha256:ecb07b8d8388c9ed95ef2520a2b9810886f28f4a8cce6e2e8dd38c30b53af41f
```
...
```console
$ docker pull drupal@sha256:1e643bc4ebef6e28238a86cb894e0154dec533f91a5d283d40c43282c55efe94
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.7 MB (186706348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97af92c8af8798bd3ff343345ade10b4743f3ba81f7610fddafe9a631f6ed6f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Thu, 12 May 2022 23:12:28 GMT
ENV DRUPAL_VERSION=9.2.19
# Thu, 12 May 2022 23:12:33 GMT
WORKDIR /opt/drupal
# Thu, 12 May 2022 23:13:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 May 2022 23:13:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bb4d69e62018d605390ab6dc94ccf87f2341d4b4ffe87de4f451b293219aa780`  
		...
		Size: 661.6 KB (661587 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:175c141e661a359e99727af6a4858dfe477b1b92a52858476dbf7ee10dfc2a39`  
		Last Modified: Fri, 13 May 2022 00:40:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a4ea20af968222ac472a2cdbdb54baa984f02f2c309006509001de0dc81feaa`  
		Last Modified: Fri, 13 May 2022 00:42:26 GMT  
		Size: 19.1 MB (19127693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
