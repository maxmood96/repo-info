...
```console
$ docker pull drupal@sha256:81db2937eb4d6cd1fd0e54858afdf073e5be77d29108a036d03afc33c2471cb6
```
...
```console
$ docker pull drupal@sha256:ccede2574336c1086b5c61692caf024e2d48ea122c2d1754619ee4c12fe12c82
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.2 MB (181173658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88644aa6003d2c3debe39ab3cf24021c50b02024b97e61585095e4c73e1767f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:ef9ddfde9c1b01ce4b269763b45bce1abf8c9d7539baca060c7e89490e1e7845 in /usr/local/bin/ 
# Wed, 06 Oct 2021 10:35:38 GMT
ENV DRUPAL_VERSION=9.2.6
# Wed, 06 Oct 2021 10:35:41 GMT
WORKDIR /opt/drupal
# Wed, 06 Oct 2021 10:36:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 06 Oct 2021 10:36:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d3455f0be58d9cb32b16cbff994442837d4abddf592a73a8e082e4a61e1ada04`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62b0c9b9b8f57808fd90d97a4bce551b40ef11d41eaedb7d36d7418038b49f8f`  
		Last Modified: Wed, 06 Oct 2021 11:06:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e6c640fad436405704f00628c618c2a10bdf5db9b6c83c46c68c2bcb1f28ed3`  
		Last Modified: Wed, 06 Oct 2021 11:07:40 GMT  
