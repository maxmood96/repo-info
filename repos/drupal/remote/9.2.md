...
```console
$ docker pull drupal@sha256:1ac677853e86adeeee08ad1235f9ae04af09ce556d18fb089fbf28c1b3c43f49
```
...
```console
$ docker pull drupal@sha256:48c039e77a6a0d07eab7a06dd011c8efcb5f7665079f79cfb2e10d1ad1eb1343
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155309139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8555d1b5e912b3501bb4aab50adda315c574834ec24a87e71577efa938e85e45`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 17 Sep 2021 18:41:55 GMT
WORKDIR /opt/drupal
# Fri, 17 Sep 2021 18:42:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 17 Sep 2021 18:42:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:862d5747d0680ef5b7e2b05b75cda61b9152b09c67b4024c6c6a9a5331e9d856`  
		...
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6da6f194cf1c1daaef1a317b11023fc4a86f42a2c3facabca6c9d555908f23eb`  
		Last Modified: Fri, 17 Sep 2021 18:57:57 GMT  
		Size: 19.2 MB (19183874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
