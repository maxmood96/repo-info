...
```console
$ docker pull drupal@sha256:1608327fa32b45cef2cb38c8f4dd2132c757ae97fba4b02641a8229962d3c800
```
...
```console
$ docker pull drupal@sha256:cb70a504ff6ef6a65956f2ab25e1f6b79d98a72a4651fdeb3bb80611c5cfbc9e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.5 MB (144488446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:989c03294de059e05087bdd776a396199c81624b8a2bcb1b3e998d0a3c287dcc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Jul 2021 03:49:55 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 03:49:56 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:50:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:50:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1dc5fca30ebe52d1c5f4bd0ae5cb0933c9e0f52defdddd0fe45d160a54026bb5`  
		...
		Size: 553.9 KB (553918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff1390ec5d515d855bbb33b9fddef64a4f82d136659069db23ab12642b579af4`  
		Last Modified: Fri, 30 Jul 2021 04:34:02 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc66fb5dc6ad0ee298f55a14525167814dd5d0a9796be4bf4f15436c4d8b1e54`  
		Last Modified: Fri, 30 Jul 2021 04:34:29 GMT  
		Size: 19.2 MB (19179658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:19bf5f0e5a4ffdade39b37f2f20cf9fa12c4444798223fd69a5c00f33d9a4f40
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.8 MB (154813780 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b796f6720fa88c772f99ba22aa5f0332093c87040f4878c9a440d2f05852f05`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Jul 2021 03:23:37 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 03:23:38 GMT
ENV DRUPAL_VERSION=9.2.2
# Fri, 30 Jul 2021 03:23:39 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:24:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:24:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f7bdfd0092343fc25f1c0b1dd787e2a184181efcd7239a6eae3babf2f98beedf`  
		...
		Size: 553.9 KB (553918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cab42875a9d4c6eaf9df70f0ba4daab5b76493d5e96eea14cbdf30909a895ff`  
		Last Modified: Fri, 30 Jul 2021 03:54:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b24ffa6eeb061cd6bf9f7037d3d44582a562239fc8f10362b2a4c10cb937d81`  
		Last Modified: Fri, 30 Jul 2021 03:54:46 GMT  
		Size: 19.2 MB (19179556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
