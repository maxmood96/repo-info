...
```console
$ docker pull drupal@sha256:d87514c379d5358a5a3050440599a02ccc69e56e35eef6630bb331afbc3c0746
```
...
```console
$ docker pull drupal@sha256:166bf1171fe39170f90efdfb6bb2c958410ae846e126cf04739c5010056f477a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.6 MB (180597335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7ccc4d67bb631d3067ced0444d4b554ef3bceb1c164067aedcb8fc0404dcf52`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Tue, 03 Aug 2021 20:42:27 GMT
ENV DRUPAL_VERSION=9.2.3
# Tue, 03 Aug 2021 20:42:32 GMT
WORKDIR /opt/drupal
# Tue, 03 Aug 2021 20:43:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 03 Aug 2021 20:43:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b40bfd79235537225399d7c3eb49495c751fd0e51814b1b6d854e8cbe3af36c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:754a7e3208ecfde7ce9cc4639793801adb2cb04058cfa34686dd5dffb56f9ec3`  
		Last Modified: Tue, 03 Aug 2021 20:58:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b092727832bacc44b118b7e01362250f31a3552897df094bf2b54e453955c70`  
		Last Modified: Tue, 03 Aug 2021 21:01:07 GMT  
		Size: 19.2 MB (19183861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
