...
```console
$ docker pull drupal@sha256:a716bbc16bcd66b964b61e4176de3615ef2d117634357be3e862c5f0d9d8990b
```
...
```console
$ docker pull drupal@sha256:8e05340fa42c1cd7a73e0431ea24640060cc5280c6574c710d53bb5cdb303dea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.7 MB (155672141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:356c8926d6dfac3f65a80ee37fb23d6900209e695590ddb4792964291e71467c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 01 Apr 2022 03:39:29 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 01 Apr 2022 03:39:29 GMT
WORKDIR /opt/drupal
# Fri, 01 Apr 2022 03:39:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 01 Apr 2022 03:40:01 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ffece3e515b4c170761c299b5b78ffb5727504b769eeab1237fdea6af79feb61`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93d7e9cb11642000fb0cca680d2c72e6e4c5488252922b3503742ce0a5fee299`  
		Last Modified: Fri, 01 Apr 2022 04:27:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5670e99dd2f8459f39bc7b724e1ceac2d773fe8835437e707b38e095347ac883`  
		Last Modified: Fri, 01 Apr 2022 04:28:10 GMT  
		Size: 19.1 MB (19127250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:689a4b0355fbbf6d96aa6da9ac138eb694487110dd545aa975d43b2c1ed95a40
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.3 MB (178269625 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24b105bed848094d01cd32024eda6835d539926b7849e41abb29a11a2a9b916e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 10:24:10 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 31 Mar 2022 10:24:10 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 10:24:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 10:24:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e24744a411ed84bbb49c7fa96e88f7ab30c43471a046e68cafa593a78ff4d60`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dc462b01f35d03ad0ec5f4de8abb2f3c1cf5a6747f890eab3a86ce7960fe045`  
		Last Modified: Thu, 31 Mar 2022 10:49:22 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ded9d911b23ba1173c4991a6d715082224da0ab9f5d0dac599bae2cb7e8275e5`  
		Last Modified: Thu, 31 Mar 2022 10:49:27 GMT  
		Size: 19.1 MB (19126272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f1b1579a3534fa52907f0d6b41725b3117ad9dc18d5db9e83fbac06098214b75
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.5 MB (186515676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12c840392361a587caac2336b18711a73a1da1c1d96ea3bf3be88f5973edd425`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:6955c7ba02c5cb16962dcfe4b0f4180532979928cffc18a143125dffa5446374 in /usr/local/bin/ 
# Thu, 31 Mar 2022 19:21:59 GMT
ENV DRUPAL_VERSION=9.2.16
# Thu, 31 Mar 2022 19:22:05 GMT
WORKDIR /opt/drupal
# Thu, 31 Mar 2022 19:22:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 31 Mar 2022 19:22:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:760da76b7a5bf6e077c76367e6d5e4fe7fbf658162fa92f89f5f087afa7babcb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69a947997d5304fc77bddec8db83d8eb70a0a96b102e8dd56b76c6486dce5f77`  
		Last Modified: Thu, 31 Mar 2022 20:28:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fed8d4a07389e1bc3364483066ebd0644086ecfed0ab1487b2f03de103daa55`  
		Last Modified: Thu, 31 Mar 2022 20:29:46 GMT  
		Size: 19.1 MB (19127373 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
