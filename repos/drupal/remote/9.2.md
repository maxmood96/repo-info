...
```console
$ docker pull drupal@sha256:fde3a0c104a27f1ca851e63ec1e9165c4fcb7c3f0317a86d1a20e7b03136d60f
```
...
```console
$ docker pull drupal@sha256:d1e4368a220e08f39eafc0fb087175674856c5f5e1239223d05a2d00e242f93d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188119274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd905f3b375ff895129294091071bf1cc46b658e59bc77751ed7e52dce229939`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Tue, 29 Mar 2022 19:09:46 GMT
ENV DRUPAL_VERSION=9.2.16
# Tue, 29 Mar 2022 19:09:47 GMT
WORKDIR /opt/drupal
# Tue, 29 Mar 2022 19:10:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Mar 2022 19:10:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d321a70884d81f0a8fddc9d34cd4b0d677f37fd8418a66487b7fce2fb3c0fb5f`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:717dbf0dca685cc82cf83869606d31e02b4d378ae38c8b55dfb66e2a80ee860d`  
		Last Modified: Tue, 29 Mar 2022 19:25:37 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d90d19eb0e0bfea3f7a11ead1bd3451e739a868d7bcaeb743ae6cec7628cf4dc`  
		Last Modified: Tue, 29 Mar 2022 19:35:14 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:449b5f34269933246c613a65f1d1e5326fd1f43e5f80eb6ae1e46f5a215f8e3d`  
		Last Modified: Tue, 29 Mar 2022 19:35:19 GMT  
		Size: 19.1 MB (19126424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
