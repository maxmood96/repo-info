...
```console
$ docker pull drupal@sha256:61702ff6edbad925865c9f8d52cfaf0fc5e08c9a0c3b310a74b2227edaba7243
```
...
```console
$ docker pull drupal@sha256:1f0be245a7ecf180a70c7e8e01908814fa96200db0c370b62ac42b41e4fe3ad5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.6 MB (178562794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b42bc5de95bb0f91ac8279b0be6d08f7f97a4709c3d2bc5454c51637433c0cef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:20:06 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:26:01 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:26:02 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:26:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:26:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5aa26ad06fa321316cecadf9e34f0cbbb323819f25f8cc89891438357154a061`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13bcc8bba968e259f9badd954fa116670d28439782d281d25cd190d24c39a4f0`  
		Last Modified: Wed, 16 Mar 2022 18:41:51 GMT  
		Size: 575.7 KB (575716 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9a47d35b824920bf844abc5c8c3d7c6b867de40f5df32d6b0f68443525a40d8`  
		Last Modified: Wed, 16 Mar 2022 18:51:33 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:610f0dba7eea07dce72559fd6edfdcdfd8e150e512eabf43009e295f6348e7d9`  
		Last Modified: Wed, 16 Mar 2022 18:51:38 GMT  
...
```console
$ docker pull drupal@sha256:92a662d44062c5dac3425db008272e64c86b48f2bc1741651dc79c2fc681b185
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.1 MB (163051430 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75ba03e895407a3ddf75062101616b66376920046656e7bea8e49784aed289c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 06:31:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Mar 2022 18:09:20 GMT
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:14:51 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:14:51 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:15:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:b5aa16a3b8f84cdd23c089c932f123335402a6ce79b403f974818c98e6e3b6dd`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d35b268c0534131d97d374089a29e3b876f4a62979d626d9c678b1af8c4a778`  
		Last Modified: Wed, 16 Mar 2022 18:30:51 GMT  
		Size: 575.7 KB (575714 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ceed0c67495ca92b9f541e6efc3ab21c74c31e0b7efa7779225fef8549fc51d4`  
		Last Modified: Wed, 16 Mar 2022 18:36:39 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:275512dc100ea3aca88feb2e5b1979c398aee0bf0226362f4bd8bf6648a31e7f`  
		Last Modified: Wed, 16 Mar 2022 18:36:43 GMT  
		Size: 19.1 MB (19124504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
