...
```console
$ docker pull drupal@sha256:a5f0ea130736e076dfa0b0a809193d2047a8e9d72bf97f9ef6e47573c1ae7b5d
```
...
```console
$ docker pull drupal@sha256:32928c07010e327668abd98b705c06f2e2b223d9e8287ed18a7945f7c06a65b0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155881863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe7b26d7fe46e20e0f282bd1b0d5266284da4520c21ecc8f9d64807578ebd6dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 06:12:44 GMT
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:17:35 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:17:35 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:18:03 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:18:05 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cd1219301e38b1c3bc184ab69d87ae2e62c070a05eaad2d7be9e1d2ea58187de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c926a3a913a42e553b6ddfa2a0b87baffc7dec517562af931a397d670f5175`  
		Last Modified: Mon, 13 Jun 2022 21:09:41 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94f0d19f38dc6a6696108d4705b7b93d86259f4d7983c78928f8dfcabdeb950e`  
		Last Modified: Mon, 13 Jun 2022 21:10:08 GMT  
...
```console
$ docker pull drupal@sha256:b604b444e295108e0f1a812e9fc249409bb9fa312115b7c2364651da5f590dca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.7 MB (186729265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48eee1bd9e524835f643d09246890ff4d745c87939da40f2a62cf70dd8d6d3d9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:c4366f21ee48a3489e643b6945f021fb37e8f59ffe9e3c0ce41868123cf74b0d in /usr/local/bin/ 
# Mon, 13 Jun 2022 20:08:53 GMT
ENV DRUPAL_VERSION=9.2.21
# Mon, 13 Jun 2022 20:08:56 GMT
WORKDIR /opt/drupal
# Mon, 13 Jun 2022 20:09:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 13 Jun 2022 20:09:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6c0ae17408db4b615a7be412aa059f1ece40bc92837ddf03cb182b46ffee0e29`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1695cf66e2a9ec36e89a962ccc3b8393d4cfd90b1ef32d8fc71bb4ae29b59fb`  
		Last Modified: Mon, 13 Jun 2022 21:15:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:938302d2ed53b7674583340bef5c4ff6834107d820cd7fcc27a5d92cfe76e33f`  
		Last Modified: Mon, 13 Jun 2022 21:16:35 GMT  
		Size: 19.1 MB (19128080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
