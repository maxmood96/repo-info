...
```console
$ docker pull drupal@sha256:0d2a9e4456fe791e14dff617ed93843e558912e202b6ef941b26e6d7b5dbc924
```
...
```console
$ docker pull drupal@sha256:0e09195a55ae76c6e3adf41b327e731f0b888d942829adcdd6ddd506b85a8c9b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.7 MB (155745943 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdd87218ffb080c5be203d69ad535e37aeb708e4934d03425a1d6e1926bbe409`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:11:17 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:11:17 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:11:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:11:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9524aab8101b53812bd32666b7f2cdd30b40ca69cd0e08dc13cc9769beb229ab`  
		...
		Size: 575.3 KB (575349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a68f6ecbbda57e7fd175c24cf586f55be4ea53ecea4a2af54b76915e074fffb`  
		Last Modified: Fri, 11 Mar 2022 15:39:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86692fd959d15a44c7ee0cce1fc7a692d4a004e8fc04bd6b146fd6ff49173824`  
		Last Modified: Fri, 11 Mar 2022 15:40:09 GMT  
		Size: 19.1 MB (19123484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ec4dcec480a16964317052a8bf9ad60bc8b3eaac83c0c7b48b65855ad90df63c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189046510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4161dba26b8bb09fcc6a2eb529a319d27197b807a9067a01ee4810a07bd4cb38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:42:42 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 14:58:16 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 14:58:16 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 14:58:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:ca4f8edcd81c2393bf14d59d33150cdaa65a6bfbf812009c15a4184de6edd528`  
		...
		Size: 575.3 KB (575344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20ec1ce4487cf438214aa8c62e0dcc2e573057845d0412a92bcab208ea8c2411`  
		Last Modified: Fri, 11 Mar 2022 15:29:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a8b6683aed695b345355f361a808ec999957fd1ed56afa0d49ac1cbf319a984`  
		Last Modified: Fri, 11 Mar 2022 15:29:28 GMT  
		Size: 19.1 MB (19123391 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
