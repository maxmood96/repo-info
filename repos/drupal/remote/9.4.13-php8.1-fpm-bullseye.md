...
```console
$ docker pull drupal@sha256:c14dec8f605bece6de8d8ba2d102c9bdf1c87afca4d4c0398fa8c347d80f548b
```
...
```console
$ docker pull drupal@sha256:b5e6770d232fee8c1917d23ac7014ae95803597b6e76aba0c89a7c2bb5118bda
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.1 MB (186144257 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b130e33988e962a69b246c8d5f9dd4fb5badf6c37d41b31a28c68d3e3a4ecf5f`
...
-	Layers:
	...
	-	`sha256:4ae4285c50914bba9fb03ba037eaf9b2c5d48796d445604fb68a4820125b4f76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1c763678b5000537ae16b63a2fd8bbcdce9c85a4666aa81ecfa1bc4d5acb042`  
		Last Modified: Fri, 14 Apr 2023 19:57:40 GMT  
		Size: 2.1 MB (2113017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17da9e6e2a08edc6d567e41f4a8f0a2f1db819881e0f8300bffdccd8d6baad53`  
		Last Modified: Fri, 14 Apr 2023 19:57:39 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b61dcca11a5903b57f33b535b041c43313992b9d35f43f3ac24b42373405d12`  
		Last Modified: Fri, 14 Apr 2023 19:57:40 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e161ec78408c18fb936145a8bd5807cd89d18139d7a927ca019e5712fa50214`  
		Last Modified: Fri, 14 Apr 2023 20:03:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a37f5a527dc3c56b97121356ba64cfe2b89ff94625180ee8c980b5f2096e9b6`  
		Last Modified: Fri, 14 Apr 2023 20:03:34 GMT  
		Size: 21.9 MB (21916961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1-fpm-bullseye` - linux; arm variant v7
...
```console
$ docker pull drupal@sha256:8179a5e89a86a9d75e53da1a8754e61629854a939330dab184ec39ca4927ad3c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.4 MB (180407029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42059a718fe066f527355841a3f3b8104ac747a917237285a085690b3d3655d3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 09:20:00 GMT
CMD ["php-fpm"]
# Wed, 12 Apr 2023 17:32:26 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 17:32:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 17:32:26 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 17:41:29 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 17:41:29 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 17:41:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 17:41:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:341f68bd7150a81ff14742b1bb5e095d884d70924f02191062044b6668e33b61`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bef6e49cfda816b00ea8b8a1785d988759ec5337dada4cbbc14975c2440a19b`  
		Last Modified: Wed, 12 Apr 2023 17:49:38 GMT  
		Size: 2.4 MB (2372131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da25d60c4702c9f133127605bbb98301fa9acbfb274a5a630bb69f55366e35dc`  
		Last Modified: Wed, 12 Apr 2023 17:49:37 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7055213c14bbe79edd031acaaaa133ac66bddf6053ec21bc44a47461101aca68`  
		Last Modified: Wed, 12 Apr 2023 17:49:38 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6a78dd9f68bc2788c8fe6935625f40b1c955ef7c3a04d0b503b311c677fb06c`  
		Last Modified: Wed, 12 Apr 2023 17:54:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3101409720b668bb4357ba205a35af626d1ae6c05bf971384d500c3ba5449e7a`  
		Last Modified: Wed, 12 Apr 2023 17:54:53 GMT  
		Size: 21.9 MB (21917118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1-fpm-bullseye` - linux; 386

```console
$ docker pull drupal@sha256:0e23baca57fb5a3126dbb514605037e946991b64f1d489fad6c2ea5d14b2c033
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.8 MB (188781745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7bcec2cb19a699e9731b4fd6ba1803c758f7d5e881c690e30eb51d47e6d911bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 12 Apr 2023 23:17:51 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 23:17:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 23:17:52 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:28:06 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 23:28:06 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:28:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:28:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4dfbb0b8edbe66b29e3c14568a90631e82d39c775eaebc454ec142252cf19e97`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a8cce0244ca75522b30e4544d95b1e73e682e05d85d422b378938f3eeb9e1d1`  
		Last Modified: Wed, 12 Apr 2023 23:35:57 GMT  
		Size: 2.2 MB (2177320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f859a8c130dbdc0ed8f662e7dbe544d0fdad77ff23c2291d7716756c1d37ee09`  
		Last Modified: Wed, 12 Apr 2023 23:35:56 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0f140f1fa5d34a3bb5dbe3fade0956d6d22b8da1641d2df2ff0cbc95168f367`  
		Last Modified: Wed, 12 Apr 2023 23:35:56 GMT  
		Size: 697.5 KB (697533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c8d63280a66f57c20922aa614d8d0072268f8f667052f48e3da75418affa90`  
		Last Modified: Wed, 12 Apr 2023 23:41:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dec0662d3580ba6cd6f8d2f53cd6eb3443ff9fe3361cd01402948befdfab0d57`  
		Last Modified: Wed, 12 Apr 2023 23:42:01 GMT  
		Size: 21.9 MB (21917033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1-fpm-bullseye` - linux; ppc64le

```console
$ docker pull drupal@sha256:ce0c57c90da5c185229e8f6d716ff553dc76c8b2aa8e0594bff372704e43e5d4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185906266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fa55f03b9b338858fc4edcad24af4095245baa9a6378018b085dbd423fccca2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 14 Apr 2023 19:35:17 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 14 Apr 2023 19:35:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 14 Apr 2023 19:35:18 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Fri, 14 Apr 2023 19:42:19 GMT
ENV DRUPAL_VERSION=9.4.13
# Fri, 14 Apr 2023 19:42:20 GMT
WORKDIR /opt/drupal
# Fri, 14 Apr 2023 19:42:47 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 14 Apr 2023 19:42:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2587f80cda8f8cafde3386d001aa8b373eee38e70ba9dcf357b143fcf733424c`  
		...
		Size: 8.9 KB (8880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64a5ec0ff1ed926508021cdf5188550552c8f18cad21f13fa62b28ec8bc264ea`  
		Last Modified: Fri, 14 Apr 2023 19:50:17 GMT  
		Size: 2.0 MB (1975229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e1cf3209d9c5456cee6309413b9fc43eb0b7f4abfb7275786a42ae720aaa878`  
		Last Modified: Fri, 14 Apr 2023 19:50:17 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeb2914dace67d4373cd2a7d6bceb6f92275eacfd2a3c7797f31b1103c3cae15`  
		Last Modified: Fri, 14 Apr 2023 19:50:17 GMT  
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b4ab5a43ebdd0a504ea033317a9827b25a220c200ea0bf2b09f27eeae743dc2`  
		Last Modified: Fri, 14 Apr 2023 19:55:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4417565c8e1cb30263329697b1af1d48a1c690fcf36317b2671ee8c0c191ff63`  
		Last Modified: Fri, 14 Apr 2023 19:55:53 GMT  
		Size: 21.9 MB (21917075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.13-php8.1-fpm-bullseye` - linux; s390x

```console
$ docker pull drupal@sha256:be2d55dddd3082fd78fe72fa9fc78ba12e0eca0bfe781f069016a208174e4e4d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163043660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8db7efdfd9465b8052695f70476c7a6c857735ab181034451d11a112c0a8d21`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 11:56:00 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 12:01:05 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 12:01:06 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 12:01:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:a290f9460deb061f728489861e781875aa12b79379523a08011c4192489a16b9`  
		...
		Size: 697.5 KB (697532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8ce417a7e4fa7f891ac9b17b0a74b0640f20d9bc2de84c73378a97eb31bae62`  
		Last Modified: Wed, 12 Apr 2023 12:08:10 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3375ec94cc23ff7a310a58e368d25e2e215253b7a5d1485d457ba48bcbcfb017`  
		Last Modified: Wed, 12 Apr 2023 12:08:14 GMT  
