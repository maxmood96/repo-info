...
```console
$ docker pull drupal@sha256:cfb032986340c3f881349940dc851ded955103d2325b422cf9f56d7cddb2c885
```
...
### `drupal:9.2.1-fpm-buster` - linux; amd64
...
### `drupal:9.2.1-fpm-buster` - linux; arm variant v7
...
### `drupal:9.2.1-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.2.1-fpm-buster` - linux; 386
...
### `drupal:9.2.1-fpm-buster` - linux; s390x
