...
```console
$ docker pull drupal@sha256:2731df0568f2ef54a5df1ce8eb6be224f84d2d51255b68717dca3d9c67dc910a
```
...
### `drupal:10.3.11-php8.2-fpm-alpine3.21` - linux; arm variant v7
...
### `drupal:10.3.11-php8.2-fpm-alpine3.21` - linux; riscv64
