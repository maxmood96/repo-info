...
### `drupal:11.2.6-fpm` - unknown; unknown
...
### `drupal:11.2.6-fpm` - linux; arm variant v7
...
### `drupal:11.2.6-fpm` - linux; arm64 variant v8
...
### `drupal:11.2.6-fpm` - linux; ppc64le
