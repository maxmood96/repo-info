...
```console
$ docker pull drupal@sha256:b0571c925ad0a2c6ba351842337d779128074df94a4d166bd6f8c822d86f1428
```
...
```console
$ docker pull drupal@sha256:30ca34927c05d0be5f2bd6be30703fe41b92f887b6575f3fc3942660e6d398cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (51040776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc6c1ca888d030b5d1168704f9fa354fed1366252cf7961d86ac87e9c6344225`
...
# Thu, 04 Aug 2022 23:36:35 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:36:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:36:46 GMT
...
-	Layers:
	...
	-	`sha256:4dccf6eed74c0a38106d1e9467b6d546fb502402f3148ceac598b7a2a5be38b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b408720689bda3500b73afc912851cde559ea295242b50f281cc3089bf1cf19`  
		Last Modified: Thu, 04 Aug 2022 23:59:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7129cbbb0f0076603aff025a7946d62c77f9b7e866120bf8d6dadb3aa40324d`  
		Last Modified: Thu, 04 Aug 2022 23:59:41 GMT  
		Size: 19.2 MB (19231347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine3.15` - linux; arm variant v6

```console
$ docker pull drupal@sha256:23b513e997b65ef99ff19eadf8373f6387b6c6fef465d7f5d395cccf53957b5b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49165725 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c2f4abc8f4bd5acec7c3dc12d94c844a996366749e1669ca1a8ebb9163bd556`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 04:30:32 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 04:30:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 04:30:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7c9eee9ece4a1e9b5971dc53bb0643617564229de08dc074b6408fd3eee31c91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ab1c1f95f7a60281e40913a7577038899ba3f16a5ec20fc9a28928e4d78416d`  
		Last Modified: Fri, 05 Aug 2022 04:49:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f51636387614da8b40bf14624896bacfe61f30aa3e1cd152b7a7d96642bb28e0`  
		Last Modified: Fri, 05 Aug 2022 04:49:29 GMT  
		Size: 19.2 MB (19231933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:72db9df55040f8f779548d991483855041eb25136089b2df81ec01a24b77dfd0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (48004611 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce3026d08606cbbb8cbc4a6d237eeeeca7bf133749b65b9f580989c9f04ba691`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 07:45:11 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 07:45:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 07:45:23 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:315e01d5db908360d144e9b82ae98eb12bc4e9d04118b557e7dabb05e6005247`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ef0acaa0e5326b5fc4356321d3c01f9b1efcb91db1a712c00316b588b61d226`  
		Last Modified: Fri, 05 Aug 2022 08:23:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27c6e9edf7202262f6a3a6b623b3655a4d6796abbe05fe68a920c4fc9b4180cd`  
		Last Modified: Fri, 05 Aug 2022 08:23:39 GMT  
		Size: 19.2 MB (19231431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:eba5dc5fb7f97e993783320897fb1ba8539564f9a0b25ad5e78a00e68cdc4658
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51241141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24e8cc85b1d448f13670fc44721299cd158e8eee9a44ebba3a59ad7b6288bb15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 00:39:37 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Fri, 05 Aug 2022 00:39:38 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:39:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:39:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e2e94b25e19d671c339a52253b718b275b9d9a3a54d7977a09f9e63cd993021d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a14e462b873fe1d262df424b6ee9c06864508a06adc062dc48acab7c1c489c4d`  
		Last Modified: Fri, 05 Aug 2022 01:12:52 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a74f87c83ff457b4d2d06bed5dc98b769ae2f8fdeeba661b49f1d10aeb3d5513`  
		Last Modified: Fri, 05 Aug 2022 01:12:59 GMT  
		Size: 19.2 MB (19232474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:224864c569b9d326621f0cb8f0c14222186e66c36a7141ebc2d91840b445f343
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51479262 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9425548a6d7a16920f100fe0ee9ce6cf3d3d71d1295c8b67d211b5ce371d639`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 23:46:03 GMT
ENV DRUPAL_VERSION=10.0.0-alpha6
# Thu, 04 Aug 2022 23:46:04 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 23:46:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 23:46:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:07f78898f6a1fd9aacf317491bf9683764da3e34c4623c00dabea6006b005b3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1253d9aa619bc38ac55836951284c557d19c2add4988ed61dfda867de117c5ef`  
		Last Modified: Fri, 05 Aug 2022 00:19:18 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:270878a07c5a6487b4ac8f091eb7358a46da1bf40d6c704f19d9665f52df1c73`  
		Last Modified: Fri, 05 Aug 2022 00:19:23 GMT  
...
```console
$ docker pull drupal@sha256:5bb043494cbe9ee184882087997a86775ea278c451b21c42083ff40d1f4b13e2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51329638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5df18602c74bdac9ae47b9b35ad5368c325b628e584b71178fc824620c99da1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 00:01:20 GMT
WORKDIR /opt/drupal
# Fri, 05 Aug 2022 00:01:41 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 05 Aug 2022 00:01:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:aed0ed513c234e661cb6e255db0a8f7a7a8b91458ec1c4a65d05ecea0d0a253f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b79f44e00aac12a823d1ae29179460f88b7cd2bc87450bed4180ac620bb237d`  
		Last Modified: Fri, 05 Aug 2022 00:36:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b52208de4328e20f17b243568fe2379abeb06d91578f2abbcc588aca16893e88`  
		Last Modified: Fri, 05 Aug 2022 00:37:03 GMT  
		Size: 19.2 MB (19231834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:rc-php8.1-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:1788da432f1b7c414b7924ffd7158649ad816d7255e65292a013c2ca249313fc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49729082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33a96c1f433ce8a558634094c014ead506ad3e9c9faede6c58d8955494d91ff0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 22:39:39 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 22:39:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 22:39:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:281ef242dbb542bc1721f89775ccdfa819a9e28c8d2e827e5ee660e98ffae02c`  
		...
		Size: 670.4 KB (670409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88606a3e26547ded9a5fa17b00951aa4d9cd5a87d16e4e0ea6f44d48eb489826`  
		Last Modified: Thu, 04 Aug 2022 23:05:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a0f49dafe077e0cbafb0a6b2befe9db34c71c56dfc46d8923f927e11a2c2c44`  
		Last Modified: Thu, 04 Aug 2022 23:05:31 GMT  
		Size: 19.2 MB (19231755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
