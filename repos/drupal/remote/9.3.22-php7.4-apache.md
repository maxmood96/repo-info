...
```console
$ docker pull drupal@sha256:8dfebc678bdd5b48061b4ae0a25dbe99934aecde6fdb4fc57a5af6cdc53ab147
```
...
```console
$ docker pull drupal@sha256:39cbef8bc38b6b01067aab74b7861f994e9e36444a15c6f84dbdfa398e4373ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.2 MB (189240854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93654c1f6d9b214d90bcf530578e47c4b9775a3f12f66d16e8a5b7d000a806df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 18:58:30 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 18:58:31 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 18:58:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 18:58:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a1d737a0dd43bef89ff138335fa3bb0fb9c028b84b92c700fb9728665583a457`  
		...
		Size: 695.2 KB (695198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa46c39ebc2ec62a909b4296b2466962e64f26392fb33437ae7e83a8c633f952`  
		Last Modified: Wed, 16 Nov 2022 22:56:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9849886c92a15792fdb9363e3a996a79150388e4b2b19d17ab29fd236400daf7`  
		Last Modified: Wed, 16 Nov 2022 22:56:56 GMT  
		Size: 21.3 MB (21314570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
