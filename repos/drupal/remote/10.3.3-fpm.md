...
```console
$ docker pull drupal@sha256:4e47945f5a785b07ff7435aa75b9887fa65aff82bd4b035ca37772d559d0862c
```
...
### `drupal:10.3.3-fpm` - unknown; unknown
...
### `drupal:10.3.3-fpm` - linux; arm64 variant v8
...
### `drupal:10.3.3-fpm` - linux; ppc64le
