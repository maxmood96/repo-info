...
```console
$ docker pull drupal@sha256:952adaa885f3f777d069b9f39edf9f0958aa2bae6b70f7a25b1eecafac210918
```
...
### `drupal:9.3.0-php7.4` - linux; amd64

```console
$ docker pull drupal@sha256:142ef4f8562c529c37488dba318a141cd2597d7b93264dc2b8fcc35d2763c3bf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.3 MB (189300342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8740dfbe5dcd1a853da022b7fa5009bee05666a4fd2d00ddaac6108bd0773b7b`
...
# Mon, 03 Jan 2022 19:41:51 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 19:41:51 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:42:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:42:02 GMT
...
-	Layers:
	...
	-	`sha256:5df52e294db51f4a41d68e530922d9f9d436a1d0d46865256166c57338c89a2c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96758c0ecfcd06d7cd1051a76eb2705c14d040a2f8668939cd7595eb95538fe2`  
		Last Modified: Mon, 03 Jan 2022 19:53:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dc26529bed0aa026d8683efd477eb3edda539e0cc1d63cd8e9b04dc8bb4465e`  
		Last Modified: Mon, 03 Jan 2022 19:53:23 GMT  
		Size: 20.1 MB (20137028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e0c7c4be60b72b43a781fab544ca9a3f97bddbed3b13ca6464e77d300f682c07
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159085538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eaa34c9dc8f130de42476cacac5784d5195ba97a5c279c6a332d057a9bcb0a1d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 20:56:40 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 20:56:41 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 20:57:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 20:57:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e63f1c7c0aefd1dd736a296a4a7371ef0df3616390b73e51315a6e66a28ddd55`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef649fe18cc2eee6436d48a50fc9244d17782208548f862478c64c139c344e09`  
		Last Modified: Mon, 03 Jan 2022 21:35:22 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2ebf6771fe0619f85ebddb8b2a29cadec0bc475a17ca106439cc548eaf01821`  
		Last Modified: Mon, 03 Jan 2022 21:35:51 GMT  
		Size: 20.1 MB (20136963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:ed58c2467280c5801aba2666ce9a505cee6291445302a96eb1848f2bf11912fa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182298441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:830538f86f65aa6c1d977459b9f26b70500c3f72e1e991132575c8d7efd5df88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 03 Jan 2022 21:38:48 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:38:49 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:39:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:39:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0efcfceac5bb677e825c9bc085f93ac363296a3fec874cb05767924f2a9f2e6a`  
		...
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a72a8246fae56255aa5083a945e8a743189b54eeecc17f60ac8cdaa4e1f0ba0`  
		Last Modified: Mon, 03 Jan 2022 21:59:38 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a46d47c4c60df04b149ec301b5c845e2a8d53383a21c7b4d956d6b7393eedb8`  
		Last Modified: Mon, 03 Jan 2022 21:59:44 GMT  
		Size: 20.1 MB (20138268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; 386

```console
$ docker pull drupal@sha256:78956e3e01f8873b3f58351311658ea8a2268e0b38c5b9256e91865db7493a28
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192303721 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b768f54b7890e0cce0b0f76047c3a38a1784e254ab63988ab782ff22b35f9111`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 19:57:57 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 19:57:57 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 19:58:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 19:58:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e9a3b22a0f1fd6e2d77af2d28f6c31cbe5b06e09720673edb638f079554c962e`  
		...
		Size: 573.6 KB (573624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db392e32cc0f20fc9b133a90b7d383cda8180079feff885290ec3c780c22bef4`  
		Last Modified: Mon, 03 Jan 2022 20:18:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a44c2dfd6640a7022a655203ba256dcbc233dd7122eb0328dd876de7e4681012`  
		Last Modified: Mon, 03 Jan 2022 20:18:21 GMT  
		Size: 20.1 MB (20137067 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; ppc64le

```console
$ docker pull drupal@sha256:7376d03f06d3d6d4c8ccaa9261cdff6fbfd647116e805331eef81d0ff1c26c65
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190676411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be4a5fc96b62e90450483af437c6814d1bf2593d9e8a24ffbf2eca9891cb7312`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:26:24 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:26:27 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:26:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:27:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7b27b115ecb16a529e87d1adf7fe79535648ad747b4dbeb1ed0e20361b86fb91`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:134abde35cc966b02ac9b9740cc4906292ed0babb84b09824c80dcfc5ded5b3d`  
		Last Modified: Mon, 03 Jan 2022 21:57:09 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a472a6cce6d5fd0df2018be58cd093f3bb42884785768ed8adbec78e08e5f48`  
		Last Modified: Mon, 03 Jan 2022 21:58:05 GMT  
		Size: 20.1 MB (20137431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; s390x

```console
$ docker pull drupal@sha256:70c3f2b2136bc8f9fe553a723332ed8f62e65c5b07c3ab1b7d28892ad119b008
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166634091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:759fe82bef867fd05d3d3bf22e9b7c74d16c03fff8f083e29847fabff29db3a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 03 Jan 2022 21:52:27 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:52:28 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:52:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:52:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ef764983b12c1feb55b8ec0f26992bcadadce21444aabc70ca3c1579e444f044`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:051d237fd4b6eb358536d07edcc3b695440d5b95161c6193efb0ddf91a8df305`  
		Last Modified: Mon, 03 Jan 2022 22:09:25 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fedcbc8a0d1815035f71f7802677d7da5257d8626111ca8bfe514524a876bf1`  
		Last Modified: Mon, 03 Jan 2022 22:09:29 GMT  
		Size: 20.1 MB (20137175 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
