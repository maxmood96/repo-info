...
```console
$ docker pull drupal@sha256:058ba9566f201caa9220a8bb18a562f121a1055890df0d9a4d3d3d6c25819831
```
...
```console
$ docker pull drupal@sha256:a81333dd48dbf721fad03cd30b227cdc7325cfce297c8b55fb6b35b2cf9da954
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.3 MB (189300220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c88684145b23288acf7f035f40f6b7a5162d3d41df1ed899d772d1a6d1f2c53d`
...
# Wed, 29 Dec 2021 19:48:33 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:48:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:48:44 GMT
...
-	Layers:
	...
	-	`sha256:62a8f8b995d22d81c382980c8ace9aeaa0d8bca22716375544b5c5a0c4c6f67c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0dbccce84e472800c014f59974a491f78ba2bce0cb7436da47e81b54d2b3a672`  
		Last Modified: Wed, 29 Dec 2021 19:59:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:845f059227fdbbaf8ab3c56ca9f574a503cd92a4a398cccd5dba6b11f9209ea2`  
		Last Modified: Wed, 29 Dec 2021 19:59:40 GMT  
		Size: 20.1 MB (20137059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d544ff62ac1a24f9a46226ca477e6171b58780ed8f2a48185c7fb6570ad33595
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159085384 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fe8d5f27315367a842690b52f451ce7b2dcc97078cf5d0e2af71c3e9efbaa02`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 20:03:16 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 20:03:17 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 20:03:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 20:03:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7f32bd00a5919b2908c78d04af3e97931f03386fdddc5c769b965ab65aa0392f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c645000c0bed229d4fd773c3905791305309be646b241d207f45500782ed44a1`  
		Last Modified: Wed, 29 Dec 2021 20:41:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b46680060f776a31f2b2ed0972fe4d4941ebff54bd801eb29b873a8b47a0b25`  
		Last Modified: Wed, 29 Dec 2021 20:41:28 GMT  
		Size: 20.1 MB (20136960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:c9f674689b7a0cf4f0bf55debd389a8b2f12a0545a36d99c9560d4af57736de1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.3 MB (182298067 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:072c0294f3bf063756f4dc56cd9a633d89ba47759db00e19f7f334472ccd35f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 19:00:12 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:00:13 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:00:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:c0684014d0ced878125799d85a40bb18ec340ac43ff3432d76b3d9ab20938024`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9df28913a5c5fa4998f8f482d49af2dbe002cad29291158350b875ffc2a25641`  
		Last Modified: Wed, 29 Dec 2021 19:20:24 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20de17a74f6690db1201eefb1e21b302140210caa89a99f35c1bc9a095d981cd`  
		Last Modified: Wed, 29 Dec 2021 19:20:29 GMT  
		Size: 20.1 MB (20138043 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; 386

```console
$ docker pull drupal@sha256:fe3cd97470789c18a61ddb2f6c5150296184b7d25f39471e0433504eb9b63e06
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192303604 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5d6dccc657fbbec7d1cb0a9516521e6ec3feefbee806def5a4ce6bbd4d22adb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:04:27 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:04:27 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:04:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:04:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:308e0f89ded06b2ec5cb5236b8686161b7468a2111cf98d0a141ad81a6dc5c52`  
		...
		Size: 573.5 KB (573471 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:400f266f58074ac93ae06ac8b3dc1a54a471cc8b672ae35a0dfe014353cf0dc1`  
		Last Modified: Wed, 29 Dec 2021 19:24:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:428a3d70912690a7c7a824e1da78185dd1bd6d4257b0604cbc265311ac8f4fe3`  
		Last Modified: Wed, 29 Dec 2021 19:24:31 GMT  
		Size: 20.1 MB (20137103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; ppc64le

```console
$ docker pull drupal@sha256:5434683dd7a4fc9328bc31c9e155173fb5e4548ad04a21d8054a2622d04674d2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **190.7 MB (190675852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd1b984df4b2c6247c43b015ac4a3aedda6a35b328bb090ba565e86bcca1b557`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:cb800ca5699937940553385748d7365ecf4a056ab8a824b0a99111e8acad5faf in /usr/local/bin/ 
# Wed, 29 Dec 2021 19:59:23 GMT
ENV DRUPAL_VERSION=9.3.0
# Wed, 29 Dec 2021 19:59:24 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:59:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:799c8ea613b6a6cb39bef54fc5c3558fa5c131aa13a6c6a78aae965f748cb0d3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f54c0f5f7c79a8233fd6b267ece00aa8b20d8bf9e3b2138194011bbb14caf387`  
		Last Modified: Wed, 29 Dec 2021 20:27:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86e735a75519017203a2ef042020893aa76d4c77c9a690008c9f61483a7497f7`  
		Last Modified: Wed, 29 Dec 2021 20:27:41 GMT  
		Size: 20.1 MB (20137019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4` - linux; s390x

```console
$ docker pull drupal@sha256:8b7d3c0f5b092dbf2ff8b35831b5e59dcd8bd3e08c7810daa175247fd024af99
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166633711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5acdefc3c8e3ff25bd0bed74925622bde6b0709d4177c7f7eed61ce75120def`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Dec 2021 19:01:12 GMT
WORKDIR /opt/drupal
# Wed, 29 Dec 2021 19:01:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 29 Dec 2021 19:01:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:25bc57cc4c04cad28e85ea4183dae416aca01941f25b384bdaf8d7b994ec8346`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9d666a72e9b6181dc2e894bc5e753c5f2525c7896a83413b8df6fe57705cfe7`  
		Last Modified: Wed, 29 Dec 2021 19:19:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f85074562bc1b17c6d50e8892129f2ee796fb52b053916f80f252dc5e77c50fb`  
		Last Modified: Wed, 29 Dec 2021 19:19:23 GMT  
		Size: 20.1 MB (20136949 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
