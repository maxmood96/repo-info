...
```console
$ docker pull drupal@sha256:cd1d84607471e14578d87e613e7f2515a1f875053b31a2ab6cca8f180db063fd
```
...
```console
$ docker pull drupal@sha256:20fd08d5be310545a1eaed73a0bf0b70a2e3c19b5a2fa678f7795b9850253d27
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.7 MB (30706271 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e5bfb425b4fe8bf1c29430ab15673575a67aa99927c61d52e6af70c389f4a18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 05 Aug 2022 04:37:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Aug 2022 04:43:14 GMT
ENV DRUPAL_VERSION=7.91
# Fri, 05 Aug 2022 04:43:15 GMT
ENV DRUPAL_MD5=edca63fdcd0f2f138016773f2df637ed
# Fri, 05 Aug 2022 04:43:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4914eb447731f74cf4063f1d0a84ed70a8e2fec387b22aa45fbad21ffa6a1221`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3a598f065c776454f79f5a07c28ecbb755c64a57329b94e1cce1a1ac3d9cfa5`  
		Last Modified: Fri, 05 Aug 2022 04:59:20 GMT  
