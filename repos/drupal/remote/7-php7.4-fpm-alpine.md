...
```console
$ docker pull drupal@sha256:a13d6b979f6c50e5618ce1d61e7b403af6eee112724c382e27cef4c6c5e25703
```
...
```console
$ docker pull drupal@sha256:452d763a4e8062bd979c380ede0cfaa037dace8fb7d8511ae145b19522141352
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33774374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82529bdd957c703f1b12092f4d658288bc3ac714e054502e9ca4da61ee8567aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 18:23:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Jun 2021 18:25:28 GMT
ENV DRUPAL_VERSION=7.81
# Wed, 16 Jun 2021 18:25:29 GMT
ENV DRUPAL_MD5=ca21e214b3de1453e71f2eb1ab182c3d
# Wed, 16 Jun 2021 18:25:30 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8d4554a3a50a58865f54ceff98b443fc7073fa153dd4c9040ca2a34172be5605`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b3679cb9a1484aa6b7de8e9781a97a04bdf9457c92bfd1facafd2ef41991c94`  
		Last Modified: Wed, 16 Jun 2021 18:32:48 GMT  
		Size: 3.4 MB (3373245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:8d45af958fe9ab24ec5f2abad392b28cbec8a49118ecad738715009339d1cfce
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.4 MB (32369593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64d685585235774f0dad17626c301b3e5f17efe4b31d63e072f6832792714afb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Jun 2021 07:25:19 GMT
ENV DRUPAL_VERSION=7.81
# Fri, 04 Jun 2021 07:25:19 GMT
ENV DRUPAL_MD5=ca21e214b3de1453e71f2eb1ab182c3d
# Fri, 04 Jun 2021 07:25:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c25a1d3e76ee9be1655b94891a6fa59e6d5d0e2c8bc1c469d8095256b9220dcb`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:face2a10eb7e29e7995efd5955d98af8e80cb4649cb4c90ed26096e4a784194d`  
		Last Modified: Fri, 04 Jun 2021 07:50:08 GMT  
		Size: 3.4 MB (3373247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:54d21ec81f6cbbe04aabd4f6d59aacf14cc973be001eb180d9554e9ffbc137e2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34847566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6689fb158bc1fc358093654eebdf7ad676c858dd2ff9df481ad825418268dd93`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 12:35:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Jun 2021 12:38:23 GMT
ENV DRUPAL_VERSION=7.81
# Wed, 16 Jun 2021 12:38:23 GMT
ENV DRUPAL_MD5=ca21e214b3de1453e71f2eb1ab182c3d
# Wed, 16 Jun 2021 12:38:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:66e4f3b4467bfebaafff21f0b0ef1c9bd4a3253243b7af2648b20663df0d678f`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01d8cd38dd7ea6aa932dbb757065b057554749a3ca7d55d412289b20db677011`  
		Last Modified: Wed, 16 Jun 2021 12:49:21 GMT  
