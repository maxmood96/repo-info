...
```console
$ docker pull drupal@sha256:3e9f652a699175ff970670ebc7f43b804fa9fe167f4a3db4e90417bd08a5ca40
```
...
```console
$ docker pull drupal@sha256:ff2dd6be239114093edbc80618908bf9f5dc5686dddc950b7940d3d5a3c7f004
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.5 MB (34528063 bytes)**  
...
-	Layers:
	...
	-	`sha256:e542b20286a21633281c510e2616b126ddac79b3ffc5fbe10f550eeaafce011e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01ebc71158dfaffbba968b9a99020feba509834863975214ed6186fc6b4f9e54`  
		Last Modified: Sat, 07 Aug 2021 03:25:44 GMT  
		Size: 1.9 MB (1909815 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:717ed2eec12d8239e2b76f3c2f1bf79faaeefbb62acb8fe9d0ec226f425d3a3b`  
		Last Modified: Sat, 07 Aug 2021 03:25:44 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:236c94f4d66898ff4aa78e1e80b9b6eddfa8dbfec444f7cfdbbcfa07cc76627d`  
		Last Modified: Sat, 07 Aug 2021 03:27:00 GMT  
...
```console
$ docker pull drupal@sha256:211165fc41f7deb4095b4fb54aece1f9059d8efc59a30424c9b18e9e50465323
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31861670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6af6c3543df0547c3a41a11567c040057dfa55f0ad036be7a29f6edfc46c0c4d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 07 Aug 2021 04:18:14 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 07 Aug 2021 04:18:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 07 Aug 2021 04:23:11 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 07 Aug 2021 04:23:11 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 07 Aug 2021 04:23:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4586ae6d93e3c430c8ec8561587879cb8382af8c7e2d68d64197095cf5014c71`  
		...
		Size: 8.4 KB (8441 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1542b90f620c8c330b0310bf2b40c72491167f27f84d3b3cedf9dcc1a223e706`  
		Last Modified: Sat, 07 Aug 2021 04:40:23 GMT  
		Size: 1.6 MB (1625527 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acd069ce0c689ce10f4c1e2b2a2a40a48b8b4926b2a874f0a72621ba802efe18`  
		Last Modified: Sat, 07 Aug 2021 04:40:22 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82f9a8cbb012bb1ddf4ce661525386b64e771e34c2d1cc247c3de87e65da1655`  
		Last Modified: Sat, 07 Aug 2021 04:44:04 GMT  
		Size: 3.4 MB (3374012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cefc369d5b1716e68be9e03b64d6e5c7380b1eca2805b6ff2dd7bfff474c1a6f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34199588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa3f86bc9b31380c15b8516bc4e73226f29eeb3dc16d85e7ff4c0881c8e790ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Aug 2021 22:50:54 GMT
CMD ["php-fpm"]
# Sat, 07 Aug 2021 02:42:04 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 07 Aug 2021 02:42:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 07 Aug 2021 02:44:13 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 07 Aug 2021 02:44:14 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 07 Aug 2021 02:44:15 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:8aa14514ff6e0b16dc0ca37d08b06ade340711347e31443d8624ee9b35a62bc0`  
		...
		Size: 8.4 KB (8444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9527f02a625f4b183aa288654bcc16d2c04b98491af35c5bda2d9ea83293fa78`  
		Last Modified: Sat, 07 Aug 2021 02:52:58 GMT  
		Size: 1.9 MB (1900311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bbcb978cdcfc74e8122f35f4c48d85e18c32900e3a198a5c362d326a95af0c9`  
		Last Modified: Sat, 07 Aug 2021 02:52:58 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:532747de6f527ffb14998c32b79954716cc8e6b90ed48ffe133eef4b43db9b1a`  
		Last Modified: Sat, 07 Aug 2021 02:55:01 GMT  
...
```console
$ docker pull drupal@sha256:8f4798fecf8d7b855573d83e41dc95d386bea9e25b3bcab428942a1a9e533dc9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.1 MB (35140923 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81ca125bcafaafae819e5358409f8f754034d458b14d68ab06c9205ea2454ae6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 07 Aug 2021 03:15:22 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 07 Aug 2021 03:15:23 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 07 Aug 2021 03:17:49 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 07 Aug 2021 03:17:50 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 07 Aug 2021 03:17:52 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a167fee1e0cc9770138528d96a2298d3558b4fa22293153f51269846969a61d5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:beb03d1428c411c2892b659a90dd0ae2acd3a74fc1330cac98dd4ff7e94b0cba`  
		Last Modified: Sat, 07 Aug 2021 03:27:23 GMT  
		Size: 2.0 MB (2031434 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1db9d6fe103310d2c58641104804f2729204f113cdb752be935b6c2103b3533`  
		Last Modified: Sat, 07 Aug 2021 03:27:22 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c9f16cfac22716cdecb007e68f2478bd5faac5a5ee427f77528dd80b6fbd01a`  
		Last Modified: Sat, 07 Aug 2021 03:29:37 GMT  
		Size: 3.4 MB (3374017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:420c99cd6720d2f214c0701eee4b3b1450528bfa9d3efe63834eb33bdca7566a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.8 MB (35786451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8094d131be1163f4467d0886d3e1b6572023e8088596b23027ce6b36dea4787f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 07 Aug 2021 07:44:51 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 07 Aug 2021 07:45:11 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 07 Aug 2021 07:49:07 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 07 Aug 2021 07:49:11 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 07 Aug 2021 07:49:25 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bde2dbf399b54eca4596fdf3259a52269b59fb907a587b0815d0bd57a308ad75`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a672dbf141aa51c6da74ba2cce8373b90429f2a0b7a66deab8db78969551e645`  
		Last Modified: Sat, 07 Aug 2021 07:58:32 GMT  
		Size: 2.1 MB (2084780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a62a5cef14ce6558faa445a1d9a7a8bfc4d00d6b7c880e22c3e39133112e6e2`  
		Last Modified: Sat, 07 Aug 2021 07:58:32 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ece6335ba1f93dd8cc1e077d4b812a36e8a89de0556107362a031de99cf2b8f`  
		Last Modified: Sat, 07 Aug 2021 08:00:32 GMT  
...
```console
$ docker pull drupal@sha256:048bfa855d3b23497ebb578cb9a56ee0f88c5891342832240cc30f16b503ad34
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.8 MB (33777472 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b1a8739328b3aaa236c753c897f9f4d5852538b186c49cd41198cf29a2df449`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 20 Aug 2021 18:34:48 GMT
CMD ["php-fpm"]
# Fri, 20 Aug 2021 21:14:35 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 20 Aug 2021 21:14:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 20 Aug 2021 21:18:03 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 20 Aug 2021 21:18:04 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 20 Aug 2021 21:18:07 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7a498c224cec0e66c10884292d34fe1190de21c30c7cc75abf92e22ed1bdfc77`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:294265a65a0b08959f1f8d6f7af8359c1547b2c86ff5e0c1c167d49c22a1629e`  
		Last Modified: Fri, 20 Aug 2021 21:29:00 GMT  
		Size: 1.9 MB (1947384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:605add2d5f5684356a36554fb4ba24e28ef5371732d703dabd22665ac4863cf0`  
		Last Modified: Fri, 20 Aug 2021 21:28:59 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b757e1b5c1cd7336ec224f38dd3392574d55929c6fafe6ea1f293bd1fcbd8a3`  
		Last Modified: Fri, 20 Aug 2021 21:31:04 GMT  
		Size: 3.4 MB (3374017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
