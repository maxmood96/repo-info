...
```console
$ docker pull drupal@sha256:c5d97e0bf563d2a0e71c0ee3884865576efd031daeadee9db7bc9aad4eb38d67
```
...
```console
$ docker pull drupal@sha256:fcae9b9b9ef72eecde61e5d80784d8e9a9db1201522f77e016ba6cf0fdf95c90
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.6 MB (34602647 bytes)**  
...
-	Layers:
	...
	-	`sha256:9163c345c1f977f7930c687030b0f0141d6f21f1617559bdb6236fadb5df44a8`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82b70b769c54a60908ccd640e092b46046fcc9e3fdb27cd7522fd1ee6e0cb668`  
		Last Modified: Sat, 28 Aug 2021 02:24:19 GMT  
...
```console
$ docker pull drupal@sha256:d3d6f07881a2b3f25dbbb71fb5fc5e0ad9dd9f5096e9fa6ace850cec4ebcbd1d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33524326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17784840bc78040d35948092ab405942711440a9f4985a918ce26800a6f4f27f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 00:17:28 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 24 Sep 2021 00:17:29 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 24 Sep 2021 00:17:32 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:790a88e7ec1ec3b6f7608662909ae8b6fcb6e4b5436c75a395f45529f123e59f`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc4d8e0395afaae3031c6d2734f027a79c878749b1b2cffeb7c873bbcf4e5963`  
		Last Modified: Fri, 24 Sep 2021 00:31:00 GMT  
		Size: 3.4 MB (3374019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:250409f0abe99c0cf98b83d03ce0edf68e0928d87bc2c1400dfd9217fda80925
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31936217 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c82c2555447bec6d096fc37bb62f12851a069b426cadc9aba79aed38d9975476`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Aug 2021 05:09:44 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 28 Aug 2021 05:09:44 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 28 Aug 2021 05:09:48 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cf782974abab255d54abb8918dbb9fb616d3cf3858078bf8090898057f542d83`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f71a9d635e270134bfed28947212ff9a770e105643ae4cbc5c068b0c608f0ca9`  
		Last Modified: Sat, 28 Aug 2021 05:30:40 GMT  
...
```console
$ docker pull drupal@sha256:60fda7c63650e6e186a643285cd5bfaba74a5e2f59ca7ead12eb68a64939e37d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34270415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68009f29de9837d00927aad04786004122c5bd331f51a32414fc90a89ca67a0e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:ce2fd9aacbfd28b9db907d98900d2c462ab15cd8d76c087f507ae57dc2699b91`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cc4fad3f72d8afdfb8af0e0cac6934280f34d502b240d987d3f290611b8005e`  
		Last Modified: Sat, 28 Aug 2021 03:13:59 GMT  
		Size: 3.4 MB (3374015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:53056cd57888b50e72118f28499e5377335d6cbe24fa2694028ce0d8a32f9ef3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.9 MB (35861324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74c417a85016f4591eaf49c2204a1ddb58cccfe4ede91f187f3fa69034124c6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Aug 2021 03:41:21 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 28 Aug 2021 03:41:25 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 28 Aug 2021 03:41:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:21609aac974eadf1f3af6b8794a7f41903e665bdd7da97612636d6ae8849eaf7`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:022f20dce8e1be71873c890d4df1ea67e2491fd920f42d6301ac0ad2f107651a`  
		Last Modified: Sat, 28 Aug 2021 03:51:15 GMT  
...
```console
$ docker pull drupal@sha256:a392f5b21a4951b6ed826873ad14ffbbf6dcbf07a160b230e953adae5f5fe7c5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 MB (34104416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcfa5270e5af8f9e7d9b985ec86c2c164f6f691d3640fd4268f59b915253650b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 00:06:15 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 24 Sep 2021 00:06:15 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 24 Sep 2021 00:06:16 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:f81e738078111c37b34ca0ae539162d09dd8fc655527f00caed4f3fb60967f23`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:267768362d1a4e6076ab86126bca053d763b16715e33470a7434f766bc1a067b`  
		Last Modified: Fri, 24 Sep 2021 00:21:38 GMT  
