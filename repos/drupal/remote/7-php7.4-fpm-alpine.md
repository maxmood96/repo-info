...
```console
$ docker pull drupal@sha256:d3acbbe3ffd14564254d034ae0e5490d338e29d00879327bbff88c2ccfed4ca9
```
...
```console
$ docker pull drupal@sha256:f25250ebf6224da1d74a4259085a9affca18ce01857cf81e71e00468cbab9ff0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.1 MB (32097299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82a1669b421249927c4a4682fbbff761bbb15062ded2512f551a00bed6ed991c`
...
-	Layers:
	...
	-	`sha256:c62772b3e6b81718026c6d5a52691a27e8d653cb6a3dae2b66458f6add738f60`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88a4918129cb175906b2525795e4a80df7de2477d33b1b463177626a9967c760`  
		Last Modified: Thu, 29 Sep 2022 16:18:18 GMT  
...
```console
$ docker pull drupal@sha256:4c3373f07c5ca1da7b9a3ed9c810287ae3f447decd69e93ab07a67c23aec75d7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.7 MB (30721362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f35bb35ee195a79fbc7858f4c7cfbd633af23bd448034e38c2e79d3ecdc8076`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Aug 2022 01:47:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 07 Sep 2022 20:54:19 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 07 Sep 2022 20:54:19 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 07 Sep 2022 20:54:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:e2f418d7a29da6b8b0bd0496eba4d646eae9a63c77bdfe3f0165576bae3c7c83`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19ce84d26202e5ca393e303289e5f031d5d0c7f7bc8b7a6a3365b6ec0c27971e`  
		Last Modified: Wed, 07 Sep 2022 21:01:39 GMT  
...
```console
$ docker pull drupal@sha256:d751c33af6ee896ab0bd5b3838808bb4460f715a8c3b16ebf312f2d700f73635
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29603620 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:baf2fae90e481efa833aae70f77408a3b3567ae9c0497b61543a9ef9fad51ebf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 10 Aug 2022 18:19:25 GMT
CMD ["php-fpm"]
# Thu, 11 Aug 2022 05:08:17 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Thu, 11 Aug 2022 05:08:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 07 Sep 2022 21:12:15 GMT
ENV DRUPAL_VERSION=7.92
# Wed, 07 Sep 2022 21:12:16 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Wed, 07 Sep 2022 21:12:18 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bdba9263d658accf7dbd171fc652cce1956e6999ea02542337ee19165b893252`  
		...
		Size: 8.4 KB (8442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59fe20e3720a1aae5d23d934e53347120b3f9a7de6f7eee99755af10622a0652`  
		Last Modified: Thu, 11 Aug 2022 05:34:41 GMT  
		Size: 1.7 MB (1653360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90aad4216da0b5b2e2f81096f11396e5450255bcdc7e451b3e905e4ee776934c`  
		Last Modified: Thu, 11 Aug 2022 05:34:40 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88777b242a1d38f14835bede5a6b1a59e974ad0db4e25c608bf9f4ecfab9db9b`  
		Last Modified: Wed, 07 Sep 2022 21:41:56 GMT  
		Size: 3.4 MB (3397089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a86cd3831559089e29e9905e171eab11d2ceb9fd098ba51f31a63bd53c6e4c54
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.8 MB (31763290 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7104b92716ef44f1d4bd1700d8e3f291223ad69633024e8eb8d56ed997b27204`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.92
# Thu, 29 Sep 2022 16:49:22 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 29 Sep 2022 16:49:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:526b94ffaee42330b6b819c748b33869f0625ec467f6979531393bbb685f2d88`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:133c68eeccfa8ec74f956fa316aa85aeac1ad1aff39d699f77d37dc7dceabcf7`  
		Last Modified: Thu, 29 Sep 2022 17:10:11 GMT  
...
```console
$ docker pull drupal@sha256:7898c0aed8443eeb422587388281910baf3e2237174c3ee64355c9c0b47147c7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.6 MB (32629762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:343b56ba5a30759c53d620ae7e88fe4bf79bc62d092e54a5e885e1c503974b5b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 29 Sep 2022 16:21:41 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Thu, 29 Sep 2022 16:21:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 16:28:03 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 29 Sep 2022 16:28:04 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 29 Sep 2022 16:28:06 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:d5e2c03ef797de18ede58625b166dc675eba9163131948b7f9b8648a97cc3668`  
		...
		Size: 8.4 KB (8442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0be1c5e5e8378f03969459661d93e3716a0dcd8fc10d06c9dc16a012fdb8aa7d`  
		Last Modified: Thu, 29 Sep 2022 16:43:58 GMT  
		Size: 2.1 MB (2085621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5948d7fbaf58739ae77b4ff66468fb1ee5bdb37f8141de513df68e88ead380c`  
		Last Modified: Thu, 29 Sep 2022 16:43:58 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c4a4d252ee0911e92251153d654557d0a0c6d0f1348739f2d502f2768c5e49`  
		Last Modified: Thu, 29 Sep 2022 16:50:22 GMT  
...
```console
$ docker pull drupal@sha256:269a78a5e7356b44b647e3c9e5fc3c7aa2eff51e92c18ca549ffd6449b1d886a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.0 MB (33020144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c936a4926677984c34fb3e1b554a4ac43d03c38d8e0f4852955eeb558a0e88d9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 16:01:44 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 29 Sep 2022 16:01:44 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 29 Sep 2022 16:01:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c4111f04c4c95d269258e7bd2339b31adf0168ba507552a44e32a789f595315d`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:596c5f79961e5944e4671407b4a05dfc3deb30ca17df27e783b1897e2b56aa84`  
		Last Modified: Thu, 29 Sep 2022 16:20:52 GMT  
		Size: 3.4 MB (3397092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:21d61af39529fc7d850c5092880559f85d57eb4ade3073d7ad0bc5c87f627c4e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31513420 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f36a7dc46a4914bf303d51a638ab2482417f09ce757e8a4e8719792a66baca71`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 16:16:16 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 29 Sep 2022 16:16:16 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 29 Sep 2022 16:16:17 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:1fd8cdf8d44d8b007d36531bc08f4c76e58c101603d74792f37dff44e752fb40`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24751bcb10b7c44926adb3124d6bc2349e3c5d177d2f1ed1ee508d33464dd460`  
		Last Modified: Thu, 29 Sep 2022 16:31:21 GMT  
		Size: 3.4 MB (3397087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
