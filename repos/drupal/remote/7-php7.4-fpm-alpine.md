...
```console
$ docker pull drupal@sha256:2bfe4d0f951cd678434770816d94c0f72d4c0fc0d7a47e11f0013d52a9bf29e0
```
...
```console
$ docker pull drupal@sha256:03d6b82d7bb4c8f05a5039d97fad151494841282ed7bbc4252b2f63f85175280
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.0 MB (34995594 bytes)**  
...
-	Layers:
	...
	-	`sha256:5863298241ad724222e7e6138e30ccfe202ed5374891dcb3bbc4d8c53331ea20`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6e64324416e930d1a6f5aa8cf837092abf8f7e334df79c6e35be3aec2deb7d4`  
		Last Modified: Mon, 01 Feb 2021 19:34:29 GMT  
		Size: 3.4 MB (3359556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:ef81fb4f4d2ba6390fa2747ac39abfc65fd26219a35d4de45b027a3b7659c974
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.6 MB (33649973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3382e95fe5f351a970b30c99181484ac323a432e32049f9753d091aa798cf01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 19:55:42 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 19:55:43 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Mon, 01 Feb 2021 19:55:47 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a6f0f64c24b379d735e2aaccbe5445692f2a39e1879dfd74b34528dc18d33fba`  
		...
		Size: 333.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0a3c69f0b8ea93f4030da954305f78d52ad77fc70b15d1f869c5c26774eea78`  
		Last Modified: Mon, 01 Feb 2021 19:58:38 GMT  
...
```console
$ docker pull drupal@sha256:cb6a62edf6fbb9a05925ce0a1a29d9bf9a455ec59ff2c3d2ec4ec8d1fa0aa97d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32257782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:deded4f70ee01dcbf692048ffcc98d8f932e6cb88171ccd752214c6754a9c0fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 20:12:27 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 20:12:28 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Mon, 01 Feb 2021 20:12:34 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ba9d485f9cc6d9f3a769143de8c2fa273a2267beb6648d183234f8fe532744cf`  
		...
		Size: 332.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9608765d465620e667a2837b94ac20c9712e062f192bbfb5031d585a6a6d47fe`  
		Last Modified: Mon, 01 Feb 2021 20:20:02 GMT  
...
```console
$ docker pull drupal@sha256:a9f4ebdbaf421a5652c2f4275171b781c5ed16c3e76d965314f8e419d84fc88e
```
...
-	Total Size: **34.7 MB (34728641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d50ee8ae29d6ebada1534910585ce7689b5b48b94ad0314b99013315d1f14a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 19:47:16 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 19:47:17 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
...
-	Layers:
	...
	-	`sha256:f6e5e2431ac2f988175ab8a2abe8f0b6fd1e6c4976e1e795691fa359d7516c85`  
		...
		Size: 333.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:251f762e50a48c44c2943bcc5afd320ad47ed385b036f15326b5d2e33118ccd9`  
		Last Modified: Mon, 01 Feb 2021 19:53:56 GMT  
		Size: 3.4 MB (3359812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:07f6b0bfe0eba70f3dd505b65b301eae632c8b2a59204ad7b6e5c427db8ce352
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.7 MB (35668302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21088f7cbddaa104a667b23c6d7913c90070c48d52e44255bb30413d37748ab3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 19:44:07 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 19:44:07 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Mon, 01 Feb 2021 19:44:09 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:5349eb19db0655bba0afad0815dd834eb9d9aaa511cafdae1542feaa403ab535`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24a4f59c0628d6264876fd5036609522060a9999fc8179cfd610d956d42f561d`  
		Last Modified: Mon, 01 Feb 2021 19:50:03 GMT  
		Size: 3.4 MB (3359552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:ec43f4b497f9bee9e151ff8dd2230fb068f8bdea8212c7b70dd31db173a6d65b
```
...
-	Total Size: **36.2 MB (36218407 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b9a61df9bc6fc305c5bbc1e646c9a6b36cc395560d1acb9404ddb7cd7bf23e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 20:40:02 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 20:40:08 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
# Mon, 01 Feb 2021 20:40:21 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:dde9eab3e15b87f76ea9f320b59429dbf1118ce24ac9571a7d336d97edbdaf59`  
		...
		Size: 333.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1239be55bf4adb97770920bcd04d09851319a25885b8342f1e8ca112cd4699dd`  
		Last Modified: Mon, 01 Feb 2021 20:52:28 GMT  
...
```console
$ docker pull drupal@sha256:9a7211608594c0ecd033ff79cb9ad2dd10dcbe318a2c9d0c59d46317a5d378c6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 MB (34146141 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f66c1d4a4729f495369db077b0e2f622a88badb6c52f64b3b8728320bf5deec8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 01 Feb 2021 19:50:38 GMT
ENV DRUPAL_VERSION=7.78
# Mon, 01 Feb 2021 19:50:39 GMT
ENV DRUPAL_MD5=67c8e2974421e8d549ad705169977498
...
-	Layers:
	...
	-	`sha256:0691430004df3932f1a37a58021f91a43a254bdb7b414289cd8f2da459b93273`  
		...
		Size: 332.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f499d0e344a8ac87e845acd0abdbc129e2e8fc798a0c56c1c23070a533ac48e9`  
