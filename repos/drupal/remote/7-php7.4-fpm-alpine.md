...
```console
$ docker pull drupal@sha256:f8edadef9beaf07048380abb10db6c994df4ebb8087419ee77ad81ec173519ad
```
...
```console
$ docker pull drupal@sha256:a94398eaa9cedb23dd72e0e1090ce04991d28cd43b0981de53ffdda35416da8f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.8 MB (31808595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f60828059013bf83082b9e92ae6d8fbb6878fceae48242083fa641bdcbaa329c`
...
-	Layers:
	...
	-	`sha256:1a55adc01bd625225485518db800ef70ea69ed6a95d11e151818d52604764426`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a695eb349ebaf08ff0ecd7f465cea9f54aafa3319f327d53a8a987bf62fb2161`  
		Last Modified: Fri, 10 Jun 2022 02:47:26 GMT  
...
```console
$ docker pull drupal@sha256:0958b1bf3fe873bf3e9fe244e0946c9acdb58129524d4e65e38b646c187c2bca
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.7 MB (30688800 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbe5633a0947d4ce2c0964fe2f24489928aebb4ca4e762debab216a65c21e76e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 01:37:09 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 10 Jun 2022 01:37:09 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 10 Jun 2022 01:37:13 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:22482a8bafac0eaec61e8141e730d9fcc610b5c1cb47cd982141c25882e9eb84`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f801a28e47731db4ae41de6c311a49de662a58116a445bd98103081adf679c3c`  
		Last Modified: Fri, 10 Jun 2022 01:55:19 GMT  
...
```console
$ docker pull drupal@sha256:2de5b1455b4a0a444421fd90097be660523736efbac1b58f45783cd378a1a20d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29573919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a5304c519ae5435dbc03fb942ddfb2f255e66932ec0e4cd8fe0396cd396cc87`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Jun 2022 17:34:22 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 01 Jun 2022 17:34:22 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 01 Jun 2022 17:34:26 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:75d4133b6a4bc216f3ae1967ac5a83fd28b56a36384a16c6400e816cc431c1b5`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef9c64ff387b4e2a80a15a22ce8a1219088c10783ab5146a6581c0e1d8f23f87`  
		Last Modified: Wed, 01 Jun 2022 18:32:31 GMT  
...
```console
$ docker pull drupal@sha256:9b7a06f93d6eed668003d1e6a0c31908668ac4ef9ddaf827f9d31fa2d653b9d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31477089 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:676dd4b929e855fa61cacbd5b4ae8cd814775e7e01bf54ade2cd666138cf71e2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Jun 2022 17:03:05 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 01 Jun 2022 17:03:06 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 01 Jun 2022 17:03:08 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2015ee1cd84fb8ee1c4ef0b52542c8a14e5fcbf704e1736ea6440a25f44e6609`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bed915e7285c639ee29e346440ff03ec4bd8e528144667e36d477030e41efaf1`  
		Last Modified: Wed, 01 Jun 2022 17:35:26 GMT  
		Size: 3.4 MB (3388520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3e43420cd5ce1fe111c9f25f0bb83422013cb82c6f679d0154618bfdc86a1ec6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.7 MB (32717231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6ca90fcb1489c65e5cf1ddec0014f95d2774852674e0147255c8271bfd39df8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Jun 2022 16:50:38 GMT
ENV DRUPAL_VERSION=7.90
# Wed, 01 Jun 2022 16:50:39 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Wed, 01 Jun 2022 16:50:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:129e6713d982a9d2fa2f7584d3e927a40934261a6dd6554c70df44247ec3f748`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ada6f8905071fadf625c4e60492ec9cead1749aa051a2f55890cd5eaf738b382`  
		Last Modified: Wed, 01 Jun 2022 18:02:44 GMT  
...
```console
$ docker pull drupal@sha256:31d583c1c5db6888da40517e3cdaddcd0a2373befc4e8339efe8799bcb275936
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.2 MB (31221891 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:899ee39a5ad62e5d67698865caaaec5417d6128fb67c516bd57a9bcd635ff7ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 03:07:56 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 10 Jun 2022 03:07:56 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 10 Jun 2022 03:07:59 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:ac57378577fcb9cedb6c0d3cd1a5bdf520c9764df32d92c08fb530e52f2cfaa6`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eabd425442f711cd14bf3152f0eb7e8a640188055566dc48d306c17771d464d2`  
		Last Modified: Fri, 10 Jun 2022 03:40:14 GMT  
