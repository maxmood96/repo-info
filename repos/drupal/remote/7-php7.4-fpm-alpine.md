...
```console
$ docker pull drupal@sha256:0b5d6d8ca3027991cf0d3da387cfc46e0c70b1cc4811c090ee3107e99c0758d3
```
...
```console
$ docker pull drupal@sha256:33e80c41faf14b4c40d2ba7eced4eadca533e46f74afe9009405072e4a31506a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31949614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7b695884ddf41cb928fa507d2f7b9c6dce7f77bde4344a3fdbe262e082657ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 03:18:35 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 03:18:36 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 03:18:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c75067b44b620210d1c2c4520db54d49639d141eba300246ddf8c792155c54f8`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:375a26d0ad98c6a5f9f0988e30ec705444f256f8f95843bc1ce41853d13123e0`  
		Last Modified: Fri, 19 Nov 2021 03:56:44 GMT  
...
```console
$ docker pull drupal@sha256:da9cc1ebc661209a891e7cd07741cc3383294915f5efa9b6d0961cb212101df8
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 MB (34286390 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bc6f0624eee5db1e32e0b4015f78aa8e739c85b12dacdfb5bb0faaa211c4e5c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 00:00:43 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 00:00:44 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 00:00:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:987c92fe1ab2a29b3ef462290137bcd287a36da5fc17ba5cd781e5d1ca96d63d`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f07ddd4fb71734cb319c46638d69f5870eb3354b22c87a40774fed17058a0890`  
		Last Modified: Fri, 19 Nov 2021 00:21:34 GMT  
		Size: 3.4 MB (3373684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:90e6cb15741a64c05196bc135dfde820b7ca3d3e172ac95d3a0919a29ef3f551
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.2 MB (35220819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59a986b1794090b32b68aa710eeb7ec68525d043fe07ed3016fc76bcfc52b02a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 18 Nov 2021 23:58:44 GMT
ENV DRUPAL_VERSION=7.82
# Thu, 18 Nov 2021 23:58:44 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Thu, 18 Nov 2021 23:58:46 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4bc4e3d8578e1db4776d8f4168fb79348f95b7b314a53d64954c9b7eccf9526c`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d51e5ac1df3462e4e7d74820a464742bf0c963558bc161a595620c7da44adcde`  
		Last Modified: Fri, 19 Nov 2021 00:24:39 GMT  
...
```console
$ docker pull drupal@sha256:87f9b1ac5b7494bde056495281fc0fa817b18948e5c5134a928bf94fa466d3a9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.9 MB (35869813 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:557d9507fc5297cd5a4ad24a81a6f88f330fdb388caaceeefd6cb37ef97ec459`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 19 Nov 2021 08:20:52 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 19 Nov 2021 08:20:56 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 19 Nov 2021 08:21:03 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:898336bc873a43ca3f204684c7e1fb3392fcaa1393dae13404d02c6e05af7445`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ed11fbc3ff777237c9f1bf8e50ee4ea5fb076a344c61c21ca26a73926e532e0`  
		Last Modified: Fri, 19 Nov 2021 09:11:17 GMT  
		Size: 3.4 MB (3374012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
