...
```console
$ docker pull drupal@sha256:633d93d71f64344d5880e31731ec7bf7674f6d6ccfc4aead417ec5406a342d45
```
...
```console
$ docker pull drupal@sha256:c278862978e399edd263a15ebc24790a133d17e4df24149b61f7ad6dbc168782
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.0 MB (30965303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5bf1a68e6ee1ff7512cd33f3c15673d1ae086a796c4205a662e7f2c6b75fb19`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=7.92
# Thu, 29 Sep 2022 17:45:40 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 29 Sep 2022 17:45:42 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:9291351af797bd120c5be0a9508982542fc1bb7cb4ddf9af6d31470150ef0695`  
		...
		Size: 321.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4659c54f9dbd8e85965e621ef9fd687a42e1789452ef0f117ea367e728b8455c`  
		Last Modified: Thu, 29 Sep 2022 17:53:45 GMT  
		Size: 3.4 MB (3397085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
