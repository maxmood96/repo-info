...
```console
$ docker pull drupal@sha256:d2040f72fcba7c48e14b76b015bcf1ef1ce8a46822f07f1a275e0259f8b6563a
```
...
```console
$ docker pull drupal@sha256:247dd24037df04fca462cd6896d4770b8b5d07674f485845351e7cc599b1e9f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31477270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fd797e28cc6dd4be9ed7ed661bddd2339053b0e1c8e675c3b74207158232222`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Jun 2022 06:14:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 06:22:28 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 10 Jun 2022 06:22:29 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 10 Jun 2022 06:22:31 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:52312ccd7035781860c534f0ab9dcded90f9e977df27a385e3bdf1961b74b462`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5779e4c4a7da9e6eb4deb7d5ec021853ae986b1437dcc8bf10312db2f9b008c4`  
		Last Modified: Fri, 10 Jun 2022 06:54:07 GMT  
		Size: 3.4 MB (3388521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:d5c0612ab8bc07cea0eeaa74c5c26b598e82e6ab0265d4367dde2437a18f2dcf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32314713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfbed14aa50238b49e90da038fe6d388e4fc4aaa0f553ab41ea566d1e5c7b79c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 04:11:32 GMT
ENV DRUPAL_VERSION=7.90
# Fri, 10 Jun 2022 04:11:33 GMT
ENV DRUPAL_MD5=4cb30e74d1b57ef32d8efcd664e32f54
# Fri, 10 Jun 2022 04:11:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:4d1c1687c3f28ae2c6625b80598e45783651eb3914e434f87f399771c99b17bb`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4571d32a492cd06143a4fcd89da000ed1e35174c864867bf6e464ec52144c197`  
		Last Modified: Fri, 10 Jun 2022 04:45:03 GMT  
		Size: 3.4 MB (3388521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
