...
```console
$ docker pull drupal@sha256:929e2e20348c1d1a18c5b19ea27f4c5510194dac48026af4b1f2d154efc73f41
```
...
```console
$ docker pull drupal@sha256:82c69bda5ac53d0620f5d882d772c0c9fb39f4608abb05f39da928007eacc1ed
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.2 MB (33214031 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de35d003823cb59a4f95281ca55153a2ad4b35c325d8e9f23b5333fb857ac9e2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Aug 2021 20:56:07 GMT
CMD ["php-fpm"]
# Sat, 07 Aug 2021 01:20:07 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 07 Aug 2021 01:20:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 07 Aug 2021 01:22:19 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 07 Aug 2021 01:22:20 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 07 Aug 2021 01:22:23 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:bd42ba338feef201f8c667cf41ed43b97f2e02290f027be60cf4a77175f66a9f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b98a4145a96432c13297fa6c977b40863999501be50ee308ae2218bc4fc297f0`  
		Last Modified: Sat, 07 Aug 2021 01:29:44 GMT  
		Size: 1.8 MB (1794971 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc3e0170c49da5f969d8635b063f52f1c227f61a7225995659dd341170e471ec`  
		Last Modified: Sat, 07 Aug 2021 01:29:43 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b4cf4b20540387030945396f7eea1e1966a90f9b4c5d75e38f55f11cdf35bde`  
		Last Modified: Sat, 07 Aug 2021 01:31:30 GMT  
...
```console
$ docker pull drupal@sha256:09f951bee1f7de840cfef00c24568962160bdd3b19cc5f94e1953662226997fb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.9 MB (31860259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2abd77d1a1104044830593989bb1cabfd26102c7abcd83d7221d3737c034ff8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 31 Jul 2021 13:59:38 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 31 Jul 2021 13:59:39 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 31 Jul 2021 13:59:43 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:b0a751631d2912c58c0b7f0fcbd5b2bd6fbb3ece0c620449759a490b4c959e9a`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de199cfc523577a1c0eb19e3d0a81eed2c7f6811ab55a8431e3d8d43e27f0c1b`  
		Last Modified: Sat, 31 Jul 2021 14:25:39 GMT  
...
```console
$ docker pull drupal@sha256:c462f23aff6803018f65e292fbf037315d161ec741f02a9f8d149fe4e34034fa
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.8 MB (35785688 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a664f53708cfc346a86d2b5bf672867e80694f673f1b4b5dd00c2e93e76f1a95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 31 Jul 2021 11:27:28 GMT
ENV DRUPAL_VERSION=7.82
# Sat, 31 Jul 2021 11:27:29 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Sat, 31 Jul 2021 11:27:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:3e38fb8644a94bb570182782557897f0903a054e9f18de78d560b11be51fce00`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a78dd20e7a2a0278539c6826e2e523cb890527c99148a61d1f4fc414d9c09546`  
		Last Modified: Sat, 31 Jul 2021 11:45:32 GMT  
