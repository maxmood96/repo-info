...
```console
$ docker pull drupal@sha256:c50efda292e7918035b6619d2063629d7d43aacadba4fb7946604de9ae747105
```
...
```console
$ docker pull drupal@sha256:dfd7d8d5941f40501051a978a6012aaff07b8d2f76c0efd1097ee3efb08dc868
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.4 MB (33398684 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b59c6f9365e493f75b5bd489377fbbde418d91b327fe42173e506227f87f9264`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 12:54:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 12:58:11 GMT
ENV DRUPAL_VERSION=7.92
# Fri, 11 Nov 2022 12:58:11 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Fri, 11 Nov 2022 12:58:12 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:fea3a03d92d4aea954c4ee33d5012692a8f473509dbe01de5548826a26ea7dbb`  
		...
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:976df510fb29fc8aa58c94dff7a6e25e2c1d614896b250b8c717242380a4b36f`  
		Last Modified: Fri, 11 Nov 2022 13:12:06 GMT  
...
```console
$ docker pull drupal@sha256:f33a1d1f062c37c2cb91b9e57a8f8410462b5ecb18919eff60ab88d6d5c6e2b8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34233632 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d786915fd059f8e509aec00e5867eb44bbab3f6c471bc73753859750332fa22`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Nov 2022 18:12:26 GMT
ENV DRUPAL_VERSION=7.92
# Thu, 03 Nov 2022 18:12:27 GMT
ENV DRUPAL_MD5=7f95bd4a6693ed5215aba4038c23c933
# Thu, 03 Nov 2022 18:12:29 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:cc70c70ab78f269433dc4c2a7eb7437c4dd296571d875bafa758bfd255389bec`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da8b1380423c71dcbbce82370466adf10a8150574c75d82bec73f1b7ec13f26`  
		Last Modified: Thu, 03 Nov 2022 18:34:43 GMT  
