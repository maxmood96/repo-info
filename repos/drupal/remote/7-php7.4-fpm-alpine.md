...
```console
$ docker pull drupal@sha256:df385dc63bb7dddabefe7b6abd4f63583f7ff05165b95a63441b5868d047aa8f
```
...
```console
$ docker pull drupal@sha256:c37bb4e035b49f0c1132ea8972ceaaca8c3b23e51020e0945ec997e92b451e76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.8 MB (29757810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e0353afe02c3556e0bb622a07cb252912bc1ac0c6575dfbddb76d581c5a0039`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 24 Mar 2022 07:47:10 GMT
ENV DRUPAL_VERSION=7.89
# Thu, 24 Mar 2022 07:47:11 GMT
ENV DRUPAL_MD5=924e707e3b1e8269fe623cf2f22ee710
# Thu, 24 Mar 2022 07:47:14 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:916cf18ce976cb5bbca1d7c2a5e004adbf752045a7dbd4d8206a2199e716eadb`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94a35dcbea77c6d16bd59695ab9e10c02fd4756f37e0833f903a0fc1f962cf4f`  
		Last Modified: Thu, 24 Mar 2022 08:14:04 GMT  
