...
```console
$ docker pull drupal@sha256:2f4059e824c51722e3c79960359acb5d342cf51c72432c8210473be3e2b400e3
```
...
```console
$ docker pull drupal@sha256:c43e8c71aca17a1084d4e0a60e1a991237233295e16d14ee65911c5424952e7d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.8 MB (34845386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4baefa8f8be36ea8f8d7b182f0ba54979fd6648113aa176985c79e5c925eab1f`
...
-	Layers:
	...
	-	`sha256:497b4ed2c48695dc49b470d4cdd2d63f324b8119566b54ad6b441e6b36e73b08`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edeff288e1f433933a9ed61e54eec1197a9c9fe60bbc2c99e22e18929c1a48e7`  
		Last Modified: Fri, 24 Sep 2021 03:15:52 GMT  
		Size: 1.9 MB (1910338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:874b45a1fbffce34d1328a43db052ce27b7d1700102eacd33f45dce84a294e6a`  
		Last Modified: Fri, 24 Sep 2021 03:15:51 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9470a1652d5a6bdf5c3356131a03cd9d79f6f42c0229e207c72b33b22d6836e0`  
		Last Modified: Fri, 24 Sep 2021 03:24:06 GMT  
...
```console
$ docker pull drupal@sha256:07430bf7950212bd8199b08e96582920a2eb36b27dd019fb9ee85a2fe9d2abdd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.5 MB (33473220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfe2b883a1733eb2266454dc7e109f079c78846dbcee1a6e1d9e0830708f53dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 14 Oct 2021 20:51:30 GMT
CMD ["php-fpm"]
# Fri, 15 Oct 2021 00:17:12 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 15 Oct 2021 00:17:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 15 Oct 2021 00:23:46 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 15 Oct 2021 00:23:46 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 15 Oct 2021 00:23:49 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:2064bb0d65e56081b257b258547cebd4d56b8904892ebdd4e9af9a485830b7cc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4cc5fa5705a705a68316720bf93dd9ea482e40a579f0e568bf082606c36a402`  
		Last Modified: Fri, 15 Oct 2021 00:32:05 GMT  
		Size: 1.8 MB (1759566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9708e6ef24d74edcd1aad088b492796567d392779cfc08e0ee6fc4bdd4236c7a`  
		Last Modified: Fri, 15 Oct 2021 00:32:04 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d22943ada2f618adad5ef3ce0c0a7023a21ef555fbf78fcf5838d3f1ccc92c0e`  
		Last Modified: Fri, 15 Oct 2021 00:37:19 GMT  
...
```console
$ docker pull drupal@sha256:21be0d6e7b712bae77fa724918c1865b60049f53955a76ff753eedd7b3406dce
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.1 MB (32148859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0077a69f72cf19e19727239d0ff2cace4630431184be44f23ee7437616777943`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Sep 2021 23:56:35 GMT
CMD ["php-fpm"]
# Fri, 24 Sep 2021 04:38:11 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 24 Sep 2021 04:38:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 04:52:20 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 24 Sep 2021 04:52:20 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 24 Sep 2021 04:52:24 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:de6dce4cf7b24eeca1c603b99b94c0c7dce3c76516d93d600bb6f42510cd6f51`  
		...
		Size: 8.4 KB (8444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0f8218ac73d5598ffafae64d7d4f6a03100b92fdc85b4c9c0b650059ba17114`  
		Last Modified: Fri, 24 Sep 2021 05:16:03 GMT  
		Size: 1.6 MB (1626472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d732bfc9c8e2e1a96014664f1447d191581e7d4181e8ef25e70a63aa8d7556f`  
		Last Modified: Fri, 24 Sep 2021 05:16:02 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec97b17b18096278c481394d72ee10bed67b8aa34583f38ae7ea033bac5b7eae`  
		Last Modified: Fri, 24 Sep 2021 05:30:20 GMT  
...
```console
$ docker pull drupal@sha256:d41f336e7c530bde1b640b37b6241333fd2f5f13e242004c8a15a116d801163f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.5 MB (34521253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4692e1fc3c8326995ae266ebd6b9b4e9d1ced3cfefdb3b7adfb6659a6e5483c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Sep 2021 23:26:45 GMT
CMD ["php-fpm"]
# Wed, 13 Oct 2021 13:36:35 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Wed, 13 Oct 2021 13:36:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 13 Oct 2021 13:46:32 GMT
ENV DRUPAL_VERSION=7.82
# Wed, 13 Oct 2021 13:46:33 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Wed, 13 Oct 2021 13:46:35 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:de6bb833c7927ea9b58136c4b9dc5d37e536c6d7bd1aff9c7cbfcb825a6287e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbf5676c204478b3bbf45aaeebf20f5dc7e364755e618bb87f5e05e15f3b0471`  
		Last Modified: Wed, 13 Oct 2021 13:58:24 GMT  
		Size: 1.9 MB (1900629 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57ced805e8b6b2ca7314e356f61d4f4405b4dfc890e711ebf3ae6a7428de75a3`  
		Last Modified: Wed, 13 Oct 2021 13:58:24 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6498ee4f94187d8b083fb83ea93ed1fa49c2f901fa407c0862bf96c2a9b5ad0`  
		Last Modified: Wed, 13 Oct 2021 14:07:25 GMT  
		Size: 3.4 MB (3373686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:7-php7.4-fpm-alpine` - linux; 386

```console
$ docker pull drupal@sha256:e2da09df4e6bf53509a04c94fa05917fbfabf88e46d632cb76e97681bd1f20d3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **35.5 MB (35489348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38c12adcb378f0034deee1fd4848d2b36826842ae1825a5bebe6db45fd8c04ef`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 03:24:51 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 24 Sep 2021 03:24:51 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 24 Sep 2021 03:24:53 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:a35ad4286a812db9983ea0adf2cac7533a5ba606d825439616f6a017211f6ee3`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47bb770ba97b4e7bb1c1b092e75e86f8e472d11b5bbe01fb36499921cae72ccc`  
		Last Modified: Fri, 24 Sep 2021 03:50:38 GMT  
...
```console
$ docker pull drupal@sha256:0bb66517f16e8ed8ae7127f091a4c020db4983259988b2bf9fdc11c590410074
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **36.1 MB (36116673 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc7d1113c78260862035d608cd5897c5899d7d72adf1dcd08d16772704308c30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 24 Sep 2021 11:20:08 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 24 Sep 2021 11:20:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 24 Sep 2021 11:38:12 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 24 Sep 2021 11:38:16 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 24 Sep 2021 11:38:39 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:7c87ffc7b33caaa3d7f183c872832afe5bda50bcf7da7b96cfd3a1e29c1c070e`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd8848af259c5d51c45b28b8a709bf73be957f1131d7c74edcea84aee94bd037`  
		Last Modified: Fri, 24 Sep 2021 12:26:39 GMT  
		Size: 2.1 MB (2085530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff50f1776727db3f3f8f045d4488f9d22ff8674ec05b10079b47c5e1de312526`  
		Last Modified: Fri, 24 Sep 2021 12:26:37 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:741168c0d586fa9126ad4e546655b2fc425b3248f92b574de1daaa8e97c152e8`  
		Last Modified: Fri, 24 Sep 2021 13:13:18 GMT  
...
```console
$ docker pull drupal@sha256:14c390d1703381994cec6b8691563b0233130e1c75d07509f7107efb1d7cd130
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 MB (34060722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d5efd2b7ec8de397503994e3bee155d0657bd2cb29b2a5a3fab480224902373`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 15 Oct 2021 00:11:56 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		coreutils 		freetype-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr/include 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .drupal-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 15 Oct 2021 00:11:56 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 15 Oct 2021 00:18:43 GMT
ENV DRUPAL_VERSION=7.82
# Fri, 15 Oct 2021 00:18:43 GMT
ENV DRUPAL_MD5=51f8515161087935662b9835194a779b
# Fri, 15 Oct 2021 00:18:44 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:415b2d4d560310481b50af67206ca3d906a3461dece236931ecf822793801216`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21afd18e44f152fa14c0b695ded0324e3eba93ffe0fc5024064ab4bd0aea9853`  
		Last Modified: Fri, 15 Oct 2021 00:28:24 GMT  
		Size: 1.9 MB (1916193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f229b27906578e1aeaa5eec9475cc799530a2e160b6b797c2dc07bb1bb0f0d94`  
		Last Modified: Fri, 15 Oct 2021 00:28:24 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d510a18e728c50762522c6ca022c50ade931f39f11f5f53d55877d02fae18a1`  
		Last Modified: Fri, 15 Oct 2021 00:33:32 GMT  
		Size: 3.4 MB (3374012 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
