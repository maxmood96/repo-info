...
### `drupal:rc-php8.0-fpm` - linux; amd64
...
### `drupal:rc-php8.0-fpm` - linux; arm variant v7
...
### `drupal:rc-php8.0-fpm` - linux; arm64 variant v8
...
### `drupal:rc-php8.0-fpm` - linux; 386
...
### `drupal:rc-php8.0-fpm` - linux; ppc64le
...
### `drupal:rc-php8.0-fpm` - linux; s390x
