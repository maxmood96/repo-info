...
```console
$ docker pull drupal@sha256:7e7a5a168c47d996620960e673fb6b7e08184b5852ab102e5b0ac2609289205c
```
...
```console
$ docker pull drupal@sha256:8183874a845db6b636b66bc2d0e0de5b88a2e66e5b1d0c9f30552379be686d7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50640088 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d79d1fb4b5f6d256e4449351648188182142df66720c81397c5114a4c795c2e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Tue, 29 Mar 2022 19:08:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Mar 2022 19:08:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ffb52103f8b52935569f027c7b26485bf1b157b18739aea5a2b74689b80ea5ed`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36c9e8009f435d928efeee55b25c8586bbcddb787dbbebf102a7e4967b4fbf0b`  
		Last Modified: Tue, 29 Mar 2022 19:34:09 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca2138be55f3dcb3b0b3752b2d025c50f02405599a9829aec863fd4aa2aef67f`  
		Last Modified: Tue, 29 Mar 2022 19:34:14 GMT  
		Size: 20.9 MB (20938615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
