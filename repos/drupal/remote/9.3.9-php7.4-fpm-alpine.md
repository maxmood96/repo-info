...
```console
$ docker pull drupal@sha256:685c80fd44ece0eec12138aec3c2a74cc9a47088d55729c17d5d86d69d9dc25d
```
...
```console
$ docker pull drupal@sha256:8a14627a193dc25172e13d451a5d1b406d75928fcfc4b810fadc501538eeb717
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49014798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb384d8bbb2234ab038917304a38b20c4ed9c95b7f1f752178aa828e8e3688b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 24 Mar 2022 02:48:40 GMT
ENV DRUPAL_VERSION=9.3.9
# Thu, 24 Mar 2022 02:48:41 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 02:49:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 02:49:13 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b4a59e12e413d07d576ce7e7934ab6cc96a94cfafd43302dcefc6dee4dc1fa27`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a274aeaf775b46162b3008306e8c147944a08d2b5695791629b420dcca7149cc`  
		Last Modified: Thu, 24 Mar 2022 03:00:28 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbe9dd0d583f7e45c0a10dca8892a500bb484ba98af8b679ad2e5aa0f4b09024`  
		Last Modified: Thu, 24 Mar 2022 03:00:58 GMT  
		Size: 20.9 MB (20938029 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.9-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:962cbd54a11243c35f85d878cada774f5e172570430c7336ed07d7410e4715a7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.9 MB (47888222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8aa1190c93a652b17353e8b09a598f31633a36948380b0a6d7d724862dc998d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 24 Mar 2022 07:40:59 GMT
ENV DRUPAL_VERSION=9.3.9
# Thu, 24 Mar 2022 07:41:00 GMT
WORKDIR /opt/drupal
# Thu, 24 Mar 2022 07:41:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 24 Mar 2022 07:41:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe33374b2e762ea5df78dfbd46e51e149f933e9a58ff204c792c17457718fbce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3871f5dd9d4a58c8f252b83578bacf09b85092221b77726ad989fcce3def30d`  
		Last Modified: Thu, 24 Mar 2022 08:09:01 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d6b03d84554c5f18d7df73ce010d617d20e360fde515474dc469c0e6ce47204`  
		Last Modified: Thu, 24 Mar 2022 08:09:31 GMT  
