...
```console
$ docker pull drupal@sha256:652e6f8930ddafbbca8a5188e29ab1aff6b15465d8c22065a228af0724770053
```
...
```console
$ docker pull drupal@sha256:081e7176382cd4510e2e041cfd2769f0f62ee24f9831e8efd842488ea63e14b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50263495 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75b825a8c17611078a890094e67e00b9a68df31ffbfde3624012892692adc8d4`
...
# Mon, 04 Apr 2022 22:13:11 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:13:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:13:22 GMT
...
-	Layers:
	...
	-	`sha256:c1e6174167bcbd598bfe7ce4d2d0502e0d21a75e6fb859697fd4e5585d5fdb81`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a83c010f6d37dcc6b2d69c8892059739037c0ff82b02f461e67ae549700f05ee`  
		Last Modified: Mon, 04 Apr 2022 22:30:40 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:336a97db7d498c6c2a3ed962afe20c4b81e570994bb7b865a3b9e4f4d548d607`  
		Last Modified: Mon, 04 Apr 2022 22:30:45 GMT  
...
```console
$ docker pull drupal@sha256:53ff82f11d5ef919a92cf6563379ad27cc736afd454373e0fd9964012e722bfd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49097433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fe38d22c7399e7f968f5341ef45ff90f37dfa774a144c8d741172865228e0cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 04 Apr 2022 21:13:07 GMT
ENV DRUPAL_VERSION=9.3.9
# Mon, 04 Apr 2022 21:13:08 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:13:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:13:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6e4905a20ab2b36d9aa236b5edea995cff8dedcbdbe789d6b3d1224bd86f00b1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5c537d79d998c7ede846d4b9f7aec703499ec62155e8d28a7a1184a9e6641a2`  
		Last Modified: Mon, 04 Apr 2022 21:28:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37ee60ffc17b695f3c45923ffc428cce51a3627db90a1ec7182a8af2a2dcd3a9`  
		Last Modified: Mon, 04 Apr 2022 21:28:40 GMT  
		Size: 20.9 MB (20937662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:83b4130b11f24617655fb0443ea97ca8ff309bf4d17166ddfa5275255ea3d6fc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50724069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d5c790d20bdf3932c7c55c62cc815307dfcaa88ed8a71de41b2138c9a97e8a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 04 Apr 2022 21:03:16 GMT
ENV DRUPAL_VERSION=9.3.9
# Mon, 04 Apr 2022 21:03:17 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:03:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:03:29 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bc569975232e00d7c7f12a922dc757acc6bd16a26a0725b8a276da3b8ea06449`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fac898c00afe73574845737aec3c166f37e7676a356b8b1c50fd1a2b587fcd25`  
		Last Modified: Mon, 04 Apr 2022 21:28:23 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c279cf0c8adad22ac514107833216c3551315c65cd478570c3dd997dcdd91a2`  
		Last Modified: Mon, 04 Apr 2022 21:28:30 GMT  
		Size: 20.9 MB (20938210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:dfccdd849a0f0a25ed34884672fa2126c282e5e1a19a870ce82a9b0aec288ad9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49697167 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba1922ab9dfcdc7d3932feed70ed37002de9c2d242a4cc41b58763b99db658a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 04 Apr 2022 21:09:34 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:09:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:09:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:68775a4e274b9d2bd3af2360f17893615ad0d115adc8af42cf2ee0c25fc63577`  
		...
		Size: 660.1 KB (660102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b62c9fc7c22a3e3635c218d2eb508f7b514dad64ac47432b17814858cd5ca768`  
		Last Modified: Mon, 04 Apr 2022 21:31:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b45103f63d363fabd556b133198dd9049a786fe10213e5fbe93a78dc855de2d0`  
		Last Modified: Mon, 04 Apr 2022 21:31:47 GMT  
		Size: 20.9 MB (20937729 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
