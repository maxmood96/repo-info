...
```console
$ docker pull drupal@sha256:01db31a0cb3c5c74d6d19a3439bc0875c2be01c6a1fdaa5772c14874b78882e5
```
...
### `drupal:9.2.17-php7.4-fpm-buster` - linux; amd64

```console
$ docker pull drupal@sha256:921ad7c0b758f389060f7786a3d87fc95dbbae75c3970dfcb0f70f41675c9b0c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161190065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58080635a11a2637856712ddf387b602e267696188d3ec38a443263eb22ba725`
...
# Tue, 19 Apr 2022 02:28:24 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 02:28:24 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:28:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:28:34 GMT
...
-	Layers:
	...
	-	`sha256:c78f0adab21639f3deab19c092ae7b829fea3a88a59aa4d91a7acd37858aaf03`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aae689dcb66d1afc43e966f1deece2752e731278e1ebc8fc4b36a7512974645f`  
		Last Modified: Tue, 19 Apr 2022 02:47:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36ccc142c81fa9cecb35babfdf4fecd35af3c17cbd8d269dc397cd83d8afba7a`  
		Last Modified: Tue, 19 Apr 2022 02:47:48 GMT  
		Size: 19.1 MB (19115712 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php7.4-fpm-buster` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9213e5228095537e1ea7c3d44861314759f3b0ed7e8a9e0e8ef4302dfb159849
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137420192 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53fa78974324d7e2780a4d1dee06ff9dbd70362a466bbfe296ef4a0edf9900ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 00:23:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 00:23:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:13f162b11051a86cd9506be6a919c823cc4fd9f129724130d7b0e84d48232f31`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97622cb25bcf730c1b4dd94f34bd2646973602a3645968767bd0fa2aba8a3768`  
		Last Modified: Tue, 19 Apr 2022 01:12:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a76513bb94de09ef066e6f8fb55dca16168753722326296bf1ed0f5ee427b81a`  
		Last Modified: Tue, 19 Apr 2022 01:12:46 GMT  
		Size: 19.1 MB (19114653 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php7.4-fpm-buster` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:b99f924aab99a4d1489edf8c63cda7f14ec2213a1e5ca4a8f0c7591ab1869e1a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.8 MB (152782705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ba97e14b82baaef133e852509e2895891ab1e9dcbcb3d3b5c5a59c355eb48cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:58:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:58:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d6d735e25ac24d48ee29ac13e38fd916b280a80ccde601688483e6f71b5c62fe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:128880ab09753139cf5a6017a2cbc2d146553028f50f26468a871a28e4e40900`  
		Last Modified: Tue, 19 Apr 2022 03:24:23 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f0eace4776a17fb3985bc23c964f5f1276c19cbcb74b1333182d0405c83b177`  
		Last Modified: Tue, 19 Apr 2022 03:24:28 GMT  
		Size: 19.1 MB (19116650 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php7.4-fpm-buster` - linux; 386

```console
$ docker pull drupal@sha256:8ffcf1af2f37096a786334300681a3333e5ad8d8e8ed128ac9f90c187a13203c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166322214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed5accb5270898bc731756f8491c963622a8386d27b6120251a4f2207aaedf15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 19 Apr 2022 02:22:26 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 02:22:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 02:22:29 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 02:28:39 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 02:28:39 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:28:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 19 Apr 2022 02:28:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1d2417ca2238fd749c967b090139519de3f99e5002f94dce8278e16e25ba6956`  
		...
		Size: 8.4 KB (8448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e03ad0879b242f693dc077e364b993a8c5bf1882541e759aeca144180f8780a5`  
		Last Modified: Tue, 19 Apr 2022 03:56:17 GMT  
		Size: 1.8 MB (1755560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29a4d21f014dbae9501e58e0bf0978b7a3e9a4e2316f1ae89abc267349c18597`  
		Last Modified: Tue, 19 Apr 2022 03:56:16 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deaf2750d004fd5f3cd7e4a4e3d890349a8eada51e054540d62fd1cbc27568dd`  
		Last Modified: Tue, 19 Apr 2022 03:56:16 GMT  
		Size: 661.6 KB (661588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe6a99d3c876c17065863ee860665cfeeceff7cf4312e586dd55b329e107b2fe`  
		Last Modified: Tue, 19 Apr 2022 04:02:32 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56b22f558429632d3f616af918b3307eddcf8b09838557e382fbb259851985f8`  
		Last Modified: Tue, 19 Apr 2022 04:02:37 GMT  
		Size: 19.1 MB (19116468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php7.4-fpm-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:82f26e702f3d14c7e4571b5f7b9fe030aa1ccadf3cd45bf1a7f29a27003f3d0a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171694959 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:829e47ae8066d580b47e919422aadc9da41222aa7100e2fb53e8141e67c0199d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 00:41:34 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 00:41:37 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 00:42:04 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:490e8f8335172aa29e9e0a04fe70d4a0278af7831831a82a429832099c99861d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f264fd22b716efff1fa37e8fd6e8287eb4475c02eed766d1c48cf0c0011a8d9`  
		Last Modified: Tue, 19 Apr 2022 01:32:39 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d3449c1248c2b75165a26436166cc6f56a5878db4c7aa68891e8bbaa34f278e`  
		Last Modified: Tue, 19 Apr 2022 01:33:24 GMT  
		Size: 19.1 MB (19115773 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2.17-php7.4-fpm-buster` - linux; s390x

```console
$ docker pull drupal@sha256:7e8db11f0ffe64693e46949e07e28ad30ebcc6fc7eb6e61abfa4cfdff6848d2b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147170333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80285249defaa1878ff357eb36c2d2033f118cb8cf10fd58e7a254776d154fab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Tue, 19 Apr 2022 02:55:47 GMT
ENV DRUPAL_VERSION=9.2.17
# Tue, 19 Apr 2022 02:55:47 GMT
WORKDIR /opt/drupal
# Tue, 19 Apr 2022 02:56:31 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:5b25b6c5d4498ca68334afc298cead5bafe119495eb10c832000138895453b61`  
		...
		Size: 661.6 KB (661588 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed92b5b3a6746e039e39a82701f63f84905e8da3b1c1f758a31eb8a03c86979c`  
		Last Modified: Tue, 19 Apr 2022 03:19:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:760edcd62009ebe53cf3fab91b0f82bfbaa87189ae706bc2c96656f2cba45afd`  
		Last Modified: Tue, 19 Apr 2022 03:19:35 GMT  
		Size: 19.1 MB (19115134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
