...
### `drupal:7.96-php8.0-apache` - linux; amd64
...
### `drupal:7.96-php8.0-apache` - linux; arm variant v5
...
### `drupal:7.96-php8.0-apache` - linux; arm variant v7
...
### `drupal:7.96-php8.0-apache` - linux; arm64 variant v8
...
### `drupal:7.96-php8.0-apache` - linux; 386
...
### `drupal:7.96-php8.0-apache` - linux; mips64le
...
### `drupal:7.96-php8.0-apache` - linux; ppc64le
...
### `drupal:7.96-php8.0-apache` - linux; s390x
