...
```console
$ docker pull drupal@sha256:b27168d44b2a7aaae5c6fb90c20801dfa057e9672dd209b3d084ab81234593ab
```
...
```console
$ docker pull drupal@sha256:bb64abfe59fbafbd5807e85a628a1f55e10d79006eb6a740a0f8c09e693ad159
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.2 MB (175167979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccbccf53adc95dabd83dadf9bc7718cab3a8391a4298faccdc4047ea6a29da62`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 12 Apr 2023 23:26:03 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Wed, 12 Apr 2023 23:29:41 GMT
ENV DRUPAL_VERSION=9.4.13
# Wed, 12 Apr 2023 23:29:41 GMT
WORKDIR /opt/drupal
# Wed, 12 Apr 2023 23:29:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 12 Apr 2023 23:29:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e1002f6ab7a70a57497c9b4545b8689289af1d7985ee341147c96c7fa8fa894d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:333709c8329de5d31f6385a52b050cfd44a47ad71821cb0c2687ca7323702458`  
		Last Modified: Wed, 12 Apr 2023 23:43:54 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a358ca06bef909161cf050c61c9df91d4c45a266352a5653fef5b4e114c2fc97`  
		Last Modified: Wed, 12 Apr 2023 23:44:02 GMT  
		Size: 21.9 MB (21916944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
