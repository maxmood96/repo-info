...
```console
$ docker pull drupal@sha256:89649024f47a85934fab7774e74a695a76f9b5843aece36611c724f5c12b3e78
```
...
```console
$ docker pull drupal@sha256:2c8b074143597d8c185d01cb379daf09517fcf4200d0ea00ad22a7acb51af71e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49869381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7997691ffa93f26d31b52bc9a67f16f6b290a8b90cfd8786cd1dad62246c23fe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 15:14:56 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Fri, 11 Nov 2022 15:19:46 GMT
ENV DRUPAL_VERSION=9.3.22
# Fri, 11 Nov 2022 15:19:47 GMT
WORKDIR /opt/drupal
# Fri, 11 Nov 2022 15:20:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Nov 2022 15:20:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:11037611f2edad39f64009ebbb968ac78bdeceafb7771fd10fe4c05ddbcf2211`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c8fe711e6ba30247c7b2ebcdfec6fb12bc6886ca86ad743790681a384259ba8`  
		Last Modified: Fri, 11 Nov 2022 15:47:46 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:accb8b28f26ce4394f9202a4f277742fbaa57d50ef0f8b88de527da638d02946`  
		Last Modified: Fri, 11 Nov 2022 15:47:53 GMT  
