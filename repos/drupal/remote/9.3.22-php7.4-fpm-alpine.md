...
```console
$ docker pull drupal@sha256:adb5e7584a27e9f2503e01fd0a242d7b68f5686b342b1d4973852213314f6ecc
```
...
```console
$ docker pull drupal@sha256:42013fcfebf8f240b0a8ca32ac56650bd828314685415153fd4f3e403e137c5e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51240153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f7230637301fc2555fef2a3bf91f47d1444288e765e8324f5e712cfc68f2fe3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 20:17:51 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:17:52 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:18:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:18:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6fa8d744f28fcc5a19a26f1d57eff5bab49cd5d3d19995596ac784db00314a49`  
		...
		Size: 692.6 KB (692580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6215a36ccf052ce867c92cfbdfb70c0f958d6ab57d0084d4b816bfd3eee76c80`  
		Last Modified: Thu, 29 Sep 2022 20:55:48 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5e12dded68359bbcf01e566239aaad7738f1d4359a190cdc3137e800173795a`  
