...
```console
$ docker pull drupal@sha256:7834d3359b26a9dd21d5b0f38b584560979a0170ed6c10ea584659b9e0d42964
```
...
```console
$ docker pull drupal@sha256:5c3a1b878d592913e18862d5f8abbd86353eaf2c615a3d5b3e75c402b723227d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.1 MB (37123623 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a9bf8678a47f26b598a7be6241f69368d9cfb0344b890a276f58a1b53237bb7`
...
# Sat, 21 Oct 2023 07:46:15 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 21 Oct 2023 07:46:15 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 21 Oct 2023 07:46:16 GMT
...
-	Layers:
	...
	-	`sha256:defa5aa5d81934222f3efdb0a62738a8d5717b3af3372084b1d71cd57e4375aa`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2e2eefde334ef6de1408fe1276ccf231b2faa25b7ef7f0127cab61256719702`  
		Last Modified: Sat, 21 Oct 2023 08:07:13 GMT  
...
```console
$ docker pull drupal@sha256:9c4a15e7b40aac1791227ba19e118b75d29944f743a512b093276f0f347b253b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.4 MB (37413763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91d8bf7aeb6942199c02c703df6da91d079638112ad51b76dc5718c28b607a67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Oct 2023 03:09:49 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 28 Oct 2023 03:09:49 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 28 Oct 2023 03:09:51 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:939112a7a46145420fa5a1a96b4bc88551e067c8d562b02c91c47890bbbec6ed`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:febb592f0f154ce6417162956112a5fbb3290f66d44acb3a619e327d09abe786`  
		Last Modified: Sat, 28 Oct 2023 03:17:35 GMT  
...
```console
$ docker pull drupal@sha256:a8803390e29d6bee3bd8c94af4354a0c3daef4caad45ec967872e0d20cfdc883
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.4 MB (37445799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78421f1502a8759920685537f810f264d6fc93cda586efbb12b4686e6c7116cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 21 Oct 2023 07:19:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 21 Oct 2023 07:32:25 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 21 Oct 2023 07:32:25 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 21 Oct 2023 07:32:27 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:91dc4fd4cdd29d75581fdda78be9a55dfd7e7fdbef4860c3685bdc33e6a129e9`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74c850937a19b1512234b01e3e9cf6da9423db474bd21adf93ce149f6071fa28`  
		Last Modified: Sat, 21 Oct 2023 07:54:01 GMT  
		Size: 3.4 MB (3411150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:0a0800a29a4873d768aea17146e6c6c59ce3f1e33f9beb82d10d2a3eef11c88f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **37.2 MB (37196356 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:020f4f39e79878a30e8ef84692ae7d7cd026cf82774102322f435a499d328afe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 21 Oct 2023 07:21:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 21 Oct 2023 07:38:17 GMT
ENV DRUPAL_VERSION=7.98
# Sat, 21 Oct 2023 07:38:17 GMT
ENV DRUPAL_MD5=4139f0feecb44a53645242194809b73a
# Sat, 21 Oct 2023 07:38:19 GMT
RUN set -eux; 	curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz; 	echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c -; 	tar -xz --strip-components=1 -f drupal.tar.gz; 	rm drupal.tar.gz; 	chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6f6cd95138c204a1ea20114705e8c6a4f2485b35ff3f76a088df40519e3a97fa`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e73a0152f6d2a16c7ecb5fe8c15759b35d48746b4a81bd546657e209015f71a`  
		Last Modified: Sat, 21 Oct 2023 08:06:58 GMT  
		Size: 3.4 MB (3411150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
