...
```console
$ docker pull drupal@sha256:ba4ef2825c9f0ffa0ef1443ebbf752391af115a2178be60c62eb4ee7a3e13041
```
...
```console
$ docker pull drupal@sha256:dcf0ef393edf809dd84b6bf8566284e06029501bffd66e68be4afd1391849865
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50635132 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a01912495449847ed3c68f7baf210f6ba0f0f0cdee5faaec0140bef72dc3955b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 20:10:16 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:10:17 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:10:17 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:10:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:10:48 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ccc9138a2908ddee8c05b92660d5e10b02b9b70f8223e6d480a8b6483d62f602`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d90ffca2c858cd6cef013e11dabdcb9bb479c9d875ef9f642d81f75fe9454c45`  
		Last Modified: Thu, 23 Dec 2021 20:22:24 GMT  
		Size: 573.3 KB (573318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5c3492f75293057ecf4ea66279c67653e3dfe34bfbb8c93fff17fe395616f0e`  
		Last Modified: Thu, 23 Dec 2021 20:22:24 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cacd2d1516bebf8d8f094dc9a94e21d7afc1345e3192a5eed7a676756ff8ac5`  
		Last Modified: Thu, 23 Dec 2021 20:22:52 GMT  
		Size: 20.1 MB (20137484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:e0362cf201e0d578fdba0a4601273aad76c97d1c41cadba2c5b07fd2a2d9dbdd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51623274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46f032620426f6ee320af8a45f3169c6eea16440705bb9157cbdf840a42d1d40`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 20:02:59 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:02:59 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:03:00 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:03:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:03:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d207d2f47ec3dff282b896404bf26ded21eefb6c07de84cda49a18f9193c5be8`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c3d02a264f394bf42eca956c93eee87270e40fe05571c5dedbb9bda7b6e3b5b`  
		Last Modified: Thu, 23 Dec 2021 20:22:25 GMT  
		Size: 573.3 KB (573316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c571ddd0a4460851cc34ac28d6d37c5e3a1993b691b80012b05e3967a3239cc`  
		Last Modified: Thu, 23 Dec 2021 20:22:24 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3eb9c658489eedfe58889454a9bec219a8e4586d20257710ca3868f118b7cc69`  
		Last Modified: Thu, 23 Dec 2021 20:22:30 GMT  
...
```console
$ docker pull drupal@sha256:6f0c25d65ee9fdf65a10c8d932387a0790b7bea7f15f7a17aaf0d97f11097431
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.6 MB (52557766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae9c5bc046a15e9689aa478fa38ec5684664d9b1432c2a4e155e22730194086b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 19:59:57 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 19:59:57 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 19:59:58 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:00:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:0f7f721739ae98f88751d25bff7ce9d0a1ab5809b52946ee34be45ac47e413ea`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0ea635a1bad1b8240d5dce2963e42463f6fc6e9a7b2bbb6488d917c2295c6ef`  
		Last Modified: Thu, 23 Dec 2021 20:20:46 GMT  
		Size: 573.3 KB (573314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:274c15be8109de8ff7831299cedf1e4fcdedb87bdc9e37b74c09e80e08f02918`  
		Last Modified: Thu, 23 Dec 2021 20:20:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:471b68d5fff07634372d36e54a721870e2a89b62b24600569f652589ee5be6db`  
		Last Modified: Thu, 23 Dec 2021 20:21:01 GMT  
		Size: 20.1 MB (20137642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:a20a9f34d18ed53ac3dab56338089dbbb9355ad8e546775f5658204e7ed26b6e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51207804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70b5f5631c8bc69a8fbb5ce12272fb77b49f9958494b9cb42662fe8564917131`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 23 Dec 2021 20:03:10 GMT
COPY file:a403970869d7d6361b870ded4a01e5f4288025d95ce7f917e6ec371bce90f3c8 in /usr/local/bin/ 
# Thu, 23 Dec 2021 20:03:10 GMT
ENV DRUPAL_VERSION=9.3.0
# Thu, 23 Dec 2021 20:03:10 GMT
WORKDIR /opt/drupal
# Thu, 23 Dec 2021 20:03:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 23 Dec 2021 20:03:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:033d4bbea6958ea17ce5f4a5b960f28d9b505a439551714a020859728194758a`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b564ac966bbbc18108038fcb97b1979d9a9b1800667030b456c8a3b4c356689e`  
		Last Modified: Thu, 23 Dec 2021 20:19:24 GMT  
		Size: 573.3 KB (573314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75e2bbd291cef8ce8ca5f5dfb2673795c4cdc7c7d548267fa0f6fb0894b536e8`  
		Last Modified: Thu, 23 Dec 2021 20:19:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a05a2e2a482de001302ce8d62378d2654dca74ba0d6bd28f8f5512e26974512`  
		Last Modified: Thu, 23 Dec 2021 20:19:28 GMT  
		Size: 20.1 MB (20137139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
