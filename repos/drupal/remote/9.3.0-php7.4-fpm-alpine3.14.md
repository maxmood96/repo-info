...
```console
$ docker pull drupal@sha256:85762ee9c0cabcd4b7fe84c8015179150a02230da3ee1c941abdf4696ee44a94
```
...
```console
$ docker pull drupal@sha256:7a3d3b17b1dcdef7e4928168dfb2a5c04c74583d6503347812e823602a0ea7bd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.6 MB (50635691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d988152e759d18eb43795d2f7e01c0590a546b9e9af48b8548090d39ae7cd52d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:26:11 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:26:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:26:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0c7c00cf4421ae0819f0e924f7bd50433dce17696d9d59bec602ad4ecc08710c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d95282d04b3201591122bd8b79f4600fe5ac3988eb76102ce7efa8f3564e238`  
		Last Modified: Mon, 03 Jan 2022 21:38:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30c2f49fd6084e2d346a452149a585faf5d1c29f9c0296b1ebab4dcc2893dd0c`  
		Last Modified: Mon, 03 Jan 2022 21:38:34 GMT  
		Size: 20.1 MB (20137732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-alpine3.14` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d1511b3f8c4ee2dc8d4cd2850bcfa4c890189a77f95f1bb5bb2371f36d8a6c0d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49286105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6029b2970d46f5104b35aad9e99996b16c5013e813bd34db706c136b846e870b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:00:38 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:00:38 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:01:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:01:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ef4e689eabeca4ccce1c3b82b5d6acb068e5cbf6d15511afd78e39a34b2fb939`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3454a0488f74605dea806971a7877b47f3b6cd7c7f36e4f89753b20b3ff87c80`  
		Last Modified: Mon, 03 Jan 2022 21:39:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c45d77f812271c8a84dab579a7e2ed824ca03bdf0f1c60352e9b9f3ad1e1364`  
		Last Modified: Mon, 03 Jan 2022 21:39:49 GMT  
		Size: 20.1 MB (20137313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-alpine3.14` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:b5240459ce57a0768777ded9cac62c58e2da386a79478ca0fb8ac49b5e7a99c7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51623298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b60546b5df93fa7e021a267174557b54ccf9d27b012aac192b4f941e44d01e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:41:56 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:41:57 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:42:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:42:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:074d51667c29ef1244aaeed6f111d2e5c251ecbad7b2a9b7d63fee2fd9e1f4dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1931ec16118a83b8b6355df6b68e642e0bcc9180c8a275d106d0b4eb00d1711f`  
		Last Modified: Mon, 03 Jan 2022 22:01:32 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8f61c19212490ed4b4001c160ec63d20a0e7c141e813afcb024487ac85dc492`  
		Last Modified: Mon, 03 Jan 2022 22:01:38 GMT  
		Size: 20.1 MB (20137881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:93b8717e6552667656e36942dc6a88bb9e2f6ac093984859df0447dbc09c9a5c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53206413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bbf8af327a359a68d705a5863ef82ae6b0a413fec3b37bd52a55d73faacdcde`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:b748d36e167a83266a0d09fb3a9032f634660adaa6e852a3dde4ee7144ef4a85 in /usr/local/bin/ 
# Mon, 03 Jan 2022 21:30:15 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:30:17 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:30:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:30:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:69aa40ea5c3c110db108d340ba80412e54168d42cf70cc4d9bb5a240d07cc885`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2ae6c4fd863628a11f76c6d0e92d158dd6cd1c24608dded378a48feb0ec8b89`  
		Last Modified: Mon, 03 Jan 2022 22:03:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ee155f576202edc902cd5767f828c7a97fe53b471edeba7db50cdf5c7c8652b`  
		Last Modified: Mon, 03 Jan 2022 22:04:00 GMT  
		Size: 20.1 MB (20137487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.0-php7.4-fpm-alpine3.14` - linux; s390x

```console
$ docker pull drupal@sha256:39175a5619e7ddbbf496c9826afd0c3ee3648f48f71212eb3636a7247db36267
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.2 MB (51208402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef0059b5d70bcb5b316caa43262c9c5edc77768b5349b08f17d32fcc037f4683`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 03 Jan 2022 21:54:25 GMT
ENV DRUPAL_VERSION=9.3.0
# Mon, 03 Jan 2022 21:54:26 GMT
WORKDIR /opt/drupal
# Mon, 03 Jan 2022 21:54:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 03 Jan 2022 21:54:39 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:34da0958112c9c132a2e57327060a87fe595412fbf2fc234d41cf9257dbb13f0`  
		...
		Size: 573.6 KB (573626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afe1f43df2bd5507ee255f786784c21a4dac7d9e266f074a00ab60a04eadb01b`  
		Last Modified: Mon, 03 Jan 2022 22:10:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8080081a16ea78ef4d9e037b1d4e55e33bb454c48c5600c2301ebd5430dd2c54`  
		Last Modified: Mon, 03 Jan 2022 22:10:42 GMT  
		Size: 20.1 MB (20137425 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
