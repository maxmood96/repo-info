...
```console
$ docker pull drupal@sha256:9e0bcf0330711bc1fc7c0d342988bc13c0936b4dff0129290933e354a20b69c0
```
...
```console
$ docker pull drupal@sha256:5e927527e1ead4cfdb5035694de34243ed1071e3c2a4d3620ba67389a0e0f8bd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161720852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65e038eab21fa06dffa1c4641adc633cd147071499dd71a97454f781e305efc4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:27:18 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:27:18 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:27:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:27:32 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:dd1ebfedc8daf1b248555671f1000bfc96d4070859a975f5f41ef3bd1132584e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:268d19e0e9361b2f97a3e915ebbf6e9bf25581ceaf2a452a451017041666e108`  
		Last Modified: Fri, 06 Oct 2023 19:50:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56a1a7604adfff17ecbe5d0a8f266aedac86a16d14d0229f9121b38e4eb204d1`  
		Last Modified: Fri, 06 Oct 2023 19:51:05 GMT  
		Size: 17.7 MB (17696924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:7b5ebb5f1450c0e852ff5ebd76f85c762fb5bd88985c0b8c3506e92b0a5b0214
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.7 MB (191707707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52154bb524419e6bbb0e2c9c760d747800fdc5e44eb333be77a0e74584de6c7a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:14:24 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:14:24 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:14:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:14:33 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4c5257c48ccb51d9eb46e80ba77bb29724fb19d10015b640e7945e565ce7fbfa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4eda4a10bdf5be396c05204d6a06c0f83353663874ee46f57fd524b0fa647e6c`  
		Last Modified: Fri, 06 Oct 2023 19:35:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e3226f0596dfe18fbb409fb72978c206abfcf80e0306108d0e34cc0a6e1f699`  
		Last Modified: Fri, 06 Oct 2023 19:35:18 GMT  
		Size: 17.7 MB (17696919 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.0-php8.1` - linux; 386

```console
$ docker pull drupal@sha256:f3537a34676fdffd664fe440cf7d94e52e5750a4043a985046633e9c94f3b732
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.6 MB (196626794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84fe9a9a12091d09c09c982906a9c874e251c8f1420fa95b1724a6324053b5e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:14:15 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 06 Oct 2023 19:14:16 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:14:29 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:14:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:701e9ff6e376340139c2ac5e5ee0dbb0d7060574c1adae0af2ba6cfea318b1e7`  
		...
		Size: 705.0 KB (705004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77e5e658ea6a667da8f251530376f58692579a8979d2d222ee80fb91b274394e`  
		Last Modified: Fri, 06 Oct 2023 19:38:02 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebf28cbae426a4c45b543c5dc9cbfcb033bac63bdef8aef5e1e2fedbf58c1970`  
		Last Modified: Fri, 06 Oct 2023 19:38:17 GMT  
		Size: 17.7 MB (17697095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
