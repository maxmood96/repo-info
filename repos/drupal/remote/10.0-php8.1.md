...
```console
$ docker pull drupal@sha256:6c726d019a828efd488703ed6f41e081331b9cee02d79ecc276c6a396df28e9f
```
...
```console
$ docker pull drupal@sha256:9001680d5c1a0f192a5896cce904a1aee49fd2306176893612c88064644c25dd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.1 MB (202097836 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f055aaf6dcd4491b029ba592c745f51dabe1e79c4fdb3b35cbdea56be1cb8465`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 20:41:52 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 20:41:52 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 20:42:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 20:42:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b46ae1a443c6bc3d52e18371074ad859e7d62e32e5950a5500d94ba26cefddd2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc3d1b936913c03aeba891c60d1f85e1d2c8ce5d012a32f926a7a01f9864353f`  
		Last Modified: Fri, 29 Sep 2023 21:16:37 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2508cb65ed92e00477bd697ce1f93f80be4d9f1e0c4a48adef87d22e9f7740dc`  
...
```console
$ docker pull drupal@sha256:0feb4c10d3d8a18e62d7167c9e460b0163e9c89f063f7ca087e301cf825f3136
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.9 MB (170939221 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6fa42ff6b7e95bf6388045c52393dfd699f0f28e45da29c46dd8d2520e0d63d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:10da4cc19573182eac538e6a49f285652f8ea0b356fa3b9ecabb774ce97aea9f in /usr/local/bin/ 
# Fri, 29 Sep 2023 22:55:38 GMT
ENV DRUPAL_VERSION=10.0.11
# Fri, 29 Sep 2023 22:55:38 GMT
WORKDIR /opt/drupal
# Fri, 29 Sep 2023 22:55:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Sep 2023 22:55:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c865b444d9e7a38e19aa2dce58c013d5c7fc17e179ef3d8243857d6d3e7c6b44`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a009f643a0dd8261d75772b979fbf38d17dbeed6ae67be42fd43598651af9fb`  
		Last Modified: Fri, 29 Sep 2023 23:52:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9bbd7c53b8f959aa7fa4e87c9a1af7ef9abddec45574a8295779f1b5187db4e`  
		Last Modified: Fri, 29 Sep 2023 23:52:46 GMT  
		Size: 17.7 MB (17695335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
