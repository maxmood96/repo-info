...
```console
$ docker pull drupal@sha256:6e8ee1a46fe6709dee512199248eefe22e421200875d615f2b6a59450ccf77a2
```
...
```console
$ docker pull drupal@sha256:95a02225d1b686f5410749a33a48e14871885bb0f04eff8951f9b716090e8cad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.1 MB (202091400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fdb15a2589804823ee20b3b2782eb4d3895ff8f81e00fe3239891cad26cf28e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:14:13 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 02 Sep 2023 11:14:13 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:14:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:14:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d429cb0adb0b13468cc50aaa4dd8174a16eec907b7d34565d8ee15d5d6c75879`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af9d50448e9187e4e53c2e5b82057dfab926ac5193f84103a6c37e9b8dafd678`  
		Last Modified: Sat, 02 Sep 2023 11:51:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4491ba3d0816efa70dca83211cacf83d9e086dd94187386ad8cbc3daf9bd3a35`  
		Last Modified: Sat, 02 Sep 2023 11:52:35 GMT  
		Size: 17.7 MB (17695931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
