...
```console
$ docker pull drupal@sha256:cef0069209e71afe1f17d0fc2502cf564e46e27168720b23cbb2ebd994d63366
```
...
```console
$ docker pull drupal@sha256:92cd4eaf83079637b1811816ab51d8562c6cbf3921931586ae24a2c8df102152
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.6 MB (196627667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d0a511bcfaa67d051207ce76ba634368b019694555a0675fc90e0e528f55291`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 05 Aug 2023 02:53:44 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 05 Aug 2023 03:01:21 GMT
ENV DRUPAL_VERSION=10.0.10
# Sat, 05 Aug 2023 03:01:21 GMT
WORKDIR /opt/drupal
# Sat, 05 Aug 2023 03:01:36 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 05 Aug 2023 03:01:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:12c76717821431046d53cfdb92c0c29868a58e38f157eade8eaeeea3c98bff6d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ed827ca9255fa204beccbaa5c62994b3d59630009014ace25ad64178bfd7017`  
		Last Modified: Sat, 05 Aug 2023 03:12:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16050abda63dd43b103c32c2399dfe1c05773dc765b15e26553cd34880f5771d`  
		Last Modified: Sat, 05 Aug 2023 03:12:22 GMT  
		Size: 17.7 MB (17696086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
