...
```console
$ docker pull drupal@sha256:868752a5df72dea1cc16188a8efa87d9f0080bbf3c8077a6d5811b69b457f882
```
...
```console
$ docker pull drupal@sha256:d867f2a5732f0e4c9b0c9632054d67ec4e909b5fe1b5f645e8f68160c956889f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.8 MB (154797859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5bb56478f0ac1369e3cd68aa38b84c7d4d8123f3c773089819efec3805b4e42`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 07 Jul 2022 20:09:47 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:02:02 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:02:02 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:02:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:730667a5c59a60840dcf8107f47cb8ec01f92b5efcc50636bfaf735a1d18bd88`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be410394c280e093cd92d4e9dda529cf7e99bd43053e6b2aa82de20899b8df7d`  
		Last Modified: Fri, 08 Jul 2022 01:57:21 GMT  
		Size: 670.1 KB (670059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b15ce8980bfc098a8c3bac37ecd8ec7f17013f2a5913200d1026aac2b7a4c328`  
		Last Modified: Tue, 12 Jul 2022 01:23:50 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24d290d7e4bcc77d8a71565e15a28ce7c591ae659e93e12862f04d57929ee9b6`  
		Last Modified: Tue, 12 Jul 2022 01:23:56 GMT  
...
```console
$ docker pull drupal@sha256:3af9a7332d2b119b710c9d48c24ad1e1adef879edf10898153751b55d2ab6970
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.4 MB (168369340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c80ac8b97090c7ce3d957df80aada317f390ab3a2ac970ca5318fc94b410118e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 07 Jul 2022 20:05:16 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:00:20 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:00:21 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:00:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:00:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a5c2aa17a20002e8bdcd41e67aa68e9c0f5a3371e23189f5ffaf28f0e84dfdad`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0d874852ff91e6bd544daf957036a5f490374a4b2ba23a2c98d7360b2592b06`  
		Last Modified: Fri, 08 Jul 2022 02:01:32 GMT  
		Size: 670.1 KB (670055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7bf97c46f6afa8c35994c7f23cc972195fc2a7ec3a4331ee5372d9826c42714`  
		Last Modified: Tue, 12 Jul 2022 01:22:42 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67dc37e175c9338aa7ab80c7c93803ff369a9ca741e4732aae1e838af32f417f`  
		Last Modified: Tue, 12 Jul 2022 01:22:47 GMT  
		Size: 21.2 MB (21208034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
