...
```console
$ docker pull drupal@sha256:0baef415098b0fe99a4e634404c7e628898ce85ca91d17972a1ff482fe3c82c0
```
...
```console
$ docker pull drupal@sha256:bcd9c099e671de2e4e7dfb990a87c0d435b4b5068d185d552ab82a4941f3f7d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.9 MB (192886586 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:654e1e1da9d0e7ed44c11f8f451d0547e9f475b23ae079de6a92289c1816a5b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 21:21:15 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 21:27:26 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 21:27:26 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 21:27:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 21:27:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1c83d7f85b36c15e30c4a92b7bcd5e6ff0c17945c5ce92f1a720eec7fbe65405`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea42c70c217a3a0bec35b782ac48448b45d4b32c2c7dba59801f5b955e652928`  
		Last Modified: Wed, 16 Aug 2023 21:45:15 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9af5197f262bcfa9e168a6c0aebea273a91d3ffbbc3d2e3d14e23413aaeb4183`  
		Last Modified: Wed, 16 Aug 2023 21:45:19 GMT  
...
```console
$ docker pull drupal@sha256:215c6a3a9a70536dcb734b4ac081561db01e995e60b97173dff500f066e861bb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197623010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69aa852189ea5e826987ceb8df5d2476f4280fcab84d46a84751baad0d96a42d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 19:12:00 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Wed, 16 Aug 2023 19:19:29 GMT
ENV DRUPAL_VERSION=9.5.10
# Wed, 16 Aug 2023 19:19:29 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 19:19:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 19:19:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d363c1c6b6bb96f3513c516ef9c04e42e32a4099728f5eef1f392e8cef83d5dc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cf6ca676debf4d2b95c589c6760faa326aa16f66ef20dd45ae5f0d10914a403`  
		Last Modified: Wed, 16 Aug 2023 19:41:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d640eeabc2c4a3377346ca13e729c3a6f5e6d7e2485a0d94964326e6d9cb807f`  
		Last Modified: Wed, 16 Aug 2023 19:41:07 GMT  
		Size: 22.9 MB (22880053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:84ef930f1d427903bf5cb93001ea1d3bd66a5d995a649b527cb08f6f6a91bf04
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.2 MB (172199097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a6a62394bf67daab3ea580e562736147f917f1511e4c62fc9567e322582134e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Aug 2023 20:01:35 GMT
WORKDIR /opt/drupal
# Wed, 16 Aug 2023 20:01:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Aug 2023 20:01:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1476278ed10e1988474ea7c9376685a0265a6d55099c5b8c31af7c266e789b75`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7288645a3b9b5ef3f9b673120aba5dfddd1cc49c9e5fa2c368bc4de1a256d4ad`  
		Last Modified: Wed, 16 Aug 2023 20:17:24 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5ea9609979f04dd94ba301bd24ebe074da012a10b05dc13d467690485937948`  
		Last Modified: Wed, 16 Aug 2023 20:17:31 GMT  
