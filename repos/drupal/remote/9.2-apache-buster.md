...
```console
$ docker pull drupal@sha256:cee83d709561b3adb5a9d3fa9986b3adac5d6774192a666fe8a401beb35d9626
```
...
```console
$ docker pull drupal@sha256:a26fdf6aff024fe3c72dbed3db583d72f94f80b5c49c7f37089493652d171cd9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.6 MB (151620973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90706892f85ad7d78dd44fb19b6479f72cab0dc91aa3f54b05094a8a0c0cf1f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 16 Mar 2022 18:15:43 GMT
ENV DRUPAL_VERSION=9.2.14
# Wed, 16 Mar 2022 18:15:43 GMT
WORKDIR /opt/drupal
# Wed, 16 Mar 2022 18:16:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 16 Mar 2022 18:16:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7884534c4f2f3debb0f371613ed99602e79ddbb4c8f8cbbc2a8dbc463574b820`  
		...
		Size: 575.7 KB (575715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:049b639852a3d9ee96e9f1f6212353ecc834a9056d4be7795954be7274252c5d`  
		Last Modified: Wed, 16 Mar 2022 18:37:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10617a5fcbbb3dea11da6ab7ea9dd834e883c22d99d7084e38135a547eee7166`  
		Last Modified: Wed, 16 Mar 2022 18:37:38 GMT  
		Size: 19.1 MB (19124668 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
