...
```console
$ docker pull drupal@sha256:bd943dabca05a83dc891f12449152bb5ff366eb2db5f202df250e5439cb2fb76
```
...
```console
$ docker pull drupal@sha256:89c19e1a216416d5d063c3f224d8f2cc2d0ad7102831606d0947415d08dbd699
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157133638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52d232268c36355ca78ca4c1236a7bfa25ca1797d15e5ef91ff0c515515bd79d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:608f7625682057a8f327a57b0a8d1d350465d3209e7a8c9e119158b6dc4b876a in /usr/local/bin/ 
# Wed, 30 Mar 2022 15:32:53 GMT
ENV DRUPAL_VERSION=9.2.16
# Wed, 30 Mar 2022 15:32:54 GMT
WORKDIR /opt/drupal
# Wed, 30 Mar 2022 15:33:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 30 Mar 2022 15:33:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3cacc7bed63bc25ddc60ab52086e7e2a224f6e7a3c71bf58f605b8c612c50343`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2b5bfadc1de2cfabfd6a08117782010fa74bcf782a3ade466f18332aa9db736`  
		Last Modified: Wed, 30 Mar 2022 16:00:10 GMT  
		Size: 113.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ebe1ac6f8df11c32564d6ca1733dd98da6711d2946ad928eee194ae0a056fd7`  
		Last Modified: Wed, 30 Mar 2022 16:00:15 GMT  
		Size: 19.1 MB (19126355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
