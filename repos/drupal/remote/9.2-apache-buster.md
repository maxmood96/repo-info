...
```console
$ docker pull drupal@sha256:a23978e6ce6b5a45c772d0eeb39e9dabb5cc5d5ccf45bc39455a611cd5c8889c
```
...
```console
$ docker pull drupal@sha256:9f93760c5ff9bbcffb0b8b3e7ba472e20144c05a8a8edda9d8033c6c2a2b0b6a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.5 MB (141536971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1fe5b5462f6e766711e8ae68a61cf2366aa42d07ff0ada49cb98aa64f23e7de`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 13:13:04 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 13:13:05 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 13:13:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 13:13:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e92cd2bdef4e0d4d0b8c6012e8a3488eeb3849ae6eca5e0f91a859ab32f1596b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fbd478938b25dd32c4ca3b9b852b377fd399bf9e6d4ba6ed061a86fefed4c78`  
		Last Modified: Fri, 11 Mar 2022 15:42:11 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ded89c165400b16980ce71f878d95daa025a7227508cd26fe16914d9d288cb9`  
		Last Modified: Fri, 11 Mar 2022 15:42:38 GMT  
		Size: 19.1 MB (19123350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:cdb3420230d6b4ba44cea29bb31e9734803f38077698ff75b98a0027f69df67f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172297721 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dac68d5b512aa0a4822e304da45374d5da8e4bf7b199ca7afccdb673a5281076`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 14:45:59 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Fri, 11 Mar 2022 14:59:06 GMT
ENV DRUPAL_VERSION=9.2.13
# Fri, 11 Mar 2022 14:59:06 GMT
WORKDIR /opt/drupal
# Fri, 11 Mar 2022 14:59:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 11 Mar 2022 14:59:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:025736ba799eaec28fa87e959adf29d6a26b68cafc0b046e6115dcd24e960a28`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e49ade7a848ff6c3d4e3547d0548e3e17c8512bfa995c30f344575a8328ad77e`  
		Last Modified: Fri, 11 Mar 2022 15:31:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:175d4f555ca1faf26649d5bf9d478ae14101311a5f44d4b0c1932cdbcd98cb72`  
		Last Modified: Fri, 11 Mar 2022 15:31:26 GMT  
