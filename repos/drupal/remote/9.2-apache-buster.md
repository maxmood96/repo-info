...
```console
$ docker pull drupal@sha256:58310c25d9a7bc9fa09f8c449fd552f9f181e5004132b99a8fb4a2d81193fae4
```
...
```console
$ docker pull drupal@sha256:19ee90dbac92ef10dc58a12b783668ca2f96468bef6e96e8711befcbae9547c1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.2 MB (157218320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:894dd43fd44ff58e62ebdfcfeaf4e2e9e9d2a07bd438e8a92263c5bd1c09c2ae`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 21:27:49 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:27:49 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:28:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 21:28:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1649f0999c462e2060a4ecfef4ac6eebdb2d582186d540b66259526f9b68c1c2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:663e260b50ded9bc0c312f20f626588f50ae462bf4314f898119b75658456cb7`  
		Last Modified: Mon, 04 Apr 2022 22:23:57 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfd71969a90bf8243f56d0dfef82549f4f5598c197e243f64573951169afe44a`  
		Last Modified: Mon, 04 Apr 2022 22:24:02 GMT  
		Size: 19.1 MB (19126648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-apache-buster` - linux; 386

```console
$ docker pull drupal@sha256:a7031aaad6f6c7089f6a9420dc832b8a0df9b906de3f73d9b6e67e33ac25580f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.6 MB (171648148 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81a3d053992108cc81aa04e19460997faabf6ba830f790d9463ba6afbd4cc5f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 21:04:49 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 21:05:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:5dc20065d1c1b7252278562536ec96e36c2d8880f6798c009803e443e98aadee`  
		...
		Size: 660.1 KB (660098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d699ae48dfba6b7a663b6820d423571a3d5dd6482770c276e7389bf5f833cecb`  
		Last Modified: Mon, 04 Apr 2022 21:31:07 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c18103db0f0863957b4d9aaab2df66922530e486c5d9af2ceb6b4a6fe158b2c1`  
		Last Modified: Mon, 04 Apr 2022 21:31:12 GMT  
		Size: 19.1 MB (19126936 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.2-apache-buster` - linux; ppc64le

```console
$ docker pull drupal@sha256:e0f3a29262894d4a3e9d7b1c6a275a99bc378f3cd30dfe7cfe85af26ceccd874
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.8 MB (176811413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c13b3b3639192ba1921921c9746d0af2e5690303a146ad42959fc6b2b1d3f9c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:9cbc8d461e82cf7c5c8b03ecbb4c9d034d879299c6d43185c2fe17145ed826be in /usr/local/bin/ 
# Mon, 04 Apr 2022 22:23:37 GMT
ENV DRUPAL_VERSION=9.2.16
# Mon, 04 Apr 2022 22:23:40 GMT
WORKDIR /opt/drupal
# Mon, 04 Apr 2022 22:24:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 04 Apr 2022 22:24:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:46c487d3bbafdbfea1b616772d3e73b94f652b14cecd34d6211c0ac2519890ba`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7264a057b0cb3a08fa620f4e60d2e2378fe6f2d7245e77e54050dd8c6c53242d`  
		Last Modified: Mon, 04 Apr 2022 23:28:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6da1d68b6a017f8414b574ef07a28483f2481c5449eec4f62b8d45b37270828`  
		Last Modified: Mon, 04 Apr 2022 23:30:04 GMT  
		Size: 19.1 MB (19127290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
