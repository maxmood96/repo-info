...
```console
$ docker pull drupal@sha256:4d3d799f6423a1a51b264a3d3a71886b912c64594776a9132dbf52fafad0023b
```
...
```console
$ docker pull drupal@sha256:5d5691063b840dfd7cfbbee618af3fa3b16d1baf2b53f9ca9c1df2b6aff9a593
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.4 MB (166383993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d60185176b80aff8cde30aa601652c4fe660e1ce1dfcabfb4632ae6e1df3223`
...
# Fri, 08 Apr 2022 20:56:40 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 20:56:40 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 20:56:51 GMT
...
-	Layers:
	...
	-	`sha256:9469b91c04f882ff915844c13fd2a3075b78deb9c2e331b7135b7d452755d522`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5237be8f42a62d5a58ff834e937c9a0008b21d62d789b5b2ffbc3ebb07af9f62`  
		Last Modified: Fri, 08 Apr 2022 22:55:14 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abe513cb2b168bdd24628b9dccd075f084cd442216c233c3dc5b55c2972584fe`  
		Last Modified: Fri, 08 Apr 2022 22:55:19 GMT  
...
```console
$ docker pull drupal@sha256:b099d94a573ae04f27e815c833533c7f31da9f6f605920acc26a5ad7c6a0ac8f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.6 MB (141555435 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba3f1fc7af67d5bd9817e44c20df27e330912db16a3eaadf9062de48d9823282`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:35:22 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:35:22 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:35:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:35:52 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:81ffc9e0cefb086ed4e5baa62eb92d7b50e191d2697f2382ad5cd3306bd0f113`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6215bda0b36f216c1bf95aca8ef38352107907336f5b0e34e15bff1711ac401`  
		Last Modified: Sat, 09 Apr 2022 00:05:18 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a34dc20f7ecbf07dc96a60a3e3455e221e8c59c7e7dae0ab804c4e9bb50caf`  
		Last Modified: Sat, 09 Apr 2022 00:05:31 GMT  
...
```console
$ docker pull drupal@sha256:e0bc7f2da55ee06d50cbd690056ceda9a64b3f6bc16fa92ea660277a0cd1c14e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.6 MB (151625669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7edd2a803894b8187cc51f2006489a93de0fca6b05569694232f1d8d85c5af2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:aaea74ade16b347785575edf0eab0f136596ac6ba3e9ea68f7b4030cb49c6710 in /usr/local/bin/ 
# Fri, 08 Apr 2022 21:11:29 GMT
ENV DRUPAL_VERSION=9.2.16
# Fri, 08 Apr 2022 21:11:29 GMT
WORKDIR /opt/drupal
# Fri, 08 Apr 2022 21:11:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 08 Apr 2022 21:11:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:26f4e8fc41f00fffe24bd1a99572403d0079a7d16a967845444250929aa3ff3b`  
		...
		Size: 660.9 KB (660934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2db5da42f10da1a864c011e31119aadd1b14815fbcce77a3f98b9ecc6db810e`  
		Last Modified: Fri, 08 Apr 2022 23:13:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f5e0070fe71214659530755446245afec718d58e76b6457bea35f5c3df0e356`  
		Last Modified: Fri, 08 Apr 2022 23:13:35 GMT  
