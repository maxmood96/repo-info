...
```console
$ docker pull drupal@sha256:04d11821cbc9f556f0b2b401ae7e610699e691c3098e4eafa53cef7ac0b56bae
```
...
```console
$ docker pull drupal@sha256:cf4ae7d3f841aaeaebb4dcbfd49d8c56f5fc7a76cf8dd8ac147afcd24695dd3c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49170294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0793e24b1fae506ff13e16db754b5646f0e29b04af7fd846b9d5c7e1e0c75fe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 12 Nov 2022 16:35:52 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Sat, 12 Nov 2022 16:35:53 GMT
ENV DRUPAL_VERSION=9.4.8
# Sat, 12 Nov 2022 16:35:53 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 16:36:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 16:36:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:216a755d323c92c9d76213d9637d0c309f7343dac0e605917c28ea479041a207`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85cfbee459d220d6e265d14ba7664d88b0cf67214027b1104d013aa1d49c601`  
		Last Modified: Sat, 12 Nov 2022 17:01:45 GMT  
		Size: 695.2 KB (695182 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e92d51d29cf2d5043eee3d1cced8e7c882aafc4b7aaf360c1c0032fda7e880e4`  
		Last Modified: Sat, 12 Nov 2022 17:01:44 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23466ad1fda76c51e1ce948eb95b3ca68e4d73aec4a5e89f0aa09b7a7b63f8e0`  
		Last Modified: Sat, 12 Nov 2022 17:01:52 GMT  
		Size: 21.9 MB (21897803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:9cc2fda6967ad4975ac5e80a785681620b5d4d4a3a75d81d93e2d7ee00440740
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52345310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e61fb5ae45427da4b334a0b5ff5e88d253e59884cc65beb362ed577502fe0360`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 12 Nov 2022 14:07:32 GMT
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Sat, 12 Nov 2022 14:07:32 GMT
ENV DRUPAL_VERSION=9.4.8
# Sat, 12 Nov 2022 14:07:32 GMT
WORKDIR /opt/drupal
# Sat, 12 Nov 2022 14:07:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 12 Nov 2022 14:08:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4b7df7d5e54820d655e24b0608c3a55e4d5f6c72a14a263c2bcefba729adf855`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d6be89c722564aabc40ca73df6ac3a4c92798a92307569eac82c9556fc32be2`  
		Last Modified: Sat, 12 Nov 2022 14:25:55 GMT  
		Size: 695.2 KB (695197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45da4db14168a355ec0dd36f447fd836d4bf65d25efd2c18ab92eb7fd463d885`  
		Last Modified: Sat, 12 Nov 2022 14:25:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9385cac1efb6b2dbd3d405695fd4f2eee348f972da11456fe88e4848789094f3`  
		Last Modified: Sat, 12 Nov 2022 14:26:04 GMT  
