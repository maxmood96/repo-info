...
```console
$ docker pull drupal@sha256:5178c66a3b22bfc39d5ae92169dc1935ac57fa8ee1a664a12d63de5aec45df30
```
...
```console
$ docker pull drupal@sha256:20a66b48f0a632c02805cc8d6c2e8b6cbaafd2baa9d6c4ece049f96b26823de4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.8 MB (50849866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8b609991836c2374c654e1af560a82b05b4ccd8f4c0f33aae21cfa7971d5b8a`
...
# Wed, 20 Jul 2022 23:36:13 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:36:13 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:36:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:36:25 GMT
...
-	Layers:
	...
	-	`sha256:203c5860772c7b5a05987c8158ffd46fc6cf3434d7e828a527ba2dc54e77b1a4`  
		...
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6dc3e0a10740c53758835457c46a7c7654bbd09a798aada8bfd0e56986f09e7`  
		Last Modified: Wed, 20 Jul 2022 23:57:42 GMT  
...
```console
$ docker pull drupal@sha256:2da10f5c1d362e3b6d4fccf2237f85ab3779cc91c6df8231243895b240f01eaa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49730382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf3585c49a8d7725a5411175e8f63bd52d6c30620c478547c09e84da31bd3cb8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:04:56 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:04:57 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:05:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:05:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f71ffe73821bd7e8311151ff890890ed03c93336b3bc1c841c30551000520c66`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b77035adcd0ac1798d9877aa51ac25f5be293938e945f887dc4d4f2e662a0d89`  
		Last Modified: Thu, 21 Jul 2022 00:25:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3abf4b2c05689efd7f046f9ac7b73125f490a9a35230fa4b3239e46a8c413591`  
		Last Modified: Thu, 21 Jul 2022 00:25:36 GMT  
		Size: 21.8 MB (21757492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php7.4-fpm-alpine3.16` - linux; arm variant v7

```console
$ docker pull drupal@sha256:42b1ca3f0b791a4a169925b70094f9d62b2cdd6003f0adc293c1fcd90ed34df2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48614770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c80e858f53d88650409b1461e5c7bfc4eb9fe2a98e52f2c58856670576b176f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:30:34 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:30:35 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:31:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:31:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fc300c66086233c79697e1c862763a0a855ab2c3f42266d9c9de66bf58ca21ec`  
		...
		Size: 670.1 KB (670051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dee2feb6f5fc7b5fbc5efd4cc0259d7507f75c19953dffa4aaaa6983807c4627`  
		Last Modified: Thu, 21 Jul 2022 01:35:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a12c107f36caaad1a2ce177b9fdf8e86ea48fe384964b570c86277c8b9619f0d`  
		Last Modified: Thu, 21 Jul 2022 01:36:28 GMT  
...
```console
$ docker pull drupal@sha256:d3a628b131ea2af4af4dcadf3b0b0449f679834b39ddeb28af833ee87c18a1cc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.5 MB (50521417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b1c0111c1a8f211e5f5f304524252cd906ffdff69b9313d01e2fb8f807d7702c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:05:02 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:05:03 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:05:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:05:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4bf6fed761f26b0a1305a8d04316881ca891fb102c4a4bd2a72e8eb9d7dbf7e3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d174bf4a04dd8b0bc4db21c3f11694d1330137cc28505c9642324b6ad109009f`  
		Last Modified: Thu, 21 Jul 2022 00:38:47 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a437646f76681523d9a8955c3c03f83e0facdcdb833f51e1b6eba46554301f6`  
		Last Modified: Thu, 21 Jul 2022 00:38:52 GMT  
...
```console
$ docker pull drupal@sha256:bcf09c7283a7f899ac47f60e77d893dedf99a80b758564dc8dc77c485d767e51
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51358822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ccdcdc1b20ba730204bc27e71b453620d91565d96193ecc19674e099897fbd9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 20 Jul 2022 23:52:07 GMT
ENV DRUPAL_VERSION=9.4.3
# Wed, 20 Jul 2022 23:52:08 GMT
WORKDIR /opt/drupal
# Wed, 20 Jul 2022 23:52:21 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 20 Jul 2022 23:52:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c6c41e8db1a5978646a351f4b121d7ca69be2eebcfe449e264779d1f85b916f3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e8b4e48cf70bb978a866f89d861fa2a1a49f03ed58c0b72f5e16759b3d82bc`  
		Last Modified: Thu, 21 Jul 2022 00:25:01 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9b178086f9333e33fdd072680904baaa344038873c2ec37151edb4ae730c41c`  
		Last Modified: Thu, 21 Jul 2022 00:25:07 GMT  
		Size: 21.8 MB (21758581 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:ab5a3afc43a978475cc3dca7c5b36eac3a15dbb93de7e95e872c232cf912abd9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50265391 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:babe7fdeb9da8cdc3562975998c25185deb0480abcd749d65de20b7341b9d58f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Thu, 21 Jul 2022 00:05:06 GMT
ENV DRUPAL_VERSION=9.4.3
# Thu, 21 Jul 2022 00:05:06 GMT
WORKDIR /opt/drupal
# Thu, 21 Jul 2022 00:05:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 21 Jul 2022 00:05:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f629b4b4c882f844369e8631ca853e6c77b1224d12fb757d231814f45235e030`  
		...
		Size: 670.0 KB (670049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7965b88754d5d4817a80db15a6179dbc06cfea10cf0e4828ecaaf96c13441bae`  
		Last Modified: Thu, 21 Jul 2022 00:51:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:223a211d239a9755aa5595653ae122c4fa188dc4ca7017ac82579095c7afd3e7`  
		Last Modified: Thu, 21 Jul 2022 00:51:35 GMT  
