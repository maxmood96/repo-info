...
```console
$ docker pull drupal@sha256:4f343db84efe6e08747a7553a6aa4f5acea32d4da31c9b975369a983d7a416cb
```
...
```console
$ docker pull drupal@sha256:e395001983105ca74ccab4f1aa93b39e83801d1889e3db6e4e1c81068620b4cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49162846 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d725d2b2394ec2f431ceeee5ad81b36a2737cc606a69f5a16326932f334bb658`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 06 Jun 2022 17:57:05 GMT
ENV DRUPAL_VERSION=9.3.15
# Mon, 06 Jun 2022 17:57:05 GMT
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 17:57:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:c6b298876f3cce65298dab96e647b2dd38ad1df1abe69a020f576a891259bdea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2a0b5374a82e7af73e3c26a065aacef98d29b9b16410535c5ac5cfa1591063b`  
		Last Modified: Mon, 06 Jun 2022 18:10:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c38c54cc788a3435d38ae3ef0dec011df7b44e53e692dde59372426313fbb66c`  
		Last Modified: Mon, 06 Jun 2022 18:11:28 GMT  
		Size: 21.2 MB (21201524 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:d9b3833209bba16206689a61961df69d7585393e6270708016369d7395fdc6bd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49695567 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83b2c699f13085df38256a97f0f55f4f7ebb80b3ff84056ca34a7993ae4be2fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /opt/drupal
# Mon, 06 Jun 2022 18:03:30 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Mon, 06 Jun 2022 18:03:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:389fce7d2af1b08b0530b3894c03355cb5289e4a7c5248dbce28c378dd3ac5ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:809f640d4b83d22161ebac57baedc291f6d7fa6ed1fca5ae8b556909aad2bcd5`  
		Last Modified: Mon, 06 Jun 2022 18:31:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1534625b737976f04e474e0bbee93e89053ef2b07c6dfdb4e4711ccf804c3bd0`  
		Last Modified: Mon, 06 Jun 2022 18:31:15 GMT  
		Size: 21.2 MB (21201437 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
