...
```console
$ docker pull drupal@sha256:68bea67894a36b90be6553b5d1288858d3c9be3965a75bd430afdd713aa93fb3
```
...
```console
$ docker pull drupal@sha256:972c170997f6910d569056d276f7e2c20dfc10bacc89e3d6434255816f5ff20d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.4 MB (162357451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17ece41b9e8513553cb4a584d838220feab6f956c5bf885bc99f38d552d882f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 15 Nov 2022 15:26:45 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 15 Nov 2022 15:26:46 GMT
WORKDIR /opt/drupal
# Tue, 15 Nov 2022 15:27:15 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 15 Nov 2022 15:27:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f79bccafaf24e218e474a3f2a90d80ddded4c6e9e8ddd36f75796160ebfe7cc3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c635c52288a28fceed52ebb59f40c1f09426ce705f16c0949423d5577db811d4`  
		Last Modified: Tue, 15 Nov 2022 15:56:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec5bbc9e64f2aa39875edef048306fcb752042744eec078ac2e069ae88c2319b`  
		Last Modified: Tue, 15 Nov 2022 15:56:32 GMT  
