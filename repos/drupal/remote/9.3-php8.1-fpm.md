...
```console
$ docker pull drupal@sha256:490a6454eb5b09b075948dc80f321a778802b1086e70a42732d343e299e7ae95
```
...
```console
$ docker pull drupal@sha256:b949db864e504796320e6c99a624b8b3a6e8a5b938ba9b7a3d8f63af3d6ab6ef
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.5 MB (155520678 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27f6fbcdf855dac0fa026c90124c8412e15c5bfa6db883bee23e0cc4eda0e7d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:48:50 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:48:50 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:49:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:49:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2dedc389f450232a46867cbdf72d68d8445b0e43fa86ae70b3f13d523d75115b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c533b91bce996e46fba3fcdbe861cce2a824cde16bc5f53383f0aa7bc0076b04`  
		Last Modified: Tue, 29 Nov 2022 07:26:38 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa937e0a6662a21895df0302455ea268a05de2c3185ed74dbe83e6426fa1a84b`  
		Last Modified: Tue, 29 Nov 2022 07:26:45 GMT  
		Size: 21.3 MB (21324462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:7122aa038945fe0c533d5ee7a12c9c1c91732a12a260be230e1512a216c53069
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.8 MB (179788489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66f8871693f76d63b785cfdfdf81a00d4436bb7a7b3e8c898f18c18234a1e556`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 06:05:14 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 06:05:14 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 06:05:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 06:05:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6ad8e248c641cab636c63f43ab3581cd1478135944a65e9c567c6934f43f156f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:699e2d388be0958d9cd422cef8461d4b2b5ab19aa35a91ac41f48ba61ec6dbdb`  
		Last Modified: Tue, 29 Nov 2022 06:25:43 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59aed4ba9dd9dacb10c4a36c2b944a523ce73169b3ea1ad87c6b3615ed918317`  
...
```console
$ docker pull drupal@sha256:0811f462c3813589e39fdc21a04a11c62c5a40a3dc9507db95533f1e02956636
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.3 MB (187294538 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37816caa680f02833555cd7fe6dc8053c5da191a1375f39f9a82c10a8055a14b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:e2da1c2113094da76d330eef39e0e1916af11394dff778e02af557c116266d7c in /usr/local/bin/ 
# Tue, 29 Nov 2022 05:28:37 GMT
ENV DRUPAL_VERSION=9.3.22
# Tue, 29 Nov 2022 05:28:37 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 05:28:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 05:28:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:5ef54932816123e4cee17c312ee88d7d1fb22adb4cb55dd4bf11359dc2368e3d`  
		...
		Size: 695.2 KB (695195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c19df159813b988e39762d5c5fa3f0394fe5a58f6826c9b853e8205d50c175fc`  
		Last Modified: Tue, 29 Nov 2022 05:59:41 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c80a5aeb70c7277d3f1cad0a2324b4cb7547164b51e6624c99f4490f682f1570`  
		Last Modified: Tue, 29 Nov 2022 05:59:47 GMT  
		Size: 21.3 MB (21323573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm` - linux; ppc64le

```console
$ docker pull drupal@sha256:8eb8209032c377bedad89aa97b7553402d990865a64b73a01857b0e671a7412a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.3 MB (185305595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc161ff938aefc789b4d53f65f98d02b68623c60bc7c3528cddced51e72bc8f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 29 Nov 2022 07:07:57 GMT
WORKDIR /opt/drupal
# Tue, 29 Nov 2022 07:08:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 29 Nov 2022 07:08:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:695e44ea89e46a77d87f9ad5c356a1de08a78bd90078904244efca3e027462bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83b8e0eca712f89a4e33152cbd99a99e30bb6c168dc80bb3a2441bade103b964`  
		Last Modified: Tue, 29 Nov 2022 07:38:26 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ebdcbeb16c973992f840c9c2de6844bc3f9b2bc78e4db2aa34c29565a46a9c4`  
		Last Modified: Tue, 29 Nov 2022 07:38:50 GMT  
