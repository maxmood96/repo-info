...
```console
$ docker pull drupal@sha256:97efe4105d706ea522bbeaa3be2ea1de7c5e54e9cd674246be7978fe61c3680b
```
...
```console
$ docker pull drupal@sha256:686463269902a0e96a1ec44ec7b8d2d1d99a7fbc0a1b427a35b07e662af6048d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.1 MB (179116159 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4938ea988fc7854780f8a1d5fea01ed9f36060d5e224a16bc8ce5dc9bb92534e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 20:41:54 GMT
ENV DRUPAL_VERSION=9.3.22
# Thu, 29 Sep 2022 20:41:54 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 20:42:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 20:42:12 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:63ab2699bac1cb42ae123c74b849a150e559b3818588c04ddbac2f1b83c74879`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b211efa90d7285882c97c43d6064ec7d6739651e03a83e1c942d719e9008b53e`  
		Last Modified: Thu, 29 Sep 2022 21:19:11 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:752746d4f345f4ca8f666eef68ea1d7751e94097ef3f0c6151709c145e526c09`  
		Last Modified: Thu, 29 Sep 2022 21:19:16 GMT  
		Size: 21.3 MB (21321165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
