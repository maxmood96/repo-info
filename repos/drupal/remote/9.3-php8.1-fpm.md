...
```console
$ docker pull drupal@sha256:2a46469ea84d7394f1202fb6359da9e3525f18a4e84b1b97fa710bbcb7cefe50
```
...
```console
$ docker pull drupal@sha256:d9956a5417dca46ad1a1a0167c089e168b27cc3e21c877b51eeb3fcdb2db898c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (187022971 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:376b91212e317b0afeb89ded87111d41bfed0f635abe4207fccda1e822a72f37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 May 2022 00:40:24 GMT
WORKDIR /opt/drupal
# Fri, 06 May 2022 00:40:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 May 2022 00:40:37 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:935fe54aab56c3970e3d75a405801910f93d39cd8d2bffb13aa433a9a65c0db3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3ad9f1bcb90cf9ca9ca587cb3a43b33e77eb2bb6120ffc44f205b7851adf657`  
		Last Modified: Fri, 06 May 2022 00:56:04 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac63b3567a1f8e2aace242dc1168539aad7ab740a8621b1fce67549690bed5b0`  
		Last Modified: Fri, 06 May 2022 00:56:09 GMT  
		Size: 21.2 MB (21166968 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7b5de2aef8175ed0c480734bcfc77549e74564ede762eddee73e31bfef547455
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.2 MB (162156559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e843ac6674c4d4e496810d8804586b6c2fa402c26abb4e4e11c88ca4e26f0795`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Apr 2022 07:30:33 GMT
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Fri, 06 May 2022 00:43:40 GMT
ENV DRUPAL_VERSION=9.3.12
# Fri, 06 May 2022 00:43:40 GMT
WORKDIR /opt/drupal
# Fri, 06 May 2022 00:43:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 May 2022 00:43:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4a58dbb54e688001ebd800860cf84761d3d820da29057bfcc1ac0e2e9fdfbb2a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f03f5fc3abad3c98f0d2b257b57cba395daa164cb2f6521795312104652792c`  
		Last Modified: Fri, 06 May 2022 01:00:37 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77fe57daa61d25dd13cba648df823932dbd74d7201e42f659fb34a0a0d2ce05`  
		Last Modified: Fri, 06 May 2022 01:00:41 GMT  
		Size: 21.2 MB (21164181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
