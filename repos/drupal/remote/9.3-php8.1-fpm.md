...
```console
$ docker pull drupal@sha256:c470cafe1066650567b7c81475291d44575be36ec816140ab524964bc45af5c1
```
...
```console
$ docker pull drupal@sha256:dab66bd392802dd43dbf8a083785b6d4a7e1483b2f25e78ce89352b3296b5730
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.7 MB (178651546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b12041cf25b65f17ec7ae41812e6d99d9e89f1c2952df6c9992c64304cacdb26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:95091188fdd3c74d6d01c7de0880a7368fde28cdcf2258fe6769e04bf78b518a in /usr/local/bin/ 
# Sat, 14 May 2022 00:39:33 GMT
ENV DRUPAL_VERSION=9.3.13
# Sat, 14 May 2022 00:39:33 GMT
WORKDIR /opt/drupal
# Sat, 14 May 2022 00:39:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 14 May 2022 00:39:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:32d89fd43696a50068420c994c9c1c64dce0edbd285daaa6f86c4445dc1c6558`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3185dd7c336b97c797a2ced255b0ed72b260a33d3b42d2d893a328d9bb8fd3d`  
		Last Modified: Sat, 14 May 2022 00:57:10 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6289f541af3ce42c4e120ae082482c7b1e03cf80ca42df5d7e744208494ff25b`  
		Last Modified: Sat, 14 May 2022 00:57:15 GMT  
		Size: 21.2 MB (21181678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3-php8.1-fpm` - linux; 386

```console
$ docker pull drupal@sha256:278086a369f15ca014fe7f1c6e3b6364a9a4c78b905232a394a3712b76120205
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **187.0 MB (186993460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ee7865b455b87a8460e275c85028dbac5f1d7c1c9c1db4457d09e7392e656b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:1f9e583d96fc7c3465fa71b67ba39b1e1740df77292ba741b69862ad8582bdca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc01e4df5fc3e889b778b2088173be16734b494281c581656ca3be7706847a21`  
		Last Modified: Sat, 14 May 2022 00:32:13 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67ad1660292e2cbe9f32be8cd967f125c985de51a8be8fa050ea3900ff0e9e28`  
		Last Modified: Sat, 14 May 2022 00:32:20 GMT  
		Size: 21.2 MB (21181820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
