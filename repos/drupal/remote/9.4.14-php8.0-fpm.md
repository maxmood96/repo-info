...
```console
$ docker pull drupal@sha256:6c7abea231dca7e95fc063b01cd22e03b6e2bcb74b2415487a10e93019c8f2a9
```
...
### `drupal:9.4.14-php8.0-fpm` - linux; amd64
...
### `drupal:9.4.14-php8.0-fpm` - linux; arm variant v7
...
### `drupal:9.4.14-php8.0-fpm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:f59dd2146edc2bf5934a09418e0a9adc2d18b10406d693e468034a96aab0c3ce
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.0 MB (178046736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bee218539abf4e9b3b3d8102b0da0f1d4452ccd58b92b98c60ac83cc4c5499c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:ff489b37977bd44e280acfbfec0d762706e6f1446d77f0c00e2bffdc52c9df8b`  
		...
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50af91b3c06ad0c130fb29a61fbe2c56737425569dc579c1baaf15a555d7a251`  
		Last Modified: Thu, 20 Apr 2023 23:04:04 GMT  
		Size: 21.9 MB (21917442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4.14-php8.0-fpm` - linux; 386
...
### `drupal:9.4.14-php8.0-fpm` - linux; ppc64le
...
### `drupal:9.4.14-php8.0-fpm` - linux; s390x

```console
$ docker pull drupal@sha256:a083a05bc476c814b03816673d16e606968e9b977b1d8e7e80dd205681377044
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (161952129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8c5803b90aa5db6bf7b69b4230428e5059d9c0109a96530361d924847dee4f33`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 11:59:49 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 20 Apr 2023 22:53:08 GMT
ENV DRUPAL_VERSION=9.4.14
# Thu, 20 Apr 2023 22:53:08 GMT
WORKDIR /opt/drupal
# Thu, 20 Apr 2023 22:53:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 20 Apr 2023 22:53:24 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bb0d8e9f5b557b8cc1c6cdc0856ccba5e414d7ac8db4c5fa3beff78ea13c1278`  
		...
		Size: 697.5 KB (697531 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e79d2684b42d4258c0a220732b232ac6c8f21dd1f29a2596036fbd0378c4ab`  
		Last Modified: Thu, 20 Apr 2023 23:01:58 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f4ef60ae73c007c93dba65220f74286f6c34e6f88d7ad14d0c46536261d813e`  
		Last Modified: Thu, 20 Apr 2023 23:02:02 GMT  
		Size: 21.9 MB (21917463 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
