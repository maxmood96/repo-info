...
```console
$ docker pull drupal@sha256:2184c13a84a23f4fc798628252fb57954da1b31df7f56791ff8c7c0f4232539a
```
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; amd64
...
### `drupal:11.1.1-php8.3-apache-bookworm` - unknown; unknown
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; arm variant v7
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; arm64 variant v8
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; 386
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; ppc64le
...
### `drupal:11.1.1-php8.3-apache-bookworm` - linux; s390x
