...
```console
$ docker pull drupal@sha256:65fb3460518124ef8b473c9d7157c4ef278e9d4ee27773df546fd602b8c77fb4
```
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; amd64
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - unknown; unknown
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; arm variant v6
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; arm variant v7
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; arm64 variant v8
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; 386
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; ppc64le
...
### `drupal:11.3.9-php8.5-fpm-alpine3.22` - linux; s390x
