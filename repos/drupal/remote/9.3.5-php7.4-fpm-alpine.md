...
```console
$ docker pull drupal@sha256:55f61894463d019054eb40b951db05968b02e95bb40858e18425b0f2c3fd09d8
```
...
```console
$ docker pull drupal@sha256:cf83801c02687e689f7639795464738530868adb1516b975b544cb476aaad628
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.0 MB (52020335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:596ac76febd0faa7e5f21824b8b6b5f1f9fa88ab7b4ba7b71fa4f43e9f081394`
...
# Tue, 08 Feb 2022 02:25:49 GMT
ENV DRUPAL_VERSION=9.3.5
# Tue, 08 Feb 2022 02:25:49 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:26:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 02:26:03 GMT
...
-	Layers:
	...
	-	`sha256:88c98b726666eeda39cbabd5bb3e8da6ca21441bfcdba81b5bf51294348bd1c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7487538abff0cc7eb076c1938e70ef5dfe967b318978f69b8a825d433e68bd08`  
		Last Modified: Tue, 08 Feb 2022 02:51:07 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae4e2625aa3c049ee4166630699953330287c40aafcad3355e89e96a8df953c4`  
		Last Modified: Tue, 08 Feb 2022 02:51:22 GMT  
		Size: 20.1 MB (20118686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.5-php7.4-fpm-alpine` - linux; arm variant v6

```console
$ docker pull drupal@sha256:f592df626cad142c0e21fb562589870489ec85a730dbb21b45d9639a658f918a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.7 MB (50650577 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:53715b8509de6b6a758adf8e70188857c2ba40b3c8bed0014b0ef83b23e25f82`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 08 Feb 2022 01:53:36 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 01:54:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 01:54:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0a8d246c7f5b5bbb36efa2b49ae552ee6aaf84bf16e7ae1869936e4d0b9664b2`  
		...
		Size: 575.1 KB (575053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0480f9976b06de705bfb840a06dadea1d649d604dc5cf4fa703b195f8c7b47ee`  
		Last Modified: Tue, 08 Feb 2022 02:08:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f442d86e6b21017337d132f96bdfe5522c7559a93abc1b83609379a0351a68b`  
		Last Modified: Tue, 08 Feb 2022 02:09:21 GMT  
		Size: 20.1 MB (20119033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.5-php7.4-fpm-alpine` - linux; arm variant v7

```console
$ docker pull drupal@sha256:e4484e0108c32b761daeea238169c9a3ecb1bf88851d32c3ce1a3406c51903c7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.3 MB (49304388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e261a57339bb8924be80a6a48acb07b51ec0673a6d2973802b118cae94507005`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 02:13:18 GMT
ENV DRUPAL_VERSION=9.3.5
# Tue, 08 Feb 2022 02:13:18 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:13:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 02:13:49 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ee09198182eb8772a46f38f5fc673ed0147b19cad2e7ed2846cbcf78b63dba60`  
		...
		Size: 575.1 KB (575053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:693bf9acd48a1ecf79459b6062d77d07213ebd958d66b11c8b5bf796946debd2`  
		Last Modified: Tue, 08 Feb 2022 03:02:56 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eba8bfaa253cf7ec9d6af2d76da53f02df1333d6ef9a0aafd5567af5e938dfbb`  
		Last Modified: Tue, 08 Feb 2022 03:03:20 GMT  
		Size: 20.1 MB (20118753 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:96a4e2ed838e9214e6b41d18f54ea0371115c8e80e06234fd38265d51963823c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52545180 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f79a4d76512fad9bceb0b38f23edc90c5063290dbc943242732237bf86323838`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 04:22:41 GMT
ENV DRUPAL_VERSION=9.3.5
# Tue, 08 Feb 2022 04:22:42 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 04:22:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 04:23:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:047c00c5bdf82e0e27b31b3327d9151356eda0570517ef8bb89199cf8efdbb67`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3855324445ded09bac6c8c765c3ffdf6dcb62a350d7b12c7dc9770fdb3c5145e`  
		Last Modified: Tue, 08 Feb 2022 04:55:20 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f545a9ce649e1558f3c69e9a0774bad0bee5fcb765d3107656384c5d5fbd4a5`  
		Last Modified: Tue, 08 Feb 2022 04:55:32 GMT  
		Size: 20.1 MB (20118734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.5-php7.4-fpm-alpine` - linux; ppc64le

```console
$ docker pull drupal@sha256:8450acf2bea409a0600bfc42610d8222deb84084d5b77eed90d0fcbc192b7b6f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53330433 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b45b854e2ddaa08976f0d0d2ebc7a0781624c66d28a43b6d83665f962d2ca97c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 02:41:54 GMT
ENV DRUPAL_VERSION=9.3.5
# Tue, 08 Feb 2022 02:41:59 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 02:42:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 02:43:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:03f2bac92a08f6ff42e70f5a0d95e6ecee4d52d9b241aaca211b330d4fe519cf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c5b9e7033de0634aa3c36601fa414cd6b09e03b3fffab5e8e2a0f87cc9e1376`  
		Last Modified: Tue, 08 Feb 2022 05:35:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccdb34b6042fea22cda4a1935c37cad329f5bcdff43ea8751a5ba580198f6ac0`  
		Last Modified: Tue, 08 Feb 2022 05:36:57 GMT  
		Size: 20.1 MB (20118645 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.5-php7.4-fpm-alpine` - linux; s390x

```console
$ docker pull drupal@sha256:4186767598cc7c1b56e2bf9e894273eaa48ad78a33c4a2417c3ad269964773ec
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.3 MB (51264169 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5a3462e9b27ada21a8878e5aa39bc654d97e16ea09145a8b457efc91ac5b533`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:5d2492db66b0322c9731a78b6235019534ed7b945ccfa3459c04a7077a215f20 in /usr/local/bin/ 
# Tue, 08 Feb 2022 01:50:44 GMT
ENV DRUPAL_VERSION=9.3.5
# Tue, 08 Feb 2022 01:50:44 GMT
WORKDIR /opt/drupal
# Tue, 08 Feb 2022 01:50:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 08 Feb 2022 01:50:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:771b419ea31dd48beca7cc7ac0025d015191c9d0ae2fc99f9f0f392685ab1709`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8e55fedd90fc53c3b251300347ddc212c609d19ebdbc4009a45d16d5cd21100`  
		Last Modified: Tue, 08 Feb 2022 02:12:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c0c8e2c3fdd16005556a0a2dd9cdc211b2e99caa1c8d8b4f18c5c5d7be4c424`  
		Last Modified: Tue, 08 Feb 2022 02:12:35 GMT  
		Size: 20.1 MB (20118549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
