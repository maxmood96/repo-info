...
```console
$ docker pull drupal@sha256:76aac23eba8082494b68ece5087cbe45e7b3ec0f1b46e4c0fa63c27faf3fb1f0
```
...
```console
$ docker pull drupal@sha256:6de62f82244e5ad3f23671b8134e538ca2c2272116bee14d19eadaad900af100
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.3 MB (160288870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d6b7b6972356a28f05954421bf4ff7cea377234726267f137fd21ac173c056e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 19:31:23 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 19:31:23 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 19:31:44 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 19:31:45 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1b33bc7216d7f84d2e2bd605aa2f74b663b233e721ce38067e45d29dc81e42a4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c37851e7d161b77d0ce5d4318a77951a22f7e4dc4edc015e13594f1b8e0c10ce`  
		Last Modified: Fri, 23 Jul 2021 19:50:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:744252b6daca7de60316e5e32fa608b99c81a4971226e2a7946191911a036df9`  
		Last Modified: Fri, 23 Jul 2021 19:50:35 GMT  
		Size: 18.9 MB (18873309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:f41ad10f1384ebdeb21289de4c681045ff206eccc9fa5b5ee4e6fc04adcc7cce
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179603321 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e781bc37a1ea4ec3328c98a22fba4357b72faaa97d9afed9c9f5b091adac774e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Sat, 24 Jul 2021 06:08:27 GMT
ENV DRUPAL_VERSION=9.1.11
# Sat, 24 Jul 2021 06:08:32 GMT
WORKDIR /opt/drupal
# Sat, 24 Jul 2021 06:09:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 24 Jul 2021 06:09:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7edd72f27a4fb37efedf0f529fc655b854c6a659ba8b1c8722a554b143510513`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb17867bbf786dc4f1e9cfa1fe459d3e007ee84a06bf79e17d7dd1b1c5820545`  
		Last Modified: Sat, 24 Jul 2021 06:43:30 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5cafb979879b933284a5ef5623f9cde46c5dc5059d7f31c8bd6451a76e22c82`  
		Last Modified: Sat, 24 Jul 2021 06:45:07 GMT  
		Size: 18.9 MB (18873478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
