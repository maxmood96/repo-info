...
```console
$ docker pull drupal@sha256:d38a2c86ebe8a8add1c1fbabd9e9140903c32cb4532ffa8b91985f5abb80813e
```
...
### `drupal:9.1.11-php7.4-apache` - linux; amd64

```console
$ docker pull drupal@sha256:2bf0f166a71cf0d464625de6146cd9adf4f581dc2f3a7162c19c66f0a6d8b5dd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.2 MB (168171122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49d8af224f7965c7f08846406028f12daeab075159f2dd2bb9b3b5a95bf410b6`
...
# Fri, 30 Jul 2021 02:58:27 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 02:58:27 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 02:58:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 02:58:40 GMT
...
-	Layers:
	...
	-	`sha256:383b01f74aba8994b2d17c7f05b3a9bdda6cd590779c48c915b650f4184dd524`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8774505be4dc3edb7614915b03499e765e77eecd54ecc38d3b9c7c246e4c8f9c`  
		Last Modified: Fri, 30 Jul 2021 03:14:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:842bcffa1a9a7ea9b2aa7a41db60fffc14397d985856451f6559ff47c4cb2e2f`  
		Last Modified: Fri, 30 Jul 2021 03:14:18 GMT  
		Size: 18.9 MB (18872680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:4baf2ef9917a0cf302f6524db3766cbb3bb9393e208e4ea279809c31eba0ab0c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143557209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2c4b3c545615a5bae2bb5276c2cbc52e811031a147cce995e9876951eb505723`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 23:43:31 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 23:43:32 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 23:44:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 23:44:02 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d9c08cde75d81b151b8a3d31c93403b14cc746a28465da3ca67cc80739bac1fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1009813bf22d15fcdfe7a47d20bed87639ee825d30f074ba08032ae3b4dc0ba7`  
		Last Modified: Sat, 24 Jul 2021 00:16:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3423fbed2264db7312994b8ef8eba4c920843ac355f379088f690f33f5ed2ea`  
		Last Modified: Sat, 24 Jul 2021 00:16:47 GMT  
		Size: 18.9 MB (18873157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:25cb294b7c91e4e22be9ef92603a93a01bffe3934862f2c4210fce366805c570
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.3 MB (160290003 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7733846ae4003717283b279d7b1c6e875d57a39f888eaadf64a633a56b39425`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Jul 2021 01:35:26 GMT
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 01:40:33 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 01:40:33 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 01:40:48 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 01:40:50 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:76f6cd0b0ca18dcd68cccf663d63a0e24c149e114031edc1c691e99dd9c58630`  
		...
		Size: 553.9 KB (553914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e032e820bbe7720bcd666fde1bfe927ec48187ece66b9cca3ecf3cb3abe2943f`  
		Last Modified: Fri, 30 Jul 2021 02:01:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69bff3034b996092cf260ff8c30dfed673de268c05b8a0b4a4871a5a5626fedf`  
		Last Modified: Fri, 30 Jul 2021 02:01:26 GMT  
		Size: 18.9 MB (18872737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; 386

```console
$ docker pull drupal@sha256:d30afd51bad99477a28e77dcbdebb1fdbea8f23866bc6a5d3408fb8e959d472f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.2 MB (174219810 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49e22722f6060a4244fa48ddd3963ef7be76ff59fbc66867ba367401e007c97c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 30 Jul 2021 01:45:35 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 01:45:35 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 01:45:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 01:45:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:83dbc9eda136abd93b8c9525c977426fd0ccd626c35c5c65a752dd7dbc64699f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:461cf13118e9cc055e9ca84f715acf7337fcd160ddb93eac202201808dc18d59`  
		Last Modified: Fri, 30 Jul 2021 02:13:45 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8642092ebadf0be0ef128c6664326741b9b90e37f6acb8e581dd72be6db11a64`  
		Last Modified: Fri, 30 Jul 2021 02:13:55 GMT  
		Size: 18.9 MB (18872666 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; ppc64le

```console
$ docker pull drupal@sha256:227a27e78960992b9500b1fe8c946578d539dd3f45142c66e9da5e7f4ae90700
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179604741 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f32edca9bfb207d6bc8644af3641d30e61a8237746ce84c316084e9d210a8aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 02:39:47 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 02:39:52 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 02:40:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 02:40:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:414fe636667fc94f022de1e15f78447a46e33dbd32f5aa4bff7f4119619e8cc7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93bc23003ec7074ba59ad5ff50ecd6cb9c595c1562609b5bb8627a6f3a66b2db`  
		Last Modified: Fri, 30 Jul 2021 03:34:28 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05eff8040801bf63054653d55ebc2e09a25cc4cdd85d99c2d364097e9a494103`  
		Last Modified: Fri, 30 Jul 2021 03:36:18 GMT  
		Size: 18.9 MB (18872717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; s390x

```console
$ docker pull drupal@sha256:5e51b41cecdde992efcd1871019f1e29873c063b32d094d816fea44011ffe708
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153860065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6587a576bb807c54494709b7a0f5879e3233ad447b0589c26aca313748ebd242`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 18:05:38 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 18:05:39 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 18:06:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 18:06:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:816a44a2b739cfb383f1173cc2be7f80ba4bea61781cf8fbf8b1b862d43496f3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d717e0d52b04d6b47ca1ad85d0ed54d36c27c79d3390eb0d60e226fa4fcd48e2`  
		Last Modified: Fri, 23 Jul 2021 18:22:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e5770ea82d5ee11cedc8e92540d6e540aecc9369c293c99bfe76ee40052ad546`  
		Last Modified: Fri, 23 Jul 2021 18:22:35 GMT  
		Size: 18.9 MB (18873318 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
