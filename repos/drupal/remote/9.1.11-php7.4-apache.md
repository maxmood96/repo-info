...
```console
$ docker pull drupal@sha256:66ea01e0d62a9a6c70ae73e3dabf349f33fe005cda55cef0d9b122caef7aa8bd
```
...
```console
$ docker pull drupal@sha256:db446071b15c41b37bc91a745d99349057ea3cb1c70f309f25a832098b56f7a8
```
...
-	Total Size: **160.3 MB (160287489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0609aa197cdb33dc7e2cd4ec2fe0f5dfad190f92b9e252da2019a1801d205dbe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 01 Jul 2021 23:02:22 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Wed, 21 Jul 2021 23:45:25 GMT
ENV DRUPAL_VERSION=9.1.11
# Wed, 21 Jul 2021 23:45:25 GMT
WORKDIR /opt/drupal
# Wed, 21 Jul 2021 23:45:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Jul 2021 23:45:40 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7cb2b0ecad94e786026a21c0252455aa47b77577fac3ee21bac9d45bf3310959`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bed706d413b5f929677f6ba37facfa545d7a76847f766ea5f355b22b825c8ed1`  
		Last Modified: Thu, 22 Jul 2021 00:06:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c03e0768d946e25db328162003efc1167ad043017944c0e1341d45088a2dc2f4`  
		Last Modified: Thu, 22 Jul 2021 00:06:40 GMT  
		Size: 18.9 MB (18873194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:971bd00b1726af153a52c85f1cb2ceec0e339269cf0cc5e6b9b8f5437c4bf4fc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153859963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcec581588cb421295085566ff1825c8bce7e275359e89a694267dabb266f0aa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 10 Jul 2021 05:05:04 GMT
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Wed, 21 Jul 2021 23:51:17 GMT
ENV DRUPAL_VERSION=9.1.11
# Wed, 21 Jul 2021 23:51:17 GMT
WORKDIR /opt/drupal
# Wed, 21 Jul 2021 23:51:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 21 Jul 2021 23:51:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ea4bea95ee43506025fa3d46a8e687b00cd8cdd1601d443dfdf0e847e1748af3`  
		...
		Size: 553.2 KB (553186 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4344200e242b851ddcb9be203927ccba4273af3fe93ecf26e13c422189c3d59c`  
		Last Modified: Thu, 22 Jul 2021 00:12:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:466e3fe1346132e5ea3175862a22c6eb11c8a1922259a7e2979269ba6b087e1f`  
		Last Modified: Thu, 22 Jul 2021 00:12:46 GMT  
		Size: 18.9 MB (18873055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
