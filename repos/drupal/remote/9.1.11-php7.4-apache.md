...
```console
$ docker pull drupal@sha256:2f1bc4522115b0db357a7c1e63c7e810e0f1b32aac9b85da43081c3715695c0f
```
...
```console
$ docker pull drupal@sha256:9684a9f53c6237c019b95031cda764eb9f0cca5be37d2b1f095629b3cd0ed073
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143558456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:145582d9d35334b8398544ebcce93069ea04b405eb8d44e00e61466f035901c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 04:11:52 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 04:11:52 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 04:12:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 04:12:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:568ea4ba3d4e7317f1d78f13250514cad8b3a500ac4456659d4d3bbeddb4b23b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54eca87d5b48ac3bc89e445c94c2d87fc58b1da824c82d66cf235a28b3ac90fd`  
		Last Modified: Fri, 30 Jul 2021 04:48:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d6bc3c34fc1c8914981be1e858f977f514c773b5430caa1fa51c20fdea76c2b`  
		Last Modified: Fri, 30 Jul 2021 04:49:01 GMT  
		Size: 18.9 MB (18872590 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:232ba03cb300dfe12206f6b1625be0d2932efa2cb275b17acb269d81a5c81270
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153859985 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6b087a9ecdd837d61d0da1d59dea7a2241de42e5dee1e3cd4b4b55f2fec8c42`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:3e162edb3278a885c516d518136f3034c1eced6f4248bd3295042096c46920e3 in /usr/local/bin/ 
# Fri, 30 Jul 2021 03:41:20 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 30 Jul 2021 03:41:20 GMT
WORKDIR /opt/drupal
# Fri, 30 Jul 2021 03:41:51 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 30 Jul 2021 03:42:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:01ffbd4a0c848232f63ca1931d536d507a4144ffdbda45a13f11efb29effe9aa`  
		...
		Size: 553.9 KB (553920 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28a8cf6b90013308e6eaefd0babf57feca622161d30b576a863e5288b02c7701`  
		Last Modified: Fri, 30 Jul 2021 03:59:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a62fa446ee7e4b3e722fb8b4a692bd9bbd58448126a94a7f3b01dad1c790e367`  
		Last Modified: Fri, 30 Jul 2021 03:59:23 GMT  
		Size: 18.9 MB (18872455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
