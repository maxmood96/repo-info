...
```console
$ docker pull drupal@sha256:0839761475ec746b6a619bb0cbca04737066e7570aab720b0a622bcb5183c205
```
...
```console
$ docker pull drupal@sha256:b49903cbbe73d1b7a1f45d3e806891327ed87d53b2abbbef16103e7dc01bec0f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.2 MB (168170635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6db97bfc2ba9d73a8a3ebdd2cab22dcb69c1eee8999add925e73bd1adf7f4f5b`
...
# Fri, 23 Jul 2021 18:40:12 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 18:40:12 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 18:40:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 18:40:30 GMT
...
-	Layers:
	...
	-	`sha256:a683fca7cb9b72c9f9369af8d854af6bc8a0fe2ec5efb010bc611b498236d31e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0902ed1cdc54f0b4608b3ebbf834ae9acb565d0db61ec11ea4b9578756f86a5`  
		Last Modified: Fri, 23 Jul 2021 18:55:00 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a0b2fa0d30817d011723e5a9459a36936084df12da77badcc4aaa3dc07bc5a5`  
		Last Modified: Fri, 23 Jul 2021 18:55:05 GMT  
		Size: 18.9 MB (18873316 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; arm variant v7

```console
$ docker pull drupal@sha256:3f0d1968777ecd51242861cdcf681fa466f525197e846be0703f34488f11320b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143556842 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0d230ea1cf43183c81a5f856fa7abc63debebb1968f9a1169b9fc39dc490f59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 23 Jul 2021 14:46:39 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 14:46:40 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 14:47:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 14:47:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1565ef6b4647f6e89077df02a79a36def8cc55ec831cb5a120ee37dce2543cfd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36d75a95ce0e927800961afa06a9b9f4b69d19253ce53656cd27f6d9d2bad558`  
		Last Modified: Fri, 23 Jul 2021 15:16:22 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3577569690e24bce7752b63ffe2d0ef43d690742f610385575adbbb1e45869be`  
		Last Modified: Fri, 23 Jul 2021 15:16:48 GMT  
		Size: 18.9 MB (18873523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.1.11-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:663323adc90f40ec3e35b61a194f7d1e71a2ed0090d03602147f495e68ec9722
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.3 MB (160288898 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbe09127281a2396a8d3838adc76e79fb16d2b4f0b7c6151cd3fd1b5a87224da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 23 Jul 2021 03:51:24 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 03:51:24 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 03:51:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 03:51:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:280f7477afcad212e60c173e5baba3c5f45e4928a1497d9787678e25c9659e7c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b44163f97f11f1ca866a74306097282d99085b67c01d648f9efeb9f48f37c8cd`  
		Last Modified: Fri, 23 Jul 2021 04:10:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd160f7ae2fa6abf3b2f361f12fb2d40a6e56a942e2504abfbab4794122fc249`  
		Last Modified: Fri, 23 Jul 2021 04:10:21 GMT  
		Size: 18.9 MB (18873370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:7178fcc0300109ab665298b952acda789b28915f076004783b5954abfa0eea99
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179602387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36dd83a6ad7961a6550af101bba2e595de504aada003ec8daec13600b8b38d75`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f539a671699d0ee2c6a9addc1c9882f0a57e431136013791bb98020df3e6cbd3 in /usr/local/bin/ 
# Fri, 23 Jul 2021 02:45:12 GMT
ENV DRUPAL_VERSION=9.1.11
# Fri, 23 Jul 2021 02:45:15 GMT
WORKDIR /opt/drupal
# Fri, 23 Jul 2021 02:45:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 23 Jul 2021 02:45:53 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d6765b57f07449d2f1436486f0a4fcdfd8e6726fcf7d80cc494ad4f7063f3eaa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e2ebbed8af2f3d0c096540128efb6e33929efdb1b09207906711c18a65e344a`  
		Last Modified: Fri, 23 Jul 2021 03:20:57 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d0650c942fa2e6e9b165f856d93b1bdca3fa6c74a35d77925b5b9de0e7290eb`  
		Last Modified: Fri, 23 Jul 2021 03:23:32 GMT  
		Size: 18.9 MB (18873279 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
