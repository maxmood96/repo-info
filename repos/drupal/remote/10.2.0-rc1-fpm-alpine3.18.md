...
```console
$ docker pull drupal@sha256:5e7cc04634dc4014a4103c2003c016d890102b1fb5b990d2d88fb6497a6f37da
```
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; amd64
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - unknown; unknown
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; arm variant v6
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; arm variant v7
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; arm64 variant v8
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; 386
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; ppc64le
...
### `drupal:10.2.0-rc1-fpm-alpine3.18` - linux; s390x

```console
$ docker pull drupal@sha256:281f0591a9c3a50f53db56ea15d1574608d346cdc0ab068c57f267c7dd3197f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.9 MB (51888572 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67c5bfbb8d679b1e8475bc697a17021cfbb1a2cde9a1a191f8115e1257ca86f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c838dd70bc1af188a4f708a1aef3d0846c7b28644844dfc594476d93edbe5291`  
		...
		Size: 114.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:20c80388893baad4eba128b2f66d401fa73ee690c631249f22d38f79a0b929c6`  
		Last Modified: Sat, 16 Dec 2023 12:12:27 GMT  
		Size: 19.2 MB (19189020 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `drupal:10.2.0-rc1-fpm-alpine3.18` - unknown; unknown

```console
$ docker pull drupal@sha256:821a0c82fd85e5fb4be52ffe2f8f798542ff1872bfb1d5984264a2288b8ad06e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.1 KB (311064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b2ceb9dda1d1d9bb1278d0b8e4e8976ad01b310e0d08e3b21c5309bd2cdd9a1`

```dockerfile
```

-	Layers:
	-	`sha256:be6066c0d0dfcaf40c8abf60fc0303209a3dfc0bf004c5288a06be6464180c38`  
		Last Modified: Sat, 16 Dec 2023 12:12:26 GMT  
		Size: 279.8 KB (279759 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:d309cdda37d912f544986ac3881b7c83b40289b5542ae26720a0f6f18630f034`  
		Last Modified: Sat, 16 Dec 2023 12:12:26 GMT  
