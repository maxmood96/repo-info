...
### `drupal:9.3.20-php8.1-fpm-alpine3.16` - linux; arm variant v7
...
### `drupal:9.3.20-php8.1-fpm-alpine3.16` - linux; arm64 variant v8
...
### `drupal:9.3.20-php8.1-fpm-alpine3.16` - linux; 386
...
### `drupal:9.3.20-php8.1-fpm-alpine3.16` - linux; ppc64le
...
### `drupal:9.3.20-php8.1-fpm-alpine3.16` - linux; s390x
