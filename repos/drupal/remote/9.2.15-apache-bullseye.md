...
```console
$ docker pull drupal@sha256:37ad68a4aa119c673ad1e956602497e9111178bbcbaa0917e896c6612b18f807
```
...
### `drupal:9.2.15-apache-bullseye` - linux; amd64
...
### `drupal:9.2.15-apache-bullseye` - linux; arm64 variant v8
...
### `drupal:9.2.15-apache-bullseye` - linux; 386
...
### `drupal:9.2.15-apache-bullseye` - linux; s390x
