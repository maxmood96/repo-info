...
```console
$ docker pull drupal@sha256:b8e36a0421e2bbeea2461a9764181f60cbe9b996f632b950800f9ee11c1e2fb8
```
...
```console
$ docker pull drupal@sha256:4399d0a039f7bd9636685302ad3c5922d360f3f4529ccaca84d81780df40c50d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.9 MB (50926479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c95154bc8efef234ba1f55fd32b16e2d2ff9b3414505641b2bd1827b2f502296`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Feb 2023 23:23:22 GMT
ENV DRUPAL_VERSION=9.4.11
# Wed, 15 Feb 2023 23:23:22 GMT
WORKDIR /opt/drupal
# Wed, 15 Feb 2023 23:23:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:eea8d1881adaa6b1eb023bd49768cb62decfd1d7f4462d2b53f9eca1962d2b20`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ec546521380036443106e515e85cdad3e6fd65cd002e77ca106e5ce21c146e0`  
		Last Modified: Wed, 15 Feb 2023 23:58:14 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:258e436dde219f76b09027639a62dee2e8897a397a3e6a66b269b183aae47984`  
		Last Modified: Wed, 15 Feb 2023 23:58:21 GMT  
