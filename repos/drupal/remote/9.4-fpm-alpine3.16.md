...
```console
$ docker pull drupal@sha256:7e243205e901e73d96cde76bf1d067cc9db8253be10d8f474f1abcba1bee5aa3
```
...
```console
$ docker pull drupal@sha256:9468fcd9b67019e1ed341ab2c9ec8586c0b5b8d19960786dc3228aecc0a93a39
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51645139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f66fa9b2d7529ad4f670f3b19505d8afb6d568afe10b9261207e1ea85daeda1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 03:10:16 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Wed, 15 Mar 2023 23:56:43 GMT
ENV DRUPAL_VERSION=9.4.12
# Wed, 15 Mar 2023 23:56:43 GMT
WORKDIR /opt/drupal
# Wed, 15 Mar 2023 23:56:56 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 15 Mar 2023 23:56:57 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6c6f29db875949e6db7629b549f0f0e639beca3132f1b0552a77e72cd667e3f4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0050292e826a455e3cd070d05c214f64946a6f905200a767c7c37c75dfca3e2f`  
		Last Modified: Thu, 16 Mar 2023 00:05:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40f0f566e5a9c253f14e39308e9ca4780d0a169519f3a849c1efd738fbbf6261`  
		Last Modified: Thu, 16 Mar 2023 00:06:00 GMT  
		Size: 21.9 MB (21902029 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
