...
```console
$ docker pull drupal@sha256:a9a6ce73e8c217ded11a8717c9cffbe3659ed1b143a072901ce4c941b8d5a719
```
...
```console
$ docker pull drupal@sha256:95620ae54285ff1f40b9d1a6a80b585d3e245eed9f08ab1f8de29e8b351b04c2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (54044530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9fcfa79f0be62681a53bb6a7ebe91db7087763f920de63280257e23388064d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:36:06 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:36:09 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:36:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:36:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9af454a60fa5d59fef369d769fb4f9257eea79d556d6f9ab618011c94b04c693`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56fd62949c8c82ee709f7b03400d9014048c6e812f7828a410b230106198c6a7`  
		Last Modified: Thu, 04 May 2023 08:01:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd681619a67404b558d28da0bbea5d31750561159b6b021c7351f5ab68120efc`  
		Last Modified: Thu, 04 May 2023 08:02:11 GMT  
		Size: 21.9 MB (21902005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.4-fpm-alpine3.16` - linux; s390x

```console
$ docker pull drupal@sha256:f3b7767edeb3f97ec3f058129a8f19076651f245270bd5fa20075ff673ed2e00
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.5 MB (52485807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:623cf6a0e2d2a74484ec692802af0345ba360e6b5571fbe2a114fb7f40a53be9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Thu, 04 May 2023 07:11:45 GMT
ENV DRUPAL_VERSION=9.4.15
# Thu, 04 May 2023 07:11:45 GMT
WORKDIR /opt/drupal
# Thu, 04 May 2023 07:11:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 May 2023 07:12:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:9a9ff1de241fdbbbd8463236672ede58f4bfce5a30ae1ce859b420e384449a9d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60d07af14ad145c90d330638f2cd79a290c0740f11fb995cddfaeb938b268aab`  
		Last Modified: Thu, 04 May 2023 07:21:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34d45adc449a2b4b893bd9a421e6dcfc59402f8c82d29068e3d5ca2ce37f8ebd`  
		Last Modified: Thu, 04 May 2023 07:21:20 GMT  
		Size: 21.9 MB (21901565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
