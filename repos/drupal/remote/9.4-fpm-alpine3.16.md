...
```console
$ docker pull drupal@sha256:0ac9134d2003b702192aedf51ea0ad3a17175b278137c8a38978cf06c8671ae6
```
...
```console
$ docker pull drupal@sha256:9d3534ac2eb130ecb8f2a32d514e406d0d553a618406200d943ae546975177e1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.3 MB (52332822 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79e7eb7baaf18a58397acd4d4a66a4be97b174c737a12f16f41ee22d8edf11f4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 10 Feb 2023 20:11:59 GMT
ENV DRUPAL_VERSION=9.4.11
# Fri, 10 Feb 2023 20:11:59 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:12:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:12:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:86b9e0fee329490296954ea229f29e71842cc3bdf1255c5744e01f0a36c0d3e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c0d54d225cee35f5a39e14ad8792cc7bafb4732bb89fea457ae089f689739ed`  
		Last Modified: Fri, 10 Feb 2023 20:21:34 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95f7f5cd4f7b71b33da3be4115bbc77dbd22044a38a8af08b5932f8a2d073f5d`  
		Last Modified: Fri, 10 Feb 2023 20:21:42 GMT  
		Size: 21.9 MB (21901766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:166c7717b8989a84785a5529bbd327db2811627b445718033cb0d431dfa96add
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.4 MB (54398285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08a8a7dd46a721f75855f83c2d9ecf71ec4a78d426ecbe77fb513958d6b896ed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:eabda45ae71a4b9525aa8464965ff1caf882c63cab948e2e2ee1aa3eca48001e in /usr/local/bin/ 
# Fri, 10 Feb 2023 20:25:45 GMT
ENV DRUPAL_VERSION=9.4.11
# Fri, 10 Feb 2023 20:25:45 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:25:55 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:25:56 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:51ddefbd23f44a2a0e82d2ed42fda0e0c46c495f3f8d9a67023942dfcfcb942a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ca8ce57bc224f49cb4e2293619b10c0b6694a2d7e1818dfd04df087c800ce84`  
		Last Modified: Fri, 10 Feb 2023 20:47:36 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20a84bf910448c9506e9b7b68475c0ee6f9fb55c11f1ec7d1d6cbd8d82137f5d`  
		Last Modified: Fri, 10 Feb 2023 20:47:41 GMT  
...
```console
$ docker pull drupal@sha256:44eb2f39ca07c0f0d11823e5fad632efee43abbdb67dac98d362c29ac06ea697
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.4 MB (54433082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:338fbd9b6938042375bf0c9bd37dcdf9dc6a2a0150fba2977c44e4a7408d2d2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.4.11
# Fri, 10 Feb 2023 20:22:24 GMT
WORKDIR /opt/drupal
# Fri, 10 Feb 2023 20:22:49 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 10 Feb 2023 20:22:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a57e014dcd02fec754da325a91ca09e04aa13d0893258ed0e7db01ce8383f68a`  
		...
		Size: 697.1 KB (697137 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46087f44dc10f7191c1323796cf625d267fad2cccdfe31ad5a1336ab5d6500cf`  
		Last Modified: Fri, 10 Feb 2023 20:52:32 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6b01cb93356c195ac5293cd012effe05ec7d5a5f2246080c81ee3e64aae2627`  
		Last Modified: Fri, 10 Feb 2023 20:52:58 GMT  
		Size: 21.9 MB (21901511 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
