...
```console
$ docker pull drupal@sha256:86323c493c31abac1c18f3f545b60f205f9c1a4de6770b72ab29acf37fd727f1
```
...
```console
$ docker pull drupal@sha256:79bac58c69c2798ccea22b930394b5b99c08e53be988ccc1adc888c4d6055039
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51644818 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:341495f97f0661ef06375801c79e5da939fdd9e9fc4e2ed4d89fd0ee5c4955de`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:12:04 GMT
COPY file:151722a4d2b58546b064de6bf000f03d8e4523c2b44cddc7229b2dce9ac9c49d in /usr/local/bin/ 
# Sat, 04 Mar 2023 02:14:25 GMT
ENV DRUPAL_VERSION=9.4.11
# Sat, 04 Mar 2023 02:14:25 GMT
WORKDIR /opt/drupal
# Sat, 04 Mar 2023 02:14:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Mar 2023 02:14:41 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d7fdb1f4f79723871b3aa65bfe2027cb7faeb825232fdc77c8c7e0ab4d31c6c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adbc82f43925df82c85a63ca6029dc1f4b290b299f89fc20c0d4f8291f94dd60`  
		Last Modified: Sat, 04 Mar 2023 02:22:53 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d55eb5cd74f19c250f639a209f7ef2b21fa90af05aada34f1e8033bcacce3fb`  
		Last Modified: Sat, 04 Mar 2023 02:22:59 GMT  
		Size: 21.9 MB (21901741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
