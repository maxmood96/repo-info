...
```console
$ docker pull drupal@sha256:a9fc1d371f3896e79e82487afd92df57023ab9410765436ccf5634c79416b10b
```
...
```console
$ docker pull drupal@sha256:18b24324d782c359cba71249f06ebddf18991f75c76c50b3c69b91624ae7c96d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49707973 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01bb8104dde578b939b15bab9de5994b1eeef4d48f123c26c4610b6929981f1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:31957edf88ab81c875036fac642510adba17e7f664ade12ad4cc270b8b01a7d0 in /usr/local/bin/ 
# Thu, 29 Sep 2022 21:54:24 GMT
ENV DRUPAL_VERSION=9.4.7
# Thu, 29 Sep 2022 21:54:24 GMT
WORKDIR /opt/drupal
# Thu, 29 Sep 2022 21:54:45 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 29 Sep 2022 21:54:46 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:2a95908b105e564348d5b8b6eaf8a23fd5d8b6f071590722be1a14de7a8d02e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28e1dddd39351345ee078d5e77cd124113e314ffa91ac95c6609a5e75807f93d`  
		Last Modified: Thu, 29 Sep 2022 22:45:40 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f74875b872496f962c51e89af4e60bfbae25a49344586913b965cb1bf2a47cbe`  
		Last Modified: Thu, 29 Sep 2022 22:45:54 GMT  
		Size: 21.9 MB (21881322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
