...
```console
$ docker pull drupal@sha256:e2de7da17e280990ab5df69613e03ffbe173ebde50794dd6eed2a8f6f0b02f8f
```
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; amd64
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - unknown; unknown
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; arm variant v6
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; arm variant v7
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; arm64 variant v8
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; 386
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; ppc64le
...
### `drupal:11.0.0-php8.3-fpm-alpine3.19` - linux; s390x
