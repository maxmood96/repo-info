...
```console
$ docker pull drupal@sha256:06d19d35ed7ce0ca6e899252922788b5f0268934f2b3c8f2404244c4d94658f9
```
...
```console
$ docker pull drupal@sha256:7dd24fe0e039612d4ce3e2e1e0f4b1b00efd6aa4c1f4873b594b27922fb6ab25
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.7 MB (142707674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:832e3dc17a2ffc8deb7f22a7dfd77d1537d847d48868990edd81d5a3021c2fed`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Sep 2021 18:02:09 GMT
COPY file:190a37f719fcfc156d8dcc2127ae21b93a852d1bcc41da08496dfa95b4533569 in /usr/local/bin/ 
# Sat, 04 Sep 2021 18:02:10 GMT
ENV DRUPAL_VERSION=8.9.18
# Sat, 04 Sep 2021 18:02:10 GMT
WORKDIR /opt/drupal
# Sat, 04 Sep 2021 18:03:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 04 Sep 2021 18:03:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:da0084caf370ec143e4935a02447ec7ac2a5e9e789bc5a3c485da225c7ea185d`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbee2f822b988963d9fd174b37a83554560c2270f63dac57cd0c9d13ba88f80c`  
		Last Modified: Sat, 04 Sep 2021 18:32:40 GMT  
		Size: 507.6 KB (507615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:651f9fe50381a1213ea46c8161aa488bae2dbd2244b5c03702df07b715ba950a`  
		Last Modified: Sat, 04 Sep 2021 18:32:39 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49bf4bbc42e56fc41999b8d00a1b12aeb7e3dca90d1e875ca06afc784129f457`  
		Last Modified: Sat, 04 Sep 2021 18:33:07 GMT  
		Size: 20.8 MB (20797306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
