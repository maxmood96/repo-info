...
```console
$ docker pull drupal@sha256:878fdfc0a7073b93248016181ed2c567453693f3663e05a3fb54d4e61f83f2a9
```
...
```console
$ docker pull drupal@sha256:e7211d0afa2c08ea284bc0458c71a6dc705519a7ac742a0fd0846175196708aa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.6 MB (162605597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4607811da352812696c6aaac461d7f16ab9265db678cd06fe3c03e73a98b8f3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Mar 2022 22:10:36 GMT
COPY file:4504a34585a65110669523e5922892f1b1d0b993b4131f7b2302f17c5be3d55f in /usr/local/bin/ 
# Tue, 01 Mar 2022 22:19:52 GMT
ENV DRUPAL_VERSION=9.2.13
# Tue, 01 Mar 2022 22:19:52 GMT
WORKDIR /opt/drupal
# Tue, 01 Mar 2022 22:20:01 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 01 Mar 2022 22:20:04 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:17d0a4d42164fbab139045041e6fe908ea7e340c741df15e3de5165862aab481`  
		...
		Size: 575.3 KB (575344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3df6f585aed1a6caf5695729854f8a9895fb4796da7bac411f8f9d8dde0c02c0`  
		Last Modified: Tue, 01 Mar 2022 22:39:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeb9baae195c7cac04f47f27c02c746eca4b465650ad6e8d2903d769cc20829d`  
		Last Modified: Tue, 01 Mar 2022 22:39:08 GMT  
		Size: 19.1 MB (19123097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
