...
```console
$ docker pull drupal@sha256:f24f4d49e4abcee6fdbff71ff64413b177489f1e7ae33bcc6deebb0c5e76ed73
```
...
```console
$ docker pull drupal@sha256:e7e1d20af2988d8375dd865cf7249de5946b3398760995aefe42c67bef24bb7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189020559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ceeb49ea7705284022af50896645ceba0c8a5d2e847cadba8ca69fc66adaabd9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 02:57:44 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 11 Jul 2023 02:57:45 GMT
ENV DRUPAL_VERSION=10.1.1
# Tue, 11 Jul 2023 02:57:45 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 02:57:54 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 02:57:55 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8336e0d54a985f0a3cd20aa9cf0c29e21cfddb7323c3f5318e10e5e4e2101769`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32b771de53e51f8977c5e27fb3b974d2d7e09188fdafd760383a24b8fc72cc88`  
		Last Modified: Tue, 11 Jul 2023 03:23:12 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaa4ecd5e78b0865ab2375157cd8da061c10cfde39a14212afa23403fb6beda6`  
		Last Modified: Tue, 11 Jul 2023 03:23:18 GMT  
		Size: 18.5 MB (18505417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:bcca706e13db5e83429d48154e41db312a4ede571c55d517258beaf7177f03f1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193764661 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d7dd8ded28fb8450c3aab741aeecea81d16d0af2fe140a858942946e1c4cc09`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 01:38:52 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 01:39:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 01:39:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b7f003e6605630ffbbe5e1e1fc420b31cfdf5967b245c742e10da3aa3502867d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7d20bcc5eb854771ccb3d24f14e2f4879955d1392318b44cd0638c698c4f5bd`  
		Last Modified: Tue, 11 Jul 2023 02:04:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75b629bcdcaf8264c4ef3581a73d803a8eb4edcd0656b37525a94df9c1698264`  
		Last Modified: Tue, 11 Jul 2023 02:05:00 GMT  
		Size: 18.5 MB (18504624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
