...
```console
$ docker pull drupal@sha256:a51ef04b77ee7d4de4602b8468c4f58d5624609528f68029dbec421a2e41318f
```
...
```console
$ docker pull drupal@sha256:c342a5fe33d87cb469ae4df83c7979bac03808af904d71ddb63c98348fe443e4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.0 MB (195007304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7dcd443beb91f30a1be10433e6c1433376dd465bd5a4e4a8fe5d214521baa17`
...
# Sat, 29 Jul 2023 00:39:08 GMT
WORKDIR /opt/drupal
# Sat, 29 Jul 2023 00:39:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 29 Jul 2023 00:39:18 GMT
...
-	Layers:
	...
	-	`sha256:fda2fb4c2777fec9b65525dc372efa4c3906e375bf69baf18c07fe99b58de946`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d77613c4f22e6ac7270f3f6f4643218970207f3678096fb8cca6b7ec702776e`  
		Last Modified: Sat, 29 Jul 2023 01:00:20 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c135296580035a97d7ca79471e3acf39be9a6efd5573ce99e971d9254733ddd6`  
		Last Modified: Sat, 29 Jul 2023 01:00:24 GMT  
		Size: 18.5 MB (18504380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:06c52c4c61117d9ec168cd3286bd4388dd56b35050ea9e37f4d245598522558f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159525248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:25e8a81cd711615eab92dc1a2f96672b48466a003412b03654a7d2becc4927c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 00:47:58 GMT
WORKDIR /opt/drupal
# Sat, 29 Jul 2023 00:48:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 29 Jul 2023 00:48:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cbb9755e700be6048433302ba7a3198e7528850dfc1fcd7c91f9cf5ff512e391`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9eedaa3bbc29a2a0abe413aa73fe60cb850ffd4cd8776311182c0d78db2e341d`  
		Last Modified: Sat, 29 Jul 2023 01:06:23 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:511f3e9a4a8551490606034915865bebfd4ee0ab380ef82b88fc5c2415a22eba`  
		Last Modified: Sat, 29 Jul 2023 01:06:29 GMT  
		Size: 18.5 MB (18504236 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:0bccc77acf901ad9fb50a2e8e646207039ff172087f6a63ef129a9dcd248e83d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189026909 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a2438ba3a2126263c8bd291520a57537311d5542e6aa178eddc2bb395ab0208`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Jul 2023 20:46:49 GMT
WORKDIR /opt/drupal
# Fri, 28 Jul 2023 20:46:58 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 28 Jul 2023 20:46:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:21e94bd710030fc2d79cf0b4858659e772b7b7f5d6020411e5eb5285f37dfc40`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8e2463f1414731cca805c0ecc7eeb7427d6c56295883e98112394f0f7cab088`  
		Last Modified: Fri, 28 Jul 2023 21:06:54 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ab2aac4c0580e0fa8184e853f801f33724b80b43472435ef3759682dfc2b65a`  
		Last Modified: Fri, 28 Jul 2023 21:06:58 GMT  
		Size: 18.5 MB (18504307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:42ffd124e06c18ed56a51dde7313fcb18542fdebbd696eebcdc5e6fc13557c8b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193765268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e82f7b3dccef23f43f89d76c4f723c43003a4c512625960878bc3a689e53027a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Jul 2023 21:27:03 GMT
WORKDIR /opt/drupal
# Fri, 28 Jul 2023 21:27:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 28 Jul 2023 21:27:18 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:64a9f77ac108955f68d26395e125555523c2951acf929e76c24843607e2d75f5`  
		...
		Size: 698.2 KB (698241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee9eb2bdfb69d386397ef4e56f464ab6ff99d1aa985ebcc2e997b1fcaf293fb0`  
		Last Modified: Fri, 28 Jul 2023 21:50:42 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bad4e32ff479c3da13e1f1b0480d09d2f5fa5dcf075eacf7e793efed5ebdb99a`  
		Last Modified: Fri, 28 Jul 2023 21:50:53 GMT  
...
```console
$ docker pull drupal@sha256:d36ec7fbc271cb2273a9e63495eff3a449cdad51abcb4bad8e969ac8cf60d655
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.9 MB (198894275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f459f4797d6043a1db107bb0c98a972b4abb2d62eec24a026839d002647478d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 02:14:42 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Tue, 11 Jul 2023 02:14:43 GMT
ENV DRUPAL_VERSION=10.1.1
# Tue, 11 Jul 2023 02:14:43 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 02:15:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 02:15:16 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0709c645fec3adb2107ff3bfe225a499c03073599f18a15a09281166a5101d80`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d7694021eb76cd37469899b6304b180c98be9a84634aa4f2215689f9f9ad445`  
		Last Modified: Tue, 11 Jul 2023 03:04:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6c2a96856c3d0bf9ed70f41fb297e17550bc3288d8d55e68a2406e335d90ea0`  
		Last Modified: Tue, 11 Jul 2023 03:04:36 GMT  
		Size: 18.5 MB (18504329 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:20f1b9cf9ce843eab1bfe7b7d49916c4a6489d7997f000a4be332b7f89461c2d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168324056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:469c73a8a63bf5fc2d4d0ef2e43b94592517aa9453816ef687a8b821eba49ff4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 11 Jul 2023 06:27:30 GMT
WORKDIR /opt/drupal
# Tue, 11 Jul 2023 06:27:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 11 Jul 2023 06:27:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cad0288461a8be8835537960aa02388788c02cb67becb469609b95fa5862ef76`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46a2133ef913b707d1df5b5eefe14e1e28f850840b80813ad9da06b5e1998035`  
		Last Modified: Tue, 11 Jul 2023 06:49:44 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3eedd15e652266f86be02b905883482f3266476f632502854b90ab74dc8d3ec`  
		Last Modified: Tue, 11 Jul 2023 06:49:48 GMT  
		Size: 18.5 MB (18504290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
