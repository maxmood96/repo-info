...
```console
$ docker pull drupal@sha256:9878a2f6c3cc467e12aa1f2a7e86e0de18fcddeef669d3701fa5c7fa580d1a9f
```
...
```console
$ docker pull drupal@sha256:feec24e09892605bc4ba6e571913cd82eb9b83a410d572f23230688a1a01355f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.9 MB (198901662 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e14445971614721ab74b89fdcab62d21ac8b67ed2e2159fb3362c128a52e5e0f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 02 Sep 2023 10:50:51 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 10:50:52 GMT
ENV DRUPAL_VERSION=10.1.2
# Sat, 02 Sep 2023 10:50:52 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 10:51:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 10:51:21 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7dbc9245219cb36f57eb14956774c56e6236edc129ba69738037df7b109976da`  
		...
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af2643f5b23010b03e3a2c36f3fef2f6b103295e990776eac3dff9fc10b63942`  
		Last Modified: Sat, 02 Sep 2023 11:32:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74bb943f1d098f4b2d1f50aa5e0ed4d56f2335f18ce353abab3891a5d0647508`  
		Last Modified: Sat, 02 Sep 2023 11:33:26 GMT  
		Size: 18.5 MB (18512319 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
