...
```console
$ docker pull drupal@sha256:4041462758a9759aff7adadef5e2bad330c786c33493ce288c14b4fa42822019
```
...
```console
$ docker pull drupal@sha256:afeb59e526ebc8438fecf58bac1593b86179f36226fca2e7134b0778b5134929
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.0 MB (195006679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f82b0c7769acbebfffaeb6667f81d06a5788418b156c4926671a0e345976c254`
...
# Fri, 18 Aug 2023 01:29:29 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:29:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:29:40 GMT
...
-	Layers:
	...
	-	`sha256:eedceda1880b91ecceb07c8e14e1053a1db5670314d4481c6a830a244b58b1ca`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f50ae3aa489df16859834e350154ec664c49545bf33373191dd9464e87a51223`  
		Last Modified: Fri, 18 Aug 2023 01:42:46 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d03d8bd2a0712fd8e29e15f4f419e41bf7be1fc6252f452737fb31063010cfc`  
		Last Modified: Fri, 18 Aug 2023 01:42:51 GMT  
		Size: 18.5 MB (18511881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:945de84ddfbfe317db71c1e0d081ebb56b825dd9d2d3c0c09a33c452a2460e60
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.5 MB (159527002 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b25c5df706c84fd4babf43f9ec419a5d819579976a7250a3158d0ebf23391954`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 01:13:07 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:13:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:13:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d496b39e8f03775c30f43dadfb44c700dbf3d52db8210841e2707255537467f8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17f4c6dcbda28d63b148825a9440f58ea2a192d07eca915b03185ed6fc9d8e48`  
		Last Modified: Fri, 18 Aug 2023 01:25:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd57893111eb82e77348db9213b68c8adad99a4690a1105e3be08e2c3dde5813`  
		Last Modified: Fri, 18 Aug 2023 01:25:14 GMT  
		Size: 18.5 MB (18511826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:2bf9752bee772f30e9d2721523c418323953125a76e5656dd7eb11192c126720
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189032656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41b6b9a3883cde2636cdb66f285f213ebf6e4ed7030791cc405818334210acd0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 00:40:37 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:40:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:40:47 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fcd791411a70b280ec10c171e54a85a9aed28f8480135c858a112da1f79e98ec`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1950ea1ac8e4ef809c70921a3aec58a18ee8e7a5a477ec268d5e74c142a0b6a0`  
		Last Modified: Fri, 18 Aug 2023 00:54:16 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184ae77ecd19e90452297cd8fadaf6e258225fb23a19fc8fd940f48354215418`  
		Last Modified: Fri, 18 Aug 2023 00:54:20 GMT  
		Size: 18.5 MB (18511525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:6c311158a67312eb760929074df7925de9ec37fb9134fcb690c780ff26c1f689
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **193.8 MB (193770919 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6ad1060de281838d746aa45427360d04105c8701ce1336da84b0bd9536a5c16`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 00:50:46 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:50:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:51:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:22aabd97af3c66ae23b41dbe244faad589a619c61bd9da55bf0f0a2b8f8ae5f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d09420ba791ff1567725090eeb117e1f4b418761b68f530f53cde48e7f243a89`  
		Last Modified: Fri, 18 Aug 2023 01:05:48 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98695391689402fa5ff292c48ca8c5d5c369bd4bc6ec1384ee16e8c26c15d472`  
		Last Modified: Fri, 18 Aug 2023 01:05:55 GMT  
		Size: 18.5 MB (18511662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:6f7dc9b605be12e8cba994d71571aec9b0460d9522c268631b2b8ae0cfb607f7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.9 MB (198895039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c050570816d5e76d22873e9b6236c807391984ad8b008a555fb5ee3b351ac05e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 01:39:18 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:39:40 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:39:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:11ba99072ba3d4154b47efe827c2ad105e825f283615f1c2e2c74cca64116100`  
		...
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96bdc5bf9a299e078c01dafc05aa4453a56e9581031eecb82f8b465f10ff08b5`  
		Last Modified: Fri, 18 Aug 2023 02:00:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69c659ab68842e9fdfce7d7b9ba9b1b5e0aa13ca777833e6355f20576c73be7c`  
		Last Modified: Fri, 18 Aug 2023 02:01:16 GMT  
		Size: 18.5 MB (18511817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:6f42c9a721b1de706022482eb3978a65bbcc3640a85eec34e84056d400cb29c4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168330848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3a218087b543ec2fee9296310f62324d12f8ad192195f23107b04d7211f3bd6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Aug 2023 00:46:11 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:46:22 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:46:28 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:0146b05f95bbeca1b825ae7e25d113b98777b992ffb4dc102e3422df756779e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e075ff03f1ffb26de29680890589973d023b62bd0144acce84c199bcbdec11`  
		Last Modified: Fri, 18 Aug 2023 01:01:57 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c33ef7535a7b66d73ea2dbaac20c1cd003750ffefde230792ab9041a7550462`  
		Last Modified: Fri, 18 Aug 2023 01:02:00 GMT  
		Size: 18.5 MB (18511845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
