...
```console
$ docker pull drupal@sha256:db5564c061c962d8457e09a3181f4aa400e35eeb5d2ad546a64d0d988b61eac8
```
...
```console
$ docker pull drupal@sha256:f1f57e6d148fa670c5304913583aab3ceca54bea630ddd2e549db7cb898c7501
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189032610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a070fbe3d4828ac54f69b8ca4e5df1806d5b38256787e045c98e7fd63bb9f025`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Aug 2023 01:35:34 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 01:35:42 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 01:35:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:21e94bd710030fc2d79cf0b4858659e772b7b7f5d6020411e5eb5285f37dfc40`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31ba4b42a1d6d789e6b8002f3348f6f27817360a8b5c3f20090d5a9d2ada417c`  
		Last Modified: Thu, 03 Aug 2023 01:42:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fed63d20c7fd547be2a2d8b3708082d470b0e9a7655b282158569b379cfb3448`  
		Last Modified: Thu, 03 Aug 2023 01:42:34 GMT  
		Size: 18.5 MB (18510006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:15c31d08ce5ce8a282bd1dc4027b5030e06ae1b012de94e1721a3cd93b16661c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168334545 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f21d804c4790a26752fb5ec1c48ae46158a06ba64723899e13c53b7f770c45fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 06:59:29 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Thu, 03 Aug 2023 09:04:55 GMT
ENV DRUPAL_VERSION=10.1.2
# Thu, 03 Aug 2023 09:04:55 GMT
WORKDIR /opt/drupal
# Thu, 03 Aug 2023 09:05:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 03 Aug 2023 09:05:14 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:50db9fb565b1f13e9ee2023b59e47100ebca8b94270ed2b45b9ca0979f52e30d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd75856422ef27bf5cdae1804015f7a39b6116bb51c0a348aa778ee924828e52`  
		Last Modified: Thu, 03 Aug 2023 09:18:53 GMT  
		Size: 144.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4899f0bd86ddf2873745c2046b7948f66952e8f9323d4c62a5af68180cc50c7`  
		Last Modified: Thu, 03 Aug 2023 09:18:57 GMT  
		Size: 18.5 MB (18510977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
