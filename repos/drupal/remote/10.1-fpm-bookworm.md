...
```console
$ docker pull drupal@sha256:392e586fa440c81330b28d015d653143ac2ec405dd2dce548af78e0d3c326fe6
```
...
```console
$ docker pull drupal@sha256:7070aa4abe838d42d448e26959938c514f5953ec6dc4ccb0ec186892a67b668f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.0 MB (189044040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f1a48afa50f295f31f968920e6f4d7bfbdc6d7a1c2a55a5885b88c4df7354cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 22:50:56 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 22:51:05 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 22:51:06 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8bff73ea32251dd63e1abc274e0931a0ecaeef910f024d286c530b137a568d24`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c763782d2567f93bcaeb9a72bbc9b844a780fd2624309081ffc4b27c87645501`  
		Last Modified: Tue, 05 Sep 2023 23:03:55 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7cbef08ae76378f158de6222f6d803f86d206063a27c508d4eedaa607551ba3`  
		Last Modified: Tue, 05 Sep 2023 23:04:08 GMT  
		Size: 18.5 MB (18512170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:eee5accea49a705d29e6055ab8926dc1e85665cf2cef8e6d02d3c5621cc71b05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.9 MB (198906348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:34dffed2a1ef5a1ebed0a68f518377409673ccec527385d9844ecbdc626edba4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 23:23:13 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:23:14 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:23:39 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:23:43 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c605553684d588ff61cd0d0706c198e5a597eb86926995bac2a1156d99af5452`  
		...
		Size: 703.4 KB (703372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e90c9c6b70b9fc2317078559f7890d8637c3e30c7a0fb1db1aa7c7ef32ed40ca`  
		Last Modified: Tue, 05 Sep 2023 23:48:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74f9270b90863ce5b9eae9650ba42645d00fb0c39f8208f693599dff2db70b06`  
		Last Modified: Tue, 05 Sep 2023 23:48:53 GMT  
		Size: 18.5 MB (18511871 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:10.1-fpm-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:e2b94fcc6b06a1e505c5158d0f112bb15e63ca1775acd6993378e401ff8ceb3b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.3 MB (168341976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f24be44ea5c1298f578f452a26c27f5e185a96bfb400bd6b4cf4e7d09a1ca010`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 05 Sep 2023 23:21:44 GMT
ENV DRUPAL_VERSION=10.1.2
# Tue, 05 Sep 2023 23:21:45 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:22:00 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:22:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:16724098c1e8eb4a802ea702e6d3e1df05a8eb6d0a6f7eed544c5a4ad8889825`  
		...
		Size: 703.4 KB (703371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed81c1276d8581ca386faa9726f8c13be29d8f4c527c43e77096dbd4bd32ae99`  
		Last Modified: Tue, 05 Sep 2023 23:46:51 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7594215a0d1085552c85e7902268ee78fc032f35601e9c2ef09614243f5b1b8a`  
		Last Modified: Tue, 05 Sep 2023 23:46:55 GMT  
		Size: 18.5 MB (18512277 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
