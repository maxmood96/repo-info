...
```console
$ docker pull drupal@sha256:55b539dd28d6fdf5deb5c3ba4729a7ca4e813d60ff422d5e38eacce4e25e68a5
```
...
```console
$ docker pull drupal@sha256:866d69d4aaeb57eb15c5e6d249cfa7060f923fdcdf3b9094f9c262595daf0b22
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155279302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89c1c9080fe192b2c00219fd4e2d6c1907ed6699ad10c0a5c329047dca75ad03`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 14:39:59 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 14:40:00 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 14:40:32 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 14:40:34 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:25ef26a96ed0ad0de5c0480179779b548d2f8dadc884fb50830e0dfda7b5d350`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65a36044096a30ca40b022d67788f784fa9e80714c9481e2b60ace522e168bbd`  
		Last Modified: Wed, 13 Jul 2022 15:40:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ff2231052cf0972f0d90b7a95d0106997eae140dc1314dc7325cdd5f85a9560`  
		Last Modified: Wed, 13 Jul 2022 15:40:50 GMT  
		Size: 21.2 MB (21216566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:3c777ccfb9fd6222bf1f07cb1e11bd533dddae403864fc8e64d8af2c7de00f87
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.1 MB (185062735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48481c269f12b4761fad9c30ddd415021d2158a04ea51c4ef8fba7063ca4583b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Wed, 13 Jul 2022 08:52:59 GMT
ENV DRUPAL_VERSION=9.3.18
# Wed, 13 Jul 2022 08:53:03 GMT
WORKDIR /opt/drupal
# Wed, 13 Jul 2022 08:53:33 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 13 Jul 2022 08:53:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ace8992da618b21711e18dd96a06ab32460b9ea063b9edc113cc29efcc261d57`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cdb843c9edd8dfebf543dbefc72d39990f02aed10fa2f2ed65503216f129f92`  
		Last Modified: Wed, 13 Jul 2022 10:09:28 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1822b8328071b48bd88892bd84b65af770ccda42a60755a671af38e245def2c8`  
		Last Modified: Wed, 13 Jul 2022 10:11:06 GMT  
		Size: 21.2 MB (21216800 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
