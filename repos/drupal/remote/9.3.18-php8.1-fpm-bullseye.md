...
```console
$ docker pull drupal@sha256:f5689640d115bf6b3d8c77257c79a816232b4758b94c3893882e8ac4f0436358
```
...
```console
$ docker pull drupal@sha256:723071f268de9670597dafe600aa4c2d63eed89294f725f039c58cd8dca7383f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180929863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5a879fe32ba509e0729448ffc5474ecfb2d5c9b8307d04330ccc39c1de656f9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 00:56:09 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 00:56:10 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 00:56:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 00:56:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b242b01d8a052b64fc544a3438e05b836df4f20f23fe5c91431ddac57cf3523f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:489651cf9ad13000d44b82dd9a444c5742e86ef6978e75efec35dfcb7703fa20`  
		Last Modified: Tue, 12 Jul 2022 01:17:29 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41c943d4329089b40748793f08bdd39a3e3334233e5794dbeb6fb20acaa4b283`  
		Last Modified: Tue, 12 Jul 2022 01:17:34 GMT  
...
```console
$ docker pull drupal@sha256:0353211b643671ac8f5c8fdc5110168657cab0ae7c63b7da42038573d4be5e7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.4 MB (189445507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:538804e67d17a96ca96e804f3985da80c9d40f3a962597c886532bb7fb1f0620`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 00:55:16 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 00:55:17 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 00:55:28 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 00:55:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:77be8bb102249d2b08eb7a092bcc959718500083f3971bdce4345556633de6d2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:146cb1076a3e5886971342afcaa06e9fc1d7a1c24e94803fd97d3311c63d9f2d`  
		Last Modified: Tue, 12 Jul 2022 01:16:16 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595e70b346a9407158c56e111bbe38281427dd3a4015b16b1b49e07ecd9cf004`  
		Last Modified: Tue, 12 Jul 2022 01:16:22 GMT  
		Size: 21.2 MB (21216696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:2e1554442110ea550b36cdd1d5ea808cd0c784ea2b04240c828317ba03c380bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164019940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e6f857174491a458541142864169943c3131cd872f8c13f7a4f71ba4d306ea6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jul 2022 23:45:32 GMT
COPY file:d35bffea39a2e9c371ea6328f9c3c520719bcde93929154f95119dc2475a94a5 in /usr/local/bin/ 
# Tue, 12 Jul 2022 01:04:52 GMT
ENV DRUPAL_VERSION=9.3.18
# Tue, 12 Jul 2022 01:04:52 GMT
WORKDIR /opt/drupal
# Tue, 12 Jul 2022 01:05:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 12 Jul 2022 01:05:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:3829edee550d54e1d5fdae101fd146d06901be0cec5c53744d19f3c18b6d86a0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3333edb1293804ca1b7c74369df6ce591299be377d1490b058fa81bd2a1fe9e`  
		Last Modified: Tue, 12 Jul 2022 01:30:56 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c7a36fd4a50f9cfecdd5b465867ac759f642d8948a97c600da14b0e3bf9cfc4`  
		Last Modified: Tue, 12 Jul 2022 01:30:59 GMT  
