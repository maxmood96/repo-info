...
```console
$ docker pull drupal@sha256:8b0ca4e715f96c8eeb7a10e37725d1c64a2b04ce79019012804cf9060546c8d2
```
...
### `drupal:10.0.0-beta1-fpm` - linux; amd64
...
### `drupal:10.0.0-beta1-fpm` - linux; arm64 variant v8
...
### `drupal:10.0.0-beta1-fpm` - linux; 386
...
### `drupal:10.0.0-beta1-fpm` - linux; s390x
