...
```console
$ docker pull drupal@sha256:c67c1034b50728adf64f849acdeb56275bf00b3ee8348cff21cd8cc8d5823b95
```
...
### `drupal:9.3.20-php8.1-fpm-alpine3.15` - linux; arm variant v7

```console
$ docker pull drupal@sha256:abceafa4555d0a3dba102f7f19cd92bf7ac009c8e08596cd798dba02dff0d686
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.9 MB (49921061 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:574a0d019aab2dad01fc04094cc538779694f256f16a87f90dc360d5d6b03fee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Aug 2022 09:06:10 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Thu, 04 Aug 2022 09:25:55 GMT
ENV DRUPAL_VERSION=9.3.20
# Thu, 04 Aug 2022 09:25:55 GMT
WORKDIR /opt/drupal
# Thu, 04 Aug 2022 09:26:08 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 04 Aug 2022 09:26:09 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:66afdf51161f576648797d8142bcd68fcc2e2a241732e5c93d3c3ef321e60f9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:111938a54d23dee0ac3122ce1eccf7c5d23117bbf6bbe07bc2772f7104776cd9`  
		Last Modified: Thu, 04 Aug 2022 10:13:38 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4147f49879c90eef331eb70a37d7f7d9ba0c5747d3c0042972cbb1ef41e28337`  
		Last Modified: Thu, 04 Aug 2022 10:13:52 GMT  
		Size: 21.2 MB (21214860 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php8.1-fpm-alpine3.15` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:7bfd2c1ea882c3a00aafb010baf3bca7c45c4a286ea010797075071f70c6b519
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53160989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0a925488fb6306411fc472655348e6635c8accd2a6b664629859dc28bbb2460`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d5e4d9e718c547a5badb49a469633a88c9a858d0b88bf6e64c24529ff00b418d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14e301d5a63fd8968e6d2958a12add90965a3b25f38e54bf6f56cd164d20dc90`  
		Last Modified: Fri, 29 Jul 2022 02:23:39 GMT  
		Size: 115.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7494718953f103ec829c130affbaf6e5c0e0d1917d2dfbe6d63a896b7dd021e5`  
		Last Modified: Fri, 29 Jul 2022 02:23:43 GMT  
		Size: 21.2 MB (21218197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php8.1-fpm-alpine3.15` - linux; 386

```console
$ docker pull drupal@sha256:a5733a3d9a8b2c786f7c3046f9d11306c9e193f6991f37401b358cb5bff28032
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.4 MB (53398209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75d812b9101c7ded8020f519afbc22fad0143eaa95d8c662ef8f93f1176e251c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:49:13 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:49:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:49:26 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4836f1782d20f7977c6dcc2fb4ab2abce109a2042edc6f65d7793d5cb8fc429e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b092e5725e4a5edfc0bfec8b7be081a1ce16c2cd338529c1396adca45b02b0c5`  
		Last Modified: Fri, 29 Jul 2022 02:21:27 GMT  
		Size: 114.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8255271f1001e18dbbc0139757a29418fa285ccb336cc33b9a1aa0579496623`  
		Last Modified: Fri, 29 Jul 2022 02:21:32 GMT  
		Size: 21.2 MB (21217855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php8.1-fpm-alpine3.15` - linux; ppc64le

```console
$ docker pull drupal@sha256:e7d6db3ba1c46cb9e26aca854e6d36869a0476f93b9250e5caa4df90b0dd99bb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53245585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8496250fee49bf1d9b7d78789816b714007d355e16210623e788653fe6caae11`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 03 Aug 2022 12:06:32 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Wed, 03 Aug 2022 12:34:56 GMT
ENV DRUPAL_VERSION=9.3.20
# Wed, 03 Aug 2022 12:34:57 GMT
WORKDIR /opt/drupal
# Wed, 03 Aug 2022 12:35:19 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:38ce0bf9118617b16320a8495762ab57116f110c8c4cf0effbbd7d0e1cc2f6e4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43b68a12cc416d667677e93906cebb342c98fc7a440562beac7eaf317b09a52c`  
		Last Modified: Wed, 03 Aug 2022 13:27:08 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd73521963a702cb714f6f96a7a49e4cfc54d4261e50abbb29b3154b3aa62895`  
		Last Modified: Wed, 03 Aug 2022 13:27:29 GMT  
		Size: 21.2 MB (21214777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9.3.20-php8.1-fpm-alpine3.15` - linux; s390x

```console
$ docker pull drupal@sha256:c72f0d1581bd44741c7054d5a7b75274ef6059ed3d458934df22ca3a5521249a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.6 MB (51645263 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab4a1a9669a0a496a7e69f5944c0973a496580f0c21ac729c4b38ea8ad6e90a9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:55:23 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:55:23 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:55:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:55:38 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:20b59024c19f2050cc6a4b9769a02ff10c06ec4ee72563a8332448eed0ffbc0e`  
		...
		Size: 670.4 KB (670419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3550cbc7569a811339e3d204cd91142018d407c7104fc8d17d2ed24613385b17`  
		Last Modified: Fri, 29 Jul 2022 02:22:35 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff8fcd273529f773daae695ceaa18d9792d93b767e7c3b5f2edaa13055c92e6a`  
		Last Modified: Fri, 29 Jul 2022 02:22:39 GMT  
		Size: 21.2 MB (21214845 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
