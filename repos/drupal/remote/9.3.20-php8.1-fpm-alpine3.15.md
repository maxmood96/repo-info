...
```console
$ docker pull drupal@sha256:06d99f7375264690eb07e5ead369f74b23f3800675387217965fc2ba42b249cc
```
...
```console
$ docker pull drupal@sha256:778aeab77936e1ddcaab3e49bae8cf55e44fe377257b10d8620827c1060d4789
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.2 MB (53228036 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26a20300c1276dc0f9e8eb5b8b99bdd936b833a2812390e7fb14c9d4971bd236`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jul 2022 01:28:33 GMT
COPY file:ebe397bd23f15e762d9b58235d8b4962a65d12542d3be8adc4e774426b23f91d in /usr/local/bin/ 
# Fri, 29 Jul 2022 01:55:53 GMT
ENV DRUPAL_VERSION=9.3.20
# Fri, 29 Jul 2022 01:55:53 GMT
WORKDIR /opt/drupal
# Fri, 29 Jul 2022 01:56:16 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 29 Jul 2022 01:56:20 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f52ed2df5dc186447a4d6e815a9bd4ee62cfaa7d28c4a9ff99aac913af4ebd2c`  
		...
		Size: 670.4 KB (670418 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:892bc39c909ae329c1eee5dac339cedd2640de11448dbf54a483068041ca2295`  
		Last Modified: Fri, 29 Jul 2022 02:45:38 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7066433fd743657bdf4a25302d187d308be7a918f32c96ec8c6a6181f575ac76`  
		Last Modified: Fri, 29 Jul 2022 02:45:58 GMT  
		Size: 21.2 MB (21214732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
