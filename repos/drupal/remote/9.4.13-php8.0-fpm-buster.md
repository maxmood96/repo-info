...
```console
$ docker pull drupal@sha256:cdbd8433027b0ebd3ba0205e0458163250a374cf9fb5c56fb3262d628d8eaf0a
```
...
```console
$ docker pull drupal@sha256:4b5ba4e7c4b8b913777bb5970473ea3c9f01ab66d2e3d1fb780e1eb6c68fce68
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140872984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8d8bf05b29b891c97452845b14a8edbeba63bce18d3539c980cb83862fa79ea`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 07:42:44 GMT
COPY file:3cfddcfffbb1a2b0544304897907e3a08247bd92e3e7f53da87a4646baf89113 in /usr/local/bin/ 
# Tue, 28 Mar 2023 07:47:35 GMT
ENV DRUPAL_VERSION=9.4.13
# Tue, 28 Mar 2023 07:47:35 GMT
WORKDIR /opt/drupal
# Tue, 28 Mar 2023 07:48:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 28 Mar 2023 07:48:07 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:1e41add9dbfaba5f74ec269ada88a25699b7e3b0856ac70e3923251af0b19647`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aafa82bb6977fc464de77ecf517db92ae139cd2346a968f896538af229fa2293`  
		Last Modified: Tue, 28 Mar 2023 08:05:49 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6bfb233cf281ac00b3223d190b087ce5bd2c39a38805dfbf3338c9ed24a58b8`  
		Last Modified: Tue, 28 Mar 2023 08:05:55 GMT  
		Size: 21.9 MB (21916964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
