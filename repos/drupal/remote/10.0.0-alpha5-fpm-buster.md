## `drupal:10.0.0-alpha5-fpm-buster`
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; amd64
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; arm variant v7
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; arm64 variant v8
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; 386
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; ppc64le
...
### `drupal:10.0.0-alpha5-fpm-buster` - linux; s390x
