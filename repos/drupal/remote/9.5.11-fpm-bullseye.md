...
```console
$ docker pull drupal@sha256:4e50b614168f0d533a0bfe86dea872b4a35931b63cd8959ba507c81c198e6273
```
...
```console
$ docker pull drupal@sha256:44c698a210c1eca6968b5be7d7696a57f3ae806cee548bcbf06fd8e4c23436ec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.1 MB (157104325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0371380be780efc80549b5c5c03ba4685506b310c23b0403640c5d061a031f77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 05:02:11 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 05:02:11 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 05:02:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 05:02:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:ba4e3ebf87c1fc028997314c3aaf53a52e34ffb18743846d9da345814888721c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1abef1414bbad490c0931c8da077b80e4780ee4a1938651cab8cfb4f61cf847a`  
		Last Modified: Thu, 12 Oct 2023 05:29:56 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed510cd9d42364162316c5d0c252cd3d01b6fb220b977ecdc1a6f8de65ee6750`  
		Last Modified: Thu, 12 Oct 2023 05:30:16 GMT  
		Size: 22.9 MB (22879017 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull drupal@sha256:5fbeec1fcfd6e17dddaa45c35fdd0e14a094f23c6a0804e66d5712e3a33bb7a3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **164.0 MB (164015072 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c0dd3c92ce4ab28b32d04683f0e0af0739df07fc9c8da3d25f04575692edd28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Tue, 10 Oct 2023 04:23:34 GMT
ENV DRUPAL_VERSION=9.5.11
# Tue, 10 Oct 2023 04:23:35 GMT
WORKDIR /opt/drupal
# Tue, 10 Oct 2023 04:23:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 10 Oct 2023 04:24:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:909ea37fcda545d14096fc18a63d845a587e64b8d56fed815ca8f79a1951c102`  
		...
		Size: 705.0 KB (705005 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:940053ba7df02cac5c859a3128f3ad7ba35bb8a678fd1390cbe40addce116650`  
		Last Modified: Tue, 10 Oct 2023 05:36:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1886cd7d0c9b2e9f8eb145235b318875ed3459ed168819c7547c9eeef6c71b0d`  
		Last Modified: Tue, 10 Oct 2023 05:36:51 GMT  
