...
```console
$ docker pull drupal@sha256:2b4632bab614c7f28d6c3e5a94c138de3a771579eaf81471e7504edbbd873835
```
...
### `drupal:9.5.7-php8.0-fpm-buster` - linux; amd64
...
### `drupal:9.5.7-php8.0-fpm-buster` - linux; arm64 variant v8
...
### `drupal:9.5.7-php8.0-fpm-buster` - linux; 386
