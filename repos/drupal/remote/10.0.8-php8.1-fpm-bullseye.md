...
```console
$ docker pull drupal@sha256:87211be28cb6c5d76a7fdf5f2f25be2de3ae23cd2941524ea925bb2b085c3d43
```
...
### `drupal:10.0.8-php8.1-fpm-bullseye` - linux; amd64
...
### `drupal:10.0.8-php8.1-fpm-bullseye` - linux; arm64 variant v8
...
### `drupal:10.0.8-php8.1-fpm-bullseye` - linux; 386
...
### `drupal:10.0.8-php8.1-fpm-bullseye` - linux; ppc64le
...
### `drupal:10.0.8-php8.1-fpm-bullseye` - linux; s390x
