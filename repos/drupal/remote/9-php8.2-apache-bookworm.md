...
```console
$ docker pull drupal@sha256:4924a637dbf55cc511d938286ef9296449dd3828e5762c711166afbab4b1a5c8
```
...
```console
$ docker pull drupal@sha256:8f317036f29b8e1b33b74668c5bec7e527d9e794fea4c117f56ae987a1144f26
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.3 MB (203343619 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84d00524978c8419d89956006b726c13a2fe9db245336a7abe3fe57c9b7a0432`
...
# Fri, 18 Aug 2023 01:36:26 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 18 Aug 2023 01:36:26 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:36:37 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:36:39 GMT
...
-	Layers:
	...
	-	`sha256:1b10cd1b2b9bf6d0697aa0cc45fbbb99d5b46bd4c74bf1c6b80f1e3744091d8b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b98c4147cf15c7df0861656076b6949f5e892300329968a0f26a58ac6b22a140`  
		Last Modified: Fri, 18 Aug 2023 01:48:27 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec7a436b0fe9f6c7faa9e250c6ea6a00038d5ae5496bef55cc5d7a8ec950a464`  
		Last Modified: Fri, 18 Aug 2023 01:48:32 GMT  
		Size: 22.9 MB (22879978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:5c345e10807bdad1f102eeabcddad06c6a5cf3b2a88f5fccd5fecdd0d2b7a34f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167415537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3414f8ebf60c6dca1db43f71467c7fda9c5fc2c758fac142c2f579d760a3afe7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 18 Aug 2023 01:12:19 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Aug 2023 01:12:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 01:12:19 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 01:18:43 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 18 Aug 2023 01:18:43 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:18:59 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:19:00 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:fe8c5a7dd7e7b2e9131b52b3750d535d9a36433a305f52d6897ccbb1db5124f9`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df7ee06dafdd8eb79d6d3403be7f7849d365e80f2fa384900b34ec82a7c3afbd`  
		Last Modified: Fri, 18 Aug 2023 01:23:47 GMT  
		Size: 1.6 MB (1556778 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01311a74363773d5c79b9613c75994ae6d42b3aa8fcfba104561a4210cfefdc`  
		Last Modified: Fri, 18 Aug 2023 01:23:46 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75f118f071c5cd8476495937490a3316b386e55678eadd88f6d379e5ae71d9b0`  
		Last Modified: Fri, 18 Aug 2023 01:23:47 GMT  
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79ab2a46f46eb1734ab35a293dc5c7006bbb1bef364852285b98049c14c700d2`  
		Last Modified: Fri, 18 Aug 2023 01:31:33 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc9b694645ae1036b20dc205541947d3018d8255df3b9b6de20744b094213fc0`  
		Last Modified: Fri, 18 Aug 2023 01:31:39 GMT  
		Size: 22.9 MB (22880107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:e93288aad9dfe15ad09b27bc92730e3b5a8fd1e873ae6efbac977df71bad5027
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.4 MB (197416147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a41c6989015019d32c38354badd3e2fd5c8449a454369201919c5bc61ac383b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:60303795faeaf22f200a4b5a36e689b17bb3051f14e670a0b337f0e54f2fccc8`  
		...
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79538f7a91dc8ddb04727a1e1e8291bee843476ab6525596fb1f90a00052e206`  
		Last Modified: Fri, 18 Aug 2023 01:00:09 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e93c29289433b16b87600e553b20a5f77554e61e6d33ff318a936b7c2658bf57`  
		Last Modified: Fri, 18 Aug 2023 01:00:13 GMT  
		Size: 22.9 MB (22880374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:6a6e7d5f6e103cf3d8f89e7f18f2cb7d4788b76c783531566f0ef9e0b36c89a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202333763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:de9468f8ac8ff91830b90b89ced1e77c975a37e47fe15ca3cc49162f706eb2b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 00:49:23 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 00:58:53 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 18 Aug 2023 00:58:53 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:59:07 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 00:59:08 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:f225efdcddf17f06655ead87f37b75c348e7b0d74b5e3b56629a04fd38197c99`  
		...
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e7285fbf1aa5ebcbf804bd85750ab2b5b1f1ac0facdff394728239ed5f5cafb`  
		Last Modified: Fri, 18 Aug 2023 01:12:21 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ab50a9dd02aaf6cbf9949f8209c90e7bde65f032061be660ed344a1ad1992b5`  
		Last Modified: Fri, 18 Aug 2023 01:12:29 GMT  
...
```console
$ docker pull drupal@sha256:ad2e39f6e0c5b718240d9ce9716b432d0da71ab3b406c965ae1bba74c307d372
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207762094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4022930b8f991e401fbde77ea67b97dc9010c3b7060ac18fc7aa1bf213e232e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 18 Aug 2023 01:37:41 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 01:50:13 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 18 Aug 2023 01:50:13 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 01:50:38 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 18 Aug 2023 01:50:42 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:983885957136375b03fe25d5b91266d3581f27e09075843a94bdd474e075acea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b50d3b314fe44f7cff3515570556c1bb4bd2941fb0695c0c75a6105c1830deb4`  
		Last Modified: Fri, 18 Aug 2023 02:11:50 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82d118ff60e1d083899dca27da1bd503f8a2fab309cb8e8a3417c860289017f8`  
		Last Modified: Fri, 18 Aug 2023 02:11:59 GMT  
		Size: 22.9 MB (22880115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:2e9e78ef8666d686e9f11aee64199d81d944e7b38ad9a5423b0d934a2a5af9b0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176559026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bb30afed7e72996ff9d755783d6786c07f806999c260b53c0ff2dab973d1429`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Aug 2023 22:51:33 GMT
CMD ["apache2-foreground"]
# Fri, 18 Aug 2023 00:45:12 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Aug 2023 00:45:13 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 18 Aug 2023 00:45:13 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Fri, 18 Aug 2023 00:53:22 GMT
ENV DRUPAL_VERSION=9.5.10
# Fri, 18 Aug 2023 00:53:22 GMT
WORKDIR /opt/drupal
# Fri, 18 Aug 2023 00:53:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:c7b53e5814c2af20eda1ca53a7e4f317f30f2b1450aaa429bbe877116cae7e6e`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:975a410cfcdf7692eadb2b9efbcbac93c48a2b4be5d1c2b7160781f8723b12d9`  
		Last Modified: Fri, 18 Aug 2023 01:01:13 GMT  
		Size: 1.8 MB (1758269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba250f1ad89cb4a3aefdef74a969efa23bbf0aa80a0027fe52b2761433494dc5`  
		Last Modified: Fri, 18 Aug 2023 01:01:13 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2fcef9bf15a6e53da127a82f37c5f024ebb45ae6167ff2c818fedffad84c06d`  
		Last Modified: Fri, 18 Aug 2023 01:01:13 GMT  
		Size: 698.2 KB (698240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c7dc559f7665e82b3fe75ae95ab5f2233fbe2d20560bab39caf5ed7e3ed5a08`  
		Last Modified: Fri, 18 Aug 2023 01:05:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85bf35127fd81fdeb7c873f987880b29738ef57bb7f636d980c3f8c340ae7bc3`  
		Last Modified: Fri, 18 Aug 2023 01:05:58 GMT  
