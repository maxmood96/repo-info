...
```console
$ docker pull drupal@sha256:bd6ef35981c05c5415b93388b0dbc279a371811064ba0763cd5d986cd1782f14
```
...
```console
$ docker pull drupal@sha256:583fce2ec57a7539ef2401ebadb0ac8bbbbbd1ae95ffdbd9f03f1f7a9aa86373
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203409402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:66fdbef7f322654d4e10ac0da478815136e63ffa126b7c5cdc60d7eddc6a0945`
...
# Thu, 12 Oct 2023 19:48:35 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 19:48:36 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 19:48:46 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 19:48:48 GMT
...
-	Layers:
	...
	-	`sha256:2e2a6caeccf3f0d1a889b994589efa2a4c851fa315695abcb5efd8c45379fa3a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fd1737aeb313245b3a032f003eae042445470103784d5bd8ea564fd72b3d6cc`  
		Last Modified: Thu, 12 Oct 2023 20:09:14 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c33f9e1de31cd247dcc643b5c5f8538383671d3af444303d1d714a70069c5db`  
		Last Modified: Thu, 12 Oct 2023 20:09:19 GMT  
		Size: 22.9 MB (22878958 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:d8e1caf9b6da28e2afea2f189d53e1f9fda52eb3e58c1c30226235ffc62334f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167395070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9774898eee0e094a60dda396ae3a8519d09cbb7da924cdc7231ea525b475a2e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 05:00:10 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 05:00:11 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 05:00:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
...
-	Layers:
	...
	-	`sha256:ec1c9ee38aa6ee678c1d50ae2ea6de3894806d7024c6dbca3fb1090e3d12074d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25c884a730638d3ef41c1b9dee837981907c6c1f9335f885a083dc4546288bb1`  
		Last Modified: Thu, 12 Oct 2023 05:24:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d71964c1bdb211ee5ea714b5ad2a2194f9515bca08833da98368da754c3b4037`  
		Last Modified: Thu, 12 Oct 2023 05:25:04 GMT  
...
```console
$ docker pull drupal@sha256:ee17e0430f35859d63b0f5794b824241289eecdfdbbeea9c72fcaae255ace566
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.5 MB (197494607 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6bca00a625c97a422edf53ad063af76d28ab71659ac17365bbc9eb16b5b63ecf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 17:23:59 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 17:23:59 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 17:24:10 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 17:24:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:24747bdabc6d0092c130b57a078fc7db706d55bc1edcef0112715840df5e3516`  
		...
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3cdd9a7b806caa6bbbb31c513c5b00c7ea74a0d2beb750a37819827bf99d8c3`  
		Last Modified: Thu, 12 Oct 2023 17:41:17 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ee7d3f09bb01d78f6d74ddf188b266e8962b27a9529ab4cd43add7b09291e31`  
		Last Modified: Thu, 12 Oct 2023 17:41:21 GMT  
		Size: 22.9 MB (22879972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:d51e3cf97f93a44f37a4524086b01b1de4684506a00a03fc9e13181026a096c0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.4 MB (202411308 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91ac276a2c6323d53d166c8815860f589e4f1a53119a54c746c8f3d453aed774`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 16:09:48 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 16:23:59 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 16:23:59 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 16:24:13 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 16:24:15 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:cb97e590713b8e243851528c27ba14a0f19ad2145f5cdf98cc5c75afe6fc5f91`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84836ac29ffe71d11a366d6268603cf900010eb4262b79c152f254c953d7c7a4`  
		Last Modified: Thu, 12 Oct 2023 16:45:54 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90f7a8cbba4c72f84cc9f28fd927061e43f0e9965e50ca56e27b591bed6c6009`  
		Last Modified: Thu, 12 Oct 2023 16:46:02 GMT  
...
```console
$ docker pull drupal@sha256:c4d5b36c4b97f4a3de870dd831214a3c23e2c816ed3ab09e85c9a4e3c9f23cbb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207829704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ba309016e9fd32246bebe9548aa167fd3a47a2a312c28b99dbd3c8b0da20a11`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 12 Oct 2023 21:07:29 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Thu, 12 Oct 2023 21:26:27 GMT
ENV DRUPAL_VERSION=9.5.11
# Thu, 12 Oct 2023 21:26:28 GMT
WORKDIR /opt/drupal
# Thu, 12 Oct 2023 21:26:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Thu, 12 Oct 2023 21:26:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:e08330f53975d10fb8985d1db071b645187267772b6535c0fa222c7446278c1e`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0d98fc76285cf9b7352f8b79bd6b4e02ef992ac96768b3062eb4f25ae23489f`  
		Last Modified: Thu, 12 Oct 2023 21:40:01 GMT  
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06df6e3b09a471ea7ce97f6e974589d971d9ad3c5a776fc888bd18a5b64604e3`  
		Last Modified: Thu, 12 Oct 2023 21:53:53 GMT  
		Size: 148.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b174df41d22897924d37dbfb5b1fbd69f41c454292cadc2092362779bb951cac`  
		Last Modified: Thu, 12 Oct 2023 21:54:23 GMT  
		Size: 22.9 MB (22879032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:eaea3a5f91d7b05e8e9e6ea149c9c4903af7727470c85e2b67067d327fc2d3b1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176625521 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7c5dbd7f103715f588e90b720f22cb7f63ebd847c90839b4ed9f267fc159b26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Oct 2023 10:18:43 GMT
CMD ["apache2-foreground"]
# Fri, 13 Oct 2023 03:05:13 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 13 Oct 2023 03:05:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 13 Oct 2023 03:05:14 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
...
-	Layers:
	...
	-	`sha256:5bb7497a319abf2584fc5cfe42987c9abf54d151db5979759024a3e6f5d2ce85`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93bcb555c49fab1801ac67c1829f0dc087537868e0fafa528d07d7382b0464e6`  
		Last Modified: Fri, 13 Oct 2023 03:33:35 GMT  
		Size: 1.8 MB (1761492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:900b2e0a0bf0a3c63f4b6a3fdd5813e06a4f90c583ff716726ce62636ddf6fd7`  
		Last Modified: Fri, 13 Oct 2023 03:33:35 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96e394acf5ca8147fa8e8e1ac8eb8739baca1313de768180a2da6a62a8122d33`  
		Last Modified: Fri, 13 Oct 2023 03:33:35 GMT  
		Size: 705.0 KB (705010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb840e70f0413e2a5e577abe1973ecbd3e4b8313f07e0aecb6bfc4e62d843a2d`  
		Last Modified: Fri, 13 Oct 2023 03:39:03 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:189c6501b8e81db8198047dda891afcfc4d00f570522e48bc218c26e3901b2a7`  
		Last Modified: Fri, 13 Oct 2023 03:39:08 GMT  
