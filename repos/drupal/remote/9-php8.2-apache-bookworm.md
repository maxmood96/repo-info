...
```console
$ docker pull drupal@sha256:0c49bfac62b7bc0a9a4b1cc92b2677f0bb94c63b976306e0cf5b21d761aeb638
```
...
```console
$ docker pull drupal@sha256:a80ce830a6d25e52a9537b44198761c9e69f063f223ddc200addf1c937c02a1d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203416597 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b193ecddca6be7faa59e60cf5bf307b0223ebeeedbb078616cf2ec2ae243ecbd`
...
# Wed, 01 Nov 2023 19:27:23 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 19:27:23 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 19:27:34 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 19:27:35 GMT
...
-	Layers:
	...
	-	`sha256:c926c0a40b480ff3e6675b35673bfc073aa1532f541b823ab72b9e0ca6a257ac`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b75d4d30684a2d0290ec1928f9686fbdfdcb65e25bb7a9e8e481b98ba52e961d`  
		Last Modified: Wed, 01 Nov 2023 19:38:18 GMT  
		Size: 2.2 MB (2202401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e9eb7a444567cdf4303261354dec9bbf9a453b90d9a8a43aa696885e76caa8e`  
		Last Modified: Wed, 01 Nov 2023 19:38:18 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43abd24ad6a2220552678851b345a2ac9a9258c1bbdfb6a05128ce649bf80ef`  
		Last Modified: Wed, 01 Nov 2023 19:38:18 GMT  
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cb5bad25238ea65880253f63e9004df8dec95128b224d24f559a0ac95a7388b`  
		Last Modified: Wed, 01 Nov 2023 19:46:35 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea47e31b2487e226428d4d959f809ca0b0a125b883370a903584a4585d07b4f4`  
		Last Modified: Wed, 01 Nov 2023 19:46:40 GMT  
		Size: 22.9 MB (22878876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:9f339056390ee40cd32fef1bb6518c6ee106c7bae8e4bb0b321bb608d1f8f001
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167398254 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3897f5a65105045490c98afac271a489ff3a9b85cc0a555b230bb44e6cd83e77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 13:27:26 GMT
CMD ["apache2-foreground"]
# Wed, 01 Nov 2023 17:34:48 GMT
RUN set -eux; 		if command -v a2enmod; then 		a2enmod rewrite; 	fi; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libpng-dev 		libpq-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg=/usr 		--with-webp 	; 		docker-php-ext-install -j "$(nproc)" 		gd 		opcache 		pdo_mysql 		pdo_pgsql 		zip 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Nov 2023 17:34:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Nov 2023 17:34:49 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:44:04 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:44:04 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:44:20 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:44:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a1a52d94d5fd7a14c0b563468a6d16ec608769d6f41e1bd64bd2afa9b1c5ca8b`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:873acc891cbf8fa07eac04281c9b80652bed47077cf769632ff2790a861b3f63`  
		Last Modified: Wed, 01 Nov 2023 17:56:11 GMT  
		Size: 1.6 MB (1559842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1df39c3dc1a99dabd95048e1ae6db4f70ac3388bf2272e5f160624817120ddc5`  
		Last Modified: Wed, 01 Nov 2023 17:56:11 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65d9b115a8bc1a5d758038a818642e240b477f2c639c9b2054c1920bfe60ccf7`  
		Last Modified: Wed, 01 Nov 2023 17:56:11 GMT  
		Size: 705.0 KB (705007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8ba24a10c82100e2ffb95de7df1dc75a0d817dc2ca03f9b373208256f3a9a9b`  
		Last Modified: Wed, 01 Nov 2023 18:07:20 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ea0d4ee909e2f70f6aa536ddb560f85579f2b04bdc40e98388daa9c8f8d4568`  
		Last Modified: Wed, 01 Nov 2023 18:07:37 GMT  
		Size: 22.9 MB (22878777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:d9c1d2ec2b272f15967a86ab66230692a1db52916dd07f6f6e922fa05d6e92cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.5 MB (197488845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9be0767fe5a2da670cf713eb9c02062127daeeda497d94a98fb26c9cdaa180db`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Nov 2023 17:33:16 GMT
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 17:46:25 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 17:46:26 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 17:46:35 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 17:46:36 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:4115c1ba1d52542dca1ae67518ed67c917c53509d02ff57cd3b125755927bce6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b81b3cd9b738a583d152ff76bf956f1ce68e2ff476ae64197008022c0916d40`  
		Last Modified: Wed, 01 Nov 2023 18:04:56 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db85b0a77c4030ac9c9ad05586628a94aff8aaff177ffa9b54b6b327738905e2`  
		Last Modified: Wed, 01 Nov 2023 18:05:00 GMT  
		Size: 22.9 MB (22878942 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:29d459d2d96b346d782e841ba5a9cf785b9f30b2201eaff1d47e115722fdf134
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.4 MB (202416092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da77f0bb82a393cb3f46aa84f479dc99cd4f95bf8e48b6454c73ee547d8f7c41`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 14:34:42 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 14:34:42 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 14:34:57 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 14:34:58 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bdb2f10225361e19a2d5253a649eab5164fa20d2e74e4b8d0d24aa2d6edbc9db`  
		...
		Size: 705.0 KB (705011 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:095e5b0a33f0df7b5547de1f77bef5fc3688a77cf77f22ca7d11e9c3163ffbae`  
		Last Modified: Wed, 01 Nov 2023 14:57:11 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c2f94a845481a2c8e9041cb36406a0a256058dfcd04ee3fe43dc2c61784820f`  
		Last Modified: Wed, 01 Nov 2023 14:57:18 GMT  
...
```console
$ docker pull drupal@sha256:6233930149886003c7f052dffac5073f6885f1725fc104e3cf74189a32bde51a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207834697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b7a9998ebc2109425da988752a57d2bfcb08d22089a053ce07b5d10f7a7733b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Wed, 01 Nov 2023 16:05:48 GMT
ENV DRUPAL_VERSION=9.5.11
# Wed, 01 Nov 2023 16:05:53 GMT
WORKDIR /opt/drupal
# Wed, 01 Nov 2023 16:06:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Wed, 01 Nov 2023 16:06:35 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:a6c2aec1cf906fb5677fc5de832b010a415e0ac4cf49eb89949ee1d57d11f32f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:173d08fd82aef4e1a9056e9fc56bcbb3e487d6c24adbdd0ec24f490aae5dba7a`  
		Last Modified: Wed, 01 Nov 2023 17:58:32 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5081d0442301013a960c0694bb17c25dc6bc31a21c6a7fcdc9b83a1d14cd4ac6`  
		Last Modified: Wed, 01 Nov 2023 18:14:27 GMT  
		Size: 22.9 MB (22879015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
