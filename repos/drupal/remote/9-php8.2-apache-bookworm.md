...
```console
$ docker pull drupal@sha256:1f753d61502d1b4c5344781725b1dfce89eef76ad40d860b359c3414a0389596
```
...
```console
$ docker pull drupal@sha256:b102c078dbfab294fca731f6448d2c97b68fcecbac868dd4a2528cbba5ae8669
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203363198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd92847c0893bfe8c9060cf7b81cb7c8a707732e588b9e6c4b77549bb5dbbf11`
...
# Fri, 06 Oct 2023 18:43:51 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 18:43:51 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:44:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:44:03 GMT
...
-	Layers:
	...
	-	`sha256:98d9ae41a5f26e9b0d7eb4f208ddad7f96d4839d4d613d5295d70a751725e5aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e178237cb0ddc9a520b81abcaf6c3732d7f091bce265c4df8b44e0b089af10`  
		Last Modified: Fri, 06 Oct 2023 19:03:23 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:872c03200d17760c083899d8430bebb0277f920d053206ee78dcde0c3cd78a0a`  
		Last Modified: Fri, 06 Oct 2023 19:03:28 GMT  
		Size: 22.9 MB (22879449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm variant v7

```console
$ docker pull drupal@sha256:8ae7db4495cd33d6bb1dc95b06e716b8187d04953923fe8ef414e195e4873947
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167434394 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a79db78ed3ae01ca5d2d9d552fe209f6b38aa2c458ce9370292bccf359d8fe1b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:28:48 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:28:48 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:29:02 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:29:03 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b03183ed97c3611ad360bde7ba02162828762cd1b9326b1d5a8f926012a2ba4e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:730035f8f35b9e0a465e18a2f586ef90b48aeba0547682f8edeb29c9a1a4b073`  
		Last Modified: Fri, 06 Oct 2023 19:53:42 GMT  
		Size: 145.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:501f2e2812f88b1a374ace36b2e4e312dd66bd6862986e993f98c6b2a47cbca3`  
		Last Modified: Fri, 06 Oct 2023 19:54:01 GMT  
		Size: 22.9 MB (22879165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:36da74d54a67ed85cc293170de105bbaaa38fa307c183746bac02e42792203f7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.4 MB (197435734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4f92cb44f9fbac589f0e1ed535480a5a50dd7fd7485608fc67f4fd2fa677941f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 06 Oct 2023 19:15:33 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:15:43 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:15:44 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:d6785468222ca817e43e62d6b066398d4d5eaa226a007da5d80cc0604bfbc133`  
		...
		Size: 705.0 KB (705008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4d4d09d80a3171c574c9771993e5d92baf6faf1d35f34b5a0c0dfdc2d457cd8`  
		Last Modified: Fri, 06 Oct 2023 19:37:30 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fd68b0872e52cd0dcac4ccd481ada58f24a22d4b95c9321758a8cb615c9937e`  
		Last Modified: Fri, 06 Oct 2023 19:37:44 GMT  
		Size: 22.9 MB (22878758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; 386

```console
$ docker pull drupal@sha256:23598264f69e3ae9d0dd541bcd726304543e02c173e513181a0fc333bc9e8600
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.4 MB (202352639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5eaf87074dcfd6021841f0f81619292496295b29f3899af2a30d6d13cc5d7783`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 19:15:54 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 19:15:55 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 19:16:09 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 19:16:11 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:bea78340e250e71e979d41170c3dac09081bcbadc6edbe9720848a48aadd6bdb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b66c4a057503e974c58913f66643a4e31f7681f61849efa9aa4b34f6599098f`  
		Last Modified: Fri, 06 Oct 2023 19:40:52 GMT  
		Size: 146.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46772af7e755cac40bd98734f76c6318a8d33fd84f3b0cd872de96dcb0c30036`  
		Last Modified: Fri, 06 Oct 2023 19:41:10 GMT  
...
```console
$ docker pull drupal@sha256:fd47ba4661e36e7924934d2f9f36d3b7c56a75f784c3489c64e84de318f6ed8d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207781812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af0758a70d487266acd07f05e8ba3e9135bf5c551ce3d085de9d1aa7c023624a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:fcefe3e3608e465d39adb0c083a9d7159d02b35d6481adc01191e633245d5673 in /usr/local/bin/ 
# Fri, 06 Oct 2023 18:48:48 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 06 Oct 2023 18:48:49 GMT
WORKDIR /opt/drupal
# Fri, 06 Oct 2023 18:49:14 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 06 Oct 2023 18:49:19 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:b732065e71c543ea8281d59683bfa4c39d28622d25a17858ba972c44a4fd348d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9ecc8e46838100ed9afb470c2658f94c4fb2388e8dd926e0da418131bbc390b`  
		Last Modified: Fri, 06 Oct 2023 19:21:06 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb1883f4146fcbaa293071ed2b65b8f7f0843f0fc151c246a4ebf1f6ff4a184f`  
		Last Modified: Fri, 06 Oct 2023 19:21:33 GMT  
		Size: 22.9 MB (22878910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:07f644664a50a935fc3f1a0c5474c0dbb838f2f4fe351e09f7d774fe0f749c76
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176579852 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ec5366c6d764560f7f19c0b2fe55b2775a188abaccc2d107236fa9c55cf536f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 30 Sep 2023 08:15:35 GMT
ENV DRUPAL_VERSION=9.5.11
# Sat, 30 Sep 2023 08:15:35 GMT
WORKDIR /opt/drupal
# Sat, 30 Sep 2023 08:15:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 30 Sep 2023 08:15:59 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:8f0f0b6091521cd4a0257302d8e3f831fc2e511435751bc2f83d616f3b65220a`  
		...
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9fd728b22a7498da47c0befb60efc736221fdbb753f40aeb10d1511313e062e`  
		Last Modified: Sat, 30 Sep 2023 08:36:18 GMT  
		Size: 704.9 KB (704940 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd8d277a5ed188dd77293084104bcf06cc9660a0a537cc523cc61e7e93cffa30`  
		Last Modified: Sat, 30 Sep 2023 09:15:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65b77f79935acb97fd5f5322246ed62288e213c49779b745d16ca89230350f83`  
		Last Modified: Sat, 30 Sep 2023 09:15:24 GMT  
		Size: 22.9 MB (22880732 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
