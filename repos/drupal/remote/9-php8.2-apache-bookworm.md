...
```console
$ docker pull drupal@sha256:16c2ad364329873ce14f82aab0c59b46f72df3dead02f7bb7519d227e6a9c537
```
...
```console
$ docker pull drupal@sha256:8dc8ffc35ce53711dae5183ce10020d2a23422f8d51b4719e7a1b1da62c09606
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203356613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79daca877af0b739afc890cf138fd23d91b8b6809999e7e5ccd3f88d9c1e2dec`
...
# Fri, 22 Sep 2023 00:37:07 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:37:07 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:37:18 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:37:19 GMT
...
-	Layers:
	...
	-	`sha256:3333a64d7892f0e1604edab03772ac2c7413ad24de2ffb8e0a6e31e7df99e2f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f183b9dc46494ac69ba5c3d78b357ff5004120d8e422ac5b50a336ecf3b0ae69`  
		Last Modified: Fri, 22 Sep 2023 00:56:19 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7e4e5d2be2cb0eed81ca6e334e91199d852626f2a8bca4b1631df0192c3dd4c`  
		Last Modified: Fri, 22 Sep 2023 00:56:24 GMT  
...
```console
$ docker pull drupal@sha256:52211c122f2e2b358c51ffb7d7fa912f7ff30c3c72c036aa22ebae06f5e82fa4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.4 MB (167428356 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c759f6050a9a7b7c6aac98297587c8632edb555cf199963cfea75226c1625657`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 21 Sep 2023 09:56:33 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 01:17:10 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 01:17:10 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 01:17:24 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 01:17:25 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:499b62bab40c9562ab25287246b9a270a3978cde16daec24f57a4952802346d6`  
		...
		Size: 704.4 KB (704417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42587aba1fbe34794c9982316b98386e4b319be8132e133ac4ac4b2bff05481e`  
		Last Modified: Fri, 22 Sep 2023 01:40:45 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a00d289ca334e984e7ef781f770a4cbffa33e690f9b8c0ed7a993a374d2d8283`  
		Last Modified: Fri, 22 Sep 2023 01:41:01 GMT  
		Size: 22.9 MB (22880870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; arm64 variant v8

```console
$ docker pull drupal@sha256:c27a3472ad554ad02378fc7b1d8066e090471f8df09677549f5778b0d2f22e35
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.4 MB (197427607 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70dd91de28511218cc3ded06bef9354065e3836260cdef8d044ace2fddee3112`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 20 Sep 2023 18:26:48 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:54:43 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:54:43 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:54:53 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:54:54 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:7fd118ebc08bc83d448b90fec7c3fab4f4d57877a474447759a6e5f5ca74c603`  
		...
		Size: 704.4 KB (704417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe878cb16ffa702c9ffbfe252b442f11bec9a5a1bb9c81a3c38c85142ac2f88f`  
		Last Modified: Fri, 22 Sep 2023 01:16:26 GMT  
		Size: 147.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53777035384c205eabf61a95ec784b46999a1a8fd3465b34e00f9393e88dbb5b`  
		Last Modified: Fri, 22 Sep 2023 01:16:39 GMT  
...
```console
$ docker pull drupal@sha256:f2cd9c17782d479767fdfc6b5829db35380dfbec9cc2f9f7ef7e19d707b55ef0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202347866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6721eb526f8f6155df303ea9eb3e0010ce73d09d8bb7f2c4b9423f99c8f3c940`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 22 Sep 2023 00:45:35 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:45:50 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:45:51 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:898966ac9f62e8ef7130c8d182c5d8af33c5d0e6c2a19e65c3a74dec76555497`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0c642fea31102b25c8e1b12badc2e19232deeab61e15ca6381e32f7202b7784`  
		Last Modified: Fri, 22 Sep 2023 01:10:05 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:260cc5b93c18b2dab27bbad6f2b048f39702faf0b67672128d5f42a5474b1489`  
		Last Modified: Fri, 22 Sep 2023 01:10:13 GMT  
		Size: 22.9 MB (22881174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; ppc64le

```console
$ docker pull drupal@sha256:003cedee5643bb4b1e8a4a8ad72d47792e64ed5bf324f1f00fd7fe185ec21c41
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207775322 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5517a1047f2f12cba0d3a537b24d62d0d3b3d618dbe79977e9985b668b10052`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 21 Sep 2023 09:37:03 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:29:00 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:29:00 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:29:23 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:29:27 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:041d982aa1ecd091502aa697d13ff4aaf75b5414ac50344e9540595ad872e2df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e110237af6c25561e3d9245f40a820dc532c821022592f80484eb944094a0dfa`  
		Last Modified: Fri, 22 Sep 2023 01:01:59 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:752e8ab395502f7a199dc19821a0915bf82f0339c6c9a395423714dd10dfed1c`  
		Last Modified: Fri, 22 Sep 2023 01:02:20 GMT  
		Size: 22.9 MB (22881115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:b30fe3bbf036199866b2e4582031a9dc19956a4778efc55e0951858b218aed4e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176573552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9cdb593c6a351559283a73523854fdebd6cb3456b36bc8543bb4cb04f418260`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 20 Sep 2023 12:56:19 GMT
COPY file:e07dca2693c052eccdcb8ecf6a4ddfa6367b2f80335dac5c4ad082d553fdbda6 in /usr/local/bin/ 
# Fri, 22 Sep 2023 00:51:13 GMT
ENV DRUPAL_VERSION=9.5.11
# Fri, 22 Sep 2023 00:51:14 GMT
WORKDIR /opt/drupal
# Fri, 22 Sep 2023 00:51:26 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Fri, 22 Sep 2023 00:51:31 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:c2f1167c433323d0c9f9375801a457d6a2df66d8c50c9c65089ed88e28718f45`  
		...
		Size: 704.4 KB (704419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6b2761a2cd2e0190bd1f94427bc3945322fead3f75ba354f2f65a15ba68ee84`  
		Last Modified: Fri, 22 Sep 2023 01:09:29 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80cd104b57c6e0b0e6e01261add6bdbdd696f6968c0947777acff18a47ca0d3f`  
		Last Modified: Fri, 22 Sep 2023 01:09:34 GMT  
		Size: 22.9 MB (22880594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
