...
```console
$ docker pull drupal@sha256:65e6ef6cd1324ebbd0105362c018f69836afae1fe1e53c1a42c7c464e23727bc
```
...
```console
$ docker pull drupal@sha256:7d9060499ffc93c50c84136c919316d0b903b925c8c447bad2ebd3854654b4b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207768826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:633118d82b2fcc73da11a875b35a04135ba72a6fc037cb9ff3f67b3e9c1636a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 10:48:57 GMT
COPY file:57a209d1c54d80b9471ec2393baac168e72338a189d9d79c9b885adb816fa7a3 in /usr/local/bin/ 
# Sat, 02 Sep 2023 11:17:50 GMT
ENV DRUPAL_VERSION=9.5.10
# Sat, 02 Sep 2023 11:17:51 GMT
WORKDIR /opt/drupal
# Sat, 02 Sep 2023 11:18:17 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Sat, 02 Sep 2023 11:18:22 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:25e07aadb1aa0b14e3afe190c3f4009307e305f5e8682443a1d01146afa72eb2`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:602f042d99a0ec6692f79fb10e6f85439850082b8b0cdf5c643d77df79002e17`  
		Last Modified: Sat, 02 Sep 2023 11:30:37 GMT  
		Size: 698.2 KB (698238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48bafc0d920491cde8035bca2905083b605a9e29933fc038fc0b2ad470704c5d`  
		Last Modified: Sat, 02 Sep 2023 11:57:13 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9c83693ed6c56ff61f72b2e36aa8402f61a24de84ac9b2782ecca858f116d58`  
		Last Modified: Sat, 02 Sep 2023 11:57:58 GMT  
		Size: 22.9 MB (22880247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
