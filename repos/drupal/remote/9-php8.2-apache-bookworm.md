...
```console
$ docker pull drupal@sha256:26a3880972edcb98027120dbef95275f98bbd489d27b2a34b818204bb7666015
```
...
```console
$ docker pull drupal@sha256:30ab1f2f95ee73d60f328775d21a24d91ac3acdf7e1b88c56ac33675032db314
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.8 MB (207773560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7b3c5ffa676b227b9c6bb8de7a002bc23e9950b4237733e3e05968f5b47e522`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:35:38 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 05 Sep 2023 23:35:38 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:36:06 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:36:10 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:20d8cd3f1a552980d21ff195ba24ae412250e2d2ab543f528911535fb67ca3a3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:943cca4d2f2bfacd38d90baadcb68ac05ced16719facdb20d5794baebf2f2086`  
		Last Modified: Wed, 06 Sep 2023 00:06:31 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6868abcec2f3378c044b3db912bf9cee273b5ddf31a3c4a3029ded04b62e8929`  
		Last Modified: Wed, 06 Sep 2023 00:06:59 GMT  
		Size: 22.9 MB (22879847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `drupal:9-php8.2-apache-bookworm` - linux; s390x

```console
$ docker pull drupal@sha256:6def68e8de66114dcf9c1be4d68216369fec753cc98339324966c81a7f659ba9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176570070 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a12f7de681af0d4cad8c4ff007fffb00f606e968d8c2279421570e381b037d54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
COPY file:f6fe652f3cef105658cfbb87953501f67ea944fed4ff642ad214db9893edf304 in /usr/local/bin/ 
# Tue, 05 Sep 2023 23:32:56 GMT
ENV DRUPAL_VERSION=9.5.10
# Tue, 05 Sep 2023 23:32:57 GMT
WORKDIR /opt/drupal
# Tue, 05 Sep 2023 23:33:11 GMT
RUN set -eux; 	export COMPOSER_HOME="$(mktemp -d)"; 	composer create-project --no-interaction "drupal/recommended-project:$DRUPAL_VERSION" ./; 	chown -R www-data:www-data web/sites web/modules web/themes; 	rmdir /var/www/html; 	ln -sf /opt/drupal/web /var/www/html; 	rm -rf "$COMPOSER_HOME"
# Tue, 05 Sep 2023 23:33:17 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/opt/drupal/vendor/bin
```
...
-	Layers:
	...
	-	`sha256:6541769e341447fa1133b2b84ac939d45c06c94379d6fe007953151452e5527f`  
		...
		Size: 703.4 KB (703372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b26ce135706da3b528e00a3e24d9473c1446d402f049f0e3b07658c467d275f`  
		Last Modified: Tue, 05 Sep 2023 23:53:47 GMT  
		Size: 149.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e10c982f7964013c44dac7784f1163438665adddb4744fa204395cd982d08ea1`  
