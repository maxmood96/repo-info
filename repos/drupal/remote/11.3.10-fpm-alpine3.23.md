...
```console
$ docker pull drupal@sha256:dd6932b1898021e82e1752e63ea547bb0a1d024ac6487903871dddcd97193dd3
```
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; amd64
...
### `drupal:11.3.10-fpm-alpine3.23` - unknown; unknown
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; arm variant v6
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; arm variant v7
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; arm64 variant v8
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; 386
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; ppc64le
...
### `drupal:11.3.10-fpm-alpine3.23` - linux; s390x
