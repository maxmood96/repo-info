...
### `drupal:8.9.14-php7.4-fpm-alpine3.12` - linux; amd64
...
### `drupal:8.9.14-php7.4-fpm-alpine3.12` - linux; arm64 variant v8
...
### `drupal:8.9.14-php7.4-fpm-alpine3.12` - linux; 386
...
### `drupal:8.9.14-php7.4-fpm-alpine3.12` - linux; ppc64le
...
### `drupal:8.9.14-php7.4-fpm-alpine3.12` - linux; s390x
