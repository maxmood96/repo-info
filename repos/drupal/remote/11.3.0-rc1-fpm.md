...
### `drupal:11.3.0-rc1-fpm` - linux; amd64
...
### `drupal:11.3.0-rc1-fpm` - unknown; unknown
...
### `drupal:11.3.0-rc1-fpm` - linux; arm variant v7
...
### `drupal:11.3.0-rc1-fpm` - linux; arm64 variant v8
...
### `drupal:11.3.0-rc1-fpm` - linux; 386
...
### `drupal:11.3.0-rc1-fpm` - linux; ppc64le
...
### `drupal:11.3.0-rc1-fpm` - linux; riscv64
...
### `drupal:11.3.0-rc1-fpm` - linux; s390x
