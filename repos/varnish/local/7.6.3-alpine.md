...
- Created: `2025-05-13T22:18:23Z`
- Virtual Size: ~ 198.08 Mb  
...
```console
libunwind-1.8.1-r0 description:
Portable and efficient C programming interface (API) to determine the call-chain of a program

libunwind-1.8.1-r0 webpage:
https://www.nongnu.org/libunwind/

libunwind-1.8.1-r0 installed size:
175 KiB

libunwind-1.8.1-r0 license:
MIT
...
```console
varnish-7.6.3-r1 description:
High-performance HTTP accelerator

varnish-7.6.3-r1 webpage:
http://www.varnish-cache.org/

varnish-7.6.3-r1 installed size:
2340 KiB

varnish-7.6.3-r1 license:
BSD
...
```console
varnish-dbg-7.6.3-r1 description:
High-performance HTTP accelerator (debug symbols)

varnish-dbg-7.6.3-r1 webpage:
http://www.varnish-cache.org/

varnish-dbg-7.6.3-r1 installed size:
5480 KiB

varnish-dbg-7.6.3-r1 license:
BSD
...
```console
varnish-dev-7.6.3-r1 description:
High-performance HTTP accelerator (development files)

varnish-dev-7.6.3-r1 webpage:
http://www.varnish-cache.org/

varnish-dev-7.6.3-r1 installed size:
470 KiB

varnish-dev-7.6.3-r1 license:
BSD
...
```console
varnish-doc-7.6.3-r1 description:
High-performance HTTP accelerator (documentation)

varnish-doc-7.6.3-r1 webpage:
http://www.varnish-cache.org/

varnish-doc-7.6.3-r1 installed size:
151 KiB

varnish-doc-7.6.3-r1 license:
BSD
...
```console
varnish-libs-7.6.3-r1 description:
High-performance HTTP accelerator (libraries)

varnish-libs-7.6.3-r1 webpage:
http://www.varnish-cache.org/

varnish-libs-7.6.3-r1 installed size:
190 KiB

varnish-libs-7.6.3-r1 license:
BSD
