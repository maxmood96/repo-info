...
- Virtual Size: ~ 381.23 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Entrypoint: `["/usr/local/bin/docker-varnish-entrypoint"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `VMOD_DEPS=autoconf-archive automake curl libtool make pkg-config python3-sphinx`
  - `VARNISH_SIZE=100M`
  - `VSM_NOPID=1`
...
### `dpkg` source package: `dns-root-data=2024071801~deb12u1`
...
```console
$ apt-get source -qq --print-uris dns-root-data=2024071801~deb12u1
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2024071801%7edeb12u1.dsc' dns-root-data_2024071801~deb12u1.dsc 1432 SHA256:36489ead184379bf7e39d64e3b8f4e3edf1157133f8d768780b5cdb8d1bae58d
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2024071801%7edeb12u1.tar.xz' dns-root-data_2024071801~deb12u1.tar.xz 16196 SHA256:a5d26f5278f0d31d13c236b21bfefbb6bf7e275a5934900d0160890812ca6feb
```

Other potentially useful URLs:

- https://sources.debian.net/src/dns-root-data/2024071801~deb12u1/ (for browsing the source)
- https://sources.debian.net/src/dns-root-data/2024071801~deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/dns-root-data/2024071801~deb12u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `getdns=1.6.0-3`

Binary Packages:

- `libgetdns10:amd64=1.6.0-3+b1`

Licenses: (parsed from: `/usr/share/doc/libgetdns10/copyright`)
...
```console
$ apt-get source -qq --print-uris getdns=1.6.0-3
'http://deb.debian.org/debian/pool/main/g/getdns/getdns_1.6.0-3.dsc' getdns_1.6.0-3.dsc 2298 SHA256:d03fa8a0f5669aaf3f08aa311430ed0f0c32b18e756bb65f0db11b6c6c1f0bdc
...
'http://deb.debian.org/debian/pool/main/g/getdns/getdns_1.6.0-3.debian.tar.xz' getdns_1.6.0-3.debian.tar.xz 21564 SHA256:6f26c5fd5478441c368e0c9d77ef6af8844247f3e06ad59e3c76390e6776b67c
```

Other potentially useful URLs:

- https://sources.debian.net/src/getdns/1.6.0-3/ (for browsing the source)
- https://sources.debian.net/src/getdns/1.6.0-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/getdns/1.6.0-3/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `jemalloc=5.3.0-1`

Binary Packages:

- `libjemalloc2:amd64=5.3.0-1`
...
```console
$ apt-get source -qq --print-uris jemalloc=5.3.0-1
'http://deb.debian.org/debian/pool/main/j/jemalloc/jemalloc_5.3.0-1.dsc' jemalloc_5.3.0-1.dsc 1977 SHA256:439f07beae27fc3643932de2ef6d095c15f852cdf1a39c2949b8f6fbc51d6f0d
...
'http://deb.debian.org/debian/pool/main/j/jemalloc/jemalloc_5.3.0-1.debian.tar.xz' jemalloc_5.3.0-1.debian.tar.xz 15268 SHA256:4e87f3aa3709ce9ae9de501a56202de3b81f565aba441c579c57c29bda00006e
```

Other potentially useful URLs:

- https://sources.debian.net/src/jemalloc/5.3.0-1/ (for browsing the source)
- https://sources.debian.net/src/jemalloc/5.3.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jemalloc/5.3.0-1/ (for access to the source package after it no longer exists in the archive)
...
Licenses: (parsed from: `/usr/share/doc/libevent-2.1-7/copyright`, `/usr/share/doc/libevent-core-2.1-7/copyright`)
...
'http://deb.debian.org/debian/pool/main/libu/libuv1/libuv1_1.44.2-1%2bdeb12u1.dsc' libuv1_1.44.2-1+deb12u1.dsc 2029 SHA256:798be0a2bcbcd40bb85302f6ccbf02b240e1958d4ad9cf153b8101c3a82f21b9
...
'http://deb.debian.org/debian/pool/main/libu/libuv1/libuv1_1.44.2-1%2bdeb12u1.debian.tar.xz' libuv1_1.44.2-1+deb12u1.debian.tar.xz 21460 SHA256:14fc605e7d1520137416fd8c097b58a191be9b07bdbb406f7b39c7894b7d66a5
```
...
### `dpkg` source package: `mailcap=3.70+nmu1`
...
```console
$ apt-get source -qq --print-uris mailcap=3.70+nmu1
'http://deb.debian.org/debian/pool/main/m/mailcap/mailcap_3.70%2bnmu1.dsc' mailcap_3.70+nmu1.dsc 1596 SHA256:1bf5a9a159126dadc1158d26d39a7f3c6b77da033ebd6aa2daf5426ec4657481
'http://deb.debian.org/debian/pool/main/m/mailcap/mailcap_3.70%2bnmu1.tar.xz' mailcap_3.70+nmu1.tar.xz 26824 SHA256:fd6a08710c54262e3f3907a6a0d2f12be9a34ca083dc569e3590291e60b5290e
```

Other potentially useful URLs:

- https://sources.debian.net/src/mailcap/3.70+nmu1/ (for browsing the source)
- https://sources.debian.net/src/mailcap/3.70+nmu1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/mailcap/3.70+nmu1/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2%2bdeb12u2.dsc' unbound_1.17.1-2+deb12u2.dsc 3355 SHA256:a7120468620010e676d854e957076badd459f3efb1e814abc2db770a20a8ae74
...
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.17.1-2%2bdeb12u2.debian.tar.xz' unbound_1.17.1-2+deb12u2.debian.tar.xz 46420 SHA256:b875917bdff790318101725a2de00192452f28c0bc0471d6cf7d063f7b9c3288
```
...
### `dpkg` source package: `varnish=7.7.0`
