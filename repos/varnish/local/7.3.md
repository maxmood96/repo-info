...
- Created: `2024-07-23T06:33:55.871574607Z`
- Virtual Size: ~ 261.31 Mb  
...
### `dpkg` source package: `dns-root-data=2024041801~deb11u1`
...
```console
$ apt-get source -qq --print-uris dns-root-data=2024041801~deb11u1
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2024041801%7edeb11u1.dsc' dns-root-data_2024041801~deb11u1.dsc 1358 SHA256:c04d5d71d0f4cbe7dd88b6f637af913ba892286a618d49014f32ffcb7c373a3d
'http://deb.debian.org/debian/pool/main/d/dns-root-data/dns-root-data_2024041801%7edeb11u1.tar.xz' dns-root-data_2024041801~deb11u1.tar.xz 15236 SHA256:0d22f990d088ca19b3030f729daf96b8e87c01f553f5560025a43447cf5126e4
```

Other potentially useful URLs:

- https://sources.debian.net/src/dns-root-data/2024041801~deb11u1/ (for browsing the source)
- https://sources.debian.net/src/dns-root-data/2024041801~deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/dns-root-data/2024041801~deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `unbound=1.13.1-1+deb11u2`

Binary Packages:

- `libunbound8:amd64=1.13.1-1+deb11u2`
...
```console
$ apt-get source -qq --print-uris unbound=1.13.1-1+deb11u2
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1-1%2bdeb11u2.dsc' unbound_1.13.1-1+deb11u2.dsc 3198 SHA256:4594320d0d1c8997ce17530763637ae96dcf72ce5d9412a01a9fd71806ac6afe
...
'http://deb.debian.org/debian/pool/main/u/unbound/unbound_1.13.1-1%2bdeb11u2.debian.tar.xz' unbound_1.13.1-1+deb11u2.debian.tar.xz 44472 SHA256:2c0289540d8530d2a7cf377d4fe2ba87f4998a37e452d5b8b4f8d353b89dd2e7
```

Other potentially useful URLs:

- https://sources.debian.net/src/unbound/1.13.1-1+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/unbound/1.13.1-1+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/unbound/1.13.1-1+deb11u2/ (for access to the source package after it no longer exists in the archive)
