...
- Created: `2025-05-26T12:40:55Z`
- Virtual Size: ~ 198.39 Mb  
...
```console
varnish-7.7.1-r1 description:
High-performance HTTP accelerator

varnish-7.7.1-r1 webpage:
http://www.varnish-cache.org/

varnish-7.7.1-r1 installed size:
2388 KiB

varnish-7.7.1-r1 license:
BSD
...
```console
varnish-dbg-7.7.1-r1 description:
High-performance HTTP accelerator (debug symbols)

varnish-dbg-7.7.1-r1 webpage:
http://www.varnish-cache.org/

varnish-dbg-7.7.1-r1 installed size:
5629 KiB

varnish-dbg-7.7.1-r1 license:
BSD
...
```console
varnish-dev-7.7.1-r1 description:
High-performance HTTP accelerator (development files)

varnish-dev-7.7.1-r1 webpage:
http://www.varnish-cache.org/

varnish-dev-7.7.1-r1 installed size:
473 KiB

varnish-dev-7.7.1-r1 license:
BSD
...
```console
varnish-doc-7.7.1-r1 description:
High-performance HTTP accelerator (documentation)

varnish-doc-7.7.1-r1 webpage:
http://www.varnish-cache.org/

varnish-doc-7.7.1-r1 installed size:
153 KiB

varnish-doc-7.7.1-r1 license:
BSD
...
```console
varnish-libs-7.7.1-r1 description:
High-performance HTTP accelerator (libraries)

varnish-libs-7.7.1-r1 webpage:
http://www.varnish-cache.org/

varnish-libs-7.7.1-r1 installed size:
190 KiB

varnish-libs-7.7.1-r1 license:
BSD
