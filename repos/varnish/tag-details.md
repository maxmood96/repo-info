...
```console
$ docker pull varnish@sha256:86e1ff6cd6e810b31de9792a0905b4396133e8937fd517d6b6748145587753d3
```
...
```console
$ docker pull varnish@sha256:baa5e41f4042965099c01698e6020337e783abda8f7b4842abb67c2c14e6cd8e
```
