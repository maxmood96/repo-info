...
```console
$ docker pull varnish@sha256:5ad0d29684343f8d2e1caf8fa0be9920ade8bcd977de723ed62c37073f093d9a
```
...
```console
$ docker pull varnish@sha256:52a969a263b3525e0b2704b56a0d60c9edf430dfd6d9d0a7de0e00ea82b7a70f
```
