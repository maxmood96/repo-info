...
```console
$ docker pull varnish@sha256:b284ce8a157e3d3005e44482c1fb3e6b9b26cd3e2f7ac8878fe3bc5e160cdedf
```
...
```console
$ docker pull varnish@sha256:ac5350c56e17735b245a5c65a38a364df20f4649dd9bfef2f962e03ea272cd1a
```
