...
```console
$ docker pull varnish@sha256:5235d74634a582cdb864ea2acd996ede5b4480c2079529ce427a0baea1497ab5
```
...
```console
$ docker pull varnish@sha256:b4dcae6c3f2f22db420e4fe8b78bab38258b6f6f140fb303b4609bba236b9a55
```
...
```console
$ docker pull varnish@sha256:c46645be3e79770e58c30fbd7297478f8ea7cae8bfecdea578d480ddb1bf68d2
```
...
```console
$ docker pull varnish@sha256:5b402c2d7196b0299508e2d0326419dcb0f68a084d7ae7420a998079cea46a35
```
...
```console
$ docker pull varnish@sha256:e0b42a86467a87ffacfef3e4767a5fe4181ed1f4d8cf5ad9ef41671eb41ca965
```
