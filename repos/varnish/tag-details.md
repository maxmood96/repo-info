...
```console
$ docker pull varnish@sha256:28c1447edfa9912b8190a14be071513ec0bda3b84f40b10e5dd782fed6cc616b
```
...
```console
$ docker pull varnish@sha256:83eed90702bcfcb9c3e5dba3ac7a663b7da79c2111c6dc28cd0eda9caa75836d
```
