...
```console
$ docker pull varnish@sha256:7bf462ceb1c59bcf3f754656d85fb8be12542a47d0e5f9023ec286413d13f17a
```
...
```console
$ docker pull varnish@sha256:10dd49003384ce996373523945333b54144e55be80549398b9552a50768a559e
```
