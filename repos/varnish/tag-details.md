...
```console
$ docker pull varnish@sha256:7e6674371faf5597a7c6281dc7c3d9a635d8bf3f28e06a5973b92653b65e8d39
```
...
```console
$ docker pull varnish@sha256:222977d1c7042e68df7cf6d6979706d98b5cbd74ffe15d8d490eddda95b62c9f
```
...
```console
$ docker pull varnish@sha256:8c69bf617e89ab9219fc469c640a716d27101b0f1cbc8b563a6dd49e4f45519a
```
...
```console
$ docker pull varnish@sha256:459cf25daf5a13106febe74bc689d041a420c8f06dad0e5772ae276afcf3fc63
```
