...
```console
$ docker pull varnish@sha256:f6d3f592436aae1aaebf6816f639dfe2e5074bce93ed68aff8665b1495fb4074
```
...
```console
$ docker pull varnish@sha256:c3572e75299debfee6bf87ba135800b012ef8fd1af7d40fb7dd726b1de16972e
```
