...
```console
$ docker pull varnish@sha256:6df9a385d8a0eb59a3a577895c1abf990cc54c924cd3ab7a8fe5376708bc7037
```
...
```console
$ docker pull varnish@sha256:57a0dab7daaf8e03ec1001158f5b8a33bd779db301b144fd972585a679c26727
```
