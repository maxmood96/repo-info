...
```console
$ docker pull varnish@sha256:1cfc5906d29cea334972e0a6b361d6a38308fcef70c92b8413a6f6592dbfee1a
```
...
```console
$ docker pull varnish@sha256:3ee6edd51e3f3d34853489789134d06b4f37295b12c8da0bd681bbe60d7fa5db
```
