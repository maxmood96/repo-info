...
```console
$ docker pull debian@sha256:cea311dfcd4ec8675f2857b4ddbe03de609580074adf99f4538672bd4478a2cd
```
...
```console
$ docker pull debian@sha256:bd04d1de0abdde32b84c9ce2c147a9b8681828d3980d5be46003dfb5ff7330f0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.8 MB (22795588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da86dca62e56f790522f6275b1492b402c7934635e9dd0ca1bf2aabb2993b4c7`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:d5a075ca84129be515b7400e5e29cbd9facebc8c5bb845cfde1d864426e60fc8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.0 MB (25967808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3efce280b53bb049b3eadcfdc9f0101df7caa910aa8d1536cfe68772e5ab1711`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:d71c9aed95fa154e2ab45acc78dcb0c3e2ee8c420f100103c6891f9b17a1b704
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27846808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9e012a38cc793da90542135ddf2c8808fb59b243ad82367cdd339d702a4fe34`
-	Default Command: `["bash"]`
