...
```console
$ docker pull debian@sha256:44d9b596776ea4efe559079b8ec35422e1b6abcc4de6e211b0085480d76df3bf
```
...
```console
$ docker pull debian@sha256:79326248a982be0b36e8280f906916fceffdd5c17a298b14446e5e72cc822fe7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.1 MB (27098544 bytes)**  
...
```console
$ docker pull debian@sha256:e59ff2979f0b21b033d474e74de042d6d8f53452143e24a76453787b383106dd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.8 MB (24837461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ec6f8837fe3e277f314c66a776ff053b8ba14685f1eac666e60417407f30b8a`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:bdd02c79d0048a4e64b954e8e7f0d0e948c93912db5590cec585b0e0ac887fc2
```
...
-	Total Size: **22.7 MB (22705906 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c790a2cec95bbefff419998014b797b02f02e0d4084d5cb9cb9d217418e962e`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:e176ec8ad232fbbb1cc7c48a493c4832ac7336bd1a3149dfa733cc0b4bb833bb
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.9 MB (25857826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:469a6e9aea991703950402316d2a0922379ab65549995be07209896ef82de9ee`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:1e103da3d714a9f737aa6b2fb722b72e1218afa080503e5a1cb7eb4bd1b09fdf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.8 MB (27754899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:415c7318bdc119c8cd22e0bfb7ea905b4be8cd524d2457a5abf064dd4bd60529`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:04b536ac734a6e288860fd6cd82a933842b6021e518a6c8260f2c9067cf27242
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.8 MB (25764196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dec3f1cfb36219f1006d000c635a3bf59bb32df16f213d73678cb856995b63c1`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:b0488fb6007b54344339e0ef773144a360b57a39384d417a90ea25e96b4687e0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30524562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e698f85776eb844dc0e1e151e79ea58b66439a1ee1f048452a286b7b2f2c081`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:0b2215785e6d2da1d2ad7e42dc9d42d09f2e78f304194f6c8541c2bd2a796a8f
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **25.7 MB (25712820 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54f43eb1d4230ee41415fdfbe4379a4d9d8fe5120265072e9e0ee43279311291`
-	Default Command: `["bash"]`
