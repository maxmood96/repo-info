...
```console
$ docker pull debian@sha256:2f8d36f10b757d603ed9e16fc84e14973b45ba00b02225689fcda9ed109cb08e
```
...
### `debian:rc-buggy-20260202` - linux; arm variant v7

```console
$ docker pull debian@sha256:98030d748f6f50a7600911537e413d2f6d9e819baa4dae7c7b707c6a4e862d52
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.6 MB (45617626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1d88f05eab57fe4c6ffbb919804ec4f19ef7ba671a63505b0b0af51642b8601`
-	Default Command: `["bash"]`
...
-	Layers:
	-	`sha256:659484058ac0aeb678184c63f6d8d114ad6c5b9d6dec2a7ef5b116eede567c38`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:07c19aee8d9ff3ad01abb00cc2cd896d4a8f128175b3169d77eb892019161ed0`  
...
```console
$ docker pull debian@sha256:cabc194f5af08b03a19821d976faaa36383f762153d2445fc45fd720010e99a9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.2 MB (3157951 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8e96132584473a25ab86f61d01a539385de545a8c3b2dc0f2b3e3ce61b1a1bb`

```dockerfile
```

-	Layers:
	-	`sha256:ec9916a39a9004d4fe2fc22efb323b1372631d966d181cf11c1a323bb7fc854f`  
		Last Modified: Tue, 03 Feb 2026 02:16:10 GMT  
		Size: 3.2 MB (3151831 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:99ff7c3902c88225de4ec73d74572ff5e519e0c8cf3d2e95d8bd3bd295b23b0b`  
		Last Modified: Tue, 03 Feb 2026 02:16:10 GMT  
...
### `debian:rc-buggy-20260202` - linux; riscv64

```console
$ docker pull debian@sha256:c276c3f851534c6c6b6599885523e46c66d82e014918d2b50885aee7e808bba6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.9 MB (46890367 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c92fae64500970cd6bad0694325e20f75676eb840002c82b150903eb50b73ee1`
-	Default Command: `["bash"]`

```dockerfile
# Mon, 02 Feb 2026 00:00:00 GMT
RUN # debian.sh --arch 'riscv64' out/ 'sid' '@1769990400'
# Sat, 07 Feb 2026 18:18:40 GMT
RUN echo 'deb http://deb.debian.org/debian rc-buggy main' > /etc/apt/sources.list.d/experimental.list # buildkit
```
...
-	Layers:
	-	`sha256:48f09a2bb3a57a16959e5ae66db8cd1e1c1ed0c93449352dcc6fc0b64e55cbda`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6d815d1c88bdf2124c0c6353db528401260c4d52ba97e847b9a6e973e1f46652`  
		Last Modified: Sat, 07 Feb 2026 18:19:35 GMT  
		Size: 224.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull debian@sha256:b00d85c65a99f54d028df5467269445e326a0d3c84339b470c4f720c815c38b9
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.1 MB (3148065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e743a141933dbe6a1b4a266746a68e21a30fe9147c7283a3a7663ee0d222f67d`

```dockerfile
```

-	Layers:
	-	`sha256:608b25e2660db278fe064424e8228dd434f96fb08fef9f485cb8ca1ae3445825`  
		Last Modified: Sat, 07 Feb 2026 18:19:35 GMT  
		Size: 3.1 MB (3141977 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:eea046fcfd8c071ff0f4f0dd2d537d81e263c55625c824cbe781638fad2208c3`  
		Last Modified: Sat, 07 Feb 2026 18:19:35 GMT  
		Size: 6.1 KB (6088 bytes)  
		MIME: application/vnd.in-toto+json
