...
```console
$ docker pull debian@sha256:a00b492d79defb8a925c058d3e4cbd23dd5f206db4da696e9d53a5731da28b34
```
...
### `debian:experimental-20260518` - linux; amd64
...
### `debian:experimental-20260518` - unknown; unknown
...
### `debian:experimental-20260518` - linux; arm variant v7
...
### `debian:experimental-20260518` - linux; arm64 variant v8
...
### `debian:experimental-20260518` - linux; 386
...
### `debian:experimental-20260518` - linux; ppc64le
...
### `debian:experimental-20260518` - linux; s390x
