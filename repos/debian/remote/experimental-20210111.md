...
```console
$ docker pull debian@sha256:831a2f2ba3d772da8c7b47446b10432ca722ff7e095c93def618d03ff7e402ca
```
...
### `debian:experimental-20210111` - linux; amd64
...
### `debian:experimental-20210111` - linux; arm variant v5
...
### `debian:experimental-20210111` - linux; arm variant v7
...
### `debian:experimental-20210111` - linux; arm64 variant v8
...
### `debian:experimental-20210111` - linux; 386
...
### `debian:experimental-20210111` - linux; ppc64le
...
### `debian:experimental-20210111` - linux; s390x
