...
- Image ID: `sha256:b2dee806c06ec9684cb6695aae3430e451f42be4486a6e06184a3a457e0b7a58`
...
- http://snapshot.debian.org/package/acl/2.2.53-10/
...
- http://snapshot.debian.org/package/adduser/3.118+deb11u1/
...
- http://snapshot.debian.org/package/apt/2.2.4/
...
- http://snapshot.debian.org/package/attr/1:2.4.48-6/
...
- http://snapshot.debian.org/package/audit/1:3.0-2/
...
- http://snapshot.debian.org/package/base-files/11.1+deb11u11/
...
- http://snapshot.debian.org/package/bash/5.1-2+deb11u1/
...
- http://snapshot.debian.org/package/cdebconf/0.260/
...
- http://snapshot.debian.org/package/coreutils/8.32-4/
...
- http://snapshot.debian.org/package/debian-archive-keyring/2021.1.1+deb11u1/
...
- http://snapshot.debian.org/package/dpkg/1.20.13/
...
- http://snapshot.debian.org/package/e2fsprogs/1.46.2-2+deb11u1/
...
- http://snapshot.debian.org/package/gcc-10/10.2.1-6/
...
- http://snapshot.debian.org/package/gcc-9/9.3.0-22/
...
- http://snapshot.debian.org/package/gnupg2/2.2.27-2+deb11u2/
...
- http://snapshot.debian.org/package/gnutls28/3.7.1-5+deb11u7/
...
- http://snapshot.debian.org/package/grep/3.6-1+deb11u1/
...
- http://snapshot.debian.org/package/gzip/1.10-4+deb11u1/
...
- http://snapshot.debian.org/package/libffi/3.3-6/
...
- http://snapshot.debian.org/package/libgcrypt20/1.8.7-6/
...
- http://snapshot.debian.org/package/libidn2/2.3.0-5/
...
- http://snapshot.debian.org/package/libselinux/3.1-3/
...
- http://snapshot.debian.org/package/libsepol/3.1-1+deb11u1/
...
- http://snapshot.debian.org/package/libtasn1-6/4.16.0-2+deb11u2/
...
- http://snapshot.debian.org/package/libtirpc/1.3.1-1+deb11u1/
...
- http://snapshot.debian.org/package/libxcrypt/1:4.4.18-4/
...
- http://snapshot.debian.org/package/lz4/1.9.3-2/
...
- http://snapshot.debian.org/package/ncurses/6.2+20201114-2+deb11u2/
...
- http://snapshot.debian.org/package/pam/1.4.0-9+deb11u1/
...
- http://snapshot.debian.org/package/pcre2/10.36-2+deb11u1/
...
- http://snapshot.debian.org/package/shadow/1:4.8.1-1+deb11u1/
...
- http://snapshot.debian.org/package/sysvinit/2.96-7+deb11u1/
...
- http://snapshot.debian.org/package/tar/1.34+dfsg-1+deb11u1/
...
- http://snapshot.debian.org/package/util-linux/2.36.1-8+deb11u2/
...
- http://snapshot.debian.org/package/xz-utils/5.2.5-2.1~deb11u1/
...
- http://snapshot.debian.org/package/zlib/1:1.2.11.dfsg-2+deb11u2/
