...
### `nats-streaming:0.21.0-linux` - linux; amd64
...
### `nats-streaming:0.21.0-linux` - linux; arm variant v6
...
### `nats-streaming:0.21.0-linux` - linux; arm variant v7
...
### `nats-streaming:0.21.0-linux` - linux; arm64 variant v8
