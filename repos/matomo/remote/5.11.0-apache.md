...
### `matomo:5.11.0-apache` - linux; amd64
...
### `matomo:5.11.0-apache` - linux; arm variant v7
...
### `matomo:5.11.0-apache` - linux; arm64 variant v8
...
### `matomo:5.11.0-apache` - linux; 386
...
### `matomo:5.11.0-apache` - linux; ppc64le
...
### `matomo:5.11.0-apache` - linux; riscv64
