...
```console
$ docker pull matomo@sha256:2d3fa556d303b280c5157f8b4b9b400c43c1bcffaac641e82017baf7b8444590
```
...
### `matomo:4.16.0-fpm` - linux; arm variant v5
...
### `matomo:4.16.0-fpm` - linux; arm variant v7
...
### `matomo:4.16.0-fpm` - linux; arm64 variant v8
...
### `matomo:4.16.0-fpm` - linux; mips64le
...
### `matomo:4.16.0-fpm` - linux; ppc64le
