...
```console
$ docker pull matomo@sha256:a5441bb6c219deaa9d50dc57e3e9934c3488c56c7a4208c6606c60c670e6e6fa
```
...
```console
$ docker pull matomo@sha256:d4172b59bb472abb0ada768eabb4d3b56307c4c7bdeab2592aa66c425eacf1b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.9 MB (180924017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb24a4f53faf1406db820c463e9ad4ede333cda75c731ed3c19a3483f7ada233`
...
# Tue, 06 Dec 2022 06:22:21 GMT
CMD ["php-fpm"]
# Tue, 06 Dec 2022 23:18:17 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 06 Dec 2022 23:18:17 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 06 Dec 2022 23:19:47 GMT
...
-	Layers:
	...
	-	`sha256:00ef903e4c1a21d8648c97ed12f0ad57e98ecee811d9fc861275c8b04aea9a9e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54db38e051bf7e498aaa7fc284ba5a80441c02e1ef28dd6f6ca0dab8392d2d7c`  
		Last Modified: Tue, 06 Dec 2022 23:21:02 GMT  
		Size: 3.3 MB (3334585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7038a7d8fe02654a71940be2d5ae555c7adf8c34d5bfaddaec96108fe7cd5de0`  
		Last Modified: Tue, 06 Dec 2022 23:21:01 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5052db56040fd2b4674bd2e302a4264c0e15cbd9b3be9524b6dd491129e7bd3`  
		Last Modified: Tue, 06 Dec 2022 23:21:04 GMT  
		Size: 17.4 MB (17370115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f26de36a3116d320d03efe9c79e28c58a2759fcb07e3b3a3bd6b6433e501da63`  
		Last Modified: Tue, 06 Dec 2022 23:21:00 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6780017d986d8d2a8cde8b63e0d60af0b3d4367def41da179270736ef4590aff`  
		Last Modified: Tue, 06 Dec 2022 23:21:01 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:974443002a3feaecbd9de169a1eed227bcc49d9c340112fefd906ce74fb3621e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.7 MB (180702333 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47b3792a36a77630e8a293cf5eceeb2c9ae93469e71d089e814f9606cac5086e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 06 Dec 2022 08:28:44 GMT
CMD ["php-fpm"]
# Tue, 06 Dec 2022 19:51:37 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 06 Dec 2022 19:51:37 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 06 Dec 2022 19:54:00 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 06 Dec 2022 19:54:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 06 Dec 2022 19:54:03 GMT
ENV MATOMO_VERSION=4.12.3
# Tue, 06 Dec 2022 19:54:29 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 06 Dec 2022 19:54:31 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 06 Dec 2022 19:54:32 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 06 Dec 2022 19:54:32 GMT
VOLUME [/var/www/html]
# Tue, 06 Dec 2022 19:54:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 06 Dec 2022 19:54:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d44a8e86b12a9a78bf0975d5936d461a397fff283f72e0893aaa3d9c6cffeb3a`  
		...
		Size: 8.6 KB (8575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e0775be5f84491d3218e5dd73aa4ef873e096a0bedd6d716e520353c6e0bade`  
		Last Modified: Tue, 06 Dec 2022 19:56:16 GMT  
		Size: 3.3 MB (3252073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d89be1d9c1f3e3cb7633ecea3743a2f25f5ad26c56ddd21226fa11ce3f2829ab`  
		Last Modified: Tue, 06 Dec 2022 19:56:16 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45adb62a2c5c2732aaabb3ed2113fa8da07ffd075ae1cbcf7910f3fb84344109`  
		Last Modified: Tue, 06 Dec 2022 19:56:21 GMT  
		Size: 17.4 MB (17369982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba6d8e7896875d51f88d462c2639c166c1ccac0c3728d833a64cc1890438f1a3`  
		Last Modified: Tue, 06 Dec 2022 19:56:15 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec56caecd772f52503640a2fec2afda6611973d8e92e72a946abfb68663391e5`  
		Last Modified: Tue, 06 Dec 2022 19:56:15 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
