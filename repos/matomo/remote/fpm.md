...
```console
$ docker pull matomo@sha256:197407c3301b5600ebf4565d06774ed175223cce095fd691d20d4799a58aa15b
```
...
```console
$ docker pull matomo@sha256:c830eddcc743eed38c2e222e8d933dd853903458f799d4a1da806957806f7143
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182093456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e333aca3fb0f41020dfc5ef93c9775a5dabb790ac200985b46d5f6df373e073b`
...
# Thu, 09 Feb 2023 08:12:59 GMT
CMD ["php-fpm"]
# Thu, 09 Feb 2023 17:18:03 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 09 Feb 2023 17:18:03 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 09 Feb 2023 17:19:30 GMT
...
-	Layers:
	...
	-	`sha256:736ba7332ad8b916142088aa22af4fb33b3fb9140c56cdc87e667552186c51f1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d217b5fc720a214e1aab1f7f3ebe1416660a537534317d5f419e5a919e4812e`  
		Last Modified: Thu, 09 Feb 2023 17:20:45 GMT  
		Size: 3.2 MB (3188855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f57736a0d21cba105a84d8ed699db0a9a3af62b1501f38638f739277094e8c9e`  
		Last Modified: Thu, 09 Feb 2023 17:20:45 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c226ea33483b85a70ce10dad9f2d77a7071622851ca95ec27bcde94825390c1`  
		Last Modified: Thu, 09 Feb 2023 17:20:48 GMT  
		Size: 17.5 MB (17474410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:040f5fe1720e9843a0e8202818b2a04f8f0e853b795b236d132b68bdf39e4e25`  
		Last Modified: Thu, 09 Feb 2023 17:20:45 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:620b03680e42a71c5c33b6ed82bb096c2c278aa26504a0c8218388290d5c2977`  
		Last Modified: Thu, 09 Feb 2023 17:20:45 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:08b88bfa408036723f0efda712f6e27cb16352d64953a4c336e6219aa6e58b2f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.1 MB (160073128 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00eb703e3a17b4a88209cda7d772d33d3538d1d28a4fa057b27693b3d13dd0e6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Feb 2023 20:28:08 GMT
CMD ["php-fpm"]
# Tue, 14 Feb 2023 21:58:02 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 14 Feb 2023 21:58:02 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 14 Feb 2023 21:59:31 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 Feb 2023 21:59:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Feb 2023 21:59:32 GMT
ENV MATOMO_VERSION=4.13.3
...
-	Layers:
	...
	-	`sha256:cd5ee1ee39e0136d918037845a93b0cfdd515e5b8d4c5b66c7f9853feaa1603a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fb2d8bb9deb13109ce9b9c7fdfc7b266cad3981ca8f1316b832fac681c9904f`  
		Last Modified: Tue, 14 Feb 2023 22:01:42 GMT  
		Size: 2.6 MB (2645719 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8fb6f234c5878c5561251e66b9dcde3bdfb4ff988ed26f7d8420b6e933a3998`  
		Last Modified: Tue, 14 Feb 2023 22:01:42 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04ad2b462ccce742598079342eb80eb1865294a6db32bbaa6d4bf4b4d2354721`  
		Last Modified: Tue, 14 Feb 2023 22:01:47 GMT  
		Size: 17.5 MB (17472965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a279417caba52be39db8dc8228ea67bde8ad4a53f6649aff28855dcbb570fdf4`  
		Last Modified: Tue, 14 Feb 2023 22:01:41 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8e2e02e0d132e8ef39753e1242c4e46acf354cf283bcd582d65697498cbfdcf`  
		Last Modified: Tue, 14 Feb 2023 22:01:42 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:3482a818a42c36db603cbbff2406372ca774e30eb96a6fb948fe6846d098fb3f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.0 MB (152015385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e2f07f599bdc5342bbdc4aa486f08bd79cf74b643537c9637b1e090cf7bd076`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 09 Feb 2023 09:25:35 GMT
CMD ["php-fpm"]
# Thu, 09 Feb 2023 18:53:46 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 09 Feb 2023 18:53:46 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 09 Feb 2023 18:55:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 18:55:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 09 Feb 2023 18:55:03 GMT
ENV MATOMO_VERSION=4.13.3
# Thu, 09 Feb 2023 18:56:10 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 18:56:12 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 09 Feb 2023 18:56:12 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 09 Feb 2023 18:56:12 GMT
...
-	Layers:
	...
	-	`sha256:19fa5cf6682fb2bd3cec8bce9da34170173fd7942c12037df3f41707bfdcfc04`  
		...
		Size: 8.9 KB (8851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8aee11362c04568f6438951c3752c7fa87f77db49bf475b53ea4689200cf0069`  
		Last Modified: Thu, 09 Feb 2023 18:57:55 GMT  
		Size: 2.5 MB (2515609 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccab6d5ce71e42316677ef7ec9d315cfeda5d125dcea3577635a07a38e6721e6`  
		Last Modified: Thu, 09 Feb 2023 18:57:55 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cca090d5ff2474050c872c489c061c1b066e16a29f17ba747a28ddc19b3534c`  
		Last Modified: Thu, 09 Feb 2023 18:58:00 GMT  
		Size: 17.5 MB (17472937 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d964945792200f3c215f1022b12024545b03b06e69255372f05a0214039ed45`  
		Last Modified: Thu, 09 Feb 2023 18:57:55 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02955c0be08f16446eadcb3e8de9e1ee67c9e34ae2f04d82745e9b1ccb947893`  
		Last Modified: Thu, 09 Feb 2023 18:57:54 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:0f5919b74780f9551175ed89f3193ee1d488b089bc3cc54ca3b852eac638e1af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.6 MB (183557633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c33943f66097d3f561dc7293cd655b262e0e62d96dcd00f288be94ae5ec077e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 09 Feb 2023 18:46:08 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 09 Feb 2023 18:46:09 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 09 Feb 2023 18:47:34 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 18:47:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 09 Feb 2023 18:47:36 GMT
ENV MATOMO_VERSION=4.13.3
# Thu, 09 Feb 2023 18:48:34 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 18:48:36 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 09 Feb 2023 18:48:37 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 09 Feb 2023 18:48:37 GMT
VOLUME [/var/www/html]
# Thu, 09 Feb 2023 18:48:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 09 Feb 2023 18:48:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:55d3897149f2300ff54ceacf7631f2a96ff377f605b62f3777f60fa697e5f5e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1da5047165028e6861f4538259583f6ad2c5988418173c66020cd8a7985cb78`  
		Last Modified: Thu, 09 Feb 2023 18:50:03 GMT  
		Size: 3.0 MB (2960202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a197fc9e348f0a4a698f760c1c056af581ea9348602b9b1837f3bdf592bae4b`  
		Last Modified: Thu, 09 Feb 2023 18:50:03 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23831479fb4645349a8c2271ef6ecddb44f706eb8997e97bd90547f3ee789a5d`  
		Last Modified: Thu, 09 Feb 2023 18:50:06 GMT  
		Size: 17.3 MB (17258119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7f0ac3d722bd949a405e3a22c3ee90590a1aa95a0b09cb0667100a1bfdbf1c2`  
		Last Modified: Thu, 09 Feb 2023 18:50:03 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96e28a1ae31ab299da7c42f595c41f4a7efefe5d07af3b75342ec18fa9783d31`  
		Last Modified: Thu, 09 Feb 2023 18:50:03 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:b3d426061381bc4ef0e96d273f24428899ff1992c584c74621d192835cad042f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.4 MB (158435275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:651ea558b34c471720b97d307b158c0b96b9c47c265df7ba53091bc52f2d601b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 10 Feb 2023 03:44:02 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 10 Feb 2023 03:44:05 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 10 Feb 2023 03:48:32 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Feb 2023 03:48:38 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Feb 2023 03:48:41 GMT
ENV MATOMO_VERSION=4.13.3
# Fri, 10 Feb 2023 03:49:48 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Feb 2023 03:49:54 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 10 Feb 2023 03:49:59 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 10 Feb 2023 03:50:03 GMT
VOLUME [/var/www/html]
# Fri, 10 Feb 2023 03:50:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Feb 2023 03:50:14 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c64a5b861c2ccc730ae2e6211c585a9b598f1ff8f009d8009d7ad74f27576292`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a24db889cebf3fa1ef34a4007b93ffaf0b12b303fc705ef3d9ce80dd131e18b`  
		Last Modified: Fri, 10 Feb 2023 03:51:29 GMT  
		Size: 2.6 MB (2561893 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f66c60fceb9aead3d050a13419a7adaa03e33f69780ebc51e7e7dc6cb70b6f02`  
		Last Modified: Fri, 10 Feb 2023 03:51:27 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7347178bc8d40308b9919380cd2095c607f26745c38d7bbf67e5ac12e8114a29`  
		Last Modified: Fri, 10 Feb 2023 03:51:42 GMT  
		Size: 17.3 MB (17256923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de1fb50508213d6b39a60636eabbca9ec71dc6eb1454a0983f583619b6d3ab56`  
		Last Modified: Fri, 10 Feb 2023 03:51:27 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ea66b873aacb7030558328dd97448c37842323f5facff8a1b99180630a42c08`  
		Last Modified: Fri, 10 Feb 2023 03:51:27 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:6db1dd83accbfe7fb88deebb698692a7473f114a9b78142a1f77945c4e5a2017
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181870172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7687a2c48ac3b91725d92d6016c6e3be027669b1f3064d506c8c9ef6dee79dc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 09 Feb 2023 10:52:28 GMT
CMD ["php-fpm"]
# Thu, 09 Feb 2023 17:54:42 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 09 Feb 2023 17:54:43 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 09 Feb 2023 17:57:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 17:57:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 09 Feb 2023 17:57:05 GMT
ENV MATOMO_VERSION=4.13.3
# Thu, 09 Feb 2023 17:57:36 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 17:57:39 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 09 Feb 2023 17:57:39 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 09 Feb 2023 17:57:40 GMT
VOLUME [/var/www/html]
# Thu, 09 Feb 2023 17:57:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 09 Feb 2023 17:57:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:61aa138e852f0f4f073855413a89fb37d54f7e927fd9bf53ad3644d7911ea8db`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9af85b03da59f2821a873f2b6735017b1c3d8f18dc51fd3a922a4fd0b04f126`  
		Last Modified: Thu, 09 Feb 2023 17:59:14 GMT  
		Size: 3.1 MB (3064591 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cb702201513a182a84c462bdafbb1808a63cac6157f1d2981b3ed90a6db7493`  
		Last Modified: Thu, 09 Feb 2023 17:59:13 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:080bc1c33fdb05384061992e2e0d49fd8e80e7118b71469b7dc546965a6c9c8d`  
		Last Modified: Thu, 09 Feb 2023 17:59:20 GMT  
		Size: 17.5 MB (17474535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bfe5bfdf3a97f954bf5ecd079bc3d4ee7b8ccd41bafa9a7881de3ed99af4708`  
		Last Modified: Thu, 09 Feb 2023 17:59:13 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fa21b858a9c4c6a4f9c04cd30d9b0f56f5d2f833d55ba39e99e03a6e82a166a`  
		Last Modified: Thu, 09 Feb 2023 17:59:14 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
