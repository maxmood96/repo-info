...
```console
$ docker pull matomo@sha256:28471506a7bfc482cf7d708426d23c52337d3a0ba9dd2dec981bd88939bb7298
```
...
```console
$ docker pull matomo@sha256:e3e5ea90017053c166a0ef2853792786ab0d68e7ac60f530241c0fb37a1bc64b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171745119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:893094af815febc6cbe3030871232c4fa72e83b50f0ab0b0961ce46743d6d1d3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Jan 2024 05:00:22 GMT
CMD ["php-fpm"]
# Fri, 12 Jan 2024 00:07:14 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 12 Jan 2024 00:10:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:10:26 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Jan 2024 00:10:26 GMT
ENV MATOMO_VERSION=5.0.1
# Fri, 12 Jan 2024 00:10:50 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:10:51 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 12 Jan 2024 00:10:51 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 12 Jan 2024 00:10:51 GMT
VOLUME [/var/www/html]
# Fri, 12 Jan 2024 00:10:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Jan 2024 00:10:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4e80ee3bb2840a732d828c0a2300a31a8aa8692b6878bd0d0b207ab5381b2de1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd0fbbe64a8f418c1656aa0f6843f869d1d95665db64679d604d04c3b3e7a11`  
		Last Modified: Fri, 12 Jan 2024 00:11:53 GMT  
		Size: 2.9 MB (2906305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3416992370995d19393b5844b192add072a50865c45f234d38a728824dc98779`  
		Last Modified: Fri, 12 Jan 2024 00:11:52 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:503152899cb670c0b7d83e081e402ce3bec1b525500e40eec8b1782dc8af4ef1`  
		Last Modified: Fri, 12 Jan 2024 00:11:58 GMT  
		Size: 21.2 MB (21243831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33fc93692fb96a7792b2654c22b41b08805788a52bae17d7390561b4cc494c6d`  
		Last Modified: Fri, 12 Jan 2024 00:11:52 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5920d76d17cb678cc1c8d50a94d920b97549924498bf033d16a494e010970291`  
		Last Modified: Fri, 12 Jan 2024 00:11:52 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:b3b53ae9f6a80f136595527d0cc8e8f924f9fe03464400afc0e6a3576244be5f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172537786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d0c33badece4f70e097b838ef79464e881b5c7306b96b150338961b9f72caf7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 12 Jan 2024 01:07:53 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 12 Jan 2024 01:13:11 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 01:13:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Jan 2024 01:13:21 GMT
ENV MATOMO_VERSION=5.0.1
# Fri, 12 Jan 2024 01:14:36 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 01:14:43 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 12 Jan 2024 01:14:48 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 12 Jan 2024 01:14:54 GMT
VOLUME [/var/www/html]
# Fri, 12 Jan 2024 01:15:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Jan 2024 01:15:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a801bfe0c5eefe6b708b6955c1a72294000094ae20befc46483673ad38d2d34f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6957aed4d95c4646c227c8cf8abc2f74c25f4f28f2f808a2e08cd2a0f4e175df`  
		Last Modified: Fri, 12 Jan 2024 01:16:21 GMT  
		Size: 2.8 MB (2808024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47b94b90b1916623e052814d222db870c98df880fd40797c69507d6cf8f17cea`  
		Last Modified: Fri, 12 Jan 2024 01:16:18 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4607e30d9adc2a2a5d4bbf798d60ca4dd259657284886bb6a01d3235856e874f`  
		Last Modified: Fri, 12 Jan 2024 01:16:35 GMT  
		Size: 21.0 MB (21038841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b19d15b2c6128650df7e83135590265573924cbf12a27a73c485dd68b87a94a`  
		Last Modified: Fri, 12 Jan 2024 01:16:18 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9037aa5290bcbd49a7f5e3273f25a5e0c99866537fb2b70a4bb83d47231efa3d`  
		Last Modified: Fri, 12 Jan 2024 01:16:18 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
