...
```console
$ docker pull matomo@sha256:3ac3f093e5a3e64e08b4963d686f7e8731a612fd2dd64aa170791588c4f381f9
```
...
```console
$ docker pull matomo@sha256:a05e009c41577004df863cbe1081bf185d06c5883cf411121c327527e4097223
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.3 MB (161342163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fc25f73cd3490532b0b30667d93e01c1f8838650a0e5d75f839df404aa6b8ab`
...
CMD ["php-fpm"]
# Thu, 24 Jun 2021 06:56:03 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 24 Jun 2021 06:57:17 GMT
...
-	Layers:
	...
	-	`sha256:47d6cddd3951841781b9e049a572004e45651e121086fad643265e8d2a217675`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a32b1856fe0876296376302bd2a8316b6773119addcb22c05b2a293746b91f4`  
		Last Modified: Thu, 24 Jun 2021 06:58:44 GMT  
		Size: 3.2 MB (3161812 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b93f0d1dac8470b6964a36078d6d53717dae5c33a3b4fc5cb09af34762161854`  
		Last Modified: Thu, 24 Jun 2021 06:58:43 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d556ae1ecda2a195d69c4336f6d1ce6f6be25b837278150fdedb15ecac492a23`  
		Last Modified: Thu, 24 Jun 2021 06:58:46 GMT  
		Size: 15.1 MB (15099567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75c89e138e598b37898c3cc6d76e031c515c5150d4eb0a9bdd115ab3dea6b73f`  
		Last Modified: Thu, 24 Jun 2021 06:58:43 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1621dd9e7375146fa551ebf92b8060cf9e1cb0e5e47259e9a9d0779ebc7beb23`  
		Last Modified: Thu, 24 Jun 2021 06:58:43 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:037206d7b99ac48046b52381669dc9639d7ec9a3bef924cb5ddbc33ed34f3d1e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.6 MB (139644886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65b16c92087da04e25e4282985bcf0fdbbd46353c63574c290f570b319dd13e2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 23 Jun 2021 07:36:25 GMT
CMD ["php-fpm"]
# Wed, 23 Jun 2021 23:41:36 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 23 Jun 2021 23:45:19 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 23:45:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 23 Jun 2021 23:45:21 GMT
ENV MATOMO_VERSION=4.3.1
# Wed, 23 Jun 2021 23:45:57 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 23:45:59 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 23 Jun 2021 23:45:59 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Wed, 23 Jun 2021 23:46:00 GMT
VOLUME [/var/www/html]
# Wed, 23 Jun 2021 23:46:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 23 Jun 2021 23:46:00 GMT
...
-	Layers:
	...
	-	`sha256:2ecebd762e68e4445e2857272a16a379fcacbe9444aaba08e30b5b200ecf9a9d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05157c5bd836305de87b1363ebda9513b653a81de31af24ef0a379edf967c03b`  
		Last Modified: Wed, 23 Jun 2021 23:48:04 GMT  
		Size: 3.0 MB (2977214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f16152cc3f7666f84f0b2cfbfd754b740d0cfe154414835fe0fcb1c4b746e9c`  
		Last Modified: Wed, 23 Jun 2021 23:48:02 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69288eca4d047328010e2b212009b5610053b4665073989f29ecf275de59e990`  
		Last Modified: Wed, 23 Jun 2021 23:48:19 GMT  
		Size: 15.1 MB (15097825 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a7f2793a61181f16441762f199090693e5202f843db3bc320682adeb942aa19`  
		Last Modified: Wed, 23 Jun 2021 23:48:03 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63912947cf9331c9084bc75c94a02a48c757b512f4d46581dc7813f918499964`  
		Last Modified: Wed, 23 Jun 2021 23:48:02 GMT  
		Size: 229.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:30c4a3f3bf0eef9627dc9d8b2b26f6d9968092f42c4d35ddaaacbbf059fbe6f8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.1 MB (137084959 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9246d5c77318629b6f09d833513c5983a8db76f46dffaae4028c392a194c77df`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 23 Jun 2021 09:53:58 GMT
CMD ["php-fpm"]
# Thu, 24 Jun 2021 20:08:22 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 24 Jun 2021 20:11:52 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Jun 2021 20:11:53 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 24 Jun 2021 20:11:54 GMT
ENV MATOMO_VERSION=4.3.1
# Thu, 24 Jun 2021 20:12:23 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Jun 2021 20:12:24 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 24 Jun 2021 20:12:25 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 24 Jun 2021 20:12:25 GMT
VOLUME [/var/www/html]
# Thu, 24 Jun 2021 20:12:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 24 Jun 2021 20:12:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ac2db2f4d15c77ab8df0a99cc9af52927043a12ee64f3571b93fbb428229b865`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aebf5fe863160c0fbf02f1b21ff839a16b7a03730b0630d5695f4b5b612cf6e6`  
		Last Modified: Thu, 24 Jun 2021 20:18:40 GMT  
		Size: 2.8 MB (2844297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aded1381108d82d725fdff2146a0be4fbf7832ec8859d228e8a5a0c527eef3ca`  
		Last Modified: Thu, 24 Jun 2021 20:18:38 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6d5d64177a257fd9904f9751e5a494161d9c43b82c4702826e4412bd0157c7a`  
		Last Modified: Thu, 24 Jun 2021 20:18:54 GMT  
		Size: 15.1 MB (15097846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9406487341b3fd77a0011a7749660d730a17a8d3c21738f7ebff1531f45c9710`  
		Last Modified: Thu, 24 Jun 2021 20:18:38 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9626b97e81c1f2c421ceddc8248a22b0706968e22eb1dcb3ff21b922d2ad8070`  
		Last Modified: Thu, 24 Jun 2021 20:18:38 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:12c40d24b4cea9aba35ea0e4e383ee04dd031ba41f3c6619b8828f656c898a43
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.5 MB (153506114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:074e33da3b450bdc88ce8ad36a423a464e2083526a4e542fecf237aa4b19e79d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 23 Jun 2021 09:39:09 GMT
CMD ["php-fpm"]
# Wed, 23 Jun 2021 23:25:27 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 23 Jun 2021 23:26:45 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 23:26:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 23 Jun 2021 23:26:46 GMT
ENV MATOMO_VERSION=4.3.1
# Wed, 23 Jun 2021 23:26:59 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 23:27:00 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 23 Jun 2021 23:27:00 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Wed, 23 Jun 2021 23:27:00 GMT
...
-	Layers:
	...
	-	`sha256:f021aaab43b1754134fc8d7b8a0a58b486febfbd40002f0013cd18695f867a9f`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6f28472caec72d033c031acfc6f6ef2329b9ebd2e4b9484ce6ac3beec526555`  
		Last Modified: Wed, 23 Jun 2021 23:28:36 GMT  
		Size: 3.1 MB (3119627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fe907e941a4900451f68776e3d81b276fe4d33256e13a21d78871843f13855e`  
		Last Modified: Wed, 23 Jun 2021 23:28:35 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39a02f5a4e4cf43fabea601c3b901c3a78f3bfcc42c869c3f64e91f7d9cb8b47`  
		Last Modified: Wed, 23 Jun 2021 23:28:38 GMT  
		Size: 15.1 MB (15098344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a324ca53e064d76193b5da3ef826c3da448c0fcd8568438261d3309f8004ba86`  
		Last Modified: Wed, 23 Jun 2021 23:28:35 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58b3bf39965005d3183b568e5e7a48c4443dcd165410b6497f2bf2a867e5f218`  
		Last Modified: Wed, 23 Jun 2021 23:28:35 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:1a2513113772be4c9b49c640a78a17bd007448bc3dd174e67b0b439bbd20863b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.1 MB (167148770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d12dcdd5994cf0051df653b1e47ae90271a1eb1d6e8b721cf22466d4c8519b3c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 23 Jun 2021 11:12:41 GMT
CMD ["php-fpm"]
# Wed, 23 Jun 2021 19:13:48 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 23 Jun 2021 19:17:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 19:17:22 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 23 Jun 2021 19:17:23 GMT
ENV MATOMO_VERSION=4.3.1
# Wed, 23 Jun 2021 19:17:47 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 19:17:48 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 23 Jun 2021 19:17:49 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Wed, 23 Jun 2021 19:17:50 GMT
VOLUME [/var/www/html]
# Wed, 23 Jun 2021 19:17:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 23 Jun 2021 19:17:50 GMT
...
-	Layers:
	...
	-	`sha256:1ae04b22df9cc2185c19284cfcb5f96533477b7786474f277449427f0b7ca6a0`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d92b17682501472c9a05f09dfdbed7e81215de34d96caa32f34afea450ca2c1b`  
		Last Modified: Wed, 23 Jun 2021 19:20:08 GMT  
		Size: 3.2 MB (3187432 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:951ece6a3565cedddac83c60be6176252bf70f1de7dc1d7deb5b0e32218bac98`  
		Last Modified: Wed, 23 Jun 2021 19:20:06 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f4a7e6e406fb0a464e77387ca4b306a7f3265e8fd3097e868ce40c926654d4b`  
		Last Modified: Wed, 23 Jun 2021 19:20:13 GMT  
		Size: 15.1 MB (15098915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:115b67c7e67cca0092d5250b2bdc5b9d147fe0a9f10b522ef8e920f24cbf21d3`  
		Last Modified: Wed, 23 Jun 2021 19:20:05 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:823f14651792cd2badba1cf308adf7642a3bdb9f6d5f521f31012fbb13611ddf`  
		Last Modified: Wed, 23 Jun 2021 19:20:05 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:bfd67cacb77ba5f504cfc7745d471a4f0d1ba6357ab14c1f908983d07743d039
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.1 MB (144063727 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:103d86d8f0b4b0ba5904b85c7171c43abf91e0658427d4aedae6021ebd6ddc06`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 23 Jun 2021 04:55:08 GMT
CMD ["php-fpm"]
# Wed, 23 Jun 2021 21:22:14 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 23 Jun 2021 21:26:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 21:26:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 23 Jun 2021 21:26:42 GMT
ENV MATOMO_VERSION=4.3.1
# Wed, 23 Jun 2021 21:27:16 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 23 Jun 2021 21:27:17 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 23 Jun 2021 21:27:18 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Wed, 23 Jun 2021 21:27:18 GMT
VOLUME [/var/www/html]
# Wed, 23 Jun 2021 21:27:18 GMT
...
-	Layers:
	...
	-	`sha256:41da9bdb4909dcdf38df1e991a26a8be37c8bdbec0346501681f2c4a1c17e4a9`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc8f25df20f53520c3519addc73bc2a026202e16816539473c799a2d4c01dc5c`  
		Last Modified: Wed, 23 Jun 2021 21:28:31 GMT  
		Size: 3.1 MB (3116247 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b4d9676329a45ec275d4608e230bab5e2a70a41e74f9913279e5a6a39737106`  
		Last Modified: Wed, 23 Jun 2021 21:28:28 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3bf30c9a1cb09b11dfdb8e76b39d163d59d0eaaf74290630a9fe4375817a207`  
		Last Modified: Wed, 23 Jun 2021 21:28:41 GMT  
		Size: 15.1 MB (15097351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54bf91d4892b1defd00f7edda9115877ac95c1a6e1932d74a57d86fcee57a7c1`  
		Last Modified: Wed, 23 Jun 2021 21:28:28 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed171e531eb16b81c84d36a93fd6aa79ad30a5eb8fcc19235dca32a30c91e369`  
		Last Modified: Wed, 23 Jun 2021 21:28:28 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:50b1982267e95796c70b819f4cd01ada7c299a77c03377a9bca188cc8a6346d1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172295464 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d89e5f0b47c1582a311cf7fc9c5bd893dff4acccbcd7640713c678e19bbbd855`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sun, 27 Jun 2021 12:09:09 GMT
LABEL maintainer=pierre@piwik.org
# Sun, 27 Jun 2021 12:11:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sun, 27 Jun 2021 12:11:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sun, 27 Jun 2021 12:11:30 GMT
ENV MATOMO_VERSION=4.3.1
# Sun, 27 Jun 2021 12:12:28 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 27 Jun 2021 12:12:33 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sun, 27 Jun 2021 12:12:34 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Sun, 27 Jun 2021 12:12:38 GMT
VOLUME [/var/www/html]
# Sun, 27 Jun 2021 12:12:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 27 Jun 2021 12:12:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:77f7157839b499671352876631ec1b7e7d252bfc0f3779c6f5f9bfcb3baea3dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:288eea55246f9bb324df4342cc558415971b0a4be7d44efdd12a4e822c1c9fe6`  
		Last Modified: Sun, 27 Jun 2021 12:17:39 GMT  
		Size: 3.4 MB (3408207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4f30d570b07a408a30912282182a42e36f0910ef9f70fe9934c004a21cc2074`  
		Last Modified: Sun, 27 Jun 2021 12:17:38 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e960f8000da9c5ecfa0408708dc0cba4e71401c5082de7a95aed3028541c5dd`  
		Last Modified: Sun, 27 Jun 2021 12:17:42 GMT  
		Size: 15.1 MB (15100207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:740efbb3c1758fb20b425457aedafad537a19b5880e5d948990fa658dea9d8fa`  
		Last Modified: Sun, 27 Jun 2021 12:17:38 GMT  
		Size: 311.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46a5d1af2ee3e14acc7f65d29bae056ca488a5c39befc31b0102751e73744c0a`  
		Last Modified: Sun, 27 Jun 2021 12:17:38 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:0d4eca5cf5fa8a8c8f294ae23af594b98e141ce20d6880c569b44bb8ef527009
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.1 MB (147051038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:329482c0ac3793cf7acad823b07979709ab2eb5b0e2abc2dc6b408a89e856f09`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 26 Jun 2021 01:13:17 GMT
CMD ["php-fpm"]
# Sun, 27 Jun 2021 14:03:22 GMT
LABEL maintainer=pierre@piwik.org
# Sun, 27 Jun 2021 14:04:57 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sun, 27 Jun 2021 14:04:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sun, 27 Jun 2021 14:04:58 GMT
ENV MATOMO_VERSION=4.3.1
# Sun, 27 Jun 2021 14:05:15 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 27 Jun 2021 14:05:17 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sun, 27 Jun 2021 14:05:17 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Sun, 27 Jun 2021 14:05:18 GMT
VOLUME [/var/www/html]
# Sun, 27 Jun 2021 14:05:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 27 Jun 2021 14:05:18 GMT
...
-	Layers:
	...
	-	`sha256:45c30e7f2f0ac5ab737987af77f2f1292aff087dc470a572e861b5ba562fed20`  
		...
		Size: 8.4 KB (8448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cc0b75f6e081f150d3cf21bb7dd0ef0439ffc670ac7e40eb47270f3381c4e60`  
		Last Modified: Sun, 27 Jun 2021 14:08:13 GMT  
		Size: 3.1 MB (3113908 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c6117d5267a757ec82c27a64867d69df894d8e7772761987fda2c154def0eaa`  
		Last Modified: Sun, 27 Jun 2021 14:08:13 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:561851b1ead944e16820532c7ca8957fc0802eececd8050746fe7a9cabee6523`  
		Last Modified: Sun, 27 Jun 2021 14:08:16 GMT  
		Size: 15.1 MB (15098259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:645c5eb2977b1b6fb9f9b38d9516cece467c69eaaec2fc4255fc729f76a1f949`  
		Last Modified: Sun, 27 Jun 2021 14:08:13 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:833a762b98dad62cdb3c789f13eb236e1b0e13ab160ee980f2e5b7d012bef022`  
		Last Modified: Sun, 27 Jun 2021 14:08:13 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
