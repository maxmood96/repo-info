...
```console
$ docker pull matomo@sha256:27861491a2078e0bd592eda4bc3dd575e97364eab858f28903271d48b736ff75
```
...
```console
$ docker pull matomo@sha256:46ca22d0a74f803853fd0ae45329a51696190487920eb0af2adb2c176d2c3ca4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.7 MB (182651452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90dfc59116a01183afaa359ec48b341e9bed4cf03a862feca388ca6ba3ab1518`
...
# Thu, 07 Jul 2022 23:20:55 GMT
CMD ["php-fpm"]
# Fri, 08 Jul 2022 02:11:58 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 02:11:58 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 02:13:32 GMT
...
-	Layers:
	...
	-	`sha256:723829a0f2a1c31773b63b7ee1e8d451565f5745131002146b5d2e9b34bb9b31`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6cdeea9051490a7dba0338308a62b04715cf299eb6f24700d806c7895b223d8`  
		Last Modified: Fri, 08 Jul 2022 02:17:11 GMT  
		Size: 3.3 MB (3333684 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ba24aa815b7d3be377a1ca88ed3fa1803a6f2e491580d7e7e7e5c51b198980f`  
		Last Modified: Fri, 08 Jul 2022 02:17:10 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:609249fac68fc60a8ccdfb888cf65b1d85b2200fe3096c968d6ca01384ffea71`  
		Last Modified: Fri, 08 Jul 2022 02:17:14 GMT  
		Size: 17.1 MB (17108122 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4dbdaf3696a0819b0185dece920d8d08ba09f7f769c9a0c47fb3f2db75661d43`  
		Last Modified: Fri, 08 Jul 2022 02:17:10 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42641698bbbfbd9d920fe0a95d0eb9e91b4fe14a977d83f4d76c9cd662e81cae`  
		Last Modified: Fri, 08 Jul 2022 02:17:10 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:2bfce150341f0eefcbf742f88e658f426c9f341bf19f92d60cae3c42defe5c31
```
...
-	Total Size: **160.0 MB (160013507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4dd8ad9a2b939caaa060f057e7bdea80dd32d1779f908d8cf7a0e253ac91e51f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 08 Jul 2022 01:46:44 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 01:46:45 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 01:50:34 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 01:50:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 01:50:36 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 01:51:37 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:63304ba788b215e6e2c59095321841a9dca478f9f6359d93a3e172902aa65ac4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c27176d5a16fa655095ca50333833fd7051af694866f4598adb15fc96e5e2fec`  
		Last Modified: Fri, 08 Jul 2022 01:53:45 GMT  
		Size: 2.8 MB (2808384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6266ae7fb7a7de89ded0e4ede83b4003ccce744978cb8f61d9129c868e81475f`  
		Last Modified: Fri, 08 Jul 2022 01:53:43 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bb66c71d18f5f2cce95e2e8d10dcc34aca52f21743174d0da2d489a6349e412`  
		Last Modified: Fri, 08 Jul 2022 01:54:02 GMT  
		Size: 17.1 MB (17106576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04b5178270aa00ad7f05c910b62afb0a440efb050b0ef3289408ae563e4554f0`  
		Last Modified: Fri, 08 Jul 2022 01:53:43 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a71e336b454f864b897b62c10440046114960dfd9ba3e63709821e713d27a83`  
		Last Modified: Fri, 08 Jul 2022 01:53:43 GMT  
		Size: 629.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:6c714497bc29ec391b9db0cb5d299e51b211d5124193c10e339c25bc585c35e3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.3 MB (152258021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae97aa9bb1e998cd7dec3ba4e4bf2709a077d9a46c0d9db45a0b0e3cff184792`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jul 2022 23:43:05 GMT
CMD ["php-fpm"]
# Fri, 08 Jul 2022 06:54:35 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 06:54:35 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 06:58:16 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 06:58:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 06:58:18 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 06:59:06 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 06:59:07 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 08 Jul 2022 06:59:08 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 08 Jul 2022 06:59:08 GMT
VOLUME [/var/www/html]
# Fri, 08 Jul 2022 06:59:08 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 08 Jul 2022 06:59:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:35a40169461c487295dab910310598d73bc78e7e2d4d4fff3c38367ecb804a3e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed1ddd41f8213051f6950f86d8698a7da48e9ff363e60cb4ea75506fa30f9a7b`  
		Last Modified: Fri, 08 Jul 2022 07:06:12 GMT  
		Size: 2.7 MB (2656596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae91fb0d8de55724f91aa02cd0287e1c94eceb0eabce4f1503bd41a611a9a6a5`  
		Last Modified: Fri, 08 Jul 2022 07:06:10 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e12b707e0eaee11af23c23528eaae9bc267eee1fd4d7e74f00066b30ce4fa929`  
		Last Modified: Fri, 08 Jul 2022 07:06:28 GMT  
		Size: 17.1 MB (17106549 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:138232f5ad67569ba7ee7bdfa8ecabad1eacfab35c365f1977d66034df6cdeb6`  
		Last Modified: Fri, 08 Jul 2022 07:06:10 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b368493ce863929343f2aceb290b2b14155018a32c87c7775675b8ca69f4ef9`  
		Last Modified: Fri, 08 Jul 2022 07:06:10 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e1a8d76c0a74f6b569c6c1b762a85f32b1b5e18ef5ea42f00a6a1e4a0d9f313b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.7 MB (174706709 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f336e07d01bf8ad1bb888fbdecef7de4edb72175b311fa6cb0e2d4dc0cf5fc7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 08 Jul 2022 03:29:12 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 03:29:12 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 03:30:30 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 03:30:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 03:30:31 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 03:31:08 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 03:31:09 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 08 Jul 2022 03:31:10 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 08 Jul 2022 03:31:10 GMT
VOLUME [/var/www/html]
# Fri, 08 Jul 2022 03:31:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 08 Jul 2022 03:31:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:991fd09b3bd21b4ae70d153c39cf1fdd6df5ac43e1bdaf799c1a0f46b86c21fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfa4d4becdd467a90864be2bdbfd1c81a46d5c87c89d6d55d80eb54b0bc1957`  
		Last Modified: Fri, 08 Jul 2022 03:34:59 GMT  
		Size: 2.7 MB (2735711 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97e4c1dda8d70863165c8009c26e2c4bf033f35807f254107857558dec771f14`  
		Last Modified: Fri, 08 Jul 2022 03:34:58 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:481966a56e37b6e456c1eb03f8af4c1822bc1c9ca92c4b282487e599248885f3`  
		Last Modified: Fri, 08 Jul 2022 03:35:03 GMT  
		Size: 16.9 MB (16888465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6439f62ba6076474748681ab12d651164e7137054797e4b75484173e140a9eb3`  
		Last Modified: Fri, 08 Jul 2022 03:34:58 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fc04a0c6f4e8b05d09fb7a1c3674ae28064d7e8e7d342e3a056f0fc4c8e2a7e`  
		Last Modified: Fri, 08 Jul 2022 03:34:58 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f8431d1ed2be125a2af583fa3847b8d3089639c322cc0f4cda4783643d61b904
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.4 MB (184386452 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80ffa55d94997e5c16c10541c09093b663ec1655d1ebb9cb6fdd1765b687faed`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 08 Jul 2022 03:08:47 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 03:08:47 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 03:10:10 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 03:10:11 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 03:10:12 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 03:10:44 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 03:10:45 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 08 Jul 2022 03:10:46 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 08 Jul 2022 03:10:46 GMT
VOLUME [/var/www/html]
...
-	Layers:
	...
	-	`sha256:619cffa3dcbf9834984e1d183b6c33e6b68446bd98d4cb9441cee8aa97ca84d6`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1da6d5eb1ea2caaa79927470273b6ba21185738e7be4a3d24eb723b6057f563`  
		Last Modified: Fri, 08 Jul 2022 03:14:39 GMT  
		Size: 3.1 MB (3107188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:271666b94f485ee13600a7788ad250346bc990f3f74ac903e2d3c5f130c5fab6`  
		Last Modified: Fri, 08 Jul 2022 03:14:39 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8069e1d03e8a7d8ccaf23e3c1196456a39bab24e60d9d2220aca05a9e6d73036`  
		Last Modified: Fri, 08 Jul 2022 03:14:42 GMT  
		Size: 16.9 MB (16888474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d82733d07e0edffcd672f2fede030162a426c6797d2ca355126f41443550fc05`  
		Last Modified: Fri, 08 Jul 2022 03:14:39 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faa0d07842d93e7bc8dc39f211999a7f898a40961c22d66558c8ed766a2ec896`  
		Last Modified: Fri, 08 Jul 2022 03:14:39 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e27b27a8fd7012ff942b3019df026c09b59ce893b59a7ab3e017270f14965158
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.6 MB (182631222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b95672ab2ab1d1fa9978e05d4197d6f1dab2aa1b4ac9ce2a65f4e17bea99001`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 08 Jul 2022 11:03:27 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 11:03:32 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 11:06:56 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 11:07:06 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 11:07:10 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 11:08:43 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 11:08:48 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 08 Jul 2022 11:08:50 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 08 Jul 2022 11:08:56 GMT
VOLUME [/var/www/html]
# Fri, 08 Jul 2022 11:09:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 08 Jul 2022 11:09:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6e15fc8f74901cb0b9cfa18751525ce5566ff98f70a9774a91595b01be9c6c2e`  
		...
		Size: 8.6 KB (8575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eae633ce7a49adec28683ee5a57225c56c37f87ddd1b11bca4a304661dd887e0`  
		Last Modified: Fri, 08 Jul 2022 11:14:57 GMT  
		Size: 3.3 MB (3251354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a47b432ebd7eecad7f0390482e511fc7aa554bd539539e809202ea023049d0a`  
		Last Modified: Fri, 08 Jul 2022 11:14:57 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d48dc58c1c5234d782cf3b89f146d6e1fc8bc4151ec596901cb56844b8a57cc`  
		Last Modified: Fri, 08 Jul 2022 11:15:01 GMT  
		Size: 17.1 MB (17108939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d46e3e96cc1236978b46a53d0c99442f1d46d421a3736cf1a63cae4d3190449`  
		Last Modified: Fri, 08 Jul 2022 11:14:57 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7842617350dddc7275ccd3b1443c2d8c7095ec3936647869ad7e1453af08232`  
		Last Modified: Fri, 08 Jul 2022 11:14:57 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4fbb184b97323476748bc706a9133b6a770ec28c28dd9622d15f6701b9308d42
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.3 MB (159322858 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cda2e471ff28a5fe4ac49001f84e18a43a5160037c77306b00aa1405094671a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 07 Jul 2022 22:07:53 GMT
CMD ["php-fpm"]
# Fri, 08 Jul 2022 01:15:15 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 08 Jul 2022 01:15:15 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 08 Jul 2022 01:16:03 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 01:16:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 08 Jul 2022 01:16:04 GMT
ENV MATOMO_VERSION=4.10.1
# Fri, 08 Jul 2022 01:16:23 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 08 Jul 2022 01:16:24 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 08 Jul 2022 01:16:25 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 08 Jul 2022 01:16:25 GMT
VOLUME [/var/www/html]
# Fri, 08 Jul 2022 01:16:25 GMT
...
-	Layers:
	...
	-	`sha256:6c2caf464c94de27594d8aafdcf8ce33257b6400ebc53db19ac37361a9c5b919`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73ba91c1c744af2e465be9cc7875a43075098a8f9a5436752959414a0c41f132`  
		Last Modified: Fri, 08 Jul 2022 01:20:08 GMT  
		Size: 3.0 MB (2958274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69dfa609acfa74f27b1a4138950046657d697676df0909c276d379088d880394`  
		Last Modified: Fri, 08 Jul 2022 01:20:08 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e7b985cdd25633709fbe3034c6076bce4cec03960337cb134dff2438163dcc8`  
		Last Modified: Fri, 08 Jul 2022 01:20:10 GMT  
		Size: 17.1 MB (17106734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84a343ab5a6e007fec050f2446db21a73375ab52518dd0206654f5aa13c3ccc2`  
		Last Modified: Fri, 08 Jul 2022 01:20:08 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83fed95249d37411562c3e00b6cc692bcb1222e268eeef8dd4949da80c1604b1`  
		Last Modified: Fri, 08 Jul 2022 01:20:08 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
