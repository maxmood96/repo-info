...
```console
$ docker pull matomo@sha256:aba2681699ed7b024c31b1c0d99d12955ede099ae582142247cc01a790c914b5
```
...
```console
$ docker pull matomo@sha256:eb54baf4eb00a7a27c87ffa522a05f14c9d42686e10c8e7912f7d43c0eefe683
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.7 MB (198680850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46fa03f08fb35f42f5cac36b4778803cbaa9576e71fc07ebe2f7b539ae118115`
...
-	Layers:
	...
	-	`sha256:d24b2373cc3e98208f2f61b5db8c983d35be27b9110dbc2c8174478f29ddf8e8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0446e408dde831cc77f37d4dad1556551c671c9bbf2de9730ca2f65f985b8c57`  
		Last Modified: Fri, 25 Oct 2024 03:51:35 GMT  
		Size: 3.4 MB (3438279 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f690de91e798202f3c8ba81be59d6d0813b04a2233f0d7bf76cd63b111db9b7b`  
		Last Modified: Fri, 25 Oct 2024 03:51:34 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f67f886a925a5e88ef4128e8267a5276736eb61c9082f9efca71f10c9cad07e2`  
		Last Modified: Fri, 25 Oct 2024 03:51:38 GMT  
		Size: 21.5 MB (21530636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e408e1086db5b8008b05116278f73b84ca98d152adb73f1942756c99061dba7`  
		Last Modified: Fri, 25 Oct 2024 03:51:34 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b153edc3ce28d6af764b9f3367a58c8094531ec59e7e3b2a37dcb7e72c87617a`  
		Last Modified: Fri, 25 Oct 2024 03:51:34 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:906b5130fca5b919ae26d82ac244e5cbd3966b13ec126f1c45a9383ab4976f3f
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.1 MB (172055856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70eb94f833593b09cdb0e551b227b7ff22ae240eaef3859add160d2cffc5050a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 25 Oct 2024 00:45:38 GMT
CMD ["php-fpm"]
# Fri, 25 Oct 2024 02:18:16 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 25 Oct 2024 02:19:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.24; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 25 Oct 2024 02:19:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 25 Oct 2024 02:19:54 GMT
ENV MATOMO_VERSION=5.1.2
...
-	Layers:
	...
	-	`sha256:96c5a7eec6c07e01a9464e739203ed8820852faf2c926b0376afbfb33a29d295`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f16857646843d8fc399814639948ef7e727eae5bd06927ebd2a489f3fd7045f1`  
		Last Modified: Fri, 25 Oct 2024 02:21:03 GMT  
		Size: 2.9 MB (2905141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6eba91e1bf201a48edf8f9ec8b9339ae0b9af3a19f6c71e5950299e53de142b`  
		Last Modified: Fri, 25 Oct 2024 02:21:02 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cde102e070d0ff887232dba81835024e42605957838c28a29f4d3a17fb0b7c6`  
		Last Modified: Fri, 25 Oct 2024 02:21:08 GMT  
		Size: 21.5 MB (21528253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:433c2af3c6cb8f1ffe387fe7b20eddf42d93757a51655afc6b45ca98fc0799af`  
		Last Modified: Fri, 25 Oct 2024 02:21:02 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2419005315f1ce2dc4f52565a82e1cecb98a1d016e576b2988623c8e636df9a`  
		Last Modified: Fri, 25 Oct 2024 02:21:02 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:bba008f4728cd4f214e097aca605f4fccef4536369443b3f0cd01a3228d244d8
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.3 MB (197338740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bbff2d0f7c005315d0292a15a2431ed2a8cbd372e04c24257b8d53281766ec0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 25 Oct 2024 03:03:17 GMT
CMD ["php-fpm"]
# Fri, 25 Oct 2024 04:46:23 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 25 Oct 2024 04:48:17 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.24; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 25 Oct 2024 04:48:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 25 Oct 2024 04:48:18 GMT
ENV MATOMO_VERSION=5.1.2
# Fri, 25 Oct 2024 04:48:35 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 25 Oct 2024 04:48:36 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 25 Oct 2024 04:48:36 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 25 Oct 2024 04:48:36 GMT
...
-	Layers:
	...
	-	`sha256:3b5a8f88444afcd0e20c0abf06f17a3026451549fdeef1145afffc0cd43918be`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:676d03e2025ae2104badb50f9a5527ef7b0627aa80959b23767ac2f70fb27230`  
		Last Modified: Fri, 25 Oct 2024 04:52:02 GMT  
		Size: 3.4 MB (3388113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3e8ddd75ad551ac62fef04d1eba769862f5ca5b0abf16d91b511324b79b172a`  
		Last Modified: Fri, 25 Oct 2024 04:52:01 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e5b6e23ebed48dc9aa28b833499af01aacc6766a79b112961fe05190852190e`  
		Last Modified: Fri, 25 Oct 2024 04:52:07 GMT  
		Size: 21.5 MB (21529487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fb3f7329f13e13d138eae37cabd83b98f25ac6317322edc7e33bb312afcf9cb`  
		Last Modified: Fri, 25 Oct 2024 04:52:01 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:406cd37dc1dea99a18c3ec87b7c7d6df28a7a42b8f4f17cb68c44b588c5bc035`  
		Last Modified: Fri, 25 Oct 2024 04:52:01 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:c64ec70c5ace12602fd2193e348af780a62a70ba1c198ab62e7da5e93634be3e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.8 MB (172834585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50f9a1a79eb8e9d1d49bd32bc645792ea40c719aedf30373cc916cd883859647`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV PHP_MEMORY_LIMIT=256M
# Thu, 17 Oct 2024 09:59:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.24; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 09:59:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 17 Oct 2024 09:59:12 GMT
ENV MATOMO_VERSION=5.1.2
# Thu, 17 Oct 2024 10:00:29 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 10:00:35 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 17 Oct 2024 10:00:41 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 17 Oct 2024 10:00:46 GMT
VOLUME [/var/www/html]
# Thu, 17 Oct 2024 10:00:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 17 Oct 2024 10:00:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:03dd57434c85b8423eab8b9acddc6649f4a66ec31596b3139785072b882c7b98`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fedfa7ca669f20ac05aa511f299f37d179c2824ccc25ff19c3c1d21b63e0bde`  
		Last Modified: Thu, 17 Oct 2024 10:02:06 GMT  
		Size: 2.8 MB (2807390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ae2648c1950d93a22e498f872be632bbb13734273d21a7a31195f7e9a12c4c`  
		Last Modified: Thu, 17 Oct 2024 10:02:03 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c42b2fe68e6bc1fc27fec0e58445383c146686ae7e595355c44bb5c07d097e91`  
		Last Modified: Thu, 17 Oct 2024 10:02:20 GMT  
		Size: 21.3 MB (21322059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b947ac7d6b2fcd9dfdffbe9ed4d14e2f5875eacd4da7ac6b08dfeb50e60bb5`  
		Last Modified: Thu, 17 Oct 2024 10:02:03 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d651535f1cd37d6757cbf28c7219a620ea2b4b6cc03915c958551a977de45b0`  
		Last Modified: Thu, 17 Oct 2024 10:02:03 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:3d6d55d633cf39bc0ea0bcbb7d4a71801d910a8194fb67f8e4370ee7c5e9facf
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202629792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e726c4c4e86ec15aab40cdf8e431610f98dc4ef7554bc5ba7a5bccbb7be71fe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 25 Oct 2024 02:02:19 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 25 Oct 2024 02:03:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.24; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 25 Oct 2024 02:03:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 25 Oct 2024 02:03:54 GMT
ENV MATOMO_VERSION=5.1.2
# Fri, 25 Oct 2024 02:04:12 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:ac52b9e53fee6e55e1c8ecfe37b3c565a03428367a4228833f018d743dfa2036`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1f6608865b9d6245430369111995dca8175a10caab3710cf0770146df036a61`  
		Last Modified: Fri, 25 Oct 2024 02:07:02 GMT  
		Size: 3.3 MB (3348514 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eecb963df6169837ad07d842befc77e9d7ab2b4d157adfc01e3abe5dcbecadfd`  
		Last Modified: Fri, 25 Oct 2024 02:07:01 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9627d6c7fe36f9ffc2e37327977cc90f924c645ad7e91fd4838c08235c073d3b`  
		Last Modified: Fri, 25 Oct 2024 02:07:05 GMT  
		Size: 21.5 MB (21529868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b42a2f9ad7d8caedcabbc1cbb90a9e8fa3887d03461c65a8409b966d6546911`  
		Last Modified: Fri, 25 Oct 2024 02:07:01 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea7dd56ca1bac42ada8e879ae5b242bf9b401297c1685d511875757cc0e4591b`  
		Last Modified: Fri, 25 Oct 2024 02:07:01 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
