...
```console
$ docker pull matomo@sha256:58db0e7d3fac2e806a78f07cdd6d9801fc891b46861828387d68f9c73c7ab951
```
...
```console
$ docker pull matomo@sha256:dff21f5e3e99ababc5d27d222b1f4b53a6257ef91d3b91c113cbaa5ca4ccfe0a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.4 MB (196409130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8bb0fffc54a20654eb2dbd5728683bf40b4c7bfe799c6be802472240aeb14e0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	apt-get dist-clean # buildkit
# Tue, 13 Jan 2026 07:37:09 GMT
COPY php.ini /usr/local/etc/php/conf.d/php-matomo.ini # buildkit
# Tue, 13 Jan 2026 07:37:11 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Tue, 13 Jan 2026 07:37:11 GMT
VOLUME [/var/www/html]
# Tue, 13 Jan 2026 07:37:11 GMT
...
-	Layers:
	...
	-	`sha256:b32b638e99a892c81c55481fd2622d67b19b3020b854b2caf8ace58df450064f`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7f14e85f10c20a0f7e55902086ba2729b54d0246ba47d9a0153d44c0d35c3c84`  
		Last Modified: Tue, 13 Jan 2026 07:37:34 GMT  
		Size: 2.9 MB (2934600 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4befa6799b46d46fa76368866f1e8beede84595b97a44876ed761337d230169d`  
		Last Modified: Tue, 13 Jan 2026 07:37:34 GMT  
		Size: 328.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0d4dbc0542e557889734d55fe4c3dca15631c5c587c6e7764bb4164ce5d1e596`  
		Last Modified: Tue, 13 Jan 2026 07:37:38 GMT  
		Size: 22.2 MB (22239240 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fffec3169f350670dafed82253adaf3400480f6fd062696147f85903f83f5eec`  
		Last Modified: Tue, 13 Jan 2026 07:37:34 GMT  
		Size: 344.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull matomo@sha256:ec04f7d1b20e87c927a59805389b374063ba6f4aa0d9fd035e19286a2c592371
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.3 KB (33295 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4eee059f8ee22f692b0cb2c34ecac5abe3ad48338ed2cf6338accf54452b8ad3`

```dockerfile
```

-	Layers:
	-	`sha256:1df60f38b83d1e21059fbc1babd282477ad7b370243c6ee084ed0eded2886907`  
		Last Modified: Tue, 13 Jan 2026 10:11:52 GMT  
...
-	Layers:
	...
	-	`sha256:c4af27533dd848063fdc4888d26da867469fc44fffed4f9821982773177117f8`  
		Last Modified: Thu, 01 Jan 2026 19:00:11 GMT  
		Size: 329.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull matomo@sha256:b93c5be441024a5236b015f85197f44384deef2614b4ec5dfebb44b124250571
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **174.6 MB (174649828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4499eab72a789ee86a87483dc00ce1f5764b20f4869890239a21a71e56269a9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:97f84985e92b42dd74bb0a2d7c62d387fbd3673780934bb0fcc9d08ea4605abe`  
		...
		Size: 9.2 KB (9194 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6c7346e4ac460f119fe653bd375341ec4012ee2648006993613305c1bb0d77d0`  
		Last Modified: Tue, 13 Jan 2026 15:56:33 GMT  
		Size: 2.7 MB (2731041 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7186791fca0226410646c2eb64d3fe9e208aae63f84ff3c2fe01ba8d069fb795`  
		Last Modified: Tue, 13 Jan 2026 15:56:32 GMT  
		Size: 325.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0b106c3cf2c44fe1cc245db93385d7a57044a87a6cbaa91a8f461de458a7ae46`  
		Last Modified: Tue, 13 Jan 2026 15:56:34 GMT  
		Size: 22.2 MB (22237773 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:12ed62872699e9346ae49b4722bd77f33c5acf0ef6395dfdc9b7224f8fecad76`  
		Last Modified: Tue, 13 Jan 2026 15:56:32 GMT  
		Size: 341.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1358be13685d4e4cfe8cf58def9282e8b336822125f0f61c9309805b9afd4145`  
		Last Modified: Tue, 13 Jan 2026 15:56:32 GMT  
		Size: 824.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull matomo@sha256:fadf522c91606a5f443d89aa6183857c103a845b44a8f76ce51cb9ba43aa8a0e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.2 KB (33242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d4e58180dfc415fbab1d1d7c8013d94b640d5bada0ea58ced5efab60c9d42dd`
