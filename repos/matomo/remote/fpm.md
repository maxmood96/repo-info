...
```console
$ docker pull matomo@sha256:7c1b5d23c5399b0a9afa0c29f073f7c171ae3a79cc2ec775a8a264a1c537acc4
```
...
```console
$ docker pull matomo@sha256:4399f3e5df63736b1f02606056fd6632ece6b2a111ddf9447b3ae00ffcdfd25c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.1 MB (161051559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f7642c64d156b187f8fd2719a95c545f1e81119a65f182774348e7c157c29b83`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 26 Jan 2022 09:49:35 GMT
CMD ["php-fpm"]
# Thu, 27 Jan 2022 12:51:54 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 27 Jan 2022 12:51:54 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 12:55:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 12:55:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 12:55:45 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 12:57:00 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 12:57:01 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 12:57:02 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 12:57:02 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 12:57:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 12:57:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:82eb3a0745d80305371bfd334afd2b7fed533d8300ffc7c4ff224ae07a8baf39`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c71cae4fa5e0c80e7489b2eb1838cb6fd098df94aa9b92d1e6d65cbca1488cfa`  
		Last Modified: Thu, 27 Jan 2022 12:59:08 GMT  
		Size: 2.8 MB (2788651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:613f321d0cce324b09d531d7d07edcaf81dad001e005ebf95a677a3a5cc27c64`  
		Last Modified: Thu, 27 Jan 2022 12:59:06 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a07d0b8a89d1c75d40995a016a0c70d9464a4e648b0380af51a1ced24813f64`  
		Last Modified: Thu, 27 Jan 2022 12:59:23 GMT  
		Size: 16.6 MB (16550843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0edad38970a7d127d95e14a0cb55388e6c1d5d83a3d3b165d3dfd050d48b87a4`  
		Last Modified: Thu, 27 Jan 2022 12:59:06 GMT  
		Size: 347.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a93211caef701fdef1dd92150ebaadb28b01be4f0f8c2739be5fc8cc45848264`  
		Last Modified: Thu, 27 Jan 2022 12:59:06 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:98e68791fc4d8a9826239b0fed2abb5958407809a3a07aa7a4930392d24fa7fd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153178534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ca9d3d008a45f5e754aa01f994d1a5624b79636a39da9b473950395f8c27a35`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 27 Jan 2022 09:54:47 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 27 Jan 2022 09:54:48 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 09:58:24 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:58:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 09:58:26 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 09:59:22 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:59:24 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 09:59:24 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 09:59:25 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 09:59:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 09:59:25 GMT
...
-	Layers:
	...
	-	`sha256:f6307d281c396d747572332c9c43febcdba5a4ecd7eaa3aaf21e5a10213ce789`  
		...
		Size: 8.6 KB (8575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a8145dd4a4173f48ddb749f20fd9a8355e2adc58b732bd81cf178431c9ffb92`  
		Last Modified: Thu, 27 Jan 2022 10:01:59 GMT  
		Size: 2.6 MB (2637415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1819fdaaf1e92e6ba2135e44cee0042028d5ac94448da13cdd3bf013d2d9625c`  
		Last Modified: Thu, 27 Jan 2022 10:01:57 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57a8e6ae6b7db7ecd573e0467dbc7cabb84a757b313292d78e5a5c60b03afda0`  
		Last Modified: Thu, 27 Jan 2022 10:02:14 GMT  
		Size: 16.6 MB (16550759 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b6a279efe4c08558fa2f6fe15f0f451b86dffab6e7ed548968125cb6115eb9f`  
		Last Modified: Thu, 27 Jan 2022 10:01:57 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:714c8faeef7d40547f0fa487098fc4f29ad734cb39d3b6424ee5677a899aaa3b`  
		Last Modified: Thu, 27 Jan 2022 10:01:57 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:d74bd3c2ebb63308c27e96ce4737a2dc8c237dfc1f7cd13156783a06b522668e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175797826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df58a6176786954d9652207d1ea22383210119459ab6d2c9432ab3ff7979ae23`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 27 Jan 2022 03:22:16 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 27 Jan 2022 03:22:16 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 03:23:30 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 03:23:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 03:23:32 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 03:24:42 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 03:24:43 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 03:24:44 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 03:24:44 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 03:24:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 03:24:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:79ddda2aade26871f281c1cef69d69876118e99de9e315e960dd078e647e0a11`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327278c4f58a041014874a8fce7ce760fa0a78e48a6a0fef8c66f7bd5971f339`  
		Last Modified: Thu, 27 Jan 2022 03:26:16 GMT  
		Size: 2.7 MB (2713101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d74cb133c34b6ac7306b2e1ca228497428a06c751f5f40846ce189425e120db`  
		Last Modified: Thu, 27 Jan 2022 03:26:15 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff2ad85eb4a0cc31f7fad22af9eafaa7a102a5f914b3a786ce594f038e10d3aa`  
		Last Modified: Thu, 27 Jan 2022 03:26:20 GMT  
		Size: 16.3 MB (16334231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c474e649585c612584df709946953ca8f5399a29163a59f45671da6e0fda79fb`  
		Last Modified: Thu, 27 Jan 2022 03:26:15 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e8214508253b17ae37557436bbf46f08827f2f0e6e90aa5389800d94d0bdb7d`  
		Last Modified: Thu, 27 Jan 2022 03:26:15 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:935d01b938c8c3b3571338a7e2c2dcd9f1dc0e3ebf58af9818acc2f5d97f71b5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.3 MB (186322606 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b185638a54f623f597043ed53425eb9780ab66466cfbbfdce6fbe4c7ee74ee1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jan 2022 09:27:07 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 09:31:22 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:31:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 09:31:25 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 09:32:29 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:32:30 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 09:32:31 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 09:32:31 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 09:32:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 09:32:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:88d23290e50b235640b334b02c59eaef7ce9b9ee7401aa31db69a513f6c35d41`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70935abf40f36bef462df4349903789216d75c8c9d2a3a2e98b87cfc150de5e0`  
		Last Modified: Thu, 27 Jan 2022 09:34:27 GMT  
		Size: 3.3 MB (3299809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7f216ff3749bf35a05095aa75d1e20d6d8004aa59574b035b6f459485f06857`  
		Last Modified: Thu, 27 Jan 2022 09:34:26 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f992229f46a9a540299ebf248a60ac81f5f4b41fcb9fad6e715bad5e0adb33c6`  
		Last Modified: Thu, 27 Jan 2022 09:34:32 GMT  
		Size: 16.6 MB (16551394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36789a971be6da12d56e6967cc38b0f9ee6e3c548c94fcf2bba8fa1a468db2ab`  
		Last Modified: Thu, 27 Jan 2022 09:34:26 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d0c3226fead923d980c406d2ee5e62df567de6d153d0ef0dfbbc5a44c7dea87`  
		Last Modified: Thu, 27 Jan 2022 09:34:26 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:ac27e2150daea46e6fab634c468239fe68839ffc9bcb59d4c7137ef2da7fb634
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (160968261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:130f08b7b92f6bf258f28c779c93ec52355e861226f8614f9f1896943815fba8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Thu, 27 Jan 2022 16:54:03 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 16:58:37 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 16:58:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 16:58:39 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 16:59:15 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 16:59:17 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 16:59:17 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 16:59:18 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 16:59:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 16:59:18 GMT
...
-	Layers:
	...
	-	`sha256:538f6cc0208150cc25134e7879aa2e6a5b40f20d4e3c9e1c4666198244fac6f6`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1830354ba7e26dffbf9161ca6d0c36560c7ba3c6b882086c9c914c62e6cc174e`  
		Last Modified: Thu, 27 Jan 2022 17:00:42 GMT  
		Size: 2.9 MB (2926676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64427b70c3f6c1a23d674794b93c9682cc92936c390129fdbdd1c9d2afaad620`  
		Last Modified: Thu, 27 Jan 2022 17:00:40 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbaa410776b1474ac2b372b689a59083b5429301cae4a8b3bbe3b4afe50c6a49`  
		Last Modified: Thu, 27 Jan 2022 17:00:54 GMT  
		Size: 16.5 MB (16549780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5219bbc06af0f026dc36af6ade38311504d54df1a2a84aaabf69fd0cdba8f78f`  
		Last Modified: Thu, 27 Jan 2022 17:00:40 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01055903aa7bdf41a22f1ab54d3d858c79fc26d4cec68a3ee95f6a96a5046558`  
		Last Modified: Thu, 27 Jan 2022 17:00:39 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:5e1df666dddba64cfaedd13dc5580126e8323d5ab98487c2b6c47dbd17104ef9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.8 MB (183848539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1505fb94d1310ab0c703fec19b2ea3d061766b9d981604db1f3d0442dfaa02a3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 27 Jan 2022 09:18:05 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 27 Jan 2022 09:18:08 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 27 Jan 2022 09:20:59 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:21:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 27 Jan 2022 09:21:08 GMT
ENV MATOMO_VERSION=4.6.2
# Thu, 27 Jan 2022 09:22:35 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jan 2022 09:22:39 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 27 Jan 2022 09:22:40 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 27 Jan 2022 09:22:43 GMT
VOLUME [/var/www/html]
# Thu, 27 Jan 2022 09:22:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 Jan 2022 09:22:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1791cf3cc44a1b003deb684e986545a0f18b11ddb6c43faa2d017e688dbf689d`  
		...
		Size: 8.6 KB (8574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d9da8a2fa5015ca03f341af9b3d28611137fe1951623e03fba99ae3839ba9e1`  
		Last Modified: Thu, 27 Jan 2022 09:24:24 GMT  
		Size: 3.2 MB (3229545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a61d2415e9bc8106d0a64ed7c3d6945ea3ade71c8f3796a68d377bf7cd3921f8`  
		Last Modified: Thu, 27 Jan 2022 09:24:23 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37a117fd031ed7bf277bc911b8e0707b224317ded70bed8edc77e507379b64b6`  
		Last Modified: Thu, 27 Jan 2022 09:24:27 GMT  
		Size: 16.6 MB (16552974 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1a357191d313d3842e7e442f1fbcac36eb711f1d3645512244d423736563abe`  
		Last Modified: Thu, 27 Jan 2022 09:24:23 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:211a474a9b15aadfb2e38f32e415fcb7cb4fdadc014d257b390c68db10de1bb9`  
		Last Modified: Thu, 27 Jan 2022 09:24:23 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:33fc6d23b43dc2afd7f83f47a49f6b4a4c0ef507e01e0b9ef5f60c37bdb17d66
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.4 MB (160414819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd1898a9f4604cb06459bbf36421b31c42a6044542e20980632aade67809b046`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 26 Jan 2022 04:21:26 GMT
CMD ["php-fpm"]
# Wed, 26 Jan 2022 20:58:41 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 26 Jan 2022 20:58:41 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 26 Jan 2022 20:59:29 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Jan 2022 20:59:30 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 26 Jan 2022 20:59:30 GMT
ENV MATOMO_VERSION=4.6.2
# Wed, 26 Jan 2022 21:00:16 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:564e6a42e82489230fe273a7f45cd2a924f4e32099a4eb53678c9306676397cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4389b8203eeb146e1a71cc3ec1558cba22b037e7c6005b7986fe5d30be5131a`  
		Last Modified: Wed, 26 Jan 2022 21:01:51 GMT  
		Size: 2.9 MB (2936317 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4e2ddd9fa019fc70dc4ea68ed075866a973a7254dcdd2521e3e2cfff89c0b40`  
		Last Modified: Wed, 26 Jan 2022 21:01:51 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17c088ef62565fa01ac03cf5f9f50c9274be8b4c5004957349ac77bb805daf00`  
		Last Modified: Wed, 26 Jan 2022 21:01:53 GMT  
		Size: 16.6 MB (16550921 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2e7c53cdb9ed561035071da3f2b465aa9fad7b23cfc6fdb06aae46ead18d8a3`  
		Last Modified: Wed, 26 Jan 2022 21:01:51 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f52da01fda739899e746b1b97a402f57e6170500b3bfcf3b693980cc05602842`  
		Last Modified: Wed, 26 Jan 2022 21:01:51 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
