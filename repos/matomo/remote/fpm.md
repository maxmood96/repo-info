...
```console
$ docker pull matomo@sha256:78254f00a281ac91654351906f2132dae2ae81b040f21e3e221ddbb19400620a
```
...
```console
$ docker pull matomo@sha256:371b24c732b7923f6b14f3c705e302b1b7d04aed8e625738de5ce934d28cdf14
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.0 MB (139982493 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3328a3e3b5a2c7e449d5fed8427fdd43a54355555f71c2285f2b3f0849f488a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 17 Apr 2020 11:24:25 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 17 Apr 2020 11:26:59 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 11:27:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 11:27:03 GMT
ENV MATOMO_VERSION=3.13.4
# Fri, 17 Apr 2020 11:27:43 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 11:27:52 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 17 Apr 2020 11:27:53 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 17 Apr 2020 11:27:54 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 11:27:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 11:27:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3540954309821513378ab436f1bbec746f1226136101874ce388269c39c1df67`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b492f627becb5c2b85dcfedd860c3276c81d6bbcaaf12a367d52760d6bb7a77a`  
		Last Modified: Fri, 17 Apr 2020 11:28:57 GMT  
		Size: 3.2 MB (3178737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74135ffc521d05d20435a19e2e8fe578d81e517d45c055ae4ca9e3b831b7d35f`  
		Last Modified: Fri, 17 Apr 2020 11:28:55 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37b785b7de33e89c2194420fc64804e0c5ed80bad891b7f2bf1cc96963e29c7f`  
		Last Modified: Fri, 17 Apr 2020 11:29:04 GMT  
		Size: 15.4 MB (15431118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a7d6661b92e7ddd7aeb17a1d17bbc795975ad68666a8f2e997c04c004f219e6`  
		Last Modified: Fri, 17 Apr 2020 11:28:55 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:543fb8ff96f6e0ac7079535b6575c05f1f4f21eee0e9c721cdc2840b252987f3`  
		Last Modified: Fri, 17 Apr 2020 11:28:55 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f539ac811120162ec268ba68ab9dcbadee73859d7a1271d0585a7b3e0843cdad
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.4 MB (147398740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5099867cf7807b1105b1acf5104ea55b4d44d2205d0e1a21612913e13dbdf034`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 17 Apr 2020 12:50:48 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 17 Apr 2020 12:51:38 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:51:38 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 12:51:39 GMT
ENV MATOMO_VERSION=3.13.4
# Fri, 17 Apr 2020 12:51:48 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 12:51:50 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 17 Apr 2020 12:51:50 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 17 Apr 2020 12:51:50 GMT
VOLUME [/var/www/html]
# Fri, 17 Apr 2020 12:51:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 17 Apr 2020 12:51:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c6a9871dc4cc78b1227ae22c8fd732fbde77f0eecccdf3de607c5661f58aafa9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e64f41e9822094b6afcc61bd1fbe3cb17fce483d7adb23ce2bfd026914e5888`  
		Last Modified: Fri, 17 Apr 2020 12:53:42 GMT  
		Size: 3.3 MB (3314853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4523a676982eb85cfb4b6a054ba68c33b1fd8175e8f386ce462b2db17347a2b5`  
		Last Modified: Fri, 17 Apr 2020 12:53:46 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0233c5f8ca2fd9484eb2a0c866f6e032ba886d06a5a5cbddd6d7af9e5d677ca9`  
		Last Modified: Fri, 17 Apr 2020 12:53:49 GMT  
		Size: 15.4 MB (15431089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76e971e863ad6d628e208bf640d2e38b91f3e70f8643bb498ba2ebfcbc6a2f61`  
		Last Modified: Fri, 17 Apr 2020 12:53:57 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15880abee7b827fd2ffd824c2eed918532f0b7c3d05747aa6adbd2cc227f0013`  
		Last Modified: Fri, 17 Apr 2020 12:53:46 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
