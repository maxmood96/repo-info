...
```console
$ docker pull matomo@sha256:62a69c007d2b1be255745dc060d1fa02d95cba0a7e8e17d3856b5b0c9fbfe5e7
```
...
```console
$ docker pull matomo@sha256:33d3e63bf8900b58d349766546869e2486c6c78f40e5202ada8a688a9079dc15
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.6 MB (198640281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cea33fdbe3cd127025c907ddcbfa79b488c8bcc9a8e404b43e66ce46306988d9`
...
# Thu, 01 Aug 2024 21:39:14 GMT
CMD ["php-fpm"]
# Thu, 01 Aug 2024 23:09:41 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 01 Aug 2024 23:11:23 GMT
...
-	Layers:
	...
	-	`sha256:7aed583be2bb139a1cd333929923d8d79950114b781622cf0f1eadde20ebae3d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43efd84eddfda50f6294e791e5e7ac1beb4b572bb84d99341ff21976d6cdf5a`  
		Last Modified: Thu, 01 Aug 2024 23:14:34 GMT  
		Size: 3.4 MB (3436508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d71ee26a711427c4700ef8d0eee4a51324eab96c107349cca9912bdfe280ca2d`  
		Last Modified: Thu, 01 Aug 2024 23:14:33 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f789be9e1296746784ffd04446159f1589ce0d37095ea4e4ab6669700bfab94`  
		Last Modified: Thu, 01 Aug 2024 23:14:37 GMT  
		Size: 21.5 MB (21522556 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf5b49ce7e3a245e471d949444250722c6551461e372a435da68a7d975d33e47`  
		Last Modified: Thu, 01 Aug 2024 23:14:33 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37773c26bbfd5d45a858ebf75bf2f811e252bd576a49b2988a748e30eb6cb5ff`  
		Last Modified: Thu, 01 Aug 2024 23:14:33 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:856be5906c71ae349b9dbee2348e28f959ed99c8fb18b54d1373d6934231646e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172016555 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:955c57414f28429515b4601cbe5fbf0c50be61b9a52f99ed3eb55d130f37d023`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Aug 2024 22:47:34 GMT
CMD ["php-fpm"]
# Thu, 01 Aug 2024 23:41:20 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 01 Aug 2024 23:42:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 23:42:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 01 Aug 2024 23:42:43 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 01 Aug 2024 23:43:00 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 23:43:01 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 01 Aug 2024 23:43:01 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 01 Aug 2024 23:43:01 GMT
...
-	Layers:
	...
	-	`sha256:8444dd07ae66f4d2db05d2e62b93b7073cdfd5e1d31ab1305956938a385c61e9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e31231aa2b4685154fee8424573e6069bbbc07f19677d4d9a2a4576c0ff5e304`  
		Last Modified: Thu, 01 Aug 2024 23:43:48 GMT  
		Size: 2.9 MB (2903678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e8e395fe1353787fec9006df25e5347b003472c57afe4afaed72872ecbdba77`  
		Last Modified: Thu, 01 Aug 2024 23:43:47 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:145c0fee6130373775ea8c3ba49f17b3a0820c5648ca42cb96d7697a5896701d`  
		Last Modified: Thu, 01 Aug 2024 23:43:53 GMT  
		Size: 21.5 MB (21520327 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:400c800a96d71ebcc8c2c68034a75e54802aeb2a89e79598ee18bf9a96bec5d2`  
		Last Modified: Thu, 01 Aug 2024 23:43:47 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03bf4a75729df41d1ac285b112da3f0f739aec3377962216633e783413ab101d`  
		Last Modified: Thu, 01 Aug 2024 23:43:47 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:60a40f8eb96922cfb67c46a8c9d12cd7fedacb8722bce04651deca49421e9720
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **163.0 MB (163002155 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6004f34a1526556b7e77e4cd536a589580c3474e4cc538c759d9a6e529dbbd98`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 01 Aug 2024 23:38:27 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 01 Aug 2024 23:39:45 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 23:39:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 01 Aug 2024 23:39:46 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 01 Aug 2024 23:40:01 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 23:40:02 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 01 Aug 2024 23:40:02 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 01 Aug 2024 23:40:02 GMT
...
-	Layers:
	...
	-	`sha256:0aa677f457a8a3bc115b5c23022cb165a08f8514766542b04d6c5157749e3d17`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41d48235d72adff82af0b5ce6c1468e272b54581a10a918fd824bf98d7f6ca0e`  
		Last Modified: Thu, 01 Aug 2024 23:42:19 GMT  
		Size: 2.8 MB (2782793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34a1850784679eecbb94459405bf45ce92bc0733f8ec6789fec9a1ef76be74b0`  
		Last Modified: Thu, 01 Aug 2024 23:42:19 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac8803b234966145e912354208ffff3e527175de68bc5c93fa7b5e4fa3af3b46`  
		Last Modified: Thu, 01 Aug 2024 23:42:23 GMT  
		Size: 21.5 MB (21520349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1aef539ce816ba5cce86159d48d7c86a443de168e7e94faf62bec0aa05d04af9`  
		Last Modified: Thu, 01 Aug 2024 23:42:19 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75d3ae13d06dcd179d6d2e7f0d2c0954e5db071dd3bdea5667f212b1913b4761`  
		Last Modified: Thu, 01 Aug 2024 23:42:19 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:45a4ee7f108c5ae12c0aaf93f91c4819931d058d0fbf91542aff9b166600b163
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.7 MB (192665577 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56ff7c3d603318214536068d7bc3fbd8eec309f5b8cdecc31d3590201071ac50`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 07:04:14 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 09:24:15 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 09:26:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 09:26:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 09:26:05 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 09:26:19 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 09:26:19 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 09:26:20 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 09:26:20 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 09:26:20 GMT
...
-	Layers:
	...
	-	`sha256:0216962ac110ce433b66f2fa894d9e288a0b6c97520513b50a5eff76250af868`  
		...
		Size: 9.2 KB (9179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:621b7850905437ab8efa6646d2770349b3e85b6a138f891e16508ba9a20601f9`  
		Last Modified: Tue, 23 Jul 2024 09:27:11 GMT  
		Size: 3.7 MB (3682435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10b5bc46256875f1635980bde6049253056dbe4ed13903562e781a6922bed336`  
		Last Modified: Tue, 23 Jul 2024 09:27:10 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a194682aca322596db5465fdbfb74972c28bc41ce1029fd24345596de06a4258`  
		Last Modified: Tue, 23 Jul 2024 09:27:14 GMT  
		Size: 21.5 MB (21522162 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:408070bb2fbaa8fb95cf25fbd49bddadab5fb1225ba65eff92ac6f1aec6566ec`  
		Last Modified: Tue, 23 Jul 2024 09:27:10 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6d97cea6f27b78e9c8471d51a93972658eabe6342c2a3af47f4a98ac428fec6`  
		Last Modified: Tue, 23 Jul 2024 09:27:10 GMT  
		Size: 824.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:dc168e9e4c81dfbcd126fa14c59bf5fe0e13e230b61d54cdf1a5dd116a061fde
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.3 MB (197305636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58fdb9ddbb345d38cf3b76dc675059666d516ae782ad7f07b8a62fab28cec8b6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 08:23:53 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 12:05:35 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 12:07:31 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 12:07:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 12:07:31 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 12:07:49 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 12:07:49 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 12:07:50 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 12:07:50 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 12:07:50 GMT
...
-	Layers:
	...
	-	`sha256:76d966ed838ac7d4e0e341aa8842d7bc62b668e32da0e534cdb88c3443981eb1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb934b8afb6a01bedd423099f2dcd064d0902a9f3db7ea2d6998c406659a26d9`  
		Last Modified: Tue, 23 Jul 2024 12:11:30 GMT  
		Size: 3.4 MB (3387388 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d786aec66b25b76cbf98fdddd06637b91c37032ea215be8405709febbbbcc6df`  
		Last Modified: Tue, 23 Jul 2024 12:11:29 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d1231985815e0a02e82aeb7b4cfdeb8891a72b8e137965f5a471a15e038d78c`  
		Last Modified: Tue, 23 Jul 2024 12:11:34 GMT  
		Size: 21.5 MB (21521619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0043702091ae6f85333efe0bc5b799f14eac9c06c9e722eb4eabfe206dbb33a`  
		Last Modified: Tue, 23 Jul 2024 12:11:29 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44c33eb0f38414114624164c83224993b2e6d586f3777d1e46fb2e968db8859d`  
		Last Modified: Tue, 23 Jul 2024 12:11:29 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4ef6dd4e16eff2fb70cdca33d6c418b81c8ff98fdd5e22931f8fc8ba7040aeb4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.8 MB (172815409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83e91f3c902d4a42b6bed53c357b2841e1fbd0245531dfc460927d102d2db80c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 23 Jul 2024 19:32:18 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 19:37:36 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 19:37:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 19:37:47 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 19:39:03 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 19:39:10 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 19:39:15 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 19:39:21 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 19:39:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 23 Jul 2024 19:39:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4e24a1c2c23273259dd21506dddfed16592acd8528f738216c22f917f65fcfd5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8e0eb2c97b304e0c3cc921cc13cd06ff7b94fdf97e8040bcf8b6603bb237b30`  
		Last Modified: Tue, 23 Jul 2024 19:40:46 GMT  
		Size: 2.8 MB (2807257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aad9e1a5ff32ae06fd23357c1356c5f6bc3e7c41461862eb065aee90dd1d4e4a`  
		Last Modified: Tue, 23 Jul 2024 19:40:43 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e515fbc0ae6804558db01cb8233d0232042ec0436510d58ed49986cd4a56da3f`  
		Last Modified: Tue, 23 Jul 2024 19:41:00 GMT  
		Size: 21.3 MB (21315510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b990607fcfa6673faee51b43af4c27ee1037722c7f52d957f17d0b744c83830d`  
		Last Modified: Tue, 23 Jul 2024 19:40:43 GMT  
		Size: 347.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ead626f8c962095c24477188f4625820b8b37db8ddd3f97226121ad04b34a03e`  
		Last Modified: Tue, 23 Jul 2024 19:40:43 GMT  
		Size: 821.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:7f58e398f0b289c1ce5740cff9aefcc2340076531f281813a576481602176730
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.6 MB (202574826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1d44721bbd24a47c51bcac9a352a1b0492c46efb6eb558099859655c89697b9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 01 Aug 2024 21:38:44 GMT
CMD ["php-fpm"]
# Thu, 01 Aug 2024 22:56:51 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 01 Aug 2024 22:58:44 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 22:58:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 01 Aug 2024 22:58:46 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 01 Aug 2024 22:59:09 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Aug 2024 22:59:11 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 01 Aug 2024 22:59:11 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 01 Aug 2024 22:59:12 GMT
VOLUME [/var/www/html]
# Thu, 01 Aug 2024 22:59:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Aug 2024 22:59:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2ddb846146ddc6bd2c471eb085d2e21668c3be4279ddf7aeef4770fbdda1d844`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33e54d1a2acfbc27a5095bd56c25e4e39df5d64d7fdf73f9a9ef8e9d382d1f2c`  
		Last Modified: Thu, 01 Aug 2024 23:02:05 GMT  
		Size: 3.3 MB (3347717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:571d4993aee9efc63c8f310c8bdc530511824be62cb7967f6a2fff5aa4186641`  
		Last Modified: Thu, 01 Aug 2024 23:02:04 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9883d2dcbff6876bbc30c78100a4b2dd485d0893089488675d78a694d093ee61`  
		Last Modified: Thu, 01 Aug 2024 23:02:09 GMT  
		Size: 21.5 MB (21522034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:659046a7a93b146b47def765c0e9d39326a4c642989d91fac3f73481985dbf7f`  
		Last Modified: Thu, 01 Aug 2024 23:02:04 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bebd001231d7370f3a6e61df203d27ca6fecc8daf70dbed2b0d4913389227683`  
		Last Modified: Thu, 01 Aug 2024 23:02:04 GMT  
		Size: 824.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e838b0324204623db78ac9c6bb43a690d9fcd291f7d986fbe3e123d60055023e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.1 MB (172137848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:887b3f3d92a24c1a63b6493eb282203729c4f56d9132381d77399cb016c2bd83`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 05:30:37 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 08:03:28 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 08:04:38 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 08:04:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 08:04:39 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 08:05:00 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 08:05:02 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 08:05:03 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 08:05:03 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 08:05:03 GMT
...
-	Layers:
	...
	-	`sha256:b1b945a65928bca16ce0a9bcbe88df7a4b1097dbab85ecd5ddb8885b4562afe9`  
		...
		Size: 9.2 KB (9176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:370d48d343ad876d0a8ba9fa8bd1f61398365b5f2b30b957fb520aa309feff39`  
		Last Modified: Tue, 23 Jul 2024 08:05:52 GMT  
		Size: 3.0 MB (2981938 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a58cd8caec56b3795cdbc43a7a4e7f4a2306bc5a12533da918eeeab91ee38d8`  
		Last Modified: Tue, 23 Jul 2024 08:05:52 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b55b3ccfe01b4ce5111a66ecd2119e0d9ba8ed41543f84a4bade50fb6ef74f2`  
		Last Modified: Tue, 23 Jul 2024 08:05:55 GMT  
		Size: 21.5 MB (21520879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6624a225269129370fd0d787266682d0a4ea18907348eb4c25274118a306f41`  
		Last Modified: Tue, 23 Jul 2024 08:05:52 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f6954d13079d476bd13012b6e6fd764253b560fd75bbaf001842e410665d9d6e`  
		Last Modified: Tue, 23 Jul 2024 08:05:52 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
