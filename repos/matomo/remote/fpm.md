...
```console
$ docker pull matomo@sha256:1e643602ed2024f5fa2bb805c12988963305a7eb8a167195f5d6dfb19fb4d44d
```
...
```console
$ docker pull matomo@sha256:780b0d1159d6b47416279738d4d1679153e7cd37caf4a25c9b701a794d074a9a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.4 MB (198371168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dba6d92ca791493613670f51dc787d170b3936d5601f843ae50a1b8c83e559a`
...
-	Layers:
	...
	-	`sha256:e20ddfb4bc2f0b61bbb80bf361ddd902304ce49aabca69aa655edeadcdd83e7c`  
		...
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0f1097e9edbe334f9893db861839d3350eafbe019c22f7af60b1860102e341d`  
		Last Modified: Thu, 01 Feb 2024 15:33:49 GMT  
		Size: 21.2 MB (21247338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fff896bb3a50ffd56e633001408facf434501fa40d03b73dd288189ff7ce4c0`  
		Last Modified: Thu, 01 Feb 2024 15:33:45 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cade4467145cfad3dfc96fde2eb91d4ab2a4eb2d61d0634357791effd705077`  
		Last Modified: Thu, 01 Feb 2024 15:33:45 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e6c7e48021a8630a3df8cbfc77cf37cbbc83045a0e44c1a8f4b09ffa6613746c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.3 MB (172329635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8ff8da5d7069f9264cbce79da6b298c73b080315b04b29dd602563064a09f86`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 01 Feb 2024 15:14:36 GMT
ENV MATOMO_VERSION=5.0.1
# Thu, 01 Feb 2024 15:15:47 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 15:15:53 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 01 Feb 2024 15:15:58 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 01 Feb 2024 15:16:04 GMT
VOLUME [/var/www/html]
# Thu, 01 Feb 2024 15:16:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 01 Feb 2024 15:16:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ab536effdc757319e43d98e9f7eb273f0842ed32536bd4e87a29bd242ad34dd3`  
		...
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ada97f2bb17cc20aa0e3d87d6f539b98da80f0096303f8ecdd4bc2d94b1edde9`  
		Last Modified: Thu, 01 Feb 2024 15:17:38 GMT  
		Size: 21.0 MB (21038796 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:accd7f87396506d39bf488112d83ee41b455e90ab6fc471340f9f188958c6296`  
		Last Modified: Thu, 01 Feb 2024 15:17:21 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43fa2d3a48b1387b16fc5f633a8ca67fb2687f4bbefbe5044df6403afc904c1a`  
		Last Modified: Thu, 01 Feb 2024 15:17:21 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:913d61139bcd5c348feda8007b0717c75bedd513c0bb1e4f6dd72262ca48b9b2
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202325536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd0e6e21ebfeb52532e4884ec2cfbf1e8d6f5131c26b83d07db1b7a1fe3a684d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 05 Feb 2024 20:30:50 GMT
ENV MATOMO_VERSION=5.0.2
# Mon, 05 Feb 2024 20:31:21 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 05 Feb 2024 20:31:24 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 05 Feb 2024 20:31:24 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Mon, 05 Feb 2024 20:31:25 GMT
VOLUME [/var/www/html]
# Mon, 05 Feb 2024 20:31:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 05 Feb 2024 20:31:25 GMT
...
-	Layers:
	...
	-	`sha256:765574e4b461890d14df35fdb9a10941c2b4cbc9ec555f23ede5354ae08ef25b`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f61c6d690af98c43ddca8d5cecda403081a8521fe26a57315103941d2a58ff8c`  
		Last Modified: Mon, 05 Feb 2024 20:32:51 GMT  
		Size: 21.3 MB (21269039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28e16ffd8c913a7099f970aa780d28caabe65d3393553e7c058dfa2bf1125b3d`  
		Last Modified: Mon, 05 Feb 2024 20:32:46 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b2553c28830d21e87c44ee867bad95fd49c00a596e828b4a41086672c8e2875`  
		Last Modified: Mon, 05 Feb 2024 20:32:47 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4f175415e05944a71aed5b2c682bcbacc2bd38f06140b3d25bc36dc64e16df5a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171672942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b7594a1e8636ff5a18fe60b616e081a39186b01c437b13347937792b55b7ef4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 11:26:51 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 01 Feb 2024 11:26:52 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 01 Feb 2024 11:26:52 GMT
VOLUME [/var/www/html]
# Thu, 01 Feb 2024 11:26:52 GMT
...
-	Layers:
	...
	-	`sha256:3f0e5673e8614c019133e09bdbe9eae85afdb43a990c4ca254885feb439fa62a`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aecd3ec53b3537cca1aa7332465f01ce14dee5e343283ef9daa4fad79e3d34db`  
		Last Modified: Thu, 01 Feb 2024 11:30:23 GMT  
		Size: 21.2 MB (21245795 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b32496c3aae7d6adfce01a6362065863c4e90d3451a157d5447791e51800990c`  
		Last Modified: Thu, 01 Feb 2024 11:30:19 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a13bcb3a3e6f0b0a09ad6a057bce1649be40b622cb38d121a00e57c8e5c21777`  
		Last Modified: Thu, 01 Feb 2024 11:30:19 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
