...
```console
$ docker pull matomo@sha256:8796fcf31066081346a043f2fd4dcb7dae01cadeaefc62355556fe3122887e8b
```
...
```console
$ docker pull matomo@sha256:173a91bb70d5ae88a382c165fd83a28e3b725a66cc5a3124a18f3e2082deedf1
```
...
-	Image ID: `sha256:1c372e78ad503ce0170376c15d5719f19302e93fe07de95f46e5a910832874d6`
...
-	Layers:
	...
	-	`sha256:0ca655565d1d5f74ab00be622187ed601f1e1deef85cdd58e29a39a2a27429df`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c49fe41bd8120b7f9be38b3813d517e4de71a915b78f9a05d48c2f1f0e297a71`  
		Last Modified: Sat, 13 Mar 2021 17:03:33 GMT  
		Size: 3.5 MB (3510339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6757c4cbc4a95e55500b6d0d33790bd0c41b5a67a537e09f02858ed0d1730915`  
		Last Modified: Sat, 13 Mar 2021 17:03:33 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:618ff2429c2e8d807ca77aaec9dabd2d4442a1918db54fcf9efcc6e300739982`  
		Last Modified: Sat, 13 Mar 2021 17:03:36 GMT  
		Size: 15.0 MB (15004990 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0299bc673f91dac009931cc8f6d5cc1838149b92c1ed932135e84c2131cc3762`  
		Last Modified: Sat, 13 Mar 2021 17:03:33 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1050b5ad78cc6f8bb2092f394698074b11aaddb81cdd6f76afd3ec865ef9d951`  
		Last Modified: Sat, 13 Mar 2021 17:03:32 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:9bf5f0f869d220ff69c4fcf72984416ad86c05b0b14788f99db11d1f08f0e573
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.7 MB (153681704 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:967bf9224d9c4906cd0e91792ed0da241480270781eebe1cd1c38e5088ce548b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Sat, 13 Mar 2021 03:52:07 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 03:52:10 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 03:52:11 GMT
ENV MATOMO_VERSION=4.2.1
# Sat, 13 Mar 2021 03:52:32 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 03:52:34 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 13 Mar 2021 03:52:35 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Sat, 13 Mar 2021 03:52:36 GMT
VOLUME [/var/www/html]
# Sat, 13 Mar 2021 03:52:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Mar 2021 03:52:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3d69d5dd41b28ffcd9856e4889389d932a8487ed6a70d010e9427eac79012528`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab1e0f3b6f8d0230103ea53d82bccddd6cfafb97a47dc9daea77f7bed2cad052`  
		Last Modified: Sat, 13 Mar 2021 03:53:33 GMT  
		Size: 3.5 MB (3463320 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b7eb686443438aa06da03bdb7e62ed0be895d2b161de622646568be50448210`  
		Last Modified: Sat, 13 Mar 2021 03:53:32 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1597cd52da3c86f641db0013fe75464bd22506ce969bb96f457d37d305d13b4f`  
		Last Modified: Sat, 13 Mar 2021 03:53:38 GMT  
		Size: 15.0 MB (15004211 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:687532b91ca894b4dc29fb0392de9a2ff8e1a8426229d35ac5211e28f99b5b76`  
		Last Modified: Sat, 13 Mar 2021 03:53:32 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa0eba5f232ecff96d14f2c399c82c82464727f139ffdf07923a2fd95b852b10`  
		Last Modified: Sat, 13 Mar 2021 03:53:33 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4b0e4e2b79773b913703d3ad44269e0fc9837180776152d426354c2d828ccd28
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167347651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:488798c6fb32cbb1fad41b9627267ebda2ad46f21955e6ee14df776d4c74f07f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Sat, 13 Mar 2021 02:49:10 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 02:49:11 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 02:49:11 GMT
ENV MATOMO_VERSION=4.2.1
# Sat, 13 Mar 2021 02:49:27 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 02:49:27 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 13 Mar 2021 02:49:28 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Sat, 13 Mar 2021 02:49:28 GMT
VOLUME [/var/www/html]
# Sat, 13 Mar 2021 02:49:28 GMT
...
-	Layers:
	...
	-	`sha256:6b8da33fc825ad5beb78abeb9437499aec8e8456a2bc11660814596fc6d1982d`  
		...
		Size: 8.4 KB (8447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c08ee31b983d1e23500d0a9fde0b19239fe4c5c1b8c9f366e93f8a78f0a7e6d8`  
		Last Modified: Sat, 13 Mar 2021 02:51:38 GMT  
		Size: 3.5 MB (3530817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1c23ceb61e4d566758cf193d6fc708bddc6a099226d9eeeeb7d518451c135b1`  
		Last Modified: Sat, 13 Mar 2021 02:51:38 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2118cbd4308b2d34d6634af3c05dd052d9769cb0af1d2678ae1f659303ac3429`  
		Last Modified: Sat, 13 Mar 2021 02:51:44 GMT  
		Size: 15.0 MB (15004460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45020227a59f9a9ff1bf7f3f38caa06fbf06e0e6a2a8d034292f9892c3ba14c9`  
		Last Modified: Sat, 13 Mar 2021 02:51:37 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1179c82977699d8916db939aa251dcc970e8552069299ee6ff61bb12e259a7c`  
		Last Modified: Sat, 13 Mar 2021 02:51:37 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:9b3b3659965bedf4412ed534357ee1385d8e5c489060a39d8bd4149192b4bfa3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172506944 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b09103b591f3d7e699423a06756d967d3f359b40183b3e2bccaf03c5f2f775f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Sat, 13 Mar 2021 08:04:36 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 08:04:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 13 Mar 2021 08:05:00 GMT
ENV MATOMO_VERSION=4.2.1
# Sat, 13 Mar 2021 08:07:14 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 13 Mar 2021 08:07:23 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 13 Mar 2021 08:07:26 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Sat, 13 Mar 2021 08:07:31 GMT
VOLUME [/var/www/html]
# Sat, 13 Mar 2021 08:07:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Mar 2021 08:07:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4a20c1177c205774246126185500b369f4f1fd4646fe7d1cb59fb9e733bd61d9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88750b18199dcf0d13e0452fd0cb5048151f68d8d05ad11359f8cd4235638ab0`  
		Last Modified: Sat, 13 Mar 2021 08:09:04 GMT  
		Size: 3.8 MB (3757473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f2d4b6b01c5c1c95301b58d295d9644afe4e0d29adf9e3b8dbcf9ee8daf5769`  
		Last Modified: Sat, 13 Mar 2021 08:09:03 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:471d5bf2614db9dc7b94b58d14d2d1b1e0bb3e25faa465e852bfe6945d55886b`  
		Last Modified: Sat, 13 Mar 2021 08:09:07 GMT  
		Size: 15.0 MB (15005515 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a26a13fcac217fe00fd01dd1e0fe59a22c9841ef5df4fe13a0d16eeec0511422`  
		Last Modified: Sat, 13 Mar 2021 08:09:03 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aec68107ebc1bff83a5d74a9904add5ddda7f1290de2bd66c5177ce256c3140`  
		Last Modified: Sat, 13 Mar 2021 08:09:03 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
