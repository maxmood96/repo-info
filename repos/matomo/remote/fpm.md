...
```console
$ docker pull matomo@sha256:e7bbe925d3dfcec8f72c5683c6f007a4ac81569c5166ad3b570c848c50f0a2cf
```
...
```console
$ docker pull matomo@sha256:7ce3b7bcff361657183ec41637b220fa62f46e572da3f9c4138818f3195b7b4d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.8 MB (225767805 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d5946c648a10e716c8f0bcecbc0e0d92a961573dad9d4d500f63a0e96022359`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 16 Jun 2026 02:30:57 GMT
ENV MATOMO_VERSION=5.11.1
# Tue, 16 Jun 2026 02:32:19 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	apt-get dist-clean # buildkit
# Tue, 16 Jun 2026 02:32:20 GMT
COPY php.ini /usr/local/etc/php/conf.d/php-matomo.ini # buildkit
# Tue, 16 Jun 2026 02:32:20 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Tue, 16 Jun 2026 02:32:20 GMT
...
-	Layers:
	...
	-	`sha256:ac557c3cf8d23eaf2622d7cfe687e6ba17addb8131feaf8b334e91855ed5108d`  
		...
		Size: 9.3 KB (9268 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4ccac269b3b95961d8b515f6466ab6955529317e58045e5a107cddc6dd22447a`  
		Last Modified: Tue, 16 Jun 2026 02:33:36 GMT  
		Size: 2.6 MB (2590949 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:98c360fa0131f22e4c25e118cfa10ed99b457f82dc95bf483e7735a0485c5fed`  
		Last Modified: Tue, 16 Jun 2026 02:33:35 GMT  
		Size: 328.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b9b14d988516742938cf9a5003ad72969ac3be615c61d0f9848beb89e6269935`  
		Last Modified: Tue, 16 Jun 2026 02:33:39 GMT  
		Size: 21.1 MB (21142639 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ff25912778d43eacce958bdd6a0cc73be283918f94d383cf81f0b1ddab4ce320`  
		Last Modified: Tue, 16 Jun 2026 02:33:35 GMT  
		Size: 345.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:dd8a016a613f59dfa85c1624e9a7d7fac04a41ad577bd217f456ccf9192d6f51`  
		Last Modified: Tue, 16 Jun 2026 02:33:36 GMT  
		Size: 823.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull matomo@sha256:d250491cc1e5174b0ee9216d0adf72909f3c52201eb5c14858a5cb5e0ab3500b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.3 KB (33301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68591d13240c1fbbad6bf5af2431d6564b60498c63b22547836650e2e1c4e2fe`

```dockerfile
```

-	Layers:
	-	`sha256:c874c6844c694236346deda129f0da47a53319641acc5d76a075b9725cd3d210`  
		Last Modified: Tue, 16 Jun 2026 02:33:35 GMT  
		Size: 33.3 KB (33301 bytes)  
		MIME: application/vnd.in-toto+json
