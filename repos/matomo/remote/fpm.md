...
```console
$ docker pull matomo@sha256:790b377b783fb64a6e986d0c0b95d842bee9c510e8af77fcffacc9e84881c5a7
```
...
```console
$ docker pull matomo@sha256:64d0d240802b41d06fc71a17a404f915218569f669d8427b5d9eb4ab4ee82ca2
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.8 MB (161796526 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b38158c6b5499d22d4cfc3eecc5a2ee6785c48fdd0994fa3bb95e3166dbbff31`
...
# Mon, 02 Aug 2021 21:20:30 GMT
ENV MATOMO_VERSION=4.4.1
# Mon, 02 Aug 2021 21:20:43 GMT
...
-	Layers:
	...
	-	`sha256:5178ef2f0638144cb525bcf27030136680949a3beaf75e59efcf6ad84a52df75`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35f69bf4c1af3c57758c9f29e9a66982b1a635bbfc213d40b982f9c359d4f667`  
		Last Modified: Mon, 02 Aug 2021 21:22:00 GMT  
		Size: 15.6 MB (15550127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:678538bfc61b27a3467a64c0f70a15ae5b40dffad6f0399f953df3b7153c3725`  
		Last Modified: Mon, 02 Aug 2021 21:21:57 GMT  
		Size: 305.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59cfe4c2674729f41eacaebddb8ad8b6dfe1ebed90dc61d270f322839bba1208`  
		Last Modified: Mon, 02 Aug 2021 21:21:57 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:2fc13351d1aedd99fc44d904f42747ee9abdd6d3ca1870f24cc44d5ae6a9c013
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140098114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b6a80d16fada72432d284fc417736fab031d83f137109ad66850cfa414ef8e4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 02 Aug 2021 22:17:51 GMT
ENV MATOMO_VERSION=4.4.1
# Mon, 02 Aug 2021 22:18:25 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 02 Aug 2021 22:18:26 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 02 Aug 2021 22:18:27 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 02 Aug 2021 22:18:27 GMT
VOLUME [/var/www/html]
# Mon, 02 Aug 2021 22:18:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 02 Aug 2021 22:18:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d63a03e0969da321072a39f4ee498c3737477fea4e697dcc179d070605a5f0af`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87296b8bb23e57694149828ee074cf411b582ab9a26c9b5aab2cd41e099ead46`  
		Last Modified: Mon, 02 Aug 2021 22:20:46 GMT  
		Size: 15.5 MB (15548555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fea28d4f1146f094571c7f2ecbaf14e75b602c82fb23378e025933459c6d637b`  
		Last Modified: Mon, 02 Aug 2021 22:20:31 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d596e094f2627319de065125c80f606d48bcf7a4ded8028b63bf396de28d7360`  
		Last Modified: Mon, 02 Aug 2021 22:20:32 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:44338b26838e75c2862c94a955481966fa0be51ac7ce850afaefa3b23284f196
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.0 MB (153957230 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf078cd7312d05c891d127e5c017c58cc80f96fbcb24582e8e218eae9eeb3582`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 02 Aug 2021 21:40:05 GMT
ENV MATOMO_VERSION=4.4.1
# Mon, 02 Aug 2021 21:40:19 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 02 Aug 2021 21:40:19 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 02 Aug 2021 21:40:20 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 02 Aug 2021 21:40:20 GMT
VOLUME [/var/www/html]
# Mon, 02 Aug 2021 21:40:20 GMT
...
-	Layers:
	...
	-	`sha256:35680f3da52beda45323aeaaa594b33d7dbacffd5877e6139ab4c89e46e3f8a4`  
		...
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fc3a007b0c6e75eef8ced8ee745e370443479fa75c3622955adb33d8c26aaef`  
		Last Modified: Mon, 02 Aug 2021 21:42:00 GMT  
		Size: 15.5 MB (15549092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f952e9c5ca9c4ebc98916c879fb0515cd78ef822a0455e6460854f94a05669e5`  
		Last Modified: Mon, 02 Aug 2021 21:41:57 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc24a8befa48ba72c6c774a80c594587cad5148fd5e89f8cead157764675d7b5`  
		Last Modified: Mon, 02 Aug 2021 21:41:57 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f939e34e295aeee5b66748fef98257751dcadf4d1cfdf84de323625e573da7dc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.6 MB (167601525 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a92d390dbc472a20ec3328f4ced8d305efe2a1b86611310db1ea35c0a18afbdf`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 02 Aug 2021 21:39:21 GMT
ENV MATOMO_VERSION=4.4.1
# Mon, 02 Aug 2021 21:39:39 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 02 Aug 2021 21:39:40 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 02 Aug 2021 21:39:40 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 02 Aug 2021 21:39:40 GMT
...
-	Layers:
	...
	-	`sha256:9c2f29b5344242a77daaaecfe4cfa8ce5d25990bace45da3e48390a0858f2b77`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b88dc88991adcfb6fe71e0dc038d43fadd3a72c63f6584d2f9dd6d102b193e68`  
		Last Modified: Mon, 02 Aug 2021 21:41:26 GMT  
		Size: 15.5 MB (15549540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20e8df91eb08b6cff1c025c34f99bee3a79f449b36b76c5bd194f17c5bbb7aff`  
		Last Modified: Mon, 02 Aug 2021 21:41:23 GMT  
		Size: 304.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:826669f9ae4adb81adea1a5dbf9be9118a168394b86f6fc740a41f28ce613b41`  
		Last Modified: Mon, 02 Aug 2021 21:41:22 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:a71faa70443bd8e5f7e32fa43bc77dea1270ac92fcee09dc541ea1fd9c75276e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.5 MB (147504894 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:454353b349717bf47484fc2ef83ef21b9a168153a11f569a8d684b1f7567032b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 02 Aug 2021 21:42:20 GMT
ENV MATOMO_VERSION=4.4.1
# Mon, 02 Aug 2021 21:42:45 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 02 Aug 2021 21:42:50 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 02 Aug 2021 21:42:51 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 02 Aug 2021 21:42:51 GMT
VOLUME [/var/www/html]
# Mon, 02 Aug 2021 21:42:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 02 Aug 2021 21:42:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0ba45f0811b4367cee540963ef3008319b54bd07ea100451eca61102f2eed515`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ecd16e8def63e9a0d4f283b6503cea10167fa0cc2c04290faebde83792e1e90b`  
		Last Modified: Mon, 02 Aug 2021 21:44:50 GMT  
		Size: 15.5 MB (15548897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c9394ec7ed6c0f9038cd3b1c407e02a604d1983342df64e0794c862ebcecf38`  
		Last Modified: Mon, 02 Aug 2021 21:44:47 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce11c07e462b3cc0e62183aae66f470b759780819301dcc239536107c38e3d12`  
		Last Modified: Mon, 02 Aug 2021 21:44:47 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
