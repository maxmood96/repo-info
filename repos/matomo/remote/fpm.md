...
```console
$ docker pull matomo@sha256:5e64197bcdde715dbbf9985167a9191ce4281ac94d0d0992be374a4997f1e0bb
```
...
```console
$ docker pull matomo@sha256:cb1837d077612865bba9c9a1a9f95ad575602d0f2b938aa44760fbb80c8ebd8e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.2 MB (182165375 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fcfe703d2fc085ba7eb64f8fbc0fd3eba0801ba4e14949d81edc7aeceefc68a`
...
# Tue, 13 Jun 2023 11:52:28 GMT
CMD ["php-fpm"]
# Tue, 13 Jun 2023 21:24:11 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 13 Jun 2023 21:24:12 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 13 Jun 2023 21:25:39 GMT
...
-	Layers:
	...
	-	`sha256:a19898b61118835ab383d3767498bb7a1829400cbf73bccf7be074e9f4cf334e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bbee3a07428996f13cd42a35443685d81584ad2a53ba51c20739a0c2e354f0c`  
		Last Modified: Tue, 13 Jun 2023 21:26:48 GMT  
		Size: 3.2 MB (3189457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1a04fbe3f2cdc94cb29defb51f63574103790e9cbf7df91d77e980ed6fae681`  
		Last Modified: Tue, 13 Jun 2023 21:26:47 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56eff14debacc938ad72ad48f58cc25413ba2d4ad04f8ca3883f7a2b6765d8f6`  
		Last Modified: Tue, 13 Jun 2023 21:26:50 GMT  
		Size: 17.5 MB (17547156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca404c6576b46377e5b53b73f47e143214667fb43f2cfb84a1eeca2ac2da7580`  
		Last Modified: Tue, 13 Jun 2023 21:26:47 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e55d4020dc2c79863f8910d2700436b9ff1162713ebd6d0660b411e0079312`  
		Last Modified: Tue, 13 Jun 2023 21:26:47 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:5b4cbfb96d06555551ea87800325c5b8313ce8a520cbd5e90d79bcbb143d02d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.7 MB (184694952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c35563abd2117072f845057736cdca33c1db4a496378de31f4aa63450824de83`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 12:04:29 GMT
CMD ["php-fpm"]
# Tue, 13 Jun 2023 23:38:15 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 13 Jun 2023 23:38:15 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 13 Jun 2023 23:39:57 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Jun 2023 23:39:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Jun 2023 23:39:58 GMT
ENV MATOMO_VERSION=4.14.2
...
-	Layers:
	...
	-	`sha256:4c33aa64bb072f88789b9d11d78c99227f771889ecfe66c0d6357f2967038f5d`  
		...
		Size: 8.9 KB (8879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b76fc8bd41c7abb81926690931da901554bf488eb843b625a1762f65a018b52b`  
		Last Modified: Tue, 13 Jun 2023 23:41:11 GMT  
		Size: 3.2 MB (3177231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57a8c71af64ac56325149d84749b20968cc7559feb1afdc2119513579caef6cc`  
		Last Modified: Tue, 13 Jun 2023 23:41:10 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a84356d640fea6f3fec6896e38af2bd20cc0b2ca0e42212a002055453bf5fa6b`  
		Last Modified: Tue, 13 Jun 2023 23:41:15 GMT  
		Size: 17.5 MB (17546257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17468839c22e34c13233c0802182bcb14f69cf3dedd4525fc8a5b99c6c76478d`  
		Last Modified: Tue, 13 Jun 2023 23:41:10 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1491526c896e72a4ece7ceed4a2a2f60a849175c3f10b2e1cd4a71a976b43611`  
		Last Modified: Tue, 13 Jun 2023 23:41:10 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:b806130406c3a0aeafb8c92d3191ab394ac1d1317ed534450f92a266e7482163
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.9 MB (181941935 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33eac89e455f77b0d54a9592b4ae4e8b5b0318135e6cd84adb8e2cb40b55fba0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Jun 2023 10:37:45 GMT
CMD ["php-fpm"]
# Wed, 14 Jun 2023 01:27:50 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 14 Jun 2023 01:27:50 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 14 Jun 2023 01:29:56 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 01:29:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 14 Jun 2023 01:29:58 GMT
ENV MATOMO_VERSION=4.14.2
# Wed, 14 Jun 2023 01:40:34 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 01:40:37 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 14 Jun 2023 01:40:37 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Wed, 14 Jun 2023 01:40:37 GMT
...
-	Layers:
	...
	-	`sha256:b9322e536da432f120a5f81bdfd9bccbf39b31df469e3621487fea796110a8d9`  
		...
		Size: 8.9 KB (8878 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8545dae1a93e088baf43b01d5a3e24b66ba3c95251a5d4c0fe443b5eb97a00c`  
		Last Modified: Wed, 14 Jun 2023 01:41:43 GMT  
		Size: 3.1 MB (3064821 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98c3656d0ba34c329a65f14ad9425905cd0f5abc11c9a418dce7f045f73a7968`  
		Last Modified: Wed, 14 Jun 2023 01:41:42 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:114173a3a3a364ea90c78ea719a99848055a778d548e5791ec6b33340df359bd`  
		Last Modified: Wed, 14 Jun 2023 01:41:48 GMT  
		Size: 17.5 MB (17547053 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:098217146df78a4883af922a8c2dd929fc345c4a89435a70a51a3c852e5eff3f`  
		Last Modified: Wed, 14 Jun 2023 01:41:42 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fedc12d51c23669b143c6ec6ac8d564000a9ad30436024951c23b6264a6df95e`  
		Last Modified: Wed, 14 Jun 2023 01:41:42 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
