...
```console
$ docker pull matomo@sha256:b224af85126c0de1dd040cde9a29c9505a235c4af32464be7520ce2218f1d247
```
...
```console
$ docker pull matomo@sha256:11140c1d0ce39b931fe84885f74a37537736e8ce9cc777dbda5f4bdc9cfbb773
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.4 MB (198376908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33c6ea38acf880a26048b17a19a3c3974ed3dad502d8f312fdb3e657e02b6d91`
...
-	Layers:
	...
	-	`sha256:8695a429c11332e5ba26147662c6ab9203f1bd2714a52e1ba1725aa2c31d660e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45d6ff42bdf7d22f81f297c3a6ade4fcfcc6fa99be82f1b94a250106ea213fa1`  
		Last Modified: Tue, 12 Mar 2024 14:36:16 GMT  
		Size: 3.4 MB (3438327 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d005c40c10a3bd69468032a431009556e966184ae7795f5a723e7c7023a9b615`  
		Last Modified: Tue, 12 Mar 2024 14:36:16 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d174e7934fdd677d9baba6172ccadabc0040266c93ad12e8c5446e916e5218a2`  
		Last Modified: Tue, 12 Mar 2024 14:36:19 GMT  
		Size: 21.3 MB (21270717 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9193350a1b72d185fc7965fbfab4997e15e86574efc5c6611a32eb06bc7eb987`  
		Last Modified: Tue, 12 Mar 2024 14:36:15 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a1425464e13a5004e51fa65bd34b2be180e27afe7ca38ee432645e16d1ad840`  
		Last Modified: Tue, 12 Mar 2024 14:36:15 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e824c1fc8225334fe1fb18b8eef6cedd365b27372ee9967dbd23c4adb6b67969
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.0 MB (197028232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dccd285dcc381ae4d0bbd7a55c74755a8c9c5ab8e2ec18b1bcae46089e1606cb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV PHP_MEMORY_LIMIT=256M
# Tue, 12 Mar 2024 15:33:04 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 15:33:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 15:33:05 GMT
ENV MATOMO_VERSION=5.0.3
# Tue, 12 Mar 2024 15:33:23 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 15:33:24 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 12 Mar 2024 15:33:24 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 12 Mar 2024 15:33:24 GMT
...
-	Layers:
	...
	-	`sha256:97cc35e67f17a0b472ff39c94114a980588db98efea00509977b20ed64466cf2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03e217de5f124f25ce24fa01d3d7938a39c728ccb3d496a5d1faa15b7df70ad1`  
		Last Modified: Tue, 12 Mar 2024 15:34:15 GMT  
		Size: 3.4 MB (3389537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a12234250b5fabb51412f4525eebbad20095740d8b4479db208028882e13f40`  
		Last Modified: Tue, 12 Mar 2024 15:34:14 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21c6ae9f6f9d8ce57e8083e438357dd667a1278e79ad9dea3e96e05ecf7db87a`  
		Last Modified: Tue, 12 Mar 2024 15:34:20 GMT  
		Size: 21.3 MB (21269880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cd13e8cf5c95451eb9f8f90c03061479406f532ce4e8d3b25d6e210dd2e9f42`  
		Last Modified: Tue, 12 Mar 2024 15:34:15 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9e5d99549fa12165725aace502719742e6e9278423f57fc4bec42007263ddc7`  
		Last Modified: Tue, 12 Mar 2024 15:34:14 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:470c512679f0fc5cc586cb15edb6573d8424169de9fabd9cd99041082457ee1a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.5 MB (172532551 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:851cabaebf128befb916dfeb6d149bde950fe734b14ac68212587ac4a6035759`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 12 Mar 2024 20:30:38 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 12 Mar 2024 20:35:53 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 20:35:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 20:36:03 GMT
ENV MATOMO_VERSION=5.0.3
# Tue, 12 Mar 2024 20:37:09 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 20:37:16 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 12 Mar 2024 20:37:20 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 12 Mar 2024 20:37:26 GMT
VOLUME [/var/www/html]
# Tue, 12 Mar 2024 20:37:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Mar 2024 20:37:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:56d1babca955250fe042b8b48604dce3974a2d9c9d6ca5e7ceadedbdc43ca7b3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eda8ebd7a71c5be835fd3097e896dea2caec8956bce8a45599de19b13d860801`  
		Last Modified: Tue, 12 Mar 2024 20:38:55 GMT  
		Size: 2.8 MB (2808074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c06d4ca6d2abbec310f2ad1bf47621656952561aab13c10691a56cd49ed7bdbe`  
		Last Modified: Tue, 12 Mar 2024 20:38:52 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9785e3228b72e00bd49c8a072bb55df277746a4c5bd93a7044b227092bab111`  
		Last Modified: Tue, 12 Mar 2024 20:39:09 GMT  
		Size: 21.1 MB (21064154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97ccc9a0e098fe4e5fef1f5575578a12d3ff014d40c2e980761c1763c1782a0b`  
		Last Modified: Tue, 12 Mar 2024 20:38:52 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb891a5ed8a80d76e94a587c19756123d054db0d3c0e04473370eb932742d5ef`  
		Last Modified: Tue, 12 Mar 2024 20:38:52 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:86afa9fc5e17bf888cc24293713553c9fa7b3ae151ad34ff8d5d7c0eb58c778f
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202301350 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:042e73f5c566e6138f2a093eedf8790adf9a6b461089aba7ee43581634ab1c12`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 12 Mar 2024 17:53:57 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 12 Mar 2024 17:55:49 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 17:55:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 17:55:52 GMT
ENV MATOMO_VERSION=5.0.3
# Tue, 12 Mar 2024 17:56:20 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 17:56:22 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 12 Mar 2024 17:56:23 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 12 Mar 2024 17:56:23 GMT
VOLUME [/var/www/html]
# Tue, 12 Mar 2024 17:56:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Mar 2024 17:56:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d74242227d50dc3bb2ea035b2bf057c3e082962e0df09ac09a1798b8206c9927`  
		...
		Size: 9.2 KB (9183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39e1432f785da0ce48637f4b6dee21d7f9af07cbc5e63ef469217e2ceb3d3d23`  
		Last Modified: Tue, 12 Mar 2024 17:57:25 GMT  
		Size: 3.4 MB (3351568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5565476cf5e64a5b6a5d48a8994b1c395cf04121809b2cd2a457c98bbd9c9285`  
		Last Modified: Tue, 12 Mar 2024 17:57:24 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9839efbc6c7880290b15fadd3a7fead4ac293f7333551eb8b89ca88225fd56d3`  
		Last Modified: Tue, 12 Mar 2024 17:57:29 GMT  
		Size: 21.3 MB (21271134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d54c1eef82944fb51f7102701e960962074f96e002a8bdc925181109bc2a8693`  
		Last Modified: Tue, 12 Mar 2024 17:57:24 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9d8203db017ecb6c4489f0bc480d0b57bf542064f4aa78a6081cfc845ec5fdb`  
		Last Modified: Tue, 12 Mar 2024 17:57:24 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e1ef228442d63730882c09ad64864f36ae3aa799afcd3c69931d4596e54160e3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.7 MB (171668719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:082f8a348499d4c96d74419a955576ccd5ee22111bc93d8d96174ae07ade2205`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 12 Mar 2024 10:10:14 GMT
CMD ["php-fpm"]
# Tue, 12 Mar 2024 16:42:10 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 12 Mar 2024 16:43:32 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 16:43:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 16:43:33 GMT
ENV MATOMO_VERSION=5.0.3
# Tue, 12 Mar 2024 16:43:56 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 16:44:02 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 12 Mar 2024 16:44:03 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 12 Mar 2024 16:44:03 GMT
VOLUME [/var/www/html]
# Tue, 12 Mar 2024 16:44:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Mar 2024 16:44:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:44dd7699b227ccd5c5c582dbca9b1b43f648dba14c4bbd20c39c07f148ca2e7c`  
		...
		Size: 9.2 KB (9184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49cbfcdcd3e9f6ead2f8b98c3f6ca39d648b170fdf25da2bbe6f7b73a1ceede5`  
		Last Modified: Tue, 12 Mar 2024 16:47:26 GMT  
		Size: 3.0 MB (2983806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:130ca822504632107ed12b7afc5a97c692326d386a7ee8caf21ef75db7436370`  
		Last Modified: Tue, 12 Mar 2024 16:47:25 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18adba665923cddcc65c612fc3ebee0a458d6d0cf59ab928fa7de7412f4ae2c3`  
		Last Modified: Tue, 12 Mar 2024 16:47:29 GMT  
		Size: 21.3 MB (21269457 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:415fe775025a783b73768ab34d09aa186150e57daa3d6d147a06944df182d826`  
		Last Modified: Tue, 12 Mar 2024 16:47:25 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0177b33ef7e73e5358ef87897402aaaafec43a720dec6f360bb6f18fa505c79`  
		Last Modified: Tue, 12 Mar 2024 16:47:25 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
