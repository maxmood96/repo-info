...
```console
$ docker pull matomo@sha256:05548ecffd457037a339da0b14d76d76d334c22a1b18949cda2230b04f82d558
```
...
```console
$ docker pull matomo@sha256:3791d1aa4d5d46f014f441ddced70e1d219d7558ec8bb6b1115ec2b859834106
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161391579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d442ba930b3e8daf5d5d3790ecb8a037a65fc07dc83cb421de1207c5db5e4bcc`
...
CMD ["php-fpm"]
# Thu, 21 Jan 2021 23:28:31 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 21 Jan 2021 23:30:04 GMT
...
-	Layers:
	...
	-	`sha256:a67418864aeddb07eb04ac2d3594622f5740b0ed8f60805aeb439ead00cdc0aa`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdf0b22243cf5b9e6c2717f25d2df8a5ede179025ca14f6446810f04606a5b4a`  
		Last Modified: Thu, 21 Jan 2021 23:33:36 GMT  
		Size: 3.5 MB (3509983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:512601ec46a591b70226eb837033b4dc21bac2a8db898703ae5bd2683a7a0cf1`  
		Last Modified: Thu, 21 Jan 2021 23:33:34 GMT  
		Size: 332.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9495282198a5198df7a93fa76d4cdda5a7c232458ac3aaa5c53f4491a780411`  
		Last Modified: Thu, 21 Jan 2021 23:33:38 GMT  
		Size: 14.9 MB (14904386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2325980ebd9945efa7065f2ba1b6a823ccc5f38fe9cacb7d10f1022e6979604a`  
		Last Modified: Thu, 21 Jan 2021 23:33:35 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19d26405955eb9893fbd98cead00a33f417505ef6e269007c242be7628c73aec`  
		Last Modified: Thu, 21 Jan 2021 23:33:34 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e02080eda8f6fe6a3d26ab91c6c5fe2b185ee3de8232447875e3f41180080f00
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.9 MB (139896093 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e3e658917dc7b64ed8e84e4e607226814d04722d062cb532096604a476992de`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 04 Feb 2021 19:10:14 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 04 Feb 2021 19:12:50 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 04 Feb 2021 19:12:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 04 Feb 2021 19:12:53 GMT
ENV MATOMO_VERSION=4.1.1
# Thu, 04 Feb 2021 19:13:34 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 04 Feb 2021 19:13:36 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 04 Feb 2021 19:13:36 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 04 Feb 2021 19:13:40 GMT
VOLUME [/var/www/html]
# Thu, 04 Feb 2021 19:13:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 04 Feb 2021 19:13:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:70cec4e2fd65b20e3c0edd301e3355959e6185fb24e5038555242cf0a7330050`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:240f4530f913c26f52a362df896b4577fbcda72290069dc1c6ff521dc4e97667`  
		Last Modified: Thu, 04 Feb 2021 19:14:47 GMT  
		Size: 3.5 MB (3490844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6ebfda244370a0f71b252de8639195681d73fc15536488278e969a9d8ceec80`  
		Last Modified: Thu, 04 Feb 2021 19:14:46 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05eedfc966a9a842035eaf2e728412f0171c5d52e151de0aa320557eed4c520c`  
		Last Modified: Thu, 04 Feb 2021 19:14:53 GMT  
		Size: 14.9 MB (14902766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f41d1fc3b23309ca2fa964ea0701e976819b59e1ae4334afbd3ebe9154403e8`  
		Last Modified: Thu, 04 Feb 2021 19:14:46 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed7f97c1d5950edfcce0e2ef6474c746cbc2fb5cf132a41a4d8cc4d37339cb30`  
		Last Modified: Thu, 04 Feb 2021 19:14:45 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f89cd2b9cfbbeace8ac53723a3133a713a6b4d5514079be7dec2d9dcdca5585c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.2 MB (137164156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12a980a0229d522b19b0425da14463b74fb161a0f9368a614d569acdf56d7d5a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Jan 2021 19:11:59 GMT
CMD ["php-fpm"]
# Fri, 22 Jan 2021 00:16:48 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 22 Jan 2021 00:18:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 00:18:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 22 Jan 2021 00:18:46 GMT
ENV MATOMO_VERSION=4.1.1
# Fri, 22 Jan 2021 00:19:16 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 00:19:18 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 22 Jan 2021 00:19:19 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Fri, 22 Jan 2021 00:19:20 GMT
VOLUME [/var/www/html]
...
-	Layers:
	...
	-	`sha256:8f26cca87ae2c8ed67cc9c730c6beae55ebd987fbb4bf5de390a1c42b58094ce`  
		...
		Size: 8.5 KB (8455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5356d8a5dbd8dfb9c6706c50613f6017eb319fafccdab16cbc3ca6b5b7c12cf`  
		Last Modified: Fri, 22 Jan 2021 00:23:37 GMT  
		Size: 3.2 MB (3190765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a03770d71fe656919b771fa75748a89fb89f2d6ce326a1b06341573186793629`  
		Last Modified: Fri, 22 Jan 2021 00:23:34 GMT  
		Size: 333.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed95545b2fbf1bd88d266e97bf75f12b5ddd55aee4d3ffb9b302ce28989d30e8`  
		Last Modified: Fri, 22 Jan 2021 00:23:42 GMT  
		Size: 14.9 MB (14902453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb7eec3d1af9243fe4aa6730a377bd6811be762c68c8a225343b0e8f2904660b`  
		Last Modified: Fri, 22 Jan 2021 00:23:37 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88be734e312c5ed0dd44d81ee6d47bf84a35eee0972f36a36a0a508df0914e70`  
		Last Modified: Fri, 22 Jan 2021 00:23:34 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:a56622c8e1bdd1dc49eede8348cd369d13b28cb18d05f855e3620434d7f435a8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.6 MB (153556501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:95eea9877708b1317a3fac7af932575dd2d1a360249f91904fca4bb75e30a372`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 21 Jan 2021 23:38:28 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 21 Jan 2021 23:40:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:40:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Jan 2021 23:40:43 GMT
ENV MATOMO_VERSION=4.1.1
# Thu, 21 Jan 2021 23:41:15 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:41:16 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 21 Jan 2021 23:41:17 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 21 Jan 2021 23:41:18 GMT
VOLUME [/var/www/html]
# Thu, 21 Jan 2021 23:41:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Jan 2021 23:41:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5b7186392bd3a41777f09888e10472aea62132612e45b24af1b610cb7df90a60`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8b09f7688d853656055436c948421effa23bfa90e3ff9ba5b7bb0f5a27ea62a`  
		Last Modified: Thu, 21 Jan 2021 23:45:41 GMT  
		Size: 3.5 MB (3463097 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7554abf1a0b01e8960b05203f8dc57fb6e511f4010b826810fadb520cc6344c4`  
		Last Modified: Thu, 21 Jan 2021 23:45:40 GMT  
		Size: 334.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:217162ab11889e89753e9507371627d5e1af5f18a27fae5a77b0c742e0ebc7b8`  
		Last Modified: Thu, 21 Jan 2021 23:45:46 GMT  
		Size: 14.9 MB (14903308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80b365ef145181a2c3d47d223342bc0b4bcd21c9ed52beaa8056f5ff5cce9e33`  
		Last Modified: Thu, 21 Jan 2021 23:45:40 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:533a7c52bd8e7a733051714ce609a0d4013d17f84480359fcf28b65562fade73`  
		Last Modified: Thu, 21 Jan 2021 23:45:40 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:690de0ca46ecab78fa341969ca1065da9685e4cfbfa12ee176c44c73af9b0f11
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.4 MB (172360020 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3dbaf18271535841d1cf4addb088cca4895278bf38ef51138ff2d6bc3ae13456`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 22 Jan 2021 01:44:29 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 22 Jan 2021 01:46:37 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 01:46:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 22 Jan 2021 01:46:49 GMT
ENV MATOMO_VERSION=4.1.1
# Fri, 22 Jan 2021 01:47:49 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 01:47:53 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 22 Jan 2021 01:47:54 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Fri, 22 Jan 2021 01:47:57 GMT
VOLUME [/var/www/html]
# Fri, 22 Jan 2021 01:48:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Jan 2021 01:48:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ada99372942839a58cacfeca404f509a31fccc028295b79ffe000a041e33d1bd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9caa33ca3f6c6e5f9f7f2d32a0bd807eeb8dbcee821be9c000212d03eff24644`  
		Last Modified: Fri, 22 Jan 2021 01:52:28 GMT  
		Size: 3.8 MB (3757297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3367086934449cfabc37b352825adec0359d27989139e219d119f7335cd2567d`  
		Last Modified: Fri, 22 Jan 2021 01:52:26 GMT  
		Size: 334.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcb5b172000b693f47774c9ecf21c929d5cedf9111d208d9bfc505a7abb09ca7`  
		Last Modified: Fri, 22 Jan 2021 01:52:30 GMT  
		Size: 14.9 MB (14904789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46d4b398323fe651a9ab435d66116dea0b2c5d340db9ef0095874bc82fea2d03`  
		Last Modified: Fri, 22 Jan 2021 01:52:26 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eee8fc6800833a274537d84cd2011124037fd3209baaf6f4f92e45c9b75ade48`  
		Last Modified: Fri, 22 Jan 2021 01:52:26 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:9329045eac8eee4ea1cce2aa57f7ae06f68555d9b7fa61c7796f5e068dba62d6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.1 MB (147111478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:361d4966d892c50c8fb6bf3d2383c99970f06a9d543f37de84c8f9bccb5a4cc8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 21 Jan 2021 23:20:22 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 21 Jan 2021 23:22:06 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.2; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:22:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Jan 2021 23:22:08 GMT
ENV MATOMO_VERSION=4.1.1
# Thu, 21 Jan 2021 23:22:31 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:22:36 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 21 Jan 2021 23:22:37 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 21 Jan 2021 23:22:37 GMT
VOLUME [/var/www/html]
# Thu, 21 Jan 2021 23:22:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Jan 2021 23:22:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:95390798b4b1b774fd515c189bbd12dfc652931e905a328138bfa0baef18e30a`  
		...
		Size: 8.5 KB (8455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9bef1ed17af0cd763c097d43f548f50bbad8bf656cb9c835090ac0d306d32146`  
		Last Modified: Thu, 21 Jan 2021 23:26:59 GMT  
		Size: 3.5 MB (3458197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9133803df4ad5d58d220675802dd3ccb3933ffe4f75f29e2d43b090f8636fa9`  
		Last Modified: Thu, 21 Jan 2021 23:26:58 GMT  
		Size: 334.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07932f950229441075d4a9520ed6974ab84d62d3afdc4f5532f212fa2ef52d68`  
		Last Modified: Thu, 21 Jan 2021 23:27:02 GMT  
		Size: 14.9 MB (14902836 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00fea77aa23cece4a41960f5d009dede60b4f17a0f188c3ffbacd9e2a70d6bea`  
		Last Modified: Thu, 21 Jan 2021 23:26:59 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12a3ccbf1180e48778b1e037905ddad9b9dbd1c572d44650c972e0bc3d91a314`  
		Last Modified: Thu, 21 Jan 2021 23:26:58 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
