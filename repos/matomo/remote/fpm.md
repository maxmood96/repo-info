...
```console
$ docker pull matomo@sha256:c2cab7561eb749784f6b1e6bb2e34c3ff3c0b01e30fcf0e7e84744cf33f984e6
```
...
```console
$ docker pull matomo@sha256:e989b066e6011ee4a98f13db235285eccb77ff828de40de71102434694f55347
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.5 MB (182524312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f6f3eaef08a5f1485f923feaa78d3050e09f7852944a7014305bce1fcd592d27`
...
# Fri, 03 Feb 2023 23:37:49 GMT
CMD ["php-fpm"]
# Sat, 04 Feb 2023 06:14:16 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 06:14:16 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 06:15:45 GMT
...
-	Layers:
	...
	-	`sha256:a9b740194260f72fe1a25d22b3f400066718a3930c6e3de6b1867db029522ec6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ede160e8c6b69f2460846b60af06a3c3aefc9f6c907dd91c8ac15aea03d5a61`  
		Last Modified: Sat, 04 Feb 2023 06:19:02 GMT  
		Size: 3.2 MB (3189034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87804282eaf4a724ccf857059f5d175c8a72c2e03935625ceb0a19724808c57a`  
		Last Modified: Sat, 04 Feb 2023 06:19:02 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5894021806f88a1361f7a2673a4aa3c9d0638fdb28cb8fb407e51f0239f4f96`  
		Last Modified: Sat, 04 Feb 2023 06:19:05 GMT  
		Size: 17.5 MB (17474577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9133b65ec3c6659adfe27e929d3a29667df76418370fe6e5780172a38016bb10`  
		Last Modified: Sat, 04 Feb 2023 06:19:01 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f125062547fca4f18e1d3a2efe8604cc88b0804ac7e9d98fbde50f2d51912649`  
		Last Modified: Sat, 04 Feb 2023 06:19:02 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:c437d7ee69052c46bd2535289fa252b07f479e05f07f4961b07a6f82d1faf59e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.7 MB (159670184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9f886d53fe05ac525d634066ed4253610312bb2bbfbfeb374678f1df34ce91c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Feb 2023 07:01:42 GMT
CMD ["php-fpm"]
# Sat, 04 Feb 2023 14:31:22 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 14:31:22 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 14:32:54 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 14:32:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Feb 2023 14:32:55 GMT
ENV MATOMO_VERSION=4.13.3
# Sat, 04 Feb 2023 14:33:45 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 14:33:45 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 04 Feb 2023 14:33:46 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Sat, 04 Feb 2023 14:33:46 GMT
VOLUME [/var/www/html]
# Sat, 04 Feb 2023 14:33:46 GMT
...
-	Layers:
	...
	-	`sha256:1a63c311e93ae9de40c9ad194da380748d19da4cfe98086206eed69238be29d7`  
		...
		Size: 8.9 KB (8851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd59c6644b56fd98f8c0da29852691a80edcf0d2dd3e8f7dfb88bef9cd22896f`  
		Last Modified: Sat, 04 Feb 2023 14:35:20 GMT  
		Size: 2.6 MB (2645528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bf45866acd64ff26f3e15d9e86c68449708d037fe1d7d26d78c7d419feadc72`  
		Last Modified: Sat, 04 Feb 2023 14:35:18 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55e747d19c4c0cc9a230723b3d259b5de13d6252dea422d9933705e919528b27`  
		Last Modified: Sat, 04 Feb 2023 14:35:24 GMT  
		Size: 17.5 MB (17472888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95f5fb02c03584a11bdc512d01984bf8c32ece2a59fb6ea17f54730bcce3ad39`  
		Last Modified: Sat, 04 Feb 2023 14:35:18 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27e6205e4eda1bc9987bb5561e2d8635350b2703d6ce6220389586f88b21483a`  
		Last Modified: Sat, 04 Feb 2023 14:35:18 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:d2ce65249b395156588b264626fd549452daa21bafcf7b3955a1e989b67bf9d5
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.4 MB (152385042 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddb8c225c98f1448422d11cee5fd3110810035b06804c4bfd8245b7a08446437`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 03 Feb 2023 23:28:20 GMT
CMD ["php-fpm"]
# Sat, 04 Feb 2023 09:17:06 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 09:17:06 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 09:18:35 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 09:18:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Feb 2023 09:18:36 GMT
ENV MATOMO_VERSION=4.13.3
# Sat, 04 Feb 2023 09:19:26 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 09:19:27 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 04 Feb 2023 09:19:27 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Sat, 04 Feb 2023 09:19:27 GMT
...
-	Layers:
	...
	-	`sha256:85255d56830bfc874083b3db2d95dfd5ed76025cc3513c9d4b2abb3b7045d205`  
		...
		Size: 8.9 KB (8851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96157c318a54041257f936a0a0254dc17fc6624fa78532614b3c7a1f3f830517`  
		Last Modified: Sat, 04 Feb 2023 09:23:11 GMT  
		Size: 2.5 MB (2515799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69128dd9ef2d2eb3ff7ceb6525942ec1eda85f35d23bfe2da0d08aa2561b1e34`  
		Last Modified: Sat, 04 Feb 2023 09:23:11 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86476c0461496eec1db5b60396b4072dfcc6c91ee997c8ebacb234571eb1d72a`  
		Last Modified: Sat, 04 Feb 2023 09:23:16 GMT  
		Size: 17.5 MB (17473075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:653ccc01c2c9c1cc6132329a51847b555d724558afcc9dfb0de4205d04d985fd`  
		Last Modified: Sat, 04 Feb 2023 09:23:11 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30182f34c7d4c1333cb8099456a1b02008c83f7e9f041e92cab4288a55ceb41f`  
		Last Modified: Sat, 04 Feb 2023 09:23:11 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:a61722530b1f36f07d8afbfb8fe7e74e2c3c39d940d2ed934cdad55e64715666
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176292309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbfb3d3ad43df63e2c76724a88b1dae78ab0b2c15180d71407e434e12ddbe4e9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Feb 2023 12:40:42 GMT
CMD ["php-fpm"]
# Sat, 04 Feb 2023 22:54:24 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 22:54:24 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 22:56:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 22:56:02 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Feb 2023 22:56:02 GMT
ENV MATOMO_VERSION=4.13.3
# Sat, 04 Feb 2023 22:56:14 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 22:56:15 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 04 Feb 2023 22:56:15 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Sat, 04 Feb 2023 22:56:15 GMT
...
-	Layers:
	...
	-	`sha256:9c0270bdd48a5b98f711da6d19c7acb26a4aa91c75e5e003dd8cc6330cd8c7a7`  
		...
		Size: 8.9 KB (8851 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22303ff1d2fd436e5e660efeee91e0199d538d1eabe961049fd59b3df183ccc8`  
		Last Modified: Sat, 04 Feb 2023 22:57:07 GMT  
		Size: 3.4 MB (3423259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:443b2696c0d0ef9f98f744039d721f2e9fa648c18ce6132be2bf222744c4c5c8`  
		Last Modified: Sat, 04 Feb 2023 22:57:06 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5205ef139938f69166fd55fca82dbc597be647781ad8b00d2c8a7aae4077fdf3`  
		Last Modified: Sat, 04 Feb 2023 22:57:09 GMT  
		Size: 17.5 MB (17473704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad2bd7cb496def660910dd5160786fb86c34c8374e2abb1b16b64a6a1555c09c`  
		Last Modified: Sat, 04 Feb 2023 22:57:06 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e37eb9eaaa390edb9d13a1ffa6f5da380d418bfed2a4d677119882be158e6c50`  
		Last Modified: Sat, 04 Feb 2023 22:57:06 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:888e165519e22fbb4858998a3b6848be73719136b1cf2d39d4c8728715ff6a81
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.1 MB (159066006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef37ee4d855547fc2474a58b8250489bf62e5a8e75321ef624b9155459dcbff4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 04 Feb 2023 04:25:37 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 04:25:40 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 04:30:08 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 04:30:14 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Feb 2023 04:30:18 GMT
ENV MATOMO_VERSION=4.13.3
# Sat, 04 Feb 2023 04:31:22 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 04:31:28 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 04 Feb 2023 04:31:33 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Sat, 04 Feb 2023 04:31:38 GMT
VOLUME [/var/www/html]
# Sat, 04 Feb 2023 04:31:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:e2dd8e23a6f5e8799cb4659c4b25a223e7d8720347b662aecbc53af3d7f5ec2f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6811880d22f3442261b0663fd4ef01596bad2bc475ffdd4e4e1c1f2de5c5ee6a`  
		Last Modified: Sat, 04 Feb 2023 04:33:02 GMT  
		Size: 2.6 MB (2562242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b4c09f04ce4e5bb1cbb219037057cd9ebc753874adacc3a98dd4737175c560c`  
		Last Modified: Sat, 04 Feb 2023 04:32:59 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0d9715b9bc6ad7fb95e44d60cae1b2034dbfb9ead6674ba026a1ab09dfc4c03`  
		Last Modified: Sat, 04 Feb 2023 04:33:14 GMT  
		Size: 17.3 MB (17257158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e459fb2d171650c42f5299074c6389df09fc614477f208376e9cdaa8d7e7493`  
		Last Modified: Sat, 04 Feb 2023 04:32:59 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04efdc8cbef700b057cbdc8f513df32dfedaa121f9f64af619672b114715210d`  
		Last Modified: Sat, 04 Feb 2023 04:32:59 GMT  
		Size: 630.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:3fb653ee5f180b63909389c63d049ac55b19badc04109eafdd26b80596545438
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (158957137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8775983761fbaf6c09bc2c3ac01a8a003d59646b99b6fd99b916312aa4b5e67e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Feb 2023 07:46:48 GMT
CMD ["php-fpm"]
# Sat, 04 Feb 2023 15:15:48 GMT
LABEL maintainer=pierre@piwik.org
# Sat, 04 Feb 2023 15:15:48 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 04 Feb 2023 15:16:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 15:16:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 04 Feb 2023 15:16:40 GMT
ENV MATOMO_VERSION=4.13.3
# Sat, 04 Feb 2023 15:16:51 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 15:16:54 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 04 Feb 2023 15:16:54 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Sat, 04 Feb 2023 15:16:54 GMT
...
-	Layers:
	...
	-	`sha256:aa253ce62f900a55b5a736463bda6989a102c07adbfa293db090c8574fc5b2e1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67d87265be5338ef9f1b78f08309e807103dca87715abd96d9219ede841caf17`  
		Last Modified: Sat, 04 Feb 2023 15:18:05 GMT  
		Size: 2.8 MB (2788969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b1ab8f2622cf60eadc51b43bd0b178191730ebaadcbfdddba67c7152ffe62e1`  
		Last Modified: Sat, 04 Feb 2023 15:18:05 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fde3578bd65548f9fecfe44f2d2d81eef4fd06d21598e6f67715c248a3c09905`  
		Last Modified: Sat, 04 Feb 2023 15:18:07 GMT  
		Size: 17.5 MB (17473225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83abf482251bfef0817d94828308d42d51f18ec545241dea2e32a2d626194b40`  
		Last Modified: Sat, 04 Feb 2023 15:18:05 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5afa87fae9647367edefe9fee0b6a253f5de4bf18b4bf13d9e1e035df52c564`  
		Last Modified: Sat, 04 Feb 2023 15:18:05 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
