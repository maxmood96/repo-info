...
```console
$ docker pull matomo@sha256:c8c3d029c58198ab3f805c1c7a2dd020b29074c9e12c65599e975606ca14d129
```
...
### `matomo:5.8.0-fpm-alpine` - linux; amd64
...
### `matomo:5.8.0-fpm-alpine` - unknown; unknown
...
### `matomo:5.8.0-fpm-alpine` - linux; arm variant v6
...
### `matomo:5.8.0-fpm-alpine` - linux; arm variant v7
...
### `matomo:5.8.0-fpm-alpine` - linux; arm64 variant v8
...
### `matomo:5.8.0-fpm-alpine` - linux; 386
...
### `matomo:5.8.0-fpm-alpine` - linux; ppc64le
...
### `matomo:5.8.0-fpm-alpine` - linux; s390x
