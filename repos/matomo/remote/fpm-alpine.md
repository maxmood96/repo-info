...
```console
$ docker pull matomo@sha256:2e87e73bbffe2eb7f5f752e17f666cc7fea2c05627f116579c9a38cb49247d2a
```
...
```console
$ docker pull matomo@sha256:87a77d1a1a06e311ec5bbf72733cb1850b2f4d737b749ce6d130366f04de22c1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.8 MB (49826630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c06b499db6c27bab1374783cf80945cb48dad8002ef8dfe1e0a013c09053b56f`
...
-	Layers:
	...
	-	`sha256:a998f125415ade23710cccd9c84b2f7ede5200baee9a83ebcf0234103ea3cb78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1d785d6290308e08b18c29a5ef49bcfb9f884d31d5cd29562f9034ed7eb3a65`  
		Last Modified: Mon, 07 Jun 2021 19:30:29 GMT  
		Size: 5.6 MB (5557321 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6c0fc72036feef7a95696200ceaca648d5fc3ae38e06a2c8c9504e3a4dc5504`  
		Last Modified: Mon, 07 Jun 2021 19:30:28 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a34815151aed9f46a03f8ed68e04ea748d95b3b909007ee56065a5c9b3ce992`  
		Last Modified: Mon, 07 Jun 2021 19:30:31 GMT  
		Size: 14.8 MB (14796285 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcb34e28fa659005f00a281fb7552298287589108e24b87409db4f603622eef4`  
		Last Modified: Mon, 07 Jun 2021 19:30:28 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b45a876c59026667ce4aef337b99f79ce6b4281aa95d99fc74d6f32d75b13d0`  
		Last Modified: Mon, 07 Jun 2021 19:30:28 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:52862a00ed32a427edf4f2f630eb9acb8ea34601fc7edb14fb2af4af609cad34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (47970798 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd08dc0bc5e9e64241bfec3c2873c7d2de9f0400563afcc28add45cb91ed3a3a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 03:57:00 GMT
CMD ["php-fpm"]
# Fri, 04 Jun 2021 06:30:59 GMT
LABEL maintainer=pierre@piwik.org
# Mon, 07 Jun 2021 20:02:06 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Mon, 07 Jun 2021 20:02:07 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Jun 2021 20:02:07 GMT
ENV MATOMO_VERSION=4.3.1
# Mon, 07 Jun 2021 20:02:17 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Mon, 07 Jun 2021 20:02:18 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 07 Jun 2021 20:02:18 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 07 Jun 2021 20:02:19 GMT
VOLUME [/var/www/html]
# Mon, 07 Jun 2021 20:02:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 07 Jun 2021 20:02:19 GMT
...
-	Layers:
	...
	-	`sha256:54c768ef4281a7a655ae853641b492c13fb858ae08623ca108fe1890e01a7785`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56cf73ab4aa2f5a3abf8261625edfa97f38cae094db65504637e0a979d22ccee`  
		Last Modified: Mon, 07 Jun 2021 20:02:46 GMT  
		Size: 5.1 MB (5144682 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02f097b105f262f79e0dbca5eba6b1499f28897d938a3d560edd2b5e7b0beac5`  
		Last Modified: Mon, 07 Jun 2021 20:02:44 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:435b3318de6c9058214ae53345a8f8ddcbb83c4e9835faf22658def00a77df89`  
		Last Modified: Mon, 07 Jun 2021 20:02:49 GMT  
		Size: 14.8 MB (14796295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85261b1a59f52327726a1af765335cbc76fd66617b32593e394426a3e337f6f5`  
		Last Modified: Mon, 07 Jun 2021 20:02:44 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee987054421d17673420fb2f5f178b22c46edcbcfb6c7a85acc93c864589ee64`  
		Last Modified: Mon, 07 Jun 2021 20:02:44 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:cad9efae2fa55a9a0480f33970790500411aca47b2cd49e461c95631eb6fab0f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46784111 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc7139c690609ba1332a4c7620b2f983358421e74400a752f6df34bb3a8c6fdd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 04:30:02 GMT
CMD ["php-fpm"]
# Fri, 04 Jun 2021 08:49:24 GMT
LABEL maintainer=pierre@piwik.org
# Mon, 07 Jun 2021 20:22:07 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Mon, 07 Jun 2021 20:22:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Jun 2021 20:22:09 GMT
ENV MATOMO_VERSION=4.3.1
# Mon, 07 Jun 2021 20:22:21 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Mon, 07 Jun 2021 20:22:22 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 07 Jun 2021 20:22:22 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 07 Jun 2021 20:22:22 GMT
VOLUME [/var/www/html]
# Mon, 07 Jun 2021 20:22:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 07 Jun 2021 20:22:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b8e0cea8589c00d63314ee71e0df19b324a9002c9caa44708bb096de2f2530b8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a0acbdd10efece6d98c77edaab95ec2d177022923e3f72e0f6a31d5564d08d7`  
		Last Modified: Mon, 07 Jun 2021 20:24:46 GMT  
		Size: 5.1 MB (5129262 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f0f6014383a6af32a6019e84ae9cc7690a60cdf12ba3c1724ca1873efbf6451`  
		Last Modified: Mon, 07 Jun 2021 20:24:45 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:309711c65e5583b219040e9f8023d5cb6a17c4da600369620953a0478c9b4823`  
		Last Modified: Mon, 07 Jun 2021 20:24:50 GMT  
		Size: 14.8 MB (14796334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faaa4cf1e807166a39b22e6ab2a6a78d8081a9e281aa93dddd20ad67ec795350`  
		Last Modified: Mon, 07 Jun 2021 20:24:45 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62a6dbc7c3c6a2dd6fc5c9cda62b5577bffe418040fd5687715940a5b5ca6381`  
		Last Modified: Mon, 07 Jun 2021 20:24:45 GMT  
		Size: 225.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f26f9c6f81901d479c255ad246b2994875b35370dde7074839ca7dc40c19ce5a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.2 MB (49223354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3480f40eb2b91f3096569adba00c812a85d38a61369dcbc8b7d90d2c47ef0f3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 07:29:05 GMT
CMD ["php-fpm"]
# Wed, 16 Jun 2021 13:10:22 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 16 Jun 2021 13:11:52 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 16 Jun 2021 13:11:53 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Jun 2021 13:11:53 GMT
ENV MATOMO_VERSION=4.3.1
# Wed, 16 Jun 2021 13:12:01 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Wed, 16 Jun 2021 13:12:02 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 16 Jun 2021 13:12:02 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Wed, 16 Jun 2021 13:12:02 GMT
...
-	Layers:
	...
	-	`sha256:da86ba73c3016b44bda3d2f85e11e982c55eeb8eebe1ece6cdc5378609b9db43`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0c367e464a73eceffac9603ea3ba6376b03ee05f28ce9de32efccf506e83a29`  
		Last Modified: Wed, 16 Jun 2021 13:13:04 GMT  
		Size: 5.1 MB (5107602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c49721f88f805cb58a9d62e33bb3fd0f012199d7f27d266c4e7abcaf40d64228`  
		Last Modified: Wed, 16 Jun 2021 13:13:03 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b32f39bd3b145222b7e973291a71871a36657e3b2b1429de7460960cf4af7d44`  
		Last Modified: Wed, 16 Jun 2021 13:13:06 GMT  
		Size: 14.8 MB (14796288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67d8d755ea030b4a1c0edf7b37e51bdcc062691c81ab333fe33ebbca6d7ba796`  
		Last Modified: Wed, 16 Jun 2021 13:13:03 GMT  
		Size: 305.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5399310af6ceb7b3788d8496555fbbd776e63a053a60ecf2099b24045b3db0ea`  
		Last Modified: Wed, 16 Jun 2021 13:13:03 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:505230196511772595a99262059e8e680c26955d63b5865140b10ef870a4cb1f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50351511 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:567a9d8f90e3c6bb622ace6a3bc7ce3d2462c3bdb7e0ab93242ad17b1c8ad043`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Mon, 07 Jun 2021 19:43:27 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Mon, 07 Jun 2021 19:43:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Jun 2021 19:43:28 GMT
ENV MATOMO_VERSION=4.3.1
# Mon, 07 Jun 2021 19:43:37 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Mon, 07 Jun 2021 19:43:38 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 07 Jun 2021 19:43:38 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 07 Jun 2021 19:43:38 GMT
VOLUME [/var/www/html]
# Mon, 07 Jun 2021 19:43:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 07 Jun 2021 19:43:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:26559e337eb39941ae5a7941b84eb02bf83114aa23184c7041d765b9f4155b9c`  
		...
		Size: 8.4 KB (8444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:752d9de02bb24095e149ff5053d5df7763155e22cea52711923765edef6a7d28`  
		Last Modified: Mon, 07 Jun 2021 19:45:43 GMT  
		Size: 5.6 MB (5558844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1e0fe2026f6e38a547180a05058ac870d120e3ee2cc3eb141252a37490749e7`  
		Last Modified: Mon, 07 Jun 2021 19:45:42 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1311a24de7d397c1fdd08e196ec190e165e9815c0a46a612b482bc660b6dfbc`  
		Last Modified: Mon, 07 Jun 2021 19:45:46 GMT  
		Size: 14.8 MB (14796239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:849d32b863cceb79ab95285623e1b1bf8675412ff35480ab2cc78d9748634915`  
		Last Modified: Mon, 07 Jun 2021 19:45:42 GMT  
		Size: 304.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad817d6e2bbbe7318dc9b2c58f8664a4491a4cb10876ceded4cf4a0ef7a14cc9`  
		Last Modified: Mon, 07 Jun 2021 19:45:42 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:5edd93cf64e8e97ce248800c264f02cdad92737c09e7c529c33eaf3d9b25e63e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50997984 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:588c558d88dde6d68723a91ee032a9c03c9cab56335af7efc3d8e3f7d0e771bb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Mon, 07 Jun 2021 19:31:54 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Mon, 07 Jun 2021 19:32:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Jun 2021 19:32:05 GMT
ENV MATOMO_VERSION=4.3.1
# Mon, 07 Jun 2021 19:32:28 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Mon, 07 Jun 2021 19:32:33 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 07 Jun 2021 19:32:37 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 07 Jun 2021 19:32:42 GMT
VOLUME [/var/www/html]
# Mon, 07 Jun 2021 19:32:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 07 Jun 2021 19:32:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8c2b9636df2b7341c3323f14d2891cb2415c6dd5cedc5cf6650d5ab9bc4880c6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e97a2021f7123a1ad521690a7d9dfdedc1e364d26b539730f649cf1d061742bc`  
		Last Modified: Mon, 07 Jun 2021 19:34:38 GMT  
		Size: 5.6 MB (5633066 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b264571fafc25f4df0829aab619b70c4b413f6861bf475124385a955732a6291`  
		Last Modified: Mon, 07 Jun 2021 19:34:37 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3fe8e896437923f582c9619d811b93a4a1c51d3473a350f4f6702dfd5ea43651`  
		Last Modified: Mon, 07 Jun 2021 19:34:40 GMT  
		Size: 14.8 MB (14796308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af3fff27a3df99916cbe4e55ad07b598a21805f54e2c69a3258077a225f66112`  
		Last Modified: Mon, 07 Jun 2021 19:34:37 GMT  
		Size: 305.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70f51ab6be0b21e04230ad9109f88bb90b3b15fe44d0223e870f8f1e05f9f560`  
		Last Modified: Mon, 07 Jun 2021 19:34:36 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4437d914d796332c49a74421698120c567a09c481e90e6f0f4b00e34216f3066
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48694569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79ed40615a4b0d0f993f84366de39141ba55b5cbdd50a437ad5ef29a6b3f9d53`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Mon, 07 Jun 2021 19:51:30 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Mon, 07 Jun 2021 19:51:32 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Mon, 07 Jun 2021 19:51:33 GMT
ENV MATOMO_VERSION=4.3.1
# Mon, 07 Jun 2021 19:51:49 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Mon, 07 Jun 2021 19:51:54 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Mon, 07 Jun 2021 19:51:55 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Mon, 07 Jun 2021 19:51:55 GMT
VOLUME [/var/www/html]
# Mon, 07 Jun 2021 19:51:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 07 Jun 2021 19:51:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:34101cded8cdbaa965b50b77f62aaec97ac13394e2c9ab5fbd3df00ca3eaf72e`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:596c30ceca416fcc45526b8ba1607861b8231fecdb00a0bf516341de2a5d50e8`  
		Last Modified: Mon, 07 Jun 2021 19:53:01 GMT  
		Size: 5.2 MB (5202605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:015b9622ee282b472b2da90784031b6b9d21ce6ef0f3007f3f9a59a510407587`  
		Last Modified: Mon, 07 Jun 2021 19:53:01 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fef651cfc35ec5e6b1f166043b3802c98becff4c33323d01c77f1d962700fdab`  
		Last Modified: Mon, 07 Jun 2021 19:53:03 GMT  
		Size: 14.8 MB (14796228 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2b33a57e2661d34b4a69613407a321124456c92d117e352f9e98e78203522de`  
		Last Modified: Mon, 07 Jun 2021 19:53:00 GMT  
		Size: 304.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d39d413510430366056d98f07f586c25f287a77392c0a9aa8a10f1644535acc`  
		Last Modified: Mon, 07 Jun 2021 19:53:00 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
