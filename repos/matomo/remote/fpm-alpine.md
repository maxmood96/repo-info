...
```console
$ docker pull matomo@sha256:30c244acb7470142ef8523e87232789495fa9d07b20a308334779ef1b01589a8
```
...
```console
$ docker pull matomo@sha256:67cbfeef745cac2afea14477e949f3c6e17fc69927efa9976bbc672f7c1e129b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.8 MB (59810323 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3ed14b486c9bcd25f407379cb283677d07dfbeb7df5bb599fb0969874359a1e`
...
# Sat, 06 Jul 2024 02:05:41 GMT
CMD ["php-fpm"]
# Sat, 06 Jul 2024 03:51:06 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 06 Jul 2024 03:52:58 GMT
...
-	Layers:
	...
	-	`sha256:eea24946c92ac69f8b09fd20686bfa6f0c1707317ba19907165534694608a758`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92c229800ebe11267b4d4791e016707830b8563a87d26e8330d92667b973c009`  
		Last Modified: Sat, 06 Jul 2024 04:04:06 GMT  
		Size: 3.4 MB (3399300 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12cdaf9790b5b3318a346453c0c187283bdf10529dd3af115c64ca607d715e69`  
		Last Modified: Sat, 06 Jul 2024 04:04:05 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4fca88abc38a82ad464b7c2e89dd89f23acedadf8d066640c6782461fe7b801`  
		Last Modified: Sat, 06 Jul 2024 04:04:09 GMT  
		Size: 21.2 MB (21226050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac7c6a8bbacdb7f939d42dd16aa5ca04ca45adc5ba2d9e3fa99d78e63249caa0`  
		Last Modified: Sat, 06 Jul 2024 04:04:05 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59e5f900b5bbf0a38f1893e414a502a2bc81b772fbe5a8d2ce42e9db4fd488b1`  
		Last Modified: Sat, 06 Jul 2024 04:04:05 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:739f2955110c4d341533b37210608d46301498f791963d3f70e10fabcef3524c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.6 MB (54637596 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6df16f83a9c315ffd3d7a81e18fd93f4eaa01627a5c0a66fefd3ca327cece44a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 23 Jul 2024 01:46:47 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 01:48:15 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 23 Jul 2024 01:48:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 01:48:16 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 02:06:07 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 23 Jul 2024 02:06:07 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 02:06:08 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 02:06:08 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 02:06:08 GMT
...
-	Layers:
	...
	-	`sha256:e998f41e04a69801451c63ac6206091f36c7b40fd63416d5696c15e2335b98fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83e350fcf2066cf89ad52878941fa8fb8733ad2f767626884e98eab92624a3f2`  
		Last Modified: Tue, 23 Jul 2024 02:06:30 GMT  
		Size: 2.9 MB (2911034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d8b2119bcb7eb7d7727fe3e31eb1f4b1a8741b6319debb4a83524b7a34cdc30`  
		Last Modified: Tue, 23 Jul 2024 02:06:29 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:693566f04867998c22a6ba78952f01aa65fe0b09a912575447eebc442b2d8fe2`  
		Last Modified: Tue, 23 Jul 2024 02:06:35 GMT  
		Size: 21.2 MB (21225686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe55e815b2a912c571d3c5d3464deeb6cd911c639e12ef29f6ddd27675c5673f`  
		Last Modified: Tue, 23 Jul 2024 02:06:29 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a19407584c1a770ee65043a0111fbe736e39a29fd8bd70bddae130d91ff807da`  
		Last Modified: Tue, 23 Jul 2024 02:06:29 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:fbcd804e576323bdca3690db802bc4164060b0bcb4956096dd3d20c120d3b162
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.3 MB (53286632 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eb35e35d74d7d48d31b3b65580e94501f61785b07844660030fb02d8c9b109d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 00:27:30 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 02:14:32 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 02:16:04 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 23 Jul 2024 02:16:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 02:16:06 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 10:55:59 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 23 Jul 2024 10:55:59 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 10:55:59 GMT
...
-	Layers:
	...
	-	`sha256:88465cbcb6aedd433576d57aa85516d32820b570633bb5dd3cab5a04edb4581a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62fe32cf1b63757b676eb72c8a037d57566e9635d03fbf551aecf598a2174a98`  
		Last Modified: Tue, 23 Jul 2024 10:56:58 GMT  
		Size: 2.8 MB (2756900 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c91cdad88d22012e5ae9ec3eb6107afc2dcc8ca2f00753aac559d972f809d658`  
		Last Modified: Tue, 23 Jul 2024 10:56:58 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21739cf8dbc79b1b2d994c35c0e48bf6ee9e1aedbdfcbeecd041b64f95a9cc5f`  
		Last Modified: Tue, 23 Jul 2024 10:57:02 GMT  
		Size: 21.2 MB (21225699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c05b149cc2ae6a8063584fc1dba3f7212bae936c9abb67731a8ef67b990a1890`  
		Last Modified: Tue, 23 Jul 2024 10:56:58 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbf85c31f2ff0c04e0c841bb692d3c0bff7fd0378a70a14fda6059c28ae1021e`  
		Last Modified: Tue, 23 Jul 2024 10:56:58 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f20a52d14062c0c858cd59cb001c1d70144ac79bbc0e9109657b2d82a5206ae4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.4 MB (57448168 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2eb54c883c0fb92be6bf00470ee1545064129bce29d17f7831dc55ecf8feb1e9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 01:16:23 GMT
CMD ["php-fpm"]
# Tue, 23 Jul 2024 03:02:22 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 23 Jul 2024 03:04:36 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Tue, 23 Jul 2024 03:04:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 23 Jul 2024 03:04:36 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 09:26:32 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 23 Jul 2024 09:26:32 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 09:26:32 GMT
...
-	Layers:
	...
	-	`sha256:5876176c021392562624347f1d643b754e6bba176140d66e6dc6086582b878bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8413c7a8f6d8f26fb1c704dd396dd2a1fbe1a54996a79f7b39592be617e171ab`  
		Last Modified: Tue, 23 Jul 2024 09:27:27 GMT  
		Size: 3.7 MB (3718402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b79e7adf9afe221a1f7bdf64aa648a17b7900bca0d47e44faae23f07b367ff`  
		Last Modified: Tue, 23 Jul 2024 09:27:26 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45335ca59a5e1e9e0a64a9611436f3d89667dd2db4d82b639deea4a1911d87b1`  
		Last Modified: Tue, 23 Jul 2024 09:27:29 GMT  
		Size: 21.2 MB (21225681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c372c3fc7c296ca145cd4ff5c19609b71a7b72fa6d906f8eeda40366f787fd84`  
		Last Modified: Tue, 23 Jul 2024 09:27:26 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8147ce854a72c92307dbcd156c283d3fd8bf15e3e557a8f845d2955b940580ff`  
		Last Modified: Tue, 23 Jul 2024 09:27:27 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:853a92935497a581e46a599fbec5232389676a812b775e50920c3fdb81f0eb14
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.9 MB (59880774 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54e94617e632e1ab48d0035137591852f6f25d39e0d1d3e9118e25a515c39cd3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 06 Jul 2024 03:08:20 GMT
CMD ["php-fpm"]
# Sat, 06 Jul 2024 04:54:32 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 06 Jul 2024 04:56:36 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 06 Jul 2024 04:56:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 06 Jul 2024 04:56:37 GMT
ENV MATOMO_VERSION=5.1.0
# Sat, 06 Jul 2024 05:00:09 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 06 Jul 2024 05:00:10 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 06 Jul 2024 05:00:10 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 06 Jul 2024 05:00:10 GMT
VOLUME [/var/www/html]
# Sat, 06 Jul 2024 05:00:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 06 Jul 2024 05:00:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c543b985109fc48fc6ac5027244d7f0f11dc52c899f9ab0175a3c3a9066924ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6e4c45066d71cb2277a7ff8bbcfcb39ff385a7151a7a25fe2da67513bc5ce4a`  
		Last Modified: Sat, 06 Jul 2024 05:01:19 GMT  
		Size: 3.4 MB (3369229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c104c511611351a0cf1c052aff7379f992a9c967f717ad6ea6d076b6c8c1094`  
		Last Modified: Sat, 06 Jul 2024 05:01:18 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fefa1390826b19b61d14f27907d395d7d113ad5c99e052fc07d6301429fb6fd8`  
		Last Modified: Sat, 06 Jul 2024 05:01:23 GMT  
		Size: 21.2 MB (21226020 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4389e7d600b7cf303b1caa880160eca455824ffb8378062a77cc6552a8562945`  
		Last Modified: Sat, 06 Jul 2024 05:01:18 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7e1389cad1223ae234e7df3e58edd51b8a80efae7231f6dc4d618158c58d61e`  
		Last Modified: Sat, 06 Jul 2024 05:01:18 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:97ee45c832d83778d226c9061a2ad39becb8a2c6a0335b2a29086141858f43e6
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.0 MB (56990338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2d1794460fdc72d72daead41239f64b2cf226323150eb9c2f9c8432d68dc2bf`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 00:32:29 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 06:53:23 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 23 Jul 2024 06:53:25 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 06:53:25 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 06:53:26 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 06:53:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 23 Jul 2024 06:53:26 GMT
...
-	Layers:
	...
	-	`sha256:58e4b4e4573fc2e3c6182207ea0d7d654e73bbbdb6f8339353ea59f76064df96`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09a4e4b5e6675c973bf224efe29b666f9337b4f361ccb7acb90079d84d8d795b`  
		Last Modified: Tue, 23 Jul 2024 06:54:23 GMT  
		Size: 3.3 MB (3270213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:331185fcd3af75186419b1bd5a1003332afc2db493dd509c3cb00fbb74b65598`  
		Last Modified: Tue, 23 Jul 2024 06:54:22 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ecb67349b71f1d3efe53ade3b40e2abcb7027cf6b74a12ea3bc18f372953b7f`  
		Last Modified: Tue, 23 Jul 2024 06:54:27 GMT  
		Size: 21.2 MB (21225689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:859257ca6317a5a68ee33f208ecc6cabef2ada764bdad1b2a0f392f38617e756`  
		Last Modified: Tue, 23 Jul 2024 06:54:22 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2113a1707753b7cd6171a6edfbef0c7587e01997cb8953909f5498c7b4107af9`  
		Last Modified: Tue, 23 Jul 2024 06:54:22 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:8525d9e0b0477bd7d3dafdd9c15341a424581d9f958442452e908afb13f9d704
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.3 MB (56281181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88dedc68e38f8464ce64d560d09a93d4427a9f0e0cdb54a4b84d814fd3dce405`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 02:02:58 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 23 Jul 2024 02:09:43 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 23 Jul 2024 02:09:44 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 23 Jul 2024 02:09:45 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 23 Jul 2024 02:09:45 GMT
VOLUME [/var/www/html]
# Tue, 23 Jul 2024 02:09:45 GMT
...
-	Layers:
	...
	-	`sha256:444cca5cdd7c1269939ba68597f6bbd5a1106cb7007ed1759cd7d1fe8f9d7c81`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e860df67cf2667a67d652606f6080b13fdfc2a240a1adebe928341141d02df47`  
		Last Modified: Tue, 23 Jul 2024 02:10:07 GMT  
		Size: 3.1 MB (3132290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62d8f2608fa3e3155c6fc1afdb6042acff1f3dc2125a8a11f0bae2d6d557ed25`  
		Last Modified: Tue, 23 Jul 2024 02:10:06 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d37863da65d93419f53e38f7303120737c10b976fba0460cea8ca88e2bc62d2`  
		Last Modified: Tue, 23 Jul 2024 02:10:10 GMT  
		Size: 21.2 MB (21225663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a133fe2bc16e1245b27a9fcb32d48dd530a21a0dd210b0558d973b74d6e4318c`  
		Last Modified: Tue, 23 Jul 2024 02:10:06 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a97915e4e870d505eddbe0cc24a6a63bbb57136e9a4961a866caac8bf160aae5`  
		Last Modified: Tue, 23 Jul 2024 02:10:07 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
