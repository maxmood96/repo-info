...
```console
$ docker pull matomo@sha256:4125c323858dd4573b6a51c8836a30332c57ac1d4a6c1b789fed84f72a7c277b
```
...
```console
$ docker pull matomo@sha256:1b10ddc9cf1997e29c8bea5b83edb0da6f6a958c9744469296f92bc03c24f5ea
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.8 MB (51822453 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c40908ac2be524a664eb3a467dd871b926bd20fc46bc2b9814f956bbc2bf36e6`
...
CMD ["php-fpm"]
# Thu, 16 Jan 2020 21:36:31 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 16 Jan 2020 21:37:45 GMT
...
# Thu, 16 Jan 2020 21:37:46 GMT
ENV MATOMO_VERSION=3.13.1
# Thu, 16 Jan 2020 21:37:51 GMT
...
-	Layers:
	...
	-	`sha256:a76c8c435cdf1b3439e2129f7c62a499a0d7621451482669ac31f801736d36ab`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28cb54b99582c3642538553e21b350110ff6d7670cdf0fe163cf0798cf77743c`  
		Last Modified: Thu, 16 Jan 2020 21:38:34 GMT  
		Size: 5.9 MB (5929284 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34a4ccd9d784badec9cc80470c1ee9c11f22633f3c343479b53e29e10302bc76`  
		Last Modified: Thu, 16 Jan 2020 21:38:33 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd6fe0f29b5c1c6a8cf2f37a8741238042406a456e179ffa32711a6a90bc78ee`  
		Last Modified: Thu, 16 Jan 2020 21:38:38 GMT  
		Size: 15.2 MB (15152257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00a50af7fd4d9539a001a03ef055d8ab0cd03fa83714feebe50adc1722e5156f`  
		Last Modified: Thu, 16 Jan 2020 21:38:33 GMT  
		Size: 303.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7895f1d00f9c4094636227581a27e2971b053861fbb4a38d7d56a31fd0701b6`  
		Last Modified: Thu, 16 Jan 2020 21:38:33 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:1f5c8063676441d5db08c655bafd6faa5bb0b1024ad0533526d1e676f8a16acd
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.1 MB (50075807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73088cdf99d7a2f8e78c8224df20e1e511aa99929e92719eaf7c25d9443fda7e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 16 Jan 2020 21:49:49 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 16 Jan 2020 21:53:12 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Jan 2020 21:53:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Jan 2020 21:53:16 GMT
ENV MATOMO_VERSION=3.13.1
# Thu, 16 Jan 2020 21:53:29 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 16 Jan 2020 21:53:31 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 16 Jan 2020 21:53:32 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 16 Jan 2020 21:53:33 GMT
VOLUME [/var/www/html]
# Thu, 16 Jan 2020 21:53:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jan 2020 21:53:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d29ba0a8fa2bf1b2ecfd2108f31f38bf4958b7dd36f312503cbbedcbd146012d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53b90486041461fa66afdc1c76d586cb3b206559cdcd9d81ac5ff79032f8cba1`  
		Last Modified: Thu, 16 Jan 2020 21:53:58 GMT  
		Size: 5.6 MB (5614748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5daf2395af061f4f73a5eb3d29db2f097720eb233bc020bb523340b72ce2182f`  
		Last Modified: Thu, 16 Jan 2020 21:53:57 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cf4c254f7e5327e5399e3f3d2e19dc2974def4815bdc3de5d53e6e2b5807bb9`  
		Last Modified: Thu, 16 Jan 2020 21:54:04 GMT  
		Size: 15.2 MB (15152244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b90250557d7ea182a4553347f2c7c080b9001dc2c01fd596e8472b3d6a777e4`  
		Last Modified: Thu, 16 Jan 2020 21:53:56 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dda8929aaef5a99b1cfe4ce9e00da11049c6d51b0fc61f9a2c1ee103236f63f2`  
		Last Modified: Thu, 16 Jan 2020 21:53:56 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:1bce7e283f0e5562048be36492bf4e2f35024f4dad24e29e99f8189e66a3524f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.6 MB (48636562 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:254c9d2ba4f95b0eacb0a585919e48069efd8ac4c03c65a6e274b703e568ced9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 26 Dec 2019 21:34:27 GMT
CMD ["php-fpm"]
# Thu, 16 Jan 2020 21:04:13 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 16 Jan 2020 21:06:20 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Jan 2020 21:06:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Jan 2020 21:06:22 GMT
ENV MATOMO_VERSION=3.13.1
# Thu, 16 Jan 2020 21:06:36 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 16 Jan 2020 21:06:40 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 16 Jan 2020 21:06:41 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 16 Jan 2020 21:06:43 GMT
VOLUME [/var/www/html]
# Thu, 16 Jan 2020 21:06:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jan 2020 21:06:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:18e687de4d653c5a639b88a7f65e523c3fb81c66add44f474f84cf85f7772ad6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b730d563844947f00f675a19293ad71d406df39070c76726d606d08d0572e3b`  
		Last Modified: Thu, 16 Jan 2020 21:08:02 GMT  
		Size: 5.4 MB (5392066 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:087993a0c44eb4c7a8ed6321f94bab79e6fcd594fe3f28d867ea2a6e7c47b773`  
		Last Modified: Thu, 16 Jan 2020 21:07:53 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5e7cc7bda586ee3d7b0d2844b355c1bd3a45824a831e3c22bfd6ab691f96e61`  
		Last Modified: Thu, 16 Jan 2020 21:08:00 GMT  
		Size: 15.2 MB (15152198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:901e66e1215744b5c0ab2d9bccba0eb04e2185abe45cbd9c6cc4aaadd9b7d385`  
		Last Modified: Thu, 16 Jan 2020 21:07:53 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f71661b99ce63596c2a11acbb6eebea72fa43454f97b98db3ba8c1a3ee28574`  
		Last Modified: Thu, 16 Jan 2020 21:07:53 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f15cd2e3dd6d9b70448c104f79718ae2980626bc2ea50388aa7a875327f4b6a2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.4 MB (51412827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8a229747a44a52a22239d070b681150053125d07d1d01237ae03899de1f60d5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 16 Jan 2020 21:47:27 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 16 Jan 2020 21:50:56 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Jan 2020 21:51:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Jan 2020 21:51:17 GMT
ENV MATOMO_VERSION=3.13.1
# Thu, 16 Jan 2020 21:51:26 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 16 Jan 2020 21:51:29 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 16 Jan 2020 21:51:30 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 16 Jan 2020 21:51:32 GMT
VOLUME [/var/www/html]
# Thu, 16 Jan 2020 21:51:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jan 2020 21:51:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cae18949d5ff2fd5cbb53b1a02ecc0dd6e210b30168fc40fac6772af107423a5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ee80af86885f5d99f0308e23310cc8e560a3fc59b0602eedf9e45ac824c4d83`  
		Last Modified: Thu, 16 Jan 2020 21:52:36 GMT  
		Size: 5.9 MB (5905310 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7a09242401a42f45a94e477be3d970e07d77e852e4f5a472a15a0227bc5d3ec`  
		Last Modified: Thu, 16 Jan 2020 21:52:34 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:185db12294d25ab3ca740e141006301ede89bb316c65bbb1b7d9ceb79cde001c`  
		Last Modified: Thu, 16 Jan 2020 21:52:40 GMT  
		Size: 15.2 MB (15152246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db4953e4a166c0d8ebe782b23d24b24f8a1f06d0b8ee67c73aeb3a7772ab652d`  
		Last Modified: Thu, 16 Jan 2020 21:52:34 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5c026390a90f48e846ebb16490c276a93dcc4145dc7698574021d174795fe99`  
		Last Modified: Thu, 16 Jan 2020 21:52:34 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e170a2f0120e7a7d80fc3ff031faa627c3ada424653252e2c158e9da00f691b1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **53.0 MB (53015372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a656db52f9a13dae79fe1e7efa845807381aa3fe1c3df300796121a40cfd766d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 16 Jan 2020 21:28:12 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 16 Jan 2020 21:30:07 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Jan 2020 21:30:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Jan 2020 21:30:44 GMT
ENV MATOMO_VERSION=3.13.1
# Thu, 16 Jan 2020 21:31:07 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 16 Jan 2020 21:31:09 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 16 Jan 2020 21:31:11 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 16 Jan 2020 21:31:16 GMT
VOLUME [/var/www/html]
# Thu, 16 Jan 2020 21:31:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Jan 2020 21:31:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e9e903c6f5ff4c873c3c58d4c1d993d14f5af469901a9bdb20cb4dec0ce0fa08`  
		...
		Size: 8.4 KB (8410 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5faa4d5dacbc9c04362e7cd5caedb47a45d13435a7966420fc0a9f051c05ae9`  
		Last Modified: Thu, 16 Jan 2020 21:33:01 GMT  
		Size: 6.1 MB (6143770 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abf912e513a9c694e9f07c261d44cde26a8640500137e0650d5d2b37f8296998`  
		Last Modified: Thu, 16 Jan 2020 21:32:59 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87843f9ebdef2d1789a8dce3a231098a27e6a07580dc340b95cde15ca21ce345`  
		Last Modified: Thu, 16 Jan 2020 21:33:04 GMT  
		Size: 15.2 MB (15152192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66af2e87244afbdaa6b8cf93c9dae51088f65179a4e2d6a00bc6d100faef9e9a`  
		Last Modified: Thu, 16 Jan 2020 21:32:59 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dda1ecacd004e2eee39330d73df1077cb3a33291258c528a2531f6e0b02d9d0`  
		Last Modified: Thu, 16 Jan 2020 21:32:59 GMT  
		Size: 222.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
