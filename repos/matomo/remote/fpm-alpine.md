...
```console
$ docker pull matomo@sha256:d8bd99404b0415ea6546420c5136d5faaaf8b20398f20bece8e4adc52e0d504c
```
...
```console
$ docker pull matomo@sha256:eb71b3d5b9fb58d3d3fcf70b148b623b163739c917097991614aad4ccbf60b22
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.2 MB (47195504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:768e12552f0e4bdcd914b9e5ac554a02ccb51d2e625f86ca6554413cc9e1d38d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Jul 2022 05:22:52 GMT
CMD ["php-fpm"]
# Tue, 19 Jul 2022 14:10:56 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Jul 2022 14:10:56 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Jul 2022 14:14:33 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 19 Jul 2022 14:14:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Jul 2022 14:14:35 GMT
ENV MATOMO_VERSION=4.10.1
# Tue, 19 Jul 2022 14:15:33 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 19 Jul 2022 14:15:34 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Jul 2022 14:15:34 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Jul 2022 14:15:35 GMT
VOLUME [/var/www/html]
# Tue, 19 Jul 2022 14:15:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Jul 2022 14:15:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:030d5c43ce56787eaf64f5c9cb36259164e676a605932a39d450b10f891e8f43`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e572dff2c7267178be86e1bbc77aea1139ff77cf6a2fc08b4e086b84c42b6e9d`  
		Last Modified: Tue, 19 Jul 2022 14:17:17 GMT  
		Size: 5.2 MB (5247424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:842063c60854364d836f1122aa4003cdb11b1b17296d7d3bbce5ac5490b4c7e7`  
		Last Modified: Tue, 19 Jul 2022 14:17:15 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b140865489246bb3fd1184d0563eb2fe307d4d73006845726a15fef9008602c7`  
		Last Modified: Tue, 19 Jul 2022 14:17:32 GMT  
		Size: 16.8 MB (16801211 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4e607de86a78de7c184b150a5b4e54ea3da259a09d92ec1ffe8e734f3c3024b`  
		Last Modified: Tue, 19 Jul 2022 14:17:15 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b396961ac59fb4847d8c17501ea62128190e1d930ec98b0a3b9d727a98d2cca1`  
		Last Modified: Tue, 19 Jul 2022 14:17:15 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:31378e22ecebaefa953ed466a79b4fef4cec614867030210d960eaf2187dae43
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.4 MB (50418400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b92e57c0d560aae3b31f00823914edd3f745d8aa9f7800d167874b55a6c7352c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 19 Jul 2022 10:28:17 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Jul 2022 10:28:22 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Jul 2022 10:30:43 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 19 Jul 2022 10:30:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Jul 2022 10:30:54 GMT
ENV MATOMO_VERSION=4.10.1
# Tue, 19 Jul 2022 10:31:16 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Tue, 19 Jul 2022 10:31:19 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Jul 2022 10:31:21 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Jul 2022 10:31:28 GMT
VOLUME [/var/www/html]
...
-	Layers:
	...
	-	`sha256:e68679c4fc101c818a3134be105a20b89a2f7287088a774b765e43484ac64823`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1315fdff00143f6a1fe9bd9f90fc88a655250b5812c80e8b09e8e4e733eb6e7`  
		Last Modified: Tue, 19 Jul 2022 10:32:48 GMT  
		Size: 5.7 MB (5693861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abcc8592fecc8f5a241451b638288c208dcd83135bd4aff8569534beed092153`  
		Last Modified: Tue, 19 Jul 2022 10:32:47 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ebc98def417fa00795ada4e815b10c297bb235c913a47d9cc2b73352f9fcab4`  
		Last Modified: Tue, 19 Jul 2022 10:32:51 GMT  
		Size: 16.8 MB (16801255 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b12549483dd87ec55770f0514218a45090230450f23ec7b4ef1cf8a5c63562f6`  
		Last Modified: Tue, 19 Jul 2022 10:32:47 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87cb5be6a658fd9ed2b7ae0fda5b8996a5dda5c296d856f43284519c4dfd421e`  
		Last Modified: Tue, 19 Jul 2022 10:32:47 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
