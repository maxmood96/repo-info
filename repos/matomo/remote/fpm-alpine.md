...
```console
$ docker pull matomo@sha256:49cc583104601b5d4db5f3ead74be6cac6424f8eea50e92b0eda19f0e18dbd22
```
...
```console
$ docker pull matomo@sha256:0625a904b88e08d90a2173583788af5725a36eaae1e30dbc58630237ee43a1ee
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49737056 bytes)**  
...
# Tue, 02 Jun 2020 21:25:14 GMT
CMD ["php-fpm"]
# Tue, 02 Jun 2020 22:05:24 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 02 Jun 2020 22:06:46 GMT
...
-	Layers:
	...
	-	`sha256:b164c4c39a4eaf735b2e9e1f764919daad50d7edf638a36a9e55d8e2d83839c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bf71402c5b744aedbc951cdb8bf9defdb61a14618baaeae2511e46768b87fa9`  
		Last Modified: Tue, 02 Jun 2020 22:07:41 GMT  
		Size: 5.9 MB (5877445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d85e9d435e6365b070560f6b2b8336298d60d58b53595123304f3803f7557285`  
		Last Modified: Tue, 02 Jun 2020 22:07:40 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b2bfc537d115b9d133ef3edc54b561b6bc7acabfee066bfa42f8ba82040b60d`  
		Last Modified: Fri, 05 Jun 2020 20:22:24 GMT  
		Size: 15.1 MB (15145865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58e29341ff13f5f7e5b7e472aa5031f4a7b2b22e2f39b71d90b1e180d033ca04`  
		Last Modified: Fri, 05 Jun 2020 20:22:18 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa6ef5b9a5b829e8ccaaae317642549f2256e57e7be7460a535dffe38d9a6c4a`  
		Last Modified: Fri, 05 Jun 2020 20:22:19 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:eae406613188a2161e22fcb3445dd36f0701c0c6841b2db61c68db891f19be24
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.5 MB (48526769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b1d98672559e1bf0ff4eaef6001f6b0ad1335bfe418308eb12195f8572584c9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Thu, 11 Jun 2020 22:13:12 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 11 Jun 2020 22:13:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jun 2020 22:13:19 GMT
ENV MATOMO_VERSION=3.13.6
# Thu, 11 Jun 2020 22:13:32 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 11 Jun 2020 22:13:34 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jun 2020 22:13:35 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 11 Jun 2020 22:13:35 GMT
VOLUME [/var/www/html]
...
-	Layers:
	...
	-	`sha256:110bea8806eab138ee66872cfa7f9b1b041c8bd35f016910dfdc78aeebd7509e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aab2c49ff8a11ed030d3470d14acf55e0a9af60215a23f37bef29800540ad15e`  
		Last Modified: Thu, 11 Jun 2020 22:13:52 GMT  
		Size: 5.9 MB (5869209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ac59a2ff44bfd3defd646ffd7dddd47a1dd8930540bfa46db31cd5fd84f766a`  
		Last Modified: Thu, 11 Jun 2020 22:13:52 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a34c76805ea1aebd8f093d77a21678d65a655811894d3d6f84aa22e9a3672b20`  
		Last Modified: Thu, 11 Jun 2020 22:14:04 GMT  
		Size: 15.1 MB (15146533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba7c62a99b2302f05a4b6c5f39166ea1ca63037bbb41506665c5621b6a4fc772`  
		Last Modified: Thu, 11 Jun 2020 22:13:52 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4af30a5423ce1ec296174b28d731951c5d1f00d4c20fc7ad63fdb11e2cebbbbf`  
		Last Modified: Thu, 11 Jun 2020 22:13:52 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:5cf6eb6ff5ea03ac43e28eeb575d4e4976643c5f8365cfdfedd0ba597ee9cce0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.3 MB (47291076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f51274e0c05f695de476f64ce98f273df4ff77b6e95ed6ef76540fde63a84fea`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 11 Jun 2020 23:45:37 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 11 Jun 2020 23:48:00 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 11 Jun 2020 23:48:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jun 2020 23:48:40 GMT
ENV MATOMO_VERSION=3.13.6
# Thu, 11 Jun 2020 23:49:15 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 11 Jun 2020 23:49:32 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jun 2020 23:49:39 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 11 Jun 2020 23:49:41 GMT
VOLUME [/var/www/html]
# Thu, 11 Jun 2020 23:49:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 11 Jun 2020 23:49:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2c12048701f270884010e6bbe3ce1bb28819a233b8d27b01991c21ee3b34671b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3f4a08363588afd3722a8bfe86480c4a24712960c92033364f96b16d75f06d3`  
		Last Modified: Thu, 11 Jun 2020 23:52:54 GMT  
		Size: 5.8 MB (5772081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e6a705fb6cb44d646330938304ead7e6f59375d59bb74f768102ee2f43e25fc`  
		Last Modified: Thu, 11 Jun 2020 23:52:49 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56434d06b83643eb8ee24cfddbf8a73cc6e6fb3fd77727395ea989a176f79f4e`  
		Last Modified: Thu, 11 Jun 2020 23:52:58 GMT  
		Size: 15.1 MB (15146459 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85c1ed1cc6d6edfe9ecff2f260461b02a82e660e378a980f211370add4f96565`  
		Last Modified: Thu, 11 Jun 2020 23:52:50 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63d325959fcbbb6baa8f594ab4c9095e84078fd81e5bc1dede27b441b623776a`  
		Last Modified: Thu, 11 Jun 2020 23:52:50 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:2d7e26d4a0bc2dabfd726aa5e6bd229df1d4a5e624ad07cd34c7c74f1feab998
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.4 MB (49442466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fa66c0e8190eee2715e74521eab348f0e8bfbf083761f4e771108eb511707f9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 03 Jun 2020 00:22:18 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 03 Jun 2020 00:24:21 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 03 Jun 2020 00:24:24 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Jun 2020 19:41:58 GMT
ENV MATOMO_VERSION=3.13.6
# Fri, 05 Jun 2020 19:42:09 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Fri, 05 Jun 2020 19:42:11 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
...
-	Layers:
	...
	-	`sha256:ab91d36a67014bb8e09dbd2fe842ab500358a868ad396c98dcdada54a7ed8e92`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb8588f8425776c7b8a208c589b58b4a9d4b5d95b0c9741018fd7d4f4d3ec526`  
		Last Modified: Wed, 03 Jun 2020 00:25:40 GMT  
		Size: 5.9 MB (5853937 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfb268c468c23e6b986f7b0b420038b4825350cfb5e2716c4f99865cd6069b91`  
		Last Modified: Wed, 03 Jun 2020 00:25:38 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3db0e280b774cc1351176507df0073ccfb163e8bb7814369371bccb1bc8b35f`  
		Last Modified: Fri, 05 Jun 2020 19:43:18 GMT  
		Size: 15.1 MB (15145883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7988a268f8a327a637f2ef15c4130e624ccdfba567d4c323252b3917a455fb79`  
		Last Modified: Fri, 05 Jun 2020 19:43:13 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:293f4db499921105bd967025bfeb576b9200c65bbd07d4673db98d8bad0b547f`  
		Last Modified: Fri, 05 Jun 2020 19:43:12 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:411eb8fede5c867ed48be2d850afb17e5943b627e5a083c345835f6e29692c68
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **50.3 MB (50304692 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4908e71588d2dc644b4ebfcc15a3aa2edc652897f6b39a8309e54889e5b28e23`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=pierre@piwik.org
# Tue, 02 Jun 2020 23:14:40 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 02 Jun 2020 23:14:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Jun 2020 19:39:26 GMT
ENV MATOMO_VERSION=3.13.6
# Fri, 05 Jun 2020 19:39:33 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Fri, 05 Jun 2020 19:39:34 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 05 Jun 2020 19:39:34 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 05 Jun 2020 19:39:34 GMT
VOLUME [/var/www/html]
# Fri, 05 Jun 2020 19:39:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Jun 2020 19:39:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ce193148c9e450cbc87a224f13ae179e135c984019cd262c24d0bcef58976669`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7639c27750d2caf5edcbd6609096abe74845b9b646d958669eac820c21503c8`  
		Last Modified: Tue, 02 Jun 2020 23:15:39 GMT  
		Size: 5.9 MB (5943354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b17ecf248209c1743df3653236f9f4e0cf31d6ca13e58b4e248ca055cadbeeb`  
		Last Modified: Tue, 02 Jun 2020 23:15:35 GMT  
		Size: 333.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c40295efed13066376fbaaa00e2ee7bfcb6bac131acc90d0198bc4c2d4c3ba90`  
		Last Modified: Fri, 05 Jun 2020 19:40:23 GMT  
		Size: 15.1 MB (15145899 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28cd96007829debea37d22b04a809fc7ae8f2b0a39d6e68d4438759b4ad0fbd6`  
		Last Modified: Fri, 05 Jun 2020 19:40:18 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2fe2be77a8fa5bbd4b5ad9debd7e2d3f13fd053a260a0805d50d649f1d93223`  
		Last Modified: Fri, 05 Jun 2020 19:40:18 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e306358b606f755b440d7cde041855dab804448c49e706f9f41f8c43eca6b950
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.0 MB (50985748 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e114633a63b43330edfc43959d74db694a9f90287e9d5d49c1163af43dd417e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 03 Jun 2020 02:59:29 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 03 Jun 2020 03:01:36 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 03 Jun 2020 03:01:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 05 Jun 2020 20:21:48 GMT
ENV MATOMO_VERSION=3.13.6
# Fri, 05 Jun 2020 20:22:09 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Fri, 05 Jun 2020 20:22:13 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 05 Jun 2020 20:22:14 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 05 Jun 2020 20:22:17 GMT
VOLUME [/var/www/html]
# Fri, 05 Jun 2020 20:22:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 05 Jun 2020 20:22:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6b5a74487d8235e9eacb55d8c53c48909fa465ba36735ed286faece8b88bf577`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:503794660d5b46650e0148569aed51ad726bc37f16b75907f31917067ea0e90b`  
		Last Modified: Wed, 03 Jun 2020 03:04:14 GMT  
		Size: 6.1 MB (6086452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d805f808c49e130be92a263f6b9b6f67d4306ab0715c0ca0ea27cabcc496e282`  
		Last Modified: Wed, 03 Jun 2020 03:04:12 GMT  
		Size: 332.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01e93a350950c993761a892964754aca818f5c6bbdc726f0390793df39287f72`  
		Last Modified: Fri, 05 Jun 2020 20:23:42 GMT  
		Size: 15.1 MB (15145873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d266fe756f3306b74bb8fed2dfe3ee31dbcf1bfebd17fa03a8939e1997c63e03`  
		Last Modified: Fri, 05 Jun 2020 20:23:38 GMT  
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8d7b7451a467992390c4d7293d3a34fc14162efac6c350a41af3c7075cf0139`  
		Last Modified: Fri, 05 Jun 2020 20:23:38 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:46f89be639efb9a8e72d4bcb512dc3d867a9aa8511cfd03dac5543acbbe1b214
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49035374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:565db3330a00176f8426f57db9091c1478fff5ccfc8a2e4d6f82ce2a02c20fbe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Jun 2020 18:34:49 GMT
CMD ["php-fpm"]
# Thu, 11 Jun 2020 21:49:52 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 11 Jun 2020 21:50:54 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .matomo-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 11 Jun 2020 21:50:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jun 2020 21:50:56 GMT
ENV MATOMO_VERSION=3.13.6
# Thu, 11 Jun 2020 21:51:02 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Thu, 11 Jun 2020 21:51:03 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jun 2020 21:51:04 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 11 Jun 2020 21:51:04 GMT
VOLUME [/var/www/html]
# Thu, 11 Jun 2020 21:51:04 GMT
...
-	Layers:
	...
	-	`sha256:b4896cdd505ffd362b66324467b2d79ac069dd0654067833711386176773d875`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c3aadda39348e5e5acff136b777b53fde3dc4929c53abdf0a5dde243be4621b`  
		Last Modified: Thu, 11 Jun 2020 21:52:01 GMT  
		Size: 6.1 MB (6058883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85319fe8c46b0f32c6e683b551160bb80289078efc8e359bc92f7dee3eb733f3`  
		Last Modified: Thu, 11 Jun 2020 21:52:06 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8295def6e983fd72529adf7f8400d325be2f65f5bcf2a311f7c1f4e3f9deefa6`  
		Last Modified: Thu, 11 Jun 2020 21:52:02 GMT  
		Size: 15.1 MB (15146530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:468f55119bdcd66fca2842b4a692046ea840bdfad2076786bb94bab4694ec6ff`  
		Last Modified: Thu, 11 Jun 2020 21:52:05 GMT  
		Size: 304.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5460fa8a54a604076febc297fd62dc2ae939fcd2766229355a59263b904d4ff7`  
		Last Modified: Thu, 11 Jun 2020 21:52:06 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
