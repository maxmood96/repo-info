...
```console
$ docker pull matomo@sha256:534ab1458bce678d4e60459d6b6aefdff900f04a2a75768f8f4c6be717530984
```
...
```console
$ docker pull matomo@sha256:71ba4c54f3710da534030d4e9f4f0324161d917291e77d3bdbbfcc310d932a51
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.9 MB (55880828 bytes)**  
...
-	Layers:
	...
	-	`sha256:c5aa152d140cf8317ad0ceabe47b9393c54f48bbc49e55f8c7c859e50ceb3262`  
		...
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f40a80e8313f721e111731e6067604a85eed9c9b283ed8556754796aed350e32`  
		Last Modified: Sat, 27 Jan 2024 11:00:16 GMT  
		Size: 20.9 MB (20947582 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b0224cd7ba082a4d945c178b0d2469f16a3e952ea1d8811b78d2c6b86ec4e3b`  
		Last Modified: Sat, 27 Jan 2024 11:00:12 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:426f7882669c8f619bbe8b99539a4138efb9e3db68bdae58b761db8c1b657924`  
		Last Modified: Sat, 27 Jan 2024 11:00:13 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:8adc142be0f86a0933e48a715cc097638f7def563d0989e866383903b7e346f7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (53968275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5784c133b2a93a8241f79921ee06d9bc5c30c357d338fba7b2f50d1516474c32`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 06:01:33 GMT
CMD ["php-fpm"]
# Sat, 27 Jan 2024 09:43:16 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 27 Jan 2024 09:44:35 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 27 Jan 2024 09:44:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 27 Jan 2024 09:44:37 GMT
ENV MATOMO_VERSION=5.0.1
# Sat, 27 Jan 2024 09:44:47 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 27 Jan 2024 09:44:48 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 27 Jan 2024 09:44:48 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 27 Jan 2024 09:44:48 GMT
...
-	Layers:
	...
	-	`sha256:76346ff4270699ce5621489a14f91f2659156895337742c85457fb76cf476dd0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0aaef046f40b0f9142567c36d51f8807f7b24bae5f0b35b5802ae13a8b1d2eaf`  
		Last Modified: Sat, 27 Jan 2024 09:45:00 GMT  
		Size: 3.3 MB (3266930 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17f9acdafe8514eb065b53f1e130c1249b9225a660b0c9564e2c614ba93d9be1`  
		Last Modified: Sat, 27 Jan 2024 09:44:59 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:caa506744bf1ab5ced524ccb83a46ffca4722dbe85aaa5cd236248951069b203`  
		Last Modified: Sat, 27 Jan 2024 09:45:05 GMT  
		Size: 20.9 MB (20947343 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0df01b2d4a1896a8808d1183d45793bb323db2f26a4d43ce494c5845614bff73`  
		Last Modified: Sat, 27 Jan 2024 09:44:59 GMT  
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea36d086a898611984c57c9fd7f8d78367bd5a88cd52cda5f422ae8b18574ec7`  
		Last Modified: Sat, 27 Jan 2024 09:44:59 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:dcf9486af912042e1f43cc0e2a6ab19fbda0a888994fb5d429e1c7b7dc83772b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.7 MB (52662863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29d84a1191978c2405f01388abf81d4af874ecbc854d3fd9ea86c621d4512741`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 11:14:20 GMT
ENV MATOMO_VERSION=5.0.1
# Sat, 27 Jan 2024 11:14:35 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 27 Jan 2024 11:14:36 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 27 Jan 2024 11:14:37 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 27 Jan 2024 11:14:37 GMT
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 11:14:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 11:14:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:570351467d1ac7b780c3b4612be355856fedcf76820ec90eb37cda7d020f0cfc`  
		...
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc1d8364bff82170c85d6e71691a03f0f5b6a80e91284f878cc3a0843bd06da5`  
		Last Modified: Sat, 27 Jan 2024 11:15:33 GMT  
		Size: 20.9 MB (20947309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35be586727843c724836412a04b6aad008d076db06dd77b245fbbea6de5db11d`  
		Last Modified: Sat, 27 Jan 2024 11:15:27 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e58761b0e2d8ab7b17ce22c3a988821ffe66607b4155001c2dfba2bffa8ee8f8`  
		Last Modified: Sat, 27 Jan 2024 11:15:27 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:fdcbd93cf0685ede611a13c7ad46d89b30dc2c3ac34097cadf89470eb8299fd3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.1 MB (56071388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddddaf7b2d3ce9d93fd10fe625a05467bf12c0647f08e3d6b16620aa5dbbb135`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 09:10:30 GMT
ENV MATOMO_VERSION=5.0.1
# Sat, 27 Jan 2024 09:10:41 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 27 Jan 2024 09:10:42 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 27 Jan 2024 09:10:42 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 27 Jan 2024 09:10:42 GMT
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 09:10:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 09:10:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:166f9e944e8574c50229e995759ca1389875f1cc2f1f7fb17b37c264e5c4294a`  
		...
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c460fc3e02c7733f6abac36270a8c96bd3a762e2d394b91c5b4efb53cf76d2f3`  
		Last Modified: Sat, 27 Jan 2024 09:12:07 GMT  
		Size: 20.9 MB (20947636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce719e3983ef6c433f4cd6019cbdeab2c7ad5eb75966770a2e4a6b7483b6c198`  
		Last Modified: Sat, 27 Jan 2024 09:12:01 GMT  
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0412e4dd248de4d655c7d6016c3ac90d80cefe427938a18e5edccf759381a974`  
		Last Modified: Sat, 27 Jan 2024 09:12:01 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:315f435846d9ddeeb4ec24a72cad2f8246b00c23c41ece73afb9424d70892971
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **56.3 MB (56315226 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86954db5c964bb0568ca6e16f4757002f09a3c664f41d10822eef68c10db69a6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 03:50:08 GMT
CMD ["php-fpm"]
# Sat, 27 Jan 2024 07:30:03 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 27 Jan 2024 07:31:43 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 27 Jan 2024 07:31:45 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 27 Jan 2024 07:31:45 GMT
ENV MATOMO_VERSION=5.0.1
# Sat, 27 Jan 2024 07:31:57 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 27 Jan 2024 07:31:59 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 27 Jan 2024 07:31:59 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 27 Jan 2024 07:32:00 GMT
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 07:32:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 07:32:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b8ce7c07f8ad7e826f226f530b811bd96fc32d55f47f15f89d99bb5a51c051e6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:132287ced36b4876e9a64da42a425192ccccdcde87c593a348f6f12d2e828a6f`  
		Last Modified: Sat, 27 Jan 2024 07:33:19 GMT  
		Size: 3.7 MB (3697130 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e461a1e0310eeecaa5ae704b9cc957b328c68e1883fe455cd1651a58e46f9348`  
		Last Modified: Sat, 27 Jan 2024 07:33:19 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48c838e57dacf32ef551f1413301f9a6a242195b34e8d8dd5d2acd5a39f3f811`  
		Last Modified: Sat, 27 Jan 2024 07:33:23 GMT  
		Size: 20.9 MB (20947292 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a6605ff06e2f05a0d5346b9f610534bd403c2511904c3727d142932ea416755`  
		Last Modified: Sat, 27 Jan 2024 07:33:18 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7eb25473eee135af790ea9b8ba3481ad954424e8bb422d12c96f78f685c4836`  
		Last Modified: Sat, 27 Jan 2024 07:33:18 GMT  
		Size: 824.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f6d78a8bff4c982906827ebf7f8987b02c310612c434852920ef4dd5945d6910
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.8 MB (57762844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b10898aee9344c1b06886651bc88b4b4345f0a0384b6475f9942861b7e6c30a6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 20 Jan 2024 01:16:09 GMT
CMD ["php-fpm"]
# Sat, 20 Jan 2024 04:59:58 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 20 Jan 2024 05:01:02 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		freetype-dev 		icu-dev 		libjpeg-turbo-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		procps 	; 		docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .matomo-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Sat, 20 Jan 2024 05:01:03 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 20 Jan 2024 05:01:03 GMT
ENV MATOMO_VERSION=5.0.1
# Sat, 20 Jan 2024 05:02:21 GMT
RUN set -ex; 	apk add --no-cache --virtual .fetch-deps 		gnupg 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apk del .fetch-deps
# Sat, 20 Jan 2024 05:02:26 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 20 Jan 2024 05:02:26 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 20 Jan 2024 05:02:26 GMT
...
-	Layers:
	...
	-	`sha256:98026cfa582c573cee293471fc4cc9d0b04f33a9beceafc1f78716b956da1aa4`  
		...
		Size: 9.2 KB (9181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66a044eb47d947d8425ea5b3738a9f88483a04fc2df0bfe55a5f88773e2f668a`  
		Last Modified: Sat, 20 Jan 2024 05:04:21 GMT  
		Size: 3.5 MB (3532948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eed3c70a5400e97e783e0215a4b3b119f91132be1875863f8ccf4cf48e266d3`  
		Last Modified: Sat, 20 Jan 2024 05:04:20 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5ae70be2f285889446afb4e8dceb1418943696dac1c49377b40b44113b9eee1`  
		Last Modified: Sat, 20 Jan 2024 05:04:28 GMT  
		Size: 20.9 MB (20947305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bb6a77608483953e1706feaf3d951d40621e8764bdb4ba81ce0ef92195ae2db`  
		Last Modified: Sat, 20 Jan 2024 05:04:20 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dcd550e2f9a50c9af85da1f484d5bc595ef0f8384ad3ba41e41835fc500252d`  
		Last Modified: Sat, 20 Jan 2024 05:04:20 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
