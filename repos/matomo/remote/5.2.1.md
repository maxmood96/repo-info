...
```console
$ docker pull matomo@sha256:80cc194bb39bd280e7023f447505b0fd41c366054e663e1f9e3f813711261479
```
...
### `matomo:5.2.1` - linux; arm variant v5
...
### `matomo:5.2.1` - linux; arm variant v7
...
### `matomo:5.2.1` - linux; arm64 variant v8
