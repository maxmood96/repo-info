...
```console
$ docker pull matomo@sha256:e53ce03bac8272cd62d40f40fc009f9b69b5dd0f95f6c02ae10a05d5323ad100
```
...
```console
$ docker pull matomo@sha256:2ca8d3db0982ca9d9f404cf68f35135a33f5b07b3de8e3dd2d2784fdb4462466
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.8 MB (165766870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0efd88a3c24e34703dbb85a9095051756cccfdcc79267f848edfe0fb1f5a3e18`
...
# Thu, 03 Sep 2020 23:45:39 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 03 Sep 2020 23:47:11 GMT
...
-	Layers:
	...
	-	`sha256:6bd3f1cf7584a179cfe71fa7109561f9efa5ee0c57f86623154d5761fb74c433`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81b2e33248af9b9abf93d17423c8275ae3151ba1e3b76160a31a89bcdcac9e70`  
		Last Modified: Thu, 03 Sep 2020 23:51:44 GMT  
		Size: 3.5 MB (3519293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd3b4df10058a587f80bb2243c142da4a4713b131c26c843e32b3330b171c790`  
		Last Modified: Thu, 03 Sep 2020 23:51:43 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:822e2650996a539bd3d5451c89593d60c3b74aa5c386cf28687a6ff698932f55`  
		Last Modified: Thu, 03 Sep 2020 23:51:47 GMT  
		Size: 15.4 MB (15380847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a925b06642732ae5c54b53cfbcea2d0b764601a9a034c3701ab58c7c02de845`  
		Last Modified: Thu, 03 Sep 2020 23:51:43 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3d82893bfe76dabb039a40fe8605c0bec96362304785e8088fa671fe7bcc24c`  
		Last Modified: Thu, 03 Sep 2020 23:51:43 GMT  
		Size: 222.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:7a3a9c3fe3549bb377abd43c9e041deb8fd43d28216e601b2bfd720710f20a97
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143912480 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f07acf9cb468e8b5f8ba02a6a2ca93b6c651ef6e946f09b45475860924ee21b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 03 Sep 2020 23:12:22 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 03 Sep 2020 23:15:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 23:16:06 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 23:16:10 GMT
ENV MATOMO_VERSION=3.14.0
# Thu, 03 Sep 2020 23:17:07 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 23:17:18 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 03 Sep 2020 23:17:28 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 03 Sep 2020 23:17:31 GMT
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 23:17:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Sep 2020 23:17:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7a3bb4f619a3f346ffc538bb58dbcace61e4eff7ba544854ce8284c498ef2cdf`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:338d739fd5ff128861afa18d4cb84a602c1771035cd227bc0e0a15c0993c5143`  
		Last Modified: Thu, 03 Sep 2020 23:24:11 GMT  
		Size: 3.3 MB (3335560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9cf963ffdda5272c7e052d51dda2bccb9018e4538c3b705980ae252c6523445`  
		Last Modified: Thu, 03 Sep 2020 23:24:09 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0463a1fae4f335627148a37dcc7332207c8a12acb05dac968a3a73df2f3abafd`  
		Last Modified: Thu, 03 Sep 2020 23:24:17 GMT  
		Size: 15.4 MB (15378903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74e06a802b3fda35f4acbb4ea3b169bb30dacc6d94b83b4bcf18b46faa27e9fc`  
		Last Modified: Thu, 03 Sep 2020 23:24:09 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e48425d8b7954497dcbb04de5db8ac05cd81b7bdbfab2f7cc5697e57ace4377b`  
		Last Modified: Thu, 03 Sep 2020 23:24:09 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:ea42b56455fc515638f93f30dc7723b3af4007afe00221b82bf0bec1d1ddc389
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.1 MB (141105975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96557c64449c77bbd0fe6c5fd3532149a97ec6a227c5fb566b260a69e4bc0ad1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 02 Sep 2020 05:54:15 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 02 Sep 2020 05:56:33 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 05:56:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 02 Sep 2020 05:57:02 GMT
ENV MATOMO_VERSION=3.14.0
# Wed, 02 Sep 2020 05:57:51 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Sep 2020 05:58:00 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 02 Sep 2020 05:58:11 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Wed, 02 Sep 2020 05:58:16 GMT
VOLUME [/var/www/html]
# Wed, 02 Sep 2020 05:58:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 02 Sep 2020 05:58:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:893960d5594c6a6d37cd955d5f4f6d4a2a46d841c9406a0d2194360a78f5891b`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c0d11c6aab7688a367157f496697bab1f3d3e1f7a0c2e202899f058813308e`  
		Last Modified: Wed, 02 Sep 2020 06:07:55 GMT  
		Size: 3.2 MB (3203873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:984643efa18dbbb3150549f5231b0daceefd9a1b64b0fcc7720a0d4e3c17bd62`  
		Last Modified: Wed, 02 Sep 2020 06:07:54 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74ed7bb8937339f55efead04df81e04ae177a376f1d9f1e05f31fda092373672`  
		Last Modified: Wed, 02 Sep 2020 06:08:02 GMT  
		Size: 15.4 MB (15378910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a09f7850eb5436d478c8723b52ac7b38c3d2593699b049c52a5860cebf636941`  
		Last Modified: Wed, 02 Sep 2020 06:07:54 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55b5190ca963e8882a11540e2614b641befa33d3c3c3fba0e2e70a260a8708a1`  
		Last Modified: Wed, 02 Sep 2020 06:07:54 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:c810884a49458b7776233f32e4ddb31911ab08d36a518f08d5286c7d7651018e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157845077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc7ececf5ba6a21a52d0544116744d6a8bd2a083d1c6ac1e9a9101b21b94fa0a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 04 Sep 2020 00:01:15 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 04 Sep 2020 00:03:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:04:09 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 00:04:13 GMT
ENV MATOMO_VERSION=3.14.0
# Fri, 04 Sep 2020 00:05:49 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:05:53 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 04 Sep 2020 00:05:55 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 04 Sep 2020 00:05:56 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 00:05:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 00:06:00 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e46d7362dd725a5a5fa5dfe25321ad04bf3245ea3002971a394264490152e1c3`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d16f820a481f69d1ec312cd7d05c84c011be2fc6139a3788e177c0ed2d3a2327`  
		Last Modified: Fri, 04 Sep 2020 00:18:45 GMT  
		Size: 3.5 MB (3462335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:496bf2284ce256a735030031978e0c6790088cc6550fa45f4ae747359f9ec209`  
		Last Modified: Fri, 04 Sep 2020 00:18:44 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:17b5770d8248969daf7290e396ce690afea4767d860edcc628037f9695bd6a32`  
		Last Modified: Fri, 04 Sep 2020 00:18:52 GMT  
		Size: 15.4 MB (15379879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f812343a76dbd55263a5ea0537071bce7464ceb9b60802f559a2fc77e5585416`  
		Last Modified: Fri, 04 Sep 2020 00:18:44 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47c73d2c5ec4bd1dca28fedb924632929f7472bf7bc604c98dd84772f5f28238`  
		Last Modified: Fri, 04 Sep 2020 00:18:44 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:562de1c215e82e65b0ac185786f13fb03397903a2d98b1d86998ecea069fe766
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.8 MB (171763733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efad9cebab4f0884688977cafe2c927d036558092816a41720bce19b2b9a22a1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 03 Sep 2020 20:01:07 GMT
CMD ["apache2-foreground"]
# Fri, 04 Sep 2020 00:25:24 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 04 Sep 2020 00:27:00 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:27:01 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Sep 2020 00:27:01 GMT
ENV MATOMO_VERSION=3.14.0
# Fri, 04 Sep 2020 00:29:01 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Sep 2020 00:29:02 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 04 Sep 2020 00:29:02 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Fri, 04 Sep 2020 00:29:02 GMT
...
-	Layers:
	...
	-	`sha256:c547f927ae4ed5261298ddc452688a0693f84fc323bc04a0f364ad05eb98f0f2`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96074a7755aa2aa5c578b1cc5a54e030d2dc1f18fb325599ef8d0ee5b9d5a667`  
		Last Modified: Fri, 04 Sep 2020 00:37:52 GMT  
		Size: 3.5 MB (3541313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f618025ebc149af74105de3418e90c965ccafccf24c824d43475b9bcfa508b7`  
		Last Modified: Fri, 04 Sep 2020 00:37:51 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64293a39a84898b96b1bddd14191b01695c9e1ad344ad1cb37a379e4433b4829`  
		Last Modified: Fri, 04 Sep 2020 00:37:57 GMT  
		Size: 15.4 MB (15380086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dcc7aaecffc189fe33eed2dbead9a7abce38abbbfd9c970b4a0262f6b60521f`  
		Last Modified: Fri, 04 Sep 2020 00:37:51 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c45591a70b44fda549495e365be781df7b0fad873c477286bac04a9677c8ddc6`  
		Last Modified: Fri, 04 Sep 2020 00:37:50 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:86a549f5afb40e4a54fa191cc420b2127d1d12e198e82e0de3dd86ce6998d17d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.4 MB (148360872 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c04dc57773166d4db727ce20a42077e197bffed526406a7e87731b617427d14c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 23:33:29 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 03 Sep 2020 23:33:29 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 03 Sep 2020 23:33:30 GMT
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 23:33:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Sep 2020 23:33:30 GMT
...
-	Layers:
	...
	-	`sha256:db8310ca387c997c2172d349a9a1c2b4a7510acfeedf0ac581ca21b6bd0f6d63`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:628f7fee5d98af0eb146ba94006ba7f342ae9d3e3b1f10321a9abd0683befc50`  
		Last Modified: Thu, 03 Sep 2020 23:38:54 GMT  
		Size: 3.5 MB (3471611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb06f37a147685a18e0e745149a426f8e11a208689987b3f1fbde67a46a06ea0`  
		Last Modified: Thu, 03 Sep 2020 23:38:51 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f2fb94f2aa634de5de1f391bb9f56512a6aa8356c3260bdc34fbe905deb1dd6`  
		Last Modified: Thu, 03 Sep 2020 23:39:04 GMT  
		Size: 15.4 MB (15377965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebda86b16ff7502460f02b5921c6e6d8065554cde2563c02999349e2aa5befe0`  
		Last Modified: Thu, 03 Sep 2020 23:38:51 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:369f41a9e03f525ca80473b9abc9d10dde3e192ce7501ea81f44081f136d270d`  
		Last Modified: Thu, 03 Sep 2020 23:38:51 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:1899199a1b630e2605e243c7247c4589a4e8cf0fdf6ff3b3a1fbeeb0de747192
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.2 MB (177197041 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd4615937e8a8317df2d1e78048dd8cc50ca9a20cc5030d9474c0c68b7457d41`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 23:42:12 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 01 Sep 2020 23:44:47 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 23:44:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Sep 2020 23:45:02 GMT
ENV MATOMO_VERSION=3.14.0
# Tue, 01 Sep 2020 23:46:11 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 23:46:17 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 01 Sep 2020 23:46:20 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Tue, 01 Sep 2020 23:46:30 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 23:46:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 23:46:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4ee4159cfdb14c1e0ec1522f3e383a5a6faacebf71a00be0498181634e5fd5c5`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33d08a37105ba4fcaaa4b43d2af9560309bdf8f4909bd412efe27586bd0e66a9`  
		Last Modified: Tue, 01 Sep 2020 23:57:05 GMT  
		Size: 3.7 MB (3744217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffb797c51f5c3d188145094ff1047cb0d0f478972504c5430bb6be6736e25899`  
		Last Modified: Tue, 01 Sep 2020 23:57:04 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9b3bf1e52166a8145dc3cb786d983bd5c424203aa3cb959dcf9615897f4114b`  
		Last Modified: Tue, 01 Sep 2020 23:57:09 GMT  
		Size: 15.4 MB (15381775 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2d93a061f47f97f5a7cf106176b8332576d3b47015092bbd9cca019732ed43e`  
		Last Modified: Tue, 01 Sep 2020 23:57:04 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50e746e2e09fb12bb9c5c281ebe4bb8c32a210c7f0351d7d89d38a0f5c0630ca`  
		Last Modified: Tue, 01 Sep 2020 23:57:04 GMT  
		Size: 224.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e1e225ffd7efc4785e6fdd5d1d92d64cf7add243bc48451dc4cdaead223e41df
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.5 MB (151459640 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce7f5b456353962161fd705ab5482ac51ca41bedd2df40697920d9e8e268230a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 03 Sep 2020 20:39:07 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 03 Sep 2020 20:40:03 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install redis-5.3.0; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 20:40:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Sep 2020 20:40:04 GMT
ENV MATOMO_VERSION=3.14.0
# Thu, 03 Sep 2020 20:40:14 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Sep 2020 20:40:15 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 03 Sep 2020 20:40:16 GMT
COPY file:5a7e05d095f2d5d960fd43fac9e7317ffe1cd3fb9251933251a337b583272d45 in /entrypoint.sh 
# Thu, 03 Sep 2020 20:40:16 GMT
VOLUME [/var/www/html]
# Thu, 03 Sep 2020 20:40:16 GMT
...
-	Layers:
	...
	-	`sha256:271f701f19b3633a7eb94bc1bbb4811d3513f597bdf3ac201279911da6df645e`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7cd1147f16ca28e4974710e32c5220e35478ed2c588ea2c40b8857f1a6ed945`  
		Last Modified: Thu, 03 Sep 2020 20:42:56 GMT  
		Size: 3.5 MB (3476621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77c83dafec3e42e1c5a39e7596311fc828b33f70bd6fe652363951a9b285cc2d`  
		Last Modified: Thu, 03 Sep 2020 20:42:56 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fe202892463b66b27c5f9b4d7e2542014707ccc5a0e9c3f69921f48586023e8`  
		Last Modified: Thu, 03 Sep 2020 20:42:57 GMT  
		Size: 15.4 MB (15379010 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d52328772fd744d56b81e8b1a83a681a461613e546912d20976c46670faae7a2`  
		Last Modified: Thu, 03 Sep 2020 20:42:55 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a16c7e759b680dc6b109634ea399b490de191a64cb8127728c8bddc230c40318`  
		Last Modified: Thu, 03 Sep 2020 20:42:56 GMT  
		Size: 223.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
