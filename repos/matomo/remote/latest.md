...
```console
$ docker pull matomo@sha256:13d9205cc11d6c40c53c5ca5d430b3f7822093d1746e9201f7e28dccb6b2d37f
```
...
```console
$ docker pull matomo@sha256:ab6ad2eaf9633fc8b68626cea6f28bb03770b34a6503ba4f65b6afaa2d6952e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.9 MB (197931494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04d871c41fb6441c5477c02171a6c69cbcec5be61971efa1a2351f6800e58d82`
...
# Thu, 17 Aug 2023 05:55:40 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 17 Aug 2023 05:57:11 GMT
...
-	Layers:
	...
	-	`sha256:a09cf138fb79a1f271c7e34796c86d434cb4af36d26d37271a003fd3bafb8125`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e98171b5a3971026bda31eac06bc5d1db958bd39e6d12205b6d3f1e91ea197a`  
		Last Modified: Thu, 17 Aug 2023 05:59:41 GMT  
		Size: 3.2 MB (3179231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31b1b22b147e61e7861522848b9db86d5ad6406e1574c84fb6fc4fee982170b0`  
		Last Modified: Thu, 17 Aug 2023 05:59:41 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75b4900990c404a36b7e059865d45515f6e4d8e4f921a3aecadcda749cbc56f1`  
		Last Modified: Thu, 17 Aug 2023 05:59:44 GMT  
		Size: 17.7 MB (17690157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1f6a7ccb56dd641a6a56832fb1b855fc924633c1f9e6892545c83f65b746009`  
		Last Modified: Thu, 17 Aug 2023 05:59:41 GMT  
		Size: 338.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bc8d50cc4f64106c38fcbf089b4d44ef4fb6835512dbef1c48f221a7c8c6db9`  
		Last Modified: Thu, 17 Aug 2023 05:59:41 GMT  
		Size: 824.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:af700232dd3f62ffb609105d7d21143dbed8e9629bbe9eb9aaad865ea460d3cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.3 MB (171277386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a03180a240289ae2b69962899ba24b989048f992f042153ec7abf28c97e14b1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 03:35:29 GMT
CMD ["apache2-foreground"]
# Sat, 02 Sep 2023 05:26:35 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 02 Sep 2023 05:27:50 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 05:27:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 05:27:51 GMT
ENV MATOMO_VERSION=4.15.1
# Sat, 02 Sep 2023 05:28:07 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 05:28:11 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 02 Sep 2023 05:28:11 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 02 Sep 2023 05:28:12 GMT
VOLUME [/var/www/html]
# Sat, 02 Sep 2023 05:28:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 02 Sep 2023 05:28:12 GMT
...
-	Layers:
	...
	-	`sha256:23e2b42944177a0de2dadf005bf2495379fd55eaca5e7e05f60310832ce97c0d`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:800ccef0e0b7cdb4cc0daca7d4bc87f9e83605287300dcff91749dbee1d4bbc6`  
		Last Modified: Sat, 02 Sep 2023 05:30:13 GMT  
		Size: 2.7 MB (2653403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c72b81fa27a637cdcca5592a3970cff7533ff6ef6a6924c8b8e4700be1c488`  
		Last Modified: Sat, 02 Sep 2023 05:30:12 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a1d0daf61c7829dcf00781b5ef67600ceee45831baec6070957807a21a2f607`  
		Last Modified: Sat, 02 Sep 2023 05:30:17 GMT  
		Size: 17.7 MB (17688153 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63076702dd89c398be14844f01e2840bca41aabbe3d6fb92ed53e0c4052db266`  
		Last Modified: Sat, 02 Sep 2023 05:30:13 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33ed911600799fa1a8b2140c2adbcf5e22327b5627cbf009a190814bb9c15425`  
		Last Modified: Sat, 02 Sep 2023 05:30:13 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:08890f7757e8ea82c7622be8ef076fe8662f7336ea35a73900e36291a9d66777
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.0 MB (192047034 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:28de329f1635fa39f45b566299ecbc30717a79b1d4e64bbaed656111545722cb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 06:13:56 GMT
CMD ["apache2-foreground"]
# Sat, 02 Sep 2023 07:58:53 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 02 Sep 2023 08:00:42 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 08:00:42 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 08:00:42 GMT
ENV MATOMO_VERSION=4.15.1
# Sat, 02 Sep 2023 08:00:55 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 08:00:55 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 02 Sep 2023 08:00:55 GMT
...
-	Layers:
	...
	-	`sha256:978875720ba76b3996145eb72e745dd7b5f5954927e65e8b7bb11b7005367702`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8bd071bc3e53a664adf8acadb3cf637dc546ac003c1971683aaf7b6dafb7619`  
		Last Modified: Sat, 02 Sep 2023 08:05:27 GMT  
		Size: 3.4 MB (3430855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d98f4f8f8532b6a36582ec36ec3e97fe10601a045c532c7d606bcf3d85eb05c7`  
		Last Modified: Sat, 02 Sep 2023 08:05:26 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04677f1b2c52be9fba766d053b44a45b49b8caa450ac4e929802cd2c5cedd3b3`  
		Last Modified: Sat, 02 Sep 2023 08:05:29 GMT  
		Size: 17.7 MB (17689915 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:312a4209a26c616fc114e793947602f74014599f7314aecb134f1c6c6e6040bc`  
		Last Modified: Sat, 02 Sep 2023 08:05:26 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6715a27b551805758c1009de3c458167357f7058780a81bde90783f0aa38817`  
		Last Modified: Sat, 02 Sep 2023 08:05:26 GMT  
		Size: 821.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:15fe316cf3f306b1353f94e44faf717580d26e5c4ae22a468e2c58ba2e546c7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.0 MB (172046890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:065d497d5195ff446b4a6d0402a720b521080f0a79c77ff1be9359eaf66a2a9b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 16 Aug 2023 23:44:57 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 16 Aug 2023 23:49:36 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 16 Aug 2023 23:49:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Aug 2023 23:49:46 GMT
ENV MATOMO_VERSION=4.15.1
# Wed, 16 Aug 2023 23:50:51 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 16 Aug 2023 23:50:57 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 16 Aug 2023 23:51:02 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Wed, 16 Aug 2023 23:51:07 GMT
VOLUME [/var/www/html]
# Wed, 16 Aug 2023 23:51:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 16 Aug 2023 23:51:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c85d5cd6ced52f9539807d0390b6fe21a04a5b153431b4187e2e1da28b7a4c95`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb85834c574d48532b432a00f3bdf552194b4b5c7dc41086adf2956fe252eaba`  
		Last Modified: Wed, 16 Aug 2023 23:58:26 GMT  
		Size: 2.6 MB (2556322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05ebb8044a1ccd22018f6eb85fdcf973b74e96c7959eec6b0b38d5ee32e9e36f`  
		Last Modified: Wed, 16 Aug 2023 23:58:24 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6406a69a964610dc3bb8021d2485232ad9ebfb64cc5629185fb9315d4c59c700`  
		Last Modified: Wed, 16 Aug 2023 23:58:39 GMT  
		Size: 17.5 MB (17482000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb8c86d2cd579b0274bf3bbfa728f56b8ab883189e434102ff28ffad81f730b2`  
		Last Modified: Wed, 16 Aug 2023 23:58:24 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5798b3f6a3850df57c27607b3715c88c60119cf27e8d89835234fc9226a0eedb`  
		Last Modified: Wed, 16 Aug 2023 23:58:24 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4a30a4faa2d0d522b84195f3d023232d5a3778d1bc9e55152b334d85bbda131d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.2 MB (171212303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37df049e64a2c576ee654cb72cc432a26cfca69ee3c071fbcebc963700f94c26`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 02 Sep 2023 03:40:05 GMT
CMD ["apache2-foreground"]
# Sat, 02 Sep 2023 06:08:27 GMT
ENV PHP_MEMORY_LIMIT=256M
# Sat, 02 Sep 2023 06:09:17 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 06:09:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 02 Sep 2023 06:09:18 GMT
ENV MATOMO_VERSION=4.15.1
# Sat, 02 Sep 2023 06:09:29 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 02 Sep 2023 06:09:31 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Sat, 02 Sep 2023 06:09:31 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Sat, 02 Sep 2023 06:09:31 GMT
VOLUME [/var/www/html]
# Sat, 02 Sep 2023 06:09:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 02 Sep 2023 06:09:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:51c5b23141d5bbe42a5d243300ff5dd37683e58535b791b975fbc001a3f8fd91`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7dabfd368b84446c7b8d37eed6a166cf150b8c2056d46d484bbb88e819b23506`  
		Last Modified: Sat, 02 Sep 2023 06:12:36 GMT  
		Size: 2.7 MB (2733703 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68cfb92a3e13a55050270024bd6fb0e7d93fbb8560b1639b853d96f7efeef88e`  
		Last Modified: Sat, 02 Sep 2023 06:12:36 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:018451928d9bfdae995549c3126cab4d77679f13475389c10a2bb3c17d670c3f`  
		Last Modified: Sat, 02 Sep 2023 06:12:38 GMT  
		Size: 17.7 MB (17688599 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8eebc6fe03b02831f26574de6e7d0bd47c95f1689a5257481db8ebeb37eca2b7`  
		Last Modified: Sat, 02 Sep 2023 06:12:36 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d40adc799253156495a8f51093ff37dd3026fca9ed70488d2b8663075cc0da2`  
		Last Modified: Sat, 02 Sep 2023 06:12:36 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
