...
```console
$ docker pull matomo@sha256:46536704d5c59dfc036f9e75d475a75fcda5c4b8fddc3f6b623c1475b355e126
```
...
```console
$ docker pull matomo@sha256:ca05fd88c99bfd3f3174567c1deedb17b0ab6cbd63ec957c5d8b72633cb12c6d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.6 MB (184617085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e08bff781a7380a2890ba480cef12f39285f3fc580114f04dd5bfacaa9d51962`
...
# Wed, 03 Aug 2022 08:22:55 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 03 Aug 2022 08:22:55 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 03 Aug 2022 08:24:26 GMT
...
-	Layers:
	...
	-	`sha256:fe5ee78bd9a69fa8dd3590074a82f0dfc87bba3e7f3c7834de00c4e3a9f7474f`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:499c6596017a7e902a9f4d20a812b5abdd0da58d0362b49ecf301c69900a8334`  
		Last Modified: Wed, 03 Aug 2022 08:27:04 GMT  
		Size: 3.4 MB (3358363 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dbdf32d90c010023f38a67436b844d063da4ba919e3742a13f86de37a6f37cf`  
		Last Modified: Wed, 03 Aug 2022 08:27:03 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:46597571c54d4986f5d5fc26869efff340fc3a2db2d68f3ab9f739d3f3cdd246`  
		Last Modified: Wed, 03 Aug 2022 08:27:06 GMT  
		Size: 17.1 MB (17133550 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16a7f14c2b7620b7327cb518ee24cdca15f0ea4dbbff183c8485932d7614f580`  
		Last Modified: Wed, 03 Aug 2022 08:27:03 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cebfef954e19713d6c680fbaa1c7db9bde5b25aed7b7c2963d07e8ff82ac23df`  
		Last Modified: Wed, 03 Aug 2022 08:27:03 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:75c3df68fea4607d60225080e2ef1a4cb11133c259c5648f609bcd6c61c2786a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.0 MB (162038366 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59e760db4613413623c045f7cce4aab1d946439cd9bbc425f07baef918274014`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 02 Aug 2022 15:39:35 GMT
CMD ["apache2-foreground"]
# Wed, 03 Aug 2022 17:31:32 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 03 Aug 2022 17:31:32 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 03 Aug 2022 17:33:34 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 17:33:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 03 Aug 2022 17:33:35 GMT
ENV MATOMO_VERSION=4.10.1
# Wed, 03 Aug 2022 17:33:53 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 03 Aug 2022 17:33:53 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 03 Aug 2022 17:33:53 GMT
...
-	Layers:
	...
	-	`sha256:f0ff530afa3ab84ce4bcef98aa732badcfbb8a39e7c12bf361f09471561df1c4`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00f3f5a7e6d0c26962cc9ca4c8b1a1b2b91d70f24f7f3f32fc16b3b3c28f6650`  
		Last Modified: Wed, 03 Aug 2022 17:37:10 GMT  
		Size: 2.8 MB (2832806 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:defa2d66acee5cc827f3de2c1605cf43e74bed7a93f8f4be755b22aa635146d4`  
		Last Modified: Wed, 03 Aug 2022 17:37:09 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b20a38ac4a8c3c374099cfa54d606e326979caa1859ae12407093b8b00e6f6a5`  
		Last Modified: Wed, 03 Aug 2022 17:37:15 GMT  
		Size: 17.1 MB (17131981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8679b6c1a2cf1d94bc90d6eea569e7cb381266232479e3ba20ff5d22012c3ee`  
		Last Modified: Wed, 03 Aug 2022 17:37:09 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79aaca7d2c32252789301de7b0a4683deb3101136fcecb766f2822362bf28908`  
		Last Modified: Wed, 03 Aug 2022 17:37:09 GMT  
		Size: 633.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
