...
```console
$ docker pull matomo@sha256:6fa716cfb5eb44910ca7e04a9c9ef367885f749845db91c6bce3f6ff8e92e24d
```
...
```console
$ docker pull matomo@sha256:0d31fc44de58e4f93e7da040511e3fd8edf5ae992eb506e14372461ed0b9a712
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.7 MB (202694371 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f61e319f80f6cfecdd8b4c8e22026e69cebee0ea3296ba4d63f09ef21bc7415c`
...
# Thu, 13 Jun 2024 09:02:21 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 13 Jun 2024 09:04:04 GMT
...
# Thu, 13 Jun 2024 09:04:05 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 13 Jun 2024 09:04:19 GMT
...
-	Layers:
	...
	-	`sha256:4cd80e85911aaff23eb0722e5ad55f06b55fd6f70c9b437e908667746ffaecf0`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f7034de5bc67d306f063be56c3f452e260bba455f80ab7183ffb83aa856144f`  
		Last Modified: Thu, 13 Jun 2024 09:06:52 GMT  
		Size: 3.5 MB (3463114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef4be73c15810fd485972cc155bcb032e51697fbc39be82aa4750c4033590577`  
		Last Modified: Thu, 13 Jun 2024 09:06:51 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff25fe97b80aeeb8b24dd1debf4a5491db50d2364ac398a24d18e75903ec059b`  
		Last Modified: Thu, 13 Jun 2024 09:06:55 GMT  
		Size: 21.5 MB (21547213 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed816814681044d92f7d68605f17dabce728bd335275624d39332a9f7672b5a5`  
		Last Modified: Thu, 13 Jun 2024 09:06:51 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b784d77c9866acff708cf579a46f8ba711978f2544686cc170b3f9bb8d86ad`  
		Last Modified: Thu, 13 Jun 2024 09:06:51 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:21f5569c8019dd6fc7ff6304e22cd1889ea35f1a8b0522127f0d9801b735cd17
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.8 MB (175839381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3d7969ef61e754b2d6c915ee58cc7605b00eb2c1029465e2078807467e3ee4e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 13 Jun 2024 02:01:00 GMT
CMD ["apache2-foreground"]
# Thu, 13 Jun 2024 07:53:12 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 13 Jun 2024 07:55:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 07:55:50 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 13 Jun 2024 07:55:50 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 13 Jun 2024 07:56:19 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 07:56:20 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 13 Jun 2024 07:56:20 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 13 Jun 2024 07:56:21 GMT
VOLUME [/var/www/html]
# Thu, 13 Jun 2024 07:56:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 13 Jun 2024 07:56:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d7ccb474409931ecc65da2295e4946e8b14bc1e82db2fb704247e554616f5005`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2031dbc3bedb7f327d275c52c82032f571a9aa0c6f5d5254edcadd2dd55f288d`  
		Last Modified: Thu, 13 Jun 2024 07:59:59 GMT  
		Size: 2.9 MB (2930750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab1b00f2a8913611fe3421c15a2076eeb3c5cbde0de468d4636439c94940be68`  
		Last Modified: Thu, 13 Jun 2024 07:59:58 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd7c33a154cdb04f398c0d76574dfaa38a9dade9c3f3430becd566cccb90c352`  
		Last Modified: Thu, 13 Jun 2024 08:00:08 GMT  
		Size: 21.5 MB (21544883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0f523cdb48bbda4cf494971b62c787f5d167d2512348c5b32300ac8cbf5ee5f`  
		Last Modified: Thu, 13 Jun 2024 07:59:57 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b74b1979c5bc88056ba048719bbc87b30bcdd998de964f5667f1da5343180efc`  
		Last Modified: Thu, 13 Jun 2024 07:59:58 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:59c665f381928f19b1e6778666320bd5d007c91613159ab1bd712ffb55c3da6b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166586826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17935ff494bfeb391c3dbea2f733e03a9e1a376c51e98832913951e548e3f82f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 20:16:10 GMT
CMD ["apache2-foreground"]
# Thu, 06 Jun 2024 23:17:58 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 06 Jun 2024 23:19:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:19:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jun 2024 19:25:32 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 11 Jun 2024 19:25:48 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jun 2024 19:25:49 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 11 Jun 2024 19:25:49 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 11 Jun 2024 19:25:49 GMT
...
-	Layers:
	...
	-	`sha256:f3b49f440d947e5019b9ba143e043f167d8055d13cdf637a083fab9b8fd7544e`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc384f46e10ece214dcbc68a91544b0c77b31b397c2ce5639d42fdf5f9d337ee`  
		Last Modified: Thu, 06 Jun 2024 23:24:07 GMT  
		Size: 2.8 MB (2809428 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c12848ac69da2b323f206a444a6f6a77483bbdc5a0df52099011ee728606a6b`  
		Last Modified: Thu, 06 Jun 2024 23:24:06 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5238d50d68ee70e9ac0e34da7712e08cca60a090199c5a96e372ed66693b8748`  
		Last Modified: Tue, 11 Jun 2024 19:26:42 GMT  
		Size: 21.5 MB (21544970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa76c0bd8df34cee3c5c0b6eb1d15a7b26b2b4e9c53bf25988f789aa306df7dc`  
		Last Modified: Tue, 11 Jun 2024 19:26:37 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53a606bdec620e6d33d3bdd7340f6f70f469e3a2fa63c370f8a76529e651cddd`  
		Last Modified: Tue, 11 Jun 2024 19:26:37 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:44f8fa1d5147c94413e03ef9b5b16f2955dc0bca655778dbd8732cbbdf04e8f8
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.7 MB (196744332 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5863557e2729451151438f75a25ab137f31c2a71eb007f9e4f1f4d09d3570e9b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 06 Jun 2024 23:36:06 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 06 Jun 2024 23:37:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:37:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jun 2024 20:12:02 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 11 Jun 2024 20:12:15 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jun 2024 20:12:16 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 11 Jun 2024 20:12:16 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 11 Jun 2024 20:12:16 GMT
...
-	Layers:
	...
	-	`sha256:1f379fe7d4ee59ba1e3e061434042f65b3222c2f71a515c8a3292ae07ba45f50`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13d5e3de8954c132ea10604ac5ef31d6cb2e8cf2e6d542755559c349dd52a377`  
		Last Modified: Thu, 06 Jun 2024 23:43:10 GMT  
		Size: 3.7 MB (3707670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f1f3abff0ec0e121c66eec4529aeecacca0cf93f6e46e04748e98dfa390d2ae`  
		Last Modified: Thu, 06 Jun 2024 23:43:10 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f8284d72f2291393fd2a7ef3cb706b8d6b0ea0fddbaf2b4636c302f462b75c0`  
		Last Modified: Tue, 11 Jun 2024 20:13:03 GMT  
		Size: 21.5 MB (21546925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec763ea82d53e79218e1310f8c93366f8c745f895492db4402bd42f6d0cb08cf`  
		Last Modified: Tue, 11 Jun 2024 20:13:00 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0624bedb8424faedde9e2c8417d8b05f7618ae82c33765a10f5d0399afccf5fd`  
		Last Modified: Tue, 11 Jun 2024 20:13:00 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:cd31c09c4617d3974c25c55fb94e4607e0502781aff241281592af4e70d45095
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.6 MB (201568536 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:835ad9ed4df75b4294619f59703168ab757e30950fd2df62cee4023952b0446b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 11 Jun 2024 20:08:42 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 11 Jun 2024 20:10:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jun 2024 20:10:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jun 2024 20:10:40 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 11 Jun 2024 20:10:57 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jun 2024 20:10:58 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 11 Jun 2024 20:10:58 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 11 Jun 2024 20:10:58 GMT
...
-	Layers:
	...
	-	`sha256:7e8f6332a20db7701987a64751d0cbe79660c3372ad5540638800ee5aed61c74`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3008130f657b55fcfba6e92dc13fa35929cb24d72377b56ef2c24c714bd26dee`  
		Last Modified: Tue, 11 Jun 2024 20:16:20 GMT  
		Size: 3.4 MB (3414015 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b6f3054f43534a44d3693d6f122e65befd0f4bc001d99f7599ab72b129f6cdd`  
		Last Modified: Tue, 11 Jun 2024 20:16:19 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcfb08007f6cf2d611ce7ea4a3079d4f0c8a97f19b4163ef855aba19e7017341`  
		Last Modified: Tue, 11 Jun 2024 20:16:25 GMT  
		Size: 21.5 MB (21546124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fede974f05fd55b80c7b74a02e4b8c1889d8df7f4dec7b8143ca1f291b701d0`  
		Last Modified: Tue, 11 Jun 2024 20:16:19 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:295cab05caf1f573215e427a26049f9b8d04a79a76871138f435f9a902b210d7`  
		Last Modified: Tue, 11 Jun 2024 20:16:19 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:75f2b058350fe8a3af7a55cb013d343528b3b1efa83db8d9fb171324cdcc07dd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.6 MB (176570010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8431bbe8cd23b213f294715788277d7c120348f7d5936eb2f02d4cfe0117894`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 07 Jun 2024 04:35:05 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 07 Jun 2024 04:40:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 04:40:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 11 Jun 2024 19:53:15 GMT
ENV MATOMO_VERSION=5.1.0
# Tue, 11 Jun 2024 19:54:26 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Jun 2024 19:54:32 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 11 Jun 2024 19:54:38 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Tue, 11 Jun 2024 19:54:44 GMT
VOLUME [/var/www/html]
# Tue, 11 Jun 2024 19:54:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Jun 2024 19:54:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c84dd852ff1d66156021f95623407db6a61e9cf8d23ec2f5511accdf9eb3ff64`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78964a466f3d98ca89dfb2e058fbade99a4a847f192da377121e6b5fb2110aba`  
		Last Modified: Fri, 07 Jun 2024 04:49:49 GMT  
		Size: 2.8 MB (2830869 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ff5b78087c4885424be95a3a448aba72503ca1c469d7d9f63b0eb3621324da5`  
		Last Modified: Fri, 07 Jun 2024 04:49:46 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:853b9a0c096e777dc484177442486117321c661685b9293de3df0fed0438306e`  
		Last Modified: Tue, 11 Jun 2024 19:57:22 GMT  
		Size: 21.3 MB (21339065 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c442b9724d7741d7f8c84b3d781f15b7d04987338d2799e57716ed5a5f4557b`  
		Last Modified: Tue, 11 Jun 2024 19:57:06 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d66019e2b1a080701f787f210ac4ddb41749f1a99b8f02a97a2b7cfd43942d07`  
		Last Modified: Tue, 11 Jun 2024 19:57:05 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:628172c16783b6360848466f00cb688a36cb12a3054d879cbc0e213b787d09bd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **207.2 MB (207151779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca6fe405d422c4377605a3ec88e593927bcfe3e7619a1301db292063a113cfcb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 13 Jun 2024 08:56:34 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 13 Jun 2024 08:58:14 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 08:58:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 13 Jun 2024 08:58:16 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 13 Jun 2024 08:58:36 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 08:58:38 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 13 Jun 2024 08:58:39 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 13 Jun 2024 08:58:39 GMT
VOLUME [/var/www/html]
# Thu, 13 Jun 2024 08:58:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 13 Jun 2024 08:58:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5ed565d989b82ef7c69dd8c28073cc99d94abc014d76c97b1c4068e8d0b268cc`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c333ba960fcc150a9de0eab348a56c98749fbe1e1c91f870b698984ef05be81f`  
		Last Modified: Thu, 13 Jun 2024 09:01:22 GMT  
		Size: 3.4 MB (3374721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37431ea43a8770b1316840ce59116b7c1238de34646522e79ec529fb4a325c5d`  
		Last Modified: Thu, 13 Jun 2024 09:01:21 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ce2fc3c751b5fdd8da41d8a6f798cc08455febb3524fbc5e7ecd20c5315645e`  
		Last Modified: Thu, 13 Jun 2024 09:01:26 GMT  
		Size: 21.5 MB (21546637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f5056ae147a2e5dffc36ea668af883a7a2b89aaa53efba2731b9c524c0370e3`  
		Last Modified: Thu, 13 Jun 2024 09:01:21 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7789e6c7828848c1b0dba1888cbc5a7791f49d8e3abdcb20ea9aebf3e6372c4f`  
		Last Modified: Thu, 13 Jun 2024 09:01:21 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:98f126c2ce206314a53e4482fb3b25cfa74842da532d1319efe149944d40b85c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.1 MB (176063731 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19b5b91eb4d7877e6ec5b17c27624c11ec5bb4379067dbb9831ced59a29a6f37`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 13 Jun 2024 04:33:12 GMT
CMD ["apache2-foreground"]
# Thu, 13 Jun 2024 06:27:01 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 13 Jun 2024 06:28:00 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 06:28:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 13 Jun 2024 06:28:00 GMT
ENV MATOMO_VERSION=5.1.0
# Thu, 13 Jun 2024 06:28:15 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 06:28:16 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 13 Jun 2024 06:28:16 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 13 Jun 2024 06:28:17 GMT
VOLUME [/var/www/html]
# Thu, 13 Jun 2024 06:28:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 13 Jun 2024 06:28:17 GMT
...
-	Layers:
	...
	-	`sha256:a49af3462d5f08982ba2fc748fb2c58bc3db4ee277d6ad32e341a98c17b38cae`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84d0cda2c9dc771f98dd9058753564807f68f1dea5ba0d592f98d02d6c8d6bd3`  
		Last Modified: Thu, 13 Jun 2024 06:30:04 GMT  
		Size: 3.0 MB (3008269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c921c39beaac5b71231b7a2e7c9c7c5c02fc2fdb20380fbe12ef9060b983ef4`  
		Last Modified: Thu, 13 Jun 2024 06:30:05 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4000a11d78cdd33ec23d6e4c1f766ab614d6f142b68cc7766ca9fcd2e2e319f`  
		Last Modified: Thu, 13 Jun 2024 06:30:07 GMT  
		Size: 21.5 MB (21545485 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:502bec391a1c34f52f751593a780763094a15b3fb491bad3082676f13d429256`  
		Last Modified: Thu, 13 Jun 2024 06:30:04 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4606b83500448fc4b2ffc748d2e447fb61be5ef982fc75437ef48eef20755c6`  
		Last Modified: Thu, 13 Jun 2024 06:30:04 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
