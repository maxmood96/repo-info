...
```console
$ docker pull matomo@sha256:26db4ef39af216d8043cee12d68b697b7899c0aed2cfb063a0b3a033424c5910
```
...
```console
$ docker pull matomo@sha256:82c544bfa09b57ea501b31a71329060a598ec7b3e0550aeee6a522587d2d3397
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.5 MB (184537663 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b61a1af509a35b885ae2dbebc0e4bb92b44f83131b60e64ed9b6ab8e8826b4d`
...
# Tue, 19 Apr 2022 03:32:08 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Apr 2022 03:32:08 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 03:33:40 GMT
...
-	Layers:
	...
	-	`sha256:ab76a6b28dbd0cbfda24c1070cb8be923d1dc205009e54f6d25f508dbae862a7`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e8d4050df4ef764fb0d0a517a85aaef2495d72225ea149e2ac6dccef1e442e0`  
		Last Modified: Tue, 19 Apr 2022 03:38:34 GMT  
		Size: 3.4 MB (3357299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0712f70a2373e6782a7c53e80704d7a8d66f6048eda9e3dc2554b51221af7c0d`  
		Last Modified: Tue, 19 Apr 2022 03:38:33 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:539c1b5ff92737cad941849b1ca2fe78a53c176dd8a79c7fcd21b59559a32bbf`  
		Last Modified: Tue, 19 Apr 2022 03:38:37 GMT  
		Size: 16.9 MB (16900968 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f154d79c3c804f9dfb567f7f83618ffc993ece64961e980810f1a6355f4f6288`  
		Last Modified: Tue, 19 Apr 2022 03:38:33 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eae74c426dd1644c8f67f5c83fd44449050c9fca3c104a3b5e6e5f8f6710af27`  
		Last Modified: Tue, 19 Apr 2022 03:38:33 GMT  
		Size: 633.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:e776cdf566d4768b0d5e42b3c65ba41b4828b1b3c92852175e8d3afe2382490c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.9 MB (161943735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c35464f742d37bde6d0d9da2bba827275b6577c5a912322f227785289ff8fde7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 19 Apr 2022 00:45:33 GMT
CMD ["apache2-foreground"]
# Tue, 19 Apr 2022 04:20:22 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Apr 2022 04:20:22 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 04:24:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:24:13 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 04:24:14 GMT
ENV MATOMO_VERSION=4.9.0
# Tue, 19 Apr 2022 04:24:58 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:24:59 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Apr 2022 04:25:00 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Apr 2022 04:25:00 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 04:25:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 04:25:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1d770694df1c8dd05bed82001e219c9a7e492b7e4ebee25685f6bd81c66bd4b0`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:611228761b440177bf14cecc1f4bf3281f03fa09e82ae630fa85d2e7610bb690`  
		Last Modified: Tue, 19 Apr 2022 04:31:08 GMT  
		Size: 2.8 MB (2832180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:145cc106487a6e4172897f3a96d06c5ed167c33552c37762f284d9e16fee5106`  
		Last Modified: Tue, 19 Apr 2022 04:31:06 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41aafb59e85a4492219f09bc4a19c409656a477a4bd9f82c8af65293d032fa8f`  
		Last Modified: Tue, 19 Apr 2022 04:31:23 GMT  
		Size: 16.9 MB (16899644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a74688521cf44c6c6b2ea6ee47fa8719c3d563231ff3b9abd47e3df3e55b7bdb`  
		Last Modified: Tue, 19 Apr 2022 04:31:06 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2b449d35e1ece969585b94170fdc3ac0f449c9d76b6f197cb4598a367afb6bf`  
		Last Modified: Tue, 19 Apr 2022 04:31:06 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:87f17d5a781138ee8c5856ba90d20158800ea771e9fbe9430ffc226d7e703bc0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.5 MB (176456764 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:862c07c0c8fe61544548ecd55b3f9e9676a429d5cdc8f3765b5ecfbbaccefd40`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 04:58:14 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:58:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 04:58:15 GMT
ENV MATOMO_VERSION=4.9.0
# Tue, 19 Apr 2022 04:58:51 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:58:52 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Apr 2022 04:58:53 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Apr 2022 04:58:54 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 04:58:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 04:58:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:471355730cdabe8d3867b31c207621195bb55080c9baf2d98592cbb9519def01`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e55228699fdbb77d3213f835a348ea021051375c70bd8472d05fd91fe60c5a6`  
		Last Modified: Tue, 19 Apr 2022 05:04:01 GMT  
		Size: 2.8 MB (2760096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76c5da411e0545963ecd0dfca29a4c2718397332deac101f82bc4909094e0ec2`  
		Last Modified: Tue, 19 Apr 2022 05:04:00 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fed43118989f10798371cdd2300e020fe9910d74af68fd4f027f6c31e9fed4ac`  
		Last Modified: Tue, 19 Apr 2022 05:04:04 GMT  
		Size: 16.7 MB (16683861 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51b05f4c99405cadd1c48711188c867c35c3968da1052370d3a9c82204a2fe68`  
		Last Modified: Tue, 19 Apr 2022 05:04:01 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:992b3a07f6b94230255c827596d6cee78b55f9a6db294ffced7c3649e5af5cb0`  
		Last Modified: Tue, 19 Apr 2022 05:04:00 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:d717fcebfe1f6cbdee2361a4bf357cbb655a25ca117adeca3f5b9f1a8ad3d498
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.8 MB (160797240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:380004b35b946505558210e55a78f9a95797633f581d4d3b7a2722600c9f0c60`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 19 Apr 2022 09:39:05 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Apr 2022 09:39:08 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 09:44:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 09:44:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 09:44:15 GMT
ENV MATOMO_VERSION=4.9.0
# Tue, 19 Apr 2022 09:45:21 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 09:45:27 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Apr 2022 09:45:32 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Apr 2022 09:45:38 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 09:45:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 09:45:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b39954375869d486227d81df4d56d725f3f6c700818ed0661b2329b58e2b35f2`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe4ff22e274375b3db6bfee8b3a1669b92a3d82661fc705d32196b3ab16e0fbc`  
		Last Modified: Tue, 19 Apr 2022 09:53:21 GMT  
		Size: 2.8 MB (2757934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2baee40d0c517faa482ad29ff94375401ed78c8206fcfd8ecfb58c5e256cd977`  
		Last Modified: Tue, 19 Apr 2022 09:53:18 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c760e99ba3252f44e97f82f022b05da9d6bf93da8d137183cab4b0749149bac`  
		Last Modified: Tue, 19 Apr 2022 09:53:32 GMT  
		Size: 16.7 MB (16683521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fe7c702dc8ea13d10bf5d1ad3170c26f1f34ab75f1fe89f692d81adfbb3cba4`  
		Last Modified: Tue, 19 Apr 2022 09:53:18 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fe79d0fbc95d52ac245023f946684c951dc77e7ab958aaf35c242baf3d9e9a5`  
		Last Modified: Tue, 19 Apr 2022 09:53:18 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:d485f3f2912debde89b53cbb01842ee17975c7208b3c01afbabfb4a1380e61d8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.0 MB (184965514 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ca52d717febc7e36fa56b98b83f0067159e6eb9b12c09aee6617d29b80aa2243`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 19 Apr 2022 14:44:18 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Apr 2022 14:44:27 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 14:47:45 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 14:47:58 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 14:48:04 GMT
ENV MATOMO_VERSION=4.9.0
# Tue, 19 Apr 2022 14:49:25 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 14:49:32 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Apr 2022 14:49:34 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Apr 2022 14:49:37 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 14:49:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 14:49:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0f42ed2db508ff307382252bc73faceaa68e7da38026d764f0ca9c3d8263b5f9`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b82d62518d4acc6592c52b08392444ca89ea6dbd2142f7246f814d615465baf5`  
		Last Modified: Tue, 19 Apr 2022 14:59:46 GMT  
		Size: 3.3 MB (3274554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c39a2a43d43c16b065e0600c728db93b82e765c496e38602e5752d5b561e3ce`  
		Last Modified: Tue, 19 Apr 2022 14:59:45 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e063a91177259e6e5445872d11c34266e160950024dcb830c94e9115a24965`  
		Last Modified: Tue, 19 Apr 2022 14:59:49 GMT  
		Size: 16.9 MB (16902293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65c3f083550b48f50dd7388d6a5e307e6008623a2c767fcf9a99803026604deb`  
		Last Modified: Tue, 19 Apr 2022 14:59:45 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184e64f5181d3b346837959027f24e06caadb10958ab15099ff488dc5a3a0292`  
		Last Modified: Tue, 19 Apr 2022 14:59:45 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:ac84e0beda6d53ca3d3ce761fed332b8bcdfc4c8b2b97b9e8b19751a9a054674
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.4 MB (161409641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:382ee852d06ba1d4cc9abb34646332b4e41355c73a814df9014a279a71ceb422`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 19 Apr 2022 04:39:04 GMT
LABEL maintainer=pierre@piwik.org
# Tue, 19 Apr 2022 04:39:05 GMT
ENV PHP_MEMORY_LIMIT=256M
# Tue, 19 Apr 2022 04:40:27 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:40:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 19 Apr 2022 04:40:28 GMT
ENV MATOMO_VERSION=4.9.0
# Tue, 19 Apr 2022 04:40:46 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 04:40:49 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Tue, 19 Apr 2022 04:40:49 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Tue, 19 Apr 2022 04:40:50 GMT
VOLUME [/var/www/html]
# Tue, 19 Apr 2022 04:40:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 19 Apr 2022 04:40:50 GMT
...
-	Layers:
	...
	-	`sha256:75c84d35eed4b11772848ab223c06010036efb3f79a63b62a731cf508f54c82f`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a07e00f611fa707d9c89315e5795cc11f77f7782e62350f33364d020b3c9656`  
		Last Modified: Tue, 19 Apr 2022 04:44:52 GMT  
		Size: 3.0 MB (2982328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fc31de3973f594f32e825c87ea6c1bfa78aee2bc36bd69dc49a58ec7536a8e5`  
		Last Modified: Tue, 19 Apr 2022 04:44:51 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7033b446d37833f7020508725acd3be5232b4c587d3d9dbbb61f108252faccd8`  
		Last Modified: Tue, 19 Apr 2022 04:44:54 GMT  
		Size: 16.9 MB (16900042 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb47319e270b5bcce2ad95bfc2f045276f5c18b15a3143d620cde960ffd9a087`  
		Last Modified: Tue, 19 Apr 2022 04:44:51 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e134f914ac19acd0ac36697818d7b8dbf6bc5b53558e965a65660d566b9e6e5`  
		Last Modified: Tue, 19 Apr 2022 04:44:51 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
