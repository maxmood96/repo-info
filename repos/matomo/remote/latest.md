...
```console
$ docker pull matomo@sha256:018bd4ffb82c74e71bcd67c1e66ca5091c278e07df8c4c2d13f28d365ae327c7
```
...
```console
$ docker pull matomo@sha256:b001ccf91564053fb30f1e18de88ca4490b870213d14122b6fe656e36502962f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.6 MB (161568638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce2f323233bfdc29a34d64de39384916c3aa3857918053432572f99594deb954`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Mar 2022 19:49:06 GMT
ENV MATOMO_VERSION=4.8.0
# Wed, 09 Mar 2022 19:50:09 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 09 Mar 2022 19:50:11 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 09 Mar 2022 19:50:11 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Wed, 09 Mar 2022 19:50:11 GMT
VOLUME [/var/www/html]
# Wed, 09 Mar 2022 19:50:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Mar 2022 19:50:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b2d45d4cb94f4e2b421f37a458bc736b37faa588531cfcb9ce02b5e464f0c33c`  
		...
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba494931f3ef23a2a69aedada1155e8a2727aef97cad205549be4fe86e3f85e0`  
		Last Modified: Wed, 09 Mar 2022 19:53:05 GMT  
		Size: 16.6 MB (16610733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ea5036a74d27aa6ac4418acbf619696c303648180986bccab6a54f31ab6b0a9`  
		Last Modified: Wed, 09 Mar 2022 19:52:48 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d897bd98fe739e3c2c02b2f1e4d8c5733ecdd75b0fad67ef0487b9570744e1f`  
		Last Modified: Wed, 09 Mar 2022 19:52:48 GMT  
		Size: 629.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:c480f3b9b37120f8abe9b69c651a57ee59e1ffec7cacfe1bd31a259ca1dfb72d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.7 MB (153675551 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a14449b04dccd574afc5585617b202ff1f9ed23cb8b1b91d68132d9c2a7121f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Mar 2022 19:58:23 GMT
ENV MATOMO_VERSION=4.8.0
# Wed, 09 Mar 2022 19:59:18 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 09 Mar 2022 19:59:19 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 09 Mar 2022 19:59:20 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Wed, 09 Mar 2022 19:59:20 GMT
VOLUME [/var/www/html]
# Wed, 09 Mar 2022 19:59:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Mar 2022 19:59:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:84cd5543481eb86f40ed7ee2d3830542c182b8b65c3e32821c54f1c2fbadc64f`  
		...
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f38e20ba350e189e6db29072b4549b8f4a010b4b4b274519db4070a36bec703`  
		Last Modified: Wed, 09 Mar 2022 20:03:34 GMT  
		Size: 16.6 MB (16610663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a32f9e76833b81557070229c22167c0132f250f3ca4a5edd24ac965ebee8ff52`  
		Last Modified: Wed, 09 Mar 2022 20:03:17 GMT  
		Size: 346.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a7903f087b39ead704eed18a7c348784d0cf19550ba047227ce488f23bce578`  
		Last Modified: Wed, 09 Mar 2022 20:03:17 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4d8b46b791ef2e91979ebcb4c0438023942efecfc6b741022755daec63a6373e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.3 MB (176296951 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ce7f0718199445699e2cc2150caf98d6eba917fbaf2ea4b4ee764fb99dd136c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 11 Mar 2022 12:39:59 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 11 Mar 2022 12:40:00 GMT
ENV PHP_MEMORY_LIMIT=256M
...
ENV MATOMO_VERSION=4.8.0
# Fri, 11 Mar 2022 12:42:38 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 12:42:39 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 11 Mar 2022 12:42:40 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 11 Mar 2022 12:42:40 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 12:42:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 12:42:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:715c64d206b0b9497579c55ff706e3900c65fa3c6a0d8f3f0aed57a536d5a9a0`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6334818b165f76b0cff70241b4133238eb19db8566d6b4f0c2b2c6fe4ad31232`  
		Last Modified: Fri, 11 Mar 2022 12:49:22 GMT  
		Size: 2.8 MB (2759112 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:399f2ef9463e38f79988e429d4d1083b80e086cdf8291511aebb9d529531cd23`  
		Last Modified: Fri, 11 Mar 2022 12:49:22 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45700b7d8d124a391268da0872c589bb5ff8ae82cc7b15f8b09e1967af97df90`  
		Last Modified: Fri, 11 Mar 2022 12:49:25 GMT  
		Size: 16.4 MB (16394242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53ca0d7280ec2bba12cb146b3f153be3389e251d383237ed3ab829b6d164d996`  
		Last Modified: Fri, 11 Mar 2022 12:49:21 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:985e7054b893d2a2a008d3fd9adacf6c8a116d68ee9f519f57b45c82fe2125cf`  
		Last Modified: Fri, 11 Mar 2022 12:49:22 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:0f7d007d79cfbbac131d75f82c383baa9fcf0bc47fbb31b6bbd51ab431621a19
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.9 MB (186949540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d80a9ed5307e5c0471204a957e741f0ef31a6fbbe0351b5c425b52297b40008b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Mar 2022 19:38:38 GMT
ENV MATOMO_VERSION=4.8.0
# Wed, 09 Mar 2022 19:39:25 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 09 Mar 2022 19:39:26 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 09 Mar 2022 19:39:26 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Wed, 09 Mar 2022 19:39:26 GMT
...
-	Layers:
	...
	-	`sha256:7c7e817e486684396589f35d24715c7fb783f7c496dcc4585297f030e50a3520`  
		...
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ca754d98c8fb56c0142432f93a74afc7ae22b89eaff61858871906e43838464`  
		Last Modified: Wed, 09 Mar 2022 19:42:18 GMT  
		Size: 16.6 MB (16611344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8612bdb94bf4bea447e79a36ee47f239b4de6e21947b9fb5c22def410e552b8`  
		Last Modified: Wed, 09 Mar 2022 19:42:13 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0824636320fbe0b1e08dc693efba11548508a43b548d050aaa793a46c8dba8e`  
		Last Modified: Wed, 09 Mar 2022 19:42:13 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:698de655ed6d1b343131bcebfe82d0c918dd29bbdf6e90245b9ab7906ab9608d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.0 MB (161039751 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:83346592da70a459537688ccb1fd6315f3e3978e90937cfd21632d794a8df6fa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 05:15:16 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 11 Mar 2022 05:16:04 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 05:16:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Mar 2022 05:16:05 GMT
ENV MATOMO_VERSION=4.8.0
# Fri, 11 Mar 2022 05:17:05 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 05:17:06 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 11 Mar 2022 05:17:07 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Fri, 11 Mar 2022 05:17:07 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 05:17:07 GMT
...
-	Layers:
	...
	-	`sha256:f24e4d41de5b68927f788ddb8c7580dbf79ea29400b309965b1c58bfb37a0d58`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3f3e823ed16a92fd44d9f9c57a317c783046c225b2ea7abf2d5ce1bf212fdef`  
		Last Modified: Fri, 11 Mar 2022 05:22:03 GMT  
		Size: 3.0 MB (2981333 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd23fa0463d5a7d33603f2bdc9cc6b684a0bc171bc6890e2ba71e84f481596c8`  
		Last Modified: Fri, 11 Mar 2022 05:22:02 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a20ff617ddaac91f1c564181fa467d396620d6bdb0ebea8f5913f8351448e151`  
		Last Modified: Fri, 11 Mar 2022 05:22:05 GMT  
		Size: 16.6 MB (16611014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc032cb9e09e55cf82ef69830137919ffb4000a018556cc7212119ed018b0803`  
		Last Modified: Fri, 11 Mar 2022 05:22:03 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:409227f12a68b843bac2bc8d57cd9eeaf8773cdd8ae96fea052e8a36134c7a1c`  
		Last Modified: Fri, 11 Mar 2022 05:22:02 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
