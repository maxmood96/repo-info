...
```console
$ docker pull matomo@sha256:7f777f91ad8b2e1d6c2de39f20a1b9e2dcc4fcce273183e3dee403416a31dc5c
```
...
```console
$ docker pull matomo@sha256:4addb36ab79f8a58be6296ba9e38101ecf65256f7c42a46b210c27a78523384d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.2 MB (186164489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b5f0cf4dbf07a1a00f58ebbf5a7101843ff9b2cb98c7293ad349781477814e7`
...
# Wed, 01 Mar 2023 23:46:33 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 01 Mar 2023 23:46:33 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 01 Mar 2023 23:48:03 GMT
...
-	Layers:
	...
	-	`sha256:3b90b0af60c1c968e37b5b1631d0564eab70adfe59c7356f0838a5292228bac1`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:424bddb8282e5216e0380e5bd37f81cf3d70840ac354e43a0cfc7fbd60926de0`  
		Last Modified: Wed, 01 Mar 2023 23:50:38 GMT  
		Size: 3.2 MB (3214150 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c627ca5162fdaa2ac29f3d987bc0f25af21d4ba543b80161daefbf8a8e9d4f8c`  
		Last Modified: Wed, 01 Mar 2023 23:50:37 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a13f85d6a0b2a94681d33629ef714c9ff088864765ea936add0024e71ad4b80`  
		Last Modified: Wed, 01 Mar 2023 23:50:41 GMT  
		Size: 17.5 MB (17499701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2dff439564d7dcf340c6a081c81f2769f2c007b170bb1b79fd646bb9f226e2c0`  
		Last Modified: Wed, 01 Mar 2023 23:50:37 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff02ca679993fa1ba4ae409bcd9d9220d8e1e9932cbda30a0e70d65042760712`  
		Last Modified: Wed, 01 Mar 2023 23:50:37 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:d0f1a0264508a576c20d107a1e87ea0baeeb3bd4b0dd5ce07cd82fa8ec5758ba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **180.3 MB (180327160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6235ee8811b774b71b7b984f8b8aa1d4c99a992d999c222439c7118965af6401`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 01 Mar 2023 08:44:21 GMT
CMD ["apache2-foreground"]
# Wed, 01 Mar 2023 19:26:24 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 01 Mar 2023 19:26:24 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 01 Mar 2023 19:28:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 19:28:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Mar 2023 19:28:05 GMT
ENV MATOMO_VERSION=4.13.3
# Wed, 01 Mar 2023 19:28:17 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 19:28:17 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 01 Mar 2023 19:28:17 GMT
...
-	Layers:
	...
	-	`sha256:3d339e70d4ca14ae2d294278fc61e0add60b01d3f57d54cad2a233dbf738a30b`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aebfa3a1c8c1e870a2210774d1721e9c2d44f13420adb1be7a0ebbcf49f9c3a3`  
		Last Modified: Wed, 01 Mar 2023 19:31:00 GMT  
		Size: 3.4 MB (3448037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac3804099cfedd3f195f35335516c7a4b73c3650e06e2672e0fb58ad05c2c1cb`  
		Last Modified: Wed, 01 Mar 2023 19:30:59 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2179df6aefc03c73a4c802619f776cbc73a386afe7dbf6f5aa79ec2695643e56`  
		Last Modified: Wed, 01 Mar 2023 19:31:02 GMT  
		Size: 17.5 MB (17498892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:042b1265c58a60165a92a9494e2d958b169e7a7d61547915c71f0ce23e555ac6`  
		Last Modified: Wed, 01 Mar 2023 19:30:59 GMT  
		Size: 341.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fda284aa5f7ce51d0f18181004b2d114cbf6a0ce5efe3fe399272e227271b17e`  
		Last Modified: Wed, 01 Mar 2023 19:30:59 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:40b497ee7a73bc8ee15931191f969c83d1b2372339049577a0b7d950f3595082
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.3 MB (162347664 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:106b0f306dd0c4f10728175c1cf3ed061a029a4bb0eb6db50c0acb5382949bc5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 02 Mar 2023 00:12:23 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 02 Mar 2023 00:12:27 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 02 Mar 2023 00:16:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 02 Mar 2023 00:17:04 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 02 Mar 2023 00:17:08 GMT
ENV MATOMO_VERSION=4.13.3
# Thu, 02 Mar 2023 00:18:16 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 02 Mar 2023 00:18:22 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 02 Mar 2023 00:18:27 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Thu, 02 Mar 2023 00:18:33 GMT
VOLUME [/var/www/html]
# Thu, 02 Mar 2023 00:18:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 02 Mar 2023 00:18:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e53f71a0b88338813fe7fd9b1159eaa7db893c29fc1ba1b844e6ab6b46ec454c`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01dc342c9f0c0c384fd64cea37fd372326d25fbd761b692a4bb092b2860f286f`  
		Last Modified: Thu, 02 Mar 2023 00:25:47 GMT  
		Size: 2.6 MB (2587724 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60b9767b6a924620b367b3327866ea540a912142a3649044955f3a4edea2658a`  
		Last Modified: Thu, 02 Mar 2023 00:25:45 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76b1f7fd8b2fe270894d32e3c68afeb6850193db0d38d0bd9689a777fbc5b48a`  
		Last Modified: Thu, 02 Mar 2023 00:25:59 GMT  
		Size: 17.3 MB (17282898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa5c1c7fccd982421b29c99c802f3e6f1ec13587d7dcd7389c2f5cced3322dd0`  
		Last Modified: Thu, 02 Mar 2023 00:25:46 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:523b064917c0cf09c53959ccfb9e07d7651fce9bbcfb2e4ed5efab4b04e38a2d`  
		Last Modified: Thu, 02 Mar 2023 00:25:45 GMT  
		Size: 631.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:70f13b56fefaafed7f53fd061a711f5fac54ab57f504a12248283677d958afc2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.5 MB (186530354 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a23082c27bb975e29f61ee9bf1060b04204165baf587e82c5f87ddf99013a0ff`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 01 Mar 2023 23:08:44 GMT
LABEL maintainer=pierre@piwik.org
# Wed, 01 Mar 2023 23:08:45 GMT
ENV PHP_MEMORY_LIMIT=256M
# Wed, 01 Mar 2023 23:11:10 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 23:11:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Mar 2023 23:11:13 GMT
ENV MATOMO_VERSION=4.13.3
# Wed, 01 Mar 2023 23:11:48 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 23:11:51 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Wed, 01 Mar 2023 23:11:51 GMT
COPY file:ccb778224a0e1f6742127aba2860c245adf24b73ca277e7260c4789883751ccb in /entrypoint.sh 
# Wed, 01 Mar 2023 23:11:54 GMT
VOLUME [/var/www/html]
# Wed, 01 Mar 2023 23:11:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 01 Mar 2023 23:11:57 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:96c6a500619f8b7be63d1aef5d1b63c5ff6b3475d9a29c5dd60d72811d85831b`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bdb77251dd3a39cf386c311321c6f25a2f2a71b7934d484f5db674d456e94d2`  
		Last Modified: Wed, 01 Mar 2023 23:16:13 GMT  
		Size: 3.1 MB (3089648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:909efb7e89a75e85dc597001831baef294c72b28a6e4d5b5b44cd4a276fc9efb`  
		Last Modified: Wed, 01 Mar 2023 23:16:12 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c475c986404efb9b63a97fda391d66096ec4017955d58e29c6f401387dd56e9`  
		Last Modified: Wed, 01 Mar 2023 23:16:18 GMT  
		Size: 17.5 MB (17500069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bedce662eb81ca5f3340cb5134d07b0be9a61d8bcdfd8fe7ff149921626a77f`  
		Last Modified: Wed, 01 Mar 2023 23:16:11 GMT  
		Size: 345.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d05a040ff497c5e318c4ba83c04aaebae97d37120315f01edaed50de3be6a99a`  
		Last Modified: Wed, 01 Mar 2023 23:16:12 GMT  
		Size: 632.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
