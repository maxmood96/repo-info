...
```console
$ docker pull matomo@sha256:6427b579ac95e0b6f5b8fb95a5775021da90e0bea1fc038d61764737e728fd60
```
...
```console
$ docker pull matomo@sha256:886c405ba341a49ead3a375dc5e3d4843490b2454f3b1fe33c372d0f8ce4b2cb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.4 MB (202371884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:248a6d8c192724b9df52e1080ec9106d6d659a01d7c4fb355b0b34603cf7cbb3`
...
# Thu, 11 Jan 2024 19:07:22 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 11 Jan 2024 19:09:07 GMT
...
-	Layers:
	...
	-	`sha256:0b12a7da9776dc02c8e9c444130d3cb41d34129c879235b271305e085f1ded9b`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11c2342fc4df0067a05529d3884c195f92251d5069f35508d0e218ba741e1b84`  
		Last Modified: Thu, 11 Jan 2024 19:13:59 GMT  
		Size: 3.5 MB (3460686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8e0f22045585d00595f4547381552454f8108b1fef59ad9a623a2f8c09f4487`  
		Last Modified: Thu, 11 Jan 2024 19:13:59 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb3fd9885cacba26628ee54e3cd6a22cac2cf719d6cf6ec518d0540d2aab04c1`  
		Last Modified: Thu, 11 Jan 2024 19:14:03 GMT  
		Size: 21.3 MB (21268748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:edb7dc792166302ee1ef8d15afc2a3108295c53ad585cf8c5febb818dd83620b`  
		Last Modified: Thu, 11 Jan 2024 19:13:59 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8fa36e9301a9b51df0723b012a6cb20b59b3ee7457db40ca02911741009d66f`  
		Last Modified: Thu, 11 Jan 2024 19:13:59 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:8ce25b3e3932297b9fb0ef4ff9ab3f54e66f67c3aa1252b6744779ca77ff33b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.5 MB (175528644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e39c3775e0fe98d5c00e221ed8cdd821abd8f53807498e6661d2a51e85c26e9d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 11 Jan 2024 04:53:25 GMT
CMD ["apache2-foreground"]
# Fri, 12 Jan 2024 00:03:35 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 12 Jan 2024 00:06:38 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:06:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Jan 2024 00:06:40 GMT
ENV MATOMO_VERSION=5.0.1
# Fri, 12 Jan 2024 00:07:05 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:07:05 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 12 Jan 2024 00:07:06 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 12 Jan 2024 00:07:06 GMT
VOLUME [/var/www/html]
# Fri, 12 Jan 2024 00:07:06 GMT
...
-	Layers:
	...
	-	`sha256:a18a33e04cefc9a1b7093aa925d265d971eece152dea00a78d7f62ff0149d564`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:994c749ef72526930409ccaa3aee571176cc3232293fa25cf65ff6dfde51a02e`  
		Last Modified: Fri, 12 Jan 2024 00:11:20 GMT  
		Size: 2.9 MB (2928693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:249ebca4dbdb4f7fb115f758dfe48e765c9cceb6c0b3e3caa3cba7a9c82207d8`  
		Last Modified: Fri, 12 Jan 2024 00:11:19 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:601c9be40494d1a3e324db2811d209324690c8093aaa010daaf3e04286d9baac`  
		Last Modified: Fri, 12 Jan 2024 00:11:25 GMT  
		Size: 21.3 MB (21266481 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39f379459b271842f150b489704829cba0d9a579520c01285292a50e8490302b`  
		Last Modified: Fri, 12 Jan 2024 00:11:19 GMT  
		Size: 344.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c265a53f11af8c2eb424893c381c4d7e630ad57d7d793a07f63827ae87432636`  
		Last Modified: Fri, 12 Jan 2024 00:11:19 GMT  
		Size: 820.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:2905a10b7e4122b535d82ff94587f17f4a8d67ed7ebd11ae26902fd4198e2248
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166269438 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2c857f68e960efa137a80dab1584d3a9272a5d7069cb5e175dccb5e2da5fec6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 11 Jan 2024 09:39:35 GMT
CMD ["apache2-foreground"]
# Fri, 12 Jan 2024 00:00:49 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 12 Jan 2024 00:03:50 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:03:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Jan 2024 00:03:52 GMT
ENV MATOMO_VERSION=5.0.1
# Fri, 12 Jan 2024 00:04:14 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 00:04:14 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 12 Jan 2024 00:04:15 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 12 Jan 2024 00:04:15 GMT
VOLUME [/var/www/html]
# Fri, 12 Jan 2024 00:04:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Jan 2024 00:04:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bf036609b94d0f7532d33cafe63e6ce542d439d605d878a022992b03d85195fa`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2412c5c404d7c26e707342b1196e9e0e771ce4c5a472e4c4724f625b5c35147e`  
		Last Modified: Fri, 12 Jan 2024 00:08:23 GMT  
		Size: 2.8 MB (2807722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aeb8c688f2e4a036c30a3d0d3003c9c9303cde117d88eb2d0167c33cd54d796b`  
		Last Modified: Fri, 12 Jan 2024 00:08:22 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b65b308dd9b004bdb84a7ebe016b45f751690c46fef67bdf494f778021ba9927`  
		Last Modified: Fri, 12 Jan 2024 00:08:28 GMT  
		Size: 21.3 MB (21266630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e9a06df760f942e7c1e6d4515fbaafd95d27724cf24c917109e247a20c42a2b`  
		Last Modified: Fri, 12 Jan 2024 00:08:22 GMT  
		Size: 343.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9551ee55237b9ec131b16aa3c6fe568569c5553755d7b7c4a2582e2fb8fc972d`  
		Last Modified: Fri, 12 Jan 2024 00:08:22 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:8afada27ff439848c56ffbb4c840e6ee528d4daa45244141e61db3fd8cad1f54
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.4 MB (196432979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb7b43e14b9bbafac1836d1ff3d03c57b6eab65081af245ac1fe008256473a97`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 11 Jan 2024 10:13:53 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 11 Jan 2024 10:15:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 10:15:43 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jan 2024 10:15:43 GMT
ENV MATOMO_VERSION=5.0.1
# Thu, 11 Jan 2024 10:15:57 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 10:15:57 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jan 2024 10:15:57 GMT
...
-	Layers:
	...
	-	`sha256:759c0ead9cf3ebc37d5ae3160057cade363bff9b52eef074453439aafe0d8aa7`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bf4ac0c66d5c9cbe73b7dbe25f97003a9346c00b82741776f50016df996c57c`  
		Last Modified: Thu, 11 Jan 2024 10:18:23 GMT  
		Size: 3.7 MB (3704439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d4877b0a4f664431ba8228c14a7a71a7ee830dfaeb325dab43cabe32eded323`  
		Last Modified: Thu, 11 Jan 2024 10:18:22 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a454a45448c00c9463e36983a616ce7f269e10499f1f8584e31445a74a42d19c`  
		Last Modified: Thu, 11 Jan 2024 10:18:25 GMT  
		Size: 21.3 MB (21268355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77ba1dde63eee4c81687fa41eb6b49730db1b93dc9d26975ee55fd186da0c530`  
		Last Modified: Thu, 11 Jan 2024 10:18:22 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bc6ab20f2d88c6980e80601cd3a561631d8f9605dbb9e46551bebf5a6ff0df1`  
		Last Modified: Thu, 11 Jan 2024 10:18:22 GMT  
		Size: 822.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:1923d2afaa9985ace71590d4a07ebaa7d3ca08a490e2efb3a724eeb6441cec83
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.3 MB (201275808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8904af40bbb3cc12668aafd4e2ed24e573892c1efee9b130ad0b2929430ff665`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:8b5a633b83f1bf8bd6b84475842b27f7e6c2fe8e24b2fde5c473ba0bcc00abfe`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dab70c7a10c8d4a4dc068fc1f8154a2dbb0a523bc5de6de79f87ea2fa5abb12`  
		Last Modified: Thu, 11 Jan 2024 18:06:35 GMT  
		Size: 3.4 MB (3412242 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38de2ce9d721c47c185c71bd3540cb0beccde407727fa58b2b8a83279833ddce`  
		Last Modified: Thu, 11 Jan 2024 18:06:34 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6ada4c9da5edbf3a0ec2f1cbddb71bbb66b197086f3eae6a856266bf6e3128e`  
		Last Modified: Thu, 11 Jan 2024 18:06:40 GMT  
		Size: 21.3 MB (21267547 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c8703fe898f78dc7b30f0caeb77ed2c42fa0f00f7a101fdb77129c803b95976`  
		Last Modified: Thu, 11 Jan 2024 18:06:34 GMT  
		Size: 340.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f1502ef54325baa390c31a435e84eccdec53c820ecd68009e1ccfb49b6ac702`  
		Last Modified: Thu, 11 Jan 2024 18:06:34 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:88ce4fe0551494b9ceed48f1b8af8c5d996bf45f08e9adde7d952c53d1f70fbd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **176.5 MB (176463081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1afcd4b23c43753e81d4de68b1a5005ccd9191b5299419ccaefa06e3437941d3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 12 Jan 2024 01:00:21 GMT
ENV PHP_MEMORY_LIMIT=256M
# Fri, 12 Jan 2024 01:05:41 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 01:05:47 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 12 Jan 2024 01:05:51 GMT
ENV MATOMO_VERSION=5.0.1
# Fri, 12 Jan 2024 01:07:05 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Jan 2024 01:07:12 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 12 Jan 2024 01:07:17 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Fri, 12 Jan 2024 01:07:23 GMT
VOLUME [/var/www/html]
# Fri, 12 Jan 2024 01:07:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Jan 2024 01:07:35 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0fe2cd64600697818181d9b81fd141f13d652742aa4af056d9c638e8122196b4`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a16a5729bc1ca3aa8a61ad0a8579101b95ecd6c4b8bb1ae71ec596867fd9dc3`  
		Last Modified: Fri, 12 Jan 2024 01:15:34 GMT  
		Size: 2.8 MB (2830315 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27705a30f56c97521c1b554bb8c0b71393b9c21a680d0d3082a688ea3634cd4c`  
		Last Modified: Fri, 12 Jan 2024 01:15:31 GMT  
		Size: 329.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1abcb74894b2e5153a330cba1a525dafe9a6827ad84fa2c3943f2e67d3044d34`  
		Last Modified: Fri, 12 Jan 2024 01:15:48 GMT  
		Size: 21.1 MB (21061586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4464d2a104cbec475e1a69bca14327a7f7838e6d4e81ac66bebd6b5d764ccdfa`  
		Last Modified: Fri, 12 Jan 2024 01:15:31 GMT  
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:736e22895f98768b7a46b2d632fa4e776ca281f019ea180aa36c0f9c799bd517`  
		Last Modified: Fri, 12 Jan 2024 01:15:31 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:915700612ee46be3c9f884dfc21d394285a61877295078510a9b627a36222002
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.8 MB (206846172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:814a9ab0299feace8876b0f6ce0f04096a1c96db18150720b9946ca9c06d584a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 11 Jan 2024 12:23:36 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 11 Jan 2024 12:25:29 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 12:25:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jan 2024 12:25:31 GMT
ENV MATOMO_VERSION=5.0.1
# Thu, 11 Jan 2024 12:26:06 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 12:26:10 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jan 2024 12:26:11 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 11 Jan 2024 12:26:12 GMT
VOLUME [/var/www/html]
# Thu, 11 Jan 2024 12:26:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 11 Jan 2024 12:26:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:86be9ff4531c640cb954248b269ef46a9b47172972adda2c0ab6fd0f5a3db6f4`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f45299751af0acf8519973950e4f388809acb2ec4da279438999ad391d097713`  
		Last Modified: Thu, 11 Jan 2024 12:30:15 GMT  
		Size: 3.4 MB (3373201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bac5ba99a1eb7087ae53585508e538e669f9c833c1a2fda7cd6c7782d08bb8aa`  
		Last Modified: Thu, 11 Jan 2024 12:30:14 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8733bfa21590ec5fd08c88c81bcc432711f8b9aa48672d3eb7969ca2cc33e81`  
		Last Modified: Thu, 11 Jan 2024 12:30:19 GMT  
		Size: 21.3 MB (21268412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c3ef6dff4319220f880dc5eaea3f0c505c54cdff11ff9b7ae0fdc8a7a653105`  
		Last Modified: Thu, 11 Jan 2024 12:30:14 GMT  
		Size: 337.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23bae12ba25c56ebf3d95b92f5d5cba9eb5ff760120887ddb9113b3568d14e7d`  
		Last Modified: Thu, 11 Jan 2024 12:30:14 GMT  
		Size: 823.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:101ba5d325f6837c5688f7e31b64d25726a340c83e440c849d560d3405dfff4b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **175.6 MB (175566830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86f727f512a417e84c7eb21199e67a54c9873819470a945022bded0de59bac7a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 11 Jan 2024 07:37:02 GMT
CMD ["apache2-foreground"]
# Thu, 11 Jan 2024 10:01:01 GMT
ENV PHP_MEMORY_LIMIT=256M
# Thu, 11 Jan 2024 10:01:56 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 		procps 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		bcmath 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.23; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 10:01:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jan 2024 10:01:57 GMT
ENV MATOMO_VERSION=5.0.1
# Thu, 11 Jan 2024 10:02:09 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys F529A27008477483777FC23D63BB30D0E5D2C749; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 10:02:11 GMT
COPY file:f4ea35cff07e183c01b4e508329d1f5c342d9f4d330bda7f28faa530ced0d166 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 11 Jan 2024 10:02:11 GMT
COPY file:900c144bc42a0cece349bbd3acad78e18e4d9e022616b0b2897604ea1fa1c744 in /entrypoint.sh 
# Thu, 11 Jan 2024 10:02:11 GMT
...
-	Layers:
	...
	-	`sha256:f7e3e73b61de93aa6768e21d9c614d16ac00a135fbd86cbe104eacf053dc76e3`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:047d55705c789410b725083a1e80a299339042f7a1daee5fe1308faa2513a306`  
		Last Modified: Thu, 11 Jan 2024 10:04:03 GMT  
		Size: 3.0 MB (3006231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d687d70c451ac8560658f342d8336774c1830ba81a80332ff34eb394dc12f66d`  
		Last Modified: Thu, 11 Jan 2024 10:04:02 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82e9c1f0d5854444a42b0be0bf1cb57727edcf4f7b96ea48d9f3c302433e094e`  
		Last Modified: Thu, 11 Jan 2024 10:04:06 GMT  
		Size: 21.3 MB (21266913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f27f85935f294497bb2293c9c493bf5e8c73b5fe716c743b6d2f0c5ca578e64a`  
		Last Modified: Thu, 11 Jan 2024 10:04:02 GMT  
		Size: 339.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06f97cbb0592927ef9d39e64757aa0671e272095a8e9a2564ce282cbffb749b2`  
		Last Modified: Thu, 11 Jan 2024 10:04:02 GMT  
		Size: 825.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
