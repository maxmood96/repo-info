...
```console
$ docker pull matomo@sha256:605dc2c60293584fd4921ac4e33ce362cbd8a18083ef21106da4f3a59d11d77e
```
...
```console
$ docker pull matomo@sha256:13f7069cc9c48e5ad984ef45fbf175e399db8d9e410de3939fc266e9d235a34d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145052626 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45e4273c3697622b96d2eef77c65d9235673788ea0e8bc8a04df53320067378f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 21:47:49 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 05 Nov 2020 21:50:16 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 21:50:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 05 Nov 2020 21:50:19 GMT
ENV MATOMO_VERSION=3.14.1
# Thu, 05 Nov 2020 21:50:54 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 21:51:00 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 05 Nov 2020 21:51:01 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 05 Nov 2020 21:51:02 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 21:51:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 21:51:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:84cc12a54b2345e862b7fb95c8e20d1c178c4559b2a41ebfa1d3e439b06c696e`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c2330ef92aa4b88271c6fa6d98bf92770cd0e8e8f232ad6fd9cecec5cefaf6d`  
		Last Modified: Thu, 05 Nov 2020 21:54:39 GMT  
		Size: 3.3 MB (3341197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4616724b64503aabc5d0aad58274f11a0913c73b1a17c18072265c3876354f5`  
		Last Modified: Thu, 05 Nov 2020 21:54:37 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27f1f783230366ac917fe935d4121d695419e7e228320043680fdc8c59c62511`  
		Last Modified: Thu, 05 Nov 2020 21:54:47 GMT  
		Size: 16.3 MB (16327417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1612e9dfd1b6e17ffd26baf7550f727e71cdc26175444963c3cfcc831339ae12`  
		Last Modified: Thu, 05 Nov 2020 21:54:39 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ec9ed9bdb0e496c2bf2f19081392c4d911abf0d7afae9b44a2b84ad84dc7d45`  
		Last Modified: Thu, 05 Nov 2020 21:54:38 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:480673c415a8bbc18c79de281939a37246f55941c331c2dbdbea736193c135ba
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.2 MB (142241157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97b40b0e4f5f17f48063f869d73f78005980ca8f4e5b84a7135718e20d3e8122`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 23:28:54 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 05 Nov 2020 23:30:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:31:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 05 Nov 2020 23:31:01 GMT
ENV MATOMO_VERSION=3.14.1
# Thu, 05 Nov 2020 23:31:28 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:31:33 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 05 Nov 2020 23:31:35 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 05 Nov 2020 23:31:37 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 23:31:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 23:31:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2640e6d18d7c27aaef0c0aaa606883a0b47c9805efebb6da79d05bc7eedc7188`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfa6dcd2fd7c7714a9b5f9b7a03ff0fee886370d17b85b0330ff46f3cdbc450b`  
		Last Modified: Thu, 05 Nov 2020 23:38:37 GMT  
		Size: 3.2 MB (3213250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e98087aee849c65041d2fe9d505277ec18bc12443ab2cdf176b64a65424df308`  
		Last Modified: Thu, 05 Nov 2020 23:38:36 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:914d8c3de12cc0c4fd7e4f772437c46bacb830a6eff53b5a55a46a42f24c1096`  
		Last Modified: Thu, 05 Nov 2020 23:38:43 GMT  
		Size: 16.3 MB (16327379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7f60a6d7017f31b850012d08d64e251b25f8861c4d871147f376569b87b46cd`  
		Last Modified: Thu, 05 Nov 2020 23:38:35 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4faddd9c2969302fa9213dd2c20e1b4d7099b2236171d55db76928d42d956d09`  
		Last Modified: Thu, 05 Nov 2020 23:38:36 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:ba60d64c69eb543d5c99d3c22c6a31440c24f199954a41460c49da7ae752c9cf
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.0 MB (159016129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:55bb7bdab5bfd7d7eb506d1e1e3240efe83619898691b71410b66a0a5a2c43ce`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 23:30:11 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 05 Nov 2020 23:32:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:32:29 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 05 Nov 2020 23:32:31 GMT
ENV MATOMO_VERSION=3.14.1
# Thu, 05 Nov 2020 23:33:13 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:33:22 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 05 Nov 2020 23:33:24 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 05 Nov 2020 23:33:27 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 23:33:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 23:33:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2ca9895ac5aafa24dc3256a4b26818b51d9941e519bad7e593a7cf58c24701ac`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa5833c8d78ecfd56a15bcc0f390760fdbd8e6d6a569c85ad8f1fe5da9f4e926`  
		Last Modified: Thu, 05 Nov 2020 23:39:56 GMT  
		Size: 3.5 MB (3472045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26b7bcd05e477f0c207355442bbf39cec91ea37749f42b0fbdaa93e0b81a2500`  
		Last Modified: Thu, 05 Nov 2020 23:39:55 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e39a065f781cd9945c0969c2195eece7e416a6ddbcf92e20df2a0e5a8895159`  
		Last Modified: Thu, 05 Nov 2020 23:40:01 GMT  
		Size: 16.3 MB (16328170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5561a62fb236616686cbaf4d0cd5380929e378352467a55bdd34fd47290a1e81`  
		Last Modified: Thu, 05 Nov 2020 23:39:55 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a665fcd5dc20cfe4641b6459112e60d9727a242187d55ef8f120aac16cd0494e`  
		Last Modified: Thu, 05 Nov 2020 23:39:55 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:4fc3e0af9cffef5525cb17d0c4c57bbb05d636d36d0bbf23ea4df2a441054bf8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.7 MB (172746939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:986597cab7c0f52e32bc36a069f73eff2752ffa1f2a2d2d537468a74165fef6e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Oct 2020 22:50:56 GMT
CMD ["apache2-foreground"]
# Fri, 30 Oct 2020 03:52:08 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 30 Oct 2020 03:53:45 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 03:53:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Oct 2020 03:53:46 GMT
ENV MATOMO_VERSION=3.14.1
# Fri, 30 Oct 2020 03:54:03 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 03:54:03 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 30 Oct 2020 03:54:03 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Fri, 30 Oct 2020 03:54:04 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 03:54:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 30 Oct 2020 03:54:04 GMT
...
-	Layers:
	...
	-	`sha256:40817d4aac8027fe99d75d9b434be4e442841ff2dcb1ec61d1e29996674aed94`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eafdd360df1244ab4badb679b7f42a6e5632c418de68f37b2fcd96de087454f8`  
		Last Modified: Fri, 30 Oct 2020 03:58:40 GMT  
		Size: 3.5 MB (3548028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:105bbcec4ab8c9d804bff8afa15f8350bb8ed2989b70eda0cccc59a1182d618e`  
		Last Modified: Fri, 30 Oct 2020 03:58:39 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f3dc9dab830d80103be8e6a4b4dfc01edaa6a00533b37d7deb9c7fe331cd732`  
		Last Modified: Fri, 30 Oct 2020 03:58:45 GMT  
		Size: 16.3 MB (16328218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e986810d783229c16766fdf4e62a95e820839c8bbede3c7b68994cb525bbe96`  
		Last Modified: Fri, 30 Oct 2020 03:58:39 GMT  
		Size: 305.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:719a4715f042833b88281998fb341dd7728d2691e1f2f53d11bfa9b81ed2fd80`  
		Last Modified: Fri, 30 Oct 2020 03:58:39 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:3df2fb42c1cf76c557eec66c29fa4abadea56dd50fdad8a08c108a02d7c2787d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.5 MB (149513900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ae85941622c22363b45c4bc5c6c94f5a20f5465bdf88f83cdc640d491eb190e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 05 Nov 2020 20:21:11 GMT
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 23:07:19 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 05 Nov 2020 23:11:31 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:11:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 05 Nov 2020 23:11:33 GMT
ENV MATOMO_VERSION=3.14.1
...
-	Layers:
	...
	-	`sha256:62cb8304df6e7f1ea65e96b9ebddd2433180b87b92d4549aca6b8fff6ff05e2c`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff9ac777b0699fb74bc54b764dffbf74ea464379fbe9f5fc96462ae8758316d3`  
		Last Modified: Thu, 05 Nov 2020 23:17:53 GMT  
		Size: 3.5 MB (3478620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8be25c049b2e124fd99f999800e00a90f71d5bbbdd6d9aade1503ad639a0982`  
		Last Modified: Thu, 05 Nov 2020 23:17:50 GMT  
		Size: 330.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34d39b705e3a814fa19dbac240e602d3526d0ad007b20f45400d695d21d79070`  
		Last Modified: Thu, 05 Nov 2020 23:18:04 GMT  
		Size: 16.3 MB (16326644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:646d0d524a517a8ac71cd23d9ef18ec6e3a21aaaa647b49c581c46cfeaaea630`  
		Last Modified: Thu, 05 Nov 2020 23:17:51 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:927ef00142433394836bce9c02a47150075756bf6c5244c7d00e079fcdadbd3e`  
		Last Modified: Thu, 05 Nov 2020 23:17:50 GMT  
		Size: 228.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:dad7636fa6329423d01b34ef3fffb18578c9901182346c49643367c8e31a6955
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.2 MB (178199848 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8880861b36d8199a3e19c4e6c0ee741ada5334c48b1a9fc289fc4b0324251fa4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 30 Oct 2020 05:34:25 GMT
LABEL maintainer=pierre@piwik.org
# Fri, 30 Oct 2020 05:37:04 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 05:37:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Oct 2020 05:37:14 GMT
ENV MATOMO_VERSION=3.14.1
# Fri, 30 Oct 2020 05:38:33 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 05:38:36 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Fri, 30 Oct 2020 05:38:38 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Fri, 30 Oct 2020 05:38:40 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 05:38:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 30 Oct 2020 05:38:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ad90e0449d0c3467c9bcb38e593d8fb8fa1abd3d5c4663cc7dbe2629d5444029`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:194de607ed6021159a62b66dbb9e1465d4bf0fa3b90ac035a665334f77e8324f`  
		Last Modified: Fri, 30 Oct 2020 05:47:21 GMT  
		Size: 3.8 MB (3757187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73d3dc6489cb3265514e6c0a6812a7e9c99937e8ec342acaf778a8112a1fcde4`  
		Last Modified: Fri, 30 Oct 2020 05:47:20 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0bf0c6d9e2c430547c43832e0de37bdf60cd58f80492aa99141fbdb4a6d1fe38`  
		Last Modified: Fri, 30 Oct 2020 05:47:25 GMT  
		Size: 16.3 MB (16330039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e26cceba53ff1f0ac2a8152bc6753f97428c4a50724c03e71b7456ff17d6a600`  
		Last Modified: Fri, 30 Oct 2020 05:47:20 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed58c0c1e4948c639f05942cf276812855ffe9ec889d12dbd757cd015087943c`  
		Last Modified: Fri, 30 Oct 2020 05:47:20 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull matomo@sha256:f9af621061eddcd74b21c6efdd9c1ccf142079665a3f3af5fa9850f2254d942e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.6 MB (152613942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed2e256a5acaed19f8f802c383cbde0d187bb671399d5e17145374fbeb9a2fe0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 22:38:31 GMT
LABEL maintainer=pierre@piwik.org
# Thu, 05 Nov 2020 22:40:11 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libpng-dev 		libzip-dev 	; 		debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure gd --with-freetype --with-jpeg; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		gd 		ldap 		mysqli 		opcache 		pdo_mysql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install redis-5.3.1; 		docker-php-ext-enable 		apcu 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 22:40:13 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 05 Nov 2020 22:40:14 GMT
ENV MATOMO_VERSION=3.14.1
# Thu, 05 Nov 2020 22:40:38 GMT
RUN set -ex; 	fetchDeps=" 		dirmngr 		gnupg 	"; 	apt-get update; 	apt-get install -y --no-install-recommends 		$fetchDeps 	; 		curl -fsSL -o matomo.tar.gz 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz"; 	curl -fsSL -o matomo.tar.gz.asc 		"https://builds.matomo.org/matomo-${MATOMO_VERSION}.tar.gz.asc"; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 814E346FA01A20DBB04B6807B5DBD5925590A237; 	gpg --batch --verify matomo.tar.gz.asc matomo.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" matomo.tar.gz.asc; 	tar -xzf matomo.tar.gz -C /usr/src/; 	rm matomo.tar.gz; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 22:40:44 GMT
COPY file:5a36d7fba12e383595e7235267e54c5714dbf865acd4c4596c92ac0f17d139b3 in /usr/local/etc/php/conf.d/php-matomo.ini 
# Thu, 05 Nov 2020 22:40:44 GMT
COPY file:0fafaeb399f05cbf0a84d0276a6353eb053cd1a1537e5631be96c2a2ffa2fd31 in /entrypoint.sh 
# Thu, 05 Nov 2020 22:40:45 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 22:40:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 22:40:46 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:68cfa4fe3e1460f5826868dc97bac52ec2d27ebc957915f0a19b2e73a90cdc57`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91a46b81d1fdf1e7ccaabbd4b29a8b49092b9f56e6a951cd907a753f744a8a9d`  
		Last Modified: Thu, 05 Nov 2020 22:45:13 GMT  
		Size: 3.5 MB (3484884 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53c0cf08ebe0cd127157bba1c9ccb82d67395d141792db31770fdc0f804d8e7b`  
		Last Modified: Thu, 05 Nov 2020 22:45:12 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a8c7e7722a880b16e5f2fad77549e85c2e1442d2d08024d983a8f026c02312b`  
		Last Modified: Thu, 05 Nov 2020 22:45:15 GMT  
		Size: 16.3 MB (16327733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c5db33ceade70669db139cf7547709c394484db3c9b49400083e3a7e97d9848`  
		Last Modified: Thu, 05 Nov 2020 22:45:12 GMT  
		Size: 307.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:606ede9a0e64b6ea5ebd925703b4c5015c8ea6490778ad6fd96e5c8ac7daeb09`  
		Last Modified: Thu, 05 Nov 2020 22:45:12 GMT  
		Size: 227.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
