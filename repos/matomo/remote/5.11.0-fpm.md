...
### `matomo:5.11.0-fpm` - unknown; unknown
...
### `matomo:5.11.0-fpm` - linux; arm variant v5
...
### `matomo:5.11.0-fpm` - linux; arm variant v7
...
### `matomo:5.11.0-fpm` - linux; arm64 variant v8
...
### `matomo:5.11.0-fpm` - linux; ppc64le
...
### `matomo:5.11.0-fpm` - linux; riscv64
