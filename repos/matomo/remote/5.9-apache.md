...
### `matomo:5.9-apache` - unknown; unknown
...
### `matomo:5.9-apache` - linux; arm variant v5
...
### `matomo:5.9-apache` - linux; arm variant v7
...
### `matomo:5.9-apache` - linux; arm64 variant v8
...
### `matomo:5.9-apache` - linux; ppc64le
...
### `matomo:5.9-apache` - linux; riscv64
