...
### `apk` package: `boost1.84`

```console
boost1.84-1.84.0-r3 description:
Free peer-reviewed portable C++ source libraries

boost1.84-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-1.84.0-r3 installed size:
1263 KiB

boost1.84-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-atomic`

```console
boost1.84-atomic-1.84.0-r3 description:
Boost atomic shared library

boost1.84-atomic-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-atomic-1.84.0-r3 installed size:
17 KiB

boost1.84-atomic-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-chrono`

```console
boost1.84-chrono-1.84.0-r3 description:
Boost chrono shared library

boost1.84-chrono-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-chrono-1.84.0-r3 installed size:
38 KiB

boost1.84-chrono-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-container`

```console
boost1.84-container-1.84.0-r3 description:
Boost container shared library

boost1.84-container-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-container-1.84.0-r3 installed size:
81 KiB

boost1.84-container-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-context`

```console
boost1.84-context-1.84.0-r3 description:
Boost context shared library

boost1.84-context-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-context-1.84.0-r3 installed size:
13 KiB

boost1.84-context-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-contract`

```console
boost1.84-contract-1.84.0-r3 description:
Boost contract shared library

boost1.84-contract-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-contract-1.84.0-r3 installed size:
106 KiB

boost1.84-contract-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-coroutine`

```console
boost1.84-coroutine-1.84.0-r3 description:
Boost coroutine shared library

boost1.84-coroutine-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-coroutine-1.84.0-r3 installed size:
17 KiB

boost1.84-coroutine-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-date_time`

```console
boost1.84-date_time-1.84.0-r3 description:
Boost date_time shared library

boost1.84-date_time-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-date_time-1.84.0-r3 installed size:
13 KiB

boost1.84-date_time-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-fiber`

```console
boost1.84-fiber-1.84.0-r3 description:
Boost fiber shared library

boost1.84-fiber-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-fiber-1.84.0-r3 installed size:
78 KiB

boost1.84-fiber-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-filesystem`

```console
boost1.84-filesystem-1.84.0-r3 description:
Boost filesystem shared library

boost1.84-filesystem-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-filesystem-1.84.0-r3 installed size:
154 KiB

boost1.84-filesystem-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-graph`

```console
boost1.84-graph-1.84.0-r3 description:
Boost graph shared library

boost1.84-graph-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-graph-1.84.0-r3 installed size:
407 KiB

boost1.84-graph-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-iostreams`

```console
boost1.84-iostreams-1.84.0-r3 description:
Boost iostreams shared library

boost1.84-iostreams-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-iostreams-1.84.0-r3 installed size:
93 KiB

boost1.84-iostreams-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-json`

```console
boost1.84-json-1.84.0-r3 description:
Boost json shared library

boost1.84-json-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-json-1.84.0-r3 installed size:
362 KiB

boost1.84-json-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-libs`

```console
boost1.84-libs-1.84.0-r3 description:
Boost shared libraries

boost1.84-libs-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-libs-1.84.0-r3 installed size:
49 KiB

boost1.84-libs-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-locale`

```console
boost1.84-locale-1.84.0-r3 description:
Boost locale shared library

boost1.84-locale-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-locale-1.84.0-r3 installed size:
902 KiB

boost1.84-locale-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-log`

```console
boost1.84-log-1.84.0-r3 description:
Boost log shared library

boost1.84-log-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-log-1.84.0-r3 installed size:
926 KiB

boost1.84-log-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-log_setup`

```console
boost1.84-log_setup-1.84.0-r3 description:
Boost log_setup shared library

boost1.84-log_setup-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-log_setup-1.84.0-r3 installed size:
987 KiB

boost1.84-log_setup-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-math`

```console
boost1.84-math-1.84.0-r3 description:
Boost math shared library

boost1.84-math-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-math-1.84.0-r3 installed size:
1182 KiB

boost1.84-math-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-nowide`

```console
boost1.84-nowide-1.84.0-r3 description:
Boost nowide shared library

boost1.84-nowide-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-nowide-1.84.0-r3 installed size:
17 KiB

boost1.84-nowide-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-prg_exec_monitor`

```console
boost1.84-prg_exec_monitor-1.84.0-r3 description:
Boost prg_exec_monitor shared library

boost1.84-prg_exec_monitor-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-prg_exec_monitor-1.84.0-r3 installed size:
78 KiB

boost1.84-prg_exec_monitor-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-program_options`

```console
boost1.84-program_options-1.84.0-r3 description:
Boost program_options shared library

boost1.84-program_options-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-program_options-1.84.0-r3 installed size:
429 KiB

boost1.84-program_options-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-python3`

```console
boost1.84-python3-1.84.0-r3 description:
Boost python3 shared library

boost1.84-python3-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-python3-1.84.0-r3 installed size:
265 KiB

boost1.84-python3-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-random`

```console
boost1.84-random-1.84.0-r3 description:
Boost random shared library

boost1.84-random-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-random-1.84.0-r3 installed size:
38 KiB

boost1.84-random-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-regex`

```console
boost1.84-regex-1.84.0-r3 description:
Boost regex shared library

boost1.84-regex-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-regex-1.84.0-r3 installed size:
363 KiB

boost1.84-regex-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-serialization`

```console
boost1.84-serialization-1.84.0-r3 description:
Boost serialization shared library

boost1.84-serialization-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-serialization-1.84.0-r3 installed size:
281 KiB

boost1.84-serialization-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-stacktrace_basic`

```console
boost1.84-stacktrace_basic-1.84.0-r3 description:
Boost stacktrace_basic shared library

boost1.84-stacktrace_basic-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-stacktrace_basic-1.84.0-r3 installed size:
17 KiB

boost1.84-stacktrace_basic-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-stacktrace_noop`

```console
boost1.84-stacktrace_noop-1.84.0-r3 description:
Boost stacktrace_noop shared library

boost1.84-stacktrace_noop-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-stacktrace_noop-1.84.0-r3 installed size:
13 KiB

boost1.84-stacktrace_noop-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-system`

```console
boost1.84-system-1.84.0-r3 description:
Boost system shared library

boost1.84-system-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-system-1.84.0-r3 installed size:
13 KiB

boost1.84-system-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-thread`

```console
boost1.84-thread-1.84.0-r3 description:
Boost thread shared library

boost1.84-thread-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-thread-1.84.0-r3 installed size:
114 KiB

boost1.84-thread-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-timer`

```console
boost1.84-timer-1.84.0-r3 description:
Boost timer shared library

boost1.84-timer-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-timer-1.84.0-r3 installed size:
21 KiB

boost1.84-timer-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-type_erasure`

```console
boost1.84-type_erasure-1.84.0-r3 description:
Boost type_erasure shared library

boost1.84-type_erasure-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-type_erasure-1.84.0-r3 installed size:
58 KiB

boost1.84-type_erasure-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-unit_test_framework`

```console
boost1.84-unit_test_framework-1.84.0-r3 description:
Boost unit_test_framework shared library

boost1.84-unit_test_framework-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-unit_test_framework-1.84.0-r3 installed size:
734 KiB

boost1.84-unit_test_framework-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-url`

```console
boost1.84-url-1.84.0-r3 description:
Boost url shared library

boost1.84-url-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-url-1.84.0-r3 installed size:
358 KiB

boost1.84-url-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-wave`

```console
boost1.84-wave-1.84.0-r3 description:
Boost wave shared library

boost1.84-wave-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-wave-1.84.0-r3 installed size:
938 KiB

boost1.84-wave-1.84.0-r3 license:
BSL-1.0

```

### `apk` package: `boost1.84-wserialization`

```console
boost1.84-wserialization-1.84.0-r3 description:
Boost wserialization shared library

boost1.84-wserialization-1.84.0-r3 webpage:
https://www.boost.org/

boost1.84-wserialization-1.84.0-r3 installed size:
189 KiB

boost1.84-wserialization-1.84.0-r3 license:
BSL-1.0
...
```console
cyrus-sasl-2.1.28-r9 description:
Cyrus Simple Authentication Service Layer (SASL)

cyrus-sasl-2.1.28-r9 webpage:
https://www.cyrusimap.org/sasl/

cyrus-sasl-2.1.28-r9 installed size:
126 KiB

cyrus-sasl-2.1.28-r9 license:
...
```console
heimdal-libs-7.8.0-r5 description:
Heimdal libraries

heimdal-libs-7.8.0-r5 webpage:
https://github.com/heimdal/

heimdal-libs-7.8.0-r5 installed size:
2654 KiB

heimdal-libs-7.8.0-r5 license:
BSD-3-Clause
