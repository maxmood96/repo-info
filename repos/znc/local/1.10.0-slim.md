...
```console
cyrus-sasl-2.1.28-r8 description:
Cyrus Simple Authentication Service Layer (SASL)

cyrus-sasl-2.1.28-r8 webpage:
https://www.cyrusimap.org/sasl/

cyrus-sasl-2.1.28-r8 installed size:
126 KiB

cyrus-sasl-2.1.28-r8 license:
...
```console
heimdal-libs-7.8.0-r4 description:
Heimdal libraries

heimdal-libs-7.8.0-r4 webpage:
https://github.com/heimdal/

heimdal-libs-7.8.0-r4 installed size:
2662 KiB

heimdal-libs-7.8.0-r4 license:
BSD-3-Clause
