...
cmake-4.1.3-r0 webpage:
https://cmake.org/

cmake-4.1.3-r0 installed size:
54 MiB

cmake-4.1.3-r0 license:
BSD-3-Clause
...
```console
g++-15.2.0-r2 description:
GNU C++ standard library and compiler

g++-15.2.0-r2 webpage:
https://gcc.gnu.org

g++-15.2.0-r2 installed size:
45 MiB
...
```console
libarchive-3.8.5-r0 description:
library that can create and read several streaming archive formats

libarchive-3.8.5-r0 webpage:
https://libarchive.org/

libarchive-3.8.5-r0 installed size:
641 KiB

libarchive-3.8.5-r0 license:
...
```console
libstdc++-dev-15.2.0-r2 description:
GNU C++ standard runtime library (development files)

libstdc++-dev-15.2.0-r2 webpage:
https://gcc.gnu.org

libstdc++-dev-15.2.0-r2 installed size:
21 MiB

libstdc++-dev-15.2.0-r2 license:
GPL-2.0-or-later AND LGPL-2.1-or-later
...
```console
rhash-libs-1.4.6-r0 description:
Utility for calculation and verification of hash sums and magnet links (libraries)

rhash-libs-1.4.6-r0 webpage:
http://rhash.anz.ru

rhash-libs-1.4.6-r0 installed size:
229 KiB

rhash-libs-1.4.6-r0 license:
0BSD
