...
```console
cmake-3.31.7-r1 description:
Cross-platform, open-source make system

cmake-3.31.7-r1 webpage:
https://www.cmake.org/

cmake-3.31.7-r1 installed size:
51 MiB

cmake-3.31.7-r1 license:
BSD-3-Clause
...
```console
file-5.46-r2 description:
File type identification utility

file-5.46-r2 webpage:
https://www.darwinsys.com/file/

file-5.46-r2 installed size:
26 KiB

file-5.46-r2 license:
BSD-2-Clause
...
```console
fortify-headers-1.1-r5 description:
standalone fortify source implementation

fortify-headers-1.1-r5 webpage:
http://git.2f30.org/fortify-headers/

fortify-headers-1.1-r5 installed size:
31 KiB

fortify-headers-1.1-r5 license:
0BSD
...
```console
g++-14.2.0-r6 description:
GNU C++ standard library and compiler

g++-14.2.0-r6 webpage:
https://gcc.gnu.org

g++-14.2.0-r6 installed size:
41 MiB
...
```console
libarchive-3.8.1-r0 description:
library that can create and read several streaming archive formats

libarchive-3.8.1-r0 webpage:
https://libarchive.org/

libarchive-3.8.1-r0 installed size:
645 KiB

libarchive-3.8.1-r0 license:
...
```console
libmagic-5.46-r2 description:
File type identification library

libmagic-5.46-r2 webpage:
https://www.darwinsys.com/file/

libmagic-5.46-r2 installed size:
9 MiB

libmagic-5.46-r2 license:
BSD-2-Clause
...
```console
libstdc++-dev-14.2.0-r6 description:
GNU C++ standard runtime library (development files)

libstdc++-dev-14.2.0-r6 webpage:
https://gcc.gnu.org

libstdc++-dev-14.2.0-r6 installed size:
21 MiB

libstdc++-dev-14.2.0-r6 license:
GPL-2.0-or-later AND LGPL-2.1-or-later
...
```console
openssl-dev-3.5.4-r0 description:
Toolkit for Transport Layer Security (TLS) (development files)

openssl-dev-3.5.4-r0 webpage:
https://www.openssl.org/

openssl-dev-3.5.4-r0 installed size:
2152 KiB

openssl-dev-3.5.4-r0 license:
Apache-2.0
...
```console
rhash-libs-1.4.5-r0 description:
Utility for calculation and verification of hash sums and magnet links (libraries)

rhash-libs-1.4.5-r0 webpage:
http://rhash.anz.ru

rhash-libs-1.4.5-r0 installed size:
221 KiB

rhash-libs-1.4.5-r0 license:
0BSD
...
```console
runtime-dependencies-20251008.225816 description:
virtual meta package

runtime-dependencies-20251008.225816 webpage:


runtime-dependencies-20251008.225816 installed size:
0 B

runtime-dependencies-20251008.225816 license:
