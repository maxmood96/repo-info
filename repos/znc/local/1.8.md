...
- Created: `2024-01-27T07:58:10.931747713Z`
...
```console
openssl-dev-3.0.12-r4 description:
Toolkit for Transport Layer Security (TLS) (development files)

openssl-dev-3.0.12-r4 webpage:
https://www.openssl.org/

openssl-dev-3.0.12-r4 installed size:
2228 KiB

openssl-dev-3.0.12-r4 license:
Apache-2.0
