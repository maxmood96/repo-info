...
### `adminer:4.7.9-standalone` - linux; amd64
...
### `adminer:4.7.9-standalone` - linux; arm variant v6
...
### `adminer:4.7.9-standalone` - linux; arm variant v7
...
### `adminer:4.7.9-standalone` - linux; arm64 variant v8
...
### `adminer:4.7.9-standalone` - linux; 386
...
### `adminer:4.7.9-standalone` - linux; ppc64le
...
### `adminer:4.7.9-standalone` - linux; s390x
