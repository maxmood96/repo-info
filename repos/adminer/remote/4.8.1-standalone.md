...
```console
$ docker pull adminer@sha256:9e339edf889c7dc4625e5834c1f3152bf100de861c6c721511b68662e822bfcd
```
...
```console
$ docker pull adminer@sha256:8ec5aa65f0c3a3c2c735d629ece7997ab5bb51e52018f29f331de68e7da95ccd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.3 MB (31309790 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0bb00fe03def3e5a51a30c4a0d2e433b55864e63aefbcc44b5ef68c1a544e146`
-	Entrypoint: `["entrypoint.sh","docker-php-entrypoint"]`
-	Default Command: `["php","-S","[::]:8080","-t","\/var\/www\/html"]`
...
# Thu, 23 Sep 2021 23:51:33 GMT
CMD ["php" "-a"]
# Mon, 11 Oct 2021 15:45:13 GMT
RUN echo "upload_max_filesize = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "post_max_size = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "memory_limit = 1G" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_execution_time = 600" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_input_vars = 5000" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini
# Mon, 11 Oct 2021 15:45:14 GMT
STOPSIGNAL SIGINT
# Mon, 11 Oct 2021 15:45:16 GMT
RUN addgroup -S adminer &&	adduser -S -G adminer adminer &&	mkdir -p /var/www/html &&	mkdir -p /var/www/html/plugins-enabled &&	chown -R adminer:adminer /var/www/html
# Mon, 11 Oct 2021 15:45:16 GMT
WORKDIR /var/www/html
# Mon, 11 Oct 2021 15:46:29 GMT
RUN set -x &&	apk add --no-cache --virtual .build-deps 	postgresql-dev 	sqlite-dev 	unixodbc-dev 	freetds-dev &&	docker-php-ext-configure pdo_odbc --with-pdo-odbc=unixODBC,/usr &&	docker-php-ext-install 	pdo_mysql 	pdo_pgsql 	pdo_sqlite 	pdo_odbc 	pdo_dblib &&	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)" &&	apk add --virtual .phpexts-rundeps $runDeps &&	apk del .build-deps
# Mon, 11 Oct 2021 15:46:30 GMT
COPY multi:8e2583c31626149dac766c1e81b6ba87f4289e683e42823f52b952fbab069922 in /var/www/html/ 
# Mon, 11 Oct 2021 15:46:30 GMT
ENV ADMINER_VERSION=4.8.1
# Mon, 11 Oct 2021 15:46:31 GMT
ENV ADMINER_DOWNLOAD_SHA256=2fd7e6d8f987b243ab1839249551f62adce19704c47d3d0c8dd9e57ea5b9c6b3
# Mon, 11 Oct 2021 15:46:31 GMT
ENV ADMINER_SRC_DOWNLOAD_SHA256=ef832414296d11eed33e9d85fff3fb316c63f13f05fceb4a961cbe4cb2ae8712
# Mon, 11 Oct 2021 15:46:34 GMT
RUN set -x &&	curl -fsSL https://github.com/vrana/adminer/releases/download/v$ADMINER_VERSION/adminer-$ADMINER_VERSION.php -o adminer.php &&	echo "$ADMINER_DOWNLOAD_SHA256  adminer.php" |sha256sum -c - &&	curl -fsSL https://github.com/vrana/adminer/archive/v$ADMINER_VERSION.tar.gz -o source.tar.gz &&	echo "$ADMINER_SRC_DOWNLOAD_SHA256  source.tar.gz" |sha256sum -c - &&	tar xzf source.tar.gz --strip-components=1 "adminer-$ADMINER_VERSION/designs/" "adminer-$ADMINER_VERSION/plugins/" &&	rm source.tar.gz
# Mon, 11 Oct 2021 15:46:35 GMT
COPY file:5ff0be587f5dd9166f7a558457b0e656c889de46d3bb2afd41f1714ab2c02ceb in /usr/local/bin/ 
# Mon, 11 Oct 2021 15:46:35 GMT
ENTRYPOINT ["entrypoint.sh" "docker-php-entrypoint"]
# Mon, 11 Oct 2021 15:46:36 GMT
USER adminer
# Mon, 11 Oct 2021 15:46:36 GMT
CMD ["php" "-S" "[::]:8080" "-t" "/var/www/html"]
# Mon, 11 Oct 2021 15:46:37 GMT
EXPOSE 8080
```
...
-	Layers:
	...
	-	`sha256:c0960abead06b887aa1b554f6858104f31e7223b873dc760ef5c601c9c2a85fe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:969ae087392d9602a36355ea923abc176c57e03443021b3cb57756f9c4caa288`  
		Last Modified: Mon, 11 Oct 2021 15:49:12 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51d2ce3c03c274148eedcfae177cbec94759cbed11cf020f37f4a3c11d3633ee`  
		Last Modified: Mon, 11 Oct 2021 15:49:10 GMT  
		Size: 1.4 KB (1413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:701bc38218b178b00391fc344841fe074b3c9c303ba4f6d466f82aa599d40066`  
		Last Modified: Mon, 11 Oct 2021 15:49:12 GMT  
		Size: 3.6 MB (3647335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e457c90e8935aba3b462de1b661079f6e6bcc5b2ec67fc518053b81f534f80`  
		Last Modified: Mon, 11 Oct 2021 15:49:10 GMT  
		Size: 1.5 KB (1491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bf4ac48260736c36fc3fc4c85bcc8957a13b0a1ff6bfc6397379fd879d74d92`  
		Last Modified: Mon, 11 Oct 2021 15:49:11 GMT  
		Size: 583.0 KB (583039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6cbb209e43c1fd4bbc7c9dcc40e29611363d0325117ef7f886770607befce9e`  
		Last Modified: Mon, 11 Oct 2021 15:49:11 GMT  
		Size: 499.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull adminer@sha256:1f3bb25880ffac642c168276e5d25f8839327fe05635818454ff7eddbfc14552
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.7 MB (33682255 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe71981f5f6d1dfa30e2c19396d7aa66598b60c65d2e9644eaea15e6e6b3ccf9`
-	Entrypoint: `["entrypoint.sh","docker-php-entrypoint"]`
-	Default Command: `["php","-S","[::]:8080","-t","\/var\/www\/html"]`
...
RUN echo "upload_max_filesize = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "post_max_size = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "memory_limit = 1G" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_execution_time = 600" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_input_vars = 5000" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini
# Wed, 13 Oct 2021 13:21:51 GMT
STOPSIGNAL SIGINT
# Wed, 13 Oct 2021 13:21:52 GMT
RUN addgroup -S adminer &&	adduser -S -G adminer adminer &&	mkdir -p /var/www/html &&	mkdir -p /var/www/html/plugins-enabled &&	chown -R adminer:adminer /var/www/html
# Wed, 13 Oct 2021 13:21:53 GMT
WORKDIR /var/www/html
# Wed, 13 Oct 2021 13:22:21 GMT
RUN set -x &&	apk add --no-cache --virtual .build-deps 	postgresql-dev 	sqlite-dev 	unixodbc-dev 	freetds-dev &&	docker-php-ext-configure pdo_odbc --with-pdo-odbc=unixODBC,/usr &&	docker-php-ext-install 	pdo_mysql 	pdo_pgsql 	pdo_sqlite 	pdo_odbc 	pdo_dblib &&	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)" &&	apk add --virtual .phpexts-rundeps $runDeps &&	apk del .build-deps
# Wed, 13 Oct 2021 13:22:23 GMT
COPY multi:8e2583c31626149dac766c1e81b6ba87f4289e683e42823f52b952fbab069922 in /var/www/html/ 
# Wed, 13 Oct 2021 13:22:23 GMT
ENV ADMINER_VERSION=4.8.1
# Wed, 13 Oct 2021 13:22:24 GMT
ENV ADMINER_DOWNLOAD_SHA256=2fd7e6d8f987b243ab1839249551f62adce19704c47d3d0c8dd9e57ea5b9c6b3
# Wed, 13 Oct 2021 13:22:25 GMT
ENV ADMINER_SRC_DOWNLOAD_SHA256=ef832414296d11eed33e9d85fff3fb316c63f13f05fceb4a961cbe4cb2ae8712
# Wed, 13 Oct 2021 13:22:27 GMT
RUN set -x &&	curl -fsSL https://github.com/vrana/adminer/releases/download/v$ADMINER_VERSION/adminer-$ADMINER_VERSION.php -o adminer.php &&	echo "$ADMINER_DOWNLOAD_SHA256  adminer.php" |sha256sum -c - &&	curl -fsSL https://github.com/vrana/adminer/archive/v$ADMINER_VERSION.tar.gz -o source.tar.gz &&	echo "$ADMINER_SRC_DOWNLOAD_SHA256  source.tar.gz" |sha256sum -c - &&	tar xzf source.tar.gz --strip-components=1 "adminer-$ADMINER_VERSION/designs/" "adminer-$ADMINER_VERSION/plugins/" &&	rm source.tar.gz
# Wed, 13 Oct 2021 13:22:29 GMT
COPY file:5ff0be587f5dd9166f7a558457b0e656c889de46d3bb2afd41f1714ab2c02ceb in /usr/local/bin/ 
# Wed, 13 Oct 2021 13:22:29 GMT
ENTRYPOINT ["entrypoint.sh" "docker-php-entrypoint"]
# Wed, 13 Oct 2021 13:22:30 GMT
USER adminer
# Wed, 13 Oct 2021 13:22:31 GMT
CMD ["php" "-S" "[::]:8080" "-t" "/var/www/html"]
# Wed, 13 Oct 2021 13:22:32 GMT
EXPOSE 8080
```
...
-	Layers:
	...
	-	`sha256:26a36d4e4195aebfa120145862f4a0d4eac484bbbfb21d3de20d89544087c6f3`  
		...
		Size: 17.8 KB (17840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2df21ba2c585cdf1f4bede119380f95753b6dc7d65c6a33253e8841f4a47a765`  
		Last Modified: Wed, 13 Oct 2021 13:23:46 GMT  
		Size: 305.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11ba55603a38017b5206373f36fd4b1e8705da0a9dcfe7fca8cdb90d9948e3ae`  
		Last Modified: Wed, 13 Oct 2021 13:23:45 GMT  
		Size: 1.4 KB (1371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a55a03ba98f96cdcf9b15f92f3c471a902a3023da39798bdb9e9b401b179fe05`  
		Last Modified: Wed, 13 Oct 2021 13:23:45 GMT  
		Size: 3.9 MB (3927883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54208c052785d419a6884f49b3e248af9ac73a2b5921fdfc481cfdc9c0b1e041`  
		Last Modified: Wed, 13 Oct 2021 13:23:44 GMT  
		Size: 1.5 KB (1490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:300cd92812d6feabd0743452f70539916755331a94647905e132be1e52daca62`  
		Last Modified: Wed, 13 Oct 2021 13:23:44 GMT  
		Size: 584.1 KB (584073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6431dce51b2237a2379ccdefe1994fe6c052181158c029d9da247ee1f538b4fb`  
		Last Modified: Wed, 13 Oct 2021 13:23:44 GMT  
		Size: 500.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
