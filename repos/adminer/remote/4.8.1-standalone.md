...
```console
$ docker pull adminer@sha256:f6e1706a3efe5bf83bd383eb005c50b785ed656dcb1288208749512affde00c9
```
...
```console
$ docker pull adminer@sha256:11bd25fdb3a830d22751cefcaabb86cde32d23fdf32e91661bde01b29ac6e8da
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.1 MB (32140776 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7fb7e092eb6df39ea5e41c9aab3492a9a17c5b36e8ea55fd1375ddd9e7a41bf`
-	Entrypoint: `["entrypoint.sh","docker-php-entrypoint"]`
-	Default Command: `["php","-S","[::]:8080","-t","\/var\/www\/html"]`
...
# Fri, 04 Jun 2021 03:49:49 GMT
CMD ["php" "-a"]
# Fri, 04 Jun 2021 06:22:13 GMT
RUN echo "upload_max_filesize = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "post_max_size = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "memory_limit = 1G" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_execution_time = 600" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_input_vars = 5000" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini
# Fri, 04 Jun 2021 06:22:14 GMT
STOPSIGNAL SIGINT
# Fri, 04 Jun 2021 06:22:14 GMT
RUN addgroup -S adminer &&	adduser -S -G adminer adminer &&	mkdir -p /var/www/html &&	mkdir -p /var/www/html/plugins-enabled &&	chown -R adminer:adminer /var/www/html
# Fri, 04 Jun 2021 06:22:15 GMT
WORKDIR /var/www/html
# Fri, 04 Jun 2021 06:22:41 GMT
RUN set -x &&	apk add --no-cache --virtual .build-deps 	postgresql-dev 	sqlite-dev 	unixodbc-dev 	freetds-dev &&	docker-php-ext-configure pdo_odbc --with-pdo-odbc=unixODBC,/usr &&	docker-php-ext-install 	pdo_mysql 	pdo_pgsql 	pdo_sqlite 	pdo_odbc 	pdo_dblib &&	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)" &&	apk add --virtual .phpexts-rundeps $runDeps &&	apk del .build-deps
# Fri, 04 Jun 2021 06:22:41 GMT
COPY multi:3020a2cf8da93deb4663b2b608f3156b5f8da81b19c0fa615f495168d48abf9c in /var/www/html/ 
# Fri, 04 Jun 2021 06:22:41 GMT
...
# Fri, 04 Jun 2021 06:22:41 GMT
ENV ADMINER_DOWNLOAD_SHA256=2fd7e6d8f987b243ab1839249551f62adce19704c47d3d0c8dd9e57ea5b9c6b3
# Fri, 04 Jun 2021 06:22:42 GMT
ENV ADMINER_SRC_DOWNLOAD_SHA256=ef832414296d11eed33e9d85fff3fb316c63f13f05fceb4a961cbe4cb2ae8712
# Fri, 04 Jun 2021 06:22:43 GMT
RUN set -x &&	curl -fsSL https://github.com/vrana/adminer/releases/download/v$ADMINER_VERSION/adminer-$ADMINER_VERSION.php -o adminer.php &&	echo "$ADMINER_DOWNLOAD_SHA256  adminer.php" |sha256sum -c - &&	curl -fsSL https://github.com/vrana/adminer/archive/v$ADMINER_VERSION.tar.gz -o source.tar.gz &&	echo "$ADMINER_SRC_DOWNLOAD_SHA256  source.tar.gz" |sha256sum -c - &&	tar xzf source.tar.gz --strip-components=1 "adminer-$ADMINER_VERSION/designs/" "adminer-$ADMINER_VERSION/plugins/" &&	rm source.tar.gz
# Fri, 04 Jun 2021 06:22:43 GMT
COPY file:5ff0be587f5dd9166f7a558457b0e656c889de46d3bb2afd41f1714ab2c02ceb in /usr/local/bin/ 
# Fri, 04 Jun 2021 06:22:44 GMT
ENTRYPOINT ["entrypoint.sh" "docker-php-entrypoint"]
# Fri, 04 Jun 2021 06:22:44 GMT
USER adminer
# Fri, 04 Jun 2021 06:22:44 GMT
...
-	Layers:
	...
	-	`sha256:1b159a4dc278a5c0d866a7db65bc12ebd0294dfe69079d6bdf6cdf503fc59418`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed8d8caf3465d4c62e0c16adf61793e5fb8f1cc10bcfef04d72c917a7cfd0668`  
		Last Modified: Fri, 04 Jun 2021 06:24:05 GMT  
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00bf0ef647b728b4d8355b6103d4c585f2a7127ba146c80dceda078dcb582df8`  
		Last Modified: Fri, 04 Jun 2021 06:24:02 GMT  
		Size: 1.4 KB (1402 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5b7acd232275fa9b82b2ded0b134d67accf365e147097b36f59e0c7a293836c`  
		Last Modified: Fri, 04 Jun 2021 06:24:03 GMT  
		Size: 3.6 MB (3603852 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed21084e74233ca751134a0dbc133ac03bb3ade0c92dc3924c9047f890264150`  
		Last Modified: Fri, 04 Jun 2021 06:24:03 GMT  
		Size: 1.5 KB (1473 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58d202a16c01e511ebb96351b210b8596617ffb0a05d3d31c898da995abd6bfb`  
		Last Modified: Fri, 04 Jun 2021 06:24:02 GMT  
		Size: 583.0 KB (583039 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:157ea33f0353ea9e5753b6ab348eca05d5abd84b87f3b9434eba487a856f8d85`  
		Last Modified: Fri, 04 Jun 2021 06:24:02 GMT  
		Size: 495.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull adminer@sha256:4aec095b6f5576b6fefc4d435b81954ef7294428310283ac2e62c0a4303d50ba
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.0 MB (30950410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c661a5c1d3e7b4e729d25787a75154322a58daf0e63b1dd3e6f8bc6066f19ff5`
-	Entrypoint: `["entrypoint.sh","docker-php-entrypoint"]`
-	Default Command: `["php","-S","[::]:8080","-t","\/var\/www\/html"]`
...
# Fri, 04 Jun 2021 04:21:49 GMT
CMD ["php" "-a"]
# Fri, 04 Jun 2021 09:05:26 GMT
RUN echo "upload_max_filesize = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "post_max_size = 128M" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "memory_limit = 1G" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_execution_time = 600" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini &&	echo "max_input_vars = 5000" >> /usr/local/etc/php/conf.d/0-upload_large_dumps.ini
# Fri, 04 Jun 2021 09:05:27 GMT
STOPSIGNAL SIGINT
# Fri, 04 Jun 2021 09:05:27 GMT
RUN addgroup -S adminer &&	adduser -S -G adminer adminer &&	mkdir -p /var/www/html &&	mkdir -p /var/www/html/plugins-enabled &&	chown -R adminer:adminer /var/www/html
# Fri, 04 Jun 2021 09:05:28 GMT
WORKDIR /var/www/html
# Fri, 04 Jun 2021 09:05:52 GMT
RUN set -x &&	apk add --no-cache --virtual .build-deps 	postgresql-dev 	sqlite-dev 	unixodbc-dev 	freetds-dev &&	docker-php-ext-configure pdo_odbc --with-pdo-odbc=unixODBC,/usr &&	docker-php-ext-install 	pdo_mysql 	pdo_pgsql 	pdo_sqlite 	pdo_odbc 	pdo_dblib &&	runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)" &&	apk add --virtual .phpexts-rundeps $runDeps &&	apk del .build-deps
# Fri, 04 Jun 2021 09:05:53 GMT
COPY multi:3020a2cf8da93deb4663b2b608f3156b5f8da81b19c0fa615f495168d48abf9c in /var/www/html/ 
# Fri, 04 Jun 2021 09:05:53 GMT
ENV ADMINER_VERSION=4.8.1
# Fri, 04 Jun 2021 09:05:53 GMT
...
-	Layers:
	...
	-	`sha256:71ed0b6a498999919909286a0243c52ea6e8e3a4cda473a5b08b1bec6cc418d0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0a29fe703182d4573d1dc40388deb6fabde6ae24840315312ef11964c6cc46f`  
		Last Modified: Fri, 04 Jun 2021 09:07:17 GMT  
		Size: 306.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:977c4b2408b3b680a041f4e5e7df30d28ef36883c81387b4a9c4022f263afbc2`  
		Last Modified: Fri, 04 Jun 2021 09:07:14 GMT  
		Size: 1.4 KB (1401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47a63fb770c7624bb3118db7387451a56b25a0cc6fd439e91699157fe33d252e`  
		Last Modified: Fri, 04 Jun 2021 09:07:15 GMT  
		Size: 3.6 MB (3581154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac5365cc3218f0c026cf2805319079a802660a86006b87fb8237ada9834f48c7`  
		Last Modified: Fri, 04 Jun 2021 09:07:14 GMT  
		Size: 1.5 KB (1470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82f54f4f3ed9977178e911810690f2b94ea297bbe888a786f5ec138fe2f1e64f`  
		Last Modified: Fri, 04 Jun 2021 09:07:14 GMT  
		Size: 583.0 KB (583037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df31c525a5740b99f09befcad09b6fbaebec8e6827c3ced5343b8bffbc026180`  
		Last Modified: Fri, 04 Jun 2021 09:07:14 GMT  
		Size: 494.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
