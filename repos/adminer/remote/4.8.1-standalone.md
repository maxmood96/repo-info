...
```console
$ docker pull adminer@sha256:fcb4f9e5124cf48fd12d5e3fbf8bc37a17fd8d9c2fefbce4b713d2eb6a220377
```
...
```console
$ docker pull adminer@sha256:cbd3d7b36167c6372ae15a95da5c6676f19d214e2895257f476ce9342236d76b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.6 MB (92634712 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7911949e45f78f12dc2645e22e99fce6875248fde37238c2fd1503f9bc49713c`
-	Entrypoint: `["entrypoint.sh"]`
-	Default Command: `["php","-S","[::]:8080","-t","\/var\/www\/html"]`
...
CMD ["bash"]
# Wed, 20 Dec 2023 13:21:31 GMT
STOPSIGNAL SIGINT
# Wed, 20 Dec 2023 13:23:31 GMT
RUN export DEBIAN_FRONTEND="noninteractive" &&	set -x &&	apt-get update &&	apt-get install -y 		php7.4-cli 		php7.4-fpm 		php7.4-mbstring 		php7.4-mysql 		php7.4-odbc 		php7.4-pdo-dblib 		php7.4-pgsql 		php7.4-sqlite3 &&	rm -rf /var/lib/apt/lists/*
# Wed, 20 Dec 2023 13:23:38 GMT
RUN echo "upload_max_filesize = 128M" >> /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini &&	echo "post_max_size = 128M" >> /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini &&	echo "memory_limit = 1G" >> /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini &&	echo "max_execution_time = 600" >> /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini &&	echo "max_input_vars = 5000" >> /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini &&	echo "variables_order = \"EGPCS\"" >> /etc/php/7.4/cli/conf.d/0-env.ini &&	cp /etc/php/7.4/cli/conf.d/0-upload_large_dumps.ini /etc/php/7.4/fpm/conf.d/0-upload_large_dumps.ini
# Wed, 20 Dec 2023 13:23:45 GMT
RUN groupadd -r adminer &&	useradd -r -g adminer adminer &&	mkdir -p /var/www/html &&	mkdir /var/www/html/plugins-enabled &&	chown -R adminer:adminer /var/www/html
# Wed, 20 Dec 2023 13:23:49 GMT
WORKDIR /var/www/html
# Wed, 20 Dec 2023 13:23:52 GMT
COPY multi:8e2583c31626149dac766c1e81b6ba87f4289e683e42823f52b952fbab069922 in /var/www/html/ 
# Wed, 20 Dec 2023 13:23:55 GMT
ENV ADMINER_VERSION=4.8.1
# Wed, 20 Dec 2023 13:23:59 GMT
ENV ADMINER_DOWNLOAD_SHA256=2fd7e6d8f987b243ab1839249551f62adce19704c47d3d0c8dd9e57ea5b9c6b3
# Wed, 20 Dec 2023 13:24:02 GMT
ENV ADMINER_COMMIT=1f173e18bdf0be29182e0d67989df56eadea4754
# Wed, 20 Dec 2023 13:24:55 GMT
RUN export DEBIAN_FRONTEND="noninteractive" &&	set -x &&	buildDeps='git curl ca-certificates' &&	apt-get update &&	apt-get install -y $buildDeps --no-install-recommends &&	rm -rf /var/lib/apt/lists/* &&	curl -fsSL "https://github.com/vrana/adminer/releases/download/v$ADMINER_VERSION/adminer-$ADMINER_VERSION.php" -o adminer.php &&	echo "$ADMINER_DOWNLOAD_SHA256  adminer.php" |sha256sum -c - &&	git clone --recurse-submodules=designs --depth 1 --shallow-submodules --branch "v$ADMINER_VERSION" https://github.com/vrana/adminer.git /tmp/adminer &&	commit="$(git -C /tmp/adminer/ rev-parse HEAD)" &&	[ "$commit" = "$ADMINER_COMMIT" ] &&	cp -r /tmp/adminer/designs/ /tmp/adminer/plugins/ . &&	rm -rf /tmp/adminer/ &&	apt-get purge -y --auto-remove $buildDeps
# Wed, 20 Dec 2023 13:24:58 GMT
COPY file:5ff0be587f5dd9166f7a558457b0e656c889de46d3bb2afd41f1714ab2c02ceb in /usr/local/bin/ 
# Wed, 20 Dec 2023 13:25:02 GMT
ENTRYPOINT ["entrypoint.sh"]
# Wed, 20 Dec 2023 13:25:05 GMT
USER adminer
# Wed, 20 Dec 2023 13:25:09 GMT
CMD ["php" "-S" "[::]:8080" "-t" "/var/www/html"]
# Wed, 20 Dec 2023 13:25:13 GMT
EXPOSE 8080
```
...
-	Layers:
	-	`sha256:4d8f97806f78898e256ac429d0634dfcccbd6f6e81547afde1469a5968e33b18`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53fabf241cc24cb471941e05238c7ec8e10f472cc8ec591f96f2d41f2d9e93e7`  
		Last Modified: Wed, 20 Dec 2023 13:27:47 GMT  
		Size: 38.0 MB (37954400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb8d5b111e5bee3f3783c725588f73fba85c417f85328ce1f9715591691fbb62`  
		Last Modified: Wed, 20 Dec 2023 13:27:21 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f83a7d02a844ed1910763b7405ab6c236ef30342df30b2d8d41ba16813327c70`  
		Last Modified: Wed, 20 Dec 2023 13:27:20 GMT  
		Size: 1.7 KB (1733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a47e90ab2df95ca1c79c2f35c919d7c56c241ddc9c0afa71a6f5872a7c105f8e`  
		Last Modified: Wed, 20 Dec 2023 13:27:20 GMT  
		Size: 1.5 KB (1483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4c358c99fd35755549e3a774f5feba98c65484a6101e92a59f745bc1404392a`  
		Last Modified: Wed, 20 Dec 2023 13:27:21 GMT  
		Size: 1.4 MB (1387200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bf74067605a1e195bb7b9aa4471e945f48982ce0205e5890c21faf5438c91a0`  
		Last Modified: Wed, 20 Dec 2023 13:27:20 GMT  
		Size: 492.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
