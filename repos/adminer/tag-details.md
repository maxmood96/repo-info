...
-	[`adminer:4.7.9`](#adminer479)
-	[`adminer:4.7.9-fastcgi`](#adminer479-fastcgi)
-	[`adminer:4.7.9-standalone`](#adminer479-standalone)
...
### `adminer:4.7.9-fastcgi` - linux; amd64
...
### `adminer:4.7.9-fastcgi` - linux; arm variant v6
...
### `adminer:4.7.9-fastcgi` - linux; arm variant v7
...
### `adminer:4.7.9-fastcgi` - linux; arm64 variant v8
...
### `adminer:4.7.9-fastcgi` - linux; 386
...
### `adminer:4.7.9-fastcgi` - linux; ppc64le
...
### `adminer:4.7.9-fastcgi` - linux; s390x
