...
- Created: `2026-06-06T00:13:11.214554004Z`
- Virtual Size: ~ 118.52 Mb  
...
```console
freetds-1.5.10-r0 description:
Tabular Datastream Library

freetds-1.5.10-r0 webpage:
https://www.freetds.org/

freetds-1.5.10-r0 installed size:
1720 KiB

freetds-1.5.10-r0 license:
