...
- Created: `2025-12-30T00:04:25.82958727Z`
- Virtual Size: ~ 144.38 Mb  
...
### `dpkg` source package: `neurodebian=0.43.0`

Binary Packages:

- `neurodebian-freeze=0.43.0`
...
```console
$ apt-get source -qq --print-uris neurodebian=0.43.0
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.43.0.dsc' neurodebian_0.43.0.dsc 2114 SHA256:468ab05f3f88343a2e9fae7f39c0f4c4eeca5a43223d169d2a65985f13c8dbcb
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.43.0.tar.xz' neurodebian_0.43.0.tar.xz 8328740 SHA256:791f2a69c372f5bb39c8352db8a9e5b8b07690922a16f7d47f14a40bd6fe0fd4
```

Other potentially useful URLs:

- https://sources.debian.net/src/neurodebian/0.43.0/ (for browsing the source)
- https://sources.debian.net/src/neurodebian/0.43.0/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/neurodebian/0.43.0/ (for access to the source package after it no longer exists in the archive)
