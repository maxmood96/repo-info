...
- Created: `2020-04-16T10:01:42.124923067Z`
- Virtual Size: ~ 138.26 Mb  
...
### `dpkg` source package: `neurodebian=0.40.0`

Binary Packages:

- `neurodebian-freeze=0.40.0`
...
```console
$ apt-get source -qq --print-uris neurodebian=0.40.0
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.40.0.dsc' neurodebian_0.40.0.dsc 2146 SHA256:949973d4d2963e340efc5b194ff79ebdb824b21112f541b936212f39ca33dd32
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.40.0.tar.xz' neurodebian_0.40.0.tar.xz 8317284 SHA256:2daa4898ca75d4735533777ce5c1ae81dc84bb3a7cab9c832409323fafcbfa66
```

Other potentially useful URLs:

- https://sources.debian.net/src/neurodebian/0.40.0/ (for browsing the source)
- https://sources.debian.net/src/neurodebian/0.40.0/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/neurodebian/0.40.0/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `openldap=2.4.49+dfsg-3`

Binary Packages:

- `libldap-2.4-2:amd64=2.4.49+dfsg-3`
- `libldap-common=2.4.49+dfsg-3`
...
```console
$ apt-get source -qq --print-uris openldap=2.4.49+dfsg-3
'http://deb.debian.org/debian/pool/main/o/openldap/openldap_2.4.49+dfsg-3.dsc' openldap_2.4.49+dfsg-3.dsc 3036 SHA256:549c467ee7e755e14e539e5653198e9782455af14d2479de24bfa157d81882df
...
'http://deb.debian.org/debian/pool/main/o/openldap/openldap_2.4.49+dfsg-3.debian.tar.xz' openldap_2.4.49+dfsg-3.debian.tar.xz 170256 SHA256:376c37c182693180d27696b9af730e7714b53f3d1cfe37d616d4769d53662304
```

Other potentially useful URLs:

- https://sources.debian.net/src/openldap/2.4.49+dfsg-3/ (for browsing the source)
- https://sources.debian.net/src/openldap/2.4.49+dfsg-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openldap/2.4.49+dfsg-3/ (for access to the source package after it no longer exists in the archive)
