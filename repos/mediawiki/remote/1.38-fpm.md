...
```console
$ docker pull mediawiki@sha256:3cf72e88de4b5c2eb4b21e4c474c7b5079a0911c695b45852c9050d79477d1cf
```
...
```console
$ docker pull mediawiki@sha256:6a33034e0f27884ca919215b3abda8d294ac264f8b6d9b0d867d6372d11f3b62
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.2 MB (260220519 bytes)**  
...
-	Layers:
	...
	-	`sha256:aeb85258457956c122869c5559c410884b6d4ecfe26163d691d8c51ab43bb7d1`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5fe20719d85ab0d5f13c53bba481da404f5eec69ab8545b7e16832336e94d55`  
		Last Modified: Fri, 24 Mar 2023 00:08:21 GMT  
		Size: 56.1 MB (56142888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:b5f69dd9a1b9a76c59bb903cc6fe1f174df1b9a5fece1c8a0293a7b309c6112e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.0 MB (251006010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68862745d42cadfe531e0ce992b49f780067cde6ddff545caa88a3ed7efc5dc2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:b40a4c0d11b654732b797eab095ecf69ff7ba84afc9f219558b607f3b8f52ac6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3740f9c09d966fb4668e1ef3e822527f1a13d4d06c79e0d3e3a88761274f1041`  
		Last Modified: Thu, 23 Mar 2023 20:46:16 GMT  
		Size: 56.1 MB (56142843 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.38-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:bb754c752a7d11e751d4408a0dd7c3efe6f31f00978c3341ad053c9f2e0269f7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.7 MB (263748835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b61a0bd100af7a64f60f8aaa6714e2a61b498c5efebb76f8f7fcd8e6deea609e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Mar 2023 02:26:23 GMT
ENV MEDIAWIKI_VERSION=1.38.5
# Fri, 24 Mar 2023 02:26:46 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Mar 2023 02:26:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6abb7a08213e24ce8e20c56c42c69cc29de3696d8b8be93cd3840d8dc455a50c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3862550c1bd2fa2cb66993e19fc80f6d228485a145a9ebd7ff35fc984d12b0e`  
		Last Modified: Fri, 24 Mar 2023 02:30:12 GMT  
		Size: 56.1 MB (56142455 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.38-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:1e65c26470dcec27b7f4b4e3f86c58e09cf15c514d8e8aae0060256a2fe16de8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.2 MB (263191588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b280bc3c0c00d420c2a768136fa341234643d17fcaa434b9954a5be6cb90f48`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:4a2a4665f3adea0269d0398e06b6cc4fa82742ce573de13a7bca0bc0ed03d2c9`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1f9f05dfa116e59fa3487583838bec6ccd6a7a603944f35cf0b46f215a3634f`  
		Last Modified: Thu, 23 Mar 2023 20:48:01 GMT  
		Size: 56.1 MB (56143160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
