...
```console
$ docker pull mediawiki@sha256:1b688fcfaf31f44e9390a168e9db332f6c60fbeca1370fcf19d004a7e4e7ac39
```
...
```console
$ docker pull mediawiki@sha256:97cf7dce68a1a7b38b4528e4ff628d90a0aa648ea89871979be062d63aa0a5ce
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.8 MB (253833782 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ac13f60a135b4e39ad27dc75900fe56aa40caa3e2fbe780cf6abf5a6616e49f`
...
-	Layers:
	...
	-	`sha256:18e3be1502e4b4aad6be7cf9ce79e1defbb70c1aff6378bce3346cb070cebd1e`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb41ec3373ee6b545579b288321922f57329c001f676734b5a1c88562048e7b1`  
		Last Modified: Sun, 11 Apr 2021 05:30:50 GMT  
		Size: 41.3 MB (41323846 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:b5a4ac390788bbb4f218fbb1d2c775e1c519f472200b1bafcd8c43253761f7a9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.5 MB (228484801 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b0fd4355d0b333f985dbc07bf23adc1c7aadec85f4209cddda166ca672eca30`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 15:41:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sat, 10 Apr 2021 15:41:37 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sat, 10 Apr 2021 15:42:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 15:42:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b68e0e84c76a96de6353b856ee8e9ff6cebfb20e0572be9daca0db485a0c4621`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65a12a03caea436354b24b46c8b5867bece1fbcced35eec51747a853a2563a7a`  
		Last Modified: Sat, 10 Apr 2021 15:48:31 GMT  
		Size: 41.3 MB (41322101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:f0140008e3cea3607242dc25805695bd23c90eeb861c55e116264e242b73125c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.2 MB (222249505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24bde14c03b0e47e7d648cd0df47b265456132a91c27d182962cce1dcd5e8f15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 11 Apr 2021 02:16:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sun, 11 Apr 2021 02:16:18 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sun, 11 Apr 2021 02:17:01 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:17:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:17b484ff7582858a59a0038b5aafb2e4528b2b094a3bccd2a268d8ded7615a80`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83dc6e61244973879189ba7e4b67282673d4fb836927ab64c275645659b3df23`  
		Last Modified: Sun, 11 Apr 2021 02:21:57 GMT  
		Size: 41.3 MB (41321834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:283229ad9c7d6c7c9f9453c886cfc9424adf918f83b51924b699683977ea89d3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.7 MB (243708198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:197dbfa513e2fb39e4699015734c5689dac6e7d5598b0587f03074d588095816`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 11 Apr 2021 02:08:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sun, 11 Apr 2021 02:08:53 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sun, 11 Apr 2021 02:09:26 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:09:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2036dd6c9eecbbb9524c31f8a0e94bcdd6d924e220c979f910a1b700ca5aafa3`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afd72ffc8316625620e512b7c0861acf04543296d4d43ca5f2bb20fdc3ef2f9c`  
		Last Modified: Sun, 11 Apr 2021 02:13:45 GMT  
		Size: 41.3 MB (41323114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:176344a58a179bbff7beedcadd9f0cde9ee67a234ab32cc16c17a9cf16eb6a34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.5 MB (261539259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49e33d2f747a9c254d6c8a26e5deeb89cbcd7778003cc3d17b5cc3edbf3a117f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 20:53:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sat, 10 Apr 2021 20:53:26 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sat, 10 Apr 2021 20:53:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 20:53:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3b2d68488c79be7850bebd06b7fef9bc9a79cb62d1825189929fe8a956359972`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3308d1d914b24651895336a92408a4295a16d03643cfa8609add7324236d8f8a`  
		Last Modified: Sat, 10 Apr 2021 20:59:55 GMT  
		Size: 41.3 MB (41324216 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:26190dd6a0a9a0b87107724f42df386860bacfb7a012c18b78e6a24acfa200cb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **271.5 MB (271492826 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a650510597214da0ca20bc16295c2caaf690f0ed96131bc3a26aa8cfeba350cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 23:53:31 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sat, 10 Apr 2021 23:53:36 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sat, 10 Apr 2021 23:55:06 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 23:55:14 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8519d5a83406f14c565553df49fc7685e4cd2a0e292dec54be254848fdfa061e`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2d6c0175d4371d46e32b92b0235f43187ed0f1111c1ca0d2911748ebce0c271`  
		Last Modified: Sun, 11 Apr 2021 00:13:54 GMT  
		Size: 41.3 MB (41326754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
