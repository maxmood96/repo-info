...
```console
$ docker pull mediawiki@sha256:f15781eb04a976da54634bdc2e8b949149cba4e0b9c192f1a1349baeb2300ff2
```
...
```console
$ docker pull mediawiki@sha256:a3a9626c9f2ae9cc6ce4c9960430bed4be5b96e078fc7af3be171cea57c3cf87
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.8 MB (253835682 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87b6c94b963c3af623175d5405fb257523f8acd11ba99fe2290009ff671d03fb`
...
-	Layers:
	...
	-	`sha256:3e964addee36b2a675fcd6117346a258444f83ec65da324bb0c4c5899d74e742`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb9a47542b1c186070e45fd3dedce1984365c036277372b13b40e80eff6d1233`  
		Last Modified: Thu, 01 Apr 2021 08:46:52 GMT  
		Size: 41.3 MB (41324865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:90d20d51b40ae49b2855c5b72d3ad910d9c6c40e0d3e4841ba2232151e2008dd
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.2 MB (222249911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:570d71387e35508f1dc0ac6114ed2f48f33cacc71b884db9b263bf1d09a5636d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 01 Apr 2021 02:06:28 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 01 Apr 2021 02:07:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Apr 2021 02:07:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e210f787effe71f594c7428dc8d28905cc37e7eed5fd9ec8c6a79bf5e268786c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4807a24161b830650fd0d1299f380cc458b2a29233a6721b15b4c516b61254c9`  
		Last Modified: Thu, 01 Apr 2021 02:12:47 GMT  
		Size: 41.3 MB (41321887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.34-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:7278fd94a1847c5a263c61e1a781b8755681e26c0a6960705b5a92ec98e8f915
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **243.7 MB (243707147 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4bbbad71ecb2f34162ed8a8f74c653e6fbf49a434fce2494c3bf0687d147c4e3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Apr 2021 06:59:28 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 01 Apr 2021 06:59:30 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 01 Apr 2021 07:00:06 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:5776da69187a24ba9aeba6456b9dc5f3218aa7cf1f387fba49a56e642da835f7`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0050201be394192699f21ea5c2c59dc71796a87778cf443604f5878a99e53ad`  
		Last Modified: Thu, 01 Apr 2021 07:04:13 GMT  
		Size: 41.3 MB (41323535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:4ce9e9d6e1c1b9b1cbcc30b684ef882d3389b5852f4ebc23299d20ae50c98ee0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **271.5 MB (271493926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:64cc4111065e2d826af2ec65c168c693b38025059e85ecce185989f16bc45508`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Apr 2021 08:06:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 01 Apr 2021 08:06:53 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 01 Apr 2021 08:08:47 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Apr 2021 08:09:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f072f365fb2ae0b32d4a57148445f916db3cd85a91e5090c138dd6fc44793c37`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45c47dde80a28423b553d378b2b48837afde2d503ba881cc3bef9f88210967b0`  
		Last Modified: Thu, 01 Apr 2021 08:25:35 GMT  
		Size: 41.3 MB (41327494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
