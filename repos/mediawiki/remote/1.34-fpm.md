...
```console
$ docker pull mediawiki@sha256:4946b50097fcfef5229651e0e490b64f10473ab60ad08df5b4391007fd193f39
```
...
```console
$ docker pull mediawiki@sha256:0bd48d67028be52c5f459f6615643532073c67d64b016d62906a92192bbd917c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.4 MB (228440768 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9f803b918afca327c77307ae983db3dd3fe30daf84c84e895d68a19877d617f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Feb 2021 17:42:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 09 Feb 2021 17:42:39 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 09 Feb 2021 17:43:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:ec46a952dad3f708d3af5adf70691a96829c838b9f07cc3ca861f4d22ec0c1a2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:308aa38018316cfb79dec6ccfcccaf7530e3d5d2e3519656aac0422a7c9a7177`  
		Last Modified: Tue, 09 Feb 2021 17:48:10 GMT  
		Size: 41.3 MB (41321842 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:9343f89f2f14ea9b5f0985c8dc6d4e5523a22559837df28e881cb9b61e016291
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.5 MB (261483636 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ef10af72b84262986608f454eee5915c0e01c08e1f4722d9cdf14e83a07615a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Feb 2021 22:10:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 09 Feb 2021 22:10:53 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 09 Feb 2021 22:11:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Feb 2021 22:11:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ca35d7e0dfb76dfc796673dd47c6d964b3cd6bb491f53c013fb1036b176cc0ce`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2545b2f8eb1de6958ca2924a10f30c941d3f914b2cc997023599327f028771a3`  
		Last Modified: Tue, 09 Feb 2021 22:16:32 GMT  
		Size: 41.3 MB (41323557 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
