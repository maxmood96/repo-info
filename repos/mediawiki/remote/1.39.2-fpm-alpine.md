...
```console
$ docker pull mediawiki@sha256:8f71462d9fc13eb259cf6637fe7bb8852bba1db61be72bd1a2e66432dc455dd3
```
...
### `mediawiki:1.39.2-fpm-alpine` - linux; amd64
...
### `mediawiki:1.39.2-fpm-alpine` - linux; arm variant v6
...
### `mediawiki:1.39.2-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:8e5d0b9d45fc69e45f1309c50a6e0a7dde01f66d5566301e02c52bb219d4964d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.9 MB (145948556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecdf88d3f1ad82991d31fc06da063156a748c677bbcffc0aaf4e3d06bd32f6d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 17 Mar 2023 03:09:20 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 17 Mar 2023 03:09:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Mar 2023 03:09:21 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 17 Mar 2023 03:09:21 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 17 Mar 2023 03:09:21 GMT
ENV MEDIAWIKI_VERSION=1.39.2
# Fri, 17 Mar 2023 03:09:37 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:92af324f0150d18d7c1d36c606192bbbe9aaa58d86875468e1c8748a2ba86680`  
		...
		Size: 8.9 KB (8877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c028fc706f2b96a2bf6ecd90fd78335ea7dbc8e44224bf833e4de8d0ba525e7f`  
		Last Modified: Fri, 17 Mar 2023 03:12:37 GMT  
		Size: 56.3 MB (56297580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b6375e51d04c811d9145ca5583016220d35280cf69e0b63830cb44e8a25d9b4`  
		Last Modified: Fri, 17 Mar 2023 03:12:30 GMT  
		Size: 6.5 MB (6532334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:053b1d541a80b304c555930f8715e78af2799ecaf37e1703c5e0f9e64c392fa8`  
		Last Modified: Fri, 17 Mar 2023 03:12:29 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c96f80c19e098669ca499ef039110b0ed1d1cf8003838d9a24222e85fa2ea639`  
		Last Modified: Fri, 17 Mar 2023 03:12:29 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a418c23d152db3ebfe9caf02fbbcc7c56dc20c088d3a9e031d246d4a5bb56c1c`  
		Last Modified: Fri, 17 Mar 2023 03:12:44 GMT  
		Size: 56.1 MB (56060828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.2-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:93b2fe8232f6977cb60f5082e023544570254fd2a72750439785704ae1de5ca5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155312762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:002b1db9dd55c983fa47c5a1fbc86b3844002d77d22c1c2c69f313ef61c9da8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Mar 2023 22:53:53 GMT
CMD ["php-fpm"]
# Thu, 16 Mar 2023 23:55:32 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Thu, 16 Mar 2023 23:57:04 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Mar 2023 23:57:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 16 Mar 2023 23:57:05 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 16 Mar 2023 23:57:05 GMT
...
# Thu, 16 Mar 2023 23:57:05 GMT
ENV MEDIAWIKI_VERSION=1.39.2
# Thu, 16 Mar 2023 23:57:17 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 16 Mar 2023 23:57:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:28a28ef0323fc76ef468d42edf158f65c48fbf627dbba2b9ce501ce0beb8f429`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9761e53b828cb1c826b1b88a4e87560138e74a304eeb075cc162be334f05efb`  
		Last Modified: Thu, 16 Mar 2023 23:59:20 GMT  
		Size: 62.1 MB (62116226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80a1be574be825b7215d876b80474222e62f28a8eba59f47a3996e8f174a4d82`  
		Last Modified: Thu, 16 Mar 2023 23:59:13 GMT  
		Size: 7.4 MB (7403905 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3126bf0d3647f47629ed24ac2509f733e577b82a8f08a4382bd725cf9cfc07ac`  
		Last Modified: Thu, 16 Mar 2023 23:59:12 GMT  
		Size: 323.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b821f403019bc4c4347df55adfb40a21a052290de77e0babc1fe4b3bb4deec46`  
		Last Modified: Thu, 16 Mar 2023 23:59:12 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4155a58a8378687fdcd73b8184bcaef5819a08b97b0ada70fde9e30c00710003`  
		Last Modified: Thu, 16 Mar 2023 23:59:21 GMT  
		Size: 56.1 MB (56061634 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.2-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:f1de27b8af179a8fcc2b1942ac34124e19036ce494bcbbbc5b14cb0ee8f5a854
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.2 MB (158190443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9ab53efc4c3a51b0f69721cd34385c9b86a217ccfad6a9cde31c963e094aead`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 00:54:17 GMT
CMD ["php-fpm"]
# Tue, 28 Mar 2023 03:24:14 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Tue, 28 Mar 2023 03:25:39 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 28 Mar 2023 03:25:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 28 Mar 2023 03:25:40 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 28 Mar 2023 03:25:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 28 Mar 2023 03:25:40 GMT
ENV MEDIAWIKI_VERSION=1.39.2
# Tue, 28 Mar 2023 03:25:56 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 28 Mar 2023 03:25:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b24e4f2ca80601691a49bd8ecee08da95d2ef55444eb89018e44bfadca597ed6`  
		...
		Size: 8.9 KB (8877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbfca0ff4c169202c4f6bc2195779ad0b22c68b19037bf9586fd2cb207955f20`  
		Last Modified: Tue, 28 Mar 2023 03:36:00 GMT  
		Size: 62.4 MB (62366309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bea0e3895371dc15f63966597fa5d782e4285b8e448b1d3bad096503d4d44d11`  
		Last Modified: Tue, 28 Mar 2023 03:35:47 GMT  
		Size: 7.2 MB (7229408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0666175160d6816a84407fe5c89106fe0904d0f80aab0ef08fa857079a4b0734`  
		Last Modified: Tue, 28 Mar 2023 03:35:46 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cc81ec72ab11744e9df6b2c0eecff94ca72ef749a031d690300d186834b6bea`  
		Last Modified: Tue, 28 Mar 2023 03:35:45 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b95d79fab13df95bd1024713384e2276e733d060e4d884f6649ea0f913e2c92`  
		Last Modified: Tue, 28 Mar 2023 03:36:05 GMT  
		Size: 56.1 MB (56061794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.2-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:bef8ed26b14deae11678f5150ca10dfae366bd3723db3986c2060364f10ee3fb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.2 MB (161179835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8118caf5792306b7375b8e2b4ca178b1a382389a267e18162e6d2c7c5a55958`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Mar 2023 22:20:33 GMT
CMD ["php-fpm"]
# Fri, 17 Mar 2023 01:55:27 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 17 Mar 2023 01:56:48 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 17 Mar 2023 01:56:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Mar 2023 01:56:50 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 17 Mar 2023 01:56:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 17 Mar 2023 01:56:50 GMT
ENV MEDIAWIKI_VERSION=1.39.2
# Fri, 17 Mar 2023 01:57:18 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 17 Mar 2023 01:57:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2316be1f05681d23d64f1ad6c18df45dda381dc3e6357caba49393e360519174`  
		...
		Size: 8.9 KB (8876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe2e74a9da906a329653bd6e38e46062851b029169203adffa6c24e48cb2f73d`  
		Last Modified: Fri, 17 Mar 2023 02:00:41 GMT  
		Size: 68.0 MB (68006811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bf792daf351db31fe60f2a2c75b4e5eb6155f5cb3db8948c6d5f15714e82e0e`  
		Last Modified: Fri, 17 Mar 2023 02:00:25 GMT  
		Size: 6.8 MB (6773699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cf2ad858a19a549f2194c80d2fc83116d46346c835878d87dc66fb2b920bcfa`  
		Last Modified: Fri, 17 Mar 2023 02:00:24 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb7bafe08a3a50c0798fed6100fbafbe39d0db6fcafde5c68afb3efa05ea88dd`  
		Last Modified: Fri, 17 Mar 2023 02:00:24 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96aedbb3bb968a2d03ed1c6fbf125edd6bf7a0b57ef691e629c9d99df529e0fb`  
		Last Modified: Fri, 17 Mar 2023 02:00:46 GMT  
		Size: 56.1 MB (56061124 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
