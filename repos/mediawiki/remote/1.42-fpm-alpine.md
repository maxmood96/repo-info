...
```console
$ docker pull mediawiki@sha256:791b72784aadf1bbb526798cf0f711ada14c65b9c703923a739a91a449e125d6
```
...
```console
$ docker pull mediawiki@sha256:1725da7114a46c12e73ba41a5d68b4f814812f8a1a4213b69e239a992591b1b2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.4 MB (146370293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddffd0a9554f1b5e55596021525708fc7a0cd43b17982efcabc54d333ba9b6cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 02:26:10 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 Jul 2024 02:26:11 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Tue, 23 Jul 2024 02:26:11 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Tue, 23 Jul 2024 02:26:37 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 23 Jul 2024 02:26:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cebc3d7a1481687dab9461c37dd0a70badaeb635c01d8c21df10271d458459ec`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39f30873c6ebe57131b14c38595700d942c5259c9c2c4ca0a5273f06aa1899d5`  
		Last Modified: Tue, 23 Jul 2024 02:28:19 GMT  
		Size: 89.6 MB (89595560 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
