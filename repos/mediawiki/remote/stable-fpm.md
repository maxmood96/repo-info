...
```console
$ docker pull mediawiki@sha256:3cc9fb48d7a0e24135d77f4430cdff3881f8015d5fa391fb1fd3dabdf9c3a4a5
```
...
```console
$ docker pull mediawiki@sha256:03d70723fea88c1db4a1a4bcddd85158652f09528f2998d7dcc6bfad8e874b31
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.1 MB (261100277 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec4a5cf32f740d82501d053c27bb23aa265ffbffbd2f4a38f5c0a901dbe77f2b`
...
# Sat, 06 Mar 2021 09:46:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 06 Mar 2021 09:46:29 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Sat, 06 Mar 2021 09:46:45 GMT
...
-	Layers:
	...
	-	`sha256:60b08098fd179f5aa568c53215c156e4e611771b622579a54cdbf160c8f98aee`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a60bf858c15d36a5c3b57f244b741c92dcb17340a7c3f67f4785f4b75ef4548`  
		Last Modified: Sat, 06 Mar 2021 09:52:13 GMT  
		Size: 48.7 MB (48662596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:6d7b4a14221f7c50eafae3772cf21a0a2db4b15c8b22eebc8e1881929ebddfe7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.8 MB (235779656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:723b9ed54d71e3b230292c092b336780a3fc3129ce17b6d887343eafa97423b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Feb 2021 17:40:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 09 Feb 2021 17:40:39 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Tue, 09 Feb 2021 17:41:30 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Feb 2021 17:41:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ec46a952dad3f708d3af5adf70691a96829c838b9f07cc3ca861f4d22ec0c1a2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f869c1b47cdda87cc364feb531aad2aada7e1414c6be080864235222bcba5b7f`  
		Last Modified: Tue, 09 Feb 2021 17:47:04 GMT  
...
```console
$ docker pull mediawiki@sha256:3b361bb614f8efffda51775594e6ced804b4abb9ffb4b9eac53c797c02a9aca8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.6 MB (229551778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5a671127a7dcb0199cd9aaed9e2c655768d48de97850f9dbe7498f4fb2c473a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Feb 2021 04:08:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 10 Feb 2021 04:08:42 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Wed, 10 Feb 2021 04:09:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Feb 2021 04:09:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ab6f994ebf2ab530ec138e866003f95553a3fe2f3afde0750cbc6fb44dcff9cd`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2d41feb51888d4d51a47e4bf7034dda4547fd34c2ca34179edb129d69fe02c2`  
		Last Modified: Wed, 10 Feb 2021 04:14:50 GMT  
		Size: 48.7 MB (48660505 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:2f9e467e3193ee0bbb41799b5ae371ced82d3444840ac126cda6a700b54450a1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.0 MB (250990412 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e34301bb8897a1982824a2f3c54e18f541001ce08b9968977cf57cdc35347945`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:5e332754f5fa3b70ae652f76e98b6231b16fe86c8ce4663284a57bf3e73a8c0a`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cfa3e541f6b529cd266a4b188474f7bdcfcc9f4162c82e6b1158645032ba600`  
		Last Modified: Wed, 10 Feb 2021 05:45:03 GMT  
		Size: 48.7 MB (48662119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:1e4a1f1e6b2da5330ff288c140e67921cf0f816745cb1499e94131ea690e0eea
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.8 MB (268837737 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:199c141e85debd9f1689a5ab1697a10c589fcb9e7592e4e00f630d8864c9af7c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:17fbbb61956ec9c1694ac892b94115266f71e140a815d3093549a6036a5444fd`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c998a1280f46d8e6b31901860f0e2a2314d7ef3cfbd748a0cf8807580efe6a1`  
		Last Modified: Sat, 06 Mar 2021 09:13:48 GMT  
		Size: 48.7 MB (48662334 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:e329d7686c2dec99d847dc8214f411347fb8a693589fe83bd1f0990c5839a3a7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.8 MB (278802896 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:43e1d460ece0e310e93b0decc3bb83c410c370dc9c5b28896a820b1cc1136792`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Feb 2021 09:31:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 10 Feb 2021 09:31:36 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Wed, 10 Feb 2021 09:34:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Feb 2021 09:34:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f71929f9abe626432c240cd10ab43bba98db5b569c300785690fbc0decf61ce1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba28c01fcc3156bac47adb6b5594dc74ff9ad0bf5b4105aa14e4eee33963292d`  
		Last Modified: Wed, 10 Feb 2021 09:58:32 GMT  
		Size: 48.7 MB (48660901 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
