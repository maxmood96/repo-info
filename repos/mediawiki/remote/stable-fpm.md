...
```console
$ docker pull mediawiki@sha256:dfdfd6bf083b1478ed547cd6ce9a82475029cff5a7b4a9fb645557c328c207c9
```
...
```console
$ docker pull mediawiki@sha256:ba4c459929cab55a9bd29557c0f923eee5657f953f0265666278e2ce704198ce
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.4 MB (275371857 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:009edd7d3920b7bf0b62949d436a4a18c2e41ca82409a9c667e3d2d8c2bb7302`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 10:44:03 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Tue, 23 Jul 2024 10:44:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 10:44:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ee55b4f2f7784a21f233d74bb801f7dc658c76d6ae5b47c5eb77a6c1fcdb01dd`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:847a858484ec8ca3fb213695ea808e07da5002ae2d67b591724837ed0e3103ae`  
		Last Modified: Tue, 23 Jul 2024 10:48:45 GMT  
		Size: 89.9 MB (89895791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:31223c91e1fa261a86f388fb9335cca27e81b6b7a0c7722fce41686cbaf88469
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.0 MB (310046564 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b37ddf25767fd44533114105f42892bb2c4e2e809d4a4659918382128a351ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 23 Jul 2024 08:26:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Tue, 23 Jul 2024 08:26:56 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Tue, 23 Jul 2024 08:27:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:7a442096e22028b68e73bfe33411174ea26e82ab944c383a973a1c40ee33e93b`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:660f40349f1f74714acb4a9b01e0fa2b584daaa9367db9966427df2600c825df`  
		Last Modified: Tue, 23 Jul 2024 08:30:02 GMT  
		Size: 89.9 MB (89897055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
