...
```console
$ docker pull mediawiki@sha256:a35639ea702d0d0fd45a46814ad1c1a0ed2f7c5fa42196ef8a5ad391a74ba059
```
...
```console
$ docker pull mediawiki@sha256:4fabc98c8007b363d758d7510f5a50833e2ac8c3fbb011462db4fd78f5c43aa3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.2 MB (289218162 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c256bd480211e266b9281756dd21fcd42476281a073504f53ce77fdd9024fe26`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:02653a5b41d93aa37ab70eb6eb3d9235fb749feff0054c96d74512a7be4d4792`  
		...
		Size: 141.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4a5d8aa9fb96c9779549b75ef524004cb855454a15aba93f9a70dd1e05ca119c`  
		Last Modified: Fri, 14 Mar 2025 04:06:10 GMT  
		Size: 92.4 MB (92354877 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:stable-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:05ffff369a181bd0a40dbd9f149675f37ba65cacaedaea48bc081bd22987cc42
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 KB (34116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0baa8c30814696568e6193aef5338b555e0d4dd7db79fc3a4318291edbd4d35f`

```dockerfile
```

-	Layers:
	-	`sha256:5ccfdc71f17aaf700628e819e266747ebbbd5dae40f41d4c4f8de2a7a4f74a2b`  
		Last Modified: Fri, 14 Mar 2025 04:06:06 GMT  
...
```console
$ docker pull mediawiki@sha256:5fadc7387b4670cc820893909f1f7ac2736f771ecd3bb04954ba46ad39cf0e37
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **277.2 MB (277208436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a38a1c54f22b8b59e3cdae34125445befb7e5b0c6f52f910dfa6b97f34c28d6e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:d31aa7e56286478282583f82dd3bbe24955aa0ae7db87b908df83ef2dd7dabc0`  
		...
		Size: 140.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d5ef91453b14c6fc11583adcb8b0113efd07a9edb06967e3e06ce09c9272bb97`  
		Last Modified: Tue, 25 Feb 2025 15:45:22 GMT  
		Size: 92.4 MB (92355086 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:stable-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:7f91fb9ed725f0c2c8c15022373701268a645c95cfb92ad8a1cc139e218da0dc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.1 KB (34116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16cef670621dd35c675c3f92fee7e3f67b87fb64b0cd1d09ffad7b2ce1e1ae91`

```dockerfile
```

-	Layers:
	-	`sha256:d5212ff72c343b297a8f15d393684a4700c2ace8f1ee8cb9d6571a8e026e6d93`  
		Last Modified: Tue, 25 Feb 2025 15:45:17 GMT  
		Size: 34.1 KB (34116 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull mediawiki@sha256:8d80ff071bd07009ac051a8a8522927f710e332ec515efe4eef69c6d50d4df16
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.8 MB (320752020 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1518e81863dacbd6d62a200dffd942c69a48b6d12f01b695065c01c0198ac437`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:9061f3772598ad23599587af2f276f1d3929ff23d49eb3fb3f29a7d71f8172b4`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ab8b73f3552ed2c222267b7e8390d94ab761d994f5ec6c5d17a5dad0133315f7`  
		Last Modified: Fri, 14 Mar 2025 02:15:58 GMT  
		Size: 55.8 MB (55771506 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fc8b6047e3fb9bd50d141406944ea0b068eb4604777581080b8a7cc0895f4ba4`  
		Last Modified: Fri, 14 Mar 2025 02:15:57 GMT  
		Size: 2.1 MB (2059728 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:68ecb4d7cb33a70dd5d93831a9cb860746d47f4daca1320cd4fec7eb50f12da3`  
		Last Modified: Fri, 14 Mar 2025 02:15:57 GMT  
		Size: 317.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:170c333a95fc54cff1dbf8ce42e5ef08ec0a4b5a393744f83f68bcdb9274bfd2`  
		Last Modified: Fri, 14 Mar 2025 02:15:57 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6886c46376ca7c0ba42db7e37a756012237a28aae9507b4dc9985fc965d27b63`  
		Last Modified: Fri, 14 Mar 2025 02:16:00 GMT  
		Size: 92.4 MB (92356617 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:stable-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:2e194f8f79a298aae3577f20ececf900410f186961fae5aad27497923851a95b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.0 KB (33954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ca3a1df2302b63b1906cd634eef6c294382d2111114e6e44a7553b675e713c7`

```dockerfile
```

-	Layers:
	-	`sha256:e56ac3f0664ab9c7c8f745f08c6adf6abbbb5dbc989a6a2e310576bdd2874284`  
		Last Modified: Fri, 14 Mar 2025 02:15:56 GMT  
