...
```console
$ docker pull mediawiki@sha256:0d7d55c7046375ab4452448d556789efa84e22f12e0c3f32499dfa3ceba40681
```
...
```console
$ docker pull mediawiki@sha256:7342f6d58f77dab29a4818acdfbc96119907f5e29f7c016ecc964d4019cfea38
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261229786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ff34aa9a02b02b4d5f6ab13612b3e46345bf650a97643ed404bfa8de0e98433`
...
# Sun, 11 Apr 2021 05:26:27 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sun, 11 Apr 2021 05:26:42 GMT
...
-	Layers:
	...
	-	`sha256:18e3be1502e4b4aad6be7cf9ce79e1defbb70c1aff6378bce3346cb070cebd1e`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb1cbe2a8db22678da705722c53f968728b5db18edb9c1ae941e8c3496791a8c`  
		Last Modified: Sun, 11 Apr 2021 05:29:51 GMT  
		Size: 48.7 MB (48719850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:ac319d2fe76abb656880b921e9c0657758ad7b097289856621a544ce52431e0f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.6 MB (229641381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc059917cd1db24c87c312d00aa006701c3a53d3359abef83ca4e3ff193c8680`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sun, 11 Apr 2021 02:14:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sun, 11 Apr 2021 02:14:17 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sun, 11 Apr 2021 02:15:03 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:17b484ff7582858a59a0038b5aafb2e4528b2b094a3bccd2a268d8ded7615a80`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d395337494b9e8202daa90a5b8c076668bf98450d14ee47451c7492f6eb0d270`  
		Last Modified: Sun, 11 Apr 2021 02:20:53 GMT  
		Size: 48.7 MB (48713710 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:f5561033ccae51e56dcff66c8096d2c5625028b6948e8682e7b5d6de3ce2cdcb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.1 MB (251100650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdbf666d7541f0142385f14c175bf2e42baca486bf0bfe4a54befe2e815d7c5e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 11 Apr 2021 02:07:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sun, 11 Apr 2021 02:07:08 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sun, 11 Apr 2021 02:07:39 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:07:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2036dd6c9eecbbb9524c31f8a0e94bcdd6d924e220c979f910a1b700ca5aafa3`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23434264c9618c25c65721179eb898facc0e9d647cdd47ab64884186aa12aa44`  
		Last Modified: Sun, 11 Apr 2021 02:12:49 GMT  
		Size: 48.7 MB (48715566 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:355cbe3db7c46ea51795bbaa330cc9fb58bb90b66c92e6a69e54eba46f0d75d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.9 MB (278888264 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:26b7d8669252c31c2fc436e98085c3e70b18c1f4cc2c79ab99c25747a56129a6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 23:46:28 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 10 Apr 2021 23:46:31 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sat, 10 Apr 2021 23:50:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 23:50:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8519d5a83406f14c565553df49fc7685e4cd2a0e292dec54be254848fdfa061e`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f235c14b207bb77b6077a459826c1a784f8fc680776556c66f28080764e14c`  
		Last Modified: Sun, 11 Apr 2021 00:04:50 GMT  
		Size: 48.7 MB (48722192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
