...
```console
$ docker pull mediawiki@sha256:405cf1269a7add675005527dde00772b2002d3026102ce40268650992c6b8793
```
...
```console
$ docker pull mediawiki@sha256:9170ce4f024129b420bc4f33b0795ca9109a0cef77403e56989daa446ce6a2c3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.5 MB (260477983 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5bbf9651fbc19247505c8c85e6f11e56dde97c1f306889308ca88a461f097f79`
...
-	Layers:
	...
	-	`sha256:47910fb02cbed007d6cff3b806a8eb4b8cf6f2dca157162ce8fbff35ccb6acb5`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3044062b26982b4ed19ad19ddfdeb0b68ffdc15b8819309aa7b718dd245735f8`  
		Last Modified: Fri, 04 Jun 2021 00:44:48 GMT  
		Size: 50.2 MB (50246233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:cce56b6d504aaf36b09bb0ecc4e2bce28a3bbba5c930e1f2d10a53f467db52e8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.2 MB (235203531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d281699b273b1fbf135fbe5bbb4ff82016e9f837a4303ab8efd7279dc47986cb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f8710f59163dc0c5c8fece1239d96a0bcaecd288582cad2539cbfeec62ec5f85`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:efd4dc3ec73e2b9a39df49579be876ae65d884578501e8638da92e830cd6b6b8`  
		Last Modified: Fri, 04 Jun 2021 03:27:10 GMT  
		Size: 50.2 MB (50244002 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:c903b8caecd5d32bafe42b0f6a71133fd172a6a9f5a23e6667ffcfd00548d0d2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.0 MB (228997880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:646b417fa23fe545b92ba5f14fa699fb7843c9c962c2d17d8446e3bc67076e43`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 04:06:16 GMT
CMD ["php-fpm"]
# Fri, 04 Jun 2021 09:52:01 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 09:53:11 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 09:53:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 04 Jun 2021 09:53:12 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 04 Jun 2021 09:53:13 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 04 Jun 2021 09:53:13 GMT
ENV MEDIAWIKI_VERSION=1.36.0
# Fri, 04 Jun 2021 09:53:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 09:53:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0ab5cd775fbf747f2eede80520319dabd167941e845ccb3c00033500b0f8f732`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6312cae7eb13faa70798c1c7bdcecdc0ee8e51dfa1d5a3003f8fb1f1e4691798`  
		Last Modified: Fri, 04 Jun 2021 10:06:05 GMT  
		Size: 57.2 MB (57189461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4266c9bc11586f35e383209124c57e21e895adb3b51596840df63d87df44aa78`  
		Last Modified: Fri, 04 Jun 2021 10:05:54 GMT  
		Size: 2.4 MB (2423914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4148b3014d7b1dd696321cf8a937a1995e0d4cc93d71f7fe05512194811f7871`  
		Last Modified: Fri, 04 Jun 2021 10:05:54 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9e6a886f12bab54b291f6e1be5417e97eb035e3f64f6a1c028c00b0d53c8f1b`  
		Last Modified: Fri, 04 Jun 2021 10:05:53 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b259bb073255e463af36cc11fdb41545e61fc1ab0f768d9f51f24147f9dbf11`  
		Last Modified: Fri, 04 Jun 2021 10:06:11 GMT  
		Size: 50.2 MB (50243678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:a6df4fece82f95052f2f986535c57f4317cc260c1f9b614aa562f316afaa169c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.4 MB (250449043 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d03e9ecebd2e8b363f74ef4099f833af4140e07f1853408c8ace837753faecd2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 05:29:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 04 Jun 2021 05:29:10 GMT
ENV MEDIAWIKI_VERSION=1.36.0
# Fri, 04 Jun 2021 05:29:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 05:29:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5ec27c5acb7d09d0237ece2e31ead542cd0660a6b9aadcb82602c3ed95d05535`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5274061d706bfbc38e570a7291f7718a8f6f1d3704b01f26aaede13445d4902d`  
		Last Modified: Fri, 04 Jun 2021 05:39:05 GMT  
		Size: 50.2 MB (50245516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:655710f96fc26da43c7f701c0f38ded01a99b5b8d752401d50d2c576a4c10e97
```
...
-	Total Size: **268.2 MB (268204644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70ffb7414124af5e74e8247bf24c5f2055b36cbbea7f6ee7de31c2cece274b2e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 04 Jun 2021 00:32:07 GMT
ENV MEDIAWIKI_VERSION=1.36.0
# Fri, 04 Jun 2021 00:32:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 00:32:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:910788f143abf53badcc5d052e6477f5ec445fe48e7fce1b8806502e0cce40d7`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c857b9d5791a6f2922317b4f73760e88458e98a3433bf668f9081ffee8a6ab05`  
		Last Modified: Fri, 04 Jun 2021 00:38:39 GMT  
		Size: 50.2 MB (50246146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d7ba49eace5262fb2a0d76b918e0e1a5aab65eb865e0b35c96d98134ecb01feb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.1 MB (278101912 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd186a23d5e3b891270bf618785aad35fee4a0090bcfda393fa19d739544bdfc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 04 Jun 2021 04:38:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 04 Jun 2021 04:38:45 GMT
ENV MEDIAWIKI_VERSION=1.36.0
# Fri, 04 Jun 2021 04:43:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 04:43:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:370bb34595ed58666dea9be786a9b0be9cbd23e140e1366e223fbd68ee3bb836`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:324f2e5a4fcfcc2239269fe1d847edc8ba583ad56fb161fe518b004a47f69427`  
		Last Modified: Fri, 04 Jun 2021 05:07:35 GMT  
		Size: 50.2 MB (50246870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
