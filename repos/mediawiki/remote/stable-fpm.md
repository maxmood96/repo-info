...
```console
$ docker pull mediawiki@sha256:59cc71054b5e6aa5b1f768fa30c2f807a317f81c2b0bb53aa6a4ae5b3862e9ba
```
...
```console
$ docker pull mediawiki@sha256:2933a9889aa2e215bc20a937e1990b0b16d9e09c03acf0e09bf9361acc849a76
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.6 MB (254596225 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1217571bfd7deec575e38751ce4731eeda6bb87a91d47c55c444230ef4f2296f`
...
-	Layers:
	...
	-	`sha256:e1b5a469ec7e15dd3464f3d737bb5e5d40b88b398a0f1b6d1e5157faba655098`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a87fd7596f06026c45bae3276a5d3106be6216fc91ec3cf6e775376e010e0296`  
		Last Modified: Thu, 21 Apr 2022 10:59:09 GMT  
		Size: 51.8 MB (51809724 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:59f3ee150d9db3134a010e251bfa89d739a79f9f6ee89707cfd2f8e74685f9bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.7 MB (229716599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d133634c5655ca2d2784858fd0eef12f8c239fd8d31f7e402c994a4e154dd3b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 19 Apr 2022 08:15:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Tue, 19 Apr 2022 08:15:43 GMT
ENV MEDIAWIKI_VERSION=1.37.2
# Tue, 19 Apr 2022 08:16:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 08:16:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9d785fd4691b0454eb8e5fc34ab1b5a37b9b836b8f69055f66c13da9d6c5f687`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc5ff7a072567c9d8241ef73958ca0edcebf20687656d1b1b87c6f26a9022cfd`  
		Last Modified: Tue, 19 Apr 2022 08:25:23 GMT  
		Size: 51.8 MB (51805923 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:74f1f1e9c19fea2cd52b31c5b3fdde45637d24cb236850945724671f29c7415e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.4 MB (219406827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:064c50e362c5d844ac393db0fba929d48e11be8e028b87a5eee950bd9b3e3c91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 19 Apr 2022 13:43:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Tue, 19 Apr 2022 13:43:33 GMT
ENV MEDIAWIKI_VERSION=1.37.2
# Tue, 19 Apr 2022 13:44:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 13:44:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:29b0f8b37f9481e0f70837907a011544a72ebdc255191a72e9e224291d48fa8f`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fedf11fe89eeef75100bc33900f016cfb5397b8f81f3af8ee63e5cdb50538863`  
		Last Modified: Tue, 19 Apr 2022 13:59:29 GMT  
		Size: 51.8 MB (51805785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:e03084b55cd8493f72dd5a16c4e23fff1431176c0d47fd8f9c94870418cc8bcf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.0 MB (245005844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ddbb9f454467a265d66cd19af6ef84ef3d94a6daaca5492f845e7273ec33d90`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Apr 2022 12:18:11 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 21 Apr 2022 12:18:12 GMT
ENV MEDIAWIKI_VERSION=1.37.2
# Thu, 21 Apr 2022 12:18:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 12:18:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:598e224523a52cb3fe114d5c3317a11627a623edb3ee3e24979d2aa0a473be9b`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb24cf5734791bdba12552e9ec8ab883d6bef2c780af75cc23b6ce62879117c8`  
		Last Modified: Thu, 21 Apr 2022 12:22:21 GMT  
		Size: 51.6 MB (51569107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:8c7447a652c2ce81330db6a7d19cf391bf058ea15dd3d1581fafb24d2e4fa8c3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.1 MB (257131152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c0ff52b9f97fe36b5487596e77e5a903ae67368c30466896e2390733576e6f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Apr 2022 00:04:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 21 Apr 2022 00:04:39 GMT
ENV MEDIAWIKI_VERSION=1.37.2
...
-	Layers:
	...
	-	`sha256:c717290ade8ba90c3239a47f6d8c7f9ed93bdf86fa4692aa98d81b103c406f40`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e3cec3326f8a42f5fedf729c035de9542b64abbdc7c588f3323117c41dd4905`  
		Last Modified: Thu, 21 Apr 2022 00:09:19 GMT  
		Size: 51.6 MB (51569856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:211abd00f9ebb280eb2cb2bb170ee4b35395f6473784f5775dbd15856bcdead4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.4 MB (258361181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1401de22fcfd842331fa370c8e41d6de5b53381dc9bd6723beb351db1d5806ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 19 Apr 2022 18:12:06 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Tue, 19 Apr 2022 18:12:07 GMT
ENV MEDIAWIKI_VERSION=1.37.2
# Tue, 19 Apr 2022 18:13:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 19 Apr 2022 18:13:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7ff8865caf0a99fcb66af1fff53c645a693b64d1aac7af884581bb8f19e6c783`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e87c03439a952b12e9722131ba2f8ed6fdf07c596fb291e35a40f2e2ebf46809`  
		Last Modified: Tue, 19 Apr 2022 18:30:59 GMT  
		Size: 51.8 MB (51810107 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
