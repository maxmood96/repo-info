...
```console
$ docker pull mediawiki@sha256:00e6f6dbb1fe11436a5acc9679a48e9356020765be4780d7d315978689610a36
```
...
```console
$ docker pull mediawiki@sha256:5a1baf9cc6ce1635cdb4905898f18a8c04fe019781f8518ee1230b41e2f56bc4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.3 MB (254279742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6c9d2da3da732ddfa0b27b62019b08fafb0ab18809e7719d5a679f52fd28690`
...
-	Layers:
	...
	-	`sha256:b56090a2d281aaa05257223d6862714fe5781da2002ebfa0d017796157b36a40`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f79011fbdfa1308eacf8ad68123a9f91e758d2aa0f52732bb0458cd413a2b62`  
		Last Modified: Sat, 19 Mar 2022 19:04:01 GMT  
		Size: 51.5 MB (51509536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:af4f960e8c0d4ef1edefe39d1ccec4a395516c92f5a722bc032493d6dbdbeedd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.3 MB (229349916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4cebea6ba5270e99b7a61b89eb8cbe5e15115237dce3513b8448d4d70abe039`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 18 Mar 2022 20:00:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Fri, 18 Mar 2022 20:00:09 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Fri, 18 Mar 2022 20:01:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Mar 2022 20:01:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c2ddaea2705c7729bce7226e8a038e68c5653147f9040045253ca9e9387c75f2`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28a5ff07165a85bc94a9e51b7eb77a086abe42dc95212e1a433d6b9c669e3941`  
		Last Modified: Fri, 18 Mar 2022 20:10:31 GMT  
		Size: 51.5 MB (51510632 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:3ddcc9078f26bc703c34e2cff523011909206226b38cf54c923cf0f081ff0f89
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.0 MB (219047712 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:713a1528970150f17a42d3e09c53946db8466749324c3dd965be92161004597f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Mar 2022 02:40:43 GMT
CMD ["php-fpm"]
# Sun, 20 Mar 2022 02:33:40 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 02:35:53 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 02:35:54 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sun, 20 Mar 2022 02:35:56 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 20 Mar 2022 02:35:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Sun, 20 Mar 2022 02:35:56 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Sun, 20 Mar 2022 02:37:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 02:37:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:04c2443581361cf7edc29d488458aaade58ccd1cbec663604abae0ce58996c7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c77199b2194eec4be15856629432f81461a7b8ae9294f3e1e074e24004323ff`  
		Last Modified: Sun, 20 Mar 2022 02:54:22 GMT  
		Size: 35.8 MB (35782733 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81494020bc4f4c88af07e9247eaa2adfc658101ef662fd74d4abca4048901a45`  
		Last Modified: Sun, 20 Mar 2022 02:54:03 GMT  
		Size: 1.6 MB (1570430 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8fef3b82678278060753ba0d0662618ca3ff7572853641c395247e887b4078e`  
		Last Modified: Sun, 20 Mar 2022 02:54:02 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66a5213b16be034223edc449dd97abb345f151f69723e8c55a37fc243284cb9a`  
		Last Modified: Sun, 20 Mar 2022 02:54:02 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96aef438ecdb941274064f5f95865affa6fe012f45c7c27f5dae2a739ffe6af7`  
		Last Modified: Sun, 20 Mar 2022 02:54:58 GMT  
		Size: 51.5 MB (51510577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:b99537b24d62662401fac30cd9592f1507ec46a9e62c3c0c470ffd27168151c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.7 MB (244688758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15fb077aa7cca5acae1e9e2fc9dad70770f55935748f5909d581c26fa7505159`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 18 Mar 2022 12:56:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Fri, 18 Mar 2022 12:56:41 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Fri, 18 Mar 2022 12:58:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Mar 2022 12:58:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b0dc568b4c50f5ce7f5d50f4f9a702a78f2856784537fdc69ffb3c569c696fbe`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b98228bd382e67b69e97bdf8e7d4280d0974862190ca66b8166a1307ad8b6e5`  
		Last Modified: Fri, 18 Mar 2022 13:13:25 GMT  
		Size: 51.3 MB (51268190 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:e914ed0ffda119cd83c03bb2633c1ddb68c8d6643372c4f3232caf6d8b293b8d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.8 MB (256806714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c8efeca33cd906501a38b1ad3676d94390fe23623a75a03e5d48859c6903590`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 24 Mar 2022 10:30:51 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Mar 2022 10:31:35 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Mar 2022 10:31:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 24 Mar 2022 10:31:36 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 24 Mar 2022 10:31:37 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 24 Mar 2022 10:31:38 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Thu, 24 Mar 2022 10:31:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Mar 2022 10:32:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e5aa866384a3d3ed0c738f70e6b183a787bf97b68f6fba1e31481feb1f28f953`  
		...
		Size: 8.4 KB (8447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a196d923014215a8ddb89232bde22e61bf3068d2baedc9d322703b16830959af`  
		Last Modified: Thu, 24 Mar 2022 10:38:02 GMT  
		Size: 43.0 MB (42992028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99c651ac64b46f05d907c9cf4aafe54ad4a97779844873178b0a72944b6967fd`  
		Last Modified: Thu, 24 Mar 2022 10:37:56 GMT  
		Size: 1.4 MB (1445701 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:588a815a14091ee4cd7e25f77ae0a79b9cb9160637a3c939816427e2af3cfeaa`  
		Last Modified: Thu, 24 Mar 2022 10:37:55 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d37c3f9357f6d85e5ee74cb8b8999a028617ac30fd4da67e8729c0050e9c44bd`  
		Last Modified: Thu, 24 Mar 2022 10:37:55 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2712925efb740762926327bff519692db4adc15b5d6e7195decd22b596927dd0`  
		Last Modified: Thu, 24 Mar 2022 10:38:06 GMT  
		Size: 51.3 MB (51268674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:0ac7278c69f86bfcba4ca649b97211e17a6af50daa072152ab5ca7874d98bd3f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.0 MB (257968501 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cda8f391a5ea3f721e376bb54a796a2402193c6250ab6a0044159547bfc84006`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 20 Mar 2022 09:34:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Sun, 20 Mar 2022 09:34:42 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Sun, 20 Mar 2022 09:38:31 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 09:38:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0bc0270f9b3285bc49297ff14f33ace3c97368132d7b4cf77bed2c539dd7de12`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a6a072a99a1fcdeb9a7e3ecb575aaa9f7ee19cffa1d248700333e105ef620df`  
		Last Modified: Sun, 20 Mar 2022 10:07:49 GMT  
		Size: 51.5 MB (51511679 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
