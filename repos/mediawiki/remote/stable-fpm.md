...
```console
$ docker pull mediawiki@sha256:1f60cb9be8e7b49bd2e1ca5549013ee0e458845d0a69023ab5d272707a46057c
```
...
```console
$ docker pull mediawiki@sha256:a9e4cf908ce25734b0949d85948e56765c06c9dcc2821ed9341b3e45c4f16e85
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.7 MB (287655589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e0e94ee2141561a9e7b09ac3878f7a9331b1187910b41acfd52edda61b8dbf6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Jul 2024 04:38:43 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Tue, 02 Jul 2024 04:38:44 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Tue, 02 Jul 2024 04:39:17 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:1fbf6acfbe228701443c788cde824b8f734dd4d18e043dabf736398720e2ffa7`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8016887fff9de8421bc125bc1867dfea6417e4c8725c04b9949db6f6fc0a1e6`  
		Last Modified: Tue, 02 Jul 2024 04:43:17 GMT  
		Size: 89.9 MB (89895769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:8772043b823b7a168c62f649efde10731d572165862ad7399365ea9f77f8420d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326864362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d5171a870bd605fa314300f90771f78fda6867fee928dbf5845c01f6f6cce23`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 02 Jul 2024 06:49:41 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Tue, 02 Jul 2024 06:49:41 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Tue, 02 Jul 2024 06:50:17 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 06:50:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e0ab6b1274e337cf0546f18be5b64859d3244f52abb65b8b3d6ae9b05cbf35bf`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e3d3deb7e41c8dfe8b223d59921de86a74ddee63c174d69fd7e8754a0027692`  
		Last Modified: Tue, 02 Jul 2024 06:54:42 GMT  
		Size: 89.9 MB (89896586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
