...
```console
$ docker pull mediawiki@sha256:d0bfac93308cd2c2babddf2b5ec050e96bef4b7c6b8e7e2591ffe4fdb7a536d7
```
...
```console
$ docker pull mediawiki@sha256:b8bcd32cfe8054640746c54dcf0dee8603751ae16cf66c819de9e59870b545b5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.9 MB (235876494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fbb7bf0283da233b2f8299586d8ee0add16051211bbafc9bb82972e0cc1439e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 15:37:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 10 Apr 2021 15:37:36 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sat, 10 Apr 2021 15:39:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 15:39:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b68e0e84c76a96de6353b856ee8e9ff6cebfb20e0572be9daca0db485a0c4621`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c223a9c03fc2f562facdb29d1f15be098ae57f3063aa24874df19e59c117fc9`  
		Last Modified: Sat, 10 Apr 2021 15:47:27 GMT  
		Size: 48.7 MB (48713794 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:ca407c084aff01022f75b4640cb31e429c6be94b9ea68bc83cce34a9e5cf4eda
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.6 MB (229641900 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b43fb8de04e75d82040f9ec5626f308ca72e5c7d6eb9e6053bc1f78fa590af2d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 10 Apr 2021 01:15:22 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sat, 10 Apr 2021 01:16:11 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 01:16:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e210f787effe71f594c7428dc8d28905cc37e7eed5fd9ec8c6a79bf5e268786c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c868aff50530bbd2e5d8d5a4a05fb8f2701a2142d111192eb3376ade58c799d3`  
		Last Modified: Sat, 10 Apr 2021 01:22:03 GMT  
		Size: 48.7 MB (48713876 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:708e57de1b3d76bbbfc9b094f9c01dd64c4d86c165975eda44c49dc60d019c40
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.9 MB (268931563 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb23a7e4f2ce8749282a949e225cf45c4b4f25ef2ed997d18efd920f63959905`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 20:51:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 10 Apr 2021 20:51:54 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Sat, 10 Apr 2021 20:52:28 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 20:52:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3b2d68488c79be7850bebd06b7fef9bc9a79cb62d1825189929fe8a956359972`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:437afea520c75259146441218dead9719c1d72bad53058124dcb19241795b8ca`  
		Last Modified: Sat, 10 Apr 2021 20:58:28 GMT  
		Size: 48.7 MB (48716520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
