...
```console
$ docker pull mediawiki@sha256:4bfe2431bf36dc16a6c742e08a5bee649b33ae22547964ad9e95fbfaddfe7fe2
```
...
```console
$ docker pull mediawiki@sha256:83f65c77d7434d76bb3e034de68c7fd3a606e85133efd5f90e253866df4af912
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.9 MB (318936481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89b4a7c772583535147cc898c088f7197eedfe669ba25a0e09df34790206d071`
...
-	Layers:
	...
	-	`sha256:fa2c67917c3b93b09f08f32d681fde5b70ee73d7301874def684ee22dd1b5e8b`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c99c6fe41053e8be19c38a4c8992fc33b486c185ac14b728046697f7eb05ca6`  
		Last Modified: Thu, 05 Sep 2024 04:30:07 GMT  
		Size: 89.9 MB (89896572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:e3386f81f9eceeebd281a15e3a1dcf3b7fa486efc09697592f766cde0f8aaa29
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.7 MB (287670457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e37d435f374fed42c831b6937eebb879b5a79d96ed2c673e9604461d9f2d6ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 05 Sep 2024 01:15:32 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Thu, 05 Sep 2024 01:16:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Sep 2024 01:16:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:240ab47afd7723cdcf3438a558764a7eb58cb9594d900c811084834275a174ca`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1f53a36f7f833abe19db7f2d5004896294b09d3d2f4c6cc9eccf89f756e60b6`  
		Last Modified: Thu, 05 Sep 2024 01:20:08 GMT  
		Size: 89.9 MB (89895975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:362d1ff365425cf551c188aa5bc43483037a9490a2aa11751efdfb07a04c1f67
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.4 MB (275378266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9483e29e2106171c700986b6360865922e580e6dc0f3504d8e102baa52984b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 05 Sep 2024 02:26:17 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Thu, 05 Sep 2024 02:26:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Sep 2024 02:26:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2141a7ac15d3cf4d0b9941dfb909620f628923722051a3460dd964661378a7ca`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d56a3878bf4fc61520f3646154dddded404266ee4ba75ce9f117489f6486e4d2`  
		Last Modified: Thu, 05 Sep 2024 02:30:16 GMT  
		Size: 89.9 MB (89895565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0a6c87bf6a3d0fd7fe1e0148cd2bd77b136f7ec0f29651e0080531ba6a8e0069
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.1 MB (310052639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59e900b0476ce24db65450deeeda7f9e8880ff8529d7de8298e93693674cd6fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 05 Sep 2024 03:38:00 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Thu, 05 Sep 2024 03:38:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Sep 2024 03:38:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:da2a5f0f6797281a1fdea3bdac0c765cd6516de6f1eca260ed6ab040f1279b37`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30aca98d5abd5d13ef68be720231cb24cc670df09a58eb0a3ed79c4dec489cd0`  
		Last Modified: Thu, 05 Sep 2024 03:41:39 GMT  
		Size: 89.9 MB (89896835 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:15b012c9a1a1697eee0d7c2c425f65449257f385c971a5d4ac26dfb159815efc
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **319.2 MB (319188222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f614961de0e51431b7824a2bd0c451a22b77afdd4daa56aecc0a47a53e2d23b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 05 Sep 2024 05:04:13 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 05 Sep 2024 05:04:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Thu, 05 Sep 2024 05:04:14 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Thu, 05 Sep 2024 05:04:43 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Sep 2024 05:04:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4493a27e51ac09eb1f4d05df130506a83565bb70626148e37d61a6242f2f18d0`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddb5836568375eac6b85ee74e987f21cfd2fd03b35a61759eb2afd7218c01325`  
		Last Modified: Thu, 05 Sep 2024 05:08:42 GMT  
		Size: 89.9 MB (89895970 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:de8709007d46e61ef502c33d05017b94e6b87b1d1a873e20d221d0d36cab8308
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326885120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:628377bc2ae49bd75662713d590c640a5fd24c10d5b555a03235039844f63f46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 07 Sep 2024 05:36:48 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.42
# Sat, 07 Sep 2024 05:36:48 GMT
ENV MEDIAWIKI_VERSION=1.42.1
# Sat, 07 Sep 2024 05:37:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 07 Sep 2024 05:37:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:75dac5c3852a86ae21558bcc06cef8058af44864bbb11defae2f6ac1bd54ce51`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f9b5a3f4df1395aba7b15dd066ead1e5ae94a778313914bf579da8fd202837f`  
		Last Modified: Sat, 07 Sep 2024 05:45:28 GMT  
		Size: 89.9 MB (89896583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
