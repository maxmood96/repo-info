...
```console
$ docker pull mediawiki@sha256:8fff01c99be07536418c2c9055507e22b4dd3e5855a1b812ecc16a79bc2fbbcf
```
...
```console
$ docker pull mediawiki@sha256:335815bbf167d4c2060cc65097381635fc234ccbeda660a91f86e38996c6d660
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.3 MB (229338171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7453f19ee7ccd067f67d44a5a385efecb4bcdcdfb1a9b03426573a498a6ff51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 11:35:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Fri, 11 Mar 2022 11:35:36 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Fri, 11 Mar 2022 11:37:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 11:37:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f3d39755d72f18fbc26aacfc8096a633bd72ea069f3d6e7825ba9dd38a2f3775`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45ec1f3e09707710127dca46a4c1ab8506b901b55a61b4190440db57805eebb5`  
		Last Modified: Fri, 11 Mar 2022 11:48:45 GMT  
		Size: 51.5 MB (51510522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:0bbe19f7cea4ebb8a4353209ef302e6e7ef885af2febb9f8a78569e068442fd5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.0 MB (219038103 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa66bfc869581919ce267c2a1b486b26d3c79520fa3e3121a2b5f2287e3be017`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 23:15:36 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Mar 2022 23:15:36 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Thu, 03 Mar 2022 23:16:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 23:16:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:16bf299ba3d936cde8f4022a6ded1bb0e754ef40f641dbd55cf62d4cdaa3e951`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6729c889dab54fc8bfce1fa91f4d39274890b2dbcb74ada462f0f097d99eb933`  
		Last Modified: Thu, 03 Mar 2022 23:33:24 GMT  
		Size: 51.5 MB (51510489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:stable-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:f2b2709b6901d1bf65b3563dbd668c198a7102c2b551e582e63004549efeabd2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.9 MB (244886382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ac54380acc285e527a79223828177da9855e7ee378a5e45a1cc36b4ff7c6e92`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 12:57:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Fri, 11 Mar 2022 12:57:02 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Fri, 11 Mar 2022 12:59:54 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 12:59:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0d0fd8c7aa497e78424c89e08ce7995a0f057c7e46bdcd3f263f02f548feb09a`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a727d5fedd82ec8904cb99d1f5350547840257ee3873ef6bc8f35ecc4935871`  
		Last Modified: Fri, 11 Mar 2022 13:17:41 GMT  
		Size: 51.3 MB (51268341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:5a8335b19e82837d05a7937bbe0e089ab80d5737ab9eff5c5f68fd5bf79492e9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.0 MB (257961531 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b5cd4a28a09cbf4a5ea2d592c659be24d18f2a681bbed8485025cd6e2f90e94`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 17:13:15 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Mar 2022 17:13:17 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Thu, 03 Mar 2022 17:17:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 17:17:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:032f7d08f7f2d6952ce44ccdd7900de55b8d853f0814a380dd7c11220412efef`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:101f601cd847e5e34e32fb5ab7e0f3b19d6ae3095a8a705aa116a1d570a61dc1`  
		Last Modified: Thu, 03 Mar 2022 18:43:21 GMT  
		Size: 51.5 MB (51511597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
