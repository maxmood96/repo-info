...
```console
$ docker pull mediawiki@sha256:2c1106ea197669fd7042e856e5e19ef5b720238e3402cb12389c5c3933f0fad0
```
...
```console
$ docker pull mediawiki@sha256:467f80073fe4c7032936b377605024499e67278af344b929822258e577fe9151
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.7 MB (298664303 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87dd03a35a114024bfa6aad00e83cf4ffbf0c05db9d873e4e1e92d29cae3c635`
...
-	Layers:
	...
	-	`sha256:df48120ea15a45737cd70ddeb7c0afc5e107889028c1636430d6cf14c91032a4`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ab354a5738e1e229fa9dd9546265d6da593d1c698cb38988218348a76ff7e64`  
		Last Modified: Sat, 29 Jul 2023 02:24:05 GMT  
		Size: 66.0 MB (66011551 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.0` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:49657b77b55e5967a3afb19ae9a3427cd8e14d62ef4c9e3bf55faaf5c185cec4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.4 MB (267352265 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:638c3c5f697f0ed9b1afd215d9781f626c71c21427b107a4fcec9a8f892c6850`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 05 Aug 2023 00:01:21 GMT
ENV MEDIAWIKI_VERSION=1.40.0
# Sat, 05 Aug 2023 00:01:48 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 00:01:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0c7e26c96c26c37bd340ed07fdbfcc577b63a49ce79f2d232cd581bdb447db6b`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a60ea0275f7d1c8813497b7697fca539fb66cdd4db3e9df98952adce88051c63`  
		Last Modified: Sat, 05 Aug 2023 00:05:22 GMT  
		Size: 66.0 MB (66009154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.0` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:cc678342b12b11fe9e224a3723c570794ace84dd51b05d992485e9c220d4fe2b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.9 MB (254885375 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b586d65eb9b4ee1fb3f26cd780d14cf68af08feed3fd76f9760ec0b0ea4d6ba`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:8238917398b0a2edd66a78e6dbca6ff63a0ef17060631684366342b79e8b3b37`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f04bbc063f2d725bc4c73271a49f6714ac5ba5397c01843ed963e09bd54d7b`  
		Last Modified: Sat, 29 Jul 2023 03:31:47 GMT  
		Size: 66.0 MB (66009154 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:762b7c1ce0eaf323360bee59ffbca18a1960d9c9a7f95d12e5ada2fb7f982ee0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.8 MB (289832131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:454cf76a994c93d945294ee6b57ff0c47620db39934fbaa80b6bfd9ef792c27e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 21:57:15 GMT
ENV MEDIAWIKI_VERSION=1.40.0
# Fri, 28 Jul 2023 21:57:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 21:57:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:22c93466681d259e802c8e51a401047b565067ef0ed5fcb7147149d01c737090`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:580edb46af2fb4d1ae09626c8497bd949a7365a8724064535c24c1cf1443809d`  
		Last Modified: Fri, 28 Jul 2023 22:03:56 GMT  
		Size: 66.0 MB (66012839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.0` - linux; 386

```console
$ docker pull mediawiki@sha256:dc1cc61d3039fdd2206b3c06c46da9fe4a138d1f8ac09778622081da121879e5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **299.1 MB (299125610 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a3686817e9eef184fd2bf3842cca449f9510849057ad11fb94d8ad823a24e5a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 22:51:06 GMT
ENV MEDIAWIKI_VERSION=1.40.0
# Fri, 28 Jul 2023 22:51:31 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 22:51:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:452be917c96b2452719de6b692832b54b93487b55a3995ef1d3c7398bdac86aa`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e531305329c9d4a25c3e5bb9ebf8b6559e808af3a592582a11fd98b576fab807`  
		Last Modified: Fri, 28 Jul 2023 23:00:48 GMT  
		Size: 66.0 MB (66009522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.0` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:4fbba1e11644bffdaccac58531738729c5c59e29f5669642b6c44d1aa6cc7a1b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **307.1 MB (307081259 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed1fc710d27e0c095794de80db807813a5b33891f245e611bf31172b5d5d2b37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 29 Jul 2023 03:50:29 GMT
ENV MEDIAWIKI_VERSION=1.40.0
# Sat, 29 Jul 2023 03:51:12 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:51:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2233015da2183f62ea1cbf64bbafa0b407da3a9a0612e5b6bbd11269b3311747`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d54b99867e71d0976d878fa2172e53bd0816aeabf889ad8d77e3b8dfaa6e4859`  
		Last Modified: Sat, 29 Jul 2023 04:04:25 GMT  
		Size: 66.0 MB (66013029 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
