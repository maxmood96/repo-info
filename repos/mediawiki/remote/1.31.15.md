...
```console
$ docker pull mediawiki@sha256:650b8c78c38a5a29f0e96da294f2b65f7e587ad1b255833703179c75a4611c0a
```
...
```console
$ docker pull mediawiki@sha256:f15a895ee0ed0576a59198d10a75f60bca4f340be74d23da6cf0e27cdc0cbb9b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.6 MB (249566286 bytes)**  
...
-	Layers:
	...
	-	`sha256:51b18253183b2c3dfb6bf6b69914605f1133aa3aa77e823402d72b8d75491b5d`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4de78890604ab9eb2577c3ad6aa7ca299a1b547dcbb8303c5c1f8e00ce13b49c`  
		Last Modified: Wed, 29 Sep 2021 14:16:38 GMT  
		Size: 36.2 MB (36177984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:bee604ca16534693fd5e0a92d74b517c1a665932b95210e122a5fe4b9ec2f43f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.0 MB (224049717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b34af25aa2271deb923eb3924f79b17ad3f973d2aff83b62941e79a03ba127ad`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Sep 2021 02:56:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Wed, 29 Sep 2021 02:56:11 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Wed, 29 Sep 2021 02:56:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 29 Sep 2021 02:57:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ce98822df8984502d2d37a58894cd5ef3b0a41313ed08f732605ec7d834b8f69`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0252cb72d48bde86094135d50a000c011b9f02f3922713e98b2d1ba94b1e8ea`  
		Last Modified: Wed, 29 Sep 2021 03:09:01 GMT  
		Size: 36.2 MB (36175771 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:22d8face26bdd4b05807eb2644240bbb44113909d2beef0c55b848e1073faa45
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **240.8 MB (240831696 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04bc26f7723063fccbd6f0e1691855e2dba2425edbce64abfcf4d6861beb7e68`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 29 Sep 2021 07:13:37 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Wed, 29 Sep 2021 07:14:04 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 29 Sep 2021 07:14:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e217602abc58c1fe5babb9acdce128ddb7d5a083300379cd88dce1b17c4967bd`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25738536a30d7986d59b03d16300dd795fe7271fd6baee2c6d238d632cedaea2`  
		Last Modified: Wed, 29 Sep 2021 07:19:43 GMT  
		Size: 36.2 MB (36176777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; 386

```console
$ docker pull mediawiki@sha256:77c2ea81fdc8cfeca1b1edf5e441350356d30df73578dffb3bd92f36e0382fb7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.5 MB (253529840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:633be687b6dd7be204063f8a55b208fb55908da88e1c35ff3ce358ccf13a0f7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:0b4bb314159962e64ae405873c402151c4ca3e7022ebba02369b0182a667bc8d`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1252c23b88eef3919be06f2f1194cdcdf05bdeed4f6ad5b9d9af2651df50285a`  
		Last Modified: Wed, 29 Sep 2021 04:37:13 GMT  
		Size: 36.2 MB (36177069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
