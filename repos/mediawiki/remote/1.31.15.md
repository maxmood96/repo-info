...
```console
$ docker pull mediawiki@sha256:a9b44652c3ae1e5124d612e4c066a896aa1fafb0c6574a30d5c7a69f8f061be3
```
...
### `mediawiki:1.31.15` - linux; amd64

```console
$ docker pull mediawiki@sha256:bd7caa217319287f4af84da52068e78b7cf1e3eae935c8c380cfefeedb587f15
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.5 MB (252478015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3578fdd96cb92049a3d0a39fcec612db15aeeaa5266b8bea77207d173b1ef2ca`
...
# Wed, 18 Aug 2021 10:59:44 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 11:00:52 GMT
...
-	Layers:
	...
	-	`sha256:ca8b44cde0d776932fb0604e4be5c1e4d2211a390212e90ae3b21a6ca6cc8f98`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c94a019a350f783a97e930d876608499fd7e506f4c5aae4e7afbd83abbc6cd`  
		Last Modified: Wed, 18 Aug 2021 11:06:10 GMT  
		Size: 64.4 MB (64446364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3a14c22f5e2d2dacf244bdc3cdd80fa91b302646c8a7815940a0cbc1ee7422c`  
		Last Modified: Wed, 18 Aug 2021 11:06:00 GMT  
		Size: 2.8 MB (2771431 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6fa46dd64fb896f0eac0eb55ee07710030c888db5a2d84e7790cf2160efd97f`  
		Last Modified: Wed, 18 Aug 2021 11:05:59 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d2bfd40dd6614973f8cdb2abc5be50fbcfd707bc438c45e502ad03ca3c0894d`  
		Last Modified: Wed, 18 Aug 2021 11:05:59 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9631bd1df190e74074cab5be63dabbf4e4c8883071e4bc2bd369e2e4ea6ba04`  
		Last Modified: Wed, 18 Aug 2021 11:06:10 GMT  
		Size: 36.2 MB (36209251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:7e55335bfe96802346b80e2bed92da0c8afd167cded13a1ed183fcab0a453c74
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.6 MB (223573911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8afd237df6463b276bbf2a87c59ebea62d38a95ab5c36c51c5e2f77d275fae37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 18 Aug 2021 12:54:18 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 12:56:49 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 12:56:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 12:56:52 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 18 Aug 2021 12:56:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Wed, 18 Aug 2021 12:56:54 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Wed, 18 Aug 2021 12:57:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 12:57:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ed2765cb347a6e166867e74fa84e0c76e1b1d9b401bc6acbadba8b3f80bc510e`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e91cc79540c7dab2435785accefe36e3ba46e4245909068e3670746ce4fea399`  
		Last Modified: Wed, 18 Aug 2021 13:09:11 GMT  
		Size: 38.4 MB (38355100 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe9ebc8fc541f72281d8caeb8e917aaf7e88e3adf883cc32b982cdef6bee29c5`  
		Last Modified: Wed, 18 Aug 2021 13:08:48 GMT  
		Size: 2.4 MB (2350080 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06c00cc5b23f765c69748944ee831e25bf788bb0aee579500f968af0a093e3fb`  
		Last Modified: Wed, 18 Aug 2021 13:08:47 GMT  
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b1a02f5d86c71e74355d89270181988bc2ca1acdaae9e202bf7c1dfbc72742ba`  
		Last Modified: Wed, 18 Aug 2021 13:08:47 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21964bec0b2798f1abb7795d771e48d69a9bb2927f9752e2881c11d5dd507594`  
		Last Modified: Wed, 18 Aug 2021 13:09:25 GMT  
		Size: 36.2 MB (36176508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; arm variant v7
...
### `mediawiki:1.31.15` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:08ec55a9787fd31ea9e5ba32fb5c4596b75cd0179636fb986e522e4d00e6ae59
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.3 MB (242299603 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:da1fdab16a67b51f970f9a34a89f6917db48617e6db4e7040d45320516c9b4d4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 17 Aug 2021 10:19:00 GMT
CMD ["apache2-foreground"]
# Wed, 18 Aug 2021 06:10:53 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:11:59 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:11:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 06:12:00 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 18 Aug 2021 06:12:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Wed, 18 Aug 2021 06:12:01 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Wed, 18 Aug 2021 06:12:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:12:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c1b8193eb1a2af9778eb3e936be3ad969f958217ddb2547cfbfe3740c741fe8d`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4871086781736f8d6cbf08df9b461599536bbda8beb9e922937cd11b7cda39a`  
		Last Modified: Wed, 18 Aug 2021 06:17:56 GMT  
		Size: 62.3 MB (62262651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:045ce611660190fe2d148179186d700f8a324a295fc3a207be46143a7acc1ce8`  
		Last Modified: Wed, 18 Aug 2021 06:17:47 GMT  
		Size: 2.7 MB (2743151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee7b0ea03bb57ca0612f56edf3f765fb5b8f478e9611449db07514a4467e387b`  
		Last Modified: Wed, 18 Aug 2021 06:17:46 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b572d9a1e6ae5a9d8e8eaf874de0b44c97f83710fab40cf87703e9b3afffb729`  
		Last Modified: Wed, 18 Aug 2021 06:17:46 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe6b7bda1a56b3c4af8deff3b487d319b3e1eab0dbe28b621fcfe4c100453ead`  
		Last Modified: Wed, 18 Aug 2021 06:17:56 GMT  
		Size: 36.2 MB (36206853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; 386

```console
$ docker pull mediawiki@sha256:55f1a003aebeed96f17a80ebb2736230eab977a1fae056936bd8f97cc972d3e4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.0 MB (253037186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69dd7ec833d146240d21054b7d882b14ab8c8b2984b945765b2b66f4f9b3c669`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 17 Aug 2021 23:58:47 GMT
CMD ["apache2-foreground"]
# Wed, 18 Aug 2021 02:55:20 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 02:58:47 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 02:58:49 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 02:58:51 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 18 Aug 2021 02:58:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Wed, 18 Aug 2021 02:58:52 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Wed, 18 Aug 2021 02:59:28 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 02:59:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b24346f1ec76b36da02951d2a1e408216e4303289a2c6226d6ed6fb7d3a8ee7c`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11d1ca2070467a306b3fdb0ed09d6ac332a039f5e1d969ecafc2bbf4e925897d`  
		Last Modified: Wed, 18 Aug 2021 03:10:13 GMT  
		Size: 42.8 MB (42774378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21bc171f4bc6f779170ef3c193a5a1cb6ca7a5177e725e61c2427570ccf221e9`  
		Last Modified: Wed, 18 Aug 2021 03:10:01 GMT  
		Size: 2.4 MB (2427026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a1d6fd8de812d4cb8a58e2cbfeaf39a69029a5bcbfffcdaf451001fcbd6f0dd`  
		Last Modified: Wed, 18 Aug 2021 03:10:01 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf6cacb2bb9b28bc8fcc37848df7718e132cb010e9b676c00578c9d436bed95c`  
		Last Modified: Wed, 18 Aug 2021 03:10:00 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:016229ffab0455742117022af0bd665c632551f22f1e2b6fad3ace378219f9a6`  
		Last Modified: Wed, 18 Aug 2021 03:10:15 GMT  
		Size: 36.2 MB (36178143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.31.15` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d06a77da787cb8f965d1d2cd9fa7ed93bdec2c6bcd3ad36a61fc3f2d8d20da11
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.6 MB (270617413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:589e8e4f1f4cda2257ead03e9cd9cc70b3f75596fc45db1c44aa206245498b15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 23 Jul 2021 17:22:34 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 17:24:29 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 17:24:41 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 17:24:53 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 23 Jul 2021 17:24:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 23 Jul 2021 17:25:02 GMT
ENV MEDIAWIKI_VERSION=1.31.15
# Fri, 23 Jul 2021 17:26:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 17:26:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:82b82ffb815f4c84ba153b9470a8c3b57ca81b5165926e2f53774635a719447f`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69ce25aa72431a5f0aa32bbea92512baac656578fbe467415b21ae990a0f5a10`  
		Last Modified: Fri, 23 Jul 2021 18:03:07 GMT  
		Size: 71.3 MB (71303567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88723e2c73081917f4cf54d82491f06852a462a1528c776c020c7c67d90a0177`  
		Last Modified: Fri, 23 Jul 2021 18:02:07 GMT  
		Size: 2.9 MB (2854220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:527f961478498436d8130cb01442825c5a9be95ffa54478d394eaf147ae923ba`  
		Last Modified: Fri, 23 Jul 2021 18:02:04 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47ff7f2c82ddc29b6a5f47aa12acd6ce8d9cace4b023258bdc4e797c68f6c42e`  
		Last Modified: Fri, 23 Jul 2021 18:02:03 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f27bc1ae468a0ba15ef59d996cb5c59243790f2c468ff32f6a42bd25e71d9e9c`  
		Last Modified: Fri, 23 Jul 2021 18:03:55 GMT  
		Size: 36.2 MB (36212372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
