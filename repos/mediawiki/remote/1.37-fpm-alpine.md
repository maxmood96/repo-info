...
```console
$ docker pull mediawiki@sha256:67ccbfee6324a0bdabab4acfc7c303960193b5beb0a689f4515b59a0b7fcdccc
```
...
```console
$ docker pull mediawiki@sha256:bd36f5cdf2306ca497f55c0b977707dbaf2dfd9f94d9cb5e2bd9add997df520c
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.6 MB (148623850 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:015d49068b4e48513f6cc8009a2f916fe69c9323f7995574f4573df3a626e643`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Nov 2022 18:04:15 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 18:04:48 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Nov 2022 18:04:48 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Thu, 03 Nov 2022 18:05:07 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Nov 2022 18:05:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a5365e497dd0b3310303e0b1704a4ce2b946ac937d999c90359b419c03d9516d`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21847322097ebf2a7961f03fb4f383fcf9cc59e558494943c5edc7b96d61f723`  
		Last Modified: Thu, 03 Nov 2022 18:07:05 GMT  
		Size: 52.1 MB (52073309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.37-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:8f39fc26b838e507a57837eda26038893e2f960d58e8825cf0ff2b04a895c74e
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.9 MB (144921785 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4aed94cfa35fb4efa98abc349fb00c094172480d12d18d4c8cb4895f2821ac27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 20:04:28 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Nov 2022 20:04:28 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Thu, 03 Nov 2022 20:04:44 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Nov 2022 20:04:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:409c12dd10f718d062abba52ce1afd643708fe50189cff30861598872d6c8aaf`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68ab9de9d6e5806320aa987fe8a8055452b84a7d856718eaaef5c9738f8fde72`  
		Last Modified: Thu, 03 Nov 2022 20:10:48 GMT  
		Size: 52.1 MB (52073268 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.37-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:bf9c025f4c546c36ab52570b6de3a4794afccebdcb09e9d085e1bfff4931e06a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.5 MB (153481621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04fa293e79e5af31359fb86fb797ff7db955d45bba46494df5ec2695fa0a8a60`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Nov 2022 18:16:48 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 18:17:48 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Nov 2022 18:17:48 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Thu, 03 Nov 2022 18:18:00 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Nov 2022 18:18:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d0aa399f2486e4ac42acf3b893da4032d21e286d8dae7b2bb669384fa29479ac`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2494afc62b213841573a072ff734f3e4a074d20fabcfb4098c0d827c3e32c978`  
		Last Modified: Thu, 03 Nov 2022 18:21:55 GMT  
		Size: 52.1 MB (52073641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.37-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:df8ab4689d4a1fff86b87699a63bd8dfb2a42960f5332556f3ba31ff469b8c35
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.3 MB (155287974 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:526736c55a3b582a6de42cb1fe80342ba7025d7f705f703b0590723ed32c4f94`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 19:18:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Nov 2022 19:18:19 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Thu, 03 Nov 2022 19:18:35 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Nov 2022 19:18:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:77aa15bbb5e5454ac4e01eb08504cd7a1f469ba7fffb684997e1e5c35f83a9fd`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c39719eed0c5fa447d7fcaf4b42234e627cb07f17ad98150aac44390d3cfb3a`  
		Last Modified: Thu, 03 Nov 2022 19:23:49 GMT  
		Size: 52.1 MB (52069327 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
