...
```console
$ docker pull mediawiki@sha256:85b688447c015bdc33f0a4c0edc08a7bc1df1cc9c99bd5167dde4f0f28e84927
```
...
```console
$ docker pull mediawiki@sha256:c279fa2bc65ac024f9ab28db051c4f268b9b7132df0ba6147ccee6346d39a795
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.3 MB (147261930 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3691000983483af5fa3039f829368a54fb9e2f0154ad51fb684893b1d293bf25`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 08 Oct 2022 05:41:34 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Sat, 08 Oct 2022 05:41:34 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Sat, 08 Oct 2022 05:41:53 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 08 Oct 2022 05:41:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f9eab3431f1b890ce0ea0098f168853e1a63c71ca8a7a37a8019c5998f4cebe7`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2501c899624a8b0e7c23191f3c6b981418dd2702b4baeb504d05a2819492ce4c`  
		Last Modified: Sat, 08 Oct 2022 05:44:00 GMT  
		Size: 52.1 MB (52073522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.37-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:bdc560ad1eba1aecdb7cbb8a61d0c78940985e4263ff97d12f3a0b25c21ae211
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.4 MB (143412337 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eca3dae6101d77a6b0b0f30e1de78855e546373c592b468f11790381a27b8f72`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 26 Oct 2022 19:06:51 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 19:08:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Wed, 26 Oct 2022 19:08:30 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Wed, 26 Oct 2022 19:08:47 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 26 Oct 2022 19:08:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0821b6af0c89deb64f988a907c8af5240e30274796c27c9ca162bf5beaa060d5`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b451575cd84358af79998b1bfe4652db6967d76da22236b9b19d5faa098f7d8`  
		Last Modified: Wed, 26 Oct 2022 19:14:58 GMT  
		Size: 52.1 MB (52072569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.37-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:be1759e100ead6a8bdf7a893c090e27517b40e3a0f378db96bfdd164de17c880
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.7 MB (151741584 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fa6abd24f57c7492618e2287c31d1bc8518ed98b2d682de1547aaaadcb209b2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 13:06:59 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Wed, 26 Oct 2022 13:07:00 GMT
ENV MEDIAWIKI_VERSION=1.37.6
# Wed, 26 Oct 2022 13:07:11 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 26 Oct 2022 13:07:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:582a58e926d265e8c8b22ee6e8315c010b1f6624f64af9c250160d3ab7644998`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:046f846fa0591d5632b783082c883fce1718072fab73da1d4d0b4ee78ba2c063`  
		Last Modified: Wed, 26 Oct 2022 13:11:07 GMT  
		Size: 52.1 MB (52073618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
