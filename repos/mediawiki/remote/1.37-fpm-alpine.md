...
```console
$ docker pull mediawiki@sha256:37efe166823eff03d04b4493cbd7f015b3874428b8642fb9097f537f62785681
```
...
```console
$ docker pull mediawiki@sha256:4a83ee01a556b19bf82813b6baad8c0f3fca0448eb48e6b2d616d58b06d577e7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.5 MB (156533582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fd6491779976f6dbdd6833b0b2b70c4611c623670cc7de610044d83fc64fedc3`
...
-	Layers:
	...
	-	`sha256:19768b73eeaba9c82d06ca4c6f0faf2e058277f9181072cc40d2eb859e30a70d`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:727cb1abcca48f2eb0dd44ea3851e4b4385ab7b32093e883b10651b20b007d22`  
		Last Modified: Thu, 03 Mar 2022 17:03:26 GMT  
		Size: 51.2 MB (51245460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:662ce4b2452a520af6bd95821832e44916d97926435a463470749124df272f36
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.3 MB (148317144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ba7d01c08e6db7226873465a80e06cc4cd26dddc01588f7552f222bde21b5de`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 23:19:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Mar 2022 23:19:33 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Thu, 03 Mar 2022 23:20:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:5fc5c9a70012c6d840792de720be5118ebd163a1656aaf2385116b48ba69de15`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99b487833e85418189be54c87f37237c66ef115e85966417c4f809f43704a8e7`  
		Last Modified: Thu, 03 Mar 2022 23:34:36 GMT  
		Size: 51.2 MB (51245365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:adc96bb8e097f1522cb913e36e5e86926eea12b765a6567469d459e083727da3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.9 MB (158925222 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d39c5d4a4e1422f58586f1175ed5655711685b853675d01713c1934727d0368`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 17:22:37 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.37
# Thu, 03 Mar 2022 17:22:42 GMT
ENV MEDIAWIKI_VERSION=1.37.1
# Thu, 03 Mar 2022 17:25:21 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Mar 2022 17:25:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:427a26fd50e9b719e53d1457e72a191731bf469e4fbf94061c579925f54a7050`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07ff9b1b7149147578d3387ead1fcfe36df89d9c94583193d6a6414a71ed749e`  
		Last Modified: Thu, 03 Mar 2022 18:49:37 GMT  
		Size: 51.2 MB (51245722 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
