...
```console
$ docker pull mediawiki@sha256:e8ffe810950c7f8abb9e035a1444e7e1e88e0194345942f2e053e1bd222c24e4
```
...
### `mediawiki:1.38.6-fpm-alpine` - linux; amd64
...
### `mediawiki:1.38.6-fpm-alpine` - linux; arm variant v6
...
### `mediawiki:1.38.6-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:fcf206795503eb8f6acb13db618a8204a9e4e069df70567db30810fca8e972d9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.5 MB (148458527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a705ed9b05d6ac02b7a3f6a515f9b0c548619e24243c1aa99b8cc207f7638209`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 10:50:36 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Thu, 15 Jun 2023 10:50:53 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 10:50:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dd2954ad5fe989b38abb9644a9bad5694295b6d43c9e3a474c2337c4920acdb9`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0eca3c5e98cb98f533afe9fed3c86ac259408e479af953353d481963737f6c84`  
		Last Modified: Thu, 15 Jun 2023 10:52:28 GMT  
		Size: 56.1 MB (56149149 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.38.6-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:201227f44aee913af3ca5a2ab3d7f06015f72ca1aa25248633cc7504467ff48e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.8 MB (156808524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db492f5cdd19276106412718acfa762a4e4ab4a3e54481457dcc37d08aad3340`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 08:44:44 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Thu, 15 Jun 2023 08:44:57 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 08:44:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f482d46c4a308165429e2e8cb4a5b8cd0857064605a22604d4f21ef6cc6e52eb`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b0308ac628256bc543d59d7e8b75b83205fb569825d98bcc1180a09d3d997a4`  
		Last Modified: Thu, 15 Jun 2023 08:46:15 GMT  
		Size: 56.1 MB (56148926 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.38.6-fpm-alpine` - linux; 386
...
### `mediawiki:1.38.6-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:bf4c6e597b3b9aa26e81a463c7c47f4676117bf48719b06c366a50bf55a880ea
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.0 MB (164993527 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0d2fb7035ff2f31f454d571459a89415ae5fcb105148e84a00f12e2d59f5de0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 14:14:24 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Thu, 15 Jun 2023 14:14:54 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 14:15:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7b523948222ac4e51a9bf185f08ff86eeccce2edac954a36bf90e92bde406233`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:711335227899d10fe0312ecae77f4906246a90a2b4c3d16b8436c0b7e90571bf`  
		Last Modified: Thu, 15 Jun 2023 14:17:27 GMT  
		Size: 56.1 MB (56148894 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
