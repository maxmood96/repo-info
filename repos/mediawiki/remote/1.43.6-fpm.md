...
```console
$ docker pull mediawiki@sha256:733bb67157416e1431ce82888b796c42f38b56f0af03ecc3bfdf0a378107d995
```
...
```console
$ docker pull mediawiki@sha256:451a6eb720f16248c13bd1e832ffb2394433f9066339f25ceaeccd19f374efe7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291940139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9059e0fe332865d0ef1b4b99e9f2b5a340d0add26d9e44eb552553892d69aa0c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 09 Jan 2026 23:35:42 GMT
CMD ["php-fpm"]
# Sat, 10 Jan 2026 00:57:20 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/* # buildkit
# Sat, 10 Jan 2026 00:58:36 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 		liblua5.1-0-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.28; 	pecl install LuaSandbox-4.1.2; 	docker-php-ext-enable 		apcu 		luasandbox 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Sat, 10 Jan 2026 00:58:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Sat, 10 Jan 2026 00:58:36 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data # buildkit
# Sat, 10 Jan 2026 00:58:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.43
# Sat, 10 Jan 2026 00:58:56 GMT
ENV MEDIAWIKI_VERSION=1.43.6
# Sat, 10 Jan 2026 00:58:56 GMT
...
-	Layers:
	...
	-	`sha256:426b746e0c71d7055a11cd36bb852d3914c08249c8b793a62034b50c6f458b85`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b37cf0336f7e42b8a0cd7f9423bc1f678eb979724dea4522a153e2988d2cc2b5`  
		Last Modified: Sat, 10 Jan 2026 00:59:25 GMT  
		Size: 46.9 MB (46877777 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6f4f85b907a5c0c30282c0859d107e928314cfa49787f4409e83e4094bf9980b`  
		Last Modified: Sat, 10 Jan 2026 00:59:22 GMT  
		Size: 16.8 MB (16771165 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c0e6f5a1d46fa30c8795e85bd29106eb49d6eb4898dc16739c8b2e85c9e0e607`  
		Last Modified: Sat, 10 Jan 2026 00:59:20 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0b47862cc45ec1971db4ba733d09439b9cd44d995dbd77eb220c2285369875db`  
		Last Modified: Sat, 10 Jan 2026 00:59:20 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ef33f1ce3b2459cd59c0dc36b7e72c97d9b0c1139bddfdaf8749630d62ea25e9`  
		Last Modified: Sat, 10 Jan 2026 00:59:35 GMT  
		Size: 93.0 MB (92993721 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:1.43.6-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:559d75ebf9b97cf8cc3129f1752ae8bf86a779212f149beefa520d60bb6dcdf0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.7 KB (34685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b01f71296d0900a5dfaad65525a6d5f201991b7d914f86a3e86251661abed190`

```dockerfile
```

-	Layers:
	-	`sha256:2a8ba937ac5576713f4bbc9164f51e98db8ba528de9dad3d5dd613c01d39556d`  
		Last Modified: Sat, 10 Jan 2026 04:16:40 GMT  
...
```console
$ docker pull mediawiki@sha256:27b76df984e4f674074237ca475cccdf5b18a4707fa513359f25fa58d1f0b5ce
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.9 MB (337887706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fff0190a4831b480aa50bf5755cc83c1e37cdfbdf4df01e3fb1b98089c146e27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6de24064742efe06bc54f3490ea7de7175a833be02c99d308b00585690012fb1`  
		...
		Size: 139.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0e854793cfa95adda3b7276972c5ef10434964623feef00a91c3f446737cc248`  
		Last Modified: Sat, 10 Jan 2026 03:56:38 GMT  
		Size: 93.0 MB (93000069 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:1.43.6-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:a92d5327295ca585db89428450a4f7917baded0b16525b17eec2212285cd82b8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.6 KB (34613 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50c01d409d5635ba27922fb1790fcfb88b026a20161bfbf187cac3fd72572ff9`

```dockerfile
```

-	Layers:
	-	`sha256:94808ee26a4b75a26c50fc16aa9003a5a339d1ea3a28dcb6d36c97868bec3782`  
		Last Modified: Sat, 10 Jan 2026 04:16:56 GMT  
