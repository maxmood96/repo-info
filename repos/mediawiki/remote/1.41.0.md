...
```console
$ docker pull mediawiki@sha256:3a51380b2d568588c3bdd8e90e47828a8a4e8cf5a480f7cfa037afdd99de8765
```
...
```console
$ docker pull mediawiki@sha256:9ab2c22a5bb66b4b3fb7ce69a5dae20a09e35e794e56ebda9a2bb13f12b42eda
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.7 MB (349717597 bytes)**  
...
-	Layers:
	...
	-	`sha256:162f84b664a6610fb4be3f62215ef3c8d83909f04d0b1c4b557c98e338d7b9f1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6e0595cc0337058ae3af6454cfb827d0ad19b81b5cd42183ee575d55f6da33`  
		Last Modified: Tue, 13 Feb 2024 14:59:02 GMT  
		Size: 117.0 MB (116967464 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41.0` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:e3a17974a6b1f86d902a4712f063991516182eb8267c28e7704e390bb606642f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.3 MB (318282961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f0206bffa7b1484206de2a46da669d61aadb528d7085561f8ea3080f62e31c7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 16:02:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Feb 2024 16:02:46 GMT
ENV MEDIAWIKI_VERSION=1.41.0
# Tue, 13 Feb 2024 16:03:30 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 16:03:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7925eba6d93aaabd598367a29093e9e65473fdff049d81c4ca97caa573e5e4cf`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7c94b61e05c156a8fb46a6c9a2e416134f832fa23a35cc53e3a991663c08ac2`  
		Last Modified: Tue, 13 Feb 2024 16:11:50 GMT  
		Size: 117.0 MB (116967264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41.0` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:459a1f50cff7fac5c8e1807652c97417f6834ebf2b7c16d92914b7573a11df92
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **305.8 MB (305805056 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91504976932dbfd08f8df334be04bdc781cd8f3431e25231e09c5ed842dfe5c2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 13 Feb 2024 20:20:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Feb 2024 20:20:26 GMT
ENV MEDIAWIKI_VERSION=1.41.0
# Tue, 13 Feb 2024 20:21:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 20:21:08 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3cf722d6f348788758f530af113a24ed24c20961ae3c4b7d93d3b45e8e71a8fb`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21d0870afce79ce1a00c3293395ea6b65732a3c2e48a91cded0730b764452baa`  
		Last Modified: Tue, 13 Feb 2024 20:28:53 GMT  
		Size: 117.0 MB (116969014 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41.0` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:4475322d9404d7c2816ec3ea400e2e38c221b1b07bae93b49a2245668bc496a5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.9 MB (340887513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08e6f96d3a7fe77e40020b5ee1f3f5c8c81aa9a1e240d61fe8b7204db742f547`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 12:07:27 GMT
ENV MEDIAWIKI_VERSION=1.41.0
# Tue, 13 Feb 2024 12:07:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 12:07:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7d404ec413f6bacfef46a1c5d580eaeb5e1f12f89ff2947943dd8e15bec165e0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b77b7aafa87600778cde46ec9071ad1ab773605a2bb2fd604d8857bc2978dd6a`  
		Last Modified: Tue, 13 Feb 2024 12:12:28 GMT  
		Size: 117.0 MB (116967202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41.0` - linux; 386

```console
$ docker pull mediawiki@sha256:426ce631981f4978f1fcd469578e854d02b4fd8a404985b4f5b27af788523274
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.2 MB (350191765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cbadfc83645840da1c52be81eac886a784fb71ed8acd6cba9941956fab67fc2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:b56dc783a31a580268105e74265490eb22f0206e0a3607fd131980a85806d508`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c79997196d83cce9d0e6cdac705d575a4d00d6517cd62904c9d6cb5c5d1688e`  
		Last Modified: Tue, 13 Feb 2024 16:03:00 GMT  
		Size: 117.0 MB (116967239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41.0` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:2001f0a3d8d582e7eb4393e156e14e2b3008ebb7733d9f1b7ae073b2de1ecb03
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.1 MB (358128081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d46f9a791bd6c08ad9e15cae63c7236d6360c62d300468a3aafadca46cb09fc8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 09:53:08 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Feb 2024 09:53:09 GMT
ENV MEDIAWIKI_VERSION=1.41.0
# Tue, 13 Feb 2024 09:53:48 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 09:53:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5b728dccbd5b89efd08b1405b3c7048f3e349fe861ffa63c97a6c85036b9b183`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdd5a9e8d30149dbd757a5946598cdb4f67edd33cb925289a3b67ce3ada472d5`  
		Last Modified: Tue, 13 Feb 2024 10:00:54 GMT  
		Size: 117.0 MB (116967819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
