...
```console
$ docker pull mediawiki@sha256:f91333a0fbd1a430e4cfa7393911f5b7c0c5a6d7bd9f233db311eb19c67f9de6
```
...
```console
$ docker pull mediawiki@sha256:c01327e1099cc4e1042b60d0f1f70c359a258501427d9b5d70ad7c7fd9e0a2f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.1 MB (340058210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:06c9476a4b9f781e2642dd26fcd6edd8d592da91fb79704258ee073f846e4b20`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6aa38944cdb6964296b36902eb8bade6ce86fbe292cafffe53ce64fa8520f724`  
		...
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f3d2a4b81eb26bd855330469995317ce5f07ad7027817339bbf2b2cbdd315f75`  
		Last Modified: Tue, 17 Mar 2026 07:21:21 GMT  
		Size: 95.2 MB (95185280 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:1.44-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:10a4a94c38902830e0c88ee3b0aee799a89e2a3775f18b657f6e25619344a91d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.3 KB (34301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2960a7de4eacdb25ead7be6f1a683bea787fb4a97df42f65de46b813b84182bf`

```dockerfile
```

-	Layers:
	-	`sha256:37edf2c245c086bdba51e600a5040ab2ee4e1a3cce57a2d46bfdd459e6eb4cb7`  
