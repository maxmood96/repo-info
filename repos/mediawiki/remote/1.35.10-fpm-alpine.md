...
```console
$ docker pull mediawiki@sha256:f5e93f7066c2ddd55b99e5934f4945e5fe46339e24e13ec84c25a3a0da2a0a70
```
...
```console
$ docker pull mediawiki@sha256:2f40527b8a71815073ccbb3c59ee59a58a2ab7f8aea2957a1b13a43a229b3844
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.1 MB (154086081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aaa71a841b7f899e2c0da7f00d052244d57f224071b281c46dc61111d8d550a8`
...
-	Layers:
	...
	-	`sha256:2e3c2bfe5d203ecd0d370d655e4476cefccbff1d0d9f591adc48428be037eb05`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adc11d928a014be47555edf90d9990785670f3dd4ebaa4d64ec05c619f421777`  
		Last Modified: Thu, 15 Jun 2023 08:01:02 GMT  
		Size: 51.0 MB (51016638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.10-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:a811cd6f8f3aa32d1c1545469e3e5949100ee013e4a40f7254015408d78998ec
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147183487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:307c0611fd221c25c80195d42bdba68aee5c84b85053a85346a3b9ccba140c1f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Jun 2023 07:15:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 15 Jun 2023 07:15:00 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Thu, 15 Jun 2023 07:15:16 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 07:15:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3451aec9652947d32c552aa96ec8b1f349a9e2a18ab6bc52c919db324d58d4d9`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a77d77da663bac9eb5b5a543bec8a569e8eda5b71b27418bea29cc9b8c1dffda`  
		Last Modified: Thu, 15 Jun 2023 07:16:38 GMT  
		Size: 51.0 MB (51016829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.10-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:7b55f166926769c2ca2c200b7c2166266c0e7260a2874654617e340defff6de0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.3 MB (143325746 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e5a7e3470f0f1b463306b60e314af87ad51737b3a05ebdb902ae3220cfcc0f7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Jun 2023 10:51:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 15 Jun 2023 10:51:04 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Thu, 15 Jun 2023 10:51:19 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 10:51:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dd2954ad5fe989b38abb9644a9bad5694295b6d43c9e3a474c2337c4920acdb9`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01d5d23d3a829b6764856bc624226c6d7df0a00fb3ba79860419b5c01c0d09b4`  
		Last Modified: Thu, 15 Jun 2023 10:52:53 GMT  
		Size: 51.0 MB (51016368 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.10-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:7d11dd4cb19bc8d07fce47a9b32c0bca0105db42388f657142f99da26bd5685d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.7 MB (151676426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd1a01db53301d0170c2f099d46edd4657c67926dfee9270d911b3301314e3e2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 08:45:05 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Thu, 15 Jun 2023 08:45:17 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 08:45:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f482d46c4a308165429e2e8cb4a5b8cd0857064605a22604d4f21ef6cc6e52eb`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9a8c63d0cbfc3d05871003fa1d72291f37ccd64f093ff2117f4004cfa05c75d`  
		Last Modified: Thu, 15 Jun 2023 08:46:37 GMT  
		Size: 51.0 MB (51016828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.10-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:3a6d26408834ca7121feec2bee98c7ee63e3fd583109eed6017c7c8cb5878b43
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.2 MB (156211938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:979cfc584181b9fd4d02c066b0cd8abca635707ff1264df469f3c5b9e4d36897`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 09 Jun 2023 09:25:14 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 09 Jun 2023 09:26:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 09 Jun 2023 09:26:45 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Fri, 09 Jun 2023 09:27:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 09 Jun 2023 09:27:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:54f55bcc391c0e40f9fa3f60bc94eeb752d232350711dabacc6ba12e74327dd7`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:205090b720c8174422e5d837321790ce50f94ba738aa1005e1c3482e9ec6ff49`  
		Last Modified: Fri, 09 Jun 2023 09:31:47 GMT  
		Size: 51.0 MB (51016667 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.10-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:2be3880c24360a11e92938e320564af01ad36fe1d86ce246bf9b6cecda0aa844
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.9 MB (159861250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d75d926f300a517b45cc4bb3e2a95e436424a5ec73657160c6a7843b9e720ccf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Jun 2023 14:15:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 15 Jun 2023 14:15:19 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Thu, 15 Jun 2023 14:15:49 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Jun 2023 14:15:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7b523948222ac4e51a9bf185f08ff86eeccce2edac954a36bf90e92bde406233`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec84b48bda6cda72c379e622da3fce68d8cf1deca02cb80f0a6837e0a46fd2ba`  
		Last Modified: Thu, 15 Jun 2023 14:18:03 GMT  
		Size: 51.0 MB (51016617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
