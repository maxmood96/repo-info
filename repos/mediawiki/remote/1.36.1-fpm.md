...
```console
$ docker pull mediawiki@sha256:bd3037c515377700a60a09c01022ee04a6994d19ddcf0b624a425f20aa28547d
```
...
```console
$ docker pull mediawiki@sha256:c2e872672640071bdbc84c1956818743bcd866102b828a9ed86520beda9c10bd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.5 MB (260478441 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:678b6791d0f85ba500e8f645f0122af82e31ad7563a15450246c130a5ab46834`
...
# Fri, 30 Jul 2021 03:42:37 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 03:42:56 GMT
...
-	Layers:
	...
	-	`sha256:ba7b3a2a26aba110253c6cacc1840eb6795d40f4fb0eb2d86f54c6bf34bdb1ea`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ba33ed5968960f363f49734b328a745006ab6efc263dc54a26302ad20fb2fbf`  
		Last Modified: Fri, 30 Jul 2021 03:47:23 GMT  
		Size: 50.2 MB (50246177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:511a6d7a22e8404945cff2011e31633a97c929d8970197159a1edf7974b31263
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.2 MB (235210082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e5aecf0427af3c64b5715056d2fd7d765ad085928a0733e991299b926847646`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 18 Aug 2021 05:24:25 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 05:26:49 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 05:26:51 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 05:26:52 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 18 Aug 2021 05:26:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 18 Aug 2021 05:26:53 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Wed, 18 Aug 2021 05:27:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 05:27:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cbe169c710a29c178a46233a18c04287db4687441663fac032977d801168a0af`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7540e2b0da6278ef0ca4502eed21f48d2ff166d48b5944ebddea7d79ac2ab640`  
		Last Modified: Wed, 18 Aug 2021 05:43:22 GMT  
		Size: 60.9 MB (60920050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5b1d7c50da62985a459b5c41aefd089dd86643a41f3201715664c3ef5bbc517`  
		Last Modified: Wed, 18 Aug 2021 05:42:45 GMT  
		Size: 2.5 MB (2473279 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c5020c9e2cf2830d90533bc320271f573ecc71a4de941980e308a02216ce54b`  
		Last Modified: Wed, 18 Aug 2021 05:42:43 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f3a45122bf02b8763058e892e35319ecb2987222184c71c732effd0ca8ee225`  
		Last Modified: Wed, 18 Aug 2021 05:42:43 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1be38962441715144290e8127ca0e96a13c27d5db8c064f014bae3e79c1d461d`  
		Last Modified: Wed, 18 Aug 2021 05:43:37 GMT  
		Size: 50.2 MB (50244342 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:e40074f26169f89ba83fe2fe40cea8eef95a8302e262638741c5c51abc9b5fb3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.0 MB (229002807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7e3789ccafc16ea649197728fea84d09186f8439b6b7f0543cc3d12f0cf3104`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 06:14:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 30 Jul 2021 06:14:17 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 06:15:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 06:15:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:745b141c1b15bf91a94c32cb62d8c1b5f30494a7ef5319ace1b544f8beb37263`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba8644def0e8f1a6e335b849c33c54b0870b7b45f038bf87f02b9f51d33933db`  
		Last Modified: Fri, 30 Jul 2021 06:26:39 GMT  
		Size: 50.2 MB (50244323 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3cca77a890cd3899ac5201ccae83fc83f6e2d870a69841724c575b6710437a8d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.5 MB (250475161 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3086024cf2f09782a96ea2767dc372e4b9897149fd009522c8c96734207b4038`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 18 Aug 2021 06:07:54 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:08:55 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:08:55 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 18 Aug 2021 06:08:56 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 18 Aug 2021 06:08:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 18 Aug 2021 06:08:56 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Wed, 18 Aug 2021 06:09:14 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 06:09:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cac3c568c73313a790994da0ca1bbd4baf60c0d324e690dea053d25c7346b8d6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3606355104ace18bf11e7e65305150db9c91d5c5096c88be130fa27f5bb30db7`  
		Last Modified: Wed, 18 Aug 2021 06:16:17 GMT  
		Size: 62.4 MB (62424291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9876a8c63fc7fa41960d668e3d5fed56b8c5c23ff6273e2a0897089919f62330`  
		Last Modified: Wed, 18 Aug 2021 06:16:09 GMT  
		Size: 2.5 MB (2517045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:325b684551d156efd8a51037e7be1c0373d44bacb9357f3dd127a9ca1fffeb15`  
		Last Modified: Wed, 18 Aug 2021 06:16:08 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b96f2aedfd09ca1662b62ca5b7e0ad12c67b20057d5eef0677c3050fb0e87007`  
		Last Modified: Wed, 18 Aug 2021 06:16:08 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71b74fddd6923796d1c9d1a3cb878003b05556613eb9a068c71b654b5074a487`  
		Last Modified: Wed, 18 Aug 2021 06:16:21 GMT  
		Size: 50.2 MB (50245352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:98b98a142149834d26d7181d5bb64d43f320236dc68268f4b62a208fc3940f44
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.9 MB (260944874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2951eb2edfb0b775f7a3499f52c47e29d6d9f19891365d8831a6384d0b0ce45e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 18 Aug 2021 02:51:36 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 18 Aug 2021 02:51:37 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Wed, 18 Aug 2021 02:52:17 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 18 Aug 2021 02:52:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:46fcab9d7ea8dc072693fc51ec0792b7975018ce078e2087a52a9daf30941c01`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ded34fb5e6eadb12e71b38eb03638895b556b8454f1599b93520aa6060a16987`  
		Last Modified: Wed, 18 Aug 2021 03:08:16 GMT  
		Size: 50.2 MB (50211874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:83fb62cc03fa28bf10da4d24e837e66fa22dbe713638144626b13e5251333dd9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.1 MB (278127703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0eb322478db261a5bd0d896181d570039c7633342aaf9e014737e50a293878c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 04:54:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 30 Jul 2021 04:54:26 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 04:56:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 04:56:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cfc3039bde8f5583a40cb9f81bdae7e015b8558f8cfaa4ec1bb41a2e345ad4ff`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bf4acf804cdf6985b1a0174224d28298d6c41223b1f94f85eec41693e1c0f7b`  
		Last Modified: Fri, 30 Jul 2021 05:18:10 GMT  
		Size: 50.2 MB (50246504 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
