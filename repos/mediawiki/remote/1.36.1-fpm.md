...
```console
$ docker pull mediawiki@sha256:2917f40c8028f9feab139719e63b005b66990c49dbeb3c900cb2f12ab961866a
```
...
```console
$ docker pull mediawiki@sha256:aa72b4634f68ffe7f64c25577eb01b3c26c03238674efef350e3adf9105b027f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.2 MB (235208887 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6f3734930a545d6072138c1a8567515a6ce69d7205f78267384361c5d1ee807`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 02:42:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 30 Jul 2021 02:42:17 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 02:43:09 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 02:43:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e66d3db9fe78b7c673ff4b7d5f38ca6568491aa5ae24f0b3f8aab7d326ad1b26`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18b90899b4ac3355541a349f687e121ba8ab0443ef39e6f80b026790401926ba`  
		Last Modified: Fri, 30 Jul 2021 02:49:37 GMT  
		Size: 50.2 MB (50243577 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:96dc5cddcce692d317e02931320b2f04646c5263f6d9e76e83c65d08a58bb7df
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.0 MB (229002434 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:192f340855c3fceead21f6c750f538f8b99a9584b1e7b7a5ae51f6d173daa621`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 23 Jul 2021 16:50:28 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 23 Jul 2021 16:50:28 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 23 Jul 2021 16:51:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:51:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2ef623fc8191f7ee3dda7e2640d6d06c16ae53cbbb67364bb2c6b1d765a4bdac`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49e09bfa9e93df27d5a4c679722aa48b460d5f1fa04e28893f76e667bc904dd9`  
		Last Modified: Fri, 23 Jul 2021 17:07:44 GMT  
		Size: 50.2 MB (50244367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:afb5fea8ac523aad16eba30ddc262205b67c09b2e9b011cb78e3b1a62dc39ccf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **250.5 MB (250474528 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bfcc331ad595eadb1259b6ae4109bc7a6f758e095b1619e5dc0933df3fcbbae8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Jul 2021 03:15:33 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 03:15:50 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 03:15:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:50bf1f637fc949fb73f7c92d4a1fdb131a5e69facc9a232070c14582685eeadb`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93575aa3b050fc8ab64621caa709ee31fcfbf34ea7fbbda6ce57039046635695`  
		Last Modified: Fri, 30 Jul 2021 03:20:51 GMT  
		Size: 50.2 MB (50244960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:400aee9a8bf2c54450e82206fccfff4b1b56e77b5bd98f0947f31b46548b0f98
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.2 MB (268203410 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1d0bcd3243c4021ab216be9130e61921f71a742d228152323ec86d29a0ed8e1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 02:33:49 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 30 Jul 2021 02:33:49 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 30 Jul 2021 02:34:10 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:b84572ad22afc2e984c0d26bffa37246d7c1bbd01c0c5d69a261ec7eddbd9100`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19b68243b01d78373b155d25c8cf5248887fdcd7376df9c64c7169f8fd649a8f`  
		Last Modified: Fri, 30 Jul 2021 02:40:04 GMT  
		Size: 50.2 MB (50245133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.1-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:602f084a53bc8d3b1c98b99293a3e179618b8369c911194fe0a8f987177ba499
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **278.1 MB (278129691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1be7d072f79926375ff5ab988347b3ebf324d9927ffc0dffaa5e1606cc7e918`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 23 Jul 2021 16:49:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 23 Jul 2021 16:49:09 GMT
ENV MEDIAWIKI_VERSION=1.36.1
# Fri, 23 Jul 2021 16:52:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:52:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:20b92bc778b81886f662fdb394a2ce81451d4c5553920d99b3ebcf74594464df`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a51d9102797ab002f8b37a1e5423d496a6cafdef47f882a07f8cebb7945706ca`  
		Last Modified: Fri, 23 Jul 2021 17:51:21 GMT  
