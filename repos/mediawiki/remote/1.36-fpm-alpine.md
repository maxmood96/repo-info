...
```console
$ docker pull mediawiki@sha256:4ebcfec664c0b934b2cb6e7c2d4f6812ae699ce491cc7002e5b7f83f07f9ba17
```
...
```console
$ docker pull mediawiki@sha256:8e6838e1bd32cbfd437769c438f2cc2f47a4ed9a8a3aeb970063432a3abcda39
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.4 MB (157442887 bytes)**  
...
-	Layers:
	...
	-	`sha256:5252df513f5d635668e46c8d40f81c678d9b413a0c25b49918768e5d29e13a69`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a4bf1cc512868469f6ecc0ceebb92adc761d1e618dda010fb91f37a322c889f`  
		Last Modified: Tue, 30 Nov 2021 12:03:32 GMT  
		Size: 49.9 MB (49948492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:d7ceb7e43743625fd16edb41b99710f9176bba7d5b69ad4ebb661b0a6626ba93
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.0 MB (149024129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9373adc279b0dec3ef21f49f8e514f240078b1b7b6be59ba13224202be0d913f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 30 Nov 2021 16:08:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Tue, 30 Nov 2021 16:08:46 GMT
ENV MEDIAWIKI_VERSION=1.36.2
# Tue, 30 Nov 2021 16:09:26 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 30 Nov 2021 16:09:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fafd1207b3dd78895713e61baa60b821e4f1472cc4d1bdbadec1ea76746df3bc`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78992d0208586af08faed94149534d8b64376d8eec109d2389608b67205b47f0`  
		Last Modified: Tue, 30 Nov 2021 16:19:33 GMT  
		Size: 49.9 MB (49948706 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:5d665f168d656ccd2c723236dd1f5f14d5b473769cc5bafddfd78f90c7c1f778
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159185231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39b0ed9b8ea071d5c97d269a9dd7e14d4dc449fee23ab96cd4c25cb7ac5d01c6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 30 Nov 2021 10:16:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Tue, 30 Nov 2021 10:16:26 GMT
ENV MEDIAWIKI_VERSION=1.36.2
# Tue, 30 Nov 2021 10:16:52 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 30 Nov 2021 10:16:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cb22c0a55abc9ce1bb6a629ece4954ee1d51702b1770ce7cff1797a529124d88`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a452715b731ba54c42e702598f88aec9b44aef2ffbe6966589496fa7e970d90`  
		Last Modified: Tue, 30 Nov 2021 10:22:37 GMT  
		Size: 49.9 MB (49948572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
