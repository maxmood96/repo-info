...
```console
$ docker pull mediawiki@sha256:624c34e66661b764d716473ecc73eb3eb9d1dbb3f7cb5a04ec65c79bcc377db5
```
...
```console
$ docker pull mediawiki@sha256:70d22c16bb1b0ff3d13cf24f620ec8e447e33a71edbfc7e4648f621fe62828d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.0 MB (256990331 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d01a1e04a1487be41f5e4f8d7632907e336efd653f015d4ab5b527155c248c09`
...
-	Layers:
	...
	-	`sha256:0bcd3543986cf001dfc4170c9b729283fa0fda897b48176dff35a82c743421f7`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1990267aa948c6562640f2fa4ae035cc62e1cb72dffc71c41857b6e8ba76e32e`  
		Last Modified: Thu, 12 May 2022 03:40:58 GMT  
		Size: 50.4 MB (50424074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:488718fea1f12d25898ec65b4433f5899c3f4bb06b57c0ad9cd322f74a883988
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.3 MB (247349711 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4277d6eb29a6eb09c38f607846cd170152d62bfd1825f844b3d03a06df0b0c17`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 11 May 2022 22:54:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 11 May 2022 22:54:50 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Wed, 11 May 2022 22:55:10 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 11 May 2022 22:55:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7c25d154f9dabd60af5d23518d20d308034821481f341c156a347d2a02833454`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26c39b4238bfd9c1b6ab3e004c7af822c5f0900f0de3b95c2a973c4f57dcf629`  
		Last Modified: Wed, 11 May 2022 22:58:56 GMT  
		Size: 50.2 MB (50181004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:9bbaac76ab0e20931458a1a16b97e514f32f777bf679367c392c3e9d756c5081
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.7 MB (259717739 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:671cce9f3bebff1e3827f039102f2c6b15250582851472e870afd23cb14f8949`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 11 May 2022 17:30:59 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 11 May 2022 17:31:00 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Wed, 11 May 2022 17:31:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 11 May 2022 17:31:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6f2c8e079a66bea2fc19c1fb98fbfc1ca552ba62a8d4a729e26b0c85eb0335af`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9b91563e74d9599c7084a5d901c56fc46540f1448e8cec9ce7a3777f43121d8`  
		Last Modified: Wed, 11 May 2022 17:35:15 GMT  
		Size: 50.2 MB (50180914 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
