...
```console
$ docker pull mediawiki@sha256:c020440e09368aae12b3a4c89441f53ff256f209ee7452d05e14c4942b810a38
```
...
```console
$ docker pull mediawiki@sha256:996dd16efe204eaa7bfa1d104f549976d3becb7a3e96501fc9fdd6089f776e21
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.6 MB (261577374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07456dc71618c6510a09cf45bf0b32f90cd645f74b2cbb90741e8a8c01c8c356`
...
# Fri, 27 Aug 2021 05:45:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 27 Aug 2021 05:45:42 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 27 Aug 2021 05:46:01 GMT
...
-	Layers:
	...
	-	`sha256:6012825c6344794245468f46ad4c2c3347a3eef1e4a1e93311660c82348f6fbb`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd52655375483081824b7098c7e9d4207c3111565b91b3cd863d6207b114592d`  
		Last Modified: Fri, 27 Aug 2021 05:55:05 GMT  
		Size: 48.7 MB (48721708 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:0a9ad2501784c390da2d41a1a60c9a049e7e3d856ab5207e0263ef1e75b9de17
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.5 MB (234457324 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:216ad2a86a97f90ae0b34aea928671a1b939c34550bc0f3fbe829ffc7fbf567e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 04 Sep 2021 01:48:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 04 Sep 2021 01:48:04 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 04 Sep 2021 01:49:01 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Sep 2021 01:49:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:312380e896ba6c440d1db1ffe02fc2ca52531c2182bc2a15a1c28202698af254`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4a96c0e5fce088f4b97324d371c0d3fa6f9edc4895a0719f6e4bd6bd6d1de8b`  
		Last Modified: Sat, 04 Sep 2021 02:04:37 GMT  
		Size: 48.7 MB (48718897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:a420e3ed59ffa76a7c12d68775c626b133bb1a2650db99be05c3b6b1eb04843f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.1 MB (225081117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1320a5805625f974a604487cafcf46cfcd7ac95255357840a2e90011eb22433e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Aug 2021 10:27:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 27 Aug 2021 10:27:33 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 27 Aug 2021 10:28:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 27 Aug 2021 10:28:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1fb7eba3a4c392e3fae8cfa4e0b8100d4a9b0e8b6b54262633064987b8b87371`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33a27903992ebd24a82a3c40ea89957248e4f1b0103e98450ae0a9a1fc68e374`  
		Last Modified: Fri, 27 Aug 2021 10:49:29 GMT  
		Size: 48.7 MB (48719432 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0e11eb1ff1def1a60175bf81eb380188fc5a23728df8e42f6b060e25050e0139
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.2 MB (251249904 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac587479d1b66c05c36e74dec491df50780ba7e06c5e7b7c337c2b956c5c770b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 04 Sep 2021 00:57:19 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 04 Sep 2021 00:57:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Sep 2021 00:57:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fccc3f31501e1532bf3278cc07dba98dc199b46b040fa6ef2c7069a5b69f2d62`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4aea452292e6dc00d442f0c301cf5e2649d8fffb456ac434e5348bfe5f288ea0`  
		Last Modified: Sat, 04 Sep 2021 01:04:09 GMT  
		Size: 48.7 MB (48720858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:99a1a2bb8caeab47c1731f428ba2e3196030c0dffa5a2d328315b7b4be476a70
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.9 MB (263887313 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:076cc0573d0a87ecb729ea222f814a9f31349a2e40846d0a7fc28e8b0f9fbb98`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 04 Sep 2021 03:57:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 04 Sep 2021 03:57:36 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 04 Sep 2021 03:57:58 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Sep 2021 03:57:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6f333d2771e78064f47e144c7abb5f2ff716de0655a07e2ddf16ed537e40b7b4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a422f1e0e77d708b1b41e8a83785366044302d4fd1a8653ce466f544dd1f780c`  
		Last Modified: Sat, 04 Sep 2021 04:09:58 GMT  
		Size: 48.7 MB (48720943 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d7a1b5cec18c8de8b47ea956886d0ec54bbc53a7a2e0b06f212948bfb3ae9a5c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.2 MB (266198339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22b1f489f0771e6cffc8fdc69836cbbdf99509e11034c484a9c9dc742e7449bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Aug 2021 13:57:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 27 Aug 2021 13:57:49 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 27 Aug 2021 14:00:11 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 27 Aug 2021 14:00:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:07d95f8063dd1bf606d7cf2711ca9e5adaca89f72a2018a911387f183bedaa06`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d06c4d6b2d7122fbcf25adf76dd82d948c4debd6b537b16b06ef3dd4a565465`  
		Last Modified: Fri, 27 Aug 2021 14:39:48 GMT  
		Size: 48.7 MB (48726540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
