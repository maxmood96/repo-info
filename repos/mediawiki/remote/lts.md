...
```console
$ docker pull mediawiki@sha256:c61f20557305a964ef112d58d2b2a0a2891d00d72aba72cf38e66398671217ae
```
...
```console
$ docker pull mediawiki@sha256:28b2547648ca6d25c58dcae89541ba93dc675652fc543a77a2a2b422927398b8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.4 MB (226398163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7dc6b88b40623b8b90359336e180b74e4927030994cc81d99238198ac35010f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 17 Apr 2020 22:51:10 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 22:52:53 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install apcu-5.1.17; 	docker-php-ext-enable 		apcu 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 22:53:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 22:53:35 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 17 Apr 2020 22:53:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 17 Apr 2020 22:53:36 GMT
ENV MEDIAWIKI_BRANCH=REL1_31
# Fri, 17 Apr 2020 22:53:36 GMT
ENV MEDIAWIKI_VERSION=1.31.7
# Fri, 17 Apr 2020 22:53:37 GMT
ENV MEDIAWIKI_SHA512=7cd106bc775f1c3997786f0bb3e2412e30d0338133d6b9c6fb7af2550c519c57b0c274095747bbb5469a59e6511206953577b7b31bfc659b82f1583620482c1b
# Fri, 17 Apr 2020 22:53:55 GMT
RUN set -eux; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	echo "${MEDIAWIKI_SHA512} *mediawiki.tar.gz" | sha512sum -c -; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	rm mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images
```
...
-	Layers:
	...
	-	`sha256:9343692f61df4a99011294a28ddbbdf146ecb5e05197784d0e0c7ad9be414c43`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e6146bc6b04ba5e041a9a12e546881d9efb2d651a1bb4b975387018372614a`  
		Last Modified: Fri, 17 Apr 2020 22:54:40 GMT  
		Size: 60.8 MB (60755748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a03cb48b13882484b6d1e69a942c27af17769eb09f0847c3fef2845a8f03287c`  
		Last Modified: Fri, 17 Apr 2020 22:54:17 GMT  
		Size: 2.7 MB (2699778 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a50545b282208da11b91e35f5fed38de091fb1269754c3c82b6ab3b24824ee7`  
		Last Modified: Fri, 17 Apr 2020 22:54:47 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbed632060555e05a950dcdf1a01e8b704b14cd7ee9737047babd976d49050de`  
		Last Modified: Fri, 17 Apr 2020 22:54:47 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eee7dc34b2234a51b40a408be6fafb9827fec628efe44ebd18b6d44fc1628a30`  
		Last Modified: Fri, 17 Apr 2020 22:55:06 GMT  
		Size: 35.8 MB (35761844 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:c3bc36c4b4acaada930762f10db96b76d6ff722ad42597180d9619544d2906e6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.7 MB (259744258 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f35353836d5a628840b9e2a1f8b610efe575d1a02cab2a4b75f65820e37f251f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install apcu-5.1.17; 	docker-php-ext-enable 		apcu 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 18 Apr 2020 00:06:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 18 Apr 2020 00:06:32 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 18 Apr 2020 00:06:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Sat, 18 Apr 2020 00:06:32 GMT
ENV MEDIAWIKI_BRANCH=REL1_31
# Sat, 18 Apr 2020 00:06:33 GMT
ENV MEDIAWIKI_VERSION=1.31.7
# Sat, 18 Apr 2020 00:06:33 GMT
ENV MEDIAWIKI_SHA512=7cd106bc775f1c3997786f0bb3e2412e30d0338133d6b9c6fb7af2550c519c57b0c274095747bbb5469a59e6511206953577b7b31bfc659b82f1583620482c1b
# Sat, 18 Apr 2020 00:06:44 GMT
RUN set -eux; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	echo "${MEDIAWIKI_SHA512} *mediawiki.tar.gz" | sha512sum -c -; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	rm mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images
```
...
-	Layers:
	...
	-	`sha256:8ac528221c84d7e8e50683ba2c0d40643e8907086a6d95e2eed9830b31a4f6bf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:055c7bc783554a89f66e595046c7d6145d2aa95f850aaa7f3707339ee49948a2`  
		Last Modified: Sat, 18 Apr 2020 00:07:30 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc5e4dc7c9790ad0d59334da4f5058521ec2bedca5a5554817c27dcd2a85647f`  
		Last Modified: Sat, 18 Apr 2020 00:07:30 GMT  
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18d467fdb202c1bf2967285bfe4c8e01586402d98f9db162c5197c932062c8e4`  
		Last Modified: Sat, 18 Apr 2020 00:07:45 GMT  
		Size: 35.8 MB (35761552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:fcf11e86746da9beb329f086126f1a21572d526bbcb813c5da4db990e7a2d98a
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.9 MB (269946012 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc2e848e2f492df325ee0ab7427b04d2804dbe8ef0589e960edaac6f9b992ca4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install apcu-5.1.17; 	docker-php-ext-enable 		apcu 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 18 Apr 2020 06:18:19 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 18 Apr 2020 06:18:26 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 18 Apr 2020 06:18:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Sat, 18 Apr 2020 06:18:33 GMT
ENV MEDIAWIKI_BRANCH=REL1_31
# Sat, 18 Apr 2020 06:18:34 GMT
ENV MEDIAWIKI_VERSION=1.31.7
# Sat, 18 Apr 2020 06:18:36 GMT
ENV MEDIAWIKI_SHA512=7cd106bc775f1c3997786f0bb3e2412e30d0338133d6b9c6fb7af2550c519c57b0c274095747bbb5469a59e6511206953577b7b31bfc659b82f1583620482c1b
# Sat, 18 Apr 2020 06:18:54 GMT
RUN set -eux; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	echo "${MEDIAWIKI_SHA512} *mediawiki.tar.gz" | sha512sum -c -; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	rm mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images
```
...
-	Layers:
	...
	-	`sha256:51913849902d881eb5f9652cf0a4259d980164c0f81f4844c4a0834975941143`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0764de11b8b423e7517eab9f410a25eb1953640b4ce8a5f63ca85ef1e1eee158`  
		Last Modified: Sat, 18 Apr 2020 06:20:21 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd8a5d213702f7b8f9e5b26d3d4988e346a27fb4b8149834fc746c0de1040785`  
		Last Modified: Sat, 18 Apr 2020 06:20:21 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0049a373cfc026f835e54b90a91bf13bc9a73276a3b73a3abe9320777167e12`  
		Last Modified: Sat, 18 Apr 2020 06:20:32 GMT  
		Size: 35.8 MB (35762129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
