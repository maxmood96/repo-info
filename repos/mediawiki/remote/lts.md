...
```console
$ docker pull mediawiki@sha256:e497aa9a4558dd7bd7620052b3eed8370fbce6bc1cdc3cfc34b70d0f63f50df5
```
...
```console
$ docker pull mediawiki@sha256:ea3660ad28d3055934ca42501ee4b387a17553d9e2519b6a59fd606615874eeb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.6 MB (291572425 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be561a0aa184440177e2e70d4c47bc42f8b3069e24688840ccbeb92650936564`
...
# Thu, 01 Feb 2024 14:58:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 14:58:29 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 03 Feb 2024 18:09:20 GMT
...
-	Layers:
	...
	-	`sha256:e24ef8d1809c539e924dec9ee3933db759b5a91a47bb1979e8b5fe92792a173c`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76c99181f40fabd7b43a6bb4d1d2915f3b741699990d20694538243031b6520`  
		Last Modified: Sat, 03 Feb 2024 18:10:05 GMT  
		Size: 58.8 MB (58787052 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:e826ae49d90db4ecb9d707811fe1001800b480e2e562bfecf51dda419118e5f4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.6 MB (247649844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a65b5054866fb5ddab178356fb8efe2177a29a387c3788fbf29bfc519b2a7ba0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 01 Feb 2024 08:59:45 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 09:00:20 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 09:00:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7f54b4f20606363eb3ecf854133b2971d8f800fe60c80970bf75ffebb3949159`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b816fd629541cfdbaa1160fe7fd95c99bf7493b24441847a35acbf8f40de1fd`  
		Last Modified: Thu, 01 Feb 2024 09:04:37 GMT  
		Size: 58.8 MB (58782325 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:598f4ee4415aba3a185b3ffccc167d68b31b98fc6a62688837b5dfe2f4e8ed48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **282.7 MB (282749747 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d3b45b6b3c693fdde12effa7939e9dc16dae0620ba4d8cc341a669c03b426a37`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 12:45:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 12:45:24 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 12:45:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 12:45:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7f31ff6de2d9710987f001854223d42ecc2fa8c563113af309d60e854e0eb6ab`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48e90f4f97ef63b275b080f47afe39ba8b012e1bb79cc0e661c2a38b6ef6eff5`  
		Last Modified: Thu, 01 Feb 2024 12:48:25 GMT  
		Size: 58.8 MB (58786380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:1d2428b52e1a69817485c8c4ec5c8d18a953a0db46aa3c0fdfb6f27ed7083f74
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.1 MB (292058364 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afb2adfd28bfbf3a2b45a6c4ef2737ea50fbec8b93a58795e8c53f9ab73b6981`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 12:29:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 12:29:02 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 12:29:27 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 12:29:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9aa45a430a5eb8cd56d14bf27271da43e417d60127f3135fde0b6d1945fd2b8f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebc5087b29962ef2c51b2869899f965557bcdf1923bf2931e3b541b5b26116c4`  
		Last Modified: Thu, 01 Feb 2024 12:33:24 GMT  
		Size: 58.8 MB (58785294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:e9dcc1884ab44a93e2ee7d9ced926386d1097f6867d5b6432516ebafbed38444
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.0 MB (299996892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e7de885b68758b11acaba4a77b7af3f3e1bcba6664adfa309dea8d04f4d4d56`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 09:20:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 09:20:58 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 09:21:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 09:21:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:45b37de1530aecff70b5673bf38f198ffef9c52f6c95b05b73b9b7a76e88c4df`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b82c9b22e2a284ed6c138dee18b12b3577c5dd2b024945a88f465b4d647ea118`  
		Last Modified: Thu, 01 Feb 2024 09:25:36 GMT  
		Size: 58.8 MB (58788348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
