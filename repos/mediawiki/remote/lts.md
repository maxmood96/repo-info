...
```console
$ docker pull mediawiki@sha256:38e02f8779faf69336b5cd0cd13862257f09e057977ae517d306051de289dcaa
```
...
```console
$ docker pull mediawiki@sha256:b1ad16dfca87e87216c71b23fb4cdecf6a9cbd9f12bc7365c71e1598f3fc403f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.0 MB (258975777 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:168ad9077b3cd654d1265669e3126640ab900965ebdf2786ef9dbe2374af7004`
...
# Thu, 18 Nov 2021 23:10:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 18 Nov 2021 23:10:55 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Thu, 18 Nov 2021 23:11:19 GMT
...
-	Layers:
	...
	-	`sha256:235a59087d17e83595a5805b34f5ce13030b541a8831c2fac0fda608588e42c6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0bc0de19b00eebf11695325f1c23df80f19c53e48c157529c112e4539d27a25`  
		Last Modified: Thu, 18 Nov 2021 23:19:56 GMT  
		Size: 48.7 MB (48727308 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:85230a146b013e11af0f3ee3aaa4de24232be08f2edbdd89f52dab0d2f8b71b1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **233.5 MB (233503802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9be20b02fa29378957f63030ec31139d91561d403683b82506245c1af296986d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 19 Nov 2021 23:55:43 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Fri, 19 Nov 2021 23:56:36 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 19 Nov 2021 23:56:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e6d8d2e82fd66433ee3bf2b286dcda96943ce016bebbf6947d497e97e00fd5b6`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53e184ad225d023e6d3735e82cedacfdfa04fd4db31f67653cf20107ebfba82d`  
		Last Modified: Sat, 20 Nov 2021 00:11:32 GMT  
		Size: 48.7 MB (48722468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:eae26b76ecf6275f6481fe21edcb671b2500144b0102b17753f8820dda69cd53
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.2 MB (249234362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4c0502221b9b6937a4bf2b7633fcf6ab11fbea1a0baf53d5e3874cc11ebbfbe`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 17 Nov 2021 18:30:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 17 Nov 2021 18:30:25 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Wed, 17 Nov 2021 18:30:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Nov 2021 18:30:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e6f73b65437a3759c6e757803fa166f8ffcad6d1642c1d1950f29c94445caa8a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:982ef3cc1c7cedd18b196aef65ca19e4c49b571f16ac10fe4666b1b3ddf3d4ec`  
		Last Modified: Wed, 17 Nov 2021 18:37:39 GMT  
		Size: 48.5 MB (48484492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:a881fd859f7ee032bfc4961df95e5bd24c0c01dfd65f65368c53aafcedbeb3c4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.9 MB (262859647 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fa7a8a5b09798e65ef4a4c91d871563da8983800d5824256b084e4cd5f99800`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 18 Nov 2021 00:11:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 18 Nov 2021 00:11:33 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Thu, 18 Nov 2021 00:12:08 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 00:12:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:814cec884484461c4c83e093560763ff8904e0a1031735b1ee5b92c923a85d36`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a49e7a4e55b5ef44c44095f34904ca28afb78fd69407a0e29fbd5b2cd047ed5`  
		Last Modified: Thu, 18 Nov 2021 00:20:37 GMT  
		Size: 48.7 MB (48724667 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d19a541e26b41dd862d20487b381ae5399428cd151d664a11e1cafa344ef274c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.5 MB (263473643 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:33f82acd6445d4b286eb56e77b87487c118d9ca1dcbe872033da2536482a0015`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 18 Nov 2021 15:52:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 18 Nov 2021 15:52:48 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Thu, 18 Nov 2021 15:54:17 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 15:54:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:daa34c5e9854fc82c82e116967cb3f1118b94ea060a8bc5f7213b26ded78f048`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f87acebba1a38eddb054a81857d6e7c98032ab0a55deda9231435ecdecd88f4`  
		Last Modified: Thu, 18 Nov 2021 16:15:31 GMT  
		Size: 48.7 MB (48728728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
