...
```console
$ docker pull mediawiki@sha256:a9687eba8190e5a7a1686fc3d130ee3c9097a6ba50639145ed1edfbcd8cf1ab8
```
...
```console
$ docker pull mediawiki@sha256:0bcc3a930c99f3f466de1306ac5e48447ac13e053092d9418e5e07cfdad1c606
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.6 MB (257554365 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f1c23f0d03dcb15ae8d0958fefaa06c86ea88c6edee13d25cccdd5c60674739`
...
# Wed, 26 Oct 2022 18:21:12 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 18:22:05 GMT
...
-	Layers:
	...
	-	`sha256:3b0ba5bc20a5b391808fd45c3785a3994a1c69e681d3c13cafb91c63ade80bdb`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91ed2488b0edc93239a1295729d523b33ae476f11592669dd38f2ec010ca373a`  
		Last Modified: Wed, 26 Oct 2022 18:26:43 GMT  
		Size: 41.7 MB (41660568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb94c7162ec482be54d7e1f1ffcf1d4bc3d372f64699e8d5eaba972123abfaf1`  
		Last Modified: Wed, 26 Oct 2022 18:26:37 GMT  
		Size: 1.7 MB (1716755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:403be1de89ee3a17f613feec946a48aaf167ef92b20c12ee09ee87bff3e88401`  
		Last Modified: Wed, 26 Oct 2022 18:26:34 GMT  
		Size: 586.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:220cf743f6c48ad0d7d89b1a82e9ca6a280197c54f4b17fcbc2d5c0a29a6fb02`  
		Last Modified: Wed, 26 Oct 2022 18:26:34 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5ad7d7c3f0b1aae25649ff7d65df9c05b97775eb2543ff8cad3cf9a666d6601`  
		Last Modified: Wed, 26 Oct 2022 18:26:34 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63dc783c8b5f9a5bef3da1d6332275e06956ea5bab9fad062f23e6e389e9ee2a`  
		Last Modified: Wed, 26 Oct 2022 18:26:34 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0be873db5ff0c741571e16b2addd94ff680630b402640d4c0b49d877d264b8c`  
		Last Modified: Wed, 26 Oct 2022 18:28:38 GMT  
		Size: 50.9 MB (50910713 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:fc44848128dad5cd9fcd3477f61acee515c0e75ac50b9ecb6441dcf36591cb72
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.5 MB (232450408 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc13d3d25b6a7dd8c0fe1dd604ace4032ac1f03d4299d4ae28ad36986bc8bcb3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 18:27:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Nov 2022 18:27:53 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Thu, 03 Nov 2022 18:28:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Nov 2022 18:28:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0a8d61e0e190fb08f5166dedc36e4af9e2174fd39a3f8a3035b72771bd5ea1af`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7952d519804d0ea8bbc6e9feacae497fff3480c04c7deb6e56f569b3896e0401`  
		Last Modified: Thu, 03 Nov 2022 18:32:39 GMT  
		Size: 50.9 MB (50906060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:6a24ac1df510cceeacd178a627b041c8aa0a0922fd4f9187a4037c8e8ecfe800
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.8 MB (221822013 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b1fcd540d8c88c6f8f627285de1e65aa19f8fcc6b40ead70c36821861f6dd28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 19:03:04 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 19:03:05 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Wed, 26 Oct 2022 19:03:05 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Wed, 26 Oct 2022 19:03:06 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 26 Oct 2022 19:03:06 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 19:08:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 26 Oct 2022 19:08:55 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Wed, 26 Oct 2022 19:09:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 19:09:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cbe2f24b8aa3f75305de0c5db20ac32741ea3f1299a5be1cbe34a8fae4a3f4a4`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee0892b454044e1071bc363ec27db0814eac9d884e669bd81a48bf98680844a4`  
		Last Modified: Wed, 26 Oct 2022 19:11:54 GMT  
		Size: 35.6 MB (35555374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2081077e07cec143340290c6dd6d5b9f58aabebaa82c5181975dc14eeff6b28a`  
		Last Modified: Wed, 26 Oct 2022 19:11:48 GMT  
		Size: 1.6 MB (1605217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4585e9cb2b5b4f67636b2d71eceeaa57ce6445b9e32db69b03c07744632618e0`  
		Last Modified: Wed, 26 Oct 2022 19:11:45 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfe65f76390088d1bdc5f139d4594768e93a8e3df5cfeb84b48896457883cfbb`  
		Last Modified: Wed, 26 Oct 2022 19:11:45 GMT  
		Size: 931.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e4c7f8ac773da55b27ff298d8aba89ccb1bf931faef781e4f3ae06b75ac994b`  
		Last Modified: Wed, 26 Oct 2022 19:11:45 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59184ae905151f3c92e1162001f8f69b2ce7760dce2c971fab19f1e80ccaab1c`  
		Last Modified: Wed, 26 Oct 2022 19:11:45 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5c7df45291fb61a83ee66b730eb6f7af9ac6c86d203b364a89226b77eb6b1a7`  
		Last Modified: Wed, 26 Oct 2022 19:15:32 GMT  
		Size: 50.9 MB (50908026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:ef792a74c8ba8e42949d336d6b09c9aaf6c27fe046682d83a6fcc94600e645f0
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.1 MB (249106873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b06f136b716cc06481cad4f98d0d182f5e18d2c8c08b98ed672cdc73e9bdba1b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Nov 2022 18:18:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Nov 2022 18:18:04 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Thu, 03 Nov 2022 18:18:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Nov 2022 18:18:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:389bc9d6106aa34f26d67c43b2897807457aab9dfd101061950e7d6f85f9e0e5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d329fbd8eeee55ee588afb6dc8c46d3e61b61b81d98d917a3c93312028267623`  
		Last Modified: Thu, 03 Nov 2022 18:22:19 GMT  
		Size: 50.9 MB (50910197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
