...
```console
$ docker pull mediawiki@sha256:d1b21905d532933b32ee5d1c37f83a605aaff755d418911ce77f7140cd2dcba6
```
...
```console
$ docker pull mediawiki@sha256:446549e782b0a6a3a5e2fe75d052dbbb5f671fc1b4a4fcd3b300417d5fcf7dc9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.8 MB (262800599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59cab33647627acc0386a271c72ce9990e1b9111020788dbcdffb9ea8a9a3454`
...
# Fri, 30 Jul 2021 03:44:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Jul 2021 03:44:50 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 30 Jul 2021 03:45:09 GMT
...
-	Layers:
	...
	-	`sha256:f58f14bc30e8c99301c4b8c7bede2b87bceeceea752e1b350075a8a42c3312f1`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6345bf10fbf2ec7ec9337825eab3e021bac77cfa0e888c8298cb32350c765926`  
		Last Modified: Fri, 30 Jul 2021 03:48:15 GMT  
		Size: 48.8 MB (48754802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:f46accf4088370464fd05bc9e4a124e7eadf36b4cbc75ed883013b33d558d5c4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.4 MB (237365118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae171de3d4c2afd9e8bc1390cbb28d393d13e97bd863638d8d4276afc7a42604`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 02:43:23 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Jul 2021 02:43:23 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 30 Jul 2021 02:44:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 02:44:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c91820174751bd2c019c663ecad9a625d3f2e1b598d2701a0d5046fe38bb5e79`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01a85de970448eb7b7886fe93b6f4274bf046c2babda0a3f493e7d12a990acd`  
		Last Modified: Fri, 30 Jul 2021 02:50:40 GMT  
		Size: 48.8 MB (48753346 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:d84aae741801effa6116ff1cd3ab4dfff3f0f663309465c7bcfdb4559db46e37
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.9 MB (230925029 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ebf4cc17292c4e4415d36896fca06d8f47e98568ecdb092ce4d92b3357c5636`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 23 Jul 2021 16:51:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 23 Jul 2021 16:51:45 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 23 Jul 2021 16:52:33 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:52:35 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:80a474753e75cfd59c06317e5a04f18b41cbd5296d10d40b7e975c65ef29003f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a3c48e5f558623df4431df530c8e3f3727a1413a422f4567e05da1bc8f86163`  
		Last Modified: Fri, 23 Jul 2021 17:08:58 GMT  
		Size: 48.8 MB (48753199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:6150bb02f93711fa73aa0514b63b1f6c29928276791d55b410632fab62f0732e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.7 MB (252726219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:196a25b145838b0f3670a0626dfc9a3fb6d13062dfe44022ccc89f6592c711d6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 03:17:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Jul 2021 03:17:35 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 30 Jul 2021 03:17:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 03:17:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5b227daba22b1c26d243dd57693176e02f2c0c8d312381d4393bf92b06775cb7`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3f32ee4f116e7dd94588a4fda1d05d76072114959493e3158973d57319e6ac5`  
		Last Modified: Fri, 30 Jul 2021 03:21:45 GMT  
		Size: 48.8 MB (48753364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:41fc3e96c0b968f5580874f8e928a6a9ed3752d57860aa94826704c2ba27cc2f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **270.7 MB (270710608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73e37cbbf96b8a2ae76266cad3a40a2ee2870703a0a114519a6a95725411d7ab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Jul 2021 02:36:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Jul 2021 02:36:17 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 30 Jul 2021 02:36:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Jul 2021 02:36:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2c52ab789015e63aa7ac4142770757e853e491b29d15981ddb8cf95c8d124d80`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed22a3841c66544fce9d0719b0e854a4f72a9c1c56a8553dd732292aff1f7bca`  
		Last Modified: Fri, 30 Jul 2021 02:41:08 GMT  
		Size: 48.8 MB (48753335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:329d4945179a6c6f939f47572d362e7fe8e73c453e4c47b485a675a6b9d84caf
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **280.9 MB (280918193 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b69365a80ca8ec9371d4d60d5cefe76dee0a206909d4bfdede991b11c765e75f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 23 Jul 2021 16:30:03 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:31:54 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:32:10 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Fri, 23 Jul 2021 16:32:24 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Fri, 23 Jul 2021 16:32:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 23 Jul 2021 16:32:45 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 23 Jul 2021 16:59:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 23 Jul 2021 16:59:34 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 23 Jul 2021 17:03:54 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 17:04:03 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0d1b54cbfb1880e2f5804a4834750f89426adbbedafc27c6f833882884431c27`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7adb7d3641140135d52ce648859ab9e97e9e166a82d13270399d1d2293805e3`  
		Last Modified: Fri, 23 Jul 2021 17:47:55 GMT  
		Size: 71.3 MB (71301966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3043d27498de0c591e740fc4ff76442bb505d979467e43b981b358ec0c74a814`  
		Last Modified: Fri, 23 Jul 2021 17:46:40 GMT  
		Size: 2.6 MB (2625364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a91eb767a66f088a598434bc6056ed54b03b0fdff728981cacf64d8f10f7dd8`  
		Last Modified: Fri, 23 Jul 2021 17:46:34 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5edbe3d60eb3578426f1c3e29b13c777a59f67375b6bd5428f87e1987f7fcb61`  
		Last Modified: Fri, 23 Jul 2021 17:46:35 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dec18e9939c8680db3b76ae8dd358dd28494e5f0d1ae637ebffceddc28de4c89`  
		Last Modified: Fri, 23 Jul 2021 17:46:34 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82198507836d611addf7c4f64134583b75e5f9e76a7da5ee6e61ae98a19e3af5`  
		Last Modified: Fri, 23 Jul 2021 17:46:35 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66ea7ce42fafb1ae1b29600eefda7bdf7b48804e9b385e4b4846d108aea37329`  
		Last Modified: Fri, 23 Jul 2021 17:55:29 GMT  
		Size: 48.8 MB (48753572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
