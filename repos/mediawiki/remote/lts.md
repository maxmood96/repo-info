...
```console
$ docker pull mediawiki@sha256:57a995ddd79e4103f416da7d7285e684dc64a6ed8281ac0ebee266dec2471863
```
...
```console
$ docker pull mediawiki@sha256:c013c8bd06645b3a860ea777f0ee31e8c6a202455ca50fb6cf7063f81070b7f0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **294.5 MB (294450127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45c8f58ec35d869b803e5f12a70a313a36bf31c4d03e494427dc83c66fc7c0b5`
...
# Tue, 09 Apr 2024 03:02:22 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 09 Apr 2024 03:02:22 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Tue, 09 Apr 2024 03:02:41 GMT
...
-	Layers:
	...
	-	`sha256:c7026e844898db664aba998032cb04f2f8fb92e6220d1b116c46a78057b1d396`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7425c3ca6c7feb73ab78e1783014a120d00449edeb8baef42ccaa6b39bb22c`  
		Last Modified: Tue, 09 Apr 2024 03:05:37 GMT  
		Size: 59.1 MB (59091076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:6ba9800562cc02d65fd36662c227d57d52e28acf64bfbf964be39d080371ed11
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **262.8 MB (262844176 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2ef73310f227c2ffe0115dece1d762c6f82099b80c5d7676fe80cf4710a78ac3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 09 Apr 2024 03:03:49 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Tue, 09 Apr 2024 03:04:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:04:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:02ea9b4c51190ac4dfaa976ce5a2a59ae2e412bbe512f061c1dff34071901190`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cce1884bf5e5f8bb32716ffbc71d142fe537140e5d21a4ece8952c574c7ba75`  
		Last Modified: Tue, 09 Apr 2024 03:08:27 GMT  
		Size: 59.1 MB (59088479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:29337be752b3ec68c09d511da6832a6b5e226b02575f0cdc0206d85e0ceeca48
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **286.0 MB (286037821 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8caf0248c1307cd459f4839a9f9b58a7cb42c7238ecbe4efbe98ac4c04c8bdc1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Apr 2024 02:18:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 09 Apr 2024 02:18:45 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Tue, 09 Apr 2024 02:19:01 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 02:19:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bdd8aa0bbdac126488395e698d72262b446ff43cfe163ebcd1e1e174796debef`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3fdc750e54d6c2e281b2f4994552933281993c128b7948b70d727b41f584232`  
		Last Modified: Tue, 09 Apr 2024 02:21:42 GMT  
		Size: 59.1 MB (59090748 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:1c41eae4e24dd304eaa9db5f5c18f73d33b6ed73dbe4d79f51b170ff0d774dca
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.5 MB (303457499 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:492a9a2a445b3998eb0250d16e1f63772bdea5aec290500ae6ef572a8d26a132`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Apr 2024 02:19:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 09 Apr 2024 02:19:20 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Tue, 09 Apr 2024 02:19:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 02:19:57 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:587e648dc384fbfb44231165556e687f30e6348b84c99719a0d2f1671364b1e9`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39b541543fee0a48423c0d1ceccd9e8294ec6809469c5ea3e794792cc90b980f`  
		Last Modified: Tue, 09 Apr 2024 02:23:26 GMT  
		Size: 59.1 MB (59091131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
