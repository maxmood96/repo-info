...
```console
$ docker pull mediawiki@sha256:6ab8c164dfe7bc6920b6c588c6686e9627367b223aa47528443e10f73acbcf94
```
...
```console
$ docker pull mediawiki@sha256:8ca865bb89472fbe0588ffb977253e967707a368c9eb6cc8a552d043ade09b2d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.5 MB (257548198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e597cacfcfef438168cf9aea883f1d689adade171f6272c45e015223365d2273`
...
# Tue, 15 Nov 2022 07:33:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 15 Nov 2022 07:33:19 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Tue, 15 Nov 2022 07:33:38 GMT
...
-	Layers:
	...
	-	`sha256:6c2d767e85f2bc8fa579b992eecb4b42bab64fe23d736d1b118b254a803e2343`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ae170c302c5a775032d328deb29904c484ee15111b67cfef57c0ee44b9f264`  
		Last Modified: Tue, 15 Nov 2022 07:36:34 GMT  
		Size: 50.9 MB (50910832 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:c1b356e98b4d379c4175c38aadc982b39914dbd0d461d441d921739b635ac60f
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.3 MB (232327884 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e9a92460b5189abe3adaf9ebce0fbd50894bc95970ef37b37d1c3f9cfda7ca2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:86a08f88109d41faa67c9b11c462be254b029714ba48269837afe50609b81168`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a69748b9068b32e919986b8750e6bbdff3ab9072c2ba88e049c8cc51492fc597`  
		Last Modified: Tue, 15 Nov 2022 12:25:34 GMT  
		Size: 50.9 MB (50907934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:f9675312c5c1ca7264ef10f0c96cfbf071846be9d2db7bd6bf5ebe3578536556
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.8 MB (221820706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:150595997e53b9350ae8ab7ea4ac3e960403964034aca2de9deacee74a5cdd7e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 15 Nov 2022 10:34:23 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 15 Nov 2022 10:34:23 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Tue, 15 Nov 2022 10:34:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 15 Nov 2022 10:34:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cf3b1daa4e697ab9818c30b7f5a952d47a218a45d79ffbc8a9350d98113f9a55`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0e71180297db3f6a53fbae7cbb6d521650bbd2d85a649f33636e7d7cddc6672`  
		Last Modified: Tue, 15 Nov 2022 10:39:17 GMT  
		Size: 50.9 MB (50908245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:7f8f42bdee097d3a68a8d850a2b7da2a603e6d7874490e709ae6877b3d476353
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.7 MB (261721705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:185f84cc38b71dac89a29d5e1c232fd691230d07d6ca64dd4d785620fa0bb81a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 15 Nov 2022 07:45:23 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 15 Nov 2022 07:45:23 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Tue, 15 Nov 2022 07:45:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:bbe4da9692997ad57c5702ed37879afdf4b9a273e079cbfc665bc0c6d59ba85e`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31d7921af69f230d83c707b41d17e8844e5f7c29abf4c8e3ad24bf3d5bbb66a0`  
		Last Modified: Tue, 15 Nov 2022 07:51:06 GMT  
		Size: 50.9 MB (50911028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
