...
```console
$ docker pull mediawiki@sha256:8cb7fb9b4a9b8a99fb0bfc0805d8f5ead3a2a77ba107ddf12de5d4a59ed98407
```
...
```console
$ docker pull mediawiki@sha256:18aea75a6a4274aa185d78fdcd7f0b0fcba28bf3fa1eb6d9515af52ee938d3b9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291855949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3fc05db18aae2365386365090aec3d2d9b5b2aa0f8024eb93abd33ad397a674e`
...
-	Layers:
	...
	-	`sha256:1b7ee182a2be2bcdb80641d7ec79ca9a1c572b958d5ce765c125daa688acd5a2`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9be3374cd982d044f842df4cdd301ee58d71eebcc6a898dfefdbacd589b650e`  
		Last Modified: Thu, 06 Jun 2024 05:50:43 GMT  
		Size: 59.1 MB (59091441 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:13f8f24573bae094967b7e6ad65def138ce637922378667d6c202f1f096604ef
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.9 MB (247913447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36112882386a4a97d580f8ba5bce0412cead522d4b30c634b784474bd04ecad2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:21:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:21:58 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:22:20 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:18feba00f0e646ff8631e220875afb7deee1db1d4e2e4030dfa1fb63230efc27`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:748c0d5ec73c931a641ee1a73ae1b7769d0f41ef46744d6e46e4801a045c4f79`  
		Last Modified: Thu, 06 Jun 2024 06:27:47 GMT  
		Size: 59.1 MB (59090267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0e5f531ff2e4dfbcec82537975bceefaf34ed1dd6d2cb4803eeb9cdee1d0ce74
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **283.0 MB (283011012 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d76ad99cc89b8d414050dcfcf66d9a61bce92934ec754a57337af06b3c13a7c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:03:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:03:02 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:03:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:03:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:13f4ef9485696a95b91b9434b5f8815ccaf41909a4cd7cca0fff3299981fbe6e`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9b9ab67e816e96824759af3551cec69e6c6d563a7e1f7a04ff3cc6467f32c1b`  
		Last Modified: Thu, 06 Jun 2024 06:06:58 GMT  
		Size: 59.1 MB (59090829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:236944d9f0281185d61dfb9c61b35ecd70e120e53f2a228396e6775b9efcbc3f
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300255652 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2609b2cb8b3b0485ff3e00eb0ca542738c0703f52ccb1aa8bdfabaf19286848`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:31:51 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:31:51 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:32:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:32:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5392c9e6c5c0a79de2d3546d0ba09b29f7e915068d4a83646136163b0a8fd83d`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8418a8a3e14aaaa5d9f75547c70a2325fca06dc82367dd23ba4f798f0f9a71ea`  
		Last Modified: Thu, 06 Jun 2024 06:39:16 GMT  
		Size: 59.1 MB (59091483 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
