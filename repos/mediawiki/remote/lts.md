...
```console
$ docker pull mediawiki@sha256:9f47001da85ee9735bfb9e39645cbf61da13c62122235e1309f948227b7713ff
```
...
```console
$ docker pull mediawiki@sha256:cb8b812295435cfd9ed105d57528fa878c2f82432b53cf6fe84bb66cbe290820
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.4 MB (257408387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d0d591469550c236109220176275ea8a2517a2936098868887e5083d0507ede1`
...
# Thu, 29 Sep 2022 16:40:09 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 16:41:00 GMT
...
-	Layers:
	...
	-	`sha256:b967f35769dbb17a8bd3ac31ec4cbfc419ce5aad3468e22cbe51ad7a5ee04d31`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c3b52404345af406bb99080193ab1abf37ba6d5035a0a65970ad1bad78fe2a0`  
		Last Modified: Thu, 29 Sep 2022 16:47:30 GMT  
		Size: 41.7 MB (41659176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:081744f4022adbf3b7d47f1be8f1f3ac5735af10bc56ffc7b0661709c21e4612`  
		Last Modified: Thu, 29 Sep 2022 16:47:23 GMT  
		Size: 1.7 MB (1716198 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81d31c1c72dae1aa0b974808ab17316f2dabb8160fb88c7f50dfb1d3993a45e6`  
		Last Modified: Thu, 29 Sep 2022 16:47:21 GMT  
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:044c1ded8c8c8eb231cdbe0e5faf8f0189bfac57a6063b3c63ec2d73f7c368c1`  
		Last Modified: Thu, 29 Sep 2022 16:47:21 GMT  
		Size: 931.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d9c79cb60618a98fe72e3c3450743467aba75ce473d48b7d051c78c6daf05e5`  
		Last Modified: Thu, 29 Sep 2022 16:47:21 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:121ab8ea22374a250803ee961c6429cc1aa8e0fa6c2e0fd3d973cadd26128760`  
		Last Modified: Thu, 29 Sep 2022 16:47:21 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3e70803a77da83b57dbd6364572d7f100c113948af7ad4ce68cd1165e72d037`  
		Last Modified: Thu, 29 Sep 2022 16:50:09 GMT  
		Size: 50.6 MB (50646696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:92e141db6d4bbee201d6ee1cf62c6ae7256defa13ab22f3d33b9aa201362217e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.2 MB (232171570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4a722c6f81a5dd2fa11f50fd6abb574332edc9a3177d55977f554080fee15d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 15:05:36 GMT
CMD ["apache2-foreground"]
# Thu, 29 Sep 2022 16:31:37 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 16:34:22 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 16:34:23 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 29 Sep 2022 16:34:24 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 29 Sep 2022 16:34:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 16:34:25 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 16:40:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 16:40:54 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 16:41:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 16:41:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:51e9f9f5805bf90cac9829615719162894c7613c078168c8719bf97180a67348`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a55857629286dcd637a9684341a5edc03a4510a74ca68d065a938d369e8dd86`  
		Last Modified: Thu, 29 Sep 2022 16:44:19 GMT  
		Size: 38.3 MB (38261194 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abfda2263906fb6e96c5c834432b533d926e160597794cbf1750bcccbec5759c`  
		Last Modified: Thu, 29 Sep 2022 16:43:59 GMT  
		Size: 1.7 MB (1659516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4ddfc09aeff1939534fe0716ed3f0b175b294683b49e2d74b19d2a6b3683a5a`  
		Last Modified: Thu, 29 Sep 2022 16:43:55 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6afcb0ba8d9d3e711bb655333b94bb53eb07c4bbe3241b5738c434cc11c73483`  
		Last Modified: Thu, 29 Sep 2022 16:43:55 GMT  
		Size: 936.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ee05d377c753fa208bfb8973ca8dd460cfe912bbe816a516dd076df3e76c190`  
		Last Modified: Thu, 29 Sep 2022 16:43:55 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c18d0db26f6558c11fc8f9413e6fae837ec668cf32cb8546f409b1293c8c69d2`  
		Last Modified: Thu, 29 Sep 2022 16:43:55 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a948148d57561d5be5c37ad1a5bcae7cc550e92b9916e682467338dc89209d03`  
		Last Modified: Thu, 29 Sep 2022 16:48:23 GMT  
		Size: 50.6 MB (50646837 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:58e57406b94c1963cd82e4ae8dec7bbbea9fc5fae5c01f3600b72e477d56c765
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.5 MB (221544037 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7121ddfc12ce51f9dd964ff7dd4a6496086934e160cc9f6e3c790a8f964cfcbc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 15 Sep 2022 01:34:26 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 15 Sep 2022 01:35:34 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 15 Sep 2022 01:35:34 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 15 Sep 2022 01:35:35 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 15 Sep 2022 01:35:35 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 15 Sep 2022 01:35:36 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Sep 2022 01:39:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 15 Sep 2022 01:39:05 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 15 Sep 2022 01:39:26 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 15 Sep 2022 01:39:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:10ca2e4348726cdfa695bd4b157c7dff79aa87fc69f47dcd4c53d8c16a9e6013`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:113e443faf1365ac002f83b2c1eb6a741387528cd8c12f451cf933e3b50d0a7d`  
		Last Modified: Thu, 15 Sep 2022 01:41:29 GMT  
		Size: 35.6 MB (35554087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d61709c4ad926e0e45d9cc2bc9969e5fe0db5c492521f9bb3c043f669fa7a7e`  
		Last Modified: Thu, 15 Sep 2022 01:41:22 GMT  
		Size: 1.6 MB (1604739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76759f6dac7407942b01f29a067cc19bd38d12373909784809b463114432c8dc`  
		Last Modified: Thu, 15 Sep 2022 01:41:19 GMT  
		Size: 571.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8515929f4b896217a7b7eedf8ee73f263d467cd994df3b5821a4dcc57e81aad7`  
		Last Modified: Thu, 15 Sep 2022 01:41:19 GMT  
		Size: 930.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbd2301c40c08975b4696a746a4ecabb48c6161a7d7dda2a4de2759678b523c0`  
		Last Modified: Thu, 15 Sep 2022 01:41:19 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff99829fd09bf8085a3ed68bf30642dd81152cdf67a87ca87476ed8b5e83f1d5`  
		Last Modified: Thu, 15 Sep 2022 01:41:19 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acc92815a33012b083fbad352aaa1c686c4803341f49ac943a26aa5f61475b2b`  
		Last Modified: Thu, 15 Sep 2022 01:44:14 GMT  
		Size: 50.6 MB (50646589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:30be85046ece71468bc51d33742c526bfc4d1b34540712428a7e01d83aa72688
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.9 MB (247911363 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ce5ca5083acac0885c07b7b28c326165d28ab772a5b70701c3503c62052b53b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 29 Sep 2022 17:35:29 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:36:24 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:36:25 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 29 Sep 2022 17:36:26 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 29 Sep 2022 17:36:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 17:36:28 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 17:42:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 17:42:01 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:42:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:42:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:49903d7dbbf75e7efc8a8af709d35986ff01aff51d43e5c3cd66d9934422cb69`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4488b9c960529532f2311413a039df5adb27874a0bda394e1ae2a40698ba29ec`  
		Last Modified: Thu, 29 Sep 2022 17:44:30 GMT  
		Size: 39.4 MB (39433753 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfcc746086c91d12b1d9a4f3f1bd4a2aa58c2fc6c027c0459a76f1b6c5f7edf9`  
		Last Modified: Thu, 29 Sep 2022 17:44:25 GMT  
		Size: 1.5 MB (1460496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3eee119b59260a06f92843a391f1cfb31d8778c1d92f89dd66790662606d301d`  
		Last Modified: Thu, 29 Sep 2022 17:44:22 GMT  
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31b7b6b7e025e8d7137ee32f4de27081bd5bbf3cc2f3df77298f8b29151b0ed0`  
		Last Modified: Thu, 29 Sep 2022 17:44:22 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:371c5135117a1e4079e58f24a8ce6136cedb5ed15686cbd2f456796694207718`  
		Last Modified: Thu, 29 Sep 2022 17:44:22 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11248a845b4d2adb2bc10b6c47288395c2c5916f87c61b1ebb7e5c5cb5e409ea`  
		Last Modified: Thu, 29 Sep 2022 17:44:22 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e2d1444d06147a4b5c414b9816834a3b9e5db81b7b73019db2dcfba26299eb9`  
		Last Modified: Thu, 29 Sep 2022 17:47:29 GMT  
		Size: 50.4 MB (50401007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:257cd1a65773a89df150f8947ed94b0a2007ae9e86d6be2d5fc58703c51da6c6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.3 MB (260304450 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81f128f778b36713e14d45d7eddf2a5207f798f659774e1dc30fa51da4da7393`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:42:15 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:42:16 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 29 Sep 2022 17:42:17 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 29 Sep 2022 17:42:18 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 17:42:19 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 17:47:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 17:47:27 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:47:48 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:47:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:caf4a2de597d0c562fb4336f741240911c3cbbd4b204f7a73c3832826bad5c17`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9862075c00078c21101b5b276efc6bf9136f640f944ff033fd1c8466830427b4`  
		Last Modified: Thu, 29 Sep 2022 17:49:59 GMT  
		Size: 42.7 MB (42666784 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f97ba700fecc6aabbcc47ed45b5b973bafe8cc72b11fe9a2f3fde8d39e5d7b07`  
		Last Modified: Thu, 29 Sep 2022 17:49:53 GMT  
		Size: 1.5 MB (1483792 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e18a1af2c49c2da5adec88b94a2c5a5a0ea69595e3a882d968ec5468b53eb14`  
		Last Modified: Thu, 29 Sep 2022 17:49:50 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6064a6c99a3a4e1cc6099f6756dd7e7db406b0f5bd46e0605c972a0077a9ab0`  
		Last Modified: Thu, 29 Sep 2022 17:49:50 GMT  
		Size: 931.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b78a52d87f76d648cff3d70d24023c07466520df68ad5f8b995a2bddd79c6d88`  
		Last Modified: Thu, 29 Sep 2022 17:49:50 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fdb48df87c97fffcb1d512ac37d06150989f79b2200e5badefb4be16c87ac5f`  
		Last Modified: Thu, 29 Sep 2022 17:49:50 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:611b473b6b791e3bf1a77f2e1fa3b483cc3a02167751d65a87dbbd181e970d71`  
		Last Modified: Thu, 29 Sep 2022 17:52:53 GMT  
		Size: 50.4 MB (50401264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d4a5213c3345b46045e78db372dc34c2628338eebf011bd39d1af6a0dd5b0915
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.6 MB (261591808 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc88da7eb65eacefb51196b6b0aa00ec9400c2d555f0aa8f661b38d7dad2cad2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 29 Sep 2022 14:28:39 GMT
CMD ["apache2-foreground"]
# Thu, 29 Sep 2022 16:59:24 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:00:48 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:00:50 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 29 Sep 2022 17:00:52 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 29 Sep 2022 17:00:53 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Sep 2022 17:00:54 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 17:09:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 17:09:48 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:10:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:10:27 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2e29f28f263995e9d81ee6bc61a86d80296cd6e49b6281aa8e7001422b9a65bd`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc21b5792a146afdf8337c10b1f705bdedd143b56ed874a312277f3bd9861599`  
		Last Modified: Thu, 29 Sep 2022 17:13:25 GMT  
		Size: 45.0 MB (44980583 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42c821dba1203b1dcdd70c1c556beb99d4ecd9d573ca92d58438b1d21300c44`  
		Last Modified: Thu, 29 Sep 2022 17:13:14 GMT  
		Size: 1.8 MB (1783644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b5681e10b8159d0af71081c42492591ddb8e027acfca7dd67c2a02dee410c2d`  
		Last Modified: Thu, 29 Sep 2022 17:13:11 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd1b8ed737c87cdda0d465fe57473fc18a5a9583a615c7fe4e494699929f5874`  
		Last Modified: Thu, 29 Sep 2022 17:13:11 GMT  
		Size: 933.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a17512a8647aa53c2a7ad1ceafaec146fca01ab75cc296551293dc0823f1c99`  
		Last Modified: Thu, 29 Sep 2022 17:13:11 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bc5cd3c624420064adc773f7444fa06cfd03b61240da70def864a370bc6aced`  
		Last Modified: Thu, 29 Sep 2022 17:13:11 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:184315f5c0a69ec326d37330acbac52898aa5134adaa569e9bf721a9c2f0dcf9`  
		Last Modified: Thu, 29 Sep 2022 17:17:41 GMT  
		Size: 50.6 MB (50646372 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
