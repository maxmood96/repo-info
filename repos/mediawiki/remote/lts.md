...
```console
$ docker pull mediawiki@sha256:30e9bd96d04d7c296e421e56ba72c3bb7965a8f3a57b66cf6e36751f94ba436d
```
...
```console
$ docker pull mediawiki@sha256:8d3915131cf0eea3834a5dbe8e8cfd2fff5e033ac149aa5a7f9adaab2dee284c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.0 MB (256991953 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efbc530d6f0182fbd361996a33538ca57a8e5590ffc38f019c0d161ab3c3677d`
...
# Fri, 10 Jun 2022 04:31:37 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 10 Jun 2022 04:31:37 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 04:31:55 GMT
...
-	Layers:
	...
	-	`sha256:bb6c9695d5d3555a9d8ecb6196b614a1b7c3c5083f238cd1a8c6d995588dc827`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d3f8e447f3d92d185d9f6540ffa22b1cd5a8e70041e8da3cf793545c44c2a9c`  
		Last Modified: Fri, 10 Jun 2022 04:35:59 GMT  
		Size: 50.4 MB (50423907 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:0c2993ce2631bb9e62523fffeb37731815aea5e990e0152e934d2981d161dfd8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.8 MB (231833275 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:896a7f1af9bb02102b1fa08be95365934e8d65143d21a8e2e6efe0ee5d8ddf54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 10 Jun 2022 03:51:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 10 Jun 2022 03:51:39 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 03:52:29 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 03:52:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:89184d8ca5dcde5e74e2173b758a4e25f6030a94a035b4c7851c7313bbac95ea`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f40f6b85a2909a57a2356b576503f956850aa78d9d595701582441a8ef3ce28f`  
		Last Modified: Fri, 10 Jun 2022 04:01:44 GMT  
		Size: 50.4 MB (50421680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:522b9c87b5d3ffd8e2e0f45d86fe505b73a2110a5ca1249e5742e66a87da9f39
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221324478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d26477c6236d5aa9b0aaacb5d4b0c70d8e0e323b9553699eed15794e862254a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 10 Jun 2022 09:32:05 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 09:32:57 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 09:32:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e83e963ee8aa512ee88f9752d98e99af888d8a34c2d39a8693b4583d2e05829a`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9f9dfdc168634e8e67c31056743417a379f7bf247ad11f2e31eece9ef1e8ad9`  
		Last Modified: Fri, 10 Jun 2022 09:46:44 GMT  
		Size: 50.4 MB (50421108 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:bea65ab6d0ef025b3917a37c866dd80e5248f566c46be061d1c3e17ad6a52866
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.4 MB (247351601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c9b0aedcd9227b859dc0c158ee86d69cd35796d490717d08a037d491c0bfc57`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 10 Jun 2022 07:02:15 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 07:03:12 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 07:03:13 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Fri, 10 Jun 2022 07:03:15 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Fri, 10 Jun 2022 07:03:15 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 07:03:16 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 10 Jun 2022 07:08:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 10 Jun 2022 07:08:43 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 07:09:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 07:09:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:dba200faae5e353b05b377b4830e6bf9e0ccb762b3ab5a370247dc25bb44e957`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cdccee517483110b60f56f3213f487ebe2f06fee009db1f15326d1ed4de481b`  
		Last Modified: Fri, 10 Jun 2022 07:11:04 GMT  
		Size: 39.4 MB (39432661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a258c606aaca1c0ea834d4ef15d491c33192e4009510d1e052dfd4854805f190`  
		Last Modified: Fri, 10 Jun 2022 07:10:59 GMT  
		Size: 1.5 MB (1460294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fba68394b0240dc5d5b4ad4247e484a2b63b77a34a93b9809b748063103b93a`  
		Last Modified: Fri, 10 Jun 2022 07:10:56 GMT  
		Size: 576.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76e222f127341b40becb2f9cbc73c2e3059a07688ad6f8369584bf65b1a61ae5`  
		Last Modified: Fri, 10 Jun 2022 07:10:56 GMT  
		Size: 933.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74f75ea856c48fb000088c1b692c8bbd4d34e44ee7e831212aa83544184e11f5`  
		Last Modified: Fri, 10 Jun 2022 07:10:56 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de24ec497a7034ecee810af0e163ca439ef755eb9267874137cc922c47cf11df`  
		Last Modified: Fri, 10 Jun 2022 07:10:56 GMT  
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c3409399992d5014292c0a097a6757a943000e27e41235dc523813f687a4c14`  
		Last Modified: Fri, 10 Jun 2022 07:13:59 GMT  
		Size: 50.2 MB (50181064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:5b75971b7d9ac4f9f7a22e0764b8a7873253bb80691be43d4b6d54095f6ef61d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.7 MB (259719993 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb7b61e04ff3586949464f636a122da1e74c798b3bc3974b692b7d16263689e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 10 Jun 2022 02:47:10 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 02:47:57 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 02:47:58 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Fri, 10 Jun 2022 02:47:59 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Fri, 10 Jun 2022 02:48:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 10 Jun 2022 02:48:01 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 10 Jun 2022 02:53:21 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 10 Jun 2022 02:53:22 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 02:53:43 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 02:53:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5705fd449d808ec0ef967f4d568027f9c9f3fd71d1188053668eef208127a7c0`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec53cb1c139e87e9f3e0fc04a90b6adf83261481db3527729eed28dee14f3712`  
		Last Modified: Fri, 10 Jun 2022 02:56:10 GMT  
		Size: 42.7 MB (42658309 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:360d5007b41338946e8f54ca887e77555fd8e13fa6b606161bada1f6634e9d0a`  
		Last Modified: Fri, 10 Jun 2022 02:55:51 GMT  
		Size: 1.5 MB (1483720 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcc2f4443dfbece3ca4f661480a1373d6ef3647baedfa4502f8ac3649e14acd4`  
		Last Modified: Fri, 10 Jun 2022 02:55:49 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:657fd9d5b63cbff89a90d64f59fdb34943068a65bb151808eabdc364800c0a54`  
		Last Modified: Fri, 10 Jun 2022 02:56:06 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4510b590987be16878a9b839753e0e7a45decf52813ba7dc55ad5f7b195adbd`  
		Last Modified: Fri, 10 Jun 2022 02:55:50 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75b5a5372935e0a12beddff7739839371f8f9730de63a98bd0aa02c0d0864e41`  
		Last Modified: Fri, 10 Jun 2022 02:55:49 GMT  
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:736086aa188f4ba55b7c5af2aad85286f7a7d933a22c777fe319b71e28d76651`  
		Last Modified: Fri, 10 Jun 2022 02:59:30 GMT  
		Size: 50.2 MB (50180404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:4fbb435a983401642bd3f441f530d8082613b9c2e755e799d72dc0d854d0cfc9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261224667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1c34c61b41965d1ea76678cb70a0297c7aaea00cfec5ca827375a8160cee9f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 10 Jun 2022 12:55:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 10 Jun 2022 12:55:51 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 10 Jun 2022 12:58:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 12:58:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7d0cb4309ee17925eaf92f66d4053e33ce7b828154e4efc7c7e2ec927c853fab`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00eaa5974098ef6690bc874ab9f673527622ac837f12acdcce8f5b003850e097`  
		Last Modified: Fri, 10 Jun 2022 13:17:59 GMT  
		Size: 50.4 MB (50426081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
