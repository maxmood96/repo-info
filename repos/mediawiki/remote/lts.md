...
```console
$ docker pull mediawiki@sha256:1f81588041bf0473080fe860873258c0eb351b1240afdb2a8067e4c24b0cee47
```
...
```console
$ docker pull mediawiki@sha256:744c969f95b05e7c9e7e755f76dc045970e93b1e594bfd957eff83b9efe8ce1d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.0 MB (256989845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96cc2ad19a1f111c4be74209a117125f7d16ad2939d82c2f7edf05d095920d35`
...
# Thu, 21 Apr 2022 10:57:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 21 Apr 2022 10:57:10 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Thu, 21 Apr 2022 10:57:28 GMT
...
-	Layers:
	...
	-	`sha256:7db36f2cf102081ab95f576796f0e112013473e09f2630dacae3b1b183101aef`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd0bca5b29d3b7851cd74753e73037e14bf57a150dfa38623b14297658a50fb3`  
		Last Modified: Thu, 21 Apr 2022 11:00:28 GMT  
		Size: 50.4 MB (50423924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:3739c74b37c112d688354e55e53ef580560225e3cf3683a9f7276a1c6881e621
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.8 MB (231829519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5081d42bcdf15f21b5d36cea3e5dc846729eef4bb73c0aa76d027f218ae284bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Apr 2022 19:35:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 21 Apr 2022 19:35:27 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Thu, 21 Apr 2022 19:36:56 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 19:36:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0ad96e6eecd0ee66187972b35e795bd2c1c2e23415bff84a43c9692b2253fba4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ad540f71e772b0eaf202cc38dc947d9b0380283573a6b3ab7873b3f1f34b68f`  
		Last Modified: Thu, 21 Apr 2022 19:45:43 GMT  
		Size: 50.4 MB (50420306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:06f5212f1baf259ea94cb755200253551eaf92eb38bbc26bd0575e8ec2a6c6bf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221319942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eeb31b0aad35c5ed642e9a7d2fe4d009472f20185b0257060345a7d2c91f10d2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 22 Apr 2022 21:18:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 22 Apr 2022 21:18:47 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 22 Apr 2022 21:19:38 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 21:19:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:768b00ec1d5d21980baa1bf1c561ea015d658d4c134e55d31bf71967575cb4c2`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a772b614dbedf2f62a5f83aed87036b76e6b4bd497aa940dc67b2c5f2e709ef`  
		Last Modified: Fri, 22 Apr 2022 21:29:33 GMT  
		Size: 50.4 MB (50420348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:c93647562b9bb8540b3a0903b62fb00f97e54a9cbb0e4553d23cc5901bd76363
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.3 MB (247348444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90591168079e32b81017161b33e1faf9b74204c8f1d03d55f7221adff9657e7d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Apr 2022 12:19:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 21 Apr 2022 12:19:44 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Thu, 21 Apr 2022 12:20:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Apr 2022 12:20:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f8c4561b0bb2381d449dc6b50b32c01e81858083437024a3a2b01334b9a1de55`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0442a2506856e130fed41d2dca3dcec572e05a06da9bcf354fcb1e9cc249bd30`  
		Last Modified: Thu, 21 Apr 2022 12:23:47 GMT  
		Size: 50.2 MB (50180925 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:2aa578467b13470888ca0eed5c0f93bbe86e1a5fc07119fe60af8f0746889938
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261219010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82bd40a1a98a5302fa9b172aeba57b9166b8f6a55dac2d275ecfe52cba27f279`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 22 Apr 2022 04:20:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 22 Apr 2022 04:20:54 GMT
ENV MEDIAWIKI_VERSION=1.35.6
# Fri, 22 Apr 2022 04:22:09 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 04:22:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:695b30cd604bf1e4fe6c40e47ee9d32bf588b77cd494f935938306c8a9ea5fd8`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb6b3e7b73b71fabdf0e234e1b4fc48c196a5dc878b5827332907f941c1776db`  
		Last Modified: Fri, 22 Apr 2022 04:29:12 GMT  
		Size: 50.4 MB (50425998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
