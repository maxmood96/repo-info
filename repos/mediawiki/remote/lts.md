...
```console
$ docker pull mediawiki@sha256:ab95b5b99b176417c0acb8b4af80e940e9af0a8935d9418597f091cab07420e5
```
...
```console
$ docker pull mediawiki@sha256:59edabfe5b3e899f27a3add496faab1f0173113f1fb3d8cc7f183bf469cc8eb2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.6 MB (289576210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2fb1dd31c7a83d2cb3f1b1c3fe26faf89599fcfef59048948f85369a29a7d65f`
...
# Sat, 29 Jul 2023 02:14:36 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 02:15:47 GMT
...
# Sat, 29 Jul 2023 02:15:48 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Sat, 29 Jul 2023 02:15:48 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 29 Jul 2023 02:15:49 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 29 Jul 2023 02:18:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 02:18:52 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 02:19:10 GMT
...
-	Layers:
	...
	-	`sha256:c9e332f656d0c55c9681902c63e480b2e689eb9ac08376e9b5dd69763a8f1187`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc00677f7a3ee0ea74fa5b2d59f902a8a3cff4b1d24ecda1c6a61857c9c42e6f`  
		Last Modified: Sat, 29 Jul 2023 02:24:01 GMT  
		Size: 53.6 MB (53618681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2795edc0267e8abad2d94f62f1946d15b7a93bcb99302ec6007e9f3548a711f`  
		Last Modified: Sat, 29 Jul 2023 02:23:53 GMT  
		Size: 1.9 MB (1922349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c378921bb15d77031795c0d46782883944bc72439c886d71a076f6cfec572e5`  
		Last Modified: Sat, 29 Jul 2023 02:23:51 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61b9aa27f699eb37a02544c8ac3b4663e12b02af339620498980644a5a936428`  
		Last Modified: Sat, 29 Jul 2023 02:23:51 GMT  
		Size: 909.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:065b8e7b30fd3cb1f3f844abce8aaf67e4a667cb2cb28193edccb47b74f8f12e`  
		Last Modified: Sat, 29 Jul 2023 02:23:51 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df48120ea15a45737cd70ddeb7c0afc5e107889028c1636430d6cf14c91032a4`  
		Last Modified: Sat, 29 Jul 2023 02:23:51 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4385bc14c7de671516711e3f40f71426071565c1fe39884082ad00ad99686607`  
		Last Modified: Sat, 29 Jul 2023 02:24:56 GMT  
		Size: 56.9 MB (56923458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:708a56196e3776ef160d18596f29bcc6914393d1b8e6ae6ae1d490fb789901a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.3 MB (258261108 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05a6a541ae3b8d6b2fa6068208114035d1ff4087245b469b119cd7af51797768`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 00:01:19 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 00:01:20 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Sat, 05 Aug 2023 00:01:20 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Sat, 05 Aug 2023 00:01:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 05 Aug 2023 00:01:21 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 05 Aug 2023 00:03:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 05 Aug 2023 00:03:54 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 05 Aug 2023 00:04:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 05 Aug 2023 00:04:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e2f79ebdb9d94a09095936359b5a5d24cc9f71f0ace8780c87f9ad945ea29280`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ce9e6bfc4bfe42c998f011b025c6d51e436af913eb572ae4259de36e7a15015`  
		Last Modified: Sat, 05 Aug 2023 00:05:14 GMT  
		Size: 49.0 MB (48965075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a21956820ffd08ccb62fce056340bd97b71a99d913fa286b43409b79b2866758`  
		Last Modified: Sat, 05 Aug 2023 00:05:07 GMT  
		Size: 1.5 MB (1506075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4e095fc38063f6a5f8e5483c7bf149888d485099c6e67bc80a9b64d59177094`  
		Last Modified: Sat, 05 Aug 2023 00:05:05 GMT  
		Size: 572.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e0b095d6c05406764d7c168414a7b886da9bbe1fbbf280345cf1b4d4839a71f`  
		Last Modified: Sat, 05 Aug 2023 00:05:05 GMT  
		Size: 903.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a533ed25dadaaac7e5fd999926fcc5560ad063427614829385db0ad9e204f12`  
		Last Modified: Sat, 05 Aug 2023 00:05:05 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c7e26c96c26c37bd340ed07fdbfcc577b63a49ce79f2d232cd581bdb447db6b`  
		Last Modified: Sat, 05 Aug 2023 00:05:05 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f24ced11c5bc3aadfe8a9217c548346bd2d2deccc7ab80f7899ad8ae3288b65d`  
		Last Modified: Sat, 05 Aug 2023 00:06:22 GMT  
		Size: 56.9 MB (56917997 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:c2ad4a806a422491dc48886c298ecad0076b3bfcd0bbcade340f96026562380a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.8 MB (245794356 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a42a793ab82440b2de7f0a226948baf7edc415d3e326797fc1447cc1cc8cf0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 05:50:46 GMT
CMD ["apache2-foreground"]
# Sat, 29 Jul 2023 03:24:00 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:24:45 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:24:45 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Sat, 29 Jul 2023 03:24:46 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Sat, 29 Jul 2023 03:24:46 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 29 Jul 2023 03:24:47 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 29 Jul 2023 03:26:57 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 03:26:58 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 03:27:20 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:27:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:17864f234c92c84f1b0cdb887e645ecef1baa08812377efd9d7d5122dd848468`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f98b2210c2be01eeca78ba978ee191191b27bf4245e2168cd4d0cfb872fc90f`  
		Last Modified: Sat, 29 Jul 2023 03:31:39 GMT  
		Size: 45.6 MB (45569512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:485265ec8b89287e606d1378f06bdef2785b8bfb567613cca82c7ab64b608acb`  
		Last Modified: Sat, 29 Jul 2023 03:31:33 GMT  
		Size: 1.5 MB (1472376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4326cc9eaf3e448ad42c7aed8ae37b7a53c352c39b26c5855184a9ec3e3c9dce`  
		Last Modified: Sat, 29 Jul 2023 03:31:30 GMT  
		Size: 574.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a5066654558d7f71c57a0fcdd9376ba747c32d60b2364aeef339717b1195d83`  
		Last Modified: Sat, 29 Jul 2023 03:31:30 GMT  
		Size: 908.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0521a192ab730a5d6f676a32d22b8b5b8d1a13bfc68c52b31b3b4d97f351afad`  
		Last Modified: Sat, 29 Jul 2023 03:31:30 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8238917398b0a2edd66a78e6dbca6ff63a0ef17060631684366342b79e8b3b37`  
		Last Modified: Sat, 29 Jul 2023 03:31:30 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fa4ed0bbfc362c4973b6389dbc908fa75d059e85cc1b90137569ae5d6a3dd82`  
		Last Modified: Sat, 29 Jul 2023 03:32:47 GMT  
		Size: 56.9 MB (56918135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:ca7b3ec1c7e5801aee6218016a27afd1473bcfe290043aba5e930517c9498db6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.0 MB (290038001 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e9fa39e23bf92b421acd71f64b230ca12748a00c1fd7a408c0d2cc308508de5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 07:11:16 GMT
CMD ["apache2-foreground"]
# Fri, 28 Jul 2023 22:49:34 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 22:51:03 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 22:51:04 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Fri, 28 Jul 2023 22:51:05 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Fri, 28 Jul 2023 22:51:05 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 28 Jul 2023 22:51:06 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 28 Jul 2023 22:54:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 28 Jul 2023 22:54:14 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Fri, 28 Jul 2023 22:54:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 22:54:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5ec6d8ac1cb4a1cac1cb1d4011134ef0d55d27c7685aec7a80d8b411d6c6d0ec`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c61222c0390998475ef8f93b7dfc863390f41bcaf5249364d3a2b3fdd8736c7f`  
		Last Modified: Fri, 28 Jul 2023 23:00:40 GMT  
		Size: 55.2 MB (55178781 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2fcca3d14f4471915e3724378eebead1c2439392a05a3c27667e54855c86e133`  
		Last Modified: Fri, 28 Jul 2023 23:00:27 GMT  
		Size: 1.9 MB (1907897 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:811a3d478cdeedab0b89841a7c3ff2cf5537b318b0293f252d7d64a500842237`  
		Last Modified: Fri, 28 Jul 2023 23:00:24 GMT  
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c8041ee2debff706375522527feab8cd605c2e9c1ff7cc71c69bae1b5d0a24a`  
		Last Modified: Fri, 28 Jul 2023 23:00:24 GMT  
		Size: 905.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9f2da669eb4c2c138f1d2ae3c49fd65bde65cf570e92400d72246821deffc95`  
		Last Modified: Fri, 28 Jul 2023 23:00:24 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:452be917c96b2452719de6b692832b54b93487b55a3995ef1d3c7398bdac86aa`  
		Last Modified: Fri, 28 Jul 2023 23:00:24 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42fd9e35ae119379691406fd8a1552cbaefd61afe0f25694497af6cca305677`  
		Last Modified: Fri, 28 Jul 2023 23:01:58 GMT  
		Size: 56.9 MB (56921913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:c2aa7d928848dcc8d67d2f9f7110c5a957828c9084ae26e314ecf73f40019d78
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **298.0 MB (297991098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1e797ce0bda8502350309ad14c29f30e759991b1de5926788596ffd79536d15`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 28 Jul 2023 18:38:58 GMT
CMD ["apache2-foreground"]
# Sat, 29 Jul 2023 03:48:54 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:50:25 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:50:26 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Sat, 29 Jul 2023 03:50:27 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Sat, 29 Jul 2023 03:50:28 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 29 Jul 2023 03:50:29 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 29 Jul 2023 03:54:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 03:54:39 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 03:55:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:55:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4922d645d7862fea6de3a5879d7bdae277d2287b89b43865124b04be6516cc55`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f0e7029810d8acee8431394babe6ceac2817bc1e1d2361eda07ba167f604548`  
		Last Modified: Sat, 29 Jul 2023 04:04:17 GMT  
		Size: 57.8 MB (57826477 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9dea45cce94070534e7acef1043a481ed6cf8dc3e4df7bd771ed41b43718782`  
		Last Modified: Sat, 29 Jul 2023 04:04:03 GMT  
		Size: 1.6 MB (1610393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97b6b4d4ee007e8bfda9f12f6ab29afe2e2b542d536c8d7c542b6e574f73da42`  
		Last Modified: Sat, 29 Jul 2023 04:04:00 GMT  
		Size: 589.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ba3d3713a5fa418da36e4404a2e19248926f040e117fd6d0af8931e92bdad64`  
		Last Modified: Sat, 29 Jul 2023 04:04:00 GMT  
		Size: 902.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3fb9de235cfdfe5eabd075c6f7775f106e1f9bf7c1dcf59dbd8558e3d8bc2d4`  
		Last Modified: Sat, 29 Jul 2023 04:04:00 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2233015da2183f62ea1cbf64bbafa0b407da3a9a0612e5b6bbd11269b3311747`  
		Last Modified: Sat, 29 Jul 2023 04:04:00 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01cac1c11914944fc3ea23a423e529087fe4821a8b6ffe39dbfa192c466db84c`  
		Last Modified: Sat, 29 Jul 2023 04:05:53 GMT  
		Size: 56.9 MB (56922868 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
