...
```console
$ docker pull mediawiki@sha256:985dcbc10bb2dd1ee0ba1c10804c877b4eab493d16578cb656b67b4cdb49bbeb
```
...
```console
$ docker pull mediawiki@sha256:85e69338106f76d025685235c4115115284f9c01a8aaac9d03a77e04bcaedc34
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.1 MB (220059429 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:672b0b5483edf21b7a1483852991fd5a5f40597418ed9f474af1fedded2c80fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:46:03 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 11 Mar 2022 17:46:03 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 11 Mar 2022 17:47:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:47:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ee98e61892276f9a805cce224b8eff55662e8601ec63798396220d91c65c7bac`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77cf3b13bfc9f05c9896265db2fd05ef1990a3aa1d9a2d4bbb218541031c026d`  
		Last Modified: Fri, 11 Mar 2022 17:59:13 GMT  
		Size: 49.2 MB (49186934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:f2a5edf927f33926ab14e6fd5783352d5bb07887103c338272a53479af573f17
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.6 MB (259568108 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d31bcf77ba4d6d360960c852fa1eabbfdb01c8280b7417b5d85f03e4cf39684b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:52:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 11 Mar 2022 17:52:25 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 11 Mar 2022 17:53:27 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:53:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bc686d87064d3c6fc59cdb5581e058d883f9d32cb5b02203f7742a438fa94236`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be7f84772e6c34941a146ff99c67dea037508f65b1ac2d06a13f551085e8508f`  
		Last Modified: Fri, 11 Mar 2022 17:59:46 GMT  
		Size: 49.2 MB (49187742 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:c99bfce0041a258d5acdae223afc05d17ae49dad661c90a2364c2ef3d31af95c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.0 MB (259951409 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:220697a18b273027fa26dab781e41385f79520ecdb256b724b3d8e940f9a8834`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:56:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 11 Mar 2022 17:56:46 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 11 Mar 2022 18:00:03 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 18:00:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:03dcb13c762f8681e949a2b6a4610e3be5c75ee0bb2420632a199cf43d63ae65`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34ed2765aec484e7e81114f4d1305aba6ec88f5f4bfb0b568c37b6f8215d1ae1`  
		Last Modified: Fri, 11 Mar 2022 18:26:35 GMT  
		Size: 49.2 MB (49186621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
