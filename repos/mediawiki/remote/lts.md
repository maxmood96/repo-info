...
```console
$ docker pull mediawiki@sha256:9a4bb5698b7fef47a55cdfcf16f4163167e84d3ecfd8bbc96c173da05ceda6ed
```
...
```console
$ docker pull mediawiki@sha256:5fd212e70d230b5dafe8d4b713c4e4829914e90dbe5c321cd6801d34ca4baff9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.7 MB (255736038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc29b6409eaf3745fb46d1b6ef3f003958793967193434514f1d03bf0fc52233`
...
# Sat, 19 Mar 2022 18:59:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 19 Mar 2022 18:59:30 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Sat, 19 Mar 2022 19:00:34 GMT
...
-	Layers:
	...
	-	`sha256:d20a9566664ffc041406f8644d3710a2a4d48350e62b9d5ff68bd0ddc922b9cf`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cda839e835fbb19489d85a0857035e7e356d9752333f97e77a37b424a22089f3`  
		Last Modified: Sat, 19 Mar 2022 19:06:07 GMT  
		Size: 49.2 MB (49188485 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:3063eeb0103df3b2f147a3179eddfe278c24f4be1cea6e86a29f46d6ab3159ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.6 MB (230578338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3e23e559fa23e8f1ce27938a539874c33a14f17b38ffe98b36292a3b65489cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 18 Mar 2022 20:04:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 18 Mar 2022 20:04:34 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 18 Mar 2022 20:05:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 18 Mar 2022 20:05:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d4c38fdedc8abf367e56c3e1d1f4948457ff21faa9ced19caa9f59b803e7feba`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b0bb9f2b11c8338ba51e1a07e7e139b52574d4dca948429edc2b9cfa2570445`  
		Last Modified: Fri, 18 Mar 2022 20:13:02 GMT  
		Size: 49.2 MB (49186912 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:06d46aa2fcf4a3c5d8fa918a61610ee2bed1954fbf30462542ec6d68c31a49ac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **220.1 MB (220069742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b15ad764e09ca5503d3ef30f5badb2a965461642349c7c68c7c9fc942e951aab`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 20 Mar 2022 02:45:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sun, 20 Mar 2022 02:45:57 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Sun, 20 Mar 2022 02:47:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 02:47:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b09b0eac5272f34684cf4c8ea67b1fbea9a86dcb1c636c06eaa1e6871ade17b2`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86fc0d2d9683d6c2d235a800b4af4455b5e57c9db7c643b332a4efa0f8a0b4cd`  
		Last Modified: Sun, 20 Mar 2022 03:00:57 GMT  
		Size: 49.2 MB (49187119 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:ebb2c8d88627d5223ccda006c321b860a7c2d151dfd147da7edbb5b3e7eac2f3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.6 MB (259576717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:acc08f7f1cc4e74ddc058543969fc55cb3525db0be8293bc9f4231d8b5b2535b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:180fed6ae161ba98fcbf5ba105893ee4732538b8244452e101812ff532e98f67`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:346b6fc7bc7d2cb7839633e952f5a41d99b5532640ec944e6169735fe202e292`  
		Last Modified: Sat, 19 Mar 2022 10:42:11 GMT  
		Size: 49.2 MB (49187827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
