...
```console
$ docker pull mediawiki@sha256:7165661bc7116b95267350d921bafaad7fe7ae033431e9cfd13d41758189edb2
```
...
```console
$ docker pull mediawiki@sha256:64e64038a4711392d9e31688c89c63ca74c1236d5a1d13d53e62c52b38aee444
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.8 MB (291841338 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b2af866cb00ab7a5c8f349698b64c1ef1f18daf51ede939a9b500ffedc7411d`
...
-	Layers:
	...
	-	`sha256:a25e00759e7aed55b9a37716bec8d9c5ac565667aa2db6f130a1779e40ada67c`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff8c1df0c9ec91888cc539f61abcd4f46e2c1d71d14b3e9eeb727b9b0684e8cc`  
		Last Modified: Tue, 12 Mar 2024 14:43:28 GMT  
		Size: 53.6 MB (53631780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85490ff05301511575d75387962f6d31e5ad575312f42dde1e07fb43737911a7`  
		Last Modified: Tue, 12 Mar 2024 14:43:21 GMT  
		Size: 1.9 MB (1925306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa18e0ba4fc365d07ec69de18486722613de45995520ae77804ac294c34f946d`  
		Last Modified: Tue, 12 Mar 2024 14:43:19 GMT  
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44a7901cd2d8663e6d0c0e14e2df3e9d4c3fe0b14c1b70e3e8283880e9c2b93e`  
		Last Modified: Tue, 12 Mar 2024 14:43:19 GMT  
		Size: 906.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:059346769a3a413e449d74a83bd06812a18284e383a21ea6b0ee2a7b1ab109f3`  
		Last Modified: Tue, 12 Mar 2024 14:43:19 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c4cede12e7be3708bad65fb8a6440a01b618474553fdca8543de656e3f0538ad`  
		Last Modified: Tue, 12 Mar 2024 14:43:19 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7b94469f538a99897cacd3eb5ae5e27b99529cf3acf05582c6f88d4f21f7359`  
		Last Modified: Fri, 29 Mar 2024 17:59:34 GMT  
		Size: 59.1 MB (59088348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:21bd089ea1216ed19c004a88a184a16eee18bf40913991f5cee532b43288b8f9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.4 MB (260404542 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42d06cf8614e5803d4ecc9ed43f26ba3dacb38cd0198b5cd1c2f7eca583c565e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Mar 2024 03:31:53 GMT
CMD ["apache2-foreground"]
# Tue, 12 Mar 2024 09:50:09 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 09:51:06 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 09:51:06 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Tue, 12 Mar 2024 09:51:07 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
...
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 29 Mar 2024 17:51:59 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 29 Mar 2024 17:52:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 29 Mar 2024 17:52:37 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:aedb9f7c59719597344a1a2cce73b4296b6960b673428430306b8ec19e8d9dd3`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b9402d40fbf9af33458fd939e8fa1a9377d1cb8d1dbdfc8772c38906287c961`  
		Last Modified: Tue, 12 Mar 2024 09:56:30 GMT  
		Size: 48.9 MB (48947340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50c61dc53dbf0cf486c037ee0bc4021b91c40563fd30c1cc3e9407c894da81b5`  
		Last Modified: Tue, 12 Mar 2024 09:56:16 GMT  
		Size: 1.5 MB (1506939 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6512d4c1ca0292ceadf32e9c1173001248b77a9e9389617142f182df849f49da`  
		Last Modified: Tue, 12 Mar 2024 09:56:14 GMT  
		Size: 577.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33b7eb573e730afb4d5d9a2936f2318cf043950994c38f4f646e70c448b6b288`  
		Last Modified: Tue, 12 Mar 2024 09:56:14 GMT  
		Size: 909.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7fe7c3e7ea4967e228c232d5a364f88e531b892001ee9ab89eff957dd7e4aa7`  
		Last Modified: Tue, 12 Mar 2024 09:56:14 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1322d84891f7f061df302c8a45fcef9f5d5cc8a3443d7088b70890906f607bb1`  
		Last Modified: Tue, 12 Mar 2024 09:56:14 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5bdcbc2495736b236a5e4a720ab1e61bae615017fe7e501d6b529f2181c4db1`  
		Last Modified: Fri, 29 Mar 2024 17:57:16 GMT  
		Size: 59.1 MB (59086082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:64a464a98236e3b3c9fb3e30e245fdb73f873ee4cfad18f27dfe88f5e6e18e63
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.9 MB (247919915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ca5d0bcda49001eed143c434f4b276a56b824c5745b39cd4abb733be32b52a4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 12 Mar 2024 13:08:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 29 Mar 2024 18:17:36 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 29 Mar 2024 18:18:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 29 Mar 2024 18:18:17 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:85f9a0967cdb48947614e7c36c4900da3c6171a318f6d2e3736e47b38d77924a`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3a34bad7b36ae80e051c4c7777a9fc2a2520d41848f9e9a65b337f1810fb6cb`  
		Last Modified: Fri, 29 Mar 2024 18:25:04 GMT  
		Size: 59.1 MB (59085736 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:4d84de6320be3b9b0d3e02b5d1942009281446f302ef64281f6ffb02cbc8a933
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **283.0 MB (283011074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05703d919f97f4e1cbd726dccd4c3245c5c80b0766dd07b667cb669c5b32ff0c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Mar 2024 06:36:09 GMT
CMD ["apache2-foreground"]
# Tue, 12 Mar 2024 11:52:13 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 11:53:38 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 11:53:39 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Tue, 12 Mar 2024 11:53:39 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Tue, 12 Mar 2024 11:53:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 11:53:40 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 12 Mar 2024 11:57:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 29 Mar 2024 18:12:47 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 29 Mar 2024 18:13:04 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 29 Mar 2024 18:13:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:24e9a8d910a76f1ea56e0187d300ba4db5159ab2f37b268ba51e802879fb2506`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7c07d4136d19ad48930a991a756761e6c2df87fd0576e74415e84418bd5084f`  
		Last Modified: Tue, 12 Mar 2024 11:58:25 GMT  
		Size: 50.7 MB (50748638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc2a44b02505c879954c7796ffa09c638aab224764a9d5c43af121c043890d4a`  
		Last Modified: Tue, 12 Mar 2024 11:58:20 GMT  
		Size: 2.2 MB (2178833 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daed52857a7b321a05214b56c39ba1ae9c5ed72979812f5cec3f6fc1ef567512`  
		Last Modified: Tue, 12 Mar 2024 11:58:18 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba9a4e59e1cdb91170b68fc7665deadab0928a4a49894caafab3cde8c6a8f49e`  
		Last Modified: Tue, 12 Mar 2024 11:58:18 GMT  
		Size: 906.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94a8147d6c1c83c73936ef1efcda57069cbbd6a9f54cb3746f8ec985cf489e7b`  
		Last Modified: Tue, 12 Mar 2024 11:58:18 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f98224c41674f9131cf6cd7979ce9a4c67253d0b81c14d441f41303f4014f029`  
		Last Modified: Tue, 12 Mar 2024 11:58:17 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14e254b5cf9fb7027153bfb0aa26c7c5000f11d31e66658ee2de3af808d0ef92`  
		Last Modified: Fri, 29 Mar 2024 18:17:24 GMT  
		Size: 59.1 MB (59088864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:98ec721adecb964da5079149affc10ea2bb980ddf163b3a755e9b92f40d0b76c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.3 MB (292316916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d354bb20e22209a5788e8e3fdd516ed09ccc539fe4c5a75e623d6ea5fce6543f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 12 Mar 2024 15:18:09 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 12 Mar 2024 15:22:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 29 Mar 2024 17:42:28 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 29 Mar 2024 17:42:55 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 29 Mar 2024 17:42:57 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:fcba7b20f4023f47fa9b8b2d3c81f66d67c1224c06693ece6c0bb16e64fe5eb7`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0da7804339148371e86d237992a7e41eeb256e509b6d8525e79900c4aee4f318`  
		Last Modified: Fri, 29 Mar 2024 17:48:37 GMT  
		Size: 59.1 MB (59087877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:dd3de3ace685ee49be6ea027f6602026d8270e4ebc83ade6005181b5aeb3b883
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.3 MB (300263111 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20573c9337d9ffa749ad26938fa454f18b99135c481ef0e432ce584c9412e0b3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 12 Mar 2024 16:00:19 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 16:01:25 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 12 Mar 2024 16:01:27 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Tue, 12 Mar 2024 16:01:28 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Tue, 12 Mar 2024 16:01:30 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 12 Mar 2024 16:01:31 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 12 Mar 2024 16:08:23 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 29 Mar 2024 17:32:39 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 29 Mar 2024 17:33:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 29 Mar 2024 17:33:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:395249a1105efd018bee53d1d8719208b8177478510706f827631d59c18a71d7`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a51922f3b78dd81267631b5277cfff2a5c4f6adc588dea2ed90d7b4f46998881`  
		Last Modified: Tue, 12 Mar 2024 16:11:05 GMT  
		Size: 57.9 MB (57855760 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6df40e2af9305aedfad81b83c4e5adb3674a130d2fd9ec0cad2c36760cebbad9`  
		Last Modified: Tue, 12 Mar 2024 16:10:56 GMT  
		Size: 1.6 MB (1611902 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b007afeff634a7a00764fd5118a14b4c1d1550a2c62f24a54644b463df5e88e5`  
		Last Modified: Tue, 12 Mar 2024 16:10:53 GMT  
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:589cbeb0ed2e1d41c1c592b19932633e0c6e31b03c4ad998c4f45a33eb633574`  
		Last Modified: Tue, 12 Mar 2024 16:10:53 GMT  
		Size: 908.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:132c666b3c4fda37367236cfd250e89457541943421fff950cb8dad67688e1e3`  
		Last Modified: Tue, 12 Mar 2024 16:10:53 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfc9dcb912aee446ebc65f111a02b40b955f4ca1f4529a2740124755be7ae1c3`  
		Last Modified: Tue, 12 Mar 2024 16:10:53 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c76a1660604c763f5ab4f5fddcb9a51144b38acf99deffd1ecd383a9590fc3e`  
		Last Modified: Fri, 29 Mar 2024 17:39:45 GMT  
		Size: 59.1 MB (59089229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
