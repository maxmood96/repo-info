...
```console
$ docker pull mediawiki@sha256:09e7079f6ee20e6823c633d149f4069c74704e6de73d47c57a09241c4ac9d35b
```
...
```console
$ docker pull mediawiki@sha256:facd81fedd96c50404eb5dcadb5ebcd6e5f95f5e8f92a1b686d5266604489793
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.9 MB (264915466 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41056e896f5c2abe1db43140a1785cca268fe7c936613a00cfc9a16641b97132`
...
# Tue, 01 Dec 2020 08:31:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 01 Dec 2020 08:31:27 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 08:31:45 GMT
...
-	Layers:
	...
	-	`sha256:6819563048f586e768140e635ed45d9e3b095b09f79286ff4a7986da3aaef9d4`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e1ca22bc03531e602d4e009551538216579d60696c86656f457a0c20dab014`  
		Last Modified: Tue, 01 Dec 2020 08:38:15 GMT  
		Size: 48.7 MB (48670044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:4cf4f06161235116f6898b7bab77b537873232c294b9e7afd52cfc0cbd9eb42d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.4 MB (239425335 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cf45252636b69a30ee1d65baa1aec98feeaf8f196aa751b16d5af0fb8633dec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 04:13:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 01 Dec 2020 04:13:54 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 04:14:36 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 04:14:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2f5e25ca995fa8906d9ec94c91bc932e909f25722f676a832eee7fec6fd80cd4`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bda1b0aff8d4895aa3fc660f969d1103374fa7f256c849485f35b8fff21f2dd6`  
		Last Modified: Tue, 01 Dec 2020 04:21:45 GMT  
		Size: 48.7 MB (48666217 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:fc55131b42a51e65f8559dc0db7b8e4249c8e526a180316a0d1d049c8c9e80d1
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **233.0 MB (232996599 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:08c3d2e8588505e50d6113388fea7986b35efcb70c662eceee5c9b4a0d7dec38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Dec 2020 05:39:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 01 Dec 2020 05:39:06 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 05:39:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 05:39:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2a8294eefe39da891d7ec1b0f69934f8c1c11ea907342f24293005e4b54e6a7f`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9333377d092d5851eb271064897bb53b4310bdb99c70af1ed12280594b4e8300`  
		Last Modified: Tue, 01 Dec 2020 05:50:22 GMT  
		Size: 48.7 MB (48666980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:26c75ec3aecd74af20a98506ed693996b446cf79c6ad95dca103cef16b238bb2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.7 MB (254735130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee41e31d7de41827e657501e484892049988afb6d541493ed73e7a564a47fc9b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 08:18:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 01 Dec 2020 08:18:21 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 08:18:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 08:18:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ba6e64dc6d52d275aeaae6416d1c1051aeb0e0dee8aa29b87a827d5f52e896e7`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4c0547ace4f7e953448ff47c350e4d6ffd6d1e6bd93112a58cda68e3ae33eeb`  
		Last Modified: Tue, 01 Dec 2020 08:27:06 GMT  
		Size: 48.7 MB (48664487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:8230206739f3bd6b21b42e6442991a38846ab9e576d61d377dd7e1933b468e12
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.8 MB (272829554 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6947399f6f875865d348247f8932e596567b751a15da14640a7afec9c3a7ef59`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Dec 2020 07:46:15 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 07:46:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 07:46:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:238540264d1037943b56908ca1d7389bd4950612be067017b44c6d8c9d322dea`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b63ad0ab5a91fe692b892084c224be0b7a2dc8305b8c75b8efddcc9ad0bbf46`  
		Last Modified: Tue, 01 Dec 2020 07:54:21 GMT  
		Size: 48.7 MB (48669472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:50df44a859765cc6ff53c39141611ecbdecc82ba9404521517356d575d9ccbd0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **283.0 MB (283046063 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c40b75c2a8b2c6c23cdd8e482cf0af0043d3a4f62693b732a8428e0adcc14b4a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 09:04:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 01 Dec 2020 09:04:46 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 01 Dec 2020 09:07:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Dec 2020 09:07:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:343f579318917dd54a1e8e06588c214b60a5fb517211092c984fc17714606852`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9b94124b59e97e61f87c40ac72b63b53f1a09a859ef3c4cc44405830e1548ff`  
		Last Modified: Tue, 01 Dec 2020 09:35:30 GMT  
		Size: 48.7 MB (48668678 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
