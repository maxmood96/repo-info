...
```console
$ docker pull mediawiki@sha256:64f6eff7887d2c5b11548e429a3f4ad73dcc27b326e2ee99cee3a792404bfdd3
```
...
```console
$ docker pull mediawiki@sha256:7a77af4f9ff8de197c7619fad8d8f6a46a8881e7a9d8ee8562bffc8c12641e10
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.7 MB (255725348 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ec6ed546c7868fa180d04f25440ec8e42777bf9029b639fcb93ba1e70aa30aa`
...
# Thu, 03 Mar 2022 15:01:31 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 15:02:30 GMT
...
-	Layers:
	...
	-	`sha256:c2c7571acfb25659ec8ea60ff64ebb5c2b06d1cd02a9c700440c5e9005cfbeb7`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b299dd371c48ff0b9d3276c1c0606161afc3e9319a98a0d731ae997e217a2ee2`  
		Last Modified: Thu, 03 Mar 2022 15:22:00 GMT  
		Size: 41.7 MB (41656934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55b7ecd56964ba430c6ce41d1b43ddcf539af8cda62bbe50fdd7c39cac405afd`  
		Last Modified: Thu, 03 Mar 2022 15:21:52 GMT  
		Size: 1.7 MB (1700601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bd6fa01be94f862a24b6c61eecb5a8bb8422536732a07b69ddf17255a59ef24c`  
		Last Modified: Thu, 03 Mar 2022 15:21:49 GMT  
		Size: 575.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4df991d0ad2adb8321f8dafe9ba672b3fd6c62e2533197da4d93378ba3a56c5c`  
		Last Modified: Thu, 03 Mar 2022 15:21:50 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fd92f2c678ed3e4553c28b4e3502cb37929fbd1210a7d89da85fecaba0594be`  
		Last Modified: Thu, 03 Mar 2022 15:21:50 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c298beb97779dd9cf143d512ce923216344cb900b1182de6568cd09d15627366`  
		Last Modified: Thu, 03 Mar 2022 15:21:50 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b0bcdec1a1e4a0051c2ecabc4ef314a5b8605d50177670e0f311970f42e6ac0`  
		Last Modified: Thu, 03 Mar 2022 17:05:37 GMT  
		Size: 49.2 MB (49188478 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:3082b594e22c7b32edb1ea49cbcbf8220fb80abdfff64e130754ea379650f74d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.6 MB (230566705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df608d370ea1ed49eefd10da89f45f61c9ba9f390edc996a49b56d24f0eec05c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 03 Mar 2022 03:51:22 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 03:53:45 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 03:53:47 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 03 Mar 2022 03:53:48 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 03 Mar 2022 03:53:50 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 03:53:51 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 04:03:57 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Mar 2022 04:03:58 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 03 Mar 2022 04:05:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 04:05:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:561a9d3cbc0620246bd8a71605afaf3aa9c2779ed8ba3a124bcd5c27a6f459c5`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1289e433090f961fd1c3cafcdcfada8bcf71376c81361a6cf9af22caff439a95`  
		Last Modified: Thu, 03 Mar 2022 04:09:01 GMT  
		Size: 38.3 MB (38260639 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77fb4f341ed67dddefd64dd85ac128cf1d5dde149aedbe3596b481159c7f98bb`  
		Last Modified: Thu, 03 Mar 2022 04:08:38 GMT  
		Size: 1.6 MB (1648723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa5b1e2dcce1f32f585d2509ae5052c33a5ee297c2883125a6a3085f5e89a989`  
		Last Modified: Thu, 03 Mar 2022 04:08:35 GMT  
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97b713630c01b4fcdcdc5efff36d229aa9cd0894c3e4c1aafde2b461af7e056f`  
		Last Modified: Thu, 03 Mar 2022 04:08:35 GMT  
		Size: 935.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cc1f7f9c269cfddc411d3eb9bebadd38a408806e73b88ad962675317bf6e7c3`  
		Last Modified: Thu, 03 Mar 2022 04:08:35 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27871f43de661e525d6a7e2054af224f9eb08d604a3d13be7c031836cfe0a137`  
		Last Modified: Thu, 03 Mar 2022 04:08:35 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2aac1e770794ec0deb315d76eb18efa19ad4c7e9d674c52d86534da3e635befb`  
		Last Modified: Thu, 03 Mar 2022 05:53:41 GMT  
		Size: 49.2 MB (49187109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:bafe1780c9907dda141ae7b8e9f956f83af6fd3c13f607c31b69637bf13b90f9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.3 MB (223250058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ae2c386dfd6fa960ed44883c430a06eeb567fa435874c927b84fc0bc57b3089`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 00:25:27 GMT
CMD ["apache2-foreground"]
# Thu, 03 Mar 2022 09:35:53 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 09:38:07 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 09:38:09 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 03 Mar 2022 09:38:11 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 03 Mar 2022 09:38:12 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 09:38:13 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 09:47:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Mar 2022 09:47:26 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 03 Mar 2022 09:48:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 09:48:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2fbbf7854cfa0197542a5513af244f18cb735e6ad381c9e7654ff4705e1e350e`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:195ee5e4dca73f7b2887eaa29e4aa25718c3959190945e31e318e3c0d6d97bc4`  
		Last Modified: Thu, 03 Mar 2022 09:52:49 GMT  
		Size: 35.6 MB (35555840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:194fccd6209c7a13109b5d44722236786dee23a5c7425ae3534f51f46f9ace1a`  
		Last Modified: Thu, 03 Mar 2022 09:52:30 GMT  
		Size: 1.6 MB (1592289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d82715bb2bc8a473f2e8f50730dc333cf0073803717170934bb9d62749a687d`  
		Last Modified: Thu, 03 Mar 2022 09:52:28 GMT  
		Size: 583.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b20c055a02538a1fc84633abc50853602087ec21cfe3e902acca14fce2f62f19`  
		Last Modified: Thu, 03 Mar 2022 09:52:28 GMT  
		Size: 936.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25ca64889ab1f14dd56a8f0b23a0d553b15d7bc107336bf4163a0c94b4337c30`  
		Last Modified: Thu, 03 Mar 2022 09:52:28 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b48e303a2c16ba1cae4a248162bf2cf175b84b48c8d5be2575b4957a000e43fa`  
		Last Modified: Thu, 03 Mar 2022 09:52:28 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2e544ec1f9ca80d1f87b3139d74ea3e8ee7fab12333e799478d2a8b7d58f16f`  
		Last Modified: Thu, 03 Mar 2022 09:58:24 GMT  
		Size: 49.2 MB (49187035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:a4f8f7e7c08bb61d90747025d4c3e0d6d1d2623f55c15b8b4e24a9ce3adc739d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.3 MB (246293444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04f93f34075dc8ae6cb9bf25d69a89962d122b5cd1b1182686aee46fde9d3f23`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 01:32:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Mar 2022 01:32:25 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 03 Mar 2022 01:33:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 01:33:33 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:38f1c7d808e06b37994c903767a1ff4c7fb5d52ddf99ef519146c38e16cf0362`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34bae93e0898aff92abd02afe986d1472d9492c1352d938afe369dc6255b3853`  
		Last Modified: Thu, 03 Mar 2022 01:39:18 GMT  
		Size: 48.9 MB (48945896 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:5061415724176ef8a4a1bc019ae20ec7811fe8bd3a180e42bff858cc924dfb42
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **259.6 MB (259567131 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d92c91e6f969add86158cb522591faf2cb3cba30b6ee08c8615fd5ca7d4eda29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 02 Mar 2022 22:08:38 GMT
CMD ["apache2-foreground"]
# Thu, 03 Mar 2022 06:56:26 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 06:57:34 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 06:57:35 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 03 Mar 2022 06:57:36 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 03 Mar 2022 06:57:36 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 06:57:37 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 07:12:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Mar 2022 07:12:05 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 03 Mar 2022 07:13:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 07:13:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:90afb76127aad1cd565f3322409fd3141b6c700c2d2e1fe1e2c196e43793b9f7`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16774a9e92ea09da6a0f4d3fec50de4593fbe1ff17c026413212d96435b569f1`  
		Last Modified: Thu, 03 Mar 2022 07:16:35 GMT  
		Size: 42.7 MB (42654384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88f7d0de05b320a597e267c6b649d59dea88e229b3de69291c12fe642b96788d`  
		Last Modified: Thu, 03 Mar 2022 07:16:24 GMT  
		Size: 1.7 MB (1708674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bff4301492c14cdc0ab60e8f27a23f1abef8a5963d307888c97ddeca464297a8`  
		Last Modified: Thu, 03 Mar 2022 07:16:21 GMT  
		Size: 579.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4718c88768e9450679f839674263c601940a167b4b536736dfc068891ef5510`  
		Last Modified: Thu, 03 Mar 2022 07:16:21 GMT  
		Size: 934.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c80ffd93a63d39e37fabdaaac4c66f51295fcd7fbbe10ad5cd01bb1b034aced9`  
		Last Modified: Thu, 03 Mar 2022 07:16:21 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a2ff3d1f882c4e994aa8db52f68cfec203efc7a2ad8d9baf71a487e8d7f2a8a`  
		Last Modified: Thu, 03 Mar 2022 07:16:21 GMT  
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ce1c0aa0f796b8919000503d896c12dd539fe3e68b909968bc76d642af15e90`  
		Last Modified: Thu, 03 Mar 2022 07:21:23 GMT  
		Size: 49.2 MB (49187761 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:ba0af5fa050b6d935624426cf1ed4409b12ef69d8c7fbc3d89c5e07e37b652e1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.0 MB (259951737 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9b6d0738b56795a20b475eb19f8b5f06c0e321983f86d79cf75cd7056eded4c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 03 Mar 2022 16:44:58 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 16:47:02 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 16:47:09 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo "<Directory /var/www/html>"; 		echo "  RewriteEngine On"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-f"; 		echo "  RewriteCond %{REQUEST_FILENAME} !-d"; 		echo "  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]"; 		echo "</Directory>"; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Thu, 03 Mar 2022 16:47:18 GMT
RUN sed -i "s/<\/VirtualHost>/\tAllowEncodedSlashes NoDecode\n<\/VirtualHost>/" "$APACHE_CONFDIR/sites-available/000-default.conf"
# Thu, 03 Mar 2022 16:47:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 03 Mar 2022 16:47:32 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 17:46:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 03 Mar 2022 17:46:59 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 03 Mar 2022 17:51:46 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 17:53:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f4c000db9ce437aab5bf348a3684bec5db60826027c9db65f8b11684826b8bc0`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2629b5fa68e7c15b9a991c78d6cf90e997ce38c8c01fcc9b18ef6f5cf1d08ad`  
		Last Modified: Thu, 03 Mar 2022 18:36:50 GMT  
		Size: 45.0 MB (44984393 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13f13924621eb01026ceda236fd9c4fa5a35893ad7af6f7a1481101b410abbbc`  
		Last Modified: Thu, 03 Mar 2022 18:36:11 GMT  
		Size: 1.8 MB (1770601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b458244ab87ab4f9087eabca7056e87f40fdea03d91558ed32e192558413f976`  
		Last Modified: Thu, 03 Mar 2022 18:36:05 GMT  
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:838ef0f4efd10eff445a796670a6ff1bb4c60d8a62d9a998738075ed19261bff`  
		Last Modified: Thu, 03 Mar 2022 18:36:05 GMT  
		Size: 938.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47fae386e971239942cde7ece4045ee62925e0201bca81353333bb4d83b7d12e`  
		Last Modified: Thu, 03 Mar 2022 18:36:05 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a619838799f130f185bd53116ae19eaa4f48a456e7750f8c05f7fde1ac0c896`  
		Last Modified: Thu, 03 Mar 2022 18:36:05 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c63c28bd3457e6d3f558835b2d8983455d3a184366e8a447d75783c6be53bc8`  
		Last Modified: Thu, 03 Mar 2022 19:06:46 GMT  
		Size: 49.2 MB (49187280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
