...
```console
$ docker pull mediawiki@sha256:e6233db6edb28e861d41a8e34085198e1ac4068ee3e377ee9c1ca1533549700d
```
...
```console
$ docker pull mediawiki@sha256:19f6b1bea3be096f33e623cf48909db245d62e7cfa95119492bfb98e9786883b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.1 MB (293147224 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f8141827e38660966257d2860bbe71a8af710963f49520097960847b936bb21`
...
# Thu, 17 Oct 2024 06:05:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 06:05:38 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 06:05:56 GMT
...
-	Layers:
	...
	-	`sha256:c3a78cf91800a632f588cc44a990b663486edca5e5491e2731129dfe2b8b1e69`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40473324f4efa0644b25692e17d12c41b995b7ac1d33c4ec792d4acb89b37b43`  
		Last Modified: Thu, 17 Oct 2024 06:08:43 GMT  
		Size: 59.8 MB (59805762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:88d9a5f704b7554acbc3693e9983b6a016a4576b7fd717548ae29ada4845eb9e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.3 MB (249300024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9db1781fe257ff925b6d77d37edc20fa17b3c7d19496723cf71590d370498c0b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 17 Oct 2024 07:28:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 07:28:58 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 07:29:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 07:29:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6b75839677a3f2575e163fee3ccf4f5cd0e8640f717abadf9b2c7c1b7c67df47`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c73ba040baa425ccd36ced69fb0f67e193301b1d8ddcf2ddad9418ee3dcb8638`  
		Last Modified: Thu, 17 Oct 2024 07:32:33 GMT  
		Size: 59.8 MB (59803465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:86b9389daf0ac40eed094edd4896dd805c2cf331b98658d6b0fb159a5d747a7c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **284.4 MB (284417123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d020104b465fac2685289ee994834ecef8ce588aef05e09d32025e403141fc1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 17 Oct 2024 05:48:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 05:48:04 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 05:48:20 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 05:48:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e246f04a92501912ec1cf55918b60be802f9b4f727f86338dc78e8cb6b818e8e`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bca09b641356ef499c5143106071797febfe7e2ed37520f9702cb4b2b259cf16`  
		Last Modified: Thu, 17 Oct 2024 05:50:51 GMT  
		Size: 59.8 MB (59805685 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts` - linux; 386

```console
$ docker pull mediawiki@sha256:e274b63888ee9cb1b13815524df0aad507cbef1a9b5a4d274ab6ac6507a6f5c4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.6 MB (293599107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f38d61907935b9cd76a20cd084c0cea3c19dd2bbc5230206b7c3e1d5bb76426`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 17 Oct 2024 07:19:22 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 17 Oct 2024 07:24:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 07:24:25 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 07:24:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 07:24:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:76af890dd6ff97a419f08b8a15e60e15a97477d2e8da3e73b0b7b01e20328838`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e39635d9f9c0b9dff90130905960fd160cdc5126dc9c3a025429480cb17b7554`  
		Last Modified: Thu, 17 Oct 2024 07:28:29 GMT  
		Size: 59.8 MB (59803931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
