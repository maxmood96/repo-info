...
```console
$ docker pull mediawiki@sha256:5a6db66806177701404cd2b7f53b028fa14c30b66b2a3159f04674e581bf2ab6
```
...
```console
$ docker pull mediawiki@sha256:b119e9f80fd5cc72d5a5833c36b7067b778e388ea42f0ed96f88509f0d95608b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.2 MB (156198729 bytes)**  
...
-	Layers:
	...
	-	`sha256:b55f2a4854779183b8ed4518b26af6e3fab5d9b7496213cf5b8d614be8593c08`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56b2c8eaa9e1fa29e5473bc04e8756d98c8051d8fad140230838351ddc77086a`  
		Last Modified: Fri, 11 Mar 2022 15:01:29 GMT  
		Size: 50.2 MB (50169899 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:64cdd73f00ced689dfc0570ae9b755f4cc4a906df47e8ab812a778cd2ed557ae
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.8 MB (151831794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cdbcfc55535b08952ac16350e0acd179bd8271d5bce48016961d75ee6f4c26e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 06:09:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 06:09:15 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 06:10:31 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 11 Mar 2022 06:10:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:362b589389a514f8d1d1ee549595da74de3981aa139ff7d45a12ec9caae152de`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21925f0f694e99b3be7b12124b16858552d5e15475979a1ea3b5181eab3929b8`  
		Last Modified: Fri, 11 Mar 2022 06:15:14 GMT  
		Size: 50.2 MB (50170170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:985f3b36b1a43009a90efad11fcdc1e7472de097f40514f3b5c18174bfc4a7e5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.2 MB (147241119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9792fe16589948ca4f0b9189907539f78527ac351d09ac5bc352441af6f94c36`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 23:23:48 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Thu, 03 Mar 2022 23:23:49 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Thu, 03 Mar 2022 23:24:50 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Mar 2022 23:24:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5fc5c9a70012c6d840792de720be5118ebd163a1656aaf2385116b48ba69de15`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18574482bb0550277644229c7ae7db9d8c6a5c8bb05b75775857304453f38532`  
		Last Modified: Thu, 03 Mar 2022 23:38:10 GMT  
		Size: 50.2 MB (50169340 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:607825083882ed91acfe0e03dc50a7be0db93b680ed21c3461006a0b02436c40
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.7 MB (154724705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cef519af8c122b8593c8469ec30d4b572382e582b6972c401502aa142c4efff7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 13:08:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 13:08:43 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 13:10:37 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 11 Mar 2022 13:10:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:11f27f6c766366657bbfdedc217c663deae9b965109ccef029d19d331af9179f`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:383fd6cdd1577a2372b47269acadfc952ea2ca288c068e40212ce249ed27a6e2`  
		Last Modified: Fri, 11 Mar 2022 13:19:28 GMT  
		Size: 50.2 MB (50171627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:22b1b377366401472e342951f871f9ca26823db7df877b67c654b05f2b3f6b07
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.8 MB (157848860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b25db705d83ff361d881e5072d5efecbaa746c43180a21cc74e42365b8d4a122`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 17:41:28 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Thu, 03 Mar 2022 17:42:12 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Thu, 03 Mar 2022 17:44:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 03 Mar 2022 17:44:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:427a26fd50e9b719e53d1457e72a191731bf469e4fbf94061c579925f54a7050`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73be23ccb81cdcb06e0c3b4dc2bb3eef28b4426e83257311d3d9db94088b6881`  
		Last Modified: Thu, 03 Mar 2022 19:04:13 GMT  
		Size: 50.2 MB (50169360 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
