...
```console
$ docker pull mediawiki@sha256:d1cc393de566e33ded45107e24ea6bef14afc4642aeb2b05e3e7effd6ce8ec74
```
...
```console
$ docker pull mediawiki@sha256:b2ba67b99efbdb8fc05b5cb0c7315be2dbd2beca0f2ddc3d0ec7846c8d519d47
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.6 MB (143628107 bytes)**  
...
-	Layers:
	...
	-	`sha256:be42b7e759389a7dbe6efc5b3337bf740ccdd01e1fea8985d4f3ee5671847d70`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b59e1f5ed9cac3180ad50b28fb4417a27db5bbd5f8ee2ad72611065bdcb74889`  
		Last Modified: Thu, 04 Feb 2021 22:16:49 GMT  
		Size: 41.0 MB (41022881 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:f5558ebefcc98d82c5bbae220627790ed07ffd9f5361dc8298fe6deb7b4a5a8a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.3 MB (139296091 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7d1b41146576dafa41803363468c732821eae9d12ad49a7475f970d433ba115`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 04 Feb 2021 18:37:39 GMT
CMD ["php-fpm"]
# Thu, 04 Feb 2021 19:54:27 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Thu, 04 Feb 2021 19:56:05 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.19; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 04 Feb 2021 19:56:08 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 04 Feb 2021 19:56:11 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 04 Feb 2021 19:57:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 04 Feb 2021 19:57:10 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 04 Feb 2021 19:57:33 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 04 Feb 2021 19:57:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d240c3eca5c4ae02078cc2b9b65130a4764c1cf0fd057704930d978c935cb7c2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a001258efebaa1967f8f288853d5fcd278a4dbf2cc9f88df3af045da3d63e171`  
		Last Modified: Thu, 04 Feb 2021 19:58:50 GMT  
		Size: 50.9 MB (50881821 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e98ce5af5fed21253b70fb5a01db638962dff55dba6c3d82d47f528ae2afea9`  
		Last Modified: Thu, 04 Feb 2021 19:58:38 GMT  
		Size: 17.4 MB (17437964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d6b46f4349b2596206aa1cee3dabe32fe494cd4460993e24934008a7cf50dca`  
		Last Modified: Thu, 04 Feb 2021 19:58:33 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0e34fdc52430b8e5eceb7c016a455d20eabe3c19a0d2134e614ce624c37b5fd`  
		Last Modified: Thu, 04 Feb 2021 19:58:33 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3f33542f2eefd193abfeb23aca7992597c43009ae2ed3a2fe12fb2acaeaa08c`  
		Last Modified: Thu, 04 Feb 2021 19:59:34 GMT  
		Size: 41.0 MB (41023506 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:8d57b9d3d177bc252c1f8bffb62cfc26e72581ee65f72c7655f0ae4a226c455e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.6 MB (135622779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:50b65a06e72a4738dff59f898dc9cf3a1e5b445147886cdd4cf4576319f679dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 04 Feb 2021 20:23:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 04 Feb 2021 20:23:20 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 04 Feb 2021 20:23:43 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 04 Feb 2021 20:23:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bb132d08e169bacd4b6ab23da4f14ec9eebff46741856821411d8d358f8400c5`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:943d53abb666ff282a124cacb72ed99f5c210c49f71279c8d2338bcb596defa1`  
		Last Modified: Thu, 04 Feb 2021 20:30:15 GMT  
		Size: 41.0 MB (41023484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:5936be797a85e3989a13986366263a7aeeb2605ad977aa0b987cc09531eb12e4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.9 MB (141936804 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:511ff86962d1e4233263faa386f4564ac3cf0e7db30500866a7f3903c26d9e69`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 04 Feb 2021 20:47:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 04 Feb 2021 20:47:53 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 04 Feb 2021 20:48:10 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 04 Feb 2021 20:48:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bd440b57f2a4ea6464a6baba3d68147dbac8f449acd69e2c647cbfaa47d8af64`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74613dc634c288033e25faf586163aaeda34c8ea1f6700c29db21e29093cad7e`  
		Last Modified: Thu, 04 Feb 2021 20:53:31 GMT  
		Size: 41.0 MB (41023379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; 386

```console
$ docker pull mediawiki@sha256:129273c705b1ba829c7d08723745715eb45d88a96567c61483f0a9215f73a2d8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145062568 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cedaa2e9d3dbf17b946f278f051ec558bfbd496070055e3d32b7032f8cd4c1b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 04 Feb 2021 22:45:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 04 Feb 2021 22:45:54 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 04 Feb 2021 22:46:08 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 04 Feb 2021 22:46:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ddd8b099ee91b0b9e3766708fbe0db77c130e0dc35e83852b920a94002bfd34b`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b7a22e9e3d97dc5a16a4fed3117fdfeca312bf304f3fe1be8cde00b5f069ef2`  
		Last Modified: Thu, 04 Feb 2021 22:51:23 GMT  
		Size: 41.0 MB (41022999 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:65b546a9651519a6b6d8c59d1012a270439f09c9a7517175e868162ff74fdb80
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145598302 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90b39e6df46f02e3b147123a464fe44f7fa5722b217fd1d4e1b05354e4d6a843`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 05 Feb 2021 00:20:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Fri, 05 Feb 2021 00:20:55 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Fri, 05 Feb 2021 00:21:59 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 05 Feb 2021 00:22:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:aa7adfc018862cdb55a70aa792727ce3fc056536905124563c962a13faa70c52`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b82584881f78a505360206cb140a7d48a9a293343210d0ba3f31a14213a2855`  
		Last Modified: Fri, 05 Feb 2021 00:44:00 GMT  
		Size: 41.0 MB (41023537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
