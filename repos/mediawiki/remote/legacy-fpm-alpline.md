...
```console
$ docker pull mediawiki@sha256:fc507d5a6a715a9db15e1cc7f576f184a9a5e3f60ce2e78330f6c38a3a09ce16
```
...
```console
$ docker pull mediawiki@sha256:313f2ab4eacc4560d0c29968e14b588454e1f5d915513017f1b8dc04975cad84
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.3 MB (154330689 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecb91c3c1fe4112cb8c55dc18714b46a9fd1ba8ae500bb936396d14b090f2244`
...
# Sat, 28 Aug 2021 02:48:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 28 Aug 2021 02:48:31 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 28 Aug 2021 02:48:48 GMT
...
-	Layers:
	...
	-	`sha256:24e9d71f87a595843d02673b126bf15fe4712ebe6be95cccfc0a47631830a52b`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7230a3c037642e92a11630965e2419da1a036ed4dcb0810881ee9a3367a3e58f`  
		Last Modified: Sat, 28 Aug 2021 02:52:09 GMT  
		Size: 48.4 MB (48433291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:006016a3dde57d7a6ae61bd849255508faef1b04da161028ba50687f8f5a76e3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.1 MB (150145266 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0f0e1cf0a1bce95052357e26f63ec010b5ddab6aaa4d32d65c52a37b1ed9f174`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 28 Aug 2021 02:11:57 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 28 Aug 2021 02:11:57 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 28 Aug 2021 02:12:33 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 28 Aug 2021 02:12:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:50a369bd555cb33be02c87bfca0ac57a1933fe0286c11eff80bf22db162a3da0`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3dc970f35daf95cb06c88a69342acee5dd85975f1ad59c99569872ce223def73`  
		Last Modified: Sat, 28 Aug 2021 02:18:58 GMT  
		Size: 48.4 MB (48433523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:80eaf52443cfbddd3fba9c523fbedff5ed227f82ce73516a76aa39f8b1d6987a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.3 MB (147311467 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d9c271a546bb1ee2e06e2d3737f77a8c5e7713bf807726cc9d9f58adcd0c610`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Aug 2021 10:29:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 27 Aug 2021 10:29:58 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 27 Aug 2021 10:30:39 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 27 Aug 2021 10:30:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bcff309aa98503b761b8f6f12c5a3e6868a4e19419c479dd539bf33a56b4aa86`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1176ab2cc4c1168007dfb7157650a314ab669731b998b5f8db991e544fdfbbf4`  
...
```console
$ docker pull mediawiki@sha256:1f5ede36cb0a390f923566e89d539d856fe0ceeecbc64e9ea3d46da5bcf931c4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.2 MB (156161894 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:396f2063dc70c94068cb958a2b9f1c05b25a5b9f3acb9f5d90c731d08ebf72df`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 28 Aug 2021 01:50:21 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 28 Aug 2021 01:50:46 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 28 Aug 2021 01:50:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bd0bbb4435984ed54caaec3802248fed78f27a5bbf907c712b1635cbc2d0b88f`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2073eb41d4e79cc988c3248b5cb0065aeb66db93068310ff904c6c8465e9091`  
		Last Modified: Sat, 28 Aug 2021 01:55:20 GMT  
		Size: 48.4 MB (48433383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d4f5ff95dfaf2bc587b24c24c60574b678873afe812deb191edbeb9c963ccca3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157950320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14f1b61465be6e35253aeeded2dec150dc661aaaf9e58fa9f050f0a9bb7fdf8f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Aug 2021 14:04:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 27 Aug 2021 14:04:45 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 27 Aug 2021 14:06:28 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 27 Aug 2021 14:06:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cb3da7738d025164732318c190d7a2150a64482f3f2a8f084822dab2a3246c65`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f486f12b75b6eecebd92ade1b4b7a526c9d8873c77f22fc446e0b697a5d5e97`  
		Last Modified: Fri, 27 Aug 2021 14:45:16 GMT  
		Size: 48.4 MB (48433375 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
