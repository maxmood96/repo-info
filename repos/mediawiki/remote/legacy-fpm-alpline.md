...
```console
$ docker pull mediawiki@sha256:0537a732f1b8e6317e069613454dc02ac5561ea92fbbd4c077e7e2486fda3050
```
...
```console
$ docker pull mediawiki@sha256:285573f0a5b02bb9f69fa7f44a22481d8a586fd3757b0cb9a18644bef2fd77c7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143658512 bytes)**  
...
-	Layers:
	...
	-	`sha256:c35981483285493e82f1292dfe035af665ac5467b367fd43e09bdadf663eb341`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2f772fee33fb6773d57870cde99a1e0d06fd0db3bd65c8d46e39d048aeac869`  
		Last Modified: Thu, 15 Apr 2021 10:51:34 GMT  
		Size: 41.0 MB (41023626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:3c49ba48fb8b1646e6c3c53d3b6f40cd93bb591fe6b3718baece9b242c7b1fcb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.3 MB (139317683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad5b6f8b81027cc2d9f5320d48f9d794a1e2bf8a883ef5e65c4a1a3a2421cbeb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 15 Apr 2021 07:55:05 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Thu, 15 Apr 2021 07:56:35 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.19; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 15 Apr 2021 07:56:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 15 Apr 2021 07:56:39 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Apr 2021 07:57:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 15 Apr 2021 07:57:33 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 15 Apr 2021 07:57:57 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Apr 2021 07:58:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d55e3cb126fcbe0fdcf086f5d99571d30f2565d8cd5206f536fa48bc0cf5829`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9f4248858a634acaf1275394157dcd57cacb9c3eaed5fc49ea075365046bb1ac`  
		Last Modified: Thu, 15 Apr 2021 07:59:25 GMT  
		Size: 50.9 MB (50893741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:364e6e762466df61dc20da4436551be005a0474b3ee2e7ec8b27212779c820cb`  
		Last Modified: Thu, 15 Apr 2021 07:59:10 GMT  
		Size: 17.4 MB (17440853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0b6a9feedac2a8ec57bdbc494bccad18f9ce5c492431d404df1c16cb4bbaf30`  
		Last Modified: Thu, 15 Apr 2021 07:59:07 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dafc8d99c8b93c918fa9798b45f81e867ae4762999da0be3814a88bd1573d63d`  
		Last Modified: Thu, 15 Apr 2021 07:59:06 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9576c2c854a44731b606bdeefc523cbdd0cde7f41774d94f57d82f9f68f2cb0e`  
		Last Modified: Thu, 15 Apr 2021 08:00:06 GMT  
		Size: 41.0 MB (41023762 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:253bc7888db60bc54037132618c5827774d6df2041a29ca619002d645c2fab3a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.6 MB (135632686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5299ee8fd1e203eab1d1c7c8ac976d92a5a1ab4978ad7f1c1062394d7f41478`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Apr 2021 08:51:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 15 Apr 2021 08:51:41 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 15 Apr 2021 08:52:06 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:44a780c0f6cce3f64c5b474a597d44ce37d0dd16b8d5affba0be99e021744c7e`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9fcbc13ae33fcf1fb818317e501428bf4b8619c46c4d6983d79aa326465d222`  
		Last Modified: Thu, 15 Apr 2021 08:54:40 GMT  
		Size: 41.0 MB (41023867 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:8ae5ee9f6757d7386376268968944e8a83d8184899cc2cae7522fddaeab0b013
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.0 MB (141966509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d714a86e36669fd5d19a20ec46f8facd3c0b717f5e0414bcb699ced35165f17`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 15 Apr 2021 09:41:32 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 15 Apr 2021 09:41:47 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Apr 2021 09:41:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:50330dbb291c3d23a3587293b55c0cd21c2e6da2052295dec35d22216df40b04`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f0aa5e457faeab8cb9b03d3d6e863085e2138c5f617082fd54cc6d2d0d60d26`  
		Last Modified: Thu, 15 Apr 2021 09:43:53 GMT  
		Size: 41.0 MB (41023409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; 386

```console
$ docker pull mediawiki@sha256:31a979fb5ba42e703065e84d294dfc51a2297157e7e1ce8e0a609471911cd0eb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.1 MB (145089700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ff25ca8b995500a8a5d20b3f36daf41c011af401d340256b1711d032b1038b0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Apr 2021 09:10:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 15 Apr 2021 09:10:20 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 15 Apr 2021 09:10:32 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Apr 2021 09:10:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e3c95501584877bf4bc5e33184ed645d4aedb9524749cfa862f1b659de6d2ea1`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd6e0c4b30e56b584fc293636c4c503b1f1a747efe886b4b8f765223db2687cf`  
		Last Modified: Thu, 15 Apr 2021 09:13:26 GMT  
		Size: 41.0 MB (41023600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:97a1ec90f40ae41cffff2e542fccc366d0bf9cdd971429d942d0bc9185913d1f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145634085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff35900eb35b8427f2afdca2f1d8f99566a0d4b5bdf7c0cdf1618c53e7ddebcb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Apr 2021 09:13:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 15 Apr 2021 09:13:32 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 15 Apr 2021 09:13:57 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 15 Apr 2021 09:14:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a88c54f071b42d2f1a2850aabc6bdc811a2facba995edceeb5ae5ebf2cbd49fb`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8ac8c8e96c0ace351cd2c0507ab04d4406d23961accb09adab90be6e5a7a739`  
		Last Modified: Thu, 15 Apr 2021 09:17:13 GMT  
		Size: 41.0 MB (41022858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
