...
```console
$ docker pull mediawiki@sha256:2b9961f87cda684e2a890e50eb4c6f879427bfe42cdd5e6c1b430e6c4e1e6276
```
...
```console
$ docker pull mediawiki@sha256:602fbb646001408caf25f3e2013d94e454c3e228067e9bf150fa833f2b665812
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.7 MB (143738952 bytes)**  
...
-	Layers:
	...
	-	`sha256:83be855bb73b285679b8bc3ce2dc5bb4b7923af91f00bd35ef6991fa92002982`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e753bf52d9d5fb7b6057b843ec249c96cb2947e4dbe4522d0d10e6543a0f473e`  
		Last Modified: Tue, 01 Dec 2020 08:40:09 GMT  
		Size: 41.0 MB (41022394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:3aa4f92186ca74645bd7e3c3e1af4fb3a51df22d02894b5f7d19aeab07ce6685
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.8 MB (139800827 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86235d7097de8d96f1ad086612494ad6f70d0df993ebaee051f75a46d5b2cd5a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c2d578a4e78cedaa67504c5dd022b14d5d0d59aecbb698446de5de453eebcd1b`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5de08eae4f03f916302d8f6c64b43f29d0b891bd40e5e5370f0f660e0468b858`  
		Last Modified: Tue, 01 Dec 2020 03:45:09 GMT  
...
```console
$ docker pull mediawiki@sha256:8e496485f951207df522aaa140150d72a74442460e45a275e9fc0c9ceeac1b98
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.0 MB (136047210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df28777b52e5cb05bc5a292c40f7ddde318d0dacdb660cc2b8929af5a72ff6c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 05:48:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 01 Dec 2020 05:48:51 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 01 Dec 2020 05:49:12 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 01 Dec 2020 05:49:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7851824ef41bdbde23657a5bc4fcf197e71e2b8e56f1f6d09bbebe3b71f1818a`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19ef07b6a46cf8544fb95f0442d8613ae91350aeac0b470692a7b45a5699f563`  
		Last Modified: Tue, 01 Dec 2020 05:53:16 GMT  
		Size: 41.0 MB (41022465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:d28242ba77b76aab8918fe59ad14ea5d2c4523fc4de042401f9f28aae932d302
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.8 MB (142774873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:45fe648d74e309713dd5384166d982989a28ec39da20914c867cca8848ed2c17`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 08:25:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 01 Dec 2020 08:25:47 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 01 Dec 2020 08:26:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 01 Dec 2020 08:26:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1b59e1390313e3e72ef5dfb84033b4e1fada9bd5f86ca090baa092030438221d`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:240dbc06e439178578d68d708da53fcae43ecbce1dc9d8fcab1be58f2078dc9e`  
		Last Modified: Tue, 01 Dec 2020 08:30:04 GMT  
		Size: 41.0 MB (41022291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; 386

```console
$ docker pull mediawiki@sha256:120b76ce392667e7c93f5f90a0e5a030ac1d85df7c982f63598bb4288c909f3f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.2 MB (146189245 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61a39d094d9507246c67d655551a690f3cb199f8ad1423196ce61eebb3b7c395`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Dec 2020 07:51:26 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 07:52:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 01 Dec 2020 07:52:56 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 01 Dec 2020 07:53:08 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 01 Dec 2020 07:53:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:08c411f33b7d809c64dbc4dda6136081386feed4becd5d3830120f0dcea48918`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:053bbb624feeb8d587dfa569e4c12081786f431a6db1503b57b847f4f2234358`  
		Last Modified: Tue, 01 Dec 2020 07:56:44 GMT  
		Size: 41.0 MB (41022411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:7e0a8c0b880a12a50c9178cac3fbec08b7d245face53f1e6433a29a10a60f07d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146637038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3624cffcd79a689f6159da69f9b97a241423f3df99d6cbd11820bf7224bf83a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 01 Dec 2020 09:23:04 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Tue, 01 Dec 2020 09:24:26 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 01 Dec 2020 09:24:33 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 01 Dec 2020 09:24:42 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Dec 2020 09:31:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 01 Dec 2020 09:31:06 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 01 Dec 2020 09:32:50 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 01 Dec 2020 09:32:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6361ae12183dd3c5178ecf61fd21a51809c9b97ea153a80c6bf37982442f960a`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:faeddf0aea3f0fa41c833e94ab4f1070ceac71ea9cb308b0780599de70092f64`  
		Last Modified: Tue, 01 Dec 2020 09:39:32 GMT  
		Size: 55.2 MB (55245288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4e67fbef4cca38d2dec98a0f83bba6c77eac9230dde8a062ef3d1a416abb473`  
		Last Modified: Tue, 01 Dec 2020 09:38:48 GMT  
		Size: 18.1 MB (18127880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:baeba7b95bad450643e7cc1ff59164108e74b8b54eddd745a6913489594c278f`  
		Last Modified: Tue, 01 Dec 2020 09:38:40 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc2a0c17217638f4aed92c20c759ec1182bd7b85945bf4e02cda2c89b701750f`  
		Last Modified: Tue, 01 Dec 2020 09:38:40 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d24ef7a0aa3d7214fc836602809135d6b6d13dba8882628721762e29242584f`  
		Last Modified: Tue, 01 Dec 2020 09:45:28 GMT  
		Size: 41.0 MB (41022491 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
