...
```console
$ docker pull mediawiki@sha256:684f236153a29def311b315393f59571e7c6118af8978ae20faabe4300ec3d48
```
...
```console
$ docker pull mediawiki@sha256:5fdc08c33323da6fd2c08c8c775717c1621bb04e028ccdd0c90e2a8befd1c6de
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.9 MB (153901448 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a2658b4efa5f984ee4ded71936554abf5f32d294fdfe43ff577698653e7e1fc`
...
-	Layers:
	...
	-	`sha256:03a56912270cff8598a6e64228498e1b3196a8efd246bd558a6f1e52407ea97c`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e6a6d97ba15ee39fd9e751bbf441f94809ba66be9af8e04d6680b50f5f0926f`  
		Last Modified: Thu, 18 Nov 2021 23:21:23 GMT  
		Size: 48.4 MB (48434295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:2da0d377873607f6a771f114af7fb672b960bc65c9a4d17289e94c6114cc4dc0
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.7 MB (149724957 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b1517a34c613ef235f57d049711fba963034f2e48eb1c27b7412661749f5e07`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 18 Nov 2021 18:36:08 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 18 Nov 2021 18:36:08 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Thu, 18 Nov 2021 18:36:43 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 18 Nov 2021 18:36:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:89a5fdaa9e87e6fc20ae1b4cb17eb558453b8f68ef4ce4602dcd198b3776be0e`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa8eefbdd584d5bc5315db3a6b00e328a1a367b677a6183aaf9e23e37620942f`  
		Last Modified: Thu, 18 Nov 2021 18:43:05 GMT  
		Size: 48.4 MB (48434384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:b8b309b397bdad215e25c9be99032f0c2e0c987a37e8d8d886940a542c335244
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.6 MB (145595644 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:077b7266ab56d4b0bb2ed00f14b1a4b71441bb29c482b09a3c9564d219337ac7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 19 Nov 2021 00:29:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 19 Nov 2021 00:29:08 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Fri, 19 Nov 2021 00:29:51 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 19 Nov 2021 00:29:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:785f1369e88c4b4bfe6d58ef68dc0d2ce4283a08397a42dc8a1a0e482b04e061`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d66347237996fee1fa2dd252ba99f9dd2e681fedcb174a96090b5f84fec79431`  
		Last Modified: Fri, 19 Nov 2021 00:51:00 GMT  
		Size: 48.4 MB (48434383 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:888c74d7dd2dd05487ea38c384f8ccc2d7f16084fc9480a76289104a9d29e681
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.3 MB (152252781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd15334a67d0c412a9be8c9085fb1071667ab93d90e4d1537083284a8fef6263`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 20 Nov 2021 00:47:03 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Sat, 20 Nov 2021 00:48:12 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Sat, 20 Nov 2021 00:48:13 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 20 Nov 2021 00:48:14 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 20 Nov 2021 00:49:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 20 Nov 2021 00:49:57 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Sat, 20 Nov 2021 00:50:10 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 20 Nov 2021 00:50:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bee09c074e685d06c59d3db8fc9c241d78fc68e320fea7ab92c8638d4d44b59f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e22bb012e0decd31fc780b3739ab6a0b76e65bcfce8d284235198f4c6e2a5690`  
		Last Modified: Sat, 20 Nov 2021 00:58:44 GMT  
		Size: 57.5 MB (57484538 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c35eb188f2425ec63ea060973a4a97b78b8c2b6c8206e23408192868c1f4c84`  
		Last Modified: Sat, 20 Nov 2021 00:58:39 GMT  
		Size: 17.3 MB (17289620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0f77c25566a4da2aceef614dd4fd96aebda75a38e90a290e94e82adb1657f47`  
		Last Modified: Sat, 20 Nov 2021 00:58:36 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de748e4daf75ba71a64b9d6859893129c4a7f491a1d314f37562cca21c1dad23`  
		Last Modified: Sat, 20 Nov 2021 00:58:36 GMT  
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5977e059efcdba3a8d4799af6d1e49c16513c9192ec844045fa0c172307b079c`  
		Last Modified: Sat, 20 Nov 2021 01:00:24 GMT  
		Size: 48.4 MB (48435234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; 386

```console
$ docker pull mediawiki@sha256:477346897395913f67690d1be0445d9c4416bfcc9721abb6002d7382a1ce7937
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.7 MB (155749735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7a664c46e4ceaa250607387800c261a6bce6aafed4fda50f0f7865fd653ba605`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 20 Nov 2021 01:16:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 20 Nov 2021 01:16:10 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Sat, 20 Nov 2021 01:16:27 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:75916bf5daad300478989ecf17fe45a7a9bcadca1ddf19601b44db8b96d615cc`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d05bb2fd4bebebb308c2b3b3a28d78c05e1e0b65ea5c6aad851806ec5bad278`  
		Last Modified: Sat, 20 Nov 2021 01:28:30 GMT  
		Size: 48.4 MB (48434384 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:26920ce75ff1311eaca756b2f0305cf9399de69367d4a843fcdb1824d3c2d6a6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155980518 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b56b56fbe92553d2694d19b880267e15d281325b338b99c6002e35460fd7fc84`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 20 Nov 2021 01:29:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 20 Nov 2021 01:29:46 GMT
ENV MEDIAWIKI_VERSION=1.35.4
# Sat, 20 Nov 2021 01:31:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 20 Nov 2021 01:31:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:50d8ea6a81dd83948100ded7a2aab4fd0efd6e19b10afcbc30de0e5c249db50c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb38bd22c713ff23be7a130fb529d46b40419025332a1dcef39d5670d583e78`  
		Last Modified: Sat, 20 Nov 2021 02:00:28 GMT  
		Size: 48.4 MB (48434299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
