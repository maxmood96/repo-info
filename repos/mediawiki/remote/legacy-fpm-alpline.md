...
```console
$ docker pull mediawiki@sha256:708986a38eb1edcf8831d30dc3a6828bbb1fe418411ecaa59dcb0c7b4006a9f6
```
...
```console
$ docker pull mediawiki@sha256:15a64b01a3fdd58ed7056a405c6813c8d2d5781ea85cb5555756910ae320f79e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.4 MB (139382929 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:494db1775a5404cad51dc781e69ebc0225d994f20611962d86795ae4a6604510`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 29 Oct 2020 23:40:11 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Thu, 29 Oct 2020 23:41:32 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 29 Oct 2020 23:41:34 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 29 Oct 2020 23:41:36 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Oct 2020 23:42:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 29 Oct 2020 23:42:19 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 29 Oct 2020 23:42:39 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 29 Oct 2020 23:42:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:689a1cae907a6f08b4e2420ceec20a0f7e0bfa5b10e4422f118fa74fab027b5f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6da69d9062c0237651a985d3d6ec725e1bfbc69b7d7ffd4f9a83076e37a559ab`  
		Last Modified: Thu, 29 Oct 2020 23:43:18 GMT  
		Size: 51.3 MB (51312879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:377552a518a4c74c42642f72dd1a8daef816ea2749f126b7f27e565b639b2d7d`  
		Last Modified: Thu, 29 Oct 2020 23:43:07 GMT  
		Size: 17.5 MB (17534396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7aa5d06efe82f0dd046a4c4da586210b91107e057de2e6028b57cabb01cc4f09`  
		Last Modified: Thu, 29 Oct 2020 23:43:02 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d155c3161de2040edec4242f08fc33906295ffed007370aa500cfe207cbce735`  
		Last Modified: Thu, 29 Oct 2020 23:43:01 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f886e2d097b1c53427eb716f65940968e129bbd9462b524814d92278d793adb`  
		Last Modified: Thu, 29 Oct 2020 23:43:59 GMT  
		Size: 41.0 MB (41022366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:d508c6aad000f89a175c0453a66a67904ac6eaa61cf9ad0f63d50e8fad409800
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.7 MB (135697628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:baba4a1c39e677830a0a271cacbc4df73daf72f90c6c170b1457ffe113279c28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Oct 2020 22:29:35 GMT
CMD ["php-fpm"]
# Fri, 30 Oct 2020 01:05:41 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 30 Oct 2020 01:06:50 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 30 Oct 2020 01:06:52 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Oct 2020 01:06:53 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Oct 2020 01:09:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Fri, 30 Oct 2020 01:09:30 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Fri, 30 Oct 2020 01:09:52 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 30 Oct 2020 01:09:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c67eb6082cc137859093dee91dd7706769070f95497591d47a23e79e10315ebc`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da28a3032bb524b1ab1beaf4efbf742870073a4f6c1f34846ed789c5e4defeb2`  
		Last Modified: Fri, 30 Oct 2020 01:13:25 GMT  
		Size: 48.8 MB (48814605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:118fdf7347796243fa393a6f23d429b18dfdd93beaefede2580686b05ba1255e`  
		Last Modified: Fri, 30 Oct 2020 01:13:17 GMT  
		Size: 17.5 MB (17493721 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a15831b07132d1d0d1a95c311ed65ceab42f8311f859d89af893ceb8d381f325`  
		Last Modified: Fri, 30 Oct 2020 01:13:08 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7ac5f0a2573417c1b4209934fe92bfc1df975c7cdce22564fd4ca83702123fd`  
		Last Modified: Fri, 30 Oct 2020 01:13:08 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d56efbdcca45c86335cbb190ac980e21255e376c4a2364838661e78b61671a32`  
		Last Modified: Fri, 30 Oct 2020 01:15:22 GMT  
		Size: 41.0 MB (41022307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:e2e9d594deaedc145b936555340f81515c011b216d3bba395d3d759a9a8ae735
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.4 MB (142383869 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f98500dfb550b7ce4dfcf59ec2c5432f9204ebe4b79ea07659e9e2922753f61`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 30 Oct 2020 01:39:08 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 30 Oct 2020 01:40:22 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 30 Oct 2020 01:40:25 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 30 Oct 2020 01:40:28 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Oct 2020 01:42:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Fri, 30 Oct 2020 01:42:43 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Fri, 30 Oct 2020 01:43:00 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:471a85f3285a0e76d9efe0bf55e69cc1b36c3d349f531657335673b1230bee1a`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60a8c151017a376a2470f3f2aaa820c03b96d5bc51dba092734478ae2757104a`  
		Last Modified: Fri, 30 Oct 2020 01:45:07 GMT  
		Size: 52.9 MB (52927204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9caa88b39ffadb67e97a08001ec9955499bec53444cd8d46810d2b8dde2d0ef7`  
		Last Modified: Fri, 30 Oct 2020 01:44:49 GMT  
		Size: 18.0 MB (17996488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e603507bb6b150691a06c43e15d39dc3bf778eceb828c8eda575bc5bbe925a8c`  
		Last Modified: Fri, 30 Oct 2020 01:44:46 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98f6bc4f16594ef749da202da056667d64078e44682696c9de791d0193607c83`  
		Last Modified: Fri, 30 Oct 2020 01:44:45 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e008454c31b64baabf5d409368304caf60f41ca6c8b7c1d632f5406d06e4c69`  
		Last Modified: Fri, 30 Oct 2020 01:46:43 GMT  
		Size: 41.0 MB (41022468 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:b8aaddabe2ae35dfffccaffbb0acf669e6693ad09a1fa88b4bf27ff5112fc659
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.2 MB (146243863 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d356988d6ce500acfb9ee4ff361fbff344e2b4a81a2be3a37b5b0083da56ee1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Tue, 27 Oct 2020 05:51:16 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Tue, 27 Oct 2020 05:52:42 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Tue, 27 Oct 2020 05:52:50 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 27 Oct 2020 05:53:00 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 27 Oct 2020 05:57:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 27 Oct 2020 05:57:55 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 27 Oct 2020 05:58:24 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 27 Oct 2020 05:58:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:21d705c0f782bbd827e58c201c0393f3e384b6fc5f58a061f5dbab83ae0e48a8`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ef4bfc7bed8d80fbcad00392c7fa0cc1fa38fa9a5cbbae3fe86daa9affd03ab`  
		Last Modified: Tue, 27 Oct 2020 06:34:08 GMT  
		Size: 55.2 MB (55244847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2cb7535d1c53b93a6c873fc362e10bcfd3eb1978cc239f644403ef836812c7a`  
		Last Modified: Tue, 27 Oct 2020 06:33:28 GMT  
		Size: 18.1 MB (18127178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a6ad8245954a19bc153283278a5f9af5f762001b7468d3182c6f1258831332f`  
		Last Modified: Tue, 27 Oct 2020 06:33:19 GMT  
		Size: 331.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef245eee1b665cbbab47e5bfb23c2c5421866dd8671bc4535d7a540c0e72bb69`  
		Last Modified: Tue, 27 Oct 2020 06:33:19 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93d67d5a444a3e03bb35ce0594c20783823493ec58d9c7df466fb93c586da213`  
		Last Modified: Tue, 27 Oct 2020 06:41:20 GMT  
		Size: 41.0 MB (41022466 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
