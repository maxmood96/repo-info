...
```console
$ docker pull mediawiki@sha256:482afe91c9bb5a5be80df4bd64920afb03b035687e32ebeca84e4ea524bcbb85
```
...
```console
$ docker pull mediawiki@sha256:a9449f3561c9bc8c8401ba9d4dfa0c7acea1649e21cff85e0242a1a37d5ac12f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.6 MB (154572496 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4baac80f65fe8844428c4da5569dc26502203bd02816fa0586454461458889e2`
...
-	Layers:
	...
	-	`sha256:d1c891bd867bf09328bd2ff7a485aad4df38d8b91d391a1ce235f10237cd90ea`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de07ab8f8e24976a4859399fe7295cf26863910980744ba21951c99877aff8b5`  
		Last Modified: Fri, 24 Sep 2021 03:42:49 GMT  
		Size: 48.4 MB (48433476 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:70375bbe7ae2b73db18cbf47e9d9dbf05be2940524a3047a5208c1e5271aaca3
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.4 MB (150387260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5cc7807e15841c3f44d52458e77bd62188d60f598cd1744c85cdbf4b674ce11e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 24 Sep 2021 01:12:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 24 Sep 2021 01:12:11 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 24 Sep 2021 01:12:49 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 24 Sep 2021 01:12:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f0b527470ef526159f9482e4477008df7b21225133ca16fd4e574ca9caf70e98`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa04f9a7e5db43656f09faec45290cf7502098a7903ecc37daf43f95a4742081`  
		Last Modified: Fri, 24 Sep 2021 01:19:41 GMT  
		Size: 48.4 MB (48433489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:379df8ceae4b176ceb60e5e7a1e974f6f27629bd0a08b01859c0d3e8bb763cfd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.0 MB (146027942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a5ba61f05b42f8c81c1645ea3c0350850ef99314b2f4dc02a729785bb82916f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 28 Aug 2021 06:03:45 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Sat, 28 Aug 2021 06:05:39 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Sat, 28 Aug 2021 06:05:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 28 Aug 2021 06:05:42 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 28 Aug 2021 06:07:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 28 Aug 2021 06:07:04 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 28 Aug 2021 06:07:46 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 28 Aug 2021 06:07:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:00e7d334c343cc8027e0a29545461b9f4dfa662e109f19e25b88d891d91c23b1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1485fe9df119154ca84d2a12f763707d104d1dd0e7914c8bdcf9b08dee5db68d`  
		Last Modified: Sat, 28 Aug 2021 06:14:18 GMT  
		Size: 53.3 MB (53342944 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63ac23738fc873e4e2c32880011537f3c2ee4dc51fa7cf829365ee9f2cff1db9`  
		Last Modified: Sat, 28 Aug 2021 06:13:55 GMT  
		Size: 17.3 MB (17315344 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00b1f6a4876631244c45afda45aac83de0eea733f7721a3d7ebe4cd806fd06c2`  
		Last Modified: Sat, 28 Aug 2021 06:13:47 GMT  
		Size: 328.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b301caa1b196eaf7566ec0f179c26ff63247dac0bf4e849a189568419d39cb17`  
		Last Modified: Sat, 28 Aug 2021 06:13:46 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bbf2acee1866af7fc99e676ef1b2fb8939289822ef625a8a357ccf29622a1ac`  
		Last Modified: Sat, 28 Aug 2021 06:16:03 GMT  
		Size: 48.4 MB (48433403 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:39d242b3ff2024fc1ed69b182b1ba909a2db4edb3be3a15fc27cc42f2bd51feb
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152929458 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea4cf51d84aaf77126678c461c31ed1faeb8edae344f9e8dedd634dc929eac8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 24 Sep 2021 05:19:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 24 Sep 2021 05:19:07 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 24 Sep 2021 05:19:30 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 24 Sep 2021 05:19:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2f8288b834b94280a04432525a16d0493470ee4b3987be3801c0c2d4228800bd`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea140cd0419ffcf8660d5d2afa6a9b4e59a1fe8d0545261f5d9bef01b20ad0c4`  
		Last Modified: Fri, 24 Sep 2021 05:29:06 GMT  
		Size: 48.4 MB (48433670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; 386

```console
$ docker pull mediawiki@sha256:30c601a40ed2ba554e80e2c0901a010280e497043efb8cc2f55c1b8bdd7b880b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156444608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8c9050182405c04b3246f47564851a436cc5cf6ad9a82c0cda03602e5f876bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 24 Sep 2021 04:44:51 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 24 Sep 2021 04:44:52 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Fri, 24 Sep 2021 04:45:14 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 24 Sep 2021 04:45:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a764dfd5f3414dbd554efca01c53fb58c99f7aa2d0a1d76e959474352dae8948`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7180c7921eab5a58378717d1d795769c2780201364cfb3b9ef55482b17b2ac12`  
		Last Modified: Fri, 24 Sep 2021 04:57:26 GMT  
		Size: 48.4 MB (48433613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:771ffa546b9135e6f94721652e45cbd59ce4c800dab24c7fccc48eeb0e8860ce
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.4 MB (156418315 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fdf8c830e8021910ad9124244c7ec88cab20806ed87bec73fd9d64bcaaf9d01`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 28 Aug 2021 04:41:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 28 Aug 2021 04:41:35 GMT
ENV MEDIAWIKI_VERSION=1.35.3
# Sat, 28 Aug 2021 04:43:32 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 28 Aug 2021 04:43:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:67d4753ae504cc4c741f7018c1ad88475d0877e126c5a00fb0817751273287d5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31abe94b70d97df00670134a951111a3db1ac2b93f9c6faf311b916e6c5f515f`  
		Last Modified: Sat, 28 Aug 2021 04:51:51 GMT  
		Size: 48.4 MB (48434008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
