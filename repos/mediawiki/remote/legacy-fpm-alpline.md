...
```console
$ docker pull mediawiki@sha256:13203e54a95cfeceb4fc15ba9b7d122615630366815ffd824ca858bf4f05d8c6
```
...
```console
$ docker pull mediawiki@sha256:87c97043cb285f0e138241df7f6d56144e46b94f18a062c946c635b306f3f211
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.0 MB (144987251 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d7856f4e275de4e1a1301e7dc38a8d48fcf46c194d4c2fcaf14510d342514165`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 16 Jun 2021 19:06:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 16 Jun 2021 19:06:43 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Wed, 16 Jun 2021 19:07:03 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 16 Jun 2021 19:07:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6fb2d4b496f9900ed037a0fb888d55614020cf7745174d3acb6085f2306f6534`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a90eb3fab1f8a7aa0e005fdf9ca532563a4ae51287b7693184b085a668eeeccd`  
		Last Modified: Wed, 16 Jun 2021 19:11:18 GMT  
		Size: 48.4 MB (48421442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:32ba60c59b8d28fb6cd75de19c0cde9293ee279014669e4f307c68ec9d1ebf5a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.3 MB (141299046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72981857c769d577e62b429dcb3dd76461cfc80995d1e2d0f18e0d9f42adb9e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 14:59:51 GMT
CMD ["php-fpm"]
# Wed, 16 Jun 2021 23:24:48 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Wed, 16 Jun 2021 23:25:59 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.20; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 16 Jun 2021 23:25:59 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 16 Jun 2021 23:26:00 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 16 Jun 2021 23:26:51 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 16 Jun 2021 23:26:51 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Wed, 16 Jun 2021 23:27:05 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 16 Jun 2021 23:27:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f76c78f34171815784442b7ca4970e7565d15ebf04b137f8760f3c3daacbd622`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7251a116136eda5111b99b6749117bb3c74f4145c11cd86fb9b7ccf1e6390f27`  
		Last Modified: Wed, 16 Jun 2021 23:31:04 GMT  
		Size: 48.5 MB (48505880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6898f08a52b1e2585a4f4928635b1da143d7a7dec47cd5c157b03ccd914be46`  
		Last Modified: Wed, 16 Jun 2021 23:30:56 GMT  
		Size: 17.1 MB (17148234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41144f8e3f82627cbfba836f3981c848a7b298fca175f98910d6700515a17aed`  
		Last Modified: Wed, 16 Jun 2021 23:30:52 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c422ab52a46a1bdd1b77d312774e98dfcece947fdd7a2af14d50fd83d335e820`  
		Last Modified: Wed, 16 Jun 2021 23:30:52 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2c63f5fcf7f8b635be2eb0c460d809e074708ba769cd8c2e543a1a4db9e0a00`  
		Last Modified: Wed, 16 Jun 2021 23:31:54 GMT  
		Size: 48.4 MB (48420879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy-fpm-alpline` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:ef16faed845549c21a6bd68e1e83b3f19eb7adeac5b34bbf13c44b36c09e514f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.7 MB (147650589 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5d8e021897e64e6835f2953ea3240b7700f20effc7a0c38d5a6a8034ad47f116`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 16 Jun 2021 13:15:05 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 16 Jun 2021 13:15:35 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 16 Jun 2021 13:15:36 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Wed, 16 Jun 2021 13:15:46 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 16 Jun 2021 13:15:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7912d715c73d9b453b2d7578f60d4df1604f0e3ebb8f82434916f3cbe394b7e6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f31576d2ddc669feb3c265869f34f7bb24842f160b216ef960f44c6ce3dde9d1`  
		Last Modified: Wed, 16 Jun 2021 13:19:30 GMT  
		Size: 48.4 MB (48421442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:77c9d7ec2fc8d55431d22e092b36785ada8063ed2ebcb6ba720a395366fd06ad
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.0 MB (150992137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:745604583daf4b11f08d1b3332e3e02ce33f9eb641fd1f7342021b14bc3cf94d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 04 Jun 2021 04:57:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 04 Jun 2021 04:57:36 GMT
ENV MEDIAWIKI_VERSION=1.35.2
# Fri, 04 Jun 2021 21:13:36 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 04 Jun 2021 21:13:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c0f9dc3e5b17970d5fac60dd1ac6aa0daea0c85ba0776384663c5e060608667e`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dfe15c64c6d4cfd2ee00b8a23a102d39c315dd826663d7cc34885eac50fb793`  
		Last Modified: Fri, 04 Jun 2021 21:14:45 GMT  
		Size: 48.4 MB (48421330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
