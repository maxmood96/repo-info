...
```console
$ docker pull mediawiki@sha256:fa5ade0dc4aabf3ae454f2776a98c3ed41cfb5f44a82ba281584d49598b11e63
```
...
```console
$ docker pull mediawiki@sha256:d95434fe94f71e0725e5450789d4ff0c4a4bc0fa2d72ca44ba4866c386ad8f5a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.0 MB (139978142 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3eee41b3c0ff171fb8f9e8fc6f6229aa451f3ac0369dbdce23df12971d214488`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Oct 2020 22:04:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Thu, 01 Oct 2020 22:04:55 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Thu, 01 Oct 2020 22:05:18 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 01 Oct 2020 22:05:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:20a4db6e34bae834b0b16402f822f1519cdbde96e3f0b180c938db15add7b9a7`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0786d9fbb08e3d34d62308a495197b8478a5c3ffea0a4f799fa97816440d525a`  
		Last Modified: Thu, 01 Oct 2020 22:08:59 GMT  
		Size: 41.0 MB (41022493 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:b202616f351ee13ff7c06330b250550fa96db21f86b9657f2510bc23785f6338
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.0 MB (142988727 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:734eb538be4aae0a86a382958190434c0fa36df7cbcff46bdc3d0be1e662bc27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_VERSION=1.34.4
# Fri, 02 Oct 2020 01:09:56 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 02 Oct 2020 01:10:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0a651c69d42ed673a452e8b04f8979068bbf0af40cd2385eccadd1b41520c85f`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:828e5f7a2f7185d2910658762f1865f64065ddfcf989e79de607cb7239ddd4f5`  
		Last Modified: Fri, 02 Oct 2020 01:29:58 GMT  
		Size: 41.0 MB (41022488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
