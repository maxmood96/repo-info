...
```console
$ docker pull mediawiki@sha256:9abd8d0cfb5cbb46440dba78b62e7b4e84094eef9b013b60f2c72647c2e4a5ef
```
...
```console
$ docker pull mediawiki@sha256:7b4320e8d50b90e2ddc73d7758ce651ef81a92e6c3976a303f088a7629454003
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.7 MB (225681797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9031f131e31f07fd1e6b67df332a19ab5a0679981ee62522db7cde71b141dbcb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Feb 2021 04:09:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Wed, 10 Feb 2021 04:09:40 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Wed, 10 Feb 2021 04:10:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Feb 2021 04:10:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:87246fcf9b6982dd8a8fc34f9143f13b56343e1a11f9d03b8ee2411206ae8620`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:900a2ae7af26afb9b9312e0d3df749098ae9fa4904afa15f3885adce15adff77`  
		Last Modified: Wed, 10 Feb 2021 04:15:25 GMT  
		Size: 41.3 MB (41344966 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:20905b450f89301c591f20e7f76d42f9d4bfd01c2bee49443336c740d935ecf3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.5 MB (265527353 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36b8bc5e5efe13b0f271548279cefca27ff27276de118a050ee4243291c98318`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Feb 2021 22:10:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Tue, 09 Feb 2021 22:10:10 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Tue, 09 Feb 2021 22:10:41 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Feb 2021 22:10:42 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4bc61db246e58e6b65878da4ed15869b6566a1b43d8455de6e700b446db9f78e`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:45a0238e7eec8a5f8ab5bbc6cf518dec61d8d2f09dc95946d201f1ecc5e21831`  
		Last Modified: Tue, 09 Feb 2021 22:15:58 GMT  
