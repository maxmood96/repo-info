...
```console
$ docker pull mediawiki@sha256:aa406286f3cc0a00c370b41705014d78b0dfb510cc2fd9421589f15c505489e2
```
...
```console
$ docker pull mediawiki@sha256:1fa3a6005e1eb520e3ac5777049cbac65acd6d8d1b0004f91b267103613a1914
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.7 MB (257689990 bytes)**  
...
# Sun, 11 Apr 2021 05:26:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sun, 11 Apr 2021 05:26:59 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sun, 11 Apr 2021 05:27:12 GMT
...
-	Layers:
	...
	-	`sha256:f0e735a4154cbca5ecfc08f356f8339ce5a74e65062b6663a0c5129dbcefecbc`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ffc3d54445d41bf25b20b7a2e884580dadaf4ba64f802f0ed4d04187472951b`  
		Last Modified: Sun, 11 Apr 2021 05:30:24 GMT  
		Size: 41.3 MB (41345172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:62f28ddd5dcc85b618ea32038354075c819e6657bbea42d17f69d8f579cae992
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.7 MB (225717191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb2841ad608e0fada3f01f4a79cca89f48cf07b48d4526fe1c2e0645f2962292`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 11 Apr 2021 02:15:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sun, 11 Apr 2021 02:15:21 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sun, 11 Apr 2021 02:16:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:16:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f51afe6aa38c2ed78193c745c817a33ec7d192e6dfa25adb6829100eaa13edb1`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12bda31b7ca05f737540b3ee29d988b99e1c157f435177f079198829b6db40b6`  
		Last Modified: Sun, 11 Apr 2021 02:21:26 GMT  
		Size: 41.3 MB (41345147 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:5213a5aa84c69decef0e64171a7f5d6067cf67d93c7d8e562068db6f0275b37f
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.5 MB (247497736 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14be295ee327e97cafa4450353d3a7080f62d1e929b0ba257ccef0a5113b91e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 11 Apr 2021 02:08:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sun, 11 Apr 2021 02:08:02 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sun, 11 Apr 2021 02:08:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 11 Apr 2021 02:08:39 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:653f8822ea865bb825800d35b0cef7073b89dcafdb369606f6d2ff3ad5862e97`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16e5ae3da814870650f9e889e6fb89938ef4f8a784e136881577120f03ceae32`  
		Last Modified: Sun, 11 Apr 2021 02:13:19 GMT  
		Size: 41.3 MB (41345662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; 386

```console
$ docker pull mediawiki@sha256:8d2ea36f5e4abe78ae9c8c67f17d5fd8b3a3187d84164bb518df6bed011ee201
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.6 MB (265584585 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6230b31eacfb1eece723156e5caa141ca739d838b6f69f96f3d21584220821b4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 20:52:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sat, 10 Apr 2021 20:52:55 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sat, 10 Apr 2021 20:53:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 20:53:19 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6f80281275133462de72a2815b9090451cfb56511a77e24b51cd78b8617a9f64`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09eab4307be83d772ded67a9919f0f24861eec0179c4069540cbc539d7317d64`  
		Last Modified: Sat, 10 Apr 2021 20:59:17 GMT  
		Size: 41.3 MB (41346579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:92a4387d1f418994a02a6ddf9fd69b6057dbac2455f68ac7227acd08de6deab6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **275.8 MB (275805690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b869f3915b2148867b1a8598d61ab20083e84a3dd7deded8974a93f2627fd70d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 10 Apr 2021 23:52:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.34
# Sat, 10 Apr 2021 23:52:09 GMT
ENV MEDIAWIKI_VERSION=1.34.4
# Sat, 10 Apr 2021 23:53:10 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 10 Apr 2021 23:53:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e766c922e6c79ad50eecfc01bea350e41d76f13fcfdf5cea00155bf43fbb7ef3`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85a228f29b630593077243036f4eb2faac50a41bdbaef7e6212082cf82cd30bb`  
		Last Modified: Sun, 11 Apr 2021 00:10:56 GMT  
		Size: 41.3 MB (41346370 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
