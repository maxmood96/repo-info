...
```console
$ docker pull mediawiki@sha256:b1b2d337aff6c81c816459e04077b0163b1c94104f020c2eefa4ce872bd98cfc
```
...
```console
$ docker pull mediawiki@sha256:f0f5649e2502167bc1663b04a78883ef4e033827a66fcb15d2ef66165ecadd33
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.1 MB (272130825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46c31c167b7b47f65f73586b5122e3de1ccd91c0ad59ea3ddcf353b9073c07a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV MEDIAWIKI_VERSION=1.40.3
# Tue, 09 Apr 2024 03:02:56 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 03:02:58 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:02ea9b4c51190ac4dfaa976ce5a2a59ae2e412bbe512f061c1dff34071901190`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11040e5c87ecf63e2130bfa0ff5b7e8abafb4cee7dbc3ebecd47d0aa126ed769`  
		Last Modified: Tue, 09 Apr 2024 03:07:22 GMT  
		Size: 68.4 MB (68375128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:3e2fbbbe7ef6c426a4ca821c843ade0407a7a1a93e897b4e3182419491e39be7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.3 MB (295324460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88907d47e55d8969fa61f0ceabe98a053034a66c74a61916834b17825f220fbd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 09 Apr 2024 02:17:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Tue, 09 Apr 2024 02:17:56 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Tue, 09 Apr 2024 02:18:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Apr 2024 02:18:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bdd8aa0bbdac126488395e698d72262b446ff43cfe163ebcd1e1e174796debef`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c56c6af1e285ab7ceffc63bcb224c71e3d2ff48c66446f8c396f47ae412a1a0a`  
		Last Modified: Tue, 09 Apr 2024 02:20:57 GMT  
		Size: 68.4 MB (68377387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
