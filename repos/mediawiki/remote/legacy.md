...
```console
$ docker pull mediawiki@sha256:25a5b7588f244993346a9ae8d4d4e9b4af29114f3e4874262890c9c2e7a83e81
```
...
```console
$ docker pull mediawiki@sha256:c4079e943279b3fc91ef93149a94c196d70f60a475a9633c3a052793698976f7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.0 MB (229040204 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ec0dbceee1e138b33df79d297e89305e1bca94b8152ce11429feb071c4efd74`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install apcu-5.1.17; 	docker-php-ext-enable 		apcu 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 17 Apr 2020 22:52:55 GMT
RUN set -eux; 	a2enmod rewrite; 	{ 		echo '<Directory /var/www/html>'; 		echo '  RewriteEngine On'; 		echo '  RewriteCond %{REQUEST_FILENAME} !-f'; 		echo '  RewriteCond %{REQUEST_FILENAME} !-d'; 		echo '  RewriteRule ^ %{DOCUMENT_ROOT}/index.php [L]'; 		echo '</Directory>'; 	} > "$APACHE_CONFDIR/conf-available/short-url.conf"; 	a2enconf short-url
# Fri, 17 Apr 2020 22:52:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 17 Apr 2020 22:52:59 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 17 Apr 2020 22:52:59 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.33
# Fri, 17 Apr 2020 22:53:00 GMT
ENV MEDIAWIKI_BRANCH=REL1_33
# Fri, 17 Apr 2020 22:53:00 GMT
ENV MEDIAWIKI_VERSION=1.33.3
# Fri, 17 Apr 2020 22:53:01 GMT
ENV MEDIAWIKI_SHA512=edca9810ad105a1018808bfc253c567c9d3841d606ce9e224f3b49e9f5e9f0ca7bf6599fb8dfa83473f1aca8102480bd38e65eede9f1a45144737d998881123e
# Fri, 17 Apr 2020 22:53:20 GMT
RUN set -eux; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	echo "${MEDIAWIKI_SHA512} *mediawiki.tar.gz" | sha512sum -c -; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	rm mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images
```
...
-	Layers:
	...
	-	`sha256:a03cb48b13882484b6d1e69a942c27af17769eb09f0847c3fef2845a8f03287c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ccdd0655da43e6b0897b0c98d51ff9b2e180699e0d5f3d56c39c198ca3b8402`  
		Last Modified: Fri, 17 Apr 2020 22:54:17 GMT  
		Size: 592.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5d2a73198d4002ddcc837bdaddbaa74216704fc3c06d62c7cb17016521320fb`  
		Last Modified: Fri, 17 Apr 2020 22:54:17 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f9e5eea01b34b3e05782c523cd31e30a0dd05e1be0f6cb751e2057e319647a3`  
		Last Modified: Fri, 17 Apr 2020 22:54:16 GMT  
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e71c8caddf0fbdaf5f85aec59ba0c0b13692ba2ff568e22a18819be2b3e3a075`  
		Last Modified: Fri, 17 Apr 2020 22:54:39 GMT  
		Size: 38.4 MB (38403292 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
