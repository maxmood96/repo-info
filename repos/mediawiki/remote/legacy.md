...
```console
$ docker pull mediawiki@sha256:7a1bd8628853decd6ae09c4e96a62eea037bb10c77ced248ff5c6928297a7d5a
```
...
```console
$ docker pull mediawiki@sha256:392498e3d5bd08940e010e2e59ba9d5d44ef9ca07b732b5b0267e997e88e74b7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.3 MB (264305642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:320fa548f67fc1da178f85640c93691deaf69207df9494281fef9f38f926f6a8`
...
-	Layers:
	...
	-	`sha256:1073bf531e87d3c61ee289932f048b299138352d59876bbe34d5738b5f8dcd22`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:beed1333a02cf1b68e5dfbec922894e3853af7cbdd957d178e992f5271f9e7af`  
		Last Modified: Wed, 14 Jun 2023 08:24:32 GMT  
		Size: 56.4 MB (56431903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:e84bacbde9924fa5dbc7ea45c148f1766d549f0332c24691c41d1dc7b6342e95
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.4 MB (238395276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5bbae882eb58cd80916fdc5961653e7f7268670c62e84313aa4bc8950beb0ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 04 Jul 2023 19:23:38 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Tue, 04 Jul 2023 19:24:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Jul 2023 19:24:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f3383663df25437ffd6e73d4f0ef946c970be5cbc9514a6cfdd9f0945f22fba9`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:053c83cc324699353249eea3f4731b94a0c4f99c757b79a981500874769a094b`  
		Last Modified: Tue, 04 Jul 2023 19:28:47 GMT  
		Size: 56.4 MB (56430141 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:976fbb7faf68f35c7ce7d2f471ab63e8ebee133daf0115a3d58f9316cf29f1d2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.9 MB (227900387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2be6b79561c9ce895491dba73c9b6aad268cb0345fbb823083c5f7025e2ef8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 14 Jun 2023 08:42:49 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.38
# Wed, 14 Jun 2023 08:42:50 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Wed, 14 Jun 2023 08:43:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 08:43:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:212a8998817fec9c348c7d5667170afdf4e672c78050bb7956a50d4001c8dccb`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8aa172ced132a53be818b95e3176f44c8f2e4f019fe581298abc1cc6b0bfc68`  
		Last Modified: Wed, 14 Jun 2023 08:47:16 GMT  
		Size: 56.4 MB (56430497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:1e709da60ce573cad386695ae0848ba74bf0083735396224fafa5ce6b614296b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.0 MB (255046456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b5ea8051ccc87337926d77ce3bdbc0e97f7dac59adb13c2e99457c43768c2dd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:fe859c4379c34645f38fd048072873f3c56c2727a4bce22abfa42cd29dd70aa3`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59b480fcd0b714d1b3a6c9944e21e73bdaf83059ccd97c5b9ec11564f043514d`  
		Last Modified: Wed, 05 Jul 2023 01:51:55 GMT  
		Size: 56.4 MB (56431607 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; 386

```console
$ docker pull mediawiki@sha256:316bfce9a09472a9cf81ca7f769e16f78eb83f5de50077bd7bd385eb3a5c993d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **268.0 MB (268037129 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51461ed1b0b608d2b320e5492b6eb6ec45702559cf26fb4b5ddb0faaa1a325ac`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 14 Jun 2023 06:24:56 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Wed, 14 Jun 2023 06:25:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 06:25:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8e536e1f7c5f1e8bcf7fa17ef28ed53c3b602ea70fe4482a7adc65eb55fdfc87`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60131e48d8709d06612c972e75e50ea0cc8fdd171460a826c9725d5fd1f584c7`  
		Last Modified: Wed, 14 Jun 2023 06:30:34 GMT  
		Size: 56.4 MB (56431671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:c59c9d4058bc1e0b9261958cc4af3f879b4e4f79314514c315b19ca81f8283ff
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **267.8 MB (267814789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10191825fb74c4d3e491d2067ee4ada3168df10452c004431a1011f2a74cb8bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 14 Jun 2023 08:24:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.38
# Wed, 14 Jun 2023 08:24:03 GMT
ENV MEDIAWIKI_VERSION=1.38.6
# Wed, 14 Jun 2023 08:24:44 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 14 Jun 2023 08:24:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c89501299511ac0e9db216679daa1e4633632c92012b3226c0a88ffcbe60b2f0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51d4efbebefca1251a1ae0d7aae2e7bc11712c8731d0baf6cae492fd45e7fea0`  
		Last Modified: Wed, 14 Jun 2023 08:31:48 GMT  
		Size: 56.4 MB (56432306 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
