...
```console
$ docker pull mediawiki@sha256:c1e459a313de4691d7966b18d053a381b2c47dc59be8f71ae4f0566a7e6afa15
```
...
```console
$ docker pull mediawiki@sha256:9e6421f5b186cbf53c2083e14bf7ac8d1c20d6d7e9eb963f6b9147d8c1a3349b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.6 MB (269634035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e73ba41e50b1630637e375405d5e3001131f32310f6801d20bfac4be6f78ba5e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 20:03:22 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 12 Apr 2024 20:03:22 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 12 Apr 2024 20:03:47 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 20:03:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4579768d19632ca842301181309dcefa7f6a8adf6b2d3271902d2782dfe2cb76`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a7168173fcd428177eff5c00d34d3543d74380b6bd3a6db4953c71735deb1a8`  
		Last Modified: Fri, 12 Apr 2024 20:07:11 GMT  
		Size: 68.4 MB (68374453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:6ef102a105c4c34ee1dff5ab2f154a6823e78b8bb3928eadddc6a0a6dd1e3535
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.1 MB (257149106 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a7fb92590f9acfe96d90a8e1684288d05e35849577f3fcb77768fce9ddcc9f8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 19:08:06 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 12 Apr 2024 19:08:07 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 12 Apr 2024 19:08:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 19:08:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:198958f9c045c1f49b2adf6e15b454dda457871f8c18444306fb486dc1acde3c`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3ad6323c4081a52154d21cb81ec3a1fd7793c41acb481ea4fbb746fcebe84e0`  
		Last Modified: Fri, 12 Apr 2024 19:14:01 GMT  
		Size: 68.4 MB (68374297 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:2f5d0331401aa82d7679d81ef69c4fa70da5a4241788fee798b8acf0f10d0c18
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.2 MB (292240660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:588bd0c2db55bc4bc432dc75eb2e29a4d14c120b13bcd8a55bf1615a74a670e7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Apr 2024 19:30:09 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 12 Apr 2024 19:30:28 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 19:30:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d1795304745c3933f73a38d3d4641d6a27aa547e49dd1f586117a90fe2323542`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ac1f5403f10f5165af66a40510f1fdb021c0c76922648692471e21d7682719f`  
		Last Modified: Fri, 12 Apr 2024 19:34:27 GMT  
		Size: 68.4 MB (68376948 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; 386

```console
$ docker pull mediawiki@sha256:76be0b662080df6b843525d7eaf9252c2aff86659afe4e3027fc8f3a2d7f2699
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.6 MB (301609519 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe402ce3de88d06b1dadefa072962e8f4c34abef65a607ce88cf28c23a7c2d0c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Apr 2024 20:53:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Wed, 10 Apr 2024 20:53:27 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Wed, 10 Apr 2024 20:53:54 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Apr 2024 20:53:55 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:307fa1ef96f42231620eebe80f9b8e0f967d6e3fcfd24d2bb82420bc8b0c12bc`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e7ff210a4473ffe3560f33488f7cf0c841e282499809bbdcf7561bfb0f12570`  
		Last Modified: Wed, 10 Apr 2024 20:57:59 GMT  
		Size: 68.4 MB (68375694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
