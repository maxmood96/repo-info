...
```console
$ docker pull mediawiki@sha256:95371d994f02ed3d4c2a734807d15452d48363c5d31fb1dbe6e48efa0950128f
```
...
```console
$ docker pull mediawiki@sha256:870f64d9c1cf96c3679ac1af191bd0be2b1098024316521e9ac356dac38d6403
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.1 MB (264080154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f68ccd317f6f5086ef2c14e084071e1e69f6335d421c578be4bde35b500b9d3e`
...
-	Layers:
	...
	-	`sha256:90b7d44828ee22e024a2a08453ec916be4d8c6a302e874be44e305e5618ef6c7`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:430c12dc47645bbdc9e3e4d58591039c9bbd8f22b590f96fcbe6868aead0e876`  
		Last Modified: Thu, 12 Jan 2023 00:01:56 GMT  
		Size: 56.2 MB (56159538 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:c2bfb6f0c4ca055c35550b57f70ec5b83216cfeb159bb8812efb4154bedf1d18
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.2 MB (238174660 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8df6a91525ab294078237fb7815aeb2c212812bc0b3dbf425ec6c280bb18a0e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 04 Feb 2023 14:41:47 GMT
ENV MEDIAWIKI_VERSION=1.38.5
# Sat, 04 Feb 2023 14:42:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 14:42:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b2722d41b20e097e4f208c41c1f4563ca183bc98286e33c70eadc3c49e6a8417`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a7febabf56e9c98db6921afd11127cc75a3f64eb1e13ec7a6aeba2cfa8269f`  
		Last Modified: Sat, 04 Feb 2023 14:48:36 GMT  
		Size: 56.2 MB (56162047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:93f3205cd51a951868a360b0554d2dd82af67c7daa65c00b8eb48feafecfac09
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.7 MB (227660326 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94dae97873274f84c5fa50c6ed545ce3457d39fdfc6327c541494663d49f184c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 12 Jan 2023 02:54:05 GMT
ENV MEDIAWIKI_VERSION=1.38.5
# Thu, 12 Jan 2023 02:54:29 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 12 Jan 2023 02:54:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9aaa9fc5fc895e29493333105da651ca34c33017d3837c87562125db31a22f1e`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c16bf59d1599b4406044135a0f94194a2742b55fad63e3a631db0acbf1f6a3ee`  
		Last Modified: Thu, 12 Jan 2023 03:00:47 GMT  
		Size: 56.2 MB (56160754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:ee55c01481c5aff51aa50a8cacf44577ef7b0733413895f8c5735527d3691717
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **254.8 MB (254827893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9de9645702cb237ddb5fa27fb663120c2f08b414c4ddd7757c8159c5dca5201c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 04 Feb 2023 23:19:46 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 04 Feb 2023 23:19:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.38
# Sat, 04 Feb 2023 23:19:47 GMT
ENV MEDIAWIKI_VERSION=1.38.5
# Sat, 04 Feb 2023 23:20:04 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 04 Feb 2023 23:20:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:beac8bddf56e121466086d0c0a67ac787334e74fe29c1ef2f45d3786ed64790c`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:328e5456bbfca7aa36465a7f5a3aa266e89626d91b4050dffe3a3b4bf2e4ead7`  
		Last Modified: Sat, 04 Feb 2023 23:24:00 GMT  
		Size: 56.2 MB (56160429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; 386

```console
$ docker pull mediawiki@sha256:e15c8ba0e4f49f18612776c7d4ddb0a1b736ffcb1c9a02105d7a028d4b285a40
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.9 MB (266912207 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:155a913e0f65afb9a829df3c65593556e25dfb5e003a006e56b3cd761c545a38`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 05 Feb 2023 00:51:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.38
# Sun, 05 Feb 2023 00:51:10 GMT
ENV MEDIAWIKI_VERSION=1.38.5
# Sun, 05 Feb 2023 00:51:33 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sun, 05 Feb 2023 00:51:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:363731a6a6cbc9e212b7c2b6a499b3e7b69cacdc2490705717ec94282f45d101`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5758a3b8efec02ab60d962f4f7ebebfdf0cfb64a86c44c3ed2861b6b2a1dd40`  
		Last Modified: Sun, 05 Feb 2023 00:57:08 GMT  
		Size: 55.9 MB (55916667 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
