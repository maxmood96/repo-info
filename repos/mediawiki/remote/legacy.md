...
```console
$ docker pull mediawiki@sha256:d7f58be5d8a0cac711a95a565923654d42eb2a01b1f9bcd53b8166e3db1bcd9b
```
...
```console
$ docker pull mediawiki@sha256:022b6c9898d8a743045397c895fa2eee2009e37ef56162e2b026f4675b83240b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.4 MB (350369524 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b89116af19e088d9ebe3d60f9b2d3c3e7bcea4c22502853eb19d39d9219de143`
...
-	Layers:
	...
	-	`sha256:ed173f7f1d94127ca84ea98b45aea33c760b988b146dd8b062cdfc1f20f6b31a`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b1a519f9215904d0b3b5adb331d754fb5c479d7d034a8e5307b37cda98ff2da`  
		Last Modified: Tue, 13 Aug 2024 05:48:51 GMT  
		Size: 117.7 MB (117663525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:bd369a8926be256ef85a3e8f23d9d7feda363639ef56d0e14918df8791de4d67
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.9 MB (318915707 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bf74ef91232aac03f6a6ea2784e8a680c7379f4cb101185953f753ef682c0ca`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 13 Aug 2024 04:26:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Aug 2024 04:26:47 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 13 Aug 2024 04:27:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Aug 2024 04:27:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5c7611d59f09bdf23406959c2a01cbae62d131e176e4911fab604ab7e8a2f357`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f9b73beb3637d638f53cb2809bea071940a7f6aa7de89f9ddb6192ae0747940`  
		Last Modified: Tue, 13 Aug 2024 04:30:41 GMT  
		Size: 117.7 MB (117663665 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:cdd03d61286590438be6d1b55a44f504a4133e9710a0a0daaf7d5c2d96b3e5b2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.4 MB (306420454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4fa492a272af10192e72806f4819d0f8628e1f91263aaab696ffad7e0c38855`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Aug 2024 04:30:21 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 13 Aug 2024 04:32:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Aug 2024 04:32:39 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 13 Aug 2024 04:33:07 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Aug 2024 04:33:11 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5e9e1d309528aa06b2c1905adde4976a534cc9180aad49d3fbd50c9c484dc300`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d215ba6cc5d8883b380710c0d35c2e1816fbe6f7a06a240e1d42dee4e1cba86e`  
		Last Modified: Tue, 13 Aug 2024 04:36:33 GMT  
		Size: 117.7 MB (117663570 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:64db80d5db0fdd9c909284ec04abdff96fdb998fa6d9cfc5b29fecf66e1b2d9d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.5 MB (341538486 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a2610314ba5d6e8b40e2b3fdaac4d9d77f5b8353dd4e1ac6bb752de6846b0d44`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 13 Aug 2024 04:36:49 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 13 Aug 2024 04:36:49 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 13 Aug 2024 04:37:11 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Aug 2024 04:37:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:cd1996491f7e30450f1d0f086c3bcee596024833fa93f1e0948ae37ebab7b437`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2febb3e96608271d3618bc3a68cddf2e40ee65744490ccf99d68e3d53695bc80`  
		Last Modified: Tue, 13 Aug 2024 04:39:52 GMT  
		Size: 117.7 MB (117663001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
