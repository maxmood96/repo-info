...
```console
$ docker pull mediawiki@sha256:9b216b20aadd0c4c58c862587ee3a4b139663023b5d0beb9146492ff0105a252
```
...
```console
$ docker pull mediawiki@sha256:a914e5b468b388646b6ca7547db530d57626db7b4b493524130f61178369f882
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.1 MB (301144014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc202b0ae011e2b047d59eb228bcf9fa6f86218dce21e87352ca0853f0380a6f`
...
-	Layers:
	...
	-	`sha256:9e9aac5694302b57be5c947b11b1b62b35634372e7dceaf984635b74aa1fae87`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c815a5f3b0da8bffd9d812b1a927728404b2aba36d64076c84aa9e46ed6c5543`  
		Last Modified: Tue, 14 May 2024 19:12:26 GMT  
		Size: 68.4 MB (68378841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:78577f6ac28bab2bbc2124b4eea7c0b3c00b14202dfcbe0601491dbae5de5e44
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.3 MB (292299268 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4aeb1d5cd979d45fc480ed133bfb1903f06687946b9186c7ff13798e279070b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 14 May 2024 14:38:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Tue, 14 May 2024 14:38:16 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Tue, 14 May 2024 14:38:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 14:38:37 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ac3a7b9e61a1cf29dc91d78503a399d126bd91e882926157650dba4dc10ee344`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f63c273d66204de50753999081841177ab5f1e93b4ddd2237f0d0dc45a65127`  
		Last Modified: Tue, 14 May 2024 14:41:19 GMT  
		Size: 68.4 MB (68379234 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
