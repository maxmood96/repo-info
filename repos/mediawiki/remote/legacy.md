...
```console
$ docker pull mediawiki@sha256:e2dbd4111618665888973241f0d1101a13731175728ea3058a2d9747b96fcd5f
```
...
```console
$ docker pull mediawiki@sha256:5d710ba2865c1dc8c70312a672c7b38a41ec6f8a633dd83764c16c65aaa4b1a8
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.1 MB (229064938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76896b713cb734b512383d4b4f1c214d5970ac3350960228e249d04e2e5db243`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV MEDIAWIKI_BRANCH=REL1_33
# Mon, 30 Mar 2020 23:49:06 GMT
ENV MEDIAWIKI_VERSION=1.33.3
# Mon, 30 Mar 2020 23:49:07 GMT
ENV MEDIAWIKI_SHA512=edca9810ad105a1018808bfc253c567c9d3841d606ce9e224f3b49e9f5e9f0ca7bf6599fb8dfa83473f1aca8102480bd38e65eede9f1a45144737d998881123e
# Mon, 30 Mar 2020 23:49:25 GMT
RUN set -eux; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	echo "${MEDIAWIKI_SHA512} *mediawiki.tar.gz" | sha512sum -c -; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	rm mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images
```
...
-	Layers:
	...
	-	`sha256:a021c92ea7e5f0b3de8a3ff580a98b954280f7fcab090b53c05e61113e86b8e4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbd777193af52a8361f3e342da38876e96a73314b02e1f89d342d2b7db1c25b4`  
		Last Modified: Mon, 30 Mar 2020 23:51:00 GMT  
		Size: 38.4 MB (38403100 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
