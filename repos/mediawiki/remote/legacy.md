...
```console
$ docker pull mediawiki@sha256:d04f491664a6f8a330618ea1be9b2907f123781f0fa11a83fdf5fce23978229e
```
...
```console
$ docker pull mediawiki@sha256:8a1150c1aa31ea07d38a48426e86495f1cc06cf8302fc8fca07888be84c46196
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.4 MB (350368622 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87501bcb88098bfbf0fc3384bb80b9acb1bf4db6769f62445d68329de22d7020`
...
-	Layers:
	...
	-	`sha256:56ca0263111bbbfe3313e93db1927c71c6dbee59355594182b6d0869f5c121d9`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:939786e30cb94d15818aa717725fddb31ea8d61df12951e21b318b0cb3a10ae7`  
		Last Modified: Tue, 23 Jul 2024 12:27:47 GMT  
		Size: 117.7 MB (117662635 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:a3ed62f56135830643c34d2c5740ef691470958638e42905ea9e1111b778d2a6
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.4 MB (306419087 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3f0d34a186477ae4d39f146a4dc5fe0181cd2383c75609a3ebcb962a28c21b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 Jul 2024 10:44:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 23 Jul 2024 10:44:54 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 23 Jul 2024 10:45:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 10:45:27 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:15fd60e4c7c3e9258a0d17933e3d01752f58fadc343b2677cc5368c1e0bfb908`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bea29a4a20034a002d4101107b41029ef8bcd0d5789fd34d07db497419e0d2ac`  
		Last Modified: Tue, 23 Jul 2024 10:49:24 GMT  
		Size: 117.7 MB (117661413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:d2febecc581af328cea778e853d3a6280885299dd0ed71381c566fa136faeaa9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.5 MB (341538650 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d23ac1cec86e56cfeff7e993d0d9e51d1b388851bd921c3076de01229c3347ee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 Jul 2024 08:27:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 23 Jul 2024 08:27:24 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 23 Jul 2024 08:27:45 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 08:27:48 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2c6fbc4c2de67e563c8d993d666dffa4cc7ccae0a5e4f3d83540f090a1792842`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d01a64e268e92c5430a6a01706413344735aa38877e6a8169e09170689a40678`  
		Last Modified: Tue, 23 Jul 2024 08:30:29 GMT  
		Size: 117.7 MB (117662520 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; 386

```console
$ docker pull mediawiki@sha256:b91f9d379e2edb4fb1c8e91edf572629f6889d14bed844c5112f624d77cbf0ae
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.8 MB (350827294 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c1128e720f4b5f771536db7c96d3a6826a532d9458dc6f2c27302a21dfd655e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 23 Jul 2024 10:30:05 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 Jul 2024 10:33:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 23 Jul 2024 10:33:24 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 23 Jul 2024 10:33:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 10:33:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a58a7433db76d3305857a278a1f578235e62ab6e23389a4028113048300bce3a`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1542b6476d25c30e5b3d3e40dda4f724f5cdbdddda7c1d8e4728f97983b921e0`  
		Last Modified: Tue, 23 Jul 2024 10:37:35 GMT  
		Size: 117.7 MB (117663429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacy` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:11fbe9e2dcb3d0ee634fd7d71eeeb0a2125b6b5d750181ce6771289138e5caa4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.8 MB (358788097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:101b7fa12e53a22891adefe72464c95b3633b958f2095dfe1caa7c72642d701e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 Jul 2024 06:59:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 23 Jul 2024 06:59:54 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 23 Jul 2024 07:00:31 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 Jul 2024 07:00:37 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d2eb4f112bd73d651da67972055a614c292882a7e79a48b8372ee6514ebaa20c`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e80384029aa1629d4a468bfbc943881f4effe1efe4de9c03eb5b7bb4ae76043f`  
		Last Modified: Tue, 23 Jul 2024 07:04:50 GMT  
		Size: 117.7 MB (117663210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
