...
```console
$ docker pull mediawiki@sha256:7922ac3ab546aa1b6c9bb567c27f1be4043c1a6b0ff546d1763105fbca10fd9a
```
...
```console
$ docker pull mediawiki@sha256:058429f79bac902f1cb55d3983adb40f708876cb2eb78443388e86efc61ce863
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.5 MB (145530260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:17e97e6aefc9c1a794a384839927b58a61d93099ef33aa27b6871c765d51c9dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Aug 2022 02:32:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 11 Aug 2022 02:32:26 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 11 Aug 2022 02:32:44 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 11 Aug 2022 02:32:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:496172fab93792f8c6bcb4e4e8f1dc6d0c24a4a0d8ca3de2326f9b03fdd947b0`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad7a5dc4db12502601c0a8135212ea00733a82f1440a79c65a4fdd561e115b16`  
		Last Modified: Thu, 11 Aug 2022 02:34:52 GMT  
		Size: 50.4 MB (50353082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:6b84bb5c928181f512488eb00b8bc24f20ec1eb8dfd35ccddc19ee65ca06233e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (150004008 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56047d612ee9f9f2d1d605acc84f3ebaa928bf99d1a53e327c66a57b0aba36fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Aug 2022 09:05:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 10 Aug 2022 09:05:19 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Wed, 10 Aug 2022 09:05:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 10 Aug 2022 09:05:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b97087316549265f71eb49849ea6e3a46de97ab0374996812140e6188f031bf9`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0a1cfe505816354953ae75a7c3e787fd553423a44bdc937c71aaac34374b9b6`  
		Last Modified: Wed, 10 Aug 2022 09:09:49 GMT  
		Size: 50.4 MB (50353424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:417ed2aeedf0103251ea488afdfc29561891aed4098baee84f4e01b73f79302b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.2 MB (158190009 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a0f49c3b446976ce8215be52e935a96e4bd8e493ab5efa78b5047ab42cc9e73`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Aug 2022 07:05:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 10 Aug 2022 07:05:26 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Wed, 10 Aug 2022 07:05:50 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 10 Aug 2022 07:05:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:af956241e0967ea96ad3623f9e1a556e856bab4c31c560bc853f68a09c77c7a3`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:599554b3e41c96de109f285c6171b1bd7ec98eaa192fb67270d89d9e759bf298`  
		Last Modified: Wed, 10 Aug 2022 07:08:56 GMT  
		Size: 50.4 MB (50353047 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
