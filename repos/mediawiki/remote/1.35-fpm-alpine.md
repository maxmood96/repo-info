...
```console
$ docker pull mediawiki@sha256:794ce77656c1d04e238c6314635360507765473be75a210eb0ad58eb40bfa4da
```
...
```console
$ docker pull mediawiki@sha256:9b23bcccebfc41fc70a67992f84d506790cfe4400d31b9ce3f9e43a5b446d231
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153432436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c22480aead27a7a48bcad6d9d811aa90b3cba1568570869bdcd6b18416db2c3f`
...
# Thu, 24 Mar 2022 00:36:36 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 24 Mar 2022 00:36:36 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 24 Mar 2022 00:36:48 GMT
...
-	Layers:
	...
	-	`sha256:33cf4bba99b440c60a6f935695a85ab9d42ce309685bcda0dab157e90b3bc6e2`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d06eccb9957a00fe46fda7a855f5c3fcd538f85cea3bc82c79bca25ef28ba021`  
		Last Modified: Thu, 24 Mar 2022 00:38:30 GMT  
		Size: 48.9 MB (48894028 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:e3bf79e0e2787a157a1a8504de2caf66e3cf968b9d15010a0a252fdab44a55ad
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.3 MB (149301726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a4b7ecf94fab66a0820635ce90bc50988b715511a8e8a3c5bc01c23c73d6c12`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 24 Mar 2022 03:49:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 24 Mar 2022 03:49:51 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 24 Mar 2022 03:50:29 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 24 Mar 2022 03:50:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4d99aecbb702b639cbaed6f0e91e9c8fe2c6da8d841c7d34b1e20ee8c3944854`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ef8c92d017fdde5e5f64582bdf2cf66d22e819af078bc5c4d498aa96b1d898e`  
		Last Modified: Thu, 24 Mar 2022 03:54:47 GMT  
		Size: 48.9 MB (48894115 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:31317c31254d5f29ca928e0dbe16f4ef04a36118cc00b2e6e4fb01a55838a3ee
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.5 MB (145515116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d0f02cccaf9872f8445a1d743aac117f500d6faaec98308b5a48d4a07c364fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 24 Mar 2022 06:30:03 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 24 Mar 2022 06:30:04 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 24 Mar 2022 06:30:41 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 24 Mar 2022 06:30:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:070bffb01b208c083607ca4eae483e86d042eab0bec2de1d75d03cd32c6057b6`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9673833ec20772f98ab54ea047073c7060f490048736cde99df81274203bedf1`  
		Last Modified: Thu, 24 Mar 2022 06:36:52 GMT  
		Size: 48.9 MB (48894133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3a87fbb3c0bf3843da2ec3e0307ea3c27f0adbf6040e93f0d9ccfadc4ec2a961
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.1 MB (152078928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7beec44b9235c0ef01d98a1cafea5d3d7e7d3c3335949acfd585f12307c1d68e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 18 Mar 2022 13:10:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 18 Mar 2022 13:10:54 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 18 Mar 2022 13:11:35 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 18 Mar 2022 13:11:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0ccdd4ea1e67a3704473ff5db958ab4a0e42a73107f428a0df9e6bbf96e95789`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:575e8148b91b0f97e3ece145976e57bf9919ff4a793321948ad3150ef5c28ab7`  
		Last Modified: Fri, 18 Mar 2022 13:16:42 GMT  
		Size: 48.9 MB (48890918 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:73ab0976664844089ffb0db5b3c19f55ee12c3b44e1a336616e67533f4636dd3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.1 MB (155099028 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa1c9ea43dcdc1e46fc29e4c2d65778203f64748dd7fcf280ef021e3152fad54`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 19 Mar 2022 10:31:51 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 19 Mar 2022 10:36:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 19 Mar 2022 10:36:09 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Sat, 19 Mar 2022 10:36:32 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 19 Mar 2022 10:36:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:094a000b805fa4442342d9df1dc58cef60f88e0dfe39a9cf82ef5d1a39a8a694`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fe88e659cb8c8bef7d531769a4ce168801ee8fea0118eda97f24f6f1a096e37`  
		Last Modified: Sat, 19 Mar 2022 10:43:22 GMT  
		Size: 48.9 MB (48893747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:3ba4b8e49961f37cd235b8b41c1340a91371aa52cb4a2ab84d9e1f53b621c24d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155901385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb04ca60f5e462a54c8755568ff18342ea7a49e0cf36969f5af3a10b7a37bad4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sun, 20 Mar 2022 09:59:57 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sun, 20 Mar 2022 09:59:59 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Sun, 20 Mar 2022 10:01:42 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:e45c15c492fa7da755973947000ca44a1a3ad3bfee781f4e87ad4ebdf5acc27f`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93b1e35db5fb2e2c99695552b1795743623c5f7b5932d89a9aa08a6aad7a3598`  
		Last Modified: Sun, 20 Mar 2022 10:22:54 GMT  
		Size: 48.9 MB (48893891 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
