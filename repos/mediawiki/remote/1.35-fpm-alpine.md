...
```console
$ docker pull mediawiki@sha256:ad090dec20f345324c2f8a67556a908b3108fde5dc46de0ad936bba575402b01
```
...
```console
$ docker pull mediawiki@sha256:8d535c49e27fdf775869ebfc5a79a5dba41b5288c429d319b5c6410745869b68
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.0 MB (150973124 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7547ae0aa9ee14672d07fa27f1767b070f424ba2fcfbaf683fad42fac775b471`
...
-	Layers:
	...
	-	`sha256:9a84bfff292bf38402cfccb3103aa98b1825d48efe2d30b3de787adbd9ed537f`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51cc38a1fe099e991ca70985e94408a6c885e256328dcf8543f3440a87f3fc15`  
		Last Modified: Fri, 29 Jan 2021 05:32:44 GMT  
		Size: 48.4 MB (48361404 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:558b1a941b9a13f90eb7e0df0209059c65eecf7bff11b538eaad635c25b43105
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146634181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ca9dd634aa5038d81ea779cdf004402ff54cea4008fc3d53ebc335dd0969bc8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 04 Feb 2021 19:56:13 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Thu, 04 Feb 2021 19:56:45 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 04 Feb 2021 19:56:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c0e34fdc52430b8e5eceb7c016a455d20eabe3c19a0d2134e614ce624c37b5fd`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddd458661e40a5116e7be13fa0fc2c3924f39bed1ab4afc89d9debc46503de19`  
		Last Modified: Thu, 04 Feb 2021 19:58:59 GMT  
		Size: 48.4 MB (48361596 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:0d77189c31badb39b2f41d8e097734aacc78131a49846ee6397840a9ed1104e0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.0 MB (142960570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3184c898e63d53a00e3b5875f89f24ca6d31df4bc2b3044a29b238c405b93be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 29 Jan 2021 03:57:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 29 Jan 2021 03:57:33 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Fri, 29 Jan 2021 03:58:03 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 29 Jan 2021 03:58:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:769606ddfdf64f087c46a8151b31a3e692624ebbad5863121e7c54e2e1c4ea7c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:744abe0e50cfa77b6cc8aed76a2d4a8eff696227f2302669fce0a50b279271fe`  
		Last Modified: Fri, 29 Jan 2021 04:00:57 GMT  
		Size: 48.4 MB (48361508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:b8ecfac323b858b2aebe1cbd8d12d3f56ec91ebdc46842d03777955b35da8936
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.3 MB (149275107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69a85718c18a4536ba8c11c2854af4025795a85c7ca437e17a347998f5ede59a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 29 Jan 2021 03:32:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 29 Jan 2021 03:32:19 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Fri, 29 Jan 2021 03:32:44 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 29 Jan 2021 03:32:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4b2b6e79f0308260ff2a7b396cdff6eb4e15e63bc580be5e3580aedabf7872a8`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0c5ed4cf05044af83092015cc4cecbc4d22423eb94462c0c62c0491af6a53da`  
		Last Modified: Fri, 29 Jan 2021 03:35:24 GMT  
		Size: 48.4 MB (48361439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:6e8375adac0b4e1eaa5ed9b53774e4756122f8efe699de1910ee6e40c8651873
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.4 MB (152403726 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98196f8c90f7769ce4fd1622574a20f366aece89fa8a8e5e43f993df4dc9290c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 29 Jan 2021 05:29:19 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Fri, 29 Jan 2021 05:29:42 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 29 Jan 2021 05:29:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:af7f21dd6986708161891660a472841b7dcab57b6985c257138e0c36841910a9`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e18e7ed390fd049640e6b48580ac2f57904cd28996b8002e9b695f97eaa0d379`  
		Last Modified: Fri, 29 Jan 2021 05:31:57 GMT  
		Size: 48.4 MB (48361598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:13bb7dbeb4470beb6dda946ee8d9f54732d6211381e4b694853adc15aae3a5fe
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.9 MB (152933220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ba7a117d584310a1c46c3cdbc0870b51d0fe5ed28884dc7a04be08e4f3da873b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 29 Jan 2021 04:31:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 29 Jan 2021 04:31:35 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Fri, 29 Jan 2021 04:32:25 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 29 Jan 2021 04:32:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:78f21dd83fb31379e40ddf85fa7806146af1fa57c56f4a66acdbded80e9dbaa2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1d69fd25ce7bf4e61eb63d132bb712f0cfd293d9f148cd3424f868b9fb5548c`  
		Last Modified: Fri, 29 Jan 2021 04:36:55 GMT  
		Size: 48.4 MB (48361523 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
