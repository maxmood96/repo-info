...
```console
$ docker pull mediawiki@sha256:1fe390cf312fa91ed48fce788381deea84e5c632951197b5edcbaabbd93fae24
```
...
```console
$ docker pull mediawiki@sha256:a4690d0144eeebe9df543532a95dd9ad40ea740743e7ff6c273ee2223f130152
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.6 MB (146636952 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6b1e434112bd138dd37c5bcc3b46fd85b7f760fd5c257c1b1463fc7a0ea2b7f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 29 Jan 2021 02:39:09 GMT
ENV MEDIAWIKI_VERSION=1.35.1
# Fri, 29 Jan 2021 02:39:36 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:8ee1df92e25aadb3fac2cc45059b38986388d8512fc99197a590e3f0e095dce8`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8a900928bf94746d1914615b2bead71a49f419fae8db2b6fd098fd66c462b84`  
		Last Modified: Fri, 29 Jan 2021 02:41:43 GMT  
		Size: 48.4 MB (48361660 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:74cff919c8085195c5a9bfd66d52054b432f842fd88cfc0cfc67789f30133c37
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **152.8 MB (152797081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:634cf4d1f8adf6134f405831525b52b8b2c4c4ba2654fdd58ca876820aaf5281`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:6cc985b64d63c7054b4dbe2cecfab9b3208b1bfefb9e186abe919dc838bb0179`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a89904b551835d3fbb3ea7beab176ffea4b23562601fdd28fcbae2e43f614862`  
		Last Modified: Thu, 21 Jan 2021 23:27:33 GMT  
		Size: 48.4 MB (48361423 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
