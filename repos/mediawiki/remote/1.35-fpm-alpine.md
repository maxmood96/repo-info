...
```console
$ docker pull mediawiki@sha256:3bc8437eaba026ecf1c55c16aa12981d98f64c6bdba6008eb31e968765d9e0d6
```
...
```console
$ docker pull mediawiki@sha256:1a10873f12f06b0bf529d820ae4741b171b0bd4bd0144766825b490aa2320be4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **145.8 MB (145809972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d83ff4ed0cd74601964cd9bafe519afa2465110c6d974c90c8a6b3bde968ea1b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 08 Oct 2022 05:41:59 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 08 Oct 2022 05:41:59 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Sat, 08 Oct 2022 05:42:20 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 08 Oct 2022 05:42:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f9eab3431f1b890ce0ea0098f168853e1a63c71ca8a7a37a8019c5998f4cebe7`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9be73a39a82c8d81362424df9ae475fbe7af3cd623a948fdca6f751103cab12`  
		Last Modified: Sat, 08 Oct 2022 05:44:32 GMT  
		Size: 50.6 MB (50621564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:684d2e5b5b254c874bf3c0ba33df9fc14fa60da8d8b9d672770caa836a8c96f1
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.3 MB (150289318 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60dbf2877d67c081a452e0c0d48c8f9a03ec35839d3a4c1de1901443dacc0157`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 13:07:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 26 Oct 2022 13:07:55 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Wed, 26 Oct 2022 13:08:07 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 26 Oct 2022 13:08:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:582a58e926d265e8c8b22ee6e8315c010b1f6624f64af9c250160d3ab7644998`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b65bd1ad1f29f0755c2de5ed4c2d12ea7dc5d45c86a6fb14357e9d2958c01c4`  
		Last Modified: Wed, 26 Oct 2022 13:12:22 GMT  
		Size: 50.6 MB (50621352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
