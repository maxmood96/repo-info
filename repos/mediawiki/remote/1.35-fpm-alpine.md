...
```console
$ docker pull mediawiki@sha256:cb269646c8fa6834f913f997c803e8f266342659429c6ed84772790b2b64f078
```
...
```console
$ docker pull mediawiki@sha256:aa12fa332b98e678fd88208c71852b670df91a9ebbec9d11178e6d7d917f0ba4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.7 MB (150673376 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37a330aca180896bf54f644910a742ea065e34d95bbf25c9a32288d4c3ad5857`
...
# Fri, 06 Nov 2020 03:48:00 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 06 Nov 2020 03:48:12 GMT
...
-	Layers:
	...
	-	`sha256:088991c0b9515a52350cc2d3895df01b72e6b821da282eadc089cb7b095478ec`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47d75b843ce7b58fef93c025cbaff1d04b0e8809b7c73157b8c4def74b94e288`  
		Last Modified: Fri, 06 Nov 2020 03:58:30 GMT  
		Size: 48.3 MB (48343244 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:0574a35643c95be4ba1321bb6785760237983536f351ce4c27fd605f648c7262
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146706270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a0ca168fcfa8cf9f0598c0aae3e95ba645bbd04240f06337756409652ec5ba34`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 05 Nov 2020 21:30:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 05 Nov 2020 21:30:55 GMT
ENV MEDIAWIKI_VERSION=1.35.0
...
-	Layers:
	...
	-	`sha256:b08b53c84130d30e9b09bfc088f45f4c2c496e4220a13234170f2e9b174e850d`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3d0436b4e718818426223167175e9c991bca07496090c7a00457985a8f86bc8`  
		Last Modified: Thu, 05 Nov 2020 21:35:33 GMT  
		Size: 48.3 MB (48345102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:89fd0869f393cfef348b6a0023274375c328c2d93f7a3b62d389808208543169
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.0 MB (143020195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86966c61ecd6ed700694c11978838f6d673d566b5e2802c588f5053dab14c2fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 06 Nov 2020 02:17:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 06 Nov 2020 02:17:41 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 06 Nov 2020 02:18:04 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 06 Nov 2020 02:18:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:630094714cebf905bc5788d384d105c81c3977331eacb39123b87a54c2adae9c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cdbaa54f64792717901b2052272e0a5f47e4310db79f667a219f1422421a27f`  
		Last Modified: Fri, 06 Nov 2020 02:33:53 GMT  
		Size: 48.3 MB (48344606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:5096e4923d57b76daa487f93e3c0f2f90ac99b003ef2970d179f78734f8e55c9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.7 MB (149705617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfaad5d915e69fd0c9aa1f2554c203de826fb26098768a8add7890af0117f580`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 06 Nov 2020 01:05:21 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 06 Nov 2020 01:05:22 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 06 Nov 2020 01:05:45 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:f8c4d457a4cde28a667bd17e162bc0b35ed8520a6d9222ebf1fa4bba8fb5eed9`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a1fa457dd1135db942c2686396f49b0ec036953c986c6239ae45054f41adce3`  
		Last Modified: Fri, 06 Nov 2020 01:21:38 GMT  
		Size: 48.3 MB (48344446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:fd318562187a5333fa2547d8e6889e49f3f4047dae98f9cd9379969cfb99a11a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.1 MB (153136415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f37109b5127ca4506d1ddceda2f3496420e21447e61081d1a3d465863c6d6ce`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:dee9b276063b966fc9b49ace0c796503fc4ad0e14e6b61362f0e4f44ea2f01f5`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eff2f6756d6a873bbea4514deb956e1e31756fa9e1a84dad49936d616c73ab05`  
		Last Modified: Fri, 06 Nov 2020 04:09:58 GMT  
		Size: 48.3 MB (48343696 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
