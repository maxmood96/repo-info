...
```console
$ docker pull mediawiki@sha256:a90a45d74af3420d21cb4f24fc7d33a0dbbd25a4d7cde99c7a69d7d472cce49c
```
...
```console
$ docker pull mediawiki@sha256:11caa5e7ab1753f3206ff2f190407ed3955dd3419dfe3e4b8ad6cbd8d62f95a1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.4 MB (153432358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73dba04923cac34b0b1cb38f65504c6ba2fa16dce797b787d9d6446f554ce478`
...
# Sat, 19 Mar 2022 19:02:03 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 19 Mar 2022 19:02:03 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Sat, 19 Mar 2022 19:02:35 GMT
...
-	Layers:
	...
	-	`sha256:f150f55699f1118169d280d1d2740780e6fee20a047564ba93f7f38d7c309da1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d4ff34f1c4f37cb6b21196083d4b288041bb7e5ac6ebead5ba2169be9e913cf`  
		Last Modified: Sat, 19 Mar 2022 19:07:07 GMT  
		Size: 48.9 MB (48894035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:9267c954240b45fca18be6f8d0a521cc164ff5644c48422fa2e9f71152538c8d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.3 MB (149301522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f684e44fdbb106b0de44295b8637b95beb0843cfd898c88da0918e61838430d8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 17 Mar 2022 12:46:47 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Thu, 17 Mar 2022 12:47:48 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 17 Mar 2022 12:47:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5b48f373ce0a43a1ff7c1e026fbfda68b55610a420ba0d3b8ea450e5638637f0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc5022fd663ac5c16e89576e9c69ccebaf3aad07a822a7cdc9a471afc952917`  
		Last Modified: Thu, 17 Mar 2022 12:51:56 GMT  
		Size: 48.9 MB (48894068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:eefdb14395e4317860fc1702439f41b90ba73b4a4686618c54146ab3ddc68c45
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146694177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a35b2f0cb94654235bb65c20da5d907d88ac5ab7d97058ab26603b628723d09`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:49:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 11 Mar 2022 17:49:26 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 11 Mar 2022 17:50:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 11 Mar 2022 17:50:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:525a828c832a68b94c6d6eeaf84a504848e14e4b1ba628ffda510b24ded30304`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02b776ed3651e1cd9d67920dd04a5cba0526fd1399a71bbb84e5446fc0264030`  
		Last Modified: Fri, 11 Mar 2022 18:01:03 GMT  
		Size: 48.9 MB (48894510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:76bd60bfe8faf1736cb1b4f3fc80a34deb26e97f20832f23445982ecc8377727
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.3 MB (157321174 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32fc29735d4db27153ae39c878f0aefcfd3dc01e24babd0df982d506421bf894`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 18:04:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 11 Mar 2022 18:04:31 GMT
ENV MEDIAWIKI_VERSION=1.35.5
# Fri, 11 Mar 2022 18:07:00 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 11 Mar 2022 18:07:09 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5cc76bc1bdd0332e23ae180e8faadc888ccf80008a15fa4fd20cb43470691d04`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81400232bb6468fcbd6e52844d59de32a11fa4488c263eba2f6a9de951e11c56`  
		Last Modified: Fri, 11 Mar 2022 18:30:59 GMT  
		Size: 48.9 MB (48894180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
