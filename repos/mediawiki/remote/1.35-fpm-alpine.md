...
```console
$ docker pull mediawiki@sha256:14e14c1f0456629c99f035a2e6048643716ba8d66850cef8e8f73af8d33eef5e
```
...
```console
$ docker pull mediawiki@sha256:37027c2b5238ffa2a8586f893e27b7638390684094059ea1b700c9b4e34b2f13
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.7 MB (150667181 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6a073ff95ed6d4a207e021940c3e628fe1700c2076629803458f4e06b90f63d5`
...
-	Layers:
	...
	-	`sha256:6310e91ebfd0c76dbfe623cce2d9409e5f55d14aae1ffbb3487b7d3923bc147a`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c04dd3242a07f3baff0b7dd71163914cc8aa312ccb64b29f27abf9daf8b825e2`  
		Last Modified: Tue, 27 Oct 2020 03:06:14 GMT  
		Size: 48.3 MB (48343414 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:a1844eb71b1b3cbcd8ef4e1fcc82650c3e4de00ccef44bb8194162b888680b96
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146700084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b46ffcce0d10cb84bb33581ab4d2db95b9d7d10f3ad20cdfad418923dc3d4946`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 27 Oct 2020 01:24:13 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 27 Oct 2020 01:24:14 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 27 Oct 2020 01:24:39 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:34e03ed32de0c87a9eaf6e91578037039bcfa4acddb05183abb385284b82acc3`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c901cc559e8be3ca471b17fd83dda57404944b2d564f9803368b0dc15a6ec090`  
		Last Modified: Tue, 27 Oct 2020 01:28:19 GMT  
		Size: 48.3 MB (48345143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:1bdbed506e952c0ed23943936298c06f765227ea8d8730cde8994f546df099e4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.0 MB (143014802 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdb13f829e379dd23e5b8ccfc311069561f92e73fc4e6646eb42bdad527b4a42`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 27 Oct 2020 03:12:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 27 Oct 2020 03:12:57 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 27 Oct 2020 03:13:20 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 27 Oct 2020 03:13:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6be0c5738cbb9e53dac25b62cb763215fad341041290d137e10e803de083da54`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da818f6b89e1cc7a3e0c61aca29d9fe61fbd3ad55ffd7bfbe27268fe98b4b3d7`  
		Last Modified: Tue, 27 Oct 2020 03:27:46 GMT  
		Size: 48.3 MB (48344699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:4121c60467ccfe1dc07de9ad445d70d6c16fa8e4b1d76cf3a13395640a14f7f5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.7 MB (149700283 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac2ef41f91996504eea93067f489286fc9527df8f8cd949ed879fe325ae12584`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 27 Oct 2020 03:57:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 27 Oct 2020 03:57:09 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 27 Oct 2020 03:57:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 27 Oct 2020 03:57:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c8d2e162825c02406ade040fa2ae4dd759a3c2454a9eae63033ad1ecdf3e6b12`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c185933eb89ee292c93beae70f6ceca7d78b3d9c392233b4284f1a19b957357`  
		Last Modified: Tue, 27 Oct 2020 04:11:33 GMT  
		Size: 48.3 MB (48344347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:4d416eea9f834823efd1b15c512b1fa83596eae7eed2a20a2741745f94cd0162
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153154727 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ff0264888c1539ab5dfb63ec04be6f2034a0cf668335c002883fe0bb92e45b03`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:f8b00d9210391c98f96aae56ea7db6c9962b9a46ca3c85a77543a62f6df85759`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51a6fbada95fd88eed077e1ccaa8d75af3d55387d5f25e698dfd9123bab81b33`  
		Last Modified: Tue, 27 Oct 2020 02:31:40 GMT  
		Size: 48.3 MB (48343178 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
