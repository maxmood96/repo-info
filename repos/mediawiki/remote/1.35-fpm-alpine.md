...
```console
$ docker pull mediawiki@sha256:99a797666cf3c393883f8b1567c17982a22c196fff8e18ac72afa4d99dcd0185
```
...
```console
$ docker pull mediawiki@sha256:edaa910acf4dfd3d9d28db43a48b0a1d715d77a37437d74a1555c1d286698890
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.7 MB (150673213 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d966c1be33c170a53b6bd2acd0c5e32465f258e39058c9e8ca09c84609ac957`
...
# Fri, 30 Oct 2020 03:17:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Oct 2020 03:17:09 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 30 Oct 2020 03:17:22 GMT
...
-	Layers:
	...
	-	`sha256:d870da7fb5793c273e5504e6ef5115c6feb39a5a1e6eb078021923f9328e1515`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35f18aa10e80c50c62e40e0a92744bdf64e554d0dc30d2d0e319e3305cf23aa5`  
		Last Modified: Fri, 30 Oct 2020 03:20:33 GMT  
		Size: 48.3 MB (48343783 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:6d66e90722211c424f349c0ee367cd56cd436227069a168ab396dea68f08d605
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.7 MB (146705724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c46538a3aeedf65caf8632c82a5bef4787eb5d63006e3f70fac6c9853fc1ccd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Oct 2020 23:41:37 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Oct 2020 23:41:37 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Thu, 29 Oct 2020 23:42:06 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 29 Oct 2020 23:42:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d155c3161de2040edec4242f08fc33906295ffed007370aa500cfe207cbce735`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e57dadca275faeeaf5a87e81ab6aecf85df3971da3cac0e358fcda25ae951da`  
		Last Modified: Thu, 29 Oct 2020 23:43:27 GMT  
		Size: 48.3 MB (48345161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:6a5fa926386bbcfd4ed3b20c3399841a9d9d62e1707196742cfd9e1b0e953a1b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.0 MB (143020446 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddeded2659d114e108a44e3d29c53d3037a4030af56af49ed1518e63495541c8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 30 Oct 2020 01:06:54 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Oct 2020 01:06:55 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 30 Oct 2020 01:07:19 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:d7ac5f0a2573417c1b4209934fe92bfc1df975c7cdce22564fd4ca83702123fd`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71bbcf3fa3987a45b1475c623b924842f9d9cdeb06c545a397310476e69bfb17`  
		Last Modified: Fri, 30 Oct 2020 01:13:39 GMT  
		Size: 48.3 MB (48345125 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:bc3849cbedea713a6881f8332ee14bfc1f79f819082efbccb09a38aa370b9235
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.7 MB (149706310 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93bf9abd49dfe48aa9194755ad7143e9d9ba01dc5f4ca66e28b8e0ddd53f95a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:98f6bc4f16594ef749da202da056667d64078e44682696c9de791d0193607c83`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0e7aae802e3751eb7d0e457bf021cc53619d72d5a3b38ed97f5c734558a2c791`  
		Last Modified: Fri, 30 Oct 2020 01:45:22 GMT  
		Size: 48.3 MB (48344909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:1bd2f587c7fcede6b0c1745f44619f36c1e375201850cd20bad5e572726725bb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.2 MB (153158876 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcefd78b817b68d90c6b44fa1632f7963276a520ea484846235923dc8d56f3ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 30 Oct 2020 03:33:58 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Fri, 30 Oct 2020 03:34:15 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 30 Oct 2020 03:34:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b6c4cca00187ca53751e865b0642eb49f1f667cb772a84536cebafb88d869b18`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3cf3494ff0e21a7bda3f91132bbc0698a04c443de5f01c7b649194e02aa4e51`  
		Last Modified: Fri, 30 Oct 2020 03:38:16 GMT  
		Size: 48.3 MB (48342598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:440cd7cc5e8bc5a5104b13e2ea5ce552d0c8083500cfc58783cf4cd2d1f31f1e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.6 MB (153566588 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d532260324b2088ef43c0b163c669452187456d9d35e91a2d9a2f005ffd71c3d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 27 Oct 2020 05:53:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 27 Oct 2020 05:53:06 GMT
ENV MEDIAWIKI_VERSION=1.35.0
# Tue, 27 Oct 2020 05:53:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 27 Oct 2020 05:53:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ef245eee1b665cbbab47e5bfb23c2c5421866dd8671bc4535d7a540c0e72bb69`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c689fa172158a119eed760f205f6544bbe41c12f03489bf7160d58c111f19e66`  
		Last Modified: Tue, 27 Oct 2020 06:35:34 GMT  
		Size: 48.3 MB (48345191 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
