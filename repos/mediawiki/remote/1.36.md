...
```console
$ docker pull mediawiki@sha256:ed8f76aad0b73ce3ce7c11b3571a5896686346321a7086839ff54c21811e96ef
```
...
```console
$ docker pull mediawiki@sha256:4852467c9733fe71a13e6efc989d7cc1fd881bccddea6a783e21c47623362f29
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.0 MB (256995328 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:922e8b2c14d3a6a5260c40a5f769e4177179730afd807428f313ce99aa49681b`
...
-	Layers:
	...
	-	`sha256:792220df4712af239e730983eb11c8232058551ecf1685abd2717ded1e73a6bd`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd6db6e45149e443fedee46ace09aaaecda4f918c16184be124d0b523658ad43`  
		Last Modified: Fri, 11 Mar 2022 15:00:37 GMT  
		Size: 50.5 MB (50458500 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:c2091c90842d7005a3aa1fed2b55026a3722c6a02930abe25a9ace0b73ba7cfa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.8 MB (231834928 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8821cfda0e36fb13f5c9da88a4aa5493a5d4848d67d499e34521dae1865f55f2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 11:37:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 11:37:44 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 11:39:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 11:39:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:039a45119fa1286cb088c8db67ae27b40b9f21ff32e88b2110626bedb30c4ad8`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30e99ba1576529ed974618f5568faa6e2d9163b7794ff0d45beb7a9d55ff0741`  
		Last Modified: Fri, 11 Mar 2022 11:49:57 GMT  
		Size: 50.5 MB (50455508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:4a9e964e66f460ba55d1a7cd83fd3229dab298c3bddce25e9e6992f6bad0359a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221326828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b7c95ef21ead7c03427a4eb86514f1e45e2939ce663ef1ee8f8c2c08357b537`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:41:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 17:41:18 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 17:42:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:42:37 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ee98e61892276f9a805cce224b8eff55662e8601ec63798396220d91c65c7bac`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5b22163571f5b5b40bb6671b850654f10b9a86927fd8ca6706a06faaa4e8e41`  
		Last Modified: Fri, 11 Mar 2022 17:56:40 GMT  
		Size: 50.5 MB (50454333 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:f342403b3c8bfddce7ab8d7b6560e288e3febd5ad248a540df925629302c48da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.8 MB (260837786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60682047211cadbad5c0b1bf10b4765671ab926900bf05c11ed60ca177dc9a46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:46:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 17:46:27 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 17:49:09 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:49:10 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bc686d87064d3c6fc59cdb5581e058d883f9d32cb5b02203f7742a438fa94236`  
		...
		Size: 174.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5a0f7e2c27ac0308b153c04bf4162d659bf379d5f152df4459f8a9bb8df74d2`  
		Last Modified: Fri, 11 Mar 2022 17:58:13 GMT  
		Size: 50.5 MB (50457420 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:2fb31592bad16036d48779cbd42557e98a670b9b45948fd4d38cc7e5fb9602d5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261226722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:515a7fb5184354640d072649db22a4ec5c0997d24f1078751c8bdababd70ff63`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 11 Mar 2022 17:44:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Fri, 11 Mar 2022 17:44:52 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 17:48:37 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 17:48:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:03dcb13c762f8681e949a2b6a4610e3be5c75ee0bb2420632a199cf43d63ae65`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac8ca3a672a2a80555d72190657f289d97785ecfe5d54c98f8b4f42803ba8360`  
		Last Modified: Fri, 11 Mar 2022 18:19:18 GMT  
		Size: 50.5 MB (50461934 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
