...
```console
$ docker pull mediawiki@sha256:9b2970b8c5aac26179b2f6b60204746450fa799057fc552a45a09a0cca2d9eb7
```
...
```console
$ docker pull mediawiki@sha256:b522cf6ecb96cd23b054c3e91468bad6f6cda56a63a65840a93614c6cd960272
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.3 MB (221327761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cc74dab262fa9ca4e3ba84f5e2c1caff4f6ae0fd7044a1d0a005844274e651c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 23:20:49 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Thu, 03 Mar 2022 23:20:50 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Thu, 03 Mar 2022 23:21:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 23:22:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7dc782df0ae4c8b4c17828ecec5218e1151282bd4a5eba00cb205f2afb206d58`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28e412a0fd61e8884bd52daa8e67b3ec895b92a329093692ad88729704b85a86`  
		Last Modified: Thu, 03 Mar 2022 23:35:48 GMT  
		Size: 50.5 MB (50455446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:1ca23ff4a54afb2ed8e9e203b4e19a9f337591e8c6ca4f187daf1edd6ba87766
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.6 MB (247562629 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cbbdb657abe5c44e7d70bdcf2ce8c8472f39f8dafde3ca52e07f09b6fe7fd67`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 11 Mar 2022 13:03:34 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Fri, 11 Mar 2022 13:05:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 13:05:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3856972c35cd56dcb0987ae46762abddfc5120b3fe412c127d90b73decdc4146`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbb37c3a2bd8dc738c4f3c55d00e77d9089fbf2ca1a25e94b7965a5a8d64d782`  
		Last Modified: Fri, 11 Mar 2022 13:18:35 GMT  
		Size: 50.2 MB (50214892 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:25bdfc80e42f5a3bf185f70c376abe197c62c2ff1c81a22bd25ea45b8e89095b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.2 MB (261224591 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae9da7c3c7cedcb6e9c627da6478e8d32defeb48e2e5f00d81651231270537b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 03 Mar 2022 17:26:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Thu, 03 Mar 2022 17:26:34 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Thu, 03 Mar 2022 17:31:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Mar 2022 17:32:43 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:8a619838799f130f185bd53116ae19eaa4f48a456e7750f8c05f7fde1ac0c896`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84b91b9b8b470903d9d6fc53b6d8a56b55fc2d58df421551cb084793e1a68c04`  
		Last Modified: Thu, 03 Mar 2022 18:54:05 GMT  
		Size: 50.5 MB (50460134 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
