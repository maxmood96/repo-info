...
```console
$ docker pull mediawiki@sha256:eb99ecdbc7c237558ad0079cc077fc7daad4f6f532e02c06b8d6e608d267a792
```
...
```console
$ docker pull mediawiki@sha256:05eec8186467d62e0af75ae186e6b37ee7c04c754235bb92086724217a0b1432
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.7 MB (260695908 bytes)**  
...
# Wed, 15 Dec 2021 19:54:22 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:54:23 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:54:49 GMT
...
-	Layers:
	...
	-	`sha256:011f271cbd004d49fc8d1a78796e71d59a6e359f5683c60f9473cf1ef35cca34`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aaaaec50d80f99a16561dd441dc1c2326c39b8e9d834653cb617d3f27e1b1fb0`  
		Last Modified: Wed, 15 Dec 2021 19:59:16 GMT  
		Size: 50.5 MB (50451670 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:bad77a6e33ee1635a143421ea72829508054178871529d992a5b834ed893c731
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.2 MB (235229867 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5f08092fb57244333a7267e95a8011e4753cef4e10921dcda00ff99439389832`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:56:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:56:40 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:57:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 19:57:38 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4ad7e62dd5edcd5006186ef55bb1f2ea51af3f6e06290f9190a85c8487c3150f`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:346e22cf004bba73d96c42fb9d1acca49fec341cef3c15947b7769e3843a8d0c`  
		Last Modified: Wed, 15 Dec 2021 20:06:43 GMT  
		Size: 50.5 MB (50451458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:079193960eebe2c2ea875f174ecc310cbc75a97c16f7ce4c2ebb24a20f90286a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **224.5 MB (224520907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4fcfbbc986ea8a472f293b789b96765bc20578334e9e3395898ae171eb618e24`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:59:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:59:09 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 20:00:03 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:250c571e83aa665c4383911698c56fa1765da9683cd93b94ea96120827431287`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85213816631d99e04b9c97b18af788abd15506ba4d129e8627c3537f80c692fe`  
		Last Modified: Wed, 15 Dec 2021 20:12:47 GMT  
		Size: 50.5 MB (50451747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3abda2f3ff34a7727863da9ff456cd52fbb2ca571fcd677f2417bc15ac13ea72
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.0 MB (251001359 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56f525f500cb16e9ad9f0d2694048e0b3e6595fcf053c33f01e1a36b23d2ea27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:47:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:58:12 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:58:30 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 19:58:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9906603e47559983bee0739845efb5b900172ba7e50d28c57b228ed2cc2e4921`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f9723b03edd7ecc5eb761f3d02ead174c5786912f70989ae51bca320a81b904`  
		Last Modified: Wed, 15 Dec 2021 20:03:24 GMT  
		Size: 50.2 MB (50208270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
