...
```console
$ docker pull mediawiki@sha256:d39f8fcebe82e034efb55486379fd8c3116db3b7d9db04c41604fc5bf0a59c2c
```
...
```console
$ docker pull mediawiki@sha256:a01c49ba8345ef7045801ece73ff0b5b6961742ae7aa3eae0a87a963b054031c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.1 MB (350058197 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4077dced6b1abaadda6156beea98af4994ead0d32204f2e3f970dede92b2656f`
...
-	Layers:
	...
	-	`sha256:9e9aac5694302b57be5c947b11b1b62b35634372e7dceaf984635b74aa1fae87`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ceba04b51dac5b8f10f16f3c6104790ec72c7a97f73b29b5f90e6815b4884c23`  
		Last Modified: Tue, 14 May 2024 19:11:56 GMT  
		Size: 117.3 MB (117293024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:7073ea2b201d4fadeeae0885818fe0c826384973c9b143153f82179d20dd6bb5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.1 MB (306123218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df9fda9a01be2eecdfb29f7a5c236bc667c7b3dee1d717e0a1dedaef704fae6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 14 May 2024 11:22:22 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 14 May 2024 11:22:23 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Tue, 14 May 2024 11:23:08 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 11:23:10 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e1a8b60f9f017d8ed445ecf3f8c61f3f11995e64d856921c8711e43981a1cab0`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f1f7ba4a14126d5626c8aaa4c1a0a0a95303134a69eac9fc30bea4a828c979a9`  
		Last Modified: Tue, 14 May 2024 11:31:14 GMT  
		Size: 117.3 MB (117299281 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0aef1eb4e8c10254fafe1c1355e5d20124c4ab3a9e1945f2b12d14a53e18ab4b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.2 MB (341213580 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ad0be1bcaae5369d1907243e474ec111745abde42c6182c50a3b49715b980d77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 14 May 2024 14:35:25 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Tue, 14 May 2024 14:35:46 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 14:35:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ac3a7b9e61a1cf29dc91d78503a399d126bd91e882926157650dba4dc10ee344`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6a6300dbfcd10dce5bb9a7e90c2fd3324164f9c6cf2fd150c69a34e2d04523f`  
		Last Modified: Tue, 14 May 2024 14:40:26 GMT  
		Size: 117.3 MB (117293546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
