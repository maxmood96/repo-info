...
```console
$ docker pull mediawiki@sha256:9b4de097cd2039c2fd96ce2017f32b294ec3093146885df806a289e70196d533
```
...
```console
$ docker pull mediawiki@sha256:7b30f6c437d3b8beb54a89b86ddb967d45339bbb6d0f1ba45879c2047167ca73
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.1 MB (350059246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16d8a174543082011876991b386f2ec1914d7fbefde589ac8bd0834b39db42bb`
...
-	Layers:
	...
	-	`sha256:629cd1f4d0654745d8c09bafe17e3b69f8c338d4fe9c6c36e45480cc1ed10f6c`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ac196f47da6f54db8f671d14f778d26fec3844ca5e823e790e788159b38cbb1`  
		Last Modified: Wed, 10 Apr 2024 18:10:17 GMT  
		Size: 117.3 MB (117299132 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:50b329698a6712ee1840d3f22188facdf9ecba743d5bf9a9811d2ef7ce3aacee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318626473 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d5a3e7001900b84a402e9ea21be1fd0122138498cb5a2d2f49271e02df54279`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 10 Apr 2024 16:07:47 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Wed, 10 Apr 2024 16:08:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Apr 2024 16:08:23 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6225f66c397613d2cf8b2f401641748edb777d4f66b9054cafba1001784ec872`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7835b16a8556f8b23b11c52e393a945dfa05de6ad11eeb4550c9665245119ed4`  
		Last Modified: Wed, 10 Apr 2024 16:13:06 GMT  
		Size: 117.3 MB (117300444 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:0fa81fdd938a4d53c331d0b4296b661b9c76e5fea5d0d80992013b7f35bd38ac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.1 MB (306142856 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb2f3dc4265764956e69fe5933e910b11c8b498f21c068cde64b5fee7ba0a4ec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 11 Apr 2024 00:00:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Thu, 11 Apr 2024 00:00:45 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 11 Apr 2024 00:01:26 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Apr 2024 00:01:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d466cc02e99dbd706f28aaafce4f7be52b90b324e563468e2ffa8a3db800c38e`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa30ae11b7601241e4955b8fb6f130319b8a4be194d5ba2c0e8175b764c047ef`  
		Last Modified: Thu, 11 Apr 2024 00:08:36 GMT  
		Size: 117.3 MB (117302121 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:448431eaa71b9a5ba236a19e641f10094789208d415423914e4fb140db9a1bee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.2 MB (341227085 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddeec4465047926a2a84b1f152b8b5d5e10a234a403dfbb51348e991e379256a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 10 Apr 2024 14:27:32 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Wed, 10 Apr 2024 14:27:55 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Apr 2024 14:27:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3afa15cf3e4de96866b4da4da1816fec19f89528991b813e92d7c6facc7ea802`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15932af9cf1133d32753291f4a9024c15ee89b77ac3f578a021999a57e563f98`  
		Last Modified: Wed, 10 Apr 2024 14:32:45 GMT  
		Size: 117.3 MB (117298168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; 386

```console
$ docker pull mediawiki@sha256:7a9859678de0ed6868055cece667403a25c416c046abf4d45ad5c8b4285c891a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.5 MB (350533713 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e669a61044bd79c5f01289667fa3266fa929094bbed699a464120b88240ec46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 10 Apr 2024 20:49:52 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Wed, 10 Apr 2024 20:50:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Apr 2024 20:50:28 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:307fa1ef96f42231620eebe80f9b8e0f967d6e3fcfd24d2bb82420bc8b0c12bc`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da08cb657f364d5ed8b2c1f00495b1fc8c8712a6f432e9ea173efa4fe1a059d`  
		Last Modified: Wed, 10 Apr 2024 20:56:36 GMT  
		Size: 117.3 MB (117299888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:0562ac0b744ad66ea8881e541bfedc86dcc150054a2bd82ea6ee0147d7d3bd76
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.5 MB (358473421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4de878602b4b59987c76a3c5175e6511756962a78177d6504d7f449bbb81f0b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 10 Apr 2024 17:37:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Wed, 10 Apr 2024 17:37:00 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Wed, 10 Apr 2024 17:37:38 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 10 Apr 2024 17:37:45 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bdadd68caf6c402356b3db3f22054153d65a3cf09ea595114f5eec831c1ab04f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:622aa20eb0ba2b79d85b92d25273e990c352215440c7ae9e08ddd28d1ccf7e44`  
		Last Modified: Wed, 10 Apr 2024 17:44:21 GMT  
		Size: 117.3 MB (117298241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
