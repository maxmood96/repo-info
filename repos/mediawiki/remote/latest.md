...
```console
$ docker pull mediawiki@sha256:ed4e33dd0f9728cc2c4f390a5aac2f0f8940026e2d6dfe1063317772b0c11b50
```
...
```console
$ docker pull mediawiki@sha256:856abe9768258227688042aa8a694add1494705fc7b9dcf0edb020e845ad08a3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.1 MB (350057398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5d1ae1805d2f61e93aa14a8c9fcae8c881a145d25cf78f10aee4d076ac18308`
...
-	Layers:
	...
	-	`sha256:1b7ee182a2be2bcdb80641d7ec79ca9a1c572b958d5ce765c125daa688acd5a2`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b8875bbf6ff18d5b99ab83ba0c8aee2f57b3933c542e4a5e7b6097ed98cf9a2`  
		Last Modified: Thu, 06 Jun 2024 05:48:06 GMT  
		Size: 117.3 MB (117292890 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:bb25026959052f00996c88dfded95758bfcb2cad6d012da7deca3a0304034595
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318610614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9888cb5882bb5632a5c12c55b24a3afaf0d7458ee65f75f54ff4b821c503681`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 03:24:50 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 03:25:29 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 03:25:31 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:139d9415f993b662bb2a81efed9f53974ce29aa10f53ae6b64ac2eb6b9eb31b8`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebe8132bb0554fd71966c2ec68d33f42f6dcd06daf9ce759aac7bcf99b830a08`  
		Last Modified: Thu, 06 Jun 2024 03:31:04 GMT  
		Size: 117.3 MB (117297978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:5b8228afb0016686b5f95ffc29cbeb9c97bd4dcf7c0090aae1d5d8663aa0c605
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.1 MB (306120994 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f24b66e9d5c01da93947db4ed38c3ecbb403352d700360e387fed5e584ab44d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 06:16:45 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 06:17:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:17:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:18feba00f0e646ff8631e220875afb7deee1db1d4e2e4030dfa1fb63230efc27`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c0124ced879b2938485565b0b9ecb6dd962a1e7af2760b328964271bd961d63`  
		Last Modified: Thu, 06 Jun 2024 06:24:11 GMT  
		Size: 117.3 MB (117297814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:f4f06b697f515bec99a342a7ccf7de0927cf9fde4fa5c0b810a67c03bfdfbe04
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.2 MB (341213134 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91b6fd12e63e31bb69f5c563f8175707b531840e007e6df855eebe3c9dadec32`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 05:56:44 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 05:57:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 05:57:08 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:13f4ef9485696a95b91b9434b5f8815ccaf41909a4cd7cca0fff3299981fbe6e`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14b6f0e1e07c4c10eefef78eb23be6dcec5e1d59afbc818b3c021da0b2d76cce`  
		Last Modified: Thu, 06 Jun 2024 06:04:39 GMT  
		Size: 117.3 MB (117292951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; 386

```console
$ docker pull mediawiki@sha256:d4aa809f12f93b91e55d9e754986ce7f218b5dd5a70db3d7d08d8fa684202607
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.5 MB (350499874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d294cbdcd6bb2ca8b073daea6fb8ab5f2486c47f8ce592e0f884b888178f1f21`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 14 May 2024 14:11:01 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Tue, 14 May 2024 14:11:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 14:11:35 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e276c60c2d5dfdabb99f2c90fd42e4690a2b6d771d721a7c553b9f2a192329a2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf276ea0149cbec8750c803b7c61cd78a326365d9517561251b8ccb48f9965d9`  
		Last Modified: Tue, 14 May 2024 14:17:51 GMT  
		Size: 117.3 MB (117292289 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:52e64a007b21eae2744d99e4fefbf7c50b4133cd4fa8d80bdaaf91bf434abcae
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.5 MB (358456685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f89aba885c6886704c964b931f9890f7b977a1756bbd188dc833b84dc09903fc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 06:24:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Thu, 06 Jun 2024 06:24:33 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 06:25:08 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:25:13 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5392c9e6c5c0a79de2d3546d0ba09b29f7e915068d4a83646136163b0a8fd83d`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:869a9f764daa7f6cb187f3a9bc84ae3c2b917ebe30566cc7390b685918f5a81b`  
		Last Modified: Thu, 06 Jun 2024 06:34:40 GMT  
		Size: 117.3 MB (117292516 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
