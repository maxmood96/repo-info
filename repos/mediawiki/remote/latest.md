...
```console
$ docker pull mediawiki@sha256:acb8d957c147ea03a5cc0aaad75096cc14551e7a4c02b6d227bc067451f74670
```
...
```console
$ docker pull mediawiki@sha256:5f4151558a2e8c0da1ee9ec866f3d01e96ed529bd476a93ba9742cd5e23aa43c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.0 MB (350034931 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1717bef3c185cfc4f1a101d9f502b6c9901e0a8a007501e4a853c0b9d57abcc6`
...
-	Layers:
	...
	-	`sha256:ca5b1e59f47f735c17049f6f9c488e5966217cf0bff7c73692187f1e1d2d980f`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0035c963a0e0a7eb8f544daab339e4178010af969bc4e763d3c5d39284c0aed`  
		Last Modified: Thu, 06 Jun 2024 23:44:01 GMT  
		Size: 117.3 MB (117292802 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:843b7fb4384777d030f37f4536098a1d2ecb9dabf45ed00ccb1d67dd64673d79
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318587859 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37889abae4a96189969cf2e8c37d1e7bc1fe19cd14455bc3c3da5a24200c227d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 13 Jun 2024 08:14:41 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 13 Jun 2024 08:15:14 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 08:15:15 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:259e1fac8223b83e5406b0bd8550956d368553ec9f51420e0924d331b8707349`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6561a7c7dc9f1f0dceb1f069ad3e8d38f4956b76b8f9b6e5ee2f5802dc64f7cb`  
		Last Modified: Thu, 13 Jun 2024 08:20:13 GMT  
		Size: 117.3 MB (117298165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:651e3a1b0f7991987e960a6247392624e866fda559bb1e0d7d584aa48c88f99d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **306.1 MB (306099153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6caaaa16833db729f9867b6878f1f7af552c77779243a562cbcba35446a4eaa0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 23:26:28 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 23:27:04 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:27:08 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c77d525489b932598e04fa6ca92e2b28aca21d54b37f809dd8ece036bf8365d3`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a211c00a05fc477182205a64f880a6850dbb08ac8bf091a6962772fb233e007`  
		Last Modified: Thu, 06 Jun 2024 23:34:22 GMT  
		Size: 117.3 MB (117298001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:710d73736f6f04edeb4d6ce3fd066a32d44bab4fc38a2cad563080301c92aff2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.2 MB (341194312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7556bc00fcf00174b67877f483dea21c56525110f223fd0a271e90ca3082c05c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 23:45:56 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 23:46:17 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:46:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:63954ce8c1e1369b006d7e7c2faf2217dac741ca408677c646c0ff0eda79b474`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b8e195359ec4650f3c8304cce0c78fca71a7e1f06648557691afd766c2906be`  
		Last Modified: Thu, 06 Jun 2024 23:53:53 GMT  
		Size: 117.3 MB (117295038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; 386

```console
$ docker pull mediawiki@sha256:a1f1dcf181617ddff10b4380a28a150bcf7ac736b84e33a0f639fa01d07b3ca7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.5 MB (350477579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2168ae75ebfe0dd04eb14954b7566570bcb0e0531437ae124ba4d5cd853a6fc3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 07 Jun 2024 03:25:44 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Fri, 07 Jun 2024 03:26:12 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 03:26:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:9eeef00488ddd9421f3abd1c5ae19fc91cf8dd3bac68db2eb53277126a20d916`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70edbcfac9821d56c517f64dd92e4ebadd83eb539caecdedc0dcc4d69f415c06`  
		Last Modified: Fri, 07 Jun 2024 03:35:15 GMT  
		Size: 117.3 MB (117292758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:072df8e236492d200760a1539a20c9e1bbe7d47ac83efe94f0594fbdef884b04
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.4 MB (358434284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b754dae87adc68d54cf4e224cbbf9876bf640c51924994d74749cafdfc8b9c4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 13 Jun 2024 09:03:51 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Thu, 13 Jun 2024 09:03:52 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 13 Jun 2024 09:04:28 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 13 Jun 2024 09:04:32 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c8cd551f7cd7b06fc9ef6429b0afb21009a19c5ed2eb3fb1de659e7235338aad`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad6ec1f1c47c97954df56d335cc765450af55086853d764a884aec49f7c84814`  
		Last Modified: Thu, 13 Jun 2024 09:11:18 GMT  
		Size: 117.3 MB (117292574 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
