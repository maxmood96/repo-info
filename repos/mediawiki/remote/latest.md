...
```console
$ docker pull mediawiki@sha256:cd297a90910861fefd314228a19518362bacf1c3b83618a624610bf76277f99c
```
...
```console
$ docker pull mediawiki@sha256:ff383ccd3b219f9d9999ebf72e996968bcbd121c4fcfb97253f049cb09a81148
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.0 MB (349991376 bytes)**  
...
# Fri, 12 Apr 2024 20:06:02 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Fri, 12 Apr 2024 20:06:24 GMT
...
-	Layers:
	...
	-	`sha256:be487fdcc962eb98b1e775821089f1b39201c583c68307bd148ddc02fadacca9`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2384434a736bf517751a505cc4a882edc0132db530fe6a36c6db7740d41ab8ff`  
		Last Modified: Fri, 12 Apr 2024 20:13:49 GMT  
		Size: 117.3 MB (117298465 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:09c6e2f56ad8642154441588b0a1bd628e314f88adc8a4a4b3298b6c9260a27a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318561877 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0112c495fbf688680dafe91f6d37b5acba79ab329833ef30571a4d10ed538da4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:4579768d19632ca842301181309dcefa7f6a8adf6b2d3271902d2782dfe2cb76`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63c14d915adedaa6e5ace5b59ffcbd04da7fb31c4c6b1d5fb4d2516a289fe109`  
		Last Modified: Fri, 12 Apr 2024 20:06:04 GMT  
		Size: 117.3 MB (117302295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:507182e023d7eae40728209ab98beab3550822e7620f8692322b6439a7f93892
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.2 MB (341162112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db418a5ced8fa1af9e9373a3417d0c794463222d520868c86129e37950a55fa2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Apr 2024 19:25:04 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Fri, 12 Apr 2024 19:25:27 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 19:25:30 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d1795304745c3933f73a38d3d4641d6a27aa547e49dd1f586117a90fe2323542`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b0f741c032c57473c345736919b5fb7cecb8c69b9818bf00899d5d7938d46342`  
		Last Modified: Fri, 12 Apr 2024 19:33:08 GMT  
		Size: 117.3 MB (117298400 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; 386

```console
$ docker pull mediawiki@sha256:b13f71efb8411219ac74edc9429e717421bd3b026d3db1d751a705bbc6b19a92
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **350.5 MB (350467749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d936cba1e1f9fe5ac98caf989cca6de2de9a89b0cbfd94f44f6979b9999ae448`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Apr 2024 21:07:07 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Fri, 12 Apr 2024 21:07:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 21:07:43 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5345037dffaf37a2cd4b55ecc0d721165ad75b5aa4bfe1ec7b44adf832b15ca5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82df482ee880578f3d3f88fd46928bd51ba0c50bcead82946d515347df5547f3`  
		Last Modified: Fri, 12 Apr 2024 21:17:10 GMT  
		Size: 117.3 MB (117299776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:latest` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:d76757006dbb72e8f444c15cb7eaefa10cd63cab3dcec38357d8b741d527ffde
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.4 MB (358405571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea46368850ce15ebd225188293267964a3acbb38889f584cdb99878e4c12ca91`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 12 Apr 2024 19:32:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Fri, 12 Apr 2024 19:32:57 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Fri, 12 Apr 2024 19:33:41 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 12 Apr 2024 19:33:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f0df051225e18c403e55e52dbd591833fe91fd1ac2680e7b32585bcfdd22d9ac`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2413db43095670c590a2ccd986fc0ccadd093981141d941e9f78065c54fc7d1`  
		Last Modified: Fri, 12 Apr 2024 19:44:48 GMT  
		Size: 117.3 MB (117298163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
