...
```console
$ docker pull mediawiki@sha256:ada5a92b5c58089a5651377c50883386850d2ac029fda5a37cf0d3055ba6960a
```
...
```console
$ docker pull mediawiki@sha256:21f1e177385a0f3b558668413102db7f9b6667f51970458d40ce2dc1c626838b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.6 MB (318588774 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a62d3a382c298ad69cd874afc4701ed2aa66dcc9a512b0af8f50c5514d4d5e9c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:1aad1b1b538ed5c595d858c862e5311972768a010b8c739000cbc3978834e2f4`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:644886cbc45fcd0227020d23bddd7fa730e9b1c97283acf6d00c7275facf50f4`  
		Last Modified: Thu, 06 Jun 2024 22:41:42 GMT  
		Size: 117.3 MB (117298157 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:8a45c1d095af3bf92c82943c49592a321b9933a5df3b4272ad3e18868e7f5712
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.4 MB (358435143 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dfafe569708baba6e78e8073d28eb625a1361fd341232fe0ed6bb3315ed7c30f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 06 Jun 2024 23:52:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Thu, 06 Jun 2024 23:52:05 GMT
ENV MEDIAWIKI_VERSION=1.41.1
# Thu, 06 Jun 2024 23:52:43 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:52:48 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:7baae56e839a2abbb463e797c6b072856c3492a7a2384c85540838df9ee791eb`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b797cb4feb4318df8af9b394cdfb6ff83c8c0c363ebd16f193f263af2765ba63`  
		Last Modified: Fri, 07 Jun 2024 00:02:21 GMT  
		Size: 117.3 MB (117292964 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
