...
```console
$ docker pull mediawiki@sha256:692f94c4219ee2152197e1566ecdb0a273b7551f51d31db39ed3a310868ef509
```
...
```console
$ docker pull mediawiki@sha256:5409381edf448e473af8bf0009806595e98025ff056ab488de27ab0daff1e407
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **288.2 MB (288172559 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd852111ecb3eab0823097f3c5f730df57170c6dde935f2c53c463c7a972cb6f`
...
# Thu, 06 Jun 2024 05:46:48 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 05:46:48 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 05:47:06 GMT
...
-	Layers:
	...
	-	`sha256:f831de488d297511f08cb74faa3f552b2a84cf9ea2a9254b44445c21c96e840f`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de17efe7bbb996cdf5bd435c4c6d6fa188c698bfacc91481c887f1508100089f`  
		Last Modified: Thu, 06 Jun 2024 05:51:06 GMT  
		Size: 59.1 MB (59071521 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:7ea0a66530ed1aa21503ec9cb7fbe50a634f9e0259865e429546bba33a832488
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.6 MB (244619405 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5f911051d8afa131d9ff5be2651a27794f56b4777574befde9808970acf4a00`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jun 2024 06:22:26 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:22:47 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:22:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5801e6f45dc3eaf36abd3887dfb599e98e822d7c48f9dc712130628910066571`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dce6829f0bcae004cc670d98412593996a55f280cd0b43960d8711ad308de9e0`  
		Last Modified: Thu, 06 Jun 2024 06:28:14 GMT  
		Size: 59.1 MB (59066814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:d61fcbc2df105cde4592b75d57873f25febf05556c48aa9cc117a6e86eb85755
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.3 MB (279268231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a5375724387680e89ea0b1bf44d146a0cbf04fa88cd99b406237d66ed80ed594`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jun 2024 05:59:07 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:03:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:03:26 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:03:42 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:03:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9a7bc5963cfd72d2d58345263dded0c5bb007d57484786cd32bc3cb8f95aa5a3`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4e6fa2390333115d2d0148d9bfd99cb854ed5321e85c453f2c05739722557bb`  
		Last Modified: Thu, 06 Jun 2024 06:07:19 GMT  
		Size: 59.1 MB (59072272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:723359cb9a870432322d184871c11b842ce103326f2cead2a06ea88538ffa081
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.1 MB (296078792 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:881c9c0da538133cc0a594d7b32ee0102247feb28d1f7c55334cae5acb2af4dc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:32:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:32:33 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:33:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 06:33:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:81c200570ee4eda79f4300033379ea73ef822d7f0a387d37708559f7c2b9f6aa`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe939c55bceb8b2db5bb73c954927bf466cc195bb1280b419e124e75d5f22007`  
		Last Modified: Thu, 06 Jun 2024 06:39:41 GMT  
		Size: 59.1 MB (59071786 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
