...
```console
$ docker pull mediawiki@sha256:ed513486613593baff4b5f636df125cb9906ba4d8193504d77de8710f1a55469
```
...
```console
$ docker pull mediawiki@sha256:0281ad8624dbfbc22265aceac5eb1b8a8d9da78c57ca34b0b314158f360853eb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.0 MB (245999368 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0699bbd54de17e14822625baf1dcf20120a0499e755d0ce00188464f43e472bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 17 Oct 2024 07:29:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 07:29:26 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 07:29:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 07:29:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a3bbf364ca0fb4380e40eaf869266525ad85a5773554c3874d781db209d28e6f`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:100b2a7360ee55df2b23ed3947f7faadc2dc831e969562a0313f3fa6ba0f933d`  
		Last Modified: Thu, 17 Oct 2024 07:32:58 GMT  
		Size: 59.8 MB (59785518 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:adad0e9d5598b83e914de9965b91f7dc55083438d854969e7ca1f08cac1a672d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **280.7 MB (280666674 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7c15c5b887f1583f542d6d757c433344fa9eb728f48061c7f1bc319c3b5658c9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 17 Oct 2024 05:48:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 17 Oct 2024 05:48:27 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Thu, 17 Oct 2024 05:48:43 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 17 Oct 2024 05:48:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6c8b0790866bfe44aa6165dba88273f82a5ee36e1ef1ec847fc2a051f9527c61`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e95947e6fa1f156e9e264dc429dd0856b987dd4a36e23f06c14917fa3f5f9d10`  
		Last Modified: Thu, 17 Oct 2024 05:51:11 GMT  
		Size: 59.8 MB (59785366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
