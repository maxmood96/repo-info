...
```console
$ docker pull mediawiki@sha256:dbfcd17b525d6ab7ab6512d299d64a621e1f9411ba8a2b0632ed49ca9ce2bdb5
```
...
```console
$ docker pull mediawiki@sha256:388ef37fbcdc5d69d0abfe6157053a2c489486653b13629b574bd7c825eeef72
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **285.9 MB (285902000 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8585431273a39bf8f77e9005616f93f440d2d53c44403d207b4fabc80f76994b`
...
# Sat, 29 Jul 2023 02:19:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 02:19:16 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 02:19:34 GMT
...
-	Layers:
	...
	-	`sha256:c394546222c4dda8cd83b99f48df62fcea07687b00846fe2eff204e4410412a0`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb5252fe6c0d3586c2fcd8e153d2c26fdc1baf6385a7414f53467cdd233297e`  
		Last Modified: Sat, 29 Jul 2023 02:25:23 GMT  
		Size: 56.9 MB (56900051 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:2533942587657fc20604a3fe46782e2920240c5f54615a6b8139a8596ddbd181
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **242.5 MB (242515546 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9af183a0a48b34bebc40207700ff940352647ff7c66daaca0d87301266742247`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 29 Jul 2023 03:27:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 03:27:26 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 03:27:46 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:27:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6862b872f3bb4b99e75abd88c1c40aa9af328ea609eaea996e7ea5c487d782cb`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:619cbef8ff0d2770559614c26b738cc0b6f4d703dcaa115ce92a069d48ae44ed`  
		Last Modified: Sat, 29 Jul 2023 03:33:17 GMT  
		Size: 56.9 MB (56899095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:eca3051adaa32c106d21b9f4de49360a2996368dc4638f85e2f3fc42de34d8c4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **286.2 MB (286173198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:539705df38559e5d590feeb2ff2a602eb64677e5976bb712a35c1814fa5f12e0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 28 Jul 2023 22:54:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 28 Jul 2023 22:54:42 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Fri, 28 Jul 2023 22:55:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 28 Jul 2023 22:55:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0cd001c37cbaecc469187a4dc4554d6094f467bb519227c67bb970a8f6ff18c2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01189453d425c9081eee262a919738db98ea656a5ae87d75eed14405df1af8f`  
		Last Modified: Fri, 28 Jul 2023 23:02:30 GMT  
		Size: 56.9 MB (56899689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:2ae2ba6a7e96febfaa7ff1237793873d8f6db33193b2f57683c3044894d8c9f6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **293.8 MB (293827347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:68f2a58cd5fe7c6f0dadfabd1095937ec4da269f9a19cbe14a5f1dd6bbd7b7a0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 29 Jul 2023 03:53:41 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 29 Jul 2023 03:56:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 29 Jul 2023 03:56:02 GMT
ENV MEDIAWIKI_VERSION=1.39.4
# Sat, 29 Jul 2023 03:56:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Sat, 29 Jul 2023 03:56:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:35c135cbaf833298f2088aa9dd84fcbcfb188d3ac7cbd6d2accc713178dab291`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf064c5fabaa2fa2a101474d199d7759a2acda755a3166934abe7a046e0439a5`  
		Last Modified: Sat, 29 Jul 2023 04:06:38 GMT  
		Size: 56.9 MB (56899895 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
