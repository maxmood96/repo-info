...
```console
$ docker pull mediawiki@sha256:ff18f0e242fd241606b04a040364b437f2e1ca124a727d591f5d7546181135e7
```
...
```console
$ docker pull mediawiki@sha256:aa1e7ae7284098e0a3b1823ab51d8be35d6724df6309dbc0fae9b82369a6e244
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.6 MB (261643110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce6cd3135e43bfe2259c129d6eb3bd5a208235d3f2faee3cbc258daa3bde5f38`
...
# Mon, 03 Apr 2023 23:41:21 GMT
ENV MEDIAWIKI_VERSION=1.39.3
# Mon, 03 Apr 2023 23:41:39 GMT
...
-	Layers:
	...
	-	`sha256:160a53b287fbafac4713de8027f2241d42c36fcac907286ead4125a490bc2d82`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23355e13d5a6540f749c4ef1e55850fec049e8893194c12494caa6b6f8c5ade7`  
		Last Modified: Mon, 03 Apr 2023 23:44:57 GMT  
		Size: 56.4 MB (56414041 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:df6bf216aab83f8ab4dc7ba851f7d24128837ce34a80b27359b8f08d8cdf088e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.9 MB (235949431 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97525130a0d91e68c5aa08b8fd698ab4ff453c5833014a595ac80e73e14a3c2d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 Apr 2023 04:55:59 GMT
CMD ["php-fpm"]
# Wed, 12 Apr 2023 10:59:44 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 11:00:31 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 11:00:31 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 11:00:32 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 12 Apr 2023 11:00:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Wed, 12 Apr 2023 11:00:32 GMT
ENV MEDIAWIKI_VERSION=1.39.3
# Wed, 12 Apr 2023 11:00:55 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 11:00:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8133b0e8e7a542ef433bb4335a22236e745acb297e7fa4c3cfb65358fa416844`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aff96abca38b7df103452a80a38bf39d147219c8df799326623c732a92e83ce0`  
		Last Modified: Wed, 12 Apr 2023 11:06:15 GMT  
		Size: 38.5 MB (38462756 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2da8a1f751de6da70a59a612f846d38acff48050a648165ef438c5ba09e1dd7f`  
		Last Modified: Wed, 12 Apr 2023 11:06:09 GMT  
		Size: 1.5 MB (1499893 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19f794610623aa5a856ae81ab2b75fe9517101200cb27b8ba7a99444e505586a`  
		Last Modified: Wed, 12 Apr 2023 11:06:09 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a830de80e8b55116a79256fa637b59fe3e573bca42145a4dcd69daf3006fd9fa`  
		Last Modified: Wed, 12 Apr 2023 11:06:09 GMT  
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:257a2aea22d86400580f49310781959c75f1b0777bc8f5f8464ac74184d4b871`  
		Last Modified: Wed, 12 Apr 2023 11:06:24 GMT  
		Size: 56.4 MB (56408499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:9469278e220ff8df5a9dc17e4e132df0f286b5ba867b66c863231ec316e0e5a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.6 MB (225636101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fbc3b18ed0e759965c6a7ab279a35958b273a9a22251a789f126d516a41d949c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 12 Apr 2023 11:42:55 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 11:43:38 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 12 Apr 2023 11:43:38 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 12 Apr 2023 11:43:39 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 12 Apr 2023 11:43:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Wed, 12 Apr 2023 11:43:39 GMT
...
-	Layers:
	...
	-	`sha256:66db3554bc0e23889d45d9424c9ed08201eb5d20c5b9ef2ff0bd6edd14825cff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d576eee1d78dab833910f0a14f0f009af984b3b307e379b89a5b28a1e48640e`  
		Last Modified: Wed, 12 Apr 2023 11:49:17 GMT  
		Size: 35.7 MB (35730184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d3fd3ffa1c1a1f891757d89cb56d2f32a2ad8e605f7bfaf261a37fa64b80054`  
		Last Modified: Wed, 12 Apr 2023 11:49:13 GMT  
		Size: 1.5 MB (1463680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f98db58c124b6baffc6865d5dd9ea61d648aff1377bd2e1fdf1c311e06ff08e`  
		Last Modified: Wed, 12 Apr 2023 11:49:12 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f30878d6331fe87f11314221a319543fc7b4d9312d08fa7a363b6c857254556`  
		Last Modified: Wed, 12 Apr 2023 11:49:12 GMT  
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3adcff571409a729337bc47df8abc2150cecab21fceb9e029a573b86dbf3519f`  
		Last Modified: Wed, 12 Apr 2023 11:49:27 GMT  
		Size: 56.4 MB (56407407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:276d44266c363390f98dffd3144b627f2fdbc642b9bb0478cd12e92715381503
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.7 MB (253657416 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8e259a1625b1eb17bdfab2a7ec651bd06ca82b1f70f992d66a1e0e28b3ef137`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 04:50:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Mon, 03 Apr 2023 23:59:19 GMT
ENV MEDIAWIKI_VERSION=1.39.3
# Mon, 03 Apr 2023 23:59:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Mon, 03 Apr 2023 23:59:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3c66c639df51ed06889f8985aa697211c1228c1c54a70617e05686710f059885`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fc9cbf5a49fb3584ef874d2da4c60937f0889a417bb7378bee22e71457b22c9e`  
		Last Modified: Tue, 04 Apr 2023 00:02:38 GMT  
		Size: 56.4 MB (56411265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:2bb29b918439e1488ec0fee7b924a4df3af987d3c908cd047eb3b9b6a579e3c0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **265.2 MB (265202060 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2824b5abfbca017087e5de86f088ac248a11f29f5e56f9560b72310033176385`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 03:23:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 04 Apr 2023 00:58:17 GMT
ENV MEDIAWIKI_VERSION=1.39.3
# Tue, 04 Apr 2023 00:58:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Apr 2023 00:58:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5a093941b4db342a95630c206c916fc57798a740e0a8fefe5dbc9e7c71c67fba`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b4c4151094a0db08ac627ad119a979eb03adca8807210da5904c4d78696ff4e`  
		Last Modified: Tue, 04 Apr 2023 01:02:50 GMT  
		Size: 56.4 MB (56412399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:328ea1e361a8fa8bd51b361d1f90e0f2ae9b9d08544887a52febe674cb0143a8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **264.6 MB (264609195 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e5ba012ae76f28cdbf9fd8daef085b5d85bbc316007138f54cfb07ddb7ad81f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Mar 2023 04:28:34 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 04 Apr 2023 00:03:35 GMT
ENV MEDIAWIKI_VERSION=1.39.3
# Tue, 04 Apr 2023 00:04:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Apr 2023 00:04:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:61d78aeb6f395d0e6cedec6da3fc97a7a68dd72459daff48f81d3af0a1e45009`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31da683026e48d0fbd9d26c6f052c0aa9ad54697ac33eb6068f44ef12024513b`  
		Last Modified: Tue, 04 Apr 2023 00:13:31 GMT  
		Size: 56.4 MB (56415669 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
