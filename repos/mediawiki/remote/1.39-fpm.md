...
```console
$ docker pull mediawiki@sha256:ae0497b8fcbcce71b1beaa611e4c19d17604c69ead0be45a1b7e7c9b5a3eadc1
```
...
```console
$ docker pull mediawiki@sha256:ebda9c06f5672ff531042dfa9c1978aa7db0d49a8ac78b5fb19167810aae304c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.9 MB (287906381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae26b3a86c4da9ef9f6c02aa133b5733d4e900641884e401c29c0c93d943d016`
...
# Thu, 01 Feb 2024 14:59:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 14:59:18 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 14:59:36 GMT
...
-	Layers:
	...
	-	`sha256:cff7114b893c8084e450d35dad1c7a07d5e3797a37ae9526f0546ebb274cbac1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b02423bbd760cb5509ba19637c9a3a923015c18fb608e17751016d361157fdcc`  
		Last Modified: Thu, 01 Feb 2024 15:02:16 GMT  
		Size: 58.8 MB (58763095 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:aef91779eb6c299728437b150afd78452effea3ecf25d18481ed79a7deb60667
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.4 MB (244363137 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20379c23e11d89df00b21b591095392340a34c656aec16a5dbd1534274420aa5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 09:00:25 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 09:00:26 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 09:01:01 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 09:01:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4acaa9c6146ab8b3c06cb3b1187182b2df73cc9ceb0257cde3506c144fa9dd76`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2fc996e7cc40e287df3f610fd80c20626a450e1ea68824e7e12bbd3ff91f043`  
		Last Modified: Thu, 01 Feb 2024 09:05:08 GMT  
		Size: 58.8 MB (58761043 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:d65c50568a3b7fd66d561044e888edf6d5e173a4b2f2e79c73d9d1c264375210
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.0 MB (279018515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f28f5bc5944515895efbb706235bceec927d7f095026591224cdcfd6ad9f278`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 12:45:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 12:45:47 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 12:46:04 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 12:46:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c0867095c92700437684d04be9f4321d7005921f4000de2742044eb5487040ff`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a22c17f3da379f4fac4ea10d4f3aac9308a8b4051845378f81550d55e4b146ad`  
		Last Modified: Thu, 01 Feb 2024 12:48:47 GMT  
		Size: 58.8 MB (58763559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:68908ed2910ecc659d54f170b970c27c93e2818967f2e925a5d5feb362df26f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **288.2 MB (288167011 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d9eb04bdeca8cd5cda70555f6fc170db6e7d9a7b20d2b7ed794a7aed7d21902`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:c351ebeb16116bd067083d934cbca752b75e02f45d9ae991d60cd7f9860344a0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2bf839b338272685e32ede51c133086ff7b455cf297c60420f8e21ae6247e33`  
		Last Modified: Thu, 01 Feb 2024 12:33:56 GMT  
		Size: 58.8 MB (58762339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:820d43e8e4d4079aca08c31ff54655b642e9e07ad10c3f2c46199ffc28bde54b
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.8 MB (295834247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19b71bad1c5839ed9f8faac778ccec7dd38687b2d69f35ff5bf60057b76b5fd1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 01 Feb 2024 09:21:57 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 01 Feb 2024 09:22:36 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 09:22:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3d735ac1f162489aba554859ca510f4b973dca397aae9dd83995f52858c8788e`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e095fee9a77294b05dd1a8a1b6611c3662816ab8889faf9beacd56ff4373f3b3`  
		Last Modified: Thu, 01 Feb 2024 09:26:06 GMT  
		Size: 58.8 MB (58764032 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
