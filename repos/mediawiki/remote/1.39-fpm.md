...
```console
$ docker pull mediawiki@sha256:40efb3dc25eb49fa89c25b394241e7c758ad250bb6bd64bdd9685fcbb8628fe2
```
...
```console
$ docker pull mediawiki@sha256:075f3f91524075c1cb545a7c36ea3b2136526d86cd26a77142ac76b67ba4ce7c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **274.6 MB (274607583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3b6c77f36d4df1eedcccb2a60eef710bf229a97d1c471ee3c299ea1f9f70a416`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 29 Dec 2025 23:40:35 GMT
CMD ["php-fpm"]
# Tue, 30 Dec 2025 07:37:17 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 30 Dec 2025 07:38:40 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 		liblua5.1-0-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.28; 	pecl install LuaSandbox-4.1.2; 	docker-php-ext-enable 		apcu 		luasandbox 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); printf "*%s\n", so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/* # buildkit
# Tue, 30 Dec 2025 07:38:40 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Tue, 30 Dec 2025 07:38:41 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data # buildkit
# Tue, 30 Dec 2025 07:39:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 30 Dec 2025 07:39:01 GMT
ENV MEDIAWIKI_VERSION=1.39.17
# Tue, 30 Dec 2025 07:39:01 GMT
...
-	Layers:
	...
	-	`sha256:30ab12c8835155237725901eb8f306a7a5f5be9e598e68d09134b88724251da4`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2b38a4dea96dd9cd9ae699bee31191ec9a6804ad78ec1a29b50538fd1bf6fa6d`  
		Last Modified: Tue, 30 Dec 2025 07:39:30 GMT  
		Size: 50.7 MB (50730276 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:e3b402bbffa77ac9e7a9defca2e3b8255beeffe4f2ffb3d773e6cf29b1f98503`  
		Last Modified: Tue, 30 Dec 2025 07:39:26 GMT  
		Size: 17.0 MB (17027519 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b1124f46eb8d5a0bde1a405a14a80183db54dbc58d65f3a66140bf96f84f253d`  
		Last Modified: Tue, 30 Dec 2025 07:39:25 GMT  
		Size: 316.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8c6259d567fa657b550d3e262dcaf6df5db3adebf9c0e11cb5744aae808da251`  
		Last Modified: Tue, 30 Dec 2025 07:39:25 GMT  
		Size: 138.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d9eb583f65641284e147f590dae2c1f498f761c65048a1b991f3a6959a154f50`  
		Last Modified: Tue, 30 Dec 2025 07:39:29 GMT  
		Size: 60.6 MB (60579364 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip

### `mediawiki:1.39-fpm` - unknown; unknown

```console
$ docker pull mediawiki@sha256:2d54d3a4c30651b8f912490e2da5b5a50feaa55cbea5b5b2773affb6515aeb19
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.4 KB (34374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e866d56b5cb099a4896d79246a183e86c4b88d274f1c19d3601a65b4302e8d1a`

```dockerfile
```

-	Layers:
	-	`sha256:e276445fcc311fdf3d590207cf725a6ddd12127347952bc346473b62c9db610a`  
		Last Modified: Tue, 30 Dec 2025 10:16:24 GMT  
