...
```console
$ docker pull mediawiki@sha256:42b28a1c3ab45f7f0d5c691c8230e11fd2b0c1d0f14b36a9f184692321ecec80
```
...
```console
$ docker pull mediawiki@sha256:7c2f2fd063ed6d8165bfdd9f9eafdf003bb31e6ddb1df0903b75129cd7edf1f3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **287.9 MB (287869502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ee77028d1b218ab66f499e6d4b20e6b68340b9e1503da0ee9b05bee5d74003e0`
...
-	Layers:
	...
	-	`sha256:52f94b9c349a5490f631e74d20a90cde6698a0ea3ffd5608c695f975b0ce6c9b`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcbec5da58d0e784e4f65c5d5f3591edfff512e3321719f58d94e7e4d3316173`  
		Last Modified: Thu, 11 Jan 2024 19:40:50 GMT  
		Size: 58.8 MB (58761339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:c5268d60c721c04def48afe1fba2edbde0190cc2039d8c13e6bf00a4d4685e64
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.6 MB (256604728 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41deb3b7d31204ab783c6d859b5c6be81d59a3cd6f71d6b8f34b615e3f3d0189`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 11 Jan 2024 23:46:37 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:48:55 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:48:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jan 2024 23:48:59 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 23:52:31 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 11 Jan 2024 23:52:31 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 11 Jan 2024 23:53:07 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:53:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:53374bab99147f083d73fbddc05d5427569ce691fbbbbe2d907dc105fd9681ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6aa945762206a979427932ed4b3e259d2ad4c683e05b6efd4fcf408e3aeec052`  
		Last Modified: Thu, 11 Jan 2024 23:54:52 GMT  
		Size: 49.2 MB (49218026 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44e006f8385a0a6ac9c068853a71aae8b6d2896edc22e587cd5f73fbe1b2e2a1`  
		Last Modified: Thu, 11 Jan 2024 23:54:40 GMT  
		Size: 1.5 MB (1486813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce66f36fd10b552677075e75f3d4955f438c45c972d033f617680b5854c95fe4`  
		Last Modified: Thu, 11 Jan 2024 23:54:39 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78fb27ac3ba025e4d4a7483c05edd43357bfcc2fa443d93a5d1f31e4c01d529f`  
		Last Modified: Thu, 11 Jan 2024 23:54:39 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:509d7a907c051e786c1c96a303d82e222c5e97ff1ec0352e1b12830f01b77ab3`  
		Last Modified: Thu, 11 Jan 2024 23:57:22 GMT  
		Size: 58.8 MB (58762227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:5f15ffe91101a974c95b21d8b13ab5b160336ea7db792e53af53439b52b7a869
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.3 MB (244334068 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:261bfeb3316e234017f6e46595dffcc2c6a7284085a8ba63a46bc84cdaea013f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 11 Jan 2024 23:06:15 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:08:35 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 		libonig-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:08:37 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 11 Jan 2024 23:08:39 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 23:11:59 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 11 Jan 2024 23:11:59 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 11 Jan 2024 23:12:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:12:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b4413e82fb6333c351adc886c2d4b82d0a99caa280f4f33cf1e80cab887ac873`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a6689e19d43835d21f215434fbc2a73fcd7a823f2080827228e4355f874fe8c`  
		Last Modified: Thu, 11 Jan 2024 23:14:28 GMT  
		Size: 45.8 MB (45838834 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01fbf3be061b066e9bd37ee7ca9d650762d8556d6071692a80a510007b2720a`  
		Last Modified: Thu, 11 Jan 2024 23:14:13 GMT  
		Size: 1.5 MB (1452037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c05f87975faa7dff1e21f17505098355c4624db7822ca071dfddc403a373947`  
		Last Modified: Thu, 11 Jan 2024 23:14:13 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b65852fdefc6d85a300428adcbb83fff21f07285fc3dd398901c98b54d4eb46f`  
		Last Modified: Thu, 11 Jan 2024 23:14:13 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba57055ff0e8797515391518ee37b3dea9a67c24f79c0dc2abf9c5280bed98b8`  
		Last Modified: Thu, 11 Jan 2024 23:16:58 GMT  
		Size: 58.8 MB (58761850 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:92a3c2bb2b877c1276dc2cb24967780d5c6e0541edb0add6cbad73590f07a1e1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **279.0 MB (278983130 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88f90618699d404e473f7055a0ea6524b9be76408e515364a49fb868e425e9e4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 10:47:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 11 Jan 2024 10:47:09 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 11 Jan 2024 10:47:25 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 10:47:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f51efd8ec5f85ece2ff5b06f61840cc446ea102968098d5ca838be89086d40a2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:899336e1f6d9a0e14e8ab2e125f2955c752cccf29e2bc6865eee60e39c30f680`  
		Last Modified: Thu, 11 Jan 2024 10:50:02 GMT  
		Size: 58.8 MB (58761185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:c4624a922700cd4c44507d637c08a6739dc9b0a3db95956a09e6e903b2c69911
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **288.1 MB (288132749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cdc60a404fd1140f8f5de09aa0f5b60fbf60cc883a75e3f1f5e3a4a7bceab29e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Jan 2024 18:53:16 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 11 Jan 2024 18:53:40 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 18:53:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:db54a87b467ed2137dbe8ba816b4ba2706e8d20e036f786a95b83dbfe842bf25`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ce45f2f1dac2ce1592426379547d3c5dbf029bd14343c7b7625fd73d2c0d923`  
		Last Modified: Thu, 11 Jan 2024 19:01:21 GMT  
		Size: 58.8 MB (58760745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:4ff8a87c56abf0b689e11bee49ea9ce8c639a3a1586dd20e9094a3b36b122a6c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.8 MB (295796939 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:54cfdfcd9f5721e6a743c658003bdcdb6d8e4083f5753f4e4669a6d7e2ce2ed3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 14:17:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 11 Jan 2024 14:17:04 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 11 Jan 2024 14:18:15 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 14:18:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:873d8804c653e96398ca8db791a255379023443aaecb79d1c103194b2ce31cf4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abf1cfaada22d8a84f64e799172f35d3bf3ddde1f62919f76d32eb2879c12868`  
		Last Modified: Thu, 11 Jan 2024 14:22:02 GMT  
		Size: 58.8 MB (58761037 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
