...
```console
$ docker pull mediawiki@sha256:3aa0e095a2e2704ee7c4fdcbf1cf5a78a6f1e8c3f276201cfa38a579e0ff5597
```
...
```console
$ docker pull mediawiki@sha256:648c1d5df31a372d735afe15131a3a2ee00de904695f3fed47cf2b169c8a39ff
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.7 MB (346726892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c58eb0fc9d9e433c01eb605ea41760538049015feccc6a53f79b07449cddd00`
...
-	Layers:
	...
	-	`sha256:fa1a926d5675658d6a4c207316b7a67bfb234819da2ac974bd69b539e3dfbd6e`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5cff0a514c35a478498c003b3d00af5841390f512ffd13f78d5819539722c255`  
		Last Modified: Thu, 27 Jun 2024 20:32:14 GMT  
		Size: 117.6 MB (117643003 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:b061be77249d8e3e04faf79f4e9db4a51480ecb46dfe10f27c0952954626eddb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.4 MB (315448926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:344d0b83aa83b640a8f2461bfaab44ab98a4068d76a1b59a0b645a144dddda28`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jun 2024 20:52:12 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Thu, 27 Jun 2024 20:52:41 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jun 2024 20:52:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b395dda077ad854170a2b245b04b8451c59d4a8d35fd098228488fe0955a20f9`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3ce1c543547c850f987a4e2aa06c3412b7e4b3fa8898d03fd3959fccd7c24ff`  
		Last Modified: Thu, 27 Jun 2024 20:58:06 GMT  
		Size: 117.6 MB (117638912 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:98e04d409a342c7155c3f7c8355f8dcc4d8654d2bc127415bd1dd53dca297c85
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.2 MB (303179997 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6cddb1ae46b489236cfc3e8ee09f986cb5e43635d18144e91308ec20df1341a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jun 2024 21:01:15 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Thu, 27 Jun 2024 21:01:44 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jun 2024 21:01:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f2d62bc0ffb48949dda9330a4cb0ad738a2c55686522fadd0df4814baa5cb591`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d95d30b33406fb59cf419a9d797d60e4a22479ccb3370ab144b734c2a798de16`  
		Last Modified: Thu, 27 Jun 2024 21:09:57 GMT  
		Size: 117.6 MB (117639829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:99d24685941e6cacdebbed8675a4c3ecf437e5137b5657196e148600578f3a42
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.8 MB (337825079 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d3386fa3f69d70b9f8ba41547785aada5870c83e1e68889b93847aa3cc1ce0d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jun 2024 20:44:50 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Thu, 27 Jun 2024 20:45:12 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jun 2024 20:45:15 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:24742a02125d2e6f5ed3dc3531749a4eb7ea7ed612939117ceb6478c4aadaba6`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4827047d0248c14c4558849903855cec2ee5c7b52761497593a19c4b0d7e0ea`  
		Last Modified: Thu, 27 Jun 2024 20:54:01 GMT  
		Size: 117.6 MB (117642961 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:43501a3635123a3c7aff3639624eecba40777e539f4181c2a4559907dda1b20d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **347.0 MB (346956854 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4d3b609606c9fb776c10e0e9ba8a182866c3f461e966c552ecefafff28378a3a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jun 2024 20:46:28 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Thu, 27 Jun 2024 20:46:58 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jun 2024 20:47:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5a660511dea59cfde58b42c41ec3613f068e643a129d424f04a900881c548074`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c5a5008c88fa347b3ee036d69ac3e3ed145fa3e10e361669ac102905e5bece5`  
		Last Modified: Thu, 27 Jun 2024 20:55:33 GMT  
		Size: 117.6 MB (117640975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:a87f72eabab3876a56a065a202ce95c8d60d111a311711a4324f1f98bc6fa797
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.6 MB (354635666 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:570679ac5c1709da48cb58fdf8a69aa30965ce5914385858f9c5174b16cfa85a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 27 Jun 2024 20:22:00 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Thu, 27 Jun 2024 20:22:35 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 Jun 2024 20:22:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f6d588b66217fe6c6440a11112e452eec6eec2f70e005dfed5a0a10d8cf2e213`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae43842de7fb241ef480ab55211a1c90bfc101043fcd49dd8dc6ba1466877d52`  
		Last Modified: Thu, 27 Jun 2024 20:33:12 GMT  
		Size: 117.6 MB (117641260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
