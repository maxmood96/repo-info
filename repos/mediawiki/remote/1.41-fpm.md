...
```console
$ docker pull mediawiki@sha256:a50315dd22010e547a199447f5f2ab60e5c956a9c622c3f3e5a97bbea0e01b5b
```
...
```console
$ docker pull mediawiki@sha256:c0ecae0eb52ea00cf61bb9cc4cd74357e3afe3eee4c566e9ae0d4e4347365e01
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.4 MB (315397242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa4c852379238933d57185641dc35385dd24b1dd4bed1654ab61189d3ade2203`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Jul 2024 04:38:43 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 02 Jul 2024 04:40:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 02 Jul 2024 04:40:05 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 02 Jul 2024 04:40:41 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 04:40:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1fbf6acfbe228701443c788cde824b8f734dd4d18e043dabf736398720e2ffa7`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:416d52af62bc34e458879f50296c93a5f1d7c65e2e32c5bc9fc8716d34ba479b`  
		Last Modified: Tue, 02 Jul 2024 04:44:23 GMT  
		Size: 117.6 MB (117637422 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:1e3485aed0bfbe7ed45e0d5cfe8c9a00550a7519fb0b3ccf7d64b914692520bc
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **303.1 MB (303114097 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c9908d4dac4c949f1178bfe5ed4b34c7e5910d830144ba4668cae54185d1fe04`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 02 Jul 2024 04:59:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 02 Jul 2024 04:59:26 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 02 Jul 2024 04:59:53 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 04:59:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4cc2328c08dc5c6d257d2e7ae125a68f53fcd2f3fa1a24aa372818ee48fc5404`  
		...
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be50cdb97f4b10234f87813d66c0a0b9a9b80721409fed220675b69c7bf56c84`  
		Last Modified: Tue, 02 Jul 2024 05:03:17 GMT  
		Size: 117.6 MB (117638335 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3ab0442a5d1ec75fd5598760091d3b666c09d7276416440331106d924d005f58
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.8 MB (337794942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6918393e7fe4cc2b5581e9175367a3d0f4347ce39174e78f520032d0f4df7e5a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Jul 2024 07:30:43 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 02 Jul 2024 07:31:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 02 Jul 2024 07:31:53 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 02 Jul 2024 07:32:13 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 07:32:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1fb5f1ba9b5fbbe75c956ed4ec816ab64d151aa2b17666330955f2081eefde12`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57dcf1acba8d1bc0f4b0e70a2f39523ed209e833f61b2eeb0ed71cf78a6a77f2`  
		Last Modified: Tue, 02 Jul 2024 07:34:52 GMT  
		Size: 117.6 MB (117645502 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:f1475f1bb700a26117d83e00da3d3b468fccbf2618a3fdd52c807f44bc28551c
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.9 MB (346937240 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:334ab2c89f9de35e3e010e82b09a1b8fece06d9076c040010f304a3a700ba0b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 02 Jul 2024 07:13:54 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 02 Jul 2024 07:15:13 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.41
# Tue, 02 Jul 2024 07:15:13 GMT
ENV MEDIAWIKI_VERSION=1.41.2
# Tue, 02 Jul 2024 07:15:41 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 02 Jul 2024 07:15:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:548d7b7725d9c5e4421d4bbcbb8ea598d29eb63ae6d985a8a0fcce9d2d6ef60c`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:373ce53bd7abb3750a0d376268facee09ad40501cd80528c7d1913ca5e2a0c20`  
		Last Modified: Tue, 02 Jul 2024 07:19:33 GMT  
		Size: 117.6 MB (117643103 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.41-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:678cb976eb3b505ecc7f2ab40171c2b2e879b047ec9004e3000843c72a4b0ed1
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **354.6 MB (354611396 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dd69ea574a049af86839fb89d047cb05403ae51d552aab3c4cab8fabe6a3ec64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:e0ab6b1274e337cf0546f18be5b64859d3244f52abb65b8b3d6ae9b05cbf35bf`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e60dd3c06a59c762ff4df9d592ba714a52e2a284d284ff666a977d33459d0f37`  
		Last Modified: Tue, 02 Jul 2024 06:55:47 GMT  
		Size: 117.6 MB (117643620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
