...
```console
$ docker pull mediawiki@sha256:7d74d1e54d85328b4166c0f564cd25f83d7e85e7c9a541aaef451a943f40948a
```
...
```console
$ docker pull mediawiki@sha256:91afbf2d7be6d5990c7807ce49182b4c1c6661f7b565669b7cfca1f23a37fb86
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.9 MB (256904110 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d929a470353e3da0798dfb81df49f104899c10a02cfcd05481efcb6c5bf8b055`
...
-	Layers:
	...
	-	`sha256:0e74fc4eb2095598d363ade4724474ac5a68a8a44c7912cf9a7151a5a3ec34f4`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59c00023060f08345f233c2f5b24b3198ce6dacb3da9a55412905f5ae92623e6`  
		Last Modified: Wed, 15 Dec 2021 19:59:42 GMT  
		Size: 50.4 MB (50433415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.3-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:a8a5fea6a00b87cb38383d1473619f72bcc7e4d10bd344c1cb3306783a24cbb5
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.7 MB (231669210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35c388e00174c0bd36288aca01e463715200b2ab4f228334309de77b4220fa27`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:57:51 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:57:51 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:58:48 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 19:58:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5a106a900ed9c5e3a29b81181a6f6d0e4366c44f514481499897cd54d238cc70`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a8df7cb7875c24859fba8b0f6de6adcd7fae6a60103efc2e8fa4ce65e2f4d8e7`  
		Last Modified: Wed, 15 Dec 2021 20:07:57 GMT  
		Size: 50.4 MB (50431648 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.3-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:f0b557f47cb4b52239336a3d757a9bb5899be19587931792d60c9d28aae86bf7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **221.2 MB (221160579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b166071ddd01f949627a8d86ce92b7d9aea96e5395a7adab1a3053b09949e65`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 20:00:19 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 20:01:11 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 20:01:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:05dfbdbcfe497396a83ce54c8682ebe66a8f6d4404f4a495212fd3813975eb99`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95d2d8d58a2fe501b97611a5d718923f3bee153a270f4aeb575fb0c45c037bbc`  
		Last Modified: Wed, 15 Dec 2021 20:13:58 GMT  
		Size: 50.4 MB (50431693 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.3-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:f2464df9a8bc0a3df6766125bc6959e561d4019158d95862b2f094ee7dec6cc4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **247.3 MB (247255229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:291227755d0c75ab6c9fdccec9df0d15062998e8b228743374a8b6bf2cc3f622`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:48:08 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:58:39 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:58:57 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 19:58:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:445dbfb11d7b635a844a7f7735db72f9b4b1cc2e3334ad3696abdf672c6ceb2f`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92cbcfb83a00904eba8d2701ff545b443e42b9f7f58bf4b433e423c9d6d777ed`  
		Last Modified: Wed, 15 Dec 2021 20:03:52 GMT  
		Size: 50.2 MB (50187249 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.3-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:741ac013106c96133efd3a61a8f0ffd2be7bb3d5f0ebd392c503090dd404344f
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.6 MB (260640436 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:253e7a8fdc86bbe3b5cab1139626eaf4a0fd0108f4a104e1c18fcb2e1c854530`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 19:45:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 19:56:40 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 19:57:05 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 19:57:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c2490661031b2f8625505b2b79b887bc1bbf5e2016aa3ec3f72848b67cce6101`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c94a24378024b86387f97eca48d0f441ad56c955c7d7140793d3934eadf1a76`  
		Last Modified: Wed, 15 Dec 2021 20:02:58 GMT  
		Size: 50.4 MB (50432874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.36.3-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:600130434503ccd4acd5cf0e5534b4fe05a1b1de16bad6bb7c8bde0a8c2b9640
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.9 MB (260920601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6843b6e1653ef26a1c22084bac63fddc1023d34d30acfcc72546b6f5743858ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Dec 2021 20:01:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.36
# Wed, 15 Dec 2021 20:01:25 GMT
ENV MEDIAWIKI_VERSION=1.36.3
# Wed, 15 Dec 2021 20:03:29 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 15 Dec 2021 20:03:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5fffa6959a8276960fa7ab8f0f52eef02b46967a5e8ccb35b8a15daf2779d041`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8e2aae6c97992196183125cb14d54ec5951c9391485b5f7f383b43e426d0785`  
		Last Modified: Wed, 15 Dec 2021 20:17:23 GMT  
		Size: 50.4 MB (50434073 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
