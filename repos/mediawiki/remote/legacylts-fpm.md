...
```console
$ docker pull mediawiki@sha256:ec6b54682c0f3b0a530f5deb47760f64f635c1be558a51674a0a178cd9b77dbc
```
...
```console
$ docker pull mediawiki@sha256:5222749faafa5b91d4d778f24c57ac30c7214eb76543ad242315bc4ec04c153e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.2 MB (255239508 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a55711fbf370bd015c9ff983d8d3b822e7a95c1dca65425d0bebe421f32ca756`
...
# Thu, 09 Feb 2023 17:30:06 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 09 Feb 2023 17:30:06 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Thu, 09 Feb 2023 17:30:25 GMT
...
-	Layers:
	...
	-	`sha256:94e400b37671efa960fdb7691980bb0bafa2288a5b2f115db2ce0137027a7fb4`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3406987a2649c7e925405f77de7270e7f228f45dcf1d1d99a9ccad3ef62540b6`  
		Last Modified: Thu, 09 Feb 2023 17:33:28 GMT  
		Size: 51.1 MB (51077819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:4e904bcfc692c40dcbbf880b896073881fec02f939243c77fa29e0875bfbb544
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.0 MB (246014515 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c70f333242184b3455f32a12a88d2b48e9df17b853b153da99abcd89caa49bec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 09 Feb 2023 15:35:20 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Thu, 09 Feb 2023 15:35:36 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 15:35:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5e5371d10cbe363cd8f04b5a68ee441d65a4709c0d9e8096a103706b418e41b3`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85c188d0a6f41d05c79a7cf067f65de735f1dd7a6fdce80cce3e590fcaeac147`  
		Last Modified: Thu, 09 Feb 2023 15:38:23 GMT  
		Size: 51.1 MB (51076110 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:2948d3cc2711d1174cc9f446448344bad1ee04df9a158dc73e1273748df777a9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.6 MB (257642618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1539b6c597ce9a11985ba070a720eae75cd4d25c382d16a22b117834dd0d1ac0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 09 Feb 2023 18:59:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 09 Feb 2023 18:59:40 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Thu, 09 Feb 2023 19:00:02 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 19:00:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:640fe16c47e5aaf0b6caefc6ec451fd3625b37e3a393046f5ba2ac951149ba43`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5258cd05a9d673a9649040172395b13767bb3d6726883178d6b0b76775a2ff31`  
		Last Modified: Thu, 09 Feb 2023 19:03:58 GMT  
		Size: 50.8 MB (50837319 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:557cca571bd9b54e9aaf2464b29e48be5c5dd4effda445f86ec4f5642ecbf34c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.2 MB (258225274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1fbfefd6b84366e757e98031bcdeabee311f749e4d8318a98c9dfc042aabc697`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 09 Feb 2023 20:11:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 09 Feb 2023 20:11:25 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Thu, 09 Feb 2023 20:12:03 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 09 Feb 2023 20:12:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:90e7074e5d2fafe47442fff0bbb47895f7816efed6004d9fe609a6ad8615076b`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53593deabe8ed342e22dafc767f2963afea2b0135a8c62233c6f59b2bcd6172f`  
		Last Modified: Thu, 09 Feb 2023 20:17:02 GMT  
		Size: 51.1 MB (51078259 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
