...
```console
$ docker pull mediawiki@sha256:e0459e529239c6a997f65026818c3c0b31b8a50dd210be17623edb80e8c1a05e
```
...
```console
$ docker pull mediawiki@sha256:692fdbb322731eeba076dc5c01eeb43a012bb3f772293f2a3ee35dea49b0e8ec
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.5 MB (253469351 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:542efc558d8e8e30aee5dec7513b6091ad67b4b20d3840b65532fad4d305e735`
...
-	Layers:
	...
	-	`sha256:17a65a4ad4a924091b474a33f9a90cca5be5166b622a7565414444c62ee420e3`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11f383aba171f4381643b56c11a256624e1a1bf31fb53732c9f94875c090bb8d`  
		Last Modified: Thu, 29 Sep 2022 16:50:38 GMT  
		Size: 50.6 MB (50626328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:b79cd4412ee325b26e6e72f36937f585062104b683c5acaf7f88945a89bcca95
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.5 MB (228463127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:582221132e50f286a0853bb9b17709f8affef822a5fb705659e5a3c5ba567aeb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 16:41:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 16:41:47 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 16:42:29 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 16:42:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:feee8b2439e678366371be08ce1564b7ff3df1b086a09ee116b597471025ea28`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01e98b2127aba066fdafc8d42f6a4ab1710a94212ab4e6232396ca6693112db7`  
		Last Modified: Thu, 29 Sep 2022 16:49:20 GMT  
		Size: 50.6 MB (50623311 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:31013e431ac6a96e7273fb79d156718fd6c5f843331c99bc126b58cd40907372
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.2 MB (218170113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56965e237fc7cfcbd8f15d067e28f48a7f8914af6ca40f25986d975e73d0566b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 15 Sep 2022 01:39:34 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 15 Sep 2022 01:39:35 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 15 Sep 2022 01:39:55 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 15 Sep 2022 01:39:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3a4dd3857b0c38a17ffaaba8e794e8bee4f59fc97845389299521e09a320dae9`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfcb998b48b7c263f339a0b020a4075678b59766f65ca41c026eb571c012e703`  
		Last Modified: Thu, 15 Sep 2022 01:44:55 GMT  
		Size: 50.6 MB (50622644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:6e4c642bf1c4c0422280c99e0d4c8597d6468fd24ae07c3381bff2b83e19b936
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.0 MB (244018487 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac6ede0d503ebda61bfde32f2b0eb9198fd5a312e7967adcaadca416c9bd4b82`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 17:42:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 17:42:32 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:42:52 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:42:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:73228140f7eeed6109b3a4fc2342e74da8799a083fdb42723129ad536f389931`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d8e0e808dd539164cf8e9ba3eb85ce7909ba53efd079d5cabcf50ef660e1b2b`  
		Last Modified: Thu, 29 Sep 2022 17:48:00 GMT  
		Size: 50.4 MB (50383650 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:3e84a9de25f102cebd03a755bc708c700e5fa2d890b5345225bc0dcf0f9b0d73
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.2 MB (256150522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:206e56579df5fed992ea495e6b6d141d1ddc00e86209b301bc2733daca442072`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 29 Sep 2022 17:47:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 29 Sep 2022 17:47:58 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:48:19 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:48:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bc0103ffc76a82bf1e3e94b0fda93ce5d714fbeeff6d29a4463c44129053cc9d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d72ef718062968a74bb61394952ffaacb50d0c4a265f08c14bc10ab9c41e579`  
		Last Modified: Thu, 29 Sep 2022 17:53:23 GMT  
		Size: 50.4 MB (50383688 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:09850277cbbb82714c6d9f6538fe19c6074250709811b07fa972be912a0c3697
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.1 MB (257101062 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:084a9c0e3cd3f75d4a16510cfb7578c97559be3e0567fcb6da1ecc9aa6d43de1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Sep 2022 17:10:38 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Thu, 29 Sep 2022 17:11:12 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Sep 2022 17:11:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c80691caced4bd22a09df3d196340c6c74ced7415dbc0276d24302aecdafa060`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5053ee2fa685913e69116005bcb33c728430228254ab1f0f5daf79ac314e3e03`  
		Last Modified: Thu, 29 Sep 2022 17:18:23 GMT  
		Size: 50.6 MB (50625984 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
