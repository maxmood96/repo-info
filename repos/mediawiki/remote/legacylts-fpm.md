...
```console
$ docker pull mediawiki@sha256:4ca35087c21e18c9f01e1f10c64539886b05035f14acbd2b95999a85843dd654
```
...
```console
$ docker pull mediawiki@sha256:86cfc2d503d83e6dfefd78f6f4798ce5d71adfc95275f1c1b42ea370a5c9b45c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.4 MB (253402388 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00a5c5853ad4b93d62a071371c632cc53e4d8296632ca15176cd332dde745de1`
...
# Wed, 13 Jul 2022 03:34:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 13 Jul 2022 03:34:32 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Wed, 13 Jul 2022 03:34:50 GMT
...
-	Layers:
	...
	-	`sha256:a2f95e96ea3cf739260e706707b3af2d5cb267b894b994eb678e01ead9b04054`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13736fa1dfcde649c4c3875f3f64d46af62fd606d883c1caad38be458ccebb11`  
		Last Modified: Wed, 13 Jul 2022 03:37:58 GMT  
		Size: 50.6 MB (50626090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:02fbd58824048f4ec239079d3645d85d216ac0930981459b74ec7d802bc57efd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.2 MB (218177656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ddfe97f1e88edca66ade3eabbefd973ef129d214044f90bd2a432c3baac4aaec`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 25 Jun 2022 04:20:26 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 01 Jul 2022 18:06:02 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Fri, 01 Jul 2022 18:06:54 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 01 Jul 2022 18:06:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:fb24318850d727e1326db65f34023f8b1d47301abc719dba3441b2d1968ad79f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:937ea3d810260d4920aeb58d1d51940f4bed9cbd362f7771bcaf8db7ed1c236c`  
		Last Modified: Fri, 01 Jul 2022 18:20:18 GMT  
		Size: 50.6 MB (50621878 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0ead9dc156293e6b9a7b5defbdba153e8b964710778d539c59e1a960d5ce2d15
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.0 MB (244012426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b866ec45550124852b623bffb49848158e0b14f2f2c2edcdf0d5d5c4903d9f1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 13 Jul 2022 03:21:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 13 Jul 2022 03:21:09 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Wed, 13 Jul 2022 03:21:30 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Jul 2022 03:21:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5f42562429ab4fffac85feed3b690359c66d0e2ad80dd216336f75a8ed6bbb0d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad32105b322f6959d4597ef988311c6192471ad982a926f5f7877ba6fb46b442`  
		Last Modified: Wed, 13 Jul 2022 03:25:22 GMT  
		Size: 50.4 MB (50383371 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:93a5a54ddf36bd5031ac17f18287293e90272a6c7f496f085e30326de58f5ff8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.1 MB (256136657 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a292a42c4341aa1e3e906c80057849080941e3ebf61efc87434181916408b63b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 12 Jul 2022 17:03:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 12 Jul 2022 17:03:55 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Tue, 12 Jul 2022 17:04:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:3b9d9a3daf8c31d0141900bbf3e8c0f59d014fa4726c6aec55dbbd71e69f6907`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b44e15ac74dab29acce0726a8fa2a2f267bbd2cb8c5e00a37b9951f75d13e85b`  
		Last Modified: Tue, 12 Jul 2022 17:09:36 GMT  
		Size: 50.4 MB (50383076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:6c6aff1ec8c551806bd8498ac93655df264cf52f4a3f56314e4d107158ef53c8
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.1 MB (257091700 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69ca7db5d58c235fa8d92b9db6699b8a592e54199eefc15985c125ce81f69203`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 13 Jul 2022 19:48:11 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 13 Jul 2022 19:48:13 GMT
ENV MEDIAWIKI_VERSION=1.35.7
# Wed, 13 Jul 2022 19:49:08 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 13 Jul 2022 19:49:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e5b3b4f6a6ceaa5c13d06b8cfaafc63e15e5d120557446e3aa28366572e0c73a`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:80d302628e5fd265e4eac182f7285293363bfac9a59960b4f5a0d3c44ffa713e`  
		Last Modified: Wed, 13 Jul 2022 19:58:26 GMT  
		Size: 50.6 MB (50626033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
