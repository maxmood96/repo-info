...
```console
$ docker pull mediawiki@sha256:4fb4404862a3b08decca7e5b3aed115e2c20b67dd7d0f8e6009ac8e1f7c98861
```
...
```console
$ docker pull mediawiki@sha256:4c82722855cfe70b9c274b110a548961c09f307e1edda04c7b1fe5da02060702
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.4 MB (255356415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aa02408aed922f59c4adc91af2702bbd8377758a94957a3462e062de8a383e1f`
...
# Tue, 23 May 2023 22:45:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 22:45:19 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 22:45:34 GMT
...
-	Layers:
	...
	-	`sha256:60437d241795670eba4219a3c0cafb8f94cdc54b57d42bb26e71762553a8cf2d`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d89ab35b48ab048921ce1274c8c29334ed29078e9b54d15b2839ab000cd588b`  
		Last Modified: Tue, 23 May 2023 22:48:15 GMT  
		Size: 51.3 MB (51285883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:7b6eb670af70344696c2e81b8517579cb0408adbf62e42a4cbcde0982408ec05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.7 MB (229664398 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:97c62bda4cf69269cc7dd8318e4d2bacb3088b2b4f781f04cb848019748d53fd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 May 2023 12:40:36 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 12:40:36 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 12:40:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:cd8a48f9dfbadc098c03642b84ff28f271f68883d6c9b82223f45d2d83ceec96`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:901224de48ebef4306fd39885f2fb60330c97fa52b5fd569571ed123fe4d3089`  
		Last Modified: Tue, 23 May 2023 12:43:56 GMT  
		Size: 51.3 MB (51285427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:aaef9ae3c9158a8e3d9ab766d298857c2463564c2b31b4abaddaa118f725ee9c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.4 MB (219376132 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9bd0c937212dc07c3e8bce84a289da3e642ae22295e398e748f3e2a45a0103d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 May 2023 12:56:40 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 12:56:41 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 12:57:01 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 May 2023 12:57:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2ee9f97ad3c4f29f0e57c2616b3e7074993e55a6f29f75813be5c4b3be2ed327`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5aa2f4098ddf292d0e0603e0c6d083494b971fd3f70ed6ea881dc9a1f6ce665`  
		Last Modified: Tue, 23 May 2023 13:00:07 GMT  
		Size: 51.3 MB (51285086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:98dbd1db735f89d4375c36378699cb3fc9aa82e3d3f7cd7f617359c5b14f318d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **246.1 MB (246139873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7f6a4680b8c795c0d10e4104fe82383ff079cd4dc6bd42dce7d98ff1a5c28e8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 May 2023 13:02:39 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 13:02:39 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 13:02:54 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 May 2023 13:02:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2a3b2fcbddd329f57f455ffe98f14a13fbdc512c040117b80d0161f04ae9f011`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4493752f4ebf70b591609ed17c59d8c6e7094a3e3e9e926aab5cdee1a06bab3c`  
		Last Modified: Tue, 23 May 2023 13:05:23 GMT  
		Size: 51.3 MB (51285807 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:306f4b1e83a9dc6a961e15585e718a655117960a3e5e85608f0bb7f9f820f8f1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.9 MB (258884098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bcd71e10b27cfa899843600e1193a9cd7cabd080750aa36902bfa36ebc3f344`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 May 2023 22:31:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 22:31:33 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 22:31:56 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 May 2023 22:31:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:53db8d8777dcae26a06a0375e6d91f85b828652e92cbdb6c215b6ed49c3cef2c`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c3e58ef8fb2743b655f16b2076022dd5074e7f538af3b044a0afa8493db243`  
		Last Modified: Tue, 23 May 2023 22:35:22 GMT  
		Size: 51.3 MB (51285898 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:e98faac01c42216298863ec0a342e13941dea6018c17b148f6c70cbc01f4ba05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **258.3 MB (258329015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8d0435f6c53eb51c5df2a73bc54874b082332bc4919f04ee00631cc1d2d2770`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 23 May 2023 22:27:13 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 23 May 2023 22:27:14 GMT
ENV MEDIAWIKI_VERSION=1.35.10
# Tue, 23 May 2023 22:27:51 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 23 May 2023 22:27:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e11060c8c68525d8738e6672eba0d97e10fd7609464b9abcb061b480ac27f396`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f93e559deb951c59eddccbb9aee42212b0bf146c783a00b8e72b1d2579adbeb2`  
		Last Modified: Tue, 23 May 2023 22:31:42 GMT  
		Size: 51.3 MB (51286058 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
