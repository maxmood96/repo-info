...
```console
$ docker pull mediawiki@sha256:70595cb1c81f2748580bf89c7212aa492cae8dfd297c7fbad24dcbdd14d73200
```
...
```console
$ docker pull mediawiki@sha256:2aa9ca41f81ce33b7900ed4a056f8361c1fc587ad76c4fb9de133a1936a60ecc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.6 MB (248619694 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:656c45b1ee091710a2018e308b81aba567d866eb5b4ce480c8a061b1923bd945`
...
-	Layers:
	...
	-	`sha256:2b522a074aee18b7bd406b0f5fc52f044801a6c3ededb65a4356595000e3cf8f`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b992af58f8e08d2ef11b8da090d90afaf2414532c5ba6052ca7cab2ec628bdac`  
		Last Modified: Thu, 21 Jan 2021 23:00:57 GMT  
		Size: 36.2 MB (36194211 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:b181fa3d23e19a1f0ab11dee1345809cb833e0e564b41f7ab76d5f858e192d15
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.3 MB (223309656 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:73d99cd7dd6af231c5640ecae358bb917606e10ed3d231d4a96d3ecbf47bff3c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 04 Feb 2021 20:09:17 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 04 Feb 2021 20:09:18 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 04 Feb 2021 20:10:07 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:5712363be1b527fae8c85539ed814c7b29c2129c02dc4218fa1d1300e30d394d`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14d27e8559c745278a5c55498d777c1f7bc773e3a0ee73defa0e2735da78d8aa`  
		Last Modified: Thu, 04 Feb 2021 20:13:40 GMT  
		Size: 36.2 MB (36190951 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:d9119a1a461a2c762a677b992df056448b901a377f489f1c3b10b5788561c9b9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.1 MB (217089571 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bcbb7ae6f592925105ea3eb294237b5958d3ef420cea2c282f1e6e3d688dd0f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Jan 2021 22:35:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 22:35:20 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 21 Jan 2021 22:35:57 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 22:35:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9351591656a6214bb7334ef13a5d08835f7e3d33e7c822d020a74be239936993`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8ab8eed573f1cc50a4846e3da12ae6df7e828fded883e69709a72a0b0368bc0`  
		Last Modified: Thu, 21 Jan 2021 22:42:27 GMT  
		Size: 36.2 MB (36189929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:146d88cb8530c8ea41c158c11a8f61a268b3151d7205f5953a27c595f9fbb26c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **238.5 MB (238518706 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ca84852694c2a1d77ef303211c9755f718f06315fe8889271633225e166b63a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:842175cc7708f05fa94edc18174348e7f192f3e213006484f78e0e85443cd56a`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be00ac7b9ee0d0b2ea0be2dc13f83c9c6539dee0c68c1e6e31f65d7391b47ea1`  
		Last Modified: Thu, 21 Jan 2021 23:05:00 GMT  
		Size: 36.2 MB (36193630 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:ba59b797ff323293fd9619de7eef5bcf7f39c1a61181301123711471ba35e9e3
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.3 MB (256347677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4440d27a1aba0404bae82d6cb84bdbed258ac6ce00bd31488a4b726024a0fd88`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Jan 2021 23:23:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 23:23:58 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 21 Jan 2021 23:24:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Jan 2021 23:24:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f607a55c8a23fc429c5f457ad03754dd00a80fb520582b4f221f2dc9571a06fc`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ee08725d68c86c4f6cf9e20e4404a4e14c55fc759da28b3d49f952882239375`  
		Last Modified: Thu, 21 Jan 2021 23:30:05 GMT  
		Size: 36.2 MB (36193490 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:2068c38b836028cc4515102a834d17ce9c7103566e51bf2ea65a897f0e2004ff
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.3 MB (266319760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b13d56ee9aa00ae5d6be5eb698d9f134f8d235b1ea3798580ab87aac2a9045a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 22 Jan 2021 02:24:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 22 Jan 2021 02:24:37 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 22 Jan 2021 02:26:14 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Jan 2021 02:26:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1721b1d5d3a86dd1329073e20911d25e0f817d413d8871c55d4e589a92c6cf1b`  
		...
		Size: 172.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98986947b873c3e3de2f8c6c1755a9ec29572a4447f1b94c7a0e3411c1b7b052`  
		Last Modified: Fri, 22 Jan 2021 02:42:36 GMT  
		Size: 36.2 MB (36196962 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
