...
```console
$ docker pull mediawiki@sha256:1d4cb9b5e902ec0592905923d270ebf320ebfabc66c44323e649dc3a8fe7ace7
```
...
```console
$ docker pull mediawiki@sha256:d9d591ac7997446ccd772acc521aefe2843f53fa52183e93be66ff7704974ebc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **253.8 MB (253750907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:548ec0fe589cfc006db85e09a9fd1ca826c32560de1f1b345dd87dd6a707f51e`
...
# Wed, 26 Oct 2022 18:25:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 26 Oct 2022 18:25:38 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Wed, 26 Oct 2022 18:25:57 GMT
...
-	Layers:
	...
	-	`sha256:35a1307a4b46207a7190a06b5316280efa859d93924945fb65fc231fe8f5aab9`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4cfc44800db87865372e9b64490e62c384809ba34a664dd5cb3f095686b5d65f`  
		Last Modified: Wed, 26 Oct 2022 18:29:06 GMT  
		Size: 50.9 MB (50886752 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:5e5e41ef009ac628ca0910a03cec77a3f0fc12d9d0890e42e18723a9a38a4d50
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.7 MB (228744312 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e389a67bd6cbaba7df9b7022e7cdecc7879c6f708f1be8692fef25c3043e438e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 25 Oct 2022 17:19:23 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Tue, 25 Oct 2022 17:20:00 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 25 Oct 2022 17:20:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d5832cc95f5dc062a08269209f19d7d43b7372b7c422b020619bf30b7a2cd6d8`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b625df09dcc02f95802d156a28d1e3be7d97bc17bcd0d69e83e12d30fe55dc0a`  
		Last Modified: Wed, 26 Oct 2022 15:53:58 GMT  
		Size: 50.9 MB (50886853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:c888e7cee4b53ef80081c7b485565f702ed429f0c400de7ce2967aca58d03c80
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **218.4 MB (218443024 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8131af68384a007190d37edb87bfe717d5b01f1c985e66cc0be1068c75357be2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Oct 2022 20:50:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Thu, 06 Oct 2022 20:50:59 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Thu, 06 Oct 2022 20:51:23 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Oct 2022 20:51:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:722e5277e7e00ca1acf04e387999b7801cfdbf58c7c1f7dbc1edc75e2a5f8877`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:410a24d1453757dcce94397d068a9f6ac9a46abfdd754c2efb14f6399165489b`  
		Last Modified: Thu, 06 Oct 2022 20:58:34 GMT  
		Size: 50.9 MB (50883382 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3e4a638ca1d44000749f118b522d302eabdfd0676e8d81a5cd35b4f18e08e8e6
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.2 MB (245206301 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fc8500b1fd2a33ae383a6ba3db01c436d928ecf0a75e75561d55cb85d645fbc9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 26 Oct 2022 13:04:43 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 13:07:36 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 26 Oct 2022 13:07:36 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Wed, 26 Oct 2022 13:07:51 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 13:07:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dc8a075ef3fe77eacb46e333cd6f64fa893c4f4e2530b1d8cd897b34cc7ad7d3`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1adffe39d974017581a212254e2b10af7c6a8774e00745681ff32cbd10009e0a`  
		Last Modified: Wed, 26 Oct 2022 13:11:56 GMT  
		Size: 50.9 MB (50886534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:46683796ab98e655222a83d31184f1ea115c715cdc2851d29e713cda31009caa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.2 MB (256217742 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3524845bb9c933eb618f2d2aa522abe38ee17947c75d0dd5517b23c109601bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 25 Oct 2022 21:00:11 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 25 Oct 2022 21:00:11 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Tue, 25 Oct 2022 21:00:32 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Tue, 25 Oct 2022 21:00:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9e2a6baf37d744207fd878a169dbb6afc965208f9ce3685ee5526cff302f7b6a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20e321b90734ba91d133e2b9e1ae0351b53624ab1e7bb12c64bff244c1f0d241`  
		Last Modified: Tue, 25 Oct 2022 21:04:29 GMT  
		Size: 50.6 MB (50641417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:a87faa59fe48b49b2da555316c1128e7f58a52619aa2d5d656c2696c35f4149d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.4 MB (257378740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56a4dda992892346b5140a4c177229364efc57837c5ea318d737ee645a515b5d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 26 Oct 2022 00:48:23 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 26 Oct 2022 00:48:24 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Wed, 26 Oct 2022 00:48:59 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Wed, 26 Oct 2022 00:49:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:08808a84a560ed99b801090d811cef2296394ab42a091a40e9cb2afe41d2c0c4`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2bc10f7a262da29926865d88e17e07f3a4e1b41800aac42a29701ef36520e0c2`  
		Last Modified: Wed, 26 Oct 2022 00:54:06 GMT  
		Size: 50.9 MB (50886691 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
