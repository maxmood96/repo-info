...
```console
$ docker pull mediawiki@sha256:25ba3ef905502e8fdfb4e91ba80ce0871d08d2ba3c16b9444af6bd9c9e66961e
```
...
```console
$ docker pull mediawiki@sha256:55c02458a2a16eb67bf86969f9023dd5a03a7de470ab7a651f2e3ee28f417c26
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.7 MB (228722959 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:874f1e523e8d344e10627ec14871ceff92d508ea7fd7551ea0c7f19d0fdd7fa8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Sep 2022 18:51:13 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Fri, 30 Sep 2022 18:51:39 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Sep 2022 18:51:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:feee8b2439e678366371be08ce1564b7ff3df1b086a09ee116b597471025ea28`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53fc92a4f014d9ec10cc72cdd4c225953fe7c393a5f28249e796493927075489`  
		Last Modified: Fri, 30 Sep 2022 18:57:03 GMT  
		Size: 50.9 MB (50883143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:5d3cd692ea18f0ffa0cd67b7e51606c85e14db40edef933fe42cefe2b8a68642
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.3 MB (244275642 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:836fd961d2ee01aff7ecd22f91b286831c81899df9a052d7fab45848a1fc7509`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Sep 2022 18:43:17 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Fri, 30 Sep 2022 18:43:36 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Sep 2022 18:43:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:73228140f7eeed6109b3a4fc2342e74da8799a083fdb42723129ad536f389931`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66299990fa2663bcde1970472e80f9073df078f0bde6cf9dcaa11ea9dc2bd4b7`  
		Last Modified: Fri, 30 Sep 2022 18:48:39 GMT  
		Size: 50.6 MB (50640805 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:7d2af265e05653c1d5e104a35a7ffc38cdd643503b86bb54f56061cfbd4f6e7f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.4 MB (256407719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00580f35d32d0d304398acf8429f99671adb400a99da78ce3bbe8bbe177a69d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Fri, 30 Sep 2022 18:41:57 GMT
ENV MEDIAWIKI_VERSION=1.35.8
# Fri, 30 Sep 2022 18:42:18 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:bc0103ffc76a82bf1e3e94b0fda93ce5d714fbeeff6d29a4463c44129053cc9d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c747e37a7587f25cb4f3f6282e1c478899ab3dfc6687d409e2e9f19db927b85f`  
		Last Modified: Fri, 30 Sep 2022 18:47:17 GMT  
		Size: 50.6 MB (50640885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
