...
```console
$ docker pull mediawiki@sha256:31da88faebfb80831651ded200d1e71a0c270de065fd75f86deca632b71081a1
```
...
```console
$ docker pull mediawiki@sha256:f2f3691fde4dfd627f1f455925440bb3fa474fec261e1c842fb4463543371378
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.3 MB (119346426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d86e49e4a6b5696a30f01233317078145a23d1819e4b59fcfc44de7eedfd09be`
...
# Tue, 01 Oct 2024 19:28:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 01 Oct 2024 19:28:09 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 19:28:21 GMT
...
-	Layers:
	...
	-	`sha256:c9783eeddb266d6e0746fb735917699efe90894ab53786c1a806fe74e2eebd1d`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4c8841e1f6b42369a8d40f9c7df369e7857f80475dafc1a860b1ef5e6ca218c`  
		Last Modified: Tue, 01 Oct 2024 19:32:35 GMT  
		Size: 59.5 MB (59481348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.10-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:98fadf44f0172b4e93da56e418413f1999a45a1a25250829ca0cb324e18c614a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.7 MB (116719934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f1b5d0857dda5ecfcdea9b88f2c31abd0d4ea2aacfb075c374b0e9330a3fa194`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Oct 2024 19:51:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 01 Oct 2024 19:51:30 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 19:51:51 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 01 Oct 2024 19:51:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f9026611e70b58cfd582c13f73b92e6488613a04a47e6082e98081f340897f63`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82bb42c6e967e696d270d2bf9dabef90eea3a9b00ddde9314d5a8ea168b99079`  
		Last Modified: Tue, 01 Oct 2024 19:53:25 GMT  
		Size: 59.5 MB (59481366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.10-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:07160f7f7f6f95b3644ac4857529d0e213e955342cbb3aca4243bc911dacbc08
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.5 MB (114504927 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d9bdd19109381bcaa888c93873994f01b6a1c04ec1d0ddc9ada01b85582c9be`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Oct 2024 20:01:45 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Oct 2024 20:05:01 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 01 Oct 2024 20:05:01 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 20:05:22 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 01 Oct 2024 20:05:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:487453d3fba5f66ea91c274943a8e2463821a7d0093b6d71dab23ac75c336e75`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7bf4a6dd747e07f323cfc8d0d246996fe7ec490a5363120f88291fc6dd3017cb`  
		Last Modified: Tue, 01 Oct 2024 20:11:22 GMT  
		Size: 59.5 MB (59481785 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.10-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:408a5217df0227f19c49991e052fe667069e4f90dc1ca0030e55fef5bb29c308
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.3 MB (120306659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e2d62e11b3500cb6ac8784da360e641536985f19f5cd44cb1fd277c87d8d4c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Oct 2024 19:48:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 01 Oct 2024 19:48:38 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 19:48:50 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 01 Oct 2024 19:48:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6bfd55c78075ae994cd421467b3907126616c2d790868acd4fa1b9b67ecddbf0`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51139d9b04bd6fa4d544ea1d594292eb88a867d655b08c77abd9598783917725`  
		Last Modified: Tue, 01 Oct 2024 19:52:38 GMT  
...
```console
$ docker pull mediawiki@sha256:6ab0017035c995d9963ee1e0cee3130500a6e025843572ee648db1dd4f5353b3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.2 MB (120179426 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cf4565f5ccef59477a5a2fe20e9f04af33a145575465079615773e27f22cc0e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Oct 2024 19:45:24 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 01 Oct 2024 19:48:43 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Tue, 01 Oct 2024 19:48:43 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 19:49:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 01 Oct 2024 19:49:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dd0e600d28acda37d5492070df630c8bc87b0a4ae20ca97b363717db46ab8206`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c9421215c1ed81c53f9c637d1f55c8f567881bd9b8ad8b86cf5334f52a5a868`  
		Last Modified: Tue, 01 Oct 2024 19:54:24 GMT  
		Size: 59.5 MB (59481543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.10-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:850ab8518903f04f7bc56b97aae7320ba53d8f0f46f1dc5682e3dbc461d992d4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **120.5 MB (120465793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be13c5a55f8138449438e991ce2225b29baec048a97fde50e3ea5eee09b5ab52`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 01 Oct 2024 19:25:32 GMT
ENV MEDIAWIKI_VERSION=1.39.10
# Tue, 01 Oct 2024 19:25:51 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Tue, 01 Oct 2024 19:25:55 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4acb9ad279f067e838fb421784e3ae2a43b355ae1f09079191f99a74a3c87f22`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88e81df2577c027559b5c4c32e9444f21625a908917b9783061439fbe95250e4`  
		Last Modified: Tue, 01 Oct 2024 19:32:58 GMT  
		Size: 59.5 MB (59481614 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
