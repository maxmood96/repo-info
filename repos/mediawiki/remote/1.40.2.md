...
```console
$ docker pull mediawiki@sha256:dc3983a55dcff17950f90c869a76a1a3e1cfd97c441c2bdaccb85186f2ab69b2
```
...
```console
$ docker pull mediawiki@sha256:263259073240d6f37af57d7bb368731832f57337fc9f41cd9de270b4421d90ce
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **300.7 MB (300720083 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2992dfc7c3d658ccb19c682487567863de59e3c06253ed16376cc373baaec924`
...
-	Layers:
	...
	-	`sha256:66a1cfcd4ac52e107e9da2b37f3d492ffe3021685a35e511c4652b2a0f2b8ab5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62887e6bd5382f58a254e89b8e10d39aaeb66ba7dd467982e37fff3546387217`  
		Last Modified: Thu, 11 Jan 2024 19:39:35 GMT  
		Size: 68.0 MB (67971784 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:6ddcf8222f0cd59c8c18fdc45ddecafa7f32ab4183d5f8504b23859e38dd42dd
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.2 MB (309180227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e033a3ce6bfc371be01a44e4a42fc132fa35d8ef69519a77137c8f63b3905df4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 01 Feb 2024 09:18:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 01 Feb 2024 09:18:46 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 01 Feb 2024 09:19:43 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 01 Feb 2024 09:19:50 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:45b37de1530aecff70b5673bf38f198ffef9c52f6c95b05b73b9b7a76e88c4df`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e68a977b5fb6c3be998ebb0cc211858d9326e0bc43ff7b85806e1b9675839563`  
		Last Modified: Thu, 01 Feb 2024 09:24:37 GMT  
		Size: 68.0 MB (67971683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
