...
```console
$ docker pull mediawiki@sha256:29302e5c0031dd203f48212c38c55c5324e260c5b1dccc1993abcf0f6e5faaba
```
...
```console
$ docker pull mediawiki@sha256:077a9b73ed8bb08cfe12eecf62440052e8fee1dffdd8341ef9ce11e35518b025
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.8 MB (256804379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f6c1a36db401d71a00e0650afaa79fd94790604b913dc88174f4e2dc9c78789`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 23:09:37 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 11 Jan 2024 23:09:38 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 11 Jan 2024 23:10:16 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 11 Jan 2024 23:10:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ab088030b229e0954fa2132104b186d86823e8ea113ee40c6dff440a4c41e02d`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f028855152162ab0a7094cf63f1c4287b1913051647f53ce55b1b610b2aee6c7`  
		Last Modified: Thu, 11 Jan 2024 23:15:19 GMT  
		Size: 68.0 MB (67970271 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:afee8d7e10954c1c17bed191ee0dc1443dc9ce91fccbbab70a481a2aef8a7a65
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.1 MB (309142690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:467b8202e5b345d411c55ea1f24c815eff54c3eb694d8c67805142c5746063f0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 11 Jan 2024 14:12:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 11 Jan 2024 14:12:16 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 11 Jan 2024 14:13:24 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
...
-	Layers:
	...
	-	`sha256:712eb153e2d9317344b2e4005ec7b01a270462754c5717727039ee02b0128ea5`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76c3681523db58d3a40e2bbcc6c8c0fb7e4934909effa5528263d29537771034`  
		Last Modified: Thu, 11 Jan 2024 14:20:33 GMT  
		Size: 68.0 MB (67971810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
