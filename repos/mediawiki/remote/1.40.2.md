...
```console
$ docker pull mediawiki@sha256:fc4c92c5409a3a40b27c93d44269c67f8a2d7dbfdec0db5eeb2b3738c4534614
```
...
```console
$ docker pull mediawiki@sha256:05352fe5d8f197bee2d20749708ddb151a54d8c9e5b07f3bcef619aa8e0f0ff7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.2 MB (301226624 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47d6bfef33bcb914ace359da0a31863c390a0166355e529f5430a672c451b69a`
...
-	Layers:
	...
	-	`sha256:285fa885dedf904c7ef26e7222bb5d770d0e38716a15143c1716b44f39617c8f`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b74221154165f584b3053b498c1c5fb2241381ff5e5b8d1cc64d17ee114fbfd`  
		Last Modified: Thu, 28 Dec 2023 03:46:39 GMT  
		Size: 68.0 MB (67971357 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.2` - linux; arm variant v5

```console
$ docker pull mediawiki@sha256:0e08115d99ec97b0a942560ff8270b7a36ee4c7aa4dc4918f536cc19405ecbc5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.8 MB (269759948 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2fd1dc7c814855b7c5d21d28aea16a6a936fc6c9791a37dc7aaceee0d10a532`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 02:50:20 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 28 Dec 2023 02:50:21 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 28 Dec 2023 02:50:51 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 28 Dec 2023 02:50:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:529204f46db9160827a8ccb889f1570bebc9d711b3d083025d423dd2d1a411d3`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d35ab8c8e25a72dad83fdd435b69caa8b65ed01b19f33d80d71d6a040b937af`  
		Last Modified: Thu, 28 Dec 2023 02:54:47 GMT  
		Size: 68.0 MB (67968909 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.2` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:0686813cf35b252d87148fc01fb49a36a12f00084e9ffbeb6a3e7d7767fa0107
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.2 MB (257245867 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f16738cc17bed3cf879b1a624c2af96a2ec939972a5551525780379aaf55df0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 04:00:41 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 28 Dec 2023 04:00:41 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 28 Dec 2023 04:01:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 28 Dec 2023 04:01:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a84468d0cf3c80715a4036780863d77302800c45b47d26785d38083ac6662940`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36fbc33b34176ff87d89f7076128ef956900c1f3f61ba3dc85a0960559d30e39`  
		Last Modified: Thu, 28 Dec 2023 04:08:39 GMT  
		Size: 68.0 MB (67969600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:15b43304814f7fca188e583657c44e94cf825756b2d0c70a381a8ad90a419895
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **301.8 MB (301761881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c66f87d8eac58eef0f54efd9316422b7ec6dd57e90414e923c976f555333b8d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 28 Dec 2023 05:31:07 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 28 Dec 2023 05:31:34 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 28 Dec 2023 05:31:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e20fec885c66a4bcf8fc2977036dd834edaf90621b8177e713d695459f3cddb5`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc5ab6b3a5780841bc0c7f882a3332585c523a9ba725771e62789b831ec44b34`  
		Last Modified: Thu, 28 Dec 2023 05:36:59 GMT  
		Size: 68.0 MB (67970998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.2` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:fc3f607099a205734fb25827fdaccfab53ab5372a82d6db240a2dc8b2efe7511
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.7 MB (309715165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9d14b423006afbdc672e32bbe54348202b73a3e6fa3e8d38bf64fe2f455c8a3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 03:27:12 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 28 Dec 2023 03:27:13 GMT
ENV MEDIAWIKI_VERSION=1.40.2
# Thu, 28 Dec 2023 03:27:50 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 28 Dec 2023 03:27:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:92804504b0eb5d5c0a1089e0417ecc87cb7cf73a45572349c15c266d856cae1f`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3da38f68b3aa076fe846cbbe6e0281e35bb7392dabcb64c62850ed9d47263b3e`  
		Last Modified: Thu, 28 Dec 2023 03:34:03 GMT  
		Size: 68.0 MB (67971627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
