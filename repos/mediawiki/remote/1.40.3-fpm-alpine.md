...
```console
$ docker pull mediawiki@sha256:c8e44f4d55385a066fb809fd06e31174d33124bdab5b56c6df523ee706cfdaf7
```
...
```console
$ docker pull mediawiki@sha256:8b495d6336f8e9d1ec1c16b16807ded152cbf055ee68524e2660db8252accdbf
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.5 MB (128511375 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c14a05e9796d4693496f72c899416b43e5c16ad1d965ba9395f61d0fed226bb`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jun 2024 23:58:54 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 06 Jun 2024 23:59:17 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 23:59:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:be8641d63bc5d9c47994562b00bb5528ee07096ae521e38d08d0f043f111465b`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a156ae0786babf876751924d276e7d4557c6f72f023763b73878ac20c2c7590`  
		Last Modified: Fri, 07 Jun 2024 00:06:06 GMT  
		Size: 68.1 MB (68056112 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
