...
```console
$ docker pull mediawiki@sha256:2cb11ab50665644fcfd47ba5cdb742f5d68c5f234b041cbaed858eb40494d753
```
...
```console
$ docker pull mediawiki@sha256:c14c3de7071e7994887ffbeb6acf91866c192e76acfc8f8e4cb55c94312c0f23
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **127.4 MB (127424154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2841421e05049612c739952bf15915f6920f80dd4d4797526e0848f765f6e5cb`
...
-	Layers:
	...
	-	`sha256:34996e231633e9f3210fb6a3970a3946fa2e86c71260538d3bfba251ed01af49`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0fa2f5bcf485daf0ef2148795d27915ec8aa37777fcd56bbcb3a6a79db35b7e`  
		Last Modified: Fri, 21 Jun 2024 04:31:46 GMT  
		Size: 4.6 MB (4563543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34a12f069fbd17cef187f9401a11e2fa97aea3dfd93bcd925d97208530e9d1ee`  
		Last Modified: Fri, 21 Jun 2024 04:31:45 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f632101843d9ea041f448a6d53570ce1de2fc7e472181f4964f9049d88138b0b`  
		Last Modified: Fri, 21 Jun 2024 04:31:46 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:68e4cf5de8717eda70478e7f8a57ca242dee707a67841097c4f42344e1c786fd`  
		Last Modified: Fri, 21 Jun 2024 04:32:30 GMT  
		Size: 68.1 MB (68055148 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.3-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:8eff93bf7e654d0d465d910f2ab266bccf4f391e7e22bb35409163387cdc4cbc
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.8 MB (124812797 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a39d448109cbed3d5fc52cff60d9481f835430385b8afcf86c9df262538de775`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 21 Jun 2024 03:07:16 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 21 Jun 2024 03:07:17 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 21 Jun 2024 03:07:17 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 21 Jun 2024 03:07:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 21 Jun 2024 03:07:52 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 21 Jun 2024 03:08:13 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 21 Jun 2024 03:08:14 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0fd8e0b5f7a78e553487f8517249dc313430adbeaf1479bd71e68b0cff9f6225`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f4f0dc1b06a3db4412d7fa977175d6a7f7906be7b6bc8f6486b28a4adabf999c`  
		Last Modified: Fri, 21 Jun 2024 03:08:52 GMT  
		Size: 4.0 MB (4046085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:32b88a4dc4f749a3c75ca692320ea0fd2b3c6f2662bd017167171fd2cfccb792`  
		Last Modified: Fri, 21 Jun 2024 03:08:51 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cad3eaa8b6ada7082775e55f9ad672873b2eef531f06d663e65a247679e1b517`  
		Last Modified: Fri, 21 Jun 2024 03:08:51 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:91b39cf7c1cb1d709bba3388a9235ea14bea2240b1d99cfe620d46175047fa3a`  
		Last Modified: Fri, 21 Jun 2024 03:09:43 GMT  
		Size: 68.1 MB (68054766 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.3-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:707bbdea565989da396b111d2c0b2325a5d0347eb3e0a286e78a7ced6e7e1bc3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.6 MB (122639015 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b00d349fff1b197714ae2d58366e9e417aa3d405938eb5b51d814aff03ea462`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 21 Jun 2024 02:01:27 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 21 Jun 2024 02:01:27 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 21 Jun 2024 02:01:28 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 21 Jun 2024 02:02:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 21 Jun 2024 02:02:09 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 21 Jun 2024 02:02:29 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 21 Jun 2024 02:02:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:feec8589ef7866e6f235aaeab56f36394b3aa886fcd02cf7205c908556c01c6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e54a58cdfdfa8bfbecad67a149cfb8e45a5a23d0f1f810a34dbae877ae25cf`  
		Last Modified: Fri, 21 Jun 2024 02:03:21 GMT  
		Size: 4.1 MB (4103231 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe484f8794ed796ac868e06d41d2cee1cdf4c8ef989226f55118c2d593156a9e`  
		Last Modified: Fri, 21 Jun 2024 02:03:21 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b98fc64ef6d16267462a4a624bcfa41c9ebfd45603c1dadb8ab98cc46ac78795`  
		Last Modified: Fri, 21 Jun 2024 02:03:21 GMT  
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60d4e24331a521b07f91baacbece4783e4be9e27bd70c32fc9783126ce454aa3`  
		Last Modified: Fri, 21 Jun 2024 02:04:13 GMT  
		Size: 68.1 MB (68055859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.3-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:3c7cd13a2e4897b6ed784edbcfd80de70e26076367f026154a284e36c16441c5
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.4 MB (128372865 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:61f4244abcaf91ae50c45871f6759a56fb477bde5182350c55ab5eb6e36ab78a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 21 Jun 2024 03:12:47 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 21 Jun 2024 03:12:47 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 21 Jun 2024 03:13:02 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 21 Jun 2024 03:13:05 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0011fe3ec05fa3e4cff7b03b7c9039c1c77b9a0c676c2be48dd4274af09c97fd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d21ca5ee4def3c7e78840b404515dbf0785906ea9bff9281f9ece3921eb635d`  
		Last Modified: Fri, 21 Jun 2024 03:13:47 GMT  
		Size: 4.9 MB (4894569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e1befc8ba7de15a8942da063543cd321f9788a9ec6f87e3fb745bfc8f9bc6891`  
		Last Modified: Fri, 21 Jun 2024 03:13:47 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f55c3265e07e85454d93125d7ce5f11e5463bcffe670739c92b8a210373b3cb`  
		Last Modified: Fri, 21 Jun 2024 03:13:47 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7cf77ccb1c2ec2c28e41ad4eb9902c3df3e6d24eb223584cb9defb1f6cec61d`  
		Last Modified: Fri, 21 Jun 2024 03:14:26 GMT  
		Size: 68.1 MB (68055877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.3-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:02205f594a71ec26e390df684356df56bf282877839f8ed7e91e5db9a479f3f7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.2 MB (128231293 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ae6eb31d6dc20042beb3ffae0d747ab811a1cd2f5394bee63a1fa08dbaf966a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 21 Jun 2024 00:56:38 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 21 Jun 2024 00:56:39 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 21 Jun 2024 00:56:39 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 21 Jun 2024 00:57:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 21 Jun 2024 00:57:14 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 21 Jun 2024 00:57:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 21 Jun 2024 00:57:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:5e63f9e3724862e059fe2bc33d5714278146e6cdf32b0200ac85d32cfe5a5a81`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8e9664607372ef926d3dca1c6dda794a0260afd789f877b77c95cfdd6434b39`  
		Last Modified: Fri, 21 Jun 2024 00:58:30 GMT  
		Size: 4.7 MB (4681048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b7db99c112cff935d0cd57d5e6c29ef470816e995b7969d680517bf9f051a5a5`  
		Last Modified: Fri, 21 Jun 2024 00:58:28 GMT  
		Size: 324.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:798e74ec45e51a5ad54e0fdff4b74b03c4839c16167e6ee3b35f3d4e37d1edaf`  
		Last Modified: Fri, 21 Jun 2024 00:58:28 GMT  
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a6c18efab6fa56b28c29a6199a0feced5cc45a28ecc354024d207d7492c0946a`  
		Last Modified: Fri, 21 Jun 2024 00:59:30 GMT  
		Size: 68.1 MB (68055831 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40.3-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:cc8c288204367d7fce3af0f6f11e07471fd8fe032c3afa33fa84e43bd561571b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.5 MB (128512886 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9659fbccb62a7519515ab4f6ac9f770bd9291b2f26542182152c363a3ba2ef77`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Fri, 21 Jun 2024 00:12:59 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del --no-network .build-deps
# Fri, 21 Jun 2024 00:13:00 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 21 Jun 2024 00:13:01 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 21 Jun 2024 00:13:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 21 Jun 2024 00:13:52 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 21 Jun 2024 00:14:17 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 21 Jun 2024 00:14:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:26f19328050b4fb0fb20cce667ee3bb78c687f48b93c6de6b3ca32e5cae298dd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ac4e613139b68c03d3a5d8581747f759060c83fb4c887da6e48f5c91fb7255c`  
		Last Modified: Fri, 21 Jun 2024 00:15:20 GMT  
		Size: 4.4 MB (4354328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f3e4ea5910ffba8749852f00c22673403436881b358816e99e8cd789f9e8346`  
		Last Modified: Fri, 21 Jun 2024 00:15:19 GMT  
		Size: 326.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8272063fafbf263831728d94f0fe7ff1f86411a8c9f42283cf27ed106706cb60`  
		Last Modified: Fri, 21 Jun 2024 00:15:19 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1060fe3994ac1301c9fd90375799f7bc7990e62148203421fe49b36adbcd0b8b`  
		Last Modified: Fri, 21 Jun 2024 00:16:08 GMT  
		Size: 68.1 MB (68055699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
