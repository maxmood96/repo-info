...
```console
$ docker pull mediawiki@sha256:b101997f7b245f41df929614f97ff08f21e4bbd9813db4b31569f973cbab8447
```
...
```console
$ docker pull mediawiki@sha256:8f67fef83e39ae5d27df5e792f16ed69f08851d5ccb5193262113b692ad1eb24
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.8 MB (124811443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa93341ae3156c2f2cb7b8096ce6dfbb6a07c16e9d471278cc99f7cbb90f86c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 21:17:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 06 Jun 2024 21:17:08 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 06 Jun 2024 21:17:33 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 21:17:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:34075f5069b01b4591312836921fdf3f9ad98db22aef256e4e96908f07f80f2e`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b11515a62e3264c1d5ad05283fd46eea06ffcdf31694d2f1ed8154effd9f2cc`  
		Last Modified: Thu, 06 Jun 2024 21:19:19 GMT  
		Size: 68.1 MB (68055611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:aa0f10ecef3bf4d37a531c8d96a783d1e71b97875cbf41090e95415c81d0a1c1
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.4 MB (128370227 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c82c4dff0080f639d2eb1d4c5c17812b1fdaf7b0464c14d3a17659040aec891`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 23:51:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 06 Jun 2024 23:51:55 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 06 Jun 2024 23:52:10 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 23:52:13 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:063ab96df607c69d0a260dea82649277dc358d321f5444c1ffe07a93a309da93`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab7bf7dc64f7ec03df8b628f30171ed4dacc6b57eac569fc5151f2f4bbc99c37`  
		Last Modified: Thu, 06 Jun 2024 23:55:49 GMT  
		Size: 68.1 MB (68055353 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
