...
```console
$ docker pull mediawiki@sha256:09706bd64b1061208ada123944d2b4f47d49383f5cd7377866f99fa8cceac011
```
...
```console
$ docker pull mediawiki@sha256:92d197e7813837049564169205e4948177c24b4ab08b42925abd1d37dafe5c58
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.7 MB (122677772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:96a623f17d803a1ecf80d807c6b310784ce2ec45a0cfd457e9bc8350c38fe3c5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 30 May 2024 00:59:04 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 30 May 2024 00:59:04 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 30 May 2024 00:59:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 30 May 2024 00:59:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d0d067bbf934b044d1aceb3240fd4524cc268437571e1088f00160c8cda70dea`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1e1fa55da1d9802c595278a842d68c2aaf06587f7f74d684fdc8fc17b9ccb54`  
		Last Modified: Thu, 30 May 2024 01:01:09 GMT  
		Size: 68.1 MB (68056884 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:75b1cfa24932d15086f85bc6dd469da61a469d80a1136743356d3f964162a507
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.5 MB (128544705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7625901f26e4919ee4aa720db314c67b91fc4b75cc273eaa61408be73280afb0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 30 May 2024 00:57:21 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 30 May 2024 00:57:21 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 30 May 2024 00:57:45 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 30 May 2024 00:57:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d004ff37b6bb70270addf68d097743d567ff7491d8348a8356b29673c8dd87d8`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7dc5ca94d01f4a73a1c36e0cac21f9fed0ed4492c7ae714e08a499f13938e36`  
		Last Modified: Thu, 30 May 2024 00:59:47 GMT  
		Size: 68.1 MB (68057212 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
