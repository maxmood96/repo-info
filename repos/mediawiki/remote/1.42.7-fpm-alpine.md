...
```console
$ docker pull mediawiki@sha256:854e069eee7c3e1e8111b7a1a61505b4f3d8e2c649c136b4227f93ca4202de27
```
...
### `mediawiki:1.42.7-fpm-alpine` - linux; amd64
...
### `mediawiki:1.42.7-fpm-alpine` - unknown; unknown
...
### `mediawiki:1.42.7-fpm-alpine` - linux; arm variant v6
...
### `mediawiki:1.42.7-fpm-alpine` - linux; arm variant v7
...
### `mediawiki:1.42.7-fpm-alpine` - linux; 386
...
### `mediawiki:1.42.7-fpm-alpine` - linux; ppc64le
