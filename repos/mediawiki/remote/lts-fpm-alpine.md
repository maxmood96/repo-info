...
```console
$ docker pull mediawiki@sha256:9bc580b9b27d873b38581f99b20deb14166066e180c9ef48686512c53e4485ea
```
...
```console
$ docker pull mediawiki@sha256:5f4e609898efbaa7b5169ebdd383245cca49b54912804a170c43dd5b89410b7a
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.1 MB (118135404 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8228bcf66ce36d77d79c91fc92478741258143f45318a54b2b3d7ef34788f73`
...
-	Layers:
	...
	-	`sha256:e2e4f872afa06541ad3c165b35251bf30247c0c7f654a75591c9242e11f6a02b`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:024ead74960d663f824b5bc5eef02f19c788f9bde1acc5a62bee3257e8eb576c`  
		Last Modified: Thu, 06 Jun 2024 23:47:21 GMT  
		Size: 58.8 MB (58768270 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:f75403b5a9d06a90d63893460e727dbbacf79d77c97df4d1c5dade36df4dff96
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.5 MB (115524144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f67b9f3e88035b257d9db284a0fe7c304d135ba2f74ba44c0f60df9b53d58408`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 21:17:41 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 21:17:42 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 21:18:03 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
...
-	Layers:
	...
	-	`sha256:34075f5069b01b4591312836921fdf3f9ad98db22aef256e4e96908f07f80f2e`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdef8333dda2363e023b74fc10d25767cb8772a64250752990145f466acd75c3`  
		Last Modified: Thu, 06 Jun 2024 21:19:49 GMT  
		Size: 58.8 MB (58768312 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:72d01cb545387722b6e9be054522875cbf29b8d564e4ea58b4002f8157e5dc67
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.4 MB (113350488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a4afe7818b8cb036a8bdb545e27b13ef263ad6e411516f0693873215edbcf52`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 23:33:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 23:33:19 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 23:33:37 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 23:33:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:47efa8bc705a983b73d790c1f919f748652b89a08f7f992ecbd9a91d105116c6`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58a654b79ca1fe8245577811e412046812f825b6413a3f7f9247e7d90a3a522f`  
		Last Modified: Thu, 06 Jun 2024 23:38:20 GMT  
		Size: 58.8 MB (58768177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:0fbab3f419cc7459ae024fb1e8cd5114b29cf019e6114d677e6795a9aba38719
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.1 MB (119083291 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d229f1a120557d1b6329c581fe16b4839f2d37b3d7b662817e0a75a885b2117e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 23:53:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 23:53:02 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 23:53:15 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 23:53:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:063ab96df607c69d0a260dea82649277dc358d321f5444c1ffe07a93a309da93`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13ad449654c469f20315d0509f9975b254d74b8099b9e0105956388f454ee0c8`  
		Last Modified: Thu, 06 Jun 2024 23:56:50 GMT  
		Size: 58.8 MB (58768417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:368243be994744a4f5b378c7e885a326c6be3065108b24a716eaa308dac5fcad
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.9 MB (118940839 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d17b0535ab2adcc7d23292079c22592f7260e311942346c9f5b837a02b2a74bc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 07 Jun 2024 03:34:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 07 Jun 2024 03:34:05 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 07 Jun 2024 03:34:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 07 Jun 2024 03:34:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:204834a7883025b7fa0701a95edaef2aff20be13f5ff95211aaa53a006556baf`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7335cae3663bb7b5b3d0d9aa9f2c86918e72075a885d98ce5d422bc357272f26`  
		Last Modified: Fri, 07 Jun 2024 03:39:42 GMT  
		Size: 58.8 MB (58767780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
