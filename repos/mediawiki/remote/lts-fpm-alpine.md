...
```console
$ docker pull mediawiki@sha256:177c28572ee1b9bbce79aa0ad690324e0a4ebaed8b49256d3ac68a233ee915a6
```
...
```console
$ docker pull mediawiki@sha256:a5172b510f56458b60f43bab94de2d38498f0cc26337e26d783c7043f1eaf16d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.1 MB (121092398 bytes)**  
...
# Fri, 12 Apr 2024 20:12:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 20:12:50 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 20:13:03 GMT
...
-	Layers:
	...
	-	`sha256:04381be728f3f05580387665867c591e568ffafcb90217ef00b5378854d1c5c6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:056a28a46020980fb9165e14de645e8c9cca418f0807428064e2688e831832be`  
		Last Modified: Fri, 12 Apr 2024 20:17:26 GMT  
		Size: 58.8 MB (58771195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:2aa3ee139480a25f9bad293c3da3f84cfe383ed7f7e0c233532a2d8993aab7c2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.2 MB (118229140 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a96fdb72c14eac5d81b39443ce5af570ca3d28fc73b8c50717f9a2430d3f1cd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 12 Apr 2024 18:40:28 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 18:41:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 18:41:33 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 18:41:50 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 12 Apr 2024 18:41:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:759aecc21920d4c52dde3f915d11b64270d58a322bdcad5029cd64f13f19b32d`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdc70896227a513f8f33ab22c2beabdd2b1aea837608a05daf89bc86c85b54f5`  
		Last Modified: Fri, 12 Apr 2024 18:43:21 GMT  
		Size: 58.8 MB (58771031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:d18be3637f43659aa83786a1703b4586fa462ee18d2ea98014d3b7e90383d095
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.0 MB (116006793 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a1bb92cb3f713640aa1a42e1ec01eae504c174cd23dd3e9e61bf4bca251a4d7d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 12 Apr 2024 19:07:26 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 19:10:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 19:10:39 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 19:10:59 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 12 Apr 2024 19:11:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:79308e24aabab306237de76a1798f97637b28407f45097f8471d9ffc98e3a8c2`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53ec4e05a6e1ebee10912007ab8658257b50de8d313d84a8d9174b7ddfd75f39`  
		Last Modified: Fri, 12 Apr 2024 19:16:21 GMT  
		Size: 58.8 MB (58771497 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:e8313217576f0cf54e0fc78cb7dc495cca0976f596070a15d40ac88b40032cb8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.4 MB (121421633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84f05c2145c69b23ea5cb5a6e81e63caaacc0f35eace5427d04fa7cfd232a73e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 19:32:07 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 19:32:07 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 19:32:20 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 12 Apr 2024 19:32:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:763b21b95a2cfa0191cabb9da38fb2df8ad6cabb753aebea9a1ea094f461fddc`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cd1e4c4eb9792a2e697705a2cc24b8504578341eb87c2c086fa7ae3721030ae`  
		Last Modified: Fri, 12 Apr 2024 19:36:14 GMT  
		Size: 58.8 MB (58770793 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:f50c3f8436817737bbf96edc7643eb646ed3729b0c038002a98149eeb3c0a559
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.7 MB (121677117 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9207bae4fbcf004b8afbf7bfd3f85f45a74e0a5df23921ce0712242035c4f6a5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 21:15:57 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 21:15:57 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 21:16:15 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 12 Apr 2024 21:16:17 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0e2ab8480b99cbf6e43c05125de5c63a13be88dc2556c3b2c52c3ddd9b8009c6`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d816455f609ba634fe0d7fce0928294db4b50717cff405bae9b50932b700c35d`  
		Last Modified: Fri, 12 Apr 2024 21:21:56 GMT  
		Size: 58.8 MB (58771379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:c21ad11289bf69568429db4667c2f9391c0191f3ec0ca97239d852e5e9a4dac7
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.0 MB (122002190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44fcf966a14f2a4d1f0e6dffa6a423b6b37697cd3b971dfcd21b91330a0d6184`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 12 Apr 2024 19:43:27 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 12 Apr 2024 19:43:27 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Fri, 12 Apr 2024 19:43:47 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 12 Apr 2024 19:43:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:90828e797f610314ea72180739a04da81af1a221ce06779bcbdccbbc019dfde8`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52c41e3a733dbd111aea86dde774c440ba100e1bc94ee9098f94f6646f3df506`  
		Last Modified: Fri, 12 Apr 2024 19:49:03 GMT  
		Size: 58.8 MB (58771537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
