...
```console
$ docker pull mediawiki@sha256:efd2a718306de352580312144e313b0f0d30603a27f54a0302a1d5b0cb5caa45
```
...
```console
$ docker pull mediawiki@sha256:662c01d92315920e4dc6dd257ea0d831c78f3910e2fc0b308ca147f01fe6a27e
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.4 MB (113389304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:058d9e96c48b36b3787ae7252afc8415486081c54db2b86ed66297f83b7375b9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 30 May 2024 00:59:31 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 30 May 2024 00:59:31 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 30 May 2024 00:59:48 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 30 May 2024 00:59:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d0d067bbf934b044d1aceb3240fd4524cc268437571e1088f00160c8cda70dea`  
		...
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab18fa4f5f0e59963a1be8734bc06149a68199cf2c0cae3200991aa18b42b8d7`  
		Last Modified: Thu, 30 May 2024 01:01:39 GMT  
		Size: 58.8 MB (58768416 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:5176adc43718a1bafa28ddc38400a7bf2b285e3db15b5f16954627d7131d6fa4
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.3 MB (119255883 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f0523b3781f9e8395a405576bf52b26485e184c244ffeee81243399d68527b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 30 May 2024 00:58:00 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 30 May 2024 00:58:00 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 30 May 2024 00:58:21 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 30 May 2024 00:58:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d004ff37b6bb70270addf68d097743d567ff7491d8348a8356b29673c8dd87d8`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:121d8bb9ce3d699b87995fe8eb10613b00cff790550c7a6e907c25dd2092f58a`  
		Last Modified: Thu, 30 May 2024 01:00:14 GMT  
		Size: 58.8 MB (58768390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
