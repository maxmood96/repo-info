...
```console
$ docker pull mediawiki@sha256:e733d0690908cec39d9ab063ffedcd0701523b8bb0867871b25780da40e58c54
```
...
```console
$ docker pull mediawiki@sha256:fdf2f354990827e3e32e02395009cfa8395994db7244703432bf7fd98519b360
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.2 MB (118157561 bytes)**  
...
# Thu, 06 Jun 2024 05:47:13 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 05:47:13 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 05:47:26 GMT
...
-	Layers:
	...
	-	`sha256:6d3a33f3d17a499d43f0402d6c2b0c70fd85b8328f8f06db4a5e15f164cd8eeb`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3734664afd52cf02ecd83a1af6b9f5a865b776c1495abc62a9abf17add35b33`  
		Last Modified: Thu, 06 Jun 2024 05:51:29 GMT  
		Size: 58.8 MB (58768077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:74c2422fc7df44054baefdfadd50df0d814698fa0791da62670eb7525b691345
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.5 MB (115546247 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d81edca9ae5fb8c60913d46b31e7e7e2c7f96ef34d1c666f1e5a340814992b7c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:301f343e078a3ca882829c012c5e7f198bfd941e499f0ec6e1967c20625f55cd`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9dcb8b186bb608ea976367a730077374dc8446de6f49b8dccca03a80f051c0b`  
		Last Modified: Thu, 06 Jun 2024 03:30:14 GMT  
		Size: 58.8 MB (58768019 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:3e42fbecd790f0cc0c401a0d2103566af37203e9fc1515fe2f529888e8424b23
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.4 MB (113372127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3de87243e83033fb3146c55c9010df90e7fe9b5d2eee585c6f2cdfd8ffb32fa8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jun 2024 06:19:49 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:22:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:22:50 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:23:07 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 06:23:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9fa01262c33068132a222984d7636e2a4c43b0e0b8557947fd7aaa648492947a`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62c1d0c999839261f4c0e035402bb6966442fd8c01a67911886acb150e21967b`  
		Last Modified: Thu, 06 Jun 2024 06:28:40 GMT  
		Size: 58.8 MB (58767569 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:a0a48799d6c273ed68b87e2b1c851821049f23103c17fd8cd8e2d29a9a6a86c7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.1 MB (119105639 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be47eec7cb046bd779762c1c055924d0607f02d5b79a3712f4f6391baa6163b8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:03:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:03:46 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:03:58 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 06:04:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b8945d054130c6140a226dbf1b4b5a904b05b80253ea28a3df50fd2c32c34a5d`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90478c5c5a3f68c84b2ceb9d5ea8b0591f844656039c2c2d69bfd83b5a7a7618`  
		Last Modified: Thu, 06 Jun 2024 06:07:39 GMT  
		Size: 58.8 MB (58768323 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:4ade746b7af3cc5338c49686f29080ddc800561f9be7782381ec30e814aef970
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (118974972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09407ef67eebe665220f53ae70fc832dff4b6a3bd07997c0f07b0797b204d835`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 30 May 2024 01:40:49 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 30 May 2024 01:41:56 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 30 May 2024 01:41:56 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 30 May 2024 01:42:14 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 30 May 2024 01:42:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7976b4d583f52de34ce8173419cc9ee50c9153b816f2652adb0e674b8572d761`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b690428c3234dd9ca4f6bb8ec73b9884c3de60ed921bb16c70846d0c3a4d8d51`  
		Last Modified: Thu, 30 May 2024 01:44:17 GMT  
		Size: 58.8 MB (58768045 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:44b74fb502c08cc6473f144d8217c15fcd2ee2916e7d0f2e0ebf102e78057bba
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.2 MB (119245345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb1b9b5bdd2f01c62444f4ced971009ef45b8f2f9dbaeb518e4d906b416d15cf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 06:33:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 06 Jun 2024 06:33:15 GMT
ENV MEDIAWIKI_VERSION=1.39.7
# Thu, 06 Jun 2024 06:33:36 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 06 Jun 2024 06:33:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:11529ce2fff5ed1fb2a2771c3a57e034fdd4b1bc609992bbe4e843e9b91a2e0b`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6df1c38af9f578ea18508c04f697e5e82c3ea7696acc777126a43c53974eb3c1`  
		Last Modified: Thu, 06 Jun 2024 06:40:07 GMT  
		Size: 58.8 MB (58767803 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
