...
```console
$ docker pull mediawiki@sha256:ea51aa654c8f860542a63c814ff92affe943b7aa12f6cb7bf4667e1054e35d2b
```
...
```console
$ docker pull mediawiki@sha256:5284ca8ffdf2401b75e9f93eeb0f2cbb1c6b3764224d7ffc2950c87e531998e2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.7 MB (118681937 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3e9529a45ad881755c6eaf6b6f5a70d3e41fa53476a93e2f4c1e5e5a30d9d3e`
...
# Fri, 27 Sep 2024 01:35:19 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 01:35:19 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 01:35:32 GMT
...
-	Layers:
	...
	-	`sha256:08377515895633f4837d93c612e486413b48074450716dfe7741f1e323ba3d45`  
		...
		Size: 138.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b03e4b0f3ee067c197672b906039cf685d797ea08b37ab553190e6a7ba1621d`  
		Last Modified: Fri, 27 Sep 2024 01:39:36 GMT  
		Size: 59.1 MB (59063727 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:834fe345c352e56cfce9eeaaa23d19d93d0bb585d2b8be79e74f8b8804cf7722
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **116.1 MB (116065683 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc9bdde70f16486cbdc8dae07a899eb829d2cc77885167b676d8dd6900fe8491`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Sep 2024 00:32:16 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 00:32:16 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 00:32:34 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 27 Sep 2024 00:32:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:68fd0c547354a8b693ff61a66a4cdfa3c12f378736c7aa5efbf853f131c01543`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa836656ffa72ad42083d5901e1b8f2331bc933328ef4797e3382a2bcf1b2034`  
		Last Modified: Fri, 27 Sep 2024 00:34:12 GMT  
		Size: 59.1 MB (59063816 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:04d41e3fc3b40bc2520cb4f85c6f87d36b1d9454f368049f62599a8e8feb54f0
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.9 MB (113856059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a27f2f76b2d3aeb6bc73aa38e5649e4e9052a78b8def52c8cec937d641ad614`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Sep 2024 02:15:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 02:15:52 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 02:16:10 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 27 Sep 2024 02:16:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:33f26f8d49be335659e25bb160060478e6b7f8365bbc972cdb38f9ca7585d605`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:661405a7bf3f8203dec67b8f86f8c8783f6173b99ede9e8d6d85bddb7589700a`  
		Last Modified: Fri, 27 Sep 2024 02:22:38 GMT  
		Size: 59.1 MB (59063677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:154ce1ecdb58c1aaefd71cc3640cb18d41d05043ed6d9242bacbf8e47e603379
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.6 MB (119637184 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ac80e542a20b66395f616800215bf3582b9b1637e3b827611226059c78e182d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Sep 2024 04:08:14 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 04:08:14 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 04:08:26 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 27 Sep 2024 04:08:29 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6af33c19daf54e6dc019ab8671a33d32c12e9a9bf2d573254999a123c3007ea7`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a0b8d1f3f4c8c5980cab30842293172e4861b6fbd9e415d7225011a6bba1c56`  
		Last Modified: Fri, 27 Sep 2024 04:12:04 GMT  
		Size: 59.1 MB (59062460 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:9bfd550945cabd0e90d96862a3ce3c6f995b379c0c7eee493bb1c064fa6a48fb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.5 MB (119513565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6270ff793f6b833c33c8bf1b047e5676992719d68c7480b7cd875db4d949a98a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Sep 2024 04:39:05 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 04:39:05 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 04:39:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 27 Sep 2024 04:39:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:eebab88c4a9c8811dca5b04fee3635e8bc7f488fae5a3d5b5a05f5b09bdb2310`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8b086da90eb88d9e6fc4292faeb096ab02779d32baac559ca368c6c65b435af`  
		Last Modified: Fri, 27 Sep 2024 04:44:40 GMT  
		Size: 59.1 MB (59062772 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:lts-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:3b0102128527a5ae17d825d92b857e2c07e9cd8832245d3f25325da397731dbb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.8 MB (119785712 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b87ae46afb716c9ee9edb8da310d7d5365f67c9367d2169651371b61ceed042f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 27 Sep 2024 02:04:02 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Fri, 27 Sep 2024 02:04:03 GMT
ENV MEDIAWIKI_VERSION=1.39.8
# Fri, 27 Sep 2024 02:04:23 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Fri, 27 Sep 2024 02:04:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c157416544647f2f3156f079e916ef0c86c1d527a9c26a0e6511926012329769`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f8d1326ff54f697f08b7b0f6784a12fdfcde80643b80c13cc0c37459f248747`  
		Last Modified: Fri, 27 Sep 2024 02:11:42 GMT  
		Size: 59.1 MB (59063636 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
