...
```console
$ docker pull mediawiki@sha256:c0ceee359b5c710d2853624ee1aa8f5149899f86eff604d364a3c2ab5945a874
```
...
```console
$ docker pull mediawiki@sha256:99bc152cb586e48cb652c01b57369c5db5e5d666eea7c7767c3bafbac9762816
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.5 MB (138496695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c99eb66650ec0ab855d413627769ab7a87474a5057b4c8e47e39023cb32f90e8`
...
# Fri, 26 Mar 2021 17:51:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 26 Mar 2021 17:51:46 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 26 Mar 2021 17:51:58 GMT
...
-	Layers:
	...
	-	`sha256:6be62f59354b9df5d01b982248b5ec7a4be183bc6f5632401e1f8ca4bee40bd6`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:453065cf4ff6cb85a4a2e77bf458844f01e94d83da1e867567bb49471e3a49a3`  
		Last Modified: Fri, 26 Mar 2021 17:54:03 GMT  
		Size: 35.9 MB (35893125 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:eae3be7e4eae385ac6037756bc968faeee01c1b19292691d65fd22b552591be4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.2 MB (134164157 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:75738c01367ff35560c272367f1370751752ec1d3906be0b960c6c7cd2370034`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 26 Mar 2021 13:04:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 26 Mar 2021 13:04:59 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 26 Mar 2021 13:05:20 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 26 Mar 2021 13:05:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8ea42917de7e011da94b414819841b1712954336d0c4d895e65134e0ea4e2049`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0a71c8614e4fc8a2a66824ca50f4441a220b2876d24669b499d85d10088c1b7`  
		Last Modified: Fri, 26 Mar 2021 13:07:13 GMT  
		Size: 35.9 MB (35892728 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:155827949d168de788bd1e9a37f1dd18972d38b42cd55e124474512669bd3f03
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.5 MB (130489419 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:349c4210926e9f1cd54d59ca5b573eedf43e16cd4e31686e08d6bff8b955b206`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 26 Mar 2021 12:31:22 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 26 Mar 2021 12:31:23 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 26 Mar 2021 12:31:45 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 26 Mar 2021 12:31:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:59f1474cf54bfb1ece7bf90a27a68b160882451c09e357a5f7486c92d3bee7d2`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:938c664feb274e5ab2e1d62b9b9ab1563290f4975a9684918064807ae7a8a224`  
		Last Modified: Fri, 26 Mar 2021 12:34:01 GMT  
		Size: 35.9 MB (35893188 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:c91bc8842f6125b6fb8b25f485358483bb34082f6159ef83d464e57da95cb7b5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.8 MB (136799479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0868334091d3c36e59797c90e6824c6b8bcd630635e119148ca6dba83868f236`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 26 Mar 2021 17:27:44 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 26 Mar 2021 17:27:45 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 26 Mar 2021 17:28:00 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 26 Mar 2021 17:28:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:49afd6bc3caf2280dfdcc8d6ac69b71b0d31caeeea7481cc7674129bc5bb1694`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:338e2da41b542a019d843971cda0edc3994ab53582307072ba4e8b8cade567de`  
		Last Modified: Fri, 26 Mar 2021 17:30:11 GMT  
...
```console
$ docker pull mediawiki@sha256:1beb7e3ae5fbeb3b99892600c2e8db14c555bf7da977118781abdd83c36e4d86
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.9 MB (139930977 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:070c458bb567f444767aad0557f8efe3912a3a3d46b7832e40df7ab36b098861`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 26 Mar 2021 22:36:12 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 26 Mar 2021 22:36:12 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 26 Mar 2021 22:36:30 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 26 Mar 2021 22:36:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7eb5d73bdb6e4da66a32c517e09119cab7842b14dda896f93a99f1cbd16d0da0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e46ca78a85770c1c69cb4f0c43577ef6e78e48665f9c1e99f48ef19d595bc5b4`  
		Last Modified: Fri, 26 Mar 2021 22:40:10 GMT  
		Size: 35.9 MB (35893038 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:018be39bb0ade065d0a945562bfaabb9b4f75b806e54108c7ab7e16551f3f64e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.5 MB (140469870 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecd4171e34071e67add77d44c3a8545281ed824557d1b140cffc0eae93e1f456`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 18 Feb 2021 05:52:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 18 Feb 2021 05:52:29 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 18 Feb 2021 05:53:22 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 18 Feb 2021 05:53:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:470076a3f1236fa9ccc3d2fb98be8c12ad6fb73de228db04b59f76c3cbbcaef9`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0376597e0a036f0358dd9730d9a7630cd6f244f299edfc72964e04ef44d1eb61`  
		Last Modified: Thu, 18 Feb 2021 05:55:32 GMT  
		Size: 35.9 MB (35893156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
