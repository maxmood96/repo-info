...
```console
$ docker pull mediawiki@sha256:e3bbe11587c4d6f39c477b4b3e06e0222ddc25b0a437eec05bd553fbfa2079da
```
...
```console
$ docker pull mediawiki@sha256:8d5dfac157c4c85c7ab99337243cb46fc98cdc7c2a143ca6050c9a93d05b1673
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.5 MB (140469676 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e851d8205c252f1770d2ff1285fe54c03db57ca2bc0145d6a5e8ff4483e9020a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 27 Mar 2021 02:45:52 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Sat, 27 Mar 2021 02:46:05 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Sat, 27 Mar 2021 02:46:41 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
...
-	Layers:
	...
	-	`sha256:c6fc2ad008bef20123df499b26b7133f42a91e1ba48595d2815a4278c95203c7`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b668704af3012138c09e3ebf1d067f18e1a6f77703ea38a9a60219427938f9b0`  
		Last Modified: Sat, 27 Mar 2021 02:48:54 GMT  
		Size: 35.9 MB (35892973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
