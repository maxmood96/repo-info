...
```console
$ docker pull mediawiki@sha256:2e062a1ecf7a865983b35a2d118cd5e2f42375fe0a7b699182a2f3fd213429c8
```
...
```console
$ docker pull mediawiki@sha256:d9582fa87f7d4a7276161ebcfd6184eaba87d27ff6163970df5914ebce90d766
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.9 MB (138891876 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:007c148994c54a8d8041263f98357b7183bc86f8f75d54771927f8d85eed15c8`
...
# Thu, 21 Jan 2021 22:56:34 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 22:56:34 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 21 Jan 2021 22:56:46 GMT
...
-	Layers:
	...
	-	`sha256:30029f369aa799e9732ceb4323ddf25a6565721588908d370fd425d732bc683b`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef9aef61f1b7fa7e1b5fffb83b148ce5f6b91f544de6f50959a40ea7ee1da2af`  
		Last Modified: Thu, 21 Jan 2021 23:01:16 GMT  
		Size: 35.9 MB (35892611 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:ff95a3aed2eb7e7493e65ba91371915ef0bf0c3815dafe5ed82ccfd47058a67c
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.9 MB (130853280 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0ff5e018550e653e8c0e6c72d3617800ffeb8a5ef10b5f6e02f01c74f6755947`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Jan 2021 22:36:10 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 22:36:11 GMT
ENV MEDIAWIKI_VERSION=1.31.12
...
-	Layers:
	...
	-	`sha256:1658e1b442a3e5f85fa9c45f05b36c9398d8cc5a5797aa7fee93eaaf8f47fe5d`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec259cdb774ed88d033e92ba4862fff5b116e270b07394e4673413445d727754`  
		Last Modified: Thu, 21 Jan 2021 22:43:00 GMT  
		Size: 35.9 MB (35892982 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:648884c4921078bfaddaebba9676131f629a2b1def51767aaa5a72e9208e50b0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.2 MB (137212488 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c85d2982749f5c23fb9a0a079bc4593599aa6343cf5ab4685f6683b79dc25cc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Jan 2021 22:59:42 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 22:59:44 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 21 Jan 2021 23:00:04 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 21 Jan 2021 23:00:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dabaafa6089051a9fe0b662aa462ef66bc4c4659072b3bc920a03111a07e7859`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:468603683897ba9a19b3d44e170fa79b1badc88db57db8e42c838aeb9a89bb61`  
		Last Modified: Thu, 21 Jan 2021 23:05:28 GMT  
		Size: 35.9 MB (35893128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:4922627b151d25334c909ad7f6c3b7b98000005ccd0cd5632b22679bb6916ccb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.3 MB (140328006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:997ef9399557e3b38de0d89225a8c08ef58c0fe2c850c92e21975416a473d4fa`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Jan 2021 23:21:48 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 21 Jan 2021 23:24:24 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Thu, 21 Jan 2021 23:24:24 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Thu, 21 Jan 2021 23:24:36 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Thu, 21 Jan 2021 23:24:37 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6cc985b64d63c7054b4dbe2cecfab9b3208b1bfefb9e186abe919dc838bb0179`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb1e4b5c0c818dd63c66f56cd70a73da9e7a62a5f4074451ec5370c4fda2c6b6`  
		Last Modified: Thu, 21 Jan 2021 23:30:29 GMT  
		Size: 35.9 MB (35892348 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:legacylts-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:804f53ef205f63be4f3b223a1aa064d41a7710dc269d338baf6ecc5b5d4496d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.9 MB (140853105 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4685e62d6f8ba77ce29671f56f7e53f6332d3d12425ffbf53f5dcbcdfc512932`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 22 Jan 2021 02:26:29 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 22 Jan 2021 02:26:33 GMT
ENV MEDIAWIKI_VERSION=1.31.12
# Fri, 22 Jan 2021 02:26:54 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Fri, 22 Jan 2021 02:27:02 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e43ec7eeac31fb57cceac1d20bbd732c6c2d93bf23a1d7aef058a66760ad5c56`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e7dfead2793f24242b1c6de9695e845da0fd7a7ec9b329c447d91b30b17b0eb`  
		Last Modified: Fri, 22 Jan 2021 02:45:00 GMT  
		Size: 35.9 MB (35893151 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
