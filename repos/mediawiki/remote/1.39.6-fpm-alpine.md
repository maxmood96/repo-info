...
```console
$ docker pull mediawiki@sha256:f74e4200554fd00c0f781e02de05e8ee5dc9b4dc21e9081cbceac2549ea671b0
```
...
```console
$ docker pull mediawiki@sha256:98da779025745ba53b8f2bb6e92a0c7b5601bb4ac85e5fc93f27d1c7a6d99124
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.2 MB (118223069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0b4ae1a6f94419816ad948d94b7811e2a622b4dc134c432bd568e199aa5ec661`
...
-	Layers:
	...
	-	`sha256:3e317491d098cab069b640bd596187242027cd2c41178091d8c6d47116a14834`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d54d96114707350330ba6578b71d0855a2f9a33180f382cc14d4ccd19bb0fe3`  
		Last Modified: Thu, 28 Dec 2023 03:48:41 GMT  
		Size: 58.5 MB (58467487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:66dcfac07cb58532e07bb029a35c403f44a92bfcb76a2da299f322adef111dd2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.7 MB (115675066 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:285d501970d41fbb53d63b17547fb9227c2c9aee4e0cc2bbaef448ae705562f3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 28 Dec 2023 07:06:33 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 07:07:38 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 28 Dec 2023 07:07:38 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 28 Dec 2023 07:07:55 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 28 Dec 2023 07:07:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2c5721148d1e3635140e67c4c074d1a12e40d575bab2286af507e53efaf46d33`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30af268decdb7fc9e27e7d415e7655dd56a42b9f9c1420839d491a5f2f818926`  
		Last Modified: Thu, 28 Dec 2023 07:09:31 GMT  
		Size: 58.5 MB (58466598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:d2aeafa21f581c09f277f418112cfdf45fb6a58cb3cc5806088d84ba5e4ba1b9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.6 MB (113595781 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b01936f16777396bbf573444b09d2e1256dde8b82ed0184ae6ef0d8f41f7aa18`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 04:04:21 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 28 Dec 2023 04:04:21 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 28 Dec 2023 04:04:48 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
...
-	Layers:
	...
	-	`sha256:3e5c1f2a1a5206d7359c1f102960d45f4b18f2587c8735b35db50744df4a47a1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:092e7cc681a971d2870fbdf45947472a90cb4b1c27df8d033ec07d27322db106`  
		Last Modified: Thu, 28 Dec 2023 04:11:24 GMT  
		Size: 58.5 MB (58466257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:b7168b990d32321c1b013a52be299dcec14c4c206055bb675bcbe2200b51ca53
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.6 MB (118642082 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4ca5e30b73e7f1659721dd9161add76ceb75e61899307f12f145484b1603343`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 28 Dec 2023 02:12:52 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 02:15:09 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 28 Dec 2023 02:15:09 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 28 Dec 2023 02:15:22 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 28 Dec 2023 02:15:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f9d23d64292b5fb78d88da3038d7b53352d7c014c6f21f1e989802b063575547`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:51a1bbc2a730be7cce2d39e55f598fe47fe2ccd863ecfa763c911731a27dd51b`  
		Last Modified: Thu, 28 Dec 2023 02:19:08 GMT  
		Size: 58.5 MB (58466870 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:f0719427be6e6e3e6e6c6ed30979d642723b5ebffaf7db97c50b6ff6cc2ed5fc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (118985718 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce63ef1a620fb6ad2274e10b6f1b1b0676f12f8f1433ecdedff9a3ede86dec6f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 28 Dec 2023 05:30:33 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 28 Dec 2023 05:33:43 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Thu, 28 Dec 2023 05:33:44 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Thu, 28 Dec 2023 05:34:02 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Thu, 28 Dec 2023 05:34:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d656bddacdc60974ebaa77400d9cf1907169576551e5736310e327b9e8141cc1`  
		...
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c6a42ec96d40aab131518e9744707d70ebe7ba19d5eff8ceca61d7c82f6dbd2`  
		Last Modified: Thu, 28 Dec 2023 05:39:41 GMT  
		Size: 58.5 MB (58466546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:246333d6ea95cf18e06d9a531935b1c198ddb05227e58a9cc745671f4e80563c
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.3 MB (119256253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b04594af04b4592e68e02ae971404ab062c4967ad6b99988056b3c5ed63727f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 27 Jan 2024 08:21:53 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 27 Jan 2024 08:21:53 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 27 Jan 2024 08:22:15 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 08:22:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cd2371dae014ff291464176b54540d4b53fd14697371849ccc9f03d68bc6841a`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7354e270c8b410b36f5097a44a5d8efdddb33f3a54efa9d83ec0993475716bb2`  
		Last Modified: Sat, 27 Jan 2024 08:24:08 GMT  
		Size: 58.5 MB (58468029 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
