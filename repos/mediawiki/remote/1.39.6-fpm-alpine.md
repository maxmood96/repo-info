...
```console
$ docker pull mediawiki@sha256:ed7ce05f3ead63d98dc91ea8282a69ddb1ebdaecce4f5e5487ac9951147e6c08
```
...
```console
$ docker pull mediawiki@sha256:ed2264b4009640ffbb7a35fe966e88914e2a4df4170cd8e3bc8312e3fe92e182
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **113.6 MB (113616232 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9231e9c0a1fa37ee123b00182ced8b2b4364376a1f3e0900ecc74d8280b41f9f`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 11:04:41 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 27 Jan 2024 11:05:09 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 11:05:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8e41e837db7c834b9c5da75aa2b4bda43038337aa57cd59737695562e9b52525`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c30273eee491910670e4be85ec151bc876a37f9d7301d63c09f03d5c2562a21`  
		Last Modified: Sat, 27 Jan 2024 11:07:21 GMT  
		Size: 58.5 MB (58467854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
