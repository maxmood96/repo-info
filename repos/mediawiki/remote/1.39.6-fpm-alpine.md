...
```console
$ docker pull mediawiki@sha256:c15843b375f4e360a0ebb5b5989f23ac415832d2ce2b06159ea1c47a58a9a290
```
...
```console
$ docker pull mediawiki@sha256:b76603504fad50c302d7da6ce8905b36d86506fc8ff118bc56a433347871829e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **118.2 MB (118236707 bytes)**  
...
# Sat, 27 Jan 2024 10:35:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 27 Jan 2024 10:35:45 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 27 Jan 2024 10:35:58 GMT
...
-	Layers:
	...
	-	`sha256:f65c853cc7fe17c0e5471f0029c531c4cc63caa0791ab1e2d466e6cac5322a37`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:657c97d61a7cd4889c7dacb07837e886c6d32e5faa7d8dbc984f48941eb82372`  
		Last Modified: Sat, 27 Jan 2024 10:37:29 GMT  
		Size: 58.5 MB (58468049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.39.6-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:9802aac9d9c59d9f110074abd3286b834b604f999c9c744a0339f21cf6f945cd
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.7 MB (115680497 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4765bdc871e5cc5625051e73f8f5496e563e9c99d2845c10f8923c40c4e03876`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 27 Jan 2024 09:47:33 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.39
# Sat, 27 Jan 2024 09:47:33 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 27 Jan 2024 09:47:48 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 09:47:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4815e54a64f98d35a0b8d1b5ee072b03efecefbc9bae405dd2cfb95173ab249d`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dbd8f0d9e3a6559305ebb8a2120aa6817ef62e1f67ac110e92fdeb7b2f356ce8`  
		Last Modified: Sat, 27 Jan 2024 09:49:25 GMT  
		Size: 58.5 MB (58468494 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:335f9005cd17007b6980abf8265b67cb7c664928a9b3edbf4ff0226642474b26
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **119.0 MB (119001285 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f54ccb8b148ad5b2a1c568eaf918d7b30ab98f67a5b8a228a99a91666102d193`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 09:35:24 GMT
ENV MEDIAWIKI_VERSION=1.39.6
# Sat, 27 Jan 2024 09:35:42 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del --no-network .fetch-deps
# Sat, 27 Jan 2024 09:35:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4544b2dda04306bfcb5c6a7d4b2e2ae674222c499366df36493cdedf337636ca`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27847f53cad24001349a328adf4e1ee09ad813d3276b2040698f1767741eea8b`  
		Last Modified: Sat, 27 Jan 2024 09:37:42 GMT  
		Size: 58.5 MB (58467883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
