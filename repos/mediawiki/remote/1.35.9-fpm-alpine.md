...
```console
$ docker pull mediawiki@sha256:ce61e99ca258670e01d97754d264d761672fc18e76815e5aaf6178d563d3e061
```
...
```console
$ docker pull mediawiki@sha256:89f0c8c2d478f73183d7ed1385f93dc8ae4b633e78ebf2b0993bfbc26bf63a3f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.8 MB (153807244 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ec51e192ba3eb129f544f4ce7efa63852f91ffff92a96e2be52036639fa5b62`
...
# Sat, 11 Feb 2023 16:57:18 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 11 Feb 2023 16:57:19 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Sat, 11 Feb 2023 16:57:32 GMT
...
-	Layers:
	...
	-	`sha256:d6331c4c9aad72ca088ca54537473ce0b192d64bef8a02378a81fa68b477e34c`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3b4dce1fc2cb7e2d8784c78e3dba9ca1e44a468358820c6b8d353d867aefc7c`  
		Last Modified: Sat, 11 Feb 2023 16:59:20 GMT  
...
```console
$ docker pull mediawiki@sha256:26216542612d2ffaa488a8667faa5ef9be0ad34bffc3b13f270e9bbc04203631
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143051911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb5a36bda3f39e52b7881ab61b009a24d6db298eeb33c21027682c3b95bae4b7`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 11 Feb 2023 14:53:02 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 11 Feb 2023 14:53:46 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 11 Feb 2023 14:53:46 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Sat, 11 Feb 2023 14:54:03 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 11 Feb 2023 14:54:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:baff61497715ddb87a07dc8e686aec8e709c79b9a247c8125d6d79be1aa775d5`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7098c574d58d7d202bb144c7bfe9e7c2034e074c913eb4e9bcccfc825f3ee24f`  
		Last Modified: Sat, 11 Feb 2023 14:57:08 GMT  
		Size: 50.8 MB (50806128 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:a43a70dade088bec6975e19fad0c2da16f3db223ff6c4cb7c0a1450e1a524baf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159606857 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9acb378756165e10b181e24b1d8c4f18c0ecc0db011dfe486f5d23ecb21213c0`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Sat, 11 Feb 2023 11:24:15 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Sat, 11 Feb 2023 11:24:15 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Sat, 11 Feb 2023 11:24:42 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Sat, 11 Feb 2023 11:24:47 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:796fc15abd919c793114aabfc25e420166fbeacbea820fcca4a9663e5cc15df3`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2781cffd19268758496951d06f5ac3fe96b9dd6a929adad15fd7f5cb049f55b5`  
		Last Modified: Sat, 11 Feb 2023 11:27:52 GMT  
		Size: 50.8 MB (50806436 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
