...
```console
$ docker pull mediawiki@sha256:92b532dd05b4ef28ab979858adddb56777e92e8b8f426915db7b0aae72c03b8d
```
...
```console
$ docker pull mediawiki@sha256:4f06567b4e81bf77b999a3d29699a74e6ac9221f97ddb40be521f8b7c65db10f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.8 MB (153806479 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:04886a6473510800f0449e3c0e98698d6c5ee47970e01c85888984b6396f0633`
...
# Wed, 15 Feb 2023 00:26:30 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 15 Feb 2023 00:26:30 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Wed, 15 Feb 2023 00:26:43 GMT
...
-	Layers:
	...
	-	`sha256:91d5e4629046b5386afe7ca32836a3ddc3a028cc73935a9b6e69bcb639d0d2fa`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b756d3ee056eebc5255f8f290b43fb46d45d3f1448a40301b8f2ee6093a96d16`  
		Last Modified: Wed, 15 Feb 2023 00:30:55 GMT  
		Size: 50.8 MB (50806488 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.9-fpm-alpine` - linux; arm variant v6

```console
$ docker pull mediawiki@sha256:4f48d154b496cbc96203316eb6b5eafbe30e42b0507f664f172d5fdbf013a983
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **146.9 MB (146917154 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8320a3f456b8149f7fd48c418f300b6db9e60a533239ef9783f124879bb9d3d9`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Feb 2023 22:21:21 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Tue, 14 Feb 2023 22:21:50 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Tue, 14 Feb 2023 22:21:50 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Tue, 14 Feb 2023 22:22:08 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Tue, 14 Feb 2023 22:22:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f1c40090be45dae5e757db6ad4707c97e158d2970549e0944dc7ad947f81aedc`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:764b7306bb7a9a3c5309e952cc837582c95e8f2cb71450079643164583d1f5c5`  
		Last Modified: Tue, 14 Feb 2023 22:24:11 GMT  
		Size: 50.8 MB (50806378 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.9-fpm-alpine` - linux; arm variant v7

```console
$ docker pull mediawiki@sha256:799fe3a12692ff7d30b0f11aa3727baa28237b6d841553f78c237e579c99d3bb
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.1 MB (143052021 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:068f8de69fa5a3e99f77c58424d548588839a9c77f1a7a67eb4e619a4af7ca46`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 15 Feb 2023 00:53:09 GMT
CMD ["php-fpm"]
# Wed, 15 Feb 2023 03:58:21 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Wed, 15 Feb 2023 03:59:22 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 15 Feb 2023 03:59:23 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 03:59:23 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
...
# Wed, 15 Feb 2023 04:00:59 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Wed, 15 Feb 2023 04:01:17 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 15 Feb 2023 04:01:18 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8f44799ad9fa3e6968026cc6ac33f58110098163aef27b06112d42b17a5bdac3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8420d4d42473e31a05fa4bcdd527714c48282933816c5d39640818fa449ec33`  
		Last Modified: Wed, 15 Feb 2023 04:05:55 GMT  
		Size: 60.8 MB (60761328 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3755371e697f7789bdf26a7939eb4ed5cdb7e771c50b6878fd1046977fa316cc`  
		Last Modified: Wed, 15 Feb 2023 04:05:46 GMT  
		Size: 6.3 MB (6302411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:72f5515da8a67f11a4aa3347cc072cf8516fa1483496af8291003b28d25a7509`  
		Last Modified: Wed, 15 Feb 2023 04:05:45 GMT  
		Size: 325.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98c22558a7a9d8fbc94cb5c3247633cad206e2e6e0abe4b0066cca7c12560d9c`  
		Last Modified: Wed, 15 Feb 2023 04:05:45 GMT  
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97a4f58b8c80ebc9f5eb5d4994bf590f7c2c6284aa11cc07fe76e33021f12c18`  
		Last Modified: Wed, 15 Feb 2023 04:07:33 GMT  
		Size: 50.8 MB (50806278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.9-fpm-alpine` - linux; arm64 variant v8

```console
$ docker pull mediawiki@sha256:c3c189facf85d61e1f9ad57a6ba4482a2c9dbc98c52f9f0a1031be2de591ea44
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.4 MB (151413238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e55d0a0bb1f9b978956a4a7065b18902c3c60b4c6759a27f392de22aec3a490`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Feb 2023 22:45:34 GMT
CMD ["php-fpm"]
# Wed, 15 Feb 2023 01:01:49 GMT
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Wed, 15 Feb 2023 01:02:33 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 15 Feb 2023 01:02:34 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 01:02:34 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
...
-	Layers:
	...
	-	`sha256:d00b26ec515edd5af293e7a00d8067fbb57e5357e898ccdcfa92bc7f8b00dc11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2597b6a14d06227f79ece17fac6be394043b824ebb79388973cc0d7ed8fc7da8`  
		Last Modified: Wed, 15 Feb 2023 01:06:38 GMT  
		Size: 67.0 MB (66996669 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fe3a5754bc569c4a09719026f7d60b1b8bced1e92e7bcb905323addc93fac84`  
		Last Modified: Wed, 15 Feb 2023 01:06:31 GMT  
		Size: 6.8 MB (6776929 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc264806dc02272718aba295cdca0276aff32c7ad994ae6d7b077ab48792c231`  
		Last Modified: Wed, 15 Feb 2023 01:06:30 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de2b5a4ae9a19818a8f3947b9b7ea1ebcc120dab59c9eee80857854f60d9f5c8`  
		Last Modified: Wed, 15 Feb 2023 01:06:30 GMT  
		Size: 171.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:225ee26190d76410ea9e2902aff7ed94d183c8d037caabca3180ef6dc9ccba41`  
		Last Modified: Wed, 15 Feb 2023 01:07:44 GMT  
		Size: 50.8 MB (50806273 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.9-fpm-alpine` - linux; 386

```console
$ docker pull mediawiki@sha256:c029e925fbf5d90a540f2622d2dc60ab531906f6bdec0b594480f3a4773a25af
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **153.7 MB (153663027 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e55653004eb8b2b8433791ef5f072b30512afe1f0db1078c011d5fb0bcc020ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Wed, 15 Feb 2023 01:17:20 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 15 Feb 2023 01:17:21 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 01:17:22 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Feb 2023 01:18:45 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 15 Feb 2023 01:18:46 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Wed, 15 Feb 2023 01:19:01 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 15 Feb 2023 01:19:03 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0d6a1039a838a8b2870b13db2defd00a5ab9bbb52c1d7579fc0405f9b2aeeb18`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86668f1041552433a67627305ffe3afa2df02104da2bb3559e1b5a4b1b690121`  
		Last Modified: Wed, 15 Feb 2023 01:22:48 GMT  
		Size: 67.8 MB (67801120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c26b7b6076e227c88de2260e728c8a85ab95876670f9cc52f4f7b3273dc467b`  
		Last Modified: Wed, 15 Feb 2023 01:22:38 GMT  
		Size: 7.2 MB (7229562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cff8356e122370abfff2e6dbb4b0eb12150d11d3f1c4f01834f9d1dcb60c1d07`  
		Last Modified: Wed, 15 Feb 2023 01:22:37 GMT  
		Size: 322.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccb3481b5f51c21f3b6b546c0211941fab4341b53be8e973218b71b795a79328`  
		Last Modified: Wed, 15 Feb 2023 01:22:37 GMT  
		Size: 137.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d82636fa753fda95459562a3c256b0d1f071533f7321c9df7a9c90a012f6ae2d`  
		Last Modified: Wed, 15 Feb 2023 01:24:06 GMT  
		Size: 50.8 MB (50806379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.35.9-fpm-alpine` - linux; ppc64le

```console
$ docker pull mediawiki@sha256:86f40815defef3e0871c19be408abb6c116b69d427350531e2e18528df70e0ad
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159608135 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cf133bd3e162abae6ce679e4a70d757a129cfac2409c648457e318d541374fd3`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 		apk add --no-cache 		git 		imagemagick 		python3 	;
# Wed, 15 Feb 2023 02:06:19 GMT
RUN set -eux; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		icu-dev 		oniguruma-dev 	; 		docker-php-ext-install -j "$(nproc)" 		calendar 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.21; 	docker-php-ext-enable 		apcu 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --virtual .mediawiki-phpext-rundeps $runDeps; 	apk del .build-deps
# Wed, 15 Feb 2023 02:06:20 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 15 Feb 2023 02:06:22 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Wed, 15 Feb 2023 02:09:12 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.35
# Wed, 15 Feb 2023 02:09:12 GMT
ENV MEDIAWIKI_VERSION=1.35.9
# Wed, 15 Feb 2023 02:09:37 GMT
RUN set -eux; 	apk add --no-cache --virtual .fetch-deps 		bzip2 		gnupg 	; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -rf "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apk del .fetch-deps
# Wed, 15 Feb 2023 02:09:42 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8f2735794ce5bd79c02789da1b681c8a6aa83b5cf09f1ef0faa8743d7cdd58b4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f929f7a6f4e88df4c79b75ad0545fb7691060036910f722d34d19ece9a83fa5c`  
		Last Modified: Wed, 15 Feb 2023 02:14:34 GMT  
		Size: 74.0 MB (73994907 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93c4b7cd776de8d6549449d8ebd85a952ae1d559271954f2daaa2e7d94a68229`  
		Last Modified: Wed, 15 Feb 2023 02:14:17 GMT  
		Size: 6.8 MB (6842087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0d7be6d2ca76e61dd8f6e6c11934f2cf749f1af2e543710fd81374a6558d15e`  
		Last Modified: Wed, 15 Feb 2023 02:14:16 GMT  
		Size: 327.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4b59fe42540a0a44a04650ea042d5f35ec32466465779709f16f3428ee3a8d5`  
		Last Modified: Wed, 15 Feb 2023 02:14:16 GMT  
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d94436bae7f6019ffc822c5b1f652ff6a9981a3f4ccd9550123516f11267b09`  
		Last Modified: Wed, 15 Feb 2023 02:16:22 GMT  
		Size: 50.8 MB (50806307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
