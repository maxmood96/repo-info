...
```console
$ docker pull mediawiki@sha256:bac8db161f1b1cfa3321fc30a5298cb582cbab638dca5c6b3cbd974a03f6144e
```
...
```console
$ docker pull mediawiki@sha256:bc70c4f37f69d2227b441f10f6fb8b2ef9ffd2be8fbb2cbc1978977314cb0fe7
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.4 MB (297436960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7951b4fe1b0c9bb240e134e3136aad8f6ee8464f01b7a5eb00f90a3f4ac56a95`
...
-	Layers:
	...
	-	`sha256:085fa19b37c231ee45bf8e9c40ac0836a6ed6de630b00c46fd6e20bccefc7628`  
		...
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afbfe4b17c34e8ab180a588708e4511c068b4f583f29814a5a75ca498dac007e`  
		Last Modified: Thu, 06 Jun 2024 23:45:50 GMT  
		Size: 68.4 MB (68358114 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:f509f116939c8c202f57901ced8b9a820f0bccb2644a98d8e60b79a7d0dcaaa2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **288.5 MB (288530214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9c65325e89793baa75161250c1234873b33b6b4d0cffa5af34a3a28b423f03e6`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Thu, 06 Jun 2024 23:51:32 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Thu, 06 Jun 2024 23:51:32 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Thu, 06 Jun 2024 23:51:49 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Thu, 06 Jun 2024 23:51:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d14a2b2131bc96de712c9a8e4d5d14935e54f2259d0a6bb1d868529e86af260e`  
		...
		Size: 141.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e195a69cc95d59a733ecf06343575b7b800f792cadb31390fa55e50761a83142`  
		Last Modified: Thu, 06 Jun 2024 23:55:28 GMT  
		Size: 68.4 MB (68357408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `mediawiki:1.40-fpm` - linux; 386

```console
$ docker pull mediawiki@sha256:064f0b9e76dfea3c5570fe6c50a4e377eb4d54a5d1151c9b530f4f012aeee741
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.7 MB (297661320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf114df513b6eb700e7da76216d55c21e354fe83fc479805d4a10de2149a4fb2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 07 Jun 2024 03:28:16 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 07 Jun 2024 03:31:55 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.40
# Fri, 07 Jun 2024 03:31:55 GMT
ENV MEDIAWIKI_VERSION=1.40.3
# Fri, 07 Jun 2024 03:32:22 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver keyserver.ubuntu.com --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Jun 2024 03:32:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d264534af7d7c0536a8a8fa09c4134347b6fddf603bf2d7651122db9a3482d57`  
		...
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb228055de6342b93c388b469e8d84537a8a8cc04a0b5247293ae387465783ce`  
		Last Modified: Fri, 07 Jun 2024 03:37:43 GMT  
		Size: 68.4 MB (68357379 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
