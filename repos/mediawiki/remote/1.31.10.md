...
```console
$ docker pull mediawiki@sha256:773e0f506a1864cbf2ee0068427b1fdaab99b2806ba2d13b60892440b045ed27
```
...
```console
$ docker pull mediawiki@sha256:8ea9ea6d7dda251bead1c8081d9e2ff8e16ba7deb84956bceead8c52636afdc0
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **252.5 MB (252497830 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4c5b59a966324dc363ae682e492bf3783e0b6ad8665f15122ed6233ce0835ca`
...
# Fri, 06 Nov 2020 03:49:54 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Nov 2020 03:51:17 GMT
...
-	Layers:
	...
	-	`sha256:d786ccf8c9d278d127799837145782c759b1d08299d0fd275f4c49642222220a`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30efbc704dfef89429f6729df18839d2918293537439fb4aedea63730c2d3b49`  
		Last Modified: Fri, 06 Nov 2020 04:00:06 GMT  
		Size: 64.4 MB (64422613 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:238ad02833ae1f19742aafa85c19c06be25392a24541a1f03bd125ed22bbe0d4`  
		Last Modified: Fri, 06 Nov 2020 03:59:49 GMT  
		Size: 2.8 MB (2778165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10a3f3f16d00ea41a07bd639e1f78c49021b6a0453c13257d0193bcbba928f83`  
		Last Modified: Fri, 06 Nov 2020 03:59:49 GMT  
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7aad8db006571da964ef0ba3ea20cea70613c5a770a170a847186a68d4736d5c`  
		Last Modified: Fri, 06 Nov 2020 03:59:48 GMT  
		Size: 139.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01ccb8a1d8ec495d5991a64c506be23d54bdeaa2cde82ac33a3e1281f5f3bf84`  
		Last Modified: Fri, 06 Nov 2020 04:00:06 GMT  
		Size: 36.2 MB (36219819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull mediawiki@sha256:4eaa21d228a5c195c881c1219a3069eaa353de8780df7ee78b94fab79d573b7e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.4 MB (260412699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:997bebb2a93a4df81ef89eb84ac83d4d717a286f446015de2b28f1cec0466c29`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 06 Nov 2020 00:27:46 GMT
CMD ["apache2-foreground"]
# Fri, 06 Nov 2020 04:00:22 GMT
RUN set -eux; 		apt-get update; 	apt-get install -y --no-install-recommends 		git 		librsvg2-bin 		imagemagick 		python3 	; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Nov 2020 04:01:56 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libicu-dev 	; 		docker-php-ext-install -j "$(nproc)" 		intl 		mbstring 		mysqli 		opcache 	; 		pecl install APCu-5.1.18; 	docker-php-ext-enable 		apcu 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Nov 2020 04:01:57 GMT
RUN { 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=60'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 06 Nov 2020 04:01:58 GMT
RUN set -eux; 	mkdir -p /var/www/data; 	chown -R www-data:www-data /var/www/data
# Fri, 06 Nov 2020 04:01:58 GMT
ENV MEDIAWIKI_MAJOR_VERSION=1.31
# Fri, 06 Nov 2020 04:01:59 GMT
ENV MEDIAWIKI_VERSION=1.31.10
# Fri, 06 Nov 2020 04:02:21 GMT
RUN set -eux; 	fetchDeps=" 		gnupg 		dirmngr 	"; 	apt-get update; 	apt-get install -y --no-install-recommends $fetchDeps; 		curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz" -o mediawiki.tar.gz; 	curl -fSL "https://releases.wikimedia.org/mediawiki/${MEDIAWIKI_MAJOR_VERSION}/mediawiki-${MEDIAWIKI_VERSION}.tar.gz.sig" -o mediawiki.tar.gz.sig; 	export GNUPGHOME="$(mktemp -d)"; 	gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 		D7D6767D135A514BEB86E9BA75682B08E8A3FEC4 		441276E9CCD15F44F6D97D18C119E1A64D70938E 		F7F780D82EBFB8A56556E7EE82403E59F9F8CD79 		1D98867E82982C8FE0ABC25F9B69B3109D3BB7B0 	; 	gpg --batch --verify mediawiki.tar.gz.sig mediawiki.tar.gz; 	tar -x --strip-components=1 -f mediawiki.tar.gz; 	gpgconf --kill all; 	rm -r "$GNUPGHOME" mediawiki.tar.gz.sig mediawiki.tar.gz; 	chown -R www-data:www-data extensions skins cache images; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false $fetchDeps; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Nov 2020 04:02:21 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:949af6ef058a6e32c0cccd3b0e7d4701605b247776811e73407f77cafbf87a09`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23897b5b90fe14c8a2a5858f678a79e5a8d8acb091657abc51f3fbec22d7a7d1`  
		Last Modified: Fri, 06 Nov 2020 04:11:56 GMT  
		Size: 66.4 MB (66391606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:54418f5570dafa7fc7660e7534287cf65034f7614b727201c95479a5b6d1b0ca`  
		Last Modified: Fri, 06 Nov 2020 04:11:34 GMT  
		Size: 2.8 MB (2765214 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:012eddf9172826cac7c47b2abc9056e5f356b0a76c0aba445c5cd39d94aaa3e2`  
		Last Modified: Fri, 06 Nov 2020 04:11:33 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:545cc2da776c9d8209aba0a6bb6ebe46a396b52e1ce10c185d5105403e994635`  
		Last Modified: Fri, 06 Nov 2020 04:11:33 GMT  
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c998d583cefd18f67455270d0ca5ddb6d93b606f8a1ac65c2fc79d98cde4b15`  
		Last Modified: Fri, 06 Nov 2020 04:11:53 GMT  
		Size: 36.2 MB (36217830 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
