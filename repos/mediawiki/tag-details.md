...
```console
$ docker pull mediawiki@sha256:96aa5ec14906f544f26b66db7160803efaaac58a5b429c24f3427072fe1c6828
```
...
```console
$ docker pull mediawiki@sha256:276e04516326d48618239e690261d994f053b996dd9ded06169d048d7c509035
```
...
```console
$ docker pull mediawiki@sha256:389005c33ae3d4bcacbcacc4c42bdd0913e991e81af5b265bc93807ce60cb095
```
...
```console
$ docker pull mediawiki@sha256:7dc54643d26a9853a3c96ddf6f0aac9a4bd83aa11ebfd61a49a4650a867dbf2a
```
...
```console
$ docker pull mediawiki@sha256:83fd02a7142c61c00fa0156ea9b95f3de4dcc4050c8855e078b608e2f4eced5f
```
