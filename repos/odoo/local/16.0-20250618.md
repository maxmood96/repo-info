...
### `dpkg` source package: `jinja2=2.11.3-1+deb11u4`

Binary Packages:

- `python3-jinja2=2.11.3-1+deb11u4`
...
```console
$ apt-get source -qq --print-uris jinja2=2.11.3-1+deb11u4
'http://deb.debian.org/debian-security/pool/updates/main/j/jinja2/jinja2_2.11.3-1%2bdeb11u4.dsc' jinja2_2.11.3-1+deb11u4.dsc 2283 SHA256:5f8819128d7fd26be399ea69846a3cbb3e0376d580aa2549253aab52b02d193b
'http://deb.debian.org/debian-security/pool/updates/main/j/jinja2/jinja2_2.11.3.orig.tar.gz' jinja2_2.11.3.orig.tar.gz 257589 SHA256:a6d58433de0ae800347cab1fa3043cebbabe8baa9d29e668f1c768cb87a333c6
'http://deb.debian.org/debian-security/pool/updates/main/j/jinja2/jinja2_2.11.3-1%2bdeb11u4.debian.tar.xz' jinja2_2.11.3-1+deb11u4.debian.tar.xz 13040 SHA256:85e4909ad34bbad167eb0f039d8b9f164b36bb2fad9de3504125bf905e1f3019
```

Other potentially useful URLs:

- https://sources.debian.net/src/jinja2/2.11.3-1+deb11u4/ (for browsing the source)
- https://sources.debian.net/src/jinja2/2.11.3-1+deb11u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jinja2/2.11.3-1+deb11u4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `nodejs=12.22.12~dfsg-1~deb11u7`

Binary Packages:

- `libnode-dev=12.22.12~dfsg-1~deb11u7`
...
```console
$ apt-get source -qq --print-uris nodejs=12.22.12~dfsg-1~deb11u7
'http://deb.debian.org/debian-security/pool/updates/main/n/nodejs/nodejs_12.22.12%7edfsg-1%7edeb11u7.dsc' nodejs_12.22.12~dfsg-1~deb11u7.dsc 3480 SHA256:f6fff82032a9870cadf5e33c7beeb10af555dc1f4a9cce92fd81ecaed39de6ff
...
'http://deb.debian.org/debian-security/pool/updates/main/n/nodejs/nodejs_12.22.12%7edfsg-1%7edeb11u7.debian.tar.xz' nodejs_12.22.12~dfsg-1~deb11u7.debian.tar.xz 178824 SHA256:b3a8d22c6664960d9b645399707cf09100ef4a6dfb15bde2ac794fa22e5fc299
```

Other potentially useful URLs:

- https://sources.debian.net/src/nodejs/12.22.12~dfsg-1~deb11u7/ (for browsing the source)
- https://sources.debian.net/src/nodejs/12.22.12~dfsg-1~deb11u7/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/nodejs/12.22.12~dfsg-1~deb11u7/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `odoo=16.0.20250618`
...
### `dpkg` source package: `postgresql-17=17.5-1.pgdg110+1`

Binary Packages:

- `libpq5:amd64=17.5-1.pgdg110+1`
- `postgresql-client-17=17.5-1.pgdg110+1`
...
### `dpkg` source package: `postgresql-common=278.pgdg110+1`

Binary Packages:

- `postgresql-client=17+278.pgdg110+1`
- `postgresql-client-common=278.pgdg110+1`
...
### `dpkg` source package: `python-urllib3=1.26.5-1~exp1+deb11u1`
...
```console
$ apt-get source -qq --print-uris python-urllib3=1.26.5-1~exp1+deb11u1
'http://deb.debian.org/debian-security/pool/updates/main/p/python-urllib3/python-urllib3_1.26.5-1%7eexp1%2bdeb11u1.dsc' python-urllib3_1.26.5-1~exp1+deb11u1.dsc 2250 SHA256:5ddb0ec9ee23599f975b3c5c4270374d49785bcd1748e5b923de17780a36be69
'http://deb.debian.org/debian-security/pool/updates/main/p/python-urllib3/python-urllib3_1.26.5.orig.tar.gz' python-urllib3_1.26.5.orig.tar.gz 292865 SHA256:a7acd0977125325f516bda9735fa7142b909a8d01e8b2e4c8108d0984e6e0098
'http://deb.debian.org/debian-security/pool/updates/main/p/python-urllib3/python-urllib3_1.26.5-1%7eexp1%2bdeb11u1.debian.tar.xz' python-urllib3_1.26.5-1~exp1+deb11u1.debian.tar.xz 15668 SHA256:c5c063d6dd1b4b871fad38f4a56fd71dbf3d37a8c3a1f61e817abba0ead80052
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-urllib3/1.26.5-1~exp1+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/python-urllib3/1.26.5-1~exp1+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-urllib3/1.26.5-1~exp1+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `python-werkzeug=1.0.1+dfsg1-2+deb11u2`

Binary Packages:

- `python3-werkzeug=1.0.1+dfsg1-2+deb11u2`
...
```console
$ apt-get source -qq --print-uris python-werkzeug=1.0.1+dfsg1-2+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/p/python-werkzeug/python-werkzeug_1.0.1%2bdfsg1-2%2bdeb11u2.dsc' python-werkzeug_1.0.1+dfsg1-2+deb11u2.dsc 2477 SHA256:9b3118ee9f4a4701b0c3f4f7c026fcd2f0a2021b17ac97b4a18b48ee35e25886
...
'http://deb.debian.org/debian-security/pool/updates/main/p/python-werkzeug/python-werkzeug_1.0.1%2bdfsg1-2%2bdeb11u2.debian.tar.xz' python-werkzeug_1.0.1+dfsg1-2+deb11u2.debian.tar.xz 13304 SHA256:1394414af39bde052c813f250dfd03da932dfbd4495820221c9dea59027b63de
```

Other potentially useful URLs:

- https://sources.debian.net/src/python-werkzeug/1.0.1+dfsg1-2+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/python-werkzeug/1.0.1+dfsg1-2+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python-werkzeug/1.0.1+dfsg1-2+deb11u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `setuptools=52.0.0-4+deb11u2`

Binary Packages:

- `python3-pkg-resources=52.0.0-4+deb11u2`
- `python3-setuptools=52.0.0-4+deb11u2`
...
```console
$ apt-get source -qq --print-uris setuptools=52.0.0-4+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/s/setuptools/setuptools_52.0.0-4%2bdeb11u2.dsc' setuptools_52.0.0-4+deb11u2.dsc 2780 SHA256:8ca363cb4ee1fc3030e284082d67445804b3096ee7746d3af41d3d22d7c9bbfa
...
'http://deb.debian.org/debian-security/pool/updates/main/s/setuptools/setuptools_52.0.0-4%2bdeb11u2.debian.tar.xz' setuptools_52.0.0-4+deb11u2.debian.tar.xz 17016 SHA256:8cc05d8971b5e6b3d92611cbaf9038b0f92e5d1c85d96393ea7f78b964c3644d
```

Other potentially useful URLs:

- https://sources.debian.net/src/setuptools/52.0.0-4+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/setuptools/52.0.0-4+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/setuptools/52.0.0-4+deb11u2/ (for access to the source package after it no longer exists in the archive)
