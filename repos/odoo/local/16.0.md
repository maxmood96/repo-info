...
### `dpkg` source package: `jinja2=2.11.3-1+deb11u2`

Binary Packages:

- `python3-jinja2=2.11.3-1+deb11u2`
...
```console
$ apt-get source -qq --print-uris jinja2=2.11.3-1+deb11u2
'http://deb.debian.org/debian-security/pool/updates/main/j/jinja2/jinja2_2.11.3-1%2bdeb11u2.dsc' jinja2_2.11.3-1+deb11u2.dsc 2251 SHA256:3fa113c42f8f6468219d9a73ea4f7277b2833268ddfa2bdc8b31d58868d6e1e0
...
'http://deb.debian.org/debian-security/pool/updates/main/j/jinja2/jinja2_2.11.3-1%2bdeb11u2.debian.tar.xz' jinja2_2.11.3-1+deb11u2.debian.tar.xz 9672 SHA256:99351c0a0dc7e2342fe70228a88c03272d4a46d3a083bc5ca3b54f2ad698858c
```

Other potentially useful URLs:

- https://sources.debian.net/src/jinja2/2.11.3-1+deb11u2/ (for browsing the source)
- https://sources.debian.net/src/jinja2/2.11.3-1+deb11u2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jinja2/2.11.3-1+deb11u2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libio-pty-perl=1:1.15-2`
...
```console
$ apt-get source -qq --print-uris libio-pty-perl=1:1.15-2
'http://deb.debian.org/debian/pool/main/libi/libio-pty-perl/libio-pty-perl_1.15-2.dsc' libio-pty-perl_1.15-2.dsc 2304 SHA256:96e86cd8fbd97a4d6e0ab09bec2ee0ad5a46b6da780627b075d7a88f7bb3f145
'http://deb.debian.org/debian/pool/main/libi/libio-pty-perl/libio-pty-perl_1.15.orig.tar.gz' libio-pty-perl_1.15.orig.tar.gz 25761 SHA256:43f9cc0f87620bbb159e0890e196b23a8e6419cbd04224c10f3dcee948f6b51a
'http://deb.debian.org/debian/pool/main/libi/libio-pty-perl/libio-pty-perl_1.15-2.debian.tar.xz' libio-pty-perl_1.15-2.debian.tar.xz 5088 SHA256:0a2e794c2a16dd95174d8d48b63447186c683443a23a9e182595a8912708c5a2
```

Other potentially useful URLs:

- https://sources.debian.net/src/libio-pty-perl/1:1.15-2/ (for browsing the source)
- https://sources.debian.net/src/libio-pty-perl/1:1.15-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libio-pty-perl/1:1.15-2/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/libi/libipc-run-perl/libipc-run-perl_20200505.0-1.dsc' libipc-run-perl_20200505.0-1.dsc 2384 SHA256:8586391f44bd6be836b1180cf8809e86c2acbba9a2d0ee314d6e07051ab917b2
'http://deb.debian.org/debian/pool/main/libi/libipc-run-perl/libipc-run-perl_20200505.0.orig.tar.gz' libipc-run-perl_20200505.0.orig.tar.gz 127505 SHA256:816ebf217fa0df99c583d73c0acc6ced78ac773787c664c75cbf140bb7e4c901
'http://deb.debian.org/debian/pool/main/libi/libipc-run-perl/libipc-run-perl_20200505.0-1.debian.tar.xz' libipc-run-perl_20200505.0-1.debian.tar.xz 5372 SHA256:ee93481f088c98003e283bac6eff10ffc1b67c2f64dcfa510eb580cb4d9edc2d
```

Other potentially useful URLs:

- https://sources.debian.net/src/libipc-run-perl/20200505.0-1/ (for browsing the source)
- https://sources.debian.net/src/libipc-run-perl/20200505.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libipc-run-perl/20200505.0-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `odoo=16.0.20241220`
...
### `dpkg` source package: `postgresql-17=17.2-1.pgdg110+1`

Binary Packages:

- `libpq5:amd64=17.2-1.pgdg110+1`
- `postgresql-client-17=17.2-1.pgdg110+1`
...
### `dpkg` source package: `postgresql-common=267.pgdg110+1`

Binary Packages:

- `postgresql-client=17+267.pgdg110+1`
- `postgresql-client-common=267.pgdg110+1`
