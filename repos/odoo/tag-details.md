...
```console
$ docker pull odoo@sha256:fd978e5ed607b345cd97234152ebbf82aac32956def81cacf6a4a25e1575654f
```
...
### `odoo:17.0-20241209` - linux; arm64 variant v8
...
### `odoo:18.0-20241209` - linux; arm64 variant v8
