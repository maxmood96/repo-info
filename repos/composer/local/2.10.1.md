...
- Created: `2026-06-05T02:12:25.969012801Z`
- Virtual Size: ~ 227.24 Mb  
...
```console
7zip-25.01-r0 description:
File archiver with a high compression ratio

7zip-25.01-r0 webpage:
https://7-zip.org/

7zip-25.01-r0 installed size:
1742 KiB

7zip-25.01-r0 license:
LGPL-2.0-only
