...
- Created: `2022-10-29T14:49:55.701413592Z`
- Virtual Size: ~ 199.73 Mb  
...
```console
p7zip-17.04-r2 description:
Command-line port of the 7zip compression utility

p7zip-17.04-r2 webpage:
https://github.com/jinfeihan57/p7zip

p7zip-17.04-r2 installed size:
10 MiB

p7zip-17.04-r2 license:
LGPL-2.0-or-later
...
```console
skalibs-2.11.2.0-r0 description:
Set of general-purpose C programming libraries for skarnet.org software.

skalibs-2.11.2.0-r0 webpage:
https://skarnet.org/software/skalibs/

skalibs-2.11.2.0-r0 installed size:
192 KiB

skalibs-2.11.2.0-r0 license:
ISC
...
```console
utmps-libs-0.1.2.0-r0 description:
A secure utmp/wtmp implementation (libraries)

utmps-libs-0.1.2.0-r0 webpage:
https://skarnet.org/software/utmps/

utmps-libs-0.1.2.0-r0 installed size:
24 KiB

utmps-libs-0.1.2.0-r0 license:
ISC
