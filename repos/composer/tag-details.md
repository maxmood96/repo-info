...
```console
$ docker pull composer@sha256:9665a98d2d1b9e40e54f9fd06649cde534501fbafca892e2ebad375466e0827f
```
...
```console
$ docker pull composer@sha256:a122c59f9df8597e35bbfe3ba9c701b400a0c9716250b96f3ae319a65ff8374b
```
