...
```console
$ docker pull composer@sha256:1c8b60c77ee151a9fdf67b07bd1e77824b738033a179801d08d6a1496449a6e1
```
...
```console
$ docker pull composer@sha256:401afc656a993cd2bfa9a0d808bbc60a212bfb4d296a894b67d5d2993a8d2d96
```
