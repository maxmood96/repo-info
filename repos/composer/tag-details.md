...
```console
$ docker pull composer@sha256:cc2b257e655c85cb00a516690ecfa9b4487b737ba7fb3273871feeae4f615a13
```
...
```console
$ docker pull composer@sha256:13a317f76cf3a6d484e0a83a3be48f607752405d6e38fb9034ee456a76cbbf2c
```
