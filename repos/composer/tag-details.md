...
### `composer:1.10.7` - linux; arm variant v6
...
### `composer:1.10.7` - linux; arm variant v7
...
### `composer:1.10.7` - linux; arm64 variant v8
...
```console
$ docker pull composer@sha256:1d4c6e9a64681e9e32e01e537bc38215350cc289759c6496f13b6c61c0592e08
```
...
```console
$ docker pull composer@sha256:53925673999379f5b944f2308b3b4e5af0f14d639561623d56b10469f8a240ea
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.3 MB (62290334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e1a00adc8dff9f46e5e992898e245f94b4aba52cddf4a4a003933fc6fe7341b`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 03 Jun 2020 17:50:03 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 03 Jun 2020 17:50:04 GMT
WORKDIR /app
# Wed, 03 Jun 2020 17:50:04 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Wed, 03 Jun 2020 17:50:05 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:43163bdea5f54fb483263a3ed86814c179c6e904da5fec66b5acdb14d75efae6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd19437bd92646c04f56904e0b9ba437c4c1d9e79fa5b76a555271644e107568`  
		Last Modified: Wed, 03 Jun 2020 17:50:35 GMT  
		Size: 407.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5473348719d209d43389a31d0edb699ead0406449347c3bda35a391e23f6916`  
		Last Modified: Wed, 03 Jun 2020 17:50:34 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull composer@sha256:0200e3d96a55432dc4f7846d233df88a8d4ca2b3ff3a3b0164ee27b21b17595c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.6 MB (59642786 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa196a1cd108694032951e0787c02a103a9508d689ca5268cacfcb92ce4a5251`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 03 Jun 2020 17:58:09 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 03 Jun 2020 17:58:09 GMT
WORKDIR /app
# Wed, 03 Jun 2020 17:58:10 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Wed, 03 Jun 2020 17:58:10 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:c8f68fbd678d0c2485f60b8a724360548295874e6cf8c41ec9686423e3ae8908`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b99457c82103ea0bf81d9b2a1f9133a7561ee939a9f4695f56a09cffb3914d55`  
		Last Modified: Wed, 03 Jun 2020 17:58:42 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a43d266cbe995e95ac86a3b0887cf7169f6825ea088804b5a8935a02ba101a8c`  
		Last Modified: Wed, 03 Jun 2020 17:58:42 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull composer@sha256:ded1a8989d0281dd73d58c18ea437b2d7aa4f2793f0cf4dba95dfd2d756dde9e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **64.3 MB (64270709 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3bcfbba6681554eca1f5e4c6a951a4bb103313f56f5262ac4eff0a1414a1a68`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 03 Jun 2020 18:40:29 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 03 Jun 2020 18:40:30 GMT
WORKDIR /app
# Wed, 03 Jun 2020 18:40:31 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Wed, 03 Jun 2020 18:40:31 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:593e51a573ecf98974920f928de96e8f01a66d936bb78e794854b4375eb52d21`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04da8818e183917280b3256f740890a2dcc99ac6388d02676eb3b7cf7bbc120d`  
		Last Modified: Wed, 03 Jun 2020 18:41:02 GMT  
		Size: 410.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf0e180fdc82c7f8afd7df3083e3d1960cddf318ac765f2c3ae3609375f36081`  
		Last Modified: Wed, 03 Jun 2020 18:41:03 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull composer@sha256:9390175dc32a6bb22cbd34994543e519f5f43725512c537f8f4a7267ce669599
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.5 MB (63496899 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81abd95d7ddbb43305ae9cccb6a140172cd336dda772c3698fce9e9c5393e3f8`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Wed, 03 Jun 2020 17:41:53 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Wed, 03 Jun 2020 17:41:54 GMT
WORKDIR /app
# Wed, 03 Jun 2020 17:41:54 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Wed, 03 Jun 2020 17:41:55 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:711c4399c73938a2e087fef2dd87cf77d8e893782705746f92fc4f7c982203eb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2007cbb5624c630ff1dca5204449f4d6cbcb19280447cabb8736d81fc3c4fcb6`  
		Last Modified: Wed, 03 Jun 2020 17:42:33 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4638feb65f0af6403c833a9b7691157a1d108074d033dbef2d17346b58e90606`  
		Last Modified: Wed, 03 Jun 2020 17:42:39 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
