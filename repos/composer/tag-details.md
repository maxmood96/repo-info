...
```console
$ docker pull composer@sha256:b2b933c08287d525cd4cb1bfa69db0a5af9adb1a25f890c5e82d02f781d96dba
```
...
```console
$ docker pull composer@sha256:a040427c0503d82c96670f9b2ac4e7b5fbf546a3f05cfc98d2fb44618a2c5e0e
```
