...
```console
$ docker pull composer@sha256:6f850ea5b15d2624ebadada1ac1460aea308fa6def8205691acd3e69bf5e5f97
```
...
```console
$ docker pull composer@sha256:e1065351e7ecae54c4cceb4035b5339f0301c7f22988ea8a7ee9a2605416a5c3
```
