...
```console
$ docker pull composer@sha256:fe663a3f420b0397e4b37cde7a9c20bff72cd67cefc79758698446dc67a4d43d
```
...
```console
$ docker pull composer@sha256:215f13a8f5b9af04defa2c6dce1e3b72f442930056dfb7006ab34fdc95d3ccaf
```
