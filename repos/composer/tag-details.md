...
```console
$ docker pull composer@sha256:88d159c413c163dd45478319614fc26049aaa9014295c5e112c45dfd06d323f1
```
...
```console
$ docker pull composer@sha256:ecf5203c90f67f85b404f3e549e7538fcdd413d6b3ed76a997393ef068b96b8d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **59.7 MB (59693166 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:94c2ce08cc2a2cf28e20ec5670302b96d83fabbb14f3078bfde09fb85e37a880`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
# Thu, 05 Nov 2020 21:24:22 GMT
ENV COMPOSER_HOME=/tmp
# Mon, 16 Nov 2020 19:49:27 GMT
ENV COMPOSER_VERSION=2.0.7
# Mon, 16 Nov 2020 19:49:31 GMT
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Mon, 16 Nov 2020 19:49:32 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Mon, 16 Nov 2020 19:49:33 GMT
WORKDIR /app
# Mon, 16 Nov 2020 19:49:33 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Mon, 16 Nov 2020 19:49:34 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:5a4940128541cfe54031659da60077c64da7fe9277660446bd2b62263b9df003`  
		...
		Size: 254.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34f7bcd2979b9f1696aba3649fcd8a34103ee220d16917c46d5dec5fa36b50de`  
		Last Modified: Mon, 16 Nov 2020 19:49:54 GMT  
		Size: 552.3 KB (552267 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4de62e4ae9db6d83c1f9f1091fcf093bda190e32fa3f3c3be1dea405e0333df6`  
		Last Modified: Mon, 16 Nov 2020 19:49:54 GMT  
		Size: 408.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:657428f2d3868bf3550b5fbb7d0fffffa550c05202a00a079e607df2727159d8`  
		Last Modified: Mon, 16 Nov 2020 19:49:57 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull composer@sha256:e6e5903a6591106c213175bcb45453dfd5848b55f474c0714f891135ca8663da
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.0 MB (57008065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:378a2b0dc5de7f55be32358b6c5a885949bc20ad0b0e1285beb492c01ac6d7dc`
-	Entrypoint: `["\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
# Fri, 06 Nov 2020 02:07:05 GMT
ENV COMPOSER_HOME=/tmp
# Mon, 16 Nov 2020 19:57:27 GMT
ENV COMPOSER_VERSION=2.0.7
# Mon, 16 Nov 2020 19:57:43 GMT
RUN set -eux;   curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/cb19f2aa3aeaa2006c0cd69a7ef011eb31463067/web/installer;   php -r "     \$signature = '48e3236262b34d30969dca3c37281b3b4bbe3221bda826ac6a9a62d6444cdb0dcd0615698a5cbe587c3f0fe57a54d8f5';     \$hash = hash('sha384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {       unlink('/tmp/installer.php');       echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;       exit(1);     }";   php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION};   composer --ansi --version --no-interaction;   rm -f /tmp/installer.php;   find /tmp -type d -exec chmod -v 1777 {} +
# Mon, 16 Nov 2020 19:57:44 GMT
COPY file:fec7a37c0f859c3b5da390e40fa6f3ea8445ed26f54be61f4bce40efcaad57ee in /docker-entrypoint.sh 
# Mon, 16 Nov 2020 19:57:45 GMT
WORKDIR /app
# Mon, 16 Nov 2020 19:57:45 GMT
ENTRYPOINT ["/docker-entrypoint.sh"]
# Mon, 16 Nov 2020 19:57:46 GMT
CMD ["composer"]
```
...
-	Layers:
	...
	-	`sha256:19cba8e3160567c89b9fed9bc15d0265931b7301067957509a413c664595a523`  
		...
		Size: 258.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28c0b2250c7fb988c09c92fa434198ec15474024316ade9d0c16a2126afd297b`  
		Last Modified: Mon, 16 Nov 2020 19:58:04 GMT  
		Size: 552.3 KB (552263 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:110be6c835698ed3dd3a873afbc8664b789e97caa581ca4f850f28171241672f`  
		Last Modified: Mon, 16 Nov 2020 19:58:03 GMT  
		Size: 410.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d729c2ef0bb470de48f7b018342a345a046b4f4c0d657566c86f2f57a8a15d64`  
		Last Modified: Mon, 16 Nov 2020 19:58:04 GMT  
		Size: 126.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `composer:2.0.7` - linux; arm variant v6
...
### `composer:2.0.7` - linux; arm variant v7
...
### `composer:2.0.7` - linux; arm64 variant v8
