...
```console
$ docker pull composer@sha256:5151ce7eb35183d6dde7fdda576e0c492d3d85e9c0a50db6811e87f8441326d6
```
...
```console
$ docker pull composer@sha256:a8cd40dfff02feccb33cf09748a1c9e82dd1eadcfa40cef46fef9f443d2de993
```
