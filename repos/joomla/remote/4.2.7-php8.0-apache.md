...
```console
$ docker pull joomla@sha256:6377f1859523b8d8217674f94b1e97aca8ecd12a6fb660230d8d6d89e0c461df
```
...
### `joomla:4.2.7-php8.0-apache` - linux; amd64
...
### `joomla:4.2.7-php8.0-apache` - linux; arm64 variant v8
...
### `joomla:4.2.7-php8.0-apache` - linux; 386
...
### `joomla:4.2.7-php8.0-apache` - linux; mips64le
...
### `joomla:4.2.7-php8.0-apache` - linux; ppc64le
...
### `joomla:4.2.7-php8.0-apache` - linux; s390x
