...
```console
$ docker pull joomla@sha256:65d52ff91f8a38b9636162a00795ebc482af35b1d54873115c3620a335c70d07
```
...
### `joomla:4.4.0-beta1` - linux; amd64
...
### `joomla:4.4.0-beta1` - linux; arm variant v5
...
### `joomla:4.4.0-beta1` - linux; arm variant v7
...
### `joomla:4.4.0-beta1` - linux; arm64 variant v8
...
### `joomla:4.4.0-beta1` - linux; mips64le
...
### `joomla:4.4.0-beta1` - linux; ppc64le
...
### `joomla:4.4.0-beta1` - linux; s390x

```console
$ docker pull joomla@sha256:e4de6f02ccfb05a18694c621053fd09c4a3f6c57b3fa3c8bb670130a5932e018
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **205.2 MB (205167422 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:aeb059beb812aa3eacabc716bb2882f7bd772212dee980fc5e97dba0f5bdf409`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 20 Sep 2023 14:06:12 GMT
VOLUME [/var/www/html]
# Wed, 20 Sep 2023 14:18:07 GMT
ENV JOOMLA_VERSION=4.4.0-beta1
# Wed, 20 Sep 2023 14:18:07 GMT
ENV JOOMLA_SHA512=0b4b375aa220b0943488213a2f0560d517403e0bc287739b6478f4f3aab65851e50ebf24c12f89a2d1234a31cb238b0bb4031fd0bcf76b83c6ee8ec4024efaed
# Wed, 20 Sep 2023 14:18:15 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0-beta1/Joomla_4.4.0-beta1-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:47e00e3eec9493c7b8d56a5daab65e73682cb58462c16af09b4bdbe50da8b231`  
		...
		Size: 19.2 KB (19155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eae985bdcc24de03cf44415cc73bab32e4f8554b270573606979b71ae963845e`  
		Last Modified: Wed, 20 Sep 2023 14:28:45 GMT  
		Size: 25.1 MB (25087269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3d99c715f08b8a5bbec06be6c9f5612c85fca4c8697984474eed72a6b551adc`  
		Last Modified: Wed, 20 Sep 2023 14:28:42 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b5fbe42f12e699746fd276830ff7f6322d1e11cc242f560f6d6911e3f0da511`  
		Last Modified: Wed, 20 Sep 2023 14:28:42 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
