...
```console
$ docker pull joomla@sha256:00f644a70ec02598f56583cec4ff369dcff63809a4b417928720ef217561d8b2
```
...
```console
$ docker pull joomla@sha256:8089c664bfed88ced176c3461d9ef71c2de445c90616cb4077060d680aad97fc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.9 MB (133868478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc3e5c366215cb598f7360a9ef13c77a56b8ab06680a266bc101cf7b3eb2d8c7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 27 Oct 2020 00:26:19 GMT
CMD ["php-fpm"]
# Tue, 27 Oct 2020 04:54:48 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 27 Oct 2020 04:54:48 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 27 Oct 2020 04:57:17 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 04:57:18 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 04:57:18 GMT
ENV JOOMLA_VERSION=3.9.22
# Tue, 27 Oct 2020 04:57:19 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Tue, 27 Oct 2020 04:57:29 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 27 Oct 2020 04:57:30 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 27 Oct 2020 04:57:31 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 27 Oct 2020 04:57:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 27 Oct 2020 04:57:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1957ddeafbffc51e3d1d436c1384a4c3ffab995309e15c7b903042401a2da690`  
		...
		Size: 8.4 KB (8424 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb6d3fae0b4453b0ef0b3e4226edc0ae253c6635607b112cce4ef4ec167e6e40`  
		Last Modified: Tue, 27 Oct 2020 05:12:32 GMT  
		Size: 3.2 MB (3183986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7794a03facfd0d02b78c8173e458031658b4bff1feee03d27e8b12d9c24dbd70`  
		Last Modified: Tue, 27 Oct 2020 05:12:36 GMT  
		Size: 9.7 MB (9690276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78602248fa2237687f78eacccff4816da5884611740f042fca4ce59f4a237a17`  
		Last Modified: Tue, 27 Oct 2020 05:12:31 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:472e623c49add2f3c9635f463d2d76327c5b349e67daf2ea03ed19ee4c0d4ed9`  
		Last Modified: Tue, 27 Oct 2020 05:12:31 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
