...
```console
$ docker pull joomla@sha256:c249e441e51c6136098a06598199fd79276849967f78f1d3ebd94d0406fe686e
```
...
```console
$ docker pull joomla@sha256:dd29868c8a2029cb872dc52d5438f5b1fd5c768871f54c7d6052bb6ca1b03a34
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **136.4 MB (136394648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9861095fc72beb2af385ef966e97212ab54a7f67de208e46d93fac72b8a5ab65`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 29 Oct 2020 22:39:14 GMT
CMD ["php-fpm"]
# Thu, 29 Oct 2020 23:29:44 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 29 Oct 2020 23:29:45 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 29 Oct 2020 23:33:10 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Oct 2020 23:33:12 GMT
VOLUME [/var/www/html]
# Thu, 29 Oct 2020 23:33:12 GMT
ENV JOOMLA_VERSION=3.9.22
# Thu, 29 Oct 2020 23:33:13 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Thu, 29 Oct 2020 23:33:23 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 29 Oct 2020 23:33:25 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 29 Oct 2020 23:33:25 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 29 Oct 2020 23:33:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 29 Oct 2020 23:33:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c6d1411e6dc4747cc33513f832afdf477301a23814da94c414ec2b28e9dfd46b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2deb47cb0694889265709065ee0a796372d8fd3934738138f8627d8daa94d60`  
		Last Modified: Thu, 29 Oct 2020 23:41:50 GMT  
		Size: 3.3 MB (3278183 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64702e482a5a8c299d4216d6be4993807b395af76870f0278788cdd7b589bbda`  
		Last Modified: Thu, 29 Oct 2020 23:41:55 GMT  
		Size: 9.7 MB (9690264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b7a71385ae66d979fecc9d85fa9f96fbefa75f4d136c6db1f94baa9aebfdc5d`  
		Last Modified: Thu, 29 Oct 2020 23:41:49 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c69f7181a3e6d64fe3531684098fabbdebddf531c227f2a61f8576f660a588e5`  
		Last Modified: Thu, 29 Oct 2020 23:41:49 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:811de3967d061a0bc7d47b61cd3eef74afdacce82cf824121157ab0aac5fda56
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.9 MB (133873733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e6221bb5cc515ad0842be16aa31ed31e5b66f251596223b30e50eaad8c45885`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 29 Oct 2020 23:20:22 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 29 Oct 2020 23:20:23 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 29 Oct 2020 23:23:19 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 29 Oct 2020 23:23:20 GMT
VOLUME [/var/www/html]
# Thu, 29 Oct 2020 23:23:21 GMT
ENV JOOMLA_VERSION=3.9.22
# Thu, 29 Oct 2020 23:23:22 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Thu, 29 Oct 2020 23:23:31 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 29 Oct 2020 23:23:33 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 29 Oct 2020 23:23:33 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 29 Oct 2020 23:23:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 29 Oct 2020 23:23:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a08e1e5db4beb7ab0e4bbdca871bb657806012931029d4496ddde0c4f5b11e35`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:736648bc01f69986df348bf3d3a3e08f19c1695254a1b4fd93725661ac72668b`  
		Last Modified: Thu, 29 Oct 2020 23:39:08 GMT  
		Size: 3.2 MB (3183987 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3e396b07572fcc3f63e57dd38ca2c784ddc4f36b5b996270a046a2b4a6353b9`  
		Last Modified: Thu, 29 Oct 2020 23:39:13 GMT  
		Size: 9.7 MB (9690264 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0b2a8780483e2b051e92aee1291b3f7294b8641c673ae268ec25c7d4bd90b54`  
		Last Modified: Thu, 29 Oct 2020 23:39:07 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:942411bad9328404d134474004a8e2ff4e8d7560f3f309884c39082e2629a04f`  
		Last Modified: Thu, 29 Oct 2020 23:39:07 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c23a6aef7f2590fab2dcab5723a04caa48d99285bd028c4421c00e90a33fd27e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.8 MB (140810733 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:864cb3c5f3bf67b1f959d1d48e94b87c381cbb1384cce51f3f8163bbdc0d4245`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Fri, 30 Oct 2020 00:19:48 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 30 Oct 2020 00:19:49 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 30 Oct 2020 00:19:49 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 30 Oct 2020 00:19:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 30 Oct 2020 00:19:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c4ef58dd0d2a2e1d77bb12a8127afed56afc329f5592d0a16dd187148118c8a9`  
		...
		Size: 8.4 KB (8419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acf36219be38bbe90ae6159d92998f28fffcde543b8f6f2859b5ca318ca97f08`  
		Last Modified: Fri, 30 Oct 2020 00:32:32 GMT  
		Size: 3.4 MB (3391023 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d08396f4593c8c820384c4f8d24572caf977c4dbfaa6ce7878bfa2518e608d8`  
		Last Modified: Fri, 30 Oct 2020 00:32:39 GMT  
		Size: 9.7 MB (9690314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:410fbf8a05069b09fb9b86731b5b6e750c58d6c4808839e0e5e6385a4874b2b8`  
		Last Modified: Fri, 30 Oct 2020 00:32:29 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3811af6d1a0483520f825b41b1cf3cb67a23b0a9ca8a75ab11862efb41aa7ef3`  
...
```console
$ docker pull joomla@sha256:2c65244d2012af84fea687f1e24858d3c126a3d108a3e2089a52742d5ef9ebde
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **143.9 MB (143894022 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d587103cddeaf953c3a863bec1559d1c1a83c887762d56513e77fe4530776ee1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 30 Oct 2020 00:46:34 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 30 Oct 2020 00:46:34 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 30 Oct 2020 00:49:35 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 30 Oct 2020 00:49:37 GMT
VOLUME [/var/www/html]
# Fri, 30 Oct 2020 00:49:37 GMT
ENV JOOMLA_VERSION=3.9.22
# Fri, 30 Oct 2020 00:49:38 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Fri, 30 Oct 2020 00:49:50 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:190eeb7961537decca05061d7e89f77422d361d11da05b86686adf9dd894f08d`  
		...
		Size: 8.4 KB (8419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98c9e0bf15401a4ac025d571a143738df87cd6f591cca9a0f1e85b2389224087`  
		Last Modified: Fri, 30 Oct 2020 01:00:43 GMT  
		Size: 3.4 MB (3417439 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a443d8dddfa8034a3c2b6a83eff4bd51c20f613ca183359106f5d5c1e4b24145`  
		Last Modified: Fri, 30 Oct 2020 01:00:44 GMT  
		Size: 9.7 MB (9690269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5e6a624b67403da5b06187eacc3342b6518f7365b168972e535c377a2294ba9`  
		Last Modified: Fri, 30 Oct 2020 01:00:42 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfec2b14ea7cb79d62b9ae79d792d29cdb8d7c170c8ec90bbb2f78e96ed54b72`  
		Last Modified: Fri, 30 Oct 2020 01:00:42 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
