...
### `joomla:5.4.beta-php8.3-apache` - linux; amd64
...
### `joomla:5.4.beta-php8.3-apache` - unknown; unknown
...
### `joomla:5.4.beta-php8.3-apache` - linux; arm variant v5
...
### `joomla:5.4.beta-php8.3-apache` - linux; arm variant v7
...
### `joomla:5.4.beta-php8.3-apache` - linux; arm64 variant v8
...
### `joomla:5.4.beta-php8.3-apache` - linux; 386
...
### `joomla:5.4.beta-php8.3-apache` - linux; ppc64le
...
### `joomla:5.4.beta-php8.3-apache` - linux; riscv64
...
### `joomla:5.4.beta-php8.3-apache` - linux; s390x
