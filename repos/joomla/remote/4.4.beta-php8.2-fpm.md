...
### `joomla:4.4.beta-php8.2-fpm` - linux; arm variant v5
...
### `joomla:4.4.beta-php8.2-fpm` - linux; arm variant v7
...
### `joomla:4.4.beta-php8.2-fpm` - linux; mips64le
...
### `joomla:4.4.beta-php8.2-fpm` - linux; ppc64le
