...
### `joomla:6.0.0-alpha3-apache` - linux; amd64
...
### `joomla:6.0.0-alpha3-apache` - unknown; unknown
...
### `joomla:6.0.0-alpha3-apache` - linux; arm variant v5
...
### `joomla:6.0.0-alpha3-apache` - linux; arm variant v7
...
### `joomla:6.0.0-alpha3-apache` - linux; arm64 variant v8
...
### `joomla:6.0.0-alpha3-apache` - linux; 386
...
### `joomla:6.0.0-alpha3-apache` - linux; mips64le
...
### `joomla:6.0.0-alpha3-apache` - linux; ppc64le
...
### `joomla:6.0.0-alpha3-apache` - linux; s390x
