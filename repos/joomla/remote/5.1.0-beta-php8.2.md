...
```console
$ docker pull joomla@sha256:1675100bba1c841106c6c72375f01335b9ec79e630706df23fe6641ce5c52a9f
```
...
```console
$ docker pull joomla@sha256:f9a089d33c8d651a83923f1c9b381b03e8bf9c2c20d27e772a0cc3aaf3d4d654
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.2 MB (235210914 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18156c4fc7eb046d40ab542418f4c1291cb41ff4d20271320681045bc8abe4cf`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Tue, 09 Apr 2024 09:35:41 GMT
ENV JOOMLA_VERSION=5.1.0-beta2
# Tue, 09 Apr 2024 09:35:45 GMT
ENV JOOMLA_SHA512=8f4f81c9147270c6f7a2373c96716c90272f12e7c8679166517eb84990e3c7724b1d3657c3f8eee1a46094a4d950830048afdd17dae516be8dac5fd7be1cba65
# Tue, 09 Apr 2024 09:36:18 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0-beta2/Joomla_5.1.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 09 Apr 2024 09:36:26 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 09 Apr 2024 09:36:33 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 09 Apr 2024 09:36:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 09:36:47 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d7e7f12f88ff8d0981b2e146e17ccafc5aedb75ed1c305400e55dada1a6a2671`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6ddcef91fbd4b2783ccbdd8a9a5b2143eb75ea2074b94ba12d281895ddf91d3`  
		Last Modified: Tue, 09 Apr 2024 11:02:02 GMT  
		Size: 23.7 MB (23652841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb2635cdf24b0d975fa7da36f43f592121566cd1a7858628646dbd73e1dda4b1`  
		Last Modified: Tue, 09 Apr 2024 11:01:24 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26641a223d4f8a33fe90851ea39b6fb8cc44be53310bd9ecf979b4c4558f399c`  
		Last Modified: Tue, 09 Apr 2024 11:01:24 GMT  
