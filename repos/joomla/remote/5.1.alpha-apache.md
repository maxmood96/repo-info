...
```console
$ docker pull joomla@sha256:486438723a3b34a4e9e7741554adb5e82102a3478d6714dbba57a1178aaddcff
```
...
### `joomla:5.1.alpha-apache` - linux; amd64
...
### `joomla:5.1.alpha-apache` - linux; arm variant v5
...
### `joomla:5.1.alpha-apache` - linux; arm variant v7
...
### `joomla:5.1.alpha-apache` - linux; arm64 variant v8
...
### `joomla:5.1.alpha-apache` - linux; 386
...
### `joomla:5.1.alpha-apache` - linux; mips64le
...
### `joomla:5.1.alpha-apache` - linux; ppc64le
...
### `joomla:5.1.alpha-apache` - linux; s390x
