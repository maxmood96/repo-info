...
```console
$ docker pull joomla@sha256:dc251fed5e19f09a26c7bc72f32e5b42af8d3f186ecaf141d94eac1f2b5a7e97
```
...
### `joomla:5.1.0-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.1.0-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.1.0-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.0-php8.2-fpm` - linux; 386
...
### `joomla:5.1.0-php8.2-fpm` - linux; mips64le
...
### `joomla:5.1.0-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.1.0-php8.2-fpm` - linux; s390x
