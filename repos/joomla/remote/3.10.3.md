...
```console
$ docker pull joomla@sha256:3ccb552b22eccc28698cf9b33821c434ee5a027fad7f913068e18cac8c6dc7fa
```
...
```console
$ docker pull joomla@sha256:a3b0e39a0f7428b2a56854b6437e4dbe55bc21dd8bd75f8a2ac87ce1b7c034df
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **157.2 MB (157231534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:df51610787dc3a19d5309ee21be5df7b240cfe7a0d03279b3ff915727934f852`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 17 Nov 2021 13:18:27 GMT
CMD ["apache2-foreground"]
# Thu, 18 Nov 2021 23:29:18 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 18 Nov 2021 23:29:18 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 18 Nov 2021 23:29:20 GMT
RUN a2enmod rewrite
# Fri, 19 Nov 2021 00:10:09 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 19 Nov 2021 00:10:09 GMT
VOLUME [/var/www/html]
# Fri, 19 Nov 2021 00:10:09 GMT
ENV JOOMLA_VERSION=3.10.3
# Fri, 19 Nov 2021 00:10:10 GMT
ENV JOOMLA_SHA512=1843595b67ee594038418efb570d2bac2e92b0f1907ead6c6d8c4cf1a547d93181358be458ce6d0a7879b9bb9d6d0f683b0f5507e345be5ee24c993bed614fe5
# Fri, 19 Nov 2021 00:10:24 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 19 Nov 2021 00:10:26 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 19 Nov 2021 00:10:26 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 19 Nov 2021 00:10:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 19 Nov 2021 00:10:27 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:44a5f58d7afd76899d7d6058f539530b7dd9ab7ed43001ca794fcebba84c838a`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07ca81a88be151f03e1dc77358e62049f3a0deea21b64e7cb9e01505e463ddd2`  
		Last Modified: Fri, 19 Nov 2021 00:16:21 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e366dfd10c2ccc22fae79f361bdd7005465791e9e69a25466d64cff6527e9d4`  
		Last Modified: Fri, 19 Nov 2021 00:20:20 GMT  
		Size: 2.8 MB (2847433 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:75c9207ca7400dea3cad1d644ba4a3c64ce6e05841bcd4e83960c5373701f877`  
		Last Modified: Fri, 19 Nov 2021 00:20:27 GMT  
		Size: 9.7 MB (9680680 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df63cf833a111bc97af8549b6990b1567fddc806c1b8d6ec00cd5e62ade68a89`  
		Last Modified: Fri, 19 Nov 2021 00:20:17 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cfd53415d96b59cbee905d4dc07375a048bbf86f96e554f6c4dfb02c7e1a606b`  
		Last Modified: Fri, 19 Nov 2021 00:20:17 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
