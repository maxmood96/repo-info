...
### `joomla:5.1.0-alpha` - linux; amd64
...
### `joomla:5.1.0-alpha` - linux; arm variant v5
...
### `joomla:5.1.0-alpha` - linux; arm variant v7
...
### `joomla:5.1.0-alpha` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha` - linux; mips64le
...
### `joomla:5.1.0-alpha` - linux; ppc64le
...
### `joomla:5.1.0-alpha` - linux; s390x
