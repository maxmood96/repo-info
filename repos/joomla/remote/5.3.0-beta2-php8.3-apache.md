...
```console
$ docker pull joomla@sha256:d5244b8f34110381cabcef4fe1c5a353f68103cef7b606bc556fa0caba04f59f
```
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; amd64
...
### `joomla:5.3.0-beta2-php8.3-apache` - unknown; unknown
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; arm variant v5
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; arm variant v7
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; arm64 variant v8
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; ppc64le
...
### `joomla:5.3.0-beta2-php8.3-apache` - linux; s390x
