...
```console
$ docker pull joomla@sha256:babccd6f38bb2fca9e829ea79b2205b6389ae54ff715d9b1c426fac8b297a543
```
...
### `joomla:5.3.beta` - unknown; unknown
...
### `joomla:5.3.beta` - linux; arm variant v5
...
### `joomla:5.3.beta` - linux; arm variant v7
...
### `joomla:5.3.beta` - linux; arm64 variant v8
...
### `joomla:5.3.beta` - linux; mips64le
