...
```console
$ docker pull joomla@sha256:d9277fdd567a9875c82537150ff8acaaa25e0a973ae763fb364de932538dcfe8
```
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; amd64
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; arm variant v5

```console
$ docker pull joomla@sha256:1ea5acfe9e37ac6ee9230ca94e715d31db8905f0576c3245a005ffb10225c5eb
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.0 MB (226016732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d15dc6be43724da299dbf8560950cbc7534ceff64410c077e769c1dbb1f78b9e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 13 Aug 2024 04:44:45 GMT
VOLUME [/var/www/html]
# Wed, 21 Aug 2024 20:56:30 GMT
ENV JOOMLA_VERSION=5.2.0-beta1
# Wed, 21 Aug 2024 20:56:30 GMT
ENV JOOMLA_SHA512=ba0a8a84acd1c603766dbd8ca08e6aeb84c223b762fb73a98385357ba959eaaa27eb798a1b73ed082941163da110e84c103be5a94c0c48f32248cd795e00e8a7
# Wed, 21 Aug 2024 20:56:34 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Aug 2024 20:56:36 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Wed, 21 Aug 2024 20:56:36 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Wed, 21 Aug 2024 20:56:36 GMT
...
-	Layers:
	...
	-	`sha256:7e8b25ce63e55e84da3e55777bd49f051f5875a8ce529ede74cdfc3d73aa0c5b`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dde5061869b87600429fb58ee571594decf0ebd92823a6c15c48a7d3d9e232d3`  
		Last Modified: Wed, 21 Aug 2024 21:01:00 GMT  
		Size: 23.4 MB (23365820 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8676a571714c7946849c8718d298473c3f3a061ef970e590188c9004f0bec7e`  
		Last Modified: Wed, 21 Aug 2024 21:00:56 GMT  
		Size: 3.7 KB (3654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e72e87c65130f4ed1723ac9525904fea0a5627c25ea8ae2f12970c700b1c2219`  
		Last Modified: Wed, 21 Aug 2024 21:00:56 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:5.2.0-beta1-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; 386
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; mips64le
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.2.0-beta1-php8.2-fpm` - linux; s390x
