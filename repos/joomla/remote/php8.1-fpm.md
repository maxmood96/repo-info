...
```console
$ docker pull joomla@sha256:b9e1829499a26d2cb4120509e9cb55ed1bbfb025766d4ae91e02ef8363f224cf
```
...
```console
$ docker pull joomla@sha256:cf4576eaad22efe7c16cccbeb58dd76a54dc5dcd5168d67f3fc3c62fb9192e5d
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.3 MB (192291947 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a78651496bd5c819c83d175155e1f847bc6c40de9a51a7e17d0e5ab33eb9b701`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 26 Oct 2022 14:41:13 GMT
ENV JOOMLA_VERSION=4.2.2
# Wed, 26 Oct 2022 14:41:17 GMT
ENV JOOMLA_SHA512=388e91bacee7ff1e07d7fc02df9fb8b5728f960fb4eb8f75679891b029d27ecb7f692b420259bae107e212ca88cecc4804ae0f61a1e771c7b6dd0208cdb04d7b
# Wed, 26 Oct 2022 14:41:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.2/Joomla_4.2.2-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 26 Oct 2022 14:41:58 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 26 Oct 2022 14:42:03 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 26 Oct 2022 14:42:09 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 26 Oct 2022 14:42:16 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ac0b54e7a6bc510e6379d53d74f5b4d5df5e636cefea8d8b897f45a757d03b09`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8b6167dec5721c6554304bf75768ebe26970ab658869e1710f9409d441d6df68`  
		Last Modified: Wed, 26 Oct 2022 15:11:59 GMT  
		Size: 23.7 MB (23701633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a0fda67f5115629e0b9a04c86fda8709d4699b33d1daf3dd8aee3d79070c143`  
		Last Modified: Wed, 26 Oct 2022 15:11:38 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2416e02ec9ffed4d1bbbeb1cf747593160e99590391ddf57c81f68ac1f0200b`  
		Last Modified: Wed, 26 Oct 2022 15:11:38 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
