...
```console
$ docker pull joomla@sha256:7c04c0a15da33928aa2cf4f1d031a040b1952a721a3d81a0bf6709efce8f2dbb
```
...
```console
$ docker pull joomla@sha256:de4f07dc4e60b9134bfaad62e3c4b775f2d12ece301dad5ecc66cbb026eff633
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.3 MB (201252690 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76216124b3b6973d85fd2dbcefc29912c030a2f3090fe6dbe32744a188088136`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull joomla@sha256:e0fcdda0b32449cecf5f602a00782dd08162ff29e0e8d59075cc7a976dec4770
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.1 MB (227070145 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7d75e4d73d6fd70e817b490486f05a2f10cdf2c777b937a01236740953e7904b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 04 Oct 2023 22:58:42 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Wed, 04 Oct 2023 22:58:42 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 04 Oct 2023 22:58:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 04 Oct 2023 22:58:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ce614b8875c09df9e508034649beb0a0c2526882e46fe727a1ba9e5bd09e4e21`  
		...
		Size: 25.1 MB (25051735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07ba6b0f5349979da65b3d885cbaff240479014c205847ec9a9b5b13cec5debe`  
		Last Modified: Wed, 04 Oct 2023 23:09:17 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae74310e6b18f642f104128e4e9fee52ecb49cf410bf84fbd8bab4d5e11b4488`  
		Last Modified: Wed, 04 Oct 2023 23:09:17 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
