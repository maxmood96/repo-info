...
```console
$ docker pull joomla@sha256:9438026ff2ff80f28bd2544481a5bc1d0e16cc4a6304d27f5b19575abbdbf088
```
...
```console
$ docker pull joomla@sha256:3ddee312ab48564d02d4cf95eb07b461c190c7446de6c578c1010dfc998bbabe
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **179.6 MB (179570194 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:71163179322edc87621e12264213dbce37584058ab219a41a7b064210c249559`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 14 May 2022 01:46:52 GMT
VOLUME [/var/www/html]
# Fri, 27 May 2022 21:42:35 GMT
ENV JOOMLA_VERSION=4.1.4
# Fri, 27 May 2022 21:42:35 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Fri, 27 May 2022 21:42:42 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 27 May 2022 21:42:43 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 27 May 2022 21:42:44 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 27 May 2022 21:42:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
...
-	Layers:
	...
	-	`sha256:38f16ec504089053728378bb43a49e0aa29e12f63e6b546118a4d4e1e64cdb0e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b48237de831605c225342a6c8b8821928ab9793905a39051297579c07bf326a9`  
		Last Modified: Fri, 27 May 2022 21:48:57 GMT  
		Size: 22.1 MB (22072979 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61bc5772e1ea9cd8f12567592774e05ee1a79fa3837e37d4834f375a8deaf9ed`  
		Last Modified: Fri, 27 May 2022 21:48:53 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89ee6449ecc0be14f8acb2b740fe1128bdf05e9165ce3ef6d0423e35490283ea`  
		Last Modified: Fri, 27 May 2022 21:48:53 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:4e9f3bdffa946ae2af0106675acd0341ba13c8fdf4eb9670963c5e43de434ee1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.2 MB (188187249 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6205be408de650e0e6fe6c28c763e37cbfb0e78c472d5de220b21a17411d9f2b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 27 May 2022 21:41:19 GMT
ENV JOOMLA_VERSION=4.1.4
# Fri, 27 May 2022 21:41:19 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Fri, 27 May 2022 21:41:26 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 27 May 2022 21:41:28 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 27 May 2022 21:41:29 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 27 May 2022 21:41:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 27 May 2022 21:41:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:340d4005e1dc326c88c5e7933a9d4610e8d33d8530a52dd84865e4f5dd0275b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5249ddd3a9097de4e0eed7e9f1bd566da9dc164f40510afe87c6e3657596a1b8`  
		Last Modified: Fri, 27 May 2022 21:47:58 GMT  
		Size: 22.1 MB (22072979 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4a93b7035b696f409179ab3ebfa234f7cee715e48c8a4de85737e0bdd775ce`  
		Last Modified: Fri, 27 May 2022 21:47:54 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:789fbec18c8135dfac367dc5747986dba0a729598f0257432a0a0115316dcefc`  
		Last Modified: Fri, 27 May 2022 21:47:54 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
