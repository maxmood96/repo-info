...
```console
$ docker pull joomla@sha256:3a33a72e5351e29ba46872597fdd5f3d64b75a071701be3be4ae350238c4649c
```
...
```console
$ docker pull joomla@sha256:00baa1b83a342a35ee14c70792d28bc91376a98f57b5e24729045f8ab61bf7f0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.4 MB (188368451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1a318be2466ee50fe955e1aa47af023ad54827b5b93837ebb9af55de8a3f83f1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 24 Mar 2022 10:08:41 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 24 Mar 2022 10:08:41 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 24 Mar 2022 10:10:06 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 24 Mar 2022 10:10:06 GMT
VOLUME [/var/www/html]
# Thu, 24 Mar 2022 10:10:07 GMT
ENV JOOMLA_VERSION=4.1.0
# Thu, 24 Mar 2022 10:10:08 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Thu, 24 Mar 2022 10:10:16 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 24 Mar 2022 10:10:18 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Thu, 24 Mar 2022 10:10:19 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 24 Mar 2022 10:10:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 24 Mar 2022 10:10:20 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8a7ad2c00df654c962cbcc98996793a485b18b5dc24525cafabc7ffae550d30a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6315de6b0fb8abbe2f60a60764f3838f28f9f7ceeee4f081fdd84ca73dccd150`  
		Last Modified: Thu, 24 Mar 2022 10:26:27 GMT  
		Size: 2.9 MB (2907322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0548758fe80a9c0eb27cff53459795b046b05ab95b1a8cbb05d64b9c05ea246a`  
		Last Modified: Thu, 24 Mar 2022 10:26:30 GMT  
		Size: 22.3 MB (22282366 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cd18f6d71a554caa5f97d5bb9c286015c3b781045f128417f4c2b88f865dd5e`  
		Last Modified: Thu, 24 Mar 2022 10:26:26 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5020c9b928537c7640ed78447a52a11211d122137f6f5f8f04a6eacc22f0cff`  
		Last Modified: Thu, 24 Mar 2022 10:26:26 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:423019bdf31e177df57e138ebec1911c3f3f2235777a8ea6cff0fb04f42c0697
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.8 MB (186767489 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5045b2d89a53fb601fbecc24630796f599bc8f086120cc951cc1e189b6f57b3b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sun, 20 Mar 2022 06:42:08 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Sun, 20 Mar 2022 06:42:12 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sun, 20 Mar 2022 06:45:19 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sun, 20 Mar 2022 06:45:22 GMT
VOLUME [/var/www/html]
# Sun, 20 Mar 2022 06:45:27 GMT
ENV JOOMLA_VERSION=4.1.0
# Sun, 20 Mar 2022 06:45:31 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Sun, 20 Mar 2022 06:45:54 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sun, 20 Mar 2022 06:45:58 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Sun, 20 Mar 2022 06:46:01 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sun, 20 Mar 2022 06:46:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 20 Mar 2022 06:46:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e61941c89d1e780c23b8e48276d242334ee13a706712006a0042b1239ea29211`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fdd2f0fc78e78d3dcb8a15a6e932cbfd349b6b4b66ce2afcd2fd001bee432879`  
		Last Modified: Sun, 20 Mar 2022 09:00:11 GMT  
		Size: 3.3 MB (3311479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c091758ac06b072550d166304bf4c831aa2bf50e6d969b2c3faf913a6182a87d`  
		Last Modified: Sun, 20 Mar 2022 09:00:14 GMT  
		Size: 22.3 MB (22285204 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8beef2d4e2b3278ff7ce898aaa8cd7aa761538274b2be9532b14b13edd9d68fe`  
		Last Modified: Sun, 20 Mar 2022 09:00:10 GMT  
		Size: 1.8 KB (1825 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a695077a8e98fddd80e67fc75002c516a8ba560b6b7088c62870b370df46405`  
		Last Modified: Sun, 20 Mar 2022 09:00:10 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
