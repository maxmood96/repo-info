...
```console
$ docker pull joomla@sha256:1d1e62ab60c2f8e43eda2c98679c26fd6310bb8027594dbaf9cf5f910a0bc340
```
...
### `joomla:4.4.10-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.10-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.10-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.10-php8.1-fpm-alpine` - linux; ppc64le
...
### `joomla:4.4.10-php8.1-fpm-alpine` - linux; s390x
