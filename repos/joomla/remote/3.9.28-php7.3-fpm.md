...
### `joomla:3.9.28-php7.3-fpm` - linux; amd64
...
### `joomla:3.9.28-php7.3-fpm` - linux; arm variant v5
...
### `joomla:3.9.28-php7.3-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.28-php7.3-fpm` - linux; mips64le
...
### `joomla:3.9.28-php7.3-fpm` - linux; s390x
