...
```console
$ docker pull joomla@sha256:4cad4bfbcc1562e9bab5f07e573fba0d179e1cd96111a68c85ed650944eda875
```
...
```console
$ docker pull joomla@sha256:bd63e602750539af0fe57ba98fb4dcf5af6bcedd1fd03ee0dd6a5453cc923ae3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.2 MB (90245077 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b5c98593d668ce748d9e69bda055f31be3e27e2f151a9db2b721348f48779ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Aug 2024 04:15:25 GMT
ENV JOOMLA_VERSION=5.2.0-beta1
# Sat, 31 Aug 2024 04:15:26 GMT
ENV JOOMLA_SHA512=ba0a8a84acd1c603766dbd8ca08e6aeb84c223b762fb73a98385357ba959eaaa27eb798a1b73ed082941163da110e84c103be5a94c0c48f32248cd795e00e8a7
# Sat, 31 Aug 2024 04:15:57 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 31 Aug 2024 04:16:02 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 31 Aug 2024 04:16:03 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 31 Aug 2024 04:16:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 31 Aug 2024 04:16:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:beda41b59fcefb8f497e83ac7156db13c4c69eb3e63df97ec35f27713dc6571d`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e17bdfb80f1e99dd47e1acbb82bc4f5ea66daa172d0df6d8887b2faa09712bad`  
		Last Modified: Sat, 31 Aug 2024 04:46:02 GMT  
		Size: 23.4 MB (23365903 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f540d3fb2e131a3dae8447c79b8fdc20d43f13da821a13bf413612310c7a391`  
		Last Modified: Sat, 31 Aug 2024 04:45:30 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6592c0ae94b37b3c2012cf6d2cf387b781f75bba475a80de104b298c2502b23`  
		Last Modified: Sat, 31 Aug 2024 04:45:30 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
