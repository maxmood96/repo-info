...
```console
$ docker pull joomla@sha256:ac3e27e420f79d8bacc02c53c80229416832a67bcc982f8d8bf9b4ac46aa74f4
```
...
```console
$ docker pull joomla@sha256:9516bfa496dc633905cedec4ada7e8c5ed4575a41b67d1da2b7c0e66e73a1f2e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.5 MB (100508685 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a31c1f095375ecf73f78588a9c5d11166305e7118144bcabc0856f414c56cace`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:5ef7dfb00e72ff2964a658a3a9fc3be7f6b7c810655f962d248f5fa61595e08b`  
		...
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6050aa082655557e88b2c905fc89166ebc2a2752dab31e8be50093c85ab0fd60`  
		Last Modified: Wed, 12 Jul 2023 18:53:04 GMT  
...
```console
$ docker pull joomla@sha256:31ec826ff294b0f3485e5fc113d19cdce6c1dda021b8e85fcbd5196c24897b8d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.2 MB (97247779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:136a112c329f408badec05a7a556ab246fd007ace3e7fb89def90c5930916409`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 08 Aug 2023 01:02:12 GMT
CMD ["php-fpm"]
# Tue, 08 Aug 2023 05:27:36 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 08 Aug 2023 05:27:36 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 08 Aug 2023 05:27:44 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Tue, 08 Aug 2023 05:29:48 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 08 Aug 2023 05:29:49 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 08 Aug 2023 05:29:49 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 08 Aug 2023 05:29:49 GMT
VOLUME [/var/www/html]
# Tue, 08 Aug 2023 05:30:31 GMT
ENV JOOMLA_VERSION=4.3.3
# Tue, 08 Aug 2023 05:30:31 GMT
ENV JOOMLA_SHA512=348dfe8a9baed29b2d75cef2462f0b39c93fc556b1de015a5a3ed5eb1552d6de8d4d0422abf179269120986c8c125e70b1aedb10874c8f535f7d4914f5a98044
# Tue, 08 Aug 2023 05:30:39 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.3/Joomla_4.3.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 08 Aug 2023 05:30:39 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Tue, 08 Aug 2023 05:30:39 GMT
...
-	Layers:
	...
	-	`sha256:278aceea56e7654784f3d50bd7ce907890d1015976fc20f4748a6af30a638092`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afb7dd7b52aed47acc9f10adb840f5b3ecc19171e663146a4ffdb18f5400690b`  
		Last Modified: Tue, 08 Aug 2023 05:35:35 GMT  
		Size: 41.1 MB (41144276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:388d5d34881a1221db248caa249657c3581ed4ded0338c083d30ade9d7130529`  
		Last Modified: Tue, 08 Aug 2023 05:35:29 GMT  
		Size: 5.9 MB (5939218 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f775cd71513c0a01bedda756029602bc4f50f77d0bf8fe2a4dac11e106be482`  
		Last Modified: Tue, 08 Aug 2023 05:35:26 GMT  
		Size: 67.4 KB (67399 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5c08f8af956efd0b755846e2edd8c3a44340181bf4c05336a67affe67c3414a`  
		Last Modified: Tue, 08 Aug 2023 05:35:26 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c43b531bc8afddbd40474ba9bd404263977bdc438f1595934e334919805757a8`  
		Last Modified: Tue, 08 Aug 2023 05:36:50 GMT  
		Size: 24.9 MB (24863201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f5e3c9ca4ad598b58ceb4712debf6cf072a837155b4c68b46e873c55a64bf93`  
		Last Modified: Tue, 08 Aug 2023 05:36:45 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d83225345684b4a1e6d2ae04b02b84977457e91d9f8e5f3e013567428864b60a`  
		Last Modified: Tue, 08 Aug 2023 05:36:45 GMT  
...
```console
$ docker pull joomla@sha256:da9304b4e82069d9c954511f38cbca3ea9403b1a197481cbdb1f232499ec50b6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.8 MB (105757242 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5de9eacb542ff0a0cb8c1a55ea448fb83b9ef8f342736236ccfa7a1378eb838`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 15 Jun 2023 11:47:34 GMT
VOLUME [/var/www/html]
# Wed, 12 Jul 2023 18:41:30 GMT
ENV JOOMLA_VERSION=4.3.3
# Wed, 12 Jul 2023 18:41:31 GMT
ENV JOOMLA_SHA512=348dfe8a9baed29b2d75cef2462f0b39c93fc556b1de015a5a3ed5eb1552d6de8d4d0422abf179269120986c8c125e70b1aedb10874c8f535f7d4914f5a98044
# Wed, 12 Jul 2023 18:41:39 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.3/Joomla_4.3.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:9cb93d1db94a09461e413cdfe4508d7eebb68d5af1e9b476c16b25e419ad29ec`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd5727aeeabcb9536ce24bfbf05256ad39284b05d77d7c8232e0707225bb9c34`  
		Last Modified: Wed, 12 Jul 2023 18:52:15 GMT  
		Size: 24.9 MB (24863184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62cdebf8e0cdde044d490d7c4913e7476397d322abef947e6e1e5b22ee8b69a0`  
		Last Modified: Wed, 12 Jul 2023 18:52:09 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f3d46ac2fbc91ac9a288bda30e4d273c1b164333683c2cc943b562f6f79cf51`  
		Last Modified: Wed, 12 Jul 2023 18:52:09 GMT  
