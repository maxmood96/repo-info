...
```console
$ docker pull joomla@sha256:9c2a6e50026ee8b0a1873192bb9db05453513704af52bdbfabc43bca9292a907
```
...
### `joomla:5.1.alpha-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.1.alpha-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.1.alpha-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.alpha-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.1.alpha-php8.2-fpm` - linux; s390x
