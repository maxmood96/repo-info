...
```console
$ docker pull joomla@sha256:36ea1af1c2c9c4b13b1110d801fe9da8713d1e007466553359492deaad8e0bac
```
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; 386
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; riscv64
...
### `joomla:4.4.7-php8.1-fpm-alpine` - linux; s390x
