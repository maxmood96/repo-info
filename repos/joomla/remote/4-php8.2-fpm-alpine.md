...
```console
$ docker pull joomla@sha256:83e10ebaa57e4755e170dc7bf03836fa294b40031acc2a7941b5ef8601084572
```
...
```console
$ docker pull joomla@sha256:0a4c035185234f7ed6052519793e36aa4ec8dfacd1aa99d2ecf84c9fea5659bc
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.4 MB (87401922 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c034936f5203bdb78c6b10b1766e54f84e6957de58ed75df5d6d7306cf5f330f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.5/Joomla_4.4.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:41:30 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:41:30 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:41:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Jun 2024 20:41:31 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6a4d4c37759a336e41b10c6d9d875b4089a264d51629496d5cd701ba27daaca1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66702af65828ce8e3d6392d00da6fb810c0db9d29722526b84eebca64ea3462c`  
		Last Modified: Fri, 14 Jun 2024 20:45:52 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:122ec556174217b7633d33a45730d5029379a63f789b99c27a24787443241f69`  
		Last Modified: Fri, 14 Jun 2024 20:45:52 GMT  
...
```console
$ docker pull joomla@sha256:15fe562f084975d887064cee9e42920ea08d78be536a9af08600e4f786ca7de9
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.0 MB (92954824 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60d7964f4a6fa75d4132c61c6af6e281fe36e4630cb6cbb43f2bfcbe507e4549`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 06 Jun 2024 22:08:42 GMT
CMD ["php-fpm"]
# Fri, 07 Jun 2024 00:53:50 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 07 Jun 2024 00:53:50 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 07 Jun 2024 01:24:08 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 07 Jun 2024 01:27:03 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	curl -fL -o imagick.tgz 'https://pecl.php.net/get/imagick-3.7.0.tgz'; 	echo '5a364354109029d224bcbb2e82e15b248be9b641227f45e63425c06531792d3e *imagick.tgz' | sha256sum -c -; 	tar --extract --directory /tmp --file imagick.tgz imagick-3.7.0; 	grep '^//#endif$' /tmp/imagick-3.7.0/Imagick.stub.php; 	test "$(grep -c '^//#endif$' /tmp/imagick-3.7.0/Imagick.stub.php)" = '1'; 	sed -i -e 's!^//#endif$!#endif!' /tmp/imagick-3.7.0/Imagick.stub.php; 	grep '^//#endif$' /tmp/imagick-3.7.0/Imagick.stub.php && exit 1 || :; 	docker-php-ext-install /tmp/imagick-3.7.0; 	rm -rf imagick.tgz /tmp/imagick-3.7.0; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Fri, 07 Jun 2024 01:27:04 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 07 Jun 2024 01:27:05 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 07 Jun 2024 01:27:05 GMT
VOLUME [/var/www/html]
# Fri, 07 Jun 2024 01:27:05 GMT
...
# Fri, 07 Jun 2024 01:27:05 GMT
ENV JOOMLA_SHA512=3bf2067d1f6faa8f36e023bcec2fc0fe1f307209feceb159f1bbe5f5618d9eede06bc23cc7610a7350c48d25d835280d81c1530a92e24f8fb989845fdbf39084
# Fri, 07 Jun 2024 01:27:14 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.5/Joomla_4.4.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:41:14 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:41:14 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:41:14 GMT
...
-	Layers:
	...
	-	`sha256:544210d3284a1ed0478f4f0be1e4b667d2e8d7343c7991ee4a0c13bba157162e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a359722a8ff31c3b8e93b738364b924cc6ba2a5e09ce99081d99f697325030d2`  
		Last Modified: Fri, 07 Jun 2024 01:37:53 GMT  
		Size: 28.5 MB (28532996 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df77599edfcb7e144380f646de0c1a6dd329938804d541a7ca7ca7bffb4a56cd`  
		Last Modified: Fri, 07 Jun 2024 01:37:48 GMT  
		Size: 6.5 MB (6544828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22e4176cb5730483f7ce9be0948e153764c37a56ebd60d73e2fcc3535c33a4f1`  
		Last Modified: Fri, 07 Jun 2024 01:37:44 GMT  
		Size: 61.5 KB (61462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e428777b967155401802f92e7b1817b1e970211f994b004109a1851f86042a`  
		Last Modified: Fri, 07 Jun 2024 01:37:44 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6fc7cc8e90c7b7fa3fc1aa7ba9788d7df27567a3685080ec25bebd33ecbd3c55`  
		Last Modified: Fri, 07 Jun 2024 01:37:51 GMT  
		Size: 25.7 MB (25657884 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28f5126b72ddfe9a78fe92c0a2ce9e13529ccb5ac9e679533f0669cf658086a2`  
		Last Modified: Fri, 14 Jun 2024 20:45:44 GMT  
		Size: 3.7 KB (3658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24a45bb57099939c2eee5cb9fd79442c3616dd8c2b3db1cb4af0342310eb8d1a`  
		Last Modified: Fri, 14 Jun 2024 20:45:43 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ae1fa46ba77b9119f4978f3fec6c777b498d267e74cc1304268fda849e394486
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.7 MB (93720035 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:05fa107c2df3da7c2c10d1aed87e9780fc4ea2bb1a1a0d39ab4501003f768df5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.5/Joomla_4.4.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:51:11 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:51:11 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:51:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Jun 2024 20:51:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a042c8a7da10f1759902caf7a01b8a7fbbdc22fd17d62653e859c5353252fbd7`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:65c15cff918306395ed0841c9628ee60a5e50ea7b8983b0181b61b73f1c9a2b4`  
		Last Modified: Fri, 14 Jun 2024 20:55:35 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fbd2b98ce26c441455107dda4e34a474ab49e48cbd0c6c234f4065f2af45843`  
		Last Modified: Fri, 14 Jun 2024 20:55:35 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:68da33d90983bb8dbd74007d195b673952989aa2a4815b418975127bbf1b797b
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.9 MB (93911114 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d27555617dac0d8a360552cbe52e640722ef698b8ae32d861aa7c1d10e676129`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:fef204e7dbb003ca54587b11f88da1ac044acbf2963bd1f680514c547d49c324`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5b94f0476a401e52beb273786f1cc7e5d16fca651c7dd9600b595321b615a5dd`  
		Last Modified: Fri, 07 Jun 2024 08:19:10 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b829b721d57ae7e46a94d55cf246eaf5bcda3413747c0c8a1a91034d2f3076ee`  
		Last Modified: Fri, 07 Jun 2024 08:19:10 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
