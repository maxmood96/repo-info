...
```console
$ docker pull joomla@sha256:8b77eab966870bc966d5fe549b906b6d12ae80594772809635f5f51a2b31d967
```
...
```console
$ docker pull joomla@sha256:1ac889a7127b592376a4947b69989f28dc8112373dfda285809ef9522aad95f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.6 MB (92619143 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4ae26d2c0b45522b8213d550df30ed0f3d7c617fe604fe5a69fa9903a573a86`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Apr 2024 22:46:15 GMT
VOLUME [/var/www/html]
# Tue, 16 Apr 2024 22:50:04 GMT
ENV JOOMLA_VERSION=4.4.4
# Tue, 16 Apr 2024 22:50:04 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Tue, 16 Apr 2024 22:50:11 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 16 Apr 2024 22:50:11 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 16 Apr 2024 22:50:12 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 16 Apr 2024 22:50:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 16 Apr 2024 22:50:12 GMT
...
-	Layers:
	...
	-	`sha256:efed48ff7943bb18f917a809e69165d7692b59104171cf2fe6d6acd6acc349ff`  
		...
		Size: 387.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5029c85f71fac4b5f9e6bbf82a80f91ae3aaff0bbdffce77a8e9d128b9f80a04`  
		Last Modified: Tue, 16 Apr 2024 22:51:36 GMT  
		Size: 25.6 MB (25646773 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e7ae1c2d74dd384b34d9feb698ff6c4f75fc322683fc778050eb00992db64a9`  
		Last Modified: Tue, 16 Apr 2024 22:51:30 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7190a417016f705209af17e70b93c2a016e0b8018a29503c6aabee6fb4823a7e`  
		Last Modified: Tue, 16 Apr 2024 22:51:30 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
