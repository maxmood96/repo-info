...
```console
$ docker pull joomla@sha256:a94dd1b33a29059e3c3c94e87cba80595a607c5df3f992c6c0a8041654aa36c1
```
...
```console
$ docker pull joomla@sha256:35332b190489a7d65735a7c96238cbe413838a78bd06bd5a1655848b56607dd3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.5 MB (94462982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:417eecd86f81cefe44afbbfde24b490df13648aa2c8209e9b56fddb91c321313`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 06 Jul 2024 10:34:27 GMT
ENV JOOMLA_VERSION=4.4.5
# Sat, 06 Jul 2024 10:34:28 GMT
ENV JOOMLA_SHA512=3bf2067d1f6faa8f36e023bcec2fc0fe1f307209feceb159f1bbe5f5618d9eede06bc23cc7610a7350c48d25d835280d81c1530a92e24f8fb989845fdbf39084
# Sat, 06 Jul 2024 10:35:14 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.5/Joomla_4.4.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 06 Jul 2024 10:35:19 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 06 Jul 2024 10:35:20 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 06 Jul 2024 10:35:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 06 Jul 2024 10:35:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f7b93e4c4ac23cef47f25b335f83bbe14a3952fb459aaffb96e08f1776a53e8c`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:93396a764f5c1f2159eeec6e7fa7bd0b2b7f4cff91cb22a04f77a9dec43104b1`  
		Last Modified: Sat, 06 Jul 2024 10:39:39 GMT  
		Size: 25.7 MB (25657887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3575e4db981a7d07297dfe4ee608c4ffbb5a3a6203507b13cd13ff54a327fc2`  
		Last Modified: Sat, 06 Jul 2024 10:39:06 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e537a7f9a10953804cf88542eb19211440dfab7d750f14318cb95f391ab9b9f`  
		Last Modified: Sat, 06 Jul 2024 10:39:06 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
