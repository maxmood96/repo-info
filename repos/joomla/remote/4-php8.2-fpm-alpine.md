...
```console
$ docker pull joomla@sha256:b7be1ee9ae8ded32923200d3123e10b2763339127d7136b7b4dc283414df3b1f
```
...
```console
$ docker pull joomla@sha256:e1e4a6504ebcb41113b4dc543d8a8d6b5bac3934ea8478f9c6bc9f46f03e7ef0
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.4 MB (92369811 bytes)**  
...
# Sat, 16 Mar 2024 10:56:15 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 16 Mar 2024 10:58:29 GMT
...
-	Layers:
	...
	-	`sha256:0a7ee9ca8bda687201bc0018682e3653c6456cae26448415e52064cb02ceaacc`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2609d0363e2dd838694a21236935f028dbdaa1439e68a8a8f2a62b99a923cbb4`  
		Last Modified: Sat, 16 Mar 2024 11:06:45 GMT  
		Size: 28.6 MB (28638301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20370704d1a1d8a63aea0a9e97375d717936025642042092d6e934f94ce151ed`  
		Last Modified: Sat, 16 Mar 2024 11:06:41 GMT  
		Size: 7.0 MB (6979172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35228e19913dccca597ba3c692bb9a6ed32f0cd1e18e12ba175ce5d55c1ccd36`  
		Last Modified: Sat, 16 Mar 2024 11:06:38 GMT  
		Size: 61.1 KB (61139 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd37050862adc165a624da7dda7c0d46c75129cbab986aec894d95f2b6f2c1cb`  
		Last Modified: Sat, 16 Mar 2024 11:06:38 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29f42324d59285a506dda8bdb12ce126d10763625e718db13ba192ed1deea9bf`  
		Last Modified: Sat, 16 Mar 2024 11:06:42 GMT  
		Size: 25.5 MB (25519526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b0f4c907a35f1ac5101aea69eb5465fd4b1562bd3964fc7a3aedde0a77b9568`  
		Last Modified: Sat, 16 Mar 2024 11:06:38 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c9afc7e78882ddc217107096183933706c79d67ace2480514d736a837ddf12d`  
		Last Modified: Sat, 16 Mar 2024 11:06:38 GMT  
...
```console
$ docker pull joomla@sha256:1d9cacf6a8b64459efc2a4e4b652083bcb0525bfecc4044d13b79ccf4e83a490
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.6 MB (92567463 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:048ad0032dc1cf6cc568c1eb9cf80c3f24be62a5c863a88181f8b4df0430e51c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 16 Mar 2024 11:20:00 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 16 Mar 2024 11:29:48 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 16 Mar 2024 11:31:52 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 16 Mar 2024 11:31:53 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 16 Mar 2024 11:31:54 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 16 Mar 2024 11:31:54 GMT
VOLUME [/var/www/html]
# Sat, 16 Mar 2024 11:31:54 GMT
...
# Sat, 16 Mar 2024 11:31:54 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Sat, 16 Mar 2024 11:31:59 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 16 Mar 2024 11:32:00 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Sat, 16 Mar 2024 11:32:00 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 16 Mar 2024 11:32:00 GMT
...
-	Layers:
	...
	-	`sha256:1686e682d675c78c25ab78d81c76d6845f30378b3401153dae89d7540da69975`  
		...
		Size: 9.2 KB (9180 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bbd52c7fce81d7779b8e31abee3a02f2f1ed8e0a05014977a19a374e9bf5534`  
		Last Modified: Sat, 16 Mar 2024 11:39:19 GMT  
		Size: 28.8 MB (28771626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77e3e8cfe961b5ce29063166dd557c49aa03244bd6825b6195ca5edc7480dec7`  
		Last Modified: Sat, 16 Mar 2024 11:39:17 GMT  
		Size: 7.0 MB (6988241 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a093968efd2a7a22a6a1e6f2470dc2009101fe9193edf84afa9ea2eaf609b1c`  
		Last Modified: Sat, 16 Mar 2024 11:39:14 GMT  
		Size: 61.1 KB (61087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc3873ef939ce4b402e50b8ad660d205c0ce25cfbdfc314dadd4445a10a559ad`  
		Last Modified: Sat, 16 Mar 2024 11:39:14 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ace67e7e07124c4a8c1d0305c4ac0f29b92df108f82617b6e69c6a0a881b45d`  
		Last Modified: Sat, 16 Mar 2024 11:39:17 GMT  
		Size: 25.5 MB (25519496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d60656d5d4c6de0fcecd7d9faab8da5474d55a77a0711d50c43a56598ab451f`  
		Last Modified: Sat, 16 Mar 2024 11:39:14 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e5f818bc0d1552921569dd4de571cce043dd8e94b816e7229ae4ca67cd89f4`  
		Last Modified: Sat, 16 Mar 2024 11:39:14 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:17218a653468cfe8b0a7986340da0db7d0520e5be5a3f64b774c4a1257f4dd46
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.0 MB (92953092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:35a370598dacd1226d25ca91b98c7c1ef876f1c8e4190e4bd0ac0bf8425191e6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 16 Mar 2024 09:16:48 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 16 Mar 2024 09:32:20 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 16 Mar 2024 09:35:26 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 16 Mar 2024 09:35:28 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 16 Mar 2024 09:35:28 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 16 Mar 2024 09:35:28 GMT
VOLUME [/var/www/html]
# Sat, 16 Mar 2024 09:35:29 GMT
ENV JOOMLA_VERSION=4.4.3
# Sat, 16 Mar 2024 09:35:29 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Sat, 16 Mar 2024 09:35:37 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 16 Mar 2024 09:35:38 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Sat, 16 Mar 2024 09:35:38 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 16 Mar 2024 09:35:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 16 Mar 2024 09:35:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2a695ebe9213f955058e7f3243c8fe6aa0312c132f27f596d46027123420625a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f66a45d7f74d826635f2e9c5288a90c794fe06740e5c513ab19c3add465b0e8d`  
		Last Modified: Sat, 16 Mar 2024 09:45:14 GMT  
		Size: 28.9 MB (28877683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34f772c93dc200a7f17e2b55c91895e9fc1c974155feee452446132de599a697`  
		Last Modified: Sat, 16 Mar 2024 09:45:09 GMT  
		Size: 7.1 MB (7077633 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83aa954216f741924b0627bfe5f3f6fecf1367f41477e6870b87b46ab7906f15`  
		Last Modified: Sat, 16 Mar 2024 09:45:05 GMT  
		Size: 61.1 KB (61133 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05cee4b2cdb654ad729d714da585830cfcdb010145d989b79078532fdd3bbe59`  
		Last Modified: Sat, 16 Mar 2024 09:45:05 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b7ab8e71b3efa685fea2919c0cebc2dc2f33a120201322d2dbbfb799ebe3928`  
		Last Modified: Sat, 16 Mar 2024 09:45:12 GMT  
		Size: 25.5 MB (25519512 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6749192b5c6111aad11e966d369b1ba2d2f36824a676e811a599cd9e217dd831`  
		Last Modified: Sat, 16 Mar 2024 09:45:05 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3adb3373380e64d2859ab888755dbe41b8d8abb49257f2f472e44ab2d22e6b2a`  
		Last Modified: Sat, 16 Mar 2024 09:45:05 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:f2792713ab1086b4e91a2c06f2faa8af3205964fa9166074251fed536a8f6435
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.7 MB (93738382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d92b72307b3d9bf0d064db129248484ccc57fc87b98e9a2e81d6dba99a66403`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 16 Mar 2024 08:56:18 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 16 Mar 2024 09:13:56 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 16 Mar 2024 09:16:40 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 16 Mar 2024 09:16:42 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 16 Mar 2024 09:16:55 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Sat, 16 Mar 2024 09:16:56 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 16 Mar 2024 09:16:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 16 Mar 2024 09:16:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4e0a4842e7bc51beaf585e0e8a67f421049d0976f1599eeb212ffd003515aae3`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1cf71c35ee8d985b401bdddd47f3697919292de6e7461190083b663c393fcf12`  
		Last Modified: Sat, 16 Mar 2024 09:27:49 GMT  
		Size: 29.4 MB (29379683 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3320150fd12f7c94b6a04a3e95870f6b93033ac280af6d9c939fafa7ed1fc35`  
		Last Modified: Sat, 16 Mar 2024 09:27:46 GMT  
		Size: 7.1 MB (7085686 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57ee4a5c9221fbcfc1989f7cb45d812c4e8e5537b637afd257d63b8bf3439299`  
		Last Modified: Sat, 16 Mar 2024 09:27:43 GMT  
		Size: 61.1 KB (61143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd46f5d29fe2bd470b2e0c0ee52bd9d2e567b0ece0ca5883188bbfe9efb71a76`  
		Last Modified: Sat, 16 Mar 2024 09:27:42 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ffbdac52c9c2e5a8340e2e6765a4644354fe7ca35321c429288ecebc496e515`  
		Last Modified: Sat, 16 Mar 2024 09:27:47 GMT  
		Size: 25.5 MB (25519522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f573e0e8a2cbab0e4219142886ab6eb4a441709a178b6175cd382ad6980e374`  
		Last Modified: Sat, 16 Mar 2024 09:27:42 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79fffc749c18251efe71a906b88f89c98944143b6b431e86a16e5315dd2ee890`  
		Last Modified: Sat, 16 Mar 2024 09:27:42 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
