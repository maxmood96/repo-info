...
```console
$ docker pull joomla@sha256:8746abc22b87aee7928ae3e11ecd1403f93a01c215981f7b1dc3625fb8b9fed5
```
...
### `joomla:6.0.4-php8.3-apache` - linux; amd64
...
### `joomla:6.0.4-php8.3-apache` - unknown; unknown
...
### `joomla:6.0.4-php8.3-apache` - linux; arm variant v5
...
### `joomla:6.0.4-php8.3-apache` - linux; arm variant v7
...
### `joomla:6.0.4-php8.3-apache` - linux; arm64 variant v8
...
### `joomla:6.0.4-php8.3-apache` - linux; 386
...
### `joomla:6.0.4-php8.3-apache` - linux; ppc64le
