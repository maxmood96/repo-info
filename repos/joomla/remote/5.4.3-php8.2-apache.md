...
```console
$ docker pull joomla@sha256:3fd14e80da7d3f4249d495a5754d247fa4c418f3aad363172c9e877f42ff0049
```
...
### `joomla:5.4.3-php8.2-apache` - linux; amd64
...
### `joomla:5.4.3-php8.2-apache` - unknown; unknown
...
### `joomla:5.4.3-php8.2-apache` - linux; arm variant v5
...
### `joomla:5.4.3-php8.2-apache` - linux; arm variant v7
...
### `joomla:5.4.3-php8.2-apache` - linux; arm64 variant v8
...
### `joomla:5.4.3-php8.2-apache` - linux; 386
...
### `joomla:5.4.3-php8.2-apache` - linux; ppc64le
...
### `joomla:5.4.3-php8.2-apache` - linux; s390x
