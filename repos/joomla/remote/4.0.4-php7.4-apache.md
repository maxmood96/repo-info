...
```console
$ docker pull joomla@sha256:c9a5311b4b7eb1533fcdbf3c827d1cb647c222d4758078f1a2f1766b1c0e265e
```
...
### `joomla:4.0.4-php7.4-apache` - linux; amd64
...
### `joomla:4.0.4-php7.4-apache` - linux; arm variant v5

```console
$ docker pull joomla@sha256:02dbf895e6140e427c74a7567d2691bd5337b94d91ab366044c8ae5fbe27f4e9
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.3 MB (169270659 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:547ff64fe5d1c4b1b3326e0a6d705feefb140d98478ae36750f1a7d750a2925f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Wed, 17 Nov 2021 22:50:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Nov 2021 22:50:27 GMT
VOLUME [/var/www/html]
# Wed, 17 Nov 2021 22:50:27 GMT
ENV JOOMLA_VERSION=4.0.4
# Wed, 17 Nov 2021 22:50:28 GMT
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Wed, 17 Nov 2021 22:50:46 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 17 Nov 2021 22:50:47 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 17 Nov 2021 22:50:48 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 17 Nov 2021 22:50:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 17 Nov 2021 22:50:49 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:e7a1e6a1f6c8c2c2e6d884ba9ac3cecc278f80c610548c98c0dc63b1716e0c33`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:423b6329ab9b27cb4d762b9f42eab422a67386dab8b597bd32cde5b81bce6a00`  
		Last Modified: Wed, 17 Nov 2021 23:32:03 GMT  
		Size: 2.9 MB (2878959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ffdc153a0482b323daa62d2f1df0769a7d1329018864d4d427b2983c053bd68`  
		Last Modified: Wed, 17 Nov 2021 23:32:22 GMT  
		Size: 21.6 MB (21566480 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:239a012d4392252cde6b3b85bcd846392891df3ba3ee67b128b91ab6ac6b2d4b`  
		Last Modified: Wed, 17 Nov 2021 23:32:01 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ac5997ae72240b1b2a3179aa8e43b658c304e360b41364da714f3504c2318c2`  
		Last Modified: Wed, 17 Nov 2021 23:32:01 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.4-php7.4-apache` - linux; arm variant v7
...
### `joomla:4.0.4-php7.4-apache` - linux; arm64 variant v8

```console
$ docker pull joomla@sha256:1545568fdb91cec70135036986178f92594eb10a160ac521441b3554f29926b1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **184.2 MB (184242547 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c89ed7960ce53fb44cb1eed34dd669de0e385d36c525d8391b919babfc1ce3a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Wed, 17 Nov 2021 17:56:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 17 Nov 2021 17:56:12 GMT
VOLUME [/var/www/html]
# Wed, 17 Nov 2021 17:56:13 GMT
ENV JOOMLA_VERSION=4.0.4
# Wed, 17 Nov 2021 17:56:14 GMT
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Wed, 17 Nov 2021 17:56:23 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 17 Nov 2021 17:56:24 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 17 Nov 2021 17:56:25 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
...
-	Layers:
	...
	-	`sha256:582c138453b0b5c363c700bc01916b509f25636948992ef18a25f384fcb6a31e`  
		...
		Size: 308.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:40eff5803f4127ce7ac9f36fbc18300f22c9ab652f8bf61cb7a6590a422f97e1`  
		Last Modified: Wed, 17 Nov 2021 18:14:39 GMT  
		Size: 2.8 MB (2808642 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:798dddc1f3dc2008f0c0ff93f1767e70f373f42df86d0e91476b20f4afca7ade`  
		Last Modified: Wed, 17 Nov 2021 18:14:42 GMT  
		Size: 21.6 MB (21566699 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b5f76bdc9be9eb9c5300b9fd34c43764a2148456cff5002c0887eff7f87ea13`  
		Last Modified: Wed, 17 Nov 2021 18:14:38 GMT  
		Size: 1.2 KB (1199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b130a6cc95c1567d98634c75ee8239988cab1a726ccd41a0358d02088a7aa09`  
		Last Modified: Wed, 17 Nov 2021 18:14:38 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.4-php7.4-apache` - linux; 386

```console
$ docker pull joomla@sha256:ca8c628f7b8a27bcac60f5dddcc0df5e040ba834ef8b0aeb4cd9397721659fbd
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **194.4 MB (194428329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e90b360bd96fb59e91dddc6a83bf661e30a54b621e7f2f122cde286d69003691`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 17 Nov 2021 22:11:54 GMT
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Wed, 17 Nov 2021 22:12:03 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 17 Nov 2021 22:12:04 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 17 Nov 2021 22:12:05 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 17 Nov 2021 22:12:05 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 17 Nov 2021 22:12:05 GMT
...
-	Layers:
	...
	-	`sha256:0d3b09de0720fb0e51ebabf55e6cb8ef0a4cb864debcf12beee3566509d642bd`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25d36a714dc0ea7204859612070322ade488e6c9371ba75659e2b4359503d22c`  
		Last Modified: Wed, 17 Nov 2021 22:28:35 GMT  
		Size: 3.1 MB (3094597 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a2814d8d73749d4753e982ef7e751a252b7a72e4ae0aed66b287cef5d94c49c`  
		Last Modified: Wed, 17 Nov 2021 22:28:40 GMT  
		Size: 21.6 MB (21566484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95b2adb23b290355845cdb7d399c73ba0ad8cbe4d2c54061e4018a0ff5db1565`  
		Last Modified: Wed, 17 Nov 2021 22:28:34 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9d01e02e10e3554501f974bbe9181de39c0956fc032ec5c7ca570bf41882008`  
		Last Modified: Wed, 17 Nov 2021 22:28:34 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.4-php7.4-apache` - linux; mips64le

```console
$ docker pull joomla@sha256:5caca4afd34f4038eb0998ad32e5aa4007c3bb25124047c158891d5c58da0656
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.3 MB (169264745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ecf4b56a878e0b113a840082a635c524782abeede5324608eeff6063eca2faa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Thu, 18 Nov 2021 23:34:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 23:34:58 GMT
VOLUME [/var/www/html]
# Thu, 18 Nov 2021 23:34:59 GMT
ENV JOOMLA_VERSION=4.0.4
# Thu, 18 Nov 2021 23:34:59 GMT
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Thu, 18 Nov 2021 23:35:21 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 18 Nov 2021 23:35:23 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 18 Nov 2021 23:35:23 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 18 Nov 2021 23:35:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 18 Nov 2021 23:35:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:07ca81a88be151f03e1dc77358e62049f3a0deea21b64e7cb9e01505e463ddd2`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb8d5c0a7618367b363d704522abe90672d6f3c058fbd4f4d26144673cf1b0d1`  
		Last Modified: Fri, 19 Nov 2021 00:16:24 GMT  
		Size: 3.0 MB (2994994 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b2b6efbb84d5ad52e6cf5615e5edca980629995f53bd646733df006bbcaf6fe`  
		Last Modified: Fri, 19 Nov 2021 00:16:39 GMT  
		Size: 21.6 MB (21566330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02deee01e5e25c6fd788c5dd8963a70dd5a93e24d67d3fd120eb0fb6637f68dc`  
		Last Modified: Fri, 19 Nov 2021 00:16:21 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca36fac8c41ae84e5319c8b5b30a1b4a71d5d704149f59e8b91b95a2e1ccc815`  
		Last Modified: Fri, 19 Nov 2021 00:16:21 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.4-php7.4-apache` - linux; ppc64le

```console
$ docker pull joomla@sha256:d94b84da7e8da3519873f97b2a567008ea99c12d7a2f9777e038866d172b249a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.8 MB (192838982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e5c352a700d8abf5002e80e11d5216a46a1f9a77a02c602d289983a98a54509`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Thu, 18 Nov 2021 15:08:15 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 18 Nov 2021 15:08:17 GMT
VOLUME [/var/www/html]
# Thu, 18 Nov 2021 15:08:19 GMT
ENV JOOMLA_VERSION=4.0.4
# Thu, 18 Nov 2021 15:08:21 GMT
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Thu, 18 Nov 2021 15:08:41 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 18 Nov 2021 15:08:48 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 18 Nov 2021 15:08:54 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 18 Nov 2021 15:08:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 18 Nov 2021 15:09:01 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:162b72afd46eae9c5bff77b1a80dace6a9a8d76b8aa9ad3ffeb276a9486f6550`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10a42e95a2d973a35161376e713737bafe1672e6b3062950c12056604c68406b`  
		Last Modified: Thu, 18 Nov 2021 15:35:47 GMT  
		Size: 3.3 MB (3285129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:855b6d312ab5e07052dda97b7650ace6a208f68bc9beea3a97008985a0e02870`  
		Last Modified: Thu, 18 Nov 2021 15:36:03 GMT  
		Size: 21.6 MB (21566593 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b98312592d1d137edd7c6f4f2eeb41b8069392c6994ea0eda0029c7840fb852d`  
		Last Modified: Thu, 18 Nov 2021 15:35:45 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3895772230332002fdba44721934bdde4f48bc9b67da62515baaa433b4d3e525`  
		Last Modified: Thu, 18 Nov 2021 15:35:45 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.4-php7.4-apache` - linux; s390x

```console
$ docker pull joomla@sha256:0375a9a3156a0b12f9086168f4002e73afef978dcb6067bd18fbc9703f8fd972
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.8 MB (168827402 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:205d2c5538239c1ac8c90058b2299b813945be34b410ba8a66be3a97b7cea3a5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 18 Nov 2021 18:24:58 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 18 Nov 2021 18:24:58 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 18 Nov 2021 18:24:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 18 Nov 2021 18:24:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3a0e10726d44ec0ef73fcdb37dceb53415b08520b71d86630807c12d243f7804`  
		...
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aed39ee6574074f2ad7a742ae59fed913e0d7904b1a08fe7477825e8b08af7d`  
		Last Modified: Thu, 18 Nov 2021 18:38:01 GMT  
		Size: 3.0 MB (3028888 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a8061496e71dceceab8c2106f06ff040cdf1a140a8e1125f4439bcead82234d`  
		Last Modified: Thu, 18 Nov 2021 18:38:04 GMT  
		Size: 21.6 MB (21566536 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:926bb33b96b0b8bc0e52668ca1d7bf30481d8ca24a525eb0e811fad26975ba84`  
		Last Modified: Thu, 18 Nov 2021 18:38:01 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08392a66500e76e47ea5cfeab711a057143dd701379a4123406bcee37f37c202`  
		Last Modified: Thu, 18 Nov 2021 18:38:01 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
