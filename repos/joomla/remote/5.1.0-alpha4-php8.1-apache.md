...
```console
$ docker pull joomla@sha256:1146348729e4ca3d743fc56ef36228441522fd4e6360dee51f04f8ffca1d3236
```
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; arm variant v5
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; mips64le
...
### `joomla:5.1.0-alpha4-php8.1-apache` - linux; s390x
