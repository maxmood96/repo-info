...
```console
$ docker pull joomla@sha256:b26afa79472955c0b9b3314af716dea95d64819fd92e278660391b80445f53b9
```
...
### `joomla:5.3.4-php8.1-fpm` - linux; arm variant v7
...
### `joomla:5.3.4-php8.1-fpm` - linux; arm64 variant v8
...
### `joomla:5.3.4-php8.1-fpm` - linux; 386
...
### `joomla:5.3.4-php8.1-fpm` - linux; ppc64le
...
### `joomla:5.3.4-php8.1-fpm` - linux; s390x
