...
```console
$ docker pull joomla@sha256:9129e1504197e7038b2e3ea38737076b8cb06383d1ef23e3b2f6c87dc03957e1
```
...
### `joomla:4.4.beta-apache` - linux; amd64
...
### `joomla:4.4.beta-apache` - linux; arm variant v5
...
### `joomla:4.4.beta-apache` - linux; arm variant v7
...
### `joomla:4.4.beta-apache` - linux; arm64 variant v8
...
### `joomla:4.4.beta-apache` - linux; 386
...
### `joomla:4.4.beta-apache` - linux; mips64le

```console
$ docker pull joomla@sha256:94aaf9c451dca5951327a9c222b9fc6cdd0a6e93ba40c5582f63406bdba6fa5e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.5 MB (206457933 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d51ebdd3feeae925311c84a432c35ab196dca98f6fbb72c4fcb6a57acfd3afa0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Fri, 22 Sep 2023 00:30:19 GMT
ENV JOOMLA_VERSION=4.4.0-beta2
# Fri, 22 Sep 2023 00:30:24 GMT
ENV JOOMLA_SHA512=f10fe68d703c28f32e8e46c1dfa2732649cb14c4b1c42e12dff6cf1941498f25d790b69b3a4701637092d84a41c5db0a557090333fe1d99123b3a439f6f6fe17
# Fri, 22 Sep 2023 00:31:03 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0-beta2/Joomla_4.4.0-beta2-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 22 Sep 2023 00:31:11 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Fri, 22 Sep 2023 00:31:17 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 22 Sep 2023 00:31:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Sep 2023 00:31:30 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f98706498fc8b30df719cd65d51373e09cc961aeaa74d1facbaf6893a2bc96de`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1472d6acb36c8c4711163308a3534acda6afc371ccfb32eab3f8fa90a6d361f1`  
		Last Modified: Fri, 22 Sep 2023 01:16:26 GMT  
		Size: 25.3 MB (25254567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6bcb82292d7ca1d110364bc734558ed5f23a7316f98f98b2aae2169dba62b3c6`  
		Last Modified: Fri, 22 Sep 2023 01:16:04 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a05fa748fa6b35d6b26b50582825a5a9cf8f2a1bb64bec34e38926747c9de139`  
		Last Modified: Fri, 22 Sep 2023 01:16:05 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.4.beta-apache` - linux; ppc64le
...
### `joomla:4.4.beta-apache` - linux; s390x
