...
```console
$ docker pull joomla@sha256:3a5101b066878b4b5df39508c6a8c9515d500de421b986543df5928f925a0642
```
...
```console
$ docker pull joomla@sha256:b9098cbd53b4dff3bff21285391ddecba21d40ff42dd3862ced49e3104ed70bc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.9 MB (256877976 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b2f05e0c71ac22635e8a677d2a00f7a01abf6c3084e93a67877a4ca5f476057`
...
-	Layers:
	...
	-	`sha256:64f106b952ca53e02d1830109f274884d46454851b39fa1fd6ed28c741578475`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df2aecd36ba268cc013fa36af79e1838697a987a6e9be0df3ff37601d4507064`  
		Last Modified: Tue, 14 May 2024 18:43:07 GMT  
		Size: 27.3 MB (27286452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c05f36c2639eef48578e697ac15733a9cfd85deef2511d123b03d384f6555d0`  
		Last Modified: Tue, 14 May 2024 18:43:08 GMT  
		Size: 32.2 MB (32187349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ab27db648b09c0b4fa935864e075a323dd86729d14ddece72566576c73c3b2a`  
		Last Modified: Tue, 14 May 2024 18:43:01 GMT  
		Size: 365.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4526b27a63728bcbed7b65c5f0b5b5bf4f75bb5e98ec5c2eeba6d91601f107d9`  
		Last Modified: Tue, 14 May 2024 18:43:01 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:327ff6ae8c9a4aa72f23b889f2b951c46d058cedfe06a92fe99313ffd8687dfc`  
		Last Modified: Tue, 14 May 2024 18:43:05 GMT  
		Size: 23.7 MB (23690562 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e00bbd57199a3ab61098590914c9093bb6076b099760c093943a362dd210d4e4`  
		Last Modified: Tue, 14 May 2024 18:43:02 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e74d799b757fe30a1efcbb63440ba564d7711788cf2e1b727790d3efa2917ca8`  
		Last Modified: Tue, 14 May 2024 18:43:01 GMT  
...
```console
$ docker pull joomla@sha256:0127fae53c909daa4b98dc9abb095a1b46f5e5ebbce5279cd648782c39e77f22
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.0 MB (248041355 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0d3b97aa643dc3df70d8aba025d20312bdc6ce3040a23138588f6cd45c54137b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 May 2024 14:58:29 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 14 May 2024 14:58:36 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 15:01:16 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 14 May 2024 15:01:17 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 May 2024 15:01:17 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 14 May 2024 15:01:17 GMT
VOLUME [/var/www/html]
# Tue, 14 May 2024 15:01:18 GMT
ENV JOOMLA_VERSION=5.1.0
# Tue, 14 May 2024 15:01:18 GMT
ENV JOOMLA_SHA512=3d5e547520ddbbbd256dccaf9c88911d3571bb0698f6857a0472f174fa1d62b71ee24442c16c20528c70dc5d4b97bf946182146497d32faecf6f8897ff72485c
# Tue, 14 May 2024 15:01:21 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0/Joomla_5.1.0-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 14 May 2024 15:01:21 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 14 May 2024 15:01:22 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 14 May 2024 15:01:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 14 May 2024 15:01:22 GMT
...
-	Layers:
	...
	-	`sha256:e9241e08c874a134c42d495e36630950d508a0fba64e7c752ef099a9f3097cc0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb4f76095608b5b4ac4412fae8a253eb7430de6ade8b1086e069111631fc992e`  
		Last Modified: Tue, 14 May 2024 15:14:02 GMT  
		Size: 27.1 MB (27101885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:921aaac1e2e8787f3145225c6fae5ce0cbdc04782c3e6f0420d8778e70e2c0c0`  
		Last Modified: Tue, 14 May 2024 15:14:03 GMT  
		Size: 29.8 MB (29771559 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a890e06e686026e86650c39b0081ecf005cc5f0ab592fe81ece41fa241e76c0`  
		Last Modified: Tue, 14 May 2024 15:13:57 GMT  
		Size: 359.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4aa85dd0180966f517381d642d9483218bc2e2e5dc08a5067294a1394c4f8a8`  
		Last Modified: Tue, 14 May 2024 15:13:57 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f31c1e5bf9e81c1cd17fb3047ebe3029ead648836600c14f51d0e542d1a79aea`  
		Last Modified: Tue, 14 May 2024 15:14:00 GMT  
		Size: 23.7 MB (23690552 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d9a416510bc23fa25796981e40529d332696de1414e0c804ee1f9039f24ece5`  
		Last Modified: Tue, 14 May 2024 15:13:57 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b09ccf95e76855e91b410ea3c992e89ed09b218a0cfaae0bb183046a3a9ead8a`  
		Last Modified: Tue, 14 May 2024 15:13:57 GMT  
...
```console
$ docker pull joomla@sha256:b7d1544ab2912f6a80b6dc25957ec9e3fa57d94775b64eaf2fc8645c89f1821f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.5 MB (228511004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36d161da867364addf11494c308cc8c3f09e53e97d16402812f6105c464115ce`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 14 May 2024 13:11:32 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 13:23:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 14 May 2024 13:23:50 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 May 2024 13:23:57 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 14 May 2024 13:24:01 GMT
VOLUME [/var/www/html]
# Tue, 14 May 2024 13:24:05 GMT
ENV JOOMLA_VERSION=5.1.0
# Tue, 14 May 2024 13:24:10 GMT
ENV JOOMLA_SHA512=3d5e547520ddbbbd256dccaf9c88911d3571bb0698f6857a0472f174fa1d62b71ee24442c16c20528c70dc5d4b97bf946182146497d32faecf6f8897ff72485c
# Tue, 14 May 2024 13:24:38 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0/Joomla_5.1.0-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 14 May 2024 13:24:46 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 14 May 2024 13:24:52 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 14 May 2024 13:24:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 14 May 2024 13:25:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:39bd35b8135413de034a7ff690250cf0b87ffdf898039f6f83a944807d6bb2bb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6c54478484634e5a981bde9d77141409cbd96a7a456dd24da8de04e4afbb6e02`  
		Last Modified: Tue, 14 May 2024 14:29:02 GMT  
		Size: 27.0 MB (27042341 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:435a8c7b081bf1ff78b7d44183b19cb116a5eeea4efaf997f62ae4f1ce11d84b`  
		Last Modified: Tue, 14 May 2024 14:29:08 GMT  
		Size: 29.3 MB (29263291 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc2e278dd93336d7d198de5f4c3ae72b3632561c5983803cf03185541a5d882a`  
		Last Modified: Tue, 14 May 2024 14:28:37 GMT  
		Size: 363.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5c145c130108b2fab2dcb697e036def2ff062efc6f70a101d41e5aa02e4e9ce`  
		Last Modified: Tue, 14 May 2024 14:28:37 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44d130b6b48571395bc420d9e86b86a19aa7e07d69e012243f0a7c833fda3429`  
		Last Modified: Tue, 14 May 2024 14:29:06 GMT  
		Size: 23.7 MB (23695969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:18612e3cf68d6f811206554915da4db3281919c0daf77f8fa059f344ca12b99d`  
		Last Modified: Tue, 14 May 2024 14:28:37 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d46b41400349cc5f76f3f5e8787d58230b989a0975ebebe434d180ed84588ee`  
		Last Modified: Tue, 14 May 2024 14:28:37 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
