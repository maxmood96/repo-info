...
```console
$ docker pull joomla@sha256:35d61737bde70a0d72ad4f5edcf29a55981a4e0d4ee86a56bbce64fa84205756
```
...
```console
$ docker pull joomla@sha256:9559b3ae7ed4048bf2938a875dae6881f44f6a1e47d05c4b68bf12fd8c5542cf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.5 MB (142527549 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:90ae5e157b09e798e8f7b6db98f7f91d8e1acd2c905f8e9a0a3857526a8727c5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 22 Apr 2022 16:18:57 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 22 Apr 2022 16:55:38 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 22 Apr 2022 16:55:39 GMT
VOLUME [/var/www/html]
# Fri, 22 Apr 2022 16:55:39 GMT
ENV JOOMLA_VERSION=3.10.8
# Fri, 22 Apr 2022 16:55:40 GMT
ENV JOOMLA_SHA512=71b7d5956be38dcef33db3e777418d68b3ad157c53112f12e97f059f2749183ee7f81280d8b9fc72712dfe5565d17fa25af177c015611c569c90aa68bcdfd70a
# Fri, 22 Apr 2022 16:55:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 22 Apr 2022 16:55:52 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 22 Apr 2022 16:55:53 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 22 Apr 2022 16:55:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Apr 2022 16:55:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:27dc3430b30cd372ef450aa7f3ab3d7253584b913d293b0006e1c63f117a1986`  
		...
		Size: 8.4 KB (8446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20ba60d26d4270003912cf6f0358336791d4cf8466e057b20f1c09755b7f6c17`  
		Last Modified: Fri, 22 Apr 2022 17:07:13 GMT  
		Size: 2.6 MB (2628486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33ff61bc02d1d6a26e9913ebb8dbe8366bf92f53420c57ec47f0f5052ada5aff`  
		Last Modified: Fri, 22 Apr 2022 17:07:22 GMT  
		Size: 9.7 MB (9710192 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b64abdfa69359954572160751525a33f4b16d0e335d97efbbe2af5762238faa9`  
		Last Modified: Fri, 22 Apr 2022 17:07:11 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5049786fb87469a99f6f3b8d29724a1264c98ec3347733ee7369ab000c78f652`  
		Last Modified: Fri, 22 Apr 2022 17:07:11 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:b5f75d1943454697b55a513168d53c7591cd0ea24195085c181aeb632fd70a8b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **149.4 MB (149415345 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8f655fa60226b7026f68236722b20ca73203425f34fa0184e7a5b95c2416667d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:7c3d67ae82ddc3381b98912ccb0729804c75e9fc083d75a30a024565c0f628c9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f124a10ec637edae6ede36d046c73630065aaf2b018c88a834300dcbdf8cf5cb`  
		Last Modified: Wed, 11 May 2022 18:57:19 GMT  
		Size: 9.7 MB (9710181 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc363ee829baaf40fc808ff550407e8455087bde2e1779c9fab04002bb4d86e2`  
		Last Modified: Wed, 11 May 2022 18:57:18 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac63684ff603b185f125af6b9712789f82820589c0032c752ecaf044f2dbc8f8`  
		Last Modified: Wed, 11 May 2022 18:57:18 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
