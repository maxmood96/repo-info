...
```console
$ docker pull joomla@sha256:e266d44ef787780efb0de3e8c41a6e7666cc2087e90ca4f6044eb9e0c033b31b
```
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; amd64
...
### `joomla:6.0.3-php8.3-fpm-alpine` - unknown; unknown
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; arm variant v6
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; arm variant v7
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; 386
...
### `joomla:6.0.3-php8.3-fpm-alpine` - linux; s390x
