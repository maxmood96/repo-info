...
```console
$ docker pull joomla@sha256:05c1bd5669b27031404565c742aefb777c86e03730740741cab0719f1081939e
```
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.2-fpm-alpine` - linux; s390x
