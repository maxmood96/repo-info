## `joomla:4.4.rc-php8.2-fpm`

```console
$ docker pull joomla@sha256:278367a858663701dbd2f23d25d122f7a3d9c831ab7c03e2cf01a7ca66456ab6
```
...
### `joomla:4.4.rc-php8.2-fpm` - linux; amd64
...
### `joomla:4.4.rc-php8.2-fpm` - linux; arm variant v5

```console
$ docker pull joomla@sha256:f8edcc25568e752a80073df490608b43379e33d7f37430ef5c31b222aaa9c4b2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.1 MB (202081413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbf099dcb3650ac28d846205fcd8f94cdae54168515ec1c62c60d8c394b56775`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 30 Sep 2023 04:18:18 GMT
VOLUME [/var/www/html]
# Wed, 04 Oct 2023 22:49:53 GMT
ENV JOOMLA_VERSION=4.4.0-rc1
# Wed, 04 Oct 2023 22:49:53 GMT
ENV JOOMLA_SHA512=f71fd1fd1ba32630b6fb26854b7bb7bc09a9985407cd6138d57e0f7c91afb6f92c3ac3169f13323f144ebe89e7eb1d85b1ad0aa950812f23347224fe2037bca1
# Wed, 04 Oct 2023 22:50:00 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.0-rc1/Joomla_4.4.0-rc1-Release_Candidate-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:7af913b4a1a63587d750cd8c95f04511933903ab3079e169a8b927004a2725b7`  
		...
		Size: 398.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d3eae17aba69b8ed2614f74b72b8db9f1e7000f9d70f56fb4dbbefcd3dd76a9c`  
		Last Modified: Wed, 04 Oct 2023 22:56:16 GMT  
		Size: 25.3 MB (25257972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bd186d3c39d756354f278ee77cb8b4046fe6ba6193ebc862a84867bdee3fcf1`  
		Last Modified: Wed, 04 Oct 2023 22:56:11 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8bb404e90f4ec9272eb4b7f1c709e60aaa5c3ff67abd7f83756b81db28b5bcd`  
		Last Modified: Wed, 04 Oct 2023 22:56:11 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.4.rc-php8.2-fpm` - linux; arm variant v7
...
### `joomla:4.4.rc-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:4.4.rc-php8.2-fpm` - linux; 386
...
### `joomla:4.4.rc-php8.2-fpm` - linux; mips64le
...
### `joomla:4.4.rc-php8.2-fpm` - linux; ppc64le
...
### `joomla:4.4.rc-php8.2-fpm` - linux; s390x
