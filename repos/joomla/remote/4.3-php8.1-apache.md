...
```console
$ docker pull joomla@sha256:f6401c632bd9e991aedddd20f47067c2fab8dadd637786a9ca28c7c30e9d9567
```
...
```console
$ docker pull joomla@sha256:dc03ec2fdfed49b0b820ef45b6bd2a8e6e61bbc00b2313300e9bb5b66e1eac5e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **206.6 MB (206554055 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65caef039a8d21e205719dd98f78cb2fa23d30503c6aba9b25f99d683a4af07a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 12 Jan 2024 00:35:34 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Fri, 12 Jan 2024 00:35:40 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 12 Jan 2024 00:35:46 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Jan 2024 00:35:53 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:075eb0fd4740a3f5de75965c1654288191574ebfd9a79c710e72a575ed073b4c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:913a6b51c2991e29d15206d14d16928e7cf3d5e62d9b0d605d6f0b02215557f8`  
		Last Modified: Fri, 12 Jan 2024 00:49:09 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a1b6ce1f08f5a5d08019667b7931c6df5a5f59474e448a7109b40ca0f3fb8782`  
		Last Modified: Fri, 12 Jan 2024 00:49:09 GMT  
