...
```console
$ docker pull joomla@sha256:ae416242dad87a0540e72fa547648ba093edfaa066a1e0f8403aa0c98be79fe8
```
...
```console
$ docker pull joomla@sha256:cf518c982942d70d21fdd32274cc940cf1dcfeb5397a1636bf45e2d603d2eab5
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.2 MB (230159170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5fb34c09362185efc0622c3c8f84984ded176556447223c465a3cb838e539869`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Fri, 02 Aug 2024 16:41:09 GMT
VOLUME [/var/www/html]
# Fri, 02 Aug 2024 16:53:36 GMT
ENV JOOMLA_VERSION=5.1.2
# Fri, 02 Aug 2024 16:53:37 GMT
ENV JOOMLA_SHA512=d344506443b403fa662aa4e626e11a76d8666c938f52e497030d4b422205a1cdf21d4457d5943f68eea47e904067f8005b49a6d95432255e772809a3a471d1b0
# Fri, 02 Aug 2024 16:53:41 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.2/Joomla_5.1.2-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 02 Aug 2024 16:53:43 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 02 Aug 2024 16:53:43 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Fri, 02 Aug 2024 16:53:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Aug 2024 16:53:44 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:f4446e4139280e521b7062601634be0119d6b72ed66c9d41e37df07ff52ea609`  
		...
		Size: 19.2 KB (19161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06ffc93b60470e10a7c39ec65141ad0635c4cb894d7dde98c83fdce5e570f26c`  
		Last Modified: Fri, 02 Aug 2024 17:06:43 GMT  
		Size: 23.8 MB (23765959 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5667ed11092b9d2f0172dfbc941ca78f777f0e5befaacf70326b97e3068056bf`  
		Last Modified: Fri, 02 Aug 2024 17:06:39 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61c88c1eeda3d510beb062a4d4cc56dcf62c87ab982dd695147a754a75c33d68`  
		Last Modified: Fri, 02 Aug 2024 17:06:39 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
