...
```console
$ docker pull joomla@sha256:9a10c0ad94177a902496e9c016966ca19238ab49f4fb13d81436ef93a90d578f
```
...
```console
$ docker pull joomla@sha256:15b6a1e94c98a6bb238dcc7ab79a44bf7149e5a4d3d2cc6a43229c068f5a5324
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.4 MB (309377099 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58dff256979de10a9a799d152447756ff32e1b74868dd41a3b2a000d1b0a9678`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Mon, 06 Apr 2026 18:55:52 GMT
ENV JOOMLA_SHA512=c1d98a550c43dbbd68b9be369352f015a05e858d6e163e5fdb909fa40563d34dee268f2fcb64b122deb8bb025b4c6af27d391e26563a58a3350c4875a2e1b3e8
# Mon, 06 Apr 2026 21:35:08 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/6.0.4/Joomla_6.0.4-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla # buildkit
# Mon, 06 Apr 2026 21:35:09 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Mon, 06 Apr 2026 21:35:09 GMT
COPY makedb.php /makedb.php # buildkit
# Mon, 06 Apr 2026 21:35:09 GMT
...
-	Layers:
	...
	-	`sha256:af446ac8a0de47e5cc6ad05389127a36abef869c4619b81178f75cb35cf7f41e`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2e37a4a6e3fffe95b7185d57d05cd6cac67ec8ff28d2f401b1aae86cb578a6b0`  
		Last Modified: Mon, 06 Apr 2026 21:36:45 GMT  
		Size: 26.5 MB (26529179 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:244e7fa8e92747922efab633c450ec951ae8b02094aec4803924e973e5734ded`  
		Last Modified: Mon, 06 Apr 2026 21:36:40 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c9bb5a2d653d8c138a2bf2e0bfc9d501890a2c398c60c149c51d46ce15cffb96`  
		Last Modified: Mon, 06 Apr 2026 21:36:40 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:70005105cacc068f834fe8ef040e59c0f108620e143050788805c88e96a5a151
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.8 KB (57835 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:201d6d44db69da08325a9542be187e5c0ef1f4b1b3eac6cf911170953ad55e35`

```dockerfile
```

-	Layers:
	-	`sha256:85c30c8f80f16a6bed7122e492c0beb3f1cd585579b35de8cbfe52d6bfe819e2`  
		Last Modified: Mon, 06 Apr 2026 21:36:40 GMT  
		Size: 57.8 KB (57835 bytes)  
		MIME: application/vnd.in-toto+json
