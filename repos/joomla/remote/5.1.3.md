...
```console
$ docker pull joomla@sha256:5d4632083d5fc536f8ed351f1081a8a3736d4f39438c4979f6b9d7417f49db51
```
...
### `joomla:5.1.3` - linux; arm variant v5
...
### `joomla:5.1.3` - linux; arm variant v7
...
### `joomla:5.1.3` - linux; arm64 variant v8
