...
### `joomla:5.1.0-beta-apache` - linux; amd64
...
### `joomla:5.1.0-beta-apache` - linux; arm variant v5
...
### `joomla:5.1.0-beta-apache` - linux; arm variant v7
...
### `joomla:5.1.0-beta-apache` - linux; arm64 variant v8
...
### `joomla:5.1.0-beta-apache` - linux; 386
...
### `joomla:5.1.0-beta-apache` - linux; mips64le
...
### `joomla:5.1.0-beta-apache` - linux; ppc64le
...
### `joomla:5.1.0-beta-apache` - linux; s390x
