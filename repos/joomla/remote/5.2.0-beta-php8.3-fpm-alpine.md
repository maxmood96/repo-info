...
```console
$ docker pull joomla@sha256:6dd2dac481b31a1b691faae0d4212f8a82447963e1e62a957d5104444a9c718b
```
...
```console
$ docker pull joomla@sha256:3d7f2fc20a5343a2cb7a78fffb68eb30409da38413f0b4d144d7189a784e0870
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.7 MB (91684507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38a2429893a37b380653cdd5c97c9f8eeea47075030d91af466d79380f6519d4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 07 Sep 2024 04:25:13 GMT
ENV JOOMLA_SHA512=ca08e2ac23e2671610f66a492d906fdbb2bb0b7cd8da235d4da861c6a5f097f0d6e5e7d84ddf5316ea685a39fd3222dae58a9ac98e3005ee41f5fc673b033355
# Sat, 07 Sep 2024 04:25:20 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta2/Joomla_5.2.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 07 Sep 2024 04:25:22 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 07 Sep 2024 04:25:22 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 07 Sep 2024 04:25:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 07 Sep 2024 04:25:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d09cdce8608a0e088936d652433a086417f209d70368c25e4935e5a734634751`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c608d4547063503e92bbec9d617d5f69cfd68cd5f4e182089704bbd688890d5`  
		Last Modified: Sat, 07 Sep 2024 05:00:46 GMT  
		Size: 23.4 MB (23441644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff49e17f6c56139aacd3e7774ccff79b518b08bae7a445ad28efc2da903f1b0d`  
		Last Modified: Sat, 07 Sep 2024 05:00:35 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf0d7c4f5839bf804972b00561b584f817d913fdc623ee0a4caf19ef1dbbc01b`  
		Last Modified: Sat, 07 Sep 2024 05:00:35 GMT  
		Size: 1.1 KB (1069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
