...
### `joomla:5.0.rc-php8.2-fpm` - linux; amd64
...
### `joomla:5.0.rc-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.0.rc-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.0.rc-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.0.rc-php8.2-fpm` - linux; 386
...
### `joomla:5.0.rc-php8.2-fpm` - linux; mips64le
...
### `joomla:5.0.rc-php8.2-fpm` - linux; ppc64le
...
### `joomla:5.0.rc-php8.2-fpm` - linux; s390x
