...
```console
$ docker pull joomla@sha256:5363bca64a3bc1763b4b1ca35748452b669752d45c4f8de07e32c82cd7d83a57
```
...
### `joomla:5.4.4-php8.3-fpm` - linux; ppc64le
...
### `joomla:5.4.4-php8.3-fpm` - linux; s390x
