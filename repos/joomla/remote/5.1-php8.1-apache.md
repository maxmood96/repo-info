...
```console
$ docker pull joomla@sha256:c918bac2d23e5037f4d74ba6ac06b598e8d5724f167403429aa23770126a0692
```
...
```console
$ docker pull joomla@sha256:1f3dcae7de6efbfd0e2c03f3fa2279d72a7c2181970dce7b2b9debd844c6d116
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.7 MB (229726059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e7ed986b95f5ccce5bdcf63fd71f78b024f400b1f019cdd1cf44eccb532ed0be`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0-beta1/Joomla_5.1.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 12 Mar 2024 15:14:23 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 12 Mar 2024 15:14:24 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 12 Mar 2024 15:14:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Mar 2024 15:14:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:01bfe7633fef04059161bef36c9f572a2fd366e034cd81dc194bd223b36b6185`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f7e638813a5ba13bf78b45e05074e2147f452e967b710dd980ce0e71ef10507`  
		Last Modified: Tue, 12 Mar 2024 16:28:44 GMT  
		Size: 23.5 MB (23526367 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7f59486c5241f65b81c3eb6b9ae62d5db42ecb67106bfd67f04798343d6e18fa`  
		Last Modified: Tue, 12 Mar 2024 16:28:39 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c2020ce21641f35ce2f9d1ec6cb30c5a07f5277920bbabef46dbb3c187f9bca2`  
		Last Modified: Tue, 12 Mar 2024 16:28:40 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
