...
```console
$ docker pull joomla@sha256:3525174f484ad3b06eed0eba9c0b12596766f3a55570cb86f559f3fc8296eb4b
```
...
```console
$ docker pull joomla@sha256:c2c75dba0959335f632bd5f9b4a37c30e4ff5d547f6284a1e3c9df33bf6a0a97
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.8 MB (229790715 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:638133a255f1f80763012c996e9d674852e1cc98fd479adb3e80cefbcbbcca07`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Fri, 12 Apr 2024 23:57:49 GMT
ENV JOOMLA_VERSION=5.1.0-beta2
# Fri, 12 Apr 2024 23:57:49 GMT
ENV JOOMLA_SHA512=8f4f81c9147270c6f7a2373c96716c90272f12e7c8679166517eb84990e3c7724b1d3657c3f8eee1a46094a4d950830048afdd17dae516be8dac5fd7be1cba65
# Fri, 12 Apr 2024 23:58:08 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0-beta2/Joomla_5.1.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 12 Apr 2024 23:58:17 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Fri, 12 Apr 2024 23:58:17 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 12 Apr 2024 23:58:17 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Apr 2024 23:58:18 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:86545689b9f76d30907382e9937c06165b0e366c1120d5302dc4817e5903a7f4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d3b8e976874c124f851cad0129409f59d072e3162fb50368d888555494aa4e9`  
		Last Modified: Sat, 13 Apr 2024 00:55:50 GMT  
		Size: 23.6 MB (23648757 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b759a8015c36759e5fa06563fd836ff42b9342e12f896c18498d052453e7cf5`  
		Last Modified: Sat, 13 Apr 2024 00:55:45 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccedb64ab01655e2a468fb0a1d5458146d07f682f5785d27a78b0d5fe574dd09`  
		Last Modified: Sat, 13 Apr 2024 00:55:45 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
