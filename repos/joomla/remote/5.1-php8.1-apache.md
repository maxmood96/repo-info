...
```console
$ docker pull joomla@sha256:c90ceadf0cb8974fd1b1b73405c4642f09712f9a422bebb0386b170b424e7b79
```
...
```console
$ docker pull joomla@sha256:3c6cc5772d04e8f109a4e0d52c3ca30ed0ba13bf16cc396d4bc1c619952a254d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.0 MB (260019873 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44ebc2de145bd48ac9dce6cd56e7910e74efe14ced64468f15f7471f421ceb7c`
...
-	Layers:
	...
	-	`sha256:d80646e587d9205cd7f01e87537e8ba826a9ad2c28b05fde0b1330b060c856d0`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:165776bd775c8b72ec46d8894769e2691829ffae3a8201cb01f226af0816dee6`  
		Last Modified: Tue, 14 May 2024 18:41:26 GMT  
		Size: 27.2 MB (27166796 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee421b17ef8e76cf08bff513926111ebbdc9fe3651d9faf52d5dd2effd721456`  
		Last Modified: Tue, 14 May 2024 18:41:26 GMT  
		Size: 32.0 MB (31953657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39ecd299769eee17847634f1a96c0e3284ab2ff9b6cf481dd63ba71e05c48f06`  
		Last Modified: Tue, 14 May 2024 18:41:21 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3d3eb120ec0e14193241fd897c735eb5b4bf96d51fe2085978f0e1327e91b91`  
		Last Modified: Tue, 14 May 2024 18:41:19 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1d0ca918bbf940c9e142662f49d4ade417cba02e618e73809728864fbe9c94de`  
		Last Modified: Tue, 14 May 2024 18:41:19 GMT  
		Size: 19.2 KB (19166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c05ece402b705dd01c88463130029cc2863a1003429a34363ebb4ae6e7c4a7c`  
		Last Modified: Tue, 14 May 2024 18:41:23 GMT  
		Size: 23.7 MB (23690563 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f4214674b5d31bf00d6e433e2cdbe1564648f8aba907592d664e59fdd222626`  
		Last Modified: Tue, 14 May 2024 18:41:19 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:133cfd6dd008d77b97567d50850242cd3a7f6779bba10aaf49ee5f040efa30fe`  
		Last Modified: Tue, 14 May 2024 18:41:19 GMT  
...
```console
$ docker pull joomla@sha256:4810350480def13cf1d0368d410d92e63c77ca515425de7f3788680ebbc9b84c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.2 MB (251225380 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc4e8a5075b552e1c7ae177c13ec4e225ee41288638c5a2ee7de19f7cc3b5af8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 14:53:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 14 May 2024 14:53:13 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 May 2024 14:53:14 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 14 May 2024 14:53:14 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 14 May 2024 14:53:14 GMT
VOLUME [/var/www/html]
# Tue, 14 May 2024 14:53:15 GMT
ENV JOOMLA_VERSION=5.1.0
# Tue, 14 May 2024 14:53:15 GMT
ENV JOOMLA_SHA512=3d5e547520ddbbbd256dccaf9c88911d3571bb0698f6857a0472f174fa1d62b71ee24442c16c20528c70dc5d4b97bf946182146497d32faecf6f8897ff72485c
# Tue, 14 May 2024 14:53:18 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0/Joomla_5.1.0-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 14 May 2024 14:53:18 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 14 May 2024 14:53:18 GMT
...
-	Layers:
	...
	-	`sha256:51ef3205f25dd028500012eb9ae615c8e32b17816ac89386fae23414c49d9b07`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c03a5584a54b39a6f10069fea418e940ce12881082d1daa1dba9f3c8b7e7948a`  
		Last Modified: Tue, 14 May 2024 15:12:19 GMT  
		Size: 27.0 MB (26999637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9dc4d3851ee2726d09a8dbc63907d4d0b15ff7dbee490bdd5fdd307bb9af33f`  
		Last Modified: Tue, 14 May 2024 15:12:19 GMT  
		Size: 29.5 MB (29531166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:952c1cdbe6610c7e20f4cc11025cc63297f2ed759ae618d54ef0fda3e12db98f`  
		Last Modified: Tue, 14 May 2024 15:12:16 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a953c5b4da9378f4778d34ba7ea0a2a9bf3f968c92e19fba1c138b1194d2641e`  
		Last Modified: Tue, 14 May 2024 15:12:14 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8d1a25a306589c3e9659e3d17d1ad96d42d8da2431565be0fe16beb85b15022`  
		Last Modified: Tue, 14 May 2024 15:12:14 GMT  
		Size: 19.2 KB (19156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b2e4c6b96d29c8803862c2e2b24c47d4a6dd567f4783c190dd17f589c31ed1f`  
		Last Modified: Tue, 14 May 2024 15:12:17 GMT  
		Size: 23.7 MB (23690555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3b59f02b819f23abe9c4e9b6b4325111eb85f7108657bff8ad47ccd84328280`  
		Last Modified: Tue, 14 May 2024 15:12:14 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c070b62ee661fb996536cca0da43d407cab96072abd29aa1cfca74e63db2018`  
		Last Modified: Tue, 14 May 2024 15:12:14 GMT  
...
```console
$ docker pull joomla@sha256:11175ac529324532a28d40d6b54efbd1437f03612da8664dc58c8e2750a08c9b
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.6 MB (231577092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:27e62bbf1b7068e2e9917f0241579eb506c5c1337747d09bc5d50d69d63ae7e5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 14 May 2024 12:27:08 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 14 May 2024 12:39:03 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 14 May 2024 12:39:10 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 May 2024 12:39:17 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 14 May 2024 12:39:24 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 14 May 2024 12:39:29 GMT
VOLUME [/var/www/html]
# Tue, 14 May 2024 12:39:33 GMT
ENV JOOMLA_VERSION=5.1.0
# Tue, 14 May 2024 12:39:38 GMT
ENV JOOMLA_SHA512=3d5e547520ddbbbd256dccaf9c88911d3571bb0698f6857a0472f174fa1d62b71ee24442c16c20528c70dc5d4b97bf946182146497d32faecf6f8897ff72485c
# Tue, 14 May 2024 12:40:06 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0/Joomla_5.1.0-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 14 May 2024 12:40:14 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 14 May 2024 12:40:20 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 14 May 2024 12:40:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 14 May 2024 12:40:34 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a39a43bd088b9a1ad6de16705c09f9b6fff57923f82b097f8aaaa28506cbbe14`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fd76c6b837b5b16d9f5cdc448d029e1fe65860fd1137694bdba73a5c83faf17`  
		Last Modified: Tue, 14 May 2024 14:25:38 GMT  
		Size: 26.9 MB (26920390 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c28d995c45cfb672a7f1766d3901d6880c4466a58afeb09e801e25968ef0ada8`  
		Last Modified: Tue, 14 May 2024 14:25:45 GMT  
		Size: 29.0 MB (29040486 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5ab4f6c7f4c20973896cb46d4bb0bb6181f562fa57cfb95ab44afc7f1135aa4`  
		Last Modified: Tue, 14 May 2024 14:25:14 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1fe0822f26208989fc5fa273ef3ea20363ad3424ad6a54842f4433d5a450b357`  
		Last Modified: Tue, 14 May 2024 14:25:12 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29ad379e115452d8a328d53836d4d00463ca5a3d754349a9b095d1640abe8be9`  
		Last Modified: Tue, 14 May 2024 14:25:12 GMT  
		Size: 19.2 KB (19161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24e0401c68abd8427d996faed437b4117f2e35a309636f9ab49dc4e7882a6168`  
		Last Modified: Tue, 14 May 2024 14:25:46 GMT  
		Size: 23.7 MB (23695965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99fc7416277a1ac503fd09f20c82d2d614ed3baf560fd1c26e045c48a2e95a80`  
		Last Modified: Tue, 14 May 2024 14:25:12 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84fe8bc737c89c01a946d8c51679f4597084606e64986ea15bcbe4e5e62d5dda`  
		Last Modified: Tue, 14 May 2024 14:25:12 GMT  
