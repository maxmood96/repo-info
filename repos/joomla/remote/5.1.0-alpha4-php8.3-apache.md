...
```console
$ docker pull joomla@sha256:f4848fe9a795f994b2db52ce49f3a6a97d55cc20dd4a48795af72a632d9e6f96
```
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; arm variant v5
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.3-apache` - linux; s390x
