...
```console
$ docker pull joomla@sha256:815ca8c83aaba1b9d9a82169ef8c3824b186964782077290771a67c7b6cde7ed
```
...
```console
$ docker pull joomla@sha256:778a429ab07ff4b96fcb12f25167cb2a923c5e9a85560559460994264b2c1a28
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **232.1 MB (232061052 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4593d752ed25a9dd2a4110ed7531ae79398ad1a5a61ff314fc6afc5552cfa02`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Wed, 21 Aug 2024 21:25:05 GMT
ENV JOOMLA_VERSION=5.2.0-beta1
# Wed, 21 Aug 2024 21:25:10 GMT
ENV JOOMLA_SHA512=ba0a8a84acd1c603766dbd8ca08e6aeb84c223b762fb73a98385357ba959eaaa27eb798a1b73ed082941163da110e84c103be5a94c0c48f32248cd795e00e8a7
# Wed, 21 Aug 2024 21:25:39 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Aug 2024 21:25:47 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Wed, 21 Aug 2024 21:25:54 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Wed, 21 Aug 2024 21:26:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 21 Aug 2024 21:26:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:15c35951501ae7de46d4971e11fd5ad7c65b0ceb3bc25027cd7a7da2c9ee054e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92cd60ef2c5a510ed2210d62752094743ad74ebe22561e864bafeb03adf47d69`  
		Last Modified: Wed, 21 Aug 2024 21:46:27 GMT  
		Size: 23.4 MB (23366034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c04c674afe9ae9ddf3d583b8529f5eea5dcf236904752870ee19362094ede1b`  
		Last Modified: Wed, 21 Aug 2024 21:46:05 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2b4109151d553b3d5cfe01604d4793cbe358febd9a090fd18fdb062527792938`  
		Last Modified: Wed, 21 Aug 2024 21:46:05 GMT  
		Size: 1.1 KB (1068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
