...
```console
$ docker pull joomla@sha256:7754482cd087c49d2a5d15fb015e2a2ca3fda613fa873a275b48e1085a1e00c5
```
...
```console
$ docker pull joomla@sha256:9c7c9fa628fec7d7b6b05e0f279aaaaf672e7ccf5f77131e084b849c6cf55dac
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **266.2 MB (266244460 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fdb4f08fe3557c7527462a294833da1980ecd846ff55b66fb4e6e5536592f2d1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 07 Sep 2024 04:21:55 GMT
VOLUME [/var/www/html]
# Sat, 07 Sep 2024 04:21:56 GMT
ENV JOOMLA_VERSION=5.2.0-beta2
# Sat, 07 Sep 2024 04:21:56 GMT
ENV JOOMLA_SHA512=ca08e2ac23e2671610f66a492d906fdbb2bb0b7cd8da235d4da861c6a5f097f0d6e5e7d84ddf5316ea685a39fd3222dae58a9ac98e3005ee41f5fc673b033355
# Sat, 07 Sep 2024 04:22:03 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta2/Joomla_5.2.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 07 Sep 2024 04:22:05 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 07 Sep 2024 04:22:05 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 07 Sep 2024 04:22:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 07 Sep 2024 04:22:06 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:66adbc1a2478bd4896cf5db4f0c7b219b11c3b28f62880260e75e97a748b5575`  
		...
		Size: 19.2 KB (19156 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df7dd8c67772a5c769c1ca721844ff52c966045b233f37020cedd8fd74b708c2`  
		Last Modified: Sat, 07 Sep 2024 05:00:20 GMT  
		Size: 23.4 MB (23441580 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:55e0b03197ae4a41d381a197eeb0854809494940da0e552f487143409f927472`  
		Last Modified: Sat, 07 Sep 2024 05:00:10 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d160133048bb54adb174d5569ed85deb64ccb0858da861226f5cb288828af0b8`  
		Last Modified: Sat, 07 Sep 2024 05:00:10 GMT  
		Size: 1.1 KB (1069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
