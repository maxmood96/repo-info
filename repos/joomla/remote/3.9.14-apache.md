...
### `joomla:3.9.14-apache` - linux; amd64
...
### `joomla:3.9.14-apache` - linux; arm variant v5
...
### `joomla:3.9.14-apache` - linux; arm variant v7
...
### `joomla:3.9.14-apache` - linux; arm64 variant v8
...
### `joomla:3.9.14-apache` - linux; 386
...
### `joomla:3.9.14-apache` - linux; ppc64le
