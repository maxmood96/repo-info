...
### `joomla:4.4.0-beta1-php8.1-apache` - linux; arm variant v5
...
### `joomla:4.4.0-beta1-php8.1-apache` - linux; arm variant v7
...
### `joomla:4.4.0-beta1-php8.1-apache` - linux; mips64le
...
### `joomla:4.4.0-beta1-php8.1-apache` - linux; ppc64le
