...
```console
$ docker pull joomla@sha256:49c630e39f61f8305341af0a40737e87533cfaf472222ecb8c996ed08cd22d51
```
...
### `joomla:4.1.3-php8.1-fpm-alpine` - linux; amd64
...
### `joomla:4.1.3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.1.3-php8.1-fpm-alpine` - linux; ppc64le
