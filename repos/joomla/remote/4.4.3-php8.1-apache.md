...
```console
$ docker pull joomla@sha256:130b008319149674c39fa9ccf0f8b507586b70693d4f5b470a6db9e1be6e6888
```
...
### `joomla:4.4.3-php8.1-apache` - linux; amd64
...
### `joomla:4.4.3-php8.1-apache` - linux; arm variant v5
...
### `joomla:4.4.3-php8.1-apache` - linux; arm variant v7
...
### `joomla:4.4.3-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:4.4.3-php8.1-apache` - linux; 386
...
### `joomla:4.4.3-php8.1-apache` - linux; mips64le
...
### `joomla:4.4.3-php8.1-apache` - linux; s390x
