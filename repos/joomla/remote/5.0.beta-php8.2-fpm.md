...
```console
$ docker pull joomla@sha256:2431aa58cfaab95e33e986fe2781927ad7085ce4d64393fc7a8b36e333e6dca9
```
...
```console
$ docker pull joomla@sha256:dcbea8e7f590d6d22377314528fbb9aa84722223a6784078f8e78d615c1d2ebc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.7 MB (189666552 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db415f5f53d92a2546f75353715c6deb38c1705d4a26c77429e1e8e0e592925d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Sep 2023 06:20:53 GMT
CMD ["php-fpm"]
# Thu, 21 Sep 2023 09:07:20 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 21 Sep 2023 09:07:21 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 21 Sep 2023 09:07:30 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 09:09:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.22; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 21 Sep 2023 09:09:49 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 09:09:49 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 21 Sep 2023 09:09:49 GMT
...
# Thu, 21 Sep 2023 09:09:49 GMT
ENV JOOMLA_VERSION=5.0.0-beta2
# Thu, 21 Sep 2023 09:09:50 GMT
ENV JOOMLA_SHA512=e7b613b818ed2406c164ee7520779ab50cf5c700a9b54e64256ed3b150103a9dc3e2cbaad06030eafea0d63b3f0314024a716f1e1c456eea13733508daddbcd8
# Thu, 21 Sep 2023 09:09:56 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/5.0.0-beta2/Joomla_5.0.0-beta2-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Sep 2023 09:09:56 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Thu, 21 Sep 2023 09:09:57 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 21 Sep 2023 09:09:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Sep 2023 09:09:57 GMT
...
-	Layers:
	...
	-	`sha256:9ef0b92eb278d9bb1109f03e505cd2b1ccbcf8c9eb9aba0506ba06ead4da2f17`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae126ddb54f727bfcf14f5982efedbaa9f2ca60b78b679325867264635a8a6ca`  
		Last Modified: Thu, 21 Sep 2023 09:25:36 GMT  
		Size: 25.2 MB (25166313 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de76ad6227e0d984d0afd9334e1be1922936ab53a846f2845e85942df33381a1`  
		Last Modified: Thu, 21 Sep 2023 09:25:32 GMT  
		Size: 3.2 MB (3246656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ecfaaa19d09eb7c19c8c4d6d41fff115e7af049fa3aa8b99e78d18a9c65ca83`  
		Last Modified: Thu, 21 Sep 2023 09:25:30 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f2dc003ffe07ba39a4af4c06a864bda8daedc7426581ee6e9d02986526547f70`  
		Last Modified: Thu, 21 Sep 2023 09:25:30 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cfebc9e5c7dc578e63a538e923eac17759d0505a3b2ce9a7d7a375ee6be235e`  
		Last Modified: Thu, 21 Sep 2023 09:25:35 GMT  
		Size: 22.5 MB (22460972 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba43da69909363da775007159c1c685336e8f09d7e562c3fa2efc2ff21eabaf4`  
		Last Modified: Thu, 21 Sep 2023 09:25:30 GMT  
		Size: 1.8 KB (1839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74f2256431c449043403006437cccb7f911f34c768e107e51cc2c5b8968eb399`  
		Last Modified: Thu, 21 Sep 2023 09:25:30 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:2a060322bc6c2646e8c7547618504c3d646119c3d43b33565594367df9d64bad
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.2 MB (231219379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b54cd1b4fa9695291d2b0c87f7f602fea9dc483907307241fac16e1acd454c10`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Sep 2023 12:06:47 GMT
VOLUME [/var/www/html]
# Thu, 21 Sep 2023 12:06:48 GMT
ENV JOOMLA_VERSION=5.0.0-beta2
# Thu, 21 Sep 2023 12:06:48 GMT
ENV JOOMLA_SHA512=e7b613b818ed2406c164ee7520779ab50cf5c700a9b54e64256ed3b150103a9dc3e2cbaad06030eafea0d63b3f0314024a716f1e1c456eea13733508daddbcd8
# Thu, 21 Sep 2023 12:06:59 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/5.0.0-beta2/Joomla_5.0.0-beta2-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Sep 2023 12:07:01 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Thu, 21 Sep 2023 12:07:02 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 21 Sep 2023 12:07:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Sep 2023 12:07:02 GMT
...
-	Layers:
	...
	-	`sha256:d106339a7178c892948ead30d46743e300ba20cbfe124a2748ed05386d753cb1`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7cfef49e1d5a25ca660f654b273ccc5a847bbb76d288a72efc20b7df13ee111c`  
		Last Modified: Thu, 21 Sep 2023 12:35:34 GMT  
		Size: 22.5 MB (22460974 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9be8beace52b69ce10a4c15e331ccfe51a804aacacdc144a45f05dd96558badc`  
		Last Modified: Thu, 21 Sep 2023 12:35:27 GMT  
		Size: 1.8 KB (1839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef963878b82edbe91d508caaaf79d5119dafb805907195fd7cd6717bf411aad8`  
		Last Modified: Thu, 21 Sep 2023 12:35:27 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
