...
```console
$ docker pull joomla@sha256:0a0dba4b168c0605e7c100897f7c03e8ecabdc1ac83fcc5ec9424c6dff23f3e2
```
...
### `joomla:3.10.9-php7.4` - linux; amd64
...
### `joomla:3.10.9-php7.4` - linux; arm variant v5
...
### `joomla:3.10.9-php7.4` - linux; arm variant v7
...
### `joomla:3.10.9-php7.4` - linux; arm64 variant v8
...
### `joomla:3.10.9-php7.4` - linux; 386
...
### `joomla:3.10.9-php7.4` - linux; mips64le
...
### `joomla:3.10.9-php7.4` - linux; ppc64le
...
### `joomla:3.10.9-php7.4` - linux; s390x
