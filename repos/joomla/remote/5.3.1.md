...
```console
$ docker pull joomla@sha256:f790f4a90457535a68cb0643d9457db6aabf24190b9ff72f92694c2ea7e19cda
```
...
### `joomla:5.3.1` - linux; arm variant v5
...
### `joomla:5.3.1` - linux; arm variant v7
...
### `joomla:5.3.1` - linux; arm64 variant v8
