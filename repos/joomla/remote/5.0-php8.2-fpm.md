...
```console
$ docker pull joomla@sha256:eeb6b660e7331f35af08f791fe2d1136e3d8f03136957b5def648b4a817604aa
```
...
```console
$ docker pull joomla@sha256:853b3b8e50fa7e1b71e85c3a4f097b5c06d2686887acc2e6c23b9803b08593de
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.5 MB (230452039 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:472052bee34457434a95c19291537178ae5dab235653eea8520de6a674361be3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 09 Apr 2024 09:56:16 GMT
ENV JOOMLA_VERSION=5.0.3
# Tue, 09 Apr 2024 09:56:21 GMT
ENV JOOMLA_SHA512=5fa4a0fdae08f8ea71216337b02f4f8dcf75b8d001fc82c0987041844cc263e78ca8244a0fbbc4a3e53055c8e09a1533464d90ea118ebd79b2b1b972807c532e
# Tue, 09 Apr 2024 09:56:52 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.3/Joomla_5.0.3-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 09 Apr 2024 09:57:00 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 09 Apr 2024 09:57:06 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 09 Apr 2024 09:57:12 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Apr 2024 09:57:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6ea4a2b64cf9e4c45bc5aeae37660980a8c20264665db400a895c74b67e8fc06`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87a7645ba48611755d15b74c2bd427cba1cfc206edfcc15a8ea735b8c47adefb`  
		Last Modified: Tue, 09 Apr 2024 11:06:38 GMT  
		Size: 22.5 MB (22522369 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bfd7953f7f86553b89558e32a29520119ddef7da50a6ad53e85942c32f88a1da`  
		Last Modified: Tue, 09 Apr 2024 11:06:17 GMT  
		Size: 2.7 KB (2739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7fc2ce702b146dad71868ad860eff26899a5d8f0d5defda67d3ff591fc52445`  
		Last Modified: Tue, 09 Apr 2024 11:06:17 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
