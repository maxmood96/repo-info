...
```console
$ docker pull joomla@sha256:251632ab7bf3777a4f5019d0d8906774c70a83d0316aa28e6dacd95dcc68f69a
```
...
```console
$ docker pull joomla@sha256:3f74951726b4bc8c7e0ba97cd4715923a268ea8361a48265787ed43757fd0600
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.0 MB (308963569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:540b1fdaeb036a2cde66e5a4265d33150879143562bbd11659001ff811743c94`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 23 Nov 2025 07:22:50 GMT
ENV JOOMLA_SHA512=ca19ea39f8cc1ef10b07abb84080d07f52e34d158522bf0b625948c4a077504cacdbe70e8eea80a3df381f21889a8f62367a9d8def861fa43d671f72b8daa73e
# Sun, 23 Nov 2025 07:23:02 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/6.0.0/Joomla_6.0.0-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla # buildkit
# Sun, 23 Nov 2025 07:23:03 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Sun, 23 Nov 2025 07:23:03 GMT
COPY makedb.php /makedb.php # buildkit
# Sun, 23 Nov 2025 07:23:03 GMT
...
-	Layers:
	...
	-	`sha256:e87456d12a0622a4cf8207e6cb2c01c77ac62481bca9dde5cf8aefeaaafe28d8`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a9eb072c5d9539204138ed1435163063b50895289b64a3b54dfb9931708412cf`  
		Last Modified: Sun, 23 Nov 2025 07:25:40 GMT  
		Size: 26.0 MB (25957982 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bad8f1ecafd2ae7e913381afae1bb94b043bd8e0c398cab960abb7ed45c53ac4`  
		Last Modified: Sun, 23 Nov 2025 07:25:38 GMT  
		Size: 3.7 KB (3655 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5ebb3a48b127a416c259847d25ec75414290cf4adae0505beb1e5c79127219e0`  
		Last Modified: Sun, 23 Nov 2025 07:25:38 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:1c3a04eb96d1f21a1d0a76385fa097ee4a4aa3ea13f367ecda7bb21c350f1756
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.5 KB (61512 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d9abf9e91afd1357ee4786dce3457d23c271acbafe52274fbb50a573bee026af`

```dockerfile
```

-	Layers:
	-	`sha256:93ebdccf9cd73cea65e1549096f8573f29bcf41d55f0eca1271a1e6667a8b6a2`  
		Last Modified: Sun, 23 Nov 2025 08:44:03 GMT  
