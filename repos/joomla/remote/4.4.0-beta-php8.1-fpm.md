...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; amd64
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; arm variant v5
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; arm variant v7
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; arm64 variant v8
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; 386
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; mips64le
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; ppc64le
...
### `joomla:4.4.0-beta-php8.1-fpm` - linux; s390x
