...
```console
$ docker pull joomla@sha256:68e24729950863a7eb602e67cce2ea67076002e4a57be6ce3dbcb6c2055efdcd
```
...
```console
$ docker pull joomla@sha256:3ff2a21996ec4e4c165797f4a6448daf1f3240c5386cda381bdf75d356b7e575
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.3 MB (71275165 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed69b9e8a00ee263434a1c3125163cf082a75600f1b676a8736bd423e6e6c66d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 01:21:25 GMT
CMD ["php-fpm"]
# Fri, 11 Mar 2022 04:46:43 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Mar 2022 04:46:44 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Mar 2022 04:46:47 GMT
RUN apk add --no-cache 	bash
# Fri, 11 Mar 2022 04:51:15 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 11 Mar 2022 04:51:16 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 04:51:16 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 04:51:17 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 04:51:36 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 04:51:37 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 04:51:38 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 04:51:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 04:51:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f78750038fa7ed2fdaf0af99420e57053482249405572f2fcb723e999dcfc916`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:673b1bcb17f6465160a3cecb71b58d1505a39907d7ac235fa64a9e2aeabd220b`  
		Last Modified: Fri, 11 Mar 2022 05:04:07 GMT  
		Size: 455.3 KB (455282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:36d6bd8e9965c2fbdbdfd2ac5397df429d00bba7cd784e3058135ddeae9f251a`  
		Last Modified: Fri, 11 Mar 2022 05:04:15 GMT  
		Size: 19.9 MB (19939651 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70a36776fbe17e0b33ae683c2a3ca1de1c4af46f1b314ebebd63b0157c25626c`  
		Last Modified: Fri, 11 Mar 2022 05:04:21 GMT  
		Size: 22.3 MB (22287096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b479a3e29c1e14f649855f6a175b84ea9b3eb28381157c5a4e0f5406b30d6a1`  
		Last Modified: Fri, 11 Mar 2022 05:04:07 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:313a057f72b58bbe1b910e6eb8ee997a889d88c4089e0e83572e5dcb72725e12`  
		Last Modified: Fri, 11 Mar 2022 05:04:07 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:4392925dd06de977f17cd3a92b733c8dc35048578fbff61456eedecbe8e32b90
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **73.4 MB (73422669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcfbfcd6d6e2f0a21543bb1336b26f0ad55eef2ec426689a7fd869f469a0a151`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Mar 2022 11:55:02 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Mar 2022 11:55:03 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Mar 2022 11:55:05 GMT
RUN apk add --no-cache 	bash
# Fri, 11 Mar 2022 11:56:56 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 11 Mar 2022 11:56:57 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 11:56:58 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 11:56:59 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 11:57:09 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 11:57:10 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 11:57:11 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 11:57:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 11:57:12 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a732378ab8830c861b6b6fc0e08277915fa0de954ef3d9aadec1708115b5f7ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:379cd3e4eabd5e52a6a0a1689807bfece9384720919d3bc036164459e262b9fa`  
		Last Modified: Fri, 11 Mar 2022 12:17:30 GMT  
		Size: 474.1 KB (474055 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa4ab861d33ecacb45c007987693d7a3f05b3171965fe36bccdca53e602b0137`  
		Last Modified: Fri, 11 Mar 2022 12:17:33 GMT  
		Size: 20.7 MB (20689740 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:212d934bdd83cac26d0f5f0d72ec1a80b2773fdbff5930a33631752c45a6f9d5`  
		Last Modified: Fri, 11 Mar 2022 12:17:34 GMT  
		Size: 22.3 MB (22284102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b28d1413985c265745605fcd52a53726cb385dfdc0b8d23c4448591b1378520a`  
		Last Modified: Fri, 11 Mar 2022 12:17:30 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7f98cb32f5cf45af9118ed6c3e5d18d9cdd790376f0126c564f98472bce637b`  
		Last Modified: Fri, 11 Mar 2022 12:17:30 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:3580453f99fb0d070aa44295239727a2b71c16c680db3eec0cd7792da3bf7ebf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.2 MB (72163646 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd8678ea6afd2fb845614f8ea468661d404782fe85287e77ddbfa260b0abc7f7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Mar 2022 01:38:44 GMT
CMD ["php-fpm"]
# Fri, 11 Mar 2022 10:54:59 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Mar 2022 10:55:00 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Mar 2022 10:55:03 GMT
RUN apk add --no-cache 	bash
# Fri, 11 Mar 2022 10:58:03 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 11 Mar 2022 10:58:05 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 10:58:06 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 10:58:06 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 10:58:24 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 10:58:30 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 10:58:31 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 10:58:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 10:58:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:83d6c335a9268a01e2bedc0381448287edc619dd7d87595ae050da34d4870bef`  
		...
		Size: 8.6 KB (8617 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4235fecf8e2191fe367054226b511fe403b8dd9fe9192be108a068f78ea0666e`  
		Last Modified: Fri, 11 Mar 2022 11:27:07 GMT  
		Size: 483.6 KB (483638 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c1b31a8172223f95ac4656939eb560b2add43b47dced58d330f78803f3d17ea`  
		Last Modified: Fri, 11 Mar 2022 11:27:10 GMT  
		Size: 20.5 MB (20466534 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8e6b594076f819fcca91d6fcbf45eb66166bdd5348e41dbf5e44644f17cc9bc`  
		Last Modified: Fri, 11 Mar 2022 11:27:10 GMT  
		Size: 22.3 MB (22287110 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8edbc16d1ad25a9c877270baf9c89c956dcddcaa6493705146e00cf12ac5e965`  
		Last Modified: Fri, 11 Mar 2022 11:27:07 GMT  
		Size: 1.8 KB (1826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69342a184905ba54ddf90ef08ef5a1fdaa4cc462192d6198fd930de51a4c15e5`  
		Last Modified: Fri, 11 Mar 2022 11:27:07 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
