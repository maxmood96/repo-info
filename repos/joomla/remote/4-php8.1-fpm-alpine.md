...
```console
$ docker pull joomla@sha256:41b8f8e70ab673f322962a0c216821a4e856d09c7d1da30e64056da14d1c4c55
```
...
```console
$ docker pull joomla@sha256:45fbecee8418eb95529b2ccabfd546905be4c440cc37909a760a7395b8e03f80
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107207550 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac5796cec3d2761c5d10e7b52a2403f47e00c678bef45ba37963c1f3c8eb5625`
...
-	Layers:
	...
	-	`sha256:82fe0ccd2bf9673c80813815d3a5f8e97f4cd126d679f2b31f982782cb46b1ad`  
		...
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16d38b837af7e4b5bfb2e8bdb18a7c86a2ce2d647ebe83cee0cad8e94c02a262`  
		Last Modified: Wed, 09 Nov 2022 21:26:10 GMT  
		Size: 23.9 MB (23929968 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11a4bd09d885eee0a78f1bff4d0c7d76d161522576dbced5ed9b2c8429efa0b2`  
		Last Modified: Wed, 09 Nov 2022 21:26:06 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:467eedf634b354116aa8e6e61e9ce94329e6d258b25b3d8ca36036c9573fcb53`  
		Last Modified: Wed, 09 Nov 2022 21:26:06 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:76909c7464a4642ea7fde87223944f20fd1bb7b8ee6afaeaa6bf05f769d1a2e7
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.6 MB (102617719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:991549ed78dbfd6d25f79fa621f13ed10100531997446b786af8ef0bf2a962c5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 05:54:03 GMT
CMD ["php-fpm"]
# Fri, 11 Nov 2022 13:43:40 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Nov 2022 13:43:40 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Nov 2022 13:43:48 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 11 Nov 2022 13:46:34 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Fri, 11 Nov 2022 13:46:35 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 13:46:36 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Nov 2022 13:46:36 GMT
VOLUME [/var/www/html]
# Fri, 11 Nov 2022 13:46:36 GMT
...
# Fri, 11 Nov 2022 13:46:36 GMT
ENV JOOMLA_SHA512=80c1721cb781c8bf709f2c2a8c78f45f52d13801ded1315a9fa9a36f03dee8b94a7714c04efcdda10b68b5dcc7da1b1066936ec3cce3bf40300fa3e534673588
# Fri, 11 Nov 2022 13:46:44 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.5/Joomla_4.2.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Nov 2022 13:46:45 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Nov 2022 13:46:45 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Fri, 11 Nov 2022 13:46:45 GMT
...
-	Layers:
	...
	-	`sha256:ba211a95577370f771c69311dde72fad37780253e50e1d56ed3fc246616628bd`  
		...
		Size: 8.6 KB (8619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9032f08110cef2a272ce305528b91aaa5e9151da3db8f5d8b331d132112cca99`  
		Last Modified: Fri, 11 Nov 2022 13:54:21 GMT  
		Size: 43.3 MB (43281209 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0cd5bbb7b6a32bf77877a5ca3157dd073f7294bc3d19da863232649b0253e744`  
		Last Modified: Fri, 11 Nov 2022 13:54:14 GMT  
		Size: 6.2 MB (6214661 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7c2441ca908e5ffbf3eb3fbbf78f91d2bee6631dd47c8c9ad096d5e5810be92b`  
		Last Modified: Fri, 11 Nov 2022 13:54:10 GMT  
		Size: 67.4 KB (67408 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f8fafd469891a75e84bd03e2c8e86498752f2366af376a359416fa7fcbbff63b`  
		Last Modified: Fri, 11 Nov 2022 13:54:10 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b415bb20c8b2f6a61ccf4bc6f2eec01598e79555b324c0bb1a4cd529db506b01`  
		Last Modified: Fri, 11 Nov 2022 13:54:16 GMT  
		Size: 23.9 MB (23930074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:342a089a4ecdf49ef87794a8f5b0f6bede1f37149410aa14c5d0fa9db5016e0d`  
		Last Modified: Fri, 11 Nov 2022 13:54:10 GMT  
		Size: 1.8 KB (1826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41b17cdc8f1fb08caf34a711d2c79c31b437a17fa595021ea4b06ca2942d1d47`  
		Last Modified: Fri, 11 Nov 2022 13:54:10 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c0e4025c6e919d392f6917488db03473da9c3b81b8a91f08d833d0bf0103da4b
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **97.8 MB (97773582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ea896c0f7a1ead894647a8d01d23769d1ad3a1d756fc84fa37d01f7ccb8e461`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 28 Oct 2022 22:14:30 GMT
VOLUME [/var/www/html]
# Wed, 09 Nov 2022 21:00:02 GMT
ENV JOOMLA_VERSION=4.2.5
# Wed, 09 Nov 2022 21:00:02 GMT
ENV JOOMLA_SHA512=80c1721cb781c8bf709f2c2a8c78f45f52d13801ded1315a9fa9a36f03dee8b94a7714c04efcdda10b68b5dcc7da1b1066936ec3cce3bf40300fa3e534673588
# Wed, 09 Nov 2022 21:00:09 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.5/Joomla_4.2.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 09 Nov 2022 21:00:10 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 09 Nov 2022 21:00:10 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 09 Nov 2022 21:00:10 GMT
...
-	Layers:
	...
	-	`sha256:2c0b02ea1d9fbd5fc658a91a14c6d9b1017e34d61046469ce30afa47f3d71e79`  
		...
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:718f8827204bafbf40cd49b0270e287c30035b2b33a49124f4241c2eb27d52d9`  
		Last Modified: Wed, 09 Nov 2022 21:07:59 GMT  
		Size: 23.9 MB (23930101 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f71bb110680944678392dd47d7cdda132c7898fd12b81d9b4468cb7469522a1`  
		Last Modified: Wed, 09 Nov 2022 21:07:53 GMT  
		Size: 1.8 KB (1826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42b0829b99226966d435c6319e73207a59a8b08edd956c0c0ff8e69dfa7fbe30`  
		Last Modified: Wed, 09 Nov 2022 21:07:53 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c367375fa2d4fddfca34ff9e2374f87f20df0225ab8c954cbc7bdd379e8310d2
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107181151 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82fc63b368dcc8a3995755514f1f28a1641d20109db5d830f881102aeb513361`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 11 Nov 2022 09:54:42 GMT
CMD ["php-fpm"]
# Fri, 11 Nov 2022 13:20:51 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Nov 2022 13:20:51 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Nov 2022 13:20:56 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Fri, 11 Nov 2022 13:22:45 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Fri, 11 Nov 2022 13:22:46 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Fri, 11 Nov 2022 13:22:46 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Fri, 11 Nov 2022 13:22:47 GMT
VOLUME [/var/www/html]
# Fri, 11 Nov 2022 13:22:47 GMT
ENV JOOMLA_VERSION=4.2.5
# Fri, 11 Nov 2022 13:22:47 GMT
ENV JOOMLA_SHA512=80c1721cb781c8bf709f2c2a8c78f45f52d13801ded1315a9fa9a36f03dee8b94a7714c04efcdda10b68b5dcc7da1b1066936ec3cce3bf40300fa3e534673588
# Fri, 11 Nov 2022 13:22:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.5/Joomla_4.2.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Nov 2022 13:22:52 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Nov 2022 13:22:52 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Fri, 11 Nov 2022 13:22:52 GMT
...
-	Layers:
	...
	-	`sha256:e0050f09412d4f121c4dc3e692c99b9885299d9b08be1f60eef5e1ce1a8cf48a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa8263521caf7a4f10ac62465109dbf089b41b5e78585c25dba1a33a11aea7c5`  
		Last Modified: Fri, 11 Nov 2022 13:29:12 GMT  
		Size: 46.1 MB (46119575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:687afea17f6e86e675a8d1a608ee13c4d866285245268ec852edc0d2f5b063bb`  
		Last Modified: Fri, 11 Nov 2022 13:29:07 GMT  
		Size: 6.5 MB (6521233 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5e0fa724d4bf696bfd4c9c651b89bf1f5c5fe96cb17b64d4be016fd12955a91`  
		Last Modified: Fri, 11 Nov 2022 13:29:04 GMT  
		Size: 67.4 KB (67407 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:887471fb81e868daabaf4db60fa7447dc7fd678efa45a34a4fe44458e6c9f7a3`  
		Last Modified: Fri, 11 Nov 2022 13:29:04 GMT  
		Size: 388.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78a715ed63d706f75879a90d90969c0627bc58dd4bf299f1be7323a59a83bd9c`  
		Last Modified: Fri, 11 Nov 2022 13:29:07 GMT  
		Size: 23.9 MB (23929969 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:352f57076e3926b2e3934bcc8c6ef759cdf2bfcdf71b5bbb97b36e015a42f9ac`  
		Last Modified: Fri, 11 Nov 2022 13:29:04 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3bcf6d1582c39402979e30852b13a7755054fddfca3dd5da1bf682da68af5dd0`  
		Last Modified: Fri, 11 Nov 2022 13:29:04 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:9ebbe2744352b38e4a80a4c8cc56543652e372e476b15f4a3d02fe0b05582afd
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.4 MB (106425382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3939f5fe39bddcb56ec21c31e75656dda7c07e31c37160539b09b31bb18e08a7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 09 Nov 2022 20:41:14 GMT
ENV JOOMLA_VERSION=4.2.5
# Wed, 09 Nov 2022 20:41:15 GMT
ENV JOOMLA_SHA512=80c1721cb781c8bf709f2c2a8c78f45f52d13801ded1315a9fa9a36f03dee8b94a7714c04efcdda10b68b5dcc7da1b1066936ec3cce3bf40300fa3e534673588
# Wed, 09 Nov 2022 20:41:24 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.5/Joomla_4.2.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 09 Nov 2022 20:41:25 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 09 Nov 2022 20:41:26 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 09 Nov 2022 20:41:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Nov 2022 20:41:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c4e1e773ed2a27ca53424d4af49a5a6d9bf1155e0a8df2527b01888c5054e883`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ebeb41f32b595a2a0e681c5074856641fc0696fa4ddd50a752c4dd685055e7ca`  
		Last Modified: Wed, 09 Nov 2022 20:47:53 GMT  
		Size: 23.9 MB (23933361 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cff3adaa04eb939c6d7d23f444f395f77e7acc5ebcb5e5e22de94d016c7b276b`  
		Last Modified: Wed, 09 Nov 2022 20:47:50 GMT  
		Size: 1.8 KB (1826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11df2d7a09a0f08659bfff88ad71025aae015010ddb803c9f94260ab9d886c12`  
		Last Modified: Wed, 09 Nov 2022 20:47:49 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:b520b5df2375fb2defa8af913f3cbbbe57d07f14e58cd1577f3cf8194167d511
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.6 MB (96597238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f5a6fe2a89975fc878cd24cac49d8d5a1b24b5e7e3649c0f8a53034ccd1358fe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 09 Nov 2022 20:44:23 GMT
ENV JOOMLA_VERSION=4.2.5
# Wed, 09 Nov 2022 20:44:23 GMT
ENV JOOMLA_SHA512=80c1721cb781c8bf709f2c2a8c78f45f52d13801ded1315a9fa9a36f03dee8b94a7714c04efcdda10b68b5dcc7da1b1066936ec3cce3bf40300fa3e534673588
# Wed, 09 Nov 2022 20:44:32 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.5/Joomla_4.2.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 09 Nov 2022 20:44:35 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 09 Nov 2022 20:44:35 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 09 Nov 2022 20:44:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Nov 2022 20:44:36 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:339a3b98deb21281d0b21b1764a69923c935a1490d8d0c25ab82f6730d15dd92`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e63929c147d292db3465f320c293acd80eff085883db131881cf19f947120817`  
		Last Modified: Wed, 09 Nov 2022 20:49:55 GMT  
		Size: 23.9 MB (23929980 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24f2c11f6cac56b2de50bafb1648e5e687f998f4ff84da0dbfb936a7b95db290`  
		Last Modified: Wed, 09 Nov 2022 20:49:52 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26ef2c571f48c241ab708f63419ff1cea0d45f76562cb4281bc29f2abe71eb9c`  
		Last Modified: Wed, 09 Nov 2022 20:49:52 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
