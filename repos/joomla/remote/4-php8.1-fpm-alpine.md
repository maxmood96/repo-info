...
```console
$ docker pull joomla@sha256:38a8c9e683b7aec908746700daf92f273d3cbf276a74801cb2d8de9fd0753cce
```
...
```console
$ docker pull joomla@sha256:5a867023df00ad92fa1843f133acfe53b29a770f6baefa88934cf06201f60cee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.9 MB (91876326 bytes)**  
...
# Sat, 27 Jan 2024 10:24:25 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 27 Jan 2024 10:26:38 GMT
...
-	Layers:
	...
	-	`sha256:fb76a595cc34e09f53e685b4dac0f164bb2e57258fb78a80fe240db3e66a3def`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d47dfd2c321780a3ffbf756c2e58525a9fcb99f285ec088378acc0fb92f50784`  
		Last Modified: Sat, 27 Jan 2024 10:32:25 GMT  
		Size: 28.6 MB (28637434 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42b478020e5935f34b2d21ddb0e3961888c87680a3a1db3f803b2d77c12a04be`  
		Last Modified: Sat, 27 Jan 2024 10:32:22 GMT  
		Size: 6.9 MB (6915847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89fb1f64c603ab2cc53e548dfa56fc0953d1f5ab01725ab5f1a1f826c4a7ea7f`  
		Last Modified: Sat, 27 Jan 2024 10:32:19 GMT  
		Size: 61.1 KB (61096 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fbfc127b6fe04c0691a8636fd91bbe1f831f78c79dbdc7cb56d66cb64b167551`  
		Last Modified: Sat, 27 Jan 2024 10:32:19 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e8c65483e4f10624072ec4591780f79fb5e190ff6a4341d627f31dc6d7be5a3c`  
		Last Modified: Wed, 21 Feb 2024 19:06:38 GMT  
		Size: 25.5 MB (25519529 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c733b7c7d03f2df2794e93f8bd55cddb5b32f7caaa61cfb04b09b0002c91bf52`  
		Last Modified: Wed, 21 Feb 2024 19:06:35 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780ae62e8be75aed6d75d77b90c44efb87c75711b2a26af19725d0ff0a08073e`  
		Last Modified: Wed, 21 Feb 2024 19:06:34 GMT  
...
```console
$ docker pull joomla@sha256:fbebcefce3b09b0886fdf69b517a008c7813c403c7ec567e8bbdd8d952d53d6d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.7 MB (89674719 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e01f7d0fe3251bb96c34319cf15ff11b948f47981620b000945e2002a425589`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 09:49:41 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 27 Jan 2024 09:59:28 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 27 Jan 2024 10:01:42 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 27 Jan 2024 10:01:44 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 27 Jan 2024 10:01:44 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 27 Jan 2024 10:01:44 GMT
VOLUME [/var/www/html]
# Wed, 21 Feb 2024 23:45:52 GMT
ENV JOOMLA_VERSION=4.4.3
# Wed, 21 Feb 2024 23:45:52 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Wed, 21 Feb 2024 23:45:59 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Feb 2024 23:45:59 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 21 Feb 2024 23:45:59 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 21 Feb 2024 23:46:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 21 Feb 2024 23:46:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9b1d4d2d4d9959b46b726ab6705197bd0ae1aa2acca8582a6f241e46b41d4c5a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4eba4805c4d0d438bf2f10950fcac94c1ef5c36e25f915bc2b04915aa22b7ab9`  
		Last Modified: Sat, 27 Jan 2024 10:06:51 GMT  
		Size: 28.2 MB (28163774 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5a5e55cac38ee37b1e149a030592887ab735526afbd6482863fd47ad746110a`  
		Last Modified: Sat, 27 Jan 2024 10:06:48 GMT  
		Size: 6.6 MB (6600817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:88ab142c5d558748cb47e487cc6e736fc27db28a5d3d47504cab20c35f131295`  
		Last Modified: Sat, 27 Jan 2024 10:06:45 GMT  
		Size: 61.1 KB (61102 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c44a0233ba07a2531092c532c990f99103db2a9ac4b1284a7206a7aa76fb28b`  
		Last Modified: Sat, 27 Jan 2024 10:06:45 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19e544cdd67448e26f4a7d61a0a063c22dcbd6b702b474c0d2e8e69aeed73852`  
		Last Modified: Wed, 21 Feb 2024 23:48:15 GMT  
		Size: 25.5 MB (25519540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5a5439ea453b846b234da9bc2e63951c5cd9e32339c14deae1fa08f2d4be23c`  
		Last Modified: Wed, 21 Feb 2024 23:48:09 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:516e1aecc8216b920edd06fa8b67878f0af20ff7797c42bf9724d38922a2dded`  
		Last Modified: Wed, 21 Feb 2024 23:48:09 GMT  
...
```console
$ docker pull joomla@sha256:fec6a28ec56ff5539935f528b992bd5f149d43e01fe4836a2b83067cd64da935
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **87.0 MB (86966260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39c6ed1013334c84ecf17fe3cb0d2c7ab452e23a4aa5d961bb3d68dbabe67927`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 27 Jan 2024 11:40:40 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 27 Jan 2024 11:45:19 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 27 Jan 2024 11:45:22 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 27 Jan 2024 11:45:24 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 27 Jan 2024 11:45:25 GMT
VOLUME [/var/www/html]
# Wed, 21 Feb 2024 19:37:23 GMT
ENV JOOMLA_VERSION=4.4.3
# Wed, 21 Feb 2024 19:37:23 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Wed, 21 Feb 2024 19:37:38 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Feb 2024 19:37:40 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 21 Feb 2024 19:37:41 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 21 Feb 2024 19:37:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 21 Feb 2024 19:37:41 GMT
...
-	Layers:
	...
	-	`sha256:38daadf7cbf584ef5d0b2ed818ee671254a42c226c250dd30757d2ca2afc393f`  
		...
		Size: 8.9 KB (8879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b437a5896bd6e66a2d301ed015172083136f29de8379556d79813a90606a7b9`  
		Last Modified: Sat, 27 Jan 2024 11:55:25 GMT  
		Size: 26.6 MB (26598256 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e2ad6d8afa68ea6e1583aa209657ce6badf065df645e6ad841c7e877082f303`  
		Last Modified: Sat, 27 Jan 2024 11:55:20 GMT  
		Size: 6.6 MB (6567530 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60868b0028f71479cbb4d1d2ef8e500acdf868e48b006914de320d2096ff4603`  
		Last Modified: Sat, 27 Jan 2024 11:55:16 GMT  
		Size: 61.1 KB (61075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a0562fc61eb3c9c9f562ddc8df5c04b50e65a6765e5f196434b08685b33dbb5e`  
		Last Modified: Sat, 27 Jan 2024 11:55:16 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:acf5fb0c2088f58a4a785753269aa5413724d4407c8798bd6501de90f721314a`  
		Last Modified: Wed, 21 Feb 2024 19:48:26 GMT  
		Size: 25.5 MB (25519528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6649b57d7cdb97efc1e6709a99cfaa237b5182df283c422b461e448c851cc5ec`  
		Last Modified: Wed, 21 Feb 2024 19:48:20 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ff59387ae80e179d7881748edbe2e10a5080edd4d4f50f5d65adc7eeec4c33b`  
		Last Modified: Wed, 21 Feb 2024 19:48:20 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:04e227b00b92ba286a2fd7f41d883bb425766de00e1a3c5e7ad49a2ecec467d1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.1 MB (92050972 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b8fedeb8ba39d77963e7bf921527bda5656e660d2a801a3cc8d3d5ad220eccb7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 10:19:29 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 27 Jan 2024 10:28:49 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Sat, 27 Jan 2024 10:30:44 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Sat, 27 Jan 2024 10:30:45 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Sat, 27 Jan 2024 10:30:46 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Sat, 27 Jan 2024 10:30:46 GMT
VOLUME [/var/www/html]
# Wed, 21 Feb 2024 19:07:28 GMT
ENV JOOMLA_VERSION=4.4.3
# Wed, 21 Feb 2024 19:07:28 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Wed, 21 Feb 2024 19:07:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Feb 2024 19:07:33 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 21 Feb 2024 19:07:33 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 21 Feb 2024 19:07:34 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 21 Feb 2024 19:07:34 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6f681dc3e8a7d16b88de580063a919552fb36158f8a8fb5c4a113009af73d5ff`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf4228b899fb60318b2b44b07e9315eb047e2e7471d42d7e069672a8d4c4b031`  
		Last Modified: Sat, 27 Jan 2024 10:36:12 GMT  
		Size: 28.8 MB (28769877 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05b80ab09967e5f44feecad79b86d482bee2b2edea7d95256d02ee3db64ba4d8`  
		Last Modified: Sat, 27 Jan 2024 10:36:09 GMT  
		Size: 6.9 MB (6917031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:934f878305fc5d9e65028d9d55055182eb9fcfaee8073f3c9e49ad5962696672`  
		Last Modified: Sat, 27 Jan 2024 10:36:06 GMT  
		Size: 61.0 KB (61044 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d802f143fb91066e20dfe0a1e32d344c6e5947b5377f12c4678b4df2c89e5015`  
		Last Modified: Sat, 27 Jan 2024 10:36:06 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9be6d2681f34e9ca993a95699001405dcba6137630ea907c60a0e8b62d252614`  
		Last Modified: Wed, 21 Feb 2024 19:16:00 GMT  
		Size: 25.5 MB (25519539 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae84e2faebf78d01d31304d5a59d376a807b2e66107455cb0d48ab3259bd1e21`  
		Last Modified: Wed, 21 Feb 2024 19:15:57 GMT  
		Size: 2.7 KB (2739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e8a7b6177972d43d49053e4982c5cd6ade97b7241e486e735b8f5b55d69ee78`  
		Last Modified: Wed, 21 Feb 2024 19:15:57 GMT  
...
```console
$ docker pull joomla@sha256:49102ec070de419760e8ed78a323a3dd3793dc09d064819c9745e5758d0b923a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.4 MB (92433058 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d2106d8f3e0410cf7a687b37c765d054e5cd9cc8fd59f16bf1198f66d01cf44f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 08:54:49 GMT
VOLUME [/var/www/html]
# Wed, 21 Feb 2024 18:40:48 GMT
ENV JOOMLA_VERSION=4.4.3
# Wed, 21 Feb 2024 18:40:48 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Wed, 21 Feb 2024 18:40:57 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 21 Feb 2024 18:40:58 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 21 Feb 2024 18:40:58 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 21 Feb 2024 18:40:58 GMT
...
-	Layers:
	...
	-	`sha256:bfa60f01b865a28639d0f54ffcba14997f9cae54b57a56d29641672d21cfab36`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5f4a1f4f5184a05130267919ca8114fa62db68122eeb23f37ce9d2641f795fe`  
		Last Modified: Wed, 21 Feb 2024 18:50:03 GMT  
		Size: 25.5 MB (25519522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c84267138b395f714412a3988905a3c2cc9cdd04b4603efe19354b71293d7864`  
		Last Modified: Wed, 21 Feb 2024 18:49:55 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:37df87393b9d7faa0dccab613ccd14c9dbb2bb527bd0768bd9a6453db1653830`  
		Last Modified: Wed, 21 Feb 2024 18:49:56 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:b8d74f6efe2cc1407693499066218c9eef35a18735760682b283a076f064839b
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.2 MB (93193094 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:921825f5af693db840fcdfd02a589e9c33428072243c36b249b1230ae3c15cf3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Wed, 28 Feb 2024 00:47:13 GMT
ENV JOOMLA_VERSION=4.4.3
# Wed, 28 Feb 2024 00:47:14 GMT
ENV JOOMLA_SHA512=40be1f6d16430b4d0f7fde1ac2c96245388f28031790757e667b5ab52802105aec1ce51efdaa13576082218e0842c893d884a78f1ef358bec6fa1fb0a2cdabcd
# Wed, 28 Feb 2024 00:47:24 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.3/Joomla_4.4.3-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 28 Feb 2024 00:47:29 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 28 Feb 2024 00:47:29 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 28 Feb 2024 00:47:30 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 28 Feb 2024 00:47:30 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:594860ea8002601f58ea9a0ba2ffd483979dd2771a137ee68037e40cf0dd1c62`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67d8e0400426b4bc46a150e4000e0197279034148f0d97d0e647e7a16771509d`  
		Last Modified: Wed, 28 Feb 2024 01:00:16 GMT  
		Size: 25.5 MB (25519540 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0fd78fbb09b26e4db5ce6b01b680304f0a834c990f8723d67298948a58860040`  
		Last Modified: Wed, 28 Feb 2024 01:00:11 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d81658c168bcad158cdfdff4b36f231d3ce32cffb5e65ebeade59752a2ae8ea9`  
		Last Modified: Wed, 28 Feb 2024 01:00:11 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
