...
```console
$ docker pull joomla@sha256:c6c1da794fc94168c1344239e9c3bf17d3d90814a6e302e731e7c77edd68fc93
```
...
```console
$ docker pull joomla@sha256:c2e3629db55d29eaf5253458c7bb4a3511f8c6bcdc37c65f37e5e86af6a99a95
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.3 MB (92348758 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dbd712389d39ba32c233718126202285f4c5de6cba6beee05a4af555d79644b3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
```console
$ docker pull joomla@sha256:524466830503ffb64f23d8caf5ad11d95588edf54c26be46fc878edcc27276c2
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.1 MB (93088724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:79035ffee597346776b6676616bbf909f70c1d2b460ba774ff9018158ff74d91`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.5/Joomla_4.4.5-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:50:58 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:50:58 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:50:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Jun 2024 20:50:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a27dc35b0e98cbaca0580f39d1b12dee9ec3cb408a080481b9250b1a8765a722`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6380f3a04ea53552f0a44d0419a28f538c03d87f94523a4e36cf44c88466cf6e`  
		Last Modified: Fri, 14 Jun 2024 20:55:02 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:706db01ca7ba5c79dcc9fa422d1f2fc52773f1dfaadcafd1df7449ead6426204`  
		Last Modified: Fri, 14 Jun 2024 20:55:02 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
