...
```console
$ docker pull joomla@sha256:832b2d2c81b7ff47fddb6b8d866b7bc0ccc7b77a3fef8b7446a933d7a7ad5f06
```
...
```console
$ docker pull joomla@sha256:87e9bc6e6e1913e2787fabea5d73c887fd930f0eb5b4d0a949281f5dbb010aac
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.2 MB (106229385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4c7e9ee95ccba276da383c91c8a70af114e2682cf59ffbaa9e98fd416ee6fb3`
...
-	Layers:
	...
	-	`sha256:ec2afb70c698b1b93d4e3466d9565d784f87bde91639528299fafe1283227329`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d5ec6b6f1eb3d1ede0cc30597a7314b4c9cb42b139dfd308cd77d9413f0394c`  
		Last Modified: Wed, 15 Mar 2023 22:36:18 GMT  
		Size: 24.3 MB (24298864 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ba73d5f7a476a6e4f856e2cf68da74b92a67c427516c824d12b678496983ee7`  
		Last Modified: Wed, 15 Mar 2023 22:36:14 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0caa0ed65339b76ceb67392b76f5bc9ffa3b7d710b326a6340eb188c597159d0`  
		Last Modified: Wed, 15 Mar 2023 22:36:14 GMT  
		Size: 724.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:14da3e04015ff0524504fde68ab3fe698c33024988e7bd2690ea88f8121fc023
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.9 MB (99924868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:020133b518e89a2f55e4e3b16fa70a632479a6d41e10f1a087cdf37bc1f97442`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 14 Mar 2023 02:24:13 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 14 Mar 2023 02:24:20 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Tue, 14 Mar 2023 02:26:21 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 14 Mar 2023 02:26:22 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 14 Mar 2023 02:26:23 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 14 Mar 2023 02:26:23 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 21:50:46 GMT
ENV JOOMLA_VERSION=4.2.9
# Wed, 15 Mar 2023 21:50:46 GMT
ENV JOOMLA_SHA512=25805241234753c05f562cf3be599c63cfcfb2e7dcf6b5b76b1cb4b6a4d305497c720eaccdc0939e4fceffa83099db9b3c44963fce86bafc3efc2fc34fecaa20
# Wed, 15 Mar 2023 21:50:53 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.9/Joomla_4.2.9-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 15 Mar 2023 21:50:53 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 15 Mar 2023 21:50:53 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 15 Mar 2023 21:50:54 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 15 Mar 2023 21:50:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a573397c2215ba3935de4ac55a318d8dc4e7646b726bbaadb5568dea69ebd528`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64842fc39d9376b35a8a10fc6d3adb1b74676dbc83e4cebd0000db32125fe0f5`  
		Last Modified: Tue, 14 Mar 2023 02:30:05 GMT  
		Size: 41.2 MB (41218250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc16432e31ffe8b597b5d0db360fee8c0b2f80c6b448879a5cc083854a467254`  
		Last Modified: Tue, 14 Mar 2023 02:29:59 GMT  
		Size: 6.3 MB (6266089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:deb6f066a75a5ab9d5f9bf789522f3c6f139fe2c4d5974400d8712022e827fd6`  
		Last Modified: Tue, 14 Mar 2023 02:29:56 GMT  
		Size: 68.2 KB (68159 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bc289fcab9316e462d4327af2177da800d40f9d54e78a81fbb78e733aa4d8e0`  
		Last Modified: Tue, 14 Mar 2023 02:29:56 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7eabd47324ccf7140a899849ccf1e1ec9c381d782dfe4c2d18cfc0a1bd08aac`  
		Last Modified: Wed, 15 Mar 2023 21:51:54 GMT  
		Size: 24.3 MB (24298865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03aeb20c5bccfc101fbe404e26e4591e657457bb88b2ef44871adda4900eded8`  
		Last Modified: Wed, 15 Mar 2023 21:51:49 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1a11dbaf8b021f1d0a473c1d8dd79aadc72bc3062aa80a1f735280241d96157`  
		Last Modified: Wed, 15 Mar 2023 21:51:49 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:8059ce7b5101700e06d503822c5b2de51728f8e1ae8734553769ca57a7a0e2c2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **96.9 MB (96925617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d8f1706b9149c3b2fffb0ec95ee0ab79b0dee76dd22fce33e89802073ae415ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:903c261a3c631e9618fc9d114c3e65bc30b91bdf2969f0619c391f7eedc3baef`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b47cda8daee18959de8375c9a89b5d19edbd2cf5e7d9c25dc7a9f91240cbec73`  
		Last Modified: Wed, 15 Mar 2023 22:12:29 GMT  
		Size: 24.3 MB (24298860 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ce42c756114450ff5da28aaad5a9035e07dedd1c343252c7179866fdc5489638`  
		Last Modified: Wed, 15 Mar 2023 22:12:24 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:061cb3418fe88fbf5ea2cfbf25afe3cfd7c6aa4217d6503833d277a7d5d0d6a7`  
		Last Modified: Wed, 15 Mar 2023 22:12:24 GMT  
		Size: 724.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:409e83eaf10126fde17fb31b82b8af34e94b2e051a1e6926f8387b16d1af11df
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **104.7 MB (104709196 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8a70530dd37056db91715f48e3168440bd2470ee50a09df2605fe8f053168089`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 04:10:28 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 21:46:17 GMT
ENV JOOMLA_VERSION=4.2.9
# Wed, 15 Mar 2023 21:46:17 GMT
ENV JOOMLA_SHA512=25805241234753c05f562cf3be599c63cfcfb2e7dcf6b5b76b1cb4b6a4d305497c720eaccdc0939e4fceffa83099db9b3c44963fce86bafc3efc2fc34fecaa20
# Wed, 15 Mar 2023 21:46:22 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.9/Joomla_4.2.9-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 15 Mar 2023 21:46:22 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 15 Mar 2023 21:46:22 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 15 Mar 2023 21:46:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 15 Mar 2023 21:46:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:9ded549d4fef6724fd97af86f38becdb8bea110efeeb70f8963d55e915333629`  
		...
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:01fd19336fe2d3756935805906f633e88ded097ae90b44966d13bdfad34c7d09`  
		Last Modified: Wed, 15 Mar 2023 21:49:24 GMT  
		Size: 24.3 MB (24298854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90538503231a05093ccbcdd1026176828cfd1d01b8cb297c52315190a6762a33`  
		Last Modified: Wed, 15 Mar 2023 21:49:21 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a209403ebb27bd94044bb6ea2dc05f685f3bbeb028ddc3e49ca8cd2503467a7e`  
		Last Modified: Wed, 15 Mar 2023 21:49:21 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ddde96b74c8a7e59dfb616b97340390b3b249b49827e074935767b2f8325c352
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.4 MB (105449471 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:331352308b98e9ff63fcbf1e216e53f194e36eb71629245b63e589480d5b9096`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 03:47:13 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 21:45:33 GMT
ENV JOOMLA_VERSION=4.2.9
# Wed, 15 Mar 2023 21:45:33 GMT
ENV JOOMLA_SHA512=25805241234753c05f562cf3be599c63cfcfb2e7dcf6b5b76b1cb4b6a4d305497c720eaccdc0939e4fceffa83099db9b3c44963fce86bafc3efc2fc34fecaa20
# Wed, 15 Mar 2023 21:45:41 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.9/Joomla_4.2.9-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 15 Mar 2023 21:45:42 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 15 Mar 2023 21:45:42 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 15 Mar 2023 21:45:42 GMT
...
-	Layers:
	...
	-	`sha256:91c5ac01b306eb460ffdf6eb03b0d8f57afeadcc14485dd2c36ad34619d6cc0f`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c28aba501930014b4ccb0f1b3195df4d0886438333b7c6c1b28c9756d4165d49`  
		Last Modified: Wed, 15 Mar 2023 21:50:24 GMT  
		Size: 24.3 MB (24298865 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:167ac498d04bdd25662aec13f8ae81e06bf7e8bc9c742d0be7d229b895eddda6`  
		Last Modified: Wed, 15 Mar 2023 21:50:18 GMT  
		Size: 1.8 KB (1825 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24dc2b134c14cda867a204e867ecb5e49d19037dbc43d2de277f29acb59a3634`  
		Last Modified: Wed, 15 Mar 2023 21:50:18 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c7517aa05746c0490accea7781403b330c1da67d915f78cb3c4c9dd2f34348e2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.1 MB (111142522 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:723f7d03885cd4f46511bc507c756087d1a802b0ad747b9fd7b84ba9b6311835`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 05:04:20 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 22:28:16 GMT
ENV JOOMLA_VERSION=4.2.9
# Wed, 15 Mar 2023 22:28:16 GMT
ENV JOOMLA_SHA512=25805241234753c05f562cf3be599c63cfcfb2e7dcf6b5b76b1cb4b6a4d305497c720eaccdc0939e4fceffa83099db9b3c44963fce86bafc3efc2fc34fecaa20
# Wed, 15 Mar 2023 22:28:30 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.9/Joomla_4.2.9-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 15 Mar 2023 22:28:32 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 15 Mar 2023 22:28:32 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 15 Mar 2023 22:28:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 15 Mar 2023 22:28:33 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2e7fa7c69489b6605e059d0e8a01eec7c18205f634ead236b89cd8bf31ca9e8d`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77462c05278ff505c28a2da17f327590ca7e8453effd6aaf2bd847756bd37206`  
		Last Modified: Wed, 15 Mar 2023 22:33:32 GMT  
		Size: 24.3 MB (24298858 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79eed66d9617fc1e133ec4baf049e62c0a9b0afff1bc1ede99a93a023e72dcc7`  
		Last Modified: Wed, 15 Mar 2023 22:33:25 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f3f38534185dec679c51846adcab92a692fa2e57b429470c4d5807481a18ad11`  
		Last Modified: Wed, 15 Mar 2023 22:33:25 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:8efb80a399bc952d5bc03c00cec8897462a4b6a12ba7e02f036ea31b48e441f6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.7 MB (105740529 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:74725cf7bcee9369db6fe6371ce940708d3c2b1963ad6f71e4f69df9cdb388b2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 04 Mar 2023 02:41:09 GMT
VOLUME [/var/www/html]
# Wed, 15 Mar 2023 21:50:45 GMT
ENV JOOMLA_VERSION=4.2.9
# Wed, 15 Mar 2023 21:50:45 GMT
ENV JOOMLA_SHA512=25805241234753c05f562cf3be599c63cfcfb2e7dcf6b5b76b1cb4b6a4d305497c720eaccdc0939e4fceffa83099db9b3c44963fce86bafc3efc2fc34fecaa20
# Wed, 15 Mar 2023 21:50:52 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.2.9/Joomla_4.2.9-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 15 Mar 2023 21:50:55 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 15 Mar 2023 21:50:55 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 15 Mar 2023 21:50:55 GMT
...
-	Layers:
	...
	-	`sha256:2831a58f9fb857d91f52d7de216b6ce61b713811b7a3b6c1e314f0ba130fd4b7`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2b40aff9bfecabe013223fd81ce613a8103e45ab6a2585e92a3a6d220e0511b`  
		Last Modified: Wed, 15 Mar 2023 21:54:39 GMT  
		Size: 24.3 MB (24298859 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cabfa12163e10aa1e3c1c83ae44843a6c6b4fab741ebe936694f0167d69b84f7`  
		Last Modified: Wed, 15 Mar 2023 21:54:36 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52e0d8f5d4c1360f691f3978557e5df3e414622335db578853a8855dc56619e`  
		Last Modified: Wed, 15 Mar 2023 21:54:35 GMT  
		Size: 722.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
