...
```console
$ docker pull joomla@sha256:0e87b98440377fda5a722629046a6e0001357cd679d67b168e050da756059908
```
...
```console
$ docker pull joomla@sha256:b634e0a398b076e4e2936a16971c41bac6d59a8a44ecb8ce51efeaa965df6196
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.1 MB (228077119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56f531af1b900096a61cb454714535c83e49cb12b5ff5c12c00af5b9dcf44851`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 12 Apr 2024 22:06:05 GMT
ENV JOOMLA_VERSION=5.1.0-beta2
# Fri, 12 Apr 2024 22:06:09 GMT
ENV JOOMLA_SHA512=8f4f81c9147270c6f7a2373c96716c90272f12e7c8679166517eb84990e3c7724b1d3657c3f8eee1a46094a4d950830048afdd17dae516be8dac5fd7be1cba65
# Fri, 12 Apr 2024 22:06:38 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0-beta2/Joomla_5.1.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 12 Apr 2024 22:06:47 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Fri, 12 Apr 2024 22:06:53 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 12 Apr 2024 22:06:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 12 Apr 2024 22:07:06 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:04a96cd5bacffbc199c3c728cdcfe38bca4744df338960d2eaded82998040d9e`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e2ff183421c8bdad1fcf3a377a1447ab0d0ad831df832cc79ddcd500b323962a`  
		Last Modified: Fri, 12 Apr 2024 22:41:07 GMT  
		Size: 23.7 MB (23652841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:591b11be286a29b9e30838095c6ac554a5f7da1887028800e7b5052019c13bc8`  
		Last Modified: Fri, 12 Apr 2024 22:40:47 GMT  
		Size: 2.7 KB (2735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41f10a289a36ee767f224dff06376bcfb51c3a021d2042f10cd606a78c6cea04`  
		Last Modified: Fri, 12 Apr 2024 22:40:47 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
