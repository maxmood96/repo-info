...
```console
$ docker pull joomla@sha256:605df42c9c09ee9b7810d02b491600efadd4f2b2e266116a3cb98b628f2350d8
```
...
```console
$ docker pull joomla@sha256:643abace52ce0dc799b3d013572c166df25da4b72df5e70337ff91f86ad5b990
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.2 MB (226221943 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2db2d232c51627b5965b22cd08e0a2c17de912fa7b102f5327664983424bfea3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Sat, 13 Apr 2024 00:14:22 GMT
ENV JOOMLA_VERSION=5.1.0-beta2
# Sat, 13 Apr 2024 00:14:23 GMT
ENV JOOMLA_SHA512=8f4f81c9147270c6f7a2373c96716c90272f12e7c8679166517eb84990e3c7724b1d3657c3f8eee1a46094a4d950830048afdd17dae516be8dac5fd7be1cba65
# Sat, 13 Apr 2024 00:14:45 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.0-beta2/Joomla_5.1.0-beta2-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 13 Apr 2024 00:14:57 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Sat, 13 Apr 2024 00:14:58 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 13 Apr 2024 00:14:59 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 13 Apr 2024 00:14:59 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2b4a22fb1de58da31ecbba1f66ce0c4654581cde1ee4424ff58555fda7d92ae6`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:413e4d672a85f5b6675ec741f7a27350eca97d8adfae9c9b3503f7e7860aefcf`  
		Last Modified: Sat, 13 Apr 2024 00:56:26 GMT  
		Size: 23.6 MB (23648782 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cf661ad8f5a5f197d368cf67b1f978e4a0372ddbb46f4ba3e25c7a65fafd06d`  
		Last Modified: Sat, 13 Apr 2024 00:56:23 GMT  
		Size: 2.7 KB (2735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a04eadce8b6bd604b0c079b1774eccedcdbf2447f71eb982527d290b486b9312`  
		Last Modified: Sat, 13 Apr 2024 00:56:22 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
