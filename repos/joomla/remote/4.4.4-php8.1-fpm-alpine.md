...
```console
$ docker pull joomla@sha256:79af108e0fca84391d14f7a88579be2b857a10b7fbebb924b8467c11a68c5530
```
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; 386
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; ppc64le
...
### `joomla:4.4.4-php8.1-fpm-alpine` - linux; s390x
