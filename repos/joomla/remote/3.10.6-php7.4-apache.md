...
```console
$ docker pull joomla@sha256:69caa97e13791aeaa1b4645c3c35497e85307afd06de566124e75029ef004f86
```
...
### `joomla:3.10.6-php7.4-apache` - linux; amd64
...
### `joomla:3.10.6-php7.4-apache` - linux; arm variant v5
...
### `joomla:3.10.6-php7.4-apache` - linux; arm variant v7
...
### `joomla:3.10.6-php7.4-apache` - linux; arm64 variant v8
...
### `joomla:3.10.6-php7.4-apache` - linux; 386
...
### `joomla:3.10.6-php7.4-apache` - linux; mips64le
...
### `joomla:3.10.6-php7.4-apache` - linux; ppc64le
...
### `joomla:3.10.6-php7.4-apache` - linux; s390x
