...
```console
$ docker pull joomla@sha256:5b60c4642e3131157eb35eafb89873c5792455b6001044a57fb34e44a6b39762
```
...
### `joomla:5.0.3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.0.3-php8.1-fpm-alpine` - linux; arm variant v7
