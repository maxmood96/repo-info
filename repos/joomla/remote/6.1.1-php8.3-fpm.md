...
### `joomla:6.1.1-php8.3-fpm` - linux; amd64
...
### `joomla:6.1.1-php8.3-fpm` - unknown; unknown
...
### `joomla:6.1.1-php8.3-fpm` - linux; arm variant v5
...
### `joomla:6.1.1-php8.3-fpm` - linux; arm variant v7
...
### `joomla:6.1.1-php8.3-fpm` - linux; arm64 variant v8
...
### `joomla:6.1.1-php8.3-fpm` - linux; 386
...
### `joomla:6.1.1-php8.3-fpm` - linux; ppc64le
...
### `joomla:6.1.1-php8.3-fpm` - linux; riscv64
...
### `joomla:6.1.1-php8.3-fpm` - linux; s390x
