...
```console
$ docker pull joomla@sha256:44cc0be53379696ed1238ddff6d9375ce4bff17d55ecf4095a8421c41d4863bd
```
...
```console
$ docker pull joomla@sha256:bb29ebabb5d865a7c0dc944184385a8ea50cd7da10cef30b7437a4f35e8cc345
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.5 MB (142503461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4abddd0ca833f56d6c12e0c0af989fbce5d275441e707b4efa93a115a13e8cab`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jul 2021 19:22:59 GMT
ENV JOOMLA_VERSION=3.9.27
# Thu, 22 Jul 2021 19:23:00 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Thu, 22 Jul 2021 19:23:13 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 22 Jul 2021 19:23:15 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 22 Jul 2021 19:23:15 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 22 Jul 2021 19:23:15 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 22 Jul 2021 19:23:16 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:19fd55250904db23bb2bd7cbe4714de4797187bb83e5e07ca8bce15aa1f26966`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f08af73ea20b6d4256ddd90f190bb7eecaf417d3cf46387906bcde9d466de8a3`  
		Last Modified: Thu, 22 Jul 2021 19:31:21 GMT  
		Size: 9.7 MB (9723325 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:826ba0e81482656db887f857615270ccd8640971c023411c63e028c2a950ee69`  
		Last Modified: Thu, 22 Jul 2021 19:31:10 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:275a27593b18066254d221cd610a38df82cabd59cf541d3f3dc6f59bccdcdb70`  
		Last Modified: Thu, 22 Jul 2021 19:31:10 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
