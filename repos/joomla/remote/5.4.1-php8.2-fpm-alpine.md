...
```console
$ docker pull joomla@sha256:a7bc034b90d0533a4dcb9ccc3c743122f3950b87b0d8711e130c648d4e0277a1
```
...
```console
$ docker pull joomla@sha256:7bae1520535ab14c17a0cf4c2cacacb85311cb1272f023e41279344bfaa00d21
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **100.8 MB (100756787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:daf2c4575d5d250ddfa4aae03339fad00e5ea4e9b691d24b4a2948acf879a097`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Dec 2025 01:22:47 GMT
CMD ["php-fpm"]
# Thu, 18 Dec 2025 02:50:00 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 18 Dec 2025 02:50:00 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 18 Dec 2025 02:50:00 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 		zstd 	; # buildkit
# Thu, 18 Dec 2025 02:53:32 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.8.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.3.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ] # buildkit
# Thu, 18 Dec 2025 02:53:34 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Thu, 18 Dec 2025 02:53:34 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini # buildkit
# Thu, 18 Dec 2025 02:53:34 GMT
...
# Thu, 18 Dec 2025 02:53:34 GMT
ENV JOOMLA_SHA512=b3f268de70f018fc5e7c4fbbd5e2a18f1ca5abf6acd35ae712a6bf989b786e0aea4d34acfe2061c91306c708d994df3ecbeaea387a6b056ff1e58e2ed34104c3
# Thu, 18 Dec 2025 02:53:38 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.4.1/Joomla_5.4.1-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla # buildkit
# Thu, 18 Dec 2025 02:53:39 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Thu, 18 Dec 2025 02:53:39 GMT
COPY makedb.php /makedb.php # buildkit
# Thu, 18 Dec 2025 02:53:39 GMT
...
-	Layers:
	...
	-	`sha256:3076c527ae6764df05e5562c4480eb7b6ce59c5a89d97ffbb16820a0a7c558e2`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:ff66359a31202ca74de0ab3faf001106551f6c2812464c95efc7b9b25581d854`  
		Last Modified: Thu, 18 Dec 2025 02:54:05 GMT  
		Size: 34.2 MB (34187931 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3b41607fb54600b62207e729d2d75360c2ee143356263dff426bd9371d77e0a6`  
		Last Modified: Thu, 18 Dec 2025 02:54:02 GMT  
		Size: 7.3 MB (7329088 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:93775401ad7487e6c2ac839c0b790a5ab569cae63cb1e95e36cc8c884a2e56ca`  
		Last Modified: Thu, 18 Dec 2025 02:54:02 GMT  
		Size: 72.9 KB (72883 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6ce4b066cd0ee30fa9feafc08b9f3021a372166c8d9312baa7f8f5400c99b075`  
		Last Modified: Thu, 18 Dec 2025 02:54:02 GMT  
		Size: 391.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:17402dcca744b3edc192687ced27c7fec5f9c7fb58ba2f14e85b2d9c3397463a`  
		Last Modified: Thu, 18 Dec 2025 02:54:04 GMT  
		Size: 25.6 MB (25648669 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:91b59ed1a6473a5140fd90fc2cc635da986fa9c36a2fa178edcf8b3f8c9b7474`  
		Last Modified: Thu, 18 Dec 2025 02:54:02 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3dc9e2a426445bca833147195218db189bfc8a58e54d188f7b3f4742ad2fe96b`  
		Last Modified: Thu, 18 Dec 2025 02:54:02 GMT  
		Size: 1.1 KB (1071 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:8d0761c81784c14a9746534dc5927fef3b554488d0303230ef321780cc86e334
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.8 KB (45761 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:87c33bea662a3aee8891db5c4238062530c380374b00faac4ba09bc41adfce1b`

```dockerfile
```

-	Layers:
	-	`sha256:0623345f70e8e08a0b0174c440ff6726258f54191bdad1a52c4ecdae6b72dd10`  
		Last Modified: Thu, 18 Dec 2025 05:43:45 GMT  
...
```console
$ docker pull joomla@sha256:ac348921c72cb25b3dd8be84f4faac783617bae7482e95b15265d6f34e962054
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **99.9 MB (99901913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ac2374d86f969e928e8732e59e6439bf0775dda26f3527e9401ae2f65a3a370`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 18 Dec 2025 01:06:01 GMT
CMD ["php-fpm"]
# Thu, 18 Dec 2025 03:51:54 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 18 Dec 2025 03:51:54 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 18 Dec 2025 03:51:54 GMT
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 		zstd 	; # buildkit
# Thu, 18 Dec 2025 03:54:31 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		icu-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.8.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.23; 	pecl install memcached-3.3.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ] # buildkit
...
-	Layers:
	...
	-	`sha256:e6d0bf141b5a4f7e5fafed2091354a0f0c0f295adf052c728f6544a1962c003b`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8675792f56a15562ab2581614bc39e4311dad0974dbb047805c09013f5f0502e`  
		Last Modified: Thu, 18 Dec 2025 03:54:52 GMT  
		Size: 34.1 MB (34118749 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:64d9123d933e90f1a16748daffb27077c1331ce68cacefddd2825939be5a50ec`  
		Last Modified: Thu, 18 Dec 2025 03:54:51 GMT  
		Size: 7.3 MB (7298351 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:297cbc66518f443ca2f8f1c544c333c8def9cd97dd0458b3511b1524c397cd3c`  
		Last Modified: Thu, 18 Dec 2025 03:54:50 GMT  
		Size: 72.8 KB (72849 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:5c619558dfdd1c23716f45c9849151da12f2b253a077ecacc477d1bb7a9ebe9d`  
		Last Modified: Thu, 18 Dec 2025 03:54:54 GMT  
		Size: 387.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:10d85f0f5419e194412e6ccb81f0f81f278d2b2866ea79841f23bf22f1863c30`  
		Last Modified: Thu, 18 Dec 2025 03:54:53 GMT  
		Size: 25.6 MB (25648682 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9d62cdf77fed1cf0e725838cd284c2a47e244a04b81f586fd9766a8f044cd8b5`  
		Last Modified: Thu, 18 Dec 2025 03:54:51 GMT  
		Size: 3.7 KB (3654 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fe9996ee29a9fb64c4ee8b56bd320180165f75e8353ded8dee44ac303b541446`  
		Last Modified: Thu, 18 Dec 2025 03:54:50 GMT  
		Size: 1.1 KB (1071 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:110ff8b78a02b564e7c1ebc1024e19d24566fae98210bb9c385073715ea3cf2a
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.7 KB (45714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ac04ba380296abb7a33cc227fed47ef6bffa9cde3ed723c54159d69f6162cc0`

```dockerfile
```

-	Layers:
	-	`sha256:e933f4fff4dba4bc46c1b63d5c271db857b8f40b194edf61794fdeb1da61eeaa`  
		Last Modified: Thu, 18 Dec 2025 05:43:50 GMT  
