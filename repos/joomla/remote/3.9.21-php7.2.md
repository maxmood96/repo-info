...
```console
$ docker pull joomla@sha256:c8c146bba46773eb501aba67067c308d8f7a9f03bb2d3a5a1950570cdc637215
```
...
### `joomla:3.9.21-php7.2` - linux; arm variant v5
...
### `joomla:3.9.21-php7.2` - linux; arm variant v7
...
### `joomla:3.9.21-php7.2` - linux; arm64 variant v8
...
### `joomla:3.9.21-php7.2` - linux; s390x
