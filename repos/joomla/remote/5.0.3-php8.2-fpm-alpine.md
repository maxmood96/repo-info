...
```console
$ docker pull joomla@sha256:754c35c1395e97ac5f1fd9323b17a7a8c2dda7ac522727c5b1d7a3018b3d63f3
```
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; amd64
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; 386
...
### `joomla:5.0.3-php8.2-fpm-alpine` - linux; s390x
