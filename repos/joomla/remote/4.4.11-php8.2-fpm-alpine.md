...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; amd64
...
### `joomla:4.4.11-php8.2-fpm-alpine` - unknown; unknown
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; arm variant v6
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; arm variant v7
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; 386
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; ppc64le
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; riscv64
...
### `joomla:4.4.11-php8.2-fpm-alpine` - linux; s390x
