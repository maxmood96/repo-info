...
```console
$ docker pull joomla@sha256:4afacf83fed61e141563889b48aab08a4c629748b33c45f17e0bd7081be97026
```
...
```console
$ docker pull joomla@sha256:2f91a2fe802a0d181e0892132f7687a7b50afa929a555166ad1a8b7587d356a4
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.6 MB (166598669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a17014e4029c09fb97a27f7125b038f306c7fe85cc58d901050a90668936c84`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 29 Sep 2021 02:13:37 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 29 Sep 2021 02:18:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 29 Sep 2021 02:18:02 GMT
VOLUME [/var/www/html]
# Wed, 29 Sep 2021 02:18:03 GMT
ENV JOOMLA_VERSION=4.0.3
# Wed, 29 Sep 2021 02:18:03 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Wed, 29 Sep 2021 02:18:20 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 29 Sep 2021 02:18:22 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 29 Sep 2021 02:18:22 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 29 Sep 2021 02:18:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 29 Sep 2021 02:18:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:512c77194b7a92d6d67e9c10736911ff715697f207c1d3685bb07077324ad92a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d2b351df1862cd0aebb65ec35f6d7a36a57094bf69725e1e426796bc9b355a1`  
		Last Modified: Wed, 29 Sep 2021 02:36:36 GMT  
		Size: 2.8 MB (2762326 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ebcdf779cb32ab4bc4d52fef5919171cf4a8e16f5335846f23c78d11766ca78`  
		Last Modified: Wed, 29 Sep 2021 02:36:52 GMT  
		Size: 21.3 MB (21324565 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e0724ec68fb85812399882433ad04f3201ef411ed49537c71fdbb3b22f78455`  
		Last Modified: Wed, 29 Sep 2021 02:36:34 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58ef1213d6c21911de4564e5aca7b4cecdd0179bc0df0b1277c8504c7b43ec53`  
		Last Modified: Wed, 29 Sep 2021 02:36:34 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:b2fe0f5f37a0463759326f286fb15149df39db77f1a12cc37998e83ec18fd579
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.8 MB (158814096 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbb2317fd254447f7f1955dd90dee687b73775273e91d89213c45cc65ae39141`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 23 Sep 2021 22:22:16 GMT
CMD ["php-fpm"]
# Fri, 24 Sep 2021 06:40:48 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 06:40:48 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 06:44:58 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 06:44:58 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 06:44:59 GMT
ENV JOOMLA_VERSION=4.0.3
# Fri, 24 Sep 2021 06:44:59 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 06:45:16 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 06:45:17 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 06:45:18 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 06:45:18 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 06:45:19 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:85a8efc306bee9af688c17b5e62926856ece5839f834f9bb03b7f035dea3ba35`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee245502a0c83fc86382e9a18df6ebe9d9e580ee62ebe2873bc2edf80dd4ca4d`  
		Last Modified: Fri, 24 Sep 2021 07:10:42 GMT  
		Size: 2.7 MB (2662697 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c94657eb965dc5100da391b28e3e2e93c73213946b6f2c82032a52c90bb811e`  
		Last Modified: Fri, 24 Sep 2021 07:10:58 GMT  
		Size: 21.3 MB (21324572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec6d0268c0af5644ead7044c4327e3d0734b5ba03e455b961260593125bd9d1e`  
		Last Modified: Fri, 24 Sep 2021 07:10:40 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a487a7881b3342cf413be7b9713517c8b099372e00ddcca9b87e472daab8fd25`  
		Last Modified: Fri, 24 Sep 2021 07:10:40 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:93c0a0863e7b74f913b6e93488b73d213cb5edf23dd275c1dc97098c4ff84811
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.1 MB (182086064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bff9696efe7636957ba1429620e30e4b2c898b83871f3e0f669138af4ab5e706`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Sep 2021 04:49:21 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 04:49:27 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 04:49:27 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 04:49:28 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 04:49:28 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 04:49:28 GMT
...
-	Layers:
	...
	-	`sha256:51513807035d253feb50cc0c44b13ce9e5a046efa1ff301ab9b4639288094571`  
		...
		Size: 8.6 KB (8572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a4f943237694d52149c435a48e275a02bd18652d25a7cbedbdc1830b26de989`  
		Last Modified: Fri, 24 Sep 2021 05:00:57 GMT  
		Size: 2.9 MB (2894822 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9567dfbf7d9af221cfa046e9aa7d46d67f35397bacd8008a7d39e0d20f1939ee`  
		Last Modified: Fri, 24 Sep 2021 05:01:00 GMT  
		Size: 21.3 MB (21324464 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6683c94515822041738bc7908288d0e458fc9c4c6de666142466d74a7b993f1`  
		Last Modified: Fri, 24 Sep 2021 05:00:56 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61b706e1e174dd6bdc245291536c270e043dc7cce008d538c795653331893068`  
		Last Modified: Fri, 24 Sep 2021 05:00:57 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:9487ee4c92b9ed86b14b1e7a681235d0b0cbdd93523e3b543fb6354c4f23b051
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **191.6 MB (191649133 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f213b723cec59cd58ded0739a8bc0cd973343253cef52851e0d6992bfb32c62d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 29 Sep 2021 02:53:04 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 29 Sep 2021 02:55:22 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 29 Sep 2021 02:55:22 GMT
VOLUME [/var/www/html]
# Wed, 29 Sep 2021 02:55:23 GMT
ENV JOOMLA_VERSION=4.0.3
# Wed, 29 Sep 2021 02:55:23 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Wed, 29 Sep 2021 02:55:37 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 29 Sep 2021 02:55:39 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 29 Sep 2021 02:55:39 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 29 Sep 2021 02:55:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 29 Sep 2021 02:55:40 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1a6323f0254ac11cd45e23f502ee585d2794f90e47319ec6ed4012462d8bc687`  
		...
		Size: 8.6 KB (8575 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74a03b7bfc38c070c834d97f795391301d6a2b3b36b3bc5eb9664c1ea3aa17cd`  
		Last Modified: Wed, 29 Sep 2021 03:12:04 GMT  
		Size: 3.0 MB (2957008 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0c53123a94b644feafe57971bfcaebf2ea62dd77778747f9ae40053f03ad4fc`  
		Last Modified: Wed, 29 Sep 2021 03:12:11 GMT  
		Size: 21.3 MB (21324646 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:241aff7084b8a22ac67a1e91ffb4f3e395e7ab5086c80b05533a36fc05195ad3`  
		Last Modified: Wed, 29 Sep 2021 03:12:02 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c6f984ebe43954eea70d3457af071f71e175a4eb9d52a48fca1ca46850b329f`  
		Last Modified: Wed, 29 Sep 2021 03:12:02 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:bce92884aa54187d98d03ebf2f17e830987d3abf49cb873d5bb2d529f5279569
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.3 MB (166348992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8406c3ebbd13b674245a589022d22d5841c388dcad824dc1d770492462b62bff`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 24 Sep 2021 06:06:11 GMT
ENV JOOMLA_VERSION=4.0.3
# Fri, 24 Sep 2021 06:06:12 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 06:06:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 06:06:34 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 06:06:35 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 06:06:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 06:06:35 GMT
...
-	Layers:
	...
	-	`sha256:4b1e2b92b42646e3737824e95f4459402b886410f21a12e7615dd7a6fc7e0968`  
		...
		Size: 8.6 KB (8573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec92d16dc09e330ec693c08f1577abeed550f77a315ffb64fb0dc81af6a092a3`  
		Last Modified: Fri, 24 Sep 2021 06:21:23 GMT  
		Size: 2.9 MB (2874750 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b26ad773984940564e595fa3a78b01893e78e41e3c7c60089430a9785a5dd67`  
		Last Modified: Fri, 24 Sep 2021 06:21:37 GMT  
		Size: 21.3 MB (21324585 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f575a4807e7e1594e70ebfcd628c18581e571450c04158b7d2019102fdfaa13`  
		Last Modified: Fri, 24 Sep 2021 06:21:20 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e21e992097315014e3b41bd28f535019a3700ac74f720cd1f9a0c9c6bd26cbdd`  
		Last Modified: Fri, 24 Sep 2021 06:21:20 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:9a55e164983a9a36569bc4756ee7d739d1a21a3d1f4da5b579742340d00d12d1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.2 MB (189246406 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12741a5acbf1cf25fd70d1bb0e4b7a0cfbf9c07ed6aedd4cf0eff9f3dbd4f30d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 10:29:52 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 10:33:24 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 10:33:27 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 10:33:30 GMT
ENV JOOMLA_VERSION=4.0.3
# Fri, 24 Sep 2021 10:33:34 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 10:34:00 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 10:34:09 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 10:34:12 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 10:34:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 10:34:26 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:bff9068d958d299a03490813a3b4ab06703b5e2e9e03c61ae30eaeb59e464eb0`  
		...
		Size: 8.6 KB (8573 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd67b5a3b719fab6a1501b174dfd8af8c9031c2703323350787fc21e0f3f5aa9`  
		Last Modified: Fri, 24 Sep 2021 10:55:56 GMT  
		Size: 3.1 MB (3142690 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:702d20adc542c7efce4ad3a28901fc4296c5fd59c7d56066a284c80b8ff7a9c4`  
		Last Modified: Fri, 24 Sep 2021 10:56:00 GMT  
		Size: 21.3 MB (21324704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97dbf6e3a3106108960fa16ba1e6808eccc8f760b5dfead1844f0eb7e9e34bfc`  
		Last Modified: Fri, 24 Sep 2021 10:55:55 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:035e732986032f0551006f43537f7e3053230e1a8a3395975cffb38a088c2d83`  
		Last Modified: Fri, 24 Sep 2021 10:55:56 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:94278ea11a195585be5bff04e79863cebb6b83f62273ca6616cc4a5bd7ba1d84
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165856272 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:456feacccf990e9eb2b8dbb3b4200bce3079dbb38118438b0e9499d90d59ba29`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 28 Sep 2021 06:12:37 GMT
CMD ["php-fpm"]
# Tue, 28 Sep 2021 15:24:40 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 28 Sep 2021 15:24:40 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 28 Sep 2021 15:25:31 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 28 Sep 2021 15:25:31 GMT
VOLUME [/var/www/html]
# Tue, 28 Sep 2021 15:25:31 GMT
...
# Tue, 28 Sep 2021 15:25:31 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Tue, 28 Sep 2021 15:25:36 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 28 Sep 2021 15:25:38 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 28 Sep 2021 15:25:38 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 28 Sep 2021 15:25:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 28 Sep 2021 15:25:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d242cfc6e6b85060488888aceb3d9f014e03d3dfa3cb5887b61a8c6aeb837a23`  
		...
		Size: 8.6 KB (8572 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a027370b6746a1cc1629c66fa1d24e872902758d86f7ffe02811dbfb45d440e2`  
		Last Modified: Tue, 28 Sep 2021 15:31:53 GMT  
		Size: 2.9 MB (2897155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e04e67f467d9537061f241c05ed5d1684727be7a7ce827cdc0bdec412d739521`  
		Last Modified: Tue, 28 Sep 2021 15:31:55 GMT  
		Size: 21.3 MB (21324546 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07b2b4aaa94c65050e705fc7fe7b7a77a176d048597a8515f648a42ea3fb9f84`  
		Last Modified: Tue, 28 Sep 2021 15:31:53 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc26f65f398c56d8ee9de899a9c164b6cc0c253ffbf707f846d210917cfe8d7f`  
		Last Modified: Tue, 28 Sep 2021 15:31:52 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
