...
### `joomla:5.3.0-beta` - unknown; unknown
...
### `joomla:5.3.0-beta` - linux; arm variant v5
...
### `joomla:5.3.0-beta` - linux; arm variant v7
...
### `joomla:5.3.0-beta` - linux; arm64 variant v8
...
### `joomla:5.3.0-beta` - linux; mips64le
...
### `joomla:5.3.0-beta` - linux; ppc64le
