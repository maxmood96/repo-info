...
```console
$ docker pull joomla@sha256:4cfb3403b865734aabb12927231ae3ea1fdf165613f7bd438fcda53066beedc1
```
...
```console
$ docker pull joomla@sha256:ad6b0443736875ca8bd03429f5a0605b25dea309929a90538113c5116998b804
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.5 MB (46473373 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b22ba7b0e4c73ef0b8ee0446dd47f4929bfa68207d9ed07eee2ede19ed7563bc`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Sat, 18 Jan 2020 07:25:31 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 18 Jan 2020 07:25:33 GMT
RUN apk add --no-cache 	bash
# Sat, 18 Jan 2020 07:28:35 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Sat, 18 Jan 2020 07:28:36 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 07:28:37 GMT
ENV JOOMLA_VERSION=3.9.14
# Sat, 18 Jan 2020 07:28:37 GMT
ENV JOOMLA_SHA512=e7807256f40330fa857d37bd00b91e76c7a0ee24d21a1c3fbe95af90cf80b01fcee15845b9cbdc75a3eec0e36b140e87d78fbe491ee6851abbc74be621cb719a
# Sat, 18 Jan 2020 07:28:48 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 18 Jan 2020 07:28:50 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Sat, 18 Jan 2020 07:28:50 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sat, 18 Jan 2020 07:28:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 07:28:52 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:058b9eb62675557d4c1f20e1afdd2c299716e7680ffb62b554714845bfba082a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7aba684223e62e59187c693f53b61a483501d6e4668c7f984c9afcddb8ce4a1`  
		Last Modified: Sat, 18 Jan 2020 07:32:46 GMT  
		Size: 591.1 KB (591109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b93644a7ba6f01cae30c3f8a0a5a22a266c8e64a2919b13d40a5bad4d3c4e44`  
		Last Modified: Sat, 18 Jan 2020 07:32:49 GMT  
		Size: 6.2 MB (6226676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16f92471d00fffe5d80ce71888e4251e02a51828458834ebb940037d34247c97`  
		Last Modified: Sat, 18 Jan 2020 07:32:48 GMT  
		Size: 9.7 MB (9651605 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1a0f46da66d38ebf14a6c3ec6c0b595aaa87b4e588c0c172383eb40b5a35c42c`  
		Last Modified: Sat, 18 Jan 2020 07:32:46 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39d7c656c68828e6d83d17d26522ab92195c4bb62e33dd1347d777224ee0f5ab`  
		Last Modified: Sat, 18 Jan 2020 07:32:46 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:5c564d6fb4a003a710b7b9d2f05ef5c88c5a765168e36c400d7553f33d3426d3
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.0 MB (45045019 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:321b17281fa13f8d6b176e3b47ffa7aa8026fadda7f8f25f7ab1e7309079e9b5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 07:18:14 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Sat, 18 Jan 2020 07:18:15 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 18 Jan 2020 07:18:18 GMT
RUN apk add --no-cache 	bash
# Sat, 18 Jan 2020 07:21:11 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Sat, 18 Jan 2020 07:21:15 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 07:21:17 GMT
ENV JOOMLA_VERSION=3.9.14
# Sat, 18 Jan 2020 07:21:18 GMT
ENV JOOMLA_SHA512=e7807256f40330fa857d37bd00b91e76c7a0ee24d21a1c3fbe95af90cf80b01fcee15845b9cbdc75a3eec0e36b140e87d78fbe491ee6851abbc74be621cb719a
# Sat, 18 Jan 2020 07:21:28 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 18 Jan 2020 07:21:30 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Sat, 18 Jan 2020 07:21:31 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sat, 18 Jan 2020 07:21:31 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 07:21:32 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:c2120addeaf6498aca9c6d902d8e0b31257c9f9386a8e1c044d39fad8c6de8cd`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f07d7d5698806cb1c8dba7c42a2695029ff514683123178a872c98c8ba92a6d`  
		Last Modified: Sat, 18 Jan 2020 07:26:05 GMT  
		Size: 545.1 KB (545129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b54216de8402c5072f388e466421e2a39a2a527e2e5c4f37e50de90b26e34f8f`  
		Last Modified: Sat, 18 Jan 2020 07:26:05 GMT  
		Size: 6.0 MB (6001817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14853bc016563ead32709333a3939c84046e8b913976321ea194784196d1470e`  
		Last Modified: Sat, 18 Jan 2020 07:26:09 GMT  
		Size: 9.7 MB (9651601 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:99e73df2f2c7cf9598ebe18580ad137321590b87e09c0e8f90114b02c1f77a8e`  
		Last Modified: Sat, 18 Jan 2020 07:26:05 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:302042df4c33b3c6ef312921c9c87bdb31d2607d4240eafc0c67ba027fa0ce74`  
		Last Modified: Sat, 18 Jan 2020 07:26:05 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:01fbb48cf6a8c3283842078695d8d859f60e4263c1215e22fb8166b6b8d89308
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.8 MB (47783261 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:798a940b172dc12131777d29ec3391c02460e3c43f45d5bb20bd4e9c446d08e0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 07:10:21 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Sat, 18 Jan 2020 07:10:22 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 18 Jan 2020 07:10:25 GMT
RUN apk add --no-cache 	bash
# Sat, 18 Jan 2020 07:13:09 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Sat, 18 Jan 2020 07:13:10 GMT
VOLUME [/var/www/html]
# Sat, 18 Jan 2020 07:13:11 GMT
ENV JOOMLA_VERSION=3.9.14
# Sat, 18 Jan 2020 07:13:12 GMT
ENV JOOMLA_SHA512=e7807256f40330fa857d37bd00b91e76c7a0ee24d21a1c3fbe95af90cf80b01fcee15845b9cbdc75a3eec0e36b140e87d78fbe491ee6851abbc74be621cb719a
# Sat, 18 Jan 2020 07:13:22 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 18 Jan 2020 07:13:23 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Sat, 18 Jan 2020 07:13:24 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sat, 18 Jan 2020 07:13:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 07:13:25 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:36c3082026c709c32df5d328f3e14a69abbd1e1a2a3dfffbe4a7a0570d4e3c36`  
		...
		Size: 8.4 KB (8413 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad98d661224b881973da4000c7a7d9981caabb7d197a66cb5a0f0f83ea805f59`  
		Last Modified: Sat, 18 Jan 2020 07:18:10 GMT  
		Size: 623.5 KB (623528 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd68b3847451ba4b8d1c7c0ca75bcbfb0fe750cb98166a698192859daaa926f5`  
		Last Modified: Sat, 18 Jan 2020 07:18:12 GMT  
		Size: 6.6 MB (6592016 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee8d1a16894e864224e92395fa45b2f19248b763b79522066582226b3f93ea55`  
		Last Modified: Sat, 18 Jan 2020 07:18:14 GMT  
		Size: 9.7 MB (9651602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:041d3e83bb0d289256f3286025100c7426c6b78b5d2f50965e0238a224a2e6a7`  
		Last Modified: Sat, 18 Jan 2020 07:18:10 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d391f21d2390003cabe118eef883cac21b51cf8e594bb1dca6d15a59254058e`  
		Last Modified: Sat, 18 Jan 2020 07:18:10 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
