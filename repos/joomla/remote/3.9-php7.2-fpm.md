...
```console
$ docker pull joomla@sha256:a1a1423fdc25fe0381435d9cb9cfcf7baf12dd96ba0c19f05c7d3e6a6c7d52e3
```
...
```console
$ docker pull joomla@sha256:09cd2162a8a4ef1aec812a660a0d8fba3954c258c4411b30ea49666d08b1cc62
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **158.0 MB (157978461 bytes)**  
...
# Thu, 10 Sep 2020 15:25:32 GMT
CMD ["php-fpm"]
# Fri, 11 Sep 2020 07:35:41 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Sep 2020 07:35:41 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Sep 2020 07:37:13 GMT
...
-	Layers:
	...
	-	`sha256:4aae6cdb7e740fc52ebda11604d0189d4a9b0c50ec74f89f6c0c468a9263e7b9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90177a859c4d758d3576362af0363d2e848bb489d3db4e5abddb609c50f6f356`  
		Last Modified: Fri, 11 Sep 2020 07:45:27 GMT  
		Size: 3.4 MB (3372054 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ae0cb7588a131d3367bad29f00870ea75b90d0cdb45fb901cce0c1198cdea256`  
		Last Modified: Fri, 11 Sep 2020 07:45:29 GMT  
		Size: 9.7 MB (9686470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de79249ebd8529f5a196e5c670dcb754adc3e7f1ea2411baad80cef05af3eef0`  
		Last Modified: Fri, 11 Sep 2020 07:45:27 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b33fa1004b6bfbb2ddc55c76c7bf1ea5b9c16deb7a1ef9f37413d9ea3e69029a`  
		Last Modified: Fri, 11 Sep 2020 07:45:27 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:e2504ffc99598d95eb9c0451130a8a839aa30c00c6491cc3ebdb0a4f3cff7324
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **150.0 MB (150042520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe4ea37ab46c1eb821877b442232264fe2b8461dcedfc73152e6a7d4ab90934f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Sep 2020 02:55:42 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Sep 2020 02:55:43 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Sep 2020 02:58:32 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Sep 2020 02:58:33 GMT
VOLUME [/var/www/html]
# Fri, 11 Sep 2020 02:58:33 GMT
ENV JOOMLA_VERSION=3.9.21
# Fri, 11 Sep 2020 02:58:34 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Fri, 11 Sep 2020 02:58:43 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Sep 2020 02:58:46 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 11 Sep 2020 02:58:47 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Sep 2020 02:58:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Sep 2020 02:58:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:36a304acdd58912b92034aee56593414081c435c624e07593c56fe240381d46f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82ffb76d33b650276c413fd4369d6b570f57bac767ce5e787974323dd847649a`  
		Last Modified: Fri, 11 Sep 2020 03:14:12 GMT  
		Size: 3.3 MB (3318121 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76da44989a463b730644262deb6649e3a1f47f0ca50c5b9c769dfe9300a3443c`  
		Last Modified: Fri, 11 Sep 2020 03:14:15 GMT  
		Size: 9.7 MB (9686475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:288948e746623d4866839ef760832e76fcd30238a0db77ecd4f5186174df8af4`  
		Last Modified: Fri, 11 Sep 2020 03:14:11 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:71eac59dfb3610501e20957b29cb8c5cb505bbe395d99cc185b6505d5d3e6c2b`  
		Last Modified: Fri, 11 Sep 2020 03:14:11 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:5470c9c34fe7f38cf0fb03faf81c6085127b56a0b7142f09795794d850434ef6
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **168.9 MB (168872267 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab9d8669be13e3c467871592f77c0d9cc7b245d70b97f7f48dc024f7305b5291`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 11 Sep 2020 08:34:14 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 11 Sep 2020 08:34:17 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 11 Sep 2020 08:37:29 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Sep 2020 08:37:32 GMT
VOLUME [/var/www/html]
# Fri, 11 Sep 2020 08:37:38 GMT
ENV JOOMLA_VERSION=3.9.21
# Fri, 11 Sep 2020 08:37:43 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Fri, 11 Sep 2020 08:38:03 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Sep 2020 08:38:06 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 11 Sep 2020 08:38:08 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Sep 2020 08:38:13 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Sep 2020 08:38:21 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:3ce74d051bd7878a7bf0bf578f793d018b832cf514819fa6bbb4f02d4513ebdc`  
		...
		Size: 7.8 KB (7790 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c6db923fb0b2a09b435bcee1dbfe248bc4f101202f813d6935370362be6588c`  
		Last Modified: Fri, 11 Sep 2020 09:07:21 GMT  
		Size: 3.5 MB (3545031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:513f1ad17331bcf5eab5b9ccb8373972179ce138f285e9750cd8fd6f10f5f773`  
		Last Modified: Fri, 11 Sep 2020 09:08:30 GMT  
		Size: 9.7 MB (9686461 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd8dc2444d1063516551b274451d2f7ed89a7774c9ad6ea553a41f144ec060fb`  
		Last Modified: Fri, 11 Sep 2020 09:07:10 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1375d6d0d138bb88f3a4e0f29c8202f880f085cd1f102c39890cbb1244f67a47`  
		Last Modified: Fri, 11 Sep 2020 09:07:10 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
