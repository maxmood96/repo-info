...
```console
$ docker pull joomla@sha256:a1c8bd637830bba3b4f5c6aaaa5696b3ae68c3667d0c615d5e59407e224e8e77
```
...
```console
$ docker pull joomla@sha256:5dbfd4979953431a3457fd7e42ee37c7192e9a2dc7a4b37a600f0ac4729a5007
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **90.5 MB (90491509 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b953140443268f95ecda74d9a2bbafd4d42ac10bfe7773aa621e963fd8cb2815`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.1/Joomla_5.1.1-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 07 Jun 2024 07:26:37 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Fri, 07 Jun 2024 07:26:38 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 07 Jun 2024 07:26:38 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Jun 2024 07:26:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:dfc6a64baf7437e853ce2551f37e7ca8ffa6dfb1d84e02308a5c8de0bd874be4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cad6e3422d5071471e4b69d095bcce6513791fe960cce2511ef8fa5a388cd4b9`  
		Last Modified: Fri, 07 Jun 2024 08:17:33 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c046d07644c96e1094c9c36e488b21bc12dfc443f35e334dd1ce22c397d8b1bd`  
		Last Modified: Fri, 07 Jun 2024 08:17:33 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
