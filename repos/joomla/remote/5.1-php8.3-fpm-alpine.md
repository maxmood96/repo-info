...
```console
$ docker pull joomla@sha256:2754e9e4d2a910f261c0bffaa31270311e6e12a0a8605bc368c41907f8cd9d09
```
...
```console
$ docker pull joomla@sha256:a288544ff34c0a02261b6a56aae8f158ab924e21eb1b14d902fee6d707b07611
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.2 MB (86191540 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2f15303e61cd02f4b2c58441ef1333178583e18695fa595d564da8cbe36dd1c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:3bea609a51aa0325bc70564a3f387bec9169468fc794c57e4bff4ee7338c8205`  
		...
		Size: 23.7 MB (23718412 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eed167c6f8337f8f0f815a31abe247628a2696f3754ede3ee1ae67684c1dcd47`  
		Last Modified: Fri, 14 Jun 2024 20:44:17 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d475cbed4854476cb4e40b625c51d5c9b2d9c989f27a2fdf941933a4126db9b0`  
		Last Modified: Fri, 14 Jun 2024 20:44:18 GMT  
...
```console
$ docker pull joomla@sha256:67e8bdc16f5752e9f7adc71caeed803aa66dd26d9fb7b6b93038a6fa6f692e89
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **91.8 MB (91751454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:52f6914e20aa4929e7526a60230600cd17b2636b2a1548a6dbe54595e8c12e68`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.1/Joomla_5.1.1-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:40:57 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:40:57 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:40:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Jun 2024 20:40:58 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:eaba2839f2bf17c7be736f1e7cebfd033ef1b30c36a9c55650c49ca0783a89c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f99e6e556f35da787256e0af7fa7298dcde8babaa8911f597d4335fa57a4e304`  
		Last Modified: Fri, 14 Jun 2024 20:44:06 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16f8f164ffbccb782376910bd1030ece8f5f6992761b1932cffe71ae429b5d7a`  
		Last Modified: Fri, 14 Jun 2024 20:44:06 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:22468e39ec4f1a08931f7d3e6cec8c9e7e96cacc21d18c048f2847a6b8ba7740
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **92.5 MB (92531734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dad151753ff4ac00092a17239a59ea0ef927ec5b9a974499c4b4c82cbe24edef`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.1.1/Joomla_5.1.1-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 14 Jun 2024 20:50:44 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 14 Jun 2024 20:50:44 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 14 Jun 2024 20:50:44 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 14 Jun 2024 20:50:45 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:456591c0a94e1b7ec37bb3e3e8b898bc70e8f8d622e776cc9d325c3613101e7e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5f1f0895153e72edd45d1516e8f643b1946fd0927138c2e43d16c5e50f25cc0b`  
		Last Modified: Fri, 14 Jun 2024 20:53:59 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d5606e1e41e5eb719ab990d3964594ceebf84463edc74c9245386fe84ec837e`  
		Last Modified: Fri, 14 Jun 2024 20:53:59 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
