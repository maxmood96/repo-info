...
```console
$ docker pull joomla@sha256:fbffa61040b838b63afdef605889b794217bafa6e80623918a1d738e6d3822ed
```
...
```console
$ docker pull joomla@sha256:bc4e6c8a3244f1007d954c366862019e3dc5c60e088507f93588434d34c0b95d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.7 MB (166653191 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b4605ff1a287b6d23cf21656328b29049bdce29a206530949dfb460b6d3df9d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Fri, 11 Mar 2022 10:25:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 10:25:39 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 10:25:40 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 10:25:40 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 10:25:58 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 10:25:59 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 10:25:59 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 10:26:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 10:26:00 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:001d912d829742eb7d64454a91313c26116dadda249bbcac4af5f2779e39f37a`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4467748d00e38a5f112e0bdb541753135daa38389ad25862983d3cdb7d38ba33`  
		Last Modified: Fri, 11 Mar 2022 11:18:40 GMT  
		Size: 2.9 MB (2896989 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccd302965aded34d743831ed149abaae6372d0d5150f565c2b99caaeb51a6fc2`  
		Last Modified: Fri, 11 Mar 2022 11:18:57 GMT  
		Size: 22.3 MB (22285220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e76271ce5a61c49b10604c5e17c49b2d29653ae62866b9abcaa750d2e8edd7f7`  
		Last Modified: Fri, 11 Mar 2022 11:18:38 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:402a91b4c5c95247e28cd46d6ce864f9009d97064830f0f19aab811c0f8df0ac`  
		Last Modified: Fri, 11 Mar 2022 11:18:38 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:fe714febb283fd2a2777cbb24b49b072edd63fd474024ba5ce6d1637192b0068
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181577170 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65698db4744ef0f938dee6f8803b42da5ca0daee7a1d4e358f417b3297ce9535`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Fri, 11 Mar 2022 11:41:57 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 11:41:58 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 11:41:59 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 11:42:00 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 11:42:08 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 11:42:09 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 11:42:10 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 11:42:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 11 Mar 2022 11:42:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0e9ca1d8e5d9791e8b61d8dc9464a8f90cb96f975fc38ed0fb4fcd1362054766`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d286a515c1828eb0f44e4e7d941fd35952a89692f27c5098adad65bec3ffc5a4`  
		Last Modified: Fri, 11 Mar 2022 12:13:56 GMT  
		Size: 2.8 MB (2825163 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec157d1fbe811587770c02968545bb7bb29aa253ec873b123e0d5ee7598c0e82`  
		Last Modified: Fri, 11 Mar 2022 12:14:00 GMT  
		Size: 22.3 MB (22282362 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d57de4523276bd86a30009c17434d99f8bd7f466ec85c72400bec1bfe99e5409`  
		Last Modified: Fri, 11 Mar 2022 12:13:56 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bec8bc016d0c61bd7209b32d338d9b70d10f620bcc5f643acd767efd98b39522`  
		Last Modified: Fri, 11 Mar 2022 12:13:56 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ef48de3130cf862bc53436d69511d0b82bf809e83dd3be2d6908db2498d24531
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.9 MB (165901560 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67b3ad43798160c927f9c2fcc1e7a55b915f663fd7aba93ac4230b1adfa528af`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Sun, 06 Mar 2022 23:55:22 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Sun, 06 Mar 2022 23:55:25 GMT
VOLUME [/var/www/html]
# Sun, 06 Mar 2022 23:55:29 GMT
ENV JOOMLA_VERSION=4.1.0
# Sun, 06 Mar 2022 23:55:33 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Sun, 06 Mar 2022 23:56:05 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sun, 06 Mar 2022 23:56:12 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Sun, 06 Mar 2022 23:56:17 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sun, 06 Mar 2022 23:56:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sun, 06 Mar 2022 23:56:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:28246432b5adabe2ad1fff6130c23945c91f5171ccede37141c4e7bc0681e717`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aa0fab1f7fe92c73d66475437b85ba5c7dac9b4539a6c2de543b48e399264a4`  
		Last Modified: Mon, 07 Mar 2022 01:00:50 GMT  
		Size: 2.8 MB (2797526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db44549c1f61b381d05d7c5148e9bd71d79eff6154907496885291221698bf2f`  
		Last Modified: Mon, 07 Mar 2022 01:01:04 GMT  
		Size: 22.3 MB (22282350 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c48863211301cd68f2f7d58714999cb300929230b95f8e846e0324d3f1f47c3e`  
		Last Modified: Mon, 07 Mar 2022 01:00:47 GMT  
		Size: 1.8 KB (1826 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2065399742d13003d7a58815448b67baec2d0fb13702d66b3499ba23a4a59534`  
		Last Modified: Mon, 07 Mar 2022 01:00:47 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:070640878448eac30b719662400136bb7ac36df53da8405ff287d79d931b6fdf
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.1 MB (166103681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6043252e2eb852eeee42c734e18ed010666610dee390678f5f299bd8d8616bde`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Fri, 11 Mar 2022 10:35:41 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 11 Mar 2022 10:35:41 GMT
VOLUME [/var/www/html]
# Fri, 11 Mar 2022 10:35:42 GMT
ENV JOOMLA_VERSION=4.1.0
# Fri, 11 Mar 2022 10:35:42 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Fri, 11 Mar 2022 10:35:49 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 11 Mar 2022 10:35:51 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 11 Mar 2022 10:35:51 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 11 Mar 2022 10:35:51 GMT
...
-	Layers:
	...
	-	`sha256:b180b5c48d1d9b575ef1d561315b7ad132f62608f4d927596302bfddae4d50c3`  
		...
		Size: 312.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ae95309b6e01e02615471ce1c1bfd9a6e134b011fc1a713ccde01a18945db64`  
		Last Modified: Fri, 11 Mar 2022 11:24:58 GMT  
		Size: 3.0 MB (3046805 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:52f3540b83cff114ec8786154503e5b5b40a3f87a0744cf0c7c3859fd35e4ea9`  
		Last Modified: Fri, 11 Mar 2022 11:25:00 GMT  
		Size: 22.3 MB (22285230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f476cc0c41545befb3c1ce3c05b27a0f09395f30b338b8cbe56f46320bd7cda`  
		Last Modified: Fri, 11 Mar 2022 11:24:58 GMT  
		Size: 1.8 KB (1828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2f85cce2416735492192a3b920d1ab248fd533706d8ee9ea2a5bfd7f7004d06c`  
		Last Modified: Fri, 11 Mar 2022 11:24:58 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
