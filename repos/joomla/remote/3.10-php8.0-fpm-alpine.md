...
```console
$ docker pull joomla@sha256:cc118adbf56b3f03868c94aeb3f7646c97d9788ae913766286955e1ce0b232f8
```
...
```console
$ docker pull joomla@sha256:4a76fac175692ac589c5424370cf6186e5a94271338ab87811ff16a9421285dc
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.5 MB (88538698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a9494d22436883bda8d8de87c8962655e6c799f1b29f59a4bc70326e03669dbe`
...
# Wed, 09 Aug 2023 11:34:50 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 11:34:51 GMT
...
-	Layers:
	...
	-	`sha256:f8d7dada7f1fefd30391e2795aef2d5e248751d8ac143c604878020db3fa886b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7b40c0ec0d7352bc6b1d940e0ad5c7da41581e19cf6591883b552995a5b330a4`  
		Last Modified: Wed, 09 Aug 2023 11:43:59 GMT  
		Size: 3.6 MB (3634941 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbffe4005349dd6408f745f4b2beaf9fa8f54f8a38a478b47df1a56c92eaec53`  
		Last Modified: Wed, 09 Aug 2023 11:44:00 GMT  
		Size: 67.0 KB (66960 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58f17667bfc5eb230a7e27d646c1a5b2ac5d355dd49f8cd2ab117bd679b5a2dd`  
		Last Modified: Wed, 09 Aug 2023 11:43:56 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0332c6c6091907f839d2b7ab4d0f120e8a5b04388efb755ab9d97a2f3e9bb168`  
		Last Modified: Wed, 09 Aug 2023 11:43:58 GMT  
		Size: 9.7 MB (9713496 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34b25efc2445002e32d589b7a482b6648d5f0bcd4ed41b32f4c50ef196bd894b`  
		Last Modified: Wed, 09 Aug 2023 11:43:56 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:afa989542d4b7901f622ff8cf61e450916dce2c653b0e8c1ec8fd6361dba9e99`  
		Last Modified: Wed, 09 Aug 2023 11:43:56 GMT  
...
```console
$ docker pull joomla@sha256:86f47ebdb89c05212223440e42ad269e2400ca534b6f97e3994c43fa83eb820d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **86.3 MB (86257150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:80b9da8110b73c8b73e5e5b8cc5d1209ad033c933532c6a9a40e0f2911305051`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Wed, 09 Aug 2023 11:03:57 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install mcrypt-1.0.4; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		mcrypt 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 09 Aug 2023 11:03:58 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 11:03:59 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 09 Aug 2023 11:03:59 GMT
VOLUME [/var/www/html]
# Wed, 09 Aug 2023 11:03:59 GMT
...
-	Layers:
	...
	-	`sha256:143cef7c2c7f97abafbe29324f34427e454540dd95ca1907380053ae90f0a32c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2ba2aa374ff8ad291c74ee16462bf668961ad37cc8b628fcb4c77a0f24b0b88`  
		Last Modified: Wed, 09 Aug 2023 11:12:51 GMT  
		Size: 3.6 MB (3570646 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccad4f153516054ad038de785fc95befe540e9f9283019927a4022d970b0bc40`  
		Last Modified: Wed, 09 Aug 2023 11:12:48 GMT  
		Size: 67.0 KB (66954 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b33121b3374b559cac44fa10165b486387f213ac1f76b2407744715faff88fd1`  
		Last Modified: Wed, 09 Aug 2023 11:12:48 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8e3eaabc3d70b0452f96eb17623c7869baf4396cec240c850b47c929c8bad613`  
		Last Modified: Wed, 09 Aug 2023 11:12:50 GMT  
		Size: 9.7 MB (9713489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a62099b01a0365d159a257ce1bf77c11726330071f809b38b185aadee46371a7`  
		Last Modified: Wed, 09 Aug 2023 11:12:48 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44c5f801c1d231c5d1ee8a61860b5e5e50888f877abd9bb6662210ec69fdf68f`  
		Last Modified: Wed, 09 Aug 2023 11:12:48 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:e566a26691dbc9e64f0ba7d701515700caa6010352c7607de321b0e74909d10f
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **94.3 MB (94300214 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f42c321a1bc695cf24c092c99fd1f1cc06173243c479a4235b483630cb34273e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Wed, 09 Aug 2023 10:27:18 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install mcrypt-1.0.4; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		mcrypt 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 09 Aug 2023 10:27:21 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 10:27:25 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 09 Aug 2023 10:27:29 GMT
VOLUME [/var/www/html]
# Wed, 09 Aug 2023 10:27:36 GMT
ENV JOOMLA_VERSION=3.10.12
# Wed, 09 Aug 2023 10:27:39 GMT
ENV JOOMLA_SHA512=9a3b73346b49718977887781071023a0c11f9de5d6707f8cd7622555d11a1e7ee00c17ba5ce2f20651395ae7d3895c6f65ac131c3bcd5185ccbf444fa428cebe
# Wed, 09 Aug 2023 10:27:49 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/3.10.12/Joomla_3.10.12-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 09 Aug 2023 10:27:52 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Wed, 09 Aug 2023 10:27:54 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 09 Aug 2023 10:27:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Aug 2023 10:27:57 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1a8d879a5e08721bcca837a67022a3d29a07ae309ac48ff4c7a26c1b9f852d89`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe727d2a1113b2c6c22cb274f00a2b5197e126c93f7991959f4cfaa777c18c29`  
		Last Modified: Wed, 09 Aug 2023 10:47:00 GMT  
		Size: 3.8 MB (3834854 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fc3ba3a88519ba30bd097c517ad7ae70471ecd6a3ebf7d27876e54430da4e74`  
		Last Modified: Wed, 09 Aug 2023 10:46:56 GMT  
		Size: 66.9 KB (66924 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fce2826f804fd2598e49c500efa88f9738cd7565afc3787da7a221c2bb3991fc`  
		Last Modified: Wed, 09 Aug 2023 10:46:56 GMT  
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4645a3e62fe4bbacf3804e9a57a186167262de49bdd777cfaa4a8d6150059b84`  
		Last Modified: Wed, 09 Aug 2023 10:46:59 GMT  
		Size: 9.7 MB (9713495 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06866a475c360dad3719199c645170d8dd7d64ae49b4acea343c22ab7c7a3a49`  
		Last Modified: Wed, 09 Aug 2023 10:46:56 GMT  
		Size: 1.8 KB (1841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c44995f4a6946bf50a5cb94fddf4bef797a088ae58e0ba7a7205d59e859bdca2`  
		Last Modified: Wed, 09 Aug 2023 10:46:56 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ab65e3a923bff04170ac46b6dccc3c60aa172e08ff44055df6b036cf5b9d2e04
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **77.9 MB (77870703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11e8b5b08b9827414235e3e77594d580b688f153ff039d570f5b17bd1076994f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apk add --no-cache 		bash 		ghostscript 		imagemagick 	;
# Wed, 09 Aug 2023 10:03:46 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		freetype-dev 		imagemagick-dev 		libjpeg-turbo-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libwebp-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 		pecl install APCu-5.1.21; 	pecl install mcrypt-1.0.4; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		mcrypt 		memcached 		redis 	; 	rm -r /tmp/pear; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive "$extDir" 			| tr ',' '\n' 			| sort -u 			| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 	)"; 	apk add --no-network --virtual .joomla-phpexts-rundeps $runDeps; 	apk del --no-network .build-deps; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 09 Aug 2023 10:03:48 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 09 Aug 2023 10:03:48 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 09 Aug 2023 10:03:49 GMT
VOLUME [/var/www/html]
# Wed, 09 Aug 2023 10:03:49 GMT
ENV JOOMLA_VERSION=3.10.12
# Wed, 09 Aug 2023 10:03:49 GMT
ENV JOOMLA_SHA512=9a3b73346b49718977887781071023a0c11f9de5d6707f8cd7622555d11a1e7ee00c17ba5ce2f20651395ae7d3895c6f65ac131c3bcd5185ccbf444fa428cebe
# Wed, 09 Aug 2023 10:03:55 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/3.10.12/Joomla_3.10.12-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 09 Aug 2023 10:03:57 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Wed, 09 Aug 2023 10:03:58 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 09 Aug 2023 10:03:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 09 Aug 2023 10:03:58 GMT
...
-	Layers:
	...
	-	`sha256:3e3b801e6029db3b2dc4d04ff2d666adfb7c3c4343d21b2dbc53eb86b38eb059`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85c1d7bb7a4fc908238a26b2e76c35572dade6d1e2ee16d2cfabf2fc487fb3d0`  
		Last Modified: Wed, 09 Aug 2023 10:11:46 GMT  
		Size: 3.6 MB (3588301 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c67215e567f5f2c73bb51f6036efa92b4e720530ac0239a9971e6e8271fdab8`  
		Last Modified: Wed, 09 Aug 2023 10:11:43 GMT  
		Size: 60.9 KB (60907 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e56763298bd93445a1a7a195f04bd857ba9d7cad923483a262723f7be0f0cf54`  
		Last Modified: Wed, 09 Aug 2023 10:11:43 GMT  
		Size: 389.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:da3de358ac4bb37552d8d55544c128a2a4a64cfc9b27451b79718bf2285f17d3`  
		Last Modified: Wed, 09 Aug 2023 10:11:45 GMT  
		Size: 9.7 MB (9713498 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12518f8ed54e834d83928591ebdd913b2dbbff63b6dec4bdf9151672b215386b`  
		Last Modified: Wed, 09 Aug 2023 10:11:43 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d23091c7f3aea89a0a6560e7c8123dc0be1fff121a0ff6df6fbf9dec5fc58c5`  
		Last Modified: Wed, 09 Aug 2023 10:11:43 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
