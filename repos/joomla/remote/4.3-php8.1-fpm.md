...
```console
$ docker pull joomla@sha256:a58485180d99ee258b4348d544c1df923daaa3254e464fe134ee4a10ebbf6789
```
...
```console
$ docker pull joomla@sha256:0b53567999510adac939b450163958d7086b289367fec7c83b8837b7d582dc02
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.3 MB (202325760 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4311ecaade489d1d4c629f021842a0998dd192ac8eefccc5bbf9fffb36966d0c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 02 Nov 2023 03:21:10 GMT
ENV JOOMLA_VERSION=4.3.4
# Thu, 02 Nov 2023 03:21:14 GMT
ENV JOOMLA_SHA512=2efede3c3230d2fd849c46f84eea9aa1ef2bef6836e0ceec6451499bb6abf7e747d63f3996d0a5f7fc2d439c5ae0380e0e71f7c2823adfdda80e87a0bc377be1
# Thu, 02 Nov 2023 03:22:25 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 02 Nov 2023 03:22:33 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Thu, 02 Nov 2023 03:22:39 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 02 Nov 2023 03:22:45 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 02 Nov 2023 03:22:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0e0d10dc5a926e4cf37076ec998a96d164ba09a5e5735bbbe9fffbb6327f5d5d`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15eff13e67fa2ba52f02e245f240f13df2f1f09d4960b7e98999c057d20a5f86`  
		Last Modified: Thu, 02 Nov 2023 04:04:11 GMT  
		Size: 25.1 MB (25054220 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22084b044491dcdba8af25e74d00f6fde4c59878371d668b44fb6748a9083ddf`  
		Last Modified: Thu, 02 Nov 2023 04:03:49 GMT  
		Size: 2.6 KB (2618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4227a5b8d295ee1ba00e6809248ec9d8dadb24eddfeb51a133ad3e80edf3597e`  
		Last Modified: Thu, 02 Nov 2023 04:03:49 GMT  
		Size: 1.1 KB (1060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
