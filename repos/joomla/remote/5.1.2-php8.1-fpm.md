...
### `joomla:5.1.2-php8.1-fpm` - linux; arm variant v5
...
### `joomla:5.1.2-php8.1-fpm` - linux; arm variant v7
...
### `joomla:5.1.2-php8.1-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.2-php8.1-fpm` - linux; 386
...
### `joomla:5.1.2-php8.1-fpm` - linux; s390x
