...
```console
$ docker pull joomla@sha256:1acee362e55241d7ce996eaf20e3c8a53fa2efb2106466f5040461df601f7b61
```
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; 386
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; ppc64le
...
### `joomla:5.1.0-php8.1-fpm-alpine` - linux; s390x
