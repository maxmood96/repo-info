...
```console
$ docker pull joomla@sha256:b5c6b1b4331171a990bdf0076b5e0ad69ba5f7d9bae378af1183b82c084950c9
```
...
### `joomla:3.10.9-php7.4-fpm` - linux; amd64
...
### `joomla:3.10.9-php7.4-fpm` - linux; arm variant v5
...
### `joomla:3.10.9-php7.4-fpm` - linux; ppc64le
