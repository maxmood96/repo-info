...
```console
$ docker pull joomla@sha256:19af0e57e1dd1623e7d9810f1acce7738c109dd59ddb72691a31c3a576569a7e
```
...
### `joomla:3.9.21-fpm` - linux; arm variant v5
...
### `joomla:3.9.21-fpm` - linux; arm variant v7
...
### `joomla:3.9.21-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.21-fpm` - linux; mips64le
...
### `joomla:3.9.21-fpm` - linux; ppc64le
