...
```console
$ docker pull joomla@sha256:f14f766c92b0aed1ebebf167535dcc904efd7506b7d86e96b3fc7b2eed85d44c
```
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; amd64
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; arm variant v5
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; arm variant v7
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; 386
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; mips64le
...
### `joomla:5.1.0-beta2-php8.1-apache` - linux; ppc64le
