...
```console
$ docker pull joomla@sha256:f7cb87311c7ac4cdb65eb7ed4b497c15fb8b17c7d8565b9964ba17f4cec45117
```
...
### `joomla:5.3.4-php8.3-fpm` - linux; arm variant v7
...
### `joomla:5.3.4-php8.3-fpm` - linux; arm64 variant v8
...
### `joomla:5.3.4-php8.3-fpm` - linux; 386
...
### `joomla:5.3.4-php8.3-fpm` - linux; ppc64le
...
### `joomla:5.3.4-php8.3-fpm` - linux; s390x
