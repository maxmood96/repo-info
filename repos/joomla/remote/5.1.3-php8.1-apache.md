...
```console
$ docker pull joomla@sha256:8bd3538262a4e40a7eea95504adcc18d654fe718fb8be7a4235c46beb362858c
```
...
### `joomla:5.1.3-php8.1-apache` - linux; amd64
...
### `joomla:5.1.3-php8.1-apache` - linux; arm variant v5
...
### `joomla:5.1.3-php8.1-apache` - linux; arm variant v7
...
### `joomla:5.1.3-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:5.1.3-php8.1-apache` - linux; 386
...
### `joomla:5.1.3-php8.1-apache` - linux; s390x
