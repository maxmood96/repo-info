...
```console
$ docker pull joomla@sha256:e5458dde678ef745f17050e49f8d011c0187a949557911caf7ce6a18a755a1a2
```
...
```console
$ docker pull joomla@sha256:eacbb5a6f2d2c303cbc5b14b7d2d8cb2c759d47e274a59ff1b534fbc87c406b2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **272.4 MB (272361667 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00d216a6b60378a5fa39f8b2f0df241d4d99ae71c01bed2f19f4772ade5545ac`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Jun 2026 02:34:46 GMT
CMD ["php-fpm"]
# Wed, 24 Jun 2026 09:58:46 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Wed, 24 Jun 2026 09:58:46 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 24 Jun 2026 09:58:46 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/* # buildkit
# Wed, 24 Jun 2026 10:03:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.8.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.27; 	pecl install memcached-3.4.0; 	pecl install redis-6.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ] # buildkit
# Wed, 24 Jun 2026 10:03:18 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini # buildkit
# Wed, 24 Jun 2026 10:03:18 GMT
...
# Wed, 24 Jun 2026 10:03:18 GMT
ENV JOOMLA_SHA512=73ecfd0f94e04a563d55293df741770b47cc3fcfdb75c383bc9c909d2071d2b212723a2546dae0978a866b0b90da31aec301ae66467722848657696b870ae7a9
# Wed, 24 Jun 2026 10:03:21 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/6.1.1/Joomla_6.1.1-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla # buildkit
# Wed, 24 Jun 2026 10:03:21 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Wed, 24 Jun 2026 10:03:22 GMT
COPY makedb.php /makedb.php # buildkit
# Wed, 24 Jun 2026 10:03:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Jun 2026 10:03:22 GMT
...
-	Layers:
	...
	-	`sha256:e6c1ec6a87cbfd9e02a7a67615b0a073e9f7e127f18ace280a17143d5e0474a6`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:02d1108d15e0be14232613623427070295d98a4ba31104d332cc72ff3ad47d4a`  
		Last Modified: Wed, 24 Jun 2026 10:03:41 GMT  
		Size: 28.6 MB (28556157 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2d9d43145279e357aa43952dfeea85989b4aa05399ad8b17775a03c174f264a4`  
		Last Modified: Wed, 24 Jun 2026 10:03:41 GMT  
		Size: 47.0 MB (47015910 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:097736cbc3efd52b662b5b10816ea8a3a70f9d5a85280c50fd4f62628f410130`  
		Last Modified: Wed, 24 Jun 2026 10:03:39 GMT  
		Size: 314.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:23e6e705e4ec8cf22d8c92aa38c46d9563af87be2d6585d1115cd5e09db1a3e1`  
		Last Modified: Wed, 24 Jun 2026 10:03:39 GMT  
		Size: 393.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b7e3cf16ab2371f3cc4e714bc4f6e0b53b2cc2e17eed25d9e20f53800be5f2ad`  
		Last Modified: Wed, 24 Jun 2026 10:03:42 GMT  
		Size: 28.4 MB (28375309 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:bbe8b1df5f5c99417c8f290022719c0d6d06a2c30bee0671e315b0e31a2d821f`  
		Last Modified: Wed, 24 Jun 2026 10:03:41 GMT  
		Size: 3.7 KB (3653 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:85b54fea90777d114b1c64803a4d89f34774c8f67f6262feffa6e9aafb8c215c`  
		Last Modified: Wed, 24 Jun 2026 10:03:42 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:f01e8fce892dffb383ca74c255f69c813bcf5a2f2a048e395e2122b2c74d24d0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.5 KB (46534 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b0848caeff744cb98d308b3df857369cedd5332fe18678e03b3b458ea195e418`

```dockerfile
```

-	Layers:
	-	`sha256:00846b398adfba0825e1affc4b43e8cefe9952eaaced525ab98ad1a9457a40b7`  
		Last Modified: Wed, 24 Jun 2026 10:03:39 GMT  
