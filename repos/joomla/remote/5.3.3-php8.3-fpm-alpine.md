...
```console
$ docker pull joomla@sha256:81420668cb8a77df10cd049ab04ca7b3ababd00c0479213a118fdecc584ca6e9
```
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; amd64
...
### `joomla:5.3.3-php8.3-fpm-alpine` - unknown; unknown
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; 386
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; ppc64le
...
### `joomla:5.3.3-php8.3-fpm-alpine` - linux; s390x
