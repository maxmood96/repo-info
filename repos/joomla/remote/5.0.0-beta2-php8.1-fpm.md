...
```console
$ docker pull joomla@sha256:7d087d5e109e038a0be7be9efe3441f09b7afde4f2e3c0653bf01243697ebde1
```
...
```console
$ docker pull joomla@sha256:43bd4e93119d637deae7dc137312a366ebad45ba9b11bf1cf8f6a13791ea6946
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **189.2 MB (189167298 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4b915cc7c825237e715810d698c1a775ee07fee389d5f24742836eeaa3155d4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 20 Sep 2023 07:40:13 GMT
CMD ["php-fpm"]
# Thu, 21 Sep 2023 09:01:25 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 21 Sep 2023 09:01:25 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 21 Sep 2023 09:01:35 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 21 Sep 2023 09:03:57 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Thu, 21 Sep 2023 09:03:57 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Thu, 21 Sep 2023 09:03:58 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Thu, 21 Sep 2023 09:03:58 GMT
VOLUME [/var/www/html]
# Thu, 21 Sep 2023 09:03:58 GMT
...
# Thu, 21 Sep 2023 09:03:58 GMT
ENV JOOMLA_SHA512=e7b613b818ed2406c164ee7520779ab50cf5c700a9b54e64256ed3b150103a9dc3e2cbaad06030eafea0d63b3f0314024a716f1e1c456eea13733508daddbcd8
# Thu, 21 Sep 2023 09:04:05 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/5.0.0-beta2/Joomla_5.0.0-beta2-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Sep 2023 09:04:06 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Thu, 21 Sep 2023 09:04:06 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 21 Sep 2023 09:04:06 GMT
...
-	Layers:
	...
	-	`sha256:9a646e61fe6e4e34dd10e44552b04764d5eac7b195fc8e83be567f76109fc41b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60e88785330f7ed7be3db57f3a6d0c9e629f8e3b1993de1d0a6a04a7e5d1ecc0`  
		Last Modified: Thu, 21 Sep 2023 09:23:56 GMT  
		Size: 25.2 MB (25166305 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d7ef83f529cee7e143192c0b870b63197cd9b9c9800347acba0b78e85abbbb6`  
		Last Modified: Thu, 21 Sep 2023 09:23:53 GMT  
		Size: 3.2 MB (3171176 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9b715c8d9b4388907e4c43a20f920a6e85d49de83076f93abc89fd4e2d505a6`  
		Last Modified: Thu, 21 Sep 2023 09:23:50 GMT  
		Size: 375.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d734763b8f3690dbc78f73c69cd525b84f979eaec3e6f5e4528e5d707d9072fe`  
		Last Modified: Thu, 21 Sep 2023 09:23:50 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a6c776fa70cd24b0311fca8553ebb21ff824a4c764c8d3a692ccb5077ee5e2e`  
		Last Modified: Thu, 21 Sep 2023 09:23:55 GMT  
		Size: 22.5 MB (22460988 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a9160fd05d5fbefe0c475fbadde366855edeeff6de1f2d1b126ed8a74a60fbc5`  
		Last Modified: Thu, 21 Sep 2023 09:23:50 GMT  
		Size: 1.8 KB (1839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43192c0ea19a29b14cd8f6ee840c1a2c126fa22e06e87098abc5c7412c26d0f3`  
		Last Modified: Thu, 21 Sep 2023 09:23:50 GMT  
...
```console
$ docker pull joomla@sha256:5ed61ca5e32ed1dfddb74e528de6550f87b3a19f770720a1ec20353196157ace
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.7 MB (230675615 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:89bec9714967f1e1d0abe0b3ffb085c202a0cfe8be56ee561d8757aa23243122`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 21 Sep 2023 11:54:50 GMT
ENV JOOMLA_SHA512=e7b613b818ed2406c164ee7520779ab50cf5c700a9b54e64256ed3b150103a9dc3e2cbaad06030eafea0d63b3f0314024a716f1e1c456eea13733508daddbcd8
# Thu, 21 Sep 2023 11:55:01 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/5.0.0-beta2/Joomla_5.0.0-beta2-Beta-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Sep 2023 11:55:03 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Thu, 21 Sep 2023 11:55:04 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 21 Sep 2023 11:55:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Sep 2023 11:55:04 GMT
...
-	Layers:
	...
	-	`sha256:cba37db20fd27af802e7ced38f1c48d12a49ece8bf0a296bbe5d8f9822915a0a`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7296dddc7c77cf1fb084d3c3a56567192b09bcc367eabe941f2a914eeec80457`  
		Last Modified: Thu, 21 Sep 2023 12:33:35 GMT  
		Size: 22.5 MB (22460975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92190f27981b57b9c7122ecc7caa30da4a1663c2fe6e35663be010c857eb61df`  
		Last Modified: Thu, 21 Sep 2023 12:33:28 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e16c3bdf355339c6287a3f510535d3a81f59e84c418bc3ff9cbc09bc5643026c`  
		Last Modified: Thu, 21 Sep 2023 12:33:28 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
