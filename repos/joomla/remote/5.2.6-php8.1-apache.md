...
### `joomla:5.2.6-php8.1-apache` - linux; arm64 variant v8
...
### `joomla:5.2.6-php8.1-apache` - linux; mips64le
...
### `joomla:5.2.6-php8.1-apache` - linux; ppc64le
...
### `joomla:5.2.6-php8.1-apache` - linux; s390x
