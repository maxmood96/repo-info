...
```console
$ docker pull joomla@sha256:e52c6146fcb45896527cbf4dd76ad910b0ac8a8946afcaa6981f2e4bf69dd54d
```
...
```console
$ docker pull joomla@sha256:f4ea61331d79c3cf003a343762ac7f19d61e8d8299d642dc7e2f7905c3a8ffb7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **312.0 MB (312041649 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93a32d73ae26917449d95b9d722c6083a00deb2636e564eff57bd4ac7075af1d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sat, 11 Apr 2026 07:39:35 GMT
ENV JOOMLA_SHA512=ec838f01572dcd67030cf2e848c89f80b381631882a5ec68497b372329e33837ebae84d95c1a4ca73d72564d260033b061fa21082678c7025641f58661885242
# Sat, 11 Apr 2026 08:18:50 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.4.4/Joomla_5.4.4-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla # buildkit
# Sat, 11 Apr 2026 08:18:51 GMT
COPY docker-entrypoint.sh /entrypoint.sh # buildkit
# Sat, 11 Apr 2026 08:18:51 GMT
COPY makedb.php /makedb.php # buildkit
# Sat, 11 Apr 2026 08:18:51 GMT
...
-	Layers:
	...
	-	`sha256:f29cd9a8631dc70ac7da0eb2c1ccb4ae25483d99ca7b30a33982d6e6ac4dfd04`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f028a6ccaff76bf78ead2844a7f1d3c30020ef7fa71979ea5688f2d71727f4e0`  
		Last Modified: Sat, 11 Apr 2026 08:20:27 GMT  
		Size: 26.1 MB (26146421 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:819fe87bfce39c5b31e3c24c348104177f8b5d62a851d1edeafecc04d730104c`  
		Last Modified: Sat, 11 Apr 2026 08:20:23 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:cb6c396441c98a8f43e9eab997b8371de75e5ff04ef88379fdfec46733ea3db9`  
		Last Modified: Sat, 11 Apr 2026 08:20:23 GMT  
		Size: 1.1 KB (1071 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull joomla@sha256:0151b80cfe05b17d229b4b87ba8572de9b607825e2696098da4b03a2cf5ee584
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **60.3 KB (60282 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b62ea77e10264794c9e214a9f412feb76bbe7e1874018883e13ddb9d290e1a9`

```dockerfile
```

-	Layers:
	-	`sha256:8e64ecab847e6127cd279d259ce49c22b9a5e79c067411948cb84f3c295f854c`  
		Last Modified: Sat, 11 Apr 2026 08:20:22 GMT  
