...
```console
$ docker pull joomla@sha256:c54aa866308f912d6e5139893cac087b38e2db35516bfda697775114635e024e
```
...
```console
$ docker pull joomla@sha256:d8761c9ceb8adc39f45308c9e2dde6db492e2fa24e80e515d5ac681ba3a46716
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.6 MB (183627163 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7e6ef06e27bb40a5e886e8feb8d6a5e3de31641e2850a567777f6496fd00e79f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 10 Jun 2022 04:06:18 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 10 Jun 2022 04:06:18 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 10 Jun 2022 04:06:19 GMT
RUN a2enmod rewrite
# Fri, 10 Jun 2022 04:08:01 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 04:08:02 GMT
VOLUME [/var/www/html]
# Fri, 10 Jun 2022 04:08:03 GMT
ENV JOOMLA_VERSION=4.1.4
# Fri, 10 Jun 2022 04:08:04 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Fri, 10 Jun 2022 04:08:11 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 10 Jun 2022 04:08:12 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 10 Jun 2022 04:08:13 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
...
-	Layers:
	...
	-	`sha256:335eb864c6671b105bcd7a49b121e369cb569ff7ce2b8df0ca747cce7fa7b268`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:04fca12c2d64f79479c7844078f12c54bc41f180056d92d9961cb3a80ea69c43`  
		Last Modified: Fri, 10 Jun 2022 04:24:22 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9b554251c8bf02eef24c545d71b2b859541eeaf693cc295757b5295735938999`  
		Last Modified: Fri, 10 Jun 2022 04:24:23 GMT  
		Size: 2.9 MB (2873492 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd75684ec77a3bab7969542a41e19f966fbd719f3ec36c7f800b207e49acf5f3`  
		Last Modified: Fri, 10 Jun 2022 04:24:26 GMT  
		Size: 22.1 MB (22072978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f78e915d5e54beb06386cb4d4b1ada91f0e5fcd11524fece498ca2b938ec1f7`  
		Last Modified: Fri, 10 Jun 2022 04:24:22 GMT  
		Size: 1.8 KB (1828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b134267847b668eba47a595e6fa578e63ac4508d0c604818a05e43f3ef641ef3`  
		Last Modified: Fri, 10 Jun 2022 04:24:22 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:125f7c540e350ddef7a78fccf567657b7e0bddf32d95032c7cea72ff99ddf9ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.7 MB (167729669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0498d4289e39b7a50d20585ba4358412e9fab75b439f3845e9cc7c7226996e61`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 09 Jun 2022 22:46:03 GMT
CMD ["apache2-foreground"]
# Fri, 10 Jun 2022 04:08:38 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 10 Jun 2022 04:08:38 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 10 Jun 2022 04:08:39 GMT
RUN a2enmod rewrite
# Fri, 10 Jun 2022 04:10:12 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 04:10:12 GMT
VOLUME [/var/www/html]
# Fri, 10 Jun 2022 04:10:12 GMT
...
# Fri, 10 Jun 2022 04:10:12 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Fri, 10 Jun 2022 04:10:20 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 10 Jun 2022 04:10:22 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 10 Jun 2022 04:10:23 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 10 Jun 2022 04:10:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 04:10:23 GMT
...
-	Layers:
	...
	-	`sha256:80d4415ec20cb3238683af7def7b35516c0dc35cd7b860765b9a73c36899ed11`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:353376aadfaa4615d5978261052ba234e827d0d0708330cf16881569b92765f1`  
		Last Modified: Fri, 10 Jun 2022 04:24:21 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:94cbc7713a4aabc0480888fe5cf316ecabfd2889a2fa6896422dc11bf1116c9b`  
		Last Modified: Fri, 10 Jun 2022 04:24:22 GMT  
		Size: 3.1 MB (3091749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:285d41684e8dc3e40525cb70bd0b7407af53f204b853034fe8bdc378d517eb21`  
		Last Modified: Fri, 10 Jun 2022 04:24:24 GMT  
		Size: 22.1 MB (22073757 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27f211b48c1c57f06e1ab9bd01fb109981b3c67b5c5f35660760e23e138ea56a`  
		Last Modified: Fri, 10 Jun 2022 04:24:21 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d19efa99b8439d82593e88b63ecd692c68e6f949baecc3a854425ce31dbe2ec1`  
		Last Modified: Fri, 10 Jun 2022 04:24:21 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
