...
```console
$ docker pull joomla@sha256:69515fbdab10de62b52738cb59febb764d1048a7970f5306a3ac09e3b1b194d9
```
...
```console
$ docker pull joomla@sha256:58736d5f3ea9bd7931517b0c68bf67cc01e78bd7dc0d8352715182edfbf136c9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **172.1 MB (172134772 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:18a34aa1cd6ac4e6007e9c70f56b17be7110af68fb11a564060b1d61b04bbe5e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 13:31:41 GMT
CMD ["apache2-foreground"]
# Wed, 02 Mar 2022 09:34:44 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Wed, 02 Mar 2022 09:34:44 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 02 Mar 2022 09:34:46 GMT
RUN a2enmod rewrite
# Wed, 02 Mar 2022 09:39:34 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 09:39:34 GMT
VOLUME [/var/www/html]
# Wed, 02 Mar 2022 09:39:34 GMT
ENV JOOMLA_VERSION=4.1.0
# Wed, 02 Mar 2022 09:39:35 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Wed, 02 Mar 2022 09:39:53 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 02 Mar 2022 09:39:54 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 02 Mar 2022 09:39:55 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 02 Mar 2022 09:39:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 02 Mar 2022 09:39:55 GMT
...
-	Layers:
	...
	-	`sha256:2e9558003eb1bbf2615081adce567bfed6210683a425758032fa39f2b68d658b`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c52ed08cedb975309b8db93c7d9a3495590fc8ae744752a9ca940448de16e4e`  
		Last Modified: Wed, 02 Mar 2022 10:14:15 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ec7ee30c0883f03726bc89d6805f372208921b5d1b0b6e476273ba41416617b`  
		Last Modified: Wed, 02 Mar 2022 10:14:18 GMT  
		Size: 2.9 MB (2921866 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03d9522739b937b0afe41e0e96a3d4c86b04563d1d6f894273a0fccea9dcce6e`  
		Last Modified: Wed, 02 Mar 2022 10:14:35 GMT  
		Size: 22.3 MB (22285197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:06d378a61141b8dfd36cb51444d1791b5da2e0c30e9cccd62c1d133fee936ab7`  
		Last Modified: Wed, 02 Mar 2022 10:14:15 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c822f7595204faed11c01cc01c830c0f4957fc2f03a80541741404afe90ef6aa`  
		Last Modified: Wed, 02 Mar 2022 10:14:15 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:1cbac9884fe51b68af31723345b3f65aeccc02750a1bd34bcec7d2b594d2e4ff
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.6 MB (197630270 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed51146ca39cb86f3602c658d214e473ebe3b1dcd410357946301c55bcf70801`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Mar 2022 15:30:15 GMT
CMD ["apache2-foreground"]
# Wed, 02 Mar 2022 07:19:30 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Wed, 02 Mar 2022 07:19:30 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 02 Mar 2022 07:19:31 GMT
RUN a2enmod rewrite
# Wed, 02 Mar 2022 07:21:26 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.6; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 02 Mar 2022 07:21:26 GMT
VOLUME [/var/www/html]
# Wed, 02 Mar 2022 07:21:26 GMT
...
# Wed, 02 Mar 2022 07:21:26 GMT
ENV JOOMLA_SHA512=44173170fb1598c465415cba919339c26624322621efed17c95fdffca7b62a1089863615e415f0ec36a6a4c4f5c746b7ec06dddd08929757f737e1a2a15ff714
# Wed, 02 Mar 2022 07:21:34 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 02 Mar 2022 07:21:34 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 02 Mar 2022 07:21:35 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 02 Mar 2022 07:21:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 02 Mar 2022 07:21:35 GMT
...
-	Layers:
	...
	-	`sha256:51a78aa8280a6ceedcc96b34de71dcf29d0a4357fdd4a4562c24846bf4d0a914`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c6992e1550caa19fbaf2010a72c4ebe753604b355ea609c429022b5c0323d30`  
		Last Modified: Wed, 02 Mar 2022 07:35:37 GMT  
		Size: 310.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7941178650705cb85de6652d6d0e7813d341801e96ea57ee62b9b1399ab1adcb`  
		Last Modified: Wed, 02 Mar 2022 07:35:38 GMT  
		Size: 3.1 MB (3148692 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a1d4b66e5e6f4e82367179a2fc5b4b6f46c5db7ae417b545680b4648b15bfe5`  
		Last Modified: Wed, 02 Mar 2022 07:35:42 GMT  
		Size: 22.3 MB (22285196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:164f73238eaf5eecd32c8986cfa92efffee266f1fd3436e5e0dc60756372bc9c`  
		Last Modified: Wed, 02 Mar 2022 07:35:37 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b41064e769c854b36da7b38e1d91b67fc36c2905256c9b733f3b10bea8bc652d`  
		Last Modified: Wed, 02 Mar 2022 07:35:37 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
