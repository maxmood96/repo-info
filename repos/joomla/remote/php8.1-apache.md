...
```console
$ docker pull joomla@sha256:07b4b8a7a3e28a1d5b8f46012c019faa84f122bc9aa5229c1bb3a230bff63513
```
...
```console
$ docker pull joomla@sha256:3b2dacef0dd71fbe0c600af8fddae3121188c012c150f26408fe58ff5729fc5f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **160.4 MB (160374098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a7d4542eaa2c5a8f5553048739a52e3469c8a267f6de73995fa3b1f5b5c19a9`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Sun, 29 May 2022 07:32:27 GMT
CMD ["apache2-foreground"]
# Mon, 30 May 2022 04:15:14 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Mon, 30 May 2022 04:15:14 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Mon, 30 May 2022 04:15:16 GMT
RUN a2enmod rewrite
# Mon, 30 May 2022 04:20:02 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Mon, 30 May 2022 04:20:02 GMT
VOLUME [/var/www/html]
...
# Mon, 30 May 2022 04:20:03 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Mon, 30 May 2022 04:20:23 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Mon, 30 May 2022 04:20:24 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Mon, 30 May 2022 04:20:25 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Mon, 30 May 2022 04:20:25 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 30 May 2022 04:20:25 GMT
...
-	Layers:
	...
	-	`sha256:5753957706ed5b576b3d4c16be5576756dad344af81dbc2ad659bf411dd10284`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a66eb126a23f567fb3efe7c82654ac43861720d827cbe05f4605e51e1e78e1fe`  
		Last Modified: Mon, 30 May 2022 04:44:39 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf90c11e7bbdebf4dd0007520afa8d2f12ccdff4aedfaae7cec7bbdd8c12bbe8`  
		Last Modified: Mon, 30 May 2022 04:44:41 GMT  
		Size: 2.8 MB (2826237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97de8418dfcd8ee1c8d1af7732c18a24a8087ab12de100e9745f7fe90633ed3a`  
		Last Modified: Mon, 30 May 2022 04:44:59 GMT  
		Size: 22.1 MB (22073746 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:13c2b32cea2dbdef59353364fe30bf401a8a637316a816b2c2bfbc464e6fb6f0`  
		Last Modified: Mon, 30 May 2022 04:44:39 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4542a62fe406dae53a25c36cff8027a65203a2c1b708ed93fc7f7d201295694b`  
		Last Modified: Mon, 30 May 2022 04:44:39 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:7cfb646461c00f997b6ea402f3d7dd76e4fcf0ad3f435644f81529befcf2d57c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.5 MB (192527451 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:110cf03a7b10d0b1049d071a6f235d93e80ce2d24679ac277398672ba58bb585`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 10 Jun 2022 02:17:58 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 10 Jun 2022 02:17:59 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 10 Jun 2022 02:18:00 GMT
RUN a2enmod rewrite
# Fri, 10 Jun 2022 02:19:27 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 10 Jun 2022 02:19:27 GMT
VOLUME [/var/www/html]
# Fri, 10 Jun 2022 02:19:28 GMT
ENV JOOMLA_VERSION=4.1.4
# Fri, 10 Jun 2022 02:19:29 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Fri, 10 Jun 2022 02:19:37 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 10 Jun 2022 02:19:38 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Fri, 10 Jun 2022 02:19:39 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 10 Jun 2022 02:19:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 10 Jun 2022 02:19:40 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:15a9c68840c63cdcb7396f1db36f6a1b775465983ed01aab8916aac7e20cbdee`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:41d293cbee7225237078ef17f444067ccd700f33272bb53db0bbd0c03371ab90`  
		Last Modified: Fri, 10 Jun 2022 02:34:38 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27120f858429637f2a2392722250f021e775b1b41e4d29ca3462ed092ea5ee73`  
		Last Modified: Fri, 10 Jun 2022 02:34:39 GMT  
		Size: 2.9 MB (2945373 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed3936932568a97e36d4263cf4eca54587308727c3c10db1e0c86f9f455bc8fb`  
		Last Modified: Fri, 10 Jun 2022 02:34:42 GMT  
		Size: 22.1 MB (22072990 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad45d14793b82cad644eaa3484c2aca631147fd81bee44f8b6b687c146e42778`  
		Last Modified: Fri, 10 Jun 2022 02:34:38 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:867727189bb6068d2fa3daa729a97e27ab190cdaae90207b05948bf77b9b9c84`  
		Last Modified: Fri, 10 Jun 2022 02:34:38 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:d3ee9073bfc059b3c3f5db26d84b3c36030ec807eaac2d32b03bfd2c1f7c0f7d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **167.3 MB (167316789 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f4972e94307d1ba7d4d3ee8d9c9f0f37a45c94012f4e8a065d3c68d50fc6b08c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Mon, 30 May 2022 04:50:55 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Mon, 30 May 2022 04:50:58 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Mon, 30 May 2022 04:51:05 GMT
RUN a2enmod rewrite
# Mon, 30 May 2022 04:57:19 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Mon, 30 May 2022 04:57:23 GMT
VOLUME [/var/www/html]
# Mon, 30 May 2022 04:57:27 GMT
ENV JOOMLA_VERSION=4.1.4
# Mon, 30 May 2022 04:57:31 GMT
ENV JOOMLA_SHA512=a9ffd64d8320d3df2f58df924b750f4b75a15eac194b4a8ef98671208ad2ca8a09a3ea6d55cce51eceded89eae7d6252ba64057b3e12ef88bc75a43d7ee6d70d
# Mon, 30 May 2022 04:58:02 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Mon, 30 May 2022 04:58:09 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Mon, 30 May 2022 04:58:14 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Mon, 30 May 2022 04:58:20 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 30 May 2022 04:58:26 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1e0d7c523e1bbba15c51f0e142dc6406e16f3005e9f2b9d17fc8ec40cee39b3a`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:24a04beaefbf0094731601c83e2c7599adc5ce8b97f877c64e162a70c102d67d`  
		Last Modified: Mon, 30 May 2022 05:22:41 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e84ee1e7d1b57ad44a5aec5bb7cbbf098f193354039a21c6df4ff4d8509bc31`  
		Last Modified: Mon, 30 May 2022 05:22:44 GMT  
		Size: 2.8 MB (2843238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:769046e9455a25f75378da1b6499febbd2b9349dff4e5c34b2417a48d4cf0182`  
		Last Modified: Mon, 30 May 2022 05:22:57 GMT  
		Size: 22.1 MB (22072977 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:723073e340dcedeab91f67a26df6c4d8d7ba60dde8846c6942b55a2d5e289cf6`  
		Last Modified: Mon, 30 May 2022 05:22:41 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:60c72c5f7e4428ad2a5cfaeb3aa19e5b9b200d76904a4c1d3cdd6a18dd8bc0f6`  
		Last Modified: Mon, 30 May 2022 05:22:41 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
