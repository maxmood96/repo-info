...
```console
$ docker pull joomla@sha256:96b5231378500a123c02d2e615aee68173f51ddd78c8ab059348fe9e1d0eb8dd
```
...
### `joomla:4.0.2-php8.0-fpm` - linux; amd64
...
### `joomla:4.0.2-php8.0-fpm` - linux; arm variant v5
...
### `joomla:4.0.2-php8.0-fpm` - linux; arm variant v7
...
### `joomla:4.0.2-php8.0-fpm` - linux; arm64 variant v8
...
### `joomla:4.0.2-php8.0-fpm` - linux; 386
...
### `joomla:4.0.2-php8.0-fpm` - linux; mips64le
...
### `joomla:4.0.2-php8.0-fpm` - linux; s390x
