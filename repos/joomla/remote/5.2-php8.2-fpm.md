...
```console
$ docker pull joomla@sha256:18b50b4b2c46a9f9a0bdd8791811324199f32fd15b25b55965acb1b58070307f
```
...
```console
$ docker pull joomla@sha256:2c009a29f3fecae12fb3fe3932ccaab73ca2585c39437fcb37da52ee8af22da3
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **226.0 MB (225974628 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f8d8f9552b73de70300b45af66872b400fb7898555f53c3c166eed38cfa3c23`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 02 Aug 2024 16:45:57 GMT
ENV JOOMLA_SHA512=4d73b21c1ce7ed5261319c4d77531b67d223571b9c8cfa7cd208ac60cb521011abea96ed0ca90ffd8b70ef45497bffface336a7e11e0f932cb60072ab23e280b
# Fri, 02 Aug 2024 16:46:01 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-alpha3/Joomla_5.2.0-alpha3-Alpha-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 02 Aug 2024 16:46:03 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 02 Aug 2024 16:46:03 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Fri, 02 Aug 2024 16:46:04 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Aug 2024 16:46:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1a7f48a9bb43fdaf3d67d579346e8f195ea5c2c7576f7f835a1d24cbf5e9d5fc`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eeda17044965eaf6a5c139dc7c07347c2c7c00e3105b0298e9d3aa531671d226`  
		Last Modified: Fri, 02 Aug 2024 17:05:51 GMT  
		Size: 23.2 MB (23181062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:82fa574b7606f27291d2900c41539f9b7eb75b39db1972fd0991b0b0ebc30a71`  
		Last Modified: Fri, 02 Aug 2024 17:05:48 GMT  
		Size: 3.7 KB (3656 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7a093504339470daa30e0daac8ee6d8629a21d481de8dd767aa4e35a49635c8`  
		Last Modified: Fri, 02 Aug 2024 17:05:48 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
