...
```console
$ docker pull joomla@sha256:c724de119952950de6c90ac7a4b9a429c91d2ae970dc7860943482698a71ec60
```
...
### `joomla:4.4.4-apache` - linux; arm variant v5
...
### `joomla:4.4.4-apache` - linux; arm variant v7
...
### `joomla:4.4.4-apache` - linux; arm64 variant v8
...
### `joomla:4.4.4-apache` - linux; mips64le
...
### `joomla:4.4.4-apache` - linux; ppc64le
...
### `joomla:4.4.4-apache` - linux; s390x
