...
```console
$ docker pull joomla@sha256:06f052347c560ed7306e9564f0a398f5037798dd56ac50ec89f358dbd0528f01
```
...
```console
$ docker pull joomla@sha256:982821f3b80d1b70f00cc4e45d672ed397b659c9f138c0fc0f9cc664db1e9607
```

-	Docker Version: 19.03.8
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.6 MB (144588964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6f8ed747357c0f5290beab81af8c736c38c334390cbed97e69736aaf960e63d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 09 Jun 2020 04:58:20 GMT
CMD ["apache2-foreground"]
# Tue, 09 Jun 2020 21:05:16 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Tue, 09 Jun 2020 21:05:17 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 09 Jun 2020 21:05:19 GMT
RUN a2enmod rewrite
# Tue, 09 Jun 2020 21:10:10 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 09 Jun 2020 21:10:11 GMT
VOLUME [/var/www/html]
# Tue, 09 Jun 2020 21:10:11 GMT
ENV JOOMLA_VERSION=3.9.18
# Tue, 09 Jun 2020 21:10:11 GMT
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Tue, 09 Jun 2020 21:10:27 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 09 Jun 2020 21:10:28 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 09 Jun 2020 21:10:29 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 09 Jun 2020 21:10:29 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 09 Jun 2020 21:10:29 GMT
...
-	Layers:
	...
	-	`sha256:37030a9bf3239197d7d4ced71b6f1323869e89ab068c112be22717702d7d5be5`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c8ed4989e4083286877e80f32f58d36a2f71bba7787732c6338bc3d186d4642`  
		Last Modified: Tue, 09 Jun 2020 21:26:55 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3553a6fb7078a831b49eb2d5d7bc0e9fd87ecf0595a11454781862dfb6305643`  
		Last Modified: Tue, 09 Jun 2020 21:26:59 GMT  
		Size: 3.4 MB (3383001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2d3338e93b32c7a7edc91fb0a6f7a07ecd15f4098750ef92842ef4f6bb16b9c`  
		Last Modified: Tue, 09 Jun 2020 21:27:07 GMT  
		Size: 9.7 MB (9653286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:291247bd369bcb6e2b1a331f571b98884df31d7c741c00f56e7f3a9499995033`  
		Last Modified: Tue, 09 Jun 2020 21:26:55 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:688baec183f7a61e77c0f9ffce22cebab6088de88232df9ef85399066731c6a1`  
		Last Modified: Tue, 09 Jun 2020 21:26:55 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
