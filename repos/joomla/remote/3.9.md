...
```console
$ docker pull joomla@sha256:b6c97070b646aa48d6aa7e8b9614ac645459156068a0b9568ddab3f8aa537ea5
```
...
```console
$ docker pull joomla@sha256:99a3c72d18197d85924ec793ac7f03e9cd47a61cc66cbd9b79b5ecdd561ec9f4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **162.1 MB (162103179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7669c247c9320f9eec4bdec0dd9ae88bef042962c2d46eda7c2b6537c1f06773`
...
# Tue, 01 Sep 2020 19:58:47 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 01 Sep 2020 19:58:47 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 19:58:48 GMT
RUN a2enmod rewrite
# Tue, 01 Sep 2020 20:00:17 GMT
...
-	Layers:
	...
	-	`sha256:310c88b7d8660b78d786da8ee2ace184e419da47987112a12b066ebecb13cdc7`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66cbf1878943d2615a8e5fcddefa353144ed3d49ac2dc18bb41377ea22be675d`  
		Last Modified: Tue, 01 Sep 2020 20:10:50 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20ae930da47cc357c763ffcb13d37c2267cc2def9bd7f572bcba6513614dcbf2`  
		Last Modified: Tue, 01 Sep 2020 20:10:50 GMT  
		Size: 3.5 MB (3468227 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d70b4bddf55dbba42aea96c1976eea788d8cdd8f730c4ef6e895a3142c365209`  
		Last Modified: Tue, 01 Sep 2020 20:10:55 GMT  
		Size: 9.7 MB (9686470 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f38284bf4f2d083e1870d385e9e83853ebd17b25c55df76070d12c520f3d7107`  
		Last Modified: Tue, 01 Sep 2020 20:10:50 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dc48d426db921706a900e234c38bc03874217ad72dd24f4019dccd54b9ae7a91`  
		Last Modified: Tue, 01 Sep 2020 20:10:49 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:071898938390a8caad1657ee2ef171721c7d8e69aa66560d5bf5eba43ca6db31
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137411630 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:46f2bf58b57e780e2cadf4e84e45bdaf392fa0896a7e8826e6bb3554927021b1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 20:28:40 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 01 Sep 2020 20:28:57 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 20:30:26 GMT
RUN a2enmod rewrite
# Tue, 01 Sep 2020 20:35:56 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 20:36:23 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 20:36:46 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 20:37:09 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 20:38:57 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 01 Sep 2020 20:39:25 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 01 Sep 2020 20:39:47 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 01 Sep 2020 20:40:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 20:40:25 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:06db406f2c29c03d617725d1b293a0f6c16b1aa6262635bf18d66846b299e9c2`  
		...
		Size: 899.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bda541b8dd983c40c80c74c5826481953f4eb0dad997c2d14c33093373fc6f26`  
		Last Modified: Tue, 01 Sep 2020 21:34:54 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc001a1047100c0604870794711db4f86000f60836dbc0ad63ad7eb8561d8f39`  
		Last Modified: Tue, 01 Sep 2020 21:34:54 GMT  
		Size: 3.2 MB (3196913 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:baea2aa1ad7a86cd3aab875741d09086c16341d9195bf05acd7b097bce58f038`  
		Last Modified: Tue, 01 Sep 2020 21:34:59 GMT  
		Size: 9.7 MB (9686479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56b6ec5938fa0db095bb278beec1a815ac3384557337c5b77c8defb7f7dacb20`  
		Last Modified: Tue, 01 Sep 2020 21:34:52 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fd323430742da8c9005a03595a7fc957c6d9baeffb38f352a542a1bcd63aaea1`  
		Last Modified: Tue, 01 Sep 2020 21:34:52 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
