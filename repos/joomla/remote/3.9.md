...
```console
$ docker pull joomla@sha256:c0460068c4e0143e6e11c29ecb9c2bff22664fc37016c1f5c48a41eacbb4f6cc
```
...
```console
$ docker pull joomla@sha256:7519e7f6baea1d42623c797d803cbe88cb3afc2cb972767b9cc3c8f69de6c118
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140118880 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fac88cfdc90bc3a8e787983796269d56aaf0e1efe257f95057c7563ea67e48f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 04 Aug 2020 20:15:38 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Tue, 04 Aug 2020 20:15:39 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 04 Aug 2020 20:15:44 GMT
RUN a2enmod rewrite
# Tue, 04 Aug 2020 20:18:32 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Aug 2020 20:18:33 GMT
VOLUME [/var/www/html]
# Tue, 04 Aug 2020 20:18:35 GMT
ENV JOOMLA_VERSION=3.9.18
# Tue, 04 Aug 2020 20:18:36 GMT
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Tue, 04 Aug 2020 20:18:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 04 Aug 2020 20:18:55 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 04 Aug 2020 20:18:55 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 04 Aug 2020 20:18:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 04 Aug 2020 20:18:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:af773e36f0e50a1003f32d79a545dadad3220e2c690be085bbaddf4a00541a3b`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca5fffedc85ee48b6198e0a64b5a9d2f77798cccbbf8eec5811e2d1b5dc5ca8e`  
		Last Modified: Tue, 04 Aug 2020 20:31:07 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:994e75997b05c38067d23370a5a80ac0f026edb0823b6ad7ad5e725ed6e80ea8`  
		Last Modified: Tue, 04 Aug 2020 20:31:08 GMT  
		Size: 3.3 MB (3266586 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:050b35e5fb680d2a9cc1964db14c5cf92a5fc1964fbf9a38913f2299a38fb1fc`  
		Last Modified: Tue, 04 Aug 2020 20:31:13 GMT  
		Size: 9.7 MB (9653278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a96ad83954b7d8d3f81623ded5e148843ab944eb3e42a3f6c4da3ad68e5bb83a`  
		Last Modified: Tue, 04 Aug 2020 20:31:07 GMT  
		Size: 1.2 KB (1174 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5d3d091721c6f4e94c7293a5d48d5246d868762c305636339b25d85908e479aa`  
		Last Modified: Tue, 04 Aug 2020 20:31:08 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:71def1f25a872055f6f6c9eca3a5eddd0d4dc67f34f547a7682d80e151ed8ed3
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.0 MB (154005372 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e246e7e7b83cb2dbc6a296b603d2ef6383aac0486cc3459360f03d1e9f7fd06e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Wed, 05 Aug 2020 10:54:04 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Wed, 05 Aug 2020 10:54:05 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 05 Aug 2020 10:54:07 GMT
RUN a2enmod rewrite
# Wed, 05 Aug 2020 10:56:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 05 Aug 2020 10:56:40 GMT
VOLUME [/var/www/html]
# Wed, 05 Aug 2020 10:56:41 GMT
ENV JOOMLA_VERSION=3.9.18
# Wed, 05 Aug 2020 10:56:42 GMT
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Wed, 05 Aug 2020 10:56:49 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 05 Aug 2020 10:56:50 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Wed, 05 Aug 2020 10:56:51 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 05 Aug 2020 10:56:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 05 Aug 2020 10:56:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:2448b324a66c95025a77882f5f02d9232ae4e23f0610c6dfc154fccca478446f`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7afc777cd68b4c44abd8a26dbb11f1beadf74cc8bf62a9eb11443208f784028f`  
		Last Modified: Wed, 05 Aug 2020 11:08:13 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d55e5b607766eb7cd744f71626d290603743444c2494294ad940a9fd0a81d358`  
		Last Modified: Wed, 05 Aug 2020 11:08:15 GMT  
		Size: 3.4 MB (3377237 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cc5cc5ce8ec6589baeec2372e78514389842785f1f2b360fd73a992671d59de`  
		Last Modified: Wed, 05 Aug 2020 11:08:18 GMT  
		Size: 9.7 MB (9653283 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:599848b12e9a085d9c6a966e22a88cb2f85e94e0c127b4d25c724a6bf1426a45`  
		Last Modified: Wed, 05 Aug 2020 11:08:14 GMT  
		Size: 1.2 KB (1171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a6eca37804b1a35b21e58d4b05e79fe72bdf41757e9382a96ae8595f7f42e53`  
		Last Modified: Wed, 05 Aug 2020 11:08:13 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:cea07b321fe3142afb2c4551537fed7573d632725ff718075ac9893efd42d78a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.6 MB (144591680 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88441fce1d1a4b65555f4be1e33da85ff57bb59105fdac2173c6b0279cd09bc4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 04 Aug 2020 13:23:32 GMT
CMD ["apache2-foreground"]
# Tue, 04 Aug 2020 22:02:08 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Tue, 04 Aug 2020 22:02:08 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 04 Aug 2020 22:02:10 GMT
RUN a2enmod rewrite
# Tue, 04 Aug 2020 22:06:49 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Aug 2020 22:06:49 GMT
VOLUME [/var/www/html]
# Tue, 04 Aug 2020 22:06:49 GMT
...
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Tue, 04 Aug 2020 22:07:04 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 04 Aug 2020 22:07:06 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 04 Aug 2020 22:07:06 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 04 Aug 2020 22:07:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 04 Aug 2020 22:07:07 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:067085f53782ce78cd3756229b777d7e57cdfa042245b3cd3196274e11248f10`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ef96df8d3e4c52fa33791d606db701c26c57f600bde4514a59840d9a5f2d92f8`  
		Last Modified: Tue, 04 Aug 2020 22:22:49 GMT  
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73303b0426ea6a797efbdf1a31b5b60b676e4ee03bf5af19cc52fdb8726cb23c`  
		Last Modified: Tue, 04 Aug 2020 22:22:53 GMT  
		Size: 3.4 MB (3382754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e97b842ce7ee0541e461e26c44e7c066def28f2087944164af34c66ff37ea67c`  
		Last Modified: Tue, 04 Aug 2020 22:22:59 GMT  
		Size: 9.7 MB (9653287 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a7059e977d4f26a22a75f2518115657f27303b3a8b3f67e9d9078698a9026a2`  
		Last Modified: Tue, 04 Aug 2020 22:22:49 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e969beb1327210095c611bd613f14e675ab11fdbc4bf91cfd886778fd61b823`  
		Last Modified: Tue, 04 Aug 2020 22:22:49 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c5eed0604c47990605a9aa96946601b69957dec3c78238867ce2b9e96f193459
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173428237 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a6aa2b0acadf80f64cc4e10cc4825730efb24fff75d8eb9c5e842321a82d4aa`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 04 Aug 2020 23:53:29 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Tue, 04 Aug 2020 23:53:35 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 04 Aug 2020 23:53:51 GMT
RUN a2enmod rewrite
# Tue, 04 Aug 2020 23:57:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 04 Aug 2020 23:57:10 GMT
VOLUME [/var/www/html]
# Tue, 04 Aug 2020 23:57:13 GMT
ENV JOOMLA_VERSION=3.9.18
# Tue, 04 Aug 2020 23:57:22 GMT
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Tue, 04 Aug 2020 23:57:42 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 04 Aug 2020 23:57:47 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 04 Aug 2020 23:57:48 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 04 Aug 2020 23:57:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 04 Aug 2020 23:57:54 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3af2a2aa24af51d274c4a67e3c8c9374944b6755d9630d99bdfb4b4d8aeeed3b`  
		...
		Size: 898.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4bc95ffa82203459fdddccf5d84caf18941e34a50208c47b2ff271a308196614`  
		Last Modified: Wed, 05 Aug 2020 00:13:20 GMT  
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f9a68e6e9839f3246aeed5f8ed986521e5573534bdb967817c0783acf3d8d91f`  
		Last Modified: Wed, 05 Aug 2020 00:13:21 GMT  
		Size: 3.6 MB (3620771 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:53eea83b9e831f62a27223fd5280fc15e327e6b55508b72bc5517ea7973dc101`  
		Last Modified: Wed, 05 Aug 2020 00:13:23 GMT  
		Size: 9.7 MB (9653276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:444fe610bd7b339a1ae8d1db80f44c04e0c007a6120f745f21bf19cf74a77302`  
		Last Modified: Wed, 05 Aug 2020 00:13:19 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bb876d287cd464b96ca9c4806c601d7dc82f8d4bb80ff40f7604f51497996bc`  
		Last Modified: Wed, 05 Aug 2020 00:13:20 GMT  
		Size: 612.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
