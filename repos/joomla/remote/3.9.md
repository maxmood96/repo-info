...
```console
$ docker pull joomla@sha256:5a623d56c3a401462d279768587647f3f96841bb469f11868411adafa209e0fb
```
...
```console
$ docker pull joomla@sha256:332b8c9f71ff202f3e54bde9f77c221e1670e587ddfc0eaec14b362864598335
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137405413 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:22ba6cef0dfc16788fb86520225b25e74195165eddb5ce03b7b308ef6a49d01e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 07 Aug 2020 05:29:07 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Fri, 07 Aug 2020 05:29:08 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 07 Aug 2020 05:29:12 GMT
RUN a2enmod rewrite
# Tue, 11 Aug 2020 01:22:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Aug 2020 01:22:37 GMT
VOLUME [/var/www/html]
# Tue, 11 Aug 2020 01:22:46 GMT
ENV JOOMLA_VERSION=3.9.20
# Tue, 11 Aug 2020 01:22:53 GMT
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 11 Aug 2020 01:24:03 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 11 Aug 2020 01:24:15 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 11 Aug 2020 01:24:21 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Aug 2020 01:24:29 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b7317c92cb75371e0e091f45c7ee5e566a3528c5b6212ede3f0e881c84a6e121`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:70ef0877110522e5fe6342a1f527524ffae8ce4e7433656ebf67095d29891f33`  
		Last Modified: Fri, 07 Aug 2020 05:51:05 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:948dfb66f3a76fd9365e8a3647431ac7463344dc6317b574ce405aaf0b108d7e`  
		Last Modified: Tue, 11 Aug 2020 01:51:26 GMT  
		Size: 3.2 MB (3196757 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62810ff41b93cc5e8a194beaa255259a105a1bdba7bd588da40de56439807ed4`  
		Last Modified: Tue, 11 Aug 2020 01:51:33 GMT  
		Size: 9.7 MB (9680452 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:87ad58f36363abf2c8228ed3f98fd7dd64eff7339ebf2cfa55ec59c82bfc7e6c`  
		Last Modified: Tue, 11 Aug 2020 01:51:26 GMT  
		Size: 1.2 KB (1169 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b51d6a7c165efa69022dfa8e15c3079807668bf30a184c9638ba5d40105383a0`  
		Last Modified: Tue, 11 Aug 2020 01:51:25 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:2ff4555bca79926087859d07c8c54d9c5342dd7280ee0b0a73c476af6fa074ba
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.1 MB (154076152 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d849ee42f0bbe7e064ec2f9009267e047d0f330bde65b294adfc0fd2d899f52`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 15:39:21 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 01 Sep 2020 15:39:21 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 15:39:24 GMT
RUN a2enmod rewrite
# Tue, 01 Sep 2020 15:42:09 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 15:42:10 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 15:42:11 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 15:42:12 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 15:42:20 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 01 Sep 2020 15:42:22 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 01 Sep 2020 15:42:23 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 01 Sep 2020 15:42:23 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 15:42:24 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:acb98cd2544811eed670ba8fd2ac2d0c3691387dddbdbe3f16a1292ee3c2d75e`  
		...
		Size: 893.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8253f853e287d45a0fabf4def59c64adfb67494e1dcba133dfdf4fcf1451c313`  
		Last Modified: Tue, 01 Sep 2020 16:00:22 GMT  
		Size: 320.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e2d5ea2ef47a59f0afc27d81dd47d722cdb66e0774b3b57ac294cb38d647d85`  
		Last Modified: Tue, 01 Sep 2020 16:00:23 GMT  
		Size: 3.4 MB (3407161 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:873db9bba9d549aba8b53e015b86a1d7d5cc567a9993e85cf8632cf2a1cbc292`  
		Last Modified: Tue, 01 Sep 2020 16:00:29 GMT  
		Size: 9.7 MB (9686479 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09f40effead2b0b630ee85ff93d68d39e381441dc16440cdb51806ba90ed2a7f`  
		Last Modified: Tue, 01 Sep 2020 16:00:22 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7065bae68315c3ee9f6c46eff6f84e261bf1496b40e93b87134e9aa2a2d40424`  
		Last Modified: Tue, 01 Sep 2020 16:00:22 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:2072c44fd94ac047854c3890cb162a99528fa85e4b4af43fc7fddf28c50b108d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **144.7 MB (144657494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e6953dc75c0c9ba29ec4cc70f83d064b56705212b9b7b271f3cb1f995a0a4b2a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Tue, 01 Sep 2020 07:21:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 07:21:40 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 07:21:41 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 07:21:41 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 07:21:56 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:967517173e584c3bc35aea556ee74a21004f8d109446fe385374dd6b6ee195ee`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:790c74f2008467c2221440d912dfad5e91208cd7f34339b0f23a3ab31badde04`  
		Last Modified: Tue, 01 Sep 2020 07:38:27 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6f85bae3442b8087a0086f0701206f63a34803c564b1c8f945c0ec6b50ad52a`  
		Last Modified: Tue, 01 Sep 2020 07:38:31 GMT  
		Size: 3.4 MB (3408310 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69f35d2852649b38ebaa4a12e47f7b226aceffd936f82cc570a8cdc1999bbca4`  
		Last Modified: Tue, 01 Sep 2020 07:38:38 GMT  
		Size: 9.7 MB (9686472 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ecfa221c1922008bbf2e39d4f21419a58702804eb665ca3150abab62da87f7c`  
		Last Modified: Tue, 01 Sep 2020 07:38:27 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:39924957caf9e751860db90231374b67e8ab87761dbd76b4b20d5a4a3ba787c7`  
		Last Modified: Tue, 01 Sep 2020 07:38:27 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ba280499514c23655f7a9f32ac09c7208dfa9a7ac61d07c598ef8eab6e2265da
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.8 MB (147812543 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57be6a6493009cc17ba2d7af57a85b6d42da4d096ccf52cc17d6edd54f44e8d3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Sep 2020 01:00:14 GMT
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 07:50:46 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 01 Sep 2020 07:50:47 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 07:50:47 GMT
RUN a2enmod rewrite
...
# Tue, 01 Sep 2020 07:52:02 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 07:52:03 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 07:52:03 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 07:52:07 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 01 Sep 2020 07:52:09 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 01 Sep 2020 07:52:09 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 01 Sep 2020 07:52:09 GMT
...
-	Layers:
	...
	-	`sha256:7b36cf1b251ea50bf9ef227bac1048a18ca281efb7fa2247f913c147869e77eb`  
		...
		Size: 896.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c56cf32b5e460396c2c92445bb49e3baf881759ee250dbf34f45eceb97e2c6b8`  
		Last Modified: Tue, 01 Sep 2020 08:01:05 GMT  
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9663b87466ea3389a922b4ea8f5812698f8d97da7d75f193ee87866ffa75dbe`  
		Last Modified: Tue, 01 Sep 2020 08:01:06 GMT  
		Size: 3.4 MB (3429561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf32f426f6c63ce60f3e12eaa2169b208b0f035b447c59de3d0778836cbe79e5`  
		Last Modified: Tue, 01 Sep 2020 08:01:07 GMT  
		Size: 9.7 MB (9686462 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33da29b1e643141fdf768105ec3181dc51ee8847bf72386e2b873942b964f357`  
		Last Modified: Tue, 01 Sep 2020 08:01:05 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69f6430ef432d410c036d286bdf5fe99885c98ab195c67b0140241844c5f6cd8`  
		Last Modified: Tue, 01 Sep 2020 08:01:05 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
