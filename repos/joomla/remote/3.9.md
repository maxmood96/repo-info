...
```console
$ docker pull joomla@sha256:bdf6b579b79d58fbb38508662e7d61cf3a899ea319c7deaf62d63a64f94871a0
```
...
```console
$ docker pull joomla@sha256:a3aafbbdd5bc324aeed5110f9f90fbdf514eaf704e61a72a3e12e0a2b328af5d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.2 MB (140177469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:112500e18e72c5c5f8e63f003bf5d1bf6a5fdce5b41daf4611f39f1c9ff4bc74`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 11 Aug 2020 01:04:16 GMT
VOLUME [/var/www/html]
# Tue, 11 Aug 2020 01:04:22 GMT
ENV JOOMLA_VERSION=3.9.20
# Tue, 11 Aug 2020 01:04:34 GMT
...
# Tue, 11 Aug 2020 01:05:20 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 11 Aug 2020 01:05:36 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 11 Aug 2020 01:05:48 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 11 Aug 2020 01:05:56 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Aug 2020 01:06:04 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0cb52d6b6edf1575b57d72e4f4b77114a53034509882c0d35c5da3d69334c02d`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc2be8f4c739697f92ee25fd56f8cd0e775646c9af4e6af86399116c8a13156b`  
		Last Modified: Tue, 11 Aug 2020 01:25:47 GMT  
		Size: 3.3 MB (3292627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e605c0a4c21712684d4ef6711ade7e0a070060296c27cab2fa299823789dc0a`  
		Last Modified: Tue, 11 Aug 2020 01:25:45 GMT  
		Size: 9.7 MB (9680454 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:829a27852770af32b2b4f70cc72c47747ddb6f576c70d140d56a3680be5662c6`  
		Last Modified: Tue, 11 Aug 2020 01:25:41 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57710aa696a1e41df88bba63f07c354b4fd02d9bd437493e5656ebe126203315`  
		Last Modified: Tue, 11 Aug 2020 01:25:41 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:4f5db0d39a808e06aa67c63f598ade274cbb3f1c756f2d324283422aacfc5028
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.4 MB (137353143 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce64f9b7642ee0e1d4f834282f5370937ccd04bc6b6f1635612cb52089079444`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Fri, 07 Aug 2020 05:31:42 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 07 Aug 2020 05:31:44 GMT
VOLUME [/var/www/html]
# Fri, 07 Aug 2020 05:31:46 GMT
ENV JOOMLA_VERSION=3.9.18
# Fri, 07 Aug 2020 05:31:47 GMT
ENV JOOMLA_SHA512=1bf4590a761cc24f59fc0d5b07ffbb8f9e50073b3536edc261b8785ff168aca2066d133a81c4ac33bcfe7b843559320ef4d1f97c5eb16096ca4b550a18b7f44d
# Fri, 07 Aug 2020 05:32:01 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 07 Aug 2020 05:32:03 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Fri, 07 Aug 2020 05:32:05 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 07 Aug 2020 05:32:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 07 Aug 2020 05:32:07 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:70ef0877110522e5fe6342a1f527524ffae8ce4e7433656ebf67095d29891f33`  
		...
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e29848d03e5c7399f7bc1c69813ecb566b0a04fd711548f699cacddbcaaae70`  
		Last Modified: Fri, 07 Aug 2020 05:51:07 GMT  
		Size: 3.2 MB (3171666 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea14f1f209237c1f00720da7025bae97570379f81c2da26877dd402e1f2c2225`  
		Last Modified: Fri, 07 Aug 2020 05:51:11 GMT  
		Size: 9.7 MB (9653269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5e1ac84190df3c27bc21a4d6eb389e9c7b63cb72df523cb5b604700383e0b76`  
		Last Modified: Fri, 07 Aug 2020 05:51:06 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:30c86b3867c4d123886a396cf826cadaceb6704ef98ee69bd2d435a66b8aab94`  
		Last Modified: Fri, 07 Aug 2020 05:51:05 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
