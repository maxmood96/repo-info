## `joomla:3.9.28-php7.4`

```console
$ docker pull joomla@sha256:8f654a476d9df2874343773c5017fce661beac65cd5071b1984fa5322250c74b
```
...
### `joomla:3.9.28-php7.4` - linux; amd64
...
### `joomla:3.9.28-php7.4` - linux; arm variant v5
...
### `joomla:3.9.28-php7.4` - linux; arm variant v7

```console
$ docker pull joomla@sha256:e936755a900fd771d398a14d07d89767f5b9ac5d918aee41aeb578aaedfd4379
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.2 MB (135199658 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eac6b50c9978a1e9879af68463eb16d5952db0f6ef012985e87b910f58152c4d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 22 Jul 2021 15:30:26 GMT
CMD ["apache2-foreground"]
# Fri, 23 Jul 2021 15:42:52 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 23 Jul 2021 15:42:52 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 23 Jul 2021 15:42:54 GMT
RUN a2enmod rewrite
# Fri, 23 Jul 2021 15:47:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 15:47:21 GMT
VOLUME [/var/www/html]
# Fri, 23 Jul 2021 15:47:21 GMT
ENV JOOMLA_VERSION=3.9.28
# Fri, 23 Jul 2021 15:47:22 GMT
ENV JOOMLA_SHA512=0751036475d9b527bd6da5f5a0c67e0c728449bf02ba9d508f206b4b2f35697093c938a4350b6e9412b16f5eabb8700575268b564fd8db451308ae4cfe4d882e
# Fri, 23 Jul 2021 15:47:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 23 Jul 2021 15:47:34 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 23 Jul 2021 15:47:35 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 23 Jul 2021 15:47:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 23 Jul 2021 15:47:36 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1146886769bf7bf2d6bbaf8d15cab3eeef4db17743e2a864be9fa4574f991c57`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8de006d5ed49de71e028c515fcebe3584a267358c49f4877b6a5b25d003afa13`  
		Last Modified: Fri, 23 Jul 2021 15:59:51 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a14922ae3b04bc7b729a9d6b01365d145c4084d4c7f2e04d6ce596900e67afb7`  
		Last Modified: Fri, 23 Jul 2021 15:59:53 GMT  
		Size: 2.9 MB (2897681 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f61c7ef1a473227545a60c92d7d268e94b1943630e92f022a90d45dd05a52357`  
		Last Modified: Fri, 23 Jul 2021 16:00:04 GMT  
		Size: 9.6 MB (9645165 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19dff380b04d1ebc06d9d51a8c3e7ad0c0fd6b2a231d0e8c032f69e8bda9063a`  
		Last Modified: Fri, 23 Jul 2021 15:59:51 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9a7989feef39fcc867d0cf0b73bfd877e04522a8ff2ae6d36c069e2b51946511`  
		Last Modified: Fri, 23 Jul 2021 15:59:51 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:3.9.28-php7.4` - linux; arm64 variant v8
...
### `joomla:3.9.28-php7.4` - linux; 386
...
### `joomla:3.9.28-php7.4` - linux; mips64le
...
### `joomla:3.9.28-php7.4` - linux; ppc64le

```console
$ docker pull joomla@sha256:bfbe8913af8211c1a73232620b2795fe955c140f71fccb7f6c09825f67e0d75d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.3 MB (171256186 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:20f053aab9c4dc7acc63ffc520b317eddd20f5951efb7225ca306c1fef8c2d1f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 23 Jul 2021 15:59:11 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 23 Jul 2021 15:59:15 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 23 Jul 2021 15:59:27 GMT
RUN a2enmod rewrite
# Fri, 23 Jul 2021 16:04:08 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Jul 2021 16:04:14 GMT
VOLUME [/var/www/html]
# Fri, 23 Jul 2021 16:04:25 GMT
ENV JOOMLA_VERSION=3.9.28
# Fri, 23 Jul 2021 16:04:30 GMT
ENV JOOMLA_SHA512=0751036475d9b527bd6da5f5a0c67e0c728449bf02ba9d508f206b4b2f35697093c938a4350b6e9412b16f5eabb8700575268b564fd8db451308ae4cfe4d882e
# Fri, 23 Jul 2021 16:04:46 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 23 Jul 2021 16:04:51 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 23 Jul 2021 16:04:54 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 23 Jul 2021 16:04:58 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 23 Jul 2021 16:05:02 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0d1b54cbfb1880e2f5804a4834750f89426adbbedafc27c6f833882884431c27`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f53b95ae215913138415f4795ae90989ca40a17c9ba289cd9587324efa9d02c`  
		Last Modified: Fri, 23 Jul 2021 16:19:03 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c6698fa0cc33b78b34fddff3e7119eb8fe5020f2378ce5533a8712e9bd2c3bf8`  
		Last Modified: Fri, 23 Jul 2021 16:19:04 GMT  
		Size: 3.4 MB (3373610 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:61e00911ad042ad104301416c4d48df60314f868a3a98958bfa9d9dadbd4ca9d`  
		Last Modified: Fri, 23 Jul 2021 16:19:06 GMT  
		Size: 9.6 MB (9645155 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:788abee1de18dec88b6998f77d298a0ec662f11eb9fbe7db1b45332397a3c108`  
		Last Modified: Fri, 23 Jul 2021 16:19:03 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97fd672d54dea0f4d5443eac1fcf43826d646b34429d5238bfd6bfbfd569adc5`  
		Last Modified: Fri, 23 Jul 2021 16:19:03 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:3.9.28-php7.4` - linux; s390x
