...
```console
$ docker pull joomla@sha256:60ea37a898fab3683f2db7ac6c775d95be9351ea26d2435e0c5b0ccf5a4cb51b
```
...
```console
$ docker pull joomla@sha256:d1d705c52a486d66d49315a6cccc9ed031e2c18b673c599eda394f26e91b1fae
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.8 MB (89767629 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d0a687ad49192f4f5a73ba27af0aa92317095b65bd84c1d9efb2c53f19097e7`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 27 Jan 2024 14:54:58 GMT
VOLUME [/var/www/html]
# Sat, 27 Jan 2024 15:24:51 GMT
ENV JOOMLA_VERSION=5.0.2
# Sat, 27 Jan 2024 15:24:51 GMT
ENV JOOMLA_SHA512=e7bc9ecab410217fdf91a87f9461ff18dab311af56c61156fb7cf076b2fdf270b003ffddf131386ef35c94cb9f4ada39f8a69712c07664147108268ab5cc85a3
# Sat, 27 Jan 2024 15:24:57 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.2/Joomla_5.0.2-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 27 Jan 2024 15:24:59 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Sat, 27 Jan 2024 15:24:59 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 27 Jan 2024 15:25:00 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 27 Jan 2024 15:25:00 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:05c15df61773c53d8f1059298171f53bfa1b6d623c5dc0b2a706f2f395e6e17e`  
		...
		Size: 390.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8cc6ea809f4bcacd3d9b21afbadbf505019625fdf62a1ebefde41bb90536a7c9`  
		Last Modified: Sat, 27 Jan 2024 15:46:12 GMT  
		Size: 22.4 MB (22446561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fea9cfe26967d8bbddb20bb23592a95a317b2901881f24829167b4f30311aad9`  
		Last Modified: Sat, 27 Jan 2024 15:46:08 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73ba3c74617ce4e33b855f9aa638d37ae18358ea8a95e127502880e433b7061a`  
		Last Modified: Sat, 27 Jan 2024 15:46:08 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
