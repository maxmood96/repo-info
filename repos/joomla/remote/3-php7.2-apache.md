...
```console
$ docker pull joomla@sha256:c4bce3c12618aae8e83f87d22e8b12d3a325f3c31467972cf6f3b11cef3e577f
```
...
```console
$ docker pull joomla@sha256:f8fb0f5828402c8560564dabb7e8c5832bbd3fd41764571e22d75a7adcda2498
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.3 MB (140289601 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae385255c352cf7ea23365e307916cf0d385dd631fee31aa91069759d8850c5b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 05 Nov 2020 23:50:09 GMT
RUN a2enmod rewrite
# Thu, 05 Nov 2020 23:53:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 23:53:26 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 23:53:27 GMT
ENV JOOMLA_VERSION=3.9.22
# Thu, 05 Nov 2020 23:53:27 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Thu, 05 Nov 2020 23:53:44 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 05 Nov 2020 23:53:48 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 05 Nov 2020 23:53:50 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 05 Nov 2020 23:53:51 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 23:53:51 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:809d155ffdbfb3b79ad9e80843f3e0f5e2d5f8269ec4199bbcb1e40a39ba63f8`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcdca2b2241e5193c15b8372836d6f33b9ee9ef52e658336d558ba55436950ee`  
		Last Modified: Fri, 06 Nov 2020 00:13:09 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:de95ba260b6137cceaeffcd88ac4d5642231e2b949371793b128772c19e387a1`  
		Last Modified: Fri, 06 Nov 2020 00:13:11 GMT  
		Size: 3.2 MB (3222998 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6dbdc5d06234a99b16839e3d093ec530a81958e87bbf46032f8c4fa31698b11`  
		Last Modified: Fri, 06 Nov 2020 00:13:17 GMT  
		Size: 9.7 MB (9690257 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d4b1b69c27808c13e4c2ae3e3c3808eedc6db2258c64673111c8886e33e5318`  
		Last Modified: Fri, 06 Nov 2020 00:13:09 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cb0c6b52558cbe814ea6e0c00c5558d0e1597889214f40c817b21afaca83411c`  
		Last Modified: Fri, 06 Nov 2020 00:13:10 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:96aae21f263ba3d89cb82223d19b150248930fcc14337a4934662371fca398d5
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.5 MB (137483566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:994a9767caff2e5f9afb6ec334e8d0f1749c2769cd1f512baa116606a3fcc5c1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 22:49:52 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 05 Nov 2020 22:49:54 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 05 Nov 2020 22:49:58 GMT
RUN a2enmod rewrite
# Thu, 05 Nov 2020 22:52:40 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 05 Nov 2020 22:52:46 GMT
VOLUME [/var/www/html]
# Thu, 05 Nov 2020 22:52:48 GMT
ENV JOOMLA_VERSION=3.9.22
# Thu, 05 Nov 2020 22:52:50 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Thu, 05 Nov 2020 22:53:04 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 05 Nov 2020 22:53:05 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 05 Nov 2020 22:53:06 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 05 Nov 2020 22:53:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 22:53:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:6f96e172850b7fe9aa73848c61d0460f1346840357e48c30f803d9cc0940d67f`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31781294876cb0d6c5bb7a2ffa2c06a1547b8b2f0e82cc2eec5b436d76e0d5e6`  
		Last Modified: Thu, 05 Nov 2020 23:25:13 GMT  
		Size: 317.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:309f1fa38002c7c76fcdf2df8e0ef2b00eb9af1a8afd0c89d829b627e701cea0`  
		Last Modified: Thu, 05 Nov 2020 23:25:15 GMT  
		Size: 3.1 MB (3135143 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1128e3caca78498a35a61a7ed9b6810907e6287d33592486f7406f50b94ae0a9`  
		Last Modified: Thu, 05 Nov 2020 23:25:19 GMT  
		Size: 9.7 MB (9690260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d76eefbcf5ea18ddb968b23371e1d18a47aec534408d5fcda0c224450d23380c`  
		Last Modified: Thu, 05 Nov 2020 23:25:14 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b31b44b36eba16b6829cd535e01821629a699ee8e2eec3ccb721beeb66ed4676`  
		Last Modified: Thu, 05 Nov 2020 23:25:13 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:a6dbc431d63c570a392c99a5817907bdc4d4723d728b56b31799882bb08531cc
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **154.2 MB (154162996 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0193ed2f48eaf1e87634b69ee741b1765e02ee142a0f1cfcb132ca091495672f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 06 Nov 2020 01:32:36 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 06 Nov 2020 01:32:37 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 06 Nov 2020 01:32:39 GMT
RUN a2enmod rewrite
# Fri, 06 Nov 2020 01:35:18 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 06 Nov 2020 01:35:20 GMT
VOLUME [/var/www/html]
# Fri, 06 Nov 2020 01:35:21 GMT
ENV JOOMLA_VERSION=3.9.22
# Fri, 06 Nov 2020 01:35:24 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Fri, 06 Nov 2020 01:35:36 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 06 Nov 2020 01:35:38 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 06 Nov 2020 01:35:39 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 06 Nov 2020 01:35:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 06 Nov 2020 01:35:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ea52e1ef3bfd8be2a8386b98b1a865dd7cc026c1c06de132c5d9d51530e14f24`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59eb6d6d91390c48deaa5ff3185ca32b6ff4b28e646f373a8fd4cdc7c976b543`  
		Last Modified: Fri, 06 Nov 2020 02:03:21 GMT  
		Size: 318.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d82d03b9067521a9a4a763842ca6c81c7aaaaf561e95d9fb32f2e8836d2b4e3`  
		Last Modified: Fri, 06 Nov 2020 02:03:23 GMT  
		Size: 3.4 MB (3351129 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:34ca97aa07c8f2fdd19e5b07e19899b14162958becde69c5a716d107f480b8cf`  
		Last Modified: Fri, 06 Nov 2020 02:03:27 GMT  
		Size: 9.7 MB (9690274 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64a7b79beea322514da30bdebd7085538939606710d53ee547a42275058dce7a`  
		Last Modified: Fri, 06 Nov 2020 02:03:21 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4e9541c5f9a48f891c7431234862639ae9757efe0b7d53b9abdf14ede3cfdbc`  
		Last Modified: Fri, 06 Nov 2020 02:03:21 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ea8ca70104984ab3d8d8c7e63d0be8f8d8350e425baa7f309ab0799db5c41c52
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **173.4 MB (173374462 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d67e2c3560aff2e7dadee6baff6b3f14c84c22523dca763b08d578c93ee82440`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 27 Oct 2020 02:51:58 GMT
RUN a2enmod rewrite
# Tue, 27 Oct 2020 02:56:17 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 27 Oct 2020 02:56:21 GMT
VOLUME [/var/www/html]
# Tue, 27 Oct 2020 02:56:25 GMT
ENV JOOMLA_VERSION=3.9.22
# Tue, 27 Oct 2020 02:56:28 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Tue, 27 Oct 2020 02:56:45 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 27 Oct 2020 02:56:51 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 27 Oct 2020 02:56:53 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 27 Oct 2020 02:56:55 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 27 Oct 2020 02:56:59 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a449c636bf534d365c877f165359f0ab41247f06db6c6045ae6f0f6a47f9a768`  
		...
		Size: 899.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8b8205001222935533a9ac3edbc51f1509f0b115cba503abf9ca6da19b51cd3`  
		Last Modified: Tue, 27 Oct 2020 03:45:45 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bad8af18ea31f65c39bc3b52321e7d9a91036eba1e1c4ea19a5883be6298ff81`  
		Last Modified: Tue, 27 Oct 2020 03:45:46 GMT  
		Size: 3.6 MB (3578626 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f606072c65718398a41f5d3aaa362753f256c08ff1770851cd6d196433533d46`  
		Last Modified: Tue, 27 Oct 2020 03:45:48 GMT  
		Size: 9.7 MB (9690265 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a28c519998b218597c2c4d02e62b3c995ff870cb5943b9a5acc5154b1527c475`  
		Last Modified: Tue, 27 Oct 2020 03:45:45 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85b1ed5a883928e7a62cf187e0b2bd83556e8905ff13b28f0a99564bc2d96ebc`  
		Last Modified: Tue, 27 Oct 2020 03:45:45 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:180d258799e7932e66f0ac4efb7dbe88a386fd52b15850c7a1939b23d5e3e684
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.9 MB (147913148 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6670209feb18c810502df92deb08047b1639b7a65425c2235e2de15641b4ab03`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 05 Nov 2020 21:07:40 GMT
CMD ["apache2-foreground"]
# Thu, 05 Nov 2020 22:46:12 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 05 Nov 2020 22:46:13 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 05 Nov 2020 22:46:14 GMT
RUN a2enmod rewrite
...
# Thu, 05 Nov 2020 22:48:07 GMT
ENV JOOMLA_SHA512=826f01683bd3d86f45a0e59dd6265cccdbeea9709604d19091572f6c5e3f8cd91a645789f6b8e8040c641badf76381acc4719cb29754c5d2bb2d5b6f4d17a60d
# Thu, 05 Nov 2020 22:48:22 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 05 Nov 2020 22:48:25 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 05 Nov 2020 22:48:26 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 05 Nov 2020 22:48:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 05 Nov 2020 22:48:26 GMT
...
-	Layers:
	...
	-	`sha256:f1816d978345c79983089f7d182973ba137ee58780f01e2e19ee7b93d8a5815e`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f746c6087b4957aab55b4529b980835a8dbc58635584727b6934b3725ca8c58d`  
		Last Modified: Thu, 05 Nov 2020 23:08:38 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:67489d0cdb8ed20fcad2d92fa9b606d49b12a63993b1156fdce9a7ab98372d3c`  
		Last Modified: Thu, 05 Nov 2020 23:08:38 GMT  
		Size: 3.4 MB (3360286 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b64422a794d6be7ad8f9ac7aa2002d236b6fee2cb24eab853abe96a426ab6401`  
		Last Modified: Thu, 05 Nov 2020 23:08:39 GMT  
		Size: 9.7 MB (9690269 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:745cde4c26f90ecb67a7ee8572e63d3c66227f9228b7761aab5a4e7612cf4605`  
		Last Modified: Thu, 05 Nov 2020 23:08:38 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1045ef672130d053a4d0000a5213975bbe16c4379566a2716e2ffbb7cda3e90`  
		Last Modified: Thu, 05 Nov 2020 23:08:38 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
