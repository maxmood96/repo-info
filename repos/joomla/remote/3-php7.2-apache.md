...
```console
$ docker pull joomla@sha256:98bfd6a764a58f44698efe0603fcc795507df29483cf821d05c4fb3fa8a5c84d
```
...
```console
$ docker pull joomla@sha256:c1fe6d2d4b1687d781f3ee36077f085267842d52a33b1c34e7a091a39327022d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.1 MB (140110118 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4268d28604da2f41ac3257decc50a68a3073b708f7db737a8a3c003b9723b5db`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 05:31:36 GMT
RUN a2enmod rewrite
# Tue, 01 Sep 2020 05:35:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 05:36:02 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 05:36:15 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 05:36:26 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 05:37:31 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 01 Sep 2020 05:37:45 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 01 Sep 2020 05:38:02 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 01 Sep 2020 05:38:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 01 Sep 2020 05:38:22 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3262e238093881d56d9d2525657b8c8dc6e33e13538724ef8f0c5d720fa2b180`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c81edc3d212e0938463a7c99314111350c3c7e350372ff5b749984c145f21039`  
		Last Modified: Tue, 01 Sep 2020 06:11:57 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:816e0ce36156b7655f5bf08e59ca960c512c07a34c9739d254f3ce316083f1fc`  
		Last Modified: Tue, 01 Sep 2020 06:11:54 GMT  
		Size: 3.2 MB (3213207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bdf84a465275709bbd2f0aaeaff6b0d83fbf7b6327b4b0ff17aba497b0cb355`  
		Last Modified: Tue, 01 Sep 2020 06:12:01 GMT  
		Size: 9.7 MB (9686475 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95ceae187bc837ff00e28966a203d5494acf7d59ca0405bce71dfa3bf7008de9`  
		Last Modified: Tue, 01 Sep 2020 06:11:56 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9643dfe9acd17881da1027e0782ed8ef29054160dee777a3ea35867a2315db6`  
		Last Modified: Tue, 01 Sep 2020 06:11:54 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:5e83b5020d0218692a0a2f93069f21e7a1f8f18c213cd7fd49cfad8254f6f577
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **137.3 MB (137318799 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ecdd81e1f5cca6e7cb0fce5b33ef0fe961fc0494b48456297d5878a44eeaf15`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Tue, 11 Aug 2020 01:06:13 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 11 Aug 2020 01:06:20 GMT
VOLUME [/var/www/html]
# Tue, 11 Aug 2020 01:06:29 GMT
ENV JOOMLA_VERSION=3.9.20
# Tue, 11 Aug 2020 01:06:42 GMT
...
# Tue, 11 Aug 2020 01:07:28 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 11 Aug 2020 01:07:41 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Tue, 11 Aug 2020 01:07:52 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 11 Aug 2020 01:08:02 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 11 Aug 2020 01:08:05 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b059cf3de24ed04dbddb42edbec72527f18c7921e6e9816c7430a8a2a708426a`  
		...
		Size: 315.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3337a9195ca014e95779eecddaedd6e1699188c9e70241de31b1b81ca67319b`  
		Last Modified: Tue, 11 Aug 2020 01:50:22 GMT  
		Size: 3.1 MB (3129447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b4556ed5c1e85ca7b8abb06c0d54a721140db4484fbee970dc00e0c8b6632300`  
		Last Modified: Tue, 11 Aug 2020 01:50:26 GMT  
		Size: 9.7 MB (9680446 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e339a8c90d59a329226b0f091696314f7f197b73e39534e1a4fbd077ab2db949`  
		Last Modified: Tue, 11 Aug 2020 01:50:22 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b36eee676610f15844b7978d120b685090e89ee70ed72cd3c9f6a70d510b8538`  
		Last Modified: Tue, 11 Aug 2020 01:50:21 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ecda6babe1801b221b2af9d115f9dd00a9767afea3dc1e521eb5ea312e0d1279
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **147.7 MB (147722699 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bfa57a486b94972595c18fccd4a005eda5e14e17f6ecec5d63ba3c63007cc38`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 01 Sep 2020 01:45:34 GMT
CMD ["apache2-foreground"]
# Tue, 01 Sep 2020 07:45:53 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 01 Sep 2020 07:45:53 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 01 Sep 2020 07:45:54 GMT
RUN a2enmod rewrite
# Tue, 01 Sep 2020 07:47:14 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Tue, 01 Sep 2020 07:47:14 GMT
VOLUME [/var/www/html]
# Tue, 01 Sep 2020 07:47:15 GMT
ENV JOOMLA_VERSION=3.9.21
# Tue, 01 Sep 2020 07:47:15 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Tue, 01 Sep 2020 07:47:19 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 01 Sep 2020 07:47:21 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Tue, 01 Sep 2020 07:47:21 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Tue, 01 Sep 2020 07:47:21 GMT
...
-	Layers:
	...
	-	`sha256:edddcfba27d23c7d1ab108bd838729503b217ed07a0fb5ebbd6085be24f05ebf`  
		...
		Size: 897.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:981553e52bdb9fc50b7d6b0a00b474d73f9f27df393851dd56921048a8de4208`  
		Last Modified: Tue, 01 Sep 2020 08:00:27 GMT  
		Size: 313.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:447a5c41b5cc51c584e2b8b91dbbefa5944dbb579985a1332bb801c3f04a1db6`  
		Last Modified: Tue, 01 Sep 2020 08:00:27 GMT  
		Size: 3.4 MB (3353347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a3e91c7d4b2f00cbfa1584c56a5ae590767593a9499136ea77bbf2be731f607c`  
		Last Modified: Tue, 01 Sep 2020 08:00:29 GMT  
		Size: 9.7 MB (9686467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:491630b9bbff54df1a80de437c68c48510858867f0ef31e039b6adafb7315b63`  
		Last Modified: Tue, 01 Sep 2020 08:00:27 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5830888aa7efbe7077c03b71ba0ca08da558734a2787e97e59913c99137ee3d`  
		Last Modified: Tue, 01 Sep 2020 08:00:27 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
