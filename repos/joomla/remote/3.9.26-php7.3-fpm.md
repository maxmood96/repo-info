...
```console
$ docker pull joomla@sha256:6b6aead3eabb76a1e8f067dcf2047e7beb1078b5edb5e7ce49f3f0304a0e5144
```
...
### `joomla:3.9.26-php7.3-fpm` - linux; amd64
...
### `joomla:3.9.26-php7.3-fpm` - linux; arm variant v5
...
### `joomla:3.9.26-php7.3-fpm` - linux; arm variant v7
...
### `joomla:3.9.26-php7.3-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.26-php7.3-fpm` - linux; mips64le
...
### `joomla:3.9.26-php7.3-fpm` - linux; ppc64le
...
### `joomla:3.9.26-php7.3-fpm` - linux; s390x
