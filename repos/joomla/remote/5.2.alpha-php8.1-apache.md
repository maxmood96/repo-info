...
```console
$ docker pull joomla@sha256:cb0836998a34dd586e01b0c2aae352ed173a802773f6b4e1c5d85ec55afd05f8
```
...
```console
$ docker pull joomla@sha256:d096e9b44ea458fe71869e117588f1c45f8fc162803724717f9b38db5c87a5fd
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **230.7 MB (230678304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2107a210247938a555e514ba61e424051cf049f023a631fab3544b17c8a98fe0`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Tue, 13 Aug 2024 14:00:09 GMT
ENV JOOMLA_VERSION=5.2.0-alpha3
# Tue, 13 Aug 2024 14:00:14 GMT
ENV JOOMLA_SHA512=4d73b21c1ce7ed5261319c4d77531b67d223571b9c8cfa7cd208ac60cb521011abea96ed0ca90ffd8b70ef45497bffface336a7e11e0f932cb60072ab23e280b
# Tue, 13 Aug 2024 14:00:45 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-alpha3/Joomla_5.2.0-alpha3-Alpha-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 13 Aug 2024 14:00:53 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Tue, 13 Aug 2024 14:01:00 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Tue, 13 Aug 2024 14:01:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 13 Aug 2024 14:01:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:a169ce62aa5467700cc23efbc23d5912f5bb1dc4ab7dccffd1237bd833ad8267`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc8b5f0aec77ae5d242b506269518fea7b6df339240be113a97c976549ea9bfa`  
		Last Modified: Tue, 13 Aug 2024 16:21:29 GMT  
		Size: 23.2 MB (23181810 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d28b824349142e19405392107b52723b8a234741c264591dec2652903b92bb26`  
		Last Modified: Tue, 13 Aug 2024 16:20:47 GMT  
		Size: 3.7 KB (3654 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9fd090465375d79d9d80d10d39cc56e4159b730da9137095305d0acf7b0434d5`  
		Last Modified: Tue, 13 Aug 2024 16:20:46 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
