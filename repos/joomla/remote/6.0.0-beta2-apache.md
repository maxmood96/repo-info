...
### `joomla:6.0.0-beta2-apache` - linux; amd64
...
### `joomla:6.0.0-beta2-apache` - unknown; unknown
...
### `joomla:6.0.0-beta2-apache` - linux; arm variant v5
...
### `joomla:6.0.0-beta2-apache` - linux; arm variant v7
...
### `joomla:6.0.0-beta2-apache` - linux; arm64 variant v8
...
### `joomla:6.0.0-beta2-apache` - linux; 386
...
### `joomla:6.0.0-beta2-apache` - linux; ppc64le
...
### `joomla:6.0.0-beta2-apache` - linux; riscv64
...
### `joomla:6.0.0-beta2-apache` - linux; s390x
