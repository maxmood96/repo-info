...
```console
$ docker pull joomla@sha256:2c6fed87f7fd6aa005144face813636692af95c346d97fe5839d035e4292ecb3
```
...
```console
$ docker pull joomla@sha256:a0c3f3d8ee7ed9909fd9601f899ea1350b7d6b620ed04aa2c5626e0c3062d9b4
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.4 MB (46396910 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0369231ed40d8ef8d13ba2c702b6013f8039fad71a7524f6977c6b459b29c05e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Sat, 18 Jan 2020 07:22:13 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Sat, 18 Jan 2020 07:22:14 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Sat, 18 Jan 2020 07:22:16 GMT
RUN apk add --no-cache 	bash
# Sat, 18 Jan 2020 07:24:50 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
...
# Sat, 18 Jan 2020 07:24:53 GMT
ENV JOOMLA_SHA512=e7807256f40330fa857d37bd00b91e76c7a0ee24d21a1c3fbe95af90cf80b01fcee15845b9cbdc75a3eec0e36b140e87d78fbe491ee6851abbc74be621cb719a
# Sat, 18 Jan 2020 07:25:06 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 18 Jan 2020 07:25:09 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Sat, 18 Jan 2020 07:25:09 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Sat, 18 Jan 2020 07:25:10 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 18 Jan 2020 07:25:11 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:1bf73baa8429aff03ffa5ccd1d5f07e482c35b9ed9473f800a390a71fee73400`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b598c49b1950acb05d5dbabff7fcaf5066aee74bc39ae841877c36c16f1b4346`  
		Last Modified: Sat, 18 Jan 2020 07:32:31 GMT  
		Size: 591.1 KB (591120 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a168a6deebd36454ba698d6ec533dde1f26d8f69dff889c3a15a79333e881729`  
		Last Modified: Sat, 18 Jan 2020 07:32:33 GMT  
		Size: 6.2 MB (6151049 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff18e08fa757a672d4ab52db7a8896cda8778634fb6157e4aa8959da6fa534b0`  
		Last Modified: Sat, 18 Jan 2020 07:32:32 GMT  
		Size: 9.7 MB (9651594 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b30e36910d1d251eda86a4e74f5b014485c53d8e51a6a15040e4d998a094d7a1`  
		Last Modified: Sat, 18 Jan 2020 07:32:30 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9ef00bc6724e4cdf502f34f24f240afe2c90749a6c8b0d5efd5b9ee9c0411343`  
		Last Modified: Sat, 18 Jan 2020 07:32:31 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
