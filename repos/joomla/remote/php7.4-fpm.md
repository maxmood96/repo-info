...
```console
$ docker pull joomla@sha256:02b0fb2b10b1342e5c5a1fe91fa2bdb90289b94623de7b5ded6b73cfff5bec80
```
...
```console
$ docker pull joomla@sha256:4b36b1e619d2e7d04cd48bfdc2b3b072a5d4aa53c8e076dfc7902caf0e1fb560
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161729112 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0a3549bf9e247b546abf1e137d8003715115564a240419e037ce262cf76dc2f5`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Fri, 23 Apr 2021 18:46:25 GMT
ENV JOOMLA_SHA512=2fd83450cb45c7cdf349e57d4933b78bf6d445775141b364f9f76a501877f3c16b794a9499e5b992f2aea74492103ffbe2d4bcc9b4f568ad79af6997a01ca842
# Fri, 23 Apr 2021 18:46:30 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 23 Apr 2021 18:46:31 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 23 Apr 2021 18:46:31 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 23 Apr 2021 18:46:31 GMT
...
-	Layers:
	...
	-	`sha256:58c874e51082639164f9bb7dddb5a7b50d61cd6750086fa9caff688437cb2174`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1f9ce1fa0b181a93c796b278f8deadae8fa5cbbc7480a406b29c24bd14447dc5`  
		Last Modified: Fri, 23 Apr 2021 18:51:00 GMT  
		Size: 3.2 MB (3156799 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73e34a36a7add8895760b40e6f6101b2edf294c53f486d8c0993377f79408b67`  
		Last Modified: Fri, 23 Apr 2021 18:51:02 GMT  
		Size: 9.7 MB (9730158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:abc76b6f9d0a0198a3d7b0e94e57b775ab43b1402f2763b87f6516ab7a327f27`  
		Last Modified: Fri, 23 Apr 2021 18:50:59 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2160195265c35af483ac3772091b1e09e52de733e1333c440b200c751530eeba`  
		Last Modified: Fri, 23 Apr 2021 18:50:59 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:47e2280f3ee70469499929edb542dace04e1dc2acc0b58f38a610cc31697ce81
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.6 MB (138646198 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57012edbc55ad5c60e5575da77be4927539f784bf99bb205d7fd85a9cc76148c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 10 Apr 2021 16:31:42 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 23 Apr 2021 19:28:41 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 23 Apr 2021 19:28:41 GMT
VOLUME [/var/www/html]
# Fri, 23 Apr 2021 19:28:41 GMT
ENV JOOMLA_VERSION=3.9.26
# Fri, 23 Apr 2021 19:28:42 GMT
ENV JOOMLA_SHA512=2fd83450cb45c7cdf349e57d4933b78bf6d445775141b364f9f76a501877f3c16b794a9499e5b992f2aea74492103ffbe2d4bcc9b4f568ad79af6997a01ca842
# Fri, 23 Apr 2021 19:28:55 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 23 Apr 2021 19:28:56 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 23 Apr 2021 19:28:57 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 23 Apr 2021 19:28:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 23 Apr 2021 19:28:57 GMT
...
-	Layers:
	...
	-	`sha256:ff85c1eedab7e6ec2b5892559995d85297dbc10aace124eef335da740c32039c`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1700b2845f32fbe55ff9cb4067982ad01b51432446d1c57381668c2dc4e0d229`  
		Last Modified: Fri, 23 Apr 2021 19:32:15 GMT  
		Size: 3.1 MB (3087887 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dd76ba8d2f70918999150294812978e63f45a671931ebe9c4336093243ad91af`  
		Last Modified: Fri, 23 Apr 2021 19:32:23 GMT  
		Size: 9.7 MB (9730146 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b667ad48da3b64ada483db46d22d6ee901dd14423cb8b7e8bcb8acee9e37223e`  
		Last Modified: Fri, 23 Apr 2021 19:32:12 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:332846ccd5594cf6a50451b1123a4661a27853d8ec9f7dd7b896dfa4abd5c2da`  
		Last Modified: Fri, 23 Apr 2021 19:32:12 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
