...
```console
$ docker pull joomla@sha256:83196463ee8e6de4303fe399290d154b2dd01add68c0613aed9c93d6b4129e14
```
...
```console
$ docker pull joomla@sha256:6b0e0cd2118459b4be669b59e1c8ca26298c4bcdcc1fdfbfbe72e2d269b6da16
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155950960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:653c7a6615736d64dd2b05697058b83af0751e72f228772bf6a81c80aec8f593`
...
-	Layers:
	...
	-	`sha256:4f626abab1e8740e67cededf27f86d049366408caf0bbc36bcf64a1efc6b4398`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d2ee6ac979e939250eb15a8e54ccc78fe2367b735a515412ac17d8a93606820`  
		Last Modified: Fri, 04 Jun 2021 00:25:19 GMT  
		Size: 3.1 MB (3147079 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fcea1971c8137b6da8768df4619b29ff2813084520c0826958d630f7e3e3ac7b`  
		Last Modified: Fri, 04 Jun 2021 00:25:21 GMT  
		Size: 9.7 MB (9723503 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8ff3cfc5c0941072138916d9412d8782ca890b4c86fe55b0118ae4ab21129940`  
		Last Modified: Fri, 04 Jun 2021 00:25:18 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b24631ce1a34d6181be7859eb7ceff7df19121881249be412417697a865a692f`  
		Last Modified: Fri, 04 Jun 2021 00:25:18 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:17b68de79ca85154d525ebe9580787cf70ceedfdc74acdacebaf0242bf3170ea
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.3 MB (134262454 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6879683eb76649262bf83785874653b3774e470e0e72beeba3c1d2b0c6d65537`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Jun 2021 23:03:03 GMT
CMD ["php-fpm"]
# Fri, 04 Jun 2021 01:57:36 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 04 Jun 2021 01:57:36 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 04 Jun 2021 02:00:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 02:00:39 GMT
VOLUME [/var/www/html]
# Fri, 04 Jun 2021 02:00:39 GMT
...
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Fri, 04 Jun 2021 02:00:47 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 04 Jun 2021 02:00:48 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 04 Jun 2021 02:00:49 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 04 Jun 2021 02:00:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 02:00:49 GMT
...
-	Layers:
	...
	-	`sha256:2822904bac8425b9d27b54f995d4a61aa9e0f98610349b4def3003368519b5e0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d5d8d3c248ac267d3539cf949c72bfb7b772f5afedb06338da1272a54bbbf66`  
		Last Modified: Fri, 04 Jun 2021 02:06:35 GMT  
		Size: 3.0 MB (2970082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db2778bad2e872f90576e11b88645933c165988fd8451054dc4d8200c40ebb05`  
		Last Modified: Fri, 04 Jun 2021 02:06:39 GMT  
		Size: 9.7 MB (9723509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f08824116db94fceb4f993d7ccb473cbfcee8d9b821de4de29f6d3b629953c9e`  
		Last Modified: Fri, 04 Jun 2021 02:06:34 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b8b31efd12226a775e232815a8c389bb9314a76572504d716f787ec5e1151fb7`  
		Last Modified: Fri, 04 Jun 2021 02:06:34 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:ec9715040e69d088284c90ab29bdc45ee6cd3a8eacc4eaa07f95f8bc645f4fbb
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **131.7 MB (131733177 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:21e776152e270e11686f3e8b4a051211f34961d2937ebbf115eff5f323c2d3eb`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 27 May 2021 06:20:24 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 27 May 2021 06:20:24 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 27 May 2021 06:23:17 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 May 2021 06:23:18 GMT
VOLUME [/var/www/html]
# Thu, 27 May 2021 06:23:18 GMT
ENV JOOMLA_VERSION=3.9.27
# Thu, 27 May 2021 06:23:18 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Thu, 27 May 2021 06:23:26 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 27 May 2021 06:23:26 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 27 May 2021 06:23:27 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 27 May 2021 06:23:27 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 27 May 2021 06:23:28 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0c9faa663779f5be4fcd6054eca5c52cd432ef0d3016609d544084960ce92a17`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f05c253f4c44befa97e9caa0e9e3ddc70bb0e7cfd8eec6eb4038659c7c70994e`  
		Last Modified: Thu, 27 May 2021 06:34:10 GMT  
		Size: 2.9 MB (2872880 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07328aaea4b74b50127cac2202fee95940e70bda01f9651afd85831202f4e771`  
		Last Modified: Thu, 27 May 2021 06:34:13 GMT  
		Size: 9.7 MB (9723508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c52150524c9814b69901e76def6de76e89adb985bdc7b3b1d3270468496d062a`  
		Last Modified: Thu, 27 May 2021 06:34:08 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5119beac6f95954fb59cae8653e1bf1a1b0ad2daf74d8ab9a6058e8675c35ebe`  
		Last Modified: Thu, 27 May 2021 06:34:08 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:8d24cfa6ad9d63666a83b538c2840bf9e431ff188ecb3097e33da5e7cfe95e7e
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148105113 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0c9573431404c317ca6ec09ce5b9388be31a52050ab18b667579b8b5ad905855`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 12 May 2021 07:08:57 GMT
CMD ["php-fpm"]
# Thu, 27 May 2021 13:13:08 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 27 May 2021 13:13:08 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 27 May 2021 13:14:44 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 27 May 2021 13:14:44 GMT
VOLUME [/var/www/html]
# Thu, 27 May 2021 13:14:44 GMT
ENV JOOMLA_VERSION=3.9.27
# Thu, 27 May 2021 13:14:45 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Thu, 27 May 2021 13:14:49 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 27 May 2021 13:14:49 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 27 May 2021 13:14:49 GMT
...
-	Layers:
	...
	-	`sha256:8ceae00ed1a99ffa15fdf950030e7763f05e379156a31f918450400afc6aa0f2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25c6d94694fd127f21e561312efb2f48b777fc9f1ffed1ce6f30cee0be9d7500`  
		Last Modified: Thu, 27 May 2021 13:21:51 GMT  
		Size: 3.1 MB (3101874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59c206c9f507c5d7f256adef1bc15c50a52bfeab6a729957aae2a9d769c37199`  
		Last Modified: Thu, 27 May 2021 13:21:53 GMT  
		Size: 9.7 MB (9723505 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c8aaac3c83f815ab57f54c6cbbfd443d4563224eb6e0126e9f806e6832bded2`  
		Last Modified: Thu, 27 May 2021 13:21:50 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3844ba675fbe888644ab7686c687257cd198b04371e39d98081b639afdd78c5`  
		Last Modified: Thu, 27 May 2021 13:21:50 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:f6256c7d2320d1209ce941b6c8f3f1e1865621fe96cdb9ee542705108396fe33
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **161.7 MB (161741765 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23b483433d3eaec7ba2f1407f4a625e424020c56481a6beb113f7b94de574279`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Jun 2021 00:09:44 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 04 Jun 2021 00:09:45 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 04 Jun 2021 00:11:27 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 00:11:27 GMT
VOLUME [/var/www/html]
# Fri, 04 Jun 2021 00:11:28 GMT
ENV JOOMLA_VERSION=3.9.27
# Fri, 04 Jun 2021 00:11:28 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Fri, 04 Jun 2021 00:11:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 04 Jun 2021 00:11:34 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 04 Jun 2021 00:11:34 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 04 Jun 2021 00:11:35 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 00:11:35 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7d3e49b4ba97e6888cbdf394fd51d5ab0f81da3fa3f8df1cb48eee4c2ca4a6a5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5fa904ca4f3be37b0862e54ec010ee0798a0e8217b5ed0b0c50b6cda021cabb3`  
		Last Modified: Fri, 04 Jun 2021 00:15:45 GMT  
		Size: 3.2 MB (3156867 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7ad876857a8bb5c867fcb5c87f76e4d1d2a32f1af511dcc52f06dfa8cd1a38ad`  
		Last Modified: Fri, 04 Jun 2021 00:15:47 GMT  
		Size: 9.7 MB (9723510 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11f96c84a8416949ce8e3c1b4e4a541111809d8c3b19dd82b4dede26cae7f56b`  
		Last Modified: Fri, 04 Jun 2021 00:15:43 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a145abb532490e810e6b757f224292209e625884be27105c769ce30b51e6be6c`  
		Last Modified: Fri, 04 Jun 2021 00:15:44 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:cd72f470540fbf1b6bfd3343367a460527321fe6dd9cc9aaad0e1f93f789707a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **138.7 MB (138662107 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fddbee904e8111f893119e45e2410b57d0e632a1324e3d7ba2aae1e1b34fe897`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 03 Jun 2021 21:37:56 GMT
CMD ["php-fpm"]
# Thu, 03 Jun 2021 22:16:45 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 03 Jun 2021 22:16:45 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 03 Jun 2021 22:21:36 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 03 Jun 2021 22:21:37 GMT
VOLUME [/var/www/html]
# Thu, 03 Jun 2021 22:21:37 GMT
ENV JOOMLA_VERSION=3.9.27
# Thu, 03 Jun 2021 22:21:37 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Thu, 03 Jun 2021 22:21:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 03 Jun 2021 22:21:52 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 03 Jun 2021 22:21:52 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 03 Jun 2021 22:21:53 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Jun 2021 22:21:53 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:614febc257f589248a0c1c6f1592441f42661e0fe793a195fff77d95bb181ae4`  
		...
		Size: 8.4 KB (8447 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3cae2ec5c5f24892f81184b73ff56d9587212aa7d7cf768ccad34e9649018d52`  
		Last Modified: Thu, 03 Jun 2021 22:23:17 GMT  
		Size: 3.1 MB (3087963 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af0fcac4f5643e217ec57dfc588c9df7c7ded184310255c6f13688aa747d83ab`  
		Last Modified: Thu, 03 Jun 2021 22:23:24 GMT  
		Size: 9.7 MB (9723324 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9da74f7920319df810f4f5a74d06691b38226658b71a1784bd83d284a1f6c93`  
		Last Modified: Thu, 03 Jun 2021 22:23:14 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:129fb9467a56aecd2aa1eb15097c3cba30c984b99d9428569151c77cd9eddaf6`  
		Last Modified: Thu, 03 Jun 2021 22:23:13 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:1ec15046da83212551f13899960ec84759e048768bdc9229a40c5ab51026dab4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.9 MB (166858691 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f875558be884c8d1d02cb9bea0263345a532d4acec9bd07a7c87f4d7a5d4fa01`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Jun 2021 03:40:43 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 04 Jun 2021 03:40:48 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 04 Jun 2021 03:44:43 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 04 Jun 2021 03:44:48 GMT
VOLUME [/var/www/html]
# Fri, 04 Jun 2021 03:44:55 GMT
ENV JOOMLA_VERSION=3.9.27
# Fri, 04 Jun 2021 03:45:05 GMT
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Fri, 04 Jun 2021 03:45:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 04 Jun 2021 03:45:37 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 04 Jun 2021 03:45:38 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 04 Jun 2021 03:45:42 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Jun 2021 03:45:46 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:cc89e7f4dc563ae18297dcfc29305bb45ee66a06405156bc0c5df2343d9be790`  
		...
		Size: 8.4 KB (8449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e49ec385f8a7fbe7b6c40dcd53b8c3642b75886d33026cf2832bea9ee13087a`  
		Last Modified: Fri, 04 Jun 2021 03:51:41 GMT  
		Size: 3.3 MB (3349240 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:38ae2151ae10feef05e5c3f1373511d474c687eed33bc04dba0471dbbefc0c44`  
		Last Modified: Fri, 04 Jun 2021 03:51:43 GMT  
		Size: 9.7 MB (9723508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bcabf5c142f881ab8832c2b34b99ca88f6594165ea5964a4e847a7bbdd6d3352`  
		Last Modified: Fri, 04 Jun 2021 03:51:40 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57a3bde0ebe30c7264eab551a641f78197073c413b26acebce49542ca3c82cbb`  
		Last Modified: Fri, 04 Jun 2021 03:51:40 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:af65cd40742d45d4e9883bc035ece2afc4278b6312dd663b9d53d9f2b9019414
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141665836 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:922be64529741ea0248bd7cadf44bb49cd1c1afc8c973f2641b396bfe3d276a2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Jun 2021 01:52:16 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 04 Jun 2021 01:52:17 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
...
ENV JOOMLA_SHA512=fe3310cdf4a94ebad1ead72eed5fdab481a0f8f80c89ee002a045ffec25d1a4de8afc26199003cee3ffbda7d42086132a70e9650a5415a0cf15444156acda18c
# Fri, 04 Jun 2021 01:53:48 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 04 Jun 2021 01:53:49 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
...
-	Layers:
	...
	-	`sha256:47569e97d00e591809105f0f416b605b1f70193138acf3b848f92490bfe9d642`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ccd18ed292e1e22744e68fe44f468e56cc09aacf9512f8a2ed877a0f2caab5fd`  
		Last Modified: Fri, 04 Jun 2021 01:57:00 GMT  
		Size: 3.1 MB (3103004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d23f5dec78f3fb86c9039fe164e110b1d25e91f4d16ba51605ea46509698502b`  
		Last Modified: Fri, 04 Jun 2021 01:57:01 GMT  
		Size: 9.7 MB (9723509 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d5335adcb6e00d5f0604840f7ef5947a7f368d77b67a253e27d2cb082ee31692`  
		Last Modified: Fri, 04 Jun 2021 01:56:59 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:395bf4ec40fa41b57cecae84bb497cad0db4905c65ab774419a6df5433e0ad7e`  
		Last Modified: Fri, 04 Jun 2021 01:57:00 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
