...
```console
$ docker pull joomla@sha256:ef21f80427d729dda9f9acba45a937510abf4f3a1bf25b6f19b91f63b3a80583
```
...
```console
$ docker pull joomla@sha256:9c74b2c608e78f08ecd6a6fc3bce91602d674591046596dff688fe4798cb25a5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **156.0 MB (155954635 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d496bf770a4cb7aed5b5fc3bf46f46707982f9e4187c6aca646e90e3bec4520`
...
# Tue, 31 Mar 2020 18:28:36 GMT
CMD ["php-fpm"]
# Wed, 01 Apr 2020 05:44:07 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Wed, 01 Apr 2020 05:44:07 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 01 Apr 2020 05:45:30 GMT
...
-	Layers:
	...
	-	`sha256:e2514f61d803e451f78ea65cb02e3cbcd57416beaa2013480a94a6bbeb6a48ac`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9729f5018232eb099ac447f08fd2352674ffd7e6ef3711a6c0e80e8b89a1b0b7`  
		Last Modified: Wed, 01 Apr 2020 05:47:13 GMT  
		Size: 3.4 MB (3419650 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b91ff82aa1eb34f943da4a74fc95571da7e64a2445e6b14eb02bfcf0a5b57616`  
		Last Modified: Wed, 01 Apr 2020 05:47:15 GMT  
		Size: 9.7 MB (9653484 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a748d769bda754653e223fddceb845fe34a60fd590424ac7220bc250cccdce3`  
		Last Modified: Wed, 01 Apr 2020 05:47:12 GMT  
		Size: 1.2 KB (1170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:27f745b6986988f8748b2cad3c4ba7df00c56a6d09498a8367f87a561de5a884`  
		Last Modified: Wed, 01 Apr 2020 05:47:12 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:16778908f8687ef74e17dcb3d2256d6bd96f414e3dab3c74cd37f71868d7c198
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.3 MB (134298032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:01a36dbe63c2cab6c1193f5a81cb88a068c89988fa329c04c492884e6359cb98`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 16 Apr 2020 08:33:04 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Thu, 16 Apr 2020 08:33:04 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 16 Apr 2020 08:36:03 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Apr 2020 08:36:04 GMT
VOLUME [/var/www/html]
# Thu, 16 Apr 2020 08:36:06 GMT
ENV JOOMLA_VERSION=3.9.16
# Thu, 16 Apr 2020 08:36:07 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Thu, 16 Apr 2020 08:36:17 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 16 Apr 2020 08:36:20 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Thu, 16 Apr 2020 08:36:21 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 16 Apr 2020 08:36:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Apr 2020 08:36:23 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:aa86cc33bbde81f2ea694fc68e918bdb19f5e66ee13436cc4cea4111e3843afe`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0588ffa0987782ca0d680a6402e675af70390a240f8ffa65a3c6f7993470ce8d`  
		Last Modified: Thu, 16 Apr 2020 08:39:10 GMT  
		Size: 3.2 MB (3249904 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ec2e183c924eaddf5f6d2481ccc84bd4658ed9b2ecfd5c15f66685e046c4822`  
		Last Modified: Thu, 16 Apr 2020 08:39:14 GMT  
		Size: 9.7 MB (9653673 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:58276585e57faba7cadca367c7ccc1f8d3ae3eca29cddbd6458251655ca1f6d5`  
		Last Modified: Thu, 16 Apr 2020 08:39:09 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f10f84c269a36a061ba9174f6b5679bb781f1e13ce7da8b7844386dd03777ee5`  
		Last Modified: Thu, 16 Apr 2020 08:39:09 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:2ea7a23ce4819732051c91f95e88f15a6df024c8ba577998939ce4daae37bdb4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148092230 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b212ab282c14e1bdc2578550f27cdece36cee45967382040eea7e8b61cd8d7b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_VERSION=3.9.16
# Wed, 01 Apr 2020 06:50:31 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Wed, 01 Apr 2020 06:50:38 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 01 Apr 2020 06:50:40 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Wed, 01 Apr 2020 06:50:40 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 01 Apr 2020 06:50:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 01 Apr 2020 06:50:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:a9b14cceba977975e05982ba9b6ca02b5b7e2c21188f3fe40d38ed7ef8cc85cb`  
		...
		Size: 8.4 KB (8415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:204f8d4f49779de02c5ef1a329ae03509d3f8bd5353922a5e59d331baea11b90`  
		Last Modified: Wed, 01 Apr 2020 06:53:27 GMT  
		Size: 3.4 MB (3364532 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c5f8fe34a45d545bb0969131f57b4a675bc64dbaa00c4174988deade9b3206e`  
		Last Modified: Wed, 01 Apr 2020 06:53:29 GMT  
		Size: 9.7 MB (9653676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc650b6cee0c2c83598578dadcff1182a70543248ec0b33ef3851982cea1fdff`  
		Last Modified: Wed, 01 Apr 2020 06:53:26 GMT  
		Size: 1.2 KB (1170 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:587dae189722345ab625af140b7dc450a6248f79f708a6b2459e36cf49f124bb`  
		Last Modified: Wed, 01 Apr 2020 06:53:26 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:bf8df645aa5021ffb5030caf041c351edc2755a5b5907fbe594d070cf9721c11
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **166.8 MB (166848046 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:99ffbc6927c9e172c2374167fe2d13536836799ce1f61d8a924a29eb9d15f366`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Wed, 01 Apr 2020 06:21:58 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Wed, 01 Apr 2020 06:22:00 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 01 Apr 2020 06:24:31 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Apr 2020 06:24:34 GMT
VOLUME [/var/www/html]
# Wed, 01 Apr 2020 06:24:37 GMT
ENV JOOMLA_VERSION=3.9.16
# Wed, 01 Apr 2020 06:24:41 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Wed, 01 Apr 2020 06:24:58 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 01 Apr 2020 06:25:04 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Wed, 01 Apr 2020 06:25:21 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 01 Apr 2020 06:25:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 01 Apr 2020 06:25:49 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0a871252b0192cf2438763f57101e3dc1a1e3e3153cc2e278a77858514e2f421`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86c62b635116f931e4030577142c36a4246733947538904a8703b4b12249750e`  
		Last Modified: Wed, 01 Apr 2020 06:30:54 GMT  
		Size: 3.6 MB (3593489 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1bf7c9866063ac8b30c6eeab3de7322bccfbffa5016e6981ef67a073983b3be0`  
		Last Modified: Wed, 01 Apr 2020 06:30:57 GMT  
		Size: 9.7 MB (9653676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85a6a30c4def0786b8534873c7d5e91445f8f8d06fa38b3463822257421e97df`  
		Last Modified: Wed, 01 Apr 2020 06:30:52 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7676dda5d2071fe4d32d7540c6dcd21a90fc6dc7457e5a42e0c662a75deea76b`  
		Last Modified: Wed, 01 Apr 2020 06:30:52 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:5b9245389381c6dca5e4e25d1ad8f1d2e5201eb45308323cfeb3e3b4c9ab535b
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **141.7 MB (141714504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38755bc2380b0d2cc566009752c285a59dfd8940233f6bc7515b8e2e87920d92`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 16 Apr 2020 05:33:55 GMT
CMD ["php-fpm"]
# Thu, 16 Apr 2020 14:27:30 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Thu, 16 Apr 2020 14:27:30 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 16 Apr 2020 14:28:28 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 16 Apr 2020 14:28:28 GMT
VOLUME [/var/www/html]
# Thu, 16 Apr 2020 14:28:28 GMT
ENV JOOMLA_VERSION=3.9.16
# Thu, 16 Apr 2020 14:28:29 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Thu, 16 Apr 2020 14:28:33 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
...
-	Layers:
	...
	-	`sha256:a8e873f058d7103e7c89cc2760d7e26a194632433fd7476570c1f46809f6dd52`  
		...
		Size: 8.4 KB (8415 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5e6c38846f1bf1d5e08c57db84d708b7707930ce9ee29063b37e81ab03389611`  
		Last Modified: Thu, 16 Apr 2020 14:33:17 GMT  
		Size: 3.4 MB (3386184 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bdb635b11a2a4ec451b14008a51289d937aa1584818793531d993208a14c433d`  
		Last Modified: Thu, 16 Apr 2020 14:33:24 GMT  
		Size: 9.7 MB (9653676 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddc654d027ca7e53cfa4be9317d89f24fe7afd6112b56a3b9d00ee377ffbc1a1`  
		Last Modified: Thu, 16 Apr 2020 14:33:22 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:663339db3f242649248c2c24cb8aa09832b48f198be509926f4f08f896b2d13b`  
		Last Modified: Thu, 16 Apr 2020 14:33:22 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
