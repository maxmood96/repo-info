...
```console
$ docker pull joomla@sha256:d0ce9d1aa1635d4e59a266d1170ea0d580dc7b3888b7a1c216015799188cfcf3
```
...
```console
$ docker pull joomla@sha256:d5787776a22b094ba9aa7d27ef83f9f96f86abbc217882d8cc9023b86e5de678
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **155.9 MB (155932288 bytes)**  
...
CMD ["php-fpm"]
# Fri, 24 Apr 2020 11:49:12 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Fri, 24 Apr 2020 11:49:12 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Apr 2020 11:50:36 GMT
...
-	Layers:
	...
	-	`sha256:c2def74fd711fde46efd1d99a7fd3ae9172bf4c4129d4c458f54c1f229cbb1bb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a5136de3d8a05e08ef005bfead81630cbeb47ce354166c16c5216b427546379`  
		Last Modified: Fri, 24 Apr 2020 11:52:27 GMT  
		Size: 3.4 MB (3415689 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:453c5d10deb102cf760b92ba304a1689553a440dc49d81a57639b9154688a386`  
		Last Modified: Fri, 24 Apr 2020 11:52:30 GMT  
		Size: 9.7 MB (9653487 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9228a3af7a21b3aed809386e00cbef1e1fa49773d9a35c4b7aec0cf524b2247a`  
		Last Modified: Fri, 24 Apr 2020 11:52:26 GMT  
		Size: 1.2 KB (1173 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f696b710b425c89d8cf15fb941a190be72177507c09f3e87cced49751d99d97c`  
		Last Modified: Fri, 24 Apr 2020 11:52:26 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:a030788c24d286fb39f9771f1132696dd1fbc8c4a27378f39d42f23e4128518c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **148.1 MB (148077598 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c7b2b0d6b47e82cbfcc3e72175095f82f4d2a1703adca680bc5d56179da82905`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 24 Apr 2020 01:52:31 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Fri, 24 Apr 2020 01:52:32 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Apr 2020 01:55:05 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Apr 2020 01:55:06 GMT
VOLUME [/var/www/html]
# Fri, 24 Apr 2020 01:55:07 GMT
ENV JOOMLA_VERSION=3.9.16
# Fri, 24 Apr 2020 01:55:08 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Fri, 24 Apr 2020 01:55:18 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Apr 2020 01:55:20 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Fri, 24 Apr 2020 01:55:21 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Apr 2020 01:55:22 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Apr 2020 01:55:22 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:6ec307f79d09bd3270f1cec0e69ca1152da40c2ee67a5194a6cf52bd1c711e7e`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e283b419e6638506d9a1bbf7eed9f48bdce17ced504077d9b3293f66e4fe9fc6`  
		Last Modified: Fri, 24 Apr 2020 01:58:43 GMT  
		Size: 3.4 MB (3358050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:427f956719fcbe8e52302e140398fdc4355ab4b53b61c8a1fbea4a4b5913f38d`  
		Last Modified: Fri, 24 Apr 2020 01:58:44 GMT  
		Size: 9.7 MB (9653668 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:716ca451a68e947646079e171a0c963a77c259ea555a2ae4f5168f9a59154870`  
		Last Modified: Fri, 24 Apr 2020 01:58:43 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2474a05b96458671659888f0b9739d14e66dfbcb5530634e08e1f2e70ac30064`  
		Last Modified: Fri, 24 Apr 2020 01:58:44 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
