...
```console
$ docker pull joomla@sha256:313e91bf5d27ca67d7e97274db9253296a2ec69b2d0fe81155902a3785b53b3b
```
...
```console
$ docker pull joomla@sha256:d4f5ed55bdbe073d8a874d464efcaf8da8491d49150b47618749d36062140525
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **165.3 MB (165340920 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cabcb9230353816a0526a50450c3fb597d1c292cd9368f3f774a1a6ea0d7a4f2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_SHA512=56dc516fd4596c1f728cf3503d7427dfc755d4b23ad5c170e2ee11d2a1d9e38484b3fa5cb337f8ce9ad8b5108386644d915afda3d3eae0d418dae9bd1d774eb3
# Thu, 18 Nov 2021 23:41:35 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 18 Nov 2021 23:41:37 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 18 Nov 2021 23:41:37 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 18 Nov 2021 23:41:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 18 Nov 2021 23:41:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:7d0c7ee61681985bf9ec4f63f356170979e6435c3454802905feb26493771ef2`  
		...
		Size: 8.4 KB (8448 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe17d8f41fa2a36ccd2ad7c8e6a7d00e29b707c1d9c58becf31d9495c2f5e26b`  
		Last Modified: Fri, 19 Nov 2021 00:17:00 GMT  
		Size: 3.0 MB (2969453 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:95e51f0e4536a38969e75c1e765ad56487e5341b479021e8c258804a9180a466`  
		Last Modified: Fri, 19 Nov 2021 00:17:15 GMT  
		Size: 21.6 MB (21566397 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c9d0e9a4db9cf580005ea521fc66974bb1998657f1cd83c168f510dafecc6199`  
		Last Modified: Fri, 19 Nov 2021 00:16:57 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2e55e4126365052ea2d00507895b2e028809233ce847eca2d3ee54a896423191`  
		Last Modified: Fri, 19 Nov 2021 00:16:57 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
