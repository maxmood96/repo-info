...
```console
$ docker pull joomla@sha256:a3b4c16422924ddc53dae47223f361206edc3f8884a9ff431a02a322275b6ac8
```
...
### `joomla:5.4.4-apache` - linux; amd64
...
### `joomla:5.4.4-apache` - unknown; unknown
...
### `joomla:5.4.4-apache` - linux; arm variant v5
...
### `joomla:5.4.4-apache` - linux; arm variant v7
...
### `joomla:5.4.4-apache` - linux; arm64 variant v8
...
### `joomla:5.4.4-apache` - linux; ppc64le
...
### `joomla:5.4.4-apache` - linux; s390x
