...
```console
$ docker pull joomla@sha256:99b0cc1f6ef2828db6e5ebfeec94ffabb72f784bc8f55913183ca39d90f2698d
```
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; arm variant v5
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.3-fpm` - linux; s390x
