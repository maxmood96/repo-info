...
```console
$ docker pull joomla@sha256:dd200c8e8f1154e848488f82911e84289341d829a7ce07bf7d81e801c745add3
```
...
```console
$ docker pull joomla@sha256:d035f039799b2501da153ff856a07f0fe4d7ad154a7bc61844e8aff711eca7f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **257.9 MB (257867740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7eb3b75f0014653426cef400af5d3f0d408d9521c99838cb00a2e0ba9b49bf48`
...
-	Layers:
	...
	-	`sha256:d5701525e6fdff07cf851e8c90d5022e216b7430de641fdac3a73f768ad2751b`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea9ab9c725924fd8422330e2aa1f4b1d0232c178f97360afdcc0d646b2559938`  
		Last Modified: Wed, 17 Apr 2024 00:37:18 GMT  
		Size: 25.6 MB (25644090 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3a9ac7ae48d3c9b88d36ea6f909b7a89c8d9b2683427418a4c47d9b8f8acb413`  
		Last Modified: Wed, 17 Apr 2024 00:37:14 GMT  
		Size: 2.7 KB (2739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea72ecec98862556c951acf18412e70913821b5b289a98a8c99cf643c7eb4fd3`  
		Last Modified: Wed, 17 Apr 2024 00:37:14 GMT  
...
```console
$ docker pull joomla@sha256:2b2f66de2e6f70337f4a0a1f181b1193723732331fdec643376bd62d083f1983
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.9 MB (227913654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:774eaf8646eeb4e6dd9fb34ad96f8aa713a9d5adaf647d05ea22b13e660060fd`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 24 Apr 2024 13:32:48 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 13:35:37 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 24 Apr 2024 13:35:38 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Apr 2024 13:35:38 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Apr 2024 13:35:38 GMT
...
# Wed, 24 Apr 2024 13:35:38 GMT
ENV JOOMLA_VERSION=4.4.4
# Wed, 24 Apr 2024 13:35:39 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Wed, 24 Apr 2024 13:35:46 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 24 Apr 2024 13:35:47 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 24 Apr 2024 13:35:47 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 24 Apr 2024 13:35:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 13:35:48 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:927408a889bae00defead3acca4a206aee8f3eb9a675a91cecefc33e2da5db5a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d6b8c1aa3cf562e9932b450d6db647c671df31fd2017ea5d8432c2727d6438fd`  
		Last Modified: Wed, 24 Apr 2024 13:40:14 GMT  
		Size: 25.8 MB (25825417 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c9cbfc635e628048d64b9145c65f542b9904e395bdbc75dd3553f78f0927a3d`  
		Last Modified: Wed, 24 Apr 2024 13:40:14 GMT  
		Size: 28.8 MB (28834394 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d7d8935e1f0d3a55e4e587271d6358a42a55c56beead219fddc6987d66d847d0`  
		Last Modified: Wed, 24 Apr 2024 13:40:07 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e39375eb28e2bffacd951c33a8ab2d8b6338cd311dbd28b45e2735923d1da475`  
		Last Modified: Wed, 24 Apr 2024 13:40:07 GMT  
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c1c500393fcfc909bcc16da2af605efb8f88b99a84cf0212738ecbdbe08197de`  
		Last Modified: Wed, 24 Apr 2024 13:40:12 GMT  
		Size: 25.6 MB (25644127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3573839dbf861e0c4487a08f4755c6da63a4c1592ddac771e477ab35ed9d6e99`  
		Last Modified: Wed, 24 Apr 2024 13:40:07 GMT  
		Size: 2.7 KB (2739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dd0e86bf1b22c1fcbf588b2b4fbdf3d144999927a0665a218c867e1b3e3b8d2`  
		Last Modified: Wed, 24 Apr 2024 13:40:07 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:91e908c990ad0d276eb17210a532f7c8511e44f75d66d525228a22f1ed477ea4
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **216.8 MB (216776065 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce66a91ecfb7a99a383ac41e9706fd4afa01a5272fef758edff47f9db9e9dcc2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Apr 2024 07:43:22 GMT
CMD ["php-fpm"]
# Wed, 24 Apr 2024 15:38:46 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Wed, 24 Apr 2024 15:38:46 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 24 Apr 2024 15:52:37 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 15:58:01 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 24 Apr 2024 15:58:03 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Apr 2024 15:58:04 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Apr 2024 15:58:05 GMT
VOLUME [/var/www/html]
# Wed, 24 Apr 2024 15:58:05 GMT
ENV JOOMLA_VERSION=4.4.4
# Wed, 24 Apr 2024 15:58:06 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Wed, 24 Apr 2024 15:58:18 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 24 Apr 2024 15:58:18 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 24 Apr 2024 15:58:19 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 24 Apr 2024 15:58:19 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 24 Apr 2024 15:58:19 GMT
...
-	Layers:
	...
	-	`sha256:40ed007f96f3696db2daf4eabfd6130b174448b3cb10f0051bf5ce0b288a3ad5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad362b5550194de5784af83f4bd0fe7b687dff8e611fd5f39f2cd3012672be01`  
		Last Modified: Wed, 24 Apr 2024 16:04:20 GMT  
		Size: 25.2 MB (25172449 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16c839c0e487196a9714d67d1a368d15b613c17daac1858865533f660cd25ad0`  
		Last Modified: Wed, 24 Apr 2024 16:04:20 GMT  
		Size: 27.2 MB (27237245 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:03ca2d324fbadd9651c409c9716007f100f63deeda82ae959be8353febd11339`  
		Last Modified: Wed, 24 Apr 2024 16:04:09 GMT  
		Size: 362.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:42d63d175ccae1e61cf6d4d0f7713605fc441f1c7762ffbdba439ec84e45aab6`  
		Last Modified: Wed, 24 Apr 2024 16:04:09 GMT  
		Size: 395.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f5d7ea25f373d9929ee7341ec69082f809c47ae06713c43116fb1f1f5681e6df`  
		Last Modified: Wed, 24 Apr 2024 16:04:18 GMT  
		Size: 25.6 MB (25644126 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9785d9b875c4ba5738e29a891e4d62ae2f802bddb890454c515d07423d1d76dc`  
		Last Modified: Wed, 24 Apr 2024 16:04:09 GMT  
		Size: 2.7 KB (2739 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23699bf0030c3dce14c9044324fb48aa3e3d818a463a5fad3f1caf845434d4a0`  
		Last Modified: Wed, 24 Apr 2024 16:04:09 GMT  
...
```console
$ docker pull joomla@sha256:be880fedac2ea5de30f1256b4423eecb21610b72fa237782e251faf2ac3b0854
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.2 MB (249179362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ab269ee5fce57cceb29505061577dc532727e06fb7cf48ad88b22473442aa7f`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Wed, 24 Apr 2024 12:02:49 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Wed, 24 Apr 2024 12:13:32 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 24 Apr 2024 12:15:45 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 24 Apr 2024 12:15:46 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 24 Apr 2024 12:15:46 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 24 Apr 2024 12:15:46 GMT
...
# Wed, 24 Apr 2024 12:15:46 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Wed, 24 Apr 2024 12:15:51 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 24 Apr 2024 12:15:52 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 24 Apr 2024 12:15:52 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 24 Apr 2024 12:15:52 GMT
...
-	Layers:
	...
	-	`sha256:97669201f547c1ec25290de2eb2456464ddfcdc07b79e9242827bae4b71d1b71`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:165b3efc2ea87f73a478267416cbb46250c77aa80a41cc4754147e2d6676d7d3`  
		Last Modified: Wed, 24 Apr 2024 12:19:56 GMT  
		Size: 26.3 MB (26293561 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44e5022b1b6144b2be9d0ed34087e233594889ca80d2f01075497d231476f49d`  
		Last Modified: Wed, 24 Apr 2024 12:19:56 GMT  
		Size: 29.8 MB (29769522 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5acc684500e08b08878e1f4a25d97769212a00a272ca7692a28dcf0c4d529325`  
		Last Modified: Wed, 24 Apr 2024 12:19:51 GMT  
		Size: 363.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28eaa158d6d7af239ad039da63b292b9c618d62172b17f01b6561bcc5168539c`  
		Last Modified: Wed, 24 Apr 2024 12:19:51 GMT  
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ff29cf7359d93494b1dca42f18794e6bec6a5ad7b34885e9a84484ff6df5374`  
		Last Modified: Wed, 24 Apr 2024 12:19:54 GMT  
		Size: 25.6 MB (25644131 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be105a654617e221f08c4138a67a7d7d95d6a5808ea6981aafeff94352aa29b3`  
		Last Modified: Wed, 24 Apr 2024 12:19:51 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:446d44749ec213214d20005a21ca1d43f7efc7832a90858226fdfdb711a6d267`  
		Last Modified: Wed, 24 Apr 2024 12:19:51 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:44f7023858f02ca68b67b604f01ac5d0018d937d5d37afad9595633f83df839d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.3 MB (256323687 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f553164ce85c1295c33c9ca331b93c340174d8e75232c9f08ce745d41e01f42a`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Apr 2024 21:47:46 GMT
VOLUME [/var/www/html]
# Tue, 16 Apr 2024 23:00:06 GMT
ENV JOOMLA_VERSION=4.4.4
# Tue, 16 Apr 2024 23:00:06 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Tue, 16 Apr 2024 23:00:15 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 16 Apr 2024 23:00:15 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 16 Apr 2024 23:00:16 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 16 Apr 2024 23:00:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 16 Apr 2024 23:00:16 GMT
...
-	Layers:
	...
	-	`sha256:e9f58bcec2d6ad23685ebe932e3d15d66666cf1b0257d6f5aacaea794a1c9dd0`  
		...
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d8677b6d22307e01e36d4dea0c4fdaa0f8d073c535086dd62a8a57ef3d272f4`  
		Last Modified: Tue, 16 Apr 2024 23:06:31 GMT  
		Size: 25.6 MB (25644092 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea1359543b7b0da9e42d9a9f5956c280867f4677c45592f61f7e5448cb30911a`  
		Last Modified: Tue, 16 Apr 2024 23:06:24 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:df42fe30d2abd66f339986151242ffe64c3ae01a3ad4e0604ada79c55b35f20a`  
		Last Modified: Tue, 16 Apr 2024 23:06:24 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:fce53e39c5ff69ff0ec450477a762c16671b8832ba5d75be248721e15fb1b95d
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.7 MB (229729565 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d83deba717f4e697de6a92dc9be4046c1d2125e0bd452637f311cfdd790030c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Tue, 16 Apr 2024 23:17:48 GMT
ENV JOOMLA_VERSION=4.4.4
# Tue, 16 Apr 2024 23:17:52 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Tue, 16 Apr 2024 23:18:29 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 16 Apr 2024 23:18:37 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 16 Apr 2024 23:18:43 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 16 Apr 2024 23:18:49 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 16 Apr 2024 23:18:56 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:129146ee296c5fb96a31ee9867e85f65bdd05df18b607d9ef494984b78ae1cd5`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6121fc606ac6a19f29867ff25ddb5e16aa5acb5e6cfc5c0bd1880f6b76254b66`  
		Last Modified: Tue, 16 Apr 2024 23:25:48 GMT  
		Size: 25.6 MB (25644910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4fff92dac02be8ebe9e83f2a5f00b2794e7cd27b903f078e5c2ecf5b127b9d82`  
		Last Modified: Tue, 16 Apr 2024 23:25:29 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:086255dd7b4509a55e9cbe3d642f5ba43291b4be1256dde6f470eb7721e6e694`  
		Last Modified: Tue, 16 Apr 2024 23:25:29 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:d4bb994f7c1d3e019c5921db7ff0fe194cc2b0e456ecee43156f89000d84b7d3
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **263.1 MB (263131101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e173eecb39814e4b8b6b4b19fefb99f669af1d8349cd7180704b06dca8497f82`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Thu, 11 Apr 2024 20:16:09 GMT
VOLUME [/var/www/html]
# Tue, 16 Apr 2024 23:27:28 GMT
ENV JOOMLA_VERSION=4.4.4
# Tue, 16 Apr 2024 23:27:28 GMT
ENV JOOMLA_SHA512=782469e12a7e6ceb719e4fca5e839d1bd5e475b2b3a932a4262ecc51b2585e94dede017021b5075b2e36c2687b27a82350064b5cc74fb27761987cff55e8637f
# Tue, 16 Apr 2024 23:27:37 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.4/Joomla_4.4.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 16 Apr 2024 23:27:40 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 16 Apr 2024 23:27:40 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 16 Apr 2024 23:27:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 16 Apr 2024 23:27:41 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:b00e98942fe1cae91b1cbe2bc538dbb87a7c6b53f9d7f174da8a4067d38ec8a8`  
		...
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76882f1c7af8010aa5d7bf4069f2b019cb2694e08485139d8192345a1155c54f`  
		Last Modified: Tue, 16 Apr 2024 23:33:29 GMT  
		Size: 25.6 MB (25644082 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ad25d486c68fe13139be9e455ac22b6b75da2d92c4b5020abe9d4fbb434cc96`  
		Last Modified: Tue, 16 Apr 2024 23:33:25 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f796957ec015837e7e75c0626498dadd688eab78e7667fe566080debbb033133`  
		Last Modified: Tue, 16 Apr 2024 23:33:25 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
