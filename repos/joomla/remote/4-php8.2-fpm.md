...
```console
$ docker pull joomla@sha256:52926b04571a2ef8d1be025d7a0f753f5d1a03c505fd649d63d7b968137d95aa
```
...
```console
$ docker pull joomla@sha256:f4a36c94900d082b5af5afdd00881b5b3145f0f49ea882a7ed7ea2c40d25b09a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **201.9 MB (201875171 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ac83b69ebece33053ca48ff901a8526b7aa0f03f7246369837ccdb09f91d3c8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:0a8967a66120dc4088744d6a5e9510d1a264726d9fd5b57a7d9a4c6a9bb05a65`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c5d033d6d91e513868ea4d271ee292a5b6ad2fb5f84216f43800fab80274e1b`  
		Last Modified: Wed, 04 Oct 2023 22:52:34 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac835e3b5d7235d1d3f92cafa28946364f684a7515b043933826cb02eb5cc62c`  
		Last Modified: Wed, 04 Oct 2023 22:52:34 GMT  
...
```console
$ docker pull joomla@sha256:679f7eecad763c39ef1337ab8b4806fc708880156f4343d0c6f4ac2c9c870b05
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.2 MB (222167710 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0dc18c1af803e9d5a9f9db0fdddb945570a69c15f1b74a3f6447e0772e85e09`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 04 Oct 2023 22:51:40 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Wed, 04 Oct 2023 22:51:41 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 04 Oct 2023 22:51:41 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 04 Oct 2023 22:51:41 GMT
...
-	Layers:
	...
	-	`sha256:f5861479888ecabc1aceaa31386b7bcbdc149a9131d0d1523559e77649b5e813`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:64b210878d8ac05d587672684b8307104c157c3123a23b6e22da773ee0f039aa`  
		Last Modified: Wed, 04 Oct 2023 23:01:52 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d28327c3c6eff63641e5cdfd1195b5b6dccb01b3487734e012307fd659604a9a`  
		Last Modified: Wed, 04 Oct 2023 23:01:52 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:60ba069e29dc095c4ce2162808c1187cb4167e56a89f46803b9259300e694f99
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.7 MB (227668768 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e9b5e41723298bceeeb031833025e5cc947ece3c440bfe913f2cef10879a58b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 04 Oct 2023 22:58:49 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Wed, 04 Oct 2023 22:58:49 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 04 Oct 2023 22:58:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 04 Oct 2023 22:58:50 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:d9105c49ea9ebf38b8aaaa0e921756b336755124dbfccd2925654893c643c5e4`  
		...
		Size: 25.1 MB (25051735 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62591c5d907823266c6328ddca742b065b4d43d49a50f04cc65fcfbfcc668a28`  
		Last Modified: Wed, 04 Oct 2023 23:10:01 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:052699fd1d943ff96000f4b30817477ec4ff6f7cdfab64e9d9228867276d1c3a`  
		Last Modified: Wed, 04 Oct 2023 23:10:01 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
