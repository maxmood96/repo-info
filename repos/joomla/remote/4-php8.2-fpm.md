...
```console
$ docker pull joomla@sha256:1bbfbeaf2ae396011e35c13941f80bdfd73d3e2e2522efecfc8fc9221da8bc20
```
...
```console
$ docker pull joomla@sha256:3fc5327087dbea6510d80119e3e710b17dda610617c4616b2e0908679263ece8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **192.8 MB (192787190 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e04c51ffe65490a794158ee61cf0673d6c952da1260ca99bb58b7600177ac71b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
-	Layers:
	...
	-	`sha256:08472a4251b1c9c95a7769996aac373d4b3cc14f4aa96b164f5080db60c8d65e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9021c427b6218cfed29b6d0e948d2f32f74cc08d6ff3db2bd0795f45eaca5eda`  
		Last Modified: Sat, 20 Jan 2024 02:41:30 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9752164d9644c03699c8c546f72c3dae7d0414e5f03dc7571ff0c4a3907046a3`  
		Last Modified: Sat, 20 Jan 2024 02:41:30 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:e7f1c20fcedf6e0c27f497bd5432e5bd130afb238bf803e1750a78ab423c9aba
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.6 MB (203634185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3345b7bbb645b394c6804e614bacf202a1f87c7370f257c8eb66cd7d9b25988`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.2/Joomla_4.4.2-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 20 Jan 2024 06:14:35 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Sat, 20 Jan 2024 06:14:40 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 20 Jan 2024 06:14:47 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 06:14:54 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:e2274090f4ec06e69ff7987a07fdca59bb021dfe0527ce32d520734777b7491a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c3f3e36b23b0f5bacf0129452c734215eacc0a506c2dad0153b658290ca5680a`  
		Last Modified: Sat, 20 Jan 2024 06:21:39 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5a7972369c81bad71927fc56fefa59fbb3aeb5de399778b297d7702f75569c84`  
		Last Modified: Sat, 20 Jan 2024 06:21:39 GMT  
...
```console
$ docker pull joomla@sha256:d30b367d1341496a3fe104e7c6c2ac3d1bbdf6e3998bf591d19af05a6d984c91
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **234.5 MB (234506507 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c0ff6009e0ad9446ef872639d300adb0378b815422dbddb3a9fe20a940028174`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.2/Joomla_4.4.2-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 20 Jan 2024 01:14:06 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Sat, 20 Jan 2024 01:14:06 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 20 Jan 2024 01:14:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 01:14:08 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:98bb0cca3d8ff0a6e16c09144e384caa2351ed84be79589bddc6649beb713395`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a451df26792984a334b23f78bbc6403bead4e06882b7c1a0f810d54ba4cdd985`  
		Last Modified: Sat, 20 Jan 2024 01:18:24 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d46e244cdf7d9d6d4b77596843d527b4773d461929c51438c1d5a505721cc7d`  
		Last Modified: Sat, 20 Jan 2024 01:18:24 GMT  
		Size: 1.1 KB (1062 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:7cf3744d81de8e5a85c6b22d1f0e2e441a6dc781ece34a0f810a8f206f42ca7c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.5 MB (202540744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ffd0a2d7401c0c50641911b0d1e60bdd07553e19180fba5bbb57ede75750dab8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.4.2/Joomla_4.4.2-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 20 Jan 2024 04:02:03 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Sat, 20 Jan 2024 04:02:03 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Sat, 20 Jan 2024 04:02:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 20 Jan 2024 04:02:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:87eefa2111d91d197c956a77f3d107b1cfec0d3297114edb7f35fb3d901faafe`  
		...
		Size: 25.4 MB (25444765 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a5d064bd7baed324d4681e93e2c984260c55d56c3590639fb9a4d751ae636ec7`  
		Last Modified: Sat, 20 Jan 2024 04:13:32 GMT  
		Size: 2.6 KB (2619 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:100940161f93f45e1219bb771eb555845e4e5458d2a6d40b5a5660a0bcac76b0`  
		Last Modified: Sat, 20 Jan 2024 04:13:32 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
