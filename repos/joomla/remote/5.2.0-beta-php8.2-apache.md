...
```console
$ docker pull joomla@sha256:68a412ddf85c1e90abad4f8248b1e4a9f6e207c16ef6df68a9a56d5458511896
```
...
```console
$ docker pull joomla@sha256:341a135b1bd8a7c834d578dcf27ae2779b7da4b1293e555b397009b9556ea646
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.5 MB (231472341 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8836d51ffc65c54d5fce408610cbdc618f7217bb4cb03d38fb5cb2ac2c037da4`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Sat, 31 Aug 2024 03:46:07 GMT
ENV JOOMLA_VERSION=5.2.0-beta1
# Sat, 31 Aug 2024 03:46:12 GMT
ENV JOOMLA_SHA512=ba0a8a84acd1c603766dbd8ca08e6aeb84c223b762fb73a98385357ba959eaaa27eb798a1b73ed082941163da110e84c103be5a94c0c48f32248cd795e00e8a7
# Sat, 31 Aug 2024 03:46:39 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 31 Aug 2024 03:46:48 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 31 Aug 2024 03:46:54 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 31 Aug 2024 03:47:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 31 Aug 2024 03:47:09 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:ce5e2a35e59787c6fc2cbc3852628557f5eba5cd6fdd6b8feb90b7ea28251d99`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:241913a69d0f883f00a288ee390b2e5c72dbe5f2bf2030797ed6697a3668eb9e`  
		Last Modified: Sat, 31 Aug 2024 05:08:50 GMT  
		Size: 23.4 MB (23366033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b3d7d5a62ed7de231c1c75f9d0815edf0324bb9428b314c8d4354273896a825`  
		Last Modified: Sat, 31 Aug 2024 05:08:20 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:62ece932d99b23d614d3584d18034c222ea391f0074636d00f75596a8e733758`  
		Last Modified: Sat, 31 Aug 2024 05:08:20 GMT  
