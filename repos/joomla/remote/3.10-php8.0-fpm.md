...
```console
$ docker pull joomla@sha256:e8b9da9e13d03fc8b01597e04863c0ceeea562885c2d706d26e22f6d6611c247
```
...
```console
$ docker pull joomla@sha256:b2c2f5892c06a7b6ec693110ce4828cb01a374f4d167a444366ec7f05456b16a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.1 MB (202145461 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57e99a790b132a8e392b8f78af02a2c6051354177a97cab9b87a5943e78a1334`
...
# Wed, 01 Mar 2023 13:09:08 GMT
CMD ["php-fpm"]
# Thu, 02 Mar 2023 01:38:39 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Thu, 02 Mar 2023 01:38:39 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 02 Mar 2023 01:38:47 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Thu, 02 Mar 2023 01:51:09 GMT
...
-	Layers:
	...
	-	`sha256:fa22ef0a46972b27e9921b1158832e96b4fc1a8db5e2a6981bd1bbc28b34caeb`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:11a31637313a4f4627eb8996d1b26081512266c89b2941846a455d10d21220ef`  
		Last Modified: Thu, 02 Mar 2023 01:53:14 GMT  
		Size: 19.1 MB (19100299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3499c2ce5604f955cbe283d850feded35afc1a2767be4142d88ddbe0cd1d5442`  
		Last Modified: Thu, 02 Mar 2023 01:55:03 GMT  
		Size: 13.2 MB (13165064 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:49e5e0450029e421ed6875a409da9d1067c31e92d13c515551698443e211c297`  
		Last Modified: Thu, 02 Mar 2023 01:54:58 GMT  
		Size: 376.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1868165563e249a0470864b4d73083966009e2fca063bdea7998e85615c55bc1`  
		Last Modified: Thu, 02 Mar 2023 01:54:58 GMT  
		Size: 392.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c74aa0f536612eedfb0e8fc08d7fc90303cd490f49a928ddcd1840cdbef4d549`  
		Last Modified: Thu, 02 Mar 2023 01:55:01 GMT  
		Size: 9.7 MB (9727086 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:595f6f4c4264153bb009f23102f1395fe36bda2e19d2a1829edb351110095e91`  
		Last Modified: Thu, 02 Mar 2023 01:54:58 GMT  
		Size: 1.8 KB (1823 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab3ab0cdd34f313783a2e3b5bcf160f98245d01ab335ceb74d4074413b10870d`  
		Last Modified: Thu, 02 Mar 2023 01:54:58 GMT  
		Size: 721.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:6d294c7672c96042913f4ed6174f829bdcf30dc2ded728b5b0b0e6da234d1038
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **177.3 MB (177339940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f86accadf31fe79240dbf2d96508e0306a37b064f1268ee7e3bb60d4f8ba4827`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 01 Mar 2023 14:27:39 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.6.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.21; 	pecl install memcached-3.2.0; 	pecl install redis-5.3.7; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Wed, 01 Mar 2023 14:27:40 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 		echo 'opcache.fast_shutdown=1'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Wed, 01 Mar 2023 14:27:40 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Wed, 01 Mar 2023 14:27:40 GMT
VOLUME [/var/www/html]
# Wed, 01 Mar 2023 14:27:41 GMT
ENV JOOMLA_VERSION=3.10.11
# Wed, 01 Mar 2023 14:27:41 GMT
ENV JOOMLA_SHA512=2c7db516ea07fa869cfff0ee01c9d141a8ac513c8040db6502e111a3d34cc681f6fee033006eeff0aa7f507a30280276c68af61c4d7595166bf9fd57728a9b44
# Wed, 01 Mar 2023 14:27:46 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/3.10.11/Joomla_3.10.11-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 01 Mar 2023 14:27:47 GMT
COPY file:0606560d4086c1b747df5afb8b84de5e317d50368eb37b8af3407cb091e8cae8 in /entrypoint.sh 
# Wed, 01 Mar 2023 14:27:48 GMT
COPY file:1462a25aec948bc277b1371aaf3aa304bc9427dd018b0df243093decbe0bcba6 in /makedb.php 
# Wed, 01 Mar 2023 14:27:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 01 Mar 2023 14:27:48 GMT
...
-	Layers:
	...
	-	`sha256:963de7f87664f56f371bd2337b6617f5b3b4d092076f30881c07fdb6bc6f5d6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c5f3bbdc57b77d4043a44915046c409bde68e8bd60da5d9b45e8daa0939f809`  
		Last Modified: Wed, 01 Mar 2023 14:31:50 GMT  
		Size: 11.1 MB (11132737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d1bd49679449e3cca120f11fc285c11da926f3c261c62dea82edfb05f51908ce`  
		Last Modified: Wed, 01 Mar 2023 14:31:48 GMT  
		Size: 373.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3ab34e9bbac52c99d774abc5edf8b19c17b2115d8d91c91381be8a610790022a`  
		Last Modified: Wed, 01 Mar 2023 14:31:48 GMT  
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4adbfa056d17e4a31f592061afe513b843f32140ed85960fb79861ed6fdf31a1`  
		Last Modified: Wed, 01 Mar 2023 14:31:49 GMT  
		Size: 9.7 MB (9727076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0246a7f89d2f2ce577ddd0fd90f63e70c1701a3d63aebfc0c44468912c24f590`  
		Last Modified: Wed, 01 Mar 2023 14:31:48 GMT  
		Size: 1.8 KB (1827 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0c560ec315838447e1b4de47b9cc9b0b4135e594cf261e1aaa5b733fdb392b0`  
		Last Modified: Wed, 01 Mar 2023 14:31:48 GMT  
		Size: 725.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
