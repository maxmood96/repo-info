...
### `joomla:6.0-php8.4-apache` - linux; amd64
...
### `joomla:6.0-php8.4-apache` - unknown; unknown
...
### `joomla:6.0-php8.4-apache` - linux; arm variant v5
...
### `joomla:6.0-php8.4-apache` - linux; arm variant v7
...
### `joomla:6.0-php8.4-apache` - linux; arm64 variant v8
...
### `joomla:6.0-php8.4-apache` - linux; 386
...
### `joomla:6.0-php8.4-apache` - linux; ppc64le
...
### `joomla:6.0-php8.4-apache` - linux; riscv64
...
### `joomla:6.0-php8.4-apache` - linux; s390x
