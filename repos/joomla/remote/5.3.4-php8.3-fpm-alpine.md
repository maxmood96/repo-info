...
```console
$ docker pull joomla@sha256:697f4fbb1612ff1d4a6ed652442462727c8ac969901ee56377e2c234b1889d90
```
...
### `joomla:5.3.4-php8.3-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.3.4-php8.3-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.3.4-php8.3-fpm-alpine` - linux; 386
...
### `joomla:5.3.4-php8.3-fpm-alpine` - linux; ppc64le
...
### `joomla:5.3.4-php8.3-fpm-alpine` - linux; s390x
