...
```console
$ docker pull joomla@sha256:c5eec4a30bad48ff98ee158f4b7d5f0ea67b6c1165ad406eda0c07ace07f8cb0
```
...
```console
$ docker pull joomla@sha256:f99c78ff8fd15ecacc38a1ad5c87fba6916de2b6d8ad3f1155a6de8965e9a01e
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **151.1 MB (151056762 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0579f1c8185d332f90ef93d13bd550cdc82011ea384676efda7496b9a3feb5da`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
ENV JOOMLA_SHA512=72ad71d7bf560b8ad744830b7f600ecdf72eb154984ee3934725fe05d4d5982f88b26707ac09bc8457c69f20118e4b3ad8028bee6446e666a40c7a7e7fcaeb7a
# Thu, 21 Oct 2021 20:38:09 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Oct 2021 20:38:10 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 21 Oct 2021 20:38:11 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 21 Oct 2021 20:38:11 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Oct 2021 20:38:12 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1380e5f7cc111903b6fd49ccbc044736e5e73ddf615183c73708457d8a2a4aa4`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:998575bbcd0211db58d4983973932bda6aa71ea67a025522b0f533641a11f545`  
		Last Modified: Thu, 21 Oct 2021 20:59:26 GMT  
		Size: 9.7 MB (9677349 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8f5cac7293286ad4fd26426e40e82a9a0bea0f97b5122100e76fd3ce27624d57`  
		Last Modified: Thu, 21 Oct 2021 20:59:12 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:455e1a0c9731a079e7de197211ffd2c431779f547988f93498e8a64eea359cb6`  
		Last Modified: Thu, 21 Oct 2021 20:59:13 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:4ceba764870e5138bed2f3a5a768adfe98a3cf6928cdf6d313ac9d49dc751f85
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **182.7 MB (182723554 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3e462b8e35d3fbae5416e2591688e83185e52a0f20672605b9e11b16b6f10d2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Thu, 21 Oct 2021 22:48:17 GMT
ENV JOOMLA_VERSION=3.10.2
# Thu, 21 Oct 2021 22:48:25 GMT
ENV JOOMLA_SHA512=72ad71d7bf560b8ad744830b7f600ecdf72eb154984ee3934725fe05d4d5982f88b26707ac09bc8457c69f20118e4b3ad8028bee6446e666a40c7a7e7fcaeb7a
# Thu, 21 Oct 2021 22:48:40 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 21 Oct 2021 22:48:46 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 21 Oct 2021 22:48:48 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 21 Oct 2021 22:48:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 21 Oct 2021 22:48:56 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:0122e2262f669d0e7ed54acee4a7f984c7c1ea86e5f81ee1956f428f5094d281`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19fb48b71a91de614e00aef0556b42377d48de93f4a6da01e1495b95a454df12`  
		Last Modified: Thu, 21 Oct 2021 23:04:54 GMT  
		Size: 9.7 MB (9677339 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe52be5a58fbc53f8e77b6576f95bb1dfec13a453962ffbb1d19c71ee67358b1`  
		Last Modified: Thu, 21 Oct 2021 23:04:51 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fb46a06fb62f2d34bf780179f75655fa1e8f679041e9374cf22df39a026dc4d7`  
		Last Modified: Thu, 21 Oct 2021 23:04:50 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
