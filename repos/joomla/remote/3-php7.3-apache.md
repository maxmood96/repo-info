...
```console
$ docker pull joomla@sha256:6a252f4bf93214b1a8d2915140f91c5399c0e77fb88bdc50cc066769dda4f6c3
```
...
```console
$ docker pull joomla@sha256:19b2aab6da0d1a6d195831c01b9e0a00b04302673cbec8e845092fb8c1a5872d
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.6 MB (159639766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a151def4895efec8eef9834be2a726cc81d95a5eff8b114f7c2c36e092c364d8`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Wed, 06 Oct 2021 17:55:50 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 06 Oct 2021 17:55:50 GMT
VOLUME [/var/www/html]
# Wed, 06 Oct 2021 17:55:51 GMT
ENV JOOMLA_VERSION=3.10.2
# Wed, 06 Oct 2021 17:55:51 GMT
ENV JOOMLA_SHA512=72ad71d7bf560b8ad744830b7f600ecdf72eb154984ee3934725fe05d4d5982f88b26707ac09bc8457c69f20118e4b3ad8028bee6446e666a40c7a7e7fcaeb7a
# Wed, 06 Oct 2021 17:56:05 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 06 Oct 2021 17:56:06 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 06 Oct 2021 17:56:07 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Wed, 06 Oct 2021 17:56:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 06 Oct 2021 17:56:07 GMT
...
-	Layers:
	...
	-	`sha256:98f6c708bf8a8b872f4e95b96a914ee58e24572383508b9d51c4af46b0908b4f`  
		...
		Size: 314.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc21478d4a7d69a91d812849d16cfae14baf62f59c5563882d39470e2311a0dc`  
		Last Modified: Wed, 06 Oct 2021 18:06:31 GMT  
		Size: 2.9 MB (2884947 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35dfcf8812346c3a2c327392d527ed61ad1f907bb4547512952dfd098dbab591`  
		Last Modified: Wed, 06 Oct 2021 18:06:39 GMT  
		Size: 9.7 MB (9677278 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9538b7c8dc545c6d3f149f5924056d0e86e568756534c585535a87f2e6f832ad`  
		Last Modified: Wed, 06 Oct 2021 18:06:28 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f05cc35a447e5c096ed29201f2af3b35318c17050cc352eb38f0e4db9a082baa`  
		Last Modified: Wed, 06 Oct 2021 18:06:28 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:66e5ff40778c6a458936fe021046b81583be33d6276f620ab0da8f7d3953ba77
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **183.3 MB (183265098 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4080bcc48d86cda4c5019d471b1b40ed260862c84d3fc7bfa50392a4e0774a3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN a2enmod rewrite
# Wed, 06 Oct 2021 12:04:32 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Wed, 06 Oct 2021 12:04:36 GMT
VOLUME [/var/www/html]
# Wed, 06 Oct 2021 12:04:40 GMT
ENV JOOMLA_VERSION=3.10.2
# Wed, 06 Oct 2021 12:04:44 GMT
ENV JOOMLA_SHA512=72ad71d7bf560b8ad744830b7f600ecdf72eb154984ee3934725fe05d4d5982f88b26707ac09bc8457c69f20118e4b3ad8028bee6446e666a40c7a7e7fcaeb7a
# Wed, 06 Oct 2021 12:04:57 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 06 Oct 2021 12:05:01 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Wed, 06 Oct 2021 12:05:04 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
...
-	Layers:
	...
	-	`sha256:044b72f7f36fa77f74cbe3c14566afb3051b376b6ac55373596f2f107972f71b`  
		...
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:09b1025f553822ebcb372709ffc61b2246871016b68582e3863739f107aa0a48`  
		Last Modified: Wed, 06 Oct 2021 12:15:40 GMT  
		Size: 3.2 MB (3150033 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0b77309722b5d40d8da5950691933362f6fa779e247b7c414ee62db0120c7c0`  
		Last Modified: Wed, 06 Oct 2021 12:15:42 GMT  
		Size: 9.7 MB (9677330 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7969b6aaf918cddfd4c2aa7f912418d68e852fc0553ee50a7e1262d04d9b0134`  
		Last Modified: Wed, 06 Oct 2021 12:15:39 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6306da305ec83ca93c6a3c6e018dde5ebcf51a88c810587523564e14d7104d94`  
		Last Modified: Wed, 06 Oct 2021 12:15:39 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:3d4948a82579fdcfd5c1caaf0b7e279fafcaa2a211a1281492283c8d3caf91ac
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **159.2 MB (159210383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8b1e36edd82aefc799ed93c8c7ddca807c9a1284c6f5848f2202b375ae4c0cbe`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 28 Sep 2021 15:25:47 GMT
RUN a2enmod rewrite
# Thu, 07 Oct 2021 18:58:52 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg-dir=/usr --with-png-dir=/usr; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.21; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Thu, 07 Oct 2021 18:58:52 GMT
VOLUME [/var/www/html]
# Thu, 07 Oct 2021 18:58:52 GMT
ENV JOOMLA_VERSION=3.10.2
# Thu, 07 Oct 2021 18:58:53 GMT
ENV JOOMLA_SHA512=72ad71d7bf560b8ad744830b7f600ecdf72eb154984ee3934725fe05d4d5982f88b26707ac09bc8457c69f20118e4b3ad8028bee6446e666a40c7a7e7fcaeb7a
# Thu, 07 Oct 2021 18:58:56 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 07 Oct 2021 18:58:58 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Thu, 07 Oct 2021 18:58:58 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 07 Oct 2021 18:58:58 GMT
...
-	Layers:
	...
	-	`sha256:4ef86364e14149410eba07860274d9c584a50590a196ab411160cc6fb5b59394`  
		...
		Size: 309.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c3ab698793950f89fa38d191690e430d37911bb8b5fca2bcdddb48b36dd175b`  
		Last Modified: Thu, 07 Oct 2021 19:06:24 GMT  
		Size: 2.9 MB (2905172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:022d5725eb11f7eea3fcbb7fceddf57d892ca4cb13b42b9c27b3b200ee5eeb9e`  
		Last Modified: Thu, 07 Oct 2021 19:06:25 GMT  
		Size: 9.7 MB (9677347 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3040b17aa9a6ff3d9ac641db4f35e12d5c3c0c42f81e45f4b0a9fd1b8afea22b`  
		Last Modified: Thu, 07 Oct 2021 19:06:24 GMT  
		Size: 1.2 KB (1200 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d766eeb1e9e2f345ce4432ebce9f3516d8d219e0d5659699a4aeb378b696b57`  
		Last Modified: Thu, 07 Oct 2021 19:06:24 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
