...
```console
$ docker pull joomla@sha256:41c82f72d0b8a1b6a4cb9058d383add04f13f3de45b611799fa99942d78bcb3e
```
...
```console
$ docker pull joomla@sha256:ee76290388827a68c66424f436d70e1c012f55fab9be14d71dd628f2e071bbf8
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.1 MB (231095989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ed06d27d336e0830d336858f2ec6c49af518fe7b330f1fb356e7402ca1aa447c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
VOLUME [/var/www/html]
# Tue, 12 Mar 2024 23:51:12 GMT
ENV JOOMLA_VERSION=5.0.3
# Tue, 12 Mar 2024 23:51:16 GMT
ENV JOOMLA_SHA512=5fa4a0fdae08f8ea71216337b02f4f8dcf75b8d001fc82c0987041844cc263e78ca8244a0fbbc4a3e53055c8e09a1533464d90ea118ebd79b2b1b972807c532e
# Tue, 12 Mar 2024 23:51:45 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.3/Joomla_5.0.3-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 12 Mar 2024 23:51:54 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 12 Mar 2024 23:52:00 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 12 Mar 2024 23:52:07 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 12 Mar 2024 23:52:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:5e7cb3c0c9c7dad567d8d32cae63952ded12961028e85896447dd957ad34ea89`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaa15045fd2426f7499ae00f8d2f49cb99bf3228ed5b05385365c93df0e43c4a`  
		Last Modified: Wed, 13 Mar 2024 01:00:13 GMT  
		Size: 22.5 MB (22522364 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6ae4afba1776e92590b99545206ca25bdca256d4eb35d195091a10d88faed3e6`  
		Last Modified: Wed, 13 Mar 2024 00:59:52 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eec615eff1a77fec4edd87f3899f487cdd69b1534b97a2667cf4c87f063833fc`  
		Last Modified: Wed, 13 Mar 2024 00:59:52 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
