...
```console
$ docker pull joomla@sha256:36b41b44f477a0e1dd2c933deea226f0f9c74c74de8e6c1168a183555f4f7d5b
```
...
```console
$ docker pull joomla@sha256:f460677b5c0223bda12f68fa398d9c8c5d0cd1f7286740a3b29644e14fed5d19
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.7 MB (217685724 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fad9eb083968039c8557fc0e3cffc69184923fc3966e13a1c56de07d64a3a7e3`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 10 Apr 2024 23:02:08 GMT
VOLUME [/var/www/html]
# Wed, 10 Apr 2024 23:09:31 GMT
ENV JOOMLA_VERSION=5.0.3
# Wed, 10 Apr 2024 23:09:31 GMT
ENV JOOMLA_SHA512=5fa4a0fdae08f8ea71216337b02f4f8dcf75b8d001fc82c0987041844cc263e78ca8244a0fbbc4a3e53055c8e09a1533464d90ea118ebd79b2b1b972807c532e
# Wed, 10 Apr 2024 23:09:39 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.3/Joomla_5.0.3-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Wed, 10 Apr 2024 23:09:40 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Wed, 10 Apr 2024 23:09:40 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Wed, 10 Apr 2024 23:09:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Wed, 10 Apr 2024 23:09:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:dd21b5879b7f7361fa3c1956ffa8c50b9832a5b6b6e5316cb2932587afcc7294`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:481e281bda3ec5a0f5e57521bbf4a29da44b76fc49de756029aec5429a5df0f5`  
		Last Modified: Wed, 10 Apr 2024 23:29:37 GMT  
		Size: 22.5 MB (22521376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d69dc1433852a36d5ef18221f5b93d0778c453e03b58eab163c524d0043abb51`  
		Last Modified: Wed, 10 Apr 2024 23:29:28 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:559ed45e92212426f6906a47384c8cb3de82145365c912fcdb5e6481394bf1c9`  
		Last Modified: Wed, 10 Apr 2024 23:29:28 GMT  
		Size: 1.1 KB (1060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
