...
```console
$ docker pull joomla@sha256:c5bee90ab75660981df65689ca271bcb181eef09c49d7b91433ae3b08d986daf
```
...
```console
$ docker pull joomla@sha256:6b57a7dd1ea82002ab4f83da7e462adbed3c91f5fe89bbfa60532769e5b98a7a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.1 MB (229060026 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8daddb48b75e64e1e15e627bddca899dd22cc9fbb0dfcc472b891f3c80494d35`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 11:05:52 GMT
CMD ["apache2-foreground"]
# Tue, 13 Feb 2024 14:38:53 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Tue, 13 Feb 2024 14:38:53 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Tue, 13 Feb 2024 14:39:14 GMT
RUN set -eux; 	apt-get update; 	apt-get install -y --no-install-recommends 		ghostscript 		zstd 	; 	rm -rf /var/lib/apt/lists/*
# Tue, 13 Feb 2024 14:45:03 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libicu-dev 		libfreetype6-dev 		libjpeg-dev 		libldap2-dev 		libmemcached-dev 		libmagickwand-dev 		libpq-dev 		libpng-dev 		libwebp-dev 		libzip-dev 	; 		docker-php-ext-configure gd 		--with-freetype 		--with-jpeg 		--with-webp 	; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		bcmath 		exif 		gd 		gmp 		intl 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 	pecl install imagick-3.7.0; 	docker-php-ext-enable imagick; 	rm -r /tmp/pear; 		out="$(php -r 'exit(0);')"; 	[ -z "$out" ]; 	err="$(php -r 'exit(0);' 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]; 		extDir="$(php -r 'echo ini_get("extension_dir");')"; 	[ -d "$extDir" ]; 	pecl install APCu-5.1.23; 	pecl install memcached-3.2.0; 	pecl install redis-6.0.2; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$extDir"/*.so 		| awk '/=>/ { so = $(NF-1); if (index(so, "/usr/local/") == 1) { next }; gsub("^/(usr/)?", "", so); print so }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		! { ldd "$extDir"/*.so | grep 'not found'; }; 	err="$(php --version 3>&1 1>&2 2>&3)"; 	[ -z "$err" ]
# Tue, 13 Feb 2024 14:45:05 GMT
RUN set -eux; 	docker-php-ext-enable opcache; 	{ 		echo 'opcache.memory_consumption=128'; 		echo 'opcache.interned_strings_buffer=8'; 		echo 'opcache.max_accelerated_files=4000'; 		echo 'opcache.revalidate_freq=2'; 	} > /usr/local/etc/php/conf.d/opcache-recommended.ini
# Tue, 13 Feb 2024 14:45:07 GMT
RUN { 		echo 'error_reporting = E_ERROR | E_WARNING | E_PARSE | E_CORE_ERROR | E_CORE_WARNING | E_COMPILE_ERROR | E_COMPILE_WARNING | E_RECOVERABLE_ERROR'; 		echo 'display_errors = Off'; 		echo 'display_startup_errors = Off'; 		echo 'log_errors = On'; 		echo 'error_log = /dev/stderr'; 		echo 'log_errors_max_len = 1024'; 		echo 'ignore_repeated_errors = On'; 		echo 'ignore_repeated_source = Off'; 		echo 'html_errors = Off'; 	} > /usr/local/etc/php/conf.d/error-logging.ini
# Tue, 13 Feb 2024 14:45:10 GMT
RUN set -eux; 	a2enmod rewrite expires; 		a2enmod remoteip; 	{ 		echo 'RemoteIPHeader X-Forwarded-For'; 		echo 'RemoteIPInternalProxy 10.0.0.0/8'; 		echo 'RemoteIPInternalProxy 172.16.0.0/12'; 		echo 'RemoteIPInternalProxy 192.168.0.0/16'; 		echo 'RemoteIPInternalProxy 169.254.0.0/16'; 		echo 'RemoteIPInternalProxy 127.0.0.0/8'; 	} > /etc/apache2/conf-available/remoteip.conf; 	a2enconf remoteip; 	find /etc/apache2 -type f -name '*.conf' -exec sed -ri 's/([[:space:]]*LogFormat[[:space:]]+"[^"]*)%h([^"]*")/\1%a\2/g' '{}' +
# Tue, 13 Feb 2024 14:45:10 GMT
VOLUME [/var/www/html]
# Tue, 13 Feb 2024 15:09:58 GMT
ENV JOOMLA_VERSION=5.0.2
# Tue, 13 Feb 2024 15:09:59 GMT
ENV JOOMLA_SHA512=e7bc9ecab410217fdf91a87f9461ff18dab311af56c61156fb7cf076b2fdf270b003ffddf131386ef35c94cb9f4ada39f8a69712c07664147108268ab5cc85a3
# Tue, 13 Feb 2024 15:10:07 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.2/Joomla_5.0.2-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 13 Feb 2024 15:10:10 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 13 Feb 2024 15:10:12 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 13 Feb 2024 15:10:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 13 Feb 2024 15:10:14 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:3fd7751ed0a66f4c74c7d73fbe12d0201f456f86f81563ddfda238fee95350bb`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc678ef7786e35a33167692ff8361375eb10a29125187ec5b569b4107dab40e2`  
		Last Modified: Tue, 13 Feb 2024 15:36:43 GMT  
		Size: 26.6 MB (26616429 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea4da4e7613abc4349c3e3e28c6b53f282fd846bf4274a96040503d4b1706e9a`  
		Last Modified: Tue, 13 Feb 2024 15:36:47 GMT  
		Size: 28.7 MB (28682185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7e05d5d3f58cd12d15043baa0edfc2db0211ffa523b3554868ece5b1d2a2875a`  
		Last Modified: Tue, 13 Feb 2024 15:36:33 GMT  
		Size: 360.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d9b196dc774c3a2f57b94339fbc0b814237f0144d25f10d567649196e9a93e4`  
		Last Modified: Tue, 13 Feb 2024 15:36:31 GMT  
		Size: 391.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d75dda9cf5f2f0a2cd865c411cb900933b63f7e8d658e23e0a6913186aad8030`  
		Last Modified: Tue, 13 Feb 2024 15:36:31 GMT  
		Size: 19.2 KB (19160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78c093489b5dae46a7d820dc6899402a1c0d5737070cc4614ecd6e787c8ed005`  
		Last Modified: Tue, 13 Feb 2024 15:39:55 GMT  
		Size: 22.4 MB (22446778 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ef0823df6900e492d084192220b47d262abb07e9663f3ea12e7f101537683e5`  
		Last Modified: Tue, 13 Feb 2024 15:39:49 GMT  
		Size: 2.7 KB (2737 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96255704a2eb0907eee5f545b8d237373227a65c48861746eb792f5072e411fd`  
		Last Modified: Tue, 13 Feb 2024 15:39:49 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:64f6dc9c63f3fbb8d83a4a1f56b254a57dce8a8a979ebdbc9afd19fa27f8e495
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **217.6 MB (217579248 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b78a9fb34917dd2d25dc23ac8f9f005ac41b0ae0d2465fe798e9414a6cd0609`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Tue, 13 Feb 2024 19:42:02 GMT
VOLUME [/var/www/html]
# Tue, 13 Feb 2024 19:55:48 GMT
ENV JOOMLA_VERSION=5.0.2
# Tue, 13 Feb 2024 19:55:48 GMT
ENV JOOMLA_SHA512=e7bc9ecab410217fdf91a87f9461ff18dab311af56c61156fb7cf076b2fdf270b003ffddf131386ef35c94cb9f4ada39f8a69712c07664147108268ab5cc85a3
# Tue, 13 Feb 2024 19:55:53 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.0.2/Joomla_5.0.2-Stable-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Tue, 13 Feb 2024 19:55:54 GMT
COPY file:6dcb949f1bfc58f87c0887173eb61a91c7f9c1290655683ed002e25b7aeb694a in /entrypoint.sh 
# Tue, 13 Feb 2024 19:55:54 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Tue, 13 Feb 2024 19:55:54 GMT
...
-	Layers:
	...
	-	`sha256:56b02dda4e8c1161d4a3310261f6fe3be92f2d5c528dac38489e9079fbf0db7f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1dd310302a2bd03b4e3fd254e62bc84988c801a6ca8f29842682d6405db22940`  
		Last Modified: Tue, 13 Feb 2024 20:13:22 GMT  
		Size: 22.4 MB (22446776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d204b8de66e279b80aa34722721d6957679e262bc4d81703cd7e208312ed6d73`  
		Last Modified: Tue, 13 Feb 2024 20:13:13 GMT  
		Size: 2.7 KB (2738 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8964412368577897b2ffa2a0cb2b93b809fd22b69754b8def5aec295485cafff`  
		Last Modified: Tue, 13 Feb 2024 20:13:13 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
