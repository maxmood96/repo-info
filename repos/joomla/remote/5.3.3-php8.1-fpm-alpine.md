...
```console
$ docker pull joomla@sha256:05cd8126acf650ccd0b4fbce73ff10f9447acac76d7b3702d0b54a924b4fba7a
```
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; amd64
...
### `joomla:5.3.3-php8.1-fpm-alpine` - unknown; unknown
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; arm variant v6
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; 386
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; ppc64le
...
### `joomla:5.3.3-php8.1-fpm-alpine` - linux; s390x
