...
```console
$ docker pull joomla@sha256:10e4d062d5d5e495cb114f592c0eac7e52772f0ce6ca41ad1851d2416744545b
```
...
### `joomla:5.4.0-beta3-apache` - linux; amd64
...
### `joomla:5.4.0-beta3-apache` - unknown; unknown
...
### `joomla:5.4.0-beta3-apache` - linux; arm variant v5
...
### `joomla:5.4.0-beta3-apache` - linux; arm variant v7
...
### `joomla:5.4.0-beta3-apache` - linux; arm64 variant v8
...
### `joomla:5.4.0-beta3-apache` - linux; 386
...
### `joomla:5.4.0-beta3-apache` - linux; ppc64le
...
### `joomla:5.4.0-beta3-apache` - linux; s390x
