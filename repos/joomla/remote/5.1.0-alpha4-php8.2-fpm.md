...
```console
$ docker pull joomla@sha256:c7e9f229eb28a5ec0d5d93f35bb0e3b08f8670c7be57c90d0809eedfbe2e6e35
```
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; arm variant v5
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; mips64le
...
### `joomla:5.1.0-alpha4-php8.2-fpm` - linux; s390x
