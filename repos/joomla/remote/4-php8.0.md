...
```console
$ docker pull joomla@sha256:10665c18ec7c28a0c1bd74173506dc3e27c4db30628ab90c921e45e4bb0327a4
```
...
```console
$ docker pull joomla@sha256:7b205a6052417ea2b04750fbd9baec14db1ffeaa318a7bbcbc6d9d2d58649fb1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **188.1 MB (188137773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:abcbe89d0c5107fc053a96aa86a9b40631c60874346c2acb693bb5816964da1b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:f6ca12812065045c503025274ffec484fc4f34f234340e398229661d53fc9cc5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:804e32ba7aee9fdb17384302c14fdc96c77105b00b2d9a058073bec45d825d6d`  
		Last Modified: Thu, 21 Sep 2023 09:29:31 GMT  
		Size: 1.8 KB (1839 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:77945861aa32add69fbb558a6698558a71da52857bf31b15169bccd3b9d7ddfd`  
		Last Modified: Thu, 21 Sep 2023 09:29:31 GMT  
...
```console
$ docker pull joomla@sha256:077de272570a01755828ea759f99ee24d36720b669159ea5d4c16a2939f092f7
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.1 MB (196114465 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:efebf91ac8ac61cb1d711e02b745842e3cf4289b6c5b660170a16f3658a41d7c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 22 Sep 2023 00:37:01 GMT
COPY file:ef363e892ed567a09d21138100f211c7065e8869c035615041fd679aebad2d73 in /entrypoint.sh 
# Fri, 22 Sep 2023 00:37:07 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Fri, 22 Sep 2023 00:37:14 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 22 Sep 2023 00:37:20 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:73ba1aca8fd75d0745de7667c1d99dca6de69146c600188de235c90fe3359877`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a23ed0ccbd86d9bfe5029fb3f2af7c0958c2e39d1c2e5224ec98ff75204f3033`  
		Last Modified: Fri, 22 Sep 2023 01:19:42 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eb7a534c2e3fa24f2889613965c104f154fcb11241c0f0d6717e7a32cf8058d8`  
		Last Modified: Fri, 22 Sep 2023 01:19:42 GMT  
		Size: 1.1 KB (1063 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:7b0b1848e15fd41e573c0dd340b504c8929731caad74ca6d0486d7de406f84ee
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **222.5 MB (222496860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bc87911d0c89a2ec87c8ccc29a873966215b86922307ff907d16e8b3ba1a9ba6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
-	Layers:
	...
	-	`sha256:640670be0875e50aa3f1911818d7613da038a207ed3ec351cab77479cc5cb399`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bf1960063d112c7619ba9c208db491eca733abb658fdaf8c8fc9b187376e929c`  
		Last Modified: Thu, 21 Sep 2023 12:40:19 GMT  
		Size: 1.8 KB (1840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b2785c2822b22b3e9f3431fbe4e1f128acf5fff3ad6af7b44389b8c3e00dc73f`  
		Last Modified: Thu, 21 Sep 2023 12:40:19 GMT  
		Size: 1.1 KB (1061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
