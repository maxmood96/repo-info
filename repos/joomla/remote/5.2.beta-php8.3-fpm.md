...
```console
$ docker pull joomla@sha256:97b9f9a4f68b3157c66516de27677bcb63979ba8b22b80dd2d9120ab2bb2a7a3
```
...
```console
$ docker pull joomla@sha256:7a45dead4367785e0624491824be44a06ed6efae1d2a9f67e86bfd732798cd5d
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.0 MB (255010720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b629e45308c3555b1caa1e7af8308f935cd680b9f16c3e839fa713bd8be34ea`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 31 Aug 2024 00:16:26 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 31 Aug 2024 00:16:26 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 31 Aug 2024 00:16:26 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 31 Aug 2024 00:16:27 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8a3d6cabb8c3e338b6b11dabad1b191450942b3208e98c8bd3aecaa8560e340f`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:33c1f5d3982c06a22525b10d555fbab39e175b0211f7136e0dbff08382944ffe`  
		Last Modified: Sat, 31 Aug 2024 00:31:10 GMT  
		Size: 23.4 MB (23365817 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cdd2cc0bcc75f2996d7062bf00804f3a15cb060b7f956c140b1bed3069d256f1`  
		Last Modified: Sat, 31 Aug 2024 00:31:02 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:08af89e8bd58fe7bb899b67aab7446ba70afc4fc093b09748ce910bbf398c740`  
		Last Modified: Sat, 31 Aug 2024 00:31:02 GMT  
		Size: 1.1 KB (1068 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
