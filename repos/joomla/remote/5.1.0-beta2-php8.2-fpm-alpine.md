...
```console
$ docker pull joomla@sha256:bef9c9ca5e5e738bf3c92f2c9c3dd2642169490010f8da30bb9bf5f885376456
```
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; amd64
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; arm variant v7
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; arm64 variant v8
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; 386
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; ppc64le
...
### `joomla:5.1.0-beta2-php8.2-fpm-alpine` - linux; s390x
