...
```console
$ docker pull joomla@sha256:16d22eb2e315b798cf8d40ba5c9fc6d0e9310508c4a4f7db73da1253257037f3
```
...
```console
$ docker pull joomla@sha256:dfd1a1ec6038cb96d3931676fe19c655993d29887ef4c0f4a9df8c87351a029f
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **88.6 MB (88589819 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ecc67a44ea6bb07c61d4bc8bd5e662ab52f168f90aca13f057efbc430dbc9a15`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Fri, 02 Aug 2024 01:59:26 GMT
ENV JOOMLA_VERSION=5.2.0-alpha3
# Fri, 02 Aug 2024 01:59:26 GMT
ENV JOOMLA_SHA512=4d73b21c1ce7ed5261319c4d77531b67d223571b9c8cfa7cd208ac60cb521011abea96ed0ca90ffd8b70ef45497bffface336a7e11e0f932cb60072ab23e280b
# Fri, 02 Aug 2024 01:59:57 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-alpha3/Joomla_5.2.0-alpha3-Alpha-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 02 Aug 2024 02:00:02 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Fri, 02 Aug 2024 02:00:02 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Fri, 02 Aug 2024 02:00:03 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 02 Aug 2024 02:00:04 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:670872276b4a05c8f4fb9a9e2cb6fbc0b5f564c559f694b3f56b324731a0c1f7`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2851fddbceed116dca7a5acbc13cedd1763ef933855b75486022c82bce6a7bf3`  
		Last Modified: Fri, 02 Aug 2024 02:54:47 GMT  
		Size: 23.2 MB (23181435 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4f0f10b763b253260793831add03745948109164e46d2d9f712576fe943004be`  
		Last Modified: Fri, 02 Aug 2024 02:54:14 GMT  
		Size: 3.7 KB (3658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5636b2ad10228e94d5c4a5a99e710d8143fbda2ba1f87f974db75c2ef04da65b`  
		Last Modified: Fri, 02 Aug 2024 02:54:14 GMT  
		Size: 1.1 KB (1070 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
