...
```console
$ docker pull joomla@sha256:16ef9a4da9b192037fbd6d3faeffc2b1c513a0eac2d8f29a921d60d1cfc214ea
```
...
```console
$ docker pull joomla@sha256:a3b9c8b6228cd261eebaf617773b9dba3b6b121de448bb5848fa9c38a8913482
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.5 MB (89451052 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f06b967a743958234ba55dbeaba04fb6b394ce277c3717cd86ef84b78bc29072`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Sat, 31 Aug 2024 03:49:05 GMT
ENV JOOMLA_VERSION=5.2.0-beta1
# Sat, 31 Aug 2024 03:49:06 GMT
ENV JOOMLA_SHA512=ba0a8a84acd1c603766dbd8ca08e6aeb84c223b762fb73a98385357ba959eaaa27eb798a1b73ed082941163da110e84c103be5a94c0c48f32248cd795e00e8a7
# Sat, 31 Aug 2024 03:49:37 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-beta1/Joomla_5.2.0-beta1-Beta-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Sat, 31 Aug 2024 03:49:42 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Sat, 31 Aug 2024 03:49:43 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Sat, 31 Aug 2024 03:49:43 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Sat, 31 Aug 2024 03:49:44 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:8ba221f9a9e51ab95e53fcab76919ac7d8d14dba22182978b05657a8d7bac0f6`  
		...
		Size: 394.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cafd5ea508634f15a90697d10fa22b55db1edc25dea460ab2d6997be9df9e24d`  
		Last Modified: Sat, 31 Aug 2024 04:45:13 GMT  
		Size: 23.4 MB (23365873 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a80da9d0772ce21fb8516bd2540843b5a7871eaea8b25c6a13eb1994e6ff065`  
		Last Modified: Sat, 31 Aug 2024 04:44:41 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a2ed0a8126c672ae22187536e756e3bef13813d0c39d94d1cfe78064aa9cdbe9`  
		Last Modified: Sat, 31 Aug 2024 04:44:41 GMT  
		Size: 1.1 KB (1069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
