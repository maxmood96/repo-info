...
```console
$ docker pull joomla@sha256:cf7f61c7b5cee806ba4c55d3d3effb26a7150afa9fb1898b91fb1f5a8d2e3bb0
```
...
```console
$ docker pull joomla@sha256:ee6a61d71102d867fc2b13752f9946c3429200e81c06ff0d37decaca6e5d54ed
```

-	Docker Version: 23.0.11
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **89.6 MB (89644734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9aeb006667beba9038acb856514c7025b81409b8f666c2814b2f40615e5dd164`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 03 Oct 2024 00:25:22 GMT
ENV JOOMLA_VERSION=5.2.0-rc1
# Thu, 03 Oct 2024 00:25:23 GMT
ENV JOOMLA_SHA512=51dd71e8f58eeba4b86bbedcd8235780bdf5db73852261154d1a0f1b057bda4395be03a60b1173f8b82d791739c0ef224e5c203c8989c54d0c2e31b45fd41b00
# Thu, 03 Oct 2024 00:25:54 GMT
RUN set -ex; 	curl -o joomla.tar.zst -SL https://github.com/joomla/joomla-cms/releases/download/5.2.0-rc1/Joomla_5.2.0-rc1-Release_Candidate-Full_Package.tar.zst; 	echo "$JOOMLA_SHA512 *joomla.tar.zst" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar --zstd -xf joomla.tar.zst -C /usr/src/joomla; 	rm joomla.tar.zst; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 03 Oct 2024 00:25:59 GMT
COPY file:09d039f2ed0d8991a914126098661c6156e603362c75d72887a3d64c1ce9f866 in /entrypoint.sh 
# Thu, 03 Oct 2024 00:26:00 GMT
COPY file:a53a9770ec4ea12b0947f498a820c4cf00b42fbd01a84c1561849a4497baa065 in /makedb.php 
# Thu, 03 Oct 2024 00:26:01 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 03 Oct 2024 00:26:01 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:4c4c1f2fa43e65ca24a0c51aceae55d8da50e168cc342c5739ef431594fa00e1`  
		...
		Size: 393.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f0067c1464241939dbd2f2b22aa3adcc7abfde99cd2356f8ee32c665f22cfd88`  
		Last Modified: Thu, 03 Oct 2024 00:29:07 GMT  
		Size: 23.7 MB (23739118 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3189bf945ada5bd6e91c08bd4a7db2fbd334b5115d684ca7d412bae6e57370c0`  
		Last Modified: Thu, 03 Oct 2024 00:28:41 GMT  
		Size: 3.7 KB (3657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a9c8f83c51bb6cbeaf62061b5eb9ac501ac333a776861e46dd2a00efc5ed168`  
		Last Modified: Thu, 03 Oct 2024 00:28:41 GMT  
		Size: 1.1 KB (1069 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
