...
```console
$ docker pull joomla@sha256:8e49e63e8254a57c60df0ed6d6fe1ed0a53b490f9c67f4b7c1dc67b9775c7c48
```
...
```console
$ docker pull joomla@sha256:d27f5ff3b66d9648e084f68a29d8db510b1237fba9c32ca2dede9461a7e17df9
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.0 MB (46011032 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:23d083bdf3b13f65b3c8f4844164b6744a5c70f3d85623e39eda00035ac6e3fd`
...
# Fri, 26 Mar 2021 17:24:24 GMT
RUN apk add --no-cache 	bash
# Fri, 26 Mar 2021 17:26:10 GMT
...
-	Layers:
	...
	-	`sha256:f3804fc82c5968b8b74d297119b095c3312003b28064650ef59e8fdfaf4b4439`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:647e488581c43fd53d6381cacfa7c9a298acd3fcfd3240df0e6714a6bad9b807`  
		Last Modified: Fri, 26 Mar 2021 17:28:48 GMT  
		Size: 590.6 KB (590647 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0b47bbbb08097d3014a49fab3cd6602d36b35a7d963c5591f4a995d252a27168`  
		Last Modified: Fri, 26 Mar 2021 17:28:49 GMT  
		Size: 6.5 MB (6495135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6539db3147c0d81c20edf0420469a2aa9ca68b9562ceffca279f5465eb741a19`  
		Last Modified: Fri, 26 Mar 2021 17:28:51 GMT  
		Size: 9.7 MB (9713185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:167abb148f2c617b65a6251940977a88dd2c7da65f39b8ec2a4990f66156c395`  
		Last Modified: Fri, 26 Mar 2021 17:28:47 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a08a927716d7ee82f4e2540a5d15bb34625f157dfbbf96c5d7dc94fddcae546`  
		Last Modified: Fri, 26 Mar 2021 17:28:47 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:118f61d80087435798442f036095b6f264e8453a7e77749fed30c9a234c99aa6
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.6 MB (46595844 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60dc546bd0af99e682806c9232e82b120fd1729d8fdaf43a410505693d08a95c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
RUN apk add --no-cache 	bash
# Fri, 26 Mar 2021 22:20:14 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		libjpeg-turbo-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.19; 	pecl install mcrypt-1.0.3; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		mcrypt 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 26 Mar 2021 22:20:14 GMT
VOLUME [/var/www/html]
# Fri, 26 Mar 2021 22:20:15 GMT
ENV JOOMLA_VERSION=3.9.25
# Fri, 26 Mar 2021 22:20:15 GMT
ENV JOOMLA_SHA512=83fc90cb09d710e30dc8e8f50c4e6074ab74fb6a431a851b2567e30273e2a27686d9702cc0cdbae7dc2db09efa0081f8418064b691de43fee1af15f7a195fa25
# Fri, 26 Mar 2021 22:20:22 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 26 Mar 2021 22:20:23 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 26 Mar 2021 22:20:23 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 26 Mar 2021 22:20:24 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 26 Mar 2021 22:20:24 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:206f6f9d97778fa77fbe0ef56b2278a45c974c856bbaeb8a71307ba9df13b2ef`  
		...
		Size: 8.4 KB (8445 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3e6db2ff7c0408543d8967acaca581c4f28979086757a6830919ecd6a7bff04a`  
		Last Modified: Fri, 26 Mar 2021 22:22:53 GMT  
		Size: 632.6 KB (632637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5bc65cd35001b258e946a07aacdffe80c7809a4317711935a5db72b8857b3254`  
		Last Modified: Fri, 26 Mar 2021 22:22:54 GMT  
		Size: 6.5 MB (6548791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9348464a436c23e5208da6b70298cfbdcd8aca96bac0939bfc79225e49b3a216`  
		Last Modified: Fri, 26 Mar 2021 22:22:57 GMT  
		Size: 9.7 MB (9713171 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec94393b4a7cc6f9177b6d3df2fe5e127f9ce3c20bd7062e31f1afc375e8468f`  
		Last Modified: Fri, 26 Mar 2021 22:22:53 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0e8da5bd0959586a21482ca896ae44273aed1a4529a225954052e2c0a376a8b`  
		Last Modified: Fri, 26 Mar 2021 22:22:52 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
