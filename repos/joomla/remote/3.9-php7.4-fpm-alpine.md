...
```console
$ docker pull joomla@sha256:6d1037a04105d57c5110bd44c896c38efd91fcc4fd9f7c2f8cac10e00e48dfb9
```
...
```console
$ docker pull joomla@sha256:e67f721a234f4eed246399f1890d1cbee8938b3a7d46cfedab56e81c4cdaf01d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.9 MB (43869878 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:40275d7a7b76397edbdf3818185e8f07544b5493a486faae926d15871a8c6af2`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 16 Apr 2020 22:43:48 GMT
RUN apk add --no-cache 	bash
# Thu, 16 Apr 2020 22:46:19 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Apr 2020 22:46:20 GMT
VOLUME [/var/www/html]
# Thu, 16 Apr 2020 22:46:20 GMT
ENV JOOMLA_VERSION=3.9.16
# Thu, 16 Apr 2020 22:46:21 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Thu, 16 Apr 2020 22:46:32 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 16 Apr 2020 22:46:36 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Thu, 16 Apr 2020 22:46:37 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 16 Apr 2020 22:46:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 16 Apr 2020 22:46:38 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:0407cd8324c13b1908ebdbf80436926b92b0709006e689e413884d4f2fb67839`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:665fc0df994fd67d2c0093bca02bc7a8d06df622fb64aac44a85ee5a559fdeea`  
		Last Modified: Thu, 16 Apr 2020 22:47:18 GMT  
		Size: 537.1 KB (537059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:26835b552ff06e78cbac71c4b2c5c0f829161858746d79eaae164eef7e0e0e16`  
		Last Modified: Thu, 16 Apr 2020 22:47:19 GMT  
		Size: 6.2 MB (6177655 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66dd5738eb7ebe4fff14a0013f8d7d9c28126adb278d020e62a94ca008080a1f`  
		Last Modified: Thu, 16 Apr 2020 22:47:24 GMT  
		Size: 9.7 MB (9653978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be900cce3e926b551f00eba1cde3a07560cdcb2ac497bc08b62f147fa8b211fc`  
		Last Modified: Thu, 16 Apr 2020 22:47:18 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:567690608586d6db1fb6a57039a2e921044dfa163144ffe48c033c1ef0d4ca8a`  
		Last Modified: Thu, 16 Apr 2020 22:47:18 GMT  
		Size: 616.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull joomla@sha256:c3fe0a7049c91775c9edff0def40f0feb3ffae08b6e20e2e62a32450a6267408
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.6 MB (44644432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:07b7cde2583fd13deaa3d7487515fdf439379ff5425f9b6df7f63e2b6804b8f1`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Thu, 16 Apr 2020 14:28:49 GMT
LABEL maintainer=Michael Babker <michael.babker@joomla.org> (@mbabker)
# Thu, 16 Apr 2020 14:28:49 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Thu, 16 Apr 2020 14:28:50 GMT
RUN apk add --no-cache 	bash
# Thu, 16 Apr 2020 14:29:39 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		libjpeg-turbo-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Thu, 16 Apr 2020 14:29:40 GMT
VOLUME [/var/www/html]
# Thu, 16 Apr 2020 14:29:40 GMT
ENV JOOMLA_VERSION=3.9.16
# Thu, 16 Apr 2020 14:29:40 GMT
ENV JOOMLA_SHA512=3266ff375631fd0c4c45c66368f3d07cdc1b41010ffad907a957e6c1acb511847bf2c112e0991792f84455b48bea95c84eca9a7325baa3cab61078fda697ed0f
# Thu, 16 Apr 2020 14:29:46 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 16 Apr 2020 14:29:48 GMT
COPY file:fcc18c5b9c2d514cfb965bab84e10b4f924a39a5f202055df75d7990da099d8f in /entrypoint.sh 
# Thu, 16 Apr 2020 14:29:48 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Thu, 16 Apr 2020 14:29:48 GMT
...
-	Layers:
	...
	-	`sha256:f6744410ab70830941e30c5b6e11cbef4dc6eeb8333ec3b6df581a329a4240d1`  
		...
		Size: 8.4 KB (8411 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c48940db04a58817008461211c10d00219f1a08be3c15ef70e6d291c26c55854`  
		Last Modified: Thu, 16 Apr 2020 14:33:31 GMT  
		Size: 576.8 KB (576754 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e01ca8bf9cb1e72bc585aaa4ea3bae47c5e8b3c99f1af4b37c679c6760cea79b`  
		Last Modified: Thu, 16 Apr 2020 14:33:32 GMT  
		Size: 6.6 MB (6586991 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a43c59ef769ebf605842b1e43da438fe1d4bf29301cfd0abdfad0a9b4a87d919`  
		Last Modified: Thu, 16 Apr 2020 14:33:38 GMT  
		Size: 9.7 MB (9653973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b701c49be94b824ba62ffc68031f38ff4241277d82f7d4cc6c2c51b132f38f3`  
		Last Modified: Thu, 16 Apr 2020 14:33:36 GMT  
		Size: 1.2 KB (1172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d752927af085f37bf2c29de56dbf206aa193754af93ee07c5e558dffecd82da`  
		Last Modified: Thu, 16 Apr 2020 14:33:36 GMT  
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
