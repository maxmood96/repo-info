...
```console
$ docker pull joomla@sha256:66d593c1a7953496e7179c9cd46eb2910d123eb44cc0903cd1180328046ea2d4
```
...
```console
$ docker pull joomla@sha256:10a010388a2f6f18b6db6b8056c37ad901f34d616cfe3ee868461b2be641b60e
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.7 MB (47746698 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4a7ef4a33823252f883216e287fecdb15d6046f291b31d094426d5014bff8156`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
CMD ["php-fpm"]
# Fri, 04 Sep 2020 03:19:46 GMT
LABEL maintainer=Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 04 Sep 2020 03:19:48 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 04 Sep 2020 03:19:56 GMT
RUN apk add --no-cache 	bash
# Fri, 04 Sep 2020 03:22:17 GMT
RUN set -ex; 		apk add --no-cache --virtual .build-deps 		$PHPIZE_DEPS 		autoconf 		bzip2-dev 		gmp-dev 		libjpeg-turbo-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libzip-dev 		openldap-dev 		pcre-dev 		postgresql-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	docker-php-ext-configure ldap; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.18; 	pecl install mcrypt-1.0.3; 	pecl install memcached-3.1.5; 	pecl install redis-4.3.0; 		docker-php-ext-enable 		apcu 		mcrypt 		memcached 		redis 	; 		runDeps="$( 		scanelf --needed --nobanner --format '%n#p' --recursive /usr/local/lib/php/extensions 		| tr ',' '\n' 		| sort -u 		| awk 'system("[ -e /usr/local/lib/" $1 " ]") == 0 { next } { print "so:" $1 }' 		)"; 	apk add --virtual .joomla-phpext-rundeps $runDeps; 	apk del .build-deps
# Fri, 04 Sep 2020 03:22:20 GMT
VOLUME [/var/www/html]
# Fri, 04 Sep 2020 03:22:24 GMT
ENV JOOMLA_VERSION=3.9.21
# Fri, 04 Sep 2020 03:22:27 GMT
ENV JOOMLA_SHA512=603027bb54f1aa0c37ecdac7438ce1294120b82a16f6c5b6671d1344e87816cc999d9b7e7fe149800e26d937a97fba383817d3e1c71bd23b1a2d380758de3a1d
# Fri, 04 Sep 2020 03:22:40 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 04 Sep 2020 03:22:43 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 04 Sep 2020 03:22:45 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 04 Sep 2020 03:22:48 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 04 Sep 2020 03:22:51 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:2d56b5d8127deeed309a76d54ee592aee909ba7fe7653488f3994403604d761c`  
		...
		Size: 8.4 KB (8443 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83b350d95c7cf75c8efc2a48f4bcd474c5c49711a11b45dfb5680a52f8025432`  
		Last Modified: Fri, 04 Sep 2020 03:29:00 GMT  
		Size: 621.8 KB (621787 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a24905364b3189b72307dc736062cd9fc6262fffb5d51192e04dc4767aa987b9`  
		Last Modified: Fri, 04 Sep 2020 03:29:02 GMT  
		Size: 7.3 MB (7278664 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2fb33e3c876a9eb3a423b41a4173d9d85d47c85fcc5a4c783e232b2c0880d59`  
		Last Modified: Fri, 04 Sep 2020 03:29:03 GMT  
		Size: 9.7 MB (9686663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ddb26aa48189e14c802fa062d0df33bf8890eaf1924619b5b1de0819294f33f9`  
		Last Modified: Fri, 04 Sep 2020 03:28:59 GMT  
		Size: 1.2 KB (1199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba3ac09e6659f5586085a0e23669eae48e39b69ec063dac94f9a6395375b3cab`  
		Last Modified: Fri, 04 Sep 2020 03:28:59 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
