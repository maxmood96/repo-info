...
```console
$ docker pull joomla@sha256:fcc73dad46fb65826f7681768d74b08400acde45efea5daa2195ea2d93bf239b
```
...
### `joomla:4.0.3` - linux; arm variant v5

```console
$ docker pull joomla@sha256:4f61cd1af88ec21f24f4ee9eb8e9b4adace5e40ffae1acd4629414bb99a010e6
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **170.1 MB (170149150 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bbbf085290dd6c1adf9035d638fc247b296f653a8b721a054cfed655f5995277`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
CMD ["apache2-foreground"]
# Fri, 24 Sep 2021 00:14:57 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 00:14:58 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 00:15:00 GMT
RUN a2enmod rewrite
# Fri, 24 Sep 2021 00:19:20 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 00:19:20 GMT
VOLUME [/var/www/html]
...
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 00:19:39 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 00:19:40 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 00:19:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 00:19:41 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:c6a6530ed71cff223340a9be7e954870d68dac083bcee673e4cc94f9122d3718`  
		...
		Size: 895.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:adea1b03fc3b3c985cfff1ba321ddd51ff34bd6ba90d10f3b6348cf3c57f8845`  
		Last Modified: Fri, 24 Sep 2021 00:41:00 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:492d5dc22ccc2f0f473ae358781a5eaeb101457e8f716bac6fa89a3b9e060004`  
		Last Modified: Fri, 24 Sep 2021 00:41:02 GMT  
		Size: 2.8 MB (2787571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff30d36fbaa8ab6d757510989b81a2cc513709654b5f06dc8787827e8383d213`  
		Last Modified: Fri, 24 Sep 2021 00:41:19 GMT  
		Size: 21.3 MB (21324595 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b60118295aaf21ad607a5df01a8a8f0ca64d47f14be3550e8412c6a915ff97e`  
		Last Modified: Fri, 24 Sep 2021 00:41:00 GMT  
		Size: 1.2 KB (1199 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f13c59caacdd38420fb48ef0f079fb27f7d6916912ef80b5e321563c2ea0434`  
		Last Modified: Fri, 24 Sep 2021 00:41:00 GMT  
		Size: 612.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.3` - linux; arm variant v7
...
### `joomla:4.0.3` - linux; arm64 variant v8

```console
$ docker pull joomla@sha256:98f6828b24249c48cd33b04ff0bd710ef4d7167510c42d14771d302f61bbb739
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **185.9 MB (185882238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec2f719813599547f2921e6b1d24d4fe151c913c119d517a7d1abfc307bee99e`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 04:44:00 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 04:44:00 GMT
RUN a2enmod rewrite
# Fri, 24 Sep 2021 04:45:25 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 04:45:25 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 04:45:25 GMT
...
# Fri, 24 Sep 2021 04:45:25 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 04:45:31 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 04:45:31 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 04:45:32 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 04:45:32 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 04:45:32 GMT
...
-	Layers:
	...
	-	`sha256:a4e0201e925bb8250c562df827301fc23774e818f4aae45c16ba5c6fcada6e2d`  
		...
		Size: 894.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c47928dae42869a7d39363b942bdbdf2c3f5be29c96be1fd9639a65e2db25c5`  
		Last Modified: Fri, 24 Sep 2021 04:59:19 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d071c880ac26df2b57105e5c9f91d236f9dd948263f00170ad80df26a928ae1f`  
		Last Modified: Fri, 24 Sep 2021 04:59:20 GMT  
		Size: 2.9 MB (2920185 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:02adb825e6cae3a50917fd4b2fd40656ca7edc0f359a5c965ab0cf401f767033`  
		Last Modified: Fri, 24 Sep 2021 04:59:23 GMT  
		Size: 21.3 MB (21324517 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ff096d0011545a0fbdf4f43cf250bf108d83384c5f2d17005b9a9773fb786038`  
		Last Modified: Fri, 24 Sep 2021 04:59:19 GMT  
		Size: 1.2 KB (1202 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:678c4bb8c592e94ee03179f05d8f913573a62037907256e87f00ab46ebbd6295`  
		Last Modified: Fri, 24 Sep 2021 04:59:19 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.3` - linux; 386

```console
$ docker pull joomla@sha256:34ee4374c61a9a863621ef33368b322b62bcdacd4045d2a5c5d88ecc6e2b1337
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **195.7 MB (195663084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2b49468100ace3548bb6c10757e69c68d580fec85003b4c5d8559ac2e57edde`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Sep 2021 18:52:49 GMT
CMD ["apache2-foreground"]
# Fri, 24 Sep 2021 04:05:07 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 04:05:07 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 04:05:08 GMT
RUN a2enmod rewrite
# Fri, 24 Sep 2021 04:06:42 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 04:06:43 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 04:06:43 GMT
ENV JOOMLA_VERSION=4.0.3
# Fri, 24 Sep 2021 04:06:43 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 04:06:50 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 04:06:51 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 04:06:51 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 04:06:52 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 04:06:52 GMT
CMD ["apache2-foreground"]
```
...
-	Layers:
	...
	-	`sha256:d0fe713aecb99e10ff0113896ef633ec31b99125c9690a504d81f61044e22a12`  
		...
		Size: 892.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7caad5fc54e584b8ac729920ec32515d952a68cfb05b6eef60b49e30f78b065a`  
		Last Modified: Fri, 24 Sep 2021 04:21:45 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:349ee3330efd2546926dd9fe7b3cec447597902907377a07a32d7b949b60a50e`  
		Last Modified: Fri, 24 Sep 2021 04:21:46 GMT  
		Size: 3.0 MB (2982322 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a15097ff12bf44766773c2b16724d1d7d10904432cc07d494962a87bc98b907`  
		Last Modified: Fri, 24 Sep 2021 04:21:50 GMT  
		Size: 21.3 MB (21324600 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19b6b54f4fc2d549d07fa1ebdce41b9b61a67a6c067a0b6bb0e239944e2bbe57`  
		Last Modified: Fri, 24 Sep 2021 04:21:45 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29ee960e525169e03c0c53b9d0e67bae46ef5328f164d966fc72b5ac13224e7d`  
		Last Modified: Fri, 24 Sep 2021 04:21:45 GMT  
		Size: 613.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `joomla:4.0.3` - linux; mips64le
...
### `joomla:4.0.3` - linux; s390x

```console
$ docker pull joomla@sha256:c705736c287ca3ad0417105c68512d8d8aa3831cc2dceac82c44b313b84d809b
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **169.6 MB (169591809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:44b90e61e973b94cd5af318cf7460da39dcff151a22dd8bd9ad3135663dc3c54`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["apache2-foreground"]`
...
# Thu, 23 Sep 2021 20:13:08 GMT
CMD ["apache2-foreground"]
# Fri, 24 Sep 2021 00:52:56 GMT
LABEL maintainer=Llewellyn van der Merwe <llewellyn.van-der-merwe@community.joomla.org> (@Llewellynvdm), Harald Leithner <harald.leithner@community.joomla.org> (@HLeithner)
# Fri, 24 Sep 2021 00:52:56 GMT
ENV JOOMLA_INSTALLATION_DISABLE_LOCALHOST_CHECK=1
# Fri, 24 Sep 2021 00:52:56 GMT
RUN a2enmod rewrite
# Fri, 24 Sep 2021 00:53:48 GMT
RUN set -ex; 		savedAptMark="$(apt-mark showmanual)"; 		apt-get update; 	apt-get install -y --no-install-recommends 		libbz2-dev 		libgmp-dev 		libjpeg-dev 		libldap2-dev 		libmcrypt-dev 		libmemcached-dev 		libpng-dev 		libpq-dev 		libzip-dev 	; 		docker-php-ext-configure gd --with-jpeg; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	docker-php-ext-configure ldap --with-libdir="lib/$debMultiarch"; 	docker-php-ext-install -j "$(nproc)" 		bz2 		gd 		gmp 		ldap 		mysqli 		pdo_mysql 		pdo_pgsql 		pgsql 		zip 	; 		pecl install APCu-5.1.20; 	pecl install memcached-3.1.5; 	pecl install redis-5.3.4; 		docker-php-ext-enable 		apcu 		memcached 		redis 	; 	rm -r /tmp/pear; 		apt-mark auto '.*' > /dev/null; 	apt-mark manual $savedAptMark; 	ldd "$(php -r 'echo ini_get("extension_dir");')"/*.so 		| awk '/=>/ { print $3 }' 		| sort -u 		| xargs -r dpkg-query -S 		| cut -d: -f1 		| sort -u 		| xargs -rt apt-mark manual; 		apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*
# Fri, 24 Sep 2021 00:53:49 GMT
VOLUME [/var/www/html]
# Fri, 24 Sep 2021 00:53:49 GMT
ENV JOOMLA_VERSION=4.0.3
# Fri, 24 Sep 2021 00:53:49 GMT
ENV JOOMLA_SHA512=9c09a621586fdcc30351a915f283581c92080c210294cacc50e0e390d991f32bee9d61dfc7b0af33c81118e46d775152159c0e27dbf73f5531512328d716901f
# Fri, 24 Sep 2021 00:53:55 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/${JOOMLA_VERSION}/Joomla_${JOOMLA_VERSION}-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Fri, 24 Sep 2021 00:53:56 GMT
COPY file:f6b7a1c96cc89593a2b9ce4c68af350ae02f2e0c654cd5e842ff6c03641d470e in /entrypoint.sh 
# Fri, 24 Sep 2021 00:53:57 GMT
COPY file:5a85d779aaae74cfa3ab6228df0f24236d4d5ad9097e2a1b277e3daea0d6d3dc in /makedb.php 
# Fri, 24 Sep 2021 00:53:57 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Fri, 24 Sep 2021 00:53:57 GMT
...
-	Layers:
	...
	-	`sha256:d6dfc48bf594ac223be89dcf9a19f2db0675483a404113aad4fa1bcdb158024e`  
		...
		Size: 891.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8160bd7ed712002bd7d4e4f6f08ce812483fb2cbab612e874badf103d8822dc0`  
		Last Modified: Fri, 24 Sep 2021 01:04:52 GMT  
		Size: 316.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cbfdfb4a940739e69735487fd9a60e695ae1c92a3d829233cc4e7384efb937f4`  
		Last Modified: Fri, 24 Sep 2021 01:04:53 GMT  
		Size: 2.9 MB (2922386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e83dc43c1bc048f1ebfa68f62cf148f3bc419014f35e18cd1089281d4bcc1f69`  
		Last Modified: Fri, 24 Sep 2021 01:04:55 GMT  
		Size: 21.3 MB (21324612 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b5210c59a32d9fed363bf629a0f7d815949b720625f59657d4e5ceed45a61793`  
		Last Modified: Fri, 24 Sep 2021 01:04:52 GMT  
		Size: 1.2 KB (1201 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:661c6e172422d39d45db17f84f7cf93fa975946714f9d2ec05aeb69ae519ae58`  
		Last Modified: Fri, 24 Sep 2021 01:04:52 GMT  
		Size: 615.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
