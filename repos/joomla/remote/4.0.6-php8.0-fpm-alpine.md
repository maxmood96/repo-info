...
```console
$ docker pull joomla@sha256:fa928f20cbecac8f27bb787f55edaf56366fc861124a62f32cbb73f7e305037c
```
...
### `joomla:4.0.6-php8.0-fpm-alpine` - linux; amd64
...
### `joomla:4.0.6-php8.0-fpm-alpine` - linux; arm variant v7
