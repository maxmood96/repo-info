...
```console
$ docker pull joomla@sha256:53c5e09a08c7279cb56602aaff3a723117d30b3e644ae231a75f18ec25fa762a
```
...
```console
$ docker pull joomla@sha256:80d652aa2d3095c835e3eeb58994ff7aab6e533b29102e436683fd5f9799bea1
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **202.8 MB (202826530 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f76732f9240665714e02e2b8f7e366fcfe2d765eb62a255a983fc45439b2960`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
VOLUME [/var/www/html]
# Thu, 02 Nov 2023 03:24:37 GMT
ENV JOOMLA_VERSION=4.3.4
# Thu, 02 Nov 2023 03:24:41 GMT
ENV JOOMLA_SHA512=2efede3c3230d2fd849c46f84eea9aa1ef2bef6836e0ceec6451499bb6abf7e747d63f3996d0a5f7fc2d439c5ae0380e0e71f7c2823adfdda80e87a0bc377be1
# Thu, 02 Nov 2023 03:25:17 GMT
RUN set -ex; 	curl -o joomla.tar.bz2 -SL https://github.com/joomla/joomla-cms/releases/download/4.3.4/Joomla_4.3.4-Stable-Full_Package.tar.bz2; 	echo "$JOOMLA_SHA512 *joomla.tar.bz2" | sha512sum -c -; 	mkdir /usr/src/joomla; 	tar -xf joomla.tar.bz2 -C /usr/src/joomla; 	rm joomla.tar.bz2; 	chown -R www-data:www-data /usr/src/joomla
# Thu, 02 Nov 2023 03:25:25 GMT
COPY file:75d4151822bf32487f27c3996faec3e2842350001f3cabdee80506df7825dc96 in /entrypoint.sh 
# Thu, 02 Nov 2023 03:25:30 GMT
COPY file:4365854cfba2f0673f4930c9c90629a51419815bb2048df2d1803bf1a9d79fd6 in /makedb.php 
# Thu, 02 Nov 2023 03:25:36 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 02 Nov 2023 03:25:43 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:08685bf5db560719dd89ef290543cc1d5dd6265ecdb55244bcf1c592e572bb30`  
		...
		Size: 396.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab576d222b42bc0b930547fc525064bc2bfd477c5c13bc15ba93cb00e89402d5`  
		Last Modified: Thu, 02 Nov 2023 04:05:33 GMT  
		Size: 25.1 MB (25054239 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:10861f0c66de383bd2a5a7ffd9553f76c33fdcf04e7c9c5ed7652ec7cf5c12ad`  
		Last Modified: Thu, 02 Nov 2023 04:05:11 GMT  
		Size: 2.6 KB (2618 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00326e1952565e88d16f6ab01a4b72fb62a37363c2ed9be76e60631a7b7b6f9c`  
		Last Modified: Thu, 02 Nov 2023 04:05:11 GMT  
