...
```console
$ docker pull joomla@sha256:bdaed2946fe51dc7b18ad32f0cc81bf474f0209fd4a9adc1c9bc8239063a271f
```
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; amd64
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; arm variant v5
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; arm variant v7
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; arm64 variant v8
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; 386
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; mips64le
...
### `joomla:5.1.0-alpha4-php8.1-fpm` - linux; s390x
