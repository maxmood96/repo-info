...
### `joomla:3.9.28-php7.3-apache` - linux; amd64
...
### `joomla:3.9.28-php7.3-apache` - linux; arm variant v5
...
### `joomla:3.9.28-php7.3-apache` - linux; arm64 variant v8
...
### `joomla:3.9.28-php7.3-apache` - linux; mips64le
...
### `joomla:3.9.28-php7.3-apache` - linux; s390x
