...
```console
openjdk11-jre-11.0.27_p6-r0 description:
Oracle OpenJDK 11 (JRE)

openjdk11-jre-11.0.27_p6-r0 webpage:
https://github.com/openjdk/jdk11u

openjdk11-jre-11.0.27_p6-r0 installed size:
2908 KiB

openjdk11-jre-11.0.27_p6-r0 license:
...
```console
openjdk11-jre-headless-11.0.27_p6-r0 description:
Oracle OpenJDK 11 (JRE headless)

openjdk11-jre-headless-11.0.27_p6-r0 webpage:
https://github.com/openjdk/jdk11u

openjdk11-jre-headless-11.0.27_p6-r0 installed size:
152 MiB

openjdk11-jre-headless-11.0.27_p6-r0 license:
GPL-2.0-with-classpath-exception
