...
```console
alsa-lib-1.2.8-r0 description:
Advanced Linux Sound Architecture (ALSA) library

alsa-lib-1.2.8-r0 webpage:
https://alsa-project.org/

alsa-lib-1.2.8-r0 installed size:
1480 KiB

alsa-lib-1.2.8-r0 license:
LGPL-2.1-or-later
...
```console
p11-kit-trust-0.24.1-r1 description:
System trust module from p11-kit

p11-kit-trust-0.24.1-r1 webpage:
https://p11-glue.freedesktop.org/

p11-kit-trust-0.24.1-r1 installed size:
424 KiB

p11-kit-trust-0.24.1-r1 license:
BSD-3-Clause
