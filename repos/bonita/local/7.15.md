...
- Created: `2024-01-27T00:47:35.466108952Z`
- Virtual Size: ~ 321.25 Mb  
...
```console
alsa-lib-1.2.7.2-r0 description:
Advanced Linux Sound Architecture (ALSA) library

alsa-lib-1.2.7.2-r0 webpage:
https://alsa-project.org/

alsa-lib-1.2.7.2-r0 installed size:
1488 KiB

alsa-lib-1.2.7.2-r0 license:
LGPL-2.1-or-later
...
```console
jattach-2.0-r0 description:
JVM dynamic attach utility

jattach-2.0-r0 webpage:
https://github.com/apangin/jattach

jattach-2.0-r0 installed size:
36 KiB

jattach-2.0-r0 license:
Apache-2.0
...
```console
p11-kit-trust-0.24.1-r0 description:
System trust module from p11-kit

p11-kit-trust-0.24.1-r0 webpage:
https://p11-glue.freedesktop.org/

p11-kit-trust-0.24.1-r0 installed size:
452 KiB

p11-kit-trust-0.24.1-r0 license:
BSD-3-Clause
