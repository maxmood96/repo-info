...
- Created: `2026-05-11T23:49:09.122727254Z`
...
- Environment:
  ...
  - `HAPROXY_VERSION=2.8.24`
  - `HAPROXY_URL=https://www.haproxy.org/download/2.8/src/haproxy-2.8.24.tar.gz`
  - `HAPROXY_SHA256=f27fcd5e04cfc390ec9e92c24cfa8c908f78b31627a5587c5fd03b457c1a3c36`
...
### `dpkg` source package: `socat=1.8.0.3-1`
...
```console
$ apt-get source -qq --print-uris socat=1.8.0.3-1
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.8.0.3-1.dsc' socat_1.8.0.3-1.dsc 1866 SHA256:e12df7759520eaa144495219d943d576a0124b31a952b44c224fad259b3755b4
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.8.0.3.orig.tar.bz2' socat_1.8.0.3.orig.tar.bz2 594396 SHA256:01eb017361d95bb3a6941e840b59e4463a3fabf92df4154ed02b16a2ed6a0095
'http://deb.debian.org/debian/pool/main/s/socat/socat_1.8.0.3-1.debian.tar.xz' socat_1.8.0.3-1.debian.tar.xz 15504 SHA256:860b43b8724d7745ff1b661cd8fe066ce0642f7e36c56f13cad014ee6e5f66f1
```

Other potentially useful URLs:

- https://sources.debian.net/src/socat/1.8.0.3-1/ (for browsing the source)
- https://sources.debian.net/src/socat/1.8.0.3-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/socat/1.8.0.3-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `tcp-wrappers=7.6.q-36`
...
```console
$ apt-get source -qq --print-uris tcp-wrappers=7.6.q-36
'http://deb.debian.org/debian/pool/main/t/tcp-wrappers/tcp-wrappers_7.6.q-36.dsc' tcp-wrappers_7.6.q-36.dsc 1354 SHA256:baefdf5420748c58b9239508d0baf4a04dc6728fb92496af7a55c36578a6b58d
...
'http://deb.debian.org/debian/pool/main/t/tcp-wrappers/tcp-wrappers_7.6.q-36.debian.tar.xz' tcp-wrappers_7.6.q-36.debian.tar.xz 43656 SHA256:b795bef572b0351d5e707e3d7e8a77b1eb3819ad9b508895ff1fc9a826b6cfa4
```

Other potentially useful URLs:

- https://sources.debian.net/src/tcp-wrappers/7.6.q-36/ (for browsing the source)
- https://sources.debian.net/src/tcp-wrappers/7.6.q-36/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/tcp-wrappers/7.6.q-36/ (for access to the source package after it no longer exists in the archive)
