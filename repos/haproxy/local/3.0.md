...
- Created: `2024-12-12T18:18:23Z`
- Virtual Size: ~ 102.50 Mb  
...
- Environment:
  ...
  - `HAPROXY_URL=https://www.haproxy.org/download/3.0/src/haproxy-3.0.7.tar.gz`
  - `HAPROXY_SHA256=5c5c6b66645278435a89cd6e2a0d39f8e7d2546212d847bd0d236511ff996f11`
...
### `dpkg` source package: `lua5.4=5.4.4-3+deb12u1`
...
```console
$ apt-get source -qq --print-uris lua5.4=5.4.4-3+deb12u1
'http://deb.debian.org/debian/pool/main/l/lua5.4/lua5.4_5.4.4-3%2bdeb12u1.dsc' lua5.4_5.4.4-3+deb12u1.dsc 2120 SHA256:d47c50154294a68c8a209c5d61bc09e5b22891c01b7c47501ac3f9725eb4a813
'http://deb.debian.org/debian/pool/main/l/lua5.4/lua5.4_5.4.4.orig.tar.gz' lua5.4_5.4.4.orig.tar.gz 360876 SHA256:164c7849653b80ae67bec4b7473b884bf5cc8d2dca05653475ec2ed27b9ebf61
'http://deb.debian.org/debian/pool/main/l/lua5.4/lua5.4_5.4.4-3%2bdeb12u1.debian.tar.xz' lua5.4_5.4.4-3+deb12u1.debian.tar.xz 9888 SHA256:2d8e0e380722c648cfeffb8d58287865619b4d035544d93d7ef3a2eaf627abe6
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.4/5.4.4-3+deb12u1/ (for browsing the source)
- https://sources.debian.net/src/lua5.4/5.4.4-3+deb12u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.4/5.4.4-3+deb12u1/ (for access to the source package after it no longer exists in the archive)
