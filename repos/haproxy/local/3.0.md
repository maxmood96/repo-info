...
- Created: `2024-06-14T16:50:59Z`
- Virtual Size: ~ 102.17 Mb  
...
- Environment:
  ...
  - `HAPROXY_URL=https://www.haproxy.org/download/3.0/src/haproxy-3.0.2.tar.gz`
  - `HAPROXY_SHA256=9672ee43b109f19356c35d72687b222dcf82b879360c6e82677397376cf5dc36`
...
### `dpkg` source package: `lua5.4=5.4.4-3`

Binary Packages:

- `liblua5.4-0:amd64=5.4.4-3`
...
```console
$ apt-get source -qq --print-uris lua5.4=5.4.4-3
'http://deb.debian.org/debian/pool/main/l/lua5.4/lua5.4_5.4.4-3.dsc' lua5.4_5.4.4-3.dsc 2088 SHA256:7c6fd5b3bad244206165bdf6f3d5e8a19632d4d361f57782a67561076edcefa2
...
'http://deb.debian.org/debian/pool/main/l/lua5.4/lua5.4_5.4.4-3.debian.tar.xz' lua5.4_5.4.4-3.debian.tar.xz 9748 SHA256:075e112ae8c57f806cefdac16eeccda366ebd062fb5259efa1e1143e4e86f7d6
```

Other potentially useful URLs:

- https://sources.debian.net/src/lua5.4/5.4.4-3/ (for browsing the source)
- https://sources.debian.net/src/lua5.4/5.4.4-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.4/5.4.4-3/ (for access to the source package after it no longer exists in the archive)
