...
```console
$ docker pull haproxy@sha256:d446886151e994bef4229018c3a9ad7878f4f46aecbbfb052beb310837e40d4b
```
...
```console
$ docker pull haproxy@sha256:e5ed3026284e805102f984c76cb69e3e25f525b4a939846b4259958a231563e8
```
