...
```console
$ docker pull haproxy@sha256:cb1b8fd0499174728d588af8cde5e8c366b4e1b99e31c4874a97c4a5fdeafa11
```
...
### `haproxy:3.3.5-alpine` - linux; amd64
...
### `haproxy:3.3.5-alpine` - unknown; unknown
...
### `haproxy:3.3.5-alpine` - linux; arm variant v6
...
### `haproxy:3.3.5-alpine` - linux; arm variant v7
...
### `haproxy:3.3.5-alpine` - linux; arm64 variant v8
...
### `haproxy:3.3.5-alpine` - linux; 386
...
### `haproxy:3.3.5-alpine` - linux; ppc64le
...
### `haproxy:3.3.5-alpine` - linux; s390x
