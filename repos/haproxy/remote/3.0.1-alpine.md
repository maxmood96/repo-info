...
### `haproxy:3.0.1-alpine` - linux; arm variant v7
...
### `haproxy:3.0.1-alpine` - linux; arm64 variant v8
...
### `haproxy:3.0.1-alpine` - linux; ppc64le
...
### `haproxy:3.0.1-alpine` - linux; s390x
