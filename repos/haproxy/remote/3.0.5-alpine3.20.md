...
### `haproxy:3.0.5-alpine3.20` - linux; amd64
...
### `haproxy:3.0.5-alpine3.20` - unknown; unknown
...
### `haproxy:3.0.5-alpine3.20` - linux; arm variant v6
...
### `haproxy:3.0.5-alpine3.20` - linux; arm variant v7
...
### `haproxy:3.0.5-alpine3.20` - linux; arm64 variant v8
...
### `haproxy:3.0.5-alpine3.20` - linux; 386
...
### `haproxy:3.0.5-alpine3.20` - linux; ppc64le
...
### `haproxy:3.0.5-alpine3.20` - linux; riscv64
...
### `haproxy:3.0.5-alpine3.20` - linux; s390x
