...
```console
$ docker pull haproxy@sha256:9517a4e3bb28de764e762f33ddfabc6eea2136fa8898a9a2b393afc634218def
```
...
### `haproxy:3.2.11-trixie` - linux; amd64
...
### `haproxy:3.2.11-trixie` - unknown; unknown
...
### `haproxy:3.2.11-trixie` - linux; arm variant v5
...
### `haproxy:3.2.11-trixie` - linux; arm variant v7
...
### `haproxy:3.2.11-trixie` - linux; arm64 variant v8
...
### `haproxy:3.2.11-trixie` - linux; 386
...
### `haproxy:3.2.11-trixie` - linux; ppc64le
...
### `haproxy:3.2.11-trixie` - linux; s390x
