...
### `haproxy:3.0.9-bookworm` - linux; amd64
...
### `haproxy:3.0.9-bookworm` - unknown; unknown
...
### `haproxy:3.0.9-bookworm` - linux; arm variant v5
...
### `haproxy:3.0.9-bookworm` - linux; arm variant v7
...
### `haproxy:3.0.9-bookworm` - linux; arm64 variant v8
...
### `haproxy:3.0.9-bookworm` - linux; 386
...
### `haproxy:3.0.9-bookworm` - linux; mips64le
...
### `haproxy:3.0.9-bookworm` - linux; ppc64le
...
### `haproxy:3.0.9-bookworm` - linux; s390x
