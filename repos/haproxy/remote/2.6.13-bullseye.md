...
```console
$ docker pull haproxy@sha256:a5624be3f9ea5e5cd91951f98bf410484c785ca341592e9993d9fb2a2081c414
```
...
### `haproxy:2.6.13-bullseye` - linux; amd64
...
### `haproxy:2.6.13-bullseye` - linux; arm variant v5
...
### `haproxy:2.6.13-bullseye` - linux; arm64 variant v8
...
### `haproxy:2.6.13-bullseye` - linux; 386
...
### `haproxy:2.6.13-bullseye` - linux; mips64le
...
### `haproxy:2.6.13-bullseye` - linux; ppc64le
...
### `haproxy:2.6.13-bullseye` - linux; s390x
