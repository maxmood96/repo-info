...
```console
$ docker pull haproxy@sha256:48a5e38c6858fe479c727ebc49984ada607b73c76de2425486dcad4f3df02e1b
```
...
### `haproxy:3.3.1-alpine3.23` - linux; amd64
...
### `haproxy:3.3.1-alpine3.23` - unknown; unknown
...
### `haproxy:3.3.1-alpine3.23` - linux; arm variant v6
...
### `haproxy:3.3.1-alpine3.23` - linux; arm variant v7
...
### `haproxy:3.3.1-alpine3.23` - linux; arm64 variant v8
...
### `haproxy:3.3.1-alpine3.23` - linux; 386
...
### `haproxy:3.3.1-alpine3.23` - linux; ppc64le
...
### `haproxy:3.3.1-alpine3.23` - linux; s390x
