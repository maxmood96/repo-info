...
```console
$ docker pull haproxy@sha256:8702d26c074443d6c4755ae674eba3a8ef6a240b8ba798b1614be1853469da37
```
...
### `haproxy:2.4.14-bullseye` - linux; amd64
...
### `haproxy:2.4.14-bullseye` - linux; arm variant v5
...
### `haproxy:2.4.14-bullseye` - linux; arm64 variant v8
...
### `haproxy:2.4.14-bullseye` - linux; 386
...
### `haproxy:2.4.14-bullseye` - linux; mips64le
...
### `haproxy:2.4.14-bullseye` - linux; s390x
