...
```console
$ docker pull haproxy@sha256:de590d492f46f3b5446a4be7d94c16026b2a35773f40022eb3054929e6ecbc6f
```
...
### `haproxy:3.3.4-alpine3.23` - linux; amd64
...
### `haproxy:3.3.4-alpine3.23` - unknown; unknown
...
### `haproxy:3.3.4-alpine3.23` - linux; arm variant v6
...
### `haproxy:3.3.4-alpine3.23` - linux; arm variant v7
...
### `haproxy:3.3.4-alpine3.23` - linux; arm64 variant v8
...
### `haproxy:3.3.4-alpine3.23` - linux; 386
...
### `haproxy:3.3.4-alpine3.23` - linux; ppc64le
...
### `haproxy:3.3.4-alpine3.23` - linux; s390x
