...
### `haproxy:2.8.11-alpine` - linux; amd64
...
### `haproxy:2.8.11-alpine` - unknown; unknown
...
### `haproxy:2.8.11-alpine` - linux; arm variant v6
...
### `haproxy:2.8.11-alpine` - linux; arm variant v7
...
### `haproxy:2.8.11-alpine` - linux; arm64 variant v8
...
### `haproxy:2.8.11-alpine` - linux; 386
...
### `haproxy:2.8.11-alpine` - linux; ppc64le
...
### `haproxy:2.8.11-alpine` - linux; riscv64
...
### `haproxy:2.8.11-alpine` - linux; s390x
