...
```console
$ docker pull haproxy@sha256:f7dde61e20c596fad39014ffae3223cf9027c5693896a415282f40353be5d899
```
...
### `haproxy:2.2-dev9-alpine` - linux; amd64
...
### `haproxy:2.2-dev9-alpine` - linux; 386
