...
- Created: `2022-12-06T09:26:42.234161351Z`
...
- `libcurl4-openssl-dev:amd64=7.74.0-1.3+deb11u3`
...
### `dpkg` source package: `mariadb-10.5=1:10.5.15-0+deb11u1`

Binary Packages:

- `libmariadb-dev=1:10.5.15-0+deb11u1`
- `libmariadb-dev-compat:amd64=1:10.5.15-0+deb11u1`
...
- `libtiff-dev:amd64=4.2.0-1+deb11u1`
- `libtiff5:amd64=4.2.0-1+deb11u1`
- `libtiffxx5:amd64=4.2.0-1+deb11u1`
