...
```console
$ docker pull perl@sha256:203aa278d9628769ea10decda4561267c739802844f7a4baa20febde8b314a79
```
...
```console
$ docker pull perl@sha256:51b748cd5bdf2a1e559b8ef3df740809f003740b2b748289533f2b24187f27f5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.5 MB (336461556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0240f915ea459c189ceba16cd7fc7f8364d9fc772fe6ecf91bccfeeeb102fca2`
...
-	Layers:
	...
	-	`sha256:2f3cd7c95976bf6db5faaf7362bcafc99b3c7ecaaaf7207ff701e2d56ba14bdd`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:298fea4aa2579a1eca5209cbbdec9fb43e2e24c3f4c42bd2307457031fdc229c`  
		Last Modified: Wed, 11 May 2022 12:16:15 GMT  
		Size: 14.3 MB (14343825 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; arm variant v5

```console
$ docker pull perl@sha256:94f716cb14a1c91654f5433400804abc9ca22d413c2721bb9d0e18fe4a7344ed
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.8 MB (308813135 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78d16f79c4c9b593ea02e79266dc8ecfb1ca3ed946a4255b7e4395211986893e`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:6e08c4e0c97e145d6de1b978f220d50e547cf095cba49f9f2d144cfb65acba86`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f23c5b5fe9a1aba267d894cc3fa6fdb3b6eab62ae56c0761fbf4ab80e92a6c60`  
		Last Modified: Wed, 11 May 2022 08:33:41 GMT  
		Size: 13.6 MB (13610505 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; arm variant v7

```console
$ docker pull perl@sha256:030e673c58744add35ef05a1938669c12794db7cc0a9bdae3a307a8953402ef2
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.1 MB (296072121 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6ae6aa6adca8a3179287bb926c4de45cc4bd0861bc3795752ee4ea54f1ade51`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Wed, 11 May 2022 08:33:56 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 09:32:56 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 09:32:57 GMT
WORKDIR /
# Wed, 11 May 2022 09:32:57 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:575e6115535cc27b234b31806c2b47e3dc7275978cb4bd377d3f894ba0c6107a`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a204012d3ee898eab9775c8e70b693656341be73c5f1f196f417af9a2b730bf`  
		Last Modified: Wed, 11 May 2022 13:24:58 GMT  
		Size: 13.4 MB (13423179 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:24c69c5fe0999ab8d25ba2dbf7cf27986d514e47b2f52f34820ae61c58ef7fe1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.6 MB (327649832 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:38d393551a43a1eef511726a13ae72a03bc0a4e68fba737b9f49cadbcbd0ff59`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 03:39:12 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 03:39:14 GMT
WORKDIR /
# Wed, 11 May 2022 03:39:15 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0a21a8fb272c58e27ddff2009fb7ef4d6bde80c96bb45ab082cc653665152038`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81dcd277c46edec3c8f17152a0daa03dedabb78fbe282dd09eed740664f4ca8a`  
		Last Modified: Wed, 11 May 2022 05:02:55 GMT  
		Size: 14.3 MB (14264715 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; 386

```console
$ docker pull perl@sha256:ae3bb0972e0f1cfdfa0fc7964ddd0f04b5a0fb4c55a10f17651bdf589b8051ea
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.3 MB (341324966 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:91cbb3cd1568f9b24f6fdfae3ef2c14ee8b862e28a6c5a07f503c92b26de30c6`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 05:21:09 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 05:21:10 GMT
WORKDIR /
# Wed, 11 May 2022 05:21:11 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:3400c1e2bd6b1f95e908e0e6b96281a4e230d779585956e5d4a268b31a8085bb`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6dd1ebacb77f08ea6dab7c70b9c86dcd07089b2b2d448e9914fe717ee6c68592`  
		Last Modified: Wed, 11 May 2022 07:05:05 GMT  
		Size: 13.9 MB (13850662 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; mips64le

```console
$ docker pull perl@sha256:7f6042cc7121f0bf835ab92d1df833db93a962b2f49584713fc09f95babd5689
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.4 MB (314402948 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6ad01ba59c1da410900262c631c296169a74e55cebdbf06f47c300df06e49698`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 07:23:11 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 07:23:17 GMT
WORKDIR /
# Wed, 11 May 2022 07:23:23 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:b29621c6fc59a8feb83a2dd1297323d80dcde96d058f59fe93546e85dd9aec53`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc65c28229e1853e3d217188e81fe03f2eac56aff4e66f90cc87af226f3cb5ce`  
		Last Modified: Wed, 11 May 2022 13:50:31 GMT  
		Size: 13.6 MB (13608035 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; ppc64le

```console
$ docker pull perl@sha256:b5f9510c48f6187bc6620f8eb461c84f9eb0d166ce248a243aa7fcb9a3f72296
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.0 MB (345048732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3a2d4c2a955e69eb75a173e4809b8285882a955f9d31dc3a2acf488255480e6`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 10:54:14 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 10:54:19 GMT
WORKDIR /
# Wed, 11 May 2022 10:54:23 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:71007a85006ec4b4649e14ba031dffe5d2a302bedb1120a670033a71a0ef8180`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9aa2960b3a4ce35fb383b552d4c17a4b3e7b826717437b72f8e4477364d329d1`  
		Last Modified: Wed, 11 May 2022 13:33:53 GMT  
		Size: 14.4 MB (14370828 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded-bullseye` - linux; s390x

```console
$ docker pull perl@sha256:6ff4375ab1615dae88ed2b1bf1a824cc749d547e5b3c4c4581dce7a89899453e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.4 MB (310426770 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e4874752141dbb8ad1bb02ac6d1f70f47588596bb988c0efb2d4bbad116a20f`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:af9d0cd9682f36815b588b7d5cf9208f463a7f944ca9ee8ebed304a2df849ebc`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c495608dbaa1896d70cca922afc8069b2161fcb495a6f22cbc73f58430373c2`  
		Last Modified: Wed, 11 May 2022 05:26:29 GMT  
		Size: 14.7 MB (14684885 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
