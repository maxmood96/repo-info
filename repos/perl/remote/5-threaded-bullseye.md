...
```console
$ docker pull perl@sha256:ff24692fdb96e195284b6578d56061fb3eefa04736b03e7276e61991c39320c3
```
...
```console
$ docker pull perl@sha256:a8fb9a2663f957c6c1fcb3304fd85a63fda0bbd6f84aecde2929bb877fa30300
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.8 MB (337775382 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4a6214c7497e44f36f17c5e64319220e80a545f3011c4cab92451118e7f0ed4`
...
-	Layers:
	...
	-	`sha256:ec50d7306bb935de781b24a65e7d491fc500886cacda7c2e0ffa819b4683f2e0`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a95dce9542a7aa9a5c03abcdbf7eed57d5622e88a18deda217c5695d539a5976`  
		Last Modified: Wed, 12 Apr 2023 22:27:20 GMT  
		Size: 15.3 MB (15282731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:15289f2ee75ae0bbbb1958567eaf912df07990a1c2cda7a98f8c05c4da1321a2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.4 MB (297361614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9e0645f5019c369da10456ef5678d7367f85cc0e36bb3c55f9b5ee59379994fb`
-	Default Command: `["perl5.36.0","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 12 Apr 2023 17:07:01 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.36.0.tar.xz -o perl-5.36.0.tar.xz     && echo '0f386dccbee8e26286404b2cca144e1005be65477979beb9b1ba272d4819bcf0 *perl-5.36.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.36.0.tar.xz -C /usr/src/perl     && rm perl-5.36.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Wed, 12 Apr 2023 17:07:02 GMT
WORKDIR /
# Wed, 12 Apr 2023 17:07:02 GMT
CMD ["perl5.36.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0c25a11bca95d490b5b38ebc050cee71bf08dc4cb5c7ef00e93ecf5de4a36938`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:839a5b2119527b9c1601691d9fccf0b7dd852a56594ae7c4e0e93267fe814b3e`  
		Last Modified: Wed, 12 Apr 2023 18:18:04 GMT  
		Size: 14.3 MB (14348030 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:baaa33b5b66044c799ec158686766b38e1950173d85e6fc37f696deeff31f571
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.8 MB (315808574 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3937d28e9aa31710570422c905cf2204a7e29200bf6852ed4149cc0a7aa6f9f`
-	Default Command: `["perl5.36.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 13 Apr 2023 01:16:03 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.36.0.tar.xz -o perl-5.36.0.tar.xz     && echo '0f386dccbee8e26286404b2cca144e1005be65477979beb9b1ba272d4819bcf0 *perl-5.36.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.36.0.tar.xz -C /usr/src/perl     && rm perl-5.36.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Thu, 13 Apr 2023 01:16:09 GMT
WORKDIR /
# Thu, 13 Apr 2023 01:16:16 GMT
CMD ["perl5.36.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:71db5482291750026f5380e27afac9cd81ca60757c6192f0fd9dd1e3e82c6da5`  
		...
		Size: 134.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3c5e8dc11707ac4e0068ab028cbfac04b205ba60404be3444f6a043cf5c768da`  
		Last Modified: Thu, 13 Apr 2023 03:34:21 GMT  
		Size: 14.5 MB (14512158 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
