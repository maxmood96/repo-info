...
### `perl:5.43.1-slim-threaded` - linux; amd64
...
### `perl:5.43.1-slim-threaded` - unknown; unknown
...
### `perl:5.43.1-slim-threaded` - linux; arm variant v5
...
### `perl:5.43.1-slim-threaded` - linux; arm variant v7
...
### `perl:5.43.1-slim-threaded` - linux; arm64 variant v8
...
### `perl:5.43.1-slim-threaded` - linux; ppc64le
...
### `perl:5.43.1-slim-threaded` - linux; s390x
