...
```console
$ docker pull perl@sha256:7bc08c223ac1e8f781102e5daba9b88b71555b07b9b32b76f96c6f8d60e38ce0
```
...
### `perl:5.41.2-threaded` - linux; arm variant v7
...
### `perl:5.41.2-threaded` - linux; arm64 variant v8
...
### `perl:5.41.2-threaded` - linux; ppc64le
...
### `perl:5.41.2-threaded` - linux; s390x
