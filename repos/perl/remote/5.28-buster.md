...
```console
$ docker pull perl@sha256:77a56716b752b98effcd7698ddec4d2a4e2ada403dea3ffe781f2494b357078a
```
...
```console
$ docker pull perl@sha256:937b51b5e67f855598dcae188365e89269a25cd030a22a2f173c6dedc62c2f24
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.4 MB (291395881 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd230d58f52537e1310b8453cd828a0970cf5d4dec40bb115f911d165d84a58d`
-	Default Command: `["perl5.28.3","-de0"]`
...
# Wed, 26 May 2021 01:23:52 GMT
WORKDIR /usr/src/perl
# Wed, 26 May 2021 01:29:24 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.28.3.tar.xz -o perl-5.28.3.tar.xz     && echo '77dc1ddf541643af14d585867d3d0741cce45d0dbe8f1467024e63165d9e2fc5 *perl-5.28.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.28.3.tar.xz -C /usr/src/perl     && rm perl-5.28.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 26 May 2021 01:29:25 GMT
WORKDIR /
# Wed, 26 May 2021 01:29:25 GMT
CMD ["perl5.28.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0f4339bff237b8283a72fe17b831c303f51de23d438be767303bba87cf406d0a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fa5db5474193762e3c0379419858ccb5022ed28bf99ebb761fc72576482ecc4`  
		Last Modified: Wed, 26 May 2021 09:58:44 GMT  
		Size: 13.1 MB (13093883 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
