...
```console
$ docker pull perl@sha256:220453395ddcd6323bccb859be527f948bcf58571327eda6f0826f2d67d171fd
```
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; arm variant v5
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; arm variant v7
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; arm64 variant v8
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; 386
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; mips64le
...
### `perl:5.39.8-slim-threaded-bullseye` - linux; s390x
