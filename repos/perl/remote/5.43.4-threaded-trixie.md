...
```console
$ docker pull perl@sha256:5d6e8c616fd1e2039032ed6818dd5cd6408ee477b960835456d4ee8f14d009a5
```
...
### `perl:5.43.4-threaded-trixie` - linux; amd64
...
### `perl:5.43.4-threaded-trixie` - unknown; unknown
...
### `perl:5.43.4-threaded-trixie` - linux; arm variant v5
...
### `perl:5.43.4-threaded-trixie` - linux; arm variant v7
...
### `perl:5.43.4-threaded-trixie` - linux; arm64 variant v8
...
### `perl:5.43.4-threaded-trixie` - linux; ppc64le
...
### `perl:5.43.4-threaded-trixie` - linux; riscv64
...
### `perl:5.43.4-threaded-trixie` - linux; s390x
