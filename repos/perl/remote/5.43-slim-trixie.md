...
```console
$ docker pull perl@sha256:02f78a9acbf4f6c1dbb19330de8781ba0a9a352a27dcdad10c060f164ff866b9
```
...
```console
$ docker pull perl@sha256:012a3c5d6d2e6463d0ca583cee052b9902c16e4c81797eb32d02e385af9f8921
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.9 MB (61936338 bytes)**  
...
# Mon, 26 Jan 2026 21:53:55 GMT
WORKDIR /usr/src/perl
# Mon, 26 Jan 2026 21:58:18 GMT
...
-	Layers:
	...
	-	`sha256:496b33b2902913c37653085c508d440a6a4115d7df8dce78534bf6de5054b9c2`  
		Last Modified: Mon, 26 Jan 2026 21:58:29 GMT  
		Size: 134.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1021e5d94c2e86c586be7688e5773eaaa0e1a64d1ab38a6de64d912e2a5fcc35`  
		Last Modified: Mon, 26 Jan 2026 21:58:30 GMT  
		Size: 32.2 MB (32162386 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:480bf58140fd21bd3d44123c411d62c7b4fa64bffa544841a545bdcdce663ba4`  
		Last Modified: Mon, 26 Jan 2026 21:58:29 GMT  
		Size: 133.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:73de29a19fa542d6f0c7540f48fee58127e04dad8e39c7cca7a66aa4074b9dd8
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4028539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e379325133748ca9e641bb13726812677945f676e4c66b44fbadba8db1c081d`

```dockerfile
```

-	Layers:
	-	`sha256:97c1f7ea777b6f7572b5d4c245e0c530b4148387969e74eca1eb361c1580b5a4`  
		Last Modified: Mon, 26 Jan 2026 21:58:30 GMT  
		Size: 4.0 MB (4009412 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:bc97e152dacbaec091d3b2b6e62a4fdb126eb5c4bf3f7282280183d77479b69d`  
		Last Modified: Mon, 26 Jan 2026 21:58:29 GMT  
...
```console
$ docker pull perl@sha256:cc1768f560e54f17ae94a58e6e9f481c3d7b318f4fe21b5c34f9ed5cf04cdc2e
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.4 MB (57352948 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84e4c32d4a96b92de3664cd5a648e1662813354cbd7f201e45b2454dfe1da373`
-	Default Command: `["perl5.43.7","-de0"]`

```dockerfile
# Mon, 12 Jan 2026 00:00:00 GMT
RUN # debian.sh --arch 'armel' out/ 'trixie' '@1768176000'
# Mon, 26 Jan 2026 21:57:12 GMT
WORKDIR /usr/src/perl
# Mon, 26 Jan 2026 22:02:47 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        zlib1g-dev        xz-utils        libssl-dev     && curl -fL https://cpan.metacpan.org/authors/id/C/CO/CORION/perl-5.43.7.tar.gz -o perl-5.43.7.tar.gz     && echo 'd8aa3057fab477b779f6658e42471836cc05f6bcbfd8416959e2f8d177a47d0b *perl-5.43.7.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.43.7.tar.gz -C /usr/src/perl     && rm perl-5.43.7.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.94.tar.gz'     && echo '9d7be8a56d1bedda05c425306cc504ba134307e0c09bda4a788c98744ebcd95d *Net-SSLeay-1.94.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.94.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.091.tar.gz'     && echo 'c5996e7335912a5c99e06bdb47ff39df309a857cbd8fd2627a021cefdb53cf54 *IO-Socket-SSL-2.091.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.091.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997017/cpm -o /usr/local/bin/cpm     && echo 'e3931a7d994c96f9c74b97d1b5b75a554fc4f06eadef1eca26ecc0bdcd1f2d11 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && savedPackages="ca-certificates curl make netbase zlib1g-dev libssl-dev"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr /root/.cpanm /root/Net-SSLeay-1.94* /root/IO-Socket-SSL-2.091* /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version # buildkit
# Mon, 26 Jan 2026 22:02:47 GMT
WORKDIR /usr/src/app
# Mon, 26 Jan 2026 22:02:47 GMT
...
-	Layers:
	-	`sha256:c113d410d30c2c035a105b56d3937958c81fbe2530f44add3bae903be6864324`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b2c5f251d9e24bfcb77ff6f48ec23e82d88e15823e4e14d145a22362072dad74`  
		Last Modified: Mon, 26 Jan 2026 22:02:58 GMT  
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:df17f43ac281c924084699d36c2c1b8cea26b1fc97005ca24af69956e671b669`  
		Last Modified: Mon, 26 Jan 2026 22:02:59 GMT  
		Size: 29.4 MB (29409956 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4a660de9a5e97c611cc97e8f226a428e5c9c7eb42bd4599eb29a7b9d2511dd6e`  
		Last Modified: Mon, 26 Jan 2026 22:02:58 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:87e59f8cc4ca23f60cc7a6b62ee1c55fd26d4a58239e1b015b82bfbc4ba551f0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4021681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc47af409438f07d2eb0d0b4815dd35a56146cb52e9f215a56cb4a135d38b2a4`

```dockerfile
```

-	Layers:
	-	`sha256:d3da35e9568822c2d34fb77bdf875fdc8f8dfadd1dbea02b1d5cb49a37f1685d`  
		Last Modified: Mon, 26 Jan 2026 22:02:58 GMT  
		Size: 4.0 MB (4002457 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:180e465307e4d3781e9d08c12f8bdace48363ec993006728f597ce144ec66e2d`  
		Last Modified: Mon, 26 Jan 2026 22:02:58 GMT  
...
-	Layers:
	-	`sha256:189f7390d8a0d0286b3cfc728190ad6e8748e9503618c0d8bbba9dff6bc02b92`  
		Last Modified: Fri, 16 Jan 2026 19:03:27 GMT  
...
```console
$ docker pull perl@sha256:a73627a88a1e2728758a0bf5aef081f1ba994814932c348117647199e537eb53
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **61.4 MB (61354961 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6701d33f39408c6f30c0a8b0a82fe8c0e175108447144912913f71fd32c4df41`
-	Default Command: `["perl5.43.7","-de0"]`

```dockerfile
# Mon, 12 Jan 2026 00:00:00 GMT
RUN # debian.sh --arch 's390x' out/ 'trixie' '@1768176000'
# Mon, 26 Jan 2026 21:52:29 GMT
WORKDIR /usr/src/perl
# Mon, 26 Jan 2026 21:58:30 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        zlib1g-dev        xz-utils        libssl-dev     && curl -fL https://cpan.metacpan.org/authors/id/C/CO/CORION/perl-5.43.7.tar.gz -o perl-5.43.7.tar.gz     && echo 'd8aa3057fab477b779f6658e42471836cc05f6bcbfd8416959e2f8d177a47d0b *perl-5.43.7.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.43.7.tar.gz -C /usr/src/perl     && rm perl-5.43.7.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.94.tar.gz'     && echo '9d7be8a56d1bedda05c425306cc504ba134307e0c09bda4a788c98744ebcd95d *Net-SSLeay-1.94.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.94.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.091.tar.gz'     && echo 'c5996e7335912a5c99e06bdb47ff39df309a857cbd8fd2627a021cefdb53cf54 *IO-Socket-SSL-2.091.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.091.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997017/cpm -o /usr/local/bin/cpm     && echo 'e3931a7d994c96f9c74b97d1b5b75a554fc4f06eadef1eca26ecc0bdcd1f2d11 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && savedPackages="ca-certificates curl make netbase zlib1g-dev libssl-dev"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr /root/.cpanm /root/Net-SSLeay-1.94* /root/IO-Socket-SSL-2.091* /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version # buildkit
# Mon, 26 Jan 2026 21:58:30 GMT
WORKDIR /usr/src/app
# Mon, 26 Jan 2026 21:58:30 GMT
...
-	Layers:
	-	`sha256:2b46bc94baaae0a37e5e04b1babf7e1f37c4390b83d49c3c6820188deba770e3`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:235fe2399c13c76fe631bfd318d23a817ee6c9538182d883c927031c47d45108`  
		Last Modified: Mon, 26 Jan 2026 21:58:48 GMT  
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:08d6a6f836eaa7b901550637d4b8c2ac075b633d311b940eeeed5f2b3fde5bee`  
		Last Modified: Mon, 26 Jan 2026 21:58:49 GMT  
		Size: 31.5 MB (31521283 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3083715fae307816dee2a143561fe249ffd7906bb4172e80f0c7681030445cf9`  
		Last Modified: Mon, 26 Jan 2026 21:58:48 GMT  
		Size: 131.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:a6f7699cf3ca74e1220ff3b33b07df880fba08043ff689ef8e83274fb5cc6fdb
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **4.0 MB (4020868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:900a4e9ab0bdb32fd39a4869e549d04da3eae60ad81395db3fd73b21c93f4fd6`

```dockerfile
```

-	Layers:
	-	`sha256:a8de6d88e8f78a7d70f099783b5874fc5b2658dcca7ef3290000aeaf14e820ce`  
		Last Modified: Mon, 26 Jan 2026 21:58:48 GMT  
		Size: 4.0 MB (4001740 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:78dee511a1af6882cbe072f9c20d492f087d3e57ebc013f0f2a3533b772509e7`  
		Last Modified: Mon, 26 Jan 2026 21:58:48 GMT  
