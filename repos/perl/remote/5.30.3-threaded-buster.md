...
```console
$ docker pull perl@sha256:71a6a477525247c27baf6825dbebb932be3f9bf74ee017becb7ac3cbf9361b5b
```
...
```console
$ docker pull perl@sha256:3740091ffc513da2587340d7ea8588a4fad21a84a99a3636c01da14e1134090f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.5 MB (326477648 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:62d1f5a8d57b48ee20b9c94170764e5fe5d23145cbc41eebd694d9731afacd90`
...
-	Layers:
	...
	-	`sha256:7ee8ddc463fd0224112f41976e81d15dd46444f93185d9cde6203a0185857be2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d9d6ba2a5fee779c81473a741e14daf7f810df347f59a04a8fe4f1446d4ec28`  
		Last Modified: Wed, 11 May 2022 12:20:01 GMT  
		Size: 1.5 KB (1451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:74e4f2f7ce88fa86a8e94d8a3b3a91363951144d794dffaa79ef19edda8ad639`  
		Last Modified: Wed, 11 May 2022 12:21:03 GMT  
		Size: 13.9 MB (13858474 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:87cc981d67ed6954e8416c07f537f189ddddd57aa826bafed154bed7f3879c7a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.2 MB (335182759 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:19615002ec94015326f750e06606f64c3809a840150d0cd04541084134162e94`
-	Default Command: `["perl5.30.3","-de0"]`
...
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		autoconf 		automake 		bzip2 		dpkg-dev 		file 		g++ 		gcc 		imagemagick 		libbz2-dev 		libc6-dev 		libcurl4-openssl-dev 		libdb-dev 		libevent-dev 		libffi-dev 		libgdbm-dev 		libglib2.0-dev 		libgmp-dev 		libjpeg-dev 		libkrb5-dev 		liblzma-dev 		libmagickcore-dev 		libmagickwand-dev 		libmaxminddb-dev 		libncurses5-dev 		libncursesw5-dev 		libpng-dev 		libpq-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		libtool 		libwebp-dev 		libxml2-dev 		libxslt-dev 		libyaml-dev 		make 		patch 		unzip 		xz-utils 		zlib1g-dev 				$( 			if apt-cache show 'default-libmysqlclient-dev' 2>/dev/null | grep -q '^Version:'; then 				echo 'default-libmysqlclient-dev'; 			else 				echo 'libmysqlclient-dev'; 			fi 		) 	; 	rm -rf /var/lib/apt/lists/*
# Wed, 11 May 2022 05:00:27 GMT
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Wed, 11 May 2022 06:24:15 GMT
COPY file:dd6fa346215843e86af65c06cf37b4a608c128f716b4ff041f78456a2ffdc5f0 in /usr/src/perl/ 
# Wed, 11 May 2022 06:24:15 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 06:49:15 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 06:49:16 GMT
WORKDIR /
# Wed, 11 May 2022 06:49:17 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:15d4335971c3c6abcc0cee05c5dc4d86bb28ee87ad0592c808e4454c0579e3ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:29e06679375820bb14455409a0ca38e85ee44de2842f19146ba1ff3df4869af9`  
		Last Modified: Wed, 11 May 2022 07:09:27 GMT  
		Size: 1.4 KB (1427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2a5443e3e5463997d3d0a484d95e24ec8539912032f49f69186df7320a4c54f4`  
		Last Modified: Wed, 11 May 2022 07:10:38 GMT  
		Size: 13.4 MB (13383879 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:4099fe2bf2447c76f501f38939a0b4456905a1b59769d515948554bbe309e097
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.9 MB (308854457 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8acc0986394168b1b6cfcb67d0af36fde1d71222636142d18f083194613e8968`
-	Default Command: `["perl5.30.3","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Wed, 11 May 2022 04:45:10 GMT
COPY file:dd6fa346215843e86af65c06cf37b4a608c128f716b4ff041f78456a2ffdc5f0 in /usr/src/perl/ 
# Wed, 11 May 2022 04:45:10 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 05:11:06 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 05:11:07 GMT
WORKDIR /
# Wed, 11 May 2022 05:11:07 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:1d011b6ca25acd6dc401817177e6000cfe8ea9d25a715781c81a70150cbd61b0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:25332130227024cf7921cad13e958fd0b8b660b5f1eddf2a340234f1bcb4195b`  
		Last Modified: Wed, 11 May 2022 05:29:08 GMT  
		Size: 1.5 KB (1451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63bc50cf3eb94b2581e597503a10a2e67c6fa92176952378ca69b56fe204f771`  
		Last Modified: Wed, 11 May 2022 05:29:53 GMT  
		Size: 14.2 MB (14203085 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
