...
```console
$ docker pull perl@sha256:c80ddb7bbefedc653b69bc96dcbd5e12cfb089c4f59b99e342b69986b14a381e
```
...
```console
$ docker pull perl@sha256:c46580d11e3a380f7b2fcd7fe4405f20bba37cb1e9718f066a31d59291005c51
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.3 MB (291278378 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3082a7abb2b26271f51341bdb93659f031a8501cfe09cd7421f4d767dead7d22`
-	Default Command: `["perl5.30.3","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 12 May 2021 08:47:57 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 12 May 2021 08:48:03 GMT
WORKDIR /
# Wed, 12 May 2021 08:48:08 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:2822312b5ef5dedbcb681dd35739756d82a14c15ff716caed4c701ac2d7505de`  
		...
		Size: 621.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1ba6dc061aa0d8a4a46622afc83a5463e064646712c1f4ba097dc36fe7f0befd`  
		Last Modified: Wed, 12 May 2021 10:54:08 GMT  
		Size: 13.0 MB (12978996 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.30.3-threaded-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:32dc1476c5bb1ecbe06c646f00b1b2816dd27124a9daa9b62ba2577f7e6a04d4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.8 MB (316772840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3234774d2f8c4f0371fb90b1b54d4678a2fe4df81e7fe9be7b8049149f0c87be`
-	Default Command: `["perl5.30.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:877f58c19e0c72a51472d3270de9271b6ebf999492a2f7fa19b4c097e2352b13`  
		...
		Size: 619.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec8b5c978b6674f5f99bcb9d7020e102b94df596f3f72fff68e06185c50f9548`  
		Last Modified: Sat, 22 May 2021 08:30:36 GMT  
		Size: 13.8 MB (13794819 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
