...
```console
$ docker pull perl@sha256:a6b6279ebfb0758d47588993e5703281518a3d1f9aed89f21d6e0aaab54b6033
```
...
```console
$ docker pull perl@sha256:0614671edbcf95187d01fddbb481fbe4bf9fc3a55c31eeb69e8e0ac67819f595
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.5 MB (326482352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:56504a23330f588d83c58fc7a48656d34f4bb4859bb691681c97f4959b7308a2`
...
-	Layers:
	...
	-	`sha256:9008d38bf62ba214092b5dbcd3a4955b1303bd42663a14266432ba0a96956c09`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84254d8b03344516708298cd9b3b6906d04e6df7011f95b12236762903f9dec8`  
		Last Modified: Tue, 29 Mar 2022 22:49:47 GMT  
...
```console
$ docker pull perl@sha256:66dc28f68c97b40aaf3bb4b944e97aa0b4c99b673bd84cea510d20915f4f25ac
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.7 MB (316748175 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:16d0aa13e0e56d26829b5eb009fddf12cf1613199b2b70537955e01ead5cbcfc`
-	Default Command: `["perl5.30.3","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 30 Mar 2022 08:03:18 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 30 Mar 2022 08:03:19 GMT
WORKDIR /
# Wed, 30 Mar 2022 08:03:20 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:7be7ca70ce2e18de5cc36da6343494c68486c2ac8bab05a88e510e9755a50df1`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89eeb28d498f681d433525c197e88033e429952913d6dc8c9eca6d83716a6d09`  
		Last Modified: Wed, 30 Mar 2022 08:25:34 GMT  
		Size: 13.8 MB (13799950 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.30.3-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:6f26e0c087f7790c90eb7ae34ba9d10c6a79f84d1517ba60aad2652faea1be60
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.2 MB (335185766 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5dd90b9252d12088cb8e156680abc4606da40b485ef07a3418883ebe720a4f9`
-	Default Command: `["perl5.30.3","-de0"]`
...
# Wed, 30 Mar 2022 01:48:40 GMT
WORKDIR /usr/src/perl
# Wed, 30 Mar 2022 02:03:37 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 30 Mar 2022 02:03:37 GMT
WORKDIR /
# Wed, 30 Mar 2022 02:03:38 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:9e565efa046dc98f3314ee2a1f680f97d5b29a1940b10b9d295196260909e56f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00e5e2a49757b27815857236841231726412a6dc6da63513bbd49e67678a7c3e`  
		Last Modified: Wed, 30 Mar 2022 02:11:47 GMT  
		Size: 13.4 MB (13383910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:668db2773f0636a9f09b335eb433f5e9afd611b9eb4ddbb608f0d8f8e6a34188
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.9 MB (308866841 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ac56355434ec1bddf106091a3739508e26a891a98b99dfe1491b3a30b0071ed3`
-	Default Command: `["perl5.30.3","-de0"]`
...
# Wed, 30 Mar 2022 04:02:38 GMT
WORKDIR /usr/src/perl
# Wed, 30 Mar 2022 04:26:10 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 30 Mar 2022 04:26:12 GMT
WORKDIR /
# Wed, 30 Mar 2022 04:26:12 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8186a5ed8327beaba92d25b1e988852b4d4c6b44f760619b1e271bbb8fc272f5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23723cf86fe8646c4200a49a9dbcf32d01ace0314f7fd17c168b051f0a387647`  
		Last Modified: Wed, 30 Mar 2022 04:44:25 GMT  
		Size: 14.2 MB (14202931 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
