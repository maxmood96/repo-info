...
```console
$ docker pull perl@sha256:8c06c236e052afc508a60f42201f8054df95b70c6703d908db42a6c4d438f486
```
...
```console
$ docker pull perl@sha256:609eb080d360bb95f70c45073b5d84b96fb68ec11926617ab68f54a159b81b77
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.4 MB (326359767 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2e27542c9bfc782d2ae2f57b782e87697c7df6257f3638294fca3280ef231cf5`
...
-	Layers:
	...
	-	`sha256:0c9c5cbe8a0e17ac2916a56cdabf35926de67aa851a5c1dad6055f616bf0eaae`  
		...
		Size: 614.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f4763c7b0c16a3991f8226febe1b9a6a117b816f46ecd5b3edd34b8538a28ad`  
		Last Modified: Thu, 22 Jul 2021 13:31:36 GMT  
		Size: 13.9 MB (13858385 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:d48dfb1b44e758a21a5c4d51075b76b068a92dfb5523d2d02ed104792633ae18
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.8 MB (316839286 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1379cd2a74a476c174b3b800ec7e1b0db765036813738a960609a45cb3b0c6ff`
-	Default Command: `["perl5.30.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:6262eb1b2ff0f8ae8426e0dd88ad150cd0f19316a81ab898f76543275ef4a6e4`  
		...
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4db7a7f62cd480b911522df7c508b83b8d369b0c4be155e35e3b9fd2d5d03dc8`  
		Last Modified: Thu, 22 Jul 2021 07:57:52 GMT  
		Size: 13.8 MB (13794499 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.30.3-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:976f0aa434a0ff043ff1e18015cfeaabef4a450be0d232886e75ad7cb5c9f222
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.3 MB (335303450 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6bf87e3077a46976aeb6aba8a7a0ae74256ad9a97ca09059df30b720ccbdd42`
-	Default Command: `["perl5.30.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:662b9617ba2287c524d31dbca340fa64234fdb3d95a7aca594eabda638449a87`  
		...
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e7b51fa9af6320da56ec15df9d98157b0e1177df058b6fa911db4e9503d0620`  
		Last Modified: Thu, 22 Jul 2021 09:38:05 GMT  
		Size: 13.4 MB (13387072 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.30.3-threaded-buster` - linux; ppc64le

```console
$ docker pull perl@sha256:894ebcca6702e7701abe76b1b8eecb121f90164fc3bb5343e83e3420bcc599ee
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **347.9 MB (347871954 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e58f81839c5f0d5f6234e08a30872f1b4a632d91370c5c444c1cc1a08e21180a`
-	Default Command: `["perl5.30.3","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 22 Jul 2021 23:41:21 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 22 Jul 2021 23:41:29 GMT
WORKDIR /
# Thu, 22 Jul 2021 23:41:34 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:97849d6cf54ded123d92ac38b028de54f08b4facfd4a76f11422242823ca50d1`  
		...
		Size: 617.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aa274fbcd96e0fbaf86c6914092653ba0b116f37f9ab928ba1eb5a5f16f81684`  
		Last Modified: Fri, 23 Jul 2021 00:04:12 GMT  
		Size: 13.9 MB (13948637 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
