...
```console
$ docker pull perl@sha256:d478210d42971c392b349c1d41768d5d1edc4d295e0b287f995e37fc8fcabcfa
```
...
### `perl:5.40.0-slim-buster` - linux; arm variant v7
...
### `perl:5.40.0-slim-buster` - unknown; unknown
...
### `perl:5.40.0-slim-buster` - linux; arm64 variant v8
...
### `perl:5.40.0-slim-buster` - linux; 386
