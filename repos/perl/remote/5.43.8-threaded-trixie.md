...
### `perl:5.43.8-threaded-trixie` - linux; amd64
...
### `perl:5.43.8-threaded-trixie` - unknown; unknown
...
### `perl:5.43.8-threaded-trixie` - linux; arm variant v5
...
### `perl:5.43.8-threaded-trixie` - linux; arm variant v7
...
### `perl:5.43.8-threaded-trixie` - linux; arm64 variant v8
...
### `perl:5.43.8-threaded-trixie` - linux; ppc64le
...
### `perl:5.43.8-threaded-trixie` - linux; riscv64
...
### `perl:5.43.8-threaded-trixie` - linux; s390x
