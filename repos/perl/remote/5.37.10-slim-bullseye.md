...
```console
$ docker pull perl@sha256:b08a4d583460776372f8ddb7532c5759aa1f4b192975f7fc9ee538ef6394d2a2
```
...
### `perl:5.37.10-slim-bullseye` - linux; amd64
...
### `perl:5.37.10-slim-bullseye` - linux; arm variant v5
...
### `perl:5.37.10-slim-bullseye` - linux; arm variant v7
...
### `perl:5.37.10-slim-bullseye` - linux; arm64 variant v8
...
### `perl:5.37.10-slim-bullseye` - linux; 386
...
### `perl:5.37.10-slim-bullseye` - linux; mips64le
...
### `perl:5.37.10-slim-bullseye` - linux; ppc64le
...
### `perl:5.37.10-slim-bullseye` - linux; s390x
