...
```console
$ docker pull perl@sha256:64c42c0b89d20045d831422a7491326bc7323c2c5513d709c4475c6be941765a
```
...
```console
$ docker pull perl@sha256:3c865dbf5e8549170ed4b9f7617bbe00e5e5495bfef64770044e9ce596a118b9
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326927934 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:043bec2c2616674b3bb5efad317b0f7f350a6afd157d3cc57d5c60bde0cf786b`
...
-	Layers:
	...
	-	`sha256:d0e7aeaac0ce51e503c4886524dcaf58e9e9ea51b0d0f6ef157069469eca5d39`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:79406303f659bfdb3b8f938bf27a82c3d6d01a455092248cd81093ff2d64c1d4`  
		Last Modified: Sat, 04 Feb 2023 18:29:41 GMT  
		Size: 14.8 MB (14825127 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:851114ce60a5e2016a5f5ed58516bf0ab510f15c451171ad698968a1981d1ff4
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291852422 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:354739049e8e9c3728631682d2c455bdff3059b27f32f4d012e2e3a03c2ce5fb`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Sat, 04 Feb 2023 14:09:49 GMT
WORKDIR /usr/src/perl
# Sat, 04 Feb 2023 15:51:05 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Sat, 04 Feb 2023 15:51:06 GMT
WORKDIR /
# Sat, 04 Feb 2023 15:51:06 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0466b95a25b07f6f48123727fb2af1bd42e21ed8d30c0f1a8309de5618e30653`  
		...
		Size: 134.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8416a6243ccb15f7652b71fcfb32daf73a09511cd34c78d8603e9c898d28e107`  
		Last Modified: Sat, 04 Feb 2023 17:27:53 GMT  
		Size: 13.9 MB (13937079 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:3a5ad396c48444695dda17da3fc12c0ad99bacd045b4f6e8aa4283eb64c58be3
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.4 MB (317427866 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7b92f4d1140b803482ca37ba770ac2fd1b5f4528e7aff41daf3797bc004b4443`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:de1ec5dabe1d913e3415ffc6f437b5cf20e9db44899f251c4c576f46c1f9b1f5`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0c228c43df656bbe442bbf4edc7ebdf5066acc6c426e9cac8eddcb00d3b2ec7`  
		Last Modified: Sat, 04 Feb 2023 12:02:10 GMT  
		Size: 14.8 MB (14763788 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; 386

```console
$ docker pull perl@sha256:3917201f438d3db4b42900b1aebf8a86267ffcbacf7f969136177c6e1bcacd59
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.6 MB (335594123 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32b5dfb977bca0e7e5a85638097e91058e0f8397861411497dcb48b0d3479a7d`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Sat, 04 Feb 2023 10:40:01 GMT
WORKDIR /usr/src/perl
# Sat, 04 Feb 2023 12:29:50 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Sat, 04 Feb 2023 12:29:51 GMT
WORKDIR /
# Sat, 04 Feb 2023 12:29:52 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:95a417b5f3417b2f81129105fb54f9b284a76e4bd949e1943be7724d92beda02`  
		...
		Size: 134.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16479efd8abec9533120177b92e596260046dd1ad82fc0408ccb41e4015c124f`  
		Last Modified: Sat, 04 Feb 2023 14:11:39 GMT  
		Size: 14.3 MB (14314855 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
