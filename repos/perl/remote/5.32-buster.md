...
```console
$ docker pull perl@sha256:166516496fb12ca958d74916beba451f0770e253b21c4ddb26997f202df8c120
```
...
```console
$ docker pull perl@sha256:010cab05f998a50ae893623da3ee54ee1e3d9b5b60ce9372cd69c68713fe6196
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.7 MB (326690329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d4136c3438100437c966516d72396162f80e2988ffdce2fa8e403e2173ab6f3d`
...
-	Layers:
	...
	-	`sha256:7fbaf488b6c23566c7d43166fba7c2adb147809a8ef885ef9de07d763ed74ca4`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7d1a04bc91eb28483df06b98883abfda053a2544bf3cab65188f826a109a04d`  
		Last Modified: Wed, 11 May 2022 12:18:05 GMT  
		Size: 14.1 MB (14072405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:d983e12f07bea9710b834ca3bdb182e5044d2f3705fd480d5bbbe016d01b50c5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.4 MB (335363340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:339d18c475b770ff262876ccafcbf55563cee4f836f1bb089638cee677c5be01`
-	Default Command: `["perl5.32.1","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Wed, 11 May 2022 05:00:28 GMT
COPY file:3744c5cc39cdbdcae10db09a1f0f399005a79f93c237b387a72ff5710cdd458c in /usr/src/perl/ 
# Wed, 11 May 2022 05:00:29 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 05:47:17 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 05:47:18 GMT
WORKDIR /
# Wed, 11 May 2022 05:47:19 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:15d4335971c3c6abcc0cee05c5dc4d86bb28ee87ad0592c808e4454c0579e3ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ba92e672c6495aa988fce21a64e6c7826d3390140f9cfde5e39ff4cf55d37847`  
		Last Modified: Wed, 11 May 2022 07:03:51 GMT  
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f54e8df7d330e48c1d92abe1a5bbe64fa4575d922c5a3d5291866a0138d5adc6`  
		Last Modified: Wed, 11 May 2022 07:07:13 GMT  
		Size: 13.6 MB (13565709 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:13f6575480109230d592b06946c6ac90b42a95d76d588a549ef3fd6ab29a3462
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.1 MB (309058127 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1d40a4a382d3d69d8d136d901261c5ef1b3626a32875777cd1e78703ef19fd9c`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 04:03:49 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 04:03:54 GMT
WORKDIR /
# Wed, 11 May 2022 04:03:54 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:4ab75c2255c945685cc7a6fd5936a8aad251d3ddae61ce441c5de759f4a5f9a2`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0686b5c9ea4c78fa426f05e72bb0576dd1c1613f81becf1cbbee4eade7e60f7`  
		Last Modified: Wed, 11 May 2022 05:27:46 GMT  
		Size: 14.4 MB (14408007 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
