...
```console
$ docker pull perl@sha256:f2b2fc1df2a9affe4838f09766115801ddce552245e608c92a12827abfe8b51a
```
...
```console
$ docker pull perl@sha256:69c4ea7e5073c2efc69c3ca07cf503f041b3252ab65f0c6385c544f3347aa1da
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.9 MB (316889890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31ceb8e487d687cabd3b2447b46d121da4523b07f84571af08eba75223a6dcc1`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Tue, 01 Mar 2022 14:35:22 GMT
WORKDIR /usr/src/perl
# Tue, 01 Mar 2022 15:12:24 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 01 Mar 2022 15:12:25 GMT
WORKDIR /
# Tue, 01 Mar 2022 15:12:26 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:42f127c7a991c30006d4fa2b456aa053b7fbb38e4fb5c24cf6c42279a567ab50`  
		...
		Size: 180.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3644832736dce67007fdd8378ca7540d75f9c2a87833b3c7b514e9332e5311df`  
		Last Modified: Tue, 01 Mar 2022 16:16:38 GMT  
		Size: 14.0 MB (14020260 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:b35bb2e9421b8d06c73f48a0e2b94bc0b388aa9b4c4a043c1f48b1e6db4379d0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.5 MB (310467749 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2235c3a67d0c4092c44cb8ad85ff4efd9064f985f65ae31d4239578117ff3936`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 01 Mar 2022 08:01:55 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 01 Mar 2022 08:01:56 GMT
WORKDIR /
# Tue, 01 Mar 2022 08:01:56 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:a1bdc2532011d90d0ee5ca49cd96158c741d76b6baf401607b6f4605cde74135`  
		...
		Size: 176.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4547bf4bd81356595b0d214fff7220bba1a222074cf91ec32165a10bf7dcd41`  
		Last Modified: Tue, 01 Mar 2022 12:39:58 GMT  
		Size: 13.3 MB (13324365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
