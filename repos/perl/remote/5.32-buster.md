...
```console
$ docker pull perl@sha256:8053aacd3bdee769ccc44586cf9ba829ab33e8a8018566bc66493105cd59188c
```
...
```console
$ docker pull perl@sha256:a10ef20c51e516c754c9546af1b1461194885a86a45e809cbfdd92cffc1cf02f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326931101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1b0d1272d45a1fb044f95d35e15efd37a4fe40a1cff08a389133ebeaeb4687b3`
...
-	Layers:
	...
	-	`sha256:054857abe66de80f9c325409f770811251a8d1b02c8e9c6af08a0d80d5e84e2c`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0638a2e7e18ef55af9e94d46e1fca68e0f70c6284e1ad4b49c7efba665e58878`  
		Last Modified: Thu, 09 Feb 2023 14:37:17 GMT  
		Size: 14.8 MB (14825238 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:4dd649c7cd44a0c0ee2dcc02d7f63807a1ca4e198b4bcd0dbf8c80d1ff7671cc
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291854481 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d82d77c7a8286600eb2e773b24d80246d723517a09f7b16c6a9df45630c9dbca`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:69a847bd147e15d0b070fb1c7237703b194d641563f62393134bc519ad8d43ca`  
		...
		Size: 134.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8644f8e813669b7896291a4d8f542cce6ee0c5402366ce204ed266b1bea23567`  
		Last Modified: Fri, 10 Feb 2023 07:31:46 GMT  
		Size: 13.9 MB (13937811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:b85b10e780a9449b9fd63053d6f4bcfe219af8272b871696bd931c8e001fc1f2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.4 MB (317430120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c5b8ae478e39f28142c5846961b7553b3f086119fd9fbc9390b11a4d0d01ab56`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:dd122db4a1a96232dc7eb754f4c7589aff6a17c47fae9f40aa21f9b7785ecad0`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44c366dd54876d09c42b5de9d5a26ad8850f66d45b1576cd29d28bb7a61795da`  
		Last Modified: Wed, 01 Mar 2023 08:08:00 GMT  
		Size: 14.8 MB (14763731 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-buster` - linux; 386

```console
$ docker pull perl@sha256:82e9d19d8a9b106195002f9c526c8dbb322c30a2a86e43bc208f1613e6d28774
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.6 MB (335593090 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:00ed32a05ec38fda21947690159304ffe883362e0818272c4923c44cd3068255`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 09 Feb 2023 13:28:56 GMT
WORKDIR /usr/src/perl
# Thu, 09 Feb 2023 15:18:34 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Thu, 09 Feb 2023 15:18:35 GMT
WORKDIR /
# Thu, 09 Feb 2023 15:18:36 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:830148373c22f2accdd5774a3306558f946f60e591aefb7bf38373de17e67084`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b685a353b5df2a5cd886a391dc7892ea21b5dfbcdda5dfbb37de37ef2cf1eb5`  
		Last Modified: Thu, 09 Feb 2023 17:01:01 GMT  
		Size: 14.3 MB (14315048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
