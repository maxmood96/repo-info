...
```console
$ docker pull perl@sha256:1147e47876349e55416b071b70a8e808e20618ddc66e0e27bb03267389479db2
```
...
```console
$ docker pull perl@sha256:0b4f5015d4af085071558ea55bb0dcc41a69da6ccd74e251c1cd2311b15393c4
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **57.0 MB (56963334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b3d63fa63da748f67112f848fc3c59d3f7e83b4023c5765d8b50c59b62c249b`
-	Default Command: `["perl5.42.0","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 25 Feb 2026 07:39:57 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        zlib1g-dev        xz-utils        libssl-dev     && curl -fL https://cpan.metacpan.org/authors/id/B/BO/BOOK/perl-5.42.0.tar.gz -o perl-5.42.0.tar.gz     && echo 'e093ef184d7f9a1b9797e2465296f55510adb6dab8842b0c3ed53329663096dc *perl-5.42.0.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.42.0.tar.gz -C /usr/src/perl     && rm perl-5.42.0.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.94.tar.gz'     && echo '9d7be8a56d1bedda05c425306cc504ba134307e0c09bda4a788c98744ebcd95d *Net-SSLeay-1.94.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.94.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.091.tar.gz'     && echo 'c5996e7335912a5c99e06bdb47ff39df309a857cbd8fd2627a021cefdb53cf54 *IO-Socket-SSL-2.091.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.091.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997017/cpm -o /usr/local/bin/cpm     && echo 'e3931a7d994c96f9c74b97d1b5b75a554fc4f06eadef1eca26ecc0bdcd1f2d11 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && savedPackages="ca-certificates curl make netbase zlib1g-dev libssl-dev"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr /root/.cpanm /root/Net-SSLeay-1.94* /root/IO-Socket-SSL-2.091* /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version # buildkit
# Wed, 25 Feb 2026 07:39:58 GMT
WORKDIR /usr/src/app
# Wed, 25 Feb 2026 07:39:58 GMT
CMD ["perl5.42.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:6a72e552c96250280de2ea8f31684d4f2c879abfd60cca2d0d877ef78f5fc728`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:a7800f8c0ebe7c31a74e3d54ff45e7c2234822497e2e1f6ce9ee5c2499204f04`  
		Last Modified: Wed, 25 Feb 2026 07:40:46 GMT  
		Size: 28.4 MB (28436871 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:45d0e576a83ab0a20c61678029411d8b6aaa6d84cf2240f4e010a3f8db80412f`  
		Last Modified: Wed, 25 Feb 2026 07:40:43 GMT  
		Size: 131.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:08e75c0d738f5f71e76864bd570daba3a6e314e4c0907e5723ed6f712609748d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.8 KB (18787 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db8c5759b92b0f6db2d8af38efb6e2530bbce930a9e24746e14d1e5e809183a5`

```dockerfile
```

-	Layers:
	-	`sha256:425e0b295f58aa3175313902ec2e13f788590b6fe9dfc8d554e8caf61896abf4`  
		Last Modified: Wed, 25 Feb 2026 07:40:43 GMT  
...
```console
$ docker pull perl@sha256:f9eb00699b8e01b988c58be031445a3083a34991960befd7042ca2d21e13e60c
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **63.2 MB (63181030 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:49ce13a5770094b5d625444613ece4cc5e47d202b8b7d28ed9166f3e7f1543e2`
-	Default Command: `["perl5.42.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:50b5842780fa5bd6d701ea78bd64af0d648da737b0c7b201d4f5a02e0b641fca`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:f091747a8c494e33199c45168b42f95e0b7150a6640ef5ba3b1c51db7db527a7`  
		Last Modified: Tue, 24 Feb 2026 22:07:40 GMT  
		Size: 31.1 MB (31102429 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:b612fe4142c355bfe41a3620cc2e46e0dc5cf348bf69122058226f0437554270`  
		Last Modified: Tue, 24 Feb 2026 22:07:39 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:a3027253cc157419af52adabe03a1daeb1a46f37cea8d8a0cfb2c884172087e0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3944969 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:593e7797621b1716f36f58dc209f68686d65adbfbf082304be55614eddfa0f9f`

```dockerfile
```

-	Layers:
	-	`sha256:1da3c1eec177161b8e97c2c4da062693a0fadfb84b799159cfeca2117ce6429f`  
		Last Modified: Tue, 24 Feb 2026 22:07:39 GMT  
		Size: 3.9 MB (3925992 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e064e4ccb0da1385581aeb1a1517fefbf7ceecd2c84773cfd08649e8aeadb0e6`  
		Last Modified: Tue, 24 Feb 2026 22:07:39 GMT  
...
```console
$ docker pull perl@sha256:f59ba7e3b4b734e1790c242a19a04f3d94466cbf0e6baaf5fb57329953f3cc33
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **55.7 MB (55706633 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a126f01507f41fea9c874b4833dc5417a8bb9bdd985c65b46ad83fe4ca26efad`
-	Default Command: `["perl5.42.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:396ddaf8ace3f4d24d8474710468aab0188969705d2bfdc207a43ff97014efdd`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7b94b40a3dcda39b61b4823337703847bc856081d4d5e540435c4851cfeb727d`  
		Last Modified: Tue, 24 Feb 2026 21:27:13 GMT  
		Size: 28.8 MB (28814841 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3dd5a3e6b77742e1f4577c7e6e8679cdfb97f601e469a9da612c95254a07ea53`  
		Last Modified: Tue, 24 Feb 2026 21:27:12 GMT  
		Size: 133.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:046ec1341143d0d5400c85df9ee0a1b03cea918b48be943eaf9058caaae49725
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.9 MB (3944252 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a50ebafe572f327874909fedfb0fb75e5c1fce82f19e7529ba82831aeb0409ea`

```dockerfile
```

-	Layers:
	-	`sha256:61e7ecf09f28ded1ac2a09419e7b17af3a412d7728672c49d466d74ad60c6551`  
		Last Modified: Tue, 24 Feb 2026 21:27:12 GMT  
		Size: 3.9 MB (3925325 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:ccc5fcf179907512e746fde5d3c18750f9db46b0e8ca184eb6d2f8e757069303`  
		Last Modified: Tue, 24 Feb 2026 21:27:12 GMT  
		Size: 18.9 KB (18927 bytes)  
		MIME: application/vnd.in-toto+json
