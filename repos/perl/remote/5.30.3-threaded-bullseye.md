...
```console
$ docker pull perl@sha256:6aaec542430cf7391fe7a0c490569360eed58e57a84df7dd581e5c9a091be17b
```
...
```console
$ docker pull perl@sha256:a3e1bb08bdd7844a51de4f182c3ba062739c4b80bb7ded1a3c615dfeb82f3776
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327136211 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:be4f7ccc7fd6beff3d5d1e46566d2d7a2fc4d40958ca342789910edbe87093ca`
-	Default Command: `["perl5.30.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:6e16f1c1b485642d946863042bc694cb5800551b56ff1e853abeb82f1e481b54`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c0bbc3dcc99d0f0aef24334f20b036494118de04deb7c1a1111896944951b3f3`  
		Last Modified: Wed, 30 Mar 2022 08:25:13 GMT  
		Size: 13.8 MB (13775576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.30.3-threaded-bullseye` - linux; 386

```console
$ docker pull perl@sha256:4872dd58122d779a91358f4d0c87b9129b73c4fb105aaf423fda8562fe3f5f1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.8 MB (340821845 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1eb2ce27738e8ccdff2a09021d91871bf1d659f08bfffb70202e7146324273f3`
-	Default Command: `["perl5.30.3","-de0"]`
...
# Wed, 30 Mar 2022 01:43:42 GMT
WORKDIR /usr/src/perl
# Wed, 30 Mar 2022 01:58:34 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 30 Mar 2022 01:58:34 GMT
WORKDIR /
# Wed, 30 Mar 2022 01:58:35 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d41433a36693e1fd04709d426e54e3cbc4e11b0cdb9198ab9687cb5c5682b1b5`  
		...
		Size: 1.4 KB (1427 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a1ec737e68f21bf7a997061808b0b1ee71895335f538ceb0642dd74a98a83ff`  
		Last Modified: Wed, 30 Mar 2022 02:11:26 GMT  
		Size: 13.4 MB (13373355 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:db0f028c442ea94dfa78a7eabec8045d28166735c62a18e9141dfe1a4ded424c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.9 MB (309921551 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3839492bfe0c22c1371452a52bf056cf99aba65c0b1ada926fa2f579113f0cd`
-	Default Command: `["perl5.30.3","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 30 Mar 2022 04:21:02 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 30 Mar 2022 04:21:03 GMT
WORKDIR /
# Wed, 30 Mar 2022 04:21:03 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d6b862e45da305003947c0f9f6c4289309fc2d370baae9dd43b4005377ffc7a2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d8e4f0e0f43476969169e174dd389cb9bb4ba0561467e2bc090b03f2b832b098`  
		Last Modified: Wed, 30 Mar 2022 04:44:12 GMT  
		Size: 14.2 MB (14195576 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
