...
```console
$ docker pull perl@sha256:902ac0b09236efd6969ccf9d571bb45222e326295390290ae6f602972d11e6bb
```
...
```console
$ docker pull perl@sha256:7aff8e7b342386bbf46a5dc22089676df78105760cf9301b05155bce717656f9
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.5 MB (339506965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8e850e7d306b6825389ba24645889ad539a53b2201323231efd41f8e3c86fb46`
...
-	Layers:
	...
	-	`sha256:116bc3fd8a510a7aff5aba9abb9cdf7d9888ee8adfe833279f7cb5dd78523a7a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2ea45d93015658b1ecf850dde0fa41b6f0005a7cad8ae290769c3bf8b35552e1`  
		Last Modified: Sat, 06 Jun 2020 01:12:16 GMT  
		Size: 14.0 MB (13998397 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:bc2c1d51b2891c0226d6338f2f8842283393142dae88a37e3a087d8ee097b597
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.1 MB (321138411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d6890cedd2bad4075fe7b8eb80fc4b29909e7ddafaa3b5c426e4015dc526531f`
-	Default Command: `["perl5.28.3","-de0"]`
...
WORKDIR /usr/src/perl
# Fri, 05 Jun 2020 22:09:42 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.28.3.tar.xz -o perl-5.28.3.tar.xz     && echo '77dc1ddf541643af14d585867d3d0741cce45d0dbe8f1467024e63165d9e2fc5 *perl-5.28.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.28.3.tar.xz -C /usr/src/perl     && rm perl-5.28.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 05 Jun 2020 22:09:44 GMT
WORKDIR /
# Fri, 05 Jun 2020 22:09:44 GMT
CMD ["perl5.28.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d6a45b8db226cf329bc5abdeac492aacc6e00d7ea1530974cbcaf82e6592f33f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cf879f6a40005eed073ee96fd2ebb964d265de37cd971fd4b18e0c94e86f1f18`  
		Last Modified: Sat, 06 Jun 2020 00:04:39 GMT  
		Size: 13.8 MB (13811293 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.28-threaded-stretch` - linux; 386

```console
$ docker pull perl@sha256:42e0d220ad5b9c3a154d706f572b68c89f82b1bc760a83bda6e1e83ef9acd62d
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.6 MB (346569893 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1e14d064d43f0a64c1c7591f21c5e624b1fbbc2918189e4c5ee4f49c98227288`
-	Default Command: `["perl5.28.3","-de0"]`
...
# Fri, 05 Jun 2020 21:30:03 GMT
WORKDIR /usr/src/perl
# Fri, 05 Jun 2020 22:34:51 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.28.3.tar.xz -o perl-5.28.3.tar.xz     && echo '77dc1ddf541643af14d585867d3d0741cce45d0dbe8f1467024e63165d9e2fc5 *perl-5.28.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.28.3.tar.xz -C /usr/src/perl     && rm perl-5.28.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 05 Jun 2020 22:34:52 GMT
WORKDIR /
# Fri, 05 Jun 2020 22:34:52 GMT
CMD ["perl5.28.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e1237f6d7ac5fb424105671c047dd2ba393dd3ed37a83012c55a8f16db323e19`  
		...
		Size: 3.1 KB (3057 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c8103454560019bfcb77029b0f6d10f3330de926abe30eb8becb0e6f87ead2eb`  
		Last Modified: Sat, 06 Jun 2020 00:50:10 GMT  
		Size: 13.5 MB (13513620 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
