...
```console
$ docker pull perl@sha256:40693a18061d8c21fa5e0ce369a365aebee45360ad80f5321c9ccbf11b3bee02
```
...
```console
$ docker pull perl@sha256:6d29c49379e76964f6c92aca23d7876d9faa2977177cb5013d0e0cb5aeccf521
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.3 MB (320312687 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7187266f719fc25b67a02199b69f3ea28b12525cbc247b2706cd554de1d97070`
-	Default Command: `["perl5.26.3","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Tue, 21 Apr 2020 07:31:19 GMT
COPY file:d3747e0777cc8ee02f02bae10815103914823c95716eb7c787ce38f4b1b70efb in /usr/src/perl/ 
# Tue, 21 Apr 2020 07:31:19 GMT
WORKDIR /usr/src/perl
# Tue, 21 Apr 2020 07:40:28 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 21 Apr 2020 07:40:31 GMT
WORKDIR /
# Tue, 21 Apr 2020 07:40:31 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:6b89e9488b4b59192ce9868d217da40cc24690ddd35b2d6814d99af7cdaf74ae`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:56321864eacf5f826640db47bc9c1bc7b0d7c6a84254eac79ba962d03b363d6f`  
		Last Modified: Tue, 21 Apr 2020 08:02:52 GMT  
		Size: 1.6 KB (1579 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0ac9eebd440fb63c04707c4f368cd525226c893d8863069e53bda167f5da254d`  
		Last Modified: Tue, 21 Apr 2020 08:03:00 GMT  
		Size: 13.0 MB (12998467 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.26.3-stretch` - linux; 386

```console
$ docker pull perl@sha256:0a986db7f4764f9b67abdcbabcaad13449e6d8af18487b728e2317e28d1f4e90
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.7 MB (345686074 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:10822bd393419248eb233fd45c702e81f68df3b3fb03462500c0e63422ce946a`
-	Default Command: `["perl5.26.3","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Tue, 21 Apr 2020 04:51:22 GMT
COPY file:d3747e0777cc8ee02f02bae10815103914823c95716eb7c787ce38f4b1b70efb in /usr/src/perl/ 
# Tue, 21 Apr 2020 04:51:22 GMT
WORKDIR /usr/src/perl
# Tue, 21 Apr 2020 05:07:28 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 21 Apr 2020 05:07:29 GMT
WORKDIR /
# Tue, 21 Apr 2020 05:07:29 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:3173724bf64dfbe2b62b74e000e77641d96a04a0cdd110beb7149fb56db5c628`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d83a56960fb088d61e969b94d5a3a22e90b382631cbe7e28f946bb50f0dc80c5`  
		Last Modified: Tue, 21 Apr 2020 05:42:00 GMT  
		Size: 1.6 KB (1554 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:83807c9288bae760ee03c845255a4ac60875a968fa9f7c8fe3eff8015a0561ab`  
		Last Modified: Tue, 21 Apr 2020 05:42:07 GMT  
