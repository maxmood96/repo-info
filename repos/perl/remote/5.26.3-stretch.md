...
```console
$ docker pull perl@sha256:6a20f15ac983be21365b14d23ed5afb585731604338b2062b448325449940308
```
...
```console
$ docker pull perl@sha256:60abb94195b5c0ba3801aded6072e5be0b8a005612ca2ffbcb5b26d8a3d7da76
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.8 MB (309785677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c35118bb03fa26ac9ab1dd7e011c1da503ad7a0083f634670bdd9f3d596f52b5`
-	Default Command: `["perl5.26.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:b79d5635666aab354c006b8754216a43b8ec09b7930babc43a7a1239399e23c9`  
		...
		Size: 818.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:92ee66c8019872164a65c28136f1f5cb5ee3c4ac823fd991463ec24f9f77b0cf`  
		Last Modified: Sat, 28 Dec 2019 12:09:23 GMT  
		Size: 12.3 MB (12336602 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.26.3-stretch` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:dca81ac8d887c7082db8d28930371c6f547f29d30d1fb0681c460d4c2a34d017
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.3 MB (320265825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a0d91dc20e07f4a58df5043a236a87180c5e41b59c93965475f10c58511f4bd`
-	Default Command: `["perl5.26.3","-de0"]`
...
WORKDIR /usr/src/perl
# Sat, 28 Dec 2019 13:13:39 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Sat, 28 Dec 2019 13:13:40 GMT
WORKDIR /
# Sat, 28 Dec 2019 13:13:41 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:f57a691d0dc4ccf96f53dc3b44caf8e3e723164bf0fd85637da58b9b3cb9fab1`  
		...
		Size: 818.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8469679a5aa1cb31be57ba31607577ec9b67b8c23d2f6b8fa67a9650b5f7a340`  
		Last Modified: Sat, 28 Dec 2019 14:14:27 GMT  
		Size: 13.0 MB (12998451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.26.3-stretch` - linux; 386

```console
$ docker pull perl@sha256:862e77a86fe7e1ab17a3351ce685c435e36b95ca6336e50f4f78e88afab54574
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.6 MB (345640243 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ec1d83f00c8740f9f3086bdd498bb0459315e055c418679cd27d9d6aa552f6ba`
-	Default Command: `["perl5.26.3","-de0"]`
...
# Sat, 28 Dec 2019 13:19:43 GMT
WORKDIR /usr/src/perl
# Sat, 28 Dec 2019 13:29:21 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Sat, 28 Dec 2019 13:29:21 GMT
WORKDIR /
# Sat, 28 Dec 2019 13:29:22 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0cf36ce1c1c432308be8ff3fa244c3f3af0615c2d52e642804fef41a35818cb9`  
		...
		Size: 788.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5aa475a423cc52a1d0ddb82016ee186ded8bc017dff503ddf73e6294b190a4e7`  
		Last Modified: Sat, 28 Dec 2019 14:37:23 GMT  
		Size: 12.6 MB (12639135 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.26.3-stretch` - linux; ppc64le

```console
$ docker pull perl@sha256:3bc40201da5317eadc3e3e802c9b0b66683498d55a9e0280765130fed5cc7509
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **333.5 MB (333538235 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:db1266dc012fd40ef40de54cffe5af2b52a8b104ae64067156399ced3b31c5d0`
-	Default Command: `["perl5.26.3","-de0"]`
...
WORKDIR /usr/src/perl
# Sat, 28 Dec 2019 12:04:57 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Sat, 28 Dec 2019 12:05:01 GMT
WORKDIR /
# Sat, 28 Dec 2019 12:05:03 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:894c36be5a21681d2d6b6b29a7e7891ee84ba0a3ea644af40a40afa239af005d`  
		...
		Size: 818.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:47c8191ef4739b66af08651818babf5b375a243350bebcc82c4f85e1b032b10b`  
		Last Modified: Sat, 28 Dec 2019 12:57:43 GMT  
		Size: 13.0 MB (13022555 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
