...
```console
$ docker pull perl@sha256:a9f9b1e94ecce5b6c1ed04806adb3136eb763645628dcbb9a081f3450c13afb8
```
...
### `perl:5.40.0-buster` - linux; arm variant v7
...
### `perl:5.40.0-buster` - unknown; unknown
...
### `perl:5.40.0-buster` - linux; arm64 variant v8
