...
```console
$ docker pull perl@sha256:46f7560cceb5e4070d75865e4eaa89a2fef6311935b37df869f1c129fc7a594a
```
...
-	Layers:
	-	`sha256:c835cdce05b80bc1ad69c251f0088d240e2be72ec612aff2ff2bc3189896e57d`  
		Last Modified: Tue, 13 Jan 2026 08:37:43 GMT  
...
-	Layers:
	...
	-	`sha256:1f8b931ac15c30bb6870b318eadf86305b85cb9961d093b834baa59e2139f6e9`  
		Last Modified: Tue, 13 Jan 2026 08:38:02 GMT  
...
```console
$ docker pull perl@sha256:db2aa6694897cfc54f73fd5f617c40c1eac548e07c79dbb2a42169f288a39de5
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.1 MB (400120299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:98d4b1859f57ae6dc288c7c98366fba31c6a9db566068e54a8eeb0f0a8181adc`
-	Default Command: `["perl5.42.0","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 30 Dec 2025 13:37:35 GMT
RUN true     && curl -fL https://cpan.metacpan.org/authors/id/B/BO/BOOK/perl-5.42.0.tar.gz -o perl-5.42.0.tar.gz     && echo 'e093ef184d7f9a1b9797e2465296f55510adb6dab8842b0c3ed53329663096dc *perl-5.42.0.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.42.0.tar.gz -C /usr/src/perl     && rm perl-5.42.0.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.94.tar.gz'     && echo '9d7be8a56d1bedda05c425306cc504ba134307e0c09bda4a788c98744ebcd95d *Net-SSLeay-1.94.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.94.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.091.tar.gz'     && echo 'c5996e7335912a5c99e06bdb47ff39df309a857cbd8fd2627a021cefdb53cf54 *IO-Socket-SSL-2.091.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.091.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997017/cpm -o /usr/local/bin/cpm     && echo 'e3931a7d994c96f9c74b97d1b5b75a554fc4f06eadef1eca26ecc0bdcd1f2d11 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /root/Net-SSLeay-1.94* /root/IO-Socket-SSL-2.091* /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version # buildkit
# Tue, 30 Dec 2025 13:37:36 GMT
WORKDIR /usr/src/app
# Tue, 30 Dec 2025 13:37:36 GMT
CMD ["perl5.42.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8abebceffef6c048f13eb5f6e8ae8f6f83805c01d659be2750d4a1eb4a84ac0c`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:4b1e4824127cfdc0dda28244ab80dd86d4d8d2602b186f1a4546148683f701cd`  
		Last Modified: Tue, 30 Dec 2025 13:38:32 GMT  
		Size: 15.9 MB (15876760 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:33ecf4b66aa427f9f2f8df35b63a1b3fa30b67eae1e6b73ab6bf2cf3af5e65ba`  
		Last Modified: Tue, 30 Dec 2025 13:38:31 GMT  
		Size: 133.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:bc9fb9520d339d45d77279ea77bb91f33d7b9697c2102f351087886b4ce036e0
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.2 MB (17215829 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bde6724473a56b15fea475c3baa05e261fe6e2311cc25bd7c0b6714b57c63f95`

```dockerfile
```

-	Layers:
	-	`sha256:e80e817a4ab6e1693ac499f5c74a36038afe3a9f487604efdf0abdd1f3528ad3`  
		Last Modified: Tue, 30 Dec 2025 14:38:06 GMT  
		Size: 17.2 MB (17196192 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:2464dbb788dca528e395aa52bed0eaa815568828d7f290c7c0bcc06123aa802d`  
		Last Modified: Tue, 30 Dec 2025 14:38:07 GMT  
...
```console
$ docker pull perl@sha256:c904c6b9deb7dd433294964fdd49b23de2b9450ba98f4ab7fe75ac0b32b24cc6
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **477.6 MB (477642942 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b04c56ef2fa67a62e41d85b40ba26652916e4c80d663ab608e251e0dea7fc428`
-	Default Command: `["perl5.42.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:89744d281ae7043a6d08686f11a85482d714b043baa7087bf99fb9b551b5cd58`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:3bcce9f69e5acf83f468570fa8c3d901b2b71d8164e3a6b53b8186427d792e37`  
		Last Modified: Sat, 03 Jan 2026 02:48:45 GMT  
		Size: 15.4 MB (15370495 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:05937e5c00288e87bf7b4009f4060f8dd4853274e78bc98f586739f6dd0baa14`  
		Last Modified: Sat, 03 Jan 2026 02:48:44 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:ca597d196e27fde99b35c2b7e436ff487f0f17e09b92369c090e6c002303ad8d
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.3 MB (17286418 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:31c6c755e84690e59aa08dff54afee8ca3912b6433be2844f816c9219a43382d`

```dockerfile
```

-	Layers:
	-	`sha256:e9ce638a6a331610ef628f9ebf64e12a06e87e196afc43bc4506cf8f95bd7775`  
		Last Modified: Sat, 03 Jan 2026 05:38:53 GMT  
		Size: 17.3 MB (17266781 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:3bdff7617255c1fccd94a587da9086726e4a88a0741c4d646b173b110f875036`  
		Last Modified: Sat, 03 Jan 2026 05:38:54 GMT  
		Size: 19.6 KB (19637 bytes)  
		MIME: application/vnd.in-toto+json
...
-	Layers:
	-	`sha256:e4cf4fd3f8af512a1f98632faf332e70790477eb7006780b76f1fb0c884b265b`  
		Last Modified: Tue, 13 Jan 2026 08:39:20 GMT  
