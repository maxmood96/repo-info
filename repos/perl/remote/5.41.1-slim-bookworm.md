...
```console
$ docker pull perl@sha256:74c64eb2b1b71a9518d5e14323a73b0234a8633bfcb961e88ba3b8b5b7dcd1a6
```
...
### `perl:5.41.1-slim-bookworm` - linux; amd64
...
### `perl:5.41.1-slim-bookworm` - unknown; unknown
...
### `perl:5.41.1-slim-bookworm` - linux; arm variant v5
...
### `perl:5.41.1-slim-bookworm` - linux; arm variant v7
...
### `perl:5.41.1-slim-bookworm` - linux; arm64 variant v8
...
### `perl:5.41.1-slim-bookworm` - linux; 386
...
### `perl:5.41.1-slim-bookworm` - linux; ppc64le
...
### `perl:5.41.1-slim-bookworm` - linux; s390x
