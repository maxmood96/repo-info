## `perl:5.10-threaded-buster`

```console
$ docker pull perl@sha256:a5222a1744704f2995c3367cee77e4ae44faa1684d59d8c61f686fd9d231fbc0
```
...
### `perl:5.10-threaded-buster` - linux; amd64

```console
$ docker pull perl@sha256:d61fe8531dd32feef64da427a023b0f35b093ec7f74d0b3351d9c47cc8190caa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **324.0 MB (323977340 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9760f59f1af9a690fa82ddd76349b2a481021bcb644705045d506049cff72b50`
...
-	Layers:
	...
	-	`sha256:2f6a3745a218a8558161588f966b8c7094336090265485e157ffc04f64b43d4d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ad076268cc981ce5945d4e6fbf8eb2c185bef5d82d272dc35dcb02ae5a04b202`  
		Last Modified: Sat, 22 May 2021 04:54:16 GMT  
		Size: 11.5 MB (11510704 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.10-threaded-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:a67c97f967b70bdf9b3465e11e06fde188316d09b2e75cd4f32ada657696545a
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **289.0 MB (288964964 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bf454b5ce2659fd4cf7dbb6acc184307932a74f4669c7fe9c27ebff36c7e1a22`
-	Default Command: `["perl5.10.1","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Wed, 26 May 2021 07:33:23 GMT
COPY file:8112f6c54aefe0f9e872cd12235fe10ef5d72b9f5a13361e58dfb55eb8056006 in /usr/src/perl/ 
# Wed, 26 May 2021 07:33:23 GMT
WORKDIR /usr/src/perl
# Wed, 26 May 2021 07:43:34 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.10.1.tar.bz2 -o perl-5.10.1.tar.bz2     && echo '9385f2c8c2ca8b1dc4a7c31903f1f8dc8f2ba867dc2a9e5c93012ed6b564e826 *perl-5.10.1.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.10.1.tar.bz2 -C /usr/src/perl     && rm perl-5.10.1.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local -A ccflags=-fwrapv -des     && make -j$(nproc)     && LD_LIBRARY_PATH=. ./perl -Ilib -de0     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 26 May 2021 07:43:35 GMT
WORKDIR /
# Wed, 26 May 2021 07:43:35 GMT
CMD ["perl5.10.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:9c1ff84aa3e7a81fc16b5e007121c2dedbf01d23c96fc520c9ca3b0b09f1368f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16c1f2fea8e5c8cb0e5733781663c78fb4dbed5e809667f5822695e6c478d593`  
		Last Modified: Wed, 26 May 2021 10:18:23 GMT  
		Size: 11.4 KB (11398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:31c427085a0daf8366d52b9f53c25ca51808511d3bc5e7c2423a0af1c8311974`  
		Last Modified: Wed, 26 May 2021 10:19:33 GMT  
		Size: 10.7 MB (10654805 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.10-threaded-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:d8ee9a2c5c9c11e068fce2b3e988565a68199a711778b0c993fbb6c282136912
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.4 MB (314440205 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6f219923b35e1868789020e02532804738657a8ac037f2010329838cd55c8e43`
-	Default Command: `["perl5.10.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:0746ee2a23c059d421a66b5f16b3dff3074df428fdfca57f181868a0a47f97aa`  
		...
		Size: 11.4 KB (11398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e0719c912311848e4c4c1eb9747022d82772879c973f169c3ad393f20ae0d127`  
		Last Modified: Fri, 28 May 2021 09:59:37 GMT  
		Size: 11.5 MB (11457533 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.10-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:85360039edd9b4946fde4e46f54185dcbaa3bec0cb9d4a05eefdd4bc71a397db
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **332.9 MB (332938975 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3068e09fd30f789fe219b75aea4fed1d15543fb9d5705223880ff271681b37e2`
-	Default Command: `["perl5.10.1","-de0"]`
...
# Sat, 22 May 2021 04:05:55 GMT
WORKDIR /usr/src/perl
# Sat, 22 May 2021 04:18:54 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.10.1.tar.bz2 -o perl-5.10.1.tar.bz2     && echo '9385f2c8c2ca8b1dc4a7c31903f1f8dc8f2ba867dc2a9e5c93012ed6b564e826 *perl-5.10.1.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.10.1.tar.bz2 -C /usr/src/perl     && rm perl-5.10.1.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local -A ccflags=-fwrapv -des     && make -j$(nproc)     && LD_LIBRARY_PATH=. ./perl -Ilib -de0     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Sat, 22 May 2021 04:18:55 GMT
WORKDIR /
# Sat, 22 May 2021 04:18:55 GMT
CMD ["perl5.10.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:5ea3ea8d7373f185584f02a932b8f217b9ae2d3b124fb2ff1581040de9d726da`  
		...
		Size: 11.4 KB (11398 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab812456571d27107c34468f94e209b34f41fe1919a120909f41e8cfa90b28c0`  
		Last Modified: Sat, 22 May 2021 06:01:28 GMT  
		Size: 11.1 MB (11051351 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.10-threaded-buster` - linux; ppc64le
...
### `perl:5.10-threaded-buster` - linux; s390x
