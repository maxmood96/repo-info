...
```console
$ docker pull perl@sha256:4218fff00b83038a4bfe549a3cce2101798b53a91ccd458b0a9947463e95b713
```
...
### `perl:5.41.1-threaded` - linux; arm variant v5
...
### `perl:5.41.1-threaded` - linux; arm variant v7
...
### `perl:5.41.1-threaded` - linux; ppc64le
...
### `perl:5.41.1-threaded` - linux; s390x
