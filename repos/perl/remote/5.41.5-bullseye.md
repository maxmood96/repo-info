...
```console
$ docker pull perl@sha256:fba067409c5b8726339565c3d361d7189bdd1067c6e24872f01d7b6748f8b773
```
...
### `perl:5.41.5-bullseye` - linux; amd64
...
### `perl:5.41.5-bullseye` - unknown; unknown
...
### `perl:5.41.5-bullseye` - linux; arm variant v7
...
### `perl:5.41.5-bullseye` - linux; arm64 variant v8
...
### `perl:5.41.5-bullseye` - linux; 386
