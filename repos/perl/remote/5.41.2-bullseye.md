...
```console
$ docker pull perl@sha256:f6301dd741bdb76d6bf4f859721ac37ac5ee2c4657493caa01adf941d813af96
```
...
### `perl:5.41.2-bullseye` - linux; arm variant v7
...
### `perl:5.41.2-bullseye` - linux; mips64le
...
### `perl:5.41.2-bullseye` - linux; ppc64le
...
### `perl:5.41.2-bullseye` - linux; s390x
