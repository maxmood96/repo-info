...
```console
$ docker pull perl@sha256:7f922283cf225b0d31d34f0561daeb102209db08e22bf4979628dc84da6fced9
```
...
### `perl:5.43.7-threaded-trixie` - linux; amd64
...
### `perl:5.43.7-threaded-trixie` - unknown; unknown
...
### `perl:5.43.7-threaded-trixie` - linux; arm variant v5
...
### `perl:5.43.7-threaded-trixie` - linux; arm variant v7
...
### `perl:5.43.7-threaded-trixie` - linux; arm64 variant v8
...
### `perl:5.43.7-threaded-trixie` - linux; ppc64le
...
### `perl:5.43.7-threaded-trixie` - linux; s390x
