...
```console
$ docker pull perl@sha256:6145f1b5f0110ec416e1bd8c0c99c194fc9feb72e23d70ac62ab0288cd839152
```
...
```console
$ docker pull perl@sha256:396c970ff1d3c513900dfe74c53f2152f9fddb618f2fa0c70e93d26a8c5f4939
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.4 MB (337384868 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a773ac7cbff799f5fb9be49afbb32a5abeaf1245c4324df8b0288d2516e07d43`
...
-	Layers:
	...
	-	`sha256:b8cd54aef17b2f37e9951fef64da5fcdfada4bbf94d61fb4cc265097bf37cbc8`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:43d218802cb86562f3833ded142f11341a477efb0c98ea64eb121f77ccf9a26f`  
		Last Modified: Tue, 13 Sep 2022 09:43:27 GMT  
		Size: 14.9 MB (14881841 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:b0c552c12f85833d52cd25df83dbc77632269e93d2ca9bb989990b85b4a75398
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.9 MB (296939956 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b53966305dfe72049658ca751060a26e5fb07f2cfa3a502a1aa87bb9593280be`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Wed, 14 Sep 2022 03:06:48 GMT
WORKDIR /usr/src/perl
# Wed, 14 Sep 2022 07:15:20 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Wed, 14 Sep 2022 07:15:21 GMT
WORKDIR /
# Wed, 14 Sep 2022 07:15:21 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:df090865fba3006796d227cb7a6e8c2d2e1a20024752050e6ea62027e04a6614`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6d324eab69b2bc228d67a203cb2b9a22f293af78a38e7c618e566dd422413a41`  
		Last Modified: Wed, 14 Sep 2022 08:04:39 GMT  
		Size: 13.9 MB (13949747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:82e7bc83c76c0039cfef39d429d9a8a11f2b61dfa2c14f7e83b19d1fa22a0041
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.7 MB (328703360 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:218b8139e1452080743d90c1d3319d246f0edd0c2be05a9a11065f78ff347132`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:f567ba29fe0eccfa28d16a3692b33474b72a18139fe67368cf20707ee8a1c6fa`  
		...
		Size: 180.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7a7985e332dca5b6d554fbc5d873ed69b0577d6d245a1815f88e04012c4b4855`  
		Last Modified: Tue, 13 Sep 2022 09:51:30 GMT  
		Size: 14.8 MB (14801276 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; 386

```console
$ docker pull perl@sha256:45a05a7367c9920de2d79bd4e5c768fdc4eda4e198d2d38d55790edfcb4505fa
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.4 MB (342418182 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2b95edcf80eaf51b0ee56e129f2fb72d0ac96bf6b38f813cef473bf3ca046454`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Tue, 13 Sep 2022 07:12:14 GMT
WORKDIR /usr/src/perl
# Tue, 13 Sep 2022 09:28:36 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 13 Sep 2022 09:28:37 GMT
WORKDIR /
# Tue, 13 Sep 2022 09:28:38 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:cc77caa6998cecb75c485dcd2b49423700aa9da596830862bb6428c88163dc6b`  
		...
		Size: 180.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ca2bb35f436fcf34d4022b7661943e764ac5f63bbaae12059ead4ff3d18b5680`  
		Last Modified: Tue, 13 Sep 2022 09:59:11 GMT  
		Size: 14.4 MB (14406076 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; mips64le

```console
$ docker pull perl@sha256:40e1f0a3839ceeb03f522ba2360ec350eb666a64ee3367f0d108a34648716bab
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.4 MB (315382040 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:348b30e8f2f0dce363c1237cfb8bc7aa1e81705c07db45ee24a59189ec390c5a`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:f68b8b889280f8bc021e13084e9a3284056555ee0f6316b8260c84014f677aec`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a575eeaf4e5d51bb18df04674667600b035a40288997f9ab1f55145595ebc0c3`  
		Last Modified: Tue, 13 Sep 2022 10:55:36 GMT  
...
```console
$ docker pull perl@sha256:76eaf285be9ce5ed6d4c5b2c5ff92a3a65c4cced754dfc944bd61b5edfe3b038
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.9 MB (345932250 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3c22901ba4148c091ed844950ad656a0ebf10dc32204d3004b5c7831f8b62eef`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Tue, 13 Sep 2022 07:09:29 GMT
WORKDIR /usr/src/perl
# Tue, 13 Sep 2022 08:38:38 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 13 Sep 2022 08:38:40 GMT
WORKDIR /
# Tue, 13 Sep 2022 08:38:40 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:06da32d8392146150ba5ebe0cc1280f8e8ea7f8641f57facf8b9476f237bdf2d`  
		...
		Size: 206.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a4dc8fed65bf9ed38287b3168f15c6114ed50cd2581ebc57d96bca4ac131ffc4`  
		Last Modified: Tue, 13 Sep 2022 08:56:08 GMT  
		Size: 14.9 MB (14927098 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
