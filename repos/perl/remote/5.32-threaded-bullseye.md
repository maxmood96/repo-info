...
```console
$ docker pull perl@sha256:483f8a850808e2d574118fbccb99b43f4c40b465a332ffbe5a65a326d828bd74
```
...
```console
$ docker pull perl@sha256:4c65d718f4fc87b61e155396f09e5de82eab2ed55bb6cd4993eb9c6965004bdc
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.1 MB (336137334 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70f49befef1ae20dd42d162b139b5973880addf43e043c56e3b392eaee796a25`
...
-	Layers:
	...
	-	`sha256:f00902df393588cdca8d9f7df63ed04e041f95125fbca5c8468872bcbaacf0dd`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4e518bfc005c1143cf3a7d3347b8d3c71334cc09e47dcaf2ed4f9384ef7223da`  
		Last Modified: Wed, 26 Jan 2022 16:12:01 GMT  
		Size: 14.1 MB (14098811 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:ce17fe777110879fd998ad09de6680a3e1947ca05da1d9b4492050d0467c85a1
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.7 MB (295743217 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9bacc8e1ac8fc3c350bc8c8dccf15f18c7061f038200ba123fe4e66d01c98935`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 27 Jan 2022 21:07:32 GMT
WORKDIR /usr/src/perl
# Thu, 27 Jan 2022 22:29:05 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 27 Jan 2022 22:29:06 GMT
WORKDIR /
# Thu, 27 Jan 2022 22:29:06 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:a17d8f4a443a7cac54c9dee8d065d763029385a2887a1f69c61cd23432d362ea`  
		...
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7a6fb75fb56016a54037217ace30e88405164517b01ee2df953e20c7433d783`  
		Last Modified: Thu, 27 Jan 2022 23:38:50 GMT  
		Size: 13.2 MB (13182296 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:2520e756d1cd4c09640ebda0c0cb42c350847019115c58f0c4765b12c777b63c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.5 MB (327521057 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:549b21746ee5d4c65e9b2e57d3be092ea81e778d9157962aa313c5718999b3fd`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Tue, 01 Mar 2022 14:31:24 GMT
WORKDIR /usr/src/perl
# Tue, 01 Mar 2022 15:24:28 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 01 Mar 2022 15:24:28 GMT
WORKDIR /
# Tue, 01 Mar 2022 15:24:29 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:20864bf6e457f610b17ffa694f42cdf149964e8107306c76c42f5bbcd82acc26`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:264573781cebc9df8da0364b1254ea040c7f710be765c49e558c438143e7faf0`  
		Last Modified: Tue, 01 Mar 2022 16:17:26 GMT  
		Size: 14.0 MB (14019288 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:2e899b2ca1cf4e0e0933be8345e0c658db1acbd8ebe8ff0fff9bec063ff4a17a
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.5 MB (314492059 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:41f3b0a530d0986bb4338b70c1f2ffcdadfdd57cc0bebae9ad1d40b21c487259`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Tue, 01 Mar 2022 04:45:25 GMT
WORKDIR /usr/src/perl
# Tue, 01 Mar 2022 09:00:14 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 01 Mar 2022 09:00:14 GMT
WORKDIR /
# Tue, 01 Mar 2022 09:00:15 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:5db2bf0fd806556e8440aa44dd6489c9ea7273bb8404317a29002029b4fca1e2`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc1a3296c7923b94d88000a9e4b4a156ddd7abb6fe3d10d90bdeab8e22beb905`  
		Last Modified: Tue, 01 Mar 2022 12:41:04 GMT  
		Size: 13.4 MB (13372226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
