...
```console
$ docker pull perl@sha256:fcfb230e9d274832f902f0e603bdc7f2d3f5084c9de2170be5bbc02477391062
```
...
```console
$ docker pull perl@sha256:33d7794eb7ae5b83df3ac25b7ebbc8bbff83ef511056be58ef6881b1825ba6b0
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **295.8 MB (295814161 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd160b62cd157db7e7dbd721c1793671a9520f757e0b400c3119ab05b132fde6`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Wed, 30 Mar 2022 22:11:58 GMT
WORKDIR /usr/src/perl
# Thu, 31 Mar 2022 00:38:51 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 31 Mar 2022 00:38:51 GMT
WORKDIR /
# Thu, 31 Mar 2022 00:38:52 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:9b0ebed85603d18a707af0727c834cb8bcc8db2120c781555f4d606a222fb7e1`  
		...
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfd4cb21000861a485ecae23d36fc8df6d026a82981e060f3ab1e20a3a278ea3`  
		Last Modified: Thu, 31 Mar 2022 02:55:58 GMT  
		Size: 13.2 MB (13182210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:f3662be11588358696dad6d9409719ac8c04c91a6aced8117c9483fcaba99dde
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.5 MB (327500483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c2fe86a50d0f196c2938d7bb8ad48c43518ed49bcd2add7f0fb1306b4cd0ac6`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Wed, 20 Apr 2022 14:03:22 GMT
WORKDIR /usr/src/perl
# Wed, 20 Apr 2022 14:57:07 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 20 Apr 2022 14:57:08 GMT
WORKDIR /
# Wed, 20 Apr 2022 14:57:09 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:35d380186bdfb4e1ac4a36f2df9b65d3bc3d2653a6f84cb80b1aa55b73590e3d`  
		...
		Size: 181.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0081d8e74399c82c2548db6545550cdf3bc75406eb18036a713bda84fe701b18`  
		Last Modified: Wed, 20 Apr 2022 15:50:42 GMT  
		Size: 14.0 MB (14018615 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:c8c0b6cde6e4c983e8738d3a37350e940a2acfca72e6bf30787257f1a570545f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.4 MB (310385067 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3f958410bf3cf81bed21c60e10442451c01f84a7e693d0c2bd46548d7f0d2d4e`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Wed, 20 Apr 2022 13:27:36 GMT
WORKDIR /usr/src/perl
# Wed, 20 Apr 2022 14:51:00 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 20 Apr 2022 14:51:01 GMT
WORKDIR /
# Wed, 20 Apr 2022 14:51:01 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8794cf9996c81b68f3dc00b9caa9b8b77e06f0933bbce1d203b159df8987c71d`  
		...
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f8038eb9484314a7fac39b0feb26d538aa161d8e0c4bbc94e94f5bd47dc8d80`  
		Last Modified: Wed, 20 Apr 2022 16:00:45 GMT  
		Size: 14.4 MB (14449933 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
