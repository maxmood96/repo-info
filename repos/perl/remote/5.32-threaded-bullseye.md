...
```console
$ docker pull perl@sha256:c016ca43a2223fb8ed8b16631d1c0320ba021801bfe764b7ee56fd41fa2788f1
```
...
```console
$ docker pull perl@sha256:870d7ad1ec2b782fb73bae20bda54bb15c6efacdd9612270e02b668adfe40d24
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.1 MB (336124476 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d85dc389a8fbfff1d532fbf4ae7144b2138bf355a8ce2eda1282bde970740e0a`
...
-	Layers:
	...
	-	`sha256:46cd601fd47f014010b51abc8db1bc2f01b14d31602d6efa3f02e051ee00f041`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a7d8a7b819b360bed98087044985f4668cc3ccfe66769abf504c46ea57dc0bc7`  
		Last Modified: Thu, 02 Dec 2021 23:15:56 GMT  
		Size: 14.1 MB (14098725 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:e7092797d63aec8c9565f52e585d4ead8d0c79bde4e9bb8e8307669a99ee541c
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.3 MB (327286258 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f9b1c9ea08c74b77efc38cbf9a4c8b296633545c6b68092c4ca32d6c96dd2c3a`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 02 Dec 2021 22:22:01 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 02 Dec 2021 22:22:02 GMT
WORKDIR /
# Thu, 02 Dec 2021 22:22:03 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:3f8098fa93952bf1659cbb89101f55e8eb31e72f19b1b1a2d55736a07574aebc`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7008a3757e9a4594d4e4500544c913d6530be07fe28952b3cf6493cf08f49231`  
		Last Modified: Thu, 02 Dec 2021 23:16:18 GMT  
		Size: 14.0 MB (14019187 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; 386

```console
$ docker pull perl@sha256:2cce566bbe0e879ff18a37f74c624d7e3fe3ebad5661535e2a16cfb4c87ee072
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.4 MB (341412320 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5888fbec13961b5a9142d3014b54d8778291551ebcfbaae9eb4257ab4be6482d`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 02 Dec 2021 09:59:01 GMT
WORKDIR /usr/src/perl
# Thu, 02 Dec 2021 12:00:39 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 02 Dec 2021 12:00:39 GMT
WORKDIR /
# Thu, 02 Dec 2021 12:00:40 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e404fe4375a46f7de9c84a660e0568fd754beff00f2ac0568509c1d5c1a513b2`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fa74f1e16dc053c88df8b2d423d17aa9a6b2b54a9a0ccbd296dcceac0c8d23c8`  
		Last Modified: Thu, 02 Dec 2021 14:24:55 GMT  
		Size: 13.6 MB (13610386 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32-threaded-bullseye` - linux; mips64le

```console
$ docker pull perl@sha256:b37e50b945601ef7da3189cbd0d1ab4c08b77b16e989c9a4a6f0996af73bd461
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.5 MB (314455582 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5db4be1cafa01c2af8948e991b63301dba5212d09eb325fe1ddad808d619c90`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 18 Nov 2021 13:02:45 GMT
WORKDIR /usr/src/perl
# Thu, 18 Nov 2021 17:18:14 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 18 Nov 2021 17:18:15 GMT
WORKDIR /
# Thu, 18 Nov 2021 17:18:15 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:4aa0fafa426752f8044b276404e52f3a1e0f14e17236b342307ec4a0c8a53ad3`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bb8d089df49e799fe75d7efa060c01b91b15826552e45cfee5c0e1a2b2a36369`  
		Last Modified: Thu, 18 Nov 2021 21:01:39 GMT  
		Size: 13.4 MB (13372048 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:84cd2855ba0a83ecf0066be9464f606f617b25f1ab092eccfdb585d87629da3a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.1 MB (310088115 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d97bc991205ed33b49a59dd82e5d3ce8c7b9c729ef8a7759560a6fc8e00731ad`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 02 Dec 2021 10:53:53 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 02 Dec 2021 10:53:56 GMT
WORKDIR /
# Thu, 02 Dec 2021 10:53:56 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:ff56489fca16bfda9ae95488834bd6aae51be5108f4dac46874b5a682194fc32`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:07374d087f4a8777979572182014c8658a4920bbaa9705764c5223805e0ada27`  
		Last Modified: Thu, 02 Dec 2021 11:56:17 GMT  
		Size: 14.4 MB (14449978 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
