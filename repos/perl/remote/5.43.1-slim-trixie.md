...
### `perl:5.43.1-slim-trixie` - linux; amd64
...
### `perl:5.43.1-slim-trixie` - unknown; unknown
...
### `perl:5.43.1-slim-trixie` - linux; arm variant v5
...
### `perl:5.43.1-slim-trixie` - linux; arm variant v7
...
### `perl:5.43.1-slim-trixie` - linux; arm64 variant v8
...
### `perl:5.43.1-slim-trixie` - linux; ppc64le
...
### `perl:5.43.1-slim-trixie` - linux; s390x
