...
```console
$ docker pull perl@sha256:c34ce32072cc9c70a706f44f66ba775bb86331e4d0a1637241bffc9c0ac587a5
```
...
### `perl:5.39.4-threaded-bookworm` - linux; amd64
...
### `perl:5.39.4-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.39.4-threaded-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.4-threaded-bookworm` - linux; 386
...
### `perl:5.39.4-threaded-bookworm` - linux; ppc64le
...
### `perl:5.39.4-threaded-bookworm` - linux; s390x
