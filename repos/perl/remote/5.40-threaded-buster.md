...
```console
$ docker pull perl@sha256:10797cacad7de9403fb0d9cde18d162ff5d4a476856cae9170a17b863427da28
```
...
### `perl:5.40-threaded-buster` - linux; arm variant v7
...
### `perl:5.40-threaded-buster` - unknown; unknown
...
### `perl:5.40-threaded-buster` - linux; arm64 variant v8
...
### `perl:5.40-threaded-buster` - linux; 386
