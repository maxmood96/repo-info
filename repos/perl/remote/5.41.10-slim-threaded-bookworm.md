...
```console
$ docker pull perl@sha256:6bdc5cf5d7bdab9ca08289ac74a438b6fc9387af0e4a8050bc7b219ab69cda86
```
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; amd64
...
### `perl:5.41.10-slim-threaded-bookworm` - unknown; unknown
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; arm variant v7
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; arm64 variant v8
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; 386
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; mips64le
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; ppc64le
...
### `perl:5.41.10-slim-threaded-bookworm` - linux; s390x
