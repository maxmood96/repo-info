...
```console
$ docker pull perl@sha256:210a0218ac3ecf49928ba58c11c956d0a5c7cc79287b900295a040da58545ec7
```
...
```console
$ docker pull perl@sha256:01cdf49dfe070aba234f783394a562a1410cb72c1b5c6b4ddc9ea3dcc13e0108
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.7 MB (327685940 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36ef2167d5c09ea783959b68246de3467ee0021c44f82646dbd32929bf3e9407`
...
-	Layers:
	...
	-	`sha256:8379d0921e0fa718453f4bd0fd8b4ced7a90f0663721d9743a54f4004322b1b6`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:078761f5038662aa085543b892be0ad0d87e9f909d6d22f22dfec72fdd4f17b5`  
		Last Modified: Thu, 30 Jun 2022 21:43:24 GMT  
		Size: 15.1 MB (15057983 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; arm variant v5

```console
$ docker pull perl@sha256:d1328b31bbf06c4a501eb69d3f398c5ef6585833548183307d1d5d9806a021a5
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **299.9 MB (299919229 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4c7df4c2a59f26e83e78747c5aa8df167a859bf4a31b87126af230093129b20`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:e10b9d85a5d3e2cbc384e661e247603ba6567741832d43e75c6ec327a19d95d4`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5ac26586dc9bd96bb2d124831c13caaeba8d77420269ea07bde21aea68fdb2cf`  
		Last Modified: Thu, 23 Jun 2022 08:24:44 GMT  
		Size: 13.7 MB (13660749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:d9a65c14ca2c2f5ce690a0302979faf5dd80246c54535dd149c45f70a920d25e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291919913 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:09e46095cfdb0a5a2516579a55ea53077c58fbd50a76d1984a136dfa943f971e`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Thu, 23 Jun 2022 08:20:15 GMT
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 10:53:55 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 10:53:56 GMT
WORKDIR /
# Thu, 23 Jun 2022 10:53:56 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:26356f518028f21720ff16121655d307e6271952a9b56b96364571b50daf419d`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:db8138c9f42f5ccdf93353a9eb13f6c187176a3de061f069910e4e2f85386385`  
		Last Modified: Thu, 23 Jun 2022 13:05:47 GMT  
		Size: 13.5 MB (13469401 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:1d3dc7d1b6d7a9680998db7588912dc8bb2b7288cce7deca36a7573a7fcb368d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **318.0 MB (317950004 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4cb9bda9c4df0092adbedcc334420346bb1f18993c8494605bed64986fccf5c2`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 21:32:44 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 21:32:46 GMT
WORKDIR /
# Thu, 30 Jun 2022 21:32:47 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:475e8e0317a59ea114085f16d572add3a511b1708a07c12d9adc5f0e361ba347`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48c8e13c3b15d5439b31f93adb2c4892fdb6af9f8bed08c78e4fdc09bdb99abf`  
		Last Modified: Thu, 30 Jun 2022 22:36:16 GMT  
		Size: 15.0 MB (14993458 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:b70f2060b05ddd414ee70c4fc736cb23973570fdcbddc3ec67640236f0d4361d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.4 MB (336415336 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d5183c5b659375cd33058fab97b01a888f99b21a568cbd7cd8c902703ed75763`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:0373ffc2ce2caab9ffc3edf6a00e16f7c6018144ed10fc7a2ce6daa3a171fc89`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:587758be925872ce8f3ba0a1eeab9ad61f26e54971117d5ef73c0ef32b30584b`  
		Last Modified: Thu, 30 Jun 2022 21:25:33 GMT  
		Size: 14.6 MB (14611230 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; mips64le

```console
$ docker pull perl@sha256:48e0b96a8ef00d1009c5cb961ba1330d980379e108f7033e7f8f5f5fa12739bc
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.6 MB (310642686 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c081e8f2916622a3cc5c7a8da83cf06bd02d29de915baf8bf51cc381c3f659ec`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 09:25:41 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 09:25:47 GMT
WORKDIR /
# Thu, 23 Jun 2022 09:25:54 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8c1cbd22837de74e1f7c04109706230e6987b182580f9142da3562c50c95fde9`  
		...
		Size: 180.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ed417a342710185aaa954431a7b071fc55a30c7048c620e401a81fedf2ebb242`  
		Last Modified: Thu, 23 Jun 2022 13:00:28 GMT  
		Size: 13.6 MB (13618986 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; ppc64le

```console
$ docker pull perl@sha256:d4b7308d904ea5804d8285120b2bd01474fd7aa29684c81e64a5a6553018bac6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **349.2 MB (349170379 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:858691dec6c5be7228718a0c7eb32ce7b31ec746fd68d748955cdac3a6057be7`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 20:45:59 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 20:46:05 GMT
WORKDIR /
# Thu, 30 Jun 2022 20:46:08 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:564d791175f6ac5804c92d328ae82c9741533c17250d7dd1ff336dd2e5b3aa64`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c747269527a419ad02db12e114b649175104055db52ed6944a7326c63ddad72d`  
		Last Modified: Thu, 30 Jun 2022 22:40:09 GMT  
		Size: 15.1 MB (15142508 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; s390x

```console
$ docker pull perl@sha256:9e70ac292ed21daff177a69b65bea6f59b32a01d090880e8882bcda1cdffac8f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.1 MB (310050917 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3d8724587cb9380a24d90faa71084bfc9b520259d52b25d4570bbbe7dcb0a234`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Thu, 23 Jun 2022 03:54:18 GMT
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 20:51:44 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 20:51:49 GMT
WORKDIR /
# Thu, 30 Jun 2022 20:51:50 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:dede816e0edef48fc6f7208c861976b4dcb6207b0b9ab724489fc33891a0b358`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6f48fc43831855fd85437546582f507ca314e10969836b5a879860bab0bd745`  
		Last Modified: Thu, 30 Jun 2022 22:36:29 GMT  
		Size: 15.4 MB (15385113 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
