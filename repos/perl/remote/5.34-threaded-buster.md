...
```console
$ docker pull perl@sha256:41d902ba92f7281d5878547de024ab61aadac43da204179ecfa1402a76c118ea
```
...
```console
$ docker pull perl@sha256:f3fd0c8b21077f136d32b2e8c33ca975d9f197d9d6cce2f7ff8bc4cb8bc95ea9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326935342 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b66e453df4aa2895c0db1c5e543ce6573d9d19d999582aebd859df298431d8c`
...
-	Layers:
	...
	-	`sha256:429b233c4cb7d7cd839163f2778d2b3c5c9b8e64b21f6a0a528cdde2604000cf`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:192b80903b61180d2019a070a5637cee2053dae2f81f6ef815194a0673482fee`  
		Last Modified: Tue, 04 Jul 2023 12:21:24 GMT  
		Size: 15.2 MB (15153911 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:163322277a7778dee096da2e904a31bd284bda51993762bef4e397c80ad72819
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.8 MB (291833238 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a4efe8d7255560e1e1231802cc68ad34e714b4a6fd332273ad49b85f2b6e7406`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Tue, 04 Jul 2023 15:46:00 GMT
WORKDIR /usr/src/perl
# Tue, 04 Jul 2023 17:16:10 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 04 Jul 2023 17:16:11 GMT
WORKDIR /
# Tue, 04 Jul 2023 17:16:11 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e7ec8287aa9fcd21fca6f2d3ecafcf2fa4228740e823417bf810e41a95217e31`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:20b8ed142f3a7759fbfd6d260e8e0778c050877994fd5cf9bea446a859ac9ebe`  
		Last Modified: Tue, 04 Jul 2023 19:11:51 GMT  
...
```console
$ docker pull perl@sha256:42aae0ca49f78e3127554896f20ee8737a46ee26ffe3ba7612f9f33a5d875ca9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.5 MB (317459210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ff5bb3ad987929d3075effb7d0861d9fec19473abfbead0381a3ca1dd88cf03`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:5b245f76a7f3bd5595cdb15bdcd0becc1408d44c5e81b90f1ec71536d381a187`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a656aca0f4944a25821ea1334a6b377315c86bfa7195f0a636c9e84428b422e`  
		Last Modified: Tue, 04 Jul 2023 09:35:37 GMT  
		Size: 15.1 MB (15086663 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:2c0e54006cc0dda2c1b32d4efae901be70d8ffcfee3cbe5e844063921d66e754
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.9 MB (335923890 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3bc063b1960a047db01165fab55335b71624ea9e881c2a9e1165ad5fc92d091b`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Tue, 04 Jul 2023 09:21:02 GMT
WORKDIR /usr/src/perl
# Tue, 04 Jul 2023 11:25:17 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 04 Jul 2023 11:25:17 GMT
WORKDIR /
# Tue, 04 Jul 2023 11:25:18 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:dc3e39ab0465a41b72761fd045b283de9072a06427d438ff0a481aceebb39079`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe775c3529e0da194754ba3650860ca7274235fb6d4637289fcb945d62079fc2`  
		Last Modified: Tue, 04 Jul 2023 14:23:19 GMT  
		Size: 14.7 MB (14709734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
