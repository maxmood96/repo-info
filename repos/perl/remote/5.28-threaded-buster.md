...
```console
$ docker pull perl@sha256:4353b88672479550f36831326ece5a7d0411edbc563e9f2f5dde87e3a1b846da
```
...
```console
$ docker pull perl@sha256:b5270fc35fc2b608eb76ab41bb5be3626245117062251fea5945e98bf187b771
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.3 MB (326344860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:86653cf78535d0a6ecd1ca56b083d148f431e9c90acb54f0ce86af1cb4a3d7ea`
...
-	Layers:
	...
	-	`sha256:4ad46e8a18e5330a585df9f66e67c92e1ac5e3bc8617b6b7412e47a014815ea6`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ab21962a168916864f701841c7a9523c870482c2632974a265a34171fa3c3ea5`  
		Last Modified: Tue, 12 Jan 2021 15:55:50 GMT  
		Size: 3.0 KB (3050 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d18a62489247021a401d17050b51842daff61096675c9e18235334f2a36bd40f`  
		Last Modified: Tue, 12 Jan 2021 15:57:23 GMT  
		Size: 14.0 MB (13989314 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:67d7b2a1a7ae1e47bbf0548cbe42e5fd75eaddcc04fac0d0127e0b6063917740
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.8 MB (316817144 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ae3e982b9677cc9ec5e4d45bf035c4e6d0ace0c118b3f409c332d90d961fc61e`
-	Default Command: `["perl5.28.3","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 09:18:16 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.28.3.tar.xz -o perl-5.28.3.tar.xz     && echo '77dc1ddf541643af14d585867d3d0741cce45d0dbe8f1467024e63165d9e2fc5 *perl-5.28.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.28.3.tar.xz -C /usr/src/perl     && rm perl-5.28.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 09:18:17 GMT
WORKDIR /
# Tue, 12 Jan 2021 09:18:18 GMT
CMD ["perl5.28.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:52a578b440f87d8c12294a11c7d5bfc0d14acd3af6b34d79cf18d64b7774ea86`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97ba4eb19075b5634efd365e7f5f1872749bd16ddc4facb6b4d2271f41b9599c`  
		Last Modified: Tue, 12 Jan 2021 09:55:18 GMT  
		Size: 13.9 MB (13928791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
