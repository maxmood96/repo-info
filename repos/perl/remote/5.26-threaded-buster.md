...
```console
$ docker pull perl@sha256:0ca53efb04d3a0f4ec4b8ccead22dceb538cb6d77ec584ea5fdbb02e72f3e5c2
```
...
```console
$ docker pull perl@sha256:aff25b74f5f0c599529a642efa61b15ba0ae59e24e89752af852ff38d62ec632
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **290.6 MB (290623387 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6b45849fe36bc9c3ed0d9d7ce79b765c7b98b9449bf9dfe9efe2ee567a0e4120`
-	Default Command: `["perl5.26.3","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Wed, 26 May 2021 02:14:20 GMT
COPY multi:358ad9bd680379d367fc08d0f4c8f134b31c045bb5fb4609a7c01a9c3e0e56f1 in /usr/src/perl/ 
# Wed, 26 May 2021 02:14:20 GMT
WORKDIR /usr/src/perl
# Wed, 26 May 2021 02:45:31 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 26 May 2021 02:45:31 GMT
WORKDIR /
# Wed, 26 May 2021 02:45:32 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:9c1ff84aa3e7a81fc16b5e007121c2dedbf01d23c96fc520c9ca3b0b09f1368f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5c6aec1c68c093129cb9a43a06544c429e6209087d465d320c57bc13dfb89f90`  
		Last Modified: Wed, 26 May 2021 10:01:01 GMT  
		Size: 3.8 KB (3813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9aee480cbaa7a1665bf2e15b806718043fdaa401d277788d9f89de03668a3bc`  
		Last Modified: Wed, 26 May 2021 10:02:15 GMT  
		Size: 12.3 MB (12320813 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
