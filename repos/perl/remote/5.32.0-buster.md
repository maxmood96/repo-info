...
```console
$ docker pull perl@sha256:64d418095a93804f2960a9785d57dd313358728d7e0cd6e71404eb2704c4026f
```
...
```console
$ docker pull perl@sha256:dddcbf8766484f175e8ce42ef898c4dcbeb55364ece315fb6e06d53bf261538d
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.4 MB (326422331 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e2dc55a9c5802039967c14b68b12f9a811650478a1435012c239eb936ef34704`
...
-	Layers:
	...
	-	`sha256:5e397b98e2c31ee6cf81a806aa82390c124e31177d4bf476fe3cef8344383fdd`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:44f83e0531718e05f57693a8712fa387c05449fb0830ff6ead9ee5592e8cd0bb`  
		Last Modified: Tue, 12 Jan 2021 15:51:21 GMT  
		Size: 14.1 MB (14069658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:bcb7cb720504436bfbaa0b337a5fc7f05f4eb70cf0001d1683a6b4a916048fe4
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.4 MB (291417233 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6c8098d129a6bd7686eee9687e95f88f0cc38ac4049d24b0e56c1b630c0bd8b6`
-	Default Command: `["perl5.32.0","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Tue, 12 Jan 2021 04:11:37 GMT
COPY file:3744c5cc39cdbdcae10db09a1f0f399005a79f93c237b387a72ff5710cdd458c in /usr/src/perl/ 
# Tue, 12 Jan 2021 04:11:38 GMT
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 04:20:49 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 04:20:51 GMT
WORKDIR /
# Tue, 12 Jan 2021 04:20:53 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:c51dcc5770194ba6ad1c304852ba4be22285ba0b6b50fc154d3cd9355e3360ce`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9cc3e9ca4a977f6552c61084ac066634fe52d04d1234af79c5d6c3b1b54e9263`  
		Last Modified: Tue, 12 Jan 2021 07:55:46 GMT  
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7109845eb69f75894790e5ac538b7ca3e13d0a220a01f974fbb84309d62bbdf`  
		Last Modified: Tue, 12 Jan 2021 07:55:51 GMT  
		Size: 13.2 MB (13215776 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:6050f92c8eabe9b0b3704259654d6698708a5dd3a4e0cc02abb0c87942a44d2b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **316.9 MB (316901483 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1644a5e5291aa511d5f23ae7d5f4b4e80d9912bc0546d87d7ddb239b43c32213`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 06:04:56 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 06:05:01 GMT
WORKDIR /
# Tue, 12 Jan 2021 06:05:03 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:fb83876de5e231ea552b14358bebc4d1eeb40983e31b364e72457a823b08674f`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d4facb50336c58f7f0045899aaa28cfa97f3bff06264cc20bc7f2b19eda526aa`  
		Last Modified: Tue, 12 Jan 2021 09:47:44 GMT  
		Size: 14.0 MB (14016004 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-buster` - linux; 386

```console
$ docker pull perl@sha256:226f7bc9e2edf8b32a72374dc498fddf598db8d27f24aea03434099060a76ee2
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.3 MB (335343484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7430158d6de52ef3bf271d36c4a87fadad93b3b467f0daf04a34609c414f0ece`
-	Default Command: `["perl5.32.0","-de0"]`
...
LABEL maintainer=Peter Martini <PeterCMartini@GMail.com>, Zak B. Elep <zakame@cpan.org>
# Tue, 12 Jan 2021 04:09:54 GMT
COPY file:3744c5cc39cdbdcae10db09a1f0f399005a79f93c237b387a72ff5710cdd458c in /usr/src/perl/ 
# Tue, 12 Jan 2021 04:09:54 GMT
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 04:20:54 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 04:20:55 GMT
WORKDIR /
# Tue, 12 Jan 2021 04:20:55 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0b6cceb0bea6140ddb7df1a40f01d872eff6767ee67808d1973c7e489c770b1b`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96b2dfdbae10fd3afcc03a0786ab2a09ba703ef0c15903c95e68f92dbb09d29a`  
		Last Modified: Tue, 12 Jan 2021 09:41:34 GMT  
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d839a05f885fa608e4c3804383741d3601586a735c87aa9f721daf335a3013f1`  
		Last Modified: Tue, 12 Jan 2021 09:41:40 GMT  
		Size: 13.6 MB (13565166 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-buster` - linux; ppc64le

```console
$ docker pull perl@sha256:df3d9a0c2cda57c3c5a363e8effdbd65cee38ae2d1b0ebcada5117311b90986b
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **347.8 MB (347840828 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fac8e11a5119167c550c7b835425561cb63a6efe7e43daeb718327c794381b03`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 05:58:34 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 05:58:37 GMT
WORKDIR /
# Tue, 12 Jan 2021 05:58:39 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:af44d5ce3ab4833008787e08cee1b875198c48efa1e04595103dca8772d06e50`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dce1dd7991f6196790d1ed33a39183a2a048afa2f90efd38db49eb3210c84fe`  
		Last Modified: Tue, 12 Jan 2021 07:36:35 GMT  
		Size: 14.1 MB (14102307 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-buster` - linux; s390x

```console
$ docker pull perl@sha256:091808a08095605485dadc812cba1d7d1fef1a3d441049239f327260ee9305e8
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.9 MB (308857679 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:82324d4e4c05b133eb079e139eabf0d892aa8d0d854359fde2117043b74ec17a`
-	Default Command: `["perl5.32.0","-de0"]`
...
# Tue, 12 Jan 2021 05:35:08 GMT
WORKDIR /usr/src/perl
# Tue, 12 Jan 2021 05:39:51 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 12 Jan 2021 05:39:52 GMT
WORKDIR /
# Tue, 12 Jan 2021 05:39:52 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:1c6c33be2029262a9b4c18f29c77b6cd650bb3e8f7c623cc538d27552d963e50`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5210458ab82225ee2a0fed708ecc3a1db21332d8536673109dca62796f3f1cf7`  
		Last Modified: Tue, 12 Jan 2021 06:38:38 GMT  
		Size: 14.4 MB (14406671 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
