...
```console
$ docker pull perl@sha256:98c45ce1df3c235c9974fc00ab1ea6e6745a111ec5b66623de00b6cbfd71931b
```
...
```console
$ docker pull perl@sha256:7a8f369efa81ac1cb6763094bdbdb0546fce368795ce387731d2518db99fd345
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.0 MB (310026403 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e5f318305b32dab030a287dd8d2cce5ab4b5ea24258591d574b54b39bbc0afaa`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 04 Aug 2020 12:26:39 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 04 Aug 2020 12:26:40 GMT
WORKDIR /
# Tue, 04 Aug 2020 12:26:40 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:bda2e35ba5d4445a8a6f3f3ebe87bb11e54544f65ee03d3037f0f0e12858ab3c`  
		...
		Size: 205.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c53f6fbe7d29569564a9ec868b790c765b614b3669537378617f522b00b57e5d`  
		Last Modified: Tue, 04 Aug 2020 16:15:57 GMT  
		Size: 13.2 MB (13243246 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-stretch` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:dcc7cf0e38d8f9ec911e117680281f01506bcce67219581c359e325ebb7010e5
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.2 MB (321215911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3290afcaf4151c7239515777833de8f4e197b9172b01fa153fdb5e5e45888c2d`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 22 Jul 2020 07:28:04 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 22 Jul 2020 07:28:06 GMT
WORKDIR /
# Wed, 22 Jul 2020 07:28:12 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e0ee0337bb9e371f1c0935d7befd8d605c01d6e4f9b89a04a786ff74046ea858`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:a896c4926a747dd7bda1415556271d28e95bcf2a28b8f3a241dd0c1ab95c0b0b`  
		Last Modified: Wed, 22 Jul 2020 11:13:06 GMT  
		Size: 13.9 MB (13897760 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-stretch` - linux; 386

```console
$ docker pull perl@sha256:827710f9b3de477af9bc8474944962fccb643f4ca19f0f3a0a44f76fbc6101e7
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.9 MB (345896231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b653972bf23c2c0093a42297b0c89a7e22fa9c1ea700d8b4592b1029be598a9d`
-	Default Command: `["perl5.32.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:859d3b595bf3ccda54d79c59ebe697bddd7919401b9c11e85549c69e6e1b599e`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15ccd6ac4792433cc56dc8452925991af1e4c1ed3a4f9390839d85b6bec44ff8`  
		Last Modified: Tue, 04 Aug 2020 12:42:50 GMT  
		Size: 13.6 MB (13569432 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
