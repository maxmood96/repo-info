...
```console
$ docker pull perl@sha256:94062e5cc34dab17d1e63a1f0850a364f0080caf7388bddf3b4446365b9d8127
```
...
```console
$ docker pull perl@sha256:962d8e3397f23a4cd3b0ac6c2b12e598624ace0a580bb0be164a8884dd9c5ee2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.3 MB (339325329 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39b498c2704a78ba64ce8415f632a2fbaedd3a7a3a84d265fa53d3a8d9bba9d7`
...
-	Layers:
	...
	-	`sha256:a81840f6f0c19b68cf1a88abe2ead3de425086f4a21bf39fc81390c276a68e01`  
		...
		Size: 413.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b9945229229c5c7d8e9d9b1fded2bef6ed57560e0ae1e334fa8f8fd9c977614b`  
		Last Modified: Sat, 06 Jun 2020 01:10:24 GMT  
		Size: 13.8 MB (13819405 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:0bb279273f319d2833c9f76ceb3b63444588b5f5e0d1f5533e0401d18aa6fbf0
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **321.0 MB (320983231 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2558991c55c902411f8a5c6379e71f3b6353afd22c7d74248dfae72192e04f9b`
-	Default Command: `["perl5.30.3","-de0"]`
...
WORKDIR /usr/src/perl
# Fri, 05 Jun 2020 20:04:03 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 05 Jun 2020 20:04:06 GMT
WORKDIR /
# Fri, 05 Jun 2020 20:04:07 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:5c40a17bdee95cece33731c12a8083b4783f18a9c6b8f404cc8904cf200249ea`  
		...
		Size: 443.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:005b02294c3ae3855ed5baec1f1ed62128c2a4f56dfc2f7c82483e3a80331b15`  
		Last Modified: Sat, 06 Jun 2020 00:01:48 GMT  
		Size: 13.7 MB (13658749 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
