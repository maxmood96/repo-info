...
### `perl:5.39.9-slim-bookworm` - linux; amd64
...
### `perl:5.39.9-slim-bookworm` - unknown; unknown
...
### `perl:5.39.9-slim-bookworm` - linux; arm variant v5
...
### `perl:5.39.9-slim-bookworm` - linux; arm variant v7
...
### `perl:5.39.9-slim-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.9-slim-bookworm` - linux; 386
...
### `perl:5.39.9-slim-bookworm` - linux; mips64le
...
### `perl:5.39.9-slim-bookworm` - linux; ppc64le
...
### `perl:5.39.9-slim-bookworm` - linux; s390x
