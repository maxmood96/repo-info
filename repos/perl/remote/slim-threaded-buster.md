...
```console
$ docker pull perl@sha256:4b26d8b8d91c222b709bf40b48c05c56a598950ba219070bf0a7d209fd329ac0
```
...
```console
$ docker pull perl@sha256:e5149140f520108ade1039484987ac70cfdb93a0b86fe2f0b82f4c1761172a39
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.1 MB (54117621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:331489ed8f7315e4346f8c2f24f3deaf78117d420d97b7960bbcff4c38bce465`
...
-	Layers:
	...
	-	`sha256:d0fc5708993b8fa9c792cc8c26a19b7efb2c3f164bb4bd2866104f786c0f406e`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66d7789245f8ec65af0de83956f04864d997048ac84c3abd2a7394f1798c2779`  
		Last Modified: Tue, 06 Dec 2022 11:43:33 GMT  
		Size: 27.0 MB (26977066 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:49e06a95d9df6664dbb60afff31a870043d86c30adda7565a6315379f016c7eb
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.3 MB (46283276 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:451a953e451e8bc98954892c247cab8a1b8ca279aa754ea0343d4823d21b2eaa`
-	Default Command: `["perl5.36.0","-de0"]`
...
# Tue, 06 Dec 2022 02:11:59 GMT
WORKDIR /usr/src/perl
# Tue, 06 Dec 2022 02:31:11 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        zlib1g-dev        xz-utils        libssl-dev     && curl -fL https://www.cpan.org/src/5.0/perl-5.36.0.tar.xz -o perl-5.36.0.tar.xz     && echo '0f386dccbee8e26286404b2cca144e1005be65477979beb9b1ba272d4819bcf0 *perl-5.36.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.36.0.tar.xz -C /usr/src/perl     && rm perl-5.36.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && savedPackages="ca-certificates make netbase zlib1g-dev libssl-dev"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 06 Dec 2022 02:31:12 GMT
WORKDIR /
# Tue, 06 Dec 2022 02:31:12 GMT
CMD ["perl5.36.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:ec302e26530375b82003deac14a262219076de80c8f0b73e7576c6c34e63d94c`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:062f80adfc4bf7e2315a71ebde16085fa056897a792ecbc229aebb9b0ea76063`  
		Last Modified: Tue, 06 Dec 2022 03:27:32 GMT  
		Size: 23.5 MB (23534160 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:slim-threaded-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:66c6053b9b416411ec4fa52bfed1e2cc0d93d12e576f1981d2949e5c38590022
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.5 MB (51504721 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bd9a287726284c2605cef180046a9595303a14533020d5341228305b951b0ee`
-	Default Command: `["perl5.36.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:08d7473f5494fd90b6f8d1c1d03489023aa0a87e8568ddecd7d59f7aa7cef1dc`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:73f28ac15c9bb6384f8e404c0d43b9658d120c60bae38be6b30ca2aeed09aa16`  
		Last Modified: Tue, 06 Dec 2022 06:31:47 GMT  
		Size: 25.6 MB (25589568 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:slim-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:0257e88093feacfbcbf4189efc183e8287b2fcc3589f057b05e9398c36243e88
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **58.9 MB (58943309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b2d7491365123d193a4dcc27dc6ed533313f0841bf1d2c01a143cbd59f469015`
-	Default Command: `["perl5.36.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:ae59163d2ca3a04a784aa8de64a74052bc6d73a9624127c60c1ae3bbcede09d3`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bc2e7ba489bce2414dd7dfbc6068d701abd26e457d251d200c3692b58e6c0902`  
		Last Modified: Tue, 06 Dec 2022 06:56:02 GMT  
		Size: 31.1 MB (31144694 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
