...
```console
$ docker pull perl@sha256:fa51442cd8953339b65d375c175b1b25fd996f8c9bb2ed9b4ab637b300bfb7dc
```
...
```console
$ docker pull perl@sha256:6ffc1235e99ff02d4f9adbed2b72b7de5d55ef00cade34be2e6b6bf4b7b89128
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.1 MB (42055843 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:403e3ca276e262188c6fdae377af6de1a3be169a8e5baac99b8f9ba208efa231`
...
-	Layers:
	...
	-	`sha256:a45879f46414de891669357ea74b57b4478f538495ddee9fee6155b96646b7fa`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b409c6699e8fce55c87ee2ba8cbb91073a5ba908aaceaab69dc26bef52228f33`  
		Last Modified: Fri, 18 Mar 2022 14:11:09 GMT  
		Size: 14.9 MB (14901814 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:slim-threaded-buster` - linux; arm variant v5

```console
$ docker pull perl@sha256:5a0016e5546ac459a20522a1c196a28540d17d19d5c7bca024b597cedc2582ae
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **39.1 MB (39092153 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:486253915eace0a31bdae88bd85982366c74d59c51dba4d920c0dfdba0cf0e80`
-	Default Command: `["perl5.34.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 17 Mar 2022 12:08:26 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        xz-utils     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && savedPackages="make netbase"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 17 Mar 2022 12:08:27 GMT
WORKDIR /
# Thu, 17 Mar 2022 12:08:27 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:6eee2f28a8006c9b9f05b9800a18294dd6c17abbab3caf7464fe9cd1310a8a37`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e36b8ff9a32591fc59a16217966bf854da1c82ac54a9b3e58e8618c0c29ef323`  
		Last Modified: Thu, 17 Mar 2022 13:58:36 GMT  
		Size: 14.2 MB (14205755 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:36a04ae188bbe56db0d65336b22960f7fb1935ab1452469a162fd3d7fd45b5b1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.8 MB (40759520 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d53fc647c0e9c613a0fa6bf3a91526417b844bf4a90c71e478e2a8b1cb020ebe`
-	Default Command: `["perl5.34.0","-de0"]`
...
# Fri, 18 Mar 2022 02:17:26 GMT
WORKDIR /usr/src/perl
# Fri, 18 Mar 2022 02:38:47 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        xz-utils     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && savedPackages="make netbase"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 18 Mar 2022 02:38:48 GMT
WORKDIR /
# Fri, 18 Mar 2022 02:38:49 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:82914edf8e596dbc08b474cb748045d08eac97e91c8b6355c595cafb052bca8b`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:988116cd9f92097f078d783c0bd1c82480e54d6621e40b31c1b823e1d6798902`  
		Last Modified: Fri, 18 Mar 2022 03:51:30 GMT  
		Size: 14.8 MB (14836109 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:slim-threaded-buster` - linux; 386

```console
$ docker pull perl@sha256:897592255562b55d113d12b8e468e69ecc638cf05b60a339f43a18285d7d0f6e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **42.2 MB (42249831 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4814569b05d2a5df7b4533964bb4a47439a41f8333ea1c1bd795496d32b21c81`
-	Default Command: `["perl5.34.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:13a37dee533d49096b300ec66fa7a829aaccb9b51d96295475ec3ecf29d108e8`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:380b1f7fd434d60cfe2fd2282e79f3794f18d00907e5809dcbb09091aee72f75`  
		Last Modified: Fri, 18 Mar 2022 13:53:04 GMT  
		Size: 14.4 MB (14445061 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:slim-threaded-buster` - linux; mips64le

```console
$ docker pull perl@sha256:863214ded2cb7ec5b16f6f098eccc3e3900b48c8231db054ad68b45e7d58be00
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **40.0 MB (39978102 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4b7b7139140f9a003b5379eafd657cb9f60ae841027b1782216c5ad1c586613e`
-	Default Command: `["perl5.34.0","-de0"]`
...
WORKDIR /usr/src/perl
# Fri, 18 Mar 2022 00:42:42 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        xz-utils     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && savedPackages="make netbase"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 18 Mar 2022 00:42:45 GMT
WORKDIR /
# Fri, 18 Mar 2022 00:42:48 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:c237fa9ee32cbcf047d8c1e973629a506f84927ce57e93b41c2338c0be5bf202`  
		...
		Size: 182.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3b59c590dc759a0f88150257235538c848a5a15111357c2af35f08bf851d62b2`  
		Last Modified: Fri, 18 Mar 2022 06:09:48 GMT  
		Size: 14.2 MB (14157723 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:defeb5772347bf6dabd91be31e2af4b51151f92dad7a1fdb937d99f709a6bcd1
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **41.0 MB (41006313 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b4df34937c1e2f0700f566fc5f355893a87fbfd22bb21df7a7c1e553f934e7f5`
-	Default Command: `["perl5.34.0","-de0"]`
...
# Thu, 17 Mar 2022 17:04:45 GMT
WORKDIR /usr/src/perl
# Thu, 17 Mar 2022 17:20:04 GMT
RUN apt-get update     && apt-get install -y --no-install-recommends        bzip2        ca-certificates        curl        dpkg-dev        gcc        libc6-dev        make        netbase        patch        xz-utils     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && savedPackages="make netbase"     && apt-mark auto '.*' > /dev/null     && apt-mark manual $savedPackages     && apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false     && rm -fr /var/cache/apt/* /var/lib/apt/lists/*     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 17 Mar 2022 17:20:05 GMT
WORKDIR /
# Thu, 17 Mar 2022 17:20:05 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d935cbfd68de75e27b02cae4892ea27300a11f0abe057f882bc9c7e21bed5dc5`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:57cfed304edf5118ccc3cc51c1564b2d6ea7bae5db4fe5e8c4cc30479bb05caf`  
		Last Modified: Thu, 17 Mar 2022 18:05:03 GMT  
		Size: 15.2 MB (15237034 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
