...
```console
$ docker pull perl@sha256:5ceaf1a283e0978cf99acd3cc064ebc04adbc75cd04eb64a275a69188a9cced2
```
...
### `perl:5.39.8-threaded` - linux; arm variant v5
...
### `perl:5.39.8-threaded` - linux; arm variant v7
...
### `perl:5.39.8-threaded` - linux; arm64 variant v8
...
### `perl:5.39.8-threaded` - linux; 386
...
### `perl:5.39.8-threaded` - linux; mips64le
...
### `perl:5.39.8-threaded` - linux; s390x
