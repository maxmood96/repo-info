...
```console
$ docker pull perl@sha256:d797ca2c36338286381ffbcb31265a4d75edd52e91bcda5e6fff033a6389af21
```
...
```console
$ docker pull perl@sha256:be4db65576c9c4056568d58424ed722987620003ccb6f99e1ebcdec7f4663e84
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.1 MB (291062219 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7ccb137c32c921e99a4cbaf5b039fcc0bc0fc23c454dc589418cb2c569a5d30c`
-	Default Command: `["perl5.30.2","-de0"]`
...
WORKDIR /usr/src/perl
# Fri, 15 May 2020 12:48:02 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.2.tar.xz -o perl-5.30.2.tar.xz     && echo 'a1aa88bd6fbbdc2e82938afbb76c408b0ea847317737b712dc196cc7907a5259 *perl-5.30.2.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.2.tar.xz -C /usr/src/perl     && rm perl-5.30.2.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Fri, 15 May 2020 12:48:09 GMT
WORKDIR /
# Fri, 15 May 2020 12:48:10 GMT
CMD ["perl5.30.2" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:36f822f3f5e93227337fca7f7bb91f4236df886417d7bec672466727f935b508`  
		...
		Size: 447.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:060639b6a615b8fda4b8844dda14a8664e10dfa741de01c49a4054a19d3cd255`  
		Last Modified: Fri, 15 May 2020 15:54:18 GMT  
		Size: 13.0 MB (12978006 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:66dcb719b68d8abbc99da4aea0bb37d45583664ddd55ce584138b191c2ac923c
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.0 MB (335048386 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:76e3daab5c066c8768cafe7c6ccd9105e072065e2b0725cbc53564ea4232ef83`
-	Default Command: `["perl5.30.2","-de0"]`
...
-	Layers:
	...
	-	`sha256:0f79fe43276be23e7195f997edbb964f005c04f13b85fe2f7b9eba06ad5ecc38`  
		...
		Size: 414.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d78aa0723995ac617ed20f2d7cb7fc56906cc231ebaf1c647a3dc63aa043c2b6`  
		Last Modified: Fri, 15 May 2020 23:07:00 GMT  
		Size: 13.4 MB (13385796 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:445be78ed0c33f39f1a37f76a590f364ca39bf879c2ad94f8df81296d5c6b3c7
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.6 MB (308564721 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:24d32d721c270d0df2a4312eb82e1999f04676cdcabcb1227f958150434c5cf1`
-	Default Command: `["perl5.30.2","-de0"]`
...
-	Layers:
	...
	-	`sha256:f1421eddc9a9bb0cbe55c87c7af6f4f67494a5b42ad4ca553da43c539c2dbbe2`  
		...
		Size: 445.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:726933d7686935b1a39dffe553e6a08486d30efb3a0487607cfda382bb29a428`  
		Last Modified: Fri, 15 May 2020 07:33:40 GMT  
		Size: 14.2 MB (14201564 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
