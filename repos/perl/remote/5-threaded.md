...
```console
$ docker pull perl@sha256:926f42c32da6b0e47e74cda500c0838850817ab0ba27f2172a795593b3712bd4
```
...
```console
$ docker pull perl@sha256:6f85993c3e0deac4300795ecb33742923b9a0d910df1d7104ddd677ad9fccb3a
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326872778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1ba8a18d97cc908f0aab089480ce4318def1ded08d1ca9a6ee325cc808b8a6a5`
...
-	Layers:
	...
	-	`sha256:aced745b792295fff94af140e5eb2814079ef8633a9c61c6619cb94b92dee18e`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:16836b99b87c4ba9f11eef5874ac90ea28831009c2100ec429daa478e3f29777`  
		Last Modified: Thu, 22 Jul 2021 13:26:34 GMT  
		Size: 14.4 MB (14371809 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:a888877237ef1922742981e4bc5b4eaee772c1995d1940efc66f569346a9f191
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.4 MB (317354992 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:040ca586e5b4f5681590a2afd7d5ae6e066a2ac2703bd36e8a2cdd6af8e17e37`
-	Default Command: `["perl5.34.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:09355a38d5ed616e097584e49fabfed81db5657c315c3b4c95ff4ce5bd71e5ff`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:350724c9acabb1ea4b25088f4e372649ddb3c9b411c308552a113b3b66cc89b0`  
		Last Modified: Thu, 22 Jul 2021 07:52:02 GMT  
		Size: 14.3 MB (14310624 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded` - linux; 386

```console
$ docker pull perl@sha256:380f44f5d645cfb52eb6cc5cba10d624883c687ffe3a339d50b494fc244f6628
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.8 MB (335827038 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b35eaf32857e1cb1dc7ae92fdf7270e6112841769a816760524060f18cd3e2e`
-	Default Command: `["perl5.34.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 22 Jul 2021 05:58:52 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 22 Jul 2021 05:58:53 GMT
WORKDIR /
# Thu, 22 Jul 2021 05:58:53 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:aa2e0a7e9927baf735d5a4123e8e5c460c194443a017b9b86e2d885a0d473483`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:63755c3c48ae863e876db525809c7f9124bdd5932bcaf1a02ab06762314e781e`  
		Last Modified: Thu, 22 Jul 2021 09:31:54 GMT  
		Size: 13.9 MB (13911077 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5-threaded` - linux; ppc64le

```console
$ docker pull perl@sha256:411376e58acdb8741e4401bab33caff7afbc33b5879eee954a49a58a372b58d7
```

-	Docker Version: 20.10.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348360583 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:42e6d1621545723beaa4b489803663d1a0556bbedc3862eef4a8a98c6ff02b83`
-	Default Command: `["perl5.34.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 22 Jul 2021 22:09:21 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.0.tar.xz -o perl-5.34.0.tar.xz     && echo '82c2e5e5c71b0e10487a80d79140469ab1f8056349ca8545140a224dbbed7ded *perl-5.34.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.0.tar.xz -C /usr/src/perl     && rm perl-5.34.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 22 Jul 2021 22:09:31 GMT
WORKDIR /
# Thu, 22 Jul 2021 22:09:40 GMT
CMD ["perl5.34.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:fd875c10df173c8532d12da2f98b98c606eb9e2532b561d51867c5cca438287f`  
		...
		Size: 204.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9e9d840e0c6a9a38b502d4899be9e6a73db3aaff3fed963b91755565a2806c8a`  
		Last Modified: Fri, 23 Jul 2021 00:00:46 GMT  
		Size: 14.4 MB (14437679 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
