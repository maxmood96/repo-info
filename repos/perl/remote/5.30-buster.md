...
```console
$ docker pull perl@sha256:d7dc95128fe2bd90574c9b0fd862d3ed53c40653625cd5f0461a7160997fb12c
```
...
```console
$ docker pull perl@sha256:0665d1239045c3f1d0089f32324eebe9cc015644ae9aa18efd29ea5e44da4979
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.4 MB (326438351 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:af9d99f8fe0615b40c59a53e0a6e21dc69000245f3da3cf358e43efbf2407a4d`
...
-	Layers:
	...
	-	`sha256:8d9d6ba2a5fee779c81473a741e14daf7f810df347f59a04a8fe4f1446d4ec28`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:177c1c21c63a53034d72c321888bd56d6e79de27d17fe9854f569ce75421146c`  
		Last Modified: Wed, 11 May 2022 12:20:04 GMT  
		Size: 13.8 MB (13819177 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:6bd2dea784d431923715c284a53b663cd66c895546ae0dcdb5d522f2a03eee42
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.1 MB (335114415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5e26d967fff6ca17a1b501d93cf7d1b8777526f44217d76e2a2d42a154821358`
-	Default Command: `["perl5.30.3","-de0"]`
...
-	Layers:
	...
	-	`sha256:29e06679375820bb14455409a0ca38e85ee44de2842f19146ba1ff3df4869af9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b669ca8e407734fa12ee04ebc31009ca083cc6ca04ddcab80dfe998d3e4e3084`  
		Last Modified: Wed, 11 May 2022 07:09:29 GMT  
		Size: 13.3 MB (13315535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:504921b282341ed73ec914cc0238530976206269737e16f0468532e30e8f95b6
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.8 MB (308809907 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d9cd4e50ca0e3957cb35437d2852271b36b6176c65bdd7a5f06241939609337`
-	Default Command: `["perl5.30.3","-de0"]`
...
# Wed, 11 May 2022 04:45:10 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 04:49:33 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.30.3.tar.xz -o perl-5.30.3.tar.xz     && echo '6967595f2e3f3a94544c35152f9a25e0cb8ea24ae45f4bf1882f2e33f4a400f4 *perl-5.30.3.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.30.3.tar.xz -C /usr/src/perl     && rm perl-5.30.3.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 04:49:34 GMT
WORKDIR /
# Wed, 11 May 2022 04:49:34 GMT
CMD ["perl5.30.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:25332130227024cf7921cad13e958fd0b8b660b5f1eddf2a340234f1bcb4195b`  
		...
		Size: 1.5 KB (1451 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aed0f8bc735737664bb9c22775b55bc31845d3f1158484d5b7bc5478db6ef4a3`  
		Last Modified: Wed, 11 May 2022 05:29:11 GMT  
		Size: 14.2 MB (14158535 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
