...
### `perl:5.43.7-threaded` - linux; amd64
...
### `perl:5.43.7-threaded` - unknown; unknown
...
### `perl:5.43.7-threaded` - linux; arm variant v5
...
### `perl:5.43.7-threaded` - linux; arm variant v7
...
### `perl:5.43.7-threaded` - linux; arm64 variant v8
...
### `perl:5.43.7-threaded` - linux; ppc64le
...
### `perl:5.43.7-threaded` - linux; riscv64
...
### `perl:5.43.7-threaded` - linux; s390x
