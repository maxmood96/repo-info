...
```console
$ docker pull perl@sha256:211fb53158c21d3385b7eb61664503310be50f1f60ce85342035d154dc53ddad
```
...
```console
$ docker pull perl@sha256:314d2333f904aa01405466df43130969fd863b7e82263c67418edf65a059d757
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.2 MB (336165989 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4e4dc34aa24e121749c7d900bd2268325841b0ffd3e4d992f9b1b9be548f62d6`
...
-	Layers:
	...
	-	`sha256:2f3cd7c95976bf6db5faaf7362bcafc99b3c7ecaaaf7207ff701e2d56ba14bdd`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0a1deabc104b00e5e2c644a45efb610b388bf239e16796073cc3adccdb98cd73`  
		Last Modified: Wed, 11 May 2022 12:17:47 GMT  
		Size: 14.0 MB (14048258 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:e03935d7e00665986817f73f92b20ba4405ce5e6bd69c700a9c4fa9a7b777ef7
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.0 MB (341011608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c379cc1e81708c37171ffde5089a591c498c086f5bd3cc2e785e5f572da85df`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Wed, 11 May 2022 05:42:14 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 05:42:15 GMT
WORKDIR /
# Wed, 11 May 2022 05:42:15 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:3400c1e2bd6b1f95e908e0e6b96281a4e230d779585956e5d4a268b31a8085bb`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ac41428e9c7cf41f070d4f1807861d43be3eca08ebfff04b1f9d140e41448bc4`  
		Last Modified: Wed, 11 May 2022 07:06:52 GMT  
		Size: 13.5 MB (13537304 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:e2e5f716545717a236308fa53349cab1d11b18fb74f585ba9e4d468a51faf0d3
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.1 MB (310148544 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b9913891a90de354dae772ec536b10c4fb6b537b73fc1df94c65651ff2cc4cd6`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Wed, 11 May 2022 03:11:57 GMT
WORKDIR /usr/src/perl
# Wed, 11 May 2022 03:58:06 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Wed, 11 May 2022 03:58:07 GMT
WORKDIR /
# Wed, 11 May 2022 03:58:08 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:af9d0cd9682f36815b588b7d5cf9208f463a7f944ca9ee8ebed304a2df849ebc`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:496284e90325dff7f39a40a908083c6ce3c094a6526a1d4b3c6f5282430f902e`  
		Last Modified: Wed, 11 May 2022 05:27:34 GMT  
		Size: 14.4 MB (14406659 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
