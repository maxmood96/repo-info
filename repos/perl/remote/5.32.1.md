...
```console
$ docker pull perl@sha256:21fc8f58f8ac09ff7a75e020fd25c2cace19daba0b4baba020b9f545c914648c
```
...
```console
$ docker pull perl@sha256:fe5d56873227dbd7648ef327f730781e699c306f54a54f3769344c64c8dcad10
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.1 MB (337086714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:88b971ad2c6874071190abad062ca5995c51e504f1f63d11c040c4122139e8d5`
...
-	Layers:
	...
	-	`sha256:039101db8e5e8af3bba0dc84a029c89f44c6b2023a5a1ba71bdb323a0c0cbc43`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9380dcf2858f216c167b159a89f5a8e45562caf15a72da9ab0cc4d3307d70c88`  
		Last Modified: Thu, 30 Jun 2022 21:44:14 GMT  
		Size: 14.7 MB (14705744 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm variant v5

```console
$ docker pull perl@sha256:4464a364534959dca5a61161874edd38a7c24023b5714095a1b290a2e4bb580c
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **308.8 MB (308804421 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d86f3693548026c2926db0b9b541b6c4f58d4833a0b8b75bb420ba63e9ad3255`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:124b3f1913edc2a12cdb9df3faa0b90a9d0d3a250ab491774d59c59b81c36dd7`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:003a7c55d2f872b127f5d950710aaa75dfc69ab7776289ace419be99ac3754e9`  
		Last Modified: Thu, 23 Jun 2022 08:26:03 GMT  
		Size: 13.4 MB (13354290 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm variant v7

```console
$ docker pull perl@sha256:28b8bd77273ef477ad11084eda75d0a13c4845c9624c1389572dbf03a235b06b
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.1 MB (296080456 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea965d17d4d23cb8852c1e1852b03eb49fa055164258d73b851d8c4ad9906598`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 11:28:51 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 11:28:52 GMT
WORKDIR /
# Thu, 23 Jun 2022 11:28:53 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:806d31ee392b8a457ba4c87f204ddb8d90f8da8e17d3bd48b2da8cf3d1963fb5`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4a61f5c6a28ecf74a641ba1789610a0b4d6226243c411d85f8ca213efaa06bc3`  
		Last Modified: Thu, 23 Jun 2022 13:07:07 GMT  
		Size: 13.2 MB (13172979 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:2dfb2409ab925f6a25e38797c17299f6b2e50f2e5af96931da91459a1a27b963
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.3 MB (328269717 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:edffec563d414dbee7ed1710b7b20480758571baf83f758eb7f5ed56725101dd`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:e0c96ec1662b2101ba354e412444933b033b2ca34a1c2dda8fc78569771348a1`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:69867b49f3b71a19ce5423c56fe8198364b2c6a11ffda1af5a56b64d98732dd1`  
		Last Modified: Thu, 30 Jun 2022 22:37:09 GMT  
		Size: 14.6 MB (14642365 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; 386

```console
$ docker pull perl@sha256:d0df651b729dd64591057db47cd57dc4e40afb49da13fcb730b17b470250f827
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **341.9 MB (341909840 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a3cc10481c011ebc5896d13cb1a2b86f085f44e9e8a1118237c68e6b7141cb0e`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 23 Jun 2022 04:04:58 GMT
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 20:31:03 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 20:31:04 GMT
WORKDIR /
# Thu, 30 Jun 2022 20:31:05 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:548f924f45f139cae23dabd838ae1cb46f59c886b1c07c8b4e0bc0d23164ca1c`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d362332fa6e649af239fd66048ca13e5b007ac9479aec8151cd39f01139e3031`  
		Last Modified: Thu, 30 Jun 2022 21:26:27 GMT  
		Size: 14.2 MB (14186382 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; mips64le

```console
$ docker pull perl@sha256:553f5e283f8c6f09ddc4137781869c3f4d0b78172b14417d033fefa029e7fb4d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **314.4 MB (314359362 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e593624495873c0d3ee6a388df31d09ac73b37ec8e5cfc0ddda46fdf72b69e7e`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 10:28:50 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 10:28:56 GMT
WORKDIR /
# Thu, 23 Jun 2022 10:29:02 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:b538978893dd9776c2571a1b98eb7aab7e91e11061403744962dcd1e4cd2dd7d`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e3566742d73edbfb0757a6af3cfb3f2f4f615e4400d034eae5c1223352b83d5c`  
		Last Modified: Thu, 23 Jun 2022 13:01:37 GMT  
		Size: 13.3 MB (13314354 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; ppc64le

```console
$ docker pull perl@sha256:75dc67f05dd1334295f8f28201899f6527fd0790695b06fcf7bc18ab17cef1d4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.6 MB (345635861 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5757d3f28a2a9164fcaadf8250aa7a194c7428f0e8e0e49a2d1ec2a15ed7bf6e`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 21:16:48 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 21:16:51 GMT
WORKDIR /
# Thu, 30 Jun 2022 21:16:55 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:fab45b224cc1b8ffbe525cab450d9db435322c49cfac5355465157f0fc21d48b`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:156c1702ecc53b9cae3d9b3760ea0c0d170b03bdb00597a94469f10ee5ef57ad`  
		Last Modified: Thu, 30 Jun 2022 22:41:08 GMT  
		Size: 14.7 MB (14712707 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; s390x

```console
$ docker pull perl@sha256:f43c44318e16a09e75e923e2c02ae8bcf8fbdc80044199d3faa867af27e10c71
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.0 MB (311048855 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7105e3e9cc2d4fe3bc4942955c696315c2e8716289c6cf61615d6bf421dd2046`
-	Default Command: `["perl5.32.1","-de0"]`
...
# Thu, 23 Jun 2022 03:49:11 GMT
WORKDIR /usr/src/perl
# Thu, 30 Jun 2022 21:21:58 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && cd /usr/local/bin     && curl -fLO https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 *cpm' | sha256sum --strict --check -     && chmod +x cpm     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 30 Jun 2022 21:22:04 GMT
WORKDIR /
# Thu, 30 Jun 2022 21:22:04 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:39fec9602f7519e8d8d8b40e3af350e4d978f68aacf15be59ac08587a0cc9cf8`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:545eaaf5437ed253b5f9eade4caa6213e89096b75f036d618347a89cfbb86661`  
		Last Modified: Thu, 30 Jun 2022 22:37:10 GMT  
		Size: 15.1 MB (15053621 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
