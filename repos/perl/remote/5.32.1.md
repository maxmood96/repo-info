...
```console
$ docker pull perl@sha256:9f44ee50ed0ce8da57107ae04cc8e01c308bc44d7edd612864f3239489772f80
```
...
```console
$ docker pull perl@sha256:2e611a9dfb6eb4e8e93481e45b947de0f6c7da77696603ad078d554b391cd781
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.3 MB (337335620 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:129743525e8a71c5055419d7cb843977bb392e06d5be1d74dba775f4846a563a`
...
-	Layers:
	...
	-	`sha256:32c261b1701b7ee804670a3af5fdcf167722b6b07610dd60ca61f4eac8ee446e`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ee5ed7679d446eade3d5e19b28b0e5df88db4e267cce06e1797db1c436350b60`  
		Last Modified: Tue, 24 Jan 2023 22:07:58 GMT  
		Size: 14.8 MB (14809292 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm variant v5

```console
$ docker pull perl@sha256:c6ae8323487679fece1feea58826b5a5db9d728cfb41a81c45bc4aef072f36f3
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.6 MB (309641080 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd774332ed443eb73170bbe8402fb6f2de432c7cff4709db2b2de07e280b128e`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:dde2842214e8b162fa858c3ce0cf0bf6555c3ac8419724abc9ca14e5e2d8624c`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dcf33cd34c353c6feb1ea5da0e969dece281d86c8ad630a06ebd0acf5a171c76`  
		Last Modified: Tue, 24 Jan 2023 19:59:55 GMT  
		Size: 14.1 MB (14096087 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm variant v7

```console
$ docker pull perl@sha256:1f65d4522e0d658feafe573c6f87d2daa34cb81a01471698671372d4e45bcb6a
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **296.9 MB (296944915 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afe2c252d54961e2b72d6d053e27f9001b4164559cee66cc38a24d326cf842ce`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:726745dfa67a55a2d1d6eb7370bdd3b4606dc681371a6ad852e3acb1a3bba471`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1b502ad5f9efb0a67c94088c1a4082a5ebb544bece520738079a454f57300937`  
		Last Modified: Tue, 24 Jan 2023 22:04:53 GMT  
		Size: 13.9 MB (13905338 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:b0eee5191d3e0cbdda9f9b99e243aeeaaa24404b6d233bed35c7a21a2bccd750
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **328.9 MB (328930281 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:380980648d04e6649426715cc266c38dd5c280c85d7fd1ba29940a6927330a3a`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 19:25:20 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 19:25:20 GMT
WORKDIR /
# Tue, 24 Jan 2023 19:25:21 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:2158db51a93d54dc6ed1699acad99ab44c3323123db478c536b6c873d352cee0`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2c9466a8525af8455d4994b82f7398fd798f7aa95ecfcb38dfeaf7aaf990af86`  
		Last Modified: Tue, 24 Jan 2023 20:42:13 GMT  
...
```console
$ docker pull perl@sha256:c6d612b0a94c71d5ed8931e18758084b5bdf90c2d27284e4cce0a2d37776a75f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **342.3 MB (342321044 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cd6a5ccd7df33adf517d94a46a513950ae5d3832fbfc83ab483f533e448a0ded`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 19:55:07 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 19:55:08 GMT
WORKDIR /
# Tue, 24 Jan 2023 19:55:08 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d8b95fc5d4e820001baf560febdadba6f5d830cbf53c1192cf8c220ba22eb677`  
		...
		Size: 135.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:856f3e51c4b01f489f5c2d746308d00d5f55d0794fbd070202b47c14df05e382`  
		Last Modified: Tue, 24 Jan 2023 21:42:41 GMT  
		Size: 14.3 MB (14281294 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; mips64le

```console
$ docker pull perl@sha256:c02f61931dd0687d3fb16a9e43e1f61f8bfa55cc94095dfa081ab3215aecc866
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.3 MB (315342763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f41ac0c6af8377e94ca465916aae0212c8b684a850b8d9e79bda3141899a7786`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 12 Jan 2023 06:08:11 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Thu, 12 Jan 2023 06:08:17 GMT
WORKDIR /
# Thu, 12 Jan 2023 06:08:24 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:12c6bb3e366b3307c889cfae3bd791bb5350aa720e18d07e25319b52208c991d`  
		...
		Size: 182.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ed36466ccf9fec250f6b8de8f1485b7ab3c66fec69446dc3dd1ee58af57c5a6`  
		Last Modified: Thu, 12 Jan 2023 07:25:55 GMT  
		Size: 14.0 MB (14017229 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; ppc64le

```console
$ docker pull perl@sha256:5278c7be9308e0dc7dea8041096b887d344991b44bf731ee2721eddf4fbf68ef
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.8 MB (345844576 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:872b2a83e5f530b381348c5c4e2da1f6d00123fb59d3a10e849f36d54bbe8934`
-	Default Command: `["perl5.32.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:9841f4b9acc9a20f0e947e067b92af0e210cdd64a8f9eea3b045ef911ae1a5bb`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b82ed2759f32ab8d520f833604f94071cfa46eb712d8a1438a77e922c30f5a12`  
		Last Modified: Tue, 24 Jan 2023 21:25:40 GMT  
		Size: 14.8 MB (14807965 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.1` - linux; s390x

```console
$ docker pull perl@sha256:485f181e7fe42b10360478ca5167f378cd3590a1949c3cea96e9a0a1eb7a8747
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.3 MB (311250812 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:92e34a9198631eb9fc33e0d55915ecb4a54d21bdadc36cc1df21121407d95732`
-	Default Command: `["perl5.32.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 19:04:57 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.32.1.tar.xz -o perl-5.32.1.tar.xz     && echo '57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309 *perl-5.32.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.32.1.tar.xz -C /usr/src/perl     && rm perl-5.32.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 19:04:58 GMT
WORKDIR /
# Tue, 24 Jan 2023 19:04:58 GMT
CMD ["perl5.32.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8cb2e0a515e60df44424cac3c3a6bc760e711b8f1906f13cdb074d56f0aa261b`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:76698fe630699c4ef2f1e32c8f8845404759b9ca2d9f89eef968810a01e3d062`  
		Last Modified: Tue, 24 Jan 2023 19:52:28 GMT  
		Size: 15.2 MB (15156380 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
