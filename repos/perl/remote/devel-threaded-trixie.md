...
```console
$ docker pull perl@sha256:4677afcce82c44c9208852ab9227b1e10cf521dd23a79c005b19c5d5fb9510c7
```
...
```console
$ docker pull perl@sha256:6308c7d0766b26f75a6bb5928cdb3a5fe62a9182449c049a24c95be66c1c49f7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **395.1 MB (395098722 bytes)**  
...
-	Layers:
	...
	-	`sha256:7d5078996c30be46c1d6d8f3637295e95c130ae2aed81b3b70fbe5212209cebe`  
		...
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:6d98bfbde5f4ff69d729fc9a369f52640e0015d68e7860110c467f34a1b76e45`  
		Last Modified: Fri, 08 May 2026 22:34:58 GMT  
		Size: 16.2 MB (16238194 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:9a61fdafbd9eb7e422476aefe7ed054995a35322d17c8cfe863395e27d11b2b3`  
		Last Modified: Fri, 08 May 2026 22:34:58 GMT  
		Size: 133.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:161c0fbea28636de7d06343c3de83839577b477f1b1f9d5ae323561d78ee81f2
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.2 MB (17229593 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:afaa228c02f27aa71077cfb99a2ef84f5cc8b1a530f21b12965578cede8bcf36`

```dockerfile
```

-	Layers:
	-	`sha256:2e94579f88f745e9168fc6eefa6a8fe726d8935e2df4b7960d5c1316d0bbb899`  
		Last Modified: Fri, 08 May 2026 22:34:58 GMT  
		Size: 17.2 MB (17210974 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0a33528b08b5596e85f09e4c824dcd457fd1e9852adc63bf70b4e7ca403ae0d2`  
		Last Modified: Fri, 08 May 2026 22:34:57 GMT  
...
```console
$ docker pull perl@sha256:32cac177d4e256ab4a0933fd3870a224262e69085fe22f351e4eb70bf0af6d99
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **358.5 MB (358522455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2f4ecfabb3f98dd32831cc2474a015f4155e36a7ba7bd88b1c8e6963b5620652`
-	Default Command: `["perl5.43.9","-de0"]`
...
RUN set -ex; 	apt-get update; 	apt-get install -y --no-install-recommends 		autoconf 		automake 		bzip2 		default-libmysqlclient-dev 		dpkg-dev 		file 		g++ 		gcc 		imagemagick 		libbz2-dev 		libc6-dev 		libcurl4-openssl-dev 		libdb-dev 		libevent-dev 		libffi-dev 		libgdbm-dev 		libglib2.0-dev 		libgmp-dev 		libjpeg-dev 		libkrb5-dev 		liblzma-dev 		libmagickcore-dev 		libmagickwand-dev 		libmaxminddb-dev 		libncurses5-dev 		libncursesw5-dev 		libpng-dev 		libpq-dev 		libreadline-dev 		libsqlite3-dev 		libssl-dev 		libtool 		libwebp-dev 		libxml2-dev 		libxslt-dev 		libyaml-dev 		make 		patch 		unzip 		xz-utils 		zlib1g-dev 	; 	apt-get dist-clean # buildkit
# Fri, 08 May 2026 22:29:17 GMT
WORKDIR /usr/src/perl
# Fri, 08 May 2026 22:35:04 GMT
RUN true     && curl -fL https://cpan.metacpan.org/authors/id/E/EH/EHERMAN/perl-5.43.9.tar.gz -o perl-5.43.9.tar.gz     && echo 'aec72b03806f2003f97e86baf28a22a20cce912d618afadf3df1f005cda5b235 *perl-5.43.9.tar.gz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.43.9.tar.gz -C /usr/src/perl     && rm perl-5.43.9.tar.gz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local -Dusedevel -Dversiononly=undef -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7049.tar.gz     && echo 'b9ffb88e62a06aa91bd7d5a28ef6bdbb942608aea90e3969aa29b33640035214 *App-cpanminus-1.7049.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7049.tar.gz && cd App-cpanminus-1.7049     && perl -pi -E 's{http://(www\.cpan\.org|backpan\.perl\.org|cpan\.metacpan\.org|fastapi\.metacpan\.org|cpanmetadb\.plackperl\.org)}{https://$1}g' bin/cpanm     && perl -pi -E 's{try_lwp=>1}{try_lwp=>0}g' bin/cpanm     && perl bin/cpanm . && cd /root     && curl -fLO 'https://www.cpan.org/authors/id/C/CH/CHRISN/Net-SSLeay-1.96.tar.gz'     && echo 'ab213691685fb2a576c669cbc8d9266f8165a31563ad15b7c4030b94adfc0753 *Net-SSLeay-1.96.tar.gz' | sha256sum --strict --check -     && cpanm --notest --from $PWD Net-SSLeay-1.96.tar.gz     && curl -fLO 'https://www.cpan.org/authors/id/S/SU/SULLR/IO-Socket-SSL-2.098.tar.gz'     && echo 'b38473be20256b1a06447dd6769ad162bfad6a258234ed2c7e2e1819c16c4df7 *IO-Socket-SSL-2.098.tar.gz' | sha256sum --strict --check -     && SSL_CERT_DIR=/etc/ssl/certs cpanm --from $PWD IO-Socket-SSL-2.098.tar.gz     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.998003/cpm -o /usr/local/bin/cpm     && echo '6a27e528cf37635773e738db36c4b4ab4345d5a9d00b8cbd2f2dc01abc73177d */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /root/Net-SSLeay-1.96* /root/IO-Socket-SSL-2.098* /usr/src/perl /usr/src/App-cpanminus-1.7049* /tmp/*     && cpanm --version && cpm --version # buildkit
# Fri, 08 May 2026 22:35:04 GMT
WORKDIR /usr/src/app
# Fri, 08 May 2026 22:35:04 GMT
...
-	Layers:
	...
	-	`sha256:ac2b43951eb50fbbec798a98a0d5e3979bc819241fd4dcdb56f1db4886771d88`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:530863b23ac13ca539fffb6ae5380ad405c8b0008348fa63d70c0bc7864ea7ff`  
		Last Modified: Fri, 08 May 2026 22:35:23 GMT  
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:fa8264ce21254c807498e659d0f0ae596acaca1a2ff6ce83e3245f0c7ba62cad`  
		Last Modified: Fri, 08 May 2026 22:35:23 GMT  
		Size: 15.5 MB (15520722 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:0f306e3d9ea87509d19667b074e292c51500643a9d54fdf33164b82c2ce66f95`  
		Last Modified: Fri, 08 May 2026 22:35:23 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:b0c2855a9937c0cf928190b38f3779be1e0ba20eb024db24a2a3660e0e6f2c07
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.0 MB (16991911 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fedf1fd85e914629861aca97a32a57baa4d2a42fceef29d25fdc15277fc5730e`

```dockerfile
```

-	Layers:
	-	`sha256:7fab44021b5240c0e4af838de42d1d5654b7449fee054921365eb7f7de3ed662`  
		Last Modified: Fri, 08 May 2026 22:35:23 GMT  
		Size: 17.0 MB (16973196 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:e160b43b5a5b932bbc7a9b7bab0df1e5d98f4d9d2e8f1b59e32207cd466b5644`  
		Last Modified: Fri, 08 May 2026 22:35:23 GMT  
...
```console
$ docker pull perl@sha256:40f14498d743c357e2a945fcb56fa763945fc10db056243dc0c5e1309104b48b
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **340.9 MB (340891774 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a3496531a6d405d2924e11819b9bc27d4840f4035df4556911c145fd81eee10`
-	Default Command: `["perl5.43.9","-de0"]`
...
-	Layers:
	...
	-	`sha256:42c66f6797abbefc309d6193205f793cea64fedf67e46f6f6933d96ecdcb0436`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2ed6467ebc018188957fb39559c73701a2eed7fa00bce32a5f4ed1a1e0102f07`  
		Last Modified: Fri, 08 May 2026 23:24:40 GMT  
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:003c29377e3829cfbc07ac7ddd29855ab9b0bd31afdb011920d93ef9166413a7`  
		Last Modified: Fri, 08 May 2026 23:24:41 GMT  
		Size: 15.3 MB (15327111 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7231deafa9704d4f40075a6c3596875f2774fe2c9f88ffbba540124f9ab1aaf5`  
		Last Modified: Fri, 08 May 2026 23:24:40 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:9f5ed51f0d44992b9f8351482b467ca87ecfa24db6f6f0d71f0de2943641bae3
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.0 MB (16997701 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2c19763dc583fb47772fe3b45ab4ed7641fad4d410466ccb6080f7699ed0d9d`

```dockerfile
```

-	Layers:
	-	`sha256:6c889c183459f1d8c44346536b7b17cca6e22321d2b4166d3d1cfa31b2bf539f`  
		Last Modified: Fri, 08 May 2026 23:24:41 GMT  
		Size: 17.0 MB (16978986 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:aa54a55a4d1b0b20d0f5f7684ff84ff940ed6f3ab159a699832417a19d5f6e3f`  
		Last Modified: Fri, 08 May 2026 23:24:41 GMT  
		Size: 18.7 KB (18715 bytes)  
		MIME: application/vnd.in-toto+json
...
```console
$ docker pull perl@sha256:1b171ed13e4be37ce01a080dc264a4c9dd18a92522a115a1c3092602e3b41540
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **384.7 MB (384737604 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fe7c387a9bb267bfd9cc42abd7e387dd0a210f1f20210874c9274b7f168289f7`
-	Default Command: `["perl5.43.9","-de0"]`
...
-	Layers:
	...
	-	`sha256:c69b233d8ebf51fb9bd13bc97e3d21a3afaac7c61eed7a9962526711d2a69207`  
		...
		Size: 136.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d6ecb3ba84a308d45db78b53e05b2ce5df46c4e3b761fe7cd9f6edbf26e83418`  
		Last Modified: Fri, 08 May 2026 22:33:56 GMT  
		Size: 16.2 MB (16178886 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:c920b62cef9ba3812cbf990e0166c45e7dea8b522ede636a4c709cf878c8e535`  
		Last Modified: Fri, 08 May 2026 22:33:55 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:5ff45358eac6b9cadfe48469d31c15e8e80a64d75ad019ddb2dc76e6a48651fc
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.3 MB (17314051 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfee96da6f2418ff27d913c86d50f4cc4225d64d26d25b377098e316b3efc9fb`

```dockerfile
```

-	Layers:
	-	`sha256:36001e52c980479e34820ad1e84c28ab845b62a7bb1f3cd6dc78c57d12a5a958`  
		Last Modified: Fri, 08 May 2026 22:33:56 GMT  
		Size: 17.3 MB (17295304 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:618455fa88ae726335fef3960aabb4f2ae1bd5c5d2e414abb2f5d8bcb001a998`  
		Last Modified: Fri, 08 May 2026 22:33:55 GMT  
...
```console
$ docker pull perl@sha256:3d98648484606c32c87b56b4fe00980a4f17bac4e9d75e65e1771e90aa5472e7
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **400.6 MB (400648677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c410b6bfd209df36c645167698950e7b3d545855f682d4187ed8897fca0d0aec`
-	Default Command: `["perl5.43.9","-de0"]`
...
-	Layers:
	...
	-	`sha256:19404befc9815eae9c2365be7c9d31bd24655ff639e0e8fea5c4488851b28986`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2c6a3e4974df6bb5e3d0a4501b3c1bf603991d64c350a7af37837ce08d5695a9`  
		Last Modified: Wed, 22 Apr 2026 17:35:13 GMT  
		Size: 16.3 MB (16261299 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:2823f5fa286d427290f79fb839b1a63899a4c0bc2cc1452b2bd45f5c93555cfc`  
		Last Modified: Wed, 22 Apr 2026 17:35:12 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:9f035597eace7ed85d49a01393734b0479b71dd3e3aba0cf6099732aba0ad5fa
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.2 MB (17215218 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f177f3bd1e3f1ebc99ca357409c1e76e435ac77fde62495cb6909a3fe6ef85e3`

```dockerfile
```

-	Layers:
	-	`sha256:b8c1f83d774b3c5d85294fbeb1351cd09b422570be58a23319e4af35f1166987`  
		Last Modified: Wed, 22 Apr 2026 17:35:13 GMT  
		Size: 17.2 MB (17196543 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:0e44b77a46a5bc5b98a34327ab60504f0ee3ee5015bd730c4edd44c9bd91f4a9`  
		Last Modified: Wed, 22 Apr 2026 17:35:12 GMT  
...
```console
$ docker pull perl@sha256:2f6f85b89dd7ec8e76977e754a8b1b27befdd900613314a0ae23535ce9530a38
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **478.1 MB (478112119 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bb22c6b47fd9805ce610d4b1ad5c80b482a0cbffff94cc3bac3a827405dae17f`
-	Default Command: `["perl5.43.9","-de0"]`
...
-	Layers:
	...
	-	`sha256:e6f94dd0e1478b5b46141bbd76a34464f78d7294695b5ef36449f97083154fdf`  
		...
		Size: 135.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:28f402f7ae270eb30a3303ade8bce4e4ebd5d2ef62dd87e9f5a8e85180f05999`  
		Last Modified: Mon, 27 Apr 2026 08:08:10 GMT  
		Size: 15.7 MB (15684202 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7075d846dbd1faf6af6122c38c4237052865074baa505e4c0e044288fda36d84`  
		Last Modified: Mon, 27 Apr 2026 08:08:05 GMT  
		Size: 132.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull perl@sha256:ac7c6d7178ee67aec8f341856123a0d674ad5ae848281230ba21572383b9f3ae
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **17.3 MB (17285807 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:510e0eb9f755e3e37f9a568942f7d5ac61316646e560bbc3a388d06097ea557c`

```dockerfile
```

-	Layers:
	-	`sha256:877c88f6a824d9750b6f459dc3678a123e823b4005be62060a27a870f9e3de02`  
		Last Modified: Mon, 27 Apr 2026 08:08:10 GMT  
		Size: 17.3 MB (17267132 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:1a2e97c80846b9e89f7d2bdd056c9e8cd8e4004ec4667bc8ad06e3a0b9b05231`  
		Last Modified: Mon, 27 Apr 2026 08:08:05 GMT  
		Size: 18.7 KB (18675 bytes)  
		MIME: application/vnd.in-toto+json
