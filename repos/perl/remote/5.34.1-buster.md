...
```console
$ docker pull perl@sha256:2ab5625d8834985b955179ec9437bcccf3f397a51062cde026a038fdb4cd8799
```
...
```console
$ docker pull perl@sha256:41748a83ea570483d12b4bc7e45b767dc58de5fa92dca3a6531d5ebeb9b2d88c
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326866122 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:32195ce14cad14f83e5f91c0ca713771ca01e62f28ea95432ab652d48c5e581b`
...
-	Layers:
	...
	-	`sha256:69601aec7ec3fe16f74bc06648cc9889664537d2bc40c11acf3a9fbf018c61bb`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:48067a926f889f1c447b2251dc38d312892835f57cda9011638f31b849a8a2d8`  
		Last Modified: Tue, 23 May 2023 07:42:04 GMT  
		Size: 15.1 MB (15071910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:02f8284b96a30d4a65d7358e1078045a1dac66ca123435545567f01d3b5b86cf
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.8 MB (291788744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:48d8663d27b8fac82e9fd948c68b665e69b059329a3c4f30e87b8a9f193ba175`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:61e9b6f36ba7137452aabcd4ab6b9be70ac47a0a6e9d4c2fa8bd952f956aa1cb`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3aefb6c325f74720e09f1f83d4db7639f1e98ee79f5350e9e09a113799833f18`  
		Last Modified: Thu, 04 May 2023 10:23:33 GMT  
		Size: 14.2 MB (14186419 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:b937d2905d4790beb176b7890c397bd7d608a0532cd37331e669df97b83eb701
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.4 MB (317350641 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:36a58d8bbf1551c881cf4ce435f7c4fec32fc7dd7b5d771510b114e4f2ffa136`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:e9284d3c43402a858f6725fa4f9cf677a69bd829cee8af91fa4aa812aba977a3`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9571ccd5fc0e9066eaab67d91f37f5d3bc5fb48b1cbe9a53338266435d4ceb7`  
		Last Modified: Thu, 04 May 2023 06:02:08 GMT  
		Size: 15.0 MB (15016545 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; 386

```console
$ docker pull perl@sha256:76b552475beae2c3daf871787251ec166eb05379fd268be273004945291b54f9
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.8 MB (335767185 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:001d271cd02d7b870477cbf8eee0069d59a7bf00ab04bd4c77ee2d0895c74985`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Tue, 23 May 2023 06:15:37 GMT
WORKDIR /usr/src/perl
# Tue, 23 May 2023 07:41:57 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 23 May 2023 07:41:58 GMT
WORKDIR /
# Tue, 23 May 2023 07:41:58 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:ef179656f863fd557df3d567069bff1380956ed8998461c164569e772d7664f4`  
		...
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daae77a48acd374d16f1fb5e2a85955604c6c193ff11eec50fd49ac9aa37bfc3`  
		Last Modified: Tue, 23 May 2023 11:17:21 GMT  
		Size: 14.6 MB (14572526 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
