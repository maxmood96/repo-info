...
```console
$ docker pull perl@sha256:1e9e3d9d97a6c1f7fe303e02cf1825330b65b94abc9f6c626d02870b4c2ed8e7
```
...
```console
$ docker pull perl@sha256:2fe56f0e89042fcb2856e3e05eaa8109052d2f9101f8b22c7a857436c2284ead
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.1 MB (327110979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:588d110298ca8fd81f30e43b2a1115256b2306acd286366482e5722bb2495096`
...
-	Layers:
	...
	-	`sha256:1a831ab79423f880d6780b01302b1747802cc485f5efd0dc545367cd425ad802`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:23a64305f784bcf80ed9bb184262c9b11c3432efc40b0393f6f1885dead2e8fa`  
		Last Modified: Wed, 12 Apr 2023 22:28:18 GMT  
		Size: 15.1 MB (15073272 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:eaa4121a015cfa42a6cd057a4bc20bbd1e45986d604d1a2d34765ebb8a98e97e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.1 MB (292058400 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:93631f92d4c84c07abfecbf17bda21d3dbfae049105c11e615b46bf9d92f21e1`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:86eb05016e399483547b514b636debb38599d2ec6b8785b381139e901bb63e71`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c1bd6c89c2864995caca432cce856be9c7f843f20899cf9421c96303f45e217`  
		Last Modified: Wed, 12 Apr 2023 18:19:04 GMT  
		Size: 14.2 MB (14186396 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:663fecd1185c77cfa74aaac257f14adc7303497c77accb32b31732c4a79d1cb2
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.6 MB (317618566 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:420b60116c5b0225d59fa074c64f1c2a50bc0be7441092f0c194fe72531ead41`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Wed, 12 Apr 2023 05:22:20 GMT
WORKDIR /usr/src/perl
# Wed, 12 Apr 2023 06:07:34 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Wed, 12 Apr 2023 06:07:35 GMT
WORKDIR /
# Wed, 12 Apr 2023 06:07:35 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:66cda3b130331e2d64a03cbf78db4998bf28f659e52c0c43ba5e7ddd42dbe7dc`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:721ebe48ee643e3c4671bd48ed898f1aacd66502c2a07027d9c7f77a35fa249c`  
		Last Modified: Wed, 12 Apr 2023 07:52:35 GMT  
		Size: 15.0 MB (15016674 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; 386

```console
$ docker pull perl@sha256:9b4183f432bbbd604f8d52d69d850d26d24c40361275215340fa4a050f8a6efe
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **336.0 MB (336038415 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e9a76de433c0e9c42adec6465c6fbf4951f3a8d5078ae30693a3227ee2ef0de2`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Wed, 12 Apr 2023 10:34:32 GMT
WORKDIR /usr/src/perl
# Wed, 12 Apr 2023 12:01:10 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Wed, 12 Apr 2023 12:01:11 GMT
WORKDIR /
# Wed, 12 Apr 2023 12:01:11 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:406fecccfe28ed4eb35ac90be05e5b9307afe9c8360e5b8af7e6e68e00fcaa24`  
		...
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8d0b04a2b8b6162bc6352e7326bb2f50690cad51411b46506bb0b015c77f920d`  
		Last Modified: Wed, 12 Apr 2023 15:37:00 GMT  
		Size: 14.6 MB (14573567 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
