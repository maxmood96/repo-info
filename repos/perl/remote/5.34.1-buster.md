...
```console
$ docker pull perl@sha256:04bf563fdb89cf21b115a3026b72ea1acc962841bd1c4d1b882397ca20722365
```
...
```console
$ docker pull perl@sha256:721528655e6b500ee1075f5d822d1f8ed49b2387fce255e216c5eb59a2255163
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326945517 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4649e08f185608bc448099565fdf83f66dfd8d5fd1ac3c0270806fb0422819d5`
...
-	Layers:
	...
	-	`sha256:638a3053fb1e1362205caeba0c1f654add2314c316214c67121652aa4b4f6696`  
		...
		Size: 199.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6cfb0cc9b0e2f6e580f1ec56ce5838634c91319fdc828aa7fffecf6de2ae1782`  
		Last Modified: Fri, 03 Jun 2022 19:16:16 GMT  
		Size: 14.3 MB (14318421 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v5

```console
$ docker pull perl@sha256:b8bc7a4ed8974ba6873f3f1ce6a821348e3186dbbf9c7e8a33d597feef115c1f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **299.9 MB (299905617 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0cea4773f53910d999a8bef45b0ca249699304bab3a9eb8fac5b4df884d7f5d0`
-	Default Command: `["perl5.34.1","-de0"]`
...
ENV PERL_CPANM_OPT=--from https://www.cpan.org
# Fri, 03 Jun 2022 19:58:16 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Fri, 03 Jun 2022 19:58:17 GMT
WORKDIR /
# Fri, 03 Jun 2022 19:58:17 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:dcaf76f8af80d87613e81578706b128205da6f7bce6a9d32cf8aea08467a9e6d`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c20a63b20490fc9978ecce135a770d32924534bba2de3403070f3dd0c037ffd3`  
		Last Modified: Fri, 03 Jun 2022 23:07:57 GMT  
		Size: 13.6 MB (13647853 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:4c2d92058271dc49f238df847da2b32c83889f5fef8eb495b02d3493df9117f4
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.2 MB (317224284 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e1b7578844d3e8c17f2a6d0e2a3ce56c31087742c8a74c0e7e98f9bfc768a9fc`
-	Default Command: `["perl5.34.1","-de0"]`
...
ENV PERL_CPANM_OPT=--from https://www.cpan.org
# Fri, 03 Jun 2022 18:40:49 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Fri, 03 Jun 2022 18:40:50 GMT
WORKDIR /
# Fri, 03 Jun 2022 18:40:51 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:be1c4e5981f4059152cad8e357bf84cda1eb8ba9dcfd82451ce63d4631fd7083`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8bbd24755ac5b96e9a4c826e7b6fc59a25f9f34dbdddaf226f5fef64e8d93520`  
		Last Modified: Fri, 03 Jun 2022 20:10:13 GMT  
		Size: 14.3 MB (14267658 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; 386

```console
$ docker pull perl@sha256:2d024babec152ffa178059286c02a3a4a6a460c1f301b52e4d425c049f698456
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.6 MB (335623455 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:67223d3274ac768eb0c6782ad0011ca5daa37de9bb67486ec533fcdb80379f9d`
-	Default Command: `["perl5.34.1","-de0"]`
...
ENV PERL_CPANM_OPT=--from https://www.cpan.org
# Fri, 03 Jun 2022 18:32:17 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Fri, 03 Jun 2022 18:32:18 GMT
WORKDIR /
# Fri, 03 Jun 2022 18:32:19 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:b3e369916f1808a873b114e6123309cad8d5a6ba6be97bd5ecc41337dac397e7`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8084d0a57091a39ecffd7123596a0be02053f81181b2e52666878d500eecea8d`  
		Last Modified: Fri, 03 Jun 2022 19:53:25 GMT  
		Size: 13.8 MB (13818442 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; mips64le

```console
$ docker pull perl@sha256:d52aa18b852d4aff03677a47f23825554d0f7c8930566ff300aa30a01733f6ff
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.6 MB (310585376 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:457f86e31f326a3c1350a6902dab554a73997f4c681070ebc52a1da6172ab0bf`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Sun, 29 May 2022 11:13:19 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Sun, 29 May 2022 11:13:26 GMT
WORKDIR /
# Sun, 29 May 2022 11:13:32 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:41eeecc7d122852cc992c1b45a3855154c38d1c0b0b10c569be62f18b681f925`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cd5e1f9fad182d415d897d612def0ced382159745fa9946dbda188dedbf6e2d0`  
		Last Modified: Sun, 29 May 2022 18:48:34 GMT  
		Size: 13.6 MB (13561606 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:3a828cc3a4b7bd35e88c7aabec1cb8847c8977435769354390b58fe68be3100d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.3 MB (309324355 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa12afb12d1cc297db9f673df4e501adf8706bb3c1916df6f02b5cc8722b434d`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:642fcc395e4c7508f73ab4f5856b6ccef98d8b6894d59893ccc66ae8e5f5df7c`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:801c9b2020e5a5b91caf4b653538911851d27d6c37fbb281e728def904c3a8e3`  
		Last Modified: Fri, 03 Jun 2022 20:45:15 GMT  
		Size: 14.7 MB (14662168 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
