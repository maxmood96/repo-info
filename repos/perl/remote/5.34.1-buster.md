...
```console
$ docker pull perl@sha256:a25752cac598dfc052bfa21727da02a26da78a083696a0ba05bdf6429f0744bb
```
...
```console
$ docker pull perl@sha256:412d92c5b94d122f415096672cb22371b14d18b127fe4aa9e56c6e8a784d8d5f
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **327.2 MB (327194849 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2dfe0e3bb2c923d42e9b6eb141f30f3cd294c5ef4cb7823734e61d3743759643`
...
-	Layers:
	...
	-	`sha256:1b31b6fffbedd09c0ca7199c012a5a96dc4bb8b2ec78a7203ec363b9f2d018f1`  
		...
		Size: 170.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b3a73d5c5ec7ec212867310cf638ec991351abf124c19c2b68a62cf23193b65e`  
		Last Modified: Tue, 24 Jan 2023 22:06:23 GMT  
		Size: 15.1 MB (15073295 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:903a40deea7e7fe13d41e81b3db09374cf9d552b8f59d3787ddfa7caf7da0f14
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **292.1 MB (292116048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d1e4af988226910fe36c8867a8e342ed349a6b6f698be2cb4c0d8381d33a836e`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 24 Jan 2023 19:41:33 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*     && cpanm --version && cpm --version
# Tue, 24 Jan 2023 19:41:34 GMT
WORKDIR /
# Tue, 24 Jan 2023 19:41:34 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:8537e93313d7070c2492af29be931bf34f38f8df607a15124058f159384c7187`  
		...
		Size: 136.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:85e1c117d4fdff7e13c80fc98ae1653865fb44e0d89dcc4bdcabd470e9c31b82`  
		Last Modified: Tue, 24 Jan 2023 22:02:43 GMT  
		Size: 14.2 MB (14184791 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:c016b675ef13d2f6e30733694b0d645b0b44187d6fe57911a899f25f5309b146
```

-	Docker Version: 20.10.17
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.7 MB (317680825 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c4beeeea6f9e9803b2ffa18e189498ab60d9998ef3e7583cd5139fe5f0fe4617`
-	Default Command: `["perl5.34.1","-de0"]`
...
-	Layers:
	...
	-	`sha256:de1ec5dabe1d913e3415ffc6f437b5cf20e9db44899f251c4c576f46c1f9b1f5`  
		...
		Size: 169.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:96672de0c3fd20d37fd9ab9425ecad6c4a61e5c7bd0170d3acd80998f4ffd70b`  
		Last Modified: Sat, 04 Feb 2023 12:00:20 GMT  
		Size: 15.0 MB (15016747 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
