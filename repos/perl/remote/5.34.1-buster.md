...
```console
$ docker pull perl@sha256:ad77f01f67eba0dc0243857dc12113214a97f708d73f24207aa6d1a8e65c5a35
```
...
```console
$ docker pull perl@sha256:fe2a920a6abd468ea495204990056de1db15c33f1fb639187c7483189c83454e
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.9 MB (326946614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:81ddb2bdaf810f27d709676b17fbd6274e9775e4efd755614917d833835ec45a`
...
-	Layers:
	...
	-	`sha256:8379d0921e0fa718453f4bd0fd8b4ced7a90f0663721d9743a54f4004322b1b6`  
		...
		Size: 198.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec5539db52c1ebd73ad2bc018f84a67aa93c0322b284e674d6c820e92d0650f4`  
		Last Modified: Thu, 23 Jun 2022 07:18:02 GMT  
		Size: 14.3 MB (14318657 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v5

```console
$ docker pull perl@sha256:fe2925f3ea9bdb3a2bbf3d5bca1469197445a30f87365078c053e0bdbfbaaedb
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **299.9 MB (299906309 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29a913d675e2a56fb42a38a77e71a333c885b41108ff555ef79bd41b55f5944c`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Thu, 23 Jun 2022 03:18:43 GMT
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 05:15:02 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 05:15:03 GMT
WORKDIR /
# Thu, 23 Jun 2022 05:15:03 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e10b9d85a5d3e2cbc384e661e247603ba6567741832d43e75c6ec327a19d95d4`  
		...
		Size: 203.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:97597e5fe0c9ddd9544284b2b40e61e472d6eb9bfc71d0aaf0c55628760500b7`  
		Last Modified: Thu, 23 Jun 2022 08:22:55 GMT  
		Size: 13.6 MB (13647829 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm variant v7

```console
$ docker pull perl@sha256:5049f686db8f24dd8e3c31a0e32cc1c46b010ee811a666902b6039a15898f426
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **291.9 MB (291911246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fecb041edb8b23eaaff2e92aff02b845a045e5a55be591c4d1ebe050a96dd51f`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 07 Jun 2022 02:00:58 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Tue, 07 Jun 2022 02:00:59 GMT
WORKDIR /
# Tue, 07 Jun 2022 02:00:59 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:9704e7b200610d9dbd677d01ac63393d1e355a34caf74604e14c72039cc1bb8c`  
		...
		Size: 201.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bbcc213eb900244c36fe09fb86f90b9104d3d235b05fd2bd93acd7d88a2299dd`  
		Last Modified: Tue, 07 Jun 2022 04:57:24 GMT  
		Size: 13.5 MB (13461000 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:d06449e330cf55d7d62f408c5001668815a23cec4be172486c6f60f447b0c211
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **317.2 MB (317224621 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cdb632bda9b93046ae797927ad23783796bb7b97d8430dfb6e9dbff541174aa`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 05:19:51 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 05:19:52 GMT
WORKDIR /
# Thu, 23 Jun 2022 05:19:53 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:475e8e0317a59ea114085f16d572add3a511b1708a07c12d9adc5f0e361ba347`  
		...
		Size: 178.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4baeecfed75d1aa8b388ab43dff45ecf9a1c238ab5fd7cbf2bebc98393c70dc3`  
		Last Modified: Thu, 23 Jun 2022 06:26:13 GMT  
		Size: 14.3 MB (14268075 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.34.1-buster` - linux; 386

```console
$ docker pull perl@sha256:e2739b2b86e82da7145b86beaa88c6c9c4088a520a51f04d7d4c1dd78ed410ab
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **335.6 MB (335622556 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b20b3954ff78e93fcda6426138bfe880b4cb6659be5bb652c8a7e1cf8975e93`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Thu, 23 Jun 2022 04:10:11 GMT
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 04:58:13 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 04:58:13 GMT
WORKDIR /
# Thu, 23 Jun 2022 04:58:14 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:0373ffc2ce2caab9ffc3edf6a00e16f7c6018144ed10fc7a2ce6daa3a171fc89`  
		...
		Size: 177.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9c7dff7718109805843f3a0eeb6f938f6d2898e01441a7f27ab03463206312a6`  
		Last Modified: Thu, 23 Jun 2022 06:19:06 GMT  
		Size: 13.8 MB (13818450 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:e03d4e8f968e7994cbcf77db68113b444f0720e1441881b52b9306a95f53c84d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **348.4 MB (348383963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:becbf94001d21368f656b22338614393e69e0bb82c34976f2e4b876c34410242`
-	Default Command: `["perl5.34.1","-de0"]`
...
WORKDIR /usr/src/perl
# Tue, 07 Jun 2022 02:49:28 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Tue, 07 Jun 2022 02:49:33 GMT
WORKDIR /
# Tue, 07 Jun 2022 02:49:35 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:480da345ad783dc9862a300a5f52bba3e280592c46318281185bb17a7484add8`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e22a8631b349791d7a1e0667e402ac450fd1056f4415564795be1de67f9afc61`  
		Last Modified: Tue, 07 Jun 2022 04:56:53 GMT  
...
```console
$ docker pull perl@sha256:17db6121f54f51c365cb3be626f6b874f2e59ae3592a347d0a58c90eed2c2c5d
```

-	Docker Version: 20.10.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **309.3 MB (309328014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cc091ba0db8553cfe6421cca0ad8d8c289d231b9a1691458a226c287b65d7bbe`
-	Default Command: `["perl5.34.1","-de0"]`
...
# Thu, 23 Jun 2022 03:54:18 GMT
WORKDIR /usr/src/perl
# Thu, 23 Jun 2022 04:58:03 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.34.1.tar.xz -o perl-5.34.1.tar.xz     && echo '6d52cf833ff1af27bb5e986870a2c30cec73c044b41e3458cd991f94374039f7 *perl-5.34.1.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.34.1.tar.xz -C /usr/src/perl     && rm perl-5.34.1.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7046.tar.gz     && echo '3e8c9d9b44a7348f9acc917163dbfc15bd5ea72501492cea3a35b346440ff862 *App-cpanminus-1.7046.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7046.tar.gz && cd App-cpanminus-1.7046 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7046* /tmp/*
# Thu, 23 Jun 2022 04:58:05 GMT
WORKDIR /
# Thu, 23 Jun 2022 04:58:05 GMT
CMD ["perl5.34.1" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:dede816e0edef48fc6f7208c861976b4dcb6207b0b9ab724489fc33891a0b358`  
		...
		Size: 200.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d056f848c48f2595ca255ae89bf6b402a1f4592959f34b1aa653339dd5632a8`  
		Last Modified: Thu, 23 Jun 2022 06:20:05 GMT  
		Size: 14.7 MB (14662210 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
