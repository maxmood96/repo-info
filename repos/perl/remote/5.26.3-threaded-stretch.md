...
```console
$ docker pull perl@sha256:17a600826d77aa81679e6bde11dba555597ceb76980b42a1e5dc3ea6b168ada5
```
...
```console
$ docker pull perl@sha256:cfcc48c14a1a371db45d733ad10723db76ef1338bca33efe6a75d1963f5e26ea
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.3 MB (320330417 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9f69ea08e14bf64dc2f014befcb34c8ad76dc15531689b0ed66ffdbc61432397`
-	Default Command: `["perl5.26.3","-de0"]`
...
# Tue, 21 Apr 2020 07:31:19 GMT
WORKDIR /usr/src/perl
# Tue, 21 Apr 2020 07:58:30 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 21 Apr 2020 07:58:33 GMT
WORKDIR /
# Tue, 21 Apr 2020 07:58:33 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:56321864eacf5f826640db47bc9c1bc7b0d7c6a84254eac79ba962d03b363d6f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:dfe2af9f02cd32f89c8c7f139580d1a342bd7ac2c1724264c51a46950ecad9b0`  
		Last Modified: Tue, 21 Apr 2020 08:03:43 GMT  
		Size: 13.0 MB (13016197 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.26.3-threaded-stretch` - linux; 386

```console
$ docker pull perl@sha256:1d2a4f8f739e5c180e9a120fcf35d477c79b78307cf5d7649446328310f29dd2
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **345.8 MB (345772773 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7795b439873e23732efa9946c41f38fbc4bd72a1c506b645a205ad71aa0980e8`
-	Default Command: `["perl5.26.3","-de0"]`
...
# Tue, 21 Apr 2020 04:51:22 GMT
WORKDIR /usr/src/perl
# Tue, 21 Apr 2020 05:39:03 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.26.3.tar.bz2 -o perl-5.26.3.tar.bz2     && echo '9ff35a613213f29ab53975141af6825ae7d4408895538cac0922e47ab92a1477 *perl-5.26.3.tar.bz2' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.26.3.tar.bz2 -C /usr/src/perl     && rm perl-5.26.3.tar.bz2     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Tue, 21 Apr 2020 05:39:04 GMT
WORKDIR /
# Tue, 21 Apr 2020 05:39:04 GMT
CMD ["perl5.26.3" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:d83a56960fb088d61e969b94d5a3a22e90b382631cbe7e28f946bb50f0dc80c5`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6e57e118fa7756fde4e539087996be208963a44153540f5b0855e2d7116b61bf`  
		Last Modified: Tue, 21 Apr 2020 05:42:31 GMT  
		Size: 12.7 MB (12725856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
