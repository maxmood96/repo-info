...
### `perl:5.39.9-slim-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.39.9-slim-threaded-bookworm` - linux; arm variant v7
...
### `perl:5.39.9-slim-threaded-bookworm` - linux; mips64le
...
### `perl:5.39.9-slim-threaded-bookworm` - linux; s390x
