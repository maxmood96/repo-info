...
```console
$ docker pull perl@sha256:88368286eb6847994ee274b51044e5833ea2be0258981e14c1b277497336c3fb
```
...
```console
$ docker pull perl@sha256:850a5f64c0075d469b614ebc427355d084f25b226d1c3e368afd6cea24ed38fa
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.3 MB (310288892 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ce9ee138b984e6ef1642149e9963d265b94d2bab56c46a5d6fabf1c7b27fb70c`
-	Default Command: `["perl5.38.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:310b46a6ee8de839829ba9f352d7f0cda660e18c734f89940c4fea6e38cb774c`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec7b148328c83b5c1b4e9a851b37cdec69db7a36330779ac3b6a8605bf46c4d0`  
		Last Modified: Wed, 01 Nov 2023 06:32:29 GMT  
		Size: 14.9 MB (14917409 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d560eb91829ebf4a1343350f7ec7d15b6cd990391b0f353db552982e206b8a7b`  
		Last Modified: Wed, 01 Nov 2023 06:32:24 GMT  
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:ff35b75df35eb3a5b5b3967c8f673690c4a479e77ce4dd27f2fc8d570d95d5d6
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.9 MB (311874654 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6387454118b6af1a95db35bf838b51c4a3c27ba193ef3e306d829b34fbbaeedb`
-	Default Command: `["perl5.38.0","-de0"]`
...
# Wed, 01 Nov 2023 03:35:00 GMT
WORKDIR /usr/src/perl
# Wed, 01 Nov 2023 03:40:33 GMT
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.38.0.tar.xz -o perl-5.38.0.tar.xz     && echo 'eca551caec3bc549a4e590c0015003790bdd1a604ffe19cc78ee631d51f7072e *perl-5.38.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.38.0.tar.xz -C /usr/src/perl     && rm perl-5.38.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version
# Wed, 01 Nov 2023 03:40:34 GMT
WORKDIR /usr/src/app
# Wed, 01 Nov 2023 03:40:35 GMT
CMD ["perl5.38.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:765ceb623175f30499cbdf521f54f713632c053ef293d0da5fd563f2d77951b9`  
		...
		Size: 168.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0d93c3ecb159fae7c83c464ed0b1d848ef2d5c5d2c8f6e3efb2d65394d369e53`  
		Last Modified: Wed, 01 Nov 2023 06:51:37 GMT  
		Size: 16.0 MB (15981224 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:28ae37ff7eaf2770170478aed6ad4cb849711d03f13ee3c6289bf14cf5a4fda0`  
		Last Modified: Wed, 01 Nov 2023 06:51:33 GMT  
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
