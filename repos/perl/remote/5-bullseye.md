...
```console
$ docker pull perl@sha256:d397037513b896e15af38dc82197e67ee0b0bd39d974c1a876930485719ed9b4
```
...
```console
$ docker pull perl@sha256:2e3090f3ba412204ed07ca0329d341942a0a4b53c6dc84aabbffc6374f6630b5
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **337.9 MB (337890325 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4ed29941b512a9f0f47e55b76081cbbd456fd41faba21d9d9baf3afa3a2910c5`
...
-	Layers:
	...
	-	`sha256:afba211aab229cfde320e4caa48a720d8330db6297bd37d6405137f68eaa60e2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d364bdb4453dffe146bebba6c5576fa4b660981c05f90c1b9d7c602f988b9c5a`  
		Last Modified: Fri, 04 Aug 2023 00:43:38 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:d186064a20b14e01c67974042ff68c3670ec68b3f056f426732d21d53382498e
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **297.5 MB (297498723 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ea65298c012d98c573cd889a4d2e724643bb7deac8365f4907b9f8dbfb59a9fc`
-	Default Command: `["perl5.38.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:3f93d36f410408549b09c33415c8c1c54a904b297bce3ac4615605bd914bcdaf`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3d3cdbf53ebb8c333a8d98c8990426fafae3905fcbd670dff7a4fb0ad639f64f`  
		Last Modified: Fri, 04 Aug 2023 00:28:45 GMT  
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:8857e04e573abfd69d1d35deadfc622fd42409f49a57e1ca6926b220dfa8da66
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.5 MB (329477675 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5b103615c7a64e64d981f2b0d4841a62233db2c2f6d2378f8a61be9a84bac263`
-	Default Command: `["perl5.38.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:e9e52ac7581ffdc5b982a8025feb4896a1ac72e65be77d1ae47de6c820ed82ea`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:81ab6fb3bf5cf4138f0d0518059f66dd1d0ea9e587a15f98c3d066a086dde544`  
		Last Modified: Fri, 04 Aug 2023 00:14:54 GMT  
		Size: 165.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:0d829618c66e318cbb037ce17ee29df226ccc4b1396d554378ec8b84e3811cf3
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **343.1 MB (343125513 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:453bcd92e1f8785b2f870d056c377e2afd8e9f5f739b2db53e1f6d75c0e360ea`
-	Default Command: `["perl5.38.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:506ddc759313015b78cac38731fe1e7163e4671ed3efb1f0b8d6552922b3df78`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8667d54f95b35dc6a5f7385372782896d75b2ffd84181c1e4b254bbaf31287a1`  
		Last Modified: Thu, 03 Aug 2023 23:41:44 GMT  
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:6e652c49659b9a6ca16b8441d95534775f44883de9c92346096f09452b1c6bdb
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.9 MB (315912050 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29107fe429605d17943998db14885b330bb207a06f99990458e86f789d517780`
-	Default Command: `["perl5.38.0","-de0"]`
...
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.38.0.tar.xz -o perl-5.38.0.tar.xz     && echo 'eca551caec3bc549a4e590c0015003790bdd1a604ffe19cc78ee631d51f7072e *perl-5.38.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.38.0.tar.xz -C /usr/src/perl     && rm perl-5.38.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version
# Fri, 04 Aug 2023 00:07:55 GMT
WORKDIR /usr/src/app
# Fri, 04 Aug 2023 00:08:01 GMT
CMD ["perl5.38.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:6e64bbe5da63c6bf13eae62d65ccb8f9fb05cbf7f4dbe17225415e344a986e01`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19cfab0713e6555f02e001b4535529f678f1ed82445b1c34933dbef38a0435bf`  
		Last Modified: Fri, 04 Aug 2023 00:12:23 GMT  
		Size: 132.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:98956cce14500bf9decb7ade380475fc17d0e83439ddee2d142b5930c2a0080a
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.4 MB (346372938 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7cabf7d9689039626323cf7ae8b149ab8d1112ef10f0758b593e6b0df29ed9e3`
-	Default Command: `["perl5.38.0","-de0"]`
...
RUN true     && curl -fL https://www.cpan.org/src/5.0/perl-5.38.0.tar.xz -o perl-5.38.0.tar.xz     && echo 'eca551caec3bc549a4e590c0015003790bdd1a604ffe19cc78ee631d51f7072e *perl-5.38.0.tar.xz' | sha256sum --strict --check -     && tar --strip-components=1 -xaf perl-5.38.0.tar.xz -C /usr/src/perl     && rm perl-5.38.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -fLO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7047.tar.gz     && echo '963e63c6e1a8725ff2f624e9086396ae150db51dd0a337c3781d09a994af05a5 *App-cpanminus-1.7047.tar.gz' | sha256sum --strict --check -     && tar -xzf App-cpanminus-1.7047.tar.gz && cd App-cpanminus-1.7047 && perl bin/cpanm . && cd /root     && cpanm IO::Socket::SSL     && curl -fL https://raw.githubusercontent.com/skaji/cpm/0.997011/cpm -o /usr/local/bin/cpm     && echo '7dee2176a450a8be3a6b9b91dac603a0c3a7e807042626d3fe6c93d843f75610 */usr/local/bin/cpm' | sha256sum --strict --check -     && chmod +x /usr/local/bin/cpm     && true     && rm -fr /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7047* /tmp/*     && cpanm --version && cpm --version
# Fri, 04 Aug 2023 00:17:03 GMT
WORKDIR /usr/src/app
# Fri, 04 Aug 2023 00:17:11 GMT
CMD ["perl5.38.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:5e2213026c9feca3bebc07c4c7e30e326a9cf338d4bed3c3efcea49973a04471`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6db6d6eaffe79f86176a40f8720d835730a7266f123feab9cdb47a2adba6205a`  
		Last Modified: Fri, 04 Aug 2023 00:19:31 GMT  
		Size: 167.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull perl@sha256:66892f0e880c2824461eb72c4f7871a5b0b43dcd2e08f2daaeb3431fd3439397
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **311.8 MB (311821965 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:561ba2780c6d9dde5cce97a98f98e0b90e5342716d97dead0bcc512b82ad9311`
-	Default Command: `["perl5.38.0","-de0"]`
...
-	Layers:
	...
	-	`sha256:66a0ff5e4da919f3ab448b57238526e0a47a00d20a7a6140052ff03c5d95da4f`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2d8935962487eb2e773effba8bf50017e7da0c2b386e592b1a3b43a2a452c208`  
		Last Modified: Thu, 03 Aug 2023 23:57:49 GMT  
		Size: 166.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
