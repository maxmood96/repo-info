...
### `perl:5.43.5-threaded-bullseye` - linux; amd64
...
### `perl:5.43.5-threaded-bullseye` - unknown; unknown
...
### `perl:5.43.5-threaded-bullseye` - linux; arm variant v7
...
### `perl:5.43.5-threaded-bullseye` - linux; arm64 variant v8
...
### `perl:5.43.5-threaded-bullseye` - linux; 386
