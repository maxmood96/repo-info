...
```console
$ docker pull perl@sha256:75ecdc53570415138d3d575e63fe35cd7bb92f8030b7554186775c73bbf5ecbc
```
...
### `perl:5.39.7-slim-threaded` - linux; arm variant v5
...
### `perl:5.39.7-slim-threaded` - linux; arm variant v7
...
### `perl:5.39.7-slim-threaded` - linux; arm64 variant v8
...
### `perl:5.39.7-slim-threaded` - linux; mips64le
...
### `perl:5.39.7-slim-threaded` - linux; ppc64le
...
### `perl:5.39.7-slim-threaded` - linux; s390x
