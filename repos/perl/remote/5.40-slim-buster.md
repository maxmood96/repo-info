...
### `perl:5.40-slim-buster` - linux; amd64
...
### `perl:5.40-slim-buster` - unknown; unknown
...
### `perl:5.40-slim-buster` - linux; arm variant v7
...
### `perl:5.40-slim-buster` - linux; arm64 variant v8
...
### `perl:5.40-slim-buster` - linux; 386
