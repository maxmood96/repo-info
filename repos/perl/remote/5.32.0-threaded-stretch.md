...
```console
$ docker pull perl@sha256:6dcc15acf0e5c7e303c98321e676eb911713c921f25a7cc29bb6c8aa489712fb
```
...
```console
$ docker pull perl@sha256:886f86ab58d82c6cba5bfd98981649f98940dc203ba16d7356ec657ace85d2c4
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **339.6 MB (339590732 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:876a8cef0767612b1915309d93f62b67fc4e5fdbde181af0eab2d3706fff3079`
...
-	Layers:
	...
	-	`sha256:8806c2444e756afea5f81d9899e635cadbadb7581ccfda56a1079ea454973168`  
		...
		Size: 180.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:84e818f50d73fd552880d0c34ca8146d101342d42e3066c7c7da0d5731624f0b`  
		Last Modified: Tue, 01 Sep 2020 18:06:52 GMT  
		Size: 14.1 MB (14127745 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-threaded-stretch` - linux; arm variant v7

```console
$ docker pull perl@sha256:ce6eb088aefb60a61c46aa2d04e90aa3f0959ff6cf88b16e7bd5eab349ecff95
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **310.0 MB (310037820 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:904e18a7e1e485964a2452b9ee3c60c41b9e0c1eaf93495a3d99743cb808b7a7`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 10 Sep 2020 04:47:49 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 10 Sep 2020 04:47:52 GMT
WORKDIR /
# Thu, 10 Sep 2020 04:47:53 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:73b4c8e66f3700d17589258369d3411f63ca0d01ef510714dfe0ef0b086f21f8`  
		...
		Size: 206.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e7b7ad089ddf2336560e1a43dde95b1445e5e2a96623d0fbc6ad96da035ad12c`  
		Last Modified: Thu, 10 Sep 2020 07:48:34 GMT  
		Size: 13.3 MB (13251074 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-threaded-stretch` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:aa800b94f7804133d44367f40179439ca5a9b029ff6009b68b59b54445221c90
```

-	Docker Version: 18.09.7
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **320.6 MB (320567778 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:57a9889ef59b8deb43fc24007546c951cec2f1571d504660f142f6b19ec8b5a7`
-	Default Command: `["perl5.32.0","-de0"]`
...
# Thu, 10 Sep 2020 05:37:00 GMT
WORKDIR /usr/src/perl
# Thu, 10 Sep 2020 06:29:27 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 10 Sep 2020 06:29:29 GMT
WORKDIR /
# Thu, 10 Sep 2020 06:29:30 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:e9f9148416a9cc7672426d05c7de642b3fe21ae532db6c499d1b56bd96d769af`  
		...
		Size: 202.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:78da35ff453af20da8ef7625a4680bcc71968b2b45ce477986ea58ee364e186e`  
		Last Modified: Thu, 10 Sep 2020 10:08:18 GMT  
		Size: 13.9 MB (13932031 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.32.0-threaded-stretch` - linux; 386

```console
$ docker pull perl@sha256:6184b08d5e91abb1881af5c67fcae3763c265a7dd2b4e5d638e92961de61ed36
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **346.0 MB (346019779 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c2551770f03ddf0e29ef0bf91c7e66cb0c85835804eab52a98aa3f87e5b57f3b`
-	Default Command: `["perl5.32.0","-de0"]`
...
WORKDIR /usr/src/perl
# Thu, 10 Sep 2020 04:20:43 GMT
RUN true     && curl -SL https://www.cpan.org/src/5.0/perl-5.32.0.tar.xz -o perl-5.32.0.tar.xz     && echo '6f436b447cf56d22464f980fac1916e707a040e96d52172984c5d184c09b859b *perl-5.32.0.tar.xz' | sha256sum -c -     && tar --strip-components=1 -xaf perl-5.32.0.tar.xz -C /usr/src/perl     && rm perl-5.32.0.tar.xz     && cat *.patch | patch -p1     && gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"     && archBits="$(dpkg-architecture --query DEB_BUILD_ARCH_BITS)"     && archFlag="$([ "$archBits" = '64' ] && echo '-Duse64bitall' || echo '-Duse64bitint')"     && ./Configure -Darchname="$gnuArch" "$archFlag" -Dusethreads -Duseshrplib -Dvendorprefix=/usr/local  -des     && make -j$(nproc)     && TEST_JOBS=$(nproc) make test_harness     && make install     && cd /usr/src     && curl -LO https://www.cpan.org/authors/id/M/MI/MIYAGAWA/App-cpanminus-1.7044.tar.gz     && echo '9b60767fe40752ef7a9d3f13f19060a63389a5c23acc3e9827e19b75500f81f3 *App-cpanminus-1.7044.tar.gz' | sha256sum -c -     && tar -xzf App-cpanminus-1.7044.tar.gz && cd App-cpanminus-1.7044 && perl bin/cpanm . && cd /root     && true     && rm -fr ./cpanm /root/.cpanm /usr/src/perl /usr/src/App-cpanminus-1.7044* /tmp/*
# Thu, 10 Sep 2020 04:20:44 GMT
WORKDIR /
# Thu, 10 Sep 2020 04:20:44 GMT
CMD ["perl5.32.0" "-de0"]
```
...
-	Layers:
	...
	-	`sha256:f30fc9209a2219accb58b1dae41eed33c4860b88e4bdf337f7c3403b99d36a1d`  
		...
		Size: 179.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be0db98687ba9600019c092845b083c061ebbf7536f63270f9be7b5210ac063b`  
		Last Modified: Thu, 10 Sep 2020 07:55:27 GMT  
		Size: 13.7 MB (13666641 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
