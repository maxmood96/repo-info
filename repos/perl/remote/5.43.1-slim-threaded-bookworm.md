...
```console
$ docker pull perl@sha256:87fd807b3392ec017f82256fd62de110f42bb769444bab746b1c9f5b133d4105
```
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; amd64
...
### `perl:5.43.1-slim-threaded-bookworm` - unknown; unknown
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; arm variant v7
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; arm64 variant v8
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; 386
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; ppc64le
...
### `perl:5.43.1-slim-threaded-bookworm` - linux; s390x
