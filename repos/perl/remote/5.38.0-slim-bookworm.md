...
### `perl:5.38.0-slim-bookworm` - linux; arm variant v5
...
### `perl:5.38.0-slim-bookworm` - linux; mips64le
...
### `perl:5.38.0-slim-bookworm` - linux; ppc64le
...
### `perl:5.38.0-slim-bookworm` - linux; s390x
