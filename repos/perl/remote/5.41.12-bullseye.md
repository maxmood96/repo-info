...
```console
$ docker pull perl@sha256:c1a970d3b248b6aba5432452fc3dceb1b99353c897214271236a0dc466b2dfa2
```
...
### `perl:5.41.12-bullseye` - linux; amd64
...
### `perl:5.41.12-bullseye` - unknown; unknown
...
### `perl:5.41.12-bullseye` - linux; arm variant v7
...
### `perl:5.41.12-bullseye` - linux; arm64 variant v8
...
### `perl:5.41.12-bullseye` - linux; 386
