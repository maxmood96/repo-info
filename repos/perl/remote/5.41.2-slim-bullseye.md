...
```console
$ docker pull perl@sha256:cff3871aff468f59881a5ba0d7da24ef7313c6180834bd76a51bd2c7a6040cc6
```
...
### `perl:5.41.2-slim-bullseye` - linux; arm variant v7
...
### `perl:5.41.2-slim-bullseye` - linux; arm64 variant v8
...
### `perl:5.41.2-slim-bullseye` - linux; mips64le
...
### `perl:5.41.2-slim-bullseye` - linux; ppc64le
...
### `perl:5.41.2-slim-bullseye` - linux; s390x
