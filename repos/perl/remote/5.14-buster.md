...
```console
$ docker pull perl@sha256:1e6c10289676353de39612cff583b45704d367055b1373c37488521ab7c816d2
```
...
### `perl:5.14-buster` - linux; arm variant v7
...
### `perl:5.14-buster` - linux; arm64 variant v8

```console
$ docker pull perl@sha256:3dec5dc014fe7dc363a34d6869d554aedd9b515b293b4fc53898d5cd73ac80fa
```

-	Docker Version: 19.03.12
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **315.1 MB (315140809 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fcf417f25b8489f57feb6b30f003a0246d3783ed28cecc5622d9999f48ec4216`
-	Default Command: `["perl5.14.4","-de0"]`
...
-	Layers:
	...
	-	`sha256:922bb445772f1d2d0633a824992e6383902cab1838791236f5be3ad72c4d7ad9`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5919c3bd573f1513fffb423903cf5caac26da251f1717ce0cb614e9ff305ef7f`  
		Last Modified: Fri, 28 May 2021 09:56:50 GMT  
		Size: 12.2 MB (12161376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `perl:5.14-buster` - linux; 386
