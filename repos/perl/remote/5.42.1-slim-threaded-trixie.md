...
```console
$ docker pull perl@sha256:6b4877f53f84540e0dbf55ce59ec6bcf970a5bf47f3497a1c796d444be8991f0
```
...
### `perl:5.42.1-slim-threaded-trixie` - linux; amd64
...
### `perl:5.42.1-slim-threaded-trixie` - unknown; unknown
...
### `perl:5.42.1-slim-threaded-trixie` - linux; arm variant v5
...
### `perl:5.42.1-slim-threaded-trixie` - linux; arm variant v7
...
### `perl:5.42.1-slim-threaded-trixie` - linux; arm64 variant v8
...
### `perl:5.42.1-slim-threaded-trixie` - linux; ppc64le
...
### `perl:5.42.1-slim-threaded-trixie` - linux; s390x
