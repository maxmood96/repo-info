...
```console
$ docker pull perl@sha256:fb435f0e5da3c5978d380fccac3e4ce6f22a47283e42cd755c3740aeac497f13
```
...
### `perl:5.39.8-bookworm` - linux; amd64
...
### `perl:5.39.8-bookworm` - unknown; unknown
...
### `perl:5.39.8-bookworm` - linux; arm variant v5
...
### `perl:5.39.8-bookworm` - linux; arm variant v7
...
### `perl:5.39.8-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.8-bookworm` - linux; 386
...
### `perl:5.39.8-bookworm` - linux; mips64le
...
### `perl:5.39.8-bookworm` - linux; ppc64le
...
### `perl:5.39.8-bookworm` - linux; s390x
