...
```console
$ docker pull perl@sha256:02995c7f3bd886b53c5780e3f19dcc4d225da085d57cb9d16041a2fd187b62df
```
...
### `perl:5.41.2-threaded-bullseye` - linux; arm variant v7
...
### `perl:5.41.2-threaded-bullseye` - linux; arm64 variant v8
...
### `perl:5.41.2-threaded-bullseye` - linux; s390x
