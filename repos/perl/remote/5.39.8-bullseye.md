...
```console
$ docker pull perl@sha256:f47a33c2715be2250aa4b83b589f66aa0f0889060b606a083ac56ddd71bbe968
```
...
### `perl:5.39.8-bullseye` - linux; amd64
...
### `perl:5.39.8-bullseye` - unknown; unknown
...
### `perl:5.39.8-bullseye` - linux; arm variant v5
...
### `perl:5.39.8-bullseye` - linux; arm variant v7
...
### `perl:5.39.8-bullseye` - linux; arm64 variant v8
...
### `perl:5.39.8-bullseye` - linux; 386
...
### `perl:5.39.8-bullseye` - linux; mips64le
...
### `perl:5.39.8-bullseye` - linux; s390x
