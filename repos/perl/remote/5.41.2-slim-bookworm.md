...
```console
$ docker pull perl@sha256:16e0977f26392e7fa5f101373ffa3d33e476bea3500b5366c852781abf582146
```
...
### `perl:5.41.2-slim-bookworm` - linux; arm variant v7
...
### `perl:5.41.2-slim-bookworm` - linux; arm64 variant v8
...
### `perl:5.41.2-slim-bookworm` - linux; mips64le
...
### `perl:5.41.2-slim-bookworm` - linux; ppc64le
...
### `perl:5.41.2-slim-bookworm` - linux; s390x
