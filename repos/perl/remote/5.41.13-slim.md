...
### `perl:5.41.13-slim` - unknown; unknown
...
### `perl:5.41.13-slim` - linux; arm variant v5
...
### `perl:5.41.13-slim` - linux; arm variant v7
...
### `perl:5.41.13-slim` - linux; arm64 variant v8
...
### `perl:5.41.13-slim` - linux; mips64le
...
### `perl:5.41.13-slim` - linux; ppc64le
