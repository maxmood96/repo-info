...
### `perl:5.39.7-threaded-bookworm` - linux; arm variant v5
...
### `perl:5.39.7-threaded-bookworm` - linux; arm variant v7
...
### `perl:5.39.7-threaded-bookworm` - linux; arm64 variant v8
...
### `perl:5.39.7-threaded-bookworm` - linux; mips64le
...
### `perl:5.39.7-threaded-bookworm` - linux; ppc64le
...
### `perl:5.39.7-threaded-bookworm` - linux; s390x
