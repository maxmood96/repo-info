...
- Created: `2023-05-23T00:20:05.070324566Z`
...
### `rpm` package: `curl-8.0.1-2.ph4.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `curl-libs-8.0.1-2.ph4.x86_64`
...
### `rpm` package: `tdnf-3.3.9-1.ph4.x86_64`

Licenses (from `rpm --query`): LGPLv2.1,GPLv2

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `tdnf-cli-libs-3.3.9-1.ph4.x86_64`
