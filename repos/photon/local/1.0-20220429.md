...
- Created: `2022-04-29T22:26:29.37259653Z`
...
### `rpm` package: `curl-7.78.0-2.ph1.x86_64`
...
### `rpm` package: `expat-2.2.9-8.ph1.x86_64`
...
### `rpm` package: `glib-2.58.3-4.ph1.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `glibc-2.22-39.ph1.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gmp-6.1.2-1.ph1.x86_64`
...
### `rpm` package: `libgcc-5.3.0-7.ph1.x86_64`
...
### `rpm` package: `libsolv-0.6.19-8.ph1.x86_64`
...
### `rpm` package: `libstdc++-5.3.0-7.ph1.x86_64`
...
### `rpm` package: `ncurses-6.0-11.ph1.x86_64`
...
### `rpm` package: `nss-3.44-5.ph1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `openssl-1.0.2zc-1.ph1.x86_64`
...
### `rpm` package: `pkg-config-0.28-5.ph1.x86_64`
...
### `rpm` package: `rpm-4.14.2-2.ph1.x86_64`
...
### `rpm` package: `tdnf-1.1.0-5.ph1.x86_64`

Licenses (from `rpm --query`): VMware

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `util-linux-2.27.1-7.ph1.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `vim-7.4-14.ph1.x86_64`
