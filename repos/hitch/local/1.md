...
- Created: `2026-05-08T19:22:04.477410628Z`
...
### `dpkg` source package: `ssl-cert=1.1.2`
...
```console
$ apt-get source -qq --print-uris ssl-cert=1.1.2
'http://deb.debian.org/debian/pool/main/s/ssl-cert/ssl-cert_1.1.2.dsc' ssl-cert_1.1.2.dsc 1645 SHA256:dd7a029a232736ffcc506f85fef510f575583fb3857bdc3b53805226f90ef49f
'http://deb.debian.org/debian/pool/main/s/ssl-cert/ssl-cert_1.1.2.tar.xz' ssl-cert_1.1.2.tar.xz 31464 SHA256:7868144c2c37083c618c991cb4cbcf5f18de586dc046db785f07f82222a8e99f
```

Other potentially useful URLs:

- https://sources.debian.net/src/ssl-cert/1.1.2/ (for browsing the source)
- https://sources.debian.net/src/ssl-cert/1.1.2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ssl-cert/1.1.2/ (for access to the source package after it no longer exists in the archive)
