...
- Created: `2023-10-21T02:36:23.989018603Z`
- Virtual Size: ~ 99.41 Mb  
...
```console
libcap-2.66-r1 description:
POSIX 1003.1e capabilities

libcap-2.66-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-2.66-r1 installed size:
12 KiB

libcap-2.66-r1 license:
...
```console
libcap-utils-2.66-r1 description:
POSIX 1003.1e capabilities (utils)

libcap-utils-2.66-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap-utils-2.66-r1 installed size:
116 KiB

libcap-utils-2.66-r1 license:
BSD-3-Clause OR GPL-2.0-only
...
```console
libcap2-2.66-r1 description:
POSIX 1003.1e capabilities (libraries)

libcap2-2.66-r1 webpage:
https://sites.google.com/site/fullycapable/

libcap2-2.66-r1 installed size:
76 KiB

libcap2-2.66-r1 license:
BSD-3-Clause OR GPL-2.0-only
