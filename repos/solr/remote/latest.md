...
```console
$ docker pull solr@sha256:b5e8bf1a17723e895f7d3eed40c3c714febb1d9f3d7281b4564c467f4d1f8676
```
...
```console
$ docker pull solr@sha256:8efab9f4e2b7fb0442636b0abd04d003038b0ccadb71cd6fe1776ef94613aa37
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **377.8 MB (377779120 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cb8e3e3d4598de3fe3b2ac94abb65e561acb22e2f5387fccdbfb3d00b199158a`
...
-	Layers:
	...
	-	`sha256:4080cbbe938d7cadb00eda7a89a93f5878d7e968b4e8b23640b11c37ad69ca7b`  
		...
		Size: 733.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:744038c46818340586a38279e18e802bfb539e8708afdc3d5cdf395c1606edf5`  
		Last Modified: Mon, 29 Jan 2024 22:52:28 GMT  
		Size: 281.1 MB (281103716 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:d04811412f9673e590eaa443d50bb124e6377b33c4c6b28e40c036c7feafac76`  
		...
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:7b998ff871bf0b038008e94a65474bd4fa348eef43e7a2c037373d6babe186f6`  
		Last Modified: Mon, 29 Jan 2024 22:52:25 GMT  
		Size: 210.0 B  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:8e396eef19a65c8ef3fc3c05eede1c7a8192052a11ba8f86535564456e88b1a5`  
		Last Modified: Mon, 29 Jan 2024 22:52:25 GMT  
		Size: 10.8 KB (10756 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
	-	`sha256:1089e7cd53299d40fccb0760766c4f9985c0798d93cb56f95ba0ebd3816d7e4d`  
		Last Modified: Mon, 29 Jan 2024 22:52:26 GMT  
		Size: 1.6 MB (1590741 bytes)  
		MIME: application/vnd.oci.image.layer.v1.tar+gzip
...
```console
$ docker pull solr@sha256:245ab6dc526240ccaf86c46599cc5c9f093a854fa7d554d1b6472552269b99ba
```

-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **3.7 MB (3738703 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3ef4fc9b42f25b57c12ed8d14a8c68cfd03400680903066ad44c6024a4527c17`

```dockerfile
```

-	Layers:
	-	`sha256:48ca63f860100712e73a427535364b7a793902e052b2a119d6ecd6d66ab158f5`  
		Last Modified: Mon, 29 Jan 2024 22:52:25 GMT  
		Size: 3.7 MB (3703899 bytes)  
		MIME: application/vnd.in-toto+json
	-	`sha256:caa867dcb7a9885d7c3cbe3b29d7d3e177978ec173392bc834638cf8467894c5`  
		Last Modified: Mon, 29 Jan 2024 22:52:25 GMT  
...
```console
$ docker pull solr@sha256:8cca0bc7f5f50b4e8a5fed11c31567248e92f7428ba8bc21f6b1571bd8173878
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **376.9 MB (376945385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5c2b41f8ead3b11da5a6ba4f1d34e2423794d97f40875001f77e8b4bb672c6f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
# Thu, 25 Jan 2024 20:40:18 GMT
ARG SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr
# Thu, 25 Jan 2024 20:41:05 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   apt-get update;   apt-get -y --no-install-recommends install wget gpg gnupg dirmngr;   rm -rf /var/lib/apt/lists/*;   export SOLR_BINARY="solr-$SOLR_VERSION$SOLR_DIST.tgz";   MAX_REDIRECTS=3;   case "${SOLR_DOWNLOAD_SERVER}" in     (*"apache.org"*);;     (*)       MAX_REDIRECTS=4 &&       SKIP_GPG_CHECK=true;;   esac;   export DOWNLOAD_URL="$SOLR_DOWNLOAD_SERVER/$SOLR_VERSION/$SOLR_BINARY";   echo "downloading $DOWNLOAD_URL";   if ! wget -t 10 --max-redirect $MAX_REDIRECTS --retry-connrefused -nv "$DOWNLOAD_URL" -O "/opt/$SOLR_BINARY"; then rm -f "/opt/$SOLR_BINARY"; fi;   if [ ! -f "/opt/$SOLR_BINARY" ]; then echo "failed download attempt for $SOLR_BINARY"; exit 1; fi;   echo "$SOLR_SHA512 */opt/$SOLR_BINARY" | sha512sum -c -;   if [ -z "$SKIP_GPG_CHECK" ]; then     export GNUPGHOME="/tmp/gnupg_home";     mkdir -p "$GNUPGHOME";     chmod 700 "$GNUPGHOME";     echo "disable-ipv6" >> "$GNUPGHOME/dirmngr.conf";     if [ -n "$SOLR_KEYS" ]; then       wget -nv "https://downloads.apache.org/solr/KEYS" -O- |         gpg --batch --import --key-origin 'url,https://downloads.apache.org/solr/KEYS';       release_keys="$(gpg --batch --export -a ${SOLR_KEYS})";       rm -rf "$GNUPGHOME"/*;       echo "${release_keys}" | gpg --batch --import;     fi;     echo "downloading $DOWNLOAD_URL.asc";     wget -nv "$DOWNLOAD_URL.asc" -O "/opt/$SOLR_BINARY.asc";     (>&2 ls -l "/opt/$SOLR_BINARY" "/opt/$SOLR_BINARY.asc");     gpg --batch --verify "/opt/$SOLR_BINARY.asc" "/opt/$SOLR_BINARY";     { command -v gpgconf; gpgconf --kill all || :; };     rm -r "$GNUPGHOME";   else     echo "Skipping GPG validation due to non-Apache build";   fi;   tar -C /opt --extract --preserve-permissions --file "/opt/$SOLR_BINARY";   rm "/opt/$SOLR_BINARY"*;   apt-get -y remove gpg dirmngr && apt-get -y autoremove;
# Thu, 25 Jan 2024 20:41:07 GMT
LABEL org.opencontainers.image.title=Apache Solr
# Thu, 25 Jan 2024 20:41:07 GMT
LABEL org.opencontainers.image.description=Apache Solr is the popular, blazing-fast, open source search platform built on Apache Lucene.
# Thu, 25 Jan 2024 20:41:07 GMT
...
-	Layers:
	...
	-	`sha256:2c24226ebd43098c00c6e2715c22788dde6531777752b1ae35e81c95623edeae`  
		...
		Size: 733.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:35592b852fe2a178338a83194dd40ebdd849123648b9a8a82a5a1dfb2686355c`  
		Last Modified: Thu, 25 Jan 2024 20:54:54 GMT  
		Size: 281.3 MB (281342280 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:90ae9e7ca50b25a05550de44ceac10790e542770b3f0e36efba8de9af9d7943f`  
		Last Modified: Thu, 25 Jan 2024 20:54:44 GMT  
		Size: 4.3 KB (4332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0c1fa56690289a47fc4cfab3e9ec88b51f61f7d8b64f806c258daed67fe6a5ff`  
		Last Modified: Thu, 25 Jan 2024 20:54:44 GMT  
		Size: 219.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8a3351914fd5d61ba9b0d597cc222b4d32f21735b5ac256edf77eaba6a63f90c`  
		Last Modified: Thu, 25 Jan 2024 20:54:44 GMT  
		Size: 10.8 KB (10847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:154aae43a481826eb5b70eba29e36c242f6f9748bb1ecef5bf6c45f9465f7e99`  
		Last Modified: Thu, 25 Jan 2024 20:54:45 GMT  
		Size: 1.7 MB (1687758 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `solr:latest` - linux; ppc64le

```console
$ docker pull solr@sha256:28974d8632cb040d3ff8932b9756d9fcc1acdc996e6c03763241825b049c4c85
```

-	Docker Version: 20.10.26
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **384.6 MB (384590274 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a8d7fa688ce6b8548de088e7ee6c0c7477043b554dd600749b4e528528e6804a`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
ARG SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr
# Thu, 25 Jan 2024 20:24:38 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   apt-get update;   apt-get -y --no-install-recommends install wget gpg gnupg dirmngr;   rm -rf /var/lib/apt/lists/*;   export SOLR_BINARY="solr-$SOLR_VERSION$SOLR_DIST.tgz";   MAX_REDIRECTS=3;   case "${SOLR_DOWNLOAD_SERVER}" in     (*"apache.org"*);;     (*)       MAX_REDIRECTS=4 &&       SKIP_GPG_CHECK=true;;   esac;   export DOWNLOAD_URL="$SOLR_DOWNLOAD_SERVER/$SOLR_VERSION/$SOLR_BINARY";   echo "downloading $DOWNLOAD_URL";   if ! wget -t 10 --max-redirect $MAX_REDIRECTS --retry-connrefused -nv "$DOWNLOAD_URL" -O "/opt/$SOLR_BINARY"; then rm -f "/opt/$SOLR_BINARY"; fi;   if [ ! -f "/opt/$SOLR_BINARY" ]; then echo "failed download attempt for $SOLR_BINARY"; exit 1; fi;   echo "$SOLR_SHA512 */opt/$SOLR_BINARY" | sha512sum -c -;   if [ -z "$SKIP_GPG_CHECK" ]; then     export GNUPGHOME="/tmp/gnupg_home";     mkdir -p "$GNUPGHOME";     chmod 700 "$GNUPGHOME";     echo "disable-ipv6" >> "$GNUPGHOME/dirmngr.conf";     if [ -n "$SOLR_KEYS" ]; then       wget -nv "https://downloads.apache.org/solr/KEYS" -O- |         gpg --batch --import --key-origin 'url,https://downloads.apache.org/solr/KEYS';       release_keys="$(gpg --batch --export -a ${SOLR_KEYS})";       rm -rf "$GNUPGHOME"/*;       echo "${release_keys}" | gpg --batch --import;     fi;     echo "downloading $DOWNLOAD_URL.asc";     wget -nv "$DOWNLOAD_URL.asc" -O "/opt/$SOLR_BINARY.asc";     (>&2 ls -l "/opt/$SOLR_BINARY" "/opt/$SOLR_BINARY.asc");     gpg --batch --verify "/opt/$SOLR_BINARY.asc" "/opt/$SOLR_BINARY";     { command -v gpgconf; gpgconf --kill all || :; };     rm -r "$GNUPGHOME";   else     echo "Skipping GPG validation due to non-Apache build";   fi;   tar -C /opt --extract --preserve-permissions --file "/opt/$SOLR_BINARY";   rm "/opt/$SOLR_BINARY"*;   apt-get -y remove gpg dirmngr && apt-get -y autoremove;
# Thu, 25 Jan 2024 20:24:43 GMT
LABEL org.opencontainers.image.title=Apache Solr
# Thu, 25 Jan 2024 20:24:44 GMT
LABEL org.opencontainers.image.description=Apache Solr is the popular, blazing-fast, open source search platform built on Apache Lucene.
# Thu, 25 Jan 2024 20:24:44 GMT
LABEL org.opencontainers.image.authors=The Apache Solr Project
# Thu, 25 Jan 2024 20:24:45 GMT
LABEL org.opencontainers.image.url=https://solr.apache.org
# Thu, 25 Jan 2024 20:24:45 GMT
LABEL org.opencontainers.image.source=https://github.com/apache/solr
# Thu, 25 Jan 2024 20:24:46 GMT
LABEL org.opencontainers.image.documentation=https://solr.apache.org/guide/
# Thu, 25 Jan 2024 20:24:46 GMT
LABEL org.opencontainers.image.version=9.4.1
# Thu, 25 Jan 2024 20:24:47 GMT
LABEL org.opencontainers.image.licenses=Apache-2.0
# Thu, 25 Jan 2024 20:24:48 GMT
ENV SOLR_USER=solr SOLR_UID=8983 SOLR_GROUP=solr SOLR_GID=8983 PATH=/opt/solr/bin:/opt/solr/docker/scripts:/opt/solr/prometheus-exporter/bin:/opt/java/openjdk/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin SOLR_INCLUDE=/etc/default/solr.in.sh SOLR_HOME=/var/solr/data SOLR_PID_DIR=/var/solr SOLR_LOGS_DIR=/var/solr/logs LOG4J_PROPS=/var/solr/log4j2.xml SOLR_JETTY_HOST=0.0.0.0 SOLR_ZK_EMBEDDED_HOST=0.0.0.0
# Thu, 25 Jan 2024 20:24:50 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   groupadd -r --gid "$SOLR_GID" "$SOLR_GROUP";   useradd -r --uid "$SOLR_UID" --gid "$SOLR_GID" "$SOLR_USER"
# Thu, 25 Jan 2024 20:24:52 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   (cd /opt; ln -s solr-*/ solr);   rm -Rf /opt/solr/docs /opt/solr/docker/Dockerfile;
# Thu, 25 Jan 2024 20:24:54 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   mkdir -p /opt/solr/server/solr/lib /docker-entrypoint-initdb.d;   cp /opt/solr/bin/solr.in.sh /etc/default/solr.in.sh;   mv /opt/solr/bin/solr.in.sh /opt/solr/bin/solr.in.sh.orig;   mv /opt/solr/bin/solr.in.cmd /opt/solr/bin/solr.in.cmd.orig;   chmod 0664 /etc/default/solr.in.sh;   mkdir -p -m0770 /var/solr;   chown -R "$SOLR_USER:0" /var/solr;   test ! -e /opt/solr/modules || ln -s /opt/solr/modules /opt/solr/contrib;   test ! -e /opt/solr/prometheus-exporter || ln -s /opt/solr/prometheus-exporter /opt/solr/modules/prometheus-exporter;
# Thu, 25 Jan 2024 20:25:08 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;     apt-get update;     apt-get -y --no-install-recommends install acl lsof procps wget netcat gosu tini jattach;     rm -rf /var/lib/apt/lists/*;
# Thu, 25 Jan 2024 20:25:09 GMT
VOLUME [/var/solr]
# Thu, 25 Jan 2024 20:25:09 GMT
EXPOSE 8983
# Thu, 25 Jan 2024 20:25:10 GMT
WORKDIR /opt/solr
# Thu, 25 Jan 2024 20:25:10 GMT
USER 8983
# Thu, 25 Jan 2024 20:25:11 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Thu, 25 Jan 2024 20:25:11 GMT
CMD ["solr-foreground"]
```
...
-	Layers:
	...
	-	`sha256:1705edde663dc0bc7b7aa8489dfbe347b084d1ed02b43479222a0114cd038cdc`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1e8fe33481a22f9afc5f4f93334bd4681100c9b092b7fbfc20b9c85645b0fe71`  
		Last Modified: Thu, 25 Jan 2024 20:36:36 GMT  
		Size: 281.3 MB (281342847 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:888920ca1969dd7762e27791df14cfce9e474d5bc0352229db969e169b576b5e`  
		Last Modified: Thu, 25 Jan 2024 20:36:21 GMT  
		Size: 4.3 KB (4299 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e9de9d6d4cf1026c1b6174271bb1aa0820e84cd47c888a8278af8eba700d76f6`  
		Last Modified: Thu, 25 Jan 2024 20:36:21 GMT  
		Size: 218.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:86fc0cca84e121e65cf0d4b8c0d3d0ed48f144b9b0e8e43129d82e6af65d7b85`  
		Last Modified: Thu, 25 Jan 2024 20:36:21 GMT  
		Size: 10.8 KB (10849 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7745bad7a7ad7b97acfa08cdd508d77b9325e71d998cf1385d436d60c324f45d`  
		Last Modified: Thu, 25 Jan 2024 20:36:21 GMT  
		Size: 1.8 MB (1835589 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `solr:latest` - linux; s390x

```console
$ docker pull solr@sha256:17af6ea04a35baa53892ac49a1ea701e85fad2bb416e23c3036ee6e1b5bf1c67
```

-	Docker Version: 20.10.23
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **372.8 MB (372816470 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a151d050adf02eda5486c35106a20baf6c75545ed44dc1ac45090cc49995c52b`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
# Thu, 25 Jan 2024 23:38:17 GMT
ARG SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr
# Thu, 25 Jan 2024 23:38:43 GMT
# ARGS: SOLR_DIST= SOLR_DOWNLOAD_SERVER=https://www.apache.org/dyn/closer.lua?action=download&filename=/solr/solr SOLR_KEYS=515EA995ED1DD799FA1422E5CA7514D8385D790B SOLR_SHA512=de22de737900e792776b35f598c14d734d432fdb9147feffd41694d66c521145c024f99ff180c2486ab91d96e34db34224f7cfa72b16afbe14d740c1d429a173 SOLR_VERSION=9.4.1
RUN set -ex;   apt-get update;   apt-get -y --no-install-recommends install wget gpg gnupg dirmngr;   rm -rf /var/lib/apt/lists/*;   export SOLR_BINARY="solr-$SOLR_VERSION$SOLR_DIST.tgz";   MAX_REDIRECTS=3;   case "${SOLR_DOWNLOAD_SERVER}" in     (*"apache.org"*);;     (*)       MAX_REDIRECTS=4 &&       SKIP_GPG_CHECK=true;;   esac;   export DOWNLOAD_URL="$SOLR_DOWNLOAD_SERVER/$SOLR_VERSION/$SOLR_BINARY";   echo "downloading $DOWNLOAD_URL";   if ! wget -t 10 --max-redirect $MAX_REDIRECTS --retry-connrefused -nv "$DOWNLOAD_URL" -O "/opt/$SOLR_BINARY"; then rm -f "/opt/$SOLR_BINARY"; fi;   if [ ! -f "/opt/$SOLR_BINARY" ]; then echo "failed download attempt for $SOLR_BINARY"; exit 1; fi;   echo "$SOLR_SHA512 */opt/$SOLR_BINARY" | sha512sum -c -;   if [ -z "$SKIP_GPG_CHECK" ]; then     export GNUPGHOME="/tmp/gnupg_home";     mkdir -p "$GNUPGHOME";     chmod 700 "$GNUPGHOME";     echo "disable-ipv6" >> "$GNUPGHOME/dirmngr.conf";     if [ -n "$SOLR_KEYS" ]; then       wget -nv "https://downloads.apache.org/solr/KEYS" -O- |         gpg --batch --import --key-origin 'url,https://downloads.apache.org/solr/KEYS';       release_keys="$(gpg --batch --export -a ${SOLR_KEYS})";       rm -rf "$GNUPGHOME"/*;       echo "${release_keys}" | gpg --batch --import;     fi;     echo "downloading $DOWNLOAD_URL.asc";     wget -nv "$DOWNLOAD_URL.asc" -O "/opt/$SOLR_BINARY.asc";     (>&2 ls -l "/opt/$SOLR_BINARY" "/opt/$SOLR_BINARY.asc");     gpg --batch --verify "/opt/$SOLR_BINARY.asc" "/opt/$SOLR_BINARY";     { command -v gpgconf; gpgconf --kill all || :; };     rm -r "$GNUPGHOME";   else     echo "Skipping GPG validation due to non-Apache build";   fi;   tar -C /opt --extract --preserve-permissions --file "/opt/$SOLR_BINARY";   rm "/opt/$SOLR_BINARY"*;   apt-get -y remove gpg dirmngr && apt-get -y autoremove;
# Thu, 25 Jan 2024 23:38:48 GMT
LABEL org.opencontainers.image.title=Apache Solr
# Thu, 25 Jan 2024 23:38:48 GMT
LABEL org.opencontainers.image.description=Apache Solr is the popular, blazing-fast, open source search platform built on Apache Lucene.
# Thu, 25 Jan 2024 23:38:49 GMT
LABEL org.opencontainers.image.authors=The Apache Solr Project
# Thu, 25 Jan 2024 23:38:49 GMT
LABEL org.opencontainers.image.url=https://solr.apache.org
# Thu, 25 Jan 2024 23:38:49 GMT
...
-	Layers:
	...
	-	`sha256:ec6708fc52fa273f05e4a85c593248bb4a068a84c7d8268db84e19590fdc83be`  
		...
		Size: 734.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:329d79328174bc121c3af1d17075e45da48c716485aa3fe079672ff8f26709c9`  
		Last Modified: Thu, 25 Jan 2024 23:54:31 GMT  
		Size: 281.3 MB (281342780 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:21599337f3338e12f5c7ac34a9ffc65026af6e901b803f5e775913a9eb3504da`  
		Last Modified: Thu, 25 Jan 2024 23:54:20 GMT  
		Size: 4.3 KB (4332 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:579beec47e53e13a9cd512c9573fc54138f3ade7da9c6fa819f44df7a848b29a`  
		Last Modified: Thu, 25 Jan 2024 23:54:20 GMT  
		Size: 219.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:66cfd6d4e59f3cb852fab28546f21f5136e6c00f5d00b44f6633bff3d8a2249a`  
		Last Modified: Thu, 25 Jan 2024 23:54:20 GMT  
		Size: 10.8 KB (10848 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:260354e4ee9f934a2e9824f2c0a1eed16b3f54858a9dd1fa4a5e7f4f847c6d56`  
		Last Modified: Thu, 25 Jan 2024 23:54:20 GMT  
		Size: 1.8 MB (1775840 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
