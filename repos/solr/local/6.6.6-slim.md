...
- Image ID: `sha256:deea3721e5fd4922de01833e78288ce7abcc635a3674ad73f2de0f47a679bb75`
- Created: `2021-09-29T10:55:29.607773447Z`
- Virtual Size: ~ 382.98 Mb  
...
### `dpkg` source package: `base-files=11.1`
...
- `libsasl2-modules:amd64=2.1.27+dfsg-2.1`
...
### `dpkg` source package: `glibc=2.31-13`
...
```console
$ apt-get source -qq --print-uris glibc=2.31-13
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.31-13.dsc' glibc_2.31-13.dsc 8315 SHA256:85cab7f072d1371775f225d3bbf89a7c2baff10fa1c4de0116e9868716c47a97
...
'http://deb.debian.org/debian/pool/main/g/glibc/glibc_2.31-13.debian.tar.xz' glibc_2.31-13.debian.tar.xz 911724 SHA256:a1f2a1ef54a13edb7185a995f4db050a8fa74f05fe4f271ef0c51d8d99285436
```

Other potentially useful URLs:

- https://sources.debian.net/src/glibc/2.31-13/ (for browsing the source)
- https://sources.debian.net/src/glibc/2.31-13/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/glibc/2.31-13/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `lsof=4.93.2+dfsg-1.1`
...
```console
$ apt-get source -qq --print-uris lsof=4.93.2+dfsg-1.1
'http://deb.debian.org/debian/pool/main/l/lsof/lsof_4.93.2+dfsg-1.1.dsc' lsof_4.93.2+dfsg-1.1.dsc 1770 SHA256:cbf656bc8e5aaa5062b8fe6188f412eb121057bc27b8b10bc6e0a2256a678b75
'http://deb.debian.org/debian/pool/main/l/lsof/lsof_4.93.2+dfsg.orig.tar.xz' lsof_4.93.2+dfsg.orig.tar.xz 743412 SHA256:a4c26f16e02b744a2f8c2868a27f0bccaa1c3a2d5091bb22dbe55d84099718c7
'http://deb.debian.org/debian/pool/main/l/lsof/lsof_4.93.2+dfsg-1.1.debian.tar.xz' lsof_4.93.2+dfsg-1.1.debian.tar.xz 18596 SHA256:ef5637e988a65056ebf28b1c0d1f5f82c3f8da04d2e48adcd33bf3ff301a7f63
```

Other potentially useful URLs:

- https://sources.debian.net/src/lsof/4.93.2+dfsg-1.1/ (for browsing the source)
- https://sources.debian.net/src/lsof/4.93.2+dfsg-1.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lsof/4.93.2+dfsg-1.1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `netcat-openbsd=1.217-3`
...
```console
$ apt-get source -qq --print-uris netcat-openbsd=1.217-3
'http://deb.debian.org/debian/pool/main/n/netcat-openbsd/netcat-openbsd_1.217-3.dsc' netcat-openbsd_1.217-3.dsc 1922 SHA256:94c8edf3c058bd393200c34e285314692985ae0f9b639b8c2d04c2f2d4fe9483
'http://deb.debian.org/debian/pool/main/n/netcat-openbsd/netcat-openbsd_1.217.orig.tar.gz' netcat-openbsd_1.217.orig.tar.gz 22927 SHA256:fcb551d9987fd51d020c62b6d81df0c2bb17ce1887bbc3fda4d28313791cc0f5
'http://deb.debian.org/debian/pool/main/n/netcat-openbsd/netcat-openbsd_1.217-3.debian.tar.xz' netcat-openbsd_1.217-3.debian.tar.xz 37004 SHA256:9cbc9850a74d06ba44a13338684b9d1f9f56908adbdee85f6c0ff629e174a4aa
```

Other potentially useful URLs:

- https://sources.debian.net/src/netcat-openbsd/1.217-3/ (for browsing the source)
- https://sources.debian.net/src/netcat-openbsd/1.217-3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/netcat-openbsd/1.217-3/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `netcat=1.10-46`
...
```console
$ apt-get source -qq --print-uris netcat=1.10-46
'http://deb.debian.org/debian/pool/main/n/netcat/netcat_1.10-46.dsc' netcat_1.10-46.dsc 1922 SHA256:9a477c927dc6f1003dc6ce14480b91a99e3d724a39edfbebb41b4ef0c9b39a25
...
'http://deb.debian.org/debian/pool/main/n/netcat/netcat_1.10-46.debian.tar.xz' netcat_1.10-46.debian.tar.xz 20724 SHA256:5f2bf914edc9bbf1a45ad77c849f30cbb6f4732293b955c35721738ce5680628
```

Other potentially useful URLs:

- https://sources.debian.net/src/netcat/1.10-46/ (for browsing the source)
- https://sources.debian.net/src/netcat/1.10-46/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/netcat/1.10-46/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `perl=5.32.1-4+deb11u1`
...
```console
$ apt-get source -qq --print-uris perl=5.32.1-4+deb11u1
'http://security.debian.org/debian-security/pool/updates/main/p/perl/perl_5.32.1-4+deb11u1.dsc' perl_5.32.1-4+deb11u1.dsc 3048 SHA256:e7a6ef35f61637642cfc0e6d41e2267713fab2b82104a664b08dded539c02fe0
'http://security.debian.org/debian-security/pool/updates/main/p/perl/perl_5.32.1.orig-regen-configure.tar.gz' perl_5.32.1.orig-regen-configure.tar.gz 871331 SHA256:1d179b41283f12ad83f9758430f6ddc49bdf20db5c396aeae7e51ebb4e4afd29
'http://security.debian.org/debian-security/pool/updates/main/p/perl/perl_5.32.1.orig.tar.xz' perl_5.32.1.orig.tar.xz 12610988 SHA256:57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309
'http://security.debian.org/debian-security/pool/updates/main/p/perl/perl_5.32.1-4+deb11u1.debian.tar.xz' perl_5.32.1-4+deb11u1.debian.tar.xz 164924 SHA256:e16f170efb96d4f2843cf890d4b1ba2cb288f43f25305c79138c3a10f690339e
```

Other potentially useful URLs:

- https://sources.debian.net/src/perl/5.32.1-4+deb11u1/ (for browsing the source)
- https://sources.debian.net/src/perl/5.32.1-4+deb11u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/perl/5.32.1-4+deb11u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `publicsuffix=20210108.1309-1`
...
```console
$ apt-get source -qq --print-uris publicsuffix=20210108.1309-1
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20210108.1309-1.dsc' publicsuffix_20210108.1309-1.dsc 1406 SHA256:f8639e27e3f56ccca53816c96f7e6c15f2d1f7e0763cbb6c0859dbe40ac1dddb
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20210108.1309.orig.tar.gz' publicsuffix_20210108.1309.orig.tar.gz 97848 SHA256:fd2ae585f07328cca542b05fbf580d6d9cff41a7a58c7dbf5f55a934d69be56a
'http://deb.debian.org/debian/pool/main/p/publicsuffix/publicsuffix_20210108.1309-1.debian.tar.xz' publicsuffix_20210108.1309-1.debian.tar.xz 14980 SHA256:7e6fe4b3d3b5ce9e1a4fe3949c70277fd6dbbdec17f59cc84f181f0e7f9deec3
```

Other potentially useful URLs:

- https://sources.debian.net/src/publicsuffix/20210108.1309-1/ (for browsing the source)
- https://sources.debian.net/src/publicsuffix/20210108.1309-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/publicsuffix/20210108.1309-1/ (for access to the source package after it no longer exists in the archive)
