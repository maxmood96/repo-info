...
```console
$ dnf --quiet download --source --url audit-libs-python-2.8.5-4.el7
http://vault.centos.org/centos/7/os/Source/SPackages/audit-2.8.5-4.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url avahi-libs-0.6.31-20.el7
...
```console
$ dnf --quiet download --source --url boost-date-time-1.53.0-28.el7
http://vault.centos.org/centos/7/os/Source/SPackages/boost-1.53.0-28.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url boost-system-1.53.0-28.el7
http://vault.centos.org/centos/7/os/Source/SPackages/boost-1.53.0-28.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url boost-thread-1.53.0-28.el7
http://vault.centos.org/centos/7/os/Source/SPackages/boost-1.53.0-28.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url checkpolicy-2.5-8.el7
http://vault.centos.org/centos/7/os/Source/SPackages/checkpolicy-2.5-8.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-8.1-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-8.1-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-binutils-2.30-55.el7.2
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-binutils-2.30-55.el7.2.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-dwz-0.12-1.1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-dwz-0.12-1.1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-dyninst-9.3.2-6.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-dyninst-9.3.2-6.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-elfutils-0.176-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-elfutils-0.176-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-elfutils-libelf-0.176-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-elfutils-0.176-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-elfutils-libs-0.176-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-elfutils-0.176-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-gcc-8.3.1-3.2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gcc-8.3.1-3.2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-gcc-c++-8.3.1-3.2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gcc-8.3.1-3.2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-gcc-gfortran-8.3.1-3.2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gcc-8.3.1-3.2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-gdb-8.2-3.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gdb-8.2-3.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-libquadmath-devel-8.3.1-3.2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gcc-8.3.1-3.2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-libstdc++-devel-8.3.1-3.2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-gcc-8.3.1-3.2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-ltrace-0.7.91-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-ltrace-0.7.91-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-make-4.2.1-4.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-make-4.2.1-4.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-memstomp-0.1.5-5.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-memstomp-0.1.5-5.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-oprofile-1.3.0-2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-oprofile-1.3.0-2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-perftools-8.1-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-8.1-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-runtime-8.1-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-8.1-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-strace-4.24-4.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-strace-4.24-4.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-systemtap-3.3-2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-systemtap-3.3-2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-systemtap-client-3.3-2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-systemtap-3.3-2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-systemtap-devel-3.3-2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-systemtap-3.3-2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-systemtap-runtime-3.3-2.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-systemtap-3.3-2.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-toolchain-8.1-1.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-8.1-1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url devtoolset-8-valgrind-3.14.0-16.el7
http://vault.centos.org/centos/7/sclo/Source/rh/devtoolset-8-valgrind-3.14.0-16.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url efivar-libs-36-12.el7
http://vault.centos.org/centos/7/os/Source/SPackages/efivar-36-12.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcgroup-0.41-21.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libcgroup-0.41-21.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libgfortran5-8.3.1-2.1.1.el7
http://vault.centos.org/centos/7/os/Source/SPackages/gcc-libraries-8.3.1-2.1.1.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libquadmath-4.8.5-44.el7
http://vault.centos.org/centos/7/os/Source/SPackages/gcc-4.8.5-44.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libselinux-python-2.5-15.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libselinux-2.5-15.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url libsemanage-python-2.5-14.el7
http://vault.centos.org/centos/7/os/Source/SPackages/libsemanage-2.5-14.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url mokutil-15-8.el7
http://vault.centos.org/centos/7/os/Source/SPackages/shim-signed-15-8.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url policycoreutils-python-2.5-34.el7
http://vault.centos.org/centos/7/os/Source/SPackages/policycoreutils-2.5-34.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url python-IPy-0.75-6.el7.noarch
http://vault.centos.org/centos/7/os/Source/SPackages/python-IPy-0.75-6.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url scl-utils-20130529-19.el7
http://vault.centos.org/centos/7/os/Source/SPackages/scl-utils-20130529-19.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url setools-libs-3.3.8-4.el7
http://vault.centos.org/centos/7/os/Source/SPackages/setools-3.3.8-4.el7.src.rpm
```
...
```console
$ dnf --quiet download --source --url zip-3.0-11.el7
