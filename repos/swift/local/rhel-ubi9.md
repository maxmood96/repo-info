...
- Created: `2025-11-17T23:22:03.936573292Z`
...
- Labels:
  - `architecture=x86_64`
  - `build-date=2025-11-17T00:53:13Z`
  ...
  - `name=ubi9/ubi`
  - `org.opencontainers.image.revision=84ea7c19db44cfaaf0c8ed0d67f74214aeb5ecf4`
  - `release=1763340522`
  - `summary=Provides the latest release of Red Hat Universal Base Image 9.`
  - `url=https://catalog.redhat.com/en/search?searchType=containers`
  - `vcs-ref=84ea7c19db44cfaaf0c8ed0d67f74214aeb5ecf4`
  - `vcs-type=git`
  - `vendor=Red Hat, Inc.`
  - `version=9.7`
...
### `rpm` package: `binutils-2.35.2-67.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-67.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/b/binutils-2.35.2-67.el9.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-67.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-67.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/b/binutils-2.35.2-67.el9.src.rpm
```
...
### `rpm` package: `cpp-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url cpp-11.5.0-11.el9
...
### `rpm` package: `crypto-policies-scripts-20250905-1.git377cc42.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url crypto-policies-scripts-20250905-1.git377cc42.el9_7.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/crypto-policies-20250905-1.git377cc42.el9_7.src.rpm
```
...
### `rpm` package: `dnf-4.14.0-31.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-31.el9.noarch
...
```console
$ dnf --quiet download --source --url elfutils-debuginfod-client-0.193-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.193-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.193-1.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.193-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-libelf-0.193-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.193-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.193-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.193-1.el9.src.rpm
```

### `rpm` package: `emacs-filesystem-27.2-18.el9.noarch`
...
```console
$ dnf --quiet download --source --url emacs-filesystem-27.2-18.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/e/emacs-27.2-18.el9.src.rpm
```
...
### `rpm` package: `gcc-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url gcc-11.5.0-11.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-11.el9.src.rpm
```

### `rpm` package: `gcc-c++-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url gcc-c++-11.5.0-11.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-11.el9.src.rpm
```

### `rpm` package: `gdb-gdbserver-16.3-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url gdb-gdbserver-16.3-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/gdb-16.3-2.el9.src.rpm
```
...
### `rpm` package: `glibc-devel-2.34-231.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-231.el9_7.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-231.el9_7.2.src.rpm
```

### `rpm` package: `glibc-headers-2.34-231.el9_7.2.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-231.el9_7.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-231.el9_7.2.src.rpm
```
...
### `rpm` package: `iproute-6.14.0-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-6.14.0-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/i/iproute-6.14.0-2.el9.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-611.8.1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libbpf-1.5.0-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libbpf-1.5.0-2.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcurl-devel-7.76.1-34.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/curl-7.76.1-34.el9.src.rpm
```
...
### `rpm` package: `libdnf-plugin-subscription-manager-1.29.47.1-1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-plugin-subscription-manager-1.29.47.1-1.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.47.1-1.el9_7.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-11.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-11.el9.src.rpm
```
...
### `rpm` package: `libstdc++-devel-11.5.0-11.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-devel-11.5.0-11.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-11.el9.src.rpm
```
...
### `rpm` package: `python3-3.9.23-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.23-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.23-2.el9.src.rpm
```
...
### `rpm` package: `python3-cloud-what-1.29.47.1-1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-cloud-what-1.29.47.1-1.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.47.1-1.el9_7.src.rpm
```
...
### `rpm` package: `python3-devel-3.9.23-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-devel-3.9.23-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.23-2.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-31.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-31.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-24.el9_7.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-24.el9_7.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-plugins-core-4.3.0-24.el9_7.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-16.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-16.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdnf-0.69.0-16.el9.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-16.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-16.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdnf-0.69.0-16.el9.src.rpm
```

### `rpm` package: `python3-librepo-1.14.5-3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-librepo-1.14.5-3.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/librepo-1.14.5-3.el9.src.rpm
```

### `rpm` package: `python3-libs-3.9.23-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.23-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.23-2.el9.src.rpm
```
...
### `rpm` package: `python3-rpm-4.16.1.3-39.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-39.el9
...
### `rpm` package: `python3-subscription-manager-rhsm-1.29.47.1-1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url python3-subscription-manager-rhsm-1.29.47.1-1.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.47.1-1.el9_7.src.rpm
```
...
### `rpm` package: `rpm-build-libs-4.16.1.3-39.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-39.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-39.el9.src.rpm
```
...
### `rpm` package: `rpm-sign-libs-4.16.1.3-39.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-39.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-39.el9.src.rpm
```
...
### `rpm` package: `sqlite-3.34.1-9.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-3.34.1-9.el9_7
...
### `rpm` package: `sqlite-devel-3.34.1-9.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-devel-3.34.1-9.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/sqlite-3.34.1-9.el9_7.src.rpm
```
...
### `rpm` package: `subscription-manager-1.29.47.1-1.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url subscription-manager-1.29.47.1-1.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.47.1-1.el9_7.src.rpm
```
...
```console
$ dnf --quiet download --source --url unzip-6.0-59.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/u/unzip-6.0-59.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-23.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/v/vim-8.2.2637-23.el9_7.src.rpm
```
...
### `rpm` package: `yum-4.14.0-31.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-31.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-31.el9.src.rpm
```
