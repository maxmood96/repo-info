...
- Image ID: `sha256:c28a237890b2d1aba91cc030accef4ea4293f4ae5772088a79263a580d2cf890`
...
### `rpm` package: `elfutils-debuginfod-client-0.192-6.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-debuginfod-client-0.192-6.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-6.el9_6.src.rpm
```

### `rpm` package: `elfutils-default-yama-scope-0.192-6.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.192-6.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-6.el9_6.src.rpm
```

### `rpm` package: `elfutils-libelf-0.192-6.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libelf-0.192-6.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-6.el9_6.src.rpm
```

### `rpm` package: `elfutils-libs-0.192-6.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.192-6.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-6.el9_6.src.rpm
```

### `rpm` package: `emacs-filesystem-27.2-14.el9_6.2.noarch`
...
```console
$ dnf --quiet download --source --url emacs-filesystem-27.2-14.el9_6.2.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/e/emacs-27.2-14.el9_6.2.src.rpm
```
...
### `rpm` package: `gdb-gdbserver-14.2-4.1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url gdb-gdbserver-14.2-4.1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/gdb-14.2-4.1.el9_6.src.rpm
```
...
### `rpm` package: `glibc-devel-2.34-168.el9_6.20.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-168.el9_6.20
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.20.src.rpm
```

### `rpm` package: `glibc-headers-2.34-168.el9_6.20.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-168.el9_6.20
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.20.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.26.1.el9_6.x86_64`
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libarchive-3.5.3-5.el9_6.src.rpm
```
...
### `rpm` package: `libdnf-plugin-subscription-manager-1.29.45.1-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-plugin-subscription-manager-1.29.45.1-1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45.1-1.el9_6.src.rpm
```
...
### `rpm` package: `libxml2-devel-2.9.13-10.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.13-10.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-10.el9_6.src.rpm
```
...
### `rpm` package: `pam-1.5.1-25.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url pam-1.5.1-25.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/pam-1.5.1-25.el9_6.src.rpm
```
...
### `rpm` package: `python3-3.9.21-2.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.21-2.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9_6.1.src.rpm
```
...
### `rpm` package: `python3-cloud-what-1.29.45.1-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-cloud-what-1.29.45.1-1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45.1-1.el9_6.src.rpm
```
...
### `rpm` package: `python3-devel-3.9.21-2.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-devel-3.9.21-2.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9_6.1.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.21-2.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.21-2.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9_6.1.src.rpm
```
...
### `rpm` package: `python3-subscription-manager-rhsm-1.29.45.1-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url python3-subscription-manager-rhsm-1.29.45.1-1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45.1-1.el9_6.src.rpm
```
...
### `rpm` package: `subscription-manager-1.29.45.1-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url subscription-manager-1.29.45.1-1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45.1-1.el9_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url systemd-252-51.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9_6.1.src.rpm
```

### `rpm` package: `systemd-libs-252-51.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-51.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9_6.1.src.rpm
```

### `rpm` package: `systemd-pam-252-51.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-51.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9_6.1.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-51.el9_6.1.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-51.el9_6.1.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9_6.1.src.rpm
```
