...
### `rpm` package: `cpp-11.4.1-3.el9.x86_64`
...
### `rpm` package: `dmidecode-3.5-3.el9.x86_64`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `dnf-4.14.0-9.el9.noarch`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `dnf-data-4.14.0-9.el9.noarch`
...
### `rpm` package: `gcc-11.4.1-3.el9.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gcc-c++-11.4.1-3.el9.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gdb-gdbserver-10.2-13.el9.x86_64`
...
### `rpm` package: `glibc-devel-2.34-100.el9_4.2.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and LGPLv2+ with exceptions and GPLv2+ and GPLv2+ with exceptions and BSD and Inner-Net and ISC and Public Domain and GFDL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `glibc-headers-2.34-100.el9_4.2.x86_64`
...
### `rpm` package: `kernel-headers-5.14.0-427.26.1.el9_4.x86_64`
...
### `rpm` package: `libbpf-1.3.0-2.el9.x86_64`
...
### `rpm` package: `libcurl-devel-7.76.1-29.el9_4.x86_64`
...
### `rpm` package: `libdnf-0.69.0-8.el9.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libdnf-plugin-subscription-manager-1.29.40-1.el9.x86_64`
...
### `rpm` package: `libgcc-11.4.1-3.el9.x86_64`
...
### `rpm` package: `libgomp-11.4.1-3.el9.x86_64`
...
### `rpm` package: `libstdc++-11.4.1-3.el9.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libstdc++-devel-11.4.1-3.el9.x86_64`
...
### `rpm` package: `libuuid-devel-2.37.4-18.el9.x86_64`
...
### `rpm` package: `openssh-8.7p1-38.el9_4.4.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `openssh-clients-8.7p1-38.el9_4.4.x86_64`
...
### `rpm` package: `openssl-fips-provider-3.0.7-2.el9.x86_64`
...
### `rpm` package: `python3-3.9.18-3.el9_4.3.x86_64`
...
### `rpm` package: `python3-cloud-what-1.29.40-1.el9.x86_64`
...
### `rpm` package: `python3-devel-3.9.18-3.el9_4.3.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-dnf-4.14.0-9.el9.noarch`

Licenses (from `rpm --query`): GPLv2+

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-dnf-plugins-core-4.3.0-13.el9.noarch`
...
### `rpm` package: `python3-hawkey-0.69.0-8.el9.x86_64`
...
### `rpm` package: `python3-libdnf-0.69.0-8.el9.x86_64`
...
### `rpm` package: `python3-libs-3.9.18-3.el9_4.3.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python3-pip-21.2.3-8.el9.noarch`
...
### `rpm` package: `python3-subscription-manager-rhsm-1.29.40-1.el9.x86_64`
...
### `rpm` package: `python3-urllib3-1.26.5-5.el9.noarch`
...
### `rpm` package: `subscription-manager-1.29.40-1.el9.x86_64`
...
### `rpm` package: `virt-what-1.25-5.el9.x86_64`
...
### `rpm` package: `yum-4.14.0-9.el9.noarch`
