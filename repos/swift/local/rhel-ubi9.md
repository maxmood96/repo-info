...
- Created: `2026-06-05T22:45:24.208572465Z`
...
- Labels:
  - `architecture=x86_64`
  - `build-date=2026-06-04T06:24:17Z`
  ...
  - `name=ubi9/ubi`
  - `org.opencontainers.image.created=2026-06-04T06:24:17Z`
  - `org.opencontainers.image.revision=a1ff645e4d0b83aad1b77555a562c5807a8af5bf`
  - `release=1780554162`
  - `summary=Provides the latest release of Red Hat Universal Base Image 9.`
  - `url=https://catalog.redhat.com/en/search?searchType=containers`
  - `vcs-ref=a1ff645e4d0b83aad1b77555a562c5807a8af5bf`
  - `vcs-type=git`
  - `vendor=Red Hat, Inc.`
  - `version=9.8`
...
### `rpm` package: `glibc-devel-2.34-270.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-270.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-270.el9_8.src.rpm
```

### `rpm` package: `glibc-headers-2.34-270.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-270.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-270.el9_8.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-687.12.1.el9_8.x86_64`
...
### `rpm` package: `libcurl-devel-7.76.1-40.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-devel-7.76.1-40.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/curl-7.76.1-40.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-3.5.5-3.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssl-3.5.5-3.el9_8.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-libs-3.5.5-3.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssl-3.5.5-3.el9_8.src.rpm
```
...
### `rpm` package: `python3-3.9.25-7.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.25-7.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.25-7.el9_8.src.rpm
```
...
### `rpm` package: `python3-devel-3.9.25-7.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-devel-3.9.25-7.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.25-7.el9_8.src.rpm
```
...
### `rpm` package: `python3-libs-3.9.25-7.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.25-7.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.25-7.el9_8.src.rpm
```
...
### `rpm` package: `rsync-3.2.5-7.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url rsync-3.2.5-7.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rsync-3.2.5-7.el9_8.src.rpm
```
...
### `rpm` package: `sqlite-3.34.1-10.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-3.34.1-10.el9_8
...
### `rpm` package: `sqlite-devel-3.34.1-10.el9_8.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-devel-3.34.1-10.el9_8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/sqlite-3.34.1-10.el9_8.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-26.el9_8.5.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-26.el9_8.5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/v/vim-8.2.2637-26.el9_8.5.src.rpm
```
