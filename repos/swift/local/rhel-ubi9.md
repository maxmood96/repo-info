...
### `rpm` package: `cpp-11.4.1-2.1.el9.x86_64`
...
### `rpm` package: `dmidecode-3.5-1.el9.x86_64`
...
### `rpm` package: `gcc-11.4.1-2.1.el9.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `gcc-c++-11.4.1-2.1.el9.x86_64`
...
### `rpm` package: `iproute-6.2.0-5.el9.x86_64`
...
### `rpm` package: `libbpf-1.2.0-1.el9.x86_64`
...
### `rpm` package: `libdnf-plugin-subscription-manager-1.29.38-1.el9_3.x86_64`
...
### `rpm` package: `libfido2-1.13.0-1.el9.x86_64`
...
### `rpm` package: `libstdc++-devel-11.4.1-2.1.el9.x86_64`
...
### `rpm` package: `libuuid-devel-2.37.4-15.el9.x86_64`
...
### `rpm` package: `perl-HTTP-Tiny-0.076-461.el9.noarch`
...
### `rpm` package: `python3-cloud-what-1.29.38-1.el9_3.x86_64`
...
### `rpm` package: `python3-devel-3.9.18-1.el9_3.1.x86_64`
...
### `rpm` package: `python3-dnf-plugins-core-4.3.0-11.el9_3.noarch`
...
### `rpm` package: `python3-subscription-manager-rhsm-1.29.38-1.el9_3.x86_64`
...
### `rpm` package: `redhat-release-9.3-0.5.el9.x86_64`
...
### `rpm` package: `subscription-manager-1.29.38-1.el9_3.x86_64`
