...
- Image ID: `sha256:0b9bf27afb735754274877072d4ac8aa977e5419f1622ab079bd98df194c2401`
...
### `rpm` package: `git-2.47.3-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url git-2.47.3-1.el9_6
...
### `rpm` package: `git-core-2.47.3-1.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url git-core-2.47.3-1.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.3-1.el9_6.src.rpm
```

### `rpm` package: `git-core-doc-2.47.3-1.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url git-core-doc-2.47.3-1.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.3-1.el9_6.src.rpm
```
...
### `rpm` package: `glibc-devel-2.34-168.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-168.el9_6.23
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.23.src.rpm
```

### `rpm` package: `glibc-headers-2.34-168.el9_6.23.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-168.el9_6.23
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.23.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.32.1.el9_6.x86_64`
...
### `rpm` package: `libcurl-devel-7.76.1-31.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-devel-7.76.1-31.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/curl-7.76.1-31.el9_6.1.src.rpm
```
...
### `rpm` package: `libxml2-devel-2.9.13-11.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.13-11.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-11.el9_6.src.rpm
```
...
### `rpm` package: `ncurses-c++-libs-6.2-10.20210508.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url ncurses-c++-libs-6.2-10.20210508.el9_6.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/n/ncurses-6.2-10.20210508.el9_6.2.src.rpm
```

### `rpm` package: `ncurses-devel-6.2-10.20210508.el9_6.2.x86_64`
...
```console
$ dnf --quiet download --source --url ncurses-devel-6.2-10.20210508.el9_6.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/n/ncurses-6.2-10.20210508.el9_6.2.src.rpm
```
...
### `rpm` package: `perl-File-Find-1.37-481.1.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url perl-File-Find-1.37-481.1.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.1.el9_6.src.rpm
```
...
### `rpm` package: `perl-Git-2.47.3-1.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url perl-Git-2.47.3-1.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.3-1.el9_6.src.rpm
```
...
### `rpm` package: `sqlite-3.34.1-8.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-3.34.1-8.el9_6
...
### `rpm` package: `sqlite-devel-3.34.1-8.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-devel-3.34.1-8.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/sqlite-3.34.1-8.el9_6.src.rpm
```
