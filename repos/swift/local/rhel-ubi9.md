...
```console
$ dnf --quiet download --source --url audit-libs-3.1.5-4.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/a/audit-3.1.5-4.el9.src.rpm
```
...
### `rpm` package: `binutils-2.35.2-63.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-2.35.2-63.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/b/binutils-2.35.2-63.el9.src.rpm
```

### `rpm` package: `binutils-gold-2.35.2-63.el9.x86_64`
...
```console
$ dnf --quiet download --source --url binutils-gold-2.35.2-63.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/b/binutils-2.35.2-63.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url cmake-filesystem-3.26.5-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/c/cmake-3.26.5-2.el9.src.rpm
```
...
### `rpm` package: `cpp-11.5.0-5.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url cpp-11.5.0-5.el9_5
...
### `rpm` package: `crypto-policies-20250128-1.git5269e22.el9.noarch`
...
```console
$ dnf --quiet download --source --url crypto-policies-20250128-1.git5269e22.el9.noarch
...
### `rpm` package: `crypto-policies-scripts-20250128-1.git5269e22.el9.noarch`
...
```console
$ dnf --quiet download --source --url crypto-policies-scripts-20250128-1.git5269e22.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/crypto-policies-20250128-1.git5269e22.el9.src.rpm
```
...
### `rpm` package: `dmidecode-3.6-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url dmidecode-3.6-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dmidecode-3.6-1.el9.src.rpm
```

### `rpm` package: `dnf-4.14.0-25.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-4.14.0-25.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-25.el9.src.rpm
```

### `rpm` package: `dnf-data-4.14.0-25.el9.noarch`
...
```console
$ dnf --quiet download --source --url dnf-data-4.14.0-25.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-25.el9.src.rpm
```

### `rpm` package: `elfutils-debuginfod-client-0.192-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-debuginfod-client-0.192-5.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-5.el9.src.rpm
```

### `rpm` package: `elfutils-default-yama-scope-0.192-5.el9.noarch`
...
```console
$ dnf --quiet download --source --url elfutils-default-yama-scope-0.192-5.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-5.el9.src.rpm
```

### `rpm` package: `elfutils-libelf-0.192-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libelf-0.192-5.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-5.el9.src.rpm
```

### `rpm` package: `elfutils-libs-0.192-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url elfutils-libs-0.192-5.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/elfutils-0.192-5.el9.src.rpm
```

### `rpm` package: `emacs-filesystem-27.2-13.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url emacs-filesystem-27.2-13.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/e/emacs-27.2-13.el9_6.src.rpm
```
...
```console
$ dnf --quiet download --source --url expat-2.5.0-5.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/e/expat-2.5.0-5.el9_6.src.rpm
```
...
### `rpm` package: `gcc-11.5.0-5.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url gcc-11.5.0-5.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-5.el9_5.src.rpm
```

### `rpm` package: `gcc-c++-11.5.0-5.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url gcc-c++-11.5.0-5.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-5.el9_5.src.rpm
```

### `rpm` package: `gdb-gdbserver-14.2-4.el9.x86_64`
...
```console
$ dnf --quiet download --source --url gdb-gdbserver-14.2-4.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/gdb-14.2-4.el9.src.rpm
```
...
### `rpm` package: `git-2.47.1-2.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url git-2.47.1-2.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.1-2.el9_6.src.rpm
```

### `rpm` package: `git-core-2.47.1-2.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url git-core-2.47.1-2.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.1-2.el9_6.src.rpm
```

### `rpm` package: `git-core-doc-2.47.1-2.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url git-core-doc-2.47.1-2.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.1-2.el9_6.src.rpm
```
...
### `rpm` package: `glibc-devel-2.34-168.el9_6.14.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-168.el9_6.14
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.14.src.rpm
```

### `rpm` package: `glibc-headers-2.34-168.el9_6.14.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-168.el9_6.14
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-168.el9_6.14.src.rpm
```
...
### `rpm` package: `gnutls-3.8.3-6.el9.x86_64`
...
```console
$ dnf --quiet download --source --url gnutls-3.8.3-6.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gnutls-3.8.3-6.el9.src.rpm
```
...
### `rpm` package: `ima-evm-utils-1.5-3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url ima-evm-utils-1.5-3.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/i/ima-evm-utils-1.5-3.el9.src.rpm
```

### `rpm` package: `iproute-6.11.0-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url iproute-6.11.0-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/i/iproute-6.11.0-1.el9.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-570.16.1.el9_6.x86_64`
...
### `rpm` package: `krb5-libs-1.21.1-6.el9.x86_64`
...
```console
$ dnf --quiet download --source --url krb5-libs-1.21.1-6.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/k/krb5-1.21.1-6.el9.src.rpm
```
...
### `rpm` package: `less-590-5.el9.x86_64`
...
```console
$ dnf --quiet download --source --url less-590-5.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/less-590-5.el9.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libarchive-3.5.3-4.el9.src.rpm
```
...
### `rpm` package: `libbpf-1.5.0-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libbpf-1.5.0-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libbpf-1.5.0-1.el9.src.rpm
```
...
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libcap-2.48-9.el9_2.src.rpm
```
...
```console
$ dnf --quiet download --source --url libcom_err-1.46.5-7.el9
...
### `rpm` package: `libcurl-devel-7.76.1-31.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libcurl-devel-7.76.1-31.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/c/curl-7.76.1-31.el9.src.rpm
```
...
### `rpm` package: `libdb-5.3.28-55.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libdb-5.3.28-55.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdb-5.3.28-55.el9.src.rpm
```

### `rpm` package: `libdnf-0.69.0-13.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-0.69.0-13.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdnf-0.69.0-13.el9.src.rpm
```

### `rpm` package: `libdnf-plugin-subscription-manager-1.29.45-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libdnf-plugin-subscription-manager-1.29.45-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45-1.el9.src.rpm
```
...
### `rpm` package: `libedit-3.1-38.20210216cvs.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libedit-3.1-38.20210216cvs.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libedit-3.1-38.20210216cvs.el9.src.rpm
```

### `rpm` package: `libedit-devel-3.1-38.20210216cvs.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libedit-devel-3.1-38.20210216cvs.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libedit-3.1-38.20210216cvs.el9.src.rpm
```
...
### `rpm` package: `libgomp-11.5.0-5.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url libgomp-11.5.0-5.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-5.el9_5.src.rpm
```
...
### `rpm` package: `libsepol-3.6-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libsepol-3.6-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libsepol-3.6-2.el9.src.rpm
```
...
### `rpm` package: `libstdc++-devel-11.5.0-5.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url libstdc++-devel-11.5.0-5.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/gcc-11.5.0-5.el9_5.src.rpm
```
...
### `rpm` package: `libuser-0.63-16.el9.x86_64`
...
```console
$ dnf --quiet download --source --url libuser-0.63-16.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libuser-0.63-16.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url libuuid-devel-2.37.4-21.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/u/util-linux-2.37.4-21.el9.src.rpm
```
...
### `rpm` package: `libxml2-devel-2.9.13-9.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.13-9.el9_6
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-9.el9_6.src.rpm
```
...
### `rpm` package: `ncurses-c++-libs-6.2-10.20210508.el9.x86_64`
...
```console
$ dnf --quiet download --source --url ncurses-c++-libs-6.2-10.20210508.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/n/ncurses-6.2-10.20210508.el9.src.rpm
```

### `rpm` package: `ncurses-devel-6.2-10.20210508.el9.x86_64`
...
```console
$ dnf --quiet download --source --url ncurses-devel-6.2-10.20210508.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/n/ncurses-6.2-10.20210508.el9.src.rpm
```
...
### `rpm` package: `openssh-8.7p1-45.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-8.7p1-45.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssh-8.7p1-45.el9.src.rpm
```

### `rpm` package: `openssh-clients-8.7p1-45.el9.x86_64`
...
```console
$ dnf --quiet download --source --url openssh-clients-8.7p1-45.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssh-8.7p1-45.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-3.0.7-6.el9_5
...
### `rpm` package: `openssl-fips-provider-so-3.0.7-6.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url openssl-fips-provider-so-3.0.7-6.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/o/openssl-fips-provider-3.0.7-6.el9_5.src.rpm
```
...
### `rpm` package: `pam-1.5.1-23.el9.x86_64`
...
```console
$ dnf --quiet download --source --url pam-1.5.1-23.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/pam-1.5.1-23.el9.src.rpm
```
...
### `rpm` package: `perl-DynaLoader-1.47-481.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-DynaLoader-1.47-481.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `perl-File-Find-1.37-481.el9.noarch`
...
```console
$ dnf --quiet download --source --url perl-File-Find-1.37-481.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `perl-Git-2.47.1-2.el9_6.noarch`
...
```console
$ dnf --quiet download --source --url perl-Git-2.47.1-2.el9_6.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.47.1-2.el9_6.src.rpm
```
...
### `rpm` package: `perl-lib-0.65-481.el9.x86_64`
...
```console
$ dnf --quiet download --source --url perl-lib-0.65-481.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/p/perl-5.32.1-481.el9.src.rpm
```
...
### `rpm` package: `python3-3.9.21-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-3.9.21-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9.src.rpm
```
...
### `rpm` package: `python3-cloud-what-1.29.45-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-cloud-what-1.29.45-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45-1.el9.src.rpm
```

### `rpm` package: `python3-dateutil-2.8.1-7.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dateutil-2.8.1-7.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-dateutil-2.8.1-7.el9.src.rpm
```
...
### `rpm` package: `python3-devel-3.9.21-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-devel-3.9.21-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9.src.rpm
```

### `rpm` package: `python3-dnf-4.14.0-25.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-4.14.0-25.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-25.el9.src.rpm
```

### `rpm` package: `python3-dnf-plugins-core-4.3.0-20.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-dnf-plugins-core-4.3.0-20.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-plugins-core-4.3.0-20.el9.src.rpm
```
...
### `rpm` package: `python3-hawkey-0.69.0-13.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-hawkey-0.69.0-13.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdnf-0.69.0-13.el9.src.rpm
```

### `rpm` package: `python3-idna-2.10-7.el9_4.1.noarch`
...
```console
$ dnf --quiet download --source --url python3-idna-2.10-7.el9_4.1.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-idna-2.10-7.el9_4.1.src.rpm
```
...
### `rpm` package: `python3-libdnf-0.69.0-13.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libdnf-0.69.0-13.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libdnf-0.69.0-13.el9.src.rpm
```

### `rpm` package: `python3-librepo-1.14.5-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-librepo-1.14.5-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/librepo-1.14.5-2.el9.src.rpm
```

### `rpm` package: `python3-libs-3.9.21-2.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-libs-3.9.21-2.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python3.9-3.9.21-2.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-pip-21.3.1-1.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-pip-21.3.1-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-pip-wheel-21.3.1-1.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-pip-21.3.1-1.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-requests-2.25.1-9.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-requests-2.25.1-9.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url python3-rpm-4.16.1.3-37.el9
...
### `rpm` package: `python3-subscription-manager-rhsm-1.29.45-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url python3-subscription-manager-rhsm-1.29.45-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45-1.el9.src.rpm
```
...
### `rpm` package: `python3-urllib3-1.26.5-6.el9.noarch`
...
```console
$ dnf --quiet download --source --url python3-urllib3-1.26.5-6.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/p/python-urllib3-1.26.5-6.el9.src.rpm
```
...
### `rpm` package: `redhat-release-9.6-0.1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url redhat-release-9.6-0.1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/redhat-release-9.6-0.1.el9.src.rpm
```

### `rpm` package: `rootfiles-8.1-34.el9.noarch`
...
```console
$ dnf --quiet download --source --url rootfiles-8.1-34.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rootfiles-8.1-34.el9.src.rpm
```

### `rpm` package: `rpm-4.16.1.3-37.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-4.16.1.3-37.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-37.el9.src.rpm
```

### `rpm` package: `rpm-build-libs-4.16.1.3-37.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-build-libs-4.16.1.3-37.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-37.el9.src.rpm
```

### `rpm` package: `rpm-libs-4.16.1.3-37.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-libs-4.16.1.3-37.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-37.el9.src.rpm
```

### `rpm` package: `rpm-sign-libs-4.16.1.3-37.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rpm-sign-libs-4.16.1.3-37.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rpm-4.16.1.3-37.el9.src.rpm
```

### `rpm` package: `rsync-3.2.5-3.el9.x86_64`
...
```console
$ dnf --quiet download --source --url rsync-3.2.5-3.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rsync-3.2.5-3.el9.src.rpm
```
...
### `rpm` package: `shadow-utils-4.9-12.el9.x86_64`
...
```console
$ dnf --quiet download --source --url shadow-utils-4.9-12.el9
...
### `rpm` package: `sqlite-3.34.1-7.el9_3.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-3.34.1-7.el9_3
...
### `rpm` package: `sqlite-devel-3.34.1-7.el9_3.x86_64`
...
```console
$ dnf --quiet download --source --url sqlite-devel-3.34.1-7.el9_3
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/sqlite-3.34.1-7.el9_3.src.rpm
```
...
### `rpm` package: `subscription-manager-1.29.45-1.el9.x86_64`
...
```console
$ dnf --quiet download --source --url subscription-manager-1.29.45-1.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/subscription-manager-1.29.45-1.el9.src.rpm
```
...
### `rpm` package: `systemd-252-51.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-252-51.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9.src.rpm
```

### `rpm` package: `systemd-libs-252-51.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-libs-252-51.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9.src.rpm
```

### `rpm` package: `systemd-pam-252-51.el9.x86_64`
...
```console
$ dnf --quiet download --source --url systemd-pam-252-51.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9.src.rpm
```

### `rpm` package: `systemd-rpm-macros-252-51.el9.noarch`
...
```console
$ dnf --quiet download --source --url systemd-rpm-macros-252-51.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/s/systemd-252-51.el9.src.rpm
```
...
```console
$ dnf --quiet download --source --url unzip-6.0-58.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/u/unzip-6.0-58.el9_5.src.rpm
```

### `rpm` package: `usermode-1.114-6.el9.x86_64`
...
```console
$ dnf --quiet download --source --url usermode-1.114-6.el9
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/u/usermode-1.114-6.el9.src.rpm
```
...
### `rpm` package: `vim-minimal-8.2.2637-22.el9_6.x86_64`
...
```console
$ dnf --quiet download --source --url virt-what-1.27-1.el9
...
### `rpm` package: `yum-4.14.0-25.el9.noarch`
...
```console
$ dnf --quiet download --source --url yum-4.14.0-25.el9.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/d/dnf-4.14.0-25.el9.src.rpm
```
