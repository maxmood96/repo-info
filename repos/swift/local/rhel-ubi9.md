...
### `rpm` package: `git-2.43.5-2.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url git-2.43.5-2.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.43.5-2.el9_5.src.rpm
```

### `rpm` package: `git-core-2.43.5-2.el9_5.x86_64`
...
```console
$ dnf --quiet download --source --url git-core-2.43.5-2.el9_5
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.43.5-2.el9_5.src.rpm
```

### `rpm` package: `git-core-doc-2.43.5-2.el9_5.noarch`
...
```console
$ dnf --quiet download --source --url git-core-doc-2.43.5-2.el9_5.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.43.5-2.el9_5.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-503.22.1.el9_5.x86_64`
...
### `rpm` package: `perl-Git-2.43.5-2.el9_5.noarch`
...
```console
$ dnf --quiet download --source --url perl-Git-2.43.5-2.el9_5.noarch
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/appstream/source/SRPMS/Packages/g/git-2.43.5-2.el9_5.src.rpm
```
...
### `rpm` package: `rsync-3.2.3-20.el9_5.1.x86_64`
...
```console
$ dnf --quiet download --source --url rsync-3.2.3-20.el9_5.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/r/rsync-3.2.3-20.el9_5.1.src.rpm
```
