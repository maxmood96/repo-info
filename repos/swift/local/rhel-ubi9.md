...
- Labels:
  - `architecture=x86_64`
  - `build-date=2025-04-28T15:33:11`
  ...
  - `vcs-ref=ef653792409ae12e17049047994ce871f185073a`
  - `vcs-type=git`
  - `vendor=Red Hat, Inc.`
  - `version=9.5`
...
### `rpm` package: `glibc-devel-2.34-125.el9_5.8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-125.el9_5.8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-125.el9_5.8.src.rpm
```

### `rpm` package: `glibc-headers-2.34-125.el9_5.8.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-125.el9_5.8
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-125.el9_5.8.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-503.38.1.el9_5.x86_64`
