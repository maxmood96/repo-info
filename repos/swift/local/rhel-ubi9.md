...
- Created: `2025-12-12T22:44:09.63127226Z`
...
### `rpm` package: `kernel-headers-5.14.0-611.13.1.el9_7.x86_64`
...
### `rpm` package: `libxml2-devel-2.9.13-14.el9_7.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.13-14.el9_7
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-14.el9_7.src.rpm
```
