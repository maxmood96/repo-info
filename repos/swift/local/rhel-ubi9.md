...
### `rpm` package: `emacs-filesystem-27.2-11.el9_5.1.noarch`
...
```console
$ dnf --quiet download --source --url emacs-filesystem-27.2-11.el9_5.1.noarch
...
### `rpm` package: `glibc-devel-2.34-125.el9_5.3.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-devel-2.34-125.el9_5.3
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-125.el9_5.3.src.rpm
```

### `rpm` package: `glibc-headers-2.34-125.el9_5.3.x86_64`
...
```console
$ dnf --quiet download --source --url glibc-headers-2.34-125.el9_5.3
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/g/glibc-2.34-125.el9_5.3.src.rpm
```
...
### `rpm` package: `kernel-headers-5.14.0-503.31.1.el9_5.x86_64`
...
### `rpm` package: `libxml2-2.9.13-6.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-2.9.13-6.el9_5.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-6.el9_5.2.src.rpm
```

### `rpm` package: `libxml2-devel-2.9.13-6.el9_5.2.x86_64`
...
```console
$ dnf --quiet download --source --url libxml2-devel-2.9.13-6.el9_5.2
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/l/libxml2-2.9.13-6.el9_5.2.src.rpm
```
