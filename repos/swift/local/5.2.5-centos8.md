...
- Created: `2021-10-29T00:27:04.139291701Z`
...
### `rpm` package: `python2-2.7.18-4.module_el8.4.0+668+03e3490a.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python2-libs-2.7.18-4.module_el8.4.0+668+03e3490a.x86_64`

Licenses (from `rpm --query`): Python

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python2-pip-9.0.3-18.module_el8.4.0+642+1dc4fb01.noarch`

Licenses (from `rpm --query`): MIT and Python and ASL 2.0 and BSD and ISC and LGPLv2 and MPLv2.0 and (ASL 2.0 or BSD)

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python2-pip-wheel-9.0.3-18.module_el8.4.0+642+1dc4fb01.noarch`

Licenses (from `rpm --query`): MIT and Python and ASL 2.0 and BSD and ISC and LGPLv2 and MPLv2.0 and (ASL 2.0 or BSD)

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python2-setuptools-39.0.1-13.module_el8.4.0+642+1dc4fb01.noarch`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `python2-setuptools-wheel-39.0.1-13.module_el8.4.0+642+1dc4fb01.noarch`
