...
### `rpm` package: `vim-minimal-8.2.2637-22.el9_6.1.x86_64`
...
```console
$ dnf --quiet download --source --url vim-minimal-8.2.2637-22.el9_6.1
https://cdn-ubi.redhat.com/content/public/ubi/dist/ubi9/9/x86_64/baseos/source/SRPMS/Packages/v/vim-8.2.2637-22.el9_6.1.src.rpm
```
