...
### `rpm` package: `cpp-8.4.1-1.el8.x86_64`
...
### `rpm` package: `emacs-filesystem-26.1-5.el8.noarch`

Licenses (from `rpm --query`): GPLv3+ and CC0-1.0

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `epel-release-8-13.el8.noarch`
...
### `rpm` package: `gcc-8.4.1-1.el8.x86_64`
...
### `rpm` package: `glibc-devel-2.28-151.el8.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and LGPLv2+ with exceptions and GPLv2+ and GPLv2+ with exceptions and BSD and Inner-Net and ISC and Public Domain and GFDL

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `glibc-headers-2.28-151.el8.x86_64`
...
### `rpm` package: `glibc-static-2.28-151.el8.x86_64`
...
### `rpm` package: `isl-0.16.1-6.el8.x86_64`
...
### `rpm` package: `kernel-headers-4.18.0-305.19.1.el8_4.x86_64`
...
### `rpm` package: `libbsd-0.9.1-4.el8.x86_64`

Licenses (from `rpm --query`): BSD and ISC and Copyright only and Public Domain

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libbsd-devel-0.9.1-4.el8.x86_64`
...
### `rpm` package: `libedit-devel-3.1-23.20170329cvs.el8.x86_64`
...
### `rpm` package: `libgomp-8.4.1-1.el8.x86_64`
...
### `rpm` package: `libicu-60.3-2.el8_1.x86_64`

Licenses (from `rpm --query`): MIT and UCD and Public Domain

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libicu-devel-60.3-2.el8_1.x86_64`
...
### `rpm` package: `libmpc-1.1.0-9.1.el8.x86_64`
...
### `rpm` package: `libstdc++-devel-8.4.1-1.el8.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libstdc++-static-8.4.1-1.el8.x86_64`
...
### `rpm` package: `libxcrypt-devel-4.1.1-4.el8.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and BSD and Public Domain

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `libxcrypt-static-4.1.1-4.el8.x86_64`
...
### `rpm` package: `ncurses-c++-libs-6.1-7.20180224.el8.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `ncurses-devel-6.1-7.20180224.el8.x86_64`
...
### `rpm` package: `openssh-8.0p1-6.el8_4.2.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`dnf download` failed or returned no results)!

### `rpm` package: `openssh-clients-8.0p1-6.el8_4.2.x86_64`
...
### `rpm` package: `platform-python-pip-9.0.3-19.el8.noarch`
...
### `rpm` package: `python3-pip-9.0.3-19.el8.noarch`
...
### `rpm` package: `python3-setuptools-39.2.0-6.el8.noarch`
...
### `rpm` package: `python36-3.6.8-2.module_el8.4.0+790+083e3d81.x86_64`
...
### `rpm` package: `sqlite-3.26.0-13.el8.x86_64`
